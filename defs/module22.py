...
SYMBOLS = [
	...
	{'addr':0x80485640,'size':4,'pad':0,'label':"lit_3720",'name':"@3720",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80485644,'size':4,'pad':0,'label':"lit_3721",'name':"@3721",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
