...
SYMBOLS = [
	...
	{'addr':0x804A4104,'size':4,'pad':0,'label':"lit_4173",'name':"@4173",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[2,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	{'addr':0x804A4108,'size':4,'pad':0,'label':"lit_4489",'name':"@4489",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	{'addr':0x804A410C,'size':4,'pad':0,'label':"lit_4490",'name':"@4490",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	...
	{'addr':0x804A4118,'size':4,'pad':0,'label':"lit_4775",'name':"@4775",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	{'addr':0x804A411C,'size':4,'pad':4,'label':"lit_4776",'name':"@4776",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
