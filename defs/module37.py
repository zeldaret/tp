...
SYMBOLS = [
	...
	{'addr':0x8048F700,'size':4,'pad':0,'label':"lit_3678",'name':"@3678",'lib':-1,'tu':3,'section':3,'class_template':False,'static':True,'is_reachable':False,'r':[1,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	{'addr':0x8048F704,'size':4,'pad':0,'label':"lit_3679",'name':"@3679",'lib':-1,'tu':3,'section':3,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
