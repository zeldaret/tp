...
SYMBOLS = [
	...
	{'addr':0x80A73DD8,'size':8,'pad':0,'label':"daNpc_Mk_Create__FPv",'name':"daNpc_Mk_Create__FPv",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80A73DE0,'size':8,'pad':0,'label':"daNpc_Mk_Delete__FPv",'name':"daNpc_Mk_Delete__FPv",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80A73DE8,'size':8,'pad':0,'label':"daNpc_Mk_Execute__FPv",'name':"daNpc_Mk_Execute__FPv",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80A73DF0,'size':8,'pad':0,'label':"daNpc_Mk_Draw__FPv",'name':"daNpc_Mk_Draw__FPv",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80A73DF8,'size':8,'pad':0,'label':"daNpc_Mk_IsDelete__FPv",'name':"daNpc_Mk_IsDelete__FPv",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
