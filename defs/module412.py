...
SYMBOLS = [
	...
	{'addr':0x80BBAE8C,'size':4,'pad':0,'label':"lit_3687",'name':"@3687",'lib':-1,'tu':3,'section':3,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	...
	{'addr':0x80BBAE94,'size':4,'pad':0,'label':"lit_3689",'name':"@3689",'lib':-1,'tu':3,'section':3,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	{'addr':0x80BBAE98,'size':4,'pad':0,'label':"lit_3690",'name':"@3690",'lib':-1,'tu':3,'section':3,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
