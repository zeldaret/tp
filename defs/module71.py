...
SYMBOLS = [
	...
	{'addr':0x8051977C,'size':4,'pad':0,'label':"lit_3870",'name':"@3870",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[1,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	{'addr':0x80519780,'size':4,'pad':0,'label':"lit_3871",'name':"@3871",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	{'addr':0x80519784,'size':4,'pad':0,'label':"lit_3872",'name':"@3872",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
	{'addr':0x80519788,'size':4,'pad':0,'label':"lit_3873",'name':"@3873",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[0,0,0],'sh':[0,0,0],'type':"FloatingPoint"},
