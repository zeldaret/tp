...
SYMBOLS = [
	...
	{'addr':0x805A5364,'size':4,'pad':0,'label':"lit_3844",'name':"@3844",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x805A5368,'size':4,'pad':0,'label':"lit_3845",'name':"@3845",'lib':-1,'tu':4,'section':4,'class_template':False,'static':True,'is_reachable':False,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
