...
void daMidna_c_NS_checkForceNormalColor(void);
...
void daMidna_c_NS_onForcePanic(void);
...
void daMidna_c_NS_checkForceTiredColor(void);
...
void daMidna_c_NS_onNoServiceWait(void);
...
extern "C" {
    ...
    void cM3d_Cross_CylCyl(void);
    void cM3dGAab_NS_ClearForMinMax(void);
    ...
    void cM3d_Cross_SphSph(void);
    void cM3dGSph_NS_cross(void);
    void cM3d_Cross_CpsSph(void);
    ...
    void cM3dGAab_NS_SetMinMax(void);
    ...
    void cM3dGSph_NS_cross_X1_(void);
...
extern "C" {
    ...
    void SetCoGObjInf__4cCcSFbbP12cCcD_GObjInfP12cCcD_GObjInfP9cCcD_SttsP9cCcD_SttsP10cCcD_GSttsP10cCcD_GStts(void);
    void ChkCo__4cCcSFv(void);
    void ChkNoHitCo__4cCcSFP8cCcD_ObjP8cCcD_Obj(void);
    void DrawClear__4cCcSFv(void);
    void cM3dGAab_NS_SetMinMax_X1_(void);
    void SetAtTgGObjInf__4cCcSFbbP8cCcD_ObjP8cCcD_ObjP12cCcD_GObjInfP12cCcD_GObjInfP9cCcD_SttsP9cCcD_SttsP10cCcD_GSttsP10cCcD_GSttsP4cXyz(void);
    void SetCoCommonHitInf__4cCcSFP8cCcD_ObjP4cXyzP8cCcD_ObjP4cXyzf(void);
    void ChkAtTgHitAfterCross__4cCcSFbbPC12cCcD_GObjInfPC12cCcD_GObjInfP9cCcD_SttsP9cCcD_SttsP10cCcD_GSttsP10cCcD_GStts(void);
    ...
    void cM3dGAab_NS_CalcCenter(void);
