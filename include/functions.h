...
extern "C" {
    ...
    void J2DPane_NS_J2DCast_F32_to_S16(void);
    void J2DPane_NS_animationPane(void);
    void J2DPane_NS_changeUseTrans(void);
    void J2DPane_NS_clearAnmTransform(void);
    void J2DPane_NS_clip(void);
    void J2DPane_NS_draw(void);
    void J2DPane_NS_dtor(void);
    void J2DPane_NS_getFirstChildPane(void);
    void J2DPane_NS_getNextChildPane(void);
    void J2DPane_NS_getPointer(void);
    void J2DPane_NS_initialize(void);
    void J2DPane_NS_initialize_X1_(void);
    void J2DPane_NS_initiate(void);
    void J2DPane_NS_insertChild(void);
    void J2DPane_NS_isUsed(void);
    void J2DPane_NS_isUsed_X1_(void);
    void J2DPane_NS_makePaneExStream(void);
    void J2DPane_NS_makePaneStream(void);
    void J2DPane_NS_place(void);
    void J2DPane_NS_resize(void);
    void J2DPane_NS_rotate_X1_(void);
    void J2DPane_NS_search(void);
    void J2DPane_NS_searchUserInfo(void);
    void J2DPane_NS_setAnimation_X6_(void);
    void J2DPane_NS_setAnimation_X7_(void);
    void J2DPane_NS_setCullBack(void);
    void J2DPane_NS_setInfluencedAlpha(void);
    void J2DPane_NS_setVisibileAnimation(void);
    void J2DPane_NS_setVtxColorAnimation(void);
    void J2DPane_NS_updateTransform(void);
    void J2DPane_X1_(void);
    void J2DPane_X2_(void);
    void J2DPane_X3_(void);
    void JSURandomInputStream_NS_align(void);
    void JSURandomInputStream_NS_peek(void);
    void JUTResReference_NS_getResource(void);
    void func_802F6F60(void);
    void func_802F6FB4(void);
    void func_802F7540(void);
