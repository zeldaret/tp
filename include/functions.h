...
void dStage_nextStage_c_NS_set(void);
...
void dStage_startStage_c_NS_set(void);
...
extern "C" {
    ...
    void dComIfG_get_timelayer(void);
    ...
    void dComIfG_play_c_NS_getTimerLimitTimeMs(void);
    void dComIfG_play_c_NS_getTimerNowTimeMs(void);
    void dComIfG_play_c_NS_getTimerPtr(void);
    void dComIfG_play_c_NS_getTimerType(void);
    void dComIfG_play_c_NS_itemInit(void);
    void dComIfG_play_c_NS_setStartStage(void);
    void dComIfG_play_c_NS_setTimerLimitTimeMs(void);
    void dComIfG_play_c_NS_setTimerMode(void);
    void dComIfG_play_c_NS_setTimerNowTimeMs(void);
    void dComIfG_play_c_NS_setTimerPtr(void);
    void dComIfG_play_c_NS_setTimerType(void);
    void dComIfG_play_c_NS_setWarpItemData(void);
    ...
    void dComIfGs_setLastWarpMarkItemData(void);
