...
void setLineID__11Z2FxLineMgrFScbb(void);
void setSceneFx__11Z2FxLineMgrFl(void);
void setUnderWaterFx__11Z2FxLineMgrFb(void);
}

#endif  // Z2FXLINEMGR_H_
