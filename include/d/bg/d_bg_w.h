...
public:
    ...
    /* 8007B958 */ virtual void ChkLock() const;
    /* 8007B964 */ virtual void ChkMoveBg() const;
    virtual void ChkMoveFlag() const = 0;
    /* 8007B270 */ virtual void GetTriPla(cBgS_PolyInfo const&) const;
    /* 8007B1B4 */ virtual void GetTriPnt(cBgS_PolyInfo const&, cXyz*, cXyz*, cXyz*) const;
    /* 8007B164 */ virtual void GetBnd() const;
    /* 8007B2B0 */ virtual void GetGrpInf(cBgS_PolyInfo const&) const;
    virtual void OffMoveFlag() = 0;
    /* 8007B240 */ virtual void GetTopUnder(f32*, f32*) const;
    /* 8007A658 */ virtual void LineCheck(cBgS_LinChk*);
    ...
    /* 8007B0E4 */ virtual void GetGrpRoomIndex(cBgS_PolyInfo const&) const;
...
public:
    ...
    /* 8007E4B4 */ virtual void ChkMoveFlag() const;
    ...
    /* 8007B3AC */ virtual void GetExitId(cBgS_PolyInfo const&);
    /* 8007B3D8 */ virtual void GetPolyColor(cBgS_PolyInfo const&);
    /* 8007B404 */ virtual void GetHorseNoEntry(cBgS_PolyInfo const&);
    /* 8007B430 */ virtual void GetSpecialCode(cBgS_PolyInfo const&);
    /* 8007B460 */ virtual void GetSpecialCode(int);
    /* 8007B488 */ virtual void GetMagnetCode(cBgS_PolyInfo const&);
    ...
    /* 8007B574 */ virtual void GetPolyHSStick(int);
    ...
    /* 8007B630 */ virtual void GetUnderwaterRoofCode(int);
    /* 8007B4B4 */ virtual void GetMonkeyBarsCode(cBgS_PolyInfo const&);
    /* 8007B6AC */ virtual void GetLinkNo(cBgS_PolyInfo const&);
    /* 8007B6D8 */ virtual void GetWallCode(cBgS_PolyInfo const&);
    /* 8007B704 */ virtual void GetPolyAtt0(cBgS_PolyInfo const&);
    /* 8007B734 */ virtual void GetPolyAtt1(cBgS_PolyInfo const&);
    /* 8007B760 */ virtual void GetGroundCode(cBgS_PolyInfo const&);
    /* 8007B7DC */ virtual void GetIronBallThrough(int);
    /* 8007B800 */ virtual void GetAttackThrough(int);
    /* 8007B87C */ virtual void GetCamMoveBG(cBgS_PolyInfo const&);
    /* 8007B8A8 */ virtual void GetRoomCamId(cBgS_PolyInfo const&);
    /* 8007B8D8 */ virtual void GetRoomPathId(cBgS_PolyInfo const&);
    /* 8007B904 */ virtual void GetRoomPathPntNo(cBgS_PolyInfo const&);
    /* 8007DF28 */ virtual void GetPolyGrpRoomInfId(cBgS_PolyInfo const&);
    /* 8007DF58 */ virtual void GetGrpSoundId(cBgS_PolyInfo const&);
