...
public:
    ...
    /* 0x1180 */ u32 mAppHamonAPrtcl;
    /* 0x1184 */ u32 mAppHamonIndPrtcl;
    /* 0x1188 */ u32 mMouthPrtcl1;
    /* 0x118C */ u32 mMouthPrtcl2;
    /* 0x1190 */ u32 mMouthPrtcl3;
    /* 0x1194 */ u32 field_0x1194[5];
    /* 0x11A8 */ u32 mDeadKareNeckPrtcls[12];
    ...
    /* 0x1228 */ u32 mWaterfallPrtcls[4];
    /* 0x1238 */ s16 mDemoMode;
    /* 0x123A */ s16 mDemoModeTimer;
    /* 0x123C */ u8 mBabaHandID;
    ...
    /* 0x127C */ cXyz mDemoCamEyeStep;
    /* 0x1288 */ cXyz mDemoCamCenterStep;
