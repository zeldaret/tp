...
public:
    ...
    /* 80B56980 */ void setAction(ActionFn);
...
private:
    ...
    /* 0x14E4 */ ActionFn mAction;
    /* 0x14f0 */ u8 field_0x14f0[0x1568 - 0x14f0];
    /* 0x1568 */ f32 field_0x1568;
    /* 0x156C */ u8 field_0x156c[0x1579 - 0x156c];
    /* 0x1579 */ u8 field_0x1579;
    /* 0x157A */ u8 field_0x157a;
    /* 0x157B */ u8 field_0x157b;
    /* 0x157C */ u8 field_0x157c[0x1581 - 0x157c];
    /* 0x1581 */ u8 field_0x1581;
    /* 0x1582 */ u8 field_0x1582[0x1588 - 0x1582];
