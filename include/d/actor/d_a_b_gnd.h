...
public:
    ...
    /* 0x05CC */ s16 mCurrentAngleYTarget;
    ...
    /* 0x0C5A */ s16 mUnkTimer;
    /* 0x0C5C */ s16 mHorseLegRot;
    /* 0x0C60 */ int field_0xc60;
    /* 0x0C64 */ int field_0xc64;
    /* 0x0C68 */ s16 mCurrentAngleYStep;
    /* 0x0C6A */ s16 mWBClodPrtclFlag;
    ...
    /* 0x0C79 */ u8 mDefSphFlag;
    /* 0x0C7A */ u8 mJumpFlag;
    /* 0x0C7B */ u8 mDefenseTypeFlag;
    ...
    /* 0x1FB8 */ cXyz mHorseBodySphCenter;
    ...
    /* 0x25BC */ u32 mHorseFrLeftFootPrtcl;
    /* 0x25C0 */ u32 mHorseFrRightFootPrtcl;
    /* 0x25C4 */ u32 mHorseBackRightFootPrtcl;
    /* 0x25C8 */ u32 mHorseBackLeftFootPrtcl;
    ...
    /* 0x25E4 */ u32 mRunWTraPrtcls[3];
    /* 0x25F0 */ u32 mLightBallPrtcls[6];
    /* 0x2608 */ u32 mLightBallPrtclMtx[5][6];
    /* 0x2680 */ u32 mTsubazeriPrtcls[2];
    /* 0x2688 */ u32 mDownSmokePrtcl;
    /* 0x268C */ u32 mBiriBiriPrtcls[3];
    /* 0x2698 */ u8 field_0x2698;
    /* 0x2699 */ u8 field_0x2699;
    /* 0x269C */ cXyz field_0x269c;
    /* 0x26A8 */ cXyz field_0x26a8[2];
    /* 0x26C0 */ s16 mGndLegRotX;
    /* 0x26C2 */ s16 mGndLegRotXTarget;
