...
public:
    ...
    /* 0x05BE */ u8 field_0x5be[0x5c0 - 0x5be];
    ...
    /* 0x08C0 */ u8 field_0x8c0[0x968 - 0x8c0];
    /* 0x0968 */ s8 field_0x968;
    /* 0x0969 */ u8 field_0x969[0x96c - 0x969];
    /* 0x096C */ f32 field_0x96c;
    /* 0x0970 */ s16 field_0x970;
    /* 0x0972 */ s16 mAction;
    /* 0x0974 */ s16 field_0x974;
    /* 0x0976 */ u8 field_0x976[2];
    ...
    /* 0x09C9 */ u8 field_0x9c9[0x9ca - 0x9c9];
    /* 0x09CA */ s16 field_0x9ca;
    /* 0x09CC */ s16 field_0x9cc;
    /* 0x09CE */ s16 field_0x9ce;
    /* 0x09D0 */ u8 field_0x9d0[0x9d4 - 0x9d0];
    ...
    /* 0x125D */ u8 field_0x125d;
    /* 0x125E */ u8 field_0x125e[0x1274 - 0x125e];
    ...
    /* 0x129C */ u8 field_0x129c;
    /* 0x129D */ u8 field_0x129d[0x12a0 - 0x129d];
    /* 0x12A0 */ int field_0x12a0;
    /* 0x12A4 */ s16 field_0x12a4;
    /* 0x12A6 */ u8 field_0x12a6[2];
    ...
    /* 0x12F0 */ u8 field_0x12f0[0x1304 - 0x12f0];
    /* 0x1304 */ u8 mBlureRate;
    /* 0x1305 */ u8 field_0x1305[0x130c - 0x1305];
