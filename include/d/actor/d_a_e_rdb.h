...
public:
    ...
    enum Animation {
        /* 0x04 */ ANM_HORN_RPLAY_RUN = 4,
        /* 0x05 */ ANM_HORN_RPLAY_STOP,
        /* 0x06 */ ANM_HORN_RPLAY_STOP2,
        /* 0x07 */ ANM_ATTACK01,
        /* 0x08 */ ANM_ATTACK02,
        /* 0x09 */ ANM_ATTACK03_END,
        /* 0x0A */ ANM_ATTACK03_SPIN,
        /* 0x0B */ ANM_ATTACK03_START,
        /* 0x0C */ ANM_DAMAGEBL,
        /* 0x0D */ ANM_DAMAGEBR,
        /* 0x0E */ ANM_DAMAGEF,
        /* 0x0F */ ANM_DAMAGEFL,
        /* 0x10 */ ANM_DAMAGEFR,
        /* 0x11 */ ANM_DOWN,
        /* 0x12 */ ANM_DOWN_RETURN,
        /* 0x13 */ ANM_DOWN_WAIT,
        /* 0x14 */ ANM_ED_DEMO_DOWN,
        /* 0x15 */ ANM_ED_DEMO_DOWNUP,
        /* 0x16 */ ANM_ED_DEMO_DOWNWAIT,
        /* 0x17 */ ANM_ED_DEMO_DOWNWALK,
        /* 0x18 */ ANM_FALL,
        /* 0x19 */ ANM_GUARD,
        /* 0x1A */ ANM_LV9_END01,
        /* 0x1B */ ANM_LV9_END02,
        ...
        /* 0x25 */ ANM_RDAMAGEL,
        /* 0x26 */ ANM_RDEAD,
        /* 0x27 */ ANM_RDEAD2_DAMAGE,
        /* 0x28 */ ANM_RDEAD2_FALL,
        /* 0x29 */ ANM_RDEAD2_RUN,
        /* 0x2A */ ANM_RDOWNB,
        /* 0x2B */ ANM_RDOWNB_RUN,
        /* 0x2C */ ANM_RDOWNB_UP,
        ...
        /* 0x32 */ ANM_RJUMP_C,
        /* 0x33 */ ANM_RNEIGH,
        /* 0x34 */ ANM_ROP_DEMO2_EXCITE,
        /* 0x35 */ ANM_ROP_DEMO2_WAIT,
        /* 0x36 */ ANM_RPLAY_RUNL,
        /* 0x37 */ ANM_RPLAY_RUNR,
        /* 0x38 */ ANM_RPLAY_STOP,
        /* 0x39 */ ANM_RPLAY_STOP2,
        /* 0x3A */ ANM_RRUN,
        /* 0x3B */ ANM_RSLIP,
        /* 0x3C */ ANM_RSTART,
        /* 0x3D */ ANM_RSTARTLOOP,
