...
class dMenu_ItemExplain_c : public dDlst_base_c {
public:
...
private:
    ...
    /* 0x28 */ int field_0x28[4];
    /* 0x38 */ CPaneMgr* mpInfoIcon;
    /* 0x3C */ CPaneMgr* mpParent[2];
    /* 0x44 */ int field_0x44[2];
    /* 0x4C */ CPaneMgr* mpLabel;
    /* 0x50 */ u8 field_0x50[0x60 - 0x50];
    /* 0x60 */ int field_0x60[3];
    ...
    /* 0x9C */ dMsgScrn3Select_c* field_0x9c;
