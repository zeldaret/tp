...
/* 80104FD8 00101F18  48 00 3F 8D */ bl daAlink_c_NS_cancelHookshotMove
/* 80104FDC 00101F1C  7F E3 FB 78 */ mr r3, r31
/* 80104FE0 00101F20  48 00 3A 39 */ bl daAlink_c_NS_checkHookshotWait
...
/* 80104FF0 00101F30  4B FB AD C1 */ bl daAlink_c_NS_checkZoraWearAbility
...
/* 80105004 00101F44  4B FA E2 4D */ bl daAlink_c_NS_setDoStatus
lbl_80105008:
...
/* 80105018 00101F58  4B FF D3 CD */ bl daAlink_c_NS_setSpeedAndAngleSwim
/* 8010501C 00101F5C  7F E3 FB 78 */ mr r3, r31
/* 80105020 00101F60  4B FF E6 79 */ bl daAlink_c_NS_setSwimMoveAnime
lbl_80105024:
/* 80105024 00101F64  7F E3 FB 78 */ mr r3, r31
/* 80105028 00101F68  4B FF E0 31 */ bl daAlink_c_NS_checkSwimUpAction
...
/* 80105040 00101F80  4B FF EE A1 */ bl daAlink_c_NS_checkSwimButtonAccept
...
/* 8010505C 00101F9C  4B FF F8 FD */ bl daAlink_c_NS_procSwimDiveInit
/* 80105060 00101FA0  48 00 01 28 */ b lbl_80105188
lbl_80105064:
/* 80105064 00101FA4  7F E3 FB 78 */ mr r3, r31
/* 80105068 00101FA8  4B FF EE A1 */ bl daAlink_c_NS_checkUpSwimButtonAccept
...
/* 8010508C 00101FCC  4B FF F5 E5 */ bl daAlink_c_NS_procSwimMoveInit
/* 80105090 00101FD0  48 00 00 F8 */ b lbl_80105188
lbl_80105094:
/* 80105094 00101FD4  7F E3 FB 78 */ mr r3, r31
/* 80105098 00101FD8  48 00 39 81 */ bl daAlink_c_NS_checkHookshotWait
...
/* 801050A8 00101FE8  48 00 39 41 */ bl daAlink_c_NS_checkBossOctaIealRoom
...
/* 801050BC 00101FFC  4B FA E6 79 */ bl daAlink_c_NS_setShapeAngleToAtnActor
lbl_801050C0:
/* 801050C0 00102000  7F E3 FB 78 */ mr r3, r31
/* 801050C4 00102004  4B FB 4C 69 */ bl daAlink_c_NS_checkNextActionFromButton
...
/* 80105108 00102048  4B FF F1 F1 */ bl daAlink_c_NS_procSwimWaitInit
/* 8010510C 0010204C  48 00 00 7C */ b lbl_80105188
lbl_80105110:
/* 80105110 00102050  7F E3 FB 78 */ mr r3, r31
/* 80105114 00102054  48 00 44 B5 */ bl daAlink_c_NS_checkNextActionHookshot
...
/* 80105124 00102064  4B FA E7 E1 */ bl daAlink_c_NS_checkZeroSpeedF
...
/* 80105150 00102090  48 00 38 C9 */ bl daAlink_c_NS_checkHookshotWait
...
/* 8010516C 001020AC  48 00 38 7D */ bl daAlink_c_NS_checkBossOctaIealRoom
...
/* 80105180 001020C0  4B FB 61 31 */ bl daAlink_c_NS_setBodyAngleXReadyAnime
lbl_80105184:
