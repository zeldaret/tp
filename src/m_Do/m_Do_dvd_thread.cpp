...
void mDoDvdThd_callback_c_NS_ctor(void);
void mDoDvdThd_callback_c_NS_create(void);
void mDoDvdThd_command_c_NS_ctor(void);
...
// mDoDvdThd_command_c::mDoDvdThd_command_c(void)
asm void mDoDvdThd_command_c_NS_ctor(void) {
    nofralloc
...
asm void mDoDvdThd_callback_c_NS_ctor(void) {
    nofralloc
...
asm mDoDvdThd_command_c* mDoDvdThd_callback_c::create(mDoDvdThd_callback_fn callback, void*) {
    nofralloc
