...
// @todo
asm void DynamicModuleControlBase::dump(void){nofralloc
...
JKRArchive* DynamicModuleControl::mountCallback(void*) {
    ...
    /* sFileCache */ lbl_80451148 =
        JKRFileCache::mount(/* "/rel/Final/Release" */ lbl_8039A580, heap, NULL);
    /* sArchive */ lbl_80451144 =
        JKRArchive::mount(/* "RELS.arc" */ lbl_8039A593, JKRArchive::MOUNT_COMP, heap,
