...
u32 dKyeff_Create(kankyo_class* kankyo_class_ptr) {
  ...
  if (strcmp_result == 0) {
    Time = OSGetTime();
    OSTicksToCalendarTime(Time,&CalendarTime);//CONCAT44(iVar1,(int)((ulonglong)OVar2 >> 0x20)),&CalendarTime);
    ...
    lbl_8042CA54.field_0x1244 = lbl_80453E6C * (CalendarTime.hours-lbl_80453E60);//(float)((double)CONCAT44(0x43300000,CalendarTime.hours ^ 0x80000000) - lbl_80453E60);
  }
  return 4;
}
#else
