...
void dScnKy_env_light_c::settingTevStruct_plightcol_plus(cXyz* param_0, dKy_tevstr_c* param_1,
    ...
    if (param_0 != NULL) {
        ...
        if (param_1->field_0x37a == 7 || param_1->field_0x37a == 1 || ((param_1->field_0x37a == 2 || param_1->field_0x37a == 6 || param_1->field_0x37a == 3) && dKy_darkworld_check()) || param_1->field_0x37a == 4 || param_1->field_0x37a == 5) {
            sp38 = -2;
        } else if (param_1->field_0x37a == 9 && dKy_darkworld_check()) {
            sp38 = -2;
        }
        ...
        if (sp44 == 0) {
            ...
            if ((sp38 <= -2 || (sp38 == -1 && dKy_Outdoor_check() == TRUE) || strcmp(dComIfGp_getStartStageName(), "D_MN09A") == 0)) {
                ...
                if (param_1->field_0x37a >= 1 && param_1->field_0x37a <= 9) {
                    dKyr_get_vectle_calc(&camera->lookat.center, &camera->lookat.eye, &camfwd);
                ...
                if (strcmp(dComIfGp_getStartStageName(), "D_MN09A") == 0) {
                    ...
                    } else if (dComIfG_play_c::getLayerNo(0) == 1 && param_1->field_0x37a == 0) {
                        field_0x10f8.r = 0x3C;
                        field_0x10f8.g = 0x5F;
                        field_0x10f8.b = 0x64;
                        spE8.y += -800.0f;
                ...
                case 9:
                    ...
                    break;
                case 7:
                    f32 sp34 = param_1->mFogColor.a / 255.0f;
                    field_0x10f8.r = 180;
                    field_0x10f8.g = 180;
                    field_0x10f8.b = 180;
                    var_f29 = 90.0f;
        ...
        if ((param_1->field_0x37a != 10 && param_1->field_0x37a != 9) || param_1->field_0x378 != 0) {
        ...
        if (dKy_shadow_mode_check(4) == 0) {
            if ((param_1->field_0x37a == 9 || param_1->field_0x37a == 10) && (player->getSinkShapeOffset() < -20.0f || player->checkSinkDead() || dKy_camera_water_in_status_check() || !player->checkSwimUp())) {
            ...
            if ((param_1->field_0x37a == 9 || param_1->field_0x37a == 10) && (player->checkSinkDead() || dComIfGp_checkPlayerStatus0(0, 0x02000308) || dComIfGp_checkPlayerStatus1(0, 0x02000000) || player->checkMagneBootsOn())) {
                cLib_addCalc(&param_1->field_0x344, 0.0f, 0.75f, 0.21f, 0.0001f);
            } else if (param_1->field_0x37a == 9 && player->getSinkShapeOffset() < -35.0f) {
                cLib_addCalc(&param_1->field_0x344, 0.0f, 0.1f, 0.001f, 0.00001f);
            } else if (param_1->field_0x37a == 10 && player->getSinkShapeOffset() < -100.0f) {
                cLib_addCalc(&param_1->field_0x344, 0.0f, 0.1f, 0.001f, 0.00001f);
            } else if (param_4 != 0) {
...
void dScnKy_env_light_c::settingTevStruct(int i_tevstrType, cXyz* param_1, dKy_tevstr_c* i_tevstr) {
    ...
    if (i_tevstrType == 14) {
        ...
        i_tevstr->field_0x360.r = 0;
        i_tevstr->field_0x360.g = 0;
        i_tevstr->field_0x360.b = 0;
        i_tevstr->field_0x360.a = 0;
        i_tevstr->mLightMode = 0;
...
static void setLightTevColorType_MAJI_sub(J3DMaterial* param_0, dKy_tevstr_c* tevstr,
                                          int param_2) {
    dScnKy_env_light_c* kankyo = dKy_getEnvlight();
    ...
    if (tevstr != NULL) {
        ...
        if (((tevstr->field_0x37a >= 1 && tevstr->field_0x37a <= 7) || tevstr->field_0x37a == 5 || tevstr->field_0x37a == 15 || (tevstr->field_0x37a == 9 && dKy_darkworld_check())) && ((tevstr->field_0x37a != 2 && tevstr->field_0x37a != 3) || dKy_darkworld_check())) {
            sp18.r = 0;
            sp18.g = 0;
            sp18.b = 0;
            sp18.a = 0;

            if (tevstr->field_0x37a == 7) {
                sp18.a = 4;
            }

            if (tevstr->field_0x37a == 3) {
                sp18.r = 12;
                sp18.g = 12;
                sp18.b = 12;
            } else if (tevstr->field_0x37a == 6) {
            ...
            } else if (tevstr->field_0x37a == 2) {
                sp18.r = 0x12;
                sp18.g = 0x12;
                sp18.b = 0x12;
            } else if (tevstr->field_0x37a == 4) {
                sp18.r = 0xFF;
                sp18.g = 0x33;
                sp18.b = 0xB;
            } else if (tevstr->field_0x37a == 5) {
                sp18.r = 0xA;
                sp18.g = 0xA;
                sp18.b = 8;
            } else if (tevstr->field_0x37a == 15) {
                sp18.r = 0x19;
                sp18.g = 0x1E;
                sp18.b = 0x23;
            }
        ...
        param_0->setAmbColor(0, &sp18);

        if (param_2 != 0) {
            param_0->setTevColor(0, (J3DGXColorS10*)&tevstr->mFogColor);
            param_0->setTevKColor(0, (J3DGXColor*)&tevstr->field_0x360);
        }
        ...
        param_0->setLight(0, &tevstr->mLightObj);

        if (sp1C != NULL) {
            if (param_2 != 2) {
                for (int i = 0; i < 6; i++) {
                    param_0->setLight(i + 2, &tevstr->mLights[i]);
                }
                ...
                for (int i = 0; i < 6; i++) {
                    if (i <= 1) {
                        ...
                        param_0->setLight(i + 2, &kankyo->field_0xf50[i].field_0x0);
                    } else {
                        param_0->setLight(i + 2, &tevstr->mLights[i]);
                    }
                }
        ...
        if (param_0->getFog() != NULL) {
            J3DFogInfo* fog_info = param_0->getFog()->getFogInfo();
            if (fog_info->mType != 0) {
                ...
                if (fog_info->mType == 7) {
                    ...
                    fog_info->mColor.r = tevstr->mColorK0.r;
                    fog_info->mColor.g = tevstr->mColorK0.g;
                    fog_info->mColor.b = tevstr->mColorK0.b;
                }
...
f32 dKy_move_room_ratio(dKy_tevstr_c* param_0, s8* param_1) {
    ...
    if (memcmp(dComIfGp_getStartStageName(), "D_MN", 4) == 0 && g_env_light.mColPatMode == 0 && g_env_light.mColPatModeGather == 0 && param_0->mColpatBlend > 0.0f && param_0->mColpatBlend < 1.0f) {
        if (param_0->mColpatBlend < 0.5f) {
            if (param_0->mEnvrIdxOverride == 0xFF) {
                *param_1 = param_0->mEnvrIdxPrev;
                var_f31 = fabsf(2.0f * (0.5f - param_0->mColpatBlend));
            } else {
                *param_1 = param_0->mRoomNo;
                var_f31 = fabsf(2.0f * (param_0->mColpatBlend - 0.5f));
            }
        } else {
            *param_1 = param_0->mRoomNo;
            var_f31 = fabsf(2.0f * (param_0->mColpatBlend - 0.5f));
...
void dKy_setLight_nowroom_actor(dKy_tevstr_c* tevstr) {
    ...
    s8 room_no = tevstr->mRoomNo;
    f32 var_f31 = 1.0f;

    if (tevstr->field_0x37a == 9 || tevstr->field_0x37a == 10) {
        var_f31 = dKy_move_room_ratio(tevstr, &room_no);
    }

    if (tevstr->field_0x37a == 14 || tevstr->field_0x37a == 12 || tevstr->field_0x37a == 13) {
        return;
    }
...
void dKy_GxFog_tevstr_set(dKy_tevstr_c* param_0) {
    ...
    GXColor color;
    color.r = param_0->mColorK0.r;
    color.g = param_0->mColorK0.g;
    color.b = param_0->mColorK0.b;
...
static void dKy_murky_set(J3DMaterial* material_p) {
    ...
    sp54.r = g_env_light.mTerrainAmbienceBG[1].r;
    sp54.g = g_env_light.mTerrainAmbienceBG[1].g;
    sp54.b = g_env_light.mTerrainAmbienceBG[1].b;
    sp54.a = g_env_light.mTerrainAmbienceBG[2].a;

    sp58.a = g_env_light.mTerrainAmbienceBG[1].a;
    ...
    if (sunlenzPkt_p != NULL && sunPkt_p->mVisibility > 1E-06f) {
        sp54.a *= 1.0f - sunPkt_p->mVisibility *
                             (1.0f - sunlenzPkt_p->mDistFalloff * sunlenzPkt_p->mDistFalloff *
                                         sunlenzPkt_p->mDistFalloff);
    }
    ...
    if (strcmp(dComIfGp_getStartStageName(), "D_MN05A") == 0) {
        ...
        if (camera_p != NULL && camera_p->lookat.eye.z < 1800.0f) {
            if (camera_p->lookat.eye.z < 1550.0f) {
                ...
                var_f0 = 1.0f - ((camera_p->lookat.eye.z - 1550.0f) / 250.0f);
            }
...
// NONMATCHING - stack / couple instructions at the end
        ...
        for (u16 i = 0; i < modelData->getMaterialNum(); i++) {
            ...
            if (mat_name[3] == 'M' && mat_name[4] == 'A') {
                    ...
                    if (mat_p->getFog() != NULL) {
                        ...
                        if (fog_info_p != NULL) {
                            if (mat_name[5] == '0' && mat_name[6] == '9') {
                                ...
                                J3DGXColorS10 color;
                                J3DGXColor k_color;
                                color.r = g_env_light.mTerrainAmbienceBG[2].r;
                                color.g = g_env_light.mTerrainAmbienceBG[2].g;
                                color.b = g_env_light.mTerrainAmbienceBG[2].b;
                                color.a = g_env_light.mTerrainAmbienceBG[2].a;

                                k_color.a = g_env_light.mTerrainAmbienceBG[1].a;
                                k_color.r = 0;
                                k_color.g = 0;
                                k_color.b = 0;
                ...
                if (memcmp(&mat_name[3], "MA07", 4) == 0) {
                    J3DGXColorS10 color;
                    color.r = (u8)(g_env_light.mThunderEff.mFlashTimer * 100.0f);
                    color.g = (u8)(g_env_light.mThunderEff.mFlashTimer * 100.0f);
                    color.b = (u8)(g_env_light.mThunderEff.mFlashTimer * 100.0f);
                    color.a = 255;
                ...
                if (memcmp(&mat_name[3], "MA10", 4) == 0 || memcmp(&mat_name[3], "MA02", 4) == 0) {
                    ...
                    if (mat_p->getTexGenBlock()->getTexMtx(0) != NULL) {
                        ...
                        if (tex_mtx_inf != NULL) {
                            ...
                            Mtx sp170;
                            if (mat_name[6] == '2') {
                                C_MTXLightPerspective(sp170, dComIfGd_getView()->fovy,
                ...
                if (memcmp(&mat_name[3], "MA11", 4) == 0) {
                    ...
                    if (mat_p->getFog() != NULL) {
                        ...
                        J3DGXColorS10 sp3C;
                        sp3C.r = g_env_light.mTerrainAmbienceBG[3].r;
                        sp3C.g = g_env_light.mTerrainAmbienceBG[3].g;
                        sp3C.b = g_env_light.mTerrainAmbienceBG[3].b;
                        sp3C.a = 255;
                    ...
                    J3DGXColorS10 color;
                    color.r = g_env_light.mTerrainAmbienceBG[3].r;
                    color.g = g_env_light.mTerrainAmbienceBG[3].g;
                    color.b = g_env_light.mTerrainAmbienceBG[3].b;
                    color.a = g_env_light.mTerrainAmbienceBG[3].a;
                    mat_p->setTevColor(1, &color);
                    ...
                    k_color.g = 0;
                    k_color.b = 0;
                    k_color.a = g_env_light.mTerrainAmbienceBG[3].a;
                    mat_p->setTevKColor(3, &k_color);
                } else if (memcmp(&mat_name[3], "MA16", 4) == 0) {
                    J3DGXColorS10 color;
                    J3DGXColor k_color;
                    color.r = g_env_light.mTerrainAmbienceBG[1].r;
                    color.g = g_env_light.mTerrainAmbienceBG[1].g;
                    color.b = g_env_light.mTerrainAmbienceBG[1].b;
                    color.a = g_env_light.mTerrainAmbienceBG[1].a;
                    mat_p->setTevColor(1, &color);
            ...
            if (memcmp(&mat_name[3], "Rainbow", 7) == 0) {
                ...
                cXyz sp5C;
                sp5C.x = -5853.0f;
                sp5C.y = temp_r16_2->lookat.eye.y;
                sp5C.z = -879.0f;

                f32 var_f1 = sp5C.abs(temp_r16_2->lookat.eye);
                ...
                sp5C = temp_r16_2->lookat.center;
                sp5C.y = temp_r16_2->lookat.eye.y;
                dKyr_get_vectle_calc(&temp_r16_2->lookat.eye, &sp5C, &sp68);
