...
void drawDoor2();
	/* 800405FC */ // True False
//  stage_tgsc_data_class const* False
// 	 stage_tgsc_data_class const False
// 		 stage_tgsc_data_class False
//  int False
//  bool False
...
//  int False
//  f32 False
void checkDispDoorS(int, int, f32);
	/* 80040838 */ // True False
//  stage_tgsc_data_class const* False
// 	 stage_tgsc_data_class const False
// 		 stage_tgsc_data_class False
...
//  f32 False
//  int False
void calcFloorNoForObjectByMapPathRend(f32, int) const;
...
void getRoomNoSingle();
	/* 8003FFF4 */ // True False
void getFirstDrawRoomNo();
	/* 80040094 */ // True False
//  int False
void getNextDrawRoomNo(int);
...
void correctionOriginPos(s8, Vec*);
	/* 8003EDC0 */ // True False
//  dStage_FileList2_dt_c const* False
// 	 dStage_FileList2_dt_c const False
// 		 dStage_FileList2_dt_c False
//  Vec* False
// 	 Vec False
void offsetPlus(dStage_FileList2_dt_c const*, Vec*);
	/* 8003EDEC */ // True False
//  dStage_FileList2_dt_c const* False
// 	 dStage_FileList2_dt_c const False
// 		 dStage_FileList2_dt_c False
...
//  f32* False
// 	 f32 False
void getFloorParameter(f32, s8*, f32*, f32*, f32*, f32*);
};
...
__declspec(section ".ctors$15") void* const _ctors_80041460 = (void*)__sinit_d_map_path_dmap_cpp;
#pragma pop
