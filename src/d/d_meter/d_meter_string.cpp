...
void dTimer_createTimer__FlUlUcUcffff(void);
...
asm void __ct__14dMeterString_cFi(void) {
    nofralloc
...
asm void __dt__14dMeterString_cFv(void) {
    nofralloc
...
asm void _create__14dMeterString_cFv(void) {
    nofralloc
...
asm void _execute__14dMeterString_cFUl(void) {
    nofralloc
...
asm void draw__14dMeterString_cFv(void) {
    nofralloc
...
asm void _delete__14dMeterString_cFv(void) {
    nofralloc
