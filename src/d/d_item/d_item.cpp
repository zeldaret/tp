...
void item_func_SWORD(void) {
    g_dComIfG_gameInfo.save_file.getPlayer().getPlayerCollect().setCollect(SWORD_BITFIELD,
                                                                           ORDON_SWORD_FLAG);
...
void item_func_WOOD_SHIELD(void) {
    g_dComIfG_gameInfo.save_file.getPlayer().getPlayerCollect().setCollect(SHIELD_BITFIELD,
                                                                           ORDON_SHIELD_FLAG);
...
void item_getcheck_func_SWORD(void) {
    g_dComIfG_gameInfo.save_file.getPlayer().getPlayerCollect().isCollect(SWORD_BITFIELD,
                                                                          ORDON_SWORD_FLAG);
}
...
void item_getcheck_func_WEAR_KOKIRI(void) {
    g_dComIfG_gameInfo.save_file.getPlayer().getPlayerCollect().isCollect(CLOTHING_BITFIELD,
                                                                          HEROS_CLOTHES_FLAG);
}
...
int item_getcheck_func_EMPTY_BOTTLE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(EMPTY_BOTTLE);
    return bottle_check;
}
...
int item_getcheck_func_GREEN_BOTTLE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(GREEN_BOTTLE);
    return bottle_check;
}
...
int item_getcheck_func_BLUE_BOTTLE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(BLUE_BOTTLE);
    return bottle_check;
}
...
int item_getcheck_func_MILK_BOTTLE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(MILK_BOTTLE);
    return bottle_check;
}
...
int item_getcheck_func_HALF_MILK_BOTTLE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(HALF_MILK_BOTTLE);
    return bottle_check;
}
...
int item_getcheck_func_WATER_BOTTLE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(WATER_BOTTLE);
    return bottle_check;
}
...
int item_getcheck_func_OIL_BOTTLE2(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(OIL_BOTTLE_2);
    return bottle_check;
}
...
int item_getcheck_func_RED_BOTTLE2(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(RED_BOTTLE_2);
    return bottle_check;
}
...
int item_getcheck_func_CHUCHU_RARE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(CHUCHU_RARE);
    return bottle_check;
}
...
int item_getcheck_func_CHUCHU_BLUE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(CHUCHU_BLUE);
    return bottle_check;
}
...
int item_getcheck_func_CHUCHU_GREEN(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(CHUCHU_GREEN);
    return bottle_check;
}
...
int item_getcheck_func_CHUCHU_YELLOW(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(CHUCHU_YELLOW);
    return bottle_check;
}
...
int item_getcheck_func_CHUCHU_PURPLE(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(CHUCHU_PURPLE);
    return bottle_check;
}
...
int item_getcheck_func_CHUCHU_YELLOW2(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(CHUCHU_YELLOW2);
    return bottle_check;
}
...
int item_getcheck_func_CHUCHU_BLACK(void) {
    ...
    bottle_check =
        g_dComIfG_gameInfo.save_file.getPlayer().getPlayerItem().checkBottle(CHUCHU_BLACK);
    return bottle_check;
}
