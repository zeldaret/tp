...
void renderingDmap_c::hasMap() const {
    // NONMATCHING
}
...
void renderingDmap_c::isDrawIconSingle2(dTres_c::data_s const* param_0, bool param_1,
...
void renderingDmap_c::getPlayerCursorSize() {
    // NONMATCHING
}
...
void renderingDmap_c::getLineWidthZoomBig(int param_0) {
    // NONMATCHING
}
 ...
 */
void renderingDmap_c::getLineWidthZoomSmall(int param_0) {
    // NONMATCHING
}
 ...
 */
void renderingDmap_c::getLineWidth(int param_0) {
    // NONMATCHING
}
...
void renderingDmap_c::getColor(int param_0) {
    // NONMATCHING
}
...
void dMenu_StageMapCtrl_c::getPlayerDrawInfo(f32* param_0, f32* param_1, s16* param_2) const {
    // NONMATCHING
}

/* 801C1218-801C12A8 1BBB58 0090+00 0/0 1/1 0/0 .text
 * getRestartDrawInfo__20dMenu_StageMapCtrl_cCFPfPfPs           */
s8 dMenu_StageMapCtrl_c::getRestartDrawInfo(f32* param_0, f32* param_1, s16* param_2) const {
    // NONMATCHING
}
 ...
 */
void dMenu_DmapMapCtrl_c::getZoomCmPerPixel() {
    // NONMATCHING
}
 ...
 */
void dMenu_DmapMapCtrl_c::isEnableZoomMove() const {
    // NONMATCHING
}
...
void renderingDmap_c::getRestartCursorSize() {
    // NONMATCHING
}
