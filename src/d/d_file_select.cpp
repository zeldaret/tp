...
#else
dFile_select_c::dFile_select_c(JKRArchive* param_0) {
    // NONMATCHING
}
#endif
...
// void J2DTextBox::setWhite(JUtility::TColor param_0) {
extern "C" void setWhite__10J2DTextBoxFQ28JUtility6TColor() {
    // NONMATCHING
}
...
void dFile_select_c::screenSet() {
    ...
    ((J2DTextBox*)field_0x0240->getPanePtr())->setFont(mpMessageFont[0]);
    ((J2DTextBox*)field_0x0244->getPanePtr())->setFont(mpMessageFont[0]);
    ...
    for (int i = 0; i < 2; i++) {
        ...
        ((J2DTextBox*)field_0x020c[i]->getPanePtr())->setFont(mpMessageFont[0]);
    ...
    for (int i = 0; i < 2; i++) {
        ...
        ((J2DTextBox*)field_0x0138[i]->getPanePtr())->setFont(mpMessageFont[0]);
...
bool J2DPicture::setBlackWhite(JUtility::TColor param_0, JUtility::TColor param_1) {
    // NONMATCHING
}
...
void dFile_select3D_c::createMaskModel() {
    ...
    setJ3D("md_mask_UI.bmd", (const char*)bck_name_8683[mMaskIdx - 1], (const char*)brk_name_8684[mMaskIdx - 1]);
    switch (mMaskIdx) {
    case 1:
...
void dFile_select3D_c::createMirrorModel() {
    ...
    setJ3D("kageri_mirrer_UI.bmd", (const char*)bck_name_8786[mMirrorIdx - 1], (const char*)brk_name_8787[mMirrorIdx - 1]);
    switch (mMirrorIdx) {
    case 1:
