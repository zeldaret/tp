...
struct dTres_c {
	...
	/* 8009BBD8 */ // False False
void createWork();
	/* 8009BC18 */ // False False
void create();
	/* 8009BC60 */ // False False
void remove();
	/* 8009BC6C */ // True False
void reset();
...
// 	 dTres_c::data_s False
void checkTreasureBox(dTres_c::data_s*);
...
void getNextData(dTres_c::typeGroupData_c*);
	/* 8009C3B4 */ // False False
//  dTres_c::typeGroupData_c const* False
// 	 dTres_c::typeGroupData_c const False
// 		 dTres_c::typeGroupData_c False
void getNextData(dTres_c::typeGroupData_c const*);
...
struct dMapInfo_n {
	/* 8003ED60 */ // False False
//  s8 False
//  Vec* False
// 	 Vec False
void correctionOriginPos(s8, Vec*);
};

struct dMapInfo_c {
	/* 8003F40C */ // False False
//  f32 False
//  bool False
//  int False
void calcFloorNo(f32, bool, int);
};
