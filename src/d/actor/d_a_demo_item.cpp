...
void daDitem_c::onEventReg(int param_0, int param_1) {
    // NONMATCHING
}
...
static void daDitem_Delete(daDitem_c* param_0) {
    // NONMATCHING
}
...
static void daDitem_Create(daDitem_c* param_0) {
    // NONMATCHING
}
...
static void daDitem_Execute(daDitem_c* param_0) {
    // NONMATCHING
}

/* 804E1878-804E18CC 001D98 0054+00 1/0 0/0 0/0 .text            daDitem_Draw__FP9daDitem_c */
static void daDitem_Draw(daDitem_c* param_0) {
    // NONMATCHING
}
...
void __sinit_d_a_demo_item_cpp() {
    // NONMATCHING
}
