...
static void daB_DRE_Create(fopAc_ac_c* param_0) {
    // NONMATCHING
}
...
static void daB_DRE_Draw(daB_DRE_c* param_0) {
    // NONMATCHING
}

/* 805CA924-805CA944 002EE4 0020+00 2/1 0/0 0/0 .text            daB_DRE_Execute__FP9daB_DRE_c */
static void daB_DRE_Execute(daB_DRE_c* param_0) {
    // NONMATCHING
}
