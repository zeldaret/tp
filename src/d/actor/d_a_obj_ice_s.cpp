 ...
 */
void daObjIce_s_c::RideOn_Angle(s16& param_0, f32 param_1, s16 param_2, f32 param_3) {
    // NONMATCHING
}
...
void daObjIce_s_c::Check_LinkRideOn(cXyz param_0) {
    // NONMATCHING
}
 ...
 */
void daObjIce_s_c::Check_RideOn(cXyz param_0) {
    // NONMATCHING
}
 ...
 */
static void daObjIce_s_Draw(daObjIce_s_c* param_0) {
    // NONMATCHING
}

/* 80C21260-80C21280 0009A0 0020+00 1/0 0/0 0/0 .text daObjIce_s_Execute__FP12daObjIce_s_c */
static void daObjIce_s_Execute(daObjIce_s_c* param_0) {
    // NONMATCHING
}
 ...
 */
static void daObjIce_s_Delete(daObjIce_s_c* param_0) {
    // NONMATCHING
}

/* 80C212AC-80C212CC 0009EC 0020+00 1/0 0/0 0/0 .text            daObjIce_s_Create__FP10fopAc_ac_c
 */
static void daObjIce_s_Create(fopAc_ac_c* param_0) {
    // NONMATCHING
}
