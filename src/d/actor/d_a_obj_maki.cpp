 ...
 */
int daObj_Maki_Draw(obj_maki_class* param_0) {
    ...
    if(param_0->field_0x57e == 0){
        ...
        if(isHit){
            ...
            for(int i = 0; i < 2; i++){
                ...
                dComIfGp_particle_set(eff_id[i],&param_0->current.pos,&param_0->tevStr,&param_0->shape_angle,0);
            }
...
int daObj_Maki_Delete(obj_maki_class* param_0) {
...
int useHeapInit(fopAc_ac_c* param_0) {
...
cPhs__Step daObj_Maki_Create(fopAc_ac_c* param_0) {
...
actor_method_class l_daObj_Maki_Method = {
    (process_method_func)daObj_Maki_Create,
    (process_method_func)daObj_Maki_Delete,
    (process_method_func)daObj_Maki_Execute,
    (process_method_func)daObj_Maki_IsDelete,
