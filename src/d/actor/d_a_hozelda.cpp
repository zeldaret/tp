 ...
 */
void daHoZelda_matAnm_c::calc(J3DMaterial* param_0) const {
    // NONMATCHING
}
...
void daHoZelda_c::modelCallBack(u16 param_0) {
    // NONMATCHING
}
...
void daHoZelda_c::setDoubleAnime(f32 param_0, f32 param_1, f32 param_2, u16 param_3,
...
void daHoZelda_c::setUpperAnime(u16 param_0) {
    // NONMATCHING
}
...
void daHoZelda_c::setSingleAnime(u16 param_0, f32 param_1, f32 param_2, s16 param_3,
                                     f32 param_4) {
    // NONMATCHING
}
...
void daHoZelda_c::setEyeBtp(u16 param_0) {
    // NONMATCHING
}

/* 808475F0-80847670 0017D0 0080+00 2/2 0/0 0/0 .text            setEyeBtk__11daHoZelda_cFUsUc */
void daHoZelda_c::setEyeBtk(u16 param_0, u8 param_1) {
    // NONMATCHING
}
...
void daHoZelda_c::setBowBck(u16 param_0) {
    // NONMATCHING
}
 ...
 */
extern "C" void func_80848CE0(void* _this, Vec const& param_0, f32 const (&param_1)[3][4]) {
    // NONMATCHING
}
...
extern "C" void func_80848D38(void* _this, u8* param_0) {
    // NONMATCHING
}

/* 80848D54-80848E34 002F34 00E0+00 1/0 0/0 0/0 .text            __dt__18daHoZelda_matAnm_cFv */
daHoZelda_matAnm_c::~daHoZelda_matAnm_c() {
    // NONMATCHING
}