...
int daNpc_Kolin_c::cutNoRide(int param_0) {
    // NONMATCHING
}
...
int daNpc_Kolin_c::cutHail(int param_0) {
    // NONMATCHING
}
 ...
 */
int daNpc_Kolin_c::cutGiveMeWoodSwd(int param_0) {
    // NONMATCHING
}
...
int daNpc_Kolin_c::cutGetWoodSwd(int param_0) {
    // NONMATCHING
}
