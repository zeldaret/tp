...
static void anm_init(e_tk2_class* param_0, int param_1, f32 param_2, u8 param_3, f32 param_4) {
    // NONMATCHING
}

/* 807BA660-807BA6D0 0001E0 0070+00 1/0 0/0 0/0 .text            daE_TK2_Draw__FP11e_tk2_class */
static void daE_TK2_Draw(e_tk2_class* param_0) {
    // NONMATCHING
}
 ...
 */
static void other_bg_check(e_tk2_class* param_0, fopAc_ac_c* param_1) {
    // NONMATCHING
}

/* 807BA7A8-807BA824 000328 007C+00 2/2 0/0 0/0 .text            pl_check__FP11e_tk2_classfs */
static void pl_check(e_tk2_class* param_0, f32 param_1, s16 param_2) {
    // NONMATCHING
}

/* 807BA824-807BA940 0003A4 011C+00 1/1 0/0 0/0 .text            damage_check__FP11e_tk2_class */
static void damage_check(e_tk2_class* param_0) {
    // NONMATCHING
}
...
static void e_tk2_wait_0(e_tk2_class* param_0) {
    // NONMATCHING
}
...
static void e_tk2_find(e_tk2_class* param_0) {
    // NONMATCHING
}
...
static void daE_TK2_Execute(e_tk2_class* param_0) {
    // NONMATCHING
}
...
static void daE_TK2_Delete(e_tk2_class* param_0) {
    // NONMATCHING
}
...
static void daE_TK2_Create(fopAc_ac_c* param_0) {
    // NONMATCHING
}
