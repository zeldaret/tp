...
int daDoor20_c::CreateHeap() {
    ...
    if (kind == 9) {
        ...
        if (!field_0x584.init(anm, 1, J3DFrameCtrl::EMode_NONE, 1.0f, 0, -1, false)) {
            return 0;
        }
        ...
        if (!field_0x5a0.init(anm, 1, J3DFrameCtrl::EMode_NONE, 1.0f, 0, -1, false)) {
            return 0;
        }
        ...
        JUT_ASSERT(375, anm != NULL);
        if (field_0x584.init(anm, 1, J3DFrameCtrl::EMode_NONE, 1.0f, 0, -1, false) == 0) {
            return 0;
        }
...
void daDoor20_c::setEventPrm() {
    ...
    u32 roomNo = FRoomNo == dComIfGp_roomControl_getStayNo() ? BRoomNo : FRoomNo;
...
int daDoor20_c::adjustmentAngle() {
    ...
    cLib_addCalcAngleS2(&angle, shape_angle.y + 0x7fff, 5, 3000);
...
void daDoor20_c::openInit_0() {
    static u16 const l_eff_id_lv3[5] = {
        dPa_RM(ID_ZF_S_LV3SLIDEDOOROPEN00SMK),
        dPa_RM(ID_ZF_S_LV3SLIDEDOOROPEN01SMK),
        dPa_RM(ID_ZF_S_LV3SLIDEDOOROPEN02SMK),
        dPa_RM(ID_ZF_S_LV3SLIDEDOOROPEN03ROCK),
        dPa_RM(ID_ZF_S_LV3SLIDEDOOROPEN04DUST),
    };

    static u16 const l_eff_id_lv4[5] = {
        dPa_RM(ID_ZF_S_LV4SLIDEDOOROPEN00SMK),
        dPa_RM(ID_ZF_S_LV4SLIDEDOOROPEN01SMK),
        dPa_RM(ID_ZF_S_LV4SLIDEDOOROPEN02SMK),
        dPa_RM(ID_ZF_S_LV4SLIDEDOOROPEN03ROCK),
        dPa_RM(ID_ZF_S_LV4SLIDEDOOROPEN04DUST),
    };
    ...
    } else if (door_param2_c::getKind(this) == 10) {
        anm = (J3DAnmTransform*)dComIfG_getObjectRes(getArcName(), "oj_DoorOpF.bck");
    } else {
        anm = (J3DAnmTransform*)dComIfG_getObjectRes(getArcName(), "oj_DoorOpD.bck");
    }
...
void daDoor20_c::openInit_1() {
    ...
    if (!field_0x584.init(anm, 1, J3DFrameCtrl::EMode_NONE, 1.0f, 0, -1, true)) {
        JUT_ASSERT(918, FALSE);
    }

    u8 swBit = door_param2_c::getSwbit3(this);
    if (swBit != 0xFF && !fopAcM_isSwitch(this, swBit)) {
        static u16 const l_eff_id[2] = {dPa_RM(ID_ZM_S_MDDOOROPENDUST00), dPa_RM(ID_ZM_S_MDDOOROPENDUST01)};
        for (int i = 0; i < 2; i++) {
...
int daDoor20_c::openProc(int param_1) {
    ...
    case 1:
        if (field_0x584.getFrame() == 17.0f) {
            dComIfGp_getVibration().StartShock(VIBMODE_S_POWER4, 15, cXyz(0.0f, 1.0f, 0.0f));
        } else if (field_0x584.getFrame() == 18.0f) {
            if (daPy_py_c::checkNowWolf()) {
                #if DEBUG
                sfx = field_0x672 ? Z2SE_OBJ_WOOD_DR_OP_MDN_FX : Z2SE_OBJ_WOOD_DR_OP_MDN;
                #else
                u32 mdnfx;
                if (field_0x672) {
                ...
                sfx = field_0x672 ? Z2SE_OBJ_WOOD_DOOR_ROLLOPEN : Z2SE_OBJ_WOOD_DOOR_ROLLOPEN2;
            }
    ...
    case 12:
    default:
        if ((door_param2_c::getKind(this) == 0 || door_param2_c::getKind(this) == 10) && field_0x584.getFrame() == 17.0f) {
            dComIfGp_getVibration().StartShock(VIBMODE_S_POWER4, 15, cXyz(0.0f, 1.0f, 0.0f));
        }
        ...
        } else if (field_0x584.getFrame() == 20.0f || (frame < 20.0f && field_0x584.getFrame() >= 20.0f)) {
            if (door_param2_c::getKind(this) == 2) {
                sfx = Z2SE_OBJ_L8_SHTR_OP;
            } else if (door_param2_c::getKind(this) == 10) {
                sfx = Z2SE_OBJ_LV9_SHTR_OP;
...
void daDoor20_c::closeInit_0() {
    ...
    if (door_param2_c::getKind(this) != 10) {
        dComIfGp_particle_setPolyColor(dPa_RM(ID_ZI_S_SHUTTERSMOKE_B), mBgc.m_gnd, &current.pos, &tevStr,
...
void daDoor20_c::closeInit_1() {
    J3DAnmTransform* anm = (J3DAnmTransform*)dComIfG_getObjectRes(getArcName(), "oj_DoorCloseC.bck");
    JUT_ASSERT(1236, anm != NULL);

    if (!field_0x584.init(anm, 1, J3DFrameCtrl::EMode_NONE, 1.0f, 0, -1, true)) {
        JUT_ASSERT(1239, FALSE);
    }
...
int daDoor20_c::create() {
    ...
    int phase = dComIfG_resLoad(&mPhase1, getAlwaysArcName());
    if (phase != cPhs_COMPLEATE_e) {
        return phase;
    }

    if (getArcName() != NULL) {
        phase = dComIfG_resLoad(&mPhase2, getArcName());
        if (phase != cPhs_COMPLEATE_e) {
            return phase;
        }
    }
    ...
    u32 i_size = 0x80000000;
    i_size |= 0x3800;
    if (!fopAcM_entrySolidHeap(this, CheckCreateHeap, i_size)) {
        phase = cPhs_ERROR_e;
    } else {
        CreateInit();
...
int daDoor20_c::demoProc() {
    ...
    if (dComIfGp_evmng_getIsAddvance(field_0x6cc)) {
        ...
        case 13:
            J3DAnmTransform* anm = (J3DAnmTransform*)dComIfG_getObjectRes(getAlwaysArcName(), "FDoorB.bck");
...
int daDoor20_c::orderStopEvent() {
    ...
    fopAcM_orderOtherEventId(this, field_0x692[field_0x6cb], field_0x6b8[field_0x6cb], 0xffff, 0, 1);
    return 1;
}
...
void daDoor20_c::setDoorAngleSpec() {
    ...
    case 1:
        ...
        } else if (door_param2_c::getFRoomNo(this) == dComIfGp_roomControl_getStayNo()) {
            field_0x670 = current.angle.y + 0x7fff;
        } else {
            field_0x670 = current.angle.y;
        }
    ...
    if (chkMakeKey() == 1 && field_0x5f0 && field_0x5ec == -1) {
        ...
        case 1:
            if (door_param2_c::getFrontOption(this) == 2) {
                cStack_28.set(0.0f, 107.0f, KREG_F(3) + 17.0f);
                cStack_30.y = 0;
                roomNo = door_param2_c::getFRoomNo(this);
            } else if (door_param2_c::getBackOption(this) == 2) {
                cStack_28.set(0.0f, 107.0f, -17.0f - KREG_F(3));
                cStack_30.y = 0x7fff;
        ...
        current.pos = prevPos;
        if (field_0x5ec == -1) {
            OS_REPORT_ERROR("シャッタードア：鍵生成できませんでした。\n"); // Shutter Door: Key generation failed.
            return 0;
        }
    }
...
int daDoor20_c::drawCheck(int param_1) {
    ...
    } else  if (dComIfGp_roomControl_checkRoomDisp(fRoomNo)) {
...
void daDoor20_c::makeEventId() {
    ...
    for (int i = 0; i < 19; i++) {
        field_0x692[i] = (s16)dComIfGp_getEventManager().getEventIdx(this, table[i], 0xFF);
        field_0x6b8[i] = 0xFF;
    }
...
int daDoor20_c::checkArea(f32 param_1, f32 param_2, f32 param_3) {
    ...
    s16 angle_delta = sVar8 - player->current.angle.y;
    if (abs(angle_delta) < 0x5000) {
        return 0;
    } else {
        return 1;
    }
...
static int daDoor20_Create(fopAc_ac_c* a_this) {
    daDoor20_c* i_this = (daDoor20_c*)a_this;
...
static actor_method_class l_daDoor20_Method = {
    (process_method_func)daDoor20_Create,
    (process_method_func)daDoor20_Delete,
    (process_method_func)daDoor20_Execute,
