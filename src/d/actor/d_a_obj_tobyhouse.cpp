...
void daObjTobyHouse_c::CreateHeap() {
    // NONMATCHING
}
...
void daObjTobyHouse_c::create1st() {
    // NONMATCHING
}
...
void daObjTobyHouse_c::Execute(f32 (**param_0)[3][4]) {
    // NONMATCHING
}
