...
void daAlink_c::setEyeMove(cXyz* param_0, s16 param_1, s16 param_2) {
    u32 temp_r28 = eyeBlinkTimer;
    f32 sp18 = eyeOffsetX;
    f32 sp14 = field_0x341c;

    eyeBlinkTimer = 75.0f + cM_rndF(30.0f);
    eyeOffsetX = 0.0f;
    field_0x341c = 0.0f;
    tempEyeOffset = 0.0f;
    ...
    if (param_0 != NULL) {
    ...
    } else if (0.0f != cachedEyeOffsetX || 0.0f != cachedEyeOffsetY) {
        var_f30 = cachedEyeOffsetY;
        var_f31 = cachedEyeOffsetX;
        tempEyeOffset = cachedEyeOffsetX;
    } else if ((mProcID == PROC_MOVE || mProcID == PROC_WOLF_MOVE) && !checkNoResetFlg1(FLG1_UNK_1000000) && headTiltAngle != 0) {
        var_f30 = 0.0f;
        var_f31 = 0.00024414062f * -headTiltAngle;
        tempEyeOffset = var_f31;
    } else if (checkSwimNeckUpDown()) {
        if (swimNeckDir> 0) {
            var_f30 = 0.5f;
        } else if (swimNeckDir< 0) {
            var_f30 = -0.5f;
        } else {
            var_f30 = 0.0f;
        }
        ...
        if (temp_r28 != 0) {
            ...
            if (checkGrabAnimeCarry() || cM_rnd() < 0.5f) {
                ...
                s16 temp_r29_2 = cM_atan2s(eyeOffsetX, field_0x341c);
                temp_r29_2 += (s16)(((int)cM_rndF(3.0f) << 13) + 0x6000);

                eyeOffsetX = cM_ssin(temp_r29_2);
            ...
            eyeOffsetX = cM_ssin(temp_r0);
            field_0x341c = cM_scos(temp_r0);
        }
        var_f31 = eyeOffsetX;
        var_f30 = field_0x341c;
    } else {
        leftEyeBone->setNowOffsetX(0.0f);
        rightEyeBone->setNowOffsetX(0.0f);
        leftEyeBone->setNowOffsetY(0.0f);
        rightEyeBone->setNowOffsetY(0.0f);
    ...
    if (daAlink_matAnm_c::getMorfFrame() == 0) {
        ...
        cLib_addCalc(leftEyeBone->getNowOffsetXP(), var_f29, 0.5f, 0.1f, 0.03f);
        cLib_addCalc(rightEyeBone->getNowOffsetXP(), var_f28, 0.5f, 0.1f, 0.03f);
        cLib_addCalc(leftEyeBone->getNowOffsetYP(), sp10, 0.5f, 0.08f, 0.02f);
        rightEyeBone->setNowOffsetY(*leftEyeBone->getNowOffsetYP());
    }
}
...
void daAlink_c::setMoveSlantAngle() {
    ...
    cLib_addCalcAngleS(&headTiltAngle, var_r28, 4, 1200, 200);

    if (checkWolf()) {
        shape_angle.z = headTiltAngle;
        if (var_r29 == 0) {
...
void daAlink_c::commonProcInit(daAlink_c::daAlink_PROC i_procID) {
    ...
    field_0x308c = 0;
    cachedEyeOffsetX = 0.0f;
    cachedEyeOffsetY = 0.0f;
    field_0x30a0 = 0;
    field_0x30a2 = 0;
    field_0x30f0 = 0;
...
int daAlink_c::procWait() {
    ...
    if (!checkNextAction(0) && !checkFrontWallTypeAction()) {
        daPy_frameCtrl_c* frameCtrl_p = mUnderFrameCtrl;
        cachedEyeOffsetX = (s16)(shape_angle.y - field_0x2fe6) * 0.005f;
...
int daAlink_c::execute() {
    ...
    leftEyeBone->offSetFlg();
    rightEyeBone->offSetFlg();
