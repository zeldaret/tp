...
// void dCcD_Cyl::operator=(dCcD_Cyl const& param_0) {
extern "C" void __as__8dCcD_CylFRC8dCcD_Cyl() {
    // NONMATCHING
}
...
// daE_VA_HIO_c::~daE_VA_HIO_c() {
extern "C" void __dt__12daE_VA_HIO_cFv(){// NONMATCHING
}
...
void __sinit_d_a_e_vt_cpp(){// NONMATCHING
}
