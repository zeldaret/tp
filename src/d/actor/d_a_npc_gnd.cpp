...
void daNpc_Gnd_c::afterJntAnm(int param_0) {
    // NONMATCHING
}
...
void daNpc_Gnd_c::afterSetMotionAnm(int param_0, int param_1, f32 param_2, int param_3) {
    // NONMATCHING
}
