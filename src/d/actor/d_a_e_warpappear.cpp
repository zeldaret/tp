    ...
    switch (i_this->field_0x59e) {
        ...
        case 6:
            ...
            if (i_this->field_0x5a0 <= 80) {
                ...
                cLib_addCalc2(&i_this->field_0x5b0.z, i_this->field_0x5c8.z, fVar1, i_this->field_0x5e8 * i_this->field_0x5f8);
        ...
        case 21:
            ...
            if (i_this->field_0x5a0 >= 180) {
                ...
                ihasiActor->field_0x5bc = dComIfGp_particle_set(ihasiActor->field_0x5bc, 0x8521, &sp54, 0, 0);
...
/* 807D1C50-807D1C58 0024F0 0008+00 1/0 0/0 0/0 .text            daE_Warpappear_IsDelete__FP18e_warpappear_class */
...
static actor_method_class l_daE_Warpappear_Method = {
    (process_method_func)daE_Warpappear_Create,
    (process_method_func)daE_Warpappear_Delete,
    (process_method_func)daE_Warpappear_Execute,
    (process_method_func)daE_Warpappear_IsDelete,
