...
void daObjKazeNeko_c::getFirstVec(cXyz* param_0, int param_1) {
    // NONMATCHING
}
...
static void daObjKazeNeko_Draw(daObjKazeNeko_c* param_0) {
    // NONMATCHING
}
 ...
 */
static void daObjKazeNeko_Execute(daObjKazeNeko_c* param_0) {
    // NONMATCHING
}
...
static void daObjKazeNeko_Delete(daObjKazeNeko_c* param_0) {
    // NONMATCHING
}

/* 80C3D168-80C3D2A0 000908 0138+00 1/0 0/0 0/0 .text daObjKazeNeko_Create__FP10fopAc_ac_c */
static void daObjKazeNeko_Create(fopAc_ac_c* param_0) {
    // NONMATCHING
}
