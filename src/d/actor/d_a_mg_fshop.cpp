...
#else
static void koro2_mtx_set(fshop_class* param_0) {
    // NONMATCHING
}
#endif
...
#else
static int daFshop_Execute(fshop_class* param_0) {
    // NONMATCHING
}
#endif
...
#else
static int koro2_heapinit(fopAc_ac_c* param_0) {
    // NONMATCHING
}
#endif
...
void __sinit_d_a_mg_fshop_cpp(){// NONMATCHING
}
