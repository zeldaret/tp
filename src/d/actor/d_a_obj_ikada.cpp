...
cPhs_Step daObjIkada_c::create() {
    ...
    if (phase == cPhs_COMPLEATE_e) {
        ...
        phase = MoveBGCreate(l_arcName, dzb_id, dBgS_MoveBGProc_TypicalRotY, 0xC00, NULL);
...
actor_process_profile_definition g_profile_Obj_Ikada = {
    ...
    /* Proc Name    */ PROC_Obj_Ikada,
    /* Proc SubMtd  */ &g_fpcLf_Method.base,
    /* Size         */ sizeof(daObjIkada_c),
    /* Size Other   */ 0,
    /* Parameters   */ 0,
    /* Leaf SubMtd  */ &g_fopAc_Method.base,
    /* Priority     */ PRIO_Obj_Ikada,
    /* Actor SubMtd */ &l_daObjIkada_Method,
