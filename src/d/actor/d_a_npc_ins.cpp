...
int daNpcIns_c::waitShop(void* param_0) {
    // NONMATCHING
}
...
int daNpcIns_c::goHome(void* param_0) {
    // NONMATCHING
}
...
BOOL daNpcIns_c::checkPoint(cXyz& param_0, f32 param_1) {
    // NONMATCHING
}
