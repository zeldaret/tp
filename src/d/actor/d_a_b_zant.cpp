 ...
 */
void daB_ZANT_c::ctrlJoint(J3DJoint* param_0, J3DModel* param_1) {
    // NONMATCHING
}

/* 8063E264-8063E2B0 000244 004C+00 1/1 0/0 0/0 .text JointCallBack__10daB_ZANT_cFP8J3DJointi */
void daB_ZANT_c::JointCallBack(J3DJoint* param_0, int param_1) {
    // NONMATCHING
}
...
static void daB_ZANT_Draw(daB_ZANT_c* param_0) {
    // NONMATCHING
}
 ...
 */
void daB_ZANT_c::setNextDamageMode(int param_0) {
    // NONMATCHING
}
...
static void s_pillar_sub(void* param_0, void* param_1) {
    // NONMATCHING
}
...
void daB_ZANT_c::calcScale(int param_0) {
    // NONMATCHING
}
...
static void s_del_tp(void* param_0, void* param_1) {
    // NONMATCHING
}
...
static void daB_ZANT_Create(daB_ZANT_c* param_0) {
    // NONMATCHING
}
