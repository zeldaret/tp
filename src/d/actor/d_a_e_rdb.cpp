...
static void e_rdb_wait(e_rdb_class* i_this) {
    ...
    switch (i_this->mMode) {
    case 0:
        anm_init(i_this, e_rdb_class::e_rdb_class::ANM_WALK, 10.0f, 2, 1.0f);
        i_this->mMode = 1;
        i_this->field_0x6b8[0] = cM_rndF(10.0f) + 20.0f;
        // [[fallthrough]]
    case 1:
        if (i_this->mAnm == e_rdb_class::ANM_WAIT01) {
            if (sVar1 < 512 && sVar1 > -512) {
                anm_init(i_this, e_rdb_class::ANM_WALK, 5.0f, 2, 1.0f);
            }
        } else if (sVar1 > 512 || sVar1 < -512) {
            anm_init(i_this, e_rdb_class::ANM_WAIT01, 5.0f, 2, 1.0f);
        }
    ...
    case 1:
        if (i_this->mAnm == 70) {
            ...
            if (i_this->mDistToPlayer > 700.0f) {
                anm_init(i_this, e_rdb_class::ANM_RWAIT, 10.0f, 2, 1.0f);
            }
        } else {
            fVar1 = 10.0f;
...
static void e_rdb_attack(e_rdb_class* i_this) {
    ...
    case 0:
        if (cM_rndF(1.0f) < 0.5f) {
            anm_init(i_this, e_rdb_class::ANM_ATTACK01, 5.0f, 0, 1.0f);
            i_this->mMode = 1;
        } else {
            anm_init(i_this, e_rdb_class::ANM_ATTACK02, 5.0f, 0, 1.0f);
            i_this->mMode = 2;
        }
        break;
...
static void e_rdb_spin_attack(e_rdb_class* i_this) {
    ...
    switch (i_this->mMode) {
    case 0:
        anm_init(i_this, e_rdb_class::ANM_ATTACK03_START, 5.0f, 0, 1.0f);
    ...
    case 1:
        ...
        anm_init(i_this, e_rdb_class::ANM_ATTACK03_SPIN, 0.0f, 2, 1.0f);
        i_this->mMode = 2;
    ...
    case 2:
        ...
        if (i_this->field_0x6b8[0] == 0) {
            anm_init(i_this, e_rdb_class::ANM_ATTACK03_END, 0.0f, 0, 1.0f);
            i_this->mMode = 3;
        }
        break;
...
static int e_rdb_defence(e_rdb_class* i_this) {
    ...
    switch (i_this->mMode) {
    case 0:
        if (i_this->mAnm != e_rdb_class::ANM_GUARD) {
            anm_init(i_this, e_rdb_class::e_rdb_class::ANM_GUARD, 3.0f, 0, 1.0f);
        } else {
            if (frame > 15) {
...
static void e_rdb_damage(e_rdb_class* i_this) {
    ...
    case 0:
        iVar1 = cM_rndF(4.99f);
        if (iVar1 == 0) {
            anm_init(i_this, e_rdb_class::ANM_DAMAGEF, 2.0f, 0, 1.0f);
        } else if (iVar1 == 1) {
            anm_init(i_this, e_rdb_class::ANM_DAMAGEFL, 2.0f, 0, 1.0f);
        } else if (iVar1 == 2) {
            anm_init(i_this, e_rdb_class::ANM_DAMAGEFR, 2.0f, 0, 1.0f);
        } else if (iVar1 == 3) {
            anm_init(i_this, e_rdb_class::ANM_DAMAGEBL, 2.0f, 0, 1.0f);
        } else if (iVar1 == 4) {
            anm_init(i_this, e_rdb_class::ANM_DAMAGEBR, 2.0f, 0, 1.0f);
        }
    ...
    case 10:
        if (i_this->mpModelMorf->isStop()) {
            anm_init(i_this, e_rdb_class::e_rdb_class::ANM_DOWN_WAIT, 5.0f, 2, 1.0f);
    ...
    case 11:
        if (i_this->field_0x6b8[0] == 0) {
            ...
            if (i_this->field_0xfcc >= 2 && strcmp(dComIfGp_getStartStageName(), "D_MN09") == 0) {
                ...
                anm_init(i_this, e_rdb_class::e_rdb_class::ANM_DOWN_RETURN, 5.0f, 0, 1.0f);
                i_this->mMode = 12;
            }
        }
        break;
...
static void e_rdb_end(e_rdb_class* i_this) {
    ...
    switch (i_this->mMode) {
    case 0:
        anm_init(i_this, e_rdb_class::ANM_ED_DEMO_DOWN, 2.0f, 0, 1.0f);
        i_this->mMode = 1;
        if (actor != NULL) {
    ...
    case 1:
        ...
        if (i_this->mpModelMorf->isStop()) {
            anm_init(i_this, e_rdb_class::ANM_ED_DEMO_DOWNWAIT, 2.0f, 2, 1.0f);
            i_this->mMode = 2;
        }
        break;

    case 3:
        anm_init(i_this, e_rdb_class::e_rdb_class::ANM_ED_DEMO_DOWNUP, 5.0f, 0, 1.0f);
        i_this->mMode = 4;
        break;

    case 4:
        if (i_this->mpModelMorf->isStop()) {
            anm_init(i_this, e_rdb_class::e_rdb_class::ANM_ED_DEMO_DOWNWALK, 3.0f, 2, 1.0f);
            i_this->mMode = 5;
        }
        break;
    ...
    case 20:
        anm_init(i_this, e_rdb_class::ANM_LV9_END01, 2.0f, 0, 1.0f);
    ...
    case 21:
        ...
        if (i_this->mpModelMorf->isStop()) {
            anm_init(i_this, e_rdb_class::ANM_LV9_END02, 3.0f, 0, 1.0f);
...
static void e_rdb_start(e_rdb_class* i_this) {
    ...
    switch (i_this->mMode) {
    case 0:
        anm_init(i_this, e_rdb_class::ANM_WALK, 10.0f, 2, 1.0f);
        i_this->mMode = 1;
        break;
    ...
    case 4:
        anm_init(i_this, e_rdb_class::e_rdb_class::ANM_OP_DEMO_SWING, 10.0f, 0, 1.0f);
        i_this->mMode = 5;
    ...
    case 11:
        ...
        if (fopAcM_searchPlayerDistanceXZ(&i_this->enemy) < 500.0f) {
            i_this->mMode = 12;
            anm_init(i_this, e_rdb_class::ANM_LV9_OP01, fVar1, 0, 1.0f);
    ...
    case 12:
        if (i_this->mAcch.ChkGroundHit()) {
            anm_init(i_this, e_rdb_class::ANM_LV9_OP02, 0.0f, 0, 1.0f);
        ...
        for (int i = 0; i <= 2; i = i + 1) {
            if (i_this->field_0x944[i].ChkTgHit() != 0) {
                ...
                if (i_this->mAtInfo.mAttackPower != 0) {
                    ...
                    if (i_this->mAnm == e_rdb_class::ANM_DOWN || i_this->mAnm == e_rdb_class::ANM_DOWN_WAIT) {
                    ...
                    (daPy_getPlayerActorClass()->getCutCount() >= 4 || bVar1))
                {
                    ...
                    if (i_this->field_0xfcc >= iVar1) {
                        ...
                        anm_init(i_this, e_rdb_class::e_rdb_class::ANM_DOWN, 5.0f, 0, 1.0f);
                        i_this->mAction = 6;
                        i_this->mMode = 10;
...
static void anm_se_set(e_rdb_class* i_this) {
    ...
    } else if (i_this->mAnm == e_rdb_class::ANM_ATTACK02) {
        if (i_this->mpModelMorf->checkFrame(0.0f)) {
            i_this->mSound.startCreatureVoice(Z2SE_EN_RDB_V_ATTACK, -1);
    ...
    } else if (i_this->mAnm == e_rdb_class::ANM_ATTACK03_END) {
        if (i_this->mpModelMorf->checkFrame(4.0f) || i_this->mpModelMorf->checkFrame(50.5f)) {
            i_this->mSound.startCreatureSound(Z2SE_EN_RDB_FOOTNOTE, 0, -1);
        }
    } else if (i_this->mAnm == e_rdb_class::ANM_DOWN) {
        if (i_this->mpModelMorf->checkFrame(0.0f)) {
    ...
    } else if (i_this->mAnm == e_rdb_class::ANM_DOWN_RETURN) {
        if (i_this->mpModelMorf->checkFrame(0.0f)) {
    ...
    } else if (i_this->mAnm == e_rdb_class::ANM_ED_DEMO_DOWNUP) {
        if (i_this->mpModelMorf->checkFrame(11.0f)) {
            i_this->mSound.startCreatureVoice(Z2SE_EN_RDB_V_ED_DEMO_DOWNUP, -1);
        }
    } else if (i_this->mAnm == e_rdb_class::ANM_ED_DEMO_DOWNWALK) {
