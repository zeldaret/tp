...
static void jump_pos_check(e_mf_class* i_this, cXyz* param_1) {
    // NONMATCHING
}
...
static void way_check(e_mf_class* i_this) {
    // NONMATCHING
}
