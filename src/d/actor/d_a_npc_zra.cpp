...
extern "C" void func_80B7F6AC(void* _this, int* param_0) {
    // NONMATCHING
}

/* 80B7F6C8-80B7F6E4 0072A8 001C+00 1/1 0/0 0/0 .text            cLib_calcTimer<Uc>__FPUc */
extern "C" void func_80B7F6C8(void* _this, u8* param_0) {
    // NONMATCHING
}
...
extern "C" void func_80B7F6E4(void* _this, int param_0, int param_1) {
    // NONMATCHING
}
