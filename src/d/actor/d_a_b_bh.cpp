...
static void anm_init(b_bh_class* param_0, int param_1, f32 param_2, u8 param_3, f32 param_4) {
    // NONMATCHING
}

/* 805AE350-805AE430 0001D0 00E0+00 1/0 0/0 0/0 .text            daB_BH_Draw__FP10b_bh_class */
static void daB_BH_Draw(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void b_bh_wait(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void b_bh_attack_1(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void b_bh_bombeat(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void b_bh_down(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void b_bh_b_down(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void b_bh_start(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void kuki_control1(b_bh_class* param_0) {
    // NONMATCHING
}

/* 805B0D6C-805B0EE0 002BEC 0174+00 1/1 0/0 0/0 .text            kuki_control2__FP10b_bh_class */
static void kuki_control2(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void kuki_control3(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void damage_check(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void anm_se_set(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void daB_BH_Execute(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void daB_BH_Delete(b_bh_class* param_0) {
    // NONMATCHING
}
...
static void daB_BH_Create(fopAc_ac_c* param_0) {
    // NONMATCHING
}
