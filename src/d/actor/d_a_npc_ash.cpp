...
#else
bool daNpcAsh_c::setExpressionAnm(int param_0, bool param_1) {
    // NONMATCHING
}
#endif
...
#else
bool daNpcAsh_c::setExpressionBtp(int param_0) {
    // NONMATCHING
}
#endif
...
#else
void daNpcAsh_c::setMotionAnm(int param_0, f32 param_1) {
    // NONMATCHING
}
#endif
...
#else
BOOL daNpcAsh_c::EvCut_Meeting(int param_0) {
    // NONMATCHING
}
#endif
...
#else
BOOL daNpcAsh_c::EvCut_WiretapSponsor(int param_0) {
    // NONMATCHING
}
#endif
...
#else
BOOL daNpcAsh_c::EvCut_WiretapEntrant(int param_0) {
    // NONMATCHING
}
#endif
...
extern "C" void func_8095CC94(void* _this, s16 param_0) /* const */ {
    // NONMATCHING
}
...
// daNpcF_ActorMngr_c::daNpcF_ActorMngr_c() {
void __ct__18daNpcF_ActorMngr_cFv() {
    // NONMATCHING
}
...
void chkPointInArea__15daTag_EvtArea_cF4cXyz() {
    // NONMATCHING
}
