...
static void daNpc_shopMaro_Create(void* param_0) {
    // NONMATCHING
}

/* 80AEBE78-80AEBE9C 000098 0024+00 1/0 0/0 0/0 .text            daNpc_shopMaro_Delete__FPv */
static void daNpc_shopMaro_Delete(void* param_0) {
    // NONMATCHING
}
