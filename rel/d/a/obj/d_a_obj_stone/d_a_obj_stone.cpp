...
int daObjStone_c::Create() {
    ...
    // setup chkobj
    mChkObj.Set(&fopAcM_GetPosition_p,&fopAcM_GetOldPosition_p,this,1,mChkCircle,&fopAcM_GetSpeed_p,0,0);
    ...
    fopAcM_setCullSizeSphere(this,0.0f,0.0f,0.0f,l_r[mStoneType]);
    ...
    fopAcM_createChild(PROC_Obj_StoneMark,fopAcM_GetID(this),mStoneType,&pos,fopAcM_GetRoomNo(this),&shape_angle,&mScale,-1,0);
