...
static actor_method_class l_daObjARI_Method = {
    (process_method_func)daObjARI_Create__FP10fopAc_ac_c,
    (process_method_func)daObjARI_Delete__FP10daObjARI_c,
    (process_method_func)daObjARI_Execute__FP10daObjARI_c,
    (process_method_func)daObjARI_IsDelete__FP10daObjARI_c,
    (process_method_func)daObjARI_Draw__FP10daObjARI_c,
};
...
extern actor_process_profile_definition g_profile_Obj_Ari = {
  ...
  PROC_Obj_Ari,           // mProcName
  &g_fpcLf_Method.mBase,  // sub_method
  sizeof(daObjARI_c),     // mSize
  0,                      // mSizeOther
  0,                      // mParameters
  &g_fopAc_Method.base,   // sub_method
  484,                    // mPriority
  &l_daObjARI_Method,     // sub_method
  0x000C0100,             // mStatus
