...
static actor_method_class l_daTitle_Method = {
    (process_method_func)daTitle_Create__FP10fopAc_ac_c,
    (process_method_func)daTitle_Delete__FP9daTitle_c,
    (process_method_func)daTitle_Execute__FP9daTitle_c,
    0,
    (process_method_func)daTitle_Draw__FP9daTitle_c,
};
