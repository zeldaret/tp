...
/* 801DA488  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA48C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801DA4A0  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA4A4  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801DA4B8  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA4BC  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801DA4C0  C0 24 09 F4 */	lfs f1, 0x9f4(r4)
/* 801DA4C4  C0 44 09 FC */	lfs f2, 0x9fc(r4)
/* 801DA4C8  48 07 A0 E9 */	bl paneTrans__8CPaneMgrFff
lbl_801DA4CC:
/* 801DA4CC  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA4D0  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801DA4F4  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA4F8  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801DA4FC  C0 24 06 60 */	lfs f1, 0x660(r4)
/* 801DA500  C0 44 06 64 */	lfs f2, 0x664(r4)
/* 801DA504  48 07 A0 AD */	bl paneTrans__8CPaneMgrFff
/* 801DA508  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA50C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801DA540  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA544  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801DA548  C0 24 06 6C */	lfs f1, 0x66c(r4)
/* 801DA54C  C0 44 06 70 */	lfs f2, 0x670(r4)
/* 801DA550  48 07 A0 61 */	bl paneTrans__8CPaneMgrFff
/* 801DA554  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA558  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801DA58C  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA590  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801DA594  C0 24 06 78 */	lfs f1, 0x678(r4)
/* 801DA598  C0 44 06 7C */	lfs f2, 0x67c(r4)
/* 801DA59C  48 07 A0 15 */	bl paneTrans__8CPaneMgrFff
/* 801DA5A0  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA5A4  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801DA5D8  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA5DC  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801DA5E0  C0 24 06 84 */	lfs f1, 0x684(r4)
/* 801DA5E4  C0 44 06 88 */	lfs f2, 0x688(r4)
/* 801DA5E8  48 07 9F C9 */	bl paneTrans__8CPaneMgrFff
/* 801DA5EC  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801DA5F0  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
