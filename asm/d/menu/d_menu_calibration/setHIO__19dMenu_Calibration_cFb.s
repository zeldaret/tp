...
/* 801AFA24  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFA28  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
/* 801AFA2C  88 03 0A 32 */	lbz r0, 0xa32(r3)
/* 801AFA30  28 00 00 00 */	cmplwi r0, 0
/* 801AFA34  41 82 00 5C */	beq lbl_801AFA90
lbl_801AFA38:
/* 801AFA38  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFA3C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801AFA64  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFA68  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
lbl_801AFA90:
/* 801AFA90  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFA94  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801AFAB8  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFABC  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801AFAC0  C0 24 06 60 */	lfs f1, 0x660(r4)
/* 801AFAC4  C0 44 06 64 */	lfs f2, 0x664(r4)
/* 801AFAC8  48 0A 4A E9 */	bl paneTrans__8CPaneMgrFff
/* 801AFACC  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFAD0  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801AFB04  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFB08  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801AFB0C  C0 24 06 6C */	lfs f1, 0x66c(r4)
/* 801AFB10  C0 44 06 70 */	lfs f2, 0x670(r4)
/* 801AFB14  48 0A 4A 9D */	bl paneTrans__8CPaneMgrFff
/* 801AFB18  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFB1C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801AFB50  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFB54  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801AFB58  C0 24 06 78 */	lfs f1, 0x678(r4)
/* 801AFB5C  C0 44 06 7C */	lfs f2, 0x67c(r4)
/* 801AFB60  48 0A 4A 51 */	bl paneTrans__8CPaneMgrFff
/* 801AFB64  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFB68  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
...
/* 801AFB9C  3C 80 80 43 */	lis r4, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFBA0  38 84 EB C8 */	addi r4, r4, g_drawHIO@l /* 0x8042EBC8@l */
/* 801AFBA4  C0 24 06 84 */	lfs f1, 0x684(r4)
/* 801AFBA8  C0 44 06 88 */	lfs f2, 0x688(r4)
/* 801AFBAC  48 0A 4A 05 */	bl paneTrans__8CPaneMgrFff
/* 801AFBB0  3C 60 80 43 */	lis r3, g_drawHIO@ha /* 0x8042EBC8@ha */
/* 801AFBB4  38 63 EB C8 */	addi r3, r3, g_drawHIO@l /* 0x8042EBC8@l */
