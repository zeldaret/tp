...
/* 8005A188  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8005A18C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8005A190  3B DF 4E 00 */	addi r30, r31, 0x4e00
/* 8005A194  7F C3 F3 78 */	mr r3, r30
/* 8005A198  3C 80 80 38 */	lis r4, d_kankyo_d_kankyo_wether__stringBase0@ha /* 0x8037A368@ha */
/* 8005A19C  38 84 A3 68 */	addi r4, r4, d_kankyo_d_kankyo_wether__stringBase0@l /* 0x8037A368@l */
...
/* 8005A1B0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A1B4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 8005A1CC  3C 80 80 38 */	lis r4, d_kankyo_d_kankyo_wether__stringBase0@ha /* 0x8037A368@ha */
/* 8005A1D0  38 84 A3 68 */	addi r4, r4, d_kankyo_d_kankyo_wether__stringBase0@l /* 0x8037A368@l */
...
/* 8005A1E4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A1E8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_8005A220:
/* 8005A220  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A224  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 8005A240  3C 80 80 38 */	lis r4, d_kankyo_d_kankyo_wether__stringBase0@ha /* 0x8037A368@ha */
/* 8005A244  38 84 A3 68 */	addi r4, r4, d_kankyo_d_kankyo_wether__stringBase0@l /* 0x8037A368@l */
...
/* 8005A258  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A25C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_8005A270:
/* 8005A270  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A274  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_8005A288:
/* 8005A288  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A28C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_8005A2A0:
/* 8005A2A0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A2A4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_8005A2B8:
/* 8005A2B8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A2BC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_8005A2D0:
/* 8005A2D0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A2D4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
