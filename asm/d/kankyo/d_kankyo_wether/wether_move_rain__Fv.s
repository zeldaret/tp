...
/* 800588A8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 800588AC  3B E3 CA 54 */	addi r31, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 800588F0  3C 60 80 3D */	lis r3, __vt__9J3DPacket@ha /* 0x803CD97C@ha */
/* 800588F4  38 03 D9 7C */	addi r0, r3, __vt__9J3DPacket@l /* 0x803CD97C@l */
...
/* 8005890C  3C 60 80 3B */	lis r3, __vt__19dKankyo_rain_Packet@ha /* 0x803A9B60@ha */
/* 80058910  38 03 9B 60 */	addi r0, r3, __vt__19dKankyo_rain_Packet@l /* 0x803A9B60@l */
/* 80058914  90 1E 00 00 */	stw r0, 0(r30)
/* 80058918  38 64 00 18 */	addi r3, r4, 0x18
/* 8005891C  3C 80 80 05 */	lis r4, __ct__8RAIN_EFFFv@ha /* 0x80056D0C@ha */
/* 80058920  38 84 6D 0C */	addi r4, r4, __ct__8RAIN_EFFFv@l /* 0x80056D0C@l */
/* 80058924  3C A0 80 05 */	lis r5, __dt__8RAIN_EFFFv@ha /* 0x80056CD0@ha */
/* 80058928  38 A5 6C D0 */	addi r5, r5, __dt__8RAIN_EFFFv@l /* 0x80056CD0@l */
/* 8005892C  38 C0 00 38 */	li r6, 0x38
/* 80058930  38 E0 00 FA */	li r7, 0xfa
/* 80058934  48 30 94 2D */	bl __construct_array
lbl_80058938:
/* 80058938  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005893C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_800589A4:
/* 800589A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 800589A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 800589AC  83 C3 5D 74 */	lwz r30, 0x5d74(r3)
/* 800589B0  48 00 47 DD */	bl dKyr_rain_move__Fv
/* 800589B4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 800589B8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 800589D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 800589D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 800589D8  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 800589DC  3C 80 80 38 */	lis r4, d_kankyo_d_kankyo_wether__stringBase0@ha /* 0x8037A368@ha */
/* 800589E0  38 84 A3 68 */	addi r4, r4, d_kankyo_d_kankyo_wether__stringBase0@l /* 0x8037A368@l */
...
lbl_80058A04:
/* 80058A04  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80058A08  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 80058A38  3C 60 80 43 */	lis r3, g_mEnvSeMgr@ha /* 0x8042DD70@ha */
/* 80058A3C  38 63 DD 70 */	addi r3, r3, g_mEnvSeMgr@l /* 0x8042DD70@l */
...
lbl_80058A50:
/* 80058A50  3C 60 80 43 */	lis r3, g_mEnvSeMgr@ha /* 0x8042DD70@ha */
/* 80058A54  38 63 DD 70 */	addi r3, r3, g_mEnvSeMgr@l /* 0x8042DD70@l */
/* 80058A58  38 80 00 01 */	li r4, 1
/* 80058A5C  38 A0 00 00 */	li r5, 0
/* 80058A60  48 26 ED D1 */	bl startRainSe__10Z2EnvSeMgrFlSc
lbl_80058A64:
/* 80058A64  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80058A68  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 80058AB8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80058ABC  3B E3 CA 54 */	addi r31, r3, g_env_light@l /* 0x8042CA54@l */
