...
/* 80059F88  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80059F8C  3B E3 CA 54 */	addi r31, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 80059FD8  3C 60 80 3D */	lis r3, __vt__9J3DPacket@ha /* 0x803CD97C@ha */
/* 80059FDC  38 03 D9 7C */	addi r0, r3, __vt__9J3DPacket@l /* 0x803CD97C@l */
...
/* 80059FF4  3C 60 80 3B */	lis r3, __vt__19dKankyo_evil_Packet@ha /* 0x803A9AC0@ha */
/* 80059FF8  38 03 9A C0 */	addi r0, r3, __vt__19dKankyo_evil_Packet@l /* 0x803A9AC0@l */
/* 80059FFC  90 1E 00 00 */	stw r0, 0(r30)
/* 8005A000  38 64 00 1C */	addi r3, r4, 0x1c
/* 8005A004  3C 80 80 05 */	lis r4, __ct__11EF_EVIL_EFFFv@ha /* 0x800570A8@ha */
/* 8005A008  38 84 70 A8 */	addi r4, r4, __ct__11EF_EVIL_EFFFv@l /* 0x800570A8@l */
/* 8005A00C  3C A0 80 05 */	lis r5, __dt__11EF_EVIL_EFFFv@ha /* 0x8005706C@ha */
/* 8005A010  38 A5 70 6C */	addi r5, r5, __dt__11EF_EVIL_EFFFv@l /* 0x8005706C@l */
/* 8005A014  38 C0 00 44 */	li r6, 0x44
/* 8005A018  38 E0 07 D0 */	li r7, 0x7d0
/* 8005A01C  48 30 7D 45 */	bl __construct_array
lbl_8005A020:
/* 8005A020  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A024  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 8005A050  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8005A054  3B C3 CA 54 */	addi r30, r3, g_env_light@l /* 0x8042CA54@l */
