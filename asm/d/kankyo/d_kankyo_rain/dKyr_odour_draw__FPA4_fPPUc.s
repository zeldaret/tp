...
/* 8006BE38  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8006BE3C  3B E3 CA 54 */	addi r31, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_8006BE60:
/* 8006BE60  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8006BE64  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
/* 8006BE68  48 2A 48 D5 */	bl reinitGX__6J3DSysFv
/* 8006BE6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8006BE70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8006BEC0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8006BEC4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8006C014  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8006C018  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8006C064  3C 80 80 43 */	lis r4, j3dSys@ha /* 0x80434AC8@ha */
/* 8006C068  38 84 4A C8 */	addi r4, r4, j3dSys@l /* 0x80434AC8@l */
...
/* 8006C3FC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8006C400  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8006C46C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8006C470  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8006C474:
...
/* 8006C6A4  D0 04 80 00 */	stfs f0, 0x8000(r4)  /* 0xCC008000@l */
