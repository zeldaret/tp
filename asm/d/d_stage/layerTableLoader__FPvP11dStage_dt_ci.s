...
lbl_800269E0:
/* 800269E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 800269E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80026A00  3C 60 80 3A */	lis r3, l_layerFuncTableA@ha /* 0x803A6644@ha */
/* 80026A04  38 63 66 44 */	addi r3, r3, l_layerFuncTableA@l /* 0x803A6644@l */
...
/* 80026A18  3C A0 80 3A */	lis r5, l_layerFuncTableA@ha /* 0x803A6644@ha */
/* 80026A1C  38 A5 66 44 */	addi r5, r5, l_layerFuncTableA@l /* 0x803A6644@l */
/* 80026A20  38 C0 00 01 */	li r6, 1
/* 80026A24  4B FF F6 91 */	bl dStage_dt_c_decode__FPvP11dStage_dt_cP9FuncTablei
/* 80026A28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80026A2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80026A6C  3C 60 80 3A */	lis r3, l_envLayerFuncTable@ha /* 0x803A6650@ha */
/* 80026A70  38 63 66 50 */	addi r3, r3, l_envLayerFuncTable@l /* 0x803A6650@l */
...
/* 80026A90  3C A0 80 3A */	lis r5, l_envLayerFuncTable@ha /* 0x803A6650@ha */
/* 80026A94  38 A5 66 50 */	addi r5, r5, l_envLayerFuncTable@l /* 0x803A6650@l */
...
lbl_80026AA4:
/* 80026AA4  3C 60 80 3A */	lis r3, l_envLayerFuncTable@ha /* 0x803A6650@ha */
/* 80026AA8  38 63 66 50 */	addi r3, r3, l_envLayerFuncTable@l /* 0x803A6650@l */
...
/* 80026AC0  3C A0 80 3A */	lis r5, l_envLayerFuncTable@ha /* 0x803A6650@ha */
/* 80026AC4  38 A5 66 50 */	addi r5, r5, l_envLayerFuncTable@l /* 0x803A6650@l */
