...
/* 802358F0  3C 60 80 43 */	lis r3, g_meter2_info@ha /* 0x80430188@ha */
/* 802358F4  3B C3 01 88 */	addi r30, r3, g_meter2_info@l /* 0x80430188@l */
...
/* 8023591C  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 80235920  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
/* 80235924  80 63 00 34 */	lwz r3, 0x34(r3)
/* 80235928  54 60 05 EF */	rlwinm. r0, r3, 0, 0x17, 0x17
/* 8023592C  41 82 01 58 */	beq lbl_80235A84
/* 80235930  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80235934  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80235938  3B A3 0D D8 */	addi r29, r3, 0xdd8
/* 8023593C  7F A3 EB 78 */	mr r3, r29
/* 80235940  3C 80 80 38 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 0x803790C0@ha */
/* 80235944  3B E4 90 C0 */	addi r31, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 0x803790C0@l */
...
/* 80235960  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80235964  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80235968  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 8023596C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80235970  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
...
lbl_8023598C:
/* 8023598C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80235990  38 A3 61 C0 */	addi r5, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 802359D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 802359D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 802359DC  3B 63 07 F0 */	addi r27, r3, 0x7f0
/* 802359E0  7F 63 DB 78 */	mr r3, r27
/* 802359E4  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 802359E8  3B E4 72 88 */	addi r31, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
...
/* 80235A00  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80235A04  3B A4 72 88 */	addi r29, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
...
/* 80235A5C  3C 60 80 23 */	lis r3, dMsgObject_searchSSItem__FPvPv@ha /* 0x80232A44@ha */
/* 80235A60  38 63 2A 44 */	addi r3, r3, dMsgObject_searchSSItem__FPvPv@l /* 0x80232A44@l */
...
/* 80235A8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80235A90  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80235A94  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 80235A98  3C 80 80 38 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 0x803790C0@ha */
/* 80235A9C  38 84 90 C0 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 0x803790C0@l */
