...
/* 80084C14  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80084C18  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80084C38  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80084C3C  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 80084C54  3C 60 80 3A */	lis r3, __vt__8cM3dGSph@ha /* 0x803A7904@ha */
/* 80084C58  38 03 79 04 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x803A7904@l */
/* 80084C5C  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_80084C60:
/* 80084C60  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80084C64  41 82 00 24 */	beq lbl_80084C88
/* 80084C68  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80084C6C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80084C70  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80084C74  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80084C78  41 82 00 10 */	beq lbl_80084C88
/* 80084C7C  3C 60 80 3A */	lis r3, __vt__8cM3dGAab@ha /* 0x803A7218@ha */
/* 80084C80  38 03 72 18 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x803A7218@l */
