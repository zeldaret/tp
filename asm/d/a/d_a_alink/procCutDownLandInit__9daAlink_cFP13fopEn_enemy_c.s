...
/* 800D58D4  3C A0 80 39 */	lis r5, m__21daAlinkHIO_cutDown_c0@ha /* 0x8038DD44@ha */
/* 800D58D8  38 A5 DD 44 */	addi r5, r5, m__21daAlinkHIO_cutDown_c0@l /* 0x8038DD44@l */
...
/* 800D599C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 800D59A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 800D59C4  3C 60 80 39 */	lis r3, m__21daAlinkHIO_cutDown_c0@ha /* 0x8038DD44@ha */
/* 800D59C8  38 63 DD 44 */	addi r3, r3, m__21daAlinkHIO_cutDown_c0@l /* 0x8038DD44@l */
...
/* 800D59E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 800D59EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 800D5A14  3C 60 80 39 */	lis r3, m__21daAlinkHIO_cutDown_c0@ha /* 0x8038DD44@ha */
/* 800D5A18  38 63 DD 44 */	addi r3, r3, m__21daAlinkHIO_cutDown_c0@l /* 0x8038DD44@l */
...
/* 800D5A88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 800D5A8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 800D5A90  80 03 5F 1C */	lwz r0, 0x5f1c(r3)
/* 800D5A94  64 00 00 40 */	oris r0, r0, 0x40
/* 800D5A98  90 03 5F 1C */	stw r0, 0x5f1c(r3)
/* 800D5A9C  3C 60 80 42 */	lis r3, l_halfAtnWaitBaseAnime@ha /* 0x80425544@ha */
/* 800D5AA0  C4 03 55 44 */	lfsu f0, l_halfAtnWaitBaseAnime@l(r3)  /* 0x80425544@l */
