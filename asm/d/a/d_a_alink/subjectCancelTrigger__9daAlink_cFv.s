...
/* 800CEB74  40 82 00 3C */	bne lbl_800CEBB0
/* 800CEB78  4B FF 1A 1D */	bl checkNotBattleStage__9daAlink_cFv
/* 800CEB7C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 800CEB80  40 82 00 30 */	bne lbl_800CEBB0
/* 800CEB84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 800CEB88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 800CEB8C  88 03 00 14 */	lbz r0, 0x14(r3)
/* 800CEB90  28 00 00 FF */	cmplwi r0, 0xff
/* 800CEB94  41 82 00 1C */	beq lbl_800CEBB0
/* 800CEB98  80 1F 31 A0 */	lwz r0, 0x31a0(r31)
/* 800CEB9C  54 00 03 5B */	rlwinm. r0, r0, 0, 0xd, 0xd
/* 800CEBA0  41 82 00 20 */	beq lbl_800CEBC0
/* 800CEBA4  80 1F 05 70 */	lwz r0, 0x570(r31)
/* 800CEBA8  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6
/* 800CEBAC  40 82 00 14 */	bne lbl_800CEBC0
lbl_800CEBB0:
/* 800CEBB0  7F E3 FB 78 */	mr r3, r31
/* 800CEBB4  38 80 00 08 */	li r4, 8
/* 800CEBB8  4B FE 3A 15 */	bl itemTriggerCheck__9daAlink_cFUc
/* 800CEBBC  48 00 00 08 */	b lbl_800CEBC4
lbl_800CEBC0:
