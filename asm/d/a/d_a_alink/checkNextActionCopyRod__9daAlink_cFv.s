...
/* 800E1D10  4B F9 1A D5 */	bl LockonTruth__12dAttention_cFv
/* 800E1D14  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 800E1D18  40 82 00 14 */	bne lbl_800E1D2C
/* 800E1D1C  80 1E 03 34 */	lwz r0, 0x334(r30)
/* 800E1D20  54 00 00 85 */	rlwinm. r0, r0, 0, 2, 2
/* 800E1D24  40 82 00 08 */	bne lbl_800E1D2C
/* 800E1D28  3B A0 00 00 */	li r29, 0
lbl_800E1D2C:
/* 800E1D2C  57 A0 06 3F */	clrlwi. r0, r29, 0x18
/* 800E1D30  40 82 00 1C */	bne lbl_800E1D4C
/* 800E1D34  A8 1F 30 8E */	lha r0, 0x308e(r31)
/* 800E1D38  2C 00 00 00 */	cmpwi r0, 0
/* 800E1D3C  40 82 00 10 */	bne lbl_800E1D4C
/* 800E1D40  7F E3 FB 78 */	mr r3, r31
/* 800E1D44  48 00 00 DD */	bl procCopyRodSubjectInit__9daAlink_cFv
/* 800E1D48  48 00 00 0C */	b lbl_800E1D54
lbl_800E1D4C:
/* 800E1D4C  7F E3 FB 78 */	mr r3, r31
/* 800E1D50  48 00 02 19 */	bl procCopyRodMoveInit__9daAlink_cFv
lbl_800E1D54:
/* 800E1D54  39 61 00 20 */	addi r11, r1, 0x20
/* 800E1D58  48 28 04 D1 */	bl _restgpr_29
