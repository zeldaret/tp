...
/* 8012CF7C  4B FF F0 2D */	bl checkWolfWaitSlipPolygon__9daAlink_cFv
/* 8012CF80  2C 03 00 00 */	cmpwi r3, 0
/* 8012CF84  41 82 00 20 */	beq lbl_8012CFA4
/* 8012CF88  C0 3F 33 AC */	lfs f1, 0x33ac(r31)
/* 8012CF8C  C0 02 92 A4 */	lfs f0, lit_6021(r2)
/* 8012CF90  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8012CF94  41 81 00 10 */	bgt lbl_8012CFA4
/* 8012CF98  7F E3 FB 78 */	mr r3, r31
/* 8012CF9C  48 00 32 49 */	bl procWolfWaitSlipInit__9daAlink_cFv
/* 8012CFA0  48 00 00 38 */	b lbl_8012CFD8
lbl_8012CFA4:
/* 8012CFA4  7F E3 FB 78 */	mr r3, r31
/* 8012CFA8  38 80 00 EF */	li r4, 0xef
/* 8012CFAC  4B F9 5D F9 */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC
/* 8012CFB0  2C 03 00 00 */	cmpwi r3, 0
/* 8012CFB4  40 82 00 0C */	bne lbl_8012CFC0
/* 8012CFB8  38 60 00 00 */	li r3, 0
/* 8012CFBC  48 00 00 1C */	b lbl_8012CFD8
lbl_8012CFC0:
/* 8012CFC0  C0 02 92 C0 */	lfs f0, lit_6108(r2)
/* 8012CFC4  D0 1F 33 98 */	stfs f0, 0x3398(r31)
/* 8012CFC8  7F E3 FB 78 */	mr r3, r31
/* 8012CFCC  38 80 00 18 */	li r4, 0x18
/* 8012CFD0  4B FF C6 A9 */	bl setSingleAnimeWolfBase__9daAlink_cFQ29daAlink_c12daAlink_WANM
