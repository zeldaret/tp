...
/* 80498AE4  4B EC 96 C9 */	bl _savegpr_17
/* 80498AE8  7C 7D 1B 78 */	mr r29, r3
/* 80498AEC  3C 60 80 4A */	lis r3, lit_3627@ha /* 0x80499A6C@ha */
/* 80498AF0  3B E3 9A 6C */	addi r31, r3, lit_3627@l /* 0x80499A6C@l */
/* 80498AF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80498AF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80498AFC  83 83 5D 74 */	lwz r28, 0x5d74(r3)
/* 80498B00  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80498B04  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 80498B28  4B D0 FB 05 */	bl dKy_GxFog_set__Fv
...
/* 80498C10  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80498C14  39 63 CA 54 */	addi r11, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 80498C9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80498CA0  38 63 4E C4 */	addi r3, r3, 0x4ec4
/* 80498CA4  4B B8 B6 E1 */	bl getStatusRoomDt__20dStage_roomControl_cFi
...
lbl_80498CC8:
/* 80498CC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80498CCC  3A A3 61 C0 */	addi r21, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80498CF4:
/* 80498CF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80498CF8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80498CFC  80 04 5F 64 */	lwz r0, 0x5f64(r4)
/* 80498D00  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80498D04  3B 03 4A C8 */	addi r24, r3, j3dSys@l /* 0x80434AC8@l */
/* 80498D08  90 18 00 48 */	stw r0, 0x48(r24)
/* 80498D0C  80 04 5F 68 */	lwz r0, 0x5f68(r4)
/* 80498D10  90 18 00 4C */	stw r0, 0x4c(r24)
/* 80498D14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498D18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80498D2C  4B EA DB BD */	bl PSMTXTrans
/* 80498D30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498D34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498D38  38 99 00 24 */	addi r4, r25, 0x24
/* 80498D3C  4B EA D7 75 */	bl PSMTXCopy
/* 80498D40  7F 23 CB 78 */	mr r3, r25
/* 80498D44  4B B7 4F 81 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80498D48  80 95 61 B0 */	lwz r4, 0x61b0(r21)
/* 80498D4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498D50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80498D64  4B EA DB 85 */	bl PSMTXTrans
/* 80498D68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498D6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498D70  38 9A 00 24 */	addi r4, r26, 0x24
/* 80498D74  4B EA D7 3D */	bl PSMTXCopy
/* 80498D78  7F 43 D3 78 */	mr r3, r26
/* 80498D7C  4B B7 4F 49 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80498D80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80498D84  3A 43 61 C0 */	addi r18, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80498DE8  3C 80 80 4A */	lis r4, d_a_vrbox2__stringBase0@ha /* 0x80499AC4@ha */
/* 80498DEC  38 84 9A C4 */	addi r4, r4, d_a_vrbox2__stringBase0@l /* 0x80499AC4@l */
/* 80498DF0  4B EC FB A5 */	bl strcmp
/* 80498DF4  2C 03 00 00 */	cmpwi r3, 0
/* 80498DF8  40 82 00 5C */	bne lbl_80498E54
/* 80498DFC  38 7C 00 D8 */	addi r3, r28, 0xd8
/* 80498E00  3C 80 80 43 */	lis r4, g_env_light@ha /* 0x8042CA54@ha */
/* 80498E04  38 84 CA 54 */	addi r4, r4, g_env_light@l /* 0x8042CA54@l */
/* 80498E08  38 84 10 88 */	addi r4, r4, 0x1088
/* 80498E0C  38 A1 00 08 */	addi r5, r1, 8
/* 80498E10  4B BC 29 51 */	bl dKyr_get_vectle_calc__FP4cXyzP4cXyzP4cXyz
...
/* 80498E5C  4B DD 7E 19 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80498E60  7C 73 1B 78 */	mr r19, r3
/* 80498E64  38 7C 00 D8 */	addi r3, r28, 0xd8
/* 80498E68  38 81 00 14 */	addi r4, r1, 0x14
/* 80498E6C  4B DD 7D 99 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80498E70  7C 72 1B 78 */	mr r18, r3
/* 80498E74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498E78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498E7C  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80498E80  C0 41 00 18 */	lfs f2, 0x18(r1)
/* 80498E84  C0 61 00 1C */	lfs f3, 0x1c(r1)
/* 80498E88  4B EA DA 61 */	bl PSMTXTrans
/* 80498E8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498E90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498E94  7E 44 07 34 */	extsh r4, r18
/* 80498E98  4B B7 35 9D */	bl mDoMtx_YrotM__FPA4_fs
/* 80498E9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498EA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498EA4  20 13 7F FF */	subfic r0, r19, 0x7fff
/* 80498EA8  7C 04 07 34 */	extsh r4, r0
/* 80498EAC  4B B7 34 F1 */	bl mDoMtx_XrotM__FPA4_fs
/* 80498EB0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80498EB4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 80498F10  4B D0 49 9D */	bl dKy_get_parcent__Ffff
...
/* 80498F38  4B B7 3F 01 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80498F3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498F40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498F44  38 9B 00 24 */	addi r4, r27, 0x24
/* 80498F48  4B EA D5 69 */	bl PSMTXCopy
/* 80498F4C  7F 63 DB 78 */	mr r3, r27
/* 80498F50  4B B7 4D 75 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80498F54  7E A3 AB 78 */	mr r3, r21
/* 80498F58  3C 80 80 4A */	lis r4, d_a_vrbox2__stringBase0@ha /* 0x80499AC4@ha */
/* 80498F5C  38 84 9A C4 */	addi r4, r4, d_a_vrbox2__stringBase0@l /* 0x80499AC4@l */
/* 80498F60  38 84 00 08 */	addi r4, r4, 8
/* 80498F64  4B EC FA 31 */	bl strcmp
...
/* 80498FA4  4B DD 7C D1 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80498FA8  7C 73 1B 78 */	mr r19, r3
/* 80498FAC  38 7C 00 D8 */	addi r3, r28, 0xd8
/* 80498FB0  38 81 00 14 */	addi r4, r1, 0x14
/* 80498FB4  4B DD 7C 51 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80498FB8  7C 72 1B 78 */	mr r18, r3
/* 80498FBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498FC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498FC4  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80498FC8  C0 41 00 18 */	lfs f2, 0x18(r1)
/* 80498FCC  C0 61 00 1C */	lfs f3, 0x1c(r1)
/* 80498FD0  4B EA D9 19 */	bl PSMTXTrans
/* 80498FD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498FD8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498FDC  7E 44 07 34 */	extsh r4, r18
/* 80498FE0  4B B7 34 55 */	bl mDoMtx_YrotM__FPA4_fs
/* 80498FE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498FE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80498FEC  20 13 7F FF */	subfic r0, r19, 0x7fff
/* 80498FF0  7C 04 07 34 */	extsh r4, r0
/* 80498FF4  4B B7 33 A9 */	bl mDoMtx_XrotM__FPA4_fs
/* 80498FF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80498FFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80499000  3C 80 80 4A */	lis r4, mangZ@ha /* 0x80499B78@ha */
/* 80499004  38 84 9B 78 */	addi r4, r4, mangZ@l /* 0x80499B78@l */
/* 80499008  A8 84 00 00 */	lha r4, 0(r4)
/* 8049900C  4B B7 34 C1 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80499020  4B B7 3E 19 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80499024  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80499028  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8049902C  3C 80 80 4A */	lis r4, mangZ@ha /* 0x80499B78@ha */
/* 80499030  A8 04 9B 78 */	lha r0, mangZ@l(r4)  /* 0x80499B78@l */
/* 80499034  7C 00 00 D0 */	neg r0, r0
/* 80499038  7C 04 07 34 */	extsh r4, r0
/* 8049903C  4B B7 34 91 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80499040  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80499044  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80499048  38 97 00 24 */	addi r4, r23, 0x24
/* 8049904C  4B EA D4 65 */	bl PSMTXCopy
/* 80499050  7E E3 BB 78 */	mr r3, r23
/* 80499054  4B B7 4C 71 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80499058  C0 3F 00 34 */	lfs f1, 0x34(r31)
/* 8049905C  4B DC E8 F9 */	bl cM_rndF__Ff
...
/* 80499074  3C 60 80 4A */	lis r3, mangZ@ha /* 0x80499B78@ha */
/* 80499078  AC 03 9B 78 */	lhau r0, mangZ@l(r3)  /* 0x80499B78@l */
/* 8049907C  7C 00 22 14 */	add r0, r0, r4
/* 80499080  B0 03 00 00 */	sth r0, 0(r3)
lbl_80499084:
/* 80499084  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80499088  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804990B4  4B E9 67 01 */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_804990B8:
...
/* 804990C8  4B EC 91 31 */	bl _restgpr_17
