...
/* 804A3FF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804A3FF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804A402C:
/* 804A402C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804A4030  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804A4034  38 80 00 00 */	li r4, 0
/* 804A4038  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 804A403C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 804A4040  4B CF F7 85 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 804A4044  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804A4048  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804A404C  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 804A4050  80 84 00 04 */	lwz r4, 4(r4)
/* 804A4054  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804A4058  4B D0 0D 49 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A405C  80 7F 05 68 */	lwz r3, 0x568(r31)
/* 804A4060  4B B6 9C 65 */	bl mDoExt_modelUpdateDL__FP8J3DModel
