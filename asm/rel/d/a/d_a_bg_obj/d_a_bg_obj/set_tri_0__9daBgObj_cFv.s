...
/* 8045AB90  4B F0 76 3C */	b _savegpr_25
...
/* 8045ABA8  3C 60 80 46 */	lis r3, l_tri_src@ha
/* 8045ABAC  3B 83 CA E4 */	addi r28, r3, l_tri_src@l
...
/* 8045ABC4  4B C2 9C C0 */	b Set__8dCcD_TriFRC11dCcD_SrcTri
...
/* 8045ABF0  3C 60 80 46 */	lis r3, lit_3873@ha
/* 8045ABF4  C0 23 CA 00 */	lfs f1, lit_3873@l(r3)
...
/* 8045AC38  4B BB 21 2C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 8045AC3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045AC40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045AC44  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 8045AC48  4B BB 17 EC */	b mDoMtx_YrotM__FPA4_fs
/* 8045AC4C  3B 20 00 00 */	li r25, 0
/* 8045AC50  3B C0 00 00 */	li r30, 0
/* 8045AC54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045AC58  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l
lbl_8045AC5C:
...
/* 8045AC6C  4B EE C1 00 */	b PSMTXMultVec
...
/* 8045AC90  4B E1 4B 4C */	b setPos__8cM3dGTriFPC3VecPC3VecPC3Vec
...
/* 8045ACA4  4B E1 4B 38 */	b setPos__8cM3dGTriFPC3VecPC3VecPC3Vec
/* 8045ACA8  39 61 00 60 */	addi r11, r1, 0x60
/* 8045ACAC  4B F0 75 6C */	b _restgpr_25
