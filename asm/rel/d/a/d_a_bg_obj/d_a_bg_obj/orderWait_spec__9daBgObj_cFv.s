...
/* 8045B9DC  3C 80 80 46 */	lis r4, l_cyl_src@ha /* 0x8045C9B8@ha */
/* 8045B9E0  3B E4 C9 B8 */	addi r31, r4, l_cyl_src@l /* 0x8045C9B8@l */
/* 8045B9E4  4B FF F9 BD */	bl setSe__9daBgObj_cFv
/* 8045B9E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8045B9EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8045BA20  4B E0 B1 15 */	bl __mi__4cXyzCFRC3Vec
...
/* 8045BA3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8045BA40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8045BA44  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 8045BA48  7C 00 00 D0 */	neg r0, r0
/* 8045BA4C  7C 04 07 34 */	extsh r4, r0
/* 8045BA50  4B BB 09 8D */	bl mDoMtx_YrotS__FPA4_fs
/* 8045BA54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8045BA58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8045BA5C  38 81 00 44 */	addi r4, r1, 0x44
/* 8045BA60  7C 85 23 78 */	mr r5, r4
/* 8045BA64  4B EE B3 09 */	bl PSMTXMultVec
/* 8045BA68  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 8045BA6C  4B BB 12 F9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8045BA70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8045BA74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8045BA78  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 8045BA7C  4B BB 09 B9 */	bl mDoMtx_YrotM__FPA4_fs
...
lbl_8045BACC:
/* 8045BACC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8045BAD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8045BAD4  38 81 00 38 */	addi r4, r1, 0x38
/* 8045BAD8  7C 85 23 78 */	mr r5, r4
/* 8045BADC  4B EE B2 91 */	bl PSMTXMultVec
/* 8045BAE0  38 61 00 08 */	addi r3, r1, 8
/* 8045BAE4  38 81 00 38 */	addi r4, r1, 0x38
/* 8045BAE8  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 8045BAEC  4B E0 B0 49 */	bl __mi__4cXyzCFRC3Vec
...
/* 8045BB08  4B E0 BB 6D */	bl cM_atan2s__Fff
