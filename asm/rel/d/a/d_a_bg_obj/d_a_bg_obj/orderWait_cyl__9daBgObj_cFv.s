...
/* 8045B814  3C 60 80 46 */	lis r3, l_cyl_src@ha /* 0x8045C9B8@ha */
/* 8045B818  3B C3 C9 B8 */	addi r30, r3, l_cyl_src@l /* 0x8045C9B8@l */
/* 8045B81C  38 7F 0B 88 */	addi r3, r31, 0xb88
/* 8045B820  4B C2 8C 41 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 8045B824  28 03 00 00 */	cmplwi r3, 0
/* 8045B828  41 82 01 70 */	beq lbl_8045B998
/* 8045B82C  38 7F 0B 88 */	addi r3, r31, 0xb88
/* 8045B830  4B C2 8C C9 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 8045B854  4B C2 7E 35 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 8045B884  4B E0 B2 B1 */	bl __mi__4cXyzCFRC3Vec
...
/* 8045B8A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8045B8A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8045B8A8  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 8045B8AC  7C 00 00 D0 */	neg r0, r0
/* 8045B8B0  7C 04 07 34 */	extsh r4, r0
/* 8045B8B4  4B BB 0B 29 */	bl mDoMtx_YrotS__FPA4_fs
/* 8045B8B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8045B8BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8045B8C0  38 81 00 44 */	addi r4, r1, 0x44
/* 8045B8C4  7C 85 23 78 */	mr r5, r4
/* 8045B8C8  4B EE B4 A5 */	bl PSMTXMultVec
/* 8045B8CC  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 8045B8D0  4B BB 14 95 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8045B8D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8045B8D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8045B8DC  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8045B8E0  4B BB 0B 55 */	bl mDoMtx_YrotM__FPA4_fs
...
lbl_8045B930:
/* 8045B930  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8045B934  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8045B938  38 81 00 38 */	addi r4, r1, 0x38
/* 8045B93C  7C 85 23 78 */	mr r5, r4
/* 8045B940  4B EE B4 2D */	bl PSMTXMultVec
/* 8045B944  38 61 00 08 */	addi r3, r1, 8
/* 8045B948  38 81 00 38 */	addi r4, r1, 0x38
/* 8045B94C  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8045B950  4B E0 B1 E5 */	bl __mi__4cXyzCFRC3Vec
...
/* 8045B96C  4B E0 BD 09 */	bl cM_atan2s__Fff
...
lbl_8045B998:
/* 8045B998  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8045B99C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8045B9A0  38 63 23 3C */	addi r3, r3, 0x233c
/* 8045B9A4  38 9F 0B 88 */	addi r4, r31, 0xb88
/* 8045B9A8  4B E0 92 01 */	bl Set__4cCcSFP8cCcD_Obj
