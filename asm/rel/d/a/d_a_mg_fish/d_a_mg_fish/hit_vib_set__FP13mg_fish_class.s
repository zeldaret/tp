...
/* 80529D8C  3C 80 80 53 */	lis r4, lit_3679@ha /* 0x80536168@ha */
/* 80529D90  3B E4 61 68 */	addi r31, r4, lit_3679@l /* 0x80536168@l */
/* 80529D94  80 03 06 4C */	lwz r0, 0x64c(r3)
/* 80529D98  90 01 00 08 */	stw r0, 8(r1)
/* 80529D9C  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80529DA0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80529DA4  38 81 00 08 */	addi r4, r1, 8
/* 80529DA8  4B AE FA 51 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80529E10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80529E14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80529E18  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80529E1C  54 00 10 3A */	slwi r0, r0, 2
/* 80529E20  3C 80 80 53 */	lis r4, vib_p@ha /* 0x805364CC@ha */
/* 80529E24  38 84 64 CC */	addi r4, r4, vib_p@l /* 0x805364CC@l */
/* 80529E28  7C 84 00 2E */	lwzx r4, r4, r0
/* 80529E2C  38 A0 00 01 */	li r5, 1
/* 80529E30  38 C1 00 0C */	addi r6, r1, 0xc
/* 80529E34  4B B4 5B F1 */	bl StartShock__12dVibration_cFii4cXyz
lbl_80529E38:
