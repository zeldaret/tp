...
/* 805310BC  3C 60 80 53 */	lis r3, lit_3679@ha /* 0x80536168@ha */
/* 805310C0  3B E3 61 68 */	addi r31, r3, lit_3679@l /* 0x80536168@l */
/* 805310C4  80 1E 06 4C */	lwz r0, 0x64c(r30)
/* 805310C8  90 01 00 08 */	stw r0, 8(r1)
/* 805310CC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 805310D0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 805310D4  38 81 00 08 */	addi r4, r1, 8
/* 805310D8  4B AE 87 21 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80531108  4B D3 68 4D */	bl cM_rndF__Ff
...
/* 80531170  4B D3 68 1D */	bl cM_rndFX__Ff
...
/* 80531194  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80531198  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8053119C  80 63 00 00 */	lwz r3, 0(r3)
/* 805311A0  4B AD B2 3D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805311B4  4B D3 67 A1 */	bl cM_rndF__Ff
...
/* 80531238  4B D3 67 1D */	bl cM_rndF__Ff
...
/* 8053125C  4B D3 66 F9 */	bl cM_rndF__Ff
...
/* 805312C4  4B C7 6E FD */	bl dKy_Sound_set__F4cXyziUii
...
/* 805312DC  4B D3 58 59 */	bl __mi__4cXyzCFRC3Vec
...
/* 805312F8  4B D3 63 7D */	bl cM_atan2s__Fff
...
/* 8053132C  4B D3 63 49 */	bl cM_atan2s__Fff
...
/* 80531354  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80531358  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80531384  4B D3 E6 B9 */	bl cLib_addCalc2__FPffff
...
/* 805313A0  4B D3 F2 69 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805313B4  4B D3 F2 55 */	bl cLib_addCalcAngleS2__FPssss
lbl_805313B8:
