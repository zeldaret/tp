...
/* 8052AA00  4B E3 77 D9 */	bl _savegpr_28
/* 8052AA04  2C 04 00 00 */	cmpwi r4, 0
/* 8052AA08  40 82 03 98 */	bne lbl_8052ADA0
/* 8052AA0C  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 8052AA10  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8052AA14  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8052AA4C  4B D4 64 11 */	bl MtxTrans__FfffUc
/* 8052AA50  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AA54  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AA68  4B AE 19 CD */	bl mDoMtx_YrotM__FPA4_fs
/* 8052AA6C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AA70  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052AA74  80 63 00 00 */	lwz r3, 0(r3)
/* 8052AA78  7C 9D E2 14 */	add r4, r29, r28
/* 8052AA7C  A8 84 06 DC */	lha r4, 0x6dc(r4)
/* 8052AA80  4B AE 19 1D */	bl mDoMtx_XrotM__FPA4_fs
/* 8052AA84  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AA88  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AAA4  4B AE 1A 29 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8052AAA8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AAAC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052AAB0  80 63 00 00 */	lwz r3, 0(r3)
/* 8052AAB4  38 80 C0 00 */	li r4, -16384
/* 8052AAB8  4B AE 19 7D */	bl mDoMtx_YrotM__FPA4_fs
...
/* 8052AACC  4B D4 63 D9 */	bl MtxScale__FfffUc
/* 8052AAD0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AAD4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AAEC  4B E1 B9 C5 */	bl PSMTXCopy
...
/* 8052AB20  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8052AB24  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8052AB28  80 84 00 00 */	lwz r4, 0(r4)
/* 8052AB2C  4B E1 B9 85 */	bl PSMTXCopy
/* 8052AB30  3C 60 80 53 */	lis r3, lit_3715@ha /* 0x80536180@ha */
/* 8052AB34  C0 23 61 80 */	lfs f1, lit_3715@l(r3)  /* 0x80536180@l */
/* 8052AB38  FC 40 08 90 */	fmr f2, f1
/* 8052AB3C  FC 60 08 90 */	fmr f3, f1
/* 8052AB40  38 60 00 01 */	li r3, 1
/* 8052AB44  4B D4 63 61 */	bl MtxScale__FfffUc
/* 8052AB48  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AB4C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AB60  4B E1 B9 51 */	bl PSMTXCopy
lbl_8052AB64:
...
/* 8052AB90  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8052AB94  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8052AB98  80 84 00 00 */	lwz r4, 0(r4)
/* 8052AB9C  4B E1 B9 15 */	bl PSMTXCopy
...
lbl_8052ABB0:
/* 8052ABB0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052ABB4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052ABC8  4B AE 18 6D */	bl mDoMtx_YrotM__FPA4_fs
lbl_8052ABCC:
/* 8052ABCC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052ABD0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052ABE4  4B E1 B8 CD */	bl PSMTXCopy
/* 8052ABE8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052ABEC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052ABF0  80 63 00 00 */	lwz r3, 0(r3)
/* 8052ABF4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8052ABF8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8052ABFC  4B E1 B8 B5 */	bl PSMTXCopy
...
/* 8052AC1C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8052AC20  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8052AC24  80 84 00 00 */	lwz r4, 0(r4)
/* 8052AC28  4B E1 B8 89 */	bl PSMTXCopy
...
lbl_8052AC3C:
/* 8052AC3C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AC40  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AC54  4B AE 17 E1 */	bl mDoMtx_YrotM__FPA4_fs
lbl_8052AC58:
/* 8052AC58  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AC5C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AC70  4B E1 B8 41 */	bl PSMTXCopy
/* 8052AC74  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AC78  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052AC7C  80 63 00 00 */	lwz r3, 0(r3)
/* 8052AC80  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8052AC84  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8052AC88  4B E1 B8 29 */	bl PSMTXCopy
...
/* 8052ACAC  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8052ACB0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8052ACB4  80 84 00 00 */	lwz r4, 0(r4)
/* 8052ACB8  4B E1 B7 F9 */	bl PSMTXCopy
...
lbl_8052ACCC:
/* 8052ACCC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052ACD0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052ACE4  4B AE 17 51 */	bl mDoMtx_YrotM__FPA4_fs
lbl_8052ACE8:
/* 8052ACE8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052ACEC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AD00  4B E1 B7 B1 */	bl PSMTXCopy
/* 8052AD04  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AD08  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052AD0C  80 63 00 00 */	lwz r3, 0(r3)
/* 8052AD10  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8052AD14  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8052AD18  4B E1 B7 99 */	bl PSMTXCopy
lbl_8052AD1C:
...
/* 8052AD48  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8052AD4C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8052AD50  80 84 00 00 */	lwz r4, 0(r4)
/* 8052AD54  4B E1 B7 5D */	bl PSMTXCopy
/* 8052AD58  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AD5C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052AD60  80 63 00 00 */	lwz r3, 0(r3)
/* 8052AD64  A8 9D 06 44 */	lha r4, 0x644(r29)
/* 8052AD68  4B AE 17 65 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8052AD6C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AD70  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AD84  4B E1 B7 2D */	bl PSMTXCopy
/* 8052AD88  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AD8C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052AD90  80 63 00 00 */	lwz r3, 0(r3)
/* 8052AD94  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8052AD98  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8052AD9C  4B E1 B7 15 */	bl PSMTXCopy
lbl_8052ADA0:
/* 8052ADA0  38 60 00 01 */	li r3, 1
/* 8052ADA4  39 61 00 20 */	addi r11, r1, 0x20
/* 8052ADA8  4B E3 74 7D */	bl _restgpr_28
