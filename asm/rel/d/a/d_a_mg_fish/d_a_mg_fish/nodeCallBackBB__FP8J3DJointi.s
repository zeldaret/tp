...
/* 8052B080  4B E3 71 59 */	bl _savegpr_28
/* 8052B084  2C 04 00 00 */	cmpwi r4, 0
/* 8052B088  40 82 00 A4 */	bne lbl_8052B12C
/* 8052B08C  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 8052B090  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8052B094  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8052B0CC  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8052B0D0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8052B0D4  80 84 00 00 */	lwz r4, 0(r4)
/* 8052B0D8  4B E1 B3 D9 */	bl PSMTXCopy
/* 8052B0DC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052B0E0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052B0F4  4B AE 13 41 */	bl mDoMtx_YrotM__FPA4_fs
/* 8052B0F8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052B0FC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052B110  4B E1 B3 A1 */	bl PSMTXCopy
/* 8052B114  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052B118  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052B11C  80 63 00 00 */	lwz r3, 0(r3)
/* 8052B120  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8052B124  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8052B128  4B E1 B3 89 */	bl PSMTXCopy
lbl_8052B12C:
/* 8052B12C  38 60 00 01 */	li r3, 1
/* 8052B130  39 61 00 20 */	addi r11, r1, 0x20
/* 8052B134  4B E3 70 F1 */	bl _restgpr_28
