...
/* 8052ADCC  4B E3 74 0D */	bl _savegpr_28
/* 8052ADD0  2C 04 00 00 */	cmpwi r4, 0
/* 8052ADD4  40 82 01 B0 */	bne lbl_8052AF84
/* 8052ADD8  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 8052ADDC  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8052ADE0  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8052AE04  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8052AE08  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8052AE0C  80 84 00 00 */	lwz r4, 0(r4)
/* 8052AE10  4B E1 B6 A1 */	bl PSMTXCopy
...
/* 8052AE30  3C 60 80 53 */	lis r3, lit_3715@ha /* 0x80536180@ha */
/* 8052AE34  C0 23 61 80 */	lfs f1, lit_3715@l(r3)  /* 0x80536180@l */
/* 8052AE38  FC 40 08 90 */	fmr f2, f1
/* 8052AE3C  FC 60 08 90 */	fmr f3, f1
/* 8052AE40  38 60 00 01 */	li r3, 1
/* 8052AE44  4B D4 60 61 */	bl MtxScale__FfffUc
/* 8052AE48  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AE4C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AE60  4B E1 B6 51 */	bl PSMTXCopy
lbl_8052AE64:
...
/* 8052AE78  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AE7C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AE90  4B AE 15 A5 */	bl mDoMtx_YrotM__FPA4_fs
lbl_8052AE94:
...
lbl_8052AEC0:
/* 8052AEC0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AEC4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AED8  4B AE 15 5D */	bl mDoMtx_YrotM__FPA4_fs
...
lbl_8052AEF8:
/* 8052AEF8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AEFC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AF10  4B AE 15 25 */	bl mDoMtx_YrotM__FPA4_fs
...
lbl_8052AF34:
/* 8052AF34  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AF38  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AF4C  4B AE 14 E9 */	bl mDoMtx_YrotM__FPA4_fs
lbl_8052AF50:
/* 8052AF50  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AF54  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8052AF68  4B E1 B5 49 */	bl PSMTXCopy
/* 8052AF6C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052AF70  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052AF74  80 63 00 00 */	lwz r3, 0(r3)
/* 8052AF78  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8052AF7C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8052AF80  4B E1 B5 31 */	bl PSMTXCopy
lbl_8052AF84:
/* 8052AF84  38 60 00 01 */	li r3, 1
/* 8052AF88  39 61 00 20 */	addi r11, r1, 0x20
/* 8052AF8C  4B E3 72 99 */	bl _restgpr_28
