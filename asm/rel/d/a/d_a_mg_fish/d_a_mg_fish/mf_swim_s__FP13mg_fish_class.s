...
/* 8052C594  3C 60 80 53 */	lis r3, lit_3679@ha /* 0x80536168@ha */
/* 8052C598  3B E3 61 68 */	addi r31, r3, lit_3679@l /* 0x80536168@l */
...
/* 8052C5C8  4B D3 B3 C5 */	bl cM_rndFX__Ff
...
/* 8052C5DC  4B D3 B3 B1 */	bl cM_rndFX__Ff
...
/* 8052C690  4B D3 B2 FD */	bl cM_rndFX__Ff
...
/* 8052C6B4  4B D3 B2 A1 */	bl cM_rndF__Ff
...
/* 8052C6EC  4B D3 A4 49 */	bl __mi__4cXyzCFRC3Vec
...
/* 8052C714  4B D3 AF 61 */	bl cM_atan2s__Fff
...
/* 8052C748  4B D3 AF 2D */	bl cM_atan2s__Fff
...
/* 8052C764  4B E1 A9 D5 */	bl PSVECSquareMag
...
/* 8052C7D4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8052C7D8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8052C844  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8052C848  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8052C84C:
...
/* 8052C870  4B D3 A2 C5 */	bl __mi__4cXyzCFRC3Vec
...
/* 8052C898  4B D3 AD DD */	bl cM_atan2s__Fff
...
/* 8052C8CC  4B D3 AD A9 */	bl cM_atan2s__Fff
...
/* 8052C95C  4B D3 AF F9 */	bl cM_rndF__Ff
...
/* 8052C988  4B D4 30 B5 */	bl cLib_addCalc2__FPffff
...
/* 8052C9A4  4B D4 3C 65 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8052C9B8  4B D4 3C 51 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8052C9F0  3C 60 80 53 */	lis r3, s_sg_sub__FPvPv@ha /* 0x8052B468@ha */
/* 8052C9F4  38 63 B4 68 */	addi r3, r3, s_sg_sub__FPvPv@l /* 0x8052B468@l */
/* 8052C9F8  7F C4 F3 78 */	mr r4, r30
/* 8052C9FC  4B AF 49 3D */	bl fpcEx_Search__FPFPvPv_PvPv
/* 8052CA00  28 03 00 00 */	cmplwi r3, 0
/* 8052CA04  40 82 00 1C */	bne lbl_8052CA20
/* 8052CA08  3C 60 80 53 */	lis r3, s_bb2_sub__FPvPv@ha /* 0x8052B41C@ha */
/* 8052CA0C  38 63 B4 1C */	addi r3, r3, s_bb2_sub__FPvPv@l /* 0x8052B41C@l */
/* 8052CA10  7F C4 F3 78 */	mr r4, r30
/* 8052CA14  4B AF 49 25 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 8052CA18  28 03 00 00 */	cmplwi r3, 0
/* 8052CA1C  41 82 00 5C */	beq lbl_8052CA78
lbl_8052CA20:
/* 8052CA20  3C 60 80 53 */	lis r3, s_bb2_sub__FPvPv@ha /* 0x8052B41C@ha */
/* 8052CA24  38 63 B4 1C */	addi r3, r3, s_bb2_sub__FPvPv@l /* 0x8052B41C@l */
/* 8052CA28  7F C4 F3 78 */	mr r4, r30
/* 8052CA2C  4B AF 49 0D */	bl fpcEx_Search__FPFPvPv_PvPv
/* 8052CA30  28 03 00 00 */	cmplwi r3, 0
/* 8052CA34  41 82 00 4C */	beq lbl_8052CA80
/* 8052CA38  3C 60 80 53 */	lis r3, s_bb_sub__FPvPv@ha /* 0x8052B3C4@ha */
/* 8052CA3C  38 63 B3 C4 */	addi r3, r3, s_bb_sub__FPvPv@l /* 0x8052B3C4@l */
/* 8052CA40  7F C4 F3 78 */	mr r4, r30
/* 8052CA44  4B AF 48 F5 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 8052CA70  4B AE D3 29 */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
/* 8052CA74  48 00 00 0C */	b lbl_8052CA80
lbl_8052CA78:
/* 8052CA78  7F C3 F3 78 */	mr r3, r30
/* 8052CA7C  4B AE D2 01 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_8052CA80:
