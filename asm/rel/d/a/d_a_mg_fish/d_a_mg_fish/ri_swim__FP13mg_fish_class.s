...
/* 8052D3E4  3C 60 80 53 */	lis r3, lit_3679@ha /* 0x80536168@ha */
/* 8052D3E8  3B E3 61 68 */	addi r31, r3, lit_3679@l /* 0x80536168@l */
...
/* 8052D430  4B D3 A5 5D */	bl cM_rndFX__Ff
...
/* 8052D454  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052D458  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052D45C  80 63 00 00 */	lwz r3, 0(r3)
/* 8052D460  4B AD EF 7D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8052D474  4B D3 A4 E1 */	bl cM_rndF__Ff
...
/* 8052D508  4B D3 96 2D */	bl __mi__4cXyzCFRC3Vec
...
/* 8052D524  4B D3 A1 51 */	bl cM_atan2s__Fff
...
/* 8052D558  4B D3 A1 1D */	bl cM_atan2s__Fff
...
/* 8052D570  4B E1 9B C9 */	bl PSVECSquareMag
...
/* 8052D5E0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8052D5E4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8052D650  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8052D654  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8052D658:
...
/* 8052D670  4B D3 A2 E5 */	bl cM_rndF__Ff
...
/* 8052D6A0  4B D4 2F 69 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8052D6B4  4B D3 A2 A1 */	bl cM_rndF__Ff
/* 8052D6B8  FC 00 08 1E */	fctiwz f0, f1
/* 8052D6BC  D8 01 00 38 */	stfd f0, 0x38(r1)
/* 8052D6C0  80 81 00 3C */	lwz r4, 0x3c(r1)
/* 8052D6C4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8052D6C8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8052D6CC  80 63 00 00 */	lwz r3, 0(r3)
/* 8052D6D0  4B AD ED 0D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8052D6E4  4B D3 A2 71 */	bl cM_rndF__Ff
...
/* 8052D76C  4B D3 93 C9 */	bl __mi__4cXyzCFRC3Vec
...
/* 8052D788  4B D3 9E ED */	bl cM_atan2s__Fff
...
/* 8052D7BC  4B D3 9E B9 */	bl cM_atan2s__Fff
...
/* 8052D7F8  4B E1 99 41 */	bl PSVECSquareMag
...
/* 8052D868  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8052D86C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8052D8D8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8052D8DC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8052D8E0:
...
/* 8052D8F8  4B D3 A0 5D */	bl cM_rndF__Ff
...
/* 8052D950  4B D4 20 ED */	bl cLib_addCalc2__FPffff
...
/* 8052D97C  4B D4 20 C1 */	bl cLib_addCalc2__FPffff
...
/* 8052D998  4B D4 20 A5 */	bl cLib_addCalc2__FPffff
...
/* 8052D9AC  4B D4 2C 5D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8052D9C8  4B D3 9F 8D */	bl cM_rndF__Ff
...
/* 8052DA00  4B D4 2C 09 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8052DA28  4B D4 20 15 */	bl cLib_addCalc2__FPffff
...
/* 8052DA3C  4B D4 2B CD */	bl cLib_addCalcAngleS2__FPssss
...
/* 8052DA50  4B D4 2B B9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8052DA64  4B D4 2B A5 */	bl cLib_addCalcAngleS2__FPssss
/* 8052DA68  38 60 00 00 */	li r3, 0
/* 8052DA6C  38 80 00 00 */	li r4, 0
/* 8052DA70  3C A0 80 44 */	lis r5, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8052DA74  38 C5 9A 20 */	addi r6, r5, sincosTable___5JMath@l /* 0x80439A20@l */
