...
/* 805AB25C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805AB260  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805AB264  4B D9 B2 4D */	bl PSMTXCopy
/* 805AB268  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805AB26C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 805AB28C  4B A6 1A D9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 805AB290  38 7E 04 DC */	addi r3, r30, 0x4dc
/* 805AB294  4B A6 1C B1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
...
/* 805AB2B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805AB2B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805AB2B8  38 9F 00 24 */	addi r4, r31, 0x24
/* 805AB2BC  4B D9 B1 F5 */	bl PSMTXCopy
/* 805AB2C0  80 7E 07 88 */	lwz r3, 0x788(r30)
/* 805AB2C4  4B A6 5F 29 */	bl modelCalc__16mDoExt_McaMorfSOFv
