...
/* 805AD91C  4B DB 48 BD */	bl _savegpr_28
/* 805AD920  7C 7F 1B 78 */	mr r31, r3
/* 805AD924  3C 60 80 5B */	lis r3, d_a_L7op_demo_dr__stringBase0@ha /* 0x805AE0AC@ha */
/* 805AD928  38 63 E0 AC */	addi r3, r3, d_a_L7op_demo_dr__stringBase0@l /* 0x805AE0AC@l */
/* 805AD92C  38 80 00 49 */	li r4, 0x49
/* 805AD930  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805AD934  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805AD948  4B A8 E9 A5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 805AD94C  7C 7C 1B 78 */	mr r28, r3
/* 805AD950  38 60 00 58 */	li r3, 0x58
/* 805AD954  4B D2 12 F9 */	bl __nw__FUl
/* 805AD958  7C 7E 1B 79 */	or. r30, r3, r3
/* 805AD95C  41 82 00 68 */	beq lbl_805AD9C4
/* 805AD960  3C 60 80 5B */	lis r3, d_a_L7op_demo_dr__stringBase0@ha /* 0x805AE0AC@ha */
/* 805AD964  38 63 E0 AC */	addi r3, r3, d_a_L7op_demo_dr__stringBase0@l /* 0x805AE0AC@l */
/* 805AD968  38 80 00 2F */	li r4, 0x2f
/* 805AD96C  7F A5 EB 78 */	mr r5, r29
/* 805AD970  38 C0 00 80 */	li r6, 0x80
/* 805AD974  4B A8 E9 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805AD9AC  3D 20 80 5B */	lis r9, lit_3853@ha /* 0x805ADF5C@ha */
/* 805AD9B0  C0 29 DF 5C */	lfs f1, lit_3853@l(r9)  /* 0x805ADF5C@l */
/* 805AD9B4  39 20 00 00 */	li r9, 0
/* 805AD9B8  39 40 FF FF */	li r10, -1
/* 805AD9BC  4B A6 2E 15 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 805AD9F8  4B DB 48 2D */	bl _restgpr_28
