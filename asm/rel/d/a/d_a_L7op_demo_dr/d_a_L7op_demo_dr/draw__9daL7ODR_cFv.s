...
/* 805AB2F8  4B DB 6E E4 */	b _savegpr_29
/* 805AB2FC  7C 7D 1B 78 */	mr r29, r3
/* 805AB300  3C 60 80 5B */	lis r3, lit_3850@ha
/* 805AB304  3B E3 DF 50 */	addi r31, r3, lit_3850@l
...
/* 805AB324  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805AB328  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805AB32C  38 80 00 00 */	li r4, 0
/* 805AB330  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 805AB334  38 DD 01 0C */	addi r6, r29, 0x10c
/* 805AB338  4B BF 84 8C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805AB33C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805AB340  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805AB344  80 9E 00 04 */	lwz r4, 4(r30)
/* 805AB348  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805AB34C  4B BF 9A 54 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 805AB350  80 7D 07 88 */	lwz r3, 0x788(r29)
/* 805AB354  4B A6 5E 6C */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 805AB3A4  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 805AB3A8  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 805AB3AC  4B A8 35 64 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 805AB3B0  90 7D 08 94 */	stw r3, 0x894(r29)
/* 805AB3B4  38 60 00 01 */	li r3, 1
lbl_805AB3B8:
/* 805AB3B8  39 61 00 30 */	addi r11, r1, 0x30
/* 805AB3BC  4B DB 6E 6C */	b _restgpr_29
