...
/* 804DDB5C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DDB60  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804DDB64  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 804DDB68  38 80 25 40 */	li r4, 0x2540
/* 804DDB6C  4B B5 6E 51 */	bl isEventBit__11dSv_event_cCFUs
/* 804DDB70  2C 03 00 00 */	cmpwi r3, 0
/* 804DDB74  40 82 00 28 */	bne lbl_804DDB9C
/* 804DDB78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DDB7C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804DDB80  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 804DDB84  3C 80 80 4E */	lis r4, l_spStageName@ha /* 0x804DF8D4@ha */
/* 804DDB88  38 84 F8 D4 */	addi r4, r4, l_spStageName@l /* 0x804DF8D4@l */
/* 804DDB8C  4B E8 AE 09 */	bl strcmp
