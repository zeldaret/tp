...
/* 804A6D58  4B EB B4 71 */	bl _savegpr_24
/* 804A6D5C  7C 7C 1B 79 */	or. r28, r3, r3
/* 804A6D60  3C 60 80 4B */	lis r3, lit_3727@ha /* 0x804A8860@ha */
/* 804A6D64  3B C3 88 60 */	addi r30, r3, lit_3727@l /* 0x804A8860@l */
...
/* 804A6D88  4B DC 0C 4D */	bl cM_initRnd2__Fiii
...
/* 804A6D9C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804A6DA0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804A6DA4  80 84 00 00 */	lwz r4, 0(r4)
/* 804A6DA8  4B E9 F7 09 */	bl PSMTXCopy
/* 804A6DAC  3B A0 00 00 */	li r29, 0
/* 804A6DB0  3B 60 00 00 */	li r27, 0
/* 804A6DB4  3B 40 00 00 */	li r26, 0
/* 804A6DB8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804A6DBC  3B E3 07 68 */	addi r31, r3, calc_mtx@l /* 0x80450768@l */
/* 804A6DC0  C3 DE 00 88 */	lfs f30, 0x88(r30)
/* 804A6DC4  C3 FE 01 04 */	lfs f31, 0x104(r30)
lbl_804A6DC8:
/* 804A6DC8  4B DC A1 55 */	bl MtxPush__Fv
/* 804A6DCC  80 7F 00 00 */	lwz r3, 0(r31)
/* 804A6DD0  38 80 40 00 */	li r4, 0x4000
/* 804A6DD4  4B B6 56 61 */	bl mDoMtx_YrotM__FPA4_fs
/* 804A6DD8  C0 3E 00 EC */	lfs f1, 0xec(r30)
/* 804A6DDC  4B DC 0C F1 */	bl cM_rndF2__Ff
...
/* 804A6DF8  4B B6 55 A5 */	bl mDoMtx_XrotM__FPA4_fs
/* 804A6DFC  2C 1D 00 0A */	cmpwi r29, 0xa
/* 804A6E00  40 80 00 5C */	bge lbl_804A6E5C
/* 804A6E04  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804A6E08  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804A6E0C  80 63 00 00 */	lwz r3, 0(r3)
/* 804A6E10  3C 80 80 4B */	lis r4, ke_za@ha /* 0x804A8A3C@ha */
/* 804A6E14  38 84 8A 3C */	addi r4, r4, ke_za@l /* 0x804A8A3C@l */
/* 804A6E18  7C 04 D2 AE */	lhax r0, r4, r26
/* 804A6E1C  1C 00 00 05 */	mulli r0, r0, 5
/* 804A6E20  7C 04 07 34 */	extsh r4, r0
/* 804A6E24  4B B6 56 A9 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804A6E28  C0 3E 00 F4 */	lfs f1, 0xf4(r30)
/* 804A6E2C  4B DC 0C A1 */	bl cM_rndF2__Ff
/* 804A6E30  C0 1E 00 F0 */	lfs f0, 0xf0(r30)
/* 804A6E34  EF A0 08 2A */	fadds f29, f0, f1
/* 804A6E38  C0 3E 00 F8 */	lfs f1, 0xf8(r30)
/* 804A6E3C  4B DC 0C 91 */	bl cM_rndF2__Ff
/* 804A6E40  C0 1E 00 50 */	lfs f0, 0x50(r30)
/* 804A6E44  EF 81 00 28 */	fsubs f28, f1, f0
/* 804A6E48  C0 3E 00 68 */	lfs f1, 0x68(r30)
/* 804A6E4C  4B DC 0C 81 */	bl cM_rndF2__Ff
/* 804A6E50  C0 1E 00 F8 */	lfs f0, 0xf8(r30)
/* 804A6E54  EF 61 00 28 */	fsubs f27, f1, f0
/* 804A6E58  48 00 00 60 */	b lbl_804A6EB8
lbl_804A6E5C:
/* 804A6E5C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804A6E60  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804A6E64  80 63 00 00 */	lwz r3, 0(r3)
/* 804A6E68  3C 80 80 4B */	lis r4, ke_za@ha /* 0x804A8A3C@ha */
/* 804A6E6C  38 84 8A 3C */	addi r4, r4, ke_za@l /* 0x804A8A3C@l */
...
/* 804A6ED4  4B DC A0 19 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804A6F1C  4B DC A0 3D */	bl MtxPull__Fv
...
/* 804A6F60  4B EB B2 B5 */	bl _restgpr_24
