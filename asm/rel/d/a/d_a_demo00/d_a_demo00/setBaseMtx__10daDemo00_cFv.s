...
/* 804A45B0  4B EB DC 2D */	bl _savegpr_29
/* 804A45B4  7C 7D 1B 78 */	mr r29, r3
/* 804A45B8  3C 60 80 4B */	lis r3, lit_3727@ha /* 0x804A8860@ha */
/* 804A45BC  3B E3 88 60 */	addi r31, r3, lit_3727@l /* 0x804A8860@l */
/* 804A45C0  3B C0 00 00 */	li r30, 0
/* 804A45C4  3C 60 80 4B */	lis r3, __vt__8cM3dGPla@ha /* 0x804A8C04@ha */
/* 804A45C8  38 03 8C 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x804A8C04@l */
...
/* 804A464C  4B DC 36 DD */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 804A4650  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804A4654  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804A4658  38 63 0F 38 */	addi r3, r3, 0xf38
/* 804A465C  80 9D 05 F8 */	lwz r4, 0x5f8(r29)
/* 804A4660  4B BC FE 41 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 804A468C  4B DC 29 E1 */	bl __ne__4cXyzCFRC3Vec
...
/* 804A46A0  4B EA 2C FD */	bl PSVECSquareDistance
...
/* 804A4710  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804A4714  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804A4780  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804A4784  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804A4788:
...
/* 804A480C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804A4810  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804A4824  4B BC FF 21 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 804A4838  4B DC 39 AD */	bl cBgW_CheckBGround__Ff
...
/* 804A484C  4B B7 93 8D */	bl fopAcM_getPolygonAngle__FPC8cM3dGPlas
...
/* 804A4898  4B DC BD 71 */	bl cLib_addCalcAngleS2__FPssss
...
/* 804A48AC  4B DC BD 5D */	bl cLib_addCalcAngleS2__FPssss
...
/* 804A48C0  4B DC BD 49 */	bl cLib_addCalcAngleS2__FPssss
lbl_804A48C4:
/* 804A48C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804A48C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804A48CC  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 804A48D0  C0 41 00 20 */	lfs f2, 0x20(r1)
/* 804A48D4  C0 61 00 24 */	lfs f3, 0x24(r1)
/* 804A48D8  4B EA 20 11 */	bl PSMTXTrans
/* 804A48DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804A48E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804A48E4  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 804A48E8  A8 BD 04 DE */	lha r5, 0x4de(r29)
/* 804A48EC  A8 DD 04 E0 */	lha r6, 0x4e0(r29)
/* 804A48F0  4B B6 78 75 */	bl mDoMtx_XYZrotM__FPA4_fsss
/* 804A48F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804A48F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804A48FC  80 9D 05 D4 */	lwz r4, 0x5d4(r29)
/* 804A4900  38 84 00 24 */	addi r4, r4, 0x24
/* 804A4904  4B EA 1B AD */	bl PSMTXCopy
...
/* 804A4924  3C 60 80 4B */	lis r3, __vt__8cM3dGPla@ha /* 0x804A8C04@ha */
/* 804A4928  38 03 8C 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x804A8C04@l */
/* 804A492C  90 01 00 38 */	stw r0, 0x38(r1)
/* 804A4930  39 61 00 50 */	addi r11, r1, 0x50
/* 804A4934  4B EB D8 F5 */	bl _restgpr_29
