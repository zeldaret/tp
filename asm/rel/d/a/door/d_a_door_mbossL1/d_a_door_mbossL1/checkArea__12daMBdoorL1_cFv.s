...
/* 806760C4  4B CE C1 19 */	bl _savegpr_29
/* 806760C8  7C 7E 1B 78 */	mr r30, r3
/* 806760CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806760D0  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806760F4  4B BF 0A 41 */	bl __mi__4cXyzCFRC3Vec
...
/* 8067611C  4B BF 0A 19 */	bl __mi__4cXyzCFRC3Vec
...
/* 80676148  4B BF 09 ED */	bl __mi__4cXyzCFRC3Vec
...
lbl_8067617C:
/* 8067617C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80676180  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80676184  7C 9E 07 34 */	extsh r30, r4
/* 80676188  7C 1E 00 D0 */	neg r0, r30
/* 8067618C  7C 04 07 34 */	extsh r4, r0
/* 80676190  4B 99 62 4D */	bl mDoMtx_YrotS__FPA4_fs
/* 80676194  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80676198  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8067619C  38 81 00 38 */	addi r4, r1, 0x38
/* 806761A0  7C 85 23 78 */	mr r5, r4
/* 806761A4  4B CD 0B C9 */	bl PSMTXMultVec
/* 806761A8  C0 01 00 38 */	lfs f0, 0x38(r1)
/* 806761AC  FC 00 02 10 */	fabs f0, f0
/* 806761B0  FC 20 00 18 */	frsp f1, f0
/* 806761B4  3C 60 80 67 */	lis r3, lit_5381@ha /* 0x80677650@ha */
/* 806761B8  C0 03 76 50 */	lfs f0, lit_5381@l(r3)  /* 0x80677650@l */
...
/* 806761DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806761E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806761E4  38 81 00 2C */	addi r4, r1, 0x2c
/* 806761E8  7C 85 23 78 */	mr r5, r4
/* 806761EC  4B CD 0B 81 */	bl PSMTXMultVec
/* 806761F0  C0 01 00 2C */	lfs f0, 0x2c(r1)
/* 806761F4  FC 00 02 10 */	fabs f0, f0
/* 806761F8  FC 20 00 18 */	frsp f1, f0
/* 806761FC  3C 60 80 67 */	lis r3, lit_5381@ha /* 0x80677650@ha */
/* 80676200  C0 03 76 50 */	lfs f0, lit_5381@l(r3)  /* 0x80677650@l */
...
/* 80676220  3C 60 80 67 */	lis r3, lit_5382@ha /* 0x80677654@ha */
/* 80676224  C0 03 76 54 */	lfs f0, lit_5382@l(r3)  /* 0x80677654@l */
...
/* 80676244  3C 60 80 67 */	lis r3, lit_5384@ha /* 0x80677658@ha */
/* 80676248  C8 23 76 58 */	lfd f1, lit_5384@l(r3)  /* 0x80677658@l */
...
/* 80676290  4B CE BF 99 */	bl _restgpr_29
