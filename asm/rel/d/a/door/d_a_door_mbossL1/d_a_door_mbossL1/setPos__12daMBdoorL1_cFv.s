...
/* 80675DC8  3C 60 80 67 */	lis r3, l_staff_name@ha /* 0x80677558@ha */
/* 80675DCC  3B E3 75 58 */	addi r31, r3, l_staff_name@l /* 0x80677558@l */
/* 80675DD0  C0 1F 00 40 */	lfs f0, 0x40(r31)
/* 80675DD4  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80675DD8  38 61 00 08 */	addi r3, r1, 8
/* 80675DDC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80675DE0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80675DE4  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80675DE8  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 80675DEC  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80675DF0  4B BF 0D 45 */	bl __mi__4cXyzCFRC3Vec
...
/* 80675E0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80675E10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80675E14  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 80675E18  7C 00 00 D0 */	neg r0, r0
/* 80675E1C  7C 04 07 34 */	extsh r4, r0
/* 80675E20  4B 99 65 BD */	bl mDoMtx_YrotS__FPA4_fs
/* 80675E24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80675E28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80675E2C  38 81 00 14 */	addi r4, r1, 0x14
/* 80675E30  7C 85 23 78 */	mr r5, r4
/* 80675E34  4B CD 0F 39 */	bl PSMTXMultVec
...
lbl_80675E84:
/* 80675E84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80675E88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80675E8C  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 80675E90  4B 99 65 4D */	bl mDoMtx_YrotS__FPA4_fs
/* 80675E94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80675E98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80675E9C  38 81 00 20 */	addi r4, r1, 0x20
/* 80675EA0  7C 85 23 78 */	mr r5, r4
/* 80675EA4  4B CD 0E C9 */	bl PSMTXMultVec
/* 80675EA8  38 61 00 20 */	addi r3, r1, 0x20
/* 80675EAC  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80675EB0  7C 65 1B 78 */	mr r5, r3
/* 80675EB4  4B CD 11 DD */	bl PSVECAdd
/* 80675EB8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80675EBC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80675EC0  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80675EC4  38 81 00 20 */	addi r4, r1, 0x20
/* 80675EC8  4B 9D 24 FD */	bl setGoal__16dEvent_manager_cFP4cXyz
