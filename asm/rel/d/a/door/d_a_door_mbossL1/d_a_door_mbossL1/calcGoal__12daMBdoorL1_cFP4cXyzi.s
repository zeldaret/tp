...
/* 806758A4  4B CE C9 35 */	bl _savegpr_28
/* 806758A8  7C 7C 1B 78 */	mr r28, r3
/* 806758AC  7C 9D 23 78 */	mr r29, r4
/* 806758B0  7C BE 2B 78 */	mr r30, r5
/* 806758B4  3C 60 80 67 */	lis r3, l_staff_name@ha /* 0x80677558@ha */
/* 806758B8  3B E3 75 58 */	addi r31, r3, l_staff_name@l /* 0x80677558@l */
/* 806758BC  38 61 00 08 */	addi r3, r1, 8
/* 806758C0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806758C4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806758C8  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806758CC  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 806758D0  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 806758D4  4B BF 12 61 */	bl __mi__4cXyzCFRC3Vec
...
/* 806758F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806758F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806758F8  A8 1C 04 DE */	lha r0, 0x4de(r28)
/* 806758FC  7C 00 00 D0 */	neg r0, r0
/* 80675900  7C 04 07 34 */	extsh r4, r0
/* 80675904  4B 99 6A D9 */	bl mDoMtx_YrotS__FPA4_fs
/* 80675908  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8067590C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80675910  38 81 00 14 */	addi r4, r1, 0x14
/* 80675914  7C 85 23 78 */	mr r5, r4
/* 80675918  4B CD 14 55 */	bl PSMTXMultVec
...
/* 8067598C  4B 99 73 D9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80675990  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80675994  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80675998  A8 9C 04 DE */	lha r4, 0x4de(r28)
/* 8067599C  4B 99 6A 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 806759A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806759A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806759A8  38 81 00 14 */	addi r4, r1, 0x14
/* 806759AC  7C 85 23 78 */	mr r5, r4
/* 806759B0  4B CD 13 BD */	bl PSMTXMultVec
...
/* 806759D0  4B CE C8 55 */	bl _restgpr_28
