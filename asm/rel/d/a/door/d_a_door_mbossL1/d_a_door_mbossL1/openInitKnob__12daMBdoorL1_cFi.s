...
/* 80675480  4B CE CD 59 */	bl _savegpr_28
/* 80675484  7C 7D 1B 78 */	mr r29, r3
/* 80675488  7C 9E 23 78 */	mr r30, r4
/* 8067548C  3C 80 80 67 */	lis r4, l_staff_name@ha /* 0x80677558@ha */
/* 80675490  3B E4 75 58 */	addi r31, r4, l_staff_name@l /* 0x80677558@l */
/* 80675494  57 C0 10 3A */	slwi r0, r30, 2
/* 80675498  3C 80 80 67 */	lis r4, bck_table@ha /* 0x80677BC0@ha */
/* 8067549C  38 84 7B C0 */	addi r4, r4, bck_table@l /* 0x80677BC0@l */
...
/* 806754AC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806754B0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806754B4  3C A5 00 02 */	addis r5, r5, 2
/* 806754B8  38 C0 00 80 */	li r6, 0x80
/* 806754BC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806754C0  4B 9C 6E BD */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80675594  4B 99 82 49 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 806755B4  4B 9B 7A B9 */	bl dComIfGp_getReverb__Fi
...
/* 806755C8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806755CC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806755F4  4B C3 63 91 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 806755F8  48 00 00 64 */	b lbl_8067565C
lbl_806755FC:
/* 806755FC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80675600  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80675604  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80675608  80 9D 05 98 */	lwz r4, 0x598(r29)
/* 8067560C  4B 9F EC 45 */	bl Release__4cBgSFP9dBgW_Base
/* 80675610  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80675614  7C 03 07 74 */	extsb r3, r0
/* 80675618  4B 9B 7A 55 */	bl dComIfGp_getReverb__Fi
...
/* 8067562C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80675630  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80675658  4B C3 63 2D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8067565C:
/* 8067565C  38 60 00 01 */	li r3, 1
/* 80675660  39 61 00 20 */	addi r11, r1, 0x20
/* 80675664  4B CE CB C1 */	bl _restgpr_28
