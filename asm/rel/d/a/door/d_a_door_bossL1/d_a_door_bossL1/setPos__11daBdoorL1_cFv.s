...
/* 804E3CE4  3C 60 80 4E */	lis r3, l_staff_name@ha /* 0x804E4A14@ha */
/* 804E3CE8  3B E3 4A 14 */	addi r31, r3, l_staff_name@l /* 0x804E4A14@l */
/* 804E3CEC  38 61 00 08 */	addi r3, r1, 8
/* 804E3CF0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804E3CF4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804E3CF8  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 804E3CFC  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 804E3D00  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 804E3D04  4B D8 2E 31 */	bl __mi__4cXyzCFRC3Vec
...
/* 804E3D20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804E3D24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804E3D28  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 804E3D2C  7C 00 00 D0 */	neg r0, r0
/* 804E3D30  7C 04 07 34 */	extsh r4, r0
/* 804E3D34  4B B2 86 A9 */	bl mDoMtx_YrotS__FPA4_fs
/* 804E3D38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804E3D3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804E3D40  38 81 00 14 */	addi r4, r1, 0x14
/* 804E3D44  7C 85 23 78 */	mr r5, r4
/* 804E3D48  4B E6 30 25 */	bl PSMTXMultVec
...
/* 804E3D88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804E3D8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804E3D90  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 804E3D94  4B B2 86 49 */	bl mDoMtx_YrotS__FPA4_fs
/* 804E3D98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804E3D9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804E3DA0  38 81 00 20 */	addi r4, r1, 0x20
/* 804E3DA4  7C 85 23 78 */	mr r5, r4
/* 804E3DA8  4B E6 2F C5 */	bl PSMTXMultVec
/* 804E3DAC  38 61 00 20 */	addi r3, r1, 0x20
/* 804E3DB0  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 804E3DB4  7C 65 1B 78 */	mr r5, r3
/* 804E3DB8  4B E6 32 D9 */	bl PSVECAdd
/* 804E3DBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804E3DC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804E3DC4  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 804E3DC8  38 81 00 20 */	addi r4, r1, 0x20
/* 804E3DCC  4B B6 45 F9 */	bl setGoal__16dEvent_manager_cFP4cXyz
