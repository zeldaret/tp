...
/* 804E3C44  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 804E3C48  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 804E3C4C  38 81 00 0C */	addi r4, r1, 0xc
/* 804E3C50  4B B3 5B A9 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 804E3C70  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804E3C74  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804E3C8C  3D 00 80 4E */	lis r8, lit_3861@ha /* 0x804E4A50@ha */
/* 804E3C90  C0 28 4A 50 */	lfs f1, lit_3861@l(r8)  /* 0x804E4A50@l */
/* 804E3C94  FC 40 08 90 */	fmr f2, f1
/* 804E3C98  3D 00 80 4E */	lis r8, lit_4238@ha /* 0x804E4A68@ha */
/* 804E3C9C  C0 68 4A 68 */	lfs f3, lit_4238@l(r8)  /* 0x804E4A68@l */
/* 804E3CA0  FC 80 18 90 */	fmr f4, f3
/* 804E3CA4  39 00 00 00 */	li r8, 0
/* 804E3CA8  4B DC 7C DD */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_804E3CAC:
