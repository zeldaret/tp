...
/* 804E1FBC  3C 80 80 4E */	lis r4, lit_3726@ha
/* 804E1FC0  38 84 4E B8 */	addi r4, r4, lit_3726@l
...
lbl_804E1FD4:
/* 804E1FD4  3C 60 80 4E */	lis r3, struct_804E4ADC+0x0@ha
/* 804E1FD8  38 63 4A DC */	addi r3, r3, struct_804E4ADC+0x0@l
/* 804E1FDC  38 63 01 F4 */	addi r3, r3, 0x1f4
/* 804E1FE0  48 00 00 70 */	b lbl_804E2050
lbl_804E1FE4:
/* 804E1FE4  3C 60 80 4E */	lis r3, struct_804E4ADC+0x0@ha
/* 804E1FE8  38 63 4A DC */	addi r3, r3, struct_804E4ADC+0x0@l
/* 804E1FEC  38 63 01 FC */	addi r3, r3, 0x1fc
/* 804E1FF0  48 00 00 60 */	b lbl_804E2050
lbl_804E1FF4:
/* 804E1FF4  3C 60 80 4E */	lis r3, struct_804E4ADC+0x0@ha
/* 804E1FF8  38 63 4A DC */	addi r3, r3, struct_804E4ADC+0x0@l
/* 804E1FFC  38 63 02 04 */	addi r3, r3, 0x204
/* 804E2000  48 00 00 50 */	b lbl_804E2050
lbl_804E2004:
/* 804E2004  3C 60 80 4E */	lis r3, struct_804E4ADC+0x0@ha
/* 804E2008  38 63 4A DC */	addi r3, r3, struct_804E4ADC+0x0@l
/* 804E200C  38 63 02 0C */	addi r3, r3, 0x20c
/* 804E2010  48 00 00 40 */	b lbl_804E2050
lbl_804E2014:
/* 804E2014  3C 60 80 4E */	lis r3, struct_804E4ADC+0x0@ha
/* 804E2018  38 63 4A DC */	addi r3, r3, struct_804E4ADC+0x0@l
/* 804E201C  38 63 02 14 */	addi r3, r3, 0x214
/* 804E2020  48 00 00 30 */	b lbl_804E2050
lbl_804E2024:
/* 804E2024  3C 60 80 4E */	lis r3, struct_804E4ADC+0x0@ha
/* 804E2028  38 63 4A DC */	addi r3, r3, struct_804E4ADC+0x0@l
/* 804E202C  38 63 02 1C */	addi r3, r3, 0x21c
/* 804E2030  48 00 00 20 */	b lbl_804E2050
lbl_804E2034:
/* 804E2034  3C 60 80 4E */	lis r3, struct_804E4ADC+0x0@ha
/* 804E2038  38 63 4A DC */	addi r3, r3, struct_804E4ADC+0x0@l
/* 804E203C  38 63 02 24 */	addi r3, r3, 0x224
/* 804E2040  48 00 00 10 */	b lbl_804E2050
lbl_804E2044:
/* 804E2044  3C 60 80 4E */	lis r3, struct_804E4ADC+0x0@ha
/* 804E2048  38 63 4A DC */	addi r3, r3, struct_804E4ADC+0x0@l
