...
/* 804E4784  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804E4788  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804E478C  38 80 00 10 */	li r4, 0x10
/* 804E4790  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 804E4794  38 DE 01 0C */	addi r6, r30, 0x10c
/* 804E4798  4B CB F0 2D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 804E479C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804E47A0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804E47A4  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 804E47A8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 804E47AC  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 804E47E4  4B B2 8E F5 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_804E47E8:
/* 804E47E8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804E47EC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804E47F0  80 9E 05 80 */	lwz r4, 0x580(r30)
/* 804E47F4  80 84 00 04 */	lwz r4, 4(r4)
/* 804E47F8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 804E47FC  4B CC 05 A5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804E4810  4B B2 91 BD */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 804E4814  80 7E 05 80 */	lwz r3, 0x580(r30)
/* 804E4818  4B B2 94 AD */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 804E4840  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804E4844  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804E4848  80 84 00 04 */	lwz r4, 4(r4)
/* 804E484C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 804E4850  4B CC 05 51 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804E4864  4B B2 91 69 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 804E4868  80 7E 05 84 */	lwz r3, 0x584(r30)
/* 804E486C  4B B2 94 59 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
lbl_804E4888:
/* 804E4888  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804E488C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
