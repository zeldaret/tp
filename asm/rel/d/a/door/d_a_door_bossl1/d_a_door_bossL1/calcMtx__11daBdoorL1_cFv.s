...
/* 804E2590  3C 80 80 4E */	lis r4, lit_3919@ha
/* 804E2594  C0 04 4A 54 */	lfs f0, lit_3919@l(r4)
...
/* 804E25AC  3C 80 80 4E */	lis r4, lit_3920@ha
/* 804E25B0  C0 04 4A 58 */	lfs f0, lit_3920@l(r4)
...
lbl_804E25D4:
/* 804E25D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E25D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E25DC  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 804E25E0  4B B2 9D FC */	b mDoMtx_YrotS__FPA4_fs
/* 804E25E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E25E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E25EC  38 81 00 14 */	addi r4, r1, 0x14
/* 804E25F0  7C 85 23 78 */	mr r5, r4
/* 804E25F4  4B E6 47 78 */	b PSMTXMultVec
/* 804E25F8  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 804E25FC  4B B2 A7 68 */	b transS__14mDoMtx_stack_cFRC4cXyz
...
/* 804E2614  4B B2 A7 C0 */	b transM__14mDoMtx_stack_cFRC4cXyz
lbl_804E2618:
/* 804E2618  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E261C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E2620  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 804E2624  38 04 7F FF */	addi r0, r4, 0x7fff
/* 804E2628  7C 04 07 34 */	extsh r4, r0
/* 804E262C  4B B2 9E 08 */	b mDoMtx_YrotM__FPA4_fs
/* 804E2630  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E2634  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E2638  80 9F 05 80 */	lwz r4, 0x580(r31)
/* 804E263C  38 84 00 24 */	addi r4, r4, 0x24
/* 804E2640  4B E6 3E 70 */	b PSMTXCopy
/* 804E2644  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 804E2648  4B B2 A7 1C */	b transS__14mDoMtx_stack_cFRC4cXyz
...
/* 804E2660  4B B2 A7 74 */	b transM__14mDoMtx_stack_cFRC4cXyz
lbl_804E2664:
/* 804E2664  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E2668  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E266C  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 804E2670  4B B2 9D C4 */	b mDoMtx_YrotM__FPA4_fs
/* 804E2674  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E2678  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E267C  80 9F 05 84 */	lwz r4, 0x584(r31)
/* 804E2680  38 84 00 24 */	addi r4, r4, 0x24
/* 804E2684  4B E6 3E 2C */	b PSMTXCopy
...
/* 804E26A4  4B E6 3E 0C */	b PSMTXCopy
...
/* 804E26B8  4B E6 3D F8 */	b PSMTXCopy
/* 804E26BC  48 00 00 84 */	b lbl_804E2740
lbl_804E26C0:
/* 804E26C0  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 804E26C4  4B B2 A6 A0 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 804E26C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E26CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E26D0  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 804E26D4  4B B2 9D 60 */	b mDoMtx_YrotM__FPA4_fs
/* 804E26D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E26DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E26E0  80 9F 05 80 */	lwz r4, 0x580(r31)
/* 804E26E4  38 84 00 24 */	addi r4, r4, 0x24
/* 804E26E8  4B E6 3D C8 */	b PSMTXCopy
/* 804E26EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E26F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E26F4  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 804E26F8  4B B2 9C E4 */	b mDoMtx_YrotS__FPA4_fs
/* 804E26FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E2700  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E2704  38 81 00 08 */	addi r4, r1, 8
/* 804E2708  7C 85 23 78 */	mr r5, r4
/* 804E270C  4B E6 46 60 */	b PSMTXMultVec
/* 804E2710  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 804E2714  4B B2 A6 50 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 804E2718  38 61 00 08 */	addi r3, r1, 8
/* 804E271C  4B B2 A6 B8 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 804E2720  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E2724  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E2728  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 804E272C  4B B2 9D 08 */	b mDoMtx_YrotM__FPA4_fs
/* 804E2730  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E2734  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E2738  38 9F 07 EC */	addi r4, r31, 0x7ec
/* 804E273C  4B E6 3D 74 */	b PSMTXCopy
lbl_804E2740:
