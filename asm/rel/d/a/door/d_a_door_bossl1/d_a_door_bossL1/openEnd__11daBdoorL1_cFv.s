...
/* 804E37D8  4B B4 98 95 */	bl dComIfGp_getReverb__Fi
...
/* 804E37EC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804E37F0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804E3804  3D 00 80 4E */	lis r8, lit_3861@ha /* 0x804E4A50@ha */
/* 804E3808  C0 28 4A 50 */	lfs f1, lit_3861@l(r8)  /* 0x804E4A50@l */
/* 804E380C  FC 40 08 90 */	fmr f2, f1
/* 804E3810  3D 00 80 4E */	lis r8, lit_4238@ha /* 0x804E4A68@ha */
/* 804E3814  C0 68 4A 68 */	lfs f3, lit_4238@l(r8)  /* 0x804E4A68@l */
/* 804E3818  FC 80 18 90 */	fmr f4, f3
/* 804E381C  39 00 00 00 */	li r8, 0
/* 804E3820  4B DC 81 65 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_804E3824:
/* 804E3824  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804E3828  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804E382C  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 804E3830  38 80 00 1F */	li r4, 0x1f
/* 804E3834  4B B8 C5 61 */	bl StopQuake__12dVibration_cFi
