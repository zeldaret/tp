...
/* 80678BD4  3C 60 80 68 */	lis r3, lit_3688@ha /* 0x80678ECC@ha */
/* 80678BD8  38 63 8E CC */	addi r3, r3, lit_3688@l /* 0x80678ECC@l */
...
/* 80678C20  4B 99 41 45 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80678C24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80678C28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80678C2C  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 80678C30  4B 99 38 05 */	bl mDoMtx_YrotM__FPA4_fs
/* 80678C34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80678C38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80678C3C  38 81 00 08 */	addi r4, r1, 8
/* 80678C40  7C 85 23 78 */	mr r5, r4
/* 80678C44  4B CC E1 29 */	bl PSMTXMultVec
/* 80678C48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80678C4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80678C50  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80678C54  38 81 00 08 */	addi r4, r1, 8
/* 80678C58  4B 9C F7 6D */	bl setGoal__16dEvent_manager_cFP4cXyz
