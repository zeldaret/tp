...
/* 804D1FF4  4B DE C0 05 */	bl deleteObject__14Z2SoundObjBaseFv
...
/* 804D2010  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 804D2014  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 804D2034  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 804D2038  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 804D2050  3C 60 80 4D */	lis r3, __vt__8cM3dGCyl@ha /* 0x804D4F78@ha */
/* 804D2054  38 03 4F 78 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x804D4F78@l */
/* 804D2058  90 1E 0A 60 */	stw r0, 0xa60(r30)
lbl_804D205C:
/* 804D205C  34 1E 0A 2C */	addic. r0, r30, 0xa2c
/* 804D2060  41 82 00 24 */	beq lbl_804D2084
/* 804D2064  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 804D2068  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 804D206C  90 1E 0A 48 */	stw r0, 0xa48(r30)
/* 804D2070  34 1E 0A 2C */	addic. r0, r30, 0xa2c
/* 804D2074  41 82 00 10 */	beq lbl_804D2084
/* 804D2078  3C 60 80 4D */	lis r3, __vt__8cM3dGAab@ha /* 0x804D4F84@ha */
/* 804D207C  38 03 4F 84 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x804D4F84@l */
/* 804D2080  90 1E 0A 44 */	stw r0, 0xa44(r30)
lbl_804D2084:
/* 804D2084  38 7E 09 28 */	addi r3, r30, 0x928
/* 804D2088  38 80 00 00 */	li r4, 0
/* 804D208C  4B BB 20 59 */	bl __dt__12dCcD_GObjInfFv
lbl_804D2090:
/* 804D2090  34 1E 08 EC */	addic. r0, r30, 0x8ec
/* 804D2094  41 82 00 54 */	beq lbl_804D20E8
/* 804D2098  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 804D209C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 804D20B4  3C 60 80 4D */	lis r3, __vt__10dCcD_GStts@ha /* 0x804D4F6C@ha */
/* 804D20B8  38 03 4F 6C */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x804D4F6C@l */
/* 804D20BC  90 1E 09 08 */	stw r0, 0x908(r30)
/* 804D20C0  34 1E 09 08 */	addic. r0, r30, 0x908
/* 804D20C4  41 82 00 10 */	beq lbl_804D20D4
/* 804D20C8  3C 60 80 4D */	lis r3, __vt__10cCcD_GStts@ha /* 0x804D4F60@ha */
/* 804D20CC  38 03 4F 60 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x804D4F60@l */
/* 804D20D0  90 1E 09 08 */	stw r0, 0x908(r30)
lbl_804D20D4:
/* 804D20D4  34 1E 08 EC */	addic. r0, r30, 0x8ec
/* 804D20D8  41 82 00 10 */	beq lbl_804D20E8
/* 804D20DC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 804D20E0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 804D20E4  90 1E 09 04 */	stw r0, 0x904(r30)
lbl_804D20E8:
/* 804D20E8  34 1E 08 CC */	addic. r0, r30, 0x8cc
/* 804D20EC  41 82 00 1C */	beq lbl_804D2108
/* 804D20F0  3C 60 80 3D */	lis r3, __vt__16Z2SoundObjSimple@ha /* 0x803CAD10@ha */
/* 804D20F4  38 03 AD 10 */	addi r0, r3, __vt__16Z2SoundObjSimple@l /* 0x803CAD10@l */
/* 804D20F8  90 1E 08 DC */	stw r0, 0x8dc(r30)
/* 804D20FC  38 7E 08 CC */	addi r3, r30, 0x8cc
/* 804D2100  38 80 00 00 */	li r4, 0
/* 804D2104  4B DE BE 45 */	bl __dt__14Z2SoundObjBaseFv
lbl_804D2108:
/* 804D2108  38 7E 08 24 */	addi r3, r30, 0x824
/* 804D210C  38 80 FF FF */	li r4, -1
/* 804D2110  4B BA 5F 7D */	bl __dt__15dBgS_LinkLinChkFv
/* 804D2114  34 1E 06 4C */	addic. r0, r30, 0x64c
/* 804D2118  41 82 00 2C */	beq lbl_804D2144
/* 804D211C  3C 60 80 4D */	lis r3, __vt__13dBgS_LinkAcch@ha /* 0x804D4F90@ha */
/* 804D2120  38 63 4F 90 */	addi r3, r3, __vt__13dBgS_LinkAcch@l /* 0x804D4F90@l */
...
/* 804D2140  4B BA 3E 55 */	bl __dt__9dBgS_AcchFv
lbl_804D2144:
/* 804D2144  38 7E 05 8C */	addi r3, r30, 0x58c
/* 804D2148  3C 80 80 4D */	lis r4, __dt__12dBgS_AcchCirFv@ha /* 0x804D1EF8@ha */
/* 804D214C  38 84 1E F8 */	addi r4, r4, __dt__12dBgS_AcchCirFv@l /* 0x804D1EF8@l */
/* 804D2150  38 A0 00 40 */	li r5, 0x40
/* 804D2154  38 C0 00 03 */	li r6, 3
/* 804D2158  4B E8 FB 91 */	bl __destroy_arr
...
/* 804D2174  3C 60 80 4D */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x804D4FB4@ha */
/* 804D2178  38 03 4F B4 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x804D4FB4@l */
/* 804D217C  90 1E 05 6C */	stw r0, 0x56c(r30)
lbl_804D2180:
/* 804D2180  7F C3 F3 78 */	mr r3, r30
/* 804D2184  38 80 00 00 */	li r4, 0
/* 804D2188  4B B4 6B 05 */	bl __dt__10fopAc_ac_cFv
/* 804D218C  7F E0 07 35 */	extsh. r0, r31
/* 804D2190  40 81 00 0C */	ble lbl_804D219C
/* 804D2194  7F C3 F3 78 */	mr r3, r30
/* 804D2198  4B DF CB A5 */	bl __dl__FPv
lbl_804D219C:
