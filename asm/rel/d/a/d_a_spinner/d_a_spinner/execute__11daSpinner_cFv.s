...
/* 804D3FB4  4B E8 E2 19 */	bl _savegpr_25
/* 804D3FB8  7C 7F 1B 78 */	mr r31, r3
/* 804D3FBC  3C 80 80 4D */	lis r4, lit_3768@ha /* 0x804D4D90@ha */
/* 804D3FC0  3B C4 4D 90 */	addi r30, r4, lit_3768@l /* 0x804D4D90@l */
...
/* 804D3FD8  4B B4 5C A5 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 804D3FEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D3FF0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804D4034:
/* 804D4034  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D4038  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804D4084  3C 60 80 4D */	lis r3, d_a_spinner__stringBase0@ha /* 0x804D4EA0@ha */
/* 804D4088  38 63 4E A0 */	addi r3, r3, d_a_spinner__stringBase0@l /* 0x804D4EA0@l */
/* 804D408C  4B BC 99 D5 */	bl checkStageName__9daAlink_cFPCc
...
lbl_804D40E0:
/* 804D40E0  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 804D40E4  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
/* 804D40E8  C3 A3 00 08 */	lfs f29, 8(r3)
lbl_804D40EC:
/* 804D40EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D40F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804D4108  3C 80 80 3E */	lis r4, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 804D410C  38 84 D2 E8 */	addi r4, r4, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
/* 804D4110  AB 44 00 0C */	lha r26, 0xc(r4)
/* 804D4114  4B CA D5 01 */	bl dCam_getControledAngleY__FP12camera_class
...
/* 804D412C  4B B5 A8 A9 */	bl dComIfG_getTrigA__FUl
...
/* 804D4250  4B B3 91 D9 */	bl play__14mDoExt_baseAnmFv
...
/* 804D4280  4B D9 36 D5 */	bl cM_rndF__Ff
...
/* 804D42B4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804D42B8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804D4310  4B B4 59 6D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 804D432C  4B C3 96 41 */	bl getSpinnerRideMoveTime__9daAlink_cFv
/* 804D4330  B0 7F 0A 7A */	sth r3, 0xa7a(r31)
/* 804D4334  7F A3 EB 78 */	mr r3, r29
/* 804D4338  4B C3 96 79 */	bl getSpinnerRideSpeedF__9daAlink_cFv
...
/* 804D4370  4B D9 C6 21 */	bl cLib_chasePosXZ__FP4cXyzRC4cXyzf
...
/* 804D43D8  4B D9 C3 69 */	bl cLib_chaseF__FPfff
...
/* 804D4408  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D440C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804D4430  4B B7 8C 39 */	bl setPoly__13dPa_control_cFUsR13cBgS_PolyInfoPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyziP18dPa_levelEcallBackScPC4cXyz
...
/* 804D4458  4B B9 B5 CD */	bl StartShock__12dVibration_cFii4cXyz
...
/* 804D4508  4B D9 C2 39 */	bl cLib_chaseF__FPfff
...
/* 804D451C  4B C3 94 E9 */	bl getSpinnerRideDecSpeedMin__9daAlink_cCFv
/* 804D4520  FF C0 08 90 */	fmr f30, f1
/* 804D4524  7F A3 EB 78 */	mr r3, r29
/* 804D4528  4B C3 94 CD */	bl getSpinnerRideDecSpeedMax__9daAlink_cCFv
/* 804D452C  FF E0 08 90 */	fmr f31, f1
/* 804D4530  7F A3 EB 78 */	mr r3, r29
/* 804D4534  4B C3 94 E1 */	bl getSpinnerRideDecSpeedRate__9daAlink_cCFv
...
/* 804D454C  4B D9 B4 31 */	bl cLib_addCalc__FPfffff
...
lbl_804D45AC:
/* 804D45AC  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha /* 0x804D4F3C@ha */
/* 804D45B0  38 03 4F 3C */	addi r0, r3, __vt__8cM3dGPla@l /* 0x804D4F3C@l */
...
/* 804D45D0  4B BA 01 75 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 804D45D4  38 61 00 6C */	addi r3, r1, 0x6c
/* 804D45D8  4B D9 2B 51 */	bl atan2sX_Z__4cXyzCFv
...
/* 804D4624  4B CD 6E 9D */	bl dKy_pol_sound_get__FPC13cBgS_PolyInfo
...
/* 804D4668  4B BA 06 55 */	bl GetSpecialCode__4dBgSFRC13cBgS_PolyInfo
...
/* 804D46AC  4B BA FC 15 */	bl ChkAtHit__12dCcD_GObjInfFv
...
/* 804D46C8  4B BA FC E1 */	bl GetAtHitGObj__12dCcD_GObjInfFv
/* 804D46CC  28 03 00 00 */	cmplwi r3, 0
/* 804D46D0  41 82 00 A4 */	beq lbl_804D4774
/* 804D46D4  38 7F 09 28 */	addi r3, r31, 0x928
/* 804D46D8  4B BA FC D1 */	bl GetAtHitGObj__12dCcD_GObjInfFv
...
/* 804D46F0  4B BA EF 99 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 804D46F4  28 03 00 00 */	cmplwi r3, 0
/* 804D46F8  41 82 00 3C */	beq lbl_804D4734
/* 804D46FC  7F 23 CB 78 */	mr r3, r25
/* 804D4700  4B BA EF 89 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 804D4714  4B D9 24 21 */	bl __mi__4cXyzCFRC3Vec
...
/* 804D4740  4B D9 23 F5 */	bl __mi__4cXyzCFRC3Vec
...
/* 804D4760  4B D9 29 C9 */	bl atan2sX_Z__4cXyzCFv
...
/* 804D478C  4B C3 92 A9 */	bl getSpinnerRideRotAngleMin__9daAlink_cCFv
/* 804D4790  7C 79 1B 78 */	mr r25, r3
/* 804D4794  7F A3 EB 78 */	mr r3, r29
/* 804D4798  4B C3 92 8D */	bl getSpinnerRideRotAngleMax__9daAlink_cCFv
...
/* 804D47B0  4B D9 BD 91 */	bl cLib_addCalcAngleS__FPsssss
lbl_804D47B4:
...
/* 804D47E0  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha /* 0x804D4F3C@ha */
/* 804D47E4  38 03 4F 3C */	addi r0, r3, __vt__8cM3dGPla@l /* 0x804D4F3C@l */
...
/* 804D4810  4B C3 92 15 */	bl getSpinnerRideRotAngleMax__9daAlink_cCFv
...
/* 804D4840  4B D9 BD 01 */	bl cLib_addCalcAngleS__FPsssss
...
/* 804D4868  4B C3 91 49 */	bl getSpinnerRideSpeedF__9daAlink_cFv
...
/* 804D48A8  4B D9 BC 99 */	bl cLib_addCalcAngleS__FPsssss
...
/* 804D4954  4B E7 2A 49 */	bl PSVECSquareDistance
...
/* 804D49EC  4B BA 20 C1 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 804D4A58  4B B4 90 8D */	bl fopAcM_getPolygonAngle__FRC13cBgS_PolyInfos
...
/* 804D4A74  4B BA FE E1 */	bl MoveCAt__8dCcD_CylFR4cXyz
/* 804D4A78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D4A7C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D4A80  38 63 23 3C */	addi r3, r3, 0x233c
/* 804D4A84  38 9F 09 28 */	addi r4, r31, 0x928
/* 804D4A88  4B D9 01 21 */	bl Set__4cCcSFP8cCcD_Obj
/* 804D4A8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D4A90  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D4A94  38 63 4B 88 */	addi r3, r3, 0x4b88
/* 804D4A98  38 9F 09 28 */	addi r4, r31, 0x928
/* 804D4A9C  38 A0 00 01 */	li r5, 1
/* 804D4AA0  4B BB 12 F9 */	bl Set__12dCcMassS_MngFP8cCcD_ObjUc
...
/* 804D4B40  4B BA 14 01 */	bl SetWallR__12dBgS_AcchCirFf
/* 804D4B44  38 7F 0A 4C */	addi r3, r31, 0xa4c
/* 804D4B48  C0 3E 00 18 */	lfs f1, 0x18(r30)
/* 804D4B4C  4B D9 A6 B5 */	bl SetR__8cM3dGCylFf
...
/* 804D4B80  4B E8 D6 99 */	bl _restgpr_25
