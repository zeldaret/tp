...
/* 8046A734  4B EF 7A A1 */	bl _savegpr_27
/* 8046A738  7C 7F 1B 78 */	mr r31, r3
/* 8046A73C  3C 60 80 47 */	lis r3, d_a_ep__stringBase0@ha /* 0x8046B0D0@ha */
/* 8046A740  38 63 B0 D0 */	addi r3, r3, d_a_ep__stringBase0@l /* 0x8046B0D0@l */
...
/* 8046A754  3C 80 80 47 */	lis r4, model_d@ha /* 0x8046B13C@ha */
/* 8046A758  38 84 B1 3C */	addi r4, r4, model_d@l /* 0x8046B13C@l */
/* 8046A75C  7C 84 00 2E */	lwzx r4, r4, r0
/* 8046A760  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8046A764  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8046A778  4B BD 1B 75 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8046A788  4B BA A4 CD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8046A7A4:
/* 8046A7A4  3C 60 80 47 */	lis r3, lit_3683@ha /* 0x8046AFCC@ha */
/* 8046A7A8  C0 23 AF CC */	lfs f1, lit_3683@l(r3)  /* 0x8046AFCC@l */
/* 8046A7AC  FC 40 08 90 */	fmr f2, f1
/* 8046A7B0  FC 60 08 90 */	fmr f3, f1
/* 8046A7B4  38 60 00 00 */	li r3, 0
/* 8046A7B8  4B E0 66 ED */	bl MtxScale__FfffUc
/* 8046A7BC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8046A7C0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8046A7C4  80 63 00 00 */	lwz r3, 0(r3)
/* 8046A7C8  80 9F 05 A0 */	lwz r4, 0x5a0(r31)
/* 8046A7CC  38 84 00 24 */	addi r4, r4, 0x24
/* 8046A7D0  4B ED BC E1 */	bl PSMTXCopy
/* 8046A7D4  3C 60 80 47 */	lis r3, d_a_ep__stringBase0@ha /* 0x8046B0D0@ha */
/* 8046A7D8  38 63 B0 D0 */	addi r3, r3, d_a_ep__stringBase0@l /* 0x8046B0D0@l */
...
/* 8046A7EC  4B BD 1B 01 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8046A80C  4B BA A4 49 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8046A844  4B EF 79 DD */	bl _restgpr_27
