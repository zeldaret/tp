...
/* 805AA234  4B DB 7F A9 */	bl _savegpr_29
/* 805AA238  7C 7E 1B 78 */	mr r30, r3
/* 805AA23C  3C 80 80 5B */	lis r4, lit_3864@ha /* 0x805AA454@ha */
/* 805AA240  3B A4 A4 54 */	addi r29, r4, lit_3864@l /* 0x805AA454@l */
...
/* 805AA25C  4B A6 E9 09 */	bl __ct__10fopAc_ac_cFv
/* 805AA260  38 7F 05 74 */	addi r3, r31, 0x574
/* 805AA264  4B D1 6D 01 */	bl __ct__15Z2CreatureEnemyFv
lbl_805AA268:
...
/* 805AA278  4B A8 27 05 */	bl getLayerNo__14dComIfG_play_cFi
/* 805AA27C  2C 03 00 03 */	cmpwi r3, 3
/* 805AA280  40 82 01 14 */	bne lbl_805AA394
/* 805AA284  38 7E 05 68 */	addi r3, r30, 0x568
/* 805AA288  3C 80 80 5B */	lis r4, d_a_L7demo_dr__stringBase0@ha /* 0x805AA4C8@ha */
/* 805AA28C  38 84 A4 C8 */	addi r4, r4, d_a_L7demo_dr__stringBase0@l /* 0x805AA4C8@l */
/* 805AA290  4B A8 2C 2D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 805AA2A4  3C 80 80 5B */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x805AA17C@ha */
/* 805AA2A8  38 84 A1 7C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x805AA17C@l */
/* 805AA2AC  38 A0 68 C0 */	li r5, 0x68c0
/* 805AA2B0  4B A7 02 01 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 805AA308  4B D1 6D 8D */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 805AA328  3C 60 80 5B */	lis r3, lit_4306@ha /* 0x805AA50C@ha */
/* 805AA32C  38 83 A5 0C */	addi r4, r3, lit_4306@l /* 0x805AA50C@l */
...
/* 805AA364  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805AA368  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805AA36C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805AA370  7C 05 07 74 */	extsb r5, r0
/* 805AA374  4B A8 AF ED */	bl isSwitch__10dSv_info_cCFii
...
/* 805AA3B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805AA3BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805AA3C0  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805AA3C4  7C 05 07 74 */	extsb r5, r0
/* 805AA3C8  4B A8 AF 99 */	bl isSwitch__10dSv_info_cCFii
...
lbl_805AA3DC:
/* 805AA3DC  3C 60 80 5B */	lis r3, lit_4317@ha /* 0x805AA518@ha */
/* 805AA3E0  38 83 A5 18 */	addi r4, r3, lit_4317@l /* 0x805AA518@l */
...
/* 805AA418  4B DB 7E 11 */	bl _restgpr_29
