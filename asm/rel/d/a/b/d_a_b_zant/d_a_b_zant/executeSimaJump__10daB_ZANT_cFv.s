...
/* 80644A4C  4B D1 D7 91 */	bl _savegpr_29
/* 80644A50  7C 7E 1B 78 */	mr r30, r3
/* 80644A54  3C 80 80 65 */	lis r4, lit_3757@ha /* 0x8064EB1C@ha */
/* 80644A58  3B E4 EB 1C */	addi r31, r4, lit_3757@l /* 0x8064EB1C@l */
...
/* 80644BC0  4B C2 2D 95 */	bl cM_rndF__Ff
...
/* 80644C34  3C 60 80 65 */	lis r3, l_HIO@ha /* 0x8064F604@ha */
/* 80644C38  38 63 F6 04 */	addi r3, r3, l_HIO@l /* 0x8064F604@l */
...
/* 80644CB4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80644CB8  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80644CBC  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 80644CC0  4B 9D 5A 51 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80644CD8  4B C2 B8 69 */	bl cLib_addCalcAngleS__FPsssss
/* 80644CDC  7F C3 F3 78 */	mr r3, r30
/* 80644CE0  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 80644CE4  4B 9D 5A FD */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80644D88  4B CE 36 A5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80644DC8  4B CE 36 65 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80644E3C  4B CE 35 F1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80644EFC  4B 9D 81 25 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
lbl_80644F40:
/* 80644F40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80644F44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80644F48  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80644F4C  C0 23 04 D0 */	lfs f1, 0x4d0(r3)
/* 80644F50  C0 43 04 D8 */	lfs f2, 0x4d8(r3)
/* 80644F54  4B C2 27 21 */	bl cM_atan2s__Fff
/* 80644F58  7C 7D 1B 78 */	mr r29, r3
/* 80644F5C  C0 3F 01 E4 */	lfs f1, 0x1e4(r31)
/* 80644F60  4B C2 2A 2D */	bl cM_rndFX__Ff
...
/* 80644FA8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80644FAC  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80645000  4B D1 D2 29 */	bl _restgpr_29
