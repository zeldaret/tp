...
/* 8064CD1C  4B D1 54 BD */	bl _savegpr_28
/* 8064CD20  7C 7C 1B 78 */	mr r28, r3
/* 8064CD24  3C 60 80 65 */	lis r3, lit_3757@ha /* 0x8064EB1C@ha */
/* 8064CD28  3B C3 EB 1C */	addi r30, r3, lit_3757@l /* 0x8064EB1C@l */
...
/* 8064CD40  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8064CD44  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8064CD48  4B CF 97 69 */	bl PSMTXCopy
/* 8064CD4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8064CD50  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8064CDE8  4B C2 28 61 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8064CDEC  38 7C 0B 04 */	addi r3, r28, 0xb04
/* 8064CDF0  C0 3E 01 0C */	lfs f1, 0x10c(r30)
/* 8064CDF4  4B C2 29 15 */	bl SetR__8cM3dGSphFf
/* 8064CDF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8064CDFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8064CE00  3B A3 23 3C */	addi r29, r3, 0x233c
/* 8064CE04  7F A3 EB 78 */	mr r3, r29
/* 8064CE08  38 9C 09 E0 */	addi r4, r28, 0x9e0
/* 8064CE0C  4B C1 7D 9D */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8064CE24  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8064CE28  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8064CE2C  4B CF 96 85 */	bl PSMTXCopy
/* 8064CE30  C0 3E 01 98 */	lfs f1, 0x198(r30)
/* 8064CE34  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 8064CE38  FC 60 10 90 */	fmr f3, f2
/* 8064CE3C  4B 9B FF 61 */	bl transM__14mDoMtx_stack_cFfff
...
/* 8064CECC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8064CED0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8064CED4  4B CF 95 DD */	bl PSMTXCopy
/* 8064CED8  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 8064CEDC  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 8064CEE0  FC 60 10 90 */	fmr f3, f2
/* 8064CEE4  4B 9B FE B9 */	bl transM__14mDoMtx_stack_cFfff
...
/* 8064CF38  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8064CF3C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8064CF40  4B CF 95 71 */	bl PSMTXCopy
/* 8064CF44  C0 3E 00 38 */	lfs f1, 0x38(r30)
/* 8064CF48  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 8064CF4C  FC 60 10 90 */	fmr f3, f2
/* 8064CF50  4B 9B FE 4D */	bl transM__14mDoMtx_stack_cFfff
