...
/* 8064DC14  4B D1 45 C5 */	bl _savegpr_28
/* 8064DC18  7C 7F 1B 78 */	mr r31, r3
/* 8064DC1C  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064DC20  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064DC24  38 80 00 48 */	li r4, 0x48
/* 8064DC28  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8064DC2C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8064DC40  4B 9E E6 AD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8064DC44  7C 7C 1B 78 */	mr r28, r3
/* 8064DC48  38 60 00 58 */	li r3, 0x58
/* 8064DC4C  4B C8 10 01 */	bl __nw__FUl
/* 8064DC50  7C 7D 1B 79 */	or. r29, r3, r3
/* 8064DC54  41 82 00 68 */	beq lbl_8064DCBC
/* 8064DC58  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064DC5C  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064DC60  38 80 00 12 */	li r4, 0x12
/* 8064DC64  7F C5 F3 78 */	mr r5, r30
/* 8064DC68  38 C0 00 80 */	li r6, 0x80
/* 8064DC6C  4B 9E E6 81 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064DCA4  3D 20 80 65 */	lis r9, lit_4169@ha /* 0x8064EB28@ha */
/* 8064DCA8  C0 29 EB 28 */	lfs f1, lit_4169@l(r9)  /* 0x8064EB28@l */
/* 8064DCAC  39 20 00 00 */	li r9, 0
/* 8064DCB0  39 40 FF FF */	li r10, -1
/* 8064DCB4  4B 9C 2B 1D */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8064DCF0  3C 60 80 64 */	lis r3, JointCallBack__10daB_ZANT_cFP8J3DJointi@ha /* 0x8063E264@ha */
/* 8064DCF4  38 03 E2 64 */	addi r0, r3, JointCallBack__10daB_ZANT_cFP8J3DJointi@l /* 0x8063E264@l */
...
/* 8064DD0C  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064DD10  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064DD14  38 80 00 49 */	li r4, 0x49
/* 8064DD18  7F C5 F3 78 */	mr r5, r30
/* 8064DD1C  38 C0 00 80 */	li r6, 0x80
/* 8064DD20  4B 9E E5 CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064DD30  4B 9C 6F 25 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8064DD50  4B C8 0E FD */	bl __nw__FUl
/* 8064DD54  7C 7D 1B 79 */	or. r29, r3, r3
/* 8064DD58  41 82 00 20 */	beq lbl_8064DD78
/* 8064DD5C  3C 80 80 65 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x8064F550@ha */
/* 8064DD60  38 04 F5 50 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x8064F550@l */
/* 8064DD64  90 1D 00 00 */	stw r0, 0(r29)
/* 8064DD68  38 80 00 00 */	li r4, 0
/* 8064DD6C  4B CD A6 91 */	bl init__12J3DFrameCtrlFs
...
lbl_8064DD90:
/* 8064DD90  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064DD94  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064DD98  38 80 00 4F */	li r4, 0x4f
/* 8064DD9C  7F C5 F3 78 */	mr r5, r30
/* 8064DDA0  38 C0 00 80 */	li r6, 0x80
/* 8064DDA4  4B 9E E5 49 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064DDC4  3D 00 80 65 */	lis r8, lit_4169@ha /* 0x8064EB28@ha */
/* 8064DDC8  C0 28 EB 28 */	lfs f1, lit_4169@l(r8)  /* 0x8064EB28@l */
/* 8064DDCC  39 00 00 00 */	li r8, 0
/* 8064DDD0  39 20 FF FF */	li r9, -1
/* 8064DDD4  4B 9B F9 39 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 8064DDEC  4B C8 0E 61 */	bl __nw__FUl
/* 8064DDF0  7C 7D 1B 79 */	or. r29, r3, r3
/* 8064DDF4  41 82 00 20 */	beq lbl_8064DE14
/* 8064DDF8  3C 80 80 65 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x8064F550@ha */
/* 8064DDFC  38 04 F5 50 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x8064F550@l */
/* 8064DE00  90 1D 00 00 */	stw r0, 0(r29)
/* 8064DE04  38 80 00 00 */	li r4, 0
/* 8064DE08  4B CD A5 F5 */	bl init__12J3DFrameCtrlFs
...
lbl_8064DE2C:
/* 8064DE2C  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064DE30  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064DE34  38 80 00 53 */	li r4, 0x53
/* 8064DE38  7F C5 F3 78 */	mr r5, r30
/* 8064DE3C  38 C0 00 80 */	li r6, 0x80
/* 8064DE40  4B 9E E4 AD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064DE60  3D 00 80 65 */	lis r8, lit_4169@ha /* 0x8064EB28@ha */
/* 8064DE64  C0 28 EB 28 */	lfs f1, lit_4169@l(r8)  /* 0x8064EB28@l */
/* 8064DE68  39 00 00 00 */	li r8, 0
/* 8064DE6C  39 20 FF FF */	li r9, -1
/* 8064DE70  4B 9B F7 CD */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 8064DE88  4B C8 0D C5 */	bl __nw__FUl
/* 8064DE8C  7C 7D 1B 79 */	or. r29, r3, r3
/* 8064DE90  41 82 00 20 */	beq lbl_8064DEB0
/* 8064DE94  3C 80 80 65 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x8064F550@ha */
/* 8064DE98  38 04 F5 50 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x8064F550@l */
/* 8064DE9C  90 1D 00 00 */	stw r0, 0(r29)
/* 8064DEA0  38 80 00 00 */	li r4, 0
/* 8064DEA4  4B CD A5 59 */	bl init__12J3DFrameCtrlFs
...
lbl_8064DEC8:
/* 8064DEC8  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064DECC  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064DED0  38 80 00 54 */	li r4, 0x54
/* 8064DED4  7F C5 F3 78 */	mr r5, r30
/* 8064DED8  38 C0 00 80 */	li r6, 0x80
/* 8064DEDC  4B 9E E4 11 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064DEFC  3D 00 80 65 */	lis r8, lit_4169@ha /* 0x8064EB28@ha */
/* 8064DF00  C0 28 EB 28 */	lfs f1, lit_4169@l(r8)  /* 0x8064EB28@l */
/* 8064DF04  39 00 00 00 */	li r8, 0
/* 8064DF08  39 20 FF FF */	li r9, -1
/* 8064DF0C  4B 9B F7 31 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_8064DF20:
/* 8064DF20  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064DF24  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064DF28  38 80 00 49 */	li r4, 0x49
/* 8064DF2C  7F C5 F3 78 */	mr r5, r30
/* 8064DF30  38 C0 00 80 */	li r6, 0x80
/* 8064DF34  4B 9E E3 B9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064DF44  4B 9C 6D 11 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8064DF64  4B C8 0C E9 */	bl __nw__FUl
/* 8064DF68  7C 7D 1B 79 */	or. r29, r3, r3
/* 8064DF6C  41 82 00 20 */	beq lbl_8064DF8C
/* 8064DF70  3C 80 80 65 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x8064F550@ha */
/* 8064DF74  38 04 F5 50 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x8064F550@l */
/* 8064DF78  90 1D 00 00 */	stw r0, 0(r29)
/* 8064DF7C  38 80 00 00 */	li r4, 0
/* 8064DF80  4B CD A4 7D */	bl init__12J3DFrameCtrlFs
...
lbl_8064DFA4:
/* 8064DFA4  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064DFA8  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064DFAC  38 80 00 4F */	li r4, 0x4f
/* 8064DFB0  7F C5 F3 78 */	mr r5, r30
/* 8064DFB4  38 C0 00 80 */	li r6, 0x80
/* 8064DFB8  4B 9E E3 35 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064DFD8  3D 00 80 65 */	lis r8, lit_4176@ha /* 0x8064EB44@ha */
/* 8064DFDC  C0 28 EB 44 */	lfs f1, lit_4176@l(r8)  /* 0x8064EB44@l */
/* 8064DFE0  39 00 00 00 */	li r8, 0
/* 8064DFE4  39 20 FF FF */	li r9, -1
/* 8064DFE8  4B 9B F7 25 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 8064E000  4B C8 0C 4D */	bl __nw__FUl
/* 8064E004  7C 7D 1B 79 */	or. r29, r3, r3
/* 8064E008  41 82 00 20 */	beq lbl_8064E028
/* 8064E00C  3C 80 80 65 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x8064F550@ha */
/* 8064E010  38 04 F5 50 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x8064F550@l */
/* 8064E014  90 1D 00 00 */	stw r0, 0(r29)
/* 8064E018  38 80 00 00 */	li r4, 0
/* 8064E01C  4B CD A3 E1 */	bl init__12J3DFrameCtrlFs
...
lbl_8064E040:
/* 8064E040  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064E044  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064E048  38 80 00 54 */	li r4, 0x54
/* 8064E04C  7F C5 F3 78 */	mr r5, r30
/* 8064E050  38 C0 00 80 */	li r6, 0x80
/* 8064E054  4B 9E E2 99 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064E074  3D 00 80 65 */	lis r8, lit_4169@ha /* 0x8064EB28@ha */
/* 8064E078  C0 28 EB 28 */	lfs f1, lit_4169@l(r8)  /* 0x8064EB28@l */
/* 8064E07C  39 00 00 00 */	li r8, 0
/* 8064E080  39 20 FF FF */	li r9, -1
/* 8064E084  4B 9B F5 B9 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_8064E098:
/* 8064E098  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064E09C  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064E0A0  38 80 00 4A */	li r4, 0x4a
/* 8064E0A4  7F C5 F3 78 */	mr r5, r30
/* 8064E0A8  38 C0 00 80 */	li r6, 0x80
/* 8064E0AC  4B 9E E2 41 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064E0BC  4B 9C 6B 99 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8064E0D8:
/* 8064E0D8  3C 60 80 65 */	lis r3, d_a_b_zant__stringBase0@ha /* 0x8064EE60@ha */
/* 8064E0DC  38 63 EE 60 */	addi r3, r3, d_a_b_zant__stringBase0@l /* 0x8064EE60@l */
/* 8064E0E0  38 80 00 4B */	li r4, 0x4b
/* 8064E0E4  7F C5 F3 78 */	mr r5, r30
/* 8064E0E8  38 C0 00 80 */	li r6, 0x80
/* 8064E0EC  4B 9E E2 01 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8064E0FC  4B 9C 6B 59 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8064E114  4B D1 41 11 */	bl _restgpr_28
