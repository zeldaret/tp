...
/* 806436A8  4B D1 EB 2D */	bl _savegpr_27
/* 806436AC  7C 7D 1B 78 */	mr r29, r3
/* 806436B0  3C 60 80 65 */	lis r3, lit_3757@ha /* 0x8064EB1C@ha */
/* 806436B4  3B E3 EB 1C */	addi r31, r3, lit_3757@l /* 0x8064EB1C@l */
...
/* 806436CC  4B 9D 62 F1 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 806436E8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806436EC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80643720  4B D0 39 71 */	bl PSVECAdd
/* 80643724  80 1D 06 DC */	lwz r0, 0x6dc(r29)
/* 80643728  28 00 00 1E */	cmplwi r0, 0x1e
/* 8064372C  41 81 09 28 */	bgt lbl_80644054
/* 80643730  3C 60 80 65 */	lis r3, lit_6631@ha /* 0x8064F094@ha */
/* 80643734  38 63 F0 94 */	addi r3, r3, lit_6631@l /* 0x8064F094@l */
...
/* 806437BC  48 00 D3 C1 */	bl setMouthMode__11daB_ZANTZ_cFUc
...
lbl_806437E8:
/* 806437E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806437EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80643820  48 00 D4 ED */	bl setAppearMode__11daB_ZANTZ_cFUc
...
/* 8064383C  4B 9D 61 81 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80643850  48 00 D4 BD */	bl setAppearMode__11daB_ZANTZ_cFUc
lbl_80643854:
...
/* 806438D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806438D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80643910  4B 9D 60 AD */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80643928  4B D0 3A 75 */	bl PSVECSquareDistance
...
/* 80643998  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8064399C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80643A08  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80643A0C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80643A10:
...
/* 80643A24  4B D0 39 79 */	bl PSVECSquareDistance
...
/* 80643A94  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80643A98  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80643B04  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80643B08  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80643B0C:
...
/* 80643B54  48 00 D1 B9 */	bl setAppearMode__11daB_ZANTZ_cFUc
...
/* 80643B68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80643B6C  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_80643B70:
/* 80643B70  38 1E 07 2C */	addi r0, r30, 0x72c
/* 80643B74  7C 7D 00 2E */	lwzx r3, r29, r0
/* 80643B78  38 81 00 10 */	addi r4, r1, 0x10
/* 80643B7C  4B 9D 5E 41 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80643B90  4B 9D 6B 81 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80643BE0  4B 9D 5D DD */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80643BF4  48 00 D1 19 */	bl setAppearMode__11daB_ZANTZ_cFUc
lbl_80643BF8:
...
/* 80643C3C  48 00 CC 19 */	bl setSnortEffect__11daB_ZANTZ_cFi
...
/* 80643C6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80643C70  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_80643C74:
/* 80643C74  38 1E 07 2C */	addi r0, r30, 0x72c
/* 80643C78  7C 7D 00 2E */	lwzx r3, r29, r0
/* 80643C7C  38 81 00 10 */	addi r4, r1, 0x10
/* 80643C80  4B 9D 5D 3D */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80643CA0  4B 9D 6A 71 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80643CF4  4B 9D 5C C9 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80643D3C  4B 9D 5C 81 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80643D88  4B 9D 5C 35 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80643D9C  48 00 CA B9 */	bl setSnortEffect__11daB_ZANTZ_cFi
lbl_80643DA0:
...
/* 80643E08  48 00 CD 75 */	bl setMouthMode__11daB_ZANTZ_cFUc
...
/* 80643E30  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80643E34  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80643E38  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80643E3C  4B 9D 68 D5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80643E54  4B C2 C6 ED */	bl cLib_addCalcAngleS__FPsssss
...
/* 80643EC4  48 00 CC B9 */	bl setMouthMode__11daB_ZANTZ_cFUc
...
/* 80643F24  4B C2 3A 31 */	bl cM_rndF__Ff
...
/* 80643F78  4B C2 39 DD */	bl cM_rndF__Ff
...
/* 80643F98  4B C2 39 BD */	bl cM_rndF__Ff
...
/* 80643FF0  48 00 CD 1D */	bl setAppearMode__11daB_ZANTZ_cFUc
...
/* 80644060  4B D1 E1 C1 */	bl _restgpr_27
