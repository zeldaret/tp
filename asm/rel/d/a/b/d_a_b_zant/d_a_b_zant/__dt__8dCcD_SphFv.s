...
/* 8063F3E8  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 8063F3EC  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 8063F40C  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 8063F410  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 8063F428  3C 60 80 65 */	lis r3, __vt__8cM3dGSph@ha /* 0x8064F58C@ha */
/* 8063F42C  38 03 F5 8C */	addi r0, r3, __vt__8cM3dGSph@l /* 0x8064F58C@l */
/* 8063F430  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_8063F434:
/* 8063F434  34 1E 01 04 */	addic. r0, r30, 0x104
/* 8063F438  41 82 00 24 */	beq lbl_8063F45C
/* 8063F43C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8063F440  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8063F444  90 1E 01 20 */	stw r0, 0x120(r30)
/* 8063F448  34 1E 01 04 */	addic. r0, r30, 0x104
/* 8063F44C  41 82 00 10 */	beq lbl_8063F45C
/* 8063F450  3C 60 80 65 */	lis r3, __vt__8cM3dGAab@ha /* 0x8064F598@ha */
/* 8063F454  38 03 F5 98 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8064F598@l */
/* 8063F458  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_8063F45C:
/* 8063F45C  7F C3 F3 78 */	mr r3, r30
/* 8063F460  38 80 00 00 */	li r4, 0
/* 8063F464  4B A4 4C 81 */	bl __dt__12dCcD_GObjInfFv
/* 8063F468  7F E0 07 35 */	extsh. r0, r31
/* 8063F46C  40 81 00 0C */	ble lbl_8063F478
/* 8063F470  7F C3 F3 78 */	mr r3, r30
/* 8063F474  4B C8 F8 C9 */	bl __dl__FPv
lbl_8063F478:
