...
/* 80647AE0  3C 80 80 65 */	lis r4, lit_3757@ha /* 0x8064EB1C@ha */
/* 80647AE4  3B E4 EB 1C */	addi r31, r4, lit_3757@l /* 0x8064EB1C@l */
...
/* 80647BA0  3C 60 80 65 */	lis r3, l_HIO@ha /* 0x8064F604@ha */
/* 80647BA4  38 63 F6 04 */	addi r3, r3, l_HIO@l /* 0x8064F604@l */
...
/* 80647C60  4B C1 FC F5 */	bl cM_rndF__Ff
...
/* 80647C98  4B CE 07 95 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80647CB0  4B CE 07 7D */	bl checkPass__12J3DFrameCtrlFf
...
lbl_80647DA8:
/* 80647DA8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80647DAC  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80647DB0  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80647DB4  4B 9D 29 5D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80647DCC  4B C2 87 75 */	bl cLib_addCalcAngleS__FPsssss
/* 80647DD0  7F C3 F3 78 */	mr r3, r30
/* 80647DD4  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80647DD8  4B 9D 29 39 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80647DDC  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 80647DE0  7C 03 00 50 */	subf r0, r3, r0
/* 80647DE4  7C 03 07 34 */	extsh r3, r0
/* 80647DE8  4B D1 D2 E9 */	bl abs
/* 80647DEC  2C 03 20 00 */	cmpwi r3, 0x2000
/* 80647DF0  40 80 03 EC */	bge lbl_806481DC
/* 80647DF4  3C 60 80 65 */	lis r3, l_HIO@ha /* 0x8064F604@ha */
/* 80647DF8  38 63 F6 04 */	addi r3, r3, l_HIO@l /* 0x8064F604@l */
...
/* 80647E4C  4B C2 8D B9 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80647E60  4B C2 87 A9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80647EA8  4B C2 8D 5D */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80647F34  4B 9D 1A 89 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80647FA8  4B CF F3 F5 */	bl PSVECSquareDistance
...
/* 80648018  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8064801C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80648088  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8064808C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80648090:
...
/* 806480BC  4B C2 88 D5 */	bl cLib_chasePosXZ__FP4cXyzRC4cXyzf
lbl_806480C0:
...
/* 8064812C  4B 9D 18 91 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80648160  3C 60 80 65 */	lis r3, target_info_count@ha /* 0x8064F690@ha */
/* 80648164  90 03 F6 90 */	stw r0, target_info_count@l(r3)  /* 0x8064F690@l */
/* 80648168  3C 60 80 64 */	lis r3, s_pillar_sub__FPvPv@ha /* 0x80640584@ha */
/* 8064816C  38 63 05 84 */	addi r3, r3, s_pillar_sub__FPvPv@l /* 0x80640584@l */
/* 80648170  7F C4 F3 78 */	mr r4, r30
/* 80648174  4B 9D 91 C5 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 80648178  3C 60 80 65 */	lis r3, target_info_count@ha /* 0x8064F690@ha */
/* 8064817C  80 03 F6 90 */	lwz r0, target_info_count@l(r3)  /* 0x8064F690@l */
