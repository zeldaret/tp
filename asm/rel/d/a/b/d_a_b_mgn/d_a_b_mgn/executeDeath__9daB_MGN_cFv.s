...
/* 8060D088  4B D5 51 45 */	bl _savegpr_25
/* 8060D08C  7C 7F 1B 78 */	mr r31, r3
/* 8060D090  3C 80 80 61 */	lis r4, lit_3928@ha /* 0x8060FDE0@ha */
/* 8060D094  3B A4 FD E0 */	addi r29, r4, lit_3928@l /* 0x8060FDE0@l */
/* 8060D098  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8060D09C  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8060D138  4B A0 E7 D1 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
lbl_8060D14C:
/* 8060D14C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8060D150  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8060D164  4B CA 22 A5 */	bl bgmStop__8Z2SeqMgrFUll
/* 8060D168  88 9F 0A FB */	lbz r4, 0xafb(r31)
/* 8060D16C  28 04 00 FF */	cmplwi r4, 0xff
/* 8060D170  41 82 00 18 */	beq lbl_8060D188
/* 8060D174  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8060D178  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8060D17C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8060D180  7C 05 07 74 */	extsb r5, r0
/* 8060D184  4B A2 80 7D */	bl onSwitch__10dSv_info_cFii
lbl_8060D188:
...
/* 8060D1C8  4B D2 26 B9 */	bl removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
/* 8060D1CC  3C 60 80 61 */	lis r3, d_a_b_mgn__stringBase0@ha /* 0x80610084@ha */
/* 8060D1D0  38 63 00 84 */	addi r3, r3, d_a_b_mgn__stringBase0@l /* 0x80610084@l */
/* 8060D1D4  38 63 00 07 */	addi r3, r3, 7
/* 8060D1D8  38 80 00 35 */	li r4, 0x35
/* 8060D1DC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8060D1E0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8060D1F4  4B A2 F0 F9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8060D218  4B A0 04 F5 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 8060D21C  3C 60 80 61 */	lis r3, d_a_b_mgn__stringBase0@ha /* 0x80610084@ha */
/* 8060D220  38 63 00 84 */	addi r3, r3, d_a_b_mgn__stringBase0@l /* 0x80610084@l */
...
/* 8060D234  4B A2 F0 B9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8060D258  4B A0 03 E5 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 8060D25C  38 00 00 01 */	li r0, 1
/* 8060D260  98 1F 0A FA */	stb r0, 0xafa(r31)
/* 8060D264  38 7C 02 48 */	addi r3, r28, 0x248
/* 8060D268  4B B5 42 69 */	bl Stop__9dCamera_cFv
/* 8060D26C  38 7C 02 48 */	addi r3, r28, 0x248
/* 8060D270  38 80 00 03 */	li r4, 3
/* 8060D274  4B B5 5D 99 */	bl SetTrimSize__9dCamera_cFl
...
/* 8060D298  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8060D29C  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8060D2DC  4B D3 9D B5 */	bl PSVECAdd
...
/* 8060D304  4B D3 9D 8D */	bl PSVECAdd
...
/* 8060D330  4B A0 D3 E1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8060D408  4B C6 26 35 */	bl cLib_addCalc2__FPffff
...
/* 8060D420  4B C6 26 1D */	bl cLib_addCalc2__FPffff
lbl_8060D424:
...
/* 8060D438  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8060D43C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8060D440  4B D3 90 71 */	bl PSMTXCopy
/* 8060D444  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8060D448  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8060D474  4B C6 2D 05 */	bl cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
/* 8060D494  4B C6 31 75 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8060D4A8  4B C6 31 61 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8060D4BC  4B C6 25 81 */	bl cLib_addCalc2__FPffff
lbl_8060D4C0:
/* 8060D4C0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8060D4C4  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8060D55C  4B D1 AE D1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 8060D57C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8060D580  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8060D594  4B A6 24 91 */	bl StartShock__12dVibration_cFii4cXyz
/* 8060D598  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8060D59C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8060D5D4  4B D1 AE 59 */	bl checkPass__12J3DFrameCtrlFf
...
/* 8060D5F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8060D5F8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8060D60C  4B A6 24 19 */	bl StartShock__12dVibration_cFii4cXyz
lbl_8060D610:
/* 8060D610  38 61 00 3C */	addi r3, r1, 0x3c
/* 8060D614  4B 9F F7 51 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8060D618  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8060D61C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8060D620  38 80 68 00 */	li r4, 0x6800
/* 8060D624  4B 9F EE 11 */	bl mDoMtx_YrotM__FPA4_fs
/* 8060D628  C0 3D 02 0C */	lfs f1, 0x20c(r29)
/* 8060D62C  C0 5D 00 04 */	lfs f2, 4(r29)
/* 8060D630  C0 7D 00 E8 */	lfs f3, 0xe8(r29)
/* 8060D634  4B 9F F7 69 */	bl transM__14mDoMtx_stack_cFfff
/* 8060D638  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8060D63C  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8060D660  4B A0 D0 B1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8060D690  4B 9F F6 D5 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8060D694  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8060D698  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8060D69C  38 80 68 00 */	li r4, 0x6800
/* 8060D6A0  4B 9F ED 95 */	bl mDoMtx_YrotM__FPA4_fs
/* 8060D6A4  C0 3D 02 0C */	lfs f1, 0x20c(r29)
/* 8060D6A8  C0 5D 00 34 */	lfs f2, 0x34(r29)
/* 8060D6AC  C0 7D 02 10 */	lfs f3, 0x210(r29)
/* 8060D6B0  4B 9F F6 ED */	bl transM__14mDoMtx_stack_cFfff
...
/* 8060D6DC  4B C6 23 61 */	bl cLib_addCalc2__FPffff
...
/* 8060D6F0  4B C6 2A 89 */	bl cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
/* 8060D708  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8060D70C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8060D710  4B D3 8D A1 */	bl PSMTXCopy
...
/* 8060D73C  4B C6 2A 3D */	bl cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
/* 8060D770  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8060D774  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8060D7DC  4B A1 99 95 */	bl dStage_changeScene__FifUlScsi
...
/* 8060D864  4B B7 32 7D */	bl Set__9dCamera_cF4cXyz4cXyzfs
lbl_8060D868:
/* 8060D868  39 61 00 80 */	addi r11, r1, 0x80
/* 8060D86C  4B D5 49 AD */	bl _restgpr_25
