...
/* 8060578C  4B D5 CA 4D */	bl _savegpr_28
...
/* 806057AC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806057B0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806057B4  4B D4 0C FD */	bl PSMTXCopy
/* 806057B8  2C 1D 00 01 */	cmpwi r29, 1
/* 806057BC  40 82 00 24 */	bne lbl_806057E0
/* 806057C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806057C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806057D8  4B A0 6C 5D */	bl mDoMtx_YrotM__FPA4_fs
/* 806057DC  48 00 00 28 */	b lbl_80605804
lbl_806057E0:
/* 806057E0  2C 1D 00 19 */	cmpwi r29, 0x19
/* 806057E4  40 82 00 20 */	bne lbl_80605804
/* 806057E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806057EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80605800  4B A0 6C 35 */	bl mDoMtx_YrotM__FPA4_fs
lbl_80605804:
/* 80605804  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80605808  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8060580C  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80605810  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80605814  7C 80 FA 14 */	add r4, r0, r31
/* 80605818  4B D4 0C 99 */	bl PSMTXCopy
/* 8060581C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80605820  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80605824  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80605828  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8060582C  4B D4 0C 85 */	bl PSMTXCopy
/* 80605830  38 60 00 01 */	li r3, 1
/* 80605834  39 61 00 20 */	addi r11, r1, 0x20
/* 80605838  4B D5 C9 ED */	bl _restgpr_28
