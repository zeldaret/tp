...
/* 80605CBC  4B D5 C5 21 */	bl _savegpr_29
/* 80605CC0  7C 7D 1B 78 */	mr r29, r3
/* 80605CC4  7C 9E 23 78 */	mr r30, r4
/* 80605CC8  4B A1 30 19 */	bl fopAc_IsActor__FPv
...
lbl_80605CE8:
/* 80605CE8  4B A1 C4 51 */	bl fpcM_IsCreating__FUi
...
/* 80605D08  4B A1 4A D9 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80605D0C  3C 60 80 61 */	lis r3, lit_4141@ha /* 0x8060FE24@ha */
/* 80605D10  C0 03 FE 24 */	lfs f0, lit_4141@l(r3)  /* 0x8060FE24@l */
/* 80605D14  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80605D18  40 80 00 44 */	bge lbl_80605D5C
/* 80605D1C  C0 3D 05 2C */	lfs f1, 0x52c(r29)
/* 80605D20  3C 60 80 61 */	lis r3, lit_3929@ha /* 0x8060FDE4@ha */
/* 80605D24  C0 03 FD E4 */	lfs f0, lit_3929@l(r3)  /* 0x8060FDE4@l */
...
/* 80605D3C  4B A1 49 D5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80605D40  7C 03 F8 50 */	subf r0, r3, r31
/* 80605D44  7C 03 07 34 */	extsh r3, r0
/* 80605D48  4B D5 F3 89 */	bl abs
...
/* 80605D64  4B D5 C4 C5 */	bl _restgpr_29
