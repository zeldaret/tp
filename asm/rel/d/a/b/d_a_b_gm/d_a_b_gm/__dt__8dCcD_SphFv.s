...
/* 805F3BA4  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 805F3BA8  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 805F3BC8  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 805F3BCC  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 805F3BE4  3C 60 80 5F */	lis r3, __vt__8cM3dGSph@ha /* 0x805F4728@ha */
/* 805F3BE8  38 03 47 28 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x805F4728@l */
/* 805F3BEC  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_805F3BF0:
/* 805F3BF0  34 1E 01 04 */	addic. r0, r30, 0x104
/* 805F3BF4  41 82 00 24 */	beq lbl_805F3C18
/* 805F3BF8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805F3BFC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805F3C00  90 1E 01 20 */	stw r0, 0x120(r30)
/* 805F3C04  34 1E 01 04 */	addic. r0, r30, 0x104
/* 805F3C08  41 82 00 10 */	beq lbl_805F3C18
/* 805F3C0C  3C 60 80 5F */	lis r3, __vt__8cM3dGAab@ha /* 0x805F4734@ha */
/* 805F3C10  38 03 47 34 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805F4734@l */
/* 805F3C14  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_805F3C18:
/* 805F3C18  7F C3 F3 78 */	mr r3, r30
/* 805F3C1C  38 80 00 00 */	li r4, 0
/* 805F3C20  4B A9 04 C5 */	bl __dt__12dCcD_GObjInfFv
/* 805F3C24  7F E0 07 35 */	extsh. r0, r31
/* 805F3C28  40 81 00 0C */	ble lbl_805F3C34
/* 805F3C2C  7F C3 F3 78 */	mr r3, r30
/* 805F3C30  4B CD B1 0D */	bl __dl__FPv
lbl_805F3C34:
