...
/* 805EF028  4B D7 31 AD */	bl _savegpr_27
/* 805EF02C  7C 7D 1B 78 */	mr r29, r3
/* 805EF030  3C 60 80 5F */	lis r3, lit_3774@ha /* 0x805F4188@ha */
/* 805EF034  3B C3 41 88 */	addi r30, r3, lit_3774@l /* 0x805F4188@l */
/* 805EF038  3C 60 80 5F */	lis r3, l_HIO@ha /* 0x805F47DC@ha */
/* 805EF03C  3B E3 47 DC */	addi r31, r3, l_HIO@l /* 0x805F47DC@l */
...
/* 805EF058  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805EF05C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805EF060  4B D5 74 51 */	bl PSMTXCopy
/* 805EF064  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805EF068  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 805EF094  4B D5 74 1D */	bl PSMTXCopy
...
/* 805EF130  3C C0 80 5F */	lis r6, l_HIO@ha /* 0x805F47DC@ha */
/* 805EF134  38 C6 47 DC */	addi r6, r6, l_HIO@l /* 0x805F47DC@l */
...
/* 805EF160  4B C7 79 D5 */	bl __mi__4cXyzCFRC3Vec
...
/* 805EF17C  4B C7 84 F9 */	bl cM_atan2s__Fff
...
/* 805EF198  4B C8 14 71 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805EF1B8  4B D5 7F 81 */	bl PSVECSquareMag
...
/* 805EF228  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805EF22C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805EF298  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805EF29C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805EF2A0:
...
/* 805EF2C0  4B D5 7E 79 */	bl PSVECSquareMag
...
/* 805EF330  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805EF334  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805EF3A0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805EF3A4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805EF3A8:
...
/* 805EF404  3C 60 80 5F */	lis r3, ko_ct@ha /* 0x805F4828@ha */
/* 805EF408  90 03 48 28 */	stw r0, ko_ct@l(r3)  /* 0x805F4828@l */
/* 805EF40C  3C 60 80 5F */	lis r3, s_ko_sub__FPvPv@ha /* 0x805EE620@ha */
/* 805EF410  38 63 E6 20 */	addi r3, r3, s_ko_sub__FPvPv@l /* 0x805EE620@l */
/* 805EF414  7F A4 EB 78 */	mr r4, r29
/* 805EF418  4B A3 1F 21 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 805EF41C  3C 60 80 5F */	lis r3, ko_ct@ha /* 0x805F4828@ha */
/* 805EF420  80 03 48 28 */	lwz r0, ko_ct@l(r3)  /* 0x805F4828@l */
...
/* 805EF43C  4B C7 7F B9 */	bl __ct__5csXyzFsss
...
/* 805EF47C  4B A2 AA 75 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
lbl_805EF480:
...
/* 805EF4A8  4B C7 84 AD */	bl cM_rndF__Ff
