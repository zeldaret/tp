...
/* 805EE0C4  4B D7 41 0D */	bl _savegpr_26
/* 805EE0C8  7C 7F 1B 78 */	mr r31, r3
/* 805EE0CC  38 7F 09 7C */	addi r3, r31, 0x97c
/* 805EE0D0  4B A9 57 61 */	bl Move__10dCcD_GSttsFv
...
/* 805EE144  3C 60 80 5F */	lis r3, lit_3794@ha /* 0x805F41A4@ha */
/* 805EE148  C0 03 41 A4 */	lfs f0, lit_3794@l(r3)  /* 0x805F41A4@l */
...
/* 805EE164  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805EE168  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805EE16C  4B D5 83 45 */	bl PSMTXCopy
/* 805EE170  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805EE174  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 805EE198  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805EE19C  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805EE1A0  3C 60 80 5F */	lis r3, name_4019@ha /* 0x805F43B0@ha */
/* 805EE1A4  3B 83 43 B0 */	addi r28, r3, name_4019@l /* 0x805F43B0@l */
/* 805EE1A8  3C 60 80 5F */	lis r3, lit_3774@ha /* 0x805F4188@ha */
/* 805EE1AC  3B 63 41 88 */	addi r27, r3, lit_3774@l /* 0x805F4188@l */
lbl_805EE1B0:
...
/* 805EE1F0  4B A5 E8 A1 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805EE224  4B A9 62 3D */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 805EE25C  4B A9 62 9D */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 805EE280  4B A3 F8 1D */	bl dComIfGs_onOneZoneSwitch__Fii
/* 805EE284  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805EE288  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 805EE28C  80 63 00 00 */	lwz r3, 0(r3)
/* 805EE290  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 805EE294  38 80 00 02 */	li r4, 2
/* 805EE298  4B CC 1C F5 */	bl changeBgmStatus__8Z2SeqMgrFl
...
/* 805EE2BC  3C 60 80 5F */	lis r3, s_ko_del__FPvPv@ha /* 0x805EE05C@ha */
/* 805EE2C0  38 63 E0 5C */	addi r3, r3, s_ko_del__FPvPv@l /* 0x805EE05C@l */
/* 805EE2C4  7F E4 FB 78 */	mr r4, r31
/* 805EE2C8  4B A3 30 71 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 805EE2CC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805EE2D0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805EE2E4  4B CC 11 25 */	bl bgmStop__8Z2SeqMgrFUll
...
lbl_805EE304:
/* 805EE304  3C 60 80 5F */	lis r3, lit_3794@ha /* 0x805F41A4@ha */
/* 805EE308  C0 23 41 A4 */	lfs f1, lit_3794@l(r3)  /* 0x805F41A4@l */
/* 805EE30C  D0 21 00 20 */	stfs f1, 0x20(r1)
/* 805EE310  3C 60 80 5F */	lis r3, lit_3774@ha /* 0x805F4188@ha */
/* 805EE314  C0 03 41 88 */	lfs f0, lit_3774@l(r3)  /* 0x805F4188@l */
/* 805EE318  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 805EE31C  D0 21 00 28 */	stfs f1, 0x28(r1)
/* 805EE320  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805EE324  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805EE338  4B A8 16 ED */	bl StartShock__12dVibration_cFii4cXyz
/* 805EE33C  3B 40 00 00 */	li r26, 0
/* 805EE340  3B C0 00 00 */	li r30, 0
/* 805EE344  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805EE348  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805EE34C  3C 60 80 5F */	lis r3, name_4042@ha /* 0x805F43B8@ha */
/* 805EE350  3B 83 43 B8 */	addi r28, r3, name_4042@l /* 0x805F43B8@l */
/* 805EE354  3C 60 80 5F */	lis r3, lit_3774@ha /* 0x805F4188@ha */
/* 805EE358  3B A3 41 88 */	addi r29, r3, lit_3774@l /* 0x805F4188@l */
lbl_805EE35C:
...
/* 805EE39C  4B A5 E6 F5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805EE3BC  4B A3 F6 E1 */	bl dComIfGs_onOneZoneSwitch__Fii
...
/* 805EE3D0  4B A9 60 91 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 805EE3E8  4B A9 61 11 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 805EE3FC  4B A9 91 19 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
/* 805EE400  38 60 00 03 */	li r3, 3
/* 805EE404  38 80 FF FF */	li r4, -1
/* 805EE408  4B A3 F6 95 */	bl dComIfGs_onOneZoneSwitch__Fii
...
/* 805EE424  4B D7 3D F9 */	bl _restgpr_26
