...
/* 805EDAB8  4B D7 47 21 */	bl _savegpr_28
/* 805EDABC  2C 04 00 00 */	cmpwi r4, 0
/* 805EDAC0  40 82 02 CC */	bne lbl_805EDD8C
/* 805EDAC4  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 805EDAC8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 805EDACC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 805EDAF0  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 805EDAF4  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 805EDAF8  80 84 00 00 */	lwz r4, 0(r4)
/* 805EDAFC  4B D5 89 B5 */	bl PSMTXCopy
...
/* 805EDB10  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDB14  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDB28  4B A1 E9 A5 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDB40  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDB44  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDB58  4B A1 E9 75 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDB70  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDB74  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDB88  4B A1 E9 45 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDBA0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDBA4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDBB8  4B A1 E9 15 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDBD0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDBD4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDBE8  4B A1 E8 E5 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDC00  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDC04  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDC18  4B A1 E8 B5 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDC30  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDC34  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDC48  4B A1 E8 85 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDC60  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDC64  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDC78  4B A1 E8 55 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDC90  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDC94  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDCA8  4B A1 E8 25 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 805EDCC0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDCC4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDCD8  4B A1 E7 F5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 805EDCDC  48 00 00 7C */	b lbl_805EDD58
lbl_805EDCE0:
/* 805EDCE0  2C 1F 00 16 */	cmpwi r31, 0x16
/* 805EDCE4  40 82 00 1C */	bne lbl_805EDD00
/* 805EDCE8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDCEC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805EDCF0  80 63 00 00 */	lwz r3, 0(r3)
/* 805EDCF4  A8 9C 1A D8 */	lha r4, 0x1ad8(r28)
/* 805EDCF8  4B A1 E7 D5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 805EDCFC  48 00 00 5C */	b lbl_805EDD58
lbl_805EDD00:
/* 805EDD00  2C 1F 00 17 */	cmpwi r31, 0x17
/* 805EDD04  40 82 00 24 */	bne lbl_805EDD28
/* 805EDD08  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDD0C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDD20  4B A1 E7 AD */	bl mDoMtx_ZrotM__FPA4_fs
/* 805EDD24  48 00 00 34 */	b lbl_805EDD58
lbl_805EDD28:
/* 805EDD28  2C 1F 00 15 */	cmpwi r31, 0x15
/* 805EDD2C  40 82 00 2C */	bne lbl_805EDD58
/* 805EDD30  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDD34  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805EDD38  80 63 00 00 */	lwz r3, 0(r3)
/* 805EDD3C  A8 9C 1A DA */	lha r4, 0x1ada(r28)
/* 805EDD40  4B A1 E6 F5 */	bl mDoMtx_YrotM__FPA4_fs
/* 805EDD44  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDD48  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805EDD4C  80 63 00 00 */	lwz r3, 0(r3)
/* 805EDD50  A8 9C 1A DC */	lha r4, 0x1adc(r28)
/* 805EDD54  4B A1 E7 79 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_805EDD58:
/* 805EDD58  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDD5C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805EDD70  4B D5 87 41 */	bl PSMTXCopy
/* 805EDD74  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EDD78  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805EDD7C  80 63 00 00 */	lwz r3, 0(r3)
/* 805EDD80  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 805EDD84  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 805EDD88  4B D5 87 29 */	bl PSMTXCopy
lbl_805EDD8C:
/* 805EDD8C  38 60 00 01 */	li r3, 1
/* 805EDD90  39 61 00 20 */	addi r11, r1, 0x20
/* 805EDD94  4B D7 44 91 */	bl _restgpr_28
