...
/* 805EE450  3C 60 80 5F */	lis r3, lit_3774@ha /* 0x805F4188@ha */
/* 805EE454  3B E3 41 88 */	addi r31, r3, lit_3774@l /* 0x805F4188@l */
/* 805EE458  38 61 00 40 */	addi r3, r1, 0x40
/* 805EE45C  4B A8 98 0D */	bl __ct__11dBgS_LinChkFv
/* 805EE460  3C 60 80 5F */	lis r3, __vt__8cM3dGPla@ha /* 0x805F4770@ha */
/* 805EE464  38 03 47 70 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x805F4770@l */
/* 805EE468  90 01 00 3C */	stw r0, 0x3c(r1)
/* 805EE46C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EE470  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805EE474  80 63 00 00 */	lwz r3, 0(r3)
/* 805EE478  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 805EE47C  4B A1 DF 61 */	bl mDoMtx_YrotS__FPA4_fs
/* 805EE480  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EE484  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805EE488  80 63 00 00 */	lwz r3, 0(r3)
/* 805EE48C  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 805EE490  4B A1 DF 0D */	bl mDoMtx_XrotM__FPA4_fs
...
/* 805EE504  4B A8 98 61 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 805EE508  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805EE50C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805EE510  3B E3 0F 38 */	addi r31, r3, 0xf38
/* 805EE514  7F E3 FB 78 */	mr r3, r31
/* 805EE518  38 81 00 40 */	addi r4, r1, 0x40
/* 805EE51C  4B A8 5E 99 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 805EE548  4B A8 61 FD */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 805EE55C  4B C7 91 19 */	bl cM_atan2s__Fff
...
/* 805EE584  3C 60 80 5F */	lis r3, __vt__8cM3dGPla@ha /* 0x805F4770@ha */
/* 805EE588  38 03 47 70 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x805F4770@l */
/* 805EE58C  90 01 00 3C */	stw r0, 0x3c(r1)
/* 805EE590  38 61 00 40 */	addi r3, r1, 0x40
/* 805EE594  38 80 FF FF */	li r4, -1
/* 805EE598  4B A8 97 45 */	bl __dt__11dBgS_LinChkFv
/* 805EE59C  38 60 00 01 */	li r3, 1
/* 805EE5A0  48 00 00 20 */	b lbl_805EE5C0
lbl_805EE5A4:
/* 805EE5A4  3C 60 80 5F */	lis r3, __vt__8cM3dGPla@ha /* 0x805F4770@ha */
/* 805EE5A8  38 03 47 70 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x805F4770@l */
/* 805EE5AC  90 01 00 3C */	stw r0, 0x3c(r1)
/* 805EE5B0  38 61 00 40 */	addi r3, r1, 0x40
/* 805EE5B4  38 80 FF FF */	li r4, -1
/* 805EE5B8  4B A8 97 25 */	bl __dt__11dBgS_LinChkFv
