...
/* 805EF9D4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805EF9D8  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805EF9DC  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 805EF9E0  4B A2 AD 31 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805EF9E4  B0 7E 05 C4 */	sth r3, 0x5c4(r30)
/* 805EF9E8  7F C3 F3 78 */	mr r3, r30
/* 805EF9EC  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 805EF9F0  4B A2 AD F1 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805EFA14  3C 60 80 5F */	lis r3, lit_4656@ha /* 0x805F4444@ha */
/* 805EFA18  38 63 44 44 */	addi r3, r3, lit_4656@l /* 0x805F4444@l */
...
lbl_805EFA70:
/* 805EFA70  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EFA74  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805EFA78  80 63 00 00 */	lwz r3, 0(r3)
/* 805EFA7C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 805EFA80  4B A1 C9 5D */	bl mDoMtx_YrotS__FPA4_fs
/* 805EFA84  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805EFA88  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805EFA8C  80 63 00 00 */	lwz r3, 0(r3)
/* 805EFA90  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 805EFA94  4B A1 C9 09 */	bl mDoMtx_XrotM__FPA4_fs
/* 805EFA98  3C 60 80 5F */	lis r3, lit_3794@ha /* 0x805F41A4@ha */
/* 805EFA9C  C0 03 41 A4 */	lfs f0, lit_3794@l(r3)  /* 0x805F41A4@l */
...
/* 805EFADC  4B C8 0B 2D */	bl cLib_addCalcAngleS2__FPssss
...
/* 805EFAF0  4B C8 0B 19 */	bl cLib_addCalcAngleS2__FPssss
