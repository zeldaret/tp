...
/* 805EDDB8  4B D7 44 19 */	bl _savegpr_26
/* 805EDDBC  7C 7E 1B 78 */	mr r30, r3
/* 805EDDC0  3C 60 80 5F */	lis r3, lit_3774@ha /* 0x805F4188@ha */
/* 805EDDC4  3B E3 41 88 */	addi r31, r3, lit_3774@l /* 0x805F4188@l */
/* 805EDDC8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EDDCC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805EDDD0  38 80 00 00 */	li r4, 0
/* 805EDDD4  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 805EDDD8  38 DE 01 0C */	addi r6, r30, 0x10c
/* 805EDDDC  4B BB 59 E9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805EDDE0  3B 40 00 00 */	li r26, 0
/* 805EDDE4  3B A0 00 00 */	li r29, 0
/* 805EDDE8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EDDEC  3B 83 CA 54 */	addi r28, r3, g_env_light@l /* 0x8042CA54@l */
lbl_805EDDF0:
...
/* 805EDE04  4B BB 6F 9D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805EDE1C  4B A1 F8 BD */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 805EDE20  7C 7E D8 2E */	lwzx r3, r30, r27
/* 805EDE24  4B A1 FE A1 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 805EDE54  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EDE58  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805EDE5C  80 9C 00 04 */	lwz r4, 4(r28)
/* 805EDE60  38 BE 01 0C */	addi r5, r30, 0x10c
/* 805EDE64  4B BB 6F 3D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805EDE78  4B A1 F8 61 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 805EDF48  4B A2 32 79 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 805EDF4C  C0 5E 04 D8 */	lfs f2, 0x4d8(r30)
/* 805EDF50  C0 7E 04 D4 */	lfs f3, 0x4d4(r30)
/* 805EDF54  C0 1F 00 20 */	lfs f0, 0x20(r31)
/* 805EDF58  3C 60 80 5F */	lis r3, l_HIO@ha /* 0x805F47DC@ha */
/* 805EDF5C  38 63 47 DC */	addi r3, r3, l_HIO@l /* 0x805F47DC@l */
...
/* 805EDFAC  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 805EDFB0  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 805EDFB4  4B A4 09 5D */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 805EDFD4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EDFD8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805EDFDC  80 9B 00 04 */	lwz r4, 4(r27)
/* 805EDFE0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 805EDFE4  4B BB 6D BD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805EDFF8  4B A1 F6 E1 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 805EDFFC  80 7E 06 B8 */	lwz r3, 0x6b8(r30)
/* 805EE000  4B A2 26 81 */	bl entryDL__14mDoExt_McaMorfFv
lbl_805EE004:
/* 805EE004  38 60 00 01 */	li r3, 1
lbl_805EE008:
/* 805EE008  39 61 00 50 */	addi r11, r1, 0x50
/* 805EE00C  4B D7 42 11 */	bl _restgpr_26
