...
/* 805C7DF4  4B D9 A3 E5 */	bl _savegpr_28
...
/* 805C7E10  3C 60 80 5D */	lis r3, d_a_b_dre__stringBase0@ha /* 0x805CAECC@ha */
/* 805C7E14  38 63 AE CC */	addi r3, r3, d_a_b_dre__stringBase0@l /* 0x805CAECC@l */
/* 805C7E18  7F C4 F3 78 */	mr r4, r30
/* 805C7E1C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C7E20  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805C7E24  3C A5 00 02 */	addis r5, r5, 2
/* 805C7E28  38 C0 00 80 */	li r6, 0x80
/* 805C7E2C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 805C7E30  4B A7 44 BD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7E48  3C C0 80 5D */	lis r6, lit_3862@ha /* 0x805CAD60@ha */
/* 805C7E4C  C0 66 AD 60 */	lfs f3, lit_3862@l(r6)  /* 0x805CAD60@l */
/* 805C7E50  3C C0 80 5D */	lis r6, lit_3863@ha /* 0x805CAD64@ha */
/* 805C7E54  C0 86 AD 64 */	lfs f4, lit_3863@l(r6)  /* 0x805CAD64@l */
/* 805C7E58  4B A4 90 19 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 805C7E74  4B D9 A3 B1 */	bl _restgpr_28
