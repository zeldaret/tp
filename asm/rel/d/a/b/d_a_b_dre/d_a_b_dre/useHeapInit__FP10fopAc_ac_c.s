...
/* 805C7B3C  4B D9 A6 9D */	bl _savegpr_28
/* 805C7B40  7C 7F 1B 78 */	mr r31, r3
/* 805C7B44  3C 60 80 5D */	lis r3, d_a_b_dre__stringBase0@ha /* 0x805CAECC@ha */
/* 805C7B48  38 63 AE CC */	addi r3, r3, d_a_b_dre__stringBase0@l /* 0x805CAECC@l */
/* 805C7B4C  38 80 00 49 */	li r4, 0x49
/* 805C7B50  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C7B54  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C7B68  4B A7 47 85 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7B80  4B D0 70 CD */	bl __nw__FUl
/* 805C7B84  7C 7C 1B 79 */	or. r28, r3, r3
/* 805C7B88  41 82 00 68 */	beq lbl_805C7BF0
/* 805C7B8C  3C 60 80 5D */	lis r3, d_a_b_dre__stringBase0@ha /* 0x805CAECC@ha */
/* 805C7B90  38 63 AE CC */	addi r3, r3, d_a_b_dre__stringBase0@l /* 0x805CAECC@l */
/* 805C7B94  38 80 00 1D */	li r4, 0x1d
/* 805C7B98  7F A5 EB 78 */	mr r5, r29
/* 805C7B9C  38 C0 00 80 */	li r6, 0x80
/* 805C7BA0  4B A7 47 4D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7BD8  3D 20 80 5D */	lis r9, lit_3844@ha /* 0x805CAD5C@ha */
/* 805C7BDC  C0 29 AD 5C */	lfs f1, lit_3844@l(r9)  /* 0x805CAD5C@l */
/* 805C7BE0  39 20 00 00 */	li r9, 0
/* 805C7BE4  39 40 FF FF */	li r10, -1
/* 805C7BE8  4B A4 8B E9 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 805C7BFC  4B D0 70 51 */	bl __nw__FUl
/* 805C7C00  7C 7C 1B 79 */	or. r28, r3, r3
/* 805C7C04  41 82 00 68 */	beq lbl_805C7C6C
/* 805C7C08  3C 60 80 5D */	lis r3, d_a_b_dre__stringBase0@ha /* 0x805CAECC@ha */
/* 805C7C0C  38 63 AE CC */	addi r3, r3, d_a_b_dre__stringBase0@l /* 0x805CAECC@l */
/* 805C7C10  38 80 00 1F */	li r4, 0x1f
/* 805C7C14  7F A5 EB 78 */	mr r5, r29
/* 805C7C18  38 C0 00 80 */	li r6, 0x80
/* 805C7C1C  4B A7 46 D1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7C54  3D 20 80 5D */	lis r9, lit_3844@ha /* 0x805CAD5C@ha */
/* 805C7C58  C0 29 AD 5C */	lfs f1, lit_3844@l(r9)  /* 0x805CAD5C@l */
/* 805C7C5C  39 20 00 00 */	li r9, 0
/* 805C7C60  39 40 FF FF */	li r10, -1
/* 805C7C64  4B A4 8B 6D */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 805C7C94  4B D0 6F B9 */	bl __nw__FUl
/* 805C7C98  7C 7E 1B 79 */	or. r30, r3, r3
/* 805C7C9C  41 82 00 20 */	beq lbl_805C7CBC
/* 805C7CA0  3C 80 80 5D */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x805CB028@ha */
/* 805C7CA4  38 04 B0 28 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x805CB028@l */
/* 805C7CA8  90 1E 00 00 */	stw r0, 0(r30)
/* 805C7CAC  38 80 00 00 */	li r4, 0
/* 805C7CB0  4B D6 07 4D */	bl init__12J3DFrameCtrlFs
...
lbl_805C7CD4:
/* 805C7CD4  3C 60 80 5D */	lis r3, d_a_b_dre__stringBase0@ha /* 0x805CAECC@ha */
/* 805C7CD8  38 63 AE CC */	addi r3, r3, d_a_b_dre__stringBase0@l /* 0x805CAECC@l */
/* 805C7CDC  38 80 00 51 */	li r4, 0x51
/* 805C7CE0  7F A5 EB 78 */	mr r5, r29
/* 805C7CE4  38 C0 00 80 */	li r6, 0x80
/* 805C7CE8  4B A7 46 05 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7D0C  3D 00 80 5D */	lis r8, lit_3844@ha /* 0x805CAD5C@ha */
/* 805C7D10  C0 28 AD 5C */	lfs f1, lit_3844@l(r8)  /* 0x805CAD5C@l */
/* 805C7D14  39 00 00 00 */	li r8, 0
/* 805C7D18  39 20 FF FF */	li r9, -1
/* 805C7D1C  4B A4 59 F1 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 805C7D58  4B D9 A4 CD */	bl _restgpr_28
