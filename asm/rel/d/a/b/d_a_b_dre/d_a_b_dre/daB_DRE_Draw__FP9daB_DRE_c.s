...
/* 805CA790  4B D9 7A 4C */	b _savegpr_29
/* 805CA794  7C 7D 1B 78 */	mr r29, r3
/* 805CA798  3C 60 80 5D */	lis r3, lit_3844@ha
/* 805CA79C  3B E3 AD 5C */	addi r31, r3, lit_3844@l
...
/* 805CA7B4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805CA7B8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805CA7BC  38 80 00 00 */	li r4, 0
/* 805CA7C0  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 805CA7C4  38 DD 01 0C */	addi r6, r29, 0x10c
/* 805CA7C8  4B BD 8F FC */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805CA7CC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805CA7D0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805CA7D4  80 9E 00 04 */	lwz r4, 4(r30)
/* 805CA7D8  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805CA7DC  4B BD A5 C4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805CA7FC  4B A4 2F AC */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 805CA83C  4B A4 69 84 */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 805CA85C  4B D6 50 24 */	b removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
lbl_805CA860:
...
/* 805CA8C0  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 805CA8C4  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 805CA8C8  4B A6 40 48 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 805CA8EC  3C 60 80 45 */	lis r3, struct_80450BE4+0x1@ha
/* 805CA8F0  98 03 0B E5 */	stb r0, struct_80450BE4+0x1@l(r3)
/* 805CA8F4  4B A3 D7 84 */	b onBlure__13mDoGph_gInf_cFv
/* 805CA8F8  48 00 00 10 */	b lbl_805CA908
lbl_805CA8FC:
/* 805CA8FC  38 00 00 00 */	li r0, 0
/* 805CA900  3C 60 80 45 */	lis r3, struct_80450BE4+0x0@ha
/* 805CA904  98 03 0B E4 */	stb r0, struct_80450BE4+0x0@l(r3)
lbl_805CA908:
/* 805CA908  38 60 00 01 */	li r3, 1
/* 805CA90C  39 61 00 30 */	addi r11, r1, 0x30
/* 805CA910  4B D9 79 18 */	b _restgpr_29
