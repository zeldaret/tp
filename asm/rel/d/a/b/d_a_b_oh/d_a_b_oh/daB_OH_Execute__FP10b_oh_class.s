...
/* 8061CDA8  4B D4 54 11 */	bl _savegpr_20
/* 8061CDAC  7C 78 1B 78 */	mr r24, r3
/* 8061CDB0  3C 60 80 62 */	lis r3, lit_3650@ha /* 0x8061D9D4@ha */
/* 8061CDB4  3B A3 D9 D4 */	addi r29, r3, lit_3650@l /* 0x8061D9D4@l */
/* 8061CDB8  4B 9F B4 F1 */	bl cDmrNowMidnaTalk__Fv
...
/* 8061CDE0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 8061CDE4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8061CDE8  38 81 00 08 */	addi r4, r1, 8
/* 8061CDEC  4B 9F CA 0D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 8061CDF0  3C 80 80 62 */	lis r4, boss@ha /* 0x8061DBD4@ha */
/* 8061CDF4  90 64 DB D4 */	stw r3, boss@l(r4)  /* 0x8061DBD4@l */
lbl_8061CDF8:
/* 8061CDF8  3C 60 80 62 */	lis r3, boss@ha /* 0x8061DBD4@ha */
/* 8061CDFC  38 63 DB D4 */	addi r3, r3, boss@l /* 0x8061DBD4@l */
...
/* 8061CE98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061CE9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8061CEB4  4B D2 9A 35 */	bl PSMTXTrans
/* 8061CEB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061CEBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061CEC0  A8 98 04 E6 */	lha r4, 0x4e6(r24)
/* 8061CEC4  4B 9E F5 71 */	bl mDoMtx_YrotM__FPA4_fs
/* 8061CEC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061CECC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061CED0  A8 98 04 E4 */	lha r4, 0x4e4(r24)
/* 8061CED4  4B 9E F4 C9 */	bl mDoMtx_XrotM__FPA4_fs
/* 8061CED8  3C 60 80 62 */	lis r3, l_HIO@ha /* 0x8061DBC4@ha */
/* 8061CEDC  3B C3 DB C4 */	addi r30, r3, l_HIO@l /* 0x8061DBC4@l */
/* 8061CEE0  C0 3E 00 08 */	lfs f1, 8(r30)
/* 8061CEE4  FC 40 08 90 */	fmr f2, f1
/* 8061CEE8  FC 60 08 90 */	fmr f3, f1
/* 8061CEEC  4B 9E FF 4D */	bl scaleM__14mDoMtx_stack_cFfff
/* 8061CEF0  80 78 05 B4 */	lwz r3, 0x5b4(r24)
/* 8061CEF4  83 83 00 04 */	lwz r28, 4(r3)
/* 8061CEF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061CEFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061CF00  38 9C 00 24 */	addi r4, r28, 0x24
/* 8061CF04  4B D2 95 AD */	bl PSMTXCopy
/* 8061CF08  88 18 04 E2 */	lbz r0, 0x4e2(r24)
/* 8061CF0C  7C 03 07 74 */	extsb r3, r0
/* 8061CF10  4B A1 01 5D */	bl dComIfGp_getReverb__Fi
...
/* 8061CF24  4B 9F 36 A5 */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 8061CF28  80 78 05 C0 */	lwz r3, 0x5c0(r24)
/* 8061CF2C  4B 9F 04 FD */	bl play__14mDoExt_baseAnmFv
/* 8061CF30  80 78 05 C4 */	lwz r3, 0x5c4(r24)
/* 8061CF34  4B 9F 04 F5 */	bl play__14mDoExt_baseAnmFv
/* 8061CF38  80 78 05 B4 */	lwz r3, 0x5b4(r24)
/* 8061CF3C  4B 9F 37 71 */	bl modelCalc__14mDoExt_McaMorfFv
...
/* 8061CF74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061CF78  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061CF7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8061CF80  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8061CFA0  4B D2 95 11 */	bl PSMTXCopy
...
/* 8061CFE4  4B C5 26 65 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 8061D004  4B C5 27 05 */	bl SetR__8cM3dGSphFf
...
/* 8061D01C  4B C5 26 ED */	bl SetR__8cM3dGSphFf
lbl_8061D020:
/* 8061D020  7F 63 DB 78 */	mr r3, r27
/* 8061D024  38 94 0C EC */	addi r4, r20, 0xcec
/* 8061D028  4B C4 7B 81 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8061D048  4B D4 51 BD */	bl _restgpr_20
