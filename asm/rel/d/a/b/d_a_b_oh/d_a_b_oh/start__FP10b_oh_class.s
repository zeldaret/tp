...
/* 8061B970  4B D4 68 61 */	bl _savegpr_26
/* 8061B974  7C 7E 1B 78 */	mr r30, r3
/* 8061B978  3C 60 80 62 */	lis r3, lit_3650@ha /* 0x8061D9D4@ha */
/* 8061B97C  3B E3 D9 D4 */	addi r31, r3, lit_3650@l /* 0x8061D9D4@l */
...
lbl_8061B9A8:
/* 8061B9A8  3C 60 80 62 */	lis r3, boss@ha /* 0x8061DBD4@ha */
/* 8061B9AC  38 63 DB D4 */	addi r3, r3, boss@l /* 0x8061DBD4@l */
...
/* 8061B9FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061BA00  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061BA04  3C 60 80 62 */	lis r3, boss@ha /* 0x8061DBD4@ha */
/* 8061BA08  3B 83 DB D4 */	addi r28, r3, boss@l /* 0x8061DBD4@l */
lbl_8061BA0C:
...
/* 8061BA24  4B D2 AA 8D */	bl PSMTXCopy
...
/* 8061BA54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8061BA58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8061BAA8  4B A3 1A 25 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8061BAD0  4B C5 3F B1 */	bl cLib_addCalc0__FPfff
...
/* 8061BAE4  4B C5 3F 59 */	bl cLib_addCalc2__FPffff
...
/* 8061BAFC  4B C5 3F 41 */	bl cLib_addCalc2__FPffff
lbl_8061BB00:
/* 8061BB00  39 61 00 50 */	addi r11, r1, 0x50
/* 8061BB04  4B D4 67 19 */	bl _restgpr_26
