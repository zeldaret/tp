...
/* 8061D738  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 8061D73C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 8061D75C  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 8061D760  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 8061D778  3C 60 80 62 */	lis r3, __vt__8cM3dGSph@ha /* 0x8061DB48@ha */
/* 8061D77C  38 03 DB 48 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x8061DB48@l */
/* 8061D780  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_8061D784:
/* 8061D784  34 1E 01 04 */	addic. r0, r30, 0x104
/* 8061D788  41 82 00 24 */	beq lbl_8061D7AC
/* 8061D78C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8061D790  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8061D794  90 1E 01 20 */	stw r0, 0x120(r30)
/* 8061D798  34 1E 01 04 */	addic. r0, r30, 0x104
/* 8061D79C  41 82 00 10 */	beq lbl_8061D7AC
/* 8061D7A0  3C 60 80 62 */	lis r3, __vt__8cM3dGAab@ha /* 0x8061DB3C@ha */
/* 8061D7A4  38 03 DB 3C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8061DB3C@l */
/* 8061D7A8  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_8061D7AC:
/* 8061D7AC  7F C3 F3 78 */	mr r3, r30
/* 8061D7B0  38 80 00 00 */	li r4, 0
/* 8061D7B4  4B A6 69 31 */	bl __dt__12dCcD_GObjInfFv
/* 8061D7B8  7F E0 07 35 */	extsh. r0, r31
/* 8061D7BC  40 81 00 0C */	ble lbl_8061D7C8
/* 8061D7C0  7F C3 F3 78 */	mr r3, r30
/* 8061D7C4  4B CB 15 79 */	bl __dl__FPv
lbl_8061D7C8:
