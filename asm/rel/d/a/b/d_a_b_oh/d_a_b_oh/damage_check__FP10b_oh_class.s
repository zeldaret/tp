...
/* 8061CB5C  4B D4 56 75 */	bl _savegpr_26
/* 8061CB60  7C 7E 1B 78 */	mr r30, r3
/* 8061CB64  3C 60 80 62 */	lis r3, lit_3650@ha /* 0x8061D9D4@ha */
/* 8061CB68  3B E3 D9 D4 */	addi r31, r3, lit_3650@l /* 0x8061D9D4@l */
/* 8061CB6C  38 7E 0C CC */	addi r3, r30, 0xccc
/* 8061CB70  4B A6 6C C1 */	bl Move__10dCcD_GSttsFv
...
/* 8061CB98  4B A6 78 C9 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 8061CB9C  28 03 00 00 */	cmplwi r3, 0
/* 8061CBA0  41 82 00 E8 */	beq lbl_8061CC88
/* 8061CBA4  7F 83 E3 78 */	mr r3, r28
/* 8061CBA8  4B A6 79 51 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 8061CBC0  4B A6 B0 45 */	bl cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 8061CBE4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061CBE8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061CBEC  4B D2 98 C5 */	bl PSMTXCopy
/* 8061CBF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061CBF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8061CC10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8061CC14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8061CC34  4B A2 F5 E5 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 8061CC44  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8061CC48  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8061CC74  4B C8 ED 11 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 8061CCA4  3C 60 80 62 */	lis r3, boss@ha /* 0x8061DBD4@ha */
/* 8061CCA8  38 63 DB D4 */	addi r3, r3, boss@l /* 0x8061DBD4@l */
...
lbl_8061CD04:
/* 8061CD04  3C 60 80 62 */	lis r3, boss@ha /* 0x8061DBD4@ha */
/* 8061CD08  38 83 DB D4 */	addi r4, r3, boss@l /* 0x8061DBD4@l */
...
/* 8061CD5C  3C 60 80 62 */	lis r3, boss@ha /* 0x8061DBD4@ha */
/* 8061CD60  38 63 DB D4 */	addi r3, r3, boss@l /* 0x8061DBD4@l */
...
/* 8061CD84  4B D4 54 99 */	bl _restgpr_26
