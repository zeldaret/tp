...
/* 8061EED8  4B D4 32 F1 */	bl _savegpr_24
/* 8061EEDC  7C 7D 1B 78 */	mr r29, r3
/* 8061EEE0  3C 60 80 63 */	lis r3, lit_3920@ha /* 0x8062E634@ha */
/* 8061EEE4  3B E3 E6 34 */	addi r31, r3, lit_3920@l /* 0x8062E634@l */
...
lbl_8061EF10:
/* 8061EF10  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8061EF14  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8061EF18  38 80 00 00 */	li r4, 0
/* 8061EF1C  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 8061EF20  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8061EF24  4B B8 48 A1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8061EF28  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8061EF2C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8061EF30  80 9E 00 04 */	lwz r4, 4(r30)
/* 8061EF34  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8061EF38  4B B8 5E 69 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8061EF58  4B 9E E8 51 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_8061EF5C:
...
/* 8061F01C  4B 9F 21 A5 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 8061F06C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 8061F070  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 8061F074  4B A0 F8 9D */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 8061F088  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8061F08C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8061F0B8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8061F0BC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8061F0C0  80 84 00 04 */	lwz r4, 4(r4)
/* 8061F0C4  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8061F0C8  4B B8 5C D9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8061F0CC  80 7D 05 FC */	lwz r3, 0x5fc(r29)
/* 8061F0D0  4B 9F 20 F1 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 8061F0D4  48 00 00 50 */	b lbl_8061F124
lbl_8061F0D8:
/* 8061F0D8  7F 5D FA 14 */	add r26, r29, r31
/* 8061F0DC  83 1A 05 BC */	lwz r24, 0x5bc(r26)
/* 8061F0E0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8061F0E4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8061F0E8  80 98 00 04 */	lwz r4, 4(r24)
/* 8061F0EC  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8061F0F0  4B B8 5C B1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8061F118  4B 9E E6 91 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_8061F11C:
/* 8061F11C  7F 03 C3 78 */	mr r3, r24
/* 8061F120  4B 9E EB A5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8061F124:
...
/* 8061F13C  4B A3 6D E1 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_8061F140:
...
/* 8061F160  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8061F164  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8061F168  80 9D 06 48 */	lwz r4, 0x648(r29)
/* 8061F16C  80 84 00 04 */	lwz r4, 4(r4)
/* 8061F170  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8061F174  4B B8 5C 2D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8061F1A0  3C 80 80 63 */	lis r4, l_HIO@ha /* 0x8062F02C@ha */
/* 8061F1A4  38 84 F0 2C */	addi r4, r4, l_HIO@l /* 0x8062F02C@l */
...
/* 8061F1C0  4B 9E EB 05 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8061F1C4:
/* 8061F1C4  38 60 00 01 */	li r3, 1
lbl_8061F1C8:
/* 8061F1C8  39 61 00 50 */	addi r11, r1, 0x50
/* 8061F1CC  4B D4 30 49 */	bl _restgpr_24
