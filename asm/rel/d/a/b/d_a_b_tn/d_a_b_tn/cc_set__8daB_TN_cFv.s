...
/* 8062BDDC  4B D3 63 E5 */	bl _savegpr_22
/* 8062BDE0  7C 7F 1B 78 */	mr r31, r3
/* 8062BDE4  3C 60 80 63 */	lis r3, lit_3920@ha /* 0x8062E634@ha */
/* 8062BDE8  3B C3 E6 34 */	addi r30, r3, lit_3920@l /* 0x8062E634@l */
...
/* 8062BE00  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8062BE04  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8062BE08  4B D1 A6 A9 */	bl PSMTXCopy
/* 8062BE0C  C0 3E 00 04 */	lfs f1, 4(r30)
/* 8062BE10  FC 40 08 90 */	fmr f2, f1
/* 8062BE14  FC 60 08 90 */	fmr f3, f1
/* 8062BE18  4B 9E 0F 85 */	bl transM__14mDoMtx_stack_cFfff
/* 8062BE1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8062BE20  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8062BE98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062BE9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8062BED4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8062BED8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8062BEDC  4B D1 A5 D5 */	bl PSMTXCopy
...
/* 8062C088  4B C4 35 C1 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8062C08C  38 7F 3E 98 */	addi r3, r31, 0x3e98
/* 8062C090  C0 3E 00 78 */	lfs f1, 0x78(r30)
/* 8062C094  4B C4 36 75 */	bl SetR__8cM3dGSphFf
/* 8062C098  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062C09C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8062C0A0  38 63 23 3C */	addi r3, r3, 0x233c
/* 8062C0A4  38 9F 3D 74 */	addi r4, r31, 0x3d74
/* 8062C0A8  4B C3 8B 01 */	bl Set__4cCcSFP8cCcD_Obj
lbl_8062C0AC:
...
/* 8062C0C4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8062C0C8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8062C0CC  4B D1 A3 E5 */	bl PSMTXCopy
/* 8062C0D0  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 8062C0D4  C0 5E 01 40 */	lfs f2, 0x140(r30)
/* 8062C0D8  C0 7E 02 80 */	lfs f3, 0x280(r30)
/* 8062C0DC  4B 9E 0C C1 */	bl transM__14mDoMtx_stack_cFfff
/* 8062C0E0  3A E0 00 00 */	li r23, 0
/* 8062C0E4  3B 40 00 00 */	li r26, 0
/* 8062C0E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062C0EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8062C10C  4B 9E 0C 91 */	bl transM__14mDoMtx_stack_cFfff
...
/* 8062C120  4B 9E 0C 7D */	bl transM__14mDoMtx_stack_cFfff
lbl_8062C124:
...
/* 8062C14C  4B C4 34 FD */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 8062C1B0  4B C4 2E 51 */	bl Set__8cM3dGCpsFRC4cXyzRC4cXyzf
...
/* 8062C1C8  4B C4 2E 39 */	bl Set__8cM3dGCpsFRC4cXyzRC4cXyzf
lbl_8062C1CC:
...
/* 8062C1EC  4B C3 89 BD */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8062C214  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8062C218  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8062C21C  4B D1 A2 95 */	bl PSMTXCopy
/* 8062C220  C0 3E 02 64 */	lfs f1, 0x264(r30)
/* 8062C224  C0 5E 00 04 */	lfs f2, 4(r30)
/* 8062C228  FC 60 10 90 */	fmr f3, f2
/* 8062C22C  4B 9E 0B 71 */	bl transM__14mDoMtx_stack_cFfff
/* 8062C230  3A E0 00 00 */	li r23, 0
/* 8062C234  3B 40 00 00 */	li r26, 0
/* 8062C238  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062C23C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8062C250  4B 9E 0B 4D */	bl transM__14mDoMtx_stack_cFfff
...
/* 8062C2B8  4B C4 2D 49 */	bl Set__8cM3dGCpsFRC4cXyzRC4cXyzf
...
/* 8062C2DC  4B C3 88 CD */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8062C2F4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8062C2F8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8062C2FC  4B D1 A1 B5 */	bl PSMTXCopy
/* 8062C300  3A E0 00 00 */	li r23, 0
/* 8062C304  3B 40 00 00 */	li r26, 0
/* 8062C308  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062C30C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8062C320  4B 9E 0A 7D */	bl transM__14mDoMtx_stack_cFfff
...
/* 8062C388  4B C4 2C 79 */	bl Set__8cM3dGCpsFRC4cXyzRC4cXyzf
...
/* 8062C3AC  4B C3 87 FD */	bl Set__4cCcSFP8cCcD_Obj
lbl_8062C3B0:
...
/* 8062C3C8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8062C3CC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8062C3D0  4B D1 A0 E1 */	bl PSMTXCopy
/* 8062C3D4  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 8062C3D8  C0 5E 02 88 */	lfs f2, 0x288(r30)
/* 8062C3DC  C0 7E 00 04 */	lfs f3, 4(r30)
/* 8062C3E0  4B 9E 09 BD */	bl transM__14mDoMtx_stack_cFfff
...
/* 8062C404  4B C4 32 45 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 8062C41C  4B C4 32 ED */	bl SetR__8cM3dGSphFf
...
/* 8062C438  4B C4 32 D1 */	bl SetR__8cM3dGSphFf
/* 8062C43C  48 00 00 10 */	b lbl_8062C44C
lbl_8062C440:
/* 8062C440  38 7F 37 3C */	addi r3, r31, 0x373c
/* 8062C444  C0 3E 00 AC */	lfs f1, 0xac(r30)
/* 8062C448  4B C4 32 C1 */	bl SetR__8cM3dGSphFf
lbl_8062C44C:
/* 8062C44C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062C450  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8062C454  38 63 23 3C */	addi r3, r3, 0x233c
/* 8062C458  38 9F 36 18 */	addi r4, r31, 0x3618
/* 8062C45C  4B C3 87 4D */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8062C488  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8062C48C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8062C490  4B D1 A0 21 */	bl PSMTXCopy
...
/* 8062C4B4  4B C4 31 95 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8062C4B8  38 7F 37 3C */	addi r3, r31, 0x373c
/* 8062C4BC  C0 3E 00 88 */	lfs f1, 0x88(r30)
/* 8062C4C0  4B C4 32 49 */	bl SetR__8cM3dGSphFf
/* 8062C4C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062C4C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8062C4CC  38 63 23 3C */	addi r3, r3, 0x233c
/* 8062C4D0  38 9F 36 18 */	addi r4, r31, 0x3618
/* 8062C4D4  4B C3 86 D5 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8062C500  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062C504  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8062C524  4B 9E 08 41 */	bl transS__14mDoMtx_stack_cFRC4cXyz
...
/* 8062C550  4B C4 30 F9 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 8062C5A0  4B D3 5C 6D */	bl _restgpr_22
