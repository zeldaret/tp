...
/* 8061EC68  4B D4 35 70 */	b _savegpr_28
...
/* 8061EC88  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8061EC8C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8061EC90  4B D2 78 20 */	b PSMTXCopy
/* 8061EC94  2C 1F 00 05 */	cmpwi r31, 5
/* 8061EC98  40 82 00 18 */	bne lbl_8061ECB0
/* 8061EC9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061ECA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8061ECA4  A8 9C 0A 96 */	lha r4, 0xa96(r28)
/* 8061ECA8  4B 9E D6 F4 */	b mDoMtx_XrotM__FPA4_fs
/* 8061ECAC  48 00 00 1C */	b lbl_8061ECC8
lbl_8061ECB0:
/* 8061ECB0  2C 1F 00 01 */	cmpwi r31, 1
/* 8061ECB4  40 82 00 14 */	bne lbl_8061ECC8
/* 8061ECB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061ECBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8061ECC0  A8 9C 0A 98 */	lha r4, 0xa98(r28)
/* 8061ECC4  4B 9E D6 D8 */	b mDoMtx_XrotM__FPA4_fs
lbl_8061ECC8:
/* 8061ECC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061ECCC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8061ECD0  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 8061ECD4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 8061ECD8  7C 80 F2 14 */	add r4, r0, r30
/* 8061ECDC  4B D2 77 D4 */	b PSMTXCopy
/* 8061ECE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061ECE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8061ECE8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 8061ECEC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 8061ECF0  4B D2 77 C0 */	b PSMTXCopy
/* 8061ECF4  38 60 00 01 */	li r3, 1
/* 8061ECF8  39 61 00 20 */	addi r11, r1, 0x20
/* 8061ECFC  4B D4 35 28 */	b _restgpr_28
