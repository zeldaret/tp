...
/* 80625EA0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80625EA4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80625EA8  4B D2 06 09 */	bl PSMTXCopy
/* 80625EAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80625EB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80625EDC  3C 60 80 63 */	lis r3, lit_3921@ha /* 0x8062E638@ha */
/* 80625EE0  C0 03 E6 38 */	lfs f0, lit_3921@l(r3)  /* 0x8062E638@l */
...
/* 80625EF8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80625EFC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80625F00  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80625F04  4B 9F 48 0D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80625F18  3C C0 80 63 */	lis r6, lit_3921@ha /* 0x8062E638@ha */
/* 80625F1C  C0 26 E6 38 */	lfs f1, lit_3921@l(r6)  /* 0x8062E638@l */
/* 80625F20  3C C0 80 63 */	lis r6, lit_3922@ha /* 0x8062E63C@ha */
/* 80625F24  C0 46 E6 3C */	lfs f2, lit_3922@l(r6)  /* 0x8062E63C@l */
/* 80625F28  4B FF A9 A1 */	bl setBck__8daB_TN_cFiUcff
/* 80625F2C  48 00 00 F4 */	b lbl_80626020
lbl_80625F30:
/* 80625F30  7F E3 FB 78 */	mr r3, r31
/* 80625F34  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80625F38  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80625F3C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80625F40  4B 9F 47 D1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80625F44  7C 64 1B 78 */	mr r4, r3
/* 80625F48  38 7F 04 E6 */	addi r3, r31, 0x4e6
/* 80625F4C  38 A0 20 00 */	li r5, 0x2000
/* 80625F50  4B C4 AC 41 */	bl cLib_chaseAngleS__FPsss
/* 80625F54  7F E3 FB 78 */	mr r3, r31
/* 80625F58  38 80 00 0C */	li r4, 0xc
/* 80625F5C  38 A0 00 00 */	li r5, 0
/* 80625F60  3C C0 80 63 */	lis r6, lit_3921@ha /* 0x8062E638@ha */
/* 80625F64  C0 26 E6 38 */	lfs f1, lit_3921@l(r6)  /* 0x8062E638@l */
/* 80625F68  3C C0 80 63 */	lis r6, lit_3922@ha /* 0x8062E63C@ha */
/* 80625F6C  C0 46 E6 3C */	lfs f2, lit_3922@l(r6)  /* 0x8062E63C@l */
...
lbl_80625F94:
/* 80625F94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80625F98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80625F9C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80625FA0  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80625FA4  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80625FA8  A0 84 02 AA */	lhz r4, 0x2aa(r4)
/* 80625FAC  4B A0 EA 11 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80625FD8  3C 60 80 63 */	lis r3, lit_3921@ha /* 0x8062E638@ha */
/* 80625FDC  C0 23 E6 38 */	lfs f1, lit_3921@l(r3)  /* 0x8062E638@l */
...
/* 80625FF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80625FFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
