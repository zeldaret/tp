...
/* 8061DCC8  4B D4 45 11 */	bl _savegpr_28
/* 8061DCCC  2C 04 00 00 */	cmpwi r4, 0
/* 8061DCD0  40 82 00 C4 */	bne lbl_8061DD94
/* 8061DCD4  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 8061DCD8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8061DCDC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8061DD08  4B C5 31 55 */	bl MtxTrans__FfffUc
/* 8061DD0C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8061DD10  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8061DD24  4B 9E E7 11 */	bl mDoMtx_YrotM__FPA4_fs
/* 8061DD28  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8061DD2C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8061DD30  80 63 00 00 */	lwz r3, 0(r3)
/* 8061DD34  7C 9C EA 14 */	add r4, r28, r29
/* 8061DD38  A8 84 07 D4 */	lha r4, 0x7d4(r4)
/* 8061DD3C  4B 9E E6 61 */	bl mDoMtx_XrotM__FPA4_fs
/* 8061DD40  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8061DD44  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8061DD48  80 63 00 00 */	lwz r3, 0(r3)
/* 8061DD4C  38 80 C0 00 */	li r4, -16384
/* 8061DD50  4B 9E E6 E5 */	bl mDoMtx_YrotM__FPA4_fs
/* 8061DD54  57 E0 10 3A */	slwi r0, r31, 2
/* 8061DD58  7C 7C 02 14 */	add r3, r28, r0
/* 8061DD5C  C0 43 05 E8 */	lfs f2, 0x5e8(r3)
/* 8061DD60  3C 60 80 62 */	lis r3, lit_3678@ha /* 0x8061EA38@ha */
/* 8061DD64  C0 23 EA 38 */	lfs f1, lit_3678@l(r3)  /* 0x8061EA38@l */
/* 8061DD68  FC 60 10 90 */	fmr f3, f2
/* 8061DD6C  38 60 00 01 */	li r3, 1
/* 8061DD70  4B C5 31 35 */	bl MtxScale__FfffUc
/* 8061DD74  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8061DD78  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8061DD90  4B D2 87 21 */	bl PSMTXCopy
lbl_8061DD94:
/* 8061DD94  38 60 00 01 */	li r3, 1
/* 8061DD98  39 61 00 20 */	addi r11, r1, 0x20
/* 8061DD9C  4B D4 44 89 */	bl _restgpr_28
