...
/* 8061E1F0  3C 60 80 62 */	lis r3, lit_3678@ha /* 0x8061EA38@ha */
/* 8061E1F4  3B E3 EA 38 */	addi r31, r3, lit_3678@l /* 0x8061EA38@l */
/* 8061E1F8  A8 1E 05 CE */	lha r0, 0x5ce(r30)
/* 8061E1FC  2C 00 00 00 */	cmpwi r0, 0
/* 8061E200  3C 60 80 62 */	lis r3, boss@ha /* 0x8061EAE8@ha */
/* 8061E204  38 63 EA E8 */	addi r3, r3, boss@l /* 0x8061EAE8@l */
...
/* 8061E22C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061E230  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061E234  4B D2 82 7D */	bl PSMTXCopy
/* 8061E238  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061E23C  38 83 D4 70 */	addi r4, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8061E258  3C 60 80 62 */	lis r3, boss@ha /* 0x8061EAE8@ha */
/* 8061E25C  38 63 EA E8 */	addi r3, r3, boss@l /* 0x8061EAE8@l */
...
/* 8061E274  4B D2 82 3D */	bl PSMTXCopy
...
/* 8061E2B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061E2BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061E2C0  38 81 00 20 */	addi r4, r1, 0x20
/* 8061E2C4  38 A1 00 14 */	addi r5, r1, 0x14
/* 8061E2C8  4B D2 8A A5 */	bl PSMTXMultVec
/* 8061E2CC  38 61 00 08 */	addi r3, r1, 8
/* 8061E2D0  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 8061E2D4  38 A1 00 14 */	addi r5, r1, 0x14
/* 8061E2D8  4B C4 88 5D */	bl __mi__4cXyzCFRC3Vec
...
/* 8061E2F4  4B C4 93 81 */	bl cM_atan2s__Fff
...
/* 8061E328  4B C4 93 4D */	bl cM_atan2s__Fff
...
/* 8061E33C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061E340  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061E344  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 8061E348  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 8061E34C  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 8061E350  4B D2 85 99 */	bl PSMTXTrans
/* 8061E354  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061E358  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061E35C  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 8061E360  4B 9E E0 D5 */	bl mDoMtx_YrotM__FPA4_fs
/* 8061E364  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061E368  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061E36C  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 8061E370  4B 9E E0 2D */	bl mDoMtx_XrotM__FPA4_fs
/* 8061E374  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 8061E378  80 83 00 04 */	lwz r4, 4(r3)
/* 8061E37C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8061E380  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8061E384  38 84 00 24 */	addi r4, r4, 0x24
/* 8061E388  4B D2 81 29 */	bl PSMTXCopy
/* 8061E38C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8061E390  7C 03 07 74 */	extsb r3, r0
/* 8061E394  4B A0 EC D9 */	bl dComIfGp_getReverb__Fi
/* 8061E398  7C 65 1B 78 */	mr r5, r3
/* 8061E39C  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 8061E3A0  38 80 00 00 */	li r4, 0
/* 8061E3A4  4B 9F 2D 0D */	bl play__16mDoExt_McaMorfSOFUlSc
/* 8061E3A8  3C 60 80 62 */	lis r3, boss@ha /* 0x8061EAE8@ha */
/* 8061E3AC  38 63 EA E8 */	addi r3, r3, boss@l /* 0x8061EAE8@l */
...
/* 8061E3E4  4B 9E F0 45 */	bl play__14mDoExt_baseAnmFv
/* 8061E3E8  80 7E 05 C4 */	lwz r3, 0x5c4(r30)
/* 8061E3EC  4B 9E F0 3D */	bl play__14mDoExt_baseAnmFv
lbl_8061E3F0:
/* 8061E3F0  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 8061E3F4  4B 9F 2D F9 */	bl modelCalc__16mDoExt_McaMorfSOFv
