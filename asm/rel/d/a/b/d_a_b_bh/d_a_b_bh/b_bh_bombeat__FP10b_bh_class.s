...
/* 805AEF88  4B DB 32 54 */	b _savegpr_29
/* 805AEF8C  7C 7E 1B 78 */	mr r30, r3
/* 805AEF90  3C 60 80 5B */	lis r3, lit_3764@ha
/* 805AEF94  3B A3 31 40 */	addi r29, r3, lit_3764@l
/* 805AEF98  80 1E 04 A4 */	lwz r0, 0x4a4(r30)
/* 805AEF9C  90 01 00 08 */	stw r0, 8(r1)
/* 805AEFA0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 805AEFA4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 805AEFA8  38 81 00 08 */	addi r4, r1, 8
/* 805AEFAC  4B A6 A8 4C */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 805AF04C  3C 60 80 5B */	lis r3, bh@ha
/* 805AF050  38 63 34 14 */	addi r3, r3, bh@l
...
/* 805AF17C  4B CC 08 C0 */	b cLib_addCalc2__FPffff
...
/* 805AF19C  4B CC 14 6C */	b cLib_addCalcAngleS2__FPssss
lbl_805AF1A0:
...
/* 805AF1E4  4B DB 30 44 */	b _restgpr_29
