...
/* 805AE360  4B DB 3E 74 */	b _savegpr_27
/* 805AE364  7C 7C 1B 78 */	mr r28, r3
/* 805AE368  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805AE36C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805AE370  38 80 00 00 */	li r4, 0
/* 805AE374  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 805AE378  38 DC 01 0C */	addi r6, r28, 0x10c
/* 805AE37C  4B BF 54 48 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805AE380  80 7C 05 B8 */	lwz r3, 0x5b8(r28)
/* 805AE384  83 C3 00 04 */	lwz r30, 4(r3)
/* 805AE388  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805AE38C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805AE390  80 9E 00 04 */	lwz r4, 4(r30)
/* 805AE394  38 BC 01 0C */	addi r5, r28, 0x10c
/* 805AE398  4B BF 6A 08 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 805AE39C  80 9E 00 04 */	lwz r4, 4(r30)
/* 805AE3A0  7F 83 E3 78 */	mr r3, r28
/* 805AE3A4  4B A6 F0 88 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 805AE3A8  80 7C 05 B8 */	lwz r3, 0x5b8(r28)
/* 805AE3AC  4B A6 2E 14 */	b entryDL__16mDoExt_McaMorfSOFv
/* 805AE3B0  3B 60 00 00 */	li r27, 0
/* 805AE3B4  3B E0 00 00 */	li r31, 0
/* 805AE3B8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805AE3BC  3B C3 CA 54 */	addi r30, r3, g_env_light@l
lbl_805AE3C0:
...
/* 805AE3D4  4B BF 69 CC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 805AE3D8  80 7D 08 00 */	lwz r3, 0x800(r29)
/* 805AE3DC  4B A5 F8 E8 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 805AE3F8  4B BF 69 A8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 805AE3FC  80 7D 09 1C */	lwz r3, 0x91c(r29)
/* 805AE400  4B A5 F8 C4 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_805AE404:
...
/* 805AE41C  4B DB 3E 04 */	b _restgpr_27
