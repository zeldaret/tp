...
/* 805B2B08  4B DA F6 C1 */	bl _savegpr_24
/* 805B2B0C  7C 7F 1B 78 */	mr r31, r3
/* 805B2B10  3C 80 80 5B */	lis r4, lit_1109@ha /* 0x805B33B0@ha */
/* 805B2B14  3B A4 33 B0 */	addi r29, r4, lit_1109@l /* 0x805B33B0@l */
/* 805B2B18  3C 80 80 5B */	lis r4, lit_3764@ha /* 0x805B3140@ha */
/* 805B2B1C  3B C4 31 40 */	addi r30, r4, lit_3764@l /* 0x805B3140@l */
...
/* 805B2B38  4B A6 60 2D */	bl __ct__10fopAc_ac_cFv
/* 805B2B3C  38 79 05 BC */	addi r3, r25, 0x5bc
/* 805B2B40  4B D0 E4 25 */	bl __ct__15Z2CreatureEnemyFv
/* 805B2B44  38 79 06 BC */	addi r3, r25, 0x6bc
/* 805B2B48  3C 80 80 5B */	lis r4, __ct__4cXyzFv@ha /* 0x805B3094@ha */
/* 805B2B4C  38 84 30 94 */	addi r4, r4, __ct__4cXyzFv@l /* 0x805B3094@l */
/* 805B2B50  3C A0 80 5B */	lis r5, __dt__4cXyzFv@ha /* 0x805AEB04@ha */
/* 805B2B54  38 A5 EB 04 */	addi r5, r5, __dt__4cXyzFv@l /* 0x805AEB04@l */
/* 805B2B58  38 C0 00 0C */	li r6, 0xc
/* 805B2B5C  38 E0 00 12 */	li r7, 0x12
/* 805B2B60  4B DA F2 01 */	bl __construct_array
/* 805B2B64  38 79 07 94 */	addi r3, r25, 0x794
/* 805B2B68  3C 80 80 5B */	lis r4, __ct__5csXyzFv@ha /* 0x805B3090@ha */
/* 805B2B6C  38 84 30 90 */	addi r4, r4, __ct__5csXyzFv@l /* 0x805B3090@l */
/* 805B2B70  3C A0 80 5B */	lis r5, __dt__5csXyzFv@ha /* 0x805B3054@ha */
/* 805B2B74  38 A5 30 54 */	addi r5, r5, __dt__5csXyzFv@l /* 0x805B3054@l */
/* 805B2B78  38 C0 00 06 */	li r6, 6
/* 805B2B7C  38 E0 00 12 */	li r7, 0x12
/* 805B2B80  4B DA F1 E1 */	bl __construct_array
/* 805B2B84  38 79 09 A8 */	addi r3, r25, 0x9a8
/* 805B2B88  3C 80 80 5B */	lis r4, __ct__5csXyzFv@ha /* 0x805B3090@ha */
/* 805B2B8C  38 84 30 90 */	addi r4, r4, __ct__5csXyzFv@l /* 0x805B3090@l */
/* 805B2B90  3C A0 80 5B */	lis r5, __dt__5csXyzFv@ha /* 0x805B3054@ha */
/* 805B2B94  38 A5 30 54 */	addi r5, r5, __dt__5csXyzFv@l /* 0x805B3054@l */
/* 805B2B98  38 C0 00 06 */	li r6, 6
/* 805B2B9C  38 E0 00 12 */	li r7, 0x12
/* 805B2BA0  4B DA F1 C1 */	bl __construct_array
/* 805B2BA4  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 805B2BA8  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 805B2BAC  90 19 0A 4C */	stw r0, 0xa4c(r25)
/* 805B2BB0  38 79 0A 50 */	addi r3, r25, 0xa50
/* 805B2BB4  4B AD 0B AD */	bl __ct__10dCcD_GSttsFv
/* 805B2BB8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 805B2BBC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 805B2BD4  4B AD 0E 55 */	bl __ct__12dCcD_GObjInfFv
/* 805B2BD8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805B2BDC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805B2BE0  90 18 01 20 */	stw r0, 0x120(r24)
/* 805B2BE4  3C 60 80 5B */	lis r3, __vt__8cM3dGAab@ha /* 0x805B338C@ha */
/* 805B2BE8  38 03 33 8C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805B338C@l */
/* 805B2BEC  90 18 01 1C */	stw r0, 0x11c(r24)
/* 805B2BF0  3C 60 80 5B */	lis r3, __vt__8cM3dGSph@ha /* 0x805B3380@ha */
/* 805B2BF4  38 03 33 80 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x805B3380@l */
/* 805B2BF8  90 18 01 34 */	stw r0, 0x134(r24)
/* 805B2BFC  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 805B2C00  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 805B2C04  90 78 01 20 */	stw r3, 0x120(r24)
/* 805B2C08  3B 83 00 58 */	addi r28, r3, 0x58
/* 805B2C0C  93 98 01 34 */	stw r28, 0x134(r24)
/* 805B2C10  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 805B2C14  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 805B2C34  4B AD 0D F5 */	bl __ct__12dCcD_GObjInfFv
/* 805B2C38  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805B2C3C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805B2C40  90 18 01 20 */	stw r0, 0x120(r24)
/* 805B2C44  3C 60 80 5B */	lis r3, __vt__8cM3dGAab@ha /* 0x805B338C@ha */
/* 805B2C48  38 03 33 8C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805B338C@l */
/* 805B2C4C  90 18 01 1C */	stw r0, 0x11c(r24)
/* 805B2C50  3C 60 80 5B */	lis r3, __vt__8cM3dGSph@ha /* 0x805B3380@ha */
/* 805B2C54  38 03 33 80 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x805B3380@l */
/* 805B2C58  90 18 01 34 */	stw r0, 0x134(r24)
/* 805B2C5C  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 805B2C60  38 03 35 40 */	addi r0, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 805B2C64  90 18 01 20 */	stw r0, 0x120(r24)
/* 805B2C68  93 98 01 34 */	stw r28, 0x134(r24)
/* 805B2C6C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 805B2C70  38 03 BF C0 */	addi r0, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 805B2C84  4B AC 32 29 */	bl __ct__12dBgS_AcchCirFv
/* 805B2C88  3B 19 0D 48 */	addi r24, r25, 0xd48
/* 805B2C8C  7F 03 C3 78 */	mr r3, r24
/* 805B2C90  4B AC 34 11 */	bl __ct__9dBgS_AcchFv
/* 805B2C94  3C 60 80 5B */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x805B335C@ha */
/* 805B2C98  38 63 33 5C */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x805B335C@l */
...
/* 805B2CB4  4B AC 61 B5 */	bl SetObj__16dBgS_PolyPassChkFv
lbl_805B2CB8:
...
/* 805B2CC8  3C 80 80 5B */	lis r4, d_a_b_bh__stringBase0@ha /* 0x805B322C@ha */
/* 805B2CCC  38 84 32 2C */	addi r4, r4, d_a_b_bh__stringBase0@l /* 0x805B322C@l */
/* 805B2CD0  4B A7 A1 ED */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 805B2D24  3C 80 80 5B */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x805B28B0@ha */
/* 805B2D28  38 84 28 B0 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x805B28B0@l */
/* 805B2D2C  3C A0 00 01 */	lis r5, 0x0001 /* 0x0000DB20@ha */
/* 805B2D30  38 A5 DB 20 */	addi r5, r5, 0xDB20 /* 0x0000DB20@l */
/* 805B2D34  4B A6 77 7D */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 805B2D90  4B AD 0A D1 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 805B2D94  38 7F 0A 70 */	addi r3, r31, 0xa70
/* 805B2D98  3C 80 80 5B */	lis r4, cc_sph_src@ha /* 0x805B328C@ha */
/* 805B2D9C  38 84 32 8C */	addi r4, r4, cc_sph_src@l /* 0x805B328C@l */
/* 805B2DA0  4B AD 1C 95 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
/* 805B2DA4  38 1F 0A 34 */	addi r0, r31, 0xa34
/* 805B2DA8  90 1F 0A B4 */	stw r0, 0xab4(r31)
/* 805B2DAC  38 7F 0B A8 */	addi r3, r31, 0xba8
/* 805B2DB0  3C 80 80 5B */	lis r4, tg_sph_src@ha /* 0x805B32CC@ha */
/* 805B2DB4  38 84 32 CC */	addi r4, r4, tg_sph_src@l /* 0x805B32CC@l */
/* 805B2DB8  4B AD 1C 7D */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805B2E08  4B AC 34 41 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 805B2E0C  38 7F 0D 08 */	addi r3, r31, 0xd08
/* 805B2E10  C0 3E 00 5C */	lfs f1, 0x5c(r30)
/* 805B2E14  C0 5E 00 18 */	lfs f2, 0x18(r30)
/* 805B2E18  4B AC 31 41 */	bl SetWall__12dBgS_AcchCirFff
...
/* 805B2E30  4B D0 E2 65 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 805B2E78  4B A7 9B 05 */	bl getLayerNo__14dComIfG_play_cFi
...
lbl_805B2EB4:
/* 805B2EB4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B2EB8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805B2ECC  4B A8 24 95 */	bl isSwitch__10dSv_info_cCFii
/* 805B2ED0  2C 03 00 00 */	cmpwi r3, 0
/* 805B2ED4  40 82 00 44 */	bne lbl_805B2F18
/* 805B2ED8  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 805B2EDC  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
...
/* 805B2F1C  4B CB 4A 39 */	bl cM_rndF__Ff
...
/* 805B2F40  4B DA F2 D5 */	bl _restgpr_24
