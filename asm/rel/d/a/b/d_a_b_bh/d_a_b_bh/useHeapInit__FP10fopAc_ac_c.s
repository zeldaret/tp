...
/* 805B28C8  4B DA F9 05 */	bl _savegpr_25
/* 805B28CC  7C 7E 1B 78 */	mr r30, r3
/* 805B28D0  3C 60 80 5B */	lis r3, lit_3764@ha /* 0x805B3140@ha */
/* 805B28D4  3B E3 31 40 */	addi r31, r3, lit_3764@l /* 0x805B3140@l */
/* 805B28D8  38 60 00 58 */	li r3, 0x58
/* 805B28DC  4B D1 C3 71 */	bl __nw__FUl
/* 805B28E0  7C 7C 1B 79 */	or. r28, r3, r3
/* 805B28E4  41 82 00 90 */	beq lbl_805B2974
/* 805B28E8  3C 60 80 5B */	lis r3, d_a_b_bh__stringBase0@ha /* 0x805B322C@ha */
/* 805B28EC  38 63 32 2C */	addi r3, r3, d_a_b_bh__stringBase0@l /* 0x805B322C@l */
/* 805B28F0  38 80 00 0C */	li r4, 0xc
/* 805B28F4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B28F8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805B290C  4B A8 99 E1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 805B2910  7C 7D 1B 78 */	mr r29, r3
/* 805B2914  3C 60 80 5B */	lis r3, d_a_b_bh__stringBase0@ha /* 0x805B322C@ha */
/* 805B2918  38 63 32 2C */	addi r3, r3, d_a_b_bh__stringBase0@l /* 0x805B322C@l */
/* 805B291C  38 80 00 15 */	li r4, 0x15
/* 805B2920  7F 65 DB 78 */	mr r5, r27
/* 805B2924  38 C0 00 80 */	li r6, 0x80
/* 805B2928  4B A8 99 C5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805B296C  4B A5 DE 65 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
lbl_805B2998:
/* 805B2998  3C 60 80 5B */	lis r3, d_a_b_bh__stringBase0@ha /* 0x805B322C@ha */
/* 805B299C  38 63 32 2C */	addi r3, r3, d_a_b_bh__stringBase0@l /* 0x805B322C@l */
/* 805B29A0  38 80 00 11 */	li r4, 0x11
/* 805B29A4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B29A8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805B29BC  4B A8 99 31 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805B29E0  4B A6 22 75 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 805B2A14  3C 60 80 5B */	lis r3, d_a_b_bh__stringBase0@ha /* 0x805B322C@ha */
/* 805B2A18  38 63 32 2C */	addi r3, r3, d_a_b_bh__stringBase0@l /* 0x805B322C@l */
/* 805B2A1C  38 80 00 12 */	li r4, 0x12
/* 805B2A20  7F 45 D3 78 */	mr r5, r26
/* 805B2A24  38 C0 00 80 */	li r6, 0x80
/* 805B2A28  4B A8 98 C5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805B2A58  4B A6 21 FD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 805B2A7C  4B CB 4F 11 */	bl cM_rndFX__Ff
...
/* 805B2A90  4B CB 4E C5 */	bl cM_rndF__Ff
...
/* 805B2AAC  4B CB 4E A9 */	bl cM_rndF__Ff
...
/* 805B2AE4  4B DA F7 35 */	bl _restgpr_25
