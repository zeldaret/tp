...
/* 80603A64  4B D5 E7 71 */	bl _savegpr_27
/* 80603A68  7C 7E 1B 78 */	mr r30, r3
/* 80603A6C  3C 80 80 60 */	lis r4, lit_3646@ha /* 0x80604044@ha */
/* 80603A70  3B E4 40 44 */	addi r31, r4, lit_3646@l /* 0x80604044@l */
...
/* 80603A9C  3C 80 80 60 */	lis r4, d_a_b_go__stringBase0@ha /* 0x8060408C@ha */
/* 80603AA0  38 84 40 8C */	addi r4, r4, d_a_b_go__stringBase0@l /* 0x8060408C@l */
/* 80603AA4  4B A2 94 19 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80603AB8  3C 80 80 60 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x8060395C@ha */
/* 80603ABC  38 84 39 5C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x8060395C@l */
/* 80603AC0  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 80603AC4  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 80603AC8  4B A1 69 E9 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80603ADC:
/* 80603ADC  3C 60 80 60 */	lis r3, data_80604140@ha /* 0x80604140@ha */
/* 80603AE0  8C 03 41 40 */	lbzu r0, data_80604140@l(r3)  /* 0x80604140@l */
...
/* 80603AFC  3C 60 80 60 */	lis r3, l_HIO@ha /* 0x80604150@ha */
/* 80603B00  38 63 41 50 */	addi r3, r3, l_HIO@l /* 0x80604150@l */
...
/* 80603B30  4B A1 69 F9 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80603B44  4B A1 69 F5 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80603B7C  4B A7 26 CD */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80603B80  38 7E 06 94 */	addi r3, r30, 0x694
/* 80603B84  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 80603B88  C0 5F 00 08 */	lfs f2, 8(r31)
/* 80603B8C  4B A7 23 CD */	bl SetWall__12dBgS_AcchCirFff
...
/* 80603BA4  4B CB D4 F1 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 80603C04  4B C6 3D 89 */	bl cM_rndFX__Ff
...
/* 80603C18  4B C6 3D 3D */	bl cM_rndF__Ff
...
/* 80603C68  4B A1 62 89 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 80603C8C  4B D5 E5 95 */	bl _restgpr_27
