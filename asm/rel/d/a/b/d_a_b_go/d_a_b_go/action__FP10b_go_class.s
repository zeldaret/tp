...
/* 80603648  4B D5 EB 95 */	bl _savegpr_29
/* 8060364C  7C 7D 1B 78 */	mr r29, r3
/* 80603650  3C 80 80 60 */	lis r4, lit_3646@ha /* 0x80604044@ha */
/* 80603654  3B C4 40 44 */	addi r30, r4, lit_3646@l /* 0x80604044@l */
/* 80603658  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8060365C  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80603660  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80603664  4B A1 70 AD */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80603668  B0 7D 06 7E */	sth r3, 0x67e(r29)
/* 8060366C  7F A3 EB 78 */	mr r3, r29
/* 80603670  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80603674  4B A1 71 6D */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806036B4  4B C6 42 A1 */	bl cM_rndF__Ff
...
/* 806036E0  4B C6 42 75 */	bl cM_rndF__Ff
...
/* 80603754  4B C6 CE B5 */	bl cLib_addCalcAngleS2__FPssss
/* 80603758  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8060375C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80603760  80 63 00 00 */	lwz r3, 0(r3)
/* 80603764  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 80603768  4B A0 8C 75 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80603788  4B C6 D7 65 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 806037A8  4B D4 38 E9 */	bl PSVECAdd
...
/* 806037C0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806037C4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806037C8  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806037CC  4B A7 32 E1 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 806037D0  39 61 00 40 */	addi r11, r1, 0x40
/* 806037D4  4B D5 EA 55 */	bl _restgpr_29
