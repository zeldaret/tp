...
/* 805B96B4  4B DA 8B 15 */	bl _savegpr_24
/* 805B96B8  7C 7D 1B 78 */	mr r29, r3
/* 805B96BC  3C 80 80 5C */	lis r4, cNullVec__6Z2Calc@ha /* 0x805BA874@ha */
/* 805B96C0  3B C4 A8 74 */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x805BA874@l */
/* 805B96C4  3C 80 80 5C */	lis r4, lit_3816@ha /* 0x805BA588@ha */
/* 805B96C8  3B E4 A5 88 */	addi r31, r4, lit_3816@l /* 0x805BA588@l */
...
/* 805B96F4  3C 80 80 5C */	lis r4, d_a_b_bq__stringBase0@ha /* 0x805BA86C@ha */
/* 805B96F8  38 84 A8 6C */	addi r4, r4, d_a_b_bq__stringBase0@l /* 0x805BA86C@l */
/* 805B96FC  4B A7 37 C1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 805B9700  7C 7C 1B 78 */	mr r28, r3
/* 805B9704  2C 1C 00 04 */	cmpwi r28, 4
/* 805B9708  40 82 04 10 */	bne lbl_805B9B18
/* 805B970C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B9710  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805B9714  3B 43 09 58 */	addi r26, r3, 0x958
/* 805B9718  7F 43 D3 78 */	mr r3, r26
/* 805B971C  38 80 00 03 */	li r4, 3
/* 805B9720  4B A7 B2 15 */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 805B9754  4B CA DC A1 */	bl __ct__5csXyzFsss
...
/* 805B9774  4B A6 31 E9 */	bl fopAcM_createWarpHole__FPC4cXyzPC5csXyziUcUcUc
/* 805B9778  7F 43 D3 78 */	mr r3, r26
/* 805B977C  38 80 00 04 */	li r4, 4
/* 805B9780  4B A7 B1 B5 */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 805B97D4  4B A6 29 01 */	bl fopAcM_createItemForBoss__FPC4cXyziiPC5csXyzPC4cXyzffi
lbl_805B97D8:
/* 805B97D8  38 00 00 06 */	li r0, 6
/* 805B97DC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805B97E0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_805B9800:
/* 805B9800  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B9804  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805B9818  4B A7 BA 99 */	bl offSwitch__10dSv_info_cFii
/* 805B981C  7F A3 EB 78 */	mr r3, r29
/* 805B9820  3C 80 80 5C */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x805B9370@ha */
/* 805B9824  38 84 93 70 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x805B9370@l */
/* 805B9828  38 A0 6F A0 */	li r5, 0x6fa0
/* 805B982C  4B A6 0C 85 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_805B9840:
/* 805B9840  3C 60 80 5C */	lis r3, data_805BAD50@ha /* 0x805BAD50@ha */
/* 805B9844  8C 03 AD 50 */	lbzu r0, data_805BAD50@l(r3)  /* 0x805BAD50@l */
...
/* 805B9860  3C 60 80 5C */	lis r3, l_HIO@ha /* 0x805BAD60@ha */
/* 805B9864  38 63 AD 60 */	addi r3, r3, l_HIO@l /* 0x805BAD60@l */
...
/* 805B988C  4B AC 9F D5 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 805B9890  38 7D 07 3C */	addi r3, r29, 0x73c
/* 805B9894  38 9E 02 F8 */	addi r4, r30, 0x2f8
/* 805B9898  4B AC B1 9D */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805B98B8  4B AC B1 7D */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805B98D4  4B AC 9F 8D */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 805B98D8  38 7D 09 E8 */	addi r3, r29, 0x9e8
/* 805B98DC  38 9E 03 78 */	addi r4, r30, 0x378
/* 805B98E0  4B AC B1 55 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805B98F4  4B AC B1 41 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805B9914  4B D0 77 81 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 805B9938  4B AC B0 FD */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805B9958  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805B995C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805B9960  80 63 00 00 */	lwz r3, 0(r3)
/* 805B9964  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 805B9968  4B A5 2A 75 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805B99E8  4B A6 05 09 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 805B9A4C  4B A6 04 A5 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
/* 805B9A50  90 7D 06 E8 */	stw r3, 0x6e8(r29)
/* 805B9A54  38 60 00 00 */	li r3, 0
/* 805B9A58  4B A7 2F 25 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 805B9A74  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 805B9A78  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
...
/* 805B9AA8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805B9AAC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805B9AC8  4B CF 55 49 */	bl bgmStart__8Z2SeqMgrFUlUll
...
/* 805B9AEC  4B CA DE 69 */	bl cM_rndF__Ff
...
/* 805B9B28  4B DA 86 ED */	bl _restgpr_24
