...
/* 805B8A44  4B DA 97 89 */	bl _savegpr_25
/* 805B8A48  7C 7F 1B 78 */	mr r31, r3
/* 805B8A4C  3C 60 80 5C */	lis r3, lit_3816@ha /* 0x805BA588@ha */
/* 805B8A50  3B C3 A5 88 */	addi r30, r3, lit_3816@l /* 0x805BA588@l */
/* 805B8A54  4B A5 F8 55 */	bl cDmrNowMidnaTalk__Fv
...
lbl_805B8A68:
/* 805B8A68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B8A6C  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_805B8A88:
/* 805B8A88  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 805B8A8C  38 83 0C 98 */	addi r4, r3, struct_80450C98+0x0@l /* 0x80450C98@l */
...
/* 805B8B20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805B8B24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805B8B28  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 805B8B2C  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 805B8B30  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 805B8B34  4B D8 DD B5 */	bl PSMTXTrans
/* 805B8B38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805B8B3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805B8B40  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 805B8B44  4B A5 38 F1 */	bl mDoMtx_YrotM__FPA4_fs
/* 805B8B48  3C 60 80 5C */	lis r3, l_HIO@ha /* 0x805BAD60@ha */
/* 805B8B4C  38 63 AD 60 */	addi r3, r3, l_HIO@l /* 0x805BAD60@l */
/* 805B8B50  C0 23 00 08 */	lfs f1, 8(r3)
/* 805B8B54  FC 40 08 90 */	fmr f2, f1
/* 805B8B58  FC 60 08 90 */	fmr f3, f1
/* 805B8B5C  4B A5 42 DD */	bl scaleM__14mDoMtx_stack_cFfff
/* 805B8B60  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 805B8B64  83 83 00 04 */	lwz r28, 4(r3)
/* 805B8B68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805B8B6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805B8B70  38 9C 00 24 */	addi r4, r28, 0x24
/* 805B8B74  4B D8 D9 3D */	bl PSMTXCopy
/* 805B8B78  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805B8B7C  7C 03 07 74 */	extsb r3, r0
/* 805B8B80  4B A7 44 ED */	bl dComIfGp_getReverb__Fi
/* 805B8B84  7C 65 1B 78 */	mr r5, r3
/* 805B8B88  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 805B8B8C  38 80 00 00 */	li r4, 0
/* 805B8B90  4B A5 85 21 */	bl play__16mDoExt_McaMorfSOFUlSc
...
/* 805B8BA8  4B A5 48 81 */	bl play__14mDoExt_baseAnmFv
lbl_805B8BAC:
...
/* 805B8BBC  4B A5 48 6D */	bl play__14mDoExt_baseAnmFv
lbl_805B8BC0:
/* 805B8BC0  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 805B8BC4  4B A5 86 29 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 805B8BF4  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 805B8BF8  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 805B8BFC  80 84 00 00 */	lwz r4, 0(r4)
/* 805B8C00  4B D8 D8 B1 */	bl PSMTXCopy
...
/* 805B8C40  4B CB 82 AD */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 805B8CA8  4B CB 6A 61 */	bl SetR__8cM3dGSphFf
...
/* 805B8CD0  4B CA DE 15 */	bl __pl__4cXyzCFRC3Vec
/* 805B8CD4  38 7F 09 D4 */	addi r3, r31, 0x9d4
/* 805B8CD8  38 81 00 50 */	addi r4, r1, 0x50
/* 805B8CDC  4B CB 69 6D */	bl SetC__8cM3dGSphFRC4cXyz
/* 805B8CE0  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 805B8CE4  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805B8CE8  38 63 09 60 */	addi r3, r3, 0x960
/* 805B8CEC  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 805B8CF0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 805B8CF4  80 84 00 00 */	lwz r4, 0(r4)
/* 805B8CF8  4B D8 D7 B9 */	bl PSMTXCopy
...
/* 805B8D54  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 805B8D58  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 805B8D5C  80 84 00 00 */	lwz r4, 0(r4)
/* 805B8D60  4B D8 D7 51 */	bl PSMTXCopy
...
/* 805B8D84  4B CB 81 69 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 805B8DF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B8DFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805B8E48  4B CB 68 01 */	bl SetC__8cM3dGSphFRC4cXyz
lbl_805B8E4C:
/* 805B8E4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B8E50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805B8E54  3B 43 23 3C */	addi r26, r3, 0x233c
/* 805B8E58  7F 43 D3 78 */	mr r3, r26
/* 805B8E5C  38 9F 07 3C */	addi r4, r31, 0x73c
/* 805B8E60  4B CA BD 49 */	bl Set__4cCcSFP8cCcD_Obj
/* 805B8E64  7F 43 D3 78 */	mr r3, r26
/* 805B8E68  38 9F 08 B0 */	addi r4, r31, 0x8b0
/* 805B8E6C  4B CA BD 3D */	bl Set__4cCcSFP8cCcD_Obj
...
/* 805B8F74  4B CB 76 95 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805B8F98  4B BE F8 75 */	bl dKy_custom_colset__FUcUcf
...
/* 805B8FB8  4B BE F8 55 */	bl dKy_custom_colset__FUcUcf
...
/* 805B8FDC  4B BE F8 31 */	bl dKy_custom_colset__FUcUcf
...
/* 805B9000  4B BE F8 0D */	bl dKy_custom_colset__FUcUcf
...
/* 805B9020  4B BE F7 ED */	bl dKy_custom_colset__FUcUcf
...
/* 805B9040  4B BE F7 CD */	bl dKy_custom_colset__FUcUcf
...
/* 805B9060  4B BE F7 AD */	bl dKy_custom_colset__FUcUcf
...
/* 805B9088  4B BE F7 85 */	bl dKy_custom_colset__FUcUcf
...
/* 805B90AC  4B BE F7 61 */	bl dKy_custom_colset__FUcUcf
...
/* 805B90C8  4B CB 69 75 */	bl cLib_addCalc2__FPffff
/* 805B90CC  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805B90D0  7C 03 07 74 */	extsb r3, r0
/* 805B90D4  4B A7 3F 99 */	bl dComIfGp_getReverb__Fi
...
/* 805B90FC  4B A7 3F 71 */	bl dComIfGp_getReverb__Fi
...
/* 805B913C  3C 60 80 5B */	lis r3, s_bi_del_sub__FPvPv@ha /* 0x805B3DAC@ha */
/* 805B9140  38 63 3D AC */	addi r3, r3, s_bi_del_sub__FPvPv@l /* 0x805B3DAC@l */
/* 805B9144  7F E4 FB 78 */	mr r4, r31
/* 805B9148  4B A6 81 F1 */	bl fpcEx_Search__FPFPvPv_PvPv
lbl_805B914C:
/* 805B914C  88 7F 13 94 */	lbz r3, 0x1394(r31)
/* 805B9150  2C 03 00 0A */	cmpwi r3, 0xa
/* 805B9154  40 82 00 18 */	bne lbl_805B916C
/* 805B9158  3C 60 80 5B */	lis r3, s_fw_del_sub__FPvPv@ha /* 0x805B3D60@ha */
/* 805B915C  38 63 3D 60 */	addi r3, r3, s_fw_del_sub__FPvPv@l /* 0x805B3D60@l */
/* 805B9160  7F E4 FB 78 */	mr r4, r31
/* 805B9164  4B A6 81 D5 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 805B91B0  4B A6 0D 41 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
lbl_805B91B4:
/* 805B91B4  3B 60 00 00 */	li r27, 0
/* 805B91B8  3B 80 00 00 */	li r28, 0
/* 805B91BC  3B 40 00 00 */	li r26, 0
/* 805B91C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B91C4  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_805B91C8:
...
/* 805B9208  3C C0 80 5C */	lis r6, takino2@ha /* 0x805BAB64@ha */
/* 805B920C  38 C6 AB 64 */	addi r6, r6, takino2@l /* 0x805BAB64@l */
...
/* 805B9228  4B A9 42 A5 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805B9268  3C C0 80 5C */	lis r6, takino@ha /* 0x805BAB5C@ha */
/* 805B926C  38 C6 AB 5C */	addi r6, r6, takino@l /* 0x805BAB5C@l */
...
/* 805B9288  4B A9 42 45 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805B92DC  4B DA 8F 3D */	bl _restgpr_25
