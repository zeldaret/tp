...
/* 805B9E1C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 805B9E20  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 805B9E40  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 805B9E44  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 805B9E5C  3C 60 80 5C */	lis r3, __vt__8cM3dGSph@ha /* 0x805BAD14@ha */
/* 805B9E60  38 03 AD 14 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x805BAD14@l */
/* 805B9E64  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_805B9E68:
/* 805B9E68  34 1E 01 04 */	addic. r0, r30, 0x104
/* 805B9E6C  41 82 00 24 */	beq lbl_805B9E90
/* 805B9E70  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805B9E74  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805B9E78  90 1E 01 20 */	stw r0, 0x120(r30)
/* 805B9E7C  34 1E 01 04 */	addic. r0, r30, 0x104
/* 805B9E80  41 82 00 10 */	beq lbl_805B9E90
/* 805B9E84  3C 60 80 5C */	lis r3, __vt__8cM3dGAab@ha /* 0x805BAD20@ha */
/* 805B9E88  38 03 AD 20 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805BAD20@l */
/* 805B9E8C  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_805B9E90:
/* 805B9E90  7F C3 F3 78 */	mr r3, r30
/* 805B9E94  38 80 00 00 */	li r4, 0
/* 805B9E98  4B AC A2 4D */	bl __dt__12dCcD_GObjInfFv
/* 805B9E9C  7F E0 07 35 */	extsh. r0, r31
/* 805B9EA0  40 81 00 0C */	ble lbl_805B9EAC
/* 805B9EA4  7F C3 F3 78 */	mr r3, r30
/* 805B9EA8  4B D1 4E 95 */	bl __dl__FPv
lbl_805B9EAC:
