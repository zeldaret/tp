...
/* 805B37B4  4B DA EA 1C */	b _savegpr_26
/* 805B37B8  7C 7D 1B 78 */	mr r29, r3
/* 805B37BC  3C 60 80 5C */	lis r3, lit_3816@ha
/* 805B37C0  3B E3 A5 88 */	addi r31, r3, lit_3816@l
...
/* 805B37E0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805B37E4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805B37E8  38 80 00 00 */	li r4, 0
/* 805B37EC  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 805B37F0  38 DD 01 0C */	addi r6, r29, 0x10c
/* 805B37F4  4B BE FF D0 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805B37F8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805B37FC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805B3800  80 9E 00 04 */	lwz r4, 4(r30)
/* 805B3804  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805B3808  4B BF 15 98 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805B382C  4B A5 9F 7C */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_805B3830:
...
/* 805B384C  4B A5 9E 8C */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_805B3850:
...
/* 805B3910  4B A5 D8 B0 */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 805B392C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805B3930  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805B3934  80 9D 05 C4 */	lwz r4, 0x5c4(r29)
/* 805B3938  80 84 00 04 */	lwz r4, 4(r4)
/* 805B393C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805B3940  4B BF 14 60 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805B3A38  4B A5 A2 8C */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_805B3A3C:
...
/* 805B3A84  3C 60 80 45 */	lis r3, struct_80450BE4+0x1@ha
/* 805B3A88  98 03 0B E5 */	stb r0, struct_80450BE4+0x1@l(r3)
/* 805B3A8C  4B A5 45 EC */	b onBlure__13mDoGph_gInf_cFv
/* 805B3A90  48 00 00 10 */	b lbl_805B3AA0
lbl_805B3A94:
/* 805B3A94  38 00 00 00 */	li r0, 0
/* 805B3A98  3C 60 80 45 */	lis r3, struct_80450BE4+0x0@ha
/* 805B3A9C  98 03 0B E4 */	stb r0, struct_80450BE4+0x0@l(r3)
lbl_805B3AA0:
/* 805B3AA0  38 60 00 01 */	li r3, 1
lbl_805B3AA4:
/* 805B3AA4  39 61 00 40 */	addi r11, r1, 0x40
/* 805B3AA8  4B DA E7 74 */	b _restgpr_26
