...
/* 805B3E1C  4B AC FA 15 */	bl Move__10dCcD_GSttsFv
/* 805B3E20  38 7F 07 1C */	addi r3, r31, 0x71c
/* 805B3E24  4B AC FA 0D */	bl Move__10dCcD_GSttsFv
...
/* 805B3EB8  4B A7 9B E5 */	bl dComIfGs_onOneZoneSwitch__Fii
...
/* 805B3ED0  4B AD 36 45 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
/* 805B3ED4  7F E3 FB 78 */	mr r3, r31
/* 805B3ED8  38 80 00 11 */	li r4, 0x11
/* 805B3EDC  3C A0 80 5C */	lis r5, lit_4137@ha /* 0x805BA5AC@ha */
/* 805B3EE0  C0 25 A5 AC */	lfs f1, lit_4137@l(r5)  /* 0x805BA5AC@l */
/* 805B3EE4  38 A0 00 00 */	li r5, 0
/* 805B3EE8  3C C0 80 5C */	lis r6, lit_3816@ha /* 0x805BA588@ha */
/* 805B3EEC  C0 46 A5 88 */	lfs f2, lit_3816@l(r6)  /* 0x805BA588@l */
...
/* 805B3F38  4B AD 05 29 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 805B3F3C  28 03 00 00 */	cmplwi r3, 0
/* 805B3F40  41 82 00 F0 */	beq lbl_805B4030
/* 805B3F44  38 7F 08 B0 */	addi r3, r31, 0x8b0
/* 805B3F48  4B AD 05 B1 */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 805B3F4C  90 7F 11 54 */	stw r3, 0x1154(r31)
/* 805B3F50  7F E3 FB 78 */	mr r3, r31
/* 805B3F54  38 9F 11 54 */	addi r4, r31, 0x1154
/* 805B3F58  4B AD 3C AD */	bl cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
/* 805B3F5C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805B3F60  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
