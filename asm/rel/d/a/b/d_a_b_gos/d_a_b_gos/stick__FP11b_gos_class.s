...
/* 806046F0  4B D5 DA E9 */	bl _savegpr_28
/* 806046F4  7C 7D 1B 78 */	mr r29, r3
/* 806046F8  3C 60 80 60 */	lis r3, lit_3646@ha /* 0x806053C8@ha */
/* 806046FC  3B E3 53 C8 */	addi r31, r3, lit_3646@l /* 0x806053C8@l */
...
/* 80604730  4B C6 32 25 */	bl cM_rndF__Ff
...
/* 80604754  4B C6 B2 E9 */	bl cLib_addCalc2__FPffff
/* 80604758  3C 60 80 60 */	lis r3, boss@ha /* 0x80605608@ha */
/* 8060475C  38 63 56 08 */	addi r3, r3, boss@l /* 0x80605608@l */
...
/* 8060477C  3C 60 80 60 */	lis r3, j_info@ha /* 0x8060541C@ha */
/* 80604780  38 63 54 1C */	addi r3, r3, j_info@l /* 0x8060541C@l */
...
/* 80604794  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80604798  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8060479C  80 84 00 00 */	lwz r4, 0(r4)
/* 806047A0  4B D4 1D 11 */	bl PSMTXCopy
...
/* 806047BC  4B C6 C7 31 */	bl MtxPosition__FP4cXyzP4cXyz
/* 806047C0  3C 60 80 60 */	lis r3, j_info@ha /* 0x8060541C@ha */
/* 806047C4  38 83 54 1C */	addi r4, r3, j_info@l /* 0x8060541C@l */
...
/* 806047FC  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80604800  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80604804  80 84 00 00 */	lwz r4, 0(r4)
/* 80604808  4B D4 1C A9 */	bl PSMTXCopy
...
/* 80604870  4B C6 B1 CD */	bl cLib_addCalc2__FPffff
...
/* 80604884  4B C6 B1 B9 */	bl cLib_addCalc2__FPffff
...
/* 80604898  4B C6 B1 A5 */	bl cLib_addCalc2__FPffff
/* 8060489C  38 7D 04 DE */	addi r3, r29, 0x4de
/* 806048A0  3C 80 80 60 */	lis r4, boss@ha /* 0x80605608@ha */
/* 806048A4  38 84 56 08 */	addi r4, r4, boss@l /* 0x80605608@l */
...
/* 806048C4  4B C6 BD 45 */	bl cLib_addCalcAngleS2__FPssss
/* 806048C8  39 61 00 60 */	addi r11, r1, 0x60
/* 806048CC  4B D5 D9 59 */	bl _restgpr_28
