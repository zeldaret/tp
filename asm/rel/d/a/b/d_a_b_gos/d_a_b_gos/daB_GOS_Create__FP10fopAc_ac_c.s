...
/* 80604E6C  4B D5 D3 71 */	bl _savegpr_29
/* 80604E70  7C 7E 1B 78 */	mr r30, r3
/* 80604E74  3C 80 80 60 */	lis r4, lit_3646@ha /* 0x806053C8@ha */
/* 80604E78  3B E4 53 C8 */	addi r31, r4, lit_3646@l /* 0x806053C8@l */
...
/* 80604EA4  3C 80 80 60 */	lis r4, d_a_b_gos__stringBase0@ha /* 0x80605414@ha */
/* 80604EA8  38 84 54 14 */	addi r4, r4, d_a_b_gos__stringBase0@l /* 0x80605414@l */
/* 80604EAC  4B A2 80 11 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80604ECC  3C 80 80 60 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80604D64@ha */
/* 80604ED0  38 84 4D 64 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80604D64@l */
/* 80604ED4  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 80604ED8  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 80604EDC  4B A1 55 D5 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80604EF0:
/* 80604EF0  3C 60 80 60 */	lis r3, data_8060560C@ha /* 0x8060560C@ha */
/* 80604EF4  8C 03 56 0C */	lbzu r0, data_8060560C@l(r3)  /* 0x8060560C@l */
...
/* 80604F10  3C 60 80 60 */	lis r3, l_HIO@ha /* 0x8060561C@ha */
/* 80604F14  38 63 56 1C */	addi r3, r3, l_HIO@l /* 0x8060561C@l */
...
/* 80604F44  4B A1 55 E5 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80604F58  4B A1 55 E1 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80604F90  4B A7 12 B9 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80604F94  38 7E 06 A4 */	addi r3, r30, 0x6a4
/* 80604F98  C0 3F 00 08 */	lfs f1, 8(r31)
/* 80604F9C  FC 40 08 90 */	fmr f2, f1
/* 80604FA0  4B A7 0F B9 */	bl SetWall__12dBgS_AcchCirFff
...
/* 80604FB8  4B CB C0 DD */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 80604FE4  4B A7 E8 7D */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80604FE8  38 7E 0B 68 */	addi r3, r30, 0xb68
/* 80604FEC  3C 80 80 60 */	lis r4, cc_cyl_src@ha /* 0x80605514@ha */
/* 80604FF0  38 84 55 14 */	addi r4, r4, cc_cyl_src@l /* 0x80605514@l */
/* 80604FF4  4B A7 F8 C1 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80605010  4B D5 D2 19 */	bl _restgpr_29
