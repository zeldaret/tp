...
/* 80610D4C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80610D50  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80610D78  3C 60 80 62 */	lis r3, lit_4017@ha /* 0x8061AD9C@ha */
/* 80610D7C  C8 23 AD 9C */	lfd f1, lit_4017@l(r3)  /* 0x8061AD9C@l */
...
/* 80610DA8  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80610DAC  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80610DB0  80 84 00 00 */	lwz r4, 0(r4)
/* 80610DB4  4B D3 56 FD */	bl PSMTXCopy
/* 80610DB8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80610DBC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80610DD0  4B 9F B6 FD */	bl mDoMtx_ZrotM__FPA4_fs
/* 80610DD4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80610DD8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80610DEC  4B D3 56 C5 */	bl PSMTXCopy
/* 80610DF0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80610DF4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80610DF8  80 63 00 00 */	lwz r3, 0(r3)
/* 80610DFC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80610E00  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80610E04  4B D3 56 AD */	bl PSMTXCopy
lbl_80610E08:
