...
/* 8063A18C  4B D2 80 50 */	b _savegpr_29
...
lbl_8063A1A8:
/* 8063A1A8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8063A1AC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8063A1B0  38 80 00 00 */	li r4, 0
/* 8063A1B4  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8063A1B8  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8063A1BC  4B B6 96 08 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8063A1C0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8063A1C4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8063A1C8  80 9F 05 B4 */	lwz r4, 0x5b4(r31)
/* 8063A1CC  80 84 00 04 */	lwz r4, 4(r4)
/* 8063A1D0  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8063A1D4  4B B6 AB CC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8063A1D8  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8063A1DC  80 83 00 04 */	lwz r4, 4(r3)
/* 8063A1E0  7F E3 FB 78 */	mr r3, r31
/* 8063A1E4  4B 9E 32 48 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 8063A1E8  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8063A1EC  4B 9D 3A D8 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 8063A1F0  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8063A1F4  4B 9F 77 58 */	b entry__10daMirror_cFP8J3DModel
...
/* 8063A254  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8063A258  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8063A25C  38 80 00 10 */	li r4, 0x10
/* 8063A260  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8063A264  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8063A268  4B B6 95 5C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8063A26C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8063A270  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8063A274  80 9F 06 B0 */	lwz r4, 0x6b0(r31)
/* 8063A278  80 84 00 04 */	lwz r4, 4(r4)
/* 8063A27C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8063A280  4B B6 AB 20 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8063A284  80 7F 06 B0 */	lwz r3, 0x6b0(r31)
/* 8063A288  80 83 00 04 */	lwz r4, 4(r3)
/* 8063A28C  7F E3 FB 78 */	mr r3, r31
/* 8063A290  4B 9E 31 9C */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 8063A294  80 7F 06 B0 */	lwz r3, 0x6b0(r31)
/* 8063A298  4B 9D 3A 2C */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 8063A29C  38 60 00 01 */	li r3, 1
lbl_8063A2A0:
/* 8063A2A0  39 61 00 20 */	addi r11, r1, 0x20
/* 8063A2A4  4B D2 7F 84 */	b _restgpr_29
