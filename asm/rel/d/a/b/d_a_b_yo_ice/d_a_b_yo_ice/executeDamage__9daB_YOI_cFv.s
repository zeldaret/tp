...
/* 8063C910  4B D2 58 CD */	bl _savegpr_29
/* 8063C914  7C 7E 1B 78 */	mr r30, r3
/* 8063C918  3C 60 80 64 */	lis r3, lit_3776@ha /* 0x8063DC84@ha */
/* 8063C91C  3B E3 DC 84 */	addi r31, r3, lit_3776@l /* 0x8063DC84@l */
...
/* 8063C978  4B C2 B0 15 */	bl cM_rndFX__Ff
...
/* 8063C98C  4B C2 B0 01 */	bl cM_rndFX__Ff
...
/* 8063C9A8  4B C2 AE C5 */	bl cM_rnd__Fv
...
/* 8063C9BC  4B C2 AF 99 */	bl cM_rndF__Ff
...
/* 8063C9E0  4B C2 AF 75 */	bl cM_rndF__Ff
...
/* 8063CA04  4B C3 42 01 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8063CA4C  4B C2 AF 41 */	bl cM_rndFX__Ff
...
/* 8063CAA8  4B C3 40 E9 */	bl cLib_chaseAngleS__FPsss
...
/* 8063CB00  4B C3 3C 41 */	bl cLib_chaseF__FPfff
...
/* 8063CB14  4B C3 3C 2D */	bl cLib_chaseF__FPfff
lbl_8063CB18:
...
/* 8063CB34  4B D0 A6 05 */	bl PSVECSquareMag
...
/* 8063CBA4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063CBA8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8063CC14  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063CC18  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8063CC1C:
...
/* 8063CC40  4B FF 2F AD */	bl onIceBreak__8daB_YO_cFUs
...
/* 8063CC74  4B 9D D0 09 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_8063CC78:
/* 8063CC78  39 61 00 70 */	addi r11, r1, 0x70
/* 8063CC7C  4B D2 55 AD */	bl _restgpr_29
