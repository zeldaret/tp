...
/* 8063C408  4B D2 5D D5 */	bl _savegpr_29
/* 8063C40C  7C 7D 1B 78 */	mr r29, r3
/* 8063C410  3C 60 80 64 */	lis r3, lit_3776@ha /* 0x8063DC84@ha */
/* 8063C414  3B E3 DC 84 */	addi r31, r3, lit_3776@l /* 0x8063DC84@l */
...
/* 8063C4B4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8063C4B8  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8063C50C  4B C3 42 35 */	bl cLib_chaseF__FPfff
...
/* 8063C520  4B C3 3E 31 */	bl cLib_addCalcPosXZ2__FP4cXyzRC4cXyzff
...
/* 8063C568  4B C3 46 29 */	bl cLib_chaseAngleS__FPsss
...
/* 8063C57C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8063C580  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8063C61C  4B C2 B3 71 */	bl cM_rndFX__Ff
...
/* 8063C664  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8063C668  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8063C67C  4B A3 33 A9 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 8063C6D4  4B C3 3E 6D */	bl cLib_addCalcAngleS__FPsssss
