...
/* 8063D5E0  4B D2 4B F9 */	bl _savegpr_28
/* 8063D5E4  7C 7C 1B 78 */	mr r28, r3
/* 8063D5E8  3C 80 80 64 */	lis r4, cNullVec__6Z2Calc@ha /* 0x8063DDA4@ha */
/* 8063D5EC  3B C4 DD A4 */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x8063DDA4@l */
/* 8063D5F0  3C 80 80 64 */	lis r4, lit_3776@ha /* 0x8063DC84@ha */
/* 8063D5F4  3B E4 DC 84 */	addi r31, r4, lit_3776@l /* 0x8063DC84@l */
...
/* 8063D620  3C 80 80 64 */	lis r4, d_a_b_yo_ice__stringBase0@ha /* 0x8063DD9C@ha */
/* 8063D624  38 84 DD 9C */	addi r4, r4, d_a_b_yo_ice__stringBase0@l /* 0x8063DD9C@l */
/* 8063D628  4B 9E F8 95 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8063D63C  3C 80 80 64 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x8063D5B0@ha */
/* 8063D640  38 84 D5 B0 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x8063D5B0@l */
/* 8063D644  38 A0 1C A0 */	li r5, 0x1ca0
/* 8063D648  4B 9D CE 69 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_8063D65C:
/* 8063D65C  3C 60 80 64 */	lis r3, data_8063DFE8@ha /* 0x8063DFE8@ha */
/* 8063D660  8C 03 DF E8 */	lbzu r0, data_8063DFE8@l(r3)  /* 0x8063DFE8@l */
...
/* 8063D67C  3C 60 80 64 */	lis r3, l_HIO@ha /* 0x8063DFF8@ha */
/* 8063D680  38 63 DF F8 */	addi r3, r3, l_HIO@l /* 0x8063DFF8@l */
...
/* 8063D6CC  4B 9D CE 5D */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 8063D6E0  4B 9D CE 59 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 8063D700  4B A4 61 61 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 8063D704  38 7C 07 58 */	addi r3, r28, 0x758
/* 8063D708  38 9E 00 20 */	addi r4, r30, 0x20
/* 8063D70C  4B A4 71 A9 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 8063D720  4B A4 71 95 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 8063D734  4B A4 71 81 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 8063D770  4B C8 2D C1 */	bl init__10Z2CreatureFP3VecP3VecUcUc
...
/* 8063D79C  4B 9D C2 21 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 8063D7E8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8063D7EC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
lbl_8063D82C:
/* 8063D82C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8063D830  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8063D8E8  4B D2 49 3D */	bl _restgpr_28
