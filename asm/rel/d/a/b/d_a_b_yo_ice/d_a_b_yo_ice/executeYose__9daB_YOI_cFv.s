...
/* 8063BB58  4B D2 66 81 */	bl _savegpr_28
/* 8063BB5C  7C 7D 1B 78 */	mr r29, r3
/* 8063BB60  3C 60 80 64 */	lis r3, lit_3776@ha /* 0x8063DC84@ha */
/* 8063BB64  3B E3 DC 84 */	addi r31, r3, lit_3776@l /* 0x8063DC84@l */
...
/* 8063BC24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8063BC28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8063BC4C  4B D0 B4 ED */	bl PSVECSquareMag
...
/* 8063BCBC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063BCC0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8063BD2C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063BD30  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8063BD34:
...
/* 8063BD98  4B C2 BB F5 */	bl cM_rndFX__Ff
...
/* 8063BE1C  4B C2 BA 51 */	bl cM_rnd__Fv
...
/* 8063BE30  4B C2 BB 25 */	bl cM_rndF__Ff
...
/* 8063BE54  4B C2 BB 01 */	bl cM_rndF__Ff
...
/* 8063BEAC  4B C3 4C E5 */	bl cLib_chaseAngleS__FPsss
...
/* 8063BF44  4B C3 4C 4D */	bl cLib_chaseAngleS__FPsss
...
/* 8063BF94  4B C3 47 AD */	bl cLib_chaseF__FPfff
...
/* 8063BFA8  4B C3 47 99 */	bl cLib_chaseF__FPfff
lbl_8063BFAC:
/* 8063BFAC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8063BFB0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8063C00C  4B D0 B1 2D */	bl PSVECSquareMag
...
/* 8063C07C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063C080  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8063C0EC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063C0F0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8063C0F4:
...
/* 8063C108  4B C2 B5 6D */	bl cM_atan2s__Fff
/* 8063C10C  C0 3F 00 E4 */	lfs f1, 0xe4(r31)
/* 8063C110  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 8063C114  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8063C118  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8063C140  4B C3 46 01 */	bl cLib_chaseF__FPfff
...
/* 8063C154  4B C3 41 FD */	bl cLib_addCalcPosXZ2__FP4cXyzRC4cXyzff
...
/* 8063C18C  4B D0 B2 11 */	bl PSVECSquareDistance
...
/* 8063C1FC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063C200  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8063C26C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063C270  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8063C274:
...
/* 8063C2D4  4B D0 B0 C9 */	bl PSVECSquareDistance
...
/* 8063C344  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063C348  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8063C3B4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8063C3B8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8063C3BC:
...
/* 8063C3DC  4B D2 5E 49 */	bl _restgpr_28
