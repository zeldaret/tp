...
/* 8063A648  4B D2 7B 89 */	bl _savegpr_26
/* 8063A64C  7C 7A 1B 78 */	mr r26, r3
/* 8063A650  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8063A654  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8063A658  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8063A65C  4B 9E 00 B5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8063A674  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8063A678  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8063A67C  3C 60 80 64 */	lis r3, break_effect_id@ha /* 0x8063DEBC@ha */
/* 8063A680  3B A3 DE BC */	addi r29, r3, break_effect_id@l /* 0x8063DEBC@l */
/* 8063A684  3C 60 80 64 */	lis r3, lit_3776@ha /* 0x8063DC84@ha */
/* 8063A688  3B C3 DC 84 */	addi r30, r3, lit_3776@l /* 0x8063DC84@l */
lbl_8063A68C:
...
/* 8063A6CC  4B A1 23 C5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8063A6E4  4B D2 7B 39 */	bl _restgpr_26
