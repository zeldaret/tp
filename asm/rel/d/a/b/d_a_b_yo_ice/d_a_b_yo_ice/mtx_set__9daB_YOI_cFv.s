...
/* 8063D0EC  3C 60 80 64 */	lis r3, l_HIO@ha /* 0x8063DFF8@ha */
/* 8063D0F0  38 63 DF F8 */	addi r3, r3, l_HIO@l /* 0x8063DFF8@l */
...
/* 8063D10C  4B 9C FC 59 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8063D110  38 61 00 08 */	addi r3, r1, 8
/* 8063D114  38 9F 04 E4 */	addi r4, r31, 0x4e4
/* 8063D118  38 BF 06 78 */	addi r5, r31, 0x678
/* 8063D11C  4B C2 A2 E9 */	bl __pl__5csXyzFR5csXyz
/* 8063D120  38 61 00 08 */	addi r3, r1, 8
/* 8063D124  4B 9C FE 21 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8063D128  FC 20 F0 90 */	fmr f1, f30
/* 8063D12C  FC 40 F8 90 */	fmr f2, f31
/* 8063D130  FC 60 F0 90 */	fmr f3, f30
/* 8063D134  4B 9C FD 05 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8063D138  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8063D13C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8063D140  80 9F 05 B4 */	lwz r4, 0x5b4(r31)
/* 8063D144  38 84 00 24 */	addi r4, r4, 0x24
/* 8063D148  4B D0 93 69 */	bl PSMTXCopy
/* 8063D14C  38 7F 06 B4 */	addi r3, r31, 0x6b4
/* 8063D150  4B 9C FC 15 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8063D154  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8063D158  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8063D15C  A8 9F 06 C4 */	lha r4, 0x6c4(r31)
/* 8063D160  4B 9C F2 D5 */	bl mDoMtx_YrotM__FPA4_fs
/* 8063D164  FC 20 F0 90 */	fmr f1, f30
/* 8063D168  3C 60 80 64 */	lis r3, lit_3776@ha /* 0x8063DC84@ha */
/* 8063D16C  C0 43 DC 84 */	lfs f2, lit_3776@l(r3)  /* 0x8063DC84@l */
/* 8063D170  FC 60 F0 90 */	fmr f3, f30
/* 8063D174  4B 9C FC C5 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8063D178  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8063D17C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8063D180  80 9F 06 B0 */	lwz r4, 0x6b0(r31)
/* 8063D184  38 84 00 24 */	addi r4, r4, 0x24
/* 8063D188  4B D0 93 29 */	bl PSMTXCopy
