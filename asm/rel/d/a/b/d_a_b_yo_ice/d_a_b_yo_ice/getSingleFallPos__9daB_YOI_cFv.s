...
/* 8063ABDC  4B B4 6A 65 */	bl dCam_getBody__Fv
/* 8063ABE0  7C 64 1B 78 */	mr r4, r3
/* 8063ABE4  38 61 00 14 */	addi r3, r1, 0x14
/* 8063ABE8  4B B4 72 7D */	bl Eye__9dCamera_cFv
...
/* 8063AC04  4B B4 6A 3D */	bl dCam_getBody__Fv
/* 8063AC08  7C 64 1B 78 */	mr r4, r3
/* 8063AC0C  38 61 00 08 */	addi r3, r1, 8
/* 8063AC10  4B B4 72 89 */	bl Center__9dCamera_cFv
...
/* 8063AC34  4B C3 5F D1 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8063AC5C  3C 60 80 64 */	lis r3, lit_4082@ha /* 0x8063DCD8@ha */
/* 8063AC60  C0 23 DC D8 */	lfs f1, lit_4082@l(r3)  /* 0x8063DCD8@l */
/* 8063AC64  C0 9F 04 D4 */	lfs f4, 0x4d4(r31)
/* 8063AC68  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8063AC6C  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
