...
/* 8063D1C8  4B D2 50 11 */	bl _savegpr_28
/* 8063D1CC  7C 7C 1B 78 */	mr r28, r3
/* 8063D1D0  3C 60 80 64 */	lis r3, lit_3776@ha /* 0x8063DC84@ha */
/* 8063D1D4  3B C3 DC 84 */	addi r30, r3, lit_3776@l /* 0x8063DC84@l */
/* 8063D1D8  80 7C 05 B4 */	lwz r3, 0x5b4(r28)
/* 8063D1DC  38 63 00 24 */	addi r3, r3, 0x24
/* 8063D1E0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8063D1E4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8063D1E8  4B D0 92 C9 */	bl PSMTXCopy
/* 8063D1EC  C0 3E 00 14 */	lfs f1, 0x14(r30)
/* 8063D1F0  C0 5E 01 04 */	lfs f2, 0x104(r30)
/* 8063D1F4  FC 60 08 90 */	fmr f3, f1
/* 8063D1F8  4B 9C FB A5 */	bl transM__14mDoMtx_stack_cFfff
/* 8063D1FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8063D200  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8063D224  4B C3 1F B9 */	bl SetC__8cM3dGCylFRC4cXyz
/* 8063D228  38 7C 0A F4 */	addi r3, r28, 0xaf4
/* 8063D22C  C0 3E 01 08 */	lfs f1, 0x108(r30)
/* 8063D230  4B C3 1F C9 */	bl SetH__8cM3dGCylFf
/* 8063D234  38 7C 0A F4 */	addi r3, r28, 0xaf4
/* 8063D238  C0 3E 00 78 */	lfs f1, 0x78(r30)
/* 8063D23C  4B C3 1F C5 */	bl SetR__8cM3dGCylFf
/* 8063D240  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8063D244  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8063D248  3B A3 23 3C */	addi r29, r3, 0x233c
/* 8063D24C  7F A3 EB 78 */	mr r3, r29
/* 8063D250  38 9C 09 D0 */	addi r4, r28, 0x9d0
/* 8063D254  4B C2 79 55 */	bl Set__4cCcSFP8cCcD_Obj
/* 8063D258  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 8063D25C  4B 9C FB 09 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8063D260  38 7C 04 E4 */	addi r3, r28, 0x4e4
/* 8063D264  4B 9C FC E1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
...
/* 8063D27C  4B 9C FB 21 */	bl transM__14mDoMtx_stack_cFfff
...
/* 8063D2B4  4B C3 1F 29 */	bl SetC__8cM3dGCylFRC4cXyz
/* 8063D2B8  38 7C 08 7C */	addi r3, r28, 0x87c
/* 8063D2BC  FC 20 F8 90 */	fmr f1, f31
/* 8063D2C0  4B C3 1F 41 */	bl SetR__8cM3dGCylFf
...
/* 8063D2D4  4B C3 1F 25 */	bl SetH__8cM3dGCylFf
/* 8063D2D8  7F A3 EB 78 */	mr r3, r29
/* 8063D2DC  38 9C 07 58 */	addi r4, r28, 0x758
/* 8063D2E0  4B C2 78 C9 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8063D300  4B C3 1E DD */	bl SetC__8cM3dGCylFRC4cXyz
/* 8063D304  38 7C 09 B8 */	addi r3, r28, 0x9b8
/* 8063D308  FC 20 F8 90 */	fmr f1, f31
/* 8063D30C  4B C3 1E F5 */	bl SetR__8cM3dGCylFf
