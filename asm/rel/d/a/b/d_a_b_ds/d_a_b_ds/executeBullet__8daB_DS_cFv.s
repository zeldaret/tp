...
/* 805D7C20  4B D8 A5 A5 */	bl _savegpr_23
/* 805D7C24  7C 7D 1B 78 */	mr r29, r3
/* 805D7C28  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805D7C2C  3B E3 CA 54 */	addi r31, r3, lit_3932@l /* 0x805DCA54@l */
...
/* 805D7C74  3C 60 80 5E */	lis r3, struct_805DDB10+0x2@ha /* 0x805DDB12@ha */
/* 805D7C78  88 03 DB 12 */	lbz r0, struct_805DDB10+0x2@l(r3)  /* 0x805DDB12@l */
...
lbl_805D7CB0:
/* 805D7CB0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D7CB4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D7D10  4B A4 1C AD */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 805D7D34  4B C8 EE 01 */	bl __mi__4cXyzCFRC3Vec
...
/* 805D7D54  4B C8 F3 FD */	bl atan2sY_XZ__4cXyzCFv
/* 805D7D58  B0 7D 04 DC */	sth r3, 0x4dc(r29)
/* 805D7D5C  38 61 00 70 */	addi r3, r1, 0x70
/* 805D7D60  4B C8 F3 C9 */	bl atan2sX_Z__4cXyzCFv
/* 805D7D64  B0 7D 04 DE */	sth r3, 0x4de(r29)
/* 805D7D68  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805D7D6C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805D7D70  80 63 00 00 */	lwz r3, 0(r3)
/* 805D7D74  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 805D7D78  4B A3 46 65 */	bl mDoMtx_YrotS__FPA4_fs
/* 805D7D7C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805D7D80  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805D7D84  80 63 00 00 */	lwz r3, 0(r3)
/* 805D7D88  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 805D7D8C  4B A3 46 11 */	bl mDoMtx_XrotM__FPA4_fs
...
lbl_805D7E10:
/* 805D7E10  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805D7E14  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805D7E18  80 63 00 00 */	lwz r3, 0(r3)
/* 805D7E1C  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 805D7E20  4B A3 45 BD */	bl mDoMtx_YrotS__FPA4_fs
/* 805D7E24  88 1D 08 56 */	lbz r0, 0x856(r29)
/* 805D7E28  28 00 00 01 */	cmplwi r0, 1
/* 805D7E2C  40 82 00 24 */	bne lbl_805D7E50
/* 805D7E30  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805D7E34  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805D7E48  4B A3 45 55 */	bl mDoMtx_XrotM__FPA4_fs
/* 805D7E4C  48 00 00 18 */	b lbl_805D7E64
lbl_805D7E50:
/* 805D7E50  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805D7E54  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805D7E58  80 63 00 00 */	lwz r3, 0(r3)
/* 805D7E5C  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 805D7E60  4B A3 45 3D */	bl mDoMtx_XrotM__FPA4_fs
lbl_805D7E64:
...
/* 805D7E80  4B C9 90 6D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 805D7E98  4B A4 1D E5 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_805D7E9C:
...
/* 805D7EB4  4B A4 1D C9 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 805D7EB8  48 00 01 A8 */	b lbl_805D8060
lbl_805D7EBC:
/* 805D7EBC  38 7D 13 38 */	addi r3, r29, 0x1338
/* 805D7EC0  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 805D7EC4  4B C9 77 85 */	bl SetC__8cM3dGSphFRC4cXyz
/* 805D7EC8  38 7D 13 38 */	addi r3, r29, 0x1338
/* 805D7ECC  C0 3D 07 D8 */	lfs f1, 0x7d8(r29)
/* 805D7ED0  4B C9 78 39 */	bl SetR__8cM3dGSphFf
/* 805D7ED4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D7ED8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805D7EDC  38 63 23 3C */	addi r3, r3, 0x233c
/* 805D7EE0  38 9D 12 14 */	addi r4, r29, 0x1214
/* 805D7EE4  4B C8 CC C5 */	bl Set__4cCcSFP8cCcD_Obj
...
lbl_805D7EFC:
/* 805D7EFC  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805D7F00  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805D7F20  4B C8 EC 15 */	bl __mi__4cXyzCFRC3Vec
...
/* 805D7F48  4B D6 F1 91 */	bl PSVECScale
...
/* 805D7F58  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805D7F5C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805D7F88  4B CD 45 85 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 805D7F8C  3B C0 00 00 */	li r30, 0
/* 805D7F90  3B 80 00 00 */	li r28, 0
/* 805D7F94  3B 60 00 00 */	li r27, 0
/* 805D7F98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D7F9C  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805D7FA0  3B 1D 07 24 */	addi r24, r29, 0x724
/* 805D7FA4  3C 60 80 5E */	lis r3, effId_9621@ha /* 0x805DD818@ha */
/* 805D7FA8  3B 43 D8 18 */	addi r26, r3, effId_9621@l /* 0x805DD818@l */
lbl_805D7FAC:
...
/* 805D7FF8  4B A7 54 D5 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805D800C  4B A7 39 0D */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805D803C  3C 80 80 45 */	lis r4, mParticleTracePCB__13dPa_control_c@ha /* 0x80450EC8@ha */
/* 805D8040  38 04 0E C8 */	addi r0, r4, mParticleTracePCB__13dPa_control_c@l /* 0x80450EC8@l */
...
/* 805D8064  4B D8 A1 AD */	bl _restgpr_23
