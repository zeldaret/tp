...
/* 805CB324  4B D9 6E B0 */	b _savegpr_27
/* 805CB328  7C 7C 1B 78 */	mr r28, r3
/* 805CB32C  7C BD 2B 78 */	mr r29, r5
/* 805CB330  3C 60 80 5E */	lis r3, lit_1109@ha
/* 805CB334  3B E3 DA 70 */	addi r31, r3, lit_1109@l
...
/* 805CB34C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805CB350  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805CB354  4B D7 B1 5C */	b PSMTXCopy
...
/* 805CB370  3C 60 80 5E */	lis r3, lit_4017@ha
/* 805CB374  38 63 D4 08 */	addi r3, r3, lit_4017@l
...
/* 805CB3A8  4B A4 1B 9C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
...
/* 805CB3D0  4B A4 1B 74 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 805CB3D4  48 00 00 88 */	b lbl_805CB45C
lbl_805CB3D8:
/* 805CB3D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CB3DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CB3E0  A8 9F 00 9C */	lha r4, 0x9c(r31)
/* 805CB3E4  4B A4 10 50 */	b mDoMtx_YrotM__FPA4_fs
/* 805CB3E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CB3EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CB3F0  A8 9F 00 A0 */	lha r4, 0xa0(r31)
/* 805CB3F4  4B A4 0F A8 */	b mDoMtx_XrotM__FPA4_fs
/* 805CB3F8  48 00 00 64 */	b lbl_805CB45C
lbl_805CB3FC:
/* 805CB3FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CB400  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CB404  A8 1F 00 9C */	lha r0, 0x9c(r31)
/* 805CB408  7C 00 00 D0 */	neg r0, r0
/* 805CB40C  7C 04 07 34 */	extsh r4, r0
/* 805CB410  4B A4 10 24 */	b mDoMtx_YrotM__FPA4_fs
/* 805CB414  48 00 00 48 */	b lbl_805CB45C
lbl_805CB418:
/* 805CB418  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CB41C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CB420  A8 1F 00 9E */	lha r0, 0x9e(r31)
/* 805CB424  7C 00 00 D0 */	neg r0, r0
/* 805CB428  7C 04 07 34 */	extsh r4, r0
/* 805CB42C  4B A4 10 08 */	b mDoMtx_YrotM__FPA4_fs
/* 805CB430  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CB434  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CB438  A8 1F 00 A0 */	lha r0, 0xa0(r31)
/* 805CB43C  7C 00 00 D0 */	neg r0, r0
/* 805CB440  7C 04 07 34 */	extsh r4, r0
/* 805CB444  4B A4 0F 58 */	b mDoMtx_XrotM__FPA4_fs
/* 805CB448  48 00 00 14 */	b lbl_805CB45C
lbl_805CB44C:
/* 805CB44C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CB450  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CB454  A8 9F 00 9E */	lha r4, 0x9e(r31)
/* 805CB458  4B A4 0F DC */	b mDoMtx_YrotM__FPA4_fs
lbl_805CB45C:
/* 805CB45C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CB460  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CB464  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 805CB468  80 04 00 0C */	lwz r0, 0xc(r4)
/* 805CB46C  7C 80 F2 14 */	add r4, r0, r30
/* 805CB470  4B D7 B0 40 */	b PSMTXCopy
/* 805CB474  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CB478  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CB47C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 805CB480  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 805CB484  4B D7 B0 2C */	b PSMTXCopy
/* 805CB488  38 60 00 01 */	li r3, 1
/* 805CB48C  39 61 00 30 */	addi r11, r1, 0x30
/* 805CB490  4B D9 6D 90 */	b _restgpr_27
