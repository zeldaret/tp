...
/* 805D1E48  3C 80 80 5E */	lis r4, lit_3932@ha /* 0x805DCA54@ha */
/* 805D1E4C  3B E4 CA 54 */	addi r31, r4, lit_3932@l /* 0x805DCA54@l */
...
/* 805D1E94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D1E98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D1EAC  4B A9 DB 79 */	bl StartShock__12dVibration_cFii4cXyz
/* 805D1EB0  7F C3 F3 78 */	mr r3, r30
/* 805D1EB4  88 1E 08 4F */	lbz r0, 0x84f(r30)
/* 805D1EB8  54 00 10 3A */	slwi r0, r0, 2
/* 805D1EBC  3C 80 80 5E */	lis r4, Ds_Etc_damage_id@ha /* 0x805DD5B8@ha */
/* 805D1EC0  38 84 D5 B8 */	addi r4, r4, Ds_Etc_damage_id@l /* 0x805DD5B8@l */
...
/* 805D1F00  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D1F04  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D1F18  4B A9 DB 0D */	bl StartShock__12dVibration_cFii4cXyz
/* 805D1F1C  7F C3 F3 78 */	mr r3, r30
/* 805D1F20  3C 80 80 5E */	lis r4, Ds_Etc_damage_id@ha /* 0x805DD5B8@ha */
/* 805D1F24  38 84 D5 B8 */	addi r4, r4, Ds_Etc_damage_id@l /* 0x805DD5B8@l */
...
lbl_805D1F5C:
/* 805D1F5C  3C 80 80 5E */	lis r4, Ds_Etc_damage_id@ha /* 0x805DD5B8@ha */
/* 805D1F60  38 84 D5 B8 */	addi r4, r4, Ds_Etc_damage_id@l /* 0x805DD5B8@l */
...
/* 805D1FA8  3C 80 80 5E */	lis r4, smokeSet_dt@ha /* 0x805DD5DC@ha */
/* 805D1FAC  38 84 D5 DC */	addi r4, r4, smokeSet_dt@l /* 0x805DD5DC@l */
