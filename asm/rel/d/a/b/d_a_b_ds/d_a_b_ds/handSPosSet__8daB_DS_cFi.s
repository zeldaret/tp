...
/* 805CBEE0  4B D9 62 E5 */	bl _savegpr_23
/* 805CBEE4  7C 7B 1B 78 */	mr r27, r3
/* 805CBEE8  7C 9C 23 78 */	mr r28, r4
/* 805CBEEC  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805CBEF0  3B E3 CA 54 */	addi r31, r3, lit_3932@l /* 0x805DCA54@l */
/* 805CBEF4  38 61 00 70 */	addi r3, r1, 0x70
/* 805CBEF8  4B AA B6 85 */	bl __ct__11dBgS_GndChkFv
...
/* 805CBF30  4B C9 BD F9 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 805CBF34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805CBF38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805CBF3C  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 805CBF40  7F C3 F3 78 */	mr r3, r30
/* 805CBF44  38 81 00 70 */	addi r4, r1, 0x70
/* 805CBF48  4B AA 85 59 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 805CBF7C  4B C9 AB B9 */	bl __mi__4cXyzCFRC3Vec
...
/* 805CBF9C  4B C9 B1 8D */	bl atan2sX_Z__4cXyzCFv
/* 805CBFA0  7C 64 07 34 */	extsh r4, r3
/* 805CBFA4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805CBFA8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805CBFAC  80 63 00 00 */	lwz r3, 0(r3)
/* 805CBFB0  4B A4 04 2D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805CC000  4B C9 BD 29 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 805CC004  7F C3 F3 78 */	mr r3, r30
/* 805CC008  38 81 00 70 */	addi r4, r1, 0x70
/* 805CC00C  4B AA 84 95 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 805CC03C  4B C9 AA F9 */	bl __mi__4cXyzCFRC3Vec
...
/* 805CC05C  4B C9 B0 F5 */	bl atan2sY_XZ__4cXyzCFv
/* 805CC060  B0 61 00 20 */	sth r3, 0x20(r1)
/* 805CC064  38 61 00 58 */	addi r3, r1, 0x58
/* 805CC068  4B C9 B0 C1 */	bl atan2sX_Z__4cXyzCFv
...
/* 805CC08C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805CC090  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805CC094  57 98 08 3C */	slwi r24, r28, 1
/* 805CC098  3C 60 80 5E */	lis r3, eff_smoke_id@ha /* 0x805DD470@ha */
/* 805CC09C  3B 83 D4 70 */	addi r28, r3, eff_smoke_id@l /* 0x805DD470@l */
lbl_805CC0A0:
...
/* 805CC0F4  4B A8 13 D9 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805CC130  4B AA 38 F5 */	bl StartShock__12dVibration_cFii4cXyz
/* 805CC134  38 61 00 70 */	addi r3, r1, 0x70
/* 805CC138  38 80 FF FF */	li r4, -1
/* 805CC13C  4B AA B4 B5 */	bl __dt__11dBgS_GndChkFv
/* 805CC140  39 61 00 F0 */	addi r11, r1, 0xf0
/* 805CC144  4B D9 60 CD */	bl _restgpr_23
