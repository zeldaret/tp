...
/* 805D0390  3C 80 80 45 */	lis r4, pauseTimer__9dScnPly_c+0x1@ha /* 0x80451125@ha */
/* 805D0394  98 04 11 25 */	stb r0, pauseTimer__9dScnPly_c+0x1@l(r4)  /* 0x80451125@l */
lbl_805D0398:
/* 805D0398  38 00 00 01 */	li r0, 1
/* 805D039C  98 03 08 5E */	stb r0, 0x85e(r3)
/* 805D03A0  4B FF FF 59 */	bl mBreakBoneSUB__8daB_DS_cFv
/* 805D03A4  3C 60 80 5E */	lis r3, lit_3933@ha /* 0x805DCA58@ha */
/* 805D03A8  C0 23 CA 58 */	lfs f1, lit_3933@l(r3)  /* 0x805DCA58@l */
/* 805D03AC  D0 21 00 08 */	stfs f1, 8(r1)
/* 805D03B0  3C 60 80 5E */	lis r3, lit_3934@ha /* 0x805DCA5C@ha */
/* 805D03B4  C0 03 CA 5C */	lfs f0, lit_3934@l(r3)  /* 0x805DCA5C@l */
/* 805D03B8  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 805D03BC  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 805D03C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D03C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D03D8  4B A9 F6 4D */	bl StartShock__12dVibration_cFii4cXyz
