...
/* 805D52E4  4B D8 CE ED */	bl _savegpr_26
/* 805D52E8  7C 7B 1B 78 */	mr r27, r3
/* 805D52EC  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805D52F0  3B A3 CA 54 */	addi r29, r3, lit_3932@l /* 0x805DCA54@l */
/* 805D52F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D52F8  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D5318  4B AA 29 51 */	bl __ct__11dBgS_LinChkFv
/* 805D531C  38 61 00 E4 */	addi r3, r1, 0xe4
/* 805D5320  4B AA 22 5D */	bl __ct__11dBgS_GndChkFv
...
/* 805D5360  4B C9 29 C9 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 805D5364  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D5368  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805D536C  3B E3 0F 38 */	addi r31, r3, 0xf38
/* 805D5370  7F E3 FB 78 */	mr r3, r31
/* 805D5374  38 81 00 E4 */	addi r4, r1, 0xe4
/* 805D5378  4B A9 F1 29 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 805D53F4  4B C9 17 41 */	bl __mi__4cXyzCFRC3Vec
...
/* 805D541C  4B C9 1D 0D */	bl atan2sX_Z__4cXyzCFv
/* 805D5420  B0 7B 07 D2 */	sth r3, 0x7d2(r27)
/* 805D5424  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805D5428  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805D542C  80 63 00 00 */	lwz r3, 0(r3)
/* 805D5430  A8 9B 07 D2 */	lha r4, 0x7d2(r27)
/* 805D5434  4B A3 6F A9 */	bl mDoMtx_YrotS__FPA4_fs
/* 805D5438  C0 1D 00 04 */	lfs f0, 4(r29)
/* 805D543C  D0 01 00 D8 */	stfs f0, 0xd8(r1)
/* 805D5440  D0 01 00 DC */	stfs f0, 0xdc(r1)
/* 805D5444  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805D5448  3B E3 DA BC */	addi r31, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805D545C  4B C9 BA 91 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 805D5470  4B C9 1C B9 */	bl atan2sX_Z__4cXyzCFv
...
/* 805D54A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D54A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805D54A8  80 63 5D 3C */	lwz r3, 0x5d3c(r3)
/* 805D54AC  38 63 02 10 */	addi r3, r3, 0x210
/* 805D54B0  80 9B 2E 14 */	lwz r4, 0x2e14(r27)
/* 805D54B4  4B A7 64 65 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805D557C  4B C9 15 B9 */	bl __mi__4cXyzCFRC3Vec
...
/* 805D55AC  4B C9 15 89 */	bl __mi__4cXyzCFRC3Vec
...
/* 805D55D4  4B C9 1B 55 */	bl atan2sX_Z__4cXyzCFv
/* 805D55D8  B0 7B 04 DE */	sth r3, 0x4de(r27)
/* 805D55DC  38 61 00 CC */	addi r3, r1, 0xcc
/* 805D55E0  4B D7 1B 59 */	bl PSVECSquareMag
...
/* 805D5650  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805D5654  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805D56C0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805D56C4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805D56C8:
...
/* 805D56F0  4B C9 1A 39 */	bl atan2sX_Z__4cXyzCFv
...
/* 805D570C  4B C9 1A 1D */	bl atan2sX_Z__4cXyzCFv
/* 805D5710  38 03 18 00 */	addi r0, r3, 0x1800
/* 805D5714  B0 1B 07 D2 */	sth r0, 0x7d2(r27)
lbl_805D5718:
/* 805D5718  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805D571C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805D5720  80 63 00 00 */	lwz r3, 0(r3)
/* 805D5724  A8 9B 04 DE */	lha r4, 0x4de(r27)
/* 805D5728  4B A3 6C B5 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805D5748  4B C9 B7 A5 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 805D5760  4B D7 19 31 */	bl PSVECAdd
...
lbl_805D5794:
/* 805D5794  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805D5798  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805D579C  80 63 00 00 */	lwz r3, 0(r3)
/* 805D57A0  A8 9B 07 D2 */	lha r4, 0x7d2(r27)
/* 805D57A4  4B A3 6C 39 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805D57B8  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805D57BC  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805D57D0  4B C9 B7 1D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 805D5808  4B C9 13 2D */	bl __mi__4cXyzCFRC3Vec
...
/* 805D5828  4B C9 19 01 */	bl atan2sX_Z__4cXyzCFv
...
/* 805D5844  4B C9 A2 75 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 805D58C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D58C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D58F4  3C C0 80 5E */	lis r6, eff_smoke_id@ha /* 0x805DD470@ha */
/* 805D58F8  38 C6 D4 70 */	addi r6, r6, eff_smoke_id@l /* 0x805DD470@l */
...
/* 805D594C  4B A9 A0 D9 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 805D5A30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D5A34  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D5A64  3C C0 80 5E */	lis r6, eff_smoke_id@ha /* 0x805DD470@ha */
/* 805D5A68  38 C6 D4 70 */	addi r6, r6, eff_smoke_id@l /* 0x805DD470@l */
...
/* 805D5A84  4B A7 7A 49 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805D5ADC  4B A9 9F 49 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 805D5B40  4B BA B0 D9 */	bl Reset__9dCamera_cF4cXyz4cXyz
/* 805D5B44  38 7C 02 48 */	addi r3, r28, 0x248
/* 805D5B48  4B B8 B9 65 */	bl Start__9dCamera_cFv
/* 805D5B4C  38 7C 02 48 */	addi r3, r28, 0x248
/* 805D5B50  38 80 00 00 */	li r4, 0
/* 805D5B54  4B B8 D4 B9 */	bl SetTrimSize__9dCamera_cFl
/* 805D5B58  38 7F 3F 90 */	addi r3, r31, 0x3f90
/* 805D5B5C  4B A6 C9 0D */	bl reset__14dEvt_control_cFv
...
/* 805D5B74  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805D5B78  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805D5BA8  4B AA 1A 49 */	bl __dt__11dBgS_GndChkFv
/* 805D5BAC  38 61 01 38 */	addi r3, r1, 0x138
/* 805D5BB0  38 80 FF FF */	li r4, -1
/* 805D5BB4  4B AA 21 29 */	bl __dt__11dBgS_LinChkFv
/* 805D5BB8  48 00 04 EC */	b lbl_805D60A4
lbl_805D5BBC:
/* 805D5BBC  38 7B 0B E8 */	addi r3, r27, 0xbe8
/* 805D5BC0  38 9B 06 E8 */	addi r4, r27, 0x6e8
/* 805D5BC4  4B C9 9A 85 */	bl SetC__8cM3dGSphFRC4cXyz
/* 805D5BC8  38 7B 0B E8 */	addi r3, r27, 0xbe8
/* 805D5BCC  C0 3D 04 E0 */	lfs f1, 0x4e0(r29)
/* 805D5BD0  4B C9 9B 39 */	bl SetR__8cM3dGSphFf
/* 805D5BD4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D5BD8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805D5BDC  38 63 23 3C */	addi r3, r3, 0x233c
/* 805D5BE0  38 9B 0A C4 */	addi r4, r27, 0xac4
/* 805D5BE4  4B C8 EF C5 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 805D5BF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D5BFC  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D5C4C  4B A7 78 81 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805D5C60  4B A7 5C B9 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805D5C88  4B CA AB 81 */	bl func_80280808
...
/* 805D5CA8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805D5CAC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805D5CD8  4B CD 68 35 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 805D5CDC  48 00 02 70 */	b lbl_805D5F4C
lbl_805D5CE0:
/* 805D5CE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D5CE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805D5CE8  80 63 5D 3C */	lwz r3, 0x5d3c(r3)
/* 805D5CEC  38 63 02 10 */	addi r3, r3, 0x210
/* 805D5CF0  80 9B 2E 14 */	lwz r4, 0x2e14(r27)
/* 805D5CF4  4B A7 5C 25 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805D5D2C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805D5D30  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 805D5D34  80 63 00 00 */	lwz r3, 0(r3)
/* 805D5D38  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 805D5D3C  38 80 00 01 */	li r4, 1
/* 805D5D40  4B CD A2 4D */	bl changeBgmStatus__8Z2SeqMgrFl
...
/* 805D5DEC  4B AA 18 05 */	bl __dt__11dBgS_GndChkFv
/* 805D5DF0  38 61 01 38 */	addi r3, r1, 0x138
/* 805D5DF4  38 80 FF FF */	li r4, -1
/* 805D5DF8  4B AA 1E E5 */	bl __dt__11dBgS_LinChkFv
...
/* 805D5E24  4B D5 26 09 */	bl checkPass__12J3DFrameCtrlFf
...
/* 805D5E6C  4B C9 9B D1 */	bl cLib_addCalc2__FPffff
...
/* 805D5E80  4B C9 A7 89 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805D5E94  4B C9 9B A9 */	bl cLib_addCalc2__FPffff
...
/* 805D5F38  4B AA 16 B9 */	bl __dt__11dBgS_GndChkFv
/* 805D5F3C  38 61 01 38 */	addi r3, r1, 0x138
/* 805D5F40  38 80 FF FF */	li r4, -1
/* 805D5F44  4B AA 1D 99 */	bl __dt__11dBgS_LinChkFv
...
/* 805D5FE4  4B C9 A6 25 */	bl cLib_addCalcAngleS2__FPssss
lbl_805D5FE8:
...
/* 805D6010  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805D6014  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805D6048  4B AA 15 A9 */	bl __dt__11dBgS_GndChkFv
/* 805D604C  38 61 01 38 */	addi r3, r1, 0x138
/* 805D6050  38 80 FF FF */	li r4, -1
/* 805D6054  4B AA 1C 89 */	bl __dt__11dBgS_LinChkFv
...
/* 805D6070  4B C9 9A 11 */	bl cLib_addCalc0__FPfff
...
/* 805D6088  4B C9 99 B5 */	bl cLib_addCalc2__FPffff
lbl_805D608C:
/* 805D608C  38 61 00 E4 */	addi r3, r1, 0xe4
/* 805D6090  38 80 FF FF */	li r4, -1
/* 805D6094  4B AA 15 5D */	bl __dt__11dBgS_GndChkFv
/* 805D6098  38 61 01 38 */	addi r3, r1, 0x138
/* 805D609C  38 80 FF FF */	li r4, -1
/* 805D60A0  4B AA 1C 3D */	bl __dt__11dBgS_LinChkFv
lbl_805D60A4:
/* 805D60A4  39 61 01 D0 */	addi r11, r1, 0x1d0
/* 805D60A8  4B D8 C1 75 */	bl _restgpr_26
