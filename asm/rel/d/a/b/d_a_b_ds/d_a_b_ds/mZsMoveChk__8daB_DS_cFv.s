...
/* 805CC1D4  4B D9 5F ED */	bl _savegpr_22
/* 805CC1D8  7C 79 1B 78 */	mr r25, r3
/* 805CC1DC  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805CC1E0  3B A3 CA 54 */	addi r29, r3, lit_3932@l /* 0x805DCA54@l */
...
/* 805CC218  4B A4 D7 A5 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 805CC254  4B AA B3 29 */	bl __ct__11dBgS_GndChkFv
/* 805CC258  7F 23 CB 78 */	mr r3, r25
/* 805CC25C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805CC260  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805CC264  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 805CC268  4B A4 E4 A9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CC26C  7C 64 1B 78 */	mr r4, r3
/* 805CC270  3B 60 00 00 */	li r27, 0
/* 805CC274  3B 00 00 00 */	li r24, 0
/* 805CC278  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805CC27C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805CC298  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805CC29C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805CC2A0  80 63 00 00 */	lwz r3, 0(r3)
/* 805CC2A4  4B A4 01 39 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805CC2C0  4B C9 B6 95 */	bl cM_rndF__Ff
...
/* 805CC304  4B C9 BA 25 */	bl SetPos__11cBgS_GndChkFPC4cXyz
...
/* 805CC320  4B AA 81 81 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 805CC358  4B A4 D6 65 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 805CC398  4B A4 E3 79 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CC39C  7C 77 1B 78 */	mr r23, r3
/* 805CC3A0  C0 3D 00 74 */	lfs f1, 0x74(r29)
/* 805CC3A4  4B C9 B5 E9 */	bl cM_rndFX__Ff
...
/* 805CC3F8  4B A4 E3 E9 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CC3FC  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805CC400  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805CC420  4B AA B1 D1 */	bl __dt__11dBgS_GndChkFv
...
/* 805CC438  4B AA B1 B9 */	bl __dt__11dBgS_GndChkFv
lbl_805CC43C:
/* 805CC43C  39 61 00 F0 */	addi r11, r1, 0xf0
/* 805CC440  4B D9 5D CD */	bl _restgpr_22
