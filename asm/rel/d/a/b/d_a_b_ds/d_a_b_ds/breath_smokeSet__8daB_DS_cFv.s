...
/* 805D204C  4B D9 01 7D */	bl _savegpr_24
/* 805D2050  7C 7D 1B 78 */	mr r29, r3
/* 805D2054  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805D2058  3B E3 CA 54 */	addi r31, r3, lit_3932@l /* 0x805DCA54@l */
...
/* 805D207C  4B C9 D9 C1 */	bl cLib_addCalc2__FPffff
...
/* 805D2090  3C 60 80 5E */	lis r3, struct_805DDB10+0x2@ha /* 0x805DDB12@ha */
/* 805D2094  98 03 DB 12 */	stb r0, struct_805DDB10+0x2@l(r3)  /* 0x805DDB12@l */
/* 805D2098  3B C0 00 00 */	li r30, 0
/* 805D209C  3B 80 00 00 */	li r28, 0
/* 805D20A0  3B 60 00 00 */	li r27, 0
/* 805D20A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D20A8  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805D20AC  3C 60 80 5E */	lis r3, effId_7205@ha /* 0x805DD5E8@ha */
/* 805D20B0  3B 23 D5 E8 */	addi r25, r3, effId_7205@l /* 0x805DD5E8@l */
lbl_805D20B4:
...
/* 805D2100  4B A7 B3 CD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805D2114  4B A7 98 05 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805D2140  4B CA E6 C9 */	bl func_80280808
...
/* 805D2174  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805D2178  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805D21A4  4B CD A3 69 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 805D21D8  4B C9 49 5D */	bl __mi__4cXyzCFRC3Vec
...
/* 805D2250  4B A4 7B 49 */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
lbl_805D2254:
/* 805D2254  39 61 00 90 */	addi r11, r1, 0x90
/* 805D2258  4B D8 FF BD */	bl _restgpr_24
