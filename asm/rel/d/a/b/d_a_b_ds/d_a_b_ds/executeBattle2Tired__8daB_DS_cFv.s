...
/* 805D5050  4B D8 D1 8D */	bl _savegpr_29
/* 805D5054  7C 7E 1B 78 */	mr r30, r3
/* 805D5058  3C 80 80 5E */	lis r4, lit_3932@ha /* 0x805DCA54@ha */
/* 805D505C  3B E4 CA 54 */	addi r31, r4, lit_3932@l /* 0x805DCA54@l */
...
/* 805D50D0  4B D5 33 5D */	bl checkPass__12J3DFrameCtrlFf
...
lbl_805D51E4:
/* 805D51E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D51E8  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D5274  3C A0 80 5E */	lis r5, l_HIO@ha /* 0x805DDABC@ha */
/* 805D5278  38 C5 DA BC */	addi r6, r5, l_HIO@l /* 0x805DDABC@l */
/* 805D527C  A8 A6 00 42 */	lha r5, 0x42(r6)
/* 805D5280  A8 C6 00 44 */	lha r6, 0x44(r6)
/* 805D5284  4B C9 B3 85 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805D52C0  4B D8 CF 69 */	bl _restgpr_29
