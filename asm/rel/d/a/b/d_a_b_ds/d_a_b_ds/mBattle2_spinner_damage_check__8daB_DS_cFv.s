...
/* 805D9D0C  4B D8 84 C1 */	bl _savegpr_25
/* 805D9D10  7C 7C 1B 78 */	mr r28, r3
/* 805D9D14  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805D9D18  3B C3 CA 54 */	addi r30, r3, lit_3932@l /* 0x805DCA54@l */
...
/* 805D9D70  4B AA A6 F1 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 805D9D88  4B AA A7 71 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 805D9DB8  4B AA D7 5D */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
...
lbl_805D9E04:
/* 805D9E04  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D9E08  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D9E30  4B AA A6 31 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 805D9E34  28 03 00 00 */	cmplwi r3, 0
/* 805D9E38  41 82 01 8C */	beq lbl_805D9FC4
/* 805D9E3C  7F 43 D3 78 */	mr r3, r26
/* 805D9E40  4B AA A6 B9 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 805D9E58  4B C8 CC DD */	bl __mi__4cXyzCFRC3Vec
...
/* 805D9EA0  4B C8 D2 89 */	bl atan2sX_Z__4cXyzCFv
...
/* 805D9EB4  4B AA A6 45 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 805D9F04  4B AA D6 11 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
...
/* 805D9F24  4B A7 22 F5 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
/* 805D9F28  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805D9F2C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 805D9F30  80 63 00 00 */	lwz r3, 0(r3)
/* 805D9F34  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 805D9F38  38 80 00 02 */	li r4, 2
/* 805D9F3C  4B CD 60 51 */	bl changeBgmStatus__8Z2SeqMgrFl
...
/* 805D9F8C  4B AA D5 89 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
...
/* 805D9FAC  4B A7 22 6D */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
lbl_805D9FB0:
...
/* 805D9FD8  4B AA 98 59 */	bl Move__10dCcD_GSttsFv
lbl_805D9FDC:
/* 805D9FDC  39 61 00 60 */	addi r11, r1, 0x60
/* 805D9FE0  4B D8 82 39 */	bl _restgpr_25
