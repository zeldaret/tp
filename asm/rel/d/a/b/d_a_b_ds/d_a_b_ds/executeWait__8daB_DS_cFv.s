...
/* 805D0044  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805D0048  3B C3 CA 54 */	addi r30, r3, lit_3932@l /* 0x805DCA54@l */
...
/* 805D0078  4B C9 78 DD */	bl cM_rndF__Ff
...
/* 805D00CC  3C 60 80 5E */	lis r3, Ds_wait_id@ha /* 0x805DD570@ha */
/* 805D00D0  38 63 D5 70 */	addi r3, r3, Ds_wait_id@l /* 0x805DD570@l */
...
/* 805D0100  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D0104  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805D0108  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 805D010C  4B A4 A6 D5 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805D0110  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805D0114  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805D0148  4B A4 A5 C9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805D014C  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 805D0150  7C 03 00 50 */	subf r0, r3, r0
/* 805D0154  7C 03 07 34 */	extsh r3, r0
/* 805D0158  4B D9 4F 79 */	bl abs
