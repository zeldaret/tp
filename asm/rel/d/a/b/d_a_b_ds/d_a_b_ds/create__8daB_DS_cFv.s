...
/* 805DB984  4B D8 68 45 */	bl _savegpr_24
/* 805DB988  7C 7F 1B 78 */	mr r31, r3
/* 805DB98C  3C 80 80 5E */	lis r4, cNullVec__6Z2Calc@ha /* 0x805DD248@ha */
/* 805DB990  3B 84 D2 48 */	addi r28, r4, cNullVec__6Z2Calc@l /* 0x805DD248@l */
/* 805DB994  3C 80 80 5E */	lis r4, lit_3932@ha /* 0x805DCA54@ha */
/* 805DB998  3B C4 CA 54 */	addi r30, r4, lit_3932@l /* 0x805DCA54@l */
...
/* 805DB9C4  3C 80 80 5E */	lis r4, d_a_b_ds__stringBase0@ha /* 0x805DD22C@ha */
/* 805DB9C8  38 84 D2 2C */	addi r4, r4, d_a_b_ds__stringBase0@l /* 0x805DD22C@l */
/* 805DB9CC  4B A5 14 F1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 805DB9E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805DB9EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805DB9F0  3B 43 09 58 */	addi r26, r3, 0x958
/* 805DB9F4  7F 43 D3 78 */	mr r3, r26
/* 805DB9F8  38 80 00 03 */	li r4, 3
/* 805DB9FC  4B A5 8F 39 */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 805DBA14  4B A5 1F 39 */	bl dComIfGs_onZoneSwitch__Fii
/* 805DBA18  38 00 00 04 */	li r0, 4
/* 805DBA1C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805DBA20  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 805DBA3C  4B A5 8E F9 */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 805DBAA4  4B A4 06 31 */	bl fopAcM_createItemForBoss__FPC4cXyziiPC5csXyzPC4cXyzffi
lbl_805DBAA8:
...
/* 805DBB40  4B AA 7D 21 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 805DBB54  4B AA 8E E1 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805DBBB4  4B A9 A6 95 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 805DBBB8  38 7F 08 B0 */	addi r3, r31, 0x8b0
/* 805DBBBC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805DBBC0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805DBBC4  38 84 0F 38 */	addi r4, r4, 0xf38
/* 805DBBC8  4B A9 AE E5 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 805DBC08  3C 80 80 5E */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x805DB954@ha */
/* 805DBC0C  38 84 B9 54 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x805DB954@l */
/* 805DBC10  3C A0 00 01 */	lis r5, 0x0001 /* 0x0000FAC0@ha */
/* 805DBC14  38 A5 FA C0 */	addi r5, r5, 0xFAC0 /* 0x0000FAC0@l */
/* 805DBC18  4B A3 E8 99 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_805DBC2C:
/* 805DBC2C  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805DBC30  38 83 DA BC */	addi r4, r3, l_HIO@l /* 0x805DDABC@l */
/* 805DBC34  A8 04 00 4A */	lha r0, 0x4a(r4)
/* 805DBC38  B0 1F 05 62 */	sth r0, 0x562(r31)
/* 805DBC3C  B0 1F 05 60 */	sth r0, 0x560(r31)
/* 805DBC40  3C 60 80 5E */	lis r3, struct_805DDAAC+0x1@ha /* 0x805DDAAD@ha */
/* 805DBC44  8C 03 DA AD */	lbzu r0, struct_805DDAAC+0x1@l(r3)  /* 0x805DDAAD@l */
...
/* 805DBCA4  4B A3 E8 85 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 805DBCB8  4B A3 E8 81 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 805DBCE4  4B A9 A5 65 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 805DBD44  4B C8 BF E5 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 805DBD48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805DBD4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805DBD50  38 63 0F 38 */	addi r3, r3, 0xf38
/* 805DBD54  38 81 00 3C */	addi r4, r1, 0x3c
/* 805DBD58  4B A9 87 49 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 805DBD7C  4B A9 B8 75 */	bl __dt__11dBgS_GndChkFv
...
/* 805DBD98  4B AA 8C 9D */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805DBDC8  4B AA 8C 6D */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805DBDF0  4B AA 8A C5 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 805DBE04  4B AA 8A B1 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 805DBE18  4B AA 8A 9D */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 805DBE80  4B CE 52 15 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 805DBF48  4B A5 1A 05 */	bl dComIfGs_onZoneSwitch__Fii
/* 805DBF4C  A0 1F 05 8E */	lhz r0, 0x58e(r31)
/* 805DBF50  60 00 02 00 */	ori r0, r0, 0x200
/* 805DBF54  B0 1F 05 8E */	sth r0, 0x58e(r31)
/* 805DBF58  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805DBF5C  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805DBF90  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805DBF94  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805DBF98  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805DBF9C  7C 05 07 74 */	extsb r5, r0
/* 805DBFA0  4B A5 92 61 */	bl onSwitch__10dSv_info_cFii
lbl_805DBFA4:
/* 805DBFA4  80 1F 04 9C */	lwz r0, 0x49c(r31)
/* 805DBFA8  60 00 40 00 */	ori r0, r0, 0x4000
/* 805DBFAC  90 1F 04 9C */	stw r0, 0x49c(r31)
/* 805DBFB0  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 805DBFB4  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
...
/* 805DBFCC  4B A5 1A 65 */	bl dComIfGs_isZoneSwitch__Fii
...
/* 805DBFF4  4B A5 19 D9 */	bl dComIfGs_offZoneSwitch__Fii
...
/* 805DC01C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805DC020  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805DC024  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805DC028  7C 05 07 74 */	extsb r5, r0
/* 805DC02C  4B A5 92 85 */	bl offSwitch__10dSv_info_cFii
lbl_805DC030:
...
/* 805DC060  4B A5 19 D1 */	bl dComIfGs_isZoneSwitch__Fii
...
/* 805DC0B0  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 805DC0B4  98 03 0C 98 */	stb r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
/* 805DC0B8  38 60 00 05 */	li r3, 5
/* 805DC0BC  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805DC0C0  7C 04 07 74 */	extsb r4, r0
/* 805DC0C4  4B A5 18 89 */	bl dComIfGs_onZoneSwitch__Fii
lbl_805DC0C8:
/* 805DC0C8  88 9F 08 59 */	lbz r4, 0x859(r31)
/* 805DC0CC  28 04 00 FF */	cmplwi r4, 0xff
/* 805DC0D0  41 82 00 18 */	beq lbl_805DC0E8
/* 805DC0D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805DC0D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805DC0DC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805DC0E0  7C 05 07 74 */	extsb r5, r0
/* 805DC0E4  4B A5 91 CD */	bl offSwitch__10dSv_info_cFii
lbl_805DC0E8:
...
/* 805DC0FC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805DC100  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805DC11C  4B CD 2E F5 */	bl bgmStart__8Z2SeqMgrFUlUll
/* 805DC120  38 60 00 01 */	li r3, 1
/* 805DC124  4B BC C6 C1 */	bl dKy_change_colpat__FUc
...
/* 805DC1D4  4B D8 60 41 */	bl _restgpr_24
