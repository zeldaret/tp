...
/* 805CD664  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805CD668  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805CD6A0  3C 60 80 5E */	lis r3, HeadAngleDt@ha /* 0x805DD49C@ha */
/* 805CD6A4  38 63 D4 9C */	addi r3, r3, HeadAngleDt@l /* 0x805DD49C@l */
...
/* 805CD6BC  4B C9 9A 95 */	bl atan2sY_XZ__4cXyzCFv
/* 805CD6C0  7C 60 07 34 */	extsh r0, r3
/* 805CD6C4  7C 00 00 D0 */	neg r0, r0
/* 805CD6C8  3C 60 80 5E */	lis r3, lit_5154@ha /* 0x805DCAEC@ha */
/* 805CD6CC  C8 23 CA EC */	lfd f1, lit_5154@l(r3)  /* 0x805DCAEC@l */
...
/* 805CD6E8  3C 60 80 5E */	lis r3, lit_4649@ha /* 0x805DCACC@ha */
/* 805CD6EC  C0 03 CA CC */	lfs f0, lit_4649@l(r3)  /* 0x805DCACC@l */
...
/* 805CD76C  4B CA 2E 9D */	bl cLib_addCalcAngleS2__FPssss
/* 805CD770  38 61 00 10 */	addi r3, r1, 0x10
/* 805CD774  4B C9 99 B5 */	bl atan2sX_Z__4cXyzCFv
...
/* 805CD7D0  4B A4 CF 41 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CD7D4  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 805CD7D8  7C 00 18 50 */	subf r0, r0, r3
/* 805CD7DC  7C 03 07 34 */	extsh r3, r0
/* 805CD7E0  4B D9 78 F1 */	bl abs
...
/* 805CD7F4  4B A4 CF ED */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CD7F8  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805CD7FC  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805CD81C  4B CA 2D ED */	bl cLib_addCalcAngleS2__FPssss
