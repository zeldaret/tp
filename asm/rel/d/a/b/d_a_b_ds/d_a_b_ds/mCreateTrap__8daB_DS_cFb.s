...
/* 805CC8B4  4B D9 59 09 */	bl _savegpr_21
/* 805CC8B8  7C 7F 1B 78 */	mr r31, r3
/* 805CC8BC  7C 98 23 78 */	mr r24, r4
/* 805CC8C0  3C 60 80 5E */	lis r3, cNullVec__6Z2Calc@ha /* 0x805DD248@ha */
/* 805CC8C4  3B 83 D2 48 */	addi r28, r3, cNullVec__6Z2Calc@l /* 0x805DD248@l */
/* 805CC8C8  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805CC8CC  3B A3 CA 54 */	addi r29, r3, lit_3932@l /* 0x805DCA54@l */
/* 805CC8D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805CC8D4  3A A3 61 C0 */	addi r21, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805CC944  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805CC948  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805CC9EC  4B A4 DD 25 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805CCA18  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805CCA1C  3B C3 DA BC */	addi r30, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805CCA68  4B A4 CF 55 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 805CCAD4  4B A8 4D 19 */	bl dPath_GetRoomPath__Fii
...
/* 805CCB10  4B C9 A0 25 */	bl __mi__4cXyzCFRC3Vec
...
/* 805CCB30  4B D7 A6 09 */	bl PSVECSquareMag
...
/* 805CCBA0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805CCBA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805CCC10  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805CCC14  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805CCC18:
...
/* 805CCC70  4B A4 D2 81 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 805CCD6C  4B A4 D1 85 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 805CCDB4  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805CCDB8  38 83 DA BC */	addi r4, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805CCE70  4B A4 D0 81 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 805CCEA0  4B D9 53 69 */	bl _restgpr_21
