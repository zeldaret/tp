...
/* 805D2284  3C 80 80 5E */	lis r4, lit_3932@ha /* 0x805DCA54@ha */
/* 805D2288  3B E4 CA 54 */	addi r31, r4, lit_3932@l /* 0x805DCA54@l */
...
/* 805D22D8  3C 80 80 5E */	lis r4, Ds_breath_id@ha /* 0x805DD5F0@ha */
/* 805D22DC  38 84 D5 F0 */	addi r4, r4, Ds_breath_id@l /* 0x805DD5F0@l */
...
/* 805D230C  4B D5 61 21 */	bl checkPass__12J3DFrameCtrlFf
...
/* 805D237C  4B C9 E2 8D */	bl cLib_addCalcAngleS2__FPssss
lbl_805D2380:
...
/* 805D23B4  3C 80 80 5E */	lis r4, Ds_breath_id@ha /* 0x805DD5F0@ha */
/* 805D23B8  38 84 D5 F0 */	addi r4, r4, Ds_breath_id@l /* 0x805DD5F0@l */
...
/* 805D23F0  3C 60 80 5E */	lis r3, struct_805DDB10+0x2@ha /* 0x805DDB12@ha */
/* 805D23F4  98 03 DB 12 */	stb r0, struct_805DDB10+0x2@l(r3)  /* 0x805DDB12@l */
...
/* 805D2410  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805D2414  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805D242C  3C 80 80 5E */	lis r4, Ds_breath_id@ha /* 0x805DD5F0@ha */
/* 805D2430  38 84 D5 F0 */	addi r4, r4, Ds_breath_id@l /* 0x805DD5F0@l */
...
/* 805D2488  4B C9 E1 81 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805D24A0  4B C9 D4 DD */	bl cLib_addCalc__FPfffff
/* 805D24A4  38 60 00 01 */	li r3, 1
/* 805D24A8  38 80 00 05 */	li r4, 5
/* 805D24AC  C0 3E 07 FC */	lfs f1, 0x7fc(r30)
/* 805D24B0  4B BD 63 5D */	bl dKy_custom_colset__FUcUcf
