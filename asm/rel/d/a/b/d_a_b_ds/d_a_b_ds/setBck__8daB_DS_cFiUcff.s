...
/* 805CBAE8  4B D9 66 F5 */	bl _savegpr_29
...
/* 805CBB00  3C 60 80 5E */	lis r3, d_a_b_ds__stringBase0@ha /* 0x805DD22C@ha */
/* 805CBB04  38 63 D2 2C */	addi r3, r3, d_a_b_ds__stringBase0@l /* 0x805DD22C@l */
/* 805CBB08  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805CBB0C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805CBB10  3C A5 00 02 */	addis r5, r5, 2
/* 805CBB14  38 C0 00 80 */	li r6, 0x80
/* 805CBB18  38 A5 C2 F8 */	addi r5, r5, -15624
/* 805CBB1C  4B A7 07 D1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805CBB34  3C C0 80 5E */	lis r6, lit_3933@ha /* 0x805DCA58@ha */
/* 805CBB38  C0 66 CA 58 */	lfs f3, lit_3933@l(r6)  /* 0x805DCA58@l */
/* 805CBB3C  3C C0 80 5E */	lis r6, lit_4285@ha /* 0x805DCAAC@ha */
/* 805CBB40  C0 86 CA AC */	lfs f4, lit_4285@l(r6)  /* 0x805DCAAC@l */
/* 805CBB44  4B A4 53 2D */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 805CBB60  4B D9 66 C9 */	bl _restgpr_29
