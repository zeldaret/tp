...
/* 805CFC9C  4B D9 25 3D */	bl _savegpr_28
/* 805CFCA0  7C 7D 1B 78 */	mr r29, r3
/* 805CFCA4  3C 60 80 5E */	lis r3, lit_3932@ha /* 0x805DCA54@ha */
/* 805CFCA8  3B C3 CA 54 */	addi r30, r3, lit_3932@l /* 0x805DCA54@l */
/* 805CFCAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805CFCB0  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805CFCF0  4B A4 AA 21 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CFCF4  A8 1D 04 E6 */	lha r0, 0x4e6(r29)
/* 805CFCF8  7C 00 18 50 */	subf r0, r0, r3
/* 805CFCFC  7C 03 07 34 */	extsh r3, r0
/* 805CFD00  4B D9 53 D1 */	bl abs
...
/* 805CFD18  4B C9 6E 1D */	bl __mi__4cXyzCFRC3Vec
...
/* 805CFD40  4B C9 6D F5 */	bl __mi__4cXyzCFRC3Vec
...
/* 805CFD60  4B D7 73 D9 */	bl PSVECSquareMag
...
/* 805CFDD0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805CFDD4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805CFE40  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805CFE44  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805CFE48:
/* 805CFE48  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805CFE4C  3B 83 DA BC */	addi r28, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805CFE80  4B D7 72 B9 */	bl PSVECSquareMag
...
/* 805CFEF0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805CFEF4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805CFF60  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805CFF64  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805CFF68:
...
/* 805CFFAC  4B A4 A8 35 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CFFB0  3C 60 80 5E */	lis r3, l_HIO@ha /* 0x805DDABC@ha */
/* 805CFFB4  38 63 DA BC */	addi r3, r3, l_HIO@l /* 0x805DDABC@l */
...
/* 805CFFCC  4B A4 A7 45 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805D0018  4B D9 22 0D */	bl _restgpr_28
