...
/* 805E9A40  3C 60 80 5F */	lis r3, lit_3912@ha /* 0x805ED064@ha */
/* 805E9A44  C0 03 D0 64 */	lfs f0, lit_3912@l(r3)  /* 0x805ED064@l */
...
/* 805E9A68  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805E9A6C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805E9A70  4B D5 CA 41 */	bl PSMTXCopy
/* 805E9A74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805E9A78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805E9A7C  38 81 00 14 */	addi r4, r1, 0x14
/* 805E9A80  7C 85 23 78 */	mr r5, r4
/* 805E9A84  4B D5 D2 E9 */	bl PSMTXMultVec
/* 805E9A88  38 61 00 08 */	addi r3, r1, 8
/* 805E9A8C  38 81 00 14 */	addi r4, r1, 0x14
/* 805E9A90  38 BE 06 5C */	addi r5, r30, 0x65c
/* 805E9A94  4B C7 D0 A1 */	bl __mi__4cXyzCFRC3Vec
...
/* 805E9ABC  3C 60 80 5F */	lis r3, lit_3912@ha /* 0x805ED064@ha */
/* 805E9AC0  C0 03 D0 64 */	lfs f0, lit_3912@l(r3)  /* 0x805ED064@l */
...
/* 805E9AD8  4B C7 DB 9D */	bl cM_atan2s__Fff
...
/* 805E9AEC  4B C7 DB 89 */	bl cM_atan2s__Fff
...
/* 805E9B00  4B C8 6B 09 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805E9B14  4B C8 6A F5 */	bl cLib_addCalcAngleS2__FPssss
