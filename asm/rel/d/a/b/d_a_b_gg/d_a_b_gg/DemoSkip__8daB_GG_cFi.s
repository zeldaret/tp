...
/* 805DFAE4  3C 60 80 5F */	lis r3, lit_3911@ha /* 0x805ED060@ha */
/* 805DFAE8  3B E3 D0 60 */	addi r31, r3, lit_3911@l /* 0x805ED060@l */
...
/* 805DFB20  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 805DFB24  9C 03 0C 98 */	stbu r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
...
/* 805DFB48  4B A4 76 29 */	bl dStage_changeScene__FifUlScsi
/* 805DFB4C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805DFB50  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 805DFB54  80 63 00 00 */	lwz r3, 0(r3)
/* 805DFB58  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 805DFB5C  4B CC FD 29 */	bl subBgmStop__8Z2SeqMgrFv
...
/* 805DFB78  3C 80 80 5F */	lis r4, data_805ED72C@ha /* 0x805ED72C@ha */
/* 805DFB7C  38 84 D7 2C */	addi r4, r4, data_805ED72C@l /* 0x805ED72C@l */
/* 805DFB80  80 84 00 00 */	lwz r4, 0(r4)
/* 805DFB84  3C A0 80 5F */	lis r5, data_805ED730@ha /* 0x805ED730@ha */
/* 805DFB88  38 A5 D7 30 */	addi r5, r5, data_805ED730@l /* 0x805ED730@l */
/* 805DFB8C  A8 A5 00 00 */	lha r5, 0(r5)
/* 805DFB90  38 C1 00 20 */	addi r6, r1, 0x20
/* 805DFB94  4B C9 12 2D */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
lbl_805DFBF8:
/* 805DFBF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805DFBFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805DFC00  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 805DFC04  38 80 00 1F */	li r4, 0x1f
/* 805DFC08  4B A9 01 8D */	bl StopQuake__12dVibration_cFi
