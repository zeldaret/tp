...
/* 805EB928  4B A2 14 3D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 805EB92C  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 805EB930  4B A2 16 15 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 805EB934  3C 60 80 5F */	lis r3, l_HIO@ha /* 0x805ED70C@ha */
/* 805EB938  38 63 D7 0C */	addi r3, r3, l_HIO@l /* 0x805ED70C@l */
/* 805EB93C  C0 23 00 08 */	lfs f1, 8(r3)
/* 805EB940  FC 40 08 90 */	fmr f2, f1
/* 805EB944  FC 60 08 90 */	fmr f3, f1
/* 805EB948  4B A2 14 F1 */	bl scaleM__14mDoMtx_stack_cFfff
/* 805EB94C  80 7F 0E 30 */	lwz r3, 0xe30(r31)
/* 805EB950  80 83 00 04 */	lwz r4, 4(r3)
/* 805EB954  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805EB958  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805EB95C  38 84 00 24 */	addi r4, r4, 0x24
/* 805EB960  4B D5 AB 51 */	bl PSMTXCopy
/* 805EB964  80 7F 0E 30 */	lwz r3, 0xe30(r31)
/* 805EB968  4B A2 58 85 */	bl modelCalc__16mDoExt_McaMorfSOFv
