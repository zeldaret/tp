...
/* 805DE7D4  4B D8 39 ED */	bl _savegpr_22
/* 805DE7D8  7C 7B 1B 78 */	mr r27, r3
/* 805DE7DC  3C 60 80 5F */	lis r3, lit_3911@ha /* 0x805ED060@ha */
/* 805DE7E0  3B C3 D0 60 */	addi r30, r3, lit_3911@l /* 0x805ED060@l */
/* 805DE7E4  38 7B 07 FC */	addi r3, r27, 0x7fc
/* 805DE7E8  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 805DE7EC  4B C9 09 F1 */	bl SetC__8cM3dGCylFRC4cXyz
/* 805DE7F0  38 7B 07 FC */	addi r3, r27, 0x7fc
/* 805DE7F4  C0 3E 00 00 */	lfs f1, 0(r30)
/* 805DE7F8  3C 80 80 5F */	lis r4, l_HIO@ha /* 0x805ED70C@ha */
/* 805DE7FC  3B E4 D7 0C */	addi r31, r4, l_HIO@l /* 0x805ED70C@l */
/* 805DE800  C0 1F 00 08 */	lfs f0, 8(r31)
/* 805DE804  EC 21 00 32 */	fmuls f1, f1, f0
/* 805DE808  4B C9 09 F9 */	bl SetR__8cM3dGCylFf
/* 805DE80C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805DE810  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805DE814  3B A3 23 3C */	addi r29, r3, 0x233c
/* 805DE818  7F A3 EB 78 */	mr r3, r29
/* 805DE81C  38 9B 06 D8 */	addi r4, r27, 0x6d8
/* 805DE820  4B C8 63 89 */	bl Set__4cCcSFP8cCcD_Obj
/* 805DE824  38 7B 0C E0 */	addi r3, r27, 0xce0
/* 805DE828  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 805DE82C  4B C9 09 B1 */	bl SetC__8cM3dGCylFRC4cXyz
...
/* 805DE840  4B C9 09 C1 */	bl SetR__8cM3dGCylFf
/* 805DE844  7F A3 EB 78 */	mr r3, r29
/* 805DE848  38 9B 0B BC */	addi r4, r27, 0xbbc
/* 805DE84C  4B C8 63 5D */	bl Set__4cCcSFP8cCcD_Obj
...
/* 805DE86C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805DE870  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_805DE874:
...
/* 805DE934  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805DE938  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805DE93C  4B D6 7B 75 */	bl PSMTXCopy
/* 805DE940  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805DE944  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805DE948  38 81 00 08 */	addi r4, r1, 8
/* 805DE94C  7C 85 23 78 */	mr r5, r4
/* 805DE950  4B D6 84 1D */	bl PSMTXMultVec
/* 805DE954  38 7B 0E 1C */	addi r3, r27, 0xe1c
/* 805DE958  38 81 00 08 */	addi r4, r1, 8
/* 805DE95C  4B C9 0C ED */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 805DE970  4B C9 0D 99 */	bl SetR__8cM3dGSphFf
/* 805DE974  7F A3 EB 78 */	mr r3, r29
/* 805DE978  38 9B 0C F8 */	addi r4, r27, 0xcf8
/* 805DE97C  4B C8 62 2D */	bl Set__4cCcSFP8cCcD_Obj
...
/* 805DE9A4  4B D8 38 69 */	bl _restgpr_22
