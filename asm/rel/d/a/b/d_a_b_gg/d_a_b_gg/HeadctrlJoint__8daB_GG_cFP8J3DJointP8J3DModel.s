...
/* 805DED68  4B D8 34 70 */	b _savegpr_28
...
/* 805DED88  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805DED8C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805DED90  4B D6 77 20 */	b PSMTXCopy
...
lbl_805DEDAC:
/* 805DEDAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DEDB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DEDB4  3C 80 80 5F */	lis r4, lit_3934@ha
/* 805DEDB8  C0 44 D0 94 */	lfs f2, lit_3934@l(r4)
/* 805DEDBC  A8 1D 06 D4 */	lha r0, 0x6d4(r29)
/* 805DEDC0  3C 80 80 5F */	lis r4, lit_4066@ha
/* 805DEDC4  C8 24 D1 A8 */	lfd f1, lit_4066@l(r4)
...
/* 805DEDF0  4B A2 D6 44 */	b mDoMtx_YrotM__FPA4_fs
/* 805DEDF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DEDF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DEDFC  3C 80 80 5F */	lis r4, lit_3934@ha
/* 805DEE00  C0 44 D0 94 */	lfs f2, lit_3934@l(r4)
/* 805DEE04  A8 1D 06 D6 */	lha r0, 0x6d6(r29)
/* 805DEE08  3C 80 80 5F */	lis r4, lit_4066@ha
/* 805DEE0C  C8 24 D1 A8 */	lfd f1, lit_4066@l(r4)
...
/* 805DEE38  4B A2 D6 94 */	b mDoMtx_ZrotM__FPA4_fs
/* 805DEE3C  48 00 00 94 */	b lbl_805DEED0
lbl_805DEE40:
/* 805DEE40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DEE44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DEE48  3C 80 80 5F */	lis r4, lit_3934@ha
/* 805DEE4C  C0 44 D0 94 */	lfs f2, lit_3934@l(r4)
/* 805DEE50  A8 1D 06 D4 */	lha r0, 0x6d4(r29)
/* 805DEE54  3C 80 80 5F */	lis r4, lit_4066@ha
/* 805DEE58  C8 24 D1 A8 */	lfd f1, lit_4066@l(r4)
...
/* 805DEE84  4B A2 D5 B0 */	b mDoMtx_YrotM__FPA4_fs
/* 805DEE88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DEE8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DEE90  3C 80 80 5F */	lis r4, lit_3934@ha
/* 805DEE94  C0 44 D0 94 */	lfs f2, lit_3934@l(r4)
/* 805DEE98  A8 1D 06 D6 */	lha r0, 0x6d6(r29)
/* 805DEE9C  3C 80 80 5F */	lis r4, lit_4066@ha
/* 805DEEA0  C8 24 D1 A8 */	lfd f1, lit_4066@l(r4)
...
/* 805DEECC  4B A2 D6 00 */	b mDoMtx_ZrotM__FPA4_fs
lbl_805DEED0:
/* 805DEED0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DEED4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DEED8  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 805DEEDC  80 04 00 0C */	lwz r0, 0xc(r4)
/* 805DEEE0  7C 80 FA 14 */	add r4, r0, r31
/* 805DEEE4  4B D6 75 CC */	b PSMTXCopy
/* 805DEEE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DEEEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DEEF0  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 805DEEF4  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 805DEEF8  4B D6 75 B8 */	b PSMTXCopy
/* 805DEEFC  38 60 00 01 */	li r3, 1
/* 805DEF00  39 61 00 40 */	addi r11, r1, 0x40
/* 805DEF04  4B D8 33 20 */	b _restgpr_28
