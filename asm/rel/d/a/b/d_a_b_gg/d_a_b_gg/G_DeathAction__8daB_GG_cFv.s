...
/* 805E7D68  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805E7D6C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805E7DA4  3C 60 80 5F */	lis r3, lit_3912@ha /* 0x805ED064@ha */
/* 805E7DA8  C0 23 D0 64 */	lfs f1, lit_3912@l(r3)  /* 0x805ED064@l */
...
/* 805E7E10  4B A3 4C C9 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
...
/* 805E7E28  4B A3 4C B1 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
/* 805E7E2C  7F C3 F3 78 */	mr r3, r30
/* 805E7E30  4B A3 1E 4D */	bl fopAcM_delete__FP10fopAc_ac_c
/* 805E7E34  88 1E 06 90 */	lbz r0, 0x690(r30)
/* 805E7E38  28 00 00 00 */	cmplwi r0, 0
/* 805E7E3C  40 82 00 28 */	bne lbl_805E7E64
/* 805E7E40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805E7E44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805E7E48  88 9E 05 CF */	lbz r4, 0x5cf(r30)
/* 805E7E4C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805E7E50  7C 05 07 74 */	extsb r5, r0
/* 805E7E54  4B A4 D3 AD */	bl onSwitch__10dSv_info_cFii
...
/* 805E7E70  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 805E7E74  98 03 0C 98 */	stb r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
/* 805E7E78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805E7E7C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805E7E80  88 9E 05 CF */	lbz r4, 0x5cf(r30)
/* 805E7E84  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805E7E88  7C 05 07 74 */	extsb r5, r0
/* 805E7E8C  4B A4 D3 75 */	bl onSwitch__10dSv_info_cFii
...
/* 805E7EA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805E7EA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805E7EA8  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805E7EAC  7C 05 07 74 */	extsb r5, r0
/* 805E7EB0  4B A4 D4 B1 */	bl isSwitch__10dSv_info_cCFii
/* 805E7EB4  2C 03 00 00 */	cmpwi r3, 0
/* 805E7EB8  40 82 00 1C */	bne lbl_805E7ED4
/* 805E7EBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805E7EC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805E7EC4  88 9E 05 CF */	lbz r4, 0x5cf(r30)
/* 805E7EC8  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805E7ECC  7C 05 07 74 */	extsb r5, r0
/* 805E7ED0  4B A4 D3 31 */	bl onSwitch__10dSv_info_cFii
lbl_805E7ED4:
/* 805E7ED4  3C 60 80 5F */	lis r3, lit_5507@ha /* 0x805ED298@ha */
/* 805E7ED8  C0 43 D2 98 */	lfs f2, lit_5507@l(r3)  /* 0x805ED298@l */
/* 805E7EDC  A8 1E 05 DA */	lha r0, 0x5da(r30)
/* 805E7EE0  3C 60 80 5F */	lis r3, lit_4066@ha /* 0x805ED1A8@ha */
/* 805E7EE4  C8 23 D1 A8 */	lfd f1, lit_4066@l(r3)  /* 0x805ED1A8@l */
