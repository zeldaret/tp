...
/* 805EC79C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 805EC7A0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 805EC7C0  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 805EC7C4  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 805EC7DC  3C 60 80 5F */	lis r3, __vt__8cM3dGSph@ha /* 0x805ED678@ha */
/* 805EC7E0  38 03 D6 78 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x805ED678@l */
/* 805EC7E4  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_805EC7E8:
/* 805EC7E8  34 1E 01 04 */	addic. r0, r30, 0x104
/* 805EC7EC  41 82 00 24 */	beq lbl_805EC810
/* 805EC7F0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805EC7F4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805EC7F8  90 1E 01 20 */	stw r0, 0x120(r30)
/* 805EC7FC  34 1E 01 04 */	addic. r0, r30, 0x104
/* 805EC800  41 82 00 10 */	beq lbl_805EC810
/* 805EC804  3C 60 80 5F */	lis r3, __vt__8cM3dGAab@ha /* 0x805ED690@ha */
/* 805EC808  38 03 D6 90 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805ED690@l */
/* 805EC80C  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_805EC810:
/* 805EC810  7F C3 F3 78 */	mr r3, r30
/* 805EC814  38 80 00 00 */	li r4, 0
/* 805EC818  4B A9 78 CD */	bl __dt__12dCcD_GObjInfFv
/* 805EC81C  7F E0 07 35 */	extsh. r0, r31
/* 805EC820  40 81 00 0C */	ble lbl_805EC82C
/* 805EC824  7F C3 F3 78 */	mr r3, r30
/* 805EC828  4B CE 25 15 */	bl __dl__FPv
lbl_805EC82C:
