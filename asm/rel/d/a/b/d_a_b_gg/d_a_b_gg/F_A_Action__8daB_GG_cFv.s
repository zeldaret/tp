...
/* 805E5D3C  4B D7 C4 A1 */	bl _savegpr_29
/* 805E5D40  7C 7D 1B 78 */	mr r29, r3
/* 805E5D44  3C 80 80 5F */	lis r4, lit_3911@ha /* 0x805ED060@ha */
/* 805E5D48  3B C4 D0 60 */	addi r30, r4, lit_3911@l /* 0x805ED060@l */
/* 805E5D4C  4B B7 9B 99 */	bl cancelBoomerangLockActor__9daPy_py_cFP10fopAc_ac_c
...
/* 805E5D90  4B C8 9C AD */	bl cLib_addCalc2__FPffff
lbl_805E5D94:
/* 805E5D94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805E5D98  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805E5DE4  4B C8 9C 59 */	bl cLib_addCalc2__FPffff
/* 805E5DE8  38 61 00 08 */	addi r3, r1, 8
/* 805E5DEC  3C 80 80 5F */	lis r4, data_805ED72C@ha /* 0x805ED72C@ha */
/* 805E5DF0  38 84 D7 2C */	addi r4, r4, data_805ED72C@l /* 0x805ED72C@l */
/* 805E5DF4  80 84 00 00 */	lwz r4, 0(r4)
/* 805E5DF8  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 805E5DFC  4B C8 0D 39 */	bl __mi__4cXyzCFRC3Vec
...
/* 805E5E3C  4B C8 18 39 */	bl cM_atan2s__Fff
...
/* 805E5E5C  4B C8 A7 AD */	bl cLib_addCalcAngleS2__FPssss
/* 805E5E60  39 61 00 30 */	addi r11, r1, 0x30
/* 805E5E64  4B D7 C3 C5 */	bl _restgpr_29
