...
/* 805EB5F0  4B D7 6B E9 */	bl _savegpr_28
/* 805EB5F4  7C 7D 1B 78 */	mr r29, r3
/* 805EB5F8  3C 60 80 5F */	lis r3, lit_3911@ha /* 0x805ED060@ha */
/* 805EB5FC  3B E3 D0 60 */	addi r31, r3, lit_3911@l /* 0x805ED060@l */
/* 805EB600  80 7D 0E 30 */	lwz r3, 0xe30(r29)
/* 805EB604  83 C3 00 04 */	lwz r30, 4(r3)
/* 805EB608  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EB60C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805EB610  38 80 00 00 */	li r4, 0
/* 805EB614  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 805EB618  38 DD 01 0C */	addi r6, r29, 0x10c
/* 805EB61C  4B BB 81 A9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805EB620  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EB624  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805EB628  80 9E 00 04 */	lwz r4, 4(r30)
/* 805EB62C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805EB630  4B BB 97 71 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 805EB634  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EB638  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805EB63C  80 9D 0E 34 */	lwz r4, 0xe34(r29)
/* 805EB640  80 84 00 04 */	lwz r4, 4(r4)
/* 805EB644  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805EB648  4B BB 97 59 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 805EB64C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EB650  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805EB654  80 9D 0E 38 */	lwz r4, 0xe38(r29)
/* 805EB658  80 84 00 04 */	lwz r4, 4(r4)
/* 805EB65C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805EB660  4B BB 97 41 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805EB67C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805EB680  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805EB684  80 9D 0E 3C */	lwz r4, 0xe3c(r29)
/* 805EB688  80 84 00 04 */	lwz r4, 4(r4)
/* 805EB68C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805EB690  4B BB 97 11 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_805EB694:
...
/* 805EB74C  4B A2 5A 75 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 805EB750  80 7D 0E 34 */	lwz r3, 0xe34(r29)
/* 805EB754  4B A2 25 71 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 805EB758  80 7D 0E 38 */	lwz r3, 0xe38(r29)
/* 805EB75C  4B A2 25 69 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 805EB77C  4B A2 25 49 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_805EB780:
...
/* 805EB7CC  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 805EB7D0  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 805EB7D4  4B A4 31 3D */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 805EB7D8  90 7D 0E 48 */	stw r3, 0xe48(r29)
/* 805EB7DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805EB7E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805EB7F4  4B A6 A7 29 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
/* 805EB7F8  7F 83 E3 78 */	mr r3, r28
/* 805EB7FC  80 9D 0E 48 */	lwz r4, 0xe48(r29)
/* 805EB800  80 BD 0E 38 */	lwz r5, 0xe38(r29)
/* 805EB804  4B A6 A7 19 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
...
/* 805EB82C  4B A6 A6 F1 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_805EB830:
...
/* 805EB85C  4B C8 4E E5 */	bl cLib_chaseF__FPfff
...
/* 805EB894  4B D7 69 91 */	bl _restgpr_28
