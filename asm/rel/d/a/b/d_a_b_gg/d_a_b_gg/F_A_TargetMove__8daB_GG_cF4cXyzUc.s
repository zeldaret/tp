...
/* 805E53EC  4B D7 CD EC */	b _savegpr_28
/* 805E53F0  7C 7D 1B 78 */	mr r29, r3
/* 805E53F4  7C 9E 23 78 */	mr r30, r4
/* 805E53F8  7C BC 2B 78 */	mr r28, r5
/* 805E53FC  3C 60 80 5F */	lis r3, lit_3911@ha
/* 805E5400  3B E3 D0 60 */	addi r31, r3, lit_3911@l
/* 805E5404  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 805E5408  4B C8 B7 FC */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 805E5444  4B D6 1F 58 */	b PSVECSquareDistance
...
/* 805E54B4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805E54B8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805E5524  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805E5528  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805E552C:
...
/* 805E5570  4B D6 10 40 */	b PSMTXInverse
/* 805E5574  38 61 00 24 */	addi r3, r1, 0x24
/* 805E5578  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805E557C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805E5580  4B D6 0F 30 */	b PSMTXCopy
/* 805E5584  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805E5588  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805E558C  7F C4 F3 78 */	mr r4, r30
/* 805E5590  7F C5 F3 78 */	mr r5, r30
/* 805E5594  4B D6 17 D8 */	b PSMTXMultVec
...
/* 805E55BC  3C 80 80 5F */	lis r4, out_pos@ha
/* 805E55C0  38 04 D7 74 */	addi r0, r4, out_pos@l
/* 805E55C4  7C 80 2A 14 */	add r4, r0, r5
/* 805E55C8  4B C8 B6 3C */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 805E55CC  7C 7F 1B 78 */	mr r31, r3
/* 805E55D0  7F C3 F3 78 */	mr r3, r30
/* 805E55D4  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 805E55D8  4B C8 B6 2C */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 805E5608  4B D7 CC 1C */	b _restgpr_28
