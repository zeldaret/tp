...
/* 805E303C  3C 80 80 5F */	lis r4, lit_3911@ha /* 0x805ED060@ha */
/* 805E3040  3B E4 D0 60 */	addi r31, r4, lit_3911@l /* 0x805ED060@l */
...
/* 805E3084  4B C8 48 D1 */	bl cM_rndF__Ff
...
/* 805E30E0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805E30E4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805E3108  3C 80 80 5F */	lis r4, data_805ED72C@ha /* 0x805ED72C@ha */
/* 805E310C  38 84 D7 2C */	addi r4, r4, data_805ED72C@l /* 0x805ED72C@l */
/* 805E3110  80 84 00 00 */	lwz r4, 0(r4)
/* 805E3114  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 805E3118  4B C8 3A 1D */	bl __mi__4cXyzCFRC3Vec
...
/* 805E3158  4B C8 45 1D */	bl cM_atan2s__Fff
...
/* 805E3170  4B C8 D4 99 */	bl cLib_addCalcAngleS2__FPssss
/* 805E3174  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 805E3178  3C 80 80 5F */	lis r4, data_805ED72C@ha /* 0x805ED72C@ha */
/* 805E317C  38 84 D7 2C */	addi r4, r4, data_805ED72C@l /* 0x805ED72C@l */
/* 805E3180  80 84 00 00 */	lwz r4, 0(r4)
/* 805E3184  4B C8 DA 81 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 805E31A0  4B C8 D4 69 */	bl cLib_addCalcAngleS2__FPssss
