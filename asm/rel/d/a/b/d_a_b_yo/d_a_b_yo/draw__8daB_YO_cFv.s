...
/* 8062F534  4B D3 2C 8D */	bl _savegpr_22
/* 8062F538  7C 7F 1B 78 */	mr r31, r3
/* 8062F53C  3C 60 80 64 */	lis r3, lit_3788@ha /* 0x806397F4@ha */
/* 8062F540  3B A3 97 F4 */	addi r29, r3, lit_3788@l /* 0x806397F4@l */
...
/* 8062F554  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8062F558  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8062F55C  38 80 00 10 */	li r4, 0x10
/* 8062F560  38 A1 00 14 */	addi r5, r1, 0x14
/* 8062F564  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8062F568  4B B7 42 5D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8062F56C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062F570  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8062F574  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 8062F578  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8062F57C  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8062F5AC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8062F5B0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8062F5B4  80 99 00 04 */	lwz r4, 4(r25)
/* 8062F5B8  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8062F5BC  4B B7 57 E5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8062F65C  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 8062F660  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 8062F6A0  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 8062F6A4  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 8062F6E0  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 8062F6E4  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 8062F760  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 8062F764  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 8062F7A0  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 8062F7A4  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 8062F7E0  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 8062F7E4  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 8062F838  4B 9D E4 8D */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8062F83C:
...
/* 8062F858  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8062F85C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8062F860  80 84 00 04 */	lwz r4, 4(r4)
/* 8062F864  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8062F868  4B B7 55 39 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8062F86C  80 7F 06 04 */	lwz r3, 0x604(r31)
/* 8062F870  4B 9D E4 55 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8062F874:
/* 8062F874  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8062F878  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_8062F8B4:
/* 8062F8B4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8062F8B8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8062F8BC  38 80 00 00 */	li r4, 0
/* 8062F8C0  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8062F8C4  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8062F8C8  4B B7 3E FD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 8062F90C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8062F910  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8062F914  80 98 00 04 */	lwz r4, 4(r24)
/* 8062F918  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8062F91C  4B B7 54 85 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8062F93C  4B 9D DD 9D */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_8062F940:
...
/* 8062F964  3C 60 80 64 */	lis r3, yo_material_draw@ha /* 0x80639B44@ha */
/* 8062F968  38 03 9B 44 */	addi r0, r3, yo_material_draw@l /* 0x80639B44@l */
...
/* 8062F9D0  4B 9E DA 5D */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 8062F9D4  7F 03 C3 78 */	mr r3, r24
/* 8062F9D8  4B 9D E2 ED */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 8062F9DC  7F 03 C3 78 */	mr r3, r24
/* 8062F9E0  4B A0 1F 6D */	bl entry__10daMirror_cFP8J3DModel
lbl_8062F9E4:
...
/* 8062FA0C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8062FA10  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8062FA14  80 96 00 04 */	lwz r4, 4(r22)
/* 8062FA18  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8062FA1C  4B B7 53 85 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8062FA3C  4B 9D DB AD */	bl entry__13mDoExt_btpAnmFP16J3DMaterialTables
...
/* 8062FA50  4B 9D DC 89 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 8062FA64  4B 9D DD 45 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 8062FA84  4B 9D DD 25 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_8062FA88:
/* 8062FA88  7F E3 FB 78 */	mr r3, r31
/* 8062FA8C  80 96 00 04 */	lwz r4, 4(r22)
/* 8062FA90  4B 9E D9 9D */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 8062FA94  80 7F 05 F4 */	lwz r3, 0x5f4(r31)
/* 8062FA98  4B 9E 17 29 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 8062FA9C  7E C3 B3 78 */	mr r3, r22
/* 8062FAA0  4B A0 1E AD */	bl entry__10daMirror_cFP8J3DModel
/* 8062FAA4  48 00 00 34 */	b lbl_8062FAD8
lbl_8062FAA8:
/* 8062FAA8  80 7F 05 F8 */	lwz r3, 0x5f8(r31)
/* 8062FAAC  82 C3 00 04 */	lwz r22, 4(r3)
/* 8062FAB0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8062FAB4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8062FAB8  80 96 00 04 */	lwz r4, 4(r22)
/* 8062FABC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8062FAC0  4B B7 52 E1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8062FAC4  7F E3 FB 78 */	mr r3, r31
/* 8062FAC8  80 96 00 04 */	lwz r4, 4(r22)
/* 8062FACC  4B 9E D9 61 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 8062FAD0  80 7F 05 F8 */	lwz r3, 0x5f8(r31)
/* 8062FAD4  4B 9E 16 ED */	bl entryDL__16mDoExt_McaMorfSOFv
lbl_8062FAD8:
...
/* 8062FB24  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 8062FB28  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 8062FB2C  4B 9F ED E5 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 8062FB50  3C 60 80 45 */	lis r3, mBlureFlag__13mDoGph_gInf_c+0x1@ha /* 0x80450BE5@ha */
/* 8062FB54  98 03 0B E5 */	stb r0, mBlureFlag__13mDoGph_gInf_c+0x1@l(r3)  /* 0x80450BE5@l */
/* 8062FB58  4B 9D 85 21 */	bl onBlure__13mDoGph_gInf_cFv
/* 8062FB5C  48 00 00 10 */	b lbl_8062FB6C
lbl_8062FB60:
/* 8062FB60  38 00 00 00 */	li r0, 0
/* 8062FB64  3C 60 80 45 */	lis r3, mBlureFlag__13mDoGph_gInf_c+0x0@ha /* 0x80450BE4@ha */
/* 8062FB68  98 03 0B E4 */	stb r0, mBlureFlag__13mDoGph_gInf_c+0x0@l(r3)  /* 0x80450BE4@l */
lbl_8062FB6C:
...
/* 8062FB7C  4B D3 26 91 */	bl _restgpr_22
