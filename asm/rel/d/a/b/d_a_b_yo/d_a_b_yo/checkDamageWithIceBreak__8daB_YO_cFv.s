...
/* 80634CFC  4B D2 D4 D1 */	bl _savegpr_25
/* 80634D00  7C 7F 1B 78 */	mr r31, r3
/* 80634D04  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80634D08  3B 84 61 C0 */	addi r28, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80634D0C  80 9C 5D AC */	lwz r4, 0x5dac(r28)
/* 80634D10  4B 9E 5A 01 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80634D14  7C 7B 1B 78 */	mr r27, r3
/* 80634D18  38 7F 12 AC */	addi r3, r31, 0x12ac
/* 80634D1C  4B A4 F5 A5 */	bl ChkAtHit__12dCcD_GObjInfFv
/* 80634D20  28 03 00 00 */	cmplwi r3, 0
/* 80634D24  41 82 00 C8 */	beq lbl_80634DEC
/* 80634D28  38 7F 12 AC */	addi r3, r31, 0x12ac
/* 80634D2C  4B A4 F6 2D */	bl GetAtHitObj__12dCcD_GObjInfFv
/* 80634D30  4B C2 ED 19 */	bl GetAc__8cCcD_ObjFv
...
/* 80634D84  4B 9E 4C 39 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80634D98  48 00 56 E9 */	bl setOperate__9daB_YOI_cFi
lbl_80634D9C:
...
/* 80634DB8  3C A0 80 64 */	lis r5, lit_6259@ha /* 0x806399B8@ha */
/* 80634DBC  C0 25 99 B8 */	lfs f1, lit_6259@l(r5)  /* 0x806399B8@l */
/* 80634DC0  3C A0 80 64 */	lis r5, lit_5343@ha /* 0x806398F8@ha */
/* 80634DC4  C0 45 98 F8 */	lfs f2, lit_5343@l(r5)  /* 0x806398F8@l */
...
/* 80634DF0  4B D2 D4 29 */	bl _restgpr_25
