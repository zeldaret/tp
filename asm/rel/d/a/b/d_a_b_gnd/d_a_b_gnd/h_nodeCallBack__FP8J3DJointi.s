...
/* 805F4DDC  4B D6 D3 FD */	bl _savegpr_28
/* 805F4DE0  2C 04 00 00 */	cmpwi r4, 0
/* 805F4DE4  40 82 01 38 */	bne lbl_805F4F1C
/* 805F4DE8  A3 A3 00 14 */	lhz r29, 0x14(r3)
/* 805F4DEC  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 805F4DF0  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 805F4E14  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 805F4E18  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 805F4E1C  80 84 00 00 */	lwz r4, 0(r4)
/* 805F4E20  4B D5 16 91 */	bl PSMTXCopy
...
lbl_805F4E34:
/* 805F4E34  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805F4E38  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805F4E50  4B A1 76 7D */	bl mDoMtx_ZrotM__FPA4_fs
...
lbl_805F4E68:
/* 805F4E68  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805F4E6C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805F4E84  4B A1 75 B1 */	bl mDoMtx_YrotM__FPA4_fs
...
lbl_805F4E9C:
/* 805F4E9C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805F4EA0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805F4EB4  4B A1 75 81 */	bl mDoMtx_YrotM__FPA4_fs
...
lbl_805F4ECC:
/* 805F4ECC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805F4ED0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805F4EE4  4B A1 75 51 */	bl mDoMtx_YrotM__FPA4_fs
lbl_805F4EE8:
/* 805F4EE8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805F4EEC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805F4F00  4B D5 15 B1 */	bl PSMTXCopy
/* 805F4F04  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805F4F08  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805F4F0C  80 63 00 00 */	lwz r3, 0(r3)
/* 805F4F10  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 805F4F14  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 805F4F18  4B D5 15 99 */	bl PSMTXCopy
lbl_805F4F1C:
/* 805F4F1C  38 60 00 01 */	li r3, 1
/* 805F4F20  39 61 00 20 */	addi r11, r1, 0x20
/* 805F4F24  4B D6 D3 01 */	bl _restgpr_28
