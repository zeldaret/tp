...
/* 805F5BF8  4B D6 C5 E5 */	bl _savegpr_29
/* 805F5BFC  3C 80 80 60 */	lis r4, lit_3815@ha /* 0x80602664@ha */
/* 805F5C00  3B E4 26 64 */	addi r31, r4, lit_3815@l /* 0x80602664@l */
...
/* 805F5C20  4B A8 20 49 */	bl __ct__11dBgS_LinChkFv
/* 805F5C24  3C 60 80 60 */	lis r3, __vt__8cM3dGPla@ha /* 0x80602F48@ha */
/* 805F5C28  38 03 2F 48 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80602F48@l */
/* 805F5C2C  90 01 00 60 */	stw r0, 0x60(r1)
/* 805F5C30  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805F5C34  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805F5C38  80 63 00 00 */	lwz r3, 0(r3)
/* 805F5C3C  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 805F5C40  4B A1 67 9D */	bl mDoMtx_YrotS__FPA4_fs
/* 805F5C44  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805F5C48  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805F5C4C  80 63 00 00 */	lwz r3, 0(r3)
/* 805F5C50  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 805F5C54  4B A1 67 49 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 805F5CD0  4B A8 20 95 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 805F5CD4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805F5CD8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805F5CDC  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 805F5CE0  7F A3 EB 78 */	mr r3, r29
/* 805F5CE4  38 81 00 64 */	addi r4, r1, 0x64
/* 805F5CE8  4B A7 E6 CD */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 805F5D6C  4B A8 1F F9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 805F5D70  7F A3 EB 78 */	mr r3, r29
/* 805F5D74  38 81 00 64 */	addi r4, r1, 0x64
/* 805F5D78  4B A7 E6 3D */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 805F5D90  4B A7 E9 B5 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 805F5D94  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 805F5D98  41 82 01 28 */	beq lbl_805F5EC0
/* 805F5D9C  C0 21 00 54 */	lfs f1, 0x54(r1)
/* 805F5DA0  4B C7 24 45 */	bl cBgW_CheckBGround__Ff
...
/* 805F5E00  4B A8 1F 65 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 805F5E04  7F A3 EB 78 */	mr r3, r29
/* 805F5E08  38 81 00 64 */	addi r4, r1, 0x64
/* 805F5E0C  4B A7 E5 A9 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
lbl_805F5E34:
/* 805F5E34  3C 60 80 60 */	lis r3, __vt__8cM3dGPla@ha /* 0x80602F48@ha */
/* 805F5E38  38 03 2F 48 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80602F48@l */
/* 805F5E3C  90 01 00 60 */	stw r0, 0x60(r1)
/* 805F5E40  38 61 00 64 */	addi r3, r1, 0x64
/* 805F5E44  38 80 FF FF */	li r4, -1
/* 805F5E48  4B A8 1E 95 */	bl __dt__11dBgS_LinChkFv
...
/* 805F5E60  4B C7 0C D5 */	bl __mi__4cXyzCFRC3Vec
...
/* 805F5E7C  4B C7 17 F9 */	bl cM_atan2s__Fff
...
/* 805F5EA0  3C 60 80 60 */	lis r3, __vt__8cM3dGPla@ha /* 0x80602F48@ha */
/* 805F5EA4  38 03 2F 48 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80602F48@l */
/* 805F5EA8  90 01 00 60 */	stw r0, 0x60(r1)
/* 805F5EAC  38 61 00 64 */	addi r3, r1, 0x64
/* 805F5EB0  38 80 FF FF */	li r4, -1
/* 805F5EB4  4B A8 1E 29 */	bl __dt__11dBgS_LinChkFv
/* 805F5EB8  38 60 00 01 */	li r3, 1
/* 805F5EBC  48 00 00 20 */	b lbl_805F5EDC
lbl_805F5EC0:
/* 805F5EC0  3C 60 80 60 */	lis r3, __vt__8cM3dGPla@ha /* 0x80602F48@ha */
/* 805F5EC4  38 03 2F 48 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80602F48@l */
/* 805F5EC8  90 01 00 60 */	stw r0, 0x60(r1)
/* 805F5ECC  38 61 00 64 */	addi r3, r1, 0x64
/* 805F5ED0  38 80 FF FF */	li r4, -1
/* 805F5ED4  4B A8 1E 09 */	bl __dt__11dBgS_LinChkFv
/* 805F5ED8  38 60 00 00 */	li r3, 0
lbl_805F5EDC:
/* 805F5EDC  39 61 00 F0 */	addi r11, r1, 0xf0
/* 805F5EE0  4B D6 C3 49 */	bl _restgpr_29
