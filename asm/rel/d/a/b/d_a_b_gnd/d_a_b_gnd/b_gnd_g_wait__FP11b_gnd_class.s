...
/* 805F7A28  4B D6 A7 AD */	bl _savegpr_27
/* 805F7A2C  7C 7B 1B 78 */	mr r27, r3
/* 805F7A30  3C 60 80 60 */	lis r3, lit_3815@ha /* 0x80602664@ha */
/* 805F7A34  3B A3 26 64 */	addi r29, r3, lit_3815@l /* 0x80602664@l */
...
/* 805F7A48  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 805F7A4C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 805F7A50  38 81 00 0C */	addi r4, r1, 0xc
/* 805F7A54  4B A2 1D A5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 805F7A58  7C 7E 1B 78 */	mr r30, r3
/* 805F7A5C  38 00 02 E4 */	li r0, 0x2e4
/* 805F7A60  B0 01 00 08 */	sth r0, 8(r1)
/* 805F7A64  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 805F7A68  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 805F7A6C  38 81 00 08 */	addi r4, r1, 8
/* 805F7A70  4B A2 1D 89 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 805F7AE0  3C 60 80 60 */	lis r3, lit_5308@ha /* 0x80602A6C@ha */
/* 805F7AE4  38 63 2A 6C */	addi r3, r3, lit_5308@l /* 0x80602A6C@l */
...
/* 805F7B1C  4B C6 FE 39 */	bl cM_rndF__Ff
...
/* 805F7B70  4B C6 FD E5 */	bl cM_rndF__Ff
...
/* 805F7BAC  4B C6 FD A9 */	bl cM_rndF__Ff
...
/* 805F7C5C  4B C6 FC F9 */	bl cM_rndF__Ff
...
/* 805F7CCC  4B C6 FC 89 */	bl cM_rndF__Ff
...
/* 805F7DC4  4B C7 7C 79 */	bl cLib_addCalc2__FPffff
...
/* 805F7DF4  4B C7 88 15 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805F7E24  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 805F7E28  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 805F7E74  4B D6 A3 AD */	bl _restgpr_27
