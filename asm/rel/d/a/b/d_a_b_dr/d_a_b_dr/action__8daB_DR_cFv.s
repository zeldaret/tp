...
/* 805C3CC0  4B D9 E5 1D */	bl _savegpr_29
/* 805C3CC4  7C 7E 1B 78 */	mr r30, r3
/* 805C3CC8  3C 80 80 5C */	lis r4, lit_3800@ha /* 0x805C6C74@ha */
/* 805C3CCC  3B E4 6C 74 */	addi r31, r4, lit_3800@l /* 0x805C6C74@l */
...
/* 805C3CF4  3C 60 80 5C */	lis r3, lit_7648@ha /* 0x805C776C@ha */
/* 805C3CF8  38 63 77 6C */	addi r3, r3, lit_7648@l /* 0x805C776C@l */
...
/* 805C3E28  4B D6 46 05 */	bl checkPass__12J3DFrameCtrlFf
...
/* 805C3E48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C3E4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C3E60  4B AA BB C5 */	bl StartShock__12dVibration_cFii4cXyz
lbl_805C3E64:
/* 805C3E64  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 805C3E68  38 63 00 0C */	addi r3, r3, 0xc
/* 805C3E6C  C0 3F 00 08 */	lfs f1, 8(r31)
/* 805C3E70  4B D6 45 BD */	bl checkPass__12J3DFrameCtrlFf
...
/* 805C3E98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C3E9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C3EB0  4B AA BC 61 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 805C3ECC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C3ED0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805C3ED4  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 805C3ED8  38 80 00 1F */	li r4, 0x1f
/* 805C3EDC  4B AA BE B9 */	bl StopQuake__12dVibration_cFi
lbl_805C3EE0:
/* 805C3EE0  7F C3 F3 78 */	mr r3, r30
/* 805C3EE4  4B FF 78 05 */	bl setSe__8daB_DR_cFv
/* 805C3EE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C3EEC  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C3F68  4B CA C6 A1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805C3F7C  4B CA C6 8D */	bl cLib_addCalcAngleS2__FPssss
lbl_805C3F80:
...
/* 805C4024  4B CA C5 E5 */	bl cLib_addCalcAngleS2__FPssss
/* 805C4028  7F C3 F3 78 */	mr r3, r30
/* 805C402C  38 9E 0A 08 */	addi r4, r30, 0xa08
/* 805C4030  4B A5 66 9D */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 805C4064  4B AB 30 B1 */	bl SetGroundUpY__9dBgS_AcchFf
/* 805C4068  38 7E 08 30 */	addi r3, r30, 0x830
/* 805C406C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C4070  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805C4074  38 84 0F 38 */	addi r4, r4, 0xf38
/* 805C4078  4B AB 2A 35 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 805C407C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805C4080  7C 03 07 74 */	extsb r3, r0
/* 805C4084  4B A6 8F E9 */	bl dComIfGp_getReverb__Fi
/* 805C4088  7C 65 1B 78 */	mr r5, r3
/* 805C408C  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 805C4090  38 80 00 00 */	li r4, 0
/* 805C4094  4B A4 D0 1D */	bl play__16mDoExt_McaMorfSOFUlSc
/* 805C4098  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805C409C  7C 03 07 74 */	extsb r3, r0
/* 805C40A0  4B A6 8F CD */	bl dComIfGp_getReverb__Fi
...
/* 805C40C4  4B A4 93 65 */	bl play__14mDoExt_baseAnmFv
/* 805C40C8  39 61 00 40 */	addi r11, r1, 0x40
/* 805C40CC  4B D9 E1 5D */	bl _restgpr_29
