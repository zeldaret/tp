...
/* 805C668C  4B AB D3 9C */	b __ct__12dCcD_GObjInfFv
/* 805C6690  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 805C6694  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 805C6698  90 1F 01 20 */	stw r0, 0x120(r31)
/* 805C669C  3C 60 80 5C */	lis r3, __vt__8cM3dGAab@ha
/* 805C66A0  38 03 78 70 */	addi r0, r3, __vt__8cM3dGAab@l
/* 805C66A4  90 1F 01 1C */	stw r0, 0x11c(r31)
/* 805C66A8  3C 60 80 5C */	lis r3, __vt__8cM3dGCyl@ha
/* 805C66AC  38 03 78 64 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 805C66B0  90 1F 01 38 */	stw r0, 0x138(r31)
/* 805C66B4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 805C66B8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 805C66BC  90 7F 01 20 */	stw r3, 0x120(r31)
/* 805C66C0  38 03 00 58 */	addi r0, r3, 0x58
/* 805C66C4  90 1F 01 38 */	stw r0, 0x138(r31)
/* 805C66C8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 805C66CC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
