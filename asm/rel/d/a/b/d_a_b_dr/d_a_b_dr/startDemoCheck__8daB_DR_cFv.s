...
/* 805C2BF8  4B D9 F5 E5 */	bl _savegpr_29
/* 805C2BFC  7C 7D 1B 78 */	mr r29, r3
/* 805C2C00  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C2C04  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C2C3C  4B A5 8C CD */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 805C2C88  4B B9 E8 49 */	bl Stop__9dCamera_cFv
/* 805C2C8C  38 7F 02 48 */	addi r3, r31, 0x248
/* 805C2C90  38 80 00 03 */	li r4, 3
/* 805C2C94  4B BA 03 79 */	bl SetTrimSize__9dCamera_cFl
/* 805C2C98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C2C9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C2CBC  4B D9 F5 6D */	bl _restgpr_29
