...
/* 805C2CE0  4B D9 F4 F5 */	bl _savegpr_27
/* 805C2CE4  7C 7B 1B 78 */	mr r27, r3
/* 805C2CE8  3C 80 80 5C */	lis r4, lit_3800@ha /* 0x805C6C74@ha */
/* 805C2CEC  3B C4 6C 74 */	addi r30, r4, lit_3800@l /* 0x805C6C74@l */
/* 805C2CF0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C2CF4  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C2D1C  3C 80 80 5C */	lis r4, lit_7387@ha /* 0x805C7704@ha */
/* 805C2D20  38 84 77 04 */	addi r4, r4, lit_7387@l /* 0x805C7704@l */
...
lbl_805C2D80:
/* 805C2D80  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805C2D84  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805C2D9C  4B A4 96 41 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805C2E00  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805C2E04  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805C2E1C  4B A4 95 C1 */	bl mDoMtx_YrotS__FPA4_fs
...
lbl_805C2EA4:
/* 805C2EA4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805C2EA8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805C2EC0  4B A4 95 1D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805C2F10  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805C2F14  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805C2F2C  4B A4 94 B1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805C2FAC  4B B9 E5 01 */	bl Start__9dCamera_cFv
/* 805C2FB0  38 7D 02 48 */	addi r3, r29, 0x248
/* 805C2FB4  38 80 00 00 */	li r4, 0
/* 805C2FB8  4B BA 00 55 */	bl SetTrimSize__9dCamera_cFl
/* 805C2FBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C2FC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805C2FC4  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 805C2FC8  4B A7 F4 A1 */	bl reset__14dEvt_control_cFv
/* 805C2FCC  88 9B 07 EC */	lbz r4, 0x7ec(r27)
/* 805C2FD0  28 04 00 FF */	cmplwi r4, 0xff
/* 805C2FD4  41 82 00 18 */	beq lbl_805C2FEC
/* 805C2FD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C2FDC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805C2FE0  88 1B 04 BA */	lbz r0, 0x4ba(r27)
/* 805C2FE4  7C 05 07 74 */	extsb r5, r0
/* 805C2FE8  4B A7 22 19 */	bl onSwitch__10dSv_info_cFii
lbl_805C2FEC:
...
/* 805C30CC  4B CA C9 71 */	bl cLib_addCalc2__FPffff
lbl_805C30D0:
...
/* 805C3198  4B A6 A7 B5 */	bl dComIfGs_onZoneSwitch__Fii
...
/* 805C31E0  4B CA C8 5D */	bl cLib_addCalc2__FPffff
lbl_805C31E4:
...
/* 805C3280  4B B9 E2 2D */	bl Start__9dCamera_cFv
/* 805C3284  38 7D 02 48 */	addi r3, r29, 0x248
/* 805C3288  38 80 00 00 */	li r4, 0
/* 805C328C  4B B9 FD 81 */	bl SetTrimSize__9dCamera_cFl
/* 805C3290  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C3294  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805C3298  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 805C329C  4B A7 F1 CD */	bl reset__14dEvt_control_cFv
...
lbl_805C3358:
/* 805C3358  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805C335C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805C3370  4B A4 90 6D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805C3430  4B BB D6 79 */	bl Set__9dCamera_cF4cXyz4cXyz
lbl_805C3434:
...
/* 805C344C  4B D6 4F E1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 805C34E4  4B A4 98 81 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 805C34E8  38 7B 04 E4 */	addi r3, r27, 0x4e4
/* 805C34EC  4B A4 9A 59 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 805C34F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805C34F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805C34F8  7C 64 1B 78 */	mr r4, r3
/* 805C34FC  4B D8 30 B5 */	bl PSMTXInverse
/* 805C3500  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805C3504  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805C3508  38 9B 05 38 */	addi r4, r27, 0x538
/* 805C350C  38 A1 00 3C */	addi r5, r1, 0x3c
/* 805C3510  4B D8 38 5D */	bl PSMTXMultVec
...
/* 805C3544  4B D9 EC DD */	bl _restgpr_27
