...
/* 805C0F10  4B DA 12 CD */	bl _savegpr_29
/* 805C0F14  7C 7D 1B 78 */	mr r29, r3
/* 805C0F18  3C 80 80 5C */	lis r4, lit_3800@ha /* 0x805C6C74@ha */
/* 805C0F1C  3B E4 6C 74 */	addi r31, r4, lit_3800@l /* 0x805C6C74@l */
/* 805C0F20  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C0F24  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C0F3C  3C 80 80 5C */	lis r4, lit_6776@ha /* 0x805C76A8@ha */
/* 805C0F40  38 84 76 A8 */	addi r4, r4, lit_6776@l /* 0x805C76A8@l */
...
/* 805C0F74  4B CA 68 F9 */	bl cM_rnd__Fv
...
/* 805C0FB0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 805C0FB4  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 805C0FFC  4B D8 60 95 */	bl PSVECAdd
...
/* 805C1028  4B CA 5B 0D */	bl __mi__4cXyzCFRC3Vec
...
/* 805C1050  4B CA 60 D9 */	bl atan2sX_Z__4cXyzCFv
...
/* 805C1100  4B CA 5A 35 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C1120  4B D8 60 19 */	bl PSVECSquareMag
...
/* 805C1190  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805C1194  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805C1200  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805C1204  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805C1208:
...
lbl_805C1258:
/* 805C1258  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 805C125C  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 805C129C  4B D8 5D F5 */	bl PSVECAdd
...
/* 805C12EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C12F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C1314  4B CA 58 21 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C1358  3C 60 80 5C */	lis r3, l_HIO@ha /* 0x805C790C@ha */
/* 805C135C  38 63 79 0C */	addi r3, r3, l_HIO@l /* 0x805C790C@l */
...
/* 805C138C  4B CA 57 A9 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C13B4  4B D8 5D 85 */	bl PSVECSquareMag
...
/* 805C1424  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805C1428  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805C1494  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805C1498  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805C149C:
...
/* 805C1500  4B CA 56 35 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C1528  4B D8 5C 11 */	bl PSVECSquareMag
...
/* 805C1598  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805C159C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805C1608  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805C160C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805C1610:
...
/* 805C166C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 805C1670  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 805C16B0  4B D8 59 E1 */	bl PSVECAdd
...
/* 805C16FC  4B CA 54 39 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C1890  4B CA E1 AD */	bl cLib_addCalc2__FPffff
...
/* 805C1954  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 805C1958  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 805C1998  4B D8 56 F9 */	bl PSVECAdd
...
/* 805C1A2C  4B CA E0 11 */	bl cLib_addCalc2__FPffff
...
/* 805C1B14  4B CA 50 21 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C1B3C  4B D8 55 FD */	bl PSVECSquareMag
...
/* 805C1BAC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805C1BB0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805C1C1C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805C1C20  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805C1C24:
...
/* 805C1C94  4B CA 4E A1 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C1CB4  4B CA 54 75 */	bl atan2sX_Z__4cXyzCFv
...
/* 805C1CC8  4B CA E9 41 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805C1CDC  4B CA E9 2D */	bl cLib_addCalcAngleS2__FPssss
...
/* 805C1CF0  4B CA E9 19 */	bl cLib_addCalcAngleS2__FPssss
/* 805C1CF4  38 61 00 78 */	addi r3, r1, 0x78
/* 805C1CF8  4B CA 54 59 */	bl atan2sY_XZ__4cXyzCFv
...
/* 805C1D0C  4B CA E8 FD */	bl cLib_addCalcAngleS2__FPssss
...
/* 805C1D20  4B CA E8 E9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805C1D50  4B CA DC ED */	bl cLib_addCalc2__FPffff
lbl_805C1D54:
...
lbl_805C1D68:
/* 805C1D68  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805C1D6C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805C1D70  80 63 00 00 */	lwz r3, 0(r3)
/* 805C1D74  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 805C1D78  4B A4 A6 65 */	bl mDoMtx_YrotS__FPA4_fs
/* 805C1D7C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805C1D80  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805C1D84  80 63 00 00 */	lwz r3, 0(r3)
/* 805C1D88  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 805C1D8C  4B A4 A6 11 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 805C1DAC  4B CA F1 41 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 805C1DC0  4B CA DC 7D */	bl cLib_addCalc2__FPffff
...
/* 805C1DD4  4B CA DC AD */	bl cLib_addCalc0__FPfff
