...
/* 805C56B4  4B D9 CB 25 */	bl _savegpr_28
...
lbl_805C56D0:
/* 805C56D0  3C 60 80 5C */	lis r3, d_a_b_dr__stringBase0@ha /* 0x805C7240@ha */
/* 805C56D4  38 63 72 40 */	addi r3, r3, d_a_b_dr__stringBase0@l /* 0x805C7240@l */
/* 805C56D8  88 1E 07 EB */	lbz r0, 0x7eb(r30)
/* 805C56DC  54 00 10 3A */	slwi r0, r0, 2
/* 805C56E0  3C 80 80 5C */	lis r4, mPartDt@ha /* 0x805C77B4@ha */
/* 805C56E4  38 84 77 B4 */	addi r4, r4, mPartDt@l /* 0x805C77B4@l */
/* 805C56E8  7C 84 00 2E */	lwzx r4, r4, r0
/* 805C56EC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C56F0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805C56F4  3C A5 00 02 */	addis r5, r5, 2
/* 805C56F8  38 C0 00 80 */	li r6, 0x80
/* 805C56FC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 805C5700  4B A7 6B ED */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C5710  4B A4 F5 45 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_805C5734:
/* 805C5734  3C 60 80 5C */	lis r3, d_a_b_dr__stringBase0@ha /* 0x805C7240@ha */
/* 805C5738  38 63 72 40 */	addi r3, r3, d_a_b_dr__stringBase0@l /* 0x805C7240@l */
/* 805C573C  38 80 00 49 */	li r4, 0x49
/* 805C5740  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805C5744  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805C5758  4B A7 6B 95 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 805C575C  7C 7C 1B 78 */	mr r28, r3
/* 805C5760  38 60 00 58 */	li r3, 0x58
/* 805C5764  4B D0 94 E9 */	bl __nw__FUl
/* 805C5768  7C 7D 1B 79 */	or. r29, r3, r3
/* 805C576C  41 82 00 68 */	beq lbl_805C57D4
/* 805C5770  3C 60 80 5C */	lis r3, d_a_b_dr__stringBase0@ha /* 0x805C7240@ha */
/* 805C5774  38 63 72 40 */	addi r3, r3, d_a_b_dr__stringBase0@l /* 0x805C7240@l */
/* 805C5778  38 80 00 2F */	li r4, 0x2f
/* 805C577C  7F E5 FB 78 */	mr r5, r31
/* 805C5780  38 C0 00 80 */	li r6, 0x80
/* 805C5784  4B A7 6B 69 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C57BC  3D 20 80 5C */	lis r9, lit_4012@ha /* 0x805C6CA8@ha */
/* 805C57C0  C0 29 6C A8 */	lfs f1, lit_4012@l(r9)  /* 0x805C6CA8@l */
/* 805C57C4  39 20 00 00 */	li r9, 0
/* 805C57C8  39 40 FF FF */	li r10, -1
/* 805C57CC  4B A4 B0 05 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 805C57FC  4B D0 94 51 */	bl __nw__FUl
/* 805C5800  7C 7D 1B 79 */	or. r29, r3, r3
/* 805C5804  41 82 00 20 */	beq lbl_805C5824
/* 805C5808  3C 80 80 5C */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x805C78A0@ha */
/* 805C580C  38 04 78 A0 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x805C78A0@l */
/* 805C5810  90 1D 00 00 */	stw r0, 0(r29)
/* 805C5814  38 80 00 00 */	li r4, 0
/* 805C5818  4B D6 2B E5 */	bl init__12J3DFrameCtrlFs
...
lbl_805C583C:
/* 805C583C  3C 60 80 5C */	lis r3, d_a_b_dr__stringBase0@ha /* 0x805C7240@ha */
/* 805C5840  38 63 72 40 */	addi r3, r3, d_a_b_dr__stringBase0@l /* 0x805C7240@l */
/* 805C5844  38 80 00 51 */	li r4, 0x51
/* 805C5848  7F E5 FB 78 */	mr r5, r31
/* 805C584C  38 C0 00 80 */	li r6, 0x80
/* 805C5850  4B A7 6A 9D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C5874  3D 00 80 5C */	lis r8, lit_4012@ha /* 0x805C6CA8@ha */
/* 805C5878  C0 28 6C A8 */	lfs f1, lit_4012@l(r8)  /* 0x805C6CA8@l */
/* 805C587C  39 00 00 00 */	li r8, 0
/* 805C5880  39 20 FF FF */	li r9, -1
/* 805C5884  4B A4 7E 89 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 805C58B0  3C 60 80 5C */	lis r3, JointCallBack__8daB_DR_cFP8J3DJointi@ha /* 0x805BB120@ha */
/* 805C58B4  38 83 B1 20 */	addi r4, r3, JointCallBack__8daB_DR_cFP8J3DJointi@l /* 0x805BB120@l */
...
/* 805C58F8  4B D9 C9 2D */	bl _restgpr_28
