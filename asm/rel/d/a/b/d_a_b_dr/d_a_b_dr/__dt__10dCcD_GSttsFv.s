...
/* 805C6A08  3C 60 80 5C */	lis r3, __vt__10dCcD_GStts@ha /* 0x805C784C@ha */
/* 805C6A0C  38 03 78 4C */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x805C784C@l */
/* 805C6A10  90 1F 00 00 */	stw r0, 0(r31)
/* 805C6A14  41 82 00 10 */	beq lbl_805C6A24
/* 805C6A18  3C 60 80 5C */	lis r3, __vt__10cCcD_GStts@ha /* 0x805C7840@ha */
/* 805C6A1C  38 03 78 40 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x805C7840@l */
...
/* 805C6A30  4B D0 83 0D */	bl __dl__FPv
lbl_805C6A34:
