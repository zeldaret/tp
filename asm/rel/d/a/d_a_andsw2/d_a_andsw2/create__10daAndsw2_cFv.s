...
/* 804D6158  4B B4 2A 0D */	bl __ct__10fopAc_ac_cFv
lbl_804D615C:
...
/* 804D617C  3C 60 80 4D */	lis r3, lit_3821@ha /* 0x804D6AC8@ha */
/* 804D6180  38 63 6A C8 */	addi r3, r3, lit_3821@l /* 0x804D6AC8@l */
...
/* 804D619C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D61A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D61A4  7F E4 FB 78 */	mr r4, r31
/* 804D61A8  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 804D61AC  7C 05 07 74 */	extsb r5, r0
/* 804D61B0  4B B5 F1 B1 */	bl isSwitch__10dSv_info_cCFii
...
/* 804D61DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D61E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D61E4  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 804D61E8  7F C4 F3 78 */	mr r4, r30
/* 804D61EC  4B B7 14 AD */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
lbl_804D620C:
/* 804D620C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D6210  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D6214  7F E4 FB 78 */	mr r4, r31
/* 804D6218  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 804D621C  7C 05 07 74 */	extsb r5, r0
/* 804D6220  4B B5 F1 41 */	bl isSwitch__10dSv_info_cCFii
...
/* 804D624C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D6250  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D6254  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 804D6258  7F C4 F3 78 */	mr r4, r30
/* 804D625C  4B B7 14 3D */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
/* 804D6270  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D6274  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D6278  7F E4 FB 78 */	mr r4, r31
/* 804D627C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 804D6280  7C 05 07 74 */	extsb r5, r0
/* 804D6284  4B B5 F0 DD */	bl isSwitch__10dSv_info_cCFii
...
/* 804D62B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D62B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D62B8  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 804D62BC  7F C4 F3 78 */	mr r4, r30
/* 804D62C0  4B B7 13 D9 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
/* 804D62D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D62D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D62DC  7F E4 FB 78 */	mr r4, r31
/* 804D62E0  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 804D62E4  7C 05 07 74 */	extsb r5, r0
/* 804D62E8  4B B5 F0 79 */	bl isSwitch__10dSv_info_cCFii
...
/* 804D6314  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D6318  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D631C  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 804D6320  7F C4 F3 78 */	mr r4, r30
/* 804D6324  4B B7 13 75 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
/* 804D6350  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D6354  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D6358  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 804D635C  7F C4 F3 78 */	mr r4, r30
/* 804D6360  4B B7 13 39 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
