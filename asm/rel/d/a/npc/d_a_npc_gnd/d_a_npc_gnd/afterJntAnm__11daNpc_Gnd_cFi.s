...
/* 809BC184  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809BC188  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809BC18C  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 809BC190  7C 00 00 D0 */	neg r0, r0
/* 809BC194  7C 04 07 34 */	extsh r4, r0
/* 809BC198  4B 65 02 9D */	bl mDoMtx_YrotM__FPA4_fs
/* 809BC19C  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 809BC1A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809BC1A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809BC1A8  4B 65 03 25 */	bl mDoMtx_ZrotM__FPA4_fs
/* 809BC1AC  48 00 00 34 */	b lbl_809BC1E0
lbl_809BC1B0:
/* 809BC1B0  2C 04 00 04 */	cmpwi r4, 4
/* 809BC1B4  40 82 00 2C */	bne lbl_809BC1E0
/* 809BC1B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809BC1BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809BC1C0  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 809BC1C4  7C 00 00 D0 */	neg r0, r0
/* 809BC1C8  7C 04 07 34 */	extsh r4, r0
/* 809BC1CC  4B 65 02 69 */	bl mDoMtx_YrotM__FPA4_fs
/* 809BC1D0  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 809BC1D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809BC1D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809BC1DC  4B 65 02 F1 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_809BC1E0:
