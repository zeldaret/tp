...
/* 809BB62C  3C 60 80 9C */	lis r3, __vt__11daNpc_Gnd_c@ha /* 0x809BE770@ha */
/* 809BB630  38 03 E7 70 */	addi r0, r3, __vt__11daNpc_Gnd_c@l /* 0x809BE770@l */
...
/* 809BB648  4B 65 5C C9 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_809BB64C:
/* 809BB64C  7F C3 F3 78 */	mr r3, r30
/* 809BB650  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 809BB654  54 00 10 3A */	slwi r0, r0, 2
/* 809BB658  3C 80 80 9C */	lis r4, l_loadResPtrnList@ha /* 0x809BE5E0@ha */
/* 809BB65C  38 84 E5 E0 */	addi r4, r4, l_loadResPtrnList@l /* 0x809BE5E0@l */
/* 809BB660  7C 84 00 2E */	lwzx r4, r4, r0
/* 809BB664  3C A0 80 9C */	lis r5, l_resNameList@ha /* 0x809BE5D4@ha */
/* 809BB668  38 A5 E5 D4 */	addi r5, r5, l_resNameList@l /* 0x809BE5D4@l */
/* 809BB66C  4B 78 CE 41 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 809BB670  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 809BB674  41 82 00 84 */	beq lbl_809BB6F8
/* 809BB678  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 809BB67C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 809BB69C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 809BB6A0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 809BB6B8  3C 60 80 9C */	lis r3, __vt__8cM3dGCyl@ha /* 0x809BE764@ha */
/* 809BB6BC  38 03 E7 64 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x809BE764@l */
/* 809BB6C0  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_809BB6C4:
/* 809BB6C4  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 809BB6C8  41 82 00 24 */	beq lbl_809BB6EC
/* 809BB6CC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 809BB6D0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 809BB6D4  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 809BB6D8  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 809BB6DC  41 82 00 10 */	beq lbl_809BB6EC
/* 809BB6E0  3C 60 80 9C */	lis r3, __vt__8cM3dGAab@ha /* 0x809BE758@ha */
/* 809BB6E4  38 03 E7 58 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809BE758@l */
/* 809BB6E8  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_809BB6EC:
/* 809BB6EC  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 809BB6F0  38 80 00 00 */	li r4, 0
/* 809BB6F4  4B 6C 89 F1 */	bl __dt__12dCcD_GObjInfFv
lbl_809BB6F8:
...
/* 809BB710  4B 91 36 2D */	bl __dl__FPv
lbl_809BB714:
