...
/* 80A08A78  4B 95 97 65 */	bl _savegpr_29
/* 80A08A7C  7C 7E 1B 78 */	mr r30, r3
/* 80A08A80  7C 9F 23 78 */	mr r31, r4
/* 80A08A84  1F BF 00 0C */	mulli r29, r31, 0xc
/* 80A08A88  3C 80 80 A1 */	lis r4, l_btpGetParamList@ha /* 0x80A0C61C@ha */
/* 80A08A8C  38 A4 C6 1C */	addi r5, r4, l_btpGetParamList@l /* 0x80A0C61C@l */
/* 80A08A90  7C 85 EA 14 */	add r4, r5, r29
/* 80A08A94  80 04 00 08 */	lwz r0, 8(r4)
/* 80A08A98  54 00 10 3A */	slwi r0, r0, 2
/* 80A08A9C  3C 80 80 A1 */	lis r4, l_arcNames@ha /* 0x80A0C6C4@ha */
/* 80A08AA0  38 84 C6 C4 */	addi r4, r4, l_arcNames@l /* 0x80A0C6C4@l */
/* 80A08AA4  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A08AA8  7C A5 E8 2E */	lwzx r5, r5, r29
/* 80A08AAC  4B 74 A0 BD */	bl getTexPtrnAnmP__8daNpcF_cFPci
/* 80A08AB0  7C 64 1B 79 */	or. r4, r3, r3
/* 80A08AB4  3C 60 80 A1 */	lis r3, l_btpGetParamList@ha /* 0x80A0C61C@ha */
/* 80A08AB8  38 03 C6 1C */	addi r0, r3, l_btpGetParamList@l /* 0x80A0C61C@l */
...
/* 80A08AF0  3C E0 80 A1 */	lis r7, lit_4248@ha /* 0x80A0C2F0@ha */
/* 80A08AF4  C0 27 C2 F0 */	lfs f1, lit_4248@l(r7)  /* 0x80A0C2F0@l */
/* 80A08AF8  4B 74 A1 CD */	bl setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 80A08B34  4B 95 96 F5 */	bl _restgpr_29
