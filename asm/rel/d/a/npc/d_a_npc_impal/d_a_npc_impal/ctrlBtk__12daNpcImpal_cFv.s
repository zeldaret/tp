...
/* 80A0B3A0  3C 80 80 A1 */	lis r4, l_btkGetParamList@ha /* 0x80A0C694@ha */
/* 80A0B3A4  38 A4 C6 94 */	addi r5, r4, l_btkGetParamList@l /* 0x80A0C694@l */
/* 80A0B3A8  80 05 00 08 */	lwz r0, 8(r5)
/* 80A0B3AC  54 00 10 3A */	slwi r0, r0, 2
/* 80A0B3B0  3C 80 80 A1 */	lis r4, l_arcNames@ha /* 0x80A0C6C4@ha */
/* 80A0B3B4  38 84 C6 C4 */	addi r4, r4, l_arcNames@l /* 0x80A0C6C4@l */
/* 80A0B3B8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A0B3BC  80 A5 00 00 */	lwz r5, 0(r5)
/* 80A0B3C0  4B 74 77 E5 */	bl getTexSRTKeyAnmP__8daNpcF_cFPci
/* 80A0B3C4  80 1F 05 B4 */	lwz r0, 0x5b4(r31)
/* 80A0B3C8  7C 03 00 40 */	cmplw r3, r0
/* 80A0B3CC  40 82 00 6C */	bne lbl_80A0B438
/* 80A0B3D0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80A0B3D4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80A0B3D8  A8 9F 08 FE */	lha r4, 0x8fe(r31)
/* 80A0B3DC  48 00 05 79 */	bl func_80A0B954
/* 80A0B3E0  3C 60 80 A1 */	lis r3, lit_4889@ha /* 0x80A0C48C@ha */
/* 80A0B3E4  C0 43 C4 8C */	lfs f2, lit_4889@l(r3)  /* 0x80A0C48C@l */
/* 80A0B3E8  3C 60 80 A1 */	lis r3, lit_5328@ha /* 0x80A0C4B4@ha */
/* 80A0B3EC  C0 03 C4 B4 */	lfs f0, lit_5328@l(r3)  /* 0x80A0C4B4@l */
...
/* 80A0B400  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80A0B404  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80A0B408  A8 9F 08 FC */	lha r4, 0x8fc(r31)
/* 80A0B40C  48 00 05 49 */	bl func_80A0B954
/* 80A0B410  3C 60 80 A1 */	lis r3, lit_5328@ha /* 0x80A0C4B4@ha */
/* 80A0B414  C0 03 C4 B4 */	lfs f0, lit_5328@l(r3)  /* 0x80A0C4B4@l */
