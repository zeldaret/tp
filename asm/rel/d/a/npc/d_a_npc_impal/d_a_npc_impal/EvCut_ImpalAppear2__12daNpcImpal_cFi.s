...
/* 80A0A690  4B 95 7B 49 */	bl _savegpr_28
/* 80A0A694  7C 7E 1B 78 */	mr r30, r3
/* 80A0A698  7C 9C 23 78 */	mr r28, r4
/* 80A0A69C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A0A6A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A0A6A4  3B A3 4F F8 */	addi r29, r3, 0x4ff8
/* 80A0A6A8  7F A3 EB 78 */	mr r3, r29
/* 80A0A6AC  4B 63 D8 B1 */	bl getMyNowCutName__16dEvent_manager_cFi
/* 80A0A6B0  7C 7F 1B 78 */	mr r31, r3
/* 80A0A6B4  7F A3 EB 78 */	mr r3, r29
/* 80A0A6B8  7F 84 E3 78 */	mr r4, r28
/* 80A0A6BC  4B 63 D6 91 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80A0A70C  4B 74 96 11 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
...
lbl_80A0A728:
/* 80A0A728  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80A0A72C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 80A0A730  80 63 00 00 */	lwz r3, 0(r3)
/* 80A0A734  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 80A0A738  38 80 00 64 */	li r4, 0x64
/* 80A0A73C  4B 8A 57 A1 */	bl bgmStreamStop__8Z2SeqMgrFUl
/* 80A0A740  48 00 00 38 */	b lbl_80A0A778
lbl_80A0A744:
/* 80A0A744  3C 60 80 A1 */	lis r3, l_resetPos@ha /* 0x80A0C6D8@ha */
/* 80A0A748  C4 03 C6 D8 */	lfsu f0, l_resetPos@l(r3)  /* 0x80A0C6D8@l */
...
/* 80A0A790  4B 74 8F 89 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80A0A7A4  3C A0 80 A1 */	lis r5, lit_4889@ha /* 0x80A0C48C@ha */
/* 80A0A7A8  C0 25 C4 8C */	lfs f1, lit_4889@l(r5)  /* 0x80A0C48C@l */
...
/* 80A0A7C4  3C A0 80 A1 */	lis r5, lit_4889@ha /* 0x80A0C48C@ha */
/* 80A0A7C8  C0 25 C4 8C */	lfs f1, lit_4889@l(r5)  /* 0x80A0C48C@l */
...
/* 80A0A82C  3C A0 80 A1 */	lis r5, lit_4889@ha /* 0x80A0C48C@ha */
/* 80A0A830  C0 25 C4 8C */	lfs f1, lit_4889@l(r5)  /* 0x80A0C48C@l */
...
/* 80A0A850  3C A0 80 A1 */	lis r5, lit_4889@ha /* 0x80A0C48C@ha */
/* 80A0A854  C0 25 C4 8C */	lfs f1, lit_4889@l(r5)  /* 0x80A0C48C@l */
...
/* 80A0A874  3C A0 80 A1 */	lis r5, lit_4889@ha /* 0x80A0C48C@ha */
/* 80A0A878  C0 25 C4 8C */	lfs f1, lit_4889@l(r5)  /* 0x80A0C48C@l */
...
/* 80A0A898  3C A0 80 A1 */	lis r5, lit_4889@ha /* 0x80A0C48C@ha */
/* 80A0A89C  C0 25 C4 8C */	lfs f1, lit_4889@l(r5)  /* 0x80A0C48C@l */
...
/* 80A0A8BC  3C A0 80 A1 */	lis r5, lit_4889@ha /* 0x80A0C48C@ha */
/* 80A0A8C0  C0 25 C4 8C */	lfs f1, lit_4889@l(r5)  /* 0x80A0C48C@l */
...
/* 80A0A918  4B 74 94 6D */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80A0A93C  4B 95 78 E9 */	bl _restgpr_28
