...
/* 80A0A960  4B 95 78 71 */	bl _savegpr_26
/* 80A0A964  7C 7E 1B 78 */	mr r30, r3
/* 80A0A968  7C 9A 23 78 */	mr r26, r4
/* 80A0A96C  3C 60 80 A1 */	lis r3, m__18daNpcImpal_Param_c@ha /* 0x80A0C270@ha */
/* 80A0A970  3B E3 C2 70 */	addi r31, r3, m__18daNpcImpal_Param_c@l /* 0x80A0C270@l */
/* 80A0A974  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A0A978  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A0A97C  3B 7C 4F F8 */	addi r27, r28, 0x4ff8
/* 80A0A980  7F 63 DB 78 */	mr r3, r27
/* 80A0A984  4B 63 D5 D9 */	bl getMyNowCutName__16dEvent_manager_cFi
/* 80A0A988  7C 7D 1B 78 */	mr r29, r3
/* 80A0A98C  7F 63 DB 78 */	mr r3, r27
/* 80A0A990  7F 44 D3 78 */	mr r4, r26
/* 80A0A994  4B 63 D3 B9 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80A0A9E8  4B 74 98 69 */	bl setAngle__8daNpcF_cFs
...
/* 80A0AA0C  4B 74 93 11 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
/* 80A0AA10  48 00 00 90 */	b lbl_80A0AAA0
lbl_80A0AA14:
/* 80A0AA14  7F C3 F3 78 */	mr r3, r30
/* 80A0AA18  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 80A0AA1C  4B 74 98 35 */	bl setAngle__8daNpcF_cFs
...
/* 80A0AA40  4B 74 92 DD */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
...
/* 80A0AA58  4B 83 FA D1 */	bl getEventId__10dMsgFlow_cFPi
...
/* 80A0AA84  4B 61 11 65 */	bl fopAcM_createItemForPresentDemo__FPC4cXyziUciiPC5csXyzPC4cXyz
/* 80A0AA88  90 7E 0D D4 */	stw r3, 0xdd4(r30)
/* 80A0AA8C  38 7C 4E C8 */	addi r3, r28, 0x4ec8
/* 80A0AA90  80 9E 0D D4 */	lwz r4, 0xdd4(r30)
/* 80A0AA94  4B 63 8C 59 */	bl setPtI_Id__14dEvt_control_cFUi
...
/* 80A0AAB8  4B 74 8C 61 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80A0AC2C  4B 74 91 59 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80A0AC58  4B 60 21 0D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80A0AC5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0AC60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A0AC64  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 80A0AC68  4B 60 17 CD */	bl mDoMtx_YrotM__FPA4_fs
/* 80A0AC6C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0AC70  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A0AC74  38 81 00 20 */	addi r4, r1, 0x20
/* 80A0AC78  7C 85 23 78 */	mr r5, r4
/* 80A0AC7C  4B 93 C0 F1 */	bl PSMTXMultVec
...
/* 80A0ACA8  4B 61 30 15 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80A0ACAC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80A0ACB0  41 82 00 10 */	beq lbl_80A0ACC0
/* 80A0ACB4  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80A0ACB8  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
/* 80A0ACBC  D0 01 00 24 */	stfs f0, 0x24(r1)
lbl_80A0ACC0:
/* 80A0ACC0  38 61 00 20 */	addi r3, r1, 0x20
/* 80A0ACC4  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80A0ACC8  4B 86 5F 3D */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80A0ACCC  7C 65 1B 78 */	mr r5, r3
/* 80A0ACD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A0ACD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A0AD08  4B 74 90 7D */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80A0AD2C  4B 95 74 F1 */	bl _restgpr_26
