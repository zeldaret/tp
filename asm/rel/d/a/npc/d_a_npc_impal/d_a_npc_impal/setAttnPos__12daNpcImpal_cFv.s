...
/* 80A0B474  3C 60 80 A1 */	lis r3, m__18daNpcImpal_Param_c@ha /* 0x80A0C270@ha */
/* 80A0B478  3B E3 C2 70 */	addi r31, r3, m__18daNpcImpal_Param_c@l /* 0x80A0C270@l */
...
/* 80A0B4BC  4B 74 72 B1 */	bl setMtx__8daNpcF_cFv
...
/* 80A0B4F0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0B4F4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A0B4F8  4B 93 AF B9 */	bl PSMTXCopy
/* 80A0B4FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0B500  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A0B578  4B 85 B5 BD */	bl __mi__4cXyzCFRC3Vec
...
/* 80A0B5A8  4B 85 C0 CD */	bl cM_atan2s__Fff
...
/* 80A0B5D4  4B 93 BB 65 */	bl PSVECSquareMag
...
/* 80A0B644  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A0B648  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80A0B6B4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A0B6B8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80A0B6BC  48 00 00 08 */	b lbl_80A0B6C4
lbl_80A0B6C0:
/* 80A0B6C0  FC 40 08 90 */	fmr f2, f1
lbl_80A0B6C4:
/* 80A0B6C4  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80A0B6C8  4B 85 BF AD */	bl cM_atan2s__Fff
...
/* 80A0B71C  4B 86 3A C1 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80A0B720  38 7E 0D A8 */	addi r3, r30, 0xda8
/* 80A0B724  38 9F 00 00 */	addi r4, r31, 0
/* 80A0B728  C0 24 00 14 */	lfs f1, 0x14(r4)
/* 80A0B72C  4B 86 3A CD */	bl SetH__8cM3dGCylFf
/* 80A0B730  38 7E 0D A8 */	addi r3, r30, 0xda8
/* 80A0B734  38 9F 00 00 */	addi r4, r31, 0
/* 80A0B738  C0 24 00 1C */	lfs f1, 0x1c(r4)
/* 80A0B73C  4B 86 3A C5 */	bl SetR__8cM3dGCylFf
/* 80A0B740  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A0B744  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A0B748  38 63 23 3C */	addi r3, r3, 0x233c
/* 80A0B74C  38 9E 0C 84 */	addi r4, r30, 0xc84
/* 80A0B750  4B 85 94 59 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80A0B754:
