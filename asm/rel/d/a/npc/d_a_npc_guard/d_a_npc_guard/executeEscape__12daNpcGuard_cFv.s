...
/* 809F0B30  4B 97 16 AD */	bl _savegpr_29
/* 809F0B34  7C 7E 1B 78 */	mr r30, r3
/* 809F0B38  3C 80 80 9F */	lis r4, lit_3900@ha /* 0x809F2C50@ha */
/* 809F0B3C  3B E4 2C 50 */	addi r31, r4, lit_3900@l /* 0x809F2C50@l */
...
/* 809F0B60  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809F0B64  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809F0B68  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 809F0B6C  4B 62 9B A5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809F0B8C  4B 87 FA 7D */	bl cLib_addCalcAngleS2__FPssss
...
/* 809F0BA4  3C 60 80 9F */	lis r3, __vt__8cM3dGPla@ha /* 0x809F2FAC@ha */
/* 809F0BA8  38 03 2F AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x809F2FAC@l */
/* 809F0BAC  90 01 00 1C */	stw r0, 0x1c(r1)
/* 809F0BB0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809F0BB4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809F0BB8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 809F0BBC  38 9E 07 28 */	addi r4, r30, 0x728
/* 809F0BC0  38 A1 00 0C */	addi r5, r1, 0xc
/* 809F0BC4  4B 68 3B 81 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 809F0BD8  4B 62 D0 01 */	bl fopAcM_getPolygonAngle__FPC8cM3dGPlas
...
lbl_809F0BF0:
/* 809F0BF0  3C 60 80 9F */	lis r3, __vt__8cM3dGPla@ha /* 0x809F2FAC@ha */
/* 809F0BF4  38 03 2F AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x809F2FAC@l */
...
/* 809F0C18  4B 95 64 C1 */	bl PSVECScale
lbl_809F0C1C:
/* 809F0C1C  7F C3 F3 78 */	mr r3, r30
/* 809F0C20  7F A4 EB 78 */	mr r4, r29
/* 809F0C24  4B 62 9A A9 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 809F0C28  38 7E 06 38 */	addi r3, r30, 0x638
/* 809F0C2C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809F0C30  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809F0C34  38 84 0F 38 */	addi r4, r4, 0xf38
/* 809F0C38  4B 68 5E 75 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 809F0C50  4B 95 67 4D */	bl PSVECSquareDistance
...
/* 809F0CC0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809F0CC4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 809F0D30  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809F0D34  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_809F0D38:
...
/* 809F0D68  4B 76 73 89 */	bl getAnmP__10daNpcCd2_cFii
...
/* 809F0D88  4B 76 81 79 */	bl setAnm__10daNpcCd2_cFP18J3DAnmTransformKeyffiii
...
/* 809F0DB8  4B 62 8E C5 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_809F0DBC:
/* 809F0DBC  39 61 00 30 */	addi r11, r1, 0x30
/* 809F0DC0  4B 97 14 69 */	bl _restgpr_29
