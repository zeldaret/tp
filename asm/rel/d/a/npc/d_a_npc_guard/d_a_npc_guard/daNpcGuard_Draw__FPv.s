...
/* 809F2388  4B 76 6D 75 */	bl drawNpc__10daNpcCd2_cFv
/* 809F238C  80 1F 0A 98 */	lwz r0, 0xa98(r31)
/* 809F2390  2C 00 00 10 */	cmpwi r0, 0x10
/* 809F2394  40 80 00 1C */	bge lbl_809F23B0
/* 809F2398  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 809F239C  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_809F23B0:
/* 809F23B0  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 809F23B4  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 809F23D0  4B 76 6C 21 */	bl drawObj__10daNpcCd2_cFiP8J3DModelf
/* 809F23D4  7F E3 FB 78 */	mr r3, r31
/* 809F23D8  3C 80 80 9F */	lis r4, lit_4488@ha /* 0x809F2D28@ha */
/* 809F23DC  C0 24 2D 28 */	lfs f1, lit_4488@l(r4)  /* 0x809F2D28@l */
/* 809F23E0  4B 76 6B 8D */	bl drawShadow__10daNpcCd2_cFf
...
/* 809F23FC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 809F2400  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 809F2404  80 84 00 04 */	lwz r4, 4(r4)
/* 809F2408  38 BF 01 0C */	addi r5, r31, 0x10c
/* 809F240C  4B 7B 29 95 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 809F2424  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F2428  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F242C  4B 95 40 85 */	bl PSMTXCopy
/* 809F2430  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F2434  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F2438  80 9F 0A CC */	lwz r4, 0xacc(r31)
/* 809F243C  38 84 00 24 */	addi r4, r4, 0x24
/* 809F2440  4B 95 40 71 */	bl PSMTXCopy
/* 809F2444  80 7F 0A CC */	lwz r3, 0xacc(r31)
/* 809F2448  4B 61 B8 7D */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_809F244C:
