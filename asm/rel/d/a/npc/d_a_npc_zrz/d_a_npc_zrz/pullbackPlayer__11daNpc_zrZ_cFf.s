...
/* 80B98C4C  4B 5B 80 15 */	bl getBeforeIdx__13daNpcF_Path_cFv
...
/* 80B98C90  3C 60 80 BA */	lis r3, lit_6287@ha /* 0x80B9B20C@ha */
/* 80B98C94  C0 03 B2 0C */	lfs f0, lit_6287@l(r3)  /* 0x80B9B20C@l */
/* 80B98C98  EC 01 00 2A */	fadds f0, f1, f0
/* 80B98C9C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80B98CA0  38 61 00 14 */	addi r3, r1, 0x14
/* 80B98CA4  4B 48 50 19 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80B98CA8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80B98CAC  41 82 00 10 */	beq lbl_80B98CBC
/* 80B98CB0  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80B98CB4  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
/* 80B98CB8  D0 01 00 18 */	stfs f0, 0x18(r1)
lbl_80B98CBC:
/* 80B98CBC  38 61 00 14 */	addi r3, r1, 0x14
/* 80B98CC0  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80B98CC4  4B 6D 7F 41 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80B98CC8  7C 65 1B 78 */	mr r5, r3
/* 80B98CCC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B98CD0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
