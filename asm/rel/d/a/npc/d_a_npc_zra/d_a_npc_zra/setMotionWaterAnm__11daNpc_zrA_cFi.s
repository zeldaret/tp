...
/* 80B7C080  4B 7E 61 4D */	bl _savegpr_25
/* 80B7C084  7C 79 1B 78 */	mr r25, r3
/* 80B7C088  7C 9A 23 78 */	mr r26, r4
/* 80B7C08C  3C 80 80 B9 */	lis r4, cNullVec__6Z2Calc@ha /* 0x80B8CE90@ha */
/* 80B7C090  3B E4 CE 90 */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x80B8CE90@l */
...
/* 80B7C0FC  4B 5D 6A E5 */	bl getTevRegKeyAnmP__8daNpcF_cFPci
...
/* 80B7C170  3C C0 80 B9 */	lis r6, lit_5070@ha /* 0x80B8C548@ha */
/* 80B7C174  C0 26 C5 48 */	lfs f1, lit_5070@l(r6)  /* 0x80B8C548@l */
/* 80B7C178  38 C0 00 02 */	li r6, 2
/* 80B7C17C  4B 5D 6B C9 */	bl setBrkAnm__8daNpcF_cFP15J3DAnmTevRegKeyP12J3DModelDatafi
...
/* 80B7C1CC  4B 5D 69 D9 */	bl getTexSRTKeyAnmP__8daNpcF_cFPci
...
/* 80B7C218  3D 00 80 B9 */	lis r8, lit_5070@ha /* 0x80B8C548@ha */
/* 80B7C21C  C0 28 C5 48 */	lfs f1, lit_5070@l(r8)  /* 0x80B8C548@l */
/* 80B7C220  39 00 00 00 */	li r8, 0
/* 80B7C224  39 20 FF FF */	li r9, -1
/* 80B7C228  4B 49 14 15 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80B7C268  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B7C26C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B7C270  3C A5 00 02 */	addis r5, r5, 2
/* 80B7C274  38 C0 00 80 */	li r6, 0x80
/* 80B7C278  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80B7C27C  4B 4C 00 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80B7C2C8  3D 00 80 B9 */	lis r8, lit_5070@ha /* 0x80B8C548@ha */
/* 80B7C2CC  C0 28 C5 48 */	lfs f1, lit_5070@l(r8)  /* 0x80B8C548@l */
/* 80B7C2D0  39 00 00 00 */	li r8, 0
/* 80B7C2D4  39 20 FF FF */	li r9, -1
/* 80B7C2D8  4B 49 11 A5 */	bl init__13mDoExt_bpkAnmFP16J3DMaterialTableP11J3DAnmColoriifss
...
/* 80B7C2F4  4B 7E 5F 25 */	bl _restgpr_25
