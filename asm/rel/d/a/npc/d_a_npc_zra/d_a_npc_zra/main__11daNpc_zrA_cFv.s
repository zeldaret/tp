...
/* 80B7AE08  4B 7E 73 D5 */	bl _savegpr_29
/* 80B7AE0C  7C 7E 1B 78 */	mr r30, r3
/* 80B7AE10  3C 80 80 B9 */	lis r4, cNullVec__6Z2Calc@ha /* 0x80B8CE90@ha */
/* 80B7AE14  3B E4 CE 90 */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x80B8CE90@l */
...
/* 80B7AE30  4B 7E 71 E9 */	bl __ptmf_test
...
/* 80B7AE44  4B 7E 72 05 */	bl __ptmf_cmpr
...
/* 80B7AE5C  4B 7E 72 29 */	bl __ptmf_scall
...
/* 80B7AEA8  4B 4B 4B AD */	bl dComIfGs_wolfeye_effect_check__Fv
...
lbl_80B7AEC8:
/* 80B7AEC8  3C 60 80 B9 */	lis r3, m__17daNpc_zrA_Param_c@ha /* 0x80B8C458@ha */
/* 80B7AECC  38 63 C4 58 */	addi r3, r3, m__17daNpc_zrA_Param_c@l /* 0x80B8C458@l */
/* 80B7AED0  88 03 00 6A */	lbz r0, 0x6a(r3)
/* 80B7AED4  28 00 00 00 */	cmplwi r0, 0
/* 80B7AED8  40 82 00 DC */	bne lbl_80B7AFB4
/* 80B7AEDC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B7AEE0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80B7AF80  4B 5D 88 FD */	bl orderEvent__8daNpcF_cFiPcUsUsUcUs
...
/* 80B7AFC0  3C 60 80 B9 */	lis r3, lit_3939@ha /* 0x80B8C508@ha */
/* 80B7AFC4  C0 03 C5 08 */	lfs f0, lit_3939@l(r3)  /* 0x80B8C508@l */
...
/* 80B7B028  3C 60 80 B9 */	lis r3, lit_3939@ha /* 0x80B8C508@ha */
/* 80B7B02C  C0 03 C5 08 */	lfs f0, lit_3939@l(r3)  /* 0x80B8C508@l */
/* 80B7B030  D0 1E 0B F4 */	stfs f0, 0xbf4(r30)
lbl_80B7B034:
/* 80B7B034  38 7E 0B E8 */	addi r3, r30, 0xbe8
/* 80B7B038  4B 49 23 F1 */	bl play__14mDoExt_baseAnmFv
...
/* 80B7B058  3C 60 80 B9 */	lis r3, lit_3939@ha /* 0x80B8C508@ha */
/* 80B7B05C  C0 03 C5 08 */	lfs f0, lit_3939@l(r3)  /* 0x80B8C508@l */
/* 80B7B060  D0 1E 0C 0C */	stfs f0, 0xc0c(r30)
lbl_80B7B064:
/* 80B7B064  38 7E 0C 00 */	addi r3, r30, 0xc00
/* 80B7B068  4B 49 23 C1 */	bl play__14mDoExt_baseAnmFv
...
/* 80B7B090  4B 7E 71 99 */	bl _restgpr_29
