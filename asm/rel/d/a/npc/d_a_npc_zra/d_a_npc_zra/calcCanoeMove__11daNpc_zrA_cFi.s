...
/* 80B8A07C  4B 7D 81 59 */	bl _savegpr_27
/* 80B8A080  7C 7E 1B 78 */	mr r30, r3
/* 80B8A084  7C 9B 23 78 */	mr r27, r4
/* 80B8A088  3C 60 80 B9 */	lis r3, m__17daNpc_zrA_Param_c@ha /* 0x80B8C458@ha */
/* 80B8A08C  3B A3 C4 58 */	addi r29, r3, m__17daNpc_zrA_Param_c@l /* 0x80B8C458@l */
...
/* 80B8A0B0  4B 49 37 E1 */	bl fopAcM_getWaterY__FPC4cXyzPf
...
/* 80B8A0CC  4B 6E 6B A9 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80B8A0D0  B0 61 00 10 */	sth r3, 0x10(r1)
/* 80B8A0D4  38 61 00 30 */	addi r3, r1, 0x30
/* 80B8A0D8  38 9E 15 9C */	addi r4, r30, 0x159c
/* 80B8A0DC  4B 6E 6B 29 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80B8A108  4B 48 2E 05 */	bl ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80B8A10C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B8A110  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B8A114  38 81 00 3C */	addi r4, r1, 0x3c
/* 80B8A118  38 BE 15 9C */	addi r5, r30, 0x159c
/* 80B8A11C  4B 7B CC 51 */	bl PSMTXMultVec
/* 80B8A120  38 7E 15 9C */	addi r3, r30, 0x159c
/* 80B8A124  38 81 00 30 */	addi r4, r1, 0x30
/* 80B8A128  7C 65 1B 78 */	mr r5, r3
/* 80B8A12C  4B 7B CF 65 */	bl PSVECAdd
/* 80B8A130  38 7E 15 9C */	addi r3, r30, 0x159c
/* 80B8A134  38 81 00 0C */	addi r4, r1, 0xc
/* 80B8A138  4B 49 37 59 */	bl fopAcM_getWaterY__FPC4cXyzPf
...
/* 80B8A154  4B 6E 6B 21 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80B8A158  B0 61 00 10 */	sth r3, 0x10(r1)
/* 80B8A15C  38 7E 15 9C */	addi r3, r30, 0x159c
/* 80B8A160  38 9E 15 A8 */	addi r4, r30, 0x15a8
/* 80B8A164  4B 6E 6A A1 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80B8A188  4B 48 2D 85 */	bl ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80B8A18C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B8A190  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B8A194  38 81 00 3C */	addi r4, r1, 0x3c
/* 80B8A198  38 BE 15 A8 */	addi r5, r30, 0x15a8
/* 80B8A19C  4B 7B CB D1 */	bl PSMTXMultVec
/* 80B8A1A0  38 7E 15 A8 */	addi r3, r30, 0x15a8
/* 80B8A1A4  38 9E 15 9C */	addi r4, r30, 0x159c
/* 80B8A1A8  7C 65 1B 78 */	mr r5, r3
/* 80B8A1AC  4B 7B CE E5 */	bl PSVECAdd
/* 80B8A1B0  38 7E 15 A8 */	addi r3, r30, 0x15a8
/* 80B8A1B4  38 81 00 0C */	addi r4, r1, 0xc
/* 80B8A1B8  4B 49 36 D9 */	bl fopAcM_getWaterY__FPC4cXyzPf
...
/* 80B8A1E0  4B 6D C9 55 */	bl __mi__4cXyzCFRC3Vec
/* 80B8A1E4  38 61 00 24 */	addi r3, r1, 0x24
/* 80B8A1E8  4B 7B CF 51 */	bl PSVECSquareMag
...
/* 80B8A258  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80B8A25C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80B8A2C8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80B8A2CC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80B8A2E4  4B 6D C8 51 */	bl __mi__4cXyzCFRC3Vec
/* 80B8A2E8  38 61 00 18 */	addi r3, r1, 0x18
/* 80B8A2EC  4B 7B CE 4D */	bl PSVECSquareMag
...
/* 80B8A334  4B 6E 5E 45 */	bl cLib_addCalcPos2__FP4cXyzRC4cXyzff
/* 80B8A338  38 7E 15 B4 */	addi r3, r30, 0x15b4
/* 80B8A33C  38 81 00 0C */	addi r4, r1, 0xc
/* 80B8A340  4B 49 35 51 */	bl fopAcM_getWaterY__FPC4cXyzPf
...
/* 80B8A384  4B 5C 63 69 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 80B8A3B8  4B 7D 7E 69 */	bl _restgpr_27
