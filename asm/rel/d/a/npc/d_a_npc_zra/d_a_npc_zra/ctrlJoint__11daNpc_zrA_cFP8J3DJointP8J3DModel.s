...
/* 80B7A874  4B 7E 79 61 */	bl _savegpr_27
/* 80B7A878  7C 7F 1B 78 */	mr r31, r3
/* 80B7A87C  7C BD 2B 78 */	mr r29, r5
/* 80B7A880  3C 60 80 B9 */	lis r3, m__17daNpc_zrA_Param_c@ha /* 0x80B8C458@ha */
/* 80B7A884  3B 83 C4 58 */	addi r28, r3, m__17daNpc_zrA_Param_c@l /* 0x80B8C458@l */
...
/* 80B7A8AC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A8B0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A8B4  4B 7C BB FD */	bl PSMTXCopy
...
/* 80B7A8CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A8D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A8D4  38 81 00 50 */	addi r4, r1, 0x50
/* 80B7A8D8  4B 7C BB D9 */	bl PSMTXCopy
...
/* 80B7A908  4B 49 26 05 */	bl ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80B7A90C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A910  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A914  7C 64 1B 78 */	mr r4, r3
/* 80B7A918  4B 7C BC 99 */	bl PSMTXInverse
/* 80B7A91C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A920  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A924  38 81 00 20 */	addi r4, r1, 0x20
/* 80B7A928  4B 7C BB 89 */	bl PSMTXCopy
/* 80B7A92C  38 61 00 14 */	addi r3, r1, 0x14
/* 80B7A930  4B 49 24 35 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80B7A934  38 7F 08 F0 */	addi r3, r31, 0x8f0
/* 80B7A938  4B 49 26 0D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80B7A93C  38 7F 15 30 */	addi r3, r31, 0x1530
/* 80B7A940  4B 49 26 05 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80B7A944  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A948  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A94C  38 81 00 20 */	addi r4, r1, 0x20
/* 80B7A950  7C 65 1B 78 */	mr r5, r3
/* 80B7A954  4B 7C BB 91 */	bl PSMTXConcat
/* 80B7A958  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A95C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A960  38 81 00 50 */	addi r4, r1, 0x50
/* 80B7A964  7C 65 1B 78 */	mr r5, r3
/* 80B7A968  4B 7C BB 7D */	bl PSMTXConcat
lbl_80B7A96C:
/* 80B7A96C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A970  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A974  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 80B7A978  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80B7A97C  7C 80 DA 14 */	add r4, r0, r27
/* 80B7A980  4B 7C BB 31 */	bl PSMTXCopy
/* 80B7A984  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A988  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A98C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80B7A990  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80B7A994  4B 7C BB 1D */	bl PSMTXCopy
...
/* 80B7A9D4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A9D8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7A9DC  4B 7C BA D5 */	bl PSMTXCopy
/* 80B7A9E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7A9E4  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B7AA18  4B 7C BA 99 */	bl PSMTXCopy
...
/* 80B7AA48  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7AA4C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7AA50  4B 7C BA 61 */	bl PSMTXCopy
...
/* 80B7AA7C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7AA80  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7AA84  4B 7C BA 2D */	bl PSMTXCopy
...
/* 80B7AABC  4B 5D 88 C1 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80B7AAC0:
/* 80B7AAC0  2C 1E 00 01 */	cmpwi r30, 1
/* 80B7AAC4  40 82 00 30 */	bne lbl_80B7AAF4
/* 80B7AAC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7AACC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7AAD0  A8 9F 09 0C */	lha r4, 0x90c(r31)
/* 80B7AAD4  4B 49 19 61 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B7AAD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7AADC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7AAE0  A8 1F 09 08 */	lha r0, 0x908(r31)
/* 80B7AAE4  7C 00 00 D0 */	neg r0, r0
/* 80B7AAE8  7C 04 07 34 */	extsh r4, r0
/* 80B7AAEC  4B 49 19 E1 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B7AAF0  48 00 00 2C */	b lbl_80B7AB1C
lbl_80B7AAF4:
/* 80B7AAF4  2C 1E 00 04 */	cmpwi r30, 4
/* 80B7AAF8  40 82 00 24 */	bne lbl_80B7AB1C
/* 80B7AAFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7AB00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7AB04  A8 9F 09 18 */	lha r4, 0x918(r31)
/* 80B7AB08  4B 49 19 2D */	bl mDoMtx_YrotM__FPA4_fs
/* 80B7AB0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7AB10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7AB14  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 80B7AB18  4B 49 19 B5 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B7AB1C:
/* 80B7AB1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7AB20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7AB24  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 80B7AB28  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80B7AB2C  7C 80 DA 14 */	add r4, r0, r27
/* 80B7AB30  4B 7C B9 81 */	bl PSMTXCopy
/* 80B7AB34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7AB38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7AB3C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80B7AB40  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80B7AB44  4B 7C B9 6D */	bl PSMTXCopy
...
/* 80B7AB74  4B 49 2E 1D */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80B7AB88  4B 7E 76 99 */	bl _restgpr_27
