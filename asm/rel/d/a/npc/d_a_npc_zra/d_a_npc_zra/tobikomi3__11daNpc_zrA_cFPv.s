...
/* 80B8AA34  3C 60 80 B9 */	lis r3, m__17daNpc_zrA_Param_c@ha /* 0x80B8C458@ha */
/* 80B8AA38  3B C3 C4 58 */	addi r30, r3, m__17daNpc_zrA_Param_c@l /* 0x80B8C458@l */
...
/* 80B8AAA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B8AAA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B8AAAC  A8 9F 08 F2 */	lha r4, 0x8f2(r31)
/* 80B8AAB0  4B 48 19 2D */	bl mDoMtx_YrotS__FPA4_fs
/* 80B8AAB4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B8AAB8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B8AABC  38 81 00 20 */	addi r4, r1, 0x20
/* 80B8AAC0  7C 85 23 78 */	mr r5, r4
/* 80B8AAC4  4B 7B C2 A9 */	bl PSMTXMultVec
/* 80B8AAC8  38 7F 15 44 */	addi r3, r31, 0x1544
/* 80B8AACC  38 81 00 20 */	addi r4, r1, 0x20
/* 80B8AAD0  C0 3E 08 28 */	lfs f1, 0x828(r30)
/* 80B8AAD4  4B 6E 5C D9 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
/* 80B8AAD8  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80B8AADC  38 9F 15 44 */	addi r4, r31, 0x1544
/* 80B8AAE0  7C 65 1B 78 */	mr r5, r3
/* 80B8AAE4  4B 7B C5 AD */	bl PSVECAdd
...
/* 80B8AB00  3C 60 80 B9 */	lis r3, lit_11420@ha /* 0x80B8D8B8@ha */
/* 80B8AB04  38 83 D8 B8 */	addi r4, r3, lit_11420@l /* 0x80B8D8B8@l */
...
lbl_80B8AB30:
/* 80B8AB30  3C 60 80 B9 */	lis r3, lit_11423@ha /* 0x80B8D8C4@ha */
/* 80B8AB34  38 83 D8 C4 */	addi r4, r3, lit_11423@l /* 0x80B8D8C4@l */
