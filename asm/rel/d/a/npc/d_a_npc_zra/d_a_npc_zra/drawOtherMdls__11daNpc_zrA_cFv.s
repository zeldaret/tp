...
/* 80B7C364  4B 7E 5E 69 */	bl _savegpr_25
...
/* 80B7C380  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B7C384  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B7C388  3B C3 61 C0 */	addi r30, r3, 0x61c0
/* 80B7C38C  3C 60 80 B9 */	lis r3, l_jntNumTbl@ha /* 0x80B8C588@ha */
/* 80B7C390  3B E3 C5 88 */	addi r31, r3, l_jntNumTbl@l /* 0x80B8C588@l */
lbl_80B7C394:
...
/* 80B7C3BC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80B7C3C0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80B7C3C4  80 9C 00 04 */	lwz r4, 4(r28)
/* 80B7C3C8  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80B7C3CC  4B 62 89 D5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80B7C3E8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7C3EC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7C3F0  4B 7C A0 C1 */	bl PSMTXCopy
/* 80B7C3F4  38 7B 04 EC */	addi r3, r27, 0x4ec
/* 80B7C3F8  4B 49 0A 79 */	bl scaleM__14mDoMtx_stack_cFRC4cXyz
/* 80B7C3FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B7C400  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B7C404  38 9C 00 24 */	addi r4, r28, 0x24
/* 80B7C408  4B 7C A0 A9 */	bl PSMTXCopy
/* 80B7C40C  7F 83 E3 78 */	mr r3, r28
/* 80B7C410  4B 49 18 B5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80B7C414  7F C3 F3 78 */	mr r3, r30
/* 80B7C418  80 9B 09 A0 */	lwz r4, 0x9a0(r27)
/* 80B7C41C  7F 85 E3 78 */	mr r5, r28
/* 80B7C420  4B 4D 9A FD */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80B7C424:
...
/* 80B7C438  4B 7E 5D E1 */	bl _restgpr_25
