...
lbl_80B44C0C:
/* 80B44C0C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B44C10  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80B44C38  4B 72 BF CD */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80B44C3C  7C 64 1B 78 */	mr r4, r3
/* 80B44C40  38 7E 0D 7A */	addi r3, r30, 0xd7a
/* 80B44C44  38 A0 06 00 */	li r5, 0x600
/* 80B44C48  4B 72 BF 49 */	bl cLib_chaseAngleS__FPsss
...
/* 80B44C74  4B 60 0A 89 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B44C78  38 00 00 00 */	li r0, 0
/* 80B44C7C  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 80B44C80  3C 60 80 B4 */	lis r3, lit_4194@ha /* 0x80B460F0@ha */
/* 80B44C84  C0 03 60 F0 */	lfs f0, lit_4194@l(r3)  /* 0x80B460F0@l */
...
/* 80B44CB8  4B 60 6F C1 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
/* 80B44CBC  2C 03 00 00 */	cmpwi r3, 0
/* 80B44CC0  41 82 00 24 */	beq lbl_80B44CE4
/* 80B44CC4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B44CC8  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B44CCC  80 7F 5D AC */	lwz r3, 0x5dac(r31)
/* 80B44CD0  7C 64 1B 78 */	mr r4, r3
/* 80B44CD4  4B 4D 5A 3D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
