...
/* 80B6C1CC  3C 60 80 B7 */	lis r3, __vt__12daNpc_Zant_c@ha /* 0x80B6EC4C@ha */
/* 80B6C1D0  38 03 EC 4C */	addi r0, r3, __vt__12daNpc_Zant_c@l /* 0x80B6EC4C@l */
...
/* 80B6C1E8  4B 4A 51 29 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80B6C1EC:
/* 80B6C1EC  7F C3 F3 78 */	mr r3, r30
/* 80B6C1F0  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 80B6C1F4  54 00 10 3A */	slwi r0, r0, 2
/* 80B6C1F8  3C 80 80 B7 */	lis r4, l_loadResPtrnList@ha /* 0x80B6EAD8@ha */
/* 80B6C1FC  38 84 EA D8 */	addi r4, r4, l_loadResPtrnList@l /* 0x80B6EAD8@l */
/* 80B6C200  7C 84 00 2E */	lwzx r4, r4, r0
/* 80B6C204  3C A0 80 B7 */	lis r5, l_resNameList@ha /* 0x80B6EACC@ha */
/* 80B6C208  38 A5 EA CC */	addi r5, r5, l_resNameList@l /* 0x80B6EACC@l */
/* 80B6C20C  4B 5D C2 A1 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80B6C210  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80B6C214  41 82 00 84 */	beq lbl_80B6C298
/* 80B6C218  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80B6C21C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80B6C23C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80B6C240  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80B6C258  3C 60 80 B7 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80B6EC40@ha */
/* 80B6C25C  38 03 EC 40 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80B6EC40@l */
/* 80B6C260  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_80B6C264:
/* 80B6C264  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80B6C268  41 82 00 24 */	beq lbl_80B6C28C
/* 80B6C26C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80B6C270  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80B6C274  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 80B6C278  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80B6C27C  41 82 00 10 */	beq lbl_80B6C28C
/* 80B6C280  3C 60 80 B7 */	lis r3, __vt__8cM3dGAab@ha /* 0x80B6EC34@ha */
/* 80B6C284  38 03 EC 34 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80B6EC34@l */
/* 80B6C288  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_80B6C28C:
/* 80B6C28C  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80B6C290  38 80 00 00 */	li r4, 0
/* 80B6C294  4B 51 7E 51 */	bl __dt__12dCcD_GObjInfFv
lbl_80B6C298:
...
/* 80B6C2B0  4B 76 2A 8D */	bl __dl__FPv
lbl_80B6C2B4:
