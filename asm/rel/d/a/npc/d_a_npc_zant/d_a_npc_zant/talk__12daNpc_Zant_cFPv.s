...
/* 80B6D5D0  4B 5D E6 21 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80B6D60C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B6D610  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B6D614  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 80B6D618  4B 4A D0 F9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80B6D640  4B 5D E6 39 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
/* 80B6D644  2C 03 00 00 */	cmpwi r3, 0
/* 80B6D648  41 82 00 30 */	beq lbl_80B6D678
/* 80B6D64C  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 80B6D650  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B6D654  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B6D658  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80B6D65C  4B 5D 80 85 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80B6D660  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B6D664  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B6D668  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80B6D66C  4B 4D 4D FD */	bl reset__14dEvt_control_cFv
...
/* 80B6D688  4B 5D 80 75 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B6D68C  38 00 00 00 */	li r0, 0
/* 80B6D690  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6D694  3C 60 80 B7 */	lis r3, lit_4176@ha /* 0x80B6EA48@ha */
/* 80B6D698  C0 03 EA 48 */	lfs f0, lit_4176@l(r3)  /* 0x80B6EA48@l */
...
/* 80B6D6D0  4B 5D 80 2D */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B6D6D4  38 00 00 00 */	li r0, 0
/* 80B6D6D8  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6D6DC  3C 60 80 B7 */	lis r3, lit_4176@ha /* 0x80B6EA48@ha */
/* 80B6D6E0  C0 03 EA 48 */	lfs f0, lit_4176@l(r3)  /* 0x80B6EA48@l */
...
/* 80B6D70C  4B 5D 7F F1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B6D710  38 00 00 00 */	li r0, 0
/* 80B6D714  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6D718  3C 60 80 B7 */	lis r3, lit_4176@ha /* 0x80B6EA48@ha */
/* 80B6D71C  C0 03 EA 48 */	lfs f0, lit_4176@l(r3)  /* 0x80B6EA48@l */
...
/* 80B6D740  4B 4A CF D1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80B6D75C  4B 5D DE ED */	bl step__8daNpcT_cFsiiii
lbl_80B6D760:
