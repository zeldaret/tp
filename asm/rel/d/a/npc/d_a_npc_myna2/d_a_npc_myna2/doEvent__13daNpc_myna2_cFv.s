...
/* 80A858A4  4B 8D C9 2D */	bl _savegpr_26
/* 80A858A8  7C 7B 1B 78 */	mr r27, r3
/* 80A858AC  3C 60 80 A9 */	lis r3, cNullVec__6Z2Calc@ha /* 0x80A886B4@ha */
/* 80A858B0  3B C3 86 B4 */	addi r30, r3, cNullVec__6Z2Calc@l /* 0x80A886B4@l */
/* 80A858B4  3B 80 00 00 */	li r28, 0
/* 80A858B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A858BC  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A85930  4B 8D C7 55 */	bl __ptmf_scall
/* 80A85934  60 00 00 00 */	nop 
/* 80A85938  48 00 00 64 */	b lbl_80A8599C
lbl_80A8593C:
/* 80A8593C  38 00 00 00 */	li r0, 0
/* 80A85940  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A85944  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A8596C  4B 5C 2E 85 */	bl ChkPresentEnd__16dEvent_manager_cFv
...
/* 80A859B8  4B 5B DD 35 */	bl setPtI_Id__14dEvt_control_cFUi
...
/* 80A859D4  4B 5C 21 49 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80A85A00  4B 5C 24 11 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 80A85A1C  4B 8D C6 69 */	bl __ptmf_scall
...
/* 80A85A34  4B 5C 27 49 */	bl cutEnd__16dEvent_manager_cFi
lbl_80A85A38:
...
/* 80A85A58  4B 5C 20 21 */	bl endCheck__16dEvent_manager_cFs
...
/* 80A85A84  4B 5B C9 E5 */	bl reset__14dEvt_control_cFv
...
/* 80A85A98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A85A9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A85AA0  88 9B 0E 0D */	lbz r4, 0xe0d(r27)
/* 80A85AA4  88 1B 04 E2 */	lbz r0, 0x4e2(r27)
/* 80A85AA8  7C 05 07 74 */	extsb r5, r0
/* 80A85AAC  4B 5A F8 05 */	bl offSwitch__10dSv_info_cFii
/* 80A85AB0  7F 63 DB 78 */	mr r3, r27
/* 80A85AB4  4B 59 41 C9 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 80A85AB8  48 00 00 40 */	b lbl_80A85AF8
lbl_80A85ABC:
/* 80A85ABC  38 7F 4E C8 */	addi r3, r31, 0x4ec8
/* 80A85AC0  4B 5B C9 A9 */	bl reset__14dEvt_control_cFv
...
/* 80A85AD8  4B 59 41 A5 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 80A85ADC  48 00 00 1C */	b lbl_80A85AF8
lbl_80A85AE0:
/* 80A85AE0  38 7F 4E C8 */	addi r3, r31, 0x4ec8
/* 80A85AE4  4B 5B C9 85 */	bl reset__14dEvt_control_cFv
...
/* 80A85B0C  4B 6C DC 0D */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80A85B2C  3C A0 80 A9 */	lis r5, lit_4982@ha /* 0x80A885C0@ha */
/* 80A85B30  C0 25 85 C0 */	lfs f1, lit_4982@l(r5)  /* 0x80A885C0@l */
...
/* 80A85B60  3C 60 80 3A */	lis r3, __ptmf_null@ha /* 0x803A2180@ha */
/* 80A85B64  38 83 21 80 */	addi r4, r3, __ptmf_null@l /* 0x803A2180@l */
...
/* 80A85B90  4B 8D C6 8D */	bl _restgpr_26
