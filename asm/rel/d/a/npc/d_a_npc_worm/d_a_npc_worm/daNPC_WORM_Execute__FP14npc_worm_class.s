...
/* 80B2EC0C  3C 60 80 B3 */	lis r3, lit_3717@ha /* 0x80B2F080@ha */
/* 80B2EC10  3B E3 F0 80 */	addi r31, r3, lit_3717@l /* 0x80B2F080@l */
...
/* 80B2EC60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2EC64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B2EC7C  4B 81 7C 6D */	bl PSMTXTrans
/* 80B2EC80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2EC84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2EC88  A8 9E 05 C6 */	lha r4, 0x5c6(r30)
/* 80B2EC8C  4B 4D D7 11 */	bl mDoMtx_XrotM__FPA4_fs
/* 80B2EC90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2EC94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2EC98  A8 9E 05 C8 */	lha r4, 0x5c8(r30)
/* 80B2EC9C  4B 4D D8 31 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B2ECA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ECA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2ECA8  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80B2ECAC  4B 4D D7 89 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B2ECB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ECB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2ECB8  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80B2ECBC  4B 4D D6 E1 */	bl mDoMtx_XrotM__FPA4_fs
/* 80B2ECC0  C0 3F 00 04 */	lfs f1, 4(r31)
/* 80B2ECC4  FC 40 08 90 */	fmr f2, f1
/* 80B2ECC8  C0 7E 05 D0 */	lfs f3, 0x5d0(r30)
/* 80B2ECCC  4B 4D E0 D1 */	bl transM__14mDoMtx_stack_cFfff
/* 80B2ECD0  C0 3F 00 70 */	lfs f1, 0x70(r31)
/* 80B2ECD4  FC 40 08 90 */	fmr f2, f1
/* 80B2ECD8  FC 60 08 90 */	fmr f3, f1
/* 80B2ECDC  4B 4D E1 5D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80B2ECE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ECE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2ECE8  80 9E 05 9C */	lwz r4, 0x59c(r30)
/* 80B2ECEC  38 84 00 24 */	addi r4, r4, 0x24
/* 80B2ECF0  4B 81 77 C1 */	bl PSMTXCopy
...
/* 80B2ED10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ED14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B2ED2C  4B 81 7B BD */	bl PSMTXTrans
/* 80B2ED30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ED34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2ED38  A8 9E 05 C6 */	lha r4, 0x5c6(r30)
/* 80B2ED3C  4B 4D D6 61 */	bl mDoMtx_XrotM__FPA4_fs
/* 80B2ED40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ED44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2ED48  A8 9E 05 C8 */	lha r4, 0x5c8(r30)
/* 80B2ED4C  4B 4D D7 81 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B2ED50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ED54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2ED58  A8 9E 05 E4 */	lha r4, 0x5e4(r30)
/* 80B2ED5C  4B 4D D6 D9 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80B2ED78  4B 4D E0 C1 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80B2ED7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ED80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2ED84  A8 1E 05 E4 */	lha r0, 0x5e4(r30)
/* 80B2ED88  7C 00 00 D0 */	neg r0, r0
/* 80B2ED8C  7C 04 07 34 */	extsh r4, r0
/* 80B2ED90  4B 4D D6 A5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B2ED94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2ED98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2ED9C  80 9E 05 A0 */	lwz r4, 0x5a0(r30)
/* 80B2EDA0  38 84 00 24 */	addi r4, r4, 0x24
/* 80B2EDA4  4B 81 77 0D */	bl PSMTXCopy
