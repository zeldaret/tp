...
/* 80AA8CAC  3C 60 80 AB */	lis r3, __vt__12daNpc_Post_c@ha
/* 80AA8CB0  38 03 DB 14 */	addi r0, r3, __vt__12daNpc_Post_c@l
...
/* 80AA8CC4  4B 56 86 4C */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AA8CC8:
/* 80AA8CC8  80 7E 0E 40 */	lwz r3, 0xe40(r30)
/* 80AA8CCC  28 03 00 00 */	cmplwi r3, 0
/* 80AA8CD0  41 82 00 08 */	beq lbl_80AA8CD8
/* 80AA8CD4  4B 56 86 3C */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AA8CD8:
/* 80AA8CD8  7F C3 F3 78 */	mr r3, r30
/* 80AA8CDC  88 1E 0F 8C */	lbz r0, 0xf8c(r30)
/* 80AA8CE0  54 00 10 3A */	slwi r0, r0, 2
/* 80AA8CE4  3C 80 80 AB */	lis r4, l_loadResPtrnList@ha
/* 80AA8CE8  38 84 D4 30 */	addi r4, r4, l_loadResPtrnList@l
/* 80AA8CEC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AA8CF0  3C A0 80 AB */	lis r5, l_resNameList@ha
/* 80AA8CF4  38 A5 D4 14 */	addi r5, r5, l_resNameList@l
/* 80AA8CF8  4B 69 F7 B4 */	b deleteRes__8daNpcT_cFPCScPPCc
/* 80AA8CFC  34 1E 0F B0 */	addic. r0, r30, 0xfb0
/* 80AA8D00  41 82 00 10 */	beq lbl_80AA8D10
/* 80AA8D04  3C 60 80 AB */	lis r3, __vt__13daNpcT_Path_c@ha
/* 80AA8D08  38 03 DB 08 */	addi r0, r3, __vt__13daNpcT_Path_c@l
/* 80AA8D0C  90 1E 0F D4 */	stw r0, 0xfd4(r30)
lbl_80AA8D10:
/* 80AA8D10  38 7E 0F 90 */	addi r3, r30, 0xf90
/* 80AA8D14  3C 80 80 AB */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha
/* 80AA8D18  38 84 C3 04 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l
/* 80AA8D1C  38 A0 00 08 */	li r5, 8
/* 80AA8D20  38 C0 00 04 */	li r6, 4
/* 80AA8D24  4B 8B 8F C4 */	b __destroy_arr
/* 80AA8D28  34 1E 0E 50 */	addic. r0, r30, 0xe50
/* 80AA8D2C  41 82 00 84 */	beq lbl_80AA8DB0
/* 80AA8D30  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80AA8D34  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80AA8D54  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80AA8D58  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80AA8D70  3C 60 80 AB */	lis r3, __vt__8cM3dGCyl@ha
/* 80AA8D74  38 03 DA FC */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80AA8D78  90 1E 0F 88 */	stw r0, 0xf88(r30)
lbl_80AA8D7C:
/* 80AA8D7C  34 1E 0F 54 */	addic. r0, r30, 0xf54
/* 80AA8D80  41 82 00 24 */	beq lbl_80AA8DA4
/* 80AA8D84  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80AA8D88  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80AA8D8C  90 1E 0F 70 */	stw r0, 0xf70(r30)
/* 80AA8D90  34 1E 0F 54 */	addic. r0, r30, 0xf54
/* 80AA8D94  41 82 00 10 */	beq lbl_80AA8DA4
/* 80AA8D98  3C 60 80 AB */	lis r3, __vt__8cM3dGAab@ha
/* 80AA8D9C  38 03 DA F0 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80AA8DA0  90 1E 0F 6C */	stw r0, 0xf6c(r30)
lbl_80AA8DA4:
/* 80AA8DA4  38 7E 0E 50 */	addi r3, r30, 0xe50
/* 80AA8DA8  38 80 00 00 */	li r4, 0
/* 80AA8DAC  4B 5D B3 38 */	b __dt__12dCcD_GObjInfFv
lbl_80AA8DB0:
...
/* 80AA8DC8  4B 82 5F 74 */	b __dl__FPv
lbl_80AA8DCC:
