...
/* 80AA9A10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AA9A14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AA9A18  4B 56 2A 1D */	bl mDoMtx_YrotM__FPA4_fs
/* 80AA9A1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AA9A20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AA9A24  A8 1F 0D 0E */	lha r0, 0xd0e(r31)
/* 80AA9A28  7C 00 00 D0 */	neg r0, r0
/* 80AA9A2C  7C 04 07 34 */	extsh r4, r0
/* 80AA9A30  4B 56 2A 9D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80AA9A34  48 00 00 34 */	b lbl_80AA9A68
lbl_80AA9A38:
/* 80AA9A38  2C 04 00 04 */	cmpwi r4, 4
/* 80AA9A3C  40 82 00 2C */	bne lbl_80AA9A68
/* 80AA9A40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AA9A44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AA9A48  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80AA9A4C  7C 00 00 D0 */	neg r0, r0
/* 80AA9A50  7C 04 07 34 */	extsh r4, r0
/* 80AA9A54  4B 56 29 E1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80AA9A58  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80AA9A5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AA9A60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AA9A64  4B 56 2A 69 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80AA9A68:
