...
/* 80AEB648  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AEB64C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AEB650  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80AEB654  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80AEB658  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80AEB65C  4B 85 B2 8D */	bl PSMTXTrans
/* 80AEB660  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AEB664  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AEB668  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80AEB66C  4B 52 0D C9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80AEB670  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AEB674  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AEB678  80 9F 05 E8 */	lwz r4, 0x5e8(r31)
/* 80AEB67C  38 84 00 24 */	addi r4, r4, 0x24
/* 80AEB680  4B 85 AE 31 */	bl PSMTXCopy
...
/* 80AEB6A0  3C 60 80 AF */	lis r3, lit_4181@ha /* 0x80AEBC44@ha */
/* 80AEB6A4  C0 03 BC 44 */	lfs f0, lit_4181@l(r3)  /* 0x80AEBC44@l */
