...
/* 8057374C  3C 60 80 57 */	lis r3, __vt__10daNpcTkj_c@ha /* 0x805768EC@ha */
/* 80573750  38 03 68 EC */	addi r0, r3, __vt__10daNpcTkj_c@l /* 0x805768EC@l */
...
/* 80573768  4B A9 DB A9 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_8057376C:
/* 8057376C  7F C3 F3 78 */	mr r3, r30
/* 80573770  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 80573774  54 00 10 3A */	slwi r0, r0, 2
/* 80573778  3C 80 80 57 */	lis r4, l_loadResPtrnList@ha /* 0x805766F8@ha */
/* 8057377C  38 84 66 F8 */	addi r4, r4, l_loadResPtrnList@l /* 0x805766F8@l */
/* 80573780  7C 84 00 2E */	lwzx r4, r4, r0
/* 80573784  3C A0 80 57 */	lis r5, l_resNameList@ha /* 0x805766EC@ha */
/* 80573788  38 A5 66 EC */	addi r5, r5, l_resNameList@l /* 0x805766EC@l */
/* 8057378C  4B BD 4D 21 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80573790  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80573794  41 82 00 84 */	beq lbl_80573818
/* 80573798  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 8057379C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 805737BC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 805737C0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 805737D8  3C 60 80 57 */	lis r3, __vt__8cM3dGCyl@ha /* 0x805768E0@ha */
/* 805737DC  38 03 68 E0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x805768E0@l */
/* 805737E0  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_805737E4:
/* 805737E4  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 805737E8  41 82 00 24 */	beq lbl_8057380C
/* 805737EC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805737F0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805737F4  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 805737F8  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 805737FC  41 82 00 10 */	beq lbl_8057380C
/* 80573800  3C 60 80 57 */	lis r3, __vt__8cM3dGAab@ha /* 0x805768D4@ha */
/* 80573804  38 03 68 D4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805768D4@l */
/* 80573808  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_8057380C:
/* 8057380C  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80573810  38 80 00 00 */	li r4, 0
/* 80573814  4B B1 08 D1 */	bl __dt__12dCcD_GObjInfFv
lbl_80573818:
...
/* 80573830  4B D5 B5 0D */	bl __dl__FPv
lbl_80573834:
