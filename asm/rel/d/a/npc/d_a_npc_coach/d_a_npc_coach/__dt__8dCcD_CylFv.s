...
/* 809A37B8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 809A37BC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 809A37DC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 809A37E0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 809A37F8  3C 60 80 9A */	lis r3, __vt__8cM3dGCyl@ha /* 0x809A522C@ha */
/* 809A37FC  38 03 52 2C */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x809A522C@l */
/* 809A3800  90 1E 01 38 */	stw r0, 0x138(r30)
lbl_809A3804:
/* 809A3804  34 1E 01 04 */	addic. r0, r30, 0x104
/* 809A3808  41 82 00 24 */	beq lbl_809A382C
/* 809A380C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 809A3810  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 809A3814  90 1E 01 20 */	stw r0, 0x120(r30)
/* 809A3818  34 1E 01 04 */	addic. r0, r30, 0x104
/* 809A381C  41 82 00 10 */	beq lbl_809A382C
/* 809A3820  3C 60 80 9A */	lis r3, __vt__8cM3dGAab@ha /* 0x809A5220@ha */
/* 809A3824  38 03 52 20 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809A5220@l */
/* 809A3828  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_809A382C:
/* 809A382C  7F C3 F3 78 */	mr r3, r30
/* 809A3830  38 80 00 00 */	li r4, 0
/* 809A3834  4B 6E 08 B1 */	bl __dt__12dCcD_GObjInfFv
/* 809A3838  7F E0 07 35 */	extsh. r0, r31
/* 809A383C  40 81 00 0C */	ble lbl_809A3848
/* 809A3840  7F C3 F3 78 */	mr r3, r30
/* 809A3844  4B 92 B4 F9 */	bl __dl__FPv
lbl_809A3848:
