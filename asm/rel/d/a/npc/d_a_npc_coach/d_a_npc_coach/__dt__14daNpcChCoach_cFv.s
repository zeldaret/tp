...
/* 809A369C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 809A36A0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 809A36C0  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 809A36C4  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 809A36DC  3C 60 80 9A */	lis r3, __vt__8cM3dGSph@ha /* 0x809A5214@ha */
/* 809A36E0  38 03 52 14 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x809A5214@l */
/* 809A36E4  90 1E 07 78 */	stw r0, 0x778(r30)
lbl_809A36E8:
/* 809A36E8  34 1E 07 48 */	addic. r0, r30, 0x748
/* 809A36EC  41 82 00 24 */	beq lbl_809A3710
/* 809A36F0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 809A36F4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 809A36F8  90 1E 07 64 */	stw r0, 0x764(r30)
/* 809A36FC  34 1E 07 48 */	addic. r0, r30, 0x748
/* 809A3700  41 82 00 10 */	beq lbl_809A3710
/* 809A3704  3C 60 80 9A */	lis r3, __vt__8cM3dGAab@ha /* 0x809A5220@ha */
/* 809A3708  38 03 52 20 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809A5220@l */
/* 809A370C  90 1E 07 60 */	stw r0, 0x760(r30)
lbl_809A3710:
/* 809A3710  38 7E 06 44 */	addi r3, r30, 0x644
/* 809A3714  38 80 00 00 */	li r4, 0
/* 809A3718  4B 6E 09 CD */	bl __dt__12dCcD_GObjInfFv
lbl_809A371C:
/* 809A371C  34 1E 06 20 */	addic. r0, r30, 0x620
/* 809A3720  41 82 00 1C */	beq lbl_809A373C
/* 809A3724  3C 60 80 3D */	lis r3, __vt__15Z2SoundObjCoach@ha /* 0x803CB8F0@ha */
/* 809A3728  38 03 B8 F0 */	addi r0, r3, __vt__15Z2SoundObjCoach@l /* 0x803CB8F0@l */
/* 809A372C  90 1E 06 30 */	stw r0, 0x630(r30)
/* 809A3730  38 7E 06 20 */	addi r3, r30, 0x620
/* 809A3734  38 80 00 00 */	li r4, 0
/* 809A3738  4B 91 A8 11 */	bl __dt__14Z2SoundObjBaseFv
lbl_809A373C:
/* 809A373C  34 1E 03 8C */	addic. r0, r30, 0x38c
/* 809A3740  41 82 00 2C */	beq lbl_809A376C
/* 809A3744  3C 60 80 9A */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x809A5238@ha */
/* 809A3748  38 63 52 38 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x809A5238@l */
