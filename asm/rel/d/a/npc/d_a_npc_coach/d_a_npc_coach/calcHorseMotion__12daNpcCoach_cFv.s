...
/* 809A1830  4B 9C 09 9D */	bl _savegpr_25
/* 809A1834  7C 7D 1B 78 */	mr r29, r3
/* 809A1838  3C 60 80 9A */	lis r3, M_attr__12daNpcCoach_c@ha /* 0x809A4ED0@ha */
/* 809A183C  3B E3 4E D0 */	addi r31, r3, M_attr__12daNpcCoach_c@l /* 0x809A4ED0@l */
...
/* 809A1888  4B 6A FF 29 */	bl dPath_GetPnt__FPC5dPathi
...
/* 809A18AC  4B 8C F3 59 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 809A18B0  7C 64 1B 78 */	mr r4, r3
/* 809A18B4  A8 7D 04 DE */	lha r3, 0x4de(r29)
/* 809A18B8  4B 8C F5 6D */	bl cLib_distanceAngleS__Fss
...
/* 809A1920  4B 8C E0 5D */	bl cLib_addCalc__FPfffff
...
/* 809A1938  4B 8C E0 45 */	bl cLib_addCalc__FPfffff
lbl_809A193C:
...
/* 809A195C  4B 92 3B C1 */	bl startWheelSound__15Z2SoundObjCoachFf
lbl_809A1960:
...
/* 809A19B8  3C 60 80 9A */	lis r3, __vt__8cM3dGPla@ha /* 0x809A5280@ha */
/* 809A19BC  38 03 52 80 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x809A5280@l */
/* 809A19C0  90 01 00 30 */	stw r0, 0x30(r1)
/* 809A19C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809A19C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809A19DC  4B 6D 2D 69 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 809A19F0  4B 67 C1 E9 */	bl fopAcM_getPolygonAngle__FPC8cM3dGPlas
/* 809A19F4  3C 80 80 9A */	lis r4, __vt__8cM3dGPla@ha /* 0x809A5280@ha */
/* 809A19F8  38 04 52 80 */	addi r0, r4, __vt__8cM3dGPla@l /* 0x809A5280@l */
...
/* 809A1A0C  3C 60 80 9A */	lis r3, __vt__8cM3dGPla@ha /* 0x809A5280@ha */
/* 809A1A10  38 03 52 80 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x809A5280@l */
...
/* 809A1A28  4B 8C EB 19 */	bl cLib_addCalcAngleS__FPsssss
/* 809A1A2C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 809A1A30  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 809A1A60  4B 67 8C 6D */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 809A1A64  A8 1D 04 E6 */	lha r0, 0x4e6(r29)
/* 809A1A68  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 809A1A6C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 809A1A70  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 809A1ABC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809A1AC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809A1AD4  4B 8C D7 09 */	bl SetC__8cM3dGCylFRC4cXyz
/* 809A1AD8  7F 43 D3 78 */	mr r3, r26
/* 809A1ADC  38 99 07 4C */	addi r4, r25, 0x74c
/* 809A1AE0  4B 8C 30 C9 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 809A1B14  4B 6D 4F 99 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 809A1B4C  4B 66 B2 19 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 809A1B50  38 7D 04 E4 */	addi r3, r29, 0x4e4
/* 809A1B54  4B 66 B3 F1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 809A1B58  80 7D 05 68 */	lwz r3, 0x568(r29)
/* 809A1B5C  80 83 00 04 */	lwz r4, 4(r3)
/* 809A1B60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809A1B64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809A1B68  38 84 00 24 */	addi r4, r4, 0x24
/* 809A1B6C  4B 9A 49 45 */	bl PSMTXCopy
...
/* 809A1B84  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809A1B88  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809A1B8C  4B 9A 49 25 */	bl PSMTXCopy
/* 809A1B90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809A1B94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 809A1BCC  4B 9C 06 4D */	bl _restgpr_25
