...
/* 80AC9980  3C 60 80 AD */	lis r3, l_bmdData@ha /* 0x80ACB450@ha */
/* 80AC9984  38 83 B4 50 */	addi r4, r3, l_bmdData@l /* 0x80ACB450@l */
/* 80AC9988  80 04 00 04 */	lwz r0, 4(r4)
/* 80AC998C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC9990  3C 60 80 AD */	lis r3, l_resNameList@ha /* 0x80ACB470@ha */
/* 80AC9994  38 63 B4 70 */	addi r3, r3, l_resNameList@l /* 0x80ACB470@l */
/* 80AC9998  7C 63 00 2E */	lwzx r3, r3, r0
/* 80AC999C  80 84 00 00 */	lwz r4, 0(r4)
/* 80AC99A0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AC99A4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AC99A8  3C A5 00 02 */	addis r5, r5, 2
/* 80AC99AC  38 C0 00 80 */	li r6, 0x80
/* 80AC99B0  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80AC99B4  4B 57 29 39 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80AC99B8  7C 7E 1B 78 */	mr r30, r3
/* 80AC99BC  38 60 00 58 */	li r3, 0x58
/* 80AC99C0  4B 80 52 8D */	bl __nw__FUl
...
/* 80AC99FC  3D 20 80 AD */	lis r9, lit_4215@ha /* 0x80ACB3FC@ha */
/* 80AC9A00  C0 29 B3 FC */	lfs f1, lit_4215@l(r9)  /* 0x80ACB3FC@l */
/* 80AC9A04  39 20 00 00 */	li r9, 0
/* 80AC9A08  39 40 FF FF */	li r10, -1
/* 80AC9A0C  4B 54 6D C5 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80AC9A30  4B 54 78 E1 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
...
/* 80AC9A64  4B 68 09 25 */	bl setFaceMotionAnm__8daNpcT_cFib
...
/* 80AC9A78  3C A0 80 AD */	lis r5, lit_4089@ha /* 0x80ACB3F0@ha */
/* 80AC9A7C  C0 25 B3 F0 */	lfs f1, lit_4089@l(r5)  /* 0x80ACB3F0@l */
