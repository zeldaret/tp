...
/* 809EBD28  4B 97 64 A9 */	bl _savegpr_26
/* 809EBD2C  7C 7C 1B 78 */	mr r28, r3
/* 809EBD30  3C 60 80 9F */	lis r3, cNullVec__6Z2Calc@ha /* 0x809EF6A0@ha */
/* 809EBD34  3B E3 F6 A0 */	addi r31, r3, cNullVec__6Z2Calc@l /* 0x809EF6A0@l */
/* 809EBD38  3B A0 00 00 */	li r29, 0
/* 809EBD3C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809EBD40  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809EBDD0  4B 76 7B 85 */	bl changeEvent__8daNpcF_cFPcPcUsUs
...
/* 809EBE10  4B 97 62 75 */	bl __ptmf_scall
/* 809EBE14  60 00 00 00 */	nop 
/* 809EBE18  48 00 00 64 */	b lbl_809EBE7C
lbl_809EBE1C:
/* 809EBE1C  38 00 00 00 */	li r0, 0
/* 809EBE20  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809EBE24  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809EBE4C  4B 65 C9 A5 */	bl ChkPresentEnd__16dEvent_manager_cFv
...
/* 809EBE94  4B 65 BC 89 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 809EBEC0  4B 65 BF 51 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 809EBEDC  4B 97 61 A9 */	bl __ptmf_scall
...
/* 809EBEF4  4B 65 C2 89 */	bl cutEnd__16dEvent_manager_cFi
lbl_809EBEF8:
...
/* 809EBF18  4B 65 BB 61 */	bl endCheck__16dEvent_manager_cFs
...
/* 809EBF38  4B 65 65 31 */	bl reset__14dEvt_control_cFv
...
/* 809EBF4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809EBF50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809EBF54  88 9C 1A 98 */	lbz r4, 0x1a98(r28)
/* 809EBF58  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 809EBF5C  7C 05 07 74 */	extsb r5, r0
/* 809EBF60  4B 64 92 A1 */	bl onSwitch__10dSv_info_cFii
/* 809EBF64  7F 83 E3 78 */	mr r3, r28
/* 809EBF68  4B 62 DD 15 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 809EBF6C  48 00 00 40 */	b lbl_809EBFAC
lbl_809EBF70:
/* 809EBF70  38 7B 4E C8 */	addi r3, r27, 0x4ec8
/* 809EBF74  4B 65 64 F5 */	bl reset__14dEvt_control_cFv
...
/* 809EBFC4  4B 76 77 55 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 809EBFE4  3C A0 80 9F */	lis r5, lit_4685@ha /* 0x809EF2B0@ha */
/* 809EBFE8  C0 25 F2 B0 */	lfs f1, lit_4685@l(r5)  /* 0x809EF2B0@l */
...
/* 809EC004  3C A0 80 9F */	lis r5, lit_4685@ha /* 0x809EF2B0@ha */
/* 809EC008  C0 25 F2 B0 */	lfs f1, lit_4685@l(r5)  /* 0x809EF2B0@l */
...
/* 809EC088  3C 60 80 3A */	lis r3, __ptmf_null@ha /* 0x803A2180@ha */
/* 809EC08C  38 83 21 80 */	addi r4, r3, __ptmf_null@l /* 0x803A2180@l */
...
/* 809EC0B8  4B 97 61 65 */	bl _restgpr_26
