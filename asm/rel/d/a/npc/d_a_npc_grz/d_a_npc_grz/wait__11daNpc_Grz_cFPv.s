...
/* 809EC50C  3C A0 80 9F */	lis r5, lit_4685@ha /* 0x809EF2B0@ha */
/* 809EC510  C0 25 F2 B0 */	lfs f1, lit_4685@l(r5)  /* 0x809EF2B0@l */
...
/* 809EC52C  3C A0 80 9F */	lis r5, lit_4685@ha /* 0x809EF2B0@ha */
/* 809EC530  C0 25 F2 B0 */	lfs f1, lit_4685@l(r5)  /* 0x809EF2B0@l */
...
/* 809EC550  3C A0 80 9F */	lis r5, lit_4685@ha /* 0x809EF2B0@ha */
/* 809EC554  C0 25 F2 B0 */	lfs f1, lit_4685@l(r5)  /* 0x809EF2B0@l */
...
/* 809EC570  3C A0 80 9F */	lis r5, lit_4685@ha /* 0x809EF2B0@ha */
/* 809EC574  C0 25 F2 B0 */	lfs f1, lit_4685@l(r5)  /* 0x809EF2B0@l */
...
/* 809EC5C4  4B 62 D6 B9 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_809EC5C8:
...
/* 809EC5D8  4B 76 41 15 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809EC5F4  4B 76 83 ED */	bl chkFindPlayer2__8daNpcF_cFis
...
/* 809EC60C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809EC610  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809EC614  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 809EC618  4B 76 40 A5 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 809EC634  4B 76 40 AD */	bl remove__18daNpcF_ActorMngr_cFv
/* 809EC638  38 00 00 00 */	li r0, 0
/* 809EC63C  90 1F 09 6C */	stw r0, 0x96c(r31)
lbl_809EC640:
/* 809EC640  38 7F 12 A8 */	addi r3, r31, 0x12a8
/* 809EC644  4B 76 40 A9 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809EC698  4B 76 7A 0D */	bl step__8daNpcF_cFsiii
...
/* 809EC6C0  4B 76 79 E5 */	bl step__8daNpcF_cFsiii
...
/* 809EC6E8  4B 76 40 05 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809EC6FC  3C A0 80 15 */	lis r5, srchAttnActor1__8daNpcF_cFPvPv@ha /* 0x80152654@ha */
/* 809EC700  38 A5 26 54 */	addi r5, r5, srchAttnActor1__8daNpcF_cFPvPv@l /* 0x80152654@l */
/* 809EC704  3C C0 80 9F */	lis r6, m__17daNpc_Grz_Param_c@ha /* 0x809EF1F4@ha */
/* 809EC708  38 C6 F1 F4 */	addi r6, r6, m__17daNpc_Grz_Param_c@l /* 0x809EF1F4@l */
...
/* 809EC728  4B 76 7C 45 */	bl getAttnActorP__8daNpcF_cFiPFPvPv_Pvffffsii
/* 809EC72C  7C 64 1B 79 */	or. r4, r3, r3
/* 809EC730  41 82 00 24 */	beq lbl_809EC754
/* 809EC734  38 7F 12 B0 */	addi r3, r31, 0x12b0
/* 809EC738  4B 76 3F 85 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
