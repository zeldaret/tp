...
/* 80AB36B8  4B 8A EB 21 */	bl _savegpr_28
...
/* 80AB36CC  3C 60 80 AB */	lis r3, lit_4241@ha /* 0x80AB5890@ha */
/* 80AB36D0  38 83 58 90 */	addi r4, r3, lit_4241@l /* 0x80AB5890@l */
...
/* 80AB3708  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AB370C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AB3710  4B 89 2D A1 */	bl PSMTXCopy
/* 80AB3714  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AB3718  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80AB374C  4B 89 2D 65 */	bl PSMTXCopy
...
/* 80AB377C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AB3780  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AB3784  4B 89 2D 2D */	bl PSMTXCopy
...
/* 80AB37B0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AB37B4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AB37B8  4B 89 2C F9 */	bl PSMTXCopy
...
/* 80AB37DC  3C C0 80 AB */	lis r6, m__17daNpcPray_Param_c@ha /* 0x80AB5808@ha */
/* 80AB37E0  38 C6 58 08 */	addi r6, r6, m__17daNpcPray_Param_c@l /* 0x80AB5808@l */
/* 80AB37E4  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80AB37E8  4B 69 FB 95 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80AB37EC:
/* 80AB37EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AB37F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AB37F4  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80AB37F8  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80AB37FC  7C 80 E2 14 */	add r4, r0, r28
/* 80AB3800  4B 89 2C B1 */	bl PSMTXCopy
/* 80AB3804  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AB3808  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AB380C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80AB3810  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80AB3814  4B 89 2C 9D */	bl PSMTXCopy
/* 80AB3818  38 60 00 01 */	li r3, 1
/* 80AB381C  39 61 00 30 */	addi r11, r1, 0x30
/* 80AB3820  4B 8A EA 05 */	bl _restgpr_28
