...
/* 80AB3B34  3C 80 80 AB */	lis r4, l_bckGetParamList@ha /* 0x80AB59A4@ha */
/* 80AB3B38  38 A4 59 A4 */	addi r5, r4, l_bckGetParamList@l /* 0x80AB59A4@l */
/* 80AB3B3C  7C 85 F2 14 */	add r4, r5, r30
/* 80AB3B40  80 04 00 08 */	lwz r0, 8(r4)
/* 80AB3B44  54 00 10 3A */	slwi r0, r0, 2
/* 80AB3B48  3C 80 80 AB */	lis r4, l_arcNames@ha /* 0x80AB59EC@ha */
/* 80AB3B4C  38 84 59 EC */	addi r4, r4, l_arcNames@l /* 0x80AB59EC@l */
/* 80AB3B50  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AB3B54  7C A5 F0 2E */	lwzx r5, r5, r30
/* 80AB3B58  4B 69 EF D5 */	bl getTrnsfrmKeyAnmP__8daNpcF_cFPci
/* 80AB3B5C  7C 64 1B 79 */	or. r4, r3, r3
/* 80AB3B60  3C 60 80 AB */	lis r3, l_bckGetParamList@ha /* 0x80AB59A4@ha */
/* 80AB3B64  38 03 59 A4 */	addi r0, r3, l_bckGetParamList@l /* 0x80AB59A4@l */
...
/* 80AB3B88  3C C0 80 AB */	lis r6, lit_4220@ha /* 0x80AB5884@ha */
/* 80AB3B8C  C0 26 58 84 */	lfs f1, lit_4220@l(r6)  /* 0x80AB5884@l */
/* 80AB3B90  FC 40 F8 90 */	fmr f2, f31
/* 80AB3B94  38 C0 00 00 */	li r6, 0
/* 80AB3B98  38 E0 FF FF */	li r7, -1
/* 80AB3B9C  4B 69 F0 81 */	bl setMcaMorfAnm__8daNpcF_cFP18J3DAnmTransformKeyffiii
