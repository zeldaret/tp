...
/* 80AB43F0  4B 8A DD ED */	bl _savegpr_29
/* 80AB43F4  7C 7E 1B 78 */	mr r30, r3
/* 80AB43F8  3C 80 80 AB */	lis r4, cNullVec__6Z2Calc@ha /* 0x80AB5984@ha */
/* 80AB43FC  3B E4 59 84 */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x80AB5984@l */
/* 80AB4400  3C 80 80 AB */	lis r4, m__17daNpcPray_Param_c@ha /* 0x80AB5808@ha */
/* 80AB4404  3B A4 58 08 */	addi r29, r4, m__17daNpcPray_Param_c@l /* 0x80AB5808@l */
...
/* 80AB4460  4B 69 C2 8D */	bl getActorP__18daNpcF_ActorMngr_cFv
...
lbl_80AB44D4:
/* 80AB44D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AB44D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AB451C  4B 59 42 D5 */	bl ChkPresentEnd__16dEvent_manager_cFv
...
/* 80AB4560  4B 59 35 BD */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
lbl_80AB4594:
/* 80AB4594  4B 6F 7F E9 */	bl dKy_darkworld_check__Fv
/* 80AB4598  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80AB459C  40 82 00 70 */	bne lbl_80AB460C
/* 80AB45A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AB45A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AB45C0  4B 8B 81 C1 */	bl pow
/* 80AB45C4  FF E0 08 18 */	frsp f31, f1
/* 80AB45C8  7F C3 F3 78 */	mr r3, r30
/* 80AB45CC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AB45D0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AB45D4  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80AB45D8  4B 56 64 BD */	bl fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80AB464C  4B 69 F2 31 */	bl orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_80AB4650:
...
/* 80AB4660  4B 8A DB C9 */	bl _restgpr_29
