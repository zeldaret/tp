...
/* 8054CB00  4B E1 56 D5 */	bl _savegpr_27
...
/* 8054CB14  4B B3 6D 1D */	bl Move__10dCcD_GSttsFv
...
/* 8054CBF0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CBF4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8054CBF8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8054CBFC  7C 05 07 74 */	extsb r5, r0
/* 8054CC00  4B AE 87 61 */	bl isSwitch__10dSv_info_cCFii
/* 8054CC04  2C 03 00 00 */	cmpwi r3, 0
/* 8054CC08  40 82 01 C8 */	bne lbl_8054CDD0
/* 8054CC0C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CC10  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8054CC24  4B AE 85 DD */	bl onSwitch__10dSv_info_cFii
...
/* 8054CC48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CC4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8054CC50  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8054CC54  7C 05 07 74 */	extsb r5, r0
/* 8054CC58  4B AE 87 09 */	bl isSwitch__10dSv_info_cCFii
/* 8054CC5C  2C 03 00 00 */	cmpwi r3, 0
/* 8054CC60  40 82 01 70 */	bne lbl_8054CDD0
/* 8054CC64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CC68  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8054CC7C  4B AE 85 85 */	bl onSwitch__10dSv_info_cFii
...
/* 8054CCA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CCA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8054CCA8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8054CCAC  7C 05 07 74 */	extsb r5, r0
/* 8054CCB0  4B AE 86 B1 */	bl isSwitch__10dSv_info_cCFii
/* 8054CCB4  2C 03 00 00 */	cmpwi r3, 0
/* 8054CCB8  40 82 00 20 */	bne lbl_8054CCD8
/* 8054CCBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CCC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8054CCD4  4B AE 85 2D */	bl onSwitch__10dSv_info_cFii
lbl_8054CCD8:
/* 8054CCD8  3B 60 00 01 */	li r27, 1
/* 8054CCDC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CCE0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8054CCF4  4B AE 7D 11 */	bl getEventReg__11dSv_event_cCFUs
...
/* 8054CD10  4B AE 7C D1 */	bl setEventReg__11dSv_event_cFUsUc
...
/* 8054CD28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CD2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8054CD30  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8054CD34  7C 05 07 74 */	extsb r5, r0
/* 8054CD38  4B AE 86 29 */	bl isSwitch__10dSv_info_cCFii
/* 8054CD3C  2C 03 00 00 */	cmpwi r3, 0
/* 8054CD40  40 82 00 20 */	bne lbl_8054CD60
/* 8054CD44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CD48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8054CD5C  4B AE 84 A5 */	bl onSwitch__10dSv_info_cFii
lbl_8054CD60:
/* 8054CD60  3B 60 00 02 */	li r27, 2
lbl_8054CD64:
/* 8054CD64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CD68  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8054CD6C  3B 83 56 B8 */	addi r28, r3, 0x56b8
/* 8054CD70  7F 83 E3 78 */	mr r3, r28
/* 8054CD74  38 80 00 00 */	li r4, 0
/* 8054CD78  4B B2 3A CD */	bl GetLockonList__12dAttention_cFl
/* 8054CD7C  28 03 00 00 */	cmplwi r3, 0
/* 8054CD80  41 82 00 34 */	beq lbl_8054CDB4
/* 8054CD84  7F 83 E3 78 */	mr r3, r28
/* 8054CD88  4B B2 6A 5D */	bl LockonTruth__12dAttention_cFv
...
/* 8054CD9C  4B B2 3A A9 */	bl GetLockonList__12dAttention_cFl
/* 8054CDA0  4B B2 6A C5 */	bl getActor__10dAttList_cFv
...
lbl_8054CDB4:
/* 8054CDB4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8054CDB8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8054CDCC  4B AE 7C 15 */	bl setEventReg__11dSv_event_cFUsUc
lbl_8054CDD0:
/* 8054CDD0  88 7E 00 74 */	lbz r3, 0x74(r30)
/* 8054CDD4  38 80 00 00 */	li r4, 0
/* 8054CDD8  4B B3 77 D9 */	bl getHitSeID__12dCcD_GObjInfFUci
...
/* 8054CE80  4B D7 16 25 */	bl startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
lbl_8054CE84:
/* 8054CE84  7F A3 EB 78 */	mr r3, r29
/* 8054CE88  39 61 00 20 */	addi r11, r1, 0x20
/* 8054CE8C  4B E1 53 95 */	bl _restgpr_27
