...
/* 8054DA68  3C 60 80 3B */	lis r3, __vt__8daNpcT_c@ha
/* 8054DA6C  38 03 3A 78 */	addi r0, r3, __vt__8daNpcT_c@l
...
/* 8054DA80  3C 80 80 55 */	lis r4, __dt__5csXyzFv@ha
/* 8054DA84  38 84 DE D8 */	addi r4, r4, __dt__5csXyzFv@l
/* 8054DA88  38 A0 00 06 */	li r5, 6
/* 8054DA8C  38 C0 00 02 */	li r6, 2
/* 8054DA90  4B E1 42 58 */	b __destroy_arr
lbl_8054DA94:
/* 8054DA94  34 1E 0B A8 */	addic. r0, r30, 0xba8
/* 8054DA98  41 82 00 B4 */	beq lbl_8054DB4C
/* 8054DA9C  3C 60 80 55 */	lis r3, __vt__15daNpcT_JntAnm_c@ha
/* 8054DAA0  38 03 F0 A4 */	addi r0, r3, __vt__15daNpcT_JntAnm_c@l
/* 8054DAA4  90 1E 0D 04 */	stw r0, 0xd04(r30)
/* 8054DAA8  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 8054DAAC  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054DAB0  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
/* 8054DAB4  38 A0 00 0C */	li r5, 0xc
/* 8054DAB8  38 C0 00 03 */	li r6, 3
/* 8054DABC  4B E1 42 2C */	b __destroy_arr
/* 8054DAC0  38 7E 0C 68 */	addi r3, r30, 0xc68
/* 8054DAC4  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054DAC8  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
/* 8054DACC  38 A0 00 0C */	li r5, 0xc
/* 8054DAD0  38 C0 00 03 */	li r6, 3
/* 8054DAD4  4B E1 42 14 */	b __destroy_arr
/* 8054DAD8  38 7E 0C 44 */	addi r3, r30, 0xc44
/* 8054DADC  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054DAE0  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
/* 8054DAE4  38 A0 00 0C */	li r5, 0xc
/* 8054DAE8  38 C0 00 03 */	li r6, 3
/* 8054DAEC  4B E1 41 FC */	b __destroy_arr
/* 8054DAF0  38 7E 0C 20 */	addi r3, r30, 0xc20
/* 8054DAF4  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054DAF8  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
/* 8054DAFC  38 A0 00 0C */	li r5, 0xc
/* 8054DB00  38 C0 00 03 */	li r6, 3
/* 8054DB04  4B E1 41 E4 */	b __destroy_arr
/* 8054DB08  38 7E 0B FC */	addi r3, r30, 0xbfc
/* 8054DB0C  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054DB10  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
/* 8054DB14  38 A0 00 0C */	li r5, 0xc
/* 8054DB18  38 C0 00 03 */	li r6, 3
/* 8054DB1C  4B E1 41 CC */	b __destroy_arr
/* 8054DB20  38 7E 0B D8 */	addi r3, r30, 0xbd8
/* 8054DB24  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054DB28  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
/* 8054DB2C  38 A0 00 0C */	li r5, 0xc
/* 8054DB30  38 C0 00 03 */	li r6, 3
/* 8054DB34  4B E1 41 B4 */	b __destroy_arr
/* 8054DB38  34 1E 0B A8 */	addic. r0, r30, 0xba8
/* 8054DB3C  41 82 00 10 */	beq lbl_8054DB4C
/* 8054DB40  3C 60 80 55 */	lis r3, __vt__18daNpcT_ActorMngr_c@ha
/* 8054DB44  38 03 F0 98 */	addi r0, r3, __vt__18daNpcT_ActorMngr_c@l
/* 8054DB48  90 1E 0B AC */	stw r0, 0xbac(r30)
lbl_8054DB4C:
/* 8054DB4C  34 1E 0B A0 */	addic. r0, r30, 0xba0
/* 8054DB50  41 82 00 10 */	beq lbl_8054DB60
/* 8054DB54  3C 60 80 55 */	lis r3, __vt__18daNpcT_ActorMngr_c@ha
/* 8054DB58  38 03 F0 98 */	addi r0, r3, __vt__18daNpcT_ActorMngr_c@l
/* 8054DB5C  90 1E 0B A4 */	stw r0, 0xba4(r30)
lbl_8054DB60:
/* 8054DB60  34 1E 0B 98 */	addic. r0, r30, 0xb98
/* 8054DB64  41 82 00 10 */	beq lbl_8054DB74
/* 8054DB68  3C 60 80 55 */	lis r3, __vt__18daNpcT_ActorMngr_c@ha
/* 8054DB6C  38 03 F0 98 */	addi r0, r3, __vt__18daNpcT_ActorMngr_c@l
/* 8054DB70  90 1E 0B 9C */	stw r0, 0xb9c(r30)
lbl_8054DB74:
/* 8054DB74  34 1E 0B 74 */	addic. r0, r30, 0xb74
/* 8054DB78  41 82 00 10 */	beq lbl_8054DB88
/* 8054DB7C  3C 60 80 55 */	lis r3, __vt__22daNpcT_MotionSeqMngr_c@ha
/* 8054DB80  38 03 F0 8C */	addi r0, r3, __vt__22daNpcT_MotionSeqMngr_c@l
/* 8054DB84  90 1E 0B 94 */	stw r0, 0xb94(r30)
lbl_8054DB88:
/* 8054DB88  34 1E 0B 50 */	addic. r0, r30, 0xb50
/* 8054DB8C  41 82 00 10 */	beq lbl_8054DB9C
/* 8054DB90  3C 60 80 55 */	lis r3, __vt__22daNpcT_MotionSeqMngr_c@ha
/* 8054DB94  38 03 F0 8C */	addi r0, r3, __vt__22daNpcT_MotionSeqMngr_c@l
/* 8054DB98  90 1E 0B 70 */	stw r0, 0xb70(r30)
lbl_8054DB9C:
/* 8054DB9C  38 7E 0A E0 */	addi r3, r30, 0xae0
/* 8054DBA0  38 80 FF FF */	li r4, -1
/* 8054DBA4  4B B2 A1 38 */	b __dt__11dBgS_LinChkFv
/* 8054DBA8  38 7E 0A 8C */	addi r3, r30, 0xa8c
/* 8054DBAC  38 80 FF FF */	li r4, -1
/* 8054DBB0  4B B2 9A 40 */	b __dt__11dBgS_GndChkFv
/* 8054DBB4  34 1E 0A 40 */	addic. r0, r30, 0xa40
/* 8054DBB8  41 82 00 54 */	beq lbl_8054DC0C
/* 8054DBBC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 8054DBC0  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 8054DC74  3C 60 80 55 */	lis r3, __vt__10dCcD_GStts@ha
/* 8054DC78  38 03 F0 80 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 8054DC7C  90 1E 08 80 */	stw r0, 0x880(r30)
/* 8054DC80  34 1E 08 80 */	addic. r0, r30, 0x880
/* 8054DC84  41 82 00 10 */	beq lbl_8054DC94
/* 8054DC88  3C 60 80 55 */	lis r3, __vt__10cCcD_GStts@ha
/* 8054DC8C  38 03 F0 74 */	addi r0, r3, __vt__10cCcD_GStts@l
/* 8054DC90  90 1E 08 80 */	stw r0, 0x880(r30)
lbl_8054DC94:
/* 8054DC94  34 1E 08 64 */	addic. r0, r30, 0x864
/* 8054DC98  41 82 00 10 */	beq lbl_8054DCA8
/* 8054DC9C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 8054DCA0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 8054DCA4  90 1E 08 7C */	stw r0, 0x87c(r30)
lbl_8054DCA8:
/* 8054DCA8  34 1E 06 8C */	addic. r0, r30, 0x68c
/* 8054DCAC  41 82 00 2C */	beq lbl_8054DCD8
/* 8054DCB0  3C 60 80 55 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 8054DCB4  38 63 F0 44 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 8054DCD4  4B B2 82 C0 */	b __dt__9dBgS_AcchFv
lbl_8054DCD8:
...
/* 8054DCF0  3C 60 80 55 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8054DCF4  38 03 F0 38 */	addi r0, r3, __vt__12J3DFrameCtrl@l
...
/* 8054DD14  3C 60 80 55 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8054DD18  38 03 F0 38 */	addi r0, r3, __vt__12J3DFrameCtrl@l
...
/* 8054DD38  3C 60 80 55 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8054DD3C  38 03 F0 38 */	addi r0, r3, __vt__12J3DFrameCtrl@l
...
/* 8054DD5C  3C 60 80 55 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8054DD60  38 03 F0 38 */	addi r0, r3, __vt__12J3DFrameCtrl@l
