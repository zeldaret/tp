...
/* 80AC5A04  4B 89 C7 D9 */	bl _savegpr_29
/* 80AC5A08  7C 7D 1B 78 */	mr r29, r3
/* 80AC5A0C  3B C0 00 00 */	li r30, 0
/* 80AC5A10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AC5A14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AC5A18  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 80AC5A1C  7F E3 FB 78 */	mr r3, r31
/* 80AC5A20  3C 80 80 AC */	lis r4, d_a_npc_seib__stringBase0@ha /* 0x80AC70D0@ha */
/* 80AC5A24  38 84 70 D0 */	addi r4, r4, d_a_npc_seib__stringBase0@l /* 0x80AC70D0@l */
/* 80AC5A28  38 84 00 22 */	addi r4, r4, 0x22
/* 80AC5A2C  7F A5 EB 78 */	mr r5, r29
/* 80AC5A30  38 C0 FF FF */	li r6, -1
/* 80AC5A34  4B 58 20 E9 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80AC5A4C  3C A0 80 AC */	lis r5, mCutNameList__12daNpc_seiB_c@ha /* 0x80AC7228@ha */
/* 80AC5A50  38 A5 72 28 */	addi r5, r5, mCutNameList__12daNpc_seiB_c@l /* 0x80AC7228@l */
/* 80AC5A54  38 C0 00 01 */	li r6, 1
/* 80AC5A58  38 E0 00 00 */	li r7, 0
/* 80AC5A5C  39 00 00 00 */	li r8, 0
/* 80AC5A60  4B 58 23 B1 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 80AC5A74  3C A0 80 AC */	lis r5, mCutList__12daNpc_seiB_c@ha /* 0x80AC722C@ha */
/* 80AC5A78  38 05 72 2C */	addi r0, r5, mCutList__12daNpc_seiB_c@l /* 0x80AC722C@l */
/* 80AC5A7C  7D 80 32 14 */	add r12, r0, r6
/* 80AC5A80  4B 89 C6 05 */	bl __ptmf_scall
