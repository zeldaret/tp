...
/* 80AC510C  3C 60 80 AC */	lis r3, __vt__12daNpc_seiB_c@ha /* 0x80AC7364@ha */
/* 80AC5110  38 03 73 64 */	addi r0, r3, __vt__12daNpc_seiB_c@l /* 0x80AC7364@l */
...
/* 80AC5128  4B 54 C1 E9 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AC512C:
/* 80AC512C  7F C3 F3 78 */	mr r3, r30
/* 80AC5130  88 1E 0E 44 */	lbz r0, 0xe44(r30)
/* 80AC5134  54 00 10 3A */	slwi r0, r0, 2
/* 80AC5138  3C 80 80 AC */	lis r4, l_loadResPtrnList@ha /* 0x80AC7144@ha */
/* 80AC513C  38 84 71 44 */	addi r4, r4, l_loadResPtrnList@l /* 0x80AC7144@l */
/* 80AC5140  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AC5144  3C A0 80 AC */	lis r5, l_resNameList@ha /* 0x80AC7138@ha */
/* 80AC5148  38 A5 71 38 */	addi r5, r5, l_resNameList@l /* 0x80AC7138@l */
/* 80AC514C  4B 68 33 61 */	bl deleteRes__8daNpcT_cFPCScPPCc
...
/* 80AC5168  4B 80 9B D5 */	bl __dl__FPv
lbl_80AC516C:
