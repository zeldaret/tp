...
/* 80AB0AC4  4B 69 B1 2D */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80AB0B28  4B 69 B1 51 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 80AB0B3C  4B 79 99 ED */	bl getEventId__10dMsgFlow_cFPi
...
/* 80AB0B84  4B 56 B0 65 */	bl fopAcM_createItemForPresentDemo__FPC4cXyziUciiPC5csXyzPC4cXyz
/* 80AB0B88  90 7F 0D 90 */	stw r3, 0xd90(r31)
lbl_80AB0B8C:
/* 80AB0B8C  80 7F 0D 90 */	lwz r3, 0xd90(r31)
/* 80AB0B90  4B 57 08 0D */	bl fpcEx_IsExist__FUi
...
/* 80AB0BAC  4B 69 96 79 */	bl evtChange__8daNpcT_cFv
...
/* 80AB0BC4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AB0BC8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AB0BCC  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80AB0BD0  4B 69 4B 11 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80AB0BD4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AB0BD8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AB0BDC  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80AB0BE0  4B 59 18 89 */	bl reset__14dEvt_control_cFv
...
/* 80AB0BFC  4B 69 4B 01 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AB0C00  38 00 00 00 */	li r0, 0
/* 80AB0C04  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AB0C08  3C 60 80 AB */	lis r3, lit_4204@ha /* 0x80AB20B8@ha */
/* 80AB0C0C  C0 03 20 B8 */	lfs f0, lit_4204@l(r3)  /* 0x80AB20B8@l */
...
/* 80AB0C60  4B 69 4A 9D */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AB0C64  38 00 00 00 */	li r0, 0
/* 80AB0C68  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AB0C6C  3C 60 80 AB */	lis r3, lit_4204@ha /* 0x80AB20B8@ha */
/* 80AB0C70  C0 03 20 B8 */	lfs f0, lit_4204@l(r3)  /* 0x80AB20B8@l */
...
/* 80AB0C9C  4B 69 4A 61 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AB0CA0  38 00 00 00 */	li r0, 0
/* 80AB0CA4  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AB0CA8  3C 60 80 AB */	lis r3, lit_4204@ha /* 0x80AB20B8@ha */
/* 80AB0CAC  C0 03 20 B8 */	lfs f0, lit_4204@l(r3)  /* 0x80AB20B8@l */
...
/* 80AB0CE0  4B 69 A9 69 */	bl step__8daNpcT_cFsiiii
lbl_80AB0CE4:
