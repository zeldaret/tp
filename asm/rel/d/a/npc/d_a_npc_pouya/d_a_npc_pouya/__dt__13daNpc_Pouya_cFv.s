...
/* 80AADDCC  3C 60 80 AB */	lis r3, __vt__13daNpc_Pouya_c@ha /* 0x80AB2C14@ha */
/* 80AADDD0  38 03 2C 14 */	addi r0, r3, __vt__13daNpc_Pouya_c@l /* 0x80AB2C14@l */
...
/* 80AADDE4  4B 56 35 2D */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AADDE8:
/* 80AADDE8  7F C3 F3 78 */	mr r3, r30
/* 80AADDEC  88 1E 0F 84 */	lbz r0, 0xf84(r30)
/* 80AADDF0  54 00 10 3A */	slwi r0, r0, 2
/* 80AADDF4  3C 80 80 AB */	lis r4, l_loadResPtrnList@ha /* 0x80AB2284@ha */
/* 80AADDF8  38 84 22 84 */	addi r4, r4, l_loadResPtrnList@l /* 0x80AB2284@l */
/* 80AADDFC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AADE00  3C A0 80 AB */	lis r5, l_resNameList@ha /* 0x80AB2270@ha */
/* 80AADE04  38 A5 22 70 */	addi r5, r5, l_resNameList@l /* 0x80AB2270@l */
/* 80AADE08  4B 69 A6 A5 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80AADE0C  34 1E 0F 88 */	addic. r0, r30, 0xf88
/* 80AADE10  41 82 00 10 */	beq lbl_80AADE20
/* 80AADE14  3C 60 80 AB */	lis r3, __vt__13daNpcT_Path_c@ha /* 0x80AB2C08@ha */
/* 80AADE18  38 03 2C 08 */	addi r0, r3, __vt__13daNpcT_Path_c@l /* 0x80AB2C08@l */
/* 80AADE1C  90 1E 0F AC */	stw r0, 0xfac(r30)
lbl_80AADE20:
/* 80AADE20  34 1E 0E 48 */	addic. r0, r30, 0xe48
/* 80AADE24  41 82 00 84 */	beq lbl_80AADEA8
/* 80AADE28  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80AADE2C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80AADE4C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80AADE50  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80AADE68  3C 60 80 AB */	lis r3, __vt__8cM3dGCyl@ha /* 0x80AB2BFC@ha */
/* 80AADE6C  38 03 2B FC */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80AB2BFC@l */
/* 80AADE70  90 1E 0F 80 */	stw r0, 0xf80(r30)
lbl_80AADE74:
/* 80AADE74  34 1E 0F 4C */	addic. r0, r30, 0xf4c
/* 80AADE78  41 82 00 24 */	beq lbl_80AADE9C
/* 80AADE7C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80AADE80  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80AADE84  90 1E 0F 68 */	stw r0, 0xf68(r30)
/* 80AADE88  34 1E 0F 4C */	addic. r0, r30, 0xf4c
/* 80AADE8C  41 82 00 10 */	beq lbl_80AADE9C
/* 80AADE90  3C 60 80 AB */	lis r3, __vt__8cM3dGAab@ha /* 0x80AB2BF0@ha */
/* 80AADE94  38 03 2B F0 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80AB2BF0@l */
/* 80AADE98  90 1E 0F 64 */	stw r0, 0xf64(r30)
lbl_80AADE9C:
/* 80AADE9C  38 7E 0E 48 */	addi r3, r30, 0xe48
/* 80AADEA0  38 80 00 00 */	li r4, 0
/* 80AADEA4  4B 5D 62 41 */	bl __dt__12dCcD_GObjInfFv
lbl_80AADEA8:
...
/* 80AADEC0  4B 82 0E 7D */	bl __dl__FPv
lbl_80AADEC4:
