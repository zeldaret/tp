...
/* 80AB1B24  4B 8B 06 B8 */	b _savegpr_29
/* 80AB1B28  7C 7F 1B 78 */	mr r31, r3
/* 80AB1B2C  7C 80 23 78 */	mr r0, r4
/* 80AB1B30  FF E0 08 90 */	fmr f31, f1
/* 80AB1B34  7C BD 2B 78 */	mr r29, r5
/* 80AB1B38  3C 60 80 AB */	lis r3, m__19daNpc_Pouya_Param_c@ha
/* 80AB1B3C  3B C3 20 00 */	addi r30, r3, m__19daNpc_Pouya_Param_c@l
...
/* 80AB1B58  4B 7B 4F DC */	b __mi__4cXyzCFRC3Vec
...
/* 80AB1B88  4B 89 55 B0 */	b PSVECSquareMag
...
/* 80AB1BF8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AB1BFC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80AB1C68  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AB1C6C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80AB1C70  48 00 00 08 */	b lbl_80AB1C78
lbl_80AB1C74:
/* 80AB1C74  FC 40 08 90 */	fmr f2, f1
lbl_80AB1C78:
/* 80AB1C78  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80AB1C7C  4B 7B 59 F8 */	b cM_atan2s__Fff
...
/* 80AB1D00  4B 8B 05 28 */	b _restgpr_29
