...
/* 80AAFA74  4B 8B 27 65 */	bl _savegpr_28
...
/* 80AAFA88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AAFA8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AAFAB8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80AAFABC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80AAFAC0  7F C4 F3 78 */	mr r4, r30
/* 80AAFAC4  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80AAFAC8  4B 6F 52 D9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80AAFACC  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 80AAFAD0  80 83 00 0C */	lwz r4, 0xc(r3)
/* 80AAFAD4  3C 60 80 AB */	lis r3, jointNo@ha /* 0x80AB2110@ha */
/* 80AAFAD8  80 03 21 10 */	lwz r0, jointNo@l(r3)  /* 0x80AB2110@l */
/* 80AAFADC  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80AAFAE0  7C 64 02 14 */	add r3, r4, r0
/* 80AAFAE4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AAFAE8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AAFAEC  4B 89 69 C5 */	bl PSMTXCopy
/* 80AAFAF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AAFAF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AAFAF8  38 81 00 08 */	addi r4, r1, 8
/* 80AAFAFC  4B 89 69 B5 */	bl PSMTXCopy
/* 80AAFB00  38 61 00 08 */	addi r3, r1, 8
/* 80AAFB04  80 9D 0E 44 */	lwz r4, 0xe44(r29)
/* 80AAFB08  38 84 00 24 */	addi r4, r4, 0x24
/* 80AAFB0C  4B 89 69 A5 */	bl PSMTXCopy
/* 80AAFB10  7F A3 EB 78 */	mr r3, r29
/* 80AAFB14  7F C4 F3 78 */	mr r4, r30
/* 80AAFB18  4B 56 D9 15 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 80AAFB1C  80 7D 0E 44 */	lwz r3, 0xe44(r29)
/* 80AAFB20  4B 55 E1 A5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80AAFB24  7F E3 FB 78 */	mr r3, r31
/* 80AAFB28  80 9D 0D 94 */	lwz r4, 0xd94(r29)
/* 80AAFB2C  80 BD 0E 44 */	lwz r5, 0xe44(r29)
/* 80AAFB30  4B 5A 63 ED */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80AAFB34:
/* 80AAFB34  39 61 00 50 */	addi r11, r1, 0x50
/* 80AAFB38  4B 8B 26 ED */	bl _restgpr_28
