...
/* 80AAEFC8  3C 80 80 AB */	lis r4, lit_4663@ha /* 0x80AB2A50@ha */
/* 80AAEFCC  38 A4 2A 50 */	addi r5, r4, lit_4663@l /* 0x80AB2A50@l */
...
/* 80AAF000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AAF004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AAF02C  4B 59 97 C5 */	bl ChkPresentEnd__16dEvent_manager_cFv
...
/* 80AAF044  4B 69 B1 E1 */	bl evtChange__8daNpcT_cFv
lbl_80AAF048:
...
lbl_80AAF068:
/* 80AAF068  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AAF06C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AAF070  38 63 09 58 */	addi r3, r3, 0x958
/* 80AAF074  38 80 00 1F */	li r4, 0x1f
/* 80AAF078  4B 58 57 E9 */	bl isSwitch__12dSv_memBit_cCFi
/* 80AAF07C  2C 03 00 00 */	cmpwi r3, 0
/* 80AAF080  41 82 00 B0 */	beq lbl_80AAF130
/* 80AAF084  38 60 01 C8 */	li r3, 0x1c8
/* 80AAF088  4B 69 DA 25 */	bl daNpcT_chkEvtBit__FUl
/* 80AAF08C  2C 03 00 00 */	cmpwi r3, 0
/* 80AAF090  40 82 00 24 */	bne lbl_80AAF0B4
/* 80AAF094  38 60 00 0B */	li r3, 0xb
/* 80AAF098  4B 69 DA 95 */	bl daNpcT_offTmpBit__FUl
/* 80AAF09C  38 00 00 03 */	li r0, 3
/* 80AAF0A0  B0 1F 0E 30 */	sth r0, 0xe30(r31)
/* 80AAF0A4  7F E3 FB 78 */	mr r3, r31
/* 80AAF0A8  4B 69 B1 7D */	bl evtChange__8daNpcT_cFv
/* 80AAF0AC  38 60 00 01 */	li r3, 1
/* 80AAF0B0  48 00 00 84 */	b lbl_80AAF134
lbl_80AAF0B4:
/* 80AAF0B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AAF0B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
