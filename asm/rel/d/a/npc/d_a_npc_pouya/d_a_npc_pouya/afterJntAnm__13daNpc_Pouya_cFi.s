...
/* 80AAEDD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AAEDD8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AAEDDC  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 80AAEDE0  7C 00 00 D0 */	neg r0, r0
/* 80AAEDE4  7C 04 07 34 */	extsh r4, r0
/* 80AAEDE8  4B 55 D6 4D */	bl mDoMtx_YrotM__FPA4_fs
/* 80AAEDEC  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 80AAEDF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AAEDF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AAEDF8  4B 55 D6 D5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80AAEDFC  48 00 00 34 */	b lbl_80AAEE30
lbl_80AAEE00:
/* 80AAEE00  2C 04 00 04 */	cmpwi r4, 4
/* 80AAEE04  40 82 00 2C */	bne lbl_80AAEE30
/* 80AAEE08  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AAEE0C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AAEE10  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80AAEE14  7C 00 00 D0 */	neg r0, r0
/* 80AAEE18  7C 04 07 34 */	extsh r4, r0
/* 80AAEE1C  4B 55 D6 19 */	bl mDoMtx_YrotM__FPA4_fs
/* 80AAEE20  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80AAEE24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AAEE28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AAEE2C  4B 55 D6 A1 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80AAEE30:
