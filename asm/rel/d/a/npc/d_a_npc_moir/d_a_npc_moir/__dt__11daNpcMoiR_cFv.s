...
/* 80A7C390  4B 8E 5E 41 */	bl _savegpr_26
/* 80A7C394  7C 7E 1B 79 */	or. r30, r3, r3
/* 80A7C398  7C 9F 23 78 */	mr r31, r4
/* 80A7C39C  41 82 01 C8 */	beq lbl_80A7C564
/* 80A7C3A0  3C 60 80 A8 */	lis r3, __vt__11daNpcMoiR_c@ha /* 0x80A83C94@ha */
/* 80A7C3A4  38 03 3C 94 */	addi r0, r3, __vt__11daNpcMoiR_c@l /* 0x80A83C94@l */
/* 80A7C3A8  90 1E 0B 44 */	stw r0, 0xb44(r30)
/* 80A7C3AC  3B A0 00 00 */	li r29, 0
/* 80A7C3B0  3B 80 00 00 */	li r28, 0
/* 80A7C3B4  3C 60 80 A8 */	lis r3, l_arcNames@ha /* 0x80A83AF8@ha */
/* 80A7C3B8  3B 43 3A F8 */	addi r26, r3, l_arcNames@l /* 0x80A83AF8@l */
/* 80A7C3BC  3C 60 80 A8 */	lis r3, l_loadRes_list@ha /* 0x80A83AEC@ha */
/* 80A7C3C0  3B 63 3A EC */	addi r27, r3, l_loadRes_list@l /* 0x80A83AEC@l */
...
/* 80A7C3D8  4B 5B 0C 31 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80A7C40C  4B 59 4F 05 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80A7C410:
/* 80A7C410  34 1E 0C A0 */	addic. r0, r30, 0xca0
/* 80A7C414  41 82 00 84 */	beq lbl_80A7C498
/* 80A7C418  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80A7C41C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80A7C43C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80A7C440  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80A7C458  3C 60 80 A8 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80A83D3C@ha */
/* 80A7C45C  38 03 3D 3C */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80A83D3C@l */
/* 80A7C460  90 1E 0D D8 */	stw r0, 0xdd8(r30)
lbl_80A7C464:
/* 80A7C464  34 1E 0D A4 */	addic. r0, r30, 0xda4
/* 80A7C468  41 82 00 24 */	beq lbl_80A7C48C
/* 80A7C46C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80A7C470  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80A7C474  90 1E 0D C0 */	stw r0, 0xdc0(r30)
/* 80A7C478  34 1E 0D A4 */	addic. r0, r30, 0xda4
/* 80A7C47C  41 82 00 10 */	beq lbl_80A7C48C
/* 80A7C480  3C 60 80 A8 */	lis r3, __vt__8cM3dGAab@ha /* 0x80A83D48@ha */
/* 80A7C484  38 03 3D 48 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80A83D48@l */
/* 80A7C488  90 1E 0D BC */	stw r0, 0xdbc(r30)
lbl_80A7C48C:
/* 80A7C48C  38 7E 0C A0 */	addi r3, r30, 0xca0
/* 80A7C490  38 80 00 00 */	li r4, 0
/* 80A7C494  4B 60 7C 51 */	bl __dt__12dCcD_GObjInfFv
lbl_80A7C498:
/* 80A7C498  38 7E 0C 7C */	addi r3, r30, 0xc7c
/* 80A7C49C  3C 80 80 A8 */	lis r4, __dt__18daNpcF_ActorMngr_cFv@ha /* 0x80A82908@ha */
/* 80A7C4A0  38 84 29 08 */	addi r4, r4, __dt__18daNpcF_ActorMngr_cFv@l /* 0x80A82908@l */
/* 80A7C4A4  38 A0 00 08 */	li r5, 8
/* 80A7C4A8  38 C0 00 04 */	li r6, 4
/* 80A7C4AC  4B 8E 58 3D */	bl __destroy_arr
/* 80A7C4B0  34 1E 0B E0 */	addic. r0, r30, 0xbe0
/* 80A7C4B4  41 82 00 88 */	beq lbl_80A7C53C
/* 80A7C4B8  3C 60 80 A8 */	lis r3, __vt__15daNpcF_Lookat_c@ha /* 0x80A83D54@ha */
/* 80A7C4BC  38 03 3D 54 */	addi r0, r3, __vt__15daNpcF_Lookat_c@l /* 0x80A83D54@l */
/* 80A7C4C0  90 1E 0C 78 */	stw r0, 0xc78(r30)
/* 80A7C4C4  38 7E 0C 5C */	addi r3, r30, 0xc5c
/* 80A7C4C8  3C 80 80 A8 */	lis r4, __dt__5csXyzFv@ha /* 0x80A82A5C@ha */
/* 80A7C4CC  38 84 2A 5C */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A82A5C@l */
/* 80A7C4D0  38 A0 00 06 */	li r5, 6
/* 80A7C4D4  38 C0 00 04 */	li r6, 4
/* 80A7C4D8  4B 8E 58 11 */	bl __destroy_arr
/* 80A7C4DC  38 7E 0C 44 */	addi r3, r30, 0xc44
/* 80A7C4E0  3C 80 80 A8 */	lis r4, __dt__5csXyzFv@ha /* 0x80A82A5C@ha */
/* 80A7C4E4  38 84 2A 5C */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A82A5C@l */
/* 80A7C4E8  38 A0 00 06 */	li r5, 6
/* 80A7C4EC  38 C0 00 04 */	li r6, 4
/* 80A7C4F0  4B 8E 57 F9 */	bl __destroy_arr
/* 80A7C4F4  38 7E 0C 2C */	addi r3, r30, 0xc2c
/* 80A7C4F8  3C 80 80 A8 */	lis r4, __dt__5csXyzFv@ha /* 0x80A82A5C@ha */
/* 80A7C4FC  38 84 2A 5C */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A82A5C@l */
/* 80A7C500  38 A0 00 06 */	li r5, 6
/* 80A7C504  38 C0 00 04 */	li r6, 4
/* 80A7C508  4B 8E 57 E1 */	bl __destroy_arr
/* 80A7C50C  38 7E 0C 14 */	addi r3, r30, 0xc14
/* 80A7C510  3C 80 80 A8 */	lis r4, __dt__5csXyzFv@ha /* 0x80A82A5C@ha */
/* 80A7C514  38 84 2A 5C */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A82A5C@l */
/* 80A7C518  38 A0 00 06 */	li r5, 6
/* 80A7C51C  38 C0 00 04 */	li r6, 4
/* 80A7C520  4B 8E 57 C9 */	bl __destroy_arr
/* 80A7C524  38 7E 0B E0 */	addi r3, r30, 0xbe0
/* 80A7C528  3C 80 80 A8 */	lis r4, __dt__4cXyzFv@ha /* 0x80A82A9C@ha */
/* 80A7C52C  38 84 2A 9C */	addi r4, r4, __dt__4cXyzFv@l /* 0x80A82A9C@l */
/* 80A7C530  38 A0 00 0C */	li r5, 0xc
/* 80A7C534  38 C0 00 04 */	li r6, 4
/* 80A7C538  4B 8E 57 B1 */	bl __destroy_arr
lbl_80A7C53C:
/* 80A7C53C  38 7E 0B 48 */	addi r3, r30, 0xb48
/* 80A7C540  38 80 FF FF */	li r4, -1
/* 80A7C544  4B 84 3E DD */	bl __dt__10Z2CreatureFv
...
/* 80A7C560  4B 85 27 DD */	bl __dl__FPv
lbl_80A7C564:
/* 80A7C564  7F C3 F3 78 */	mr r3, r30
/* 80A7C568  39 61 00 20 */	addi r11, r1, 0x20
/* 80A7C56C  4B 8E 5C B1 */	bl _restgpr_26
