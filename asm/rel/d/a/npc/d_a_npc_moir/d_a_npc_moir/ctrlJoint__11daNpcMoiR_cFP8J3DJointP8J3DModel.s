...
/* 80A7CF0C  4B 8E 52 CD */	bl _savegpr_28
...
/* 80A7CF20  3C 60 80 A8 */	lis r3, lit_4386@ha /* 0x80A83338@ha */
/* 80A7CF24  38 83 33 38 */	addi r4, r3, lit_4386@l /* 0x80A83338@l */
...
/* 80A7CF5C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A7CF60  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A7CF64  4B 8C 95 4D */	bl PSMTXCopy
/* 80A7CF68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A7CF6C  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A7CFA0  4B 8C 95 11 */	bl PSMTXCopy
...
/* 80A7CFD0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A7CFD4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A7CFD8  4B 8C 94 D9 */	bl PSMTXCopy
...
/* 80A7D004  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A7D008  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A7D00C  4B 8C 94 A5 */	bl PSMTXCopy
...
/* 80A7D03C  3C C0 80 A8 */	lis r6, m__17daNpcMoiR_Param_c@ha /* 0x80A832AC@ha */
/* 80A7D040  38 C6 32 AC */	addi r6, r6, m__17daNpcMoiR_Param_c@l /* 0x80A832AC@l */
/* 80A7D044  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80A7D048  4B 6D 63 35 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80A7D04C:
/* 80A7D04C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A7D050  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A7D054  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80A7D058  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80A7D05C  7C 80 E2 14 */	add r4, r0, r28
/* 80A7D060  4B 8C 94 51 */	bl PSMTXCopy
/* 80A7D064  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A7D068  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A7D06C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80A7D070  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80A7D074  4B 8C 94 3D */	bl PSMTXCopy
...
/* 80A7D0A4  4B 59 08 ED */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80A7D0B8  4B 8E 51 6D */	bl _restgpr_28
