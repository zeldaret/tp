...
/* 80A7D3A4  4B 8E 4E 38 */	b _savegpr_29
/* 80A7D3A8  7C 7E 1B 78 */	mr r30, r3
/* 80A7D3AC  7C 9F 23 78 */	mr r31, r4
/* 80A7D3B0  1F BF 00 0C */	mulli r29, r31, 0xc
/* 80A7D3B4  3C 80 80 A8 */	lis r4, l_btpGetParamList@ha
/* 80A7D3B8  38 A4 3A A4 */	addi r5, r4, l_btpGetParamList@l
/* 80A7D3BC  7C 85 EA 14 */	add r4, r5, r29
/* 80A7D3C0  80 04 00 08 */	lwz r0, 8(r4)
/* 80A7D3C4  54 00 10 3A */	slwi r0, r0, 2
/* 80A7D3C8  3C 80 80 A8 */	lis r4, l_arcNames@ha
/* 80A7D3CC  38 84 3A F8 */	addi r4, r4, l_arcNames@l
/* 80A7D3D0  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A7D3D4  7C A5 E8 2E */	lwzx r5, r5, r29
/* 80A7D3D8  4B 6D 57 90 */	b getTexPtrnAnmP__8daNpcF_cFPci
/* 80A7D3DC  7C 64 1B 79 */	or. r4, r3, r3
/* 80A7D3E0  3C 60 80 A8 */	lis r3, l_btpGetParamList@ha
/* 80A7D3E4  38 03 3A A4 */	addi r0, r3, l_btpGetParamList@l
...
/* 80A7D41C  3C E0 80 A8 */	lis r7, lit_4337@ha
/* 80A7D420  C0 27 33 30 */	lfs f1, lit_4337@l(r7)
/* 80A7D424  4B 6D 58 A0 */	b setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 80A7D460  4B 8E 4D C8 */	b _restgpr_29
