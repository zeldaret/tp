...
/* 80953C18  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80953C1C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80953C20  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 80953C24  3C 80 80 95 */	lis r4, d_a_npc_aru__stringBase0@ha /* 0x8095781C@ha */
/* 80953C28  38 84 78 1C */	addi r4, r4, d_a_npc_aru__stringBase0@l /* 0x8095781C@l */
/* 80953C2C  38 84 00 C1 */	addi r4, r4, 0xc1
/* 80953C30  4B A1 4D 65 */	bl strcmp
...
/* 80953C44  4B 6D 8D 39 */	bl getLayerNo__14dComIfG_play_cFi
/* 80953C48  2C 03 00 06 */	cmpwi r3, 6
/* 80953C4C  41 82 00 14 */	beq lbl_80953C60
/* 80953C50  38 60 00 00 */	li r3, 0
/* 80953C54  4B 6D 8D 29 */	bl getLayerNo__14dComIfG_play_cFi
