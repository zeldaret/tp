...
/* 80B72BAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B72BB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B72BB4  4B 49 98 81 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B72BB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B72BBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B72BC0  A8 1F 0D 0E */	lha r0, 0xd0e(r31)
/* 80B72BC4  7C 00 00 D0 */	neg r0, r0
/* 80B72BC8  7C 04 07 34 */	extsh r4, r0
/* 80B72BCC  4B 49 99 01 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80B72BE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B72BE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B72BE8  4B 49 98 4D */	bl mDoMtx_YrotM__FPA4_fs
/* 80B72BEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B72BF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B72BF4  A8 1F 0D 08 */	lha r0, 0xd08(r31)
/* 80B72BF8  7C 00 00 D0 */	neg r0, r0
/* 80B72BFC  7C 04 07 34 */	extsh r4, r0
/* 80B72C00  4B 49 98 CD */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B72C04:
