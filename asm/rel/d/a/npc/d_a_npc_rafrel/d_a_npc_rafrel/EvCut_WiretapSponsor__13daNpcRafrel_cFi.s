...
/* 80ABD8B0  4B 8A 49 25 */	bl _savegpr_27
/* 80ABD8B4  7C 7D 1B 78 */	mr r29, r3
/* 80ABD8B8  7C 9B 23 78 */	mr r27, r4
/* 80ABD8BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ABD8C0  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80ABD8C4  3B 9E 4F F8 */	addi r28, r30, 0x4ff8
/* 80ABD8C8  3C 60 80 AC */	lis r3, lit_5583@ha /* 0x80ABFD8C@ha */
/* 80ABD8CC  38 83 FD 8C */	addi r4, r3, lit_5583@l /* 0x80ABFD8C@l */
...
/* 80ABD958  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ABD95C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80ABD9A4  4B 69 63 79 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
lbl_80ABD9A8:
...
/* 80ABD9C0  4B 69 5D 59 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80ABD9D4  3C A0 80 AC */	lis r5, lit_5080@ha /* 0x80ABFD30@ha */
/* 80ABD9D8  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)  /* 0x80ABFD30@l */
...
/* 80ABD9F4  3C A0 80 AC */	lis r5, lit_5080@ha /* 0x80ABFD30@ha */
/* 80ABD9F8  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)  /* 0x80ABFD30@l */
...
/* 80ABDA58  3C A0 80 AC */	lis r5, lit_5080@ha /* 0x80ABFD30@ha */
/* 80ABDA5C  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)  /* 0x80ABFD30@l */
...
/* 80ABDA7C  3C A0 80 AC */	lis r5, lit_5080@ha /* 0x80ABFD30@ha */
/* 80ABDA80  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)  /* 0x80ABFD30@l */
...
/* 80ABDAA0  3C A0 80 AC */	lis r5, lit_5080@ha /* 0x80ABFD30@ha */
/* 80ABDAA4  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)  /* 0x80ABFD30@l */
...
/* 80ABDAC4  3C A0 80 AC */	lis r5, lit_5080@ha /* 0x80ABFD30@ha */
/* 80ABDAC8  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)  /* 0x80ABFD30@l */
...
/* 80ABDB04  4B 69 62 81 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80ABDB1C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ABDB20  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80ABDB24  80 84 4F 94 */	lwz r4, 0x4f94(r4)
/* 80ABDB28  4B 58 57 C5 */	bl convPId__14dEvt_control_cFUi
/* 80ABDB2C  7C 03 E8 40 */	cmplw r3, r29
/* 80ABDB30  40 82 00 0C */	bne lbl_80ABDB3C
/* 80ABDB34  38 7D 0C 8C */	addi r3, r29, 0xc8c
/* 80ABDB38  4B 69 2B B5 */	bl getActorP__18daNpcF_ActorMngr_cFv
lbl_80ABDB3C:
...
/* 80ABDB68  4B 8A 46 B9 */	bl _restgpr_27
