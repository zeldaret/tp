...
/* 80ABA8FC  4B 8A 78 E0 */	b _savegpr_29
/* 80ABA900  7C 7E 1B 78 */	mr r30, r3
/* 80ABA904  7C 9F 23 78 */	mr r31, r4
/* 80ABA908  1F BF 00 0C */	mulli r29, r31, 0xc
/* 80ABA90C  3C 80 80 AC */	lis r4, l_btpGetParamList@ha
/* 80ABA910  38 A4 FF FC */	addi r5, r4, l_btpGetParamList@l
/* 80ABA914  7C 85 EA 14 */	add r4, r5, r29
/* 80ABA918  80 04 00 08 */	lwz r0, 8(r4)
/* 80ABA91C  54 00 10 3A */	slwi r0, r0, 2
/* 80ABA920  3C 80 80 AC */	lis r4, l_arcNames@ha
/* 80ABA924  38 84 00 98 */	addi r4, r4, l_arcNames@l
/* 80ABA928  7C 84 00 2E */	lwzx r4, r4, r0
/* 80ABA92C  7C A5 E8 2E */	lwzx r5, r5, r29
/* 80ABA930  4B 69 82 38 */	b getTexPtrnAnmP__8daNpcF_cFPci
/* 80ABA934  7C 64 1B 79 */	or. r4, r3, r3
/* 80ABA938  3C 60 80 AC */	lis r3, l_btpGetParamList@ha
/* 80ABA93C  38 03 FF FC */	addi r0, r3, l_btpGetParamList@l
...
/* 80ABA974  3C E0 80 AC */	lis r7, lit_4320@ha
/* 80ABA978  C0 27 FA 64 */	lfs f1, lit_4320@l(r7)
/* 80ABA97C  4B 69 83 48 */	b setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 80ABA9B8  4B 8A 78 70 */	b _restgpr_29
