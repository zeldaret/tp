...
/* 80ABDEB4  3C 60 80 AC */	lis r3, m__19daNpcRafrel_Param_c@ha /* 0x80ABF9E0@ha */
/* 80ABDEB8  3B E3 F9 E0 */	addi r31, r3, m__19daNpcRafrel_Param_c@l /* 0x80ABF9E0@l */
/* 80ABDEBC  38 7E 0C 84 */	addi r3, r30, 0xc84
/* 80ABDEC0  4B 69 28 2D */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 80ABDED4  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 80ABDED8  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 80ABDEDC  38 81 00 0C */	addi r4, r1, 0xc
/* 80ABDEE0  4B 55 B9 19 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80ABDEE4  7C 64 1B 78 */	mr r4, r3
/* 80ABDEE8  38 7E 0C 84 */	addi r3, r30, 0xc84
/* 80ABDEEC  4B 69 27 D1 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
lbl_80ABDEF0:
/* 80ABDEF0  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 80ABDEF4  4B 69 27 F9 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 80ABDF08  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 80ABDF0C  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 80ABDF10  38 81 00 0A */	addi r4, r1, 0xa
/* 80ABDF14  4B 55 B8 E5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80ABDF18  7C 64 1B 78 */	mr r4, r3
/* 80ABDF1C  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 80ABDF20  4B 69 27 9D */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
lbl_80ABDF24:
/* 80ABDF24  38 7E 0C 94 */	addi r3, r30, 0xc94
/* 80ABDF28  4B 69 27 C5 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 80ABDF3C  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 80ABDF40  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 80ABDF44  38 81 00 08 */	addi r4, r1, 8
/* 80ABDF48  4B 55 B8 B1 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80ABDF4C  7C 64 1B 78 */	mr r4, r3
/* 80ABDF50  38 7E 0C 94 */	addi r3, r30, 0xc94
/* 80ABDF54  4B 69 27 69 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
lbl_80ABDF58:
...
/* 80ABDF6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ABDF70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80ABDF84  4B 56 E9 F9 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 80ABDFE4  4B 69 62 95 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 80ABE000  4B 69 62 79 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 80ABE01C  4B 69 62 5D */	bl getDistTableIdx__8daNpcF_cFii
...
/* 80ABE03C  4B 69 62 3D */	bl getDistTableIdx__8daNpcF_cFii
...
/* 80ABE0A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ABE0AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80ABE0B0  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80ABE0B4  38 63 04 D0 */	addi r3, r3, 0x4d0
/* 80ABE0B8  38 81 00 14 */	addi r4, r1, 0x14
/* 80ABE0BC  4B 88 92 E1 */	bl PSVECSquareDistance
...
/* 80ABE12C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80ABE130  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80ABE19C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80ABE1A0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80ABE1A4:
