...
/* 80ABCA50  4B 8A 57 8D */	bl _savegpr_29
/* 80ABCA54  7C 7E 1B 78 */	mr r30, r3
/* 80ABCA58  3C 80 80 AC */	lis r4, m__19daNpcRafrel_Param_c@ha /* 0x80ABF9E0@ha */
/* 80ABCA5C  3B E4 F9 E0 */	addi r31, r4, m__19daNpcRafrel_Param_c@l /* 0x80ABF9E0@l */
...
/* 80ABCB00  4B 7B 41 05 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80ABCBFC  4B 69 72 F9 */	bl turn__8daNpcF_cFsfi
...
/* 80ABCC5C  4B 88 A7 41 */	bl PSVECSquareDistance
...
/* 80ABCCCC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80ABCCD0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80ABCD3C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80ABCD40  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80ABCD44:
...
/* 80ABCD54  4B 55 CF 29 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_80ABCD58:
/* 80ABCD58  38 60 00 01 */	li r3, 1
/* 80ABCD5C  39 61 00 40 */	addi r11, r1, 0x40
/* 80ABCD60  4B 8A 54 C9 */	bl _restgpr_29
