...
/* 80B2FE94  4B 83 23 39 */	bl _savegpr_25
...
/* 80B2FED0  3C 60 80 B4 */	lis r3, lit_4467@ha /* 0x80B41898@ha */
/* 80B2FED4  38 83 18 98 */	addi r4, r3, lit_4467@l /* 0x80B41898@l */
...
/* 80B2FF1C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2FF20  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2FF24  4B 81 65 8D */	bl PSMTXCopy
/* 80B2FF28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2FF2C  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B2FF64  4B 81 65 4D */	bl PSMTXCopy
...
/* 80B2FF98  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2FF9C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2FFA0  4B 81 65 11 */	bl PSMTXCopy
...
/* 80B2FFCC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B2FFD0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B2FFD4  4B 81 64 DD */	bl PSMTXCopy
...
/* 80B30018  4B 62 33 65 */	bl setLookatMtx__8daNpcF_cFiPif
...
/* 80B30054  4B 62 33 29 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80B30058:
/* 80B30058  7C 1E C8 00 */	cmpw r30, r25
/* 80B3005C  40 82 00 30 */	bne lbl_80B3008C
/* 80B30060  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B30064  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B30068  A8 9F 09 0C */	lha r4, 0x90c(r31)
/* 80B3006C  4B 4D C3 C9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B30070  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B30074  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B30078  A8 1F 09 08 */	lha r0, 0x908(r31)
/* 80B3007C  7C 00 00 D0 */	neg r0, r0
/* 80B30080  7C 04 07 34 */	extsh r4, r0
/* 80B30084  4B 4D C4 49 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B30088  48 00 00 2C */	b lbl_80B300B4
lbl_80B3008C:
/* 80B3008C  7C 1E D8 00 */	cmpw r30, r27
/* 80B30090  40 82 00 24 */	bne lbl_80B300B4
/* 80B30094  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B30098  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B3009C  A8 9F 09 18 */	lha r4, 0x918(r31)
/* 80B300A0  4B 4D C3 95 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B300A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B300A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B300AC  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 80B300B0  4B 4D C4 1D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B300B4:
/* 80B300B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B300B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B300BC  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 80B300C0  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80B300C4  7C 80 D2 14 */	add r4, r0, r26
/* 80B300C8  4B 81 63 E9 */	bl PSMTXCopy
/* 80B300CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B300D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B300D4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80B300D8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80B300DC  4B 81 63 D5 */	bl PSMTXCopy
...
/* 80B30128  4B 4D D8 69 */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80B3013C  4B 83 20 DD */	bl _restgpr_25
