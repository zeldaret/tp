...
/* 80B3BC9C  4B 82 65 39 */	bl _savegpr_27
/* 80B3BCA0  7C 7B 1B 78 */	mr r27, r3
/* 80B3BCA4  3C 60 80 B4 */	lis r3, m__21daNpcWrestler_Param_c@ha /* 0x80B416DC@ha */
/* 80B3BCA8  3B C3 16 DC */	addi r30, r3, m__21daNpcWrestler_Param_c@l /* 0x80B416DC@l */
/* 80B3BCAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B3BCB0  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B3BCB4  83 BF 5D AC */	lwz r29, 0x5dac(r31)
/* 80B3BCB8  4B 64 59 89 */	bl dCam_getBody__Fv
...
lbl_80B3BD04:
/* 80B3BD04  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80B3BD08  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 80B3BD0C  80 63 00 00 */	lwz r3, 0(r3)
/* 80B3BD10  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 80B3BD14  38 80 00 04 */	li r4, 4
/* 80B3BD18  4B 77 60 DD */	bl changeSubBgmStatus__8Z2SeqMgrFl
...
/* 80B3BD64  4B 4D FB A5 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 80B3BD84  4B 64 61 15 */	bl Center__9dCamera_cFv
...
/* 80B3BDA8  4B 64 60 BD */	bl Eye__9dCamera_cFv
...
/* 80B3BDEC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B3BDF0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B3BDF4  4B 80 A6 BD */	bl PSMTXCopy
/* 80B3BDF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B3BDFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B3BE60  4B 62 56 71 */	bl Stop__9dCamera_cFv
/* 80B3BE64  7F 83 E3 78 */	mr r3, r28
/* 80B3BE68  38 80 00 02 */	li r4, 2
/* 80B3BE6C  4B 62 71 A1 */	bl SetTrimSize__9dCamera_cFl
...
/* 80B3BED0  4B 61 47 ED */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 80B3BEFC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B3BF00  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B3BF04  4B 80 A5 AD */	bl PSMTXCopy
/* 80B3BF08  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B3BF0C  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B3BF4C  4B 73 3B 6D */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 80B3BF6C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B3BF70  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B3BF74  4B 80 A5 3D */	bl PSMTXCopy
...
/* 80B3BF9C  4B 80 B0 F5 */	bl PSVECAdd
...
/* 80B3C01C  4B 4D 0D 49 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80B3C020  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B3C024  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B3C028  A8 9B 08 F2 */	lha r4, 0x8f2(r27)
/* 80B3C02C  4B 4D 04 09 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B3C030  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B3C034  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B3C038  38 9B 0E 14 */	addi r4, r27, 0xe14
/* 80B3C03C  7C 85 23 78 */	mr r5, r4
/* 80B3C040  4B 80 AD 2D */	bl PSMTXMultVec
...
/* 80B3C0D4  4B 73 38 A9 */	bl cLib_addCalc__FPfffff
...
/* 80B3C134  4B 64 4A E5 */	bl Reset__9dCamera_cF4cXyz4cXyz
/* 80B3C138  7F 83 E3 78 */	mr r3, r28
/* 80B3C13C  4B 62 53 71 */	bl Start__9dCamera_cFv
/* 80B3C140  7F 83 E3 78 */	mr r3, r28
/* 80B3C144  38 80 00 00 */	li r4, 0
/* 80B3C148  4B 62 6E C5 */	bl SetTrimSize__9dCamera_cFl
/* 80B3C14C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B3C150  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B3C154  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80B3C158  4B 50 63 11 */	bl reset__14dEvt_control_cFv
/* 80B3C15C  C0 1E 01 B8 */	lfs f0, 0x1b8(r30)
/* 80B3C160  D0 1B 0E 8C */	stfs f0, 0xe8c(r27)
/* 80B3C164  3C 60 80 B4 */	lis r3, lit_9598@ha /* 0x80B42C3C@ha */
/* 80B3C168  38 83 2C 3C */	addi r4, r3, lit_9598@l /* 0x80B42C3C@l */
...
/* 80B3C190  4B 82 5E 89 */	bl __ptmf_test
...
/* 80B3C1A8  4B 82 5E DD */	bl __ptmf_scall
...
/* 80B3C1D4  4B 82 5E 45 */	bl __ptmf_test
...
/* 80B3C1EC  4B 82 5E 99 */	bl __ptmf_scall
...
/* 80B3C244  4B 64 48 9D */	bl Set__9dCamera_cF4cXyz4cXyzfs
...
/* 80B3C264  4B 82 5F BD */	bl _restgpr_27
