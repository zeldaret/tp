...
/* 80B39C28  4B 82 85 AD */	bl _savegpr_27
/* 80B39C2C  7C 7D 1B 78 */	mr r29, r3
/* 80B39C30  3C 80 80 B4 */	lis r4, m__21daNpcWrestler_Param_c@ha /* 0x80B416DC@ha */
/* 80B39C34  3B C4 16 DC */	addi r30, r4, m__21daNpcWrestler_Param_c@l /* 0x80B416DC@l */
...
lbl_80B39CA4:
/* 80B39CA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B39CA8  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80B39CCC  4B 4D 30 99 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80B39CD0  38 7B 05 F8 */	addi r3, r27, 0x5f8
/* 80B39CD4  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 80B39CD8  4B 73 6F 2D */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80B39CDC  A8 1D 0E 94 */	lha r0, 0xe94(r29)
/* 80B39CE0  7C 00 1A 14 */	add r0, r0, r3
/* 80B39CE4  7C 04 07 34 */	extsh r4, r0
/* 80B39CE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B39CEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B39CF0  4B 4D 27 45 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B39CF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B39CF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B39CFC  38 81 00 08 */	addi r4, r1, 8
/* 80B39D00  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80B39D04  4B 80 D0 69 */	bl PSMTXMultVec
/* 80B39D08  7F A3 EB 78 */	mr r3, r29
/* 80B39D0C  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80B39D10  4B 4E 0A 01 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80B39D2C  4B 73 68 15 */	bl cLib_addCalcAngleS__FPsssss
/* 80B39D30  7F A3 EB 78 */	mr r3, r29
/* 80B39D34  A8 9D 08 F2 */	lha r4, 0x8f2(r29)
/* 80B39D38  4B 61 A5 19 */	bl setAngle__8daNpcF_cFs
...
/* 80B39D9C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B39DA0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B39DA4  4B 80 C7 0D */	bl PSMTXCopy
/* 80B39DA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B39DAC  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B39DEC  4B 4E 32 35 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 80B39E08  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B39E0C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B39E10  4B 80 C6 A1 */	bl PSMTXCopy
...
/* 80B39E50  4B 4E 31 D1 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
lbl_80B39E54:
/* 80B39E54  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80B39E58  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 80B39E5C  80 63 00 00 */	lwz r3, 0(r3)
/* 80B39E60  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 80B39E64  38 80 00 02 */	li r4, 2
/* 80B39E68  4B 77 7F 8D */	bl changeSubBgmStatus__8Z2SeqMgrFl
...
/* 80B39EA4  3C 60 80 B4 */	lis r3, lit_8834@ha /* 0x80B42BD4@ha */
/* 80B39EA8  38 83 2B D4 */	addi r4, r3, lit_8834@l /* 0x80B42BD4@l */
...
/* 80B39ED0  4B 82 81 49 */	bl __ptmf_test
...
/* 80B39EE8  4B 82 81 9D */	bl __ptmf_scall
...
/* 80B39F14  4B 82 81 05 */	bl __ptmf_test
...
/* 80B39F2C  4B 82 81 59 */	bl __ptmf_scall
...
/* 80B39F5C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B39F60  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B39F64  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80B39F68  4B 61 67 55 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
lbl_80B39F6C:
/* 80B39F6C  38 60 00 01 */	li r3, 1
/* 80B39F70  39 61 00 50 */	addi r11, r1, 0x50
/* 80B39F74  4B 82 82 AD */	bl _restgpr_27
