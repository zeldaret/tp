...
/* 8095B174  4B A0 70 69 */	bl _savegpr_29
/* 8095B178  7C 7E 1B 78 */	mr r30, r3
/* 8095B17C  3C 80 80 96 */	lis r4, m__16daNpcAsh_Param_c@ha /* 0x8095D640@ha */
/* 8095B180  3B E4 D6 40 */	addi r31, r4, m__16daNpcAsh_Param_c@l /* 0x8095D640@l */
...
/* 8095B218  4B 91 59 ED */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8095B314  4B 7F 8B E1 */	bl turn__8daNpcF_cFsfi
...
/* 8095B374  4B 9E C0 29 */	bl PSVECSquareDistance
...
/* 8095B3E4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8095B3E8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8095B454  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8095B458  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8095B45C:
...
/* 8095B46C  4B 6B E8 11 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_8095B470:
/* 8095B470  38 60 00 01 */	li r3, 1
/* 8095B474  39 61 00 40 */	addi r11, r1, 0x40
/* 8095B478  4B A0 6D B1 */	bl _restgpr_29
