...
/* 809596F0  4B A0 8A ED */	bl _savegpr_29
/* 809596F4  7C 7E 1B 78 */	mr r30, r3
/* 809596F8  7C 9F 23 78 */	mr r31, r4
/* 809596FC  1F BF 00 0C */	mulli r29, r31, 0xc
/* 80959700  3C 80 80 96 */	lis r4, l_btpGetParamList@ha /* 0x8095DA88@ha */
/* 80959704  38 A4 DA 88 */	addi r5, r4, l_btpGetParamList@l /* 0x8095DA88@l */
/* 80959708  7C 85 EA 14 */	add r4, r5, r29
/* 8095970C  80 04 00 08 */	lwz r0, 8(r4)
/* 80959710  54 00 10 3A */	slwi r0, r0, 2
/* 80959714  3C 80 80 96 */	lis r4, l_arcNames@ha /* 0x8095DAC0@ha */
/* 80959718  38 84 DA C0 */	addi r4, r4, l_arcNames@l /* 0x8095DAC0@l */
/* 8095971C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80959720  7C A5 E8 2E */	lwzx r5, r5, r29
/* 80959724  4B 7F 94 45 */	bl getTexPtrnAnmP__8daNpcF_cFPci
/* 80959728  7C 64 1B 79 */	or. r4, r3, r3
/* 8095972C  3C 60 80 96 */	lis r3, l_btpGetParamList@ha /* 0x8095DA88@ha */
/* 80959730  38 03 DA 88 */	addi r0, r3, l_btpGetParamList@l /* 0x8095DA88@l */
...
/* 80959768  3C E0 80 96 */	lis r7, lit_4300@ha /* 0x8095D6BC@ha */
/* 8095976C  C0 27 D6 BC */	lfs f1, lit_4300@l(r7)  /* 0x8095D6BC@l */
/* 80959770  4B 7F 95 55 */	bl setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 809597AC  4B A0 8A 7D */	bl _restgpr_29
