...
/* 8095C538  3C 60 80 96 */	lis r3, m__16daNpcAsh_Param_c@ha /* 0x8095D640@ha */
/* 8095C53C  3B E3 D6 40 */	addi r31, r3, m__16daNpcAsh_Param_c@l /* 0x8095D640@l */
/* 8095C540  80 1E 0B E0 */	lwz r0, 0xbe0(r30)
/* 8095C544  28 00 00 00 */	cmplwi r0, 0
/* 8095C548  41 82 00 60 */	beq lbl_8095C5A8
/* 8095C54C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8095C550  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8095C574  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8095C578  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
