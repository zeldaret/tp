...
/* 80959248  4B A0 8F 91 */	bl _savegpr_28
...
/* 8095925C  3C 60 80 96 */	lis r3, lit_4385@ha /* 0x8095D6C4@ha */
/* 80959260  38 83 D6 C4 */	addi r4, r3, lit_4385@l /* 0x8095D6C4@l */
...
/* 80959298  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8095929C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809592A0  4B 9E D2 11 */	bl PSMTXCopy
/* 809592A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809592A8  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 809592DC  4B 9E D1 D5 */	bl PSMTXCopy
...
/* 8095930C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80959310  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80959314  4B 9E D1 9D */	bl PSMTXCopy
...
/* 80959340  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80959344  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80959348  4B 9E D1 69 */	bl PSMTXCopy
...
/* 80959378  3C C0 80 96 */	lis r6, m__16daNpcAsh_Param_c@ha /* 0x8095D640@ha */
/* 8095937C  38 C6 D6 40 */	addi r6, r6, m__16daNpcAsh_Param_c@l /* 0x8095D640@l */
/* 80959380  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80959384  4B 7F 9F F9 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80959388:
/* 80959388  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8095938C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80959390  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80959394  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80959398  7C 80 E2 14 */	add r4, r0, r28
/* 8095939C  4B 9E D1 15 */	bl PSMTXCopy
/* 809593A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809593A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809593A8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 809593AC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 809593B0  4B 9E D1 01 */	bl PSMTXCopy
...
/* 809593E0  4B 6B 45 B1 */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809593F8  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 809593FC  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 80959444  4B A0 8D E1 */	bl _restgpr_28
