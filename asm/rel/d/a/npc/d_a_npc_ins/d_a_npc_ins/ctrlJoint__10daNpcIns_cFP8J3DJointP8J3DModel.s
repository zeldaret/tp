...
/* 80A0F0CC  4B 95 31 0D */	bl _savegpr_28
...
/* 80A0F0E0  3C 60 80 A1 */	lis r3, lit_4507@ha /* 0x80A13EF4@ha */
/* 80A0F0E4  38 83 3E F4 */	addi r4, r3, lit_4507@l /* 0x80A13EF4@l */
...
/* 80A0F11C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0F120  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A0F124  4B 93 73 8D */	bl PSMTXCopy
/* 80A0F128  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0F12C  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A0F160  4B 93 73 51 */	bl PSMTXCopy
...
/* 80A0F190  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0F194  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A0F198  4B 93 73 19 */	bl PSMTXCopy
...
/* 80A0F1C4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0F1C8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A0F1CC  4B 93 72 E5 */	bl PSMTXCopy
...
/* 80A0F1FC  3C C0 80 A1 */	lis r6, m__16daNpcIns_Param_c@ha /* 0x80A13E6C@ha */
/* 80A0F200  38 C6 3E 6C */	addi r6, r6, m__16daNpcIns_Param_c@l /* 0x80A13E6C@l */
/* 80A0F204  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80A0F208  4B 74 41 75 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80A0F20C:
/* 80A0F20C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0F210  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A0F214  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80A0F218  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80A0F21C  7C 80 E2 14 */	add r4, r0, r28
/* 80A0F220  4B 93 72 91 */	bl PSMTXCopy
/* 80A0F224  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A0F228  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A0F22C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80A0F230  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80A0F234  4B 93 72 7D */	bl PSMTXCopy
...
/* 80A0F264  4B 5F E7 2D */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80A0F278  4B 95 2F AD */	bl _restgpr_28
