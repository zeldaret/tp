...
/* 80A12EBC  3C 60 80 A1 */	lis r3, l_insectParams@ha /* 0x80A13DAC@ha */
/* 80A12EC0  3B E3 3D AC */	addi r31, r3, l_insectParams@l /* 0x80A13DAC@l */
...
/* 80A12F44  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A12F48  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A12F4C  4B 93 35 65 */	bl PSMTXCopy
/* 80A12F50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A12F54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A12FF4  4B 93 40 C1 */	bl PSVECSubtract
...
/* 80A13014  4B 85 46 61 */	bl cM_atan2s__Fff
...
/* 80A13040  4B 93 40 F9 */	bl PSVECSquareMag
...
/* 80A130B0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A130B4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80A13120  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A13124  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80A13128  48 00 00 08 */	b lbl_80A13130
lbl_80A1312C:
/* 80A1312C  FC 40 08 90 */	fmr f2, f1
lbl_80A13130:
/* 80A13130  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80A13134  4B 85 45 41 */	bl cM_atan2s__Fff
...
/* 80A1317C  4B 85 C0 61 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80A13180  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A13184  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A13188  38 63 23 3C */	addi r3, r3, 0x233c
/* 80A1318C  38 9E 0C 8C */	addi r4, r30, 0xc8c
/* 80A13190  4B 85 1A 19 */	bl Set__4cCcSFP8cCcD_Obj
