...
/* 80A0E470  4B 95 3D 61 */	bl _savegpr_26
/* 80A0E474  7C 7E 1B 79 */	or. r30, r3, r3
/* 80A0E478  7C 9F 23 78 */	mr r31, r4
/* 80A0E47C  41 82 01 C8 */	beq lbl_80A0E644
/* 80A0E480  3C 60 80 A1 */	lis r3, __vt__10daNpcIns_c@ha /* 0x80A14518@ha */
/* 80A0E484  38 03 45 18 */	addi r0, r3, __vt__10daNpcIns_c@l /* 0x80A14518@l */
/* 80A0E488  90 1E 0B 44 */	stw r0, 0xb44(r30)
/* 80A0E48C  3B A0 00 00 */	li r29, 0
/* 80A0E490  3B 80 00 00 */	li r28, 0
/* 80A0E494  3C 60 80 A1 */	lis r3, l_arcNames@ha /* 0x80A14384@ha */
/* 80A0E498  3B 43 43 84 */	addi r26, r3, l_arcNames@l /* 0x80A14384@l */
/* 80A0E49C  3C 60 80 A1 */	lis r3, l_loadRes_list@ha /* 0x80A14378@ha */
/* 80A0E4A0  3B 63 43 78 */	addi r27, r3, l_loadRes_list@l /* 0x80A14378@l */
...
/* 80A0E4B8  4B 61 EB 51 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80A0E4EC  4B 60 2E 25 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80A0E4F0:
/* 80A0E4F0  34 1E 0C 8C */	addic. r0, r30, 0xc8c
/* 80A0E4F4  41 82 00 84 */	beq lbl_80A0E578
/* 80A0E4F8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80A0E4FC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80A0E51C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80A0E520  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80A0E538  3C 60 80 A1 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80A145C0@ha */
/* 80A0E53C  38 03 45 C0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80A145C0@l */
/* 80A0E540  90 1E 0D C4 */	stw r0, 0xdc4(r30)
lbl_80A0E544:
/* 80A0E544  34 1E 0D 90 */	addic. r0, r30, 0xd90
/* 80A0E548  41 82 00 24 */	beq lbl_80A0E56C
/* 80A0E54C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80A0E550  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80A0E554  90 1E 0D AC */	stw r0, 0xdac(r30)
/* 80A0E558  34 1E 0D 90 */	addic. r0, r30, 0xd90
/* 80A0E55C  41 82 00 10 */	beq lbl_80A0E56C
/* 80A0E560  3C 60 80 A1 */	lis r3, __vt__8cM3dGAab@ha /* 0x80A145CC@ha */
/* 80A0E564  38 03 45 CC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80A145CC@l */
/* 80A0E568  90 1E 0D A8 */	stw r0, 0xda8(r30)
lbl_80A0E56C:
/* 80A0E56C  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 80A0E570  38 80 00 00 */	li r4, 0
/* 80A0E574  4B 67 5B 71 */	bl __dt__12dCcD_GObjInfFv
lbl_80A0E578:
/* 80A0E578  38 7E 0C 80 */	addi r3, r30, 0xc80
/* 80A0E57C  3C 80 80 A1 */	lis r4, __dt__18daNpcF_ActorMngr_cFv@ha /* 0x80A13558@ha */
/* 80A0E580  38 84 35 58 */	addi r4, r4, __dt__18daNpcF_ActorMngr_cFv@l /* 0x80A13558@l */
/* 80A0E584  38 A0 00 08 */	li r5, 8
/* 80A0E588  38 C0 00 01 */	li r6, 1
/* 80A0E58C  4B 95 37 5D */	bl __destroy_arr
/* 80A0E590  34 1E 0B E4 */	addic. r0, r30, 0xbe4
/* 80A0E594  41 82 00 88 */	beq lbl_80A0E61C
/* 80A0E598  3C 60 80 A1 */	lis r3, __vt__15daNpcF_Lookat_c@ha /* 0x80A145D8@ha */
/* 80A0E59C  38 03 45 D8 */	addi r0, r3, __vt__15daNpcF_Lookat_c@l /* 0x80A145D8@l */
/* 80A0E5A0  90 1E 0C 7C */	stw r0, 0xc7c(r30)
/* 80A0E5A4  38 7E 0C 60 */	addi r3, r30, 0xc60
/* 80A0E5A8  3C 80 80 A1 */	lis r4, __dt__5csXyzFv@ha /* 0x80A136AC@ha */
/* 80A0E5AC  38 84 36 AC */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A136AC@l */
/* 80A0E5B0  38 A0 00 06 */	li r5, 6
/* 80A0E5B4  38 C0 00 04 */	li r6, 4
/* 80A0E5B8  4B 95 37 31 */	bl __destroy_arr
/* 80A0E5BC  38 7E 0C 48 */	addi r3, r30, 0xc48
/* 80A0E5C0  3C 80 80 A1 */	lis r4, __dt__5csXyzFv@ha /* 0x80A136AC@ha */
/* 80A0E5C4  38 84 36 AC */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A136AC@l */
/* 80A0E5C8  38 A0 00 06 */	li r5, 6
/* 80A0E5CC  38 C0 00 04 */	li r6, 4
/* 80A0E5D0  4B 95 37 19 */	bl __destroy_arr
/* 80A0E5D4  38 7E 0C 30 */	addi r3, r30, 0xc30
/* 80A0E5D8  3C 80 80 A1 */	lis r4, __dt__5csXyzFv@ha /* 0x80A136AC@ha */
/* 80A0E5DC  38 84 36 AC */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A136AC@l */
/* 80A0E5E0  38 A0 00 06 */	li r5, 6
/* 80A0E5E4  38 C0 00 04 */	li r6, 4
/* 80A0E5E8  4B 95 37 01 */	bl __destroy_arr
/* 80A0E5EC  38 7E 0C 18 */	addi r3, r30, 0xc18
/* 80A0E5F0  3C 80 80 A1 */	lis r4, __dt__5csXyzFv@ha /* 0x80A136AC@ha */
/* 80A0E5F4  38 84 36 AC */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A136AC@l */
/* 80A0E5F8  38 A0 00 06 */	li r5, 6
/* 80A0E5FC  38 C0 00 04 */	li r6, 4
/* 80A0E600  4B 95 36 E9 */	bl __destroy_arr
/* 80A0E604  38 7E 0B E4 */	addi r3, r30, 0xbe4
/* 80A0E608  3C 80 80 A1 */	lis r4, __dt__4cXyzFv@ha /* 0x80A136EC@ha */
/* 80A0E60C  38 84 36 EC */	addi r4, r4, __dt__4cXyzFv@l /* 0x80A136EC@l */
/* 80A0E610  38 A0 00 0C */	li r5, 0xc
/* 80A0E614  38 C0 00 04 */	li r6, 4
/* 80A0E618  4B 95 36 D1 */	bl __destroy_arr
lbl_80A0E61C:
/* 80A0E61C  38 7E 0B 48 */	addi r3, r30, 0xb48
/* 80A0E620  38 80 FF FF */	li r4, -1
/* 80A0E624  4B 8B 1D FD */	bl __dt__10Z2CreatureFv
...
/* 80A0E640  4B 8C 06 FD */	bl __dl__FPv
lbl_80A0E644:
/* 80A0E644  7F C3 F3 78 */	mr r3, r30
/* 80A0E648  39 61 00 20 */	addi r11, r1, 0x20
/* 80A0E64C  4B 95 3B D1 */	bl _restgpr_26
