...
/* 80A0EFCC  3C C0 80 A1 */	lis r6, m__16daNpcIns_Param_c@ha /* 0x80A13E6C@ha */
/* 80A0EFD0  38 C6 3E 6C */	addi r6, r6, m__16daNpcIns_Param_c@l /* 0x80A13E6C@l */
/* 80A0EFD4  C0 26 00 0C */	lfs f1, 0xc(r6)
/* 80A0EFD8  38 C0 00 00 */	li r6, 0
/* 80A0EFDC  38 E0 00 00 */	li r7, 0
/* 80A0EFE0  4B 74 32 CD */	bl draw__8daNpcF_cFiifP11_GXColorS10i
/* 80A0EFE4  80 9F 0B D8 */	lwz r4, 0xbd8(r31)
/* 80A0EFE8  28 04 00 00 */	cmplwi r4, 0
/* 80A0EFEC  41 82 00 58 */	beq lbl_80A0F044
/* 80A0EFF0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80A0EFF4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80A0EFF8  80 84 00 04 */	lwz r4, 4(r4)
/* 80A0EFFC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80A0F000  4B 79 5D A1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80A0F020  4B 93 74 91 */	bl PSMTXCopy
/* 80A0F024  80 7F 0B D8 */	lwz r3, 0xbd8(r31)
/* 80A0F028  4B 5F EC 9D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80A0F02C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A0F030  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A0F034  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 80A0F038  80 9F 09 A0 */	lwz r4, 0x9a0(r31)
/* 80A0F03C  80 BF 0B D8 */	lwz r5, 0xbd8(r31)
/* 80A0F040  4B 64 6E DD */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80A0F044:
/* 80A0F044  80 9F 0B DC */	lwz r4, 0xbdc(r31)
/* 80A0F048  28 04 00 00 */	cmplwi r4, 0
/* 80A0F04C  41 82 00 58 */	beq lbl_80A0F0A4
/* 80A0F050  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80A0F054  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80A0F058  80 84 00 04 */	lwz r4, 4(r4)
/* 80A0F05C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80A0F060  4B 79 5D 41 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80A0F080  4B 93 74 31 */	bl PSMTXCopy
/* 80A0F084  80 7F 0B DC */	lwz r3, 0xbdc(r31)
/* 80A0F088  4B 5F EC 3D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80A0F08C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A0F090  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A0F094  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 80A0F098  80 9F 09 A0 */	lwz r4, 0x9a0(r31)
/* 80A0F09C  80 BF 0B DC */	lwz r5, 0xbdc(r31)
/* 80A0F0A0  4B 64 6E 7D */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80A0F0A4:
