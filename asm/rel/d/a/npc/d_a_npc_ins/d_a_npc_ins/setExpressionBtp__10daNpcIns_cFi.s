...
/* 80A0F548  4B 95 2C 95 */	bl _savegpr_29
/* 80A0F54C  7C 7E 1B 78 */	mr r30, r3
/* 80A0F550  7C 9F 23 78 */	mr r31, r4
/* 80A0F554  1F BF 00 0C */	mulli r29, r31, 0xc
/* 80A0F558  3C 80 80 A1 */	lis r4, l_btpGetParamList@ha /* 0x80A142DC@ha */
/* 80A0F55C  38 A4 42 DC */	addi r5, r4, l_btpGetParamList@l /* 0x80A142DC@l */
/* 80A0F560  7C 85 EA 14 */	add r4, r5, r29
/* 80A0F564  80 04 00 08 */	lwz r0, 8(r4)
/* 80A0F568  54 00 10 3A */	slwi r0, r0, 2
/* 80A0F56C  3C 80 80 A1 */	lis r4, l_arcNames@ha /* 0x80A14384@ha */
/* 80A0F570  38 84 43 84 */	addi r4, r4, l_arcNames@l /* 0x80A14384@l */
/* 80A0F574  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A0F578  7C A5 E8 2E */	lwzx r5, r5, r29
/* 80A0F57C  4B 74 35 ED */	bl getTexPtrnAnmP__8daNpcF_cFPci
/* 80A0F580  7C 64 1B 79 */	or. r4, r3, r3
/* 80A0F584  3C 60 80 A1 */	lis r3, l_btpGetParamList@ha /* 0x80A142DC@ha */
/* 80A0F588  38 03 42 DC */	addi r0, r3, l_btpGetParamList@l /* 0x80A142DC@l */
...
/* 80A0F5C0  3C E0 80 A1 */	lis r7, lit_4414@ha /* 0x80A13EEC@ha */
/* 80A0F5C4  C0 27 3E EC */	lfs f1, lit_4414@l(r7)  /* 0x80A13EEC@l */
/* 80A0F5C8  4B 74 36 FD */	bl setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 80A0F604  4B 95 2C 25 */	bl _restgpr_29
