...
/* 80B4D32C  3C 60 80 B5 */	lis r3, __vt__13daNpc_Yelia_c@ha /* 0x80B53318@ha */
/* 80B4D330  38 03 33 18 */	addi r0, r3, __vt__13daNpc_Yelia_c@l /* 0x80B53318@l */
...
/* 80B4D344  4B 4C 3F CD */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80B4D348:
/* 80B4D348  7F C3 F3 78 */	mr r3, r30
/* 80B4D34C  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 80B4D350  54 00 10 3A */	slwi r0, r0, 2
/* 80B4D354  3C 80 80 B5 */	lis r4, l_loadResPtrnList@ha /* 0x80B52588@ha */
/* 80B4D358  38 84 25 88 */	addi r4, r4, l_loadResPtrnList@l /* 0x80B52588@l */
/* 80B4D35C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80B4D360  3C A0 80 B5 */	lis r5, l_resNameList@ha /* 0x80B52544@ha */
/* 80B4D364  38 A5 25 44 */	addi r5, r5, l_resNameList@l /* 0x80B52544@l */
/* 80B4D368  4B 5F B1 45 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80B4D36C  34 1E 0F BC */	addic. r0, r30, 0xfbc
/* 80B4D370  41 82 00 10 */	beq lbl_80B4D380
/* 80B4D374  3C 60 80 B5 */	lis r3, __vt__13daNpcT_Path_c@ha /* 0x80B5330C@ha */
/* 80B4D378  38 03 33 0C */	addi r0, r3, __vt__13daNpcT_Path_c@l /* 0x80B5330C@l */
/* 80B4D37C  90 1E 0F E0 */	stw r0, 0xfe0(r30)
lbl_80B4D380:
/* 80B4D380  38 7E 0F 84 */	addi r3, r30, 0xf84
/* 80B4D384  3C 80 80 B5 */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha /* 0x80B513E0@ha */
/* 80B4D388  38 84 13 E0 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l /* 0x80B513E0@l */
/* 80B4D38C  38 A0 00 08 */	li r5, 8
/* 80B4D390  38 C0 00 04 */	li r6, 4
/* 80B4D394  4B 81 49 55 */	bl __destroy_arr
/* 80B4D398  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80B4D39C  41 82 00 84 */	beq lbl_80B4D420
/* 80B4D3A0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80B4D3A4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80B4D3C4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80B4D3C8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80B4D3E0  3C 60 80 B5 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80B53300@ha */
/* 80B4D3E4  38 03 33 00 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80B53300@l */
/* 80B4D3E8  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_80B4D3EC:
/* 80B4D3EC  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80B4D3F0  41 82 00 24 */	beq lbl_80B4D414
/* 80B4D3F4  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80B4D3F8  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80B4D3FC  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 80B4D400  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80B4D404  41 82 00 10 */	beq lbl_80B4D414
/* 80B4D408  3C 60 80 B5 */	lis r3, __vt__8cM3dGAab@ha /* 0x80B532F4@ha */
/* 80B4D40C  38 03 32 F4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80B532F4@l */
/* 80B4D410  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_80B4D414:
/* 80B4D414  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80B4D418  38 80 00 00 */	li r4, 0
/* 80B4D41C  4B 53 6C C9 */	bl __dt__12dCcD_GObjInfFv
lbl_80B4D420:
...
/* 80B4D438  4B 78 19 05 */	bl __dl__FPv
lbl_80B4D43C:
