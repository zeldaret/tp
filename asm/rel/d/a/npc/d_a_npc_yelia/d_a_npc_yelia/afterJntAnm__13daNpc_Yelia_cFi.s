...
/* 80B4E084  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B4E088  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B4E08C  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 80B4E090  7C 00 00 D0 */	neg r0, r0
/* 80B4E094  7C 04 07 34 */	extsh r4, r0
/* 80B4E098  4B 4B E3 9D */	bl mDoMtx_YrotM__FPA4_fs
/* 80B4E09C  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 80B4E0A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B4E0A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B4E0A8  4B 4B E4 25 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B4E0AC  48 00 00 34 */	b lbl_80B4E0E0
lbl_80B4E0B0:
/* 80B4E0B0  2C 04 00 04 */	cmpwi r4, 4
/* 80B4E0B4  40 82 00 2C */	bne lbl_80B4E0E0
/* 80B4E0B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B4E0BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B4E0C0  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80B4E0C4  7C 00 00 D0 */	neg r0, r0
/* 80B4E0C8  7C 04 07 34 */	extsh r4, r0
/* 80B4E0CC  4B 4B E3 69 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B4E0D0  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80B4E0D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B4E0D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B4E0DC  4B 4B E3 F1 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B4E0E0:
