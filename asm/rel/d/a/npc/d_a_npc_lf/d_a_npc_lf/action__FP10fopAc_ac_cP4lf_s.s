...
/* 80A6A1C8  4B 8F 80 15 */	bl _savegpr_29
/* 80A6A1CC  7C 9D 23 78 */	mr r29, r4
/* 80A6A1D0  3C 80 80 A7 */	lis r4, lit_3769@ha /* 0x80A6A97C@ha */
/* 80A6A1D4  3B C4 A9 7C */	addi r30, r4, lit_3769@l /* 0x80A6A97C@l */
...
lbl_80A6A228:
/* 80A6A228  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80A6A22C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80A6A230  80 63 00 00 */	lwz r3, 0(r3)
/* 80A6A234  A8 9D 00 12 */	lha r4, 0x12(r29)
/* 80A6A238  4B 5A 21 A5 */	bl mDoMtx_YrotS__FPA4_fs
/* 80A6A23C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80A6A240  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80A6A244  80 63 00 00 */	lwz r3, 0(r3)
/* 80A6A248  A8 9D 00 10 */	lha r4, 0x10(r29)
/* 80A6A24C  4B 5A 21 51 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80A6A260  3C 60 80 A7 */	lis r3, l_HIO@ha /* 0x80A6AAA0@ha */
/* 80A6A264  3B E3 AA A0 */	addi r31, r3, l_HIO@l /* 0x80A6AAA0@l */
...
/* 80A6A2A0  4B 80 57 9D */	bl cLib_addCalc2__FPffff
...
/* 80A6A2C0  4B 80 57 7D */	bl cLib_addCalc2__FPffff
...
/* 80A6A304  3C C0 80 44 */	lis r6, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80A6A308  39 06 9A 20 */	addi r8, r6, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80A6A30C  3C C0 80 A7 */	lis r6, wp@ha /* 0x80A6AA1C@ha */
/* 80A6A310  38 E6 AA 1C */	addi r7, r6, wp@l /* 0x80A6AA1C@l */
...
/* 80A6A36C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80A6A370  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80A6A398  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A6A39C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A6A3A0  C0 3D 00 04 */	lfs f1, 4(r29)
/* 80A6A3A4  C0 5D 00 08 */	lfs f2, 8(r29)
/* 80A6A3A8  C0 7D 00 0C */	lfs f3, 0xc(r29)
/* 80A6A3AC  4B 8D C5 3D */	bl PSMTXTrans
/* 80A6A3B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A6A3B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A6A3C8  4B 5A 20 6D */	bl mDoMtx_YrotM__FPA4_fs
/* 80A6A3CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A6A3D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A6A3D4  A8 9D 00 10 */	lha r4, 0x10(r29)
/* 80A6A3D8  4B 5A 1F C5 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80A6A3F0  4B 5A 2A 49 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80A6A3F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A6A3F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A6A3FC  80 9D 00 00 */	lwz r4, 0(r29)
/* 80A6A400  38 84 00 24 */	addi r4, r4, 0x24
/* 80A6A404  4B 8D C0 AD */	bl PSMTXCopy
/* 80A6A408  39 61 00 30 */	addi r11, r1, 0x30
/* 80A6A40C  4B 8F 7E 1D */	bl _restgpr_29
