...
/* 80543058  4B E1 F1 7D */	bl _savegpr_27
/* 8054305C  3C A0 80 55 */	lis r5, lit_3905@ha /* 0x8054A964@ha */
/* 80543060  3B E5 A9 64 */	addi r31, r5, lit_3905@l /* 0x8054A964@l */
/* 80543064  2C 04 00 00 */	cmpwi r4, 0
/* 80543068  40 82 02 CC */	bne lbl_80543334
/* 8054306C  A3 63 00 14 */	lhz r27, 0x14(r3)
/* 80543070  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80543074  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80543098  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8054309C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 805430A0  80 84 00 00 */	lwz r4, 0(r4)
/* 805430A4  4B E0 34 0D */	bl PSMTXCopy
...
/* 805430BC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805430C0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805430C4  80 63 00 00 */	lwz r3, 0(r3)
/* 805430C8  A8 9C 06 C4 */	lha r4, 0x6c4(r28)
/* 805430CC  4B AC 93 69 */	bl mDoMtx_YrotM__FPA4_fs
/* 805430D0  48 00 02 30 */	b lbl_80543300
lbl_805430D4:
/* 805430D4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805430D8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8054311C  4B AC 92 81 */	bl mDoMtx_XrotM__FPA4_fs
/* 80543120  48 00 01 E0 */	b lbl_80543300
lbl_80543124:
/* 80543124  2C 1B 00 03 */	cmpwi r27, 3
/* 80543128  40 82 00 50 */	bne lbl_80543178
/* 8054312C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80543130  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80543150  4B AC 92 4D */	bl mDoMtx_XrotM__FPA4_fs
/* 80543154  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80543158  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80543170  4B AC 93 5D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80543174  48 00 01 8C */	b lbl_80543300
lbl_80543178:
/* 80543178  2C 1B 00 04 */	cmpwi r27, 4
/* 8054317C  40 82 00 50 */	bne lbl_805431CC
/* 80543180  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80543184  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805431A4  4B AC 91 F9 */	bl mDoMtx_XrotM__FPA4_fs
/* 805431A8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805431AC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805431C4  4B AC 93 09 */	bl mDoMtx_ZrotM__FPA4_fs
/* 805431C8  48 00 01 38 */	b lbl_80543300
lbl_805431CC:
/* 805431CC  2C 1B 00 0B */	cmpwi r27, 0xb
/* 805431D0  40 82 00 1C */	bne lbl_805431EC
/* 805431D4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805431D8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805431DC  80 63 00 00 */	lwz r3, 0(r3)
/* 805431E0  A8 9C 06 B6 */	lha r4, 0x6b6(r28)
/* 805431E4  4B AC 92 E9 */	bl mDoMtx_ZrotM__FPA4_fs
/* 805431E8  48 00 01 18 */	b lbl_80543300
lbl_805431EC:
/* 805431EC  2C 1B 00 0E */	cmpwi r27, 0xe
/* 805431F0  40 82 00 24 */	bne lbl_80543214
/* 805431F4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805431F8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805432B4  4B AC 92 19 */	bl mDoMtx_ZrotM__FPA4_fs
/* 805432B8  48 00 00 48 */	b lbl_80543300
lbl_805432BC:
/* 805432BC  2C 1B 00 1D */	cmpwi r27, 0x1d
/* 805432C0  40 82 00 1C */	bne lbl_805432DC
/* 805432C4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805432C8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805432CC  80 63 00 00 */	lwz r3, 0(r3)
/* 805432D0  A8 9C 07 06 */	lha r4, 0x706(r28)
/* 805432D4  4B AC 91 F9 */	bl mDoMtx_ZrotM__FPA4_fs
/* 805432D8  48 00 00 28 */	b lbl_80543300
lbl_805432DC:
/* 805432DC  2C 1B 00 1E */	cmpwi r27, 0x1e
/* 805432E0  40 82 00 20 */	bne lbl_80543300
/* 805432E4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805432E8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805432FC  4B AC 91 D1 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80543300:
/* 80543300  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80543304  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80543318  4B E0 31 99 */	bl PSMTXCopy
/* 8054331C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80543320  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80543324  80 63 00 00 */	lwz r3, 0(r3)
/* 80543328  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8054332C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80543330  4B E0 31 81 */	bl PSMTXCopy
lbl_80543334:
/* 80543334  38 60 00 01 */	li r3, 1
/* 80543338  39 61 00 30 */	addi r11, r1, 0x30
/* 8054333C  4B E1 EE E5 */	bl _restgpr_27
