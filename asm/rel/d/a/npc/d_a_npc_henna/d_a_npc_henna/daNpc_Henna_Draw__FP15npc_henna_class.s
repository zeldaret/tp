...
/* 80543368  3C 60 80 55 */	lis r3, lit_3905@ha /* 0x8054A964@ha */
/* 8054336C  3B C3 A9 64 */	addi r30, r3, lit_3905@l /* 0x8054A964@l */
...
lbl_80543384:
/* 80543384  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80543388  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8054338C  38 80 00 00 */	li r4, 0
/* 80543390  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80543394  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80543398  4B C6 04 2D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8054339C  88 1F 06 94 */	lbz r0, 0x694(r31)
/* 805433A0  7C 00 07 75 */	extsb. r0, r0
/* 805433A4  40 82 00 D4 */	bne lbl_80543478
/* 805433A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805433AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80543410  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80543414  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80543418  80 9E 00 04 */	lwz r4, 4(r30)
/* 8054341C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80543420  4B C6 19 81 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80543440  4B AC A2 99 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 8054346C  4B AC A1 7D */	bl entry__13mDoExt_btpAnmFP16J3DMaterialTables
/* 80543470  80 7F 06 24 */	lwz r3, 0x624(r31)
/* 80543474  4B AC D2 0D */	bl entryDL__14mDoExt_McaMorfFv
lbl_80543478:
/* 80543478  88 1F 06 93 */	lbz r0, 0x693(r31)
/* 8054347C  7C 00 07 75 */	extsb. r0, r0
/* 80543480  41 82 00 24 */	beq lbl_805434A4
/* 80543484  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80543488  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8054348C  80 9F 06 8C */	lwz r4, 0x68c(r31)
/* 80543490  80 84 00 04 */	lwz r4, 4(r4)
/* 80543494  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80543498  4B C6 19 09 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8054349C  80 7F 06 8C */	lwz r3, 0x68c(r31)
/* 805434A0  4B AC A8 25 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_805434A4:
