...
/* 80A1A1B8  3C 60 80 A2 */	lis r3, __vt__13daNpc_Jagar_c@ha
/* 80A1A1BC  38 03 AD 08 */	addi r0, r3, __vt__13daNpc_Jagar_c@l
/* 80A1A1C0  90 1F 0E 3C */	stw r0, 0xe3c(r31)
/* 80A1A1C4  3B DF 0E 44 */	addi r30, r31, 0xe44
/* 80A1A1C8  7F C3 F3 78 */	mr r3, r30
/* 80A1A1CC  4B 66 98 5C */	b __ct__12dCcD_GObjInfFv
/* 80A1A1D0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80A1A1D4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80A1A1D8  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80A1A1DC  3C 60 80 A2 */	lis r3, __vt__8cM3dGAab@ha
/* 80A1A1E0  38 03 AC E4 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80A1A1E4  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80A1A1E8  3C 60 80 A2 */	lis r3, __vt__8cM3dGCyl@ha
/* 80A1A1EC  38 03 AC F0 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80A1A1F0  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80A1A1F4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80A1A1F8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80A1A1FC  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80A1A200  38 03 00 58 */	addi r0, r3, 0x58
/* 80A1A204  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80A1A208  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80A1A20C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80A1A228  3C 80 80 A2 */	lis r4, __ct__18daNpcT_ActorMngr_cFv@ha
/* 80A1A22C  38 84 94 B8 */	addi r4, r4, __ct__18daNpcT_ActorMngr_cFv@l
/* 80A1A230  3C A0 80 A2 */	lis r5, __dt__18daNpcT_ActorMngr_cFv@ha
/* 80A1A234  38 A5 94 28 */	addi r5, r5, __dt__18daNpcT_ActorMngr_cFv@l
/* 80A1A238  38 C0 00 08 */	li r6, 8
/* 80A1A23C  38 E0 00 05 */	li r7, 5
/* 80A1A240  4B 94 7B 20 */	b __construct_array
/* 80A1A244  38 7F 0F AC */	addi r3, r31, 0xfac
/* 80A1A248  3C 80 80 A2 */	lis r4, __vt__13daNpcT_Path_c@ha
/* 80A1A24C  38 04 AC FC */	addi r0, r4, __vt__13daNpcT_Path_c@l
/* 80A1A250  90 1F 0F D0 */	stw r0, 0xfd0(r31)
/* 80A1A254  4B 72 B9 EC */	b initialize__13daNpcT_Path_cFv
