...
/* 80A91014  4B 8D 11 B1 */	bl _savegpr_23
/* 80A91018  7C 7F 1B 78 */	mr r31, r3
/* 80A9101C  3C 60 80 A9 */	lis r3, lit_3990@ha /* 0x80A9241C@ha */
/* 80A91020  3B C3 24 1C */	addi r30, r3, lit_3990@l /* 0x80A9241C@l */
/* 80A91024  4B 58 72 85 */	bl cDmrNowMidnaTalk__Fv
...
/* 80A91078  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A9107C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A91080  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80A91084  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80A91088  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80A9108C  A0 84 03 AC */	lhz r4, 0x3ac(r4)
/* 80A91090  4B 5A 39 2D */	bl isEventBit__11dSv_event_cCFUs
...
/* 80A910B4  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 80A910B8  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 80A910BC  38 81 00 20 */	addi r4, r1, 0x20
/* 80A910C0  4B 58 87 39 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80A91164  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A91168  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A9116C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80A91170  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80A91174  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80A91178  4B 8B 57 71 */	bl PSMTXTrans
/* 80A9117C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A91180  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A91184  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80A91188  4B 57 B2 AD */	bl mDoMtx_YrotM__FPA4_fs
/* 80A9118C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A91190  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A91194  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80A91198  4B 57 B2 05 */	bl mDoMtx_XrotM__FPA4_fs
/* 80A9119C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A911A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A911A4  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 80A911A8  4B 57 B3 25 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80A911AC  C0 3F 06 D8 */	lfs f1, 0x6d8(r31)
/* 80A911B0  3C 60 80 A9 */	lis r3, l_HIO@ha /* 0x80A92AD4@ha */
/* 80A911B4  38 63 2A D4 */	addi r3, r3, l_HIO@l /* 0x80A92AD4@l */
...
/* 80A911D0  4B 57 BC 69 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80A911D4  80 7F 05 E8 */	lwz r3, 0x5e8(r31)
/* 80A911D8  83 83 00 04 */	lwz r28, 4(r3)
/* 80A911DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A911E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A911E4  38 9C 00 24 */	addi r4, r28, 0x24
/* 80A911E8  4B 8B 52 C9 */	bl PSMTXCopy
...
/* 80A911FC  4B 57 F3 CD */	bl play__14mDoExt_McaMorfFP3VecUlSc
...
/* 80A91250  4B 57 F4 5D */	bl modelCalc__14mDoExt_McaMorfFv
/* 80A91254  88 1F 05 B4 */	lbz r0, 0x5b4(r31)
/* 80A91258  28 00 00 03 */	cmplwi r0, 3
/* 80A9125C  40 82 00 60 */	bne lbl_80A912BC
/* 80A91260  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A91264  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A91268  C0 3F 06 00 */	lfs f1, 0x600(r31)
/* 80A9126C  C0 5F 06 04 */	lfs f2, 0x604(r31)
/* 80A91270  C0 7F 06 08 */	lfs f3, 0x608(r31)
/* 80A91274  4B 8B 56 75 */	bl PSMTXTrans
/* 80A91278  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A9127C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A91280  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80A91284  4B 57 B1 B1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80A91288  80 7F 05 FC */	lwz r3, 0x5fc(r31)
/* 80A9128C  80 83 00 04 */	lwz r4, 4(r3)
/* 80A91290  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A91294  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A91298  38 84 00 24 */	addi r4, r4, 0x24
/* 80A9129C  4B 8B 52 15 */	bl PSMTXCopy
...
/* 80A912B0  4B 57 F3 19 */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 80A912B4  80 7F 05 FC */	lwz r3, 0x5fc(r31)
/* 80A912B8  4B 57 F3 F5 */	bl modelCalc__14mDoExt_McaMorfFv
lbl_80A912BC:
/* 80A912BC  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 80A912C0  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80A912C4  38 63 00 C0 */	addi r3, r3, 0xc0
/* 80A912C8  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80A912CC  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80A912D0  80 84 00 00 */	lwz r4, 0(r4)
/* 80A912D4  4B 8B 51 DD */	bl PSMTXCopy
/* 80A912D8  38 61 00 40 */	addi r3, r1, 0x40
/* 80A912DC  38 9F 05 38 */	addi r4, r31, 0x538
/* 80A912E0  4B 7D FC 0D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80A91320  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80A91324  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80A91328  80 84 00 00 */	lwz r4, 0(r4)
/* 80A9132C  4B 8B 51 85 */	bl PSMTXCopy
...
/* 80A91358  4B 7D E7 29 */	bl cLib_addCalc0__FPfff
/* 80A9135C  38 61 00 40 */	addi r3, r1, 0x40
/* 80A91360  38 81 00 34 */	addi r4, r1, 0x34
/* 80A91364  4B 7D FB 89 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80A9138C  4B 7D E2 BD */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 80A913A0  4B 7D E3 69 */	bl SetR__8cM3dGSphFf
/* 80A913A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A913A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A913AC  3A E3 23 3C */	addi r23, r3, 0x233c
/* 80A913B0  7E E3 BB 78 */	mr r3, r23
/* 80A913B4  38 9F 09 5C */	addi r4, r31, 0x95c
/* 80A913B8  4B 7D 37 F1 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80A91404  4B 8B 5C 8D */	bl PSVECAdd
...
/* 80A91474  3C 60 80 A9 */	lis r3, d_a_npc_ne__stringBase0@ha /* 0x80A925D0@ha */
/* 80A91478  38 03 25 D0 */	addi r0, r3, d_a_npc_ne__stringBase0@l /* 0x80A925D0@l */
/* 80A9147C  7C 04 00 40 */	cmplw r4, r0
/* 80A91480  40 82 00 C4 */	bne lbl_80A91544
/* 80A91484  4B 59 E5 D1 */	bl dComIfGs_wolfeye_effect_check__Fv
...
/* 80A9149C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A914A0  3A E3 61 C0 */	addi r23, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A914A4  3C 60 80 A9 */	lis r3, e_name@ha /* 0x80A92944@ha */
/* 80A914A8  3B 03 29 44 */	addi r24, r3, e_name@l /* 0x80A92944@l */
lbl_80A914AC:
...
/* 80A914F8  4B 5B BF D5 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80A9150C  4B 5B A4 0D */	bl getEmitter__Q213dPa_control_c7level_cFUl
/* 80A91510  7C 79 1B 79 */	or. r25, r3, r3
/* 80A91514  41 82 00 1C */	beq lbl_80A91530
/* 80A91518  4B 59 E5 3D */	bl dComIfGs_wolfeye_effect_check__Fv
...
/* 80A91564  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80A91568  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80A9156C  38 81 00 24 */	addi r4, r1, 0x24
/* 80A91570  4B 58 82 89 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80A91584  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A91588  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A9158C  4B 8B 4F 25 */	bl PSMTXCopy
/* 80A91590  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A91594  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A91598  38 80 B5 C8 */	li r4, -19000
/* 80A9159C  4B 57 AF 31 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80A915A0  C0 3E 00 64 */	lfs f1, 0x64(r30)
/* 80A915A4  FC 40 08 90 */	fmr f2, f1
/* 80A915A8  FC 60 08 90 */	fmr f3, f1
/* 80A915AC  4B 57 B8 8D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80A915B0  C0 3E 00 44 */	lfs f1, 0x44(r30)
/* 80A915B4  C0 5E 01 1C */	lfs f2, 0x11c(r30)
/* 80A915B8  C0 7E 00 B8 */	lfs f3, 0xb8(r30)
/* 80A915BC  4B 57 B7 E1 */	bl transM__14mDoMtx_stack_cFfff
/* 80A915C0  80 7D 06 00 */	lwz r3, 0x600(r29)
/* 80A915C4  80 83 00 04 */	lwz r4, 4(r3)
/* 80A915C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A915CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A915D0  38 84 00 24 */	addi r4, r4, 0x24
/* 80A915D4  4B 8B 4E DD */	bl PSMTXCopy
/* 80A915D8  3C 60 80 43 */	lis r3, g_Counter@ha /* 0x80430CD8@ha */
/* 80A915DC  38 63 0C D8 */	addi r3, r3, g_Counter@l /* 0x80430CD8@l */
/* 80A915E0  80 03 00 08 */	lwz r0, 8(r3)
/* 80A915E4  1C 00 3A 98 */	mulli r0, r0, 0x3a98
/* 80A915E8  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80A915EC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80A915F0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80A91680  4B 57 EF 49 */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 80A91684  80 7D 06 00 */	lwz r3, 0x600(r29)
/* 80A91688  4B 57 F0 25 */	bl modelCalc__14mDoExt_McaMorfFv
...
/* 80A91718  4B 8D 0A F9 */	bl _restgpr_23
