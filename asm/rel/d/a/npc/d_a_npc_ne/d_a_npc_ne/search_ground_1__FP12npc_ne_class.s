...
/* 80A8D7FC  4B 8D 49 CD */	bl _savegpr_24
/* 80A8D800  7C 7E 1B 78 */	mr r30, r3
/* 80A8D804  3C 60 80 A9 */	lis r3, lit_3990@ha /* 0x80A9241C@ha */
/* 80A8D808  3B E3 24 1C */	addi r31, r3, lit_3990@l /* 0x80A9241C@l */
/* 80A8D80C  38 61 00 4C */	addi r3, r1, 0x4c
/* 80A8D810  4B 5E A4 59 */	bl __ct__11dBgS_LinChkFv
/* 80A8D814  38 61 00 BC */	addi r3, r1, 0xbc
/* 80A8D818  3C 80 80 A9 */	lis r4, __ct__4cXyzFv@ha /* 0x80A8DD54@ha */
/* 80A8D81C  38 84 DD 54 */	addi r4, r4, __ct__4cXyzFv@l /* 0x80A8DD54@l */
/* 80A8D820  3C A0 80 A9 */	lis r5, __dt__4cXyzFv@ha /* 0x80A89160@ha */
/* 80A8D824  38 A5 91 60 */	addi r5, r5, __dt__4cXyzFv@l /* 0x80A89160@l */
/* 80A8D828  38 C0 00 0C */	li r6, 0xc
/* 80A8D82C  38 E0 00 10 */	li r7, 0x10
/* 80A8D830  4B 8D 45 31 */	bl __construct_array
/* 80A8D834  AB BE 04 E6 */	lha r29, 0x4e6(r30)
/* 80A8D838  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A8D83C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A8D840  3B 43 0F 38 */	addi r26, r3, 0xf38
/* 80A8D844  38 7A 3E C8 */	addi r3, r26, 0x3ec8
/* 80A8D848  3C 80 80 A9 */	lis r4, d_a_npc_ne__stringBase0@ha /* 0x80A925D0@ha */
/* 80A8D84C  38 84 25 D0 */	addi r4, r4, d_a_npc_ne__stringBase0@l /* 0x80A925D0@l */
/* 80A8D850  38 84 00 0F */	addi r4, r4, 0xf
/* 80A8D854  4B 8D B1 41 */	bl strcmp
...
/* 80A8D884  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80A8D888  3B 83 07 68 */	addi r28, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80A8D8BC  4B 57 EB 21 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80A8D8F8  4B 5E A4 6D */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80A8D8FC  7F 43 D3 78 */	mr r3, r26
/* 80A8D900  38 81 00 4C */	addi r4, r1, 0x4c
/* 80A8D904  4B 5E 6A B1 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80A8D984  4B 5E A3 E1 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80A8D988  7F 43 D3 78 */	mr r3, r26
/* 80A8D98C  38 81 00 4C */	addi r4, r1, 0x4c
/* 80A8D990  4B 5E 6A 25 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80A8DA14  4B 5E A3 51 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80A8DA18  7F 43 D3 78 */	mr r3, r26
/* 80A8DA1C  38 81 00 4C */	addi r4, r1, 0x4c
/* 80A8DA20  4B 5E 69 95 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80A8DAC0  4B 7D 90 75 */	bl __mi__4cXyzCFRC3Vec
...
/* 80A8DAD4  4B 7D 90 61 */	bl __mi__4cXyzCFRC3Vec
/* 80A8DAD8  38 61 00 1C */	addi r3, r1, 0x1c
/* 80A8DADC  4B 8B 96 5D */	bl PSVECSquareMag
...
/* 80A8DB48  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A8DB4C  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80A8DBB8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A8DBBC  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80A8DBC0  48 00 00 08 */	b lbl_80A8DBC8
lbl_80A8DBC4:
/* 80A8DBC4  FF C0 08 90 */	fmr f30, f1
lbl_80A8DBC8:
/* 80A8DBC8  38 61 00 10 */	addi r3, r1, 0x10
/* 80A8DBCC  4B 8B 95 6D */	bl PSVECSquareMag
...
/* 80A8DC38  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A8DC3C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80A8DCA8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A8DCAC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80A8DCB0:
...
/* 80A8DCF4  3C 80 80 A9 */	lis r4, __dt__4cXyzFv@ha /* 0x80A89160@ha */
/* 80A8DCF8  38 84 91 60 */	addi r4, r4, __dt__4cXyzFv@l /* 0x80A89160@l */
/* 80A8DCFC  38 A0 00 0C */	li r5, 0xc
/* 80A8DD00  38 C0 00 10 */	li r6, 0x10
/* 80A8DD04  4B 8D 3F E5 */	bl __destroy_arr
/* 80A8DD08  38 61 00 4C */	addi r3, r1, 0x4c
/* 80A8DD0C  38 80 FF FF */	li r4, -1
/* 80A8DD10  4B 5E 9F CD */	bl __dt__11dBgS_LinChkFv
...
/* 80A8DD40  4B 8D 44 D5 */	bl _restgpr_24
