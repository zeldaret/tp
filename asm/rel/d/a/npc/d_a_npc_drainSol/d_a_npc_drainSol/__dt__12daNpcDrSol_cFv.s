...
/* 809AE004  3C 60 80 9B */	lis r3, __vt__12daNpcDrSol_c@ha /* 0x809AFB68@ha */
/* 809AE008  38 03 FB 68 */	addi r0, r3, __vt__12daNpcDrSol_c@l /* 0x809AFB68@l */
...
/* 809AE01C  3C 80 80 9B */	lis r4, l_arcNames@ha /* 0x809AFAEC@ha */
/* 809AE020  38 84 FA EC */	addi r4, r4, l_arcNames@l /* 0x809AFAEC@l */
/* 809AE024  7C 84 00 2E */	lwzx r4, r4, r0
/* 809AE028  4B 67 EF E1 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 809AE03C  4B 66 32 D5 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_809AE040:
/* 809AE040  34 1E 0B E0 */	addic. r0, r30, 0xbe0
/* 809AE044  41 82 00 84 */	beq lbl_809AE0C8
/* 809AE048  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 809AE04C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 809AE06C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 809AE070  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 809AE088  3C 60 80 9B */	lis r3, __vt__8cM3dGCyl@ha /* 0x809AFC10@ha */
/* 809AE08C  38 03 FC 10 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x809AFC10@l */
/* 809AE090  90 1E 0D 18 */	stw r0, 0xd18(r30)
lbl_809AE094:
/* 809AE094  34 1E 0C E4 */	addic. r0, r30, 0xce4
/* 809AE098  41 82 00 24 */	beq lbl_809AE0BC
/* 809AE09C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 809AE0A0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 809AE0A4  90 1E 0D 00 */	stw r0, 0xd00(r30)
/* 809AE0A8  34 1E 0C E4 */	addic. r0, r30, 0xce4
/* 809AE0AC  41 82 00 10 */	beq lbl_809AE0BC
/* 809AE0B0  3C 60 80 9B */	lis r3, __vt__8cM3dGAab@ha /* 0x809AFC1C@ha */
/* 809AE0B4  38 03 FC 1C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809AFC1C@l */
/* 809AE0B8  90 1E 0C FC */	stw r0, 0xcfc(r30)
lbl_809AE0BC:
/* 809AE0BC  38 7E 0B E0 */	addi r3, r30, 0xbe0
/* 809AE0C0  38 80 00 00 */	li r4, 0
/* 809AE0C4  4B 6D 60 21 */	bl __dt__12dCcD_GObjInfFv
lbl_809AE0C8:
/* 809AE0C8  38 7E 0B 48 */	addi r3, r30, 0xb48
/* 809AE0CC  38 80 FF FF */	li r4, -1
/* 809AE0D0  4B 91 23 51 */	bl __dt__10Z2CreatureFv
...
/* 809AE0EC  4B 92 0C 51 */	bl __dl__FPv
lbl_809AE0F0:
