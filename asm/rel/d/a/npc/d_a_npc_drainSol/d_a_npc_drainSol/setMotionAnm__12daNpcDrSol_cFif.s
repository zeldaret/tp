...
/* 809AF15C  3C 80 80 9B */	lis r4, l_arcNames@ha
/* 809AF160  38 84 FA EC */	addi r4, r4, l_arcNames@l
/* 809AF164  7C 84 00 2E */	lwzx r4, r4, r0
/* 809AF168  54 BE 18 38 */	slwi r30, r5, 3
/* 809AF16C  3C A0 80 9B */	lis r5, l_bckGetParamList@ha
/* 809AF170  38 A5 FA D4 */	addi r5, r5, l_bckGetParamList@l
/* 809AF174  7C A5 F0 2E */	lwzx r5, r5, r30
/* 809AF178  4B 7A 39 B4 */	b getTrnsfrmKeyAnmP__8daNpcF_cFPci
/* 809AF17C  7C 64 1B 79 */	or. r4, r3, r3
/* 809AF180  3C 60 80 9B */	lis r3, l_bckGetParamList@ha
/* 809AF184  38 03 FA D4 */	addi r0, r3, l_bckGetParamList@l
...
/* 809AF1A8  3C C0 80 9B */	lis r6, lit_4190@ha
/* 809AF1AC  C0 26 FA 38 */	lfs f1, lit_4190@l(r6)
/* 809AF1B0  FC 40 F8 90 */	fmr f2, f31
/* 809AF1B4  38 C0 00 00 */	li r6, 0
/* 809AF1B8  38 E0 FF FF */	li r7, -1
/* 809AF1BC  4B 7A 3A 60 */	b setMcaMorfAnm__8daNpcF_cFP18J3DAnmTransformKeyffiii
