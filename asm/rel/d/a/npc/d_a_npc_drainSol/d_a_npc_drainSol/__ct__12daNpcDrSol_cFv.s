...
/* 809ADE88  3C 60 80 9B */	lis r3, __vt__12daNpcDrSol_c@ha /* 0x809AFB68@ha */
/* 809ADE8C  38 03 FB 68 */	addi r0, r3, __vt__12daNpcDrSol_c@l /* 0x809AFB68@l */
/* 809ADE90  90 1F 0B 44 */	stw r0, 0xb44(r31)
/* 809ADE94  38 7F 0B 48 */	addi r3, r31, 0xb48
/* 809ADE98  4B 91 25 31 */	bl __ct__10Z2CreatureFv
/* 809ADE9C  3B DF 0B E0 */	addi r30, r31, 0xbe0
/* 809ADEA0  7F C3 F3 78 */	mr r3, r30
/* 809ADEA4  4B 6D 5B 85 */	bl __ct__12dCcD_GObjInfFv
/* 809ADEA8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 809ADEAC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 809ADEB0  90 1E 01 20 */	stw r0, 0x120(r30)
/* 809ADEB4  3C 60 80 9B */	lis r3, __vt__8cM3dGAab@ha /* 0x809AFC1C@ha */
/* 809ADEB8  38 03 FC 1C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809AFC1C@l */
/* 809ADEBC  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 809ADEC0  3C 60 80 9B */	lis r3, __vt__8cM3dGCyl@ha /* 0x809AFC10@ha */
/* 809ADEC4  38 03 FC 10 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x809AFC10@l */
/* 809ADEC8  90 1E 01 38 */	stw r0, 0x138(r30)
/* 809ADECC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 809ADED0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 809ADED4  90 7E 01 20 */	stw r3, 0x120(r30)
/* 809ADED8  38 03 00 58 */	addi r0, r3, 0x58
/* 809ADEDC  90 1E 01 38 */	stw r0, 0x138(r30)
/* 809ADEE0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 809ADEE4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
