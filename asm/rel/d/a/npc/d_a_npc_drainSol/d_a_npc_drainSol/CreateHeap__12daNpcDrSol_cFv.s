...
/* 809AE364  4B 9B 3E 79 */	bl _savegpr_29
/* 809AE368  7C 7E 1B 78 */	mr r30, r3
/* 809AE36C  88 03 0D 39 */	lbz r0, 0xd39(r3)
/* 809AE370  54 00 10 3A */	slwi r0, r0, 2
/* 809AE374  3C 60 80 9B */	lis r3, l_arcNames@ha /* 0x809AFAEC@ha */
/* 809AE378  38 63 FA EC */	addi r3, r3, l_arcNames@l /* 0x809AFAEC@l */
/* 809AE37C  7C 63 00 2E */	lwzx r3, r3, r0
/* 809AE380  3C 80 80 9B */	lis r4, l_bmdGetParamList@ha /* 0x809AFACC@ha */
/* 809AE384  38 84 FA CC */	addi r4, r4, l_bmdGetParamList@l /* 0x809AFACC@l */
/* 809AE388  7C 84 00 2E */	lwzx r4, r4, r0
/* 809AE38C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809AE390  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809AE3A4  4B 68 DF 49 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 809AE3A8  7C 7D 1B 78 */	mr r29, r3
/* 809AE3AC  38 60 00 58 */	li r3, 0x58
/* 809AE3B0  4B 92 08 9D */	bl __nw__FUl
...
/* 809AE3EC  3D 20 80 9B */	lis r9, lit_4190@ha /* 0x809AFA38@ha */
/* 809AE3F0  C0 29 FA 38 */	lfs f1, lit_4190@l(r9)  /* 0x809AFA38@l */
/* 809AE3F4  39 20 00 00 */	li r9, 0
/* 809AE3F8  39 40 FF FF */	li r10, -1
/* 809AE3FC  4B 66 23 D5 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 809AE420  4B 66 2E F1 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
...
/* 809AE444  3C 60 80 9B */	lis r3, lit_4153@ha /* 0x809AFA20@ha */
/* 809AE448  38 63 FA 20 */	addi r3, r3, lit_4153@l /* 0x809AFA20@l */
...
/* 809AE4BC  3C 60 80 9B */	lis r3, l_arcNames@ha /* 0x809AFAEC@ha */
/* 809AE4C0  38 63 FA EC */	addi r3, r3, l_arcNames@l /* 0x809AFAEC@l */
...
/* 809AE4D4  4B 68 DE 19 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 809AE4E4  4B 66 67 71 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 809AE508  4B 9B 3D 21 */	bl _restgpr_29
