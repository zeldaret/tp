...
/* 80A26AE0  4B 93 B6 F9 */	bl _savegpr_28
...
/* 80A26AF4  3C 60 80 A3 */	lis r3, lit_4270@ha /* 0x80A2A0DC@ha */
/* 80A26AF8  38 83 A0 DC */	addi r4, r3, lit_4270@l /* 0x80A2A0DC@l */
...
/* 80A26B30  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A26B34  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A26B38  4B 91 F9 79 */	bl PSMTXCopy
/* 80A26B3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A26B40  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A26B74  4B 91 F9 3D */	bl PSMTXCopy
...
/* 80A26BA4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A26BA8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A26BAC  4B 91 F9 05 */	bl PSMTXCopy
...
/* 80A26BD8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A26BDC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A26BE0  4B 91 F8 D1 */	bl PSMTXCopy
...
/* 80A26C04  3C C0 80 A3 */	lis r6, m__21daNpcKasiMich_Param_c@ha /* 0x80A2A04C@ha */
/* 80A26C08  38 C6 A0 4C */	addi r6, r6, m__21daNpcKasiMich_Param_c@l /* 0x80A2A04C@l */
/* 80A26C0C  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80A26C10  4B 72 C7 6D */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80A26C14:
/* 80A26C14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A26C18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A26C1C  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80A26C20  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80A26C24  7C 80 E2 14 */	add r4, r0, r28
/* 80A26C28  4B 91 F8 89 */	bl PSMTXCopy
/* 80A26C2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A26C30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A26C34  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80A26C38  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80A26C3C  4B 91 F8 75 */	bl PSMTXCopy
/* 80A26C40  38 60 00 01 */	li r3, 1
/* 80A26C44  39 61 00 30 */	addi r11, r1, 0x30
/* 80A26C48  4B 93 B5 DD */	bl _restgpr_28
