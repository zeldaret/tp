...
/* 80A271AC  3C 80 80 A3 */	lis r4, l_bckGetParamList@ha
/* 80A271B0  38 A4 A2 D4 */	addi r5, r4, l_bckGetParamList@l
/* 80A271B4  7C 85 F2 14 */	add r4, r5, r30
/* 80A271B8  80 04 00 08 */	lwz r0, 8(r4)
/* 80A271BC  54 00 10 3A */	slwi r0, r0, 2
/* 80A271C0  3C 80 80 A3 */	lis r4, l_arcNames@ha
/* 80A271C4  38 84 A3 A0 */	addi r4, r4, l_arcNames@l
/* 80A271C8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A271CC  7C A5 F0 2E */	lwzx r5, r5, r30
/* 80A271D0  4B 72 B9 5C */	b getTrnsfrmKeyAnmP__8daNpcF_cFPci
/* 80A271D4  7C 64 1B 79 */	or. r4, r3, r3
/* 80A271D8  3C 60 80 A3 */	lis r3, l_bckGetParamList@ha
/* 80A271DC  38 03 A2 D4 */	addi r0, r3, l_bckGetParamList@l
...
/* 80A27200  3C C0 80 A3 */	lis r6, lit_4247@ha
/* 80A27204  C0 26 A0 D0 */	lfs f1, lit_4247@l(r6)
/* 80A27208  FC 40 F8 90 */	fmr f2, f31
/* 80A2720C  38 C0 00 00 */	li r6, 0
/* 80A27210  38 E0 FF FF */	li r7, -1
/* 80A27214  4B 72 BA 08 */	b setMcaMorfAnm__8daNpcF_cFP18J3DAnmTransformKeyffiii
