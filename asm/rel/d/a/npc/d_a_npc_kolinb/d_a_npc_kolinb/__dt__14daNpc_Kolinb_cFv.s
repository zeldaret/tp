...
/* 80A459AC  3C 60 80 A5 */	lis r3, __vt__14daNpc_Kolinb_c@ha /* 0x80A48DB0@ha */
/* 80A459B0  38 03 8D B0 */	addi r0, r3, __vt__14daNpc_Kolinb_c@l /* 0x80A48DB0@l */
...
/* 80A459C4  4B 5C B9 4D */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80A459C8:
/* 80A459C8  80 9E 0F B0 */	lwz r4, 0xfb0(r30)
/* 80A459CC  28 04 00 00 */	cmplwi r4, 0
/* 80A459D0  41 82 00 14 */	beq lbl_80A459E4
/* 80A459D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A459D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A459DC  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80A459E0  4B 62 E8 71 */	bl Release__4cBgSFP9dBgW_Base
lbl_80A459E4:
/* 80A459E4  7F C3 F3 78 */	mr r3, r30
/* 80A459E8  88 1E 0F B4 */	lbz r0, 0xfb4(r30)
/* 80A459EC  54 00 10 3A */	slwi r0, r0, 2
/* 80A459F0  3C 80 80 A5 */	lis r4, l_loadResPtrnList@ha /* 0x80A488A8@ha */
/* 80A459F4  38 84 88 A8 */	addi r4, r4, l_loadResPtrnList@l /* 0x80A488A8@l */
/* 80A459F8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A459FC  3C A0 80 A5 */	lis r5, l_resNameList@ha /* 0x80A48894@ha */
/* 80A45A00  38 A5 88 94 */	addi r5, r5, l_resNameList@l /* 0x80A48894@l */
/* 80A45A04  4B 70 2A A9 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80A45A08  34 1E 0F D0 */	addic. r0, r30, 0xfd0
/* 80A45A0C  41 82 00 10 */	beq lbl_80A45A1C
/* 80A45A10  3C 60 80 A5 */	lis r3, __vt__13daNpcT_Path_c@ha /* 0x80A48DA4@ha */
/* 80A45A14  38 03 8D A4 */	addi r0, r3, __vt__13daNpcT_Path_c@l /* 0x80A48DA4@l */
/* 80A45A18  90 1E 0F F4 */	stw r0, 0xff4(r30)
lbl_80A45A1C:
/* 80A45A1C  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80A45A20  41 82 00 84 */	beq lbl_80A45AA4
/* 80A45A24  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80A45A28  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80A45A48  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80A45A4C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80A45A64  3C 60 80 A5 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80A48D98@ha */
/* 80A45A68  38 03 8D 98 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80A48D98@l */
/* 80A45A6C  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_80A45A70:
/* 80A45A70  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80A45A74  41 82 00 24 */	beq lbl_80A45A98
/* 80A45A78  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80A45A7C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80A45A80  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 80A45A84  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80A45A88  41 82 00 10 */	beq lbl_80A45A98
/* 80A45A8C  3C 60 80 A5 */	lis r3, __vt__8cM3dGAab@ha /* 0x80A48D8C@ha */
/* 80A45A90  38 03 8D 8C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80A48D8C@l */
/* 80A45A94  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_80A45A98:
/* 80A45A98  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80A45A9C  38 80 00 00 */	li r4, 0
/* 80A45AA0  4B 63 E6 45 */	bl __dt__12dCcD_GObjInfFv
lbl_80A45AA4:
...
/* 80A45ABC  4B 88 92 81 */	bl __dl__FPv
lbl_80A45AC0:
