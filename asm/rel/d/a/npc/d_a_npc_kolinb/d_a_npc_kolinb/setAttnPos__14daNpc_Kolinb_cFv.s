...
/* 80A46900  3C 80 80 A5 */	lis r4, m__20daNpc_Kolinb_Param_c@ha /* 0x80A48710@ha */
/* 80A46904  3B C4 87 10 */	addi r30, r4, m__20daNpc_Kolinb_Param_c@l /* 0x80A48710@l */
...
/* 80A46920  4B 70 28 71 */	bl setMtx__8daNpcT_cFv
...
/* 80A46940  4B 8F FB 71 */	bl PSMTXCopy
/* 80A46944  80 7F 0F B0 */	lwz r3, 0xfb0(r31)
/* 80A46948  4B 63 50 79 */	bl Move__4dBgWFv
lbl_80A4694C:
...
/* 80A46978  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A4697C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A46980  4B 8F FB 31 */	bl PSMTXCopy
/* 80A46984  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A46988  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A4698C  38 81 00 18 */	addi r4, r1, 0x18
/* 80A46990  38 BF 05 38 */	addi r5, r31, 0x538
/* 80A46994  4B 90 03 D9 */	bl PSMTXMultVec
...
/* 80A469B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A469B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A469BC  A8 9F 0D 7A */	lha r4, 0xd7a(r31)
/* 80A469C0  4B 5C 5A 1D */	bl mDoMtx_YrotS__FPA4_fs
/* 80A469C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A469C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A469CC  38 81 00 18 */	addi r4, r1, 0x18
/* 80A469D0  7C 85 23 78 */	mr r5, r4
/* 80A469D4  4B 90 03 99 */	bl PSMTXMultVec
/* 80A469D8  38 61 00 0C */	addi r3, r1, 0xc
/* 80A469DC  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80A469E0  38 A1 00 18 */	addi r5, r1, 0x18
/* 80A469E4  4B 82 01 01 */	bl __pl__4cXyzCFRC3Vec
