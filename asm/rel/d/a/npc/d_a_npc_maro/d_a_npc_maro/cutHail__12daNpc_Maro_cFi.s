...
/* 8055E424  4B E0 3D B1 */	bl _savegpr_27
/* 8055E428  7C 7E 1B 78 */	mr r30, r3
/* 8055E42C  7C 9B 23 78 */	mr r27, r4
/* 8055E430  3B E0 00 00 */	li r31, 0
/* 8055E434  3B 80 FF FF */	li r28, -1
/* 8055E438  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055E43C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055E440  3B A3 4F F8 */	addi r29, r3, 0x4ff8
/* 8055E444  7F A3 EB 78 */	mr r3, r29
/* 8055E448  3C A0 80 56 */	lis r5, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055E44C  38 A5 4D 58 */	addi r5, r5, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055E450  38 A5 02 1B */	addi r5, r5, 0x21b
/* 8055E454  38 C0 00 03 */	li r6, 3
/* 8055E458  4B AE 9C 95 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8055E470  4B AE 98 DD */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8055E4A0  4B BE 73 F9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055E4A4  93 BE 0B 5C */	stw r29, 0xb5c(r30)
/* 8055E4A8  38 00 00 09 */	li r0, 9
/* 8055E4AC  90 1E 0B 58 */	stw r0, 0xb58(r30)
/* 8055E4B0  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E4B4  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055E4D0  4B BE 73 C9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055E4D4  93 BE 0B 80 */	stw r29, 0xb80(r30)
/* 8055E4D8  38 00 00 00 */	li r0, 0
/* 8055E4DC  90 1E 0B 7C */	stw r0, 0xb7c(r30)
/* 8055E4E0  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E4E4  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055E530  4B BE 71 CD */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055E534  38 00 00 00 */	li r0, 0
/* 8055E538  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 8055E53C  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E540  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055E564  4B E0 3C BD */	bl _restgpr_27
