...
/* 8055B5AC  3C 80 80 56 */	lis r4, __vt__12daNpc_Maro_c@ha
/* 8055B5B0  38 04 5C A4 */	addi r0, r4, __vt__12daNpc_Maro_c@l
/* 8055B5B4  90 1E 0E 3C */	stw r0, 0xe3c(r30)
/* 8055B5B8  4B C3 EF AC */	b deleteObject__13dShopSystem_cFv
...
/* 8055B5D0  4B AD 41 CC */	b dComIfG_TimerDeleteRequest__Fi
lbl_8055B5D4:
/* 8055B5D4  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 8055B5D8  28 03 00 00 */	cmplwi r3, 0
/* 8055B5DC  41 82 00 08 */	beq lbl_8055B5E4
/* 8055B5E0  4B AB 5D 30 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_8055B5E4:
/* 8055B5E4  7F C3 F3 78 */	mr r3, r30
/* 8055B5E8  88 1E 10 C0 */	lbz r0, 0x10c0(r30)
/* 8055B5EC  54 00 10 3A */	slwi r0, r0, 2
/* 8055B5F0  3C 80 80 56 */	lis r4, l_loadResPtrnList@ha
/* 8055B5F4  38 84 50 80 */	addi r4, r4, l_loadResPtrnList@l
/* 8055B5F8  7C 84 00 2E */	lwzx r4, r4, r0
/* 8055B5FC  3C A0 80 56 */	lis r5, l_resNameList@ha
/* 8055B600  38 A5 50 44 */	addi r5, r5, l_resNameList@l
/* 8055B604  4B BE CE A8 */	b deleteRes__8daNpcT_cFPCScPPCc
/* 8055B608  38 7E 10 C4 */	addi r3, r30, 0x10c4
/* 8055B60C  3C 80 80 56 */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha
/* 8055B610  38 84 38 80 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l
/* 8055B614  38 A0 00 08 */	li r5, 8
/* 8055B618  38 C0 00 09 */	li r6, 9
/* 8055B61C  4B E0 66 CC */	b __destroy_arr
/* 8055B620  34 1E 0F 80 */	addic. r0, r30, 0xf80
/* 8055B624  41 82 00 84 */	beq lbl_8055B6A8
/* 8055B628  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 8055B62C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 8055B64C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 8055B650  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
