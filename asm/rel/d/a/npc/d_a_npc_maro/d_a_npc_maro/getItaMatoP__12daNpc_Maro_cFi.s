...
/* 8055C260  4B E0 5F 6C */	b _savegpr_25
/* 8055C264  7C 7D 1B 78 */	mr r29, r3
/* 8055C268  7C 9E 23 78 */	mr r30, r4
/* 8055C26C  3B E0 00 00 */	li r31, 0
/* 8055C270  3C 60 80 56 */	lis r3, lit_4808@ha
/* 8055C274  C3 E3 4C B8 */	lfs f31, lit_4808@l(r3)
/* 8055C278  38 00 00 00 */	li r0, 0
/* 8055C27C  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha
/* 8055C280  90 03 0F DC */	stw r0, mFindCount__8daNpcT_c@l(r3)
/* 8055C284  3C 60 80 56 */	lis r3, srchItaMato__12daNpc_Maro_cFPvPv@ha
/* 8055C288  38 63 C1 AC */	addi r3, r3, srchItaMato__12daNpc_Maro_cFPvPv@l
/* 8055C28C  7F A4 EB 78 */	mr r4, r29
/* 8055C290  4B AB D5 68 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 8055C294  3B 20 00 00 */	li r25, 0
/* 8055C298  3B 80 00 00 */	li r28, 0
/* 8055C29C  3C 60 80 42 */	lis r3, mFindActorPtrs__8daNpcT_c@ha
/* 8055C2A0  3B 43 57 08 */	addi r26, r3, mFindActorPtrs__8daNpcT_c@l
/* 8055C2A4  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha
/* 8055C2A8  3B 63 0F DC */	addi r27, r3, mFindCount__8daNpcT_c@l
...
/* 8055C2D8  4B AB E5 08 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8055C2EC  4B AB E4 F4 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8055C31C  4B E0 5E FC */	b _restgpr_25
