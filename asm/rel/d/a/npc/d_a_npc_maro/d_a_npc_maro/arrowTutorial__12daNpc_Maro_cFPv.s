...
/* 805631F4  4B BE 26 A5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 805631F8  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 805631FC  38 00 00 09 */	li r0, 9
/* 80563200  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80563204  3C 60 80 56 */	lis r3, lit_5128@ha /* 0x80564CCC@ha */
/* 80563208  C0 03 4C CC */	lfs f0, lit_5128@l(r3)  /* 0x80564CCC@l */
...
/* 80563224  4B BE 26 75 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80563228  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 8056322C  38 00 00 00 */	li r0, 0
/* 80563230  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80563234  3C 60 80 56 */	lis r3, lit_5128@ha /* 0x80564CCC@ha */
/* 80563238  C0 03 4C CC */	lfs f0, lit_5128@l(r3)  /* 0x80564CCC@l */
...
/* 8056324C  4B BE 99 21 */	bl daNpcT_chkTmpBit__FUl
...
/* 8056328C  4B BE 24 7D */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 80563290  28 03 00 00 */	cmplwi r3, 0
/* 80563294  41 82 00 50 */	beq lbl_805632E4
/* 80563298  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056329C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80563308  4B BE 97 A5 */	bl daNpcT_chkEvtBit__FUl
/* 8056330C  2C 03 00 00 */	cmpwi r3, 0
/* 80563310  40 82 00 4C */	bne lbl_8056335C
/* 80563314  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80563318  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8056331C  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 80563320  7F C3 F3 78 */	mr r3, r30
/* 80563324  4B AC 98 B9 */	bl getTimerPtr__14dComIfG_play_cFv
/* 80563328  28 03 00 00 */	cmplwi r3, 0
/* 8056332C  41 82 00 30 */	beq lbl_8056335C
/* 80563330  7F C3 F3 78 */	mr r3, r30
/* 80563334  4B AC 98 89 */	bl getTimerMode__14dComIfG_play_cFv
/* 80563338  2C 03 00 00 */	cmpwi r3, 0
/* 8056333C  40 82 00 20 */	bne lbl_8056335C
/* 80563340  7F C3 F3 78 */	mr r3, r30
/* 80563344  4B AC 98 99 */	bl getTimerPtr__14dComIfG_play_cFv
/* 80563348  4B CF A7 55 */	bl getRestTimeMs__8dTimer_cFv
...
/* 80563378  4B BE 23 85 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8056337C  38 00 00 00 */	li r0, 0
/* 80563380  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80563384  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 80563388  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 805633E0  4B BE 82 69 */	bl step__8daNpcT_cFsiiii
...
/* 805633FC  4B BE 76 1D */	bl setAngle__8daNpcT_cFs
