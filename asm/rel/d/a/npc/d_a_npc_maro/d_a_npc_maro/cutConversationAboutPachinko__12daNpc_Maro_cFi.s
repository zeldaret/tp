...
/* 8055DDEC  4B E0 43 E9 */	bl _savegpr_27
/* 8055DDF0  7C 7E 1B 78 */	mr r30, r3
/* 8055DDF4  7C 9B 23 78 */	mr r27, r4
/* 8055DDF8  3B E0 00 00 */	li r31, 0
/* 8055DDFC  3B 80 FF FF */	li r28, -1
/* 8055DE00  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055DE04  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055DE08  3B A3 4F F8 */	addi r29, r3, 0x4ff8
/* 8055DE0C  7F A3 EB 78 */	mr r3, r29
/* 8055DE10  3C A0 80 56 */	lis r5, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055DE14  38 A5 4D 58 */	addi r5, r5, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055DE18  38 A5 02 1B */	addi r5, r5, 0x21b
/* 8055DE1C  38 C0 00 03 */	li r6, 3
/* 8055DE20  4B AE A2 CD */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8055DE38  4B AE 9F 15 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8055DE58  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055DE5C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055DE60  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8055DE64  4B AB C8 AD */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8055DE9C  4B BE 78 61 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055DEA0  38 00 00 00 */	li r0, 0
/* 8055DEA4  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 8055DEA8  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055DEAC  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055DEF4  4B BE D7 55 */	bl step__8daNpcT_cFsiiii
...
/* 8055DF14  4B BE 79 85 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055DF18  93 BE 0B 5C */	stw r29, 0xb5c(r30)
/* 8055DF1C  38 00 00 09 */	li r0, 9
/* 8055DF20  90 1E 0B 58 */	stw r0, 0xb58(r30)
/* 8055DF24  3C 60 80 56 */	lis r3, lit_5128@ha /* 0x80564CCC@ha */
/* 8055DF28  C0 03 4C CC */	lfs f0, lit_5128@l(r3)  /* 0x80564CCC@l */
