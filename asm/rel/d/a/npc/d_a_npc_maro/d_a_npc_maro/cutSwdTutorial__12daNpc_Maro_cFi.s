...
/* 8055E134  4B E0 40 A1 */	bl _savegpr_27
/* 8055E138  7C 7D 1B 78 */	mr r29, r3
/* 8055E13C  7C 9B 23 78 */	mr r27, r4
/* 8055E140  3B E0 00 00 */	li r31, 0
/* 8055E144  3B C0 FF FF */	li r30, -1
/* 8055E148  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055E14C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055E150  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 8055E154  7F 83 E3 78 */	mr r3, r28
/* 8055E158  3C A0 80 56 */	lis r5, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055E15C  38 A5 4D 58 */	addi r5, r5, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055E160  38 A5 02 1B */	addi r5, r5, 0x21b
/* 8055E164  38 C0 00 03 */	li r6, 3
/* 8055E168  4B AE 9F 85 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8055E180  4B AE 9B CD */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8055E1B8  4B BE 76 E1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055E1BC  93 9D 0B 5C */	stw r28, 0xb5c(r29)
/* 8055E1C0  38 00 00 01 */	li r0, 1
/* 8055E1C4  90 1D 0B 58 */	stw r0, 0xb58(r29)
/* 8055E1C8  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E1CC  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055E1E8  4B BE 76 B1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055E1EC  93 9D 0B 80 */	stw r28, 0xb80(r29)
/* 8055E1F0  38 00 00 00 */	li r0, 0
/* 8055E1F4  90 1D 0B 7C */	stw r0, 0xb7c(r29)
/* 8055E1F8  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E1FC  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
/* 8055E200  D0 1D 0B 8C */	stfs f0, 0xb8c(r29)
lbl_8055E204:
/* 8055E204  7F A3 EB 78 */	mr r3, r29
/* 8055E208  A8 9D 04 B6 */	lha r4, 0x4b6(r29)
/* 8055E20C  4B BE C8 0D */	bl setAngle__8daNpcT_cFs
...
/* 8055E230  4B BE C6 D9 */	bl setPos__8daNpcT_cF4cXyz
lbl_8055E234:
...
/* 8055E284  4B BE 74 79 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055E288  38 00 00 00 */	li r0, 0
/* 8055E28C  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 8055E290  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E294  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055E2D0  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E2D4  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
/* 8055E2D8  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 8055E2DC  3C 60 80 56 */	lis r3, lit_5731@ha /* 0x80564CFC@ha */
/* 8055E2E0  C0 03 4C FC */	lfs f0, lit_5731@l(r3)  /* 0x80564CFC@l */
/* 8055E2E4  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 8055E2E8  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 8055E2EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8055E2F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8055E2F4  A8 9D 0D 7A */	lha r4, 0xd7a(r29)
/* 8055E2F8  38 04 20 00 */	addi r0, r4, 0x2000
/* 8055E2FC  7C 04 07 34 */	extsh r4, r0
/* 8055E300  4B AA E0 DD */	bl mDoMtx_YrotS__FPA4_fs
/* 8055E304  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8055E308  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8055E30C  38 81 00 20 */	addi r4, r1, 0x20
/* 8055E310  7C 85 23 78 */	mr r5, r4
/* 8055E314  4B DE 8A 59 */	bl PSMTXMultVec
/* 8055E318  38 61 00 08 */	addi r3, r1, 8
/* 8055E31C  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 8055E320  38 A1 00 20 */	addi r5, r1, 0x20
/* 8055E324  4B D0 87 C1 */	bl __pl__4cXyzCFRC3Vec
...
/* 8055E36C  4B BE 73 91 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055E370  38 00 00 00 */	li r0, 0
/* 8055E374  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 8055E378  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E37C  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055E3CC  4B BE 73 31 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055E3D0  38 00 00 00 */	li r0, 0
/* 8055E3D4  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 8055E3D8  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055E3DC  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055E400  4B E0 3E 21 */	bl _restgpr_27
