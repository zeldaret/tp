...
/* 8055F83C  4B E0 29 95 */	bl _savegpr_26
/* 8055F840  7C 7B 1B 78 */	mr r27, r3
/* 8055F844  7C 9A 23 78 */	mr r26, r4
/* 8055F848  38 7B 0B A0 */	addi r3, r27, 0xba0
/* 8055F84C  4B BE 5E BD */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8055F850  7C 7F 1B 78 */	mr r31, r3
/* 8055F854  3B A0 00 00 */	li r29, 0
/* 8055F858  3B 80 FF FF */	li r28, -1
/* 8055F85C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055F860  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055F864  3B C3 4F F8 */	addi r30, r3, 0x4ff8
/* 8055F868  7F C3 F3 78 */	mr r3, r30
/* 8055F86C  7F 44 D3 78 */	mr r4, r26
/* 8055F870  3C A0 80 56 */	lis r5, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055F874  38 A5 4D 58 */	addi r5, r5, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055F878  38 A5 02 1B */	addi r5, r5, 0x21b
/* 8055F87C  38 C0 00 03 */	li r6, 3
/* 8055F880  4B AE 88 6D */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8055F898  4B AE 84 B5 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8055F8D0  4B BE 5F C9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055F8D4  93 5B 0B 5C */	stw r26, 0xb5c(r27)
/* 8055F8D8  38 00 00 09 */	li r0, 9
/* 8055F8DC  90 1B 0B 58 */	stw r0, 0xb58(r27)
/* 8055F8E0  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055F8E4  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055F900  4B BE 5F 99 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055F904  93 5B 0B 80 */	stw r26, 0xb80(r27)
/* 8055F908  38 00 00 00 */	li r0, 0
/* 8055F90C  90 1B 0B 7C */	stw r0, 0xb7c(r27)
/* 8055F910  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055F914  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055F92C  4B BE 5D D1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055F930  38 00 00 00 */	li r0, 0
/* 8055F934  90 1B 0B C8 */	stw r0, 0xbc8(r27)
/* 8055F938  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055F93C  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055F9A0  4B BE CB 61 */	bl daNpcT_getPlayerInfoFromPlayerList__FiiP4cXyzP5csXyz
/* 8055F9A4  2C 03 00 00 */	cmpwi r3, 0
/* 8055F9A8  41 82 00 C0 */	beq lbl_8055FA68
/* 8055F9AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055F9B0  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8055F9E8  4B AE 89 DD */	bl setGoal__16dEvent_manager_cFP4cXyz
...
/* 8055FA10  4B BE C1 E1 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 8055FA14  7F 63 DB 78 */	mr r3, r27
/* 8055FA18  A8 9B 0D C8 */	lha r4, 0xdc8(r27)
/* 8055FA1C  4B BE AF FD */	bl setAngle__8daNpcT_cFs
...
/* 8055FA30  4B BE 5C CD */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055FA34  38 00 00 00 */	li r0, 0
/* 8055FA38  90 1B 0B C8 */	stw r0, 0xbc8(r27)
/* 8055FA3C  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055FA40  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055FA9C  4B BE C1 DD */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 8055FAB8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055FABC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055FAC0  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8055FAC4  4B BE 5C 1D */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 8055FAC8  38 7B 0B A0 */	addi r3, r27, 0xba0
/* 8055FACC  4B BE 5C 31 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055FAD0  3B A0 00 01 */	li r29, 1
lbl_8055FAD4:
/* 8055FAD4  7F A3 EB 78 */	mr r3, r29
/* 8055FAD8  39 61 00 40 */	addi r11, r1, 0x40
/* 8055FADC  4B E0 27 41 */	bl _restgpr_26
