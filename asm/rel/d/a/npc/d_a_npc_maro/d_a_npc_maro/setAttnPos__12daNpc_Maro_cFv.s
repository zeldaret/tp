...
/* 8055D6A0  4B E0 4B 35 */	bl _savegpr_27
/* 8055D6A4  7C 7E 1B 78 */	mr r30, r3
/* 8055D6A8  3C 60 80 56 */	lis r3, m__18daNpc_Maro_Param_c@ha /* 0x80564BAC@ha */
/* 8055D6AC  3B E3 4B AC */	addi r31, r3, m__18daNpc_Maro_Param_c@l /* 0x80564BAC@l */
...
/* 8055D6D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055D6D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8055D6F0  4B BE A7 4D */	bl calc__19daNpcT_DmgStagger_cFi
...
/* 8055D7C8  4B BE 95 11 */	bl setParam__15daNpcT_JntAnm_cFP10fopAc_ac_cP8J3DModelP4cXyziiiffffffffffP4cXyz
...
/* 8055D7DC  4B BE A4 5D */	bl calcJntRad__15daNpcT_JntAnm_cFfff
/* 8055D7E0  7F C3 F3 78 */	mr r3, r30
/* 8055D7E4  4B BE B9 AD */	bl setMtx__8daNpcT_cFv
...
/* 8055D814  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8055D818  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8055D81C  4B DE 8C 95 */	bl PSMTXCopy
/* 8055D820  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8055D824  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8055D828  38 81 00 34 */	addi r4, r1, 0x34
/* 8055D82C  38 BE 05 38 */	addi r5, r30, 0x538
/* 8055D830  4B DE 95 3D */	bl PSMTXMultVec
...
/* 8055D8AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8055D8B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8055D8B4  A8 9E 0D 7A */	lha r4, 0xd7a(r30)
/* 8055D8B8  4B AA EB 25 */	bl mDoMtx_YrotS__FPA4_fs
/* 8055D8BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8055D8C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8055D8C4  38 81 00 34 */	addi r4, r1, 0x34
/* 8055D8C8  7C 85 23 78 */	mr r5, r4
/* 8055D8CC  4B DE 94 A1 */	bl PSMTXMultVec
/* 8055D8D0  38 61 00 10 */	addi r3, r1, 0x10
/* 8055D8D4  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 8055D8D8  38 A1 00 34 */	addi r5, r1, 0x34
/* 8055D8DC  4B D0 92 09 */	bl __pl__4cXyzCFRC3Vec
...
/* 8055D904  4B E0 49 1D */	bl _restgpr_27
