...
/* 8055F644  4B E0 2B 91 */	bl _savegpr_27
/* 8055F648  7C 7E 1B 78 */	mr r30, r3
/* 8055F64C  7C 9B 23 78 */	mr r27, r4
/* 8055F650  3B E0 00 00 */	li r31, 0
/* 8055F654  3B 80 FF FF */	li r28, -1
/* 8055F658  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055F65C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055F660  3B A3 4F F8 */	addi r29, r3, 0x4ff8
/* 8055F664  7F A3 EB 78 */	mr r3, r29
/* 8055F668  3C A0 80 56 */	lis r5, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055F66C  38 A5 4D 58 */	addi r5, r5, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055F670  38 A5 02 1B */	addi r5, r5, 0x21b
/* 8055F674  38 C0 00 03 */	li r6, 3
/* 8055F678  4B AE 8A 75 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8055F690  4B AE 86 BD */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8055F6B8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055F6BC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055F6C0  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8055F6C4  4B AB B0 4D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8055F708  4B BE 5F F5 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055F70C  38 00 00 00 */	li r0, 0
/* 8055F710  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 8055F714  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055F718  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055F758  4B BE BE F1 */	bl step__8daNpcT_cFsiiii
...
/* 8055F778  4B BE 61 21 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055F77C  93 BE 0B 5C */	stw r29, 0xb5c(r30)
/* 8055F780  38 00 00 09 */	li r0, 9
/* 8055F784  90 1E 0B 58 */	stw r0, 0xb58(r30)
/* 8055F788  3C 60 80 56 */	lis r3, lit_5128@ha /* 0x80564CCC@ha */
/* 8055F78C  C0 03 4C CC */	lfs f0, lit_5128@l(r3)  /* 0x80564CCC@l */
...
/* 8055F7A8  4B BE 60 F1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055F7AC  93 BE 0B 80 */	stw r29, 0xb80(r30)
/* 8055F7B0  38 00 00 00 */	li r0, 0
/* 8055F7B4  90 1E 0B 7C */	stw r0, 0xb7c(r30)
/* 8055F7B8  3C 60 80 56 */	lis r3, lit_5128@ha /* 0x80564CCC@ha */
/* 8055F7BC  C0 03 4C CC */	lfs f0, lit_5128@l(r3)  /* 0x80564CCC@l */
...
/* 8055F7E0  4B BE 5F 1D */	bl remove__18daNpcT_ActorMngr_cFv
/* 8055F7E4  38 00 00 00 */	li r0, 0
/* 8055F7E8  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 8055F7EC  3C 60 80 56 */	lis r3, lit_4318@ha /* 0x80564CA0@ha */
/* 8055F7F0  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)  /* 0x80564CA0@l */
...
/* 8055F818  4B E0 2A 09 */	bl _restgpr_27
