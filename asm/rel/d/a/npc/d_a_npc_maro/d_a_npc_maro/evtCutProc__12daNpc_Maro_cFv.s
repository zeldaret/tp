...
/* 8055D204  4B E0 4F D9 */	bl _savegpr_29
/* 8055D208  7C 7E 1B 78 */	mr r30, r3
/* 8055D20C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8055D210  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8055D214  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 8055D218  7F E3 FB 78 */	mr r3, r31
/* 8055D21C  3C 80 80 56 */	lis r4, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055D220  38 84 4D 58 */	addi r4, r4, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055D224  38 84 01 0A */	addi r4, r4, 0x10a
/* 8055D228  7F C5 F3 78 */	mr r5, r30
/* 8055D22C  38 C0 FF FF */	li r6, -1
/* 8055D230  4B AE A8 ED */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 8055D250  4B AE B1 99 */	bl getRunEventName__16dEvent_manager_cFv
/* 8055D254  3C 80 80 56 */	lis r4, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055D258  38 84 4D 58 */	addi r4, r4, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055D25C  38 84 00 99 */	addi r4, r4, 0x99
/* 8055D260  4B E0 B7 35 */	bl strcmp
/* 8055D264  2C 03 00 00 */	cmpwi r3, 0
/* 8055D268  41 82 00 64 */	beq lbl_8055D2CC
/* 8055D26C  7F E3 FB 78 */	mr r3, r31
/* 8055D270  4B AE B1 79 */	bl getRunEventName__16dEvent_manager_cFv
/* 8055D274  3C 80 80 56 */	lis r4, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055D278  38 84 4D 58 */	addi r4, r4, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055D27C  38 84 00 AD */	addi r4, r4, 0xad
/* 8055D280  4B E0 B7 15 */	bl strcmp
/* 8055D284  2C 03 00 00 */	cmpwi r3, 0
/* 8055D288  41 82 00 44 */	beq lbl_8055D2CC
/* 8055D28C  7F E3 FB 78 */	mr r3, r31
/* 8055D290  4B AE B1 59 */	bl getRunEventName__16dEvent_manager_cFv
/* 8055D294  3C 80 80 56 */	lis r4, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055D298  38 84 4D 58 */	addi r4, r4, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055D29C  38 84 00 C4 */	addi r4, r4, 0xc4
/* 8055D2A0  4B E0 B6 F5 */	bl strcmp
/* 8055D2A4  2C 03 00 00 */	cmpwi r3, 0
/* 8055D2A8  41 82 00 24 */	beq lbl_8055D2CC
/* 8055D2AC  7F E3 FB 78 */	mr r3, r31
/* 8055D2B0  4B AE B1 39 */	bl getRunEventName__16dEvent_manager_cFv
/* 8055D2B4  3C 80 80 56 */	lis r4, d_a_npc_maro__stringBase0@ha /* 0x80564D58@ha */
/* 8055D2B8  38 84 4D 58 */	addi r4, r4, d_a_npc_maro__stringBase0@l /* 0x80564D58@l */
/* 8055D2BC  38 84 00 D6 */	addi r4, r4, 0xd6
/* 8055D2C0  4B E0 B6 D5 */	bl strcmp
...
/* 8055D2E0  3C A0 80 56 */	lis r5, mCutNameList__12daNpc_Maro_c@ha /* 0x80565424@ha */
/* 8055D2E4  38 A5 54 24 */	addi r5, r5, mCutNameList__12daNpc_Maro_c@l /* 0x80565424@l */
/* 8055D2E8  38 C0 00 11 */	li r6, 0x11
/* 8055D2EC  38 E0 00 00 */	li r7, 0
/* 8055D2F0  39 00 00 00 */	li r8, 0
/* 8055D2F4  4B AE AB 1D */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 8055D308  3C A0 80 56 */	lis r5, mCutList__12daNpc_Maro_c@ha /* 0x80565528@ha */
/* 8055D30C  38 05 55 28 */	addi r0, r5, mCutList__12daNpc_Maro_c@l /* 0x80565528@l */
/* 8055D310  7D 80 32 14 */	add r12, r0, r6
/* 8055D314  4B E0 4D 71 */	bl __ptmf_scall
...
/* 8055D32C  4B AE AE 51 */	bl cutEnd__16dEvent_manager_cFi
lbl_8055D330:
...
/* 8055D348  4B C3 8F C5 */	bl Save__16ShopCam_action_cFv
lbl_8055D34C:
/* 8055D34C  38 60 00 00 */	li r3, 0
lbl_8055D350:
/* 8055D350  39 61 00 20 */	addi r11, r1, 0x20
/* 8055D354  4B E0 4E D5 */	bl _restgpr_29
