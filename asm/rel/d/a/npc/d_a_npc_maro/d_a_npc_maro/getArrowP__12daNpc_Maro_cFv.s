...
/* 8055C0D4  4B E0 60 FC */	b _savegpr_26
/* 8055C0D8  7C 7E 1B 78 */	mr r30, r3
/* 8055C0DC  3B E0 00 00 */	li r31, 0
/* 8055C0E0  3C 60 80 56 */	lis r3, lit_4808@ha
/* 8055C0E4  C3 C3 4C B8 */	lfs f30, lit_4808@l(r3)
/* 8055C0E8  38 00 00 00 */	li r0, 0
/* 8055C0EC  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha
/* 8055C0F0  90 03 0F DC */	stw r0, mFindCount__8daNpcT_c@l(r3)
/* 8055C0F4  3C 60 80 56 */	lis r3, srchArrow__12daNpc_Maro_cFPvPv@ha
/* 8055C0F8  38 63 C0 18 */	addi r3, r3, srchArrow__12daNpc_Maro_cFPvPv@l
/* 8055C0FC  7F C4 F3 78 */	mr r4, r30
/* 8055C100  4B AB D6 F8 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 8055C104  3B 40 00 00 */	li r26, 0
/* 8055C108  3B A0 00 00 */	li r29, 0
/* 8055C10C  3C 60 80 42 */	lis r3, mFindActorPtrs__8daNpcT_c@ha
/* 8055C110  3B 63 57 08 */	addi r27, r3, mFindActorPtrs__8daNpcT_c@l
/* 8055C114  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 8055C118  C3 E3 11 80 */	lfs f31, G_CM3D_F_ABS_MIN@l(r3)
/* 8055C11C  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha
/* 8055C120  3B 83 0F DC */	addi r28, r3, mFindCount__8daNpcT_c@l
...
/* 8055C14C  4B AB E6 94 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8055C160  4B AB E6 80 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8055C198  4B E0 60 84 */	b _restgpr_26
