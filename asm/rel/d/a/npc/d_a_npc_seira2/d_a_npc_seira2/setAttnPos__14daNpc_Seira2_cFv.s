...
/* 80AD20B8  4B 89 01 1D */	bl _savegpr_27
/* 80AD20BC  7C 7E 1B 78 */	mr r30, r3
/* 80AD20C0  3C 60 80 AD */	lis r3, m__20daNpc_Seira2_Param_c@ha /* 0x80AD4A60@ha */
/* 80AD20C4  3B E3 4A 60 */	addi r31, r3, m__20daNpc_Seira2_Param_c@l /* 0x80AD4A60@l */
...
/* 80AD20E8  4B 67 5D 55 */	bl calc__19daNpcT_DmgStagger_cFi
...
/* 80AD218C  4B 67 4B 4D */	bl setParam__15daNpcT_JntAnm_cFP10fopAc_ac_cP8J3DModelP4cXyziiiffffffffffP4cXyz
...
/* 80AD21D0  4B 67 5A 69 */	bl calcJntRad__15daNpcT_JntAnm_cFfff
/* 80AD21D4  7F C3 F3 78 */	mr r3, r30
/* 80AD21D8  4B 67 6F B9 */	bl setMtx__8daNpcT_cFv
...
/* 80AD21FC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD2200  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD2204  4B 87 42 AD */	bl PSMTXCopy
/* 80AD2208  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD220C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD2210  38 81 00 34 */	addi r4, r1, 0x34
/* 80AD2214  4B 87 42 9D */	bl PSMTXCopy
...
/* 80AD2228  4B 87 42 89 */	bl PSMTXCopy
/* 80AD222C  80 7E 0F 7C */	lwz r3, 0xf7c(r30)
/* 80AD2230  38 80 00 00 */	li r4, 0
/* 80AD2234  38 A0 00 00 */	li r5, 0
/* 80AD2238  4B 53 EE 79 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 80AD223C  80 7E 0F 7C */	lwz r3, 0xf7c(r30)
/* 80AD2240  4B 53 EF AD */	bl modelCalc__16mDoExt_McaMorfSOFv
lbl_80AD2244:
...
/* 80AD2270  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD2274  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD2278  4B 87 42 39 */	bl PSMTXCopy
/* 80AD227C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD2280  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD2284  38 81 00 28 */	addi r4, r1, 0x28
/* 80AD2288  38 BE 05 38 */	addi r5, r30, 0x538
/* 80AD228C  4B 87 4A E1 */	bl PSMTXMultVec
...
/* 80AD2344  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD2348  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD234C  4B 87 41 65 */	bl PSMTXCopy
/* 80AD2350  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD2354  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD2358  38 81 00 28 */	addi r4, r1, 0x28
/* 80AD235C  38 BE 05 50 */	addi r5, r30, 0x550
/* 80AD2360  4B 87 4A 0D */	bl PSMTXMultVec
...
/* 80AD2394  4B 88 FE 8D */	bl _restgpr_27
