...
/* 80AD43F4  4B 88 DD E9 */	bl _savegpr_29
/* 80AD43F8  7C 7F 1B 78 */	mr r31, r3
/* 80AD43FC  7C 80 23 78 */	mr r0, r4
/* 80AD4400  FF E0 08 90 */	fmr f31, f1
/* 80AD4404  7C BD 2B 78 */	mr r29, r5
/* 80AD4408  3C 60 80 AD */	lis r3, m__20daNpc_Seira2_Param_c@ha /* 0x80AD4A60@ha */
/* 80AD440C  3B C3 4A 60 */	addi r30, r3, m__20daNpc_Seira2_Param_c@l /* 0x80AD4A60@l */
...
/* 80AD4428  4B 79 27 0D */	bl __mi__4cXyzCFRC3Vec
...
/* 80AD4458  4B 87 2C E1 */	bl PSVECSquareMag
...
/* 80AD44C8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80AD44CC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80AD4538  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80AD453C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80AD4540  48 00 00 08 */	b lbl_80AD4548
lbl_80AD4544:
/* 80AD4544  FC 40 08 90 */	fmr f2, f1
lbl_80AD4548:
/* 80AD4548  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80AD454C  4B 79 31 29 */	bl cM_atan2s__Fff
...
/* 80AD45D0  4B 88 DC 59 */	bl _restgpr_29
