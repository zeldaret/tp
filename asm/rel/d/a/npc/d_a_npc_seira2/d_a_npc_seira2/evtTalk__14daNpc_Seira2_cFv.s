...
/* 80AD1C78  3C 80 80 AD */	lis r4, cNullVec__6Z2Calc@ha /* 0x80AD4B90@ha */
/* 80AD1C7C  3B E4 4B 90 */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x80AD4B90@l */
...
/* 80AD1CC0  4B 89 03 C5 */	bl __ptmf_scall
/* 80AD1CC4  60 00 00 00 */	nop 
/* 80AD1CC8  48 00 01 20 */	b lbl_80AD1DE8
lbl_80AD1CCC:
/* 80AD1CCC  38 00 00 00 */	li r0, 0
/* 80AD1CD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AD1CD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AD1CF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AD1CFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AD1D00  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80AD1D04  4B 57 6A ED */	bl ChkPresentEnd__16dEvent_manager_cFv
/* 80AD1D08  2C 03 00 00 */	cmpwi r3, 0
/* 80AD1D0C  41 82 00 DC */	beq lbl_80AD1DE8
lbl_80AD1D10:
/* 80AD1D10  38 7E 0E 78 */	addi r3, r30, 0xe78
/* 80AD1D14  4B 6C 3F 89 */	bl shop_cam_action_init__16ShopCam_action_cFv
...
/* 80AD1D74  4B 89 03 11 */	bl __ptmf_scall
/* 80AD1D78  60 00 00 00 */	nop 
/* 80AD1D7C  48 00 00 6C */	b lbl_80AD1DE8
lbl_80AD1D80:
/* 80AD1D80  38 00 00 00 */	li r0, 0
/* 80AD1D84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AD1D88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AD1DAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AD1DB0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AD1DB4  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80AD1DB8  4B 57 6A 39 */	bl ChkPresentEnd__16dEvent_manager_cFv
