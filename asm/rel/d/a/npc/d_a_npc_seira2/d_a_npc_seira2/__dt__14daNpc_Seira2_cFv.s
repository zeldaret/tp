...
/* 80AD0C2C  3C 80 80 AD */	lis r4, __vt__14daNpc_Seira2_c@ha
/* 80AD0C30  38 04 55 30 */	addi r0, r4, __vt__14daNpc_Seira2_c@l
/* 80AD0C34  90 1E 0E 3C */	stw r0, 0xe3c(r30)
/* 80AD0C38  4B 6C 99 2C */	b deleteObject__13dShopSystem_cFv
/* 80AD0C3C  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80AD0C40  28 03 00 00 */	cmplwi r3, 0
/* 80AD0C44  41 82 00 08 */	beq lbl_80AD0C4C
/* 80AD0C48  4B 54 06 C8 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AD0C4C:
/* 80AD0C4C  80 7E 0F 7C */	lwz r3, 0xf7c(r30)
/* 80AD0C50  28 03 00 00 */	cmplwi r3, 0
/* 80AD0C54  41 82 00 08 */	beq lbl_80AD0C5C
/* 80AD0C58  4B 54 06 B8 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AD0C5C:
/* 80AD0C5C  7F C3 F3 78 */	mr r3, r30
/* 80AD0C60  88 1E 10 C1 */	lbz r0, 0x10c1(r30)
/* 80AD0C64  54 00 10 3A */	slwi r0, r0, 2
/* 80AD0C68  3C 80 80 AD */	lis r4, l_loadResPtrnList@ha
/* 80AD0C6C  38 84 4B E4 */	addi r4, r4, l_loadResPtrnList@l
/* 80AD0C70  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AD0C74  3C A0 80 AD */	lis r5, l_resNameList@ha
/* 80AD0C78  38 A5 4B D0 */	addi r5, r5, l_resNameList@l
/* 80AD0C7C  4B 67 78 30 */	b deleteRes__8daNpcT_cFPCScPPCc
/* 80AD0C80  38 7E 10 C4 */	addi r3, r30, 0x10c4
/* 80AD0C84  3C 80 80 AD */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha
/* 80AD0C88  38 84 3A 60 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l
/* 80AD0C8C  38 A0 00 08 */	li r5, 8
/* 80AD0C90  38 C0 00 01 */	li r6, 1
/* 80AD0C94  4B 89 10 54 */	b __destroy_arr
/* 80AD0C98  34 1E 0F 84 */	addic. r0, r30, 0xf84
/* 80AD0C9C  41 82 00 84 */	beq lbl_80AD0D20
/* 80AD0CA0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80AD0CA4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80AD0CC4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80AD0CC8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
