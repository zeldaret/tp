...
/* 80A4E810  4B 91 39 C9 */	bl _savegpr_28
/* 80A4E814  7C 7C 1B 78 */	mr r28, r3
/* 80A4E818  3C 60 80 A6 */	lis r3, lit_4030@ha /* 0x80A5DEFC@ha */
/* 80A4E81C  3B E3 DE FC */	addi r31, r3, lit_4030@l /* 0x80A5DEFC@l */
/* 80A4E820  80 1C 04 A4 */	lwz r0, 0x4a4(r28)
/* 80A4E824  90 01 00 08 */	stw r0, 8(r1)
/* 80A4E828  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80A4E82C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80A4E830  38 81 00 08 */	addi r4, r1, 8
/* 80A4E834  4B 5C AF C5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80A4E838  7C 7E 1B 79 */	or. r30, r3, r3
/* 80A4E83C  40 82 00 3C */	bne lbl_80A4E878
/* 80A4E840  3C 60 80 A5 */	lis r3, s_sw_sub__FPvPv@ha /* 0x80A4BA14@ha */
/* 80A4E844  38 63 BA 14 */	addi r3, r3, s_sw_sub__FPvPv@l /* 0x80A4BA14@l */
/* 80A4E848  7F 84 E3 78 */	mr r4, r28
/* 80A4E84C  4B 5D 2A ED */	bl fpcEx_Search__FPFPvPv_PvPv
...
lbl_80A4E878:
/* 80A4E878  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A4E87C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A4E8AC  4B 82 1D 5D */	bl cLib_addCalcAngleS2__FPssss
...
/* 80A4E96C  4B 81 8F E9 */	bl cM_rndF__Ff
...
/* 80A4E998  4B 81 8F BD */	bl cM_rndF__Ff
...
/* 80A4E9B8  4B 81 8F 9D */	bl cM_rndF__Ff
...
/* 80A4E9E8  4B 81 8F 6D */	bl cM_rndF__Ff
...
/* 80A4EA38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A4EA3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A4EA60  3C 60 80 A6 */	lis r3, leader@ha /* 0x80A5FEA0@ha */
/* 80A4EA64  38 63 FE A0 */	addi r3, r3, leader@l /* 0x80A5FEA0@l */
...
/* 80A4EA7C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80A4EA80  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80A4EA84  80 63 00 00 */	lwz r3, 0(r3)
/* 80A4EA88  A8 9C 04 B6 */	lha r4, 0x4b6(r28)
/* 80A4EA8C  4B 5B D9 51 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80A4EAAC  3C 80 80 A6 */	lis r4, obj_pos@ha /* 0x80A5FE94@ha */
/* 80A4EAB0  38 84 FE 94 */	addi r4, r4, obj_pos@l /* 0x80A5FE94@l */
/* 80A4EAB4  4B 82 24 39 */	bl MtxPosition__FP4cXyzP4cXyz
/* 80A4EAB8  3C 60 80 A6 */	lis r3, obj_pos@ha /* 0x80A5FE94@ha */
/* 80A4EABC  38 63 FE 94 */	addi r3, r3, obj_pos@l /* 0x80A5FE94@l */
/* 80A4EAC0  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 80A4EAC4  7C 65 1B 78 */	mr r5, r3
/* 80A4EAC8  4B 8F 85 C9 */	bl PSVECAdd
/* 80A4EACC  38 61 00 1C */	addi r3, r1, 0x1c
/* 80A4EAD0  3C 80 80 A6 */	lis r4, obj_pos@ha /* 0x80A5FE94@ha */
/* 80A4EAD4  38 84 FE 94 */	addi r4, r4, obj_pos@l /* 0x80A5FE94@l */
/* 80A4EAD8  38 BC 06 14 */	addi r5, r28, 0x614
/* 80A4EADC  4B 81 80 59 */	bl __mi__4cXyzCFRC3Vec
...
/* 80A4EB04  4B 8F 85 D5 */	bl PSVECScale
...
lbl_80A4EC2C:
/* 80A4EC2C  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 80A4EC30  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
...
/* 80A4ECD4  3C 60 80 A6 */	lis r3, leader@ha /* 0x80A5FEA0@ha */
/* 80A4ECD8  38 63 FE A0 */	addi r3, r3, leader@l /* 0x80A5FEA0@l */
...
/* 80A4ECEC  3C 60 80 A6 */	lis r3, leader@ha /* 0x80A5FEA0@ha */
/* 80A4ECF0  38 63 FE A0 */	addi r3, r3, leader@l /* 0x80A5FEA0@l */
...
/* 80A4ED30  3C 60 80 A6 */	lis r3, leader@ha /* 0x80A5FEA0@ha */
/* 80A4ED34  38 63 FE A0 */	addi r3, r3, leader@l /* 0x80A5FEA0@l */
...
/* 80A4ED80  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80A4ED84  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80A4EDAC  4B 82 18 5D */	bl cLib_addCalcAngleS2__FPssss
...
/* 80A4EDF4  4B 82 0C 8D */	bl cLib_addCalc0__FPfff
lbl_80A4EDF8:
...
/* 80A4EE04  4B 91 34 21 */	bl _restgpr_28
