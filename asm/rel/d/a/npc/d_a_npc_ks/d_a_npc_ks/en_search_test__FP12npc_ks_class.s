...
/* 80A49F50  4B 91 82 81 */	bl _savegpr_26
/* 80A49F54  7C 7C 1B 78 */	mr r28, r3
/* 80A49F58  3C 60 80 A6 */	lis r3, lit_4030@ha /* 0x80A5DEFC@ha */
/* 80A49F5C  3B C3 DE FC */	addi r30, r3, lit_4030@l /* 0x80A5DEFC@l */
/* 80A49F60  38 A0 00 00 */	li r5, 0
/* 80A49F64  3C 60 80 A6 */	lis r3, target_info_count@ha /* 0x80A5FF18@ha */
/* 80A49F68  90 A3 FF 18 */	stw r5, target_info_count@l(r3)  /* 0x80A5FF18@l */
/* 80A49F6C  7C A3 2B 78 */	mr r3, r5
/* 80A49F70  3C 80 80 A6 */	lis r4, target_info@ha /* 0x80A5FEF0@ha */
/* 80A49F74  38 84 FE F0 */	addi r4, r4, target_info@l /* 0x80A5FEF0@l */
...
/* 80A49F8C  3C 60 80 A5 */	lis r3, s_en_sub__FPvPv@ha /* 0x80A49EC0@ha */
/* 80A49F90  38 63 9E C0 */	addi r3, r3, s_en_sub__FPvPv@l /* 0x80A49EC0@l */
/* 80A49F94  7F 84 E3 78 */	mr r4, r28
/* 80A49F98  4B 5D 73 A1 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 80A49F9C  C3 DE 00 40 */	lfs f30, 0x40(r30)
/* 80A49FA0  3C 60 80 A6 */	lis r3, target_info_count@ha /* 0x80A5FF18@ha */
/* 80A49FA4  3B E3 FF 18 */	addi r31, r3, target_info_count@l /* 0x80A5FF18@l */
...
/* 80A49FD0  4B 81 CB 65 */	bl __mi__4cXyzCFRC3Vec
...
/* 80A49FF0  4B 8F D1 49 */	bl PSVECSquareMag
...
/* 80A4A05C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A4A060  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80A4A0CC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A4A0D0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80A4A0D4:
...
lbl_80A4A114:
/* 80A4A114  3C 60 80 A6 */	lis r3, target_info@ha /* 0x80A5FEF0@ha */
/* 80A4A118  3B 63 FE F0 */	addi r27, r3, target_info@l /* 0x80A5FEF0@l */
...
/* 80A4A150  4B 91 80 CD */	bl _restgpr_26
