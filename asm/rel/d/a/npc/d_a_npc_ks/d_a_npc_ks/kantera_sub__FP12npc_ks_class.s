...
/* 80A5B624  4B 90 6B B9 */	bl _savegpr_29
/* 80A5B628  7C 7D 1B 78 */	mr r29, r3
/* 80A5B62C  3C 60 80 A6 */	lis r3, lit_4030@ha /* 0x80A5DEFC@ha */
/* 80A5B630  3B C3 DE FC */	addi r30, r3, lit_4030@l /* 0x80A5DEFC@l */
...
/* 80A5B648  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A5B64C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A5B650  4B 8E AE 61 */	bl PSMTXCopy
/* 80A5B654  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A5B658  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A5B65C  80 9D 0C 00 */	lwz r4, 0xc00(r29)
/* 80A5B660  38 84 00 24 */	addi r4, r4, 0x24
/* 80A5B664  4B 8E AE 4D */	bl PSMTXCopy
...
/* 80A5B684  4B 5B 17 19 */	bl transM__14mDoMtx_stack_cFfff
/* 80A5B688  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A5B68C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A5B6A8  3C 60 80 A6 */	lis r3, l_HIO@ha /* 0x80A5FEB8@ha */
/* 80A5B6AC  38 63 FE B8 */	addi r3, r3, l_HIO@l /* 0x80A5FEB8@l */
/* 80A5B6B0  C0 23 00 34 */	lfs f1, 0x34(r3)
/* 80A5B6B4  FC 40 08 90 */	fmr f2, f1
/* 80A5B6B8  FC 60 08 90 */	fmr f3, f1
/* 80A5B6BC  4B 5B 17 7D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80A5B6C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A5B6C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A5B6C8  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80A5B6CC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A5B6D0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A5B6F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A5B6FC  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A5B720  4B 5C 14 81 */	bl fopAcM_cancelCarryNow__FP10fopAc_ac_c
...
/* 80A5B738  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A5B73C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A5B740  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80A5B744  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80A5B748  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80A5B74C  A0 84 01 C4 */	lhz r4, 0x1c4(r4)
/* 80A5B750  4B 5D 92 3D */	bl onEventBit__11dSv_event_cFUs
...
lbl_80A5B7D0:
/* 80A5B7D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A5B7D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A5B7D8  C0 3D 0C 04 */	lfs f1, 0xc04(r29)
/* 80A5B7DC  C0 5D 0C 08 */	lfs f2, 0xc08(r29)
/* 80A5B7E0  C0 7D 0C 0C */	lfs f3, 0xc0c(r29)
/* 80A5B7E4  4B 8E B1 05 */	bl PSMTXTrans
...
/* 80A5B7F4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80A5B7F8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
lbl_80A5B84C:
/* 80A5B84C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A5B850  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A5B854  4B 5B 0C 79 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80A5B858  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A5B85C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A5B860  38 80 13 88 */	li r4, 0x1388
/* 80A5B864  4B 5B 0B D1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80A5B868  80 7F 5D AC */	lwz r3, 0x5dac(r31)
/* 80A5B86C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A5B870  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A5B8E8  4B 90 69 41 */	bl _restgpr_29
