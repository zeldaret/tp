...
/* 80A4A1C0  4B 91 80 1D */	bl _savegpr_29
/* 80A4A1C4  7C 7D 1B 78 */	mr r29, r3
/* 80A4A1C8  3C 60 80 A6 */	lis r3, lit_4030@ha /* 0x80A5DEFC@ha */
/* 80A4A1CC  3B C3 DE FC */	addi r30, r3, lit_4030@l /* 0x80A5DEFC@l */
/* 80A4A1D0  3C 60 80 A6 */	lis r3, leader@ha /* 0x80A5FEA0@ha */
/* 80A4A1D4  80 03 FE A0 */	lwz r0, leader@l(r3)  /* 0x80A5FEA0@l */
...
/* 80A4A1EC  3C 60 80 A5 */	lis r3, s_ori_sub__FPvPv@ha /* 0x80A4A164@ha */
/* 80A4A1F0  38 63 A1 64 */	addi r3, r3, s_ori_sub__FPvPv@l /* 0x80A4A164@l */
/* 80A4A1F4  7F A4 EB 78 */	mr r4, r29
/* 80A4A1F8  4B 5D 71 41 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80A4A254  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80A4A258  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80A4A25C  38 81 00 0C */	addi r4, r1, 0xc
/* 80A4A260  4B 5C F5 99 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80A4A288  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A4A28C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A4A290  38 63 09 58 */	addi r3, r3, 0x958
/* 80A4A294  80 9D 05 BC */	lwz r4, 0x5bc(r29)
/* 80A4A298  4B 5E A5 09 */	bl onTbox__12dSv_memBit_cFi
...
/* 80A4A2F4  4B 8D E1 39 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80A4A30C  4B 8D E1 21 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80A4A3AC  3C 60 80 A6 */	lis r3, leader@ha /* 0x80A5FEA0@ha */
/* 80A4A3B0  38 63 FE A0 */	addi r3, r3, leader@l /* 0x80A5FEA0@l */
...
/* 80A4A3C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A4A3C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A4A3CC  38 80 00 14 */	li r4, 0x14
/* 80A4A3D0  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80A4A3D4  7C 05 07 74 */	extsb r5, r0
/* 80A4A3D8  4B 5E AF 89 */	bl isSwitch__10dSv_info_cCFii
...
/* 80A4A494  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A4A498  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80A4A504  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A4A508  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80A4A50C:
...
/* 80A4A51C  3C 60 80 A6 */	lis r3, leader@ha /* 0x80A5FEA0@ha */
/* 80A4A520  38 63 FE A0 */	addi r3, r3, leader@l /* 0x80A5FEA0@l */
/* 80A4A524  80 63 00 00 */	lwz r3, 0(r3)
/* 80A4A528  B0 03 0B 42 */	sth r0, 0xb42(r3)
lbl_80A4A52C:
/* 80A4A52C  39 61 00 40 */	addi r11, r1, 0x40
/* 80A4A530  4B 91 7C F9 */	bl _restgpr_29
