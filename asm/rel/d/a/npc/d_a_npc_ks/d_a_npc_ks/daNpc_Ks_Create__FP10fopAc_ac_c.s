...
/* 80A5D364  4B 90 4E 69 */	bl _savegpr_25
/* 80A5D368  7C 7C 1B 78 */	mr r28, r3
/* 80A5D36C  3C 80 80 A6 */	lis r4, lit_1109@ha /* 0x80A5FE48@ha */
/* 80A5D370  3B A4 FE 48 */	addi r29, r4, lit_1109@l /* 0x80A5FE48@l */
/* 80A5D374  3C 80 80 A6 */	lis r4, lit_4030@ha /* 0x80A5DEFC@ha */
/* 80A5D378  3B C4 DE FC */	addi r30, r4, lit_4030@l /* 0x80A5DEFC@l */
...
/* 80A5D394  4B 5B B7 D1 */	bl __ct__10fopAc_ac_cFv
/* 80A5D398  38 7A 06 40 */	addi r3, r26, 0x640
/* 80A5D39C  4B 61 8B 11 */	bl __ct__12dBgS_AcchCirFv
/* 80A5D3A0  3B 3A 06 80 */	addi r25, r26, 0x680
/* 80A5D3A4  7F 23 CB 78 */	mr r3, r25
/* 80A5D3A8  4B 61 8C F9 */	bl __ct__9dBgS_AcchFv
/* 80A5D3AC  3C 60 80 A6 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80A5FE00@ha */
/* 80A5D3B0  38 63 FE 00 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80A5FE00@l */
...
/* 80A5D3CC  4B 61 BA 9D */	bl SetObj__16dBgS_PolyPassChkFv
/* 80A5D3D0  38 7A 08 60 */	addi r3, r26, 0x860
/* 80A5D3D4  4B 86 2F F5 */	bl __ct__10Z2CreatureFv
/* 80A5D3D8  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80A5D3DC  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80A5D3E0  90 1A 09 68 */	stw r0, 0x968(r26)
/* 80A5D3E4  38 7A 09 6C */	addi r3, r26, 0x96c
/* 80A5D3E8  4B 62 63 79 */	bl __ct__10dCcD_GSttsFv
/* 80A5D3EC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80A5D3F0  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80A5D408  4B 62 66 21 */	bl __ct__12dCcD_GObjInfFv
/* 80A5D40C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80A5D410  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80A5D414  90 1B 01 20 */	stw r0, 0x120(r27)
/* 80A5D418  3C 60 80 A6 */	lis r3, __vt__8cM3dGAab@ha /* 0x80A5FDF4@ha */
/* 80A5D41C  38 03 FD F4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80A5FDF4@l */
/* 80A5D420  90 1B 01 1C */	stw r0, 0x11c(r27)
/* 80A5D424  3C 60 80 A6 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80A5FDE8@ha */
/* 80A5D428  38 03 FD E8 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80A5FDE8@l */
/* 80A5D42C  90 1B 01 38 */	stw r0, 0x138(r27)
/* 80A5D430  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80A5D434  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80A5D438  90 7B 01 20 */	stw r3, 0x120(r27)
/* 80A5D43C  38 03 00 58 */	addi r0, r3, 0x58
/* 80A5D440  90 1B 01 38 */	stw r0, 0x138(r27)
/* 80A5D444  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80A5D448  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80A5D464  4B 7E CA 9D */	bl __ct__10dMsgFlow_cFv
lbl_80A5D468:
/* 80A5D468  80 1C 04 A0 */	lwz r0, 0x4a0(r28)
/* 80A5D46C  60 00 00 08 */	ori r0, r0, 8
/* 80A5D470  90 1C 04 A0 */	stw r0, 0x4a0(r28)
lbl_80A5D474:
/* 80A5D474  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A5D478  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A5D490  4B 74 F0 ED */	bl dKy_darkworld_check__Fv
/* 80A5D494  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80A5D498  41 82 00 14 */	beq lbl_80A5D4AC
/* 80A5D49C  3C 60 80 A6 */	lis r3, d_a_npc_ks__stringBase0@ha /* 0x80A5E438@ha */
/* 80A5D4A0  38 03 E4 38 */	addi r0, r3, d_a_npc_ks__stringBase0@l /* 0x80A5E438@l */
/* 80A5D4A4  90 1C 05 C0 */	stw r0, 0x5c0(r28)
/* 80A5D4A8  48 00 00 14 */	b lbl_80A5D4BC
lbl_80A5D4AC:
/* 80A5D4AC  3C 60 80 A6 */	lis r3, d_a_npc_ks__stringBase0@ha /* 0x80A5E438@ha */
/* 80A5D4B0  38 63 E4 38 */	addi r3, r3, d_a_npc_ks__stringBase0@l /* 0x80A5E438@l */
...
/* 80A5D4C4  4B 5C F9 F9 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80A5D508  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A5D50C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A5D510  3B 23 07 F0 */	addi r25, r3, 0x7f0
/* 80A5D514  7F 23 CB 78 */	mr r3, r25
/* 80A5D518  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80A5D51C  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80A5D520  A0 84 01 C2 */	lhz r4, 0x1c2(r4)
/* 80A5D524  4B 5D 74 99 */	bl isEventBit__11dSv_event_cCFUs
/* 80A5D528  2C 03 00 00 */	cmpwi r3, 0
/* 80A5D52C  41 82 00 28 */	beq lbl_80A5D554
/* 80A5D530  7F 23 CB 78 */	mr r3, r25
/* 80A5D534  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80A5D538  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80A5D53C  A0 84 01 C4 */	lhz r4, 0x1c4(r4)
/* 80A5D540  4B 5D 74 7D */	bl isEventBit__11dSv_event_cCFUs
...
/* 80A5D598  3C 80 80 A6 */	lis r4, d_a_npc_ks__stringBase0@ha /* 0x80A5E438@ha */
/* 80A5D59C  38 84 E4 38 */	addi r4, r4, d_a_npc_ks__stringBase0@l /* 0x80A5E438@l */
/* 80A5D5A0  38 84 00 19 */	addi r4, r4, 0x19
/* 80A5D5A4  4B 90 B3 F1 */	bl strcmp
/* 80A5D5A8  2C 03 00 00 */	cmpwi r3, 0
/* 80A5D5AC  40 82 00 28 */	bne lbl_80A5D5D4
/* 80A5D5B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A5D5B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A5D5B8  38 63 09 58 */	addi r3, r3, 0x958
/* 80A5D5BC  38 80 00 03 */	li r4, 3
/* 80A5D5C0  4B 5D 73 75 */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 80A5D5E0  3C 60 80 A6 */	lis r3, s_check_sub__FPvPv@ha /* 0x80A5D2BC@ha */
/* 80A5D5E4  38 63 D2 BC */	addi r3, r3, s_check_sub__FPvPv@l /* 0x80A5D2BC@l */
/* 80A5D5E8  7F 84 E3 78 */	mr r4, r28
/* 80A5D5EC  4B 5C 3D 4D */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80A5D650  3C 80 80 A6 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80A5C450@ha */
/* 80A5D654  38 84 C4 50 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80A5C450@l */
/* 80A5D658  38 A0 38 A0 */	li r5, 0x38a0
/* 80A5D65C  4B 5B CE 55 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80A5D6B4  4B 5B CE 75 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80A5D6C8  4B 5B CE 71 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80A5D6F4  4B 61 8B 55 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80A5D6F8  38 7C 06 40 */	addi r3, r28, 0x640
/* 80A5D6FC  C0 3E 00 40 */	lfs f1, 0x40(r30)
/* 80A5D700  FC 40 08 90 */	fmr f2, f1
/* 80A5D704  4B 61 88 55 */	bl SetWall__12dBgS_AcchCirFff
/* 80A5D708  C0 3E 05 38 */	lfs f1, 0x538(r30)
/* 80A5D70C  4B 80 A2 49 */	bl cM_rndF__Ff
...
/* 80A5D728  3C 60 80 A6 */	lis r3, saru_p@ha /* 0x80A5E478@ha */
/* 80A5D72C  38 63 E4 78 */	addi r3, r3, saru_p@l /* 0x80A5E478@l */
...
/* 80A5D77C  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80A5D780  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80A5D784  38 81 00 10 */	addi r4, r1, 0x10
/* 80A5D788  4B 5B C0 71 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80A5D7E4  3C 60 80 A6 */	lis r3, saru_p@ha /* 0x80A5E478@ha */
/* 80A5D7E8  38 63 E4 78 */	addi r3, r3, saru_p@l /* 0x80A5E478@l */
...
/* 80A5D80C  4B 86 2D 25 */	bl init__10Z2CreatureFP3VecP3VecUcUc
...
/* 80A5D820  4B 62 60 41 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80A5D824  38 7C 09 8C */	addi r3, r28, 0x98c
/* 80A5D828  3C 80 80 A6 */	lis r4, cc_cyl_src@ha /* 0x80A5FD30@ha */
/* 80A5D82C  38 84 FD 30 */	addi r4, r4, cc_cyl_src@l /* 0x80A5FD30@l */
/* 80A5D830  4B 62 70 85 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80A5D868  4B 90 49 B1 */	bl _restgpr_25
