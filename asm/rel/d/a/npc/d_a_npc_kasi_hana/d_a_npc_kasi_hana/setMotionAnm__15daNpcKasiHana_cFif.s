...
/* 80A1CEF8  3C 80 80 A2 */	lis r4, l_bckGetParamList@ha
/* 80A1CEFC  38 A4 13 F4 */	addi r5, r4, l_bckGetParamList@l
/* 80A1CF00  7C 85 F2 14 */	add r4, r5, r30
/* 80A1CF04  80 04 00 08 */	lwz r0, 8(r4)
/* 80A1CF08  54 00 10 3A */	slwi r0, r0, 2
/* 80A1CF0C  3C 80 80 A2 */	lis r4, l_arcNames@ha
/* 80A1CF10  38 84 14 B4 */	addi r4, r4, l_arcNames@l
/* 80A1CF14  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A1CF18  7C A5 F0 2E */	lwzx r5, r5, r30
/* 80A1CF1C  4B 73 5C 10 */	b getTrnsfrmKeyAnmP__8daNpcF_cFPci
/* 80A1CF20  7C 64 1B 79 */	or. r4, r3, r3
/* 80A1CF24  3C 60 80 A2 */	lis r3, l_bckGetParamList@ha
/* 80A1CF28  38 03 13 F4 */	addi r0, r3, l_bckGetParamList@l
...
/* 80A1CF4C  3C C0 80 A2 */	lis r6, lit_4211@ha
/* 80A1CF50  C0 26 10 C0 */	lfs f1, lit_4211@l(r6)
/* 80A1CF54  FC 40 F8 90 */	fmr f2, f31
/* 80A1CF58  38 C0 00 00 */	li r6, 0
/* 80A1CF5C  38 E0 FF FF */	li r7, -1
/* 80A1CF60  4B 73 5C BC */	b setMcaMorfAnm__8daNpcF_cFP18J3DAnmTransformKeyffiii
