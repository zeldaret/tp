...
/* 80A1CD38  4B 94 54 A5 */	bl _savegpr_29
/* 80A1CD3C  7C 7E 1B 78 */	mr r30, r3
/* 80A1CD40  3C 60 80 A2 */	lis r3, lit_3908@ha /* 0x80A21080@ha */
/* 80A1CD44  3B E3 10 80 */	addi r31, r3, lit_3908@l /* 0x80A21080@l */
...
/* 80A1CD88  4B 73 59 E5 */	bl setMtx__8daNpcF_cFv
...
/* 80A1CDC0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A1CDC4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A1CDC8  4B 92 96 E9 */	bl PSMTXCopy
/* 80A1CDCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A1CDD0  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A1CDF8  4B 92 9F 75 */	bl PSMTXMultVec
/* 80A1CDFC  C0 1F 00 00 */	lfs f0, 0(r31)
/* 80A1CE00  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80A1CE04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A1CE08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A1CE0C  38 81 00 14 */	addi r4, r1, 0x14
/* 80A1CE10  7C 85 23 78 */	mr r5, r4
/* 80A1CE14  4B 92 9F 59 */	bl PSMTXMultVec
/* 80A1CE18  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 80A1CE1C  38 81 00 14 */	addi r4, r1, 0x14
/* 80A1CE20  4B 85 3E 55 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80A1CE24  B0 7E 09 02 */	sth r3, 0x902(r30)
/* 80A1CE28  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 80A1CE2C  38 81 00 14 */	addi r4, r1, 0x14
/* 80A1CE30  4B 85 3D D5 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80A1CE6C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A1CE70  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A1CE74  4B 92 96 3D */	bl PSMTXCopy
...
/* 80A1CEA0  4B 85 23 3D */	bl SetC__8cM3dGCylFRC4cXyz
/* 80A1CEA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A1CEA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A1CEAC  38 63 23 3C */	addi r3, r3, 0x233c
/* 80A1CEB0  38 9E 12 C8 */	addi r4, r30, 0x12c8
/* 80A1CEB4  4B 84 7C F5 */	bl Set__4cCcSFP8cCcD_Obj
/* 80A1CEB8  39 61 00 30 */	addi r11, r1, 0x30
/* 80A1CEBC  4B 94 53 6D */	bl _restgpr_29
