...
/* 80A1EA40  3C 80 80 A2 */	lis r4, lit_5717@ha /* 0x80A21660@ha */
/* 80A1EA44  38 A4 16 60 */	addi r5, r4, lit_5717@l /* 0x80A21660@l */
...
/* 80A1EA7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A1EA80  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A1EA84  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80A1EA88  4B 62 39 E1 */	bl reset__14dEvt_control_cFv
/* 80A1EA8C  48 00 00 B4 */	b lbl_80A1EB40
lbl_80A1EA90:
/* 80A1EA90  38 80 00 00 */	li r4, 0
/* 80A1EA94  38 A0 00 01 */	li r5, 1
/* 80A1EA98  38 C0 00 00 */	li r6, 0
/* 80A1EA9C  4B 73 52 E9 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
/* 80A1EAA0  2C 03 00 00 */	cmpwi r3, 0
/* 80A1EAA4  41 82 00 58 */	beq lbl_80A1EAFC
/* 80A1EAA8  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 80A1EAAC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A1EAB0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A1EAB4  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80A1EAB8  4B 73 1C 05 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
/* 80A1EABC  88 1E 14 04 */	lbz r0, 0x1404(r30)
/* 80A1EAC0  7C 00 07 75 */	extsb. r0, r0
/* 80A1EAC4  40 82 00 30 */	bne lbl_80A1EAF4
/* 80A1EAC8  3C 60 80 A2 */	lis r3, lit_5727@ha /* 0x80A2166C@ha */
/* 80A1EACC  38 83 16 6C */	addi r4, r3, lit_5727@l /* 0x80A2166C@l */
...
/* 80A1EB10  4B 73 4C 09 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80A1EB24  3C A0 80 A2 */	lis r5, lit_3998@ha /* 0x80A21090@ha */
/* 80A1EB28  C0 25 10 90 */	lfs f1, lit_3998@l(r5)  /* 0x80A21090@l */
