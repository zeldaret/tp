...
/* 80AA4820  4B 5D F0 40 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 80AA4838  3C 80 80 39 */	lis r4, m_cylDat__10daNpcCd2_c@ha
/* 80AA483C  38 84 39 50 */	addi r4, r4, m_cylDat__10daNpcCd2_c@l
/* 80AA4840  4B 5E 00 74 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80AA4854  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 80AA4858  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_80AA486C:
/* 80AA486C  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 80AA4870  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
/* 80AA4874  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 80AA4878  7C 84 02 14 */	add r4, r4, r0
/* 80AA487C  C0 24 FF 34 */	lfs f1, -0xcc(r4)
lbl_80AA4880:
/* 80AA4880  4B 7C A9 80 */	b SetR__8cM3dGCylFf
...
/* 80AA4894  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 80AA4898  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_80AA48AC:
/* 80AA48AC  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 80AA48B0  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
/* 80AA48B4  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 80AA48B8  7C 84 02 14 */	add r4, r4, r0
/* 80AA48BC  C0 24 FF 30 */	lfs f1, -0xd0(r4)
lbl_80AA48C0:
/* 80AA48C0  4B 7C A9 38 */	b SetH__8cM3dGCylFf
