...
/* 80AA3400  4B 8B ED DD */	bl _savegpr_29
/* 80AA3404  7C 7E 1B 78 */	mr r30, r3
/* 80AA3408  3C 80 80 AA */	lis r4, lit_4109@ha /* 0x80AA698C@ha */
/* 80AA340C  3B E4 69 8C */	addi r31, r4, lit_4109@l /* 0x80AA698C@l */
...
/* 80AA345C  4B 6B 67 B9 */	bl checkPoint__11PathTrace_cF4cXyzf
...
/* 80AA34C8  3C A0 80 AA */	lis r5, m_funcTbl__13daNpcPasser_c@ha /* 0x80AA6B14@ha */
/* 80AA34CC  38 A5 6B 14 */	addi r5, r5, m_funcTbl__13daNpcPasser_c@l /* 0x80AA6B14@l */
...
/* 80AA34E0  4B 8B EB A5 */	bl __ptmf_scall
...
/* 80AA34F8  3C 60 80 AA */	lis r3, m_funcTbl__13daNpcPasser_c@ha /* 0x80AA6B14@ha */
/* 80AA34FC  38 63 6B 14 */	addi r3, r3, m_funcTbl__13daNpcPasser_c@l /* 0x80AA6B14@l */
...
/* 80AA3514  4B 8B EB 05 */	bl __ptmf_test
...
/* 80AA3570  4B 6B 68 51 */	bl checkPathEnd__11PathTrace_cF4cXyzf
/* 80AA3574  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80AA3578  41 82 00 10 */	beq lbl_80AA3588
/* 80AA357C  7F C3 F3 78 */	mr r3, r30
/* 80AA3580  4B 57 66 FD */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80AA35A0  4B 6B 4B 51 */	bl getAnmP__10daNpcCd2_cFii
...
/* 80AA35C0  4B 6B 59 41 */	bl setAnm__10daNpcCd2_cFP18J3DAnmTransformKeyffiii
...
/* 80AA35D4  4B 6B 69 C5 */	bl setNextPoint__11PathTrace_cFR4cXyz
...
/* 80AA35FC  4B 6B 6D 75 */	bl checkObstacle__11PathTrace_cFP10fopAc_ac_c
/* 80AA3600  38 7E 0A CC */	addi r3, r30, 0xacc
/* 80AA3604  38 81 00 28 */	addi r4, r1, 0x28
/* 80AA3608  4B 6B 68 4D */	bl getTargetPoint__11PathTrace_cFP3Vec
/* 80AA360C  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80AA3610  38 81 00 28 */	addi r4, r1, 0x28
/* 80AA3614  4B 7C D5 F1 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80AA3628  4B 7C CF E1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80AA3640  3C 60 80 AA */	lis r3, __vt__8cM3dGPla@ha /* 0x80AA73C0@ha */
/* 80AA3644  38 03 73 C0 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80AA73C0@l */
/* 80AA3648  90 01 00 44 */	stw r0, 0x44(r1)
/* 80AA364C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AA3650  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AA3654  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80AA3658  38 9E 07 28 */	addi r4, r30, 0x728
/* 80AA365C  38 A1 00 34 */	addi r5, r1, 0x34
/* 80AA3660  4B 5D 10 E5 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80AA3674  4B 57 A5 65 */	bl fopAcM_getPolygonAngle__FPC8cM3dGPlas
...
lbl_80AA368C:
/* 80AA368C  3C 60 80 AA */	lis r3, __vt__8cM3dGPla@ha /* 0x80AA73C0@ha */
/* 80AA3690  38 03 73 C0 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80AA73C0@l */
...
/* 80AA36AC  4B 8A 3C F1 */	bl PSVECSquareDistance
...
/* 80AA371C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80AA3720  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80AA378C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80AA3790  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80AA3794:
...
/* 80AA37E4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AA37E8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AA37EC  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80AA37F0  4B 5D 32 BD */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 80AA37F4  7F C3 F3 78 */	mr r3, r30
/* 80AA37F8  4B 6B 60 21 */	bl checkFearSituation__10daNpcCd2_cFv
...
/* 80AA3848  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80AA384C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80AA3850  38 81 00 0C */	addi r4, r1, 0xc
/* 80AA3854  4B 57 5F A5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80AA3858  28 03 00 00 */	cmplwi r3, 0
/* 80AA385C  41 82 00 08 */	beq lbl_80AA3864
/* 80AA3860  4B 57 64 1D */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_80AA3864:
/* 80AA3864  39 61 00 60 */	addi r11, r1, 0x60
/* 80AA3868  4B 8B E9 C1 */	bl _restgpr_29
