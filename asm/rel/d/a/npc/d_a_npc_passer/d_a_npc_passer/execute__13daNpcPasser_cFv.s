...
/* 80AA2FF8  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 80AA2FFC  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_80AA3010:
/* 80AA3010  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 80AA3014  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 80AA3038  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 80AA303C  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_80AA3050:
/* 80AA3050  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 80AA3054  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
/* 80AA3058  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 80AA305C  7C 84 02 14 */	add r4, r4, r0
/* 80AA3060  C0 24 FF 3C */	lfs f1, -0xc4(r4)
lbl_80AA3064:
/* 80AA3064  4B 5D 2E DC */	b SetWallR__12dBgS_AcchCirFf
...
/* 80AA3078  3C 80 80 AA */	lis r4, lit_4109@ha
/* 80AA307C  C0 44 69 8C */	lfs f2, lit_4109@l(r4)
/* 80AA3080  3C 80 80 AA */	lis r4, lit_4110@ha
/* 80AA3084  C0 64 69 90 */	lfs f3, lit_4110@l(r4)
/* 80AA3088  4B 7C C9 B4 */	b cLib_addCalc2__FPffff
/* 80AA308C  7F E3 FB 78 */	mr r3, r31
/* 80AA3090  38 80 FF FF */	li r4, -1
/* 80AA3094  4B 6B 5D 94 */	b animation__10daNpcCd2_cFi
...
/* 80AA313C  4B 57 6B 40 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80AA3140:
