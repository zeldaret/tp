...
/* 80553328  3C 60 80 55 */	lis r3, __vt__12daNpc_Kkri_c@ha /* 0x80553E08@ha */
/* 8055332C  38 03 3E 08 */	addi r0, r3, __vt__12daNpc_Kkri_c@l /* 0x80553E08@l */
/* 80553330  90 1F 0E 3C */	stw r0, 0xe3c(r31)
/* 80553334  3B DF 0E 44 */	addi r30, r31, 0xe44
/* 80553338  7F C3 F3 78 */	mr r3, r30
/* 8055333C  4B B3 06 ED */	bl __ct__12dCcD_GObjInfFv
/* 80553340  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80553344  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80553348  90 1E 01 20 */	stw r0, 0x120(r30)
/* 8055334C  3C 60 80 55 */	lis r3, __vt__8cM3dGAab@ha /* 0x80553DE4@ha */
/* 80553350  38 03 3D E4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80553DE4@l */
/* 80553354  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80553358  3C 60 80 55 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80553DF0@ha */
/* 8055335C  38 03 3D F0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80553DF0@l */
/* 80553360  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80553364  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80553368  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 8055336C  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80553370  38 03 00 58 */	addi r0, r3, 0x58
/* 80553374  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80553378  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 8055337C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80553398  3C 80 80 55 */	lis r4, __ct__18daNpcT_ActorMngr_cFv@ha /* 0x80552630@ha */
/* 8055339C  38 84 26 30 */	addi r4, r4, __ct__18daNpcT_ActorMngr_cFv@l /* 0x80552630@l */
/* 805533A0  3C A0 80 55 */	lis r5, __dt__18daNpcT_ActorMngr_cFv@ha /* 0x805525A0@ha */
/* 805533A4  38 A5 25 A0 */	addi r5, r5, __dt__18daNpcT_ActorMngr_cFv@l /* 0x805525A0@l */
/* 805533A8  38 C0 00 08 */	li r6, 8
/* 805533AC  38 E0 00 01 */	li r7, 1
/* 805533B0  4B E0 E9 B1 */	bl __construct_array
/* 805533B4  38 7F 0F A4 */	addi r3, r31, 0xfa4
/* 805533B8  3C 80 80 55 */	lis r4, __vt__13daNpcT_Path_c@ha /* 0x80553DFC@ha */
/* 805533BC  38 04 3D FC */	addi r0, r4, __vt__13daNpcT_Path_c@l /* 0x80553DFC@l */
/* 805533C0  90 1F 0F C8 */	stw r0, 0xfc8(r31)
/* 805533C4  4B BF 28 7D */	bl initialize__13daNpcT_Path_cFv
