...
/* 80975940  4B 9E C8 99 */	bl _savegpr_28
/* 80975944  7C 7F 1B 78 */	mr r31, r3
/* 80975948  3C 60 80 98 */	lis r3, m__17daNpcBouS_Param_c@ha /* 0x80978410@ha */
/* 8097594C  3B C3 84 10 */	addi r30, r3, m__17daNpcBouS_Param_c@l /* 0x80978410@l */
/* 80975950  4B 80 BC F1 */	bl dCam_getBody__Fv
...
/* 809759A0  4B 69 27 31 */	bl fadeOut__13mDoGph_gInf_cFf
/* 809759A4  7F A3 EB 78 */	mr r3, r29
/* 809759A8  4B 7E BB 29 */	bl Stop__9dCamera_cFv
...
/* 80975A04  4B 6A 5F 05 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 80975A28  3C 60 80 97 */	lis r3, s_sub__FPvPv@ha /* 0x80974998@ha */
/* 80975A2C  38 63 49 98 */	addi r3, r3, s_sub__FPvPv@l /* 0x80974998@l */
/* 80975A30  7F E4 FB 78 */	mr r4, r31
/* 80975A34  4B 6A B9 05 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80975A78  4B 7D E7 D9 */	bl setAngle__8daNpcF_cFs
...
/* 80975A94  4B 69 72 D1 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80975A98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80975A9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80975AA0  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80975AA4  4B 69 69 91 */	bl mDoMtx_YrotM__FPA4_fs
/* 80975AA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80975AAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80975AB0  38 81 00 18 */	addi r4, r1, 0x18
/* 80975AB4  7C 85 23 78 */	mr r5, r4
/* 80975AB8  4B 9D 12 B5 */	bl PSMTXMultVec
/* 80975ABC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80975AC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80975B20  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80975B24  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80975B28  80 7C 5D AC */	lwz r3, 0x5dac(r28)
/* 80975B2C  38 63 04 D0 */	addi r3, r3, 0x4d0
/* 80975B30  4B 69 72 35 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80975B34  80 9C 5D AC */	lwz r4, 0x5dac(r28)
/* 80975B38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80975B3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80975B40  A8 84 04 E6 */	lha r4, 0x4e6(r4)
/* 80975B44  4B 69 68 F1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80975B48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80975B4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80975B50  38 81 00 54 */	addi r4, r1, 0x54
/* 80975B54  7C 85 23 78 */	mr r5, r4
/* 80975B58  4B 9D 12 15 */	bl PSMTXMultVec
/* 80975B5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80975B60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80975B64  38 9E 00 00 */	addi r4, r30, 0
/* 80975B68  A8 84 00 86 */	lha r4, 0x86(r4)
/* 80975B6C  4B 69 68 C9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80975B70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80975B74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80975B78  38 9E 00 00 */	addi r4, r30, 0
/* 80975B7C  A8 84 00 84 */	lha r4, 0x84(r4)
/* 80975B80  4B 69 68 1D */	bl mDoMtx_XrotM__FPA4_fs
/* 80975B84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80975B88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80975B8C  38 81 00 48 */	addi r4, r1, 0x48
/* 80975B90  7C 85 23 78 */	mr r5, r4
/* 80975B94  4B 9D 11 D9 */	bl PSMTXMultVec
...
/* 80975BE4  4B 80 AE FD */	bl Set__9dCamera_cF4cXyz4cXyzfs
...
/* 80975C80  4B 7D E1 05 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
/* 80975C84  2C 03 00 00 */	cmpwi r3, 0
/* 80975C88  41 82 00 84 */	beq lbl_80975D0C
/* 80975C8C  38 7F 0C 78 */	addi r3, r31, 0xc78
/* 80975C90  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80975C94  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80975C98  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80975C9C  4B 7D AA 21 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 80975CE4  3C C0 80 98 */	lis r6, l_createPos@ha /* 0x80978BC4@ha */
/* 80975CE8  38 C6 8B C4 */	addi r6, r6, l_createPos@l /* 0x80978BC4@l */
/* 80975CEC  39 00 00 00 */	li r8, 0
/* 80975CF0  39 20 00 00 */	li r9, 0
/* 80975CF4  4B 6A 41 FD */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 80975D24  4B 7D D9 F5 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80975E04  4B 6A B5 55 */	bl fpcEx_SearchByID__FUi
/* 80975E08  28 03 00 00 */	cmplwi r3, 0
/* 80975E0C  41 82 00 B0 */	beq lbl_80975EBC
/* 80975E10  48 1B A3 AD */	bl checkStartUp__15daNpcWrestler_cFv
/* 80975E14  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80975E18  41 82 00 A4 */	beq lbl_80975EBC
/* 80975E1C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80975E20  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80975E24  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80975E28  4B 6C C6 41 */	bl reset__14dEvt_control_cFv
/* 80975E2C  3C 60 80 98 */	lis r3, lit_5163@ha /* 0x80978A18@ha */
/* 80975E30  38 83 8A 18 */	addi r4, r3, lit_5163@l /* 0x80978A18@l */
...
/* 80975E58  4B 9E C1 C1 */	bl __ptmf_test
...
/* 80975E70  4B 9E C2 15 */	bl __ptmf_scall
...
/* 80975E9C  4B 9E C1 7D */	bl __ptmf_test
