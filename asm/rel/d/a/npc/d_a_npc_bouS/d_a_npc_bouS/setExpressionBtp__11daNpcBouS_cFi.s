...
/* 80974524  4B 9E DC B9 */	bl _savegpr_29
/* 80974528  7C 7E 1B 78 */	mr r30, r3
/* 8097452C  7C 9F 23 78 */	mr r31, r4
/* 80974530  1F BF 00 0C */	mulli r29, r31, 0xc
/* 80974534  3C 80 80 98 */	lis r4, l_btpGetParamList@ha /* 0x809788D8@ha */
/* 80974538  38 A4 88 D8 */	addi r5, r4, l_btpGetParamList@l /* 0x809788D8@l */
/* 8097453C  7C 85 EA 14 */	add r4, r5, r29
/* 80974540  80 04 00 08 */	lwz r0, 8(r4)
/* 80974544  54 00 10 3A */	slwi r0, r0, 2
/* 80974548  3C 80 80 98 */	lis r4, l_arcNames@ha /* 0x80978920@ha */
/* 8097454C  38 84 89 20 */	addi r4, r4, l_arcNames@l /* 0x80978920@l */
/* 80974550  7C 84 00 2E */	lwzx r4, r4, r0
/* 80974554  7C A5 E8 2E */	lwzx r5, r5, r29
/* 80974558  4B 7D E6 11 */	bl getTexPtrnAnmP__8daNpcF_cFPci
/* 8097455C  7C 64 1B 79 */	or. r4, r3, r3
/* 80974560  3C 60 80 98 */	lis r3, l_btpGetParamList@ha /* 0x809788D8@ha */
/* 80974564  38 03 88 D8 */	addi r0, r3, l_btpGetParamList@l /* 0x809788D8@l */
...
/* 8097459C  3C E0 80 98 */	lis r7, lit_4446@ha /* 0x809784AC@ha */
/* 809745A0  C0 27 84 AC */	lfs f1, lit_4446@l(r7)  /* 0x809784AC@l */
/* 809745A4  4B 7D E7 21 */	bl setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 809745E0  4B 9E DC 49 */	bl _restgpr_29
