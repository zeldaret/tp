...
/* 809740A0  4B 9E E1 39 */	bl _savegpr_28
...
/* 809740B4  3C 60 80 98 */	lis r3, lit_4497@ha /* 0x809784B4@ha */
/* 809740B8  38 83 84 B4 */	addi r4, r3, lit_4497@l /* 0x809784B4@l */
...
/* 809740F0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809740F4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809740F8  4B 9D 23 B9 */	bl PSMTXCopy
/* 809740FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80974100  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80974134  4B 9D 23 7D */	bl PSMTXCopy
...
/* 80974164  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80974168  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8097416C  4B 9D 23 45 */	bl PSMTXCopy
...
/* 80974198  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8097419C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809741A0  4B 9D 23 11 */	bl PSMTXCopy
...
/* 809741D0  3C C0 80 98 */	lis r6, m__17daNpcBouS_Param_c@ha /* 0x80978410@ha */
/* 809741D4  38 C6 84 10 */	addi r6, r6, m__17daNpcBouS_Param_c@l /* 0x80978410@l */
/* 809741D8  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 809741DC  4B 7D F1 A1 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_809741E0:
/* 809741E0  2C 1D 00 01 */	cmpwi r29, 1
/* 809741E4  40 82 00 30 */	bne lbl_80974214
/* 809741E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809741EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809741F0  A8 9F 09 0C */	lha r4, 0x90c(r31)
/* 809741F4  4B 69 82 41 */	bl mDoMtx_YrotM__FPA4_fs
/* 809741F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809741FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80974200  A8 1F 09 08 */	lha r0, 0x908(r31)
/* 80974204  7C 00 00 D0 */	neg r0, r0
/* 80974208  7C 04 07 34 */	extsh r4, r0
/* 8097420C  4B 69 82 C1 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80974210  48 00 00 2C */	b lbl_8097423C
lbl_80974214:
/* 80974214  2C 1D 00 04 */	cmpwi r29, 4
/* 80974218  40 82 00 24 */	bne lbl_8097423C
/* 8097421C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80974220  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80974224  A8 9F 09 18 */	lha r4, 0x918(r31)
/* 80974228  4B 69 82 0D */	bl mDoMtx_YrotM__FPA4_fs
/* 8097422C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80974230  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80974234  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 80974238  4B 69 82 95 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_8097423C:
/* 8097423C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80974240  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80974244  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 80974248  80 04 00 0C */	lwz r0, 0xc(r4)
/* 8097424C  7C 80 F2 14 */	add r4, r0, r30
/* 80974250  4B 9D 22 61 */	bl PSMTXCopy
/* 80974254  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80974258  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8097425C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80974260  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80974264  4B 9D 22 4D */	bl PSMTXCopy
...
/* 80974294  4B 69 96 FD */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809742A8  4B 9E DF 7D */	bl _restgpr_28
