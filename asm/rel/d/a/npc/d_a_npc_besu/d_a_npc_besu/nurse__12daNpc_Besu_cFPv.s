...
/* 8053CC0C  4B C0 8C 8D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CC10  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 8053CC14  38 00 00 07 */	li r0, 7
/* 8053CC18  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 8053CC1C  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CC20  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
...
/* 8053CC44  4B C0 8C 55 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CC48  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 8053CC4C  38 00 00 0D */	li r0, 0xd
/* 8053CC50  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 8053CC54  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CC58  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
...
/* 8053CC98  4B C0 8A 65 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8053CC9C  38 00 00 00 */	li r0, 0
/* 8053CCA0  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 8053CCA4  3C 60 80 54 */	lis r3, lit_4337@ha /* 0x8053E844@ha */
/* 8053CCA8  C0 03 E8 44 */	lfs f0, lit_4337@l(r3)  /* 0x8053E844@l */
...
lbl_8053CCF4:
/* 8053CCF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053CCF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053CCFC  3B C3 4F F8 */	addi r30, r3, 0x4ff8
/* 8053CD00  7F C3 F3 78 */	mr r3, r30
/* 8053CD04  4B B0 B6 E5 */	bl getRunEventName__16dEvent_manager_cFv
/* 8053CD08  3C 80 80 54 */	lis r4, d_a_npc_besu__stringBase0@ha /* 0x8053E908@ha */
/* 8053CD0C  38 84 E9 08 */	addi r4, r4, d_a_npc_besu__stringBase0@l /* 0x8053E908@l */
/* 8053CD10  38 84 02 18 */	addi r4, r4, 0x218
/* 8053CD14  4B E2 BC 81 */	bl strcmp
/* 8053CD18  2C 03 00 00 */	cmpwi r3, 0
/* 8053CD1C  41 82 01 10 */	beq lbl_8053CE2C
/* 8053CD20  7F C3 F3 78 */	mr r3, r30
/* 8053CD24  4B B0 B6 C5 */	bl getRunEventName__16dEvent_manager_cFv
/* 8053CD28  3C 80 80 54 */	lis r4, d_a_npc_besu__stringBase0@ha /* 0x8053E908@ha */
/* 8053CD2C  38 84 E9 08 */	addi r4, r4, d_a_npc_besu__stringBase0@l /* 0x8053E908@l */
/* 8053CD30  38 84 02 35 */	addi r4, r4, 0x235
/* 8053CD34  4B E2 BC 61 */	bl strcmp
...
/* 8053CD6C  4B C0 8B 2D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CD70  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 8053CD74  38 00 00 12 */	li r0, 0x12
/* 8053CD78  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 8053CD7C  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CD80  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
...
/* 8053CD9C  4B C0 8A FD */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CDA0  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 8053CDA4  38 00 00 15 */	li r0, 0x15
/* 8053CDA8  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 8053CDAC  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CDB0  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
/* 8053CDB4  D0 1F 0B 8C */	stfs f0, 0xb8c(r31)
/* 8053CDB8  48 00 00 74 */	b lbl_8053CE2C
lbl_8053CDBC:
/* 8053CDBC  38 7F 0B 74 */	addi r3, r31, 0xb74
/* 8053CDC0  4B C0 8C 65 */	bl checkEndSequence__22daNpcT_MotionSeqMngr_cFv
...
/* 8053CDE0  4B C0 8A B9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CDE4  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 8053CDE8  38 00 00 07 */	li r0, 7
/* 8053CDEC  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 8053CDF0  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CDF4  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
...
/* 8053CE10  4B C0 8A 89 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CE14  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 8053CE18  38 00 00 0D */	li r0, 0xd
/* 8053CE1C  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 8053CE20  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CE24  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
...
/* 8053CE74  4B C0 8A 25 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CE78  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 8053CE7C  38 00 00 07 */	li r0, 7
/* 8053CE80  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 8053CE84  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CE88  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
...
/* 8053CEA4  4B C0 89 F5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CEA8  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 8053CEAC  38 00 00 0D */	li r0, 0xd
/* 8053CEB0  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 8053CEB4  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CEB8  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
...
/* 8053CF08  4B C0 89 91 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CF0C  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 8053CF10  38 00 00 04 */	li r0, 4
/* 8053CF14  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 8053CF18  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CF1C  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
...
/* 8053CF38  4B C0 89 61 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8053CF3C  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 8053CF40  38 00 00 0E */	li r0, 0xe
/* 8053CF44  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 8053CF48  3C 60 80 54 */	lis r3, lit_4894@ha /* 0x8053E86C@ha */
/* 8053CF4C  C0 03 E8 6C */	lfs f0, lit_4894@l(r3)  /* 0x8053E86C@l */
