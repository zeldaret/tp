...
/* 8053C09C  4B E2 61 41 */	bl _savegpr_29
/* 8053C0A0  7C 7E 1B 78 */	mr r30, r3
/* 8053C0A4  3C 60 80 54 */	lis r3, m__18daNpc_Besu_Param_c@ha /* 0x8053E754@ha */
/* 8053C0A8  3B E3 E7 54 */	addi r31, r3, m__18daNpc_Besu_Param_c@l /* 0x8053E754@l */
...
/* 8053C104  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053C108  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053C10C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8053C110  7C 05 07 74 */	extsb r5, r0
/* 8053C114  4B AF 92 4D */	bl isSwitch__10dSv_info_cCFii
...
/* 8053C134  4B C0 97 65 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C160  4B C0 97 39 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C190  4B C0 97 09 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C1BC  4B C0 96 DD */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C1EC  4B C0 96 AD */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C218  4B C0 96 81 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C258  4B C0 96 41 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C284  4B C0 96 15 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C2B4  4B C0 95 E5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C2E0  4B C0 95 B9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053C338  4B C1 07 75 */	bl daNpcT_chkEvtBit__FUl
...
/* 8053C354  4B AD D9 29 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 8053C358  38 60 00 01 */	li r3, 1
/* 8053C35C  48 00 07 2C */	b lbl_8053CA88
lbl_8053C360:
/* 8053C360  38 7E 10 E0 */	addi r3, r30, 0x10e0
/* 8053C364  4B C0 93 A5 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8053C394  48 52 9D 45 */	bl checkStartDemo13StbEvt__11daNpc_Len_cFP10fopAc_ac_cfffffff
...
/* 8053C3C0  4B C1 06 ED */	bl daNpcT_chkEvtBit__FUl
/* 8053C3C4  2C 03 00 00 */	cmpwi r3, 0
/* 8053C3C8  41 82 00 44 */	beq lbl_8053C40C
/* 8053C3CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053C3D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8053C3F0  4B C1 06 BD */	bl daNpcT_chkEvtBit__FUl
/* 8053C3F4  2C 03 00 00 */	cmpwi r3, 0
/* 8053C3F8  41 82 00 14 */	beq lbl_8053C40C
/* 8053C3FC  7F C3 F3 78 */	mr r3, r30
/* 8053C400  4B AD D8 7D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 8053C434  4B C0 92 C9 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C468  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053C46C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053C470  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8053C474  7C 05 07 74 */	extsb r5, r0
/* 8053C478  4B AF 8E E9 */	bl isSwitch__10dSv_info_cCFii
...
/* 8053C4A8  4B AF 51 A1 */	bl daNpcKakashi_chkSwdTutorialStage__Fv
/* 8053C4AC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8053C4B0  41 82 00 10 */	beq lbl_8053C4C0
/* 8053C4B4  38 7E 0B 98 */	addi r3, r30, 0xb98
/* 8053C4B8  4B C0 92 45 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C4D8  4B C0 92 25 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8053C4DC  48 00 00 64 */	b lbl_8053C540
lbl_8053C4E0:
/* 8053C4E0  28 00 00 0C */	cmplwi r0, 0xc
/* 8053C4E4  40 82 00 5C */	bne lbl_8053C540
/* 8053C4E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053C4EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8053C4FC  4B AF 85 09 */	bl getEventReg__11dSv_event_cCFUs
...
/* 8053C51C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053C520  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053C524  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8053C528  4B C0 91 B9 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
...
/* 8053C53C  4B C0 91 C1 */	bl remove__18daNpcT_ActorMngr_cFv
lbl_8053C540:
/* 8053C540  38 7E 0B 98 */	addi r3, r30, 0xb98
/* 8053C544  4B C0 91 C5 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
lbl_8053C570:
/* 8053C570  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053C574  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053C578  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 8053C57C  38 80 0D 02 */	li r4, 0xd02
/* 8053C580  4B AF 84 0D */	bl onEventBit__11dSv_event_cFUs
lbl_8053C584:
...
/* 8053C594  4B C0 91 69 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C5E4  4B C0 91 19 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C610  4B C0 90 F9 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8053C624  4B C0 E5 AD */	bl chkActorInSight__8daNpcT_cFP10fopAc_ac_cfs
...
/* 8053C640  4B C0 90 BD */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C668  4B C0 EC D1 */	bl srchPlayerActor__8daNpcT_cFv
...
lbl_8053C6A4:
/* 8053C6A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053C6A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053C6AC  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 8053C6B0  38 80 0D 02 */	li r4, 0xd02
/* 8053C6B4  4B AF 82 F1 */	bl offEventBit__11dSv_event_cFUs
lbl_8053C6B8:
...
/* 8053C6C8  4B C0 90 35 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C730  4B C0 EF 19 */	bl step__8daNpcT_cFsiiii
...
/* 8053C760  4B C0 EE E9 */	bl step__8daNpcT_cFsiiii
...
/* 8053C77C  4B C0 E2 9D */	bl setAngle__8daNpcT_cFs
...
lbl_8053C794:
/* 8053C794  4B AF 4E B5 */	bl daNpcKakashi_chkSwdTutorialStage__Fv
...
/* 8053C7B0  4B C0 8F 4D */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C7EC  4B C0 EB 4D */	bl srchPlayerActor__8daNpcT_cFv
lbl_8053C7F0:
...
lbl_8053C83C:
/* 8053C83C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053C840  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053C844  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 8053C848  38 80 0E 40 */	li r4, 0xe40
/* 8053C84C  4B AF 81 59 */	bl offEventBit__11dSv_event_cFUs
/* 8053C850  48 00 02 1C */	b lbl_8053CA6C
lbl_8053C854:
/* 8053C854  38 60 00 64 */	li r3, 0x64
/* 8053C858  4B C1 03 15 */	bl daNpcT_chkTmpBit__FUl
...
/* 8053C888  4B C0 8E 75 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C8F0  4B C0 8E 19 */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8053C8F4  7C 7D 1B 78 */	mr r29, r3
/* 8053C8F8  48 00 00 10 */	b lbl_8053C908
lbl_8053C8FC:
/* 8053C8FC  38 7E 10 C8 */	addi r3, r30, 0x10c8
/* 8053C900  4B C0 8E 09 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8053C914  4B C0 8D F5 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8053C93C  4B C0 8D C1 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053C974  4B AD C3 6D */	bl fopAc_IsActor__FPv
...
/* 8053C988  4B C0 8D 59 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
...
/* 8053C9A4  4B C0 8D 65 */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8053C9A8  7C 7D 1B 79 */	or. r29, r3, r3
/* 8053C9AC  41 82 00 C0 */	beq lbl_8053CA6C
/* 8053C9B0  38 7E 0B A8 */	addi r3, r30, 0xba8
/* 8053C9B4  4B C0 8D 55 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8053C9DC  4B C0 8D 21 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053CA14  4B AD C2 CD */	bl fopAc_IsActor__FPv
...
/* 8053CA28  4B C0 8C B9 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
...
lbl_8053CA58:
/* 8053CA58  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053CA5C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053CA60  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 8053CA64  38 80 0E 40 */	li r4, 0xe40
/* 8053CA68  4B AF 7F 25 */	bl onEventBit__11dSv_event_cFUs
lbl_8053CA6C:
...
/* 8053CA8C  4B E2 57 9D */	bl _restgpr_29
