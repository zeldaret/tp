...
/* 8053A46C  4B E2 7D 61 */	bl _savegpr_25
/* 8053A470  7C 79 1B 78 */	mr r25, r3
/* 8053A474  7C 9A 23 78 */	mr r26, r4
/* 8053A478  3C 60 80 54 */	lis r3, m__18daNpc_Besu_Param_c@ha /* 0x8053E754@ha */
/* 8053A47C  3B E3 E7 54 */	addi r31, r3, m__18daNpc_Besu_Param_c@l /* 0x8053E754@l */
/* 8053A480  3B A0 00 00 */	li r29, 0
/* 8053A484  3B 80 FF FF */	li r28, -1
/* 8053A488  3B 60 00 00 */	li r27, 0
/* 8053A48C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053A490  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053A494  3B C3 4F F8 */	addi r30, r3, 0x4ff8
/* 8053A498  7F C3 F3 78 */	mr r3, r30
/* 8053A49C  3C A0 80 54 */	lis r5, d_a_npc_besu__stringBase0@ha /* 0x8053E908@ha */
/* 8053A4A0  38 A5 E9 08 */	addi r5, r5, d_a_npc_besu__stringBase0@l /* 0x8053E908@l */
/* 8053A4A4  38 A5 01 F3 */	addi r5, r5, 0x1f3
/* 8053A4A8  38 C0 00 03 */	li r6, 3
/* 8053A4AC  4B B0 DC 41 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8053A4C4  3C A0 80 54 */	lis r5, d_a_npc_besu__stringBase0@ha /* 0x8053E908@ha */
/* 8053A4C8  38 A5 E9 08 */	addi r5, r5, d_a_npc_besu__stringBase0@l /* 0x8053E908@l */
/* 8053A4CC  38 A5 02 04 */	addi r5, r5, 0x204
/* 8053A4D0  38 C0 00 03 */	li r6, 3
/* 8053A4D4  4B B0 DC 19 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8053A500  4B C0 B2 09 */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8053A504  90 61 00 0C */	stw r3, 0xc(r1)
/* 8053A508  38 79 10 D0 */	addi r3, r25, 0x10d0
/* 8053A50C  4B C0 B1 FD */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8053A510  90 61 00 10 */	stw r3, 0x10(r1)
/* 8053A514  93 21 00 14 */	stw r25, 0x14(r1)
/* 8053A518  80 01 00 0C */	lwz r0, 0xc(r1)
/* 8053A51C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053A520  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8053A558  4B B0 D7 F5 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8053A58C  4B C1 16 65 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
lbl_8053A590:
...
/* 8053A5B8  4B C0 B1 45 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053A618  4B C1 10 31 */	bl step__8daNpcT_cFsiiii
...
/* 8053A638  4B C0 B2 61 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053A664  4B C0 B2 35 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053A698  4B C1 0F B1 */	bl step__8daNpcT_cFsiiii
...
/* 8053A6B8  4B C0 B1 E1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053A6E4  4B C0 B1 B5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053A728  4B C1 15 51 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 8053A73C  4B D0 FD ED */	bl getEventId__10dMsgFlow_cFPi
...
/* 8053A76C  4B AE CA 05 */	bl dStage_changeScene__FifUlScsi
...
/* 8053A78C  4B E2 7A 8D */	bl _restgpr_25
