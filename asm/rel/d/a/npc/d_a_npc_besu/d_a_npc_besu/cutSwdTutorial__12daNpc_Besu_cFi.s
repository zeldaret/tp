...
/* 8053A7B0  4B E2 7A 21 */	bl _savegpr_26
/* 8053A7B4  7C 7D 1B 78 */	mr r29, r3
/* 8053A7B8  7C 9A 23 78 */	mr r26, r4
/* 8053A7BC  3C 60 80 54 */	lis r3, m__18daNpc_Besu_Param_c@ha /* 0x8053E754@ha */
/* 8053A7C0  3B E3 E7 54 */	addi r31, r3, m__18daNpc_Besu_Param_c@l /* 0x8053E754@l */
/* 8053A7C4  3B C0 00 00 */	li r30, 0
/* 8053A7C8  3B 60 FF FF */	li r27, -1
/* 8053A7CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8053A7D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8053A7D4  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 8053A7D8  7F 83 E3 78 */	mr r3, r28
/* 8053A7DC  3C A0 80 54 */	lis r5, d_a_npc_besu__stringBase0@ha /* 0x8053E908@ha */
/* 8053A7E0  38 A5 E9 08 */	addi r5, r5, d_a_npc_besu__stringBase0@l /* 0x8053E908@l */
/* 8053A7E4  38 A5 01 F3 */	addi r5, r5, 0x1f3
/* 8053A7E8  38 C0 00 03 */	li r6, 3
/* 8053A7EC  4B B0 D9 01 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8053A804  4B B0 D5 49 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8053A830  4B C0 B0 69 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053A850  4B C0 B0 49 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8053A870  4B C1 01 A9 */	bl setAngle__8daNpcT_cFs
...
/* 8053A888  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8053A88C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8053A890  A8 9D 0D 7A */	lha r4, 0xd7a(r29)
/* 8053A894  4B AD 1B 49 */	bl mDoMtx_YrotS__FPA4_fs
/* 8053A898  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8053A89C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8053A8A0  38 81 00 14 */	addi r4, r1, 0x14
/* 8053A8A4  7C 85 23 78 */	mr r5, r4
/* 8053A8A8  4B E0 C4 C5 */	bl PSMTXMultVec
/* 8053A8AC  38 61 00 14 */	addi r3, r1, 0x14
/* 8053A8B0  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 8053A8B4  7C 65 1B 78 */	mr r5, r3
/* 8053A8B8  4B E0 C7 D9 */	bl PSVECAdd
...
/* 8053A8DC  4B C1 00 2D */	bl setPos__8daNpcT_cF4cXyz
lbl_8053A8E0:
...
/* 8053A930  4B C0 AD CD */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053A97C  4B C0 AD 8D */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8053A980  7C 7C 1B 78 */	mr r28, r3
/* 8053A984  38 7D 0B A8 */	addi r3, r29, 0xba8
/* 8053A988  4B C0 AD 81 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8053A9B0  4B C0 AD 4D */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053A9E8  4B AD E2 F9 */	bl fopAc_IsActor__FPv
...
/* 8053A9FC  4B C0 AC E5 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
...
/* 8053AA28  4B C0 AC D5 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8053AA58  4B E2 77 C5 */	bl _restgpr_26
