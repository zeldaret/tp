...
/* 80AF2ED0  4B 86 F3 01 */	bl _savegpr_26
/* 80AF2ED4  7C 7E 1B 79 */	or. r30, r3, r3
/* 80AF2ED8  7C 9F 23 78 */	mr r31, r4
/* 80AF2EDC  41 82 01 C8 */	beq lbl_80AF30A4
/* 80AF2EE0  3C 60 80 AF */	lis r3, __vt__16daNpc_SoldierB_c@ha /* 0x80AF5D4C@ha */
/* 80AF2EE4  38 03 5D 4C */	addi r0, r3, __vt__16daNpc_SoldierB_c@l /* 0x80AF5D4C@l */
/* 80AF2EE8  90 1E 0B 44 */	stw r0, 0xb44(r30)
/* 80AF2EEC  3B A0 00 00 */	li r29, 0
/* 80AF2EF0  3B 80 00 00 */	li r28, 0
/* 80AF2EF4  3C 60 80 AF */	lis r3, l_resNames@ha /* 0x80AF5C8C@ha */
/* 80AF2EF8  3B 43 5C 8C */	addi r26, r3, l_resNames@l /* 0x80AF5C8C@l */
/* 80AF2EFC  3C 60 80 AF */	lis r3, l_loadRes_list@ha /* 0x80AF5C84@ha */
/* 80AF2F00  3B 63 5C 84 */	addi r27, r3, l_loadRes_list@l /* 0x80AF5C84@l */
...
/* 80AF2F18  4B 53 A0 F1 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80AF2F4C  4B 51 E3 C5 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AF2F50:
/* 80AF2F50  34 1E 0C 94 */	addic. r0, r30, 0xc94
/* 80AF2F54  41 82 00 84 */	beq lbl_80AF2FD8
/* 80AF2F58  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80AF2F5C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80AF2F7C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80AF2F80  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80AF2F98  3C 60 80 AF */	lis r3, __vt__8cM3dGCyl@ha /* 0x80AF5DF4@ha */
/* 80AF2F9C  38 03 5D F4 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80AF5DF4@l */
/* 80AF2FA0  90 1E 0D CC */	stw r0, 0xdcc(r30)
lbl_80AF2FA4:
/* 80AF2FA4  34 1E 0D 98 */	addic. r0, r30, 0xd98
/* 80AF2FA8  41 82 00 24 */	beq lbl_80AF2FCC
/* 80AF2FAC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80AF2FB0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80AF2FB4  90 1E 0D B4 */	stw r0, 0xdb4(r30)
/* 80AF2FB8  34 1E 0D 98 */	addic. r0, r30, 0xd98
/* 80AF2FBC  41 82 00 10 */	beq lbl_80AF2FCC
/* 80AF2FC0  3C 60 80 AF */	lis r3, __vt__8cM3dGAab@ha /* 0x80AF5E00@ha */
/* 80AF2FC4  38 03 5E 00 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80AF5E00@l */
/* 80AF2FC8  90 1E 0D B0 */	stw r0, 0xdb0(r30)
lbl_80AF2FCC:
/* 80AF2FCC  38 7E 0C 94 */	addi r3, r30, 0xc94
/* 80AF2FD0  38 80 00 00 */	li r4, 0
/* 80AF2FD4  4B 59 11 11 */	bl __dt__12dCcD_GObjInfFv
lbl_80AF2FD8:
/* 80AF2FD8  38 7E 0C 78 */	addi r3, r30, 0xc78
/* 80AF2FDC  3C 80 80 AF */	lis r4, __dt__18daNpcF_ActorMngr_cFv@ha /* 0x80AF51E8@ha */
/* 80AF2FE0  38 84 51 E8 */	addi r4, r4, __dt__18daNpcF_ActorMngr_cFv@l /* 0x80AF51E8@l */
/* 80AF2FE4  38 A0 00 08 */	li r5, 8
/* 80AF2FE8  38 C0 00 03 */	li r6, 3
/* 80AF2FEC  4B 86 EC FD */	bl __destroy_arr
/* 80AF2FF0  34 1E 0B DC */	addic. r0, r30, 0xbdc
/* 80AF2FF4  41 82 00 88 */	beq lbl_80AF307C
/* 80AF2FF8  3C 60 80 AF */	lis r3, __vt__15daNpcF_Lookat_c@ha /* 0x80AF5E0C@ha */
/* 80AF2FFC  38 03 5E 0C */	addi r0, r3, __vt__15daNpcF_Lookat_c@l /* 0x80AF5E0C@l */
/* 80AF3000  90 1E 0C 74 */	stw r0, 0xc74(r30)
/* 80AF3004  38 7E 0C 58 */	addi r3, r30, 0xc58
/* 80AF3008  3C 80 80 AF */	lis r4, __dt__5csXyzFv@ha /* 0x80AF533C@ha */
/* 80AF300C  38 84 53 3C */	addi r4, r4, __dt__5csXyzFv@l /* 0x80AF533C@l */
/* 80AF3010  38 A0 00 06 */	li r5, 6
/* 80AF3014  38 C0 00 04 */	li r6, 4
/* 80AF3018  4B 86 EC D1 */	bl __destroy_arr
/* 80AF301C  38 7E 0C 40 */	addi r3, r30, 0xc40
/* 80AF3020  3C 80 80 AF */	lis r4, __dt__5csXyzFv@ha /* 0x80AF533C@ha */
/* 80AF3024  38 84 53 3C */	addi r4, r4, __dt__5csXyzFv@l /* 0x80AF533C@l */
/* 80AF3028  38 A0 00 06 */	li r5, 6
/* 80AF302C  38 C0 00 04 */	li r6, 4
/* 80AF3030  4B 86 EC B9 */	bl __destroy_arr
/* 80AF3034  38 7E 0C 28 */	addi r3, r30, 0xc28
/* 80AF3038  3C 80 80 AF */	lis r4, __dt__5csXyzFv@ha /* 0x80AF533C@ha */
/* 80AF303C  38 84 53 3C */	addi r4, r4, __dt__5csXyzFv@l /* 0x80AF533C@l */
/* 80AF3040  38 A0 00 06 */	li r5, 6
/* 80AF3044  38 C0 00 04 */	li r6, 4
/* 80AF3048  4B 86 EC A1 */	bl __destroy_arr
/* 80AF304C  38 7E 0C 10 */	addi r3, r30, 0xc10
/* 80AF3050  3C 80 80 AF */	lis r4, __dt__5csXyzFv@ha /* 0x80AF533C@ha */
/* 80AF3054  38 84 53 3C */	addi r4, r4, __dt__5csXyzFv@l /* 0x80AF533C@l */
/* 80AF3058  38 A0 00 06 */	li r5, 6
/* 80AF305C  38 C0 00 04 */	li r6, 4
/* 80AF3060  4B 86 EC 89 */	bl __destroy_arr
/* 80AF3064  38 7E 0B DC */	addi r3, r30, 0xbdc
/* 80AF3068  3C 80 80 AF */	lis r4, __dt__4cXyzFv@ha /* 0x80AF537C@ha */
/* 80AF306C  38 84 53 7C */	addi r4, r4, __dt__4cXyzFv@l /* 0x80AF537C@l */
/* 80AF3070  38 A0 00 0C */	li r5, 0xc
/* 80AF3074  38 C0 00 04 */	li r6, 4
/* 80AF3078  4B 86 EC 71 */	bl __destroy_arr
lbl_80AF307C:
/* 80AF307C  38 7E 0B 48 */	addi r3, r30, 0xb48
/* 80AF3080  38 80 FF FF */	li r4, -1
/* 80AF3084  4B 7C D3 9D */	bl __dt__10Z2CreatureFv
...
/* 80AF30A0  4B 7D BC 9D */	bl __dl__FPv
lbl_80AF30A4:
/* 80AF30A4  7F C3 F3 78 */	mr r3, r30
/* 80AF30A8  39 61 00 20 */	addi r11, r1, 0x20
/* 80AF30AC  4B 86 F1 71 */	bl _restgpr_26
