...
/* 80AA86B4  3C 60 80 AB */	lis r3, __vt__9daNpcCd_c@ha
/* 80AA86B8  38 03 8B 74 */	addi r0, r3, __vt__9daNpcCd_c@l
/* 80AA86BC  90 1E 05 68 */	stw r0, 0x568(r30)
/* 80AA86C0  34 1E 08 88 */	addic. r0, r30, 0x888
/* 80AA86C4  41 82 00 84 */	beq lbl_80AA8748
/* 80AA86C8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80AA86CC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80AA86EC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80AA86F0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80AA8708  3C 60 80 AB */	lis r3, __vt__8cM3dGCyl@ha
/* 80AA870C  38 03 8B 38 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80AA8710  90 1E 09 C0 */	stw r0, 0x9c0(r30)
lbl_80AA8714:
/* 80AA8714  34 1E 09 8C */	addic. r0, r30, 0x98c
/* 80AA8718  41 82 00 24 */	beq lbl_80AA873C
/* 80AA871C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80AA8720  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80AA8724  90 1E 09 A8 */	stw r0, 0x9a8(r30)
/* 80AA8728  34 1E 09 8C */	addic. r0, r30, 0x98c
/* 80AA872C  41 82 00 10 */	beq lbl_80AA873C
/* 80AA8730  3C 60 80 AB */	lis r3, __vt__8cM3dGAab@ha
/* 80AA8734  38 03 8B 44 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80AA8738  90 1E 09 A4 */	stw r0, 0x9a4(r30)
lbl_80AA873C:
/* 80AA873C  38 7E 08 88 */	addi r3, r30, 0x888
/* 80AA8740  38 80 00 00 */	li r4, 0
/* 80AA8744  4B 5D B9 A0 */	b __dt__12dCcD_GObjInfFv
lbl_80AA8748:
/* 80AA8748  34 1E 08 4C */	addic. r0, r30, 0x84c
/* 80AA874C  41 82 00 54 */	beq lbl_80AA87A0
/* 80AA8750  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80AA8754  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80AA876C  3C 60 80 AB */	lis r3, __vt__10dCcD_GStts@ha
/* 80AA8770  38 03 8B 20 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 80AA8774  90 1E 08 68 */	stw r0, 0x868(r30)
/* 80AA8778  34 1E 08 68 */	addic. r0, r30, 0x868
/* 80AA877C  41 82 00 10 */	beq lbl_80AA878C
/* 80AA8780  3C 60 80 AB */	lis r3, __vt__10cCcD_GStts@ha
/* 80AA8784  38 03 8B 14 */	addi r0, r3, __vt__10cCcD_GStts@l
/* 80AA8788  90 1E 08 68 */	stw r0, 0x868(r30)
lbl_80AA878C:
/* 80AA878C  34 1E 08 4C */	addic. r0, r30, 0x84c
/* 80AA8790  41 82 00 10 */	beq lbl_80AA87A0
/* 80AA8794  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80AA8798  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80AA879C  90 1E 08 64 */	stw r0, 0x864(r30)
lbl_80AA87A0:
/* 80AA87A0  34 1E 08 0C */	addic. r0, r30, 0x80c
/* 80AA87A4  41 82 00 28 */	beq lbl_80AA87CC
/* 80AA87A8  3C 60 80 AB */	lis r3, __vt__12dBgS_AcchCir@ha
/* 80AA87AC  38 03 8B 08 */	addi r0, r3, __vt__12dBgS_AcchCir@l
/* 80AA87B0  90 1E 08 18 */	stw r0, 0x818(r30)
/* 80AA87B4  38 7E 08 20 */	addi r3, r30, 0x820
/* 80AA87B8  38 80 FF FF */	li r4, -1
/* 80AA87BC  4B 7C 67 5C */	b __dt__8cM3dGCirFv
/* 80AA87C0  38 7E 08 0C */	addi r3, r30, 0x80c
/* 80AA87C4  38 80 00 00 */	li r4, 0
/* 80AA87C8  4B 7B F8 E8 */	b __dt__13cBgS_PolyInfoFv
lbl_80AA87CC:
/* 80AA87CC  34 1E 06 34 */	addic. r0, r30, 0x634
/* 80AA87D0  41 82 00 2C */	beq lbl_80AA87FC
/* 80AA87D4  3C 60 80 AB */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80AA87D8  38 63 8B 50 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
