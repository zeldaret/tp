...
/* 80997DB8  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 80997DBC  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 80997DD0  3C 60 80 9A */	lis r3, l_motionAnmData@ha /* 0x80999C00@ha */
/* 80997DD4  38 83 9C 00 */	addi r4, r3, l_motionAnmData@l /* 0x80999C00@l */
/* 80997DD8  80 04 00 24 */	lwz r0, 0x24(r4)
/* 80997DDC  54 00 10 3A */	slwi r0, r0, 2
/* 80997DE0  3C 60 80 9A */	lis r3, l_resNameList@ha /* 0x80999AF0@ha */
/* 80997DE4  38 63 9A F0 */	addi r3, r3, l_resNameList@l /* 0x80999AF0@l */
/* 80997DE8  7C 63 00 2E */	lwzx r3, r3, r0
/* 80997DEC  80 84 00 1C */	lwz r4, 0x1c(r4)
/* 80997DF0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80997DF4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80997DF8  3C A5 00 02 */	addis r5, r5, 2
/* 80997DFC  38 C0 00 80 */	li r6, 0x80
/* 80997E00  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80997E04  4B 6A 44 E9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
