...
/* 80998374  4B 7B 38 7D */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 809983B0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809983B4  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809983B8  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 809983BC  4B 68 23 55 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809983E4  4B 7B 38 95 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
/* 809983E8  2C 03 00 00 */	cmpwi r3, 0
/* 809983EC  41 82 00 30 */	beq lbl_8099841C
/* 809983F0  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 809983F4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809983F8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809983FC  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80998400  4B 7A D2 E1 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80998404  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80998408  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8099840C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80998410  4B 6A A0 59 */	bl reset__14dEvt_control_cFv
...
/* 8099842C  4B 7A D2 D1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80998430  38 00 00 00 */	li r0, 0
/* 80998434  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80998438  3C 60 80 9A */	lis r3, lit_4152@ha /* 0x80999A2C@ha */
/* 8099843C  C0 03 9A 2C */	lfs f0, lit_4152@l(r3)  /* 0x80999A2C@l */
...
/* 80998474  4B 7A D2 89 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80998478  38 00 00 00 */	li r0, 0
/* 8099847C  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80998480  3C 60 80 9A */	lis r3, lit_4152@ha /* 0x80999A2C@ha */
/* 80998484  C0 03 9A 2C */	lfs f0, lit_4152@l(r3)  /* 0x80999A2C@l */
...
/* 809984B0  4B 7A D2 4D */	bl remove__18daNpcT_ActorMngr_cFv
/* 809984B4  38 00 00 00 */	li r0, 0
/* 809984B8  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 809984BC  3C 60 80 9A */	lis r3, lit_4152@ha /* 0x80999A2C@ha */
/* 809984C0  C0 03 9A 2C */	lfs f0, lit_4152@l(r3)  /* 0x80999A2C@l */
...
/* 809984E4  4B 68 22 2D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80998500  4B 7B 31 49 */	bl step__8daNpcT_cFsiiii
lbl_80998504:
