...
/* 80998538  3C 80 80 9A */	lis r4, m__20daNpc_clerkB_Param_c@ha /* 0x80999978@ha */
/* 8099853C  3B E4 99 78 */	addi r31, r4, m__20daNpc_clerkB_Param_c@l /* 0x80999978@l */
...
/* 809985D8  4B 7A D1 25 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 80998638  4B 80 1B 21 */	bl shop_process__13dShopSystem_cFP10fopAc_ac_cP10dMsgFlow_c
...
/* 80998650  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80998654  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80998658  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8099865C  4B 7A D0 85 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80998660  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80998664  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80998668  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8099866C  4B 6A 9D FD */	bl reset__14dEvt_control_cFv
...
/* 809986A4  4B 7A D0 59 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 809986E4  4B 7F E2 BD */	bl getCurrentPos__15dShopItemCtrl_cFi
...
/* 80998718  4B 67 46 4D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8099871C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80998720  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80998724  A8 9E 0D 7A */	lha r4, 0xd7a(r30)
/* 80998728  4B 67 3D 0D */	bl mDoMtx_YrotM__FPA4_fs
/* 8099872C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80998730  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80998734  38 81 00 2C */	addi r4, r1, 0x2c
/* 80998738  38 BE 0D 6C */	addi r5, r30, 0xd6c
/* 8099873C  4B 9A E6 31 */	bl PSMTXMultVec
...
/* 8099876C  4B 7A CF 91 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 809987C4  4B 7A CF 39 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 80998800  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80998804  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80998808  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 8099880C  4B 67 3B D1 */	bl mDoMtx_YrotS__FPA4_fs
/* 80998810  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80998814  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80998818  38 81 00 38 */	addi r4, r1, 0x38
/* 8099881C  7C 85 23 78 */	mr r5, r4
/* 80998820  4B 9A E5 4D */	bl PSMTXMultVec
/* 80998824  38 61 00 38 */	addi r3, r1, 0x38
/* 80998828  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 8099882C  7C 65 1B 78 */	mr r5, r3
/* 80998830  4B 9A E8 61 */	bl PSVECAdd
/* 80998834  38 7E 0E 78 */	addi r3, r30, 0xe78
/* 80998838  38 81 00 38 */	addi r4, r1, 0x38
/* 8099883C  4B 7F E0 7D */	bl setMasterCamCtrPos__16ShopCam_action_cFP4cXyz
/* 80998840  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80998844  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80998848  A8 9E 0D 7A */	lha r4, 0xd7a(r30)
/* 8099884C  38 04 40 00 */	addi r0, r4, 0x4000
/* 80998850  7C 04 07 34 */	extsh r4, r0
/* 80998854  4B 67 3B 89 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8099886C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80998870  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80998874  38 81 00 2C */	addi r4, r1, 0x2c
/* 80998878  7C 85 23 78 */	mr r5, r4
/* 8099887C  4B 9A E4 F1 */	bl PSMTXMultVec
/* 80998880  38 61 00 14 */	addi r3, r1, 0x14
/* 80998884  38 9E 04 A8 */	addi r4, r30, 0x4a8
/* 80998888  38 A1 00 2C */	addi r5, r1, 0x2c
/* 8099888C  4B 8C E2 59 */	bl __pl__4cXyzCFRC3Vec
...
/* 809988BC  4B 7B 20 4D */	bl setPos__8daNpcT_cF4cXyz
lbl_809988C0:
