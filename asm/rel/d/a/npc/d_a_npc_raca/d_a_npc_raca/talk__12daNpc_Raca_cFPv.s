...
/* 80AB7960  4B 69 51 CD */	bl daNpcT_offTmpBit__FUl
...
/* 80AB7978  4B 69 51 75 */	bl daNpcT_onTmpBit__FUl
lbl_80AB797C:
...
/* 80AB7994  4B 69 42 5D */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80AB79D0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AB79D4  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AB79D8  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 80AB79DC  4B 56 2D 35 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80AB7A04  4B 69 42 75 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
/* 80AB7A08  2C 03 00 00 */	cmpwi r3, 0
/* 80AB7A0C  41 82 00 30 */	beq lbl_80AB7A3C
/* 80AB7A10  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 80AB7A14  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AB7A18  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AB7A1C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80AB7A20  4B 68 DC C1 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80AB7A24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AB7A28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AB7A2C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80AB7A30  4B 58 AA 39 */	bl reset__14dEvt_control_cFv
...
/* 80AB7A4C  4B 68 DC B1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AB7A50  38 00 00 00 */	li r0, 0
/* 80AB7A54  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AB7A58  3C 60 80 AC */	lis r3, lit_4040@ha /* 0x80AB8F64@ha */
/* 80AB7A5C  C0 03 8F 64 */	lfs f0, lit_4040@l(r3)  /* 0x80AB8F64@l */
...
/* 80AB7A94  4B 68 DC 69 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AB7A98  38 00 00 00 */	li r0, 0
/* 80AB7A9C  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AB7AA0  3C 60 80 AC */	lis r3, lit_4040@ha /* 0x80AB8F64@ha */
/* 80AB7AA4  C0 03 8F 64 */	lfs f0, lit_4040@l(r3)  /* 0x80AB8F64@l */
...
/* 80AB7AD0  4B 68 DC 2D */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AB7AD4  38 00 00 00 */	li r0, 0
/* 80AB7AD8  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AB7ADC  3C 60 80 AC */	lis r3, lit_4040@ha /* 0x80AB8F64@ha */
/* 80AB7AE0  C0 03 8F 64 */	lfs f0, lit_4040@l(r3)  /* 0x80AB8F64@l */
...
/* 80AB7B04  4B 56 2C 0D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80AB7B20  4B 69 3B 29 */	bl step__8daNpcT_cFsiiii
lbl_80AB7B24:
