...
/* 80979154  4B 9E 90 85 */	bl _savegpr_28
/* 80979158  7C 7F 1B 78 */	mr r31, r3
/* 8097915C  3C 80 80 98 */	lis r4, lit_4037@ha /* 0x8097F540@ha */
/* 80979160  3B C4 F5 40 */	addi r30, r4, lit_4037@l /* 0x8097F540@l */
...
/* 809791B0  4B 7E 0A 65 */	bl checkPoint__11PathTrace_cF4cXyzf
...
/* 809791F4  4B 82 69 3D */	bl dKy_getDarktime_minute__Fv
/* 809791F8  7C 7D 1B 78 */	mr r29, r3
/* 809791FC  48 00 00 0C */	b lbl_80979208
lbl_80979200:
/* 80979200  4B 82 68 3D */	bl dKy_getdaytime_minute__Fv
...
/* 80979214  4B 82 68 E1 */	bl dKy_getDarktime_hour__Fv
/* 80979218  48 00 00 08 */	b lbl_80979220
lbl_8097921C:
/* 8097921C  4B 82 67 F5 */	bl dKy_getdaytime_hour__Fv
lbl_80979220:
...
/* 80979274  4B 7E 0B 4D */	bl checkPathEnd__11PathTrace_cF4cXyzf
...
/* 809792DC  4B 7E 0C BD */	bl setNextPoint__11PathTrace_cFR4cXyz
...
lbl_809792F8:
/* 809792F8  3C 60 80 98 */	lis r3, d_a_npc_cdn3__stringBase0@ha /* 0x8097F5AC@ha */
/* 809792FC  38 63 F5 AC */	addi r3, r3, d_a_npc_cdn3__stringBase0@l /* 0x8097F5AC@l */
/* 80979300  4C C6 31 82 */	crclr 6
/* 80979304  4B 68 D9 09 */	bl OSReport_Error
lbl_80979308:
...
/* 80979344  4B 82 67 ED */	bl dKy_getDarktime_minute__Fv
/* 80979348  7C 7D 1B 78 */	mr r29, r3
/* 8097934C  48 00 00 0C */	b lbl_80979358
lbl_80979350:
/* 80979350  4B 82 66 ED */	bl dKy_getdaytime_minute__Fv
...
/* 80979364  4B 82 67 91 */	bl dKy_getDarktime_hour__Fv
/* 80979368  48 00 00 08 */	b lbl_80979370
lbl_8097936C:
/* 8097936C  4B 82 66 A5 */	bl dKy_getdaytime_hour__Fv
lbl_80979370:
...
/* 8097942C  4B 8F 78 11 */	bl cLib_targetAngleY__FRC3VecRC3Vec
...
/* 8097946C  4B 7E 05 CD */	bl setPath__11PathTrace_cFiiiP4cXyzb
...
/* 809794E8  3C A0 80 98 */	lis r5, m_funcTbl__11daNpcCdn3_c@ha /* 0x8097F848@ha */
/* 809794EC  38 A5 F8 48 */	addi r5, r5, m_funcTbl__11daNpcCdn3_c@l /* 0x8097F848@l */
/* 809794F0  7D 85 00 2E */	lwzx r12, r5, r0
/* 809794F4  4B 9E 8B 91 */	bl __ptmf_scall
/* 809794F8  60 00 00 00 */	nop 
lbl_809794FC:
/* 809794FC  38 7F 0A D0 */	addi r3, r31, 0xad0
/* 80979500  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80979504  4B 7E 0A 95 */	bl setNextPoint__11PathTrace_cFR4cXyz
...
/* 80979524  3C A0 80 98 */	lis r5, m_funcTbl__11daNpcCdn3_c@ha /* 0x8097F848@ha */
/* 80979528  38 A5 F8 48 */	addi r5, r5, m_funcTbl__11daNpcCdn3_c@l /* 0x8097F848@l */
...
/* 8097953C  4B 9E 8B 49 */	bl __ptmf_scall
...
/* 80979554  3C 60 80 98 */	lis r3, m_funcTbl__11daNpcCdn3_c@ha /* 0x8097F848@ha */
/* 80979558  38 63 F8 48 */	addi r3, r3, m_funcTbl__11daNpcCdn3_c@l /* 0x8097F848@l */
...
/* 80979570  4B 9E 8A A9 */	bl __ptmf_test
...
/* 809795A4  4B 82 65 8D */	bl dKy_getDarktime_minute__Fv
/* 809795A8  7C 7D 1B 78 */	mr r29, r3
/* 809795AC  48 00 00 0C */	b lbl_809795B8
lbl_809795B0:
/* 809795B0  4B 82 64 8D */	bl dKy_getdaytime_minute__Fv
...
/* 809795C4  4B 82 65 31 */	bl dKy_getDarktime_hour__Fv
/* 809795C8  48 00 00 08 */	b lbl_809795D0
lbl_809795CC:
/* 809795CC  4B 82 64 45 */	bl dKy_getdaytime_hour__Fv
lbl_809795D0:
...
/* 809795FC  4B 7D EA F5 */	bl getAnmP__10daNpcCd2_cFii
...
/* 8097961C  4B 7D F8 E5 */	bl setAnm__10daNpcCd2_cFP18J3DAnmTransformKeyffiii
...
/* 80979640  4B 7E 09 59 */	bl setNextPoint__11PathTrace_cFR4cXyz
...
/* 8097965C  3C A0 80 98 */	lis r5, m_funcTbl__11daNpcCdn3_c@ha /* 0x8097F848@ha */
/* 80979660  38 A5 F8 48 */	addi r5, r5, m_funcTbl__11daNpcCdn3_c@l /* 0x8097F848@l */
...
/* 80979674  4B 9E 8A 11 */	bl __ptmf_scall
...
/* 8097968C  3C 60 80 98 */	lis r3, m_funcTbl__11daNpcCdn3_c@ha /* 0x8097F848@ha */
/* 80979690  38 63 F8 48 */	addi r3, r3, m_funcTbl__11daNpcCdn3_c@l /* 0x8097F848@l */
...
/* 809796A8  4B 9E 89 71 */	bl __ptmf_test
...
/* 809796CC  4B 7D EA 25 */	bl getAnmP__10daNpcCd2_cFii
...
/* 809796EC  4B 7D F8 15 */	bl setAnm__10daNpcCd2_cFP18J3DAnmTransformKeyffiii
...
/* 80979708  4B 7E 08 91 */	bl setNextPoint__11PathTrace_cFR4cXyz
...
/* 80979754  4B 7E 0C 1D */	bl checkObstacle__11PathTrace_cFP10fopAc_ac_c
lbl_80979758:
/* 80979758  38 7F 0A D0 */	addi r3, r31, 0xad0
/* 8097975C  38 81 00 48 */	addi r4, r1, 0x48
/* 80979760  4B 7E 06 F5 */	bl getTargetPoint__11PathTrace_cFP3Vec
/* 80979764  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80979768  38 81 00 48 */	addi r4, r1, 0x48
/* 8097976C  4B 8F 74 99 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80979780  4B 8F 6E 89 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80979798  3C 60 80 98 */	lis r3, __vt__8cM3dGPla@ha /* 0x80980738@ha */
/* 8097979C  38 03 07 38 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80980738@l */
/* 809797A0  90 01 00 64 */	stw r0, 0x64(r1)
/* 809797A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809797A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809797AC  38 63 0F 38 */	addi r3, r3, 0xf38
/* 809797B0  38 9F 07 28 */	addi r4, r31, 0x728
/* 809797B4  38 A1 00 54 */	addi r5, r1, 0x54
/* 809797B8  4B 6F AF 8D */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 809797CC  4B 6A 44 0D */	bl fopAcM_getPolygonAngle__FPC8cM3dGPlas
...
lbl_809797E4:
/* 809797E4  3C 60 80 98 */	lis r3, __vt__8cM3dGPla@ha /* 0x80980738@ha */
/* 809797E8  38 03 07 38 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80980738@l */
...
/* 80979804  4B 9C DB 99 */	bl PSVECSquareDistance
...
/* 80979874  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80979878  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 809798E4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809798E8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_809798EC:
...
/* 8097993C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80979940  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80979944  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80979948  4B 6F D1 65 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 8097994C  7F E3 FB 78 */	mr r3, r31
/* 80979950  4B 7D FE C9 */	bl checkFearSituation__10daNpcCd2_cFv
...
/* 8097999C  4B 9E 88 89 */	bl _restgpr_28
