...
/* 8097CC68  4B 9E 55 71 */	bl _savegpr_28
/* 8097CC6C  7C 7D 1B 78 */	mr r29, r3
/* 8097CC70  3C 60 80 98 */	lis r3, lit_4037@ha /* 0x8097F540@ha */
/* 8097CC74  3B E3 F5 40 */	addi r31, r3, lit_4037@l /* 0x8097F540@l */
...
/* 8097CD28  4B 82 2E 09 */	bl dKy_getDarktime_minute__Fv
/* 8097CD2C  7C 7E 1B 78 */	mr r30, r3
/* 8097CD30  48 00 00 0C */	b lbl_8097CD3C
lbl_8097CD34:
/* 8097CD34  4B 82 2D 09 */	bl dKy_getdaytime_minute__Fv
...
/* 8097CD48  4B 82 2D AD */	bl dKy_getDarktime_hour__Fv
/* 8097CD4C  48 00 00 08 */	b lbl_8097CD54
lbl_8097CD50:
/* 8097CD50  4B 82 2C C1 */	bl dKy_getdaytime_hour__Fv
lbl_8097CD54:
...
/* 8097CDB8  4B 69 D7 91 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 8097CDBC  80 BD 0A 98 */	lwz r5, 0xa98(r29)
/* 8097CDC0  2C 05 00 10 */	cmpwi r5, 0x10
/* 8097CDC4  40 80 00 1C */	bge lbl_8097CDE0
/* 8097CDC8  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097CDCC  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097CDE0:
/* 8097CDE0  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097CDE4  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097CE00  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097CE04  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097CE18:
/* 8097CE18  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097CE1C  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l /* 0x8042861C@l */
/* 8097CE20  1C 05 02 3C */	mulli r0, r5, 0x23c
/* 8097CE24  7C 84 02 14 */	add r4, r4, r0
/* 8097CE28  C0 24 FF 38 */	lfs f1, -0xc8(r4)
lbl_8097CE2C:
/* 8097CE2C  4B 6F 91 2D */	bl SetWall__12dBgS_AcchCirFff
...
/* 8097CE58  4B 6F 93 F1 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 8097CE78  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8097CE7C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8097CE80  3B C4 0F 38 */	addi r30, r4, 0xf38
/* 8097CE84  7F C4 F3 78 */	mr r4, r30
/* 8097CE88  4B 6F 9C 25 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 8097CE8C  7F A3 EB 78 */	mr r3, r29
/* 8097CE90  4B 7D BE F9 */	bl setEnvTevCol__10daNpcCd2_cFv
/* 8097CE94  7F A3 EB 78 */	mr r3, r29
/* 8097CE98  4B 7D BF 4D */	bl setRoomNo__10daNpcCd2_cFv
...
/* 8097CEAC  4B 70 69 B5 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 8097CEC4  3C 80 80 39 */	lis r4, m_cylDat__10daNpcCd2_c@ha /* 0x80393950@ha */
/* 8097CEC8  38 84 39 50 */	addi r4, r4, m_cylDat__10daNpcCd2_c@l /* 0x80393950@l */
/* 8097CECC  4B 70 79 E9 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 8097CEE0  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097CEE4  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097CEF8:
/* 8097CEF8  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097CEFC  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l /* 0x8042861C@l */
/* 8097CF00  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 8097CF04  7C 84 02 14 */	add r4, r4, r0
/* 8097CF08  C0 24 FF 34 */	lfs f1, -0xcc(r4)
lbl_8097CF0C:
/* 8097CF0C  4B 8F 22 F5 */	bl SetR__8cM3dGCylFf
...
/* 8097CF20  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097CF24  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097CF38:
/* 8097CF38  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097CF3C  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l /* 0x8042861C@l */
/* 8097CF40  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 8097CF44  7C 84 02 14 */	add r4, r4, r0
/* 8097CF48  C0 24 FF 30 */	lfs f1, -0xd0(r4)
lbl_8097CF4C:
/* 8097CF4C  4B 8F 22 AD */	bl SetH__8cM3dGCylFf
/* 8097CF50  3B 9E 3E C8 */	addi r28, r30, 0x3ec8
/* 8097CF54  7F 83 E3 78 */	mr r3, r28
/* 8097CF58  3C 80 80 98 */	lis r4, d_a_npc_cdn3__stringBase0@ha /* 0x8097F5AC@ha */
/* 8097CF5C  38 84 F5 AC */	addi r4, r4, d_a_npc_cdn3__stringBase0@l /* 0x8097F5AC@l */
/* 8097CF60  38 84 00 F4 */	addi r4, r4, 0xf4
/* 8097CF64  4B 9E BA 31 */	bl strcmp
/* 8097CF68  2C 03 00 00 */	cmpwi r3, 0
/* 8097CF6C  40 82 00 38 */	bne lbl_8097CFA4
/* 8097CF70  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8097CF74  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8097CFB8  3C 80 80 98 */	lis r4, d_a_npc_cdn3__stringBase0@ha /* 0x8097F5AC@ha */
/* 8097CFBC  38 84 F5 AC */	addi r4, r4, d_a_npc_cdn3__stringBase0@l /* 0x8097F5AC@l */
/* 8097CFC0  38 84 00 9E */	addi r4, r4, 0x9e
/* 8097CFC4  4B 9E B9 D1 */	bl strcmp
/* 8097CFC8  2C 03 00 00 */	cmpwi r3, 0
/* 8097CFCC  40 82 00 18 */	bne lbl_8097CFE4
/* 8097CFD0  38 60 00 00 */	li r3, 0
/* 8097CFD4  4B 6A F9 A9 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 8097D018  4B 7D CA 21 */	bl setPath__11PathTrace_cFiiiP4cXyzb
...
/* 8097D048  4B 69 2B 35 */	bl setMorf__13mDoExt_morf_cFf
...
/* 8097D064  4B 9E 51 C1 */	bl _restgpr_28
