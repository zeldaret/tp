...
/* 8097AC08  4B 9E 75 D5 */	bl _savegpr_29
/* 8097AC0C  7C 7D 1B 78 */	mr r29, r3
/* 8097AC10  3C 60 80 98 */	lis r3, lit_4037@ha /* 0x8097F540@ha */
/* 8097AC14  3B E3 F5 40 */	addi r31, r3, lit_4037@l /* 0x8097F540@l */
...
/* 8097AC3C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097AC40  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097AC54:
/* 8097AC54  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097AC58  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097AC70  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097AC74  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097AC88:
/* 8097AC88  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097AC8C  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097ACAC  4B 8F 5A 95 */	bl cLib_chaseF__FPfff
...
/* 8097ACD8  4B 8F 5A 69 */	bl cLib_chaseF__FPfff
...
/* 8097AD04  4B 8F 5A 3D */	bl cLib_chaseF__FPfff
...
/* 8097AD20  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097AD24  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097AD38:
/* 8097AD38  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097AD3C  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097AD58  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097AD5C  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097AD70:
/* 8097AD70  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097AD74  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097ADAC  4B 8F 59 95 */	bl cLib_chaseF__FPfff
...
/* 8097ADD8  4B 8F 59 69 */	bl cLib_chaseF__FPfff
...
/* 8097AE04  4B 8F 59 3D */	bl cLib_chaseF__FPfff
...
/* 8097AF00  4B 9E 73 29 */	bl _restgpr_29
