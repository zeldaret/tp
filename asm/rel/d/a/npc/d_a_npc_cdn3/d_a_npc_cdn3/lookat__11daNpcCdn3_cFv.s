...
/* 8097D144  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D148  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D15C:
/* 8097D15C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D160  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D17C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D180  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D194:
/* 8097D194  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D198  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D1B4  4B 8E A2 41 */	bl __ct__5csXyzFsss
...
/* 8097D1D4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D1D8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D1EC:
/* 8097D1EC  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D1F0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D20C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D210  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D224:
/* 8097D224  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D228  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D244  4B 8E A1 B1 */	bl __ct__5csXyzFsss
...
/* 8097D264  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D268  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D27C:
/* 8097D27C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D280  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D29C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D2A0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D2B4:
/* 8097D2B4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D2B8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D2D4  4B 8E A1 21 */	bl __ct__5csXyzFsss
...
/* 8097D2F4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D2F8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D30C:
/* 8097D30C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D310  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D32C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D330  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D344:
/* 8097D344  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D348  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D364  4B 8E A0 91 */	bl __ct__5csXyzFsss
...
/* 8097D384  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D388  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D39C:
/* 8097D39C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D3A0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D3BC  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D3C0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D3D4:
/* 8097D3D4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D3D8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D3F4  4B 8E A0 01 */	bl __ct__5csXyzFsss
...
/* 8097D414  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D418  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D42C:
/* 8097D42C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D430  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D44C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D450  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D464:
/* 8097D464  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D468  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D484  4B 8E 9F 71 */	bl __ct__5csXyzFsss
...
/* 8097D498  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 8097D49C  3B C3 0C F4 */	addi r30, r3, Zero__4cXyz@l /* 0x80430CF4@l */
...
/* 8097D4BC  4B 7D AB ED */	bl isM___10daNpcCd2_cFv
...
/* 8097D524  4B 8D 3E E9 */	bl init__16dNpcLib_lookat_cFP8J3DModelPiP5csXyzP5csXyz
/* 8097D528  38 7F 0A F8 */	addi r3, r31, 0xaf8
/* 8097D52C  4B 7C 81 DD */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8097D548  4B 9C 8F 69 */	bl PSMTXCopy
/* 8097D54C  38 7F 0A F8 */	addi r3, r31, 0xaf8
/* 8097D550  4B 7C 81 B9 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8097D580  4B 9C 8F 31 */	bl PSMTXCopy
/* 8097D584  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 8097D588  C0 03 0C F4 */	lfs f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 8097D5D4  4B 7C 81 35 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8097D5F8  4B 8D 3F 3D */	bl action__16dNpcLib_lookat_cF4cXyz4cXyzP10fopAc_ac_cPA4_fi
