...
/* 8097D758  4B 9E 4A 85 */	bl _savegpr_29
...
/* 8097D76C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D770  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D784:
/* 8097D784  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D788  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l /* 0x8042861C@l */
...
/* 8097D7AC  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D7B0  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l /* 0x8042861C@l */
...
lbl_8097D7C4:
/* 8097D7C4  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha /* 0x8042861C@ha */
/* 8097D7C8  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l /* 0x8042861C@l */
/* 8097D7CC  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 8097D7D0  7C 84 02 14 */	add r4, r4, r0
/* 8097D7D4  C0 24 FF 3C */	lfs f1, -0xc4(r4)
lbl_8097D7D8:
/* 8097D7D8  4B 6F 87 69 */	bl SetWallR__12dBgS_AcchCirFf
...
/* 8097D824  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8097D828  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8097D840  4B 69 C4 3D */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_8097D844:
...
/* 8097D86C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8097D870  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8097D874  3B A3 4E 00 */	addi r29, r3, 0x4e00
/* 8097D878  7F A3 EB 78 */	mr r3, r29
/* 8097D87C  3C 80 80 98 */	lis r4, d_a_npc_cdn3__stringBase0@ha /* 0x8097F5AC@ha */
/* 8097D880  38 84 F5 AC */	addi r4, r4, d_a_npc_cdn3__stringBase0@l /* 0x8097F5AC@l */
/* 8097D884  38 84 00 9E */	addi r4, r4, 0x9e
/* 8097D888  4B 9E B1 0D */	bl strcmp
/* 8097D88C  2C 03 00 00 */	cmpwi r3, 0
/* 8097D890  40 82 00 18 */	bne lbl_8097D8A8
/* 8097D894  38 60 00 00 */	li r3, 0
/* 8097D898  4B 6A F0 E5 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 8097D8B4  3C 80 80 98 */	lis r4, d_a_npc_cdn3__stringBase0@ha /* 0x8097F5AC@ha */
/* 8097D8B8  38 84 F5 AC */	addi r4, r4, d_a_npc_cdn3__stringBase0@l /* 0x8097F5AC@l */
/* 8097D8BC  38 84 00 F4 */	addi r4, r4, 0xf4
/* 8097D8C0  4B 9E B0 D5 */	bl strcmp
...
/* 8097D978  4B 7E 1A AD */	bl checkNowWolfEyeUp__9daPy_py_cFv
...
lbl_8097D99C:
/* 8097D99C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8097D9A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8097DA04  4B 7E 1A 21 */	bl checkNowWolfEyeUp__9daPy_py_cFv
...
/* 8097DA4C  3C 80 80 98 */	lis r4, lit_5944@ha /* 0x8097F5A0@ha */
/* 8097DA50  C0 44 F5 A0 */	lfs f2, lit_5944@l(r4)  /* 0x8097F5A0@l */
/* 8097DA54  3C 80 80 98 */	lis r4, lit_5945@ha /* 0x8097F5A4@ha */
/* 8097DA58  C0 64 F5 A4 */	lfs f3, lit_5945@l(r4)  /* 0x8097F5A4@l */
/* 8097DA5C  4B 8F 1F E1 */	bl cLib_addCalc2__FPffff
/* 8097DA60  7F E3 FB 78 */	mr r3, r31
/* 8097DA64  38 80 FF FF */	li r4, -1
/* 8097DA68  4B 7D B3 C1 */	bl animation__10daNpcCd2_cFi
/* 8097DA6C  38 7F 09 B0 */	addi r3, r31, 0x9b0
/* 8097DA70  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 8097DA74  4B 8F 17 69 */	bl SetC__8cM3dGCylFRC4cXyz
/* 8097DA78  80 1F 04 A0 */	lwz r0, 0x4a0(r31)
/* 8097DA7C  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
/* 8097DA80  40 82 00 18 */	bne lbl_8097DA98
/* 8097DA84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8097DA88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8097DA8C  38 63 23 3C */	addi r3, r3, 0x233c
/* 8097DA90  38 9F 08 8C */	addi r4, r31, 0x88c
/* 8097DA94  4B 8E 71 15 */	bl Set__4cCcSFP8cCcD_Obj
lbl_8097DA98:
...
/* 8097DAA8  4B 9E 47 81 */	bl _restgpr_29
