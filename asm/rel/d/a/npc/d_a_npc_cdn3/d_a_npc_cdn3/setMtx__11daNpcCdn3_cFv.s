...
/* 8097D08C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8097D090  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8097D094  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 8097D098  C0 5F 0B 64 */	lfs f2, 0xb64(r31)
/* 8097D09C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 8097D0A0  4B 9C 98 49 */	bl PSMTXTrans
/* 8097D0A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8097D0A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8097D0AC  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8097D0B0  4B 68 F3 85 */	bl mDoMtx_YrotM__FPA4_fs
/* 8097D0B4  80 7F 05 8C */	lwz r3, 0x58c(r31)
/* 8097D0B8  80 83 00 04 */	lwz r4, 4(r3)
/* 8097D0BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8097D0C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8097D0C4  38 84 00 24 */	addi r4, r4, 0x24
/* 8097D0C8  4B 9C 93 E9 */	bl PSMTXCopy
/* 8097D0CC  38 00 00 00 */	li r0, 0
/* 8097D0D0  90 1F 0A 9C */	stw r0, 0xa9c(r31)
/* 8097D0D4  80 7F 05 8C */	lwz r3, 0x58c(r31)
/* 8097D0D8  4B 69 41 15 */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 8097D0DC  7F E3 FB 78 */	mr r3, r31
/* 8097D0E0  80 9F 0A 98 */	lwz r4, 0xa98(r31)
/* 8097D0E4  4B 7D B3 3D */	bl setAttention__10daNpcCd2_cFi
...
/* 8097D0FC  4B 69 40 F1 */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 8097D100  7F E3 FB 78 */	mr r3, r31
/* 8097D104  80 9F 0A 98 */	lwz r4, 0xa98(r31)
/* 8097D108  4B 7D B3 19 */	bl setAttention__10daNpcCd2_cFi
