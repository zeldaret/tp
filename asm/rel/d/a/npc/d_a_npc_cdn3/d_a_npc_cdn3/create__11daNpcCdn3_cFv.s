...
/* 8097C920  4B 9E 58 B9 */	bl _savegpr_28
...
/* 8097C944  4B 69 C2 21 */	bl __ct__10fopAc_ac_cFv
/* 8097C948  3C 60 80 98 */	lis r3, __vt__10daNpcCd2_c@ha /* 0x8098072C@ha */
/* 8097C94C  38 03 07 2C */	addi r0, r3, __vt__10daNpcCd2_c@l /* 0x8098072C@l */
/* 8097C950  90 1E 05 68 */	stw r0, 0x568(r30)
/* 8097C954  38 7E 05 94 */	addi r3, r30, 0x594
/* 8097C958  4B 94 42 B9 */	bl __ct__17Z2CreatureCitizenFv
/* 8097C95C  3B 9E 06 38 */	addi r28, r30, 0x638
/* 8097C960  7F 83 E3 78 */	mr r3, r28
/* 8097C964  4B 6F 97 3D */	bl __ct__9dBgS_AcchFv
/* 8097C968  3C 60 80 98 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80980708@ha */
/* 8097C96C  38 63 07 08 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80980708@l */
...
/* 8097C988  4B 6F C4 E1 */	bl SetObj__16dBgS_PolyPassChkFv
/* 8097C98C  38 7E 08 10 */	addi r3, r30, 0x810
/* 8097C990  4B 6F 95 1D */	bl __ct__12dBgS_AcchCirFv
/* 8097C994  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 8097C998  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 8097C99C  90 1E 08 68 */	stw r0, 0x868(r30)
/* 8097C9A0  38 7E 08 6C */	addi r3, r30, 0x86c
/* 8097C9A4  4B 70 6D BD */	bl __ct__10dCcD_GSttsFv
/* 8097C9A8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 8097C9AC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 8097C9C4  4B 70 70 65 */	bl __ct__12dCcD_GObjInfFv
/* 8097C9C8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8097C9CC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8097C9D0  90 1C 01 20 */	stw r0, 0x120(r28)
/* 8097C9D4  3C 60 80 98 */	lis r3, __vt__8cM3dGAab@ha /* 0x809806FC@ha */
/* 8097C9D8  38 03 06 FC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809806FC@l */
/* 8097C9DC  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 8097C9E0  3C 60 80 98 */	lis r3, __vt__8cM3dGCyl@ha /* 0x809806F0@ha */
/* 8097C9E4  38 03 06 F0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x809806F0@l */
/* 8097C9E8  90 1C 01 38 */	stw r0, 0x138(r28)
/* 8097C9EC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 8097C9F0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 8097C9F4  90 7C 01 20 */	stw r3, 0x120(r28)
/* 8097C9F8  38 03 00 58 */	addi r0, r3, 0x58
/* 8097C9FC  90 1C 01 38 */	stw r0, 0x138(r28)
/* 8097CA00  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 8097CA04  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 8097CA20  4B 8D 48 F5 */	bl __ct__16dNpcLib_lookat_cFv
/* 8097CA24  3C 60 80 98 */	lis r3, __vt__11daNpcCdn3_c@ha /* 0x809806E4@ha */
/* 8097CA28  38 03 06 E4 */	addi r0, r3, __vt__11daNpcCdn3_c@l /* 0x809806E4@l */
/* 8097CA2C  90 1D 05 68 */	stw r0, 0x568(r29)
/* 8097CA30  3C 60 80 98 */	lis r3, __vt__18daNpcT_ActorMngr_c@ha /* 0x809806D8@ha */
/* 8097CA34  38 03 06 D8 */	addi r0, r3, __vt__18daNpcT_ActorMngr_c@l /* 0x809806D8@l */
/* 8097CA38  90 1D 0A FC */	stw r0, 0xafc(r29)
/* 8097CA3C  38 7D 0A F8 */	addi r3, r29, 0xaf8
/* 8097CA40  4B 7C 8C 95 */	bl initialize__18daNpcT_ActorMngr_cFv
/* 8097CA44  38 7D 0B 00 */	addi r3, r29, 0xb00
/* 8097CA48  4B 8C D4 B9 */	bl __ct__10dMsgFlow_cFv
lbl_8097CA4C:
/* 8097CA4C  80 1F 04 A0 */	lwz r0, 0x4a0(r31)
/* 8097CA50  60 00 00 08 */	ori r0, r0, 8
/* 8097CA54  90 1F 04 A0 */	stw r0, 0x4a0(r31)
lbl_8097CA58:
/* 8097CA58  4B 82 FB 25 */	bl dKy_darkworld_check__Fv
...
/* 8097CA78  4B 7D B6 31 */	bl isM___10daNpcCd2_cFv
...
/* 8097CA8C  3C 60 80 98 */	lis r3, lit_5487@ha /* 0x80980638@ha */
/* 8097CA90  38 63 06 38 */	addi r3, r3, lit_5487@l /* 0x80980638@l */
...
lbl_8097CAE8:
/* 8097CAE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8097CAEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8097CAF0  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 8097CAF4  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 8097CAF8  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 8097CAFC  A0 84 02 32 */	lhz r4, 0x232(r4)
/* 8097CB00  4B 6B 7E BD */	bl isEventBit__11dSv_event_cCFUs
...
/* 8097CB24  3C 60 80 98 */	lis r3, lit_5488@ha /* 0x80980618@ha */
/* 8097CB28  38 63 06 18 */	addi r3, r3, lit_5488@l /* 0x80980618@l */
...
lbl_8097CB80:
/* 8097CB80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8097CB84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8097CB88  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 8097CB8C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 8097CB90  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 8097CB94  A0 84 02 32 */	lhz r4, 0x232(r4)
/* 8097CB98  4B 6B 7E 25 */	bl isEventBit__11dSv_event_cCFUs
...
lbl_8097CBDC:
/* 8097CBDC  3C 60 80 98 */	lis r3, d_a_npc_cdn3__stringBase0@ha /* 0x8097F5AC@ha */
/* 8097CBE0  38 63 F5 AC */	addi r3, r3, d_a_npc_cdn3__stringBase0@l /* 0x8097F5AC@l */
/* 8097CBE4  38 63 00 A6 */	addi r3, r3, 0xa6
/* 8097CBE8  4C C6 31 82 */	crclr 6
/* 8097CBEC  4B 68 A0 21 */	bl OSReport_Error
lbl_8097CBF0:
/* 8097CBF0  7F E3 FB 78 */	mr r3, r31
/* 8097CBF4  80 9F 0A 98 */	lwz r4, 0xa98(r31)
/* 8097CBF8  80 BF 0B 58 */	lwz r5, 0xb58(r31)
/* 8097CBFC  4B 7D BF BD */	bl loadResrc__10daNpcCd2_cFii
...
/* 8097CC10  3C 80 80 98 */	lis r4, createHeapCallBack__FP10fopAc_ac_c@ha /* 0x80978CD8@ha */
/* 8097CC14  38 84 8C D8 */	addi r4, r4, createHeapCallBack__FP10fopAc_ac_c@l /* 0x80978CD8@l */
/* 8097CC18  3C A0 80 00 */	lis r5, 0x8000 /* 0x80002890@ha */
/* 8097CC1C  38 A5 28 90 */	addi r5, r5, 0x2890 /* 0x80002890@l */
/* 8097CC20  4B 69 D8 91 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8097CC44  4B 9E 55 E1 */	bl _restgpr_28
