...
/* 809D69FC  4B 98 B7 E1 */	bl _savegpr_29
/* 809D6A00  7C 7F 1B 78 */	mr r31, r3
/* 809D6A04  7C 80 23 78 */	mr r0, r4
/* 809D6A08  FF E0 08 90 */	fmr f31, f1
/* 809D6A0C  7C BD 2B 78 */	mr r29, r5
/* 809D6A10  3C 60 80 9D */	lis r3, m__17daNpc_grM_Param_c@ha /* 0x809D6D70@ha */
/* 809D6A14  3B C3 6D 70 */	addi r30, r3, m__17daNpc_grM_Param_c@l /* 0x809D6D70@l */
...
/* 809D6A30  4B 89 01 05 */	bl __mi__4cXyzCFRC3Vec
...
/* 809D6A60  4B 97 06 D9 */	bl PSVECSquareMag
...
/* 809D6AD0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809D6AD4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 809D6B40  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809D6B44  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 809D6B48  48 00 00 08 */	b lbl_809D6B50
lbl_809D6B4C:
/* 809D6B4C  FC 40 08 90 */	fmr f2, f1
lbl_809D6B50:
/* 809D6B50  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 809D6B54  4B 89 0B 21 */	bl cM_atan2s__Fff
...
/* 809D6BD8  4B 98 B6 51 */	bl _restgpr_29
