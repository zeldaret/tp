...
/* 809D408C  3C 80 80 9D */	lis r4, __vt__11daNpc_grM_c@ha
/* 809D4090  38 04 72 10 */	addi r0, r4, __vt__11daNpc_grM_c@l
/* 809D4094  90 1E 0E 3C */	stw r0, 0xe3c(r30)
/* 809D4098  4B 7C 64 CC */	b deleteObject__13dShopSystem_cFv
...
/* 809D40AC  4B 63 D2 64 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_809D40B0:
/* 809D40B0  7F C3 F3 78 */	mr r3, r30
/* 809D40B4  88 1E 10 BC */	lbz r0, 0x10bc(r30)
/* 809D40B8  54 00 10 3A */	slwi r0, r0, 2
/* 809D40BC  3C 80 80 9D */	lis r4, l_loadResPtrnList@ha
/* 809D40C0  38 84 6E E4 */	addi r4, r4, l_loadResPtrnList@l
/* 809D40C4  7C 84 00 2E */	lwzx r4, r4, r0
/* 809D40C8  3C A0 80 9D */	lis r5, l_resNameList@ha
/* 809D40CC  38 A5 6E D4 */	addi r5, r5, l_resNameList@l
/* 809D40D0  4B 77 43 DC */	b deleteRes__8daNpcT_cFPCScPPCc
/* 809D40D4  34 1E 0F 80 */	addic. r0, r30, 0xf80
/* 809D40D8  41 82 00 84 */	beq lbl_809D415C
/* 809D40DC  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 809D40E0  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 809D4100  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 809D4104  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
