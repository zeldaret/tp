...
/* 809D4960  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809D4964  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809D4968  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 809D496C  7C 00 00 D0 */	neg r0, r0
/* 809D4970  7C 04 07 34 */	extsh r4, r0
/* 809D4974  4B 63 7A C1 */	bl mDoMtx_YrotM__FPA4_fs
/* 809D4978  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 809D497C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809D4980  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809D4984  4B 63 7B 49 */	bl mDoMtx_ZrotM__FPA4_fs
/* 809D4988  48 00 00 34 */	b lbl_809D49BC
lbl_809D498C:
/* 809D498C  2C 04 00 04 */	cmpwi r4, 4
/* 809D4990  40 82 00 2C */	bne lbl_809D49BC
/* 809D4994  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809D4998  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809D499C  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 809D49A0  7C 00 00 D0 */	neg r0, r0
/* 809D49A4  7C 04 07 34 */	extsh r4, r0
/* 809D49A8  4B 63 7A 8D */	bl mDoMtx_YrotM__FPA4_fs
/* 809D49AC  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 809D49B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809D49B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809D49B8  4B 63 7B 15 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_809D49BC:
