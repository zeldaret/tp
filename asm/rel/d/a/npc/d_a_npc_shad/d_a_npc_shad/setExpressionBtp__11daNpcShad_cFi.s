...
/* 80AD975C  4B 88 8A 81 */	bl _savegpr_29
/* 80AD9760  7C 7E 1B 78 */	mr r30, r3
/* 80AD9764  7C 9F 23 78 */	mr r31, r4
/* 80AD9768  1F BF 00 0C */	mulli r29, r31, 0xc
/* 80AD976C  3C 80 80 AE */	lis r4, l_btpGetParamList@ha /* 0x80AE27F0@ha */
/* 80AD9770  38 A4 27 F0 */	addi r5, r4, l_btpGetParamList@l /* 0x80AE27F0@l */
/* 80AD9774  7C 85 EA 14 */	add r4, r5, r29
/* 80AD9778  80 04 00 08 */	lwz r0, 8(r4)
/* 80AD977C  54 00 10 3A */	slwi r0, r0, 2
/* 80AD9780  3C 80 80 AE */	lis r4, l_arcNames@ha /* 0x80AE28E0@ha */
/* 80AD9784  38 84 28 E0 */	addi r4, r4, l_arcNames@l /* 0x80AE28E0@l */
/* 80AD9788  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AD978C  7C A5 E8 2E */	lwzx r5, r5, r29
/* 80AD9790  4B 67 93 D9 */	bl getTexPtrnAnmP__8daNpcF_cFPci
/* 80AD9794  7C 64 1B 79 */	or. r4, r3, r3
/* 80AD9798  3C 60 80 AE */	lis r3, l_btpGetParamList@ha /* 0x80AE27F0@ha */
/* 80AD979C  38 03 27 F0 */	addi r0, r3, l_btpGetParamList@l /* 0x80AE27F0@l */
...
/* 80AD97D4  3C E0 80 AE */	lis r7, lit_4497@ha /* 0x80AE2068@ha */
/* 80AD97D8  C0 27 20 68 */	lfs f1, lit_4497@l(r7)  /* 0x80AE2068@l */
/* 80AD97DC  4B 67 94 E9 */	bl setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 80AD9818  4B 88 8A 11 */	bl _restgpr_29
