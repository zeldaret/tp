...
/* 80AD9290  4B 88 8F 49 */	bl _savegpr_28
...
/* 80AD92A4  3C 60 80 AE */	lis r3, lit_4591@ha /* 0x80AE2070@ha */
/* 80AD92A8  38 83 20 70 */	addi r4, r3, lit_4591@l /* 0x80AE2070@l */
...
/* 80AD92E0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD92E4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD92E8  4B 86 D1 C9 */	bl PSMTXCopy
/* 80AD92EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD92F0  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80AD9324  4B 86 D1 8D */	bl PSMTXCopy
...
/* 80AD9354  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD9358  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD935C  4B 86 D1 55 */	bl PSMTXCopy
...
/* 80AD9388  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD938C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD9390  4B 86 D1 21 */	bl PSMTXCopy
...
/* 80AD93BC  3C C0 80 AE */	lis r6, m__17daNpcShad_Param_c@ha /* 0x80AE1FDC@ha */
/* 80AD93C0  38 C6 1F DC */	addi r6, r6, m__17daNpcShad_Param_c@l /* 0x80AE1FDC@l */
/* 80AD93C4  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80AD93C8  4B 67 9F B5 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80AD93CC:
/* 80AD93CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD93D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD93D4  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80AD93D8  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80AD93DC  7C 80 E2 14 */	add r4, r0, r28
/* 80AD93E0  4B 86 D0 D1 */	bl PSMTXCopy
/* 80AD93E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD93E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD93EC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80AD93F0  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80AD93F4  4B 86 D0 BD */	bl PSMTXCopy
...
/* 80AD9424  4B 53 45 6D */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80AD9438  4B 88 8D ED */	bl _restgpr_28
