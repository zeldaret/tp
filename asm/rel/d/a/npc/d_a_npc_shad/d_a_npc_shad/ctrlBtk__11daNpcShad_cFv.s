...
/* 80AE0EF0  3C 80 80 AE */	lis r4, l_btkGetParamList@ha /* 0x80AE2874@ha */
/* 80AE0EF4  38 A4 28 74 */	addi r5, r4, l_btkGetParamList@l /* 0x80AE2874@l */
/* 80AE0EF8  80 05 00 08 */	lwz r0, 8(r5)
/* 80AE0EFC  54 00 10 3A */	slwi r0, r0, 2
/* 80AE0F00  3C 80 80 AE */	lis r4, l_arcNames@ha /* 0x80AE28E0@ha */
/* 80AE0F04  38 84 28 E0 */	addi r4, r4, l_arcNames@l /* 0x80AE28E0@l */
/* 80AE0F08  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AE0F0C  80 A5 00 00 */	lwz r5, 0(r5)
/* 80AE0F10  4B 67 1C 95 */	bl getTexSRTKeyAnmP__8daNpcF_cFPci
/* 80AE0F14  80 1F 05 B4 */	lwz r0, 0x5b4(r31)
/* 80AE0F18  7C 03 00 40 */	cmplw r3, r0
/* 80AE0F1C  40 82 00 6C */	bne lbl_80AE0F88
/* 80AE0F20  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80AE0F24  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80AE0F28  A8 9F 08 FE */	lha r4, 0x8fe(r31)
/* 80AE0F2C  48 00 06 19 */	bl func_80AE1544
/* 80AE0F30  3C 60 80 AE */	lis r3, lit_5210@ha /* 0x80AE2418@ha */
/* 80AE0F34  C0 43 24 18 */	lfs f2, lit_5210@l(r3)  /* 0x80AE2418@l */
/* 80AE0F38  3C 60 80 AE */	lis r3, lit_6995@ha /* 0x80AE24B0@ha */
/* 80AE0F3C  C0 03 24 B0 */	lfs f0, lit_6995@l(r3)  /* 0x80AE24B0@l */
...
/* 80AE0F50  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80AE0F54  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80AE0F58  A8 9F 08 FC */	lha r4, 0x8fc(r31)
/* 80AE0F5C  48 00 05 E9 */	bl func_80AE1544
/* 80AE0F60  3C 60 80 AE */	lis r3, lit_6995@ha /* 0x80AE24B0@ha */
/* 80AE0F64  C0 03 24 B0 */	lfs f0, lit_6995@l(r3)  /* 0x80AE24B0@l */
