...
/* 80ADC810  4B 88 59 C5 */	bl _savegpr_27
/* 80ADC814  7C 7D 1B 78 */	mr r29, r3
/* 80ADC818  7C 9B 23 78 */	mr r27, r4
/* 80ADC81C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ADC820  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80ADC824  3B 9E 4F F8 */	addi r28, r30, 0x4ff8
/* 80ADC828  7F 83 E3 78 */	mr r3, r28
/* 80ADC82C  3C A0 80 AE */	lis r5, d_a_npc_shad__stringBase0@ha /* 0x80AE24C4@ha */
/* 80ADC830  38 A5 24 C4 */	addi r5, r5, d_a_npc_shad__stringBase0@l /* 0x80AE24C4@l */
/* 80ADC834  38 A5 01 4E */	addi r5, r5, 0x14e
/* 80ADC838  38 C0 00 03 */	li r6, 3
/* 80ADC83C  4B 56 B8 B1 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80ADC858  4B 56 B4 F5 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80ADC888  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADC88C  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADC8A8  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADC8AC  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADC908  4B 67 6E 11 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80ADC91C  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADC920  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADC93C  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADC940  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADC9A4  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADC9A8  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADC9C8  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADC9CC  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADC9EC  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADC9F0  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADCA10  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADCA14  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADCA34  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADCA38  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADCA6C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ADCA70  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80ADCA74  80 84 4F 94 */	lwz r4, 0x4f94(r4)
/* 80ADCA78  4B 56 68 75 */	bl convPId__14dEvt_control_cFUi
...
/* 80ADCAC4  4B 88 57 5D */	bl _restgpr_27
