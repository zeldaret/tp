...
/* 80ADFB80  4B 88 26 55 */	bl _savegpr_27
/* 80ADFB84  7C 7D 1B 78 */	mr r29, r3
/* 80ADFB88  7C 9B 23 78 */	mr r27, r4
/* 80ADFB8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ADFB90  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80ADFB94  3B 9E 4F F8 */	addi r28, r30, 0x4ff8
/* 80ADFB98  3C 60 80 AE */	lis r3, lit_6782@ha /* 0x80AE24A0@ha */
/* 80ADFB9C  38 83 24 A0 */	addi r4, r3, lit_6782@l /* 0x80AE24A0@l */
...
/* 80ADFC28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ADFC2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80ADFC74  4B 67 40 A9 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
lbl_80ADFC78:
...
/* 80ADFC90  4B 67 3A 89 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80ADFCA4  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADFCA8  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADFCC4  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADFCC8  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADFD2C  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADFD30  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADFD50  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADFD54  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADFD74  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADFD78  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADFD98  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADFD9C  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADFDBC  3C A0 80 AE */	lis r5, lit_5210@ha /* 0x80AE2418@ha */
/* 80ADFDC0  C0 25 24 18 */	lfs f1, lit_5210@l(r5)  /* 0x80AE2418@l */
...
/* 80ADFDFC  4B 67 3F 89 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80ADFE14  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ADFE18  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80ADFE1C  80 84 4F 94 */	lwz r4, 0x4f94(r4)
/* 80ADFE20  4B 56 34 CD */	bl convPId__14dEvt_control_cFUi
/* 80ADFE24  7C 03 E8 40 */	cmplw r3, r29
/* 80ADFE28  40 82 00 0C */	bne lbl_80ADFE34
/* 80ADFE2C  38 7D 0C 90 */	addi r3, r29, 0xc90
/* 80ADFE30  4B 67 08 BD */	bl getActorP__18daNpcF_ActorMngr_cFv
lbl_80ADFE34:
...
/* 80ADFE60  4B 88 23 C1 */	bl _restgpr_27
