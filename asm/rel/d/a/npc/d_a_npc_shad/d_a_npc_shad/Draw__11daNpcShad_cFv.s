...
/* 80AD9184  3C C0 80 AE */	lis r6, m__17daNpcShad_Param_c@ha /* 0x80AE1FDC@ha */
/* 80AD9188  38 C6 1F DC */	addi r6, r6, m__17daNpcShad_Param_c@l /* 0x80AE1FDC@l */
/* 80AD918C  C0 26 00 0C */	lfs f1, 0xc(r6)
/* 80AD9190  38 C0 00 00 */	li r6, 0
/* 80AD9194  38 E0 00 00 */	li r7, 0
/* 80AD9198  4B 67 91 15 */	bl draw__8daNpcF_cFiifP11_GXColorS10i
/* 80AD919C  80 9F 0B 48 */	lwz r4, 0xb48(r31)
/* 80AD91A0  28 04 00 00 */	cmplwi r4, 0
/* 80AD91A4  41 82 00 54 */	beq lbl_80AD91F8
/* 80AD91A8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80AD91AC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80AD91B0  80 84 00 04 */	lwz r4, 4(r4)
/* 80AD91B4  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80AD91B8  4B 6C BB E9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80AD91D0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD91D4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD91D8  4B 86 D2 D9 */	bl PSMTXCopy
/* 80AD91DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD91E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD91E4  80 9F 0B 48 */	lwz r4, 0xb48(r31)
/* 80AD91E8  38 84 00 24 */	addi r4, r4, 0x24
/* 80AD91EC  4B 86 D2 C5 */	bl PSMTXCopy
/* 80AD91F0  80 7F 0B 48 */	lwz r3, 0xb48(r31)
/* 80AD91F4  4B 53 4A D1 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80AD91F8:
...
lbl_80AD9218:
/* 80AD9218  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80AD921C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80AD9220  80 84 00 04 */	lwz r4, 4(r4)
/* 80AD9224  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80AD9228  4B 6C BB 79 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80AD9240  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD9244  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD9248  4B 86 D2 69 */	bl PSMTXCopy
/* 80AD924C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AD9250  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AD9254  80 9F 0B 4C */	lwz r4, 0xb4c(r31)
/* 80AD9258  38 84 00 24 */	addi r4, r4, 0x24
/* 80AD925C  4B 86 D2 55 */	bl PSMTXCopy
/* 80AD9260  80 7F 0B 4C */	lwz r3, 0xb4c(r31)
/* 80AD9264  4B 53 4A 61 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80AD9268:
