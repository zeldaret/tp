...
/* 80B0FDFC  3C 80 80 B1 */	lis r4, m__16daNpcTkc_Param_c@ha /* 0x80B108B4@ha */
/* 80B0FE00  3B E4 08 B4 */	addi r31, r4, m__16daNpcTkc_Param_c@l /* 0x80B108B4@l */
...
lbl_80B0FE38:
/* 80B0FE38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B0FE3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80B0FE50  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80B0FE54  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80B0FE58  38 81 00 08 */	addi r4, r1, 8
/* 80B0FE5C  4B 50 99 9D */	bl fopAcIt_Judge__FPFPvPv_PvPv
lbl_80B0FE60:
...
/* 80B0FEAC  4B 76 0D 59 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80B0FEC8  4B 76 07 41 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80B0FEF4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B0FEF8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B0FEFC  4B 83 65 B5 */	bl PSMTXCopy
/* 80B0FF00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B0FF04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B0FF28  4B 83 6E 45 */	bl PSMTXMultVec
...
/* 80B0FF70  4B 75 F6 D9 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80B0FF74  3C 60 80 B1 */	lis r3, lit_4487@ha /* 0x80B10B38@ha */
/* 80B0FF78  38 83 0B 38 */	addi r4, r3, lit_4487@l /* 0x80B10B38@l */
...
/* 80B0FF9C  4B 85 20 AD */	bl __ptmf_cmpr
/* 80B0FFA0  2C 03 00 00 */	cmpwi r3, 0
/* 80B0FFA4  41 82 00 18 */	beq lbl_80B0FFBC
/* 80B0FFA8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B0FFAC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B0FFB0  38 63 23 3C */	addi r3, r3, 0x233c
/* 80B0FFB4  38 9E 0B E8 */	addi r4, r30, 0xbe8
/* 80B0FFB8  4B 75 4B F1 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80B0FFBC:
