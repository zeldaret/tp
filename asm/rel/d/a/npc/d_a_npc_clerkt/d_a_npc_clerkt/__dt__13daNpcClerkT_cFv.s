...
/* 8099A16C  3C 80 80 9A */	lis r4, __vt__13daNpcClerkT_c@ha
/* 8099A170  38 04 D5 6C */	addi r0, r4, __vt__13daNpcClerkT_c@l
/* 8099A174  90 1E 0E 3C */	stw r0, 0xe3c(r30)
/* 8099A178  4B 80 03 EC */	b deleteObject__13dShopSystem_cFv
...
/* 8099A18C  4B 67 71 84 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_8099A190:
/* 8099A190  7F C3 F3 78 */	mr r3, r30
/* 8099A194  88 1E 10 BC */	lbz r0, 0x10bc(r30)
/* 8099A198  54 00 10 3A */	slwi r0, r0, 2
/* 8099A19C  3C 80 80 9A */	lis r4, l_loadResPtrnList@ha
/* 8099A1A0  38 84 D3 9C */	addi r4, r4, l_loadResPtrnList@l
/* 8099A1A4  7C 84 00 2E */	lwzx r4, r4, r0
/* 8099A1A8  3C A0 80 9A */	lis r5, l_resNameList@ha
/* 8099A1AC  38 A5 D3 90 */	addi r5, r5, l_resNameList@l
/* 8099A1B0  4B 7A E2 FC */	b deleteRes__8daNpcT_cFPCScPPCc
/* 8099A1B4  38 7E 10 C0 */	addi r3, r30, 0x10c0
/* 8099A1B8  3C 80 80 9A */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha
/* 8099A1BC  38 84 C2 D4 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l
/* 8099A1C0  38 A0 00 08 */	li r5, 8
/* 8099A1C4  38 C0 00 01 */	li r6, 1
/* 8099A1C8  4B 9C 7B 20 */	b __destroy_arr
/* 8099A1CC  34 1E 0F 80 */	addic. r0, r30, 0xf80
/* 8099A1D0  41 82 00 84 */	beq lbl_8099A254
/* 8099A1D4  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 8099A1D8  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 8099A1F8  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 8099A1FC  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
