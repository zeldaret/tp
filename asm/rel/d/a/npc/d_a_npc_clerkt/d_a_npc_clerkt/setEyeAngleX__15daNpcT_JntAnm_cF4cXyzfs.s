...
/* 8099CC68  4B 9C 55 75 */	bl _savegpr_29
/* 8099CC6C  7C 7F 1B 78 */	mr r31, r3
/* 8099CC70  7C 80 23 78 */	mr r0, r4
/* 8099CC74  FF E0 08 90 */	fmr f31, f1
/* 8099CC78  7C BD 2B 78 */	mr r29, r5
/* 8099CC7C  3C 60 80 9A */	lis r3, m__19daNpcClerkt_Param_c@ha /* 0x8099D244@ha */
/* 8099CC80  3B C3 D2 44 */	addi r30, r3, m__19daNpcClerkt_Param_c@l /* 0x8099D244@l */
...
/* 8099CC9C  4B 8C 9E 99 */	bl __mi__4cXyzCFRC3Vec
...
/* 8099CCCC  4B 9A A4 6D */	bl PSVECSquareMag
...
/* 8099CD3C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8099CD40  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8099CDAC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8099CDB0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 8099CDB4  48 00 00 08 */	b lbl_8099CDBC
lbl_8099CDB8:
/* 8099CDB8  FC 40 08 90 */	fmr f2, f1
lbl_8099CDBC:
/* 8099CDBC  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 8099CDC0  4B 8C A8 B5 */	bl cM_atan2s__Fff
...
/* 8099CE44  4B 9C 53 E5 */	bl _restgpr_29
