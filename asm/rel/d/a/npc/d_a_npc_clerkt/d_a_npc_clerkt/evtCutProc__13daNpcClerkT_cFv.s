...
/* 8099AF28  4B 9C 72 B5 */	bl _savegpr_29
/* 8099AF2C  7C 7D 1B 78 */	mr r29, r3
/* 8099AF30  3B C0 00 00 */	li r30, 0
/* 8099AF34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8099AF38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8099AF3C  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 8099AF40  7F E3 FB 78 */	mr r3, r31
/* 8099AF44  3C 80 80 9A */	lis r4, d_a_npc_clerkt__stringBase0@ha /* 0x8099D33C@ha */
/* 8099AF48  38 84 D3 3C */	addi r4, r4, d_a_npc_clerkt__stringBase0@l /* 0x8099D33C@l */
/* 8099AF4C  38 84 00 15 */	addi r4, r4, 0x15
/* 8099AF50  7F A5 EB 78 */	mr r5, r29
/* 8099AF54  38 C0 FF FF */	li r6, -1
/* 8099AF58  4B 6A CB C5 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 8099AF70  3C A0 80 9A */	lis r5, mCutNameList__13daNpcClerkT_c@ha /* 0x8099D428@ha */
/* 8099AF74  38 A5 D4 28 */	addi r5, r5, mCutNameList__13daNpcClerkT_c@l /* 0x8099D428@l */
/* 8099AF78  38 C0 00 01 */	li r6, 1
/* 8099AF7C  38 E0 00 00 */	li r7, 0
/* 8099AF80  39 00 00 00 */	li r8, 0
/* 8099AF84  4B 6A CE 8D */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 8099AF98  3C A0 80 9A */	lis r5, mCutList__13daNpcClerkT_c@ha /* 0x8099D42C@ha */
/* 8099AF9C  38 05 D4 2C */	addi r0, r5, mCutList__13daNpcClerkT_c@l /* 0x8099D42C@l */
/* 8099AFA0  7D 80 32 14 */	add r12, r0, r6
/* 8099AFA4  4B 9C 70 E1 */	bl __ptmf_scall
