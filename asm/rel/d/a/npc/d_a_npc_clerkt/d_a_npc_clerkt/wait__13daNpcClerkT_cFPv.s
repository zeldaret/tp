...
/* 8099B2DC  4B 7A A5 BD */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8099B2E0  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 8099B2E4  38 00 00 01 */	li r0, 1
/* 8099B2E8  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 8099B2EC  3C 60 80 9A */	lis r3, lit_4829@ha /* 0x8099D308@ha */
/* 8099B2F0  C0 03 D3 08 */	lfs f0, lit_4829@l(r3)  /* 0x8099D308@l */
...
/* 8099B30C  4B 7A A5 8D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8099B310  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 8099B314  38 00 00 00 */	li r0, 0
/* 8099B318  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 8099B31C  3C 60 80 9A */	lis r3, lit_4829@ha /* 0x8099D308@ha */
/* 8099B320  C0 03 D3 08 */	lfs f0, lit_4829@l(r3)  /* 0x8099D308@l */
...
/* 8099B340  4B 7A A3 C9 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8099B35C  4B 7A A3 A1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8099B360  38 00 00 00 */	li r0, 0
/* 8099B364  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 8099B368  3C 60 80 9A */	lis r3, lit_4123@ha /* 0x8099D2F0@ha */
/* 8099B36C  C0 03 D2 F0 */	lfs f0, lit_4123@l(r3)  /* 0x8099D2F0@l */
...
/* 8099B388  4B 7A A3 81 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8099B39C  4B 7A F8 35 */	bl chkActorInSight__8daNpcT_cFP10fopAc_ac_cfs
...
/* 8099B3B8  4B 7A A3 45 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8099B3BC  38 00 00 00 */	li r0, 0
/* 8099B3C0  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 8099B3C4  3C 60 80 9A */	lis r3, lit_4123@ha /* 0x8099D2F0@ha */
/* 8099B3C8  C0 03 D2 F0 */	lfs f0, lit_4123@l(r3)  /* 0x8099D2F0@l */
...
/* 8099B3E8  4B 7A FF 51 */	bl srchPlayerActor__8daNpcT_cFv
...
/* 8099B420  4B 7A A2 DD */	bl remove__18daNpcT_ActorMngr_cFv
/* 8099B424  38 00 00 00 */	li r0, 0
/* 8099B428  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 8099B42C  3C 60 80 9A */	lis r3, lit_4123@ha /* 0x8099D2F0@ha */
/* 8099B430  C0 03 D2 F0 */	lfs f0, lit_4123@l(r3)  /* 0x8099D2F0@l */
...
/* 8099B468  4B 7A F5 B1 */	bl setAngle__8daNpcT_cFs
...
/* 8099B48C  4B 7B 01 BD */	bl step__8daNpcT_cFsiiii
...
/* 8099B4BC  4B 7A FE 7D */	bl srchPlayerActor__8daNpcT_cFv
lbl_8099B4C0:
