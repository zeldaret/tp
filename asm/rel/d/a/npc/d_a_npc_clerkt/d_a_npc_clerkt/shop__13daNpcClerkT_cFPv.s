...
/* 8099B814  4B 9C 69 C9 */	bl _savegpr_29
/* 8099B818  7C 7D 1B 78 */	mr r29, r3
/* 8099B81C  3C 80 80 9A */	lis r4, m__19daNpcClerkt_Param_c@ha /* 0x8099D244@ha */
/* 8099B820  3B C4 D2 44 */	addi r30, r4, m__19daNpcClerkt_Param_c@l /* 0x8099D244@l */
/* 8099B824  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8099B828  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8099B82C  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8099B830  4B 67 EE E1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8099B8C0  4B 7A 9E 3D */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8099B91C  4B 67 ED F5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8099B93C  4B 7F E8 1D */	bl shop_process__13dShopSystem_cFP10fopAc_ac_cP10dMsgFlow_c
...
/* 8099B958  4B 7A 9D 89 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 8099B95C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8099B960  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8099B964  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8099B968  4B 6A 6B 01 */	bl reset__14dEvt_control_cFv
...
/* 8099B988  4B 67 ED 89 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8099B9A4  4B 7A FC A5 */	bl step__8daNpcT_cFsiiii
lbl_8099B9A8:
...
/* 8099B9F4  4B 7F AF AD */	bl getCurrentPos__15dShopItemCtrl_cFi
...
/* 8099BA28  4B 67 13 3D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8099BA2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8099BA30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8099BA34  A8 9D 0D 7A */	lha r4, 0xd7a(r29)
/* 8099BA38  4B 67 09 FD */	bl mDoMtx_YrotM__FPA4_fs
/* 8099BA3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8099BA40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8099BA44  38 81 00 14 */	addi r4, r1, 0x14
/* 8099BA48  38 BD 0D 6C */	addi r5, r29, 0xd6c
/* 8099BA4C  4B 9A B3 21 */	bl PSMTXMultVec
...
/* 8099BA7C  4B 7A 9C 81 */	bl remove__18daNpcT_ActorMngr_cFv
...
lbl_8099BAC4:
/* 8099BAC4  4B 89 C7 69 */	bl getStatus__12dMsgObject_cFv
...
/* 8099BAE8  4B 7A 9C 15 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8099BB0C  4B 89 C8 99 */	bl isMouthCheck__12dMsgObject_cFv
...
/* 8099BB50  4B 7A 9B AD */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8099BB8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8099BB90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8099BB94  A8 9D 04 B6 */	lha r4, 0x4b6(r29)
/* 8099BB98  4B 67 08 45 */	bl mDoMtx_YrotS__FPA4_fs
/* 8099BB9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8099BBA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8099BBA4  38 81 00 20 */	addi r4, r1, 0x20
/* 8099BBA8  7C 85 23 78 */	mr r5, r4
/* 8099BBAC  4B 9A B1 C1 */	bl PSMTXMultVec
/* 8099BBB0  38 61 00 20 */	addi r3, r1, 0x20
/* 8099BBB4  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 8099BBB8  7C 65 1B 78 */	mr r5, r3
/* 8099BBBC  4B 9A B4 D5 */	bl PSVECAdd
/* 8099BBC0  38 7D 0E 78 */	addi r3, r29, 0xe78
/* 8099BBC4  38 81 00 20 */	addi r4, r1, 0x20
/* 8099BBC8  4B 7F AC F1 */	bl setMasterCamCtrPos__16ShopCam_action_cFP4cXyz
lbl_8099BBCC:
/* 8099BBCC  38 60 00 00 */	li r3, 0
/* 8099BBD0  39 61 00 40 */	addi r11, r1, 0x40
/* 8099BBD4  4B 9C 66 55 */	bl _restgpr_29
