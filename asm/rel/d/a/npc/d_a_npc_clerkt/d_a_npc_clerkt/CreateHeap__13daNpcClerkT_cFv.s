...
/* 8099A540  4B 9C 7C 9D */	bl _savegpr_29
/* 8099A544  7C 7F 1B 78 */	mr r31, r3
/* 8099A548  3C 60 80 9A */	lis r3, l_bmdData@ha /* 0x8099D378@ha */
/* 8099A54C  38 83 D3 78 */	addi r4, r3, l_bmdData@l /* 0x8099D378@l */
/* 8099A550  80 04 00 04 */	lwz r0, 4(r4)
/* 8099A554  54 00 10 3A */	slwi r0, r0, 2
/* 8099A558  3C 60 80 9A */	lis r3, l_resNameList@ha /* 0x8099D390@ha */
/* 8099A55C  38 63 D3 90 */	addi r3, r3, l_resNameList@l /* 0x8099D390@l */
/* 8099A560  7C 63 00 2E */	lwzx r3, r3, r0
/* 8099A564  80 84 00 00 */	lwz r4, 0(r4)
/* 8099A568  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8099A56C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8099A570  3C A5 00 02 */	addis r5, r5, 2
/* 8099A574  38 C0 00 80 */	li r6, 0x80
/* 8099A578  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8099A57C  4B 6A 1D 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8099A580  7C 7E 1B 78 */	mr r30, r3
/* 8099A584  38 60 00 58 */	li r3, 0x58
/* 8099A588  4B 93 46 C5 */	bl __nw__FUl
...
/* 8099A5C4  3D 20 80 9A */	lis r9, lit_4490@ha /* 0x8099D304@ha */
/* 8099A5C8  C0 29 D3 04 */	lfs f1, lit_4490@l(r9)  /* 0x8099D304@l */
/* 8099A5CC  39 20 00 00 */	li r9, 0
/* 8099A5D0  39 40 FF FF */	li r10, -1
/* 8099A5D4  4B 67 61 FD */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8099A5F8  4B 67 6D 19 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
...
/* 8099A620  3C 60 80 9A */	lis r3, ctrlJointCallBack__13daNpcClerkT_cFP8J3DJointi@ha /* 0x8099AB34@ha */
/* 8099A624  38 83 AB 34 */	addi r4, r3, ctrlJointCallBack__13daNpcClerkT_cFP8J3DJointi@l /* 0x8099AB34@l */
...
/* 8099A658  4B 93 45 F5 */	bl __nw__FUl
/* 8099A65C  7C 7E 1B 79 */	or. r30, r3, r3
/* 8099A660  41 82 00 D0 */	beq lbl_8099A730
/* 8099A664  7F DD F3 78 */	mr r29, r30
/* 8099A668  3C 60 80 3D */	lis r3, __vt__14J3DMaterialAnm@ha /* 0x803CEE60@ha */
/* 8099A66C  38 03 EE 60 */	addi r0, r3, __vt__14J3DMaterialAnm@l /* 0x803CEE60@l */
/* 8099A670  90 1E 00 00 */	stw r0, 0(r30)
/* 8099A674  38 7E 00 04 */	addi r3, r30, 4
/* 8099A678  3C 80 80 9A */	lis r4, __ct__14J3DMatColorAnmFv@ha /* 0x8099A954@ha */
/* 8099A67C  38 84 A9 54 */	addi r4, r4, __ct__14J3DMatColorAnmFv@l /* 0x8099A954@l */
/* 8099A680  3C A0 80 9A */	lis r5, __dt__14J3DMatColorAnmFv@ha /* 0x8099A918@ha */
/* 8099A684  38 A5 A9 18 */	addi r5, r5, __dt__14J3DMatColorAnmFv@l /* 0x8099A918@l */
/* 8099A688  38 C0 00 08 */	li r6, 8
/* 8099A68C  38 E0 00 02 */	li r7, 2
/* 8099A690  4B 9C 76 D1 */	bl __construct_array
/* 8099A694  38 7E 00 14 */	addi r3, r30, 0x14
/* 8099A698  3C 80 80 9A */	lis r4, __ct__12J3DTexMtxAnmFv@ha /* 0x8099A900@ha */
/* 8099A69C  38 84 A9 00 */	addi r4, r4, __ct__12J3DTexMtxAnmFv@l /* 0x8099A900@l */
/* 8099A6A0  3C A0 80 9A */	lis r5, __dt__12J3DTexMtxAnmFv@ha /* 0x8099A8C4@ha */
/* 8099A6A4  38 A5 A8 C4 */	addi r5, r5, __dt__12J3DTexMtxAnmFv@l /* 0x8099A8C4@l */
/* 8099A6A8  38 C0 00 08 */	li r6, 8
/* 8099A6AC  38 E0 00 08 */	li r7, 8
/* 8099A6B0  4B 9C 76 B1 */	bl __construct_array
/* 8099A6B4  38 7E 00 54 */	addi r3, r30, 0x54
/* 8099A6B8  3C 80 80 9A */	lis r4, __ct__11J3DTexNoAnmFv@ha /* 0x8099A8A0@ha */
/* 8099A6BC  38 84 A8 A0 */	addi r4, r4, __ct__11J3DTexNoAnmFv@l /* 0x8099A8A0@l */
/* 8099A6C0  3C A0 80 9A */	lis r5, __dt__11J3DTexNoAnmFv@ha /* 0x8099A858@ha */
/* 8099A6C4  38 A5 A8 58 */	addi r5, r5, __dt__11J3DTexNoAnmFv@l /* 0x8099A858@l */
/* 8099A6C8  38 C0 00 0C */	li r6, 0xc
/* 8099A6CC  38 E0 00 08 */	li r7, 8
/* 8099A6D0  4B 9C 76 91 */	bl __construct_array
/* 8099A6D4  38 7E 00 B4 */	addi r3, r30, 0xb4
/* 8099A6D8  3C 80 80 9A */	lis r4, __ct__14J3DTevColorAnmFv@ha /* 0x8099A840@ha */
/* 8099A6DC  38 84 A8 40 */	addi r4, r4, __ct__14J3DTevColorAnmFv@l /* 0x8099A840@l */
/* 8099A6E0  3C A0 80 9A */	lis r5, __dt__14J3DTevColorAnmFv@ha /* 0x8099A804@ha */
/* 8099A6E4  38 A5 A8 04 */	addi r5, r5, __dt__14J3DTevColorAnmFv@l /* 0x8099A804@l */
/* 8099A6E8  38 C0 00 08 */	li r6, 8
/* 8099A6EC  38 E0 00 04 */	li r7, 4
/* 8099A6F0  4B 9C 76 71 */	bl __construct_array
/* 8099A6F4  38 7E 00 D4 */	addi r3, r30, 0xd4
/* 8099A6F8  3C 80 80 9A */	lis r4, __ct__15J3DTevKColorAnmFv@ha /* 0x8099A7EC@ha */
/* 8099A6FC  38 84 A7 EC */	addi r4, r4, __ct__15J3DTevKColorAnmFv@l /* 0x8099A7EC@l */
/* 8099A700  3C A0 80 9A */	lis r5, __dt__15J3DTevKColorAnmFv@ha /* 0x8099A7B0@ha */
/* 8099A704  38 A5 A7 B0 */	addi r5, r5, __dt__15J3DTevKColorAnmFv@l /* 0x8099A7B0@l */
/* 8099A708  38 C0 00 08 */	li r6, 8
/* 8099A70C  38 E0 00 04 */	li r7, 4
/* 8099A710  4B 9C 76 51 */	bl __construct_array
/* 8099A714  7F C3 F3 78 */	mr r3, r30
/* 8099A718  4B 99 1C 09 */	bl initialize__14J3DMaterialAnmFv
/* 8099A71C  3C 60 80 3B */	lis r3, __vt__15daNpcT_MatAnm_c@ha /* 0x803B3B6C@ha */
/* 8099A720  38 03 3B 6C */	addi r0, r3, __vt__15daNpcT_MatAnm_c@l /* 0x803B3B6C@l */
/* 8099A724  90 1D 00 00 */	stw r0, 0(r29)
/* 8099A728  7F A3 EB 78 */	mr r3, r29
/* 8099A72C  4B 7A B0 39 */	bl initialize__15daNpcT_MatAnm_cFv
lbl_8099A730:
...
/* 8099A754  4B 7A FC 35 */	bl setFaceMotionAnm__8daNpcT_cFib
...
/* 8099A768  3C A0 80 9A */	lis r5, lit_4123@ha /* 0x8099D2F0@ha */
/* 8099A76C  C0 25 D2 F0 */	lfs f1, lit_4123@l(r5)  /* 0x8099D2F0@l */
...
/* 8099A79C  4B 9C 7A 8D */	bl _restgpr_29
