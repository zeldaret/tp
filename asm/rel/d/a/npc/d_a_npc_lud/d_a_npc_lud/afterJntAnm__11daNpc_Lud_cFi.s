...
/* 80A6BB38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6BB3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6BB40  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 80A6BB44  7C 00 00 D0 */	neg r0, r0
/* 80A6BB48  7C 04 07 34 */	extsh r4, r0
/* 80A6BB4C  4B 5A 08 E8 */	b mDoMtx_YrotM__FPA4_fs
/* 80A6BB50  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 80A6BB54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6BB58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6BB5C  4B 5A 09 70 */	b mDoMtx_ZrotM__FPA4_fs
/* 80A6BB60  48 00 00 34 */	b lbl_80A6BB94
lbl_80A6BB64:
/* 80A6BB64  2C 04 00 04 */	cmpwi r4, 4
/* 80A6BB68  40 82 00 2C */	bne lbl_80A6BB94
/* 80A6BB6C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6BB70  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6BB74  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80A6BB78  7C 00 00 D0 */	neg r0, r0
/* 80A6BB7C  7C 04 07 34 */	extsh r4, r0
/* 80A6BB80  4B 5A 08 B4 */	b mDoMtx_YrotM__FPA4_fs
/* 80A6BB84  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80A6BB88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6BB8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6BB90  4B 5A 09 3C */	b mDoMtx_ZrotM__FPA4_fs
lbl_80A6BB94:
