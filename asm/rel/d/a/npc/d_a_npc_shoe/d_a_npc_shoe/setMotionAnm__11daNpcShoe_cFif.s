...
/* 80AE9A28  3C 80 80 AF */	lis r4, l_bckGetParamList@ha /* 0x80AEA558@ha */
/* 80AE9A2C  38 A4 A5 58 */	addi r5, r4, l_bckGetParamList@l /* 0x80AEA558@l */
/* 80AE9A30  7C 85 F2 14 */	add r4, r5, r30
/* 80AE9A34  80 04 00 08 */	lwz r0, 8(r4)
/* 80AE9A38  54 00 10 3A */	slwi r0, r0, 2
/* 80AE9A3C  3C 80 80 AF */	lis r4, l_arcNames@ha /* 0x80AEA5A0@ha */
/* 80AE9A40  38 84 A5 A0 */	addi r4, r4, l_arcNames@l /* 0x80AEA5A0@l */
/* 80AE9A44  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AE9A48  7C A5 F0 2E */	lwzx r5, r5, r30
/* 80AE9A4C  4B 66 90 E1 */	bl getTrnsfrmKeyAnmP__8daNpcF_cFPci
/* 80AE9A50  7C 64 1B 79 */	or. r4, r3, r3
/* 80AE9A54  3C 60 80 AF */	lis r3, l_bckGetParamList@ha /* 0x80AEA558@ha */
/* 80AE9A58  38 03 A5 58 */	addi r0, r3, l_bckGetParamList@l /* 0x80AEA558@l */
...
/* 80AE9A7C  3C C0 80 AF */	lis r6, lit_4235@ha /* 0x80AEA42C@ha */
/* 80AE9A80  C0 26 A4 2C */	lfs f1, lit_4235@l(r6)  /* 0x80AEA42C@l */
/* 80AE9A84  FC 40 F8 90 */	fmr f2, f31
/* 80AE9A88  38 C0 00 00 */	li r6, 0
/* 80AE9A8C  38 E0 FF FF */	li r7, -1
/* 80AE9A90  4B 66 91 8D */	bl setMcaMorfAnm__8daNpcF_cFP18J3DAnmTransformKeyffiii
