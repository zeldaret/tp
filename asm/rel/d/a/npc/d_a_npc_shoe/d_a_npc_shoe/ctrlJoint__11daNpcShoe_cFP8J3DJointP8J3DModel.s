...
/* 80AE841C  4B 87 9D BD */	bl _savegpr_28
...
/* 80AE8430  3C 60 80 AF */	lis r3, lit_4302@ha /* 0x80AEA438@ha */
/* 80AE8434  38 83 A4 38 */	addi r4, r3, lit_4302@l /* 0x80AEA438@l */
...
/* 80AE846C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AE8470  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AE8474  4B 85 E0 3D */	bl PSMTXCopy
/* 80AE8478  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AE847C  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80AE84B0  4B 85 E0 01 */	bl PSMTXCopy
...
/* 80AE84E0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AE84E4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AE84E8  4B 85 DF C9 */	bl PSMTXCopy
...
/* 80AE8514  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AE8518  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AE851C  4B 85 DF 95 */	bl PSMTXCopy
...
/* 80AE8540  3C C0 80 AF */	lis r6, m__17daNpcShoe_Param_c@ha /* 0x80AEA3B0@ha */
/* 80AE8544  38 C6 A3 B0 */	addi r6, r6, m__17daNpcShoe_Param_c@l /* 0x80AEA3B0@l */
/* 80AE8548  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80AE854C  4B 66 AE 31 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80AE8550:
/* 80AE8550  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AE8554  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AE8558  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80AE855C  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80AE8560  7C 80 E2 14 */	add r4, r0, r28
/* 80AE8564  4B 85 DF 4D */	bl PSMTXCopy
/* 80AE8568  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AE856C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AE8570  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80AE8574  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80AE8578  4B 85 DF 39 */	bl PSMTXCopy
/* 80AE857C  38 60 00 01 */	li r3, 1
/* 80AE8580  39 61 00 30 */	addi r11, r1, 0x30
/* 80AE8584  4B 87 9C A1 */	bl _restgpr_28
