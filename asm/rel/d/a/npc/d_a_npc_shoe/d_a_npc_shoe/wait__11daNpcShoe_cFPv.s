...
/* 80AE8A1C  4B 87 97 BD */	bl _savegpr_28
/* 80AE8A20  7C 7C 1B 78 */	mr r28, r3
/* 80AE8A24  3C 80 80 AF */	lis r4, cNullVec__6Z2Calc@ha /* 0x80AEA538@ha */
/* 80AE8A28  3B A4 A5 38 */	addi r29, r4, cNullVec__6Z2Calc@l /* 0x80AEA538@l */
/* 80AE8A2C  3C 80 80 AF */	lis r4, m__17daNpcShoe_Param_c@ha /* 0x80AEA3B0@ha */
/* 80AE8A30  3B C4 A3 B0 */	addi r30, r4, m__17daNpcShoe_Param_c@l /* 0x80AEA3B0@l */
...
lbl_80AE8A84:
/* 80AE8A84  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AE8A88  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AE8A8C  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80AE8A90  38 BE 00 00 */	addi r5, r30, 0
/* 80AE8A94  C0 25 00 50 */	lfs f1, 0x50(r5)
/* 80AE8A98  4B 66 AF 59 */	bl chkActorInSight__8daNpcF_cFP10fopAc_ac_cf
/* 80AE8A9C  2C 03 00 00 */	cmpwi r3, 0
/* 80AE8AA0  40 82 00 10 */	bne lbl_80AE8AB0
/* 80AE8AA4  38 7C 0C 94 */	addi r3, r28, 0xc94
/* 80AE8AA8  4B 66 7C 39 */	bl remove__18daNpcF_ActorMngr_cFv
/* 80AE8AAC  48 00 00 78 */	b lbl_80AE8B24
lbl_80AE8AB0:
/* 80AE8AB0  38 7C 0C 94 */	addi r3, r28, 0xc94
/* 80AE8AB4  4B 66 7C 39 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 80AE8AD0  4B 66 B1 0D */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 80AE8AF4  4B 66 B0 E9 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 80AE8B14  4B 66 7B A9 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
/* 80AE8B18  48 00 00 0C */	b lbl_80AE8B24
lbl_80AE8B1C:
/* 80AE8B1C  38 7C 0C 94 */	addi r3, r28, 0xc94
/* 80AE8B20  4B 66 7B C1 */	bl remove__18daNpcF_ActorMngr_cFv
lbl_80AE8B24:
/* 80AE8B24  38 7C 0C 94 */	addi r3, r28, 0xc94
/* 80AE8B28  4B 66 7B C5 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
lbl_80AE8B60:
/* 80AE8B60  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AE8B64  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AE8BA8  4B 55 FC 49 */	bl ChkPresentEnd__16dEvent_manager_cFv
...
/* 80AE8BD8  4B 87 94 41 */	bl __ptmf_test
...
/* 80AE8BF0  4B 87 94 95 */	bl __ptmf_scall
...
/* 80AE8C1C  4B 87 93 FD */	bl __ptmf_test
...
/* 80AE8C34  4B 87 94 51 */	bl __ptmf_scall
...
/* 80AE8C50  4B 55 EE CD */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80AE8C80  4B 87 93 99 */	bl __ptmf_test
...
/* 80AE8C98  4B 87 93 ED */	bl __ptmf_scall
...
/* 80AE8CC4  4B 87 93 55 */	bl __ptmf_test
...
/* 80AE8CDC  4B 87 93 A9 */	bl __ptmf_scall
/* 80AE8CE0  60 00 00 00 */	nop 
/* 80AE8CE4  48 00 01 1C */	b lbl_80AE8E00
lbl_80AE8CE8:
/* 80AE8CE8  4B 6C 38 95 */	bl dKy_darkworld_check__Fv
/* 80AE8CEC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80AE8CF0  40 82 00 CC */	bne lbl_80AE8DBC
/* 80AE8CF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AE8CF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AE8D14  4B 88 3A 6D */	bl pow
/* 80AE8D18  FF E0 08 18 */	frsp f31, f1
/* 80AE8D1C  7F 83 E3 78 */	mr r3, r28
/* 80AE8D20  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80AE8D24  4B 53 1D 71 */	bl fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80AE8D54  4B 87 92 C5 */	bl __ptmf_test
...
/* 80AE8D6C  4B 87 93 19 */	bl __ptmf_scall
...
/* 80AE8D98  4B 87 92 81 */	bl __ptmf_test
...
/* 80AE8DB0  4B 87 92 D5 */	bl __ptmf_scall
...
/* 80AE8DFC  4B 66 AA 81 */	bl orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_80AE8E00:
...
/* 80AE8E10  4B 87 94 15 */	bl _restgpr_28
