...
/* 80AE8320  3C 80 80 AF */	lis r4, m__17daNpcShoe_Param_c@ha
/* 80AE8324  3B E4 A3 B0 */	addi r31, r4, m__17daNpcShoe_Param_c@l
...
/* 80AE8354  4B 66 9F 58 */	b draw__8daNpcF_cFiifP11_GXColorS10i
/* 80AE8358  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80AE835C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80AE8360  80 9E 0B 48 */	lwz r4, 0xb48(r30)
/* 80AE8364  80 84 00 04 */	lwz r4, 4(r4)
/* 80AE8368  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80AE836C  4B 6B CA 34 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80AE8384  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AE8388  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AE838C  4B 85 E1 24 */	b PSMTXCopy
/* 80AE8390  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AE8394  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AE8398  80 9E 0B 48 */	lwz r4, 0xb48(r30)
/* 80AE839C  38 84 00 24 */	addi r4, r4, 0x24
/* 80AE83A0  4B 85 E1 10 */	b PSMTXCopy
/* 80AE83A4  80 7E 0B 48 */	lwz r3, 0xb48(r30)
/* 80AE83A8  4B 52 59 1C */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80AE83AC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80AE83B0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80AE83B4  80 9E 0B 4C */	lwz r4, 0xb4c(r30)
/* 80AE83B8  80 84 00 04 */	lwz r4, 4(r4)
/* 80AE83BC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80AE83C0  4B 6B C9 E0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80AE83C4  80 7E 0B 4C */	lwz r3, 0xb4c(r30)
/* 80AE83C8  4B 52 58 FC */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80AE83E4  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80AE83E8  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80AE83EC  4B 54 4C C8 */	b dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
