...
/* 80A9A658  3C 60 80 3B */	lis r3, __vt__8daNpcT_c@ha
/* 80A9A65C  38 03 3A 78 */	addi r0, r3, __vt__8daNpcT_c@l
...
/* 80A9A670  3C 80 80 AA */	lis r4, __dt__5csXyzFv@ha
/* 80A9A674  38 84 A9 FC */	addi r4, r4, __dt__5csXyzFv@l
/* 80A9A678  38 A0 00 06 */	li r5, 6
/* 80A9A67C  38 C0 00 02 */	li r6, 2
/* 80A9A680  4B 8C 76 68 */	b __destroy_arr
lbl_80A9A684:
/* 80A9A684  34 1E 0B A8 */	addic. r0, r30, 0xba8
/* 80A9A688  41 82 00 B4 */	beq lbl_80A9A73C
/* 80A9A68C  3C 60 80 AA */	lis r3, __vt__15daNpcT_JntAnm_c@ha
/* 80A9A690  38 03 C0 84 */	addi r0, r3, __vt__15daNpcT_JntAnm_c@l
/* 80A9A694  90 1E 0D 04 */	stw r0, 0xd04(r30)
/* 80A9A698  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 80A9A69C  3C 80 80 AA */	lis r4, __dt__4cXyzFv@ha
/* 80A9A6A0  38 84 A9 C0 */	addi r4, r4, __dt__4cXyzFv@l
/* 80A9A6A4  38 A0 00 0C */	li r5, 0xc
/* 80A9A6A8  38 C0 00 03 */	li r6, 3
/* 80A9A6AC  4B 8C 76 3C */	b __destroy_arr
/* 80A9A6B0  38 7E 0C 68 */	addi r3, r30, 0xc68
/* 80A9A6B4  3C 80 80 AA */	lis r4, __dt__4cXyzFv@ha
/* 80A9A6B8  38 84 A9 C0 */	addi r4, r4, __dt__4cXyzFv@l
/* 80A9A6BC  38 A0 00 0C */	li r5, 0xc
/* 80A9A6C0  38 C0 00 03 */	li r6, 3
/* 80A9A6C4  4B 8C 76 24 */	b __destroy_arr
/* 80A9A6C8  38 7E 0C 44 */	addi r3, r30, 0xc44
/* 80A9A6CC  3C 80 80 AA */	lis r4, __dt__4cXyzFv@ha
/* 80A9A6D0  38 84 A9 C0 */	addi r4, r4, __dt__4cXyzFv@l
/* 80A9A6D4  38 A0 00 0C */	li r5, 0xc
/* 80A9A6D8  38 C0 00 03 */	li r6, 3
/* 80A9A6DC  4B 8C 76 0C */	b __destroy_arr
/* 80A9A6E0  38 7E 0C 20 */	addi r3, r30, 0xc20
/* 80A9A6E4  3C 80 80 AA */	lis r4, __dt__4cXyzFv@ha
/* 80A9A6E8  38 84 A9 C0 */	addi r4, r4, __dt__4cXyzFv@l
/* 80A9A6EC  38 A0 00 0C */	li r5, 0xc
/* 80A9A6F0  38 C0 00 03 */	li r6, 3
/* 80A9A6F4  4B 8C 75 F4 */	b __destroy_arr
/* 80A9A6F8  38 7E 0B FC */	addi r3, r30, 0xbfc
/* 80A9A6FC  3C 80 80 AA */	lis r4, __dt__4cXyzFv@ha
/* 80A9A700  38 84 A9 C0 */	addi r4, r4, __dt__4cXyzFv@l
/* 80A9A704  38 A0 00 0C */	li r5, 0xc
/* 80A9A708  38 C0 00 03 */	li r6, 3
/* 80A9A70C  4B 8C 75 DC */	b __destroy_arr
/* 80A9A710  38 7E 0B D8 */	addi r3, r30, 0xbd8
/* 80A9A714  3C 80 80 AA */	lis r4, __dt__4cXyzFv@ha
/* 80A9A718  38 84 A9 C0 */	addi r4, r4, __dt__4cXyzFv@l
/* 80A9A71C  38 A0 00 0C */	li r5, 0xc
/* 80A9A720  38 C0 00 03 */	li r6, 3
/* 80A9A724  4B 8C 75 C4 */	b __destroy_arr
/* 80A9A728  34 1E 0B A8 */	addic. r0, r30, 0xba8
/* 80A9A72C  41 82 00 10 */	beq lbl_80A9A73C
/* 80A9A730  3C 60 80 AA */	lis r3, __vt__18daNpcT_ActorMngr_c@ha
/* 80A9A734  38 03 C0 78 */	addi r0, r3, __vt__18daNpcT_ActorMngr_c@l
/* 80A9A738  90 1E 0B AC */	stw r0, 0xbac(r30)
lbl_80A9A73C:
/* 80A9A73C  34 1E 0B A0 */	addic. r0, r30, 0xba0
/* 80A9A740  41 82 00 10 */	beq lbl_80A9A750
/* 80A9A744  3C 60 80 AA */	lis r3, __vt__18daNpcT_ActorMngr_c@ha
/* 80A9A748  38 03 C0 78 */	addi r0, r3, __vt__18daNpcT_ActorMngr_c@l
/* 80A9A74C  90 1E 0B A4 */	stw r0, 0xba4(r30)
lbl_80A9A750:
/* 80A9A750  34 1E 0B 98 */	addic. r0, r30, 0xb98
/* 80A9A754  41 82 00 10 */	beq lbl_80A9A764
/* 80A9A758  3C 60 80 AA */	lis r3, __vt__18daNpcT_ActorMngr_c@ha
/* 80A9A75C  38 03 C0 78 */	addi r0, r3, __vt__18daNpcT_ActorMngr_c@l
/* 80A9A760  90 1E 0B 9C */	stw r0, 0xb9c(r30)
lbl_80A9A764:
/* 80A9A764  34 1E 0B 74 */	addic. r0, r30, 0xb74
/* 80A9A768  41 82 00 10 */	beq lbl_80A9A778
/* 80A9A76C  3C 60 80 AA */	lis r3, __vt__22daNpcT_MotionSeqMngr_c@ha
/* 80A9A770  38 03 C0 6C */	addi r0, r3, __vt__22daNpcT_MotionSeqMngr_c@l
/* 80A9A774  90 1E 0B 94 */	stw r0, 0xb94(r30)
lbl_80A9A778:
/* 80A9A778  34 1E 0B 50 */	addic. r0, r30, 0xb50
/* 80A9A77C  41 82 00 10 */	beq lbl_80A9A78C
/* 80A9A780  3C 60 80 AA */	lis r3, __vt__22daNpcT_MotionSeqMngr_c@ha
/* 80A9A784  38 03 C0 6C */	addi r0, r3, __vt__22daNpcT_MotionSeqMngr_c@l
/* 80A9A788  90 1E 0B 70 */	stw r0, 0xb70(r30)
lbl_80A9A78C:
/* 80A9A78C  38 7E 0A E0 */	addi r3, r30, 0xae0
/* 80A9A790  38 80 FF FF */	li r4, -1
/* 80A9A794  4B 5D D5 48 */	b __dt__11dBgS_LinChkFv
/* 80A9A798  38 7E 0A 8C */	addi r3, r30, 0xa8c
/* 80A9A79C  38 80 FF FF */	li r4, -1
/* 80A9A7A0  4B 5D CE 50 */	b __dt__11dBgS_GndChkFv
/* 80A9A7A4  34 1E 0A 40 */	addic. r0, r30, 0xa40
/* 80A9A7A8  41 82 00 54 */	beq lbl_80A9A7FC
/* 80A9A7AC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80A9A7B0  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80A9A864  3C 60 80 AA */	lis r3, __vt__10dCcD_GStts@ha
/* 80A9A868  38 03 C0 60 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 80A9A86C  90 1E 08 80 */	stw r0, 0x880(r30)
/* 80A9A870  34 1E 08 80 */	addic. r0, r30, 0x880
/* 80A9A874  41 82 00 10 */	beq lbl_80A9A884
/* 80A9A878  3C 60 80 AA */	lis r3, __vt__10cCcD_GStts@ha
/* 80A9A87C  38 03 C0 54 */	addi r0, r3, __vt__10cCcD_GStts@l
/* 80A9A880  90 1E 08 80 */	stw r0, 0x880(r30)
lbl_80A9A884:
/* 80A9A884  34 1E 08 64 */	addic. r0, r30, 0x864
/* 80A9A888  41 82 00 10 */	beq lbl_80A9A898
/* 80A9A88C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80A9A890  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80A9A894  90 1E 08 7C */	stw r0, 0x87c(r30)
lbl_80A9A898:
/* 80A9A898  34 1E 06 8C */	addic. r0, r30, 0x68c
/* 80A9A89C  41 82 00 2C */	beq lbl_80A9A8C8
/* 80A9A8A0  3C 60 80 AA */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80A9A8A4  38 63 C0 24 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80A9A8C4  4B 5D B6 D0 */	b __dt__9dBgS_AcchFv
lbl_80A9A8C8:
...
/* 80A9A8E0  3C 60 80 AA */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80A9A8E4  38 03 C0 18 */	addi r0, r3, __vt__12J3DFrameCtrl@l
...
/* 80A9A904  3C 60 80 AA */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80A9A908  38 03 C0 18 */	addi r0, r3, __vt__12J3DFrameCtrl@l
...
/* 80A9A928  3C 60 80 AA */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80A9A92C  38 03 C0 18 */	addi r0, r3, __vt__12J3DFrameCtrl@l
...
/* 80A9A94C  3C 60 80 AA */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80A9A950  38 03 C0 18 */	addi r0, r3, __vt__12J3DFrameCtrl@l
