...
/* 80A9B354  4B 8C 6E 89 */	bl _savegpr_29
/* 80A9B358  7C 7F 1B 78 */	mr r31, r3
/* 80A9B35C  7C 80 23 78 */	mr r0, r4
/* 80A9B360  FF E0 08 90 */	fmr f31, f1
/* 80A9B364  7C BD 2B 78 */	mr r29, r5
/* 80A9B368  3C 60 80 AA */	lis r3, m__24daNpc_Pachi_Maro_Param_c@ha /* 0x80A9B88C@ha */
/* 80A9B36C  3B C3 B8 8C */	addi r30, r3, m__24daNpc_Pachi_Maro_Param_c@l /* 0x80A9B88C@l */
...
/* 80A9B388  4B 7C B7 AD */	bl __mi__4cXyzCFRC3Vec
...
/* 80A9B3B8  4B 8A BD 81 */	bl PSVECSquareMag
...
/* 80A9B428  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A9B42C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80A9B498  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A9B49C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80A9B4A0  48 00 00 08 */	b lbl_80A9B4A8
lbl_80A9B4A4:
/* 80A9B4A4  FC 40 08 90 */	fmr f2, f1
lbl_80A9B4A8:
/* 80A9B4A8  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80A9B4AC  4B 7C C1 C9 */	bl cM_atan2s__Fff
...
/* 80A9B530  4B 8C 6C F9 */	bl _restgpr_29
