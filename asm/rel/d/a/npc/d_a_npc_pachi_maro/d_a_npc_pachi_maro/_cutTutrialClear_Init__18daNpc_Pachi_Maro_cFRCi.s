...
/* 80A99C10  4B 6A BA ED */	bl remove__18daNpcT_ActorMngr_cFv
/* 80A99C14  38 00 00 00 */	li r0, 0
/* 80A99C18  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 80A99C1C  3C 60 80 AA */	lis r3, lit_4346@ha /* 0x80A9B930@ha */
/* 80A99C20  C0 03 B9 30 */	lfs f0, lit_4346@l(r3)  /* 0x80A9B930@l */
...
/* 80A99C50  4B 6A BC 49 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A99C54  93 FE 0B 80 */	stw r31, 0xb80(r30)
/* 80A99C58  38 00 00 00 */	li r0, 0
/* 80A99C5C  90 1E 0B 7C */	stw r0, 0xb7c(r30)
/* 80A99C60  3C 60 80 AA */	lis r3, lit_4673@ha /* 0x80A9B94C@ha */
/* 80A99C64  C0 03 B9 4C */	lfs f0, lit_4673@l(r3)  /* 0x80A9B94C@l */
...
/* 80A99C80  4B 6A BC 19 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A99C84  93 FE 0B 5C */	stw r31, 0xb5c(r30)
/* 80A99C88  38 00 00 01 */	li r0, 1
/* 80A99C8C  90 1E 0B 58 */	stw r0, 0xb58(r30)
/* 80A99C90  3C 60 80 AA */	lis r3, lit_4673@ha /* 0x80A9B94C@ha */
/* 80A99C94  C0 03 B9 4C */	lfs f0, lit_4673@l(r3)  /* 0x80A9B94C@l */
