...
/* 80A97CAC  3C 60 80 AA */	lis r3, __vt__18daNpc_Pachi_Maro_c@ha /* 0x80A9C0A8@ha */
/* 80A97CB0  38 03 C0 A8 */	addi r0, r3, __vt__18daNpc_Pachi_Maro_c@l /* 0x80A9C0A8@l */
...
/* 80A97CC4  4B 57 96 4D */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80A97CC8:
/* 80A97CC8  7F C3 F3 78 */	mr r3, r30
/* 80A97CCC  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 80A97CD0  54 00 10 3A */	slwi r0, r0, 2
/* 80A97CD4  3C 80 80 AA */	lis r4, l_loadResPtrnList@ha /* 0x80A9BAFC@ha */
/* 80A97CD8  38 84 BA FC */	addi r4, r4, l_loadResPtrnList@l /* 0x80A9BAFC@l */
/* 80A97CDC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A97CE0  3C A0 80 AA */	lis r5, l_resNameList@ha /* 0x80A9BAB8@ha */
/* 80A97CE4  38 A5 BA B8 */	addi r5, r5, l_resNameList@l /* 0x80A9BAB8@l */
/* 80A97CE8  4B 6B 07 C5 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80A97CEC  38 7E 0F A0 */	addi r3, r30, 0xfa0
/* 80A97CF0  3C 80 80 AA */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha /* 0x80A9AA38@ha */
/* 80A97CF4  38 84 AA 38 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l /* 0x80A9AA38@l */
/* 80A97CF8  38 A0 00 08 */	li r5, 8
/* 80A97CFC  38 C0 00 02 */	li r6, 2
/* 80A97D00  4B 8C 9F E9 */	bl __destroy_arr
/* 80A97D04  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80A97D08  41 82 00 84 */	beq lbl_80A97D8C
/* 80A97D0C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80A97D10  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80A97D30  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80A97D34  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80A97D4C  3C 60 80 AA */	lis r3, __vt__8cM3dGCyl@ha /* 0x80A9C09C@ha */
/* 80A97D50  38 03 C0 9C */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80A9C09C@l */
/* 80A97D54  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_80A97D58:
/* 80A97D58  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80A97D5C  41 82 00 24 */	beq lbl_80A97D80
/* 80A97D60  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80A97D64  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80A97D68  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 80A97D6C  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80A97D70  41 82 00 10 */	beq lbl_80A97D80
/* 80A97D74  3C 60 80 AA */	lis r3, __vt__8cM3dGAab@ha /* 0x80A9C090@ha */
/* 80A97D78  38 03 C0 90 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80A9C090@l */
/* 80A97D7C  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_80A97D80:
/* 80A97D80  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80A97D84  38 80 00 00 */	li r4, 0
/* 80A97D88  4B 5E C3 5D */	bl __dt__12dCcD_GObjInfFv
lbl_80A97D8C:
...
/* 80A97DA4  4B 83 6F 99 */	bl __dl__FPv
lbl_80A97DA8:
