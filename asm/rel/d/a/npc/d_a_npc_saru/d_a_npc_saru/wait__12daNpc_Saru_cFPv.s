...
/* 80AC28B4  4B 89 F9 29 */	bl _savegpr_29
...
/* 80AC2930  4B 68 2F 69 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2934  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 80AC2938  38 00 00 00 */	li r0, 0
/* 80AC293C  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80AC2940  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2944  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2960  4B 68 2F 39 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2964  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80AC2968  38 00 00 00 */	li r0, 0
/* 80AC296C  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80AC2970  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2974  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2994  4B 68 2F 05 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2998  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 80AC299C  38 00 00 00 */	li r0, 0
/* 80AC29A0  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80AC29A4  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC29A8  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC29C4  4B 68 2E D5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC29C8  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80AC29CC  38 00 00 04 */	li r0, 4
/* 80AC29D0  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80AC29D4  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC29D8  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
/* 80AC29DC  D0 1F 0B 8C */	stfs f0, 0xb8c(r31)
/* 80AC29E0  48 00 01 DC */	b lbl_80AC2BBC
lbl_80AC29E4:
/* 80AC29E4  38 7F 0F 8C */	addi r3, r31, 0xf8c
/* 80AC29E8  4B 68 2D 21 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80AC2A08  4B 68 2E 91 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2A0C  93 BF 0B 5C */	stw r29, 0xb5c(r31)
/* 80AC2A10  38 00 00 00 */	li r0, 0
/* 80AC2A14  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80AC2A18  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2A1C  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2A38  4B 68 2E 61 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2A3C  93 BF 0B 80 */	stw r29, 0xb80(r31)
/* 80AC2A40  38 00 00 08 */	li r0, 8
/* 80AC2A44  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80AC2A48  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2A4C  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2AA8  4B 68 2D F1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2AAC  93 BF 0B 5C */	stw r29, 0xb5c(r31)
/* 80AC2AB0  38 00 00 00 */	li r0, 0
/* 80AC2AB4  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80AC2AB8  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2ABC  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2AD8  4B 68 2D C1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2ADC  93 BF 0B 80 */	stw r29, 0xb80(r31)
/* 80AC2AE0  38 00 00 09 */	li r0, 9
/* 80AC2AE4  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80AC2AE8  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2AEC  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2B0C  4B 68 2D 8D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2B10  93 BF 0B 5C */	stw r29, 0xb5c(r31)
/* 80AC2B14  38 00 00 00 */	li r0, 0
/* 80AC2B18  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80AC2B1C  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2B20  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2B3C  4B 68 2D 5D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2B40  93 BF 0B 80 */	stw r29, 0xb80(r31)
/* 80AC2B44  38 00 00 00 */	li r0, 0
/* 80AC2B48  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80AC2B4C  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2B50  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2B70  4B 68 2D 29 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2B74  93 BF 0B 5C */	stw r29, 0xb5c(r31)
/* 80AC2B78  38 00 00 00 */	li r0, 0
/* 80AC2B7C  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80AC2B80  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2B84  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2BA0  4B 68 2C F9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2BA4  93 BF 0B 80 */	stw r29, 0xb80(r31)
/* 80AC2BA8  38 00 00 00 */	li r0, 0
/* 80AC2BAC  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80AC2BB0  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2BB4  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2BD4  4B 68 9E D9 */	bl daNpcT_chkEvtBit__FUl
/* 80AC2BD8  2C 03 00 00 */	cmpwi r3, 0
/* 80AC2BDC  41 82 00 14 */	beq lbl_80AC2BF0
/* 80AC2BE0  7F E3 FB 78 */	mr r3, r31
/* 80AC2BE4  4B 55 70 99 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80AC2C18  4B 68 2A F1 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80AC2C78  4B 68 2C 21 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2C7C  93 BF 0B 5C */	stw r29, 0xb5c(r31)
/* 80AC2C80  38 00 00 00 */	li r0, 0
/* 80AC2C84  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80AC2C88  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2C8C  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2CA8  4B 68 2B F1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2CAC  93 BF 0B 80 */	stw r29, 0xb80(r31)
/* 80AC2CB0  38 00 00 09 */	li r0, 9
/* 80AC2CB4  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80AC2CB8  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2CBC  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
/* 80AC2CC0  D0 1F 0B 8C */	stfs f0, 0xb8c(r31)
lbl_80AC2CC4:
/* 80AC2CC4  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 80AC2CC8  4B 68 2A 41 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80AC2CF0  4B 68 2A 0D */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AC2CF4  38 00 00 00 */	li r0, 0
/* 80AC2CF8  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AC2CFC  3C 60 80 AC */	lis r3, lit_4231@ha /* 0x80AC45AC@ha */
/* 80AC2D00  C0 03 45 AC */	lfs f0, lit_4231@l(r3)  /* 0x80AC45AC@l */
...
/* 80AC2D20  4B 68 29 E9 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80AC2D34  4B 68 7E 9D */	bl chkActorInSight__8daNpcT_cFP10fopAc_ac_cfs
...
/* 80AC2D50  4B 68 29 AD */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AC2D54  38 00 00 00 */	li r0, 0
/* 80AC2D58  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AC2D5C  3C 60 80 AC */	lis r3, lit_4231@ha /* 0x80AC45AC@ha */
/* 80AC2D60  C0 03 45 AC */	lfs f0, lit_4231@l(r3)  /* 0x80AC45AC@l */
...
/* 80AC2D7C  4B 68 85 BD */	bl srchPlayerActor__8daNpcT_cFv
...
/* 80AC2DB4  4B 68 29 49 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AC2DB8  38 00 00 00 */	li r0, 0
/* 80AC2DBC  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AC2DC0  3C 60 80 AC */	lis r3, lit_4231@ha /* 0x80AC45AC@ha */
/* 80AC2DC4  C0 03 45 AC */	lfs f0, lit_4231@l(r3)  /* 0x80AC45AC@l */
...
/* 80AC2E0C  4B 68 88 3D */	bl step__8daNpcT_cFsiiii
...
/* 80AC2E28  4B 68 7B F1 */	bl setAngle__8daNpcT_cFs
...
/* 80AC2E5C  4B 68 2B C9 */	bl checkEndSequence__22daNpcT_MotionSeqMngr_cFv
...
/* 80AC2EBC  4B 68 29 DD */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2EC0  93 BF 0B 5C */	stw r29, 0xb5c(r31)
/* 80AC2EC4  38 00 00 00 */	li r0, 0
/* 80AC2EC8  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80AC2ECC  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2ED0  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2EEC  4B 68 29 AD */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2EF0  93 BF 0B 80 */	stw r29, 0xb80(r31)
/* 80AC2EF4  38 00 00 05 */	li r0, 5
/* 80AC2EF8  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80AC2EFC  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2F00  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2F18  4B 68 84 21 */	bl srchPlayerActor__8daNpcT_cFv
lbl_80AC2F1C:
...
/* 80AC2F38  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha /* 0x80450FDC@ha */
/* 80AC2F3C  90 03 0F DC */	stw r0, mFindCount__8daNpcT_c@l(r3)  /* 0x80450FDC@l */
/* 80AC2F40  3C 60 80 AC */	lis r3, srchYm__12daNpc_Saru_cFPvPv@ha /* 0x80AC0B64@ha */
/* 80AC2F44  38 63 0B 64 */	addi r3, r3, srchYm__12daNpc_Saru_cFPvPv@l /* 0x80AC0B64@l */
/* 80AC2F48  7F E4 FB 78 */	mr r4, r31
/* 80AC2F4C  4B 55 68 AD */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80AC2F50  38 E0 00 00 */	li r7, 0
/* 80AC2F54  38 60 00 00 */	li r3, 0
/* 80AC2F58  3C 80 80 45 */	lis r4, mFindCount__8daNpcT_c@ha /* 0x80450FDC@ha */
/* 80AC2F5C  80 C4 0F DC */	lwz r6, mFindCount__8daNpcT_c@l(r4)  /* 0x80450FDC@l */
/* 80AC2F60  3C 80 80 42 */	lis r4, mFindActorPtrs__8daNpcT_c@ha /* 0x80425708@ha */
/* 80AC2F64  38 A4 57 08 */	addi r5, r4, mFindActorPtrs__8daNpcT_c@l /* 0x80425708@l */
...
/* 80AC2FC4  4B 89 F2 65 */	bl _restgpr_29
