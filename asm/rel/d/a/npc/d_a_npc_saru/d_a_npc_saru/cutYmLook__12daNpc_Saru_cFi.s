...
/* 80AC25A8  4B 89 FC 25 */	bl _savegpr_25
...
/* 80AC25C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AC25C4  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AC25C8  3B 7C 4F F8 */	addi r27, r28, 0x4ff8
/* 80AC25CC  7F 63 DB 78 */	mr r3, r27
/* 80AC25D0  3C A0 80 AC */	lis r5, d_a_npc_saru__stringBase0@ha /* 0x80AC4654@ha */
/* 80AC25D4  38 A5 46 54 */	addi r5, r5, d_a_npc_saru__stringBase0@l /* 0x80AC4654@l */
/* 80AC25D8  38 A5 00 42 */	addi r5, r5, 0x42
/* 80AC25DC  38 C0 00 03 */	li r6, 3
/* 80AC25E0  4B 58 5B 0D */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80AC25F8  3C A0 80 AC */	lis r5, d_a_npc_saru__stringBase0@ha /* 0x80AC4654@ha */
/* 80AC25FC  38 A5 46 54 */	addi r5, r5, d_a_npc_saru__stringBase0@l /* 0x80AC4654@l */
/* 80AC2600  38 A5 00 46 */	addi r5, r5, 0x46
/* 80AC2604  38 C0 00 03 */	li r6, 3
/* 80AC2608  4B 58 5A E5 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80AC2620  4B 58 57 2D */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80AC2670  3C 80 80 AC */	lis r4, l_evtList@ha /* 0x80AC46E4@ha */
/* 80AC2674  38 84 46 E4 */	addi r4, r4, l_evtList@l /* 0x80AC46E4@l */
/* 80AC2678  80 84 00 10 */	lwz r4, 0x10(r4)
/* 80AC267C  4B 8A 64 B1 */	bl strcpy
/* 80AC2680  38 61 00 08 */	addi r3, r1, 8
/* 80AC2684  3C 80 80 AC */	lis r4, d_a_npc_saru__stringBase0@ha /* 0x80AC4654@ha */
/* 80AC2688  38 84 46 54 */	addi r4, r4, d_a_npc_saru__stringBase0@l /* 0x80AC4654@l */
/* 80AC268C  38 84 00 4C */	addi r4, r4, 0x4c
/* 80AC2690  4B 8A 64 2D */	bl strcat
...
/* 80AC26A4  4B 58 02 B5 */	bl setSkipZev__14dEvt_control_cFPvPc
/* 80AC26A8  7F 63 DB 78 */	mr r3, r27
/* 80AC26AC  4B 58 02 FD */	bl onSkipFade__14dEvt_control_cFv
...
/* 80AC26D4  4B 68 31 C5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC26D8  93 9D 0B 80 */	stw r28, 0xb80(r29)
/* 80AC26DC  38 00 00 02 */	li r0, 2
/* 80AC26E0  90 1D 0B 7C */	stw r0, 0xb7c(r29)
/* 80AC26E4  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC26E8  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2700  4B 68 94 F1 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80AC271C  4B 68 31 7D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2720  93 9D 0B 80 */	stw r28, 0xb80(r29)
/* 80AC2724  38 00 00 06 */	li r0, 6
/* 80AC2728  90 1D 0B 7C */	stw r0, 0xb7c(r29)
/* 80AC272C  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2730  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
/* 80AC2734  D0 1D 0B 8C */	stfs f0, 0xb8c(r29)
/* 80AC2738  48 00 00 14 */	b lbl_80AC274C
lbl_80AC273C:
/* 80AC273C  38 60 01 6C */	li r3, 0x16c
/* 80AC2740  4B 68 A2 ED */	bl daNpcT_onEvtBit__FUl
/* 80AC2744  38 7D 09 74 */	addi r3, r29, 0x974
/* 80AC2748  4B 78 7D 7D */	bl remove__10dMsgFlow_cFv
lbl_80AC274C:
...
/* 80AC2798  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha /* 0x80450FDC@ha */
/* 80AC279C  90 03 0F DC */	stw r0, mFindCount__8daNpcT_c@l(r3)  /* 0x80450FDC@l */
/* 80AC27A0  3C 60 80 AC */	lis r3, srchYm__12daNpc_Saru_cFPvPv@ha /* 0x80AC0B64@ha */
/* 80AC27A4  38 63 0B 64 */	addi r3, r3, srchYm__12daNpc_Saru_cFPvPv@l /* 0x80AC0B64@l */
/* 80AC27A8  7F A4 EB 78 */	mr r4, r29
/* 80AC27AC  4B 55 70 4D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80AC27B0  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha /* 0x80450FDC@ha */
/* 80AC27B4  80 03 0F DC */	lwz r0, mFindCount__8daNpcT_c@l(r3)  /* 0x80450FDC@l */
...
/* 80AC281C  4B 68 32 09 */	bl checkEndSequence__22daNpcT_MotionSeqMngr_cFv
...
/* 80AC2844  4B 68 94 35 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 80AC2868  4B 68 31 BD */	bl checkEndSequence__22daNpcT_MotionSeqMngr_cFv
...
/* 80AC2890  4B 89 F9 89 */	bl _restgpr_25
