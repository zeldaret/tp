...
/* 80AC2378  4B 89 FE 5D */	bl _savegpr_27
/* 80AC237C  7C 7D 1B 78 */	mr r29, r3
/* 80AC2380  7C 9B 23 78 */	mr r27, r4
/* 80AC2384  3B E0 00 00 */	li r31, 0
/* 80AC2388  3B C0 FF FF */	li r30, -1
/* 80AC238C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AC2390  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AC2394  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 80AC2398  7F 83 E3 78 */	mr r3, r28
/* 80AC239C  3C A0 80 AC */	lis r5, d_a_npc_saru__stringBase0@ha /* 0x80AC4654@ha */
/* 80AC23A0  38 A5 46 54 */	addi r5, r5, d_a_npc_saru__stringBase0@l /* 0x80AC4654@l */
/* 80AC23A4  38 A5 00 42 */	addi r5, r5, 0x42
/* 80AC23A8  38 C0 00 03 */	li r6, 3
/* 80AC23AC  4B 58 5D 41 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80AC23C4  4B 58 59 89 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80AC23FC  4B 68 34 9D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2400  93 9D 0B 5C */	stw r28, 0xb5c(r29)
/* 80AC2404  38 00 00 00 */	li r0, 0
/* 80AC2408  90 1D 0B 58 */	stw r0, 0xb58(r29)
/* 80AC240C  3C 60 80 AC */	lis r3, lit_4231@ha /* 0x80AC45AC@ha */
/* 80AC2410  C0 03 45 AC */	lfs f0, lit_4231@l(r3)  /* 0x80AC45AC@l */
...
/* 80AC242C  4B 68 34 6D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2430  93 9D 0B 80 */	stw r28, 0xb80(r29)
/* 80AC2434  38 00 00 09 */	li r0, 9
/* 80AC2438  90 1D 0B 7C */	stw r0, 0xb7c(r29)
/* 80AC243C  3C 60 80 AC */	lis r3, lit_4231@ha /* 0x80AC45AC@ha */
/* 80AC2440  C0 03 45 AC */	lfs f0, lit_4231@l(r3)  /* 0x80AC45AC@l */
...
/* 80AC2460  4B 68 34 39 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2464  93 9D 0B 5C */	stw r28, 0xb5c(r29)
/* 80AC2468  38 00 00 00 */	li r0, 0
/* 80AC246C  90 1D 0B 58 */	stw r0, 0xb58(r29)
/* 80AC2470  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC2474  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC2490  4B 68 34 09 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80AC2494  93 9D 0B 80 */	stw r28, 0xb80(r29)
/* 80AC2498  38 00 00 0A */	li r0, 0xa
/* 80AC249C  90 1D 0B 7C */	stw r0, 0xb7c(r29)
/* 80AC24A0  3C 60 80 AC */	lis r3, lit_4608@ha /* 0x80AC45CC@ha */
/* 80AC24A4  C0 03 45 CC */	lfs f0, lit_4608@l(r3)  /* 0x80AC45CC@l */
...
/* 80AC24E4  4B 68 32 19 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AC24E8  38 00 00 00 */	li r0, 0
/* 80AC24EC  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 80AC24F0  3C 60 80 AC */	lis r3, lit_4231@ha /* 0x80AC45AC@ha */
/* 80AC24F4  C0 03 45 AC */	lfs f0, lit_4231@l(r3)  /* 0x80AC45AC@l */
...
/* 80AC2524  4B 68 31 D9 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AC2528  38 00 00 00 */	li r0, 0
/* 80AC252C  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 80AC2530  3C 60 80 AC */	lis r3, lit_4231@ha /* 0x80AC45AC@ha */
/* 80AC2534  C0 03 45 AC */	lfs f0, lit_4231@l(r3)  /* 0x80AC45AC@l */
...
/* 80AC2578  4B 68 90 D1 */	bl step__8daNpcT_cFsiiii
lbl_80AC257C:
/* 80AC257C  7F E3 FB 78 */	mr r3, r31
/* 80AC2580  39 61 00 20 */	addi r11, r1, 0x20
/* 80AC2584  4B 89 FC 9D */	bl _restgpr_27
