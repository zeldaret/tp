...
/* 80AC3FE8  4B 89 E1 F4 */	b _savegpr_29
/* 80AC3FEC  7C 7F 1B 78 */	mr r31, r3
/* 80AC3FF0  7C 80 23 78 */	mr r0, r4
/* 80AC3FF4  FF E0 08 90 */	fmr f31, f1
/* 80AC3FF8  7C BD 2B 78 */	mr r29, r5
/* 80AC3FFC  3C 60 80 AC */	lis r3, m__18daNpc_Saru_Param_c@ha
/* 80AC4000  3B C3 44 F8 */	addi r30, r3, m__18daNpc_Saru_Param_c@l
...
/* 80AC401C  4B 7A 2B 18 */	b __mi__4cXyzCFRC3Vec
...
/* 80AC404C  4B 88 30 EC */	b PSVECSquareMag
...
/* 80AC40BC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AC40C0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80AC412C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AC4130  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80AC4134  48 00 00 08 */	b lbl_80AC413C
lbl_80AC4138:
/* 80AC4138  FC 40 08 90 */	fmr f2, f1
lbl_80AC413C:
/* 80AC413C  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80AC4140  4B 7A 35 34 */	b cM_atan2s__Fff
...
/* 80AC41C4  4B 89 E0 64 */	b _restgpr_29
