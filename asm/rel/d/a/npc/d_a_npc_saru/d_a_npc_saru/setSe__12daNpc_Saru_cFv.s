...
/* 80AC1C5C  4B 8A 05 81 */	bl _savegpr_29
/* 80AC1C60  7C 7D 1B 78 */	mr r29, r3
/* 80AC1C64  3C 60 80 AC */	lis r3, m__18daNpc_Saru_Param_c@ha /* 0x80AC44F8@ha */
/* 80AC1C68  3B E3 44 F8 */	addi r31, r3, m__18daNpc_Saru_Param_c@l /* 0x80AC44F8@l */
...
/* 80AC1C7C  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 80AC1C80  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 80AC1C94  3C 60 80 AC */	lis r3, l_motionAnmData@ha /* 0x80AC473C@ha */
/* 80AC1C98  38 83 47 3C */	addi r4, r3, l_motionAnmData@l /* 0x80AC473C@l */
/* 80AC1C9C  80 04 02 C4 */	lwz r0, 0x2c4(r4)
/* 80AC1CA0  54 00 10 3A */	slwi r0, r0, 2
/* 80AC1CA4  3C 60 80 AC */	lis r3, l_resNameList@ha /* 0x80AC46FC@ha */
/* 80AC1CA8  38 63 46 FC */	addi r3, r3, l_resNameList@l /* 0x80AC46FC@l */
/* 80AC1CAC  7C 63 00 2E */	lwzx r3, r3, r0
/* 80AC1CB0  80 84 02 BC */	lwz r4, 0x2bc(r4)
/* 80AC1CB4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AC1CB8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AC1CCC  4B 57 A6 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AC1CE8  4B 86 67 45 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1D28  4B 86 67 05 */	bl checkPass__12J3DFrameCtrlFf
...
lbl_80AC1D60:
/* 80AC1D60  3C 60 80 AC */	lis r3, l_motionAnmData@ha /* 0x80AC473C@ha */
/* 80AC1D64  38 83 47 3C */	addi r4, r3, l_motionAnmData@l /* 0x80AC473C@l */
/* 80AC1D68  80 04 03 F8 */	lwz r0, 0x3f8(r4)
/* 80AC1D6C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC1D70  3C 60 80 AC */	lis r3, l_resNameList@ha /* 0x80AC46FC@ha */
/* 80AC1D74  38 63 46 FC */	addi r3, r3, l_resNameList@l /* 0x80AC46FC@l */
...
/* 80AC1D88  4B 57 A5 65 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AC1DA4  4B 86 66 89 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1DBC  4B 86 66 71 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1DD4  4B 86 66 59 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1DEC  4B 86 66 41 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1E2C  4B 86 66 01 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1E44  4B 86 65 E9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1E88  4B 86 65 A5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1EA0  4B 86 65 8D */	bl checkPass__12J3DFrameCtrlFf
...
lbl_80AC1ED8:
/* 80AC1ED8  3C 60 80 AC */	lis r3, l_motionAnmData@ha /* 0x80AC473C@ha */
/* 80AC1EDC  38 83 47 3C */	addi r4, r3, l_motionAnmData@l /* 0x80AC473C@l */
/* 80AC1EE0  80 04 01 3C */	lwz r0, 0x13c(r4)
/* 80AC1EE4  54 00 10 3A */	slwi r0, r0, 2
/* 80AC1EE8  3C 60 80 AC */	lis r3, l_resNameList@ha /* 0x80AC46FC@ha */
/* 80AC1EEC  38 63 46 FC */	addi r3, r3, l_resNameList@l /* 0x80AC46FC@l */
...
/* 80AC1F00  4B 57 A3 ED */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AC1F1C  4B 86 65 11 */	bl checkPass__12J3DFrameCtrlFf
...
lbl_80AC1F50:
/* 80AC1F50  3C 60 80 AC */	lis r3, l_motionAnmData@ha /* 0x80AC473C@ha */
/* 80AC1F54  38 83 47 3C */	addi r4, r3, l_motionAnmData@l /* 0x80AC473C@l */
/* 80AC1F58  80 04 04 30 */	lwz r0, 0x430(r4)
/* 80AC1F5C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC1F60  3C 60 80 AC */	lis r3, l_resNameList@ha /* 0x80AC46FC@ha */
/* 80AC1F64  38 63 46 FC */	addi r3, r3, l_resNameList@l /* 0x80AC46FC@l */
...
/* 80AC1F78  4B 57 A3 75 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AC1F94  4B 86 64 99 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1FAC  4B 86 64 81 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC1FEC  4B 86 64 41 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC2004  4B 86 64 29 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC201C  4B 86 64 11 */	bl checkPass__12J3DFrameCtrlFf
...
lbl_80AC2054:
/* 80AC2054  3C 60 80 AC */	lis r3, l_motionAnmData@ha /* 0x80AC473C@ha */
/* 80AC2058  38 83 47 3C */	addi r4, r3, l_motionAnmData@l /* 0x80AC473C@l */
/* 80AC205C  80 04 00 5C */	lwz r0, 0x5c(r4)
/* 80AC2060  54 00 10 3A */	slwi r0, r0, 2
/* 80AC2064  3C 60 80 AC */	lis r3, l_resNameList@ha /* 0x80AC46FC@ha */
/* 80AC2068  38 63 46 FC */	addi r3, r3, l_resNameList@l /* 0x80AC46FC@l */
...
/* 80AC207C  4B 57 A2 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AC2098  4B 86 63 95 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC20D8  4B 86 63 55 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC211C  4B 86 63 11 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80AC2158  4B 8A 00 D1 */	bl _restgpr_29
