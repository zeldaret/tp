...
/* 80AC044C  3C 60 80 AC */	lis r3, __vt__12daNpc_Saru_c@ha /* 0x80AC4F10@ha */
/* 80AC0450  38 03 4F 10 */	addi r0, r3, __vt__12daNpc_Saru_c@l /* 0x80AC4F10@l */
...
/* 80AC0464  4B 55 0E AD */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AC0468:
/* 80AC0468  7F C3 F3 78 */	mr r3, r30
/* 80AC046C  88 1E 0F 88 */	lbz r0, 0xf88(r30)
/* 80AC0470  54 00 10 3A */	slwi r0, r0, 2
/* 80AC0474  3C 80 80 AC */	lis r4, l_loadResPtrnList@ha /* 0x80AC4710@ha */
/* 80AC0478  38 84 47 10 */	addi r4, r4, l_loadResPtrnList@l /* 0x80AC4710@l */
/* 80AC047C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AC0480  3C A0 80 AC */	lis r5, l_resNameList@ha /* 0x80AC46FC@ha */
/* 80AC0484  38 A5 46 FC */	addi r5, r5, l_resNameList@l /* 0x80AC46FC@l */
/* 80AC0488  4B 68 80 25 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80AC048C  34 1E 0F 94 */	addic. r0, r30, 0xf94
/* 80AC0490  41 82 00 10 */	beq lbl_80AC04A0
/* 80AC0494  3C 60 80 AC */	lis r3, __vt__13daNpcT_Path_c@ha /* 0x80AC4F04@ha */
/* 80AC0498  38 03 4F 04 */	addi r0, r3, __vt__13daNpcT_Path_c@l /* 0x80AC4F04@l */
/* 80AC049C  90 1E 0F B8 */	stw r0, 0xfb8(r30)
lbl_80AC04A0:
/* 80AC04A0  38 7E 0F 8C */	addi r3, r30, 0xf8c
/* 80AC04A4  3C 80 80 AC */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha /* 0x80AC3684@ha */
/* 80AC04A8  38 84 36 84 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l /* 0x80AC3684@l */
/* 80AC04AC  38 A0 00 08 */	li r5, 8
/* 80AC04B0  38 C0 00 01 */	li r6, 1
/* 80AC04B4  4B 8A 18 35 */	bl __destroy_arr
/* 80AC04B8  34 1E 0E 4C */	addic. r0, r30, 0xe4c
/* 80AC04BC  41 82 00 84 */	beq lbl_80AC0540
/* 80AC04C0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80AC04C4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80AC04E4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80AC04E8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80AC0500  3C 60 80 AC */	lis r3, __vt__8cM3dGCyl@ha /* 0x80AC4EF8@ha */
/* 80AC0504  38 03 4E F8 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80AC4EF8@l */
/* 80AC0508  90 1E 0F 84 */	stw r0, 0xf84(r30)
lbl_80AC050C:
/* 80AC050C  34 1E 0F 50 */	addic. r0, r30, 0xf50
/* 80AC0510  41 82 00 24 */	beq lbl_80AC0534
/* 80AC0514  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80AC0518  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80AC051C  90 1E 0F 6C */	stw r0, 0xf6c(r30)
/* 80AC0520  34 1E 0F 50 */	addic. r0, r30, 0xf50
/* 80AC0524  41 82 00 10 */	beq lbl_80AC0534
/* 80AC0528  3C 60 80 AC */	lis r3, __vt__8cM3dGAab@ha /* 0x80AC4EEC@ha */
/* 80AC052C  38 03 4E EC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80AC4EEC@l */
/* 80AC0530  90 1E 0F 68 */	stw r0, 0xf68(r30)
lbl_80AC0534:
/* 80AC0534  38 7E 0E 4C */	addi r3, r30, 0xe4c
/* 80AC0538  38 80 00 00 */	li r4, 0
/* 80AC053C  4B 5C 3B A9 */	bl __dt__12dCcD_GObjInfFv
lbl_80AC0540:
...
/* 80AC0558  4B 80 E7 E5 */	bl __dl__FPv
lbl_80AC055C:
