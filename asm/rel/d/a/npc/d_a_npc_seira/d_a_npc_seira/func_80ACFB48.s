...
/* 80ACFB6C  3C 60 80 AD */	lis r3, __vt__13daNpc_Seira_c@ha
/* 80ACFB70  38 03 0A 14 */	addi r0, r3, __vt__13daNpc_Seira_c@l
/* 80ACFB74  90 1F 0E 3C */	stw r0, 0xe3c(r31)
/* 80ACFB78  3B DF 0F 84 */	addi r30, r31, 0xf84
/* 80ACFB7C  7F C3 F3 78 */	mr r3, r30
/* 80ACFB80  4B 5B 3E A8 */	b __ct__12dCcD_GObjInfFv
/* 80ACFB84  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80ACFB88  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80ACFB8C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80ACFB90  3C 60 80 AD */	lis r3, __vt__8cM3dGAab@ha
/* 80ACFB94  38 03 09 FC */	addi r0, r3, __vt__8cM3dGAab@l
/* 80ACFB98  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80ACFB9C  3C 60 80 AD */	lis r3, __vt__8cM3dGCyl@ha
/* 80ACFBA0  38 03 0A 08 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80ACFBA4  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80ACFBA8  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80ACFBAC  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80ACFBB0  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80ACFBB4  38 03 00 58 */	addi r0, r3, 0x58
/* 80ACFBB8  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80ACFBBC  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80ACFBC0  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80ACFBDC  3C 80 80 AD */	lis r4, __ct__18daNpcT_ActorMngr_cFv@ha
/* 80ACFBE0  38 84 EE 30 */	addi r4, r4, __ct__18daNpcT_ActorMngr_cFv@l
/* 80ACFBE4  3C A0 80 AD */	lis r5, __dt__18daNpcT_ActorMngr_cFv@ha
/* 80ACFBE8  38 A5 ED E8 */	addi r5, r5, __dt__18daNpcT_ActorMngr_cFv@l
/* 80ACFBEC  38 C0 00 08 */	li r6, 8
/* 80ACFBF0  38 E0 00 03 */	li r7, 3
/* 80ACFBF4  4B 89 21 6C */	b __construct_array
