...
/* 80ACDEC0  4B 67 79 D9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80ACDEC4  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 80ACDEC8  38 00 00 02 */	li r0, 2
/* 80ACDECC  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80ACDED0  3C 60 80 AD */	lis r3, lit_4716@ha /* 0x80ACFEB0@ha */
/* 80ACDED4  C0 03 FE B0 */	lfs f0, lit_4716@l(r3)  /* 0x80ACFEB0@l */
...
/* 80ACDEF0  4B 67 79 A9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80ACDEF4  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80ACDEF8  38 00 00 02 */	li r0, 2
/* 80ACDEFC  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80ACDF00  3C 60 80 AD */	lis r3, lit_4716@ha /* 0x80ACFEB0@ha */
/* 80ACDF04  C0 03 FE B0 */	lfs f0, lit_4716@l(r3)  /* 0x80ACFEB0@l */
...
/* 80ACDF1C  4B 67 77 E1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80ACDF20  38 00 00 00 */	li r0, 0
/* 80ACDF24  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80ACDF28  3C 60 80 AD */	lis r3, lit_4063@ha /* 0x80ACFE98@ha */
/* 80ACDF2C  C0 03 FE 98 */	lfs f0, lit_4063@l(r3)  /* 0x80ACFE98@l */
...
/* 80ACDFA0  4B 67 78 F9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80ACDFA4  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 80ACDFA8  38 00 00 03 */	li r0, 3
/* 80ACDFAC  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80ACDFB0  3C 60 80 AD */	lis r3, lit_4716@ha /* 0x80ACFEB0@ha */
/* 80ACDFB4  C0 03 FE B0 */	lfs f0, lit_4716@l(r3)  /* 0x80ACFEB0@l */
...
/* 80ACDFD0  4B 67 78 C9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80ACDFD4  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80ACDFD8  38 00 00 0E */	li r0, 0xe
/* 80ACDFDC  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80ACDFE0  3C 60 80 AD */	lis r3, lit_4716@ha /* 0x80ACFEB0@ha */
/* 80ACDFE4  C0 03 FE B0 */	lfs f0, lit_4716@l(r3)  /* 0x80ACFEB0@l */
/* 80ACDFE8  D0 1F 0B 8C */	stfs f0, 0xb8c(r31)
/* 80ACDFEC  48 00 00 90 */	b lbl_80ACE07C
lbl_80ACDFF0:
/* 80ACDFF0  38 7F 0B 74 */	addi r3, r31, 0xb74
/* 80ACDFF4  4B 67 7A 31 */	bl checkEndSequence__22daNpcT_MotionSeqMngr_cFv
...
/* 80ACE024  4B 67 78 75 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80ACE028  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 80ACE02C  38 00 00 02 */	li r0, 2
/* 80ACE030  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80ACE034  3C 60 80 AD */	lis r3, lit_4716@ha /* 0x80ACFEB0@ha */
/* 80ACE038  C0 03 FE B0 */	lfs f0, lit_4716@l(r3)  /* 0x80ACFEB0@l */
...
/* 80ACE054  4B 67 78 45 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80ACE058  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80ACE05C  38 00 00 02 */	li r0, 2
/* 80ACE060  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80ACE064  3C 60 80 AD */	lis r3, lit_4716@ha /* 0x80ACFEB0@ha */
/* 80ACE068  C0 03 FE B0 */	lfs f0, lit_4716@l(r3)  /* 0x80ACFEB0@l */
