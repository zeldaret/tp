...
/* 80ACB7EC  3C 80 80 AD */	lis r4, __vt__13daNpc_Seira_c@ha /* 0x80AD0A14@ha */
/* 80ACB7F0  38 04 0A 14 */	addi r0, r4, __vt__13daNpc_Seira_c@l /* 0x80AD0A14@l */
/* 80ACB7F4  90 1E 0E 3C */	stw r0, 0xe3c(r30)
/* 80ACB7F8  4B 6C ED 6D */	bl deleteObject__13dShopSystem_cFv
/* 80ACB7FC  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80ACB800  28 03 00 00 */	cmplwi r3, 0
/* 80ACB804  41 82 00 08 */	beq lbl_80ACB80C
/* 80ACB808  4B 54 5B 09 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80ACB80C:
/* 80ACB80C  80 7E 0F 7C */	lwz r3, 0xf7c(r30)
/* 80ACB810  28 03 00 00 */	cmplwi r3, 0
/* 80ACB814  41 82 00 08 */	beq lbl_80ACB81C
/* 80ACB818  4B 54 5A F9 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80ACB81C:
/* 80ACB81C  7F C3 F3 78 */	mr r3, r30
/* 80ACB820  88 1E 10 C1 */	lbz r0, 0x10c1(r30)
/* 80ACB824  54 00 10 3A */	slwi r0, r0, 2
/* 80ACB828  3C 80 80 AD */	lis r4, l_loadResPtrnList@ha /* 0x80ACFFFC@ha */
/* 80ACB82C  38 84 FF FC */	addi r4, r4, l_loadResPtrnList@l /* 0x80ACFFFC@l */
/* 80ACB830  7C 84 00 2E */	lwzx r4, r4, r0
/* 80ACB834  3C A0 80 AD */	lis r5, l_resNameList@ha /* 0x80ACFFE0@ha */
/* 80ACB838  38 A5 FF E0 */	addi r5, r5, l_resNameList@l /* 0x80ACFFE0@l */
/* 80ACB83C  4B 67 CC 71 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80ACB840  38 7E 10 C4 */	addi r3, r30, 0x10c4
/* 80ACB844  3C 80 80 AD */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha /* 0x80ACEDE8@ha */
/* 80ACB848  38 84 ED E8 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l /* 0x80ACEDE8@l */
/* 80ACB84C  38 A0 00 08 */	li r5, 8
/* 80ACB850  38 C0 00 03 */	li r6, 3
/* 80ACB854  4B 89 64 95 */	bl __destroy_arr
/* 80ACB858  34 1E 0F 84 */	addic. r0, r30, 0xf84
/* 80ACB85C  41 82 00 84 */	beq lbl_80ACB8E0
/* 80ACB860  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80ACB864  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80ACB884  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80ACB888  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80ACB8A0  3C 60 80 AD */	lis r3, __vt__8cM3dGCyl@ha /* 0x80AD0A08@ha */
/* 80ACB8A4  38 03 0A 08 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80AD0A08@l */
/* 80ACB8A8  90 1E 10 BC */	stw r0, 0x10bc(r30)
lbl_80ACB8AC:
/* 80ACB8AC  34 1E 10 88 */	addic. r0, r30, 0x1088
/* 80ACB8B0  41 82 00 24 */	beq lbl_80ACB8D4
/* 80ACB8B4  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80ACB8B8  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80ACB8BC  90 1E 10 A4 */	stw r0, 0x10a4(r30)
/* 80ACB8C0  34 1E 10 88 */	addic. r0, r30, 0x1088
/* 80ACB8C4  41 82 00 10 */	beq lbl_80ACB8D4
/* 80ACB8C8  3C 60 80 AD */	lis r3, __vt__8cM3dGAab@ha /* 0x80AD09FC@ha */
/* 80ACB8CC  38 03 09 FC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80AD09FC@l */
/* 80ACB8D0  90 1E 10 A0 */	stw r0, 0x10a0(r30)
lbl_80ACB8D4:
/* 80ACB8D4  38 7E 0F 84 */	addi r3, r30, 0xf84
/* 80ACB8D8  38 80 00 00 */	li r4, 0
/* 80ACB8DC  4B 5B 88 09 */	bl __dt__12dCcD_GObjInfFv
lbl_80ACB8E0:
/* 80ACB8E0  7F C3 F3 78 */	mr r3, r30
/* 80ACB8E4  38 80 00 00 */	li r4, 0
/* 80ACB8E8  4B 6C BB FD */	bl __dt__13dShopSystem_cFv
/* 80ACB8EC  7F E0 07 35 */	extsh. r0, r31
/* 80ACB8F0  40 81 00 0C */	ble lbl_80ACB8FC
/* 80ACB8F4  7F C3 F3 78 */	mr r3, r30
/* 80ACB8F8  4B 80 34 45 */	bl __dl__FPv
lbl_80ACB8FC:
