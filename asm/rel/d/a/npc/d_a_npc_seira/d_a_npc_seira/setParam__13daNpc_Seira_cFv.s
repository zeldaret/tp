...
/* 80ACC6AC  4B 89 5B 29 */	bl _savegpr_27
...
/* 80ACC6D0  4B 6C 9C E5 */	bl Reset__16ShopCam_action_cFv
/* 80ACC6D4  48 00 00 0C */	b lbl_80ACC6E0
lbl_80ACC6D8:
/* 80ACC6D8  38 7F 0E 78 */	addi r3, r31, 0xe78
/* 80ACC6DC  4B 6C 9C 81 */	bl EventRecoverNotime__16ShopCam_action_cFv
lbl_80ACC6E0:
...
/* 80ACC6F8  3C 60 80 AD */	lis r3, m__19daNpc_Seira_Param_c@ha /* 0x80ACFDF0@ha */
/* 80ACC6FC  38 63 FD F0 */	addi r3, r3, m__19daNpc_Seira_Param_c@l /* 0x80ACFDF0@l */
...
lbl_80ACC72C:
/* 80ACC72C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80ACC730  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80ACC760  4B 68 02 B9 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80ACC778  4B 68 02 A1 */	bl daNpcT_getDistTableIdx__Fii
/* 80ACC77C  98 7F 05 47 */	stb r3, 0x547(r31)
/* 80ACC780  38 00 00 0A */	li r0, 0xa
/* 80ACC784  90 1F 05 5C */	stw r0, 0x55c(r31)
/* 80ACC788  3C 60 80 AD */	lis r3, m__19daNpc_Seira_Param_c@ha /* 0x80ACFDF0@ha */
/* 80ACC78C  38 63 FD F0 */	addi r3, r3, m__19daNpc_Seira_Param_c@l /* 0x80ACFDF0@l */
...
/* 80ACC7CC  4B 5A 97 75 */	bl SetWallR__12dBgS_AcchCirFf
/* 80ACC7D0  3C 60 80 AD */	lis r3, m__19daNpc_Seira_Param_c@ha /* 0x80ACFDF0@ha */
/* 80ACC7D4  38 63 FD F0 */	addi r3, r3, m__19daNpc_Seira_Param_c@l /* 0x80ACFDF0@l */
...
/* 80ACC804  4B 89 5A 1D */	bl _restgpr_27
