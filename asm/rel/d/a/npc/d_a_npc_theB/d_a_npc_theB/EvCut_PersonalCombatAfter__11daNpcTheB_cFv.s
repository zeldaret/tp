...
/* 80AFFBC4  4B 86 26 11 */	bl _savegpr_27
/* 80AFFBC8  7C 7D 1B 78 */	mr r29, r3
/* 80AFFBCC  3C 60 80 B0 */	lis r3, m__17daNpcTheB_Param_c@ha /* 0x80B00D6C@ha */
/* 80AFFBD0  3B E3 0D 6C */	addi r31, r3, m__17daNpcTheB_Param_c@l /* 0x80B00D6C@l */
/* 80AFFBD4  80 1D 04 A4 */	lwz r0, 0x4a4(r29)
/* 80AFFBD8  90 01 00 08 */	stw r0, 8(r1)
/* 80AFFBDC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80AFFBE0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80AFFBE4  38 81 00 08 */	addi r4, r1, 8
/* 80AFFBE8  4B 51 9C 11 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80AFFBFC  3C 60 80 B0 */	lis r3, lit_5334@ha /* 0x80B011B4@ha */
/* 80AFFC00  38 63 11 B4 */	addi r3, r3, lit_5334@l /* 0x80B011B4@l */
...
lbl_80AFFC14:
/* 80AFFC14  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AFFC18  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AFFC3C  4B 50 D1 29 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80AFFC40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AFFC44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AFFC48  3B 7C 04 E4 */	addi r27, r28, 0x4e4
/* 80AFFC4C  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 80AFFC50  4B 50 C7 E5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80AFFC54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AFFC58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AFFC5C  38 81 00 14 */	addi r4, r1, 0x14
/* 80AFFC60  7C 85 23 78 */	mr r5, r4
/* 80AFFC64  4B 84 71 09 */	bl PSMTXMultVec
/* 80AFFC68  38 61 00 14 */	addi r3, r1, 0x14
/* 80AFFC6C  4B 51 E0 51 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80AFFC70  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80AFFC74  41 82 00 10 */	beq lbl_80AFFC84
/* 80AFFC78  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80AFFC7C  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 80AFFC90  4B E9 E0 99 */	bl setPosAngle__12daNpcCoach_cFR4cXyzR5csXyz
...
/* 80AFFCB0  4B 65 0A 0D */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 80AFFD00  4B 52 16 59 */	bl fpcEx_SearchByID__FUi
...
/* 80AFFD24  4B 65 3F F9 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
...
/* 80AFFD48  4B 65 40 3D */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80AFFD6C  4B 65 09 75 */	bl remove__18daNpcF_ActorMngr_cFv
...
/* 80AFFDA0  4B 65 39 79 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80AFFEE0  4B 86 23 41 */	bl _restgpr_27
