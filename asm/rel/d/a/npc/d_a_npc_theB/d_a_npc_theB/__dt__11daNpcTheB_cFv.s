...
/* 80AFC9A0  3C 60 80 B0 */	lis r3, __vt__11daNpcTheB_c@ha /* 0x80B01230@ha */
/* 80AFC9A4  38 03 12 30 */	addi r0, r3, __vt__11daNpcTheB_c@l /* 0x80B01230@l */
/* 80AFC9A8  90 1E 0B 44 */	stw r0, 0xb44(r30)
/* 80AFC9AC  38 7E 0D D8 */	addi r3, r30, 0xdd8
/* 80AFC9B0  3C 80 80 B0 */	lis r4, l_arcName@ha /* 0x80B010E4@ha */
/* 80AFC9B4  38 84 10 E4 */	addi r4, r4, l_arcName@l /* 0x80B010E4@l */
/* 80AFC9B8  80 84 00 00 */	lwz r4, 0(r4)
/* 80AFC9BC  4B 53 06 4D */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80AFC9D0  4B 51 49 41 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AFC9D4:
/* 80AFC9D4  34 1E 0C 84 */	addic. r0, r30, 0xc84
/* 80AFC9D8  41 82 00 84 */	beq lbl_80AFCA5C
/* 80AFC9DC  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80AFC9E0  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80AFCA00  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80AFCA04  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80AFCA1C  3C 60 80 B0 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80B012D8@ha */
/* 80AFCA20  38 03 12 D8 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80B012D8@l */
/* 80AFCA24  90 1E 0D BC */	stw r0, 0xdbc(r30)
lbl_80AFCA28:
/* 80AFCA28  34 1E 0D 88 */	addic. r0, r30, 0xd88
/* 80AFCA2C  41 82 00 24 */	beq lbl_80AFCA50
/* 80AFCA30  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80AFCA34  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80AFCA38  90 1E 0D A4 */	stw r0, 0xda4(r30)
/* 80AFCA3C  34 1E 0D 88 */	addic. r0, r30, 0xd88
/* 80AFCA40  41 82 00 10 */	beq lbl_80AFCA50
/* 80AFCA44  3C 60 80 B0 */	lis r3, __vt__8cM3dGAab@ha /* 0x80B012E4@ha */
/* 80AFCA48  38 03 12 E4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80B012E4@l */
/* 80AFCA4C  90 1E 0D A0 */	stw r0, 0xda0(r30)
lbl_80AFCA50:
/* 80AFCA50  38 7E 0C 84 */	addi r3, r30, 0xc84
/* 80AFCA54  38 80 00 00 */	li r4, 0
/* 80AFCA58  4B 58 76 8D */	bl __dt__12dCcD_GObjInfFv
lbl_80AFCA5C:
/* 80AFCA5C  38 7E 0C 78 */	addi r3, r30, 0xc78
/* 80AFCA60  3C 80 80 B0 */	lis r4, __dt__18daNpcF_ActorMngr_cFv@ha /* 0x80B0042C@ha */
/* 80AFCA64  38 84 04 2C */	addi r4, r4, __dt__18daNpcF_ActorMngr_cFv@l /* 0x80B0042C@l */
/* 80AFCA68  38 A0 00 08 */	li r5, 8
/* 80AFCA6C  38 C0 00 01 */	li r6, 1
/* 80AFCA70  4B 86 52 79 */	bl __destroy_arr
/* 80AFCA74  34 1E 0B DC */	addic. r0, r30, 0xbdc
/* 80AFCA78  41 82 00 88 */	beq lbl_80AFCB00
/* 80AFCA7C  3C 60 80 B0 */	lis r3, __vt__15daNpcF_Lookat_c@ha /* 0x80B012F0@ha */
/* 80AFCA80  38 03 12 F0 */	addi r0, r3, __vt__15daNpcF_Lookat_c@l /* 0x80B012F0@l */
/* 80AFCA84  90 1E 0C 74 */	stw r0, 0xc74(r30)
/* 80AFCA88  38 7E 0C 58 */	addi r3, r30, 0xc58
/* 80AFCA8C  3C 80 80 B0 */	lis r4, __dt__5csXyzFv@ha /* 0x80B00580@ha */
/* 80AFCA90  38 84 05 80 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80B00580@l */
/* 80AFCA94  38 A0 00 06 */	li r5, 6
/* 80AFCA98  38 C0 00 04 */	li r6, 4
/* 80AFCA9C  4B 86 52 4D */	bl __destroy_arr
/* 80AFCAA0  38 7E 0C 40 */	addi r3, r30, 0xc40
/* 80AFCAA4  3C 80 80 B0 */	lis r4, __dt__5csXyzFv@ha /* 0x80B00580@ha */
/* 80AFCAA8  38 84 05 80 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80B00580@l */
/* 80AFCAAC  38 A0 00 06 */	li r5, 6
/* 80AFCAB0  38 C0 00 04 */	li r6, 4
/* 80AFCAB4  4B 86 52 35 */	bl __destroy_arr
/* 80AFCAB8  38 7E 0C 28 */	addi r3, r30, 0xc28
/* 80AFCABC  3C 80 80 B0 */	lis r4, __dt__5csXyzFv@ha /* 0x80B00580@ha */
/* 80AFCAC0  38 84 05 80 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80B00580@l */
/* 80AFCAC4  38 A0 00 06 */	li r5, 6
/* 80AFCAC8  38 C0 00 04 */	li r6, 4
/* 80AFCACC  4B 86 52 1D */	bl __destroy_arr
/* 80AFCAD0  38 7E 0C 10 */	addi r3, r30, 0xc10
/* 80AFCAD4  3C 80 80 B0 */	lis r4, __dt__5csXyzFv@ha /* 0x80B00580@ha */
/* 80AFCAD8  38 84 05 80 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80B00580@l */
/* 80AFCADC  38 A0 00 06 */	li r5, 6
/* 80AFCAE0  38 C0 00 04 */	li r6, 4
/* 80AFCAE4  4B 86 52 05 */	bl __destroy_arr
/* 80AFCAE8  38 7E 0B DC */	addi r3, r30, 0xbdc
/* 80AFCAEC  3C 80 80 B0 */	lis r4, __dt__4cXyzFv@ha /* 0x80B005C0@ha */
/* 80AFCAF0  38 84 05 C0 */	addi r4, r4, __dt__4cXyzFv@l /* 0x80B005C0@l */
/* 80AFCAF4  38 A0 00 0C */	li r5, 0xc
/* 80AFCAF8  38 C0 00 04 */	li r6, 4
/* 80AFCAFC  4B 86 51 ED */	bl __destroy_arr
lbl_80AFCB00:
/* 80AFCB00  38 7E 0B 48 */	addi r3, r30, 0xb48
/* 80AFCB04  38 80 FF FF */	li r4, -1
/* 80AFCB08  4B 7C 39 19 */	bl __dt__10Z2CreatureFv
...
/* 80AFCB24  4B 7D 22 19 */	bl __dl__FPv
lbl_80AFCB28:
