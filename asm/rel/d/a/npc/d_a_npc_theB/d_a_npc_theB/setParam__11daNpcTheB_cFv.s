...
/* 80AFD948  4B 86 48 85 */	bl _savegpr_25
...
/* 80AFD968  3C 60 80 B0 */	lis r3, m__17daNpcTheB_Param_c@ha /* 0x80B00D6C@ha */
/* 80AFD96C  38 63 0D 6C */	addi r3, r3, m__17daNpcTheB_Param_c@l /* 0x80B00D6C@l */
...
/* 80AFD988  4B 86 46 C1 */	bl __ptmf_cmpr
...
/* 80AFD9A8  4B 65 2D 09 */	bl initialize__18daNpcF_ActorMngr_cFv
...
/* 80AFD9D4  4B 65 68 A5 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 80AFD9F0  4B 65 68 89 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 80AFDA0C  4B 52 39 4D */	bl fpcEx_SearchByID__FUi
/* 80AFDA10  C0 23 05 2C */	lfs f1, 0x52c(r3)
/* 80AFDA14  3C 60 80 B0 */	lis r3, lit_4248@ha /* 0x80B00DF0@ha */
/* 80AFDA18  C0 03 0D F0 */	lfs f0, lit_4248@l(r3)  /* 0x80B00DF0@l */
...
/* 80AFDA3C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AFDA40  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AFDA44  38 63 09 78 */	addi r3, r3, 0x978
/* 80AFDA48  38 80 00 37 */	li r4, 0x37
/* 80AFDA4C  4B 53 71 9D */	bl isSwitch__12dSv_danBit_cCFi
...
/* 80AFDA64  3C 80 80 B0 */	lis r4, m__17daNpcTheB_Param_c@ha /* 0x80B00D6C@ha */
/* 80AFDA68  38 84 0D 6C */	addi r4, r4, m__17daNpcTheB_Param_c@l /* 0x80B00D6C@l */
/* 80AFDA6C  C0 24 00 1C */	lfs f1, 0x1c(r4)
/* 80AFDA70  4B 57 84 D1 */	bl SetWallR__12dBgS_AcchCirFf
/* 80AFDA74  3C 60 80 B0 */	lis r3, m__17daNpcTheB_Param_c@ha /* 0x80B00D6C@ha */
/* 80AFDA78  38 63 0D 6C */	addi r3, r3, m__17daNpcTheB_Param_c@l /* 0x80B00D6C@l */
...
/* 80AFDA90  4B 86 47 89 */	bl _restgpr_25
