...
/* 80AFEA24  4B 86 37 B1 */	bl _savegpr_27
/* 80AFEA28  7C 7B 1B 78 */	mr r27, r3
/* 80AFEA2C  3C 60 80 B0 */	lis r3, cNullVec__6Z2Calc@ha /* 0x80B01028@ha */
/* 80AFEA30  3B C3 10 28 */	addi r30, r3, cNullVec__6Z2Calc@l /* 0x80B01028@l */
/* 80AFEA34  3B 80 00 00 */	li r28, 0
/* 80AFEA38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AFEA3C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AFEA78  4B 86 35 D1 */	bl __ptmf_cmpr
...
/* 80AFEA90  4B 86 35 F5 */	bl __ptmf_scall
/* 80AFEA94  60 00 00 00 */	nop 
/* 80AFEA98  48 00 00 F4 */	b lbl_80AFEB8C
lbl_80AFEA9C:
/* 80AFEA9C  38 00 00 00 */	li r0, 0
/* 80AFEAA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AFEAA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AFEACC  4B 54 9D 25 */	bl ChkPresentEnd__16dEvent_manager_cFv
...
/* 80AFEAFC  4B 86 35 1D */	bl __ptmf_test
...
/* 80AFEB14  4B 86 35 71 */	bl __ptmf_scall
...
/* 80AFEB40  4B 86 34 D9 */	bl __ptmf_test
...
/* 80AFEB58  4B 86 35 2D */	bl __ptmf_scall
/* 80AFEB5C  60 00 00 00 */	nop 
lbl_80AFEB60:
/* 80AFEB60  80 1B 04 A4 */	lwz r0, 0x4a4(r27)
/* 80AFEB64  90 01 00 10 */	stw r0, 0x10(r1)
/* 80AFEB68  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80AFEB6C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80AFEB70  38 81 00 10 */	addi r4, r1, 0x10
/* 80AFEB74  4B 51 AC 85 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80AFEBA8  4B 54 8F 75 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80AFEBC4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80AFEBC8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80AFEBCC  38 81 00 0C */	addi r4, r1, 0xc
/* 80AFEBD0  4B 51 AC 29 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80AFEC00  4B 86 34 85 */	bl __ptmf_scall
...
/* 80AFEC18  4B 54 95 65 */	bl cutEnd__16dEvent_manager_cFi
lbl_80AFEC1C:
/* 80AFEC1C  3B 80 00 01 */	li r28, 1
/* 80AFEC20  48 00 00 80 */	b lbl_80AFECA0
lbl_80AFEC24:
/* 80AFEC24  38 7F 4E 00 */	addi r3, r31, 0x4e00
/* 80AFEC28  3C 80 80 B0 */	lis r4, d_a_npc_theB__stringBase0@ha /* 0x80B00FA0@ha */
/* 80AFEC2C  38 84 0F A0 */	addi r4, r4, d_a_npc_theB__stringBase0@l /* 0x80B00FA0@l */
/* 80AFEC30  38 84 00 76 */	addi r4, r4, 0x76
/* 80AFEC34  4B 86 9D 61 */	bl strcmp
...
/* 80AFEC64  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 80AFEC68  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 80AFEC6C  38 81 00 08 */	addi r4, r1, 8
/* 80AFEC70  4B 51 AB 89 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80AFED10  4B 86 35 11 */	bl _restgpr_27
