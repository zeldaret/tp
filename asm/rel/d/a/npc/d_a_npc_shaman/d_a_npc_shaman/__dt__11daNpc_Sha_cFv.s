...
/* 80AE2DEC  3C 60 80 AE */	lis r3, __vt__11daNpc_Sha_c@ha
/* 80AE2DF0  38 03 77 60 */	addi r0, r3, __vt__11daNpc_Sha_c@l
...
/* 80AE2E04  4B 52 E5 0C */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AE2E08:
/* 80AE2E08  7F C3 F3 78 */	mr r3, r30
/* 80AE2E0C  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 80AE2E10  54 00 10 3A */	slwi r0, r0, 2
/* 80AE2E14  3C 80 80 AE */	lis r4, l_loadResPtrnList@ha
/* 80AE2E18  38 84 6D 7C */	addi r4, r4, l_loadResPtrnList@l
/* 80AE2E1C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AE2E20  3C A0 80 AE */	lis r5, l_resNameList@ha
/* 80AE2E24  38 A5 6D 70 */	addi r5, r5, l_resNameList@l
/* 80AE2E28  4B 66 56 84 */	b deleteRes__8daNpcT_cFPCScPPCc
/* 80AE2E2C  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80AE2E30  41 82 00 84 */	beq lbl_80AE2EB4
/* 80AE2E34  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80AE2E38  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80AE2E58  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80AE2E5C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80AE2E74  3C 60 80 AE */	lis r3, __vt__8cM3dGCyl@ha
/* 80AE2E78  38 03 77 54 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80AE2E7C  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_80AE2E80:
/* 80AE2E80  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80AE2E84  41 82 00 24 */	beq lbl_80AE2EA8
/* 80AE2E88  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80AE2E8C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80AE2E90  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 80AE2E94  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80AE2E98  41 82 00 10 */	beq lbl_80AE2EA8
/* 80AE2E9C  3C 60 80 AE */	lis r3, __vt__8cM3dGAab@ha
/* 80AE2EA0  38 03 77 48 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80AE2EA4  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_80AE2EA8:
/* 80AE2EA8  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80AE2EAC  38 80 00 00 */	li r4, 0
/* 80AE2EB0  4B 5A 12 34 */	b __dt__12dCcD_GObjInfFv
lbl_80AE2EB4:
...
/* 80AE2ECC  4B 7E BE 70 */	b __dl__FPv
lbl_80AE2ED0:
