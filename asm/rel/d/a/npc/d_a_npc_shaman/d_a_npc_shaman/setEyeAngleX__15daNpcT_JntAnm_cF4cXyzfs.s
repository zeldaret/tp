...
/* 80AE6170  4B 87 C0 6C */	b _savegpr_29
/* 80AE6174  7C 7F 1B 78 */	mr r31, r3
/* 80AE6178  7C 80 23 78 */	mr r0, r4
/* 80AE617C  FF E0 08 90 */	fmr f31, f1
/* 80AE6180  7C BD 2B 78 */	mr r29, r5
/* 80AE6184  3C 60 80 AE */	lis r3, m__17daNpc_Sha_Param_c@ha
/* 80AE6188  3B C3 6B C8 */	addi r30, r3, m__17daNpc_Sha_Param_c@l
...
/* 80AE61A4  4B 78 09 90 */	b __mi__4cXyzCFRC3Vec
...
/* 80AE61D4  4B 86 0F 64 */	b PSVECSquareMag
...
/* 80AE6244  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AE6248  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80AE62B4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AE62B8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80AE62BC  48 00 00 08 */	b lbl_80AE62C4
lbl_80AE62C0:
/* 80AE62C0  FC 40 08 90 */	fmr f2, f1
lbl_80AE62C4:
/* 80AE62C4  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80AE62C8  4B 78 13 AC */	b cM_atan2s__Fff
...
/* 80AE634C  4B 87 BE DC */	b _restgpr_29
