...
/* 809AB7CC  4B 7A 70 FD */	bl initialize__8daNpcF_cFv
/* 809AB7D0  38 7F 0B F0 */	addi r3, r31, 0xbf0
/* 809AB7D4  4B 7A 58 65 */	bl initialize__15daNpcF_Lookat_cFv
/* 809AB7D8  38 7F 0C 8C */	addi r3, r31, 0xc8c
/* 809AB7DC  4B 7A 4E D5 */	bl initialize__18daNpcF_ActorMngr_cFv
/* 809AB7E0  38 A0 00 00 */	li r5, 0
/* 809AB7E4  90 BF 0D F4 */	stw r5, 0xdf4(r31)
/* 809AB7E8  90 BF 0D F8 */	stw r5, 0xdf8(r31)
/* 809AB7EC  3C 60 80 3A */	lis r3, __ptmf_null@ha /* 0x803A2180@ha */
/* 809AB7F0  38 83 21 80 */	addi r4, r3, __ptmf_null@l /* 0x803A2180@l */
...
/* 809AB8B8  3C 60 80 9B */	lis r3, lit_4477@ha /* 0x809ADA3C@ha */
/* 809AB8BC  C0 03 DA 3C */	lfs f0, lit_4477@l(r3)  /* 0x809ADA3C@l */
...
/* 809AB8DC  3C 80 80 9B */	lis r4, l_arcNames@ha /* 0x809ADB9C@ha */
/* 809AB8E0  38 84 DB 9C */	addi r4, r4, l_arcNames@l /* 0x809ADB9C@l */
/* 809AB8E4  80 84 00 00 */	lwz r4, 0(r4)
/* 809AB8E8  38 A0 00 07 */	li r5, 7
/* 809AB8EC  4B 7A 72 7D */	bl getTexPtrnAnmP__8daNpcF_cFPci
...
/* 809AB914  3C C0 80 9B */	lis r6, lit_4319@ha /* 0x809ADA24@ha */
/* 809AB918  C0 26 DA 24 */	lfs f1, lit_4319@l(r6)  /* 0x809ADA24@l */
/* 809AB91C  38 C0 00 02 */	li r6, 2
/* 809AB920  4B 7A 73 A5 */	bl setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
lbl_809AB938:
/* 809AB938  3C 60 80 9B */	lis r3, lit_4449@ha /* 0x809ADBB8@ha */
/* 809AB93C  38 83 DB B8 */	addi r4, r3, lit_4449@l /* 0x809ADBB8@l */
...
/* 809AB964  3C 60 80 9B */	lis r3, lit_4477@ha /* 0x809ADA3C@ha */
/* 809AB968  C0 03 DA 3C */	lfs f0, lit_4477@l(r3)  /* 0x809ADA3C@l */
