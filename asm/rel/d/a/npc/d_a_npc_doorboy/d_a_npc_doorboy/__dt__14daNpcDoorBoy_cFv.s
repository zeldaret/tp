...
/* 809AAEB0  4B 9B 73 21 */	bl _savegpr_26
/* 809AAEB4  7C 7E 1B 79 */	or. r30, r3, r3
/* 809AAEB8  7C 9F 23 78 */	mr r31, r4
/* 809AAEBC  41 82 01 B0 */	beq lbl_809AB06C
/* 809AAEC0  3C 60 80 9B */	lis r3, __vt__14daNpcDoorBoy_c@ha /* 0x809ADC74@ha */
/* 809AAEC4  38 03 DC 74 */	addi r0, r3, __vt__14daNpcDoorBoy_c@l /* 0x809ADC74@l */
...
/* 809AAED8  3C 60 80 9B */	lis r3, l_arcNames@ha /* 0x809ADB9C@ha */
/* 809AAEDC  3B 63 DB 9C */	addi r27, r3, l_arcNames@l /* 0x809ADB9C@l */
lbl_809AAEE0:
/* 809AAEE0  38 7C 0D E0 */	addi r3, r28, 0xde0
/* 809AAEE4  7C 7E 1A 14 */	add r3, r30, r3
/* 809AAEE8  7C 9B E8 2E */	lwzx r4, r27, r29
/* 809AAEEC  4B 68 21 1D */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 809AAF14  4B 66 63 FD */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_809AAF18:
/* 809AAF18  34 1E 0C 98 */	addic. r0, r30, 0xc98
/* 809AAF1C  41 82 00 84 */	beq lbl_809AAFA0
/* 809AAF20  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 809AAF24  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 809AAF44  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 809AAF48  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 809AAF60  3C 60 80 9B */	lis r3, __vt__8cM3dGCyl@ha /* 0x809ADD1C@ha */
/* 809AAF64  38 03 DD 1C */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x809ADD1C@l */
/* 809AAF68  90 1E 0D D0 */	stw r0, 0xdd0(r30)
lbl_809AAF6C:
/* 809AAF6C  34 1E 0D 9C */	addic. r0, r30, 0xd9c
/* 809AAF70  41 82 00 24 */	beq lbl_809AAF94
/* 809AAF74  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 809AAF78  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 809AAF7C  90 1E 0D B8 */	stw r0, 0xdb8(r30)
/* 809AAF80  34 1E 0D 9C */	addic. r0, r30, 0xd9c
/* 809AAF84  41 82 00 10 */	beq lbl_809AAF94
/* 809AAF88  3C 60 80 9B */	lis r3, __vt__8cM3dGAab@ha /* 0x809ADD28@ha */
/* 809AAF8C  38 03 DD 28 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809ADD28@l */
/* 809AAF90  90 1E 0D B4 */	stw r0, 0xdb4(r30)
lbl_809AAF94:
/* 809AAF94  38 7E 0C 98 */	addi r3, r30, 0xc98
/* 809AAF98  38 80 00 00 */	li r4, 0
/* 809AAF9C  4B 6D 91 49 */	bl __dt__12dCcD_GObjInfFv
lbl_809AAFA0:
/* 809AAFA0  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 809AAFA4  3C 80 80 9B */	lis r4, __dt__18daNpcF_ActorMngr_cFv@ha /* 0x809AD0D0@ha */
/* 809AAFA8  38 84 D0 D0 */	addi r4, r4, __dt__18daNpcF_ActorMngr_cFv@l /* 0x809AD0D0@l */
/* 809AAFAC  38 A0 00 08 */	li r5, 8
/* 809AAFB0  38 C0 00 01 */	li r6, 1
/* 809AAFB4  4B 9B 6D 35 */	bl __destroy_arr
/* 809AAFB8  34 1E 0B F0 */	addic. r0, r30, 0xbf0
/* 809AAFBC  41 82 00 88 */	beq lbl_809AB044
/* 809AAFC0  3C 60 80 9B */	lis r3, __vt__15daNpcF_Lookat_c@ha /* 0x809ADD34@ha */
/* 809AAFC4  38 03 DD 34 */	addi r0, r3, __vt__15daNpcF_Lookat_c@l /* 0x809ADD34@l */
/* 809AAFC8  90 1E 0C 88 */	stw r0, 0xc88(r30)
/* 809AAFCC  38 7E 0C 6C */	addi r3, r30, 0xc6c
/* 809AAFD0  3C 80 80 9B */	lis r4, __dt__5csXyzFv@ha /* 0x809AD224@ha */
/* 809AAFD4  38 84 D2 24 */	addi r4, r4, __dt__5csXyzFv@l /* 0x809AD224@l */
/* 809AAFD8  38 A0 00 06 */	li r5, 6
/* 809AAFDC  38 C0 00 04 */	li r6, 4
/* 809AAFE0  4B 9B 6D 09 */	bl __destroy_arr
/* 809AAFE4  38 7E 0C 54 */	addi r3, r30, 0xc54
/* 809AAFE8  3C 80 80 9B */	lis r4, __dt__5csXyzFv@ha /* 0x809AD224@ha */
/* 809AAFEC  38 84 D2 24 */	addi r4, r4, __dt__5csXyzFv@l /* 0x809AD224@l */
/* 809AAFF0  38 A0 00 06 */	li r5, 6
/* 809AAFF4  38 C0 00 04 */	li r6, 4
/* 809AAFF8  4B 9B 6C F1 */	bl __destroy_arr
/* 809AAFFC  38 7E 0C 3C */	addi r3, r30, 0xc3c
/* 809AB000  3C 80 80 9B */	lis r4, __dt__5csXyzFv@ha /* 0x809AD224@ha */
/* 809AB004  38 84 D2 24 */	addi r4, r4, __dt__5csXyzFv@l /* 0x809AD224@l */
/* 809AB008  38 A0 00 06 */	li r5, 6
/* 809AB00C  38 C0 00 04 */	li r6, 4
/* 809AB010  4B 9B 6C D9 */	bl __destroy_arr
/* 809AB014  38 7E 0C 24 */	addi r3, r30, 0xc24
/* 809AB018  3C 80 80 9B */	lis r4, __dt__5csXyzFv@ha /* 0x809AD224@ha */
/* 809AB01C  38 84 D2 24 */	addi r4, r4, __dt__5csXyzFv@l /* 0x809AD224@l */
/* 809AB020  38 A0 00 06 */	li r5, 6
/* 809AB024  38 C0 00 04 */	li r6, 4
/* 809AB028  4B 9B 6C C1 */	bl __destroy_arr
/* 809AB02C  38 7E 0B F0 */	addi r3, r30, 0xbf0
/* 809AB030  3C 80 80 9B */	lis r4, __dt__4cXyzFv@ha /* 0x809AD264@ha */
/* 809AB034  38 84 D2 64 */	addi r4, r4, __dt__4cXyzFv@l /* 0x809AD264@l */
/* 809AB038  38 A0 00 0C */	li r5, 0xc
/* 809AB03C  38 C0 00 04 */	li r6, 4
/* 809AB040  4B 9B 6C A9 */	bl __destroy_arr
lbl_809AB044:
/* 809AB044  38 7E 0B 48 */	addi r3, r30, 0xb48
/* 809AB048  38 80 FF FF */	li r4, -1
/* 809AB04C  4B 91 5C 21 */	bl __dt__17Z2CreatureCitizenFv
...
/* 809AB068  4B 92 3C D5 */	bl __dl__FPv
lbl_809AB06C:
/* 809AB06C  7F C3 F3 78 */	mr r3, r30
/* 809AB070  39 61 00 20 */	addi r11, r1, 0x20
/* 809AB074  4B 9B 71 A9 */	bl _restgpr_26
