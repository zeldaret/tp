...
/* 809ABA44  4B 9B 67 91 */	bl _savegpr_27
/* 809ABA48  7C 7C 1B 78 */	mr r28, r3
/* 809ABA4C  3C 80 80 9B */	lis r4, cNullVec__6Z2Calc@ha /* 0x809ADB28@ha */
/* 809ABA50  3B A4 DB 28 */	addi r29, r4, cNullVec__6Z2Calc@l /* 0x809ADB28@l */
/* 809ABA54  3C 80 80 9B */	lis r4, m__20daNpcDoorBoy_Param_c@ha /* 0x809AD9A8@ha */
/* 809ABA58  3B C4 D9 A8 */	addi r30, r4, m__20daNpcDoorBoy_Param_c@l /* 0x809AD9A8@l */
...
lbl_809ABAB4:
/* 809ABAB4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809ABAB8  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809ABABC  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 809ABAC0  38 BE 00 00 */	addi r5, r30, 0
/* 809ABAC4  C0 25 00 50 */	lfs f1, 0x50(r5)
/* 809ABAC8  4B 7A 7F 29 */	bl chkActorInSight__8daNpcF_cFP10fopAc_ac_cf
/* 809ABACC  2C 03 00 00 */	cmpwi r3, 0
/* 809ABAD0  40 82 00 10 */	bne lbl_809ABAE0
/* 809ABAD4  38 7C 0C 8C */	addi r3, r28, 0xc8c
/* 809ABAD8  4B 7A 4C 09 */	bl remove__18daNpcF_ActorMngr_cFv
/* 809ABADC  48 00 00 78 */	b lbl_809ABB54
lbl_809ABAE0:
/* 809ABAE0  38 7C 0C 8C */	addi r3, r28, 0xc8c
/* 809ABAE4  4B 7A 4C 09 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809ABB00  4B 7A 80 DD */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 809ABB24  4B 7A 80 B9 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 809ABB44  4B 7A 4B 79 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
/* 809ABB48  48 00 00 0C */	b lbl_809ABB54
lbl_809ABB4C:
/* 809ABB4C  38 7C 0C 8C */	addi r3, r28, 0xc8c
/* 809ABB50  4B 7A 4B 91 */	bl remove__18daNpcF_ActorMngr_cFv
lbl_809ABB54:
/* 809ABB54  38 7C 0C 8C */	addi r3, r28, 0xc8c
/* 809ABB58  4B 7A 4B 95 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809ABC0C  4B 7A 82 E9 */	bl turn__8daNpcF_cFsfi
...
lbl_809ABC84:
/* 809ABC84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809ABC88  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809ABCCC  4B 69 CB 25 */	bl ChkPresentEnd__16dEvent_manager_cFv
...
/* 809ABCFC  4B 9B 63 1D */	bl __ptmf_test
...
/* 809ABD14  4B 9B 63 71 */	bl __ptmf_scall
...
/* 809ABD40  4B 9B 62 D9 */	bl __ptmf_test
...
/* 809ABD58  4B 9B 63 2D */	bl __ptmf_scall
/* 809ABD5C  60 00 00 00 */	nop 
/* 809ABD60  48 00 02 E0 */	b lbl_809AC040
lbl_809ABD64:
/* 809ABD64  4B 88 BD 39 */	bl getNowTalkFlowNo__12dMsgObject_cFv
/* 809ABD68  7C 60 07 34 */	extsh r0, r3
/* 809ABD6C  2C 00 04 35 */	cmpwi r0, 0x435
/* 809ABD70  40 82 01 10 */	bne lbl_809ABE80
/* 809ABD74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809ABD78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809ABD7C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 809ABD80  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 809ABD84  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 809ABD88  A0 84 00 F8 */	lhz r4, 0xf8(r4)
/* 809ABD8C  4B 68 8C 31 */	bl isEventBit__11dSv_event_cCFUs
...
lbl_809ABDA0:
/* 809ABDA0  4B 80 07 DD */	bl dKy_darkworld_check__Fv
/* 809ABDA4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 809ABDA8  41 82 00 0C */	beq lbl_809ABDB4
/* 809ABDAC  4B 7F 3D 49 */	bl dKy_getDarktime_hour__Fv
/* 809ABDB0  48 00 00 08 */	b lbl_809ABDB8
lbl_809ABDB4:
/* 809ABDB4  4B 7F 3C 5D */	bl dKy_getdaytime_hour__Fv
lbl_809ABDB8:
...
/* 809ABDD4  4B 68 1D 91 */	bl dComIfGs_isOneZoneSwitch__Fii
...
/* 809ABE18  4B 9B 62 01 */	bl __ptmf_test
...
/* 809ABE30  4B 9B 62 55 */	bl __ptmf_scall
...
/* 809ABE5C  4B 9B 61 BD */	bl __ptmf_test
...
/* 809ABE74  4B 9B 62 11 */	bl __ptmf_scall
...
/* 809ABE90  4B 69 BC 8D */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 809ABEC0  4B 9B 61 59 */	bl __ptmf_test
...
/* 809ABED8  4B 9B 61 AD */	bl __ptmf_scall
...
/* 809ABF04  4B 9B 61 15 */	bl __ptmf_test
...
/* 809ABF1C  4B 9B 61 69 */	bl __ptmf_scall
/* 809ABF20  60 00 00 00 */	nop 
/* 809ABF24  48 00 01 1C */	b lbl_809AC040
lbl_809ABF28:
/* 809ABF28  4B 80 06 55 */	bl dKy_darkworld_check__Fv
/* 809ABF2C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 809ABF30  40 82 00 CC */	bne lbl_809ABFFC
/* 809ABF34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809ABF38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809ABF54  4B 9C 08 2D */	bl pow
/* 809ABF58  FF E0 08 18 */	frsp f31, f1
/* 809ABF5C  7F 83 E3 78 */	mr r3, r28
/* 809ABF60  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 809ABF64  4B 66 EB 31 */	bl fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809ABF94  4B 9B 60 85 */	bl __ptmf_test
...
/* 809ABFAC  4B 9B 60 D9 */	bl __ptmf_scall
...
/* 809ABFD8  4B 9B 60 41 */	bl __ptmf_test
...
/* 809ABFF0  4B 9B 60 95 */	bl __ptmf_scall
...
/* 809AC03C  4B 7A 78 41 */	bl orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_809AC040:
...
/* 809AC050  4B 9B 61 D1 */	bl _restgpr_27
