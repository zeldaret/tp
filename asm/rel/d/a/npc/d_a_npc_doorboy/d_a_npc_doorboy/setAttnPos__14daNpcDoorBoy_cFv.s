...
/* 809ACC6C  4B 9B 55 71 */	bl _savegpr_29
/* 809ACC70  7C 7E 1B 78 */	mr r30, r3
/* 809ACC74  3C 60 80 9B */	lis r3, m__20daNpcDoorBoy_Param_c@ha /* 0x809AD9A8@ha */
/* 809ACC78  3B E3 D9 A8 */	addi r31, r3, m__20daNpcDoorBoy_Param_c@l /* 0x809AD9A8@l */
...
/* 809ACCE8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809ACCEC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809ACCF0  4B 99 97 C1 */	bl PSMTXCopy
/* 809ACCF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809ACCF8  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 809ACD8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809ACD90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809ACD94  38 9E 05 50 */	addi r4, r30, 0x550
/* 809ACD98  7C 85 23 78 */	mr r5, r4
/* 809ACD9C  4B 99 9F D1 */	bl PSMTXMultVec
...
/* 809ACDB4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809ACDB8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809ACDBC  4B 99 96 F5 */	bl PSMTXCopy
...
/* 809ACDE8  4B 8C 23 F5 */	bl SetC__8cM3dGCylFRC4cXyz
/* 809ACDEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809ACDF0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809ACDF4  38 63 23 3C */	addi r3, r3, 0x233c
/* 809ACDF8  38 9E 0C 98 */	addi r4, r30, 0xc98
/* 809ACDFC  4B 8B 7D AD */	bl Set__4cCcSFP8cCcD_Obj
/* 809ACE00  39 61 00 30 */	addi r11, r1, 0x30
/* 809ACE04  4B 9B 54 25 */	bl _restgpr_29
