...
/* 809AD020  3C 80 80 9B */	lis r4, l_bckGetParamList@ha
/* 809AD024  38 A4 DB 48 */	addi r5, r4, l_bckGetParamList@l
/* 809AD028  7C 85 F2 14 */	add r4, r5, r30
/* 809AD02C  80 04 00 08 */	lwz r0, 8(r4)
/* 809AD030  54 00 10 3A */	slwi r0, r0, 2
/* 809AD034  3C 80 80 9B */	lis r4, l_arcNames@ha
/* 809AD038  38 84 DB 9C */	addi r4, r4, l_arcNames@l
/* 809AD03C  7C 84 00 2E */	lwzx r4, r4, r0
/* 809AD040  7C A5 F0 2E */	lwzx r5, r5, r30
/* 809AD044  4B 7A 5A E8 */	b getTrnsfrmKeyAnmP__8daNpcF_cFPci
/* 809AD048  7C 64 1B 79 */	or. r4, r3, r3
/* 809AD04C  3C 60 80 9B */	lis r3, l_bckGetParamList@ha
/* 809AD050  38 03 DB 48 */	addi r0, r3, l_bckGetParamList@l
...
/* 809AD074  3C C0 80 9B */	lis r6, lit_4319@ha
/* 809AD078  C0 26 DA 24 */	lfs f1, lit_4319@l(r6)
/* 809AD07C  FC 40 F8 90 */	fmr f2, f31
/* 809AD080  38 C0 00 00 */	li r6, 0
/* 809AD084  38 E0 FF FF */	li r7, -1
/* 809AD088  4B 7A 5B 94 */	b setMcaMorfAnm__8daNpcF_cFP18J3DAnmTransformKeyffiii
