...
/* 80B54B60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B54B64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B54B68  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 80B54B6C  7C 00 00 D0 */	neg r0, r0
/* 80B54B70  7C 04 07 34 */	extsh r4, r0
/* 80B54B74  4B 4B 78 C1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B54B78  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 80B54B7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B54B80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B54B84  4B 4B 79 49 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B54B88  48 00 00 34 */	b lbl_80B54BBC
lbl_80B54B8C:
/* 80B54B8C  2C 04 00 04 */	cmpwi r4, 4
/* 80B54B90  40 82 00 2C */	bne lbl_80B54BBC
/* 80B54B94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B54B98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B54B9C  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80B54BA0  7C 00 00 D0 */	neg r0, r0
/* 80B54BA4  7C 04 07 34 */	extsh r4, r0
/* 80B54BA8  4B 4B 78 8D */	bl mDoMtx_YrotM__FPA4_fs
/* 80B54BAC  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80B54BB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B54BB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B54BB8  4B 4B 79 15 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B54BBC:
