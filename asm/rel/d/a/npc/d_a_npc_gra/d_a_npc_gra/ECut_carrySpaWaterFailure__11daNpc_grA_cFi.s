...
/* 809C5D54  4B 99 C4 7D */	bl _savegpr_26
/* 809C5D58  7C 7E 1B 78 */	mr r30, r3
/* 809C5D5C  7C 9A 23 78 */	mr r26, r4
/* 809C5D60  3C 60 80 9D */	lis r3, m__17daNpc_grA_Param_c@ha /* 0x809C9D98@ha */
/* 809C5D64  3B A3 9D 98 */	addi r29, r3, m__17daNpc_grA_Param_c@l /* 0x809C9D98@l */
/* 809C5D68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C5D6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809C5D80  3C A0 80 9D */	lis r5, d_a_npc_gra__stringBase0@ha /* 0x809CA4B8@ha */
/* 809C5D84  38 A5 A4 B8 */	addi r5, r5, d_a_npc_gra__stringBase0@l /* 0x809CA4B8@l */
/* 809C5D88  38 A5 01 46 */	addi r5, r5, 0x146
/* 809C5D8C  38 C0 00 03 */	li r6, 3
/* 809C5D90  4B 68 23 5D */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809C5DA8  4B 68 1F A5 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 809C5E70  4B 78 F8 85 */	bl daNpcF_onTmpBit__FUl
/* 809C5E74  7F C3 F3 78 */	mr r3, r30
/* 809C5E78  38 80 00 29 */	li r4, 0x29
/* 809C5E7C  38 A0 00 00 */	li r5, 0
/* 809C5E80  4B 78 DE 9D */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
lbl_809C5E84:
...
/* 809C5EDC  4B 96 25 51 */	bl checkPass__12J3DFrameCtrlFf
...
/* 809C5F00  4B 64 6E 65 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 809C5F04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809C5F08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809C5F0C  A8 9E 08 F2 */	lha r4, 0x8f2(r30)
/* 809C5F10  4B 64 65 25 */	bl mDoMtx_YrotM__FPA4_fs
/* 809C5F14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809C5F18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809C5F1C  38 81 00 08 */	addi r4, r1, 8
/* 809C5F20  38 BE 15 24 */	addi r5, r30, 0x1524
/* 809C5F24  4B 98 0E 49 */	bl PSMTXMultVec
...
/* 809C5F5C  4B 78 DE 29 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809C5F7C  4B 99 C2 A1 */	bl _restgpr_26
