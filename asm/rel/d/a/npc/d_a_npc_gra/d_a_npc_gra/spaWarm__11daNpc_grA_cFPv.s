...
/* 809C7848  3C A0 80 9D */	lis r5, lit_4611@ha /* 0x809C9E34@ha */
/* 809C784C  C0 25 9E 34 */	lfs f1, lit_4611@l(r5)  /* 0x809C9E34@l */
...
/* 809C7888  3C A0 80 9D */	lis r5, lit_4611@ha /* 0x809C9E34@ha */
/* 809C788C  C0 25 9E 34 */	lfs f1, lit_4611@l(r5)  /* 0x809C9E34@l */
...
/* 809C78E0  3C 60 80 9C */	lis r3, s_subShop__FPvPv@ha /* 0x809BFC00@ha */
/* 809C78E4  38 63 FC 00 */	addi r3, r3, s_subShop__FPvPv@l /* 0x809BFC00@l */
/* 809C78E8  7F E4 FB 78 */	mr r4, r31
/* 809C78EC  4B 65 9A 4D */	bl fpcEx_Search__FPFPvPv_PvPv
/* 809C78F0  7C 64 1B 79 */	or. r4, r3, r3
/* 809C78F4  41 82 00 14 */	beq lbl_809C7908
/* 809C78F8  38 7F 0C 8C */	addi r3, r31, 0xc8c
/* 809C78FC  4B 78 8D C1 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 809C7934  4B 78 8D B9 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809C7978  4B 78 8D 75 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809C79C0  4B 78 C6 E5 */	bl step__8daNpcF_cFsiii
...
/* 809C7A00  3C A0 80 9D */	lis r5, lit_4611@ha /* 0x809C9E34@ha */
/* 809C7A04  C0 25 9E 34 */	lfs f1, lit_4611@l(r5)  /* 0x809C9E34@l */
...
/* 809C7A24  3C A0 80 9D */	lis r5, lit_6106@ha /* 0x809CA408@ha */
/* 809C7A28  C0 25 A4 08 */	lfs f1, lit_6106@l(r5)  /* 0x809CA408@l */
...
/* 809C7A68  3C A0 80 9D */	lis r5, lit_4611@ha /* 0x809C9E34@ha */
/* 809C7A6C  C0 25 9E 34 */	lfs f1, lit_4611@l(r5)  /* 0x809C9E34@l */
...
/* 809C7A8C  3C A0 80 9D */	lis r5, lit_6106@ha /* 0x809CA408@ha */
/* 809C7A90  C0 25 A4 08 */	lfs f1, lit_6106@l(r5)  /* 0x809CA408@l */
