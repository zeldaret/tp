...
/* 809C8BE4  4B 99 95 F1 */	bl _savegpr_27
/* 809C8BE8  7C 7C 1B 78 */	mr r28, r3
/* 809C8BEC  3C 80 80 9D */	lis r4, cNullVec__6Z2Calc@ha /* 0x809CA614@ha */
/* 809C8BF0  3B E4 A6 14 */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x809CA614@l */
...
/* 809C8C4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C8C50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C8C54  88 9C 14 CF */	lbz r4, 0x14cf(r28)
/* 809C8C58  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 809C8C5C  7C 05 07 74 */	extsb r5, r0
/* 809C8C60  4B 66 C7 01 */	bl isSwitch__10dSv_info_cCFii
...
/* 809C8C74  4B 78 C9 C1 */	bl daNpcF_chkEvtBit__FUl
/* 809C8C78  2C 03 00 00 */	cmpwi r3, 0
/* 809C8C7C  41 82 00 2C */	beq lbl_809C8CA8
/* 809C8C80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C8C84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C8C88  88 9C 14 CF */	lbz r4, 0x14cf(r28)
/* 809C8C8C  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 809C8C90  7C 05 07 74 */	extsb r5, r0
/* 809C8C94  4B 66 C5 6D */	bl onSwitch__10dSv_info_cFii
...
/* 809C8CB4  4B 78 B0 69 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
/* 809C8CB8  7F 83 E3 78 */	mr r3, r28
/* 809C8CBC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C8CC0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C8CC4  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 809C8CC8  4B 65 1A 49 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809C8CEC  4B 78 CA 49 */	bl daNpcF_offTmpBit__FUl
/* 809C8CF0  38 60 00 0C */	li r3, 0xc
/* 809C8CF4  4B 78 CA 41 */	bl daNpcF_offTmpBit__FUl
...
/* 809C8D14  4B 78 CA 21 */	bl daNpcF_offTmpBit__FUl
lbl_809C8D18:
...
/* 809C8DB8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C8DBC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C8DC0  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 809C8DC4  4B 78 78 F9 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 809C8DF0  4B 78 B2 B5 */	bl step__8daNpcF_cFsiii
...
/* 809C8E04  3C A0 80 9D */	lis r5, lit_6106@ha /* 0x809CA408@ha */
/* 809C8E08  C0 25 A4 08 */	lfs f1, lit_6106@l(r5)  /* 0x809CA408@l */
...
/* 809C8E30  3C A0 80 9D */	lis r5, lit_6106@ha /* 0x809CA408@ha */
/* 809C8E34  C0 25 A4 08 */	lfs f1, lit_6106@l(r5)  /* 0x809CA408@l */
...
/* 809C8E58  3C A0 80 9D */	lis r5, lit_6106@ha /* 0x809CA408@ha */
/* 809C8E5C  C0 25 A4 08 */	lfs f1, lit_6106@l(r5)  /* 0x809CA408@l */
...
/* 809C8E94  4B 78 AE F1 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809C8EA8  4B 88 16 81 */	bl getEventId__10dMsgFlow_cFPi
...
/* 809C8ED4  4B 65 2D 15 */	bl fopAcM_createItemForPresentDemo__FPC4cXyziUciiPC5csXyzPC4cXyz
...
/* 809C8EEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C8EF0  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C8EF4  38 7D 4F F8 */	addi r3, r29, 0x4ff8
/* 809C8EF8  7F 84 E3 78 */	mr r4, r28
/* 809C8EFC  3C A0 80 9D */	lis r5, d_a_npc_gra__stringBase0@ha /* 0x809CA4B8@ha */
/* 809C8F00  38 A5 A4 B8 */	addi r5, r5, d_a_npc_gra__stringBase0@l /* 0x809CA4B8@l */
/* 809C8F04  38 A5 01 4A */	addi r5, r5, 0x14a
/* 809C8F08  38 C0 00 FF */	li r6, 0xff
/* 809C8F0C  4B 67 E8 4D */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
/* 809C8F10  7C 7B 1B 78 */	mr r27, r3
/* 809C8F14  38 7D 4E C8 */	addi r3, r29, 0x4ec8
/* 809C8F18  7F 84 E3 78 */	mr r4, r28
/* 809C8F1C  4B 67 95 FD */	bl reset__14dEvt_control_cFPv
...
/* 809C8F34  4B 65 26 B1 */	bl fopAcM_orderChangeEventId__FP10fopAc_ac_csUsUs
...
/* 809C8F78  4B 78 C6 BD */	bl daNpcF_chkEvtBit__FUl
/* 809C8F7C  2C 03 00 00 */	cmpwi r3, 0
/* 809C8F80  41 82 00 70 */	beq lbl_809C8FF0
/* 809C8F84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C8F88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C8F8C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 809C8F90  7F 84 E3 78 */	mr r4, r28
/* 809C8F94  4B 67 95 85 */	bl reset__14dEvt_control_cFPv
...
/* 809C8FEC  4B 78 A9 69 */	bl changeEvent__8daNpcF_cFPcPcUsUs
lbl_809C8FF0:
...
/* 809C9010  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C9014  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C9018  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 809C901C  4B 67 94 4D */	bl reset__14dEvt_control_cFv
lbl_809C9020:
...
/* 809C9030  4B 99 91 F1 */	bl _restgpr_27
