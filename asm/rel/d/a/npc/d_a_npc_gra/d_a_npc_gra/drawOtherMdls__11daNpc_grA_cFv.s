...
/* 809C1090  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 809C1094  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 809C1098  80 84 00 04 */	lwz r4, 4(r4)
/* 809C109C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 809C10A0  4B 7E 3D 01 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 809C10CC  4B 98 53 E5 */	bl PSMTXCopy
...
/* 809C10E8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809C10EC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809C10F0  4B 98 53 C1 */	bl PSMTXCopy
/* 809C10F4  38 7F 04 EC */	addi r3, r31, 0x4ec
/* 809C10F8  4B 64 BD 79 */	bl scaleM__14mDoMtx_stack_cFRC4cXyz
/* 809C10FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809C1100  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809C1104  80 9F 0B D8 */	lwz r4, 0xbd8(r31)
/* 809C1108  38 84 00 24 */	addi r4, r4, 0x24
/* 809C110C  4B 98 53 A5 */	bl PSMTXCopy
/* 809C1110  80 7F 0B D8 */	lwz r3, 0xbd8(r31)
/* 809C1114  80 83 00 04 */	lwz r4, 4(r3)
/* 809C1118  7F E3 FB 78 */	mr r3, r31
/* 809C111C  4B 65 C3 11 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
lbl_809C1120:
/* 809C1120  80 7F 0B D8 */	lwz r3, 0xbd8(r31)
/* 809C1124  4B 64 CB A1 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 809C1128  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C112C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C1130  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 809C1134  80 9F 09 A0 */	lwz r4, 0x9a0(r31)
/* 809C1138  80 BF 0B D8 */	lwz r5, 0xbd8(r31)
/* 809C113C  4B 69 4D E1 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_809C1140:
