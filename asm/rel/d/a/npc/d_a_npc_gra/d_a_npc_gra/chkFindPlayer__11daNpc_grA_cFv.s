...
/* 809C3434  4B 99 ED A9 */	bl _savegpr_29
/* 809C3438  7C 7F 1B 78 */	mr r31, r3
/* 809C343C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C3440  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C3444  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 809C3448  4B 65 72 C9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 809C344C  A8 1F 04 DE */	lha r0, 0x4de(r31)
/* 809C3450  7C 00 18 50 */	subf r0, r0, r3
/* 809C3454  7C 03 07 34 */	extsh r3, r0
/* 809C3458  4B 9A 1C 79 */	bl abs
...
/* 809C3474  4B 78 D2 79 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809C3490  4B 79 0D E9 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 809C34A4  4B 79 07 39 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 809C34C0  4B 79 0D B9 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 809C34D4  4B 79 07 09 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
/* 809C34D8  7C 7D 1B 78 */	mr r29, r3
/* 809C34DC  48 00 00 B8 */	b lbl_809C3594
lbl_809C34E0:
/* 809C34E0  38 7F 0C 7C */	addi r3, r31, 0xc7c
/* 809C34E4  4B 78 D2 09 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809C3500  4B 79 0D 79 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 809C3514  4B 79 06 C9 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 809C3530  4B 79 0D 49 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 809C3544  4B 79 06 99 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
/* 809C3548  7C 7D 1B 78 */	mr r29, r3
/* 809C354C  48 00 00 48 */	b lbl_809C3594
lbl_809C3550:
/* 809C3550  38 7F 0C 7C */	addi r3, r31, 0xc7c
/* 809C3554  4B 78 D1 99 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809C3570  4B 79 06 6D */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 809C358C  4B 79 06 51 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 809C35A4  4B 78 D1 19 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
/* 809C35A8  48 00 00 0C */	b lbl_809C35B4
lbl_809C35AC:
/* 809C35AC  38 7F 0C 7C */	addi r3, r31, 0xc7c
/* 809C35B0  4B 78 D1 31 */	bl remove__18daNpcF_ActorMngr_cFv
lbl_809C35B4:
/* 809C35B4  7F A3 EB 78 */	mr r3, r29
/* 809C35B8  39 61 00 20 */	addi r11, r1, 0x20
/* 809C35BC  4B 99 EC 6D */	bl _restgpr_29
