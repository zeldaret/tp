...
/* 809C0CF4  4B 9A 14 E8 */	b _savegpr_29
...
/* 809C0D1C  3C A0 80 9D */	lis r5, l_btpGetParamList@ha
/* 809C0D20  38 C5 A7 F4 */	addi r6, r5, l_btpGetParamList@l
...
/* 809C0D3C  3C 80 80 9D */	lis r4, l_resNames@ha
/* 809C0D40  38 84 AA D4 */	addi r4, r4, l_resNames@l
/* 809C0D44  7C 84 00 2E */	lwzx r4, r4, r0
/* 809C0D48  4B 79 1E 20 */	b getTexPtrnAnmP__8daNpcF_cFPci
/* 809C0D4C  7C 64 1B 78 */	mr r4, r3
lbl_809C0D50:
/* 809C0D50  28 1E 00 0E */	cmplwi r30, 0xe
/* 809C0D54  41 81 00 44 */	bgt lbl_809C0D98
/* 809C0D58  3C 60 80 9D */	lis r3, lit_5405@ha
/* 809C0D5C  38 63 AC EC */	addi r3, r3, lit_5405@l
...
/* 809C0DBC  3C C0 80 9D */	lis r6, lit_4610@ha
/* 809C0DC0  C0 26 9E 30 */	lfs f1, lit_4610@l(r6)
/* 809C0DC4  7F E6 FB 78 */	mr r6, r31
/* 809C0DC8  4B 79 1E FC */	b setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 809C0E04  4B 9A 14 24 */	b _restgpr_29
