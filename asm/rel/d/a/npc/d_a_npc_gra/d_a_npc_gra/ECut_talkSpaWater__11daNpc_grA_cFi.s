...
/* 809C6618  4B 99 BB BD */	bl _savegpr_27
/* 809C661C  7C 7C 1B 78 */	mr r28, r3
/* 809C6620  7C 9B 23 78 */	mr r27, r4
/* 809C6624  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C6628  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809C663C  3C A0 80 9D */	lis r5, d_a_npc_gra__stringBase0@ha /* 0x809CA4B8@ha */
/* 809C6640  38 A5 A4 B8 */	addi r5, r5, d_a_npc_gra__stringBase0@l /* 0x809CA4B8@l */
/* 809C6644  38 A5 01 46 */	addi r5, r5, 0x146
/* 809C6648  38 C0 00 03 */	li r6, 3
/* 809C664C  4B 68 1A A1 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809C6664  4B 68 16 E9 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 809C66AC  4B 78 D6 71 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
/* 809C66B0  3C 60 80 9D */	lis r3, lit_4611@ha /* 0x809C9E34@ha */
/* 809C66B4  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)  /* 0x809C9E34@l */
/* 809C66B8  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 809C66BC  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 809C66C0  3C 60 80 9D */	lis r3, lit_7629@ha /* 0x809CA4A0@ha */
/* 809C66C4  C0 03 A4 A0 */	lfs f0, lit_7629@l(r3)  /* 0x809CA4A0@l */
/* 809C66C8  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 809C66CC  38 7C 04 A8 */	addi r3, r28, 0x4a8
/* 809C66D0  4B 64 66 95 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 809C66D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C66D8  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809C66EC  3C 60 80 9D */	lis r3, lit_4611@ha /* 0x809C9E34@ha */
/* 809C66F0  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)  /* 0x809C9E34@l */
/* 809C66F4  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 809C66F8  40 80 00 20 */	bge lbl_809C6718
/* 809C66FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809C6700  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809C6704  A8 9C 04 B6 */	lha r4, 0x4b6(r28)
/* 809C6708  38 04 10 00 */	addi r0, r4, 0x1000
/* 809C670C  7C 04 07 34 */	extsh r4, r0
/* 809C6710  4B 64 5D 25 */	bl mDoMtx_YrotM__FPA4_fs
/* 809C6714  48 00 00 1C */	b lbl_809C6730
lbl_809C6718:
/* 809C6718  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809C671C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809C6720  A8 9C 04 B6 */	lha r4, 0x4b6(r28)
/* 809C6724  38 04 F0 00 */	addi r0, r4, -4096
/* 809C6728  7C 04 07 34 */	extsh r4, r0
/* 809C672C  4B 64 5D 09 */	bl mDoMtx_YrotM__FPA4_fs
lbl_809C6730:
/* 809C6730  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809C6734  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809C6738  38 81 00 14 */	addi r4, r1, 0x14
/* 809C673C  7C 85 23 78 */	mr r5, r4
/* 809C6740  4B 98 06 2D */	bl PSMTXMultVec
...
/* 809C675C  3C 60 80 9D */	lis r3, lit_7629@ha /* 0x809CA4A0@ha */
/* 809C6760  C0 03 A4 A0 */	lfs f0, lit_7629@l(r3)  /* 0x809CA4A0@l */
/* 809C6764  EC 01 00 2A */	fadds f0, f1, f0
/* 809C6768  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 809C676C  38 61 00 08 */	addi r3, r1, 8
/* 809C6770  4B 65 75 4D */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 809C6774  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 809C6778  41 82 00 10 */	beq lbl_809C6788
/* 809C677C  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 809C6780  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 809C6794  4B 8A A4 A9 */	bl cLib_targetAngleY__FRC3VecRC3Vec
...
/* 809C67E8  4B 78 D5 9D */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809C6808  4B 99 BA 19 */	bl _restgpr_27
