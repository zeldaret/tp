...
/* 809BFE0C  4B 9A 23 C5 */	bl _savegpr_26
...
/* 809BFE40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809BFE44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809BFE64  4B 9A 21 E5 */	bl __ptmf_cmpr
...
/* 809BFE84  4B 79 08 2D */	bl initialize__18daNpcF_ActorMngr_cFv
...
/* 809BFEF0  3C 60 80 9D */	lis r3, m__17daNpc_grA_Param_c@ha /* 0x809C9D98@ha */
/* 809BFEF4  38 63 9D 98 */	addi r3, r3, m__17daNpc_grA_Param_c@l /* 0x809C9D98@l */
...
lbl_809BFF38:
/* 809BFF38  3C 60 80 9D */	lis r3, lit_4986@ha /* 0x809CAC70@ha */
/* 809BFF3C  38 83 AC 70 */	addi r4, r3, lit_4986@l /* 0x809CAC70@l */
...
/* 809BFF80  4B 79 42 F9 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 809BFF9C  4B 79 42 DD */	bl getDistTableIdx__8daNpcF_cFii
...
lbl_809BFFC0:
/* 809BFFC0  3C 60 80 9D */	lis r3, m__17daNpc_grA_Param_c@ha /* 0x809C9D98@ha */
/* 809BFFC4  38 83 9D 98 */	addi r4, r3, m__17daNpc_grA_Param_c@l /* 0x809C9D98@l */
...
/* 809BFFE8  3C 80 80 9D */	lis r4, lit_4527@ha /* 0x809C9E2C@ha */
/* 809BFFEC  C0 24 9E 2C */	lfs f1, lit_4527@l(r4)  /* 0x809C9E2C@l */
/* 809BFFF0  48 00 00 08 */	b lbl_809BFFF8
lbl_809BFFF4:
/* 809BFFF4  C0 24 00 1C */	lfs f1, 0x1c(r4)
lbl_809BFFF8:
/* 809BFFF8  4B 6B 5F 49 */	bl SetWallR__12dBgS_AcchCirFf
/* 809BFFFC  3C 60 80 9D */	lis r3, m__17daNpc_grA_Param_c@ha /* 0x809C9D98@ha */
/* 809C0000  38 63 9D 98 */	addi r3, r3, m__17daNpc_grA_Param_c@l /* 0x809C9D98@l */
...
/* 809C0024  4B 9A 21 F9 */	bl _restgpr_26
