...
/* 809C4BF4  4B 99 D5 DD */	bl _savegpr_26
/* 809C4BF8  7C 7D 1B 78 */	mr r29, r3
/* 809C4BFC  7C 9A 23 78 */	mr r26, r4
/* 809C4C00  3C 60 80 9D */	lis r3, m__17daNpc_grA_Param_c@ha /* 0x809C9D98@ha */
/* 809C4C04  3B E3 9D 98 */	addi r31, r3, m__17daNpc_grA_Param_c@l /* 0x809C9D98@l */
/* 809C4C08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C4C0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809C4C20  3C A0 80 9D */	lis r5, d_a_npc_gra__stringBase0@ha /* 0x809CA4B8@ha */
/* 809C4C24  38 A5 A4 B8 */	addi r5, r5, d_a_npc_gra__stringBase0@l /* 0x809CA4B8@l */
/* 809C4C28  38 A5 01 46 */	addi r5, r5, 0x146
/* 809C4C2C  38 C0 00 03 */	li r6, 3
/* 809C4C30  4B 68 34 BD */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809C4C48  4B 68 31 05 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 809C4CE4  4B 78 F0 39 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
...
/* 809C4D54  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809C4D58  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 809C4D84  4B 8E 6C 01 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_809C4D88:
...
/* 809C4DBC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C4DC0  3B 84 61 C0 */	addi r28, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C4DC4  80 9C 5D AC */	lwz r4, 0x5dac(r28)
/* 809C4DC8  4B 65 59 49 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809C4DF4  4B 65 59 1D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809C4E0C  4B 78 F2 99 */	bl step__8daNpcF_cFsiii
...
/* 809C4E54  4B 78 EF 31 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809C4EA0  4B 99 D3 7D */	bl _restgpr_26
