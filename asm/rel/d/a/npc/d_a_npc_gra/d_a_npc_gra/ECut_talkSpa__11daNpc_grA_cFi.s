...
/* 809C3B38  4B 99 E6 9D */	bl _savegpr_27
/* 809C3B3C  7C 7D 1B 78 */	mr r29, r3
/* 809C3B40  7C 9B 23 78 */	mr r27, r4
/* 809C3B44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809C3B48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809C3B4C  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 809C3B50  3B E0 00 00 */	li r31, 0
/* 809C3B54  3B C0 FF FF */	li r30, -1
/* 809C3B58  3C 60 80 9D */	lis r3, lit_6467@ha /* 0x809CA440@ha */
/* 809C3B5C  38 83 A4 40 */	addi r4, r3, lit_6467@l /* 0x809CA440@l */
...
/* 809C3B78  4B 78 CB 75 */	bl getActorP__18daNpcF_ActorMngr_cFv
/* 809C3B7C  90 61 00 0C */	stw r3, 0xc(r1)
/* 809C3B80  7F 83 E3 78 */	mr r3, r28
/* 809C3B84  7F 64 DB 78 */	mr r4, r27
/* 809C3B88  3C A0 80 9D */	lis r5, d_a_npc_gra__stringBase0@ha /* 0x809CA4B8@ha */
/* 809C3B8C  38 A5 A4 B8 */	addi r5, r5, d_a_npc_gra__stringBase0@l /* 0x809CA4B8@l */
/* 809C3B90  38 A5 01 46 */	addi r5, r5, 0x146
/* 809C3B94  38 C0 00 03 */	li r6, 3
/* 809C3B98  4B 68 45 55 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809C3BB0  4B 68 41 9D */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 809C3BE4  4B 78 CB 09 */	bl getActorP__18daNpcF_ActorMngr_cFv
/* 809C3BE8  3B 83 0B A8 */	addi r28, r3, 0xba8
/* 809C3BEC  7F 83 E3 78 */	mr r3, r28
/* 809C3BF0  4B 78 1B 19 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 809C3C18  4B 78 1A E5 */	bl remove__18daNpcT_ActorMngr_cFv
/* 809C3C1C  38 00 00 00 */	li r0, 0
/* 809C3C20  90 1C 00 20 */	stw r0, 0x20(r28)
/* 809C3C24  3C 60 80 9D */	lis r3, lit_4611@ha /* 0x809C9E34@ha */
/* 809C3C28  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)  /* 0x809C9E34@l */
...
/* 809C3C54  4B 65 50 8D */	bl fopAc_IsActor__FPv
...
/* 809C3C68  4B 78 1A 79 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 809C3C6C  3C 60 80 9D */	lis r3, lit_4611@ha /* 0x809C9E34@ha */
/* 809C3C70  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)  /* 0x809C9E34@l */
...
/* 809C3D20  4B 79 00 65 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809C3D64  4B 99 E4 BD */	bl _restgpr_27
