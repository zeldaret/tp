...
/* 809E04F0  4B 98 1C E9 */	bl _savegpr_28
...
/* 809E0504  3C 60 80 9E */	lis r3, lit_4505@ha /* 0x809E396C@ha */
/* 809E0508  38 83 39 6C */	addi r4, r3, lit_4505@l /* 0x809E396C@l */
...
/* 809E0540  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E0544  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E0548  4B 96 5F 69 */	bl PSMTXCopy
/* 809E054C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E0550  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 809E0584  4B 96 5F 2D */	bl PSMTXCopy
...
/* 809E05B4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E05B8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E05BC  4B 96 5E F5 */	bl PSMTXCopy
...
/* 809E05E8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E05EC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E05F0  4B 96 5E C1 */	bl PSMTXCopy
...
/* 809E0620  3C C0 80 9E */	lis r6, m__17daNpc_grR_Param_c@ha /* 0x809E38D8@ha */
/* 809E0624  38 C6 38 D8 */	addi r6, r6, m__17daNpc_grR_Param_c@l /* 0x809E38D8@l */
/* 809E0628  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 809E062C  4B 77 2D 51 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_809E0630:
/* 809E0630  2C 1D 00 01 */	cmpwi r29, 1
/* 809E0634  40 82 00 30 */	bne lbl_809E0664
/* 809E0638  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E063C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E0640  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 809E0644  7C 00 00 D0 */	neg r0, r0
/* 809E0648  7C 04 07 34 */	extsh r4, r0
/* 809E064C  4B 62 BD E9 */	bl mDoMtx_YrotM__FPA4_fs
/* 809E0650  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E0654  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E0658  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 809E065C  4B 62 BE 71 */	bl mDoMtx_ZrotM__FPA4_fs
/* 809E0660  48 00 00 34 */	b lbl_809E0694
lbl_809E0664:
/* 809E0664  2C 1D 00 04 */	cmpwi r29, 4
/* 809E0668  40 82 00 2C */	bne lbl_809E0694
/* 809E066C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E0670  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E0674  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 809E0678  7C 00 00 D0 */	neg r0, r0
/* 809E067C  7C 04 07 34 */	extsh r4, r0
/* 809E0680  4B 62 BD B5 */	bl mDoMtx_YrotM__FPA4_fs
/* 809E0684  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E0688  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E068C  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 809E0690  4B 62 BE 3D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_809E0694:
/* 809E0694  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E0698  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E069C  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 809E06A0  80 04 00 0C */	lwz r0, 0xc(r4)
/* 809E06A4  7C 80 F2 14 */	add r4, r0, r30
/* 809E06A8  4B 96 5E 09 */	bl PSMTXCopy
/* 809E06AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809E06B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809E06B4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 809E06B8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 809E06BC  4B 96 5D F5 */	bl PSMTXCopy
...
/* 809E06EC  4B 62 D2 A5 */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809E0700  4B 98 1B 25 */	bl _restgpr_28
