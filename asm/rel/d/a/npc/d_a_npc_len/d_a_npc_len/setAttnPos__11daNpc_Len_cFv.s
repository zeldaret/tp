...
/* 80A65B3C  4B 8F C6 99 */	bl _savegpr_27
/* 80A65B40  7C 7E 1B 78 */	mr r30, r3
/* 80A65B44  3C 60 80 A7 */	lis r3, m__17daNpc_Len_Param_c@ha /* 0x80A68EA4@ha */
/* 80A65B48  3B E3 8E A4 */	addi r31, r3, m__17daNpc_Len_Param_c@l /* 0x80A68EA4@l */
...
/* 80A65B7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A65B80  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A65B9C  4B 6E 22 A1 */	bl calc__19daNpcT_DmgStagger_cFi
...
/* 80A65C70  4B 6E 10 69 */	bl setParam__15daNpcT_JntAnm_cFP10fopAc_ac_cP8J3DModelP4cXyziiiffffffffffP4cXyz
...
/* 80A65C90  4B 6E 1F A9 */	bl calcJntRad__15daNpcT_JntAnm_cFfff
...
/* 80A65CA8  4B 6E 1F 91 */	bl calcJntRad__15daNpcT_JntAnm_cFfff
lbl_80A65CAC:
/* 80A65CAC  7F C3 F3 78 */	mr r3, r30
/* 80A65CB0  4B 6E 34 E1 */	bl setMtx__8daNpcT_cFv
...
/* 80A65CE0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A65CE4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A65CE8  4B 8E 07 C9 */	bl PSMTXCopy
/* 80A65CEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A65CF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A65CF4  38 81 00 40 */	addi r4, r1, 0x40
/* 80A65CF8  38 BE 05 38 */	addi r5, r30, 0x538
/* 80A65CFC  4B 8E 10 71 */	bl PSMTXMultVec
...
lbl_80A65DA8:
/* 80A65DA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A65DAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A65DB0  A8 9E 0D 7A */	lha r4, 0xd7a(r30)
/* 80A65DB4  4B 5A 66 29 */	bl mDoMtx_YrotS__FPA4_fs
/* 80A65DB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A65DBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A65DC0  38 81 00 40 */	addi r4, r1, 0x40
/* 80A65DC4  7C 85 23 78 */	mr r5, r4
/* 80A65DC8  4B 8E 0F A5 */	bl PSMTXMultVec
/* 80A65DCC  38 61 00 10 */	addi r3, r1, 0x10
/* 80A65DD0  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80A65DD4  38 A1 00 40 */	addi r5, r1, 0x40
/* 80A65DD8  4B 80 0D 0D */	bl __pl__4cXyzCFRC3Vec
...
/* 80A65E14  4B 8F C4 0D */	bl _restgpr_27
