...
/* 80A65194  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A65198  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A6519C  4B 5A 72 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 80A651A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A651A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A651A8  A8 1E 0D 0E */	lha r0, 0xd0e(r30)
/* 80A651AC  7C 00 00 D0 */	neg r0, r0
/* 80A651B0  7C 04 07 34 */	extsh r4, r0
/* 80A651B4  4B 5A 73 19 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80A651C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A651CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A651D0  4B 5A 72 65 */	bl mDoMtx_YrotM__FPA4_fs
/* 80A651D4  A8 9E 0D 08 */	lha r4, 0xd08(r30)
/* 80A651D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A651DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A651E0  4B 5A 72 ED */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80A651E4:
...
/* 80A651F4  3C 60 80 A7 */	lis r3, lit_4388@ha /* 0x80A68F80@ha */
/* 80A651F8  C0 43 8F 80 */	lfs f2, lit_4388@l(r3)  /* 0x80A68F80@l */
...
/* 80A6520C  4B 80 23 D9 */	bl cM_rad2s__Ff
/* 80A65210  7C 60 1B 78 */	mr r0, r3
/* 80A65214  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A65218  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A6521C  3C 80 80 A7 */	lis r4, lit_4585@ha /* 0x80A68F88@ha */
/* 80A65220  C0 44 8F 88 */	lfs f2, lit_4585@l(r4)  /* 0x80A68F88@l */
/* 80A65224  7C 00 07 34 */	extsh r0, r0
/* 80A65228  7C 00 00 D0 */	neg r0, r0
/* 80A6522C  3C 80 80 A7 */	lis r4, lit_4587@ha /* 0x80A68F8C@ha */
/* 80A65230  C8 24 8F 8C */	lfd f1, lit_4587@l(r4)  /* 0x80A68F8C@l */
...
/* 80A6525C  4B 5A 71 D9 */	bl mDoMtx_YrotM__FPA4_fs
lbl_80A65260:
