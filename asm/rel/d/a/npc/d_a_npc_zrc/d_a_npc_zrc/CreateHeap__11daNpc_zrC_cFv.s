...
/* 80B8E348  4B 7D 3E 95 */	bl _savegpr_29
...
/* 80B8E360  3C 60 80 B9 */	lis r3, l_bmdGetParamList@ha /* 0x80B93708@ha */
/* 80B8E364  38 63 37 08 */	addi r3, r3, l_bmdGetParamList@l /* 0x80B93708@l */
...
/* 80B8E37C  3C 60 80 B9 */	lis r3, l_resNames@ha /* 0x80B93948@ha */
/* 80B8E380  38 63 39 48 */	addi r3, r3, l_resNames@l /* 0x80B93948@l */
/* 80B8E384  7C 63 00 2E */	lwzx r3, r3, r0
/* 80B8E388  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B8E38C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B8E390  3C A5 00 02 */	addis r5, r5, 2
/* 80B8E394  38 C0 00 80 */	li r6, 0x80
/* 80B8E398  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80B8E39C  4B 4A DF 51 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80B8E3A0  7C 7E 1B 78 */	mr r30, r3
lbl_80B8E3A4:
/* 80B8E3A4  3F A0 00 08 */	lis r29, 8
/* 80B8E3A8  48 00 00 48 */	b lbl_80B8E3F0
lbl_80B8E3AC:
/* 80B8E3AC  3C 60 80 B9 */	lis r3, l_bmdGetParamList@ha /* 0x80B93708@ha */
/* 80B8E3B0  84 83 37 08 */	lwzu r4, l_bmdGetParamList@l(r3)  /* 0x80B93708@l */
...
/* 80B8E3C4  3C 60 80 B9 */	lis r3, l_resNames@ha /* 0x80B93948@ha */
/* 80B8E3C8  38 63 39 48 */	addi r3, r3, l_resNames@l /* 0x80B93948@l */
/* 80B8E3CC  7C 63 00 2E */	lwzx r3, r3, r0
/* 80B8E3D0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B8E3D4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B8E3D8  3C A5 00 02 */	addis r5, r5, 2
/* 80B8E3DC  38 C0 00 80 */	li r6, 0x80
/* 80B8E3E0  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80B8E3E4  4B 4A DF 09 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80B8E3E8  7C 7E 1B 78 */	mr r30, r3
lbl_80B8E3EC:
/* 80B8E3EC  3B A0 00 00 */	li r29, 0
lbl_80B8E3F0:
/* 80B8E3F0  38 60 00 58 */	li r3, 0x58
/* 80B8E3F4  4B 74 08 59 */	bl __nw__FUl
...
/* 80B8E42C  3D 20 80 B9 */	lis r9, lit_4483@ha /* 0x80B93294@ha */
/* 80B8E430  C0 29 32 94 */	lfs f1, lit_4483@l(r9)  /* 0x80B93294@l */
/* 80B8E434  39 20 00 00 */	li r9, 0
/* 80B8E438  39 40 FF FF */	li r10, -1
/* 80B8E43C  4B 48 23 95 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80B8E460  4B 48 2E B1 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
...
/* 80B8E488  3C 60 80 B9 */	lis r3, ctrlJointCallBack__11daNpc_zrC_cFP8J3DJointi@ha /* 0x80B8EB68@ha */
/* 80B8E48C  38 83 EB 68 */	addi r4, r3, ctrlJointCallBack__11daNpc_zrC_cFP8J3DJointi@l /* 0x80B8EB68@l */
...
/* 80B8E4C0  4B 74 07 8D */	bl __nw__FUl
/* 80B8E4C4  7C 7E 1B 79 */	or. r30, r3, r3
/* 80B8E4C8  41 82 00 D0 */	beq lbl_80B8E598
/* 80B8E4CC  7F DD F3 78 */	mr r29, r30
/* 80B8E4D0  3C 60 80 3D */	lis r3, __vt__14J3DMaterialAnm@ha /* 0x803CEE60@ha */
/* 80B8E4D4  38 03 EE 60 */	addi r0, r3, __vt__14J3DMaterialAnm@l /* 0x803CEE60@l */
/* 80B8E4D8  90 1E 00 00 */	stw r0, 0(r30)
/* 80B8E4DC  38 7E 00 04 */	addi r3, r30, 4
/* 80B8E4E0  3C 80 80 B9 */	lis r4, __ct__14J3DMatColorAnmFv@ha /* 0x80B8E818@ha */
/* 80B8E4E4  38 84 E8 18 */	addi r4, r4, __ct__14J3DMatColorAnmFv@l /* 0x80B8E818@l */
/* 80B8E4E8  3C A0 80 B9 */	lis r5, __dt__14J3DMatColorAnmFv@ha /* 0x80B8E7DC@ha */
/* 80B8E4EC  38 A5 E7 DC */	addi r5, r5, __dt__14J3DMatColorAnmFv@l /* 0x80B8E7DC@l */
/* 80B8E4F0  38 C0 00 08 */	li r6, 8
/* 80B8E4F4  38 E0 00 02 */	li r7, 2
/* 80B8E4F8  4B 7D 38 69 */	bl __construct_array
/* 80B8E4FC  38 7E 00 14 */	addi r3, r30, 0x14
/* 80B8E500  3C 80 80 B9 */	lis r4, __ct__12J3DTexMtxAnmFv@ha /* 0x80B8E7C4@ha */
/* 80B8E504  38 84 E7 C4 */	addi r4, r4, __ct__12J3DTexMtxAnmFv@l /* 0x80B8E7C4@l */
/* 80B8E508  3C A0 80 B9 */	lis r5, __dt__12J3DTexMtxAnmFv@ha /* 0x80B8E788@ha */
/* 80B8E50C  38 A5 E7 88 */	addi r5, r5, __dt__12J3DTexMtxAnmFv@l /* 0x80B8E788@l */
/* 80B8E510  38 C0 00 08 */	li r6, 8
/* 80B8E514  38 E0 00 08 */	li r7, 8
/* 80B8E518  4B 7D 38 49 */	bl __construct_array
/* 80B8E51C  38 7E 00 54 */	addi r3, r30, 0x54
/* 80B8E520  3C 80 80 B9 */	lis r4, __ct__11J3DTexNoAnmFv@ha /* 0x80B8E764@ha */
/* 80B8E524  38 84 E7 64 */	addi r4, r4, __ct__11J3DTexNoAnmFv@l /* 0x80B8E764@l */
/* 80B8E528  3C A0 80 B9 */	lis r5, __dt__11J3DTexNoAnmFv@ha /* 0x80B8E71C@ha */
/* 80B8E52C  38 A5 E7 1C */	addi r5, r5, __dt__11J3DTexNoAnmFv@l /* 0x80B8E71C@l */
/* 80B8E530  38 C0 00 0C */	li r6, 0xc
/* 80B8E534  38 E0 00 08 */	li r7, 8
/* 80B8E538  4B 7D 38 29 */	bl __construct_array
/* 80B8E53C  38 7E 00 B4 */	addi r3, r30, 0xb4
/* 80B8E540  3C 80 80 B9 */	lis r4, __ct__14J3DTevColorAnmFv@ha /* 0x80B8E704@ha */
/* 80B8E544  38 84 E7 04 */	addi r4, r4, __ct__14J3DTevColorAnmFv@l /* 0x80B8E704@l */
/* 80B8E548  3C A0 80 B9 */	lis r5, __dt__14J3DTevColorAnmFv@ha /* 0x80B8E6C8@ha */
/* 80B8E54C  38 A5 E6 C8 */	addi r5, r5, __dt__14J3DTevColorAnmFv@l /* 0x80B8E6C8@l */
/* 80B8E550  38 C0 00 08 */	li r6, 8
/* 80B8E554  38 E0 00 04 */	li r7, 4
/* 80B8E558  4B 7D 38 09 */	bl __construct_array
/* 80B8E55C  38 7E 00 D4 */	addi r3, r30, 0xd4
/* 80B8E560  3C 80 80 B9 */	lis r4, __ct__15J3DTevKColorAnmFv@ha /* 0x80B8E6B0@ha */
/* 80B8E564  38 84 E6 B0 */	addi r4, r4, __ct__15J3DTevKColorAnmFv@l /* 0x80B8E6B0@l */
/* 80B8E568  3C A0 80 B9 */	lis r5, __dt__15J3DTevKColorAnmFv@ha /* 0x80B8E674@ha */
/* 80B8E56C  38 A5 E6 74 */	addi r5, r5, __dt__15J3DTevKColorAnmFv@l /* 0x80B8E674@l */
/* 80B8E570  38 C0 00 08 */	li r6, 8
/* 80B8E574  38 E0 00 04 */	li r7, 4
/* 80B8E578  4B 7D 37 E9 */	bl __construct_array
/* 80B8E57C  7F C3 F3 78 */	mr r3, r30
/* 80B8E580  4B 79 DD A1 */	bl initialize__14J3DMaterialAnmFv
/* 80B8E584  3C 60 80 3B */	lis r3, __vt__15daNpcF_MatAnm_c@ha /* 0x803B3920@ha */
/* 80B8E588  38 03 39 20 */	addi r0, r3, __vt__15daNpcF_MatAnm_c@l /* 0x803B3920@l */
/* 80B8E58C  90 1D 00 00 */	stw r0, 0(r29)
/* 80B8E590  7F A3 EB 78 */	mr r3, r29
/* 80B8E594  4B 5C 21 A5 */	bl initialize__15daNpcF_MatAnm_cFv
lbl_80B8E598:
...
/* 80B8E5F0  3C A0 80 B9 */	lis r5, lit_4484@ha /* 0x80B93298@ha */
/* 80B8E5F4  C0 25 32 98 */	lfs f1, lit_4484@l(r5)  /* 0x80B93298@l */
...
/* 80B8E640  3C A0 80 B9 */	lis r5, lit_4484@ha /* 0x80B93298@ha */
/* 80B8E644  C0 25 32 98 */	lfs f1, lit_4484@l(r5)  /* 0x80B93298@l */
...
/* 80B8E660  4B 7D 3B C9 */	bl _restgpr_29
