...
/* 80B8EF50  3C 80 80 B9 */	lis r4, l_btkGetParamList@ha /* 0x80B93890@ha */
/* 80B8EF54  84 A4 38 90 */	lwzu r5, l_btkGetParamList@l(r4)  /* 0x80B93890@l */
...
/* 80B8EF68  3C 80 80 B9 */	lis r4, l_resNames@ha /* 0x80B93948@ha */
/* 80B8EF6C  38 84 39 48 */	addi r4, r4, l_resNames@l /* 0x80B93948@l */
/* 80B8EF70  7C 84 00 2E */	lwzx r4, r4, r0
/* 80B8EF74  4B 5C 3C 31 */	bl getTexSRTKeyAnmP__8daNpcF_cFPci
...
/* 80B8EF90  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80B8EF94  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80B8EF98  7C 04 04 2E */	lfsx f0, r4, r0
/* 80B8EF9C  3C 60 80 B9 */	lis r3, lit_4767@ha /* 0x80B932A8@ha */
/* 80B8EFA0  C0 43 32 A8 */	lfs f2, lit_4767@l(r3)  /* 0x80B932A8@l */
/* 80B8EFA4  3C 60 80 B9 */	lis r3, lit_4768@ha /* 0x80B932AC@ha */
/* 80B8EFA8  C0 23 32 AC */	lfs f1, lit_4768@l(r3)  /* 0x80B932AC@l */
