...
/* 80B601EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B601F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B601F4  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 80B601F8  7C 00 00 D0 */	neg r0, r0
/* 80B601FC  7C 04 07 34 */	extsh r4, r0
/* 80B60200  4B 4A C2 35 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B60204  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 80B60208  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B6020C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B60210  4B 4A C2 BD */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B60214  48 00 00 34 */	b lbl_80B60248
lbl_80B60218:
/* 80B60218  2C 1E 00 05 */	cmpwi r30, 5
/* 80B6021C  40 82 00 2C */	bne lbl_80B60248
/* 80B60220  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B60224  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B60228  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80B6022C  7C 00 00 D0 */	neg r0, r0
/* 80B60230  7C 04 07 34 */	extsh r4, r0
/* 80B60234  4B 4A C2 01 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B60238  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80B6023C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B60240  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B60244  4B 4A C2 89 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B60248:
/* 80B60248  2C 1E 00 0D */	cmpwi r30, 0xd
/* 80B6024C  40 82 00 14 */	bne lbl_80B60260
/* 80B60250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B60254  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B60258  A8 9F 0D CC */	lha r4, 0xdcc(r31)
/* 80B6025C  4B 4A C2 71 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B60260:
/* 80B60260  2C 1E 00 10 */	cmpwi r30, 0x10
/* 80B60264  40 82 00 14 */	bne lbl_80B60278
/* 80B60268  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B6026C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B60270  A8 9F 0D D0 */	lha r4, 0xdd0(r31)
/* 80B60274  4B 4A C2 59 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B60278:
