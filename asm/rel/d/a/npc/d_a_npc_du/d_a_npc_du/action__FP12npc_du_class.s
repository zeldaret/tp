...
/* 809B08F0  4B 9B 18 ED */	bl _savegpr_29
/* 809B08F4  7C 7E 1B 78 */	mr r30, r3
/* 809B08F8  3C 80 80 9B */	lis r4, lit_3762@ha /* 0x809B1848@ha */
/* 809B08FC  3B E4 18 48 */	addi r31, r4, lit_3762@l /* 0x809B1848@l */
/* 809B0900  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B0904  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809B0908  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 809B090C  4B 66 9E D5 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 809B0910  D0 3E 05 B8 */	stfs f1, 0x5b8(r30)
/* 809B0914  7F C3 F3 78 */	mr r3, r30
/* 809B0918  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 809B091C  4B 66 9D F5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809B09F8  4B 67 C6 75 */	bl dComIfGp_getReverb__Fi
...
/* 809B0A0C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809B0A10  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 809B0A38  4B 8F AF 4D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_809B0A3C:
/* 809B0A3C  88 1E 09 80 */	lbz r0, 0x980(r30)
/* 809B0A40  2C 00 00 01 */	cmpwi r0, 1
/* 809B0A44  40 82 00 3C */	bne lbl_809B0A80
/* 809B0A48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B0A4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809B0A90  4B 8B FB 79 */	bl cLib_addCalcAngleS2__FPssss
...
/* 809B0AA4  4B 8B FB 65 */	bl cLib_addCalcAngleS2__FPssss
/* 809B0AA8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 809B0AAC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 809B0AB0  80 63 00 00 */	lwz r3, 0(r3)
/* 809B0AB4  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 809B0AB8  4B 65 B9 25 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 809B0AD8  4B 8C 04 15 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 809B0AF8  4B 99 65 99 */	bl PSVECAdd
...
/* 809B0B5C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B0B60  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809B0B64  3B A4 0F 38 */	addi r29, r4, 0xf38
/* 809B0B68  7F A4 EB 78 */	mr r4, r29
/* 809B0B6C  4B 6C 5F 41 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 809B0B70  38 61 00 30 */	addi r3, r1, 0x30
/* 809B0B74  4B 6C 6C 3D */	bl __ct__18dBgS_ObjGndChk_SplFv
...
/* 809B0BAC  4B 8B 71 7D */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 809B0BB0  7F A3 EB 78 */	mr r3, r29
/* 809B0BB4  38 81 00 30 */	addi r4, r1, 0x30
/* 809B0BB8  4B 6C 38 E9 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 809B0BE8  4B 8B EE 55 */	bl cLib_addCalc2__FPffff
...
lbl_809B0C48:
/* 809B0C48  4B 66 C4 C5 */	bl fopAcM_effHamonSet__FPUlPC4cXyzff
lbl_809B0C4C:
...
/* 809B0C5C  4B 8B 6C F9 */	bl cM_rndF__Ff
...
/* 809B0C70  4B 8B 6D 1D */	bl cM_rndFX__Ff
...
/* 809B0C94  4B 8B F9 75 */	bl cLib_addCalcAngleS2__FPssss
/* 809B0C98  38 61 00 30 */	addi r3, r1, 0x30
/* 809B0C9C  38 80 FF FF */	li r4, -1
/* 809B0CA0  4B 6C 6B A9 */	bl __dt__18dBgS_ObjGndChk_SplFv
/* 809B0CA4  39 61 00 A0 */	addi r11, r1, 0xa0
/* 809B0CA8  4B 9B 15 81 */	bl _restgpr_29
