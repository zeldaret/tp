...
/* 809B11F0  4B 9B 0F E9 */	bl _savegpr_28
/* 809B11F4  7C 7F 1B 78 */	mr r31, r3
/* 809B11F8  38 60 00 54 */	li r3, 0x54
/* 809B11FC  4B 91 DA 51 */	bl __nw__FUl
/* 809B1200  7C 7E 1B 79 */	or. r30, r3, r3
/* 809B1204  41 82 00 A4 */	beq lbl_809B12A8
/* 809B1208  3C 60 80 9B */	lis r3, d_a_npc_du__stringBase0@ha /* 0x809B18DC@ha */
/* 809B120C  38 63 18 DC */	addi r3, r3, d_a_npc_du__stringBase0@l /* 0x809B18DC@l */
/* 809B1210  38 63 00 07 */	addi r3, r3, 7
/* 809B1214  38 80 00 06 */	li r4, 6
/* 809B1218  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B121C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809B1230  4B 68 B0 BD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 809B1234  7C 7D 1B 78 */	mr r29, r3
/* 809B1238  3C 60 80 9B */	lis r3, d_a_npc_du__stringBase0@ha /* 0x809B18DC@ha */
/* 809B123C  38 63 18 DC */	addi r3, r3, d_a_npc_du__stringBase0@l /* 0x809B18DC@l */
...
/* 809B1250  4B 68 B0 9D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 809B1290  3D 20 80 9B */	lis r9, lit_3762@ha /* 0x809B1848@ha */
/* 809B1294  C0 29 18 48 */	lfs f1, lit_3762@l(r9)  /* 0x809B1848@l */
/* 809B1298  39 20 00 00 */	li r9, 0
/* 809B129C  39 40 FF FF */	li r10, -1
/* 809B12A0  4B 65 E9 AD */	bl __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 809B12D4  3C 60 80 9B */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x809AFE20@ha */
/* 809B12D8  38 83 FE 20 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l /* 0x809AFE20@l */
...
/* 809B130C  4B 91 D9 41 */	bl __nw__FUl
/* 809B1310  7C 7E 1B 79 */	or. r30, r3, r3
/* 809B1314  41 82 00 20 */	beq lbl_809B1334
/* 809B1318  3C 80 80 9B */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x809B19C8@ha */
/* 809B131C  38 04 19 C8 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x809B19C8@l */
/* 809B1320  90 1E 00 00 */	stw r0, 0(r30)
/* 809B1324  38 80 00 00 */	li r4, 0
/* 809B1328  4B 97 70 D5 */	bl init__12J3DFrameCtrlFs
...
lbl_809B134C:
/* 809B134C  3C 60 80 9B */	lis r3, d_a_npc_du__stringBase0@ha /* 0x809B18DC@ha */
/* 809B1350  38 63 18 DC */	addi r3, r3, d_a_npc_du__stringBase0@l /* 0x809B18DC@l */
/* 809B1354  38 63 00 07 */	addi r3, r3, 7
/* 809B1358  38 80 00 0D */	li r4, 0xd
/* 809B135C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B1360  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809B1364  3C A5 00 02 */	addis r5, r5, 2
/* 809B1368  38 C0 00 80 */	li r6, 0x80
/* 809B136C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 809B1370  4B 68 AF 7D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 809B1394  3D 00 80 9B */	lis r8, lit_3762@ha /* 0x809B1848@ha */
/* 809B1398  C0 28 18 48 */	lfs f1, lit_3762@l(r8)  /* 0x809B1848@l */
/* 809B139C  39 00 00 00 */	li r8, 0
/* 809B13A0  39 20 FF FF */	li r9, -1
/* 809B13A4  4B 65 C1 A9 */	bl init__13mDoExt_btpAnmFP16J3DMaterialTableP16J3DAnmTexPatterniifss
/* 809B13A8  30 03 FF FF */	addic r0, r3, -1
/* 809B13AC  7C 60 19 10 */	subfe r3, r0, r3
lbl_809B13B0:
/* 809B13B0  39 61 00 30 */	addi r11, r1, 0x30
/* 809B13B4  4B 9B 0E 71 */	bl _restgpr_28
