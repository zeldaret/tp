...
/* 809B1420  4B 9B 0D B9 */	bl _savegpr_28
/* 809B1424  7C 7E 1B 78 */	mr r30, r3
/* 809B1428  3C 80 80 9B */	lis r4, lit_3762@ha /* 0x809B1848@ha */
/* 809B142C  3B E4 18 48 */	addi r31, r4, lit_3762@l /* 0x809B1848@l */
...
/* 809B1448  4B 66 77 1D */	bl __ct__10fopAc_ac_cFv
/* 809B144C  38 7D 05 E8 */	addi r3, r29, 0x5e8
/* 809B1450  4B 6C 4A 5D */	bl __ct__12dBgS_AcchCirFv
/* 809B1454  3B 9D 06 28 */	addi r28, r29, 0x628
/* 809B1458  7F 83 E3 78 */	mr r3, r28
/* 809B145C  4B 6C 4C 45 */	bl __ct__9dBgS_AcchFv
/* 809B1460  3C 60 80 9B */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x809B19A4@ha */
/* 809B1464  38 63 19 A4 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x809B19A4@l */
...
/* 809B1480  4B 6C 79 E9 */	bl SetObj__16dBgS_PolyPassChkFv
/* 809B1484  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 809B1488  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 809B148C  90 1D 08 1C */	stw r0, 0x81c(r29)
/* 809B1490  38 7D 08 20 */	addi r3, r29, 0x820
/* 809B1494  4B 6D 22 CD */	bl __ct__10dCcD_GSttsFv
/* 809B1498  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 809B149C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 809B14B4  4B 6D 25 75 */	bl __ct__12dCcD_GObjInfFv
/* 809B14B8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 809B14BC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 809B14C0  90 1C 01 20 */	stw r0, 0x120(r28)
/* 809B14C4  3C 60 80 9B */	lis r3, __vt__8cM3dGAab@ha /* 0x809B1998@ha */
/* 809B14C8  38 03 19 98 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809B1998@l */
/* 809B14CC  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 809B14D0  3C 60 80 9B */	lis r3, __vt__8cM3dGSph@ha /* 0x809B198C@ha */
/* 809B14D4  38 03 19 8C */	addi r0, r3, __vt__8cM3dGSph@l /* 0x809B198C@l */
/* 809B14D8  90 1C 01 34 */	stw r0, 0x134(r28)
/* 809B14DC  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 809B14E0  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 809B14E4  90 7C 01 20 */	stw r3, 0x120(r28)
/* 809B14E8  38 03 00 58 */	addi r0, r3, 0x58
/* 809B14EC  90 1C 01 34 */	stw r0, 0x134(r28)
/* 809B14F0  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 809B14F4  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 809B1510  4B 89 89 F1 */	bl __ct__10dMsgFlow_cFv
/* 809B1514  38 7D 09 DC */	addi r3, r29, 0x9dc
/* 809B1518  4B 90 D3 2D */	bl __ct__16Z2SoundObjSimpleFv
lbl_809B151C:
...
/* 809B152C  3C 80 80 9B */	lis r4, d_a_npc_du__stringBase0@ha /* 0x809B18DC@ha */
/* 809B1530  38 84 18 DC */	addi r4, r4, d_a_npc_du__stringBase0@l /* 0x809B18DC@l */
/* 809B1534  38 84 00 07 */	addi r4, r4, 7
/* 809B1538  4B 67 B9 85 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 809B1594  3C 80 80 9B */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x809B11E0@ha */
/* 809B1598  38 84 11 E0 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x809B11E0@l */
/* 809B159C  38 A0 12 80 */	li r5, 0x1280
/* 809B15A0  4B 66 8F 11 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_809B15B4:
/* 809B15B4  3C 60 80 9B */	lis r3, data_809B19E8@ha /* 0x809B19E8@ha */
/* 809B15B8  8C 03 19 E8 */	lbzu r0, data_809B19E8@l(r3)  /* 0x809B19E8@l */
...
/* 809B15D4  3C 60 80 9B */	lis r3, l_HIO@ha /* 0x809B19F8@ha */
/* 809B15D8  38 63 19 F8 */	addi r3, r3, l_HIO@l /* 0x809B19F8@l */
...
/* 809B161C  4B 6C 4C 2D */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 809B1620  38 7E 05 E8 */	addi r3, r30, 0x5e8
/* 809B1624  C0 3F 00 50 */	lfs f1, 0x50(r31)
/* 809B1628  C0 5F 00 88 */	lfs f2, 0x88(r31)
/* 809B162C  4B 6C 49 2D */	bl SetWall__12dBgS_AcchCirFff
...
/* 809B1640  4B 6D 22 21 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 809B1644  38 7E 08 40 */	addi r3, r30, 0x840
/* 809B1648  3C 80 80 9B */	lis r4, cc_sph_src@ha /* 0x809B18FC@ha */
/* 809B164C  38 84 18 FC */	addi r4, r4, cc_sph_src@l /* 0x809B18FC@l */
/* 809B1650  4B 6D 33 E5 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
/* 809B1654  38 1E 08 04 */	addi r0, r30, 0x804
/* 809B1658  90 1E 08 84 */	stw r0, 0x884(r30)
/* 809B165C  C0 3F 00 8C */	lfs f1, 0x8c(r31)
/* 809B1660  4B 8B 62 F5 */	bl cM_rndF__Ff
...
/* 809B168C  4B 9B 0B 99 */	bl _restgpr_28
