...
/* 809B6910  4B 9A B8 CD */	bl _savegpr_29
/* 809B6914  7C 7F 1B 78 */	mr r31, r3
/* 809B6918  3C A0 80 9C */	lis r5, m__19daNpc_Fairy_Param_c@ha /* 0x809B92E4@ha */
/* 809B691C  3B C5 92 E4 */	addi r30, r5, m__19daNpc_Fairy_Param_c@l /* 0x809B92E4@l */
...
/* 809B6930  3C 80 80 9C */	lis r4, lit_6222@ha /* 0x809B9E2C@ha */
/* 809B6934  38 84 9E 2C */	addi r4, r4, lit_6222@l /* 0x809B9E2C@l */
...
/* 809B695C  4B 78 EF 3D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 809B6980  4B 7F 1E 65 */	bl dKy_change_colpat__FUc
/* 809B6984  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809B6988  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 809B699C  4B 8F 91 F9 */	bl bgmStreamPrepare__8Z2SeqMgrFUl
...
/* 809B69B4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809B69B8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 809B69BC  80 63 00 00 */	lwz r3, 0(r3)
/* 809B69C0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 809B69C4  4B 8F 94 55 */	bl bgmStreamPlay__8Z2SeqMgrFv
/* 809B69C8  38 60 00 0C */	li r3, 0xc
/* 809B69CC  4B 7F 1E 19 */	bl dKy_change_colpat__FUc
/* 809B69D0  48 00 00 F0 */	b lbl_809B6AC0
lbl_809B69D4:
/* 809B69D4  80 9F 0A 7C */	lwz r4, 0xa7c(r31)
/* 809B69D8  38 A0 00 00 */	li r5, 0
/* 809B69DC  4B 79 52 15 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 809B6A30  4B 78 EE 69 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 809B6A5C  4B 78 EE 3D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
lbl_809B6A74:
/* 809B6A74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B6A78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809B6AA0  4B 79 51 51 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 809B6AA4  48 00 00 1C */	b lbl_809B6AC0
lbl_809B6AA8:
/* 809B6AA8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809B6AAC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 809B6AB0  80 63 00 00 */	lwz r3, 0(r3)
/* 809B6AB4  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 809B6AB8  38 80 00 2D */	li r4, 0x2d
/* 809B6ABC  4B 8F 94 21 */	bl bgmStreamStop__8Z2SeqMgrFUl
lbl_809B6AC0:
/* 809B6AC0  38 60 00 00 */	li r3, 0
/* 809B6AC4  39 61 00 30 */	addi r11, r1, 0x30
/* 809B6AC8  4B 9A B7 61 */	bl _restgpr_29
