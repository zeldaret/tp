...
/* 809B1BD8  3C 60 80 9C */	lis r3, l_resNameList@ha /* 0x809B95F8@ha */
/* 809B1BDC  38 63 95 F8 */	addi r3, r3, l_resNameList@l /* 0x809B95F8@l */
/* 809B1BE0  80 63 00 04 */	lwz r3, 4(r3)
/* 809B1BE4  38 80 00 22 */	li r4, 0x22
/* 809B1BE8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B1BEC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809B1BF0  3C A5 00 02 */	addis r5, r5, 2
/* 809B1BF4  38 C0 00 80 */	li r6, 0x80
/* 809B1BF8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 809B1BFC  4B 68 A6 F1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 809B1C00  7C 7F 1B 78 */	mr r31, r3
/* 809B1C04  38 60 00 58 */	li r3, 0x58
/* 809B1C08  4B 91 D0 45 */	bl __nw__FUl
...
/* 809B1C44  3D 20 80 9C */	lis r9, lit_3916@ha /* 0x809B9378@ha */
/* 809B1C48  C0 29 93 78 */	lfs f1, lit_3916@l(r9)  /* 0x809B9378@l */
/* 809B1C4C  39 20 00 00 */	li r9, 0
/* 809B1C50  39 40 FF FF */	li r10, -1
/* 809B1C54  4B 65 EB 7D */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 809B1C78  4B 65 F6 99 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
...
/* 809B1C9C  3C 60 80 9B */	lis r3, ctrlJointCallBack__16_Fairy_Feather_cFP8J3DJointi@ha /* 0x809B1F64@ha */
/* 809B1CA0  38 63 1F 64 */	addi r3, r3, ctrlJointCallBack__16_Fairy_Feather_cFP8J3DJointi@l /* 0x809B1F64@l */
