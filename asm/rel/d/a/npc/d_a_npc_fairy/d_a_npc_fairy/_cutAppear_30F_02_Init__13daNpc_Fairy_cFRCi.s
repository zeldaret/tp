...
/* 809B56B0  4B 79 01 E9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 809B56B4  93 FE 0B 80 */	stw r31, 0xb80(r30)
/* 809B56B8  38 00 00 03 */	li r0, 3
/* 809B56BC  90 1E 0B 7C */	stw r0, 0xb7c(r30)
/* 809B56C0  3C 60 80 9C */	lis r3, lit_3945@ha /* 0x809B93CC@ha */
/* 809B56C4  C0 03 93 CC */	lfs f0, lit_3945@l(r3)  /* 0x809B93CC@l */
...
/* 809B56D8  4B 7F 31 0D */	bl dKy_change_colpat__FUc
/* 809B56DC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809B56E0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 809B56F4  4B 8F A4 A1 */	bl bgmStreamPrepare__8Z2SeqMgrFUl
...
/* 809B5710  4B 7F 30 D5 */	bl dKy_change_colpat__FUc
/* 809B5714  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809B5718  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 809B571C  80 63 00 00 */	lwz r3, 0(r3)
/* 809B5720  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 809B5724  4B 8F A6 F5 */	bl bgmStreamPlay__8Z2SeqMgrFv
/* 809B5728  48 00 00 2C */	b lbl_809B5754
lbl_809B572C:
/* 809B572C  80 9E 0A 7C */	lwz r4, 0xa7c(r30)
/* 809B5730  38 A0 00 00 */	li r5, 0
/* 809B5734  4B 79 64 BD */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 809B5738  48 00 00 1C */	b lbl_809B5754
lbl_809B573C:
/* 809B573C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809B5740  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 809B5744  80 63 00 00 */	lwz r3, 0(r3)
/* 809B5748  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 809B574C  38 80 00 2D */	li r4, 0x2d
/* 809B5750  4B 8F A7 8D */	bl bgmStreamStop__8Z2SeqMgrFUl
lbl_809B5754:
