...
/* 809B1EC4  3C 60 80 9C */	lis r3, sBtkPrm@ha /* 0x809B93DC@ha */
/* 809B1EC8  38 83 93 DC */	addi r4, r3, sBtkPrm@l /* 0x809B93DC@l */
/* 809B1ECC  7C 64 FA 14 */	add r3, r4, r31
/* 809B1ED0  80 03 00 08 */	lwz r0, 8(r3)
/* 809B1ED4  54 00 10 3A */	slwi r0, r0, 2
/* 809B1ED8  3C 60 80 9C */	lis r3, l_resNameList@ha /* 0x809B95F8@ha */
/* 809B1EDC  38 63 95 F8 */	addi r3, r3, l_resNameList@l /* 0x809B95F8@l */
/* 809B1EE0  7C 63 00 2E */	lwzx r3, r3, r0
/* 809B1EE4  7C 84 F8 2E */	lwzx r4, r4, r31
/* 809B1EE8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B1EEC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809B1EF0  3C A5 00 02 */	addis r5, r5, 2
/* 809B1EF4  38 C0 00 80 */	li r6, 0x80
/* 809B1EF8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 809B1EFC  4B 68 A3 F1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 809B1F28  3C E0 80 9C */	lis r7, sBtkPrm@ha /* 0x809B93DC@ha */
/* 809B1F2C  38 07 93 DC */	addi r0, r7, sBtkPrm@l /* 0x809B93DC@l */
/* 809B1F30  7C E0 FA 14 */	add r7, r0, r31
/* 809B1F34  80 E7 00 04 */	lwz r7, 4(r7)
/* 809B1F38  3D 00 80 9C */	lis r8, lit_3916@ha /* 0x809B9378@ha */
/* 809B1F3C  C0 28 93 78 */	lfs f1, lit_3916@l(r8)  /* 0x809B9378@l */
/* 809B1F40  39 00 00 00 */	li r8, 0
/* 809B1F44  39 20 FF FF */	li r9, -1
/* 809B1F48  4B 65 B6 F5 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
lbl_809B1F4C:
