...
/* 809B6C40  4B 9A B5 99 */	bl _savegpr_28
/* 809B6C44  7C 7C 1B 78 */	mr r28, r3
/* 809B6C48  7C 9D 23 78 */	mr r29, r4
/* 809B6C4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809B6C50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809B6C54  3B C3 4F F8 */	addi r30, r3, 0x4ff8
/* 809B6C58  7F C3 F3 78 */	mr r3, r30
/* 809B6C5C  3C A0 80 9C */	lis r5, d_a_npc_fairy__stringBase0@ha /* 0x809B94CC@ha */
/* 809B6C60  38 A5 94 CC */	addi r5, r5, d_a_npc_fairy__stringBase0@l /* 0x809B94CC@l */
/* 809B6C64  38 A5 00 FE */	addi r5, r5, 0xfe
/* 809B6C68  38 C0 00 03 */	li r6, 3
/* 809B6C6C  4B 69 14 81 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809B6C90  3C A0 80 9C */	lis r5, d_a_npc_fairy__stringBase0@ha /* 0x809B94CC@ha */
/* 809B6C94  38 A5 94 CC */	addi r5, r5, d_a_npc_fairy__stringBase0@l /* 0x809B94CC@l */
/* 809B6C98  38 A5 01 04 */	addi r5, r5, 0x104
/* 809B6C9C  38 C0 00 03 */	li r6, 3
/* 809B6CA0  4B 69 14 4D */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809B6CBC  4B 69 10 91 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 809B6CEC  4B 9A B5 39 */	bl _restgpr_28
