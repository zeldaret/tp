...
/* 809CBE9C  4B 99 63 3D */	bl _savegpr_28
...
/* 809CBEB0  3C 60 80 9D */	lis r3, lit_4478@ha /* 0x809CF5A0@ha */
/* 809CBEB4  38 83 F5 A0 */	addi r4, r3, lit_4478@l /* 0x809CF5A0@l */
...
/* 809CBEEC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CBEF0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CBEF4  4B 97 A5 BD */	bl PSMTXCopy
/* 809CBEF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CBEFC  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 809CBF30  4B 97 A5 81 */	bl PSMTXCopy
...
/* 809CBF60  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CBF64  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CBF68  4B 97 A5 49 */	bl PSMTXCopy
...
/* 809CBF94  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CBF98  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CBF9C  4B 97 A5 15 */	bl PSMTXCopy
...
/* 809CBFCC  3C C0 80 9D */	lis r6, m__17daNpc_grC_Param_c@ha /* 0x809CF51C@ha */
/* 809CBFD0  38 C6 F5 1C */	addi r6, r6, m__17daNpc_grC_Param_c@l /* 0x809CF51C@l */
/* 809CBFD4  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 809CBFD8  4B 78 73 A5 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_809CBFDC:
/* 809CBFDC  2C 1D 00 01 */	cmpwi r29, 1
/* 809CBFE0  40 82 00 30 */	bne lbl_809CC010
/* 809CBFE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CBFE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CBFEC  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 809CBFF0  7C 00 00 D0 */	neg r0, r0
/* 809CBFF4  7C 04 07 34 */	extsh r4, r0
/* 809CBFF8  4B 64 04 3D */	bl mDoMtx_YrotM__FPA4_fs
/* 809CBFFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC000  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC004  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 809CC008  4B 64 04 C5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 809CC00C  48 00 00 34 */	b lbl_809CC040
lbl_809CC010:
/* 809CC010  2C 1D 00 04 */	cmpwi r29, 4
/* 809CC014  40 82 00 2C */	bne lbl_809CC040
/* 809CC018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC01C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC020  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 809CC024  7C 00 00 D0 */	neg r0, r0
/* 809CC028  7C 04 07 34 */	extsh r4, r0
/* 809CC02C  4B 64 04 09 */	bl mDoMtx_YrotM__FPA4_fs
/* 809CC030  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC034  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC038  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 809CC03C  4B 64 04 91 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_809CC040:
/* 809CC040  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC044  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC048  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 809CC04C  80 04 00 0C */	lwz r0, 0xc(r4)
/* 809CC050  7C 80 F2 14 */	add r4, r0, r30
/* 809CC054  4B 97 A4 5D */	bl PSMTXCopy
/* 809CC058  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC05C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC060  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 809CC064  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 809CC068  4B 97 A4 49 */	bl PSMTXCopy
...
/* 809CC098  4B 64 18 F9 */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809CC0AC  4B 99 61 79 */	bl _restgpr_28
