...
/* 809CC414  4B 99 5D B5 */	bl _savegpr_24
/* 809CC418  7C 7C 1B 78 */	mr r28, r3
/* 809CC41C  3C 60 80 9D */	lis r3, lit_1109@ha /* 0x809CFB68@ha */
/* 809CC420  3B A3 FB 68 */	addi r29, r3, lit_1109@l /* 0x809CFB68@l */
/* 809CC424  3C 60 80 9D */	lis r3, m__17daNpc_grC_Param_c@ha /* 0x809CF51C@ha */
/* 809CC428  3B C3 F5 1C */	addi r30, r3, m__17daNpc_grC_Param_c@l /* 0x809CF51C@l */
...
/* 809CC454  3C 80 80 9D */	lis r4, __dt__4cXyzFv@ha /* 0x809CEDF8@ha */
/* 809CC458  38 84 ED F8 */	addi r4, r4, __dt__4cXyzFv@l /* 0x809CEDF8@l */
...
/* 809CC470  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC474  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC478  A8 9C 09 90 */	lha r4, 0x990(r28)
/* 809CC47C  4B 63 FF 61 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 809CC490  4B 8A 35 AD */	bl cLib_addCalc2__FPffff
...
/* 809CC4A4  4B 8A 35 99 */	bl cLib_addCalc2__FPffff
/* 809CC4A8  3B 00 00 00 */	li r24, 0
/* 809CC4AC  3B E0 00 00 */	li r31, 0
/* 809CC4B0  3B 60 00 00 */	li r27, 0
/* 809CC4B4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 809CC4B8  3B 23 9A 20 */	addi r25, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 809CC4BC  C3 DE 00 80 */	lfs f30, 0x80(r30)
/* 809CC4C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC4C4  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_809CC4C8:
...
/* 809CC4F8  4B 97 A8 75 */	bl PSMTXMultVec
...
/* 809CC550  4B 8A 41 81 */	bl cLib_chaseS__FPsss
...
/* 809CC598  3C 60 80 9D */	lis r3, ctrlJointCallBack__11daNpc_grC_cFP8J3DJointi@ha /* 0x809CC0E0@ha */
/* 809CC59C  38 83 C0 E0 */	addi r4, r3, ctrlJointCallBack__11daNpc_grC_cFP8J3DJointi@l /* 0x809CC0E0@l */
...
/* 809CC600  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC604  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC608  4B 97 9E A9 */	bl PSMTXCopy
/* 809CC60C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC610  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 809CC638  4B 97 A7 35 */	bl PSMTXMultVec
/* 809CC63C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC640  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC644  38 9D 00 60 */	addi r4, r29, 0x60
/* 809CC648  38 A1 00 30 */	addi r5, r1, 0x30
/* 809CC64C  4B 97 A7 21 */	bl PSMTXMultVec
/* 809CC650  38 7C 08 E4 */	addi r3, r28, 0x8e4
/* 809CC654  38 81 00 30 */	addi r4, r1, 0x30
/* 809CC658  4B 8A 46 1D */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 809CC65C  B0 7C 09 02 */	sth r3, 0x902(r28)
/* 809CC660  38 7C 08 E4 */	addi r3, r28, 0x8e4
/* 809CC664  38 81 00 30 */	addi r4, r1, 0x30
/* 809CC668  4B 8A 45 9D */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 809CC684  4B 89 A4 B1 */	bl __mi__4cXyzCFRC3Vec
...
/* 809CC6B4  4B 89 AF C1 */	bl cM_atan2s__Fff
...
/* 809CC6E0  4B 97 AA 59 */	bl PSVECSquareMag
...
/* 809CC750  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809CC754  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 809CC7C0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809CC7C4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 809CC7C8  48 00 00 08 */	b lbl_809CC7D0
lbl_809CC7CC:
/* 809CC7CC  FC 40 08 90 */	fmr f2, f1
lbl_809CC7D0:
/* 809CC7D0  C0 21 00 40 */	lfs f1, 0x40(r1)
/* 809CC7D4  4B 89 AE A1 */	bl cM_atan2s__Fff
...
/* 809CC878  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809CC87C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809CC880  4B 97 9C 31 */	bl PSMTXCopy
...
/* 809CC8AC  4B 8A 29 31 */	bl SetC__8cM3dGCylFRC4cXyz
...
/* 809CC8C4  4B 8A 29 35 */	bl SetH__8cM3dGCylFf
...
/* 809CC8DC  4B 8A 29 25 */	bl SetR__8cM3dGCylFf
/* 809CC8E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809CC8E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809CC8E8  38 63 23 3C */	addi r3, r3, 0x233c
/* 809CC8EC  38 9C 0C C4 */	addi r4, r28, 0xcc4
/* 809CC8F0  4B 89 82 B9 */	bl Set__4cCcSFP8cCcD_Obj
lbl_809CC8F4:
...
/* 809CC91C  4B 99 58 F9 */	bl _restgpr_24
