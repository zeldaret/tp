...
/* 809CC27C  4B 99 5F 61 */	bl _savegpr_29
/* 809CC280  7C 7E 1B 78 */	mr r30, r3
/* 809CC284  3C 80 80 9D */	lis r4, cNullVec__6Z2Calc@ha /* 0x809CF81C@ha */
/* 809CC288  3B E4 F8 1C */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x809CF81C@l */
...
/* 809CC2C0  4B 66 37 95 */	bl dComIfGs_wolfeye_effect_check__Fv
...
lbl_809CC2E0:
/* 809CC2E0  3C 60 80 9D */	lis r3, m__17daNpc_grC_Param_c@ha /* 0x809CF51C@ha */
/* 809CC2E4  38 63 F5 1C */	addi r3, r3, m__17daNpc_grC_Param_c@l /* 0x809CF51C@l */
/* 809CC2E8  88 03 00 6A */	lbz r0, 0x6a(r3)
/* 809CC2EC  28 00 00 00 */	cmplwi r0, 0
/* 809CC2F0  40 82 00 AC */	bne lbl_809CC39C
/* 809CC2F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809CC2F8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809CC398  4B 78 74 E5 */	bl orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_809CC39C:
/* 809CC39C  88 1E 09 EE */	lbz r0, 0x9ee(r30)
/* 809CC3A0  28 00 00 00 */	cmplwi r0, 0
/* 809CC3A4  41 82 00 1C */	beq lbl_809CC3C0
/* 809CC3A8  3C 60 80 9D */	lis r3, lit_4455@ha /* 0x809CF59C@ha */
/* 809CC3AC  C0 03 F5 9C */	lfs f0, lit_4455@l(r3)  /* 0x809CF59C@l */
...
/* 809CC3D8  4B 99 5E 51 */	bl _restgpr_29
