...
/* 809A7098  4B 9B B1 45 */	bl _savegpr_29
...
/* 809A70B0  3C 60 80 9B */	lis r3, l_bmdData@ha /* 0x809AA460@ha */
/* 809A70B4  38 83 A4 60 */	addi r4, r3, l_bmdData@l /* 0x809AA460@l */
/* 809A70B8  7C 64 2A 14 */	add r3, r4, r5
/* 809A70BC  80 03 00 04 */	lwz r0, 4(r3)
/* 809A70C0  54 00 10 3A */	slwi r0, r0, 2
/* 809A70C4  3C 60 80 9B */	lis r3, l_resNameList@ha /* 0x809AA478@ha */
/* 809A70C8  38 63 A4 78 */	addi r3, r3, l_resNameList@l /* 0x809AA478@l */
/* 809A70CC  7C 63 00 2E */	lwzx r3, r3, r0
/* 809A70D0  7C 84 28 2E */	lwzx r4, r4, r5
/* 809A70D4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809A70D8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809A70DC  3C A5 00 02 */	addis r5, r5, 2
/* 809A70E0  38 C0 00 80 */	li r6, 0x80
/* 809A70E4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 809A70E8  4B 69 52 05 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 809A7100  4B 92 7B 4D */	bl __nw__FUl
...
/* 809A713C  3D 20 80 9B */	lis r9, lit_4348@ha /* 0x809AA3D4@ha */
/* 809A7140  C0 29 A3 D4 */	lfs f1, lit_4348@l(r9)  /* 0x809AA3D4@l */
/* 809A7144  39 20 00 00 */	li r9, 0
/* 809A7148  39 40 FF FF */	li r10, -1
/* 809A714C  4B 66 96 85 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 809A717C  3C 60 80 9A */	lis r3, ctrlJointCallBack__11daNpc_Doc_cFP8J3DJointi@ha /* 0x809A75D0@ha */
/* 809A7180  38 83 75 D0 */	addi r4, r3, ctrlJointCallBack__11daNpc_Doc_cFP8J3DJointi@l /* 0x809A75D0@l */
...
/* 809A71B4  4B 92 7A 99 */	bl __nw__FUl
/* 809A71B8  7C 7F 1B 79 */	or. r31, r3, r3
/* 809A71BC  41 82 00 D0 */	beq lbl_809A728C
/* 809A71C0  7F FD FB 78 */	mr r29, r31
/* 809A71C4  3C 60 80 3D */	lis r3, __vt__14J3DMaterialAnm@ha /* 0x803CEE60@ha */
/* 809A71C8  38 03 EE 60 */	addi r0, r3, __vt__14J3DMaterialAnm@l /* 0x803CEE60@l */
/* 809A71CC  90 1F 00 00 */	stw r0, 0(r31)
/* 809A71D0  38 7F 00 04 */	addi r3, r31, 4
/* 809A71D4  3C 80 80 9A */	lis r4, __ct__14J3DMatColorAnmFv@ha /* 0x809A74B0@ha */
/* 809A71D8  38 84 74 B0 */	addi r4, r4, __ct__14J3DMatColorAnmFv@l /* 0x809A74B0@l */
/* 809A71DC  3C A0 80 9A */	lis r5, __dt__14J3DMatColorAnmFv@ha /* 0x809A7474@ha */
/* 809A71E0  38 A5 74 74 */	addi r5, r5, __dt__14J3DMatColorAnmFv@l /* 0x809A7474@l */
/* 809A71E4  38 C0 00 08 */	li r6, 8
/* 809A71E8  38 E0 00 02 */	li r7, 2
/* 809A71EC  4B 9B AB 75 */	bl __construct_array
/* 809A71F0  38 7F 00 14 */	addi r3, r31, 0x14
/* 809A71F4  3C 80 80 9A */	lis r4, __ct__12J3DTexMtxAnmFv@ha /* 0x809A745C@ha */
/* 809A71F8  38 84 74 5C */	addi r4, r4, __ct__12J3DTexMtxAnmFv@l /* 0x809A745C@l */
/* 809A71FC  3C A0 80 9A */	lis r5, __dt__12J3DTexMtxAnmFv@ha /* 0x809A7420@ha */
/* 809A7200  38 A5 74 20 */	addi r5, r5, __dt__12J3DTexMtxAnmFv@l /* 0x809A7420@l */
/* 809A7204  38 C0 00 08 */	li r6, 8
/* 809A7208  38 E0 00 08 */	li r7, 8
/* 809A720C  4B 9B AB 55 */	bl __construct_array
/* 809A7210  38 7F 00 54 */	addi r3, r31, 0x54
/* 809A7214  3C 80 80 9A */	lis r4, __ct__11J3DTexNoAnmFv@ha /* 0x809A73FC@ha */
/* 809A7218  38 84 73 FC */	addi r4, r4, __ct__11J3DTexNoAnmFv@l /* 0x809A73FC@l */
/* 809A721C  3C A0 80 9A */	lis r5, __dt__11J3DTexNoAnmFv@ha /* 0x809A73B4@ha */
/* 809A7220  38 A5 73 B4 */	addi r5, r5, __dt__11J3DTexNoAnmFv@l /* 0x809A73B4@l */
/* 809A7224  38 C0 00 0C */	li r6, 0xc
/* 809A7228  38 E0 00 08 */	li r7, 8
/* 809A722C  4B 9B AB 35 */	bl __construct_array
/* 809A7230  38 7F 00 B4 */	addi r3, r31, 0xb4
/* 809A7234  3C 80 80 9A */	lis r4, __ct__14J3DTevColorAnmFv@ha /* 0x809A739C@ha */
/* 809A7238  38 84 73 9C */	addi r4, r4, __ct__14J3DTevColorAnmFv@l /* 0x809A739C@l */
/* 809A723C  3C A0 80 9A */	lis r5, __dt__14J3DTevColorAnmFv@ha /* 0x809A7360@ha */
/* 809A7240  38 A5 73 60 */	addi r5, r5, __dt__14J3DTevColorAnmFv@l /* 0x809A7360@l */
/* 809A7244  38 C0 00 08 */	li r6, 8
/* 809A7248  38 E0 00 04 */	li r7, 4
/* 809A724C  4B 9B AB 15 */	bl __construct_array
/* 809A7250  38 7F 00 D4 */	addi r3, r31, 0xd4
/* 809A7254  3C 80 80 9A */	lis r4, __ct__15J3DTevKColorAnmFv@ha /* 0x809A7348@ha */
/* 809A7258  38 84 73 48 */	addi r4, r4, __ct__15J3DTevKColorAnmFv@l /* 0x809A7348@l */
/* 809A725C  3C A0 80 9A */	lis r5, __dt__15J3DTevKColorAnmFv@ha /* 0x809A730C@ha */
/* 809A7260  38 A5 73 0C */	addi r5, r5, __dt__15J3DTevKColorAnmFv@l /* 0x809A730C@l */
/* 809A7264  38 C0 00 08 */	li r6, 8
/* 809A7268  38 E0 00 04 */	li r7, 4
/* 809A726C  4B 9B AA F5 */	bl __construct_array
/* 809A7270  7F E3 FB 78 */	mr r3, r31
/* 809A7274  4B 98 50 AD */	bl initialize__14J3DMaterialAnmFv
/* 809A7278  3C 60 80 3B */	lis r3, __vt__15daNpcT_MatAnm_c@ha /* 0x803B3B6C@ha */
/* 809A727C  38 03 3B 6C */	addi r0, r3, __vt__15daNpcT_MatAnm_c@l /* 0x803B3B6C@l */
/* 809A7280  90 1D 00 00 */	stw r0, 0(r29)
/* 809A7284  7F A3 EB 78 */	mr r3, r29
/* 809A7288  4B 79 E4 DD */	bl initialize__15daNpcT_MatAnm_cFv
lbl_809A728C:
...
/* 809A72B0  4B 7A 30 D9 */	bl setFaceMotionAnm__8daNpcT_cFib
...
/* 809A72C4  3C A0 80 9B */	lis r5, lit_4037@ha /* 0x809AA3C4@ha */
/* 809A72C8  C0 25 A3 C4 */	lfs f1, lit_4037@l(r5)  /* 0x809AA3C4@l */
...
/* 809A72F8  4B 9B AF 31 */	bl _restgpr_29
