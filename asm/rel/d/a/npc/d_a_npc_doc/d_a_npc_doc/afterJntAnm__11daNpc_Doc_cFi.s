...
/* 809A7938  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809A793C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809A7940  4B 66 4A F5 */	bl mDoMtx_YrotM__FPA4_fs
/* 809A7944  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809A7948  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809A794C  A8 1F 0D 0E */	lha r0, 0xd0e(r31)
/* 809A7950  7C 00 00 D0 */	neg r0, r0
/* 809A7954  7C 04 07 34 */	extsh r4, r0
/* 809A7958  4B 66 4B 75 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 809A796C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809A7970  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809A7974  4B 66 4A C1 */	bl mDoMtx_YrotM__FPA4_fs
/* 809A7978  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809A797C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809A7980  A8 1F 0D 08 */	lha r0, 0xd08(r31)
/* 809A7984  7C 00 00 D0 */	neg r0, r0
/* 809A7988  7C 04 07 34 */	extsh r4, r0
/* 809A798C  4B 66 4B 41 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_809A7990:
