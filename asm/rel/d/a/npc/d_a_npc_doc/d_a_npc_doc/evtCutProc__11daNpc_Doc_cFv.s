...
/* 809A7CF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809A7CFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809A7D00  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 809A7D04  7F E3 FB 78 */	mr r3, r31
/* 809A7D08  3C 80 80 9B */	lis r4, d_a_npc_doc__stringBase0@ha /* 0x809AA428@ha */
/* 809A7D0C  38 84 A4 28 */	addi r4, r4, d_a_npc_doc__stringBase0@l /* 0x809AA428@l */
/* 809A7D10  38 84 00 0D */	addi r4, r4, 0xd
/* 809A7D14  7F C5 F3 78 */	mr r5, r30
/* 809A7D18  38 C0 FF FF */	li r6, -1
/* 809A7D1C  4B 69 FE 01 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 809A7D34  3C A0 80 9B */	lis r5, mCutNameList__11daNpc_Doc_c@ha /* 0x809AA8A4@ha */
/* 809A7D38  38 A5 A8 A4 */	addi r5, r5, mCutNameList__11daNpc_Doc_c@l /* 0x809AA8A4@l */
/* 809A7D3C  38 C0 00 01 */	li r6, 1
/* 809A7D40  38 E0 00 00 */	li r7, 0
/* 809A7D44  39 00 00 00 */	li r8, 0
/* 809A7D48  4B 6A 00 C9 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 809A7D5C  3C A0 80 9B */	lis r5, mCutList__11daNpc_Doc_c@ha /* 0x809AA8A8@ha */
/* 809A7D60  38 05 A8 A8 */	addi r0, r5, mCutList__11daNpc_Doc_c@l /* 0x809AA8A8@l */
/* 809A7D64  7D 80 32 14 */	add r12, r0, r6
/* 809A7D68  4B 9B A3 1D */	bl __ptmf_scall
...
/* 809A7D80  4B 6A 03 FD */	bl cutEnd__16dEvent_manager_cFi
lbl_809A7D84:
