...
/* 809A6CAC  3C 60 80 9B */	lis r3, __vt__11daNpc_Doc_c@ha /* 0x809AA9F4@ha */
/* 809A6CB0  38 03 A9 F4 */	addi r0, r3, __vt__11daNpc_Doc_c@l /* 0x809AA9F4@l */
...
/* 809A6CC4  4B 66 A6 4D */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_809A6CC8:
/* 809A6CC8  7F C3 F3 78 */	mr r3, r30
/* 809A6CCC  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 809A6CD0  54 00 10 3A */	slwi r0, r0, 2
/* 809A6CD4  3C 80 80 9B */	lis r4, l_loadResPtrnList@ha /* 0x809AA488@ha */
/* 809A6CD8  38 84 A4 88 */	addi r4, r4, l_loadResPtrnList@l /* 0x809AA488@l */
/* 809A6CDC  7C 84 00 2E */	lwzx r4, r4, r0
/* 809A6CE0  3C A0 80 9B */	lis r5, l_resNameList@ha /* 0x809AA478@ha */
/* 809A6CE4  38 A5 A4 78 */	addi r5, r5, l_resNameList@l /* 0x809AA478@l */
/* 809A6CE8  4B 7A 17 C5 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 809A6CEC  34 1E 0F 84 */	addic. r0, r30, 0xf84
/* 809A6CF0  41 82 00 10 */	beq lbl_809A6D00
/* 809A6CF4  3C 60 80 9B */	lis r3, __vt__13daNpcT_Path_c@ha /* 0x809AA9E8@ha */
/* 809A6CF8  38 03 A9 E8 */	addi r0, r3, __vt__13daNpcT_Path_c@l /* 0x809AA9E8@l */
/* 809A6CFC  90 1E 0F A8 */	stw r0, 0xfa8(r30)
lbl_809A6D00:
/* 809A6D00  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 809A6D04  41 82 00 84 */	beq lbl_809A6D88
/* 809A6D08  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 809A6D0C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 809A6D2C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 809A6D30  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 809A6D48  3C 60 80 9B */	lis r3, __vt__8cM3dGCyl@ha /* 0x809AA9DC@ha */
/* 809A6D4C  38 03 A9 DC */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x809AA9DC@l */
/* 809A6D50  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_809A6D54:
/* 809A6D54  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 809A6D58  41 82 00 24 */	beq lbl_809A6D7C
/* 809A6D5C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 809A6D60  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 809A6D64  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 809A6D68  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 809A6D6C  41 82 00 10 */	beq lbl_809A6D7C
/* 809A6D70  3C 60 80 9B */	lis r3, __vt__8cM3dGAab@ha /* 0x809AA9D0@ha */
/* 809A6D74  38 03 A9 D0 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x809AA9D0@l */
/* 809A6D78  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_809A6D7C:
/* 809A6D7C  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 809A6D80  38 80 00 00 */	li r4, 0
/* 809A6D84  4B 6D D3 61 */	bl __dt__12dCcD_GObjInfFv
lbl_809A6D88:
...
/* 809A6DA0  4B 92 7F 9D */	bl __dl__FPv
lbl_809A6DA4:
