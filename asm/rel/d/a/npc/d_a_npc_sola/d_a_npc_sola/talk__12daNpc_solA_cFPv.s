...
/* 80AEDD70  4B 87 44 6D */	bl _savegpr_29
...
/* 80AEDDA4  4B 65 DE 4D */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80AEDDCC  4B 65 79 31 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80AEDDD0  38 00 00 00 */	li r0, 0
/* 80AEDDD4  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AEDDD8  3C 60 80 AF */	lis r3, lit_4295@ha /* 0x80AEF19C@ha */
/* 80AEDDDC  C0 03 F1 9C */	lfs f0, lit_4295@l(r3)  /* 0x80AEF19C@l */
...
/* 80AEDDFC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AEDE00  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AEDE04  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 80AEDE08  4B 52 C9 09 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80AEDE2C  4B 52 C8 E5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80AEDE48  4B 65 D8 01 */	bl step__8daNpcT_cFsiiii
...
/* 80AEDE7C  4B 65 DD FD */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
/* 80AEDE80  2C 03 00 00 */	cmpwi r3, 0
/* 80AEDE84  41 82 00 30 */	beq lbl_80AEDEB4
/* 80AEDE88  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 80AEDE8C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AEDE90  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AEDE94  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80AEDE98  4B 65 78 49 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80AEDE9C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AEDEA0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AEDEA4  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80AEDEA8  4B 55 45 C1 */	bl reset__14dEvt_control_cFv
...
/* 80AEDEBC  4B 87 43 6D */	bl _restgpr_29
