...
/* 80AECBCC  3C 60 80 AF */	lis r3, __vt__12daNpc_solA_c@ha
/* 80AECBD0  38 03 F3 A8 */	addi r0, r3, __vt__12daNpc_solA_c@l
...
/* 80AECBE8  4B 52 47 28 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80AECBEC:
/* 80AECBEC  7F C3 F3 78 */	mr r3, r30
/* 80AECBF0  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 80AECBF4  54 00 10 3A */	slwi r0, r0, 2
/* 80AECBF8  3C 80 80 AF */	lis r4, l_loadResPtrnList@ha
/* 80AECBFC  38 84 F2 38 */	addi r4, r4, l_loadResPtrnList@l
/* 80AECC00  7C 84 00 2E */	lwzx r4, r4, r0
/* 80AECC04  3C A0 80 AF */	lis r5, l_resNameList@ha
/* 80AECC08  38 A5 F2 2C */	addi r5, r5, l_resNameList@l
/* 80AECC0C  4B 65 B8 A0 */	b deleteRes__8daNpcT_cFPCScPPCc
/* 80AECC10  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80AECC14  41 82 00 84 */	beq lbl_80AECC98
/* 80AECC18  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80AECC1C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80AECC3C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80AECC40  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80AECC58  3C 60 80 AF */	lis r3, __vt__8cM3dGCyl@ha
/* 80AECC5C  38 03 F3 9C */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80AECC60  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_80AECC64:
/* 80AECC64  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80AECC68  41 82 00 24 */	beq lbl_80AECC8C
/* 80AECC6C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80AECC70  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80AECC74  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 80AECC78  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80AECC7C  41 82 00 10 */	beq lbl_80AECC8C
/* 80AECC80  3C 60 80 AF */	lis r3, __vt__8cM3dGAab@ha
/* 80AECC84  38 03 F3 90 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80AECC88  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_80AECC8C:
/* 80AECC8C  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80AECC90  38 80 00 00 */	li r4, 0
/* 80AECC94  4B 59 74 50 */	b __dt__12dCcD_GObjInfFv
lbl_80AECC98:
...
/* 80AECCB0  4B 7E 20 8C */	b __dl__FPv
lbl_80AECCB4:
