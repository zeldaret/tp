...
/* 80A9C2AC  3C 60 80 AA */	lis r3, __vt__18daNpc_Pachi_Taro_c@ha
/* 80A9C2B0  38 03 2A B0 */	addi r0, r3, __vt__18daNpc_Pachi_Taro_c@l
...
/* 80A9C2C4  4B 57 50 4C */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80A9C2C8:
/* 80A9C2C8  7F C3 F3 78 */	mr r3, r30
/* 80A9C2CC  88 1E 0F 88 */	lbz r0, 0xf88(r30)
/* 80A9C2D0  54 00 10 3A */	slwi r0, r0, 2
/* 80A9C2D4  3C 80 80 AA */	lis r4, l_loadResPtrnList@ha
/* 80A9C2D8  38 84 1A 0C */	addi r4, r4, l_loadResPtrnList@l
/* 80A9C2DC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A9C2E0  3C A0 80 AA */	lis r5, l_resNameList@ha
/* 80A9C2E4  38 A5 19 CC */	addi r5, r5, l_resNameList@l
/* 80A9C2E8  4B 6A C1 C4 */	b deleteRes__8daNpcT_cFPCScPPCc
/* 80A9C2EC  38 7E 0F 8C */	addi r3, r30, 0xf8c
/* 80A9C2F0  3C 80 80 AA */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha
/* 80A9C2F4  38 84 07 58 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l
/* 80A9C2F8  38 A0 00 08 */	li r5, 8
/* 80A9C2FC  38 C0 00 06 */	li r6, 6
/* 80A9C300  4B 8C 59 E8 */	b __destroy_arr
/* 80A9C304  34 1E 0E 4C */	addic. r0, r30, 0xe4c
/* 80A9C308  41 82 00 84 */	beq lbl_80A9C38C
/* 80A9C30C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80A9C310  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80A9C330  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80A9C334  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80A9C34C  3C 60 80 AA */	lis r3, __vt__8cM3dGCyl@ha
/* 80A9C350  38 03 2A A4 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80A9C354  90 1E 0F 84 */	stw r0, 0xf84(r30)
lbl_80A9C358:
/* 80A9C358  34 1E 0F 50 */	addic. r0, r30, 0xf50
/* 80A9C35C  41 82 00 24 */	beq lbl_80A9C380
/* 80A9C360  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80A9C364  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80A9C368  90 1E 0F 6C */	stw r0, 0xf6c(r30)
/* 80A9C36C  34 1E 0F 50 */	addic. r0, r30, 0xf50
/* 80A9C370  41 82 00 10 */	beq lbl_80A9C380
/* 80A9C374  3C 60 80 AA */	lis r3, __vt__8cM3dGAab@ha
/* 80A9C378  38 03 2A 98 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80A9C37C  90 1E 0F 68 */	stw r0, 0xf68(r30)
lbl_80A9C380:
/* 80A9C380  38 7E 0E 4C */	addi r3, r30, 0xe4c
/* 80A9C384  38 80 00 00 */	li r4, 0
/* 80A9C388  4B 5E 7D 5C */	b __dt__12dCcD_GObjInfFv
lbl_80A9C38C:
...
/* 80A9C3A4  4B 83 29 98 */	b __dl__FPv
lbl_80A9C3A8:
