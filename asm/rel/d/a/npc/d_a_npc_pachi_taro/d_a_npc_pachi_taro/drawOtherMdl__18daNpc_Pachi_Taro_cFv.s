...
/* 80A9DC2C  4B 8C 45 A5 */	bl _savegpr_26
...
/* 80A9DC44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A9DC48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80A9DC88:
/* 80A9DC88  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80A9DC8C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80A9DC90  80 84 00 04 */	lwz r4, 4(r4)
/* 80A9DC94  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80A9DC98  4B 70 71 09 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80A9DC9C  80 7F 00 84 */	lwz r3, 0x84(r31)
/* 80A9DCA0  80 83 00 0C */	lwz r4, 0xc(r3)
/* 80A9DCA4  3C 60 80 AA */	lis r3, jointNo@ha /* 0x80AA16EC@ha */
/* 80A9DCA8  38 63 16 EC */	addi r3, r3, jointNo@l /* 0x80AA16EC@l */
/* 80A9DCAC  7C 03 D0 2E */	lwzx r0, r3, r26
/* 80A9DCB0  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80A9DCB4  7C 64 02 14 */	add r3, r4, r0
/* 80A9DCB8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A9DCBC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A9DCC0  4B 8A 87 F1 */	bl PSMTXCopy
/* 80A9DCC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A9DCC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A9DCCC  38 81 00 08 */	addi r4, r1, 8
/* 80A9DCD0  4B 8A 87 E1 */	bl PSMTXCopy
/* 80A9DCD4  38 61 00 08 */	addi r3, r1, 8
/* 80A9DCD8  7C 9B E8 2E */	lwzx r4, r27, r29
/* 80A9DCDC  38 84 00 24 */	addi r4, r4, 0x24
/* 80A9DCE0  4B 8A 87 D1 */	bl PSMTXCopy
/* 80A9DCE4  7C 7B E8 2E */	lwzx r3, r27, r29
/* 80A9DCE8  4B 56 FF DD */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80A9DCEC  7F C3 F3 78 */	mr r3, r30
/* 80A9DCF0  80 9B 0D 94 */	lwz r4, 0xd94(r27)
/* 80A9DCF4  7C BB E8 2E */	lwzx r5, r27, r29
/* 80A9DCF8  4B 5B 82 25 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80A9DCFC:
...
/* 80A9DD10  4B 8C 45 0D */	bl _restgpr_26
