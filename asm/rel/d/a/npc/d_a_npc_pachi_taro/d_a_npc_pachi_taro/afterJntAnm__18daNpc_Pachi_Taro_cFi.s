...
/* 80A9CF2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A9CF30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A9CF34  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 80A9CF38  7C 00 00 D0 */	neg r0, r0
/* 80A9CF3C  7C 04 07 34 */	extsh r4, r0
/* 80A9CF40  4B 56 F4 F5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80A9CF44  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 80A9CF48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A9CF4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A9CF50  4B 56 F5 7D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80A9CF54  48 00 00 34 */	b lbl_80A9CF88
lbl_80A9CF58:
/* 80A9CF58  2C 04 00 04 */	cmpwi r4, 4
/* 80A9CF5C  40 82 00 2C */	bne lbl_80A9CF88
/* 80A9CF60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A9CF64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A9CF68  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80A9CF6C  7C 00 00 D0 */	neg r0, r0
/* 80A9CF70  7C 04 07 34 */	extsh r4, r0
/* 80A9CF74  4B 56 F4 C1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80A9CF78  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80A9CF7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A9CF80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A9CF84  4B 56 F5 49 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80A9CF88:
