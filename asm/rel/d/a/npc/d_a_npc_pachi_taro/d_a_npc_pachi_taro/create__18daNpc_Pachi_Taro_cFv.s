...
/* 80A9C3D4  4B 8C 5E 09 */	bl _savegpr_29
/* 80A9C3D8  7C 7D 1B 78 */	mr r29, r3
/* 80A9C3DC  3C 80 80 AA */	lis r4, m__24daNpc_Pachi_Taro_Param_c@ha /* 0x80AA1604@ha */
/* 80A9C3E0  3B E4 16 04 */	addi r31, r4, m__24daNpc_Pachi_Taro_Param_c@l /* 0x80AA1604@l */
/* 80A9C3E4  3C 80 80 AA */	lis r4, cNullVec__6Z2Calc@ha /* 0x80AA192C@ha */
/* 80A9C3E8  3B C4 19 2C */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x80AA192C@l */
...
/* 80A9C47C  4B 6A BF 7D */	bl loadRes__8daNpcT_cFPCScPPCc
...
/* 80A9C490  3C 80 80 AA */	lis r4, createHeapCallBack__18daNpc_Pachi_Taro_cFP10fopAc_ac_c@ha /* 0x80A9CCC0@ha */
/* 80A9C494  38 84 CC C0 */	addi r4, r4, createHeapCallBack__18daNpc_Pachi_Taro_cFP10fopAc_ac_c@l /* 0x80A9CCC0@l */
/* 80A9C498  38 A0 48 E0 */	li r5, 0x48e0
/* 80A9C49C  4B 57 E0 15 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80A9C4F4  4B 57 E0 55 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80A9C50C  4B 82 40 25 */	bl init__10Z2CreatureFP3VecP3VecUcUc
...
/* 80A9C538  4B 5D 9D 11 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80A9C55C  4B 5E 73 05 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80A9C560  38 7D 0E 4C */	addi r3, r29, 0xe4c
/* 80A9C564  3C 80 80 3B */	lis r4, mCcDCyl__8daNpcT_c@ha /* 0x803B36D8@ha */
/* 80A9C568  38 84 36 D8 */	addi r4, r4, mCcDCyl__8daNpcT_c@l /* 0x803B36D8@l */
/* 80A9C56C  4B 5E 83 49 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
/* 80A9C570  38 1D 08 64 */	addi r0, r29, 0x864
/* 80A9C574  90 1D 0E 90 */	stw r0, 0xe90(r29)
/* 80A9C578  3C 60 80 14 */	lis r3, tgHitCallBack__8daNpcT_cFP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 0x80147FA4@ha */
/* 80A9C57C  38 03 7F A4 */	addi r0, r3, tgHitCallBack__8daNpcT_cFP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 0x80147FA4@l */
/* 80A9C580  90 1D 0E F0 */	stw r0, 0xef0(r29)
/* 80A9C584  38 7D 06 8C */	addi r3, r29, 0x68c
/* 80A9C588  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A9C58C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A9C590  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80A9C594  4B 5D A5 19 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80A9C624  4B 6A C6 4D */	bl setEnvTevColor__8daNpcT_cFv
/* 80A9C628  7F A3 EB 78 */	mr r3, r29
/* 80A9C62C  4B 6A C6 A1 */	bl setRoomNo__8daNpcT_cFv
lbl_80A9C630:
...
/* 80A9C688  4B 8C 5B A1 */	bl _restgpr_29
