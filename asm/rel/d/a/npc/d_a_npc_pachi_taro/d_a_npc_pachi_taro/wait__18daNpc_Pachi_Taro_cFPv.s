...
/* 80A9DED4  4B 6A 79 C5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A9DED8  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 80A9DEDC  38 00 00 1F */	li r0, 0x1f
/* 80A9DEE0  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80A9DEE4  3C 60 80 AA */	lis r3, lit_4731@ha /* 0x80AA16C0@ha */
/* 80A9DEE8  C0 03 16 C0 */	lfs f0, lit_4731@l(r3)  /* 0x80AA16C0@l */
...
/* 80A9DF04  4B 6A 79 95 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A9DF08  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80A9DF0C  38 00 00 00 */	li r0, 0
/* 80A9DF10  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80A9DF14  3C 60 80 AA */	lis r3, lit_4731@ha /* 0x80AA16C0@ha */
/* 80A9DF18  C0 03 16 C0 */	lfs f0, lit_4731@l(r3)  /* 0x80AA16C0@l */
...
/* 80A9DF38  4B 6A 77 D1 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80A9DF60  4B 6A 77 9D */	bl remove__18daNpcT_ActorMngr_cFv
/* 80A9DF64  38 00 00 00 */	li r0, 0
/* 80A9DF68  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80A9DF6C  3C 60 80 AA */	lis r3, lit_4373@ha /* 0x80AA16A4@ha */
/* 80A9DF70  C0 03 16 A4 */	lfs f0, lit_4373@l(r3)  /* 0x80AA16A4@l */
...
/* 80A9DF9C  4B 6A 77 6D */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80A9DFB0  4B 6A CC 21 */	bl chkActorInSight__8daNpcT_cFP10fopAc_ac_cfs
...
/* 80A9DFCC  4B 6A 77 31 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80A9DFD0  38 00 00 00 */	li r0, 0
/* 80A9DFD4  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80A9DFD8  3C 60 80 AA */	lis r3, lit_4373@ha /* 0x80AA16A4@ha */
/* 80A9DFDC  C0 03 16 A4 */	lfs f0, lit_4373@l(r3)  /* 0x80AA16A4@l */
...
/* 80A9E004  4B 6A D3 35 */	bl srchPlayerActor__8daNpcT_cFv
...
/* 80A9E03C  4B 6A 76 C1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80A9E040  38 00 00 00 */	li r0, 0
/* 80A9E044  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80A9E048  3C 60 80 AA */	lis r3, lit_4373@ha /* 0x80AA16A4@ha */
/* 80A9E04C  C0 03 16 A4 */	lfs f0, lit_4373@l(r3)  /* 0x80AA16A4@l */
...
/* 80A9E0A0  4B 6A D5 A9 */	bl step__8daNpcT_cFsiiii
...
/* 80A9E0BC  4B 6A C9 5D */	bl setAngle__8daNpcT_cFs
...
/* 80A9E0E4  4B 6A D2 55 */	bl srchPlayerActor__8daNpcT_cFv
lbl_80A9E0E8:
...
/* 80A9E104  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A9E108  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A9E10C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80A9E110  7F E4 FB 78 */	mr r4, r31
/* 80A9E114  3C A0 80 04 */	lis r5, dEv_defaultSkipProc__FPvi@ha /* 0x800425E8@ha */
/* 80A9E118  38 A5 25 E8 */	addi r5, r5, dEv_defaultSkipProc__FPvi@l /* 0x800425E8@l */
/* 80A9E11C  38 C0 00 00 */	li r6, 0
/* 80A9E120  4B 5A 47 F5 */	bl setSkipProc__14dEvt_control_cFPvPFPvi_ii
