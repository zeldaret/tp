...
/* 80AA1074  4B 8C 11 69 */	bl _savegpr_29
/* 80AA1078  7C 7F 1B 78 */	mr r31, r3
/* 80AA107C  7C 80 23 78 */	mr r0, r4
/* 80AA1080  FF E0 08 90 */	fmr f31, f1
/* 80AA1084  7C BD 2B 78 */	mr r29, r5
/* 80AA1088  3C 60 80 AA */	lis r3, m__24daNpc_Pachi_Taro_Param_c@ha /* 0x80AA1604@ha */
/* 80AA108C  3B C3 16 04 */	addi r30, r3, m__24daNpc_Pachi_Taro_Param_c@l /* 0x80AA1604@l */
...
/* 80AA10A8  4B 7C 5A 8D */	bl __mi__4cXyzCFRC3Vec
...
/* 80AA10D8  4B 8A 60 61 */	bl PSVECSquareMag
...
/* 80AA1148  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80AA114C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80AA11B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80AA11BC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80AA11C0  48 00 00 08 */	b lbl_80AA11C8
lbl_80AA11C4:
/* 80AA11C4  FC 40 08 90 */	fmr f2, f1
lbl_80AA11C8:
/* 80AA11C8  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80AA11CC  4B 7C 64 A9 */	bl cM_atan2s__Fff
...
/* 80AA1250  4B 8C 0F D9 */	bl _restgpr_29
