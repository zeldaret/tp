...
/* 8096E8BC  4B 9F 39 19 */	bl _savegpr_27
/* 8096E8C0  7C 7E 1B 78 */	mr r30, r3
/* 8096E8C4  3C 60 80 97 */	lis r3, m__17daNpc_Bou_Param_c@ha /* 0x80972860@ha */
/* 8096E8C8  3B E3 28 60 */	addi r31, r3, m__17daNpc_Bou_Param_c@l /* 0x80972860@l */
...
/* 8096E8EC  4B 7D 95 51 */	bl calc__19daNpcT_DmgStagger_cFi
...
/* 8096E9C0  4B 7D 83 19 */	bl setParam__15daNpcT_JntAnm_cFP10fopAc_ac_cP8J3DModelP4cXyziiiffffffffffP4cXyz
...
/* 8096E9D4  4B 7D 92 65 */	bl calcJntRad__15daNpcT_JntAnm_cFfff
/* 8096E9D8  7F C3 F3 78 */	mr r3, r30
/* 8096E9DC  4B 7D A7 B5 */	bl setMtx__8daNpcT_cFv
...
/* 8096EA0C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8096EA10  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8096EA14  4B 9D 7A 9D */	bl PSMTXCopy
/* 8096EA18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8096EA1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8096EA20  38 81 00 34 */	addi r4, r1, 0x34
/* 8096EA24  38 BE 05 38 */	addi r5, r30, 0x538
/* 8096EA28  4B 9D 83 45 */	bl PSMTXMultVec
...
/* 8096EAA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8096EAAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8096EAB0  A8 9E 0D 7A */	lha r4, 0xd7a(r30)
/* 8096EAB4  4B 69 D9 29 */	bl mDoMtx_YrotS__FPA4_fs
/* 8096EAB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8096EABC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8096EAC0  38 81 00 34 */	addi r4, r1, 0x34
/* 8096EAC4  7C 85 23 78 */	mr r5, r4
/* 8096EAC8  4B 9D 82 A5 */	bl PSMTXMultVec
/* 8096EACC  38 61 00 10 */	addi r3, r1, 0x10
/* 8096EAD0  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 8096EAD4  38 A1 00 34 */	addi r5, r1, 0x34
/* 8096EAD8  4B 8F 80 0D */	bl __pl__4cXyzCFRC3Vec
...
/* 8096EB00  4B 9F 37 21 */	bl _restgpr_27
