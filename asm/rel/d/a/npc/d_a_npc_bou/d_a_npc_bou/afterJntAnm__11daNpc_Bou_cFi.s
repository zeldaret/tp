...
/* 8096DD64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8096DD68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8096DD6C  4B 69 E6 C8 */	b mDoMtx_YrotM__FPA4_fs
/* 8096DD70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8096DD74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8096DD78  A8 1F 0D 0E */	lha r0, 0xd0e(r31)
/* 8096DD7C  7C 00 00 D0 */	neg r0, r0
/* 8096DD80  7C 04 07 34 */	extsh r4, r0
/* 8096DD84  4B 69 E7 48 */	b mDoMtx_ZrotM__FPA4_fs
...
/* 8096DD98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8096DD9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8096DDA0  4B 69 E6 94 */	b mDoMtx_YrotM__FPA4_fs
/* 8096DDA4  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 8096DDA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8096DDAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8096DDB0  4B 69 E7 1C */	b mDoMtx_ZrotM__FPA4_fs
lbl_8096DDB4:
