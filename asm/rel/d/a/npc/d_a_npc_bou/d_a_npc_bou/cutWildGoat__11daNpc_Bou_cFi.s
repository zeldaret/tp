...
/* 8096EE20  4B 9F 33 A9 */	bl _savegpr_24
...
/* 8096EE3C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8096EE40  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8096EE44  3B 3F 4F F8 */	addi r25, r31, 0x4ff8
/* 8096EE48  7F 23 CB 78 */	mr r3, r25
/* 8096EE4C  3C A0 80 97 */	lis r5, d_a_npc_bou__stringBase0@ha /* 0x8097299C@ha */
/* 8096EE50  38 A5 29 9C */	addi r5, r5, d_a_npc_bou__stringBase0@l /* 0x8097299C@l */
/* 8096EE54  38 A5 00 DA */	addi r5, r5, 0xda
/* 8096EE58  38 C0 00 03 */	li r6, 3
/* 8096EE5C  4B 6D 92 91 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8096EE74  3C A0 80 97 */	lis r5, d_a_npc_bou__stringBase0@ha /* 0x8097299C@ha */
/* 8096EE78  38 A5 29 9C */	addi r5, r5, d_a_npc_bou__stringBase0@l /* 0x8097299C@l */
/* 8096EE7C  38 A5 00 DE */	addi r5, r5, 0xde
/* 8096EE80  38 C0 00 03 */	li r6, 3
/* 8096EE84  4B 6D 92 69 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8096EE9C  3C A0 80 97 */	lis r5, d_a_npc_bou__stringBase0@ha /* 0x8097299C@ha */
/* 8096EEA0  38 A5 29 9C */	addi r5, r5, d_a_npc_bou__stringBase0@l /* 0x8097299C@l */
/* 8096EEA4  38 A5 00 E4 */	addi r5, r5, 0xe4
/* 8096EEA8  38 C0 00 03 */	li r6, 3
/* 8096EEAC  4B 6D 92 41 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8096EEC4  4B 6D 8E 89 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8096EED8  3C 60 80 97 */	lis r3, lit_5286@ha /* 0x80973250@ha */
/* 8096EEDC  38 63 32 50 */	addi r3, r3, lit_5286@l /* 0x80973250@l */
...
/* 8096EEF4  4B 7D 68 15 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8096EF08  4B 7D DC 25 */	bl daNpcT_offTmpBit__FUl
/* 8096EF0C  7F 43 D3 78 */	mr r3, r26
/* 8096EF10  80 9A 0A 7C */	lwz r4, 0xa7c(r26)
/* 8096EF14  38 A0 00 00 */	li r5, 0
/* 8096EF18  4B 7D CC D9 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 8096EF1C  48 00 00 E0 */	b lbl_8096EFFC
lbl_8096EF20:
/* 8096EF20  38 7A 0F 84 */	addi r3, r26, 0xf84
/* 8096EF24  4B 7D 67 E5 */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8096EF28  7C 64 1B 78 */	mr r4, r3
/* 8096EF2C  38 7F 4E C8 */	addi r3, r31, 0x4ec8
/* 8096EF30  4B 6D 47 2D */	bl setPt2__14dEvt_control_cFPv
/* 8096EF34  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8096EF38  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8096EF4C  4B 94 05 51 */	bl subBgmStart__8Z2SeqMgrFUl
/* 8096EF50  48 00 00 AC */	b lbl_8096EFFC
lbl_8096EF54:
/* 8096EF54  38 7A 0F 84 */	addi r3, r26, 0xf84
/* 8096EF58  4B 7D 67 B1 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8096EF80  4B 7D D5 81 */	bl daNpcT_getPlayerInfoFromPlayerList__FiiP4cXyzP5csXyz
/* 8096EF84  2C 03 00 00 */	cmpwi r3, 0
/* 8096EF88  41 82 00 2C */	beq lbl_8096EFB4
/* 8096EF8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8096EF90  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8096EFD4  4B 7D B9 35 */	bl setPos__8daNpcT_cF4cXyz
/* 8096EFD8  7F 43 D3 78 */	mr r3, r26
/* 8096EFDC  A8 9A 04 B6 */	lha r4, 0x4b6(r26)
/* 8096EFE0  4B 7D BA 39 */	bl setAngle__8daNpcT_cFs
/* 8096EFE4  48 00 00 18 */	b lbl_8096EFFC
lbl_8096EFE8:
/* 8096EFE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8096EFEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8096EFF0  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 8096EFF4  38 00 00 2A */	li r0, 0x2a
/* 8096EFF8  98 03 05 6A */	stb r0, 0x56a(r3)
lbl_8096EFFC:
/* 8096EFFC  3C 60 80 97 */	lis r3, lit_5178@ha /* 0x80972978@ha */
/* 8096F000  38 83 29 78 */	addi r4, r3, lit_5178@l /* 0x80972978@l */
...
/* 8096F050  4B 7D 66 AD */	bl remove__18daNpcT_ActorMngr_cFv
/* 8096F054  38 00 00 00 */	li r0, 0
/* 8096F058  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8096F05C  3C 60 80 97 */	lis r3, lit_4328@ha /* 0x80972928@ha */
/* 8096F060  C0 03 29 28 */	lfs f0, lit_4328@l(r3)  /* 0x80972928@l */
...
/* 8096F0A8  4B 7D C5 A1 */	bl step__8daNpcT_cFsiiii
...
/* 8096F0C0  4B 7D 66 3D */	bl remove__18daNpcT_ActorMngr_cFv
/* 8096F0C4  38 00 00 00 */	li r0, 0
/* 8096F0C8  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8096F0CC  3C 60 80 97 */	lis r3, lit_4328@ha /* 0x80972928@ha */
/* 8096F0D0  C0 03 29 28 */	lfs f0, lit_4328@l(r3)  /* 0x80972928@l */
...
/* 8096F108  4B 7D 66 01 */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8096F10C  7C 79 1B 78 */	mr r25, r3
/* 8096F110  38 7A 0B A8 */	addi r3, r26, 0xba8
/* 8096F114  4B 7D 65 F5 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8096F13C  4B 7D 65 C1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8096F140  38 00 00 00 */	li r0, 0
/* 8096F144  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8096F148  3C 60 80 97 */	lis r3, lit_4328@ha /* 0x80972928@ha */
/* 8096F14C  C0 03 29 28 */	lfs f0, lit_4328@l(r3)  /* 0x80972928@l */
...
/* 8096F178  4B 6A 9B 69 */	bl fopAc_IsActor__FPv
...
/* 8096F18C  4B 7D 65 55 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 8096F190  3C 60 80 97 */	lis r3, lit_4328@ha /* 0x80972928@ha */
/* 8096F194  C0 03 29 28 */	lfs f0, lit_4328@l(r3)  /* 0x80972928@l */
...
/* 8096F1C8  4B 7D CA B1 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 8096F210  4B 7D 64 F9 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8096F228  4B 7D 64 E1 */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8096F22C  7C 79 1B 78 */	mr r25, r3
/* 8096F230  38 7A 0B A8 */	addi r3, r26, 0xba8
/* 8096F234  4B 7D 64 D5 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 8096F25C  4B 7D 64 A1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8096F260  38 00 00 00 */	li r0, 0
/* 8096F264  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8096F268  3C 60 80 97 */	lis r3, lit_4328@ha /* 0x80972928@ha */
/* 8096F26C  C0 03 29 28 */	lfs f0, lit_4328@l(r3)  /* 0x80972928@l */
...
/* 8096F298  4B 6A 9A 49 */	bl fopAc_IsActor__FPv
...
/* 8096F2AC  4B 7D 64 35 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 8096F2B0  3C 60 80 97 */	lis r3, lit_4328@ha /* 0x80972928@ha */
/* 8096F2B4  C0 03 29 28 */	lfs f0, lit_4328@l(r3)  /* 0x80972928@l */
...
/* 8096F2D0  4B 9F 2F 45 */	bl _restgpr_24
