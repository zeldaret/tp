...
/* 8096F520  4B 9F 2C B5 */	bl _savegpr_27
/* 8096F524  7C 7D 1B 78 */	mr r29, r3
/* 8096F528  7C 9B 23 78 */	mr r27, r4
/* 8096F52C  3B E0 00 00 */	li r31, 0
/* 8096F530  3B C0 FF FF */	li r30, -1
/* 8096F534  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8096F538  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8096F53C  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 8096F540  7F 83 E3 78 */	mr r3, r28
/* 8096F544  3C A0 80 97 */	lis r5, d_a_npc_bou__stringBase0@ha /* 0x8097299C@ha */
/* 8096F548  38 A5 29 9C */	addi r5, r5, d_a_npc_bou__stringBase0@l /* 0x8097299C@l */
/* 8096F54C  38 A5 00 DA */	addi r5, r5, 0xda
/* 8096F550  38 C0 00 03 */	li r6, 3
/* 8096F554  4B 6D 8B 99 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8096F56C  4B 6D 87 E1 */	bl getIsAddvance__16dEvent_manager_cFi
...
lbl_8096F594:
/* 8096F594  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8096F598  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 8096F59C  80 63 00 00 */	lwz r3, 0(r3)
/* 8096F5A0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8096F5A4  4B 94 02 E1 */	bl subBgmStop__8Z2SeqMgrFv
/* 8096F5A8  38 60 00 1C */	li r3, 0x1c
/* 8096F5AC  4B 7D D5 41 */	bl daNpcT_onTmpBit__FUl
...
/* 8096F5C8  4B 7D 62 D1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8096F5CC  93 9D 0B 5C */	stw r28, 0xb5c(r29)
/* 8096F5D0  38 00 00 0A */	li r0, 0xa
/* 8096F5D4  90 1D 0B 58 */	stw r0, 0xb58(r29)
/* 8096F5D8  3C 60 80 97 */	lis r3, lit_4758@ha /* 0x80972940@ha */
/* 8096F5DC  C0 03 29 40 */	lfs f0, lit_4758@l(r3)  /* 0x80972940@l */
...
/* 8096F5F8  4B 7D 62 A1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8096F5FC  93 9D 0B 80 */	stw r28, 0xb80(r29)
/* 8096F600  38 00 00 00 */	li r0, 0
/* 8096F604  90 1D 0B 7C */	stw r0, 0xb7c(r29)
/* 8096F608  3C 60 80 97 */	lis r3, lit_4758@ha /* 0x80972940@ha */
/* 8096F60C  C0 03 29 40 */	lfs f0, lit_4758@l(r3)  /* 0x80972940@l */
...
/* 8096F620  4B 7D C5 D1 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 8096F668  4B 7D 60 95 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8096F66C  38 00 00 00 */	li r0, 0
/* 8096F670  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 8096F674  3C 60 80 97 */	lis r3, lit_4328@ha /* 0x80972928@ha */
/* 8096F678  C0 03 29 28 */	lfs f0, lit_4328@l(r3)  /* 0x80972928@l */
...
/* 8096F6C0  4B 7D BF 89 */	bl step__8daNpcT_cFsiiii
...
/* 8096F6D8  4B 7D 60 25 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8096F6DC  38 00 00 00 */	li r0, 0
/* 8096F6E0  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 8096F6E4  3C 60 80 97 */	lis r3, lit_4328@ha /* 0x80972928@ha */
/* 8096F6E8  C0 03 29 28 */	lfs f0, lit_4328@l(r3)  /* 0x80972928@l */
...
/* 8096F718  4B 7D C5 61 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
