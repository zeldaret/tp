...
/* 8095EE10  4B A0 33 CC */	b _savegpr_29
/* 8095EE14  7C 7E 1B 78 */	mr r30, r3
/* 8095EE18  7C 9F 23 78 */	mr r31, r4
/* 8095EE1C  1F BF 00 0C */	mulli r29, r31, 0xc
/* 8095EE20  3C 80 80 96 */	lis r4, l_btpGetParamList@ha
/* 8095EE24  38 A4 25 34 */	addi r5, r4, l_btpGetParamList@l
/* 8095EE28  7C 85 EA 14 */	add r4, r5, r29
/* 8095EE2C  80 04 00 08 */	lwz r0, 8(r4)
/* 8095EE30  54 00 10 3A */	slwi r0, r0, 2
/* 8095EE34  3C 80 80 96 */	lis r4, l_arcNames@ha
/* 8095EE38  38 84 25 94 */	addi r4, r4, l_arcNames@l
/* 8095EE3C  7C 84 00 2E */	lwzx r4, r4, r0
/* 8095EE40  7C A5 E8 2E */	lwzx r5, r5, r29
/* 8095EE44  4B 7F 3D 24 */	b getTexPtrnAnmP__8daNpcF_cFPci
/* 8095EE48  7C 64 1B 79 */	or. r4, r3, r3
/* 8095EE4C  3C 60 80 96 */	lis r3, l_btpGetParamList@ha
/* 8095EE50  38 03 25 34 */	addi r0, r3, l_btpGetParamList@l
...
/* 8095EE88  3C E0 80 96 */	lis r7, lit_4237@ha
/* 8095EE8C  C0 27 21 64 */	lfs f1, lit_4237@l(r7)
/* 8095EE90  4B 7F 3E 34 */	b setBtpAnm__8daNpcF_cFP16J3DAnmTexPatternP12J3DModelDatafi
...
/* 8095EECC  4B A0 33 5C */	b _restgpr_29
