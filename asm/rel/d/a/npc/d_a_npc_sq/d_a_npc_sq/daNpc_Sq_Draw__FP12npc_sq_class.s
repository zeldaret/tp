...
/* 80AF60C8  4B 86 C1 15 */	bl _savegpr_29
/* 80AF60CC  7C 7D 1B 78 */	mr r29, r3
/* 80AF60D0  3C 60 80 AF */	lis r3, lit_3768@ha /* 0x80AF7408@ha */
/* 80AF60D4  3B E3 74 08 */	addi r31, r3, lit_3768@l /* 0x80AF7408@l */
/* 80AF60D8  80 7D 06 1C */	lwz r3, 0x61c(r29)
/* 80AF60DC  83 C3 00 04 */	lwz r30, 4(r3)
/* 80AF60E0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80AF60E4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80AF60E8  38 80 00 00 */	li r4, 0
/* 80AF60EC  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80AF60F0  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80AF60F4  4B 6A D6 D1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80AF60F8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80AF60FC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80AF6100  80 9E 00 04 */	lwz r4, 4(r30)
/* 80AF6104  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80AF6108  4B 6A EC 99 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80AF611C  4B 51 75 BD */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80AF6120  80 7D 06 1C */	lwz r3, 0x61c(r29)
/* 80AF6124  4B 51 A5 5D */	bl entryDL__14mDoExt_McaMorfFv
...
/* 80AF6160  3C E0 80 AF */	lis r7, l_HIO@ha /* 0x80AF75D0@ha */
/* 80AF6164  38 E7 75 D0 */	addi r7, r7, l_HIO@l /* 0x80AF75D0@l */
...
/* 80AF6184  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80AF6188  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80AF618C  4B 53 87 85 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 80AF6190  90 7D 06 2C */	stw r3, 0x62c(r29)
/* 80AF6194  38 60 00 01 */	li r3, 1
/* 80AF6198  39 61 00 30 */	addi r11, r1, 0x30
/* 80AF619C  4B 86 C0 8D */	bl _restgpr_29
