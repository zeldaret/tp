...
/* 809E52B0  3C 80 80 9F */	lis r4, l_btkGetParamList@ha
/* 809E52B4  84 A4 80 4C */	lwzu r5, l_btkGetParamList@l(r4)
...
/* 809E52C8  3C 80 80 9F */	lis r4, l_resNames@ha
/* 809E52CC  38 84 80 84 */	addi r4, r4, l_resNames@l
/* 809E52D0  7C 84 00 2E */	lwzx r4, r4, r0
/* 809E52D4  4B 76 D8 D0 */	b getTexSRTKeyAnmP__8daNpcF_cFPci
...
/* 809E52F0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 809E52F4  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
/* 809E52F8  7C 04 04 2E */	lfsx f0, r4, r0
/* 809E52FC  3C 60 80 9E */	lis r3, lit_4746@ha
/* 809E5300  C0 43 7E 5C */	lfs f2, lit_4746@l(r3)
/* 809E5304  3C 60 80 9E */	lis r3, lit_4747@ha
/* 809E5308  C0 23 7E 60 */	lfs f1, lit_4747@l(r3)
