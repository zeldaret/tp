...
/* 8096385C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80963860  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80963864  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 80963868  7C 00 00 D0 */	neg r0, r0
/* 8096386C  7C 04 07 34 */	extsh r4, r0
/* 80963870  4B 6A 8B C4 */	b mDoMtx_YrotM__FPA4_fs
/* 80963874  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 80963878  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8096387C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80963880  4B 6A 8C 4C */	b mDoMtx_ZrotM__FPA4_fs
/* 80963884  48 00 00 34 */	b lbl_809638B8
lbl_80963888:
/* 80963888  2C 04 00 06 */	cmpwi r4, 6
/* 8096388C  40 82 00 2C */	bne lbl_809638B8
/* 80963890  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80963894  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80963898  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 8096389C  7C 00 00 D0 */	neg r0, r0
/* 809638A0  7C 04 07 34 */	extsh r4, r0
/* 809638A4  4B 6A 8B 90 */	b mDoMtx_YrotM__FPA4_fs
/* 809638A8  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 809638AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809638B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809638B4  4B 6A 8C 18 */	b mDoMtx_ZrotM__FPA4_fs
lbl_809638B8:
