...
/* 809D8AF8  4B 98 96 E5 */	bl _savegpr_29
...
/* 809D8B2C  4B 77 30 C5 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 809D8B5C  4B 76 CB A1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 809D8B60  38 00 00 00 */	li r0, 0
/* 809D8B64  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 809D8B68  3C 60 80 9E */	lis r3, lit_4008@ha /* 0x809D9E18@ha */
/* 809D8B6C  C0 03 9E 18 */	lfs f0, lit_4008@l(r3)  /* 0x809D9E18@l */
...
/* 809D8B88  3C 60 80 9E */	lis r3, lit_4977@ha /* 0x809DA28C@ha */
/* 809D8B8C  38 63 A2 8C */	addi r3, r3, lit_4977@l /* 0x809DA28C@l */
/* 809D8B90  38 9E 10 C0 */	addi r4, r30, 0x10c0
/* 809D8B94  4B 98 94 B5 */	bl __ptmf_cmpr
...
/* 809D8BAC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809D8BB0  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809D8BB4  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 809D8BB8  4B 64 1B 59 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809D8BD4  4B 64 1B 3D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809D8BF0  4B 77 2A 59 */	bl step__8daNpcT_cFsiiii
...
/* 809D8C18  4B 77 30 61 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
/* 809D8C1C  2C 03 00 00 */	cmpwi r3, 0
/* 809D8C20  41 82 00 30 */	beq lbl_809D8C50
/* 809D8C24  38 7E 0B 98 */	addi r3, r30, 0xb98
/* 809D8C28  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809D8C2C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809D8C30  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 809D8C34  4B 76 CA AD */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 809D8C38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809D8C3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809D8C40  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 809D8C44  4B 66 98 25 */	bl reset__14dEvt_control_cFv
...
/* 809D8C58  4B 98 95 D1 */	bl _restgpr_29
