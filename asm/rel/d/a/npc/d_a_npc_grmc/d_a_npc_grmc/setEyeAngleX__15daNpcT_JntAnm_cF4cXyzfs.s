...
/* 809D9A28  4B 98 87 B4 */	b _savegpr_29
/* 809D9A2C  7C 7F 1B 78 */	mr r31, r3
/* 809D9A30  7C 80 23 78 */	mr r0, r4
/* 809D9A34  FF E0 08 90 */	fmr f31, f1
/* 809D9A38  7C BD 2B 78 */	mr r29, r5
/* 809D9A3C  3C 60 80 9E */	lis r3, m__18daNpc_grMC_Param_c@ha
/* 809D9A40  3B C3 9D 70 */	addi r30, r3, m__18daNpc_grMC_Param_c@l
...
/* 809D9A5C  4B 88 D0 D8 */	b __mi__4cXyzCFRC3Vec
...
/* 809D9A8C  4B 96 D6 AC */	b PSVECSquareMag
...
/* 809D9AFC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809D9B00  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 809D9B6C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809D9B70  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 809D9B74  48 00 00 08 */	b lbl_809D9B7C
lbl_809D9B78:
/* 809D9B78  FC 40 08 90 */	fmr f2, f1
lbl_809D9B7C:
/* 809D9B7C  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 809D9B80  4B 88 DA F4 */	b cM_atan2s__Fff
...
/* 809D9C04  4B 98 86 24 */	b _restgpr_29
