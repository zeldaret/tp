...
/* 80567210  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80567214  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80567218  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 8056721C  7C 00 00 D0 */	neg r0, r0
/* 80567220  7C 04 07 34 */	extsh r4, r0
/* 80567224  4B AA 52 10 */	b mDoMtx_YrotM__FPA4_fs
/* 80567228  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 8056722C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80567230  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80567234  4B AA 52 98 */	b mDoMtx_ZrotM__FPA4_fs
/* 80567238  48 00 00 34 */	b lbl_8056726C
lbl_8056723C:
/* 8056723C  2C 04 00 04 */	cmpwi r4, 4
/* 80567240  40 82 00 2C */	bne lbl_8056726C
/* 80567244  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80567248  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8056724C  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80567250  7C 00 00 D0 */	neg r0, r0
/* 80567254  7C 04 07 34 */	extsh r4, r0
/* 80567258  4B AA 51 DC */	b mDoMtx_YrotM__FPA4_fs
/* 8056725C  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80567260  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80567264  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80567268  4B AA 52 64 */	b mDoMtx_ZrotM__FPA4_fs
lbl_8056726C:
