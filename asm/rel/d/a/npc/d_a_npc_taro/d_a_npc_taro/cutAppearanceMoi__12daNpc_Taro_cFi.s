...
/* 8056A470  4B DF 7D 59 */	bl _savegpr_24
/* 8056A474  7C 7E 1B 78 */	mr r30, r3
/* 8056A478  7C 98 23 78 */	mr r24, r4
/* 8056A47C  3C 60 80 57 */	lis r3, m__18daNpc_Taro_Param_c@ha /* 0x805716C8@ha */
/* 8056A480  3B A3 16 C8 */	addi r29, r3, m__18daNpc_Taro_Param_c@l /* 0x805716C8@l */
/* 8056A484  3B E0 00 00 */	li r31, 0
/* 8056A488  3B 40 FF FF */	li r26, -1
/* 8056A48C  3B 20 00 00 */	li r25, 0
/* 8056A490  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056A494  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8056A498  3B 63 0F 38 */	addi r27, r3, 0xf38
/* 8056A49C  3B 9B 40 C0 */	addi r28, r27, 0x40c0
/* 8056A4A0  7F 83 E3 78 */	mr r3, r28
/* 8056A4A4  3C A0 80 57 */	lis r5, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 8056A4A8  38 A5 19 08 */	addi r5, r5, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
/* 8056A4AC  38 A5 02 9C */	addi r5, r5, 0x29c
/* 8056A4B0  38 C0 00 03 */	li r6, 3
/* 8056A4B4  4B AD DC 39 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056A4CC  3C A0 80 57 */	lis r5, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 8056A4D0  38 A5 19 08 */	addi r5, r5, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
/* 8056A4D4  38 A5 02 A0 */	addi r5, r5, 0x2a0
/* 8056A4D8  38 C0 00 03 */	li r6, 3
/* 8056A4DC  4B AD DC 11 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056A504  4B BD B2 05 */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8056A508  90 61 00 18 */	stw r3, 0x18(r1)
/* 8056A50C  80 01 00 14 */	lwz r0, 0x14(r1)
/* 8056A510  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056A514  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8056A54C  4B AD D8 01 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8056A560  3C 60 80 57 */	lis r3, lit_6877@ha /* 0x80573050@ha */
/* 8056A564  38 63 30 50 */	addi r3, r3, lit_6877@l /* 0x80573050@l */
...
/* 8056A58C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056A590  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8056A5A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A5AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A5B0  4B AA 1E 2D */	bl mDoMtx_YrotS__FPA4_fs
/* 8056A5B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A5B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A5BC  38 81 00 9C */	addi r4, r1, 0x9c
/* 8056A5C0  7C 85 23 78 */	mr r5, r4
/* 8056A5C4  4B DD C7 A9 */	bl PSMTXMultVec
...
/* 8056A5D8  4B DD CA B9 */	bl PSVECAdd
/* 8056A5DC  7F 83 E3 78 */	mr r3, r28
/* 8056A5E0  38 81 00 9C */	addi r4, r1, 0x9c
/* 8056A5E4  4B AD DD E1 */	bl setGoal__16dEvent_manager_cFP4cXyz
...
/* 8056A5F8  4B BE 25 35 */	bl daNpcT_offTmpBit__FUl
/* 8056A5FC  38 60 00 0C */	li r3, 0xc
/* 8056A600  4B BE 25 2D */	bl daNpcT_offTmpBit__FUl
...
/* 8056A61C  4B BD B2 7D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056A648  4B BD B2 51 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056A674  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A678  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A67C  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 8056A680  38 04 F8 E4 */	addi r0, r4, -1820
/* 8056A684  7C 04 07 34 */	extsh r4, r0
/* 8056A688  4B AA 1D 55 */	bl mDoMtx_YrotS__FPA4_fs
/* 8056A68C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A690  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A694  38 81 00 9C */	addi r4, r1, 0x9c
/* 8056A698  7C 85 23 78 */	mr r5, r4
/* 8056A69C  4B DD C6 D1 */	bl PSMTXMultVec
/* 8056A6A0  38 61 00 9C */	addi r3, r1, 0x9c
/* 8056A6A4  38 9E 04 A8 */	addi r4, r30, 0x4a8
/* 8056A6A8  7C 65 1B 78 */	mr r5, r3
/* 8056A6AC  4B DD C9 E5 */	bl PSVECAdd
...
/* 8056A6D0  4B BE 02 39 */	bl setPos__8daNpcT_cF4cXyz
/* 8056A6D4  7F C3 F3 78 */	mr r3, r30
/* 8056A6D8  38 80 00 78 */	li r4, 0x78
/* 8056A6DC  38 A1 00 14 */	addi r5, r1, 0x14
/* 8056A6E0  4B BE 15 11 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 8056A6E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056A6E8  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8056A718  4B AD DC AD */	bl setGoal__16dEvent_manager_cFP4cXyz
...
/* 8056A740  4B BD B1 59 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056A76C  4B BD B1 2D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056A78C  4B BE 02 8D */	bl setAngle__8daNpcT_cFs
...
/* 8056A7A8  4B BD B0 F1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056A7D4  4B BD B0 C5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056A81C  4B BE 01 FD */	bl setAngle__8daNpcT_cFs
...
/* 8056A834  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A838  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A83C  A8 9E 0D 7A */	lha r4, 0xd7a(r30)
/* 8056A840  4B AA 1B 9D */	bl mDoMtx_YrotS__FPA4_fs
/* 8056A844  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A848  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A84C  38 81 00 9C */	addi r4, r1, 0x9c
/* 8056A850  7C 85 23 78 */	mr r5, r4
/* 8056A854  4B DD C5 19 */	bl PSMTXMultVec
/* 8056A858  38 61 00 9C */	addi r3, r1, 0x9c
/* 8056A85C  38 9E 04 A8 */	addi r4, r30, 0x4a8
/* 8056A860  7C 65 1B 78 */	mr r5, r3
/* 8056A864  4B DD C8 2D */	bl PSVECAdd
...
/* 8056A888  4B BE 00 81 */	bl setPos__8daNpcT_cF4cXyz
...
/* 8056A8A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A8A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A8AC  38 81 00 9C */	addi r4, r1, 0x9c
/* 8056A8B0  7C 85 23 78 */	mr r5, r4
/* 8056A8B4  4B DD C4 B9 */	bl PSMTXMultVec
/* 8056A8B8  38 61 00 9C */	addi r3, r1, 0x9c
/* 8056A8BC  38 9E 04 A8 */	addi r4, r30, 0x4a8
/* 8056A8C0  7C 65 1B 78 */	mr r5, r3
/* 8056A8C4  4B DD C7 CD */	bl PSVECAdd
/* 8056A8C8  38 7E 09 30 */	addi r3, r30, 0x930
/* 8056A8CC  38 81 00 9C */	addi r4, r1, 0x9c
/* 8056A8D0  4B CF D4 59 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 8056A8D4  7F 63 DB 78 */	mr r3, r27
/* 8056A8D8  38 9E 09 30 */	addi r4, r30, 0x930
/* 8056A8DC  4B B0 9B C5 */	bl GroundCross__4cBgSFP11cBgS_GndChk
/* 8056A8E0  D0 21 00 A0 */	stfs f1, 0xa0(r1)
/* 8056A8E4  38 61 00 9C */	addi r3, r1, 0x9c
/* 8056A8E8  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 8056A8EC  4B D0 63 19 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 8056A8F0  7C 60 1B 78 */	mr r0, r3
/* 8056A8F4  B0 01 00 1E */	sth r0, 0x1e(r1)
/* 8056A8F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056A8FC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8056A94C  3C 60 80 57 */	lis r3, lit_6878@ha /* 0x80573024@ha */
/* 8056A950  38 63 30 24 */	addi r3, r3, lit_6878@l /* 0x80573024@l */
...
/* 8056A974  4B BD AD 89 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8056A9AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A9B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A9B4  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 8056A9B8  38 04 F8 E4 */	addi r0, r4, -1820
/* 8056A9BC  7C 04 07 34 */	extsh r4, r0
/* 8056A9C0  4B AA 1A 1D */	bl mDoMtx_YrotS__FPA4_fs
/* 8056A9C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056A9C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056A9CC  38 81 00 9C */	addi r4, r1, 0x9c
/* 8056A9D0  7C 85 23 78 */	mr r5, r4
/* 8056A9D4  4B DD C3 99 */	bl PSMTXMultVec
/* 8056A9D8  38 61 00 9C */	addi r3, r1, 0x9c
/* 8056A9DC  38 9E 04 A8 */	addi r4, r30, 0x4a8
/* 8056A9E0  7C 65 1B 78 */	mr r5, r3
/* 8056A9E4  4B DD C6 AD */	bl PSVECAdd
...
/* 8056AA2C  4B DD C9 71 */	bl PSVECSquareDistance
...
/* 8056AA9C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8056AAA0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8056AB0C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8056AB10  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8056AB14:
...
/* 8056AB34  4B BE 0C D5 */	bl calcSpeedAndAngle__8daNpcT_cF4cXyziss
...
/* 8056AB6C  4B DD C8 31 */	bl PSVECSquareDistance
...
/* 8056ABDC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8056ABE0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8056AC4C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8056AC50  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8056AC54:
...
/* 8056AC6C  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 8056AC70  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 8056AC94  4B BD AA 69 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8056ACE0  4B BD AA 1D */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8056AD1C  4B BE 0F 5D */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 8056AD4C  4B BD A9 B1 */	bl remove__18daNpcT_ActorMngr_cFv
...
lbl_8056AD98:
/* 8056AD98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056AD9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056ADA0  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 8056ADA4  38 04 F8 E4 */	addi r0, r4, -1820
/* 8056ADA8  7C 04 07 34 */	extsh r4, r0
/* 8056ADAC  4B AA 16 31 */	bl mDoMtx_YrotS__FPA4_fs
/* 8056ADB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8056ADB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056ADB8  38 81 00 9C */	addi r4, r1, 0x9c
/* 8056ADBC  7C 85 23 78 */	mr r5, r4
/* 8056ADC0  4B DD BF AD */	bl PSMTXMultVec
/* 8056ADC4  38 61 00 9C */	addi r3, r1, 0x9c
/* 8056ADC8  38 9E 04 A8 */	addi r4, r30, 0x4a8
/* 8056ADCC  7C 65 1B 78 */	mr r5, r3
/* 8056ADD0  4B DD C2 C1 */	bl PSVECAdd
...
/* 8056AE18  4B DD C5 85 */	bl PSVECSquareDistance
...
/* 8056AE88  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8056AE8C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8056AEF8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8056AEFC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8056AF00:
...
/* 8056AF20  4B BE 08 E9 */	bl calcSpeedAndAngle__8daNpcT_cF4cXyziss
...
/* 8056AF68  4B BE 06 E1 */	bl step__8daNpcT_cFsiiii
...
/* 8056AF88  4B BD A9 11 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056AFB4  4B BD A8 E5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056AFEC  4B DF 72 29 */	bl _restgpr_24
