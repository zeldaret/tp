...
/* 80568C68  4B DF 95 6D */	bl _savegpr_27
/* 80568C6C  7C 7E 1B 78 */	mr r30, r3
/* 80568C70  7C 9B 23 78 */	mr r27, r4
/* 80568C74  3B E0 00 00 */	li r31, 0
/* 80568C78  3B 80 FF FF */	li r28, -1
/* 80568C7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80568C80  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80568C84  3B A3 4F F8 */	addi r29, r3, 0x4ff8
/* 80568C88  7F A3 EB 78 */	mr r3, r29
/* 80568C8C  3C A0 80 57 */	lis r5, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 80568C90  38 A5 19 08 */	addi r5, r5, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
/* 80568C94  38 A5 02 9C */	addi r5, r5, 0x29c
/* 80568C98  38 C0 00 03 */	li r6, 3
/* 80568C9C  4B AD F4 51 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80568CB4  4B AD F0 99 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80568CDC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80568CE0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80568CE4  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80568CE8  4B AB 1A 29 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80568D18  4B BD C9 E5 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80568D1C  38 00 00 00 */	li r0, 0
/* 80568D20  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 80568D24  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 80568D28  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 80568D68  4B BE 28 E1 */	bl step__8daNpcT_cFsiiii
...
/* 80568D88  4B BD CB 11 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80568D8C  93 BE 0B 5C */	stw r29, 0xb5c(r30)
/* 80568D90  38 00 00 1F */	li r0, 0x1f
/* 80568D94  90 1E 0B 58 */	stw r0, 0xb58(r30)
/* 80568D98  3C 60 80 57 */	lis r3, lit_5232@ha /* 0x805717D0@ha */
/* 80568D9C  C0 03 17 D0 */	lfs f0, lit_5232@l(r3)  /* 0x805717D0@l */
...
/* 80568DB8  4B BD CA E1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80568DBC  93 BE 0B 80 */	stw r29, 0xb80(r30)
/* 80568DC0  38 00 00 00 */	li r0, 0
/* 80568DC4  90 1E 0B 7C */	stw r0, 0xb7c(r30)
/* 80568DC8  3C 60 80 57 */	lis r3, lit_5232@ha /* 0x805717D0@ha */
/* 80568DCC  C0 03 17 D0 */	lfs f0, lit_5232@l(r3)  /* 0x805717D0@l */
...
/* 80568DEC  4B DF 94 35 */	bl _restgpr_27
