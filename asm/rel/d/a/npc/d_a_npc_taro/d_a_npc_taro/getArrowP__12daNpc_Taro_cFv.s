...
/* 80566BF4  4B DF B5 DD */	bl _savegpr_26
/* 80566BF8  7C 7E 1B 78 */	mr r30, r3
/* 80566BFC  3B E0 00 00 */	li r31, 0
/* 80566C00  3C 60 80 57 */	lis r3, lit_4965@ha /* 0x805717C4@ha */
/* 80566C04  C3 C3 17 C4 */	lfs f30, lit_4965@l(r3)  /* 0x805717C4@l */
/* 80566C08  38 00 00 00 */	li r0, 0
/* 80566C0C  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha /* 0x80450FDC@ha */
/* 80566C10  90 03 0F DC */	stw r0, mFindCount__8daNpcT_c@l(r3)  /* 0x80450FDC@l */
/* 80566C14  3C 60 80 56 */	lis r3, srchArrow__12daNpc_Taro_cFPvPv@ha /* 0x80566A70@ha */
/* 80566C18  38 63 6A 70 */	addi r3, r3, srchArrow__12daNpc_Taro_cFPvPv@l /* 0x80566A70@l */
/* 80566C1C  7F C4 F3 78 */	mr r4, r30
/* 80566C20  4B AB 2B D9 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80566C24  3B 40 00 00 */	li r26, 0
/* 80566C28  3B A0 00 00 */	li r29, 0
/* 80566C2C  3C 60 80 42 */	lis r3, mFindActorPtrs__8daNpcT_c@ha /* 0x80425708@ha */
/* 80566C30  3B 63 57 08 */	addi r27, r3, mFindActorPtrs__8daNpcT_c@l /* 0x80425708@l */
/* 80566C34  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 80566C38  C3 E3 11 80 */	lfs f31, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
/* 80566C3C  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha /* 0x80450FDC@ha */
/* 80566C40  3B 83 0F DC */	addi r28, r3, mFindCount__8daNpcT_c@l /* 0x80450FDC@l */
...
/* 80566C6C  4B AB 3B 75 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80566C80  4B AB 3B 61 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80566CB8  4B DF B5 65 */	bl _restgpr_26
