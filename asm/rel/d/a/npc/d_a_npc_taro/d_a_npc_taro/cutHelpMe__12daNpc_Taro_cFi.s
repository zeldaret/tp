...
/* 8056A130  4B DF 80 A1 */	bl _savegpr_26
...
/* 8056A148  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056A14C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8056A150  3B 63 4F F8 */	addi r27, r3, 0x4ff8
/* 8056A154  7F 63 DB 78 */	mr r3, r27
/* 8056A158  3C A0 80 57 */	lis r5, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 8056A15C  38 A5 19 08 */	addi r5, r5, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
/* 8056A160  38 A5 02 9C */	addi r5, r5, 0x29c
/* 8056A164  38 C0 00 03 */	li r6, 3
/* 8056A168  4B AD DF 85 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056A180  3C A0 80 57 */	lis r5, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 8056A184  38 A5 19 08 */	addi r5, r5, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
/* 8056A188  38 A5 02 A0 */	addi r5, r5, 0x2a0
/* 8056A18C  38 C0 00 03 */	li r6, 3
/* 8056A190  4B AD DF 5D */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056A1A8  4B AD DB A5 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8056A1F0  4B BD B6 A9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056A1F4  93 7C 0B 5C */	stw r27, 0xb5c(r28)
/* 8056A1F8  38 00 00 1E */	li r0, 0x1e
/* 8056A1FC  90 1C 0B 58 */	stw r0, 0xb58(r28)
/* 8056A200  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056A204  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056A220  4B BD B6 79 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056A224  93 7C 0B 80 */	stw r27, 0xb80(r28)
/* 8056A228  38 00 00 1A */	li r0, 0x1a
/* 8056A22C  90 1C 0B 7C */	stw r0, 0xb7c(r28)
/* 8056A230  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056A234  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056A258  4B BD B6 41 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056A25C  93 7C 0B 5C */	stw r27, 0xb5c(r28)
/* 8056A260  38 00 00 1C */	li r0, 0x1c
/* 8056A264  90 1C 0B 58 */	stw r0, 0xb58(r28)
/* 8056A268  3C 60 80 57 */	lis r3, lit_5232@ha /* 0x805717D0@ha */
/* 8056A26C  C0 03 17 D0 */	lfs f0, lit_5232@l(r3)  /* 0x805717D0@l */
...
/* 8056A288  4B BD B6 11 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056A28C  93 7C 0B 80 */	stw r27, 0xb80(r28)
/* 8056A290  38 00 00 29 */	li r0, 0x29
/* 8056A294  90 1C 0B 7C */	stw r0, 0xb7c(r28)
/* 8056A298  3C 60 80 57 */	lis r3, lit_5232@ha /* 0x805717D0@ha */
/* 8056A29C  C0 03 17 D0 */	lfs f0, lit_5232@l(r3)  /* 0x805717D0@l */
...
/* 8056A2CC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8056A2D0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8056A33C  4B BD B3 C1 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8056A340  38 00 00 00 */	li r0, 0
/* 8056A344  90 1C 0B C8 */	stw r0, 0xbc8(r28)
/* 8056A348  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056A34C  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056A38C  4B BD B3 71 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8056A390  38 00 00 00 */	li r0, 0
/* 8056A394  90 1C 0B C8 */	stw r0, 0xbc8(r28)
/* 8056A398  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056A39C  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056A3D0  3C 80 80 57 */	lis r4, lit_4472@ha /* 0x805717AC@ha */
/* 8056A3D4  C0 24 17 AC */	lfs f1, lit_4472@l(r4)  /* 0x805717AC@l */
...
/* 8056A3EC  4B AB CD 85 */	bl dStage_changeScene__FifUlScsi
...
/* 8056A418  4B BD B2 E5 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8056A41C  38 00 00 00 */	li r0, 0
/* 8056A420  90 1C 0B C8 */	stw r0, 0xbc8(r28)
/* 8056A424  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056A428  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056A44C  4B DF 7D D1 */	bl _restgpr_26
