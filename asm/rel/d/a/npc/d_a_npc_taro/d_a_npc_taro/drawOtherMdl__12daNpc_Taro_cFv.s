...
/* 805685A8  4B DF 9C 29 */	bl _savegpr_26
...
/* 805685C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805685C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80568604:
/* 80568604  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80568608  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8056860C  80 84 00 04 */	lwz r4, 4(r4)
/* 80568610  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80568614  4B C3 C7 8D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80568618  80 7F 00 84 */	lwz r3, 0x84(r31)
/* 8056861C  80 83 00 0C */	lwz r4, 0xc(r3)
/* 80568620  3C 60 80 57 */	lis r3, jointNo@ha /* 0x80571814@ha */
/* 80568624  38 63 18 14 */	addi r3, r3, jointNo@l /* 0x80571814@l */
/* 80568628  7C 03 D0 2E */	lwzx r0, r3, r26
/* 8056862C  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80568630  7C 64 02 14 */	add r3, r4, r0
/* 80568634  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80568638  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8056863C  4B DD DE 75 */	bl PSMTXCopy
/* 80568640  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80568644  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80568648  38 81 00 08 */	addi r4, r1, 8
/* 8056864C  4B DD DE 65 */	bl PSMTXCopy
/* 80568650  38 61 00 08 */	addi r3, r1, 8
/* 80568654  7C 9B E8 2E */	lwzx r4, r27, r29
/* 80568658  38 84 00 24 */	addi r4, r4, 0x24
/* 8056865C  4B DD DE 55 */	bl PSMTXCopy
/* 80568660  7C 7B E8 2E */	lwzx r3, r27, r29
/* 80568664  4B AA 56 61 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80568668  7F C3 F3 78 */	mr r3, r30
/* 8056866C  80 9B 0D 94 */	lwz r4, 0xd94(r27)
/* 80568670  7C BB E8 2E */	lwzx r5, r27, r29
/* 80568674  4B AE D8 A9 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80568678:
...
/* 8056868C  4B DF 9B 91 */	bl _restgpr_26
