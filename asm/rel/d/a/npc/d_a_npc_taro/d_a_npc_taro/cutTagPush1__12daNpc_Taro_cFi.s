...
/* 8056D320  4B DF 4E B1 */	bl _savegpr_26
/* 8056D324  7C 7C 1B 78 */	mr r28, r3
/* 8056D328  7C 9A 23 78 */	mr r26, r4
/* 8056D32C  38 7C 0B A0 */	addi r3, r28, 0xba0
/* 8056D330  4B BD 83 D9 */	bl getActorP__18daNpcT_ActorMngr_cFv
/* 8056D334  7C 7F 1B 78 */	mr r31, r3
/* 8056D338  3B C0 00 00 */	li r30, 0
/* 8056D33C  3B A0 FF FF */	li r29, -1
/* 8056D340  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056D344  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8056D348  3B 63 4F F8 */	addi r27, r3, 0x4ff8
/* 8056D34C  7F 63 DB 78 */	mr r3, r27
/* 8056D350  7F 44 D3 78 */	mr r4, r26
/* 8056D354  3C A0 80 57 */	lis r5, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 8056D358  38 A5 19 08 */	addi r5, r5, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
/* 8056D35C  38 A5 02 9C */	addi r5, r5, 0x29c
/* 8056D360  38 C0 00 03 */	li r6, 3
/* 8056D364  4B AD AD 89 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056D37C  4B AD A9 D1 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8056D3E0  4B BD F1 21 */	bl daNpcT_getPlayerInfoFromPlayerList__FiiP4cXyzP5csXyz
/* 8056D3E4  2C 03 00 00 */	cmpwi r3, 0
/* 8056D3E8  41 82 01 18 */	beq lbl_8056D500
/* 8056D3EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056D3F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8056D42C  4B BD 84 6D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056D430  93 7C 0B 5C */	stw r27, 0xb5c(r28)
/* 8056D434  38 00 00 1F */	li r0, 0x1f
/* 8056D438  90 1C 0B 58 */	stw r0, 0xb58(r28)
/* 8056D43C  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056D440  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056D45C  4B BD 84 3D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056D460  93 7C 0B 80 */	stw r27, 0xb80(r28)
/* 8056D464  38 00 00 00 */	li r0, 0
/* 8056D468  90 1C 0B 7C */	stw r0, 0xb7c(r28)
/* 8056D46C  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056D470  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056D488  4B BD 82 75 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8056D48C  38 00 00 00 */	li r0, 0
/* 8056D490  90 1C 0B C8 */	stw r0, 0xbc8(r28)
/* 8056D494  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056D498  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056D4DC  4B BD E7 15 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 8056D4E0  7F 83 E3 78 */	mr r3, r28
/* 8056D4E4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056D4E8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8056D4EC  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8056D4F0  4B AA D2 21 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8056D4F4  7C 64 1B 78 */	mr r4, r3
/* 8056D4F8  7F 83 E3 78 */	mr r3, r28
/* 8056D4FC  4B BD D5 1D */	bl setAngle__8daNpcT_cFs
lbl_8056D500:
...
/* 8056D548  4B BD E7 31 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 8056D55C  4B CD CF CD */	bl getEventId__10dMsgFlow_cFPi
/* 8056D560  54 60 04 3E */	clrlwi r0, r3, 0x10
/* 8056D564  28 00 00 02 */	cmplwi r0, 2
/* 8056D568  40 82 00 20 */	bne lbl_8056D588
/* 8056D56C  3C 60 80 57 */	lis r3, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 8056D570  38 63 19 08 */	addi r3, r3, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
...
/* 8056D584  4B AB FF D1 */	bl dComIfGp_setNextStage__FPCcsScSc
lbl_8056D588:
/* 8056D588  38 00 00 01 */	li r0, 1
/* 8056D58C  98 1C 11 A0 */	stb r0, 0x11a0(r28)
/* 8056D590  38 7C 0B A0 */	addi r3, r28, 0xba0
/* 8056D594  4B BD 81 69 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 8056D5AC  4B DF 4C 71 */	bl _restgpr_26
