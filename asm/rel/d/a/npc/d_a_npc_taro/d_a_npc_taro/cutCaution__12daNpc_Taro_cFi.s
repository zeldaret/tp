...
/* 8056D0C8  4B DF 51 05 */	bl _savegpr_25
...
/* 8056D0E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8056D0E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8056D0E8  3B 43 4F F8 */	addi r26, r3, 0x4ff8
/* 8056D0EC  7F 43 D3 78 */	mr r3, r26
/* 8056D0F0  3C A0 80 57 */	lis r5, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 8056D0F4  38 A5 19 08 */	addi r5, r5, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
/* 8056D0F8  38 A5 02 9C */	addi r5, r5, 0x29c
/* 8056D0FC  38 C0 00 03 */	li r6, 3
/* 8056D100  4B AD AF ED */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056D118  3C A0 80 57 */	lis r5, d_a_npc_taro__stringBase0@ha /* 0x80571908@ha */
/* 8056D11C  38 A5 19 08 */	addi r5, r5, d_a_npc_taro__stringBase0@l /* 0x80571908@l */
/* 8056D120  38 A5 02 A0 */	addi r5, r5, 0x2a0
/* 8056D124  38 C0 00 03 */	li r6, 3
/* 8056D128  4B AD AF C5 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056D140  4B AD AC 0D */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8056D1D4  4B BD 85 29 */	bl remove__18daNpcT_ActorMngr_cFv
/* 8056D1D8  38 00 00 00 */	li r0, 0
/* 8056D1DC  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 8056D1E0  3C 60 80 57 */	lis r3, lit_4472@ha /* 0x805717AC@ha */
/* 8056D1E4  C0 03 17 AC */	lfs f0, lit_4472@l(r3)  /* 0x805717AC@l */
...
/* 8056D204  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha /* 0x80450FDC@ha */
/* 8056D208  90 03 0F DC */	stw r0, mFindCount__8daNpcT_c@l(r3)  /* 0x80450FDC@l */
/* 8056D20C  3C 60 80 56 */	lis r3, srchNpc__12daNpc_Taro_cFPvPv@ha /* 0x80566B0C@ha */
/* 8056D210  38 63 6B 0C */	addi r3, r3, srchNpc__12daNpc_Taro_cFPvPv@l /* 0x80566B0C@l */
/* 8056D214  7F A4 EB 78 */	mr r4, r29
/* 8056D218  4B AA C5 E1 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 8056D21C  3B 20 00 00 */	li r25, 0
/* 8056D220  3B 80 00 00 */	li r28, 0
/* 8056D224  3C 60 80 42 */	lis r3, mFindActorPtrs__8daNpcT_c@ha /* 0x80425708@ha */
/* 8056D228  3B 43 57 08 */	addi r26, r3, mFindActorPtrs__8daNpcT_c@l /* 0x80425708@l */
/* 8056D22C  3C 60 80 45 */	lis r3, mFindCount__8daNpcT_c@ha /* 0x80450FDC@ha */
/* 8056D230  3B 63 0F DC */	addi r27, r3, mFindCount__8daNpcT_c@l /* 0x80450FDC@l */
...
/* 8056D244  4B AA CA 39 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_8056D248:
...
/* 8056D27C  4B BD E9 75 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
lbl_8056D280:
...
/* 8056D2D8  4B BD E9 A1 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 8056D2FC  4B DF 4F 1D */	bl _restgpr_25
