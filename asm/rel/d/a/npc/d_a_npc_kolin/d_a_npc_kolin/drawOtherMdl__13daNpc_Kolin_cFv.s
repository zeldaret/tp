...
/* 80555CFC  4B E0 C4 E1 */	bl _savegpr_29
...
/* 80555D10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80555D14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80555D3C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80555D40  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80555D44  80 84 00 04 */	lwz r4, 4(r4)
/* 80555D48  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80555D4C  4B C4 F0 55 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80555D50  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 80555D54  80 83 00 0C */	lwz r4, 0xc(r3)
/* 80555D58  3C 60 80 56 */	lis r3, jointNo@ha /* 0x8055A704@ha */
/* 80555D5C  80 03 A7 04 */	lwz r0, jointNo@l(r3)  /* 0x8055A704@l */
/* 80555D60  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80555D64  7C 64 02 14 */	add r3, r4, r0
/* 80555D68  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80555D6C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80555D70  4B DF 07 41 */	bl PSMTXCopy
/* 80555D74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80555D78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80555D7C  38 81 00 08 */	addi r4, r1, 8
/* 80555D80  4B DF 07 31 */	bl PSMTXCopy
/* 80555D84  38 61 00 08 */	addi r3, r1, 8
/* 80555D88  80 9E 0E 44 */	lwz r4, 0xe44(r30)
/* 80555D8C  38 84 00 24 */	addi r4, r4, 0x24
/* 80555D90  4B DF 07 21 */	bl PSMTXCopy
/* 80555D94  80 7E 0E 44 */	lwz r3, 0xe44(r30)
/* 80555D98  4B AB 7F 2D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80555D9C  7F E3 FB 78 */	mr r3, r31
/* 80555DA0  80 9E 0D 94 */	lwz r4, 0xd94(r30)
/* 80555DA4  80 BE 0E 44 */	lwz r5, 0xe44(r30)
/* 80555DA8  4B B0 01 75 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80555DAC:
/* 80555DAC  39 61 00 50 */	addi r11, r1, 0x50
/* 80555DB0  4B E0 C4 79 */	bl _restgpr_29
