...
/* 80558EF0  4B BE C9 A9 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80558EF4  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80558EF8  38 00 00 01 */	li r0, 1
/* 80558EFC  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80558F00  3C 60 80 56 */	lis r3, lit_4742@ha /* 0x8055A6B8@ha */
/* 80558F04  C0 03 A6 B8 */	lfs f0, lit_4742@l(r3)  /* 0x8055A6B8@l */
...
/* 80558F18  4B BF 2C D9 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80558F6C  4B BF 2D 0D */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 80558F88  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80558F8C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80558F90  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80558F94  4B BE C7 4D */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80558F98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80558F9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80558FA0  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80558FA4  4B AE 94 C5 */	bl reset__14dEvt_control_cFv
...
/* 80558FC0  4B BE C7 3D */	bl remove__18daNpcT_ActorMngr_cFv
/* 80558FC4  38 00 00 00 */	li r0, 0
/* 80558FC8  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80558FCC  3C 60 80 56 */	lis r3, lit_4110@ha /* 0x8055A6A0@ha */
/* 80558FD0  C0 03 A6 A0 */	lfs f0, lit_4110@l(r3)  /* 0x8055A6A0@l */
...
/* 80559014  4B BE C6 E9 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80559018  38 00 00 00 */	li r0, 0
/* 8055901C  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80559020  3C 60 80 56 */	lis r3, lit_4110@ha /* 0x8055A6A0@ha */
/* 80559024  C0 03 A6 A0 */	lfs f0, lit_4110@l(r3)  /* 0x8055A6A0@l */
...
/* 80559050  4B BE C6 AD */	bl remove__18daNpcT_ActorMngr_cFv
/* 80559054  38 00 00 00 */	li r0, 0
/* 80559058  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 8055905C  3C 60 80 56 */	lis r3, lit_4110@ha /* 0x8055A6A0@ha */
/* 80559060  C0 03 A6 A0 */	lfs f0, lit_4110@l(r3)  /* 0x8055A6A0@l */
...
/* 80559094  4B BF 25 B5 */	bl step__8daNpcT_cFsiiii
lbl_80559098:
