...
/* 80556014  4B E0 C1 C1 */	bl _savegpr_27
/* 80556018  7C 7F 1B 78 */	mr r31, r3
/* 8055601C  7C 9B 23 78 */	mr r27, r4
/* 80556020  7C BC 2B 78 */	mr r28, r5
/* 80556024  7C DD 33 78 */	mr r29, r6
/* 80556028  3C A0 80 56 */	lis r5, m__19daNpc_Kolin_Param_c@ha /* 0x8055A5B4@ha */
/* 8055602C  3B C5 A5 B4 */	addi r30, r5, m__19daNpc_Kolin_Param_c@l /* 0x8055A5B4@l */
/* 80556030  4B AC 49 35 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80556048  4B AC 46 C9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8055605C  4B D1 A5 AD */	bl cLib_addCalcAngleS2__FPssss
...
/* 805560B8  4B AC 46 59 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805560BC  7C 64 1B 78 */	mr r4, r3
/* 805560C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805560C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805560C8  4B AB 63 15 */	bl mDoMtx_YrotS__FPA4_fs
/* 805560CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805560D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805560D4  38 81 00 4C */	addi r4, r1, 0x4c
/* 805560D8  38 A1 00 40 */	addi r5, r1, 0x40
/* 805560DC  4B DF 0C 91 */	bl PSMTXMultVec
/* 805560E0  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 805560E4  38 81 00 40 */	addi r4, r1, 0x40
/* 805560E8  7C 65 1B 78 */	mr r5, r3
/* 805560EC  4B DF 0F A5 */	bl PSVECAdd
...
/* 80556124  4B D1 A6 1D */	bl cLib_chaseF__FPfff
...
/* 80556148  4B D1 09 ED */	bl __mi__4cXyzCFRC3Vec
...
/* 80556168  4B DF 0F D1 */	bl PSVECSquareMag
...
/* 805561D8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805561DC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80556248  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8055624C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80556250:
...
/* 80556264  4B D1 08 D1 */	bl __mi__4cXyzCFRC3Vec
...
/* 80556284  4B DF 0E B5 */	bl PSVECSquareMag
...
/* 805562F4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805562F8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80556364  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80556368  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8055636C:
...
/* 8055638C  4B D1 A3 B5 */	bl cLib_chaseF__FPfff
...
/* 805563A8  4B E0 BE 79 */	bl _restgpr_27
