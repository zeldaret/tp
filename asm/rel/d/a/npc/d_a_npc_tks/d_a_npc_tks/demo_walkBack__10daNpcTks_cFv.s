...
/* 80B1A31C  4B 84 7E B1 */	bl _savegpr_25
/* 80B1A320  7C 7A 1B 78 */	mr r26, r3
/* 80B1A324  3C 80 80 B2 */	lis r4, m__16daNpcTks_Param_c@ha /* 0x80B1DD58@ha */
/* 80B1A328  3B A4 DD 58 */	addi r29, r4, m__16daNpcTks_Param_c@l /* 0x80B1DD58@l */
...
lbl_80B1A3B4:
/* 80B1A3B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B1A3B8  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B1A3BC  3B 9B 4E 00 */	addi r28, r27, 0x4e00
/* 80B1A3C0  7F 83 E3 78 */	mr r3, r28
/* 80B1A3C4  3C 80 80 B2 */	lis r4, d_a_npc_tks__stringBase0@ha /* 0x80B1E048@ha */
/* 80B1A3C8  38 84 E0 48 */	addi r4, r4, d_a_npc_tks__stringBase0@l /* 0x80B1E048@l */
/* 80B1A3CC  38 84 00 29 */	addi r4, r4, 0x29
/* 80B1A3D0  4B 84 E5 C5 */	bl strcmp
...
/* 80B1A414  3C 80 80 B2 */	lis r4, d_a_npc_tks__stringBase0@ha /* 0x80B1E048@ha */
/* 80B1A418  38 84 E0 48 */	addi r4, r4, d_a_npc_tks__stringBase0@l /* 0x80B1E048@l */
/* 80B1A41C  38 84 00 30 */	addi r4, r4, 0x30
/* 80B1A420  4B 84 E5 75 */	bl strcmp
...
/* 80B1A488  3C 80 80 B2 */	lis r4, l_myName@ha /* 0x80B1E20C@ha */
/* 80B1A48C  38 84 E2 0C */	addi r4, r4, l_myName@l /* 0x80B1E20C@l */
/* 80B1A490  80 84 00 00 */	lwz r4, 0(r4)
/* 80B1A494  38 A0 00 00 */	li r5, 0
/* 80B1A498  38 C0 00 00 */	li r6, 0
/* 80B1A49C  4B 52 D6 81 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
lbl_80B1A4B4:
/* 80B1A4B4  3C 60 80 B2 */	lis r3, l_arcName@ha /* 0x80B1E208@ha */
/* 80B1A4B8  80 03 E2 08 */	lwz r0, l_arcName@l(r3)  /* 0x80B1E208@l */
/* 80B1A4BC  90 1A 01 00 */	stw r0, 0x100(r26)
/* 80B1A4C0  38 7B 4F F8 */	addi r3, r27, 0x4ff8
/* 80B1A4C4  7F 44 D3 78 */	mr r4, r26
/* 80B1A4C8  3C A0 80 B2 */	lis r5, d_a_npc_tks__stringBase0@ha /* 0x80B1E048@ha */
/* 80B1A4CC  38 A5 E0 48 */	addi r5, r5, d_a_npc_tks__stringBase0@l /* 0x80B1E048@l */
/* 80B1A4D0  38 A5 00 77 */	addi r5, r5, 0x77
/* 80B1A4D4  38 C0 00 FF */	li r6, 0xff
/* 80B1A4D8  4B 52 D2 81 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 80B1A4FC  4B 50 11 81 */	bl fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs
lbl_80B1A500:
/* 80B1A500  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B1A504  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80B1A528  3C 80 80 B2 */	lis r4, l_myName@ha /* 0x80B1E20C@ha */
/* 80B1A52C  38 84 E2 0C */	addi r4, r4, l_myName@l /* 0x80B1E20C@l */
/* 80B1A530  80 84 00 00 */	lwz r4, 0(r4)
/* 80B1A534  38 A0 00 00 */	li r5, 0
/* 80B1A538  38 C0 00 00 */	li r6, 0
/* 80B1A53C  4B 52 D5 E1 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80B1A554  4B 52 DA 09 */	bl getMyNowCutName__16dEvent_manager_cFi
/* 80B1A558  7C 7F 1B 78 */	mr r31, r3
/* 80B1A55C  7F 83 E3 78 */	mr r3, r28
/* 80B1A560  7F 64 DB 78 */	mr r4, r27
/* 80B1A564  4B 52 D7 E9 */	bl getIsAddvance__16dEvent_manager_cFi
...
lbl_80B1A5A8:
/* 80B1A5A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B1A5AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80B1A5C8  4B 63 97 55 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
/* 80B1A5CC  38 00 00 00 */	li r0, 0
/* 80B1A5D0  90 1A 09 50 */	stw r0, 0x950(r26)
/* 80B1A5D4  7F 43 D3 78 */	mr r3, r26
/* 80B1A5D8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B1A5DC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B1A5E0  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80B1A5E4  4B 50 01 2D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80B1A5E8  7C 64 1B 78 */	mr r4, r3
/* 80B1A5EC  7F 43 D3 78 */	mr r3, r26
/* 80B1A5F0  4B 63 9C 61 */	bl setAngle__8daNpcF_cFs
...
/* 80B1A658  4B 63 90 C1 */	bl ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80B1A714  4B 52 DA 69 */	bl cutEnd__16dEvent_manager_cFi
...
/* 80B1A72C  4B 63 96 59 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80B1A740  4B 52 DA 3D */	bl cutEnd__16dEvent_manager_cFi
...
/* 80B1A760  4B 80 DC CD */	bl checkPass__12J3DFrameCtrlFf
...
/* 80B1A7EC  4B 75 5F 55 */	bl cLib_chaseF__FPfff
...
/* 80B1A820  4B 52 D9 5D */	bl cutEnd__16dEvent_manager_cFi
lbl_80B1A824:
...
/* 80B1A840  4B 52 D2 39 */	bl endCheck__16dEvent_manager_cFs
/* 80B1A844  2C 03 00 00 */	cmpwi r3, 0
/* 80B1A848  41 82 00 28 */	beq lbl_80B1A870
/* 80B1A84C  38 7E 4E C8 */	addi r3, r30, 0x4ec8
/* 80B1A850  4B 52 7C 19 */	bl reset__14dEvt_control_cFv
/* 80B1A854  38 00 FF FF */	li r0, -1
/* 80B1A858  B0 1A 09 D4 */	sth r0, 0x9d4(r26)
/* 80B1A85C  3C 60 80 43 */	lis r3, g_meter2_info@ha /* 0x80430188@ha */
/* 80B1A860  38 63 01 88 */	addi r3, r3, g_meter2_info@l /* 0x80430188@l */
/* 80B1A864  4B 70 21 A1 */	bl warpInProc__13dMeter2Info_cFv
/* 80B1A868  7F 43 D3 78 */	mr r3, r26
/* 80B1A86C  4B 4F F4 11 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_80B1A870:
/* 80B1A870  39 61 00 40 */	addi r11, r1, 0x40
/* 80B1A874  4B 84 79 A5 */	bl _restgpr_25
