...
/* 80B1CC40  3C 60 80 B2 */	lis r3, m__16daNpcTks_Param_c@ha /* 0x80B1DD58@ha */
/* 80B1CC44  3B E3 DD 58 */	addi r31, r3, m__16daNpcTks_Param_c@l /* 0x80B1DD58@l */
...
/* 80B1CC94  3C 60 80 B1 */	lis r3, ctrlJointCallBack__10daNpcTks_cFP8J3DJointi@ha /* 0x80B15670@ha */
/* 80B1CC98  38 83 56 70 */	addi r4, r3, ctrlJointCallBack__10daNpcTks_cFP8J3DJointi@l /* 0x80B15670@l */
...
/* 80B1CD40  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B1CD44  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B1CD48  4B 82 97 69 */	bl PSMTXCopy
/* 80B1CD4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B1CD50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B1CDC8  4B 74 9D 6D */	bl __mi__4cXyzCFRC3Vec
...
/* 80B1CDF8  4B 74 A8 7D */	bl cM_atan2s__Fff
...
/* 80B1CE24  4B 82 A3 15 */	bl PSVECSquareMag
...
/* 80B1CE94  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80B1CE98  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80B1CF04  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80B1CF08  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80B1CF0C  48 00 00 08 */	b lbl_80B1CF14
lbl_80B1CF10:
/* 80B1CF10  FC 40 08 90 */	fmr f2, f1
lbl_80B1CF14:
/* 80B1CF14  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80B1CF18  4B 74 A7 5D */	bl cM_atan2s__Fff
...
/* 80B1CF74  4B 75 22 69 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80B1CF78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B1CF7C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B1CF80  38 63 23 3C */	addi r3, r3, 0x233c
/* 80B1CF84  38 9E 12 10 */	addi r4, r30, 0x1210
/* 80B1CF88  4B 74 7C 21 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80B1CF8C:
...
/* 80B1CFA0  4B 75 22 3D */	bl SetC__8cM3dGCylFRC4cXyz
/* 80B1CFA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B1CFA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B1CFAC  38 63 23 3C */	addi r3, r3, 0x233c
/* 80B1CFB0  38 9E 0F F4 */	addi r4, r30, 0xff4
/* 80B1CFB4  4B 74 7B F5 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80B1CFB8:
