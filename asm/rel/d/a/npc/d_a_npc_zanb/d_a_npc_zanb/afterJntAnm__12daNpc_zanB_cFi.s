...
/* 80B69A5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B69A60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B69A64  4B 4A 29 D1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B69A68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B69A6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B69A70  A8 1F 0D 0E */	lha r0, 0xd0e(r31)
/* 80B69A74  7C 00 00 D0 */	neg r0, r0
/* 80B69A78  7C 04 07 34 */	extsh r4, r0
/* 80B69A7C  4B 4A 2A 51 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B69A80  48 00 00 34 */	b lbl_80B69AB4
lbl_80B69A84:
/* 80B69A84  2C 04 00 03 */	cmpwi r4, 3
/* 80B69A88  40 82 00 2C */	bne lbl_80B69AB4
/* 80B69A8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B69A90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B69A94  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80B69A98  7C 00 00 D0 */	neg r0, r0
/* 80B69A9C  7C 04 07 34 */	extsh r4, r0
/* 80B69AA0  4B 4A 29 95 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B69AA4  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80B69AA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B69AAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B69AB0  4B 4A 2A 1D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B69AB4:
