...
/* 80B6A5FC  4B 5D B2 9D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80B6A600  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 80B6A604  38 00 00 00 */	li r0, 0
/* 80B6A608  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80B6A60C  3C 60 80 B7 */	lis r3, lit_4529@ha /* 0x80B6BD7C@ha */
/* 80B6A610  C0 03 BD 7C */	lfs f0, lit_4529@l(r3)  /* 0x80B6BD7C@l */
...
/* 80B6A62C  4B 5D B2 6D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80B6A630  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80B6A634  38 00 00 01 */	li r0, 1
/* 80B6A638  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80B6A63C  3C 60 80 B7 */	lis r3, lit_4529@ha /* 0x80B6BD7C@ha */
/* 80B6A640  C0 03 BD 7C */	lfs f0, lit_4529@l(r3)  /* 0x80B6BD7C@l */
...
/* 80B6A660  4B 5D B2 39 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80B6A664  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 80B6A668  38 00 00 00 */	li r0, 0
/* 80B6A66C  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 80B6A670  3C 60 80 B7 */	lis r3, lit_4529@ha /* 0x80B6BD7C@ha */
/* 80B6A674  C0 03 BD 7C */	lfs f0, lit_4529@l(r3)  /* 0x80B6BD7C@l */
...
/* 80B6A690  4B 5D B2 09 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80B6A694  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 80B6A698  38 00 00 00 */	li r0, 0
/* 80B6A69C  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 80B6A6A0  3C 60 80 B7 */	lis r3, lit_4529@ha /* 0x80B6BD7C@ha */
/* 80B6A6A4  C0 03 BD 7C */	lfs f0, lit_4529@l(r3)  /* 0x80B6BD7C@l */
...
/* 80B6A6D0  4B 5D B0 2D */	bl remove__18daNpcT_ActorMngr_cFv
lbl_80B6A6D4:
/* 80B6A6D4  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 80B6A6D8  4B 5D B0 31 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80B6A700  4B 5D AF FD */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B6A704  38 00 00 00 */	li r0, 0
/* 80B6A708  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6A70C  3C 60 80 B7 */	lis r3, lit_4190@ha /* 0x80B6BD6C@ha */
/* 80B6A710  C0 03 BD 6C */	lfs f0, lit_4190@l(r3)  /* 0x80B6BD6C@l */
...
/* 80B6A730  4B 5D AF D9 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80B6A744  4B 5E 04 8D */	bl chkActorInSight__8daNpcT_cFP10fopAc_ac_cfs
...
/* 80B6A760  4B 5D AF 9D */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B6A764  38 00 00 00 */	li r0, 0
/* 80B6A768  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6A76C  3C 60 80 B7 */	lis r3, lit_4190@ha /* 0x80B6BD6C@ha */
/* 80B6A770  C0 03 BD 6C */	lfs f0, lit_4190@l(r3)  /* 0x80B6BD6C@l */
...
/* 80B6A78C  4B 5E 0B AD */	bl srchPlayerActor__8daNpcT_cFv
...
/* 80B6A7C4  4B 5D AF 39 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B6A7C8  38 00 00 00 */	li r0, 0
/* 80B6A7CC  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6A7D0  3C 60 80 B7 */	lis r3, lit_4190@ha /* 0x80B6BD6C@ha */
/* 80B6A7D4  C0 03 BD 6C */	lfs f0, lit_4190@l(r3)  /* 0x80B6BD6C@l */
...
/* 80B6A81C  4B 5E 0E 2D */	bl step__8daNpcT_cFsiiii
...
/* 80B6A838  4B 5E 01 E1 */	bl setAngle__8daNpcT_cFs
...
/* 80B6A854  4B 5E 0A E5 */	bl srchPlayerActor__8daNpcT_cFv
lbl_80B6A858:
