...
/* 80A70C8C  3C 60 80 A7 */	lis r3, __vt__12daNpc_midP_c@ha /* 0x80A73C78@ha */
/* 80A70C90  38 03 3C 78 */	addi r0, r3, __vt__12daNpc_midP_c@l /* 0x80A73C78@l */
...
/* 80A70CA8  4B 5A 06 69 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80A70CAC:
/* 80A70CAC  7F C3 F3 78 */	mr r3, r30
/* 80A70CB0  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 80A70CB4  54 00 10 3A */	slwi r0, r0, 2
/* 80A70CB8  3C 80 80 A7 */	lis r4, l_loadResPtrnList@ha /* 0x80A73AF8@ha */
/* 80A70CBC  38 84 3A F8 */	addi r4, r4, l_loadResPtrnList@l /* 0x80A73AF8@l */
/* 80A70CC0  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A70CC4  3C A0 80 A7 */	lis r5, l_resNameList@ha /* 0x80A73AEC@ha */
/* 80A70CC8  38 A5 3A EC */	addi r5, r5, l_resNameList@l /* 0x80A73AEC@l */
/* 80A70CCC  4B 6D 77 E1 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80A70CD0  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80A70CD4  41 82 00 84 */	beq lbl_80A70D58
/* 80A70CD8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80A70CDC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80A70CFC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80A70D00  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80A70D18  3C 60 80 A7 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80A73C6C@ha */
/* 80A70D1C  38 03 3C 6C */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80A73C6C@l */
/* 80A70D20  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_80A70D24:
/* 80A70D24  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80A70D28  41 82 00 24 */	beq lbl_80A70D4C
/* 80A70D2C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80A70D30  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80A70D34  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 80A70D38  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80A70D3C  41 82 00 10 */	beq lbl_80A70D4C
/* 80A70D40  3C 60 80 A7 */	lis r3, __vt__8cM3dGAab@ha /* 0x80A73C60@ha */
/* 80A70D44  38 03 3C 60 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80A73C60@l */
/* 80A70D48  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_80A70D4C:
/* 80A70D4C  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80A70D50  38 80 00 00 */	li r4, 0
/* 80A70D54  4B 61 33 91 */	bl __dt__12dCcD_GObjInfFv
lbl_80A70D58:
...
/* 80A70D70  4B 85 DF CD */	bl __dl__FPv
lbl_80A70D74:
