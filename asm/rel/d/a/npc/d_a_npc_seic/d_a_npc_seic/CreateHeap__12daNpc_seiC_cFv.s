...
/* 80AC7840  3C 60 80 AD */	lis r3, l_bmdData@ha /* 0x80AC9310@ha */
/* 80AC7844  38 83 93 10 */	addi r4, r3, l_bmdData@l /* 0x80AC9310@l */
/* 80AC7848  80 04 00 04 */	lwz r0, 4(r4)
/* 80AC784C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC7850  3C 60 80 AD */	lis r3, l_resNameList@ha /* 0x80AC9330@ha */
/* 80AC7854  38 63 93 30 */	addi r3, r3, l_resNameList@l /* 0x80AC9330@l */
/* 80AC7858  7C 63 00 2E */	lwzx r3, r3, r0
/* 80AC785C  80 84 00 00 */	lwz r4, 0(r4)
/* 80AC7860  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AC7864  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AC7868  3C A5 00 02 */	addis r5, r5, 2
/* 80AC786C  38 C0 00 80 */	li r6, 0x80
/* 80AC7870  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80AC7874  4B 57 4A 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80AC7878  7C 7E 1B 78 */	mr r30, r3
/* 80AC787C  38 60 00 58 */	li r3, 0x58
/* 80AC7880  4B 80 73 CD */	bl __nw__FUl
...
/* 80AC78BC  3D 20 80 AD */	lis r9, lit_4215@ha /* 0x80AC92BC@ha */
/* 80AC78C0  C0 29 92 BC */	lfs f1, lit_4215@l(r9)  /* 0x80AC92BC@l */
/* 80AC78C4  39 20 00 00 */	li r9, 0
/* 80AC78C8  39 40 FF FF */	li r10, -1
/* 80AC78CC  4B 54 8F 05 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80AC78F0  4B 54 9A 21 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
...
/* 80AC7924  4B 68 2A 65 */	bl setFaceMotionAnm__8daNpcT_cFib
...
/* 80AC7938  3C A0 80 AD */	lis r5, lit_4089@ha /* 0x80AC92B0@ha */
/* 80AC793C  C0 25 92 B0 */	lfs f1, lit_4089@l(r5)  /* 0x80AC92B0@l */
