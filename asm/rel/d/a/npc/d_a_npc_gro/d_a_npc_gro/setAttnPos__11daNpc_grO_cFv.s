...
/* 809DB874  4B 98 69 55 */	bl _savegpr_24
/* 809DB878  7C 7D 1B 78 */	mr r29, r3
/* 809DB87C  3C 60 80 9E */	lis r3, lit_1109@ha /* 0x809DF700@ha */
/* 809DB880  3B C3 F7 00 */	addi r30, r3, lit_1109@l /* 0x809DF700@l */
/* 809DB884  3C 60 80 9E */	lis r3, m__17daNpc_grO_Param_c@ha /* 0x809DEF7C@ha */
/* 809DB888  3B E3 EF 7C */	addi r31, r3, m__17daNpc_grO_Param_c@l /* 0x809DEF7C@l */
...
/* 809DB8B4  3C 80 80 9E */	lis r4, __dt__4cXyzFv@ha /* 0x809DE81C@ha */
/* 809DB8B8  38 84 E8 1C */	addi r4, r4, __dt__4cXyzFv@l /* 0x809DE81C@l */
...
/* 809DB8D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809DB8D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809DB8D8  A8 9D 09 90 */	lha r4, 0x990(r29)
/* 809DB8DC  4B 63 0B 01 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 809DB8F0  4B 89 41 4D */	bl cLib_addCalc2__FPffff
...
/* 809DB904  4B 89 41 39 */	bl cLib_addCalc2__FPffff
/* 809DB908  3B 00 00 00 */	li r24, 0
/* 809DB90C  3B 80 00 00 */	li r28, 0
/* 809DB910  3B 60 00 00 */	li r27, 0
/* 809DB914  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 809DB918  3B 23 9A 20 */	addi r25, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 809DB91C  C3 DF 00 90 */	lfs f30, 0x90(r31)
/* 809DB920  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809DB924  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_809DB928:
...
/* 809DB958  4B 96 B4 15 */	bl PSMTXMultVec
...
/* 809DB9B0  4B 89 4D 21 */	bl cLib_chaseS__FPsss
...
/* 809DBA18  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809DBA1C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809DBA20  4B 96 AA 91 */	bl PSMTXCopy
/* 809DBA24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809DBA28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 809DBAA0  4B 88 B0 95 */	bl __mi__4cXyzCFRC3Vec
...
/* 809DBAD8  4B 88 BB 9D */	bl cM_atan2s__Fff
...
/* 809DBB04  4B 96 B6 35 */	bl PSVECSquareMag
...
/* 809DBB74  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809DBB78  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 809DBBE4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809DBBE8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 809DBBEC  48 00 00 08 */	b lbl_809DBBF4
lbl_809DBBF0:
/* 809DBBF0  FC 40 08 90 */	fmr f2, f1
lbl_809DBBF4:
/* 809DBBF4  C0 21 00 40 */	lfs f1, 0x40(r1)
/* 809DBBF8  4B 88 BA 7D */	bl cM_atan2s__Fff
...
/* 809DBC2C  4B 63 11 39 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 809DBC30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809DBC34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809DBC38  A8 9D 08 F0 */	lha r4, 0x8f0(r29)
/* 809DBC3C  A8 BD 08 F2 */	lha r5, 0x8f2(r29)
/* 809DBC40  A8 DD 08 F4 */	lha r6, 0x8f4(r29)
/* 809DBC44  4B 63 06 5D */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 809DBC48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809DBC4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809DBC50  38 81 00 3C */	addi r4, r1, 0x3c
/* 809DBC54  38 A1 00 48 */	addi r5, r1, 0x48
/* 809DBC58  4B 96 B1 15 */	bl PSMTXMultVec
...
/* 809DBCD4  4B 89 35 09 */	bl SetC__8cM3dGCylFRC4cXyz
...
/* 809DBCEC  4B 89 35 0D */	bl SetH__8cM3dGCylFf
...
/* 809DBD04  4B 89 34 FD */	bl SetR__8cM3dGCylFf
/* 809DBD08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DBD0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DBD10  38 63 23 3C */	addi r3, r3, 0x233c
/* 809DBD14  38 9D 0C 98 */	addi r4, r29, 0xc98
/* 809DBD18  4B 88 8E 91 */	bl Set__4cCcSFP8cCcD_Obj
lbl_809DBD1C:
...
/* 809DBD44  4B 98 64 D1 */	bl _restgpr_24
