...
/* 809DE31C  4B 98 3E B9 */	bl _savegpr_27
/* 809DE320  7C 7D 1B 78 */	mr r29, r3
/* 809DE324  7C 9B 23 78 */	mr r27, r4
/* 809DE328  3B E0 00 00 */	li r31, 0
/* 809DE32C  3B C0 FF FF */	li r30, -1
/* 809DE330  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DE334  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DE338  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 809DE33C  7F 83 E3 78 */	mr r3, r28
/* 809DE340  3C A0 80 9E */	lis r5, d_a_npc_gro__stringBase0@ha /* 0x809DF2B8@ha */
/* 809DE344  38 A5 F2 B8 */	addi r5, r5, d_a_npc_gro__stringBase0@l /* 0x809DF2B8@l */
/* 809DE348  38 A5 00 3C */	addi r5, r5, 0x3c
/* 809DE34C  38 C0 00 03 */	li r6, 3
/* 809DE350  4B 66 9D 9D */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809DE368  4B 66 99 E5 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 809DE390  4B 77 23 5D */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 809DE3D8  4B 76 E1 29 */	bl daNpcT_getPlayerInfoFromPlayerList__FiiP4cXyzP5csXyz
/* 809DE3DC  2C 03 00 00 */	cmpwi r3, 0
/* 809DE3E0  41 82 00 B0 */	beq lbl_809DE490
/* 809DE3E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DE3E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809DE418  3C A0 80 9E */	lis r5, lit_4553@ha /* 0x809DF00C@ha */
/* 809DE41C  C0 25 F0 0C */	lfs f1, lit_4553@l(r5)  /* 0x809DF00C@l */
...
/* 809DE438  3C A0 80 9E */	lis r5, lit_4553@ha /* 0x809DF00C@ha */
/* 809DE43C  C0 25 F0 0C */	lfs f1, lit_4553@l(r5)  /* 0x809DF00C@l */
...
/* 809DE46C  4B 77 58 B1 */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
/* 809DE470  7F A3 EB 78 */	mr r3, r29
/* 809DE474  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DE478  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DE47C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 809DE480  4B 63 C2 91 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 809DE484  7C 64 1B 78 */	mr r4, r3
/* 809DE488  7F A3 EB 78 */	mr r3, r29
/* 809DE48C  4B 77 5D C5 */	bl setAngle__8daNpcF_cFs
lbl_809DE490:
...
/* 809DE4C0  4B 77 58 C5 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809DE4D8  4B 98 3D 49 */	bl _restgpr_27
