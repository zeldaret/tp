...
/* 809DB798  3C 80 80 9E */	lis r4, l_btkGetParamList@ha
/* 809DB79C  84 A4 F4 24 */	lwzu r5, l_btkGetParamList@l(r4)
...
/* 809DB7B0  3C 80 80 9E */	lis r4, l_resNames@ha
/* 809DB7B4  38 84 F4 A4 */	addi r4, r4, l_resNames@l
/* 809DB7B8  7C 84 00 2E */	lwzx r4, r4, r0
/* 809DB7BC  4B 77 73 E8 */	b getTexSRTKeyAnmP__8daNpcF_cFPci
...
/* 809DB7D8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 809DB7DC  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
/* 809DB7E0  7C 04 04 2E */	lfsx f0, r4, r0
/* 809DB7E4  3C 60 80 9E */	lis r3, lit_4812@ha
/* 809DB7E8  C0 43 F0 1C */	lfs f2, lit_4812@l(r3)
/* 809DB7EC  3C 60 80 9E */	lis r3, lit_4813@ha
/* 809DB7F0  C0 23 F0 20 */	lfs f1, lit_4813@l(r3)
