...
/* 809DDD08  4B 98 44 CD */	bl _savegpr_27
/* 809DDD0C  7C 7C 1B 78 */	mr r28, r3
/* 809DDD10  3C 60 80 9E */	lis r3, cNullVec__6Z2Calc@ha /* 0x809DF2F8@ha */
/* 809DDD14  3B E3 F2 F8 */	addi r31, r3, cNullVec__6Z2Calc@l /* 0x809DF2F8@l */
...
/* 809DDD54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DDD58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DDD5C  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 809DDD60  3C 80 80 9E */	lis r4, d_a_npc_gro__stringBase0@ha /* 0x809DF2B8@ha */
/* 809DDD64  38 84 F2 B8 */	addi r4, r4, d_a_npc_gro__stringBase0@l /* 0x809DF2B8@l */
/* 809DDD68  38 84 00 25 */	addi r4, r4, 0x25
/* 809DDD6C  4B 98 AC 29 */	bl strcmp
...
/* 809DDD88  4B 77 79 AD */	bl daNpcF_offTmpBit__FUl
lbl_809DDD8C:
...
/* 809DDDA0  4B 77 5F 7D */	bl initTalk__8daNpcF_cFiPP10fopAc_ac_c
...
/* 809DDE04  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DDE08  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DDE0C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 809DDE10  4B 77 28 AD */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 809DDE28  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DDE2C  3B 64 61 C0 */	addi r27, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DDE30  80 9B 5D AC */	lwz r4, 0x5dac(r27)
/* 809DDE34  4B 77 28 89 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
/* 809DDE38  7F 83 E3 78 */	mr r3, r28
/* 809DDE3C  80 9B 5D AC */	lwz r4, 0x5dac(r27)
/* 809DDE40  4B 63 C8 D1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809DDE64  4B 63 C8 AD */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809DDE7C  4B 77 62 29 */	bl step__8daNpcF_cFsiii
...
/* 809DDE90  3C A0 80 9E */	lis r5, lit_4812@ha /* 0x809DF01C@ha */
/* 809DDE94  C0 25 F0 1C */	lfs f1, lit_4812@l(r5)  /* 0x809DF01C@l */
...
/* 809DDEB0  3C A0 80 9E */	lis r5, lit_4812@ha /* 0x809DF01C@ha */
/* 809DDEB4  C0 25 F0 1C */	lfs f1, lit_4812@l(r5)  /* 0x809DF01C@l */
...
/* 809DDEEC  4B 77 5E 99 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809DDF0C  4B 86 C6 1D */	bl getEventId__10dMsgFlow_cFPi
...
/* 809DDF38  4B 63 DC B1 */	bl fopAcM_createItemForPresentDemo__FPC4cXyziUciiPC5csXyzPC4cXyz
...
/* 809DDF50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DDF54  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DDF58  38 7D 4F F8 */	addi r3, r29, 0x4ff8
/* 809DDF5C  7F 84 E3 78 */	mr r4, r28
/* 809DDF60  3C A0 80 9E */	lis r5, d_a_npc_gro__stringBase0@ha /* 0x809DF2B8@ha */
/* 809DDF64  38 A5 F2 B8 */	addi r5, r5, d_a_npc_gro__stringBase0@l /* 0x809DF2B8@l */
/* 809DDF68  38 A5 00 2C */	addi r5, r5, 0x2c
/* 809DDF6C  38 C0 00 FF */	li r6, 0xff
/* 809DDF70  4B 66 97 E9 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
/* 809DDF74  7C 7B 1B 78 */	mr r27, r3
/* 809DDF78  38 7D 4E C8 */	addi r3, r29, 0x4ec8
/* 809DDF7C  7F 84 E3 78 */	mr r4, r28
/* 809DDF80  4B 66 45 99 */	bl reset__14dEvt_control_cFPv
...
/* 809DDF98  4B 63 D6 4D */	bl fopAcM_orderChangeEventId__FP10fopAc_ac_csUsUs
...
/* 809DDFBC  4B 77 76 F9 */	bl daNpcF_chkTmpBit__FUl
/* 809DDFC0  2C 03 00 00 */	cmpwi r3, 0
/* 809DDFC4  41 82 00 6C */	beq lbl_809DE030
/* 809DDFC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DDFCC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DDFD0  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 809DDFD4  7F 84 E3 78 */	mr r4, r28
/* 809DDFD8  4B 66 45 41 */	bl reset__14dEvt_control_cFPv
...
/* 809DE02C  4B 77 59 29 */	bl changeEvent__8daNpcF_cFPcPcUsUs
lbl_809DE030:
...
/* 809DE050  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DE054  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809DE058  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 809DE05C  4B 66 44 0D */	bl reset__14dEvt_control_cFv
lbl_809DE060:
...
/* 809DE070  4B 98 41 B1 */	bl _restgpr_27
