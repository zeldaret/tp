...
/* 809DB604  4B 98 6B D9 */	bl _savegpr_29
/* 809DB608  7C 7E 1B 78 */	mr r30, r3
/* 809DB60C  3C 80 80 9E */	lis r4, cNullVec__6Z2Calc@ha /* 0x809DF2F8@ha */
/* 809DB610  3B E4 F2 F8 */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x809DF2F8@l */
...
/* 809DB648  4B 65 44 0D */	bl dComIfGs_wolfeye_effect_check__Fv
...
lbl_809DB668:
/* 809DB668  3C 60 80 9E */	lis r3, m__17daNpc_grO_Param_c@ha /* 0x809DEF7C@ha */
/* 809DB66C  38 63 EF 7C */	addi r3, r3, m__17daNpc_grO_Param_c@l /* 0x809DEF7C@l */
/* 809DB670  88 03 00 6A */	lbz r0, 0x6a(r3)
/* 809DB674  28 00 00 00 */	cmplwi r0, 0
/* 809DB678  40 82 00 AC */	bne lbl_809DB724
/* 809DB67C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809DB680  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809DB720  4B 77 81 5D */	bl orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_809DB724:
/* 809DB724  88 1E 09 EE */	lbz r0, 0x9ee(r30)
/* 809DB728  28 00 00 00 */	cmplwi r0, 0
/* 809DB72C  41 82 00 1C */	beq lbl_809DB748
/* 809DB730  3C 60 80 9E */	lis r3, lit_4553@ha /* 0x809DF00C@ha */
/* 809DB734  C0 03 F0 0C */	lfs f0, lit_4553@l(r3)  /* 0x809DF00C@l */
...
/* 809DB760  4B 98 6A C9 */	bl _restgpr_29
