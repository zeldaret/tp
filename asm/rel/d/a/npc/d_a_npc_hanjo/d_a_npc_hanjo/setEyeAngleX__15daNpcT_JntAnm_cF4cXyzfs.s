...
/* 809FFBBC  4B 96 26 20 */	b _savegpr_29
/* 809FFBC0  7C 7F 1B 78 */	mr r31, r3
/* 809FFBC4  7C 80 23 78 */	mr r0, r4
/* 809FFBC8  FF E0 08 90 */	fmr f31, f1
/* 809FFBCC  7C BD 2B 78 */	mr r29, r5
/* 809FFBD0  3C 60 80 A0 */	lis r3, m__19daNpc_Hanjo_Param_c@ha
/* 809FFBD4  3B C3 06 00 */	addi r30, r3, m__19daNpc_Hanjo_Param_c@l
...
/* 809FFBF0  4B 86 6F 44 */	b __mi__4cXyzCFRC3Vec
...
/* 809FFC20  4B 94 75 18 */	b PSVECSquareMag
...
/* 809FFC90  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809FFC94  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 809FFD00  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809FFD04  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 809FFD08  48 00 00 08 */	b lbl_809FFD10
lbl_809FFD0C:
/* 809FFD0C  FC 40 08 90 */	fmr f2, f1
lbl_809FFD10:
/* 809FFD10  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 809FFD14  4B 86 79 60 */	b cM_atan2s__Fff
...
/* 809FFD98  4B 96 24 90 */	b _restgpr_29
