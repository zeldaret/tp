...
/* 809FB2DC  4B 96 6E F5 */	bl _savegpr_26
/* 809FB2E0  7C 7F 1B 78 */	mr r31, r3
/* 809FB2E4  3C 60 80 A0 */	lis r3, m__19daNpc_Hanjo_Param_c@ha /* 0x80A00600@ha */
/* 809FB2E8  3B C3 06 00 */	addi r30, r3, m__19daNpc_Hanjo_Param_c@l /* 0x80A00600@l */
...
/* 809FB32C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 809FB330  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 809FB334  80 84 00 04 */	lwz r4, 4(r4)
/* 809FB338  38 BF 01 0C */	addi r5, r31, 0x10c
/* 809FB33C  4B 7A 9A 65 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 809FB354  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809FB358  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809FB35C  4B 94 B1 55 */	bl PSMTXCopy
/* 809FB360  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809FB364  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809FB368  38 81 00 08 */	addi r4, r1, 8
/* 809FB36C  4B 94 B1 45 */	bl PSMTXCopy
...
/* 809FB3A8  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 809FB3AC  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 809FB3C4  4B 94 B0 ED */	bl PSMTXCopy
/* 809FB3C8  48 00 00 28 */	b lbl_809FB3F0
lbl_809FB3CC:
/* 809FB3CC  38 7C 11 20 */	addi r3, r28, 0x1120
/* 809FB3D0  4B 61 19 95 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 809FB3D4  38 7C 11 38 */	addi r3, r28, 0x1138
/* 809FB3D8  4B 61 1B 6D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 809FB3DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809FB3E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809FB3E4  80 9C 11 10 */	lwz r4, 0x1110(r28)
/* 809FB3E8  38 84 00 24 */	addi r4, r4, 0x24
/* 809FB3EC  4B 94 B0 C5 */	bl PSMTXCopy
lbl_809FB3F0:
/* 809FB3F0  80 7C 11 10 */	lwz r3, 0x1110(r28)
/* 809FB3F4  4B 61 28 D1 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_809FB3F8:
...
/* 809FB42C  3C 80 80 A0 */	lis r4, l_motionAnmData@ha /* 0x80A00B34@ha */
/* 809FB430  38 A4 0B 34 */	addi r5, r4, l_motionAnmData@l /* 0x80A00B34@l */
/* 809FB434  80 05 01 90 */	lwz r0, 0x190(r5)
/* 809FB438  54 00 10 3A */	slwi r0, r0, 2
/* 809FB43C  3C 80 80 A0 */	lis r4, l_resNameList@ha /* 0x80A009D8@ha */
/* 809FB440  38 84 09 D8 */	addi r4, r4, l_resNameList@l /* 0x80A009D8@l */
/* 809FB444  7C 84 00 2E */	lwzx r4, r4, r0
/* 809FB448  80 A5 01 88 */	lwz r5, 0x188(r5)
/* 809FB44C  4B 74 CC 49 */	bl getTrnsfrmKeyAnmP__8daNpcT_cFPCci
...
/* 809FB460  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 809FB464  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 809FB468  80 9F 0E 48 */	lwz r4, 0xe48(r31)
/* 809FB46C  80 84 00 04 */	lwz r4, 4(r4)
/* 809FB470  38 BF 01 0C */	addi r5, r31, 0x10c
/* 809FB474  4B 7A 99 2D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 809FB478  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 809FB47C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 809FB480  38 63 03 60 */	addi r3, r3, 0x360
/* 809FB484  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809FB488  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809FB48C  4B 94 B0 25 */	bl PSMTXCopy
/* 809FB490  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809FB494  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809FB498  38 80 17 2F */	li r4, 0x172f
/* 809FB49C  38 A0 10 80 */	li r5, 0x1080
/* 809FB4A0  38 C0 23 83 */	li r6, 0x2383
/* 809FB4A4  4B 61 0C C1 */	bl mDoMtx_XYZrotM__FPA4_fsss
/* 809FB4A8  C0 3E 01 7C */	lfs f1, 0x17c(r30)
/* 809FB4AC  C0 5E 01 80 */	lfs f2, 0x180(r30)
/* 809FB4B0  C0 7E 01 84 */	lfs f3, 0x184(r30)
/* 809FB4B4  4B 61 18 E9 */	bl transM__14mDoMtx_stack_cFfff
/* 809FB4B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809FB4BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809FB4C0  38 81 00 08 */	addi r4, r1, 8
/* 809FB4C4  4B 94 AF ED */	bl PSMTXCopy
/* 809FB4C8  38 61 00 08 */	addi r3, r1, 8
/* 809FB4CC  80 9F 0E 48 */	lwz r4, 0xe48(r31)
/* 809FB4D0  38 84 00 24 */	addi r4, r4, 0x24
/* 809FB4D4  4B 94 AF DD */	bl PSMTXCopy
/* 809FB4D8  80 7F 0E 48 */	lwz r3, 0xe48(r31)
/* 809FB4DC  4B 61 27 E9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_809FB4E0:
...
/* 809FB4F8  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 809FB4FC  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 809FB510  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 809FB514  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 809FB518  80 84 00 04 */	lwz r4, 4(r4)
/* 809FB51C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 809FB520  4B 7A 98 81 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 809FB524  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 809FB528  80 63 00 0C */	lwz r3, 0xc(r3)
/* 809FB52C  38 63 00 C0 */	addi r3, r3, 0xc0
/* 809FB530  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809FB534  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809FB538  4B 94 AF 79 */	bl PSMTXCopy
/* 809FB53C  C0 3F 17 18 */	lfs f1, 0x1718(r31)
/* 809FB540  FC 40 08 90 */	fmr f2, f1
/* 809FB544  FC 60 08 90 */	fmr f3, f1
/* 809FB548  4B 61 18 F1 */	bl scaleM__14mDoMtx_stack_cFfff
/* 809FB54C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809FB550  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809FB554  38 81 00 08 */	addi r4, r1, 8
/* 809FB558  4B 94 AF 59 */	bl PSMTXCopy
/* 809FB55C  38 61 00 08 */	addi r3, r1, 8
/* 809FB560  80 9F 0E 44 */	lwz r4, 0xe44(r31)
/* 809FB564  38 84 00 24 */	addi r4, r4, 0x24
/* 809FB568  4B 94 AF 49 */	bl PSMTXCopy
/* 809FB56C  80 7F 0E 44 */	lwz r3, 0xe44(r31)
/* 809FB570  4B 61 27 55 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 809FB574  38 7F 17 18 */	addi r3, r31, 0x1718
/* 809FB578  C0 3E 01 18 */	lfs f1, 0x118(r30)
/* 809FB57C  C0 5E 01 88 */	lfs f2, 0x188(r30)
/* 809FB580  4B 87 51 C1 */	bl cLib_chaseF__FPfff
lbl_809FB584:
/* 809FB584  39 61 00 50 */	addi r11, r1, 0x50
/* 809FB588  4B 96 6C 95 */	bl _restgpr_26
