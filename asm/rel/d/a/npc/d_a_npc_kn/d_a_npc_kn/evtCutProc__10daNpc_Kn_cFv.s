...
/* 80A2C328  4B 93 5E B5 */	bl _savegpr_29
...
/* 80A2C350  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A2C354  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A2C358  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 80A2C35C  7F E3 FB 78 */	mr r3, r31
/* 80A2C360  3C 80 80 A4 */	lis r4, d_a_npc_kn__stringBase0@ha /* 0x80A40AF8@ha */
/* 80A2C364  38 84 0A F8 */	addi r4, r4, d_a_npc_kn__stringBase0@l /* 0x80A40AF8@l */
/* 80A2C368  38 84 02 32 */	addi r4, r4, 0x232
/* 80A2C36C  7F A5 EB 78 */	mr r5, r29
/* 80A2C370  38 C0 FF FF */	li r6, -1
/* 80A2C374  4B 61 B7 A9 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80A2C38C  3C A0 80 A4 */	lis r5, mCutNameList__10daNpc_Kn_c@ha /* 0x80A41588@ha */
/* 80A2C390  38 A5 15 88 */	addi r5, r5, mCutNameList__10daNpc_Kn_c@l /* 0x80A41588@l */
/* 80A2C394  38 C0 00 15 */	li r6, 0x15
/* 80A2C398  38 E0 00 00 */	li r7, 0
/* 80A2C39C  39 00 00 00 */	li r8, 0
/* 80A2C3A0  4B 61 BA 71 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 80A2C3B4  3C A0 80 A4 */	lis r5, mCutList__10daNpc_Kn_c@ha /* 0x80A416CC@ha */
/* 80A2C3B8  38 05 16 CC */	addi r0, r5, mCutList__10daNpc_Kn_c@l /* 0x80A416CC@l */
/* 80A2C3BC  7D 80 32 14 */	add r12, r0, r6
/* 80A2C3C0  4B 93 5C C5 */	bl __ptmf_scall
...
/* 80A2C3D8  4B 61 BD A5 */	bl cutEnd__16dEvent_manager_cFi
lbl_80A2C3DC:
...
/* 80A2C3E8  4B 93 5E 41 */	bl _restgpr_29
