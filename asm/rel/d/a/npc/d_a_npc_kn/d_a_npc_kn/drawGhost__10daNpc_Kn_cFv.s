...
/* 80A2CFBC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80A2CFC0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80A2CFC4  38 80 00 07 */	li r4, 7
/* 80A2CFC8  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80A2CFCC  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80A2CFD0  4B 77 67 F5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80A2CFD4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80A2CFD8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80A2CFDC  80 9F 00 04 */	lwz r4, 4(r31)
/* 80A2CFE0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80A2CFE4  4B 77 7D BD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80A2CFE8  4B 77 F5 95 */	bl dKy_darkworld_check__Fv
/* 80A2CFEC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80A2CFF0  41 82 00 4C */	beq lbl_80A2D03C
/* 80A2CFF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A2CFF8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A2CFFC  80 04 5F 88 */	lwz r0, 0x5f88(r4)
/* 80A2D000  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80A2D004  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80A2D01C  4B 5E 17 A5 */	bl entryDL__21mDoExt_invisibleModelFP4cXyz
/* 80A2D020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A2D024  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A2D044  4B 5E 17 7D */	bl entryDL__21mDoExt_invisibleModelFP4cXyz
lbl_80A2D048:
