...
/* 80A3C7A8  4B 92 5A 34 */	b _savegpr_29
/* 80A3C7AC  7C 7F 1B 78 */	mr r31, r3
/* 80A3C7B0  7C 80 23 78 */	mr r0, r4
/* 80A3C7B4  FF E0 08 90 */	fmr f31, f1
/* 80A3C7B8  7C BD 2B 78 */	mr r29, r5
/* 80A3C7BC  3C 60 80 A4 */	lis r3, mCcDObjData__10daNpc_Kn_c@ha
/* 80A3C7C0  3B C3 08 C8 */	addi r30, r3, mCcDObjData__10daNpc_Kn_c@l
...
/* 80A3C7DC  4B 82 A3 58 */	b __mi__4cXyzCFRC3Vec
...
/* 80A3C80C  4B 90 A9 2C */	b PSVECSquareMag
...
/* 80A3C87C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80A3C880  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80A3C8EC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80A3C8F0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80A3C8F4  48 00 00 08 */	b lbl_80A3C8FC
lbl_80A3C8F8:
/* 80A3C8F8  FC 40 08 90 */	fmr f2, f1
lbl_80A3C8FC:
/* 80A3C8FC  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80A3C900  4B 82 AD 74 */	b cM_atan2s__Fff
...
/* 80A3C984  4B 92 58 A4 */	b _restgpr_29
