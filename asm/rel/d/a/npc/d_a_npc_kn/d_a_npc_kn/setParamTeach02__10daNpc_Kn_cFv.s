...
/* 80A3EB94  4B 92 36 45 */	bl _savegpr_28
/* 80A3EB98  7C 7E 1B 78 */	mr r30, r3
/* 80A3EB9C  3C 60 80 A4 */	lis r3, mCcDObjData__10daNpc_Kn_c@ha /* 0x80A408C8@ha */
/* 80A3EBA0  3B E3 08 C8 */	addi r31, r3, mCcDObjData__10daNpc_Kn_c@l /* 0x80A408C8@l */
...
/* 80A3EBE8  4B 70 DE 31 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80A3EC08  4B 70 DE 11 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80A3EC20  4B 70 DD F9 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80A3EC40  4B 70 DD D9 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80A3EC5C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A3EC60  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A3EC64  4B 90 78 4D */	bl PSMTXCopy
/* 80A3EC68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A3EC6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A3EC8C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A3EC90  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A3EC94  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80A3EC98  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 80A3EC9C  38 A1 00 24 */	addi r5, r1, 0x24
/* 80A3ECA0  4B 82 7E 95 */	bl __mi__4cXyzCFRC3Vec
...
/* 80A3ECC0  4B 90 84 79 */	bl PSVECSquareMag
...
/* 80A3ED30  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A3ED34  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80A3EDA0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80A3EDA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80A3EDA8:
...
/* 80A3EDD0  4B 70 DC 49 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80A3EDF0  4B 70 DC 29 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80A3EE04  4B 63 71 3D */	bl SetWallR__12dBgS_AcchCirFf
...
/* 80A3EE24  4B 92 34 01 */	bl _restgpr_28
