...
/* 80A3F9AC  4B 92 28 25 */	bl _savegpr_26
/* 80A3F9B0  7C 7C 1B 78 */	mr r28, r3
/* 80A3F9B4  7C 9A 23 78 */	mr r26, r4
/* 80A3F9B8  3C 60 80 A4 */	lis r3, mCcDObjData__10daNpc_Kn_c@ha /* 0x80A408C8@ha */
/* 80A3F9BC  3B E3 08 C8 */	addi r31, r3, mCcDObjData__10daNpc_Kn_c@l /* 0x80A408C8@l */
/* 80A3F9C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A3F9C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A3F9D8  3C A0 80 A4 */	lis r5, d_a_npc_kn__stringBase0@ha /* 0x80A40AF8@ha */
/* 80A3F9DC  38 A5 0A F8 */	addi r5, r5, d_a_npc_kn__stringBase0@l /* 0x80A40AF8@l */
/* 80A3F9E0  38 A5 02 35 */	addi r5, r5, 0x235
/* 80A3F9E4  38 C0 00 03 */	li r6, 3
/* 80A3F9E8  4B 60 87 05 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80A3FA00  4B 60 83 4D */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80A3FA14  3C 60 80 A4 */	lis r3, lit_14386@ha /* 0x80A43000@ha */
/* 80A3FA18  38 63 30 00 */	addi r3, r3, lit_14386@l /* 0x80A43000@l */
...
/* 80A3FA4C  4B 70 5E 4D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A3FA78  4B 70 5E 21 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A3FAA8  4B 70 5D F1 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A3FAD4  4B 70 5D C5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A3FB00  4B 70 5B FD */	bl remove__18daNpcT_ActorMngr_cFv
...
lbl_80A3FB44:
/* 80A3FB44  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80A3FB48  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80A3FB64  4B 86 F4 AD */	bl bgmStart__8Z2SeqMgrFUlUll
...
/* 80A3FBB0  4B 5C D1 B5 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80A3FBB4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A3FBB8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A3FBBC  A8 9C 04 B6 */	lha r4, 0x4b6(r28)
/* 80A3FBC0  4B 5C C8 75 */	bl mDoMtx_YrotM__FPA4_fs
/* 80A3FBC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A3FBC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A3FBCC  38 81 00 38 */	addi r4, r1, 0x38
/* 80A3FBD0  7C 85 23 78 */	mr r5, r4
/* 80A3FBD4  4B 90 71 99 */	bl PSMTXMultVec
...
/* 80A3FC00  4B 5D E0 BD */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80A3FC04  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80A3FC08  41 82 00 18 */	beq lbl_80A3FC20
/* 80A3FC0C  C0 3F 02 2C */	lfs f1, 0x22c(r31)
/* 80A3FC10  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80A3FC14  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
/* 80A3FC18  EC 01 00 2A */	fadds f0, f1, f0
/* 80A3FC1C  D0 01 00 3C */	stfs f0, 0x3c(r1)
lbl_80A3FC20:
/* 80A3FC20  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A3FC24  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A3FCA4  4B 70 5B F5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A3FCC4  4B 70 5B D5 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A3FCEC  4B 70 5A 11 */	bl remove__18daNpcT_ActorMngr_cFv
...
/* 80A3FD18  3C 60 80 A4 */	lis r3, lit_14387@ha /* 0x80A42F34@ha */
/* 80A3FD1C  38 63 2F 34 */	addi r3, r3, lit_14387@l /* 0x80A42F34@l */
...
/* 80A3FD98  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A3FD9C  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A3FDA0  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 80A3FDA4  4B 5D A9 6D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A3FDC0  4B 5D A9 51 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A3FE00  4B 70 5A 99 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A3FE2C  4B 70 5A 6D */	bl initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A3FE90  4B 5C CE D5 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80A3FE94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A3FE98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A3FE9C  A8 9C 04 B6 */	lha r4, 0x4b6(r28)
/* 80A3FEA0  4B 5C C5 95 */	bl mDoMtx_YrotM__FPA4_fs
/* 80A3FEA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A3FEA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A3FEAC  38 81 00 20 */	addi r4, r1, 0x20
/* 80A3FEB0  7C 85 23 78 */	mr r5, r4
/* 80A3FEB4  4B 90 6E B9 */	bl PSMTXMultVec
...
/* 80A3FEE0  4B 5D DD DD */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80A3FEE4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80A3FEE8  41 82 00 10 */	beq lbl_80A3FEF8
/* 80A3FEEC  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80A3FEF0  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
/* 80A3FEF4  D0 01 00 24 */	stfs f0, 0x24(r1)
lbl_80A3FEF8:
/* 80A3FEF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A3FEFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80A3FFA0  4B 92 22 7D */	bl _restgpr_26
