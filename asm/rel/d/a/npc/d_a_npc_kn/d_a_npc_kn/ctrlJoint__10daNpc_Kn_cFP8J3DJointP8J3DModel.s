...
/* 80A398AC  4B 92 89 29 */	bl _savegpr_27
...
/* 80A398D0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A398D4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A398D8  4B 90 CB D9 */	bl PSMTXCopy
...
lbl_80A398F4:
/* 80A398F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A398F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A398FC  38 81 00 4C */	addi r4, r1, 0x4c
/* 80A39900  4B 90 CB B1 */	bl PSMTXCopy
...
/* 80A3991C  3C 60 80 A4 */	lis r3, lit_4204@ha /* 0x80A40900@ha */
/* 80A39920  C0 03 09 00 */	lfs f0, lit_4204@l(r3)  /* 0x80A40900@l */
/* 80A39924  D0 01 00 78 */	stfs f0, 0x78(r1)
/* 80A39928  D0 01 00 68 */	stfs f0, 0x68(r1)
/* 80A3992C  D0 01 00 58 */	stfs f0, 0x58(r1)
/* 80A39930  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A39934  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A399B8  4B 5D 35 8D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80A399BC:
/* 80A399BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A399C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A399C4  7C 64 1B 78 */	mr r4, r3
/* 80A399C8  4B 90 CB E9 */	bl PSMTXInverse
/* 80A399CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A399D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A399D4  38 81 00 1C */	addi r4, r1, 0x1c
/* 80A399D8  4B 90 CA D9 */	bl PSMTXCopy
/* 80A399DC  38 61 00 10 */	addi r3, r1, 0x10
/* 80A399E0  4B 5D 33 85 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80A399E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A399E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A39A38  4B 5D 35 0D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80A39A3C:
...
/* 80A39A58  4B 82 DB 8D */	bl cM_rad2s__Ff
...
/* 80A39A74  4B 82 DB 71 */	bl cM_rad2s__Ff
...
/* 80A39A8C  4B 5D 34 B9 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80A39A90:
...
/* 80A39AA0  3C 60 80 A4 */	lis r3, lit_4327@ha /* 0x80A4090C@ha */
/* 80A39AA4  C0 43 09 0C */	lfs f2, lit_4327@l(r3)  /* 0x80A4090C@l */
...
/* 80A39AB8  4B 82 DB 2D */	bl cM_rad2s__Ff
/* 80A39ABC  7C 7B 1B 78 */	mr r27, r3
/* 80A39AC0  C0 3C 0C D8 */	lfs f1, 0xcd8(r28)
/* 80A39AC4  C0 7C 0C C0 */	lfs f3, 0xcc0(r28)
/* 80A39AC8  3C 60 80 A4 */	lis r3, lit_4327@ha /* 0x80A4090C@ha */
/* 80A39ACC  C0 43 09 0C */	lfs f2, lit_4327@l(r3)  /* 0x80A4090C@l */
...
/* 80A39AE0  4B 82 DB 05 */	bl cM_rad2s__Ff
...
/* 80A39AF8  4B 5D 34 4D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80A39AFC:
/* 80A39AFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A39B00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A39B04  38 81 00 1C */	addi r4, r1, 0x1c
/* 80A39B08  7C 65 1B 78 */	mr r5, r3
/* 80A39B0C  4B 90 C9 D9 */	bl PSMTXConcat
/* 80A39B10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A39B14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A39B18  38 81 00 4C */	addi r4, r1, 0x4c
/* 80A39B1C  7C 65 1B 78 */	mr r5, r3
/* 80A39B20  4B 90 C9 C5 */	bl PSMTXConcat
lbl_80A39B24:
...
/* 80A39B3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A39B40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A39B44  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 80A39B48  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80A39B4C  7C 80 FA 14 */	add r4, r0, r31
/* 80A39B50  4B 90 C9 61 */	bl PSMTXCopy
/* 80A39B54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A39B58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A39B5C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80A39B60  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80A39B64  4B 90 C9 4D */	bl PSMTXCopy
...
/* 80A39B94  4B 5D 3D FD */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80A39BA8  4B 92 86 79 */	bl _restgpr_27
