...
/* 809F457C  3C 80 80 A0 */	lis r4, l_btkGetParamList@ha
/* 809F4580  84 A4 88 7C */	lwzu r5, l_btkGetParamList@l(r4)
...
/* 809F4594  3C 80 80 A0 */	lis r4, l_resNames@ha
/* 809F4598  38 84 89 68 */	addi r4, r4, l_resNames@l
/* 809F459C  7C 84 00 2E */	lwzx r4, r4, r0
/* 809F45A0  4B 75 E6 04 */	b getTexSRTKeyAnmP__8daNpcF_cFPci
...
/* 809F45BC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 809F45C0  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
/* 809F45C4  7C 04 04 2E */	lfsx f0, r4, r0
/* 809F45C8  3C 60 80 A0 */	lis r3, lit_4803@ha
/* 809F45CC  C0 43 85 B0 */	lfs f2, lit_4803@l(r3)
/* 809F45D0  3C 60 80 A0 */	lis r3, lit_4804@ha
/* 809F45D4  C0 23 85 B4 */	lfs f1, lit_4804@l(r3)
