...
/* 809F3FC8  4B 96 E2 11 */	bl _savegpr_28
...
/* 809F3FDC  3C 60 80 A0 */	lis r3, lit_4589@ha /* 0x809F85A4@ha */
/* 809F3FE0  38 83 85 A4 */	addi r4, r3, lit_4589@l /* 0x809F85A4@l */
...
/* 809F4018  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F401C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F4020  4B 95 24 91 */	bl PSMTXCopy
/* 809F4024  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F4028  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 809F405C  4B 95 24 55 */	bl PSMTXCopy
...
/* 809F408C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F4090  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F4094  4B 95 24 1D */	bl PSMTXCopy
...
/* 809F40C0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F40C4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F40C8  4B 95 23 E9 */	bl PSMTXCopy
...
/* 809F40F8  3C C0 80 A0 */	lis r6, m__19daNpc_GWolf_Param_c@ha /* 0x809F84F4@ha */
/* 809F40FC  38 C6 84 F4 */	addi r6, r6, m__19daNpc_GWolf_Param_c@l /* 0x809F84F4@l */
/* 809F4100  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 809F4104  4B 75 F2 79 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_809F4108:
/* 809F4108  2C 1D 00 01 */	cmpwi r29, 1
/* 809F410C  40 82 00 30 */	bne lbl_809F413C
/* 809F4110  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F4114  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F4118  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 809F411C  7C 00 00 D0 */	neg r0, r0
/* 809F4120  7C 04 07 34 */	extsh r4, r0
/* 809F4124  4B 61 83 11 */	bl mDoMtx_YrotM__FPA4_fs
/* 809F4128  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F412C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F4130  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 809F4134  4B 61 83 99 */	bl mDoMtx_ZrotM__FPA4_fs
/* 809F4138  48 00 00 34 */	b lbl_809F416C
lbl_809F413C:
/* 809F413C  2C 1D 00 04 */	cmpwi r29, 4
/* 809F4140  40 82 00 2C */	bne lbl_809F416C
/* 809F4144  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F4148  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F414C  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 809F4150  7C 00 00 D0 */	neg r0, r0
/* 809F4154  7C 04 07 34 */	extsh r4, r0
/* 809F4158  4B 61 82 DD */	bl mDoMtx_YrotM__FPA4_fs
/* 809F415C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F4160  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F4164  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 809F4168  4B 61 83 65 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_809F416C:
/* 809F416C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F4170  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F4174  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 809F4178  80 04 00 0C */	lwz r0, 0xc(r4)
/* 809F417C  7C 80 F2 14 */	add r4, r0, r30
/* 809F4180  4B 95 23 31 */	bl PSMTXCopy
/* 809F4184  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F4188  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F418C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 809F4190  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 809F4194  4B 95 23 1D */	bl PSMTXCopy
...
/* 809F41C4  4B 61 97 CD */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809F41D8  4B 96 E0 4D */	bl _restgpr_28
