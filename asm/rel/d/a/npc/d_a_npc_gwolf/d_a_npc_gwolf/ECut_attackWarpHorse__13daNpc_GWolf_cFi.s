...
/* 809F6558  4B 96 BC 71 */	bl _savegpr_24
/* 809F655C  7C 7A 1B 78 */	mr r26, r3
/* 809F6560  7C 98 23 78 */	mr r24, r4
/* 809F6564  3C 60 80 A0 */	lis r3, m__19daNpc_GWolf_Param_c@ha /* 0x809F84F4@ha */
/* 809F6568  3B C3 84 F4 */	addi r30, r3, m__19daNpc_GWolf_Param_c@l /* 0x809F84F4@l */
/* 809F656C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809F6570  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809F6588  3C A0 80 A0 */	lis r5, d_a_npc_gwolf__stringBase0@ha /* 0x809F871C@ha */
/* 809F658C  38 A5 87 1C */	addi r5, r5, d_a_npc_gwolf__stringBase0@l /* 0x809F871C@l */
/* 809F6590  38 A5 00 D3 */	addi r5, r5, 0xd3
/* 809F6594  38 C0 00 03 */	li r6, 3
/* 809F6598  4B 65 1B 55 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809F65B0  4B 65 17 9D */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 809F65C4  3C 60 80 A0 */	lis r3, lit_5816@ha /* 0x809F8CC0@ha */
/* 809F65C8  38 63 8C C0 */	addi r3, r3, lit_5816@l /* 0x809F8CC0@l */
...
/* 809F6668  4B 78 AF D9 */	bl dCam_getBody__Fv
...
/* 809F667C  4B 78 AA F5 */	bl StartBlure__9dCamera_cFiP10fopAc_ac_cff
...
/* 809F6720  4B 87 04 15 */	bl __mi__4cXyzCFRC3Vec
...
/* 809F6740  4B 95 09 F9 */	bl PSVECSquareMag
...
/* 809F67B0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809F67B4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 809F6820  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809F6824  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_809F6828:
...
/* 809F686C  3C 60 80 A0 */	lis r3, lit_5817@ha /* 0x809F8C1C@ha */
/* 809F6870  38 63 8C 1C */	addi r3, r3, lit_5817@l /* 0x809F8C1C@l */
...
/* 809F68A0  4B 61 64 C5 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 809F68A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F68A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F68AC  A8 9A 08 F2 */	lha r4, 0x8f2(r26)
/* 809F68B0  4B 61 5B 85 */	bl mDoMtx_YrotM__FPA4_fs
/* 809F68B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 809F68B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 809F68BC  38 81 00 4C */	addi r4, r1, 0x4c
/* 809F68C0  7C 85 23 78 */	mr r5, r4
/* 809F68C4  4B 95 04 A9 */	bl PSMTXMultVec
/* 809F68C8  38 61 00 4C */	addi r3, r1, 0x4c
/* 809F68CC  4B 62 73 F1 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 809F68D0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 809F68D4  41 82 00 10 */	beq lbl_809F68E4
/* 809F68D8  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 809F68DC  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
/* 809F68E0  D0 01 00 50 */	stfs f0, 0x50(r1)
lbl_809F68E4:
/* 809F68E4  38 61 00 4C */	addi r3, r1, 0x4c
/* 809F68E8  38 9A 04 D0 */	addi r4, r26, 0x4d0
/* 809F68EC  4B 87 A3 19 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 809F6924  4B 62 3D ED */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809F6938  4B 87 9C D1 */	bl cLib_addCalcAngleS2__FPssss
/* 809F693C  7F 43 D3 78 */	mr r3, r26
/* 809F6940  A8 9A 08 F2 */	lha r4, 0x8f2(r26)
/* 809F6944  4B 75 D9 0D */	bl setAngle__8daNpcF_cFs
...
/* 809F69F0  4B 87 01 45 */	bl __mi__4cXyzCFRC3Vec
...
/* 809F6A10  4B 95 07 29 */	bl PSVECSquareMag
...
/* 809F6A80  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809F6A84  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 809F6AF0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 809F6AF4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_809F6AF8:
...
/* 809F6B14  3C 60 80 A0 */	lis r3, l_appearTmpFlag@ha /* 0x809F8970@ha */
/* 809F6B18  38 63 89 70 */	addi r3, r3, l_appearTmpFlag@l /* 0x809F8970@l */
/* 809F6B1C  7C 63 02 AE */	lhax r3, r3, r0
/* 809F6B20  2C 03 FF FF */	cmpwi r3, -1
/* 809F6B24  41 82 00 08 */	beq lbl_809F6B2C
/* 809F6B28  4B 75 5F C5 */	bl daNpcT_onTmpBit__FUl
lbl_809F6B2C:
...
/* 809F6B48  4B 63 06 29 */	bl dStage_changeScene__FifUlScsi
...
/* 809F6B60  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 809F6B64  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 809F6B8C  4B 8B 4D F9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 809F6BE8  4B 96 B6 2D */	bl _restgpr_24
