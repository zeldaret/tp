...
/* 80AF0450  4B 87 1D 79 */	bl _savegpr_24
/* 80AF0454  7C 7D 1B 78 */	mr r29, r3
/* 80AF0458  3C 60 80 AF */	lis r3, lit_1109@ha /* 0x80AF2AF0@ha */
/* 80AF045C  3B C3 2A F0 */	addi r30, r3, lit_1109@l /* 0x80AF2AF0@l */
/* 80AF0460  3C 60 80 AF */	lis r3, m__22daNpc_SoldierA_Param_c@ha /* 0x80AF26E8@ha */
/* 80AF0464  3B E3 26 E8 */	addi r31, r3, m__22daNpc_SoldierA_Param_c@l /* 0x80AF26E8@l */
...
/* 80AF048C  3C 80 80 AF */	lis r4, __dt__4cXyzFv@ha /* 0x80AF1F74@ha */
/* 80AF0490  38 84 1F 74 */	addi r4, r4, __dt__4cXyzFv@l /* 0x80AF1F74@l */
...
/* 80AF04A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF04AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF04B0  A8 9D 09 90 */	lha r4, 0x990(r29)
/* 80AF04B4  4B 51 BF 29 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80AF04C8  4B 77 F5 75 */	bl cLib_addCalc2__FPffff
...
/* 80AF04DC  4B 77 F5 61 */	bl cLib_addCalc2__FPffff
/* 80AF04E0  3B 00 00 00 */	li r24, 0
/* 80AF04E4  3B 80 00 00 */	li r28, 0
/* 80AF04E8  3B 60 00 00 */	li r27, 0
/* 80AF04EC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80AF04F0  3B 23 9A 20 */	addi r25, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80AF04F4  C3 DF 00 80 */	lfs f30, 0x80(r31)
/* 80AF04F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF04FC  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_80AF0500:
...
/* 80AF0530  4B 85 68 3D */	bl PSMTXMultVec
...
/* 80AF0588  4B 78 01 49 */	bl cLib_chaseS__FPsss
...
/* 80AF05F0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF05F4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF05F8  4B 85 5E B9 */	bl PSMTXCopy
/* 80AF05FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF0600  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80AF0624  4B 85 67 49 */	bl PSMTXMultVec
/* 80AF0628  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF062C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF0630  38 9E 00 60 */	addi r4, r30, 0x60
/* 80AF0634  38 A1 00 30 */	addi r5, r1, 0x30
/* 80AF0638  4B 85 67 35 */	bl PSMTXMultVec
/* 80AF063C  38 7D 08 E4 */	addi r3, r29, 0x8e4
/* 80AF0640  38 81 00 30 */	addi r4, r1, 0x30
/* 80AF0644  4B 78 06 31 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80AF0648  B0 7D 09 02 */	sth r3, 0x902(r29)
/* 80AF064C  38 7D 08 E4 */	addi r3, r29, 0x8e4
/* 80AF0650  38 81 00 30 */	addi r4, r1, 0x30
/* 80AF0654  4B 78 05 B1 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80AF0670  4B 77 64 C5 */	bl __mi__4cXyzCFRC3Vec
...
/* 80AF06A8  4B 77 6F CD */	bl cM_atan2s__Fff
...
/* 80AF06D4  4B 85 6A 65 */	bl PSVECSquareMag
...
/* 80AF0744  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80AF0748  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80AF07B4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80AF07B8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80AF07BC  48 00 00 08 */	b lbl_80AF07C4
lbl_80AF07C0:
/* 80AF07C0  FC 40 08 90 */	fmr f2, f1
lbl_80AF07C4:
/* 80AF07C4  C0 21 00 40 */	lfs f1, 0x40(r1)
/* 80AF07C8  4B 77 6E AD */	bl cM_atan2s__Fff
...
/* 80AF0808  4B 51 C5 5D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80AF080C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF0810  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF0814  A8 9D 08 F0 */	lha r4, 0x8f0(r29)
/* 80AF0818  A8 BD 08 F2 */	lha r5, 0x8f2(r29)
/* 80AF081C  A8 DD 08 F4 */	lha r6, 0x8f4(r29)
/* 80AF0820  4B 51 BA 81 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80AF0824  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF0828  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF082C  38 81 00 3C */	addi r4, r1, 0x3c
/* 80AF0830  38 A1 00 48 */	addi r5, r1, 0x48
/* 80AF0834  4B 85 65 39 */	bl PSMTXMultVec
...
/* 80AF08A4  4B 77 E9 39 */	bl SetC__8cM3dGCylFRC4cXyz
...
/* 80AF08BC  4B 77 E9 3D */	bl SetH__8cM3dGCylFf
...
/* 80AF08D4  4B 77 E9 2D */	bl SetR__8cM3dGCylFf
/* 80AF08D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AF08DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AF08E0  38 63 23 3C */	addi r3, r3, 0x233c
/* 80AF08E4  38 9D 0C 94 */	addi r4, r29, 0xc94
/* 80AF08E8  4B 77 42 C1 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80AF08EC:
...
/* 80AF0914  4B 87 19 01 */	bl _restgpr_24
