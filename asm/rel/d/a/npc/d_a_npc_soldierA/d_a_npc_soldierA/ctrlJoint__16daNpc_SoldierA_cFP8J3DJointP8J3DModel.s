...
/* 80AEFF24  4B 87 22 B5 */	bl _savegpr_28
...
/* 80AEFF38  3C 60 80 AF */	lis r3, lit_4472@ha /* 0x80AF276C@ha */
/* 80AEFF3C  38 83 27 6C */	addi r4, r3, lit_4472@l /* 0x80AF276C@l */
...
/* 80AEFF74  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AEFF78  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AEFF7C  4B 85 65 35 */	bl PSMTXCopy
/* 80AEFF80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AEFF84  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80AEFFB8  4B 85 64 F9 */	bl PSMTXCopy
...
/* 80AEFFE8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AEFFEC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AEFFF0  4B 85 64 C1 */	bl PSMTXCopy
...
/* 80AF001C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF0020  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF0024  4B 85 64 8D */	bl PSMTXCopy
...
/* 80AF0054  3C C0 80 AF */	lis r6, m__22daNpc_SoldierA_Param_c@ha /* 0x80AF26E8@ha */
/* 80AF0058  38 C6 26 E8 */	addi r6, r6, m__22daNpc_SoldierA_Param_c@l /* 0x80AF26E8@l */
/* 80AF005C  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80AF0060  4B 66 33 1D */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80AF0064:
/* 80AF0064  2C 1E 00 01 */	cmpwi r30, 1
/* 80AF0068  40 82 00 30 */	bne lbl_80AF0098
/* 80AF006C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF0070  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF0074  A8 1C 09 0C */	lha r0, 0x90c(r28)
/* 80AF0078  7C 00 00 D0 */	neg r0, r0
/* 80AF007C  7C 04 07 34 */	extsh r4, r0
/* 80AF0080  4B 51 C3 B5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80AF0084  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF0088  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF008C  A8 9C 09 08 */	lha r4, 0x908(r28)
/* 80AF0090  4B 51 C4 3D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80AF0094  48 00 00 34 */	b lbl_80AF00C8
lbl_80AF0098:
/* 80AF0098  2C 1E 00 04 */	cmpwi r30, 4
/* 80AF009C  40 82 00 2C */	bne lbl_80AF00C8
/* 80AF00A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF00A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF00A8  A8 1C 09 18 */	lha r0, 0x918(r28)
/* 80AF00AC  7C 00 00 D0 */	neg r0, r0
/* 80AF00B0  7C 04 07 34 */	extsh r4, r0
/* 80AF00B4  4B 51 C3 81 */	bl mDoMtx_YrotM__FPA4_fs
/* 80AF00B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF00BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF00C0  A8 9C 09 14 */	lha r4, 0x914(r28)
/* 80AF00C4  4B 51 C4 09 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80AF00C8:
/* 80AF00C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF00CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF00D0  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 80AF00D4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80AF00D8  7C 80 FA 14 */	add r4, r0, r31
/* 80AF00DC  4B 85 63 D5 */	bl PSMTXCopy
/* 80AF00E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80AF00E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80AF00E8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80AF00EC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80AF00F0  4B 85 63 C1 */	bl PSMTXCopy
/* 80AF00F4  38 60 00 01 */	li r3, 1
/* 80AF00F8  39 61 00 30 */	addi r11, r1, 0x30
/* 80AF00FC  4B 87 21 29 */	bl _restgpr_28
