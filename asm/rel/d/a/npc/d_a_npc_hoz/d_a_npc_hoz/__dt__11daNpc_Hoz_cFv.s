...
/* 80A0152C  3C 60 80 A0 */	lis r3, __vt__11daNpc_Hoz_c@ha /* 0x80A07810@ha */
/* 80A01530  38 03 78 10 */	addi r0, r3, __vt__11daNpc_Hoz_c@l /* 0x80A07810@l */
...
/* 80A01548  4B 74 B5 E5 */	bl daNpcT_offTmpBit__FUl
lbl_80A0154C:
...
/* 80A0155C  4B 60 FD B5 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80A01560:
/* 80A01560  7F C3 F3 78 */	mr r3, r30
/* 80A01564  88 1E 0F 80 */	lbz r0, 0xf80(r30)
/* 80A01568  54 00 10 3A */	slwi r0, r0, 2
/* 80A0156C  3C 80 80 A0 */	lis r4, l_loadResPtrnList@ha /* 0x80A068AC@ha */
/* 80A01570  38 84 68 AC */	addi r4, r4, l_loadResPtrnList@l /* 0x80A068AC@l */
/* 80A01574  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A01578  3C A0 80 A0 */	lis r5, l_resNameList@ha /* 0x80A0687C@ha */
/* 80A0157C  38 A5 68 7C */	addi r5, r5, l_resNameList@l /* 0x80A0687C@l */
/* 80A01580  4B 74 6F 2D */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80A01584  34 1E 0F A0 */	addic. r0, r30, 0xfa0
/* 80A01588  41 82 00 10 */	beq lbl_80A01598
/* 80A0158C  3C 60 80 A0 */	lis r3, __vt__18daNpcT_ActorMngr_c@ha /* 0x80A07804@ha */
/* 80A01590  38 03 78 04 */	addi r0, r3, __vt__18daNpcT_ActorMngr_c@l /* 0x80A07804@l */
/* 80A01594  90 1E 0F A4 */	stw r0, 0xfa4(r30)
lbl_80A01598:
/* 80A01598  34 1E 0E 44 */	addic. r0, r30, 0xe44
/* 80A0159C  41 82 00 84 */	beq lbl_80A01620
/* 80A015A0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80A015A4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80A015C4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80A015C8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80A015E0  3C 60 80 A0 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80A077F8@ha */
/* 80A015E4  38 03 77 F8 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80A077F8@l */
/* 80A015E8  90 1E 0F 7C */	stw r0, 0xf7c(r30)
lbl_80A015EC:
/* 80A015EC  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80A015F0  41 82 00 24 */	beq lbl_80A01614
/* 80A015F4  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80A015F8  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80A015FC  90 1E 0F 64 */	stw r0, 0xf64(r30)
/* 80A01600  34 1E 0F 48 */	addic. r0, r30, 0xf48
/* 80A01604  41 82 00 10 */	beq lbl_80A01614
/* 80A01608  3C 60 80 A0 */	lis r3, __vt__8cM3dGAab@ha /* 0x80A077EC@ha */
/* 80A0160C  38 03 77 EC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80A077EC@l */
/* 80A01610  90 1E 0F 60 */	stw r0, 0xf60(r30)
lbl_80A01614:
/* 80A01614  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80A01618  38 80 00 00 */	li r4, 0
/* 80A0161C  4B 68 2A C9 */	bl __dt__12dCcD_GObjInfFv
lbl_80A01620:
...
/* 80A01638  4B 8C D7 05 */	bl __dl__FPv
lbl_80A0163C:
