...
/* 80A0460C  4B 95 DB D1 */	bl _savegpr_29
...
/* 80A04640  4B 74 75 B1 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80A04668  4B 74 10 95 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80A0466C  38 00 00 00 */	li r0, 0
/* 80A04670  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80A04674  3C 60 80 A0 */	lis r3, lit_4337@ha /* 0x80A0670C@ha */
/* 80A04678  C0 03 67 0C */	lfs f0, lit_4337@l(r3)  /* 0x80A0670C@l */
...
/* 80A04698  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A0469C  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A046A0  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 80A046A4  4B 61 60 6D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A046C8  4B 61 60 49 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A046E4  4B 74 6F 65 */	bl step__8daNpcT_cFsiiii
...
/* 80A04718  4B 74 75 61 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 80A04734  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A04738  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A0473C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80A04740  4B 74 0F A1 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80A04744  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A04748  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A0474C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80A04750  4B 63 DD 19 */	bl reset__14dEvt_control_cFv
...
lbl_80A04784:
/* 80A04784  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80A04788  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80A0478C  88 9F 0F 88 */	lbz r4, 0xf88(r31)
/* 80A04790  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80A04794  7C 05 07 74 */	extsb r5, r0
/* 80A04798  4B 63 0B C9 */	bl isSwitch__10dSv_info_cCFii
...
/* 80A047C0  4B 74 5A 65 */	bl evtChange__8daNpcT_cFv
/* 80A047C4  48 00 00 9C */	b lbl_80A04860
lbl_80A047C8:
/* 80A047C8  3C 60 80 43 */	lis r3, g_meter2_info@ha /* 0x80430188@ha */
/* 80A047CC  38 63 01 88 */	addi r3, r3, g_meter2_info@l /* 0x80430188@l */
...
/* 80A047EC  4B 81 96 2D */	bl setMiniGameItem__13dMeter2Info_cFUc
/* 80A047F0  3C 60 80 43 */	lis r3, g_meter2_info@ha /* 0x80430188@ha */
/* 80A047F4  38 63 01 88 */	addi r3, r3, g_meter2_info@l /* 0x80430188@l */
...
/* 80A0480C  4B 74 83 61 */	bl daNpcT_chkTmpBit__FUl
...
/* 80A04834  4B 74 59 F1 */	bl evtChange__8daNpcT_cFv
...
/* 80A0485C  4B 74 59 C9 */	bl evtChange__8daNpcT_cFv
lbl_80A04860:
/* 80A04860  38 60 00 00 */	li r3, 0
/* 80A04864  39 61 00 20 */	addi r11, r1, 0x20
/* 80A04868  4B 95 D9 C1 */	bl _restgpr_29
