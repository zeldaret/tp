...
/* 80A60D14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A60D18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A60D1C  A8 1F 0D 12 */	lha r0, 0xd12(r31)
/* 80A60D20  7C 00 00 D0 */	neg r0, r0
/* 80A60D24  7C 04 07 34 */	extsh r4, r0
/* 80A60D28  4B 5A B7 0C */	b mDoMtx_YrotM__FPA4_fs
/* 80A60D2C  A8 9F 0D 0E */	lha r4, 0xd0e(r31)
/* 80A60D30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A60D34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A60D38  4B 5A B7 94 */	b mDoMtx_ZrotM__FPA4_fs
/* 80A60D3C  48 00 00 34 */	b lbl_80A60D70
lbl_80A60D40:
/* 80A60D40  2C 04 00 04 */	cmpwi r4, 4
/* 80A60D44  40 82 00 2C */	bne lbl_80A60D70
/* 80A60D48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A60D4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A60D50  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80A60D54  7C 00 00 D0 */	neg r0, r0
/* 80A60D58  7C 04 07 34 */	extsh r4, r0
/* 80A60D5C  4B 5A B6 D8 */	b mDoMtx_YrotM__FPA4_fs
/* 80A60D60  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80A60D64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A60D68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A60D6C  4B 5A B7 60 */	b mDoMtx_ZrotM__FPA4_fs
lbl_80A60D70:
