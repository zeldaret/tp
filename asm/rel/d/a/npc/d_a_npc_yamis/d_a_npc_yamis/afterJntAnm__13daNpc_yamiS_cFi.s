...
/* 80B47274  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B47278  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B4727C  4B 4C 51 B8 */	b mDoMtx_YrotM__FPA4_fs
/* 80B47280  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B47284  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B47288  A8 1F 0D 0E */	lha r0, 0xd0e(r31)
/* 80B4728C  7C 00 00 D0 */	neg r0, r0
/* 80B47290  7C 04 07 34 */	extsh r4, r0
/* 80B47294  4B 4C 52 38 */	b mDoMtx_ZrotM__FPA4_fs
/* 80B47298  48 00 00 34 */	b lbl_80B472CC
lbl_80B4729C:
/* 80B4729C  2C 04 00 04 */	cmpwi r4, 4
/* 80B472A0  40 82 00 2C */	bne lbl_80B472CC
/* 80B472A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B472A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B472AC  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80B472B0  7C 00 00 D0 */	neg r0, r0
/* 80B472B4  7C 04 07 34 */	extsh r4, r0
/* 80B472B8  4B 4C 51 7C */	b mDoMtx_YrotM__FPA4_fs
/* 80B472BC  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80B472C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B472C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B472C8  4B 4C 52 04 */	b mDoMtx_ZrotM__FPA4_fs
lbl_80B472CC:
