...
/* 80B0B700  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B0B704  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B0B708  4B 83 AD A9 */	bl PSMTXCopy
/* 80B0B70C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B0B710  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B0B748  3C 60 80 B1 */	lis r3, lit_4004@ha /* 0x80B0C1D8@ha */
/* 80B0B74C  C0 03 C1 D8 */	lfs f0, lit_4004@l(r3)  /* 0x80B0C1D8@l */
...
/* 80B0B76C  4B 76 3E DD */	bl SetC__8cM3dGSphFRC4cXyz
/* 80B0B770  38 7F 0A E8 */	addi r3, r31, 0xae8
/* 80B0B774  3C 80 80 B1 */	lis r4, lit_7266@ha /* 0x80B0C348@ha */
/* 80B0B778  C0 24 C3 48 */	lfs f1, lit_7266@l(r4)  /* 0x80B0C348@l */
/* 80B0B77C  4B 76 3F 8D */	bl SetR__8cM3dGSphFf
/* 80B0B780  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B0B784  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B0B788  38 63 23 3C */	addi r3, r3, 0x233c
/* 80B0B78C  38 9F 09 C4 */	addi r4, r31, 0x9c4
/* 80B0B790  4B 75 94 19 */	bl Set__4cCcSFP8cCcD_Obj
/* 80B0B794  48 00 00 1C */	b lbl_80B0B7B0
lbl_80B0B798:
/* 80B0B798  38 7F 09 C4 */	addi r3, r31, 0x9c4
/* 80B0B79C  4B 57 8B 7D */	bl ResetAtHit__12dCcD_GObjInfFv
/* 80B0B7A0  38 7F 09 C4 */	addi r3, r31, 0x9c4
/* 80B0B7A4  4B 57 8D 15 */	bl ResetTgHit__12dCcD_GObjInfFv
/* 80B0B7A8  38 7F 09 C4 */	addi r3, r31, 0x9c4
/* 80B0B7AC  4B 57 8F 05 */	bl ResetCoHit__12dCcD_GObjInfFv
lbl_80B0B7B0:
