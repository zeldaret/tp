...
/* 80B0B9BC  4B 85 68 1D */	bl _savegpr_28
...
/* 80B0B9DC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B0B9E0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B0B9E4  4B 83 AA CD */	bl PSMTXCopy
/* 80B0B9E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B0B9EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B0BA2C  4B 50 08 75 */	bl mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80B0BA40  4B 50 08 61 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80B0BA44  48 00 00 F0 */	b lbl_80B0BB34
lbl_80B0BA48:
/* 80B0BA48  A8 9C 06 AA */	lha r4, 0x6aa(r28)
/* 80B0BA4C  4B 50 09 51 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80B0BA7C  3C 80 80 B1 */	lis r4, lit_4231@ha /* 0x80B0C22C@ha */
/* 80B0BA80  C0 04 C2 2C */	lfs f0, lit_4231@l(r4)  /* 0x80B0C22C@l */
...
/* 80B0BA94  4B 83 AA 1D */	bl PSMTXCopy
...
/* 80B0BAD0  3C 80 80 B1 */	lis r4, lit_4231@ha /* 0x80B0C22C@ha */
/* 80B0BAD4  C0 04 C2 2C */	lfs f0, lit_4231@l(r4)  /* 0x80B0C22C@l */
...
/* 80B0BAE8  4B 83 A9 C9 */	bl PSMTXCopy
...
/* 80B0BB0C  4B 50 07 95 */	bl mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80B0BB30  4B 50 07 71 */	bl mDoMtx_ZXYrotM__FPA4_fsss
lbl_80B0BB34:
/* 80B0BB34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B0BB38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B0BB3C  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80B0BB40  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80B0BB44  7C 80 FA 14 */	add r4, r0, r31
/* 80B0BB48  4B 83 A9 69 */	bl PSMTXCopy
/* 80B0BB4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B0BB50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B0BB54  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80B0BB58  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80B0BB5C  4B 83 A9 55 */	bl PSMTXCopy
/* 80B0BB60  38 60 00 01 */	li r3, 1
/* 80B0BB64  39 61 00 20 */	addi r11, r1, 0x20
/* 80B0BB68  4B 85 66 BD */	bl _restgpr_28
