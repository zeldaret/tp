...
/* 80B04C08  4B 85 D5 D5 */	bl _savegpr_29
/* 80B04C0C  7C 7E 1B 78 */	mr r30, r3
/* 80B04C10  3C 60 80 B1 */	lis r3, lit_3999@ha /* 0x80B0C1C4@ha */
/* 80B04C14  3B E3 C1 C4 */	addi r31, r3, lit_3999@l /* 0x80B0C1C4@l */
...
/* 80B04C2C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80B04C30  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80B04C9C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04CA0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04CA4  4B 84 18 0D */	bl PSMTXCopy
/* 80B04CA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04CAC  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B04CCC  4B 50 80 99 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80B04CD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04CD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B04CF4  4B 50 75 AD */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80B04CF8  C0 3F 00 30 */	lfs f1, 0x30(r31)
/* 80B04CFC  C0 5F 01 04 */	lfs f2, 0x104(r31)
/* 80B04D00  C0 7F 00 14 */	lfs f3, 0x14(r31)
/* 80B04D04  4B 50 80 99 */	bl transM__14mDoMtx_stack_cFfff
/* 80B04D08  83 DE 06 34 */	lwz r30, 0x634(r30)
/* 80B04D0C  38 00 00 01 */	li r0, 1
/* 80B04D10  98 1E 0B 08 */	stb r0, 0xb08(r30)
/* 80B04D14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04D18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04D1C  7C 64 1B 78 */	mr r4, r3
/* 80B04D20  4B 84 17 91 */	bl PSMTXCopy
...
/* 80B04D74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04D78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04D7C  38 84 00 24 */	addi r4, r4, 0x24
/* 80B04D80  4B 84 17 31 */	bl PSMTXCopy
...
/* 80B04D98  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04D9C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04DA0  4B 84 17 11 */	bl PSMTXCopy
/* 80B04DA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04DA8  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B04DC8  4B 50 7F 9D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80B04DCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04DD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B04DF8  4B 50 74 A9 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80B04DFC  C0 3F 00 D4 */	lfs f1, 0xd4(r31)
/* 80B04E00  C0 5F 01 08 */	lfs f2, 0x108(r31)
/* 80B04E04  C0 7F 00 30 */	lfs f3, 0x30(r31)
/* 80B04E08  4B 50 7F 95 */	bl transM__14mDoMtx_stack_cFfff
/* 80B04E0C  C0 3F 00 18 */	lfs f1, 0x18(r31)
/* 80B04E10  C0 5F 00 BC */	lfs f2, 0xbc(r31)
/* 80B04E14  C0 7F 00 30 */	lfs f3, 0x30(r31)
/* 80B04E18  4B 50 7F 85 */	bl transM__14mDoMtx_stack_cFfff
/* 80B04E1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04E20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04E24  38 80 00 00 */	li r4, 0
/* 80B04E28  38 A0 00 00 */	li r5, 0
/* 80B04E2C  A8 DE 06 A6 */	lha r6, 0x6a6(r30)
/* 80B04E30  4B 50 74 71 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80B04E34  C0 3F 00 70 */	lfs f1, 0x70(r31)
/* 80B04E38  C0 5F 01 04 */	lfs f2, 0x104(r31)
/* 80B04E3C  C0 7F 00 30 */	lfs f3, 0x30(r31)
/* 80B04E40  4B 50 7F 5D */	bl transM__14mDoMtx_stack_cFfff
/* 80B04E44  83 DE 06 34 */	lwz r30, 0x634(r30)
/* 80B04E48  38 00 00 01 */	li r0, 1
/* 80B04E4C  98 1E 0B A2 */	stb r0, 0xba2(r30)
/* 80B04E50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04E54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04E58  7C 64 1B 78 */	mr r4, r3
/* 80B04E5C  4B 84 16 55 */	bl PSMTXCopy
...
/* 80B04E9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04EA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04EA4  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80B04EA8  38 84 00 24 */	addi r4, r4, 0x24
/* 80B04EAC  4B 84 16 05 */	bl PSMTXCopy
...
/* 80B04EC4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04EC8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04ECC  4B 84 15 E5 */	bl PSMTXCopy
/* 80B04ED0  C0 3F 01 0C */	lfs f1, 0x10c(r31)
/* 80B04ED4  C0 5F 01 10 */	lfs f2, 0x110(r31)
/* 80B04ED8  C0 7F 00 30 */	lfs f3, 0x30(r31)
/* 80B04EDC  4B 50 7E C1 */	bl transM__14mDoMtx_stack_cFfff
/* 80B04EE0  83 BE 06 34 */	lwz r29, 0x634(r30)
/* 80B04EE4  38 00 00 01 */	li r0, 1
/* 80B04EE8  98 1D 0B B3 */	stb r0, 0xbb3(r29)
/* 80B04EEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04EF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B04EF4  7C 64 1B 78 */	mr r4, r3
/* 80B04EF8  4B 84 15 B9 */	bl PSMTXCopy
/* 80B04EFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B04F00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80B04F48  4B 84 15 69 */	bl PSMTXCopy
lbl_80B04F4C:
/* 80B04F4C  39 61 00 50 */	addi r11, r1, 0x50
/* 80B04F50  4B 85 D2 D9 */	bl _restgpr_29
