...
/* 80AF9D00  4B 86 84 DD */	bl _savegpr_29
/* 80AF9D04  7C 7D 1B 78 */	mr r29, r3
/* 80AF9D08  3C 80 80 B0 */	lis r4, cNullVec__6Z2Calc@ha /* 0x80AFC1D0@ha */
/* 80AF9D0C  3B C4 C1 D0 */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x80AFC1D0@l */
...
/* 80AF9D28  4B 86 82 F1 */	bl __ptmf_test
...
/* 80AF9D3C  4B 86 83 0D */	bl __ptmf_cmpr
...
/* 80AF9D54  4B 86 83 31 */	bl __ptmf_scall
...
/* 80AF9D7C  4B 86 82 9D */	bl __ptmf_test
...
/* 80AF9D9C  4B 86 82 E9 */	bl __ptmf_scall
/* 80AF9DA0  60 00 00 00 */	nop 
lbl_80AF9DA4:
/* 80AF9DA4  38 61 00 08 */	addi r3, r1, 8
/* 80AF9DA8  4B 86 82 71 */	bl __ptmf_test
...
/* 80AF9DE0  4B 86 82 A5 */	bl __ptmf_scall
...
/* 80AF9DF4  3C 60 80 B0 */	lis r3, lit_4297@ha /* 0x80AFBE88@ha */
/* 80AF9DF8  C0 03 BE 88 */	lfs f0, lit_4297@l(r3)  /* 0x80AFBE88@l */
...
/* 80AF9E28  4B 53 5C 2D */	bl dComIfGs_wolfeye_effect_check__Fv
...
lbl_80AF9E48:
/* 80AF9E48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AF9E4C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AF9E7C  4B 54 98 71 */	bl setPtI_Id__14dEvt_control_cFUi
/* 80AF9E80  38 00 FF FF */	li r0, -1
/* 80AF9E84  90 1D 0E 00 */	stw r0, 0xe00(r29)
lbl_80AF9E88:
/* 80AF9E88  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9E8C  38 63 BE 0C */	addi r3, r3, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
/* 80AF9E90  88 03 00 6A */	lbz r0, 0x6a(r3)
/* 80AF9E94  28 00 00 00 */	cmplwi r0, 0
/* 80AF9E98  40 82 00 D0 */	bne lbl_80AF9F68
/* 80AF9E9C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AF9EA0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AF9F14  3C 80 80 B0 */	lis r4, d_a_npc_the__stringBase0@ha /* 0x80AFC158@ha */
/* 80AF9F18  38 84 C1 58 */	addi r4, r4, d_a_npc_the__stringBase0@l /* 0x80AFC158@l */
/* 80AF9F1C  38 84 00 54 */	addi r4, r4, 0x54
/* 80AF9F20  4B 86 EA 75 */	bl strcmp
...
/* 80AF9F64  4B 65 99 19 */	bl orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_80AF9F68:
...
/* 80AF9F80  4B 86 82 A9 */	bl _restgpr_29
