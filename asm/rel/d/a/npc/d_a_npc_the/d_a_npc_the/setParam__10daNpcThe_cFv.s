...
/* 80AF9A04  4B 86 87 D5 */	bl _savegpr_28
/* 80AF9A08  7C 7D 1B 78 */	mr r29, r3
/* 80AF9A0C  3C 60 80 B0 */	lis r3, cNullVec__6Z2Calc@ha /* 0x80AFC1D0@ha */
/* 80AF9A10  3B E3 C1 D0 */	addi r31, r3, cNullVec__6Z2Calc@l /* 0x80AFC1D0@l */
/* 80AF9A14  38 7D 0C 88 */	addi r3, r29, 0xc88
/* 80AF9A18  4B 65 6C D5 */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 80AF9A30  4B 65 A8 71 */	bl getEvtAreaTagP__8daNpcF_cFii
/* 80AF9A34  7C 64 1B 78 */	mr r4, r3
/* 80AF9A38  38 7D 0C 88 */	addi r3, r29, 0xc88
/* 80AF9A3C  4B 65 6C 81 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
lbl_80AF9A40:
...
/* 80AF9A58  3C 60 80 3A */	lis r3, __ptmf_null@ha /* 0x803A2180@ha */
/* 80AF9A5C  38 83 21 80 */	addi r4, r3, __ptmf_null@l /* 0x803A2180@l */
...
/* 80AF9A78  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
...
/* 80AF9AF0  4B 86 85 59 */	bl __ptmf_cmpr
...
/* 80AF9B10  4B 65 6B A1 */	bl initialize__18daNpcF_ActorMngr_cFv
...
lbl_80AF9B38:
/* 80AF9B38  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9B3C  38 63 BE 0C */	addi r3, r3, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
...
lbl_80AF9B58:
/* 80AF9B58  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9B5C  38 63 BE 0C */	addi r3, r3, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
...
/* 80AF9B70  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AF9B74  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80AF9B78  3B 83 4E 00 */	addi r28, r3, 0x4e00
/* 80AF9B7C  7F 83 E3 78 */	mr r3, r28
/* 80AF9B80  3C 80 80 B0 */	lis r4, d_a_npc_the__stringBase0@ha /* 0x80AFC158@ha */
/* 80AF9B84  38 84 C1 58 */	addi r4, r4, d_a_npc_the__stringBase0@l /* 0x80AFC158@l */
/* 80AF9B88  38 84 00 54 */	addi r4, r4, 0x54
/* 80AF9B8C  4B 86 EE 09 */	bl strcmp
/* 80AF9B90  2C 03 00 00 */	cmpwi r3, 0
/* 80AF9B94  40 82 00 30 */	bne lbl_80AF9BC4
/* 80AF9B98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80AF9B9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80AF9BB0  4B 53 2D CD */	bl getLayerNo__14dComIfG_play_cFi
...
/* 80AF9BFC  3C 80 80 B0 */	lis r4, d_a_npc_the__stringBase0@ha /* 0x80AFC158@ha */
/* 80AF9C00  38 84 C1 58 */	addi r4, r4, d_a_npc_the__stringBase0@l /* 0x80AFC158@l */
/* 80AF9C04  38 84 00 54 */	addi r4, r4, 0x54
/* 80AF9C08  4B 86 ED 8D */	bl strcmp
/* 80AF9C0C  2C 03 00 00 */	cmpwi r3, 0
/* 80AF9C10  40 82 00 4C */	bne lbl_80AF9C5C
/* 80AF9C14  7F A3 EB 78 */	mr r3, r29
/* 80AF9C18  3C 80 80 B0 */	lis r4, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9C1C  38 84 BE 0C */	addi r4, r4, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
/* 80AF9C20  A8 84 00 4C */	lha r4, 0x4c(r4)
/* 80AF9C24  7F C5 F3 78 */	mr r5, r30
/* 80AF9C28  4B 65 A6 51 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 80AF9C3C  3C 80 80 B0 */	lis r4, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9C40  38 84 BE 0C */	addi r4, r4, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
/* 80AF9C44  A8 84 00 48 */	lha r4, 0x48(r4)
/* 80AF9C48  38 84 00 01 */	addi r4, r4, 1
/* 80AF9C4C  7F E5 FB 78 */	mr r5, r31
/* 80AF9C50  4B 65 A6 29 */	bl getDistTableIdx__8daNpcF_cFii
/* 80AF9C54  98 7D 05 47 */	stb r3, 0x547(r29)
/* 80AF9C58  48 00 00 44 */	b lbl_80AF9C9C
lbl_80AF9C5C:
/* 80AF9C5C  7F A3 EB 78 */	mr r3, r29
/* 80AF9C60  3C 80 80 B0 */	lis r4, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9C64  38 84 BE 0C */	addi r4, r4, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
/* 80AF9C68  A8 84 00 4C */	lha r4, 0x4c(r4)
/* 80AF9C6C  7F C5 F3 78 */	mr r5, r30
/* 80AF9C70  4B 65 A6 09 */	bl getDistTableIdx__8daNpcF_cFii
...
/* 80AF9C84  3C 80 80 B0 */	lis r4, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9C88  38 84 BE 0C */	addi r4, r4, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
/* 80AF9C8C  A8 84 00 48 */	lha r4, 0x48(r4)
/* 80AF9C90  7F E5 FB 78 */	mr r5, r31
/* 80AF9C94  4B 65 A5 E5 */	bl getDistTableIdx__8daNpcF_cFii
/* 80AF9C98  98 7D 05 47 */	stb r3, 0x547(r29)
lbl_80AF9C9C:
/* 80AF9C9C  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9CA0  38 83 BE 0C */	addi r4, r3, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
...
/* 80AF9CBC  4B 57 C2 85 */	bl SetWallR__12dBgS_AcchCirFf
/* 80AF9CC0  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha /* 0x80AFBE0C@ha */
/* 80AF9CC4  38 63 BE 0C */	addi r3, r3, m__16daNpcThe_Param_c@l /* 0x80AFBE0C@l */
...
/* 80AF9CDC  4B 86 85 49 */	bl _restgpr_28
