...
lbl_8099046C:
/* 8099046C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80990470  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80990474  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80990478  4B 68 A2 99 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8099047C  7C 64 1B 78 */	mr r4, r3
/* 80990480  7F C3 F3 78 */	mr r3, r30
/* 80990484  4B 7C 3D CD */	bl setAngle__8daNpcF_cFs
...
/* 8099049C  4B 7C 38 E9 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
/* 809904A0  2C 03 00 00 */	cmpwi r3, 0
/* 809904A4  41 82 00 A8 */	beq lbl_8099054C
/* 809904A8  38 7E 0E 70 */	addi r3, r30, 0xe70
/* 809904AC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809904B0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809904B4  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 809904B8  4B 7C 02 05 */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 809904CC  4B 8B A0 5D */	bl getEventId__10dMsgFlow_cFPi
...
/* 80990500  4B 68 B6 E9 */	bl fopAcM_createItemForPresentDemo__FPC4cXyziUciiPC5csXyzPC4cXyz
...
/* 80990514  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80990518  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8099051C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80990520  4B 6B 31 CD */	bl setPtI_Id__14dEvt_control_cFUi
lbl_80990524:
/* 80990524  7F C3 F3 78 */	mr r3, r30
/* 80990528  38 80 00 0E */	li r4, 0xe
/* 8099052C  3C A0 80 99 */	lis r5, lit_4627@ha /* 0x809919A4@ha */
/* 80990530  C0 25 19 A4 */	lfs f1, lit_4627@l(r5)  /* 0x809919A4@l */
...
/* 8099056C  4B 7C 38 19 */	bl talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80990580  3C A0 80 99 */	lis r5, lit_4627@ha /* 0x809919A4@ha */
/* 80990584  C0 25 19 A4 */	lfs f1, lit_4627@l(r5)  /* 0x809919A4@l */
