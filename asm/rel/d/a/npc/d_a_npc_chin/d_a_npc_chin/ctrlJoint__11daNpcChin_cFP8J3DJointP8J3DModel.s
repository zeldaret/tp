...
/* 8098CDF8  4B 9D 53 E1 */	bl _savegpr_28
...
/* 8098CE0C  3C 60 80 99 */	lis r3, lit_4473@ha /* 0x80991998@ha */
/* 8098CE10  38 83 19 98 */	addi r4, r3, lit_4473@l /* 0x80991998@l */
...
/* 8098CE48  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8098CE4C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8098CE50  4B 9B 96 61 */	bl PSMTXCopy
/* 8098CE54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8098CE58  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8098CE8C  4B 9B 96 25 */	bl PSMTXCopy
...
/* 8098CEBC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8098CEC0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8098CEC4  4B 9B 95 ED */	bl PSMTXCopy
...
/* 8098CEF0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8098CEF4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8098CEF8  4B 9B 95 B9 */	bl PSMTXCopy
...
/* 8098CF28  3C C0 80 99 */	lis r6, m__17daNpcChin_Param_c@ha /* 0x8099190C@ha */
/* 8098CF2C  38 C6 19 0C */	addi r6, r6, m__17daNpcChin_Param_c@l /* 0x8099190C@l */
/* 8098CF30  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 8098CF34  4B 7C 64 49 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_8098CF38:
/* 8098CF38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8098CF3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8098CF40  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 8098CF44  80 04 00 0C */	lwz r0, 0xc(r4)
/* 8098CF48  7C 80 E2 14 */	add r4, r0, r28
/* 8098CF4C  4B 9B 95 65 */	bl PSMTXCopy
/* 8098CF50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8098CF54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8098CF58  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8098CF5C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8098CF60  4B 9B 95 51 */	bl PSMTXCopy
...
/* 8098CF90  4B 68 0A 01 */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 8098CFA4  4B 9D 52 81 */	bl _restgpr_28
