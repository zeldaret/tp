...
/* 8098D1B8  3C 80 80 99 */	lis r4, l_btkGetParamList@ha /* 0x8099203C@ha */
/* 8098D1BC  38 A4 20 3C */	addi r5, r4, l_btkGetParamList@l /* 0x8099203C@l */
/* 8098D1C0  80 05 00 08 */	lwz r0, 8(r5)
/* 8098D1C4  54 00 10 3A */	slwi r0, r0, 2
/* 8098D1C8  3C 80 80 99 */	lis r4, l_arcNames@ha /* 0x809920A8@ha */
/* 8098D1CC  38 84 20 A8 */	addi r4, r4, l_arcNames@l /* 0x809920A8@l */
/* 8098D1D0  7C 84 00 2E */	lwzx r4, r4, r0
/* 8098D1D4  80 A5 00 00 */	lwz r5, 0(r5)
/* 8098D1D8  4B 7C 59 CD */	bl getTexSRTKeyAnmP__8daNpcF_cFPci
...
/* 8098D1F0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8098D1F4  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 8098D1F8  7C 44 04 2E */	lfsx f2, r4, r0
/* 8098D1FC  3C 60 80 99 */	lis r3, lit_4627@ha /* 0x809919A4@ha */
/* 8098D200  C0 23 19 A4 */	lfs f1, lit_4627@l(r3)  /* 0x809919A4@l */
