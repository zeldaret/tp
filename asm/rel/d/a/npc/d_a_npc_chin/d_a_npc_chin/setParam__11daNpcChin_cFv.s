...
/* 8098D03C  3C 80 80 99 */	lis r4, m__17daNpcChin_Param_c@ha /* 0x8099190C@ha */
/* 8098D040  38 A4 19 0C */	addi r5, r4, m__17daNpcChin_Param_c@l /* 0x8099190C@l */
/* 8098D044  A8 85 00 4C */	lha r4, 0x4c(r5)
/* 8098D048  A8 A5 00 4E */	lha r5, 0x4e(r5)
/* 8098D04C  4B 7C 72 2D */	bl getDistTableIdx__8daNpcF_cFii
...
/* 8098D060  3C 80 80 99 */	lis r4, m__17daNpcChin_Param_c@ha /* 0x8099190C@ha */
/* 8098D064  38 A4 19 0C */	addi r5, r4, m__17daNpcChin_Param_c@l /* 0x8099190C@l */
/* 8098D068  A8 85 00 48 */	lha r4, 0x48(r5)
/* 8098D06C  A8 A5 00 4A */	lha r5, 0x4a(r5)
/* 8098D070  4B 7C 72 09 */	bl getDistTableIdx__8daNpcF_cFii
/* 8098D074  98 7F 05 47 */	stb r3, 0x547(r31)
/* 8098D078  38 00 00 0A */	li r0, 0xa
/* 8098D07C  90 1F 05 5C */	stw r0, 0x55c(r31)
/* 8098D080  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8098D084  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8098D0C0  4B 6A 29 95 */	bl dComIfGs_wolfeye_effect_check__Fv
