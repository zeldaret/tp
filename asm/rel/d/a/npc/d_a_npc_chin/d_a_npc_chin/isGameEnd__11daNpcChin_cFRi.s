...
/* 8098FB74  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8098FB78  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8098FB90  3D 00 80 99 */	lis r8, lit_3884@ha /* 0x80991978@ha */
/* 8098FB94  C0 28 19 78 */	lfs f1, lit_3884@l(r8)  /* 0x80991978@l */
/* 8098FB98  FC 40 08 90 */	fmr f2, f1
/* 8098FB9C  3D 00 80 99 */	lis r8, lit_4627@ha /* 0x809919A4@ha */
/* 8098FBA0  C0 68 19 A4 */	lfs f3, lit_4627@l(r8)  /* 0x809919A4@l */
/* 8098FBA4  FC 80 18 90 */	fmr f4, f3
/* 8098FBA8  39 00 00 00 */	li r8, 0
/* 8098FBAC  4B 91 BD D9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 8098FBF4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8098FBF8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8098FC10  3D 00 80 99 */	lis r8, lit_3884@ha /* 0x80991978@ha */
/* 8098FC14  C0 28 19 78 */	lfs f1, lit_3884@l(r8)  /* 0x80991978@l */
/* 8098FC18  FC 40 08 90 */	fmr f2, f1
/* 8098FC1C  3D 00 80 99 */	lis r8, lit_4627@ha /* 0x809919A4@ha */
/* 8098FC20  C0 68 19 A4 */	lfs f3, lit_4627@l(r8)  /* 0x809919A4@l */
/* 8098FC24  FC 80 18 90 */	fmr f4, f3
/* 8098FC28  39 00 00 00 */	li r8, 0
/* 8098FC2C  4B 91 BD 59 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 8098FC4C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8098FC50  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8098FC68  3D 00 80 99 */	lis r8, lit_3884@ha /* 0x80991978@ha */
/* 8098FC6C  C0 28 19 78 */	lfs f1, lit_3884@l(r8)  /* 0x80991978@l */
/* 8098FC70  FC 40 08 90 */	fmr f2, f1
/* 8098FC74  3D 00 80 99 */	lis r8, lit_4627@ha /* 0x809919A4@ha */
/* 8098FC78  C0 68 19 A4 */	lfs f3, lit_4627@l(r8)  /* 0x809919A4@l */
/* 8098FC7C  FC 80 18 90 */	fmr f4, f3
/* 8098FC80  39 00 00 00 */	li r8, 0
/* 8098FC84  4B 91 BD 01 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8098FC88  48 00 00 48 */	b lbl_8098FCD0
lbl_8098FC8C:
/* 8098FC8C  38 00 00 88 */	li r0, 0x88
/* 8098FC90  90 01 00 08 */	stw r0, 8(r1)
/* 8098FC94  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8098FC98  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8098FCB0  3D 00 80 99 */	lis r8, lit_3884@ha /* 0x80991978@ha */
/* 8098FCB4  C0 28 19 78 */	lfs f1, lit_3884@l(r8)  /* 0x80991978@l */
/* 8098FCB8  FC 40 08 90 */	fmr f2, f1
/* 8098FCBC  3D 00 80 99 */	lis r8, lit_4627@ha /* 0x809919A4@ha */
/* 8098FCC0  C0 68 19 A4 */	lfs f3, lit_4627@l(r8)  /* 0x809919A4@l */
/* 8098FCC4  FC 80 18 90 */	fmr f4, f3
/* 8098FCC8  39 00 00 00 */	li r8, 0
/* 8098FCCC  4B 91 BC B9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8098FCD0:
...
/* 8098FD24  4B 9D 25 05 */	bl _restgpr_29
