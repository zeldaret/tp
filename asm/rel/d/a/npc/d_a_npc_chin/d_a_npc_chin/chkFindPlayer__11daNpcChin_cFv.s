...
/* 8098EA10  4B 9D 37 CD */	bl _savegpr_29
/* 8098EA14  7C 7D 1B 78 */	mr r29, r3
/* 8098EA18  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8098EA1C  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8098EA20  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8098EA24  3C A0 80 99 */	lis r5, m__17daNpcChin_Param_c@ha /* 0x8099190C@ha */
/* 8098EA28  38 A5 19 0C */	addi r5, r5, m__17daNpcChin_Param_c@l /* 0x8099190C@l */
/* 8098EA2C  C0 25 00 50 */	lfs f1, 0x50(r5)
/* 8098EA30  4B 7C 4F C1 */	bl chkActorInSight__8daNpcF_cFP10fopAc_ac_cf
/* 8098EA34  2C 03 00 00 */	cmpwi r3, 0
/* 8098EA38  40 82 00 14 */	bne lbl_8098EA4C
/* 8098EA3C  38 7D 0E 70 */	addi r3, r29, 0xe70
/* 8098EA40  4B 7C 1C A1 */	bl remove__18daNpcF_ActorMngr_cFv
/* 8098EA44  38 60 00 00 */	li r3, 0
/* 8098EA48  48 00 00 6C */	b lbl_8098EAB4
lbl_8098EA4C:
/* 8098EA4C  38 7D 0E 70 */	addi r3, r29, 0xe70
/* 8098EA50  4B 7C 1C 9D */	bl getActorP__18daNpcF_ActorMngr_cFv
...
/* 8098EA6C  4B 7C 51 71 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 8098EA88  4B 7C 51 55 */	bl chkActorInAttnArea__8daNpcF_cFP10fopAc_ac_cP10fopAc_ac_ci
...
/* 8098EAA0  4B 7C 1C 1D */	bl entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
/* 8098EAA4  48 00 00 0C */	b lbl_8098EAB0
lbl_8098EAA8:
/* 8098EAA8  38 7D 0E 70 */	addi r3, r29, 0xe70
/* 8098EAAC  4B 7C 1C 35 */	bl remove__18daNpcF_ActorMngr_cFv
lbl_8098EAB0:
/* 8098EAB0  7F C3 F3 78 */	mr r3, r30
lbl_8098EAB4:
/* 8098EAB4  39 61 00 20 */	addi r11, r1, 0x20
/* 8098EAB8  4B 9D 37 71 */	bl _restgpr_29
