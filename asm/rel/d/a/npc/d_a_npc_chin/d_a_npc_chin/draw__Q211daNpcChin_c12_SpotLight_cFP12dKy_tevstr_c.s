...
/* 8098C088  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8098C08C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8098C090  38 80 00 00 */	li r4, 0
/* 8098C094  38 BE 00 1C */	addi r5, r30, 0x1c
/* 8098C098  7F E6 FB 78 */	mr r6, r31
/* 8098C09C  4B 81 77 28 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8098C0A0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8098C0A4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8098C0A8  80 9E 00 00 */	lwz r4, 0(r30)
/* 8098C0AC  80 84 00 04 */	lwz r4, 4(r4)
/* 8098C0B0  7F E5 FB 78 */	mr r5, r31
/* 8098C0B4  4B 81 8C EC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8098C0CC  4B 68 16 0C */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 8098C0D0  80 7E 00 00 */	lwz r3, 0(r30)
/* 8098C0D4  4B 68 1B F0 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8098C0E8  4B 9A 36 CC */	b removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_8098C0EC:
