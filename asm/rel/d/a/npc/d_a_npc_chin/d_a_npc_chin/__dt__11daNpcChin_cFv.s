...
/* 8098C2E8  4B 9D 5E EC */	b _savegpr_27
/* 8098C2EC  7C 7E 1B 79 */	or. r30, r3, r3
/* 8098C2F0  7C 9F 23 78 */	mr r31, r4
/* 8098C2F4  41 82 02 00 */	beq lbl_8098C4F4
/* 8098C2F8  3C 60 80 99 */	lis r3, __vt__11daNpcChin_c@ha
/* 8098C2FC  38 03 23 38 */	addi r0, r3, __vt__11daNpcChin_c@l
...
/* 8098C314  4B 6A 34 88 */	b dComIfG_TimerDeleteRequest__Fi
lbl_8098C318:
/* 8098C318  88 1E 09 F4 */	lbz r0, 0x9f4(r30)
/* 8098C31C  54 00 10 3A */	slwi r0, r0, 2
/* 8098C320  3C 60 80 99 */	lis r3, sLoadResInfo@ha
/* 8098C324  38 63 20 C0 */	addi r3, r3, sLoadResInfo@l
/* 8098C328  7F 63 00 2E */	lwzx r27, r3, r0
/* 8098C32C  3B A0 00 00 */	li r29, 0
/* 8098C330  3C 60 80 99 */	lis r3, l_arcNames@ha
/* 8098C334  3B 83 20 A8 */	addi r28, r3, l_arcNames@l
...
/* 8098C34C  4B 6A 0C BC */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 8098C374  4B 68 4F 9C */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_8098C378:
/* 8098C378  38 7E 0E 70 */	addi r3, r30, 0xe70
/* 8098C37C  3C 80 80 99 */	lis r4, __dt__18daNpcF_ActorMngr_cFv@ha
/* 8098C380  38 84 0E CC */	addi r4, r4, __dt__18daNpcF_ActorMngr_cFv@l
/* 8098C384  38 A0 00 08 */	li r5, 8
/* 8098C388  38 C0 00 01 */	li r6, 1
/* 8098C38C  4B 9D 59 5C */	b __destroy_arr
...
/* 8098C3AC  3C 60 80 99 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8098C3B0  38 03 23 D4 */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 8098C3B4  90 1E 0E 34 */	stw r0, 0xe34(r30)
lbl_8098C3B8:
/* 8098C3B8  34 1E 0C 7C */	addic. r0, r30, 0xc7c
/* 8098C3BC  41 82 00 84 */	beq lbl_8098C440
/* 8098C3C0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 8098C3C4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 8098C3E4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 8098C3E8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 8098C400  3C 60 80 99 */	lis r3, __vt__8cM3dGCyl@ha
/* 8098C404  38 03 23 E0 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 8098C408  90 1E 0D B4 */	stw r0, 0xdb4(r30)
lbl_8098C40C:
/* 8098C40C  34 1E 0D 80 */	addic. r0, r30, 0xd80
/* 8098C410  41 82 00 24 */	beq lbl_8098C434
/* 8098C414  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 8098C418  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 8098C41C  90 1E 0D 9C */	stw r0, 0xd9c(r30)
/* 8098C420  34 1E 0D 80 */	addic. r0, r30, 0xd80
/* 8098C424  41 82 00 10 */	beq lbl_8098C434
/* 8098C428  3C 60 80 99 */	lis r3, __vt__8cM3dGAab@ha
/* 8098C42C  38 03 23 EC */	addi r0, r3, __vt__8cM3dGAab@l
/* 8098C430  90 1E 0D 98 */	stw r0, 0xd98(r30)
lbl_8098C434:
/* 8098C434  38 7E 0C 7C */	addi r3, r30, 0xc7c
/* 8098C438  38 80 00 00 */	li r4, 0
/* 8098C43C  4B 6F 7C A8 */	b __dt__12dCcD_GObjInfFv
lbl_8098C440:
/* 8098C440  34 1E 0B DC */	addic. r0, r30, 0xbdc
/* 8098C444  41 82 00 88 */	beq lbl_8098C4CC
/* 8098C448  3C 60 80 99 */	lis r3, __vt__15daNpcF_Lookat_c@ha
/* 8098C44C  38 03 23 F8 */	addi r0, r3, __vt__15daNpcF_Lookat_c@l
/* 8098C450  90 1E 0C 74 */	stw r0, 0xc74(r30)
/* 8098C454  38 7E 0C 58 */	addi r3, r30, 0xc58
/* 8098C458  3C 80 80 99 */	lis r4, __dt__5csXyzFv@ha
/* 8098C45C  38 84 10 20 */	addi r4, r4, __dt__5csXyzFv@l
/* 8098C460  38 A0 00 06 */	li r5, 6
/* 8098C464  38 C0 00 04 */	li r6, 4
/* 8098C468  4B 9D 58 80 */	b __destroy_arr
/* 8098C46C  38 7E 0C 40 */	addi r3, r30, 0xc40
/* 8098C470  3C 80 80 99 */	lis r4, __dt__5csXyzFv@ha
/* 8098C474  38 84 10 20 */	addi r4, r4, __dt__5csXyzFv@l
/* 8098C478  38 A0 00 06 */	li r5, 6
/* 8098C47C  38 C0 00 04 */	li r6, 4
/* 8098C480  4B 9D 58 68 */	b __destroy_arr
/* 8098C484  38 7E 0C 28 */	addi r3, r30, 0xc28
/* 8098C488  3C 80 80 99 */	lis r4, __dt__5csXyzFv@ha
/* 8098C48C  38 84 10 20 */	addi r4, r4, __dt__5csXyzFv@l
/* 8098C490  38 A0 00 06 */	li r5, 6
/* 8098C494  38 C0 00 04 */	li r6, 4
/* 8098C498  4B 9D 58 50 */	b __destroy_arr
/* 8098C49C  38 7E 0C 10 */	addi r3, r30, 0xc10
/* 8098C4A0  3C 80 80 99 */	lis r4, __dt__5csXyzFv@ha
/* 8098C4A4  38 84 10 20 */	addi r4, r4, __dt__5csXyzFv@l
/* 8098C4A8  38 A0 00 06 */	li r5, 6
/* 8098C4AC  38 C0 00 04 */	li r6, 4
/* 8098C4B0  4B 9D 58 38 */	b __destroy_arr
/* 8098C4B4  38 7E 0B DC */	addi r3, r30, 0xbdc
/* 8098C4B8  3C 80 80 99 */	lis r4, __dt__4cXyzFv@ha
/* 8098C4BC  38 84 10 60 */	addi r4, r4, __dt__4cXyzFv@l
/* 8098C4C0  38 A0 00 0C */	li r5, 0xc
/* 8098C4C4  38 C0 00 04 */	li r6, 4
/* 8098C4C8  4B 9D 58 20 */	b __destroy_arr
lbl_8098C4CC:
/* 8098C4CC  38 7E 0B 48 */	addi r3, r30, 0xb48
/* 8098C4D0  38 80 FF FF */	li r4, -1
/* 8098C4D4  4B 93 3F 4C */	b __dt__10Z2CreatureFv
