...
/* 80B4B828  4B 60 03 C9 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80B4B864  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B4B868  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B4B86C  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 80B4B870  4B 4C EE A1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80B4B898  4B 60 03 E1 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
/* 80B4B89C  2C 03 00 00 */	cmpwi r3, 0
/* 80B4B8A0  41 82 00 30 */	beq lbl_80B4B8D0
/* 80B4B8A4  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 80B4B8A8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B4B8AC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B4B8B0  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80B4B8B4  4B 5F 9E 2D */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80B4B8B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80B4B8BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80B4B8C0  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80B4B8C4  4B 4F 6B A5 */	bl reset__14dEvt_control_cFv
...
/* 80B4B8E0  4B 5F 9E 1D */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B4B8E4  38 00 00 00 */	li r0, 0
/* 80B4B8E8  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B4B8EC  3C 60 80 B5 */	lis r3, lit_4193@ha /* 0x80B4CE48@ha */
/* 80B4B8F0  C0 03 CE 48 */	lfs f0, lit_4193@l(r3)  /* 0x80B4CE48@l */
...
/* 80B4B928  4B 5F 9D D5 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B4B92C  38 00 00 00 */	li r0, 0
/* 80B4B930  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B4B934  3C 60 80 B5 */	lis r3, lit_4193@ha /* 0x80B4CE48@ha */
/* 80B4B938  C0 03 CE 48 */	lfs f0, lit_4193@l(r3)  /* 0x80B4CE48@l */
...
/* 80B4B964  4B 5F 9D 99 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80B4B968  38 00 00 00 */	li r0, 0
/* 80B4B96C  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B4B970  3C 60 80 B5 */	lis r3, lit_4193@ha /* 0x80B4CE48@ha */
/* 80B4B974  C0 03 CE 48 */	lfs f0, lit_4193@l(r3)  /* 0x80B4CE48@l */
...
/* 80B4B998  4B 4C ED 79 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80B4B9B4  4B 5F FC 95 */	bl step__8daNpcT_cFsiiii
