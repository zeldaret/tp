...
/* 80B4A934  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B4A938  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B4A93C  4B 4C 1A F9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80B4A940  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B4A944  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B4A948  A8 1F 0D 0E */	lha r0, 0xd0e(r31)
/* 80B4A94C  7C 00 00 D0 */	neg r0, r0
/* 80B4A950  7C 04 07 34 */	extsh r4, r0
/* 80B4A954  4B 4C 1B 79 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80B4A958  48 00 00 34 */	b lbl_80B4A98C
lbl_80B4A95C:
/* 80B4A95C  2C 04 00 04 */	cmpwi r4, 4
/* 80B4A960  40 82 00 2C */	bne lbl_80B4A98C
/* 80B4A964  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B4A968  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B4A96C  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80B4A970  7C 00 00 D0 */	neg r0, r0
/* 80B4A974  7C 04 07 34 */	extsh r4, r0
/* 80B4A978  4B 4C 1A BD */	bl mDoMtx_YrotM__FPA4_fs
/* 80B4A97C  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80B4A980  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80B4A984  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80B4A988  4B 4C 1B 45 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80B4A98C:
