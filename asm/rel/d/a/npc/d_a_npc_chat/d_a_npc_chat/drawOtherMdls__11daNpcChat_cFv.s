...
/* 809835E8  4B 9D EB F1 */	bl _savegpr_28
/* 809835EC  7C 7D 1B 78 */	mr r29, r3
/* 809835F0  3C 80 80 98 */	lis r4, cNullVec__6Z2Calc@ha /* 0x8098795C@ha */
/* 809835F4  3B E4 79 5C */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x8098795C@l */
...
/* 8098360C  3C 60 80 98 */	lis r3, a_jntNumTbl@ha /* 0x80986F64@ha */
/* 80983610  38 03 6F 64 */	addi r0, r3, a_jntNumTbl@l /* 0x80986F64@l */
...
/* 80983680  4B 6A C3 D5 */	bl dComIfGs_wolfeye_effect_check__Fv
...
/* 809836CC  4B 9D E9 7D */	bl __ptmf_cmpr
/* 809836D0  2C 03 00 00 */	cmpwi r3, 0
/* 809836D4  41 82 00 B0 */	beq lbl_80983784
/* 809836D8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 809836DC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 809836E0  80 9D 0B F0 */	lwz r4, 0xbf0(r29)
/* 809836E4  80 84 00 04 */	lwz r4, 4(r4)
/* 809836E8  38 BD 01 0C */	addi r5, r29, 0x10c
/* 809836EC  4B 82 16 B5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80983708  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8098370C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80983710  4B 9C 2D A1 */	bl PSMTXCopy
/* 80983714  FC 20 F8 90 */	fmr f1, f31
/* 80983718  FC 40 F8 90 */	fmr f2, f31
/* 8098371C  FC 60 F8 90 */	fmr f3, f31
/* 80983720  4B 68 97 19 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80983724  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80983728  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8098372C  80 9D 0B F0 */	lwz r4, 0xbf0(r29)
/* 80983730  38 84 00 24 */	addi r4, r4, 0x24
/* 80983734  4B 9C 2D 7D */	bl PSMTXCopy
/* 80983738  80 7D 0B F0 */	lwz r3, 0xbf0(r29)
/* 8098373C  4B 68 A5 89 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80983768  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8098376C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80983770  80 84 00 04 */	lwz r4, 4(r4)
/* 80983774  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80983778  4B 82 16 29 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8098377C  80 7D 0B F0 */	lwz r3, 0xbf0(r29)
/* 80983780  4B 68 A5 45 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80983784:
/* 80983784  E3 E1 00 38 */	psq_l f31, 56(r1), 0, 0 /* qr0 */
/* 80983788  CB E1 00 30 */	lfd f31, 0x30(r1)
/* 8098378C  39 61 00 30 */	addi r11, r1, 0x30
/* 80983790  4B 9D EA 95 */	bl _restgpr_28
