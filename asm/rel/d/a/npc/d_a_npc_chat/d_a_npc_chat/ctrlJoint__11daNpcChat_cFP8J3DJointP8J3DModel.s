...
/* 809827A0  3C 80 80 98 */	lis r4, lit_4766@ha /* 0x80986F24@ha */
/* 809827A4  C0 24 6F 24 */	lfs f1, lit_4766@l(r4)  /* 0x80986F24@l */
/* 809827A8  2C 00 00 10 */	cmpwi r0, 0x10
/* 809827AC  40 80 00 24 */	bge lbl_809827D0
/* 809827B0  3C 80 80 99 */	lis r4, a_jntTbl_M@ha /* 0x80988114@ha */
/* 809827B4  38 A4 81 14 */	addi r5, r4, a_jntTbl_M@l /* 0x80988114@l */
...
lbl_809827D0:
/* 809827D0  3C 80 80 99 */	lis r4, a_jntTbl_W@ha /* 0x80989CD4@ha */
/* 809827D4  38 A4 9C D4 */	addi r5, r4, a_jntTbl_W@l /* 0x80989CD4@l */
...
/* 809827F0  3C 80 80 98 */	lis r4, lit_4766@ha /* 0x80986F24@ha */
/* 809827F4  C0 24 6F 24 */	lfs f1, lit_4766@l(r4)  /* 0x80986F24@l */
/* 809827F8  2C 00 00 10 */	cmpwi r0, 0x10
/* 809827FC  40 80 00 24 */	bge lbl_80982820
/* 80982800  3C 80 80 99 */	lis r4, a_jntTbl_M@ha /* 0x80988114@ha */
/* 80982804  38 A4 81 14 */	addi r5, r4, a_jntTbl_M@l /* 0x80988114@l */
...
lbl_80982820:
/* 80982820  3C 80 80 99 */	lis r4, a_jntTbl_W@ha /* 0x80989CD4@ha */
/* 80982824  38 A4 9C D4 */	addi r5, r4, a_jntTbl_W@l /* 0x80989CD4@l */
...
/* 80982840  3C 80 80 98 */	lis r4, lit_4766@ha /* 0x80986F24@ha */
/* 80982844  C0 24 6F 24 */	lfs f1, lit_4766@l(r4)  /* 0x80986F24@l */
/* 80982848  2C 00 00 10 */	cmpwi r0, 0x10
/* 8098284C  40 80 00 20 */	bge lbl_8098286C
/* 80982850  1C A0 01 7C */	mulli r5, r0, 0x17c
/* 80982854  3C 80 80 99 */	lis r4, a_jntTbl_M@ha /* 0x80988114@ha */
/* 80982858  38 04 81 14 */	addi r0, r4, a_jntTbl_M@l /* 0x80988114@l */
...
lbl_8098286C:
/* 8098286C  3C 80 80 99 */	lis r4, a_jntTbl_W@ha /* 0x80989CD4@ha */
/* 80982870  38 84 9C D4 */	addi r4, r4, a_jntTbl_W@l /* 0x80989CD4@l */
...
/* 8098289C  3C 60 80 98 */	lis r3, lit_5146@ha /* 0x80986F5C@ha */
/* 809828A0  C0 43 6F 5C */	lfs f2, lit_5146@l(r3)  /* 0x80986F5C@l */
/* 809828A4  2C 00 00 10 */	cmpwi r0, 0x10
/* 809828A8  40 80 00 24 */	bge lbl_809828CC
/* 809828AC  3C 60 80 99 */	lis r3, a_jntTbl_M@ha /* 0x80988114@ha */
/* 809828B0  38 83 81 14 */	addi r4, r3, a_jntTbl_M@l /* 0x80988114@l */
...
lbl_809828CC:
/* 809828CC  3C 60 80 99 */	lis r3, a_jntTbl_W@ha /* 0x80989CD4@ha */
/* 809828D0  38 83 9C D4 */	addi r4, r3, a_jntTbl_W@l /* 0x80989CD4@l */
...
/* 809828EC  3C 60 80 98 */	lis r3, lit_4768@ha /* 0x80986F2C@ha */
/* 809828F0  C8 23 6F 2C */	lfd f1, lit_4768@l(r3)  /* 0x80986F2C@l */
...
/* 8098291C  3C 60 80 98 */	lis r3, lit_5146@ha /* 0x80986F5C@ha */
/* 80982920  C0 43 6F 5C */	lfs f2, lit_5146@l(r3)  /* 0x80986F5C@l */
/* 80982924  2C 00 00 10 */	cmpwi r0, 0x10
/* 80982928  40 80 00 24 */	bge lbl_8098294C
/* 8098292C  3C 60 80 99 */	lis r3, a_jntTbl_M@ha /* 0x80988114@ha */
/* 80982930  38 83 81 14 */	addi r4, r3, a_jntTbl_M@l /* 0x80988114@l */
...
lbl_8098294C:
/* 8098294C  3C 60 80 99 */	lis r3, a_jntTbl_W@ha /* 0x80989CD4@ha */
/* 80982950  38 83 9C D4 */	addi r4, r3, a_jntTbl_W@l /* 0x80989CD4@l */
...
/* 8098296C  3C 60 80 98 */	lis r3, lit_4768@ha /* 0x80986F2C@ha */
/* 80982970  C8 23 6F 2C */	lfd f1, lit_4768@l(r3)  /* 0x80986F2C@l */
...
/* 8098299C  3C 60 80 98 */	lis r3, lit_5146@ha /* 0x80986F5C@ha */
/* 809829A0  C0 43 6F 5C */	lfs f2, lit_5146@l(r3)  /* 0x80986F5C@l */
/* 809829A4  2C 00 00 10 */	cmpwi r0, 0x10
/* 809829A8  40 80 00 24 */	bge lbl_809829CC
/* 809829AC  3C 60 80 99 */	lis r3, a_jntTbl_M@ha /* 0x80988114@ha */
/* 809829B0  38 63 81 14 */	addi r3, r3, a_jntTbl_M@l /* 0x80988114@l */
...
lbl_809829CC:
/* 809829CC  3C 60 80 99 */	lis r3, a_jntTbl_W@ha /* 0x80989CD4@ha */
/* 809829D0  38 63 9C D4 */	addi r3, r3, a_jntTbl_W@l /* 0x80989CD4@l */
...
/* 809829EC  3C 60 80 98 */	lis r3, lit_4768@ha /* 0x80986F2C@ha */
/* 809829F0  C8 23 6F 2C */	lfd f1, lit_4768@l(r3)  /* 0x80986F2C@l */
...
/* 80982A20  4B 8E 49 D5 */	bl __ct__5csXyzFsss
...
/* 80982A34  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80982A38  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80982A3C  4B 9C 3A 75 */	bl PSMTXCopy
/* 80982A40  38 61 00 08 */	addi r3, r1, 8
/* 80982A44  4B 68 A5 01 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80982A48  38 61 00 10 */	addi r3, r1, 0x10
/* 80982A4C  4B 68 A3 89 */	bl transM__14mDoMtx_stack_cFRC4cXyz
/* 80982A50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80982A54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80982A58  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80982A5C  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80982A60  7C 80 FA 14 */	add r4, r0, r31
/* 80982A64  4B 9C 3A 4D */	bl PSMTXCopy
/* 80982A68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80982A6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80982A70  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80982A74  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80982A78  4B 9C 3A 39 */	bl PSMTXCopy
