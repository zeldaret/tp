...
/* 80A229AC  3C 80 80 A2 */	lis r4, l_bckGetParamList@ha /* 0x80A25B44@ha */
/* 80A229B0  38 A4 5B 44 */	addi r5, r4, l_bckGetParamList@l /* 0x80A25B44@l */
/* 80A229B4  7C 85 F2 14 */	add r4, r5, r30
/* 80A229B8  80 04 00 08 */	lwz r0, 8(r4)
/* 80A229BC  54 00 10 3A */	slwi r0, r0, 2
/* 80A229C0  3C 80 80 A2 */	lis r4, l_arcNames@ha /* 0x80A25C10@ha */
/* 80A229C4  38 84 5C 10 */	addi r4, r4, l_arcNames@l /* 0x80A25C10@l */
/* 80A229C8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80A229CC  7C A5 F0 2E */	lwzx r5, r5, r30
/* 80A229D0  4B 73 01 5D */	bl getTrnsfrmKeyAnmP__8daNpcF_cFPci
/* 80A229D4  7C 64 1B 79 */	or. r4, r3, r3
/* 80A229D8  3C 60 80 A2 */	lis r3, l_bckGetParamList@ha /* 0x80A25B44@ha */
/* 80A229DC  38 03 5B 44 */	addi r0, r3, l_bckGetParamList@l /* 0x80A25B44@l */
...
/* 80A22A00  3C C0 80 A2 */	lis r6, lit_4247@ha /* 0x80A2593C@ha */
/* 80A22A04  C0 26 59 3C */	lfs f1, lit_4247@l(r6)  /* 0x80A2593C@l */
/* 80A22A08  FC 40 F8 90 */	fmr f2, f31
/* 80A22A0C  38 C0 00 00 */	li r6, 0
/* 80A22A10  38 E0 FF FF */	li r7, -1
/* 80A22A14  4B 73 02 09 */	bl setMcaMorfAnm__8daNpcF_cFP18J3DAnmTransformKeyffiii
