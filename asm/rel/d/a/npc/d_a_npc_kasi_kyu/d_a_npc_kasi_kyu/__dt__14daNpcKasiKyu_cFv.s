...
/* 80A21C24  4B 94 05 AD */	bl _savegpr_26
/* 80A21C28  7C 7E 1B 79 */	or. r30, r3, r3
/* 80A21C2C  7C 9F 23 78 */	mr r31, r4
/* 80A21C30  41 82 01 D8 */	beq lbl_80A21E08
/* 80A21C34  3C 60 80 A2 */	lis r3, __vt__14daNpcKasiKyu_c@ha /* 0x80A25F14@ha */
/* 80A21C38  38 03 5F 14 */	addi r0, r3, __vt__14daNpcKasiKyu_c@l /* 0x80A25F14@l */
...
/* 80A21C4C  3C 60 80 A2 */	lis r3, l_arcNames@ha /* 0x80A25C10@ha */
/* 80A21C50  3B 63 5C 10 */	addi r27, r3, l_arcNames@l /* 0x80A25C10@l */
lbl_80A21C54:
/* 80A21C54  38 7C 14 14 */	addi r3, r28, 0x1414
/* 80A21C58  7C 7E 1A 14 */	add r3, r30, r3
/* 80A21C5C  7C 9B E8 2E */	lwzx r4, r27, r29
/* 80A21C60  4B 60 B3 A9 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80A21C88  4B 5E F6 89 */	bl stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80A21C8C:
/* 80A21C8C  34 1E 12 C8 */	addic. r0, r30, 0x12c8
/* 80A21C90  41 82 00 84 */	beq lbl_80A21D14
/* 80A21C94  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80A21C98  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80A21CB8  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80A21CBC  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80A21CD4  3C 60 80 A2 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80A25FBC@ha */
/* 80A21CD8  38 03 5F BC */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80A25FBC@l */
/* 80A21CDC  90 1E 14 00 */	stw r0, 0x1400(r30)
lbl_80A21CE0:
/* 80A21CE0  34 1E 13 CC */	addic. r0, r30, 0x13cc
/* 80A21CE4  41 82 00 24 */	beq lbl_80A21D08
/* 80A21CE8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80A21CEC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80A21CF0  90 1E 13 E8 */	stw r0, 0x13e8(r30)
/* 80A21CF4  34 1E 13 CC */	addic. r0, r30, 0x13cc
/* 80A21CF8  41 82 00 10 */	beq lbl_80A21D08
/* 80A21CFC  3C 60 80 A2 */	lis r3, __vt__8cM3dGAab@ha /* 0x80A25FC8@ha */
/* 80A21D00  38 03 5F C8 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80A25FC8@l */
/* 80A21D04  90 1E 13 E4 */	stw r0, 0x13e4(r30)
lbl_80A21D08:
/* 80A21D08  38 7E 12 C8 */	addi r3, r30, 0x12c8
/* 80A21D0C  38 80 00 00 */	li r4, 0
/* 80A21D10  4B 66 23 D5 */	bl __dt__12dCcD_GObjInfFv
lbl_80A21D14:
/* 80A21D14  34 1E 0C 94 */	addic. r0, r30, 0xc94
/* 80A21D18  41 82 00 24 */	beq lbl_80A21D3C
/* 80A21D1C  3C 60 80 A2 */	lis r3, __vt__13daNpcF_Path_c@ha /* 0x80A25FE0@ha */
/* 80A21D20  38 03 5F E0 */	addi r0, r3, __vt__13daNpcF_Path_c@l /* 0x80A25FE0@l */
/* 80A21D24  90 1E 12 C0 */	stw r0, 0x12c0(r30)
/* 80A21D28  34 1E 0C B4 */	addic. r0, r30, 0xcb4
/* 80A21D2C  41 82 00 10 */	beq lbl_80A21D3C
/* 80A21D30  3C 60 80 A2 */	lis r3, __vt__16daNpcF_SPCurve_c@ha /* 0x80A25FD4@ha */
/* 80A21D34  38 03 5F D4 */	addi r0, r3, __vt__16daNpcF_SPCurve_c@l /* 0x80A25FD4@l */
/* 80A21D38  90 1E 12 BC */	stw r0, 0x12bc(r30)
lbl_80A21D3C:
/* 80A21D3C  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 80A21D40  3C 80 80 A2 */	lis r4, __dt__18daNpcF_ActorMngr_cFv@ha /* 0x80A24FE0@ha */
/* 80A21D44  38 84 4F E0 */	addi r4, r4, __dt__18daNpcF_ActorMngr_cFv@l /* 0x80A24FE0@l */
/* 80A21D48  38 A0 00 08 */	li r5, 8
/* 80A21D4C  38 C0 00 01 */	li r6, 1
/* 80A21D50  4B 93 FF 99 */	bl __destroy_arr
/* 80A21D54  34 1E 0B F0 */	addic. r0, r30, 0xbf0
/* 80A21D58  41 82 00 88 */	beq lbl_80A21DE0
/* 80A21D5C  3C 60 80 A2 */	lis r3, __vt__15daNpcF_Lookat_c@ha /* 0x80A25FEC@ha */
/* 80A21D60  38 03 5F EC */	addi r0, r3, __vt__15daNpcF_Lookat_c@l /* 0x80A25FEC@l */
/* 80A21D64  90 1E 0C 88 */	stw r0, 0xc88(r30)
/* 80A21D68  38 7E 0C 6C */	addi r3, r30, 0xc6c
/* 80A21D6C  3C 80 80 A2 */	lis r4, __dt__5csXyzFv@ha /* 0x80A25134@ha */
/* 80A21D70  38 84 51 34 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A25134@l */
/* 80A21D74  38 A0 00 06 */	li r5, 6
/* 80A21D78  38 C0 00 04 */	li r6, 4
/* 80A21D7C  4B 93 FF 6D */	bl __destroy_arr
/* 80A21D80  38 7E 0C 54 */	addi r3, r30, 0xc54
/* 80A21D84  3C 80 80 A2 */	lis r4, __dt__5csXyzFv@ha /* 0x80A25134@ha */
/* 80A21D88  38 84 51 34 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A25134@l */
/* 80A21D8C  38 A0 00 06 */	li r5, 6
/* 80A21D90  38 C0 00 04 */	li r6, 4
/* 80A21D94  4B 93 FF 55 */	bl __destroy_arr
/* 80A21D98  38 7E 0C 3C */	addi r3, r30, 0xc3c
/* 80A21D9C  3C 80 80 A2 */	lis r4, __dt__5csXyzFv@ha /* 0x80A25134@ha */
/* 80A21DA0  38 84 51 34 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A25134@l */
/* 80A21DA4  38 A0 00 06 */	li r5, 6
/* 80A21DA8  38 C0 00 04 */	li r6, 4
/* 80A21DAC  4B 93 FF 3D */	bl __destroy_arr
/* 80A21DB0  38 7E 0C 24 */	addi r3, r30, 0xc24
/* 80A21DB4  3C 80 80 A2 */	lis r4, __dt__5csXyzFv@ha /* 0x80A25134@ha */
/* 80A21DB8  38 84 51 34 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80A25134@l */
/* 80A21DBC  38 A0 00 06 */	li r5, 6
/* 80A21DC0  38 C0 00 04 */	li r6, 4
/* 80A21DC4  4B 93 FF 25 */	bl __destroy_arr
/* 80A21DC8  38 7E 0B F0 */	addi r3, r30, 0xbf0
/* 80A21DCC  3C 80 80 A2 */	lis r4, __dt__4cXyzFv@ha /* 0x80A25174@ha */
/* 80A21DD0  38 84 51 74 */	addi r4, r4, __dt__4cXyzFv@l /* 0x80A25174@l */
/* 80A21DD4  38 A0 00 0C */	li r5, 0xc
/* 80A21DD8  38 C0 00 04 */	li r6, 4
/* 80A21DDC  4B 93 FF 0D */	bl __destroy_arr
lbl_80A21DE0:
/* 80A21DE0  38 7E 0B 48 */	addi r3, r30, 0xb48
/* 80A21DE4  38 80 FF FF */	li r4, -1
/* 80A21DE8  4B 89 EE 85 */	bl __dt__17Z2CreatureCitizenFv
...
/* 80A21E04  4B 8A CF 39 */	bl __dl__FPv
lbl_80A21E08:
/* 80A21E08  7F C3 F3 78 */	mr r3, r30
/* 80A21E0C  39 61 00 20 */	addi r11, r1, 0x20
/* 80A21E10  4B 94 04 0D */	bl _restgpr_26
