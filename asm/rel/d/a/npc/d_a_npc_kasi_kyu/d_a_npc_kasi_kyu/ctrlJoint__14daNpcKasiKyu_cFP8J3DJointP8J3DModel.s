...
/* 80A222E0  4B 93 FE F9 */	bl _savegpr_28
...
/* 80A222F4  3C 60 80 A2 */	lis r3, lit_4270@ha /* 0x80A25948@ha */
/* 80A222F8  38 83 59 48 */	addi r4, r3, lit_4270@l /* 0x80A25948@l */
...
/* 80A22330  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A22334  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A22338  4B 92 41 79 */	bl PSMTXCopy
/* 80A2233C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A22340  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80A22374  4B 92 41 3D */	bl PSMTXCopy
...
/* 80A223A4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A223A8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A223AC  4B 92 41 05 */	bl PSMTXCopy
...
/* 80A223D8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A223DC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A223E0  4B 92 40 D1 */	bl PSMTXCopy
...
/* 80A22404  3C C0 80 A2 */	lis r6, m__20daNpcKasiKyu_Param_c@ha /* 0x80A258B8@ha */
/* 80A22408  38 C6 58 B8 */	addi r6, r6, m__20daNpcKasiKyu_Param_c@l /* 0x80A258B8@l */
/* 80A2240C  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80A22410  4B 73 0F 6D */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80A22414:
/* 80A22414  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A22418  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A2241C  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80A22420  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80A22424  7C 80 E2 14 */	add r4, r0, r28
/* 80A22428  4B 92 40 89 */	bl PSMTXCopy
/* 80A2242C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80A22430  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80A22434  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80A22438  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80A2243C  4B 92 40 75 */	bl PSMTXCopy
/* 80A22440  38 60 00 01 */	li r3, 1
/* 80A22444  39 61 00 30 */	addi r11, r1, 0x30
/* 80A22448  4B 93 FD DD */	bl _restgpr_28
