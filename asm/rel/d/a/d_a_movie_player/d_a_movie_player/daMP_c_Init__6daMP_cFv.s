...
/* 80878C4C  3C 60 80 94 */	lis r3, daMP_Fail_alloc@ha
/* 80878C50  90 03 5B 08 */	stw r0, daMP_Fail_alloc@l(r3)
...
/* 80878C70  3C 80 80 88 */	lis r4, stringBase0@ha
/* 80878C74  38 84 91 1C */	addi r4, r4, stringBase0@l
/* 80878C78  38 84 02 F9 */	addi r4, r4, 0x2f9
/* 80878C7C  7F C5 F3 78 */	mr r5, r30
/* 80878C80  4C C6 31 82 */	crclr 6
/* 80878C84  4B AE D8 58 */	b sprintf
...
/* 80878C9C  3C 60 80 94 */	lis r3, daMP_Fail_alloc@ha
/* 80878CA0  90 03 5B 08 */	stw r0, daMP_Fail_alloc@l(r3)
lbl_80878CA4:
/* 80878CA4  3C 60 80 88 */	lis r3, daMP_Get_MovieRestFrame__Fv@ha
/* 80878CA8  38 03 8A 6C */	addi r0, r3, daMP_Get_MovieRestFrame__Fv@l
/* 80878CAC  90 1F 05 68 */	stw r0, 0x568(r31)
/* 80878CB0  3C 60 80 88 */	lis r3, daMP_Set_PercentMovieVolume__Ff@ha
/* 80878CB4  38 03 8B 38 */	addi r0, r3, daMP_Set_PercentMovieVolume__Ff@l
/* 80878CB8  90 1F 05 6C */	stw r0, 0x56c(r31)
/* 80878CBC  3C 60 80 88 */	lis r3, daMP_THPPlayerGetTotalFrame__Fv@ha
/* 80878CC0  38 03 85 F8 */	addi r0, r3, daMP_THPPlayerGetTotalFrame__Fv@l
/* 80878CC4  90 1F 05 70 */	stw r0, 0x570(r31)
/* 80878CC8  3C 60 80 88 */	lis r3, daMP_THPPlayerPlay__Fv@ha
/* 80878CCC  38 03 82 E4 */	addi r0, r3, daMP_THPPlayerPlay__Fv@l
/* 80878CD0  90 1F 05 74 */	stw r0, 0x574(r31)
/* 80878CD4  3C 60 80 88 */	lis r3, daMP_THPPlayerStop__Fv@ha
/* 80878CD8  38 03 83 44 */	addi r0, r3, daMP_THPPlayerStop__Fv@l
/* 80878CDC  90 1F 05 78 */	stw r0, 0x578(r31)
/* 80878CE0  3C 60 80 88 */	lis r3, daMP_THPPlayerPause__Fv@ha
/* 80878CE4  38 03 83 FC */	addi r0, r3, daMP_THPPlayerPause__Fv@l
/* 80878CE8  90 1F 05 7C */	stw r0, 0x57c(r31)
/* 80878CEC  3C 60 80 45 */	lis r3, m_myObj__6daMP_c@ha
/* 80878CF0  93 E3 0D B8 */	stw r31, m_myObj__6daMP_c@l(r3)
