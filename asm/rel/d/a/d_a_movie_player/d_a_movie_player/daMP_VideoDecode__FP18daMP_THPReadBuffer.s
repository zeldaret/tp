...
/* 80875CB0  4B AE C5 19 */	bl _savegpr_24
/* 80875CB4  7C 78 1B 78 */	mr r24, r3
/* 80875CB8  80 83 00 00 */	lwz r4, 0(r3)
/* 80875CBC  3B 44 00 08 */	addi r26, r4, 8
/* 80875CC0  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha /* 0x80879BD0@ha */
/* 80875CC4  3B C3 9B D0 */	addi r30, r3, daMP_ActivePlayer@l /* 0x80879BD0@l */
...
/* 80875CE4  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha /* 0x80879BD0@ha */
/* 80875CE8  3B E3 9B D0 */	addi r31, r3, daMP_ActivePlayer@l /* 0x80879BD0@l */
...
/* 80875D28  3C 60 80 8E */	lis r3, daMP_First@ha /* 0x808E0510@ha */
/* 80875D2C  80 03 05 10 */	lwz r0, daMP_First@l(r3)  /* 0x808E0510@l */
...
/* 80875D44  3C 60 80 8E */	lis r3, daMP_First@ha /* 0x808E0510@ha */
/* 80875D48  90 03 05 10 */	stw r0, daMP_First@l(r3)  /* 0x808E0510@l */
lbl_80875D4C:
/* 80875D4C  3C 60 80 88 */	lis r3, daMP_VideoDecodeThread@ha /* 0x8087C1A0@ha */
/* 80875D50  38 63 C1 A0 */	addi r3, r3, daMP_VideoDecodeThread@l /* 0x8087C1A0@l */
/* 80875D54  4B AC BC E9 */	bl OSSuspendThread
lbl_80875D58:
...
/* 80875D9C  3C 60 80 8E */	lis r3, daMP_First@ha /* 0x808E0510@ha */
/* 80875DA0  80 03 05 10 */	lwz r0, daMP_First@l(r3)  /* 0x808E0510@l */
...
/* 80875DB8  3C 60 80 8E */	lis r3, daMP_First@ha /* 0x808E0510@ha */
/* 80875DBC  90 03 05 10 */	stw r0, daMP_First@l(r3)  /* 0x808E0510@l */
lbl_80875DC0:
/* 80875DC0  39 61 00 30 */	addi r11, r1, 0x30
/* 80875DC4  4B AE C4 51 */	bl _restgpr_24
