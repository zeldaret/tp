...
/* 80877FE0  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha /* 0x80879BD0@ha */
/* 80877FE4  3B C3 9B D0 */	addi r30, r3, daMP_ActivePlayer@l /* 0x80879BD0@l */
...
/* 80878014  3C 60 80 88 */	lis r3, d_a_movie_player__stringBase0@ha /* 0x8087911C@ha */
/* 80878018  38 63 91 1C */	addi r3, r3, d_a_movie_player__stringBase0@l /* 0x8087911C@l */
/* 8087801C  38 63 01 C6 */	addi r3, r3, 0x1c6
/* 80878020  4C C6 31 82 */	crclr 6
/* 80878024  4B 78 EA 99 */	bl OSReport
...
/* 80878040  3C 80 80 94 */	lis r4, daMP_WorkBuffer@ha /* 0x809448A0@ha */
/* 80878044  38 84 48 A0 */	addi r4, r4, daMP_WorkBuffer@l /* 0x809448A0@l */
...
/* 8087805C  4B AD 0D E9 */	bl DVDReadPrio
/* 80878060  2C 03 00 00 */	cmpwi r3, 0
/* 80878064  40 80 00 20 */	bge lbl_80878084
/* 80878068  3C 60 80 88 */	lis r3, d_a_movie_player__stringBase0@ha /* 0x8087911C@ha */
/* 8087806C  38 63 91 1C */	addi r3, r3, d_a_movie_player__stringBase0@l /* 0x8087911C@l */
/* 80878070  38 63 01 F2 */	addi r3, r3, 0x1f2
/* 80878074  4C C6 31 82 */	crclr 6
/* 80878078  4B 78 EA 45 */	bl OSReport
/* 8087807C  38 60 00 00 */	li r3, 0
/* 80878080  48 00 02 00 */	b lbl_80878280
lbl_80878084:
/* 80878084  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha /* 0x80879BD0@ha */
/* 80878088  38 83 9B D0 */	addi r4, r3, daMP_ActivePlayer@l /* 0x80879BD0@l */
/* 8087808C  80 04 00 64 */	lwz r0, 0x64(r4)
/* 80878090  3C 60 80 94 */	lis r3, daMP_WorkBuffer@ha /* 0x809448A0@ha */
/* 80878094  84 A3 48 A0 */	lwzu r5, daMP_WorkBuffer@l(r3)  /* 0x809448A0@l */
...
lbl_808780B4:
/* 808780B4  3C 60 80 88 */	lis r3, d_a_movie_player__stringBase0@ha /* 0x8087911C@ha */
/* 808780B8  38 63 91 1C */	addi r3, r3, d_a_movie_player__stringBase0@l /* 0x8087911C@l */
/* 808780BC  38 63 02 1F */	addi r3, r3, 0x21f
/* 808780C0  4C C6 31 82 */	crclr 6
/* 808780C4  4B 78 E9 F9 */	bl OSReport
...
lbl_808780E4:
/* 808780E4  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha /* 0x80879BD0@ha */
/* 808780E8  3B E3 9B D0 */	addi r31, r3, daMP_ActivePlayer@l /* 0x80879BD0@l */
...
lbl_8087810C:
/* 8087810C  3C 60 80 88 */	lis r3, d_a_movie_player__stringBase0@ha /* 0x8087911C@ha */
/* 80878110  38 63 91 1C */	addi r3, r3, d_a_movie_player__stringBase0@l /* 0x8087911C@l */
/* 80878114  38 63 02 52 */	addi r3, r3, 0x252
/* 80878118  4C C6 31 82 */	crclr 6
/* 8087811C  4B 78 E9 A1 */	bl OSReport
...
/* 80878130  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha /* 0x80879BD0@ha */
/* 80878134  3B 83 9B D0 */	addi r28, r3, daMP_ActivePlayer@l /* 0x80879BD0@l */
...
/* 80878164  4B AD 0C E1 */	bl DVDReadPrio
/* 80878168  2C 03 00 00 */	cmpwi r3, 0
/* 8087816C  40 80 00 20 */	bge lbl_8087818C
/* 80878170  3C 60 80 88 */	lis r3, d_a_movie_player__stringBase0@ha /* 0x8087911C@ha */
/* 80878174  38 63 91 1C */	addi r3, r3, d_a_movie_player__stringBase0@l /* 0x8087911C@l */
/* 80878178  38 63 02 7B */	addi r3, r3, 0x27b
/* 8087817C  4C C6 31 82 */	crclr 6
/* 80878180  4B 78 E9 3D */	bl OSReport
...
/* 80878194  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha /* 0x80879BD0@ha */
/* 80878198  38 63 9B D0 */	addi r3, r3, daMP_ActivePlayer@l /* 0x80879BD0@l */
...
/* 80878244  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha /* 0x80879BD0@ha */
/* 80878248  38 63 9B D0 */	addi r3, r3, daMP_ActivePlayer@l /* 0x80879BD0@l */
...
/* 80878260  3C 60 80 87 */	lis r3, daMP_PlayControl__FUl@ha /* 0x80877C8C@ha */
/* 80878264  38 63 7C 8C */	addi r3, r3, daMP_PlayControl__FUl@l /* 0x80877C8C@l */
/* 80878268  4B AD 3F BD */	bl VISetPostRetraceCallback
/* 8087826C  3C 80 80 94 */	lis r4, daMP_OldVIPostCallback@ha /* 0x80944930@ha */
/* 80878270  90 64 49 30 */	stw r3, daMP_OldVIPostCallback@l(r4)  /* 0x80944930@l */
