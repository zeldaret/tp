...
/* 808789AC  3C 80 80 94 */	lis r4, daMP_DrawPosX@ha /* 0x80945AFC@ha */
/* 808789B0  38 84 5A FC */	addi r4, r4, daMP_DrawPosX@l /* 0x80945AFC@l */
/* 808789B4  80 84 00 00 */	lwz r4, 0(r4)
/* 808789B8  3C A0 80 94 */	lis r5, daMP_DrawPosY@ha /* 0x80945B00@ha */
/* 808789BC  38 A5 5B 00 */	addi r5, r5, daMP_DrawPosY@l /* 0x80945B00@l */
/* 808789C0  80 A5 00 00 */	lwz r5, 0(r5)
/* 808789C4  3C C0 80 94 */	lis r6, daMP_videoInfo@ha /* 0x80945AE0@ha */
/* 808789C8  38 E6 5A E0 */	addi r7, r6, daMP_videoInfo@l /* 0x80945AE0@l */
...
/* 808789E0  4B 7A 5B 79 */	bl fopOvlpM_IsPeek__Fv
...
/* 808789F8  4B 9E A8 B5 */	bl cAPICPad_ANY_BUTTON__FUl
/* 808789FC  28 03 00 00 */	cmplwi r3, 0
/* 80878A00  40 82 00 10 */	bne lbl_80878A10
/* 80878A04  4B 7B 90 75 */	bl daMP_c_Get_MovieRestFrame__6daMP_cFv
/* 80878A08  28 03 00 00 */	cmplwi r3, 0
/* 80878A0C  40 82 00 14 */	bne lbl_80878A20
lbl_80878A10:
/* 80878A10  48 00 00 25 */	bl dComIfGp_event_reset__Fv
/* 80878A14  3C 60 80 88 */	lis r3, lit_4809@ha /* 0x808790FC@ha */
/* 80878A18  C0 23 90 FC */	lfs f1, lit_4809@l(r3)  /* 0x808790FC@l */
/* 80878A1C  4B 7B 90 89 */	bl daMP_c_Set_PercentMovieVolume__6daMP_cFf
lbl_80878A20:
