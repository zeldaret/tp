...
/* 80875FF0  3C 60 80 88 */	lis r3, lit_1109@ha
/* 80875FF4  3B C3 95 A0 */	addi r30, r3, lit_1109@l
/* 80875FF8  3F FE 00 06 */	addis r31, r30, 6
/* 80875FFC  41 82 00 54 */	beq lbl_80876050
/* 80876000  38 7E 2C 00 */	addi r3, r30, 0x2c00
/* 80876004  3C 80 80 87 */	lis r4, daMP_VideoDecoderForOnMemory__FPv@ha
/* 80876008  38 84 5E A0 */	addi r4, r4, daMP_VideoDecoderForOnMemory__FPv@l
/* 8087600C  3C C0 80 88 */	lis r6, daMP_VideoDecodeThreadStack@ha
/* 80876010  38 C6 C4 B8 */	addi r6, r6, daMP_VideoDecodeThreadStack@l
...
/* 80876028  4B AC B2 64 */	b OSCreateThread
/* 8087602C  2C 03 00 00 */	cmpwi r3, 0
/* 80876030  40 82 00 74 */	bne lbl_808760A4
/* 80876034  3C 60 80 88 */	lis r3, stringBase0@ha
/* 80876038  38 63 91 1C */	addi r3, r3, stringBase0@l
/* 8087603C  38 63 00 1A */	addi r3, r3, 0x1a
/* 80876040  4C C6 31 82 */	crclr 6
/* 80876044  4B 79 0A 78 */	b OSReport
/* 80876048  38 60 00 00 */	li r3, 0
/* 8087604C  48 00 00 88 */	b lbl_808760D4
lbl_80876050:
/* 80876050  38 7E 2C 00 */	addi r3, r30, 0x2c00
/* 80876054  3C 80 80 87 */	lis r4, daMP_VideoDecoder__FPv@ha
/* 80876058  38 84 5D D8 */	addi r4, r4, daMP_VideoDecoder__FPv@l
/* 8087605C  38 A0 00 00 */	li r5, 0
/* 80876060  3C C0 80 88 */	lis r6, daMP_VideoDecodeThreadStack@ha
/* 80876064  38 C6 C4 B8 */	addi r6, r6, daMP_VideoDecodeThreadStack@l
...
/* 8087607C  4B AC B2 10 */	b OSCreateThread
/* 80876080  2C 03 00 00 */	cmpwi r3, 0
/* 80876084  40 82 00 20 */	bne lbl_808760A4
/* 80876088  3C 60 80 88 */	lis r3, stringBase0@ha
/* 8087608C  38 63 91 1C */	addi r3, r3, stringBase0@l
/* 80876090  38 63 00 1A */	addi r3, r3, 0x1a
/* 80876094  4C C6 31 82 */	crclr 6
/* 80876098  4B 79 0A 24 */	b OSReport
