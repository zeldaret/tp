...
/* 80876408  3C 60 80 88 */	lis r3, lit_1109@ha
/* 8087640C  38 63 95 A0 */	addi r3, r3, lit_1109@l
...
/* 80876420  3C 80 80 87 */	lis r4, daMP_AudioDecoderForOnMemory__FPv@ha
/* 80876424  38 84 63 44 */	addi r4, r4, daMP_AudioDecoderForOnMemory__FPv@l
...
/* 80876440  4B AC AE 4C */	b OSCreateThread
...
/* 80876458  3C 80 80 87 */	lis r4, daMP_AudioDecoder__FPv@ha
/* 8087645C  38 84 63 1C */	addi r4, r4, daMP_AudioDecoder__FPv@l
...
/* 8087647C  4B AC AE 10 */	b OSCreateThread
/* 80876480  2C 03 00 00 */	cmpwi r3, 0
/* 80876484  40 82 00 20 */	bne lbl_808764A4
/* 80876488  3C 60 80 88 */	lis r3, stringBase0@ha
/* 8087648C  38 63 91 1C */	addi r3, r3, stringBase0@l
/* 80876490  38 63 00 3C */	addi r3, r3, 0x3c
/* 80876494  4C C6 31 82 */	crclr 6
/* 80876498  4B 79 06 24 */	b OSReport
