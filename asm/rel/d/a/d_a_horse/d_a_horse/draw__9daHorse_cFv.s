...
/* 808445A8  3C 60 80 84 */	lis r3, lit_3894@ha /* 0x808454AC@ha */
/* 808445AC  3B E3 54 AC */	addi r31, r3, lit_3894@l /* 0x808454AC@l */
/* 808445B0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 808445B4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 808445B8  38 80 00 00 */	li r4, 0
/* 808445BC  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 808445C0  38 DE 01 0C */	addi r6, r30, 0x10c
/* 808445C4  4B 95 F2 01 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
lbl_808445E8:
/* 808445E8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 808445EC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 808445F0  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 808445F4  80 84 00 04 */	lwz r4, 4(r4)
/* 808445F8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 808445FC  4B 96 07 A5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80844600  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80844604  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80844660  4B 7C 8F 89 */	bl entry__13mDoExt_btpAnmFP16J3DMaterialTables
/* 80844664  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80844668  4B 7C 96 FD */	bl mDoExt_modelEntryDL__FP8J3DModel
...
/* 808446B8  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 808446BC  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 808446C0  4B 7E A2 51 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 808446E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 808446E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 808446E8  80 63 5D B4 */	lwz r3, 0x5db4(r3)
/* 808446EC  4B 8A 88 71 */	bl checkHorseSubjectivity__9daAlink_cCFv
...
/* 80844704  3C A0 80 84 */	lis r5, reinLineColor@ha /* 0x80845A30@ha */
/* 80844708  38 A5 5A 30 */	addi r5, r5, reinLineColor@l /* 0x80845A30@l */
/* 8084470C  38 C0 00 00 */	li r6, 0
/* 80844710  38 FE 01 0C */	addi r7, r30, 0x10c
/* 80844714  4B 7C F0 29 */	bl update__19mDoExt_3DlineMat1_cFifR8_GXColorUsP12dKy_tevstr_c
...
/* 80844730  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80844734  38 03 61 C0 */	addi r0, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8084474C  4B 7C FF ED */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
lbl_80844750:
