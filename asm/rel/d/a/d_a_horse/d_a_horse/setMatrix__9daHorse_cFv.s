...
/* 8083D9E8  4B B2 47 F5 */	bl _savegpr_29
/* 8083D9EC  7C 7E 1B 78 */	mr r30, r3
/* 8083D9F0  3C 60 80 84 */	lis r3, lit_3894@ha /* 0x808454AC@ha */
/* 8083D9F4  3B E3 54 AC */	addi r31, r3, lit_3894@l /* 0x808454AC@l */
...
/* 8083DB28  4B A3 2A 19 */	bl cLib_addCalcAngleS__FPsssss
...
/* 8083DB48  4B A3 29 F9 */	bl cLib_addCalcAngleS__FPsssss
...
/* 8083DB64  4B A3 29 DD */	bl cLib_addCalcAngleS__FPsssss
lbl_8083DB68:
/* 8083DB68  7F C3 F3 78 */	mr r3, r30
/* 8083DB6C  48 00 0D 39 */	bl setNeckAngle__9daHorse_cFv
/* 8083DB70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8083DB74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8083DB78  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 8083DB7C  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 8083DB80  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 8083DB84  4B B0 8D 65 */	bl PSMTXTrans
/* 8083DB88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8083DB8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8083DB90  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 8083DB94  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 8083DB98  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 8083DB9C  4B 7C E7 05 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 8083DBA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8083DBA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8083DBA8  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 8083DBAC  38 84 00 24 */	addi r4, r4, 0x24
/* 8083DBB0  4B B0 89 01 */	bl PSMTXCopy
/* 8083DBB4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8083DBB8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8083DBCC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8083DBD0  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8083DC44  4B B2 45 E5 */	bl _restgpr_29
