...
/* 8083EB54  3C 60 80 84 */	lis r3, m_footJointTable__9daHorse_c@ha /* 0x808454C0@ha */
/* 8083EB58  3B E3 54 C0 */	addi r31, r3, m_footJointTable__9daHorse_c@l /* 0x808454C0@l */
/* 8083EB5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8083EB60  3A 23 D4 70 */	addi r17, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8083EB94  4B 7C D8 E1 */	bl mDoMtx_ZrotS__FPA4_fs
...
/* 8083EBB8  4B B0 79 2D */	bl PSMTXConcat
...
/* 8083EBD0  4B B0 78 E1 */	bl PSMTXCopy
...
/* 8083EC08  4B 7C E1 95 */	bl transM__14mDoMtx_stack_cFfff
/* 8083EC0C  7D E3 7B 78 */	mr r3, r15
/* 8083EC10  4B 7C E3 6D */	bl quatM__14mDoMtx_stack_cFPC10Quaternion
...
/* 8083EC58  4B B0 78 59 */	bl PSMTXCopy
/* 8083EC5C  C0 30 00 34 */	lfs f1, 0x34(r16)
/* 8083EC60  C0 50 00 38 */	lfs f2, 0x38(r16)
/* 8083EC64  C0 70 00 3C */	lfs f3, 0x3c(r16)
/* 8083EC68  4B 7C E1 35 */	bl transM__14mDoMtx_stack_cFfff
/* 8083EC6C  38 6F 00 10 */	addi r3, r15, 0x10
/* 8083EC70  4B 7C E3 0D */	bl quatM__14mDoMtx_stack_cFPC10Quaternion
...
/* 8083ECC0  4B B0 77 F1 */	bl PSMTXCopy
/* 8083ECC4  C0 30 00 54 */	lfs f1, 0x54(r16)
/* 8083ECC8  C0 50 00 58 */	lfs f2, 0x58(r16)
/* 8083ECCC  C0 70 00 5C */	lfs f3, 0x5c(r16)
/* 8083ECD0  4B 7C E0 CD */	bl transM__14mDoMtx_stack_cFfff
/* 8083ECD4  38 6F 00 20 */	addi r3, r15, 0x20
/* 8083ECD8  4B 7C E2 A5 */	bl quatM__14mDoMtx_stack_cFPC10Quaternion
/* 8083ECDC  C0 30 00 40 */	lfs f1, 0x40(r16)
/* 8083ECE0  C0 50 00 44 */	lfs f2, 0x44(r16)
/* 8083ECE4  C0 70 00 48 */	lfs f3, 0x48(r16)
/* 8083ECE8  4B 7C E1 51 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8083ECEC  2C 1C 00 02 */	cmpwi r28, 2
/* 8083ECF0  41 80 00 28 */	blt lbl_8083ED18
/* 8083ECF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8083ECF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8083ED10  4B 7C D7 BD */	bl mDoMtx_ZrotM__FPA4_fs
/* 8083ED14  48 00 00 14 */	b lbl_8083ED28
lbl_8083ED18:
/* 8083ED18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8083ED1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8083ED20  A8 9D 00 0A */	lha r4, 0xa(r29)
/* 8083ED24  4B 7C D7 A9 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_8083ED28:
...
/* 8083ED48  4B B0 77 69 */	bl PSMTXCopy
