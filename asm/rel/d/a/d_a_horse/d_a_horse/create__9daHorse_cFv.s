...
/* 808394A8  4B B2 8D 21 */	bl _savegpr_24
/* 808394AC  7C 79 1B 78 */	mr r25, r3
/* 808394B0  3C 80 80 84 */	lis r4, cNullVec__6Z2Calc@ha /* 0x808458D4@ha */
/* 808394B4  3B 84 58 D4 */	addi r28, r4, cNullVec__6Z2Calc@l /* 0x808458D4@l */
/* 808394B8  3C 80 80 84 */	lis r4, lit_3894@ha /* 0x808454AC@ha */
/* 808394BC  3B A4 54 AC */	addi r29, r4, lit_3894@l /* 0x808454AC@l */
...
/* 80839508  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8083950C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80839510  3B 43 07 F0 */	addi r26, r3, 0x7f0
/* 80839514  7F 43 D3 78 */	mr r3, r26
/* 80839518  38 80 05 80 */	li r4, 0x580
/* 8083951C  4B 7F B4 A1 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80839530  4B 7F B4 8D */	bl isEventBit__11dSv_event_cCFUs
/* 80839534  2C 03 00 00 */	cmpwi r3, 0
/* 80839538  40 82 00 30 */	bne lbl_80839568
/* 8083953C  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 80839540  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 80839544  38 63 00 10 */	addi r3, r3, 0x10
/* 80839548  4B 86 45 19 */	bl checkStageName__9daAlink_cFPCc
...
/* 8083955C  4B 7F B4 61 */	bl isEventBit__11dSv_event_cCFUs
/* 80839560  2C 03 00 00 */	cmpwi r3, 0
/* 80839564  41 82 00 20 */	beq lbl_80839584
lbl_80839568:
/* 80839568  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8083956C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80839570  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 80839574  38 80 13 01 */	li r4, 0x1301
/* 80839578  4B 7F B4 45 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80839594  4B 7F 39 29 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 80839598  7C 7B 1B 78 */	mr r27, r3
/* 8083959C  2C 1B 00 04 */	cmpwi r27, 4
/* 808395A0  40 82 07 40 */	bne lbl_80839CE0
/* 808395A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 808395A8  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 808396C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 808396CC  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 808396D0  38 7F 00 4E */	addi r3, r31, 0x4e
/* 808396D4  3C 80 80 84 */	lis r4, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 808396D8  38 84 58 5C */	addi r4, r4, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 808396DC  38 84 00 18 */	addi r4, r4, 0x18
/* 808396E0  4B B2 F2 B5 */	bl strcmp
/* 808396E4  2C 03 00 00 */	cmpwi r3, 0
/* 808396E8  41 82 00 C0 */	beq lbl_808397A8
/* 808396EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 808396F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 808396F4  3B 03 07 F0 */	addi r24, r3, 0x7f0
/* 808396F8  7F 03 C3 78 */	mr r3, r24
/* 808396FC  38 80 15 80 */	li r4, 0x1580
/* 80839700  4B 7F B2 BD */	bl isEventBit__11dSv_event_cCFUs
...
/* 80839714  4B 7F B2 A9 */	bl isEventBit__11dSv_event_cCFUs
/* 80839718  2C 03 00 00 */	cmpwi r3, 0
/* 8083971C  41 82 00 8C */	beq lbl_808397A8
lbl_80839720:
/* 80839720  38 7F 00 4E */	addi r3, r31, 0x4e
/* 80839724  4B 86 43 3D */	bl checkStageName__9daAlink_cFPCc
...
/* 808397AC  3C 80 80 84 */	lis r4, daHorse_createHeap__FP10fopAc_ac_c@ha /* 0x808393EC@ha */
/* 808397B0  38 84 93 EC */	addi r4, r4, daHorse_createHeap__FP10fopAc_ac_c@l /* 0x808393EC@l */
/* 808397B4  38 A0 6E 60 */	li r5, 0x6e60
/* 808397B8  4B 7E 0C F9 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_808397CC:
/* 808397CC  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 808397D0  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 808397D4  38 63 00 19 */	addi r3, r3, 0x19
/* 808397D8  4B 86 42 89 */	bl checkStageName__9daAlink_cFPCc
/* 808397DC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 808397E0  40 82 00 60 */	bne lbl_80839840
/* 808397E4  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 808397E8  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 808397EC  38 63 00 20 */	addi r3, r3, 0x20
/* 808397F0  4B 86 42 71 */	bl checkStageName__9daAlink_cFPCc
/* 808397F4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 808397F8  40 82 00 48 */	bne lbl_80839840
/* 808397FC  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 80839800  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 80839804  38 63 00 08 */	addi r3, r3, 8
/* 80839808  4B 86 42 59 */	bl checkStageName__9daAlink_cFPCc
/* 8083980C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80839810  40 82 00 30 */	bne lbl_80839840
/* 80839814  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 80839818  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 8083981C  4B 86 42 45 */	bl checkStageName__9daAlink_cFPCc
/* 80839820  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80839824  40 82 00 1C */	bne lbl_80839840
/* 80839828  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 8083982C  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 80839830  38 63 00 28 */	addi r3, r3, 0x28
/* 80839834  4B 86 42 2D */	bl checkStageName__9daAlink_cFPCc
...
/* 808398B4  4B 81 7F 39 */	bl dPath_GetRoomPath__Fii
...
/* 808398CC  4B 81 7F CD */	bl dPath_GetNextRoomPath__FPC5dPathi
...
/* 8083990C  4B 84 9F 55 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 80839958  4B 83 C9 31 */	bl Set__9dBgS_AcchFP10fopAc_ac_ciP12dBgS_AcchCir
...
/* 808399AC  4B A8 B8 61 */	bl init__14Z2CreatureRideFP3VecP3VecUcUc
...
/* 808399E4  4B 81 72 B9 */	bl init__7dPaPo_cFP9dBgS_Acchff
...
/* 80839A14  4B 84 AE A1 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80839A34  4B A3 57 CD */	bl SetR__8cM3dGCylFf
/* 80839A38  38 79 0F 6C */	addi r3, r25, 0xf6c
/* 80839A3C  38 9C 00 68 */	addi r4, r28, 0x68
/* 80839A40  4B 84 AF F5 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80839A54  3C 60 80 84 */	lis r3, daHorse_coHitCallbackAll__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 0x80838A68@ha */
/* 80839A58  38 03 8A 68 */	addi r0, r3, daHorse_coHitCallbackAll__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 0x80838A68@l */
/* 80839A5C  90 19 0A 30 */	stw r0, 0xa30(r25)
/* 80839A60  3C 60 80 84 */	lis r3, daHorse_coHitCallbackCowHit__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 0x80838A44@ha */
/* 80839A64  38 03 8A 44 */	addi r0, r3, daHorse_coHitCallbackCowHit__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 0x80838A44@l */
...
/* 80839A78  4B 84 AE 3D */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
/* 80839A7C  38 19 08 94 */	addi r0, r25, 0x894
/* 80839A80  90 19 0D 38 */	stw r0, 0xd38(r25)
/* 80839A84  3C 60 80 84 */	lis r3, daHorse_coHitCallbackBoarJump__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 0x80838A20@ha */
/* 80839A88  38 03 8A 20 */	addi r0, r3, daHorse_coHitCallbackBoarJump__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 0x80838A20@l */
/* 80839A8C  90 19 0D E4 */	stw r0, 0xde4(r25)
/* 80839A90  38 79 0D 20 */	addi r3, r25, 0xd20
/* 80839A94  38 80 00 20 */	li r4, 0x20
/* 80839A98  4B A2 AE 85 */	bl SetVsGrp__10cCcD_ObjCoFUl
...
/* 80839AC8  4B A3 57 39 */	bl SetR__8cM3dGCylFf
/* 80839ACC  38 79 0E 30 */	addi r3, r25, 0xe30
/* 80839AD0  38 9C 00 24 */	addi r4, r28, 0x24
/* 80839AD4  4B 84 AD E1 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80839B0C  4B A3 56 ED */	bl SetH__8cM3dGCylFf
/* 80839B10  38 79 0F 54 */	addi r3, r25, 0xf54
/* 80839B14  C0 3D 01 9C */	lfs f1, 0x19c(r29)
/* 80839B18  4B A3 56 E9 */	bl SetR__8cM3dGCylFf
...
/* 80839B48  3C 60 80 84 */	lis r3, daHorse_modelCallBack__FP8J3DJointi@ha /* 0x80838F3C@ha */
/* 80839B4C  38 63 8F 3C */	addi r3, r3, daHorse_modelCallBack__FP8J3DJointi@l /* 0x80838F3C@l */
...
/* 80839BB8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80839BBC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80839BC0  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80839BC4  4B 83 CE E9 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80839BE4  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 80839BE8  38 63 0C F4 */	addi r3, r3, Zero__4cXyz@l /* 0x80430CF4@l */
...
/* 80839C6C  4B B2 84 19 */	bl __ptmf_scall
...
/* 80839C84  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 80839C88  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 80839C8C  38 63 00 30 */	addi r3, r3, 0x30
/* 80839C90  4B 86 3D D1 */	bl checkStageName__9daAlink_cFPCc
/* 80839C94  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80839C98  40 82 00 34 */	bne lbl_80839CCC
/* 80839C9C  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 80839CA0  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 80839CA4  38 63 00 38 */	addi r3, r3, 0x38
/* 80839CA8  4B 86 3D B9 */	bl checkStageName__9daAlink_cFPCc
/* 80839CAC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80839CB0  40 82 00 1C */	bne lbl_80839CCC
/* 80839CB4  3C 60 80 84 */	lis r3, d_a_horse__stringBase0@ha /* 0x8084585C@ha */
/* 80839CB8  38 63 58 5C */	addi r3, r3, d_a_horse__stringBase0@l /* 0x8084585C@l */
/* 80839CBC  38 63 00 40 */	addi r3, r3, 0x40
/* 80839CC0  4B 86 3D A1 */	bl checkStageName__9daAlink_cFPCc
...
/* 80839CDC  4B 7D FB E9 */	bl fopAcM_setStageLayer__FPv
lbl_80839CE0:
/* 80839CE0  7F 63 DB 78 */	mr r3, r27
lbl_80839CE4:
/* 80839CE4  39 61 00 30 */	addi r11, r1, 0x30
/* 80839CE8  4B B2 85 2D */	bl _restgpr_24
