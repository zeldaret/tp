...
/* 80838B88  4B B2 96 48 */	b _savegpr_26
...
/* 80838BB4  3C 60 80 84 */	lis r3, lit_4306@ha
/* 80838BB8  C0 03 55 FC */	lfs f0, lit_4306@l(r3)
...
/* 80838BE8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80838BEC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80838BF0  4B B0 D8 C0 */	b PSMTXCopy
...
/* 80838C48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80838C4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80838C50  C0 3B 00 0C */	lfs f1, 0xc(r27)
/* 80838C54  C0 5B 00 1C */	lfs f2, 0x1c(r27)
/* 80838C58  C0 7B 00 2C */	lfs f3, 0x2c(r27)
/* 80838C5C  4B B0 DC 8C */	b PSMTXTrans
/* 80838C60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80838C64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80838C68  A8 9E 16 F0 */	lha r4, 0x16f0(r30)
/* 80838C6C  4B 7D 37 C8 */	b mDoMtx_YrotM__FPA4_fs
...
/* 80838C88  4B 7D 41 14 */	b transM__14mDoMtx_stack_cFfff
/* 80838C8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80838C90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80838C94  7F 64 DB 78 */	mr r4, r27
/* 80838C98  7C 65 1B 78 */	mr r5, r3
/* 80838C9C  4B B0 D8 48 */	b PSMTXConcat
...
/* 80838CB8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80838CBC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80838CC0  4B B0 D7 F0 */	b PSMTXCopy
lbl_80838CC4:
...
lbl_80838CE4:
/* 80838CE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80838CE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80838CEC  A8 1E 04 E4 */	lha r0, 0x4e4(r30)
/* 80838CF0  7C 00 0E 70 */	srawi r0, r0, 1
/* 80838CF4  7C 04 07 34 */	extsh r4, r0
/* 80838CF8  4B 7D 37 D4 */	b mDoMtx_ZrotM__FPA4_fs
/* 80838CFC  48 00 00 20 */	b lbl_80838D1C
lbl_80838D00:
/* 80838D00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80838D04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80838D18  4B 7D 37 B4 */	b mDoMtx_ZrotM__FPA4_fs
lbl_80838D1C:
/* 80838D1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80838D20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80838D38  4B B0 D7 78 */	b PSMTXCopy
...
/* 80838D4C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80838D50  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80838D54  4B B0 D7 5C */	b PSMTXCopy
...
/* 80838DC4  4B B0 0A B4 */	b JMAEulerToQuat__FsssP10Quaternion
...
/* 80838DE0  4B 7D 3D 7C */	b mDoMtx_QuatConcat__FPC10QuaternionPC10QuaternionP10Quaternion
...
/* 80838DF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80838DF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80838DFC  C0 3D 00 14 */	lfs f1, 0x14(r29)
/* 80838E00  C0 5D 00 18 */	lfs f2, 0x18(r29)
/* 80838E04  C0 7D 00 1C */	lfs f3, 0x1c(r29)
/* 80838E08  4B B0 DA E0 */	b PSMTXTrans
/* 80838E0C  80 7E 05 AC */	lwz r3, 0x5ac(r30)
/* 80838E10  80 03 00 20 */	lwz r0, 0x20(r3)
/* 80838E14  7C 60 E2 14 */	add r3, r0, r28
/* 80838E18  4B 7D 41 64 */	b quatM__14mDoMtx_stack_cFPC10Quaternion
/* 80838E1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80838E20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80838E24  7C 64 1B 78 */	mr r4, r3
/* 80838E28  4B B0 D7 88 */	b PSMTXInverse
...
/* 80838E44  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80838E48  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80838E4C  3C A0 80 43 */	lis r5, mCurrentMtx__6J3DSys@ha
/* 80838E50  38 A5 4B E4 */	addi r5, r5, mCurrentMtx__6J3DSys@l
/* 80838E54  4B B0 D6 90 */	b PSMTXConcat
/* 80838E58  7F 43 D3 78 */	mr r3, r26
/* 80838E5C  38 81 00 18 */	addi r4, r1, 0x18
/* 80838E60  4B B0 DB 88 */	b PSMTXQuat
...
/* 80838E7C  3C 60 80 43 */	lis r3, mCurrentMtx__6J3DSys@ha
/* 80838E80  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l
/* 80838E84  7F 44 D3 78 */	mr r4, r26
/* 80838E88  7C 65 1B 78 */	mr r5, r3
/* 80838E8C  4B B0 D6 58 */	b PSMTXConcat
/* 80838E90  3C 60 80 43 */	lis r3, mCurrentMtx__6J3DSys@ha
/* 80838E94  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l
/* 80838E98  7F 44 D3 78 */	mr r4, r26
/* 80838E9C  4B B0 D6 14 */	b PSMTXCopy
...
/* 80838EFC  3C 60 80 84 */	lis r3, lit_4304@ha
/* 80838F00  C0 03 55 F4 */	lfs f0, lit_4304@l(r3)
...
/* 80838F14  3C 60 80 84 */	lis r3, lit_4306@ha
/* 80838F18  C0 03 55 FC */	lfs f0, lit_4306@l(r3)
/* 80838F1C  D0 1E 05 A4 */	stfs f0, 0x5a4(r30)
lbl_80838F20:
/* 80838F20  38 60 00 01 */	li r3, 1
/* 80838F24  39 61 00 40 */	addi r11, r1, 0x40
/* 80838F28  4B B2 92 F4 */	b _restgpr_26
