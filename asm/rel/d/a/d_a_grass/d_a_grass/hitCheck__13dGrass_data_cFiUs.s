...
/* 8051EB98  4B E4 36 3D */	bl _savegpr_27
/* 8051EB9C  7C 7D 1B 78 */	mr r29, r3
/* 8051EBA0  7C 9E 23 78 */	mr r30, r4
/* 8051EBA4  7C BF 2B 78 */	mr r31, r5
/* 8051EBA8  3C 60 80 52 */	lis r3, __vt__15dCcMassS_HitInf@ha /* 0x805278B8@ha */
/* 8051EBAC  38 03 78 B8 */	addi r0, r3, __vt__15dCcMassS_HitInf@l /* 0x805278B8@l */
/* 8051EBB0  90 01 00 20 */	stw r0, 0x20(r1)
/* 8051EBB4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8051EBB8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8051EBCC  4B B6 6C E1 */	bl Chk__12dCcMassS_MngFP4cXyzPP10fopAc_ac_cP15dCcMassS_HitInf
...
/* 8051EC2C  3C 60 80 45 */	lis r3, m_grass__9daGrass_c@ha /* 0x80450DB0@ha */
/* 8051EC30  80 83 0D B0 */	lwz r4, m_grass__9daGrass_c@l(r3)  /* 0x80450DB0@l */
...
/* 8051EC68  4B B0 E4 05 */	bl dComIfGp_getReverb__Fi
...
/* 8051EC7C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8051EC80  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8051EC94  3D 00 80 52 */	lis r8, lit_4516@ha /* 0x80523090@ha */
/* 8051EC98  C0 28 30 90 */	lfs f1, lit_4516@l(r8)  /* 0x80523090@l */
/* 8051EC9C  FC 40 08 90 */	fmr f2, f1
/* 8051ECA0  3D 00 80 52 */	lis r8, lit_4517@ha /* 0x80523094@ha */
/* 8051ECA4  C0 68 30 94 */	lfs f3, lit_4517@l(r8)  /* 0x80523094@l */
/* 8051ECA8  FC 80 18 90 */	fmr f4, f3
/* 8051ECAC  39 00 00 00 */	li r8, 0
/* 8051ECB0  4B D8 CC D5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 8051ECD0  4B D5 18 71 */	bl cLib_addCalcAngleS__FPsssss
...
/* 8051ECF0  4B D5 18 51 */	bl cLib_addCalcAngleS__FPsssss
/* 8051ECF4  7C 60 07 35 */	extsh. r0, r3
/* 8051ECF8  40 82 00 7C */	bne lbl_8051ED74
/* 8051ECFC  38 80 00 00 */	li r4, 0
/* 8051ED00  3C 60 80 45 */	lis r3, m_grass__9daGrass_c@ha /* 0x80450DB0@ha */
/* 8051ED04  38 63 0D B0 */	addi r3, r3, m_grass__9daGrass_c@l /* 0x80450DB0@l */
...
lbl_8051ED74:
/* 8051ED74  3C 60 80 52 */	lis r3, __vt__15dCcMassS_HitInf@ha /* 0x805278B8@ha */
/* 8051ED78  38 03 78 B8 */	addi r0, r3, __vt__15dCcMassS_HitInf@l /* 0x805278B8@l */
/* 8051ED7C  90 01 00 20 */	stw r0, 0x20(r1)
/* 8051ED80  39 61 00 40 */	addi r11, r1, 0x40
/* 8051ED84  4B E4 34 9D */	bl _restgpr_27
