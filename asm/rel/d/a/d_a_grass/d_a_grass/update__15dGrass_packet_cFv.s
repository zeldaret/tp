...
/* 80520050  4B E4 21 69 */	bl _savegpr_20
/* 80520054  7C 7B 1B 78 */	mr r27, r3
/* 80520058  3C 60 80 52 */	lis r3, lit_3999@ha /* 0x80523028@ha */
/* 8052005C  3B C3 30 28 */	addi r30, r3, lit_3999@l /* 0x80523028@l */
/* 80520060  3E FB 00 02 */	addis r23, r27, 2
/* 80520064  3B 00 00 00 */	li r24, 0
/* 80520068  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8052006C  3A C3 D4 70 */	addi r22, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80520084  4B AE C3 59 */	bl mDoMtx_YrotS__FPA4_fs
/* 80520088  7E C3 B3 78 */	mr r3, r22
/* 8052008C  A8 97 00 04 */	lha r4, 4(r23)
/* 80520090  4B AE C3 0D */	bl mDoMtx_XrotM__FPA4_fs
...
/* 805200A4  4B AE C3 91 */	bl mDoMtx_YrotM__FPA4_fs
/* 805200A8  7E 83 A3 78 */	mr r3, r20
/* 805200AC  38 97 00 08 */	addi r4, r23, 8
/* 805200B0  4B E2 64 01 */	bl PSMTXCopy
...
/* 805200D4  3C 60 80 45 */	lis r3, mSystemFar__14mDoLib_clipper@ha /* 0x80450C70@ha */
/* 805200D8  C0 03 0C 70 */	lfs f0, mSystemFar__14mDoLib_clipper@l(r3)  /* 0x80450C70@l */
/* 805200DC  EC 01 00 32 */	fmuls f0, f1, f0
/* 805200E0  3C 60 80 3E */	lis r3, mClipper__14mDoLib_clipper@ha /* 0x803DD8E4@ha */
/* 805200E4  3A E3 D8 E4 */	addi r23, r3, mClipper__14mDoLib_clipper@l /* 0x803DD8E4@l */
/* 805200E8  D0 17 00 58 */	stfs f0, 0x58(r23)
/* 805200EC  7E E3 BB 78 */	mr r3, r23
/* 805200F0  3B 18 BD 64 */	addi r24, r24, -17052
/* 805200F4  4B D5 36 99 */	bl calcViewFrustum__11J3DUClipperFv
/* 805200F8  3B 80 00 00 */	li r28, 0
/* 805200FC  3A C0 00 00 */	li r22, 0
/* 80520100  3B E0 00 00 */	li r31, 0
/* 80520104  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80520108  3A A3 CA 54 */	addi r21, r3, g_env_light@l /* 0x8042CA54@l */
/* 8052010C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80520110  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80520184  3C 60 80 3E */	lis r3, mClipper__14mDoLib_clipper@ha /* 0x803DD8E4@ha */
/* 80520188  38 63 D8 E4 */	addi r3, r3, mClipper__14mDoLib_clipper@l /* 0x803DD8E4@l */
/* 8052018C  3C 80 80 43 */	lis r4, j3dSys@ha /* 0x80434AC8@ha */
/* 80520190  38 84 4A C8 */	addi r4, r4, j3dSys@l /* 0x80434AC8@l */
/* 80520194  38 A1 00 08 */	addi r5, r1, 8
/* 80520198  4B D5 37 65 */	bl clip__11J3DUClipperCFPA4_Cf3Vecf
...
/* 80520204  3C 80 80 52 */	lis r4, mAngleZ@ha /* 0x80527930@ha */
/* 80520208  38 84 79 30 */	addi r4, r4, mAngleZ@l /* 0x80527930@l */
...
lbl_805202DC:
/* 805202DC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805202E0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805202E4  4B E2 61 CD */	bl PSMTXCopy
...
/* 805202FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80520300  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80520304  3C 80 80 52 */	lis r4, mAngleZ@ha /* 0x80527930@ha */
/* 80520308  3A 84 79 30 */	addi r20, r4, mAngleZ@l /* 0x80527930@l */
/* 8052030C  7C 94 FA AE */	lhax r4, r20, r31
/* 80520310  4B AE C1 BD */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80520324  4B AE CB 15 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80520328  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8052032C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80520330  7C 14 FA AE */	lhax r0, r20, r31
/* 80520334  7C 00 00 D0 */	neg r0, r0
/* 80520338  7C 04 07 34 */	extsh r4, r0
/* 8052033C  4B AE C1 91 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8052039C  3C 80 80 52 */	lis r4, d_a_grass__stringBase0@ha /* 0x805231C0@ha */
/* 805203A0  38 84 31 C0 */	addi r4, r4, d_a_grass__stringBase0@l /* 0x805231C0@l */
/* 805203A4  38 84 00 07 */	addi r4, r4, 7
/* 805203A8  38 A0 00 06 */	li r5, 6
/* 805203AC  4B E4 5C E1 */	bl memcmp
/* 805203B0  2C 03 00 00 */	cmpwi r3, 0
/* 805203B4  41 82 00 1C */	beq lbl_805203D0
/* 805203B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805203BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805203C0  3C 80 80 52 */	lis r4, mAngleZ@ha /* 0x80527930@ha */
/* 805203C4  38 84 79 30 */	addi r4, r4, mAngleZ@l /* 0x80527930@l */
/* 805203C8  7C 84 FA AE */	lhax r4, r4, r31
/* 805203CC  4B AE C1 01 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_805203D0:
/* 805203D0  FC 20 F8 90 */	fmr f1, f31
/* 805203D4  FC 40 F0 90 */	fmr f2, f30
/* 805203D8  FC 60 F8 90 */	fmr f3, f31
/* 805203DC  4B AE CA 5D */	bl scaleM__14mDoMtx_stack_cFfff
...
/* 805203F0  3C 80 80 52 */	lis r4, d_a_grass__stringBase0@ha /* 0x805231C0@ha */
/* 805203F4  38 84 31 C0 */	addi r4, r4, d_a_grass__stringBase0@l /* 0x805231C0@l */
/* 805203F8  38 84 00 07 */	addi r4, r4, 7
/* 805203FC  38 A0 00 06 */	li r5, 6
/* 80520400  4B E4 5C 8D */	bl memcmp
/* 80520404  2C 03 00 00 */	cmpwi r3, 0
/* 80520408  41 82 00 24 */	beq lbl_8052042C
/* 8052040C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80520410  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80520414  3C 80 80 52 */	lis r4, mAngleZ@ha /* 0x80527930@ha */
/* 80520418  38 84 79 30 */	addi r4, r4, mAngleZ@l /* 0x80527930@l */
/* 8052041C  7C 04 FA AE */	lhax r0, r4, r31
/* 80520420  7C 00 00 D0 */	neg r0, r0
/* 80520424  7C 04 07 34 */	extsh r4, r0
/* 80520428  4B AE C0 A5 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_8052042C:
...
/* 80520470  4B AE C9 C9 */	bl scaleM__14mDoMtx_stack_cFfff
lbl_80520474:
...
/* 80520484  3C 80 80 52 */	lis r4, d_a_grass__stringBase0@ha /* 0x805231C0@ha */
/* 80520488  38 84 31 C0 */	addi r4, r4, d_a_grass__stringBase0@l /* 0x805231C0@l */
/* 8052048C  38 84 00 07 */	addi r4, r4, 7
/* 80520490  38 A0 00 06 */	li r5, 6
/* 80520494  4B E4 5B F9 */	bl memcmp
/* 80520498  2C 03 00 00 */	cmpwi r3, 0
/* 8052049C  41 82 00 74 */	beq lbl_80520510
/* 805204A0  4B B3 A6 51 */	bl dKyw_get_wind_pow__Fv
/* 805204A4  FF E0 08 90 */	fmr f31, f1
/* 805204A8  4B B3 A6 49 */	bl dKyw_get_wind_pow__Fv
/* 805204AC  EF E1 07 F2 */	fmuls f31, f1, f31
/* 805204B0  4B B3 A6 41 */	bl dKyw_get_wind_pow__Fv
...
/* 805204FC  3C 60 80 52 */	lis r3, mAngleZ@ha /* 0x80527930@ha */
/* 80520500  38 63 79 30 */	addi r3, r3, mAngleZ@l /* 0x80527930@l */
/* 80520504  7C 03 FA AE */	lhax r0, r3, r31
/* 80520508  7C 00 22 14 */	add r0, r0, r4
/* 8052050C  7C 03 FB 2E */	sthx r0, r3, r31
lbl_80520510:
/* 80520510  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80520514  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
/* 80520518  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8052051C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80520520  38 BD 00 18 */	addi r5, r29, 0x18
/* 80520524  4B E2 5F C1 */	bl PSMTXConcat
/* 80520528  48 00 00 E4 */	b lbl_8052060C
lbl_8052052C:
/* 8052052C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80520530  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80520534  C0 3D 00 0C */	lfs f1, 0xc(r29)
/* 80520538  C0 5D 00 10 */	lfs f2, 0x10(r29)
/* 8052053C  C0 7D 00 14 */	lfs f3, 0x14(r29)
/* 80520540  4B E2 63 A9 */	bl PSMTXTrans
/* 80520544  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80520548  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8052054C  7E C4 07 34 */	extsh r4, r22
/* 80520550  4B AE BE E5 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80520594  4B AE C8 A5 */	bl scaleM__14mDoMtx_stack_cFfff
lbl_80520598:
...
/* 805205F0  4B AE C8 49 */	bl scaleM__14mDoMtx_stack_cFfff
/* 805205F4  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 805205F8  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
/* 805205FC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80520600  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80520604  38 BD 00 18 */	addi r5, r29, 0x18
/* 80520608  4B E2 5E DD */	bl PSMTXConcat
lbl_8052060C:
...
/* 80520624  3C 60 80 45 */	lis r3, mSystemFar__14mDoLib_clipper@ha /* 0x80450C70@ha */
/* 80520628  C0 03 0C 70 */	lfs f0, mSystemFar__14mDoLib_clipper@l(r3)  /* 0x80450C70@l */
/* 8052062C  D0 17 00 58 */	stfs f0, 0x58(r23)
/* 80520630  3C 60 80 3E */	lis r3, mClipper__14mDoLib_clipper@ha /* 0x803DD8E4@ha */
/* 80520634  38 63 D8 E4 */	addi r3, r3, mClipper__14mDoLib_clipper@l /* 0x803DD8E4@l */
/* 80520638  4B D5 31 55 */	bl calcViewFrustum__11J3DUClipperFv
/* 8052063C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80520640  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80520644  80 63 5F 90 */	lwz r3, 0x5f90(r3)
/* 80520648  7F 64 DB 78 */	mr r4, r27
/* 8052064C  38 A0 00 00 */	li r5, 0
/* 80520650  4B E0 4E 3D */	bl entryImm__13J3DDrawBufferFP9J3DPacketUs
...
/* 80520668  4B E4 1B 9D */	bl _restgpr_20
