...
/* 8051C1B4  3C 60 80 52 */	lis r3, __vt__16dFlower_packet_c@ha
/* 8051C1B8  38 03 78 90 */	addi r0, r3, __vt__16dFlower_packet_c@l
/* 8051C1BC  90 1E 00 00 */	stw r0, 0(r30)
/* 8051C1C0  38 7E 00 14 */	addi r3, r30, 0x14
/* 8051C1C4  3C 80 80 52 */	lis r4, __dt__14dFlower_data_cFv@ha
/* 8051C1C8  38 84 2F CC */	addi r4, r4, __dt__14dFlower_data_cFv@l
/* 8051C1CC  38 A0 00 48 */	li r5, 0x48
/* 8051C1D0  38 C0 03 E8 */	li r6, 0x3e8
/* 8051C1D4  4B E4 5B 14 */	b __destroy_arr
/* 8051C1D8  28 1E 00 00 */	cmplwi r30, 0
/* 8051C1DC  41 82 00 10 */	beq lbl_8051C1EC
/* 8051C1E0  3C 60 80 3D */	lis r3, __vt__9J3DPacket@ha
/* 8051C1E4  38 03 D9 7C */	addi r0, r3, __vt__9J3DPacket@l
...
/* 8051C1F8  4B DB 2B 44 */	b __dl__FPv
lbl_8051C1FC:
