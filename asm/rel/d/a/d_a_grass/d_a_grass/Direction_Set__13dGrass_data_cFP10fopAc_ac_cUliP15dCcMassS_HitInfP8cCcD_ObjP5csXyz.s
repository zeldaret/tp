...
/* 8051DF6C  4B E4 42 69 */	bl _savegpr_27
...
/* 8051DF80  3C 60 80 52 */	lis r3, lit_3999@ha /* 0x80523028@ha */
/* 8051DF84  3B C3 30 28 */	addi r30, r3, lit_3999@l /* 0x80523028@l */
...
/* 8051DFD0  4B E2 91 69 */	bl PSVECSquareMag
...
/* 8051DFE4  4B B6 67 B9 */	bl dCcD_GetGObjInf__FP8cCcD_Obj
...
/* 8051E014  4B E2 91 25 */	bl PSVECSquareMag
/* 8051E018  FF E0 08 90 */	fmr f31, f1
/* 8051E01C  FC 00 0A 10 */	fabs f0, f1
/* 8051E020  FC 20 00 18 */	frsp f1, f0
/* 8051E024  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 8051E028  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 8051E074  4B E2 90 65 */	bl PSVECScale
...
/* 8051E094  4B E2 90 A5 */	bl PSVECSquareMag
...
/* 8051E0E4  4B E2 90 55 */	bl PSVECSquareMag
/* 8051E0E8  FF E0 08 90 */	fmr f31, f1
lbl_8051E0EC:
/* 8051E0EC  FC 00 FA 10 */	fabs f0, f31
/* 8051E0F0  FC 20 00 18 */	frsp f1, f0
/* 8051E0F4  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 8051E0F8  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 8051E10C  4B D4 95 69 */	bl cM_atan2s__Fff
/* 8051E110  7C 7D 1B 78 */	mr r29, r3
lbl_8051E114:
/* 8051E114  4B D4 97 59 */	bl cM_rnd__Fv
...
/* 8051E164  4B D4 95 11 */	bl cM_atan2s__Fff
...
/* 8051E1B4  4B E4 40 6D */	bl _restgpr_27
