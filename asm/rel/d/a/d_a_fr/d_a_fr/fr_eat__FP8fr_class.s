...
/* 8051A840  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 8051A844  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8051A848  38 81 00 08 */	addi r4, r1, 8
/* 8051A84C  4B AF EF AD */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 8051A850  7C 7F 1B 79 */	or. r31, r3, r3
/* 8051A854  40 82 00 10 */	bne lbl_8051A864
/* 8051A858  7F C3 F3 78 */	mr r3, r30
/* 8051A85C  4B AF F4 21 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 8051A890  3C A0 80 52 */	lis r5, lit_3650@ha /* 0x8051B9CC@ha */
/* 8051A894  C0 25 B9 CC */	lfs f1, lit_3650@l(r5)  /* 0x8051B9CC@l */
/* 8051A898  38 A0 00 02 */	li r5, 2
/* 8051A89C  3C C0 80 52 */	lis r6, lit_3669@ha /* 0x8051B9E4@ha */
/* 8051A8A0  C0 46 B9 E4 */	lfs f2, lit_3669@l(r6)  /* 0x8051B9E4@l */
/* 8051A8A4  4B FF F0 A9 */	bl anm_init__FP8fr_classifUcf
/* 8051A8A8  38 00 00 14 */	li r0, 0x14
/* 8051A8AC  B0 1E 05 DC */	sth r0, 0x5dc(r30)
lbl_8051A8B0:
/* 8051A8B0  3C 60 80 52 */	lis r3, lit_3669@ha /* 0x8051B9E4@ha */
/* 8051A8B4  C0 03 B9 E4 */	lfs f0, lit_3669@l(r3)  /* 0x8051B9E4@l */
...
/* 8051A8E8  4B AF F3 95 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_8051A8EC:
