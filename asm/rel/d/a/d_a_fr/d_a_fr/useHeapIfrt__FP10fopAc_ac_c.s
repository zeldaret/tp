...
/* 8051B3C0  4B E4 6E 19 */	bl _savegpr_28
/* 8051B3C4  7C 7F 1B 78 */	mr r31, r3
/* 8051B3C8  38 60 00 54 */	li r3, 0x54
/* 8051B3CC  4B DB 38 81 */	bl __nw__FUl
/* 8051B3D0  7C 7E 1B 79 */	or. r30, r3, r3
/* 8051B3D4  41 82 00 9C */	beq lbl_8051B470
/* 8051B3D8  3C 60 80 52 */	lis r3, d_a_fr__stringBase0@ha /* 0x8051BA88@ha */
/* 8051B3DC  38 63 BA 88 */	addi r3, r3, d_a_fr__stringBase0@l /* 0x8051BA88@l */
/* 8051B3E0  38 80 00 0B */	li r4, 0xb
/* 8051B3E4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8051B3E8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8051B3FC  4B B2 0E F1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8051B400  7C 7D 1B 78 */	mr r29, r3
/* 8051B404  3C 60 80 52 */	lis r3, d_a_fr__stringBase0@ha /* 0x8051BA88@ha */
/* 8051B408  38 63 BA 88 */	addi r3, r3, d_a_fr__stringBase0@l /* 0x8051BA88@l */
/* 8051B40C  38 80 00 0E */	li r4, 0xe
/* 8051B410  7F 85 E3 78 */	mr r5, r28
/* 8051B414  38 C0 00 80 */	li r6, 0x80
/* 8051B418  4B B2 0E D5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8051B458  3D 20 80 52 */	lis r9, lit_3691@ha /* 0x8051B9EC@ha */
/* 8051B45C  C0 29 B9 EC */	lfs f1, lit_3691@l(r9)  /* 0x8051B9EC@l */
/* 8051B460  39 20 00 00 */	li r9, 0
/* 8051B464  39 40 FF FF */	li r10, -1
/* 8051B468  4B AF 47 E5 */	bl __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 8051B498  4B DB 37 B5 */	bl __nw__FUl
/* 8051B49C  7C 7E 1B 79 */	or. r30, r3, r3
/* 8051B4A0  41 82 00 20 */	beq lbl_8051B4C0
/* 8051B4A4  3C 80 80 52 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x8051BBEC@ha */
/* 8051B4A8  38 04 BB EC */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x8051BBEC@l */
/* 8051B4AC  90 1E 00 00 */	stw r0, 0(r30)
/* 8051B4B0  38 80 00 00 */	li r4, 0
/* 8051B4B4  4B E0 CF 49 */	bl init__12J3DFrameCtrlFs
...
lbl_8051B4D8:
/* 8051B4D8  3C 60 80 52 */	lis r3, d_a_fr__stringBase0@ha /* 0x8051BA88@ha */
/* 8051B4DC  38 63 BA 88 */	addi r3, r3, d_a_fr__stringBase0@l /* 0x8051BA88@l */
/* 8051B4E0  38 80 00 11 */	li r4, 0x11
/* 8051B4E4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8051B4E8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8051B4EC  3C A5 00 02 */	addis r5, r5, 2
/* 8051B4F0  38 C0 00 80 */	li r6, 0x80
/* 8051B4F4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8051B4F8  4B B2 0D F5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8051B51C  3D 00 80 52 */	lis r8, lit_3691@ha /* 0x8051B9EC@ha */
/* 8051B520  C0 28 B9 EC */	lfs f1, lit_3691@l(r8)  /* 0x8051B9EC@l */
/* 8051B524  39 00 00 00 */	li r8, 0
/* 8051B528  39 20 FF FF */	li r9, -1
/* 8051B52C  4B AF 21 11 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 8051B530  30 03 FF FF */	addic r0, r3, -1
/* 8051B534  7C 60 19 10 */	subfe r3, r0, r3
lbl_8051B538:
/* 8051B538  39 61 00 30 */	addi r11, r1, 0x30
/* 8051B53C  4B E4 6C E9 */	bl _restgpr_28
