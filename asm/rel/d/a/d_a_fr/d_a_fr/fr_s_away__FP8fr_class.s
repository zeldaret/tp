...
/* 8051A630  4B E4 7B AD */	bl _savegpr_29
/* 8051A634  7C 7E 1B 78 */	mr r30, r3
/* 8051A638  3C 60 80 52 */	lis r3, lit_3649@ha /* 0x8051B9C8@ha */
/* 8051A63C  3B E3 B9 C8 */	addi r31, r3, lit_3649@l /* 0x8051B9C8@l */
...
/* 8051A668  4B D4 D2 ED */	bl cM_rndF__Ff
...
/* 8051A6C0  3C 60 80 52 */	lis r3, l_HIO@ha /* 0x8051BC20@ha */
/* 8051A6C4  38 63 BC 20 */	addi r3, r3, l_HIO@l /* 0x8051BC20@l */
...
/* 8051A6DC  4B D5 53 61 */	bl cLib_addCalc2__FPffff
...
/* 8051A740  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8051A744  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8051A748  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8051A74C  4B AF FF C5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8051A750  7C 7D 1B 78 */	mr r29, r3
/* 8051A754  C0 3F 00 64 */	lfs f1, 0x64(r31)
/* 8051A758  4B D4 D2 35 */	bl cM_rndFX__Ff
...
/* 8051A784  4B D5 5E 85 */	bl cLib_addCalcAngleS2__FPssss
lbl_8051A788:
/* 8051A788  C0 5E 05 D8 */	lfs f2, 0x5d8(r30)
/* 8051A78C  C0 3F 00 68 */	lfs f1, 0x68(r31)
/* 8051A790  3C 60 80 52 */	lis r3, l_HIO@ha /* 0x8051BC20@ha */
/* 8051A794  38 63 BC 20 */	addi r3, r3, l_HIO@l /* 0x8051BC20@l */
...
/* 8051A7F4  3C 80 80 52 */	lis r4, l_HIO@ha /* 0x8051BC20@ha */
/* 8051A7F8  38 84 BC 20 */	addi r4, r4, l_HIO@l /* 0x8051BC20@l */
/* 8051A7FC  C0 04 00 28 */	lfs f0, 0x28(r4)
/* 8051A800  EC 42 00 32 */	fmuls f2, f2, f0
/* 8051A804  4B D5 52 7D */	bl cLib_addCalc0__FPfff
lbl_8051A808:
/* 8051A808  39 61 00 20 */	addi r11, r1, 0x20
/* 8051A80C  4B E4 7A 1D */	bl _restgpr_29
