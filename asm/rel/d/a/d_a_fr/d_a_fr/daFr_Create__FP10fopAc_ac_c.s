...
/* 8051B5A8  4B E4 6C 31 */	bl _savegpr_28
/* 8051B5AC  7C 7E 1B 78 */	mr r30, r3
/* 8051B5B0  3C 80 80 52 */	lis r4, lit_3649@ha /* 0x8051B9C8@ha */
/* 8051B5B4  3B E4 B9 C8 */	addi r31, r4, lit_3649@l /* 0x8051B9C8@l */
...
/* 8051B5D0  4B AF D5 95 */	bl __ct__10fopAc_ac_cFv
/* 8051B5D4  38 7D 06 04 */	addi r3, r29, 0x604
/* 8051B5D8  4B B5 A8 D5 */	bl __ct__12dBgS_AcchCirFv
/* 8051B5DC  3B 9D 06 44 */	addi r28, r29, 0x644
/* 8051B5E0  7F 83 E3 78 */	mr r3, r28
/* 8051B5E4  4B B5 AA BD */	bl __ct__9dBgS_AcchFv
/* 8051B5E8  3C 60 80 52 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x8051BBC8@ha */
/* 8051B5EC  38 63 BB C8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x8051BBC8@l */
...
/* 8051B608  4B B5 D8 61 */	bl SetObj__16dBgS_PolyPassChkFv
/* 8051B60C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 8051B610  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 8051B614  90 1D 08 34 */	stw r0, 0x834(r29)
/* 8051B618  38 7D 08 38 */	addi r3, r29, 0x838
/* 8051B61C  4B B6 81 45 */	bl __ct__10dCcD_GSttsFv
/* 8051B620  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 8051B624  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 8051B63C  4B B6 83 ED */	bl __ct__12dCcD_GObjInfFv
/* 8051B640  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8051B644  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8051B648  90 1C 01 20 */	stw r0, 0x120(r28)
/* 8051B64C  3C 60 80 52 */	lis r3, __vt__8cM3dGAab@ha /* 0x8051BBBC@ha */
/* 8051B650  38 03 BB BC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8051BBBC@l */
/* 8051B654  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 8051B658  3C 60 80 52 */	lis r3, __vt__8cM3dGSph@ha /* 0x8051BBB0@ha */
/* 8051B65C  38 03 BB B0 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x8051BBB0@l */
/* 8051B660  90 1C 01 34 */	stw r0, 0x134(r28)
/* 8051B664  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 8051B668  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 8051B66C  90 7C 01 20 */	stw r3, 0x120(r28)
/* 8051B670  38 03 00 58 */	addi r0, r3, 0x58
/* 8051B674  90 1C 01 34 */	stw r0, 0x134(r28)
/* 8051B678  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 8051B67C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 8051B698  4B D2 E8 69 */	bl __ct__10dMsgFlow_cFv
lbl_8051B69C:
...
/* 8051B6AC  3C 80 80 52 */	lis r4, d_a_fr__stringBase0@ha /* 0x8051BA88@ha */
/* 8051B6B0  38 84 BA 88 */	addi r4, r4, d_a_fr__stringBase0@l /* 0x8051BA88@l */
/* 8051B6B4  4B B1 18 09 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8051B6E8  3C 80 80 52 */	lis r4, useHeapIfrt__FP10fopAc_ac_c@ha /* 0x8051B3B0@ha */
/* 8051B6EC  38 84 B3 B0 */	addi r4, r4, useHeapIfrt__FP10fopAc_ac_c@l /* 0x8051B3B0@l */
/* 8051B6F0  38 A0 14 E0 */	li r5, 0x14e0
/* 8051B6F4  4B AF ED BD */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_8051B708:
/* 8051B708  3C 60 80 52 */	lis r3, data_8051BC10@ha /* 0x8051BC10@ha */
/* 8051B70C  8C 03 BC 10 */	lbzu r0, data_8051BC10@l(r3)  /* 0x8051BC10@l */
...
/* 8051B728  3C 60 80 52 */	lis r3, l_HIO@ha /* 0x8051BC20@ha */
/* 8051B72C  38 63 BC 20 */	addi r3, r3, l_HIO@l /* 0x8051BC20@l */
...
/* 8051B744  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8051B748  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8051B74C  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8051B750  3C 80 80 52 */	lis r4, d_a_fr__stringBase0@ha /* 0x8051BA88@ha */
/* 8051B754  38 84 BA 88 */	addi r4, r4, d_a_fr__stringBase0@l /* 0x8051BA88@l */
/* 8051B758  38 84 00 03 */	addi r4, r4, 3
/* 8051B75C  4B E4 D2 39 */	bl strcmp
...
/* 8051B7A8  4B B5 AA A1 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 8051B7AC  38 7E 06 04 */	addi r3, r30, 0x604
/* 8051B7B0  C0 3F 00 04 */	lfs f1, 4(r31)
/* 8051B7B4  FC 40 08 90 */	fmr f2, f1
/* 8051B7B8  4B B5 A7 A1 */	bl SetWall__12dBgS_AcchCirFff
...
/* 8051B7E8  4B D4 C1 6D */	bl cM_rndF__Ff
...
/* 8051B80C  4B E4 6A 19 */	bl _restgpr_28
