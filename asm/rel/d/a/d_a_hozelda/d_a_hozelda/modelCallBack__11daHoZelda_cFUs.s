...
/* 80846728  4B B1 BA B4 */	b _savegpr_29
...
/* 8084679C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 808467A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 808467A4  C0 26 00 14 */	lfs f1, 0x14(r6)
/* 808467A8  C0 46 00 18 */	lfs f2, 0x18(r6)
/* 808467AC  C0 66 00 1C */	lfs f3, 0x1c(r6)
/* 808467B0  4B B0 01 38 */	b PSMTXTrans
/* 808467B4  80 7E 05 C4 */	lwz r3, 0x5c4(r30)
/* 808467B8  80 63 00 20 */	lwz r3, 0x20(r3)
/* 808467BC  4B 7C 67 C0 */	b quatM__14mDoMtx_stack_cFPC10Quaternion
/* 808467C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 808467C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 808467C8  7C 64 1B 78 */	mr r4, r3
/* 808467CC  4B AF FD E4 */	b PSMTXInverse
...
/* 808467E0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 808467E4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 808467E8  3C A0 80 43 */	lis r5, mCurrentMtx__6J3DSys@ha
/* 808467EC  38 A5 4B E4 */	addi r5, r5, mCurrentMtx__6J3DSys@l
/* 808467F0  4B AF FC F4 */	b PSMTXConcat
/* 808467F4  80 7E 05 C4 */	lwz r3, 0x5c4(r30)
/* 808467F8  80 83 00 20 */	lwz r4, 0x20(r3)
/* 808467FC  7F E3 FB 78 */	mr r3, r31
/* 80846800  4B B0 01 E8 */	b PSMTXQuat
...
/* 8084681C  3C 60 80 43 */	lis r3, mCurrentMtx__6J3DSys@ha
/* 80846820  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l
/* 80846824  7F E4 FB 78 */	mr r4, r31
/* 80846828  7C 65 1B 78 */	mr r5, r3
/* 8084682C  4B AF FC B8 */	b PSMTXConcat
/* 80846830  3C 60 80 43 */	lis r3, mCurrentMtx__6J3DSys@ha
/* 80846834  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l
/* 80846838  7F E4 FB 78 */	mr r4, r31
/* 8084683C  4B AF FC 74 */	b PSMTXCopy
...
lbl_80846858:
/* 80846858  3C 60 80 85 */	lis r3, lit_3722@ha
/* 8084685C  C0 03 8E 58 */	lfs f0, lit_3722@l(r3)
...
lbl_80846888:
/* 80846888  3C 60 80 85 */	lis r3, lit_3697@ha
/* 8084688C  C0 03 8E 54 */	lfs f0, lit_3697@l(r3)
...
/* 808468AC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 808468B0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 808468B4  4B AF FB FC */	b PSMTXCopy
/* 808468B8  57 A0 04 3E */	clrlwi r0, r29, 0x10
/* 808468BC  28 00 00 01 */	cmplwi r0, 1
/* 808468C0  40 82 00 34 */	bne lbl_808468F4
/* 808468C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 808468C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 808468CC  A8 9E 06 F4 */	lha r4, 0x6f4(r30)
/* 808468D0  4B 7C 5A CC */	b mDoMtx_XrotM__FPA4_fs
/* 808468D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 808468D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 808468EC  4B 7C 5B E0 */	b mDoMtx_ZrotM__FPA4_fs
/* 808468F0  48 00 00 2C */	b lbl_8084691C
lbl_808468F4:
/* 808468F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 808468F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 808468FC  A8 9E 06 EE */	lha r4, 0x6ee(r30)
/* 80846900  4B 7C 5A 9C */	b mDoMtx_XrotM__FPA4_fs
/* 80846904  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80846908  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8084690C  A8 1E 06 EC */	lha r0, 0x6ec(r30)
/* 80846910  7C 00 00 D0 */	neg r0, r0
/* 80846914  7C 04 07 34 */	extsh r4, r0
/* 80846918  4B 7C 5B B4 */	b mDoMtx_ZrotM__FPA4_fs
lbl_8084691C:
/* 8084691C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80846920  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80846934  4B AF FB 7C */	b PSMTXCopy
...
/* 80846948  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 8084694C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80846950  4B AF FB 60 */	b PSMTXCopy
lbl_80846954:
/* 80846954  39 61 00 40 */	addi r11, r1, 0x40
/* 80846958  4B B1 B8 D0 */	b _restgpr_29
