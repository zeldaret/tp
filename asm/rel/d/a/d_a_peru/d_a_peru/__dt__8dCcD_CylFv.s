...
/* 80D4B070  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80D4B074  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80D4B094  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80D4B098  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80D4B0B0  3C 60 80 D5 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80D4C684@ha */
/* 80D4B0B4  38 03 C6 84 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80D4C684@l */
/* 80D4B0B8  90 1E 01 38 */	stw r0, 0x138(r30)
lbl_80D4B0BC:
/* 80D4B0BC  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80D4B0C0  41 82 00 24 */	beq lbl_80D4B0E4
/* 80D4B0C4  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80D4B0C8  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80D4B0CC  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80D4B0D0  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80D4B0D4  41 82 00 10 */	beq lbl_80D4B0E4
/* 80D4B0D8  3C 60 80 D5 */	lis r3, __vt__8cM3dGAab@ha /* 0x80D4C678@ha */
/* 80D4B0DC  38 03 C6 78 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80D4C678@l */
/* 80D4B0E0  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_80D4B0E4:
/* 80D4B0E4  7F C3 F3 78 */	mr r3, r30
/* 80D4B0E8  38 80 00 00 */	li r4, 0
/* 80D4B0EC  4B 33 8F F9 */	bl __dt__12dCcD_GObjInfFv
/* 80D4B0F0  7F E0 07 35 */	extsh. r0, r31
/* 80D4B0F4  40 81 00 0C */	ble lbl_80D4B100
/* 80D4B0F8  7F C3 F3 78 */	mr r3, r30
/* 80D4B0FC  4B 58 3C 41 */	bl __dl__FPv
lbl_80D4B100:
