...
/* 80667E78  4B CF A3 61 */	bl _savegpr_28
/* 80667E7C  2C 04 00 00 */	cmpwi r4, 0
/* 80667E80  40 82 01 48 */	bne lbl_80667FC8
/* 80667E84  A3 83 00 14 */	lhz r28, 0x14(r3)
/* 80667E88  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80667E8C  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80667EB0  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80667EB4  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80667EB8  80 84 00 00 */	lwz r4, 0(r4)
/* 80667EBC  4B CD E5 F5 */	bl PSMTXCopy
...
lbl_80667ED0:
/* 80667ED0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667ED4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80667EEC  4B 9A 45 49 */	bl mDoMtx_YrotM__FPA4_fs
/* 80667EF0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667EF4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80667F0C  4B 9A 44 91 */	bl mDoMtx_XrotM__FPA4_fs
/* 80667F10  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667F14  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80667F18  80 63 00 00 */	lwz r3, 0(r3)
/* 80667F1C  A8 9D 06 0E */	lha r4, 0x60e(r29)
/* 80667F20  4B 9A 45 AD */	bl mDoMtx_ZrotM__FPA4_fs
/* 80667F24  48 00 00 70 */	b lbl_80667F94
lbl_80667F28:
/* 80667F28  2C 1C 00 16 */	cmpwi r28, 0x16
/* 80667F2C  40 82 00 40 */	bne lbl_80667F6C
/* 80667F30  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667F34  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80667F48  4B 9A 44 ED */	bl mDoMtx_YrotM__FPA4_fs
/* 80667F4C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667F50  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80667F64  4B 9A 45 69 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80667F68  48 00 00 2C */	b lbl_80667F94
lbl_80667F6C:
/* 80667F6C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667F70  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80667F74  80 63 00 00 */	lwz r3, 0(r3)
/* 80667F78  A8 9D 06 40 */	lha r4, 0x640(r29)
/* 80667F7C  4B 9A 44 B9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80667F80  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667F84  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80667F88  80 63 00 00 */	lwz r3, 0(r3)
/* 80667F8C  A8 9D 06 3E */	lha r4, 0x63e(r29)
/* 80667F90  4B 9A 45 3D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80667F94:
/* 80667F94  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667F98  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80667FAC  4B CD E5 05 */	bl PSMTXCopy
/* 80667FB0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80667FB4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80667FB8  80 63 00 00 */	lwz r3, 0(r3)
/* 80667FBC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80667FC0  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80667FC4  4B CD E4 ED */	bl PSMTXCopy
lbl_80667FC8:
/* 80667FC8  38 60 00 01 */	li r3, 1
/* 80667FCC  39 61 00 20 */	addi r11, r1, 0x20
/* 80667FD0  4B CF A2 55 */	bl _restgpr_28
