...
/* 8066BD5C  4B CF 64 75 */	bl _savegpr_26
/* 8066BD60  7C 7D 1B 78 */	mr r29, r3
/* 8066BD64  3C 60 80 67 */	lis r3, lit_3662@ha /* 0x8066EDE8@ha */
/* 8066BD68  3B C3 ED E8 */	addi r30, r3, lit_3662@l /* 0x8066EDE8@l */
/* 8066BD6C  3B 80 00 01 */	li r28, 1
/* 8066BD70  38 00 00 0A */	li r0, 0xa
/* 8066BD74  B0 1D 06 04 */	sth r0, 0x604(r29)
/* 8066BD78  3C 60 80 67 */	lis r3, s_c_sub__FPvPv@ha /* 0x8066B774@ha */
/* 8066BD7C  38 63 B7 74 */	addi r3, r3, s_c_sub__FPvPv@l /* 0x8066B774@l */
/* 8066BD80  7F A4 EB 78 */	mr r4, r29
/* 8066BD84  4B 9B 55 B5 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 8066BDBC  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8066BDC0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8066BDC4  80 84 00 00 */	lwz r4, 0(r4)
/* 8066BDC8  4B CD A6 E9 */	bl PSMTXCopy
...
/* 8066BE74  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066BE78  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8066BEE4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066BEE8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8066BEEC:
/* 8066BEEC  FF E0 08 90 */	fmr f31, f1
/* 8066BEF0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066BEF4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8066BF34  3C 60 80 67 */	lis r3, lit_5348@ha /* 0x8066F0C4@ha */
/* 8066BF38  38 63 F0 C4 */	addi r3, r3, lit_5348@l /* 0x8066F0C4@l */
...
/* 8066C020  4B BF AB 15 */	bl __mi__4cXyzCFRC3Vec
...
/* 8066C040  4B CD B0 F9 */	bl PSVECSquareMag
...
/* 8066C0B0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066C0B4  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8066C120  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066C124  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8066C138  4B BF B5 3D */	bl cM_atan2s__Fff
/* 8066C13C  7C 64 1B 78 */	mr r4, r3
/* 8066C140  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8066C144  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8066C148  80 63 00 00 */	lwz r3, 0(r3)
/* 8066C14C  4B 9A 02 91 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8066C178  4B C0 4D 75 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8066C19C  4B C0 38 A1 */	bl cLib_addCalc2__FPffff
...
/* 8066C1C0  4B C0 38 7D */	bl cLib_addCalc2__FPffff
...
/* 8066C208  4B BF A9 2D */	bl __mi__4cXyzCFRC3Vec
/* 8066C20C  38 61 00 28 */	addi r3, r1, 0x28
/* 8066C210  4B CD AF 29 */	bl PSVECSquareMag
...
/* 8066C280  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066C284  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8066C2F0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066C2F4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8066C2F8:
...
/* 8066C368  4B C0 42 A1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066C404  4B BF B5 51 */	bl cM_rndF__Ff
...
/* 8066C420  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8066C424  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8066C428  80 63 00 00 */	lwz r3, 0(r3)
/* 8066C42C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 8066C430  4B 99 FF AD */	bl mDoMtx_YrotS__FPA4_fs
/* 8066C434  C0 3E 00 80 */	lfs f1, 0x80(r30)
/* 8066C438  4B BF B5 55 */	bl cM_rndFX__Ff
/* 8066C43C  D0 21 00 58 */	stfs f1, 0x58(r1)
/* 8066C440  C0 3E 00 24 */	lfs f1, 0x24(r30)
/* 8066C444  4B BF B5 11 */	bl cM_rndF__Ff
...
/* 8066C4B4  4B C0 41 55 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066C5CC  4B BF A5 69 */	bl __mi__4cXyzCFRC3Vec
...
/* 8066C5E8  4B BF B0 8D */	bl cM_atan2s__Fff
...
/* 8066C5FC  4B C0 40 0D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066C6DC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8066C6E0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8066C6E4  80 63 00 00 */	lwz r3, 0(r3)
/* 8066C6E8  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8066C6EC  4B 99 FC F1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8066C7A4  4B A0 B4 C5 */	bl __ct__11dBgS_LinChkFv
...
/* 8066C7B8  4B A0 B5 AD */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8066C7BC  38 00 00 01 */	li r0, 1
/* 8066C7C0  98 1D 0C 80 */	stb r0, 0xc80(r29)
/* 8066C7C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066C7C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8066C7CC  3B 43 0F 38 */	addi r26, r3, 0xf38
/* 8066C7D0  7F 43 D3 78 */	mr r3, r26
/* 8066C7D4  38 81 00 64 */	addi r4, r1, 0x64
/* 8066C7D8  4B A0 7B DD */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8066C7F4  4B A0 B5 71 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8066C7F8  7F 43 D3 78 */	mr r3, r26
/* 8066C7FC  38 81 00 64 */	addi r4, r1, 0x64
/* 8066C800  4B A0 7B B5 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8066C81C  4B A0 B5 49 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8066C820  7F 43 D3 78 */	mr r3, r26
/* 8066C824  38 81 00 64 */	addi r4, r1, 0x64
/* 8066C828  4B A0 7B 8D */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8066C864  4B A0 B4 79 */	bl __dt__11dBgS_LinChkFv
lbl_8066C868:
...
/* 8066C880  4B CF 59 9D */	bl _restgpr_26
