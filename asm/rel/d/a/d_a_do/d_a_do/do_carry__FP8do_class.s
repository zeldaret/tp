...
/* 8066CAB8  4B CF 57 21 */	bl _savegpr_28
/* 8066CABC  7C 7E 1B 78 */	mr r30, r3
/* 8066CAC0  3C 60 80 67 */	lis r3, lit_3662@ha /* 0x8066EDE8@ha */
/* 8066CAC4  3B E3 ED E8 */	addi r31, r3, lit_3662@l /* 0x8066EDE8@l */
...
lbl_8066CAFC:
/* 8066CAFC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066CB00  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8066CB9C  4B CB B8 91 */	bl checkPass__12J3DFrameCtrlFf
...
lbl_8066CBD4:
/* 8066CBD4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066CBD8  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8066CC88  4B A0 A8 F5 */	bl __ct__11dBgS_GndChkFv
...
/* 8066CCB8  4B BF B0 71 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 8066CCBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066CCC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8066CCC4  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 8066CCC8  7F 83 E3 78 */	mr r3, r28
/* 8066CCCC  38 81 00 94 */	addi r4, r1, 0x94
/* 8066CCD0  4B A0 77 D1 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8066CCF8  4B A0 77 A9 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8066CD10  4B A0 A8 E1 */	bl __dt__11dBgS_GndChkFv
lbl_8066CD14:
...
lbl_8066CD44:
/* 8066CD44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066CD48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8066CD4C  83 83 5D AC */	lwz r28, 0x5dac(r3)
/* 8066CD50  38 61 00 24 */	addi r3, r1, 0x24
/* 8066CD54  4B A0 AF 15 */	bl __ct__11dBgS_LinChkFv
...
/* 8066CD8C  4B A0 AF D9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8066CD90  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066CD94  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8066CD98  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8066CD9C  38 81 00 24 */	addi r4, r1, 0x24
/* 8066CDA0  4B A0 76 15 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8066CDCC  4B A0 AF 11 */	bl __dt__11dBgS_LinChkFv
/* 8066CDD0  7F A3 EB 78 */	mr r3, r29
/* 8066CDD4  39 61 01 10 */	addi r11, r1, 0x110
/* 8066CDD8  4B CF 54 4D */	bl _restgpr_28
