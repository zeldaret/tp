...
/* 8066CED4  4B CF 52 ED */	bl _savegpr_22
/* 8066CED8  7C 7D 1B 78 */	mr r29, r3
/* 8066CEDC  3C 80 80 67 */	lis r4, lit_1109@ha /* 0x8066F278@ha */
/* 8066CEE0  3B C4 F2 78 */	addi r30, r4, lit_1109@l /* 0x8066F278@l */
/* 8066CEE4  3C 80 80 67 */	lis r4, lit_3662@ha /* 0x8066EDE8@ha */
/* 8066CEE8  3B E4 ED E8 */	addi r31, r4, lit_3662@l /* 0x8066EDE8@l */
/* 8066CEEC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066CEF0  3B 04 61 C0 */	addi r24, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8066CF04  4B 9A D8 DD */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8066CF40  4B 9A D7 D1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8066CF60  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 8066CF64  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
...
/* 8066CFE8  3C 60 80 67 */	lis r3, lit_5955@ha /* 0x8066F0EC@ha */
/* 8066CFEC  38 63 F0 EC */	addi r3, r3, lit_5955@l /* 0x8066F0EC@l */
...
/* 8066D11C  4B 9B 00 D9 */	bl fopAcM_riverStream__FP4cXyzPsPff
...
/* 8066D1A8  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 8066D1AC  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8066D1B0  38 81 00 20 */	addi r4, r1, 0x20
/* 8066D1B4  4B 9A C6 45 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 8066D1B8  28 03 00 00 */	cmplwi r3, 0
/* 8066D1BC  41 82 00 08 */	beq lbl_8066D1C4
/* 8066D1C0  4B 9C AA 45 */	bl endControl__8daItem_cFv
lbl_8066D1C4:
...
/* 8066D22C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066D230  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8066D2B8  4B C0 33 51 */	bl cLib_addCalcAngleS2__FPssss
/* 8066D2BC  A8 1D 05 F2 */	lha r0, 0x5f2(r29)
/* 8066D2C0  2C 00 00 1E */	cmpwi r0, 0x1e
/* 8066D2C4  41 82 02 C0 */	beq lbl_8066D584
/* 8066D2C8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8066D2CC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8066D2D0  80 63 00 00 */	lwz r3, 0(r3)
/* 8066D2D4  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 8066D2D8  4B 99 F1 05 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8066D314  4B C0 3B D9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8066D344  4B CD 9D 4D */	bl PSVECAdd
...
/* 8066D43C  4B A0 8B 1D */	bl SetWall__12dBgS_AcchCirFff
/* 8066D440  38 7D 06 FC */	addi r3, r29, 0x6fc
/* 8066D444  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066D448  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8066D44C  3B 04 0F 38 */	addi r24, r4, 0xf38
/* 8066D450  7F 04 C3 78 */	mr r4, r24
/* 8066D454  4B A0 96 59 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 8066D480  4B A0 A0 FD */	bl __ct__11dBgS_GndChkFv
/* 8066D484  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8066D488  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8066D48C  80 63 00 00 */	lwz r3, 0(r3)
/* 8066D490  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 8066D494  4B 99 EF 49 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8066D4F8  4B BF A8 15 */	bl SetPos__11cBgS_GndChkFPC3Vec
/* 8066D4FC  7F 03 C3 78 */	mr r3, r24
/* 8066D500  38 81 00 8C */	addi r4, r1, 0x8c
/* 8066D504  4B A0 6F 9D */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8066D518  4B BF 96 1D */	bl __mi__4cXyzCFRC3Vec
...
/* 8066D6C4  3C 80 80 67 */	lis r4, __dt__4cXyzFv@ha /* 0x80668134@ha */
/* 8066D6C8  38 84 81 34 */	addi r4, r4, __dt__4cXyzFv@l /* 0x80668134@l */
...
/* 8066D6E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066D6EC  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8066D6F0  3C 60 80 67 */	lis r3, w_eff_id@ha /* 0x8066F0E4@ha */
/* 8066D6F4  3B 63 F0 E4 */	addi r27, r3, w_eff_id@l /* 0x8066F0E4@l */
lbl_8066D6F8:
...
/* 8066D744  4B 9D FD 89 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8066D794  4B BF A1 C1 */	bl cM_rndF__Ff
...
/* 8066D7E8  4B C0 2E 21 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066D7FC  4B C0 2E 0D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066D870  4B BF 92 C5 */	bl __mi__4cXyzCFRC3Vec
...
/* 8066D89C  4B BF 92 99 */	bl __mi__4cXyzCFRC3Vec
...
/* 8066D8D8  4B BF 9D 9D */	bl cM_atan2s__Fff
...
/* 8066D914  4B BF 9D 61 */	bl cM_atan2s__Fff
...
/* 8066D9AC  4B C0 2C 5D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066D9CC  4B C0 2C 3D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066D9E0  4B C0 2C 29 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066D9F4  4B C0 2C 15 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066DA08  4B C0 2C 01 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066DA5C  4B BF 9E F9 */	bl cM_rndF__Ff
...
/* 8066DA7C  4B BF 9E D9 */	bl cM_rndF__Ff
...
/* 8066DA90  4B BF 9E FD */	bl cM_rndFX__Ff
...
/* 8066DAA8  4B BF 9E AD */	bl cM_rndF__Ff
...
/* 8066DABC  4B BF 9E D1 */	bl cM_rndFX__Ff
...
/* 8066DAE4  4B BF 9E 71 */	bl cM_rndF__Ff
...
/* 8066DB38  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8066DB3C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8066DBCC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8066DBD0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8066DC98  4B C0 1D A5 */	bl cLib_addCalc2__FPffff
...
/* 8066DCC0  4B C0 29 49 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066DCE8  4B BF 9C 6D */	bl cM_rndF__Ff
...
/* 8066DD34  4B CF 44 D9 */	bl _restgpr_22
