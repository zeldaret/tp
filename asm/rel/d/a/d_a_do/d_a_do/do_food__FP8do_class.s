...
/* 8066AB88  4B CF 76 4D */	bl _savegpr_27
/* 8066AB8C  7C 7C 1B 78 */	mr r28, r3
/* 8066AB90  3C 60 80 67 */	lis r3, lit_3662@ha /* 0x8066EDE8@ha */
/* 8066AB94  3B C3 ED E8 */	addi r30, r3, lit_3662@l /* 0x8066EDE8@l */
/* 8066AB98  80 1C 06 84 */	lwz r0, 0x684(r28)
/* 8066AB9C  90 01 00 10 */	stw r0, 0x10(r1)
/* 8066ABA0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 8066ABA4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8066ABA8  38 81 00 10 */	addi r4, r1, 0x10
/* 8066ABAC  4B 9A EC 4D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 8066ABB0  7C 7F 1B 79 */	or. r31, r3, r3
/* 8066ABB4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066ABB8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8066AC3C  3C 60 80 67 */	lis r3, lit_4969@ha /* 0x8066F05C@ha */
/* 8066AC40  38 63 F0 5C */	addi r3, r3, lit_4969@l /* 0x8066F05C@l */
...
/* 8066AC60  4B BF CC F5 */	bl cM_rndF__Ff
...
/* 8066ACA8  4B BF CC AD */	bl cM_rndF__Ff
...
/* 8066ACBC  4B BF CC D1 */	bl cM_rndFX__Ff
...
/* 8066ACE8  4B BF CC 6D */	bl cM_rndF__Ff
...
/* 8066AD0C  4B BF CC 49 */	bl cM_rndF__Ff
...
/* 8066AD2C  4B BF CC 61 */	bl cM_rndFX__Ff
...
/* 8066AD44  4B BF CC 11 */	bl cM_rndF__Ff
...
/* 8066AD6C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8066AD70  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8066AD74  80 63 00 00 */	lwz r3, 0(r3)
/* 8066AD78  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 8066AD7C  4B 9A 16 61 */	bl mDoMtx_YrotS__FPA4_fs
/* 8066AD80  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 8066AD84  4B BF CC 09 */	bl cM_rndFX__Ff
...
/* 8066AD98  4B BF CB BD */	bl cM_rndF__Ff
...
/* 8066ADD4  4B C0 4C 69 */	bl cLib_addCalc2__FPffff
...
/* 8066ADE8  4B C0 4C 55 */	bl cLib_addCalc2__FPffff
...
/* 8066AE08  4B C0 58 01 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066AE1C  4B C0 57 ED */	bl cLib_addCalcAngleS2__FPssss
lbl_8066AE20:
...
/* 8066AE44  4B BF CB 11 */	bl cM_rndF__Ff
...
/* 8066AE5C  4B BF CA F9 */	bl cM_rndF__Ff
...
/* 8066AEF4  4B BF CA 61 */	bl cM_rndF__Ff
...
/* 8066AF88  4B C0 4A B5 */	bl cLib_addCalc2__FPffff
/* 8066AF8C  C0 1C 05 E8 */	lfs f0, 0x5e8(r28)
/* 8066AF90  80 7C 05 D0 */	lwz r3, 0x5d0(r28)
/* 8066AF94  D0 03 00 18 */	stfs f0, 0x18(r3)
/* 8066AF98  3C 60 80 67 */	lis r3, l_HIO@ha /* 0x8066F2C4@ha */
/* 8066AF9C  3B A3 F2 C4 */	addi r29, r3, l_HIO@l /* 0x8066F2C4@l */
...
/* 8066AFF0  4B CD C1 49 */	bl PSVECSquareMag
...
/* 8066B060  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066B064  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8066B0D0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066B0D4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8066B0D8:
...
/* 8066B11C  4B C0 49 21 */	bl cLib_addCalc2__FPffff
lbl_8066B120:
/* 8066B120  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 8066B124  C0 41 00 28 */	lfs f2, 0x28(r1)
/* 8066B128  4B BF C5 4D */	bl cM_atan2s__Fff
...
/* 8066B13C  4B C0 54 CD */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066B16C  4B BF C7 E9 */	bl cM_rndF__Ff
...
/* 8066B190  4B CD BF A9 */	bl PSVECSquareMag
...
/* 8066B200  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066B204  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8066B270  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8066B274  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8066B278:
...
/* 8066B2A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066B2A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8066B2A8  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8066B2AC  3C 80 80 67 */	lis r4, d_a_do__stringBase0@ha /* 0x8066EFB0@ha */
/* 8066B2B0  38 84 EF B0 */	addi r4, r4, d_a_do__stringBase0@l /* 0x8066EFB0@l */
/* 8066B2B4  38 84 00 03 */	addi r4, r4, 3
/* 8066B2B8  4B CF D6 DD */	bl strcmp
...
/* 8066B34C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8066B350  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8066B36C  4B BF C5 E9 */	bl cM_rndF__Ff
...
/* 8066B3B8  4B 9B 0E 89 */	bl fopAcM_createItem__FPC4cXyziiiPC5csXyzPC4cXyzi
...
/* 8066B3CC  4B BF C5 89 */	bl cM_rndF__Ff
...
/* 8066B450  4B C0 45 ED */	bl cLib_addCalc2__FPffff
/* 8066B454  38 7C 05 2C */	addi r3, r28, 0x52c
/* 8066B458  C0 3C 05 E8 */	lfs f1, 0x5e8(r28)
/* 8066B45C  3C 80 80 67 */	lis r4, l_HIO@ha /* 0x8066F2C4@ha */
/* 8066B460  38 84 F2 C4 */	addi r4, r4, l_HIO@l /* 0x8066F2C4@l */
...
/* 8066B474  4B C0 45 C9 */	bl cLib_addCalc2__FPffff
...
/* 8066B490  4B BF C4 C5 */	bl cM_rndF__Ff
...
/* 8066B4F0  4B C0 45 4D */	bl cLib_addCalc2__FPffff
/* 8066B4F4  C0 1C 05 E8 */	lfs f0, 0x5e8(r28)
/* 8066B4F8  80 7C 05 D0 */	lwz r3, 0x5d0(r28)
/* 8066B4FC  D0 03 00 18 */	stfs f0, 0x18(r3)
/* 8066B500  3C 60 80 67 */	lis r3, l_HIO@ha /* 0x8066F2C4@ha */
/* 8066B504  38 63 F2 C4 */	addi r3, r3, l_HIO@l /* 0x8066F2C4@l */
...
/* 8066B524  4B C0 45 19 */	bl cLib_addCalc2__FPffff
...
/* 8066B538  4B C0 50 D1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8066B590  4B BF C3 FD */	bl cM_rndFX__Ff
...
/* 8066B5EC  4B C0 44 51 */	bl cLib_addCalc2__FPffff
/* 8066B5F0  38 7C 05 2C */	addi r3, r28, 0x52c
/* 8066B5F4  C0 3C 05 E8 */	lfs f1, 0x5e8(r28)
/* 8066B5F8  3C 80 80 67 */	lis r4, l_HIO@ha /* 0x8066F2C4@ha */
/* 8066B5FC  38 84 F2 C4 */	addi r4, r4, l_HIO@l /* 0x8066F2C4@l */
...
/* 8066B610  4B C0 44 2D */	bl cLib_addCalc2__FPffff
...
/* 8066B63C  4B CF 6B E5 */	bl _restgpr_27
