...
/* 80D4CDBC  3C 60 80 D5 */	lis r3, lit_3859@ha /* 0x80D4D298@ha */
/* 80D4CDC0  38 83 D2 98 */	addi r4, r3, lit_3859@l /* 0x80D4D298@l */
...
/* 80D4CDEC  4B 5F 9F 81 */	bl PSMTXMultVec
/* 80D4CDF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CDF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CDF8  C0 21 00 2C */	lfs f1, 0x2c(r1)
/* 80D4CDFC  C0 41 00 30 */	lfs f2, 0x30(r1)
/* 80D4CE00  C0 61 00 34 */	lfs f3, 0x34(r1)
/* 80D4CE04  4B 5F 9A E5 */	bl PSMTXTrans
/* 80D4CE08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D4CE0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D4CE28  4B 51 9D 0D */	bl __mi__4cXyzCFRC3Vec
...
/* 80D4CE48  4B 51 A2 E1 */	bl atan2sX_Z__4cXyzCFv
/* 80D4CE4C  7C 64 1B 78 */	mr r4, r3
/* 80D4CE50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CE54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CE58  4B 2B F5 DD */	bl mDoMtx_YrotM__FPA4_fs
/* 80D4CE5C  38 61 00 14 */	addi r3, r1, 0x14
/* 80D4CE60  4B 51 A2 F1 */	bl atan2sY_XZ__4cXyzCFv
/* 80D4CE64  7C 64 1B 78 */	mr r4, r3
/* 80D4CE68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CE6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CE70  4B 2B F5 2D */	bl mDoMtx_XrotM__FPA4_fs
lbl_80D4CE74:
/* 80D4CE74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CE78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CE7C  80 9F 05 78 */	lwz r4, 0x578(r31)
/* 80D4CE80  38 84 00 24 */	addi r4, r4, 0x24
/* 80D4CE84  4B 5F 96 2D */	bl PSMTXCopy
