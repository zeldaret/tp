...
/* 80D4C978  3C 60 80 D5 */	lis r3, __vt__11daPPolamp_c@ha /* 0x80D4D330@ha */
/* 80D4C97C  38 03 D3 30 */	addi r0, r3, __vt__11daPPolamp_c@l /* 0x80D4D330@l */
...
lbl_80D4C990:
/* 80D4C990  3C 80 80 D5 */	lis r4, l_arcName@ha /* 0x80D4D2D0@ha */
/* 80D4C994  38 84 D2 D0 */	addi r4, r4, l_arcName@l /* 0x80D4D2D0@l */
/* 80D4C998  80 84 00 00 */	lwz r4, 0(r4)
/* 80D4C99C  4B 2E 06 6D */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80D4C9B8  3C 60 80 D5 */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80D4D324@ha */
/* 80D4C9BC  38 03 D3 24 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80D4D324@l */
/* 80D4C9C0  90 1E 05 7C */	stw r0, 0x57c(r30)
lbl_80D4C9C4:
/* 80D4C9C4  7F C3 F3 78 */	mr r3, r30
/* 80D4C9C8  38 80 00 00 */	li r4, 0
/* 80D4C9CC  4B 2C C2 C1 */	bl __dt__10fopAc_ac_cFv
/* 80D4C9D0  7F E0 07 35 */	extsh. r0, r31
/* 80D4C9D4  40 81 00 0C */	ble lbl_80D4C9E0
/* 80D4C9D8  7F C3 F3 78 */	mr r3, r30
/* 80D4C9DC  4B 58 23 61 */	bl __dl__FPv
lbl_80D4C9E0:
