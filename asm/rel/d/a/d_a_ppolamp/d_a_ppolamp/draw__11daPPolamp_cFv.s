...
/* 80D4CB94  4B 61 56 41 */	bl _savegpr_27
/* 80D4CB98  7C 7E 1B 78 */	mr r30, r3
/* 80D4CB9C  3C 60 80 D5 */	lis r3, lit_1109@ha /* 0x80D4D340@ha */
/* 80D4CBA0  3B E3 D3 40 */	addi r31, r3, lit_1109@l /* 0x80D4D340@l */
/* 80D4CBA4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D4CBA8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D4CBAC  38 80 00 00 */	li r4, 0
/* 80D4CBB0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80D4CBB4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80D4CBB8  4B 45 6C 0D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80D4CBBC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D4CBC0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D4CBC4  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80D4CBC8  80 84 00 04 */	lwz r4, 4(r4)
/* 80D4CBCC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80D4CBD0  4B 45 81 D1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D4CBD4  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80D4CBD8  4B 2C 10 ED */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80D4CBDC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D4CBE0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D4CBE4  80 9E 05 78 */	lwz r4, 0x578(r30)
/* 80D4CBE8  80 84 00 04 */	lwz r4, 4(r4)
/* 80D4CBEC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80D4CBF0  4B 45 81 B1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D4CBF4  88 1F 00 3D */	lbz r0, 0x3d(r31)
/* 80D4CBF8  7C 00 07 75 */	extsb. r0, r0
/* 80D4CBFC  40 82 00 24 */	bne lbl_80D4CC20
/* 80D4CC00  3C 60 80 D5 */	lis r3, lit_3797@ha /* 0x80D4D288@ha */
/* 80D4CC04  38 83 D2 88 */	addi r4, r3, lit_3797@l /* 0x80D4D288@l */
...
/* 80D4CC2C  3C 60 80 D5 */	lis r3, lit_3802@ha /* 0x80D4D290@ha */
/* 80D4CC30  38 83 D2 90 */	addi r4, r3, lit_3802@l /* 0x80D4D290@l */
...
/* 80D4CCC8  4B 2C 0D 05 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80D4CCCC  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80D4CCD0  4B 2C 0F F5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80D4CCD4  38 60 00 01 */	li r3, 1
/* 80D4CCD8  39 61 00 20 */	addi r11, r1, 0x20
/* 80D4CCDC  4B 61 55 45 */	bl _restgpr_27
