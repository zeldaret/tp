...
/* 80D4CEB4  3C 60 80 D5 */	lis r3, l_arcName@ha /* 0x80D4D2D0@ha */
/* 80D4CEB8  38 63 D2 D0 */	addi r3, r3, l_arcName@l /* 0x80D4D2D0@l */
/* 80D4CEBC  80 63 00 00 */	lwz r3, 0(r3)
/* 80D4CEC0  38 80 00 08 */	li r4, 8
/* 80D4CEC4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D4CEC8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D4CEDC  4B 2E F4 11 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D4CEEC  4B 2C 7D 69 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D4CF08:
/* 80D4CF08  3C 60 80 D5 */	lis r3, l_arcName@ha /* 0x80D4D2D0@ha */
/* 80D4CF0C  38 63 D2 D0 */	addi r3, r3, l_arcName@l /* 0x80D4D2D0@l */
...
/* 80D4CF20  4B 2E F3 CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D4CF30  4B 2C 7D 25 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D4CF4C:
/* 80D4CF4C  3C 60 80 D5 */	lis r3, l_arcName@ha /* 0x80D4D2D0@ha */
/* 80D4CF50  38 63 D2 D0 */	addi r3, r3, l_arcName@l /* 0x80D4D2D0@l */
...
/* 80D4CF64  4B 2E F3 89 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D4CF78  3C E0 80 D5 */	lis r7, lit_3909@ha /* 0x80D4D2A4@ha */
/* 80D4CF7C  C0 27 D2 A4 */	lfs f1, lit_3909@l(r7)  /* 0x80D4D2A4@l */
/* 80D4CF80  38 E0 00 00 */	li r7, 0
/* 80D4CF84  39 00 FF FF */	li r8, -1
/* 80D4CF88  39 20 00 00 */	li r9, 0
/* 80D4CF8C  4B 2C 08 51 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
