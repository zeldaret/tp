...
lbl_80D4CA1C:
/* 80D4CA1C  3C 80 80 D5 */	lis r4, l_arcName@ha /* 0x80D4D2D0@ha */
/* 80D4CA20  38 84 D2 D0 */	addi r4, r4, l_arcName@l /* 0x80D4D2D0@l */
/* 80D4CA24  80 84 00 00 */	lwz r4, 0(r4)
/* 80D4CA28  4B 2E 04 95 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80D4CA3C  3C 80 80 D5 */	lis r4, daPPolamp_c_createHeap__FP10fopAc_ac_c@ha /* 0x80D4C938@ha */
/* 80D4CA40  38 84 C9 38 */	addi r4, r4, daPPolamp_c_createHeap__FP10fopAc_ac_c@l /* 0x80D4C938@l */
/* 80D4CA44  38 A0 10 10 */	li r5, 0x1010
/* 80D4CA48  4B 2C DA 69 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80D4CA78  3C 60 80 D5 */	lis r3, lit_3757@ha /* 0x80D4D27C@ha */
/* 80D4CA7C  38 83 D2 7C */	addi r4, r3, lit_3757@l /* 0x80D4D27C@l */
...
/* 80D4CAA8  4B 5F A2 C5 */	bl PSMTXMultVec
/* 80D4CAAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CAB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CAB4  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80D4CAB8  C0 41 00 18 */	lfs f2, 0x18(r1)
/* 80D4CABC  C0 61 00 1C */	lfs f3, 0x1c(r1)
/* 80D4CAC0  4B 5F 9E 29 */	bl PSMTXTrans
/* 80D4CAC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CAC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CACC  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80D4CAD0  4B 2B F9 65 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D4CAD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CAD8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CADC  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80D4CAE0  4B 2B F8 BD */	bl mDoMtx_XrotM__FPA4_fs
/* 80D4CAE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CAE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CAEC  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 80D4CAF0  4B 2B F9 DD */	bl mDoMtx_ZrotM__FPA4_fs
/* 80D4CAF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D4CAF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D4CAFC  80 9E 05 78 */	lwz r4, 0x578(r30)
/* 80D4CB00  38 84 00 24 */	addi r4, r4, 0x24
/* 80D4CB04  4B 5F 99 AD */	bl PSMTXCopy
lbl_80D4CB08:
