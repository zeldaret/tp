...
/* 8049A388  4B EC 7E 4D */	bl _savegpr_27
/* 8049A38C  7C 7B 1B 78 */	mr r27, r3
/* 8049A390  7C 9C 23 78 */	mr r28, r4
/* 8049A394  7C BD 2B 78 */	mr r29, r5
/* 8049A398  3C 60 80 4A */	lis r3, lit_3768@ha /* 0x8049DC84@ha */
/* 8049A39C  3B E3 DC 84 */	addi r31, r3, lit_3768@l /* 0x8049DC84@l */
/* 8049A3A0  38 7B 05 DC */	addi r3, r27, 0x5dc
/* 8049A3A4  7F 66 DB 78 */	mr r6, r27
/* 8049A3A8  4B BD D9 BD */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8049A3AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8049A3B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8049A3B4  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 8049A3B8  7F C3 F3 78 */	mr r3, r30
/* 8049A3BC  38 9B 05 DC */	addi r4, r27, 0x5dc
/* 8049A3C0  4B BD 9F F5 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8049A3D4  4B BD AA 7D */	bl GetPolyAtt0__4dBgSFRC13cBgS_PolyInfo
...
/* 8049A410  4B DC C7 25 */	bl __mi__4cXyzCFRC3Vec
...
/* 8049A434  4B EA CF 69 */	bl PSVECSquareDistance
...
/* 8049A4A4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8049A4A8  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8049A514  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8049A518  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8049A534  4B EA CC 05 */	bl PSVECSquareMag
...
/* 8049A5A4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8049A5A8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8049A614  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8049A618  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8049A61C:
...
/* 8049A688  4B B8 36 FD */	bl waterCheck__11fopAcM_wt_cFPC4cXyz
/* 8049A68C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8049A690  41 82 00 B8 */	beq lbl_8049A748
/* 8049A694  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha /* 0x80450CD8@ha */
/* 8049A698  C0 23 0C D8 */	lfs f1, mWaterY__11fopAcM_wt_c@l(r3)  /* 0x80450CD8@l */
...
/* 8049A6AC  3C 80 80 3F */	lis r4, mWaterCheck__11fopAcM_wt_c@ha /* 0x803F1D80@ha */
/* 8049A6B0  38 84 1D 80 */	addi r4, r4, mWaterCheck__11fopAcM_wt_c@l /* 0x803F1D80@l */
/* 8049A6B4  4B BD A7 9D */	bl GetPolyAtt0__4dBgSFRC13cBgS_PolyInfo
/* 8049A6B8  2C 03 00 06 */	cmpwi r3, 6
/* 8049A6BC  40 82 00 18 */	bne lbl_8049A6D4
/* 8049A6C0  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha /* 0x80450CD8@ha */
/* 8049A6C4  C0 03 0C D8 */	lfs f0, mWaterY__11fopAcM_wt_c@l(r3)  /* 0x80450CD8@l */
...
/* 8049A6E0  4B DC C4 55 */	bl __mi__4cXyzCFRC3Vec
...
/* 8049A758  4B EC 7A C9 */	bl _restgpr_27
