...
/* 8049B130  4B EC 70 AC */	b _savegpr_29
...
/* 8049B148  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8049B14C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8049B150  38 81 00 08 */	addi r4, r1, 8
/* 8049B154  4B B7 E6 A4 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8049B190  4B B9 BE 18 */	b setArrowPosAndAngle__9dJntCol_cFPC4cXyzPC4cXyziP4cXyzP5csXyz
/* 8049B194  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049B198  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049B19C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 8049B1A0  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 8049B1A4  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 8049B1A8  4B EA B7 40 */	b PSMTXTrans
/* 8049B1AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049B1B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8049B1C8  4B B7 10 D8 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 8049B1CC  3C 60 80 4A */	lis r3, lit_4130@ha
/* 8049B1D0  C0 23 DD 1C */	lfs f1, lit_4130@l(r3)
/* 8049B1D4  FC 40 08 90 */	fmr f2, f1
/* 8049B1D8  3C 60 80 4A */	lis r3, lit_4606@ha
/* 8049B1DC  C0 63 DD 94 */	lfs f3, lit_4606@l(r3)
/* 8049B1E0  4B B7 1B BC */	b transM__14mDoMtx_stack_cFfff
/* 8049B1E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049B1E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049B1EC  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 8049B1F0  38 84 00 24 */	addi r4, r4, 0x24
/* 8049B1F4  4B EA B2 BC */	b PSMTXCopy
/* 8049B1F8  7F A3 EB 78 */	mr r3, r29
lbl_8049B1FC:
/* 8049B1FC  39 61 00 20 */	addi r11, r1, 0x20
/* 8049B200  4B EC 70 28 */	b _restgpr_29
