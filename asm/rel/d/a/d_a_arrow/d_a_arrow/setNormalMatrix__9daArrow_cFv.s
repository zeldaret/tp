...
/* 8049AE7C  3C 60 80 4A */	lis r3, lit_3768@ha /* 0x8049DC84@ha */
/* 8049AE80  3B E3 DC 84 */	addi r31, r3, lit_3768@l /* 0x8049DC84@l */
/* 8049AE84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8049AE88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8049AE8C  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 8049AE90  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 8049AE94  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 8049AE98  4B EA BA 51 */	bl PSMTXTrans
/* 8049AE9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8049AEA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8049AEA4  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 8049AEA8  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 8049AEAC  38 C0 00 00 */	li r6, 0
/* 8049AEB0  4B B7 13 F1 */	bl mDoMtx_ZXYrotM__FPA4_fsss
...
/* 8049AECC  4B B7 1E D1 */	bl transM__14mDoMtx_stack_cFfff
...
/* 8049AEE8  4B B7 1E B5 */	bl transM__14mDoMtx_stack_cFfff
lbl_8049AEEC:
/* 8049AEEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8049AEF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8049AEF4  80 9E 05 68 */	lwz r4, 0x568(r30)
/* 8049AEF8  38 84 00 24 */	addi r4, r4, 0x24
/* 8049AEFC  4B EA B5 B5 */	bl PSMTXCopy
