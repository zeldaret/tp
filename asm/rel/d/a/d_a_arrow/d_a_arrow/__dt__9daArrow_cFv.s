...
/* 8049D9B0  4B E2 06 49 */	bl deleteObject__14Z2SoundObjBaseFv
...
/* 8049D9C8  3C 60 80 3B */	lis r3, __vt__22dPa_hermiteEcallBack_c@ha /* 0x803A83A0@ha */
/* 8049D9CC  38 03 83 A0 */	addi r0, r3, __vt__22dPa_hermiteEcallBack_c@l /* 0x803A83A0@l */
/* 8049D9D0  90 1E 0A 10 */	stw r0, 0xa10(r30)
/* 8049D9D4  34 1E 0A 10 */	addic. r0, r30, 0xa10
/* 8049D9D8  41 82 00 30 */	beq lbl_8049DA08
/* 8049D9DC  3C 60 80 4A */	lis r3, __vt__18dPa_levelEcallBack@ha /* 0x8049DEF4@ha */
/* 8049D9E0  38 03 DE F4 */	addi r0, r3, __vt__18dPa_levelEcallBack@l /* 0x8049DEF4@l */
...
/* 8049DA04  4B DE 0C A1 */	bl __dt__18JPAEmitterCallBackFv
lbl_8049DA08:
/* 8049DA08  34 1E 09 04 */	addic. r0, r30, 0x904
/* 8049DA0C  41 82 00 1C */	beq lbl_8049DA28
/* 8049DA10  3C 60 80 3D */	lis r3, __vt__15Z2SoundObjArrow@ha /* 0x803CACF0@ha */
/* 8049DA14  38 03 AC F0 */	addi r0, r3, __vt__15Z2SoundObjArrow@l /* 0x803CACF0@l */
/* 8049DA18  90 1E 09 14 */	stw r0, 0x914(r30)
/* 8049DA1C  38 7E 09 04 */	addi r3, r30, 0x904
/* 8049DA20  38 80 00 00 */	li r4, 0
/* 8049DA24  4B E2 0B D9 */	bl __dt__21Z2DopplerSoundObjBaseFv
lbl_8049DA28:
/* 8049DA28  34 1E 07 CC */	addic. r0, r30, 0x7cc
/* 8049DA2C  41 82 00 84 */	beq lbl_8049DAB0
/* 8049DA30  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 8049DA34  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 8049DA54  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 8049DA58  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 8049DA70  3C 60 80 4A */	lis r3, __vt__8cM3dGSph@ha /* 0x8049DF34@ha */
/* 8049DA74  38 03 DF 34 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x8049DF34@l */
/* 8049DA78  90 1E 09 00 */	stw r0, 0x900(r30)
lbl_8049DA7C:
/* 8049DA7C  34 1E 08 D0 */	addic. r0, r30, 0x8d0
/* 8049DA80  41 82 00 24 */	beq lbl_8049DAA4
/* 8049DA84  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8049DA88  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8049DA8C  90 1E 08 EC */	stw r0, 0x8ec(r30)
/* 8049DA90  34 1E 08 D0 */	addic. r0, r30, 0x8d0
/* 8049DA94  41 82 00 10 */	beq lbl_8049DAA4
/* 8049DA98  3C 60 80 4A */	lis r3, __vt__8cM3dGAab@ha /* 0x8049DF40@ha */
/* 8049DA9C  38 03 DF 40 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8049DF40@l */
/* 8049DAA0  90 1E 08 E8 */	stw r0, 0x8e8(r30)
lbl_8049DAA4:
/* 8049DAA4  38 7E 07 CC */	addi r3, r30, 0x7cc
/* 8049DAA8  38 80 00 00 */	li r4, 0
/* 8049DAAC  4B BE 66 39 */	bl __dt__12dCcD_GObjInfFv
lbl_8049DAB0:
/* 8049DAB0  34 1E 06 88 */	addic. r0, r30, 0x688
/* 8049DAB4  41 82 00 7C */	beq lbl_8049DB30
/* 8049DAB8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cps@ha /* 0x803AC170@ha */
/* 8049DABC  38 63 C1 70 */	addi r3, r3, __vt__8dCcD_Cps@l /* 0x803AC170@l */
...
/* 8049DADC  3C 60 80 3C */	lis r3, __vt__12cCcD_CpsAttr@ha /* 0x803C3608@ha */
/* 8049DAE0  38 63 36 08 */	addi r3, r3, __vt__12cCcD_CpsAttr@l /* 0x803C3608@l */
...
/* 8049DAF8  4B DD 14 AD */	bl __dt__8cM3dGCpsFv
/* 8049DAFC  34 1E 07 8C */	addic. r0, r30, 0x78c
/* 8049DB00  41 82 00 24 */	beq lbl_8049DB24
/* 8049DB04  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8049DB08  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8049DB0C  90 1E 07 A8 */	stw r0, 0x7a8(r30)
/* 8049DB10  34 1E 07 8C */	addic. r0, r30, 0x78c
/* 8049DB14  41 82 00 10 */	beq lbl_8049DB24
/* 8049DB18  3C 60 80 4A */	lis r3, __vt__8cM3dGAab@ha /* 0x8049DF40@ha */
/* 8049DB1C  38 03 DF 40 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8049DF40@l */
/* 8049DB20  90 1E 07 A4 */	stw r0, 0x7a4(r30)
lbl_8049DB24:
/* 8049DB24  38 7E 06 88 */	addi r3, r30, 0x688
/* 8049DB28  38 80 00 00 */	li r4, 0
/* 8049DB2C  4B BE 65 B9 */	bl __dt__12dCcD_GObjInfFv
lbl_8049DB30:
/* 8049DB30  34 1E 06 4C */	addic. r0, r30, 0x64c
/* 8049DB34  41 82 00 54 */	beq lbl_8049DB88
/* 8049DB38  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 8049DB3C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 8049DB54  3C 60 80 4A */	lis r3, __vt__10dCcD_GStts@ha /* 0x8049DEE8@ha */
/* 8049DB58  38 03 DE E8 */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x8049DEE8@l */
/* 8049DB5C  90 1E 06 68 */	stw r0, 0x668(r30)
/* 8049DB60  34 1E 06 68 */	addic. r0, r30, 0x668
/* 8049DB64  41 82 00 10 */	beq lbl_8049DB74
/* 8049DB68  3C 60 80 4A */	lis r3, __vt__10cCcD_GStts@ha /* 0x8049DEDC@ha */
/* 8049DB6C  38 03 DE DC */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x8049DEDC@l */
/* 8049DB70  90 1E 06 68 */	stw r0, 0x668(r30)
lbl_8049DB74:
/* 8049DB74  34 1E 06 4C */	addic. r0, r30, 0x64c
/* 8049DB78  41 82 00 10 */	beq lbl_8049DB88
/* 8049DB7C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 8049DB80  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 8049DB84  90 1E 06 64 */	stw r0, 0x664(r30)
lbl_8049DB88:
/* 8049DB88  38 7E 05 DC */	addi r3, r30, 0x5dc
/* 8049DB8C  38 80 FF FF */	li r4, -1
/* 8049DB90  4B BD A4 29 */	bl __dt__14dBgS_ObjLinChkFv
/* 8049DB94  38 7E 05 6C */	addi r3, r30, 0x56c
/* 8049DB98  38 80 FF FF */	li r4, -1
/* 8049DB9C  4B BD A6 A5 */	bl __dt__16dBgS_ArrowLinChkFv
/* 8049DBA0  7F C3 F3 78 */	mr r3, r30
/* 8049DBA4  38 80 00 00 */	li r4, 0
/* 8049DBA8  4B B7 B0 E5 */	bl __dt__10fopAc_ac_cFv
/* 8049DBAC  7F E0 07 35 */	extsh. r0, r31
/* 8049DBB0  40 81 00 0C */	ble lbl_8049DBBC
/* 8049DBB4  7F C3 F3 78 */	mr r3, r30
/* 8049DBB8  4B E3 11 85 */	bl __dl__FPv
lbl_8049DBBC:
