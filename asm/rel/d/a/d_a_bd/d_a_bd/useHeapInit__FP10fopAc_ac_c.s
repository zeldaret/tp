...
/* 804D961C  4B E8 8B BD */	bl _savegpr_28
/* 804D9620  7C 7F 1B 78 */	mr r31, r3
/* 804D9624  38 60 00 54 */	li r3, 0x54
/* 804D9628  4B DF 56 25 */	bl __nw__FUl
/* 804D962C  7C 7E 1B 79 */	or. r30, r3, r3
/* 804D9630  41 82 00 9C */	beq lbl_804D96CC
/* 804D9634  3C 60 80 4E */	lis r3, d_a_bd__stringBase0@ha /* 0x804D9F6C@ha */
/* 804D9638  38 63 9F 6C */	addi r3, r3, d_a_bd__stringBase0@l /* 0x804D9F6C@l */
/* 804D963C  38 80 00 08 */	li r4, 8
/* 804D9640  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D9644  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804D9658  4B B6 2C 95 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 804D965C  7C 7D 1B 78 */	mr r29, r3
/* 804D9660  3C 60 80 4E */	lis r3, d_a_bd__stringBase0@ha /* 0x804D9F6C@ha */
/* 804D9664  38 63 9F 6C */	addi r3, r3, d_a_bd__stringBase0@l /* 0x804D9F6C@l */
/* 804D9668  38 80 00 0E */	li r4, 0xe
/* 804D966C  7F 85 E3 78 */	mr r5, r28
/* 804D9670  38 C0 00 80 */	li r6, 0x80
/* 804D9674  4B B6 2C 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804D96B4  3D 20 80 4E */	lis r9, lit_4171@ha /* 0x804D9EA8@ha */
/* 804D96B8  C0 29 9E A8 */	lfs f1, lit_4171@l(r9)  /* 0x804D9EA8@l */
/* 804D96BC  39 20 00 00 */	li r9, 0
/* 804D96C0  39 40 FF FF */	li r10, -1
/* 804D96C4  4B B3 65 89 */	bl __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 804D96F4  4B DF 55 59 */	bl __nw__FUl
/* 804D96F8  7C 7E 1B 79 */	or. r30, r3, r3
/* 804D96FC  41 82 00 20 */	beq lbl_804D971C
/* 804D9700  3C 80 80 4E */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x804DA300@ha */
/* 804D9704  38 04 A3 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x804DA300@l */
/* 804D9708  90 1E 00 00 */	stw r0, 0(r30)
/* 804D970C  38 80 00 00 */	li r4, 0
/* 804D9710  4B E4 EC ED */	bl init__12J3DFrameCtrlFs
...
lbl_804D9734:
/* 804D9734  3C 60 80 4E */	lis r3, d_a_bd__stringBase0@ha /* 0x804D9F6C@ha */
/* 804D9738  38 63 9F 6C */	addi r3, r3, d_a_bd__stringBase0@l /* 0x804D9F6C@l */
/* 804D973C  38 80 00 11 */	li r4, 0x11
/* 804D9740  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D9744  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D9748  3C A5 00 02 */	addis r5, r5, 2
/* 804D974C  38 C0 00 80 */	li r6, 0x80
/* 804D9750  38 A5 C2 F8 */	addi r5, r5, -15624
/* 804D9754  4B B6 2B 99 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804D9778  3D 00 80 4E */	lis r8, lit_4171@ha /* 0x804D9EA8@ha */
/* 804D977C  C0 28 9E A8 */	lfs f1, lit_4171@l(r8)  /* 0x804D9EA8@l */
/* 804D9780  39 00 00 00 */	li r8, 0
/* 804D9784  39 20 FF FF */	li r9, -1
/* 804D9788  4B B3 3E B5 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 804D97C0  4B E8 8A 65 */	bl _restgpr_28
