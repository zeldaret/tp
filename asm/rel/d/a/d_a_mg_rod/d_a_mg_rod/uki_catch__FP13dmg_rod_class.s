...
/* 804B41B0  4B EA E0 21 */	bl _savegpr_26
/* 804B41B4  7C 7C 1B 78 */	mr r28, r3
/* 804B41B8  3C 60 80 4C */	lis r3, lit_1109@ha /* 0x804BBB90@ha */
/* 804B41BC  3B A3 BB 90 */	addi r29, r3, lit_1109@l /* 0x804BBB90@l */
/* 804B41C0  3C 60 80 4C */	lis r3, lit_3879@ha /* 0x804BB534@ha */
/* 804B41C4  3B C3 B5 34 */	addi r30, r3, lit_3879@l /* 0x804BB534@l */
/* 804B41C8  80 1C 10 AC */	lwz r0, 0x10ac(r28)
/* 804B41CC  90 01 00 08 */	stw r0, 8(r1)
/* 804B41D0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 804B41D4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 804B41D8  38 81 00 08 */	addi r4, r1, 8
/* 804B41DC  4B B6 56 1D */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 804B4230  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4234  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804B42C4:
/* 804B42C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B42C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B432C  4B DB B7 11 */	bl cLib_addCalc2__FPffff
...
/* 804B4340  4B DB C2 C9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 804B4358  4B DB B6 E5 */	bl cLib_addCalc2__FPffff
...
/* 804B43D8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B43DC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B43F0  4B DF B0 AD */	bl subBgmStart__8Z2SeqMgrFUl
/* 804B43F4  C0 3E 00 0C */	lfs f1, 0xc(r30)
/* 804B43F8  4B DB 35 5D */	bl cM_rndF__Ff
/* 804B43FC  C0 1E 00 9C */	lfs f0, 0x9c(r30)
/* 804B4400  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804B4404  40 80 00 1C */	bge lbl_804B4420
/* 804B4408  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B440C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804B4420:
/* 804B4420  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4424  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804B4470:
/* 804B4470  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B4474  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B4488  4B DF B0 15 */	bl subBgmStart__8Z2SeqMgrFUl
/* 804B448C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4490  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B44B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B44B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804B44CC:
/* 804B44CC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B44D0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B44E4  4B DF AF B9 */	bl subBgmStart__8Z2SeqMgrFUl
/* 804B44E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B44EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804B4500:
/* 804B4500  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B4504  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B4518  4B DF AF 85 */	bl subBgmStart__8Z2SeqMgrFUl
/* 804B451C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4520  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B4554  3C 60 80 45 */	lis r3, struct_80450C9C+0x2@ha /* 0x80450C9E@ha */
/* 804B4558  88 03 0C 9E */	lbz r0, struct_80450C9C+0x2@l(r3)  /* 0x80450C9E@l */
...
/* 804B4578  4B D9 5A 19 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4594  4B D9 59 FD */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 804B4598  38 00 00 01 */	li r0, 1
/* 804B459C  3C 60 80 45 */	lis r3, struct_80450C9C+0x2@ha /* 0x80450C9E@ha */
/* 804B45A0  98 03 0C 9E */	stb r0, struct_80450C9C+0x2@l(r3)  /* 0x80450C9E@l */
lbl_804B45A4:
...
/* 804B45D8  4B D9 59 B9 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 804B45DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B45E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B45E4  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 804B45E8  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 804B45EC  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 804B45F0  A0 84 03 A4 */	lhz r4, 0x3a4(r4)
/* 804B45F4  4B B8 03 99 */	bl onEventBit__11dSv_event_cFUs
...
/* 804B4618  4B D9 59 79 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B463C  4B D9 59 55 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4670  4B D9 59 21 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B468C  4B D9 59 05 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B46B0  4B D9 58 E1 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 804B46B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B46B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B46BC  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 804B46C0  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 804B46C4  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 804B46C8  A0 84 03 A8 */	lhz r4, 0x3a8(r4)
/* 804B46CC  4B B8 02 C1 */	bl onEventBit__11dSv_event_cFUs
/* 804B46D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B46D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B46D8  38 63 00 9C */	addi r3, r3, 0x9c
/* 804B46DC  4B B7 ED B9 */	bl setEmptyBottle__17dSv_player_item_cFv
...
/* 804B4700  4B D9 58 91 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4724  4B D9 58 6D */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4748  4B D9 58 49 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B47A8  4B D9 57 E9 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B47C4  4B D9 57 CD */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B47EC  4B D9 57 A5 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4808  4B D9 57 89 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4830  4B D9 57 61 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B484C  4B D9 57 45 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4874  4B D9 57 1D */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4890  4B D9 57 01 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B48B8  4B D9 56 D9 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B48D4  4B D9 56 BD */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B48FC  4B D9 56 95 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B4918  4B D9 56 79 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
lbl_804B491C:
/* 804B491C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4920  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B4924  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 804B4928  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 804B492C  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 804B4930  A0 84 04 D8 */	lhz r4, 0x4d8(r4)
/* 804B4934  4B B8 00 59 */	bl onEventBit__11dSv_event_cFUs
lbl_804B4938:
...
/* 804B497C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4980  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B4984  90 03 5E 0C */	stw r0, 0x5e0c(r3)
/* 804B4988  48 00 00 14 */	b lbl_804B499C
lbl_804B498C:
/* 804B498C  7F 40 07 34 */	extsh r0, r26
/* 804B4990  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4994  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B49C0  4B D9 59 19 */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 804B49FC  4B DB 2F 59 */	bl cM_rndF__Ff
...
/* 804B4A14  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4A18  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804B4A2C:
/* 804B4A2C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B4A30  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B4A34  3B C3 01 6C */	addi r30, r3, 0x16c
/* 804B4A38  7F C3 F3 78 */	mr r3, r30
/* 804B4A3C  7F 64 DB 78 */	mr r4, r27
/* 804B4A40  4B B7 FA BD */	bl addFishCount__18dSv_fishing_info_cFUc
...
/* 804B4A80  4B EA D7 9D */	bl _restgpr_26
