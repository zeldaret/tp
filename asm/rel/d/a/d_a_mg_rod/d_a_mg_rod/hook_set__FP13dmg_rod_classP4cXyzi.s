...
/* 804B11F4  4B EB 0F E1 */	bl _savegpr_27
/* 804B11F8  7C 7E 1B 78 */	mr r30, r3
/* 804B11FC  7C 9B 23 78 */	mr r27, r4
/* 804B1200  7C BD 2B 78 */	mr r29, r5
/* 804B1204  3C 60 80 4C */	lis r3, lit_3879@ha /* 0x804BB534@ha */
/* 804B1208  3B E3 B5 34 */	addi r31, r3, lit_3879@l /* 0x804BB534@l */
...
lbl_804B123C:
/* 804B123C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1240  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B1244  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 804B1248  4B B5 B1 95 */	bl mDoMtx_YrotS__FPA4_fs
/* 804B124C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1250  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B1254  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 804B1258  4B B5 B2 75 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 804B1270  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1274  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B1278  38 81 00 2C */	addi r4, r1, 0x2c
/* 804B127C  38 A1 00 14 */	addi r5, r1, 0x14
/* 804B1280  4B E9 5A ED */	bl PSMTXMultVec
...
/* 804B1294  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1298  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B129C  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 804B12A0  4B B5 B1 3D */	bl mDoMtx_YrotS__FPA4_fs
/* 804B12A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B12A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B12AC  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 804B12B0  4B B5 B0 ED */	bl mDoMtx_XrotM__FPA4_fs
/* 804B12B4  2C 1D 00 00 */	cmpwi r29, 0
/* 804B12B8  40 82 00 44 */	bne lbl_804B12FC
/* 804B12BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B12C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804B12E0  4B B5 B1 ED */	bl mDoMtx_ZrotM__FPA4_fs
...
lbl_804B1310:
/* 804B1310  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1314  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B1318  38 81 00 2C */	addi r4, r1, 0x2c
/* 804B131C  38 A1 00 14 */	addi r5, r1, 0x14
/* 804B1320  4B E9 5A 4D */	bl PSMTXMultVec
...
/* 804B13D0  4B DB 62 A5 */	bl cM_atan2s__Fff
...
/* 804B1400  4B DB 62 75 */	bl cM_atan2s__Fff
/* 804B1404  B0 7C 00 1A */	sth r3, 0x1a(r28)
/* 804B1408  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804B140C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804B1410  80 63 00 00 */	lwz r3, 0(r3)
/* 804B1414  A8 9C 00 18 */	lha r4, 0x18(r28)
/* 804B1418  4B B5 AF 2D */	bl mDoMtx_XrotS__FPA4_fs
/* 804B141C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804B1420  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804B1424  80 63 00 00 */	lwz r3, 0(r3)
/* 804B1428  A8 9C 00 1A */	lha r4, 0x1a(r28)
/* 804B142C  4B B5 B0 09 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 804B1478  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B147C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B1480  C0 3C 00 00 */	lfs f1, 0(r28)
/* 804B1484  C0 5C 00 04 */	lfs f2, 4(r28)
/* 804B1488  C0 7C 00 08 */	lfs f3, 8(r28)
/* 804B148C  4B E9 54 5D */	bl PSMTXTrans
...
lbl_804B14AC:
/* 804B14AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B14B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B14B4  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 804B14B8  4B B5 AF 7D */	bl mDoMtx_YrotM__FPA4_fs
/* 804B14BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B14C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B14C4  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 804B14C8  4B B5 AE D5 */	bl mDoMtx_XrotM__FPA4_fs
/* 804B14CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B14D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B14D4  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 804B14D8  4B B5 AF F5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804B14DC  48 00 01 70 */	b lbl_804B164C
lbl_804B14E0:
/* 804B14E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B14E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B14E8  A8 9C 00 18 */	lha r4, 0x18(r28)
/* 804B14EC  4B B5 AE B1 */	bl mDoMtx_XrotM__FPA4_fs
/* 804B14F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B14F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B14F8  A8 9C 00 1A */	lha r4, 0x1a(r28)
/* 804B14FC  4B B5 AF 39 */	bl mDoMtx_YrotM__FPA4_fs
/* 804B1500  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1504  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B1508  38 80 C0 00 */	li r4, -16384
/* 804B150C  4B B5 AE 91 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 804B15E4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804B15E8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804B1610  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1614  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804B1628  4B B5 AD 75 */	bl mDoMtx_XrotM__FPA4_fs
/* 804B162C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1630  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B1634  7F 64 DB 78 */	mr r4, r27
/* 804B1638  4B B5 AE 95 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804B163C  38 7E 0F EC */	addi r3, r30, 0xfec
/* 804B1640  C0 3F 00 0C */	lfs f1, 0xc(r31)
/* 804B1644  C0 5F 01 E0 */	lfs f2, 0x1e0(r31)
/* 804B1648  4B DB E4 39 */	bl cLib_addCalc0__FPfff
lbl_804B164C:
/* 804B164C  C0 3F 00 0C */	lfs f1, 0xc(r31)
/* 804B1650  FC 40 08 90 */	fmr f2, f1
/* 804B1654  FC 60 08 90 */	fmr f3, f1
/* 804B1658  4B B5 B7 E1 */	bl scaleM__14mDoMtx_stack_cFfff
/* 804B165C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1660  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804B1664  A8 9E 04 E0 */	lha r4, 0x4e0(r30)
/* 804B1668  4B B5 AD CD */	bl mDoMtx_YrotM__FPA4_fs
/* 804B166C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804B1670  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804B1684  4B E9 4E 2D */	bl PSMTXCopy
...
/* 804B16A4  4B EB 0B 7D */	bl _restgpr_27
