...
/* 804AD484  4B EB 4D 4D */	bl _savegpr_26
...
/* 804AD4A8  3C 60 80 4C */	lis r3, lit_4882@ha /* 0x804BB58C@ha */
/* 804AD4AC  C0 03 B5 8C */	lfs f0, lit_4882@l(r3)  /* 0x804BB58C@l */
/* 804AD4B0  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 804AD4B4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804AD4B8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804AD4BC  80 63 00 00 */	lwz r3, 0(r3)
/* 804AD4C0  A8 9B 04 DE */	lha r4, 0x4de(r27)
/* 804AD4C4  4B B5 EF 19 */	bl mDoMtx_YrotS__FPA4_fs
/* 804AD4C8  38 61 00 2C */	addi r3, r1, 0x2c
/* 804AD4CC  4B BC A7 9D */	bl __ct__11dBgS_LinChkFv
/* 804AD4D0  38 61 00 84 */	addi r3, r1, 0x84
/* 804AD4D4  4B BC BA 0D */	bl SetRope__16dBgS_PolyPassChkFv
/* 804AD4D8  3B 40 00 00 */	li r26, 0
/* 804AD4DC  3B E0 00 00 */	li r31, 0
/* 804AD4E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804AD4E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804AD4E8  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 804AD4EC  3C 60 80 4C */	lis r3, c_x@ha /* 0x804BB8E8@ha */
/* 804AD4F0  3B A3 B8 E8 */	addi r29, r3, c_x@l /* 0x804BB8E8@l */
/* 804AD4F4  3C 60 80 4C */	lis r3, c_z@ha /* 0x804BB8F4@ha */
/* 804AD4F8  3B C3 B8 F4 */	addi r30, r3, c_z@l /* 0x804BB8F4@l */
lbl_804AD4FC:
...
/* 804AD540  4B BC A8 25 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 804AD544  7F 83 E3 78 */	mr r3, r28
/* 804AD548  38 81 00 2C */	addi r4, r1, 0x2c
/* 804AD54C  4B BC 6E 69 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 804AD560  4B BC A7 7D */	bl __dt__11dBgS_LinChkFv
...
/* 804AD584  4B BC A7 59 */	bl __dt__11dBgS_LinChkFv
...
/* 804AD598  4B EB 4C 85 */	bl _restgpr_26
