...
/* 804B0AA0  4B EB 17 3D */	bl _savegpr_29
/* 804B0AA4  7C 7E 1B 78 */	mr r30, r3
/* 804B0AA8  3C 60 80 4C */	lis r3, lit_3879@ha /* 0x804BB534@ha */
/* 804B0AAC  3B E3 B5 34 */	addi r31, r3, lit_3879@l /* 0x804BB534@l */
/* 804B0AB0  80 1E 10 AC */	lwz r0, 0x10ac(r30)
/* 804B0AB4  90 01 00 08 */	stw r0, 8(r1)
/* 804B0AB8  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 804B0ABC  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 804B0AC0  38 81 00 08 */	addi r4, r1, 8
/* 804B0AC4  4B B6 8D 35 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 804B0AF8  3C 60 80 4C */	lis r3, henna@ha /* 0x804BBBD0@ha */
/* 804B0AFC  80 03 BB D0 */	lwz r0, henna@l(r3)  /* 0x804BBBD0@l */
...
/* 804B0B1C  4B D9 94 75 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B0B38  4B D9 94 59 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B0B4C  3C 60 80 4C */	lis r3, henna@ha /* 0x804BBBD0@ha */
/* 804B0B50  80 03 BB D0 */	lwz r0, henna@l(r3)  /* 0x804BBBD0@l */
...
/* 804B0B70  4B D9 94 21 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B0B8C  4B D9 94 05 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 804B0B90  48 00 00 E8 */	b lbl_804B0C78
lbl_804B0B94:
/* 804B0B94  2C 00 00 02 */	cmpwi r0, 2
/* 804B0B98  40 82 00 4C */	bne lbl_804B0BE4
/* 804B0B9C  3C 60 80 4C */	lis r3, henna@ha /* 0x804BBBD0@ha */
/* 804B0BA0  80 03 BB D0 */	lwz r0, henna@l(r3)  /* 0x804BBBD0@l */
...
/* 804B0BC0  4B D9 93 D1 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B0BDC  4B D9 93 B5 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 804B0BE0  48 00 00 98 */	b lbl_804B0C78
lbl_804B0BE4:
/* 804B0BE4  2C 00 00 03 */	cmpwi r0, 3
/* 804B0BE8  40 82 00 4C */	bne lbl_804B0C34
/* 804B0BEC  3C 60 80 4C */	lis r3, henna@ha /* 0x804BBBD0@ha */
/* 804B0BF0  80 03 BB D0 */	lwz r0, henna@l(r3)  /* 0x804BBBD0@l */
...
/* 804B0C10  4B D9 93 81 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B0C2C  4B D9 93 65 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 804B0C30  48 00 00 48 */	b lbl_804B0C78
lbl_804B0C34:
/* 804B0C34  3C 60 80 4C */	lis r3, henna@ha /* 0x804BBBD0@ha */
/* 804B0C38  80 03 BB D0 */	lwz r0, henna@l(r3)  /* 0x804BBBD0@l */
...
/* 804B0C58  4B D9 93 39 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B0C74  4B D9 93 1D */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
lbl_804B0C78:
...
/* 804B0C9C  4B D9 96 3D */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 804B0CC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0CCC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B0CEC  4B CB 23 21 */	bl SetTrimSize__9dCamera_cFl
...
/* 804B0D00  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0D04  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B0D08  80 63 5D B4 */	lwz r3, 0x5db4(r3)
/* 804B0D0C  98 03 2F C8 */	stb r0, 0x2fc8(r3)
/* 804B0D10  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B0D14  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 804B0D18  80 63 00 00 */	lwz r3, 0(r3)
/* 804B0D1C  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 804B0D20  38 80 00 01 */	li r4, 1
/* 804B0D24  4B E0 1D 65 */	bl changeFishingBgm__8Z2SeqMgrFl
...
/* 804B0D38  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B0D3C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B0D50  4B DF E7 4D */	bl subBgmStart__8Z2SeqMgrFUl
...
/* 804B0D64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0D68  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B0D84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0D88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804B0D9C:
/* 804B0D9C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0DA0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B0DE4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0DE8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B0DEC  83 A3 5D AC */	lwz r29, 0x5dac(r3)
/* 804B0DF0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804B0DF4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804B0DF8  80 63 00 00 */	lwz r3, 0(r3)
/* 804B0DFC  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 804B0E00  4B B5 B5 DD */	bl mDoMtx_YrotS__FPA4_fs
/* 804B0E04  A8 1E 05 78 */	lha r0, 0x578(r30)
/* 804B0E08  1C 00 07 08 */	mulli r0, r0, 0x708
/* 804B0E0C  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 804B0E10  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804B0E14  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
