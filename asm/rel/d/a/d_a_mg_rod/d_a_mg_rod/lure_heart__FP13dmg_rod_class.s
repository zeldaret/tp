...
/* 804B0E84  4B EB 13 55 */	bl _savegpr_28
/* 804B0E88  7C 7D 1B 78 */	mr r29, r3
/* 804B0E8C  3C 60 80 4C */	lis r3, lit_3879@ha /* 0x804BB534@ha */
/* 804B0E90  3B C3 B5 34 */	addi r30, r3, lit_3879@l /* 0x804BB534@l */
...
/* 804B0ED0  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 804B0ED4  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 804B0ED8  38 81 00 08 */	addi r4, r1, 8
/* 804B0EDC  4B B6 89 1D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 804B0EE0  7C 7C 1B 79 */	or. r28, r3, r3
/* 804B0EE4  41 82 00 58 */	beq lbl_804B0F3C
/* 804B0EE8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804B0EEC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804B0EF0  80 63 00 00 */	lwz r3, 0(r3)
/* 804B0EF4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0EF8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B0EFC  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 804B0F00  A8 84 04 E6 */	lha r4, 0x4e6(r4)
/* 804B0F04  4B B5 B4 D9 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 804B0F28  4B DB FF C5 */	bl MtxPosition__FP4cXyzP4cXyz
/* 804B0F2C  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 804B0F30  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 804B0F34  7C 65 1B 78 */	mr r5, r3
/* 804B0F38  4B E9 61 59 */	bl PSVECAdd
lbl_804B0F3C:
/* 804B0F3C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0F40  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B0F84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0F88  A0 83 61 C0 */	lhz r4, g_dComIfG_gameInfo@l(r3)  /* 0x804061C0@l */
...
/* 804B0FA4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B0FA8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B0FBC  4B DF E4 E1 */	bl subBgmStart__8Z2SeqMgrFUl
/* 804B0FC0  48 00 00 20 */	b lbl_804B0FE0
lbl_804B0FC4:
/* 804B0FC4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B0FC8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B0FDC  4B DF E4 C1 */	bl subBgmStart__8Z2SeqMgrFUl
lbl_804B0FE0:
/* 804B0FE0  38 80 00 01 */	li r4, 1
/* 804B0FE4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0FE8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B0FEC  98 83 5E B4 */	stb r4, 0x5eb4(r3)
/* 804B0FF0  3C 60 80 4C */	lis r3, henna@ha /* 0x804BBBD0@ha */
/* 804B0FF4  84 A3 BB D0 */	lwzu r5, henna@l(r3)  /* 0x804BBBD0@l */
...
/* 804B1020  3C 60 80 4C */	lis r3, henna@ha /* 0x804BBBD0@ha */
/* 804B1024  80 03 BB D0 */	lwz r0, henna@l(r3)  /* 0x804BBBD0@l */
...
/* 804B1044  4B D9 8F 4D */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B1060  4B D9 8F 31 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
lbl_804B1064:
/* 804B1064  A8 1D 13 B6 */	lha r0, 0x13b6(r29)
/* 804B1068  2C 00 00 5A */	cmpwi r0, 0x5a
/* 804B106C  40 82 00 20 */	bne lbl_804B108C
/* 804B1070  3C 60 80 4C */	lis r3, henna@ha /* 0x804BBBD0@ha */
/* 804B1074  38 63 BB D0 */	addi r3, r3, henna@l /* 0x804BBBD0@l */
...
/* 804B109C  4B D9 92 3D */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 804B10CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B10D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B10F0  4B CB 1F 1D */	bl SetTrimSize__9dCamera_cFl
...
/* 804B1150  4B B6 8B 2D */	bl fopAcM_delete__FP10fopAc_ac_c
/* 804B1154  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B1158  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B115C  38 80 00 80 */	li r4, 0x80
/* 804B1160  88 1C 04 BA */	lbz r0, 0x4ba(r28)
/* 804B1164  7C 05 07 74 */	extsb r5, r0
/* 804B1168  4B B8 43 79 */	bl onItem__10dSv_info_cFii
/* 804B116C  38 60 00 21 */	li r3, 0x21
/* 804B1170  4B BE 6D 1D */	bl execItemGet__FUc
/* 804B1174  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B1178  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B118C  4B B8 38 79 */	bl getEventReg__11dSv_event_cCFUs
