...
/* 804A9744  4B EB 8A 95 */	bl _savegpr_28
/* 804A9748  2C 04 00 00 */	cmpwi r4, 0
/* 804A974C  40 82 00 90 */	bne lbl_804A97DC
/* 804A9750  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 804A9754  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 804A9758  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 804A977C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804A9780  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804A9784  80 84 00 00 */	lwz r4, 0(r4)
/* 804A9788  4B E9 CD 29 */	bl PSMTXCopy
/* 804A978C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804A9790  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804A97A4  4B B6 2B F9 */	bl mDoMtx_XrotM__FPA4_fs
/* 804A97A8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804A97AC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804A97C0  4B E9 CC F1 */	bl PSMTXCopy
/* 804A97C4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804A97C8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804A97CC  80 63 00 00 */	lwz r3, 0(r3)
/* 804A97D0  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 804A97D4  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 804A97D8  4B E9 CC D9 */	bl PSMTXCopy
lbl_804A97DC:
/* 804A97DC  38 60 00 01 */	li r3, 1
/* 804A97E0  39 61 00 20 */	addi r11, r1, 0x20
/* 804A97E4  4B EB 8A 41 */	bl _restgpr_28
