...
/* 804AC238  4B EB 5F A5 */	bl _savegpr_29
/* 804AC23C  7C 7E 1B 78 */	mr r30, r3
/* 804AC240  3C 60 80 4C */	lis r3, lit_3879@ha /* 0x804BB534@ha */
/* 804AC244  3B E3 B5 34 */	addi r31, r3, lit_3879@l /* 0x804BB534@l */
...
/* 804AC258  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 804AC25C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 804AC260  38 81 00 08 */	addi r4, r1, 8
/* 804AC264  4B B6 D5 95 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 804AC268  28 03 00 00 */	cmplwi r3, 0
/* 804AC26C  40 82 00 10 */	bne lbl_804AC27C
/* 804AC270  7F C3 F3 78 */	mr r3, r30
/* 804AC274  4B B6 DA 09 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 804AC278  48 00 01 8C */	b lbl_804AC404
lbl_804AC27C:
/* 804AC27C  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 804AC280  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
...
/* 804AC2A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804AC2AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804AC308  4B DB A8 2D */	bl __mi__4cXyzCFRC3Vec
...
/* 804AC324  4B DB B3 51 */	bl cM_atan2s__Fff
...
/* 804AC35C  4B DB B3 19 */	bl cM_atan2s__Fff
/* 804AC360  B0 7E 04 DE */	sth r3, 0x4de(r30)
/* 804AC364  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804AC368  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804AC36C  80 7D 5D B4 */	lwz r3, 0x5db4(r29)
/* 804AC370  7F C4 F3 78 */	mr r4, r30
/* 804AC374  4B C4 7A D9 */	bl checkFishingRodGrab__9daAlink_cCFP10fopAc_ac_c
...
/* 804AC3B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804AC3B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804AC3D4  4B DB B2 A1 */	bl cM_atan2s__Fff
...
/* 804AC408  4B EB 5E 21 */	bl _restgpr_29
