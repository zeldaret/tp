...
/* 804B02D4  4B EB 1E E9 */	bl _savegpr_21
/* 804B02D8  7C 79 1B 78 */	mr r25, r3
/* 804B02DC  3C 60 80 4C */	lis r3, lit_1109@ha /* 0x804BBB90@ha */
/* 804B02E0  3B 63 BB 90 */	addi r27, r3, lit_1109@l /* 0x804BBB90@l */
/* 804B02E4  3C 60 80 4C */	lis r3, cNullVec__6Z2Calc@ha /* 0x804BB850@ha */
/* 804B02E8  3B 83 B8 50 */	addi r28, r3, cNullVec__6Z2Calc@l /* 0x804BB850@l */
/* 804B02EC  3C 60 80 4C */	lis r3, lit_3879@ha /* 0x804BB534@ha */
/* 804B02F0  3B A3 B5 34 */	addi r29, r3, lit_3879@l /* 0x804BB534@l */
/* 804B02F4  80 19 10 AC */	lwz r0, 0x10ac(r25)
/* 804B02F8  90 01 00 08 */	stw r0, 8(r1)
/* 804B02FC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 804B0300  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 804B0304  38 81 00 08 */	addi r4, r1, 8
/* 804B0308  4B B6 94 F1 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 804B0398  4B DC 02 71 */	bl cLib_addCalcAngleS2__FPssss
...
/* 804B03BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B03C0  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B040C  4B D9 9B 85 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
lbl_804B0410:
...
/* 804B0434  4B D9 9E A5 */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 804B04E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B04E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B04FC  4B B8 45 09 */	bl getEventReg__11dSv_event_cCFUs
...
lbl_804B0584:
/* 804B0584  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0588  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B059C  4B B8 44 69 */	bl getEventReg__11dSv_event_cCFUs
...
/* 804B05D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B05D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B05D8  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 804B05DC  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 804B05E0  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 804B05E4  A0 84 03 A6 */	lhz r4, 0x3a6(r4)
/* 804B05E8  4B B8 43 D5 */	bl isEventBit__11dSv_event_cCFUs
/* 804B05EC  2C 03 00 00 */	cmpwi r3, 0
/* 804B05F0  40 82 00 24 */	bne lbl_804B0614
/* 804B05F4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B05F8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B060C  4B DF EE 91 */	bl subBgmStart__8Z2SeqMgrFUl
...
/* 804B0620  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B0624  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B0638  4B DF EE 65 */	bl subBgmStart__8Z2SeqMgrFUl
...
/* 804B064C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B0650  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B0664  4B DF EE 39 */	bl subBgmStart__8Z2SeqMgrFUl
/* 804B0668  48 00 00 C4 */	b lbl_804B072C
lbl_804B066C:
/* 804B066C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B0670  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804B0684  4B DF EE 19 */	bl subBgmStart__8Z2SeqMgrFUl
...
/* 804B06A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B06A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B06AC  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 804B06B0  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 804B06B4  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 804B06B8  A0 84 03 A6 */	lhz r4, 0x3a6(r4)
/* 804B06BC  4B B8 43 01 */	bl isEventBit__11dSv_event_cCFUs
...
/* 804B0744  3C 60 80 45 */	lis r3, struct_80450C98+0x2@ha /* 0x80450C9A@ha */
/* 804B0748  38 83 0C 9A */	addi r4, r3, struct_80450C98+0x2@l /* 0x80450C9A@l */
...
lbl_804B076C:
/* 804B076C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0770  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B0774  3A C3 07 F0 */	addi r22, r3, 0x7f0
/* 804B0778  7E C3 B3 78 */	mr r3, r22
/* 804B077C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 804B0780  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 804B0784  A0 84 03 A6 */	lhz r4, 0x3a6(r4)
/* 804B0788  4B B8 42 05 */	bl onEventBit__11dSv_event_cFUs
...
/* 804B079C  4B B8 42 69 */	bl getEventReg__11dSv_event_cCFUs
...
/* 804B07B4  4B B8 42 2D */	bl setEventReg__11dSv_event_cFUsUc
...
/* 804B0888  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B088C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804B0890  90 03 5E 0C */	stw r0, 0x5e0c(r3)
/* 804B0894  48 00 00 14 */	b lbl_804B08A8
lbl_804B0898:
/* 804B0898  7F 00 07 34 */	extsh r0, r24
/* 804B089C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B08A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B08BC  4B D9 96 D5 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 804B08E4  4B D9 99 F5 */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 804B090C  3C 60 80 45 */	lis r3, struct_80450C98+0x3@ha /* 0x80450C9B@ha */
/* 804B0910  98 03 0C 9B */	stb r0, struct_80450C98+0x3@l(r3)  /* 0x80450C9B@l */
/* 804B0914  4B D8 7B 2D */	bl getSelectCursorPos__12dMsgObject_cFv
/* 804B0918  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804B091C  40 82 00 CC */	bne lbl_804B09E8
/* 804B0920  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B0924  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B093C  4B B8 40 A5 */	bl setEventReg__11dSv_event_cFUsUc
...
/* 804B0978  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B097C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B099C  4B CB 26 71 */	bl SetTrimSize__9dCamera_cFl
...
/* 804B09B4  3C 60 80 45 */	lis r3, struct_80450C98+0x3@ha /* 0x80450C9B@ha */
/* 804B09B8  9C 03 0C 9B */	stbu r0, struct_80450C98+0x3@l(r3)  /* 0x80450C9B@l */
...
/* 804B0A7C  4B EB 17 8D */	bl _restgpr_21
