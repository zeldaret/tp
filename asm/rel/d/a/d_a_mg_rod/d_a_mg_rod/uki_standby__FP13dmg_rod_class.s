...
/* 804B3474  4B EA ED 65 */	bl _savegpr_28
/* 804B3478  7C 7D 1B 78 */	mr r29, r3
/* 804B347C  3C 60 80 4C */	lis r3, lit_3879@ha /* 0x804BB534@ha */
/* 804B3480  3B E3 B5 34 */	addi r31, r3, lit_3879@l /* 0x804BB534@l */
/* 804B3484  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B3488  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B34D0  4B DB C5 6D */	bl cLib_addCalc2__FPffff
...
/* 804B34E4  4B DB C5 59 */	bl cLib_addCalc2__FPffff
...
/* 804B350C  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 804B3510  C0 03 D2 E8 */	lfs f0, m_cpadInfo__8mDoCPd_c@l(r3)  /* 0x803DD2E8@l */
...
lbl_804B352C:
/* 804B352C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804B3530  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804B3534  80 63 00 00 */	lwz r3, 0(r3)
/* 804B3538  A8 9D 14 18 */	lha r4, 0x1418(r29)
/* 804B353C  4B B5 8E A1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 804B355C  4B DB D9 91 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804B3588  4B DB 35 AD */	bl __mi__4cXyzCFRC3Vec
...
/* 804B35A8  4B E9 3B 91 */	bl PSVECSquareMag
...
/* 804B3618  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804B361C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804B3688  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804B368C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804B3690:
...
/* 804B36F4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804B36F8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804B373C  4B DB C3 01 */	bl cLib_addCalc2__FPffff
...
/* 804B37AC  4B B6 C0 D1 */	bl fopKyM_createWpillar__FPC4cXyzfi
lbl_804B37B0:
...
/* 804B3830  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B3834  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B3884  4B DB C1 FD */	bl cLib_addCalc0__FPfff
...
/* 804B3898  4B DB C1 A5 */	bl cLib_addCalc2__FPffff
...
/* 804B3934  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804B3938  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804B39A4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804B39A8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804B39AC:
...
/* 804B3A04  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B3A08  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 804B3A0C  80 63 00 00 */	lwz r3, 0(r3)
/* 804B3A10  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 804B3A14  38 80 00 01 */	li r4, 1
/* 804B3A18  4B DF F0 71 */	bl changeFishingBgm__8Z2SeqMgrFl
...
/* 804B3A48  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B3A4C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 804B3A50  80 63 00 00 */	lwz r3, 0(r3)
/* 804B3A54  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 804B3A58  38 80 00 00 */	li r4, 0
/* 804B3A5C  4B DF F0 2D */	bl changeFishingBgm__8Z2SeqMgrFl
lbl_804B3A60:
/* 804B3A60  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 804B3A64  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
...
/* 804B3A7C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804B3A80  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 804B3A84  80 63 00 00 */	lwz r3, 0(r3)
/* 804B3A88  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 804B3A8C  38 80 00 00 */	li r4, 0
/* 804B3A90  4B DF EF F9 */	bl changeFishingBgm__8Z2SeqMgrFl
lbl_804B3A94:
/* 804B3A94  A8 1D 05 7A */	lha r0, 0x57a(r29)
/* 804B3A98  2C 00 00 00 */	cmpwi r0, 0
/* 804B3A9C  40 82 00 84 */	bne lbl_804B3B20
/* 804B3AA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B3AA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B3AB8  4B BD 0B A1 */	bl ChkCoHit__12dCcD_GObjInfFv
/* 804B3ABC  28 03 00 00 */	cmplwi r3, 0
/* 804B3AC0  40 82 00 58 */	bne lbl_804B3B18
/* 804B3AC4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B3AC8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B3B34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804B3B38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804B3B68  4B EA E6 BD */	bl _restgpr_28
