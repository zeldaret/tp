...
/* 804CA69C  3C 60 80 4D */	lis r3, lit_5987@ha /* 0x804CC584@ha */
/* 804CA6A0  38 83 C5 84 */	addi r4, r3, lit_5987@l /* 0x804CC584@l */
...
/* 804CA6C4  4B BD 31 C1 */	bl getAlinkArcName__9daAlink_cFv
/* 804CA6C8  38 80 00 14 */	li r4, 0x14
/* 804CA6CC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CA6D0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804CA6D4  3C A5 00 02 */	addis r5, r5, 2
/* 804CA6D8  38 C0 00 80 */	li r6, 0x80
/* 804CA6DC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 804CA6E0  4B B7 1C 0D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804CA6F4  3C E0 80 4D */	lis r7, lit_6001@ha /* 0x804CC4A0@ha */
/* 804CA6F8  C0 27 C4 A0 */	lfs f1, lit_6001@l(r7)  /* 0x804CC4A0@l */
/* 804CA6FC  38 E0 00 00 */	li r7, 0
/* 804CA700  39 00 FF FF */	li r8, -1
/* 804CA704  39 20 00 01 */	li r9, 1
/* 804CA708  4B B4 30 D5 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 804CA724  3C 60 80 4C */	lis r3, daNbomb_coHitCallback__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 0x804C6E10@ha */
/* 804CA728  38 03 6E 10 */	addi r0, r3, daNbomb_coHitCallback__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 0x804C6E10@l */
...
/* 804CA73C  3C 60 80 4D */	lis r3, lit_5880@ha /* 0x804CC494@ha */
/* 804CA740  C0 03 C4 94 */	lfs f0, lit_5880@l(r3)  /* 0x804CC494@l */
