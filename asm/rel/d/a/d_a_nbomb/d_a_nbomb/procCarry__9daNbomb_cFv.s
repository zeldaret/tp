...
/* 804C956C  4B E9 8C 6D */	bl _savegpr_28
/* 804C9570  7C 7E 1B 78 */	mr r30, r3
/* 804C9574  3C 60 80 4D */	lis r3, lit_3767@ha /* 0x804CC340@ha */
/* 804C9578  3B E3 C3 40 */	addi r31, r3, lit_3767@l /* 0x804CC340@l */
/* 804C957C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C9580  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804C9594  4B DA 71 AD */	bl cLib_chaseF__FPfff
...
/* 804C9624  3C 80 80 43 */	lis r4, BaseY__4cXyz@ha /* 0x80430D24@ha */
/* 804C9628  38 84 0D 24 */	addi r4, r4, BaseY__4cXyz@l /* 0x80430D24@l */
/* 804C962C  38 BE 0B F0 */	addi r5, r30, 0xbf0
/* 804C9630  4B E7 D8 1D */	bl PSMTXMultVecSR
/* 804C9634  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 804C9638  38 63 00 24 */	addi r3, r3, 0x24
/* 804C963C  3C 80 80 43 */	lis r4, BaseZ__4cXyz@ha /* 0x80430D3C@ha */
/* 804C9640  38 84 0D 3C */	addi r4, r4, BaseZ__4cXyz@l /* 0x80430D3C@l */
/* 804C9644  38 BE 0B FC */	addi r5, r30, 0xbfc
/* 804C9648  4B E7 D8 05 */	bl PSMTXMultVecSR
/* 804C964C  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 804C9650  38 63 00 24 */	addi r3, r3, 0x24
/* 804C9654  3C 80 80 43 */	lis r4, BaseX__4cXyz@ha /* 0x80430D0C@ha */
/* 804C9658  38 84 0D 0C */	addi r4, r4, BaseX__4cXyz@l /* 0x80430D0C@l */
/* 804C965C  38 BE 0C 08 */	addi r5, r30, 0xc08
/* 804C9660  4B E7 D7 ED */	bl PSMTXMultVecSR
/* 804C9664  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 804C9668  38 63 00 24 */	addi r3, r3, 0x24
/* 804C966C  38 9E 04 E4 */	addi r4, r30, 0x4e4
/* 804C9670  4B B4 35 91 */	bl mDoMtx_MtxToRot__FPA4_CfP5csXyz
...
/* 804C970C  4B BA E6 59 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 804C97B4  4B BA E5 B1 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 804C9854  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C9858  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804C985C  38 84 0F 38 */	addi r4, r4, 0xf38
/* 804C9860  4B BA D2 4D */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 804C98F8  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 804C98FC  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 804C991C  4B E9 89 09 */	bl _restgpr_28
