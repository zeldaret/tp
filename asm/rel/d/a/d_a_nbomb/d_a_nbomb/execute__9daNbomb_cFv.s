...
/* 804CAF10  4B E9 72 BD */	bl _savegpr_25
/* 804CAF14  7C 7F 1B 78 */	mr r31, r3
/* 804CAF18  3C 60 80 4D */	lis r3, lit_3767@ha /* 0x804CC340@ha */
/* 804CAF1C  3B C3 C3 40 */	addi r30, r3, lit_3767@l /* 0x804CC340@l */
...
lbl_804CAF44:
/* 804CAF44  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804CAF48  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804CAF80  4B E7 C1 B9 */	bl PSVECSquareMag
...
/* 804CAFAC  4B E7 C0 E5 */	bl PSVECAdd
/* 804CAFB0  38 61 00 A4 */	addi r3, r1, 0xa4
/* 804CAFB4  4B D9 C1 75 */	bl atan2sX_Z__4cXyzCFv
...
/* 804CAFD8  4B E7 C1 61 */	bl PSVECSquareMag
...
/* 804CB048  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CB04C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804CB0B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CB0BC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804CB0C0:
...
/* 804CB0D0  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 804CB0D4  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 804CB100  4B E7 C0 39 */	bl PSVECSquareMag
...
/* 804CB134  4B B5 28 75 */	bl fopAcM_getWaterStream__FPC4cXyzRC13cBgS_PolyInfoP4cXyzPii
...
/* 804CB190  4B DA 49 29 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 804CB1B0  4B E7 BE E1 */	bl PSVECAdd
/* 804CB1B4  38 61 00 A4 */	addi r3, r1, 0xa4
/* 804CB1B8  4B D9 BF 71 */	bl atan2sX_Z__4cXyzCFv
...
/* 804CB1DC  4B E7 BF 5D */	bl PSVECSquareMag
...
/* 804CB24C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CB250  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804CB2BC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CB2C0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804CB2C4:
...
/* 804CB2D4  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 804CB2D8  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 804CB33C  4B DA 54 05 */	bl cLib_chaseF__FPfff
...
/* 804CB384  4B E9 6C 95 */	bl __ptmf_test
...
/* 804CB398  4B E9 6C ED */	bl __ptmf_scall
...
/* 804CB3B0  4B B4 E8 CD */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 804CB3CC  4B C0 C3 9D */	bl checkIcePolygonDamage__9daAlink_cFP13cBgS_PolyInfo
...
/* 804CB3E8  4B C0 C3 81 */	bl checkIcePolygonDamage__9daAlink_cFP13cBgS_PolyInfo
...
/* 804CB404  4B C0 C3 65 */	bl checkIcePolygonDamage__9daAlink_cFP13cBgS_PolyInfo
...
/* 804CB424  4B B4 20 05 */	bl play__14mDoExt_baseAnmFv
lbl_804CB428:
/* 804CB428  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CB42C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CB450  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CB454  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804CB458  38 63 0F 38 */	addi r3, r3, 0xf38
/* 804CB45C  38 9F 06 F8 */	addi r4, r31, 0x6f8
/* 804CB460  4B BA 99 F1 */	bl GetPolyAtt0__4dBgSFRC13cBgS_PolyInfo
...
/* 804CB490  4B B6 1B DD */	bl dComIfGp_getReverb__Fi
...
/* 804CB4A4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 804CB4A8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 804CB4D0  4B DE 04 B5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 804CB538  4B D9 B6 4D */	bl __ml__4cXyzCFf
...
/* 804CB584  4B B5 42 F9 */	bl fopKyM_createWpillar__FPC4cXyzfi
...
/* 804CB628  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 804CB62C  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 804CB664  4B C1 81 8D */	bl getBombWaterGravity__9daAlink_cCFv
/* 804CB668  D0 3F 05 30 */	stfs f1, 0x530(r31)
/* 804CB66C  7F 83 E3 78 */	mr r3, r28
/* 804CB670  4B C1 81 91 */	bl getBombWaterMaxFallSpeed__9daAlink_cCFv
...
/* 804CB6B4  4B B4 E5 C9 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 804CB6B8  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 804CB6BC  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 804CB6EC  4B B4 E5 91 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 804CB708  4B C1 80 69 */	bl getBombGravity__9daAlink_cCFv
/* 804CB70C  D0 3F 05 30 */	stfs f1, 0x530(r31)
/* 804CB710  7F 83 E3 78 */	mr r3, r28
/* 804CB714  4B C1 80 6D */	bl getBombMaxFallSpeed__9daAlink_cCFv
...
/* 804CB780  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804CB784  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804CB7C0  4B E7 B9 79 */	bl PSVECSquareMag
...
/* 804CB830  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CB834  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804CB8A0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CB8A4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804CB8A8:
/* 804CB8A8  FF A0 08 90 */	fmr f29, f1
/* 804CB8AC  38 61 00 80 */	addi r3, r1, 0x80
/* 804CB8B0  4B D9 B8 79 */	bl atan2sX_Z__4cXyzCFv
...
/* 804CB8F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB8FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CB900  7F 24 CB 78 */	mr r4, r25
/* 804CB904  4B B4 0A D9 */	bl mDoMtx_YrotS__FPA4_fs
/* 804CB908  2C 1B 00 00 */	cmpwi r27, 0
/* 804CB90C  40 82 00 18 */	bne lbl_804CB924
/* 804CB910  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB914  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CB918  7F 44 D3 78 */	mr r4, r26
/* 804CB91C  4B B4 0A 81 */	bl mDoMtx_XrotM__FPA4_fs
/* 804CB920  48 00 00 1C */	b lbl_804CB93C
lbl_804CB924:
/* 804CB924  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB928  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CB92C  7F 40 07 34 */	extsh r0, r26
/* 804CB930  7C 00 0E 70 */	srawi r0, r0, 1
/* 804CB934  7C 04 07 34 */	extsh r4, r0
/* 804CB938  4B B4 0A 65 */	bl mDoMtx_XrotM__FPA4_fs
lbl_804CB93C:
/* 804CB93C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB940  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CB944  7C 19 00 D0 */	neg r0, r25
/* 804CB948  7C 04 07 34 */	extsh r4, r0
/* 804CB94C  4B B4 0A E9 */	bl mDoMtx_YrotM__FPA4_fs
/* 804CB950  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB954  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CB958  38 9F 0A 40 */	addi r4, r31, 0xa40
/* 804CB95C  7C 65 1B 78 */	mr r5, r3
/* 804CB960  4B E7 AB 85 */	bl PSMTXConcat
/* 804CB964  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB968  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CB96C  38 9F 0A 40 */	addi r4, r31, 0xa40
/* 804CB970  4B E7 AB 41 */	bl PSMTXCopy
lbl_804CB974:
...
/* 804CB9B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB9B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804CB9C8  4B B4 0A 15 */	bl mDoMtx_YrotS__FPA4_fs
/* 804CB9CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB9D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CB9D4  38 9F 0A 40 */	addi r4, r31, 0xa40
/* 804CB9D8  7C 65 1B 78 */	mr r5, r3
/* 804CB9DC  4B E7 AB 09 */	bl PSMTXConcat
/* 804CB9E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CB9E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CB9E8  38 9F 0A 40 */	addi r4, r31, 0xa40
/* 804CB9EC  4B E7 AA C5 */	bl PSMTXCopy
lbl_804CB9F0:
...
/* 804CBA38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CBA3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804CBA58  4B E7 AE 91 */	bl PSMTXTrans
/* 804CBA5C  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 804CBA60  4B B4 14 E5 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 804CBA64  C0 3E 00 40 */	lfs f1, 0x40(r30)
/* 804CBA68  C0 5E 01 74 */	lfs f2, 0x174(r30)
/* 804CBA6C  FC 60 08 90 */	fmr f3, f1
/* 804CBA70  4B B4 13 2D */	bl transM__14mDoMtx_stack_cFfff
/* 804CBA74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CBA78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CBA7C  38 9F 0A 40 */	addi r4, r31, 0xa40
/* 804CBA80  7C 65 1B 78 */	mr r5, r3
/* 804CBA84  4B E7 AA 61 */	bl PSMTXConcat
/* 804CBA88  C0 3E 00 40 */	lfs f1, 0x40(r30)
/* 804CBA8C  C0 5E 01 84 */	lfs f2, 0x184(r30)
/* 804CBA90  FC 60 08 90 */	fmr f3, f1
/* 804CBA94  4B B4 13 09 */	bl transM__14mDoMtx_stack_cFfff
/* 804CBA98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804CBA9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804CBAA0  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 804CBAA4  38 84 00 24 */	addi r4, r4, 0x24
/* 804CBAA8  4B E7 AA 09 */	bl PSMTXCopy
lbl_804CBAAC:
...
/* 804CBABC  4B E7 B2 B1 */	bl PSMTXMultVec
...
/* 804CBAE0  4B DA 3B 69 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 804CBAF4  4B DA 3C 15 */	bl SetR__8cM3dGSphFf
/* 804CBAF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CBAFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804CBB00  3B 63 23 3C */	addi r27, r3, 0x233c
/* 804CBB04  7F 63 DB 78 */	mr r3, r27
/* 804CBB08  38 9F 07 CC */	addi r4, r31, 0x7cc
/* 804CBB0C  4B D9 90 9D */	bl Set__4cCcSFP8cCcD_Obj
...
/* 804CBB24  4B DA 3B 25 */	bl SetC__8cM3dGSphFRC4cXyz
/* 804CBB28  7F 63 DB 78 */	mr r3, r27
/* 804CBB2C  38 9F 09 04 */	addi r4, r31, 0x904
/* 804CBB30  4B D9 90 79 */	bl Set__4cCcSFP8cCcD_Obj
lbl_804CBB34:
...
/* 804CBB60  4B B4 1E 6D */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_804CBB64:
...
/* 804CBBEC  4B B6 14 81 */	bl dComIfGp_getReverb__Fi
...
/* 804CBC2C  4B E9 65 ED */	bl _restgpr_25
