...
/* 804C8310  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C8314  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804C8348  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C834C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804C8350  83 C3 5D B4 */	lwz r30, 0x5db4(r3)
/* 804C8354  7F C3 F3 78 */	mr r3, r30
/* 804C8358  4B C1 B4 09 */	bl getBombExplodeTime__9daAlink_cCFv
...
/* 804C8370  4B C1 B3 F1 */	bl getBombExplodeTime__9daAlink_cCFv
/* 804C8374  7C 60 07 34 */	extsh r0, r3
/* 804C8378  3C 60 80 4D */	lis r3, lit_4689@ha /* 0x804CC3D8@ha */
/* 804C837C  C8 23 C3 D8 */	lfd f1, lit_4689@l(r3)  /* 0x804CC3D8@l */
...
/* 804C8398  3C 60 80 4D */	lis r3, lit_5021@ha /* 0x804CC3E0@ha */
/* 804C839C  C0 03 C3 E0 */	lfs f0, lit_5021@l(r3)  /* 0x804CC3E0@l */
...
/* 804C83F0  4B C0 F3 79 */	bl checkIcePolygonDamage__9daAlink_cFP13cBgS_PolyInfo
