...
/* 804C7EC4  4B E9 A3 11 */	bl _savegpr_27
/* 804C7EC8  7C 7E 1B 79 */	or. r30, r3, r3
/* 804C7ECC  7C 9F 23 78 */	mr r31, r4
/* 804C7ED0  41 82 03 80 */	beq lbl_804C8250
/* 804C7ED4  3C 60 80 4D */	lis r3, __vt__9daNbomb_c@ha /* 0x804CC64C@ha */
/* 804C7ED8  38 03 C6 4C */	addi r0, r3, __vt__9daNbomb_c@l /* 0x804CC64C@l */
...
/* 804C7EF8  3C C0 80 4D */	lis r6, lit_4255@ha /* 0x804CC380@ha */
/* 804C7EFC  C0 26 C3 80 */	lfs f1, lit_4255@l(r6)  /* 0x804CC380@l */
/* 804C7F00  4B CD FF 89 */	bl dKy_actor_addcol_set__Fsssf
lbl_804C7F04:
/* 804C7F04  38 7E 0B 60 */	addi r3, r30, 0xb60
/* 804C7F08  4B CD FA 25 */	bl dKy_plight_cut__FP15LIGHT_INFLUENCE
/* 804C7F0C  38 7E 0B 80 */	addi r3, r30, 0xb80
/* 804C7F10  4B B9 2F 49 */	bl dKyw_pntwind_cut__FP14WIND_INFLUENCE
/* 804C7F14  38 7E 0B 20 */	addi r3, r30, 0xb20
/* 804C7F18  4B DF 60 E1 */	bl deleteObject__14Z2SoundObjBaseFv
...
/* 804C7F30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C7F34  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_804C7F38:
...
/* 804C7F48  4B B8 39 D1 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 804C7F84  3C 80 80 4D */	lis r4, m_arcNameList__9daNbomb_c@ha /* 0x804CC518@ha */
/* 804C7F88  38 84 C5 18 */	addi r4, r4, m_arcNameList__9daNbomb_c@l /* 0x804CC518@l */
/* 804C7F8C  7C 84 00 2E */	lwzx r4, r4, r0
/* 804C7F90  4B B6 50 79 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
lbl_804C7F94:
/* 804C7F94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C7F98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804C7FEC  4B B5 4B B5 */	bl fopAcM_cancelCarryNow__FP10fopAc_ac_c
/* 804C7FF0  80 1E 04 9C */	lwz r0, 0x49c(r30)
/* 804C7FF4  54 00 03 14 */	rlwinm r0, r0, 0, 0xc, 0xa
/* 804C7FF8  90 1E 04 9C */	stw r0, 0x49c(r30)
/* 804C7FFC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C8000  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804C8004  80 63 5D 3C */	lwz r3, 0x5d3c(r3)
/* 804C8008  38 63 02 10 */	addi r3, r3, 0x210
/* 804C800C  80 9E 0B B8 */	lwz r4, 0xbb8(r30)
/* 804C8010  4B B8 39 09 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 804C802C  3C 60 80 3D */	lis r3, __vt__16Z2SoundObjSimple@ha /* 0x803CAD10@ha */
/* 804C8030  38 03 AD 10 */	addi r0, r3, __vt__16Z2SoundObjSimple@l /* 0x803CAD10@l */
/* 804C8034  90 1E 0B 30 */	stw r0, 0xb30(r30)
/* 804C8038  38 7E 0B 20 */	addi r3, r30, 0xb20
/* 804C803C  38 80 00 00 */	li r4, 0
/* 804C8040  4B DF 5F 09 */	bl __dt__14Z2SoundObjBaseFv
lbl_804C8044:
/* 804C8044  38 7E 0B 10 */	addi r3, r30, 0xb10
/* 804C8048  38 80 FF FF */	li r4, -1
/* 804C804C  4B DA 00 65 */	bl __dt__13cBgS_PolyInfoFv
/* 804C8050  38 7E 0A A0 */	addi r3, r30, 0xaa0
/* 804C8054  38 80 FF FF */	li r4, -1
/* 804C8058  4B BB 01 09 */	bl __dt__15dBgS_BombLinChkFv
/* 804C805C  34 1E 09 04 */	addic. r0, r30, 0x904
/* 804C8060  41 82 00 84 */	beq lbl_804C80E4
/* 804C8064  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 804C8068  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 804C8088  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 804C808C  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 804C80A4  3C 60 80 4D */	lis r3, __vt__8cM3dGSph@ha /* 0x804CC610@ha */
/* 804C80A8  38 03 C6 10 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x804CC610@l */
/* 804C80AC  90 1E 0A 38 */	stw r0, 0xa38(r30)
lbl_804C80B0:
/* 804C80B0  34 1E 0A 08 */	addic. r0, r30, 0xa08
/* 804C80B4  41 82 00 24 */	beq lbl_804C80D8
/* 804C80B8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 804C80BC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 804C80C0  90 1E 0A 24 */	stw r0, 0xa24(r30)
/* 804C80C4  34 1E 0A 08 */	addic. r0, r30, 0xa08
/* 804C80C8  41 82 00 10 */	beq lbl_804C80D8
/* 804C80CC  3C 60 80 4D */	lis r3, __vt__8cM3dGAab@ha /* 0x804CC61C@ha */
/* 804C80D0  38 03 C6 1C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x804CC61C@l */
/* 804C80D4  90 1E 0A 20 */	stw r0, 0xa20(r30)
lbl_804C80D8:
/* 804C80D8  38 7E 09 04 */	addi r3, r30, 0x904
/* 804C80DC  38 80 00 00 */	li r4, 0
/* 804C80E0  4B BB C0 05 */	bl __dt__12dCcD_GObjInfFv
lbl_804C80E4:
/* 804C80E4  34 1E 07 CC */	addic. r0, r30, 0x7cc
/* 804C80E8  41 82 00 84 */	beq lbl_804C816C
/* 804C80EC  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 804C80F0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 804C8110  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 804C8114  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 804C812C  3C 60 80 4D */	lis r3, __vt__8cM3dGSph@ha /* 0x804CC610@ha */
/* 804C8130  38 03 C6 10 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x804CC610@l */
/* 804C8134  90 1E 09 00 */	stw r0, 0x900(r30)
lbl_804C8138:
/* 804C8138  34 1E 08 D0 */	addic. r0, r30, 0x8d0
/* 804C813C  41 82 00 24 */	beq lbl_804C8160
/* 804C8140  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 804C8144  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 804C8148  90 1E 08 EC */	stw r0, 0x8ec(r30)
/* 804C814C  34 1E 08 D0 */	addic. r0, r30, 0x8d0
/* 804C8150  41 82 00 10 */	beq lbl_804C8160
/* 804C8154  3C 60 80 4D */	lis r3, __vt__8cM3dGAab@ha /* 0x804CC61C@ha */
/* 804C8158  38 03 C6 1C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x804CC61C@l */
/* 804C815C  90 1E 08 E8 */	stw r0, 0x8e8(r30)
lbl_804C8160:
/* 804C8160  38 7E 07 CC */	addi r3, r30, 0x7cc
/* 804C8164  38 80 00 00 */	li r4, 0
/* 804C8168  4B BB BF 7D */	bl __dt__12dCcD_GObjInfFv
lbl_804C816C:
/* 804C816C  34 1E 07 90 */	addic. r0, r30, 0x790
/* 804C8170  41 82 00 54 */	beq lbl_804C81C4
/* 804C8174  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 804C8178  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 804C8190  3C 60 80 4D */	lis r3, __vt__10dCcD_GStts@ha /* 0x804CC604@ha */
/* 804C8194  38 03 C6 04 */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x804CC604@l */
/* 804C8198  90 1E 07 AC */	stw r0, 0x7ac(r30)
/* 804C819C  34 1E 07 AC */	addic. r0, r30, 0x7ac
/* 804C81A0  41 82 00 10 */	beq lbl_804C81B0
/* 804C81A4  3C 60 80 4D */	lis r3, __vt__10cCcD_GStts@ha /* 0x804CC5F8@ha */
/* 804C81A8  38 03 C5 F8 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x804CC5F8@l */
/* 804C81AC  90 1E 07 AC */	stw r0, 0x7ac(r30)
lbl_804C81B0:
/* 804C81B0  34 1E 07 90 */	addic. r0, r30, 0x790
/* 804C81B4  41 82 00 10 */	beq lbl_804C81C4
/* 804C81B8  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 804C81BC  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 804C81C0  90 1E 07 A8 */	stw r0, 0x7a8(r30)
lbl_804C81C4:
/* 804C81C4  34 1E 07 50 */	addic. r0, r30, 0x750
/* 804C81C8  41 82 00 28 */	beq lbl_804C81F0
/* 804C81CC  3C 60 80 4D */	lis r3, __vt__12dBgS_AcchCir@ha /* 0x804CC5EC@ha */
/* 804C81D0  38 03 C5 EC */	addi r0, r3, __vt__12dBgS_AcchCir@l /* 0x804CC5EC@l */
/* 804C81D4  90 1E 07 5C */	stw r0, 0x75c(r30)
/* 804C81D8  38 7E 07 64 */	addi r3, r30, 0x764
/* 804C81DC  38 80 FF FF */	li r4, -1
/* 804C81E0  4B DA 6D 39 */	bl __dt__8cM3dGCirFv
/* 804C81E4  38 7E 07 50 */	addi r3, r30, 0x750
/* 804C81E8  38 80 00 00 */	li r4, 0
/* 804C81EC  4B D9 FE C5 */	bl __dt__13cBgS_PolyInfoFv
lbl_804C81F0:
/* 804C81F0  34 1E 05 78 */	addic. r0, r30, 0x578
/* 804C81F4  41 82 00 2C */	beq lbl_804C8220
/* 804C81F8  3C 60 80 4D */	lis r3, __vt__13dBgS_BombAcch@ha /* 0x804CC628@ha */
/* 804C81FC  38 63 C6 28 */	addi r3, r3, __vt__13dBgS_BombAcch@l /* 0x804CC628@l */
