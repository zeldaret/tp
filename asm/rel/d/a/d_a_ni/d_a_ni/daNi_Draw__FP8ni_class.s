...
/* 8094C120  4B A1 60 BC */	b _savegpr_29
/* 8094C124  7C 7D 1B 78 */	mr r29, r3
/* 8094C128  3C 60 80 95 */	lis r3, lit_3958@ha
/* 8094C12C  3B E3 11 C0 */	addi r31, r3, lit_3958@l
/* 8094C130  80 7D 05 E8 */	lwz r3, 0x5e8(r29)
/* 8094C134  83 C3 00 04 */	lwz r30, 4(r3)
/* 8094C138  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8094C13C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8094C140  38 80 00 00 */	li r4, 0
/* 8094C144  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 8094C148  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8094C14C  4B 85 76 78 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8094C150  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8094C154  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8094C158  80 9E 00 04 */	lwz r4, 4(r30)
/* 8094C15C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8094C160  4B 85 8C 40 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8094C174  4B 6C 15 64 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 8094C178  80 7D 05 E8 */	lwz r3, 0x5e8(r29)
/* 8094C17C  4B 6C 45 04 */	b entryDL__14mDoExt_McaMorfFv
...
/* 8094C1D8  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 8094C1DC  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 8094C1E0  4B 6E 27 30 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 8094C1E4  90 7D 06 00 */	stw r3, 0x600(r29)
lbl_8094C1E8:
/* 8094C1E8  38 60 00 01 */	li r3, 1
/* 8094C1EC  39 61 00 30 */	addi r11, r1, 0x30
/* 8094C1F0  4B A1 60 38 */	b _restgpr_29
