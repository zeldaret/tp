...
/* 8094C540  4B A1 5C 91 */	bl _savegpr_26
/* 8094C544  7C 7E 1B 78 */	mr r30, r3
/* 8094C548  3C 60 80 95 */	lis r3, lit_3958@ha /* 0x809511C0@ha */
/* 8094C54C  3B E3 11 C0 */	addi r31, r3, lit_3958@l /* 0x809511C0@l */
/* 8094C550  38 A0 00 00 */	li r5, 0
/* 8094C554  3C 60 80 95 */	lis r3, target_info_count@ha /* 0x80951600@ha */
/* 8094C558  90 A3 16 00 */	stw r5, target_info_count@l(r3)  /* 0x80951600@l */
/* 8094C55C  7C A3 2B 78 */	mr r3, r5
/* 8094C560  3C 80 80 95 */	lis r4, target_info@ha /* 0x809515D8@ha */
/* 8094C564  38 84 15 D8 */	addi r4, r4, target_info@l /* 0x809515D8@l */
...
/* 8094C57C  3C 60 80 95 */	lis r3, s_t_sub__FPvPv@ha /* 0x8094C4B0@ha */
/* 8094C580  38 63 C4 B0 */	addi r3, r3, s_t_sub__FPvPv@l /* 0x8094C4B0@l */
/* 8094C584  7F C4 F3 78 */	mr r4, r30
/* 8094C588  4B 6D 4D B1 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 8094C58C  C3 DF 00 28 */	lfs f30, 0x28(r31)
/* 8094C590  3C 60 80 95 */	lis r3, target_info_count@ha /* 0x80951600@ha */
/* 8094C594  3B 83 16 00 */	addi r28, r3, target_info_count@l /* 0x80951600@l */
...
/* 8094C5C0  4B 91 A5 75 */	bl __mi__4cXyzCFRC3Vec
...
lbl_8094C638:
/* 8094C638  3C 60 80 95 */	lis r3, target_info@ha /* 0x809515D8@ha */
/* 8094C63C  3B A3 15 D8 */	addi r29, r3, target_info@l /* 0x809515D8@l */
...
/* 8094C674  4B A1 5B A9 */	bl _restgpr_26
