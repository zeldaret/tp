...
/* 8094DEE0  4B A1 42 FD */	bl _savegpr_29
/* 8094DEE4  7C 7D 1B 78 */	mr r29, r3
/* 8094DEE8  3C 60 80 95 */	lis r3, lit_3958@ha /* 0x809511C0@ha */
/* 8094DEEC  3B E3 11 C0 */	addi r31, r3, lit_3958@l /* 0x809511C0@l */
/* 8094DEF0  38 00 02 9C */	li r0, 0x29c
/* 8094DEF4  B0 01 00 08 */	sth r0, 8(r1)
/* 8094DEF8  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 8094DEFC  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 8094DF00  38 81 00 08 */	addi r4, r1, 8
/* 8094DF04  4B 6C B8 F5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8094DF30  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8094DF34  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8094DF38  4B 9F 85 79 */	bl PSMTXCopy
/* 8094DF3C  C0 3F 00 C4 */	lfs f1, 0xc4(r31)
/* 8094DF40  C0 5F 00 24 */	lfs f2, 0x24(r31)
/* 8094DF44  FC 60 10 90 */	fmr f3, f2
/* 8094DF48  4B 6B EE 55 */	bl transM__14mDoMtx_stack_cFfff
/* 8094DF4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8094DF50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8094E050  4B 91 8A E5 */	bl __mi__4cXyzCFRC3Vec
...
/* 8094E078  4B 91 95 FD */	bl cM_atan2s__Fff
...
/* 8094E12C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8094E130  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8094E19C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8094E1A0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8094E1A4:
...
/* 8094E1EC  4B 92 18 51 */	bl cLib_addCalc2__FPffff
...
/* 8094E200  4B 92 18 3D */	bl cLib_addCalc2__FPffff
...
/* 8094E214  4B 92 18 29 */	bl cLib_addCalc2__FPffff
...
/* 8094E268  4B 92 23 A1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8094E29C  4B A1 3F 8D */	bl _restgpr_29
