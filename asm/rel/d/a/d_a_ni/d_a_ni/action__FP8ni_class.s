...
/* 8094F5F0  4B A1 2B D1 */	bl _savegpr_22
/* 8094F5F4  7C 7C 1B 78 */	mr r28, r3
/* 8094F5F8  3C 80 80 95 */	lis r4, cNullVec__6Z2Calc@ha /* 0x80951330@ha */
/* 8094F5FC  3B A4 13 30 */	addi r29, r4, cNullVec__6Z2Calc@l /* 0x80951330@l */
/* 8094F600  3C 80 80 95 */	lis r4, lit_1109@ha /* 0x80951550@ha */
/* 8094F604  3B C4 15 50 */	addi r30, r4, lit_1109@l /* 0x80951550@l */
/* 8094F608  3C 80 80 95 */	lis r4, lit_3958@ha /* 0x809511C0@ha */
/* 8094F60C  3B E4 11 C0 */	addi r31, r4, lit_3958@l /* 0x809511C0@l */
...
/* 8094F624  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8094F628  3A C4 61 C0 */	addi r22, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8094F62C  80 96 5D AC */	lwz r4, 0x5dac(r22)
/* 8094F630  4B 6C B1 B1 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8094F634  D0 3C 05 E0 */	stfs f1, 0x5e0(r28)
/* 8094F638  7F 83 E3 78 */	mr r3, r28
/* 8094F63C  80 96 5D AC */	lwz r4, 0x5dac(r22)
/* 8094F640  4B 6C B0 D1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8094F694  3C 60 80 95 */	lis r3, lit_5666@ha /* 0x809513FC@ha */
/* 8094F698  38 63 13 FC */	addi r3, r3, lit_5666@l /* 0x809513FC@l */
...
/* 8094F82C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8094F830  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8094F8A4  4B 92 0D 65 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8094F8DC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8094F8E0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8094F8E4  80 63 00 00 */	lwz r3, 0(r3)
/* 8094F8E8  A8 9C 04 DE */	lha r4, 0x4de(r28)
/* 8094F8EC  4B 6B CA F1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8094F90C  4B 92 15 E1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8094F980  4B 9F 77 11 */	bl PSVECAdd
...
/* 8094F9B4  4B 92 00 CD */	bl cLib_addCalc0__FPfff
/* 8094F9B8  48 00 02 F0 */	b lbl_8094FCA8
lbl_8094F9BC:
/* 8094F9BC  2C 16 00 02 */	cmpwi r22, 2
/* 8094F9C0  40 82 02 D8 */	bne lbl_8094FC98
/* 8094F9C4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8094F9C8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8094F9CC  80 63 00 00 */	lwz r3, 0(r3)
/* 8094F9D0  A8 9C 04 DE */	lha r4, 0x4de(r28)
/* 8094F9D4  4B 6B CA 09 */	bl mDoMtx_YrotS__FPA4_fs
/* 8094F9D8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8094F9DC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8094F9E0  80 63 00 00 */	lwz r3, 0(r3)
/* 8094F9E4  A8 9C 04 DC */	lha r4, 0x4dc(r28)
/* 8094F9E8  4B 6B C9 B5 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 8094FA48  4B 9F 76 F1 */	bl PSVECSquareMag
...
/* 8094FAB8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8094FABC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8094FB28  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8094FB2C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8094FB44  4B 91 6F F1 */	bl __mi__4cXyzCFRC3Vec
...
/* 8094FB64  4B 9F 75 D5 */	bl PSVECSquareMag
...
/* 8094FBD4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8094FBD8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8094FC44  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8094FC48  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8094FC4C:
...
/* 8094FC80  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8094FC84  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8094FCA4  4B 91 FD DD */	bl cLib_addCalc0__FPfff
lbl_8094FCA8:
...
/* 8094FCC0  4B 91 FD C1 */	bl cLib_addCalc0__FPfff
...
lbl_8094FD3C:
/* 8094FD3C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8094FD40  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8094FD44  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8094FD48  3C 80 80 95 */	lis r4, d_a_ni__stringBase0@ha /* 0x8095131C@ha */
/* 8094FD4C  38 84 13 1C */	addi r4, r4, d_a_ni__stringBase0@l /* 0x8095131C@l */
/* 8094FD50  38 84 00 03 */	addi r4, r4, 3
/* 8094FD54  4B A1 8C 41 */	bl strcmp
...
/* 8094FDA4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8094FDA8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8094FDAC  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8094FDB0  4B 72 6C FD */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 8094FDD8  4B 91 7B 7D */	bl cM_rndF__Ff
...
/* 8094FDEC  4B 91 7B A1 */	bl cM_rndFX__Ff
...
/* 8094FE04  4B 91 7B 51 */	bl cM_rndF__Ff
...
/* 8094FE18  4B 91 7B 75 */	bl cM_rndFX__Ff
...
/* 8094FE30  4B 91 7B 25 */	bl cM_rndF__Ff
...
/* 8094FE44  4B 91 7B 49 */	bl cM_rndFX__Ff
...
/* 8094FE5C  4B 91 7A F9 */	bl cM_rndF__Ff
...
/* 8094FE70  4B 91 7B 1D */	bl cM_rndFX__Ff
...
/* 8094FE88  4B 91 7A CD */	bl cM_rndF__Ff
...
/* 8094FE9C  4B 91 7A F1 */	bl cM_rndFX__Ff
...
/* 8094FEC0  4B 92 07 49 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8094FED4  4B 92 07 35 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8094FEE8  4B 92 07 21 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8094FEFC  4B 92 07 0D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8094FF10  4B 92 06 F9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8094FF48  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8094FF4C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8094FFD0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8094FFD4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
lbl_80950050:
/* 80950050  4B 6C D0 BD */	bl fopAcM_effHamonSet__FPUlPC4cXyzff
...
/* 80950064  4B 6C D1 91 */	bl fopAcM_riverStream__FP4cXyzPsPff
...
/* 809500BC  4B 72 7C A9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 809500C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809500C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 809500C8  3A C3 0F 38 */	addi r22, r3, 0xf38
/* 809500CC  7E C3 B3 78 */	mr r3, r22
/* 809500D0  38 81 00 80 */	addi r4, r1, 0x80
/* 809500D4  4B 72 42 E1 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 809500F8  4B 91 7C 31 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 809500FC  7E C3 B3 78 */	mr r3, r22
/* 80950100  38 81 00 F0 */	addi r4, r1, 0xf0
/* 80950104  4B 72 43 9D */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80950134  4B 91 F9 09 */	bl cLib_addCalc2__FPffff
...
/* 809501B0  3C 80 80 95 */	lis r4, __dt__4cXyzFv@ha /* 0x8094C204@ha */
/* 809501B4  38 84 C2 04 */	addi r4, r4, __dt__4cXyzFv@l /* 0x8094C204@l */
...
/* 809501D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809501D8  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8095022C  4B 6F D2 A1 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
