...
/* 8094E390  4B A1 3E 49 */	bl _savegpr_28
/* 8094E394  3C 80 80 95 */	lis r4, lit_3958@ha /* 0x809511C0@ha */
/* 8094E398  3B E4 11 C0 */	addi r31, r4, lit_3958@l /* 0x809511C0@l */
/* 8094E39C  7C 7D 1B 78 */	mr r29, r3
/* 8094E3A0  38 61 00 2C */	addi r3, r1, 0x2c
/* 8094E3A4  4B 72 98 C5 */	bl __ct__11dBgS_LinChkFv
...
/* 8094E3F8  4B 91 92 7D */	bl cM_atan2s__Fff
/* 8094E3FC  7C 64 1B 78 */	mr r4, r3
/* 8094E400  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8094E404  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8094E408  80 63 00 00 */	lwz r3, 0(r3)
/* 8094E40C  4B 6B DF D1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8094E42C  4B 92 2A C1 */	bl MtxPosition__FP4cXyzP4cXyz
/* 8094E430  38 61 00 08 */	addi r3, r1, 8
/* 8094E434  38 81 00 14 */	addi r4, r1, 0x14
/* 8094E438  7C 65 1B 78 */	mr r5, r3
/* 8094E43C  4B 9F 8C 55 */	bl PSVECAdd
/* 8094E440  3B 80 00 00 */	li r28, 0
/* 8094E444  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8094E448  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8094E464  4B 72 99 01 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8094E468  7F C3 F3 78 */	mr r3, r30
/* 8094E46C  38 81 00 2C */	addi r4, r1, 0x2c
/* 8094E470  4B 72 5F 45 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8094E49C  4B 72 98 41 */	bl __dt__11dBgS_LinChkFv
...
/* 8094E4D4  4B 72 98 09 */	bl __dt__11dBgS_LinChkFv
...
/* 8094E4E8  4B A1 3D 3D */	bl _restgpr_28
