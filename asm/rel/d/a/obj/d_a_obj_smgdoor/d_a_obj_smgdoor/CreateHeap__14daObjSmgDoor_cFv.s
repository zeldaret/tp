...
/* 80CDBE2C  4B 68 63 A9 */	bl _savegpr_27
/* 80CDBE30  7C 7B 1B 78 */	mr r27, r3
/* 80CDBE34  88 03 05 E8 */	lbz r0, 0x5e8(r3)
/* 80CDBE38  54 00 10 3A */	slwi r0, r0, 2
/* 80CDBE3C  3C 60 80 CE */	lis r3, l_arcName@ha /* 0x80CDCCE4@ha */
/* 80CDBE40  38 63 CC E4 */	addi r3, r3, l_arcName@l /* 0x80CDCCE4@l */
/* 80CDBE44  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CDBE48  3C 80 80 CE */	lis r4, l_bmd@ha /* 0x80CDCCEC@ha */
/* 80CDBE4C  38 84 CC EC */	addi r4, r4, l_bmd@l /* 0x80CDCCEC@l */
/* 80CDBE50  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CDBE54  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDBE58  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CDBE5C  3C A5 00 02 */	addis r5, r5, 2
/* 80CDBE60  38 C0 00 80 */	li r6, 0x80
/* 80CDBE64  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80CDBE68  4B 36 05 15 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80CDBE88  4B 33 8D CD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CDBEC0  4B 68 63 61 */	bl _restgpr_27
