...
/* 80CDC268  4B 58 BF 6D */	bl ChkUsed__9cBgW_BgIdCFv
/* 80CDC26C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CDC270  41 82 00 18 */	beq lbl_80CDC288
/* 80CDC274  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDC278  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CDC27C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CDC280  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80CDC284  4B 39 7F CD */	bl Release__4cBgSFP9dBgW_Base
lbl_80CDC288:
...
/* 80CDC29C  4B 35 0D D1 */	bl dComIfGp_getReverb__Fi
...
/* 80CDC2B0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CDC2B4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CDC2C8  3D 00 80 CE */	lis r8, lit_3825@ha /* 0x80CDCC04@ha */
/* 80CDC2CC  C0 28 CC 04 */	lfs f1, lit_3825@l(r8)  /* 0x80CDCC04@l */
/* 80CDC2D0  FC 40 08 90 */	fmr f2, f1
/* 80CDC2D4  3D 00 80 CE */	lis r8, lit_3826@ha /* 0x80CDCC08@ha */
/* 80CDC2D8  C0 68 CC 08 */	lfs f3, lit_3826@l(r8)  /* 0x80CDCC08@l */
/* 80CDC2DC  FC 80 18 90 */	fmr f4, f3
/* 80CDC2E0  39 00 00 00 */	li r8, 0
/* 80CDC2E4  4B 5C F6 A1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80CDC2FC  4B 35 0D 71 */	bl dComIfGp_getReverb__Fi
...
/* 80CDC310  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CDC314  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CDC328  3D 00 80 CE */	lis r8, lit_3825@ha /* 0x80CDCC04@ha */
/* 80CDC32C  C0 28 CC 04 */	lfs f1, lit_3825@l(r8)  /* 0x80CDCC04@l */
/* 80CDC330  FC 40 08 90 */	fmr f2, f1
/* 80CDC334  3D 00 80 CE */	lis r8, lit_3826@ha /* 0x80CDCC08@ha */
/* 80CDC338  C0 68 CC 08 */	lfs f3, lit_3826@l(r8)  /* 0x80CDCC08@l */
/* 80CDC33C  FC 80 18 90 */	fmr f4, f3
/* 80CDC340  39 00 00 00 */	li r8, 0
/* 80CDC344  4B 5C F6 41 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80CDC348:
