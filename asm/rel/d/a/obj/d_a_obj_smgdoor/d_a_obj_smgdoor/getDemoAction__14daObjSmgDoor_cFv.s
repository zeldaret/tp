...
/* 80CDC000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDC004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CDC008  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80CDC00C  80 84 05 B4 */	lwz r4, 0x5b4(r4)
/* 80CDC010  3C A0 80 CE */	lis r5, action_table@ha /* 0x80CDCD1C@ha */
/* 80CDC014  38 A5 CD 1C */	addi r5, r5, action_table@l /* 0x80CDCD1C@l */
/* 80CDC018  38 C0 00 06 */	li r6, 6
/* 80CDC01C  38 E0 00 00 */	li r7, 0
/* 80CDC020  39 00 00 00 */	li r8, 0
/* 80CDC024  4B 36 BD ED */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
