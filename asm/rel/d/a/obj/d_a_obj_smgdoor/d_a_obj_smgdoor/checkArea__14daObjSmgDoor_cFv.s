...
/* 80CDC810  4B 68 59 CD */	bl _savegpr_29
/* 80CDC814  7C 7D 1B 78 */	mr r29, r3
/* 80CDC818  3C 60 80 CE */	lis r3, lit_3705@ha /* 0x80CDCBF4@ha */
/* 80CDC81C  3B E3 CB F4 */	addi r31, r3, lit_3705@l /* 0x80CDCBF4@l */
/* 80CDC820  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDC824  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CDC858  4B 58 A2 DD */	bl __mi__4cXyzCFRC3Vec
...
/* 80CDC888  4B 66 A8 B1 */	bl PSVECSquareMag
/* 80CDC88C  FF E0 08 90 */	fmr f31, f1
/* 80CDC890  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CDC894  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80CDC8D8  4B 58 A6 1D */	bl normalize__4cXyzFv
...
/* 80CDC960  4B 68 58 C9 */	bl _restgpr_29
