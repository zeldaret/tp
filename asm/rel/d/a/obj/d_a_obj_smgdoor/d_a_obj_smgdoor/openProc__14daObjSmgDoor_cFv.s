...
/* 80CDC430  4B 35 0C 3D */	bl dComIfGp_getReverb__Fi
...
/* 80CDC444  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CDC448  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CDC45C  3D 00 80 CE */	lis r8, lit_3825@ha /* 0x80CDCC04@ha */
/* 80CDC460  C0 28 CC 04 */	lfs f1, lit_3825@l(r8)  /* 0x80CDCC04@l */
/* 80CDC464  FC 40 08 90 */	fmr f2, f1
/* 80CDC468  3D 00 80 CE */	lis r8, lit_3826@ha /* 0x80CDCC08@ha */
/* 80CDC46C  C0 68 CC 08 */	lfs f3, lit_3826@l(r8)  /* 0x80CDCC08@l */
/* 80CDC470  FC 80 18 90 */	fmr f4, f3
/* 80CDC474  39 00 00 00 */	li r8, 0
/* 80CDC478  4B 5C F5 0D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CDC47C  38 60 00 03 */	li r3, 3
/* 80CDC480  4B 4C C3 65 */	bl dKy_change_colpat__FUc
lbl_80CDC484:
