...
/* 80CB4B30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB4B34  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB4B38  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CB4B3C  4B 3B F7 15 */	bl Release__4cBgSFP9dBgW_Base
lbl_80CB4B40:
/* 80CB4B40  80 9F 05 B4 */	lwz r4, 0x5b4(r31)
/* 80CB4B44  28 04 00 00 */	cmplwi r4, 0
/* 80CB4B48  41 82 00 20 */	beq lbl_80CB4B68
/* 80CB4B4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB4B50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB4B54  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CB4B58  7F E5 FB 78 */	mr r5, r31
/* 80CB4B5C  4B 3B FE AD */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80CB4B60  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 80CB4B64  4B 3C 6E 5D */	bl Move__4dBgWFv
lbl_80CB4B68:
...
/* 80CB4B80  4B 36 59 F9 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80CB4B84  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80CB4B88  7C 03 07 74 */	extsb r3, r0
/* 80CB4B8C  4B 37 84 E1 */	bl dComIfGp_getReverb__Fi
...
/* 80CB4BA0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CB4BA4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CB4BB8  3D 00 80 CB */	lis r8, lit_3724@ha /* 0x80CB4FC8@ha */
/* 80CB4BBC  C0 28 4F C8 */	lfs f1, lit_3724@l(r8)  /* 0x80CB4FC8@l */
/* 80CB4BC0  FC 40 08 90 */	fmr f2, f1
/* 80CB4BC4  3D 00 80 CB */	lis r8, lit_3926@ha /* 0x80CB4FD8@ha */
/* 80CB4BC8  C0 68 4F D8 */	lfs f3, lit_3926@l(r8)  /* 0x80CB4FD8@l */
/* 80CB4BCC  FC 80 18 90 */	fmr f4, f3
/* 80CB4BD0  39 00 00 00 */	li r8, 0
/* 80CB4BD4  4B 5F 6D B1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
