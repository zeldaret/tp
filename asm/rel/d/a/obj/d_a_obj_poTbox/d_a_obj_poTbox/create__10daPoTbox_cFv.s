...
/* 80CB46D4  4B 6A DB 09 */	bl _savegpr_29
...
/* 80CB46F4  4B 3C 3F 31 */	bl __ct__16dBgS_MoveBgActorFv
/* 80CB46F8  3C 60 80 CB */	lis r3, __vt__10daPoTbox_c@ha /* 0x80CB50E0@ha */
/* 80CB46FC  38 03 50 E0 */	addi r0, r3, __vt__10daPoTbox_c@l /* 0x80CB50E0@l */
/* 80CB4700  90 1F 05 9C */	stw r0, 0x59c(r31)
/* 80CB4704  3B BF 05 B8 */	addi r29, r31, 0x5b8
/* 80CB4708  3C 60 80 CB */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80CB50D4@ha */
/* 80CB470C  38 03 50 D4 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80CB50D4@l */
/* 80CB4710  90 1F 05 B8 */	stw r0, 0x5b8(r31)
/* 80CB4714  7F A3 EB 78 */	mr r3, r29
/* 80CB4718  38 80 00 00 */	li r4, 0
/* 80CB471C  4B 67 3C E1 */	bl init__12J3DFrameCtrlFs
/* 80CB4720  38 00 00 00 */	li r0, 0
/* 80CB4724  90 1D 00 18 */	stw r0, 0x18(r29)
/* 80CB4728  3B BF 05 D4 */	addi r29, r31, 0x5d4
/* 80CB472C  3C 60 80 CB */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80CB50D4@ha */
/* 80CB4730  38 03 50 D4 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80CB50D4@l */
/* 80CB4734  90 1F 05 D4 */	stw r0, 0x5d4(r31)
/* 80CB4738  7F A3 EB 78 */	mr r3, r29
/* 80CB473C  38 80 00 00 */	li r4, 0
/* 80CB4740  4B 67 3C BD */	bl init__12J3DFrameCtrlFs
/* 80CB4744  38 00 00 00 */	li r0, 0
/* 80CB4748  90 1D 00 14 */	stw r0, 0x14(r29)
/* 80CB474C  3B BF 05 EC */	addi r29, r31, 0x5ec
/* 80CB4750  3C 60 80 CB */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80CB50D4@ha */
/* 80CB4754  38 03 50 D4 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80CB50D4@l */
/* 80CB4758  90 1F 05 EC */	stw r0, 0x5ec(r31)
/* 80CB475C  7F A3 EB 78 */	mr r3, r29
/* 80CB4760  38 80 00 00 */	li r4, 0
/* 80CB4764  4B 67 3C 99 */	bl init__12J3DFrameCtrlFs
...
/* 80CB4794  3C 80 80 CB */	lis r4, l_type@ha /* 0x80CB500C@ha */
/* 80CB4798  38 84 50 0C */	addi r4, r4, l_type@l /* 0x80CB500C@l */
/* 80CB479C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CB47A0  4B 37 87 1D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CB47BC  3C 80 80 CB */	lis r4, l_type@ha /* 0x80CB500C@ha */
/* 80CB47C0  38 84 50 0C */	addi r4, r4, l_type@l /* 0x80CB500C@l */
/* 80CB47C4  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CB47C8  3C A0 80 CB */	lis r5, l_dzbIdx@ha /* 0x80CB501C@ha */
/* 80CB47CC  38 A5 50 1C */	addi r5, r5, l_dzbIdx@l /* 0x80CB501C@l */
/* 80CB47D0  7C A5 00 2E */	lwzx r5, r5, r0
/* 80CB47D4  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075A24@ha */
/* 80CB47D8  38 C6 5A 24 */	addi r6, r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075A24@l */
/* 80CB47DC  38 E0 6E A0 */	li r7, 0x6ea0
/* 80CB47E0  39 00 00 00 */	li r8, 0
/* 80CB47E4  4B 3C 3F D9 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80CB4810  4B 36 5D 69 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80CB4830  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB4834  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB4838  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80CB483C  7C 05 07 74 */	extsb r5, r0
/* 80CB4840  4B 38 0B 21 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CB486C  4B 36 5D 0D */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80CB4870  38 00 00 01 */	li r0, 1
/* 80CB4874  98 1E 06 05 */	stb r0, 0x605(r30)
/* 80CB4878  A8 1E 05 C0 */	lha r0, 0x5c0(r30)
/* 80CB487C  3C 60 80 CB */	lis r3, lit_3835@ha /* 0x80CB4FD0@ha */
/* 80CB4880  C8 43 4F D0 */	lfd f2, lit_3835@l(r3)  /* 0x80CB4FD0@l */
...
/* 80CB489C  3C 60 80 CB */	lis r3, lit_3724@ha /* 0x80CB4FC8@ha */
/* 80CB48A0  C0 23 4F C8 */	lfs f1, lit_3724@l(r3)  /* 0x80CB4FC8@l */
...
/* 80CB48D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB48DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB48E0  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CB48E4  4B 3B F9 6D */	bl Release__4cBgSFP9dBgW_Base
lbl_80CB48E8:
/* 80CB48E8  80 9E 05 B4 */	lwz r4, 0x5b4(r30)
/* 80CB48EC  28 04 00 00 */	cmplwi r4, 0
/* 80CB48F0  41 82 00 20 */	beq lbl_80CB4910
/* 80CB48F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB48F8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB48FC  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CB4900  7F C5 F3 78 */	mr r5, r30
/* 80CB4904  4B 3C 01 05 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80CB4908  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 80CB490C  4B 3C 70 B5 */	bl Move__4dBgWFv
lbl_80CB4910:
...
/* 80CB4940  4B 6A D8 E9 */	bl _restgpr_29
