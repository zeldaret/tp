...
/* 80CB42DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB42E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB42E4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80CB42E8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80CB42EC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80CB42F0  4B 69 25 F8 */	b PSMTXTrans
/* 80CB42F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB42F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB42FC  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80CB4300  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80CB4304  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80CB4308  4B 35 7F 98 */	b mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80CB4328  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB432C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB4330  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80CB4334  38 84 00 24 */	addi r4, r4, 0x24
/* 80CB4338  4B 69 21 78 */	b PSMTXCopy
...
/* 80CB4360  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB4364  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB4368  80 9F 05 AC */	lwz r4, 0x5ac(r31)
/* 80CB436C  38 84 00 24 */	addi r4, r4, 0x24
/* 80CB4370  4B 69 21 40 */	b PSMTXCopy
lbl_80CB4374:
...
/* 80CB4398  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB439C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB43A0  80 9F 05 B0 */	lwz r4, 0x5b0(r31)
/* 80CB43A4  38 84 00 24 */	addi r4, r4, 0x24
/* 80CB43A8  4B 69 21 08 */	b PSMTXCopy
lbl_80CB43AC:
/* 80CB43AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB43B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB43B4  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80CB43B8  4B 69 20 F8 */	b PSMTXCopy
