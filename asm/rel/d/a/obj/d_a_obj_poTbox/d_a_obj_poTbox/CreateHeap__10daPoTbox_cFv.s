...
/* 80CB43E0  4B 6A DD FD */	bl _savegpr_29
/* 80CB43E4  7C 7D 1B 78 */	mr r29, r3
/* 80CB43E8  88 03 06 06 */	lbz r0, 0x606(r3)
/* 80CB43EC  54 00 10 3A */	slwi r0, r0, 2
/* 80CB43F0  3C 60 80 CB */	lis r3, l_type@ha /* 0x80CB500C@ha */
/* 80CB43F4  38 63 50 0C */	addi r3, r3, l_type@l /* 0x80CB500C@l */
/* 80CB43F8  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CB43FC  3C 80 80 CB */	lis r4, l_bmdIdx@ha /* 0x80CB5014@ha */
/* 80CB4400  38 84 50 14 */	addi r4, r4, l_bmdIdx@l /* 0x80CB5014@l */
/* 80CB4404  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CB4408  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB440C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CB4420  4B 38 7E CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CB4430  4B 36 08 25 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CB445C  3C 60 80 CB */	lis r3, l_type@ha /* 0x80CB500C@ha */
/* 80CB4460  38 63 50 0C */	addi r3, r3, l_type@l /* 0x80CB500C@l */
...
/* 80CB4474  4B 38 7E 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CB4484  4B 36 07 D1 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CB44A8  3C 60 80 CB */	lis r3, l_type@ha /* 0x80CB500C@ha */
/* 80CB44AC  38 63 50 0C */	addi r3, r3, l_type@l /* 0x80CB500C@l */
...
/* 80CB44C0  4B 38 7E 2D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CB44D4  3C E0 80 CB */	lis r7, lit_3724@ha /* 0x80CB4FC8@ha */
/* 80CB44D8  C0 27 4F C8 */	lfs f1, lit_3724@l(r7)  /* 0x80CB4FC8@l */
/* 80CB44DC  38 E0 00 00 */	li r7, 0
/* 80CB44E0  39 00 FF FF */	li r8, -1
/* 80CB44E4  39 20 00 00 */	li r9, 0
/* 80CB44E8  4B 35 92 F5 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
/* 80CB44EC  88 1D 06 06 */	lbz r0, 0x606(r29)
/* 80CB44F0  54 00 10 3A */	slwi r0, r0, 2
/* 80CB44F4  3C 60 80 CB */	lis r3, l_type@ha /* 0x80CB500C@ha */
/* 80CB44F8  38 63 50 0C */	addi r3, r3, l_type@l /* 0x80CB500C@l */
...
/* 80CB450C  4B 38 7D E1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CB4520  4B 36 07 35 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CB4544  3C 60 80 CB */	lis r3, l_type@ha /* 0x80CB500C@ha */
/* 80CB4548  38 63 50 0C */	addi r3, r3, l_type@l /* 0x80CB500C@l */
...
/* 80CB455C  4B 38 7D 91 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CB4574  3D 00 80 CB */	lis r8, lit_3724@ha /* 0x80CB4FC8@ha */
/* 80CB4578  C0 28 4F C8 */	lfs f1, lit_3724@l(r8)  /* 0x80CB4FC8@l */
/* 80CB457C  39 00 00 00 */	li r8, 0
/* 80CB4580  39 20 FF FF */	li r9, -1
/* 80CB4584  4B 35 90 B9 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80CB4588  88 1D 06 06 */	lbz r0, 0x606(r29)
/* 80CB458C  54 00 10 3A */	slwi r0, r0, 2
/* 80CB4590  3C 60 80 CB */	lis r3, l_type@ha /* 0x80CB500C@ha */
/* 80CB4594  38 63 50 0C */	addi r3, r3, l_type@l /* 0x80CB500C@l */
...
/* 80CB45A8  4B 38 7D 45 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CB45C0  3D 00 80 CB */	lis r8, lit_3724@ha /* 0x80CB4FC8@ha */
/* 80CB45C4  C0 28 4F C8 */	lfs f1, lit_3724@l(r8)  /* 0x80CB4FC8@l */
/* 80CB45C8  39 00 00 00 */	li r8, 0
/* 80CB45CC  39 20 FF FF */	li r9, -1
/* 80CB45D0  4B 35 91 3D */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80CB45D4  38 60 00 C0 */	li r3, 0xc0
/* 80CB45D8  4B 61 A6 75 */	bl __nw__FUl
/* 80CB45DC  7C 60 1B 79 */	or. r0, r3, r3
/* 80CB45E0  41 82 00 0C */	beq lbl_80CB45EC
/* 80CB45E4  4B 3C 73 8D */	bl __ct__4dBgWFv
...
/* 80CB4604  3C 60 80 CB */	lis r3, l_type@ha /* 0x80CB500C@ha */
/* 80CB4608  38 63 50 0C */	addi r3, r3, l_type@l /* 0x80CB500C@l */
...
/* 80CB461C  4B 38 7C D1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CB4630  4B 3C 59 09 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80CB4664  3C 60 80 CB */	lis r3, l_type@ha /* 0x80CB500C@ha */
/* 80CB4668  38 63 50 0C */	addi r3, r3, l_type@l /* 0x80CB500C@l */
...
/* 80CB467C  4B 38 7C 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CB4690  3C E0 80 CB */	lis r7, lit_3724@ha /* 0x80CB4FC8@ha */
/* 80CB4694  C0 27 4F C8 */	lfs f1, lit_3724@l(r7)  /* 0x80CB4FC8@l */
/* 80CB4698  38 E0 00 00 */	li r7, 0
/* 80CB469C  39 00 FF FF */	li r8, -1
/* 80CB46A0  39 20 00 00 */	li r9, 0
/* 80CB46A4  4B 35 91 39 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
lbl_80CB46A8:
/* 80CB46A8  38 60 00 01 */	li r3, 1
lbl_80CB46AC:
/* 80CB46AC  39 61 00 20 */	addi r11, r1, 0x20
/* 80CB46B0  4B 6A DB 79 */	bl _restgpr_29
