...
/* 80CB9570  3C 80 80 CC */	lis r4, lit_3649@ha /* 0x80CB9A84@ha */
/* 80CB9574  3B E4 9A 84 */	addi r31, r4, lit_3649@l /* 0x80CB9A84@l */
...
/* 80CB9590  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB9594  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB9598  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80CB959C  3C 80 80 CC */	lis r4, l_HIO@ha /* 0x80CB9BF4@ha */
/* 80CB95A0  38 84 9B F4 */	addi r4, r4, l_HIO@l /* 0x80CB9BF4@l */
/* 80CB95A4  88 84 00 15 */	lbz r4, 0x15(r4)
/* 80CB95A8  38 A0 00 0F */	li r5, 0xf
/* 80CB95AC  38 C1 00 18 */	addi r6, r1, 0x18
/* 80CB95B0  4B 3B 64 75 */	bl StartShock__12dVibration_cFii4cXyz
/* 80CB95B4  3C 60 80 CC */	lis r3, l_HIO@ha /* 0x80CB9BF4@ha */
/* 80CB95B8  38 63 9B F4 */	addi r3, r3, l_HIO@l /* 0x80CB9BF4@l */
...
/* 80CB95D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CB95D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CB95D8  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80CB95DC  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80CB95E0  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80CB95E4  4B 35 2C 25 */	bl mDoMtx_ZXYrotS__FPA4_fsss
/* 80CB95E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CB95EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CB95F0  38 81 00 30 */	addi r4, r1, 0x30
/* 80CB95F4  7C 85 23 78 */	mr r5, r4
/* 80CB95F8  4B 68 D7 75 */	bl PSMTXMultVec
/* 80CB95FC  38 61 00 0C */	addi r3, r1, 0xc
/* 80CB9600  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80CB9604  38 A1 00 30 */	addi r5, r1, 0x30
/* 80CB9608  4B 5A D4 DD */	bl __pl__4cXyzCFRC3Vec
...
/* 80CB962C  4B 37 3A 41 */	bl dComIfGp_getReverb__Fi
...
/* 80CB9640  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CB9644  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CB966C  4B 5F 23 19 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CB9670  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB9674  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CB9688  4B 37 BB 79 */	bl onSwitch__10dSv_info_cFii
