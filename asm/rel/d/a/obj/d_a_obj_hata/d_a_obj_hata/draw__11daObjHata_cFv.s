...
/* 80C18FD4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C18FD8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C18FDC  38 80 00 10 */	li r4, 0x10
/* 80C18FE0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C18FE4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C18FE8  4B 58 A7 DD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C18FEC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C18FF0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C18FF4  80 9E 05 88 */	lwz r4, 0x588(r30)
/* 80C18FF8  80 84 00 04 */	lwz r4, 4(r4)
/* 80C18FFC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C19000  4B 58 BD A1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C19004  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C19008  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1900C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C19010  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C19014  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C19028  4B 3F 4C 9D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C1902C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C19030  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
