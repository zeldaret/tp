...
/* 80BAD24C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BAD250  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BAD254  38 80 00 10 */	li r4, 0x10
/* 80BAD258  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BAD25C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BAD260  4B 5F 65 65 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BAD264  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BAD268  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BAD26C  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80BAD270  80 84 00 04 */	lwz r4, 4(r4)
/* 80BAD274  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BAD278  4B 5F 7B 29 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BAD27C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BAD280  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BAD284  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80BAD288  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BAD28C  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BAD2A0  4B 46 0A 25 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80BAD2A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BAD2A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
