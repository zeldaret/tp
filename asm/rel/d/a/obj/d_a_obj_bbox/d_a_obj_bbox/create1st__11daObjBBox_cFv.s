...
/* 80BACEF0  4B 4C B7 35 */	bl __ct__16dBgS_MoveBgActorFv
/* 80BACEF4  3C 60 80 BB */	lis r3, __vt__11daObjBBox_c@ha /* 0x80BAD540@ha */
/* 80BACEF8  38 03 D5 40 */	addi r0, r3, __vt__11daObjBBox_c@l /* 0x80BAD540@l */
/* 80BACEFC  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80BACF00  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BACF04  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BACF08  90 1E 05 C4 */	stw r0, 0x5c4(r30)
/* 80BACF0C  38 7E 05 C8 */	addi r3, r30, 0x5c8
/* 80BACF10  4B 4D 68 51 */	bl __ct__10dCcD_GSttsFv
/* 80BACF14  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BACF18  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BACF30  4B 4D 6A F9 */	bl __ct__12dCcD_GObjInfFv
/* 80BACF34  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BACF38  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BACF3C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80BACF40  3C 60 80 BB */	lis r3, __vt__8cM3dGAab@ha /* 0x80BAD534@ha */
/* 80BACF44  38 03 D5 34 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BAD534@l */
/* 80BACF48  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80BACF4C  3C 60 80 BB */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BAD528@ha */
/* 80BACF50  38 03 D5 28 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BAD528@l */
/* 80BACF54  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80BACF58  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BACF5C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80BACF60  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80BACF64  38 03 00 58 */	addi r0, r3, 0x58
/* 80BACF68  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80BACF6C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BACF70  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
lbl_80BACF94:
/* 80BACF94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BACF98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BACFAC  4B 48 83 B5 */	bl isSwitch__10dSv_info_cCFii
...
/* 80BACFC4  3C 80 80 BB */	lis r4, l_arcName@ha /* 0x80BAD4D4@ha */
/* 80BACFC8  38 84 D4 D4 */	addi r4, r4, l_arcName@l /* 0x80BAD4D4@l */
/* 80BACFCC  80 84 00 00 */	lwz r4, 0(r4)
/* 80BACFD0  4B 47 FE ED */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BACFE4  3C 80 80 BB */	lis r4, l_arcName@ha /* 0x80BAD4D4@ha */
/* 80BACFE8  38 84 D4 D4 */	addi r4, r4, l_arcName@l /* 0x80BAD4D4@l */
...
/* 80BAD000  4B 4C B7 BD */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
