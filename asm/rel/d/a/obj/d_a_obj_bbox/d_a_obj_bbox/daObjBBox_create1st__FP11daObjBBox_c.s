...
/* 80BAD33C  4B 4C B2 E9 */	bl __ct__16dBgS_MoveBgActorFv
/* 80BAD340  3C 60 80 BB */	lis r3, __vt__11daObjBBox_c@ha /* 0x80BAD540@ha */
/* 80BAD344  38 03 D5 40 */	addi r0, r3, __vt__11daObjBBox_c@l /* 0x80BAD540@l */
/* 80BAD348  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80BAD34C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BAD350  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BAD354  90 1E 05 C4 */	stw r0, 0x5c4(r30)
/* 80BAD358  38 7E 05 C8 */	addi r3, r30, 0x5c8
/* 80BAD35C  4B 4D 64 05 */	bl __ct__10dCcD_GSttsFv
/* 80BAD360  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BAD364  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BAD37C  4B 4D 66 AD */	bl __ct__12dCcD_GObjInfFv
/* 80BAD380  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BAD384  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BAD388  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80BAD38C  3C 60 80 BB */	lis r3, __vt__8cM3dGAab@ha /* 0x80BAD534@ha */
/* 80BAD390  38 03 D5 34 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BAD534@l */
/* 80BAD394  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80BAD398  3C 60 80 BB */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BAD528@ha */
/* 80BAD39C  38 03 D5 28 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BAD528@l */
/* 80BAD3A0  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80BAD3A4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BAD3A8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80BAD3AC  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80BAD3B0  38 03 00 58 */	addi r0, r3, 0x58
/* 80BAD3B4  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80BAD3B8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BAD3BC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
