...
/* 80CA3C2C  3C 80 80 CA */	lis r4, __vt__13daObj_Nougu_c@ha
/* 80CA3C30  38 04 4A F4 */	addi r0, r4, __vt__13daObj_Nougu_c@l
...
/* 80CA3C44  4B 38 93 C4 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80CA3C48  38 7E 08 08 */	addi r3, r30, 0x808
/* 80CA3C4C  3C 80 80 CA */	lis r4, __dt__8dCcD_SphFv@ha
/* 80CA3C50  38 84 3D 58 */	addi r4, r4, __dt__8dCcD_SphFv@l
/* 80CA3C54  38 A0 01 38 */	li r5, 0x138
/* 80CA3C58  38 C0 00 05 */	li r6, 5
/* 80CA3C5C  4B 6B E0 8C */	b __destroy_arr
/* 80CA3C60  38 7E 07 CC */	addi r3, r30, 0x7cc
/* 80CA3C64  38 80 FF FF */	li r4, -1
/* 80CA3C68  4B 5C 40 2C */	b __dt__11cBgS_GndChkFv
/* 80CA3C6C  34 1E 07 8C */	addic. r0, r30, 0x78c
/* 80CA3C70  41 82 00 28 */	beq lbl_80CA3C98
/* 80CA3C74  3C 60 80 CA */	lis r3, __vt__12dBgS_AcchCir@ha
/* 80CA3C78  38 03 4A E8 */	addi r0, r3, __vt__12dBgS_AcchCir@l
/* 80CA3C7C  90 1E 07 98 */	stw r0, 0x798(r30)
/* 80CA3C80  38 7E 07 A0 */	addi r3, r30, 0x7a0
/* 80CA3C84  38 80 FF FF */	li r4, -1
/* 80CA3C88  4B 5C B2 90 */	b __dt__8cM3dGCirFv
/* 80CA3C8C  38 7E 07 8C */	addi r3, r30, 0x78c
/* 80CA3C90  38 80 00 00 */	li r4, 0
/* 80CA3C94  4B 5C 44 1C */	b __dt__13cBgS_PolyInfoFv
lbl_80CA3C98:
/* 80CA3C98  34 1E 07 50 */	addic. r0, r30, 0x750
/* 80CA3C9C  41 82 00 54 */	beq lbl_80CA3CF0
/* 80CA3CA0  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80CA3CA4  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80CA3CBC  3C 60 80 CA */	lis r3, __vt__10dCcD_GStts@ha
/* 80CA3CC0  38 03 4A DC */	addi r0, r3, __vt__10dCcD_GStts@l
/* 80CA3CC4  90 1E 07 6C */	stw r0, 0x76c(r30)
/* 80CA3CC8  34 1E 07 6C */	addic. r0, r30, 0x76c
/* 80CA3CCC  41 82 00 10 */	beq lbl_80CA3CDC
/* 80CA3CD0  3C 60 80 CA */	lis r3, __vt__10cCcD_GStts@ha
/* 80CA3CD4  38 03 4A D0 */	addi r0, r3, __vt__10cCcD_GStts@l
/* 80CA3CD8  90 1E 07 6C */	stw r0, 0x76c(r30)
lbl_80CA3CDC:
/* 80CA3CDC  34 1E 07 50 */	addic. r0, r30, 0x750
/* 80CA3CE0  41 82 00 10 */	beq lbl_80CA3CF0
/* 80CA3CE4  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80CA3CE8  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80CA3CEC  90 1E 07 68 */	stw r0, 0x768(r30)
lbl_80CA3CF0:
/* 80CA3CF0  34 1E 05 78 */	addic. r0, r30, 0x578
/* 80CA3CF4  41 82 00 2C */	beq lbl_80CA3D20
/* 80CA3CF8  3C 60 80 CA */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80CA3CFC  38 63 4A AC */	addi r3, r3, __vt__12dBgS_ObjAcch@l
