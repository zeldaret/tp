...
/* 80CCD2A8  3C A0 80 CD */	lis r5, m__22daObj_SekiDoor_Param_c@ha /* 0x80CCDA08@ha */
/* 80CCD2AC  3B E5 DA 08 */	addi r31, r5, m__22daObj_SekiDoor_Param_c@l /* 0x80CCDA08@l */
...
/* 80CCD2D0  3C 80 80 CD */	lis r4, dComIfGp_event_runCheck__Fv@ha /* 0x80CCD51C@ha */
/* 80CCD2D4  34 04 D5 1C */	addic. r0, r4, dComIfGp_event_runCheck__Fv@l /* 0x80CCD51C@l */
/* 80CCD2D8  40 82 02 18 */	bne lbl_80CCD4F0
/* 80CCD2DC  4B 34 C9 A1 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80CCD2F0  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 80CCD2F4  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 80CCD338  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CCD33C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80CCD380  4B 5A 33 51 */	bl cLib_chaseS__FPsss
/* 80CCD384  2C 03 00 00 */	cmpwi r3, 0
/* 80CCD388  41 82 00 18 */	beq lbl_80CCD3A0
/* 80CCD38C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCD390  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CCD394  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80CCD398  38 80 00 0F */	li r4, 0xf
/* 80CCD39C  4B 3A 29 F9 */	bl StopQuake__12dVibration_cFi
lbl_80CCD3A0:
...
/* 80CCD3F0  4B 5A 33 51 */	bl cLib_chaseF__FPfff
...
/* 80CCD410  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CCD414  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CCD440  4B 5D F0 CD */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80CCD45C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CCD460  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CCD48C  4B 5D E4 F9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80CCD4A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCD4A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CCD4BC  4B 3A 25 69 */	bl StartShock__12dVibration_cFii4cXyz
