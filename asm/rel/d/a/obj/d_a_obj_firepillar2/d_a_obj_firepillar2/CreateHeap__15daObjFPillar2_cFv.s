...
/* 80BEA044  4B 77 81 91 */	bl _savegpr_27
/* 80BEA048  7C 7F 1B 78 */	mr r31, r3
/* 80BEA04C  3C 60 80 BF */	lis r3, l_arcName@ha /* 0x80BEB548@ha */
/* 80BEA050  38 63 B5 48 */	addi r3, r3, l_arcName@l /* 0x80BEB548@l */
/* 80BEA054  80 63 00 00 */	lwz r3, 0(r3)
/* 80BEA058  38 80 00 08 */	li r4, 8
/* 80BEA05C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BEA060  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BEA074  4B 45 22 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BEA088  4B 42 AB CD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80BEA0A4:
/* 80BEA0A4  3C 60 80 BF */	lis r3, l_arcName@ha /* 0x80BEB548@ha */
/* 80BEA0A8  38 63 B5 48 */	addi r3, r3, l_arcName@l /* 0x80BEB548@l */
...
/* 80BEA0BC  4B 45 22 31 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BEA0C0  7C 7B 1B 78 */	mr r27, r3
/* 80BEA0C4  38 60 00 18 */	li r3, 0x18
/* 80BEA0C8  4B 6E 4B 85 */	bl __nw__FUl
/* 80BEA0CC  7C 7E 1B 79 */	or. r30, r3, r3
/* 80BEA0D0  41 82 00 20 */	beq lbl_80BEA0F0
/* 80BEA0D4  3C 80 80 BF */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80BEB6D0@ha */
/* 80BEA0D8  38 04 B6 D0 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80BEB6D0@l */
/* 80BEA0DC  90 1E 00 00 */	stw r0, 0(r30)
/* 80BEA0E0  38 80 00 00 */	li r4, 0
/* 80BEA0E4  4B 73 E3 19 */	bl init__12J3DFrameCtrlFs
...
/* 80BEA110  3D 00 80 BF */	lis r8, lit_3656@ha /* 0x80BEB4C4@ha */
/* 80BEA114  C0 28 B4 C4 */	lfs f1, lit_3656@l(r8)  /* 0x80BEB4C4@l */
/* 80BEA118  39 00 00 00 */	li r8, 0
/* 80BEA11C  39 20 FF FF */	li r9, -1
/* 80BEA120  4B 42 35 1D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80BEA134:
/* 80BEA134  3C 60 80 BF */	lis r3, l_arcName@ha /* 0x80BEB548@ha */
/* 80BEA138  38 63 B5 48 */	addi r3, r3, l_arcName@l /* 0x80BEB548@l */
...
/* 80BEA14C  4B 45 21 A1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BEA150  7C 7B 1B 78 */	mr r27, r3
/* 80BEA154  38 60 00 1C */	li r3, 0x1c
/* 80BEA158  4B 6E 4A F5 */	bl __nw__FUl
/* 80BEA15C  7C 7E 1B 79 */	or. r30, r3, r3
/* 80BEA160  41 82 00 20 */	beq lbl_80BEA180
/* 80BEA164  3C 80 80 BF */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80BEB6D0@ha */
/* 80BEA168  38 04 B6 D0 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80BEB6D0@l */
/* 80BEA16C  90 1E 00 00 */	stw r0, 0(r30)
/* 80BEA170  38 80 00 00 */	li r4, 0
/* 80BEA174  4B 73 E2 89 */	bl init__12J3DFrameCtrlFs
...
/* 80BEA19C  3C E0 80 BF */	lis r7, lit_3656@ha /* 0x80BEB4C4@ha */
/* 80BEA1A0  C0 27 B4 C4 */	lfs f1, lit_3656@l(r7)  /* 0x80BEB4C4@l */
/* 80BEA1A4  38 E0 00 00 */	li r7, 0
/* 80BEA1A8  39 00 FF FF */	li r8, -1
/* 80BEA1AC  39 20 00 00 */	li r9, 0
/* 80BEA1B0  4B 42 36 2D */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80BEA1CC  4B 77 80 55 */	bl _restgpr_27
