...
/* 80BEA238  4B 77 7F A5 */	bl _savegpr_29
...
/* 80BEA258  4B 42 E9 0D */	bl __ct__10fopAc_ac_cFv
/* 80BEA25C  3B BE 05 7C */	addi r29, r30, 0x57c
/* 80BEA260  7F A3 EB 78 */	mr r3, r29
/* 80BEA264  4B 48 BE 3D */	bl __ct__9dBgS_AcchFv
/* 80BEA268  3C 60 80 BF */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80BEB6AC@ha */
/* 80BEA26C  38 63 B6 AC */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80BEB6AC@l */
...
/* 80BEA288  4B 48 EB E1 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80BEA28C  38 7E 07 54 */	addi r3, r30, 0x754
/* 80BEA290  4B 48 BC 1D */	bl __ct__12dBgS_AcchCirFv
/* 80BEA294  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BEA298  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BEA29C  90 1E 07 AC */	stw r0, 0x7ac(r30)
/* 80BEA2A0  38 7E 07 B0 */	addi r3, r30, 0x7b0
/* 80BEA2A4  4B 49 94 BD */	bl __ct__10dCcD_GSttsFv
/* 80BEA2A8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BEA2AC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BEA2C4  4B 49 97 65 */	bl __ct__12dCcD_GObjInfFv
/* 80BEA2C8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BEA2CC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BEA2D0  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80BEA2D4  3C 60 80 BF */	lis r3, __vt__8cM3dGAab@ha /* 0x80BEB6A0@ha */
/* 80BEA2D8  38 03 B6 A0 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BEB6A0@l */
/* 80BEA2DC  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80BEA2E0  38 7D 01 24 */	addi r3, r29, 0x124
/* 80BEA2E4  4B 68 4C A5 */	bl __ct__8cM3dGCpsFv
/* 80BEA2E8  3C 60 80 3C */	lis r3, __vt__12cCcD_CpsAttr@ha /* 0x803C3608@ha */
/* 80BEA2EC  38 63 36 08 */	addi r3, r3, __vt__12cCcD_CpsAttr@l /* 0x803C3608@l */
/* 80BEA2F0  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80BEA2F4  38 03 00 58 */	addi r0, r3, 0x58
/* 80BEA2F8  90 1D 01 3C */	stw r0, 0x13c(r29)
/* 80BEA2FC  3C 60 80 3B */	lis r3, __vt__8dCcD_Cps@ha /* 0x803AC170@ha */
/* 80BEA300  38 63 C1 70 */	addi r3, r3, __vt__8dCcD_Cps@l /* 0x803AC170@l */
...
/* 80BEA31C  4B 6D 45 29 */	bl __ct__16Z2SoundObjSimpleFv
lbl_80BEA320:
...
/* 80BEA384  3C 80 80 BF */	lis r4, l_arcName@ha /* 0x80BEB548@ha */
/* 80BEA388  38 84 B5 48 */	addi r4, r4, l_arcName@l /* 0x80BEB548@l */
/* 80BEA38C  80 84 00 00 */	lwz r4, 0(r4)
/* 80BEA390  4B 44 2B 2D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BEA3A4  3C 80 80 BF */	lis r4, CheckCreateHeap__FP10fopAc_ac_c@ha /* 0x80BE9CB8@ha */
/* 80BEA3A8  38 84 9C B8 */	addi r4, r4, CheckCreateHeap__FP10fopAc_ac_c@l /* 0x80BE9CB8@l */
/* 80BEA3AC  38 A0 12 80 */	li r5, 0x1280
/* 80BEA3B0  4B 43 01 01 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80BEA3EC  4B 77 7E 3D */	bl _restgpr_29
