...
/* 80C45480  4B 71 CD 45 */	bl _savegpr_23
/* 80C45484  7C 7A 1B 78 */	mr r26, r3
/* 80C45488  3C 60 80 C4 */	lis r3, lit_3769@ha /* 0x80C45F1C@ha */
/* 80C4548C  3B A3 5F 1C */	addi r29, r3, lit_3769@l /* 0x80C45F1C@l */
...
/* 80C454BC  4B 41 56 35 */	bl dKyw_get_wind_pow__Fv
...
/* 80C454DC  4B 62 A5 61 */	bl cLib_addCalc2__FPffff
...
/* 80C45510  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C45514  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C45550  4B 66 6F BD */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C45554  4B 41 55 8D */	bl dKyw_get_wind_vec__Fv
...
/* 80C4556C  4B 62 21 09 */	bl cM_atan2s__Fff
/* 80C45570  B0 7A 04 DE */	sth r3, 0x4de(r26)
lbl_80C45574:
/* 80C45574  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C45578  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80C4557C  80 63 00 00 */	lwz r3, 0(r3)
/* 80C45580  A8 9A 04 DE */	lha r4, 0x4de(r26)
/* 80C45584  4B 3C 6E 59 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80C455A0  4B 62 B9 4D */	bl MtxPosition__FP4cXyzP4cXyz
/* 80C455A4  C0 1D 00 28 */	lfs f0, 0x28(r29)
/* 80C455A8  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80C455AC  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 80C455B0  3C 60 80 C4 */	lis r3, l_HIO@ha /* 0x80C46000@ha */
/* 80C455B4  38 63 60 00 */	addi r3, r3, l_HIO@l /* 0x80C46000@l */
...
/* 80C455F8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C455FC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C4565C  4B 62 23 31 */	bl cM_rndFX__Ff
...
/* 80C4567C  4B 62 23 11 */	bl cM_rndFX__Ff
...
/* 80C456C0  3C 60 80 C4 */	lis r3, l_HIO@ha /* 0x80C46000@ha */
/* 80C456C4  3B C3 60 00 */	addi r30, r3, l_HIO@l /* 0x80C46000@l */
/* 80C456C8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C456CC  3B E3 9A 20 */	addi r31, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C456E0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C456E4  3B 03 07 68 */	addi r24, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80C457A0  4B 62 1E D5 */	bl cM_atan2s__Fff
...
/* 80C457C8  4B 62 1E AD */	bl cM_atan2s__Fff
...
/* 80C458C4  4B 71 C9 4D */	bl _restgpr_23
