...
/* 80BD4774  4B 78 DA 69 */	bl _savegpr_29
/* 80BD4778  7C 7E 1B 78 */	mr r30, r3
/* 80BD477C  3C 80 80 BD */	lis r4, ccCylSrc@ha /* 0x80BD4D04@ha */
/* 80BD4780  3B E4 4D 04 */	addi r31, r4, ccCylSrc@l /* 0x80BD4D04@l */
...
/* 80BD479C  4B 4A 3E 89 */	bl __ct__16dBgS_MoveBgActorFv
/* 80BD47A0  3C 60 80 BD */	lis r3, __vt__15daObjCRVLH_DW_c@ha /* 0x80BD4E30@ha */
/* 80BD47A4  38 03 4E 30 */	addi r0, r3, __vt__15daObjCRVLH_DW_c@l /* 0x80BD4E30@l */
/* 80BD47A8  90 1D 05 9C */	stw r0, 0x59c(r29)
/* 80BD47AC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BD47B0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BD47B4  90 1D 05 E8 */	stw r0, 0x5e8(r29)
/* 80BD47B8  38 7D 05 EC */	addi r3, r29, 0x5ec
/* 80BD47BC  4B 4A EF A5 */	bl __ct__10dCcD_GSttsFv
/* 80BD47C0  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BD47C4  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BD47DC  4B 4A F2 4D */	bl __ct__12dCcD_GObjInfFv
/* 80BD47E0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BD47E4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BD47E8  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80BD47EC  3C 60 80 BD */	lis r3, __vt__8cM3dGAab@ha /* 0x80BD4E24@ha */
/* 80BD47F0  38 03 4E 24 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BD4E24@l */
/* 80BD47F4  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80BD47F8  3C 60 80 BD */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BD4E18@ha */
/* 80BD47FC  38 03 4E 18 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BD4E18@l */
/* 80BD4800  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80BD4804  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BD4808  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80BD480C  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80BD4810  38 03 00 58 */	addi r0, r3, 0x58
/* 80BD4814  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80BD4818  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BD481C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80BD4844  3C 80 80 BD */	lis r4, l_arcName@ha /* 0x80BD4DC4@ha */
/* 80BD4848  38 84 4D C4 */	addi r4, r4, l_arcName@l /* 0x80BD4DC4@l */
/* 80BD484C  80 84 00 00 */	lwz r4, 0(r4)
/* 80BD4850  4B 45 86 6D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BD4874  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BD4878  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BD487C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80BD4880  7C 05 07 74 */	extsb r5, r0
/* 80BD4884  4B 46 0A DD */	bl isSwitch__10dSv_info_cCFii
...
/* 80BD48A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BD48A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BD48A8  3C 63 00 02 */	addis r3, r3, 2
/* 80BD48AC  3C 80 80 BD */	lis r4, l_arcName@ha /* 0x80BD4DC4@ha */
/* 80BD48B0  38 84 4D C4 */	addi r4, r4, l_arcName@l /* 0x80BD4DC4@l */
/* 80BD48B4  80 84 00 00 */	lwz r4, 0(r4)
/* 80BD48B8  3C A0 80 BD */	lis r5, d_a_obj_crvlh_down__stringBase0@ha /* 0x80BD4D88@ha */
/* 80BD48BC  38 A5 4D 88 */	addi r5, r5, d_a_obj_crvlh_down__stringBase0@l /* 0x80BD4D88@l */
/* 80BD48C0  38 A5 00 29 */	addi r5, r5, 0x29
/* 80BD48C4  38 63 C2 F8 */	addi r3, r3, -15624
/* 80BD48C8  4B 46 7D F1 */	bl getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80BD48CC  7C 65 1B 78 */	mr r5, r3
/* 80BD48D0  7F C3 F3 78 */	mr r3, r30
/* 80BD48D4  3C 80 80 BD */	lis r4, l_arcName@ha /* 0x80BD4DC4@ha */
/* 80BD48D8  38 84 4D C4 */	addi r4, r4, l_arcName@l /* 0x80BD4DC4@l */
/* 80BD48DC  80 84 00 00 */	lwz r4, 0(r4)
/* 80BD48E0  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80BD48E4  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80BD48E8  38 E0 0B 40 */	li r7, 0xb40
/* 80BD48EC  39 00 00 00 */	li r8, 0
/* 80BD48F0  4B 4A 3E CD */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80BD493C  4B 44 93 81 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80BD4940  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BD4944  41 82 00 18 */	beq lbl_80BD495C
/* 80BD4948  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80BD494C  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 80BD4980  4B 44 5B C9 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80BD49C8  4B 44 55 29 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
/* 80BD49CC  90 7E 05 A0 */	stw r3, 0x5a0(r30)
lbl_80BD49D0:
/* 80BD49D0  7F A3 EB 78 */	mr r3, r29
lbl_80BD49D4:
/* 80BD49D4  39 61 00 30 */	addi r11, r1, 0x30
/* 80BD49D8  4B 78 D8 51 */	bl _restgpr_29
