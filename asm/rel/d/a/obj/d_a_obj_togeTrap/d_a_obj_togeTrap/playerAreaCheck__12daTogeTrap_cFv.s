...
/* 80D185F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D185F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D18608  4B 54 E5 2D */	bl __mi__4cXyzCFRC3Vec
...
/* 80D18624  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D18628  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1862C  A8 1F 04 DE */	lha r0, 0x4de(r31)
/* 80D18630  7C 00 00 D0 */	neg r0, r0
/* 80D18634  7C 04 07 34 */	extsh r4, r0
/* 80D18638  4B 2F 3D A5 */	bl mDoMtx_YrotS__FPA4_fs
/* 80D1863C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D18640  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D18644  38 81 00 14 */	addi r4, r1, 0x14
/* 80D18648  7C 85 23 78 */	mr r5, r4
/* 80D1864C  4B 62 E7 21 */	bl PSMTXMultVec
...
/* 80D1866C  3C 80 80 D2 */	lis r4, l_HIO@ha /* 0x80D190B4@ha */
/* 80D18670  38 84 90 B4 */	addi r4, r4, l_HIO@l /* 0x80D190B4@l */
...
/* 80D18684  3C 80 80 D2 */	lis r4, lit_3975@ha /* 0x80D18EF8@ha */
/* 80D18688  C0 04 8E F8 */	lfs f0, lit_3975@l(r4)  /* 0x80D18EF8@l */
