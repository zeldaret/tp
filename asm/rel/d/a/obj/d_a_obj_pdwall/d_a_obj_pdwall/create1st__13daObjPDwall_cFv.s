...
/* 80CAC808  4B 6B 59 CD */	bl _savegpr_27
/* 80CAC80C  7C 7F 1B 79 */	or. r31, r3, r3
/* 80CAC810  41 82 00 08 */	beq lbl_80CAC818
/* 80CAC814  38 63 05 A0 */	addi r3, r3, 0x5a0
lbl_80CAC818:
/* 80CAC818  3C 80 80 CB */	lis r4, l_arcName@ha /* 0x80CAD1FC@ha */
/* 80CAC81C  38 84 D1 FC */	addi r4, r4, l_arcName@l /* 0x80CAD1FC@l */
/* 80CAC820  80 84 00 00 */	lwz r4, 0(r4)
/* 80CAC824  4B 38 06 99 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CAC840  3C 80 80 CB */	lis r4, l_arcName@ha /* 0x80CAD1FC@ha */
/* 80CAC844  38 84 D1 FC */	addi r4, r4, l_arcName@l /* 0x80CAD1FC@l */
/* 80CAC848  80 84 00 00 */	lwz r4, 0(r4)
/* 80CAC84C  38 A0 00 07 */	li r5, 7
/* 80CAC850  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80CAC854  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
...
/* 80CAC864  4B 3C BF 59 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80CAC880  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CAC884  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CAC89C  4B 3C 81 6D */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80CAC8C8  4B 6B 59 59 */	bl _restgpr_27
