...
/* 80CACFE4  4B 6B 51 F1 */	bl _savegpr_27
/* 80CACFE8  7C 7B 1B 78 */	mr r27, r3
/* 80CACFEC  3B 80 00 00 */	li r28, 0
/* 80CACFF0  3B E0 00 00 */	li r31, 0
/* 80CACFF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CACFF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CAD010  4B 5B B1 C5 */	bl ChkUsed__9cBgW_BgIdCFv
...
/* 80CAD024  4B 3C 72 2D */	bl Release__4cBgSFP9dBgW_Base
lbl_80CAD028:
...
lbl_80CAD048:
/* 80CAD048  3C 80 80 CB */	lis r4, l_arcName@ha /* 0x80CAD1FC@ha */
/* 80CAD04C  38 84 D1 FC */	addi r4, r4, l_arcName@l /* 0x80CAD1FC@l */
/* 80CAD050  80 84 00 00 */	lwz r4, 0(r4)
/* 80CAD054  4B 37 FF B5 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80CAD058  38 60 00 01 */	li r3, 1
/* 80CAD05C  39 61 00 20 */	addi r11, r1, 0x20
/* 80CAD060  4B 6B 51 C1 */	bl _restgpr_27
