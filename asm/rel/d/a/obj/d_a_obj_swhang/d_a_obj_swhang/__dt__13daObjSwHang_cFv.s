...
/* 80CFD054  3C 60 80 D0 */	lis r3, __vt__13daObjSwHang_c@ha
/* 80CFD058  38 63 D4 84 */	addi r3, r3, __vt__13daObjSwHang_c@l
...
/* 80CFD070  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 80CFD074  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 80CFD094  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 80CFD098  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
...
/* 80CFD0B0  3C 60 80 D0 */	lis r3, __vt__8cM3dGSph@ha
/* 80CFD0B4  38 03 D4 54 */	addi r0, r3, __vt__8cM3dGSph@l
/* 80CFD0B8  90 1E 07 2C */	stw r0, 0x72c(r30)
lbl_80CFD0BC:
/* 80CFD0BC  34 1E 06 FC */	addic. r0, r30, 0x6fc
/* 80CFD0C0  41 82 00 24 */	beq lbl_80CFD0E4
/* 80CFD0C4  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80CFD0C8  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80CFD0CC  90 1E 07 18 */	stw r0, 0x718(r30)
/* 80CFD0D0  34 1E 06 FC */	addic. r0, r30, 0x6fc
/* 80CFD0D4  41 82 00 10 */	beq lbl_80CFD0E4
/* 80CFD0D8  3C 60 80 D0 */	lis r3, __vt__8cM3dGAab@ha
/* 80CFD0DC  38 03 D4 60 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80CFD0E0  90 1E 07 14 */	stw r0, 0x714(r30)
lbl_80CFD0E4:
/* 80CFD0E4  38 7E 05 F8 */	addi r3, r30, 0x5f8
/* 80CFD0E8  38 80 00 00 */	li r4, 0
/* 80CFD0EC  4B 38 6F F8 */	b __dt__12dCcD_GObjInfFv
lbl_80CFD0F0:
/* 80CFD0F0  34 1E 05 BC */	addic. r0, r30, 0x5bc
/* 80CFD0F4  41 82 00 54 */	beq lbl_80CFD148
/* 80CFD0F8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80CFD0FC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
