...
/* 80CFBCD8  3C 60 80 D0 */	lis r3, l_arcName@ha /* 0x80CFD2D8@ha */
/* 80CFBCDC  38 63 D2 D8 */	addi r3, r3, l_arcName@l /* 0x80CFD2D8@l */
/* 80CFBCE0  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CFBCE4  3C 80 80 D0 */	lis r4, l_bmdIdx@ha /* 0x80CFD1DC@ha */
/* 80CFBCE8  38 84 D1 DC */	addi r4, r4, l_bmdIdx@l /* 0x80CFD1DC@l */
/* 80CFBCEC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CFBCF0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CFBCF4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CFBD08  4B 34 05 E5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CFBD18  4B 31 8F 3D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CFBD38  4B 5D 2F 15 */	bl __nw__FUl
/* 80CFBD3C  7C 60 1B 79 */	or. r0, r3, r3
/* 80CFBD40  41 82 00 0C */	beq lbl_80CFBD4C
/* 80CFBD44  4B 37 FC 2D */	bl __ct__4dBgWFv
...
/* 80CFBD64  3C 60 80 D0 */	lis r3, l_arcName@ha /* 0x80CFD2D8@ha */
/* 80CFBD68  38 63 D2 D8 */	addi r3, r3, l_arcName@l /* 0x80CFD2D8@l */
/* 80CFBD6C  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CFBD70  3C 80 80 D0 */	lis r4, l_dzbIdx@ha /* 0x80CFD1F0@ha */
/* 80CFBD74  38 84 D1 F0 */	addi r4, r4, l_dzbIdx@l /* 0x80CFD1F0@l */
/* 80CFBD78  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CFBD7C  7F C5 F3 78 */	mr r5, r30
/* 80CFBD80  38 C0 00 80 */	li r6, 0x80
/* 80CFBD84  4B 34 05 69 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CFBD98  4B 37 E1 A1 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
