...
lbl_80CFCD2C:
/* 80CFCD2C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CFCD30  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CFCD34  38 80 00 00 */	li r4, 0
/* 80CFCD38  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CFCD3C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CFCD40  4B 4A 6A 84 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CFCD44  48 00 00 1C */	b lbl_80CFCD60
lbl_80CFCD48:
/* 80CFCD48  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CFCD4C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CFCD50  38 80 00 10 */	li r4, 0x10
/* 80CFCD54  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CFCD58  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CFCD5C  4B 4A 6A 68 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
lbl_80CFCD60:
/* 80CFCD60  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CFCD64  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CFCD68  80 9F 05 B8 */	lwz r4, 0x5b8(r31)
/* 80CFCD6C  80 84 00 04 */	lwz r4, 4(r4)
/* 80CFCD70  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CFCD74  4B 4A 80 2C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CFCD78  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 80CFCD7C  4B 31 0F 48 */	b mDoExt_modelUpdateDL__FP8J3DModel
