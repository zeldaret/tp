...
/* 80CFBE00  4B 37 C8 25 */	bl __ct__16dBgS_MoveBgActorFv
/* 80CFBE04  3C 60 80 D0 */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80CFD46C@ha */
/* 80CFBE08  38 03 D4 6C */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80CFD46C@l */
...
/* 80CFBE1C  3C 60 80 D0 */	lis r3, __vt__13daObjSwHang_c@ha /* 0x80CFD484@ha */
/* 80CFBE20  38 63 D4 84 */	addi r3, r3, __vt__13daObjSwHang_c@l /* 0x80CFD484@l */
/* 80CFBE24  90 7E 05 9C */	stw r3, 0x59c(r30)
/* 80CFBE28  38 03 00 28 */	addi r0, r3, 0x28
/* 80CFBE2C  90 1E 05 A0 */	stw r0, 0x5a0(r30)
/* 80CFBE30  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CFBE34  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CFBE38  90 1E 05 D4 */	stw r0, 0x5d4(r30)
/* 80CFBE3C  38 7E 05 D8 */	addi r3, r30, 0x5d8
/* 80CFBE40  4B 38 79 21 */	bl __ct__10dCcD_GSttsFv
/* 80CFBE44  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CFBE48  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CFBE60  4B 38 7B C9 */	bl __ct__12dCcD_GObjInfFv
/* 80CFBE64  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CFBE68  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CFBE6C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80CFBE70  3C 60 80 D0 */	lis r3, __vt__8cM3dGAab@ha /* 0x80CFD460@ha */
/* 80CFBE74  38 03 D4 60 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CFD460@l */
/* 80CFBE78  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80CFBE7C  3C 60 80 D0 */	lis r3, __vt__8cM3dGSph@ha /* 0x80CFD454@ha */
/* 80CFBE80  38 03 D4 54 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80CFD454@l */
/* 80CFBE84  90 1E 01 34 */	stw r0, 0x134(r30)
/* 80CFBE88  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80CFBE8C  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 80CFBE90  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80CFBE94  38 03 00 58 */	addi r0, r3, 0x58
/* 80CFBE98  90 1E 01 34 */	stw r0, 0x134(r30)
/* 80CFBE9C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80CFBEA0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80CFBEDC  3C 80 80 D0 */	lis r4, l_arcName@ha /* 0x80CFD2D8@ha */
/* 80CFBEE0  38 84 D2 D8 */	addi r4, r4, l_arcName@l /* 0x80CFD2D8@l */
/* 80CFBEE4  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CFBEE8  4B 33 0F D5 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CFBF04  3C 80 80 D0 */	lis r4, l_arcName@ha /* 0x80CFD2D8@ha */
/* 80CFBF08  38 84 D2 D8 */	addi r4, r4, l_arcName@l /* 0x80CFD2D8@l */
/* 80CFBF0C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CFBF10  3C A0 80 D0 */	lis r5, l_dzbIdx2@ha /* 0x80CFD204@ha */
/* 80CFBF14  38 A5 D2 04 */	addi r5, r5, l_dzbIdx2@l /* 0x80CFD204@l */
/* 80CFBF18  7C A5 00 2E */	lwzx r5, r5, r0
/* 80CFBF1C  38 C0 00 00 */	li r6, 0
/* 80CFBF20  3C E0 80 D0 */	lis r7, l_heap_size@ha /* 0x80CFD22C@ha */
/* 80CFBF24  38 E7 D2 2C */	addi r7, r7, l_heap_size@l /* 0x80CFD22C@l */
/* 80CFBF28  7C E7 00 2E */	lwzx r7, r7, r0
/* 80CFBF2C  39 00 00 00 */	li r8, 0
/* 80CFBF30  4B 37 C8 8D */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
