...
/* 80CFC060  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CFC064  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CFC068  80 A3 5D AC */	lwz r5, 0x5dac(r3)
/* 80CFC06C  88 1F 07 30 */	lbz r0, 0x730(r31)
/* 80CFC070  1C 80 00 0C */	mulli r4, r0, 0xc
/* 80CFC074  3C 60 80 D0 */	lis r3, l_hang_offset@ha /* 0x80CFD300@ha */
/* 80CFC078  38 03 D3 00 */	addi r0, r3, l_hang_offset@l /* 0x80CFD300@l */
...
/* 80CFC0D8  4B 31 0C 8D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80CFC0DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFC0E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFC0E4  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CFC0E8  4B 31 03 4D */	bl mDoMtx_YrotM__FPA4_fs
/* 80CFC0EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFC0F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFC0F4  38 9F 07 70 */	addi r4, r31, 0x770
/* 80CFC0F8  7C 85 23 78 */	mr r5, r4
/* 80CFC0FC  4B 64 AC 71 */	bl PSMTXMultVec
