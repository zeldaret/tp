...
/* 80D292B0  4B 63 8F 2D */	bl _savegpr_29
...
/* 80D292C8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D292CC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D292D0  38 80 00 20 */	li r4, 0x20
/* 80D292D4  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80D292D8  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80D292DC  4B 47 A4 E9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80D292E0  48 00 00 1C */	b lbl_80D292FC
lbl_80D292E4:
/* 80D292E4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D292E8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D292EC  38 80 00 10 */	li r4, 0x10
/* 80D292F0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80D292F4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80D292F8  4B 47 A4 CD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
lbl_80D292FC:
/* 80D292FC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D29300  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D29304  80 9E 05 B0 */	lwz r4, 0x5b0(r30)
/* 80D29308  80 84 00 04 */	lwz r4, 4(r4)
/* 80D2930C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80D29310  4B 47 BA 91 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D29314  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D29318  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D2931C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80D29320  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80D29324  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80D29358  4B 2E 46 75 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_80D2935C:
...
/* 80D29378  4B 2E 43 61 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80D2937C:
/* 80D2937C  80 7E 05 B0 */	lwz r3, 0x5b0(r30)
/* 80D29380  4B 2E 49 45 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D2939C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D293A0  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D293E0  4B 2E 42 F9 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80D293F8  4B 2E 43 B1 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80D293FC  80 7E 05 BC */	lwz r3, 0x5bc(r30)
/* 80D29400  4B 2E 48 C5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80D29404  80 7E 05 B0 */	lwz r3, 0x5b0(r30)
/* 80D29408  80 63 00 04 */	lwz r3, 4(r3)
/* 80D2940C  4B 2E 4A 81 */	bl mDoExt_brkAnmRemove__FP12J3DModelData
/* 80D29410  80 7E 05 B0 */	lwz r3, 0x5b0(r30)
/* 80D29414  80 63 00 04 */	lwz r3, 4(r3)
/* 80D29418  4B 2E 49 D9 */	bl mDoExt_btkAnmRemove__FP12J3DModelData
...
/* 80D29434  4B 63 8D F5 */	bl _restgpr_29
