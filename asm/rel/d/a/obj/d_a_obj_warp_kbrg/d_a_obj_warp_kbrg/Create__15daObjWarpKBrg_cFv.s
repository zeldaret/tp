...
/* 80D270D4  4B 63 B0 FD */	bl _savegpr_26
...
lbl_80D27108:
/* 80D27108  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2710C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D27110  54 84 06 3E */	clrlwi r4, r4, 0x18
/* 80D27114  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D27118  7C 05 07 74 */	extsb r5, r0
/* 80D2711C  4B 30 E2 45 */	bl isSwitch__10dSv_info_cCFii
...
/* 80D2713C  4B 54 10 99 */	bl ChkUsed__9cBgW_BgIdCFv
/* 80D27140  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80D27144  41 82 00 88 */	beq lbl_80D271CC
/* 80D27148  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2714C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D27150  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80D27154  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80D27158  4B 34 D0 F9 */	bl Release__4cBgSFP9dBgW_Base
/* 80D2715C  48 00 00 70 */	b lbl_80D271CC
lbl_80D27160:
/* 80D27160  80 9F 05 B8 */	lwz r4, 0x5b8(r31)
/* 80D27164  A8 04 00 08 */	lha r0, 8(r4)
/* 80D27168  3C 60 80 D3 */	lis r3, lit_3827@ha /* 0x80D2962C@ha */
/* 80D2716C  C8 23 96 2C */	lfd f1, lit_3827@l(r3)  /* 0x80D2962C@l */
...
/* 80D271B4  3C 60 80 D3 */	lis r3, lit_3825@ha /* 0x80D29624@ha */
/* 80D271B8  C0 03 96 24 */	lfs f0, lit_3825@l(r3)  /* 0x80D29624@l */
...
/* 80D271FC  3C 60 80 D3 */	lis r3, d_a_obj_warp_kbrg__stringBase0@ha /* 0x80D29688@ha */
/* 80D27200  3B 83 96 88 */	addi r28, r3, d_a_obj_warp_kbrg__stringBase0@l /* 0x80D29688@l */
/* 80D27204  48 00 00 2C */	b lbl_80D27230
lbl_80D27208:
/* 80D27208  7F A3 EB 78 */	mr r3, r29
/* 80D2720C  7F 64 DB 78 */	mr r4, r27
/* 80D27210  4B 5B 78 E9 */	bl getName__10JUTNameTabCFUs
/* 80D27214  38 9C 00 51 */	addi r4, r28, 0x51
/* 80D27218  4B 64 17 7D */	bl strcmp
...
/* 80D27268  4B 2F 33 11 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80D2726C  38 00 00 36 */	li r0, 0x36
/* 80D27270  98 1F 05 45 */	stb r0, 0x545(r31)
/* 80D27274  98 1F 05 47 */	stb r0, 0x547(r31)
/* 80D27278  3C 60 80 D3 */	lis r3, l_evArcName@ha /* 0x80D29738@ha */
/* 80D2727C  80 03 97 38 */	lwz r0, l_evArcName@l(r3)  /* 0x80D29738@l */
...
/* 80D27290  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D27294  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D27298  3B 63 4F F8 */	addi r27, r3, 0x4ff8
/* 80D2729C  3C 60 80 D3 */	lis r3, l_portal_warp_name@ha /* 0x80D2973C@ha */
/* 80D272A0  3B 83 97 3C */	addi r28, r3, l_portal_warp_name@l /* 0x80D2973C@l */
lbl_80D272A4:
...
/* 80D272B4  4B 32 04 A5 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 80D272E0  4B 35 16 71 */	bl MoveBGExecute__16dBgS_MoveBgActorFv
/* 80D272E4  38 60 00 01 */	li r3, 1
/* 80D272E8  39 61 00 30 */	addi r11, r1, 0x30
/* 80D272EC  4B 63 AF 31 */	bl _restgpr_26
