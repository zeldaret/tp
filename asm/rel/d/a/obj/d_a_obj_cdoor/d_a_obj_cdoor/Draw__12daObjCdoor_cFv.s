...
/* 80BC7C1C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BC7C20  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BC7C24  38 80 00 10 */	li r4, 0x10
/* 80BC7C28  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BC7C2C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BC7C30  4B 5D BB 95 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BC7C34  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BC7C38  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BC7C3C  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80BC7C40  80 84 00 04 */	lwz r4, 4(r4)
/* 80BC7C44  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BC7C48  4B 5D D1 59 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80BC7C74  4B 44 5D 59 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80BC7C78  48 00 00 10 */	b lbl_80BC7C88
lbl_80BC7C7C:
/* 80BC7C7C  38 7E 05 DC */	addi r3, r30, 0x5dc
/* 80BC7C80  C0 3E 05 EC */	lfs f1, 0x5ec(r30)
/* 80BC7C84  4B 44 5D 49 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_80BC7C88:
/* 80BC7C88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC7C8C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BC7C90  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80BC7C94  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BC7C98  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BC7CAC  4B 44 60 19 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80BC7CB0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC7CB4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
