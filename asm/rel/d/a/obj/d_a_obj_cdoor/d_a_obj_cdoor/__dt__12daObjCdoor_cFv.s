...
/* 80BC72BC  3C 60 80 BC */	lis r3, __vt__12daObjCdoor_c@ha /* 0x80BC7E80@ha */
/* 80BC72C0  38 03 7E 80 */	addi r0, r3, __vt__12daObjCdoor_c@l /* 0x80BC7E80@l */
...
/* 80BC72D4  3C 80 80 BC */	lis r4, l_arcName@ha /* 0x80BC7D78@ha */
/* 80BC72D8  38 84 7D 78 */	addi r4, r4, l_arcName@l /* 0x80BC7D78@l */
/* 80BC72DC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80BC72E0  4B 46 5D 29 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80BC72FC  3C 60 80 BC */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80BC7EAC@ha */
/* 80BC7300  38 03 7E AC */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80BC7EAC@l */
...
/* 80BC7320  3C 60 80 BC */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80BC7EAC@ha */
/* 80BC7324  38 03 7E AC */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80BC7EAC@l */
/* 80BC7328  90 1E 05 C0 */	stw r0, 0x5c0(r30)
lbl_80BC732C:
/* 80BC732C  28 1E 00 00 */	cmplwi r30, 0
/* 80BC7330  41 82 00 1C */	beq lbl_80BC734C
/* 80BC7334  3C 60 80 3B */	lis r3, __vt__16dBgS_MoveBgActor@ha /* 0x803AB9A0@ha */
/* 80BC7338  38 03 B9 A0 */	addi r0, r3, __vt__16dBgS_MoveBgActor@l /* 0x803AB9A0@l */
/* 80BC733C  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80BC7340  7F C3 F3 78 */	mr r3, r30
/* 80BC7344  38 80 00 00 */	li r4, 0
/* 80BC7348  4B 45 19 45 */	bl __dt__10fopAc_ac_cFv
lbl_80BC734C:
/* 80BC734C  7F E0 07 35 */	extsh. r0, r31
/* 80BC7350  40 81 00 0C */	ble lbl_80BC735C
/* 80BC7354  7F C3 F3 78 */	mr r3, r30
/* 80BC7358  4B 70 79 E5 */	bl __dl__FPv
lbl_80BC735C:
