...
/* 80CF1988  4B 67 08 45 */	bl _savegpr_25
/* 80CF198C  7C 7F 1B 78 */	mr r31, r3
/* 80CF1990  3C 80 80 CF */	lis r4, lit_3850@ha /* 0x80CF3000@ha */
/* 80CF1994  3B C4 30 00 */	addi r30, r4, lit_3850@l /* 0x80CF3000@l */
...
/* 80CF19CC  3C 60 80 CF */	lis r3, saru_ct@ha /* 0x80CF3278@ha */
/* 80CF19D0  90 03 32 78 */	stw r0, saru_ct@l(r3)  /* 0x80CF3278@l */
/* 80CF19D4  3C 60 80 CF */	lis r3, s_ks_sub__FPvPv@ha /* 0x80CF0774@ha */
/* 80CF19D8  38 63 07 74 */	addi r3, r3, s_ks_sub__FPvPv@l /* 0x80CF0774@l */
/* 80CF19DC  7F E4 FB 78 */	mr r4, r31
/* 80CF19E0  4B 32 F9 59 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 80CF19E4  3C 60 80 CF */	lis r3, saru_ct@ha /* 0x80CF3278@ha */
/* 80CF19E8  80 03 32 78 */	lwz r0, saru_ct@l(r3)  /* 0x80CF3278@l */
...
/* 80CF19FC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF1A00  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF1A04  7F 84 E3 78 */	mr r4, r28
/* 80CF1A08  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80CF1A0C  7C 05 07 74 */	extsb r5, r0
/* 80CF1A10  4B 34 39 51 */	bl isSwitch__10dSv_info_cCFii
/* 80CF1A14  2C 03 00 00 */	cmpwi r3, 0
/* 80CF1A18  40 82 00 18 */	bne lbl_80CF1A30
lbl_80CF1A1C:
/* 80CF1A1C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF1A20  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF1A24  88 03 4F AD */	lbz r0, 0x4fad(r3)
/* 80CF1A28  28 00 00 00 */	cmplwi r0, 0
/* 80CF1A2C  40 82 01 0C */	bne lbl_80CF1B38
lbl_80CF1A30:
/* 80CF1A30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF1A34  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF1A38  38 80 00 53 */	li r4, 0x53
/* 80CF1A3C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80CF1A40  7C 05 07 74 */	extsb r5, r0
/* 80CF1A44  4B 34 39 1D */	bl isSwitch__10dSv_info_cCFii
/* 80CF1A48  2C 03 00 00 */	cmpwi r3, 0
/* 80CF1A4C  41 82 00 EC */	beq lbl_80CF1B38
/* 80CF1A50  38 00 00 00 */	li r0, 0
/* 80CF1A54  3C 60 80 CF */	lis r3, saru_ct@ha /* 0x80CF3278@ha */
/* 80CF1A58  90 03 32 78 */	stw r0, saru_ct@l(r3)  /* 0x80CF3278@l */
/* 80CF1A5C  3C 60 80 CF */	lis r3, s_ksdel_sub__FPvPv@ha /* 0x80CF07F8@ha */
/* 80CF1A60  38 63 07 F8 */	addi r3, r3, s_ksdel_sub__FPvPv@l /* 0x80CF07F8@l */
/* 80CF1A64  7F E4 FB 78 */	mr r4, r31
/* 80CF1A68  4B 32 F8 D1 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80CF1A8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF1A90  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF1A94  7F 84 E3 78 */	mr r4, r28
/* 80CF1A98  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80CF1A9C  7C 05 07 74 */	extsb r5, r0
/* 80CF1AA0  4B 34 38 C1 */	bl isSwitch__10dSv_info_cCFii
...
lbl_80CF1AE8:
/* 80CF1AE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF1AEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF1AF0  38 80 00 79 */	li r4, 0x79
/* 80CF1AF4  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80CF1AF8  7C 05 07 74 */	extsb r5, r0
/* 80CF1AFC  4B 34 37 05 */	bl onSwitch__10dSv_info_cFii
/* 80CF1B00  38 00 00 01 */	li r0, 1
/* 80CF1B04  B0 1F 05 76 */	sth r0, 0x576(r31)
/* 80CF1B08  C0 1F 04 A8 */	lfs f0, 0x4a8(r31)
/* 80CF1B0C  3C 60 80 CF */	lis r3, sc_path@ha /* 0x80CF3100@ha */
/* 80CF1B10  38 63 31 00 */	addi r3, r3, sc_path@l /* 0x80CF3100@l */
...
/* 80CF1B48  4B 57 DE F5 */	bl cLib_addCalc2__FPffff
...
/* 80CF1B70  4B 57 DF 11 */	bl cLib_addCalc0__FPfff
...
/* 80CF1B84  4B 57 EA 85 */	bl cLib_addCalcAngleS2__FPssss
/* 80CF1B88  3B 7F 05 A8 */	addi r27, r31, 0x5a8
/* 80CF1B8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF1B90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF1B94  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80CF1B98  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80CF1B9C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80CF1BA0  4B 65 4D 49 */	bl PSMTXTrans
/* 80CF1BA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF1BA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80CF1BBC  4B 31 A8 79 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CF1BC0  C3 FE 00 0C */	lfs f31, 0xc(r30)
/* 80CF1BC4  3B 40 00 00 */	li r26, 0
/* 80CF1BC8  3B 20 00 00 */	li r25, 0
/* 80CF1BCC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CF1BD0  3B 83 9A 20 */	addi r28, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80CF1BD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF1BD8  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_80CF1BDC:
...
/* 80CF1C4C  4B 31 A7 51 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CF1C50  7F A3 EB 78 */	mr r3, r29
/* 80CF1C54  A8 9B 00 2C */	lha r4, 0x2c(r27)
/* 80CF1C58  4B 31 A8 75 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80CF1C84  4B 57 E9 85 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80CF1C98  4B 57 E9 71 */	bl cLib_addCalcAngleS2__FPssss
/* 80CF1C9C  4B 31 B0 2D */	bl push__14mDoMtx_stack_cFv
/* 80CF1CA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF1CA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF1CA8  A8 9B 00 28 */	lha r4, 0x28(r27)
/* 80CF1CAC  4B 31 A6 F1 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CF1CB0  80 7B 00 40 */	lwz r3, 0x40(r27)
/* 80CF1CB4  80 83 00 04 */	lwz r4, 4(r3)
/* 80CF1CB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF1CBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF1CC0  38 84 00 24 */	addi r4, r4, 0x24
/* 80CF1CC4  4B 65 47 ED */	bl PSMTXCopy
/* 80CF1CC8  80 7B 00 40 */	lwz r3, 0x40(r27)
/* 80CF1CCC  38 80 00 00 */	li r4, 0
/* 80CF1CD0  38 A0 00 00 */	li r5, 0
/* 80CF1CD4  38 C0 00 00 */	li r6, 0
/* 80CF1CD8  4B 31 E8 F1 */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 80CF1CDC  80 7B 00 40 */	lwz r3, 0x40(r27)
/* 80CF1CE0  4B 31 E9 CD */	bl modelCalc__14mDoExt_McaMorfFv
...
/* 80CF1D10  4B 65 47 A1 */	bl PSMTXCopy
lbl_80CF1D14:
/* 80CF1D14  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80CF1D18  7C 03 07 74 */	extsb r3, r0
/* 80CF1D1C  4B 33 B3 51 */	bl dComIfGp_getReverb__Fi
...
/* 80CF1D3C  4B 31 AF D9 */	bl pop__14mDoMtx_stack_cFv
lbl_80CF1D40:
/* 80CF1D40  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80CF1D44  C0 5E 00 94 */	lfs f2, 0x94(r30)
/* 80CF1D48  FC 60 08 90 */	fmr f3, f1
/* 80CF1D4C  4B 31 B0 51 */	bl transM__14mDoMtx_stack_cFfff
...
/* 80CF1D74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF1D78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF1D7C  38 81 00 28 */	addi r4, r1, 0x28
/* 80CF1D80  38 BF 05 38 */	addi r5, r31, 0x538
/* 80CF1D84  4B 65 4F E9 */	bl PSMTXMultVec
...
/* 80CF1E10  4B 57 4D 25 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CF1E30  4B 65 53 09 */	bl PSVECSquareMag
...
/* 80CF1EA0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CF1EA4  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CF1F10  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CF1F14  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CF1F2C  4B 57 4C 09 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CF1F4C  4B 65 51 ED */	bl PSVECSquareMag
...
/* 80CF1FBC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CF1FC0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CF202C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CF2030  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80CF2034:
...
/* 80CF2068  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CF206C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
lbl_80CF2080:
/* 80CF2080  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF2084  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80CF2098  4B 65 48 51 */	bl PSMTXTrans
/* 80CF209C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF20A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF20A4  A8 9C 00 2A */	lha r4, 0x2a(r28)
/* 80CF20A8  4B 31 A3 8D */	bl mDoMtx_YrotM__FPA4_fs
/* 80CF20AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF20B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF20B4  A8 9C 00 28 */	lha r4, 0x28(r28)
/* 80CF20B8  4B 31 A2 E5 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CF20BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF20C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF20C4  A8 9C 00 2C */	lha r4, 0x2c(r28)
/* 80CF20C8  4B 31 A4 05 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80CF20CC  80 7C 00 40 */	lwz r3, 0x40(r28)
/* 80CF20D0  80 83 00 04 */	lwz r4, 4(r3)
/* 80CF20D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF20D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF20DC  38 84 00 24 */	addi r4, r4, 0x24
/* 80CF20E0  4B 65 43 D1 */	bl PSMTXCopy
/* 80CF20E4  80 7C 00 40 */	lwz r3, 0x40(r28)
/* 80CF20E8  38 80 00 00 */	li r4, 0
/* 80CF20EC  38 A0 00 00 */	li r5, 0
/* 80CF20F0  38 C0 00 00 */	li r6, 0
/* 80CF20F4  4B 31 E4 D5 */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 80CF20F8  80 7C 00 40 */	lwz r3, 0x40(r28)
/* 80CF20FC  4B 31 E5 B1 */	bl modelCalc__14mDoExt_McaMorfFv
/* 80CF2100  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80CF2104  7C 03 07 74 */	extsb r3, r0
/* 80CF2108  4B 33 AF 65 */	bl dComIfGp_getReverb__Fi
...
/* 80CF214C  4B 67 00 CD */	bl _restgpr_25
