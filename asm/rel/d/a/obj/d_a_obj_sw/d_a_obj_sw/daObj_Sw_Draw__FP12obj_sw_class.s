...
/* 80CF0648  4B 67 1B 95 */	bl _savegpr_29
...
/* 80CF065C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF0660  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF0664  38 80 00 00 */	li r4, 0
/* 80CF0668  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CF066C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CF0670  4B 4B 31 55 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 80CF0690  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF0694  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF0698  80 84 00 04 */	lwz r4, 4(r4)
/* 80CF069C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CF06A0  4B 4B 47 01 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CF06A4  80 7E 00 40 */	lwz r3, 0x40(r30)
/* 80CF06A8  4B 31 FF D9 */	bl entryDL__14mDoExt_McaMorfFv
...
/* 80CF06C0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF06C4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF06C8  80 84 00 04 */	lwz r4, 4(r4)
/* 80CF06CC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CF06D0  4B 4B 46 D1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CF06D4  80 7F 08 C8 */	lwz r3, 0x8c8(r31)
/* 80CF06D8  4B 31 D5 ED */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80CF06DC:
...
lbl_80CF06F0:
/* 80CF06F0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF06F4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF06F8  38 80 00 10 */	li r4, 0x10
/* 80CF06FC  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CF0700  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CF0704  4B 4B 30 C1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CF0708  38 7F 0D 50 */	addi r3, r31, 0xd50
/* 80CF070C  38 80 00 3F */	li r4, 0x3f
/* 80CF0710  3C A0 80 CF */	lis r5, l_color@ha /* 0x80CF30FC@ha */
/* 80CF0714  38 A5 30 FC */	addi r5, r5, l_color@l /* 0x80CF30FC@l */
/* 80CF0718  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CF071C  4B 32 38 95 */	bl update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 80CF0738  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF073C  38 03 61 C0 */	addi r0, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF0754  4B 32 3F E5 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
lbl_80CF0758:
/* 80CF0758  38 60 00 01 */	li r3, 1
/* 80CF075C  39 61 00 20 */	addi r11, r1, 0x20
/* 80CF0760  4B 67 1A C9 */	bl _restgpr_29
