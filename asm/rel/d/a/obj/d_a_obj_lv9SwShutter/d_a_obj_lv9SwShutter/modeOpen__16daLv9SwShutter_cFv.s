...
/* 80C8D2F8  3C 60 80 C9 */	lis r3, lit_3627@ha /* 0x80C8D7DC@ha */
/* 80C8D2FC  3B E3 D7 DC */	addi r31, r3, lit_3627@l /* 0x80C8D7DC@l */
/* 80C8D300  38 7E 05 B0 */	addi r3, r30, 0x5b0
/* 80C8D304  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 80C8D308  C0 5F 00 14 */	lfs f2, 0x14(r31)
/* 80C8D30C  3C 80 80 C9 */	lis r4, l_HIO@ha /* 0x80C8D91C@ha */
/* 80C8D310  38 84 D9 1C */	addi r4, r4, l_HIO@l /* 0x80C8D91C@l */
/* 80C8D314  C0 64 00 04 */	lfs f3, 4(r4)
/* 80C8D318  C0 9F 00 18 */	lfs f4, 0x18(r31)
/* 80C8D31C  4B 5E 26 61 */	bl cLib_addCalc__FPfffff
/* 80C8D320  FF E0 08 90 */	fmr f31, f1
/* 80C8D324  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8D328  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8D32C  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C8D330  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C8D334  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C8D338  4B 37 EE D1 */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C8D350  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8D354  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8D358  38 81 00 10 */	addi r4, r1, 0x10
/* 80C8D35C  7C 85 23 78 */	mr r5, r4
/* 80C8D360  4B 6B 9A 0D */	bl PSMTXMultVec
/* 80C8D364  38 61 00 10 */	addi r3, r1, 0x10
/* 80C8D368  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C8D36C  7C 65 1B 78 */	mr r5, r3
/* 80C8D370  4B 6B 9D 21 */	bl PSVECAdd
/* 80C8D374  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8D378  7C 03 07 74 */	extsb r3, r0
/* 80C8D37C  4B 39 FC F1 */	bl dComIfGp_getReverb__Fi
...
/* 80C8D390  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8D394  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8D3BC  4B 61 F1 51 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C8D3D4  4B 39 FC 99 */	bl dComIfGp_getReverb__Fi
...
/* 80C8D3E8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8D3EC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8D414  4B 61 E5 71 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
