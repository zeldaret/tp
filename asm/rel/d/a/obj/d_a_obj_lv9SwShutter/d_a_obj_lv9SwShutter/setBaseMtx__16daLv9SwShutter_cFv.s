...
/* 80C8CF4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8CF50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C8CF54  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C8CF58  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C8CF5C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C8CF60  4B 6B 99 88 */	b PSMTXTrans
/* 80C8CF64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8CF68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C8CF6C  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C8CF70  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C8CF74  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C8CF78  4B 37 F3 28 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C8CF7C  3C 60 80 C9 */	lis r3, lit_3650@ha
/* 80C8CF80  C0 23 D7 E8 */	lfs f1, lit_3650@l(r3)
/* 80C8CF84  C0 5F 05 B0 */	lfs f2, 0x5b0(r31)
/* 80C8CF88  FC 60 08 90 */	fmr f3, f1
/* 80C8CF8C  4B 37 FE 10 */	b transM__14mDoMtx_stack_cFfff
...
/* 80C8CFAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8CFB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C8CFB4  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C8CFB8  38 84 00 24 */	addi r4, r4, 0x24
/* 80C8CFBC  4B 6B 94 F4 */	b PSMTXCopy
