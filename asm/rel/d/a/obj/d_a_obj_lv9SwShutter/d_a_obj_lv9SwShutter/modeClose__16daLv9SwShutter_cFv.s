...
/* 80C8D478  3C 60 80 C9 */	lis r3, lit_3627@ha /* 0x80C8D7DC@ha */
/* 80C8D47C  3B E3 D7 DC */	addi r31, r3, lit_3627@l /* 0x80C8D7DC@l */
/* 80C8D480  38 7E 05 2C */	addi r3, r30, 0x52c
/* 80C8D484  3C 80 80 C9 */	lis r4, l_HIO@ha /* 0x80C8D91C@ha */
/* 80C8D488  38 84 D9 1C */	addi r4, r4, l_HIO@l /* 0x80C8D91C@l */
/* 80C8D48C  C0 24 00 08 */	lfs f1, 8(r4)
/* 80C8D490  C0 44 00 0C */	lfs f2, 0xc(r4)
/* 80C8D494  4B 5E 32 AD */	bl cLib_chaseF__FPfff
...
/* 80C8D4AC  4B 5E 24 D1 */	bl cLib_addCalc__FPfffff
/* 80C8D4B0  FF E0 08 90 */	fmr f31, f1
/* 80C8D4B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8D4B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8D4BC  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C8D4C0  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C8D4C4  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C8D4C8  4B 37 ED 41 */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C8D4E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8D4E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8D4E8  38 81 00 10 */	addi r4, r1, 0x10
/* 80C8D4EC  7C 85 23 78 */	mr r5, r4
/* 80C8D4F0  4B 6B 98 7D */	bl PSMTXMultVec
/* 80C8D4F4  38 61 00 10 */	addi r3, r1, 0x10
/* 80C8D4F8  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C8D4FC  7C 65 1B 78 */	mr r5, r3
/* 80C8D500  4B 6B 9B 91 */	bl PSVECAdd
/* 80C8D504  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8D508  7C 03 07 74 */	extsb r3, r0
/* 80C8D50C  4B 39 FB 61 */	bl dComIfGp_getReverb__Fi
...
/* 80C8D520  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8D524  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8D54C  4B 61 EF C1 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C8D564  4B 39 FB 09 */	bl dComIfGp_getReverb__Fi
...
/* 80C8D578  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8D57C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8D5A4  4B 61 E3 E1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
