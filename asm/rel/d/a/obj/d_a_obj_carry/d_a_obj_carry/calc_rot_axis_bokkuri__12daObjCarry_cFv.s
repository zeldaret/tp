...
/* 80478204  4B DF 84 CD */	bl cLib_chaseS__FPsss
/* 80478208  2C 03 00 00 */	cmpwi r3, 0
/* 8047820C  41 82 01 90 */	beq lbl_8047839C
/* 80478210  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 80478214  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 8047823C  4B DE E8 F9 */	bl __mi__4cXyzCFRC3Vec
...
/* 8047825C  4B DE EE 51 */	bl isZero__4cXyzCFv
/* 80478260  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80478264  40 82 00 44 */	bne lbl_804782A8
/* 80478268  3C 60 80 43 */	lis r3, BaseX__4cXyz@ha /* 0x80430D0C@ha */
/* 8047826C  C4 03 0D 0C */	lfsu f0, BaseX__4cXyz@l(r3)  /* 0x80430D0C@l */
...
/* 80478284  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80478288  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8047828C  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80478290  4B B9 41 4D */	bl mDoMtx_YrotS__FPA4_fs
/* 80478294  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80478298  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8047829C  38 9F 0C F4 */	addi r4, r31, 0xcf4
/* 804782A0  7C 85 23 78 */	mr r5, r4
/* 804782A4  4B EC EA C9 */	bl PSMTXMultVec
lbl_804782A8:
...
/* 804782CC  3C 60 80 48 */	lis r3, lit_4171@ha /* 0x8047A3AC@ha */
/* 804782D0  C8 23 A3 AC */	lfd f1, lit_4171@l(r3)  /* 0x8047A3AC@l */
...
/* 804782EC  3C 60 80 48 */	lis r3, lit_3958@ha /* 0x8047A384@ha */
/* 804782F0  C0 23 A3 84 */	lfs f1, lit_3958@l(r3)  /* 0x8047A384@l */
...
lbl_80478334:
/* 80478334  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 80478338  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
lbl_8047835C:
/* 8047835C  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 80478360  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 80478380  3C 60 80 48 */	lis r3, lit_3899@ha /* 0x8047A354@ha */
/* 80478384  C0 03 A3 54 */	lfs f0, lit_3899@l(r3)  /* 0x8047A354@l */
