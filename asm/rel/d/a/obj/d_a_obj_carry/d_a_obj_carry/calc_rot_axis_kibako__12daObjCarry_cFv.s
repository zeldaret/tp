...
/* 80478048  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 8047804C  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
lbl_80478070:
/* 80478070  3C 60 80 43 */	lis r3, BaseX__4cXyz@ha /* 0x80430D0C@ha */
/* 80478074  C4 03 0D 0C */	lfsu f0, BaseX__4cXyz@l(r3)  /* 0x80430D0C@l */
...
/* 8047808C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80478090  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80478094  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80478098  4B B9 43 45 */	bl mDoMtx_YrotS__FPA4_fs
/* 8047809C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804780A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804780A4  38 9F 0C F4 */	addi r4, r31, 0xcf4
/* 804780A8  7C 85 23 78 */	mr r5, r4
/* 804780AC  4B EC EC C1 */	bl PSMTXMultVec
/* 804780B0  38 61 00 08 */	addi r3, r1, 8
/* 804780B4  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 804780B8  38 BF 04 BC */	addi r5, r31, 0x4bc
/* 804780BC  4B DE EA 79 */	bl __mi__4cXyzCFRC3Vec
...
/* 804780D8  3C 60 80 48 */	lis r3, lit_4171@ha /* 0x8047A3AC@ha */
/* 804780DC  C8 23 A3 AC */	lfd f1, lit_4171@l(r3)  /* 0x8047A3AC@l */
...
/* 804780F8  3C 60 80 48 */	lis r3, lit_3958@ha /* 0x8047A384@ha */
/* 804780FC  C0 23 A3 84 */	lfs f1, lit_3958@l(r3)  /* 0x8047A384@l */
