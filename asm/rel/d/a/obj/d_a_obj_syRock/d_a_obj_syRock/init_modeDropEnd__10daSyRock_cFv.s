...
/* 80D039A4  3C 60 80 D0 */	lis r3, lit_3807@ha /* 0x80D03FF0@ha */
/* 80D039A8  C0 23 3F F0 */	lfs f1, lit_3807@l(r3)  /* 0x80D03FF0@l */
/* 80D039AC  D0 21 00 08 */	stfs f1, 8(r1)
/* 80D039B0  3C 60 80 D0 */	lis r3, lit_4014@ha /* 0x80D04000@ha */
/* 80D039B4  C0 03 40 00 */	lfs f0, lit_4014@l(r3)  /* 0x80D04000@l */
/* 80D039B8  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80D039BC  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80D039C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D039C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D039C8  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80D039CC  3C 80 80 D0 */	lis r4, l_HIO@ha /* 0x80D0426C@ha */
/* 80D039D0  38 84 42 6C */	addi r4, r4, l_HIO@l /* 0x80D0426C@l */
/* 80D039D4  88 84 00 25 */	lbz r4, 0x25(r4)
/* 80D039D8  38 A0 00 0F */	li r5, 0xf
/* 80D039DC  38 C1 00 08 */	addi r6, r1, 8
/* 80D039E0  4B 36 C0 45 */	bl StartShock__12dVibration_cFii4cXyz
lbl_80D039E4:
/* 80D039E4  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80D039E8  28 04 00 00 */	cmplwi r4, 0
/* 80D039EC  41 82 00 18 */	beq lbl_80D03A04
/* 80D039F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D039F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D039F8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80D039FC  7F E5 FB 78 */	mr r5, r31
/* 80D03A00  4B 37 10 09 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
lbl_80D03A04:
...
/* 80D03A18  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D03A1C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D03A20  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D03A24  7C 05 07 74 */	extsb r5, r0
/* 80D03A28  4B 33 17 D9 */	bl onSwitch__10dSv_info_cFii
