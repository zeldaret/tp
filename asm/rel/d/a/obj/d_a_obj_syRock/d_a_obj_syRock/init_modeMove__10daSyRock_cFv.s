...
/* 80D03504  4B 32 9B 69 */	bl dComIfGp_getReverb__Fi
...
/* 80D03518  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D0351C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D03530  3D 00 80 D0 */	lis r8, lit_4014@ha /* 0x80D04000@ha */
/* 80D03534  C0 28 40 00 */	lfs f1, lit_4014@l(r8)  /* 0x80D04000@l */
/* 80D03538  FC 40 08 90 */	fmr f2, f1
/* 80D0353C  3D 00 80 D0 */	lis r8, lit_4015@ha /* 0x80D04004@ha */
/* 80D03540  C0 68 40 04 */	lfs f3, lit_4015@l(r8)  /* 0x80D04004@l */
/* 80D03544  FC 80 18 90 */	fmr f4, f3
/* 80D03548  39 00 00 00 */	li r8, 0
/* 80D0354C  4B 5A 84 39 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80D03550  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80D03554  28 04 00 00 */	cmplwi r4, 0
/* 80D03558  41 82 00 18 */	beq lbl_80D03570
/* 80D0355C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D03560  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D03564  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80D03568  7F E5 FB 78 */	mr r5, r31
/* 80D0356C  4B 37 14 9D */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
lbl_80D03570:
/* 80D03570  38 00 00 01 */	li r0, 1
/* 80D03574  80 7F 09 94 */	lwz r3, 0x994(r31)
/* 80D03578  98 03 0B 79 */	stb r0, 0xb79(r3)
/* 80D0357C  3C 60 80 D0 */	lis r3, l_HIO@ha /* 0x80D0426C@ha */
/* 80D03580  38 63 42 6C */	addi r3, r3, l_HIO@l /* 0x80D0426C@l */
...
/* 80D035C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D035CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D035D0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D035D4  7C 05 07 74 */	extsb r5, r0
/* 80D035D8  4B 33 1C 29 */	bl onSwitch__10dSv_info_cFii
