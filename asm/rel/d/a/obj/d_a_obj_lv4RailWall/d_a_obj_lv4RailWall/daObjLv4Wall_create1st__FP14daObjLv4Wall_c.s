...
/* 80C61524  4B 70 0C B9 */	bl _savegpr_29
...
/* 80C61544  4B 41 70 E1 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C61548  3C 60 80 C6 */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80C61CD8@ha */
/* 80C6154C  38 03 1C D8 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80C61CD8@l */
...
/* 80C61560  3C 60 80 C6 */	lis r3, __vt__14daObjLv4Wall_c@ha /* 0x80C61CF0@ha */
/* 80C61564  38 63 1C F0 */	addi r3, r3, __vt__14daObjLv4Wall_c@l /* 0x80C61CF0@l */
...
/* 80C6157C  4B 41 4B 25 */	bl __ct__9dBgS_AcchFv
/* 80C61580  3C 60 80 C6 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80C61CB4@ha */
/* 80C61584  38 63 1C B4 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80C61CB4@l */
...
/* 80C615A0  4B 41 78 C9 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80C615A4  38 7E 07 94 */	addi r3, r30, 0x794
/* 80C615A8  4B 41 49 05 */	bl __ct__12dBgS_AcchCirFv
/* 80C615AC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C615B0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C615B4  90 1E 07 EC */	stw r0, 0x7ec(r30)
/* 80C615B8  38 7E 07 F0 */	addi r3, r30, 0x7f0
/* 80C615BC  4B 42 21 A5 */	bl __ct__10dCcD_GSttsFv
/* 80C615C0  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C615C4  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C615DC  4B 42 24 4D */	bl __ct__12dCcD_GObjInfFv
/* 80C615E0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C615E4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C615E8  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80C615EC  3C 60 80 C6 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C61CA8@ha */
/* 80C615F0  38 03 1C A8 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C61CA8@l */
/* 80C615F4  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80C615F8  3C 60 80 C6 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C61C9C@ha */
/* 80C615FC  38 03 1C 9C */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C61C9C@l */
/* 80C61600  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80C61604  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C61608  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80C6160C  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80C61610  38 03 00 58 */	addi r0, r3, 0x58
/* 80C61614  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80C61618  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C6161C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C6164C  4B 70 0B DD */	bl _restgpr_29
