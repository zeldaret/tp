...
/* 80C61960  3C 60 80 C6 */	lis r3, __vt__14daObjLv4Wall_c@ha
/* 80C61964  38 63 1C F0 */	addi r3, r3, __vt__14daObjLv4Wall_c@l
...
/* 80C6197C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80C61980  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80C619A0  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80C619A4  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80C619BC  3C 60 80 C6 */	lis r3, __vt__8cM3dGCyl@ha
/* 80C619C0  38 03 1C 9C */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80C619C4  90 1E 09 48 */	stw r0, 0x948(r30)
lbl_80C619C8:
/* 80C619C8  34 1E 09 14 */	addic. r0, r30, 0x914
/* 80C619CC  41 82 00 24 */	beq lbl_80C619F0
/* 80C619D0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80C619D4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80C619D8  90 1E 09 30 */	stw r0, 0x930(r30)
/* 80C619DC  34 1E 09 14 */	addic. r0, r30, 0x914
/* 80C619E0  41 82 00 10 */	beq lbl_80C619F0
/* 80C619E4  3C 60 80 C6 */	lis r3, __vt__8cM3dGAab@ha
/* 80C619E8  38 03 1C A8 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80C619EC  90 1E 09 2C */	stw r0, 0x92c(r30)
lbl_80C619F0:
/* 80C619F0  38 7E 08 10 */	addi r3, r30, 0x810
/* 80C619F4  38 80 00 00 */	li r4, 0
/* 80C619F8  4B 42 26 EC */	b __dt__12dCcD_GObjInfFv
lbl_80C619FC:
/* 80C619FC  34 1E 07 D4 */	addic. r0, r30, 0x7d4
/* 80C61A00  41 82 00 54 */	beq lbl_80C61A54
/* 80C61A04  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C61A08  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C61A20  3C 60 80 C6 */	lis r3, __vt__10dCcD_GStts@ha
/* 80C61A24  38 03 1C 90 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 80C61A28  90 1E 07 F0 */	stw r0, 0x7f0(r30)
/* 80C61A2C  34 1E 07 F0 */	addic. r0, r30, 0x7f0
/* 80C61A30  41 82 00 10 */	beq lbl_80C61A40
/* 80C61A34  3C 60 80 C6 */	lis r3, __vt__10cCcD_GStts@ha
/* 80C61A38  38 03 1C 84 */	addi r0, r3, __vt__10cCcD_GStts@l
/* 80C61A3C  90 1E 07 F0 */	stw r0, 0x7f0(r30)
lbl_80C61A40:
/* 80C61A40  34 1E 07 D4 */	addic. r0, r30, 0x7d4
/* 80C61A44  41 82 00 10 */	beq lbl_80C61A54
/* 80C61A48  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C61A4C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C61A50  90 1E 07 EC */	stw r0, 0x7ec(r30)
lbl_80C61A54:
/* 80C61A54  34 1E 07 94 */	addic. r0, r30, 0x794
/* 80C61A58  41 82 00 28 */	beq lbl_80C61A80
/* 80C61A5C  3C 60 80 C6 */	lis r3, __vt__12dBgS_AcchCir@ha
/* 80C61A60  38 03 1C 78 */	addi r0, r3, __vt__12dBgS_AcchCir@l
/* 80C61A64  90 1E 07 A0 */	stw r0, 0x7a0(r30)
/* 80C61A68  38 7E 07 A8 */	addi r3, r30, 0x7a8
/* 80C61A6C  38 80 FF FF */	li r4, -1
/* 80C61A70  4B 60 D4 A8 */	b __dt__8cM3dGCirFv
/* 80C61A74  38 7E 07 94 */	addi r3, r30, 0x794
/* 80C61A78  38 80 00 00 */	li r4, 0
/* 80C61A7C  4B 60 66 34 */	b __dt__13cBgS_PolyInfoFv
lbl_80C61A80:
/* 80C61A80  34 1E 05 BC */	addic. r0, r30, 0x5bc
/* 80C61A84  41 82 00 2C */	beq lbl_80C61AB0
/* 80C61A88  3C 60 80 C6 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80C61A8C  38 63 1C B4 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
