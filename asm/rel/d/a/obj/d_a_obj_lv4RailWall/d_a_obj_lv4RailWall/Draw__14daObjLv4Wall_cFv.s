...
/* 80C61454  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C61458  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C6145C  38 80 00 10 */	li r4, 0x10
/* 80C61460  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C61464  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C61468  4B 54 23 5D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C6146C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C61470  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C61474  80 9E 05 B8 */	lwz r4, 0x5b8(r30)
/* 80C61478  80 84 00 04 */	lwz r4, 4(r4)
/* 80C6147C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C61480  4B 54 39 21 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C61484  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C61488  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C6148C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C61490  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C61494  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C614A8  4B 3A C8 1D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C614AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C614B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
