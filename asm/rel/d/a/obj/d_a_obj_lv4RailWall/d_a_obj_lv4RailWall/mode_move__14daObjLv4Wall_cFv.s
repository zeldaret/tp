...
/* 80C61080  4B 70 11 5D */	bl _savegpr_29
/* 80C61084  7C 7E 1B 78 */	mr r30, r3
/* 80C61088  3C 60 80 C6 */	lis r3, lit_3709@ha /* 0x80C61B38@ha */
/* 80C6108C  3B E3 1B 38 */	addi r31, r3, lit_3709@l /* 0x80C61B38@l */
...
/* 80C61114  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C61118  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C6112C  4B 40 E9 E5 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 80C61168  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C6116C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C61180  4B 40 E9 91 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 80C611B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C611BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C611D0  4B 40 E9 41 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 80C61208  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C6120C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C61220  4B 40 E8 F1 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 80C61258  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C6125C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C61270  4B 40 E8 A1 */	bl StartQuake__12dVibration_cFii4cXyz
lbl_80C61274:
/* 80C61274  2C 1D 00 00 */	cmpwi r29, 0
/* 80C61278  41 82 00 B4 */	beq lbl_80C6132C
/* 80C6127C  3C 60 80 C6 */	lis r3, s_BossSearch__FPvPv@ha /* 0x80C60A78@ha */
/* 80C61280  38 63 0A 78 */	addi r3, r3, s_BossSearch__FPvPv@l /* 0x80C60A78@l */
/* 80C61284  7F C4 F3 78 */	mr r4, r30
/* 80C61288  4B 3C 00 B1 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80C6129C  4B 3C BD D1 */	bl dComIfGp_getReverb__Fi
...
/* 80C612B0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C612B4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C612DC  4B 64 A6 A9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C612E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C612E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C612E8  3B A3 5B D4 */	addi r29, r3, 0x5bd4
/* 80C612EC  7F A3 EB 78 */	mr r3, r29
/* 80C612F0  38 80 00 1F */	li r4, 0x1f
/* 80C612F4  4B 40 EA A1 */	bl StopQuake__12dVibration_cFi
...
/* 80C6131C  4B 40 E7 09 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 80C6135C  4B 3C BD 11 */	bl dComIfGp_getReverb__Fi
...
/* 80C61370  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C61374  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
