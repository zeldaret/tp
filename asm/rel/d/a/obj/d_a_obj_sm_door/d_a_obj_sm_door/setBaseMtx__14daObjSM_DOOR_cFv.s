...
/* 80CD8C98  4B 33 40 CD */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80CD8C9C  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80CD8CA0  4B 33 42 A5 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CD8CA4  88 1F 05 A0 */	lbz r0, 0x5a0(r31)
/* 80CD8CA8  28 00 00 00 */	cmplwi r0, 0
/* 80CD8CAC  40 82 00 1C */	bne lbl_80CD8CC8
/* 80CD8CB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CD8CB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CD8CB8  80 9F 05 CC */	lwz r4, 0x5cc(r31)
/* 80CD8CBC  38 84 00 24 */	addi r4, r4, 0x24
/* 80CD8CC0  4B 66 D7 F1 */	bl PSMTXCopy
/* 80CD8CC4  48 00 00 18 */	b lbl_80CD8CDC
lbl_80CD8CC8:
/* 80CD8CC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CD8CCC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CD8CD0  80 9F 05 D0 */	lwz r4, 0x5d0(r31)
/* 80CD8CD4  38 84 00 24 */	addi r4, r4, 0x24
/* 80CD8CD8  4B 66 D7 D9 */	bl PSMTXCopy
lbl_80CD8CDC:
/* 80CD8CDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CD8CE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CD8CE4  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80CD8CE8  4B 66 D7 C9 */	bl PSMTXCopy
