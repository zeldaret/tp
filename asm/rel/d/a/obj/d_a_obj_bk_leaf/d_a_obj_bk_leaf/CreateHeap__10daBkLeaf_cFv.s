...
/* 80BB62AC  4B 7A BF 31 */	bl _savegpr_29
/* 80BB62B0  7C 7D 1B 78 */	mr r29, r3
/* 80BB62B4  3C 60 80 BB */	lis r3, cNullVec__6Z2Calc@ha /* 0x80BB6738@ha */
/* 80BB62B8  3B E3 67 38 */	addi r31, r3, cNullVec__6Z2Calc@l /* 0x80BB6738@l */
/* 80BB62BC  80 7F 00 20 */	lwz r3, 0x20(r31)
/* 80BB62C0  80 9F 00 24 */	lwz r4, 0x24(r31)
/* 80BB62C4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BB62C8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BB62DC  4B 48 60 A1 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80BB62EC  4B 45 E9 69 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80BB6318  4B 48 60 65 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80BB631C  7C 7E 1B 78 */	mr r30, r3
/* 80BB6320  38 60 00 1C */	li r3, 0x1c
/* 80BB6324  4B 71 89 29 */	bl __nw__FUl
/* 80BB6328  7C 7F 1B 79 */	or. r31, r3, r3
/* 80BB632C  41 82 00 20 */	beq lbl_80BB634C
/* 80BB6330  3C 80 80 BB */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80BB67B4@ha */
/* 80BB6334  38 04 67 B4 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80BB67B4@l */
/* 80BB6338  90 1F 00 00 */	stw r0, 0(r31)
/* 80BB633C  38 80 00 00 */	li r4, 0
/* 80BB6340  4B 77 20 BD */	bl init__12J3DFrameCtrlFs
...
/* 80BB6368  3C E0 80 BB */	lis r7, lit_3742@ha /* 0x80BB6710@ha */
/* 80BB636C  C0 27 67 10 */	lfs f1, lit_3742@l(r7)  /* 0x80BB6710@l */
/* 80BB6370  38 E0 00 00 */	li r7, 0
/* 80BB6374  39 00 FF FF */	li r8, -1
/* 80BB6378  39 20 00 00 */	li r9, 0
/* 80BB637C  4B 45 74 61 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80BB6398  4B 7A BE 91 */	bl _restgpr_29
