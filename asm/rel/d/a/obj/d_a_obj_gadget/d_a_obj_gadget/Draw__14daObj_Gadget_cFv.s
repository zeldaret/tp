...
/* 80BF3FC4  3C 60 80 BF */	lis r3, m__20daObj_Gadget_Param_c@ha /* 0x80BF4944@ha */
/* 80BF3FC8  3B E3 49 44 */	addi r31, r3, m__20daObj_Gadget_Param_c@l /* 0x80BF4944@l */
/* 80BF3FCC  88 1E 0A 44 */	lbz r0, 0xa44(r30)
/* 80BF3FD0  28 00 00 00 */	cmplwi r0, 0
/* 80BF3FD4  40 82 00 F8 */	bne lbl_80BF40CC
/* 80BF3FD8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BF3FDC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BF3FE0  38 80 00 00 */	li r4, 0
/* 80BF3FE4  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BF3FE8  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BF3FEC  4B 5A F7 D9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BF3FF0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BF3FF4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BF3FF8  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80BF3FFC  80 84 00 04 */	lwz r4, 4(r4)
/* 80BF4000  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BF4004  4B 5B 0D 9D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BF4008  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80BF400C  4B 41 9C B9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80BF4010  38 00 00 00 */	li r0, 0
/* 80BF4014  90 01 00 08 */	stw r0, 8(r1)
/* 80BF4018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF401C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BF4038  4B 42 59 85 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80BF4064  3C 60 80 BF */	lis r3, __vt__8cM3dGPla@ha /* 0x80BF4B00@ha */
/* 80BF4068  38 03 4B 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80BF4B00@l */
/* 80BF406C  90 01 00 1C */	stw r0, 0x1c(r1)
/* 80BF4070  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF4074  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BF4078  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80BF407C  38 9E 07 E0 */	addi r4, r30, 0x7e0
/* 80BF4080  38 A1 00 0C */	addi r5, r1, 0xc
/* 80BF4084  4B 48 06 C1 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80BF4088  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BF408C  41 82 00 34 */	beq lbl_80BF40C0
/* 80BF4090  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF4094  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BF40B4  3C E0 80 42 */	lis r7, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80BF40B8  38 E7 48 D0 */	addi r7, r7, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80BF40BC  4B 46 1E C9 */	bl setSimple__21dDlst_shadowControl_cFP4cXyzffP4cXyzsfP9_GXTexObj
lbl_80BF40C0:
/* 80BF40C0  3C 60 80 BF */	lis r3, __vt__8cM3dGPla@ha /* 0x80BF4B00@ha */
/* 80BF40C4  38 03 4B 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80BF4B00@l */
