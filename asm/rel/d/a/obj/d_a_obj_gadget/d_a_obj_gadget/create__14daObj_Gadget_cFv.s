...
/* 80BF2F38  4B 76 F2 9D */	bl _savegpr_27
/* 80BF2F3C  7C 7C 1B 78 */	mr r28, r3
/* 80BF2F40  3C 80 80 BF */	lis r4, cNullVec__6Z2Calc@ha /* 0x80BF4A2C@ha */
/* 80BF2F44  3B C4 4A 2C */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x80BF4A2C@l */
/* 80BF2F48  3C 80 80 BF */	lis r4, m__20daObj_Gadget_Param_c@ha /* 0x80BF4944@ha */
/* 80BF2F4C  3B E4 49 44 */	addi r31, r4, m__20daObj_Gadget_Param_c@l /* 0x80BF4944@l */
...
/* 80BF2F68  4B 42 5B FD */	bl __ct__10fopAc_ac_cFv
/* 80BF2F6C  3C 60 80 BF */	lis r3, __vt__14daObj_Gadget_c@ha /* 0x80BF4B78@ha */
/* 80BF2F70  38 03 4B 78 */	addi r0, r3, __vt__14daObj_Gadget_c@l /* 0x80BF4B78@l */
/* 80BF2F74  90 1D 0A 48 */	stw r0, 0xa48(r29)
/* 80BF2F78  3B 7D 05 78 */	addi r27, r29, 0x578
/* 80BF2F7C  7F 63 DB 78 */	mr r3, r27
/* 80BF2F80  4B 48 31 21 */	bl __ct__9dBgS_AcchFv
/* 80BF2F84  3C 60 80 BF */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80BF4B0C@ha */
/* 80BF2F88  38 63 4B 0C */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80BF4B0C@l */
...
/* 80BF2FA4  4B 48 5E C5 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80BF2FA8  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BF2FAC  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BF2FB0  90 1D 07 68 */	stw r0, 0x768(r29)
/* 80BF2FB4  38 7D 07 6C */	addi r3, r29, 0x76c
/* 80BF2FB8  4B 49 07 A9 */	bl __ct__10dCcD_GSttsFv
/* 80BF2FBC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BF2FC0  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BF2FD4  4B 48 2E D9 */	bl __ct__12dBgS_AcchCirFv
/* 80BF2FD8  38 7D 07 CC */	addi r3, r29, 0x7cc
/* 80BF2FDC  4B 67 4C 41 */	bl __ct__11cBgS_GndChkFv
/* 80BF2FE0  3B 7D 08 08 */	addi r27, r29, 0x808
/* 80BF2FE4  7F 63 DB 78 */	mr r3, r27
/* 80BF2FE8  4B 49 0A 41 */	bl __ct__12dCcD_GObjInfFv
/* 80BF2FEC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BF2FF0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BF2FF4  90 1B 01 20 */	stw r0, 0x120(r27)
/* 80BF2FF8  3C 60 80 BF */	lis r3, __vt__8cM3dGAab@ha /* 0x80BF4B54@ha */
/* 80BF2FFC  38 03 4B 54 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BF4B54@l */
/* 80BF3000  90 1B 01 1C */	stw r0, 0x11c(r27)
/* 80BF3004  3C 60 80 BF */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BF4B60@ha */
/* 80BF3008  38 03 4B 60 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BF4B60@l */
/* 80BF300C  90 1B 01 38 */	stw r0, 0x138(r27)
/* 80BF3010  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BF3014  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80BF3018  90 7B 01 20 */	stw r3, 0x120(r27)
/* 80BF301C  38 03 00 58 */	addi r0, r3, 0x58
/* 80BF3020  90 1B 01 38 */	stw r0, 0x138(r27)
/* 80BF3024  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BF3028  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80BF3040  3C 60 80 BF */	lis r3, __vt__8cM3dGLin@ha /* 0x80BF4B6C@ha */
/* 80BF3044  38 03 4B 6C */	addi r0, r3, __vt__8cM3dGLin@l /* 0x80BF4B6C@l */
/* 80BF3048  90 1D 09 5C */	stw r0, 0x95c(r29)
/* 80BF304C  38 7D 09 60 */	addi r3, r29, 0x960
/* 80BF3050  4B 48 4C 19 */	bl __ct__11dBgS_LinChkFv
lbl_80BF3054:
...
/* 80BF308C  4B 43 9E 31 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BF30A0  3C 80 80 BF */	lis r4, createHeapCallBack__14daObj_Gadget_cFP10fopAc_ac_c@ha /* 0x80BF4130@ha */
/* 80BF30A4  38 84 41 30 */	addi r4, r4, createHeapCallBack__14daObj_Gadget_cFP10fopAc_ac_c@l /* 0x80BF4130@l */
/* 80BF30A8  38 A0 00 00 */	li r5, 0
/* 80BF30AC  4B 42 74 05 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80BF30E8  4B 42 74 61 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80BF3114  4B 48 31 35 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80BF3138  4B 49 07 29 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80BF313C  38 7C 08 08 */	addi r3, r28, 0x808
/* 80BF3140  38 9E 00 38 */	addi r4, r30, 0x38
/* 80BF3144  4B 49 17 71 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
/* 80BF3148  38 1C 07 50 */	addi r0, r28, 0x750
/* 80BF314C  90 1C 08 4C */	stw r0, 0x84c(r28)
/* 80BF3150  38 7C 05 78 */	addi r3, r28, 0x578
/* 80BF3154  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF3158  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BF315C  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80BF3160  4B 48 39 4D */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80BF3214  4B 76 F0 0D */	bl _restgpr_27
