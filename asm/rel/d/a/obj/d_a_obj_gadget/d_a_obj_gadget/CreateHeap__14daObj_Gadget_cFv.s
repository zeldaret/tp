...
/* 80BF3494  3C 60 80 BF */	lis r3, l_bmdData@ha /* 0x80BF4A4C@ha */
/* 80BF3498  38 83 4A 4C */	addi r4, r3, l_bmdData@l /* 0x80BF4A4C@l */
/* 80BF349C  7C 64 2A 14 */	add r3, r4, r5
/* 80BF34A0  80 03 00 04 */	lwz r0, 4(r3)
/* 80BF34A4  54 00 10 3A */	slwi r0, r0, 2
/* 80BF34A8  3C 60 80 BF */	lis r3, l_resNameList@ha /* 0x80BF4A5C@ha */
/* 80BF34AC  38 63 4A 5C */	addi r3, r3, l_resNameList@l /* 0x80BF4A5C@l */
/* 80BF34B0  7C 63 00 2E */	lwzx r3, r3, r0
/* 80BF34B4  7C 84 28 2E */	lwzx r4, r4, r5
/* 80BF34B8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF34BC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BF34C0  3C A5 00 02 */	addis r5, r5, 2
/* 80BF34C4  38 C0 00 80 */	li r6, 0x80
/* 80BF34C8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BF34CC  4B 44 8E 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BF34DC  4B 42 17 79 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
