...
/* 80BF2D4C  3C 60 80 BF */	lis r3, __vt__14daObj_Gadget_c@ha /* 0x80BF4B78@ha */
/* 80BF2D50  38 03 4B 78 */	addi r0, r3, __vt__14daObj_Gadget_c@l /* 0x80BF4B78@l */
/* 80BF2D54  90 1E 0A 48 */	stw r0, 0xa48(r30)
/* 80BF2D58  38 7E 05 6C */	addi r3, r30, 0x56c
/* 80BF2D5C  3C 80 80 BF */	lis r4, l_bmdData@ha /* 0x80BF4A4C@ha */
/* 80BF2D60  38 84 4A 4C */	addi r4, r4, l_bmdData@l /* 0x80BF4A4C@l */
...
/* 80BF2D78  3C 80 80 BF */	lis r4, l_resNameList@ha /* 0x80BF4A5C@ha */
/* 80BF2D7C  38 84 4A 5C */	addi r4, r4, l_resNameList@l /* 0x80BF4A5C@l */
/* 80BF2D80  7C 84 00 2E */	lwzx r4, r4, r0
/* 80BF2D84  4B 43 A2 85 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80BF2D88  38 7E 09 60 */	addi r3, r30, 0x960
/* 80BF2D8C  38 80 FF FF */	li r4, -1
/* 80BF2D90  4B 48 4F 4D */	bl __dt__11dBgS_LinChkFv
/* 80BF2D94  34 1E 09 44 */	addic. r0, r30, 0x944
/* 80BF2D98  41 82 00 10 */	beq lbl_80BF2DA8
/* 80BF2D9C  3C 60 80 BF */	lis r3, __vt__8cM3dGLin@ha /* 0x80BF4B6C@ha */
/* 80BF2DA0  38 03 4B 6C */	addi r0, r3, __vt__8cM3dGLin@l /* 0x80BF4B6C@l */
/* 80BF2DA4  90 1E 09 5C */	stw r0, 0x95c(r30)
lbl_80BF2DA8:
/* 80BF2DA8  34 1E 08 08 */	addic. r0, r30, 0x808
/* 80BF2DAC  41 82 00 84 */	beq lbl_80BF2E30
/* 80BF2DB0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BF2DB4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80BF2DD4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BF2DD8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80BF2DF0  3C 60 80 BF */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BF4B60@ha */
/* 80BF2DF4  38 03 4B 60 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BF4B60@l */
/* 80BF2DF8  90 1E 09 40 */	stw r0, 0x940(r30)
lbl_80BF2DFC:
/* 80BF2DFC  34 1E 09 0C */	addic. r0, r30, 0x90c
/* 80BF2E00  41 82 00 24 */	beq lbl_80BF2E24
/* 80BF2E04  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BF2E08  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BF2E0C  90 1E 09 28 */	stw r0, 0x928(r30)
/* 80BF2E10  34 1E 09 0C */	addic. r0, r30, 0x90c
/* 80BF2E14  41 82 00 10 */	beq lbl_80BF2E24
/* 80BF2E18  3C 60 80 BF */	lis r3, __vt__8cM3dGAab@ha /* 0x80BF4B54@ha */
/* 80BF2E1C  38 03 4B 54 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BF4B54@l */
/* 80BF2E20  90 1E 09 24 */	stw r0, 0x924(r30)
lbl_80BF2E24:
/* 80BF2E24  38 7E 08 08 */	addi r3, r30, 0x808
/* 80BF2E28  38 80 00 00 */	li r4, 0
/* 80BF2E2C  4B 49 12 B9 */	bl __dt__12dCcD_GObjInfFv
lbl_80BF2E30:
/* 80BF2E30  38 7E 07 CC */	addi r3, r30, 0x7cc
/* 80BF2E34  38 80 FF FF */	li r4, -1
/* 80BF2E38  4B 67 4E 5D */	bl __dt__11cBgS_GndChkFv
/* 80BF2E3C  34 1E 07 8C */	addic. r0, r30, 0x78c
/* 80BF2E40  41 82 00 28 */	beq lbl_80BF2E68
/* 80BF2E44  3C 60 80 BF */	lis r3, __vt__12dBgS_AcchCir@ha /* 0x80BF4B48@ha */
/* 80BF2E48  38 03 4B 48 */	addi r0, r3, __vt__12dBgS_AcchCir@l /* 0x80BF4B48@l */
/* 80BF2E4C  90 1E 07 98 */	stw r0, 0x798(r30)
/* 80BF2E50  38 7E 07 A0 */	addi r3, r30, 0x7a0
/* 80BF2E54  38 80 FF FF */	li r4, -1
/* 80BF2E58  4B 67 C0 C1 */	bl __dt__8cM3dGCirFv
/* 80BF2E5C  38 7E 07 8C */	addi r3, r30, 0x78c
/* 80BF2E60  38 80 00 00 */	li r4, 0
/* 80BF2E64  4B 67 52 4D */	bl __dt__13cBgS_PolyInfoFv
lbl_80BF2E68:
/* 80BF2E68  34 1E 07 50 */	addic. r0, r30, 0x750
/* 80BF2E6C  41 82 00 54 */	beq lbl_80BF2EC0
/* 80BF2E70  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BF2E74  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BF2E8C  3C 60 80 BF */	lis r3, __vt__10dCcD_GStts@ha /* 0x80BF4B3C@ha */
/* 80BF2E90  38 03 4B 3C */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x80BF4B3C@l */
/* 80BF2E94  90 1E 07 6C */	stw r0, 0x76c(r30)
/* 80BF2E98  34 1E 07 6C */	addic. r0, r30, 0x76c
/* 80BF2E9C  41 82 00 10 */	beq lbl_80BF2EAC
/* 80BF2EA0  3C 60 80 BF */	lis r3, __vt__10cCcD_GStts@ha /* 0x80BF4B30@ha */
/* 80BF2EA4  38 03 4B 30 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x80BF4B30@l */
/* 80BF2EA8  90 1E 07 6C */	stw r0, 0x76c(r30)
lbl_80BF2EAC:
/* 80BF2EAC  34 1E 07 50 */	addic. r0, r30, 0x750
/* 80BF2EB0  41 82 00 10 */	beq lbl_80BF2EC0
/* 80BF2EB4  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BF2EB8  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BF2EBC  90 1E 07 68 */	stw r0, 0x768(r30)
lbl_80BF2EC0:
/* 80BF2EC0  34 1E 05 78 */	addic. r0, r30, 0x578
/* 80BF2EC4  41 82 00 2C */	beq lbl_80BF2EF0
/* 80BF2EC8  3C 60 80 BF */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80BF4B0C@ha */
/* 80BF2ECC  38 63 4B 0C */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80BF4B0C@l */
