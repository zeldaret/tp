...
/* 80C2FDAC  3C 60 80 C3 */	lis r3, lit_3774@ha /* 0x80C3114C@ha */
/* 80C2FDB0  3B C3 11 4C */	addi r30, r3, lit_3774@l /* 0x80C3114C@l */
/* 80C2FDB4  80 1F 08 3C */	lwz r0, 0x83c(r31)
/* 80C2FDB8  2C 00 00 00 */	cmpwi r0, 0
/* 80C2FDBC  40 82 00 78 */	bne lbl_80C2FE34
/* 80C2FDC0  3C 60 80 C3 */	lis r3, d_a_obj_kag__stringBase0@ha /* 0x80C31260@ha */
/* 80C2FDC4  38 63 12 60 */	addi r3, r3, d_a_obj_kag__stringBase0@l /* 0x80C31260@l */
/* 80C2FDC8  38 80 00 06 */	li r4, 6
/* 80C2FDCC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C2FDD0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C2FDD4  3C A5 00 02 */	addis r5, r5, 2
/* 80C2FDD8  38 C0 00 80 */	li r6, 0x80
/* 80C2FDDC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C2FDE0  4B 40 C5 0D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2FE00  4B 3E 10 71 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C2FE48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C2FE4C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C2FE60  3C 60 80 C3 */	lis r3, d_a_obj_kag__stringBase0@ha /* 0x80C31260@ha */
/* 80C2FE64  38 63 12 60 */	addi r3, r3, d_a_obj_kag__stringBase0@l /* 0x80C31260@l */
/* 80C2FE68  38 63 00 06 */	addi r3, r3, 6
/* 80C2FE6C  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C2FE70  4B 73 8B 25 */	bl strcmp
/* 80C2FE74  2C 03 00 00 */	cmpwi r3, 0
/* 80C2FE78  40 82 00 54 */	bne lbl_80C2FECC
/* 80C2FE7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C2FE80  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C2FE9C  3C 60 80 C3 */	lis r3, lit_4476@ha /* 0x80C3130C@ha */
/* 80C2FEA0  38 83 13 0C */	addi r4, r3, lit_4476@l /* 0x80C3130C@l */
...
lbl_80C2FECC:
/* 80C2FECC  3C 60 80 C3 */	lis r3, lit_4479@ha /* 0x80C31318@ha */
/* 80C2FED0  38 83 13 18 */	addi r4, r3, lit_4479@l /* 0x80C31318@l */
