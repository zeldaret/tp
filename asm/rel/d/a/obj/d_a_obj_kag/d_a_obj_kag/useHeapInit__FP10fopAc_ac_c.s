...
/* 80C2E4E8  4B 73 3C ED */	bl _savegpr_27
/* 80C2E4EC  7C 7F 1B 78 */	mr r31, r3
/* 80C2E4F0  3C 60 80 C3 */	lis r3, lit_3774@ha /* 0x80C3114C@ha */
/* 80C2E4F4  3B C3 11 4C */	addi r30, r3, lit_3774@l /* 0x80C3114C@l */
/* 80C2E4F8  3C 60 80 C3 */	lis r3, d_a_obj_kag__stringBase0@ha /* 0x80C31260@ha */
/* 80C2E4FC  38 63 12 60 */	addi r3, r3, d_a_obj_kag__stringBase0@l /* 0x80C31260@l */
/* 80C2E500  38 80 00 0A */	li r4, 0xa
/* 80C2E504  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C2E508  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C2E51C  4B 40 DD D1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C2E520  7C 7B 1B 78 */	mr r27, r3
/* 80C2E524  38 60 00 58 */	li r3, 0x58
/* 80C2E528  4B 6A 07 25 */	bl __nw__FUl
/* 80C2E52C  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C2E530  41 82 00 64 */	beq lbl_80C2E594
/* 80C2E534  3C 60 80 C3 */	lis r3, d_a_obj_kag__stringBase0@ha /* 0x80C31260@ha */
/* 80C2E538  38 63 12 60 */	addi r3, r3, d_a_obj_kag__stringBase0@l /* 0x80C31260@l */
/* 80C2E53C  38 80 00 06 */	li r4, 6
/* 80C2E540  7F A5 EB 78 */	mr r5, r29
/* 80C2E544  38 C0 00 80 */	li r6, 0x80
/* 80C2E548  4B 40 DD A5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2E58C  4B 3E 22 45 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80C2E5BC  4B 6A 06 91 */	bl __nw__FUl
/* 80C2E5C0  7C 7B 1B 79 */	or. r27, r3, r3
/* 80C2E5C4  41 82 00 20 */	beq lbl_80C2E5E4
/* 80C2E5C8  3C 80 80 C3 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C31410@ha */
/* 80C2E5CC  38 04 14 10 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C31410@l */
/* 80C2E5D0  90 1B 00 00 */	stw r0, 0(r27)
/* 80C2E5D4  38 80 00 00 */	li r4, 0
/* 80C2E5D8  4B 6F 9E 25 */	bl init__12J3DFrameCtrlFs
...
lbl_80C2E5FC:
/* 80C2E5FC  3C 60 80 C3 */	lis r3, d_a_obj_kag__stringBase0@ha /* 0x80C31260@ha */
/* 80C2E600  38 63 12 60 */	addi r3, r3, d_a_obj_kag__stringBase0@l /* 0x80C31260@l */
...
/* 80C2E61C  4B 40 DC D1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2E644  4B 3D F0 C9 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C2E65C  4B 6A 05 F1 */	bl __nw__FUl
/* 80C2E660  7C 7B 1B 79 */	or. r27, r3, r3
/* 80C2E664  41 82 00 20 */	beq lbl_80C2E684
/* 80C2E668  3C 80 80 C3 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C31410@ha */
/* 80C2E66C  38 04 14 10 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C31410@l */
/* 80C2E670  90 1B 00 00 */	stw r0, 0(r27)
/* 80C2E674  38 80 00 00 */	li r4, 0
/* 80C2E678  4B 6F 9D 85 */	bl init__12J3DFrameCtrlFs
...
lbl_80C2E69C:
/* 80C2E69C  3C 60 80 C3 */	lis r3, d_a_obj_kag__stringBase0@ha /* 0x80C31260@ha */
/* 80C2E6A0  38 63 12 60 */	addi r3, r3, d_a_obj_kag__stringBase0@l /* 0x80C31260@l */
...
/* 80C2E6BC  4B 40 DC 31 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2E6E4  4B 3D EF 59 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C2E700  4B 73 3B 21 */	bl _restgpr_27
