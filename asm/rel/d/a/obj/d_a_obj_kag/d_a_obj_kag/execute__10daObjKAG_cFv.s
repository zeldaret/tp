...
/* 80C3056C  3C 60 80 C3 */	lis r3, lit_4714@ha /* 0x80C3123C@ha */
/* 80C30570  C0 43 12 3C */	lfs f2, lit_4714@l(r3)  /* 0x80C3123C@l */
/* 80C30574  80 1F 05 78 */	lwz r0, 0x578(r31)
/* 80C30578  3C 60 80 C3 */	lis r3, lit_4716@ha /* 0x80C31244@ha */
/* 80C3057C  C8 23 12 44 */	lfd f1, lit_4716@l(r3)  /* 0x80C31244@l */
...
/* 80C305CC  4B 52 DA AD */	bl Insect_GetDemoMain__9dInsect_cFv
...
/* 80C30674  4B 63 EF D5 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80C30678  38 7F 07 E8 */	addi r3, r31, 0x7e8
/* 80C3067C  3C 80 80 C3 */	lis r4, lit_4460@ha /* 0x80C31208@ha */
/* 80C30680  C0 24 12 08 */	lfs f1, lit_4460@l(r4)  /* 0x80C31208@l */
/* 80C30684  C0 1F 04 EC */	lfs f0, 0x4ec(r31)
/* 80C30688  EC 21 00 32 */	fmuls f1, f1, f0
/* 80C3068C  4B 63 F0 7D */	bl SetR__8cM3dGSphFf
/* 80C30690  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C30694  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C30698  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C3069C  38 9F 06 C4 */	addi r4, r31, 0x6c4
/* 80C306A0  4B 63 45 09 */	bl Set__4cCcSFP8cCcD_Obj
