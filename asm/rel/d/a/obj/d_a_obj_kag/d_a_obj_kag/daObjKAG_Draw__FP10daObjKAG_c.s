...
/* 80C307E4  4B 73 19 F9 */	bl _savegpr_29
/* 80C307E8  7C 7D 1B 78 */	mr r29, r3
/* 80C307EC  3C 80 80 C3 */	lis r4, lit_3774@ha /* 0x80C3114C@ha */
/* 80C307F0  3B E4 11 4C */	addi r31, r4, lit_3774@l /* 0x80C3114C@l */
...
/* 80C30804  4B 52 DA 69 */	bl CalcZBuffer__9dInsect_cFf
/* 80C30808  80 7D 06 28 */	lwz r3, 0x628(r29)
/* 80C3080C  83 C3 00 04 */	lwz r30, 4(r3)
/* 80C30810  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C30814  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C30818  38 80 00 00 */	li r4, 0
/* 80C3081C  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80C30820  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80C30824  4B 57 2F A1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C30828  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C3082C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C30830  80 9E 00 04 */	lwz r4, 4(r30)
/* 80C30834  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80C30838  4B 57 45 69 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C3084C  4B 3D CE 8D */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C30860  4B 3D CF 49 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80C30878  4B 3E CB B5 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 80C3087C  80 7D 06 28 */	lwz r3, 0x628(r29)
/* 80C30880  4B 3E 09 41 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 80C308A8  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80C308AC  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80C308B0  4B 3F C8 05 */	bl dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80C308B4:
/* 80C308B4  38 60 00 01 */	li r3, 1
/* 80C308B8  39 61 00 20 */	addi r11, r1, 0x20
/* 80C308BC  4B 73 19 6D */	bl _restgpr_29
