...
/* 80CB9F5C  4B 6A 82 80 */	b _savegpr_29
/* 80CB9F60  7C 7F 1B 78 */	mr r31, r3
/* 80CB9F64  3C 60 80 CC */	lis r3, l_cull_box@ha
/* 80CB9F68  3B C3 C3 68 */	addi r30, r3, l_cull_box@l
/* 80CB9F6C  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80CB9F70  4B 35 2D F4 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CB9F74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB9F78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB9F7C  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CB9F80  4B 35 24 B4 */	b mDoMtx_YrotM__FPA4_fs
/* 80CB9F84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB9F88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB9F8C  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80CB9F90  38 84 00 24 */	addi r4, r4, 0x24
/* 80CB9F94  4B 68 C5 1C */	b PSMTXCopy
...
/* 80CB9FBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB9FC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB9FC4  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CB9FC8  4B 35 24 14 */	b mDoMtx_YrotS__FPA4_fs
/* 80CB9FCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB9FD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB9FD4  38 81 00 5C */	addi r4, r1, 0x5c
/* 80CB9FD8  7C 85 23 78 */	mr r5, r4
/* 80CB9FDC  4B 68 CD 90 */	b PSMTXMultVec
/* 80CB9FE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CB9FE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CB9FE8  38 81 00 50 */	addi r4, r1, 0x50
/* 80CB9FEC  7C 85 23 78 */	mr r5, r4
/* 80CB9FF0  4B 68 CD 7C */	b PSMTXMultVec
/* 80CB9FF4  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80CB9FF8  4B 35 2D 6C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CB9FFC  38 61 00 5C */	addi r3, r1, 0x5c
/* 80CBA000  4B 35 2D D4 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80CBA004  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA008  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA00C  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CBA010  4B 35 24 24 */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA014  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA018  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA01C  A8 9F 0B 76 */	lha r4, 0xb76(r31)
/* 80CBA020  4B 35 24 14 */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA024  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA028  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA02C  38 9F 0C 30 */	addi r4, r31, 0xc30
/* 80CBA030  4B 68 C4 80 */	b PSMTXCopy
/* 80CBA034  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA038  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA03C  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80CBA040  4B 68 C4 70 */	b PSMTXCopy
/* 80CBA044  38 61 00 14 */	addi r3, r1, 0x14
/* 80CBA048  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80CBA04C  38 A1 00 5C */	addi r5, r1, 0x5c
/* 80CBA050  4B 5A CA 94 */	b __pl__4cXyzCFRC3Vec
...
/* 80CBA070  4B 35 2C F4 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CBA074  38 61 00 50 */	addi r3, r1, 0x50
/* 80CBA078  4B 35 2D 5C */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80CBA07C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA080  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA084  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CBA088  4B 35 23 AC */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA08C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA090  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA094  38 80 7F FF */	li r4, 0x7fff
/* 80CBA098  4B 35 23 9C */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA09C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA0A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA0A4  A8 9F 0B 74 */	lha r4, 0xb74(r31)
/* 80CBA0A8  4B 35 23 8C */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA0AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA0B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA0B4  38 9F 0C 00 */	addi r4, r31, 0xc00
/* 80CBA0B8  4B 68 C3 F8 */	b PSMTXCopy
/* 80CBA0BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA0C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA0C4  38 9F 0A E4 */	addi r4, r31, 0xae4
/* 80CBA0C8  4B 68 C3 E8 */	b PSMTXCopy
...
/* 80CBA10C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA110  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA114  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CBA118  4B 35 22 C4 */	b mDoMtx_YrotS__FPA4_fs
/* 80CBA11C  C0 3E 00 68 */	lfs f1, 0x68(r30)
/* 80CBA120  C0 5E 00 5C */	lfs f2, 0x5c(r30)
/* 80CBA124  FC 60 10 90 */	fmr f3, f2
/* 80CBA128  4B 35 2C 74 */	b transM__14mDoMtx_stack_cFfff
/* 80CBA12C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA130  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA134  A8 9F 0B 76 */	lha r4, 0xb76(r31)
/* 80CBA138  4B 35 22 FC */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA13C  C0 3E 00 6C */	lfs f1, 0x6c(r30)
/* 80CBA140  C0 5E 00 5C */	lfs f2, 0x5c(r30)
/* 80CBA144  FC 60 10 90 */	fmr f3, f2
/* 80CBA148  4B 35 2C 54 */	b transM__14mDoMtx_stack_cFfff
/* 80CBA14C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA150  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA154  38 81 00 44 */	addi r4, r1, 0x44
/* 80CBA158  7C 85 23 78 */	mr r5, r4
/* 80CBA15C  4B 68 CC 10 */	b PSMTXMultVec
...
/* 80CBA178  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA17C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBA190  4B 35 22 4C */	b mDoMtx_YrotS__FPA4_fs
/* 80CBA194  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA198  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA19C  38 81 00 2C */	addi r4, r1, 0x2c
/* 80CBA1A0  7C 85 23 78 */	mr r5, r4
/* 80CBA1A4  4B 68 CB C8 */	b PSMTXMultVec
...
/* 80CBA1C0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80CBA1C4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80CBA204  4B 5B 57 78 */	b cLib_addCalc__FPfffff
/* 80CBA208  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80CBA20C  4B 35 2B 58 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CBA210  38 61 00 2C */	addi r3, r1, 0x2c
/* 80CBA214  4B 35 2B C0 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80CBA218  38 61 00 44 */	addi r3, r1, 0x44
/* 80CBA21C  4B 35 2B B8 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80CBA220  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA224  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBA238  4B 35 21 FC */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA23C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA240  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA244  38 80 F1 C8 */	li r4, -3640
/* 80CBA248  4B 35 21 54 */	b mDoMtx_XrotM__FPA4_fs
/* 80CBA24C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA250  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA254  A8 1F 0B AA */	lha r0, 0xbaa(r31)
/* 80CBA258  7C 00 00 D0 */	neg r0, r0
/* 80CBA25C  7C 04 07 34 */	extsh r4, r0
/* 80CBA260  4B 35 21 3C */	b mDoMtx_XrotM__FPA4_fs
/* 80CBA264  C0 3E 00 7C */	lfs f1, 0x7c(r30)
/* 80CBA268  C0 5E 00 5C */	lfs f2, 0x5c(r30)
/* 80CBA26C  FC 60 10 90 */	fmr f3, f2
/* 80CBA270  4B 35 2B 2C */	b transM__14mDoMtx_stack_cFfff
/* 80CBA274  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA278  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA27C  A8 9F 0B AE */	lha r4, 0xbae(r31)
/* 80CBA280  4B 35 22 4C */	b mDoMtx_ZrotM__FPA4_fs
/* 80CBA284  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA288  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA28C  7F A4 EB 78 */	mr r4, r29
/* 80CBA290  4B 35 22 3C */	b mDoMtx_ZrotM__FPA4_fs
/* 80CBA294  C0 3E 00 80 */	lfs f1, 0x80(r30)
/* 80CBA298  C0 5E 00 5C */	lfs f2, 0x5c(r30)
/* 80CBA29C  FC 60 10 90 */	fmr f3, f2
/* 80CBA2A0  4B 35 2A FC */	b transM__14mDoMtx_stack_cFfff
/* 80CBA2A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA2A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA2AC  80 9F 05 B0 */	lwz r4, 0x5b0(r31)
/* 80CBA2B0  38 84 00 24 */	addi r4, r4, 0x24
/* 80CBA2B4  4B 68 C1 FC */	b PSMTXCopy
...
/* 80CBA2D4  4B 35 2A 90 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CBA2D8  38 61 00 44 */	addi r3, r1, 0x44
/* 80CBA2DC  4B 35 2A F8 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80CBA2E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA2E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBA2F8  4B 35 21 3C */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA2FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA300  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA304  38 80 F1 C8 */	li r4, -3640
/* 80CBA308  4B 35 20 94 */	b mDoMtx_XrotM__FPA4_fs
/* 80CBA30C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA310  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA314  A8 1F 0B AA */	lha r0, 0xbaa(r31)
/* 80CBA318  7C 00 00 D0 */	neg r0, r0
/* 80CBA31C  7C 04 07 34 */	extsh r4, r0
/* 80CBA320  4B 35 20 7C */	b mDoMtx_XrotM__FPA4_fs
/* 80CBA324  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA328  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA32C  80 9F 05 AC */	lwz r4, 0x5ac(r31)
/* 80CBA330  38 84 00 24 */	addi r4, r4, 0x24
/* 80CBA334  4B 68 C1 7C */	b PSMTXCopy
...
/* 80CBA394  4B 36 39 28 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80CBA398  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CBA39C  41 82 00 78 */	beq lbl_80CBA414
/* 80CBA3A0  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80CBA3A4  C0 23 0C D0 */	lfs f1, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 80CBA3E8  4B 68 CC F0 */	b PSVECScale
...
/* 80CBA408  4B 35 F9 90 */	b fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
...
/* 80CBA428  4B 5B 61 18 */	b cLib_addCalcAngleS__FPsssss
/* 80CBA42C  38 7F 0B D0 */	addi r3, r31, 0xbd0
/* 80CBA430  4B 35 29 34 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CBA434  38 7F 0B DC */	addi r3, r31, 0xbdc
/* 80CBA438  4B 35 2B 0C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CBA43C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA440  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA444  80 9F 05 AC */	lwz r4, 0x5ac(r31)
/* 80CBA448  38 84 00 24 */	addi r4, r4, 0x24
/* 80CBA44C  4B 68 C0 64 */	b PSMTXCopy
lbl_80CBA450:
/* 80CBA450  39 61 00 80 */	addi r11, r1, 0x80
/* 80CBA454  4B 6A 7D D4 */	b _restgpr_29
