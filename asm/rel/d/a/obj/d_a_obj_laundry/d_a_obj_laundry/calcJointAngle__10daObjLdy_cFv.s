...
/* 80C5165C  4B 71 0B 70 */	b _savegpr_25
/* 80C51660  3C 80 80 C5 */	lis r4, M_attr__10daObjLdy_c@ha
/* 80C51664  3B E4 20 00 */	addi r31, r4, M_attr__10daObjLdy_c@l
/* 80C51668  3B A3 07 20 */	addi r29, r3, 0x720
/* 80C5166C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C51670  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C51674  38 63 05 78 */	addi r3, r3, 0x578
/* 80C51678  4B 6F 4E 38 */	b PSMTXCopy
/* 80C5167C  3B 80 00 00 */	li r28, 0
/* 80C51680  3B DF 00 00 */	addi r30, r31, 0
/* 80C51684  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C51688  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l
/* 80C5168C  7F 3A CB 78 */	mr r26, r25
/* 80C51690  C3 FF 00 50 */	lfs f31, 0x50(r31)
/* 80C51694  7F 3B CB 78 */	mr r27, r25
lbl_80C51698:
/* 80C51698  4B 3B B6 30 */	b push__14mDoMtx_stack_cFv
/* 80C5169C  7F 23 CB 78 */	mr r3, r25
/* 80C516A0  7F 24 CB 78 */	mr r4, r25
/* 80C516A4  4B 6F 4F 0C */	b PSMTXInverse
/* 80C516A8  7F 43 D3 78 */	mr r3, r26
/* 80C516AC  7F A4 EB 78 */	mr r4, r29
/* 80C516B0  38 A1 00 18 */	addi r5, r1, 0x18
/* 80C516B4  4B 6F 56 B8 */	b PSMTXMultVec
/* 80C516B8  4B 3B B6 5C */	b pop__14mDoMtx_stack_cFv
/* 80C516BC  38 61 00 18 */	addi r3, r1, 0x18
/* 80C516C0  7C 64 1B 78 */	mr r4, r3
/* 80C516C4  C0 3F 00 C0 */	lfs f1, 0xc0(r31)
/* 80C516C8  4B 6F 5A 10 */	b PSVECScale
/* 80C516CC  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 80C516D0  C0 41 00 1C */	lfs f2, 0x1c(r1)
/* 80C516D4  4B 61 5F A0 */	b cM_atan2s__Fff
...
/* 80C516F4  4B 6F 5A 44 */	b PSVECSquareMag
...
/* 80C51760  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C51764  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C517D0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C517D4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C51828  4B 71 09 F0 */	b _restgpr_25
