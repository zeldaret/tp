...
/* 80C5186C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C51870  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C51898  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5189C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C518A0  4B 6F 4C 11 */	bl PSMTXCopy
/* 80C518A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C518A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C518AC  A8 81 00 08 */	lha r4, 8(r1)
/* 80C518B0  4B 3B AA ED */	bl mDoMtx_XrotM__FPA4_fs
/* 80C518B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C518B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C518BC  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80C518C0  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C518C4  7C 80 FA 14 */	add r4, r0, r31
/* 80C518C8  4B 6F 4B E9 */	bl PSMTXCopy
/* 80C518CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C518D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C518D4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80C518D8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80C518DC  4B 6F 4B D5 */	bl PSMTXCopy
