...
/* 80C5190C  4B 71 08 CD */	bl _savegpr_28
/* 80C51910  7C 7F 1B 78 */	mr r31, r3
/* 80C51914  3C 60 80 C5 */	lis r3, l_arcName@ha /* 0x80C520F0@ha */
/* 80C51918  38 63 20 F0 */	addi r3, r3, l_arcName@l /* 0x80C520F0@l */
/* 80C5191C  80 63 00 00 */	lwz r3, 0(r3)
/* 80C51920  3C 80 80 C5 */	lis r4, d_a_obj_laundry__stringBase0@ha /* 0x80C520C8@ha */
/* 80C51924  38 84 20 C8 */	addi r4, r4, d_a_obj_laundry__stringBase0@l /* 0x80C520C8@l */
/* 80C51928  38 84 00 0A */	addi r4, r4, 0xa
/* 80C5192C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C51930  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C51944  4B 3E AA 39 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80C51958  4B 3C 32 FD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C5195C  90 7F 05 68 */	stw r3, 0x568(r31)
/* 80C51960  3C 60 80 C5 */	lis r3, l_arcName@ha /* 0x80C520F0@ha */
/* 80C51964  38 63 20 F0 */	addi r3, r3, l_arcName@l /* 0x80C520F0@l */
/* 80C51968  80 63 00 00 */	lwz r3, 0(r3)
/* 80C5196C  3C 80 80 C5 */	lis r4, d_a_obj_laundry__stringBase0@ha /* 0x80C520C8@ha */
/* 80C51970  38 84 20 C8 */	addi r4, r4, d_a_obj_laundry__stringBase0@l /* 0x80C520C8@l */
/* 80C51974  38 84 00 18 */	addi r4, r4, 0x18
/* 80C51978  7F 85 E3 78 */	mr r5, r28
/* 80C5197C  38 C0 00 80 */	li r6, 0x80
/* 80C51980  4B 3E A9 FD */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80C51984  7C 7C 1B 78 */	mr r28, r3
/* 80C51988  38 60 00 18 */	li r3, 0x18
/* 80C5198C  4B 67 D2 C1 */	bl __nw__FUl
/* 80C51990  7C 7E 1B 79 */	or. r30, r3, r3
/* 80C51994  41 82 00 20 */	beq lbl_80C519B4
/* 80C51998  3C 80 80 C5 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C52174@ha */
/* 80C5199C  38 04 21 74 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C52174@l */
/* 80C519A0  90 1E 00 00 */	stw r0, 0(r30)
/* 80C519A4  38 80 00 00 */	li r4, 0
/* 80C519A8  4B 6D 6A 55 */	bl init__12J3DFrameCtrlFs
...
/* 80C519CC  3D 00 80 C5 */	lis r8, lit_4203@ha /* 0x80C520C4@ha */
/* 80C519D0  C0 28 20 C4 */	lfs f1, lit_4203@l(r8)  /* 0x80C520C4@l */
/* 80C519D4  39 00 00 00 */	li r8, 0
/* 80C519D8  39 20 FF FF */	li r9, -1
/* 80C519DC  4B 3B BC 61 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C519F8  3C 60 80 C5 */	lis r3, lit_3757@ha /* 0x80C52048@ha */
/* 80C519FC  C8 23 20 48 */	lfd f1, lit_3757@l(r3)  /* 0x80C52048@l */
...
/* 80C51A24  3C 60 80 C5 */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x80C51844@ha */
/* 80C51A28  38 83 18 44 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l /* 0x80C51844@l */
...
/* 80C51A84  4B 71 07 A1 */	bl _restgpr_28
