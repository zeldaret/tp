...
/* 80C76EF0  4B 6E B2 ED */	bl _savegpr_29
/* 80C76EF4  7C 9E 23 78 */	mr r30, r4
/* 80C76EF8  7C BF 2B 78 */	mr r31, r5
/* 80C76EFC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C76F00  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C76F48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C76F4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C76FCC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80C76FD0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80C76FD4  38 81 00 08 */	addi r4, r1, 8
/* 80C76FD8  4B 3A 28 21 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C77064  4B 6E B1 C5 */	bl _restgpr_29
