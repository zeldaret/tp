...
/* 80C772D0  3C 60 80 C7 */	lis r3, data_80C77B20@ha /* 0x80C77B20@ha */
/* 80C772D4  38 C3 7B 20 */	addi r6, r3, data_80C77B20@l /* 0x80C77B20@l */
/* 80C772D8  88 06 00 00 */	lbz r0, 0(r6)
/* 80C772DC  7C 00 07 75 */	extsb. r0, r0
/* 80C772E0  40 82 00 34 */	bne lbl_80C77314
/* 80C772E4  3C 60 80 C7 */	lis r3, mode_proc@ha /* 0x80C77A2C@ha */
/* 80C772E8  38 A3 7A 2C */	addi r5, r3, mode_proc@l /* 0x80C77A2C@l */
/* 80C772EC  3C 60 80 C7 */	lis r3, lit_3913@ha /* 0x80C77A20@ha */
/* 80C772F0  38 83 7A 20 */	addi r4, r3, lit_3913@l /* 0x80C77A20@l */
...
/* 80C77320  3C 80 80 C7 */	lis r4, mode_proc@ha /* 0x80C77A2C@ha */
/* 80C77324  38 04 7A 2C */	addi r0, r4, mode_proc@l /* 0x80C77A2C@l */
/* 80C77328  7D 80 2A 14 */	add r12, r0, r5
/* 80C7732C  4B 6E AD 59 */	bl __ptmf_scall
/* 80C77330  60 00 00 00 */	nop 
/* 80C77334  3C 60 80 C7 */	lis r3, lit_3735@ha /* 0x80C779E4@ha */
/* 80C77338  C0 23 79 E4 */	lfs f1, lit_3735@l(r3)  /* 0x80C779E4@l */
...
/* 80C77350  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C77354  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C773CC  3C 80 80 C7 */	lis r4, lit_3670@ha /* 0x80C779B8@ha */
/* 80C773D0  C0 24 79 B8 */	lfs f1, lit_3670@l(r4)  /* 0x80C779B8@l */
/* 80C773D4  C0 5F 05 E8 */	lfs f2, 0x5e8(r31)
/* 80C773D8  C0 7F 05 EC */	lfs f3, 0x5ec(r31)
/* 80C773DC  C0 9F 05 F0 */	lfs f4, 0x5f0(r31)
/* 80C773E0  4B 5F 85 9D */	bl cLib_addCalc__FPfffff
/* 80C773E4  3C 60 80 C7 */	lis r3, lit_3735@ha /* 0x80C779E4@ha */
/* 80C773E8  C0 23 79 E4 */	lfs f1, lit_3735@l(r3)  /* 0x80C779E4@l */
...
/* 80C77410  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C77414  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C7742C  3C 80 80 C7 */	lis r4, lit_3670@ha /* 0x80C779B8@ha */
/* 80C77430  C0 24 79 B8 */	lfs f1, lit_3670@l(r4)  /* 0x80C779B8@l */
/* 80C77434  C0 5F 06 0C */	lfs f2, 0x60c(r31)
/* 80C77438  C0 7F 06 10 */	lfs f3, 0x610(r31)
/* 80C7743C  C0 9F 06 14 */	lfs f4, 0x614(r31)
/* 80C77440  4B 5F 85 3D */	bl cLib_addCalc__FPfffff
