...
/* 80C76D3C  4B 40 18 E9 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C76D40  3C 60 80 C7 */	lis r3, __vt__10daTenbin_c@ha /* 0x80C77A88@ha */
/* 80C76D44  38 03 7A 88 */	addi r0, r3, __vt__10daTenbin_c@l /* 0x80C77A88@l */
...
/* 80C76D5C  3C 80 80 C7 */	lis r4, d_a_obj_lv6Tenbin__stringBase0@ha /* 0x80C779FC@ha */
/* 80C76D60  38 84 79 FC */	addi r4, r4, d_a_obj_lv6Tenbin__stringBase0@l /* 0x80C779FC@l */
/* 80C76D64  4B 3B 61 59 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C76D78  3C 80 80 C7 */	lis r4, d_a_obj_lv6Tenbin__stringBase0@ha /* 0x80C779FC@ha */
/* 80C76D7C  38 84 79 FC */	addi r4, r4, d_a_obj_lv6Tenbin__stringBase0@l /* 0x80C779FC@l */
/* 80C76D80  38 A0 00 08 */	li r5, 8
/* 80C76D84  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075A24@ha */
/* 80C76D88  38 C6 5A 24 */	addi r6, r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075A24@l */
/* 80C76D8C  38 E0 6A 00 */	li r7, 0x6a00
/* 80C76D90  39 00 00 00 */	li r8, 0
/* 80C76D94  4B 40 1A 29 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C76DB4  3C 60 80 C7 */	lis r3, l_cull_box@ha /* 0x80C77A08@ha */
/* 80C76DB8  38 83 7A 08 */	addi r4, r3, l_cull_box@l /* 0x80C77A08@l */
...
/* 80C76DD8  4B 3A 37 71 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80C76DDC  3C 60 80 C7 */	lis r3, rideCallBackLeft__10daTenbin_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 0x80C77078@ha */
/* 80C76DE0  38 03 70 78 */	addi r0, r3, rideCallBackLeft__10daTenbin_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 0x80C77078@l */
/* 80C76DE4  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 80C76DE8  90 03 00 B4 */	stw r0, 0xb4(r3)
/* 80C76DEC  3C 60 80 C7 */	lis r3, rideCallBackRight__10daTenbin_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 0x80C76EE0@ha */
/* 80C76DF0  38 03 6E E0 */	addi r0, r3, rideCallBackRight__10daTenbin_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 0x80C76EE0@l */
...
/* 80C76E18  3C 60 80 C7 */	lis r3, lit_3670@ha /* 0x80C779B8@ha */
/* 80C76E1C  C0 03 79 B8 */	lfs f0, lit_3670@l(r3)  /* 0x80C779B8@l */
...
/* 80C76E98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C76E9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C76EA0  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C76EA4  7F C5 F3 78 */	mr r5, r30
/* 80C76EA8  4B 3F DB 61 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80C76EAC  80 7E 06 1C */	lwz r3, 0x61c(r30)
/* 80C76EB0  4B 40 4B 11 */	bl Move__4dBgWFv
lbl_80C76EB4:
/* 80C76EB4  7F C3 F3 78 */	mr r3, r30
/* 80C76EB8  4B 40 1A 99 */	bl MoveBGExecute__16dBgS_MoveBgActorFv
