...
/* 80D2C278  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D2C27C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D2C280  38 80 00 10 */	li r4, 0x10
/* 80D2C284  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80D2C288  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80D2C28C  4B 47 75 39 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80D2C290  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D2C294  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D2C298  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80D2C29C  80 84 00 04 */	lwz r4, 4(r4)
/* 80D2C2A0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80D2C2A4  4B 47 8A FD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D2C2A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2C2AC  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D2C2B0  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80D2C2B4  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80D2C2B8  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80D2C2CC  4B 2E 19 F9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80D2C2D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2C2D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
