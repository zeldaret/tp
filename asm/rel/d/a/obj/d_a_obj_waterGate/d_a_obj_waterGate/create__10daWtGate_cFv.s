...
/* 80D2BD2C  4B 34 C8 F9 */	bl __ct__16dBgS_MoveBgActorFv
/* 80D2BD30  3C 60 80 D3 */	lis r3, __vt__10daWtGate_c@ha /* 0x80D2C568@ha */
/* 80D2BD34  38 03 C5 68 */	addi r0, r3, __vt__10daWtGate_c@l /* 0x80D2C568@l */
...
/* 80D2BD4C  3C 80 80 D3 */	lis r4, d_a_obj_waterGate__stringBase0@ha /* 0x80D2C48C@ha */
/* 80D2BD50  38 84 C4 8C */	addi r4, r4, d_a_obj_waterGate__stringBase0@l /* 0x80D2C48C@l */
/* 80D2BD54  4B 30 11 69 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80D2BD68  3C 80 80 D3 */	lis r4, d_a_obj_waterGate__stringBase0@ha /* 0x80D2C48C@ha */
/* 80D2BD6C  38 84 C4 8C */	addi r4, r4, d_a_obj_waterGate__stringBase0@l /* 0x80D2C48C@l */
/* 80D2BD70  38 A0 00 07 */	li r5, 7
/* 80D2BD74  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80D2BD78  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80D2BD7C  38 E0 0E 00 */	li r7, 0xe00
/* 80D2BD80  39 00 00 00 */	li r8, 0
/* 80D2BD84  4B 34 CA 39 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80D2BDB0  4B 2E E7 C9 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80D2BDB4  3C 60 80 D3 */	lis r3, lit_3712@ha /* 0x80D2C470@ha */
/* 80D2BDB8  C0 43 C4 70 */	lfs f2, lit_3712@l(r3)  /* 0x80D2C470@l */
/* 80D2BDBC  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 80D2BDC0  54 00 C6 3E */	rlwinm r0, r0, 0x18, 0x18, 0x1f
/* 80D2BDC4  3C 60 80 D3 */	lis r3, lit_3714@ha /* 0x80D2C474@ha */
/* 80D2BDC8  C8 23 C4 74 */	lfd f1, lit_3714@l(r3)  /* 0x80D2C474@l */
...
lbl_80D2BE14:
/* 80D2BE14  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2BE18  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D2BE1C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80D2BE20  7C 05 07 74 */	extsb r5, r0
/* 80D2BE24  4B 30 95 3D */	bl isSwitch__10dSv_info_cCFii
