...
/* 80C5760C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C57610  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C57614  38 80 00 40 */	li r4, 0x40
/* 80C57618  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C5761C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C57620  4B 54 C1 A5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C57624  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C57628  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C5762C  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80C57630  80 84 00 04 */	lwz r4, 4(r4)
/* 80C57634  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C57638  4B 54 D7 69 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C5763C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C57640  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C57644  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C57648  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C5764C  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C57660  4B 3B 66 65 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C57664  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C57668  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
