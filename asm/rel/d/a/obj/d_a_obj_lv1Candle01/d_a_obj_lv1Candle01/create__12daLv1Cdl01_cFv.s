...
/* 80C56E24  4B 70 B3 B9 */	bl _savegpr_29
...
/* 80C56E44  4B 42 17 E1 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C56E48  3C 60 80 C5 */	lis r3, __vt__12daLv1Cdl01_c@ha /* 0x80C57978@ha */
/* 80C56E4C  38 03 79 78 */	addi r0, r3, __vt__12daLv1Cdl01_c@l /* 0x80C57978@l */
/* 80C56E50  90 1F 05 9C */	stw r0, 0x59c(r31)
/* 80C56E54  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C56E58  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C56E5C  90 1F 05 C4 */	stw r0, 0x5c4(r31)
/* 80C56E60  38 7F 05 C8 */	addi r3, r31, 0x5c8
/* 80C56E64  4B 42 C8 FD */	bl __ct__10dCcD_GSttsFv
/* 80C56E68  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C56E6C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C56E84  4B 42 CB A5 */	bl __ct__12dCcD_GObjInfFv
/* 80C56E88  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C56E8C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C56E90  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80C56E94  3C 60 80 C5 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C5796C@ha */
/* 80C56E98  38 03 79 6C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C5796C@l */
/* 80C56E9C  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80C56EA0  3C 60 80 C5 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C57960@ha */
/* 80C56EA4  38 03 79 60 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C57960@l */
/* 80C56EA8  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80C56EAC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C56EB0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80C56EB4  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80C56EB8  38 03 00 58 */	addi r0, r3, 0x58
/* 80C56EBC  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80C56EC0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C56EC4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C56EE0  4B 66 79 65 */	bl __ct__16Z2SoundObjSimpleFv
lbl_80C56EE4:
...
/* 80C56EF4  3C 80 80 C5 */	lis r4, d_a_obj_lv1Candle01__stringBase0@ha /* 0x80C578C0@ha */
/* 80C56EF8  38 84 78 C0 */	addi r4, r4, d_a_obj_lv1Candle01__stringBase0@l /* 0x80C578C0@l */
/* 80C56EFC  4B 3D 5F C1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C56F10  3C 80 80 C5 */	lis r4, d_a_obj_lv1Candle01__stringBase0@ha /* 0x80C578C0@ha */
/* 80C56F14  38 84 78 C0 */	addi r4, r4, d_a_obj_lv1Candle01__stringBase0@l /* 0x80C578C0@l */
/* 80C56F18  38 A0 FF FF */	li r5, -1
/* 80C56F1C  38 C0 00 00 */	li r6, 0
/* 80C56F20  38 E0 08 20 */	li r7, 0x820
/* 80C56F24  39 00 00 00 */	li r8, 0
/* 80C56F28  4B 42 18 95 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C56F5C  4B 3C 36 1D */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80C56F88  3C 60 80 C5 */	lis r3, lit_3723@ha /* 0x80C5788C@ha */
/* 80C56F8C  C0 23 78 8C */	lfs f1, lit_3723@l(r3)  /* 0x80C5788C@l */
...
/* 80C56FEC  4B 42 C8 75 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C56FF0  38 7E 05 E8 */	addi r3, r30, 0x5e8
/* 80C56FF4  3C 80 80 C5 */	lis r4, mCcDCyl__12daLv1Cdl01_c@ha /* 0x80C578CC@ha */
/* 80C56FF8  38 84 78 CC */	addi r4, r4, mCcDCyl__12daLv1Cdl01_c@l /* 0x80C578CC@l */
/* 80C56FFC  4B 42 D8 B9 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80C57034  4B 70 B1 F5 */	bl _restgpr_29
