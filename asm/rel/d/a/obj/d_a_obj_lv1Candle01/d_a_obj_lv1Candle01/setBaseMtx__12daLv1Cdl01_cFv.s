...
/* 80C56D34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C56D38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C56D3C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C56D40  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C56D44  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C56D48  4B 6E FB A1 */	bl PSMTXTrans
/* 80C56D4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C56D50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C56D54  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 80C56D58  A8 BF 04 DE */	lha r5, 0x4de(r31)
/* 80C56D5C  A8 DF 04 E0 */	lha r6, 0x4e0(r31)
/* 80C56D60  4B 3B 55 41 */	bl mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80C56D80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C56D84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C56D88  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C56D8C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C56D90  4B 6E F7 21 */	bl PSMTXCopy
