...
/* 80C8BDDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8BDE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8BDE4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C8BDE8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C8BDEC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C8BDF0  4B 6B AA F9 */	bl PSMTXTrans
/* 80C8BDF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8BDF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8BDFC  38 80 00 00 */	li r4, 0
/* 80C8BE00  A8 BF 04 DE */	lha r5, 0x4de(r31)
/* 80C8BE04  38 C0 00 00 */	li r6, 0
/* 80C8BE08  4B 38 04 99 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80C8BE0C  3C 60 80 C9 */	lis r3, lit_3628@ha /* 0x80C8CBF0@ha */
/* 80C8BE10  C0 23 CB F0 */	lfs f1, lit_3628@l(r3)  /* 0x80C8CBF0@l */
/* 80C8BE14  C0 5F 05 C0 */	lfs f2, 0x5c0(r31)
/* 80C8BE18  FC 60 08 90 */	fmr f3, f1
/* 80C8BE1C  4B 38 0F 81 */	bl transM__14mDoMtx_stack_cFfff
...
/* 80C8BE3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8BE40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8BE44  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C8BE48  38 84 00 24 */	addi r4, r4, 0x24
/* 80C8BE4C  4B 6B A6 65 */	bl PSMTXCopy
