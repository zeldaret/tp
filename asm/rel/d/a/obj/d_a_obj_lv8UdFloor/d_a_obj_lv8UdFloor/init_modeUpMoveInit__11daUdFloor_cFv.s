...
/* 80C8C290  3C 60 80 C9 */	lis r3, l_HIO@ha /* 0x80C8CD8C@ha */
/* 80C8C294  38 63 CD 8C */	addi r3, r3, l_HIO@l /* 0x80C8CD8C@l */
...
/* 80C8C2A8  4B 3A 0D C5 */	bl dComIfGp_getReverb__Fi
...
/* 80C8C2BC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8C2C0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8C2D4  3D 00 80 C9 */	lis r8, lit_3777@ha /* 0x80C8CC20@ha */
/* 80C8C2D8  C0 28 CC 20 */	lfs f1, lit_3777@l(r8)  /* 0x80C8CC20@l */
/* 80C8C2DC  FC 40 08 90 */	fmr f2, f1
/* 80C8C2E0  3D 00 80 C9 */	lis r8, lit_3778@ha /* 0x80C8CC24@ha */
/* 80C8C2E4  C0 68 CC 24 */	lfs f3, lit_3778@l(r8)  /* 0x80C8CC24@l */
/* 80C8C2E8  FC 80 18 90 */	fmr f4, f3
/* 80C8C2EC  39 00 00 00 */	li r8, 0
/* 80C8C2F0  4B 61 F6 95 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
