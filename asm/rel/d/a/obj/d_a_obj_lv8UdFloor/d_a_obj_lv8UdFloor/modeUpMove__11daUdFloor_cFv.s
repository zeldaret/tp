...
/* 80C8C6A4  3C 60 80 C9 */	lis r3, lit_3628@ha /* 0x80C8CBF0@ha */
/* 80C8C6A8  3B E3 CB F0 */	addi r31, r3, lit_3628@l /* 0x80C8CBF0@l */
...
/* 80C8C6D4  4B 3A 09 99 */	bl dComIfGp_getReverb__Fi
...
/* 80C8C6E8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8C6EC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8C714  4B 61 F2 71 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C8C72C  4B 5E 40 15 */	bl cLib_chaseF__FPfff
...
/* 80C8C744  4B 5E 32 39 */	bl cLib_addCalc__FPfffff
...
/* 80C8C75C  4B 3A 09 11 */	bl dComIfGp_getReverb__Fi
...
/* 80C8C770  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8C774  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8C79C  4B 61 F1 E9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C8C7B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C8C7B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C8C7BC  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C8C7C0  3C 80 80 C9 */	lis r4, l_HIO@ha /* 0x80C8CD8C@ha */
/* 80C8C7C4  38 84 CD 8C */	addi r4, r4, l_HIO@l /* 0x80C8CD8C@l */
/* 80C8C7C8  88 84 00 0C */	lbz r4, 0xc(r4)
/* 80C8C7CC  38 A0 00 0F */	li r5, 0xf
/* 80C8C7D0  38 C1 00 10 */	addi r6, r1, 0x10
/* 80C8C7D4  4B 3E 32 51 */	bl StartShock__12dVibration_cFii4cXyz
