...
/* 80C936B8  4B 6C EB 25 */	bl _savegpr_29
/* 80C936BC  7C 7E 1B 78 */	mr r30, r3
/* 80C936C0  3C 60 80 C9 */	lis r3, l_bmd@ha /* 0x80C93D88@ha */
/* 80C936C4  3B E3 3D 88 */	addi r31, r3, l_bmd@l /* 0x80C93D88@l */
...
/* 80C936EC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80C936F0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80C936F4  38 81 00 08 */	addi r4, r1, 8
/* 80C936F8  4B 38 61 01 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C93754  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C93758  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9375C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C93760  7C 05 07 74 */	extsb r5, r0
/* 80C93764  4B 3A 1B FD */	bl isSwitch__10dSv_info_cCFii
...
/* 80C937D4  4B 37 95 91 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C937D8  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80C937DC  4B 37 97 69 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C937E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C937E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C937E8  38 81 00 28 */	addi r4, r1, 0x28
/* 80C937EC  7C 85 23 78 */	mr r5, r4
/* 80C937F0  4B 6B 35 7D */	bl PSMTXMultVec
...
/* 80C93864  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C93868  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9386C  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C93870  38 9E 05 BC */	addi r4, r30, 0x5bc
/* 80C93874  4B 5D 13 35 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80C93890  4B 37 9B 99 */	bl play__14mDoExt_baseAnmFv
/* 80C93894  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80C93898  4B 37 9B 91 */	bl play__14mDoExt_baseAnmFv
/* 80C9389C  80 7E 05 7C */	lwz r3, 0x57c(r30)
/* 80C938A0  4B 37 9B 89 */	bl play__14mDoExt_baseAnmFv
...
/* 80C938E4  4B 39 97 89 */	bl dComIfGp_getReverb__Fi
...
/* 80C93914  4B 6C E9 15 */	bl _restgpr_29
