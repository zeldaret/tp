...
/* 80C934F0  4B 6C EC ED */	bl _savegpr_29
...
/* 80C93510  4B 38 56 55 */	bl __ct__10fopAc_ac_cFv
/* 80C93514  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C93518  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C9351C  90 1E 05 98 */	stw r0, 0x598(r30)
/* 80C93520  38 7E 05 9C */	addi r3, r30, 0x59c
/* 80C93524  4B 3F 02 3D */	bl __ct__10dCcD_GSttsFv
/* 80C93528  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C9352C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C93544  4B 3F 04 E5 */	bl __ct__12dCcD_GObjInfFv
/* 80C93548  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C9354C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C93550  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80C93554  3C 60 80 C9 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C93EB8@ha */
/* 80C93558  38 03 3E B8 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C93EB8@l */
/* 80C9355C  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80C93560  38 7D 01 24 */	addi r3, r29, 0x124
/* 80C93564  4B 5D BA 25 */	bl __ct__8cM3dGCpsFv
/* 80C93568  3C 60 80 3C */	lis r3, __vt__12cCcD_CpsAttr@ha /* 0x803C3608@ha */
/* 80C9356C  38 63 36 08 */	addi r3, r3, __vt__12cCcD_CpsAttr@l /* 0x803C3608@l */
/* 80C93570  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80C93574  38 03 00 58 */	addi r0, r3, 0x58
/* 80C93578  90 1D 01 3C */	stw r0, 0x13c(r29)
/* 80C9357C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cps@ha /* 0x803AC170@ha */
/* 80C93580  38 63 C1 70 */	addi r3, r3, __vt__8dCcD_Cps@l /* 0x803AC170@l */
...
/* 80C9359C  4B 62 B2 A9 */	bl __ct__16Z2SoundObjSimpleFv
lbl_80C935A0:
...
/* 80C935EC  3C 80 80 C9 */	lis r4, l_arcName@ha /* 0x80C93E14@ha */
/* 80C935F0  38 84 3E 14 */	addi r4, r4, l_arcName@l /* 0x80C93E14@l */
/* 80C935F4  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C935F8  4B 39 98 C5 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C9360C  3C 80 80 C9 */	lis r4, CheckCreateHeap__FP10fopAc_ac_c@ha /* 0x80C92FB8@ha */
/* 80C93610  38 84 2F B8 */	addi r4, r4, CheckCreateHeap__FP10fopAc_ac_c@l /* 0x80C92FB8@l */
/* 80C93614  38 A0 40 00 */	li r5, 0x4000
/* 80C93618  4B 38 6E 99 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80C9364C  4B 6C EB DD */	bl _restgpr_29
