...
/* 80D1FC1C  4B 64 25 BD */	bl _savegpr_28
/* 80D1FC20  7C 7E 1B 78 */	mr r30, r3
/* 80D1FC24  3C 60 80 D2 */	lis r3, lit_3638@ha /* 0x80D20308@ha */
/* 80D1FC28  3B E3 03 08 */	addi r31, r3, lit_3638@l /* 0x80D20308@l */
/* 80D1FC2C  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80D1FC30  54 00 10 3A */	slwi r0, r0, 2
/* 80D1FC34  3C 60 80 D2 */	lis r3, l_resNameIdx@ha /* 0x80D205B0@ha */
/* 80D1FC38  38 63 05 B0 */	addi r3, r3, l_resNameIdx@l /* 0x80D205B0@l */
/* 80D1FC3C  7C 63 00 2E */	lwzx r3, r3, r0
/* 80D1FC40  38 9F 00 04 */	addi r4, r31, 4
/* 80D1FC44  7C 84 00 2E */	lwzx r4, r4, r0
/* 80D1FC48  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1FC4C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D1FC60  4B 31 C6 8D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1FC74  4B 2F 4F E1 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80D1FC98  3C 60 80 D2 */	lis r3, l_resNameIdx@ha /* 0x80D205B0@ha */
/* 80D1FC9C  38 63 05 B0 */	addi r3, r3, l_resNameIdx@l /* 0x80D205B0@l */
...
/* 80D1FCB4  4B 31 C6 39 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1FCD8  4B 2E D9 65 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80D1FCDC  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80D1FCE0  54 00 10 3A */	slwi r0, r0, 2
/* 80D1FCE4  3C 60 80 D2 */	lis r3, l_resNameIdx@ha /* 0x80D205B0@ha */
/* 80D1FCE8  38 63 05 B0 */	addi r3, r3, l_resNameIdx@l /* 0x80D205B0@l */
...
/* 80D1FD00  4B 31 C5 ED */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1FD24  4B 2E D9 E9 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80D1FD28  38 60 00 01 */	li r3, 1
lbl_80D1FD2C:
/* 80D1FD2C  39 61 00 20 */	addi r11, r1, 0x20
/* 80D1FD30  4B 64 24 F5 */	bl _restgpr_28
