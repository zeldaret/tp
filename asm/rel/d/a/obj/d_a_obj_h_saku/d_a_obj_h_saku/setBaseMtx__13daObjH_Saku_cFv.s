...
/* 80C15E5C  3C 60 80 C1 */	lis r3, lit_3703@ha
/* 80C15E60  3B C3 64 C8 */	addi r30, r3, lit_3703@l
...
/* 80C15E74  4B 65 15 80 */	b __ct__5csXyzFsss
/* 80C15E78  38 7F 05 A4 */	addi r3, r31, 0x5a4
/* 80C15E7C  4B 3F 6E E8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C15E80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C15E84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C15E98  4B 3F 65 9C */	b mDoMtx_YrotM__FPA4_fs
/* 80C15E9C  C0 3E 00 04 */	lfs f1, 4(r30)
/* 80C15EA0  FC 40 08 90 */	fmr f2, f1
/* 80C15EA4  C0 7E 00 08 */	lfs f3, 8(r30)
/* 80C15EA8  4B 3F 6E F4 */	b transM__14mDoMtx_stack_cFfff
/* 80C15EAC  38 61 00 08 */	addi r3, r1, 8
/* 80C15EB0  4B 3F 70 94 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C15EB4  C0 3E 00 04 */	lfs f1, 4(r30)
/* 80C15EB8  FC 40 08 90 */	fmr f2, f1
/* 80C15EBC  C0 7E 00 40 */	lfs f3, 0x40(r30)
/* 80C15EC0  4B 3F 6E DC */	b transM__14mDoMtx_stack_cFfff
/* 80C15EC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C15EC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C15ECC  80 9F 06 28 */	lwz r4, 0x628(r31)
/* 80C15ED0  38 84 00 24 */	addi r4, r4, 0x24
/* 80C15ED4  4B 73 05 DC */	b PSMTXCopy
...
/* 80C15EF4  4B 3F 6E 70 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C15EF8  38 61 00 08 */	addi r3, r1, 8
/* 80C15EFC  4B 3F 70 48 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C15F00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C15F04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C15F08  80 9F 06 2C */	lwz r4, 0x62c(r31)
/* 80C15F0C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C15F10  4B 73 05 A0 */	b PSMTXCopy
/* 80C15F14  C0 3E 00 18 */	lfs f1, 0x18(r30)
/* 80C15F18  C0 5E 00 0C */	lfs f2, 0xc(r30)
/* 80C15F1C  FC 60 10 90 */	fmr f3, f2
/* 80C15F20  4B 3F 6F 18 */	b scaleM__14mDoMtx_stack_cFfff
/* 80C15F24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C15F28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C15F2C  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80C15F30  4B 73 05 80 */	b PSMTXCopy
