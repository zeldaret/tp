...
/* 80C1553C  4B 74 CC A1 */	bl _savegpr_29
/* 80C15540  7C 7E 1B 78 */	mr r30, r3
/* 80C15544  3C 60 80 C1 */	lis r3, lit_3703@ha /* 0x80C164C8@ha */
/* 80C15548  3B E3 64 C8 */	addi r31, r3, lit_3703@l /* 0x80C164C8@l */
...
/* 80C15574  4B 65 B8 4D */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 80C15578  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1557C  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C155C4  4B 43 74 CD */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C1560C  4B 43 74 85 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C15654  4B 43 74 3D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C15664  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C15668  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C15694  4B 69 62 F1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C156C0  4B 65 22 95 */	bl cM_rndF__Ff
...
/* 80C156F0  4B 65 22 65 */	bl cM_rndF__Ff
...
/* 80C15734  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C15738  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C1573C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C15740  4B 3F 6C 9D */	bl mDoMtx_YrotS__FPA4_fs
/* 80C15744  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C15748  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C1574C  38 81 00 24 */	addi r4, r1, 0x24
/* 80C15750  7C 85 23 78 */	mr r5, r4
/* 80C15754  4B 73 16 19 */	bl PSMTXMultVec
...
/* 80C1579C  4B 65 2A 39 */	bl ChkUsed__9cBgW_BgIdCFv
/* 80C157A0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C157A4  41 82 00 18 */	beq lbl_80C157BC
/* 80C157A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C157AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C157B0  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C157B4  80 9E 05 68 */	lwz r4, 0x568(r30)
/* 80C157B8  4B 45 EA 99 */	bl Release__4cBgSFP9dBgW_Base
lbl_80C157BC:
/* 80C157BC  39 61 00 60 */	addi r11, r1, 0x60
/* 80C157C0  4B 74 CA 69 */	bl _restgpr_29
