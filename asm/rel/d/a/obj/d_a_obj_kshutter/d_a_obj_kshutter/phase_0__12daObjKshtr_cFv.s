...
/* 80C481C4  3C 60 80 C5 */	lis r3, l_anmArcName@ha
/* 80C481C8  38 63 9E E4 */	addi r3, r3, l_anmArcName@l
...
/* 80C481DC  4B 3E 4C E0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C481F8  3C 80 80 C5 */	lis r4, l_arcName@ha
/* 80C481FC  38 84 9E 80 */	addi r4, r4, l_arcName@l
/* 80C48200  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C48204  4B 3E 4C B8 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C4821C  3C 80 80 C5 */	lis r4, l_arcName@ha
/* 80C48220  38 84 9E 80 */	addi r4, r4, l_arcName@l
/* 80C48224  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C48228  3C A0 80 C5 */	lis r5, l_dzb@ha
/* 80C4822C  38 A5 9C BC */	addi r5, r5, l_dzb@l
/* 80C48230  7C A5 00 2E */	lwzx r5, r5, r0
/* 80C48234  38 C0 00 00 */	li r6, 0
/* 80C48238  3C E0 80 C5 */	lis r7, l_heap_size@ha
/* 80C4823C  38 E7 9C D0 */	addi r7, r7, l_heap_size@l
/* 80C48240  7C E7 00 2E */	lwzx r7, r7, r0
/* 80C48244  39 00 00 00 */	li r8, 0
/* 80C48248  4B 43 05 74 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
