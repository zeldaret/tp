...
/* 80C482A8  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80C482AC  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80C482B0  38 81 00 08 */	addi r4, r1, 8
/* 80C482B4  4B 3D 15 45 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80C482B8  7C 7F 1B 79 */	or. r31, r3, r3
/* 80C482BC  41 82 00 48 */	beq lbl_80C48304
/* 80C482C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C482C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C482C8  88 9E 05 EB */	lbz r4, 0x5eb(r30)
/* 80C482CC  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C482D0  7C 05 07 74 */	extsb r5, r0
/* 80C482D4  4B 3E D0 8D */	bl isSwitch__10dSv_info_cCFii
