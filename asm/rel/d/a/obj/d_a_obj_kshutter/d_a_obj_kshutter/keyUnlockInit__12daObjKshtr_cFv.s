...
/* 80C48AE4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80C48AE8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80C48AEC  38 81 00 0C */	addi r4, r1, 0xc
/* 80C48AF0  4B 3D 0D 09 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
lbl_80C48B04:
/* 80C48B04  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C48B08  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C48B20  4B 3E 45 4D */	bl dComIfGp_getReverb__Fi
...
/* 80C48B34  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C48B38  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C48B4C  3D 00 80 C5 */	lis r8, lit_3842@ha /* 0x80C49D10@ha */
/* 80C48B50  C0 28 9D 10 */	lfs f1, lit_3842@l(r8)  /* 0x80C49D10@l */
/* 80C48B54  FC 40 08 90 */	fmr f2, f1
/* 80C48B58  3D 00 80 C5 */	lis r8, lit_4190@ha /* 0x80C49D20@ha */
/* 80C48B5C  C0 68 9D 20 */	lfs f3, lit_4190@l(r8)  /* 0x80C49D20@l */
/* 80C48B60  FC 80 18 90 */	fmr f4, f3
/* 80C48B64  39 00 00 00 */	li r8, 0
/* 80C48B68  4B 66 2E 1D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
