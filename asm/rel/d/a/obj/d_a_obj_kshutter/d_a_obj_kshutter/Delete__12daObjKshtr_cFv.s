...
/* 80C49B6C  3C 80 80 C5 */	lis r4, l_arcName@ha
/* 80C49B70  38 84 9E 80 */	addi r4, r4, l_arcName@l
/* 80C49B74  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C49B78  4B 3E 34 90 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80C49B7C  88 1F 05 EA */	lbz r0, 0x5ea(r31)
/* 80C49B80  54 00 10 3A */	slwi r0, r0, 2
/* 80C49B84  3C 60 80 C5 */	lis r3, l_anmArcName@ha
/* 80C49B88  38 63 9E E4 */	addi r3, r3, l_anmArcName@l
...
/* 80C49B9C  4B 3E 34 6C */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
lbl_80C49BA0:
