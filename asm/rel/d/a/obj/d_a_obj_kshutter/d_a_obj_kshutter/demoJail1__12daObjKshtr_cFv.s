...
/* 80C49274  3C 60 80 C5 */	lis r3, l_bmd@ha /* 0x80C49CA8@ha */
/* 80C49278  3B E3 9C A8 */	addi r31, r3, l_bmd@l /* 0x80C49CA8@l */
/* 80C4927C  80 1E 06 14 */	lwz r0, 0x614(r30)
/* 80C49280  90 01 00 14 */	stw r0, 0x14(r1)
/* 80C49284  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80C49288  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80C4928C  38 81 00 14 */	addi r4, r1, 0x14
/* 80C49290  4B 3D 05 69 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C492DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C492E0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C492F8  4B 3E 3D 75 */	bl dComIfGp_getReverb__Fi
...
/* 80C4930C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C49310  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C49338  4B 66 26 4D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C49370  4B 3E 3C FD */	bl dComIfGp_getReverb__Fi
...
/* 80C49384  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C49388  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C493B0  4B 66 25 D5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C493C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C493CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C493E0  4B 42 66 45 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 80C493FC  4B 3C 40 2D */	bl play__14mDoExt_baseAnmFv
...
/* 80C4941C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C49420  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C49434  4B 42 65 F1 */	bl StartShock__12dVibration_cFii4cXyz
/* 80C49438  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C4943C  7C 03 07 74 */	extsb r3, r0
/* 80C49440  4B 3E 3C 2D */	bl dComIfGp_getReverb__Fi
...
/* 80C49454  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C49458  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C49480  4B 66 25 05 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
