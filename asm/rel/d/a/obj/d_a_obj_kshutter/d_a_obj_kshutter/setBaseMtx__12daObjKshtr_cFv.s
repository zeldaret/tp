...
/* 80C47B40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C47B44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C47B5C  4B 6F ED 8D */	bl PSMTXTrans
/* 80C47B60  88 1F 05 EA */	lbz r0, 0x5ea(r31)
/* 80C47B64  28 00 00 04 */	cmplwi r0, 4
/* 80C47B68  40 82 00 18 */	bne lbl_80C47B80
/* 80C47B6C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C47B70  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C47B74  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C47B78  4B 3C 48 BD */	bl mDoMtx_YrotM__FPA4_fs
/* 80C47B7C  48 00 00 1C */	b lbl_80C47B98
lbl_80C47B80:
/* 80C47B80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C47B84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C47B88  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C47B8C  38 04 7F FF */	addi r0, r4, 0x7fff
/* 80C47B90  7C 04 07 34 */	extsh r4, r0
/* 80C47B94  4B 3C 48 A1 */	bl mDoMtx_YrotM__FPA4_fs
lbl_80C47B98:
/* 80C47B98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C47B9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C47BA0  80 9F 05 B0 */	lwz r4, 0x5b0(r31)
/* 80C47BA4  38 84 00 24 */	addi r4, r4, 0x24
/* 80C47BA8  4B 6F E9 09 */	bl PSMTXCopy
/* 80C47BAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C47BB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C47BB4  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80C47BB8  4B 6F E8 F9 */	bl PSMTXCopy
...
/* 80C47BD4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C47BD8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C47BDC  4B 6F E8 D5 */	bl PSMTXCopy
/* 80C47BE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C47BE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
