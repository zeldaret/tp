...
/* 80BFDD38  3C 60 80 C0 */	lis r3, lit_3627@ha /* 0x80BFDFE8@ha */
/* 80BFDD3C  3B E3 DF E8 */	addi r31, r3, lit_3627@l /* 0x80BFDFE8@l */
/* 80BFDD40  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80BFDD44  7C 03 07 74 */	extsb r3, r0
/* 80BFDD48  4B 42 F3 25 */	bl dComIfGp_getReverb__Fi
...
/* 80BFDD5C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BFDD60  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BFDD88  4B 6A DB FD */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80BFDDA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BFDDA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BFDDA8  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80BFDDAC  3C 80 80 C0 */	lis r4, l_HIO@ha /* 0x80BFE11C@ha */
/* 80BFDDB0  38 84 E1 1C */	addi r4, r4, l_HIO@l /* 0x80BFE11C@l */
/* 80BFDDB4  88 84 00 08 */	lbz r4, 8(r4)
/* 80BFDDB8  38 A0 00 0F */	li r5, 0xf
/* 80BFDDBC  38 C1 00 0C */	addi r6, r1, 0xc
/* 80BFDDC0  4B 47 1C 65 */	bl StartShock__12dVibration_cFii4cXyz
