...
/* 80BFD738  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BFD73C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BFD740  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80BFD744  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80BFD748  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80BFD74C  4B 74 91 9D */	bl PSMTXTrans
/* 80BFD750  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BFD754  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BFD758  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80BFD75C  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80BFD760  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80BFD764  4B 40 EB 3D */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80BFD768  C0 3F 05 B4 */	lfs f1, 0x5b4(r31)
/* 80BFD76C  3C 60 80 C0 */	lis r3, lit_3648@ha /* 0x80BFDFEC@ha */
/* 80BFD770  C0 43 DF EC */	lfs f2, lit_3648@l(r3)  /* 0x80BFDFEC@l */
/* 80BFD774  FC 60 10 90 */	fmr f3, f2
/* 80BFD778  4B 40 F6 25 */	bl transM__14mDoMtx_stack_cFfff
...
/* 80BFD798  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BFD79C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BFD7A0  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80BFD7A4  38 84 00 24 */	addi r4, r4, 0x24
/* 80BFD7A8  4B 74 8D 09 */	bl PSMTXCopy
