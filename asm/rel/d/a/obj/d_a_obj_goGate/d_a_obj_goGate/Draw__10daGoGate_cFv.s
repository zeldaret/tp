...
/* 80BFDDF4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BFDDF8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BFDDFC  38 80 00 10 */	li r4, 0x10
/* 80BFDE00  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BFDE04  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BFDE08  4B 5A 59 BD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BFDE0C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BFDE10  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BFDE14  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80BFDE18  80 84 00 04 */	lwz r4, 4(r4)
/* 80BFDE1C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BFDE20  4B 5A 6F 81 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BFDE24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BFDE28  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BFDE2C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80BFDE30  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BFDE34  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BFDE48  4B 40 FE 7D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80BFDE4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BFDE50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
