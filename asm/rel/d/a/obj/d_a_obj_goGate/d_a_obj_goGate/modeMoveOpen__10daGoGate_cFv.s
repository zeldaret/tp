...
/* 80BFDB0C  3C 60 80 C0 */	lis r3, lit_3627@ha /* 0x80BFDFE8@ha */
/* 80BFDB10  3B E3 DF E8 */	addi r31, r3, lit_3627@l /* 0x80BFDFE8@l */
/* 80BFDB14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BFDB18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BFDB1C  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80BFDB20  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80BFDB24  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80BFDB28  4B 40 E6 E1 */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80BFDB40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BFDB44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BFDB48  38 81 00 0C */	addi r4, r1, 0xc
/* 80BFDB4C  7C 85 23 78 */	mr r5, r4
/* 80BFDB50  4B 74 92 1D */	bl PSMTXMultVec
/* 80BFDB54  38 61 00 0C */	addi r3, r1, 0xc
/* 80BFDB58  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80BFDB5C  7C 65 1B 78 */	mr r5, r3
/* 80BFDB60  4B 74 95 31 */	bl PSVECAdd
/* 80BFDB64  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80BFDB68  7C 03 07 74 */	extsb r3, r0
/* 80BFDB6C  4B 42 F5 01 */	bl dComIfGp_getReverb__Fi
...
/* 80BFDB80  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BFDB84  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BFDBAC  4B 6A E9 61 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80BFDBB0  38 7E 05 B4 */	addi r3, r30, 0x5b4
/* 80BFDBB4  C0 3E 05 B0 */	lfs f1, 0x5b0(r30)
/* 80BFDBB8  C0 5F 00 18 */	lfs f2, 0x18(r31)
/* 80BFDBBC  3C 80 80 C0 */	lis r4, l_HIO@ha /* 0x80BFE11C@ha */
/* 80BFDBC0  38 84 E1 1C */	addi r4, r4, l_HIO@l /* 0x80BFE11C@l */
/* 80BFDBC4  C0 64 00 04 */	lfs f3, 4(r4)
/* 80BFDBC8  C0 9F 00 1C */	lfs f4, 0x1c(r31)
/* 80BFDBCC  4B 67 1D B1 */	bl cLib_addCalc__FPfffff
