...
/* 80C5C078  3C 80 80 C6 */	lis r4, l_arcName@ha
/* 80C5C07C  38 84 C3 F0 */	addi r4, r4, l_arcName@l
/* 80C5C080  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C5C084  4B 3D 0E 38 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C5C0A0  3C 80 80 C6 */	lis r4, l_arcName@ha
/* 80C5C0A4  38 84 C3 F0 */	addi r4, r4, l_arcName@l
/* 80C5C0A8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C5C0AC  3C A0 80 C6 */	lis r5, l_dzbIdx@ha
/* 80C5C0B0  38 A5 C3 C4 */	addi r5, r5, l_dzbIdx@l
/* 80C5C0B4  7C A5 00 2E */	lwzx r5, r5, r0
/* 80C5C0B8  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C5C0BC  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C5C0C0  3C E0 80 C6 */	lis r7, l_heap_size@ha
/* 80C5C0C4  38 E7 C3 D4 */	addi r7, r7, l_heap_size@l
/* 80C5C0C8  7C E7 00 2E */	lwzx r7, r7, r0
/* 80C5C0CC  39 00 00 00 */	li r8, 0
/* 80C5C0D0  4B 41 C6 EC */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
