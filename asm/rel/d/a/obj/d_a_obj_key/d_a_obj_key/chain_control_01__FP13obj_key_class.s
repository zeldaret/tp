...
/* 80C3FBF8  4B 72 25 C1 */	bl _savegpr_20
/* 80C3FBFC  7C 7F 1B 78 */	mr r31, r3
/* 80C3FC00  3C 60 80 C4 */	lis r3, lit_3778@ha /* 0x80C40FEC@ha */
/* 80C3FC04  3B A3 0F EC */	addi r29, r3, lit_3778@l /* 0x80C40FEC@l */
/* 80C3FC08  38 61 00 90 */	addi r3, r1, 0x90
/* 80C3FC0C  4B 43 79 71 */	bl __ct__11dBgS_GndChkFv
/* 80C3FC10  80 1F 04 A4 */	lwz r0, 0x4a4(r31)
/* 80C3FC14  90 01 00 14 */	stw r0, 0x14(r1)
/* 80C3FC18  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80C3FC1C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80C3FC20  38 81 00 14 */	addi r4, r1, 0x14
/* 80C3FC24  4B 3D 9B D5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80C3FC28  7C 7E 1B 78 */	mr r30, r3
/* 80C3FC2C  80 1F 05 E4 */	lwz r0, 0x5e4(r31)
/* 80C3FC30  90 01 00 10 */	stw r0, 0x10(r1)
/* 80C3FC34  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80C3FC38  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80C3FC3C  38 81 00 10 */	addi r4, r1, 0x10
/* 80C3FC40  4B 3D 9B B9 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C3FC84  4B 3D E0 39 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80C3FC88  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C3FC8C  41 82 00 18 */	beq lbl_80C3FCA4
/* 80C3FC90  C0 3D 00 2C */	lfs f1, 0x2c(r29)
/* 80C3FC94  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80C3FC98  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 80C3FCD4  4B 3D 9F A9 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 80C3FCD8  38 61 00 90 */	addi r3, r1, 0x90
/* 80C3FCDC  38 80 FF FF */	li r4, -1
/* 80C3FCE0  4B 43 79 11 */	bl __dt__11dBgS_GndChkFv
...
/* 80C3FD50  4B 3E D3 1D */	bl dComIfGp_getReverb__Fi
...
/* 80C3FD64  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C3FD68  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C3FD90  4B 66 C7 7D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C3FDD4  3C 60 80 C4 */	lis r3, l_HIO@ha /* 0x80C41148@ha */
/* 80C3FDD8  38 63 11 48 */	addi r3, r3, l_HIO@l /* 0x80C41148@l */
...
/* 80C3FE10  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80C3FE14  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80C3FE18  80 84 00 00 */	lwz r4, 0(r4)
/* 80C3FE1C  4B 70 66 95 */	bl PSMTXCopy
...
/* 80C3FE40  4B 63 10 AD */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80C3FE64  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80C3FE68  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80C3FE6C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C3FE70  4B 70 66 41 */	bl PSMTXCopy
...
/* 80C3FE94  4B 63 10 59 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80C3FECC  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80C3FED0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80C3FED4  80 84 00 00 */	lwz r4, 0(r4)
/* 80C3FED8  4B 70 65 D9 */	bl PSMTXCopy
...
/* 80C3FF04  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80C3FF08  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80C3FF0C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C3FF10  4B 70 65 A1 */	bl PSMTXCopy
...
/* 80C3FF34  4B 63 0F B9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80C3FF48  4B 3D 9D 35 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 80C3FF4C  7F E3 FB 78 */	mr r3, r31
/* 80C3FF50  4B 3D 9D 2D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80C3FF74  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80C3FF78  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80C3FF7C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C3FF80  4B 70 65 31 */	bl PSMTXCopy
...
/* 80C3FFA0  4B 63 0F 4D */	bl MtxPosition__FP4cXyzP4cXyz
...
lbl_80C40000:
/* 80C40000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C40004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C40020  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80C40024  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80C40028  80 84 00 00 */	lwz r4, 0(r4)
/* 80C4002C  4B 70 64 85 */	bl PSMTXCopy
...
/* 80C40050  4B 63 0E 9D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80C40068  3C 60 80 C4 */	lis r3, target_info_count@ha /* 0x80C41158@ha */
/* 80C4006C  B0 03 11 58 */	sth r0, target_info_count@l(r3)  /* 0x80C41158@l */
/* 80C40070  3C 60 80 C4 */	lis r3, s_count_sub__FPvPv@ha /* 0x80C3F4D4@ha */
/* 80C40074  38 63 F4 D4 */	addi r3, r3, s_count_sub__FPvPv@l /* 0x80C3F4D4@l */
/* 80C40078  7F E4 FB 78 */	mr r4, r31
/* 80C4007C  4B 3E 12 BD */	bl fpcEx_Search__FPFPvPv_PvPv
lbl_80C40080:
...
/* 80C40118  4B 62 78 75 */	bl cM_rndFX__Ff
...
/* 80C40134  4B 62 75 41 */	bl cM_atan2s__Fff
...
/* 80C40160  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C40164  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80C40168  80 63 00 00 */	lwz r3, 0(r3)
/* 80C4016C  A8 9F 06 14 */	lha r4, 0x614(r31)
/* 80C40170  4B 3C C2 6D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80C40188  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C4018C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C401E4  4B 62 69 51 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C40200  4B 62 74 75 */	bl cM_atan2s__Fff
...
lbl_80C40220:
/* 80C40220  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C40224  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80C40228  80 63 00 00 */	lwz r3, 0(r3)
/* 80C4022C  38 04 D8 F0 */	addi r0, r4, -10000
/* 80C40230  7C 04 07 34 */	extsh r4, r0
/* 80C40234  4B 3C C1 A9 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80C40248  4B 70 6E F1 */	bl PSVECSquareMag
...
/* 80C402B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C402BC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C40328  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C4032C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C40330:
/* 80C40330  D0 21 00 8C */	stfs f1, 0x8c(r1)
/* 80C40334  38 61 00 84 */	addi r3, r1, 0x84
/* 80C40338  38 81 00 3C */	addi r4, r1, 0x3c
/* 80C4033C  4B 63 0B B1 */	bl MtxPosition__FP4cXyzP4cXyz
lbl_80C40340:
...
/* 80C40358  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4035C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C40360  3A C3 0F 38 */	addi r22, r3, 0xf38
/* 80C40364  C3 FD 00 1C */	lfs f31, 0x1c(r29)
/* 80C40368  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C4036C  3B 63 07 68 */	addi r27, r3, calc_mtx@l /* 0x80450768@l */
/* 80C40370  3C 60 80 43 */	lis r3, g_Counter@ha /* 0x80430CD8@ha */
/* 80C40374  3A E3 0C D8 */	addi r23, r3, g_Counter@l /* 0x80430CD8@l */
lbl_80C40378:
...
/* 80C40400  4B 62 72 75 */	bl cM_atan2s__Fff
...
/* 80C404CC  4B 62 78 41 */	bl SetPos__11cBgS_GndChkFPC3Vec
/* 80C404D0  7E C3 B3 78 */	mr r3, r22
/* 80C404D4  38 81 00 90 */	addi r4, r1, 0x90
/* 80C404D8  4B 43 3F C9 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80C40578  3C 60 80 C4 */	lis r3, l_HIO@ha /* 0x80C41148@ha */
/* 80C4057C  3B C3 11 48 */	addi r30, r3, l_HIO@l /* 0x80C41148@l */
/* 80C40580  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C40584  3A E3 07 68 */	addi r23, r3, calc_mtx@l /* 0x80450768@l */
lbl_80C40588:
...
/* 80C405E4  4B 3C BE E9 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80C405F8  4B 63 08 AD */	bl MtxScale__FfffUc
/* 80C405FC  2C 19 00 01 */	cmpwi r25, 1
/* 80C40600  40 82 00 20 */	bne lbl_80C40620
/* 80C40604  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C40608  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80C4061C  4B 3C BD 81 */	bl mDoMtx_XrotM__FPA4_fs
lbl_80C40620:
...
/* 80C40630  4B 63 08 2D */	bl MtxTrans__FfffUc
/* 80C40634  80 77 00 00 */	lwz r3, 0(r23)
/* 80C40638  38 80 C0 00 */	li r4, -16384
/* 80C4063C  4B 3C BD 61 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80C40650  4B 70 5E 61 */	bl PSMTXCopy
...
/* 80C40674  4B 63 08 79 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80C406A8  4B 43 6F 49 */	bl __dt__11dBgS_GndChkFv
lbl_80C406AC:
...
/* 80C406D8  4B 72 1B 2D */	bl _restgpr_20
