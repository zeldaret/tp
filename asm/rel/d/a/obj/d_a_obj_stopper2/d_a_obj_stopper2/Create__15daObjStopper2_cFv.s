...
/* 80CEF45C  4B 67 2D 75 */	bl _savegpr_26
/* 80CEF460  7C 7F 1B 78 */	mr r31, r3
/* 80CEF464  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CEF468  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CEF47C  4B 34 5E E5 */	bl isSwitch__10dSv_info_cCFii
/* 80CEF480  2C 03 00 00 */	cmpwi r3, 0
/* 80CEF484  40 82 00 1C */	bne lbl_80CEF4A0
/* 80CEF488  3C 60 80 CF */	lis r3, lit_3722@ha /* 0x80CEFE90@ha */
/* 80CEF48C  C0 03 FE 90 */	lfs f0, lit_3722@l(r3)  /* 0x80CEFE90@l */
...
/* 80CEF4B8  3C 60 80 CF */	lis r3, lit_3723@ha /* 0x80CEFE94@ha */
/* 80CEF4BC  C0 23 FE 94 */	lfs f1, lit_3723@l(r3)  /* 0x80CEFE94@l */
...
/* 80CEF4F4  4B 32 B0 85 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80CEF504  3C 60 80 CF */	lis r3, l_arcName@ha /* 0x80CEFF24@ha */
/* 80CEF508  80 03 FF 24 */	lwz r0, l_arcName@l(r3)  /* 0x80CEFF24@l */
...
/* 80CEF51C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CEF520  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CEF524  3B 63 4F F8 */	addi r27, r3, 0x4ff8
/* 80CEF528  3C 60 80 CF */	lis r3, l_evName@ha /* 0x80CEFF28@ha */
/* 80CEF52C  3B 83 FF 28 */	addi r28, r3, l_evName@l /* 0x80CEFF28@l */
lbl_80CEF530:
...
/* 80CEF540  4B 35 82 19 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 80CEF568  4B 67 2C B5 */	bl _restgpr_26
