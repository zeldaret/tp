...
/* 80BB6FE4  4B 7A B1 E5 */	bl _savegpr_24
...
/* 80BB6FFC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BB7000  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BB7004  3F E3 00 02 */	addis r31, r3, 2
/* 80BB7008  3B FF C2 F8 */	addi r31, r31, -15624
/* 80BB700C  1C 9A 00 0C */	mulli r4, r26, 0xc
/* 80BB7010  3C 60 80 BB */	lis r3, BMD_IDX@ha /* 0x80BB7F24@ha */
/* 80BB7014  38 03 7F 24 */	addi r0, r3, BMD_IDX@l /* 0x80BB7F24@l */
/* 80BB7018  7F 20 22 14 */	add r25, r0, r4
/* 80BB701C  3C 60 80 BC */	lis r3, l_arcName@ha /* 0x80BB803C@ha */
/* 80BB7020  3B 63 80 3C */	addi r27, r3, l_arcName@l /* 0x80BB803C@l */
...
/* 80BB7038  4B 48 52 B5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BB703C  3C 80 00 08 */	lis r4, 8
/* 80BB7040  38 BC 00 84 */	addi r5, r28, 0x84
/* 80BB7044  4B 45 DC 11 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80BB7080  4B 71 7B CD */	bl __nw__FUl
/* 80BB7084  7C 60 1B 79 */	or. r0, r3, r3
/* 80BB7088  41 82 00 0C */	beq lbl_80BB7094
/* 80BB708C  4B 4C 48 E5 */	bl __ct__4dBgWFv
...
lbl_80BB70AC:
/* 80BB70AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BB70B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BB70B4  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80BB70B8  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80BB70BC  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80BB70C0  4B 78 F8 29 */	bl PSMTXTrans
/* 80BB70C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BB70C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BB70CC  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80BB70D0  4B 45 53 65 */	bl mDoMtx_YrotM__FPA4_fs
/* 80BB70D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BB70D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BB70DC  38 9E 05 7C */	addi r4, r30, 0x57c
/* 80BB70E0  4B 78 F3 D1 */	bl PSMTXCopy
/* 80BB70E4  3C 60 80 BC */	lis r3, l_arcName@ha /* 0x80BB803C@ha */
/* 80BB70E8  38 63 80 3C */	addi r3, r3, l_arcName@l /* 0x80BB803C@l */
...
/* 80BB70FC  4B 48 51 F1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BB7110  4B 4C 2E 29 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80BB7130  4B 7A B0 E5 */	bl _restgpr_24
