...
/* 80C747A4  4B 6E DA 1D */	bl _savegpr_22
/* 80C747A8  7C 7B 1B 78 */	mr r27, r3
/* 80C747AC  7C 9C 23 78 */	mr r28, r4
/* 80C747B0  3C 80 80 C7 */	lis r4, lit_3633@ha /* 0x80C75524@ha */
/* 80C747B4  3B E4 55 24 */	addi r31, r4, lit_3633@l /* 0x80C75524@l */
...
/* 80C747D0  4B 40 FC 91 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 80C747D4  28 03 00 00 */	cmplwi r3, 0
/* 80C747D8  41 82 00 24 */	beq lbl_80C747FC
/* 80C747DC  7F 23 CB 78 */	mr r3, r25
/* 80C747E0  4B 40 FD 69 */	bl GetTgHitGObj__12dCcD_GObjInfFv
...
/* 80C74814  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C74818  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C74838  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C7483C  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_80C74840:
...
/* 80C7490C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C74910  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_80C74914:
...
/* 80C749F4  4B 40 6F CD */	bl Move__4dBgWFv
lbl_80C749F8:
...
/* 80C74A28  4B 6E D7 E5 */	bl _restgpr_22
