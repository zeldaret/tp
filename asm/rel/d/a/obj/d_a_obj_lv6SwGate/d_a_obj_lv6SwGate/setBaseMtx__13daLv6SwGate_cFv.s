...
/* 80C74018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7401C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C74020  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C74024  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C74028  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C7402C  4B 6D 28 BC */	b PSMTXTrans
/* 80C74030  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C74034  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C74038  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C7403C  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C74040  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C74044  4B 39 82 5C */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C74048  3C 60 80 C7 */	lis r3, lit_3674@ha
/* 80C7404C  C0 23 55 60 */	lfs f1, lit_3674@l(r3)
/* 80C74050  C0 1F 14 C0 */	lfs f0, 0x14c0(r31)
/* 80C74054  EC 21 00 28 */	fsubs f1, f1, f0
/* 80C74058  3C 60 80 C7 */	lis r3, lit_3675@ha
/* 80C7405C  C0 43 55 64 */	lfs f2, lit_3675@l(r3)
/* 80C74060  FC 60 10 90 */	fmr f3, f2
/* 80C74064  4B 39 8D 38 */	b transM__14mDoMtx_stack_cFfff
...
/* 80C74084  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C74088  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7408C  80 9F 14 B4 */	lwz r4, 0x14b4(r31)
/* 80C74090  38 84 00 24 */	addi r4, r4, 0x24
/* 80C74094  4B 6D 24 1C */	b PSMTXCopy
/* 80C74098  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7409C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C740A0  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80C740A4  4B 6D 24 0C */	b PSMTXCopy
/* 80C740A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C740AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C740B0  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C740B4  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C740B8  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C740BC  4B 6D 28 2C */	b PSMTXTrans
/* 80C740C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C740C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C740E0  4B 39 81 C0 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C740E4  3C 60 80 C7 */	lis r3, lit_3674@ha
/* 80C740E8  C0 23 55 60 */	lfs f1, lit_3674@l(r3)
/* 80C740EC  C0 1F 14 C0 */	lfs f0, 0x14c0(r31)
/* 80C740F0  EC 21 00 28 */	fsubs f1, f1, f0
/* 80C740F4  3C 60 80 C7 */	lis r3, lit_3675@ha
/* 80C740F8  C0 43 55 64 */	lfs f2, lit_3675@l(r3)
/* 80C740FC  FC 60 10 90 */	fmr f3, f2
/* 80C74100  4B 39 8C 9C */	b transM__14mDoMtx_stack_cFfff
...
/* 80C74120  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C74124  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C74128  80 9F 14 B8 */	lwz r4, 0x14b8(r31)
/* 80C7412C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C74130  4B 6D 23 80 */	b PSMTXCopy
/* 80C74134  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C74138  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7413C  38 9F 14 C8 */	addi r4, r31, 0x14c8
/* 80C74140  4B 6D 23 70 */	b PSMTXCopy
