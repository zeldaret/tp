...
/* 80C1761C  4B 46 C4 0D */	bl __ct__12dCcD_GObjInfFv
/* 80C17620  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C17624  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C17628  90 1F 01 20 */	stw r0, 0x120(r31)
/* 80C1762C  3C 60 80 C2 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C181FC@ha */
/* 80C17630  38 03 81 FC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C181FC@l */
/* 80C17634  90 1F 01 1C */	stw r0, 0x11c(r31)
/* 80C17638  3C 60 80 C2 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C18208@ha */
/* 80C1763C  38 03 82 08 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C18208@l */
/* 80C17640  90 1F 01 38 */	stw r0, 0x138(r31)
/* 80C17644  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C17648  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80C1764C  90 7F 01 20 */	stw r3, 0x120(r31)
/* 80C17650  38 03 00 58 */	addi r0, r3, 0x58
/* 80C17654  90 1F 01 38 */	stw r0, 0x138(r31)
/* 80C17658  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C1765C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
