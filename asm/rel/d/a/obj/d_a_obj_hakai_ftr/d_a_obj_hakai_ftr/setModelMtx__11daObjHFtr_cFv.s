...
/* 80C17E24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C17E28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C17E2C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C17E30  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C17E34  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C17E38  4B 72 EA B1 */	bl PSMTXTrans
/* 80C17E3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C17E40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C17E44  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C17E48  4B 3F 45 ED */	bl mDoMtx_YrotM__FPA4_fs
/* 80C17E4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C17E50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C17E54  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C17E58  38 84 00 24 */	addi r4, r4, 0x24
/* 80C17E5C  4B 72 E6 55 */	bl PSMTXCopy
