...
/* 80C1755C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C17560  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C17580  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C17584  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80C1759C  3C 60 80 C2 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C18208@ha */
/* 80C175A0  38 03 82 08 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C18208@l */
/* 80C175A4  90 1E 01 38 */	stw r0, 0x138(r30)
lbl_80C175A8:
/* 80C175A8  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80C175AC  41 82 00 24 */	beq lbl_80C175D0
/* 80C175B0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C175B4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C175B8  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C175BC  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80C175C0  41 82 00 10 */	beq lbl_80C175D0
/* 80C175C4  3C 60 80 C2 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C181FC@ha */
/* 80C175C8  38 03 81 FC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C181FC@l */
/* 80C175CC  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_80C175D0:
/* 80C175D0  7F C3 F3 78 */	mr r3, r30
/* 80C175D4  38 80 00 00 */	li r4, 0
/* 80C175D8  4B 46 CB 0D */	bl __dt__12dCcD_GObjInfFv
/* 80C175DC  7F E0 07 35 */	extsh. r0, r31
/* 80C175E0  40 81 00 0C */	ble lbl_80C175EC
/* 80C175E4  7F C3 F3 78 */	mr r3, r30
/* 80C175E8  4B 6B 77 55 */	bl __dl__FPv
lbl_80C175EC:
