...
/* 80C17884  4B 74 A9 55 */	bl _savegpr_28
/* 80C17888  7C 7E 1B 78 */	mr r30, r3
/* 80C1788C  80 03 00 B0 */	lwz r0, 0xb0(r3)
/* 80C17890  54 1F 16 BA */	rlwinm r31, r0, 2, 0x1a, 0x1d
/* 80C17894  3C 60 80 C2 */	lis r3, l_arcName@ha /* 0x80C1817C@ha */
/* 80C17898  3B A3 81 7C */	addi r29, r3, l_arcName@l /* 0x80C1817C@l */
/* 80C1789C  7C 7D F8 2E */	lwzx r3, r29, r31
/* 80C178A0  3C 80 80 C2 */	lis r4, l_bmdIdx@ha /* 0x80C180B8@ha */
/* 80C178A4  38 84 80 B8 */	addi r4, r4, l_bmdIdx@l /* 0x80C180B8@l */
/* 80C178A8  7C 84 F8 2E */	lwzx r4, r4, r31
/* 80C178AC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C178B0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C178C4  4B 42 4A 29 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C178D4  4B 3F D3 81 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C178F4  4B 6B 73 59 */	bl __nw__FUl
/* 80C178F8  7C 60 1B 79 */	or. r0, r3, r3
/* 80C178FC  41 82 00 0C */	beq lbl_80C17908
/* 80C17900  4B 46 40 71 */	bl __ct__4dBgWFv
...
lbl_80C17920:
/* 80C17920  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C17924  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C17928  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80C1792C  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80C17930  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80C17934  4B 72 EF B5 */	bl PSMTXTrans
/* 80C17938  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C1793C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C17940  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80C17944  4B 3F 4A F1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C17948  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C1794C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C17950  38 9E 05 74 */	addi r4, r30, 0x574
/* 80C17954  4B 72 EB 5D */	bl PSMTXCopy
/* 80C17958  7C 7D F8 2E */	lwzx r3, r29, r31
/* 80C1795C  3C 80 80 C2 */	lis r4, l_dzbIdx@ha /* 0x80C180C4@ha */
/* 80C17960  38 84 80 C4 */	addi r4, r4, l_dzbIdx@l /* 0x80C180C4@l */
/* 80C17964  7C 84 F8 2E */	lwzx r4, r4, r31
/* 80C17968  7F 85 E3 78 */	mr r5, r28
/* 80C1796C  38 C0 00 80 */	li r6, 0x80
/* 80C17970  4B 42 49 7D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C17984  4B 46 25 B5 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80C1799C  4B 74 A8 89 */	bl _restgpr_28
