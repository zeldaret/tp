...
/* 80BEEC74  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BEEC78  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BEEC7C  38 80 00 10 */	li r4, 0x10
/* 80BEEC80  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BEEC84  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BEEC88  4B 5B 4B 3D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BEEC8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BEEC90  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BEEC94  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80BEEC98  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BEEC9C  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
/* 80BEECA0  90 1F 00 48 */	stw r0, 0x48(r31)
/* 80BEECA4  80 04 5F 74 */	lwz r0, 0x5f74(r4)
/* 80BEECA8  90 1F 00 4C */	stw r0, 0x4c(r31)
/* 80BEECAC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BEECB0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BEECB4  80 9E 05 68 */	lwz r4, 0x568(r30)
/* 80BEECB8  80 84 00 04 */	lwz r4, 4(r4)
/* 80BEECBC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BEECC0  4B 5B 60 E1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BEECC4  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 80BEECC8  4B 41 EF FD */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80BEECE4  4B 73 67 A9 */	bl entryImm__13J3DDrawBufferFP9J3DPacketUs
lbl_80BEECE8:
/* 80BEECE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BEECEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
