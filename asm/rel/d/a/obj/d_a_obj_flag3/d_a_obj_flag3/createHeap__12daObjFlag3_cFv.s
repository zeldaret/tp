...
/* 80BEEA88  4B 77 37 55 */	bl _savegpr_29
...
/* 80BEEAAC  3C 80 80 BF */	lis r4, d_a_obj_flag3__stringBase0@ha /* 0x80BF0554@ha */
/* 80BEEAB0  38 84 05 54 */	addi r4, r4, d_a_obj_flag3__stringBase0@l /* 0x80BF0554@l */
/* 80BEEAB4  4C C6 31 82 */	crclr 6
/* 80BEEAB8  4B 77 7A 25 */	bl sprintf
...
/* 80BEEADC  3C 80 80 BF */	lis r4, d_a_obj_flag3__stringBase0@ha /* 0x80BF0554@ha */
/* 80BEEAE0  38 84 05 54 */	addi r4, r4, d_a_obj_flag3__stringBase0@l /* 0x80BF0554@l */
/* 80BEEAE4  38 84 00 0D */	addi r4, r4, 0xd
/* 80BEEAE8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BEEAEC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BEEAF0  3C A5 00 02 */	addis r5, r5, 2
/* 80BEEAF4  38 C0 00 80 */	li r6, 0x80
/* 80BEEAF8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BEEAFC  4B 44 D8 81 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80BEEB34  4B 76 F3 0D */	bl GXInitTexObj
...
/* 80BEEB50  3C C0 80 BF */	lis r6, lit_3813@ha /* 0x80BF04F8@ha */
/* 80BEEB54  C0 46 04 F8 */	lfs f2, lit_3813@l(r6)  /* 0x80BF04F8@l */
/* 80BEEB58  88 1F 00 16 */	lbz r0, 0x16(r31)
/* 80BEEB5C  7C 00 07 74 */	extsb r0, r0
/* 80BEEB60  3C C0 80 BF */	lis r6, lit_3816@ha /* 0x80BF0500@ha */
/* 80BEEB64  C8 86 05 00 */	lfd f4, lit_3816@l(r6)  /* 0x80BF0500@l */
...
/* 80BEEBA4  3C C0 80 BF */	lis r6, lit_3814@ha /* 0x80BF04FC@ha */
/* 80BEEBA8  C0 66 04 FC */	lfs f3, lit_3814@l(r6)  /* 0x80BF04FC@l */
...
/* 80BEEBD4  4B 76 F5 01 */	bl GXInitTexObjLOD
lbl_80BEEBD8:
/* 80BEEBD8  7F C3 F3 78 */	mr r3, r30
/* 80BEEBDC  4B 44 2C 95 */	bl getArcName__12daSetBgObj_cFP10fopAc_ac_c
/* 80BEEBE0  3C 80 80 BF */	lis r4, d_a_obj_flag3__stringBase0@ha /* 0x80BF0554@ha */
/* 80BEEBE4  38 84 05 54 */	addi r4, r4, d_a_obj_flag3__stringBase0@l /* 0x80BF0554@l */
/* 80BEEBE8  38 84 00 16 */	addi r4, r4, 0x16
/* 80BEEBEC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BEEBF0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BEEBF4  3C A5 00 02 */	addis r5, r5, 2
/* 80BEEBF8  38 C0 00 80 */	li r6, 0x80
/* 80BEEBFC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BEEC00  4B 44 D7 7D */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80BEEC10  4B 42 60 45 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80BEEC28  4B 77 36 01 */	bl _restgpr_29
