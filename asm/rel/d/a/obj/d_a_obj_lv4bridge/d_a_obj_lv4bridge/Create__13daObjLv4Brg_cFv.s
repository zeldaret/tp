...
/* 80C629A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C629AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C629C0  4B 3D 29 A1 */	bl isSwitch__10dSv_info_cCFii
/* 80C629C4  2C 03 00 00 */	cmpwi r3, 0
/* 80C629C8  41 82 00 1C */	beq lbl_80C629E4
/* 80C629CC  3C 60 80 C6 */	lis r3, lit_3676@ha /* 0x80C6317C@ha */
/* 80C629D0  C0 03 31 7C */	lfs f0, lit_3676@l(r3)  /* 0x80C6317C@l */
...
lbl_80C629E4:
/* 80C629E4  3C 60 80 C6 */	lis r3, lit_3653@ha /* 0x80C63170@ha */
/* 80C629E8  C0 03 31 70 */	lfs f0, lit_3653@l(r3)  /* 0x80C63170@l */
...
/* 80C62A10  4B 41 5F 41 */	bl MoveBGExecute__16dBgS_MoveBgActorFv
