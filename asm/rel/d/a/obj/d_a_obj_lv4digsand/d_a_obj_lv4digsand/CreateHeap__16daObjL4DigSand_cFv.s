...
/* 80C66C38  3C 60 80 C6 */	lis r3, l_arcName@ha /* 0x80C6760C@ha */
/* 80C66C3C  38 63 76 0C */	addi r3, r3, l_arcName@l /* 0x80C6760C@l */
/* 80C66C40  80 63 00 00 */	lwz r3, 0(r3)
/* 80C66C44  38 80 00 04 */	li r4, 4
/* 80C66C48  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C66C4C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C66C50  3C A5 00 02 */	addis r5, r5, 2
/* 80C66C54  38 C0 00 80 */	li r6, 0x80
/* 80C66C58  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C66C5C  4B 3D 56 91 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C66C6C  4B 3A DF E9 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
