...
/* 80C66CA8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C66CAC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C66CC0  4B 3C E6 A1 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C66CD8  3C 80 80 C6 */	lis r4, l_arcName@ha /* 0x80C6760C@ha */
/* 80C66CDC  38 84 76 0C */	addi r4, r4, l_arcName@l /* 0x80C6760C@l */
/* 80C66CE0  80 84 00 00 */	lwz r4, 0(r4)
/* 80C66CE4  4B 3C 61 D9 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C66CF8  3C 80 80 C6 */	lis r4, l_arcName@ha /* 0x80C6760C@ha */
/* 80C66CFC  38 84 76 0C */	addi r4, r4, l_arcName@l /* 0x80C6760C@l */
...
/* 80C66D14  4B 41 1A A9 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
