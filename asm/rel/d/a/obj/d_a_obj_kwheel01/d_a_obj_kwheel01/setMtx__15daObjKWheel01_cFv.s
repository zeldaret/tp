...
/* 80C4EC74  4B 71 35 64 */	b _savegpr_28
/* 80C4EC78  7C 7F 1B 78 */	mr r31, r3
/* 80C4EC7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4EC80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4EC84  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C4EC88  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C4EC8C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C4EC90  4B 6F 7C 58 */	b PSMTXTrans
/* 80C4EC94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4EC98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4EC9C  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80C4ECA0  4B 3B D7 94 */	b mDoMtx_YrotM__FPA4_fs
/* 80C4ECA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4ECA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4ECAC  38 9F 05 E8 */	addi r4, r31, 0x5e8
/* 80C4ECB0  4B 6F 78 00 */	b PSMTXCopy
/* 80C4ECB4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4ECB8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4ECBC  38 9F 05 B8 */	addi r4, r31, 0x5b8
/* 80C4ECC0  4B 6F 77 F0 */	b PSMTXCopy
...
/* 80C4ECD4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C4ECD8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C4ECDC  4B 6F 77 D4 */	b PSMTXCopy
/* 80C4ECE0  3C 60 80 C5 */	lis r3, lit_3717@ha
/* 80C4ECE4  C0 23 F6 E4 */	lfs f1, lit_3717@l(r3)
/* 80C4ECE8  4B 61 8C A4 */	b cM_rndFX__Ff
/* 80C4ECEC  FF C0 08 90 */	fmr f30, f1
/* 80C4ECF0  3C 60 80 C5 */	lis r3, lit_3717@ha
/* 80C4ECF4  C0 23 F6 E4 */	lfs f1, lit_3717@l(r3)
/* 80C4ECF8  4B 61 8C 94 */	b cM_rndFX__Ff
/* 80C4ECFC  FF E0 08 90 */	fmr f31, f1
/* 80C4ED00  3C 60 80 C5 */	lis r3, lit_3717@ha
/* 80C4ED04  C0 23 F6 E4 */	lfs f1, lit_3717@l(r3)
/* 80C4ED08  4B 61 8C 84 */	b cM_rndFX__Ff
/* 80C4ED0C  FC 40 F8 90 */	fmr f2, f31
/* 80C4ED10  FC 60 F0 90 */	fmr f3, f30
/* 80C4ED14  4B 3B E0 88 */	b transM__14mDoMtx_stack_cFfff
/* 80C4ED18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4ED1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4ED20  38 9F 05 E8 */	addi r4, r31, 0x5e8
/* 80C4ED24  4B 6F 77 8C */	b PSMTXCopy
lbl_80C4ED28:
...
/* 80C4ED50  3C 80 80 C5 */	lis r4, l_pos@ha
/* 80C4ED54  38 04 F6 FC */	addi r0, r4, l_pos@l
/* 80C4ED58  7C 80 EA 14 */	add r4, r0, r29
/* 80C4ED5C  38 A1 00 08 */	addi r5, r1, 8
/* 80C4ED60  4B 6F 80 0C */	b PSMTXMultVec
/* 80C4ED64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4ED68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4ED6C  C0 21 00 08 */	lfs f1, 8(r1)
/* 80C4ED70  C0 41 00 0C */	lfs f2, 0xc(r1)
/* 80C4ED74  C0 61 00 10 */	lfs f3, 0x10(r1)
/* 80C4ED78  4B 6F 7B 70 */	b PSMTXTrans
/* 80C4ED7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4ED80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4ED84  38 9E 06 40 */	addi r4, r30, 0x640
/* 80C4ED88  7C 9F 22 14 */	add r4, r31, r4
/* 80C4ED8C  4B 6F 77 24 */	b PSMTXCopy
lbl_80C4ED90:
...
/* 80C4EDB8  4B 71 34 6C */	b _restgpr_28
