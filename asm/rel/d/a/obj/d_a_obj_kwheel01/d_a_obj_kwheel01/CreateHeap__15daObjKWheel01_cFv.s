...
/* 80C4EDDC  4B 71 33 F1 */	bl _savegpr_25
/* 80C4EDE0  7C 7C 1B 78 */	mr r28, r3
/* 80C4EDE4  3C 60 80 C5 */	lis r3, l_arcName@ha /* 0x80C4F6F8@ha */
/* 80C4EDE8  38 63 F6 F8 */	addi r3, r3, l_arcName@l /* 0x80C4F6F8@l */
/* 80C4EDEC  80 63 00 00 */	lwz r3, 0(r3)
/* 80C4EDF0  80 1C 00 B0 */	lwz r0, 0xb0(r28)
/* 80C4EDF4  54 00 3F 7A */	rlwinm r0, r0, 7, 0x1d, 0x1d
/* 80C4EDF8  3C 80 80 C5 */	lis r4, l_bmdidx@ha /* 0x80C4F6C4@ha */
/* 80C4EDFC  38 84 F6 C4 */	addi r4, r4, l_bmdidx@l /* 0x80C4F6C4@l */
/* 80C4EE00  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C4EE04  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4EE08  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C4EE1C  4B 3E D4 D1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4EE2C  4B 3C 5E 29 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C4EE54  3C 60 80 C5 */	lis r3, l_dzbidx@ha /* 0x80C4F6B8@ha */
/* 80C4EE58  3B E3 F6 B8 */	addi r31, r3, l_dzbidx@l /* 0x80C4F6B8@l */
lbl_80C4EE5C:
...
/* 80C4EE88  4B 67 FD C5 */	bl __nw__FUl
/* 80C4EE8C  7C 60 1B 79 */	or. r0, r3, r3
/* 80C4EE90  41 82 00 0C */	beq lbl_80C4EE9C
/* 80C4EE94  4B 42 CA DD */	bl __ct__4dBgWFv
...
lbl_80C4EEB8:
/* 80C4EEB8  3C 60 80 C5 */	lis r3, l_arcName@ha /* 0x80C4F6F8@ha */
/* 80C4EEBC  38 63 F6 F8 */	addi r3, r3, l_arcName@l /* 0x80C4F6F8@l */
...
/* 80C4EED0  4B 3E D4 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4EEE8  4B 42 B0 51 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80C4EF24  4B 71 32 F5 */	bl _restgpr_25
