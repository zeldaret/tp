...
/* 80C2603C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C26040  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C26044  38 80 00 20 */	li r4, 0x20
/* 80C26048  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C2604C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80C26050  4B 57 D7 75 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C26054  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C26058  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C2605C  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80C26060  80 84 00 04 */	lwz r4, 4(r4)
/* 80C26064  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C26068  4B 57 ED 39 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C2606C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C26070  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C26074  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C26078  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C2607C  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C26090  4B 3E 7C 35 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C26094  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C26098  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80C260B0:
/* 80C260B0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C260B4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C260B8  38 80 00 10 */	li r4, 0x10
/* 80C260BC  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C260C0  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80C260C4  4B 57 D7 01 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C260C8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C260CC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C260D0  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80C260D4  80 84 00 04 */	lwz r4, 4(r4)
/* 80C260D8  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C260DC  4B 57 EC C5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C260F4  4B 3E 75 E5 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80C260F8  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80C260FC  4B 3E 7B C9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80C26100:
