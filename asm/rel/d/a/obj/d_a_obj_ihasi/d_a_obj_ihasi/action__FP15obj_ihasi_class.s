...
/* 80C2613C  3C 80 80 C2 */	lis r4, lit_3841@ha /* 0x80C26888@ha */
/* 80C26140  3B E4 68 88 */	addi r31, r4, lit_3841@l /* 0x80C26888@l */
...
lbl_80C2616C:
/* 80C2616C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C26170  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C26174  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80C26178  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80C2617C  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80C26180  4B 72 07 69 */	bl PSMTXTrans
...
/* 80C2619C  4B 3E 6C 01 */	bl transM__14mDoMtx_stack_cFfff
/* 80C261A0  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80C261A4  4B 3E 72 85 */	bl play__14mDoExt_baseAnmFv
/* 80C261A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C261AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C261B0  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80C261B4  38 84 00 24 */	addi r4, r4, 0x24
/* 80C261B8  4B 72 02 F9 */	bl PSMTXCopy
/* 80C261BC  48 00 00 30 */	b lbl_80C261EC
lbl_80C261C0:
/* 80C261C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C261C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C261C8  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80C261CC  38 84 00 24 */	addi r4, r4, 0x24
/* 80C261D0  4B 72 02 E1 */	bl PSMTXCopy
/* 80C261D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C261D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C261DC  38 9E 05 88 */	addi r4, r30, 0x588
/* 80C261E0  4B 72 02 D1 */	bl PSMTXCopy
/* 80C261E4  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 80C261E8  4B 45 57 D9 */	bl Move__4dBgWFv
lbl_80C261EC:
