...
/* 80D2CFA8  4B 63 52 21 */	bl _savegpr_24
/* 80D2CFAC  7C 7E 1B 78 */	mr r30, r3
/* 80D2CFB0  3C 60 80 D3 */	lis r3, lit_3746@ha /* 0x80D2E800@ha */
/* 80D2CFB4  C0 03 E8 00 */	lfs f0, lit_3746@l(r3)  /* 0x80D2E800@l */
/* 80D2CFB8  D0 01 00 38 */	stfs f0, 0x38(r1)
/* 80D2CFBC  D0 01 00 3C */	stfs f0, 0x3c(r1)
/* 80D2CFC0  D0 01 00 40 */	stfs f0, 0x40(r1)
/* 80D2CFC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D2CFC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D2CFCC  C0 3E 0B 24 */	lfs f1, 0xb24(r30)
/* 80D2CFD0  C0 5E 0B 28 */	lfs f2, 0xb28(r30)
/* 80D2CFD4  C0 7E 0B 2C */	lfs f3, 0xb2c(r30)
/* 80D2CFD8  4B 61 99 11 */	bl PSMTXTrans
/* 80D2CFDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D2CFE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D2CFE4  38 81 00 38 */	addi r4, r1, 0x38
/* 80D2CFE8  7C 85 23 78 */	mr r5, r4
/* 80D2CFEC  4B 61 9D 81 */	bl PSMTXMultVec
/* 80D2CFF0  38 61 00 20 */	addi r3, r1, 0x20
/* 80D2CFF4  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80D2CFF8  38 A1 00 38 */	addi r5, r1, 0x38
/* 80D2CFFC  4B 53 9A E9 */	bl __pl__4cXyzCFRC3Vec
...
/* 80D2D040  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2D044  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D2D048  3C 60 80 D3 */	lis r3, l_eff@ha /* 0x80D2EA04@ha */
/* 80D2D04C  3B 43 EA 04 */	addi r26, r3, l_eff@l /* 0x80D2EA04@l */
/* 80D2D050  3C 60 80 D3 */	lis r3, lit_3645@ha /* 0x80D2E770@ha */
/* 80D2D054  3B 63 E7 70 */	addi r27, r3, lit_3645@l /* 0x80D2E770@l */
lbl_80D2D058:
...
/* 80D2D0A4  4B 32 04 29 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D2D0FC  3C C0 80 D3 */	lis r6, l_eff@ha /* 0x80D2EA04@ha */
/* 80D2D100  38 C6 EA 04 */	addi r6, r6, l_eff@l /* 0x80D2EA04@l */
...
/* 80D2D118  3D 60 80 D3 */	lis r11, lit_3645@ha /* 0x80D2E770@ha */
/* 80D2D11C  C0 2B E7 70 */	lfs f1, lit_3645@l(r11)  /* 0x80D2E770@l */
/* 80D2D120  4B 32 03 AD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D2D164  3C C0 80 D3 */	lis r6, l_eff@ha /* 0x80D2EA04@ha */
/* 80D2D168  38 C6 EA 04 */	addi r6, r6, l_eff@l /* 0x80D2EA04@l */
...
/* 80D2D180  3D 60 80 D3 */	lis r11, lit_3645@ha /* 0x80D2E770@ha */
/* 80D2D184  C0 2B E7 70 */	lfs f1, lit_3645@l(r11)  /* 0x80D2E770@l */
/* 80D2D188  4B 32 03 45 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D2D1CC  3C C0 80 D3 */	lis r6, l_eff@ha /* 0x80D2EA04@ha */
/* 80D2D1D0  38 C6 EA 04 */	addi r6, r6, l_eff@l /* 0x80D2EA04@l */
...
/* 80D2D1E8  3D 60 80 D3 */	lis r11, lit_3645@ha /* 0x80D2E770@ha */
/* 80D2D1EC  C0 2B E7 70 */	lfs f1, lit_3645@l(r11)  /* 0x80D2E770@l */
/* 80D2D1F0  4B 32 02 DD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D2D234  3C C0 80 D3 */	lis r6, l_eff@ha /* 0x80D2EA04@ha */
/* 80D2D238  38 C6 EA 04 */	addi r6, r6, l_eff@l /* 0x80D2EA04@l */
...
/* 80D2D250  3D 60 80 D3 */	lis r11, lit_3645@ha /* 0x80D2E770@ha */
/* 80D2D254  C0 2B E7 70 */	lfs f1, lit_3645@l(r11)  /* 0x80D2E770@l */
/* 80D2D258  4B 32 02 75 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80D2D25C  90 7E 0B 60 */	stw r3, 0xb60(r30)
lbl_80D2D260:
/* 80D2D260  39 61 00 70 */	addi r11, r1, 0x70
/* 80D2D264  4B 63 4F B1 */	bl _restgpr_24
