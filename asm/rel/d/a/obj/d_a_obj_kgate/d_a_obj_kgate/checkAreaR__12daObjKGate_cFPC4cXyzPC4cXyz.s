...
/* 805890E4  4B DD 90 F5 */	bl _savegpr_28
/* 805890E8  7C 7D 1B 78 */	mr r29, r3
/* 805890EC  3C 60 80 59 */	lis r3, l_gateBmdIdx@ha /* 0x8058AB30@ha */
/* 805890F0  3B E3 AB 30 */	addi r31, r3, l_gateBmdIdx@l /* 0x8058AB30@l */
/* 805890F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805890F8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80589140  3C 60 80 59 */	lis r3, search_coach__FPvPv@ha /* 0x80588078@ha */
/* 80589144  38 63 80 78 */	addi r3, r3, search_coach__FPvPv@l /* 0x80588078@l */
/* 80589148  7F A4 EB 78 */	mr r4, r29
/* 8058914C  4B A9 06 AD */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80589150  7C 7C 1B 79 */	or. r28, r3, r3
/* 80589154  41 82 00 CC */	beq lbl_80589220
/* 80589158  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 8058915C  4B A8 3C 09 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80589160  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80589164  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80589168  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 8058916C  4B A8 32 C9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80589170  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80589174  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80589178  38 81 00 2C */	addi r4, r1, 0x2c
/* 8058917C  7C 85 23 78 */	mr r5, r4
/* 80589180  4B DB DB ED */	bl PSMTXMultVec
...
/* 805891A8  4B DB D4 09 */	bl PSMTXInverse
/* 805891AC  38 61 00 74 */	addi r3, r1, 0x74
/* 805891B0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805891B4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805891B8  4B DB D2 F9 */	bl PSMTXCopy
/* 805891BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805891C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805891C4  38 81 00 38 */	addi r4, r1, 0x38
/* 805891C8  7C 85 23 78 */	mr r5, r4
/* 805891CC  4B DB DB A1 */	bl PSMTXMultVec
...
/* 80589234  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80589238  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058924C  4B A8 3B 19 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80589250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80589254  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80589258  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 8058925C  4B A8 31 D9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80589260  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80589264  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80589268  38 81 00 2C */	addi r4, r1, 0x2c
/* 8058926C  7C 85 23 78 */	mr r5, r4
/* 80589270  4B DB DA FD */	bl PSMTXMultVec
...
/* 80589298  4B DB D3 19 */	bl PSMTXInverse
/* 8058929C  38 61 00 74 */	addi r3, r1, 0x74
/* 805892A0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805892A4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805892A8  4B DB D2 09 */	bl PSMTXCopy
/* 805892AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805892B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805892B4  38 81 00 38 */	addi r4, r1, 0x38
/* 805892B8  7C 85 23 78 */	mr r5, r4
/* 805892BC  4B DB DA B1 */	bl PSMTXMultVec
...
/* 80589390  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80589394  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_805893D0:
/* 805893D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805893D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805893D8  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 805893DC  4B A8 30 01 */	bl mDoMtx_YrotS__FPA4_fs
/* 805893E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805893E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805893E8  38 81 00 08 */	addi r4, r1, 8
/* 805893EC  7C 85 23 78 */	mr r5, r4
/* 805893F0  4B DB D9 7D */	bl PSMTXMultVec
/* 805893F4  38 61 00 38 */	addi r3, r1, 0x38
/* 805893F8  38 81 00 08 */	addi r4, r1, 8
/* 805893FC  7C 65 1B 78 */	mr r5, r3
/* 80589400  4B DB DC 91 */	bl PSVECAdd
/* 80589404  80 7D 05 AC */	lwz r3, 0x5ac(r29)
/* 80589408  38 63 00 24 */	addi r3, r3, 0x24
/* 8058940C  38 81 00 44 */	addi r4, r1, 0x44
/* 80589410  4B DB D1 A1 */	bl PSMTXInverse
/* 80589414  38 61 00 44 */	addi r3, r1, 0x44
/* 80589418  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058941C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80589420  4B DB D0 91 */	bl PSMTXCopy
/* 80589424  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80589428  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058942C  38 81 00 38 */	addi r4, r1, 0x38
/* 80589430  7C 85 23 78 */	mr r5, r4
/* 80589434  4B DB D9 39 */	bl PSMTXMultVec
...
/* 80589490  4B DD 8D 95 */	bl _restgpr_28
