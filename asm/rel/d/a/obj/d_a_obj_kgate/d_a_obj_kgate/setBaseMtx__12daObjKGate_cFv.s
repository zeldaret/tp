...
/* 8058828C  4B DD 9F 50 */	b _savegpr_29
/* 80588290  7C 7F 1B 78 */	mr r31, r3
/* 80588294  3C 60 80 59 */	lis r3, l_gateBmdIdx@ha
/* 80588298  3B C3 AB 30 */	addi r30, r3, l_gateBmdIdx@l
...
lbl_805882FC:
/* 805882FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588300  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80588304  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80588308  4B A8 40 D4 */	b mDoMtx_YrotS__FPA4_fs
/* 8058830C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588310  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80588314  38 81 00 5C */	addi r4, r1, 0x5c
/* 80588318  7C 85 23 78 */	mr r5, r4
/* 8058831C  4B DB EA 50 */	b PSMTXMultVec
/* 80588320  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588324  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80588328  38 81 00 50 */	addi r4, r1, 0x50
/* 8058832C  7C 85 23 78 */	mr r5, r4
/* 80588330  4B DB EA 3C */	b PSMTXMultVec
/* 80588334  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80588338  4B A8 4A 2C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 8058833C  38 61 00 5C */	addi r3, r1, 0x5c
/* 80588340  4B A8 4A 94 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80588344  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588348  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8058834C  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80588350  4B A8 40 E4 */	b mDoMtx_YrotM__FPA4_fs
/* 80588354  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588358  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8058835C  A8 9F 0B 7A */	lha r4, 0xb7a(r31)
/* 80588360  4B A8 40 D4 */	b mDoMtx_YrotM__FPA4_fs
/* 80588364  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588368  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8058836C  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80588370  38 84 00 24 */	addi r4, r4, 0x24
/* 80588374  4B DB E1 3C */	b PSMTXCopy
/* 80588378  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058837C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80588380  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80588384  4B DB E1 2C */	b PSMTXCopy
/* 80588388  38 61 00 14 */	addi r3, r1, 0x14
/* 8058838C  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80588390  38 A1 00 5C */	addi r5, r1, 0x5c
/* 80588394  4B CD E7 50 */	b __pl__4cXyzCFRC3Vec
...
/* 805883B4  4B A8 49 B0 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 805883B8  38 61 00 50 */	addi r3, r1, 0x50
/* 805883BC  4B A8 4A 18 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 805883C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805883C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805883C8  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 805883CC  4B A8 40 68 */	b mDoMtx_YrotM__FPA4_fs
/* 805883D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805883D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805883D8  38 80 7F FF */	li r4, 0x7fff
/* 805883DC  4B A8 40 58 */	b mDoMtx_YrotM__FPA4_fs
/* 805883E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805883E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805883E8  A8 9F 0B 78 */	lha r4, 0xb78(r31)
/* 805883EC  4B A8 40 48 */	b mDoMtx_YrotM__FPA4_fs
/* 805883F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805883F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805883F8  80 9F 05 AC */	lwz r4, 0x5ac(r31)
/* 805883FC  38 84 00 24 */	addi r4, r4, 0x24
/* 80588400  4B DB E0 B0 */	b PSMTXCopy
/* 80588404  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588408  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8058840C  38 9F 0A E8 */	addi r4, r31, 0xae8
/* 80588410  4B DB E0 A0 */	b PSMTXCopy
...
/* 80588460  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588464  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80588478  4B A8 3F 64 */	b mDoMtx_YrotS__FPA4_fs
/* 8058847C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588480  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80588484  38 81 00 44 */	addi r4, r1, 0x44
/* 80588488  7C 85 23 78 */	mr r5, r4
/* 8058848C  4B DB E8 E0 */	b PSMTXMultVec
...
/* 805884A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805884AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805884B0  38 81 00 2C */	addi r4, r1, 0x2c
/* 805884B4  7C 85 23 78 */	mr r5, r4
/* 805884B8  4B DB E8 B4 */	b PSMTXMultVec
...
/* 805884D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805884D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805884DC  38 81 00 38 */	addi r4, r1, 0x38
/* 805884E0  7C 85 23 78 */	mr r5, r4
/* 805884E4  4B DB E8 88 */	b PSMTXMultVec
/* 805884E8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 805884EC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8058852C  4B CE 74 50 */	b cLib_addCalc__FPfffff
/* 80588530  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80588534  4B A8 48 30 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80588538  38 61 00 5C */	addi r3, r1, 0x5c
/* 8058853C  4B A8 48 98 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80588540  38 61 00 2C */	addi r3, r1, 0x2c
/* 80588544  4B A8 48 90 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80588548  38 61 00 44 */	addi r3, r1, 0x44
/* 8058854C  4B A8 48 88 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80588550  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588554  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80588568  4B A8 3E CC */	b mDoMtx_YrotM__FPA4_fs
/* 8058856C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588570  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80588574  38 80 F1 C8 */	li r4, -3640
/* 80588578  4B A8 3E 24 */	b mDoMtx_XrotM__FPA4_fs
/* 8058857C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588580  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80588584  A8 1F 0B AE */	lha r0, 0xbae(r31)
/* 80588588  7C 00 00 D0 */	neg r0, r0
/* 8058858C  7C 04 07 34 */	extsh r4, r0
/* 80588590  4B A8 3E 0C */	b mDoMtx_XrotM__FPA4_fs
/* 80588594  C0 3E 00 DC */	lfs f1, 0xdc(r30)
/* 80588598  C0 5E 00 AC */	lfs f2, 0xac(r30)
/* 8058859C  FC 60 10 90 */	fmr f3, f2
/* 805885A0  4B A8 47 FC */	b transM__14mDoMtx_stack_cFfff
/* 805885A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805885A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805885AC  A8 9F 0B B2 */	lha r4, 0xbb2(r31)
/* 805885B0  4B A8 3F 1C */	b mDoMtx_ZrotM__FPA4_fs
/* 805885B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805885B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805885BC  7F A4 EB 78 */	mr r4, r29
/* 805885C0  4B A8 3F 0C */	b mDoMtx_ZrotM__FPA4_fs
/* 805885C4  C0 3E 00 E0 */	lfs f1, 0xe0(r30)
/* 805885C8  C0 5E 00 AC */	lfs f2, 0xac(r30)
/* 805885CC  FC 60 10 90 */	fmr f3, f2
/* 805885D0  4B A8 47 CC */	b transM__14mDoMtx_stack_cFfff
/* 805885D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805885D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805885DC  80 9F 05 B4 */	lwz r4, 0x5b4(r31)
/* 805885E0  38 84 00 24 */	addi r4, r4, 0x24
/* 805885E4  4B DB DE CC */	b PSMTXCopy
...
/* 80588604  4B A8 47 60 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80588608  38 61 00 5C */	addi r3, r1, 0x5c
/* 8058860C  4B A8 47 C8 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80588610  38 61 00 44 */	addi r3, r1, 0x44
/* 80588614  4B A8 47 C0 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80588618  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058861C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80588630  4B A8 3E 04 */	b mDoMtx_YrotM__FPA4_fs
/* 80588634  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588638  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8058863C  38 80 F1 C8 */	li r4, -3640
/* 80588640  4B A8 3D 5C */	b mDoMtx_XrotM__FPA4_fs
/* 80588644  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588648  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8058864C  A8 1F 0B AE */	lha r0, 0xbae(r31)
/* 80588650  7C 00 00 D0 */	neg r0, r0
/* 80588654  7C 04 07 34 */	extsh r4, r0
/* 80588658  4B A8 3D 44 */	b mDoMtx_XrotM__FPA4_fs
/* 8058865C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588660  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80588664  80 9F 05 B0 */	lwz r4, 0x5b0(r31)
/* 80588668  38 84 00 24 */	addi r4, r4, 0x24
/* 8058866C  4B DB DE 44 */	b PSMTXCopy
...
/* 805886CC  4B A9 55 F0 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 805886D0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 805886D4  41 82 00 78 */	beq lbl_8058874C
/* 805886D8  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 805886DC  C0 23 0C D0 */	lfs f1, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 80588720  4B DB E9 B8 */	b PSVECScale
...
/* 80588740  4B A9 16 58 */	b fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
...
/* 80588760  4B CE 7D E0 */	b cLib_addCalcAngleS__FPsssss
/* 80588764  38 7F 0B D4 */	addi r3, r31, 0xbd4
/* 80588768  4B A8 45 FC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 8058876C  38 7F 0B E0 */	addi r3, r31, 0xbe0
/* 80588770  4B A8 47 D4 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80588774  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80588778  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8058877C  80 9F 05 B0 */	lwz r4, 0x5b0(r31)
/* 80588780  38 84 00 24 */	addi r4, r4, 0x24
/* 80588784  4B DB DD 2C */	b PSMTXCopy
lbl_80588788:
/* 80588788  39 61 00 80 */	addi r11, r1, 0x80
/* 8058878C  4B DD 9A 9C */	b _restgpr_29
