...
/* 80589F50  4B DD 82 79 */	bl _savegpr_24
/* 80589F54  7C 7D 1B 78 */	mr r29, r3
/* 80589F58  3C 60 80 59 */	lis r3, l_gateBmdIdx@ha /* 0x8058AB30@ha */
/* 80589F5C  3B E3 AB 30 */	addi r31, r3, l_gateBmdIdx@l /* 0x8058AB30@l */
/* 80589F60  80 1D 00 B0 */	lwz r0, 0xb0(r29)
/* 80589F64  54 1E 06 3E */	clrlwi r30, r0, 0x18
/* 80589F68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80589F6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80589F70  7F C4 F3 78 */	mr r4, r30
/* 80589F74  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 80589F78  7C 05 07 74 */	extsb r5, r0
/* 80589F7C  4B AA B3 E5 */	bl isSwitch__10dSv_info_cCFii
...
lbl_80589FBC:
/* 80589FBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80589FC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058A024  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8058A028  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8058A0A8  4B AF A3 B9 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 8058A0AC  28 03 00 00 */	cmplwi r3, 0
/* 8058A0B0  41 82 00 44 */	beq lbl_8058A0F4
/* 8058A0B4  7F 43 D3 78 */	mr r3, r26
/* 8058A0B8  4B AF A4 41 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 8058A0D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058A0D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058A0D8  7F C4 F3 78 */	mr r4, r30
/* 8058A0DC  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8058A0E0  7C 05 07 74 */	extsb r5, r0
/* 8058A0E4  4B AA B1 1D */	bl onSwitch__10dSv_info_cFii
/* 8058A0E8  7F A3 EB 78 */	mr r3, r29
/* 8058A0EC  4B A8 FB 91 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 8058A110  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058A114  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058A118  3B 43 23 3C */	addi r26, r3, 0x233c
/* 8058A11C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058A120  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_8058A124:
...
/* 8058A19C  4B DD 80 79 */	bl _restgpr_24
