...
/* 80588D10  4B DD 94 C9 */	bl _savegpr_28
/* 80588D14  7C 7D 1B 78 */	mr r29, r3
/* 80588D18  3C 60 80 59 */	lis r3, l_gateBmdIdx@ha /* 0x8058AB30@ha */
/* 80588D1C  3B E3 AB 30 */	addi r31, r3, l_gateBmdIdx@l /* 0x8058AB30@l */
/* 80588D20  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80588D24  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80588D70  3C 60 80 59 */	lis r3, search_coach__FPvPv@ha /* 0x80588078@ha */
/* 80588D74  38 63 80 78 */	addi r3, r3, search_coach__FPvPv@l /* 0x80588078@l */
/* 80588D78  7F A4 EB 78 */	mr r4, r29
/* 80588D7C  4B A9 0A 7D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80588D80  7C 7C 1B 79 */	or. r28, r3, r3
/* 80588D84  41 82 00 CC */	beq lbl_80588E50
/* 80588D88  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 80588D8C  4B A8 3F D9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80588D90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80588D94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80588D98  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 80588D9C  4B A8 36 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 80588DA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80588DA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80588DA8  38 81 00 20 */	addi r4, r1, 0x20
/* 80588DAC  7C 85 23 78 */	mr r5, r4
/* 80588DB0  4B DB DF BD */	bl PSMTXMultVec
...
/* 80588DD8  4B DB D7 D9 */	bl PSMTXInverse
/* 80588DDC  38 61 00 38 */	addi r3, r1, 0x38
/* 80588DE0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80588DE4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80588DE8  4B DB D6 C9 */	bl PSMTXCopy
/* 80588DEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80588DF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80588DF4  38 81 00 2C */	addi r4, r1, 0x2c
/* 80588DF8  7C 85 23 78 */	mr r5, r4
/* 80588DFC  4B DB DF 71 */	bl PSMTXMultVec
...
/* 80588E64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80588E68  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80588E7C  4B A8 3E E9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80588E80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80588E84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80588E88  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 80588E8C  4B A8 35 A9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80588E90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80588E94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80588E98  38 81 00 20 */	addi r4, r1, 0x20
/* 80588E9C  7C 85 23 78 */	mr r5, r4
/* 80588EA0  4B DB DE CD */	bl PSMTXMultVec
...
/* 80588EC8  4B DB D6 E9 */	bl PSMTXInverse
/* 80588ECC  38 61 00 38 */	addi r3, r1, 0x38
/* 80588ED0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80588ED4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80588ED8  4B DB D5 D9 */	bl PSMTXCopy
/* 80588EDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80588EE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80588EE4  38 81 00 2C */	addi r4, r1, 0x2c
/* 80588EE8  7C 85 23 78 */	mr r5, r4
/* 80588EEC  4B DB DE 81 */	bl PSMTXMultVec
...
/* 80588FC0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80588FC4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80589000:
/* 80589000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80589004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80589008  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 8058900C  4B A8 33 D1 */	bl mDoMtx_YrotS__FPA4_fs
/* 80589010  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80589014  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80589018  38 81 00 20 */	addi r4, r1, 0x20
/* 8058901C  7C 85 23 78 */	mr r5, r4
/* 80589020  4B DB DD 4D */	bl PSMTXMultVec
/* 80589024  38 61 00 2C */	addi r3, r1, 0x2c
/* 80589028  38 81 00 20 */	addi r4, r1, 0x20
/* 8058902C  7C 65 1B 78 */	mr r5, r3
/* 80589030  4B DB E0 61 */	bl PSVECAdd
/* 80589034  80 7D 05 A8 */	lwz r3, 0x5a8(r29)
/* 80589038  38 63 00 24 */	addi r3, r3, 0x24
/* 8058903C  38 81 00 38 */	addi r4, r1, 0x38
/* 80589040  4B DB D5 71 */	bl PSMTXInverse
/* 80589044  38 61 00 38 */	addi r3, r1, 0x38
/* 80589048  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058904C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80589050  4B DB D4 61 */	bl PSMTXCopy
/* 80589054  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80589058  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058905C  38 81 00 2C */	addi r4, r1, 0x2c
/* 80589060  7C 85 23 78 */	mr r5, r4
/* 80589064  4B DB DD 09 */	bl PSMTXMultVec
...
/* 805890C0  4B DD 91 65 */	bl _restgpr_28
