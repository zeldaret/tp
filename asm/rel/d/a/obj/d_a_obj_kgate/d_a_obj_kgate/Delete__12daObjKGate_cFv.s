...
/* 8058A714  4B CD DA C1 */	bl ChkUsed__9cBgW_BgIdCFv
/* 8058A718  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8058A71C  41 82 00 18 */	beq lbl_8058A734
/* 8058A720  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058A724  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058A728  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8058A72C  80 9F 0A E4 */	lwz r4, 0xae4(r31)
/* 8058A730  4B AE 9B 21 */	bl Release__4cBgSFP9dBgW_Base
lbl_8058A734:
/* 8058A734  38 7F 05 A0 */	addi r3, r31, 0x5a0
/* 8058A738  88 1F 0B EC */	lbz r0, 0xbec(r31)
/* 8058A73C  54 00 10 3A */	slwi r0, r0, 2
/* 8058A740  3C 80 80 59 */	lis r4, l_arcName@ha /* 0x8058AD44@ha */
/* 8058A744  38 84 AD 44 */	addi r4, r4, l_arcName@l /* 0x8058AD44@l */
/* 8058A748  7C 84 00 2E */	lwzx r4, r4, r0
/* 8058A74C  4B AA 28 BD */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
