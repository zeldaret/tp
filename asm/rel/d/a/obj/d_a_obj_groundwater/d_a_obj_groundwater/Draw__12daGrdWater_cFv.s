...
/* 80C14564  4B 74 DC 69 */	bl _savegpr_25
/* 80C14568  7C 7B 1B 78 */	mr r27, r3
/* 80C1456C  3C 60 80 C1 */	lis r3, lit_3642@ha /* 0x80C149E0@ha */
/* 80C14570  3B A3 49 E0 */	addi r29, r3, lit_3642@l /* 0x80C149E0@l */
/* 80C14574  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C14578  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C1457C  38 80 00 10 */	li r4, 0x10
/* 80C14580  38 BB 04 D0 */	addi r5, r27, 0x4d0
/* 80C14584  38 DB 01 0C */	addi r6, r27, 0x10c
/* 80C14588  4B 58 F2 3D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C1458C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C14590  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C14594  80 9B 05 AC */	lwz r4, 0x5ac(r27)
/* 80C14598  80 84 00 04 */	lwz r4, 4(r4)
/* 80C1459C  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80C145A0  4B 59 08 01 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C145A4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C145A8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C145AC  80 9B 05 A8 */	lwz r4, 0x5a8(r27)
/* 80C145B0  80 84 00 04 */	lwz r4, 4(r4)
/* 80C145B4  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80C145B8  4B 59 07 E9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C145BC  80 7B 05 A8 */	lwz r3, 0x5a8(r27)
/* 80C145C0  4B 59 87 65 */	bl dKy_bg_MAxx_proc__FPv
/* 80C145C4  80 7B 05 AC */	lwz r3, 0x5ac(r27)
/* 80C145C8  4B 59 87 5D */	bl dKy_bg_MAxx_proc__FPv
...
/* 80C145E0  4B 3F 90 F9 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C145F8  4B 3F 90 E1 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C14668  4B 3F 93 65 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C1466C  38 7B 06 9C */	addi r3, r27, 0x69c
/* 80C14670  7F 84 E3 78 */	mr r4, r28
/* 80C14674  C0 3B 06 AC */	lfs f1, 0x6ac(r27)
/* 80C14678  4B 3F 93 55 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
...
/* 80C146C0  4B 3F 93 0D */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C146C4  38 7B 06 D4 */	addi r3, r27, 0x6d4
/* 80C146C8  7F 84 E3 78 */	mr r4, r28
/* 80C146CC  C0 3B 06 E4 */	lfs f1, 0x6e4(r27)
/* 80C146D0  4B 3F 92 FD */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_80C146D4:
/* 80C146D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C146D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C146DC  80 03 5F 7C */	lwz r0, 0x5f7c(r3)
/* 80C146E0  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C146E4  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
/* 80C146E8  90 1E 00 4C */	stw r0, 0x4c(r30)
/* 80C146EC  80 7B 05 A8 */	lwz r3, 0x5a8(r27)
/* 80C146F0  4B 3F 95 D5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C146F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C146F8  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C146FC  80 1F 5F 80 */	lwz r0, 0x5f80(r31)
/* 80C14700  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C14704  3B 43 4A C8 */	addi r26, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C1476C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C14770  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C14794  4B 73 24 85 */	bl C_MTXLightPerspective
/* 80C14798  7F 23 CB 78 */	mr r3, r25
/* 80C1479C  38 81 00 08 */	addi r4, r1, 8
/* 80C147A0  4B 71 0F F5 */	bl setEffectMtx__13J3DTexMtxInfoFPA4_f
/* 80C147A4  7F 83 E3 78 */	mr r3, r28
/* 80C147A8  38 80 00 00 */	li r4, 0
/* 80C147AC  3C A0 80 3A */	lis r5, j3dDefaultMtx@ha /* 0x803A1E5C@ha */
/* 80C147B0  38 A5 1E 5C */	addi r5, r5, j3dDefaultMtx@l /* 0x803A1E5C@l */
/* 80C147B4  4B 71 18 59 */	bl simpleCalcMaterial__12J3DModelDataFUsPA4_f
lbl_80C147B8:
/* 80C147B8  80 7B 05 AC */	lwz r3, 0x5ac(r27)
/* 80C147BC  4B 3F 95 09 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80C147D8  4B 74 DA 41 */	bl _restgpr_25
