...
/* 80C34068  4B 72 E1 70 */	b _savegpr_28
...
/* 80C34088  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C3408C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C34090  4B 71 24 20 */	b PSMTXCopy
...
lbl_80C340B8:
/* 80C340B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C340BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C340C0  A8 9F 05 6E */	lha r4, 0x56e(r31)
/* 80C340C4  4B 3D 84 08 */	b mDoMtx_ZrotM__FPA4_fs
/* 80C340C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C340CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C340D0  A8 9F 05 84 */	lha r4, 0x584(r31)
/* 80C340D4  4B 3D 83 60 */	b mDoMtx_YrotM__FPA4_fs
/* 80C340D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C340DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C340E0  A8 1F 05 6E */	lha r0, 0x56e(r31)
/* 80C340E4  3C 80 80 C3 */	lis r4, lit_3809@ha
/* 80C340E8  C8 64 4E F4 */	lfd f3, lit_3809@l(r4)
...
/* 80C34104  3C 80 80 C3 */	lis r4, lit_3806@ha
/* 80C34108  C0 24 4E EC */	lfs f1, lit_3806@l(r4)
...
/* 80C34138  4B 3D 82 64 */	b mDoMtx_XrotM__FPA4_fs
/* 80C3413C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C34140  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34144  A8 1F 05 84 */	lha r0, 0x584(r31)
/* 80C34148  7C 00 00 D0 */	neg r0, r0
/* 80C3414C  7C 04 07 34 */	extsh r4, r0
/* 80C34150  4B 3D 82 E4 */	b mDoMtx_YrotM__FPA4_fs
/* 80C34154  48 00 00 EC */	b lbl_80C34240
lbl_80C34158:
/* 80C34158  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3415C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34160  A8 9F 05 70 */	lha r4, 0x570(r31)
/* 80C34164  4B 3D 83 68 */	b mDoMtx_ZrotM__FPA4_fs
/* 80C34168  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3416C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34170  A8 9F 05 84 */	lha r4, 0x584(r31)
/* 80C34174  4B 3D 82 C0 */	b mDoMtx_YrotM__FPA4_fs
/* 80C34178  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3417C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34180  A8 1F 05 70 */	lha r0, 0x570(r31)
/* 80C34184  3C 80 80 C3 */	lis r4, lit_3809@ha
/* 80C34188  C8 64 4E F4 */	lfd f3, lit_3809@l(r4)
...
/* 80C341A4  3C 80 80 C3 */	lis r4, lit_3807@ha
/* 80C341A8  C0 24 4E F0 */	lfs f1, lit_3807@l(r4)
...
/* 80C341D8  4B 3D 81 C4 */	b mDoMtx_XrotM__FPA4_fs
/* 80C341DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C341E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C341E4  A8 1F 05 84 */	lha r0, 0x584(r31)
/* 80C341E8  7C 00 00 D0 */	neg r0, r0
/* 80C341EC  7C 04 07 34 */	extsh r4, r0
/* 80C341F0  4B 3D 82 44 */	b mDoMtx_YrotM__FPA4_fs
/* 80C341F4  48 00 00 4C */	b lbl_80C34240
lbl_80C341F8:
/* 80C341F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C341FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34200  A8 9F 05 72 */	lha r4, 0x572(r31)
/* 80C34204  4B 3D 82 C8 */	b mDoMtx_ZrotM__FPA4_fs
/* 80C34208  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3420C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34210  A8 9F 05 84 */	lha r4, 0x584(r31)
/* 80C34214  4B 3D 82 20 */	b mDoMtx_YrotM__FPA4_fs
/* 80C34218  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3421C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34220  A8 9F 05 72 */	lha r4, 0x572(r31)
/* 80C34224  4B 3D 81 78 */	b mDoMtx_XrotM__FPA4_fs
/* 80C34228  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3422C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34230  A8 1F 05 84 */	lha r0, 0x584(r31)
/* 80C34234  7C 00 00 D0 */	neg r0, r0
/* 80C34238  7C 04 07 34 */	extsh r4, r0
/* 80C3423C  4B 3D 81 F8 */	b mDoMtx_YrotM__FPA4_fs
lbl_80C34240:
/* 80C34240  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C34244  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34248  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80C3424C  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C34250  7C 80 EA 14 */	add r4, r0, r29
/* 80C34254  4B 71 22 5C */	b PSMTXCopy
/* 80C34258  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3425C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C34260  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80C34264  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80C34268  4B 71 22 48 */	b PSMTXCopy
/* 80C3426C  38 60 00 01 */	li r3, 1
/* 80C34270  39 61 00 30 */	addi r11, r1, 0x30
/* 80C34274  4B 72 DF B0 */	b _restgpr_28
