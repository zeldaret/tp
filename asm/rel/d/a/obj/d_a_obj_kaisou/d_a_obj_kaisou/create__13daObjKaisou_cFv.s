...
/* 80C34BE8  4B 72 D5 F5 */	bl _savegpr_29
/* 80C34BEC  7C 7D 1B 78 */	mr r29, r3
/* 80C34BF0  3C 80 80 C3 */	lis r4, lit_3806@ha /* 0x80C34EEC@ha */
/* 80C34BF4  3B E4 4E EC */	addi r31, r4, lit_3806@l /* 0x80C34EEC@l */
...
/* 80C34C10  4B 3E 3F 55 */	bl __ct__10fopAc_ac_cFv
/* 80C34C14  38 7E 05 88 */	addi r3, r30, 0x588
/* 80C34C18  4B 68 9C 2D */	bl __ct__16Z2SoundObjSimpleFv
/* 80C34C1C  38 7E 05 BC */	addi r3, r30, 0x5bc
/* 80C34C20  4B 44 12 8D */	bl __ct__12dBgS_AcchCirFv
/* 80C34C24  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C34C28  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C34C2C  90 1E 06 14 */	stw r0, 0x614(r30)
/* 80C34C30  38 7E 06 18 */	addi r3, r30, 0x618
/* 80C34C34  4B 44 EB 2D */	bl __ct__10dCcD_GSttsFv
/* 80C34C38  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C34C3C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C34C54  4B 44 ED D5 */	bl __ct__12dCcD_GObjInfFv
/* 80C34C58  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C34C5C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C34C60  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C34C64  3C 60 80 C3 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C35094@ha */
/* 80C34C68  38 03 50 94 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C35094@l */
/* 80C34C6C  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80C34C70  3C 60 80 C3 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C35088@ha */
/* 80C34C74  38 03 50 88 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C35088@l */
/* 80C34C78  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C34C7C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C34C80  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80C34C84  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80C34C88  38 03 00 58 */	addi r0, r3, 0x58
/* 80C34C8C  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C34C90  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C34C94  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C34CBC  3C 80 80 C3 */	lis r4, l_arcName@ha /* 0x80C34FC0@ha */
/* 80C34CC0  38 84 4F C0 */	addi r4, r4, l_arcName@l /* 0x80C34FC0@l */
/* 80C34CC4  80 84 00 00 */	lwz r4, 0(r4)
/* 80C34CC8  4B 3F 81 F5 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 80C34CCC  7C 7E 1B 78 */	mr r30, r3
/* 80C34CD0  2C 1E 00 04 */	cmpwi r30, 4
/* 80C34CD4  40 82 01 5C */	bne lbl_80C34E30
/* 80C34CD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C34CDC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C34CE0  38 63 09 58 */	addi r3, r3, 0x958
/* 80C34CE4  38 80 00 03 */	li r4, 3
/* 80C34CE8  4B 3F FC 4D */	bl isDungeonItem__12dSv_memBit_cCFi
/* 80C34CEC  2C 03 00 00 */	cmpwi r3, 0
/* 80C34CF0  41 82 00 3C */	beq lbl_80C34D2C
/* 80C34CF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C34CF8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C34CFC  88 04 4E 0A */	lbz r0, 0x4e0a(r4)
/* 80C34D00  2C 00 00 32 */	cmpwi r0, 0x32
/* 80C34D04  40 82 00 28 */	bne lbl_80C34D2C
/* 80C34D08  3C 60 80 C3 */	lis r3, d_a_obj_kaisou__stringBase0@ha /* 0x80C34FA0@ha */
/* 80C34D0C  38 63 4F A0 */	addi r3, r3, d_a_obj_kaisou__stringBase0@l /* 0x80C34FA0@l */
/* 80C34D10  38 63 00 16 */	addi r3, r3, 0x16
/* 80C34D14  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C34D18  4B 73 3C 7D */	bl strcmp
...
/* 80C34D30  3C 80 80 C3 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80C342D4@ha */
/* 80C34D34  38 84 42 D4 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80C342D4@l */
/* 80C34D38  38 A0 08 D0 */	li r5, 0x8d0
/* 80C34D3C  4B 3E 57 75 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80C34D88  4B 3E 8F 35 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80C34D8C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C34D90  41 82 00 10 */	beq lbl_80C34DA0
/* 80C34D94  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80C34D98  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 80C34DAC  3C 60 80 C3 */	lis r3, JointCallBack__FP8J3DJointi@ha /* 0x80C34288@ha */
/* 80C34DB0  38 83 42 88 */	addi r4, r3, JointCallBack__FP8J3DJointi@l /* 0x80C34288@l */
...
/* 80C34E24  4B 3E 57 25 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80C34E38  4B 72 D3 F1 */	bl _restgpr_29
