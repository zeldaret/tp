...
/* 80BA8128  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BA812C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BA8130  4B 79 E3 81 */	bl PSMTXCopy
/* 80BA8134  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BA8138  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80BA815C  4B 6C 74 ED */	bl SetC__8cM3dGSphFRC4cXyz
/* 80BA8160  38 7F 09 00 */	addi r3, r31, 0x900
/* 80BA8164  88 1F 05 78 */	lbz r0, 0x578(r31)
/* 80BA8168  54 05 10 3A */	slwi r5, r0, 2
/* 80BA816C  3C 80 80 BB */	lis r4, l_HIO@ha /* 0x80BA900C@ha */
/* 80BA8170  38 04 90 0C */	addi r0, r4, l_HIO@l /* 0x80BA900C@l */
/* 80BA8174  7C 80 2A 14 */	add r4, r0, r5
/* 80BA8178  C0 24 00 08 */	lfs f1, 8(r4)
/* 80BA817C  3C 80 80 BB */	lis r4, balloon_radius@ha /* 0x80BA8E80@ha */
/* 80BA8180  38 84 8E 80 */	addi r4, r4, balloon_radius@l /* 0x80BA8E80@l */
/* 80BA8184  7C 04 2C 2E */	lfsx f0, r4, r5
/* 80BA8188  EC 21 00 32 */	fmuls f1, f1, f0
/* 80BA818C  4B 6C 75 7D */	bl SetR__8cM3dGSphFf
/* 80BA8190  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BA8194  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BA8198  38 63 23 3C */	addi r3, r3, 0x233c
/* 80BA819C  38 9F 07 DC */	addi r4, r31, 0x7dc
/* 80BA81A0  4B 6B CA 09 */	bl Set__4cCcSFP8cCcD_Obj
