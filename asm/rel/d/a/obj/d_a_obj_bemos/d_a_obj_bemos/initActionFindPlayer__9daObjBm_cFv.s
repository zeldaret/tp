...
/* 80BB166C  3C 60 80 BB */	lis r3, l_arcName@ha /* 0x80BB3A94@ha */
/* 80BB1670  38 63 3A 94 */	addi r3, r3, l_arcName@l /* 0x80BB3A94@l */
/* 80BB1674  80 63 00 00 */	lwz r3, 0(r3)
/* 80BB1678  38 80 00 13 */	li r4, 0x13
/* 80BB167C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BB1680  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BB1684  3C A5 00 02 */	addis r5, r5, 2
/* 80BB1688  38 C0 00 80 */	li r6, 0x80
/* 80BB168C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BB1690  4B 48 AC 5D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BB16B0  3D 00 80 BB */	lis r8, lit_3934@ha /* 0x80BB3824@ha */
/* 80BB16B4  C0 28 38 24 */	lfs f1, lit_3934@l(r8)  /* 0x80BB3824@l */
/* 80BB16B8  39 00 00 00 */	li r8, 0
/* 80BB16BC  39 20 FF FF */	li r9, -1
/* 80BB16C0  4B 45 C0 4D */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80BB16C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BB16C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BB170C  3D 60 80 BB */	lis r11, lit_3934@ha /* 0x80BB3824@ha */
/* 80BB1710  C0 2B 38 24 */	lfs f1, lit_3934@l(r11)  /* 0x80BB3824@l */
/* 80BB1714  4B 49 B3 7D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BB172C  4B 47 B9 41 */	bl dComIfGp_getReverb__Fi
...
/* 80BB1740  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BB1744  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BB175C  3D 00 80 BB */	lis r8, lit_3934@ha /* 0x80BB3824@ha */
/* 80BB1760  C0 28 38 24 */	lfs f1, lit_3934@l(r8)  /* 0x80BB3824@l */
/* 80BB1764  FC 40 08 90 */	fmr f2, f1
/* 80BB1768  3D 00 80 BB */	lis r8, lit_4402@ha /* 0x80BB3840@ha */
/* 80BB176C  C0 68 38 40 */	lfs f3, lit_4402@l(r8)  /* 0x80BB3840@l */
/* 80BB1770  FC 80 18 90 */	fmr f4, f3
/* 80BB1774  39 00 00 00 */	li r8, 0
/* 80BB1778  4B 6F A2 0D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80BB177C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80BB1780  7C 03 07 74 */	extsb r3, r0
/* 80BB1784  4B 47 B8 E9 */	bl dComIfGp_getReverb__Fi
...
/* 80BB1798  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BB179C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BB17B0  3D 00 80 BB */	lis r8, lit_3934@ha /* 0x80BB3824@ha */
/* 80BB17B4  C0 28 38 24 */	lfs f1, lit_3934@l(r8)  /* 0x80BB3824@l */
/* 80BB17B8  FC 40 08 90 */	fmr f2, f1
/* 80BB17BC  3D 00 80 BB */	lis r8, lit_4402@ha /* 0x80BB3840@ha */
/* 80BB17C0  C0 68 38 40 */	lfs f3, lit_4402@l(r8)  /* 0x80BB3840@l */
/* 80BB17C4  FC 80 18 90 */	fmr f4, f3
/* 80BB17C8  39 00 00 00 */	li r8, 0
/* 80BB17CC  4B 6F A1 B9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
