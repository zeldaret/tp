...
/* 80BAE4B8  4B 7B 3D 21 */	bl _savegpr_28
/* 80BAE4BC  2C 04 00 00 */	cmpwi r4, 0
/* 80BAE4C0  40 82 01 20 */	bne lbl_80BAE5E0
/* 80BAE4C4  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 80BAE4C8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BAE4CC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BAE4E8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BAE4EC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BAE4F0  4B 79 7F C1 */	bl PSMTXCopy
/* 80BAE4F4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BAE4F8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80BAE530  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BAE534  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BAE538  A8 1C 0F 96 */	lha r0, 0xf96(r28)
/* 80BAE53C  7C 00 22 14 */	add r0, r0, r4
/* 80BAE540  7C 04 07 34 */	extsh r4, r0
/* 80BAE544  4B 45 DE 59 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80BAE558  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BAE55C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BAE560  A8 9C 0F 9A */	lha r4, 0xf9a(r28)
/* 80BAE564  4B 45 DE 39 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80BAE578  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BAE57C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BAE580  A8 9C 0F 9E */	lha r4, 0xf9e(r28)
/* 80BAE584  4B 45 DE 19 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80BAE598  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BAE59C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BAE5A0  A8 9C 0F A2 */	lha r4, 0xfa2(r28)
/* 80BAE5A4  4B 45 DD F9 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80BAE5B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BAE5BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BAE5C0  A8 9C 0F A6 */	lha r4, 0xfa6(r28)
/* 80BAE5C4  4B 45 DD D9 */	bl mDoMtx_XrotM__FPA4_fs
lbl_80BAE5C8:
/* 80BAE5C8  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 80BAE5CC  80 03 00 0C */	lwz r0, 0xc(r3)
/* 80BAE5D0  7C 80 EA 14 */	add r4, r0, r29
/* 80BAE5D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BAE5D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BAE5DC  4B 79 7E D5 */	bl PSMTXCopy
lbl_80BAE5E0:
/* 80BAE5E0  38 60 00 01 */	li r3, 1
/* 80BAE5E4  39 61 00 20 */	addi r11, r1, 0x20
/* 80BAE5E8  4B 7B 3C 3D */	bl _restgpr_28
