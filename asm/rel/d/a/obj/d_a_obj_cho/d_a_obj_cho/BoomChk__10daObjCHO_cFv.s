...
/* 80BCB5D0  4B 79 6C 09 */	bl _savegpr_28
/* 80BCB5D4  7C 7E 1B 78 */	mr r30, r3
/* 80BCB5D8  3C 60 80 BD */	lis r3, lit_3775@ha /* 0x80BCC578@ha */
/* 80BCB5DC  3B E3 C5 78 */	addi r31, r3, lit_3775@l /* 0x80BCC578@l */
/* 80BCB5E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCB5E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BCB630  4B 59 30 25 */	bl posMove__20daPy_boomerangMove_cFP4cXyzPsP10fopAc_ac_cs
...
/* 80BCB644  4B 59 32 39 */	bl bgCheckAfterOffset__20daPy_boomerangMove_cFPC4cXyz
...
/* 80BCB660  4B 4A C6 09 */	bl __ct__11dBgS_LinChkFv
...
/* 80BCB674  4B 4A C6 F1 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80BCB678  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCB67C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BCB680  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80BCB684  7F 83 E3 78 */	mr r3, r28
/* 80BCB688  38 81 00 28 */	addi r4, r1, 0x28
/* 80BCB68C  4B 4A 8D 29 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80BCB690  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BCB694  41 82 00 E4 */	beq lbl_80BCB778
/* 80BCB698  3C 60 80 BD */	lis r3, __vt__8cM3dGPla@ha /* 0x80BCC714@ha */
/* 80BCB69C  38 03 C7 14 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80BCC714@l */
...
/* 80BCB6B0  4B 4A 90 95 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80BCB70C  3C 60 80 BD */	lis r3, d_a_obj_cho__stringBase0@ha /* 0x80BCC678@ha */
/* 80BCB710  38 63 C6 78 */	addi r3, r3, d_a_obj_cho__stringBase0@l /* 0x80BCC678@l */
/* 80BCB714  38 80 00 06 */	li r4, 6
/* 80BCB718  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCB71C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BCB720  3C A5 00 02 */	addis r5, r5, 2
/* 80BCB724  38 C0 00 80 */	li r6, 0x80
/* 80BCB728  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BCB72C  4B 47 0B C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BCB74C  4B 44 57 25 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80BCB768  3C 60 80 BD */	lis r3, __vt__8cM3dGPla@ha /* 0x80BCC714@ha */
/* 80BCB76C  38 03 C7 14 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80BCC714@l */
...
/* 80BCB7B8  3C 60 80 BD */	lis r3, d_a_obj_cho__stringBase0@ha /* 0x80BCC678@ha */
/* 80BCB7BC  38 63 C6 78 */	addi r3, r3, d_a_obj_cho__stringBase0@l /* 0x80BCC678@l */
/* 80BCB7C0  38 80 00 06 */	li r4, 6
/* 80BCB7C4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCB7C8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BCB7CC  3C A5 00 02 */	addis r5, r5, 2
/* 80BCB7D0  38 C0 00 80 */	li r6, 0x80
/* 80BCB7D4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BCB7D8  4B 47 0B 15 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BCB7F8  4B 44 56 79 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80BCB818  4B 4A C4 C5 */	bl __dt__11dBgS_LinChkFv
lbl_80BCB81C:
/* 80BCB81C  39 61 00 B0 */	addi r11, r1, 0xb0
/* 80BCB820  4B 79 6A 05 */	bl _restgpr_28
