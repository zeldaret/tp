...
/* 80BCB4C4  3C 60 80 BD */	lis r3, lit_4300@ha /* 0x80BCC658@ha */
/* 80BCB4C8  C8 23 C6 58 */	lfd f1, lit_4300@l(r3)  /* 0x80BCC658@l */
...
/* 80BCB4EC  3C 80 80 BD */	lis r4, lit_3927@ha /* 0x80BCC5C4@ha */
/* 80BCB4F0  C0 24 C5 C4 */	lfs f1, lit_3927@l(r4)  /* 0x80BCC5C4@l */
/* 80BCB4F4  3C 80 80 BD */	lis r4, lit_3889@ha /* 0x80BCC5C0@ha */
/* 80BCB4F8  C0 44 C5 C0 */	lfs f2, lit_3889@l(r4)  /* 0x80BCC5C0@l */
/* 80BCB4FC  FC 60 10 90 */	fmr f3, f2
/* 80BCB500  4B 6A 45 3D */	bl cLib_addCalc2__FPffff
/* 80BCB504  48 00 00 1C */	b lbl_80BCB520
lbl_80BCB508:
/* 80BCB508  38 7F 09 94 */	addi r3, r31, 0x994
/* 80BCB50C  3C 80 80 BD */	lis r4, lit_3889@ha /* 0x80BCC5C0@ha */
/* 80BCB510  C0 24 C5 C0 */	lfs f1, lit_3889@l(r4)  /* 0x80BCC5C0@l */
/* 80BCB514  FC 40 08 90 */	fmr f2, f1
/* 80BCB518  FC 60 08 90 */	fmr f3, f1
/* 80BCB51C  4B 6A 45 21 */	bl cLib_addCalc2__FPffff
lbl_80BCB520:
/* 80BCB520  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCB524  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BCB56C  3D 60 80 BD */	lis r11, lit_3889@ha /* 0x80BCC5C0@ha */
/* 80BCB570  C0 2B C5 C0 */	lfs f1, lit_3889@l(r11)  /* 0x80BCC5C0@l */
/* 80BCB574  4B 48 1F 59 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BCB58C  4B 48 03 8D */	bl getEmitter__Q213dPa_control_c7level_cFUl
