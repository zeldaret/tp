...
/* 80C94604  3C 60 80 C9 */	lis r3, l_bmdData@ha /* 0x80C95B88@ha */
/* 80C94608  38 83 5B 88 */	addi r4, r3, l_bmdData@l /* 0x80C95B88@l */
/* 80C9460C  7C 64 2A 14 */	add r3, r4, r5
/* 80C94610  80 03 00 04 */	lwz r0, 4(r3)
/* 80C94614  54 00 10 3A */	slwi r0, r0, 2
/* 80C94618  3C 60 80 C9 */	lis r3, l_resNameList@ha /* 0x80C95B90@ha */
/* 80C9461C  38 63 5B 90 */	addi r3, r3, l_resNameList@l /* 0x80C95B90@l */
/* 80C94620  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C94624  7C 84 28 2E */	lwzx r4, r4, r5
/* 80C94628  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9462C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C94630  3C A5 00 02 */	addis r5, r5, 2
/* 80C94634  38 C0 00 80 */	li r6, 0x80
/* 80C94638  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C9463C  4B 3A 7C B1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9464C  4B 38 06 09 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
