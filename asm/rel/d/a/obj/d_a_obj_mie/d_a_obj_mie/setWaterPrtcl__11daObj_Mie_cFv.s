...
/* 80C95778  4B 6C CA 4D */	bl _savegpr_23
/* 80C9577C  7C 7E 1B 78 */	mr r30, r3
/* 80C95780  3C 60 80 C9 */	lis r3, lit_1109@ha /* 0x80C95CD0@ha */
/* 80C95784  3B E3 5C D0 */	addi r31, r3, lit_1109@l /* 0x80C95CD0@l */
/* 80C95788  88 1F 00 5C */	lbz r0, 0x5c(r31)
/* 80C9578C  7C 00 07 75 */	extsb. r0, r0
/* 80C95790  40 82 00 34 */	bne lbl_80C957C4
/* 80C95794  3C 60 80 C9 */	lis r3, lit_4594@ha /* 0x80C95B78@ha */
/* 80C95798  C0 03 5B 78 */	lfs f0, lit_4594@l(r3)  /* 0x80C95B78@l */
...
/* 80C957AC  3C 80 80 C9 */	lis r4, __dt__4cXyzFv@ha /* 0x80C9453C@ha */
/* 80C957B0  38 84 45 3C */	addi r4, r4, __dt__4cXyzFv@l /* 0x80C9453C@l */
...
/* 80C957E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C957EC  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C957F0  3C 60 80 C9 */	lis r3, emttrId@ha /* 0x80C95BDC@ha */
/* 80C957F4  3B 43 5B DC */	addi r26, r3, emttrId@l /* 0x80C95BDC@l */
/* 80C957F8  3C 60 80 C9 */	lis r3, lit_4389@ha /* 0x80C95B30@ha */
/* 80C957FC  3B 63 5B 30 */	addi r27, r3, lit_4389@l /* 0x80C95B30@l */
lbl_80C95800:
...
/* 80C9584C  4B 3B 7C 81 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C95860  4B 3B 60 55 */	bl forceOnEventMove__Q213dPa_control_c7level_cFUl
...
/* 80C9587C  4B 6C C9 95 */	bl _restgpr_23
