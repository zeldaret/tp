...
/* 80C95430  3C 60 80 C9 */	lis r3, srchPouyaa__11daObj_Mie_cFPvPv@ha
/* 80C95434  38 63 52 F8 */	addi r3, r3, srchPouyaa__11daObj_Mie_cFPvPv@l
/* 80C95438  38 80 00 00 */	li r4, 0
/* 80C9543C  4B 38 43 BC */	b fopAcIt_Judge__FPFPvPv_PvPv
lbl_80C95440:
...
/* 80C9545C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C95460  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C95464  4B 6B 10 4C */	b PSMTXCopy
/* 80C95468  48 00 00 2C */	b lbl_80C95494
lbl_80C9546C:
/* 80C9546C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C95470  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C95474  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C95478  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C9547C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C95480  4B 6B 14 68 */	b PSMTXTrans
/* 80C95484  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80C95488  4B 37 7A BC */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C9548C  38 7F 04 EC */	addi r3, r31, 0x4ec
/* 80C95490  4B 37 79 E0 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
lbl_80C95494:
/* 80C95494  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C95498  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9549C  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80C954A0  38 84 00 24 */	addi r4, r4, 0x24
/* 80C954A4  4B 6B 10 0C */	b PSMTXCopy
