...
/* 80C946C0  4B 6C DB 15 */	bl _savegpr_27
/* 80C946C4  7C 7B 1B 78 */	mr r27, r3
/* 80C946C8  3C 60 80 C9 */	lis r3, m__17daObj_Mie_Param_c@ha /* 0x80C95AAC@ha */
/* 80C946CC  3B A3 5A AC */	addi r29, r3, m__17daObj_Mie_Param_c@l /* 0x80C95AAC@l */
...
/* 80C94708  4B 3E 18 39 */	bl SetWallR__12dBgS_AcchCirFf
...
/* 80C947EC  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 80C947F0  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 80C94808  4B 38 89 F5 */	bl fopAcM_carryOffRevise__FP10fopAc_ac_c
...
/* 80C9483C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C94840  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C9487C  4B 38 90 15 */	bl fopAcM_getWaterY__FPC4cXyzPf
...
/* 80C94990  4B 5D AF ED */	bl cLib_addCalc__FPfffff
...
/* 80C949AC  4B 5D AF D1 */	bl cLib_addCalc__FPfffff
lbl_80C949B0:
...
/* 80C94A34  4B 3B CF 29 */	bl dPath_GetPolyRoomPathVec__FRC13cBgS_PolyInfoP4cXyzPi
...
/* 80C94A48  4B 5D 25 01 */	bl normalizeZP__4cXyzFv
/* 80C94A4C  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80C94A50  C0 41 00 24 */	lfs f2, 0x24(r1)
/* 80C94A54  4B 5D 2C 21 */	bl cM_atan2s__Fff
...
/* 80C94A68  4B 5D BB A1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C94A8C  4B 5D C1 05 */	bl cLib_chaseAngleS__FPsss
...
/* 80C94AC4  4B 5D AF 79 */	bl cLib_addCalc2__FPffff
...
/* 80C94AD8  4B 5D BC 69 */	bl cLib_chaseF__FPfff
lbl_80C94ADC:
...
/* 80C94AF0  4B 5D AF 4D */	bl cLib_addCalc2__FPffff
...
/* 80C94B58  4B 5D 2E 35 */	bl cM_rndFX__Ff
...
/* 80C94BCC  4B 5D BB 75 */	bl cLib_chaseF__FPfff
...
/* 80C94C20  4B 5D 2D 6D */	bl cM_rndFX__Ff
...
/* 80C94D84  4B 5D AC B9 */	bl cLib_addCalc2__FPffff
...
/* 80C94D9C  4B 5D AC A1 */	bl cLib_addCalc2__FPffff
lbl_80C94DA0:
/* 80C94DA0  A8 1B 0A 10 */	lha r0, 0xa10(r27)
/* 80C94DA4  1C 00 03 E8 */	mulli r0, r0, 0x3e8
/* 80C94DA8  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80C94DAC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C94DB0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C94E08  4B 5D BD 89 */	bl cLib_chaseAngleS__FPsss
...
/* 80C94E34  4B 5D B9 0D */	bl cLib_chaseF__FPfff
...
/* 80C94E88  4B 5D 27 ED */	bl cM_atan2s__Fff
...
/* 80C94EDC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C94EE0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C94F68  4B 38 82 8D */	bl fopAcM_riverStream__FP4cXyzPsPff
lbl_80C94F6C:
/* 80C94F6C  38 7B 05 78 */	addi r3, r27, 0x578
/* 80C94F70  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C94F74  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C94F78  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80C94F7C  4B 3E 1B 31 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80C95024  4B 4C 05 49 */	bl daNpcF_getGroundAngle__FP13cBgS_PolyInfos
...
/* 80C950B8  4B 5D A1 49 */	bl SetR__8cM3dGCylFf
/* 80C950BC  38 7B 09 2C */	addi r3, r27, 0x92c
/* 80C950C0  38 9D 00 00 */	addi r4, r29, 0
/* 80C950C4  C0 24 00 14 */	lfs f1, 0x14(r4)
/* 80C950C8  4B 5D A1 31 */	bl SetH__8cM3dGCylFf
/* 80C950CC  38 7B 09 2C */	addi r3, r27, 0x92c
/* 80C950D0  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 80C950D4  4B 5D A1 09 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80C950D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C950DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C950E0  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C950E4  38 9B 08 08 */	addi r4, r27, 0x808
/* 80C950E8  4B 5C FA C1 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80C950EC:
...
/* 80C9512C  4B 6C D0 F5 */	bl _restgpr_27
