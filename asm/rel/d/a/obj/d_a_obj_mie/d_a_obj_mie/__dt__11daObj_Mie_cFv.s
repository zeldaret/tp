...
/* 80C93FEC  3C 60 80 C9 */	lis r3, __vt__11daObj_Mie_c@ha
/* 80C93FF0  38 03 5C AC */	addi r0, r3, __vt__11daObj_Mie_c@l
/* 80C93FF4  90 1E 0A 4C */	stw r0, 0xa4c(r30)
/* 80C93FF8  38 7E 05 6C */	addi r3, r30, 0x56c
/* 80C93FFC  3C 80 80 C9 */	lis r4, l_bmdData@ha
/* 80C94000  38 84 5B 88 */	addi r4, r4, l_bmdData@l
...
/* 80C94018  3C 80 80 C9 */	lis r4, l_resNameList@ha
/* 80C9401C  38 84 5B 90 */	addi r4, r4, l_resNameList@l
/* 80C94020  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C94024  4B 39 8F E4 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80C94028  38 7E 09 60 */	addi r3, r30, 0x960
/* 80C9402C  38 80 FF FF */	li r4, -1
/* 80C94030  4B 3E 3C AC */	b __dt__11dBgS_LinChkFv
/* 80C94034  34 1E 09 44 */	addic. r0, r30, 0x944
/* 80C94038  41 82 00 10 */	beq lbl_80C94048
/* 80C9403C  3C 60 80 C9 */	lis r3, __vt__8cM3dGLin@ha
/* 80C94040  38 03 5C A0 */	addi r0, r3, __vt__8cM3dGLin@l
/* 80C94044  90 1E 09 5C */	stw r0, 0x95c(r30)
lbl_80C94048:
/* 80C94048  34 1E 08 08 */	addic. r0, r30, 0x808
/* 80C9404C  41 82 00 84 */	beq lbl_80C940D0
/* 80C94050  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80C94054  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80C94074  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80C94078  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80C9412C  3C 60 80 C9 */	lis r3, __vt__10dCcD_GStts@ha
/* 80C94130  38 03 5C 70 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 80C94134  90 1E 07 6C */	stw r0, 0x76c(r30)
/* 80C94138  34 1E 07 6C */	addic. r0, r30, 0x76c
/* 80C9413C  41 82 00 10 */	beq lbl_80C9414C
/* 80C94140  3C 60 80 C9 */	lis r3, __vt__10cCcD_GStts@ha
/* 80C94144  38 03 5C 64 */	addi r0, r3, __vt__10cCcD_GStts@l
/* 80C94148  90 1E 07 6C */	stw r0, 0x76c(r30)
lbl_80C9414C:
/* 80C9414C  34 1E 07 50 */	addic. r0, r30, 0x750
/* 80C94150  41 82 00 10 */	beq lbl_80C94160
/* 80C94154  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C94158  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C9415C  90 1E 07 68 */	stw r0, 0x768(r30)
lbl_80C94160:
/* 80C94160  34 1E 05 78 */	addic. r0, r30, 0x578
/* 80C94164  41 82 00 2C */	beq lbl_80C94190
/* 80C94168  3C 60 80 C9 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80C9416C  38 63 5C 40 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
