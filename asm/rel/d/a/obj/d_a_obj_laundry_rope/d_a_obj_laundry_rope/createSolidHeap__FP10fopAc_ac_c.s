...
/* 80C52CDC  3C 60 80 C5 */	lis r3, l_arcName@ha /* 0x80C533CC@ha */
/* 80C52CE0  38 63 33 CC */	addi r3, r3, l_arcName@l /* 0x80C533CC@l */
/* 80C52CE4  80 63 00 00 */	lwz r3, 0(r3)
/* 80C52CE8  3C 80 80 C5 */	lis r4, d_a_obj_laundry_rope__stringBase0@ha /* 0x80C533B0@ha */
/* 80C52CEC  38 84 33 B0 */	addi r4, r4, d_a_obj_laundry_rope__stringBase0@l /* 0x80C533B0@l */
/* 80C52CF0  38 84 00 0A */	addi r4, r4, 0xa
/* 80C52CF4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C52CF8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C52CFC  3C A5 00 02 */	addis r5, r5, 2
/* 80C52D00  38 C0 00 80 */	li r6, 0x80
/* 80C52D04  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C52D08  4B 3E 96 75 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80C52D20  4B 3C 06 41 */	bl init__19mDoExt_3DlineMat1_cFUsUsP7ResTIMGi
...
/* 80C52D3C  3C 60 80 C5 */	lis r3, lit_4036@ha /* 0x80C533AC@ha */
/* 80C52D40  C0 03 33 AC */	lfs f0, lit_4036@l(r3)  /* 0x80C533AC@l */
