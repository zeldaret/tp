...
/* 80C52E58  3C 80 80 C5 */	lis r4, l_arcName@ha /* 0x80C533CC@ha */
/* 80C52E5C  38 84 33 CC */	addi r4, r4, l_arcName@l /* 0x80C533CC@l */
/* 80C52E60  80 84 00 00 */	lwz r4, 0(r4)
/* 80C52E64  4B 3D A1 A5 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80C52E68  38 7F 16 8C */	addi r3, r31, 0x168c
/* 80C52E6C  3C 80 80 C5 */	lis r4, __dt__4cXyzFv@ha /* 0x80C52820@ha */
/* 80C52E70  38 84 28 20 */	addi r4, r4, __dt__4cXyzFv@l /* 0x80C52820@l */
/* 80C52E74  38 A0 00 0C */	li r5, 0xc
/* 80C52E78  38 C0 00 0D */	li r6, 0xd
/* 80C52E7C  4B 70 EE 6D */	bl __destroy_arr
/* 80C52E80  38 7F 15 F0 */	addi r3, r31, 0x15f0
/* 80C52E84  3C 80 80 C5 */	lis r4, __dt__4cXyzFv@ha /* 0x80C52820@ha */
/* 80C52E88  38 84 28 20 */	addi r4, r4, __dt__4cXyzFv@l /* 0x80C52820@l */
/* 80C52E8C  38 A0 00 0C */	li r5, 0xc
/* 80C52E90  38 C0 00 0D */	li r6, 0xd
/* 80C52E94  4B 70 EE 55 */	bl __destroy_arr
/* 80C52E98  38 7F 06 18 */	addi r3, r31, 0x618
/* 80C52E9C  3C 80 80 C5 */	lis r4, __dt__8dCcD_SphFv@ha /* 0x80C52F2C@ha */
/* 80C52EA0  38 84 2F 2C */	addi r4, r4, __dt__8dCcD_SphFv@l /* 0x80C52F2C@l */
/* 80C52EA4  38 A0 01 38 */	li r5, 0x138
/* 80C52EA8  38 C0 00 0D */	li r6, 0xd
/* 80C52EAC  4B 70 EE 3D */	bl __destroy_arr
/* 80C52EB0  34 1F 05 DC */	addic. r0, r31, 0x5dc
/* 80C52EB4  41 82 00 54 */	beq lbl_80C52F08
/* 80C52EB8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C52EBC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C52ED4  3C 60 80 C5 */	lis r3, __vt__10dCcD_GStts@ha /* 0x80C5345C@ha */
/* 80C52ED8  38 03 34 5C */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x80C5345C@l */
/* 80C52EDC  90 1F 05 F8 */	stw r0, 0x5f8(r31)
/* 80C52EE0  34 1F 05 F8 */	addic. r0, r31, 0x5f8
/* 80C52EE4  41 82 00 10 */	beq lbl_80C52EF4
/* 80C52EE8  3C 60 80 C5 */	lis r3, __vt__10cCcD_GStts@ha /* 0x80C53450@ha */
/* 80C52EEC  38 03 34 50 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x80C53450@l */
/* 80C52EF0  90 1F 05 F8 */	stw r0, 0x5f8(r31)
lbl_80C52EF4:
/* 80C52EF4  34 1F 05 DC */	addic. r0, r31, 0x5dc
/* 80C52EF8  41 82 00 10 */	beq lbl_80C52F08
/* 80C52EFC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C52F00  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C52F04  90 1F 05 F4 */	stw r0, 0x5f4(r31)
lbl_80C52F08:
/* 80C52F08  7F E3 FB 78 */	mr r3, r31
/* 80C52F0C  38 80 00 00 */	li r4, 0
/* 80C52F10  4B 3C 5D 7D */	bl __dt__10fopAc_ac_cFv
lbl_80C52F14:
