...
/* 80C52208  4B 70 FF C9 */	bl _savegpr_26
/* 80C5220C  7C 7E 1B 78 */	mr r30, r3
/* 80C52210  3C 60 80 C5 */	lis r3, M_attr__14daObjLndRope_c@ha /* 0x80C53304@ha */
/* 80C52214  3B E3 33 04 */	addi r31, r3, M_attr__14daObjLndRope_c@l /* 0x80C53304@l */
...
/* 80C52230  4B 3F F5 BD */	bl dPath_GetRoomPath__Fii
...
/* 80C522AC  4B 61 48 89 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C5231C  4B 61 53 59 */	bl cM_atan2s__Fff
...
/* 80C52340  4B 6F 4D F9 */	bl PSVECSquareMag
...
/* 80C523B0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C523B4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C52420  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C52424  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C52438  4B 61 52 3D */	bl cM_atan2s__Fff
...
/* 80C5245C  4B 6F 4C DD */	bl PSVECSquareMag
...
/* 80C524CC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C524D0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C5253C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C52540  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C52544:
...
/* 80C5256C  4B 3C 7F DD */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80C52570  38 7E 17 5C */	addi r3, r30, 0x175c
/* 80C52574  4B 6F 4B C5 */	bl PSVECSquareMag
...
/* 80C525E4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C525E8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C52654  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C52658  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C5265C:
...
/* 80C52678  4B 61 45 0D */	bl __ml__4cXyzCFf
...
/* 80C526CC  4B 61 44 19 */	bl __pl__4cXyzCFRC3Vec
...
/* 80C52778  4B 61 E4 FD */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 80C5278C  4B 61 E4 79 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80C527A4  4B 61 4C 51 */	bl __ct__5csXyzFsss
...
/* 80C527E8  4B 3C 77 09 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 80C5280C  4B 70 FA 11 */	bl _restgpr_26
