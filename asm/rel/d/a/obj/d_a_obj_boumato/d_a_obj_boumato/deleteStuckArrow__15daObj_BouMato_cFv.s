...
/* 80BBBF5C  4B 7A 62 71 */	bl _savegpr_25
/* 80BBBF60  7C 79 1B 78 */	mr r25, r3
/* 80BBBF64  38 00 00 00 */	li r0, 0
/* 80BBBF68  3C 60 80 BC */	lis r3, l_findCount@ha /* 0x80BBC808@ha */
/* 80BBBF6C  90 03 C8 08 */	stw r0, l_findCount@l(r3)  /* 0x80BBC808@l */
/* 80BBBF70  3C 60 80 BC */	lis r3, srchArrow__15daObj_BouMato_cFPvPv@ha /* 0x80BBBEA0@ha */
/* 80BBBF74  38 63 BE A0 */	addi r3, r3, srchArrow__15daObj_BouMato_cFPvPv@l /* 0x80BBBEA0@l */
/* 80BBBF78  7F 24 CB 78 */	mr r4, r25
/* 80BBBF7C  4B 45 D8 7D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80BBBF80  3B 60 00 00 */	li r27, 0
/* 80BBBF84  3B E0 00 00 */	li r31, 0
/* 80BBBF88  3C 60 80 BC */	lis r3, l_findActorPtrs@ha /* 0x80BBC678@ha */
/* 80BBBF8C  3B 83 C6 78 */	addi r28, r3, l_findActorPtrs@l /* 0x80BBC678@l */
/* 80BBBF90  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80BBBF94  3B A3 35 90 */	addi r29, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80BBBF98  3C 60 80 BC */	lis r3, l_findCount@ha /* 0x80BBC808@ha */
/* 80BBBF9C  3B C3 C8 08 */	addi r30, r3, l_findCount@l /* 0x80BBC808@l */
...
/* 80BBBFB8  4B 45 D8 41 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80BBBFBC  7C 19 18 40 */	cmplw r25, r3
/* 80BBBFC0  40 82 00 0C */	bne lbl_80BBBFCC
/* 80BBBFC4  7F 43 D3 78 */	mr r3, r26
/* 80BBBFC8  4B 45 DC B5 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_80BBBFCC:
...
/* 80BBBFE4  4B 7A 62 35 */	bl _restgpr_25
