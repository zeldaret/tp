...
/* 80BBBD98  3C 60 80 BC */	lis r3, m__21daObj_BouMato_Param_c@ha /* 0x80BBC470@ha */
/* 80BBBD9C  3B E3 C4 70 */	addi r31, r3, m__21daObj_BouMato_Param_c@l /* 0x80BBC470@l */
/* 80BBBDA0  88 1E 0A 38 */	lbz r0, 0xa38(r30)
/* 80BBBDA4  28 00 00 00 */	cmplwi r0, 0
/* 80BBBDA8  40 82 00 8C */	bne lbl_80BBBE34
/* 80BBBDAC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BBBDB0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BBBDB4  38 80 00 00 */	li r4, 0
/* 80BBBDB8  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BBBDBC  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BBBDC0  4B 5E 7A 05 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BBBDC4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BBBDC8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BBBDCC  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80BBBDD0  80 84 00 04 */	lwz r4, 4(r4)
/* 80BBBDD4  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BBBDD8  4B 5E 8F C9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BBBDDC  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80BBBDE0  4B 45 1E E5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80BBBE24  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80BBBE28  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80BBBE2C  4B 47 2A E5 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
