...
/* 80BBB00C  3C 80 80 BC */	lis r4, __vt__15daObj_BouMato_c@ha
/* 80BBB010  38 04 C6 54 */	addi r0, r4, __vt__15daObj_BouMato_c@l
...
/* 80BBB024  4B 47 1F E4 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80BBB028  38 7E 09 F8 */	addi r3, r30, 0x9f8
/* 80BBB02C  3C 80 80 BC */	lis r4, __dt__5csXyzFv@ha
/* 80BBB030  38 84 B1 F4 */	addi r4, r4, __dt__5csXyzFv@l
/* 80BBB034  38 A0 00 06 */	li r5, 6
/* 80BBB038  38 C0 00 03 */	li r6, 3
/* 80BBB03C  4B 7A 6C AC */	b __destroy_arr
/* 80BBB040  38 7E 09 78 */	addi r3, r30, 0x978
/* 80BBB044  38 80 FF FF */	li r4, -1
/* 80BBB048  4B 4B CC 94 */	b __dt__11dBgS_LinChkFv
/* 80BBB04C  34 1E 09 5C */	addic. r0, r30, 0x95c
/* 80BBB050  41 82 00 10 */	beq lbl_80BBB060
/* 80BBB054  3C 60 80 BC */	lis r3, __vt__8cM3dGLin@ha
/* 80BBB058  38 03 C6 48 */	addi r0, r3, __vt__8cM3dGLin@l
/* 80BBB05C  90 1E 09 74 */	stw r0, 0x974(r30)
lbl_80BBB060:
/* 80BBB060  34 1E 09 44 */	addic. r0, r30, 0x944
/* 80BBB064  41 82 00 10 */	beq lbl_80BBB074
/* 80BBB068  3C 60 80 BC */	lis r3, __vt__8cM3dGCyl@ha
/* 80BBB06C  38 03 C6 3C */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80BBB070  90 1E 09 58 */	stw r0, 0x958(r30)
lbl_80BBB074:
/* 80BBB074  34 1E 08 08 */	addic. r0, r30, 0x808
/* 80BBB078  41 82 00 84 */	beq lbl_80BBB0FC
/* 80BBB07C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80BBB080  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80BBB0A0  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80BBB0A4  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80BBB158  3C 60 80 BC */	lis r3, __vt__10dCcD_GStts@ha
/* 80BBB15C  38 03 C6 18 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 80BBB160  90 1E 07 6C */	stw r0, 0x76c(r30)
/* 80BBB164  34 1E 07 6C */	addic. r0, r30, 0x76c
/* 80BBB168  41 82 00 10 */	beq lbl_80BBB178
/* 80BBB16C  3C 60 80 BC */	lis r3, __vt__10cCcD_GStts@ha
/* 80BBB170  38 03 C6 0C */	addi r0, r3, __vt__10cCcD_GStts@l
/* 80BBB174  90 1E 07 6C */	stw r0, 0x76c(r30)
lbl_80BBB178:
/* 80BBB178  34 1E 07 50 */	addic. r0, r30, 0x750
/* 80BBB17C  41 82 00 10 */	beq lbl_80BBB18C
/* 80BBB180  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80BBB184  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80BBB188  90 1E 07 68 */	stw r0, 0x768(r30)
lbl_80BBB18C:
/* 80BBB18C  34 1E 05 78 */	addic. r0, r30, 0x578
/* 80BBB190  41 82 00 2C */	beq lbl_80BBB1BC
/* 80BBB194  3C 60 80 BC */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80BBB198  38 63 C5 E8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
