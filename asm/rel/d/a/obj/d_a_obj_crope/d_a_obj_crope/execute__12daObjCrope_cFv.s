...
/* 80BCE51C  4B 79 3C B9 */	bl _savegpr_27
/* 80BCE520  7C 7D 1B 78 */	mr r29, r3
/* 80BCE524  3C 80 80 BD */	lis r4, l_arcName@ha /* 0x80BCEACC@ha */
/* 80BCE528  3B E4 EA CC */	addi r31, r4, l_arcName@l /* 0x80BCEACC@l */
/* 80BCE52C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCE530  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BCE56C  4B 6A 0D 3D */	bl __ct__8cM3dGLinFRC4cXyzRC4cXyz
...
/* 80BCE594  4B 69 A0 99 */	bl cM3d_Len2dSqPntAndSegLine__FffffffPfPfPf
...
/* 80BCE620  4B 77 8D 7D */	bl PSVECSquareDistance
...
/* 80BCE690  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BCE694  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BCE700  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BCE704  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BCE744  4B 77 8C 59 */	bl PSVECSquareDistance
...
/* 80BCE7B4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BCE7B8  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BCE824  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BCE828  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BCE8E0  4B 6A 0D 69 */	bl SetC__8cM3dGSphFRC4cXyz
...
lbl_80BCE8FC:
/* 80BCE8FC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCE900  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BCE904  38 63 23 3C */	addi r3, r3, 0x233c
/* 80BCE908  38 9D 05 AC */	addi r4, r29, 0x5ac
/* 80BCE90C  4B 69 62 9D */	bl Set__4cCcSFP8cCcD_Obj
lbl_80BCE910:
/* 80BCE910  3C 60 80 BD */	lis r3, __vt__8cM3dGLin@ha /* 0x80BCEBD0@ha */
/* 80BCE914  38 03 EB D0 */	addi r0, r3, __vt__8cM3dGLin@l /* 0x80BCEBD0@l */
...
/* 80BCE940  4B 79 38 E1 */	bl _restgpr_27
