...
/* 80C54394  4B 70 DE 35 */	bl _savegpr_24
/* 80C54398  7C 9B 23 78 */	mr r27, r4
/* 80C5439C  3C 60 80 C5 */	lis r3, lit_1109@ha /* 0x80C55B40@ha */
/* 80C543A0  3B C3 5B 40 */	addi r30, r3, lit_1109@l /* 0x80C55B40@l */
/* 80C543A4  3C 60 80 C5 */	lis r3, lit_3916@ha /* 0x80C55A10@ha */
/* 80C543A8  3B E3 5A 10 */	addi r31, r3, lit_3916@l /* 0x80C55A10@l */
/* 80C543AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C543B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C543E4  4B 61 27 51 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C54454  4B 61 B5 E9 */	bl cLib_addCalc2__FPffff
/* 80C54458  C0 21 00 2C */	lfs f1, 0x2c(r1)
/* 80C5445C  C0 41 00 34 */	lfs f2, 0x34(r1)
/* 80C54460  4B 61 32 15 */	bl cM_atan2s__Fff
...
/* 80C54474  4B 61 C1 95 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C54488  4B 61 C1 81 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C544A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C544AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C544F0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C544F4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C544F8  4B 6F 1F B9 */	bl PSMTXCopy
/* 80C544FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C54500  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C5455C  4B 61 25 D9 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C54578  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C5457C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80C54590  4B 3B 7E 4D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80C545A4  4B 61 C8 B9 */	bl MtxTrans__FfffUc
/* 80C545A8  38 61 00 2C */	addi r3, r1, 0x2c
/* 80C545AC  38 81 00 20 */	addi r4, r1, 0x20
/* 80C545B0  4B 61 C9 3D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80C54658  4B 61 B3 E5 */	bl cLib_addCalc2__FPffff
...
/* 80C54670  4B 61 B3 CD */	bl cLib_addCalc2__FPffff
/* 80C54674  C0 21 00 2C */	lfs f1, 0x2c(r1)
/* 80C54678  C0 41 00 34 */	lfs f2, 0x34(r1)
/* 80C5467C  4B 61 2F F9 */	bl cM_atan2s__Fff
...
/* 80C54690  4B 61 BF 79 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C546A4  4B 61 BF 65 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C546C4  4B 70 DB 51 */	bl _restgpr_24
