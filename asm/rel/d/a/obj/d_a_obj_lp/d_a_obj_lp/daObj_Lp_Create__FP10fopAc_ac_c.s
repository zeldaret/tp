...
/* 80C554B8  4B 70 CD 09 */	bl _savegpr_22
/* 80C554BC  7C 7C 1B 78 */	mr r28, r3
/* 80C554C0  3C 80 80 C5 */	lis r4, lit_3916@ha /* 0x80C55A10@ha */
/* 80C554C4  3B C4 5A 10 */	addi r30, r4, lit_3916@l /* 0x80C55A10@l */
...
/* 80C554E0  4B 3C 36 85 */	bl __ct__10fopAc_ac_cFv
/* 80C554E4  38 76 05 7C */	addi r3, r22, 0x57c
/* 80C554E8  3C 80 80 C5 */	lis r4, __ct__5wd_ssFv@ha /* 0x80C55A04@ha */
/* 80C554EC  38 84 5A 04 */	addi r4, r4, __ct__5wd_ssFv@l /* 0x80C55A04@l */
/* 80C554F0  3C A0 80 C5 */	lis r5, __dt__5wd_ssFv@ha /* 0x80C559C8@ha */
/* 80C554F4  38 A5 59 C8 */	addi r5, r5, __dt__5wd_ssFv@l /* 0x80C559C8@l */
/* 80C554F8  38 C0 00 54 */	li r6, 0x54
/* 80C554FC  38 E0 02 00 */	li r7, 0x200
/* 80C55500  4B 70 C8 61 */	bl __construct_array
/* 80C55504  3C 60 80 C5 */	lis r3, __vt__18mDoExt_3DlineMat_c@ha /* 0x80C55B2C@ha */
/* 80C55508  38 03 5B 2C */	addi r0, r3, __vt__18mDoExt_3DlineMat_c@l /* 0x80C55B2C@l */
/* 80C5550C  3C 96 00 01 */	addis r4, r22, 1
/* 80C55510  90 04 AD 7C */	stw r0, -0x5284(r4)
/* 80C55514  3C 60 80 3A */	lis r3, __vt__19mDoExt_3DlineMat0_c@ha /* 0x803A325C@ha */
/* 80C55518  38 03 32 5C */	addi r0, r3, __vt__19mDoExt_3DlineMat0_c@l /* 0x803A325C@l */
...
/* 80C55530  3C 80 80 C5 */	lis r4, d_a_obj_lp__stringBase0@ha /* 0x80C55AC0@ha */
/* 80C55534  38 84 5A C0 */	addi r4, r4, d_a_obj_lp__stringBase0@l /* 0x80C55AC0@l */
/* 80C55538  38 84 00 07 */	addi r4, r4, 7
/* 80C5553C  4B 3D 79 81 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C55590  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C55594  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C555D0  3C 80 80 C5 */	lis r4, d_a_obj_lp__stringBase0@ha /* 0x80C55AC0@ha */
/* 80C555D4  38 84 5A C0 */	addi r4, r4, d_a_obj_lp__stringBase0@l /* 0x80C55AC0@l */
/* 80C555D8  38 84 00 0E */	addi r4, r4, 0xe
/* 80C555DC  4B 71 33 B9 */	bl strcmp
...
/* 80C55610  3C 80 80 C5 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80C5518C@ha */
/* 80C55614  38 84 51 8C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80C5518C@l */
...
/* 80C55638  4B 3C 4E 79 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80C55694  4B 3C 4E 95 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80C556A8  4B 3C 4E 91 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80C556BC  4B 61 B7 A1 */	bl MtxTrans__FfffUc
...
/* 80C556D4  4B 42 1E A9 */	bl __ct__11dBgS_GndChkFv
/* 80C556D8  38 61 00 20 */	addi r3, r1, 0x20
/* 80C556DC  4B 42 20 D5 */	bl __ct__18dBgS_ObjGndChk_SplFv
...
/* 80C556FC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C55700  3B E3 07 68 */	addi r31, r3, calc_mtx@l /* 0x80450768@l */
...
lbl_80C5571C:
/* 80C5571C  4B 61 B8 01 */	bl MtxPush__Fv
/* 80C55720  C0 3E 00 A8 */	lfs f1, 0xa8(r30)
/* 80C55724  4B 61 22 31 */	bl cM_rndF__Ff
...
/* 80C55738  4B 3B 6C FD */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80C5574C  4B 61 B7 A1 */	bl MtxPosition__FP4cXyzP4cXyz
/* 80C55750  C0 3E 00 44 */	lfs f1, 0x44(r30)
/* 80C55754  4B 61 22 01 */	bl cM_rndF__Ff
...
/* 80C5578C  4B 61 B7 CD */	bl MtxPull__Fv
...
/* 80C55804  4B 41 EC 9D */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80C55860  4B 61 21 2D */	bl cM_rndFX__Ff
...
/* 80C55890  4B 61 20 FD */	bl cM_rndFX__Ff
...
/* 80C558A4  4B 61 20 E9 */	bl cM_rndFX__Ff
...
/* 80C558D4  4B 42 1F 75 */	bl __dt__18dBgS_ObjGndChk_SplFv
/* 80C558D8  38 61 00 74 */	addi r3, r1, 0x74
/* 80C558DC  38 80 FF FF */	li r4, -1
/* 80C558E0  4B 42 1D 11 */	bl __dt__11dBgS_GndChkFv
...
/* 80C55928  3C 60 80 C5 */	lis r3, d_a_obj_lp__stringBase0@ha /* 0x80C55AC0@ha */
/* 80C5592C  38 63 5A C0 */	addi r3, r3, d_a_obj_lp__stringBase0@l /* 0x80C55AC0@l */
/* 80C55930  38 63 00 07 */	addi r3, r3, 7
/* 80C55934  38 80 00 03 */	li r4, 3
/* 80C55938  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C5593C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C55940  3C A5 00 02 */	addis r5, r5, 2
/* 80C55944  38 C0 00 80 */	li r6, 0x80
/* 80C55948  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C5594C  4B 3E 69 A1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C55964  4B 3D 71 8D */	bl addSimpleModel__14dComIfG_play_cFP12J3DModelDataiUc
...
/* 80C5597C  4B 42 1E CD */	bl __dt__18dBgS_ObjGndChk_SplFv
/* 80C55980  38 61 00 74 */	addi r3, r1, 0x74
/* 80C55984  38 80 FF FF */	li r4, -1
/* 80C55988  4B 42 1C 69 */	bl __dt__11dBgS_GndChkFv
lbl_80C5598C:
...
/* 80C559B4  4B 70 C8 59 */	bl _restgpr_22
