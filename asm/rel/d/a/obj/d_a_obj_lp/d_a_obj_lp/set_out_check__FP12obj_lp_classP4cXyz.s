...
/* 80C54B30  4B 70 D6 AD */	bl _savegpr_29
/* 80C54B34  7C 7D 1B 78 */	mr r29, r3
/* 80C54B38  7C 9F 23 78 */	mr r31, r4
/* 80C54B3C  3C 60 80 C5 */	lis r3, lit_3916@ha /* 0x80C55A10@ha */
/* 80C54B40  3B C3 5A 10 */	addi r30, r3, lit_3916@l /* 0x80C55A10@l */
/* 80C54B44  38 61 00 24 */	addi r3, r1, 0x24
/* 80C54B48  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80C54B4C  4B 61 1F E9 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C54B80  4B 6F 25 B9 */	bl PSVECSquareMag
...
/* 80C54BF0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C54BF4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C54C60  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C54C64  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C54C68:
...
lbl_80C54C9C:
/* 80C54C9C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C54CA0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C54CB4  4B 61 1E 81 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C54CD0  4B 61 29 A5 */	bl cM_atan2s__Fff
...
/* 80C54CE4  4B 61 1E 51 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C54D00  4B 61 29 75 */	bl cM_atan2s__Fff
...
/* 80C54D2C  4B 70 D4 FD */	bl _restgpr_29
