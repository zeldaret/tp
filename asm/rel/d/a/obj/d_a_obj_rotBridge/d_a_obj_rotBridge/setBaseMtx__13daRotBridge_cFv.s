...
/* 80CBEA44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBEA48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBEA4C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80CBEA50  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80CBEA54  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80CBEA58  4B 68 7E 91 */	bl PSMTXTrans
/* 80CBEA5C  A8 1F 04 B6 */	lha r0, 0x4b6(r31)
/* 80CBEA60  2C 00 00 00 */	cmpwi r0, 0
/* 80CBEA64  40 82 00 18 */	bne lbl_80CBEA7C
/* 80CBEA68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBEA6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBEA70  38 80 C0 00 */	li r4, -16384
/* 80CBEA74  4B 34 D9 C1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CBEA78  48 00 00 14 */	b lbl_80CBEA8C
lbl_80CBEA7C:
/* 80CBEA7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBEA80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBEA84  38 80 80 00 */	li r4, -32768
/* 80CBEA88  4B 34 D9 AD */	bl mDoMtx_YrotM__FPA4_fs
lbl_80CBEA8C:
...
/* 80CBEAA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBEAAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBEAB0  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80CBEAB4  38 84 00 24 */	addi r4, r4, 0x24
/* 80CBEAB8  4B 68 79 F9 */	bl PSMTXCopy
/* 80CBEABC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBEAC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBEAC4  38 9F 05 E0 */	addi r4, r31, 0x5e0
/* 80CBEAC8  4B 68 79 E9 */	bl PSMTXCopy
lbl_80CBEACC:
/* 80CBEACC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBEAD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBEAD4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80CBEAD8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80CBEADC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80CBEAE0  4B 68 7E 09 */	bl PSMTXTrans
/* 80CBEAE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBEAE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBEAEC  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80CBEAF0  4B 34 D9 45 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80CBEB10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBEB14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBEB18  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80CBEB1C  38 84 00 24 */	addi r4, r4, 0x24
/* 80CBEB20  4B 68 79 91 */	bl PSMTXCopy
