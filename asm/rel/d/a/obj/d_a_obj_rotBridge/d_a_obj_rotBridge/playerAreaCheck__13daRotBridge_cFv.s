...
/* 80CBF068  3C 60 80 CC */	lis r3, lit_3626@ha /* 0x80CBF668@ha */
/* 80CBF06C  3B C3 F6 68 */	addi r30, r3, lit_3626@l /* 0x80CBF668@l */
/* 80CBF070  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CBF074  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CBF088  4B 5A 7A AD */	bl __mi__4cXyzCFRC3Vec
...
/* 80CBF0B8  4B 68 80 81 */	bl PSVECSquareMag
...
/* 80CBF128  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CBF12C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CBF198  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CBF19C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80CBF1A0:
/* 80CBF1A0  38 00 00 00 */	li r0, 0
/* 80CBF1A4  98 1F 05 B0 */	stb r0, 0x5b0(r31)
/* 80CBF1A8  3C 60 80 CC */	lis r3, l_HIO@ha /* 0x80CBF794@ha */
/* 80CBF1AC  38 63 F7 94 */	addi r3, r3, l_HIO@l /* 0x80CBF794@l */
