...
/* 80CBEF44  4B 6A 32 99 */	bl _savegpr_29
/* 80CBEF48  7C 7D 1B 78 */	mr r29, r3
/* 80CBEF4C  7C 9E 23 78 */	mr r30, r4
/* 80CBEF50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CBEF54  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CBEF68  4B 37 63 F9 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CBEF94  4B 36 E0 D9 */	bl dComIfGp_getReverb__Fi
...
/* 80CBEFA8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CBEFAC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CBEFC0  3D 00 80 CC */	lis r8, lit_3694@ha /* 0x80CBF690@ha */
/* 80CBEFC4  C0 28 F6 90 */	lfs f1, lit_3694@l(r8)  /* 0x80CBF690@l */
/* 80CBEFC8  FC 40 08 90 */	fmr f2, f1
/* 80CBEFCC  3D 00 80 CC */	lis r8, lit_3833@ha /* 0x80CBF6A0@ha */
/* 80CBEFD0  C0 68 F6 A0 */	lfs f3, lit_3833@l(r8)  /* 0x80CBF6A0@l */
/* 80CBEFD4  FC 80 18 90 */	fmr f4, f3
/* 80CBEFD8  39 00 00 00 */	li r8, 0
/* 80CBEFDC  4B 5E C9 A9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CBEFE0  80 9D 05 DC */	lwz r4, 0x5dc(r29)
/* 80CBEFE4  28 04 00 00 */	cmplwi r4, 0
/* 80CBEFE8  41 82 00 20 */	beq lbl_80CBF008
/* 80CBEFEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CBEFF0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CBEFF4  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CBEFF8  7F A5 EB 78 */	mr r5, r29
/* 80CBEFFC  4B 3B 5A 0D */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80CBF000  80 7D 05 DC */	lwz r3, 0x5dc(r29)
/* 80CBF004  4B 3B C9 BD */	bl Move__4dBgWFv
lbl_80CBF008:
...
/* 80CBF03C  4B 6A 31 ED */	bl _restgpr_29
