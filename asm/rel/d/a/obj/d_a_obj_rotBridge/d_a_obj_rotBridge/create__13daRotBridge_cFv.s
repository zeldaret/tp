...
/* 80CBECEC  4B 3B 99 39 */	bl __ct__16dBgS_MoveBgActorFv
/* 80CBECF0  3C 60 80 CC */	lis r3, __vt__13daRotBridge_c@ha /* 0x80CBF740@ha */
/* 80CBECF4  38 03 F7 40 */	addi r0, r3, __vt__13daRotBridge_c@l /* 0x80CBF740@l */
/* 80CBECF8  90 1F 05 9C */	stw r0, 0x59c(r31)
/* 80CBECFC  3C 60 80 CC */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80CBF734@ha */
/* 80CBED00  38 03 F7 34 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80CBF734@l */
/* 80CBED04  94 1F 05 BC */	stwu r0, 0x5bc(r31)
/* 80CBED08  7F E3 FB 78 */	mr r3, r31
/* 80CBED0C  38 80 00 00 */	li r4, 0
/* 80CBED10  4B 66 96 ED */	bl init__12J3DFrameCtrlFs
...
/* 80CBED40  3C 80 80 CC */	lis r4, l_resNameIdx@ha /* 0x80CBF6D8@ha */
/* 80CBED44  38 84 F6 D8 */	addi r4, r4, l_resNameIdx@l /* 0x80CBF6D8@l */
/* 80CBED48  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CBED4C  4B 36 E1 71 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CBED68  3C 80 80 CC */	lis r4, l_resNameIdx@ha /* 0x80CBF6D8@ha */
/* 80CBED6C  38 84 F6 D8 */	addi r4, r4, l_resNameIdx@l /* 0x80CBF6D8@l */
/* 80CBED70  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CBED74  3C A0 80 CC */	lis r5, l_dzbIdx@ha /* 0x80CBF678@ha */
/* 80CBED78  38 A5 F6 78 */	addi r5, r5, l_dzbIdx@l /* 0x80CBF678@l */
/* 80CBED7C  7C A5 00 2E */	lwzx r5, r5, r0
/* 80CBED80  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80CBED84  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80CBED88  38 E0 2C 80 */	li r7, 0x2c80
/* 80CBED8C  39 00 00 00 */	li r8, 0
/* 80CBED90  4B 3B 9A 2D */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
lbl_80CBEDA4:
/* 80CBEDA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CBEDA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CBEDBC  4B 37 65 A5 */	bl isSwitch__10dSv_info_cCFii
/* 80CBEDC0  98 7E 05 AD */	stb r3, 0x5ad(r30)
/* 80CBEDC4  A8 1E 05 C4 */	lha r0, 0x5c4(r30)
/* 80CBEDC8  3C 60 80 CC */	lis r3, lit_3776@ha /* 0x80CBF698@ha */
/* 80CBEDCC  C8 23 F6 98 */	lfd f1, lit_3776@l(r3)  /* 0x80CBF698@l */
...
/* 80CBEDE8  3C 60 80 CC */	lis r3, lit_3694@ha /* 0x80CBF690@ha */
/* 80CBEDEC  C0 23 F6 90 */	lfs f1, lit_3694@l(r3)  /* 0x80CBF690@l */
...
/* 80CBEE3C  4B 66 8D 99 */	bl calcAnmMtx__8J3DModelFv
/* 80CBEE40  3C 60 80 CC */	lis r3, rideCallBack__13daRotBridge_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 0x80CBEF1C@ha */
/* 80CBEE44  38 03 EF 1C */	addi r0, r3, rideCallBack__13daRotBridge_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 0x80CBEF1C@l */
...
/* 80CBEE5C  4B 5A 93 79 */	bl ChkUsed__9cBgW_BgIdCFv
/* 80CBEE60  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CBEE64  41 82 00 20 */	beq lbl_80CBEE84
/* 80CBEE68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CBEE6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CBEE70  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CBEE74  80 9E 05 DC */	lwz r4, 0x5dc(r30)
/* 80CBEE78  4B 3B 53 D9 */	bl Release__4cBgSFP9dBgW_Base
/* 80CBEE7C  80 7E 05 DC */	lwz r3, 0x5dc(r30)
/* 80CBEE80  4B 3B CB 41 */	bl Move__4dBgWFv
lbl_80CBEE84:
...
/* 80CBEEAC  4B 35 B6 CD */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
