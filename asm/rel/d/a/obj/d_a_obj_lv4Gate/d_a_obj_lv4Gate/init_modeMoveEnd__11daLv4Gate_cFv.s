...
/* 80C5F0DC  3C 60 80 C6 */	lis r3, lit_3625@ha /* 0x80C5F3F4@ha */
/* 80C5F0E0  3B C3 F3 F4 */	addi r30, r3, lit_3625@l /* 0x80C5F3F4@l */
/* 80C5F0E4  88 1F 05 AD */	lbz r0, 0x5ad(r31)
/* 80C5F0E8  28 00 00 00 */	cmplwi r0, 0
/* 80C5F0EC  40 82 00 D8 */	bne lbl_80C5F1C4
/* 80C5F0F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5F0F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C5F0F8  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C5F0FC  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C5F100  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C5F104  4B 3A D1 05 */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C5F11C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5F120  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C5F124  38 81 00 18 */	addi r4, r1, 0x18
/* 80C5F128  7C 85 23 78 */	mr r5, r4
/* 80C5F12C  4B 6E 7C 41 */	bl PSMTXMultVec
/* 80C5F130  38 61 00 18 */	addi r3, r1, 0x18
/* 80C5F134  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80C5F138  7C 65 1B 78 */	mr r5, r3
/* 80C5F13C  4B 6E 7F 55 */	bl PSVECAdd
/* 80C5F140  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C5F144  7C 03 07 74 */	extsb r3, r0
/* 80C5F148  4B 3C DF 25 */	bl dComIfGp_getReverb__Fi
...
/* 80C5F15C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C5F160  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C5F188  4B 64 C7 FD */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C5F1A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C5F1A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C5F1A8  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C5F1AC  3C 80 80 C6 */	lis r4, l_HIO@ha /* 0x80C5F52C@ha */
/* 80C5F1B0  38 84 F5 2C */	addi r4, r4, l_HIO@l /* 0x80C5F52C@l */
/* 80C5F1B4  88 84 00 08 */	lbz r4, 8(r4)
/* 80C5F1B8  38 A0 00 0F */	li r5, 0xf
/* 80C5F1BC  38 C1 00 0C */	addi r6, r1, 0xc
/* 80C5F1C0  4B 41 08 65 */	bl StartShock__12dVibration_cFii4cXyz
lbl_80C5F1C4:
