...
/* 80C5EBF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5EBFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C5EC00  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C5EC04  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C5EC08  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C5EC0C  4B 6E 7C DD */	bl PSMTXTrans
/* 80C5EC10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5EC14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C5EC18  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C5EC1C  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C5EC20  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C5EC24  4B 3A D6 7D */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80C5EC28  C0 3F 05 B4 */	lfs f1, 0x5b4(r31)
/* 80C5EC2C  3C 60 80 C6 */	lis r3, lit_3646@ha /* 0x80C5F3F8@ha */
/* 80C5EC30  C0 43 F3 F8 */	lfs f2, lit_3646@l(r3)  /* 0x80C5F3F8@l */
/* 80C5EC34  FC 60 10 90 */	fmr f3, f2
/* 80C5EC38  4B 3A E1 65 */	bl transM__14mDoMtx_stack_cFfff
...
/* 80C5EC58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5EC5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C5EC60  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C5EC64  38 84 00 24 */	addi r4, r4, 0x24
/* 80C5EC68  4B 6E 78 49 */	bl PSMTXCopy
