...
/* 80C839A8  4B 6D E8 35 */	bl _savegpr_29
...
/* 80C839C8  4B 5E 31 6D */	bl __mi__4cXyzCFRC3Vec
...
/* 80C839E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C839E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C839EC  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 80C839F0  7C 00 00 D0 */	neg r0, r0
/* 80C839F4  7C 04 07 34 */	extsh r4, r0
/* 80C839F8  4B 38 89 E5 */	bl mDoMtx_YrotS__FPA4_fs
/* 80C839FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C83A00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C83A04  38 81 00 14 */	addi r4, r1, 0x14
/* 80C83A08  7C 85 23 78 */	mr r5, r4
/* 80C83A0C  4B 6C 33 61 */	bl PSMTXMultVec
/* 80C83A10  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80C83A14  3C 60 80 C8 */	lis r3, lit_3695@ha /* 0x80C846A4@ha */
/* 80C83A18  C0 03 46 A4 */	lfs f0, lit_3695@l(r3)  /* 0x80C846A4@l */
...
/* 80C83A84  4B 6D E7 A5 */	bl _restgpr_29
