...
/* 80C83E68  4B 6D E3 6D */	bl _savegpr_27
/* 80C83E6C  7C 7B 1B 78 */	mr r27, r3
/* 80C83E70  3C 60 80 C8 */	lis r3, lit_3695@ha /* 0x80C846A4@ha */
/* 80C83E74  3B C3 46 A4 */	addi r30, r3, lit_3695@l /* 0x80C846A4@l */
/* 80C83E78  3B 80 00 01 */	li r28, 1
/* 80C83E7C  38 A0 FF FF */	li r5, -1
/* 80C83E80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C83E84  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C83F8C  4B 5E C6 7D */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C83FA4  4B 5E C6 65 */	bl cLib_addCalcAngleS2__FPssss
lbl_80C83FA8:
...
/* 80C83FBC  4B 3A 90 B1 */	bl dComIfGp_getReverb__Fi
...
/* 80C83FD0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C83FD4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C83FFC  4B 62 79 89 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C84000:
...
/* 80C84018  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C8401C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C840D8  4B 5E C4 69 */	bl cLib_addCalcAngleS__FPsssss
lbl_80C840DC:
...
lbl_80C8412C:
/* 80C8412C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C84130  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C84150  4B 5E 29 E5 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C8416C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C84170  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C84174  A8 1B 04 E6 */	lha r0, 0x4e6(r27)
/* 80C84178  7C 00 00 D0 */	neg r0, r0
/* 80C8417C  7C 04 07 34 */	extsh r4, r0
/* 80C84180  4B 38 82 5D */	bl mDoMtx_YrotS__FPA4_fs
/* 80C84184  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C84188  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8418C  38 81 00 18 */	addi r4, r1, 0x18
/* 80C84190  7C 85 23 78 */	mr r5, r4
/* 80C84194  4B 6C 2B D9 */	bl PSMTXMultVec
...
/* 80C84224  4B 6D DF FD */	bl _restgpr_27
