...
/* 80CFEA5C  4B 56 97 79 */	bl ChkUsed__9cBgW_BgIdCFv
/* 80CFEA60  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CFEA64  41 82 00 18 */	beq lbl_80CFEA7C
/* 80CFEA68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CFEA6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CFEA70  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CFEA74  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80CFEA78  4B 37 57 D9 */	bl Release__4cBgSFP9dBgW_Base
lbl_80CFEA7C:
/* 80CFEA7C  38 7F 05 68 */	addi r3, r31, 0x568
/* 80CFEA80  80 1F 05 C0 */	lwz r0, 0x5c0(r31)
/* 80CFEA84  1C A0 00 38 */	mulli r5, r0, 0x38
/* 80CFEA88  3C 80 80 D0 */	lis r4, M_attr__Q212daObjSwpush25Act_c@ha /* 0x80CFFC00@ha */
/* 80CFEA8C  38 04 FC 00 */	addi r0, r4, M_attr__Q212daObjSwpush25Act_c@l /* 0x80CFFC00@l */
/* 80CFEA90  7C 80 2A 14 */	add r4, r0, r5
/* 80CFEA94  80 84 00 0C */	lwz r4, 0xc(r4)
/* 80CFEA98  4B 32 E5 71 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
