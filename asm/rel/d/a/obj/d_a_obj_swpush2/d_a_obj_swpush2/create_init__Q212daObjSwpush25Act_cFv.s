...
/* 80CFE6E8  4B 66 3A E5 */	bl _savegpr_25
/* 80CFE6EC  7C 7D 1B 78 */	mr r29, r3
/* 80CFE6F0  3C 60 80 D0 */	lis r3, M_arcname__Q212daObjSwpush25Act_c@ha /* 0x80CFFBF4@ha */
/* 80CFE6F4  3B E3 FB F4 */	addi r31, r3, M_arcname__Q212daObjSwpush25Act_c@l /* 0x80CFFBF4@l */
/* 80CFE6F8  3B C0 00 01 */	li r30, 1
/* 80CFE6FC  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80CFE700  4B 30 E6 65 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80CFE704  38 7D 04 E4 */	addi r3, r29, 0x4e4
/* 80CFE708  4B 30 E8 3D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CFE70C  38 7D 04 EC */	addi r3, r29, 0x4ec
/* 80CFE710  4B 30 E7 61 */	bl scaleM__14mDoMtx_stack_cFRC4cXyz
/* 80CFE714  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFE718  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFE71C  38 9D 05 74 */	addi r4, r29, 0x574
/* 80CFE720  4B 64 7D 91 */	bl PSMTXCopy
/* 80CFE724  3C 60 80 D0 */	lis r3, rideCB__Q212daObjSwpush25Act_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 0x80CFEB78@ha */
/* 80CFE728  38 03 EB 78 */	addi r0, r3, rideCB__Q212daObjSwpush25Act_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 0x80CFEB78@l */
...
/* 80CFE780  4B 31 BD C9 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80CFE7E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CFE7E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CFE7E8  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 80CFE7EC  7C 05 07 74 */	extsb r5, r0
/* 80CFE7F0  4B 33 6B 71 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CFE878  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CFE87C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CFE880  3B 23 0F 38 */	addi r25, r3, 0xf38
/* 80CFE884  38 79 40 C0 */	addi r3, r25, 0x40c0
/* 80CFE888  7F A4 EB 78 */	mr r4, r29
/* 80CFE88C  4B 34 8E 0D */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
/* 80CFE8A0  4B 37 61 69 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80CFE8B8  4B 66 39 61 */	bl _restgpr_25
