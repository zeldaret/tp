...
/* 80CFF914  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CFF918  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CFF91C  38 80 00 10 */	li r4, 0x10
/* 80CFF920  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CFF924  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CFF928  4B 4A 3E 9D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CFF92C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CFF930  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CFF934  80 9F 05 A4 */	lwz r4, 0x5a4(r31)
/* 80CFF938  80 84 00 04 */	lwz r4, 4(r4)
/* 80CFF93C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CFF940  4B 4A 54 61 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80CFF958  4B 30 DE 51 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80CFF970  4B 30 DD 69 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80CFF988  3C 80 80 D0 */	lis r4, lit_3858@ha /* 0x80CFFCE4@ha */
/* 80CFF98C  C0 24 FC E4 */	lfs f1, lit_3858@l(r4)  /* 0x80CFFCE4@l */
...
/* 80CFF9AC  3C 80 80 D0 */	lis r4, lit_3858@ha /* 0x80CFFCE4@ha */
/* 80CFF9B0  C0 04 FC E4 */	lfs f0, lit_3858@l(r4)  /* 0x80CFFCE4@l */
...
/* 80CFF9D0  4B 30 DD 09 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80CFF9E8  4B 30 DB 31 */	bl entry__13mDoExt_bpkAnmFP16J3DMaterialTablef
...
/* 80CFFA00  4B 30 DD A9 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80CFFA18  4B 30 DC C1 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80CFFA1C:
/* 80CFFA1C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CFFA20  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CFFA24  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CFFA28  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CFFA2C  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CFFA40  4B 30 E2 85 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CFFA44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CFFA48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CFFA70  4B 62 FE 11 */	bl removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
...
/* 80CFFA88  4B 62 FD 2D */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
...
/* 80CFFAA0  3C 60 80 D0 */	lis r3, lit_3858@ha /* 0x80CFFCE4@ha */
/* 80CFFAA4  C0 23 FC E4 */	lfs f1, lit_3858@l(r3)  /* 0x80CFFCE4@l */
...
/* 80CFFAC4  3C 60 80 D0 */	lis r3, lit_3858@ha /* 0x80CFFCE4@ha */
/* 80CFFAC8  C0 03 FC E4 */	lfs f0, lit_3858@l(r3)  /* 0x80CFFCE4@l */
...
/* 80CFFAE8  4B 62 FC CD */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
...
/* 80CFFB00  4B 62 FB 4D */	bl removeMatColorAnimator__16J3DMaterialTableFP11J3DAnmColor
...
/* 80CFFB18  4B 62 FD 69 */	bl removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
...
/* 80CFFB30  4B 62 FC 85 */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_80CFFB34:
