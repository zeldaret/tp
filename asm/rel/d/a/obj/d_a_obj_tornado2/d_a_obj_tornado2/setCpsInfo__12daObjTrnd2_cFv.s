...
/* 80D1C7A0  3C 60 80 D2 */	lis r3, l_R02_eff_id@ha /* 0x80D1D3D4@ha */
/* 80D1C7A4  3B E3 D3 D4 */	addi r31, r3, l_R02_eff_id@l /* 0x80D1D3D4@l */
...
/* 80D1C7C4  4B 55 3F 7D */	bl cLib_chaseF__FPfff
...
/* 80D1C7F8  4B 2F 05 6D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80D1C7FC  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80D1C800  4B 2F 07 45 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D1C804  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1C808  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1C80C  38 9E 06 F4 */	addi r4, r30, 0x6f4
/* 80D1C810  7C 85 23 78 */	mr r5, r4
/* 80D1C814  4B 62 A5 59 */	bl PSMTXMultVec
/* 80D1C818  38 7E 06 C8 */	addi r3, r30, 0x6c8
/* 80D1C81C  38 9E 06 E8 */	addi r4, r30, 0x6e8
/* 80D1C820  4B 55 28 1D */	bl Set__8cM3dGCpsFRC9cM3dGCpsS
...
/* 80D1C884  4B 54 A8 29 */	bl isZero__4cXyzCFv
...
/* 80D1C898  4B 54 A6 5D */	bl normalize__4cXyzFv
/* 80D1C89C  48 00 00 20 */	b lbl_80D1C8BC
lbl_80D1C8A0:
/* 80D1C8A0  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 80D1C8A4  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 80D1C8E0  4B 62 A7 F9 */	bl PSVECScale
