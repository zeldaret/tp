...
/* 80D13AD0  4B 30 52 11 */	bl fopAc_IsActor__FPv
...
/* 80D13AEC  4B 9D 76 11 */	bl isWait__8daE_HZ_cFv
/* 80D13AF0  54 60 06 3E */	clrlwi r0, r3, 0x18
/* 80D13AF4  28 00 00 01 */	cmplwi r0, 1
/* 80D13AF8  40 82 00 48 */	bne lbl_80D13B40
/* 80D13AFC  3C 60 80 D1 */	lis r3, hz_check_pos_x@ha /* 0x80D15910@ha */
/* 80D13B00  C0 23 59 10 */	lfs f1, hz_check_pos_x@l(r3)  /* 0x80D15910@l */
/* 80D13B04  C0 1F 04 D0 */	lfs f0, 0x4d0(r31)
/* 80D13B08  EC 41 00 28 */	fsubs f2, f1, f0
/* 80D13B0C  3C 60 80 D1 */	lis r3, hz_check_pos_z@ha /* 0x80D15914@ha */
/* 80D13B10  C0 23 59 14 */	lfs f1, hz_check_pos_z@l(r3)  /* 0x80D15914@l */
...
/* 80D13B28  3C 60 80 D1 */	lis r3, lit_3917@ha /* 0x80D1560C@ha */
/* 80D13B2C  C0 03 56 0C */	lfs f0, lit_3917@l(r3)  /* 0x80D1560C@l */
