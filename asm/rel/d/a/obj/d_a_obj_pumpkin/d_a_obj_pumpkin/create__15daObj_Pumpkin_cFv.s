...
/* 80CB5A14  4B 6A C7 B5 */	bl _savegpr_24
/* 80CB5A18  7C 7A 1B 78 */	mr r26, r3
/* 80CB5A1C  3C 80 80 CC */	lis r4, cNullVec__6Z2Calc@ha /* 0x80CB846C@ha */
/* 80CB5A20  3B C4 84 6C */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x80CB846C@l */
/* 80CB5A24  3C 80 80 CC */	lis r4, m__21daObj_Pumpkin_Param_c@ha /* 0x80CB8370@ha */
/* 80CB5A28  3B E4 83 70 */	addi r31, r4, m__21daObj_Pumpkin_Param_c@l /* 0x80CB8370@l */
...
/* 80CB5A44  4B 36 31 21 */	bl __ct__10fopAc_ac_cFv
/* 80CB5A48  3C 60 80 CC */	lis r3, __vt__15daObj_Pumpkin_c@ha /* 0x80CB85B0@ha */
/* 80CB5A4C  38 03 85 B0 */	addi r0, r3, __vt__15daObj_Pumpkin_c@l /* 0x80CB85B0@l */
/* 80CB5A50  90 19 0B B8 */	stw r0, 0xbb8(r25)
/* 80CB5A54  3B 19 05 78 */	addi r24, r25, 0x578
/* 80CB5A58  7F 03 C3 78 */	mr r3, r24
/* 80CB5A5C  4B 3C 06 45 */	bl __ct__9dBgS_AcchFv
/* 80CB5A60  3C 60 80 CC */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80CB8544@ha */
/* 80CB5A64  38 63 85 44 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80CB8544@l */
...
/* 80CB5A80  4B 3C 33 E9 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80CB5A84  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CB5A88  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CB5A8C  90 19 07 68 */	stw r0, 0x768(r25)
/* 80CB5A90  38 79 07 6C */	addi r3, r25, 0x76c
/* 80CB5A94  4B 3C DC CD */	bl __ct__10dCcD_GSttsFv
/* 80CB5A98  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CB5A9C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CB5AB0  4B 3C 03 FD */	bl __ct__12dBgS_AcchCirFv
/* 80CB5AB4  38 79 07 CC */	addi r3, r25, 0x7cc
/* 80CB5AB8  4B 5B 21 65 */	bl __ct__11cBgS_GndChkFv
/* 80CB5ABC  3B 19 08 08 */	addi r24, r25, 0x808
/* 80CB5AC0  7F 03 C3 78 */	mr r3, r24
/* 80CB5AC4  4B 3C DF 65 */	bl __ct__12dCcD_GObjInfFv
/* 80CB5AC8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CB5ACC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CB5AD0  90 18 01 20 */	stw r0, 0x120(r24)
/* 80CB5AD4  3C 60 80 CC */	lis r3, __vt__8cM3dGAab@ha /* 0x80CB858C@ha */
/* 80CB5AD8  38 03 85 8C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CB858C@l */
/* 80CB5ADC  90 18 01 1C */	stw r0, 0x11c(r24)
/* 80CB5AE0  3C 60 80 CC */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CB8598@ha */
/* 80CB5AE4  38 03 85 98 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CB8598@l */
/* 80CB5AE8  90 18 01 38 */	stw r0, 0x138(r24)
/* 80CB5AEC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CB5AF0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80CB5AF4  90 78 01 20 */	stw r3, 0x120(r24)
/* 80CB5AF8  3B A3 00 58 */	addi r29, r3, 0x58
/* 80CB5AFC  93 B8 01 38 */	stw r29, 0x138(r24)
/* 80CB5B00  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CB5B04  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80CB5B24  4B 3C DF 05 */	bl __ct__12dCcD_GObjInfFv
/* 80CB5B28  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CB5B2C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CB5B30  90 18 01 20 */	stw r0, 0x120(r24)
/* 80CB5B34  3C 60 80 CC */	lis r3, __vt__8cM3dGAab@ha /* 0x80CB858C@ha */
/* 80CB5B38  38 03 85 8C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CB858C@l */
/* 80CB5B3C  90 18 01 1C */	stw r0, 0x11c(r24)
/* 80CB5B40  3C 60 80 CC */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CB8598@ha */
/* 80CB5B44  38 03 85 98 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CB8598@l */
/* 80CB5B48  90 18 01 38 */	stw r0, 0x138(r24)
/* 80CB5B4C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CB5B50  38 03 35 A4 */	addi r0, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80CB5B54  90 18 01 20 */	stw r0, 0x120(r24)
/* 80CB5B58  93 B8 01 38 */	stw r29, 0x138(r24)
/* 80CB5B5C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CB5B60  38 03 C0 50 */	addi r0, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
/* 80CB5B64  90 18 00 3C */	stw r0, 0x3c(r24)
/* 80CB5B68  93 98 01 20 */	stw r28, 0x120(r24)
/* 80CB5B6C  93 78 01 38 */	stw r27, 0x138(r24)
/* 80CB5B70  3C 60 80 CC */	lis r3, __vt__8cM3dGLin@ha /* 0x80CB85A4@ha */
/* 80CB5B74  38 03 85 A4 */	addi r0, r3, __vt__8cM3dGLin@l /* 0x80CB85A4@l */
/* 80CB5B78  90 19 0A A4 */	stw r0, 0xaa4(r25)
/* 80CB5B7C  38 79 0A A8 */	addi r3, r25, 0xaa8
/* 80CB5B80  4B 3C 20 E9 */	bl __ct__11dBgS_LinChkFv
lbl_80CB5B84:
...
/* 80CB5C00  4B 37 72 BD */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CB5C4C  3C 80 80 CB */	lis r4, createHeapCallBack__15daObj_Pumpkin_cFP10fopAc_ac_c@ha /* 0x80CB7824@ha */
/* 80CB5C50  38 84 78 24 */	addi r4, r4, createHeapCallBack__15daObj_Pumpkin_cFP10fopAc_ac_c@l /* 0x80CB7824@l */
/* 80CB5C54  38 A0 0E B0 */	li r5, 0xeb0
/* 80CB5C58  4B 36 48 59 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80CB5C94  4B 36 48 B5 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80CB5CC8  4B 3C 05 81 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80CB5CEC  4B 3C DB 75 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80CB5CF0  38 7A 08 08 */	addi r3, r26, 0x808
/* 80CB5CF4  38 9E 00 30 */	addi r4, r30, 0x30
/* 80CB5CF8  4B 3C EB BD */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80CB5D0C  4B 3C EB A9 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80CB5D60  4B 6A C4 B5 */	bl _restgpr_24
