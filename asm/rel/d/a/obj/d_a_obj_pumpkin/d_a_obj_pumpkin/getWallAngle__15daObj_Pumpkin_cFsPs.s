...
/* 80CB7B9C  4B 6A A6 31 */	bl _savegpr_25
/* 80CB7BA0  7C 79 1B 78 */	mr r25, r3
/* 80CB7BA4  7C BA 2B 78 */	mr r26, r5
/* 80CB7BA8  3C 60 80 CC */	lis r3, m__21daObj_Pumpkin_Param_c@ha /* 0x80CB8370@ha */
/* 80CB7BAC  3B A3 83 70 */	addi r29, r3, m__21daObj_Pumpkin_Param_c@l /* 0x80CB8370@l */
/* 80CB7BB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CB7BB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CB7BB8  4B 35 48 25 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80CB7BD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CB7BD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CB7BD8  38 81 00 14 */	addi r4, r1, 0x14
/* 80CB7BDC  38 A1 00 20 */	addi r5, r1, 0x20
/* 80CB7BE0  4B 68 F1 8D */	bl PSMTXMultVec
/* 80CB7BE4  38 61 00 20 */	addi r3, r1, 0x20
/* 80CB7BE8  38 99 04 D0 */	addi r4, r25, 0x4d0
/* 80CB7BEC  7C 65 1B 78 */	mr r5, r3
/* 80CB7BF0  4B 68 F4 A1 */	bl PSVECAdd
...
/* 80CB7C14  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB7C18  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB7C1C  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80CB7C20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CB7C24  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80CB7C40  4B 68 F1 2D */	bl PSMTXMultVec
...
/* 80CB7C5C  4B 68 F4 35 */	bl PSVECAdd
...
/* 80CB7C70  4B 3C 00 F5 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80CB7C74  7F 83 E3 78 */	mr r3, r28
/* 80CB7C78  38 99 0A A8 */	addi r4, r25, 0xaa8
/* 80CB7C7C  4B 3B C7 39 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80CB7CC8  4B 5A EE 6D */	bl __mi__4cXyzCFRC3Vec
...
/* 80CB7CE4  4B 5A F9 91 */	bl cM_atan2s__Fff
...
/* 80CB7D00  4B 6A A5 19 */	bl _restgpr_25
