...
/* 80D19C44  4B 64 85 99 */	bl _savegpr_29
/* 80D19C48  7C 7F 1B 78 */	mr r31, r3
/* 80D19C4C  3C 60 80 D2 */	lis r3, lit_3775@ha /* 0x80D1B6D8@ha */
/* 80D19C50  3B C3 B6 D8 */	addi r30, r3, lit_3775@l /* 0x80D1B6D8@l */
/* 80D19C54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D19C58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D19C94  4B 62 D7 09 */	bl PSVECSquareDistance
...
/* 80D19D04  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D19D08  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80D19D74  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D19D78  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80D19D7C:
...
/* 80D19DF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D19DF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D19E14  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80D19E18  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80D19E1C  80 84 00 00 */	lwz r4, 0(r4)
/* 80D19E20  4B 62 C6 91 */	bl PSMTXCopy
/* 80D19E24  38 61 00 24 */	addi r3, r1, 0x24
/* 80D19E28  38 9F 07 3C */	addi r4, r31, 0x73c
/* 80D19E2C  4B 55 70 C1 */	bl MtxPosition__FP4cXyzP4cXyz
lbl_80D19E30:
/* 80D19E30  39 61 00 40 */	addi r11, r1, 0x40
/* 80D19E34  4B 64 83 F5 */	bl _restgpr_29
