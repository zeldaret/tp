...
/* 80C90398  3C 80 80 C9 */	lis r4, d_a_obj_maki__stringBase0@ha /* 0x80C90960@ha */
/* 80C9039C  38 84 09 60 */	addi r4, r4, d_a_obj_maki__stringBase0@l /* 0x80C90960@l */
/* 80C903A0  4B 39 CC 69 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80C903B4  3C 60 80 C9 */	lis r3, data_80C90A50@ha /* 0x80C90A50@ha */
/* 80C903B8  98 03 0A 50 */	stb r0, data_80C90A50@l(r3)  /* 0x80C90A50@l */
lbl_80C903BC:
/* 80C903BC  C0 3F 07 20 */	lfs f1, 0x720(r31)
/* 80C903C0  3C 60 80 C9 */	lis r3, lit_3933@ha /* 0x80C90948@ha */
/* 80C903C4  C0 03 09 48 */	lfs f0, lit_3933@l(r3)  /* 0x80C90948@l */
/* 80C903C8  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C903CC  40 81 00 0C */	ble lbl_80C903D8
/* 80C903D0  38 7F 07 0C */	addi r3, r31, 0x70c
/* 80C903D4  4B 51 75 59 */	bl dKy_plight_cut__FP15LIGHT_INFLUENCE
lbl_80C903D8:
