...
/* 80C8FE38  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C8FE3C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C8FE40  38 80 00 10 */	li r4, 0x10
/* 80C8FE44  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C8FE48  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80C8FE4C  4B 51 39 79 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C8FE50  A8 1F 05 7E */	lha r0, 0x57e(r31)
/* 80C8FE54  2C 00 00 00 */	cmpwi r0, 0
/* 80C8FE58  40 82 00 40 */	bne lbl_80C8FE98
/* 80C8FE5C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C8FE60  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C8FE64  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80C8FE68  80 84 00 04 */	lwz r4, 4(r4)
/* 80C8FE6C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C8FE70  4B 51 4F 31 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C8FE88  4B 37 D9 21 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80C8FE8C  80 7F 05 70 */	lwz r3, 0x570(r31)
/* 80C8FE90  4B 37 DE 35 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80C8FEA4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C8FEA8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C8FEAC  80 9F 05 78 */	lwz r4, 0x578(r31)
/* 80C8FEB0  80 84 00 04 */	lwz r4, 4(r4)
/* 80C8FEB4  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C8FEB8  4B 51 4E E9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C8FEBC  80 7F 05 78 */	lwz r3, 0x578(r31)
/* 80C8FEC0  4B 37 DE 05 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80C8FEC4:
