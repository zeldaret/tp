...
/* 80C9059C  4B 6D 1C 41 */	bl _savegpr_29
/* 80C905A0  7C 7E 1B 78 */	mr r30, r3
/* 80C905A4  3C 80 80 C9 */	lis r4, lit_3928@ha /* 0x80C90934@ha */
/* 80C905A8  3B E4 09 34 */	addi r31, r4, lit_3928@l /* 0x80C90934@l */
...
/* 80C905C4  4B 38 85 A1 */	bl __ct__10fopAc_ac_cFv
/* 80C905C8  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C905CC  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C905D0  90 1D 05 9C */	stw r0, 0x59c(r29)
/* 80C905D4  38 7D 05 A0 */	addi r3, r29, 0x5a0
/* 80C905D8  4B 3F 31 89 */	bl __ct__10dCcD_GSttsFv
/* 80C905DC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C905E0  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C905F8  4B 3F 34 31 */	bl __ct__12dCcD_GObjInfFv
/* 80C905FC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C90600  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C90604  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80C90608  3C 60 80 C9 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C90A20@ha */
/* 80C9060C  38 03 0A 20 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C90A20@l */
/* 80C90610  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80C90614  3C 60 80 C9 */	lis r3, __vt__8cM3dGSph@ha /* 0x80C90A14@ha */
/* 80C90618  38 03 0A 14 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80C90A14@l */
/* 80C9061C  90 1D 01 34 */	stw r0, 0x134(r29)
/* 80C90620  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80C90624  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 80C90628  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80C9062C  38 03 00 58 */	addi r0, r3, 0x58
/* 80C90630  90 1D 01 34 */	stw r0, 0x134(r29)
/* 80C90634  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80C90638  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80C90660  3C 80 80 C9 */	lis r4, d_a_obj_maki__stringBase0@ha /* 0x80C90960@ha */
/* 80C90664  38 84 09 60 */	addi r4, r4, d_a_obj_maki__stringBase0@l /* 0x80C90960@l */
/* 80C90668  4B 39 C8 55 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C90690  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C90694  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C90698  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C9069C  7C 05 07 74 */	extsb r5, r0
/* 80C906A0  4B 3A 4C C1 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C906B8  3C 80 80 C9 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80C903F0@ha */
/* 80C906BC  38 84 03 F0 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80C903F0@l */
/* 80C906C0  38 A0 10 20 */	li r5, 0x1020
/* 80C906C4  4B 38 9D ED */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80C906D8:
/* 80C906D8  3C 60 80 C9 */	lis r3, data_80C90A50@ha /* 0x80C90A50@ha */
/* 80C906DC  8C 03 0A 50 */	lbzu r0, data_80C90A50@l(r3)  /* 0x80C90A50@l */
...
/* 80C906F8  3C 60 80 C9 */	lis r3, l_HIO@ha /* 0x80C90A60@ha */
/* 80C906FC  38 63 0A 60 */	addi r3, r3, l_HIO@l /* 0x80C90A60@l */
...
/* 80C90714  4B 38 9E 15 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80C90728  4B 38 9E 11 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80C9073C  4B 3F 31 25 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C90740  38 7E 05 C0 */	addi r3, r30, 0x5c0
/* 80C90744  3C 80 80 C9 */	lis r4, cc_sph_src@ha /* 0x80C90984@ha */
/* 80C90748  38 84 09 84 */	addi r4, r4, cc_sph_src@l /* 0x80C90984@l */
/* 80C9074C  4B 3F 42 E9 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
lbl_80C90770:
/* 80C90770  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C90774  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C90778  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 80C9077C  3C 80 80 C9 */	lis r4, d_a_obj_maki__stringBase0@ha /* 0x80C90960@ha */
/* 80C90780  38 84 09 60 */	addi r4, r4, d_a_obj_maki__stringBase0@l /* 0x80C90960@l */
/* 80C90784  38 84 00 09 */	addi r4, r4, 9
/* 80C90788  4B 6D 82 0D */	bl strcmp
...
/* 80C907E4  4B 51 6F AD */	bl dKy_plight_set__FP15LIGHT_INFLUENCE
lbl_80C907E8:
...
/* 80C907F8  4B 6D 1A 31 */	bl _restgpr_29
