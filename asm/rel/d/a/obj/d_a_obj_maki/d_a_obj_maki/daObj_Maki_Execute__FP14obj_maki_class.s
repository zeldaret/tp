...
/* 80C8FEEC  4B 6D 22 D9 */	bl _savegpr_23
/* 80C8FEF0  7C 7F 1B 78 */	mr r31, r3
/* 80C8FEF4  3C 60 80 C9 */	lis r3, lit_3928@ha /* 0x80C90934@ha */
/* 80C8FEF8  3B C3 09 34 */	addi r30, r3, lit_3928@l /* 0x80C90934@l */
...
/* 80C8FF54  4B 37 D4 D5 */	bl play__14mDoExt_baseAnmFv
/* 80C8FF58  3A E0 00 00 */	li r23, 0
/* 80C8FF5C  3B 60 00 00 */	li r27, 0
/* 80C8FF60  3B 40 00 00 */	li r26, 0
/* 80C8FF64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C8FF68  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C8FF6C  3C 60 80 C9 */	lis r3, eff_id_3814@ha /* 0x80C90974@ha */
/* 80C8FF70  3B 23 09 74 */	addi r25, r3, eff_id_3814@l /* 0x80C90974@l */
lbl_80C8FF74:
...
/* 80C8FFC0  4B 3B D5 0D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C8FFE4  4B 3F 44 7D */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 80C8FFF8  4B 3F 46 61 */	bl ChkCoHit__12dCcD_GObjInfFv
/* 80C8FFFC  28 03 00 00 */	cmplwi r3, 0
/* 80C90000  41 82 00 20 */	beq lbl_80C90020
/* 80C90004  38 7F 05 C0 */	addi r3, r31, 0x5c0
/* 80C90008  4B 3F 46 E9 */	bl GetCoHitObj__12dCcD_GObjInfFv
/* 80C9000C  4B 5D 3A 3D */	bl GetAc__8cCcD_ObjFv
...
/* 80C90030  4B 3F 42 91 */	bl ChkAtHit__12dCcD_GObjInfFv
...
/* 80C9004C  4B 39 D0 21 */	bl dComIfGp_getReverb__Fi
...
/* 80C90060  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C90064  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C9008C  4B 61 B8 F9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C90090:
...
/* 80C900B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C900B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C900B8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C900BC  7C 05 07 74 */	extsb r5, r0
/* 80C900C0  4B 3A 51 41 */	bl onSwitch__10dSv_info_cFii
lbl_80C900C4:
/* 80C900C4  3A E0 00 00 */	li r23, 0
/* 80C900C8  3B A0 00 00 */	li r29, 0
/* 80C900CC  3C 60 80 C9 */	lis r3, eff_id_3833@ha /* 0x80C90980@ha */
/* 80C900D0  3B 43 09 80 */	addi r26, r3, eff_id_3833@l /* 0x80C90980@l */
lbl_80C900D4:
...
/* 80C90114  4B 3B C9 7D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C90130  4B 39 CF 3D */	bl dComIfGp_getReverb__Fi
...
/* 80C90144  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C90148  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C90170  4B 61 B8 15 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C90174  83 BF 05 78 */	lwz r29, 0x578(r31)
lbl_80C90178:
/* 80C90178  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C9017C  7C 03 07 74 */	extsb r3, r0
/* 80C90180  4B 39 CE ED */	bl dComIfGp_getReverb__Fi
...
/* 80C90194  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C90198  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C901C0  4B 61 C3 4D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C901E8  4B 5D F5 21 */	bl SetR__8cM3dGSphFf
/* 80C901EC  48 00 00 10 */	b lbl_80C901FC
lbl_80C901F0:
/* 80C901F0  38 7F 06 E4 */	addi r3, r31, 0x6e4
/* 80C901F4  C0 3E 00 10 */	lfs f1, 0x10(r30)
/* 80C901F8  4B 5D F5 11 */	bl SetR__8cM3dGSphFf
lbl_80C901FC:
/* 80C901FC  38 7F 06 E4 */	addi r3, r31, 0x6e4
/* 80C90200  38 81 00 30 */	addi r4, r1, 0x30
/* 80C90204  4B 5D F4 45 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80C90208  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9020C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C90210  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C90214  38 9F 05 C0 */	addi r4, r31, 0x5c0
/* 80C90218  4B 5D 49 91 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80C90230  4B 51 76 FD */	bl dKy_plight_cut__FP15LIGHT_INFLUENCE
...
/* 80C9025C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C90260  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C902B0  4B 3B D2 1D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80C902B4  90 7F 06 F8 */	stw r3, 0x6f8(r31)
/* 80C902B8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C902BC  7C 03 07 74 */	extsb r3, r0
/* 80C902C0  4B 39 CD AD */	bl dComIfGp_getReverb__Fi
...
/* 80C902D4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C902D8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C90300  4B 61 C2 0D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C90304:
/* 80C90304  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C90308  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9030C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C90310  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C90314  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C90318  4B 6B 65 D1 */	bl PSMTXTrans
/* 80C9031C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C90320  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C90324  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C90328  4B 37 C1 0D */	bl mDoMtx_YrotM__FPA4_fs
/* 80C9032C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C90330  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C90334  38 9D 00 24 */	addi r4, r29, 0x24
/* 80C90338  4B 6B 61 79 */	bl PSMTXCopy
...
/* 80C90364  4B 6D 1E AD */	bl _restgpr_23
