...
/* 80D09758  4B 65 8A 81 */	bl _savegpr_28
/* 80D0975C  7C 7C 1B 78 */	mr r28, r3
/* 80D09760  3C 60 80 D1 */	lis r3, lit_3775@ha /* 0x80D0B8F0@ha */
/* 80D09764  3B E3 B8 F0 */	addi r31, r3, lit_3775@l /* 0x80D0B8F0@l */
...
/* 80D097B8  4B 36 E4 B1 */	bl __ct__11dBgS_LinChkFv
/* 80D097BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D097C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D097C4  83 C3 5D AC */	lwz r30, 0x5dac(r3)
/* 80D097C8  38 61 00 9C */	addi r3, r1, 0x9c
/* 80D097CC  4B 36 F6 9D */	bl SetObj__16dBgS_PolyPassChkFv
...
lbl_80D097F8:
/* 80D097F8  3C 60 80 D1 */	lis r3, d_a_obj_ten__stringBase0@ha /* 0x80D0B9E4@ha */
/* 80D097FC  38 63 B9 E4 */	addi r3, r3, d_a_obj_ten__stringBase0@l /* 0x80D0B9E4@l */
/* 80D09800  38 80 00 06 */	li r4, 6
/* 80D09804  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D09808  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D0980C  3C A5 00 02 */	addis r5, r5, 2
/* 80D09810  38 C0 00 80 */	li r6, 0x80
/* 80D09814  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80D09818  4B 33 2A D5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D09838  4B 30 76 39 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80D09888  4B 30 36 85 */	bl ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80D0988C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D09890  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D09894  38 81 00 38 */	addi r4, r1, 0x38
/* 80D09898  7C 85 23 78 */	mr r5, r4
/* 80D0989C  4B 63 D4 D1 */	bl PSMTXMultVec
/* 80D098A0  C0 3F 00 84 */	lfs f1, 0x84(r31)
/* 80D098A4  4B 55 E0 B1 */	bl cM_rndF__Ff
...
/* 80D098D0  4B 55 E0 85 */	bl cM_rndF__Ff
...
/* 80D098F4  4B 55 E0 61 */	bl cM_rndF__Ff
...
/* 80D09914  4B 55 E0 41 */	bl cM_rndF__Ff
...
/* 80D099E4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D099E8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80D09A54  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D09A58  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80D09A5C:
...
/* 80D09A88  4B 56 6B 81 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80D09AA0  4B 56 6B 69 */	bl cLib_addCalcAngleS2__FPssss
lbl_80D09AA4:
/* 80D09AA4  7F A3 EB 78 */	mr r3, r29
/* 80D09AA8  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 80D09AAC  4B 63 D8 F1 */	bl PSVECSquareDistance
...
/* 80D09B1C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D09B20  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80D09B8C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D09B90  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80D09B94:
...
/* 80D09BD8  4B 56 70 2D */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80D09BF0  4B 56 71 D1 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 80D09C50  3C 60 80 D1 */	lis r3, d_a_obj_ten__stringBase0@ha /* 0x80D0B9E4@ha */
/* 80D09C54  38 63 B9 E4 */	addi r3, r3, d_a_obj_ten__stringBase0@l /* 0x80D0B9E4@l */
/* 80D09C58  38 80 00 07 */	li r4, 7
/* 80D09C5C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D09C60  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D09C64  3C A5 00 02 */	addis r5, r5, 2
/* 80D09C68  38 C0 00 80 */	li r6, 0x80
/* 80D09C6C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80D09C70  4B 33 26 7D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D09C90  4B 30 71 E1 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80D09CD4  3C 60 80 D1 */	lis r3, d_a_obj_ten__stringBase0@ha /* 0x80D0B9E4@ha */
/* 80D09CD8  38 63 B9 E4 */	addi r3, r3, d_a_obj_ten__stringBase0@l /* 0x80D0B9E4@l */
/* 80D09CDC  38 80 00 06 */	li r4, 6
/* 80D09CE0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D09CE4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D09CE8  3C A5 00 02 */	addis r5, r5, 2
/* 80D09CEC  38 C0 00 80 */	li r6, 0x80
/* 80D09CF0  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80D09CF4  4B 33 25 F9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D09D14  4B 30 71 5D */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
lbl_80D09D18:
...
/* 80D09D44  4B 55 CD F1 */	bl __mi__4cXyzCFRC3Vec
...
/* 80D09D64  4B 55 DC 29 */	bl cM_rndFX__Ff
...
/* 80D09D78  4B 55 DC 15 */	bl cM_rndFX__Ff
...
/* 80D09DB4  4B 55 DB A1 */	bl cM_rndF__Ff
...
/* 80D09DD4  4B 55 DB 81 */	bl cM_rndF__Ff
...
/* 80D09E44  4B 56 67 C5 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80D09E58  4B 56 67 B1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80D09E70  4B 56 67 99 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80D09E84  4B 56 67 85 */	bl cLib_addCalcAngleS2__FPssss
lbl_80D09E88:
...
/* 80D09ED4  4B 56 67 35 */	bl cLib_addCalcAngleS2__FPssss
lbl_80D09ED8:
...
/* 80D09EF0  4B 56 6C A1 */	bl cLib_chaseAngleS__FPsss
lbl_80D09EF4:
...
/* 80D09F3C  4B 36 DD A1 */	bl __dt__11dBgS_LinChkFv
/* 80D09F40  39 61 00 D0 */	addi r11, r1, 0xd0
/* 80D09F44  4B 65 82 E1 */	bl _restgpr_28
