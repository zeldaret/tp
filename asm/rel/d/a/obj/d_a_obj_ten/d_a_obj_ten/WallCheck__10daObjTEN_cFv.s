...
/* 80D08DA4  4B 65 94 39 */	bl _savegpr_29
/* 80D08DA8  7C 7F 1B 78 */	mr r31, r3
/* 80D08DAC  3C 60 80 D1 */	lis r3, lit_3775@ha /* 0x80D0B8F0@ha */
/* 80D08DB0  3B C3 B8 F0 */	addi r30, r3, lit_3775@l /* 0x80D0B8F0@l */
/* 80D08DB4  38 61 00 38 */	addi r3, r1, 0x38
/* 80D08DB8  4B 36 EE B1 */	bl __ct__11dBgS_LinChkFv
/* 80D08DBC  38 61 00 90 */	addi r3, r1, 0x90
/* 80D08DC0  4B 37 00 A9 */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80D08DD4  4B 36 EF 91 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80D08DD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D08DDC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D08DE0  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80D08DE4  7F A3 EB 78 */	mr r3, r29
/* 80D08DE8  38 81 00 38 */	addi r4, r1, 0x38
/* 80D08DEC  4B 36 B5 C9 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80D08DF0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80D08DF4  41 82 01 A4 */	beq lbl_80D08F98
/* 80D08DF8  3C 60 80 D1 */	lis r3, __vt__8cM3dGPla@ha /* 0x80D0BA8C@ha */
/* 80D08DFC  38 03 BA 8C */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80D0BA8C@l */
...
/* 80D08E10  4B 36 B9 35 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80D08E58  4B 63 E5 45 */	bl PSVECSquareDistance
...
/* 80D08EC8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D08ECC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80D08F38  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D08F3C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80D08F40  48 00 00 08 */	b lbl_80D08F48
lbl_80D08F44:
/* 80D08F44  FC 40 08 90 */	fmr f2, f1
lbl_80D08F48:
/* 80D08F48  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80D08F4C  4B 55 E7 29 */	bl cM_atan2s__Fff
...
/* 80D08F60  4B 55 E7 15 */	bl cM_atan2s__Fff
/* 80D08F64  B0 7F 06 02 */	sth r3, 0x602(r31)
/* 80D08F68  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80D08F6C  C0 41 00 2C */	lfs f2, 0x2c(r1)
/* 80D08F70  4B 55 E7 05 */	bl cM_atan2s__Fff
/* 80D08F74  B0 7F 06 0A */	sth r3, 0x60a(r31)
/* 80D08F78  3C 60 80 D1 */	lis r3, __vt__8cM3dGPla@ha /* 0x80D0BA8C@ha */
/* 80D08F7C  38 03 BA 8C */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80D0BA8C@l */
/* 80D08F80  90 01 00 34 */	stw r0, 0x34(r1)
/* 80D08F84  38 61 00 38 */	addi r3, r1, 0x38
/* 80D08F88  38 80 FF FF */	li r4, -1
/* 80D08F8C  4B 36 ED 51 */	bl __dt__11dBgS_LinChkFv
...
/* 80D08FA0  4B 36 ED 3D */	bl __dt__11dBgS_LinChkFv
/* 80D08FA4  38 60 00 00 */	li r3, 0
lbl_80D08FA8:
/* 80D08FA8  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80D08FAC  4B 65 92 7D */	bl _restgpr_29
