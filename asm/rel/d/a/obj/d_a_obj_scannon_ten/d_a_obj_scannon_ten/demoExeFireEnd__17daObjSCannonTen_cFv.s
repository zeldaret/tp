...
/* 80CCC398  3C 80 80 CD */	lis r4, lit_4228@ha /* 0x80CCCC74@ha */
/* 80CCC39C  C0 24 CC 74 */	lfs f1, lit_4228@l(r4)  /* 0x80CCCC74@l */
/* 80CCC3A0  4B 65 C0 8D */	bl checkPass__12J3DFrameCtrlFf
/* 80CCC3A4  2C 03 00 00 */	cmpwi r3, 0
/* 80CCC3A8  41 82 00 18 */	beq lbl_80CCC3C0
/* 80CCC3AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCC3B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CCC3B4  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80CCC3B8  80 9F 05 E4 */	lwz r4, 0x5e4(r31)
/* 80CCC3BC  4B 37 BD C1 */	bl cutEnd__16dEvent_manager_cFi
lbl_80CCC3C0:
