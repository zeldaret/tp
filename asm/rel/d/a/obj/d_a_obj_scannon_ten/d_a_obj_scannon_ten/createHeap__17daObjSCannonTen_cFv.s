...
/* 80CCB504  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCCCF0@ha */
/* 80CCB508  38 63 CC F0 */	addi r3, r3, l_arcName@l /* 0x80CCCCF0@l */
/* 80CCB50C  80 63 00 00 */	lwz r3, 0(r3)
/* 80CCB510  38 80 00 09 */	li r4, 9
/* 80CCB514  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCB518  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CCB52C  4B 37 0D C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCB53C  4B 34 97 19 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80CCB558:
/* 80CCB558  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCCCF0@ha */
/* 80CCB55C  38 63 CC F0 */	addi r3, r3, l_arcName@l /* 0x80CCCCF0@l */
...
/* 80CCB570  4B 37 0D 7D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCB584  3C E0 80 CD */	lis r7, lit_3832@ha /* 0x80CCCC38@ha */
/* 80CCB588  C0 27 CC 38 */	lfs f1, lit_3832@l(r7)  /* 0x80CCCC38@l */
/* 80CCB58C  38 E0 00 00 */	li r7, 0
/* 80CCB590  39 00 FF FF */	li r8, -1
/* 80CCB594  39 20 00 00 */	li r9, 0
/* 80CCB598  4B 34 22 45 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80CCB5B0  4B 60 36 9D */	bl __nw__FUl
/* 80CCB5B4  7C 60 1B 79 */	or. r0, r3, r3
/* 80CCB5B8  41 82 00 0C */	beq lbl_80CCB5C4
/* 80CCB5BC  4B 3B 03 B5 */	bl __ct__4dBgWFv
...
lbl_80CCB5DC:
/* 80CCB5DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CCB5E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CCB5E4  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80CCB5E8  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80CCB5EC  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80CCB5F0  4B 67 B2 F9 */	bl PSMTXTrans
/* 80CCB5F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CCB5F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CCB5FC  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CCB600  4B 34 0E 35 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CCB604  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CCB608  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CCB60C  38 9E 05 A8 */	addi r4, r30, 0x5a8
/* 80CCB610  4B 67 AE A1 */	bl PSMTXCopy
/* 80CCB614  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCCCF0@ha */
/* 80CCB618  38 63 CC F0 */	addi r3, r3, l_arcName@l /* 0x80CCCCF0@l */
...
/* 80CCB62C  4B 37 0C C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCB640  4B 3A E8 F9 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
