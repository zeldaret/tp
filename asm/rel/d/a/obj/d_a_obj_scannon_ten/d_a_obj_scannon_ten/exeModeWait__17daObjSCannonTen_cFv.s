...
/* 80CCBC28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCBC2C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CCBC30  80 04 5F 1C */	lwz r0, 0x5f1c(r4)
/* 80CCBC34  54 00 06 F7 */	rlwinm. r0, r0, 0, 0x1b, 0x1b
/* 80CCBC38  41 82 00 64 */	beq lbl_80CCBC9C
/* 80CCBC3C  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCCCF0@ha */
/* 80CCBC40  80 03 CC F0 */	lwz r0, l_arcName@l(r3)  /* 0x80CCCCF0@l */
/* 80CCBC44  90 1F 01 00 */	stw r0, 0x100(r31)
/* 80CCBC48  38 64 4F F8 */	addi r3, r4, 0x4ff8
/* 80CCBC4C  7F E4 FB 78 */	mr r4, r31
/* 80CCBC50  3C A0 80 CD */	lis r5, l_eventName@ha /* 0x80CCCCF8@ha */
/* 80CCBC54  38 A5 CC F8 */	addi r5, r5, l_eventName@l /* 0x80CCCCF8@l */
/* 80CCBC58  80 A5 00 00 */	lwz r5, 0(r5)
/* 80CCBC5C  38 C0 00 FF */	li r6, 0xff
/* 80CCBC60  4B 37 BA F9 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 80CCBC84  4B 34 F9 F9 */	bl fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs
