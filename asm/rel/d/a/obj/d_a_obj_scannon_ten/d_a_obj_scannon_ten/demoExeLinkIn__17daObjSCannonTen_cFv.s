...
/* 80CCBF18  3C 60 80 CD */	lis r3, lit_3832@ha /* 0x80CCCC38@ha */
/* 80CCBF1C  38 83 CC 38 */	addi r4, r3, lit_3832@l /* 0x80CCCC38@l */
/* 80CCBF20  80 1F 04 9C */	lwz r0, 0x49c(r31)
/* 80CCBF24  54 00 02 D7 */	rlwinm. r0, r0, 0, 0xb, 0xb
/* 80CCBF28  40 82 00 88 */	bne lbl_80CCBFB0
/* 80CCBF2C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCBF30  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80CCBF9C:
/* 80CCBF9C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCBFA0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CCBFA4  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80CCBFA8  80 9F 05 E4 */	lwz r4, 0x5e4(r31)
/* 80CCBFAC  4B 37 C1 D1 */	bl cutEnd__16dEvent_manager_cFi
lbl_80CCBFB0:
