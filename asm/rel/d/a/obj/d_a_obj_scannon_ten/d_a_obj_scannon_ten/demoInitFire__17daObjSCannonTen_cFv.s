...
/* 80CCC218  3C 60 80 CD */	lis r3, lit_3832@ha /* 0x80CCCC38@ha */
/* 80CCC21C  C0 23 CC 38 */	lfs f1, lit_3832@l(r3)  /* 0x80CCCC38@l */
/* 80CCC220  D0 21 00 08 */	stfs f1, 8(r1)
/* 80CCC224  3C 60 80 CD */	lis r3, lit_3987@ha /* 0x80CCCC4C@ha */
/* 80CCC228  C0 03 CC 4C */	lfs f0, lit_3987@l(r3)  /* 0x80CCCC4C@l */
/* 80CCC22C  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80CCC230  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80CCC234  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCC238  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CCC24C  4B 3A 38 C5 */	bl StartQuake__12dVibration_cFii4cXyz
