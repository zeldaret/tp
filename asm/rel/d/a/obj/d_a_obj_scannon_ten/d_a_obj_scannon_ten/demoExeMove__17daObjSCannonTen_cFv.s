...
/* 80CCC130  3C 80 80 CD */	lis r4, lit_3832@ha /* 0x80CCCC38@ha */
/* 80CCC134  3B E4 CC 38 */	addi r31, r4, lit_3832@l /* 0x80CCCC38@l */
...
/* 80CCC144  4B 65 C2 E9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80CCC164  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCC168  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CCC17C  4B 3A 38 A9 */	bl StartShock__12dVibration_cFii4cXyz
/* 80CCC180  48 00 00 74 */	b lbl_80CCC1F4
lbl_80CCC184:
/* 80CCC184  38 7E 05 78 */	addi r3, r30, 0x578
/* 80CCC188  C0 3F 00 30 */	lfs f1, 0x30(r31)
/* 80CCC18C  4B 65 C2 A1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80CCC1AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCC1B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CCC1C4  4B 3A 38 61 */	bl StartShock__12dVibration_cFii4cXyz
/* 80CCC1C8  48 00 00 2C */	b lbl_80CCC1F4
lbl_80CCC1CC:
/* 80CCC1CC  38 7E 05 78 */	addi r3, r30, 0x578
/* 80CCC1D0  C0 3F 00 34 */	lfs f1, 0x34(r31)
/* 80CCC1D4  4B 65 C2 59 */	bl checkPass__12J3DFrameCtrlFf
/* 80CCC1D8  2C 03 00 00 */	cmpwi r3, 0
/* 80CCC1DC  41 82 00 18 */	beq lbl_80CCC1F4
/* 80CCC1E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCC1E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CCC1E8  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80CCC1EC  80 9E 05 E4 */	lwz r4, 0x5e4(r30)
/* 80CCC1F0  4B 37 BF 8D */	bl cutEnd__16dEvent_manager_cFi
lbl_80CCC1F4:
