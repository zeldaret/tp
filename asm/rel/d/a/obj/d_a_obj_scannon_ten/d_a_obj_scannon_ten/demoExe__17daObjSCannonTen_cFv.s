...
/* 80CCBDE0  4B 69 63 FD */	bl _savegpr_29
/* 80CCBDE4  7C 7D 1B 78 */	mr r29, r3
/* 80CCBDE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCBDEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CCBDF0  3B C3 4F F8 */	addi r30, r3, 0x4ff8
/* 80CCBDF4  7F C3 F3 78 */	mr r3, r30
/* 80CCBDF8  80 9D 05 E4 */	lwz r4, 0x5e4(r29)
/* 80CCBDFC  3C A0 80 CD */	lis r5, CUT_TYPE_TABLE_FIRE_SECOND@ha /* 0x80CCCE7C@ha */
/* 80CCBE00  38 A5 CE 7C */	addi r5, r5, CUT_TYPE_TABLE_FIRE_SECOND@l /* 0x80CCCE7C@l */
/* 80CCBE04  38 C0 00 06 */	li r6, 6
/* 80CCBE08  38 E0 00 00 */	li r7, 0
/* 80CCBE0C  39 00 00 00 */	li r8, 0
/* 80CCBE10  4B 37 C0 01 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 80CCBE28  4B 37 BF 25 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80CCBE44  3C 60 80 CD */	lis r3, s_demoExeProc__17daObjSCannonTen_c@ha /* 0x80CCCDEC@ha */
/* 80CCBE48  38 03 CD EC */	addi r0, r3, s_demoExeProc__17daObjSCannonTen_c@l /* 0x80CCCDEC@l */
/* 80CCBE4C  7C 60 22 14 */	add r3, r0, r4
/* 80CCBE50  3B C3 00 0C */	addi r30, r3, 0xc
/* 80CCBE54  7F C3 F3 78 */	mr r3, r30
/* 80CCBE58  4B 69 61 C1 */	bl __ptmf_test
...
/* 80CCBE6C  4B 69 62 19 */	bl __ptmf_scall
/* 80CCBE70  60 00 00 00 */	nop 
lbl_80CCBE74:
/* 80CCBE74  39 61 00 20 */	addi r11, r1, 0x20
/* 80CCBE78  4B 69 63 B1 */	bl _restgpr_29
