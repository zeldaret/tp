...
/* 80CCBA68  4B 69 67 75 */	bl _savegpr_29
/* 80CCBA6C  7C 7E 1B 78 */	mr r30, r3
/* 80CCBA70  3C 60 80 CD */	lis r3, lit_3832@ha /* 0x80CCCC38@ha */
/* 80CCBA74  3B E3 CC 38 */	addi r31, r3, lit_3832@l /* 0x80CCCC38@l */
/* 80CCBA78  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CCBA7C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CCBA80  38 80 00 08 */	li r4, 8
/* 80CCBA84  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CCBA88  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CCBA8C  4B 4D 7D 39 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CCBA90  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CCBA94  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CCBA98  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80CCBA9C  80 84 00 04 */	lwz r4, 4(r4)
/* 80CCBAA0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CCBAA4  4B 4D 92 FD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80CCBAB8  4B 34 1F 15 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80CCBABC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCBAC0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CCBAC4  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CCBAC8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CCBACC  3B A3 4A C8 */	addi r29, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CCBAE0  4B 34 21 E5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CCBAE4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCBAE8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CCBB40  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80CCBB44  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80CCBB48  4B 36 2D C9 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 80CCBB4C  90 7E 05 DC */	stw r3, 0x5dc(r30)
/* 80CCBB50  38 60 00 01 */	li r3, 1
/* 80CCBB54  39 61 00 30 */	addi r11, r1, 0x30
/* 80CCBB58  4B 69 66 D1 */	bl _restgpr_29
