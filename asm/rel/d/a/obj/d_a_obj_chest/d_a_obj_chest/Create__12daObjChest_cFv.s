...
/* 80BC9098  4B 79 91 39 */	bl _savegpr_26
/* 80BC909C  7C 7E 1B 78 */	mr r30, r3
/* 80BC90A0  3C 60 80 BD */	lis r3, l_cyl_src@ha /* 0x80BC9FFC@ha */
/* 80BC90A4  3B E3 9F FC */	addi r31, r3, l_cyl_src@l /* 0x80BC9FFC@l */
/* 80BC90A8  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 80BC90AC  54 04 06 3E */	clrlwi r4, r0, 0x18
/* 80BC90B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC90B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BC90B8  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80BC90BC  7C 05 07 74 */	extsb r5, r0
/* 80BC90C0  4B 46 C2 A1 */	bl isSwitch__10dSv_info_cCFii
...
/* 80BC9110  4B 44 3C 55 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80BC9114  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC9118  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC911C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80BC9120  4B 44 33 15 */	bl mDoMtx_YrotM__FPA4_fs
/* 80BC9124  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC9128  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC912C  A8 9E 0A 84 */	lha r4, 0xa84(r30)
/* 80BC9130  4B 44 32 6D */	bl mDoMtx_XrotM__FPA4_fs
/* 80BC9134  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC9138  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC913C  38 9E 0A 78 */	addi r4, r30, 0xa78
/* 80BC9140  7C 85 23 78 */	mr r5, r4
/* 80BC9144  4B 77 DC 29 */	bl PSMTXMultVec
/* 80BC9148  38 7E 0A 78 */	addi r3, r30, 0xa78
/* 80BC914C  4B 45 4B 71 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80BC9150  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BC9154  41 82 00 10 */	beq lbl_80BC9164
/* 80BC9158  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80BC915C  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 80BC91A0  4B 4A CD B9 */	bl SetWall__12dBgS_AcchCirFff
...
/* 80BC91CC  4B 4A D0 7D */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80BC91E0  4B 4B A6 81 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 80BC91FC  4B 4B B6 B9 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80BC9220  4B 45 13 59 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80BC9224  38 60 00 01 */	li r3, 1
/* 80BC9228  39 61 00 40 */	addi r11, r1, 0x40
/* 80BC922C  4B 79 8F F1 */	bl _restgpr_26
