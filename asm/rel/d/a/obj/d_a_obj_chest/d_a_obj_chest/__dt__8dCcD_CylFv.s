...
/* 80BC9410  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BC9414  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80BC9434  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BC9438  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80BC9450  3C 60 80 BD */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BCA1A4@ha */
/* 80BC9454  38 03 A1 A4 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BCA1A4@l */
/* 80BC9458  90 1E 01 38 */	stw r0, 0x138(r30)
lbl_80BC945C:
/* 80BC945C  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80BC9460  41 82 00 24 */	beq lbl_80BC9484
/* 80BC9464  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BC9468  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BC946C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80BC9470  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80BC9474  41 82 00 10 */	beq lbl_80BC9484
/* 80BC9478  3C 60 80 BD */	lis r3, __vt__8cM3dGAab@ha /* 0x80BCA198@ha */
/* 80BC947C  38 03 A1 98 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BCA198@l */
/* 80BC9480  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_80BC9484:
/* 80BC9484  7F C3 F3 78 */	mr r3, r30
/* 80BC9488  38 80 00 00 */	li r4, 0
/* 80BC948C  4B 4B AC 59 */	bl __dt__12dCcD_GObjInfFv
/* 80BC9490  7F E0 07 35 */	extsh. r0, r31
/* 80BC9494  40 81 00 0C */	ble lbl_80BC94A0
/* 80BC9498  7F C3 F3 78 */	mr r3, r30
/* 80BC949C  4B 70 58 A1 */	bl __dl__FPv
lbl_80BC94A0:
