...
/* 80BC9840  4B 79 89 85 */	bl _savegpr_23
/* 80BC9844  7C 7F 1B 78 */	mr r31, r3
/* 80BC9848  3C 60 80 BD */	lis r3, l_cyl_src@ha /* 0x80BC9FFC@ha */
/* 80BC984C  3B 63 9F FC */	addi r27, r3, l_cyl_src@l /* 0x80BC9FFC@l */
/* 80BC9850  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC9854  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BC987C  4B 69 E0 D9 */	bl cM_rndF__Ff
...
/* 80BC989C  4B 69 E0 F1 */	bl cM_rndFX__Ff
...
/* 80BC98BC  4B 69 E0 99 */	bl cM_rndF__Ff
...
/* 80BC98E8  4B 46 37 85 */	bl dComIfGp_getReverb__Fi
...
/* 80BC98FC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BC9900  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BC9928  4B 6E 20 5D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80BC992C:
/* 80BC992C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC9930  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BC9944  4B 46 BA 1D */	bl isSwitch__10dSv_info_cCFii
/* 80BC9948  2C 03 00 00 */	cmpwi r3, 0
/* 80BC994C  40 82 02 64 */	bne lbl_80BC9BB0
/* 80BC9950  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC9954  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BC9994  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC9998  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80BC99E0  4B 44 33 85 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80BC99E4  7F 83 E3 78 */	mr r3, r28
/* 80BC99E8  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80BC99EC  4B 44 2A 49 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80BC9A04  4B 77 D3 69 */	bl PSMTXMultVec
...
/* 80BC9A68  4B 77 D9 35 */	bl PSVECSquareDistance
...
/* 80BC9AD4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BC9AD8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BC9B44  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BC9B48  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80BC9B4C:
...
/* 80BC9B84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC9B88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BC9B9C  4B 46 B6 65 */	bl onSwitch__10dSv_info_cFii
lbl_80BC9BA0:
...
/* 80BC9BDC  4B 79 86 35 */	bl _restgpr_23
