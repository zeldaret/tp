...
/* 80C47568  4B 71 AC 75 */	bl _savegpr_29
/* 80C4756C  7C 7E 1B 78 */	mr r30, r3
/* 80C47570  3C 60 80 C4 */	lis r3, l_DATA@ha /* 0x80C47950@ha */
/* 80C47574  3B E3 79 50 */	addi r31, r3, l_DATA@l /* 0x80C47950@l */
...
/* 80C475AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C475B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C475B4  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80C475B8  4B 3C 4E 25 */	bl mDoMtx_YrotS__FPA4_fs
/* 80C475BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C475C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C475C4  38 81 00 2C */	addi r4, r1, 0x2c
/* 80C475C8  38 BE 04 F8 */	addi r5, r30, 0x4f8
/* 80C475CC  4B 6F F7 A1 */	bl PSMTXMultVec
...
lbl_80C475E8:
/* 80C475E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C475EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C47604  4B 3D 9D 55 */	bl fpcEx_SearchByID__FUi
...
/* 80C47640  4B 61 F4 F5 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C476A4  4B 3D 25 D9 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80C476C0  4B 3D 9C 99 */	bl fpcEx_SearchByID__FUi
...
/* 80C47720  4B 3D 25 5D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80C47738  4B 43 CB 89 */	bl ChkAtHit__12dCcD_GObjInfFv
...
/* 80C47750  4B 3D 25 2D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80C47774  4B 62 7E D5 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80C47778  38 7E 06 F8 */	addi r3, r30, 0x6f8
/* 80C4777C  C0 3F 00 00 */	lfs f1, 0(r31)
/* 80C47780  4B 62 7F 89 */	bl SetR__8cM3dGSphFf
/* 80C47784  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C47788  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4778C  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C47790  38 9E 05 D4 */	addi r4, r30, 0x5d4
/* 80C47794  4B 61 D4 15 */	bl Set__4cCcSFP8cCcD_Obj
/* 80C47798  38 60 00 01 */	li r3, 1
lbl_80C4779C:
/* 80C4779C  39 61 00 50 */	addi r11, r1, 0x50
/* 80C477A0  4B 71 AA 89 */	bl _restgpr_29
