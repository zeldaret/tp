...
/* 80CC5464  3C 60 80 CC */	lis r3, M_attr__14daObjItaRope_c@ha /* 0x80CC68F0@ha */
/* 80CC5468  3B E3 68 F0 */	addi r31, r3, M_attr__14daObjItaRope_c@l /* 0x80CC68F0@l */
...
/* 80CC5488  4B 68 1C B1 */	bl PSVECSquareMag
...
/* 80CC54F8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CC54FC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CC5568  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CC556C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80CC5570  48 00 00 08 */	b lbl_80CC5578
lbl_80CC5574:
/* 80CC5574  FF E0 08 90 */	fmr f31, f1
lbl_80CC5578:
/* 80CC5578  4B 5A 22 F5 */	bl cM_rnd__Fv
...
/* 80CC5594  4B 68 1B 45 */	bl PSVECScale
...
/* 80CC55B8  4B 5A 15 7D */	bl __mi__4cXyzCFRC3Vec
...
/* 80CC55F8  4B 5A B1 49 */	bl cLib_chaseF__FPfff
...
/* 80CC5618  4B 68 1A 79 */	bl PSVECAdd
/* 80CC561C  4B 5A 22 51 */	bl cM_rnd__Fv
...
/* 80CC5638  4B 68 1A 59 */	bl PSVECAdd
