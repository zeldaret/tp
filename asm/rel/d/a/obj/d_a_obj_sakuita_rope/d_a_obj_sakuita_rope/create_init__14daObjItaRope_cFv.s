...
/* 80CC57FC  4B 69 C9 D9 */	bl _savegpr_27
/* 80CC5800  7C 7E 1B 78 */	mr r30, r3
/* 80CC5804  3C 60 80 CC */	lis r3, M_attr__14daObjItaRope_c@ha /* 0x80CC68F0@ha */
/* 80CC5808  3B E3 68 F0 */	addi r31, r3, M_attr__14daObjItaRope_c@l /* 0x80CC68F0@l */
...
/* 80CC5824  4B 38 BF C9 */	bl dPath_GetRoomPath__Fii
...
/* 80CC58A0  4B 5A 12 95 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CC5910  4B 5A 1D 65 */	bl cM_atan2s__Fff
...
/* 80CC5934  4B 68 18 05 */	bl PSVECSquareMag
...
/* 80CC59A4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CC59A8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CC5A14  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CC5A18  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CC5A2C  4B 5A 1C 49 */	bl cM_atan2s__Fff
...
/* 80CC5A50  4B 68 16 E9 */	bl PSVECSquareMag
...
/* 80CC5AC0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CC5AC4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CC5B30  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CC5B34  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80CC5B38:
...
/* 80CC5B60  4B 35 49 E9 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80CC5B64  38 7E 06 20 */	addi r3, r30, 0x620
/* 80CC5B68  4B 68 15 D1 */	bl PSVECSquareMag
...
/* 80CC5BD8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CC5BDC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CC5C48  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CC5C4C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80CC5C50:
...
/* 80CC5C94  4B 5A 0E F1 */	bl __ml__4cXyzCFf
...
/* 80CC5CF0  4B 5A 0D F5 */	bl __pl__4cXyzCFRC3Vec
...
/* 80CC5D74  3C 60 80 CC */	lis r3, l_arcName@ha /* 0x80CC6998@ha */
/* 80CC5D78  38 63 69 98 */	addi r3, r3, l_arcName@l /* 0x80CC6998@l */
/* 80CC5D7C  80 63 00 00 */	lwz r3, 0(r3)
/* 80CC5D80  3C 80 80 CC */	lis r4, d_a_obj_sakuita_rope__stringBase0@ha /* 0x80CC6970@ha */
/* 80CC5D84  38 84 69 70 */	addi r4, r4, d_a_obj_sakuita_rope__stringBase0@l /* 0x80CC6970@l */
/* 80CC5D88  38 84 00 0A */	addi r4, r4, 0xa
/* 80CC5D8C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC5D90  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC5D94  3C A5 00 02 */	addis r5, r5, 2
/* 80CC5D98  38 C0 00 80 */	li r6, 0x80
/* 80CC5D9C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80CC5DA0  4B 37 65 DD */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CC5DA4  7C 64 1B 78 */	mr r4, r3
/* 80CC5DA8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC5DAC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CC5DC0  4B 36 6D 31 */	bl addSimpleModel__14dComIfG_play_cFP12J3DModelDataiUc
...
/* 80CC5DEC  4B 5A AE 19 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80CC5E34  4B 69 C3 ED */	bl _restgpr_27
