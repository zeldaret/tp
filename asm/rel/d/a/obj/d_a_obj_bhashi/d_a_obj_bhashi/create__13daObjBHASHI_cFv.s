...
/* 8057843C  4B DE 9D 9D */	bl _savegpr_28
/* 80578440  7C 7C 1B 78 */	mr r28, r3
/* 80578444  3C 80 80 58 */	lis r4, ccCylSrc@ha /* 0x80578A88@ha */
/* 80578448  3B E4 8A 88 */	addi r31, r4, ccCylSrc@l /* 0x80578A88@l */
...
/* 80578464  4B B0 01 C1 */	bl __ct__16dBgS_MoveBgActorFv
/* 80578468  3C 60 80 58 */	lis r3, __vt__13daObjBHASHI_c@ha /* 0x80578C5C@ha */
/* 8057846C  38 03 8C 5C */	addi r0, r3, __vt__13daObjBHASHI_c@l /* 0x80578C5C@l */
/* 80578470  90 1D 05 9C */	stw r0, 0x59c(r29)
/* 80578474  38 7D 05 AC */	addi r3, r29, 0x5ac
/* 80578478  3C 80 80 57 */	lis r4, __ct__7Hahen_cFv@ha /* 0x80577794@ha */
/* 8057847C  38 84 77 94 */	addi r4, r4, __ct__7Hahen_cFv@l /* 0x80577794@l */
/* 80578480  3C A0 80 58 */	lis r5, __dt__7Hahen_cFv@ha /* 0x80578744@ha */
/* 80578484  38 A5 87 44 */	addi r5, r5, __dt__7Hahen_cFv@l /* 0x80578744@l */
/* 80578488  38 C0 00 34 */	li r6, 0x34
/* 8057848C  38 E0 00 3C */	li r7, 0x3c
/* 80578490  4B DE 98 D1 */	bl __construct_array
/* 80578494  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80578498  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 8057849C  90 1D 13 00 */	stw r0, 0x1300(r29)
/* 805784A0  38 7D 13 04 */	addi r3, r29, 0x1304
/* 805784A4  4B B0 B2 BD */	bl __ct__10dCcD_GSttsFv
/* 805784A8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 805784AC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 805784C4  4B B0 B5 65 */	bl __ct__12dCcD_GObjInfFv
/* 805784C8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805784CC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805784D0  90 1D 01 20 */	stw r0, 0x120(r29)
/* 805784D4  3C 60 80 58 */	lis r3, __vt__8cM3dGAab@ha /* 0x80578C50@ha */
/* 805784D8  38 03 8C 50 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80578C50@l */
/* 805784DC  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 805784E0  3C 60 80 58 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80578C44@ha */
/* 805784E4  38 03 8C 44 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80578C44@l */
/* 805784E8  90 1D 01 38 */	stw r0, 0x138(r29)
/* 805784EC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 805784F0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 805784F4  90 7D 01 20 */	stw r3, 0x120(r29)
/* 805784F8  38 03 00 58 */	addi r0, r3, 0x58
/* 805784FC  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80578500  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80578504  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 8057852C  3C 80 80 58 */	lis r4, l_arcName@ha /* 0x80578BF0@ha */
/* 80578530  38 84 8B F0 */	addi r4, r4, l_arcName@l /* 0x80578BF0@l */
/* 80578534  80 84 00 00 */	lwz r4, 0(r4)
/* 80578538  4B AB 49 85 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80578550  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80578554  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80578558  3F C3 00 02 */	addis r30, r3, 2
/* 8057855C  3B DE C2 F8 */	addi r30, r30, -15624
/* 80578560  7F C3 F3 78 */	mr r3, r30
/* 80578564  3C 80 80 58 */	lis r4, l_arcName@ha /* 0x80578BF0@ha */
/* 80578568  38 84 8B F0 */	addi r4, r4, l_arcName@l /* 0x80578BF0@l */
/* 8057856C  80 84 00 00 */	lwz r4, 0(r4)
/* 80578570  3C A0 80 58 */	lis r5, d_a_obj_bhashi__stringBase0@ha /* 0x80578BA8@ha */
/* 80578574  38 A5 8B A8 */	addi r5, r5, d_a_obj_bhashi__stringBase0@l /* 0x80578BA8@l */
/* 80578578  38 A5 00 34 */	addi r5, r5, 0x34
/* 8057857C  4B AC 41 3D */	bl getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80578580  7C 65 1B 78 */	mr r5, r3
/* 80578584  7F 83 E3 78 */	mr r3, r28
/* 80578588  3C 80 80 58 */	lis r4, l_arcName@ha /* 0x80578BF0@ha */
/* 8057858C  38 84 8B F0 */	addi r4, r4, l_arcName@l /* 0x80578BF0@l */
/* 80578590  80 84 00 00 */	lwz r4, 0(r4)
/* 80578594  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80578598  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
...
/* 805785A8  4B B0 02 15 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 805785FC  4B AA 56 C1 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80578600  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80578604  41 82 00 20 */	beq lbl_80578624
/* 80578608  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 8057860C  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 80578640  4B AA 1F 09 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80578644  3C 60 80 58 */	lis r3, l_arcName@ha /* 0x80578BF0@ha */
/* 80578648  38 63 8B F0 */	addi r3, r3, l_arcName@l /* 0x80578BF0@l */
/* 8057864C  80 63 00 00 */	lwz r3, 0(r3)
/* 80578650  3C 80 80 58 */	lis r4, d_a_obj_bhashi__stringBase0@ha /* 0x80578BA8@ha */
/* 80578654  38 84 8B A8 */	addi r4, r4, d_a_obj_bhashi__stringBase0@l /* 0x80578BA8@l */
/* 80578658  38 84 00 1B */	addi r4, r4, 0x1b
/* 8057865C  7F C5 F3 78 */	mr r5, r30
/* 80578660  38 C0 00 80 */	li r6, 0x80
/* 80578664  4B AC 3D 19 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80578668  7C 64 1B 78 */	mr r4, r3
/* 8057866C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80578670  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80578684  4B AB 44 6D */	bl addSimpleModel__14dComIfG_play_cFP12J3DModelDataiUc
...
/* 805786A0  4B DE 9B 85 */	bl _restgpr_28
