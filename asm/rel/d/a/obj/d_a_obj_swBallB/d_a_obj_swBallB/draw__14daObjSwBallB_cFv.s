...
/* 80CF56B4  4B 66 CB 25 */	bl _savegpr_28
/* 80CF56B8  7C 7E 1B 78 */	mr r30, r3
/* 80CF56BC  3C 60 80 CF */	lis r3, l_color@ha /* 0x80CF59D0@ha */
/* 80CF56C0  3B 83 59 D0 */	addi r28, r3, l_color@l /* 0x80CF59D0@l */
/* 80CF56C4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF56C8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF56CC  38 80 00 00 */	li r4, 0
/* 80CF56D0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CF56D4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CF56D8  4B 4A E0 ED */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CF56DC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF56E0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF56E4  80 9E 05 84 */	lwz r4, 0x584(r30)
/* 80CF56E8  80 84 00 04 */	lwz r4, 4(r4)
/* 80CF56EC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CF56F0  4B 4A F6 B1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CF56F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF56F8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF56FC  80 04 5F 78 */	lwz r0, 0x5f78(r4)
/* 80CF5700  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CF5704  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CF5788  4B 65 15 5D */	bl C_MTXLightOrtho
/* 80CF578C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF5790  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF5794  38 80 40 00 */	li r4, 0x4000
/* 80CF5798  4B 31 6B AD */	bl mDoMtx_XrotS__FPA4_fs
...
/* 80CF57B4  4B 31 75 E9 */	bl transM__14mDoMtx_stack_cFfff
/* 80CF57B8  38 61 00 08 */	addi r3, r1, 8
/* 80CF57BC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF57C0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF57C4  38 BD 00 24 */	addi r5, r29, 0x24
/* 80CF57C8  4B 65 0D 1D */	bl PSMTXConcat
lbl_80CF57CC:
...
/* 80CF57E0  4B 31 7E F9 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80CF57E4  80 7E 05 84 */	lwz r3, 0x584(r30)
/* 80CF57E8  4B 31 84 DD */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CF57EC  80 7E 05 84 */	lwz r3, 0x584(r30)
/* 80CF57F0  80 63 00 04 */	lwz r3, 4(r3)
/* 80CF57F4  4B 31 85 FD */	bl mDoExt_btkAnmRemove__FP12J3DModelData
/* 80CF57F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF57FC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF5818  4B 66 CA 0D */	bl _restgpr_28
