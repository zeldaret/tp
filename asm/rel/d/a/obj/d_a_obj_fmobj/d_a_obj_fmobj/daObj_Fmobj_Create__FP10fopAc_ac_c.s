...
/* 8057CDF0  4B DE 53 ED */	bl _savegpr_29
/* 8057CDF4  7C 7E 1B 78 */	mr r30, r3
/* 8057CDF8  3C 80 80 58 */	lis r4, lit_3743@ha /* 0x8057CF68@ha */
/* 8057CDFC  3B E4 CF 68 */	addi r31, r4, lit_3743@l /* 0x8057CF68@l */
...
/* 8057CE14  4B A9 BD 51 */	bl __ct__10fopAc_ac_cFv
lbl_8057CE18:
...
/* 8057CE28  3C 80 80 58 */	lis r4, d_a_obj_fmobj__stringBase0@ha /* 0x8057CF74@ha */
/* 8057CE2C  38 84 CF 74 */	addi r4, r4, d_a_obj_fmobj__stringBase0@l /* 0x8057CF74@l */
/* 8057CE30  4B AB 00 8D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8057CE48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8057CE4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8057CE50  38 63 09 58 */	addi r3, r3, 0x958
/* 8057CE54  38 80 00 03 */	li r4, 3
/* 8057CE58  4B AB 7A DD */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 8057CE70  3C 80 80 58 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x8057CCDC@ha */
/* 8057CE74  38 84 CC DC */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x8057CCDC@l */
/* 8057CE78  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 8057CE7C  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 8057CE80  4B A9 D6 31 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_8057CE94:
/* 8057CE94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8057CE98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8057CE9C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8057CEA0  80 9E 05 B8 */	lwz r4, 0x5b8(r30)
/* 8057CEA4  7F C5 F3 78 */	mr r5, r30
/* 8057CEA8  4B AF 7B 61 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 8057CECC  4B CE AA 89 */	bl cM_rndF__Ff
...
/* 8057CEE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8057CEE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8057CEE8  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 8057CEEC  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 8057CEF0  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 8057CEF4  4B DC 99 F5 */	bl PSMTXTrans
/* 8057CEF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8057CEFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8057CF00  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 8057CF04  4B A8 F5 31 */	bl mDoMtx_YrotM__FPA4_fs
/* 8057CF08  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8057CF0C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8057CF10  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 8057CF14  38 84 00 24 */	addi r4, r4, 0x24
/* 8057CF18  4B DC 95 99 */	bl PSMTXCopy
/* 8057CF1C  C0 3F 00 04 */	lfs f1, 4(r31)
/* 8057CF20  C0 5F 00 08 */	lfs f2, 8(r31)
/* 8057CF24  FC 60 08 90 */	fmr f3, f1
/* 8057CF28  4B A8 FE 75 */	bl transM__14mDoMtx_stack_cFfff
/* 8057CF2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8057CF30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8057CF34  38 9E 05 88 */	addi r4, r30, 0x588
/* 8057CF38  4B DC 95 79 */	bl PSMTXCopy
/* 8057CF3C  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 8057CF40  4B AF EA 81 */	bl Move__4dBgWFv
lbl_8057CF44:
/* 8057CF44  7F A3 EB 78 */	mr r3, r29
lbl_8057CF48:
/* 8057CF48  39 61 00 20 */	addi r11, r1, 0x20
/* 8057CF4C  4B DE 52 DD */	bl _restgpr_29
