...
/* 80C1A758  4B 74 7A 71 */	bl _savegpr_24
/* 80C1A75C  7C 7E 1B 78 */	mr r30, r3
/* 80C1A760  3C 60 80 C2 */	lis r3, lit_3665@ha /* 0x80C1B600@ha */
/* 80C1A764  3B E3 B6 00 */	addi r31, r3, lit_3665@l /* 0x80C1B600@l */
...
/* 80C1A77C  4B 65 4F 8D */	bl SetR__8cM3dGSphFf
...
/* 80C1A7E0  4B 46 9E 79 */	bl ChkCoHit__12dCcD_GObjInfFv
...
/* 80C1A864  4B 65 51 D9 */	bl cLib_addCalc2__FPffff
/* 80C1A868  7F C3 F3 78 */	mr r3, r30
/* 80C1A86C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1A870  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1A874  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80C1A878  4B 3F FE 99 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C1A8AC  4B 65 5D 5D */	bl cLib_addCalcAngleS2__FPssss
lbl_80C1A8B0:
/* 80C1A8B0  38 7E 06 F8 */	addi r3, r30, 0x6f8
/* 80C1A8B4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1A8B8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1A8BC  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80C1A8C0  4B 45 C1 ED */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80C1A8D8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1A8DC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1A8E0  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80C1A8E4  4B 45 C1 C9 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80C1A900  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1A904  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1A908  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80C1A90C  4B 45 C1 A1 */	bl CrrPos__9dBgS_AcchFR4dBgS
lbl_80C1A910:
...
/* 80C1A920  4B 46 9B 41 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 80C1A938  4B 46 9B C1 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 80C1A950  4B 46 CB C5 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
/* 80C1A954  7F C3 F3 78 */	mr r3, r30
/* 80C1A958  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1A95C  3B 64 61 C0 */	addi r27, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1A960  80 9B 5D AC */	lwz r4, 0x5dac(r27)
/* 80C1A964  4B 3F FD AD */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C1A978  4B 46 D0 E1 */	bl at_power_check__FP11dCcU_AtInfo
...
/* 80C1A9B0  4B 64 CF A5 */	bl cM_rndF__Ff
...
/* 80C1A9C4  4B 64 CF 91 */	bl cM_rndF__Ff
...
/* 80C1A9E4  4B 64 CF 71 */	bl cM_rndF__Ff
...
/* 80C1AA30  4B 64 CF 5D */	bl cM_rndFX__Ff
...
/* 80C1AA6C  4B 40 20 6D */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
...
/* 80C1AA98  4B 64 CE F5 */	bl cM_rndFX__Ff
...
/* 80C1AAB8  4B 64 CE D5 */	bl cM_rndFX__Ff
...
/* 80C1AAF0  4B 65 5B 19 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C1AB04  4B 65 5B 05 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C1AB18  4B 65 5A F1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C1AB2C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C1AB30  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C1AB84  4B 65 4E FD */	bl cLib_addCalc0__FPfff
...
/* 80C1AB98  4B 65 5A 71 */	bl cLib_addCalcAngleS2__FPssss
lbl_80C1AB9C:
...
/* 80C1ABE0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C1ABE4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80C1ABE8  80 63 00 00 */	lwz r3, 0(r3)
/* 80C1ABEC  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C1ABF0  4B 3F 17 ED */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80C1AC14  4B 65 62 D9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80C1AC94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1AC98  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1AC9C  3C 60 80 C2 */	lis r3, w_eff_id@ha /* 0x80C1B708@ha */
/* 80C1ACA0  3B 63 B7 08 */	addi r27, r3, w_eff_id@l /* 0x80C1B708@l */
lbl_80C1ACA4:
...
/* 80C1ACF0  4B 43 27 DD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C1AD60  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C1AD64  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C1ADA4  4B 65 4C 99 */	bl cLib_addCalc2__FPffff
/* 80C1ADA8  48 00 00 0C */	b lbl_80C1ADB4
lbl_80C1ADAC:
/* 80C1ADAC  C0 1F 00 0C */	lfs f0, 0xc(r31)
/* 80C1ADB0  D0 1E 04 EC */	stfs f0, 0x4ec(r30)
lbl_80C1ADB4:
/* 80C1ADB4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C1ADB8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C1ADBC  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80C1ADC0  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80C1ADC4  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80C1ADC8  4B 72 BB 21 */	bl PSMTXTrans
/* 80C1ADCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C1ADD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C1ADD4  A8 9E 06 78 */	lha r4, 0x678(r30)
/* 80C1ADD8  4B 3F 16 5D */	bl mDoMtx_YrotM__FPA4_fs
/* 80C1ADDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C1ADE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C1ADF4  4B 3F 15 A9 */	bl mDoMtx_XrotM__FPA4_fs
/* 80C1ADF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C1ADFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C1AE10  4B 3F 16 BD */	bl mDoMtx_ZrotM__FPA4_fs
/* 80C1AE14  C0 3F 00 08 */	lfs f1, 8(r31)
/* 80C1AE18  C0 5F 00 14 */	lfs f2, 0x14(r31)
/* 80C1AE1C  FC 60 08 90 */	fmr f3, f1
/* 80C1AE20  4B 3F 1F 7D */	bl transM__14mDoMtx_stack_cFfff
/* 80C1AE24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C1AE28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C1AE2C  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C1AE30  4B 3F 15 6D */	bl mDoMtx_XrotM__FPA4_fs
/* 80C1AE34  C0 3F 00 08 */	lfs f1, 8(r31)
/* 80C1AE38  C0 5F 00 64 */	lfs f2, 0x64(r31)
/* 80C1AE3C  FC 60 08 90 */	fmr f3, f1
/* 80C1AE40  4B 3F 1F 5D */	bl transM__14mDoMtx_stack_cFfff
/* 80C1AE44  C0 3E 04 EC */	lfs f1, 0x4ec(r30)
/* 80C1AE48  FC 40 08 90 */	fmr f2, f1
/* 80C1AE4C  FC 60 08 90 */	fmr f3, f1
/* 80C1AE50  4B 3F 1F E9 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80C1AE54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C1AE58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C1AE5C  80 9E 05 B8 */	lwz r4, 0x5b8(r30)
/* 80C1AE60  38 84 00 24 */	addi r4, r4, 0x24
/* 80C1AE64  4B 72 B6 4D */	bl PSMTXCopy
/* 80C1AE68  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C1AE6C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80C1AE70  80 63 00 00 */	lwz r3, 0(r3)
/* 80C1AE74  A8 9E 06 7A */	lha r4, 0x67a(r30)
/* 80C1AE78  4B 3F 14 CD */	bl mDoMtx_XrotS__FPA4_fs
...
/* 80C1AED8  4B 65 47 71 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80C1AEDC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1AEE0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1AEE4  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C1AEE8  38 9E 09 0C */	addi r4, r30, 0x90c
/* 80C1AEEC  4B 64 9C BD */	bl Set__4cCcSFP8cCcD_Obj
/* 80C1AEF0  80 1E 06 A8 */	lwz r0, 0x6a8(r30)
/* 80C1AEF4  90 01 00 20 */	stw r0, 0x20(r1)
/* 80C1AEF8  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80C1AEFC  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80C1AF00  38 81 00 20 */	addi r4, r1, 0x20
/* 80C1AF04  4B 3F E8 F5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C1AF2C  4B 3F 56 9D */	bl play__14mDoExt_McaMorfFP3VecUlSc
lbl_80C1AF30:
...
/* 80C1AF4C  4B 65 56 BD */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C1AF6C  4B 74 72 A9 */	bl _restgpr_24
