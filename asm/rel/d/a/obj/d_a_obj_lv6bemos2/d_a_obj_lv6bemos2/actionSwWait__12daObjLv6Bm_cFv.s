...
/* 80C7FFC8  4B 6E 22 15 */	bl _savegpr_29
/* 80C7FFCC  7C 7F 1B 78 */	mr r31, r3
/* 80C7FFD0  3C 60 80 C8 */	lis r3, l_eye_offset@ha /* 0x80C81C2C@ha */
/* 80C7FFD4  3B C3 1C 2C */	addi r30, r3, l_eye_offset@l /* 0x80C81C2C@l */
...
lbl_80C80000:
/* 80C80000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C80004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C80018  4B 3B 53 49 */	bl isSwitch__10dSv_info_cCFii
/* 80C8001C  2C 03 00 00 */	cmpwi r3, 0
/* 80C80020  41 82 02 74 */	beq lbl_80C80294
/* 80C80024  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C81D24@ha */
/* 80C80028  38 63 1D 24 */	addi r3, r3, l_arcName@l /* 0x80C81D24@l */
/* 80C8002C  80 63 00 00 */	lwz r3, 0(r3)
/* 80C80030  38 80 00 16 */	li r4, 0x16
/* 80C80034  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C80038  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C8003C  3C A5 00 02 */	addis r5, r5, 2
/* 80C80040  38 C0 00 80 */	li r6, 0x80
/* 80C80044  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C80048  4B 3B C2 A5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C80074  4B 38 D6 99 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C800A4  4B 3A CF C9 */	bl dComIfGp_getReverb__Fi
...
/* 80C800B8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C800BC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C800E4  4B 62 B8 A1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C8014C  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C81D24@ha */
/* 80C80150  38 63 1D 24 */	addi r3, r3, l_arcName@l /* 0x80C81D24@l */
/* 80C80154  80 63 00 00 */	lwz r3, 0(r3)
/* 80C80158  38 80 00 1B */	li r4, 0x1b
/* 80C8015C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C80160  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C80174  4B 3B C1 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C801A0  4B 38 D4 9D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80C801A4  C0 1E 00 28 */	lfs f0, 0x28(r30)
/* 80C801A8  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 80C801AC  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 80C801B0  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C81D24@ha */
/* 80C801B4  38 63 1D 24 */	addi r3, r3, l_arcName@l /* 0x80C81D24@l */
...
/* 80C801C8  4B 3B C1 25 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C801F4  4B 38 D5 19 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80C801F8  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C81D24@ha */
/* 80C801FC  38 63 1D 24 */	addi r3, r3, l_arcName@l /* 0x80C81D24@l */
...
/* 80C80210  4B 3B C0 DD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C80234  4B 38 D5 A9 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
/* 80C80238  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C8023C  7C 03 07 74 */	extsb r3, r0
/* 80C80240  4B 3A CE 2D */	bl dComIfGp_getReverb__Fi
...
/* 80C80254  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C80258  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C80280  4B 62 B7 05 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C80298  4B 6E 1F 91 */	bl _restgpr_29
