...
/* 80C81510  4B 6E 0C CD */	bl _savegpr_29
/* 80C81514  7C 7E 1B 78 */	mr r30, r3
/* 80C81518  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C8151C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C81520  38 80 00 10 */	li r4, 0x10
/* 80C81524  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C81528  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C8152C  4B 52 22 99 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C81530  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C81534  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C81538  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80C8153C  80 84 00 04 */	lwz r4, 4(r4)
/* 80C81540  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C81544  4B 52 38 5D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C81548  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C8154C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C81550  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C81554  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C81558  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C8159C  4B 38 C2 0D */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80C815B0  4B 38 C4 1D */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C815B4  80 7E 05 A8 */	lwz r3, 0x5a8(r30)
/* 80C815B8  4B 38 C7 0D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C815BC  80 7E 05 A8 */	lwz r3, 0x5a8(r30)
/* 80C815C0  80 63 00 04 */	lwz r3, 4(r3)
/* 80C815C4  4B 38 C8 C9 */	bl mDoExt_brkAnmRemove__FP12J3DModelData
...
/* 80C815EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C815F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C81604  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C81608  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C8160C  80 9E 05 B4 */	lwz r4, 0x5b4(r30)
/* 80C81610  80 84 00 04 */	lwz r4, 4(r4)
/* 80C81614  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C81618  4B 52 37 89 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C81630  4B 38 C0 A9 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C81648  4B 38 C0 91 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C8165C  4B 38 C3 71 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C81660  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 80C81664  4B 38 C6 61 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C81668  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 80C8166C  80 63 00 04 */	lwz r3, 4(r3)
/* 80C81670  4B 38 C7 81 */	bl mDoExt_btkAnmRemove__FP12J3DModelData
...
/* 80C81694  4B 6E 0B 95 */	bl _restgpr_29
