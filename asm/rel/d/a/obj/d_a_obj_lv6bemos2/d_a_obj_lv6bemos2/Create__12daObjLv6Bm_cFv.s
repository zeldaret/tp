...
/* 80C7E458  4B 6E 3D 6D */	bl _savegpr_23
/* 80C7E45C  7C 7A 1B 78 */	mr r26, r3
/* 80C7E460  3C 60 80 C8 */	lis r3, cNullVec__6Z2Calc@ha /* 0x80C81D04@ha */
/* 80C7E464  3B E3 1D 04 */	addi r31, r3, cNullVec__6Z2Calc@l /* 0x80C81D04@l */
...
/* 80C7E484  4B 40 53 DD */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C7E488  38 7A 06 00 */	addi r3, r26, 0x600
/* 80C7E48C  38 9F 00 68 */	addi r4, r31, 0x68
/* 80C7E490  4B 40 65 A5 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80C7E4A4  4B 40 63 2D */	bl Set__8dCcD_CpsFRC11dCcD_SrcCps
...
/* 80C7E4B8  4B 40 63 FD */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80C7E4E4  4B 39 C0 65 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80C7E518  4B 66 05 E1 */	bl getName__10JUTNameTabCFUs
/* 80C7E51C  7C 9E C0 2E */	lwzx r4, r30, r24
/* 80C7E520  4B 6E A4 75 */	bl strcmp
...
/* 80C7E544  3C 60 80 C8 */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x80C7E1B8@ha */
/* 80C7E548  38 03 E1 B8 */	addi r0, r3, nodeCallBack__FP8J3DJointi@l /* 0x80C7E1B8@l */
...
/* 80C7E5A0  4B 66 05 59 */	bl getName__10JUTNameTabCFUs
/* 80C7E5A4  80 9F 00 24 */	lwz r4, 0x24(r31)
/* 80C7E5A8  4B 6E A3 ED */	bl strcmp
...
/* 80C7E628  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7E62C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C7E640  4B 3B 6D 21 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C7E670  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7E674  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7E678  88 1A 04 BA */	lbz r0, 0x4ba(r26)
/* 80C7E67C  7C 05 07 74 */	extsb r5, r0
/* 80C7E680  4B 3B 6C E1 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C7E6B0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7E6B4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7E6B8  3C A5 00 02 */	addis r5, r5, 2
/* 80C7E6BC  38 C0 00 80 */	li r6, 0x80
/* 80C7E6C0  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C7E6C4  4B 3B DC 29 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C7E6E4  3D 00 80 C8 */	lis r8, lit_3855@ha /* 0x80C81C48@ha */
/* 80C7E6E8  C0 28 1C 48 */	lfs f1, lit_3855@l(r8)  /* 0x80C81C48@l */
/* 80C7E6EC  39 00 00 00 */	li r8, 0
/* 80C7E6F0  39 20 FF FF */	li r9, -1
/* 80C7E6F4  4B 38 F0 19 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80C7E6F8  80 9A 05 B0 */	lwz r4, 0x5b0(r26)
/* 80C7E6FC  A8 04 00 08 */	lha r0, 8(r4)
/* 80C7E700  3C 60 80 C8 */	lis r3, lit_4012@ha /* 0x80C81C4C@ha */
/* 80C7E704  C8 23 1C 4C */	lfd f1, lit_4012@l(r3)  /* 0x80C81C4C@l */
...
/* 80C7E750  4B 6E 3A C1 */	bl _restgpr_23
