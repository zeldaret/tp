...
/* 80C7E1C8  4B 6E 40 11 */	bl _savegpr_28
/* 80C7E1CC  2C 04 00 00 */	cmpwi r4, 0
/* 80C7E1D0  40 82 01 20 */	bne lbl_80C7E2F0
/* 80C7E1D4  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 80C7E1D8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C7E1DC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C7E1F8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C7E1FC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C7E200  4B 6C 82 B1 */	bl PSMTXCopy
/* 80C7E204  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C7E208  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C7E240  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C7E244  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C7E248  A8 1C 09 C2 */	lha r0, 0x9c2(r28)
/* 80C7E24C  7C 00 22 14 */	add r0, r0, r4
/* 80C7E250  7C 04 07 34 */	extsh r4, r0
/* 80C7E254  4B 38 E1 49 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80C7E268  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C7E26C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C7E270  A8 9C 09 C6 */	lha r4, 0x9c6(r28)
/* 80C7E274  4B 38 E1 29 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80C7E288  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C7E28C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C7E290  A8 9C 09 CA */	lha r4, 0x9ca(r28)
/* 80C7E294  4B 38 E1 09 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80C7E2A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C7E2AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C7E2B0  A8 9C 09 CE */	lha r4, 0x9ce(r28)
/* 80C7E2B4  4B 38 E0 E9 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80C7E2C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C7E2CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C7E2D0  A8 9C 09 D2 */	lha r4, 0x9d2(r28)
/* 80C7E2D4  4B 38 E0 C9 */	bl mDoMtx_XrotM__FPA4_fs
lbl_80C7E2D8:
/* 80C7E2D8  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 80C7E2DC  80 03 00 0C */	lwz r0, 0xc(r3)
/* 80C7E2E0  7C 80 EA 14 */	add r4, r0, r29
/* 80C7E2E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C7E2E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C7E2EC  4B 6C 81 C5 */	bl PSMTXCopy
lbl_80C7E2F0:
/* 80C7E2F0  38 60 00 01 */	li r3, 1
/* 80C7E2F4  39 61 00 20 */	addi r11, r1, 0x20
/* 80C7E2F8  4B 6E 3F 2D */	bl _restgpr_28
