...
/* 80C7E388  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7E38C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7E390  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C7E394  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C7E398  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C7E39C  4B 6C 85 4C */	b PSMTXTrans
/* 80C7E3A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7E3A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7E3A8  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C7E3AC  4B 38 E0 88 */	b mDoMtx_YrotM__FPA4_fs
/* 80C7E3B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7E3B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7E3B8  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C7E3BC  38 84 00 24 */	addi r4, r4, 0x24
/* 80C7E3C0  4B 6C 80 F0 */	b PSMTXCopy
/* 80C7E3C4  3C 60 80 C8 */	lis r3, lit_3855@ha
/* 80C7E3C8  C0 23 1C 48 */	lfs f1, lit_3855@l(r3)
/* 80C7E3CC  FC 40 08 90 */	fmr f2, f1
/* 80C7E3D0  FC 60 08 90 */	fmr f3, f1
/* 80C7E3D4  4B 38 EA 64 */	b scaleM__14mDoMtx_stack_cFfff
/* 80C7E3D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7E3DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7E3E0  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80C7E3E4  4B 6C 80 CC */	b PSMTXCopy
/* 80C7E3E8  C0 3F 0A 0C */	lfs f1, 0xa0c(r31)
/* 80C7E3EC  3C 60 80 C8 */	lis r3, lit_3854@ha
/* 80C7E3F0  C0 03 1C 44 */	lfs f0, lit_3854@l(r3)
...
/* 80C7E414  4B 38 E9 50 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C7E418  38 7F 09 F0 */	addi r3, r31, 0x9f0
/* 80C7E41C  4B 38 EB 28 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C7E420  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7E424  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7E428  80 9F 05 B4 */	lwz r4, 0x5b4(r31)
/* 80C7E42C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C7E430  4B 6C 80 80 */	b PSMTXCopy
