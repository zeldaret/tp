...
/* 80C80844  4B 6E 19 85 */	bl _savegpr_24
/* 80C80848  7C 7E 1B 78 */	mr r30, r3
/* 80C8084C  3C 80 80 C8 */	lis r4, l_eye_offset@ha /* 0x80C81C2C@ha */
/* 80C80850  3B E4 1C 2C */	addi r31, r4, l_eye_offset@l /* 0x80C81C2C@l */
/* 80C80854  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C80858  3B 64 61 C0 */	addi r27, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C8085C  80 9B 5D AC */	lwz r4, 0x5dac(r27)
/* 80C80860  4B 39 A1 05 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C80918  4B 39 9D F9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C80934  4B 5E FE 0D */	bl cLib_chaseF__FPfff
...
/* 80C80974  4B 39 9D 9D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C80990  4B 5E FD B1 */	bl cLib_chaseF__FPfff
...
lbl_80C809A8:
/* 80C809A8  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C81D24@ha */
/* 80C809AC  38 63 1D 24 */	addi r3, r3, l_arcName@l /* 0x80C81D24@l */
/* 80C809B0  80 63 00 00 */	lwz r3, 0(r3)
/* 80C809B4  38 80 00 1A */	li r4, 0x1a
/* 80C809B8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C809BC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C809D0  4B 3B B9 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C809FC  4B 38 CC 41 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80C80A00  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C81D24@ha */
/* 80C80A04  38 63 1D 24 */	addi r3, r3, l_arcName@l /* 0x80C81D24@l */
...
/* 80C80A18  4B 3B B8 D5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C80A44  4B 38 CC C9 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C80A6C  4B 5E FB F1 */	bl cLib_chaseUC__FPUcUcUc
...
/* 80C80BB0  4B 39 D0 B9 */	bl lineCheck__11fopAcM_lc_cFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C80BB4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C80BB8  41 82 01 64 */	beq lbl_80C80D1C
/* 80C80BBC  3C 60 80 C8 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C81FA4@ha */
/* 80C80BC0  38 03 1F A4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C81FA4@l */
/* 80C80BC4  90 01 00 34 */	stw r0, 0x34(r1)
/* 80C80BC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C80BCC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C80BD0  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C80BD4  3C 80 80 3F */	lis r4, mLineCheck__11fopAcM_lc_c@ha /* 0x803F1C48@ha */
/* 80C80BD8  38 84 1C 48 */	addi r4, r4, mLineCheck__11fopAcM_lc_c@l /* 0x803F1C48@l */
/* 80C80BDC  38 84 00 14 */	addi r4, r4, 0x14
/* 80C80BE0  38 A1 00 24 */	addi r5, r1, 0x24
/* 80C80BE4  4B 3F 3B 61 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C80BE8  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80C80BEC  4B 5E 75 F9 */	bl cBgW_CheckBGround__Ff
/* 80C80BF0  3C 80 80 C8 */	lis r4, __vt__8cM3dGPla@ha /* 0x80C81FA4@ha */
/* 80C80BF4  38 04 1F A4 */	addi r0, r4, __vt__8cM3dGPla@l /* 0x80C81FA4@l */
...
/* 80C80C1C  3C 60 80 3F */	lis r3, mLineCheck__11fopAcM_lc_c@ha /* 0x803F1C48@ha */
/* 80C80C20  38 63 1C 48 */	addi r3, r3, mLineCheck__11fopAcM_lc_c@l /* 0x803F1C48@l */
/* 80C80C24  3B 43 00 30 */	addi r26, r3, 0x30
/* 80C80C28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C80C2C  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_80C80C30:
...
/* 80C80C84  4B 3C BE 0D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
lbl_80C80CAC:
/* 80C80CAC  3C 60 80 3F */	lis r3, mLineCheck__11fopAcM_lc_c@ha /* 0x803F1C48@ha */
/* 80C80CB0  38 63 1C 48 */	addi r3, r3, mLineCheck__11fopAcM_lc_c@l /* 0x803F1C48@l */
/* 80C80CB4  3B 23 00 30 */	addi r25, r3, 0x30
/* 80C80CB8  7F 23 CB 78 */	mr r3, r25
/* 80C80CBC  4B 38 C0 A9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C80CC0  3B 00 00 00 */	li r24, 0
/* 80C80CC4  3B A0 00 00 */	li r29, 0
/* 80C80CC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C80CCC  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_80C80CD0:
...
/* 80C80CEC  4B 5F FA F5 */	bl func_802807E0
lbl_80C80CF0:
...
/* 80C80D84  4B 5E 62 E9 */	bl __ne__4cXyzCFRC3Vec
...
/* 80C80DEC  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C81D24@ha */
/* 80C80DF0  38 63 1D 24 */	addi r3, r3, l_arcName@l /* 0x80C81D24@l */
/* 80C80DF4  80 63 00 00 */	lwz r3, 0(r3)
/* 80C80DF8  38 80 00 13 */	li r4, 0x13
/* 80C80DFC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C80E00  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C80E04  3C A5 00 02 */	addis r5, r5, 2
/* 80C80E08  38 C0 00 80 */	li r6, 0x80
/* 80C80E0C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C80E10  4B 3B B4 DD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C80E3C  4B 38 C8 D1 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
lbl_80C80E40:
...
/* 80C80E78  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C80E7C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C80E80  4B 6C 56 31 */	bl PSMTXCopy
/* 80C80E84  3B 00 00 00 */	li r24, 0
/* 80C80E88  3B E0 00 00 */	li r31, 0
/* 80C80E8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C80E90  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_80C80E94:
...
/* 80C80EB0  4B 5F F9 31 */	bl func_802807E0
lbl_80C80EB4:
