...
/* 80C8143C  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C81D24@ha */
/* 80C81440  38 63 1D 24 */	addi r3, r3, l_arcName@l /* 0x80C81D24@l */
/* 80C81444  80 63 00 00 */	lwz r3, 0(r3)
/* 80C81448  38 80 00 08 */	li r4, 8
/* 80C8144C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C81450  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C81454  3C A5 00 02 */	addis r5, r5, 2
/* 80C81458  38 C0 00 80 */	li r6, 0x80
/* 80C8145C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C81460  4B 3B AE 8D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C81474  3C E0 80 C8 */	lis r7, lit_4173@ha /* 0x80C81C54@ha */
/* 80C81478  C0 27 1C 54 */	lfs f1, lit_4173@l(r7)  /* 0x80C81C54@l */
/* 80C8147C  38 E0 00 00 */	li r7, 0
/* 80C81480  39 00 FF FF */	li r8, -1
/* 80C81484  39 20 00 01 */	li r9, 1
/* 80C81488  4B 38 C3 55 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
/* 80C8148C  80 9F 05 B0 */	lwz r4, 0x5b0(r31)
/* 80C81490  A8 04 00 08 */	lha r0, 8(r4)
/* 80C81494  3C 60 80 C8 */	lis r3, lit_4012@ha /* 0x80C81C4C@ha */
/* 80C81498  C8 23 1C 4C */	lfd f1, lit_4012@l(r3)  /* 0x80C81C4C@l */
