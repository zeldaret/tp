...
/* 80C7FA6C  4B 6E 27 6D */	bl _savegpr_28
/* 80C7FA70  7C 7E 1B 78 */	mr r30, r3
/* 80C7FA74  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7FA78  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C7FA9C  4B 39 AE C9 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C7FAC4  3C 60 80 C8 */	lis r3, l_eye_offset@ha /* 0x80C81C2C@ha */
/* 80C7FAC8  38 63 1C 2C */	addi r3, r3, l_eye_offset@l /* 0x80C81C2C@l */
/* 80C7FACC  C0 63 00 04 */	lfs f3, 4(r3)
/* 80C7FAD0  3C 60 80 C8 */	lis r3, lit_3855@ha /* 0x80C81C48@ha */
/* 80C7FAD4  C0 43 1C 48 */	lfs f2, lit_3855@l(r3)  /* 0x80C81C48@l */
...
/* 80C7FAFC  4B 39 AC 15 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C7FB6C  4B 39 E0 FD */	bl lineCheck__11fopAcM_lc_cFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 80C7FB90  4B 6E 26 95 */	bl _restgpr_28
