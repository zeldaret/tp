...
/* 80C5FCB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5FCBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5FCC0  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C5FCC4  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C5FCC8  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C5FCCC  4B 6E 6C 1C */	b PSMTXTrans
/* 80C5FCD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5FCD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5FCD8  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C5FCDC  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C5FCE0  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C5FCE4  4B 3A C5 BC */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C5FCE8  3C 60 80 C6 */	lis r3, lit_3655@ha
/* 80C5FCEC  C0 23 08 1C */	lfs f1, lit_3655@l(r3)
/* 80C5FCF0  C0 5F 05 B4 */	lfs f2, 0x5b4(r31)
/* 80C5FCF4  FC 60 08 90 */	fmr f3, f1
/* 80C5FCF8  4B 3A D0 A4 */	b transM__14mDoMtx_stack_cFfff
...
/* 80C5FD18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5FD1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5FD20  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C5FD24  38 84 00 24 */	addi r4, r4, 0x24
/* 80C5FD28  4B 6E 67 88 */	b PSMTXCopy
