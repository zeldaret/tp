...
/* 80C60610  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C60614  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C60618  38 80 00 10 */	li r4, 0x10
/* 80C6061C  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C60620  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C60624  4B 54 31 A1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C60628  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C6062C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C60630  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80C60634  80 84 00 04 */	lwz r4, 4(r4)
/* 80C60638  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C6063C  4B 54 47 65 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C60640  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C60644  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C60648  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C6064C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C60650  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C60664  4B 3A D6 61 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C60668  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C6066C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
