...
/* 80C16AAC  3C 60 80 C1 */	lis r3, l_arcName@ha /* 0x80C1737C@ha */
/* 80C16AB0  38 63 73 7C */	addi r3, r3, l_arcName@l /* 0x80C1737C@l */
/* 80C16AB4  80 63 00 00 */	lwz r3, 0(r3)
/* 80C16AB8  38 80 00 03 */	li r4, 3
/* 80C16ABC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C16AC0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C16AC4  3C A5 00 02 */	addis r5, r5, 2
/* 80C16AC8  38 C0 00 80 */	li r6, 0x80
/* 80C16ACC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C16AD0  4B 42 58 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C16AE0  4B 3F E1 75 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
