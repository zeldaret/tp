...
/* 80C16938  3C 60 80 C1 */	lis r3, __vt__14daObjHBarrel_c@ha /* 0x80C173D0@ha */
/* 80C1693C  38 03 73 D0 */	addi r0, r3, __vt__14daObjHBarrel_c@l /* 0x80C173D0@l */
...
lbl_80C16950:
/* 80C16950  3C 80 80 C1 */	lis r4, l_arcName@ha /* 0x80C1737C@ha */
/* 80C16954  38 84 73 7C */	addi r4, r4, l_arcName@l /* 0x80C1737C@l */
/* 80C16958  80 84 00 00 */	lwz r4, 0(r4)
/* 80C1695C  4B 41 66 AD */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80C16960  34 1E 06 F0 */	addic. r0, r30, 0x6f0
/* 80C16964  41 82 00 1C */	beq lbl_80C16980
/* 80C16968  3C 60 80 3D */	lis r3, __vt__16Z2SoundObjSimple@ha /* 0x803CAD10@ha */
/* 80C1696C  38 03 AD 10 */	addi r0, r3, __vt__16Z2SoundObjSimple@l /* 0x803CAD10@l */
/* 80C16970  90 1E 07 00 */	stw r0, 0x700(r30)
/* 80C16974  38 7E 06 F0 */	addi r3, r30, 0x6f0
/* 80C16978  38 80 00 00 */	li r4, 0
/* 80C1697C  4B 6A 75 CD */	bl __dt__14Z2SoundObjBaseFv
lbl_80C16980:
/* 80C16980  34 1E 05 B4 */	addic. r0, r30, 0x5b4
/* 80C16984  41 82 00 84 */	beq lbl_80C16A08
/* 80C16988  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C1698C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C169AC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C169B0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80C169C8  3C 60 80 C1 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C173F4@ha */
/* 80C169CC  38 03 73 F4 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C173F4@l */
/* 80C169D0  90 1E 06 EC */	stw r0, 0x6ec(r30)
lbl_80C169D4:
/* 80C169D4  34 1E 06 B8 */	addic. r0, r30, 0x6b8
/* 80C169D8  41 82 00 24 */	beq lbl_80C169FC
/* 80C169DC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C169E0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C169E4  90 1E 06 D4 */	stw r0, 0x6d4(r30)
/* 80C169E8  34 1E 06 B8 */	addic. r0, r30, 0x6b8
/* 80C169EC  41 82 00 10 */	beq lbl_80C169FC
/* 80C169F0  3C 60 80 C1 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C17400@ha */
/* 80C169F4  38 03 74 00 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C17400@l */
/* 80C169F8  90 1E 06 D0 */	stw r0, 0x6d0(r30)
lbl_80C169FC:
/* 80C169FC  38 7E 05 B4 */	addi r3, r30, 0x5b4
/* 80C16A00  38 80 00 00 */	li r4, 0
/* 80C16A04  4B 46 D6 E1 */	bl __dt__12dCcD_GObjInfFv
lbl_80C16A08:
/* 80C16A08  34 1E 05 78 */	addic. r0, r30, 0x578
/* 80C16A0C  41 82 00 54 */	beq lbl_80C16A60
/* 80C16A10  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C16A14  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C16A2C  3C 60 80 C1 */	lis r3, __vt__10dCcD_GStts@ha /* 0x80C173E8@ha */
/* 80C16A30  38 03 73 E8 */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x80C173E8@l */
/* 80C16A34  90 1E 05 94 */	stw r0, 0x594(r30)
/* 80C16A38  34 1E 05 94 */	addic. r0, r30, 0x594
/* 80C16A3C  41 82 00 10 */	beq lbl_80C16A4C
/* 80C16A40  3C 60 80 C1 */	lis r3, __vt__10cCcD_GStts@ha /* 0x80C173DC@ha */
/* 80C16A44  38 03 73 DC */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x80C173DC@l */
/* 80C16A48  90 1E 05 94 */	stw r0, 0x594(r30)
lbl_80C16A4C:
/* 80C16A4C  34 1E 05 78 */	addic. r0, r30, 0x578
/* 80C16A50  41 82 00 10 */	beq lbl_80C16A60
/* 80C16A54  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C16A58  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C16A5C  90 1E 05 90 */	stw r0, 0x590(r30)
lbl_80C16A60:
/* 80C16A60  7F C3 F3 78 */	mr r3, r30
/* 80C16A64  38 80 00 00 */	li r4, 0
/* 80C16A68  4B 40 22 25 */	bl __dt__10fopAc_ac_cFv
/* 80C16A6C  7F E0 07 35 */	extsh. r0, r31
/* 80C16A70  40 81 00 0C */	ble lbl_80C16A7C
/* 80C16A74  7F C3 F3 78 */	mr r3, r30
/* 80C16A78  4B 6B 82 C5 */	bl __dl__FPv
lbl_80C16A7C:
