...
/* 80C16C58  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C16C5C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C16C60  38 80 00 08 */	li r4, 8
/* 80C16C64  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C16C68  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80C16C6C  4B 58 CB 58 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C16C70  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C16C74  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C16C78  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80C16C7C  80 84 00 04 */	lwz r4, 4(r4)
/* 80C16C80  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C16C84  4B 58 E1 1C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C16C88  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80C16C8C  4B 3F 6F A0 */	b mDoExt_modelUpdate__FP8J3DModel
