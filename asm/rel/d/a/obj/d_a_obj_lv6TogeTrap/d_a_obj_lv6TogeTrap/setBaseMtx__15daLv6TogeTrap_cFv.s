...
/* 80C79F28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C79F2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C79F44  4B 6C C9 A4 */	b PSMTXTrans
/* 80C79F48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C79F4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C79F50  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C79F54  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C79F58  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C79F5C  4B 39 23 44 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C79F60  C0 3F 05 FC */	lfs f1, 0x5fc(r31)
/* 80C79F64  3C 60 80 C8 */	lis r3, lit_3665@ha
/* 80C79F68  C0 43 C6 E8 */	lfs f2, lit_3665@l(r3)
/* 80C79F6C  FC 60 10 90 */	fmr f3, f2
/* 80C79F70  4B 39 2E 2C */	b transM__14mDoMtx_stack_cFfff
/* 80C79F74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C79F78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C79F7C  38 80 00 00 */	li r4, 0
/* 80C79F80  A8 BF 06 00 */	lha r5, 0x600(r31)
/* 80C79F84  38 C0 00 00 */	li r6, 0
/* 80C79F88  4B 39 23 18 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C79F8C  C0 3F 04 EC */	lfs f1, 0x4ec(r31)
/* 80C79F90  C0 5F 04 F0 */	lfs f2, 0x4f0(r31)
/* 80C79F94  C0 7F 04 F4 */	lfs f3, 0x4f4(r31)
/* 80C79F98  4B 39 2E A0 */	b scaleM__14mDoMtx_stack_cFfff
/* 80C79F9C  3C 60 80 C8 */	lis r3, lit_3632@ha
/* 80C79FA0  C0 03 C6 1C */	lfs f0, lit_3632@l(r3)
...
/* 80C79FC0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C79FC4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C79FC8  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C79FCC  38 84 00 24 */	addi r4, r4, 0x24
/* 80C79FD0  4B 6C C4 E0 */	b PSMTXCopy
