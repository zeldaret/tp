...
/* 80C7B6EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7B6F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7B6F4  83 C3 5D AC */	lwz r30, 0x5dac(r3)
/* 80C7B6F8  38 7F 06 50 */	addi r3, r31, 0x650
/* 80C7B6FC  4B 40 8F 5D */	bl ChkCoHit__12dCcD_GObjInfFv
/* 80C7B700  28 03 00 00 */	cmplwi r3, 0
/* 80C7B704  41 82 00 EC */	beq lbl_80C7B7F0
/* 80C7B708  38 7F 07 38 */	addi r3, r31, 0x738
/* 80C7B70C  4B 40 7F 7D */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 80C7B730  4B 5E B4 05 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C7B758  4B 5E B3 DD */	bl __mi__4cXyzCFRC3Vec
...
/* 80C7B77C  4B 6C BA 19 */	bl PSVECDotProduct
/* 80C7B780  3C 60 80 C8 */	lis r3, lit_3665@ha /* 0x80C7C6E8@ha */
/* 80C7B784  C0 03 C6 E8 */	lfs f0, lit_3665@l(r3)  /* 0x80C7C6E8@l */
...
/* 80C7B7A0  4B 3D 60 4D */	bl dPath_GetRoomPath__Fii
...
lbl_80C7B7F0:
/* 80C7B7F0  3C 60 80 C8 */	lis r3, searchSekizoAct__15daLv6TogeTrap_cFPvPv@ha /* 0x80C7A6B0@ha */
/* 80C7B7F4  38 63 A6 B0 */	addi r3, r3, searchSekizoAct__15daLv6TogeTrap_cFPvPv@l /* 0x80C7A6B0@l */
/* 80C7B7F8  7F E4 FB 78 */	mr r4, r31
/* 80C7B7FC  4B 39 DF FD */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80C7B800  7C 64 1B 79 */	or. r4, r3, r3
/* 80C7B804  38 00 00 00 */	li r0, 0
/* 80C7B808  98 1F 06 09 */	stb r0, 0x609(r31)
/* 80C7B80C  3C 60 80 C8 */	lis r3, lit_4416@ha /* 0x80C7C74C@ha */
/* 80C7B810  C0 03 C7 4C */	lfs f0, lit_4416@l(r3)  /* 0x80C7C74C@l */
...
/* 80C7B82C  4B 5E CE E5 */	bl cM3d_Len3dSqPntAndSegLine__FPC8cM3dGLinPC3VecP3VecPf
...
/* 80C7B844  4B 5E CE CD */	bl cM3d_Len3dSqPntAndSegLine__FPC8cM3dGLinPC3VecP3VecPf
...
/* 80C7B8CC  3C 60 80 C8 */	lis r3, lit_3665@ha /* 0x80C7C6E8@ha */
/* 80C7B8D0  C0 03 C6 E8 */	lfs f0, lit_3665@l(r3)  /* 0x80C7C6E8@l */
...
lbl_80C7B8FC:
/* 80C7B8FC  3C 60 80 C8 */	lis r3, l_HIO@ha /* 0x80C7CA64@ha */
/* 80C7B900  38 63 CA 64 */	addi r3, r3, l_HIO@l /* 0x80C7CA64@l */
