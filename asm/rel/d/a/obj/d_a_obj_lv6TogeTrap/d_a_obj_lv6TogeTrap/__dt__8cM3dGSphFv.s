...
/* 80C7A594  3C A0 80 C8 */	lis r5, __vt__8cM3dGSph@ha /* 0x80C7C9EC@ha */
/* 80C7A598  38 05 C9 EC */	addi r0, r5, __vt__8cM3dGSph@l /* 0x80C7C9EC@l */
/* 80C7A59C  90 1F 00 10 */	stw r0, 0x10(r31)
/* 80C7A5A0  7C 80 07 35 */	extsh. r0, r4
/* 80C7A5A4  40 81 00 08 */	ble lbl_80C7A5AC
/* 80C7A5A8  4B 65 47 95 */	bl __dl__FPv
lbl_80C7A5AC:
