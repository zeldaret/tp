...
/* 80C7C3F8  4B 64 1C 01 */	bl deleteObject__14Z2SoundObjBaseFv
/* 80C7C3FC  38 7F 05 A0 */	addi r3, r31, 0x5a0
/* 80C7C400  88 1F 06 0C */	lbz r0, 0x60c(r31)
/* 80C7C404  54 00 10 3A */	slwi r0, r0, 2
/* 80C7C408  3C 80 80 C8 */	lis r4, l_resNameIdx@ha /* 0x80C7C81C@ha */
/* 80C7C40C  38 84 C8 1C */	addi r4, r4, l_resNameIdx@l /* 0x80C7C81C@l */
/* 80C7C410  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C7C414  4B 3B 0B F5 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
