...
/* 80C7B550  4B 3B 1B 1D */	bl dComIfGp_getReverb__Fi
/* 80C7B554  7C 7F 1B 78 */	mr r31, r3
/* 80C7B558  C0 3E 05 2C */	lfs f1, 0x52c(r30)
/* 80C7B55C  4B 6E 6B 51 */	bl __cvt_fp2unsigned
...
/* 80C7B570  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C7B574  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C7B588  3D 00 80 C8 */	lis r8, lit_3632@ha /* 0x80C7C61C@ha */
/* 80C7B58C  C0 28 C6 1C */	lfs f1, lit_3632@l(r8)  /* 0x80C7C61C@l */
/* 80C7B590  FC 40 08 90 */	fmr f2, f1
/* 80C7B594  3D 00 80 C8 */	lis r8, lit_4150@ha /* 0x80C7C728@ha */
/* 80C7B598  C0 68 C7 28 */	lfs f3, lit_4150@l(r8)  /* 0x80C7C728@l */
/* 80C7B59C  FC 80 18 90 */	fmr f4, f3
/* 80C7B5A0  39 00 00 00 */	li r8, 0
/* 80C7B5A4  4B 63 0F 69 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C7B5CC  4B 39 E6 B1 */	bl fopAcM_delete__FP10fopAc_ac_c
