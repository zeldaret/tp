...
/* 80C7AE34  4B 6E 73 A5 */	bl _savegpr_28
/* 80C7AE38  7C 7C 1B 78 */	mr r28, r3
/* 80C7AE3C  3C 60 80 C8 */	lis r3, lit_3631@ha /* 0x80C7C618@ha */
/* 80C7AE40  3B C3 C6 18 */	addi r30, r3, lit_3631@l /* 0x80C7C618@l */
/* 80C7AE44  C0 3C 05 D4 */	lfs f1, 0x5d4(r28)
/* 80C7AE48  38 7C 05 2C */	addi r3, r28, 0x52c
/* 80C7AE4C  3C 80 80 C8 */	lis r4, l_HIO@ha /* 0x80C7CA64@ha */
/* 80C7AE50  38 84 CA 64 */	addi r4, r4, l_HIO@l /* 0x80C7CA64@l */
/* 80C7AE54  C0 04 00 20 */	lfs f0, 0x20(r4)
/* 80C7AE58  EC 41 00 24 */	fdivs f2, f1, f0
/* 80C7AE5C  4B 5F 58 E5 */	bl cLib_chaseF__FPfff
...
/* 80C7AE78  4B 5F 4C 41 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
/* 80C7AE7C  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 80C7AE80  7C 03 07 74 */	extsb r3, r0
/* 80C7AE84  4B 3B 21 E9 */	bl dComIfGp_getReverb__Fi
/* 80C7AE88  7C 7D 1B 78 */	mr r29, r3
/* 80C7AE8C  C0 3C 05 2C */	lfs f1, 0x52c(r28)
/* 80C7AE90  4B 6E 72 1D */	bl __cvt_fp2unsigned
...
/* 80C7AEA4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C7AEA8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C7AED0  4B 63 16 3D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C7AEE4  4B 5E C1 49 */	bl __eq__4cXyzCFRC3Vec
...
/* 80C7AEFC  4B 6E 73 29 */	bl _restgpr_28
