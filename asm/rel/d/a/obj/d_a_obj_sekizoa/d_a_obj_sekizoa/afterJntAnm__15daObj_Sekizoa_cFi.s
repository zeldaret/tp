...
/* 80CCF378  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCF37C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CCF380  4B 33 D0 B4 */	b mDoMtx_YrotM__FPA4_fs
/* 80CCF384  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCF388  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CCF38C  A8 1F 0D 0E */	lha r0, 0xd0e(r31)
/* 80CCF390  7C 00 00 D0 */	neg r0, r0
/* 80CCF394  7C 04 07 34 */	extsh r4, r0
/* 80CCF398  4B 33 D1 34 */	b mDoMtx_ZrotM__FPA4_fs
/* 80CCF39C  48 00 00 34 */	b lbl_80CCF3D0
lbl_80CCF3A0:
/* 80CCF3A0  2C 04 00 03 */	cmpwi r4, 3
/* 80CCF3A4  40 82 00 2C */	bne lbl_80CCF3D0
/* 80CCF3A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCF3AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CCF3B0  A8 1F 0D 0C */	lha r0, 0xd0c(r31)
/* 80CCF3B4  7C 00 00 D0 */	neg r0, r0
/* 80CCF3B8  7C 04 07 34 */	extsh r4, r0
/* 80CCF3BC  4B 33 D0 78 */	b mDoMtx_YrotM__FPA4_fs
/* 80CCF3C0  A8 9F 0D 08 */	lha r4, 0xd08(r31)
/* 80CCF3C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCF3C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CCF3CC  4B 33 D1 00 */	b mDoMtx_ZrotM__FPA4_fs
lbl_80CCF3D0:
