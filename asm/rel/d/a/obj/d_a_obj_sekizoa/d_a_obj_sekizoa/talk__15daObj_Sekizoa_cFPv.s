...
/* 80CD45F8  4B 47 75 F9 */	bl initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80CD4640  4B 47 76 39 */	bl talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 80CD465C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD4660  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD4664  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80CD4668  4B 47 10 79 */	bl entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80CD466C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD4670  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD4674  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80CD4678  4B 36 DD F1 */	bl reset__14dEvt_control_cFv
...
/* 80CD4694  4B 47 10 69 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80CD4698  38 00 00 00 */	li r0, 0
/* 80CD469C  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80CD46A0  3C 60 80 CD */	lis r3, lit_4350@ha /* 0x80CD5DBC@ha */
/* 80CD46A4  C0 03 5D BC */	lfs f0, lit_4350@l(r3)  /* 0x80CD5DBC@l */
...
/* 80CD46DC  4B 47 10 21 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80CD46E0  38 00 00 00 */	li r0, 0
/* 80CD46E4  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80CD46E8  3C 60 80 CD */	lis r3, lit_4350@ha /* 0x80CD5DBC@ha */
/* 80CD46EC  C0 03 5D BC */	lfs f0, lit_4350@l(r3)  /* 0x80CD5DBC@l */
...
/* 80CD4718  4B 47 0F E5 */	bl remove__18daNpcT_ActorMngr_cFv
/* 80CD471C  38 00 00 00 */	li r0, 0
/* 80CD4720  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80CD4724  3C 60 80 CD */	lis r3, lit_4350@ha /* 0x80CD5DBC@ha */
/* 80CD4728  C0 03 5D BC */	lfs f0, lit_4350@l(r3)  /* 0x80CD5DBC@l */
...
/* 80CD475C  4B 47 6E ED */	bl step__8daNpcT_cFsiiii
lbl_80CD4760:
