...
/* 80CD05FC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CD0600  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CD0604  38 80 00 07 */	li r4, 7
/* 80CD0608  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CD060C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CD0610  4B 4D 31 B5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CD0614  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CD0618  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CD061C  80 9F 00 04 */	lwz r4, 4(r31)
/* 80CD0620  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CD0624  4B 4D 47 7D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CD0628  38 7E 0E 44 */	addi r3, r30, 0xe44
/* 80CD062C  38 80 00 00 */	li r4, 0
/* 80CD0630  4B 33 E1 91 */	bl entryDL__21mDoExt_invisibleModelFP4cXyz
/* 80CD0634  48 00 00 70 */	b lbl_80CD06A4
lbl_80CD0638:
/* 80CD0638  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CD063C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CD0640  38 80 00 10 */	li r4, 0x10
/* 80CD0644  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CD0648  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CD064C  4B 4D 31 79 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CD0650  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CD0654  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CD0658  80 9F 00 04 */	lwz r4, 4(r31)
/* 80CD065C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CD0660  4B 4D 47 41 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CD0664  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD0668  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD066C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CD0670  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CD0674  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CD0688  4B 34 0B 39 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 80CD068C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD0690  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
