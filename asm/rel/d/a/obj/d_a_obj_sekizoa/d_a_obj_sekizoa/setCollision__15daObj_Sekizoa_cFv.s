...
/* 80CD00BC  4B 69 21 19 */	bl _savegpr_27
/* 80CD00C0  7C 7B 1B 78 */	mr r27, r3
/* 80CD00C4  3C 60 80 CD */	lis r3, m__21daObj_Sekizoa_Param_c@ha /* 0x80CD5CFC@ha */
/* 80CD00C8  3B E3 5C FC */	addi r31, r3, m__21daObj_Sekizoa_Param_c@l /* 0x80CD5CFC@l */
...
/* 80CD00EC  4B 47 CA 81 */	bl daNpcT_chkTmpBit__FUl
...
lbl_80CD0100:
/* 80CD0100  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD0104  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80CD01B4:
/* 80CD01B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CD01B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CD01BC  A8 9B 0D 7A */	lha r4, 0xd7a(r27)
/* 80CD01C0  4B 33 C2 1D */	bl mDoMtx_YrotS__FPA4_fs
/* 80CD01C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CD01C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CD01CC  38 81 00 14 */	addi r4, r1, 0x14
/* 80CD01D0  7C 85 23 78 */	mr r5, r4
/* 80CD01D4  4B 67 6B 99 */	bl PSMTXMultVec
...
/* 80CD01E8  4B 59 68 FD */	bl __pl__4cXyzCFRC3Vec
...
/* 80CD0240  4B 59 EF B9 */	bl SetH__8cM3dGCylFf
/* 80CD0244  38 7B 10 B0 */	addi r3, r27, 0x10b0
/* 80CD0248  C0 3F 01 0C */	lfs f1, 0x10c(r31)
/* 80CD024C  4B 59 EF B5 */	bl SetR__8cM3dGCylFf
/* 80CD0250  38 7B 10 B0 */	addi r3, r27, 0x10b0
/* 80CD0254  38 81 00 20 */	addi r4, r1, 0x20
/* 80CD0258  4B 59 EF 85 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80CD025C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD0260  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD0264  38 63 23 3C */	addi r3, r3, 0x233c
/* 80CD0268  38 9B 0F 8C */	addi r4, r27, 0xf8c
/* 80CD026C  4B 59 49 3D */	bl Set__4cCcSFP8cCcD_Obj
lbl_80CD0270:
...
lbl_80CD02DC:
/* 80CD02DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CD02E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CD02E4  A8 9B 0D 7A */	lha r4, 0xd7a(r27)
/* 80CD02E8  4B 33 C0 F5 */	bl mDoMtx_YrotS__FPA4_fs
/* 80CD02EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CD02F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CD02F4  38 81 00 20 */	addi r4, r1, 0x20
/* 80CD02F8  7C 85 23 78 */	mr r5, r4
/* 80CD02FC  4B 67 6A 71 */	bl PSMTXMultVec
/* 80CD0300  38 61 00 20 */	addi r3, r1, 0x20
/* 80CD0304  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 80CD0308  7C 65 1B 78 */	mr r5, r3
/* 80CD030C  4B 67 6D 85 */	bl PSVECAdd
/* 80CD0310  38 7B 0F 74 */	addi r3, r27, 0xf74
/* 80CD0314  FC 20 F8 90 */	fmr f1, f31
/* 80CD0318  4B 59 EE E1 */	bl SetH__8cM3dGCylFf
/* 80CD031C  38 7B 0F 74 */	addi r3, r27, 0xf74
/* 80CD0320  FC 20 F0 90 */	fmr f1, f30
/* 80CD0324  4B 59 EE DD */	bl SetR__8cM3dGCylFf
/* 80CD0328  38 7B 0F 74 */	addi r3, r27, 0xf74
/* 80CD032C  38 81 00 20 */	addi r4, r1, 0x20
/* 80CD0330  4B 59 EE AD */	bl SetC__8cM3dGCylFRC4cXyz
/* 80CD0334  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD0338  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD033C  38 63 23 3C */	addi r3, r3, 0x233c
/* 80CD0340  38 9B 0E 50 */	addi r4, r27, 0xe50
/* 80CD0344  4B 59 48 65 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80CD0348:
...
/* 80CD03AC  4B 69 1E 75 */	bl _restgpr_27
