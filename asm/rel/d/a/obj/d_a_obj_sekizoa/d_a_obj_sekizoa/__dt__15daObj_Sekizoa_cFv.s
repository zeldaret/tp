...
/* 80CCE36C  3C 60 80 CD */	lis r3, __vt__15daObj_Sekizoa_c@ha /* 0x80CD6808@ha */
/* 80CCE370  38 03 68 08 */	addi r0, r3, __vt__15daObj_Sekizoa_c@l /* 0x80CD6808@l */
...
/* 80CCE3B8  4B 47 E7 B5 */	bl daNpcT_chkTmpBit__FUl
/* 80CCE3BC  2C 03 00 00 */	cmpwi r3, 0
/* 80CCE3C0  41 82 00 18 */	beq lbl_80CCE3D8
/* 80CCE3C4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CCE3C8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 80CCE3CC  80 63 00 00 */	lwz r3, 0(r3)
/* 80CCE3D0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 80CCE3D4  4B 5E 14 B1 */	bl subBgmStop__8Z2SeqMgrFv
lbl_80CCE3D8:
/* 80CCE3D8  7F C3 F3 78 */	mr r3, r30
/* 80CCE3DC  88 1E 10 C8 */	lbz r0, 0x10c8(r30)
/* 80CCE3E0  54 00 10 3A */	slwi r0, r0, 2
/* 80CCE3E4  3C 80 80 CD */	lis r4, l_loadResPtrnList@ha /* 0x80CD5FA4@ha */
/* 80CCE3E8  38 84 5F A4 */	addi r4, r4, l_loadResPtrnList@l /* 0x80CD5FA4@l */
/* 80CCE3EC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CCE3F0  3C A0 80 CD */	lis r5, l_resNameList@ha /* 0x80CD5F90@ha */
/* 80CCE3F4  38 A5 5F 90 */	addi r5, r5, l_resNameList@l /* 0x80CD5F90@l */
/* 80CCE3F8  4B 47 A0 B5 */	bl deleteRes__8daNpcT_cFPCScPPCc
/* 80CCE3FC  34 1E 11 24 */	addic. r0, r30, 0x1124
/* 80CCE400  41 82 00 10 */	beq lbl_80CCE410
/* 80CCE404  3C 60 80 CD */	lis r3, __vt__13daNpcT_Path_c@ha /* 0x80CD67FC@ha */
/* 80CCE408  38 03 67 FC */	addi r0, r3, __vt__13daNpcT_Path_c@l /* 0x80CD67FC@l */
/* 80CCE40C  90 1E 11 48 */	stw r0, 0x1148(r30)
lbl_80CCE410:
/* 80CCE410  38 7E 10 CC */	addi r3, r30, 0x10cc
/* 80CCE414  3C 80 80 CD */	lis r4, __dt__18daNpcT_ActorMngr_cFv@ha /* 0x80CD4C48@ha */
/* 80CCE418  38 84 4C 48 */	addi r4, r4, __dt__18daNpcT_ActorMngr_cFv@l /* 0x80CD4C48@l */
/* 80CCE41C  38 A0 00 08 */	li r5, 8
/* 80CCE420  38 C0 00 08 */	li r6, 8
/* 80CCE424  4B 69 38 C5 */	bl __destroy_arr
/* 80CCE428  34 1E 0F 8C */	addic. r0, r30, 0xf8c
/* 80CCE42C  41 82 00 84 */	beq lbl_80CCE4B0
/* 80CCE430  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CCE434  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80CCE454  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CCE458  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80CCE470  3C 60 80 CD */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CD67F0@ha */
/* 80CCE474  38 03 67 F0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CD67F0@l */
/* 80CCE478  90 1E 10 C4 */	stw r0, 0x10c4(r30)
lbl_80CCE47C:
/* 80CCE47C  34 1E 10 90 */	addic. r0, r30, 0x1090
/* 80CCE480  41 82 00 24 */	beq lbl_80CCE4A4
/* 80CCE484  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CCE488  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CCE48C  90 1E 10 AC */	stw r0, 0x10ac(r30)
/* 80CCE490  34 1E 10 90 */	addic. r0, r30, 0x1090
/* 80CCE494  41 82 00 10 */	beq lbl_80CCE4A4
/* 80CCE498  3C 60 80 CD */	lis r3, __vt__8cM3dGAab@ha /* 0x80CD67E4@ha */
/* 80CCE49C  38 03 67 E4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CD67E4@l */
/* 80CCE4A0  90 1E 10 A8 */	stw r0, 0x10a8(r30)
lbl_80CCE4A4:
/* 80CCE4A4  38 7E 0F 8C */	addi r3, r30, 0xf8c
/* 80CCE4A8  38 80 00 00 */	li r4, 0
/* 80CCE4AC  4B 3B 5C 39 */	bl __dt__12dCcD_GObjInfFv
lbl_80CCE4B0:
/* 80CCE4B0  34 1E 0E 50 */	addic. r0, r30, 0xe50
/* 80CCE4B4  41 82 00 84 */	beq lbl_80CCE538
/* 80CCE4B8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CCE4BC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80CCE4DC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CCE4E0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80CCE4F8  3C 60 80 CD */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CD67F0@ha */
/* 80CCE4FC  38 03 67 F0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CD67F0@l */
/* 80CCE500  90 1E 0F 88 */	stw r0, 0xf88(r30)
lbl_80CCE504:
/* 80CCE504  34 1E 0F 54 */	addic. r0, r30, 0xf54
/* 80CCE508  41 82 00 24 */	beq lbl_80CCE52C
/* 80CCE50C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CCE510  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CCE514  90 1E 0F 70 */	stw r0, 0xf70(r30)
/* 80CCE518  34 1E 0F 54 */	addic. r0, r30, 0xf54
/* 80CCE51C  41 82 00 10 */	beq lbl_80CCE52C
/* 80CCE520  3C 60 80 CD */	lis r3, __vt__8cM3dGAab@ha /* 0x80CD67E4@ha */
/* 80CCE524  38 03 67 E4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CD67E4@l */
/* 80CCE528  90 1E 0F 6C */	stw r0, 0xf6c(r30)
lbl_80CCE52C:
/* 80CCE52C  38 7E 0E 50 */	addi r3, r30, 0xe50
/* 80CCE530  38 80 00 00 */	li r4, 0
/* 80CCE534  4B 3B 5B B1 */	bl __dt__12dCcD_GObjInfFv
lbl_80CCE538:
...
/* 80CCE550  4B 60 07 ED */	bl __dl__FPv
lbl_80CCE554:
