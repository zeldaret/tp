...
/* 80CD3900  4B 68 E8 CD */	bl _savegpr_25
/* 80CD3904  7C 7C 1B 78 */	mr r28, r3
/* 80CD3908  7C 99 23 78 */	mr r25, r4
/* 80CD390C  3C 60 80 CD */	lis r3, m__21daObj_Sekizoa_Param_c@ha /* 0x80CD5CFC@ha */
/* 80CD3910  3B E3 5C FC */	addi r31, r3, m__21daObj_Sekizoa_Param_c@l /* 0x80CD5CFC@l */
/* 80CD3914  3B C0 00 00 */	li r30, 0
/* 80CD3918  3B A0 FF FF */	li r29, -1
/* 80CD391C  3B 40 00 00 */	li r26, 0
/* 80CD3920  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD3924  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD3928  3B 63 4F F8 */	addi r27, r3, 0x4ff8
/* 80CD392C  7F 63 DB 78 */	mr r3, r27
/* 80CD3930  3C A0 80 CD */	lis r5, d_a_obj_sekizoa__stringBase0@ha /* 0x80CD5E64@ha */
/* 80CD3934  38 A5 5E 64 */	addi r5, r5, d_a_obj_sekizoa__stringBase0@l /* 0x80CD5E64@l */
/* 80CD3938  38 A5 00 5F */	addi r5, r5, 0x5f
/* 80CD393C  38 C0 00 03 */	li r6, 3
/* 80CD3940  4B 37 47 AD */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80CD3958  3C A0 80 CD */	lis r5, d_a_obj_sekizoa__stringBase0@ha /* 0x80CD5E64@ha */
/* 80CD395C  38 A5 5E 64 */	addi r5, r5, d_a_obj_sekizoa__stringBase0@l /* 0x80CD5E64@l */
/* 80CD3960  38 A5 00 63 */	addi r5, r5, 0x63
/* 80CD3964  38 C0 00 03 */	li r6, 3
/* 80CD3968  4B 37 47 85 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80CD3980  4B 37 43 CD */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80CD39C4  4B 47 1D 45 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80CD3A04  4B 47 1D 05 */	bl getActorP__18daNpcT_ActorMngr_cFv
...
/* 80CD3A54  4B 47 8A AD */	bl daNpcT_getPlayerInfoFromPlayerList__FiiP4cXyzP5csXyz
/* 80CD3A58  2C 03 00 00 */	cmpwi r3, 0
/* 80CD3A5C  41 82 00 38 */	beq lbl_80CD3A94
/* 80CD3A60  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD3A64  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CD3A90  4B 37 49 35 */	bl setGoal__16dEvent_manager_cFP4cXyz
lbl_80CD3A94:
...
/* 80CD3AA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD3AA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD3AAC  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 80CD3AB0  7C 05 07 74 */	extsb r5, r0
/* 80CD3AB4  4B 36 17 FD */	bl offSwitch__10dSv_info_cFii
lbl_80CD3AB8:
/* 80CD3AB8  38 60 00 00 */	li r3, 0
/* 80CD3ABC  38 80 00 00 */	li r4, 0
/* 80CD3AC0  C0 3F 00 C0 */	lfs f1, 0xc0(r31)
/* 80CD3AC4  4B 4D 4D 49 */	bl dKy_custom_colset__FUcUcf
/* 80CD3AC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD3ACC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD3AD0  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80CD3AD4  38 00 00 00 */	li r0, 0
/* 80CD3AD8  98 03 05 6A */	stb r0, 0x56a(r3)
/* 80CD3ADC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CD3AE0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 80CD3AE4  80 63 00 00 */	lwz r3, 0(r3)
/* 80CD3AE8  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 80CD3AEC  4B 5D BD 99 */	bl subBgmStop__8Z2SeqMgrFv
/* 80CD3AF0  38 60 00 31 */	li r3, 0x31
/* 80CD3AF4  4B 47 90 39 */	bl daNpcT_offTmpBit__FUl
/* 80CD3AF8  38 00 00 00 */	li r0, 0
/* 80CD3AFC  98 1C 11 73 */	stb r0, 0x1173(r28)
/* 80CD3B00  38 00 00 01 */	li r0, 1
/* 80CD3B04  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD3B08  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CD3B34  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CD3B38  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CD3B64  4B 5D 7E 21 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80CD3B68:
...
/* 80CD3BC4  4B 68 E6 55 */	bl _restgpr_25
