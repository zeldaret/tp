...
/* 80CD2718  4B 68 FA BD */	bl _savegpr_27
/* 80CD271C  7C 7E 1B 78 */	mr r30, r3
/* 80CD2720  7C 9B 23 78 */	mr r27, r4
/* 80CD2724  3B E0 00 00 */	li r31, 0
/* 80CD2728  3B A0 FF FF */	li r29, -1
/* 80CD272C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD2730  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CD2734  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 80CD2738  7F 83 E3 78 */	mr r3, r28
/* 80CD273C  3C A0 80 CD */	lis r5, d_a_obj_sekizoa__stringBase0@ha /* 0x80CD5E64@ha */
/* 80CD2740  38 A5 5E 64 */	addi r5, r5, d_a_obj_sekizoa__stringBase0@l /* 0x80CD5E64@l */
/* 80CD2744  38 A5 00 5F */	addi r5, r5, 0x5f
/* 80CD2748  38 C0 00 03 */	li r6, 3
/* 80CD274C  4B 37 59 A1 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80CD2764  4B 37 55 E9 */	bl getIsAddvance__16dEvent_manager_cFi
...
lbl_80CD2788:
/* 80CD2788  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD278C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80CD27C4:
/* 80CD27C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD27C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CD2834  4B 47 8E 15 */	bl step__8daNpcT_cFsiiii
...
/* 80CD2854  4B 47 30 45 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80CD2858  93 BE 0B 5C */	stw r29, 0xb5c(r30)
/* 80CD285C  38 00 00 00 */	li r0, 0
/* 80CD2860  90 1E 0B 58 */	stw r0, 0xb58(r30)
/* 80CD2864  3C 60 80 CD */	lis r3, lit_5307@ha /* 0x80CD5E14@ha */
/* 80CD2868  C0 03 5E 14 */	lfs f0, lit_5307@l(r3)  /* 0x80CD5E14@l */
...
/* 80CD2894  4B 47 30 05 */	bl initialize__22daNpcT_MotionSeqMngr_cFv
/* 80CD2898  93 9E 0B 80 */	stw r28, 0xb80(r30)
/* 80CD289C  93 BE 0B 7C */	stw r29, 0xb7c(r30)
/* 80CD28A0  3C 60 80 CD */	lis r3, lit_5307@ha /* 0x80CD5E14@ha */
/* 80CD28A4  C0 03 5E 14 */	lfs f0, lit_5307@l(r3)  /* 0x80CD5E14@l */
...
lbl_80CD28B8:
/* 80CD28B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CD28BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CD28F4  4B 68 F9 2D */	bl _restgpr_27
