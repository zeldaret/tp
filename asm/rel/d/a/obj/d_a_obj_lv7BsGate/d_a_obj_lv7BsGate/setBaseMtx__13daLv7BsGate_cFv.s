...
/* 80C84944  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C84948  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C8494C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C84950  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C84954  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C84958  4B 6C 1F 90 */	b PSMTXTrans
/* 80C8495C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C84960  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C84964  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C84968  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C8496C  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C84970  4B 38 79 30 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C84974  C0 3F 05 B8 */	lfs f1, 0x5b8(r31)
/* 80C84978  3C 60 80 C8 */	lis r3, lit_3650@ha
/* 80C8497C  C0 43 52 18 */	lfs f2, lit_3650@l(r3)
/* 80C84980  FC 60 10 90 */	fmr f3, f2
/* 80C84984  4B 38 84 18 */	b transM__14mDoMtx_stack_cFfff
...
/* 80C849A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C849A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C849AC  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C849B0  38 84 00 24 */	addi r4, r4, 0x24
/* 80C849B4  4B 6C 1A FC */	b PSMTXCopy
