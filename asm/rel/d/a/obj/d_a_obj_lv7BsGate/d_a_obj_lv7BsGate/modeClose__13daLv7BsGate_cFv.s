...
/* 80C84EB8  3C 60 80 C8 */	lis r3, lit_3628@ha /* 0x80C85210@ha */
/* 80C84EBC  3B E3 52 10 */	addi r31, r3, lit_3628@l /* 0x80C85210@l */
...
/* 80C84ED4  4B 3A 81 99 */	bl dComIfGp_getReverb__Fi
...
/* 80C84EE8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C84EEC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C84F14  4B 62 75 F9 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C84F18:
/* 80C84F18  38 7E 05 B8 */	addi r3, r30, 0x5b8
/* 80C84F1C  C0 3F 00 08 */	lfs f1, 8(r31)
/* 80C84F20  C0 5F 00 20 */	lfs f2, 0x20(r31)
/* 80C84F24  3C 80 80 C8 */	lis r4, l_HIO@ha /* 0x80C8536C@ha */
/* 80C84F28  38 84 53 6C */	addi r4, r4, l_HIO@l /* 0x80C8536C@l */
/* 80C84F2C  C0 64 00 08 */	lfs f3, 8(r4)
/* 80C84F30  C0 9F 00 1C */	lfs f4, 0x1c(r31)
/* 80C84F34  4B 5E AA 49 */	bl cLib_addCalc__FPfffff
...
/* 80C84F58  4B 3A 81 15 */	bl dComIfGp_getReverb__Fi
...
/* 80C84F6C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C84F70  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C84F98  4B 62 69 ED */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C84F9C:
...
/* 80C84FB0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C84FB4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C84FB8  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C84FBC  3C 80 80 C8 */	lis r4, l_HIO@ha /* 0x80C8536C@ha */
/* 80C84FC0  38 84 53 6C */	addi r4, r4, l_HIO@l /* 0x80C8536C@l */
/* 80C84FC4  88 84 00 0C */	lbz r4, 0xc(r4)
/* 80C84FC8  38 A0 00 0F */	li r5, 0xf
/* 80C84FCC  38 C1 00 10 */	addi r6, r1, 0x10
/* 80C84FD0  4B 3E AA 55 */	bl StartShock__12dVibration_cFii4cXyz
