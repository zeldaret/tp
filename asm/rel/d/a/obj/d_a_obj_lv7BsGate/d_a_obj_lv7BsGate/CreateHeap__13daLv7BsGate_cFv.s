...
/* 80C849E8  3C 60 80 C8 */	lis r3, l_type@ha /* 0x80C85264@ha */
/* 80C849EC  38 63 52 64 */	addi r3, r3, l_type@l /* 0x80C85264@l */
/* 80C849F0  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C849F4  3C 80 80 C8 */	lis r4, l_bmdIdx@ha /* 0x80C8526C@ha */
/* 80C849F8  38 84 52 6C */	addi r4, r4, l_bmdIdx@l /* 0x80C8526C@l */
/* 80C849FC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C84A00  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C84A04  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C84A08  3C A5 00 02 */	addis r5, r5, 2
/* 80C84A0C  38 C0 00 80 */	li r6, 0x80
/* 80C84A10  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C84A14  4B 3B 78 D9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C84A24  4B 39 02 31 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
