...
/* 80C84A78  4B 3F 3B AD */	bl __ct__16dBgS_MoveBgActorFv
/* 80C84A7C  3C 60 80 C8 */	lis r3, __vt__13daLv7BsGate_c@ha /* 0x80C85314@ha */
/* 80C84A80  38 03 53 14 */	addi r0, r3, __vt__13daLv7BsGate_c@l /* 0x80C85314@l */
...
/* 80C84AAC  3C 80 80 C8 */	lis r4, l_type@ha /* 0x80C85264@ha */
/* 80C84AB0  38 84 52 64 */	addi r4, r4, l_type@l /* 0x80C85264@l */
/* 80C84AB4  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C84AB8  4B 3A 84 05 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C84AD4  3C 80 80 C8 */	lis r4, l_type@ha /* 0x80C85264@ha */
/* 80C84AD8  38 84 52 64 */	addi r4, r4, l_type@l /* 0x80C85264@l */
/* 80C84ADC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C84AE0  3C A0 80 C8 */	lis r5, l_dzbIdx@ha /* 0x80C85274@ha */
/* 80C84AE4  38 A5 52 74 */	addi r5, r5, l_dzbIdx@l /* 0x80C85274@l */
/* 80C84AE8  7C A5 00 2E */	lwzx r5, r5, r0
/* 80C84AEC  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80C84AF0  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80C84AF4  38 E0 26 00 */	li r7, 0x2600
/* 80C84AF8  39 00 00 00 */	li r8, 0
/* 80C84AFC  4B 3F 3C C1 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C84B28  4B 39 5A 51 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80C84B2C  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 80C84B30  54 04 E6 3E */	rlwinm r4, r0, 0x1c, 0x18, 0x1f
/* 80C84B34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C84B38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C84B3C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C84B40  7C 05 07 74 */	extsb r5, r0
/* 80C84B44  4B 3B 08 1D */	bl isSwitch__10dSv_info_cCFii
...
/* 80C84B58  3C 60 80 C8 */	lis r3, lit_3722@ha /* 0x80C8521C@ha */
/* 80C84B5C  C0 03 52 1C */	lfs f0, lit_3722@l(r3)  /* 0x80C8521C@l */
...
lbl_80C84B80:
/* 80C84B80  3C 60 80 C8 */	lis r3, lit_3650@ha /* 0x80C85218@ha */
/* 80C84B84  C0 03 52 18 */	lfs f0, lit_3650@l(r3)  /* 0x80C85218@l */
