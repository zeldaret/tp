...
/* 80CA55D4  4B 6B CB F9 */	bl _savegpr_25
/* 80CA55D8  7C 7B 1B 78 */	mr r27, r3
/* 80CA55DC  3C 60 80 CA */	lis r3, ccSphSrc@ha /* 0x80CA6480@ha */
/* 80CA55E0  3B E3 64 80 */	addi r31, r3, ccSphSrc@l /* 0x80CA6480@l */
...
/* 80CA55FC  4B 3D F0 5D */	bl ChkCoHit__12dCcD_GObjInfFv
/* 80CA5600  28 03 00 00 */	cmplwi r3, 0
/* 80CA5604  41 82 01 A8 */	beq lbl_80CA57AC
/* 80CA5608  7F 43 D3 78 */	mr r3, r26
/* 80CA560C  4B 3D F0 E5 */	bl GetCoHitObj__12dCcD_GObjInfFv
/* 80CA5610  4B 5B E4 39 */	bl GetAc__8cCcD_ObjFv
/* 80CA5614  7C 7E 1B 78 */	mr r30, r3
/* 80CA5618  7F 43 D3 78 */	mr r3, r26
/* 80CA561C  4B 3D F0 D5 */	bl GetCoHitObj__12dCcD_GObjInfFv
...
/* 80CA5648  4B 5C B5 BD */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80CA56DC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CA56E0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CA570C  4B 60 62 79 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80CA5730  4B 5C 22 5D */	bl cM_rndFX__Ff
...
/* 80CA5750  4B 5C 22 3D */	bl cM_rndFX__Ff
...
/* 80CA576C  4B 5C 22 21 */	bl cM_rndFX__Ff
...
lbl_80CA5784:
/* 80CA5784  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA5788  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA578C  A8 9B 06 CC */	lha r4, 0x6cc(r27)
/* 80CA5790  4B 36 6C 4D */	bl mDoMtx_YrotS__FPA4_fs
/* 80CA5794  38 9D 06 00 */	addi r4, r29, 0x600
/* 80CA5798  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA579C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA57A0  7C 85 23 78 */	mr r5, r4
/* 80CA57A4  4B 6A 15 C9 */	bl PSMTXMultVec
...
/* 80CA57FC  4B 6A 18 DD */	bl PSVECScale
...
/* 80CA5810  4B 6A 18 81 */	bl PSVECAdd
lbl_80CA5814:
...
/* 80CA5830  4B 6B C9 E9 */	bl _restgpr_25
