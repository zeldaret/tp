...
/* 80CA59CC  4B 6B C7 FD */	bl _savegpr_24
...
/* 80CA59E4  3C 60 80 CA */	lis r3, lit_3683@ha /* 0x80CA64C8@ha */
/* 80CA59E8  3B 43 64 C8 */	addi r26, r3, lit_3683@l /* 0x80CA64C8@l */
/* 80CA59EC  3C 60 80 CA */	lis r3, lit_4057@ha /* 0x80CA6540@ha */
/* 80CA59F0  3B 63 65 40 */	addi r27, r3, lit_4057@l /* 0x80CA6540@l */
/* 80CA59F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA59F8  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA59FC  48 00 00 58 */	b lbl_80CA5A54
lbl_80CA5A00:
/* 80CA5A00  38 7D 05 A0 */	addi r3, r29, 0x5a0
/* 80CA5A04  7C 78 1A 14 */	add r3, r24, r3
/* 80CA5A08  4B 36 73 5D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80CA5A0C  38 78 04 E4 */	addi r3, r24, 0x4e4
/* 80CA5A10  4B 36 75 35 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CA5A14  38 7E 06 60 */	addi r3, r30, 0x660
/* 80CA5A18  7C 78 1A 14 */	add r3, r24, r3
/* 80CA5A1C  4B 36 75 29 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CA5A20  C0 3A 00 00 */	lfs f1, 0(r26)
/* 80CA5A24  C0 5B 00 00 */	lfs f2, 0(r27)
/* 80CA5A28  FC 60 08 90 */	fmr f3, f1
/* 80CA5A2C  4B 36 73 71 */	bl transM__14mDoMtx_stack_cFfff
...
/* 80CA5A40  4B 6A 0A 71 */	bl PSMTXCopy
...
/* 80CA5A60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA5A64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA5A68  38 98 05 6C */	addi r4, r24, 0x56c
/* 80CA5A6C  4B 6A 0A 45 */	bl PSMTXCopy
/* 80CA5A70  39 61 00 30 */	addi r11, r1, 0x30
/* 80CA5A74  4B 6B C7 A1 */	bl _restgpr_24
