...
/* 80C68CC8  3C 80 80 C7 */	lis r4, l_arcName@ha /* 0x80C69990@ha */
/* 80C68CCC  38 84 99 90 */	addi r4, r4, l_arcName@l /* 0x80C69990@l */
/* 80C68CD0  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C68CD4  4B 3C 41 E9 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C68D08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C68D0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C68D10  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C68D14  7C 05 07 74 */	extsb r5, r0
/* 80C68D18  4B 3C C6 49 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C68D48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C68D4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C68D50  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C68D54  7C 05 07 74 */	extsb r5, r0
/* 80C68D58  4B 3C C6 09 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C68D80  3C 80 80 C7 */	lis r4, l_arcName@ha /* 0x80C69990@ha */
/* 80C68D84  38 84 99 90 */	addi r4, r4, l_arcName@l /* 0x80C69990@l */
/* 80C68D88  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C68D8C  3C A0 80 C7 */	lis r5, l_dzbidx@ha /* 0x80C698E8@ha */
/* 80C68D90  38 A5 98 E8 */	addi r5, r5, l_dzbidx@l /* 0x80C698E8@l */
/* 80C68D94  7C A5 00 2E */	lwzx r5, r5, r0
/* 80C68D98  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80C68D9C  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
...
/* 80C68DAC  4B 40 FA 11 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
