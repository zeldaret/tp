...
/* 80C68E04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C68E08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C68E20  4B 6D DA C9 */	bl PSMTXTrans
/* 80C68E24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C68E28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C68E3C  4B 3A 35 F9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C68E40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C68E44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C68E48  38 9F 05 A8 */	addi r4, r31, 0x5a8
/* 80C68E4C  4B 6D D6 65 */	bl PSMTXCopy
...
/* 80C68E80  3C 60 80 C7 */	lis r3, lit_3691@ha /* 0x80C69950@ha */
/* 80C68E84  C8 23 99 50 */	lfd f1, lit_3691@l(r3)  /* 0x80C69950@l */
...
/* 80C68EA0  3C 60 80 C7 */	lis r3, lit_3688@ha /* 0x80C69948@ha */
/* 80C68EA4  C0 03 99 48 */	lfs f0, lit_3688@l(r3)  /* 0x80C69948@l */
/* 80C68EA8  EC 21 00 32 */	fmuls f1, f1, f0
/* 80C68EAC  3C 60 80 C7 */	lis r3, lit_3689@ha /* 0x80C6994C@ha */
/* 80C68EB0  C0 03 99 4C */	lfs f0, lit_3689@l(r3)  /* 0x80C6994C@l */
/* 80C68EB4  EF A0 00 72 */	fmuls f29, f0, f1
/* 80C68EB8  FC 20 E8 90 */	fmr f1, f29
/* 80C68EBC  4B 5F EA D1 */	bl cM_rndFX__Ff
/* 80C68EC0  FF C0 08 90 */	fmr f30, f1
/* 80C68EC4  FC 20 E8 90 */	fmr f1, f29
/* 80C68EC8  4B 5F EA C5 */	bl cM_rndFX__Ff
/* 80C68ECC  FF E0 08 90 */	fmr f31, f1
/* 80C68ED0  FC 20 E8 90 */	fmr f1, f29
/* 80C68ED4  4B 5F EA B9 */	bl cM_rndFX__Ff
/* 80C68ED8  FC 40 F8 90 */	fmr f2, f31
/* 80C68EDC  FC 60 F0 90 */	fmr f3, f30
/* 80C68EE0  4B 3A 3E BD */	bl transM__14mDoMtx_stack_cFfff
lbl_80C68EE4:
/* 80C68EE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C68EE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C68EEC  38 9F 05 D8 */	addi r4, r31, 0x5d8
/* 80C68EF0  4B 6D D5 C1 */	bl PSMTXCopy
