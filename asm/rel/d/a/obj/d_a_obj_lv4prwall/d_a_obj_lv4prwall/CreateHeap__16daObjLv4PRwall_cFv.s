...
/* 80C68F3C  3C 60 80 C7 */	lis r3, l_arcName@ha /* 0x80C69990@ha */
/* 80C68F40  38 63 99 90 */	addi r3, r3, l_arcName@l /* 0x80C69990@l */
/* 80C68F44  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C68F48  3C 80 80 C7 */	lis r4, l_bmdidx@ha /* 0x80C698F4@ha */
/* 80C68F4C  38 84 98 F4 */	addi r4, r4, l_bmdidx@l /* 0x80C698F4@l */
/* 80C68F50  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C68F54  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C68F58  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C68F5C  3C A5 00 02 */	addis r5, r5, 2
/* 80C68F60  38 C0 00 80 */	li r6, 0x80
/* 80C68F64  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C68F68  4B 3D 33 85 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C68F78  4B 3A BC DD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
