...
/* 80C26DC4  4B 73 B4 19 */	bl _savegpr_29
/* 80C26DC8  3C 80 80 C2 */	lis r4, lit_3668@ha /* 0x80C274F0@ha */
/* 80C26DCC  3B E4 74 F0 */	addi r31, r4, lit_3668@l /* 0x80C274F0@l */
...
/* 80C26DEC  4B 45 18 39 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C26DF0  3C 60 80 C2 */	lis r3, __vt__12daObjIkada_c@ha /* 0x80C275FC@ha */
/* 80C26DF4  38 03 75 FC */	addi r0, r3, __vt__12daObjIkada_c@l /* 0x80C275FC@l */
/* 80C26DF8  90 1D 05 9C */	stw r0, 0x59c(r29)
/* 80C26DFC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C26E00  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C26E04  90 1D 05 FC */	stw r0, 0x5fc(r29)
/* 80C26E08  38 7D 06 00 */	addi r3, r29, 0x600
/* 80C26E0C  4B 45 C9 55 */	bl __ct__10dCcD_GSttsFv
/* 80C26E10  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C26E14  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C26E28  4B 44 F0 85 */	bl __ct__12dBgS_AcchCirFv
/* 80C26E2C  3B BD 06 6C */	addi r29, r29, 0x66c
/* 80C26E30  7F A3 EB 78 */	mr r3, r29
/* 80C26E34  4B 44 F2 6D */	bl __ct__9dBgS_AcchFv
/* 80C26E38  3C 60 80 C2 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80C275D8@ha */
/* 80C26E3C  38 63 75 D8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80C275D8@l */
...
/* 80C26E58  4B 45 20 11 */	bl SetObj__16dBgS_PolyPassChkFv
lbl_80C26E5C:
...
/* 80C26E6C  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C27584@ha */
/* 80C26E70  38 84 75 84 */	addi r4, r4, l_arcName@l /* 0x80C27584@l */
/* 80C26E74  80 84 00 00 */	lwz r4, 0(r4)
/* 80C26E78  4B 40 60 45 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 80C26E7C  7C 7D 1B 78 */	mr r29, r3
/* 80C26E80  2C 1D 00 04 */	cmpwi r29, 4
/* 80C26E84  40 82 00 68 */	bne lbl_80C26EEC
/* 80C26E88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C26E8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C26E90  3C 63 00 02 */	addis r3, r3, 2
/* 80C26E94  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C27584@ha */
/* 80C26E98  38 84 75 84 */	addi r4, r4, l_arcName@l /* 0x80C27584@l */
/* 80C26E9C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C26EA0  3C A0 80 C2 */	lis r5, d_a_obj_ikada__stringBase0@ha /* 0x80C27564@ha */
/* 80C26EA4  38 A5 75 64 */	addi r5, r5, d_a_obj_ikada__stringBase0@l /* 0x80C27564@l */
/* 80C26EA8  38 A5 00 08 */	addi r5, r5, 8
/* 80C26EAC  38 63 C2 F8 */	addi r3, r3, -15624
/* 80C26EB0  4B 41 58 09 */	bl getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80C26EB4  7C 65 1B 78 */	mr r5, r3
/* 80C26EB8  7F C3 F3 78 */	mr r3, r30
/* 80C26EBC  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C27584@ha */
/* 80C26EC0  38 84 75 84 */	addi r4, r4, l_arcName@l /* 0x80C27584@l */
/* 80C26EC4  80 84 00 00 */	lwz r4, 0(r4)
/* 80C26EC8  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80C26ECC  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80C26ED0  38 E0 0C 00 */	li r7, 0xc00
/* 80C26ED4  39 00 00 00 */	li r8, 0
/* 80C26ED8  4B 45 18 E5 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C26F14  4B 44 F3 35 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80C26F18  38 7E 06 2C */	addi r3, r30, 0x62c
/* 80C26F1C  C0 3F 00 34 */	lfs f1, 0x34(r31)
/* 80C26F20  C0 5F 00 40 */	lfs f2, 0x40(r31)
/* 80C26F24  4B 44 F0 35 */	bl SetWall__12dBgS_AcchCirFff
/* 80C26F28  C0 3F 00 44 */	lfs f1, 0x44(r31)
/* 80C26F2C  4B 64 0A 61 */	bl cM_rndFX__Ff
...
/* 80C26F5C  4B 3F 35 ED */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80C26F84  4B 3F 6E 01 */	bl waterCheck__11fopAcM_wt_cFPC4cXyz
/* 80C26F88  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C26F8C  41 82 00 10 */	beq lbl_80C26F9C
/* 80C26F90  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha /* 0x80450CD8@ha */
/* 80C26F94  C0 03 0C D8 */	lfs f0, mWaterY__11fopAcM_wt_c@l(r3)  /* 0x80450CD8@l */
/* 80C26F98  D0 1E 04 D4 */	stfs f0, 0x4d4(r30)
lbl_80C26F9C:
/* 80C26F9C  7F A3 EB 78 */	mr r3, r29
/* 80C26FA0  39 61 00 40 */	addi r11, r1, 0x40
/* 80C26FA4  4B 73 B2 85 */	bl _restgpr_29
