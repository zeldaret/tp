...
/* 80C8322C  4B 6D EF B1 */	bl _savegpr_29
/* 80C83230  7C 7D 1B 78 */	mr r29, r3
/* 80C83234  7C 9E 23 78 */	mr r30, r4
/* 80C83238  3C 60 80 C8 */	lis r3, searchObjLv6SwTurn__FPvPv@ha /* 0x80C82FA4@ha */
/* 80C8323C  38 63 2F A4 */	addi r3, r3, searchObjLv6SwTurn__FPvPv@l /* 0x80C82FA4@l */
/* 80C83240  7F A4 EB 78 */	mr r4, r29
/* 80C83244  4B 39 65 B5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C83288  4B 6C 32 29 */	bl PSMTXCopy
...
/* 80C832A0  4B 3C 55 CD */	bl eventUpdate__17dEvLib_callback_cFv
...
/* 80C832B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C832B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C832BC  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 80C832C0  7C 05 07 74 */	extsb r5, r0
/* 80C832C4  4B 3B 20 9D */	bl isSwitch__10dSv_info_cCFii
...
/* 80C832F8  4B 3C 56 49 */	bl orderEvent__17dEvLib_callback_cFiii
...
/* 80C83314  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C83318  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C8331C  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 80C83320  7C 05 07 74 */	extsb r5, r0
/* 80C83324  4B 3B 20 3D */	bl isSwitch__10dSv_info_cCFii
...
/* 80C83358  4B 3C 55 E9 */	bl orderEvent__17dEvLib_callback_cFiii
...
/* 80C83394  4B 3C 55 AD */	bl orderEvent__17dEvLib_callback_cFiii
...
/* 80C834B8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C834BC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C834D4  3D 00 80 C8 */	lis r8, lit_3755@ha /* 0x80C83834@ha */
/* 80C834D8  C0 28 38 34 */	lfs f1, lit_3755@l(r8)  /* 0x80C83834@l */
/* 80C834DC  FC 40 08 90 */	fmr f2, f1
/* 80C834E0  3D 00 80 C8 */	lis r8, lit_3756@ha /* 0x80C83838@ha */
/* 80C834E4  C0 68 38 38 */	lfs f3, lit_3756@l(r8)  /* 0x80C83838@l */
/* 80C834E8  FC 80 18 90 */	fmr f4, f3
/* 80C834EC  39 00 00 00 */	li r8, 0
/* 80C834F0  4B 62 84 95 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C83510  4B 6C 2F A1 */	bl PSMTXCopy
...
/* 80C83524  4B 6D ED 05 */	bl _restgpr_29
