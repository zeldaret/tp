...
/* 80BDF6F4  4B 6D E9 05 */	bl deleteObject__14Z2SoundObjBaseFv
/* 80BDF6F8  80 7F 05 E8 */	lwz r3, 0x5e8(r31)
/* 80BDF6FC  28 03 00 00 */	cmplwi r3, 0
/* 80BDF700  41 82 00 24 */	beq lbl_80BDF724
/* 80BDF704  4B 68 8A D1 */	bl ChkUsed__9cBgW_BgIdCFv
/* 80BDF708  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BDF70C  41 82 00 18 */	beq lbl_80BDF724
/* 80BDF710  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BDF714  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BDF718  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80BDF71C  80 9F 05 E8 */	lwz r4, 0x5e8(r31)
/* 80BDF720  4B 49 4B 31 */	bl Release__4cBgSFP9dBgW_Base
lbl_80BDF724:
/* 80BDF724  38 7F 05 A0 */	addi r3, r31, 0x5a0
/* 80BDF728  3C 80 80 BE */	lis r4, l_el_arcName@ha /* 0x80BDF964@ha */
/* 80BDF72C  38 84 F9 64 */	addi r4, r4, l_el_arcName@l /* 0x80BDF964@l */
/* 80BDF730  80 84 00 00 */	lwz r4, 0(r4)
/* 80BDF734  4B 44 D8 D5 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80BDF738  38 7F 05 A8 */	addi r3, r31, 0x5a8
/* 80BDF73C  3C 80 80 BE */	lis r4, l_sw_arcName@ha /* 0x80BDF968@ha */
/* 80BDF740  38 84 F9 68 */	addi r4, r4, l_sw_arcName@l /* 0x80BDF968@l */
/* 80BDF744  80 84 00 00 */	lwz r4, 0(r4)
/* 80BDF748  4B 44 D8 C1 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
