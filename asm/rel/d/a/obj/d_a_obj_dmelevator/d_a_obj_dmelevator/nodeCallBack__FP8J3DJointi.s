...
/* 80BDDCB0  4B 78 45 29 */	bl _savegpr_28
/* 80BDDCB4  2C 04 00 00 */	cmpwi r4, 0
/* 80BDDCB8  40 82 00 64 */	bne lbl_80BDDD1C
/* 80BDDCBC  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 80BDDCC0  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BDDCC4  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BDDCE0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BDDCE4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BDDCE8  4B 76 87 C9 */	bl PSMTXCopy
/* 80BDDCEC  2C 1F 00 02 */	cmpwi r31, 2
/* 80BDDCF0  40 82 00 14 */	bne lbl_80BDDD04
/* 80BDDCF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BDDCF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BDDCFC  A8 9C 05 E4 */	lha r4, 0x5e4(r28)
/* 80BDDD00  4B 42 E6 9D */	bl mDoMtx_XrotM__FPA4_fs
lbl_80BDDD04:
/* 80BDDD04  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 80BDDD08  80 03 00 0C */	lwz r0, 0xc(r3)
/* 80BDDD0C  7C 80 EA 14 */	add r4, r0, r29
/* 80BDDD10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BDDD14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BDDD18  4B 76 87 99 */	bl PSMTXCopy
lbl_80BDDD1C:
/* 80BDDD1C  38 60 00 01 */	li r3, 1
/* 80BDDD20  39 61 00 20 */	addi r11, r1, 0x20
/* 80BDDD24  4B 78 45 01 */	bl _restgpr_28
