...
/* 80BDDF0C  4B 78 42 CD */	bl _savegpr_28
/* 80BDDF10  7C 7D 1B 78 */	mr r29, r3
/* 80BDDF14  3C 80 80 BE */	lis r4, cNullVec__6Z2Calc@ha /* 0x80BDF944@ha */
/* 80BDDF18  3B E4 F9 44 */	addi r31, r4, cNullVec__6Z2Calc@l /* 0x80BDF944@l */
/* 80BDDF1C  3C 80 80 BE */	lis r4, l_swOffset@ha /* 0x80BDF870@ha */
/* 80BDDF20  3B 84 F8 70 */	addi r28, r4, l_swOffset@l /* 0x80BDF870@l */
...
lbl_80BDDF50:
/* 80BDDF50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BDDF54  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BDDF68  4B 49 6A A1 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80BDDFAC  4B 43 C5 9D */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80BDDFC0  3C 60 80 BE */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x80BDDCA0@ha */
/* 80BDDFC4  38 03 DC A0 */	addi r0, r3, nodeCallBack__FP8J3DJointi@l /* 0x80BDDCA0@l */
...
/* 80BDDFE4  3C 60 80 BE */	lis r3, nodeCallBackForSw__FP8J3DJointi@ha /* 0x80BDDBF0@ha */
/* 80BDDFE8  38 03 DB F0 */	addi r0, r3, nodeCallBackForSw__FP8J3DJointi@l /* 0x80BDDBF0@l */
/* 80BDDFEC  90 04 00 04 */	stw r0, 4(r4)
/* 80BDDFF0  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 80BDDFF4  93 A3 00 14 */	stw r29, 0x14(r3)
/* 80BDDFF8  3C 60 80 BE */	lis r3, rideCallBack__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 0x80BDD96C@ha */
/* 80BDDFFC  38 03 D9 6C */	addi r0, r3, rideCallBack__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 0x80BDD96C@l */
/* 80BDE000  80 7D 05 E8 */	lwz r3, 0x5e8(r29)
/* 80BDE004  90 03 00 B4 */	stw r0, 0xb4(r3)
/* 80BDE008  80 7D 05 E8 */	lwz r3, 0x5e8(r29)
/* 80BDE00C  4B 49 D9 B5 */	bl Move__4dBgWFv
...
/* 80BDE020  3C 80 80 BE */	lis r4, d_a_obj_dmelevator__stringBase0@ha /* 0x80BDF8EC@ha */
/* 80BDE024  38 84 F8 EC */	addi r4, r4, d_a_obj_dmelevator__stringBase0@l /* 0x80BDF8EC@l */
/* 80BDE028  38 84 00 36 */	addi r4, r4, 0x36
/* 80BDE02C  4B 78 A9 69 */	bl strcmp
...
/* 80BDE048  4B 46 97 11 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
/* 80BDE04C  B0 7D 05 E6 */	sth r3, 0x5e6(r29)
/* 80BDE050  48 00 00 38 */	b lbl_80BDE088
lbl_80BDE054:
/* 80BDE054  7F 83 E3 78 */	mr r3, r28
/* 80BDE058  3C 80 80 BE */	lis r4, d_a_obj_dmelevator__stringBase0@ha /* 0x80BDF8EC@ha */
/* 80BDE05C  38 84 F8 EC */	addi r4, r4, d_a_obj_dmelevator__stringBase0@l /* 0x80BDF8EC@l */
/* 80BDE060  38 84 00 3E */	addi r4, r4, 0x3e
/* 80BDE064  4B 78 A9 31 */	bl strcmp
...
/* 80BDE080  4B 46 96 D9 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
/* 80BDE084  B0 7D 05 E6 */	sth r3, 0x5e6(r29)
lbl_80BDE088:
/* 80BDE088  38 60 00 01 */	li r3, 1
lbl_80BDE08C:
/* 80BDE08C  39 61 00 20 */	addi r11, r1, 0x20
/* 80BDE090  4B 78 41 95 */	bl _restgpr_28
