...
/* 80594C08  4B DC D5 D5 */	bl _savegpr_29
...
/* 80594C28  4B A8 3F 3D */	bl __ct__10fopAc_ac_cFv
/* 80594C2C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80594C30  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80594C34  90 1E 05 BC */	stw r0, 0x5bc(r30)
/* 80594C38  38 7E 05 C0 */	addi r3, r30, 0x5c0
/* 80594C3C  4B AE EB 25 */	bl __ct__10dCcD_GSttsFv
/* 80594C40  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80594C44  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80594C5C  4B AE ED CD */	bl __ct__12dCcD_GObjInfFv
/* 80594C60  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80594C64  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80594C68  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80594C6C  3C 60 80 59 */	lis r3, __vt__8cM3dGAab@ha /* 0x80594F94@ha */
/* 80594C70  38 03 4F 94 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80594F94@l */
/* 80594C74  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80594C78  3C 60 80 59 */	lis r3, __vt__8cM3dGSph@ha /* 0x80594FA0@ha */
/* 80594C7C  38 03 4F A0 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80594FA0@l */
/* 80594C80  90 1D 01 34 */	stw r0, 0x134(r29)
/* 80594C84  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80594C88  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 80594C8C  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80594C90  38 03 00 58 */	addi r0, r3, 0x58
/* 80594C94  90 1D 01 34 */	stw r0, 0x134(r29)
/* 80594C98  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80594C9C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80594CB8  4B CB 52 49 */	bl __ct__10dMsgFlow_cFv
lbl_80594CBC:
...
/* 80594CCC  3C 80 80 59 */	lis r4, l_arcName@ha /* 0x80594F28@ha */
/* 80594CD0  38 84 4F 28 */	addi r4, r4, l_arcName@l /* 0x80594F28@l */
/* 80594CD4  80 84 00 00 */	lwz r4, 0(r4)
/* 80594CD8  4B A9 81 E5 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80594CEC  3C 80 80 59 */	lis r4, createSolidHeap__FP10fopAc_ac_c@ha /* 0x80594950@ha */
/* 80594CF0  38 84 49 50 */	addi r4, r4, createSolidHeap__FP10fopAc_ac_c@l /* 0x80594950@l */
/* 80594CF4  38 A0 08 00 */	li r5, 0x800
/* 80594CF8  4B A8 57 B9 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80594D24  4B DC D5 05 */	bl _restgpr_29
