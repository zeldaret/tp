...
/* 8046EACC  4B EF 37 0D */	bl _savegpr_28
/* 8046EAD0  7C 7E 1B 78 */	mr r30, r3
/* 8046EAD4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8046EAD8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8046EADC  38 80 00 10 */	li r4, 0x10
/* 8046EAE0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 8046EAE4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 8046EAE8  4B D3 4C DD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8046EAEC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8046EAF0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8046EAF4  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 8046EAF8  80 84 00 04 */	lwz r4, 4(r4)
/* 8046EAFC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8046EB00  4B D3 62 A1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8046EB04  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8046EB08  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8046EB0C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 8046EB10  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8046EB14  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8046EB88  4B B9 F1 3D */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8046EBDC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8046EBE0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8046EBFC  4B EF 36 29 */	bl _restgpr_28
