...
/* 80D0D50C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D0D510  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D0D524  4B 55 96 11 */	bl __mi__4cXyzCFRC3Vec
...
/* 80D0D540  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D0D544  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D0D548  A8 1F 04 DE */	lha r0, 0x4de(r31)
/* 80D0D54C  7C 00 00 D0 */	neg r0, r0
/* 80D0D550  7C 04 07 34 */	extsh r4, r0
/* 80D0D554  4B 2F EE 89 */	bl mDoMtx_YrotS__FPA4_fs
/* 80D0D558  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D0D55C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D0D560  38 81 00 14 */	addi r4, r1, 0x14
/* 80D0D564  7C 85 23 78 */	mr r5, r4
/* 80D0D568  4B 63 98 05 */	bl PSMTXMultVec
/* 80D0D56C  38 60 00 01 */	li r3, 1
/* 80D0D570  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80D0D574  3C 80 80 D1 */	lis r4, lit_3663@ha /* 0x80D0E5F8@ha */
/* 80D0D578  C0 04 E5 F8 */	lfs f0, lit_3663@l(r4)  /* 0x80D0E5F8@l */
