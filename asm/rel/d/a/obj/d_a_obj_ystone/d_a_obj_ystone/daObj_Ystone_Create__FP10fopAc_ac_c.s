...
/* 80D3EAAC  4B 2D A0 B8 */	b __ct__10fopAc_ac_cFv
lbl_80D3EAB0:
...
/* 80D3EAD4  3C 80 80 D4 */	lis r4, l_arcName@ha
/* 80D3EAD8  38 84 EC BC */	addi r4, r4, l_arcName@l
/* 80D3EADC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80D3EAE0  4B 2E E3 DC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80D3EB00  3C 80 80 D4 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80D3EB04  38 84 E7 B8 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80D3EB08  38 A0 10 00 */	li r5, 0x1000
/* 80D3EB0C  4B 2D B9 A4 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80D3EB24  3C 80 80 D4 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80D3EB28  38 84 E7 B8 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80D3EB2C  38 A0 33 A0 */	li r5, 0x33a0
/* 80D3EB30  4B 2D B9 80 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80D3EB70:
/* 80D3EB70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D3EB74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D3EB78  3C 80 80 D4 */	lis r4, lit_3968@ha
/* 80D3EB7C  C0 24 EC 54 */	lfs f1, lit_3968@l(r4)
/* 80D3EB80  FC 40 08 90 */	fmr f2, f1
/* 80D3EB84  FC 60 08 90 */	fmr f3, f1
/* 80D3EB88  4B 60 7D E0 */	b PSMTXScale
/* 80D3EB8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D3EB90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D3EB94  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80D3EB98  38 84 00 24 */	addi r4, r4, 0x24
/* 80D3EB9C  4B 60 79 14 */	b PSMTXCopy
...
lbl_80D3EBD4:
/* 80D3EBD4  3C 60 80 D4 */	lis r3, lit_3967@ha
/* 80D3EBD8  C0 03 EC 50 */	lfs f0, lit_3967@l(r3)
