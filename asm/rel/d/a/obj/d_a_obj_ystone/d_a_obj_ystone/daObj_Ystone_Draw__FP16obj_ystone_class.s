...
/* 80D3E0A8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D3E0AC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80D3E0B0  38 80 00 00 */	li r4, 0
/* 80D3E0B4  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80D3E0B8  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80D3E0BC  4B 46 57 08 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 80D3E0D8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D3E0DC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80D3E0E0  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80D3E0E4  80 84 00 04 */	lwz r4, 4(r4)
/* 80D3E0E8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80D3E0EC  4B 46 6C B4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80D3E104  4B 2C F6 A4 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80D3E108  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80D3E10C  4B 2C FB B8 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80D3E110  48 00 00 54 */	b lbl_80D3E164
lbl_80D3E114:
/* 80D3E114  80 7E 05 7C */	lwz r3, 0x57c(r30)
/* 80D3E118  83 E3 00 04 */	lwz r31, 4(r3)
/* 80D3E11C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D3E120  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80D3E124  80 9F 00 04 */	lwz r4, 4(r31)
/* 80D3E128  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80D3E12C  4B 46 6C 74 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80D3E14C  4B 2C F5 8C */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80D3E150:
/* 80D3E150  7F C3 F3 78 */	mr r3, r30
/* 80D3E154  80 9F 00 04 */	lwz r4, 4(r31)
/* 80D3E158  4B 2D F2 D4 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 80D3E15C  80 7E 05 7C */	lwz r3, 0x57c(r30)
/* 80D3E160  4B 2D 30 60 */	b entryDL__16mDoExt_McaMorfSOFv
lbl_80D3E164:
