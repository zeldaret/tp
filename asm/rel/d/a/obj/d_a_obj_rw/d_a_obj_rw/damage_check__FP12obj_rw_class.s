...
/* 80CC2BB4  4B 69 F6 19 */	bl _savegpr_25
/* 80CC2BB8  7C 7E 1B 78 */	mr r30, r3
/* 80CC2BBC  3C 60 80 CC */	lis r3, lit_3649@ha /* 0x80CC3AF4@ha */
/* 80CC2BC0  3B E3 3A F4 */	addi r31, r3, lit_3649@l /* 0x80CC3AF4@l */
/* 80CC2BC4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC2BC8  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC2BCC  83 5C 5D AC */	lwz r26, 0x5dac(r28)
/* 80CC2BD0  38 7E 06 94 */	addi r3, r30, 0x694
/* 80CC2BD4  4B 3C 0C 5D */	bl Move__10dCcD_GSttsFv
...
/* 80CC2C70  4B 35 7A A1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80CC2CA8  4B 5A 4C AD */	bl cM_rndF__Ff
/* 80CC2CAC  C0 1F 00 18 */	lfs f0, 0x18(r31)
/* 80CC2CB0  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80CC2CB4  40 80 00 68 */	bge lbl_80CC2D1C
/* 80CC2CB8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80CC2CBC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80CC2CC0  80 63 00 00 */	lwz r3, 0(r3)
/* 80CC2CC4  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CC2CC8  4B 34 97 15 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80CC2D18  4B 35 95 29 */	bl fopAcM_createItem__FPC4cXyziiiPC5csXyzPC4cXyzi
lbl_80CC2D1C:
...
/* 80CC2D70  4B 35 9D 69 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
...
/* 80CC2DA8  4B 35 93 2D */	bl fopAcM_createItemForBoss__FPC4cXyziiPC5csXyzPC4cXyzffi
...
/* 80CC2DBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC2DC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC2DC4  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80CC2DC8  7C 05 07 74 */	extsb r5, r0
/* 80CC2DCC  4B 37 24 35 */	bl onSwitch__10dSv_info_cFii
...
/* 80CC2DF8  4B 3C 16 69 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 80CC2E20  4B 37 4A E1 */	bl HitSeStart__5daObjFPC4cXyziPC12dCcD_GObjInfUl
...
/* 80CC2E4C  4B 69 F3 CD */	bl _restgpr_25
