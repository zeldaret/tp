...
/* 80CA119C  4B 6C 10 3D */	bl _savegpr_28
/* 80CA11A0  7C 7C 1B 78 */	mr r28, r3
/* 80CA11A4  3C 80 80 CA */	lis r4, cNullVec__6Z2Calc@ha /* 0x80CA32B0@ha */
/* 80CA11A8  3B C4 32 B0 */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x80CA32B0@l */
/* 80CA11AC  3C 80 80 CA */	lis r4, lit_3774@ha /* 0x80CA31BC@ha */
/* 80CA11B0  3B E4 31 BC */	addi r31, r4, lit_3774@l /* 0x80CA31BC@l */
...
/* 80CA11CC  4B 5C 67 89 */	bl cM_rndF__Ff
...
/* 80CA12AC  4B 5C F4 95 */	bl cLib_chaseF__FPfff
...
/* 80CA12D0  4B 3D 69 99 */	bl __ct__11dBgS_LinChkFv
/* 80CA12D4  38 61 00 BC */	addi r3, r1, 0xbc
/* 80CA12D8  4B 3D 69 91 */	bl __ct__11dBgS_LinChkFv
...
/* 80CA1314  4B 36 BA 51 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80CA1318  38 7C 07 D4 */	addi r3, r28, 0x7d4
/* 80CA131C  4B 36 BC 29 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CA1320  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA1324  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA1328  A8 9C 04 DE */	lha r4, 0x4de(r28)
/* 80CA132C  4B 36 B1 09 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CA1330  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA1334  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA1338  38 81 00 88 */	addi r4, r1, 0x88
/* 80CA133C  7C 85 23 78 */	mr r5, r4
/* 80CA1340  4B 6A 5A 2D */	bl PSMTXMultVec
/* 80CA1344  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA1348  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA134C  38 81 00 7C */	addi r4, r1, 0x7c
/* 80CA1350  7C 85 23 78 */	mr r5, r4
/* 80CA1354  4B 6A 5A 19 */	bl PSMTXMultVec
/* 80CA1358  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA135C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA1360  38 81 00 70 */	addi r4, r1, 0x70
/* 80CA1364  7C 85 23 78 */	mr r5, r4
/* 80CA1368  4B 6A 5A 05 */	bl PSMTXMultVec
/* 80CA136C  38 61 01 84 */	addi r3, r1, 0x184
/* 80CA1370  4B 3D 7A F9 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80CA1374  38 61 01 14 */	addi r3, r1, 0x114
/* 80CA1378  4B 3D 7A F1 */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80CA138C  4B 3D 69 D9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 80CA13A0  4B 3D 69 C5 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80CA13A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA13A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CA13AC  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80CA13B0  7F A3 EB 78 */	mr r3, r29
/* 80CA13B4  38 81 01 2C */	addi r4, r1, 0x12c
/* 80CA13B8  4B 3D 2F FD */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80CA13BC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CA13C0  41 82 02 6C */	beq lbl_80CA162C
/* 80CA13C4  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha /* 0x80CA3468@ha */
/* 80CA13C8  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CA3468@l */
...
/* 80CA13DC  4B 3D 33 69 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CA140C  4B 6A 5F 91 */	bl PSVECSquareDistance
...
/* 80CA147C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CA1480  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CA14EC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CA14F0  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CA1540  4B 3D 2E 75 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80CA1544  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CA1548  41 82 00 D4 */	beq lbl_80CA161C
/* 80CA154C  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha /* 0x80CA3468@ha */
/* 80CA1550  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CA3468@l */
...
/* 80CA1564  4B 3D 31 E1 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CA15F0  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha /* 0x80CA3468@ha */
/* 80CA15F4  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CA3468@l */
...
/* 80CA1608  4B 3D 66 D5 */	bl __dt__11dBgS_LinChkFv
/* 80CA160C  38 61 01 2C */	addi r3, r1, 0x12c
/* 80CA1610  38 80 FF FF */	li r4, -1
/* 80CA1614  4B 3D 66 C9 */	bl __dt__11dBgS_LinChkFv
/* 80CA1618  48 00 02 CC */	b lbl_80CA18E4
lbl_80CA161C:
/* 80CA161C  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha /* 0x80CA3468@ha */
/* 80CA1620  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CA3468@l */
...
/* 80CA1648  4B 5C 63 45 */	bl cM_rndFX__Ff
...
/* 80CA16B0  4B 3D 66 2D */	bl __dt__11dBgS_LinChkFv
/* 80CA16B4  38 61 01 2C */	addi r3, r1, 0x12c
/* 80CA16B8  38 80 FF FF */	li r4, -1
/* 80CA16BC  4B 3D 66 21 */	bl __dt__11dBgS_LinChkFv
...
/* 80CA16D4  4B 5C 62 B9 */	bl cM_rndFX__Ff
...
/* 80CA1714  4B 3D 65 C9 */	bl __dt__11dBgS_LinChkFv
/* 80CA1718  38 61 01 2C */	addi r3, r1, 0x12c
/* 80CA171C  38 80 FF FF */	li r4, -1
/* 80CA1720  4B 3D 65 BD */	bl __dt__11dBgS_LinChkFv
...
/* 80CA173C  4B 6A 5C 61 */	bl PSVECSquareDistance
...
/* 80CA17AC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CA17B0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CA181C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CA1820  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80CA1824:
...
/* 80CA183C  4B 5C 52 F9 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CA185C  4B 5C 61 31 */	bl cM_rndFX__Ff
...
/* 80CA1870  4B 5C 61 1D */	bl cM_rndFX__Ff
...
/* 80CA1884  4B 5C 5D F1 */	bl cM_atan2s__Fff
