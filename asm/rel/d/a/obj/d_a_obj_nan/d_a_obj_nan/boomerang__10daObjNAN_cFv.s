...
/* 80CA1F78  4B 6C 02 65 */	bl _savegpr_29
/* 80CA1F7C  7C 7F 1B 78 */	mr r31, r3
/* 80CA1F80  3C 80 80 CA */	lis r4, lit_3774@ha /* 0x80CA31BC@ha */
/* 80CA1F84  3B C4 31 BC */	addi r30, r4, lit_3774@l /* 0x80CA31BC@l */
...
/* 80CA1FA0  4B 3E 25 A9 */	bl GetTgHitGObj__12dCcD_GObjInfFv
/* 80CA1FA4  38 7F 07 A8 */	addi r3, r31, 0x7a8
/* 80CA1FA8  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80CA1FAC  4B 4B C6 05 */	bl initOffset__20daPy_boomerangMove_cFPC4cXyz
...
/* 80CA2030  4B 4B C6 25 */	bl posMove__20daPy_boomerangMove_cFP4cXyzPsP10fopAc_ac_cs
/* 80CA2034  2C 03 00 00 */	cmpwi r3, 0
/* 80CA2038  40 82 03 04 */	bne lbl_80CA233C
/* 80CA203C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA2040  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CA2044  83 A3 5D AC */	lwz r29, 0x5dac(r3)
/* 80CA2048  38 61 00 68 */	addi r3, r1, 0x68
/* 80CA204C  4B 3D 5C 1D */	bl __ct__11dBgS_LinChkFv
...
/* 80CA208C  4B 36 AC D9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80CA2090  C0 3E 00 74 */	lfs f1, 0x74(r30)
/* 80CA2094  4B 5C 58 F9 */	bl cM_rndFX__Ff
/* 80CA2098  FC 00 08 1E */	fctiwz f0, f1
/* 80CA209C  D8 01 00 D8 */	stfd f0, 0xd8(r1)
/* 80CA20A0  80 81 00 DC */	lwz r4, 0xdc(r1)
/* 80CA20A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA20A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA20AC  4B 36 A3 89 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CA20B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA20B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA20B8  38 81 00 3C */	addi r4, r1, 0x3c
/* 80CA20BC  7C 85 23 78 */	mr r5, r4
/* 80CA20C0  4B 6A 4C AD */	bl PSMTXMultVec
/* 80CA20C4  38 61 00 C0 */	addi r3, r1, 0xc0
/* 80CA20C8  4B 3D 6D A1 */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80CA20DC  4B 3D 5C 89 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80CA20E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA20E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CA20E8  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80CA20EC  7F A3 EB 78 */	mr r3, r29
/* 80CA20F0  38 81 00 68 */	addi r4, r1, 0x68
/* 80CA20F4  4B 3D 22 C1 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80CA20F8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CA20FC  41 82 01 D4 */	beq lbl_80CA22D0
/* 80CA2100  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha /* 0x80CA3468@ha */
/* 80CA2104  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CA3468@l */
...
/* 80CA2118  4B 3D 26 2D */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CA2148  4B 6A 52 55 */	bl PSVECSquareDistance
...
/* 80CA21B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CA21BC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CA2228  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CA222C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CA2270  4B 5C 54 05 */	bl cM_atan2s__Fff
...
/* 80CA2284  4B 5C 53 F1 */	bl cM_atan2s__Fff
/* 80CA2288  7C 03 00 D0 */	neg r0, r3
/* 80CA228C  B0 1F 07 DE */	sth r0, 0x7de(r31)
/* 80CA2290  B0 1F 07 D8 */	sth r0, 0x7d8(r31)
/* 80CA2294  3C 60 80 CA */	lis r3, lit_4509@ha /* 0x80CA337C@ha */
/* 80CA2298  38 83 33 7C */	addi r4, r3, lit_4509@l /* 0x80CA337C@l */
...
/* 80CA22C0  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha /* 0x80CA3468@ha */
/* 80CA22C4  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CA3468@l */
...
/* 80CA2300  3C 60 80 CA */	lis r3, lit_4512@ha /* 0x80CA3388@ha */
/* 80CA2304  38 83 33 88 */	addi r4, r3, lit_4512@l /* 0x80CA3388@l */
