...
/* 80CA1D6C  4B 6C 04 71 */	bl _savegpr_29
/* 80CA1D70  7C 7E 1B 78 */	mr r30, r3
/* 80CA1D74  3C 80 80 CA */	lis r4, lit_3774@ha /* 0x80CA31BC@ha */
/* 80CA1D78  3B E4 31 BC */	addi r31, r4, lit_3774@l /* 0x80CA31BC@l */
/* 80CA1D7C  80 03 07 D0 */	lwz r0, 0x7d0(r3)
/* 80CA1D80  2C 00 00 00 */	cmpwi r0, 0
/* 80CA1D84  40 82 00 64 */	bne lbl_80CA1DE8
/* 80CA1D88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA1D8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CA1E34  3C 60 80 CA */	lis r3, lit_4444@ha /* 0x80CA3370@ha */
/* 80CA1E38  38 83 33 70 */	addi r4, r3, lit_4444@l /* 0x80CA3370@l */
...
/* 80CA1E64  4B 3D 5E 05 */	bl __ct__11dBgS_LinChkFv
/* 80CA1E68  38 61 00 98 */	addi r3, r1, 0x98
/* 80CA1E6C  4B 3D 6F FD */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80CA1E80  4B 3D 5E E5 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80CA1E84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA1E88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CA1E8C  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80CA1E90  7F A3 EB 78 */	mr r3, r29
/* 80CA1E94  38 81 00 40 */	addi r4, r1, 0x40
/* 80CA1E98  4B 3D 25 1D */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80CA1E9C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CA1EA0  41 82 00 9C */	beq lbl_80CA1F3C
/* 80CA1EA4  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha /* 0x80CA3468@ha */
/* 80CA1EA8  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CA3468@l */
...
/* 80CA1EBC  4B 3D 28 89 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CA1F30  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha /* 0x80CA3468@ha */
/* 80CA1F34  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CA3468@l */
/* 80CA1F38  90 01 00 3C */	stw r0, 0x3c(r1)
lbl_80CA1F3C:
/* 80CA1F3C  38 61 00 40 */	addi r3, r1, 0x40
/* 80CA1F40  38 80 FF FF */	li r4, -1
/* 80CA1F44  4B 3D 5D 99 */	bl __dt__11dBgS_LinChkFv
lbl_80CA1F48:
/* 80CA1F48  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80CA1F4C  4B 6C 02 DD */	bl _restgpr_29
