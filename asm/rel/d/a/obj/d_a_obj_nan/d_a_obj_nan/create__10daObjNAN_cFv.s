...
/* 80CA2B78  4B 6B F6 5D */	bl _savegpr_27
/* 80CA2B7C  7C 7B 1B 78 */	mr r27, r3
/* 80CA2B80  3C 80 80 CA */	lis r4, cNullVec__6Z2Calc@ha /* 0x80CA32B0@ha */
/* 80CA2B84  3B C4 32 B0 */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x80CA32B0@l */
/* 80CA2B88  3C 80 80 CA */	lis r4, lit_3774@ha /* 0x80CA31BC@ha */
/* 80CA2B8C  3B E4 31 BC */	addi r31, r4, lit_3774@l /* 0x80CA31BC@l */
...
/* 80CA2BB4  4B 4B B4 5D */	bl __ct__9dInsect_cFv
/* 80CA2BB8  3C 60 80 CA */	lis r3, __vt__10daObjNAN_c@ha /* 0x80CA345C@ha */
/* 80CA2BBC  38 03 34 5C */	addi r0, r3, __vt__10daObjNAN_c@l /* 0x80CA345C@l */
/* 80CA2BC0  90 1C 05 68 */	stw r0, 0x568(r28)
/* 80CA2BC4  38 7C 05 98 */	addi r3, r28, 0x598
/* 80CA2BC8  4B 61 D8 01 */	bl __ct__10Z2CreatureFv
/* 80CA2BCC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CA2BD0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CA2BD4  90 1C 06 4C */	stw r0, 0x64c(r28)
/* 80CA2BD8  38 7C 06 50 */	addi r3, r28, 0x650
/* 80CA2BDC  4B 3E 0B 85 */	bl __ct__10dCcD_GSttsFv
/* 80CA2BE0  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CA2BE4  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CA2BFC  4B 3E 0E 2D */	bl __ct__12dCcD_GObjInfFv
/* 80CA2C00  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CA2C04  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CA2C08  90 1C 01 20 */	stw r0, 0x120(r28)
/* 80CA2C0C  3C 60 80 CA */	lis r3, __vt__8cM3dGAab@ha /* 0x80CA3450@ha */
/* 80CA2C10  38 03 34 50 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CA3450@l */
/* 80CA2C14  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 80CA2C18  3C 60 80 CA */	lis r3, __vt__8cM3dGSph@ha /* 0x80CA3444@ha */
/* 80CA2C1C  38 03 34 44 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80CA3444@l */
/* 80CA2C20  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80CA2C24  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80CA2C28  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 80CA2C2C  90 7C 01 20 */	stw r3, 0x120(r28)
/* 80CA2C30  38 03 00 58 */	addi r0, r3, 0x58
/* 80CA2C34  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80CA2C38  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80CA2C3C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80CA2C64  3C 80 80 CA */	lis r4, d_a_obj_nan__stringBase0@ha /* 0x80CA32A0@ha */
/* 80CA2C68  38 84 32 A0 */	addi r4, r4, d_a_obj_nan__stringBase0@l /* 0x80CA32A0@l */
/* 80CA2C6C  4B 38 A2 51 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CA2CB4  3C 60 80 CA */	lis r3, l_HIO@ha /* 0x80CA34A8@ha */
/* 80CA2CB8  38 63 34 A8 */	addi r3, r3, l_HIO@l /* 0x80CA34A8@l */
...
lbl_80CA2CD0:
/* 80CA2CD0  3C 60 80 CA */	lis r3, l_HIO@ha /* 0x80CA34A8@ha */
/* 80CA2CD4  38 63 34 A8 */	addi r3, r3, l_HIO@l /* 0x80CA34A8@l */
...
/* 80CA2D30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA2D34  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CA2D48  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80CA2D4C  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80CA2D50  7C 84 02 2E */	lhzx r4, r4, r0
/* 80CA2D54  4B 39 1C 69 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80CA2D70  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80CA2D74  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80CA2D78  7C 84 02 2E */	lhzx r4, r4, r0
/* 80CA2D7C  4B 39 1C 41 */	bl isEventBit__11dSv_event_cCFUs
...
lbl_80CA2D90:
/* 80CA2D90  3C 60 80 CA */	lis r3, d_a_obj_nan__stringBase0@ha /* 0x80CA32A0@ha */
/* 80CA2D94  38 63 32 A0 */	addi r3, r3, d_a_obj_nan__stringBase0@l /* 0x80CA32A0@l */
/* 80CA2D98  38 63 00 06 */	addi r3, r3, 6
/* 80CA2D9C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA2DA0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CA2DA4  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80CA2DA8  4B 6C 5B ED */	bl strcmp
/* 80CA2DAC  2C 03 00 00 */	cmpwi r3, 0
/* 80CA2DB0  40 82 00 AC */	bne lbl_80CA2E5C
/* 80CA2DB4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA2DB8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CA2DCC  4B 53 71 71 */	bl isCatchNotGiveInsect__14dMenu_Insect_cFUc
...
/* 80CA2DEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA2DF0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CA2DF4  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80CA2DF8  A0 1F 00 D8 */	lhz r0, 0xd8(r31)
/* 80CA2DFC  54 00 08 3C */	slwi r0, r0, 1
/* 80CA2E00  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80CA2E04  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80CA2E08  7C 84 02 2E */	lhzx r4, r4, r0
/* 80CA2E0C  4B 39 1B B1 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80CA2E24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA2E28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CA2E3C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80CA2E40  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80CA2E44  7C 84 02 2E */	lhzx r4, r4, r0
/* 80CA2E48  4B 39 1B 75 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80CA2E60  3C 80 80 CA */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80CA0678@ha */
/* 80CA2E64  38 84 06 78 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80CA0678@l */
...
/* 80CA2E78  4B 37 76 39 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80CA2E8C:
/* 80CA2E8C  3C 60 80 CA */	lis r3, data_80CA3498@ha /* 0x80CA3498@ha */
/* 80CA2E90  8C 03 34 98 */	lbzu r0, data_80CA3498@l(r3)  /* 0x80CA3498@l */
...
/* 80CA2EAC  3C 60 80 CA */	lis r3, l_HIO@ha /* 0x80CA34A8@ha */
/* 80CA2EB0  38 63 34 A8 */	addi r3, r3, l_HIO@l /* 0x80CA34A8@l */
...
/* 80CA2EE0  4B 37 76 49 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80CA2EF4  4B 37 76 45 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80CA2F20  4B 61 D6 11 */	bl init__10Z2CreatureFP3VecP3VecUcUc
...
/* 80CA2F48  4B 3E 09 19 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80CA2F4C  38 7B 06 70 */	addi r3, r27, 0x670
/* 80CA2F50  38 9E 00 20 */	addi r4, r30, 0x20
/* 80CA2F54  4B 3E 1A E1 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80CA2FC8  4B 6B F2 59 */	bl _restgpr_27
