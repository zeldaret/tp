...
/* 80CF69AC  4B 66 B8 31 */	bl _savegpr_29
/* 80CF69B0  7C 7D 1B 78 */	mr r29, r3
/* 80CF69B4  3B C0 00 00 */	li r30, 0
/* 80CF69B8  3C 60 80 CF */	lis r3, s_ballA_sub__FPvPv@ha /* 0x80CF5C24@ha */
/* 80CF69BC  38 63 5C 24 */	addi r3, r3, s_ballA_sub__FPvPv@l /* 0x80CF5C24@l */
/* 80CF69C0  7F A4 EB 78 */	mr r4, r29
/* 80CF69C4  4B 32 A9 75 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80CF69E0  3C 80 80 CF */	lis r4, lit_3850@ha /* 0x80CF6CEC@ha */
/* 80CF69E4  C0 24 6C EC */	lfs f1, lit_3850@l(r4)  /* 0x80CF6CEC@l */
/* 80CF69E8  3C 80 80 CF */	lis r4, lit_4175@ha /* 0x80CF6CFC@ha */
/* 80CF69EC  C0 44 6C FC */	lfs f2, lit_4175@l(r4)  /* 0x80CF6CFC@l */
/* 80CF69F0  4B 57 9D 51 */	bl cLib_chaseF__FPfff
...
lbl_80CF6A08:
/* 80CF6A08  3C 60 80 CF */	lis r3, s_ballB_sub__FPvPv@ha /* 0x80CF5C7C@ha */
/* 80CF6A0C  38 63 5C 7C */	addi r3, r3, s_ballB_sub__FPvPv@l /* 0x80CF5C7C@l */
/* 80CF6A10  7F A4 EB 78 */	mr r4, r29
/* 80CF6A14  4B 32 A9 25 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80CF6A30  3C 80 80 CF */	lis r4, lit_3850@ha /* 0x80CF6CEC@ha */
/* 80CF6A34  C0 24 6C EC */	lfs f1, lit_3850@l(r4)  /* 0x80CF6CEC@l */
/* 80CF6A38  3C 80 80 CF */	lis r4, lit_4175@ha /* 0x80CF6CFC@ha */
/* 80CF6A3C  C0 44 6C FC */	lfs f2, lit_4175@l(r4)  /* 0x80CF6CFC@l */
/* 80CF6A40  4B 57 9D 01 */	bl cLib_chaseF__FPfff
...
/* 80CF6A60  4B 66 B7 C9 */	bl _restgpr_29
