...
/* 80CF5F08  4B 66 C2 D1 */	bl _savegpr_28
/* 80CF5F0C  7C 7F 1B 78 */	mr r31, r3
/* 80CF5F10  3C 60 80 CF */	lis r3, l_arcName@ha /* 0x80CF6DB0@ha */
/* 80CF5F14  38 63 6D B0 */	addi r3, r3, l_arcName@l /* 0x80CF6DB0@l */
/* 80CF5F18  80 63 00 00 */	lwz r3, 0(r3)
/* 80CF5F1C  38 80 00 06 */	li r4, 6
/* 80CF5F20  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF5F24  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF5F38  4B 34 63 B5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CF5F4C  4B 31 ED 09 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80CF5F68:
/* 80CF5F68  3C 60 80 CF */	lis r3, l_arcName@ha /* 0x80CF6DB0@ha */
/* 80CF5F6C  38 63 6D B0 */	addi r3, r3, l_arcName@l /* 0x80CF6DB0@l */
...
/* 80CF5F80  4B 34 63 6D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80CF5F84  7C 7C 1B 78 */	mr r28, r3
/* 80CF5F88  38 60 00 18 */	li r3, 0x18
/* 80CF5F8C  4B 5D 8C C1 */	bl __nw__FUl
/* 80CF5F90  7C 7E 1B 79 */	or. r30, r3, r3
/* 80CF5F94  41 82 00 20 */	beq lbl_80CF5FB4
/* 80CF5F98  3C 80 80 CF */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80CF6F08@ha */
/* 80CF5F9C  38 04 6F 08 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80CF6F08@l */
/* 80CF5FA0  90 1E 00 00 */	stw r0, 0(r30)
/* 80CF5FA4  38 80 00 00 */	li r4, 0
/* 80CF5FA8  4B 63 24 55 */	bl init__12J3DFrameCtrlFs
...
/* 80CF5FD4  3D 00 80 CF */	lis r8, lit_3814@ha /* 0x80CF6CDC@ha */
/* 80CF5FD8  C0 28 6C DC */	lfs f1, lit_3814@l(r8)  /* 0x80CF6CDC@l */
/* 80CF5FDC  39 00 00 00 */	li r8, 0
/* 80CF5FE0  39 20 FF FF */	li r9, -1
/* 80CF5FE4  4B 31 76 59 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80CF5FF8:
/* 80CF5FF8  3C 60 80 CF */	lis r3, lit_3850@ha /* 0x80CF6CEC@ha */
/* 80CF5FFC  C0 03 6C EC */	lfs f0, lit_3850@l(r3)  /* 0x80CF6CEC@l */
...
/* 80CF6010  4B 66 C2 15 */	bl _restgpr_28
