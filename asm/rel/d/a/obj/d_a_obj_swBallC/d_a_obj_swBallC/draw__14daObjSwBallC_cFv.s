...
/* 80CF6A84  4B 66 B7 55 */	bl _savegpr_28
/* 80CF6A88  7C 7E 1B 78 */	mr r30, r3
/* 80CF6A8C  3C 60 80 CF */	lis r3, l_color@ha /* 0x80CF6CD4@ha */
/* 80CF6A90  3B 83 6C D4 */	addi r28, r3, l_color@l /* 0x80CF6CD4@l */
/* 80CF6A94  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF6A98  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF6A9C  38 80 00 00 */	li r4, 0
/* 80CF6AA0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CF6AA4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CF6AA8  4B 4A CD 1D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CF6AAC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF6AB0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF6AB4  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80CF6AB8  80 84 00 04 */	lwz r4, 4(r4)
/* 80CF6ABC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CF6AC0  4B 4A E2 E1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CF6AC4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF6AC8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF6ACC  80 04 5F 78 */	lwz r0, 0x5f78(r4)
/* 80CF6AD0  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CF6AD4  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CF6B58  4B 65 01 8D */	bl C_MTXLightOrtho
/* 80CF6B5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF6B60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF6B64  38 80 40 00 */	li r4, 0x4000
/* 80CF6B68  4B 31 57 DD */	bl mDoMtx_XrotS__FPA4_fs
...
/* 80CF6B84  4B 31 62 19 */	bl transM__14mDoMtx_stack_cFfff
/* 80CF6B88  38 61 00 08 */	addi r3, r1, 8
/* 80CF6B8C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF6B90  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF6B94  38 BD 00 24 */	addi r5, r29, 0x24
/* 80CF6B98  4B 64 F9 4D */	bl PSMTXConcat
lbl_80CF6B9C:
...
/* 80CF6BB0  4B 31 6B 29 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80CF6BB4  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80CF6BB8  4B 31 71 0D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CF6BBC  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80CF6BC0  80 63 00 04 */	lwz r3, 4(r3)
/* 80CF6BC4  4B 31 72 2D */	bl mDoExt_btkAnmRemove__FP12J3DModelData
/* 80CF6BC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF6BCC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF6BE8  4B 66 B6 3D */	bl _restgpr_28
