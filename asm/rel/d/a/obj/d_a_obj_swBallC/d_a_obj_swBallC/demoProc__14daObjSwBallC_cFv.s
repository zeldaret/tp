...
/* 80CF6404  4B 66 BD D1 */	bl _savegpr_27
/* 80CF6408  7C 7B 1B 78 */	mr r27, r3
/* 80CF640C  3C 60 80 CF */	lis r3, l_color@ha /* 0x80CF6CD4@ha */
/* 80CF6410  3B C3 6C D4 */	addi r30, r3, l_color@l /* 0x80CF6CD4@l */
/* 80CF6414  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF6418  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF642C  3C A0 80 CF */	lis r5, action_table@ha /* 0x80CF6E1C@ha */
/* 80CF6430  38 A5 6E 1C */	addi r5, r5, action_table@l /* 0x80CF6E1C@l */
/* 80CF6434  38 C0 00 0D */	li r6, 0xd
/* 80CF6438  38 E0 00 00 */	li r7, 0
/* 80CF643C  39 00 00 00 */	li r8, 0
/* 80CF6440  4B 35 19 D1 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
/* 80CF6444  7C 7F 1B 78 */	mr r31, r3
/* 80CF6448  7F 83 E3 78 */	mr r3, r28
/* 80CF644C  3C 80 80 CF */	lis r4, l_staffName@ha /* 0x80CF6DB8@ha */
/* 80CF6450  38 84 6D B8 */	addi r4, r4, l_staffName@l /* 0x80CF6DB8@l */
/* 80CF6454  80 84 00 00 */	lwz r4, 0(r4)
/* 80CF6458  38 A0 00 00 */	li r5, 0
/* 80CF645C  38 C0 00 00 */	li r6, 0
/* 80CF6460  4B 35 16 BD */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80CF647C  4B 35 18 D1 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80CF6490  3C 60 80 CF */	lis r3, lit_4112@ha /* 0x80CF6E84@ha */
/* 80CF6494  38 63 6E 84 */	addi r3, r3, lit_4112@l /* 0x80CF6E84@l */
...
/* 80CF64B0  3C A0 80 CF */	lis r5, d_a_obj_swBallC__stringBase0@ha /* 0x80CF6D08@ha */
/* 80CF64B4  38 A5 6D 08 */	addi r5, r5, d_a_obj_swBallC__stringBase0@l /* 0x80CF6D08@l */
/* 80CF64B8  38 A5 00 81 */	addi r5, r5, 0x81
/* 80CF64BC  38 C0 00 03 */	li r6, 3
/* 80CF64C0  4B 35 1C 2D */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80CF6530  4B 33 6B 3D */	bl dComIfGp_getReverb__Fi
...
/* 80CF6544  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CF6548  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CF6570  4B 5B 54 15 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CF6574  48 00 01 00 */	b lbl_80CF6674
lbl_80CF6578:
/* 80CF6578  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CF657C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CF6590  4B 5B 96 05 */	bl bgmStreamPrepare__8Z2SeqMgrFUl
...
/* 80CF65AC  4B 52 7F 85 */	bl dMeter2Info_setSword__FUcb
...
/* 80CF6670  4B 3A 18 1D */	bl execItemGet__FUc
lbl_80CF6674:
...
/* 80CF6694  3C 60 80 CF */	lis r3, lit_4113@ha /* 0x80CF6E50@ha */
/* 80CF6698  38 63 6E 50 */	addi r3, r3, lit_4113@l /* 0x80CF6E50@l */
...
/* 80CF66C4  4B 35 1A B9 */	bl cutEnd__16dEvent_manager_cFi
/* 80CF66C8  48 00 01 00 */	b lbl_80CF67C8
lbl_80CF66CC:
/* 80CF66CC  80 7B 05 74 */	lwz r3, 0x574(r27)
/* 80CF66D0  4B 31 6D 59 */	bl play__14mDoExt_baseAnmFv
...
/* 80CF66E4  4B 35 1A 99 */	bl cutEnd__16dEvent_manager_cFi
/* 80CF66E8  48 00 00 E0 */	b lbl_80CF67C8
lbl_80CF66EC:
/* 80CF66EC  7F 83 E3 78 */	mr r3, r28
/* 80CF66F0  80 9B 05 78 */	lwz r4, 0x578(r27)
/* 80CF66F4  4B 35 1A 89 */	bl cutEnd__16dEvent_manager_cFi
...
/* 80CF671C  4B 35 1A 61 */	bl cutEnd__16dEvent_manager_cFi
...
/* 80CF673C  4B 32 97 49 */	bl fopMsgM_messageSet__FUlUl
/* 80CF6740  90 7B 05 88 */	stw r3, 0x588(r27)
/* 80CF6744  48 00 00 84 */	b lbl_80CF67C8
lbl_80CF6748:
/* 80CF6748  4B 32 92 DD */	bl fopMsgM_SearchByID__FUi
...
/* 80CF6784  4B 35 19 F9 */	bl cutEnd__16dEvent_manager_cFi
...
/* 80CF67B4  4B 35 19 C9 */	bl cutEnd__16dEvent_manager_cFi
/* 80CF67B8  48 00 00 10 */	b lbl_80CF67C8
lbl_80CF67BC:
/* 80CF67BC  7F 83 E3 78 */	mr r3, r28
/* 80CF67C0  80 9B 05 78 */	lwz r4, 0x578(r27)
/* 80CF67C4  4B 35 19 B9 */	bl cutEnd__16dEvent_manager_cFi
lbl_80CF67C8:
...
/* 80CF67E8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CF67EC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 80CF67F0  80 63 00 00 */	lwz r3, 0(r3)
/* 80CF67F4  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 80CF67F8  4B 5B 96 21 */	bl bgmStreamPlay__8Z2SeqMgrFv
lbl_80CF67FC:
/* 80CF67FC  38 60 00 00 */	li r3, 0
/* 80CF6800  39 61 00 30 */	addi r11, r1, 0x30
/* 80CF6804  4B 66 BA 1D */	bl _restgpr_27
