...
/* 80CF6214  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF6218  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF621C  38 80 00 3D */	li r4, 0x3d
/* 80CF6220  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CF6224  7C 05 07 74 */	extsb r5, r0
/* 80CF6228  4B 33 F1 39 */	bl isSwitch__10dSv_info_cCFii
/* 80CF622C  2C 03 00 00 */	cmpwi r3, 0
/* 80CF6230  41 82 00 58 */	beq lbl_80CF6288
/* 80CF6234  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF6238  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF623C  38 80 00 3E */	li r4, 0x3e
/* 80CF6240  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CF6244  7C 05 07 74 */	extsb r5, r0
/* 80CF6248  4B 33 F1 19 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CF6278  4B 32 54 05 */	bl fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs
