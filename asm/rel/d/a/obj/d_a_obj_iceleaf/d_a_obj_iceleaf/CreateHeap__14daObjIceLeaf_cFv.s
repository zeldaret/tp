...
/* 80C24CAC  4B 73 D5 31 */	bl _savegpr_29
/* 80C24CB0  7C 7F 1B 78 */	mr r31, r3
/* 80C24CB4  3C 60 80 C2 */	lis r3, l_arcName@ha /* 0x80C25DD0@ha */
/* 80C24CB8  38 63 5D D0 */	addi r3, r3, l_arcName@l /* 0x80C25DD0@l */
/* 80C24CBC  80 63 00 00 */	lwz r3, 0(r3)
/* 80C24CC0  38 80 00 07 */	li r4, 7
/* 80C24CC4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C24CC8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C24CDC  4B 41 76 11 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C24CEC  4B 3E FF 69 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C24D08:
/* 80C24D08  3C 60 80 C2 */	lis r3, l_arcName@ha /* 0x80C25DD0@ha */
/* 80C24D0C  38 63 5D D0 */	addi r3, r3, l_arcName@l /* 0x80C25DD0@l */
...
/* 80C24D20  4B 41 75 CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C24D24  7C 7D 1B 78 */	mr r29, r3
/* 80C24D28  38 60 00 1C */	li r3, 0x1c
/* 80C24D2C  4B 6A 9F 21 */	bl __nw__FUl
/* 80C24D30  7C 7E 1B 79 */	or. r30, r3, r3
/* 80C24D34  41 82 00 20 */	beq lbl_80C24D54
/* 80C24D38  3C 80 80 C2 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C25F88@ha */
/* 80C24D3C  38 04 5F 88 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C25F88@l */
/* 80C24D40  90 1E 00 00 */	stw r0, 0(r30)
/* 80C24D44  38 80 00 00 */	li r4, 0
/* 80C24D48  4B 70 36 B5 */	bl init__12J3DFrameCtrlFs
...
/* 80C24D70  3C E0 80 C2 */	lis r7, lit_3806@ha /* 0x80C25D78@ha */
/* 80C24D74  C0 27 5D 78 */	lfs f1, lit_3806@l(r7)  /* 0x80C25D78@l */
/* 80C24D78  38 E0 00 00 */	li r7, 0
/* 80C24D7C  39 00 FF FF */	li r8, -1
/* 80C24D80  39 20 00 00 */	li r9, 0
/* 80C24D84  4B 3E 8A 59 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
lbl_80C24D98:
/* 80C24D98  3C 60 80 C2 */	lis r3, lit_3703@ha /* 0x80C25D64@ha */
/* 80C24D9C  C0 03 5D 64 */	lfs f0, lit_3703@l(r3)  /* 0x80C25D64@l */
...
/* 80C24DB8  4B 73 D4 71 */	bl _restgpr_29
