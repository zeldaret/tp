...
/* 80C2542C  4B 73 CD AD */	bl _savegpr_28
/* 80C25430  7C 7D 1B 78 */	mr r29, r3
/* 80C25434  3C 60 80 C2 */	lis r3, lit_3703@ha /* 0x80C25D64@ha */
/* 80C25438  3B 83 5D 64 */	addi r28, r3, lit_3703@l /* 0x80C25D64@l */
/* 80C2543C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C25440  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C25444  83 E3 5D AC */	lwz r31, 0x5dac(r3)
/* 80C25448  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C2544C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C25450  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C25454  A0 84 02 68 */	lhz r4, 0x268(r4)
/* 80C25458  4B 40 F5 65 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80C25470  4B 72 1F 2D */	bl PSVECSquareDistance
...
/* 80C254E0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C254E4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C25550  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C25554  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C25558:
...
/* 80C255E4  4B 64 9B F9 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80C255E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C255EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C255F0  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C255F4  38 9D 07 C8 */	addi r4, r29, 0x7c8
/* 80C255F8  4B 63 F5 B1 */	bl Set__4cCcSFP8cCcD_Obj
/* 80C255FC  39 61 00 20 */	addi r11, r1, 0x20
/* 80C25600  4B 73 CC 25 */	bl _restgpr_28
