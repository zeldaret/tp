...
/* 80C87478  4B 5E 0D 5D */	bl ChkUsed__9cBgW_BgIdCFv
/* 80C8747C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C87480  41 82 00 18 */	beq lbl_80C87498
/* 80C87484  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C87488  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C8748C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C87490  80 9F 0A 90 */	lwz r4, 0xa90(r31)
/* 80C87494  4B 3E CD BD */	bl Release__4cBgSFP9dBgW_Base
lbl_80C87498:
/* 80C87498  38 7F 05 A0 */	addi r3, r31, 0x5a0
/* 80C8749C  88 1F 0A 7E */	lbz r0, 0xa7e(r31)
/* 80C874A0  54 00 10 3A */	slwi r0, r0, 2
/* 80C874A4  3C 80 80 C8 */	lis r4, l_arcName@ha /* 0x80C87A54@ha */
/* 80C874A8  38 84 7A 54 */	addi r4, r4, l_arcName@l /* 0x80C87A54@l */
/* 80C874AC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C874B0  4B 3A 5B 59 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
