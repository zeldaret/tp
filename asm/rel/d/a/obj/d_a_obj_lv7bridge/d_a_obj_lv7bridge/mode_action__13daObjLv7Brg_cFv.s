...
/* 80C86F64  4B 6D B2 79 */	bl _savegpr_29
/* 80C86F68  7C 7E 1B 78 */	mr r30, r3
/* 80C86F6C  3C 60 80 C8 */	lis r3, l_bmd@ha /* 0x80C879A0@ha */
/* 80C86F70  3B E3 79 A0 */	addi r31, r3, l_bmd@l /* 0x80C879A0@l */
/* 80C86F74  C3 FE 0A 78 */	lfs f31, 0xa78(r30)
/* 80C86F78  C3 DE 05 2C */	lfs f30, 0x52c(r30)
/* 80C86F7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C86F80  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C86F94  4B 3A E3 CD */	bl isSwitch__10dSv_info_cCFii
...
/* 80C86FE8  4B 5E 89 95 */	bl cLib_addCalc__FPfffff
...
/* 80C87040  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C87044  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8706C  4B 62 54 A1 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C87070:
...
/* 80C87098  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C8709C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C870B0  4B 3E 8A 61 */	bl StartQuake__12dVibration_cFii4cXyz
lbl_80C870B4:
...
/* 80C870CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C870D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C870D4  3B C3 5B D4 */	addi r30, r3, 0x5bd4
/* 80C870D8  7F C3 F3 78 */	mr r3, r30
/* 80C870DC  38 80 00 1F */	li r4, 0x1f
/* 80C870E0  4B 3E 8C B5 */	bl StopQuake__12dVibration_cFi
...
/* 80C87110  4B 3E 89 15 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 80C8712C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C87130  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C87134  3B A3 5B D4 */	addi r29, r3, 0x5bd4
/* 80C87138  7F A3 EB 78 */	mr r3, r29
/* 80C8713C  38 80 00 1F */	li r4, 0x1f
/* 80C87140  4B 3E 8C 55 */	bl StopQuake__12dVibration_cFi
...
/* 80C8715C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C87160  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8718C  4B 62 47 F9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C871B4  4B 3E 88 71 */	bl StartShock__12dVibration_cFii4cXyz
/* 80C871B8  88 1E 0A 7C */	lbz r0, 0xa7c(r30)
/* 80C871BC  28 00 00 00 */	cmplwi r0, 0
/* 80C871C0  40 82 00 28 */	bne lbl_80C871E8
/* 80C871C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C871C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C871DC  4B 3A E0 25 */	bl onSwitch__10dSv_info_cFii
...
/* 80C871FC  4B 6D B0 2D */	bl _restgpr_29
