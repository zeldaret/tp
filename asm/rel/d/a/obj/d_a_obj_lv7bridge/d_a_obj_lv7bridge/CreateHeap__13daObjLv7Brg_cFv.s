...
/* 80C867DC  4B 6D B9 E9 */	bl _savegpr_23
/* 80C867E0  7C 7C 1B 78 */	mr r28, r3
/* 80C867E4  3C 60 80 C8 */	lis r3, l_bmd@ha /* 0x80C879A0@ha */
/* 80C867E8  3B E3 79 A0 */	addi r31, r3, l_bmd@l /* 0x80C879A0@l */
/* 80C867EC  88 1C 0A 7E */	lbz r0, 0xa7e(r28)
/* 80C867F0  54 00 10 3A */	slwi r0, r0, 2
/* 80C867F4  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C87A54@ha */
/* 80C867F8  38 63 7A 54 */	addi r3, r3, l_arcName@l /* 0x80C87A54@l */
/* 80C867FC  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C86800  38 9F 00 00 */	addi r4, r31, 0
/* 80C86804  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C86808  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C8680C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C86820  4B 3B 5A CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C86830  4B 38 E4 25 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C8685C  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C87A54@ha */
/* 80C86860  38 63 7A 54 */	addi r3, r3, l_arcName@l /* 0x80C87A54@l */
...
/* 80C86874  4B 3B 5A 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C86884  4B 38 E3 D1 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C868A8  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C87A54@ha */
/* 80C868AC  3B 03 7A 54 */	addi r24, r3, l_arcName@l /* 0x80C87A54@l */
...
/* 80C868CC  4B 3B 5A 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C868D0  7C 77 1B 78 */	mr r23, r3
/* 80C868D4  38 60 00 1C */	li r3, 0x1c
/* 80C868D8  4B 64 83 75 */	bl __nw__FUl
/* 80C868DC  7C 7A 1B 79 */	or. r26, r3, r3
/* 80C868E0  41 82 00 20 */	beq lbl_80C86900
/* 80C868E4  3C 80 80 C8 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C87B80@ha */
/* 80C868E8  38 04 7B 80 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C87B80@l */
/* 80C868EC  90 1A 00 00 */	stw r0, 0(r26)
/* 80C868F0  38 80 00 00 */	li r4, 0
/* 80C868F4  4B 6A 1B 09 */	bl init__12J3DFrameCtrlFs
...
/* 80C86930  4B 38 6E AD */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80C86958  4B 64 82 F5 */	bl __nw__FUl
/* 80C8695C  7C 60 1B 79 */	or. r0, r3, r3
/* 80C86960  41 82 00 0C */	beq lbl_80C8696C
/* 80C86964  4B 3F 50 0D */	bl __ct__4dBgWFv
...
/* 80C86984  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C87A54@ha */
/* 80C86988  38 63 7A 54 */	addi r3, r3, l_arcName@l /* 0x80C87A54@l */
...
/* 80C8699C  4B 3B 59 51 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C869B0  4B 3F 35 89 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
/* 80C869B4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C869B8  40 82 00 18 */	bne lbl_80C869D0
/* 80C869BC  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075A24@ha */
/* 80C869C0  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075A24@l */
...
/* 80C869E8  4B 6D B8 29 */	bl _restgpr_23
