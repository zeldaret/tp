...
/* 80D0CC78  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80D0CC7C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80D0CC9C  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80D0CCA0  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 80D0CCB8  3C 60 80 D1 */	lis r3, __vt__8cM3dGSph@ha /* 0x80D0D3AC@ha */
/* 80D0CCBC  38 03 D3 AC */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80D0D3AC@l */
/* 80D0CCC0  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_80D0CCC4:
/* 80D0CCC4  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80D0CCC8  41 82 00 24 */	beq lbl_80D0CCEC
/* 80D0CCCC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80D0CCD0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80D0CCD4  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80D0CCD8  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80D0CCDC  41 82 00 10 */	beq lbl_80D0CCEC
/* 80D0CCE0  3C 60 80 D1 */	lis r3, __vt__8cM3dGAab@ha /* 0x80D0D3C4@ha */
/* 80D0CCE4  38 03 D3 C4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80D0D3C4@l */
/* 80D0CCE8  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_80D0CCEC:
/* 80D0CCEC  7F C3 F3 78 */	mr r3, r30
/* 80D0CCF0  38 80 00 00 */	li r4, 0
/* 80D0CCF4  4B 37 73 F1 */	bl __dt__12dCcD_GObjInfFv
/* 80D0CCF8  7F E0 07 35 */	extsh. r0, r31
/* 80D0CCFC  40 81 00 0C */	ble lbl_80D0CD08
/* 80D0CD00  7F C3 F3 78 */	mr r3, r30
/* 80D0CD04  4B 5C 20 39 */	bl __dl__FPv
lbl_80D0CD08:
