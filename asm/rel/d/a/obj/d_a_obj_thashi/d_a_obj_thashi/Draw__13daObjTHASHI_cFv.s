...
/* 80D0CEF0  4B 65 52 E9 */	bl _savegpr_28
/* 80D0CEF4  7C 7F 1B 78 */	mr r31, r3
/* 80D0CEF8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D0CEFC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D0CF00  38 80 00 00 */	li r4, 0
/* 80D0CF04  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80D0CF08  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80D0CF0C  4B 49 68 B9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80D0CF10  80 1F 05 A4 */	lwz r0, 0x5a4(r31)
/* 80D0CF14  28 00 00 08 */	cmplwi r0, 8
/* 80D0CF18  41 81 01 30 */	bgt lbl_80D0D048
/* 80D0CF1C  3C 60 80 D1 */	lis r3, lit_4854@ha /* 0x80D0D440@ha */
/* 80D0CF20  38 63 D4 40 */	addi r3, r3, lit_4854@l /* 0x80D0D440@l */
...
lbl_80D0CF34:
/* 80D0CF34  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D0CF38  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D0CF3C  80 9F 10 D4 */	lwz r4, 0x10d4(r31)
/* 80D0CF40  80 84 00 04 */	lwz r4, 4(r4)
/* 80D0CF44  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80D0CF48  4B 49 7E 59 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D0CF4C  48 00 00 FC */	b lbl_80D0D048
lbl_80D0CF50:
/* 80D0CF50  3B 80 00 00 */	li r28, 0
/* 80D0CF54  3B C0 00 00 */	li r30, 0
/* 80D0CF58  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D0CF5C  3B A3 CA 54 */	addi r29, r3, g_env_light@l /* 0x8042CA54@l */
lbl_80D0CF60:
...
/* 80D0CF74  4B 49 7E 2D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80D0CF88  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D0CF8C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D0CF90  80 9F 10 D8 */	lwz r4, 0x10d8(r31)
/* 80D0CF94  80 84 00 04 */	lwz r4, 4(r4)
/* 80D0CF98  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80D0CF9C  4B 49 7E 05 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D0CFA0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D0CFA4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D0CFA8  80 9F 11 A4 */	lwz r4, 0x11a4(r31)
/* 80D0CFAC  80 84 00 04 */	lwz r4, 4(r4)
/* 80D0CFB0  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80D0CFB4  4B 49 7D ED */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D0CFB8  48 00 00 90 */	b lbl_80D0D048
lbl_80D0CFBC:
/* 80D0CFBC  3B 80 00 00 */	li r28, 0
/* 80D0CFC0  3B C0 00 00 */	li r30, 0
/* 80D0CFC4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D0CFC8  3B A3 CA 54 */	addi r29, r3, g_env_light@l /* 0x8042CA54@l */
lbl_80D0CFCC:
...
/* 80D0CFE0  4B 49 7D C1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80D0D000  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D0D004  3B A3 CA 54 */	addi r29, r3, g_env_light@l /* 0x8042CA54@l */
lbl_80D0D008:
...
/* 80D0D01C  4B 49 7D 85 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80D0D030  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D0D034  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D0D038  80 9F 10 D8 */	lwz r4, 0x10d8(r31)
/* 80D0D03C  80 84 00 04 */	lwz r4, 4(r4)
/* 80D0D040  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80D0D044  4B 49 7D 5D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_80D0D048:
/* 80D0D048  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D0D04C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D0D050  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80D0D054  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80D0D058  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80D0D074  3C 60 80 D1 */	lis r3, lit_4855@ha /* 0x80D0D41C@ha */
/* 80D0D078  38 63 D4 1C */	addi r3, r3, lit_4855@l /* 0x80D0D41C@l */
...
/* 80D0D090  4B 30 0C 35 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D0D0A8  4B 30 0C 1D */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D0D0C0  4B 30 0C 05 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80D0D0C4  80 7F 11 A4 */	lwz r3, 0x11a4(r31)
/* 80D0D0C8  4B 30 0B FD */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D0D0E0  4B 30 0B E5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D0D108  4B 30 0B BD */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D0D120  4B 30 0B A5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80D0D124:
/* 80D0D124  38 60 00 01 */	li r3, 1
/* 80D0D128  39 61 00 20 */	addi r11, r1, 0x20
/* 80D0D12C  4B 65 50 F9 */	bl _restgpr_28
