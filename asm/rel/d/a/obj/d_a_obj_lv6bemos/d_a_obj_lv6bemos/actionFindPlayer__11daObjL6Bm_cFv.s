...
/* 80C7D6DC  4B 6E 4A FD */	bl _savegpr_28
/* 80C7D6E0  7C 7E 1B 78 */	mr r30, r3
/* 80C7D6E4  3C 80 80 C8 */	lis r4, l_sph_src@ha /* 0x80C7DECC@ha */
/* 80C7D6E8  3B E4 DE CC */	addi r31, r4, l_sph_src@l /* 0x80C7DECC@l */
/* 80C7D6EC  3B 80 00 00 */	li r28, 0
/* 80C7D6F0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7D6F4  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7D6F8  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 80C7D6FC  4B 39 D2 69 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C7D760  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C7DF98@ha */
/* 80C7D764  38 63 DF 98 */	addi r3, r3, l_arcName@l /* 0x80C7DF98@l */
/* 80C7D768  80 63 00 00 */	lwz r3, 0(r3)
/* 80C7D76C  38 80 00 12 */	li r4, 0x12
/* 80C7D770  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7D774  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7D778  3C A5 00 02 */	addis r5, r5, 2
/* 80C7D77C  38 C0 00 80 */	li r6, 0x80
/* 80C7D780  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C7D784  4B 3B EB 69 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C7D7B0  4B 38 FE 8D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C7D7C8  4B 39 CF 49 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C7D7DC  4B 5F 2E 2D */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C7D7FC  3C 60 80 C8 */	lis r3, l_arcName@ha /* 0x80C7DF98@ha */
/* 80C7D800  38 63 DF 98 */	addi r3, r3, l_arcName@l /* 0x80C7DF98@l */
/* 80C7D804  80 63 00 00 */	lwz r3, 0(r3)
/* 80C7D808  38 80 00 13 */	li r4, 0x13
/* 80C7D80C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7D810  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7D814  3C A5 00 02 */	addis r5, r5, 2
/* 80C7D818  38 C0 00 80 */	li r6, 0x80
/* 80C7D81C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C7D820  4B 3B EA CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C7D84C  4B 38 FD F1 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
