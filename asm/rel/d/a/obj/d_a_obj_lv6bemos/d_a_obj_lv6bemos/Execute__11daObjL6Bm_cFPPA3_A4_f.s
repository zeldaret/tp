...
/* 80C7D3B4  4B 6E 4E 19 */	bl _savegpr_25
...
/* 80C7D3D0  4B 39 00 59 */	bl play__14mDoExt_baseAnmFv
/* 80C7D3D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7D3D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7D3DC  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C7D3E0  38 9E 05 E8 */	addi r4, r30, 0x5e8
/* 80C7D3E4  4B 5E 77 C5 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80C7D3E8:
/* 80C7D3E8  38 7E 07 48 */	addi r3, r30, 0x748
/* 80C7D3EC  4B 40 70 75 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 80C7D3F0  28 03 00 00 */	cmplwi r3, 0
/* 80C7D3F4  41 82 00 AC */	beq lbl_80C7D4A0
/* 80C7D3F8  38 7E 07 48 */	addi r3, r30, 0x748
/* 80C7D3FC  4B 40 70 FD */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 80C7D410  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7D414  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7D418  3C 60 80 C8 */	lis r3, l_particle_id@ha /* 0x80C7DF44@ha */
/* 80C7D41C  3B 63 DF 44 */	addi r27, r3, l_particle_id@l /* 0x80C7DF44@l */
/* 80C7D420  3C 60 80 C8 */	lis r3, lit_3880@ha /* 0x80C7DF38@ha */
/* 80C7D424  3B 83 DF 38 */	addi r28, r3, lit_3880@l /* 0x80C7DF38@l */
lbl_80C7D428:
...
/* 80C7D468  4B 3C F6 29 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C7D480  4B 39 C7 FD */	bl fopAcM_delete__FP10fopAc_ac_c
/* 80C7D484  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7D488  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C7D49C  4B 3B 7D 65 */	bl onSwitch__10dSv_info_cFii
lbl_80C7D4A0:
/* 80C7D4A0  38 7E 08 6C */	addi r3, r30, 0x86c
/* 80C7D4A4  38 9E 08 94 */	addi r4, r30, 0x894
/* 80C7D4A8  4B 5F 21 A1 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80C7D4AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C7D4B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C7D4B4  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C7D4B8  38 9E 07 48 */	addi r4, r30, 0x748
/* 80C7D4BC  4B 5E 76 ED */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80C7D4E0  4B 6E 4D 39 */	bl _restgpr_25
