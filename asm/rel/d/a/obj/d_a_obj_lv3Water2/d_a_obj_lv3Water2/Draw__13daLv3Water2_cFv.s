...
/* 80C5ADB4  4B 70 74 21 */	bl _savegpr_27
/* 80C5ADB8  7C 7E 1B 78 */	mr r30, r3
/* 80C5ADBC  3C 60 80 C6 */	lis r3, l_bmdIdx@ha /* 0x80C5B364@ha */
/* 80C5ADC0  3B E3 B3 64 */	addi r31, r3, l_bmdIdx@l /* 0x80C5B364@l */
/* 80C5ADC4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C5ADC8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C5ADCC  38 80 00 10 */	li r4, 0x10
/* 80C5ADD0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C5ADD4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C5ADD8  4B 54 89 ED */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C5ADDC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C5ADE0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C5ADE4  80 9E 05 C0 */	lwz r4, 0x5c0(r30)
/* 80C5ADE8  80 84 00 04 */	lwz r4, 4(r4)
/* 80C5ADEC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C5ADF0  4B 54 9F B1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C5AE08  4B 3B 28 D1 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80C5AE0C  80 7B 00 60 */	lwz r3, 0x60(r27)
/* 80C5AE10  83 83 00 00 */	lwz r28, 0(r3)
/* 80C5AE14  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C5AE18  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C5AE1C  80 04 5F A0 */	lwz r0, 0x5fa0(r4)
/* 80C5AE20  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C5AE24  3B A3 4A C8 */	addi r29, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C5AE74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C5AE78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C5AE9C  4B 6E BD 7D */	bl C_MTXLightPerspective
/* 80C5AEA0  7F 83 E3 78 */	mr r3, r28
/* 80C5AEA4  38 81 00 08 */	addi r4, r1, 8
/* 80C5AEA8  4B 6C A8 ED */	bl setEffectMtx__13J3DTexMtxInfoFPA4_f
/* 80C5AEAC  7F 63 DB 78 */	mr r3, r27
/* 80C5AEB0  38 80 00 00 */	li r4, 0
/* 80C5AEB4  3C A0 80 3A */	lis r5, j3dDefaultMtx@ha /* 0x803A1E5C@ha */
/* 80C5AEB8  38 A5 1E 5C */	addi r5, r5, j3dDefaultMtx@l /* 0x803A1E5C@l */
/* 80C5AEBC  4B 6C B1 51 */	bl simpleCalcMaterial__12J3DModelDataFUsPA4_f
lbl_80C5AEC0:
/* 80C5AEC0  80 7E 05 C0 */	lwz r3, 0x5c0(r30)
/* 80C5AEC4  4B 3B 2E 01 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C5AEC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C5AECC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C5AEE8  4B 70 73 39 */	bl _restgpr_27
