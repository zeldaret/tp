...
/* 80C5A508  4B 70 7C D1 */	bl _savegpr_28
/* 80C5A50C  7C 7F 1B 78 */	mr r31, r3
/* 80C5A510  3C 60 80 C6 */	lis r3, l_bmdIdx@ha /* 0x80C5B364@ha */
/* 80C5A514  3B A3 B3 64 */	addi r29, r3, l_bmdIdx@l /* 0x80C5B364@l */
/* 80C5A518  88 1F 05 DD */	lbz r0, 0x5dd(r31)
/* 80C5A51C  54 00 10 3A */	slwi r0, r0, 2
/* 80C5A520  3C 60 80 C6 */	lis r3, l_resNameIdx@ha /* 0x80C5B3C4@ha */
/* 80C5A524  38 63 B3 C4 */	addi r3, r3, l_resNameIdx@l /* 0x80C5B3C4@l */
/* 80C5A528  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C5A52C  38 9D 00 00 */	addi r4, r29, 0
/* 80C5A530  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C5A534  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C5A538  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C5A54C  4B 3E 1D A1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C5A560  4B 3B A6 F5 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C5A584  3C 60 80 C6 */	lis r3, l_resNameIdx@ha /* 0x80C5B3C4@ha */
/* 80C5A588  38 63 B3 C4 */	addi r3, r3, l_resNameIdx@l /* 0x80C5B3C4@l */
...
/* 80C5A5A0  4B 3E 1D 4D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C5A5C4  4B 3B 30 79 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80C5A5C8  38 60 00 01 */	li r3, 1
lbl_80C5A5CC:
/* 80C5A5CC  39 61 00 20 */	addi r11, r1, 0x20
/* 80C5A5D0  4B 70 7C 55 */	bl _restgpr_28
