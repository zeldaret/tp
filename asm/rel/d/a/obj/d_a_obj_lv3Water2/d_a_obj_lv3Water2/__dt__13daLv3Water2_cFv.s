...
/* 80C5B2B8  3C 60 80 C6 */	lis r3, __vt__13daLv3Water2_c@ha /* 0x80C5B46C@ha */
/* 80C5B2BC  38 63 B4 6C */	addi r3, r3, __vt__13daLv3Water2_c@l /* 0x80C5B46C@l */
...
/* 80C5B2E4  3C 60 80 C6 */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80C5B448@ha */
/* 80C5B2E8  38 03 B4 48 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80C5B448@l */
/* 80C5B2EC  90 1E 05 C4 */	stw r0, 0x5c4(r30)
lbl_80C5B2F0:
/* 80C5B2F0  34 1E 05 A8 */	addic. r0, r30, 0x5a8
/* 80C5B2F4  41 82 00 10 */	beq lbl_80C5B304
/* 80C5B2F8  3C 60 80 C6 */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80C5B454@ha */
/* 80C5B2FC  38 03 B4 54 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80C5B454@l */
/* 80C5B300  90 1E 05 A8 */	stw r0, 0x5a8(r30)
lbl_80C5B304:
/* 80C5B304  28 1E 00 00 */	cmplwi r30, 0
/* 80C5B308  41 82 00 1C */	beq lbl_80C5B324
/* 80C5B30C  3C 60 80 3B */	lis r3, __vt__16dBgS_MoveBgActor@ha /* 0x803AB9A0@ha */
/* 80C5B310  38 03 B9 A0 */	addi r0, r3, __vt__16dBgS_MoveBgActor@l /* 0x803AB9A0@l */
/* 80C5B314  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C5B318  7F C3 F3 78 */	mr r3, r30
/* 80C5B31C  38 80 00 00 */	li r4, 0
/* 80C5B320  4B 3B D9 6D */	bl __dt__10fopAc_ac_cFv
lbl_80C5B324:
/* 80C5B324  7F E0 07 35 */	extsh. r0, r31
/* 80C5B328  40 81 00 0C */	ble lbl_80C5B334
/* 80C5B32C  7F C3 F3 78 */	mr r3, r30
/* 80C5B330  4B 67 3A 0D */	bl __dl__FPv
lbl_80C5B334:
