...
/* 80C5A48C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5A490  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C5A494  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C5A498  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C5A49C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C5A4A0  4B 6E C4 49 */	bl PSMTXTrans
/* 80C5A4A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5A4A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C5A4AC  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C5A4B0  4B 3B 1F 85 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80C5A4D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5A4D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C5A4D8  80 9F 05 C0 */	lwz r4, 0x5c0(r31)
/* 80C5A4DC  38 84 00 24 */	addi r4, r4, 0x24
/* 80C5A4E0  4B 6E BF D1 */	bl PSMTXCopy
