...
/* 80BE2B48  4B 77 F6 95 */	bl _savegpr_29
/* 80BE2B4C  7C 7D 1B 78 */	mr r29, r3
/* 80BE2B50  7C 9E 23 78 */	mr r30, r4
/* 80BE2B54  3C 60 80 BE */	lis r3, lit_3673@ha /* 0x80BE2F98@ha */
/* 80BE2B58  3B E3 2F 98 */	addi r31, r3, lit_3673@l /* 0x80BE2F98@l */
/* 80BE2B5C  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80BE2B60  7C 03 07 74 */	extsb r3, r0
/* 80BE2B64  4B 44 A5 09 */	bl dComIfGp_getReverb__Fi
...
/* 80BE2B78  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BE2B7C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BE2BA4  4B 6C 99 69 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80BE2BA8  38 60 01 F6 */	li r3, 0x1f6
/* 80BE2BAC  3C 80 80 BE */	lis r4, data_80BE30F8@ha /* 0x80BE30F8@ha */
/* 80BE2BB0  38 84 30 F8 */	addi r4, r4, data_80BE30F8@l /* 0x80BE30F8@l */
/* 80BE2BB4  4B 43 6E 79 */	bl fopAcM_SearchByName__FsPP10fopAc_ac_c
/* 80BE2BB8  2C 03 00 00 */	cmpwi r3, 0
/* 80BE2BBC  41 82 00 24 */	beq lbl_80BE2BE0
/* 80BE2BC0  3C 60 80 BE */	lis r3, data_80BE30F8@ha /* 0x80BE30F8@ha */
/* 80BE2BC4  38 63 30 F8 */	addi r3, r3, data_80BE30F8@l /* 0x80BE30F8@l */
...
/* 80BE2BD8  3C 60 80 BE */	lis r3, data_80BE30FC@ha /* 0x80BE30FC@ha */
/* 80BE2BDC  90 03 30 FC */	stw r0, data_80BE30FC@l(r3)  /* 0x80BE30FC@l */
lbl_80BE2BE0:
...
/* 80BE2C80  3C 60 80 BE */	lis r3, data_80BE30F8@ha /* 0x80BE30F8@ha */
/* 80BE2C84  80 03 30 F8 */	lwz r0, data_80BE30F8@l(r3)  /* 0x80BE30F8@l */
...
/* 80BE2CBC  4B 43 B0 C9 */	bl waterCheck__11fopAcM_wt_cFPC4cXyz
/* 80BE2CC0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BE2CC4  41 82 00 14 */	beq lbl_80BE2CD8
/* 80BE2CC8  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha /* 0x80450CD8@ha */
/* 80BE2CCC  C0 23 0C D8 */	lfs f1, mWaterY__11fopAcM_wt_c@l(r3)  /* 0x80450CD8@l */
/* 80BE2CD0  C0 1F 00 70 */	lfs f0, 0x70(r31)
/* 80BE2CD4  EF E1 00 28 */	fsubs f31, f1, f0
lbl_80BE2CD8:
/* 80BE2CD8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BE2CDC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80BE2D1C  4B 68 CC 61 */	bl cLib_addCalc__FPfffff
/* 80BE2D20  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BE2D24  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80BE2D94  4B 68 D7 AD */	bl cLib_addCalcAngleS__FPsssss
/* 80BE2D98  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BE2D9C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80BE2E2C  4B 68 CB 51 */	bl cLib_addCalc__FPfffff
...
/* 80BE2E44  4B 68 CB 39 */	bl cLib_addCalc__FPfffff
/* 80BE2E48  7F A3 EB 78 */	mr r3, r29
/* 80BE2E4C  38 9D 05 E4 */	addi r4, r29, 0x5e4
/* 80BE2E50  4B 43 78 7D */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 80BE2E68  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BE2E6C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BE2E70  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80BE2E74  4B 49 3C 39 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80BE2E88  4B 77 F3 A1 */	bl _restgpr_29
