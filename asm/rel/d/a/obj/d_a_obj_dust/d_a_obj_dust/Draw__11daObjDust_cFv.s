...
/* 80BE2EB4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BE2EB8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BE2EBC  38 80 00 10 */	li r4, 0x10
/* 80BE2EC0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BE2EC4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BE2EC8  4B 5C 08 FD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BE2ECC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BE2ED0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BE2ED4  80 9E 06 20 */	lwz r4, 0x620(r30)
/* 80BE2ED8  80 84 00 04 */	lwz r4, 4(r4)
/* 80BE2EDC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BE2EE0  4B 5C 1E C1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BE2EE4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BE2EE8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BE2EEC  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80BE2EF0  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BE2EF4  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BE2F08  4B 42 AD BD */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80BE2F0C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BE2F10  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
