...
/* 8059D9C8  4B A8 F6 41 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 8059D9CC  38 7F 07 4C */	addi r3, r31, 0x74c
/* 8059D9D0  3C 80 80 5A */	lis r4, __dt__5csXyzFv@ha /* 0x8059D2E4@ha */
/* 8059D9D4  38 84 D2 E4 */	addi r4, r4, __dt__5csXyzFv@l /* 0x8059D2E4@l */
/* 8059D9D8  38 A0 00 06 */	li r5, 6
/* 8059D9DC  38 C0 00 03 */	li r6, 3
/* 8059D9E0  4B DC 43 09 */	bl __destroy_arr
/* 8059D9E4  38 7F 07 2C */	addi r3, r31, 0x72c
/* 8059D9E8  38 80 FF FF */	li r4, -1
/* 8059D9EC  4B CC A6 C5 */	bl __dt__13cBgS_PolyInfoFv
/* 8059D9F0  34 1F 05 F0 */	addic. r0, r31, 0x5f0
/* 8059D9F4  41 82 00 84 */	beq lbl_8059DA78
/* 8059D9F8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 8059D9FC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 8059DA1C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 8059DA20  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 8059DA38  3C 60 80 5A */	lis r3, __vt__8cM3dGCyl@ha /* 0x8059E094@ha */
/* 8059DA3C  38 03 E0 94 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x8059E094@l */
/* 8059DA40  90 1F 07 28 */	stw r0, 0x728(r31)
lbl_8059DA44:
/* 8059DA44  34 1F 06 F4 */	addic. r0, r31, 0x6f4
/* 8059DA48  41 82 00 24 */	beq lbl_8059DA6C
/* 8059DA4C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8059DA50  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8059DA54  90 1F 07 10 */	stw r0, 0x710(r31)
/* 8059DA58  34 1F 06 F4 */	addic. r0, r31, 0x6f4
/* 8059DA5C  41 82 00 10 */	beq lbl_8059DA6C
/* 8059DA60  3C 60 80 5A */	lis r3, __vt__8cM3dGAab@ha /* 0x8059E088@ha */
/* 8059DA64  38 03 E0 88 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8059E088@l */
/* 8059DA68  90 1F 07 0C */	stw r0, 0x70c(r31)
lbl_8059DA6C:
/* 8059DA6C  38 7F 05 F0 */	addi r3, r31, 0x5f0
/* 8059DA70  38 80 00 00 */	li r4, 0
/* 8059DA74  4B AE 66 71 */	bl __dt__12dCcD_GObjInfFv
lbl_8059DA78:
/* 8059DA78  34 1F 05 B4 */	addic. r0, r31, 0x5b4
/* 8059DA7C  41 82 00 54 */	beq lbl_8059DAD0
/* 8059DA80  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 8059DA84  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 8059DA9C  3C 60 80 5A */	lis r3, __vt__10dCcD_GStts@ha /* 0x8059E07C@ha */
/* 8059DAA0  38 03 E0 7C */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x8059E07C@l */
/* 8059DAA4  90 1F 05 D0 */	stw r0, 0x5d0(r31)
/* 8059DAA8  34 1F 05 D0 */	addic. r0, r31, 0x5d0
/* 8059DAAC  41 82 00 10 */	beq lbl_8059DABC
/* 8059DAB0  3C 60 80 5A */	lis r3, __vt__10cCcD_GStts@ha /* 0x8059E070@ha */
/* 8059DAB4  38 03 E0 70 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x8059E070@l */
/* 8059DAB8  90 1F 05 D0 */	stw r0, 0x5d0(r31)
lbl_8059DABC:
/* 8059DABC  34 1F 05 B4 */	addic. r0, r31, 0x5b4
/* 8059DAC0  41 82 00 10 */	beq lbl_8059DAD0
/* 8059DAC4  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 8059DAC8  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 8059DACC  90 1F 05 CC */	stw r0, 0x5cc(r31)
lbl_8059DAD0:
/* 8059DAD0  7F E3 FB 78 */	mr r3, r31
/* 8059DAD4  38 80 00 00 */	li r4, 0
/* 8059DAD8  4B A7 B1 B5 */	bl __dt__10fopAc_ac_cFv
lbl_8059DADC:
