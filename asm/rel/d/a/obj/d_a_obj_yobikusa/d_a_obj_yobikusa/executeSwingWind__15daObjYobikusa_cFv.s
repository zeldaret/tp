...
/* 8059CAAC  4B AB E8 4D */	bl dKyw_get_AllWind_vec__FP4cXyzP4cXyzPf
/* 8059CAB0  A8 1F 07 66 */	lha r0, 0x766(r31)
/* 8059CAB4  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 8059CAB8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8059CABC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 8059CAC0  7C 23 04 2E */	lfsx f1, r3, r0
/* 8059CAC4  3C 60 80 5A */	lis r3, M_attr__15daObjYobikusa_c@ha /* 0x8059DE7C@ha */
/* 8059CAC8  38 63 DE 7C */	addi r3, r3, M_attr__15daObjYobikusa_c@l /* 0x8059DE7C@l */
...
/* 8059CAE4  3C 60 80 5A */	lis r3, lit_3699@ha /* 0x8059DEBC@ha */
/* 8059CAE8  C0 03 DE BC */	lfs f0, lit_3699@l(r3)  /* 0x8059DEBC@l */
...
/* 8059CB00  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8059CB04  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8059CB4C  3C 60 80 5A */	lis r3, M_attr__15daObjYobikusa_c@ha /* 0x8059DE7C@ha */
/* 8059CB50  38 63 DE 7C */	addi r3, r3, M_attr__15daObjYobikusa_c@l /* 0x8059DE7C@l */
...
/* 8059CB78  3C 60 80 5A */	lis r3, lit_3699@ha /* 0x8059DEBC@ha */
/* 8059CB7C  C0 03 DE BC */	lfs f0, lit_3699@l(r3)  /* 0x8059DEBC@l */
...
/* 8059CB94  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8059CB98  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8059CBD8  3C 60 80 5A */	lis r3, M_attr__15daObjYobikusa_c@ha /* 0x8059DE7C@ha */
/* 8059CBDC  38 83 DE 7C */	addi r4, r3, M_attr__15daObjYobikusa_c@l /* 0x8059DE7C@l */
...
/* 8059CC28  4B AE 7A 31 */	bl ChkCoHit__12dCcD_GObjInfFv
