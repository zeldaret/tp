...
/* 8059DB04  4B DC 46 D8 */	b _savegpr_29
...
/* 8059DB24  4B A7 B0 40 */	b __ct__10fopAc_ac_cFv
/* 8059DB28  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 8059DB2C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 8059DB30  90 1E 05 CC */	stw r0, 0x5cc(r30)
/* 8059DB34  38 7E 05 D0 */	addi r3, r30, 0x5d0
/* 8059DB38  4B AE 5C 28 */	b __ct__10dCcD_GSttsFv
/* 8059DB3C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 8059DB40  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 8059DB58  4B AE 5E D0 */	b __ct__12dCcD_GObjInfFv
/* 8059DB5C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 8059DB60  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 8059DB64  90 1D 01 20 */	stw r0, 0x120(r29)
/* 8059DB68  3C 60 80 5A */	lis r3, __vt__8cM3dGAab@ha
/* 8059DB6C  38 03 E0 88 */	addi r0, r3, __vt__8cM3dGAab@l
/* 8059DB70  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 8059DB74  3C 60 80 5A */	lis r3, __vt__8cM3dGCyl@ha
/* 8059DB78  38 03 E0 94 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 8059DB7C  90 1D 01 38 */	stw r0, 0x138(r29)
/* 8059DB80  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 8059DB84  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 8059DB88  90 7D 01 20 */	stw r3, 0x120(r29)
/* 8059DB8C  38 03 00 58 */	addi r0, r3, 0x58
/* 8059DB90  90 1D 01 38 */	stw r0, 0x138(r29)
/* 8059DB94  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 8059DB98  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 8059DBB4  4B CC A4 C0 */	b __ct__13cBgS_PolyInfoFv
/* 8059DBB8  38 7E 07 4C */	addi r3, r30, 0x74c
/* 8059DBBC  3C 80 80 5A */	lis r4, __ct__5csXyzFv@ha
/* 8059DBC0  38 84 DC 88 */	addi r4, r4, __ct__5csXyzFv@l
/* 8059DBC4  3C A0 80 5A */	lis r5, __dt__5csXyzFv@ha
/* 8059DBC8  38 A5 D2 E4 */	addi r5, r5, __dt__5csXyzFv@l
/* 8059DBCC  38 C0 00 06 */	li r6, 6
/* 8059DBD0  38 E0 00 03 */	li r7, 3
/* 8059DBD4  4B DC 41 8C */	b __construct_array
lbl_8059DBD8:
...
lbl_8059DC04:
/* 8059DC04  3C 60 80 5A */	lis r3, l_arcName1@ha
/* 8059DC08  80 03 DF 88 */	lwz r0, l_arcName1@l(r3)
/* 8059DC0C  90 1F 07 60 */	stw r0, 0x760(r31)
/* 8059DC10  48 00 00 10 */	b lbl_8059DC20
lbl_8059DC14:
/* 8059DC14  3C 60 80 5A */	lis r3, l_arcName2@ha
/* 8059DC18  80 03 DF 8C */	lwz r0, l_arcName2@l(r3)
/* 8059DC1C  90 1F 07 60 */	stw r0, 0x760(r31)
lbl_8059DC20:
/* 8059DC20  38 7F 05 A4 */	addi r3, r31, 0x5a4
/* 8059DC24  80 9F 07 60 */	lwz r4, 0x760(r31)
/* 8059DC28  4B A8 F2 94 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8059DC3C  3C 80 80 5A */	lis r4, createSolidHeap__FP10fopAc_ac_c@ha
/* 8059DC40  38 84 D5 20 */	addi r4, r4, createSolidHeap__FP10fopAc_ac_c@l
/* 8059DC44  38 A0 10 80 */	li r5, 0x1080
/* 8059DC48  4B A7 C8 68 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8059DC74  4B DC 45 B4 */	b _restgpr_29
