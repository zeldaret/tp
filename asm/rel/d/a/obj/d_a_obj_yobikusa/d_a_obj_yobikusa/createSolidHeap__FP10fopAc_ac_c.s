...
/* 8059D530  4B DC 4C A9 */	bl _savegpr_28
...
lbl_8059D558:
/* 8059D558  3C 60 80 5A */	lis r3, d_a_obj_yobikusa__stringBase0@ha /* 0x8059DF24@ha */
/* 8059D55C  38 63 DF 24 */	addi r3, r3, d_a_obj_yobikusa__stringBase0@l /* 0x8059DF24@l */
/* 8059D560  38 83 00 0E */	addi r4, r3, 0xe
/* 8059D564  3B C3 00 19 */	addi r30, r3, 0x19
/* 8059D568  48 00 00 14 */	b lbl_8059D57C
lbl_8059D56C:
/* 8059D56C  3C 60 80 5A */	lis r3, d_a_obj_yobikusa__stringBase0@ha /* 0x8059DF24@ha */
/* 8059D570  38 63 DF 24 */	addi r3, r3, d_a_obj_yobikusa__stringBase0@l /* 0x8059DF24@l */
/* 8059D574  38 83 00 26 */	addi r4, r3, 0x26
/* 8059D578  3B C3 00 34 */	addi r30, r3, 0x34
lbl_8059D57C:
/* 8059D57C  80 7F 07 60 */	lwz r3, 0x760(r31)
/* 8059D580  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8059D584  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8059D598  4B A9 ED E5 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 8059D5B0  4B A9 ED CD */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 8059D5C8  4B A7 76 8D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8059D5E0  4B A7 76 75 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8059D60C  3C 60 80 5A */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x8059D1C4@ha */
/* 8059D610  38 83 D1 C4 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l /* 0x8059D1C4@l */
...
/* 8059D660  4B DC 4B C5 */	bl _restgpr_28
