...
/* 8059D1D4  4B DC 50 05 */	bl _savegpr_28
...
/* 8059D1F0  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8059D1F4  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8059D210  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8059D214  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8059D218  4B DA 92 99 */	bl PSMTXCopy
...
/* 8059D238  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8059D23C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8059D240  4B A6 F1 5D */	bl mDoMtx_XrotM__FPA4_fs
lbl_8059D244:
/* 8059D244  A8 81 00 0C */	lha r4, 0xc(r1)
/* 8059D248  7C 80 07 35 */	extsh. r0, r4
/* 8059D24C  41 82 00 10 */	beq lbl_8059D25C
/* 8059D250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8059D254  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8059D258  4B A6 F2 75 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_8059D25C:
/* 8059D25C  A8 81 00 0A */	lha r4, 0xa(r1)
/* 8059D260  7C 80 07 35 */	extsh. r0, r4
/* 8059D264  41 82 00 10 */	beq lbl_8059D274
/* 8059D268  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8059D26C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8059D270  4B A6 F1 C5 */	bl mDoMtx_YrotM__FPA4_fs
lbl_8059D274:
...
/* 8059D298  4B A6 FB D9 */	bl scaleM__14mDoMtx_stack_cFRC4cXyz
lbl_8059D29C:
/* 8059D29C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8059D2A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8059D2A4  80 9F 00 84 */	lwz r4, 0x84(r31)
/* 8059D2A8  80 04 00 0C */	lwz r0, 0xc(r4)
/* 8059D2AC  7C 80 F2 14 */	add r4, r0, r30
/* 8059D2B0  4B DA 92 01 */	bl PSMTXCopy
/* 8059D2B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8059D2B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8059D2BC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8059D2C0  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8059D2C4  4B DA 91 ED */	bl PSMTXCopy
/* 8059D2C8  38 60 00 01 */	li r3, 1
lbl_8059D2CC:
/* 8059D2CC  39 61 00 30 */	addi r11, r1, 0x30
/* 8059D2D0  4B DC 4F 55 */	bl _restgpr_28
