...
/* 80C5E854  3C 60 80 C6 */	lis r3, __vt__16daLv4EdShutter_c@ha /* 0x80C5E9EC@ha */
/* 80C5E858  38 63 E9 EC */	addi r3, r3, __vt__16daLv4EdShutter_c@l /* 0x80C5E9EC@l */
...
/* 80C5E870  3C 60 80 C6 */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80C5E9D4@ha */
/* 80C5E874  38 03 E9 D4 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80C5E9D4@l */
/* 80C5E878  90 1E 05 A8 */	stw r0, 0x5a8(r30)
lbl_80C5E87C:
/* 80C5E87C  28 1E 00 00 */	cmplwi r30, 0
/* 80C5E880  41 82 00 1C */	beq lbl_80C5E89C
/* 80C5E884  3C 60 80 3B */	lis r3, __vt__16dBgS_MoveBgActor@ha /* 0x803AB9A0@ha */
/* 80C5E888  38 03 B9 A0 */	addi r0, r3, __vt__16dBgS_MoveBgActor@l /* 0x803AB9A0@l */
/* 80C5E88C  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C5E890  7F C3 F3 78 */	mr r3, r30
/* 80C5E894  38 80 00 00 */	li r4, 0
/* 80C5E898  4B 3B A3 F5 */	bl __dt__10fopAc_ac_cFv
lbl_80C5E89C:
/* 80C5E89C  7F E0 07 35 */	extsh. r0, r31
/* 80C5E8A0  40 81 00 0C */	ble lbl_80C5E8AC
/* 80C5E8A4  7F C3 F3 78 */	mr r3, r30
/* 80C5E8A8  4B 67 04 95 */	bl __dl__FPv
lbl_80C5E8AC:
