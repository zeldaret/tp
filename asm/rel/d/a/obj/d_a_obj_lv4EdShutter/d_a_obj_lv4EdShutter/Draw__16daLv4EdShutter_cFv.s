...
/* 80C5E5E4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C5E5E8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C5E5EC  38 80 00 10 */	li r4, 0x10
/* 80C5E5F0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C5E5F4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C5E5F8  4B 54 51 CD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C5E5FC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C5E600  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C5E604  80 9E 05 C0 */	lwz r4, 0x5c0(r30)
/* 80C5E608  80 84 00 04 */	lwz r4, 4(r4)
/* 80C5E60C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C5E610  4B 54 67 91 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C5E614  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C5E618  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C5E61C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C5E620  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C5E624  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C5E638  4B 3A F6 8D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C5E63C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C5E640  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
