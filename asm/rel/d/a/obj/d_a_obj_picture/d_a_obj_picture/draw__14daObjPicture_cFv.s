...
/* 80CAE06C  4B 6B 41 61 */	bl _savegpr_25
/* 80CAE070  7C 7F 1B 78 */	mr r31, r3
/* 80CAE074  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CAE078  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CAE07C  38 80 00 10 */	li r4, 0x10
/* 80CAE080  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CAE084  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CAE088  4B 4F 57 3D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CAE08C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CAE090  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CAE094  80 9F 0C B8 */	lwz r4, 0xcb8(r31)
/* 80CAE098  80 84 00 04 */	lwz r4, 4(r4)
/* 80CAE09C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CAE0A0  4B 4F 6D 01 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CAE0A4  80 7F 0C B8 */	lwz r3, 0xcb8(r31)
/* 80CAE0A8  4B 35 FB 85 */	bl mDoExt_modelUpdate__FP8J3DModel
...
lbl_80CAE0C0:
/* 80CAE0C0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CAE0C4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CAE0C8  80 9F 0C B4 */	lwz r4, 0xcb4(r31)
/* 80CAE0CC  80 84 00 04 */	lwz r4, 4(r4)
/* 80CAE0D0  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CAE0D4  4B 4F 6C CD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CAE0D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CAE0DC  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CAE0E0  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CAE0E4  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CAE0E8  3B 83 4A C8 */	addi r28, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CAE0FC  4B 35 FB C9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CAE100  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CAE104  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CAE124  3C 60 80 CB */	lis r3, lit_4042@ha /* 0x80CAF064@ha */
/* 80CAE128  3B 83 F0 64 */	addi r28, r3, lit_4042@l /* 0x80CAF064@l */
/* 80CAE12C  3C 60 80 CB */	lis r3, lit_4076@ha /* 0x80CAF068@ha */
/* 80CAE130  3B A3 F0 68 */	addi r29, r3, lit_4076@l /* 0x80CAF068@l */
lbl_80CAE134:
...
/* 80CAE158  4B 36 55 E5 */	bl update__19mDoExt_3DlineMat1_cFifR8_GXColorUsP12dKy_tevstr_c
...
/* 80CAE188  4B 36 65 B1 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
...
/* 80CAE1A4  4B 6B 40 75 */	bl _restgpr_25
