...
/* 80CAD920  4B 6B 48 95 */	bl _savegpr_19
/* 80CAD924  7C 7C 1B 78 */	mr r28, r3
/* 80CAD928  3C 60 80 CB */	lis r3, l_dzbIdx@ha /* 0x80CAF01C@ha */
/* 80CAD92C  3A A3 F0 1C */	addi r21, r3, l_dzbIdx@l /* 0x80CAF01C@l */
/* 80CAD930  80 1C 00 B0 */	lwz r0, 0xb0(r28)
/* 80CAD934  54 1E 07 FE */	clrlwi r30, r0, 0x1f
/* 80CAD938  3C 60 80 CB */	lis r3, l_arcName@ha /* 0x80CAF0E8@ha */
/* 80CAD93C  38 63 F0 E8 */	addi r3, r3, l_arcName@l /* 0x80CAF0E8@l */
/* 80CAD940  80 63 00 00 */	lwz r3, 0(r3)
/* 80CAD944  38 80 00 05 */	li r4, 5
/* 80CAD948  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CAD94C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CAD960  4B 38 E9 8D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CAD970  4B 36 72 E5 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CAD9B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CAD9B8  3A C3 D4 70 */	addi r22, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CAD9BC  7E D7 B3 78 */	mr r23, r22
/* 80CAD9C0  3C 60 80 CB */	lis r3, l_arcName@ha /* 0x80CAF0E8@ha */
/* 80CAD9C4  3B 03 F0 E8 */	addi r24, r3, l_arcName@l /* 0x80CAF0E8@l */
...
/* 80CAD9E4  4B 62 12 69 */	bl __nw__FUl
/* 80CAD9E8  7C 60 1B 79 */	or. r0, r3, r3
/* 80CAD9EC  41 82 00 0C */	beq lbl_80CAD9F8
/* 80CAD9F0  4B 3C DF 81 */	bl __ct__4dBgWFv
...
/* 80CADA50  4B 69 8E 99 */	bl PSMTXTrans
...
/* 80CADA64  4B 35 E8 3D */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80CADA68  FC 20 F8 90 */	fmr f1, f31
/* 80CADA6C  FC 40 F8 90 */	fmr f2, f31
/* 80CADA70  FC 60 F8 90 */	fmr f3, f31
/* 80CADA74  4B 35 F3 C5 */	bl scaleM__14mDoMtx_stack_cFfff
...
/* 80CADA88  4B 69 8A 29 */	bl PSMTXCopy
...
/* 80CADA9C  4B 38 E8 51 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CADAB0  4B 3C C4 89 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80CADAD0  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80CADAD4  38 03 5A D8 */	addi r0, r3, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
...
lbl_80CADB08:
/* 80CADB08  3C 60 80 CB */	lis r3, l_arcName@ha /* 0x80CAF0E8@ha */
/* 80CADB0C  38 63 F0 E8 */	addi r3, r3, l_arcName@l /* 0x80CAF0E8@l */
...
/* 80CADB28  4B 38 E7 C5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CADB38  4B 36 71 1D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CADB5C  3C 60 80 CB */	lis r3, l_arcName@ha /* 0x80CAF0E8@ha */
/* 80CADB60  3A A3 F0 E8 */	addi r21, r3, l_arcName@l /* 0x80CAF0E8@l */
lbl_80CADB64:
/* 80CADB64  38 60 00 3C */	li r3, 0x3c
/* 80CADB68  4B 62 10 E5 */	bl __nw__FUl
/* 80CADB6C  28 03 00 00 */	cmplwi r3, 0
/* 80CADB70  41 82 00 1C */	beq lbl_80CADB8C
/* 80CADB74  3C 80 80 CB */	lis r4, __vt__18mDoExt_3DlineMat_c@ha /* 0x80CAF1F0@ha */
/* 80CADB78  38 04 F1 F0 */	addi r0, r4, __vt__18mDoExt_3DlineMat_c@l /* 0x80CAF1F0@l */
/* 80CADB7C  90 03 00 00 */	stw r0, 0(r3)
/* 80CADB80  3C 80 80 3A */	lis r4, __vt__19mDoExt_3DlineMat1_c@ha /* 0x803A3248@ha */
/* 80CADB84  38 04 32 48 */	addi r0, r4, __vt__19mDoExt_3DlineMat1_c@l /* 0x803A3248@l */
...
/* 80CADBB8  4B 38 E7 35 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CADBD0  4B 36 57 91 */	bl init__19mDoExt_3DlineMat1_cFUsUsP7ResTIMGi
...
/* 80CADC04  4B 6B 45 FD */	bl _restgpr_19
