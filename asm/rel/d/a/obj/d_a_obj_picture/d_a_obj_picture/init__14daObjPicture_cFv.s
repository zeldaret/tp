...
/* 80CAE528  3C 60 80 CB */	lis r3, l_dzbIdx@ha /* 0x80CAF01C@ha */
/* 80CAE52C  3B E3 F0 1C */	addi r31, r3, l_dzbIdx@l /* 0x80CAF01C@l */
...
/* 80CAE55C  4B 35 E8 09 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80CAE560  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80CAE564  4B 35 E9 E1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CAE568  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CAE56C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CAE570  38 81 00 08 */	addi r4, r1, 8
/* 80CAE574  38 BE 0C 94 */	addi r5, r30, 0xc94
/* 80CAE578  4B 69 87 F5 */	bl PSMTXMultVec
/* 80CAE57C  C0 1F 00 7C */	lfs f0, 0x7c(r31)
/* 80CAE580  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80CAE584  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CAE588  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CAE58C  38 81 00 08 */	addi r4, r1, 8
/* 80CAE590  38 BE 0C A0 */	addi r5, r30, 0xca0
/* 80CAE594  4B 69 87 D9 */	bl PSMTXMultVec
