...
/* 80CAE64C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAE650  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CAE654  C0 3F 04 A8 */	lfs f1, 0x4a8(r31)
/* 80CAE658  3C 80 80 CB */	lis r4, lit_3926@ha
/* 80CAE65C  C0 44 F0 30 */	lfs f2, lit_3926@l(r4)
/* 80CAE660  C0 1F 04 AC */	lfs f0, 0x4ac(r31)
/* 80CAE664  EC 42 00 2A */	fadds f2, f2, f0
/* 80CAE668  C0 7F 04 B0 */	lfs f3, 0x4b0(r31)
/* 80CAE66C  4B 69 82 7C */	b PSMTXTrans
/* 80CAE670  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAE674  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CAE678  A8 9F 04 B4 */	lha r4, 0x4b4(r31)
/* 80CAE67C  A8 BF 04 B6 */	lha r5, 0x4b6(r31)
/* 80CAE680  A8 DF 04 B8 */	lha r6, 0x4b8(r31)
/* 80CAE684  4B 35 DC 1C */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80CAE688  3C 60 80 CB */	lis r3, lit_3927@ha
/* 80CAE68C  C0 23 F0 34 */	lfs f1, lit_3927@l(r3)
/* 80CAE690  FC 40 08 90 */	fmr f2, f1
/* 80CAE694  FC 60 08 90 */	fmr f3, f1
/* 80CAE698  4B 35 E7 A0 */	b scaleM__14mDoMtx_stack_cFfff
/* 80CAE69C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAE6A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CAE6A4  80 9F 0C B8 */	lwz r4, 0xcb8(r31)
/* 80CAE6A8  38 84 00 24 */	addi r4, r4, 0x24
/* 80CAE6AC  4B 69 7E 04 */	b PSMTXCopy
