...
/* 80BF27B4  3C 60 80 BF */	lis r3, d_a_obj_fw__stringBase0@ha /* 0x80BF2BA4@ha */
/* 80BF27B8  38 63 2B A4 */	addi r3, r3, d_a_obj_fw__stringBase0@l /* 0x80BF2BA4@l */
/* 80BF27BC  88 1F 05 70 */	lbz r0, 0x570(r31)
/* 80BF27C0  54 00 10 3A */	slwi r0, r0, 2
/* 80BF27C4  3C 80 80 BF */	lis r4, bmdd@ha /* 0x80BF2BAC@ha */
/* 80BF27C8  38 84 2B AC */	addi r4, r4, bmdd@l /* 0x80BF2BAC@l */
/* 80BF27CC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80BF27D0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF27D4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BF27E8  4B 44 9B 05 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BF27F8  4B 42 24 5D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80BF2818  4B 6D C4 35 */	bl __nw__FUl
/* 80BF281C  7C 60 1B 79 */	or. r0, r3, r3
/* 80BF2820  41 82 00 0C */	beq lbl_80BF282C
/* 80BF2824  4B 48 91 4D */	bl __ct__4dBgWFv
...
lbl_80BF2844:
/* 80BF2844  3C 60 80 BF */	lis r3, d_a_obj_fw__stringBase0@ha /* 0x80BF2BA4@ha */
/* 80BF2848  38 63 2B A4 */	addi r3, r3, d_a_obj_fw__stringBase0@l /* 0x80BF2BA4@l */
/* 80BF284C  88 1F 05 70 */	lbz r0, 0x570(r31)
/* 80BF2850  54 00 10 3A */	slwi r0, r0, 2
/* 80BF2854  3C 80 80 BF */	lis r4, dzbd@ha /* 0x80BF2BB4@ha */
/* 80BF2858  38 84 2B B4 */	addi r4, r4, dzbd@l /* 0x80BF2BB4@l */
/* 80BF285C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80BF2860  7F C5 F3 78 */	mr r5, r30
/* 80BF2864  38 C0 00 80 */	li r6, 0x80
/* 80BF2868  4B 44 9A 85 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BF287C  4B 48 76 BD */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80BF2894:
/* 80BF2894  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075A24@ha */
/* 80BF2898  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075A24@l */
/* 80BF289C  80 7F 05 E8 */	lwz r3, 0x5e8(r31)
/* 80BF28A0  90 03 00 B0 */	stw r0, 0xb0(r3)
/* 80BF28A4  3C 60 80 BF */	lis r3, ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 0x80BF2070@ha */
/* 80BF28A8  38 03 20 70 */	addi r0, r3, ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 0x80BF2070@l */
