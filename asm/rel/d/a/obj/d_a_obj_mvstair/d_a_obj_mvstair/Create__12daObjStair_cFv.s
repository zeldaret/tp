...
/* 80C9D174  4B 37 D4 05 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80C9D178  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9D17C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C9D190  4B 3A A5 09 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
/* 80C9D1A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9D1A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9D1AC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C9D1B0  7C 05 07 74 */	extsb r5, r0
/* 80C9D1B4  4B 39 81 AD */	bl isSwitch__10dSv_info_cCFii
...
lbl_80C9D1F8:
/* 80C9D1F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9D1FC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9D200  7F C4 F3 78 */	mr r4, r30
/* 80C9D204  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C9D208  7C 05 07 74 */	extsb r5, r0
/* 80C9D20C  4B 39 81 55 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C9D250  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9D254  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C9D268  4B 39 80 F9 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C9D288  3C 60 80 CA */	lis r3, lit_3709@ha /* 0x80C9E8DC@ha */
/* 80C9D28C  C0 23 E8 DC */	lfs f1, lit_3709@l(r3)  /* 0x80C9E8DC@l */
