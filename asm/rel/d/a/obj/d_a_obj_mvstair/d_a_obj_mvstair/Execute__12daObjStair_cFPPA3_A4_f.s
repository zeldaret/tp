...
/* 80C9D5A4  4B 6C 4C 39 */	bl _savegpr_29
/* 80C9D5A8  7C 7E 1B 78 */	mr r30, r3
/* 80C9D5AC  7C 9D 23 78 */	mr r29, r4
/* 80C9D5B0  3C 80 80 CA */	lis r4, l_bmdName@ha /* 0x80C9E8AC@ha */
/* 80C9D5B4  3B E4 E8 AC */	addi r31, r4, l_bmdName@l /* 0x80C9E8AC@l */
...
/* 80C9D5D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9D5D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C9D5EC  4B 39 7D 75 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C9D60C  4B 36 F7 59 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C9D610  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9D614  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9D618  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80C9D61C  4B 36 EE 19 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C9D620  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9D624  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9D628  38 9E 06 00 */	addi r4, r30, 0x600
/* 80C9D62C  7C 85 23 78 */	mr r5, r4
/* 80C9D630  4B 6A 97 3D */	bl PSMTXMultVec
...
/* 80C9D64C  4B 36 F7 19 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C9D650  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9D654  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9D658  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80C9D65C  4B 36 ED D9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C9D660  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9D664  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9D668  38 9E 06 0C */	addi r4, r30, 0x60c
/* 80C9D66C  7C 85 23 78 */	mr r5, r4
/* 80C9D670  4B 6A 96 FD */	bl PSMTXMultVec
...
/* 80C9D68C  4B 36 F6 D9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C9D690  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9D694  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9D698  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80C9D69C  4B 36 ED 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C9D6A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9D6A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9D6A8  38 9E 06 18 */	addi r4, r30, 0x618
/* 80C9D6AC  7C 85 23 78 */	mr r5, r4
/* 80C9D6B0  4B 6A 96 BD */	bl PSMTXMultVec
...
/* 80C9D6CC  4B 36 F6 99 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C9D6D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9D6D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9D6D8  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80C9D6DC  4B 36 ED 59 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C9D6E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9D6E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9D6E8  38 9E 06 24 */	addi r4, r30, 0x624
/* 80C9D6EC  7C 85 23 78 */	mr r5, r4
/* 80C9D6F0  4B 6A 96 7D */	bl PSMTXMultVec
/* 80C9D6F4  38 60 00 01 */	li r3, 1
/* 80C9D6F8  39 61 00 20 */	addi r11, r1, 0x20
/* 80C9D6FC  4B 6C 4B 2D */	bl _restgpr_29
