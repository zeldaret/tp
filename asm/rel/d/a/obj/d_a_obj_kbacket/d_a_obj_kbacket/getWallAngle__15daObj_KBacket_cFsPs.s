...
/* 8058787C  4B DD A9 51 */	bl _savegpr_25
/* 80587880  7C 79 1B 78 */	mr r25, r3
/* 80587884  7C BA 2B 78 */	mr r26, r5
/* 80587888  3C 60 80 58 */	lis r3, m__21daObj_KBacket_Param_c@ha /* 0x80587D84@ha */
/* 8058788C  3B A3 7D 84 */	addi r29, r3, m__21daObj_KBacket_Param_c@l /* 0x80587D84@l */
/* 80587890  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80587894  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80587898  4B A8 4B 45 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 805878B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 805878B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 805878B8  38 81 00 14 */	addi r4, r1, 0x14
/* 805878BC  38 A1 00 20 */	addi r5, r1, 0x20
/* 805878C0  4B DB F4 AD */	bl PSMTXMultVec
/* 805878C4  38 61 00 20 */	addi r3, r1, 0x20
/* 805878C8  38 99 04 D0 */	addi r4, r25, 0x4d0
/* 805878CC  7C 65 1B 78 */	mr r5, r3
/* 805878D0  4B DB F7 C1 */	bl PSVECAdd
...
/* 805878F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805878F8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805878FC  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80587900  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80587904  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80587920  4B DB F4 4D */	bl PSMTXMultVec
...
/* 8058793C  4B DB F7 55 */	bl PSVECAdd
...
/* 80587950  4B AF 04 15 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80587954  7F 83 E3 78 */	mr r3, r28
/* 80587958  38 99 09 60 */	addi r4, r25, 0x960
/* 8058795C  4B AE CA 59 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 805879A8  4B CD F1 8D */	bl __mi__4cXyzCFRC3Vec
...
/* 805879C4  4B CD FC B1 */	bl cM_atan2s__Fff
...
/* 805879E0  4B DD A8 39 */	bl _restgpr_25
