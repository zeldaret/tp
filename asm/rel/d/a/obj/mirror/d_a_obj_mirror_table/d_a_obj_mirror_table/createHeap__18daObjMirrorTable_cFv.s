...
/* 80C99948  4B 6C 88 89 */	bl _savegpr_26
/* 80C9994C  7C 7F 1B 78 */	mr r31, r3
/* 80C99950  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99954  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
/* 80C99958  80 63 00 00 */	lwz r3, 0(r3)
/* 80C9995C  38 80 00 15 */	li r4, 0x15
/* 80C99960  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C99964  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C99978  4B 3A 29 75 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99988  4B 37 B2 CD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C999A4:
/* 80C999A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C999A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C999AC  3B 83 07 F0 */	addi r28, r3, 0x7f0
/* 80C999B0  7F 83 E3 78 */	mr r3, r28
/* 80C999B4  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C999B8  3B A4 72 88 */	addi r29, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C999BC  A0 9D 02 C4 */	lhz r4, 0x2c4(r29)
/* 80C999C0  4B 39 AF FD */	bl isEventBit__11dSv_event_cCFUs
/* 80C999C4  7C 60 1B 79 */	or. r0, r3, r3
/* 80C999C8  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C999CC  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C999E8  4B 3A 29 05 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C999F8  4B 37 B2 5D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C99A14:
/* 80C99A14  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99A18  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99A2C  4B 3A 28 C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99A30  7C 7A 1B 78 */	mr r26, r3
/* 80C99A34  38 60 00 1C */	li r3, 0x1c
/* 80C99A38  4B 63 52 15 */	bl __nw__FUl
/* 80C99A3C  7C 7B 1B 79 */	or. r27, r3, r3
/* 80C99A40  41 82 00 20 */	beq lbl_80C99A60
/* 80C99A44  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C9B2F8@ha */
/* 80C99A48  38 04 B2 F8 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C9B2F8@l */
/* 80C99A4C  90 1B 00 00 */	stw r0, 0(r27)
/* 80C99A50  38 80 00 00 */	li r4, 0
/* 80C99A54  4B 68 E9 A9 */	bl init__12J3DFrameCtrlFs
...
/* 80C99A74  3C 60 80 CA */	lis r3, lit_3850@ha /* 0x80C9B25C@ha */
/* 80C99A78  C0 23 B2 5C */	lfs f1, lit_3850@l(r3)  /* 0x80C9B25C@l */
/* 80C99A7C  48 00 00 0C */	b lbl_80C99A88
lbl_80C99A80:
/* 80C99A80  3C 60 80 CA */	lis r3, lit_3851@ha /* 0x80C9B260@ha */
/* 80C99A84  C0 23 B2 60 */	lfs f1, lit_3851@l(r3)  /* 0x80C9B260@l */
lbl_80C99A88:
...
/* 80C99AAC  4B 37 3D 31 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80C99AD4  3C 60 80 CA */	lis r3, lit_3853@ha /* 0x80C9B264@ha */
/* 80C99AD8  C8 23 B2 64 */	lfd f1, lit_3853@l(r3)  /* 0x80C9B264@l */
...
lbl_80C99AFC:
/* 80C99AFC  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99B00  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99B14  4B 3A 27 D9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99B28  4B 3E 04 11 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80C99B44  4B 39 AE 79 */	bl isEventBit__11dSv_event_cCFUs
/* 80C99B48  7C 60 1B 79 */	or. r0, r3, r3
/* 80C99B4C  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99B50  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99B6C  4B 3A 27 81 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99B80  4B 3E 03 B9 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80C99BC0  4B 39 AD FD */	bl isEventBit__11dSv_event_cCFUs
/* 80C99BC4  2C 03 00 00 */	cmpwi r3, 0
/* 80C99BC8  41 82 03 50 */	beq lbl_80C99F18
/* 80C99BCC  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99BD0  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99BE4  4B 3A 27 09 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99BF8  4B 37 B0 5D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C99BFC  90 7F 05 70 */	stw r3, 0x570(r31)
/* 80C99C00  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99C04  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99C18  4B 3A 26 D5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99C1C  7C 7A 1B 78 */	mr r26, r3
/* 80C99C20  38 60 00 18 */	li r3, 0x18
/* 80C99C24  4B 63 50 29 */	bl __nw__FUl
/* 80C99C28  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C99C2C  41 82 00 20 */	beq lbl_80C99C4C
/* 80C99C30  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C9B2F8@ha */
/* 80C99C34  38 04 B2 F8 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C9B2F8@l */
/* 80C99C38  90 1C 00 00 */	stw r0, 0(r28)
/* 80C99C3C  38 80 00 00 */	li r4, 0
/* 80C99C40  4B 68 E7 BD */	bl init__12J3DFrameCtrlFs
...
/* 80C99C6C  3D 00 80 CA */	lis r8, lit_3850@ha /* 0x80C9B25C@ha */
/* 80C99C70  C0 28 B2 5C */	lfs f1, lit_3850@l(r8)  /* 0x80C9B25C@l */
/* 80C99C74  39 00 00 00 */	li r8, 0
/* 80C99C78  39 20 FF FF */	li r9, -1
/* 80C99C7C  4B 37 3A 91 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80C99C90:
/* 80C99C90  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99C94  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99CA8  4B 3A 26 45 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99CBC  4B 3E 02 7D */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80C99CD0:
/* 80C99CD0  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99CD4  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99CE8  4B 3A 26 05 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99CF8  4B 37 AF 5D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C99CFC  90 7F 05 74 */	stw r3, 0x574(r31)
/* 80C99D00  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99D04  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99D18  4B 3A 25 D5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99D2C  4B 37 AF 29 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C99D30  90 7F 05 78 */	stw r3, 0x578(r31)
/* 80C99D34  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99D38  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99D4C  4B 3A 25 A1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99D50  7C 7A 1B 78 */	mr r26, r3
/* 80C99D54  38 60 00 18 */	li r3, 0x18
/* 80C99D58  4B 63 4E F5 */	bl __nw__FUl
/* 80C99D5C  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C99D60  41 82 00 20 */	beq lbl_80C99D80
/* 80C99D64  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C9B2F8@ha */
/* 80C99D68  38 04 B2 F8 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C9B2F8@l */
/* 80C99D6C  90 1C 00 00 */	stw r0, 0(r28)
/* 80C99D70  38 80 00 00 */	li r4, 0
/* 80C99D74  4B 68 E6 89 */	bl init__12J3DFrameCtrlFs
...
/* 80C99DA0  3D 00 80 CA */	lis r8, lit_3850@ha /* 0x80C9B25C@ha */
/* 80C99DA4  C0 28 B2 5C */	lfs f1, lit_3850@l(r8)  /* 0x80C9B25C@l */
/* 80C99DA8  39 00 00 00 */	li r8, 0
/* 80C99DAC  39 20 FF FF */	li r9, -1
/* 80C99DB0  4B 37 38 8D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80C99DC4:
/* 80C99DC4  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99DC8  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99DDC  4B 3A 25 11 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99DF0  4B 37 AE 65 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C99DF4  90 7F 05 7C */	stw r3, 0x57c(r31)
/* 80C99DF8  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99DFC  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99E10  4B 3A 24 DD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99E14  7C 7B 1B 78 */	mr r27, r3
/* 80C99E18  38 60 00 18 */	li r3, 0x18
/* 80C99E1C  4B 63 4E 31 */	bl __nw__FUl
/* 80C99E20  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C99E24  41 82 00 20 */	beq lbl_80C99E44
/* 80C99E28  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C9B2F8@ha */
/* 80C99E2C  38 04 B2 F8 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C9B2F8@l */
/* 80C99E30  90 1C 00 00 */	stw r0, 0(r28)
/* 80C99E34  38 80 00 00 */	li r4, 0
/* 80C99E38  4B 68 E5 C5 */	bl init__12J3DFrameCtrlFs
...
/* 80C99E64  3D 00 80 CA */	lis r8, lit_3850@ha /* 0x80C9B25C@ha */
/* 80C99E68  C0 28 B2 5C */	lfs f1, lit_3850@l(r8)  /* 0x80C9B25C@l */
/* 80C99E6C  39 00 00 00 */	li r8, 0
/* 80C99E70  39 20 FF FF */	li r9, -1
/* 80C99E74  4B 37 38 99 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80C99E88:
/* 80C99E88  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80C9B2A4@ha */
/* 80C99E8C  38 63 B2 A4 */	addi r3, r3, l_arcName@l /* 0x80C9B2A4@l */
...
/* 80C99EA0  4B 3A 24 4D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99EA4  7C 7B 1B 78 */	mr r27, r3
/* 80C99EA8  38 60 00 1C */	li r3, 0x1c
/* 80C99EAC  4B 63 4D A1 */	bl __nw__FUl
/* 80C99EB0  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C99EB4  41 82 00 20 */	beq lbl_80C99ED4
/* 80C99EB8  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C9B2F8@ha */
/* 80C99EBC  38 04 B2 F8 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C9B2F8@l */
/* 80C99EC0  90 1C 00 00 */	stw r0, 0(r28)
/* 80C99EC4  38 80 00 00 */	li r4, 0
/* 80C99EC8  4B 68 E5 35 */	bl init__12J3DFrameCtrlFs
...
/* 80C99EF0  3C E0 80 CA */	lis r7, lit_3850@ha /* 0x80C9B25C@ha */
/* 80C99EF4  C0 27 B2 5C */	lfs f1, lit_3850@l(r7)  /* 0x80C9B25C@l */
/* 80C99EF8  38 E0 00 00 */	li r7, 0
/* 80C99EFC  39 00 FF FF */	li r8, -1
/* 80C99F00  39 20 00 00 */	li r9, 0
/* 80C99F04  4B 37 38 D9 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80C99F20  4B 6C 82 FD */	bl _restgpr_26
