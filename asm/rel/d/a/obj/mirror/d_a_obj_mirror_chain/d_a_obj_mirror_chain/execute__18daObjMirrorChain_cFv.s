...
/* 80C97998  4B 6C A8 45 */	bl _savegpr_29
/* 80C9799C  7C 7E 1B 78 */	mr r30, r3
/* 80C979A0  3C 60 80 CA */	lis r3, lit_3915@ha /* 0x80C98028@ha */
/* 80C979A4  3B E3 80 28 */	addi r31, r3, lit_3915@l /* 0x80C98028@l */
/* 80C979A8  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80C979AC  28 03 00 00 */	cmplwi r3, 0
/* 80C979B0  41 82 00 08 */	beq lbl_80C979B8
/* 80C979B4  4B 37 5A 75 */	bl play__14mDoExt_baseAnmFv
lbl_80C979B8:
/* 80C979B8  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80C979BC  28 03 00 00 */	cmplwi r3, 0
/* 80C979C0  41 82 00 08 */	beq lbl_80C979C8
/* 80C979C4  4B 37 5A 65 */	bl play__14mDoExt_baseAnmFv
lbl_80C979C8:
/* 80C979C8  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80C979CC  28 03 00 00 */	cmplwi r3, 0
/* 80C979D0  41 82 00 08 */	beq lbl_80C979D8
/* 80C979D4  4B 37 5A 55 */	bl play__14mDoExt_baseAnmFv
lbl_80C979D8:
/* 80C979D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C979DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C979E0  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C979E4  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C979E8  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C979EC  A0 84 02 C4 */	lhz r4, 0x2c4(r4)
/* 80C979F0  4B 39 CF CD */	bl isEventBit__11dSv_event_cCFUs
...
/* 80C97A28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C97A2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C97A30  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80C97A34  7F A3 EB 78 */	mr r3, r29
/* 80C97A38  4B 3D C8 19 */	bl Release__4cBgSFP9dBgW_Base
/* 80C97A3C  7F A3 EB 78 */	mr r3, r29
/* 80C97A40  38 9E 06 48 */	addi r4, r30, 0x648
/* 80C97A44  7F C5 F3 78 */	mr r5, r30
/* 80C97A48  4B 3D CF C1 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80C97A4C  38 1E 06 48 */	addi r0, r30, 0x648
/* 80C97A50  90 1E 05 84 */	stw r0, 0x584(r30)
/* 80C97A54  80 7E 05 84 */	lwz r3, 0x584(r30)
/* 80C97A58  4B 3E 3F 69 */	bl Move__4dBgWFv
lbl_80C97A5C:
/* 80C97A5C  80 1E 07 08 */	lwz r0, 0x708(r30)
/* 80C97A60  28 00 00 00 */	cmplwi r0, 0
/* 80C97A64  40 82 00 D8 */	bne lbl_80C97B3C
/* 80C97A68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C97A6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C97AB4  4B 3B 4F DD */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C97ACC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C97AD0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C97AD4  4B 6A E9 DD */	bl PSMTXCopy
/* 80C97AD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C97ADC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C97B04  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C97B08  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C97B34  4B 61 3E 51 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C97B4C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C97B50  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C97B54  4B 6A E9 5D */	bl PSMTXCopy
/* 80C97B58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C97B5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C97B90  4B 6C A6 99 */	bl _restgpr_29
