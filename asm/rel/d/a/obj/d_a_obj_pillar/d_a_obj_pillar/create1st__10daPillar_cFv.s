...
/* 80CAF8D4  4B 3C 8D 51 */	bl __ct__16dBgS_MoveBgActorFv
/* 80CAF8D8  3C 60 80 CB */	lis r3, __vt__10daPillar_c@ha /* 0x80CB0BD8@ha */
/* 80CAF8DC  38 03 0B D8 */	addi r0, r3, __vt__10daPillar_c@l /* 0x80CB0BD8@l */
/* 80CAF8E0  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80CAF8E4  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CAF8E8  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CAF8EC  90 1E 05 C4 */	stw r0, 0x5c4(r30)
/* 80CAF8F0  38 7E 05 C8 */	addi r3, r30, 0x5c8
/* 80CAF8F4  4B 3D 3E 6D */	bl __ct__10dCcD_GSttsFv
/* 80CAF8F8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CAF8FC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CAF914  4B 3D 41 15 */	bl __ct__12dCcD_GObjInfFv
/* 80CAF918  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CAF91C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CAF920  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80CAF924  3C 60 80 CB */	lis r3, __vt__8cM3dGAab@ha /* 0x80CB0BCC@ha */
/* 80CAF928  38 03 0B CC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CB0BCC@l */
/* 80CAF92C  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80CAF930  3C 60 80 CB */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CB0BC0@ha */
/* 80CAF934  38 03 0B C0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CB0BC0@l */
/* 80CAF938  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80CAF93C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CAF940  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80CAF944  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80CAF948  38 03 00 58 */	addi r0, r3, 0x58
/* 80CAF94C  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80CAF950  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CAF954  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80CAF9D0  3C 80 80 CB */	lis r4, l_arcName@ha /* 0x80CB0B08@ha */
/* 80CAF9D4  38 84 0B 08 */	addi r4, r4, l_arcName@l /* 0x80CB0B08@l */
/* 80CAF9D8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CAF9DC  4B 37 D4 E1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CAF9F8  3C 80 80 CB */	lis r4, l_arcName@ha /* 0x80CB0B08@ha */
/* 80CAF9FC  38 84 0B 08 */	addi r4, r4, l_arcName@l /* 0x80CB0B08@l */
/* 80CAFA00  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CAFA04  3C A0 80 CB */	lis r5, l_dzb@ha /* 0x80CB09DC@ha */
/* 80CAFA08  38 A5 09 DC */	addi r5, r5, l_dzb@l /* 0x80CB09DC@l */
/* 80CAFA0C  7C A5 00 2E */	lwzx r5, r5, r0
/* 80CAFA10  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075A24@ha */
/* 80CAFA14  38 C6 5A 24 */	addi r6, r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075A24@l */
/* 80CAFA18  3C E0 80 CB */	lis r7, l_heap_size@ha /* 0x80CB09EC@ha */
/* 80CAFA1C  38 E7 09 EC */	addi r7, r7, l_heap_size@l /* 0x80CB09EC@l */
/* 80CAFA20  7C E7 00 2E */	lwzx r7, r7, r0
/* 80CAFA24  39 00 00 00 */	li r8, 0
/* 80CAFA28  4B 3C 8D 95 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
