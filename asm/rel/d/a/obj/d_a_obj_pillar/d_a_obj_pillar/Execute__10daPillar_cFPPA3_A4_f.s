...
/* 80CB03E0  4B 6B 1D F9 */	bl _savegpr_28
/* 80CB03E4  7C 7E 1B 78 */	mr r30, r3
/* 80CB03E8  7C 9F 23 78 */	mr r31, r4
/* 80CB03EC  3C 80 80 CB */	lis r4, l_bmd@ha /* 0x80CB09D4@ha */
/* 80CB03F0  3B A4 09 D4 */	addi r29, r4, l_bmd@l /* 0x80CB09D4@l */
/* 80CB03F4  C0 3D 00 EC */	lfs f1, 0xec(r29)
/* 80CB03F8  3C 80 80 CB */	lis r4, l_HIO@ha /* 0x80CB0C2C@ha */
/* 80CB03FC  38 C4 0C 2C */	addi r6, r4, l_HIO@l /* 0x80CB0C2C@l */
...
/* 80CB041C  4B 36 A6 C5 */	bl fopAcM_rollPlayerCrash__FPC10fopAc_ac_cfUlffif
...
/* 80CB04C8  4B 5C 00 79 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80CB04E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB04E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CB04FC  4B 3B F6 15 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 80CB0520  4B 5C 00 21 */	bl cLib_addCalcAngleS__FPsssss
/* 80CB0524  A8 1E 04 E4 */	lha r0, 0x4e4(r30)
/* 80CB0528  2C 00 01 04 */	cmpwi r0, 0x104
/* 80CB052C  40 80 00 4C */	bge lbl_80CB0578
/* 80CB0530  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB0534  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB0538  3B 83 5B D4 */	addi r28, r3, 0x5bd4
/* 80CB053C  7F 83 E3 78 */	mr r3, r28
/* 80CB0540  38 80 00 1F */	li r4, 0x1f
/* 80CB0544  4B 3B F8 51 */	bl StopQuake__12dVibration_cFi
...
/* 80CB056C  4B 3B F5 A5 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 80CB0590  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB0594  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB0598  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80CB059C  38 80 00 1F */	li r4, 0x1f
/* 80CB05A0  4B 3B F7 F5 */	bl StopQuake__12dVibration_cFi
...
/* 80CB05C4  4B 5B FF 7D */	bl cLib_addCalcAngleS__FPsssss
...
/* 80CB0624  4B 5B EB B9 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80CB0628  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB062C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB0630  38 63 23 3C */	addi r3, r3, 0x233c
/* 80CB0634  38 9E 05 E8 */	addi r4, r30, 0x5e8
/* 80CB0638  4B 5B 45 71 */	bl Set__4cCcSFP8cCcD_Obj
/* 80CB063C  38 60 00 01 */	li r3, 1
/* 80CB0640  39 61 00 30 */	addi r11, r1, 0x30
/* 80CB0644  4B 6B 1B E1 */	bl _restgpr_28
