...
/* 80CB0670  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CB0674  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CB0678  38 80 00 10 */	li r4, 0x10
/* 80CB067C  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CB0680  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CB0684  4B 4F 31 41 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CB0688  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CB068C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CB0690  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80CB0694  80 84 00 04 */	lwz r4, 4(r4)
/* 80CB0698  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CB069C  4B 4F 47 05 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CB06A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB06A4  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB06A8  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CB06AC  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CB06B0  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CB06C4  4B 35 D6 01 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CB06C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB06CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CB06EC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CB06F0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CB06F4  38 80 00 00 */	li r4, 0
/* 80CB06F8  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CB06FC  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CB0700  4B 4F 30 C5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CB0704  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CB0708  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CB070C  80 9F 07 24 */	lwz r4, 0x724(r31)
/* 80CB0710  80 84 00 04 */	lwz r4, 4(r4)
/* 80CB0714  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CB0718  4B 4F 46 89 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CB071C  80 7F 07 24 */	lwz r3, 0x724(r31)
/* 80CB0720  4B 35 D5 A5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80CB0724:
