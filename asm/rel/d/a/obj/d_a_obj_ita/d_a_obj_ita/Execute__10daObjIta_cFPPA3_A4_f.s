...
/* 80C28C88  4B 73 95 51 */	bl _savegpr_28
/* 80C28C8C  7C 7D 1B 78 */	mr r29, r3
/* 80C28C90  7C 9E 23 78 */	mr r30, r4
/* 80C28C94  3C 60 80 C3 */	lis r3, lit_3649@ha /* 0x80C29238@ha */
/* 80C28C98  3B E3 92 38 */	addi r31, r3, lit_3649@l /* 0x80C29238@l */
/* 80C28C9C  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80C28CA0  7C 03 07 74 */	extsb r3, r0
/* 80C28CA4  4B 40 43 C9 */	bl dComIfGp_getReverb__Fi
...
/* 80C28CB8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C28CBC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C28CE4  4B 68 38 29 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
lbl_80C28D08:
/* 80C28D08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C28D0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C28D10  83 83 5D AC */	lwz r28, 0x5dac(r3)
/* 80C28D14  38 60 01 F6 */	li r3, 0x1f6
/* 80C28D18  3C 80 80 C3 */	lis r4, data_80C293F4@ha /* 0x80C293F4@ha */
/* 80C28D1C  38 84 93 F4 */	addi r4, r4, data_80C293F4@l /* 0x80C293F4@l */
/* 80C28D20  4B 3F 0D 0D */	bl fopAcM_SearchByName__FsPP10fopAc_ac_c
/* 80C28D24  2C 03 00 00 */	cmpwi r3, 0
/* 80C28D28  41 82 00 24 */	beq lbl_80C28D4C
/* 80C28D2C  3C 60 80 C3 */	lis r3, data_80C293F4@ha /* 0x80C293F4@ha */
/* 80C28D30  38 63 93 F4 */	addi r3, r3, data_80C293F4@l /* 0x80C293F4@l */
...
/* 80C28D44  3C 60 80 C3 */	lis r3, data_80C293F8@ha /* 0x80C293F8@ha */
/* 80C28D48  90 03 93 F8 */	stw r0, data_80C293F8@l(r3)  /* 0x80C293F8@l */
lbl_80C28D4C:
...
/* 80C28DF8  3C 60 80 C3 */	lis r3, data_80C293F4@ha /* 0x80C293F4@ha */
/* 80C28DFC  80 03 93 F4 */	lwz r0, data_80C293F4@l(r3)  /* 0x80C293F4@l */
...
/* 80C28E38  4B 3F 4F 4D */	bl waterCheck__11fopAcM_wt_cFPC4cXyz
/* 80C28E3C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C28E40  41 82 00 14 */	beq lbl_80C28E54
/* 80C28E44  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha /* 0x80450CD8@ha */
/* 80C28E48  C0 23 0C D8 */	lfs f1, mWaterY__11fopAcM_wt_c@l(r3)  /* 0x80450CD8@l */
/* 80C28E4C  C0 1F 00 8C */	lfs f0, 0x8c(r31)
/* 80C28E50  EF E1 00 28 */	fsubs f31, f1, f0
lbl_80C28E54:
/* 80C28E54  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C28E58  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C28EA0  4B 64 6A DD */	bl cLib_addCalc__FPfffff
/* 80C28EA4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C28EA8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C28F18  4B 64 76 29 */	bl cLib_addCalcAngleS__FPsssss
/* 80C28F1C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C28F20  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C28F88  4B 64 75 B9 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80C28FBC  4B 64 69 C1 */	bl cLib_addCalc__FPfffff
...
/* 80C28FD0  4B 64 6A 6D */	bl cLib_addCalc2__FPffff
...
/* 80C28FE8  4B 64 69 95 */	bl cLib_addCalc__FPfffff
...
/* 80C29000  4B 64 69 7D */	bl cLib_addCalc__FPfffff
...
/* 80C29018  4B 64 75 29 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80C29030  4B 64 75 11 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80C29048  4B 64 74 F9 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80C29060  4B 3F 16 6D */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 80C29078  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C2907C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C29080  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80C29084  4B 44 DA 29 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80C29098  4B 73 91 8D */	bl _restgpr_28
