...
/* 80C28684  4B 73 9B 59 */	bl _savegpr_29
/* 80C28688  7C 7D 1B 78 */	mr r29, r3
/* 80C2868C  3C 60 80 C3 */	lis r3, lit_3649@ha /* 0x80C29238@ha */
/* 80C28690  3B E3 92 38 */	addi r31, r3, lit_3649@l /* 0x80C29238@l */
/* 80C28694  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C28698  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C286D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C286DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C286E0  A8 1D 04 E6 */	lha r0, 0x4e6(r29)
/* 80C286E4  7C 00 00 D0 */	neg r0, r0
/* 80C286E8  7C 04 07 34 */	extsh r4, r0
/* 80C286EC  4B 3E 3C F1 */	bl mDoMtx_YrotS__FPA4_fs
/* 80C286F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C286F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C286F8  38 81 00 08 */	addi r4, r1, 8
/* 80C286FC  7C 85 23 78 */	mr r5, r4
/* 80C28700  4B 71 E6 6D */	bl PSMTXMultVec
...
/* 80C28760  4B 64 7D E1 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80C28774  4B 73 9A B5 */	bl _restgpr_29
