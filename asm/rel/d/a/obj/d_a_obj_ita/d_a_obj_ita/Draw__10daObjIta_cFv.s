...
/* 80C290C4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C290C8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C290CC  38 80 00 10 */	li r4, 0x10
/* 80C290D0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C290D4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C290D8  4B 57 A6 ED */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C290DC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C290E0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C290E4  80 9E 06 24 */	lwz r4, 0x624(r30)
/* 80C290E8  80 84 00 04 */	lwz r4, 4(r4)
/* 80C290EC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C290F0  4B 57 BC B1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C290F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C290F8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C290FC  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C29100  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C29104  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C29118  4B 3E 4B AD */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C2911C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C29120  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
