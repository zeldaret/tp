...
/* 80D05BD0  4B 56 26 05 */	bl ChkUsed__9cBgW_BgIdCFv
/* 80D05BD4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80D05BD8  41 82 00 18 */	beq lbl_80D05BF0
/* 80D05BDC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D05BE0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D05BE4  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80D05BE8  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80D05BEC  4B 36 E6 65 */	bl Release__4cBgSFP9dBgW_Base
lbl_80D05BF0:
/* 80D05BF0  3C 60 80 D0 */	lis r3, l_HIO@ha /* 0x80D0633C@ha */
/* 80D05BF4  38 63 63 3C */	addi r3, r3, l_HIO@l /* 0x80D0633C@l */
...
/* 80D05C08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D05C0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D05C20  4B 56 0F 15 */	bl __mi__4cXyzCFRC3Vec
...
/* 80D05C3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D05C40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D05C44  A8 1F 04 DE */	lha r0, 0x4de(r31)
/* 80D05C48  7C 00 00 D0 */	neg r0, r0
/* 80D05C4C  7C 04 07 34 */	extsh r4, r0
/* 80D05C50  4B 30 67 8D */	bl mDoMtx_YrotS__FPA4_fs
/* 80D05C54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D05C58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D05C5C  38 81 00 14 */	addi r4, r1, 0x14
/* 80D05C60  7C 85 23 78 */	mr r5, r4
/* 80D05C64  4B 64 11 09 */	bl PSMTXMultVec
/* 80D05C68  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80D05C6C  3C 60 80 D0 */	lis r3, lit_3651@ha /* 0x80D060E0@ha */
/* 80D05C70  C0 03 60 E0 */	lfs f0, lit_3651@l(r3)  /* 0x80D060E0@l */
