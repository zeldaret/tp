...
/* 80D05D44  3C 60 80 D0 */	lis r3, lit_3651@ha /* 0x80D060E0@ha */
/* 80D05D48  3B C3 60 E0 */	addi r30, r3, lit_3651@l /* 0x80D060E0@l */
/* 80D05D4C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80D05D50  7C 03 07 74 */	extsb r3, r0
/* 80D05D54  4B 32 73 19 */	bl dComIfGp_getReverb__Fi
...
/* 80D05D68  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D05D6C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D05D94  4B 5A 5B F1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D05DAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D05DB0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D05DB4  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80D05DB8  3C 80 80 D0 */	lis r4, l_HIO@ha /* 0x80D0633C@ha */
/* 80D05DBC  38 84 63 3C */	addi r4, r4, l_HIO@l /* 0x80D0633C@l */
/* 80D05DC0  88 84 00 0C */	lbz r4, 0xc(r4)
/* 80D05DC4  38 A0 00 0F */	li r5, 0xf
/* 80D05DC8  38 C1 00 0C */	addi r6, r1, 0xc
/* 80D05DCC  4B 36 9C 59 */	bl StartShock__12dVibration_cFii4cXyz
/* 80D05DD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D05DD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D05DE8  4B 32 F4 19 */	bl onSwitch__10dSv_info_cFii
/* 80D05DEC  A8 1F 13 84 */	lha r0, 0x1384(r31)
/* 80D05DF0  2C 00 00 00 */	cmpwi r0, 0
/* 80D05DF4  40 82 00 24 */	bne lbl_80D05E18
/* 80D05DF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D05DFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D05E10  4B 32 F4 A1 */	bl offSwitch__10dSv_info_cFii
/* 80D05E14  48 00 00 20 */	b lbl_80D05E34
lbl_80D05E18:
/* 80D05E18  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D05E1C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D05E30  4B 32 F3 D1 */	bl onSwitch__10dSv_info_cFii
lbl_80D05E34:
