...
/* 8058E9AC  4B DD 38 31 */	bl _savegpr_29
/* 8058E9B0  7C 7F 1B 78 */	mr r31, r3
/* 8058E9B4  3C 80 80 59 */	lis r4, lit_3637@ha /* 0x8058F130@ha */
/* 8058E9B8  3B C4 F1 30 */	addi r30, r4, lit_3637@l /* 0x8058F130@l */
...
/* 8058EA60  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058EA64  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058EA7C  3D 00 80 45 */	lis r8, g_whiteColor@ha /* 0x80450608@ha */
/* 8058EA80  39 08 06 08 */	addi r8, r8, g_whiteColor@l /* 0x80450608@l */
/* 8058EA84  7D 09 43 78 */	mr r9, r8
/* 8058EA88  39 40 00 00 */	li r10, 0
/* 8058EA8C  C0 3E 00 58 */	lfs f1, 0x58(r30)
/* 8058EA90  4B AB E7 29 */	bl setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
...
/* 8058EAA8  3D 00 80 45 */	lis r8, g_whiteColor@ha /* 0x80450608@ha */
/* 8058EAAC  39 08 06 08 */	addi r8, r8, g_whiteColor@l /* 0x80450608@l */
/* 8058EAB0  7D 09 43 78 */	mr r9, r8
/* 8058EAB4  39 40 00 00 */	li r10, 0
/* 8058EAB8  C0 3E 00 58 */	lfs f1, 0x58(r30)
/* 8058EABC  4B AB E6 FD */	bl setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
...
/* 8058EAD4  3D 00 80 45 */	lis r8, g_whiteColor@ha /* 0x80450608@ha */
/* 8058EAD8  39 08 06 08 */	addi r8, r8, g_whiteColor@l /* 0x80450608@l */
/* 8058EADC  7D 09 43 78 */	mr r9, r8
/* 8058EAE0  39 40 00 00 */	li r10, 0
/* 8058EAE4  C0 3E 00 58 */	lfs f1, 0x58(r30)
/* 8058EAE8  4B AB E6 D1 */	bl setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
/* 8058EAEC  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8058EAF0  7C 03 07 74 */	extsb r3, r0
/* 8058EAF4  4B A9 E5 79 */	bl dComIfGp_getReverb__Fi
...
/* 8058EB08  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058EB0C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058EB34  4B D1 D9 D9 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8058EB38:
/* 8058EB38  80 BF 07 34 */	lwz r5, 0x734(r31)
/* 8058EB3C  28 05 00 00 */	cmplwi r5, 0
/* 8058EB40  41 82 00 58 */	beq lbl_8058EB98
/* 8058EB44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058EB48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058EB4C  88 85 05 87 */	lbz r4, 0x587(r5)
/* 8058EB50  88 05 04 BA */	lbz r0, 0x4ba(r5)
/* 8058EB54  7C 05 07 74 */	extsb r5, r0
/* 8058EB58  4B AA 68 09 */	bl isSwitch__10dSv_info_cCFii
...
/* 8058EBF0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058EBF4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058EBF8  88 9F 06 F8 */	lbz r4, 0x6f8(r31)
/* 8058EBFC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 8058EC00  7C 05 07 74 */	extsb r5, r0
/* 8058EC04  4B AA 65 FD */	bl onSwitch__10dSv_info_cFii
/* 8058EC08  48 00 00 1C */	b lbl_8058EC24
lbl_8058EC0C:
/* 8058EC0C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058EC10  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058EC14  88 9F 06 F8 */	lbz r4, 0x6f8(r31)
/* 8058EC18  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 8058EC1C  7C 05 07 74 */	extsb r5, r0
/* 8058EC20  4B AA 66 91 */	bl offSwitch__10dSv_info_cFii
lbl_8058EC24:
/* 8058EC24  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8058EC28  7C 03 07 74 */	extsb r3, r0
/* 8058EC2C  4B A9 E4 41 */	bl dComIfGp_getReverb__Fi
...
/* 8058EC40  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058EC44  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058EC6C  4B D1 CD 19 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 8058ECCC  4B A9 E3 A1 */	bl dComIfGp_getReverb__Fi
...
/* 8058ECE0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058ECE4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058ED0C  4B D1 CC 79 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8058ED10  88 9F 06 F8 */	lbz r4, 0x6f8(r31)
/* 8058ED14  28 04 00 FF */	cmplwi r4, 0xff
/* 8058ED18  40 82 00 18 */	bne lbl_8058ED30
/* 8058ED1C  3C 60 80 59 */	lis r3, l_HIO@ha /* 0x8058F2AC@ha */
/* 8058ED20  38 63 F2 AC */	addi r3, r3, l_HIO@l /* 0x8058F2AC@l */
...
/* 8058ED3C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058ED40  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058ED44  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 8058ED48  7C 05 07 74 */	extsb r5, r0
/* 8058ED4C  4B AA 65 65 */	bl offSwitch__10dSv_info_cFii
/* 8058ED50  48 00 00 18 */	b lbl_8058ED68
lbl_8058ED54:
/* 8058ED54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058ED58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058ED5C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 8058ED60  7C 05 07 74 */	extsb r5, r0
/* 8058ED64  4B AA 64 9D */	bl onSwitch__10dSv_info_cFii
lbl_8058ED68:
/* 8058ED68  38 7F 05 B0 */	addi r3, r31, 0x5b0
/* 8058ED6C  4B AF 57 8D */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 8058ED70  28 03 00 00 */	cmplwi r3, 0
/* 8058ED74  41 82 00 C8 */	beq lbl_8058EE3C
/* 8058ED78  4B CD 4C D1 */	bl GetAc__8cCcD_ObjFv
...
/* 8058EDBC  4B AF 57 8D */	bl GetTgHitGObj__12dCcD_GObjInfFv
...
/* 8058EDE8  4B AF 57 95 */	bl GetTgHitObjSe__12dCcD_GObjInfFv
/* 8058EDEC  38 80 00 01 */	li r4, 1
/* 8058EDF0  4B AF 57 C1 */	bl getHitSeID__12dCcD_GObjInfFUci
...
/* 8058EE10  4B D2 F6 95 */	bl startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
...
/* 8058EE24  4B D2 F6 81 */	bl startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
lbl_8058EE28:
...
/* 8058EE44  4B A9 E2 29 */	bl dComIfGp_getReverb__Fi
...
/* 8058EE6C  4B CE 03 95 */	bl SetR__8cM3dGCylFf
/* 8058EE70  38 7F 06 D4 */	addi r3, r31, 0x6d4
/* 8058EE74  C0 3E 00 78 */	lfs f1, 0x78(r30)
/* 8058EE78  4B CE 03 81 */	bl SetH__8cM3dGCylFf
/* 8058EE7C  38 7F 06 D4 */	addi r3, r31, 0x6d4
/* 8058EE80  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 8058EE84  4B CE 03 59 */	bl SetC__8cM3dGCylFRC4cXyz
/* 8058EE88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058EE8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058EE90  38 63 23 3C */	addi r3, r3, 0x233c
/* 8058EE94  38 9F 05 B0 */	addi r4, r31, 0x5b0
/* 8058EE98  4B CD 5D 11 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8058EEB4  4B DD 33 75 */	bl _restgpr_29
