...
/* 80BEBC5C  3C A0 80 BF */	lis r5, M_attr__11daObjFlag_c@ha /* 0x80BEC4EC@ha */
/* 80BEBC60  38 E5 C4 EC */	addi r7, r5, M_attr__11daObjFlag_c@l /* 0x80BEC4EC@l */
/* 80BEBC64  A8 07 00 0E */	lha r0, 0xe(r7)
/* 80BEBC68  3C A0 80 BF */	lis r5, lit_3764@ha /* 0x80BEC53C@ha */
/* 80BEBC6C  C8 65 C5 3C */	lfd f3, lit_3764@l(r5)  /* 0x80BEC53C@l */
...
/* 80BEBC88  3C A0 80 BF */	lis r5, lit_3791@ha /* 0x80BEC544@ha */
/* 80BEBC8C  C0 05 C5 44 */	lfs f0, lit_3791@l(r5)  /* 0x80BEC544@l */
...
/* 80BEBCA8  3C A0 80 44 */	lis r5, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BEBCAC  38 A5 9A 20 */	addi r5, r5, sincosTable___5JMath@l /* 0x80439A20@l */
...
lbl_80BEBCF0:
/* 80BEBCF0  3C 60 80 BF */	lis r3, M_attr__11daObjFlag_c@ha /* 0x80BEC4EC@ha */
/* 80BEBCF4  38 63 C4 EC */	addi r3, r3, M_attr__11daObjFlag_c@l /* 0x80BEC4EC@l */
...
/* 80BEBD0C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BEBD10  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80BEBD38  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BEBD3C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80BEBD40  7C 63 04 2E */	lfsx f3, r3, r0
/* 80BEBD44  A8 07 00 0E */	lha r0, 0xe(r7)
/* 80BEBD48  3C 60 80 BF */	lis r3, lit_3764@ha /* 0x80BEC53C@ha */
/* 80BEBD4C  C8 43 C5 3C */	lfd f2, lit_3764@l(r3)  /* 0x80BEC53C@l */
...
/* 80BEBD80  3C 60 80 BF */	lis r3, M_attr__11daObjFlag_c@ha /* 0x80BEC4EC@ha */
/* 80BEBD84  38 63 C4 EC */	addi r3, r3, M_attr__11daObjFlag_c@l /* 0x80BEC4EC@l */
