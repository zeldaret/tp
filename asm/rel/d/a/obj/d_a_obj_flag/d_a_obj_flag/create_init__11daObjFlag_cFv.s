...
/* 80BEB78C  4B 44 60 E5 */	bl getArcName__12daSetBgObj_cFP10fopAc_ac_c
/* 80BEB790  3C 80 80 BF */	lis r4, d_a_obj_flag__stringBase0@ha /* 0x80BEC554@ha */
/* 80BEB794  38 84 C5 54 */	addi r4, r4, d_a_obj_flag__stringBase0@l /* 0x80BEC554@l */
/* 80BEB798  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BEB79C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BEB7A0  3C A5 00 02 */	addis r5, r5, 2
/* 80BEB7A4  38 C0 00 80 */	li r6, 0x80
/* 80BEB7A8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BEB7AC  4B 45 0B D1 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80BEB7B0  80 03 00 00 */	lwz r0, 0(r3)
/* 80BEB7B4  54 00 04 3E */	clrlwi r0, r0, 0x10
/* 80BEB7B8  3C 60 80 BF */	lis r3, lit_3639@ha /* 0x80BEC524@ha */
/* 80BEB7BC  C8 23 C5 24 */	lfd f1, lit_3639@l(r3)  /* 0x80BEC524@l */
...
/* 80BEB804  4B 67 C0 69 */	bl cM_rnd__Fv
/* 80BEB808  3C 60 80 BF */	lis r3, lit_3637@ha /* 0x80BEC520@ha */
/* 80BEB80C  C0 03 C5 20 */	lfs f0, lit_3637@l(r3)  /* 0x80BEC520@l */
...
/* 80BEB824  4B 67 C0 49 */	bl cM_rnd__Fv
/* 80BEB828  3C 60 80 BF */	lis r3, lit_3637@ha /* 0x80BEC520@ha */
/* 80BEB82C  C0 03 C5 20 */	lfs f0, lit_3637@l(r3)  /* 0x80BEC520@l */
...
/* 80BEB854  4B 67 C0 19 */	bl cM_rnd__Fv
/* 80BEB858  3C 60 80 BF */	lis r3, lit_3637@ha /* 0x80BEC520@ha */
/* 80BEB85C  C0 03 C5 20 */	lfs f0, lit_3637@l(r3)  /* 0x80BEC520@l */
...
/* 80BEB874  4B 67 BF F9 */	bl cM_rnd__Fv
/* 80BEB878  3C 60 80 BF */	lis r3, lit_3637@ha /* 0x80BEC520@ha */
/* 80BEB87C  C0 03 C5 20 */	lfs f0, lit_3637@l(r3)  /* 0x80BEC520@l */
...
/* 80BEB894  4B 67 BF D9 */	bl cM_rnd__Fv
/* 80BEB898  3C 60 80 BF */	lis r3, lit_3637@ha /* 0x80BEC520@ha */
/* 80BEB89C  C0 03 C5 20 */	lfs f0, lit_3637@l(r3)  /* 0x80BEC520@l */
...
/* 80BEB8B4  4B 67 BF B9 */	bl cM_rnd__Fv
/* 80BEB8B8  3C 60 80 BF */	lis r3, lit_3637@ha /* 0x80BEC520@ha */
/* 80BEB8BC  C0 03 C5 20 */	lfs f0, lit_3637@l(r3)  /* 0x80BEC520@l */
