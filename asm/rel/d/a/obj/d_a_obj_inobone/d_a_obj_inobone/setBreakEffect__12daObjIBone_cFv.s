...
/* 80C27E58  4B 73 A3 7D */	bl _savegpr_27
/* 80C27E5C  7C 7E 1B 78 */	mr r30, r3
/* 80C27E60  3C 60 80 C3 */	lis r3, l_cyl_src@ha /* 0x80C28120@ha */
/* 80C27E64  3B E3 81 20 */	addi r31, r3, l_cyl_src@l /* 0x80C28120@l */
...
/* 80C27E80  3C 60 80 C3 */	lis r3, d_a_obj_inobone__stringBase0@ha /* 0x80C281C4@ha */
/* 80C27E84  38 63 81 C4 */	addi r3, r3, d_a_obj_inobone__stringBase0@l /* 0x80C281C4@l */
/* 80C27E88  38 63 00 2A */	addi r3, r3, 0x2a
/* 80C27E8C  38 80 00 20 */	li r4, 0x20
/* 80C27E90  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C27E94  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C27EA8  4B 41 44 45 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C27EAC  7C 7C 1B 78 */	mr r28, r3
/* 80C27EB0  3C 60 80 C3 */	lis r3, d_a_obj_inobone__stringBase0@ha /* 0x80C281C4@ha */
/* 80C27EB4  38 63 81 C4 */	addi r3, r3, d_a_obj_inobone__stringBase0@l /* 0x80C281C4@l */
...
/* 80C27EC8  4B 41 44 25 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C27ECC  7C 7B 1B 78 */	mr r27, r3
/* 80C27ED0  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C27ED4  7C 05 07 74 */	extsb r5, r0
/* 80C27ED8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C27EDC  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C27EE0  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)
/* 80C27EE4  3C 80 80 45 */	lis r4, mEcallback__18dPa_modelEcallBack@ha /* 0x80450E90@ha */
/* 80C27EE8  38 04 0E 90 */	addi r0, r4, mEcallback__18dPa_modelEcallBack@l /* 0x80450E90@l */
...
/* 80C27F2C  4B 42 4B 65 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C27F48  4B 42 2C B9 */	bl setModel__18dPa_modelEcallBackFP14JPABaseEmitterP12J3DModelDataRC12dKy_tevstr_cUcPvUcUc
...
/* 80C27F90  4B 42 4B 01 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C27FA0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C27FA4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C27FD0  4B 68 39 B5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C27FD4  39 61 00 50 */	addi r11, r1, 0x50
/* 80C27FD8  4B 73 A2 49 */	bl _restgpr_27
