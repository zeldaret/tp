...
/* 80597BF8  4B AE BE 31 */	bl __ct__12dCcD_GObjInfFv
/* 80597BFC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80597C00  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80597C04  90 1F 01 20 */	stw r0, 0x120(r31)
/* 80597C08  3C 60 80 5A */	lis r3, __vt__8cM3dGAab@ha /* 0x805980B0@ha */
/* 80597C0C  38 03 80 B0 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805980B0@l */
/* 80597C10  90 1F 01 1C */	stw r0, 0x11c(r31)
/* 80597C14  38 7F 01 24 */	addi r3, r31, 0x124
/* 80597C18  4B CD 73 71 */	bl __ct__8cM3dGCpsFv
/* 80597C1C  3C 60 80 3C */	lis r3, __vt__12cCcD_CpsAttr@ha /* 0x803C3608@ha */
/* 80597C20  38 63 36 08 */	addi r3, r3, __vt__12cCcD_CpsAttr@l /* 0x803C3608@l */
/* 80597C24  90 7F 01 20 */	stw r3, 0x120(r31)
/* 80597C28  38 03 00 58 */	addi r0, r3, 0x58
/* 80597C2C  90 1F 01 3C */	stw r0, 0x13c(r31)
/* 80597C30  3C 60 80 3B */	lis r3, __vt__8dCcD_Cps@ha /* 0x803AC170@ha */
/* 80597C34  38 63 C1 70 */	addi r3, r3, __vt__8dCcD_Cps@l /* 0x803AC170@l */
