...
/* 80597608  4B DC AB C9 */	bl _savegpr_26
/* 8059760C  7C 7D 1B 78 */	mr r29, r3
/* 80597610  3C 60 80 59 */	lis r3, l_brgBmdIdx@ha /* 0x80597D7C@ha */
/* 80597614  3B E3 7D 7C */	addi r31, r3, l_brgBmdIdx@l /* 0x80597D7C@l */
/* 80597618  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8059761C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80597620  38 80 00 10 */	li r4, 0x10
/* 80597624  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80597628  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8059762C  4B C0 C1 99 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80597630  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80597634  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80597638  80 9D 05 B0 */	lwz r4, 0x5b0(r29)
/* 8059763C  80 84 00 04 */	lwz r4, 4(r4)
/* 80597640  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80597644  4B C0 D7 5D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80597648  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8059764C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80597650  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80597654  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80597658  3B 83 4A C8 */	addi r28, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8059766C  4B A7 66 59 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80597670  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80597674  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80597694  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80597698  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8059769C  38 80 00 00 */	li r4, 0
/* 805976A0  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 805976A4  38 DD 01 0C */	addi r6, r29, 0x10c
/* 805976A8  4B C0 C1 1D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805976AC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805976B0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805976B4  80 9D 05 B4 */	lwz r4, 0x5b4(r29)
/* 805976B8  80 84 00 04 */	lwz r4, 4(r4)
/* 805976BC  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805976C0  4B C0 D6 E1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 805976C4  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 805976C8  4B A7 65 FD */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_805976CC:
...
/* 80597704  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80597708  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80597770  4B A7 BF CD */	bl update__19mDoExt_3DlineMat1_cFifR8_GXColorUsP12dKy_tevstr_c
...
/* 805977A0  4B A7 CF 99 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
lbl_805977A4:
...
/* 805977BC  4B DC AA 61 */	bl _restgpr_26
