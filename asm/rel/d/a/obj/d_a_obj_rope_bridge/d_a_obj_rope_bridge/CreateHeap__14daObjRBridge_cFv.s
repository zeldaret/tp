...
/* 80596B98  4B DC B6 39 */	bl _savegpr_26
/* 80596B9C  7C 7E 1B 78 */	mr r30, r3
/* 80596BA0  88 03 0A F0 */	lbz r0, 0xaf0(r3)
/* 80596BA4  54 00 10 3A */	slwi r0, r0, 2
/* 80596BA8  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x80597E84@ha */
/* 80596BAC  38 63 7E 84 */	addi r3, r3, l_arcName@l /* 0x80597E84@l */
/* 80596BB0  7C 63 00 2E */	lwzx r3, r3, r0
/* 80596BB4  3C 80 80 59 */	lis r4, l_brgBmdIdx@ha /* 0x80597D7C@ha */
/* 80596BB8  38 84 7D 7C */	addi r4, r4, l_brgBmdIdx@l /* 0x80597D7C@l */
/* 80596BBC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80596BC0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80596BC4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80596BD8  4B AA 57 15 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80596BE8  4B A7 E0 6D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80596C04:
/* 80596C04  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80596C08  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80596C1C  4B A9 E7 45 */	bl isSwitch__10dSv_info_cCFii
/* 80596C20  2C 03 00 00 */	cmpwi r3, 0
/* 80596C24  40 82 00 48 */	bne lbl_80596C6C
/* 80596C28  3C 60 80 59 */	lis r3, l_ropeArcName@ha /* 0x80597E8C@ha */
/* 80596C2C  38 63 7E 8C */	addi r3, r3, l_ropeArcName@l /* 0x80597E8C@l */
...
/* 80596C40  4B AA 56 AD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80596C50  4B A7 E0 05 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80596C74:
/* 80596C74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80596C78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80596C8C  4B A9 E6 D5 */	bl isSwitch__10dSv_info_cCFii
/* 80596C90  2C 03 00 00 */	cmpwi r3, 0
/* 80596C94  40 82 01 18 */	bne lbl_80596DAC
/* 80596C98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80596C9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80596CB0  4B A9 E6 B1 */	bl isSwitch__10dSv_info_cCFii
...
/* 80596CD0  4B D3 7F F5 */	bl __nwa__FUl
/* 80596CD4  3C 80 80 59 */	lis r4, __ct__4cXyzFv@ha /* 0x80596DE8@ha */
/* 80596CD8  38 84 6D E8 */	addi r4, r4, __ct__4cXyzFv@l /* 0x80596DE8@l */
/* 80596CDC  3C A0 80 59 */	lis r5, __dt__4cXyzFv@ha /* 0x80596130@ha */
/* 80596CE0  38 A5 61 30 */	addi r5, r5, __dt__4cXyzFv@l /* 0x80596130@l */
/* 80596CE4  38 C0 00 0C */	li r6, 0xc
/* 80596CE8  7F 87 E3 78 */	mr r7, r28
/* 80596CEC  4B DC B2 29 */	bl __construct_new_array
...
/* 80596D10  3C 60 80 59 */	lis r3, l_ropeArcName@ha /* 0x80597E8C@ha */
/* 80596D14  3B 83 7E 8C */	addi r28, r3, l_ropeArcName@l /* 0x80597E8C@l */
lbl_80596D18:
/* 80596D18  38 60 00 3C */	li r3, 0x3c
/* 80596D1C  4B D3 7F 31 */	bl __nw__FUl
/* 80596D20  28 03 00 00 */	cmplwi r3, 0
/* 80596D24  41 82 00 1C */	beq lbl_80596D40
/* 80596D28  3C 80 80 5A */	lis r4, __vt__18mDoExt_3DlineMat_c@ha /* 0x805980BC@ha */
/* 80596D2C  38 04 80 BC */	addi r0, r4, __vt__18mDoExt_3DlineMat_c@l /* 0x805980BC@l */
/* 80596D30  90 03 00 00 */	stw r0, 0(r3)
/* 80596D34  3C 80 80 3A */	lis r4, __vt__19mDoExt_3DlineMat1_c@ha /* 0x803A3248@ha */
/* 80596D38  38 04 32 48 */	addi r0, r4, __vt__19mDoExt_3DlineMat1_c@l /* 0x803A3248@l */
...
/* 80596D6C  4B AA 55 81 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80596D84  4B A7 C5 DD */	bl init__19mDoExt_3DlineMat1_cFUsUsP7ResTIMGi
...
/* 80596DD4  4B DC B4 49 */	bl _restgpr_26
