...
/* 80CF3D94  4B 66 E4 2D */	bl _savegpr_22
/* 80CF3D98  7C 76 1B 78 */	mr r22, r3
/* 80CF3D9C  3C 60 80 CF */	lis r3, l_color@ha /* 0x80CF43E4@ha */
/* 80CF3DA0  3B E3 43 E4 */	addi r31, r3, l_color@l /* 0x80CF43E4@l */
/* 80CF3DA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF3DA8  3A E3 61 C0 */	addi r23, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF3DAC  83 17 5D AC */	lwz r24, 0x5dac(r23)
/* 80CF3DB0  38 78 04 D0 */	addi r3, r24, 0x4d0
/* 80CF3DB4  38 96 04 D0 */	addi r4, r22, 0x4d0
/* 80CF3DB8  4B 57 CE 4D */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80CF3DD0  4B 32 6B 95 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80CF3E00  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80CF3E04  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80CF3E08  38 81 00 0C */	addi r4, r1, 0xc
/* 80CF3E0C  4B 32 59 ED */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80CF3E10  7C 77 1B 79 */	or. r23, r3, r3
/* 80CF3E14  41 82 00 40 */	beq lbl_80CF3E54
/* 80CF3E18  4B 32 4E C9 */	bl fopAc_IsActor__FPv
...
/* 80CF3E88  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80CF3E8C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80CF3E90  38 81 00 08 */	addi r4, r1, 8
/* 80CF3E94  4B 32 59 65 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80CF4058  4B 66 E1 B5 */	bl _restgpr_22
