...
/* 80CF4208  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF420C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF4220  4B 34 11 41 */	bl isSwitch__10dSv_info_cCFii
/* 80CF4224  2C 03 00 00 */	cmpwi r3, 0
/* 80CF4228  40 82 00 20 */	bne lbl_80CF4248
/* 80CF422C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF4230  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF4244  4B 34 10 6D */	bl offSwitch__10dSv_info_cFii
lbl_80CF4248:
/* 80CF4248  38 7F 05 7C */	addi r3, r31, 0x57c
/* 80CF424C  3C 80 80 CF */	lis r4, l_arcName@ha /* 0x80CF4438@ha */
/* 80CF4250  38 84 44 38 */	addi r4, r4, l_arcName@l /* 0x80CF4438@l */
/* 80CF4254  80 84 00 00 */	lwz r4, 0(r4)
/* 80CF4258  4B 33 8D B1 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
