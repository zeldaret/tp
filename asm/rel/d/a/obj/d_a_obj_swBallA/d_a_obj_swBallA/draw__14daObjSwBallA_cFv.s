...
/* 80CF407C  4B 66 E1 5D */	bl _savegpr_28
/* 80CF4080  7C 7E 1B 78 */	mr r30, r3
/* 80CF4084  3C 60 80 CF */	lis r3, l_color@ha /* 0x80CF43E4@ha */
/* 80CF4088  3B 83 43 E4 */	addi r28, r3, l_color@l /* 0x80CF43E4@l */
/* 80CF408C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF4090  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF4094  38 80 00 00 */	li r4, 0
/* 80CF4098  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CF409C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CF40A0  4B 4A F7 25 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CF40A4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF40A8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF40AC  80 9E 05 84 */	lwz r4, 0x584(r30)
/* 80CF40B0  80 84 00 04 */	lwz r4, 4(r4)
/* 80CF40B4  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CF40B8  4B 4B 0C E9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CF40BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF40C0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF40C4  80 04 5F 78 */	lwz r0, 0x5f78(r4)
/* 80CF40C8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CF40CC  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CF4150  4B 65 2B 95 */	bl C_MTXLightOrtho
/* 80CF4154  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF4158  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF415C  38 80 40 00 */	li r4, 0x4000
/* 80CF4160  4B 31 81 E5 */	bl mDoMtx_XrotS__FPA4_fs
...
/* 80CF417C  4B 31 8C 21 */	bl transM__14mDoMtx_stack_cFfff
/* 80CF4180  38 61 00 08 */	addi r3, r1, 8
/* 80CF4184  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF4188  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF418C  38 BD 00 24 */	addi r5, r29, 0x24
/* 80CF4190  4B 65 23 55 */	bl PSMTXConcat
lbl_80CF4194:
...
/* 80CF41A8  4B 31 95 31 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80CF41AC  80 7E 05 84 */	lwz r3, 0x584(r30)
/* 80CF41B0  4B 31 9B 15 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CF41B4  80 7E 05 84 */	lwz r3, 0x584(r30)
/* 80CF41B8  80 63 00 04 */	lwz r3, 4(r3)
/* 80CF41BC  4B 31 9C 35 */	bl mDoExt_btkAnmRemove__FP12J3DModelData
/* 80CF41C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF41C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF41E0  4B 66 E0 45 */	bl _restgpr_28
