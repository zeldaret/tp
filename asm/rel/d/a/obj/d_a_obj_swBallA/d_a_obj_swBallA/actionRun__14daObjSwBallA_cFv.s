...
/* 80CF3BAC  4B 33 94 C1 */	bl dComIfGp_getReverb__Fi
...
/* 80CF3BC0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CF3BC4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CF3BD8  3D 00 80 CF */	lis r8, lit_3918@ha /* 0x80CF4404@ha */
/* 80CF3BDC  C0 28 44 04 */	lfs f1, lit_3918@l(r8)  /* 0x80CF4404@l */
/* 80CF3BE0  FC 40 08 90 */	fmr f2, f1
/* 80CF3BE4  3D 00 80 CF */	lis r8, lit_4032@ha /* 0x80CF4408@ha */
/* 80CF3BE8  C0 68 44 08 */	lfs f3, lit_4032@l(r8)  /* 0x80CF4408@l */
/* 80CF3BEC  FC 80 18 90 */	fmr f4, f3
/* 80CF3BF0  39 00 00 00 */	li r8, 0
/* 80CF3BF4  4B 5B 7D 91 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CF3BF8  3C 60 80 CF */	lis r3, lit_3918@ha /* 0x80CF4404@ha */
/* 80CF3BFC  C0 03 44 04 */	lfs f0, lit_3918@l(r3)  /* 0x80CF4404@l */
...
/* 80CF3C2C  4B 33 94 41 */	bl dComIfGp_getReverb__Fi
...
/* 80CF3C40  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CF3C44  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CF3C58  3D 00 80 CF */	lis r8, lit_3918@ha /* 0x80CF4404@ha */
/* 80CF3C5C  C0 28 44 04 */	lfs f1, lit_3918@l(r8)  /* 0x80CF4404@l */
/* 80CF3C60  FC 40 08 90 */	fmr f2, f1
/* 80CF3C64  3D 00 80 CF */	lis r8, lit_4032@ha /* 0x80CF4408@ha */
/* 80CF3C68  C0 68 44 08 */	lfs f3, lit_4032@l(r8)  /* 0x80CF4408@l */
/* 80CF3C6C  FC 80 18 90 */	fmr f4, f3
/* 80CF3C70  39 00 00 00 */	li r8, 0
/* 80CF3C74  4B 5B 7D 11 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CF3C78  3C 60 80 CF */	lis r3, lit_4032@ha /* 0x80CF4408@ha */
/* 80CF3C7C  C0 03 44 08 */	lfs f0, lit_4032@l(r3)  /* 0x80CF4408@l */
/* 80CF3C80  80 7F 05 88 */	lwz r3, 0x588(r31)
/* 80CF3C84  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 80CF3C88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF3C8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF3CA0  4B 34 16 11 */	bl offSwitch__10dSv_info_cFii
...
/* 80CF3CB4  4B 31 97 75 */	bl play__14mDoExt_baseAnmFv
/* 80CF3CB8  2C 03 00 00 */	cmpwi r3, 0
/* 80CF3CBC  41 82 00 58 */	beq lbl_80CF3D14
/* 80CF3CC0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF3CC4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF3CD8  4B 34 15 29 */	bl onSwitch__10dSv_info_cFii
...
/* 80CF3CF8  4B 35 4C 49 */	bl orderEvent__17dEvLib_callback_cFiii
lbl_80CF3CFC:
...
/* 80CF3D1C  4B 33 93 51 */	bl dComIfGp_getReverb__Fi
...
/* 80CF3D30  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CF3D34  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CF3D48  3D 00 80 CF */	lis r8, lit_3918@ha /* 0x80CF4404@ha */
/* 80CF3D4C  C0 28 44 04 */	lfs f1, lit_3918@l(r8)  /* 0x80CF4404@l */
/* 80CF3D50  FC 40 08 90 */	fmr f2, f1
/* 80CF3D54  3D 00 80 CF */	lis r8, lit_4032@ha /* 0x80CF4408@ha */
/* 80CF3D58  C0 68 44 08 */	lfs f3, lit_4032@l(r8)  /* 0x80CF4408@l */
/* 80CF3D5C  FC 80 18 90 */	fmr f4, f3
/* 80CF3D60  39 00 00 00 */	li r8, 0
/* 80CF3D64  4B 5B 87 A9 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80CF3D68:
