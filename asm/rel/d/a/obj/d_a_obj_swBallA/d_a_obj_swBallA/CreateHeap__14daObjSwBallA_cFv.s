...
/* 80CF380C  4B 66 E9 CD */	bl _savegpr_28
/* 80CF3810  7C 7F 1B 78 */	mr r31, r3
/* 80CF3814  3C 60 80 CF */	lis r3, l_arcName@ha /* 0x80CF4438@ha */
/* 80CF3818  38 63 44 38 */	addi r3, r3, l_arcName@l /* 0x80CF4438@l */
/* 80CF381C  80 63 00 00 */	lwz r3, 0(r3)
/* 80CF3820  38 80 00 04 */	li r4, 4
/* 80CF3824  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF3828  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF383C  4B 34 8A B1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CF3850  4B 32 14 05 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80CF386C:
/* 80CF386C  3C 60 80 CF */	lis r3, l_arcName@ha /* 0x80CF4438@ha */
/* 80CF3870  38 63 44 38 */	addi r3, r3, l_arcName@l /* 0x80CF4438@l */
...
/* 80CF3884  4B 34 8A 69 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80CF3888  7C 7C 1B 78 */	mr r28, r3
/* 80CF388C  38 60 00 18 */	li r3, 0x18
/* 80CF3890  4B 5D B3 BD */	bl __nw__FUl
/* 80CF3894  7C 7E 1B 79 */	or. r30, r3, r3
/* 80CF3898  41 82 00 20 */	beq lbl_80CF38B8
/* 80CF389C  3C 80 80 CF */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80CF44F8@ha */
/* 80CF38A0  38 04 44 F8 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80CF44F8@l */
/* 80CF38A4  90 1E 00 00 */	stw r0, 0(r30)
/* 80CF38A8  38 80 00 00 */	li r4, 0
/* 80CF38AC  4B 63 4B 51 */	bl init__12J3DFrameCtrlFs
...
/* 80CF38D8  3D 00 80 CF */	lis r8, lit_3918@ha /* 0x80CF4404@ha */
/* 80CF38DC  C0 28 44 04 */	lfs f1, lit_3918@l(r8)  /* 0x80CF4404@l */
/* 80CF38E0  39 00 00 00 */	li r8, 0
/* 80CF38E4  39 20 FF FF */	li r9, -1
/* 80CF38E8  4B 31 9D 55 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80CF38FC:
/* 80CF38FC  3C 60 80 CF */	lis r3, lit_3733@ha /* 0x80CF43F4@ha */
/* 80CF3900  C0 03 43 F4 */	lfs f0, lit_3733@l(r3)  /* 0x80CF43F4@l */
...
/* 80CF3914  4B 66 E9 11 */	bl _restgpr_28
