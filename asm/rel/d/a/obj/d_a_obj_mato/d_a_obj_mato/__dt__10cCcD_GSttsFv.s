...
/* 80C92C18  3C A0 80 C9 */	lis r5, __vt__10cCcD_GStts@ha /* 0x80C92DAC@ha */
/* 80C92C1C  38 05 2D AC */	addi r0, r5, __vt__10cCcD_GStts@l /* 0x80C92DAC@l */
/* 80C92C20  90 1F 00 00 */	stw r0, 0(r31)
/* 80C92C24  7C 80 07 35 */	extsh. r0, r4
/* 80C92C28  40 81 00 08 */	ble lbl_80C92C30
/* 80C92C2C  4B 63 C1 11 */	bl __dl__FPv
lbl_80C92C30:
