...
/* 80C9294C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C92950  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C92970  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C92974  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80C9298C  3C 60 80 C9 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C92DD0@ha */
/* 80C92990  38 03 2D D0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C92DD0@l */
/* 80C92994  90 1E 01 78 */	stw r0, 0x178(r30)
lbl_80C92998:
/* 80C92998  34 1E 01 44 */	addic. r0, r30, 0x144
/* 80C9299C  41 82 00 24 */	beq lbl_80C929C0
/* 80C929A0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C929A4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C929A8  90 1E 01 60 */	stw r0, 0x160(r30)
/* 80C929AC  34 1E 01 44 */	addic. r0, r30, 0x144
/* 80C929B0  41 82 00 10 */	beq lbl_80C929C0
/* 80C929B4  3C 60 80 C9 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C92DC4@ha */
/* 80C929B8  38 03 2D C4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C92DC4@l */
/* 80C929BC  90 1E 01 5C */	stw r0, 0x15c(r30)
lbl_80C929C0:
/* 80C929C0  38 7E 00 40 */	addi r3, r30, 0x40
/* 80C929C4  38 80 00 00 */	li r4, 0
/* 80C929C8  4B 3F 17 1D */	bl __dt__12dCcD_GObjInfFv
lbl_80C929CC:
/* 80C929CC  34 1E 00 04 */	addic. r0, r30, 4
/* 80C929D0  41 82 00 54 */	beq lbl_80C92A24
/* 80C929D4  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C929D8  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C929F0  3C 60 80 C9 */	lis r3, __vt__10dCcD_GStts@ha /* 0x80C92DB8@ha */
/* 80C929F4  38 03 2D B8 */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x80C92DB8@l */
/* 80C929F8  90 1E 00 20 */	stw r0, 0x20(r30)
/* 80C929FC  34 1E 00 20 */	addic. r0, r30, 0x20
/* 80C92A00  41 82 00 10 */	beq lbl_80C92A10
/* 80C92A04  3C 60 80 C9 */	lis r3, __vt__10cCcD_GStts@ha /* 0x80C92DAC@ha */
/* 80C92A08  38 03 2D AC */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x80C92DAC@l */
/* 80C92A0C  90 1E 00 20 */	stw r0, 0x20(r30)
lbl_80C92A10:
/* 80C92A10  34 1E 00 04 */	addic. r0, r30, 4
/* 80C92A14  41 82 00 10 */	beq lbl_80C92A24
/* 80C92A18  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C92A1C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
...
/* 80C92A30  4B 63 C3 0D */	bl __dl__FPv
lbl_80C92A34:
