...
/* 80C92A68  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C92A6C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C92A70  90 1F 00 1C */	stw r0, 0x1c(r31)
/* 80C92A74  38 7F 00 20 */	addi r3, r31, 0x20
/* 80C92A78  4B 3F 0C E9 */	bl __ct__10dCcD_GSttsFv
/* 80C92A7C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C92A80  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C92A98  4B 3F 0F 91 */	bl __ct__12dCcD_GObjInfFv
/* 80C92A9C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C92AA0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C92AA4  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C92AA8  3C 60 80 C9 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C92DC4@ha */
/* 80C92AAC  38 03 2D C4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C92DC4@l */
/* 80C92AB0  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80C92AB4  3C 60 80 C9 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C92DD0@ha */
/* 80C92AB8  38 03 2D D0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C92DD0@l */
/* 80C92ABC  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C92AC0  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C92AC4  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80C92AC8  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80C92ACC  38 03 00 58 */	addi r0, r3, 0x58
/* 80C92AD0  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C92AD4  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C92AD8  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
