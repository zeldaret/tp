...
/* 80C4A310  4B 71 7E CD */	bl _savegpr_29
...
/* 80C4A324  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4A328  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4A32C  38 80 00 0A */	li r4, 0xa
/* 80C4A330  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A334  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A338  3C A5 00 02 */	addis r5, r5, 2
/* 80C4A33C  38 C0 00 80 */	li r6, 0x80
/* 80C4A340  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4A344  4B 3F 1F A9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C4A348  7C 7E 1B 78 */	mr r30, r3
/* 80C4A34C  48 00 00 2C */	b lbl_80C4A378
lbl_80C4A350:
/* 80C4A350  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4A354  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4A358  38 80 00 0B */	li r4, 0xb
/* 80C4A35C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A360  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A364  3C A5 00 02 */	addis r5, r5, 2
/* 80C4A368  38 C0 00 80 */	li r6, 0x80
/* 80C4A36C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4A370  4B 3F 1F 7D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C4A374  7C 7E 1B 78 */	mr r30, r3
lbl_80C4A378:
/* 80C4A378  38 60 00 58 */	li r3, 0x58
/* 80C4A37C  4B 68 48 D1 */	bl __nw__FUl
/* 80C4A380  7C 7D 1B 79 */	or. r29, r3, r3
/* 80C4A384  41 82 00 74 */	beq lbl_80C4A3F8
/* 80C4A388  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4A38C  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4A390  38 80 00 07 */	li r4, 7
/* 80C4A394  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A398  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A39C  3C A5 00 02 */	addis r5, r5, 2
/* 80C4A3A0  38 C0 00 80 */	li r6, 0x80
/* 80C4A3A4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4A3A8  4B 3F 1F 45 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4A3E0  3D 20 80 C5 */	lis r9, lit_3895@ha /* 0x80C4D4DC@ha */
/* 80C4A3E4  C0 29 D4 DC */	lfs f1, lit_3895@l(r9)  /* 0x80C4D4DC@l */
/* 80C4A3E8  39 20 00 00 */	li r9, 0
/* 80C4A3EC  39 40 FF FF */	li r10, -1
/* 80C4A3F0  4B 3C 63 E1 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80C4A420  4B 68 48 2D */	bl __nw__FUl
/* 80C4A424  7C 7D 1B 79 */	or. r29, r3, r3
/* 80C4A428  41 82 00 20 */	beq lbl_80C4A448
/* 80C4A42C  3C 80 80 C5 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C4D640@ha */
/* 80C4A430  38 04 D6 40 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C4D640@l */
/* 80C4A434  90 1D 00 00 */	stw r0, 0(r29)
/* 80C4A438  38 80 00 00 */	li r4, 0
/* 80C4A43C  4B 6D DF C1 */	bl init__12J3DFrameCtrlFs
...
/* 80C4A46C  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4A470  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4A474  38 80 00 0E */	li r4, 0xe
/* 80C4A478  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A47C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A480  3C A5 00 02 */	addis r5, r5, 2
/* 80C4A484  38 C0 00 80 */	li r6, 0x80
/* 80C4A488  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4A48C  4B 3F 1E 61 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4A4A8  3D 00 80 C5 */	lis r8, lit_3895@ha /* 0x80C4D4DC@ha */
/* 80C4A4AC  C0 28 D4 DC */	lfs f1, lit_3895@l(r8)  /* 0x80C4D4DC@l */
/* 80C4A4B0  39 00 00 00 */	li r8, 0
/* 80C4A4B4  39 20 FF FF */	li r9, -1
/* 80C4A4B8  4B 3C 32 55 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80C4A4CC:
/* 80C4A4CC  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4A4D0  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4A4D4  38 80 00 0F */	li r4, 0xf
/* 80C4A4D8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A4DC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A4E0  3C A5 00 02 */	addis r5, r5, 2
/* 80C4A4E4  38 C0 00 80 */	li r6, 0x80
/* 80C4A4E8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4A4EC  4B 3F 1E 01 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4A508  3D 00 80 C5 */	lis r8, lit_3895@ha /* 0x80C4D4DC@ha */
/* 80C4A50C  C0 28 D4 DC */	lfs f1, lit_3895@l(r8)  /* 0x80C4D4DC@l */
/* 80C4A510  39 00 00 00 */	li r8, 0
/* 80C4A514  39 20 FF FF */	li r9, -1
/* 80C4A518  4B 3C 31 F5 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C4A530  4B 68 47 1D */	bl __nw__FUl
/* 80C4A534  7C 7D 1B 79 */	or. r29, r3, r3
/* 80C4A538  41 82 00 20 */	beq lbl_80C4A558
/* 80C4A53C  3C 80 80 C5 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C4D640@ha */
/* 80C4A540  38 04 D6 40 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C4D640@l */
/* 80C4A544  90 1D 00 00 */	stw r0, 0(r29)
/* 80C4A548  38 80 00 00 */	li r4, 0
/* 80C4A54C  4B 6D DE B1 */	bl init__12J3DFrameCtrlFs
...
/* 80C4A57C  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4A580  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4A584  38 80 00 12 */	li r4, 0x12
/* 80C4A588  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A58C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A590  3C A5 00 02 */	addis r5, r5, 2
/* 80C4A594  38 C0 00 80 */	li r6, 0x80
/* 80C4A598  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4A59C  4B 3F 1D 51 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4A5B8  3D 00 80 C5 */	lis r8, lit_3895@ha /* 0x80C4D4DC@ha */
/* 80C4A5BC  C0 28 D4 DC */	lfs f1, lit_3895@l(r8)  /* 0x80C4D4DC@l */
/* 80C4A5C0  39 00 00 00 */	li r8, 0
/* 80C4A5C4  39 20 FF FF */	li r9, -1
/* 80C4A5C8  4B 3C 30 75 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80C4A5DC:
/* 80C4A5DC  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4A5E0  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4A5E4  38 80 00 13 */	li r4, 0x13
/* 80C4A5E8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A5EC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A5F0  3C A5 00 02 */	addis r5, r5, 2
/* 80C4A5F4  38 C0 00 80 */	li r6, 0x80
/* 80C4A5F8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4A5FC  4B 3F 1C F1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4A618  3D 00 80 C5 */	lis r8, lit_3895@ha /* 0x80C4D4DC@ha */
/* 80C4A61C  C0 28 D4 DC */	lfs f1, lit_3895@l(r8)  /* 0x80C4D4DC@l */
/* 80C4A620  39 00 00 00 */	li r8, 0
/* 80C4A624  39 20 FF FF */	li r9, -1
/* 80C4A628  4B 3C 30 15 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C4A644  4B 71 7B E5 */	bl _restgpr_29
