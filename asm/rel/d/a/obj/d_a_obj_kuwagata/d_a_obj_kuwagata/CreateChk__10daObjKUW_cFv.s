...
/* 80C4C99C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4C9A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4C9A4  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C4C9A8  7F E3 FB 78 */	mr r3, r31
/* 80C4C9AC  3C 80 80 C5 */	lis r4, l_musiya_num@ha /* 0x80C4D574@ha */
/* 80C4C9B0  A0 04 D5 74 */	lhz r0, l_musiya_num@l(r4)  /* 0x80C4D574@l */
/* 80C4C9B4  54 00 08 3C */	slwi r0, r0, 1
/* 80C4C9B8  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C4C9BC  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C4C9C0  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C4C9C4  4B 3E 7F F9 */	bl isEventBit__11dSv_event_cCFUs
/* 80C4C9C8  2C 03 00 00 */	cmpwi r3, 0
/* 80C4C9CC  41 82 00 30 */	beq lbl_80C4C9FC
/* 80C4C9D0  7F E3 FB 78 */	mr r3, r31
/* 80C4C9D4  3C 80 80 C5 */	lis r4, l_musiya_num@ha /* 0x80C4D574@ha */
/* 80C4C9D8  38 84 D5 74 */	addi r4, r4, l_musiya_num@l /* 0x80C4D574@l */
/* 80C4C9DC  A0 04 00 02 */	lhz r0, 2(r4)
/* 80C4C9E0  54 00 08 3C */	slwi r0, r0, 1
/* 80C4C9E4  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C4C9E8  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C4C9EC  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C4C9F0  4B 3E 7F CD */	bl isEventBit__11dSv_event_cCFUs
...
lbl_80C4CA04:
/* 80C4CA04  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4CA08  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4CA0C  38 63 00 06 */	addi r3, r3, 6
/* 80C4CA10  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4CA14  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4CA18  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C4CA1C  4B 71 BF 79 */	bl strcmp
/* 80C4CA20  2C 03 00 00 */	cmpwi r3, 0
/* 80C4CA24  40 82 00 CC */	bne lbl_80C4CAF0
/* 80C4CA28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4CA2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C4CA40  3C 60 80 C5 */	lis r3, l_kuw_itemno@ha /* 0x80C4D548@ha */
/* 80C4CA44  38 63 D5 48 */	addi r3, r3, l_kuw_itemno@l /* 0x80C4D548@l */
/* 80C4CA48  7C 63 00 AE */	lbzx r3, r3, r0
/* 80C4CA4C  4B 58 D4 F1 */	bl isCatchNotGiveInsect__14dMenu_Insect_cFUc
...
/* 80C4CA6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4CA70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4CA74  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C4CA78  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C4CA7C  3C 80 80 C5 */	lis r4, l_musiya_num@ha /* 0x80C4D574@ha */
/* 80C4CA80  38 84 D5 74 */	addi r4, r4, l_musiya_num@l /* 0x80C4D574@l */
/* 80C4CA84  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C4CA88  54 00 08 3C */	slwi r0, r0, 1
/* 80C4CA8C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C4CA90  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C4CA94  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C4CA98  4B 3E 7F 25 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80C4CAB0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4CAB4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4CAB8  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C4CABC  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C4CAC0  3C 80 80 C5 */	lis r4, l_musiya_num@ha /* 0x80C4D574@ha */
/* 80C4CAC4  38 84 D5 74 */	addi r4, r4, l_musiya_num@l /* 0x80C4D574@l */
/* 80C4CAC8  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C4CACC  54 00 08 3C */	slwi r0, r0, 1
/* 80C4CAD0  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C4CAD4  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C4CAD8  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C4CADC  4B 3E 7E E1 */	bl isEventBit__11dSv_event_cCFUs
