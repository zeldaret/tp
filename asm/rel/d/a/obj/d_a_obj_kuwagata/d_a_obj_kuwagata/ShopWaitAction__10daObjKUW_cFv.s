...
/* 80C4A6FC  3C 60 80 C5 */	lis r3, lit_3775@ha /* 0x80C4D490@ha */
/* 80C4A700  3B C3 D4 90 */	addi r30, r3, lit_3775@l /* 0x80C4D490@l */
...
/* 80C4A728  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4A72C  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4A730  38 80 00 07 */	li r4, 7
/* 80C4A734  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A738  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A73C  3C A5 00 02 */	addis r5, r5, 2
/* 80C4A740  38 C0 00 80 */	li r6, 0x80
/* 80C4A744  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4A748  4B 3F 1B A5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4A768  4B 3C 67 09 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C4A77C  4B 61 D1 D9 */	bl cM_rndF__Ff
...
/* 80C4A7CC  4B 61 D1 89 */	bl cM_rndF__Ff
...
/* 80C4A818  4B 61 D1 3D */	bl cM_rndF__Ff
