...
/* 80C4AC5C  3C 60 80 C5 */	lis r3, lit_3775@ha /* 0x80C4D490@ha */
/* 80C4AC60  3B E3 D4 90 */	addi r31, r3, lit_3775@l /* 0x80C4D490@l */
...
/* 80C4AC9C  4B 3C 22 71 */	bl ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80C4ACA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C4ACA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C4ACA8  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C4ACAC  4B 3C 17 89 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C4ACB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C4ACB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C4ACB8  38 81 00 14 */	addi r4, r1, 0x14
/* 80C4ACBC  38 A1 00 08 */	addi r5, r1, 8
/* 80C4ACC0  4B 6F C0 AD */	bl PSMTXMultVec
...
/* 80C4AD04  4B 62 4D 39 */	bl cLib_addCalc2__FPffff
...
/* 80C4AD18  4B 62 4D 25 */	bl cLib_addCalc2__FPffff
...
/* 80C4AD2C  4B 62 58 DD */	bl cLib_addCalcAngleS2__FPssss
