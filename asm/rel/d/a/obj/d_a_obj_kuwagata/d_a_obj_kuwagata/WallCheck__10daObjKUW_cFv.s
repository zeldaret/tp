...
/* 80C4A9E0  4B 71 77 FD */	bl _savegpr_29
/* 80C4A9E4  7C 7F 1B 78 */	mr r31, r3
/* 80C4A9E8  3C 60 80 C5 */	lis r3, lit_3775@ha /* 0x80C4D490@ha */
/* 80C4A9EC  3B C3 D4 90 */	addi r30, r3, lit_3775@l /* 0x80C4D490@l */
/* 80C4A9F0  38 61 00 38 */	addi r3, r1, 0x38
/* 80C4A9F4  4B 42 D2 75 */	bl __ct__11dBgS_LinChkFv
/* 80C4A9F8  38 61 00 90 */	addi r3, r1, 0x90
/* 80C4A9FC  4B 42 E4 6D */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80C4AA10  4B 42 D3 55 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C4AA14  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4AA18  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4AA1C  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80C4AA20  7F A3 EB 78 */	mr r3, r29
/* 80C4AA24  38 81 00 38 */	addi r4, r1, 0x38
/* 80C4AA28  4B 42 99 8D */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80C4AA2C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C4AA30  41 82 01 A4 */	beq lbl_80C4ABD4
/* 80C4AA34  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C4D634@ha */
/* 80C4AA38  38 03 D6 34 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C4D634@l */
...
/* 80C4AA4C  4B 42 9C F9 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C4AA94  4B 6F C9 09 */	bl PSVECSquareDistance
...
/* 80C4AB04  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C4AB08  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C4AB74  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C4AB78  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80C4AB7C  48 00 00 08 */	b lbl_80C4AB84
lbl_80C4AB80:
/* 80C4AB80  FC 40 08 90 */	fmr f2, f1
lbl_80C4AB84:
/* 80C4AB84  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80C4AB88  4B 61 CA ED */	bl cM_atan2s__Fff
...
/* 80C4AB9C  4B 61 CA D9 */	bl cM_atan2s__Fff
/* 80C4ABA0  B0 7F 09 9A */	sth r3, 0x99a(r31)
/* 80C4ABA4  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80C4ABA8  C0 41 00 2C */	lfs f2, 0x2c(r1)
/* 80C4ABAC  4B 61 CA C9 */	bl cM_atan2s__Fff
/* 80C4ABB0  B0 7F 09 A2 */	sth r3, 0x9a2(r31)
/* 80C4ABB4  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C4D634@ha */
/* 80C4ABB8  38 03 D6 34 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C4D634@l */
/* 80C4ABBC  90 01 00 34 */	stw r0, 0x34(r1)
/* 80C4ABC0  38 61 00 38 */	addi r3, r1, 0x38
/* 80C4ABC4  38 80 FF FF */	li r4, -1
/* 80C4ABC8  4B 42 D1 15 */	bl __dt__11dBgS_LinChkFv
...
/* 80C4ABDC  4B 42 D1 01 */	bl __dt__11dBgS_LinChkFv
/* 80C4ABE0  38 60 00 00 */	li r3, 0
lbl_80C4ABE4:
/* 80C4ABE4  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80C4ABE8  4B 71 76 41 */	bl _restgpr_29
