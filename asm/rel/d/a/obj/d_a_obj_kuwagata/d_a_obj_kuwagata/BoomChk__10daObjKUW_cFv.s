...
/* 80C4BFD0  4B 71 62 09 */	bl _savegpr_28
/* 80C4BFD4  7C 7E 1B 78 */	mr r30, r3
/* 80C4BFD8  3C 60 80 C5 */	lis r3, lit_3775@ha /* 0x80C4D490@ha */
/* 80C4BFDC  3B E3 D4 90 */	addi r31, r3, lit_3775@l /* 0x80C4D490@l */
/* 80C4BFE0  88 1E 09 C1 */	lbz r0, 0x9c1(r30)
/* 80C4BFE4  28 00 00 00 */	cmplwi r0, 0
/* 80C4BFE8  41 82 03 8C */	beq lbl_80C4C374
/* 80C4BFEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4BFF0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C4C048  4B 51 26 0D */	bl posMove__20daPy_boomerangMove_cFP4cXyzPsP10fopAc_ac_cs
...
/* 80C4C05C  4B 51 28 21 */	bl bgCheckAfterOffset__20daPy_boomerangMove_cFPC4cXyz
...
/* 80C4C078  4B 42 BB F1 */	bl __ct__11dBgS_LinChkFv
/* 80C4C07C  38 61 00 9C */	addi r3, r1, 0x9c
/* 80C4C080  4B 42 CD E9 */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80C4C094  4B 42 BC D1 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C4C098  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4C09C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4C0A0  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80C4C0A4  7F 83 E3 78 */	mr r3, r28
/* 80C4C0A8  38 81 00 44 */	addi r4, r1, 0x44
/* 80C4C0AC  4B 42 83 09 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80C4C0B0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C4C0B4  41 82 01 D0 */	beq lbl_80C4C284
/* 80C4C0B8  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C4D634@ha */
/* 80C4C0BC  38 03 D6 34 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C4D634@l */
...
/* 80C4C0D0  4B 42 86 75 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C4C154  4B 6F B2 49 */	bl PSVECSquareDistance
...
/* 80C4C1C4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C4C1C8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C4C234  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C4C238  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80C4C23C  48 00 00 08 */	b lbl_80C4C244
lbl_80C4C240:
/* 80C4C240  FC 40 08 90 */	fmr f2, f1
lbl_80C4C244:
/* 80C4C244  C0 21 00 30 */	lfs f1, 0x30(r1)
/* 80C4C248  4B 61 B4 2D */	bl cM_atan2s__Fff
...
/* 80C4C25C  4B 61 B4 19 */	bl cM_atan2s__Fff
/* 80C4C260  B0 7E 09 9A */	sth r3, 0x99a(r30)
/* 80C4C264  C0 21 00 30 */	lfs f1, 0x30(r1)
/* 80C4C268  C0 41 00 38 */	lfs f2, 0x38(r1)
/* 80C4C26C  4B 61 B4 09 */	bl cM_atan2s__Fff
/* 80C4C270  B0 7E 09 A2 */	sth r3, 0x9a2(r30)
/* 80C4C274  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C4D634@ha */
/* 80C4C278  38 03 D6 34 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C4D634@l */
...
/* 80C4C294  3C 60 80 C5 */	lis r3, d_a_obj_kuwagata__stringBase0@ha /* 0x80C4D58C@ha */
/* 80C4C298  38 63 D5 8C */	addi r3, r3, d_a_obj_kuwagata__stringBase0@l /* 0x80C4D58C@l */
/* 80C4C29C  38 80 00 06 */	li r4, 6
/* 80C4C2A0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4C2A4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4C2A8  3C A5 00 02 */	addis r5, r5, 2
/* 80C4C2AC  38 C0 00 80 */	li r6, 0x80
/* 80C4C2B0  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4C2B4  4B 3F 00 39 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4C330  4B 61 B6 25 */	bl cM_rndF__Ff
...
/* 80C4C370  4B 42 B9 6D */	bl __dt__11dBgS_LinChkFv
lbl_80C4C374:
/* 80C4C374  39 61 00 D0 */	addi r11, r1, 0xd0
/* 80C4C378  4B 71 5E AD */	bl _restgpr_28
