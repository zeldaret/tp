...
/* 80C4C88C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C4C890  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C4C894  38 80 00 10 */	li r4, 0x10
/* 80C4C898  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C4C89C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C4C8A0  4B 55 6F 24 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C4C8A4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C4C8A8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C4C8AC  80 9F 00 04 */	lwz r4, 4(r31)
/* 80C4C8B0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C4C8B4  4B 55 84 EC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C4C8C8  4B 3C 0E 10 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C4C8DC  4B 3C 0E CC */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80C4C8E0  80 7E 0A 58 */	lwz r3, 0xa58(r30)
/* 80C4C8E4  4B 3C 48 DC */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 80C4C8FC  3C 80 80 C5 */	lis r4, lit_4758@ha
/* 80C4C900  C0 44 D5 6C */	lfs f2, lit_4758@l(r4)
/* 80C4C904  38 9E 08 40 */	addi r4, r30, 0x840
/* 80C4C908  38 A0 00 00 */	li r5, 0
/* 80C4C90C  3C C0 80 C5 */	lis r6, lit_4759@ha
/* 80C4C910  C0 66 D5 70 */	lfs f3, lit_4759@l(r6)
/* 80C4C914  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80C4C918  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80C4C91C  4B 3E 07 98 */	b dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80C4C920:
