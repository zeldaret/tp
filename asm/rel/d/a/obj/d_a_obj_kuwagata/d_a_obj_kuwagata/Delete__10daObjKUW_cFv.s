...
/* 80C4C7A4  3C 80 80 C5 */	lis r4, stringBase0@ha
/* 80C4C7A8  38 84 D5 8C */	addi r4, r4, stringBase0@l
/* 80C4C7AC  4B 3E 08 5C */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80C4C7C0  3C 60 80 C5 */	lis r3, data_80C4D660@ha
/* 80C4C7C4  98 03 D6 60 */	stb r0, data_80C4D660@l(r3)
lbl_80C4C7C8:
...
/* 80C4C7D8  4B 3C 4B 38 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_80C4C7DC:
