...
/* 80C4A2A4  4B 62 53 A5 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80C4A2A8  38 7F 06 F0 */	addi r3, r31, 0x6f0
/* 80C4A2AC  3C 80 80 C5 */	lis r4, lit_3789@ha /* 0x80C4D4D8@ha */
/* 80C4A2B0  C0 24 D4 D8 */	lfs f1, lit_3789@l(r4)  /* 0x80C4D4D8@l */
/* 80C4A2B4  4B 62 54 55 */	bl SetR__8cM3dGSphFf
/* 80C4A2B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4A2BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4A2C0  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C4A2C4  38 9F 05 CC */	addi r4, r31, 0x5cc
/* 80C4A2C8  4B 61 A8 E1 */	bl Set__4cCcSFP8cCcD_Obj
