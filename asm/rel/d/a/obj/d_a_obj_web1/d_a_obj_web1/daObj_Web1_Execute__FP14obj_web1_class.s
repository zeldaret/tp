...
/* 80D3578C  3C 60 80 D3 */	lis r3, lit_3703@ha /* 0x80D360C0@ha */
/* 80D35790  3B E3 60 C0 */	addi r31, r3, lit_3703@l /* 0x80D360C0@l */
...
/* 80D357E8  4B 2F 78 85 */	bl dComIfGp_getReverb__Fi
...
/* 80D35830  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D35834  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D3587C  4B 31 72 15 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D35894  4B 2F 77 D9 */	bl dComIfGp_getReverb__Fi
...
/* 80D358A8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D358AC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D358D4  4B 57 6C 39 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80D358D8  88 1E 05 B4 */	lbz r0, 0x5b4(r30)
/* 80D358DC  2C 00 00 23 */	cmpwi r0, 0x23
/* 80D358E0  40 82 00 28 */	bne lbl_80D35908
/* 80D358E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D358E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D358FC  4B 2F F9 05 */	bl onSwitch__10dSv_info_cFii
/* 80D35900  7F C3 F3 78 */	mr r3, r30
/* 80D35904  4B 2E 43 79 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_80D35908:
...
lbl_80D35920:
/* 80D35920  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D35924  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D35928  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80D3592C  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80D35930  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80D35934  4B 61 0F B5 */	bl PSMTXTrans
/* 80D35938  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D3593C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D35940  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80D35944  4B 2D 6A F1 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80D35960  4B 2D 74 D9 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80D35964  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80D35968  4B 2D 7A C1 */	bl play__14mDoExt_baseAnmFv
/* 80D3596C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D35970  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D35974  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80D35978  38 84 00 24 */	addi r4, r4, 0x24
/* 80D3597C  4B 61 0B 35 */	bl PSMTXCopy
/* 80D35980  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D35984  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D35988  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80D3598C  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80D35990  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80D35994  4B 61 0F 55 */	bl PSMTXTrans
...
/* 80D359A8  4B 2D 74 91 */	bl scaleM__14mDoMtx_stack_cFfff
...
/* 80D359D0  4B 2D 73 CD */	bl transM__14mDoMtx_stack_cFfff
/* 80D359D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D359D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D359DC  38 9E 05 C0 */	addi r4, r30, 0x5c0
/* 80D359E0  4B 61 0A D1 */	bl PSMTXCopy
/* 80D359E4  80 7E 05 F0 */	lwz r3, 0x5f0(r30)
/* 80D359E8  4B 34 5F D9 */	bl Move__4dBgWFv
/* 80D359EC  38 7E 07 54 */	addi r3, r30, 0x754
/* 80D359F0  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80D359F4  4B 53 97 E9 */	bl SetC__8cM3dGCylFRC4cXyz
...
/* 80D35A08  4B 53 97 F9 */	bl SetR__8cM3dGCylFf
/* 80D35A0C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D35A10  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D35A14  38 63 23 3C */	addi r3, r3, 0x233c
/* 80D35A18  38 9E 06 30 */	addi r4, r30, 0x630
/* 80D35A1C  4B 52 F1 8D */	bl Set__4cCcSFP8cCcD_Obj
