...
/* 80C3CDA0  4B 72 54 29 */	bl _savegpr_24
/* 80C3CDA4  7C 7E 1B 78 */	mr r30, r3
/* 80C3CDA8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C3CDAC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C3CDB0  38 80 00 10 */	li r4, 0x10
/* 80C3CDB4  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C3CDB8  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C3CDBC  4B 56 6A 09 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C3CDC0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C3CDC4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C3CDC8  80 9E 05 68 */	lwz r4, 0x568(r30)
/* 80C3CDCC  80 84 00 04 */	lwz r4, 4(r4)
/* 80C3CDD0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C3CDD4  4B 56 7F CD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C3CDD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3CDDC  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3CDE0  80 1F 5F 70 */	lwz r0, 0x5f70(r31)
/* 80C3CDE4  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C3CDE8  3B 43 4A C8 */	addi r26, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C3CDFC  4B 3D 0E C9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C3CE00  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3CE04  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C3CE34  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C3CE38  3B 83 CA 54 */	addi r28, r3, g_env_light@l /* 0x8042CA54@l */
lbl_80C3CE3C:
...
/* 80C3CE50  4B 56 7F 51 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C3CE68  4B 3D 0E 5D */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80C3CE94  4B 72 53 81 */	bl _restgpr_24
