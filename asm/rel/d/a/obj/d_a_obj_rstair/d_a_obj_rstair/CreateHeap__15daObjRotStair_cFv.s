...
/* 80CC1800  4B 6A 09 B5 */	bl _savegpr_19
/* 80CC1804  7C 76 1B 78 */	mr r22, r3
/* 80CC1808  3C 60 80 CC */	lis r3, l_wtr_bmd@ha /* 0x80CC2700@ha */
/* 80CC180C  3B 43 27 00 */	addi r26, r3, l_wtr_bmd@l /* 0x80CC2700@l */
/* 80CC1810  3C 60 80 CC */	lis r3, l_arcName@ha /* 0x80CC275C@ha */
/* 80CC1814  38 63 27 5C */	addi r3, r3, l_arcName@l /* 0x80CC275C@l */
/* 80CC1818  80 63 00 00 */	lwz r3, 0(r3)
/* 80CC181C  38 80 00 05 */	li r4, 5
/* 80CC1820  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC1824  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CC1838  4B 37 AA B5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CC1848  4B 35 34 0D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CC186C  3C 60 80 CC */	lis r3, l_arcName@ha /* 0x80CC275C@ha */
/* 80CC1870  3B 63 27 5C */	addi r27, r3, l_arcName@l /* 0x80CC275C@l */
...
/* 80CC1890  4B 37 AA 5D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80CC1894  7C 7D 1B 78 */	mr r29, r3
/* 80CC1898  3C 80 00 08 */	lis r4, 8
/* 80CC189C  38 BE 02 84 */	addi r5, r30, 0x284
/* 80CC18A0  4B 35 33 B5 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CC18D0  4B 37 AA 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80CC18D4  7C 73 1B 78 */	mr r19, r3
/* 80CC18D8  38 60 00 18 */	li r3, 0x18
/* 80CC18DC  4B 60 D3 71 */	bl __nw__FUl
/* 80CC18E0  7C 74 1B 79 */	or. r20, r3, r3
/* 80CC18E4  41 82 00 20 */	beq lbl_80CC1904
/* 80CC18E8  3C 80 80 CC */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80CC284C@ha */
/* 80CC18EC  38 04 28 4C */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80CC284C@l */
/* 80CC18F0  90 14 00 00 */	stw r0, 0(r20)
/* 80CC18F4  38 80 00 00 */	li r4, 0
/* 80CC18F8  4B 66 6B 05 */	bl init__12J3DFrameCtrlFs
...
/* 80CC1930  4B 34 BD 0D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80CC1958  4B 60 D2 F5 */	bl __nw__FUl
/* 80CC195C  7C 60 1B 79 */	or. r0, r3, r3
/* 80CC1960  41 82 00 0C */	beq lbl_80CC196C
/* 80CC1964  4B 3B A0 0D */	bl __ct__4dBgWFv
...
/* 80CC197C  3C 60 80 CC */	lis r3, l_arcName@ha /* 0x80CC275C@ha */
/* 80CC1980  38 63 27 5C */	addi r3, r3, l_arcName@l /* 0x80CC275C@l */
...
/* 80CC1994  4B 37 A9 59 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CC19A8  4B 3B 85 91 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80CC19CC  4B 6A 08 35 */	bl _restgpr_19
