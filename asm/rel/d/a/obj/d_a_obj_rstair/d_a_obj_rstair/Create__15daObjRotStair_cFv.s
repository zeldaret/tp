...
/* 80CC16C0  4B 6A 0B 19 */	bl _savegpr_28
/* 80CC16C4  7C 7F 1B 78 */	mr r31, r3
/* 80CC16C8  3B A0 00 00 */	li r29, 0
/* 80CC16CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC16D0  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_80CC16D4:
...
/* 80CC16EC  4B 37 3C 75 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CC1714  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC1718  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_80CC171C:
...
/* 80CC1734  4B 37 3C 2D */	bl isSwitch__10dSv_info_cCFii
...
/* 80CC1764  3C 60 80 CC */	lis r3, l_target_angleY@ha /* 0x80CC2710@ha */
/* 80CC1768  38 63 27 10 */	addi r3, r3, l_target_angleY@l /* 0x80CC2710@l */
...
/* 80CC179C  4B 35 8D DD */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80CC17A0  80 1F 00 B0 */	lwz r0, 0xb0(r31)
/* 80CC17A4  98 1F 05 E0 */	stb r0, 0x5e0(r31)
/* 80CC17A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC17AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC17B0  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80CC17B4  7F E4 FB 78 */	mr r4, r31
/* 80CC17B8  88 BF 05 E0 */	lbz r5, 0x5e0(r31)
/* 80CC17BC  4B 38 5E DD */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
/* 80CC17C0  B0 7F 05 DE */	sth r3, 0x5de(r31)
/* 80CC17C4  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 80CC17C8  4B 3B A1 F9 */	bl Move__4dBgWFv
...
/* 80CC17DC  4B 6A 0A 49 */	bl _restgpr_28
