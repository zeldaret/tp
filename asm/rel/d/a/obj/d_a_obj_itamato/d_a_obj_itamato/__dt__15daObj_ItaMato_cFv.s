...
/* 80C2950C  3C 80 80 C3 */	lis r4, __vt__15daObj_ItaMato_c@ha /* 0x80C2AD34@ha */
/* 80C29510  38 04 AD 34 */	addi r0, r4, __vt__15daObj_ItaMato_c@l /* 0x80C2AD34@l */
...
/* 80C29524  4B 40 3A E5 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80C29528  38 7E 09 D0 */	addi r3, r30, 0x9d0
/* 80C2952C  3C 80 80 C3 */	lis r4, __dt__5csXyzFv@ha /* 0x80C296E0@ha */
/* 80C29530  38 84 96 E0 */	addi r4, r4, __dt__5csXyzFv@l /* 0x80C296E0@l */
/* 80C29534  38 A0 00 06 */	li r5, 6
/* 80C29538  38 C0 00 03 */	li r6, 3
/* 80C2953C  4B 73 87 AD */	bl __destroy_arr
/* 80C29540  38 7E 09 60 */	addi r3, r30, 0x960
/* 80C29544  38 80 FF FF */	li r4, -1
/* 80C29548  4B 44 E7 95 */	bl __dt__11dBgS_LinChkFv
/* 80C2954C  34 1E 09 44 */	addic. r0, r30, 0x944
/* 80C29550  41 82 00 10 */	beq lbl_80C29560
/* 80C29554  3C 60 80 C3 */	lis r3, __vt__8cM3dGLin@ha /* 0x80C2AD28@ha */
/* 80C29558  38 03 AD 28 */	addi r0, r3, __vt__8cM3dGLin@l /* 0x80C2AD28@l */
/* 80C2955C  90 1E 09 5C */	stw r0, 0x95c(r30)
lbl_80C29560:
/* 80C29560  34 1E 08 0C */	addic. r0, r30, 0x80c
/* 80C29564  41 82 00 84 */	beq lbl_80C295E8
/* 80C29568  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80C2956C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80C2958C  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80C29590  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 80C295A8  3C 60 80 C3 */	lis r3, __vt__8cM3dGSph@ha /* 0x80C2AD1C@ha */
/* 80C295AC  38 03 AD 1C */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80C2AD1C@l */
/* 80C295B0  90 1E 09 40 */	stw r0, 0x940(r30)
lbl_80C295B4:
/* 80C295B4  34 1E 09 10 */	addic. r0, r30, 0x910
/* 80C295B8  41 82 00 24 */	beq lbl_80C295DC
/* 80C295BC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C295C0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C295C4  90 1E 09 2C */	stw r0, 0x92c(r30)
/* 80C295C8  34 1E 09 10 */	addic. r0, r30, 0x910
/* 80C295CC  41 82 00 10 */	beq lbl_80C295DC
/* 80C295D0  3C 60 80 C3 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C2AD10@ha */
/* 80C295D4  38 03 AD 10 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C2AD10@l */
/* 80C295D8  90 1E 09 28 */	stw r0, 0x928(r30)
lbl_80C295DC:
/* 80C295DC  38 7E 08 0C */	addi r3, r30, 0x80c
/* 80C295E0  38 80 00 00 */	li r4, 0
/* 80C295E4  4B 45 AB 01 */	bl __dt__12dCcD_GObjInfFv
lbl_80C295E8:
/* 80C295E8  38 7E 07 D0 */	addi r3, r30, 0x7d0
/* 80C295EC  38 80 FF FF */	li r4, -1
/* 80C295F0  4B 63 E6 A5 */	bl __dt__11cBgS_GndChkFv
/* 80C295F4  34 1E 07 90 */	addic. r0, r30, 0x790
/* 80C295F8  41 82 00 28 */	beq lbl_80C29620
/* 80C295FC  3C 60 80 C3 */	lis r3, __vt__12dBgS_AcchCir@ha /* 0x80C2AD04@ha */
/* 80C29600  38 03 AD 04 */	addi r0, r3, __vt__12dBgS_AcchCir@l /* 0x80C2AD04@l */
/* 80C29604  90 1E 07 9C */	stw r0, 0x79c(r30)
/* 80C29608  38 7E 07 A4 */	addi r3, r30, 0x7a4
/* 80C2960C  38 80 FF FF */	li r4, -1
/* 80C29610  4B 64 59 09 */	bl __dt__8cM3dGCirFv
/* 80C29614  38 7E 07 90 */	addi r3, r30, 0x790
/* 80C29618  38 80 00 00 */	li r4, 0
/* 80C2961C  4B 63 EA 95 */	bl __dt__13cBgS_PolyInfoFv
lbl_80C29620:
/* 80C29620  34 1E 07 54 */	addic. r0, r30, 0x754
/* 80C29624  41 82 00 54 */	beq lbl_80C29678
/* 80C29628  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C2962C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C29644  3C 60 80 C3 */	lis r3, __vt__10dCcD_GStts@ha /* 0x80C2ACF8@ha */
/* 80C29648  38 03 AC F8 */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x80C2ACF8@l */
/* 80C2964C  90 1E 07 70 */	stw r0, 0x770(r30)
/* 80C29650  34 1E 07 70 */	addic. r0, r30, 0x770
/* 80C29654  41 82 00 10 */	beq lbl_80C29664
/* 80C29658  3C 60 80 C3 */	lis r3, __vt__10cCcD_GStts@ha /* 0x80C2ACEC@ha */
/* 80C2965C  38 03 AC EC */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x80C2ACEC@l */
/* 80C29660  90 1E 07 70 */	stw r0, 0x770(r30)
lbl_80C29664:
/* 80C29664  34 1E 07 54 */	addic. r0, r30, 0x754
/* 80C29668  41 82 00 10 */	beq lbl_80C29678
/* 80C2966C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C29670  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C29674  90 1E 07 6C */	stw r0, 0x76c(r30)
lbl_80C29678:
/* 80C29678  34 1E 05 7C */	addic. r0, r30, 0x57c
/* 80C2967C  41 82 00 2C */	beq lbl_80C296A8
/* 80C29680  3C 60 80 C3 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80C2ACC8@ha */
/* 80C29684  38 63 AC C8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80C2ACC8@l */
