...
/* 80C2A464  3C 60 80 C3 */	lis r3, m__21daObj_ItaMato_Param_c@ha /* 0x80C2AB70@ha */
/* 80C2A468  3B E3 AB 70 */	addi r31, r3, m__21daObj_ItaMato_Param_c@l /* 0x80C2AB70@l */
...
lbl_80C2A490:
/* 80C2A490  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C2A494  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C2A498  38 80 00 00 */	li r4, 0
/* 80C2A49C  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C2A4A0  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C2A4A4  4B 57 93 21 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C2A4A8  88 1E 0A 18 */	lbz r0, 0xa18(r30)
/* 80C2A4AC  28 00 00 00 */	cmplwi r0, 0
/* 80C2A4B0  41 82 00 68 */	beq lbl_80C2A518
/* 80C2A4B4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C2A4B8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C2A4BC  80 9E 05 78 */	lwz r4, 0x578(r30)
/* 80C2A4C0  80 84 00 04 */	lwz r4, 4(r4)
/* 80C2A4C4  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C2A4C8  4B 57 A8 D9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C2A4F0  4B 3E 37 D5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
lbl_80C2A518:
/* 80C2A518  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C2A51C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 80C2A538  4B 57 A8 69 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C2A54C  4B 3E 37 79 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80C2A550:
...
/* 80C2A5A4  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80C2A5A8  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80C2A5AC  4B 40 43 65 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
