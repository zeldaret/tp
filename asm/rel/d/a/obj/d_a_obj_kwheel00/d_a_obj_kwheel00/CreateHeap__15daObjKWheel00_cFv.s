...
/* 80C4D9D4  3C 60 80 C5 */	lis r3, l_arcName@ha /* 0x80C4E870@ha */
/* 80C4D9D8  38 63 E8 70 */	addi r3, r3, l_arcName@l /* 0x80C4E870@l */
/* 80C4D9DC  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C4D9E0  3C 80 80 C5 */	lis r4, l_bmdidx@ha /* 0x80C4E808@ha */
/* 80C4D9E4  38 84 E8 08 */	addi r4, r4, l_bmdidx@l /* 0x80C4E808@l */
/* 80C4D9E8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C4D9EC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4D9F0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4D9F4  3C A5 00 02 */	addis r5, r5, 2
/* 80C4D9F8  38 C0 00 80 */	li r6, 0x80
/* 80C4D9FC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4DA00  4B 3E E8 ED */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4DA10  4B 3C 72 45 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
