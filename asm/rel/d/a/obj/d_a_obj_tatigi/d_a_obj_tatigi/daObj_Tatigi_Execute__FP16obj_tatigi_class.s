...
/* 80D07A70  4B 65 A7 5D */	bl _savegpr_25
/* 80D07A74  7C 7A 1B 78 */	mr r26, r3
/* 80D07A78  3C 60 80 D1 */	lis r3, lit_3867@ha /* 0x80D085C0@ha */
/* 80D07A7C  3B E3 85 C0 */	addi r31, r3, lit_3867@l /* 0x80D085C0@l */
...
/* 80D07AB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D07AB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D07AB8  C0 3B 00 04 */	lfs f1, 4(r27)
/* 80D07ABC  C0 5B 00 08 */	lfs f2, 8(r27)
/* 80D07AC0  C0 7B 00 0C */	lfs f3, 0xc(r27)
/* 80D07AC4  4B 63 EE 25 */	bl PSMTXTrans
/* 80D07AC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D07ACC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D07AD0  A8 9B 00 1C */	lha r4, 0x1c(r27)
/* 80D07AD4  4B 30 49 61 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D07AD8  C0 3B 00 10 */	lfs f1, 0x10(r27)
/* 80D07ADC  C0 5B 00 14 */	lfs f2, 0x14(r27)
/* 80D07AE0  C0 7B 00 18 */	lfs f3, 0x18(r27)
/* 80D07AE4  4B 30 53 55 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80D07AE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D07AEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D07AF0  80 9B 00 00 */	lwz r4, 0(r27)
/* 80D07AF4  38 84 00 24 */	addi r4, r4, 0x24
/* 80D07AF8  4B 63 E9 B9 */	bl PSMTXCopy
/* 80D07AFC  38 7B 01 44 */	addi r3, r27, 0x144
/* 80D07B00  38 9B 00 04 */	addi r4, r27, 4
/* 80D07B04  4B 56 76 D9 */	bl SetC__8cM3dGCylFRC4cXyz
...
/* 80D07B18  4B 56 76 E9 */	bl SetR__8cM3dGCylFf
/* 80D07B1C  38 7B 01 44 */	addi r3, r27, 0x144
/* 80D07B20  C0 3F 00 04 */	lfs f1, 4(r31)
/* 80D07B24  4B 56 76 D5 */	bl SetH__8cM3dGCylFf
lbl_80D07B28:
...
/* 80D07B50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D07B54  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D07B68  4B 55 D0 41 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80D07B7C  4B 37 CA DD */	bl ChkCoHit__12dCcD_GObjInfFv
/* 80D07B80  28 03 00 00 */	cmplwi r3, 0
/* 80D07B84  41 82 00 34 */	beq lbl_80D07BB8
/* 80D07B88  38 7D 00 20 */	addi r3, r29, 0x20
/* 80D07B8C  4B 37 CB 65 */	bl GetCoHitObj__12dCcD_GObjInfFv
/* 80D07B90  4B 55 BE B9 */	bl GetAc__8cCcD_ObjFv
...
/* 80D07BD8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80D07BDC  38 A3 9A 20 */	addi r5, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80D07C4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D07C50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D07C54  C0 3D 00 04 */	lfs f1, 4(r29)
/* 80D07C58  C0 5D 00 08 */	lfs f2, 8(r29)
/* 80D07C5C  C0 7D 00 0C */	lfs f3, 0xc(r29)
/* 80D07C60  4B 63 EC 89 */	bl PSMTXTrans
/* 80D07C64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D07C68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D07C6C  A8 9D 00 1C */	lha r4, 0x1c(r29)
/* 80D07C70  4B 30 47 C5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D07C74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D07C78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D07C7C  7F 84 E3 78 */	mr r4, r28
/* 80D07C80  4B 30 47 1D */	bl mDoMtx_XrotM__FPA4_fs
/* 80D07C84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D07C88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D07C8C  7F 24 CB 78 */	mr r4, r25
/* 80D07C90  4B 30 48 3D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80D07C94  C0 3D 00 10 */	lfs f1, 0x10(r29)
/* 80D07C98  C0 5D 00 14 */	lfs f2, 0x14(r29)
/* 80D07C9C  C0 7D 00 18 */	lfs f3, 0x18(r29)
/* 80D07CA0  4B 30 51 99 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80D07CA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D07CA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D07CAC  80 9D 00 00 */	lwz r4, 0(r29)
/* 80D07CB0  38 84 00 24 */	addi r4, r4, 0x24
/* 80D07CB4  4B 63 E7 FD */	bl PSMTXCopy
lbl_80D07CB8:
...
/* 80D07CD4  4B 65 A5 45 */	bl _restgpr_25
