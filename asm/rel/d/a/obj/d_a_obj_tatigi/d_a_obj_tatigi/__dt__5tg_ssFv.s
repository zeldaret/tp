...
/* 80D083E8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80D083EC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80D0840C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80D08410  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80D08428  3C 60 80 D1 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80D086C8@ha */
/* 80D0842C  38 03 86 C8 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80D086C8@l */
/* 80D08430  90 1E 01 58 */	stw r0, 0x158(r30)
lbl_80D08434:
/* 80D08434  34 1E 01 24 */	addic. r0, r30, 0x124
/* 80D08438  41 82 00 24 */	beq lbl_80D0845C
/* 80D0843C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80D08440  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80D08444  90 1E 01 40 */	stw r0, 0x140(r30)
/* 80D08448  34 1E 01 24 */	addic. r0, r30, 0x124
/* 80D0844C  41 82 00 10 */	beq lbl_80D0845C
/* 80D08450  3C 60 80 D1 */	lis r3, __vt__8cM3dGAab@ha /* 0x80D086BC@ha */
/* 80D08454  38 03 86 BC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80D086BC@l */
/* 80D08458  90 1E 01 3C */	stw r0, 0x13c(r30)
lbl_80D0845C:
/* 80D0845C  38 7E 00 20 */	addi r3, r30, 0x20
/* 80D08460  38 80 00 00 */	li r4, 0
/* 80D08464  4B 37 BC 81 */	bl __dt__12dCcD_GObjInfFv
lbl_80D08468:
/* 80D08468  7F E0 07 35 */	extsh. r0, r31
/* 80D0846C  40 81 00 0C */	ble lbl_80D08478
/* 80D08470  7F C3 F3 78 */	mr r3, r30
/* 80D08474  4B 5C 68 C9 */	bl __dl__FPv
lbl_80D08478:
