...
/* 80BA63AC  4B 7B BE 2D */	bl _savegpr_28
/* 80BA63B0  7C 7C 1B 78 */	mr r28, r3
/* 80BA63B4  3C 60 80 BA */	lis r3, m__22daObj_AutoMata_Param_c@ha /* 0x80BA6C10@ha */
/* 80BA63B8  3B E3 6C 10 */	addi r31, r3, m__22daObj_AutoMata_Param_c@l /* 0x80BA6C10@l */
/* 80BA63BC  80 7C 05 6C */	lwz r3, 0x56c(r28)
/* 80BA63C0  83 C3 00 04 */	lwz r30, 4(r3)
/* 80BA63C4  83 BE 00 04 */	lwz r29, 4(r30)
/* 80BA63C8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BA63CC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BA63D0  38 80 00 00 */	li r4, 0
/* 80BA63D4  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 80BA63D8  38 DC 01 0C */	addi r6, r28, 0x10c
/* 80BA63DC  4B 5F D3 E9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BA63E0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BA63E4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BA63E8  80 9E 00 04 */	lwz r4, 4(r30)
/* 80BA63EC  38 BC 01 0C */	addi r5, r28, 0x10c
/* 80BA63F0  4B 5F E9 B1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BA63F4  C0 3C 06 10 */	lfs f1, 0x610(r28)
/* 80BA63F8  38 7C 06 00 */	addi r3, r28, 0x600
/* 80BA63FC  38 9D 00 58 */	addi r4, r29, 0x58
/* 80BA6400  4B 46 72 D9 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80BA6404  80 7C 05 6C */	lwz r3, 0x56c(r28)
/* 80BA6408  4B 46 AD B9 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 80BA640C  38 7D 00 58 */	addi r3, r29, 0x58
/* 80BA6410  80 9C 06 14 */	lwz r4, 0x614(r28)
/* 80BA6414  4B 78 93 A1 */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
...
/* 80BA6454  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80BA6458  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80BA645C  4B 48 84 B5 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 80BA6460  90 7C 0B 24 */	stw r3, 0xb24(r28)
lbl_80BA6464:
/* 80BA6464  38 60 00 01 */	li r3, 1
/* 80BA6468  39 61 00 20 */	addi r11, r1, 0x20
/* 80BA646C  4B 7B BD B9 */	bl _restgpr_28
