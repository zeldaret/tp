...
/* 80CA35B4  3C 80 80 CA */	lis r4, lit_3831@ha /* 0x80CA3A44@ha */
/* 80CA35B8  3B E4 3A 44 */	addi r31, r4, lit_3831@l /* 0x80CA3A44@l */
/* 80CA35BC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA35C0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CA35D4  4B 37 73 91 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80CA3688  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CA368C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80CA36AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA36B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA36B4  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80CA36B8  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80CA36BC  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80CA36C0  4B 6A 32 29 */	bl PSMTXTrans
/* 80CA36C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA36C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA36CC  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CA36D0  4B 36 8D 65 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CA36D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA36D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA36DC  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80CA36E0  4B 36 8C BD */	bl mDoMtx_XrotM__FPA4_fs
/* 80CA36E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CA36E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CA36EC  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80CA36F0  38 84 00 24 */	addi r4, r4, 0x24
/* 80CA36F4  4B 6A 2D BD */	bl PSMTXCopy
...
/* 80CA3748  4B 5C BF 01 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80CA374C  38 7E 06 E0 */	addi r3, r30, 0x6e0
/* 80CA3750  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 80CA3754  4B 5C BF B5 */	bl SetR__8cM3dGSphFf
/* 80CA3758  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CA375C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CA3760  38 63 23 3C */	addi r3, r3, 0x233c
/* 80CA3764  38 9E 05 BC */	addi r4, r30, 0x5bc
/* 80CA3768  4B 5C 14 41 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80CA3784  4B 5C C2 FD */	bl cLib_addCalc0__FPfff
