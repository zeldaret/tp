...
/* 80C1C1D8  4B 45 C4 4D */	bl __ct__16dBgS_MoveBgActorFv
/* 80C1C1DC  3C 60 80 C2 */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80C1C984@ha */
/* 80C1C1E0  38 03 C9 84 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80C1C984@l */
...
/* 80C1C1F4  3C 60 80 C2 */	lis r3, __vt__16daObjHBombkoya_c@ha /* 0x80C1C9A8@ha */
/* 80C1C1F8  38 63 C9 A8 */	addi r3, r3, __vt__16daObjHBombkoya_c@l /* 0x80C1C9A8@l */
/* 80C1C1FC  90 7E 05 9C */	stw r3, 0x59c(r30)
/* 80C1C200  38 03 00 28 */	addi r0, r3, 0x28
/* 80C1C204  90 1E 05 A8 */	stw r0, 0x5a8(r30)
/* 80C1C208  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C1C20C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C1C210  90 1E 06 60 */	stw r0, 0x660(r30)
/* 80C1C214  38 7E 06 64 */	addi r3, r30, 0x664
/* 80C1C218  4B 46 75 49 */	bl __ct__10dCcD_GSttsFv
/* 80C1C21C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C1C220  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C1C238  4B 46 77 F1 */	bl __ct__12dCcD_GObjInfFv
/* 80C1C23C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C1C240  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C1C244  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C1C248  3C 60 80 C2 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C1C99C@ha */
/* 80C1C24C  38 03 C9 9C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C1C99C@l */
/* 80C1C250  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80C1C254  3C 60 80 C2 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C1C978@ha */
/* 80C1C258  38 03 C9 78 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C1C978@l */
/* 80C1C25C  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C1C260  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C1C264  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80C1C268  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80C1C26C  38 03 00 58 */	addi r0, r3, 0x58
/* 80C1C270  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C1C274  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C1C278  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
