...
/* 80C1BA18  3C 80 80 C2 */	lis r4, __vt__8cM3dGAab@ha
/* 80C1BA1C  38 04 C9 9C */	addi r0, r4, __vt__8cM3dGAab@l
...
/* 80C1BA54  3C 60 80 C2 */	lis r3, lit_3699@ha
/* 80C1BA58  C0 03 C5 F8 */	lfs f0, lit_3699@l(r3)
/* 80C1BA5C  EC A5 00 2A */	fadds f5, f5, f0
/* 80C1BA60  D0 A1 00 18 */	stfs f5, 0x18(r1)
/* 80C1BA64  7F E3 FB 78 */	mr r3, r31
/* 80C1BA68  4B 3F EA E0 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80C1BA6C  38 00 00 00 */	li r0, 0
/* 80C1BA70  90 1F 06 1C */	stw r0, 0x61c(r31)
/* 80C1BA74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C1BA78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C1BA7C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C1BA80  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C1BA84  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C1BA88  4B 72 AE 60 */	b PSMTXTrans
/* 80C1BA8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C1BA90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C1BA94  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80C1BA98  4B 3F 09 9C */	b mDoMtx_YrotM__FPA4_fs
/* 80C1BA9C  C0 3F 04 EC */	lfs f1, 0x4ec(r31)
/* 80C1BAA0  C0 5F 04 F0 */	lfs f2, 0x4f0(r31)
/* 80C1BAA4  C0 7F 04 F4 */	lfs f3, 0x4f4(r31)
/* 80C1BAA8  4B 3F 13 90 */	b scaleM__14mDoMtx_stack_cFfff
/* 80C1BAAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C1BAB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C1BAB4  38 9F 05 E8 */	addi r4, r31, 0x5e8
/* 80C1BAB8  4B 72 A9 F8 */	b PSMTXCopy
...
/* 80C1BAF4  4B 46 7D 6C */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C1BAF8  38 7F 06 84 */	addi r3, r31, 0x684
/* 80C1BAFC  3C 80 80 C2 */	lis r4, l_cc_cyl_src@ha
/* 80C1BB00  38 84 C7 38 */	addi r4, r4, l_cc_cyl_src@l
/* 80C1BB04  4B 46 8D B0 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
/* 80C1BB08  38 1F 06 48 */	addi r0, r31, 0x648
/* 80C1BB0C  90 1F 06 C8 */	stw r0, 0x6c8(r31)
/* 80C1BB10  3C 60 80 C2 */	lis r3, __vt__8cM3dGAab@ha
/* 80C1BB14  38 03 C9 9C */	addi r0, r3, __vt__8cM3dGAab@l
