...
/* 80C91724  4B 6D 0A B5 */	bl _savegpr_28
/* 80C91728  7C 7E 1B 78 */	mr r30, r3
/* 80C9172C  3C 60 80 C9 */	lis r3, mAttr__18daObjMasterSword_c@ha /* 0x80C91940@ha */
/* 80C91730  3B E3 19 40 */	addi r31, r3, mAttr__18daObjMasterSword_c@l /* 0x80C91940@l */
/* 80C91734  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C91738  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9173C  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 80C91740  3C 80 80 38 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 0x803790C0@ha */
/* 80C91744  38 84 90 C0 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 0x803790C0@l */
/* 80C91748  A0 84 00 92 */	lhz r4, 0x92(r4)
/* 80C9174C  4B 3A 32 71 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80C91768  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C9176C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C91770  38 80 00 10 */	li r4, 0x10
/* 80C91774  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C91778  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C9177C  4B 51 20 49 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C91780  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C91784  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C91788  80 9E 05 68 */	lwz r4, 0x568(r30)
/* 80C9178C  80 84 00 04 */	lwz r4, 4(r4)
/* 80C91790  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C91794  4B 51 36 0D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C91798  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9179C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C917A0  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C917A4  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C917A8  3B A3 4A C8 */	addi r29, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C917C4  4B 37 BF 15 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80C917C8  C0 3E 05 9C */	lfs f1, 0x59c(r30)
/* 80C917CC  38 7E 05 8C */	addi r3, r30, 0x58c
/* 80C917D0  38 9C 00 58 */	addi r4, r28, 0x58
/* 80C917D4  4B 37 BF D5 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80C917D8  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 80C917DC  4B 37 C4 E9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C917E0  38 7C 00 58 */	addi r3, r28, 0x58
/* 80C917E4  80 9E 05 88 */	lwz r4, 0x588(r30)
/* 80C917E8  4B 69 DF CD */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
/* 80C917EC  38 7C 00 58 */	addi r3, r28, 0x58
/* 80C917F0  80 9E 05 A0 */	lwz r4, 0x5a0(r30)
/* 80C917F4  4B 69 E0 8D */	bl removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
/* 80C917F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C917FC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C91868  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80C9186C  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80C91870  4B 39 D0 A1 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 80C91874  90 7E 07 24 */	stw r3, 0x724(r30)
/* 80C91878  38 60 00 01 */	li r3, 1
lbl_80C9187C:
/* 80C9187C  39 61 00 30 */	addi r11, r1, 0x30
/* 80C91880  4B 6D 09 A5 */	bl _restgpr_28
