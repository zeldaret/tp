...
/* 80C90C80  4B 6D 15 5D */	bl _savegpr_29
/* 80C90C84  7C 7F 1B 78 */	mr r31, r3
/* 80C90C88  3C 60 80 C9 */	lis r3, l_arcName@ha /* 0x80C9199C@ha */
/* 80C90C8C  38 63 19 9C */	addi r3, r3, l_arcName@l /* 0x80C9199C@l */
/* 80C90C90  80 63 00 00 */	lwz r3, 0(r3)
/* 80C90C94  38 80 00 05 */	li r4, 5
/* 80C90C98  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C90C9C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C90CB0  4B 3A B6 3D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C90CC4  4B 38 3F 91 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C90CE0:
/* 80C90CE0  3C 60 80 C9 */	lis r3, l_arcName@ha /* 0x80C9199C@ha */
/* 80C90CE4  38 63 19 9C */	addi r3, r3, l_arcName@l /* 0x80C9199C@l */
...
/* 80C90CF8  4B 3A B5 F5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C90D10  3D 00 80 C9 */	lis r8, lit_3759@ha /* 0x80C91950@ha */
/* 80C90D14  C0 28 19 50 */	lfs f1, lit_3759@l(r8)  /* 0x80C91950@l */
/* 80C90D18  39 00 00 00 */	li r8, 0
/* 80C90D1C  39 20 FF FF */	li r9, -1
/* 80C90D20  4B 37 C9 1D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80C90D34:
/* 80C90D34  3C 60 80 C9 */	lis r3, l_arcName@ha /* 0x80C9199C@ha */
/* 80C90D38  38 63 19 9C */	addi r3, r3, l_arcName@l /* 0x80C9199C@l */
...
/* 80C90D4C  4B 3A B5 A1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C90D64  3D 00 80 C9 */	lis r8, lit_3759@ha /* 0x80C91950@ha */
/* 80C90D68  C0 28 19 50 */	lfs f1, lit_3759@l(r8)  /* 0x80C91950@l */
/* 80C90D6C  39 00 00 00 */	li r8, 0
/* 80C90D70  39 20 FF FF */	li r9, -1
/* 80C90D74  4B 37 C9 99 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80C90D78  30 03 FF FF */	addic r0, r3, -1
/* 80C90D7C  7C 60 19 10 */	subfe r3, r0, r3
lbl_80C90D80:
/* 80C90D80  39 61 00 20 */	addi r11, r1, 0x20
/* 80C90D84  4B 6D 14 A5 */	bl _restgpr_29
