...
/* 80C6B530  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C6B534  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C6B538  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C6B53C  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C6B540  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C6B544  4B 6D B3 A4 */	b PSMTXTrans
/* 80C6B548  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C6B54C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C6B550  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C6B554  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C6B558  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C6B55C  4B 3A 0D 44 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C6B560  C0 3F 08 6C */	lfs f1, 0x86c(r31)
/* 80C6B564  C0 5F 08 70 */	lfs f2, 0x870(r31)
/* 80C6B568  C0 7F 08 74 */	lfs f3, 0x874(r31)
/* 80C6B56C  4B 3A 18 CC */	b scaleM__14mDoMtx_stack_cFfff
/* 80C6B570  3C 60 80 C7 */	lis r3, lit_3656@ha
/* 80C6B574  C0 03 C6 40 */	lfs f0, lit_3656@l(r3)
...
/* 80C6B5A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C6B5A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C6B5BC  4B 6D AE F4 */	b PSMTXCopy
/* 80C6B5C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C6B5C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C6B5C8  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80C6B5CC  4B 6D AE E4 */	b PSMTXCopy
