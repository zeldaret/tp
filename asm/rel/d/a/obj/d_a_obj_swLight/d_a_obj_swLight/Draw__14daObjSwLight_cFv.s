...
/* 80CF7AB0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF7AB4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF7AB8  38 80 00 10 */	li r4, 0x10
/* 80CF7ABC  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CF7AC0  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CF7AC4  4B 4A BD 01 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CF7AC8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CF7ACC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CF7AD0  80 9F 05 B8 */	lwz r4, 0x5b8(r31)
/* 80CF7AD4  80 84 00 04 */	lwz r4, 4(r4)
/* 80CF7AD8  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CF7ADC  4B 4A D2 C5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80CF7B10  3C 80 80 D0 */	lis r4, lit_3781@ha /* 0x80CF842C@ha */
/* 80CF7B14  C0 44 84 2C */	lfs f2, lit_3781@l(r4)  /* 0x80CF842C@l */
/* 80CF7B18  C0 3F 0A DC */	lfs f1, 0xadc(r31)
/* 80CF7B1C  3C 80 80 D0 */	lis r4, lit_3701@ha /* 0x80CF8420@ha */
/* 80CF7B20  C0 04 84 20 */	lfs f0, lit_3701@l(r4)  /* 0x80CF8420@l */
...
/* 80CF7B4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF7B50  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF7B54  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CF7B58  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CF7B5C  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CF7B70  4B 31 61 55 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CF7B74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF7B78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
