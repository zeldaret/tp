...
/* 80C827B0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C827B4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C827D4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C827D8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80C827F0  3C 60 80 C8 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C82C6C@ha */
/* 80C827F4  38 03 2C 6C */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C82C6C@l */
/* 80C827F8  90 1E 01 38 */	stw r0, 0x138(r30)
lbl_80C827FC:
/* 80C827FC  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80C82800  41 82 00 24 */	beq lbl_80C82824
/* 80C82804  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C82808  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C8280C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C82810  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80C82814  41 82 00 10 */	beq lbl_80C82824
/* 80C82818  3C 60 80 C8 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C82C60@ha */
/* 80C8281C  38 03 2C 60 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C82C60@l */
/* 80C82820  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_80C82824:
/* 80C82824  7F C3 F3 78 */	mr r3, r30
/* 80C82828  38 80 00 00 */	li r4, 0
/* 80C8282C  4B 40 18 B9 */	bl __dt__12dCcD_GObjInfFv
/* 80C82830  7F E0 07 35 */	extsh. r0, r31
/* 80C82834  40 81 00 0C */	ble lbl_80C82840
/* 80C82838  7F C3 F3 78 */	mr r3, r30
/* 80C8283C  4B 64 C5 01 */	bl __dl__FPv
lbl_80C82840:
