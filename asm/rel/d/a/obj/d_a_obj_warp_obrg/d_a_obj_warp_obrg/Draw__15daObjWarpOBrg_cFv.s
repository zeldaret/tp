...
/* 80D2B5EC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D2B5F0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D2B5F4  38 80 00 20 */	li r4, 0x20
/* 80D2B5F8  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80D2B5FC  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80D2B600  4B 47 81 C5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80D2B604  48 00 00 1C */	b lbl_80D2B620
lbl_80D2B608:
/* 80D2B608  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D2B60C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D2B610  38 80 00 10 */	li r4, 0x10
/* 80D2B614  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80D2B618  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80D2B61C  4B 47 81 A9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
lbl_80D2B620:
/* 80D2B620  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D2B624  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D2B628  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80D2B62C  80 84 00 04 */	lwz r4, 4(r4)
/* 80D2B630  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80D2B634  4B 47 97 6D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D2B638  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2B63C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D2B640  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80D2B644  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80D2B648  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80D2B668  4B 2E 23 65 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
...
/* 80D2B680  4B 2E 20 59 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80D2B684  80 7F 05 A8 */	lwz r3, 0x5a8(r31)
/* 80D2B688  4B 2E 26 3D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80D2B68C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2B690  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
