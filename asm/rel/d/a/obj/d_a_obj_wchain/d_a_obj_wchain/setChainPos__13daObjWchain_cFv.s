...
/* 80D30834  4B 63 19 8D */	bl _savegpr_22
/* 80D30838  7C 7F 1B 78 */	mr r31, r3
/* 80D3083C  3C 60 80 D3 */	lis r3, l_arcName@ha /* 0x80D31924@ha */
/* 80D30840  3B C3 19 24 */	addi r30, r3, l_arcName@l /* 0x80D31924@l */
/* 80D30844  88 1F 07 74 */	lbz r0, 0x774(r31)
/* 80D30848  28 00 00 00 */	cmplwi r0, 0
/* 80D3084C  41 82 02 B4 */	beq lbl_80D30B00
/* 80D30850  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D30854  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D308E4  4B 53 62 51 */	bl __mi__4cXyzCFRC3Vec
...
/* 80D30900  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D30904  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D30908  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 80D3090C  7C 00 00 D0 */	neg r0, r0
/* 80D30910  7C 04 07 34 */	extsh r4, r0
/* 80D30914  4B 2D BA C9 */	bl mDoMtx_YrotS__FPA4_fs
/* 80D30918  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D3091C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D30920  38 81 00 EC */	addi r4, r1, 0xec
/* 80D30924  7C 85 23 78 */	mr r5, r4
/* 80D30928  4B 61 64 45 */	bl PSMTXMultVec
...
/* 80D3093C  4B 53 6D 39 */	bl cM_atan2s__Fff
...
/* 80D30974  4B 53 6D 01 */	bl cM_atan2s__Fff
/* 80D30978  B0 7F 07 7C */	sth r3, 0x77c(r31)
/* 80D3097C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D30980  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D30984  C0 3F 05 88 */	lfs f1, 0x588(r31)
/* 80D30988  C0 5F 05 8C */	lfs f2, 0x58c(r31)
/* 80D3098C  C0 7F 05 90 */	lfs f3, 0x590(r31)
/* 80D30990  4B 61 5F 59 */	bl PSMTXTrans
/* 80D30994  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D30998  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D3099C  A8 9F 07 7C */	lha r4, 0x77c(r31)
/* 80D309A0  4B 2D BB 2D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80D309A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D309A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D309AC  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80D309B0  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80D309B4  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80D309B8  4B 2D B8 E9 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80D309BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D309C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D309C4  38 9E 00 78 */	addi r4, r30, 0x78
/* 80D309C8  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80D309CC  4B 61 63 A1 */	bl PSMTXMultVec
...
/* 80D30A00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D30A04  3A C3 D4 70 */	addi r22, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80D30AAC  4B 61 5E 3D */	bl PSMTXTrans
/* 80D30AB0  7E C3 B3 78 */	mr r3, r22
/* 80D30AB4  A8 99 00 00 */	lha r4, 0(r25)
/* 80D30AB8  4B 2D BA 15 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80D30B18  4B 53 FC 29 */	bl cLib_chaseF__FPfff
...
/* 80D30B40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D30B44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D30B48  88 9F 07 78 */	lbz r4, 0x778(r31)
/* 80D30B4C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D30B50  7C 05 07 74 */	extsb r5, r0
/* 80D30B54  4B 30 48 0D */	bl isSwitch__10dSv_info_cCFii
...
/* 80D30B6C  4B 53 FB D5 */	bl cLib_chaseF__FPfff
...
/* 80D30B9C  4B 53 FB A5 */	bl cLib_chaseF__FPfff
lbl_80D30BA0:
...
/* 80D30C5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D30C60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80D30C80  4B 2D B7 5D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80D30C94  4B 53 6B D9 */	bl cM_rnd__Fv
/* 80D30C98  FC 00 E8 90 */	fmr f0, f29
/* 80D30C9C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80D30CA0  40 80 00 58 */	bge lbl_80D30CF8
/* 80D30CA4  4B 53 6B C9 */	bl cM_rnd__Fv
/* 80D30CA8  C0 1E 00 A8 */	lfs f0, 0xa8(r30)
/* 80D30CAC  EF E0 00 72 */	fmuls f31, f0, f1
/* 80D30CB0  FC 20 F8 90 */	fmr f1, f31
/* 80D30CB4  4B 53 69 31 */	bl cM_rad2s__Ff
/* 80D30CB8  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80D30CBC  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80D30CD0  4B 53 69 15 */	bl cM_rad2s__Ff
/* 80D30CD4  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 80D30CD8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80D30CDC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
lbl_80D30CF8:
/* 80D30CF8  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 80D30CFC  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 80D30D20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D30D24  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80D30D50  4B 53 5D E5 */	bl __mi__4cXyzCFRC3Vec
...
/* 80D30DA8  4B 61 62 E9 */	bl PSVECAdd
...
/* 80D30DD0  4B 61 62 C1 */	bl PSVECAdd
...
/* 80D30E8C  4B 61 5E E1 */	bl PSMTXMultVec
...
/* 80D30EA0  4B 53 67 D5 */	bl cM_atan2s__Fff
...
/* 80D30ED4  4B 53 67 A1 */	bl cM_atan2s__Fff
...
/* 80D30F64  4B 53 5B D1 */	bl __mi__4cXyzCFRC3Vec
...
/* 80D31018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D3101C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D31020  38 81 00 EC */	addi r4, r1, 0xec
/* 80D31024  7C 85 23 78 */	mr r5, r4
/* 80D31028  4B 61 5D 45 */	bl PSMTXMultVec
...
/* 80D3103C  4B 53 66 39 */	bl cM_atan2s__Fff
...
/* 80D31074  4B 53 66 01 */	bl cM_atan2s__Fff
...
/* 80D31098  4B 63 11 75 */	bl _restgpr_22
