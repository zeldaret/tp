...
/* 80D00BE8  4B 66 15 F4 */	b _savegpr_29
...
/* 80D00C08  4B 56 5F 2C */	b __mi__4cXyzCFRC3Vec
...
/* 80D00C24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D00C28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D00C2C  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 80D00C30  7C 00 00 D0 */	neg r0, r0
/* 80D00C34  7C 04 07 34 */	extsh r4, r0
/* 80D00C38  4B 30 B7 A4 */	b mDoMtx_YrotS__FPA4_fs
/* 80D00C3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D00C40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D00C44  38 81 00 14 */	addi r4, r1, 0x14
/* 80D00C48  7C 85 23 78 */	mr r5, r4
/* 80D00C4C  4B 64 61 20 */	b PSMTXMultVec
/* 80D00C50  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80D00C54  3C 60 80 D0 */	lis r3, lit_3698@ha
/* 80D00C58  C0 03 20 90 */	lfs f0, lit_3698@l(r3)
...
/* 80D00CC4  4B 66 15 64 */	b _restgpr_29
