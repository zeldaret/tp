...
/* 80D00F00  3C 60 80 D0 */	lis r3, l_arcName@ha /* 0x80D020EC@ha */
/* 80D00F04  38 63 20 EC */	addi r3, r3, l_arcName@l /* 0x80D020EC@l */
/* 80D00F08  7C 63 00 2E */	lwzx r3, r3, r0
/* 80D00F0C  3C 80 80 D0 */	lis r4, l_bmd@ha /* 0x80D0206C@ha */
/* 80D00F10  38 84 20 6C */	addi r4, r4, l_bmd@l /* 0x80D0206C@l */
/* 80D00F14  7C 84 00 2E */	lwzx r4, r4, r0
/* 80D00F18  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D00F1C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D00F20  3C A5 00 02 */	addis r5, r5, 2
/* 80D00F24  38 C0 00 80 */	li r6, 0x80
/* 80D00F28  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80D00F2C  4B 33 B3 C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D00F3C  4B 31 3D 19 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
