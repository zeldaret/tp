...
/* 80CDA174  4B 68 80 65 */	bl _savegpr_28
...
/* 80CDA198  4B 33 E9 CD */	bl __ct__10fopAc_ac_cFv
/* 80CDA19C  3C 60 80 3B */	lis r3, __vt__12daItemBase_c@ha /* 0x803B3610@ha */
/* 80CDA1A0  38 03 36 10 */	addi r0, r3, __vt__12daItemBase_c@l /* 0x803B3610@l */
/* 80CDA1A4  90 1D 05 68 */	stw r0, 0x568(r29)
/* 80CDA1A8  3B 9D 05 8C */	addi r28, r29, 0x58c
/* 80CDA1AC  7F 83 E3 78 */	mr r3, r28
/* 80CDA1B0  4B 39 BE F1 */	bl __ct__9dBgS_AcchFv
/* 80CDA1B4  3C 60 80 CE */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80CDBA38@ha */
/* 80CDA1B8  38 63 BA 38 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80CDBA38@l */
...
/* 80CDA1D4  4B 39 EC 95 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80CDA1D8  38 7D 07 64 */	addi r3, r29, 0x764
/* 80CDA1DC  4B 39 BC D1 */	bl __ct__12dBgS_AcchCirFv
/* 80CDA1E0  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CDA1E4  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CDA1E8  90 1D 07 BC */	stw r0, 0x7bc(r29)
/* 80CDA1EC  38 7D 07 C0 */	addi r3, r29, 0x7c0
/* 80CDA1F0  4B 3A 95 71 */	bl __ct__10dCcD_GSttsFv
/* 80CDA1F4  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CDA1F8  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CDA210  4B 3A 98 19 */	bl __ct__12dCcD_GObjInfFv
/* 80CDA214  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CDA218  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CDA21C  90 1C 01 20 */	stw r0, 0x120(r28)
/* 80CDA220  3C 60 80 CE */	lis r3, __vt__8cM3dGAab@ha /* 0x80CDBA2C@ha */
/* 80CDA224  38 03 BA 2C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CDBA2C@l */
/* 80CDA228  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 80CDA22C  3C 60 80 CE */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CDBA20@ha */
/* 80CDA230  38 03 BA 20 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CDBA20@l */
/* 80CDA234  90 1C 01 38 */	stw r0, 0x138(r28)
/* 80CDA238  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CDA23C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80CDA240  90 7C 01 20 */	stw r3, 0x120(r28)
/* 80CDA244  38 03 00 58 */	addi r0, r3, 0x58
/* 80CDA248  90 1C 01 38 */	stw r0, 0x138(r28)
/* 80CDA24C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CDA250  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80CDA268  3C 60 80 CE */	lis r3, __vt__7daKey_c@ha /* 0x80CDBA5C@ha */
/* 80CDA26C  38 03 BA 5C */	addi r0, r3, __vt__7daKey_c@l /* 0x80CDBA5C@l */
/* 80CDA270  90 1E 05 68 */	stw r0, 0x568(r30)
/* 80CDA274  38 7E 09 3C */	addi r3, r30, 0x93c
/* 80CDA278  3C 80 80 CE */	lis r4, __defctor__19dPa_followEcallBackFv@ha /* 0x80CDA48C@ha */
/* 80CDA27C  38 84 A4 8C */	addi r4, r4, __defctor__19dPa_followEcallBackFv@l /* 0x80CDA48C@l */
/* 80CDA280  3C A0 80 CE */	lis r5, __dt__19dPa_followEcallBackFv@ha /* 0x80CDA404@ha */
/* 80CDA284  38 A5 A4 04 */	addi r5, r5, __dt__19dPa_followEcallBackFv@l /* 0x80CDA404@l */
/* 80CDA288  38 C0 00 14 */	li r6, 0x14
/* 80CDA28C  38 E0 00 02 */	li r7, 2
/* 80CDA290  4B 68 7A D1 */	bl __construct_array
lbl_80CDA294:
...
/* 80CDA2E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDA2EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CDA2F0  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 80CDA2F4  3C 80 80 CE */	lis r4, d_a_obj_smallkey__stringBase0@ha /* 0x80CDB890@ha */
/* 80CDA2F8  38 84 B8 90 */	addi r4, r4, d_a_obj_smallkey__stringBase0@l /* 0x80CDB890@l */
/* 80CDA2FC  4B 68 E6 99 */	bl strcmp
...
/* 80CDA310  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDA314  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CDA318  3B C3 09 58 */	addi r30, r3, 0x958
/* 80CDA31C  7F C3 F3 78 */	mr r3, r30
/* 80CDA320  4B 35 A4 C9 */	bl isTbox__12dSv_memBit_cCFi
/* 80CDA324  2C 03 00 00 */	cmpwi r3, 0
/* 80CDA328  41 82 00 34 */	beq lbl_80CDA35C
/* 80CDA32C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDA330  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CDA358  4B 35 A4 6D */	bl offTbox__12dSv_memBit_cFi
lbl_80CDA35C:
/* 80CDA35C  80 1F 00 B0 */	lwz r0, 0xb0(r31)
/* 80CDA360  54 04 C6 3E */	rlwinm r4, r0, 0x18, 0x18, 0x1f
/* 80CDA364  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDA368  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CDA36C  38 63 09 58 */	addi r3, r3, 0x958
/* 80CDA370  4B 35 A4 79 */	bl isTbox__12dSv_memBit_cCFi
...
/* 80CDA38C  3C 60 80 3B */	lis r3, field_item_res__10dItem_data@ha /* 0x803ADD88@ha */
/* 80CDA390  38 63 DD 88 */	addi r3, r3, field_item_res__10dItem_data@l /* 0x803ADD88@l */
/* 80CDA394  7C 83 00 2E */	lwzx r4, r3, r0
/* 80CDA398  38 7F 05 6C */	addi r3, r31, 0x56c
/* 80CDA39C  4B 35 2B 21 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CDA3B0  3C 80 80 03 */	lis r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@ha /* 0x80037B78@ha */
/* 80CDA3B4  38 84 7B 78 */	addi r4, r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@l /* 0x80037B78@l */
/* 80CDA3B8  38 A0 08 40 */	li r5, 0x840
/* 80CDA3BC  4B 34 00 F5 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80CDA3F0  4B 68 7E 35 */	bl _restgpr_28
