...
lbl_80CC88D4:
/* 80CC88D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC88D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC88DC  3B C3 5B D4 */	addi r30, r3, 0x5bd4
/* 80CC88E0  7F C3 F3 78 */	mr r3, r30
/* 80CC88E4  4B 3A 75 79 */	bl CheckQuake__12dVibration_cFv
...
/* 80CC88F8  4B 3A 74 9D */	bl StopQuake__12dVibration_cFi
lbl_80CC88FC:
...
/* 80CC8924  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC8928  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC892C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CC8930  7C 05 07 74 */	extsb r5, r0
/* 80CC8934  4B 36 CA 2D */	bl isSwitch__10dSv_info_cCFii
...
/* 80CC8948  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC894C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC8950  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CC8954  7C 05 07 74 */	extsb r5, r0
/* 80CC8958  4B 36 C8 A9 */	bl onSwitch__10dSv_info_cFii
lbl_80CC895C:
/* 80CC895C  38 60 00 07 */	li r3, 7
/* 80CC8960  3C 80 80 CD */	lis r4, lit_3994@ha /* 0x80CC91AC@ha */
/* 80CC8964  C0 24 91 AC */	lfs f1, lit_3994@l(r4)  /* 0x80CC91AC@l */
...
/* 80CC897C  4B 35 E7 F5 */	bl dStage_changeScene__FifUlScsi
lbl_80CC8980:
