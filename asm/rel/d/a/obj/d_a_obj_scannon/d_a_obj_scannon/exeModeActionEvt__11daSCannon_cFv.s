...
/* 80CC7D2C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC7D30  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC7D34  38 7E 4F F8 */	addi r3, r30, 0x4ff8
/* 80CC7D38  A8 9F 06 10 */	lha r4, 0x610(r31)
/* 80CC7D3C  4B 37 FD 3D */	bl endCheck__16dEvent_manager_cFs
/* 80CC7D40  2C 03 00 00 */	cmpwi r3, 0
/* 80CC7D44  41 82 01 08 */	beq lbl_80CC7E4C
/* 80CC7D48  38 7E 4E C8 */	addi r3, r30, 0x4ec8
/* 80CC7D4C  4B 37 A7 1D */	bl reset__14dEvt_control_cFv
...
/* 80CC7D94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC7D98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC7D9C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CC7DA0  7C 05 07 74 */	extsb r5, r0
/* 80CC7DA4  4B 36 D5 BD */	bl isSwitch__10dSv_info_cCFii
...
/* 80CC7E00  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC7E04  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC7E08  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CC7E0C  7C 05 07 74 */	extsb r5, r0
/* 80CC7E10  4B 36 D5 51 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CC7E24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC7E28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC7E2C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CC7E30  7C 05 07 74 */	extsb r5, r0
/* 80CC7E34  4B 36 D3 CD */	bl onSwitch__10dSv_info_cFii
lbl_80CC7E38:
...
/* 80CC7E68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC7E6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC7E70  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CC7E74  7C 05 07 74 */	extsb r5, r0
/* 80CC7E78  4B 36 D4 E9 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CC7E8C  3C A0 80 CC */	lis r5, eventCallBack__FPvi@ha /* 0x80CC6A98@ha */
/* 80CC7E90  38 A5 6A 98 */	addi r5, r5, eventCallBack__FPvi@l /* 0x80CC6A98@l */
/* 80CC7E94  38 C0 00 00 */	li r6, 0
/* 80CC7E98  4B 37 AA 7D */	bl setSkipProc__14dEvt_control_cFPvPFPvi_ii
lbl_80CC7E9C:
