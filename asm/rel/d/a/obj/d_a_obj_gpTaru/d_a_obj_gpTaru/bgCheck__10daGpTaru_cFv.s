...
/* 8057DBA4  4B DE 46 29 */	bl _savegpr_25
/* 8057DBA8  7C 79 1B 78 */	mr r25, r3
/* 8057DBAC  3C 60 80 58 */	lis r3, lit_3656@ha /* 0x8057F570@ha */
/* 8057DBB0  3B E3 F5 70 */	addi r31, r3, lit_3656@l /* 0x8057F570@l */
...
/* 8057DBD8  4B DC 95 61 */	bl PSVECSquareMag
...
/* 8057DC48  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8057DC4C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8057DCB8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8057DCBC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8057DCC0:
...
/* 8057DD3C  4B DC 93 FD */	bl PSVECSquareMag
...
/* 8057DDAC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8057DDB0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8057DE1C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8057DE20  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8057DE24:
/* 8057DE24  D0 39 05 2C */	stfs f1, 0x52c(r25)
/* 8057DE28  C0 21 00 58 */	lfs f1, 0x58(r1)
/* 8057DE2C  C0 41 00 60 */	lfs f2, 0x60(r1)
/* 8057DE30  4B CE 98 45 */	bl cM_atan2s__Fff
...
/* 8057DE44  4B DC 92 F5 */	bl PSVECSquareMag
...
/* 8057DEB4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8057DEB8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8057DF24  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8057DF28  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8057DF2C:
...
/* 8057E064  4B AA 18 19 */	bl fopKyM_createWpillar__FPC4cXyzfi
/* 8057E068  88 19 04 E2 */	lbz r0, 0x4e2(r25)
/* 8057E06C  7C 03 07 74 */	extsb r3, r0
/* 8057E070  4B AA EF FD */	bl dComIfGp_getReverb__Fi
...
/* 8057E084  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8057E088  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8057E0B0  4B D2 D8 D5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8057E0B4:
...
/* 8057E0D8  3C 60 80 58 */	lis r3, l_HIO@ha /* 0x8057F8E4@ha */
/* 8057E0DC  38 63 F8 E4 */	addi r3, r3, l_HIO@l /* 0x8057F8E4@l */
...
/* 8057E0FC  4B DC 8F DD */	bl PSVECScale
...
/* 8057E11C  4B A9 BC 7D */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
/* 8057E120  88 19 04 E2 */	lbz r0, 0x4e2(r25)
/* 8057E124  7C 03 07 74 */	extsb r3, r0
/* 8057E128  4B AA EF 45 */	bl dComIfGp_getReverb__Fi
...
/* 8057E13C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8057E140  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8057E168  4B D2 D8 1D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8057E16C:
...
/* 8057E1F8  4B A9 EF 15 */	bl fopAcM_effHamonSet__FPUlPC4cXyzff
lbl_8057E1FC:
...
/* 8057E210  4B DE 40 09 */	bl _restgpr_25
