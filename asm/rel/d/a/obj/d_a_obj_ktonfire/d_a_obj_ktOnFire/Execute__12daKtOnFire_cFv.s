...
/* 8058CA2C  4B DD 57 B1 */	bl _savegpr_29
/* 8058CA30  7C 7F 1B 78 */	mr r31, r3
/* 8058CA34  3C 60 80 59 */	lis r3, mCcDObjInfo__12daKtOnFire_c@ha /* 0x8058CF88@ha */
/* 8058CA38  3B C3 CF 88 */	addi r30, r3, mCcDObjInfo__12daKtOnFire_c@l /* 0x8058CF88@l */
/* 8058CA3C  8B BF 06 E1 */	lbz r29, 0x6e1(r31)
/* 8058CA40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058CA44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058CA58  4B AA 89 09 */	bl isSwitch__10dSv_info_cCFii
...
/* 8058CA74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058CA78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058CA8C  4B AA 88 25 */	bl offSwitch__10dSv_info_cFii
...
/* 8058CAFC  4B AA 05 71 */	bl dComIfGp_getReverb__Fi
...
/* 8058CB10  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058CB14  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058CB3C  4B D1 EE 49 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8058CB40  3C 60 80 59 */	lis r3, l_HIO@ha /* 0x8058D0CC@ha */
/* 8058CB44  38 63 D0 CC */	addi r3, r3, l_HIO@l /* 0x8058D0CC@l */
...
/* 8058CB90  4B AA 04 DD */	bl dComIfGp_getReverb__Fi
...
/* 8058CBA4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058CBA8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058CBD0  4B D1 ED B5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8058CBD4  3C 60 80 59 */	lis r3, l_HIO@ha /* 0x8058D0CC@ha */
/* 8058CBD8  38 63 D0 CC */	addi r3, r3, l_HIO@l /* 0x8058D0CC@l */
...
/* 8058CBF4  4B CE 26 0D */	bl SetR__8cM3dGCylFf
/* 8058CBF8  38 7F 06 C8 */	addi r3, r31, 0x6c8
/* 8058CBFC  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 8058CC00  4B CE 25 F9 */	bl SetH__8cM3dGCylFf
/* 8058CC04  38 7F 06 C8 */	addi r3, r31, 0x6c8
/* 8058CC08  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 8058CC0C  4B CE 25 D1 */	bl SetC__8cM3dGCylFRC4cXyz
/* 8058CC10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058CC14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058CC18  38 63 23 3C */	addi r3, r3, 0x233c
/* 8058CC1C  38 9F 05 A4 */	addi r4, r31, 0x5a4
/* 8058CC20  4B CD 7F 89 */	bl Set__4cCcSFP8cCcD_Obj
/* 8058CC24  88 1F 06 E2 */	lbz r0, 0x6e2(r31)
/* 8058CC28  28 00 00 00 */	cmplwi r0, 0
/* 8058CC2C  41 82 01 48 */	beq lbl_8058CD74
/* 8058CC30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058CC34  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058CC80  4B AC 08 4D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8058CCD0  4B AC 07 FD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8058CD20  4B AC 07 AD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8058CD24  90 7F 06 F8 */	stw r3, 0x6f8(r31)
/* 8058CD28  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8058CD2C  7C 03 07 74 */	extsb r3, r0
/* 8058CD30  4B AA 03 3D */	bl dComIfGp_getReverb__Fi
...
/* 8058CD44  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058CD48  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058CD70  4B D1 F7 9D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8058CD74:
...
/* 8058CDA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058CDA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058CDB8  4B AA 84 49 */	bl onSwitch__10dSv_info_cFii
/* 8058CDBC  48 00 00 20 */	b lbl_8058CDDC
lbl_8058CDC0:
/* 8058CDC0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058CDC4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058CDD8  4B AA 84 D9 */	bl offSwitch__10dSv_info_cFii
lbl_8058CDDC:
/* 8058CDDC  38 60 00 01 */	li r3, 1
/* 8058CDE0  39 61 00 40 */	addi r11, r1, 0x40
/* 8058CDE4  4B DD 54 45 */	bl _restgpr_29
