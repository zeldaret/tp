...
/* 80C41280  4B 72 0F 5D */	bl _savegpr_29
/* 80C41284  2C 04 00 00 */	cmpwi r4, 0
/* 80C41288  40 82 00 A8 */	bne lbl_80C41330
/* 80C4128C  A0 83 00 14 */	lhz r4, 0x14(r3)
/* 80C41290  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C41294  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C412C0  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80C412C4  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80C412C8  80 84 00 00 */	lwz r4, 0(r4)
/* 80C412CC  4B 70 51 E5 */	bl PSMTXCopy
/* 80C412D0  C0 3D 2A FC */	lfs f1, 0x2afc(r29)
/* 80C412D4  3C 60 80 C4 */	lis r3, lit_3689@ha /* 0x80C439E8@ha */
/* 80C412D8  C0 43 39 E8 */	lfs f2, lit_3689@l(r3)  /* 0x80C439E8@l */
/* 80C412DC  FC 60 10 90 */	fmr f3, f2
/* 80C412E0  38 60 00 01 */	li r3, 1
/* 80C412E4  4B 62 FB 79 */	bl MtxTrans__FfffUc
/* 80C412E8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C412EC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80C412F0  80 63 00 00 */	lwz r3, 0(r3)
/* 80C412F4  A8 9D 2B 00 */	lha r4, 0x2b00(r29)
/* 80C412F8  4B 3C B0 A5 */	bl mDoMtx_XrotM__FPA4_fs
/* 80C412FC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C41300  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80C41314  4B 70 51 9D */	bl PSMTXCopy
/* 80C41318  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C4131C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80C41320  80 63 00 00 */	lwz r3, 0(r3)
/* 80C41324  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80C41328  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80C4132C  4B 70 51 85 */	bl PSMTXCopy
lbl_80C41330:
/* 80C41330  38 60 00 01 */	li r3, 1
/* 80C41334  39 61 00 20 */	addi r11, r1, 0x20
/* 80C41338  4B 72 0E F1 */	bl _restgpr_29
