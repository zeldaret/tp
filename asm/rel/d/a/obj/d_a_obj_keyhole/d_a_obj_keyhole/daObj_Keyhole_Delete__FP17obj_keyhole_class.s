...
/* 80C42D3C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C42D40  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C42D44  3C A5 00 02 */	addis r5, r5, 2
/* 80C42D48  38 C0 00 80 */	li r6, 0x80
/* 80C42D4C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C42D50  4B 3F 95 9D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C42D54  7C 64 1B 78 */	mr r4, r3
/* 80C42D58  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C42D5C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C42D60  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C42D64  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C42D68  7C 05 07 74 */	extsb r5, r0
/* 80C42D6C  4B 3E 9D C5 */	bl removeSimpleModel__14dComIfG_play_cFP12J3DModelDatai
...
/* 80C42D80  4B 3E A2 89 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80C42D94  3C 60 80 C4 */	lis r3, struct_80C43CE4+0x1@ha /* 0x80C43CE5@ha */
/* 80C42D98  98 03 3C E5 */	stb r0, struct_80C43CE4+0x1@l(r3)  /* 0x80C43CE5@l */
lbl_80C42D9C:
...
/* 80C42DAC  4B 67 D9 49 */	bl stopAnime__10Z2CreatureFv
lbl_80C42DB0:
