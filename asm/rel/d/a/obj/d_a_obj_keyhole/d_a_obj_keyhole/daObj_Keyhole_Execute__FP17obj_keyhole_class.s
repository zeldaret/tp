...
/* 80C427E0  4B 71 F9 FD */	bl _savegpr_29
/* 80C427E4  7C 7E 1B 78 */	mr r30, r3
/* 80C427E8  3C 60 80 C4 */	lis r3, lit_3655@ha /* 0x80C439E4@ha */
/* 80C427EC  3B E3 39 E4 */	addi r31, r3, lit_3655@l /* 0x80C439E4@l */
...
/* 80C428CC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80C428D0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80C428D4  80 63 00 00 */	lwz r3, 0(r3)
/* 80C428D8  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C428DC  4B 3C 9B 01 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80C428EC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C428F0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C4298C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C42990  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C429C0  4B 62 D0 C1 */	bl cLib_addCalc0__FPfff
...
/* 80C429EC  4B 62 D0 95 */	bl cLib_addCalc0__FPfff
lbl_80C429F0:
/* 80C429F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C429F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C429F8  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80C429FC  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80C42A00  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80C42A04  4B 70 3E E5 */	bl PSMTXTrans
/* 80C42A08  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42A0C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42A10  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80C42A14  4B 3C 9A 21 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C42A18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42A1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42A20  A8 9E 2A EC */	lha r4, 0x2aec(r30)
/* 80C42A24  4B 3C 9A 11 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C42A28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42A2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42A30  7F A4 07 34 */	extsh r4, r29
/* 80C42A34  4B 3C 99 69 */	bl mDoMtx_XrotM__FPA4_fs
/* 80C42A38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42A3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42A40  A8 1E 2A EC */	lha r0, 0x2aec(r30)
/* 80C42A44  7C 00 00 D0 */	neg r0, r0
/* 80C42A48  7C 04 07 34 */	extsh r4, r0
/* 80C42A4C  4B 3C 99 E9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C42A50  88 1E 05 84 */	lbz r0, 0x584(r30)
/* 80C42A54  28 00 00 00 */	cmplwi r0, 0
/* 80C42A58  40 82 00 18 */	bne lbl_80C42A70
/* 80C42A5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42A60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42A64  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C42A68  4B 3C 99 35 */	bl mDoMtx_XrotM__FPA4_fs
/* 80C42A6C  48 00 00 1C */	b lbl_80C42A88
lbl_80C42A70:
/* 80C42A70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42A74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42A78  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C42A7C  38 04 C0 00 */	addi r0, r4, -16384
/* 80C42A80  7C 04 07 34 */	extsh r4, r0
/* 80C42A84  4B 3C 99 19 */	bl mDoMtx_XrotM__FPA4_fs
lbl_80C42A88:
/* 80C42A88  C0 3E 2A F0 */	lfs f1, 0x2af0(r30)
/* 80C42A8C  C0 5E 2A F4 */	lfs f2, 0x2af4(r30)
/* 80C42A90  C0 7E 2A F8 */	lfs f3, 0x2af8(r30)
/* 80C42A94  4B 3C A3 09 */	bl transM__14mDoMtx_stack_cFfff
/* 80C42A98  88 1E 05 84 */	lbz r0, 0x584(r30)
/* 80C42A9C  28 00 00 00 */	cmplwi r0, 0
/* 80C42AA0  40 82 00 1C */	bne lbl_80C42ABC
/* 80C42AA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42AA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42AAC  80 9E 05 78 */	lwz r4, 0x578(r30)
/* 80C42AB0  38 84 00 24 */	addi r4, r4, 0x24
/* 80C42AB4  4B 70 39 FD */	bl PSMTXCopy
/* 80C42AB8  48 00 00 50 */	b lbl_80C42B08
lbl_80C42ABC:
/* 80C42ABC  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80C42AC0  83 A3 00 04 */	lwz r29, 4(r3)
/* 80C42AC4  3C 60 80 C4 */	lis r3, l_HIO@ha /* 0x80C43CF4@ha */
/* 80C42AC8  38 63 3C F4 */	addi r3, r3, l_HIO@l /* 0x80C43CF4@l */
/* 80C42ACC  C0 23 00 08 */	lfs f1, 8(r3)
/* 80C42AD0  FC 40 08 90 */	fmr f2, f1
/* 80C42AD4  FC 60 08 90 */	fmr f3, f1
/* 80C42AD8  4B 3C A3 61 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80C42ADC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42AE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42AE4  38 9D 00 24 */	addi r4, r29, 0x24
/* 80C42AE8  4B 70 39 C9 */	bl PSMTXCopy
...
/* 80C42AFC  4B 3C DA CD */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 80C42B00  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80C42B04  4B 3C DB A9 */	bl modelCalc__14mDoExt_McaMorfFv
lbl_80C42B08:
...
/* 80C42B20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C42B24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C42B28  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80C42B2C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80C42B30  80 84 00 00 */	lwz r4, 0(r4)
/* 80C42B34  4B 70 39 7D */	bl PSMTXCopy
...
/* 80C42B50  4B 62 E3 9D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80C42B78  4B 62 CA D1 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 80C42B90  4B 62 CB 79 */	bl SetR__8cM3dGSphFf
/* 80C42B94  48 00 00 20 */	b lbl_80C42BB4
lbl_80C42B98:
/* 80C42B98  38 7E 2C 64 */	addi r3, r30, 0x2c64
/* 80C42B9C  C0 3F 00 A4 */	lfs f1, 0xa4(r31)
/* 80C42BA0  3C 80 80 C4 */	lis r4, l_HIO@ha /* 0x80C43CF4@ha */
/* 80C42BA4  38 84 3C F4 */	addi r4, r4, l_HIO@l /* 0x80C43CF4@l */
/* 80C42BA8  C0 04 00 08 */	lfs f0, 8(r4)
/* 80C42BAC  EC 21 00 32 */	fmuls f1, f1, f0
/* 80C42BB0  4B 62 CB 59 */	bl SetR__8cM3dGSphFf
lbl_80C42BB4:
/* 80C42BB4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C42BB8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C42BBC  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C42BC0  38 9E 2B 40 */	addi r4, r30, 0x2b40
/* 80C42BC4  4B 62 1F E5 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80C42BD8  4B 44 1A 81 */	bl ChkCoHit__12dCcD_GObjInfFv
...
/* 80C42BF0  4B 44 18 71 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 80C42C08  4B 44 18 F1 */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 80C42C0C  90 7E 2C 78 */	stw r3, 0x2c78(r30)
/* 80C42C10  38 7E 2C 78 */	addi r3, r30, 0x2c78
/* 80C42C14  4B 44 4E 45 */	bl at_power_check__FP11dCcU_AtInfo
...
/* 80C42C64  4B 44 48 B1 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
lbl_80C42C68:
/* 80C42C68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C42C6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C42C8C  4B 3D 7C D9 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C42CD0  4B 3E A3 9D */	bl dComIfGp_getReverb__Fi
...
/* 80C42CF8  4B 71 F5 31 */	bl _restgpr_29
