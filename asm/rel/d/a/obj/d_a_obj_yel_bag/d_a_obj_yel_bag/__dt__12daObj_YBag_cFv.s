...
/* 80D3C418  4B 62 5D B8 */	b _savegpr_26
/* 80D3C41C  7C 7E 1B 79 */	or. r30, r3, r3
/* 80D3C420  7C 9F 23 78 */	mr r31, r4
/* 80D3C424  41 82 01 D0 */	beq lbl_80D3C5F4
/* 80D3C428  3C 60 80 D4 */	lis r3, __vt__12daObj_YBag_c@ha
/* 80D3C42C  38 03 DE 50 */	addi r0, r3, __vt__12daObj_YBag_c@l
/* 80D3C430  90 1E 0A 38 */	stw r0, 0xa38(r30)
/* 80D3C434  3B A0 00 00 */	li r29, 0
/* 80D3C438  3B 80 00 00 */	li r28, 0
/* 80D3C43C  3C 60 80 D4 */	lis r3, l_resNames@ha
/* 80D3C440  3B 43 DD B0 */	addi r26, r3, l_resNames@l
/* 80D3C444  3C 60 80 D4 */	lis r3, l_loadRes_list@ha
/* 80D3C448  3B 63 DD A8 */	addi r27, r3, l_loadRes_list@l
...
/* 80D3C460  4B 2F 0B A8 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 80D3C48C  4B 33 B8 50 */	b __dt__11dBgS_LinChkFv
/* 80D3C490  38 7E 09 18 */	addi r3, r30, 0x918
/* 80D3C494  38 80 FF FF */	li r4, -1
/* 80D3C498  4B 52 B7 FC */	b __dt__11cBgS_GndChkFv
/* 80D3C49C  34 1E 07 DC */	addic. r0, r30, 0x7dc
/* 80D3C4A0  41 82 00 84 */	beq lbl_80D3C524
/* 80D3C4A4  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80D3C4A8  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80D3C4C8  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80D3C4CC  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80D3C574  3C 60 80 D4 */	lis r3, __vt__10dCcD_GStts@ha
/* 80D3C578  38 03 DE 68 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 80D3C57C  90 1E 07 7C */	stw r0, 0x77c(r30)
/* 80D3C580  34 1E 07 7C */	addic. r0, r30, 0x77c
/* 80D3C584  41 82 00 10 */	beq lbl_80D3C594
/* 80D3C588  3C 60 80 D4 */	lis r3, __vt__10cCcD_GStts@ha
/* 80D3C58C  38 03 DE 5C */	addi r0, r3, __vt__10cCcD_GStts@l
/* 80D3C590  90 1E 07 7C */	stw r0, 0x77c(r30)
lbl_80D3C594:
/* 80D3C594  34 1E 07 60 */	addic. r0, r30, 0x760
/* 80D3C598  41 82 00 10 */	beq lbl_80D3C5A8
/* 80D3C59C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80D3C5A0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80D3C5A4  90 1E 07 78 */	stw r0, 0x778(r30)
lbl_80D3C5A8:
/* 80D3C5A8  34 1E 05 88 */	addic. r0, r30, 0x588
/* 80D3C5AC  41 82 00 2C */	beq lbl_80D3C5D8
/* 80D3C5B0  3C 60 80 D4 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80D3C5B4  38 63 DE 98 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
