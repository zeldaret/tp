...
/* 80D3D344  3C 60 80 D4 */	lis r3, mCcDObjInfo__12daObj_YBag_c@ha /* 0x80D3DC8C@ha */
/* 80D3D348  3B E3 DC 8C */	addi r31, r3, mCcDObjInfo__12daObj_YBag_c@l /* 0x80D3DC8C@l */
/* 80D3D34C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D3D350  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D3D354  38 80 00 00 */	li r4, 0
/* 80D3D358  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80D3D35C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80D3D360  4B 46 64 65 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80D3D364  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80D3D368  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80D3D36C  80 9E 05 80 */	lwz r4, 0x580(r30)
/* 80D3D370  80 84 00 04 */	lwz r4, 4(r4)
/* 80D3D374  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80D3D378  4B 46 7A 29 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D3D37C  80 7E 05 80 */	lwz r3, 0x580(r30)
/* 80D3D380  4B 2D 09 45 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D3D39C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D3D3A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D3D3BC  4B 2D C6 01 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80D3D40C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80D3D410  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80D3D414  4B 2F 14 FD */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
