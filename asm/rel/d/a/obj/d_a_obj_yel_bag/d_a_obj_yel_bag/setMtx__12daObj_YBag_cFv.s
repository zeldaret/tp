...
/* 80D3D5F4  3C 60 80 D4 */	lis r3, lit_4334@ha
/* 80D3D5F8  C8 23 DD 4C */	lfd f1, lit_4334@l(r3)
...
/* 80D3D614  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80D3D618  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80D3D638  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D3D63C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D3D640  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80D3D644  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80D3D648  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80D3D64C  4B 60 92 9C */	b PSMTXTrans
/* 80D3D650  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80D3D654  4B 2C F8 F0 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D3D658  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D3D65C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D3D660  7F C4 F3 78 */	mr r4, r30
/* 80D3D664  4B 2C ED D0 */	b mDoMtx_YrotM__FPA4_fs
/* 80D3D668  38 7F 04 EC */	addi r3, r31, 0x4ec
/* 80D3D66C  4B 2C F8 04 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
/* 80D3D670  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D3D674  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D3D678  80 9F 05 80 */	lwz r4, 0x580(r31)
/* 80D3D67C  38 84 00 24 */	addi r4, r4, 0x24
/* 80D3D680  4B 60 8E 30 */	b PSMTXCopy
