...
/* 80584AE8  4B DD D6 ED */	bl _savegpr_27
/* 80584AEC  7C 7F 1B 78 */	mr r31, r3
/* 80584AF0  3C 60 80 58 */	lis r3, lit_3970@ha /* 0x80585620@ha */
/* 80584AF4  3B 83 56 20 */	addi r28, r3, lit_3970@l /* 0x80585620@l */
...
/* 80584B14  4B CE 28 E1 */	bl __ct__5csXyzFsss
...
/* 80584B78  3C 60 80 58 */	lis r3, data_805858B8@ha /* 0x805858B8@ha */
/* 80584B7C  38 63 58 B8 */	addi r3, r3, data_805858B8@l /* 0x805858B8@l */
...
/* 80584BB8  4B A8 81 AD */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80584BBC  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80584BC0  4B A8 83 85 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80584BC4  38 61 00 08 */	addi r3, r1, 8
/* 80584BC8  4B A8 83 7D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80584BCC  38 7F 05 DC */	addi r3, r31, 0x5dc
/* 80584BD0  4B A8 82 05 */	bl transM__14mDoMtx_stack_cFRC4cXyz
/* 80584BD4  38 61 00 10 */	addi r3, r1, 0x10
/* 80584BD8  4B A8 81 FD */	bl transM__14mDoMtx_stack_cFRC4cXyz
...
/* 80584C14  4B A8 81 51 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80584C18  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80584C1C  4B A8 83 29 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80584C20  38 7F 05 DC */	addi r3, r31, 0x5dc
/* 80584C24  4B A8 81 B1 */	bl transM__14mDoMtx_stack_cFRC4cXyz
/* 80584C28  38 61 00 10 */	addi r3, r1, 0x10
/* 80584C2C  4B A8 81 A9 */	bl transM__14mDoMtx_stack_cFRC4cXyz
/* 80584C30  48 00 00 2C */	b lbl_80584C5C
lbl_80584C34:
/* 80584C34  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80584C38  4B A8 81 2D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80584C3C  38 7F 05 EE */	addi r3, r31, 0x5ee
/* 80584C40  4B A8 83 05 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80584C44  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80584C48  4B A8 82 FD */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80584C4C  38 7F 05 DC */	addi r3, r31, 0x5dc
/* 80584C50  4B A8 81 85 */	bl transM__14mDoMtx_stack_cFRC4cXyz
/* 80584C54  38 7F 05 F4 */	addi r3, r31, 0x5f4
/* 80584C58  4B A8 82 ED */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80584C5C:
/* 80584C5C  3C 60 80 58 */	lis r3, l_HIO@ha /* 0x80585CC4@ha */
/* 80584C60  38 63 5C C4 */	addi r3, r3, l_HIO@l /* 0x80585CC4@l */
/* 80584C64  C0 23 00 08 */	lfs f1, 8(r3)
/* 80584C68  FC 40 08 90 */	fmr f2, f1
/* 80584C6C  FC 60 08 90 */	fmr f3, f1
/* 80584C70  4B A8 81 C9 */	bl scaleM__14mDoMtx_stack_cFfff
...
/* 80584C84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80584C88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80584C8C  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80584C90  38 84 00 24 */	addi r4, r4, 0x24
/* 80584C94  4B DC 18 1D */	bl PSMTXCopy
...
/* 80584CA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80584CAC  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_80584CB0:
...
/* 80584CD0  4B DC 17 E1 */	bl PSMTXCopy
lbl_80584CD4:
...
/* 80584CE8  4B DD D5 39 */	bl _restgpr_27
