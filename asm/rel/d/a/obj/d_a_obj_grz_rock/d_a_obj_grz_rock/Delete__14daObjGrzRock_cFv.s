...
/* 80C1525C  3C 60 80 C1 */	lis r3, l_arcName@ha /* 0x80C1538C@ha */
/* 80C15260  38 83 53 8C */	addi r4, r3, l_arcName@l /* 0x80C1538C@l */
/* 80C15264  38 7F 05 A0 */	addi r3, r31, 0x5a0
/* 80C15268  80 84 00 00 */	lwz r4, 0(r4)
/* 80C1526C  4B 41 7D 9D */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80C15270  80 7F 05 68 */	lwz r3, 0x568(r31)
/* 80C15274  28 03 00 00 */	cmplwi r3, 0
/* 80C15278  41 82 00 24 */	beq lbl_80C1529C
/* 80C1527C  4B 65 2F 59 */	bl ChkUsed__9cBgW_BgIdCFv
/* 80C15280  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C15284  41 82 00 18 */	beq lbl_80C1529C
/* 80C15288  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1528C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C15290  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C15294  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80C15298  4B 45 EF B9 */	bl Release__4cBgSFP9dBgW_Base
lbl_80C1529C:
