...
/* 80C14F60  4B 74 D2 7D */	bl _savegpr_29
...
/* 80C14F80  4B 46 36 A5 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C14F84  3C 60 80 C1 */	lis r3, __vt__14daObjGrzRock_c@ha /* 0x80C15404@ha */
/* 80C14F88  38 03 54 04 */	addi r0, r3, __vt__14daObjGrzRock_c@l /* 0x80C15404@l */
/* 80C14F8C  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C14F90  3B BE 05 AC */	addi r29, r30, 0x5ac
/* 80C14F94  7F A3 EB 78 */	mr r3, r29
/* 80C14F98  4B 46 11 09 */	bl __ct__9dBgS_AcchFv
/* 80C14F9C  3C 60 80 C1 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80C153E0@ha */
/* 80C14FA0  38 63 53 E0 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80C153E0@l */
...
/* 80C14FBC  4B 46 3E AD */	bl SetObj__16dBgS_PolyPassChkFv
/* 80C14FC0  38 7E 07 84 */	addi r3, r30, 0x784
/* 80C14FC4  4B 46 0E E9 */	bl __ct__12dBgS_AcchCirFv
/* 80C14FC8  38 7E 07 C4 */	addi r3, r30, 0x7c4
/* 80C14FCC  4B 65 2C 51 */	bl __ct__11cBgS_GndChkFv
lbl_80C14FD0:
/* 80C14FD0  80 1F 04 A0 */	lwz r0, 0x4a0(r31)
/* 80C14FD4  60 00 00 08 */	ori r0, r0, 8
/* 80C14FD8  90 1F 04 A0 */	stw r0, 0x4a0(r31)
lbl_80C14FDC:
/* 80C14FDC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C14FE0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C14FF4  4B 42 03 6D */	bl isSwitch__10dSv_info_cCFii
...
/* 80C1500C  3C 60 80 C1 */	lis r3, l_arcName@ha /* 0x80C1538C@ha */
/* 80C15010  38 83 53 8C */	addi r4, r3, l_arcName@l /* 0x80C1538C@l */
/* 80C15014  38 7F 05 A0 */	addi r3, r31, 0x5a0
/* 80C15018  80 84 00 00 */	lwz r4, 0(r4)
/* 80C1501C  4B 41 7E A1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C15054  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C15058  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C1505C  3C 63 00 02 */	addis r3, r3, 2
/* 80C15060  3C 80 80 C1 */	lis r4, l_arcName@ha /* 0x80C1538C@ha */
/* 80C15064  38 84 53 8C */	addi r4, r4, l_arcName@l /* 0x80C1538C@l */
/* 80C15068  80 84 00 00 */	lwz r4, 0(r4)
/* 80C1506C  3C A0 80 C1 */	lis r5, d_a_obj_grz_rock__stringBase0@ha /* 0x80C15378@ha */
/* 80C15070  38 A5 53 78 */	addi r5, r5, d_a_obj_grz_rock__stringBase0@l /* 0x80C15378@l */
/* 80C15074  38 A5 00 08 */	addi r5, r5, 8
/* 80C15078  38 63 C2 F8 */	addi r3, r3, -15624
/* 80C1507C  4B 42 76 3D */	bl getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80C15080  7C 65 1B 78 */	mr r5, r3
/* 80C15084  7F E3 FB 78 */	mr r3, r31
/* 80C15088  3C 80 80 C1 */	lis r4, l_arcName@ha /* 0x80C1538C@ha */
/* 80C1508C  38 84 53 8C */	addi r4, r4, l_arcName@l /* 0x80C1538C@l */
/* 80C15090  80 84 00 00 */	lwz r4, 0(r4)
/* 80C15094  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80C15098  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80C1509C  38 E0 10 30 */	li r7, 0x1030
/* 80C150A0  39 00 00 00 */	li r8, 0
/* 80C150A4  4B 46 37 19 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C150C8  4B 74 D1 61 */	bl _restgpr_29
