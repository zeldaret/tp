...
/* 80C14BEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C14BF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C14BF4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C14BF8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C14BFC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C14C00  4B 73 1C E8 */	b PSMTXTrans
/* 80C14C04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C14C08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C14C0C  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C14C10  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C14C14  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C14C18  4B 3F 76 88 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C14C1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C14C20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C14C24  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C14C28  38 84 00 24 */	addi r4, r4, 0x24
/* 80C14C2C  4B 73 18 84 */	b PSMTXCopy
/* 80C14C30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C14C34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C14C38  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80C14C3C  4B 73 18 74 */	b PSMTXCopy
