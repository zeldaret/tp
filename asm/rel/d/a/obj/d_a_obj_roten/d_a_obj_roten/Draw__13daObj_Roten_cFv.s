...
/* 80CC1150  3C 60 80 CC */	lis r3, lit_3778@ha /* 0x80CC1400@ha */
/* 80CC1154  3B E3 14 00 */	addi r31, r3, lit_3778@l /* 0x80CC1400@l */
...
/* 80CC1178  4B 5A E8 05 */	bl cLib_addCalc__FPfffff
...
/* 80CC1194  4B 5A E7 E9 */	bl cLib_addCalc__FPfffff
lbl_80CC1198:
...
/* 80CC11C4  4B 4E 8B 9D */	bl dKy_BossLight_set__FP4cXyzP8_GXColorfUc
lbl_80CC11C8:
/* 80CC11C8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CC11CC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CC11D0  38 80 00 10 */	li r4, 0x10
/* 80CC11D4  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CC11D8  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CC11DC  4B 4E 25 E9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CC11E0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CC11E4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CC11E8  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80CC11EC  80 84 00 04 */	lwz r4, 4(r4)
/* 80CC11F0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CC11F4  4B 4E 3B AD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CC11F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC11FC  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC1200  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CC1204  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CC1208  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CC121C  4B 34 CA A9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CC1220  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC1224  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
