...
/* 80C9FD64  4B 62 EE E9 */	bl __nw__FUl
/* 80C9FD68  7C 60 1B 79 */	or. r0, r3, r3
/* 80C9FD6C  41 82 00 0C */	beq lbl_80C9FD78
/* 80C9FD70  4B 3D BC 01 */	bl __ct__4dBgWFv
...
lbl_80C9FD90:
/* 80C9FD90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9FD94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9FD98  C0 3F 00 38 */	lfs f1, 0x38(r31)
/* 80C9FD9C  C0 5F 00 3C */	lfs f2, 0x3c(r31)
/* 80C9FDA0  C0 7F 00 40 */	lfs f3, 0x40(r31)
/* 80C9FDA4  4B 6A 6B 45 */	bl PSMTXTrans
/* 80C9FDA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9FDAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9FDB0  38 80 80 00 */	li r4, -32768
/* 80C9FDB4  4B 36 C6 81 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C9FDB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9FDBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9FDC0  38 9F 02 BC */	addi r4, r31, 0x2bc
/* 80C9FDC4  4B 6A 66 ED */	bl PSMTXCopy
/* 80C9FDC8  3C 60 80 CA */	lis r3, l_arcName@ha /* 0x80CA0408@ha */
/* 80C9FDCC  38 63 04 08 */	addi r3, r3, l_arcName@l /* 0x80CA0408@l */
/* 80C9FDD0  80 63 00 00 */	lwz r3, 0(r3)
/* 80C9FDD4  38 80 00 07 */	li r4, 7
/* 80C9FDD8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9FDDC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9FDE0  3C A5 00 02 */	addis r5, r5, 2
/* 80C9FDE4  38 C0 00 80 */	li r6, 0x80
/* 80C9FDE8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C9FDEC  4B 39 C5 01 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9FE00  4B 3D A1 39 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
