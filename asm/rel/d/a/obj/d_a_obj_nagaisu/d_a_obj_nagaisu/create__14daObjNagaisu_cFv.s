...
/* 80C9F678  4B 6C 2B 61 */	bl _savegpr_28
...
lbl_80C9F6B4:
/* 80C9F6B4  3C 80 80 CA */	lis r4, l_arcName@ha /* 0x80CA0408@ha */
/* 80C9F6B8  38 84 04 08 */	addi r4, r4, l_arcName@l /* 0x80CA0408@l */
/* 80C9F6BC  80 84 00 00 */	lwz r4, 0(r4)
/* 80C9F6C0  4B 38 D7 FD */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C9F6D4  3C 60 80 CA */	lis r3, lit_3731@ha /* 0x80CA03BC@ha */
/* 80C9F6D8  C0 03 03 BC */	lfs f0, lit_3731@l(r3)  /* 0x80CA03BC@l */
...
/* 80C9F6F0  3C 80 80 CA */	lis r4, daObjNagaisu_c_createHeap__FP10fopAc_ac_c@ha /* 0x80C9F3B8@ha */
/* 80C9F6F4  38 84 F3 B8 */	addi r4, r4, daObjNagaisu_c_createHeap__FP10fopAc_ac_c@l /* 0x80C9F3B8@l */
/* 80C9F6F8  3C A0 00 01 */	lis r5, 0x0001 /* 0x00012000@ha */
/* 80C9F6FC  38 A5 20 00 */	addi r5, r5, 0x2000 /* 0x00012000@l */
/* 80C9F700  4B 37 AD B1 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80C9F71C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9F720  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9F724  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C9F728  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C9F72C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C9F730  4B 6A 71 B9 */	bl PSMTXTrans
/* 80C9F734  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9F738  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9F73C  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80C9F740  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9F744  4B 6A 6D 6D */	bl PSMTXCopy
...
/* 80C9F760  4B 37 AE 19 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80C9F794  4B 6C 2A 91 */	bl _restgpr_28
