...
/* 80C9FB1C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C9FB20  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C9FB40  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C9FB44  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80C9FB5C  3C 60 80 CA */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CA0474@ha */
/* 80C9FB60  38 03 04 74 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CA0474@l */
/* 80C9FB64  90 1E 01 38 */	stw r0, 0x138(r30)
lbl_80C9FB68:
/* 80C9FB68  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80C9FB6C  41 82 00 24 */	beq lbl_80C9FB90
/* 80C9FB70  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C9FB74  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C9FB78  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C9FB7C  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80C9FB80  41 82 00 10 */	beq lbl_80C9FB90
/* 80C9FB84  3C 60 80 CA */	lis r3, __vt__8cM3dGAab@ha /* 0x80CA0468@ha */
/* 80C9FB88  38 03 04 68 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CA0468@l */
/* 80C9FB8C  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_80C9FB90:
/* 80C9FB90  7F C3 F3 78 */	mr r3, r30
/* 80C9FB94  38 80 00 00 */	li r4, 0
/* 80C9FB98  4B 3E 45 4D */	bl __dt__12dCcD_GObjInfFv
/* 80C9FB9C  7F E0 07 35 */	extsh. r0, r31
/* 80C9FBA0  40 81 00 0C */	ble lbl_80C9FBAC
/* 80C9FBA4  7F C3 F3 78 */	mr r3, r30
/* 80C9FBA8  4B 62 F1 95 */	bl __dl__FPv
lbl_80C9FBAC:
