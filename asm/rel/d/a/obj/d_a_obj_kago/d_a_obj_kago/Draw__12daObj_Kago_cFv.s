...
/* 80C332E8  3C 60 80 C3 */	lis r3, m__18daObj_Kago_Param_c@ha /* 0x80C33C80@ha */
/* 80C332EC  3B C3 3C 80 */	addi r30, r3, m__18daObj_Kago_Param_c@l /* 0x80C33C80@l */
...
/* 80C33308  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C3330C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C33310  38 80 00 00 */	li r4, 0
/* 80C33314  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C33318  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80C3331C  4B 57 04 A9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C33320  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C33324  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C33328  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80C3332C  80 84 00 04 */	lwz r4, 4(r4)
/* 80C33330  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C33334  4B 57 1A 6D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C33338  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80C3333C  4B 3D A9 89 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C33340  38 00 00 00 */	li r0, 0
/* 80C33344  90 01 00 08 */	stw r0, 8(r1)
/* 80C33348  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3334C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C33368  4B 3E 66 55 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80C333C4  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80C333C8  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80C333CC  4B 3F B5 45 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
