...
lbl_80C323F8:
/* 80C323F8  3C 60 80 C3 */	lis r3, l_bmdData@ha /* 0x80C33DC0@ha */
/* 80C323FC  38 83 3D C0 */	addi r4, r3, l_bmdData@l /* 0x80C33DC0@l */
/* 80C32400  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C32404  54 00 10 3A */	slwi r0, r0, 2
/* 80C32408  3C 60 80 C3 */	lis r3, l_resNameList@ha /* 0x80C33DD0@ha */
/* 80C3240C  38 63 3D D0 */	addi r3, r3, l_resNameList@l /* 0x80C33DD0@l */
/* 80C32410  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C32414  80 84 00 08 */	lwz r4, 8(r4)
/* 80C32418  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3241C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C32420  3C A5 00 02 */	addis r5, r5, 2
/* 80C32424  38 C0 00 80 */	li r6, 0x80
/* 80C32428  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C3242C  4B 40 9E C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C32430  48 00 00 3C */	b lbl_80C3246C
lbl_80C32434:
/* 80C32434  3C 60 80 C3 */	lis r3, l_bmdData@ha /* 0x80C33DC0@ha */
/* 80C32438  38 83 3D C0 */	addi r4, r3, l_bmdData@l /* 0x80C33DC0@l */
/* 80C3243C  80 04 00 04 */	lwz r0, 4(r4)
/* 80C32440  54 00 10 3A */	slwi r0, r0, 2
/* 80C32444  3C 60 80 C3 */	lis r3, l_resNameList@ha /* 0x80C33DD0@ha */
/* 80C32448  38 63 3D D0 */	addi r3, r3, l_resNameList@l /* 0x80C33DD0@l */
/* 80C3244C  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C32450  80 84 00 00 */	lwz r4, 0(r4)
/* 80C32454  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C32458  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3245C  3C A5 00 02 */	addis r5, r5, 2
/* 80C32460  38 C0 00 80 */	li r6, 0x80
/* 80C32464  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C32468  4B 40 9E 85 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
lbl_80C3246C:
...
/* 80C32488  4B 3E 27 CD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
