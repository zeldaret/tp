...
/* 80C33638  4B 72 EB 95 */	bl _savegpr_25
/* 80C3363C  7C 79 1B 78 */	mr r25, r3
/* 80C33640  7C BA 2B 78 */	mr r26, r5
/* 80C33644  3C 60 80 C3 */	lis r3, m__18daObj_Kago_Param_c@ha /* 0x80C33C80@ha */
/* 80C33648  3B A3 3C 80 */	addi r29, r3, m__18daObj_Kago_Param_c@l /* 0x80C33C80@l */
/* 80C3364C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C33650  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C33654  4B 3D 8D 89 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80C3366C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C33670  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C33674  38 81 00 14 */	addi r4, r1, 0x14
/* 80C33678  38 A1 00 20 */	addi r5, r1, 0x20
/* 80C3367C  4B 71 36 F1 */	bl PSMTXMultVec
/* 80C33680  38 61 00 20 */	addi r3, r1, 0x20
/* 80C33684  38 99 04 D0 */	addi r4, r25, 0x4d0
/* 80C33688  7C 65 1B 78 */	mr r5, r3
/* 80C3368C  4B 71 3A 05 */	bl PSVECAdd
...
/* 80C336B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C336B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C336B8  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80C336BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C336C0  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C336DC  4B 71 36 91 */	bl PSMTXMultVec
...
/* 80C336F8  4B 71 39 99 */	bl PSVECAdd
...
/* 80C3370C  4B 44 46 59 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C33710  7F 83 E3 78 */	mr r3, r28
/* 80C33714  38 99 0A 9C */	addi r4, r25, 0xa9c
/* 80C33718  4B 44 0C 9D */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80C33764  4B 63 33 D1 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C33780  4B 63 3E F5 */	bl cM_atan2s__Fff
...
/* 80C3379C  4B 72 EA 7D */	bl _restgpr_25
