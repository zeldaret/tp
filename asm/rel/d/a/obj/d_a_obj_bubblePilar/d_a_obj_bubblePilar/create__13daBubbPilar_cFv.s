...
/* 80BC3600  4B 4B 50 25 */	bl __ct__16dBgS_MoveBgActorFv
/* 80BC3604  3C 60 80 BC */	lis r3, __vt__13daBubbPilar_c@ha /* 0x80BC41D0@ha */
/* 80BC3608  38 03 41 D0 */	addi r0, r3, __vt__13daBubbPilar_c@l /* 0x80BC41D0@l */
/* 80BC360C  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80BC3610  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BC3614  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BC3618  90 1E 05 C8 */	stw r0, 0x5c8(r30)
/* 80BC361C  38 7E 05 CC */	addi r3, r30, 0x5cc
/* 80BC3620  4B 4C 01 41 */	bl __ct__10dCcD_GSttsFv
/* 80BC3624  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BC3628  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BC3640  4B 4C 03 E9 */	bl __ct__12dCcD_GObjInfFv
/* 80BC3644  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BC3648  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BC364C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80BC3650  3C 60 80 BC */	lis r3, __vt__8cM3dGAab@ha /* 0x80BC41C4@ha */
/* 80BC3654  38 03 41 C4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BC41C4@l */
/* 80BC3658  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80BC365C  3C 60 80 BC */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BC41B8@ha */
/* 80BC3660  38 03 41 B8 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BC41B8@l */
/* 80BC3664  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80BC3668  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BC366C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80BC3670  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80BC3674  38 03 00 58 */	addi r0, r3, 0x58
/* 80BC3678  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80BC367C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BC3680  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80BC36A8  3C 80 80 BC */	lis r4, d_a_obj_bubblePilar__stringBase0@ha /* 0x80BC40B4@ha */
/* 80BC36AC  38 84 40 B4 */	addi r4, r4, d_a_obj_bubblePilar__stringBase0@l /* 0x80BC40B4@l */
/* 80BC36B0  4B 46 98 0D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BC36C4  3C 80 80 BC */	lis r4, d_a_obj_bubblePilar__stringBase0@ha /* 0x80BC40B4@ha */
/* 80BC36C8  38 84 40 B4 */	addi r4, r4, d_a_obj_bubblePilar__stringBase0@l /* 0x80BC40B4@l */
/* 80BC36CC  38 A0 00 08 */	li r5, 8
/* 80BC36D0  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075A24@ha */
/* 80BC36D4  38 C6 5A 24 */	addi r6, r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075A24@l */
/* 80BC36D8  38 E0 19 00 */	li r7, 0x1900
/* 80BC36DC  39 00 00 00 */	li r8, 0
/* 80BC36E0  4B 4B 50 DD */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80BC3704  4B 4C 01 5D */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80BC3708  38 7F 05 EC */	addi r3, r31, 0x5ec
/* 80BC370C  3C 80 80 BC */	lis r4, mCcDCyl__13daBubbPilar_c@ha /* 0x80BC40DC@ha */
/* 80BC3710  38 84 40 DC */	addi r4, r4, mCcDCyl__13daBubbPilar_c@l /* 0x80BC40DC@l */
/* 80BC3714  4B 4C 11 A1 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80BC374C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC3750  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BC3754  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80BC3758  4B 4B 0A F9 */	bl Release__4cBgSFP9dBgW_Base
lbl_80BC375C:
...
lbl_80BC3788:
/* 80BC3788  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC378C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BC3790  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80BC3794  7C 05 07 74 */	extsb r5, r0
/* 80BC3798  4B 47 1B C9 */	bl isSwitch__10dSv_info_cCFii
...
/* 80BC3800  4B 45 6D 79 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
