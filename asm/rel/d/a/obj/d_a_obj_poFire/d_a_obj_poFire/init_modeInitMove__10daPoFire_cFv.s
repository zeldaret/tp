...
/* 80CB303C  4B 3C 45 41 */	bl __ct__11dBgS_GndChkFv
/* 80CB3040  38 61 00 20 */	addi r3, r1, 0x20
/* 80CB3044  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80CB3048  4B 5B 4C E1 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 80CB304C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB3050  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB3054  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CB3058  38 81 00 20 */	addi r4, r1, 0x20
/* 80CB305C  4B 3C 14 45 */	bl GroundCross__4cBgSFP11cBgS_GndChk
/* 80CB3060  D0 3F 05 D0 */	stfs f1, 0x5d0(r31)
/* 80CB3064  3C 60 80 CB */	lis r3, lit_3726@ha /* 0x80CB3F0C@ha */
/* 80CB3068  C0 03 3F 0C */	lfs f0, lit_3726@l(r3)  /* 0x80CB3F0C@l */
/* 80CB306C  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80CB3070  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80CB3074  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CB3078  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CB307C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CB3080  C0 3F 05 F8 */	lfs f1, 0x5f8(r31)
/* 80CB3084  C0 5F 05 FC */	lfs f2, 0x5fc(r31)
/* 80CB3088  C0 7F 06 00 */	lfs f3, 0x600(r31)
/* 80CB308C  4B 69 38 5D */	bl PSMTXTrans
/* 80CB3090  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CB3094  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CB3098  38 81 00 14 */	addi r4, r1, 0x14
/* 80CB309C  7C 85 23 78 */	mr r5, r4
/* 80CB30A0  4B 69 3C CD */	bl PSMTXMultVec
/* 80CB30A4  38 61 00 08 */	addi r3, r1, 8
/* 80CB30A8  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80CB30AC  38 A1 00 14 */	addi r5, r1, 0x14
/* 80CB30B0  4B 5B 3A 35 */	bl __pl__4cXyzCFRC3Vec
...
/* 80CB30E4  4B 3C 45 0D */	bl __dt__11dBgS_GndChkFv
