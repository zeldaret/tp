...
/* 80C12010  4B 3F B4 18 */	b play__14mDoExt_baseAnmFv
...
/* 80C1203C  3C 60 80 C1 */	lis r3, lit_3857@ha
/* 80C12040  C0 03 24 00 */	lfs f0, lit_3857@l(r3)
...
lbl_80C1205C:
/* 80C1205C  3C 60 80 C1 */	lis r3, lit_3860@ha
/* 80C12060  C0 03 24 0C */	lfs f0, lit_3860@l(r3)
...
/* 80C1207C  3C 60 80 C1 */	lis r3, lit_3860@ha
/* 80C12080  C0 03 24 0C */	lfs f0, lit_3860@l(r3)
...
/* 80C120A4  3C 60 80 C1 */	lis r3, lit_3857@ha
/* 80C120A8  C0 03 24 00 */	lfs f0, lit_3857@l(r3)
/* 80C120AC  D0 1E 05 D8 */	stfs f0, 0x5d8(r30)
/* 80C120B0  48 00 00 10 */	b lbl_80C120C0
lbl_80C120B4:
/* 80C120B4  3C 60 80 C1 */	lis r3, lit_3857@ha
/* 80C120B8  C0 03 24 00 */	lfs f0, lit_3857@l(r3)
