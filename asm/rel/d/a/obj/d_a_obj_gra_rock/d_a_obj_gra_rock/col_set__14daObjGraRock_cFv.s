...
/* 80C117E8  3C 60 80 C1 */	lis r3, mCcDCyl__14daObjGraRock_c@ha /* 0x80C123BC@ha */
/* 80C117EC  3B E3 23 BC */	addi r31, r3, mCcDCyl__14daObjGraRock_c@l /* 0x80C123BC@l */
/* 80C117F0  38 7E 08 38 */	addi r3, r30, 0x838
/* 80C117F4  4B 47 2C 6D */	bl ChkTgHit__12dCcD_GObjInfFv
/* 80C117F8  28 03 00 00 */	cmplwi r3, 0
/* 80C117FC  41 82 01 3C */	beq lbl_80C11938
/* 80C11800  38 7E 08 38 */	addi r3, r30, 0x838
/* 80C11804  4B 47 2C F5 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 80C11834  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C11838  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C1183C  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 80C11840  A8 BE 04 DE */	lha r5, 0x4de(r30)
/* 80C11844  A8 DE 04 E0 */	lha r6, 0x4e0(r30)
/* 80C11848  4B 3F A9 C1 */	bl mDoMtx_ZXYrotS__FPA4_fsss
/* 80C1184C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C11850  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C11854  38 81 00 14 */	addi r4, r1, 0x14
/* 80C11858  7C 85 23 78 */	mr r5, r4
/* 80C1185C  4B 73 55 11 */	bl PSMTXMultVec
/* 80C11860  38 61 00 14 */	addi r3, r1, 0x14
/* 80C11864  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C11868  7C 65 1B 78 */	mr r5, r3
/* 80C1186C  4B 73 58 25 */	bl PSVECAdd
...
/* 80C1187C  4B 54 3D F9 */	bl daNpcF_onEvtBit__FUl
/* 80C11880  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C11884  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C11888  88 9E 09 C8 */	lbz r4, 0x9c8(r30)
/* 80C1188C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C11890  7C 05 07 74 */	extsb r5, r0
/* 80C11894  4B 42 39 6D */	bl onSwitch__10dSv_info_cFii
...
/* 80C118D4  4B 40 84 C5 */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
...
/* 80C118E4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C118E8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C11914  4B 69 A0 71 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C11918  7F C3 F3 78 */	mr r3, r30
/* 80C1191C  4B 40 83 61 */	bl fopAcM_delete__FP10fopAc_ac_c
...
lbl_80C11938:
/* 80C11938  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C1193C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C11940  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C11944  38 9E 08 38 */	addi r4, r30, 0x838
/* 80C11948  4B 65 32 61 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80C1194C:
