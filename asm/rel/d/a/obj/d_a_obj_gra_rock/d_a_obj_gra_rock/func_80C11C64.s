...
/* 80C11C74  4B 75 05 59 */	bl _savegpr_25
...
/* 80C11C94  4B 46 69 91 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C11C98  3C 60 80 C1 */	lis r3, __vt__14daObjGraRock_c@ha /* 0x80C12548@ha */
/* 80C11C9C  38 03 25 48 */	addi r0, r3, __vt__14daObjGraRock_c@l /* 0x80C12548@l */
/* 80C11CA0  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C11CA4  3B 3E 05 CC */	addi r25, r30, 0x5cc
/* 80C11CA8  3C 60 80 C1 */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80C1253C@ha */
/* 80C11CAC  38 03 25 3C */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80C1253C@l */
/* 80C11CB0  90 1E 05 CC */	stw r0, 0x5cc(r30)
/* 80C11CB4  7F 23 CB 78 */	mr r3, r25
/* 80C11CB8  38 80 00 00 */	li r4, 0
/* 80C11CBC  4B 71 67 41 */	bl init__12J3DFrameCtrlFs
...
/* 80C11CD0  4B 46 43 D1 */	bl __ct__9dBgS_AcchFv
/* 80C11CD4  3C 60 80 C1 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80C12518@ha */
/* 80C11CD8  38 63 25 18 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80C12518@l */
...
/* 80C11CF4  4B 46 71 75 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80C11CF8  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C11CFC  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C11D00  90 1E 07 D4 */	stw r0, 0x7d4(r30)
/* 80C11D04  38 7E 07 D8 */	addi r3, r30, 0x7d8
/* 80C11D08  4B 47 1A 59 */	bl __ct__10dCcD_GSttsFv
/* 80C11D0C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C11D10  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C11D24  4B 46 41 89 */	bl __ct__12dBgS_AcchCirFv
/* 80C11D28  3B 3E 08 38 */	addi r25, r30, 0x838
/* 80C11D2C  7F 23 CB 78 */	mr r3, r25
/* 80C11D30  4B 47 1C F9 */	bl __ct__12dCcD_GObjInfFv
/* 80C11D34  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C11D38  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C11D3C  90 19 01 20 */	stw r0, 0x120(r25)
/* 80C11D40  3C 60 80 C1 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C1250C@ha */
/* 80C11D44  38 03 25 0C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C1250C@l */
/* 80C11D48  90 19 01 1C */	stw r0, 0x11c(r25)
/* 80C11D4C  3C 60 80 C1 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80C12500@ha */
/* 80C11D50  38 03 25 00 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80C12500@l */
/* 80C11D54  90 19 01 38 */	stw r0, 0x138(r25)
/* 80C11D58  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80C11D5C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80C11D60  90 79 01 20 */	stw r3, 0x120(r25)
/* 80C11D64  38 03 00 58 */	addi r0, r3, 0x58
/* 80C11D68  90 19 01 38 */	stw r0, 0x138(r25)
/* 80C11D6C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80C11D70  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80C11D8C  4B 65 5E 91 */	bl __ct__11cBgS_GndChkFv
lbl_80C11D90:
...
/* 80C11DB4  3C 60 80 C1 */	lis r3, l_arcName@ha /* 0x80C1249C@ha */
/* 80C11DB8  3B 83 24 9C */	addi r28, r3, l_arcName@l /* 0x80C1249C@l */
lbl_80C11DBC:
/* 80C11DBC  38 7D 05 A0 */	addi r3, r29, 0x5a0
/* 80C11DC0  7C 7F 1A 14 */	add r3, r31, r3
/* 80C11DC4  7C 9C F0 2E */	lwzx r4, r28, r30
/* 80C11DC8  4B 41 B0 F5 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C11E10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C11E14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C11E18  3C 63 00 02 */	addis r3, r3, 2
/* 80C11E1C  3C 80 80 C1 */	lis r4, l_arcName@ha /* 0x80C1249C@ha */
/* 80C11E20  38 84 24 9C */	addi r4, r4, l_arcName@l /* 0x80C1249C@l */
/* 80C11E24  80 84 00 00 */	lwz r4, 0(r4)
/* 80C11E28  3C A0 80 C1 */	lis r5, d_a_obj_gra_rock__stringBase0@ha /* 0x80C12440@ha */
/* 80C11E2C  38 A5 24 40 */	addi r5, r5, d_a_obj_gra_rock__stringBase0@l /* 0x80C12440@l */
/* 80C11E30  38 A5 00 4B */	addi r5, r5, 0x4b
/* 80C11E34  38 63 C2 F8 */	addi r3, r3, -15624
/* 80C11E38  4B 42 A8 81 */	bl getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80C11E3C  7C 65 1B 78 */	mr r5, r3
/* 80C11E40  7F E3 FB 78 */	mr r3, r31
/* 80C11E44  3C 80 80 C1 */	lis r4, l_arcName@ha /* 0x80C1249C@ha */
/* 80C11E48  38 84 24 9C */	addi r4, r4, l_arcName@l /* 0x80C1249C@l */
/* 80C11E4C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C11E50  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80C11E54  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80C11E58  38 E0 2D 50 */	li r7, 0x2d50
/* 80C11E5C  39 00 00 00 */	li r8, 0
/* 80C11E60  4B 46 69 5D */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
/* 80C11E64  7C 79 1B 78 */	mr r25, r3
/* 80C11E68  38 60 01 50 */	li r3, 0x150
/* 80C11E6C  4B 54 37 C9 */	bl daNpcF_chkEvtBit__FUl
...
/* 80C11E94  4B 75 03 85 */	bl _restgpr_25
