...
/* 80BE63EC  3C 80 80 BE */	lis r4, l_arcName@ha
/* 80BE63F0  38 84 74 38 */	addi r4, r4, l_arcName@l
/* 80BE63F4  4B 44 6C 14 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80BE63F8  38 7F 08 A4 */	addi r3, r31, 0x8a4
/* 80BE63FC  3C 80 80 BE */	lis r4, __dt__5csXyzFv@ha
/* 80BE6400  38 84 63 28 */	addi r4, r4, __dt__5csXyzFv@l
/* 80BE6404  38 A0 00 06 */	li r5, 6
/* 80BE6408  38 C0 00 16 */	li r6, 0x16
/* 80BE640C  4B 77 B8 DC */	b __destroy_arr
/* 80BE6410  38 7F 07 9C */	addi r3, r31, 0x79c
/* 80BE6414  3C 80 80 BE */	lis r4, __dt__4cXyzFv@ha
/* 80BE6418  38 84 63 68 */	addi r4, r4, __dt__4cXyzFv@l
/* 80BE641C  38 A0 00 0C */	li r5, 0xc
/* 80BE6420  38 C0 00 16 */	li r6, 0x16
/* 80BE6424  4B 77 B8 C4 */	b __destroy_arr
/* 80BE6428  38 7F 06 94 */	addi r3, r31, 0x694
/* 80BE642C  3C 80 80 BE */	lis r4, __dt__4cXyzFv@ha
/* 80BE6430  38 84 63 68 */	addi r4, r4, __dt__4cXyzFv@l
/* 80BE6434  38 A0 00 0C */	li r5, 0xc
/* 80BE6438  38 C0 00 16 */	li r6, 0x16
/* 80BE643C  4B 77 B8 AC */	b __destroy_arr
/* 80BE6440  38 7F 05 8C */	addi r3, r31, 0x58c
/* 80BE6444  3C 80 80 BE */	lis r4, __dt__4cXyzFv@ha
/* 80BE6448  38 84 63 68 */	addi r4, r4, __dt__4cXyzFv@l
/* 80BE644C  38 A0 00 0C */	li r5, 0xc
/* 80BE6450  38 C0 00 16 */	li r6, 0x16
/* 80BE6454  4B 77 B8 94 */	b __destroy_arr
/* 80BE6458  34 1F 05 74 */	addic. r0, r31, 0x574
/* 80BE645C  41 82 00 24 */	beq lbl_80BE6480
/* 80BE6460  3C 60 80 BE */	lis r3, __vt__19daObjFchain_shape_c@ha
/* 80BE6464  38 03 75 28 */	addi r0, r3, __vt__19daObjFchain_shape_c@l
/* 80BE6468  90 1F 05 74 */	stw r0, 0x574(r31)
/* 80BE646C  34 1F 05 74 */	addic. r0, r31, 0x574
/* 80BE6470  41 82 00 10 */	beq lbl_80BE6480
/* 80BE6474  3C 60 80 3D */	lis r3, __vt__9J3DPacket@ha
/* 80BE6478  38 03 D9 7C */	addi r0, r3, __vt__9J3DPacket@l
/* 80BE647C  90 1F 05 74 */	stw r0, 0x574(r31)
lbl_80BE6480:
/* 80BE6480  7F E3 FB 78 */	mr r3, r31
/* 80BE6484  38 80 00 00 */	li r4, 0
/* 80BE6488  4B 43 28 04 */	b __dt__10fopAc_ac_cFv
/* 80BE648C  7F C0 07 35 */	extsh. r0, r30
/* 80BE6490  40 81 00 0C */	ble lbl_80BE649C
/* 80BE6494  7F E3 FB 78 */	mr r3, r31
/* 80BE6498  4B 6E 88 A4 */	b __dl__FPv
lbl_80BE649C:
