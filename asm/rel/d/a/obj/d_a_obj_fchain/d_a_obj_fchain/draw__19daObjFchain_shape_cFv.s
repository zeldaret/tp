...
/* 80BE71A4  4B 77 B0 25 */	bl _savegpr_24
...
/* 80BE71C8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BE71CC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BE71E8  3C 60 80 45 */	lis r3, sOldVcdVatCmd__8J3DShape@ha /* 0x804515D0@ha */
/* 80BE71EC  90 03 15 D0 */	stw r0, sOldVcdVatCmd__8J3DShape@l(r3)  /* 0x804515D0@l */
...
/* 80BE7208  4B 72 E0 F9 */	bl loadPreDrawSetting__8J3DShapeCFv
...
/* 80BE723C  4B 77 67 25 */	bl GXSetChanAmbColor
/* 80BE7240  3C 60 80 45 */	lis r3, g_whiteColor@ha /* 0x80450608@ha */
/* 80BE7244  80 03 06 08 */	lwz r0, g_whiteColor@l(r3)  /* 0x80450608@l */
/* 80BE7248  90 01 00 08 */	stw r0, 8(r1)
/* 80BE724C  38 60 00 04 */	li r3, 4
/* 80BE7250  38 81 00 08 */	addi r4, r1, 8
/* 80BE7254  4B 77 67 F5 */	bl GXSetChanMatColor
/* 80BE7258  4B 5C 03 69 */	bl dKy_setLight_again__Fv
/* 80BE725C  7F 83 E3 78 */	mr r3, r28
/* 80BE7260  4B 5C 13 F1 */	bl dKy_GxFog_tevstr_set__FP12dKy_tevstr_c
/* 80BE7264  38 7C 00 34 */	addi r3, r28, 0x34
/* 80BE7268  38 80 00 01 */	li r4, 1
/* 80BE726C  4B 77 66 79 */	bl GXLoadLightObjImm
/* 80BE7270  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BE7274  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BE7278  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BE727C  38 80 05 10 */	li r4, 0x510
/* 80BE7280  4B 44 D7 3D */	bl isEventBit__11dSv_event_cCFUs
...
/* 80BE7298  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BE729C  3B 43 4A C8 */	addi r26, r3, j3dSys@l /* 0x80434AC8@l */
/* 80BE72A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BE72A4  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80BE72B8  4B 75 F1 F9 */	bl PSMTXCopy
/* 80BE72BC  7F C3 F3 78 */	mr r3, r30
/* 80BE72C0  4B 42 5B 15 */	bl transM__14mDoMtx_stack_cFRC4cXyz
/* 80BE72C4  7F A3 EB 78 */	mr r3, r29
/* 80BE72C8  4B 42 5C 7D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80BE72CC  7F 63 DB 78 */	mr r3, r27
/* 80BE72D0  38 80 00 00 */	li r4, 0
/* 80BE72D4  4B 77 8F 79 */	bl GXLoadPosMtxImm
/* 80BE72D8  7F 83 E3 78 */	mr r3, r28
/* 80BE72DC  38 80 00 00 */	li r4, 0
/* 80BE72E0  4B 77 8F BD */	bl GXLoadNrmMtxImm
...
/* 80BE7310  4B 77 AF 05 */	bl _restgpr_24
