...
/* 80BB5E28  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BB5E2C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BB5E30  38 80 00 10 */	li r4, 0x10
/* 80BB5E34  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BB5E38  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BB5E3C  4B 5E D9 89 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BB5E40  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BB5E44  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BB5E48  80 9E 05 EC */	lwz r4, 0x5ec(r30)
/* 80BB5E4C  80 84 00 04 */	lwz r4, 4(r4)
/* 80BB5E50  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BB5E54  4B 5E EF 4D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BB5E58  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BB5E5C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BB5E60  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80BB5E64  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BB5E68  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BB5E7C  4B 45 7E 49 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80BB5E80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BB5E84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
