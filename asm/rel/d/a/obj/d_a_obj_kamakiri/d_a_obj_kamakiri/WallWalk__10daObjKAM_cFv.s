...
/* 80C35D08  4B 72 C4 D5 */	bl _savegpr_29
/* 80C35D0C  7C 7D 1B 78 */	mr r29, r3
/* 80C35D10  3C 60 80 C4 */	lis r3, lit_3775@ha /* 0x80C38408@ha */
/* 80C35D14  3B C3 84 08 */	addi r30, r3, lit_3775@l /* 0x80C38408@l */
...
/* 80C35D60  4B 44 1F 09 */	bl __ct__11dBgS_LinChkFv
/* 80C35D64  38 61 00 6C */	addi r3, r1, 0x6c
/* 80C35D68  4B 44 1F 01 */	bl __ct__11dBgS_LinChkFv
/* 80C35D6C  38 61 01 34 */	addi r3, r1, 0x134
/* 80C35D70  4B 44 30 F9 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80C35D74  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80C35D78  4B 3D 6F ED */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C35D7C  38 7D 09 9A */	addi r3, r29, 0x99a
/* 80C35D80  4B 3D 71 C5 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C35D84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C35D88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C35D8C  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 80C35D90  4B 3D 66 A5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C35D94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C35D98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C35D9C  38 81 00 4C */	addi r4, r1, 0x4c
/* 80C35DA0  7C 85 23 78 */	mr r5, r4
/* 80C35DA4  4B 71 0F C9 */	bl PSMTXMultVec
/* 80C35DA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C35DAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C35DB0  38 81 00 40 */	addi r4, r1, 0x40
/* 80C35DB4  7C 85 23 78 */	mr r5, r4
/* 80C35DB8  4B 71 0F B5 */	bl PSMTXMultVec
...
/* 80C35DCC  4B 44 1F 99 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C35DD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C35DD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C35DD8  3B E3 0F 38 */	addi r31, r3, 0xf38
/* 80C35DDC  7F E3 FB 78 */	mr r3, r31
/* 80C35DE0  38 81 00 DC */	addi r4, r1, 0xdc
/* 80C35DE4  4B 43 E5 D1 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80C35DF8  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C385A4@ha */
/* 80C35DFC  38 03 85 A4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C385A4@l */
...
/* 80C35E10  4B 43 E9 35 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C35E14  C0 21 00 58 */	lfs f1, 0x58(r1)
/* 80C35E18  C0 41 00 60 */	lfs f2, 0x60(r1)
/* 80C35E1C  4B 63 18 59 */	bl cM_atan2s__Fff
...
/* 80C35E50  4B 71 15 4D */	bl PSVECSquareDistance
...
/* 80C35EC0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C35EC4  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C35F30  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C35F34  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C35F7C  4B 71 14 21 */	bl PSVECSquareDistance
...
/* 80C35FEC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C35FF0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C3605C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C36060  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C36064:
...
/* 80C3609C  4B 63 15 D9 */	bl cM_atan2s__Fff
...
/* 80C360B0  4B 63 15 C5 */	bl cM_atan2s__Fff
...
lbl_80C360C8:
/* 80C360C8  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C385A4@ha */
/* 80C360CC  38 03 85 A4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C385A4@l */
...
/* 80C360F4  4B 63 A5 15 */	bl cLib_addCalcAngleS2__FPssss
