...
/* 80C36F68  4B 72 B2 71 */	bl _savegpr_28
/* 80C36F6C  7C 7E 1B 78 */	mr r30, r3
/* 80C36F70  3C 60 80 C4 */	lis r3, lit_3775@ha /* 0x80C38408@ha */
/* 80C36F74  3B E3 84 08 */	addi r31, r3, lit_3775@l /* 0x80C38408@l */
/* 80C36F78  88 1E 09 C1 */	lbz r0, 0x9c1(r30)
/* 80C36F7C  28 00 00 00 */	cmplwi r0, 0
/* 80C36F80  41 82 03 8C */	beq lbl_80C3730C
/* 80C36F84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C36F88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C36FE0  4B 52 76 75 */	bl posMove__20daPy_boomerangMove_cFP4cXyzPsP10fopAc_ac_cs
...
/* 80C36FF4  4B 52 78 89 */	bl bgCheckAfterOffset__20daPy_boomerangMove_cFPC4cXyz
...
/* 80C37010  4B 44 0C 59 */	bl __ct__11dBgS_LinChkFv
/* 80C37014  38 61 00 9C */	addi r3, r1, 0x9c
/* 80C37018  4B 44 1E 51 */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80C3702C  4B 44 0D 39 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C37030  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C37034  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C37038  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80C3703C  7F 83 E3 78 */	mr r3, r28
/* 80C37040  38 81 00 44 */	addi r4, r1, 0x44
/* 80C37044  4B 43 D3 71 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80C37048  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C3704C  41 82 01 D0 */	beq lbl_80C3721C
/* 80C37050  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C385A4@ha */
/* 80C37054  38 03 85 A4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C385A4@l */
...
/* 80C37068  4B 43 D6 DD */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C370EC  4B 71 02 B1 */	bl PSVECSquareDistance
...
/* 80C3715C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C37160  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C371CC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C371D0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80C371D4  48 00 00 08 */	b lbl_80C371DC
lbl_80C371D8:
/* 80C371D8  FC 40 08 90 */	fmr f2, f1
lbl_80C371DC:
/* 80C371DC  C0 21 00 30 */	lfs f1, 0x30(r1)
/* 80C371E0  4B 63 04 95 */	bl cM_atan2s__Fff
...
/* 80C371F4  4B 63 04 81 */	bl cM_atan2s__Fff
/* 80C371F8  B0 7E 09 9A */	sth r3, 0x99a(r30)
/* 80C371FC  C0 21 00 30 */	lfs f1, 0x30(r1)
/* 80C37200  C0 41 00 38 */	lfs f2, 0x38(r1)
/* 80C37204  4B 63 04 71 */	bl cM_atan2s__Fff
/* 80C37208  B0 7E 09 A2 */	sth r3, 0x9a2(r30)
/* 80C3720C  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C385A4@ha */
/* 80C37210  38 03 85 A4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C385A4@l */
...
/* 80C3722C  3C 60 80 C4 */	lis r3, d_a_obj_kamakiri__stringBase0@ha /* 0x80C384FC@ha */
/* 80C37230  38 63 84 FC */	addi r3, r3, d_a_obj_kamakiri__stringBase0@l /* 0x80C384FC@l */
/* 80C37234  38 80 00 06 */	li r4, 6
/* 80C37238  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3723C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C37240  3C A5 00 02 */	addis r5, r5, 2
/* 80C37244  38 C0 00 80 */	li r6, 0x80
/* 80C37248  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C3724C  4B 40 50 A1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C372C8  4B 63 06 8D */	bl cM_rndF__Ff
...
/* 80C37308  4B 44 09 D5 */	bl __dt__11dBgS_LinChkFv
lbl_80C3730C:
/* 80C3730C  39 61 00 D0 */	addi r11, r1, 0xd0
/* 80C37310  4B 72 AF 15 */	bl _restgpr_28
