...
/* 80C35BFC  3C 60 80 C4 */	lis r3, lit_3775@ha /* 0x80C38408@ha */
/* 80C35C00  3B E3 84 08 */	addi r31, r3, lit_3775@l /* 0x80C38408@l */
...
/* 80C35C3C  4B 3D 72 D1 */	bl ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80C35C40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C35C44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C35C48  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C35C4C  4B 3D 67 E9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C35C50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C35C54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C35C58  38 81 00 14 */	addi r4, r1, 0x14
/* 80C35C5C  38 A1 00 08 */	addi r5, r1, 8
/* 80C35C60  4B 71 11 0D */	bl PSMTXMultVec
...
/* 80C35CA4  4B 63 9D 99 */	bl cLib_addCalc2__FPffff
...
/* 80C35CB8  4B 63 9D 85 */	bl cLib_addCalc2__FPffff
...
/* 80C35CCC  4B 63 A9 3D */	bl cLib_addCalcAngleS2__FPssss
