...
/* 80C35980  4B 72 C8 5D */	bl _savegpr_29
/* 80C35984  7C 7F 1B 78 */	mr r31, r3
/* 80C35988  3C 60 80 C4 */	lis r3, lit_3775@ha /* 0x80C38408@ha */
/* 80C3598C  3B C3 84 08 */	addi r30, r3, lit_3775@l /* 0x80C38408@l */
/* 80C35990  38 61 00 38 */	addi r3, r1, 0x38
/* 80C35994  4B 44 22 D5 */	bl __ct__11dBgS_LinChkFv
/* 80C35998  38 61 00 90 */	addi r3, r1, 0x90
/* 80C3599C  4B 44 34 CD */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80C359B0  4B 44 23 B5 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C359B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C359B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C359BC  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80C359C0  7F A3 EB 78 */	mr r3, r29
/* 80C359C4  38 81 00 38 */	addi r4, r1, 0x38
/* 80C359C8  4B 43 E9 ED */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 80C359CC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C359D0  41 82 01 A4 */	beq lbl_80C35B74
/* 80C359D4  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C385A4@ha */
/* 80C359D8  38 03 85 A4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C385A4@l */
...
/* 80C359EC  4B 43 ED 59 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C35A34  4B 71 19 69 */	bl PSVECSquareDistance
...
/* 80C35AA4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C35AA8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C35B14  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C35B18  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80C35B1C  48 00 00 08 */	b lbl_80C35B24
lbl_80C35B20:
/* 80C35B20  FC 40 08 90 */	fmr f2, f1
lbl_80C35B24:
/* 80C35B24  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80C35B28  4B 63 1B 4D */	bl cM_atan2s__Fff
...
/* 80C35B3C  4B 63 1B 39 */	bl cM_atan2s__Fff
/* 80C35B40  B0 7F 09 9A */	sth r3, 0x99a(r31)
/* 80C35B44  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80C35B48  C0 41 00 2C */	lfs f2, 0x2c(r1)
/* 80C35B4C  4B 63 1B 29 */	bl cM_atan2s__Fff
/* 80C35B50  B0 7F 09 A2 */	sth r3, 0x9a2(r31)
/* 80C35B54  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C385A4@ha */
/* 80C35B58  38 03 85 A4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C385A4@l */
/* 80C35B5C  90 01 00 34 */	stw r0, 0x34(r1)
/* 80C35B60  38 61 00 38 */	addi r3, r1, 0x38
/* 80C35B64  38 80 FF FF */	li r4, -1
/* 80C35B68  4B 44 21 75 */	bl __dt__11dBgS_LinChkFv
...
/* 80C35B7C  4B 44 21 61 */	bl __dt__11dBgS_LinChkFv
/* 80C35B80  38 60 00 00 */	li r3, 0
lbl_80C35B84:
/* 80C35B84  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80C35B88  4B 72 C6 A1 */	bl _restgpr_29
