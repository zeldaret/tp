...
/* 80C36158  3C 60 80 C4 */	lis r3, lit_3775@ha /* 0x80C38408@ha */
/* 80C3615C  3B E3 84 08 */	addi r31, r3, lit_3775@l /* 0x80C38408@l */
...
lbl_80C361B4:
/* 80C361B4  3C 60 80 C4 */	lis r3, d_a_obj_kamakiri__stringBase0@ha /* 0x80C384FC@ha */
/* 80C361B8  38 63 84 FC */	addi r3, r3, d_a_obj_kamakiri__stringBase0@l /* 0x80C384FC@l */
/* 80C361BC  38 80 00 07 */	li r4, 7
/* 80C361C0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C361C4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C361C8  3C A5 00 02 */	addis r5, r5, 2
/* 80C361CC  38 C0 00 80 */	li r6, 0x80
/* 80C361D0  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C361D4  4B 40 61 19 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C361F4  4B 3D AC 7D */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C3621C  4B 63 17 39 */	bl cM_rndF__Ff
...
/* 80C3624C  4B 63 17 41 */	bl cM_rndFX__Ff
/* 80C36250  FF E0 08 90 */	fmr f31, f1
/* 80C36254  C0 3F 00 60 */	lfs f1, 0x60(r31)
/* 80C36258  4B 63 17 35 */	bl cM_rndFX__Ff
...
/* 80C36274  4B 63 14 01 */	bl cM_atan2s__Fff
/* 80C36278  B0 7E 09 90 */	sth r3, 0x990(r30)
/* 80C3627C  C0 3F 00 5C */	lfs f1, 0x5c(r31)
/* 80C36280  4B 63 16 D5 */	bl cM_rndF__Ff
...
/* 80C362AC  4B 63 16 A9 */	bl cM_rndF__Ff
...
/* 80C362F4  4B 63 16 61 */	bl cM_rndF__Ff
