...
/* 80CE88B8  4B 67 98 F9 */	bl _savegpr_18
/* 80CE88BC  7C 78 1B 78 */	mr r24, r3
/* 80CE88C0  3C 60 80 CF */	lis r3, lit_3651@ha /* 0x80CE8DBC@ha */
/* 80CE88C4  3B 63 8D BC */	addi r27, r3, lit_3651@l /* 0x80CE8DBC@l */
...
/* 80CE88DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE88E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CE88E4  3B 43 23 3C */	addi r26, r3, 0x233c
/* 80CE88E8  C3 FB 01 0C */	lfs f31, 0x10c(r27)
/* 80CE88EC  3C 60 80 CF */	lis r3, l_HIO@ha /* 0x80CE8FD4@ha */
/* 80CE88F0  3A E3 8F D4 */	addi r23, r3, l_HIO@l /* 0x80CE8FD4@l */
lbl_80CE88F4:
/* 80CE88F4  7E D8 E2 14 */	add r22, r24, r28
/* 80CE88F8  3A B6 06 FC */	addi r21, r22, 0x6fc
/* 80CE88FC  7E A3 AB 78 */	mr r3, r21
/* 80CE8900  4B 39 BD 59 */	bl ChkCoHit__12dCcD_GObjInfFv
...
/* 80CE8958  4B 34 47 15 */	bl dComIfGp_getReverb__Fi
...
/* 80CE896C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CE8970  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CE8998  4B 5C 2F ED */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80CE899C:
...
/* 80CE89C4  4B 58 6D 45 */	bl SetR__8cM3dGSphFf
...
/* 80CE89F8  4B 58 6C 51 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80CE89FC  7F 43 D3 78 */	mr r3, r26
/* 80CE8A00  7E A4 AB 78 */	mr r4, r21
/* 80CE8A04  4B 57 C1 A5 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80CE8A20  4B 32 4A 09 */	bl play__14mDoExt_baseAnmFv
...
/* 80CE8A54  4B 34 46 19 */	bl dComIfGp_getReverb__Fi
...
/* 80CE8A68  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CE8A6C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CE8A94  4B 5C 2E F1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CE8A98  88 18 04 E2 */	lbz r0, 0x4e2(r24)
/* 80CE8A9C  7C 03 07 74 */	extsb r3, r0
/* 80CE8AA0  4B 34 45 CD */	bl dComIfGp_getReverb__Fi
...
/* 80CE8AB4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CE8AB8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CE8AE0  4B 5C 2E A5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80CE8AE4:
...
/* 80CE8B10  4B 67 96 ED */	bl _restgpr_18
