...
/* 80CE8400  4B 67 9D C9 */	bl _savegpr_24
...
/* 80CE8420  4B 33 07 45 */	bl __ct__10fopAc_ac_cFv
/* 80CE8424  3C 60 80 CF */	lis r3, __vt__14daStairBlock_c@ha /* 0x80CE8F8C@ha */
/* 80CE8428  38 03 8F 8C */	addi r0, r3, __vt__14daStairBlock_c@l /* 0x80CE8F8C@l */
/* 80CE842C  90 18 05 68 */	stw r0, 0x568(r24)
/* 80CE8430  38 78 05 9C */	addi r3, r24, 0x59c
/* 80CE8434  3C 80 80 CF */	lis r4, __ct__13mDoExt_bckAnmFv@ha /* 0x80CE87E4@ha */
/* 80CE8438  38 84 87 E4 */	addi r4, r4, __ct__13mDoExt_bckAnmFv@l /* 0x80CE87E4@l */
/* 80CE843C  3C A0 80 CF */	lis r5, __dt__13mDoExt_bckAnmFv@ha /* 0x80CE8790@ha */
/* 80CE8440  38 A5 87 90 */	addi r5, r5, __dt__13mDoExt_bckAnmFv@l /* 0x80CE8790@l */
/* 80CE8444  38 C0 00 1C */	li r6, 0x1c
/* 80CE8448  38 E0 00 0A */	li r7, 0xa
/* 80CE844C  4B 67 99 15 */	bl __construct_array
/* 80CE8450  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CE8454  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CE8458  90 18 06 D8 */	stw r0, 0x6d8(r24)
/* 80CE845C  38 78 06 DC */	addi r3, r24, 0x6dc
/* 80CE8460  4B 39 B3 01 */	bl __ct__10dCcD_GSttsFv
/* 80CE8464  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CE8468  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CE847C  3C 80 80 CF */	lis r4, __ct__8dCcD_SphFv@ha /* 0x80CE867C@ha */
/* 80CE8480  38 84 86 7C */	addi r4, r4, __ct__8dCcD_SphFv@l /* 0x80CE867C@l */
/* 80CE8484  3C A0 80 CF */	lis r5, __dt__8dCcD_SphFv@ha /* 0x80CE85B0@ha */
/* 80CE8488  38 A5 85 B0 */	addi r5, r5, __dt__8dCcD_SphFv@l /* 0x80CE85B0@l */
/* 80CE848C  38 C0 01 38 */	li r6, 0x138
/* 80CE8490  38 E0 00 0A */	li r7, 0xa
/* 80CE8494  4B 67 98 CD */	bl __construct_array
lbl_80CE8498:
...
/* 80CE84A8  3C 80 80 CF */	lis r4, d_a_obj_stairBlock__stringBase0@ha /* 0x80CE8ECC@ha */
/* 80CE84AC  38 84 8E CC */	addi r4, r4, d_a_obj_stairBlock__stringBase0@l /* 0x80CE8ECC@l */
/* 80CE84B0  4B 34 4A 0D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CE84C4  3C 80 80 CF */	lis r4, createHeapCallBack__14daStairBlock_cFP10fopAc_ac_c@ha /* 0x80CE8874@ha */
/* 80CE84C8  38 84 88 74 */	addi r4, r4, createHeapCallBack__14daStairBlock_cFP10fopAc_ac_c@l /* 0x80CE8874@l */
/* 80CE84CC  3C A0 00 01 */	lis r5, 0x0001 /* 0x00009000@ha */
/* 80CE84D0  38 A5 90 00 */	addi r5, r5, 0x9000 /* 0x00009000@l */
/* 80CE84D4  4B 33 1F DD */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80CE8500  4B 33 20 79 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80CE8514  4B 39 B3 4D */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80CE8518  3B 00 00 00 */	li r24, 0
/* 80CE851C  3B A0 00 00 */	li r29, 0
/* 80CE8520  3C 60 80 CF */	lis r3, mCcDSph__14daStairBlock_c@ha /* 0x80CE8ED8@ha */
/* 80CE8524  3B 43 8E D8 */	addi r26, r3, mCcDSph__14daStairBlock_c@l /* 0x80CE8ED8@l */
...
/* 80CE853C  4B 39 C4 F9 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80CE8578  4B 32 62 BD */	bl mDoExt_setupShareTexture__FP12J3DModelDataP12J3DModelData
...
/* 80CE859C  4B 67 9C 79 */	bl _restgpr_24
