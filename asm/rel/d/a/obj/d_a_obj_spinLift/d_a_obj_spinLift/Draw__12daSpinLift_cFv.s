...
/* 80CE4AB8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CE4ABC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CE4AC0  38 80 00 40 */	li r4, 0x40
/* 80CE4AC4  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CE4AC8  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CE4ACC  4B 4B EC F9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CE4AD0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CE4AD4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CE4AD8  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80CE4ADC  80 84 00 04 */	lwz r4, 4(r4)
/* 80CE4AE0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CE4AE4  4B 4C 02 BD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CE4AE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE4AEC  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CE4AF0  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CE4AF4  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CE4AF8  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CE4B0C  4B 32 91 B9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CE4B10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE4B14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
