...
/* 80CE3F48  4B 39 46 DD */	bl __ct__16dBgS_MoveBgActorFv
/* 80CE3F4C  3C 60 80 CE */	lis r3, __vt__12daSpinLift_c@ha /* 0x80CE4E7C@ha */
/* 80CE3F50  38 03 4E 7C */	addi r0, r3, __vt__12daSpinLift_c@l /* 0x80CE4E7C@l */
...
/* 80CE3F78  3C 80 80 CE */	lis r4, l_resNameIdx@ha /* 0x80CE4DA8@ha */
/* 80CE3F7C  38 84 4D A8 */	addi r4, r4, l_resNameIdx@l /* 0x80CE4DA8@l */
/* 80CE3F80  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CE3F84  4B 34 8F 39 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CE3FA0  3C 80 80 CE */	lis r4, l_resNameIdx@ha /* 0x80CE4DA8@ha */
/* 80CE3FA4  38 84 4D A8 */	addi r4, r4, l_resNameIdx@l /* 0x80CE4DA8@l */
/* 80CE3FA8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CE3FAC  3C A0 80 CE */	lis r5, l_dzbIdx@ha /* 0x80CE4CE4@ha */
/* 80CE3FB0  38 A5 4C E4 */	addi r5, r5, l_dzbIdx@l /* 0x80CE4CE4@l */
/* 80CE3FB4  7C A5 00 2E */	lwzx r5, r5, r0
/* 80CE3FB8  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80CE3FBC  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
...
/* 80CE3FCC  4B 39 47 F1 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80CE3FF8  4B 33 65 81 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80CE3FFC  3C 60 80 CE */	lis r3, lit_3731@ha /* 0x80CE4D08@ha */
/* 80CE4000  C0 43 4D 08 */	lfs f2, lit_3731@l(r3)  /* 0x80CE4D08@l */
/* 80CE4004  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 80CE4008  54 00 86 3E */	rlwinm r0, r0, 0x10, 0x18, 0x1f
/* 80CE400C  7C 00 07 74 */	extsb r0, r0
/* 80CE4010  3C 60 80 CE */	lis r3, lit_3733@ha /* 0x80CE4D0C@ha */
/* 80CE4014  C8 23 4D 0C */	lfd f1, lit_3733@l(r3)  /* 0x80CE4D0C@l */
...
/* 80CE4044  3C 60 80 CE */	lis r3, lit_3735@ha /* 0x80CE4D14@ha */
/* 80CE4048  C8 23 4D 14 */	lfd f1, lit_3735@l(r3)  /* 0x80CE4D14@l */
...
/* 80CE4078  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE407C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CE4080  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80CE4084  7C 05 07 74 */	extsb r5, r0
/* 80CE4088  4B 35 12 D9 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CE4098  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE409C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CE40A0  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80CE40A4  7C 05 07 74 */	extsb r5, r0
/* 80CE40A8  4B 35 12 B9 */	bl isSwitch__10dSv_info_cCFii
