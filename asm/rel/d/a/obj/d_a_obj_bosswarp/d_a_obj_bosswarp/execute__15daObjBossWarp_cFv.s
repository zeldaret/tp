...
/* 8057A008  4B DE 81 CD */	bl _savegpr_27
/* 8057A00C  7C 7D 1B 78 */	mr r29, r3
/* 8057A010  3C 60 80 58 */	lis r3, l_hair_offset@ha /* 0x8057B360@ha */
/* 8057A014  3B C3 B3 60 */	addi r30, r3, l_hair_offset@l /* 0x8057B360@l */
/* 8057A018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8057A01C  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8057A054  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8057A058  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8057A05C  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8057A060  7C 05 07 74 */	extsb r5, r0
/* 8057A064  4B AB B2 FD */	bl isSwitch__10dSv_info_cCFii
...
lbl_8057A084:
/* 8057A084  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8057A088  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8057A0F0  4B AC E7 3D */	bl checkStartDemo__16dEvent_manager_cFv
...
/* 8057A124  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8057A128  83 63 10 18 */	lwz r27, m_midnaActor__9daPy_py_c@l(r3)  /* 0x80451018@l */
...
/* 8057A16C  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 8057A170  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 8057A174  38 81 00 08 */	addi r4, r1, 8
/* 8057A178  4B A9 F6 81 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8057A1BC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8057A1C0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8057A1C4  4B DC C2 ED */	bl PSMTXCopy
...
/* 8057A1F0  4B A9 2B E5 */	bl transM__14mDoMtx_stack_cFRC4cXyz
...
/* 8057A23C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8057A240  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8057A244  4B A9 20 5D */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 8057A248  C0 3D 05 CC */	lfs f1, 0x5cc(r29)
/* 8057A24C  FC 40 08 90 */	fmr f2, f1
/* 8057A250  FC 60 08 90 */	fmr f3, f1
/* 8057A254  4B A9 2B E5 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8057A258  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8057A25C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8057A284  4B DC C2 2D */	bl PSMTXCopy
...
/* 8057A2A0  4B DC C2 11 */	bl PSMTXCopy
lbl_8057A2A4:
/* 8057A2A4  80 7D 05 7C */	lwz r3, 0x57c(r29)
/* 8057A2A8  4B A9 31 81 */	bl play__14mDoExt_baseAnmFv
/* 8057A2AC  80 7D 05 74 */	lwz r3, 0x574(r29)
/* 8057A2B0  4B A9 31 79 */	bl play__14mDoExt_baseAnmFv
/* 8057A2B4  80 7D 05 78 */	lwz r3, 0x578(r29)
/* 8057A2B8  4B A9 31 71 */	bl play__14mDoExt_baseAnmFv
...
/* 8057A2D4  4B CF 64 6D */	bl cLib_chaseF__FPfff
lbl_8057A2D8:
...
/* 8057A338  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8057A33C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8057A368  4B D3 21 A5 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8057A36C:
...
/* 8057A37C  4B DE 7E A5 */	bl _restgpr_27
