...
/* 80BFFA10  4B 76 27 B9 */	bl _savegpr_24
...
/* 80BFFA24  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BFFA28  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BFFA2C  38 80 00 10 */	li r4, 0x10
/* 80BFFA30  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80BFFA34  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80BFFA38  4B 5A 3D 8D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BFFA3C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BFFA40  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BFFA44  80 9F 0F 9C */	lwz r4, 0xf9c(r31)
/* 80BFFA48  80 84 00 04 */	lwz r4, 4(r4)
/* 80BFFA4C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80BFFA50  4B 5A 53 51 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BFFA54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BFFA58  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BFFA5C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80BFFA60  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BFFA64  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80BFFA78  4B 40 E2 4D */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80BFFA8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BFFA90  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BFFA94  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BFFA98  3B 63 4A C8 */	addi r27, r3, j3dSys@l /* 0x80434AC8@l */
/* 80BFFA9C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BFFAA0  3B 83 CA 54 */	addi r28, r3, g_env_light@l /* 0x8042CA54@l */
lbl_80BFFAA4:
...
/* 80BFFAB8  4B 5A 3D 0D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 80BFFAD0  4B 5A 52 D1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80BFFAE8  4B 40 E1 DD */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80BFFB08  4B 76 27 0D */	bl _restgpr_24
