...
/* 80BFEA78  4B 76 37 64 */	b _savegpr_29
...
/* 80BFEA90  4B 66 92 98 */	b SetPos__11cBgS_GndChkFPC4cXyz
...
/* 80BFEAB0  4B 41 EE F8 */	b fopAcM_getWaterStream__FPC4cXyzRC13cBgS_PolyInfoP4cXyzPii
/* 80BFEAB4  80 01 00 08 */	lwz r0, 8(r1)
/* 80BFEAB8  3C 80 80 C0 */	lis r4, lit_3805@ha
/* 80BFEABC  C8 64 FC 6C */	lfd f3, lit_3805@l(r4)
...
/* 80BFEB28  3C 80 80 C0 */	lis r4, lit_4011@ha
/* 80BFEB2C  C0 04 FC 9C */	lfs f0, lit_4011@l(r4)
/* 80BFEB30  EC 20 00 B2 */	fmuls f1, f0, f2
/* 80BFEB34  3C 80 80 C0 */	lis r4, lit_4012@ha
/* 80BFEB38  C0 44 FC A0 */	lfs f2, lit_4012@l(r4)
/* 80BFEB3C  FC 60 F8 90 */	fmr f3, f31
/* 80BFEB40  4B 67 0E FC */	b cLib_addCalc2__FPffff
/* 80BFEB44  38 7F 00 08 */	addi r3, r31, 8
/* 80BFEB48  3C 80 80 C0 */	lis r4, lit_4011@ha
/* 80BFEB4C  C0 24 FC 9C */	lfs f1, lit_4011@l(r4)
/* 80BFEB50  C0 01 00 14 */	lfs f0, 0x14(r1)
/* 80BFEB54  EC 21 00 32 */	fmuls f1, f1, f0
/* 80BFEB58  3C 80 80 C0 */	lis r4, lit_4012@ha
/* 80BFEB5C  C0 44 FC A0 */	lfs f2, lit_4012@l(r4)
/* 80BFEB60  FC 60 F8 90 */	fmr f3, f31
/* 80BFEB64  4B 67 0E D8 */	b cLib_addCalc2__FPffff
...
/* 80BFEB7C  4B 76 36 AC */	b _restgpr_29
