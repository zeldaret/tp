...
/* 80C38BC0  4B 72 96 1C */	b _savegpr_29
...
/* 80C38BE0  4B 3D FF 84 */	b __ct__10fopAc_ac_cFv
/* 80C38BE4  3C 60 80 3B */	lis r3, __vt__12daItemBase_c@ha
/* 80C38BE8  38 03 36 10 */	addi r0, r3, __vt__12daItemBase_c@l
/* 80C38BEC  90 1E 05 68 */	stw r0, 0x568(r30)
/* 80C38BF0  3B BE 05 8C */	addi r29, r30, 0x58c
/* 80C38BF4  7F A3 EB 78 */	mr r3, r29
/* 80C38BF8  4B 43 D4 A8 */	b __ct__9dBgS_AcchFv
/* 80C38BFC  3C 60 80 C4 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80C38C00  38 63 97 E8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80C38C1C  4B 44 02 4C */	b SetObj__16dBgS_PolyPassChkFv
/* 80C38C20  38 7E 07 64 */	addi r3, r30, 0x764
/* 80C38C24  4B 43 D2 88 */	b __ct__12dBgS_AcchCirFv
/* 80C38C28  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C38C2C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C38C30  90 1E 07 BC */	stw r0, 0x7bc(r30)
/* 80C38C34  38 7E 07 C0 */	addi r3, r30, 0x7c0
/* 80C38C38  4B 44 AB 28 */	b __ct__10dCcD_GSttsFv
/* 80C38C3C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C38C40  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C38C58  4B 44 AD D0 */	b __ct__12dCcD_GObjInfFv
/* 80C38C5C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80C38C60  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80C38C64  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80C38C68  3C 60 80 C4 */	lis r3, __vt__8cM3dGAab@ha
/* 80C38C6C  38 03 97 DC */	addi r0, r3, __vt__8cM3dGAab@l
/* 80C38C70  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80C38C74  3C 60 80 C4 */	lis r3, __vt__8cM3dGCyl@ha
/* 80C38C78  38 03 97 D0 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80C38C7C  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80C38C80  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80C38C84  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80C38C88  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80C38C8C  38 03 00 58 */	addi r0, r3, 0x58
/* 80C38C90  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80C38C94  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80C38C98  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80C38CB0  3C 60 80 C4 */	lis r3, __vt__15daItemKantera_c@ha
/* 80C38CB4  38 03 98 0C */	addi r0, r3, __vt__15daItemKantera_c@l
...
/* 80C38D18  4B 45 F1 C8 */	b checkItemGet__FUci
...
/* 80C38D34  3C 60 80 3B */	lis r3, field_item_res__10dItem_data@ha
/* 80C38D38  38 63 DD 88 */	addi r3, r3, field_item_res__10dItem_data@l
/* 80C38D3C  7C 83 00 2E */	lwzx r4, r3, r0
/* 80C38D40  38 7F 05 6C */	addi r3, r31, 0x56c
/* 80C38D44  4B 3F 41 78 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C38D58  3C 80 80 03 */	lis r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@ha
/* 80C38D5C  38 84 7B 78 */	addi r4, r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@l
/* 80C38D60  38 A0 19 40 */	li r5, 0x1940
/* 80C38D64  4B 3E 17 4C */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80C38D98  4B 72 94 90 */	b _restgpr_29
