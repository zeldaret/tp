...
/* 80D3F44C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D3F450  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D3F464  4B 52 76 D1 */	bl __mi__4cXyzCFRC3Vec
...
/* 80D3F480  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D3F484  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D3F488  A8 1F 04 DE */	lha r0, 0x4de(r31)
/* 80D3F48C  7C 00 00 D0 */	neg r0, r0
/* 80D3F490  7C 04 07 34 */	extsh r4, r0
/* 80D3F494  4B 2C CF 49 */	bl mDoMtx_YrotS__FPA4_fs
/* 80D3F498  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D3F49C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D3F4A0  38 81 00 14 */	addi r4, r1, 0x14
/* 80D3F4A4  7C 85 23 78 */	mr r5, r4
/* 80D3F4A8  4B 60 78 C5 */	bl PSMTXMultVec
/* 80D3F4AC  38 60 00 01 */	li r3, 1
/* 80D3F4B0  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80D3F4B4  3C 80 80 D4 */	lis r4, lit_3658@ha /* 0x80D4027C@ha */
/* 80D3F4B8  C0 04 02 7C */	lfs f0, lit_3658@l(r4)  /* 0x80D4027C@l */
