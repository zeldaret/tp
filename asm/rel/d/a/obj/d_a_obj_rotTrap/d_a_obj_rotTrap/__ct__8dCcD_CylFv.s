...
/* 80CBFD68  4B 3C 3C C1 */	bl __ct__12dCcD_GObjInfFv
/* 80CBFD6C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CBFD70  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CBFD74  90 1F 01 20 */	stw r0, 0x120(r31)
/* 80CBFD78  3C 60 80 CC */	lis r3, __vt__8cM3dGAab@ha /* 0x80CC0A54@ha */
/* 80CBFD7C  38 03 0A 54 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CC0A54@l */
/* 80CBFD80  90 1F 01 1C */	stw r0, 0x11c(r31)
/* 80CBFD84  3C 60 80 CC */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CC0A60@ha */
/* 80CBFD88  38 03 0A 60 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CC0A60@l */
/* 80CBFD8C  90 1F 01 38 */	stw r0, 0x138(r31)
/* 80CBFD90  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CBFD94  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80CBFD98  90 7F 01 20 */	stw r3, 0x120(r31)
/* 80CBFD9C  38 03 00 58 */	addi r0, r3, 0x58
/* 80CBFDA0  90 1F 01 38 */	stw r0, 0x138(r31)
/* 80CBFDA4  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CBFDA8  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
