...
/* 80CBFAD8  4B 6A 26 F5 */	bl _savegpr_25
...
/* 80CBFAF8  4B 3B 8B 2D */	bl __ct__16dBgS_MoveBgActorFv
/* 80CBFAFC  3C 60 80 CC */	lis r3, __vt__11daRotTrap_c@ha /* 0x80CC0A6C@ha */
/* 80CBFB00  38 03 0A 6C */	addi r0, r3, __vt__11daRotTrap_c@l /* 0x80CC0A6C@l */
/* 80CBFB04  90 19 05 9C */	stw r0, 0x59c(r25)
/* 80CBFB08  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CBFB0C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CBFB10  90 19 05 CC */	stw r0, 0x5cc(r25)
/* 80CBFB14  38 79 05 D0 */	addi r3, r25, 0x5d0
/* 80CBFB18  4B 3C 3C 49 */	bl __ct__10dCcD_GSttsFv
/* 80CBFB1C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CBFB20  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CBFB34  3C 80 80 CC */	lis r4, __ct__8dCcD_CylFv@ha /* 0x80CBFD54@ha */
/* 80CBFB38  38 84 FD 54 */	addi r4, r4, __ct__8dCcD_CylFv@l /* 0x80CBFD54@l */
/* 80CBFB3C  3C A0 80 CC */	lis r5, __dt__8dCcD_CylFv@ha /* 0x80CBFC88@ha */
/* 80CBFB40  38 A5 FC 88 */	addi r5, r5, __dt__8dCcD_CylFv@l /* 0x80CBFC88@l */
/* 80CBFB44  38 C0 01 3C */	li r6, 0x13c
/* 80CBFB48  38 E0 00 0E */	li r7, 0xe
/* 80CBFB4C  4B 6A 22 15 */	bl __construct_array
lbl_80CBFB50:
...
/* 80CBFB60  3C 80 80 CC */	lis r4, d_a_obj_rotTrap__stringBase0@ha /* 0x80CC0858@ha */
/* 80CBFB64  38 84 08 58 */	addi r4, r4, d_a_obj_rotTrap__stringBase0@l /* 0x80CC0858@l */
/* 80CBFB68  4B 36 D3 55 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CBFB7C  3C 80 80 CC */	lis r4, d_a_obj_rotTrap__stringBase0@ha /* 0x80CC0858@ha */
/* 80CBFB80  38 84 08 58 */	addi r4, r4, d_a_obj_rotTrap__stringBase0@l /* 0x80CC0858@l */
/* 80CBFB84  38 A0 00 07 */	li r5, 7
/* 80CBFB88  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80CBFB8C  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80CBFB90  38 E0 7D F0 */	li r7, 0x7df0
/* 80CBFB94  39 00 00 00 */	li r8, 0
/* 80CBFB98  4B 3B 8C 25 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80CBFBC4  4B 35 A9 B5 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80CBFBD8  4B 3C 3C 89 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80CBFBDC  3B 20 00 00 */	li r25, 0
/* 80CBFBE0  3B A0 00 00 */	li r29, 0
/* 80CBFBE4  3C 60 80 CC */	lis r3, mCcDCyl__11daRotTrap_c@ha /* 0x80CC0880@ha */
/* 80CBFBE8  3B 63 08 80 */	addi r27, r3, mCcDCyl__11daRotTrap_c@l /* 0x80CC0880@l */
...
/* 80CBFBFC  4B 3C 4C B9 */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
...
lbl_80CBFC34:
/* 80CBFC34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CBFC38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CBFC3C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80CBFC40  7C 05 07 74 */	extsb r5, r0
/* 80CBFC44  4B 37 57 1D */	bl isSwitch__10dSv_info_cCFii
...
/* 80CBFC74  4B 6A 25 A5 */	bl _restgpr_25
