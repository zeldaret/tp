...
/* 80CBFF2C  4B 6A 22 8D */	bl _savegpr_20
/* 80CBFF30  7C 7D 1B 78 */	mr r29, r3
/* 80CBFF34  3C 60 80 CC */	lis r3, cNullVec__6Z2Calc@ha /* 0x80CC0860@ha */
/* 80CBFF38  3B E3 08 60 */	addi r31, r3, cNullVec__6Z2Calc@l /* 0x80CC0860@l */
/* 80CBFF3C  3C 60 80 CC */	lis r3, data_80CC0AD4@ha /* 0x80CC0AD4@ha */
/* 80CBFF40  38 A3 0A D4 */	addi r5, r3, data_80CC0AD4@l /* 0x80CC0AD4@l */
...
/* 80CBFFB8  4B 6A 20 CD */	bl __ptmf_scall
...
/* 80CBFFD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CBFFD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CBFFD8  3A C3 23 3C */	addi r22, r3, 0x233c
/* 80CBFFDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CBFFE0  3A E3 D4 70 */	addi r23, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CBFFE4  3B 1F 01 0C */	addi r24, r31, 0x10c
/* 80CBFFE8  3C 60 80 CC */	lis r3, lit_3880@ha /* 0x80CC083C@ha */
/* 80CBFFEC  3B 23 08 3C */	addi r25, r3, lit_3880@l /* 0x80CC083C@l */
lbl_80CBFFF0:
...
/* 80CC0000  4B 34 C2 09 */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80CC0098  4B 6A 21 6D */	bl _restgpr_20
