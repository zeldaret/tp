...
/* 80CAC0E8  4B 6B 60 F4 */	b _savegpr_29
...
/* 80CAC108  4B 3C C5 1C */	b __ct__16dBgS_MoveBgActorFv
/* 80CAC10C  3C 60 80 CB */	lis r3, __vt__13daObjPDtile_c@ha
/* 80CAC110  38 03 C7 3C */	addi r0, r3, __vt__13daObjPDtile_c@l
/* 80CAC114  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80CAC118  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80CAC11C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80CAC120  90 1E 06 4C */	stw r0, 0x64c(r30)
/* 80CAC124  38 7E 06 50 */	addi r3, r30, 0x650
/* 80CAC128  4B 3D 76 38 */	b __ct__10dCcD_GSttsFv
/* 80CAC12C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80CAC130  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80CAC148  4B 3D 78 E0 */	b __ct__12dCcD_GObjInfFv
/* 80CAC14C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80CAC150  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80CAC154  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80CAC158  3C 60 80 CB */	lis r3, __vt__8cM3dGAab@ha
/* 80CAC15C  38 03 C7 00 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80CAC160  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80CAC164  3C 60 80 CB */	lis r3, __vt__8cM3dGCyl@ha
/* 80CAC168  38 03 C6 F4 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80CAC16C  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80CAC170  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80CAC174  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80CAC178  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80CAC17C  38 03 00 58 */	addi r0, r3, 0x58
/* 80CAC180  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80CAC184  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80CAC188  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80CAC1A4  4B 61 26 A0 */	b __ct__16Z2SoundObjSimpleFv
lbl_80CAC1A8:
...
/* 80CAC1C0  4B 6B 60 68 */	b _restgpr_29
