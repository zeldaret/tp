...
/* 80C3A4F0  3C 80 80 C4 */	lis r4, lit_3775@ha /* 0x80C3C674@ha */
/* 80C3A4F4  3B E4 C6 74 */	addi r31, r4, lit_3775@l /* 0x80C3C674@l */
/* 80C3A4F8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3A4FC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3A500  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80C3A504  4B 3E 02 DD */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C3A52C  4B 62 C6 09 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C3A54C  4B 62 D4 41 */	bl cM_rndFX__Ff
...
/* 80C3A560  4B 62 D4 2D */	bl cM_rndFX__Ff
...
/* 80C3A574  4B 62 D1 01 */	bl cM_atan2s__Fff
/* 80C3A578  B0 7E 07 E0 */	sth r3, 0x7e0(r30)
/* 80C3A57C  C0 3F 00 98 */	lfs f1, 0x98(r31)
/* 80C3A580  4B 62 D3 D5 */	bl cM_rndF__Ff
...
/* 80C3A5CC  4B 63 60 3D */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C3A5EC  4B 63 60 1D */	bl cLib_addCalcAngleS2__FPssss
