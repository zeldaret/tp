...
/* 80C39A68  4B 72 87 70 */	b _savegpr_28
...
/* 80C39A88  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C39A8C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C39A90  4B 70 CA 20 */	b PSMTXCopy
/* 80C39A94  2C 1D 00 01 */	cmpwi r29, 1
/* 80C39A98  40 82 00 4C */	bne lbl_80C39AE4
/* 80C39A9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C39AA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C39AA4  3C 80 80 C4 */	lis r4, lit_3812@ha
/* 80C39AA8  C0 44 C6 C0 */	lfs f2, lit_3812@l(r4)
/* 80C39AAC  A8 1C 07 F2 */	lha r0, 0x7f2(r28)
/* 80C39AB0  3C 80 80 C4 */	lis r4, lit_3814@ha
/* 80C39AB4  C8 24 C6 C4 */	lfd f1, lit_3814@l(r4)
...
/* 80C39AE0  4B 3D 29 54 */	b mDoMtx_YrotM__FPA4_fs
lbl_80C39AE4:
/* 80C39AE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C39AE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C39AEC  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80C39AF0  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C39AF4  7C 80 FA 14 */	add r4, r0, r31
/* 80C39AF8  4B 70 C9 B8 */	b PSMTXCopy
/* 80C39AFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C39B00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C39B04  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80C39B08  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80C39B0C  4B 70 C9 A4 */	b PSMTXCopy
/* 80C39B10  38 60 00 01 */	li r3, 1
/* 80C39B14  39 61 00 30 */	addi r11, r1, 0x30
/* 80C39B18  4B 72 87 0C */	b _restgpr_28
