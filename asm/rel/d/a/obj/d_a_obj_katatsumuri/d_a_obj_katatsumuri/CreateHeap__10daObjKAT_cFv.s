...
/* 80C39BA8  4B 72 86 31 */	bl _savegpr_28
/* 80C39BAC  7C 7F 1B 78 */	mr r31, r3
/* 80C39BB0  3C 60 80 C4 */	lis r3, d_a_obj_katatsumuri__stringBase0@ha /* 0x80C3C764@ha */
/* 80C39BB4  38 63 C7 64 */	addi r3, r3, d_a_obj_katatsumuri__stringBase0@l /* 0x80C3C764@l */
/* 80C39BB8  38 80 00 09 */	li r4, 9
/* 80C39BBC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C39BC0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C39BD4  4B 40 27 19 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C39BD8  7C 7D 1B 78 */	mr r29, r3
/* 80C39BDC  38 60 00 58 */	li r3, 0x58
/* 80C39BE0  4B 69 50 6D */	bl __nw__FUl
/* 80C39BE4  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C39BE8  41 82 00 68 */	beq lbl_80C39C50
/* 80C39BEC  3C 60 80 C4 */	lis r3, d_a_obj_katatsumuri__stringBase0@ha /* 0x80C3C764@ha */
/* 80C39BF0  38 63 C7 64 */	addi r3, r3, d_a_obj_katatsumuri__stringBase0@l /* 0x80C3C764@l */
/* 80C39BF4  38 80 00 06 */	li r4, 6
/* 80C39BF8  7F C5 F3 78 */	mr r5, r30
/* 80C39BFC  38 C0 00 80 */	li r6, 0x80
/* 80C39C00  4B 40 26 ED */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C39C38  3D 20 80 C4 */	lis r9, lit_3775@ha /* 0x80C3C674@ha */
/* 80C39C3C  C0 29 C6 74 */	lfs f1, lit_3775@l(r9)  /* 0x80C3C674@l */
/* 80C39C40  39 20 00 00 */	li r9, 0
/* 80C39C44  39 40 FF FF */	li r10, -1
/* 80C39C48  4B 3D 6B 89 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80C39C78  4B 69 4F D5 */	bl __nw__FUl
/* 80C39C7C  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C39C80  41 82 00 20 */	beq lbl_80C39CA0
/* 80C39C84  3C 80 80 C4 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C3C814@ha */
/* 80C39C88  38 04 C8 14 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C3C814@l */
/* 80C39C8C  90 1C 00 00 */	stw r0, 0(r28)
/* 80C39C90  38 80 00 00 */	li r4, 0
/* 80C39C94  4B 6E E7 69 */	bl init__12J3DFrameCtrlFs
...
/* 80C39CC4  3C 60 80 C4 */	lis r3, d_a_obj_katatsumuri__stringBase0@ha /* 0x80C3C764@ha */
/* 80C39CC8  38 63 C7 64 */	addi r3, r3, d_a_obj_katatsumuri__stringBase0@l /* 0x80C3C764@l */
/* 80C39CCC  38 80 00 0C */	li r4, 0xc
/* 80C39CD0  7F C5 F3 78 */	mr r5, r30
/* 80C39CD4  38 C0 00 80 */	li r6, 0x80
/* 80C39CD8  4B 40 26 15 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C39CF4  3D 00 80 C4 */	lis r8, lit_3775@ha /* 0x80C3C674@ha */
/* 80C39CF8  C0 28 C6 74 */	lfs f1, lit_3775@l(r8)  /* 0x80C3C674@l */
/* 80C39CFC  39 00 00 00 */	li r8, 0
/* 80C39D00  39 20 FF FF */	li r9, -1
/* 80C39D04  4B 3D 3A 09 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80C39D18:
/* 80C39D18  3C 60 80 C4 */	lis r3, d_a_obj_katatsumuri__stringBase0@ha /* 0x80C3C764@ha */
/* 80C39D1C  38 63 C7 64 */	addi r3, r3, d_a_obj_katatsumuri__stringBase0@l /* 0x80C3C764@l */
/* 80C39D20  38 80 00 0D */	li r4, 0xd
/* 80C39D24  7F C5 F3 78 */	mr r5, r30
/* 80C39D28  38 C0 00 80 */	li r6, 0x80
/* 80C39D2C  4B 40 25 C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C39D48  3D 00 80 C4 */	lis r8, lit_3775@ha /* 0x80C3C674@ha */
/* 80C39D4C  C0 28 C6 74 */	lfs f1, lit_3775@l(r8)  /* 0x80C3C674@l */
/* 80C39D50  39 00 00 00 */	li r8, 0
/* 80C39D54  39 20 FF FF */	li r9, -1
/* 80C39D58  4B 3D 39 B5 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C39D70  4B 69 4E DD */	bl __nw__FUl
/* 80C39D74  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C39D78  41 82 00 20 */	beq lbl_80C39D98
/* 80C39D7C  3C 80 80 C4 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80C3C814@ha */
/* 80C39D80  38 04 C8 14 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80C3C814@l */
/* 80C39D84  90 1C 00 00 */	stw r0, 0(r28)
/* 80C39D88  38 80 00 00 */	li r4, 0
/* 80C39D8C  4B 6E E6 71 */	bl init__12J3DFrameCtrlFs
...
/* 80C39DBC  3C 60 80 C4 */	lis r3, d_a_obj_katatsumuri__stringBase0@ha /* 0x80C3C764@ha */
/* 80C39DC0  38 63 C7 64 */	addi r3, r3, d_a_obj_katatsumuri__stringBase0@l /* 0x80C3C764@l */
/* 80C39DC4  38 80 00 10 */	li r4, 0x10
/* 80C39DC8  7F C5 F3 78 */	mr r5, r30
/* 80C39DCC  38 C0 00 80 */	li r6, 0x80
/* 80C39DD0  4B 40 25 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C39DEC  3D 00 80 C4 */	lis r8, lit_3775@ha /* 0x80C3C674@ha */
/* 80C39DF0  C0 28 C6 74 */	lfs f1, lit_3775@l(r8)  /* 0x80C3C674@l */
/* 80C39DF4  39 00 00 00 */	li r8, 0
/* 80C39DF8  39 20 FF FF */	li r9, -1
/* 80C39DFC  4B 3D 38 41 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80C39E10:
/* 80C39E10  3C 60 80 C4 */	lis r3, d_a_obj_katatsumuri__stringBase0@ha /* 0x80C3C764@ha */
/* 80C39E14  38 63 C7 64 */	addi r3, r3, d_a_obj_katatsumuri__stringBase0@l /* 0x80C3C764@l */
/* 80C39E18  38 80 00 11 */	li r4, 0x11
/* 80C39E1C  7F C5 F3 78 */	mr r5, r30
/* 80C39E20  38 C0 00 80 */	li r6, 0x80
/* 80C39E24  4B 40 24 C9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C39E40  3D 00 80 C4 */	lis r8, lit_3775@ha /* 0x80C3C674@ha */
/* 80C39E44  C0 28 C6 74 */	lfs f1, lit_3775@l(r8)  /* 0x80C3C674@l */
/* 80C39E48  39 00 00 00 */	li r8, 0
/* 80C39E4C  39 20 FF FF */	li r9, -1
/* 80C39E50  4B 3D 37 ED */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C39E6C  4B 72 83 B9 */	bl _restgpr_28
