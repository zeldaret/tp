...
/* 80C3BAEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3BAF0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3BAF4  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C3BAF8  7F E3 FB 78 */	mr r3, r31
/* 80C3BAFC  3C 80 80 C4 */	lis r4, l_musiya_num@ha /* 0x80C3C754@ha */
/* 80C3BB00  A0 04 C7 54 */	lhz r0, l_musiya_num@l(r4)  /* 0x80C3C754@l */
/* 80C3BB04  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BB08  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C3BB0C  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C3BB10  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BB14  4B 3F 8E A9 */	bl isEventBit__11dSv_event_cCFUs
/* 80C3BB18  2C 03 00 00 */	cmpwi r3, 0
/* 80C3BB1C  41 82 00 30 */	beq lbl_80C3BB4C
/* 80C3BB20  7F E3 FB 78 */	mr r3, r31
/* 80C3BB24  3C 80 80 C4 */	lis r4, l_musiya_num@ha /* 0x80C3C754@ha */
/* 80C3BB28  38 84 C7 54 */	addi r4, r4, l_musiya_num@l /* 0x80C3C754@l */
/* 80C3BB2C  A0 04 00 02 */	lhz r0, 2(r4)
/* 80C3BB30  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BB34  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C3BB38  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C3BB3C  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BB40  4B 3F 8E 7D */	bl isEventBit__11dSv_event_cCFUs
...
lbl_80C3BB54:
/* 80C3BB54  3C 60 80 C4 */	lis r3, d_a_obj_katatsumuri__stringBase0@ha /* 0x80C3C764@ha */
/* 80C3BB58  38 63 C7 64 */	addi r3, r3, d_a_obj_katatsumuri__stringBase0@l /* 0x80C3C764@l */
/* 80C3BB5C  38 63 00 04 */	addi r3, r3, 4
/* 80C3BB60  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3BB64  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3BB68  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C3BB6C  4B 72 CE 29 */	bl strcmp
/* 80C3BB70  2C 03 00 00 */	cmpwi r3, 0
/* 80C3BB74  40 82 00 CC */	bne lbl_80C3BC40
/* 80C3BB78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3BB7C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C3BB90  3C 60 80 C4 */	lis r3, l_kat_itemno@ha /* 0x80C3C678@ha */
/* 80C3BB94  38 63 C6 78 */	addi r3, r3, l_kat_itemno@l /* 0x80C3C678@l */
/* 80C3BB98  7C 63 00 AE */	lbzx r3, r3, r0
/* 80C3BB9C  4B 59 E3 A1 */	bl isCatchNotGiveInsect__14dMenu_Insect_cFUc
...
/* 80C3BBBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3BBC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3BBC4  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C3BBC8  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C3BBCC  3C 80 80 C4 */	lis r4, l_musiya_num@ha /* 0x80C3C754@ha */
/* 80C3BBD0  38 84 C7 54 */	addi r4, r4, l_musiya_num@l /* 0x80C3C754@l */
/* 80C3BBD4  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C3BBD8  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BBDC  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C3BBE0  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C3BBE4  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BBE8  4B 3F 8D D5 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80C3BC00  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3BC04  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3BC08  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C3BC0C  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C3BC10  3C 80 80 C4 */	lis r4, l_musiya_num@ha /* 0x80C3C754@ha */
/* 80C3BC14  38 84 C7 54 */	addi r4, r4, l_musiya_num@l /* 0x80C3C754@l */
/* 80C3BC18  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C3BC1C  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BC20  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80C3BC24  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80C3BC28  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BC2C  4B 3F 8D 91 */	bl isEventBit__11dSv_event_cCFUs
