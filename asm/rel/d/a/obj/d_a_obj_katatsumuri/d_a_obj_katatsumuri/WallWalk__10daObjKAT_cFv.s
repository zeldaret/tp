...
/* 80C39F1C  4B 72 82 C1 */	bl _savegpr_29
/* 80C39F20  7C 7E 1B 78 */	mr r30, r3
/* 80C39F24  3C 60 80 C4 */	lis r3, lit_3775@ha /* 0x80C3C674@ha */
/* 80C39F28  3B E3 C6 74 */	addi r31, r3, lit_3775@l /* 0x80C3C674@l */
...
/* 80C39FA8  4B 43 DC C1 */	bl __ct__11dBgS_LinChkFv
/* 80C39FAC  38 61 00 C8 */	addi r3, r1, 0xc8
/* 80C39FB0  4B 43 DC B9 */	bl __ct__11dBgS_LinChkFv
/* 80C39FB4  38 61 01 90 */	addi r3, r1, 0x190
/* 80C39FB8  4B 43 EE B1 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80C39FBC  38 61 01 20 */	addi r3, r1, 0x120
/* 80C39FC0  4B 43 EE A9 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80C39FC4  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80C39FC8  4B 3D 2D 9D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C39FCC  38 7E 07 EA */	addi r3, r30, 0x7ea
/* 80C39FD0  4B 3D 2F 75 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C39FD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C39FD8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C39FDC  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C39FE0  4B 3D 24 55 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C39FE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C39FE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C39FEC  38 81 00 94 */	addi r4, r1, 0x94
/* 80C39FF0  38 A1 00 88 */	addi r5, r1, 0x88
/* 80C39FF4  4B 70 CD 79 */	bl PSMTXMultVec
/* 80C39FF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C39FFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C3A000  38 81 00 7C */	addi r4, r1, 0x7c
/* 80C3A004  38 A1 00 70 */	addi r5, r1, 0x70
/* 80C3A008  4B 70 CD 65 */	bl PSMTXMultVec
/* 80C3A00C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C3A010  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C3A014  38 81 00 64 */	addi r4, r1, 0x64
/* 80C3A018  38 A1 00 58 */	addi r5, r1, 0x58
/* 80C3A01C  4B 70 CD 51 */	bl PSMTXMultVec
/* 80C3A020  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C3A024  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C3A028  38 81 00 4C */	addi r4, r1, 0x4c
/* 80C3A02C  38 A1 00 40 */	addi r5, r1, 0x40
/* 80C3A030  4B 70 CD 3D */	bl PSMTXMultVec
...
/* 80C3A044  4B 43 DD 21 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 80C3A058  4B 43 DD 0D */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C3A05C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3A060  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3A064  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80C3A068  7F A3 EB 78 */	mr r3, r29
/* 80C3A06C  38 81 01 38 */	addi r4, r1, 0x138
/* 80C3A070  4B 43 A3 45 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80C3A084  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C3C808@ha */
/* 80C3A088  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C3C808@l */
...
/* 80C3A09C  4B 43 A6 A9 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C3A0A0  C0 21 00 B4 */	lfs f1, 0xb4(r1)
/* 80C3A0A4  C0 41 00 BC */	lfs f2, 0xbc(r1)
/* 80C3A0A8  4B 62 D5 CD */	bl cM_atan2s__Fff
...
/* 80C3A0DC  4B 70 D2 C1 */	bl PSVECSquareDistance
...
/* 80C3A14C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C3A150  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C3A1BC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C3A1C0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C3A1EC  4B 62 D4 89 */	bl cM_atan2s__Fff
...
/* 80C3A200  4B 62 D4 75 */	bl cM_atan2s__Fff
/* 80C3A204  B0 7E 07 C2 */	sth r3, 0x7c2(r30)
/* 80C3A208  C0 21 00 B4 */	lfs f1, 0xb4(r1)
/* 80C3A20C  C0 41 00 BC */	lfs f2, 0xbc(r1)
/* 80C3A210  4B 62 D4 65 */	bl cM_atan2s__Fff
/* 80C3A214  B0 7E 07 F6 */	sth r3, 0x7f6(r30)
/* 80C3A218  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C3C808@ha */
/* 80C3A21C  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C3C808@l */
...
/* 80C3A230  4B 43 A1 85 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80C3A244  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C3C808@ha */
/* 80C3A248  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C3C808@l */
...
/* 80C3A25C  4B 43 A4 E9 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C3A260  C0 21 00 A0 */	lfs f1, 0xa0(r1)
/* 80C3A264  C0 41 00 A8 */	lfs f2, 0xa8(r1)
/* 80C3A268  4B 62 D4 0D */	bl cM_atan2s__Fff
...
/* 80C3A29C  4B 70 D1 01 */	bl PSVECSquareDistance
...
/* 80C3A30C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C3A310  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C3A37C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C3A380  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C3A3AC  4B 62 D2 C9 */	bl cM_atan2s__Fff
...
/* 80C3A3C0  4B 62 D2 B5 */	bl cM_atan2s__Fff
/* 80C3A3C4  B0 7E 07 C2 */	sth r3, 0x7c2(r30)
/* 80C3A3C8  C0 21 00 A0 */	lfs f1, 0xa0(r1)
/* 80C3A3CC  C0 41 00 A8 */	lfs f2, 0xa8(r1)
/* 80C3A3D0  4B 62 D2 A5 */	bl cM_atan2s__Fff
/* 80C3A3D4  B0 7E 07 F6 */	sth r3, 0x7f6(r30)
/* 80C3A3D8  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C3C808@ha */
/* 80C3A3DC  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C3C808@l */
...
/* 80C3A400  4B 63 63 AD */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 80C3A42C  4B 63 61 DD */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C3A440  4B 63 61 C9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C3A454  4B 63 61 B5 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C3A468  4B 43 D8 75 */	bl __dt__11dBgS_LinChkFv
/* 80C3A46C  38 61 01 38 */	addi r3, r1, 0x138
/* 80C3A470  38 80 FF FF */	li r4, -1
/* 80C3A474  4B 43 D8 69 */	bl __dt__11dBgS_LinChkFv
/* 80C3A478  39 61 01 C0 */	addi r11, r1, 0x1c0
/* 80C3A47C  4B 72 7D AD */	bl _restgpr_29
