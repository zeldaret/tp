...
/* 80C3B9D0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C3B9D4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C3B9D8  38 80 00 10 */	li r4, 0x10
/* 80C3B9DC  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C3B9E0  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C3B9E4  4B 56 7D E0 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C3B9E8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C3B9EC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C3B9F0  80 9F 00 04 */	lwz r4, 4(r31)
/* 80C3B9F4  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C3B9F8  4B 56 93 A8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C3BA0C  4B 3D 1C CC */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C3BA20  4B 3D 1D 88 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80C3BA24  80 9F 00 04 */	lwz r4, 4(r31)
/* 80C3BA28  7F C3 F3 78 */	mr r3, r30
/* 80C3BA2C  4B 3E 1A 00 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 80C3BA30  80 7E 0A 64 */	lwz r3, 0xa64(r30)
/* 80C3BA34  4B 3D 57 8C */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 80C3BA4C  3C 80 80 C4 */	lis r4, lit_4695@ha
/* 80C3BA50  C0 44 C7 4C */	lfs f2, lit_4695@l(r4)
/* 80C3BA54  38 9E 06 80 */	addi r4, r30, 0x680
/* 80C3BA58  38 A0 00 00 */	li r5, 0
/* 80C3BA5C  3C C0 80 C4 */	lis r6, lit_4696@ha
/* 80C3BA60  C0 66 C7 50 */	lfs f3, lit_4696@l(r6)
/* 80C3BA64  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80C3BA68  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80C3BA6C  4B 3F 16 48 */	b dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80C3BA70:
