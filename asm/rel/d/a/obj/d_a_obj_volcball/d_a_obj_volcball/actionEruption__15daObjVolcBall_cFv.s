...
/* 80D2295C  4B 63 F8 75 */	bl _savegpr_26
/* 80D22960  7C 7B 1B 78 */	mr r27, r3
/* 80D22964  3C 60 80 D2 */	lis r3, l_sph_src@ha /* 0x80D23DCC@ha */
/* 80D22968  3B E3 3D CC */	addi r31, r3, l_sph_src@l /* 0x80D23DCC@l */
/* 80D2296C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D22970  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D22974  3B A3 5B D4 */	addi r29, r3, 0x5bd4
/* 80D22978  7F A3 EB 78 */	mr r3, r29
/* 80D2297C  4B 34 D4 E1 */	bl CheckQuake__12dVibration_cFv
...
lbl_80D22990:
/* 80D22990  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D22994  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D229C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D229C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D229CC  88 1B 04 BA */	lbz r0, 0x4ba(r27)
/* 80D229D0  7C 05 07 74 */	extsb r5, r0
/* 80D229D4  4B 31 29 8D */	bl isSwitch__10dSv_info_cCFii
...
/* 80D22AB0  4B 54 DC 91 */	bl cLib_chaseF__FPfff
...
/* 80D22AD8  4B 54 DC 69 */	bl cLib_chaseF__FPfff
...
/* 80D22B00  4B 54 DC 41 */	bl cLib_chaseF__FPfff
...
/* 80D22B28  4B 54 DC 19 */	bl cLib_chaseF__FPfff
...
/* 80D22B54  4B 54 CB B5 */	bl SetR__8cM3dGSphFf
/* 80D22B58  38 7B 28 5C */	addi r3, r27, 0x285c
/* 80D22B5C  38 9B 25 10 */	addi r4, r27, 0x2510
/* 80D22B60  4B 54 CA E9 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80D22B64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D22B68  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D22B6C  38 63 23 3C */	addi r3, r3, 0x233c
/* 80D22B70  38 9B 27 38 */	addi r4, r27, 0x2738
/* 80D22B74  4B 54 20 35 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80D22B78:
...
/* 80D22BB8  4B 54 4D D5 */	bl cM_rndFX__Ff
...
/* 80D22BD8  4B 63 F4 D5 */	bl __cvt_fp2unsigned
...
/* 80D22BFC  4B 34 D1 99 */	bl StopQuake__12dVibration_cFi
lbl_80D22C00:
/* 80D22C00  88 1B 04 E2 */	lbz r0, 0x4e2(r27)
/* 80D22C04  7C 03 07 74 */	extsb r3, r0
/* 80D22C08  4B 30 A4 65 */	bl dComIfGp_getReverb__Fi
...
/* 80D22C1C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D22C20  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
