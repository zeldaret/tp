...
/* 80D23880  3C 60 80 D2 */	lis r3, lit_3717@ha /* 0x80D23E14@ha */
/* 80D23884  C0 23 3E 14 */	lfs f1, lit_3717@l(r3)  /* 0x80D23E14@l */
/* 80D23888  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 80D2388C  3C 60 80 D2 */	lis r3, lit_4031@ha /* 0x80D23E24@ha */
/* 80D23890  C0 03 3E 24 */	lfs f0, lit_4031@l(r3)  /* 0x80D23E24@l */
/* 80D23894  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80D23898  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80D2389C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D238A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D238B4  4B 34 C2 5D */	bl StartQuake__12dVibration_cFii4cXyz
/* 80D238B8  48 00 00 3C */	b lbl_80D238F4
lbl_80D238BC:
/* 80D238BC  3C 60 80 D2 */	lis r3, lit_3717@ha /* 0x80D23E14@ha */
/* 80D238C0  C0 23 3E 14 */	lfs f1, lit_3717@l(r3)  /* 0x80D23E14@l */
/* 80D238C4  D0 21 00 08 */	stfs f1, 8(r1)
/* 80D238C8  3C 60 80 D2 */	lis r3, lit_4031@ha /* 0x80D23E24@ha */
/* 80D238CC  C0 03 3E 24 */	lfs f0, lit_4031@l(r3)  /* 0x80D23E24@l */
/* 80D238D0  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80D238D4  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80D238D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D238DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D238F0  4B 34 C2 21 */	bl StartQuake__12dVibration_cFii4cXyz
lbl_80D238F4:
