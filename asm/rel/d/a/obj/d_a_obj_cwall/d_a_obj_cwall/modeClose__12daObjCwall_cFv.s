...
/* 80BD8C08  4B 78 95 C9 */	bl _savegpr_26
/* 80BD8C0C  7C 7A 1B 78 */	mr r26, r3
/* 80BD8C10  3C 60 80 BE */	lis r3, l_wallBmd@ha /* 0x80BD9FA4@ha */
/* 80BD8C14  3B C3 9F A4 */	addi r30, r3, l_wallBmd@l /* 0x80BD9FA4@l */
/* 80BD8C18  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BD8C1C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BD8C58  4B 76 E7 45 */	bl PSVECSquareDistance
...
/* 80BD8CC8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BD8CCC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BD8D38  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BD8D3C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BD8D88  4B 76 E6 15 */	bl PSVECSquareDistance
...
/* 80BD8DF8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BD8DFC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BD8E68  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BD8E6C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80BD8E70:
...
/* 80BD8F78  4B 69 78 35 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 80BD8FB4  4B 76 E3 E9 */	bl PSVECSquareDistance
...
/* 80BD9024  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BD9028  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BD9094  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BD9098  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80BD909C:
...
/* 80BD90D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BD90D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BD90EC  4B 49 69 39 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 80BD9104  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BD9108  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BD9134  4B 6D 28 51 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80BD915C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BD9160  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BD9164  88 1A 04 BA */	lbz r0, 0x4ba(r26)
/* 80BD9168  7C 05 07 74 */	extsb r5, r0
/* 80BD916C  4B 45 C0 95 */	bl onSwitch__10dSv_info_cFii
lbl_80BD9170:
...
/* 80BD91F8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BD91FC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BD9224  4B 6D 27 61 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80BD925C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BD9260  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BD928C  4B 6D 32 81 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80BD92A0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BD92A4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BD92D0  4B 6D 32 3D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80BD92D4:
...
/* 80BD92F4  4B 43 3A 71 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80BD92F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BD92FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BD9300  A8 9A 04 B6 */	lha r4, 0x4b6(r26)
/* 80BD9304  4B 43 31 31 */	bl mDoMtx_YrotM__FPA4_fs
/* 80BD9308  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BD930C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BD9310  38 81 00 60 */	addi r4, r1, 0x60
/* 80BD9314  7C 85 23 78 */	mr r5, r4
/* 80BD9318  4B 76 DA 55 */	bl PSMTXMultVec
/* 80BD931C  38 7A 07 0C */	addi r3, r26, 0x70c
/* 80BD9320  38 81 00 60 */	addi r4, r1, 0x60
/* 80BD9324  4B 69 5E B9 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80BD9328  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BD932C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BD9330  38 63 23 3C */	addi r3, r3, 0x233c
/* 80BD9334  38 9A 05 E8 */	addi r4, r26, 0x5e8
/* 80BD9338  4B 68 B8 71 */	bl Set__4cCcSFP8cCcD_Obj
/* 80BD933C  E3 E1 00 B8 */	psq_l f31, 184(r1), 0, 0 /* qr0 */
/* 80BD9340  CB E1 00 B0 */	lfd f31, 0xb0(r1)
/* 80BD9344  39 61 00 B0 */	addi r11, r1, 0xb0
/* 80BD9348  4B 78 8E D5 */	bl _restgpr_26
