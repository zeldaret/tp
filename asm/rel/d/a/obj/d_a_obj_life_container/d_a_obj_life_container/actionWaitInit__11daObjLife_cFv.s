...
/* 804CD5E4  4B B6 A4 91 */	bl show__12daItemBase_cFv
...
/* 804CD608  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CD60C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804CD610  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 804CD614  3C 80 80 4D */	lis r4, d_a_obj_life_container__stringBase0@ha /* 0x804CE4A4@ha */
/* 804CD618  38 84 E4 A4 */	addi r4, r4, d_a_obj_life_container__stringBase0@l /* 0x804CE4A4@l */
/* 804CD61C  4B E9 B3 79 */	bl strcmp
/* 804CD620  2C 03 00 00 */	cmpwi r3, 0
/* 804CD624  40 82 00 24 */	bne lbl_804CD648
/* 804CD628  3C 60 80 4D */	lis r3, lit_3855@ha /* 0x804CE438@ha */
/* 804CD62C  C0 03 E4 38 */	lfs f0, lit_3855@l(r3)  /* 0x804CE438@l */
/* 804CD630  D0 1F 05 30 */	stfs f0, 0x530(r31)
/* 804CD634  38 00 00 00 */	li r0, 0
/* 804CD638  B0 1F 09 48 */	sth r0, 0x948(r31)
/* 804CD63C  3C 60 80 4D */	lis r3, lit_4206@ha /* 0x804CE484@ha */
/* 804CD640  C0 03 E4 84 */	lfs f0, lit_4206@l(r3)  /* 0x804CE484@l */
