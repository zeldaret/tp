...
/* 804CCE14  3C 60 80 4D */	lis r3, lit_3969@ha /* 0x804CE46C@ha */
/* 804CCE18  C0 03 E4 6C */	lfs f0, lit_3969@l(r3)  /* 0x804CE46C@l */
...
/* 804CCE34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CCE38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CCE7C  3D 60 80 4D */	lis r11, lit_3970@ha /* 0x804CE470@ha */
/* 804CCE80  C0 2B E4 70 */	lfs f1, lit_3970@l(r11)  /* 0x804CE470@l */
/* 804CCE84  4B B7 FC 0D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_804CCE88:
/* 804CCE88  80 1F 09 8C */	lwz r0, 0x98c(r31)
/* 804CCE8C  28 00 00 00 */	cmplwi r0, 0
/* 804CCE90  40 82 00 58 */	bne lbl_804CCEE8
/* 804CCE94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CCE98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CCEDC  3D 60 80 4D */	lis r11, lit_3970@ha /* 0x804CE470@ha */
/* 804CCEE0  C0 2B E4 70 */	lfs f1, lit_3970@l(r11)  /* 0x804CE470@l */
/* 804CCEE4  4B B7 FB AD */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_804CCEE8:
/* 804CCEE8  80 1F 09 A0 */	lwz r0, 0x9a0(r31)
/* 804CCEEC  28 00 00 00 */	cmplwi r0, 0
/* 804CCEF0  40 82 00 58 */	bne lbl_804CCF48
/* 804CCEF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CCEF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CCF3C  3D 60 80 4D */	lis r11, lit_3970@ha /* 0x804CE470@ha */
/* 804CCF40  C0 2B E4 70 */	lfs f1, lit_3970@l(r11)  /* 0x804CE470@l */
/* 804CCF44  4B B7 FB 4D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_804CCF48:
