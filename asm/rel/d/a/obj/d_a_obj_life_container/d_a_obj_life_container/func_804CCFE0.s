...
/* 804CCFF0  4B E9 51 E9 */	bl _savegpr_28
...
/* 804CD014  4B B4 BB 51 */	bl __ct__10fopAc_ac_cFv
/* 804CD018  3C 60 80 3B */	lis r3, __vt__12daItemBase_c@ha /* 0x803B3610@ha */
/* 804CD01C  38 03 36 10 */	addi r0, r3, __vt__12daItemBase_c@l /* 0x803B3610@l */
/* 804CD020  90 1D 05 68 */	stw r0, 0x568(r29)
/* 804CD024  3B 9D 05 8C */	addi r28, r29, 0x58c
/* 804CD028  7F 83 E3 78 */	mr r3, r28
/* 804CD02C  4B BA 90 75 */	bl __ct__9dBgS_AcchFv
/* 804CD030  3C 60 80 4D */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x804CE62C@ha */
/* 804CD034  38 63 E6 2C */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x804CE62C@l */
...
/* 804CD050  4B BA BE 19 */	bl SetObj__16dBgS_PolyPassChkFv
/* 804CD054  38 7D 07 64 */	addi r3, r29, 0x764
/* 804CD058  4B BA 8E 55 */	bl __ct__12dBgS_AcchCirFv
/* 804CD05C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 804CD060  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 804CD064  90 1D 07 BC */	stw r0, 0x7bc(r29)
/* 804CD068  38 7D 07 C0 */	addi r3, r29, 0x7c0
/* 804CD06C  4B BB 66 F5 */	bl __ct__10dCcD_GSttsFv
/* 804CD070  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 804CD074  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 804CD08C  4B BB 69 9D */	bl __ct__12dCcD_GObjInfFv
/* 804CD090  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 804CD094  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 804CD098  90 1C 01 20 */	stw r0, 0x120(r28)
/* 804CD09C  3C 60 80 4D */	lis r3, __vt__8cM3dGAab@ha /* 0x804CE620@ha */
/* 804CD0A0  38 03 E6 20 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x804CE620@l */
/* 804CD0A4  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 804CD0A8  3C 60 80 4D */	lis r3, __vt__8cM3dGCyl@ha /* 0x804CE614@ha */
/* 804CD0AC  38 03 E6 14 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x804CE614@l */
/* 804CD0B0  90 1C 01 38 */	stw r0, 0x138(r28)
/* 804CD0B4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 804CD0B8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 804CD0BC  90 7C 01 20 */	stw r3, 0x120(r28)
/* 804CD0C0  38 03 00 58 */	addi r0, r3, 0x58
/* 804CD0C4  90 1C 01 38 */	stw r0, 0x138(r28)
/* 804CD0C8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 804CD0CC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 804CD0E4  3C 60 80 4D */	lis r3, __vt__11daObjLife_c@ha /* 0x804CE650@ha */
/* 804CD0E8  38 03 E6 50 */	addi r0, r3, __vt__11daObjLife_c@l /* 0x804CE650@l */
...
/* 804CD17C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CD180  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CD194  4B B6 83 FD */	bl isItem__10dSv_info_cCFii
...
/* 804CD1B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CD1B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804CD1BC  38 63 09 58 */	addi r3, r3, 0x958
/* 804CD1C0  38 80 00 04 */	li r4, 4
/* 804CD1C4  4B B6 77 71 */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 804CD1E0  3C 60 80 3B */	lis r3, field_item_res__10dItem_data@ha /* 0x803ADD88@ha */
/* 804CD1E4  38 63 DD 88 */	addi r3, r3, field_item_res__10dItem_data@l /* 0x803ADD88@l */
/* 804CD1E8  7C 83 00 2E */	lwzx r4, r3, r0
/* 804CD1EC  38 7F 05 6C */	addi r3, r31, 0x56c
/* 804CD1F0  4B B5 FC CD */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 804CD204  3C 80 80 03 */	lis r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@ha /* 0x80037B78@ha */
/* 804CD208  38 84 7B 78 */	addi r4, r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@l /* 0x80037B78@l */
/* 804CD20C  38 A0 40 00 */	li r5, 0x4000
/* 804CD210  4B B4 D2 A1 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 804CD244  4B E9 4F E1 */	bl _restgpr_28
