...
/* 80BF50EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF50F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BF50F4  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BF50F8  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 80BF50FC  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80BF5100  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80BF5104  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BF5108  4B 43 F8 B5 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80BF5120  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF5124  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BF5128  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BF512C  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 80BF5130  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80BF5134  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80BF5138  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BF513C  4B 43 F8 81 */	bl isEventBit__11dSv_event_cCFUs
