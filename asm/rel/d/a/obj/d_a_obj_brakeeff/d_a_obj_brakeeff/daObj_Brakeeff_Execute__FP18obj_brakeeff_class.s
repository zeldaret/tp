...
/* 8046E004  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8046E008  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8046E00C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 8046E010  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 8046E014  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 8046E018  4B ED 88 D1 */	bl PSMTXTrans
/* 8046E01C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8046E020  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8046E024  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8046E028  4B B9 E4 0D */	bl mDoMtx_YrotM__FPA4_fs
/* 8046E02C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8046E030  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8046E034  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 8046E038  4B B9 E3 65 */	bl mDoMtx_XrotM__FPA4_fs
/* 8046E03C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8046E040  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8046E044  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 8046E048  4B B9 E4 85 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8046E04C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8046E050  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8046E054  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 8046E058  38 84 00 24 */	addi r4, r4, 0x24
/* 8046E05C  4B ED 84 55 */	bl PSMTXCopy
/* 8046E060  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8046E064  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8046E068  38 9F 07 08 */	addi r4, r31, 0x708
/* 8046E06C  4B ED 84 45 */	bl PSMTXCopy
/* 8046E070  80 7F 07 38 */	lwz r3, 0x738(r31)
/* 8046E074  4B C0 D9 4D */	bl Move__4dBgWFv
/* 8046E078  80 7F 05 78 */	lwz r3, 0x578(r31)
/* 8046E07C  4B B9 F3 AD */	bl play__14mDoExt_baseAnmFv
