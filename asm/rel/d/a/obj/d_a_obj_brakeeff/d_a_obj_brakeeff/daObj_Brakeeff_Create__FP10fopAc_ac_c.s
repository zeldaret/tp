...
/* 8046E328  4B BA A8 3D */	bl __ct__10fopAc_ac_cFv
/* 8046E32C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 8046E330  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 8046E334  90 1E 05 A0 */	stw r0, 0x5a0(r30)
/* 8046E338  38 7E 05 A4 */	addi r3, r30, 0x5a4
/* 8046E33C  4B C1 54 25 */	bl __ct__10dCcD_GSttsFv
/* 8046E340  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 8046E344  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 8046E35C  4B C1 56 CD */	bl __ct__12dCcD_GObjInfFv
/* 8046E360  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8046E364  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8046E368  90 1E 01 20 */	stw r0, 0x120(r30)
/* 8046E36C  3C 60 80 47 */	lis r3, __vt__8cM3dGAab@ha /* 0x8046E5F8@ha */
/* 8046E370  38 03 E5 F8 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8046E5F8@l */
/* 8046E374  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 8046E378  3C 60 80 47 */	lis r3, __vt__8cM3dGSph@ha /* 0x8046E5EC@ha */
/* 8046E37C  38 03 E5 EC */	addi r0, r3, __vt__8cM3dGSph@l /* 0x8046E5EC@l */
/* 8046E380  90 1E 01 34 */	stw r0, 0x134(r30)
/* 8046E384  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 8046E388  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 8046E38C  90 7E 01 20 */	stw r3, 0x120(r30)
/* 8046E390  38 03 00 58 */	addi r0, r3, 0x58
/* 8046E394  90 1E 01 34 */	stw r0, 0x134(r30)
/* 8046E398  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 8046E39C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 8046E3C4  3C 80 80 47 */	lis r4, d_a_obj_brakeeff__stringBase0@ha /* 0x8046E538@ha */
/* 8046E3C8  38 84 E5 38 */	addi r4, r4, d_a_obj_brakeeff__stringBase0@l /* 0x8046E538@l */
/* 8046E3CC  4B BB EA F1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8046E3E8  3C 80 80 47 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x8046E0F0@ha */
/* 8046E3EC  38 84 E0 F0 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x8046E0F0@l */
/* 8046E3F0  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 8046E3F4  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 8046E3F8  4B BA C0 B9 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_8046E40C:
/* 8046E40C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8046E410  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8046E414  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8046E418  80 9F 07 38 */	lwz r4, 0x738(r31)
/* 8046E41C  7F E5 FB 78 */	mr r5, r31
/* 8046E420  4B C0 65 E9 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 8046E450  4B C1 54 11 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 8046E454  38 7F 05 C4 */	addi r3, r31, 0x5c4
/* 8046E458  3C 80 80 47 */	lis r4, cc_sph_src@ha /* 0x8046E55C@ha */
/* 8046E45C  38 84 E5 5C */	addi r4, r4, cc_sph_src@l /* 0x8046E55C@l */
/* 8046E460  4B C1 65 D5 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
