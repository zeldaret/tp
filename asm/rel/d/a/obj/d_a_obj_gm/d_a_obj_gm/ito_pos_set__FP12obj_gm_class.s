...
/* 80BFB428  4B 76 6D A9 */	bl _savegpr_26
/* 80BFB42C  7C 7F 1B 78 */	mr r31, r3
/* 80BFB430  3C 60 80 C0 */	lis r3, lit_3686@ha /* 0x80BFD32C@ha */
/* 80BFB434  3B A3 D3 2C */	addi r29, r3, lit_3686@l /* 0x80BFD32C@l */
...
/* 80BFB44C  3C 60 80 C0 */	lis r3, obj_size_maji@ha /* 0x80BFD45C@ha */
/* 80BFB450  38 63 D4 5C */	addi r3, r3, obj_size_maji@l /* 0x80BFD45C@l */
/* 80BFB454  7C 03 04 2E */	lfsx f0, r3, r0
/* 80BFB458  EC 01 00 32 */	fmuls f0, f1, f0
/* 80BFB45C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80BFB460  4B 67 5A BD */	bl MtxPush__Fv
/* 80BFB464  3B 40 00 00 */	li r26, 0
/* 80BFB468  3B C0 00 00 */	li r30, 0
/* 80BFB46C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80BFB470  3B 83 07 68 */	addi r28, r3, calc_mtx@l /* 0x80450768@l */
/* 80BFB474  C3 FD 00 1C */	lfs f31, 0x1c(r29)
/* 80BFB478  3C 60 80 C0 */	lis r3, obj_size@ha /* 0x80BFD3E8@ha */
/* 80BFB47C  3B A3 D3 E8 */	addi r29, r3, obj_size@l /* 0x80BFD3E8@l */
lbl_80BFB480:
/* 80BFB480  80 7C 00 00 */	lwz r3, 0(r28)
/* 80BFB484  38 80 2A AA */	li r4, 0x2aaa
/* 80BFB488  4B 41 0F AD */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80BFB4AC  4B 67 5A 41 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80BFB4D0  4B 67 5A 1D */	bl MtxPosition__FP4cXyzP4cXyz
