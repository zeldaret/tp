...
/* 80BFCB88  3C 60 80 C0 */	lis r3, d_a_obj_gm__stringBase0@ha /* 0x80BFD3C0@ha */
/* 80BFCB8C  38 63 D3 C0 */	addi r3, r3, d_a_obj_gm__stringBase0@l /* 0x80BFD3C0@l */
/* 80BFCB90  88 1F 05 70 */	lbz r0, 0x570(r31)
/* 80BFCB94  54 00 10 3A */	slwi r0, r0, 2
/* 80BFCB98  3C 80 80 C0 */	lis r4, gm_obj_bmd@ha /* 0x80BFD478@ha */
/* 80BFCB9C  38 84 D4 78 */	addi r4, r4, gm_obj_bmd@l /* 0x80BFD478@l */
/* 80BFCBA0  7C 84 00 2E */	lwzx r4, r4, r0
/* 80BFCBA4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BFCBA8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BFCBAC  3C A5 00 02 */	addis r5, r5, 2
/* 80BFCBB0  38 C0 00 80 */	li r6, 0x80
/* 80BFCBB4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BFCBB8  4B 43 F7 35 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BFCBC8  4B 41 80 8D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
