...
/* 80BFC674  4B 76 5B 69 */	bl _savegpr_29
/* 80BFC678  7C 7F 1B 78 */	mr r31, r3
/* 80BFC67C  3C 80 80 C0 */	lis r4, lit_3686@ha /* 0x80BFD32C@ha */
/* 80BFC680  3B C4 D3 2C */	addi r30, r4, lit_3686@l /* 0x80BFD32C@l */
...
/* 80BFC6DC  3C 60 80 C0 */	lis r3, neg@ha /* 0x80BFD44C@ha */
/* 80BFC6E0  38 63 D4 4C */	addi r3, r3, neg@l /* 0x80BFD44C@l */
/* 80BFC6E4  7C 03 02 AE */	lhax r0, r3, r0
/* 80BFC6E8  7C 04 01 D6 */	mullw r0, r4, r0
/* 80BFC6EC  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80BFC6F0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BFC6F4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80BFC720  4B 67 33 1D */	bl cLib_addCalc2__FPffff
...
/* 80BFC734  4B 67 3E D5 */	bl cLib_addCalcAngleS2__FPssss
lbl_80BFC738:
/* 80BFC738  38 7F 09 88 */	addi r3, r31, 0x988
/* 80BFC73C  4B 48 7D 25 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 80BFC760  4B 48 7D 99 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 80BFC774  4B 48 AD A1 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
lbl_80BFC778:
/* 80BFC778  38 7F 09 88 */	addi r3, r31, 0x988
/* 80BFC77C  4B 48 7D 7D */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 80BFC780  4B 66 72 C9 */	bl GetAc__8cCcD_ObjFv
...
/* 80BFC7BC  4B 76 5A 6D */	bl _restgpr_29
