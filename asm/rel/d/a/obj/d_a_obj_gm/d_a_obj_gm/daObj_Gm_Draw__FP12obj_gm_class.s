...
/* 80BFB184  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BFB188  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BFB18C  38 80 00 10 */	li r4, 0x10
/* 80BFB190  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80BFB194  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80BFB198  4B 5A 86 2D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BFB19C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BFB1A0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BFB1A4  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80BFB1A8  80 84 00 04 */	lwz r4, 4(r4)
/* 80BFB1AC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80BFB1B0  4B 5A 9B F1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BFB1B4  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80BFB1B8  4B 41 2B 0D */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80BFB1D8  3C 80 80 C0 */	lis r4, obj_size@ha /* 0x80BFD3E8@ha */
/* 80BFB1DC  38 84 D3 E8 */	addi r4, r4, obj_size@l /* 0x80BFD3E8@l */
/* 80BFB1E0  7C 44 04 2E */	lfsx f2, r4, r0
/* 80BFB1E4  38 9F 08 60 */	addi r4, r31, 0x860
/* 80BFB1E8  38 A0 00 00 */	li r5, 0
/* 80BFB1EC  3C C0 80 C0 */	lis r6, lit_3686@ha /* 0x80BFD32C@ha */
/* 80BFB1F0  C0 66 D3 2C */	lfs f3, lit_3686@l(r6)  /* 0x80BFD32C@l */
/* 80BFB1F4  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80BFB1F8  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80BFB1FC  4B 43 1E B9 */	bl dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80BFB200:
