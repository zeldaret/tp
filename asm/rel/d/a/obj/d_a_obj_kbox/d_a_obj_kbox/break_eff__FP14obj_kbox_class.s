...
/* 80C3D75C  4B 72 4A 79 */	bl _savegpr_27
...
/* 80C3D77C  3C 60 80 C4 */	lis r3, lit_3704@ha /* 0x80C3F070@ha */
/* 80C3D780  C0 03 F0 70 */	lfs f0, lit_3704@l(r3)  /* 0x80C3F070@l */
/* 80C3D784  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80C3D788  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80C3D78C  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80C3D790  3C 60 80 C4 */	lis r3, d_a_obj_kbox__stringBase0@ha /* 0x80C3F108@ha */
/* 80C3D794  38 63 F1 08 */	addi r3, r3, d_a_obj_kbox__stringBase0@l /* 0x80C3F108@l */
/* 80C3D798  38 83 00 07 */	addi r4, r3, 7
/* 80C3D79C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3D7A0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3D7A4  3C A5 00 02 */	addis r5, r5, 2
/* 80C3D7A8  38 C0 00 80 */	li r6, 0x80
/* 80C3D7AC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C3D7B0  4B 3F EB CD */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80C3D7B4  7C 7C 1B 78 */	mr r28, r3
/* 80C3D7B8  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C3D7BC  7C 05 07 74 */	extsb r5, r0
/* 80C3D7C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3D7C4  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C3D7C8  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)
/* 80C3D7CC  3C 80 80 45 */	lis r4, mEcallback__18dPa_modelEcallBack@ha /* 0x80450E90@ha */
/* 80C3D7D0  38 04 0E 90 */	addi r0, r4, mEcallback__18dPa_modelEcallBack@l /* 0x80450E90@l */
...
/* 80C3D810  3D 60 80 C4 */	lis r11, lit_3704@ha /* 0x80C3F070@ha */
/* 80C3D814  C0 2B F0 70 */	lfs f1, lit_3704@l(r11)  /* 0x80C3F070@l */
/* 80C3D818  4B 40 F2 79 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C3D834  4B 40 D3 CD */	bl setModel__18dPa_modelEcallBackFP14JPABaseEmitterP12J3DModelDataRC12dKy_tevstr_cUcPvUcUc
/* 80C3D838  3B 60 00 00 */	li r27, 0
/* 80C3D83C  3B C0 00 00 */	li r30, 0
/* 80C3D840  3C 60 80 C4 */	lis r3, particle_id@ha /* 0x80C3F068@ha */
/* 80C3D844  3B 83 F0 68 */	addi r28, r3, particle_id@l /* 0x80C3F068@l */
/* 80C3D848  3C 60 80 C4 */	lis r3, lit_3704@ha /* 0x80C3F070@ha */
/* 80C3D84C  3B A3 F0 70 */	addi r29, r3, lit_3704@l /* 0x80C3F070@l */
lbl_80C3D850:
...
/* 80C3D890  4B 40 F2 01 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C3D8A8  4B 72 49 79 */	bl _restgpr_27
