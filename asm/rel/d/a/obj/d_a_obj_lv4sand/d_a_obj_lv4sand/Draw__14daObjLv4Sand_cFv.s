...
/* 80C6A0E8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C6A0EC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C6A0F0  38 80 00 10 */	li r4, 0x10
/* 80C6A0F4  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C6A0F8  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C6A0FC  4B 53 96 C9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C6A100  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C6A104  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C6A108  80 9E 05 B8 */	lwz r4, 0x5b8(r30)
/* 80C6A10C  80 84 00 04 */	lwz r4, 4(r4)
/* 80C6A110  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C6A114  4B 53 AC 8D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C6A12C  4B 3A 35 AD */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80C6A130  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C6A134  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C6A138  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C6A13C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C6A140  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C6A154  4B 3A 3B 71 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C6A158  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C6A15C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
