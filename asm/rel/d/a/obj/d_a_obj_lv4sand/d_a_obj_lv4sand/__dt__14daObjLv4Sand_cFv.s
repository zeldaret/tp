...
/* 80C6A32C  3C 60 80 C7 */	lis r3, __vt__14daObjLv4Sand_c@ha
/* 80C6A330  38 63 A4 C0 */	addi r3, r3, __vt__14daObjLv4Sand_c@l
...
/* 80C6A348  3C 60 80 C7 */	lis r3, __vt__17dEvLib_callback_c@ha
/* 80C6A34C  38 03 A4 9C */	addi r0, r3, __vt__17dEvLib_callback_c@l
/* 80C6A350  90 1E 05 A0 */	stw r0, 0x5a0(r30)
lbl_80C6A354:
/* 80C6A354  28 1E 00 00 */	cmplwi r30, 0
/* 80C6A358  41 82 00 1C */	beq lbl_80C6A374
/* 80C6A35C  3C 60 80 3B */	lis r3, __vt__16dBgS_MoveBgActor@ha
/* 80C6A360  38 03 B9 A0 */	addi r0, r3, __vt__16dBgS_MoveBgActor@l
/* 80C6A364  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C6A368  7F C3 F3 78 */	mr r3, r30
/* 80C6A36C  38 80 00 00 */	li r4, 0
/* 80C6A370  4B 3A E9 1C */	b __dt__10fopAc_ac_cFv
lbl_80C6A374:
/* 80C6A374  7F E0 07 35 */	extsh. r0, r31
/* 80C6A378  40 81 00 0C */	ble lbl_80C6A384
/* 80C6A37C  7F C3 F3 78 */	mr r3, r30
/* 80C6A380  4B 66 49 BC */	b __dl__FPv
lbl_80C6A384:
