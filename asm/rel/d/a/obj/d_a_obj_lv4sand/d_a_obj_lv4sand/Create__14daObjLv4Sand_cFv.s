...
/* 80C69B64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C69B68  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C69B7C  4B 3C B7 E5 */	bl isSwitch__10dSv_info_cCFii
/* 80C69B80  2C 03 00 00 */	cmpwi r3, 0
/* 80C69B84  40 82 00 20 */	bne lbl_80C69BA4
/* 80C69B88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C69B8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C69B90  38 63 09 58 */	addi r3, r3, 0x958
/* 80C69B94  38 80 00 03 */	li r4, 3
/* 80C69B98  4B 3C AD 9D */	bl isDungeonItem__12dSv_memBit_cCFi
/* 80C69B9C  2C 03 00 00 */	cmpwi r3, 0
/* 80C69BA0  41 82 00 38 */	beq lbl_80C69BD8
lbl_80C69BA4:
/* 80C69BA4  3C 60 80 C7 */	lis r3, lit_3679@ha /* 0x80C6A3B8@ha */
/* 80C69BA8  C0 03 A3 B8 */	lfs f0, lit_3679@l(r3)  /* 0x80C6A3B8@l */
...
/* 80C69BB8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C69BBC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C69BD0  4B 3C B6 31 */	bl onSwitch__10dSv_info_cFii
/* 80C69BD4  48 00 00 18 */	b lbl_80C69BEC
lbl_80C69BD8:
/* 80C69BD8  3C 60 80 C7 */	lis r3, lit_3680@ha /* 0x80C6A3BC@ha */
/* 80C69BDC  C0 03 A3 BC */	lfs f0, lit_3680@l(r3)  /* 0x80C6A3BC@l */
...
/* 80C69C0C  4B 3B 09 6D */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
