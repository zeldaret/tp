...
/* 80C69E20  4B 6F 83 BD */	bl _savegpr_29
/* 80C69E24  7C 7D 1B 78 */	mr r29, r3
/* 80C69E28  7C 9E 23 78 */	mr r30, r4
/* 80C69E2C  3C 80 80 C7 */	lis r4, lit_3679@ha /* 0x80C6A3B8@ha */
/* 80C69E30  3B E4 A3 B8 */	addi r31, r4, lit_3679@l /* 0x80C6A3B8@l */
...
/* 80C69E40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C69E44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C69E48  38 80 00 EA */	li r4, 0xea
/* 80C69E4C  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 80C69E50  7C 05 07 74 */	extsb r5, r0
/* 80C69E54  4B 3C B5 0D */	bl isSwitch__10dSv_info_cCFii
/* 80C69E58  2C 03 00 00 */	cmpwi r3, 0
/* 80C69E5C  41 82 00 98 */	beq lbl_80C69EF4
/* 80C69E60  80 7D 05 BC */	lwz r3, 0x5bc(r29)
/* 80C69E64  4B 3A 35 C5 */	bl play__14mDoExt_baseAnmFv
...
/* 80C69EB0  4B 3C 31 BD */	bl dComIfGp_getReverb__Fi
...
/* 80C69EC4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C69EC8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C69EF0  4B 64 26 1D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C69EF4:
...
/* 80C69F04  4B 6F 83 25 */	bl _restgpr_29
