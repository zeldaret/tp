...
/* 80C71B18  3C 60 80 C7 */	lis r3, lit_3664@ha /* 0x80C72184@ha */
/* 80C71B1C  C0 03 21 84 */	lfs f0, lit_3664@l(r3)  /* 0x80C72184@l */
/* 80C71B20  D0 01 00 2C */	stfs f0, 0x2c(r1)
/* 80C71B24  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80C71B28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C71B2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C71B30  38 80 00 00 */	li r4, 0
/* 80C71B34  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C71B38  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C71B3C  4B 39 A6 CD */	bl mDoMtx_ZXYrotS__FPA4_fsss
/* 80C71B40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C71B44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C71B48  38 81 00 28 */	addi r4, r1, 0x28
/* 80C71B4C  7C 85 23 78 */	mr r5, r4
/* 80C71B50  4B 6D 52 1D */	bl PSMTXMultVec
/* 80C71B54  38 61 00 28 */	addi r3, r1, 0x28
/* 80C71B58  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C71B5C  7C 65 1B 78 */	mr r5, r3
/* 80C71B60  4B 6D 55 31 */	bl PSVECAdd
...
/* 80C71B7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C71B80  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C71BC0  3D 60 80 C7 */	lis r11, lit_3922@ha /* 0x80C72198@ha */
/* 80C71BC4  C0 2B 21 98 */	lfs f1, lit_3922@l(r11)  /* 0x80C72198@l */
/* 80C71BC8  4B 3D AE C9 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C71C0C  3D 60 80 C7 */	lis r11, lit_3922@ha /* 0x80C72198@ha */
/* 80C71C10  C0 2B 21 98 */	lfs f1, lit_3922@l(r11)  /* 0x80C72198@l */
/* 80C71C14  4B 3D AE 7D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C71C58  3D 60 80 C7 */	lis r11, lit_3922@ha /* 0x80C72198@ha */
/* 80C71C5C  C0 2B 21 98 */	lfs f1, lit_3922@l(r11)  /* 0x80C72198@l */
/* 80C71C60  4B 3D AE 31 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C71CA4  3D 60 80 C7 */	lis r11, lit_3922@ha /* 0x80C72198@ha */
/* 80C71CA8  C0 2B 21 98 */	lfs f1, lit_3922@l(r11)  /* 0x80C72198@l */
/* 80C71CAC  4B 3D AD E5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C71CF0  3D 60 80 C7 */	lis r11, lit_3922@ha /* 0x80C72198@ha */
/* 80C71CF4  C0 2B 21 98 */	lfs f1, lit_3922@l(r11)  /* 0x80C72198@l */
/* 80C71CF8  4B 3D AD 99 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C71D0C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C71D10  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C71D14  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C71D18  7C 05 07 74 */	extsb r5, r0
/* 80C71D1C  4B 3C 34 E5 */	bl onSwitch__10dSv_info_cFii
lbl_80C71D20:
/* 80C71D20  7F C3 F3 78 */	mr r3, r30
/* 80C71D24  4B 3A 7F 59 */	bl fopAcM_delete__FP10fopAc_ac_c
