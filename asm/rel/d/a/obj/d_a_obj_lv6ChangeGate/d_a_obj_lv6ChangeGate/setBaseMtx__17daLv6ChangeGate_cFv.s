...
/* 80C70D4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C70D50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C70D54  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C70D58  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C70D5C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C70D60  4B 6D 5B 89 */	bl PSMTXTrans
/* 80C70D64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C70D68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C70D6C  38 80 00 00 */	li r4, 0
/* 80C70D70  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C70D74  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C70D78  4B 39 B5 29 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 80C70D7C  C0 3F 14 D8 */	lfs f1, 0x14d8(r31)
/* 80C70D80  3C 60 80 C7 */	lis r3, lit_3664@ha /* 0x80C72184@ha */
/* 80C70D84  C0 43 21 84 */	lfs f2, lit_3664@l(r3)  /* 0x80C72184@l */
/* 80C70D88  FC 60 10 90 */	fmr f3, f2
/* 80C70D8C  4B 39 C0 11 */	bl transM__14mDoMtx_stack_cFfff
...
/* 80C70DAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C70DB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C70DB4  80 9F 05 C0 */	lwz r4, 0x5c0(r31)
/* 80C70DB8  38 84 00 24 */	addi r4, r4, 0x24
/* 80C70DBC  4B 6D 56 F5 */	bl PSMTXCopy
