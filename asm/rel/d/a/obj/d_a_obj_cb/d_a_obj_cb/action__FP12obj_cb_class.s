...
/* 80BC4BCC  4B 79 D6 11 */	bl _savegpr_29
/* 80BC4BD0  7C 7E 1B 78 */	mr r30, r3
/* 80BC4BD4  3C 80 80 BC */	lis r4, lit_3882@ha /* 0x80BC57E4@ha */
/* 80BC4BD8  3B E4 57 E4 */	addi r31, r4, lit_3882@l /* 0x80BC57E4@l */
...
/* 80BC4C34  4B 6A 1F 01 */	bl __mi__4cXyzCFRC3Vec
/* 80BC4C38  38 61 00 14 */	addi r3, r1, 0x14
/* 80BC4C3C  4B 78 24 FD */	bl PSVECSquareMag
...
/* 80BC4CAC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BC4CB0  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BC4D1C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BC4D20  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BC4D44  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80BC4D48  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80BC4D4C  80 63 00 00 */	lwz r3, 0(r3)
/* 80BC4D50  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80BC4D54  4B 44 76 89 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80BC4DA4  4B 6A B8 65 */	bl cLib_addCalcAngleS2__FPssss
lbl_80BC4DA8:
...
/* 80BC4DB8  4B 6A AC 85 */	bl cLib_addCalc2__FPffff
...
/* 80BC4DEC  4B 6A C1 01 */	bl MtxPosition__FP4cXyzP4cXyz
/* 80BC4DF0  38 00 09 00 */	li r0, 0x900
/* 80BC4DF4  B0 1E 05 A0 */	sth r0, 0x5a0(r30)
/* 80BC4DF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC4DFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BC4E00  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80BC4E04  80 9E 07 F8 */	lwz r4, 0x7f8(r30)
/* 80BC4E08  4B 4A F4 49 */	bl Release__4cBgSFP9dBgW_Base
...
/* 80BC4E20  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BC4E24  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BC4E50  4B 6E 6B 35 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80BC4E70  4B 6A B7 99 */	bl cLib_addCalcAngleS2__FPssss
/* 80BC4E74  48 00 02 80 */	b lbl_80BC50F4
lbl_80BC4E78:
/* 80BC4E78  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC4E7C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BC4E80  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80BC4E84  4B 45 5A E1 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80BC4E88  C0 1F 00 38 */	lfs f0, 0x38(r31)
/* 80BC4E8C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80BC4E90  40 80 02 64 */	bge lbl_80BC50F4
/* 80BC4E94  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80BC4E98  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80BC4E9C  80 63 00 00 */	lwz r3, 0(r3)
/* 80BC4EA0  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80BC4EA4  4B 44 75 39 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80BC4ECC  4B 6A C0 21 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80BC4EEC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80BC4EF0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80BC4F1C  4B 6E 6A 69 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80BC4F30  4B 78 21 61 */	bl PSVECAdd
...
/* 80BC4F6C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BC4F70  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BC4F74  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80BC4F78  4B 4B 1B 35 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80BC4FA8  4B 6A 29 E5 */	bl cM_rndFX__Ff
...
/* 80BC4FC0  4B 6A 29 CD */	bl cM_rndFX__Ff
...
/* 80BC4FD8  4B 6A 29 B5 */	bl cM_rndFX__Ff
...
/* 80BC4FF4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80BC4FF8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80BC4FFC  80 63 00 00 */	lwz r3, 0(r3)
/* 80BC5000  4B 44 73 DD */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80BC5014  4B 6A 29 41 */	bl cM_rndF__Ff
...
/* 80BC502C  4B 6A BE C1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80BC5058  4B 45 7F C9 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 80BC5080  4B 6A B5 89 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80BC5094  4B 6A B5 75 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80BC50F0  4B 6A A9 4D */	bl cLib_addCalc2__FPffff
lbl_80BC50F4:
/* 80BC50F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC50F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC50FC  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80BC5100  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80BC5104  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80BC5108  4B 78 17 E1 */	bl PSMTXTrans
/* 80BC510C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC5110  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC5114  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80BC5118  4B 44 73 1D */	bl mDoMtx_YrotM__FPA4_fs
/* 80BC511C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC5120  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC5124  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80BC5128  4B 44 72 75 */	bl mDoMtx_XrotM__FPA4_fs
/* 80BC512C  C0 3F 00 00 */	lfs f1, 0(r31)
/* 80BC5130  C0 5E 05 A8 */	lfs f2, 0x5a8(r30)
/* 80BC5134  FC 60 08 90 */	fmr f3, f1
/* 80BC5138  4B 44 7C 65 */	bl transM__14mDoMtx_stack_cFfff
/* 80BC513C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC5140  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC5144  7F A4 07 34 */	extsh r4, r29
/* 80BC5148  4B 44 72 55 */	bl mDoMtx_XrotM__FPA4_fs
/* 80BC514C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC5150  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC5154  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80BC5158  38 84 00 24 */	addi r4, r4, 0x24
/* 80BC515C  4B 78 13 55 */	bl PSMTXCopy
/* 80BC5160  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC5164  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC5168  7C 1D 00 D0 */	neg r0, r29
/* 80BC516C  7C 04 07 34 */	extsh r4, r0
/* 80BC5170  4B 44 72 2D */	bl mDoMtx_XrotM__FPA4_fs
/* 80BC5174  80 1E 07 F8 */	lwz r0, 0x7f8(r30)
/* 80BC5178  28 00 00 00 */	cmplwi r0, 0
/* 80BC517C  41 82 00 1C */	beq lbl_80BC5198
/* 80BC5180  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80BC5184  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80BC5188  38 9E 07 C8 */	addi r4, r30, 0x7c8
/* 80BC518C  4B 78 13 25 */	bl PSMTXCopy
/* 80BC5190  80 7E 07 F8 */	lwz r3, 0x7f8(r30)
/* 80BC5194  4B 4B 68 2D */	bl Move__4dBgWFv
lbl_80BC5198:
/* 80BC5198  E3 E1 00 68 */	psq_l f31, 104(r1), 0, 0 /* qr0 */
/* 80BC519C  CB E1 00 60 */	lfd f31, 0x60(r1)
/* 80BC51A0  39 61 00 60 */	addi r11, r1, 0x60
/* 80BC51A4  4B 79 D0 85 */	bl _restgpr_29
