...
/* 80D1D8E0  4B 64 48 ED */	bl _savegpr_25
/* 80D1D8E4  7C 7F 1B 78 */	mr r31, r3
/* 80D1D8E8  3C 80 80 D2 */	lis r4, lit_3879@ha /* 0x80D1EE2C@ha */
/* 80D1D8EC  3B C4 EE 2C */	addi r30, r4, lit_3879@l /* 0x80D1EE2C@l */
/* 80D1D8F0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1D8F4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D1D908  4B 2F C3 75 */	bl fopAcM_delete__FP10fopAc_ac_c
...
lbl_80D1D968:
/* 80D1D968  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1D96C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1D970  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80D1D974  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80D1D978  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80D1D97C  4B 62 8F 6D */	bl PSMTXTrans
/* 80D1D980  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1D984  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1D988  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80D1D98C  4B 2E EA A9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D1D990  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1D994  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1D998  38 9A 00 24 */	addi r4, r26, 0x24
/* 80D1D99C  4B 62 8B 15 */	bl PSMTXCopy
/* 80D1D9A0  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80D1D9A4  7C 03 07 74 */	extsb r3, r0
/* 80D1D9A8  4B 30 F6 C5 */	bl dComIfGp_getReverb__Fi
...
/* 80D1D9BC  4B 2F 2C 0D */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 80D1D9C0  80 7F 05 70 */	lwz r3, 0x570(r31)
/* 80D1D9C4  4B 2F 2C E9 */	bl modelCalc__14mDoExt_McaMorfFv
...
/* 80D1D9DC  3C 60 80 D2 */	lis r3, lit_4263@ha /* 0x80D1EEC0@ha */
/* 80D1D9E0  38 63 EE C0 */	addi r3, r3, lit_4263@l /* 0x80D1EEC0@l */
...
/* 80D1DA64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1DA68  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D1DA6C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80D1DA70  7C 05 07 74 */	extsb r5, r0
/* 80D1DA74  4B 31 78 ED */	bl isSwitch__10dSv_info_cCFii
/* 80D1DA78  2C 03 00 00 */	cmpwi r3, 0
/* 80D1DA7C  40 82 04 90 */	bne lbl_80D1DF0C
lbl_80D1DA80:
/* 80D1DA80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1DA84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D1DA88  88 9F 05 96 */	lbz r4, 0x596(r31)
/* 80D1DA8C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80D1DA90  7C 05 07 74 */	extsb r5, r0
/* 80D1DA94  4B 31 78 CD */	bl isSwitch__10dSv_info_cCFii
/* 80D1DA98  2C 03 00 00 */	cmpwi r3, 0
/* 80D1DA9C  41 82 04 70 */	beq lbl_80D1DF0C
/* 80D1DAA0  C0 3E 00 10 */	lfs f1, 0x10(r30)
/* 80D1DAA4  4B 54 9E B1 */	bl cM_rndF__Ff
...
/* 80D1DB78  4B 60 A8 B5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80D1DB90  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D1DB94  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D1DBC0  4B 58 DD C5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D1DBD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1DBDC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D1DBF0  4B 35 1E 35 */	bl StartShock__12dVibration_cFii4cXyz
lbl_80D1DBF4:
...
/* 80D1DC48  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D1DC4C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D1DC78  4B 58 DD 0D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D1DC9C  4B 2E F7 8D */	bl play__14mDoExt_baseAnmFv
lbl_80D1DCA0:
/* 80D1DCA0  88 9F 05 97 */	lbz r4, 0x597(r31)
/* 80D1DCA4  28 04 00 FF */	cmplwi r4, 0xff
/* 80D1DCA8  41 82 00 20 */	beq lbl_80D1DCC8
/* 80D1DCAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1DCB0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D1DCB4  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80D1DCB8  7C 05 07 74 */	extsb r5, r0
/* 80D1DCBC  4B 31 76 A5 */	bl isSwitch__10dSv_info_cCFii
/* 80D1DCC0  2C 03 00 00 */	cmpwi r3, 0
/* 80D1DCC4  40 82 00 24 */	bne lbl_80D1DCE8
lbl_80D1DCC8:
/* 80D1DCC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1DCCC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D1DCD0  88 9F 05 96 */	lbz r4, 0x596(r31)
/* 80D1DCD4  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80D1DCD8  7C 05 07 74 */	extsb r5, r0
/* 80D1DCDC  4B 31 76 85 */	bl isSwitch__10dSv_info_cCFii
...
/* 80D1DD80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1DD84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D1DDCC  4B 32 EC C5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D1DDDC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D1DDE0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D1DE0C  4B 58 DB 79 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D1DE40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1DE44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D1DE8C  4B 32 EC 05 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D1DE9C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D1DEA0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D1DECC  4B 58 DA B9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
lbl_80D1DF0C:
/* 80D1DF0C  3C 60 80 D2 */	lis r3, s_tp_sub__FPvPv@ha /* 0x80D1D850@ha */
/* 80D1DF10  38 63 D8 50 */	addi r3, r3, s_tp_sub__FPvPv@l /* 0x80D1D850@l */
/* 80D1DF14  7F E4 FB 78 */	mr r4, r31
/* 80D1DF18  4B 30 34 21 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80D1DF48  4B 54 8B ED */	bl __mi__4cXyzCFRC3Vec
...
/* 80D1DF68  4B 62 91 D1 */	bl PSVECSquareMag
...
/* 80D1DFD8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D1DFDC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80D1E048  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D1E04C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80D1E050:
...
/* 80D1E060  4B 54 96 15 */	bl cM_atan2s__Fff
...
/* 80D1E094  4B 54 95 E1 */	bl cM_atan2s__Fff
...
lbl_80D1E0D8:
/* 80D1E0D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E0DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E0E0  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80D1E0E4  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80D1E0E8  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80D1E0EC  4B 62 87 FD */	bl PSMTXTrans
/* 80D1E0F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E0F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E0F8  7F 64 DB 78 */	mr r4, r27
/* 80D1E0FC  4B 2E E3 39 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D1E100  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E104  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E108  7F 44 D3 78 */	mr r4, r26
/* 80D1E10C  4B 2E E2 91 */	bl mDoMtx_XrotM__FPA4_fs
/* 80D1E110  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80D1E114  FC 40 08 90 */	fmr f2, f1
/* 80D1E118  FC 60 F8 90 */	fmr f3, f31
/* 80D1E11C  4B 2E ED 1D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80D1E120  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E124  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E128  38 80 C0 00 */	li r4, -16384
/* 80D1E12C  4B 2E E3 09 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D1E130  C0 3E 00 44 */	lfs f1, 0x44(r30)
/* 80D1E134  C0 5E 00 48 */	lfs f2, 0x48(r30)
/* 80D1E138  C0 7E 00 08 */	lfs f3, 8(r30)
/* 80D1E13C  4B 2E EC 61 */	bl transM__14mDoMtx_stack_cFfff
/* 80D1E140  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E144  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E148  80 9F 05 7C */	lwz r4, 0x57c(r31)
/* 80D1E14C  38 84 00 24 */	addi r4, r4, 0x24
/* 80D1E150  4B 62 83 61 */	bl PSMTXCopy
/* 80D1E154  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E158  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E15C  80 9F 05 80 */	lwz r4, 0x580(r31)
/* 80D1E160  38 84 00 24 */	addi r4, r4, 0x24
/* 80D1E164  4B 62 83 4D */	bl PSMTXCopy
/* 80D1E168  80 7F 05 84 */	lwz r3, 0x584(r31)
/* 80D1E16C  4B 2E F2 BD */	bl play__14mDoExt_baseAnmFv
/* 80D1E170  80 7F 05 88 */	lwz r3, 0x588(r31)
/* 80D1E174  4B 2E F2 B5 */	bl play__14mDoExt_baseAnmFv
...
/* 80D1E1B8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80D1E1BC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80D1E1C0  80 63 00 00 */	lwz r3, 0(r3)
/* 80D1E1C4  7C 1B 00 D0 */	neg r0, r27
/* 80D1E1C8  7C 04 07 34 */	extsh r4, r0
/* 80D1E1CC  4B 2E E2 11 */	bl mDoMtx_YrotS__FPA4_fs
/* 80D1E1D0  38 61 00 6C */	addi r3, r1, 0x6c
/* 80D1E1D4  38 81 00 60 */	addi r4, r1, 0x60
/* 80D1E1D8  4B 55 2D 15 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80D1E238  4B 2E F1 F1 */	bl play__14mDoExt_baseAnmFv
lbl_80D1E23C:
...
/* 80D1E248  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D1E24C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D1E278  4B 58 E2 95 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D1E294  4B 2E F1 95 */	bl play__14mDoExt_baseAnmFv
...
/* 80D1E2A4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D1E2A8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D1E2D4  4B 58 E2 39 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D1E2D8:
...
/* 80D1E2F8  4B 2E F1 31 */	bl play__14mDoExt_baseAnmFv
lbl_80D1E2FC:
...
/* 80D1E310  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E314  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E318  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80D1E31C  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80D1E320  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80D1E324  4B 62 85 C5 */	bl PSMTXTrans
/* 80D1E328  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E32C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E330  7F 64 DB 78 */	mr r4, r27
/* 80D1E334  4B 2E E1 01 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D1E338  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E33C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E340  7F 44 D3 78 */	mr r4, r26
/* 80D1E344  4B 2E E0 59 */	bl mDoMtx_XrotM__FPA4_fs
/* 80D1E348  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80D1E34C  FC 40 08 90 */	fmr f2, f1
/* 80D1E350  FC 60 F8 90 */	fmr f3, f31
/* 80D1E354  4B 2E EA E5 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80D1E358  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E35C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E360  38 80 C0 00 */	li r4, -16384
/* 80D1E364  4B 2E E0 D1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D1E368  C0 3E 00 44 */	lfs f1, 0x44(r30)
/* 80D1E36C  C0 5E 00 48 */	lfs f2, 0x48(r30)
/* 80D1E370  C0 7E 00 08 */	lfs f3, 8(r30)
/* 80D1E374  4B 2E EA 29 */	bl transM__14mDoMtx_stack_cFfff
/* 80D1E378  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E37C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80D1E39C  4B 62 81 15 */	bl PSMTXCopy
/* 80D1E3A0  80 7F 06 04 */	lwz r3, 0x604(r31)
/* 80D1E3A4  4B 35 D6 1D */	bl Move__4dBgWFv
...
/* 80D1E3B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E3BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80D1E3D4  4B 62 85 15 */	bl PSMTXTrans
/* 80D1E3D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1E3DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D1E3E0  38 9F 05 D4 */	addi r4, r31, 0x5d4
/* 80D1E3E4  4B 62 80 CD */	bl PSMTXCopy
/* 80D1E3E8  80 7F 06 04 */	lwz r3, 0x604(r31)
/* 80D1E3EC  4B 35 D5 D5 */	bl Move__4dBgWFv
lbl_80D1E3F0:
...
/* 80D1E424  4B 55 0D B9 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80D1E428  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D1E42C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D1E430  38 63 23 3C */	addi r3, r3, 0x233c
/* 80D1E434  38 9F 06 44 */	addi r4, r31, 0x644
/* 80D1E438  4B 54 67 71 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80D1E44C  4B 64 3D CD */	bl _restgpr_25
