...
/* 80C8DF4C  3C 60 80 C9 */	lis r3, mSpeed__11daMagLift_c@ha
/* 80C8DF50  3B E3 E6 5C */	addi r31, r3, mSpeed__11daMagLift_c@l
...
/* 80C8DF90  4B 5D 8B A4 */	b __mi__4cXyzCFRC3Vec
/* 80C8DF94  38 61 00 1C */	addi r3, r1, 0x1c
/* 80C8DF98  4B 6B 91 A0 */	b PSVECSquareMag
...
/* 80C8E008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C8E00C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C8E078  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C8E07C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C8E080:
...
/* 80C8E0B4  4B 5D 8A 80 */	b __mi__4cXyzCFRC3Vec
/* 80C8E0B8  38 61 00 10 */	addi r3, r1, 0x10
/* 80C8E0BC  4B 6B 90 7C */	b PSVECSquareMag
...
/* 80C8E12C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C8E130  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C8E19C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C8E1A0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C8E1A4:
...
/* 80C8E1C8  4B 5E 18 F0 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
