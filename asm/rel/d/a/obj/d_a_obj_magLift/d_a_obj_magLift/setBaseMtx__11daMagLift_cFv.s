...
/* 80C8DAB4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8DAB8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8DABC  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C8DAC0  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C8DAC4  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C8DAC8  4B 6B 8E 21 */	bl PSMTXTrans
/* 80C8DACC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8DAD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8DAD4  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 80C8DAD8  A8 BF 04 DE */	lha r5, 0x4de(r31)
/* 80C8DADC  A8 DF 04 E0 */	lha r6, 0x4e0(r31)
/* 80C8DAE0  4B 37 E7 C1 */	bl mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80C8DB00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8DB04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8DB08  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C8DB0C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C8DB10  4B 6B 89 A1 */	bl PSMTXCopy
