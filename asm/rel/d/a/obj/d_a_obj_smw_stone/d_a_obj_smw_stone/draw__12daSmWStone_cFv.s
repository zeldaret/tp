...
/* 80CDE93C  4B 68 38 A1 */	bl _savegpr_29
/* 80CDE940  7C 7F 1B 78 */	mr r31, r3
/* 80CDE944  3C 60 80 CE */	lis r3, lit_3776@ha /* 0x80CDEEF4@ha */
/* 80CDE948  3B A3 EE F4 */	addi r29, r3, lit_3776@l /* 0x80CDEEF4@l */
/* 80CDE94C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CDE950  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CDE954  38 80 00 08 */	li r4, 8
/* 80CDE958  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CDE95C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CDE960  4B 4C 4E 65 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CDE964  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CDE968  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CDE96C  80 9F 05 84 */	lwz r4, 0x584(r31)
/* 80CDE970  80 84 00 04 */	lwz r4, 4(r4)
/* 80CDE974  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CDE978  4B 4C 64 29 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CDE97C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDE980  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CDE984  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CDE988  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CDE98C  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CDE9A0  4B 32 F3 25 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CDE9A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CDE9A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CDEA00  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80CDEA04  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80CDEA08  4B 34 FF 09 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 80CDEA0C  90 7F 05 C0 */	stw r3, 0x5c0(r31)
/* 80CDEA10  38 60 00 01 */	li r3, 1
/* 80CDEA14  39 61 00 30 */	addi r11, r1, 0x30
/* 80CDEA18  4B 68 38 11 */	bl _restgpr_29
