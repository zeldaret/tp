...
/* 80CC3E3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CC3E40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CC3E44  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80CC3E48  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80CC3E4C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80CC3E50  4B 68 2A 99 */	bl PSMTXTrans
/* 80CC3E54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CC3E58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CC3E5C  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80CC3E60  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80CC3E64  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80CC3E68  4B 34 84 39 */	bl mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80CC3E88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CC3E8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CC3E90  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80CC3E94  38 84 00 24 */	addi r4, r4, 0x24
/* 80CC3E98  4B 68 26 19 */	bl PSMTXCopy
