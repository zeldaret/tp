...
/* 80CC4330  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CC4334  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CC4338  38 80 00 10 */	li r4, 0x10
/* 80CC433C  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CC4340  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CC4344  4B 4D F4 81 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CC4348  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CC434C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CC4350  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80CC4354  80 84 00 04 */	lwz r4, 4(r4)
/* 80CC4358  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CC435C  4B 4E 0A 45 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CC4360  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC4364  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC4368  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CC436C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80CC4370  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80CC4384  4B 34 99 41 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CC4388  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC438C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
