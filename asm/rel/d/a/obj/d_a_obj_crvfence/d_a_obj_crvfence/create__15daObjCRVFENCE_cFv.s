...
/* 80BCFAF4  4B 79 26 E5 */	bl _savegpr_28
/* 80BCFAF8  7C 7E 1B 78 */	mr r30, r3
/* 80BCFAFC  3C 80 80 BD */	lis r4, lit_3685@ha /* 0x80BD0188@ha */
/* 80BCFB00  3B E4 01 88 */	addi r31, r4, lit_3685@l /* 0x80BD0188@l */
...
/* 80BCFB1C  4B 4A 8B 09 */	bl __ct__16dBgS_MoveBgActorFv
/* 80BCFB20  3C 60 80 BD */	lis r3, __vt__15daObjCRVFENCE_c@ha /* 0x80BD02F0@ha */
/* 80BCFB24  38 03 02 F0 */	addi r0, r3, __vt__15daObjCRVFENCE_c@l /* 0x80BD02F0@l */
/* 80BCFB28  90 1D 05 9C */	stw r0, 0x59c(r29)
/* 80BCFB2C  38 7D 05 F8 */	addi r3, r29, 0x5f8
/* 80BCFB30  3C 80 80 BD */	lis r4, __ct__4cXyzFv@ha /* 0x80BCFFBC@ha */
/* 80BCFB34  38 84 FF BC */	addi r4, r4, __ct__4cXyzFv@l /* 0x80BCFFBC@l */
/* 80BCFB38  3C A0 80 BD */	lis r5, __dt__4cXyzFv@ha /* 0x80BCED24@ha */
/* 80BCFB3C  38 A5 ED 24 */	addi r5, r5, __dt__4cXyzFv@l /* 0x80BCED24@l */
/* 80BCFB40  38 C0 00 0C */	li r6, 0xc
/* 80BCFB44  38 E0 00 06 */	li r7, 6
/* 80BCFB48  4B 79 22 19 */	bl __construct_array
/* 80BCFB4C  38 7D 06 70 */	addi r3, r29, 0x670
/* 80BCFB50  4B 4A 63 5D */	bl __ct__12dBgS_AcchCirFv
/* 80BCFB54  3B 9D 06 B0 */	addi r28, r29, 0x6b0
/* 80BCFB58  7F 83 E3 78 */	mr r3, r28
/* 80BCFB5C  4B 4A 65 45 */	bl __ct__9dBgS_AcchFv
/* 80BCFB60  3C 60 80 BD */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80BD02CC@ha */
/* 80BCFB64  38 63 02 CC */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80BD02CC@l */
...
/* 80BCFB80  4B 4A 92 E9 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80BCFB84  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BCFB88  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BCFB8C  90 1D 08 A0 */	stw r0, 0x8a0(r29)
/* 80BCFB90  38 7D 08 A4 */	addi r3, r29, 0x8a4
/* 80BCFB94  4B 4B 3B CD */	bl __ct__10dCcD_GSttsFv
/* 80BCFB98  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BCFB9C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BCFBB0  3C 80 80 BD */	lis r4, __ct__8dCcD_SphFv@ha /* 0x80BCFE38@ha */
/* 80BCFBB4  38 84 FE 38 */	addi r4, r4, __ct__8dCcD_SphFv@l /* 0x80BCFE38@l */
/* 80BCFBB8  3C A0 80 BD */	lis r5, __dt__8dCcD_SphFv@ha /* 0x80BCFD6C@ha */
/* 80BCFBBC  38 A5 FD 6C */	addi r5, r5, __dt__8dCcD_SphFv@l /* 0x80BCFD6C@l */
/* 80BCFBC0  38 C0 01 38 */	li r6, 0x138
/* 80BCFBC4  38 E0 00 06 */	li r7, 6
/* 80BCFBC8  4B 79 21 99 */	bl __construct_array
lbl_80BCFBCC:
...
/* 80BCFBDC  3C 80 80 BD */	lis r4, l_arcName@ha /* 0x80BD0260@ha */
/* 80BCFBE0  38 84 02 60 */	addi r4, r4, l_arcName@l /* 0x80BD0260@l */
/* 80BCFBE4  80 84 00 00 */	lwz r4, 0(r4)
/* 80BCFBE8  4B 45 D2 D5 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BCFC0C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCFC10  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BCFC14  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80BCFC18  7C 05 07 74 */	extsb r5, r0
/* 80BCFC1C  4B 46 57 45 */	bl isSwitch__10dSv_info_cCFii
...
/* 80BCFC38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BCFC3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BCFC40  3C 63 00 02 */	addis r3, r3, 2
/* 80BCFC44  3C 80 80 BD */	lis r4, l_arcName@ha /* 0x80BD0260@ha */
/* 80BCFC48  38 84 02 60 */	addi r4, r4, l_arcName@l /* 0x80BD0260@l */
/* 80BCFC4C  80 84 00 00 */	lwz r4, 0(r4)
/* 80BCFC50  3C A0 80 BD */	lis r5, d_a_obj_crvfence__stringBase0@ha /* 0x80BD020C@ha */
/* 80BCFC54  38 A5 02 0C */	addi r5, r5, d_a_obj_crvfence__stringBase0@l /* 0x80BD020C@l */
/* 80BCFC58  38 A5 00 42 */	addi r5, r5, 0x42
/* 80BCFC5C  38 63 C2 F8 */	addi r3, r3, -15624
/* 80BCFC60  4B 46 CA 59 */	bl getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80BCFC64  7C 65 1B 78 */	mr r5, r3
/* 80BCFC68  7F C3 F3 78 */	mr r3, r30
/* 80BCFC6C  3C 80 80 BD */	lis r4, l_arcName@ha /* 0x80BD0260@ha */
/* 80BCFC70  38 84 02 60 */	addi r4, r4, l_arcName@l /* 0x80BD0260@l */
/* 80BCFC74  80 84 00 00 */	lwz r4, 0(r4)
/* 80BCFC78  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80BCFC7C  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80BCFC80  38 E0 1C A0 */	li r7, 0x1ca0
/* 80BCFC84  39 00 00 00 */	li r8, 0
/* 80BCFC88  4B 4A 8B 35 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80BCFCC4  4B 4A 65 85 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80BCFD00  4B 44 DF BD */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80BCFD04  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BCFD08  41 82 00 10 */	beq lbl_80BCFD18
/* 80BCFD0C  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80BCFD10  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 80BCFD44  4B 44 A8 05 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80BCFD58  4B 79 24 CD */	bl _restgpr_28
