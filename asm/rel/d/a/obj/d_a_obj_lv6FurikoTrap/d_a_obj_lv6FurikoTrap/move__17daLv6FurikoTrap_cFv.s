...
/* 80C72CB4  3C 80 80 C7 */	lis r4, data_80C732E4@ha /* 0x80C732E4@ha */
/* 80C72CB8  38 E4 32 E4 */	addi r7, r4, data_80C732E4@l /* 0x80C732E4@l */
/* 80C72CBC  88 07 00 00 */	lbz r0, 0(r7)
/* 80C72CC0  7C 00 07 75 */	extsb. r0, r0
/* 80C72CC4  40 82 00 34 */	bne lbl_80C72CF8
/* 80C72CC8  3C 80 80 C7 */	lis r4, mode_proc@ha /* 0x80C73208@ha */
/* 80C72CCC  38 C4 32 08 */	addi r6, r4, mode_proc@l /* 0x80C73208@l */
/* 80C72CD0  3C 80 80 C7 */	lis r4, lit_3884@ha /* 0x80C731FC@ha */
/* 80C72CD4  38 A4 31 FC */	addi r5, r4, lit_3884@l /* 0x80C731FC@l */
...
/* 80C72D00  3C 80 80 C7 */	lis r4, mode_proc@ha /* 0x80C73208@ha */
/* 80C72D04  38 04 32 08 */	addi r0, r4, mode_proc@l /* 0x80C73208@l */
/* 80C72D08  7D 80 2A 14 */	add r12, r0, r5
/* 80C72D0C  4B 6E F3 79 */	bl __ptmf_scall
