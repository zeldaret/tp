...
/* 80C729F4  4B 6E F7 BD */	bl _savegpr_18
/* 80C729F8  7C 7C 1B 78 */	mr r28, r3
/* 80C729FC  7C 92 23 78 */	mr r18, r4
/* 80C72A00  3C 80 80 C7 */	lis r4, lit_3625@ha /* 0x80C73130@ha */
/* 80C72A04  3B E4 31 30 */	addi r31, r4, lit_3625@l /* 0x80C73130@l */
...
/* 80C72A28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C72A2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C72A50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C72A54  3A E3 D4 70 */	addi r23, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C72A98  4B 39 99 DD */	bl mDoMtx_ZrotS__FPA4_fs
...
/* 80C72B30  3C 60 80 C7 */	lis r3, posx@ha /* 0x80C731E4@ha */
/* 80C72B34  3A C3 31 E4 */	addi r22, r3, posx@l /* 0x80C731E4@l */
/* 80C72B38  3C 60 80 C7 */	lis r3, posy@ha /* 0x80C731F0@ha */
/* 80C72B3C  3A E3 31 F0 */	addi r23, r3, posy@l /* 0x80C731F0@l */
/* 80C72B40  C3 FF 00 38 */	lfs f31, 0x38(r31)
/* 80C72B44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C72B48  3B 03 D4 70 */	addi r24, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C72BD8  4B 5F CB 31 */	bl SetR__8cM3dGSphFf
...
/* 80C72C58  4B 41 0B D9 */	bl Move__10dCcD_GSttsFv
...
/* 80C72C94  4B 6E F5 69 */	bl _restgpr_18
