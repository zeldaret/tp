...
/* 80C8A448  4B 6D 7D 95 */	bl _savegpr_29
/* 80C8A44C  7C 7D 1B 78 */	mr r29, r3
/* 80C8A450  3C 60 80 C9 */	lis r3, d_a_obj_lv8OptiLift__stringBase0@ha /* 0x80C8BA3C@ha */
/* 80C8A454  38 63 BA 3C */	addi r3, r3, d_a_obj_lv8OptiLift__stringBase0@l /* 0x80C8BA3C@l */
/* 80C8A458  38 80 00 05 */	li r4, 5
/* 80C8A45C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C8A460  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C8A474  4B 3B 1E 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C8A488  4B 38 A7 CD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C8A4A4:
/* 80C8A4A4  3C 60 80 C9 */	lis r3, d_a_obj_lv8OptiLift__stringBase0@ha /* 0x80C8BA3C@ha */
/* 80C8A4A8  38 63 BA 3C */	addi r3, r3, d_a_obj_lv8OptiLift__stringBase0@l /* 0x80C8BA3C@l */
/* 80C8A4AC  38 80 00 08 */	li r4, 8
/* 80C8A4B0  7F C5 F3 78 */	mr r5, r30
/* 80C8A4B4  38 C0 00 80 */	li r6, 0x80
/* 80C8A4B8  4B 3B 1E 35 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C8A4D0  3D 00 80 C9 */	lis r8, lit_3695@ha /* 0x80C8B9F0@ha */
/* 80C8A4D4  C0 28 B9 F0 */	lfs f1, lit_3695@l(r8)  /* 0x80C8B9F0@l */
/* 80C8A4D8  39 00 00 00 */	li r8, 0
/* 80C8A4DC  39 20 FF FF */	li r9, -1
/* 80C8A4E0  4B 38 31 5D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80C8A4E4  38 60 00 01 */	li r3, 1
lbl_80C8A4E8:
/* 80C8A4E8  39 61 00 20 */	addi r11, r1, 0x20
/* 80C8A4EC  4B 6D 7D 3D */	bl _restgpr_29
