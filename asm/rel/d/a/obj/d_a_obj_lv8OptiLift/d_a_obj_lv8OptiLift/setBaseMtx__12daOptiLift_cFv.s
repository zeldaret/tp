...
/* 80C8A3C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8A3C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C8A3CC  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C8A3D0  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C8A3D4  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C8A3D8  4B 6B C5 10 */	b PSMTXTrans
/* 80C8A3DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8A3E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C8A3E4  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 80C8A3E8  A8 BF 04 DE */	lha r5, 0x4de(r31)
/* 80C8A3EC  A8 DF 04 E0 */	lha r6, 0x4e0(r31)
/* 80C8A3F0  4B 38 1E B0 */	b mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80C8A410  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8A414  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C8A418  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C8A41C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C8A420  4B 6B C0 90 */	b PSMTXCopy
