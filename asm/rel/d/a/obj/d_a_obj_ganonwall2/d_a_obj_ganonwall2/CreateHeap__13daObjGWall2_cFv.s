...
/* 80BF5960  4B 76 C8 79 */	bl _savegpr_28
/* 80BF5964  7C 7C 1B 78 */	mr r28, r3
/* 80BF5968  3C 60 80 BF */	lis r3, l_arcName@ha /* 0x80BF620C@ha */
/* 80BF596C  38 63 62 0C */	addi r3, r3, l_arcName@l /* 0x80BF620C@l */
/* 80BF5970  80 63 00 00 */	lwz r3, 0(r3)
/* 80BF5974  38 80 00 05 */	li r4, 5
/* 80BF5978  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BF597C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BF5990  4B 44 69 5D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BF59A4  4B 41 F2 B1 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80BF59C0:
/* 80BF59C0  3C 60 80 BF */	lis r3, l_arcName@ha /* 0x80BF620C@ha */
/* 80BF59C4  38 63 62 0C */	addi r3, r3, l_arcName@l /* 0x80BF620C@l */
...
/* 80BF59D8  4B 44 69 15 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BF59DC  7C 7D 1B 78 */	mr r29, r3
/* 80BF59E0  38 60 00 18 */	li r3, 0x18
/* 80BF59E4  4B 6D 92 69 */	bl __nw__FUl
/* 80BF59E8  7C 7F 1B 79 */	or. r31, r3, r3
/* 80BF59EC  41 82 00 20 */	beq lbl_80BF5A0C
/* 80BF59F0  3C 80 80 BF */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80BF6264@ha */
/* 80BF59F4  38 04 62 64 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80BF6264@l */
/* 80BF59F8  90 1F 00 00 */	stw r0, 0(r31)
/* 80BF59FC  38 80 00 00 */	li r4, 0
/* 80BF5A00  4B 73 29 FD */	bl init__12J3DFrameCtrlFs
...
/* 80BF5A2C  3D 00 80 BF */	lis r8, lit_3702@ha /* 0x80BF61D8@ha */
/* 80BF5A30  C0 28 61 D8 */	lfs f1, lit_3702@l(r8)  /* 0x80BF61D8@l */
/* 80BF5A34  39 00 00 00 */	li r8, 0
/* 80BF5A38  39 20 FF FF */	li r9, -1
/* 80BF5A3C  4B 41 7C 01 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80BF5A58  4B 76 C7 CD */	bl _restgpr_28
