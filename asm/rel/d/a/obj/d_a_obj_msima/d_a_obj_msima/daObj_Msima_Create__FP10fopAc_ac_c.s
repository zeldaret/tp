...
/* 80C9C778  4B 6C 5A 65 */	bl _savegpr_29
/* 80C9C77C  7C 7E 1B 78 */	mr r30, r3
/* 80C9C780  3C 80 80 CA */	lis r4, lit_3863@ha /* 0x80C9CD4C@ha */
/* 80C9C784  3B E4 CD 4C */	addi r31, r4, lit_3863@l /* 0x80C9CD4C@l */
...
/* 80C9C7A0  4B 37 C3 C5 */	bl __ct__10fopAc_ac_cFv
/* 80C9C7A4  38 7D 06 00 */	addi r3, r29, 0x600
/* 80C9C7A8  4B 62 20 9D */	bl __ct__16Z2SoundObjSimpleFv
/* 80C9C7AC  38 7D 06 20 */	addi r3, r29, 0x620
/* 80C9C7B0  3C 80 80 CA */	lis r4, __ct__10ms_chain_sFv@ha /* 0x80C9CA9C@ha */
/* 80C9C7B4  38 84 CA 9C */	addi r4, r4, __ct__10ms_chain_sFv@l /* 0x80C9CA9C@l */
/* 80C9C7B8  3C A0 80 CA */	lis r5, __dt__10ms_chain_sFv@ha /* 0x80C9CA60@ha */
/* 80C9C7BC  38 A5 CA 60 */	addi r5, r5, __dt__10ms_chain_sFv@l /* 0x80C9CA60@l */
/* 80C9C7C0  38 C0 00 A0 */	li r6, 0xa0
/* 80C9C7C4  38 E0 00 04 */	li r7, 4
/* 80C9C7C8  4B 6C 55 99 */	bl __construct_array
lbl_80C9C7CC:
...
/* 80C9C7DC  3C 80 80 CA */	lis r4, d_a_obj_msima__stringBase0@ha /* 0x80C9CDEC@ha */
/* 80C9C7E0  38 84 CD EC */	addi r4, r4, d_a_obj_msima__stringBase0@l /* 0x80C9CDEC@l */
/* 80C9C7E4  4B 39 06 D9 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C9C814  3C 80 80 CA */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80C9C42C@ha */
/* 80C9C818  38 84 C4 2C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80C9C42C@l */
/* 80C9C81C  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 80C9C820  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 80C9C824  4B 37 DC 8D */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80C9C838:
/* 80C9C838  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9C83C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9C840  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C9C844  80 9E 05 FC */	lwz r4, 0x5fc(r30)
/* 80C9C848  7F C5 F3 78 */	mr r5, r30
/* 80C9C84C  4B 3D 81 BD */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
lbl_80C9C860:
/* 80C9C860  3C 60 80 CA */	lis r3, struct_80C9CEA4+0x1@ha /* 0x80C9CEA5@ha */
/* 80C9C864  8C 03 CE A5 */	lbzu r0, struct_80C9CEA4+0x1@l(r3)  /* 0x80C9CEA5@l */
...
/* 80C9C880  3C 60 80 CA */	lis r3, l_HIO@ha /* 0x80C9CEB4@ha */
/* 80C9C884  38 63 CE B4 */	addi r3, r3, l_HIO@l /* 0x80C9CEB4@l */
...
/* 80C9C8AC  4B 5C B0 A9 */	bl cM_rndF__Ff
...
/* 80C9C8CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9C8D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9C8D4  38 63 09 58 */	addi r3, r3, 0x958
/* 80C9C8D8  38 80 00 07 */	li r4, 7
/* 80C9C8DC  4B 39 80 59 */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 80C9C91C  3C 60 80 CA */	lis r3, l_HIO@ha /* 0x80C9CEB4@ha */
/* 80C9C920  38 63 CE B4 */	addi r3, r3, l_HIO@l /* 0x80C9CEB4@l */
...
/* 80C9C93C  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 80C9C940  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
...
/* 80C9C954  4B 39 10 DD */	bl dComIfGs_isZoneSwitch__Fii
...
/* 80C9CA14  4B 37 D4 DD */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 80C9CA4C  4B 6C 57 DD */	bl _restgpr_29
