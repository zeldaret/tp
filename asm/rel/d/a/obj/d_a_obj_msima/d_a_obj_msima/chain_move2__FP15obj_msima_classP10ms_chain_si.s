...
/* 80C9C02C  4B 6C 61 8C */	b _savegpr_20
/* 80C9C030  7C 74 1B 78 */	mr r20, r3
/* 80C9C034  7C 9B 23 78 */	mr r27, r4
/* 80C9C038  3C 60 80 CA */	lis r3, lit_3863@ha
/* 80C9C03C  3B C3 CD 4C */	addi r30, r3, lit_3863@l
...
/* 80C9C054  3C 60 80 CA */	lis r3, chain_p2@ha
/* 80C9C058  38 63 CF 70 */	addi r3, r3, chain_p2@l
...
/* 80C9C078  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9C07C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9C080  A8 94 04 E6 */	lha r4, 0x4e6(r20)
/* 80C9C084  4B 37 03 58 */	b mDoMtx_YrotS__FPA4_fs
/* 80C9C088  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9C08C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9C090  38 81 00 08 */	addi r4, r1, 8
/* 80C9C094  38 A1 00 14 */	addi r5, r1, 0x14
/* 80C9C098  4B 6A AC D4 */	b PSMTXMultVec
...
lbl_80C9C0B8:
/* 80C9C0B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9C0BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9C0C0  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80C9C0C4  C0 41 00 18 */	lfs f2, 0x18(r1)
/* 80C9C0C8  C0 61 00 1C */	lfs f3, 0x1c(r1)
/* 80C9C0CC  4B 6A A8 1C */	b PSMTXTrans
...
/* 80C9C0E0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C9C0E4  3B E3 9A 20 */	addi r31, r3, sincosTable___5JMath@l
/* 80C9C0E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9C0EC  3A A3 D4 70 */	addi r21, r3, now__14mDoMtx_stack_c@l
...
/* 80C9C104  4B 5C BA 00 */	b cM_rndFX2__Ff
...
/* 80C9C230  4B 5D 38 50 */	b cLib_addCalc0__FPfff
...
/* 80C9C248  4B 6C 5F BC */	b _restgpr_20
