...
/* 80C9BEC0  4B 6C 63 0D */	bl _savegpr_25
/* 80C9BEC4  7C 7C 1B 78 */	mr r28, r3
/* 80C9BEC8  7C 9D 23 78 */	mr r29, r4
/* 80C9BECC  7C BE 2B 78 */	mr r30, r5
/* 80C9BED0  3C 60 80 CA */	lis r3, lit_3863@ha /* 0x80C9CD4C@ha */
/* 80C9BED4  3B E3 CD 4C */	addi r31, r3, lit_3863@l /* 0x80C9CD4C@l */
/* 80C9BED8  80 7C 05 74 */	lwz r3, 0x574(r28)
/* 80C9BEDC  38 63 00 24 */	addi r3, r3, 0x24
/* 80C9BEE0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9BEE4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9BEE8  4B 6A A5 C9 */	bl PSMTXCopy
/* 80C9BEEC  1C 1E 00 0C */	mulli r0, r30, 0xc
/* 80C9BEF0  3C 60 80 CA */	lis r3, chain_p@ha /* 0x80C9CF10@ha */
/* 80C9BEF4  38 63 CF 10 */	addi r3, r3, chain_p@l /* 0x80C9CF10@l */
...
/* 80C9BF14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9BF18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9BF1C  38 81 00 08 */	addi r4, r1, 8
/* 80C9BF20  38 BD 00 94 */	addi r5, r29, 0x94
/* 80C9BF24  4B 6A AE 49 */	bl PSMTXMultVec
/* 80C9BF28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9BF2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9BF30  C0 3D 00 94 */	lfs f1, 0x94(r29)
/* 80C9BF34  C0 5D 00 98 */	lfs f2, 0x98(r29)
/* 80C9BF38  C0 7D 00 9C */	lfs f3, 0x9c(r29)
/* 80C9BF3C  4B 6A A9 AD */	bl PSMTXTrans
/* 80C9BF40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9BF44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C9BF58  4B 37 04 DD */	bl mDoMtx_YrotM__FPA4_fs
/* 80C9BF5C  3B 40 00 00 */	li r26, 0
/* 80C9BF60  3B 20 00 00 */	li r25, 0
/* 80C9BF64  3B 80 00 00 */	li r28, 0
/* 80C9BF68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C9BF6C  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C9BF70  7F 7E DB 78 */	mr r30, r27
lbl_80C9BF74:
/* 80C9BF74  C0 3F 00 60 */	lfs f1, 0x60(r31)
/* 80C9BF78  4B 5C BB 8D */	bl cM_rndFX2__Ff
...
/* 80C9BFF8  4B 6C 62 21 */	bl _restgpr_25
