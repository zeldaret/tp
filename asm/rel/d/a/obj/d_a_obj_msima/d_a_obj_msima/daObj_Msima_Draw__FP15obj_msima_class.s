...
/* 80C9B4B8  4B 6C 6D 11 */	bl _savegpr_24
/* 80C9B4BC  7C 7F 1B 78 */	mr r31, r3
/* 80C9B4C0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C9B4C4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C9B4C8  38 80 00 10 */	li r4, 0x10
/* 80C9B4CC  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C9B4D0  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80C9B4D4  4B 50 82 F1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C9B4D8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C9B4DC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C9B4E0  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80C9B4E4  80 84 00 04 */	lwz r4, 4(r4)
/* 80C9B4E8  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C9B4EC  4B 50 98 B5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C9B4F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9B4F4  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C9B4F8  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C9B4FC  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C9B500  3B 83 4A C8 */	addi r28, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C9B524  4B 37 21 B5 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C9B53C  4B 37 22 6D */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80C9B540  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80C9B544  4B 37 27 81 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C9B548  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C9B54C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C9B574  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C9B578  3B 83 CA 54 */	addi r28, r3, g_env_light@l /* 0x8042CA54@l */
lbl_80C9B57C:
...
/* 80C9B5A0  4B 50 82 25 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C9B5A4  7F 83 E3 78 */	mr r3, r28
/* 80C9B5A8  80 9A 00 04 */	lwz r4, 4(r26)
/* 80C9B5AC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C9B5B0  4B 50 97 F1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C9B5B4  7F 43 D3 78 */	mr r3, r26
/* 80C9B5B8  4B 37 27 0D */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80C9B5E4  4B 6C 6C 31 */	bl _restgpr_24
