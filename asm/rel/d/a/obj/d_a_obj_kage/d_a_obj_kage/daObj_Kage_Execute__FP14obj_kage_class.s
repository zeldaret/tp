...
/* 80C31554  4B 73 0C 85 */	bl _savegpr_28
/* 80C31558  7C 7E 1B 78 */	mr r30, r3
/* 80C3155C  3C 60 80 C3 */	lis r3, lit_3854@ha /* 0x80C3195C@ha */
/* 80C31560  3B E3 19 5C */	addi r31, r3, lit_3854@l /* 0x80C3195C@l */
...
/* 80C315CC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C315D0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C31618  4B 63 E4 25 */	bl cLib_addCalc2__FPffff
...
/* 80C3162C  4B 63 E4 11 */	bl cLib_addCalc2__FPffff
/* 80C31630  48 00 00 98 */	b lbl_80C316C8
lbl_80C31634:
/* 80C31634  C3 FF 00 18 */	lfs f31, 0x18(r31)
/* 80C31638  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C3163C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C31654  4B 3E 93 11 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C31678  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C3167C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C316C4  4B 63 E3 79 */	bl cLib_addCalc2__FPffff
lbl_80C316C8:
/* 80C316C8  B3 BE 04 E4 */	sth r29, 0x4e4(r30)
/* 80C316CC  B3 9E 04 E8 */	sth r28, 0x4e8(r30)
/* 80C316D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C316D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C316E8  4B 71 52 01 */	bl PSMTXTrans
/* 80C316EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C316F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C316F4  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80C316F8  4B 3D AD 3D */	bl mDoMtx_YrotM__FPA4_fs
/* 80C316FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C31700  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C31704  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C31708  4B 3D AC 95 */	bl mDoMtx_XrotM__FPA4_fs
/* 80C3170C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C31710  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C31714  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 80C31718  4B 3D AD B5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80C3171C  C0 3F 00 00 */	lfs f1, 0(r31)
/* 80C31720  FC 40 F8 50 */	fneg f2, f31
/* 80C31724  FC 60 08 90 */	fmr f3, f1
/* 80C31728  4B 3D B6 75 */	bl transM__14mDoMtx_stack_cFfff
/* 80C3172C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C31730  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C31734  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80C31738  38 84 00 24 */	addi r4, r4, 0x24
/* 80C3173C  4B 71 4D 75 */	bl PSMTXCopy
...
/* 80C31750  4B 73 0A D5 */	bl _restgpr_28
