...
/* 80BDBCC8  4B 78 65 05 */	bl _savegpr_25
/* 80BDBCCC  7C 7D 1B 78 */	mr r29, r3
/* 80BDBCD0  3C 80 80 BE */	lis r4, lit_3775@ha /* 0x80BDC3B0@ha */
/* 80BDBCD4  3B E4 C3 B0 */	addi r31, r4, lit_3775@l /* 0x80BDC3B0@l */
...
/* 80BDBCF0  4B 58 23 21 */	bl __ct__9dInsect_cFv
/* 80BDBCF4  3C 60 80 BE */	lis r3, __vt__10daObjDAN_c@ha /* 0x80BDC538@ha */
/* 80BDBCF8  38 03 C5 38 */	addi r0, r3, __vt__10daObjDAN_c@l /* 0x80BDC538@l */
/* 80BDBCFC  90 1E 05 68 */	stw r0, 0x568(r30)
/* 80BDBD00  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BDBD04  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BDBD08  90 1E 05 A8 */	stw r0, 0x5a8(r30)
/* 80BDBD0C  38 7E 05 AC */	addi r3, r30, 0x5ac
/* 80BDBD10  4B 4A 7A 51 */	bl __ct__10dCcD_GSttsFv
/* 80BDBD14  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BDBD18  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BDBD30  4B 4A 7C F9 */	bl __ct__12dCcD_GObjInfFv
/* 80BDBD34  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BDBD38  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BDBD3C  90 1A 01 20 */	stw r0, 0x120(r26)
/* 80BDBD40  3C 60 80 BE */	lis r3, __vt__8cM3dGAab@ha /* 0x80BDC52C@ha */
/* 80BDBD44  38 03 C5 2C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BDC52C@l */
/* 80BDBD48  90 1A 01 1C */	stw r0, 0x11c(r26)
/* 80BDBD4C  3C 60 80 BE */	lis r3, __vt__8cM3dGSph@ha /* 0x80BDC520@ha */
/* 80BDBD50  38 03 C5 20 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80BDC520@l */
/* 80BDBD54  90 1A 01 34 */	stw r0, 0x134(r26)
/* 80BDBD58  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80BDBD5C  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 80BDBD60  90 7A 01 20 */	stw r3, 0x120(r26)
/* 80BDBD64  38 03 00 58 */	addi r0, r3, 0x58
/* 80BDBD68  90 1A 01 34 */	stw r0, 0x134(r26)
/* 80BDBD6C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80BDBD70  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80BDBD8C  4B 49 B7 F1 */	bl __ct__11dBgS_GndChkFv
/* 80BDBD90  38 7E 07 B0 */	addi r3, r30, 0x7b0
/* 80BDBD94  4B 6E 46 35 */	bl __ct__10Z2CreatureFv
/* 80BDBD98  38 7E 08 48 */	addi r3, r30, 0x848
/* 80BDBD9C  4B 49 A1 11 */	bl __ct__12dBgS_AcchCirFv
/* 80BDBDA0  3B 5E 08 88 */	addi r26, r30, 0x888
/* 80BDBDA4  7F 43 D3 78 */	mr r3, r26
/* 80BDBDA8  4B 49 A2 F9 */	bl __ct__9dBgS_AcchFv
/* 80BDBDAC  3C 60 80 BE */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80BDC4FC@ha */
/* 80BDBDB0  38 63 C4 FC */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80BDC4FC@l */
...
/* 80BDBDCC  4B 49 D0 9D */	bl SetObj__16dBgS_PolyPassChkFv
lbl_80BDBDD0:
...
/* 80BDBDE0  3C 80 80 BE */	lis r4, d_a_obj_dan__stringBase0@ha /* 0x80BDC46C@ha */
/* 80BDBDE4  38 84 C4 6C */	addi r4, r4, d_a_obj_dan__stringBase0@l /* 0x80BDC46C@l */
/* 80BDBDE8  4B 45 10 D5 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BDBE80  3C 60 80 BE */	lis r3, l_HIO@ha /* 0x80BDC578@ha */
/* 80BDBE84  38 63 C5 78 */	addi r3, r3, l_HIO@l /* 0x80BDC578@l */
...
/* 80BDBEA4  3C 60 80 BE */	lis r3, l_HIO@ha /* 0x80BDC578@ha */
/* 80BDBEA8  38 63 C5 78 */	addi r3, r3, l_HIO@l /* 0x80BDC578@l */
...
/* 80BDBED8  3C 80 80 BE */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80BDA678@ha */
/* 80BDBEDC  38 84 A6 78 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80BDA678@l */
/* 80BDBEE0  38 A0 12 00 */	li r5, 0x1200
/* 80BDBEE4  4B 43 E5 CD */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80BDBEF8:
/* 80BDBEF8  3C 60 80 BE */	lis r3, data_80BDC568@ha /* 0x80BDC568@ha */
/* 80BDBEFC  8C 03 C5 68 */	lbzu r0, data_80BDC568@l(r3)  /* 0x80BDC568@l */
...
/* 80BDBF18  3C 60 80 BE */	lis r3, l_HIO@ha /* 0x80BDC578@ha */
/* 80BDBF1C  38 63 C5 78 */	addi r3, r3, l_HIO@l /* 0x80BDC578@l */
...
/* 80BDBF30  4B 49 A0 29 */	bl SetWall__12dBgS_AcchCirFff
...
/* 80BDBF5C  4B 49 A2 ED */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80BDBF98  3C 60 80 BE */	lis r3, d_a_obj_dan__stringBase0@ha /* 0x80BDC46C@ha */
/* 80BDBF9C  38 63 C4 6C */	addi r3, r3, d_a_obj_dan__stringBase0@l /* 0x80BDC46C@l */
/* 80BDBFA0  38 63 00 06 */	addi r3, r3, 6
/* 80BDBFA4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BDBFA8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BDBFAC  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80BDBFB0  4B 78 C9 E5 */	bl strcmp
/* 80BDBFB4  2C 03 00 00 */	cmpwi r3, 0
/* 80BDBFB8  40 82 00 80 */	bne lbl_80BDC038
/* 80BDBFBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BDBFC0  38 A3 61 C0 */	addi r5, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BDBFF4  3C 60 80 BE */	lis r3, d_a_obj_dan__stringBase0@ha /* 0x80BDC46C@ha */
/* 80BDBFF8  38 63 C4 6C */	addi r3, r3, d_a_obj_dan__stringBase0@l /* 0x80BDC46C@l */
...
/* 80BDC00C  4B 46 02 E1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BDC02C  4B 43 4E 45 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80BDC04C  4B 49 B5 31 */	bl __ct__11dBgS_GndChkFv
/* 80BDC050  3C 60 80 BE */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x80BDC4CC@ha */
/* 80BDC054  38 63 C4 CC */	addi r3, r3, __vt__14dBgS_ObjGndChk@l /* 0x80BDC4CC@l */
...
/* 80BDC078  4B 49 CD F1 */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 80BDC0A8  4B 68 BC 81 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 80BDC0AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BDC0B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BDC0B4  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80BDC0B8  7F 24 CB 78 */	mr r4, r25
/* 80BDC0BC  4B 49 83 E5 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80BDC0F8  4B 43 E4 31 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80BDC10C  4B 43 E4 2D */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80BDC124  4B 6E 44 0D */	bl init__10Z2CreatureFP3VecP3VecUcUc
/* 80BDC128  7F A3 EB 78 */	mr r3, r29
/* 80BDC12C  4B FF F9 C1 */	bl daObjDAN_Execute__FP10daObjDAN_c
/* 80BDC130  3C 60 80 BE */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x80BDC4CC@ha */
/* 80BDC134  38 03 C4 CC */	addi r0, r3, __vt__14dBgS_ObjGndChk@l /* 0x80BDC4CC@l */
...
/* 80BDC150  4B 49 B4 A1 */	bl __dt__11dBgS_GndChkFv
lbl_80BDC154:
/* 80BDC154  7F C3 F3 78 */	mr r3, r30
lbl_80BDC158:
/* 80BDC158  39 61 00 90 */	addi r11, r1, 0x90
/* 80BDC15C  4B 78 60 BD */	bl _restgpr_25
