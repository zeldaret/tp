...
/* 80BDBA3C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BDBA40  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BDBA44  38 80 00 10 */	li r4, 0x10
/* 80BDBA48  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BDBA4C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BDBA50  4B 5C 7D 75 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BDBA54  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BDBA58  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BDBA5C  80 9F 00 04 */	lwz r4, 4(r31)
/* 80BDBA60  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BDBA64  4B 5C 93 3D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80BDBA78  4B 43 1C 61 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80BDBA8C  4B 43 1D 1D */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80BDBA90  80 7E 08 44 */	lwz r3, 0x844(r30)
/* 80BDBA94  4B 43 57 2D */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 80BDBAAC  3C 80 80 BE */	lis r4, lit_4050@ha /* 0x80BDC420@ha */
/* 80BDBAB0  C0 44 C4 20 */	lfs f2, lit_4050@l(r4)  /* 0x80BDC420@l */
/* 80BDBAB4  38 9E 09 78 */	addi r4, r30, 0x978
/* 80BDBAB8  38 A0 00 00 */	li r5, 0
/* 80BDBABC  3C C0 80 BE */	lis r6, lit_4354@ha /* 0x80BDC45C@ha */
/* 80BDBAC0  C0 66 C4 5C */	lfs f3, lit_4354@l(r6)  /* 0x80BDC45C@l */
/* 80BDBAC4  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80BDBAC8  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80BDBACC  4B 45 15 E9 */	bl dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80BDBAD0:
