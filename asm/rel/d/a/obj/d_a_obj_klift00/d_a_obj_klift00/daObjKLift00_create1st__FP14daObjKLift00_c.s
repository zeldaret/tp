...
/* 8058C080  4B AE C5 A4 */	b __ct__16dBgS_MoveBgActorFv
/* 8058C084  3C 60 80 59 */	lis r3, __vt__14daObjKLift00_c@ha
/* 8058C088  38 03 C4 CC */	addi r0, r3, __vt__14daObjKLift00_c@l
/* 8058C08C  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 8058C090  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 8058C094  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 8058C098  90 1E 06 3C */	stw r0, 0x63c(r30)
/* 8058C09C  38 7E 06 40 */	addi r3, r30, 0x640
/* 8058C0A0  4B AF 76 C0 */	b __ct__10dCcD_GSttsFv
/* 8058C0A4  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 8058C0A8  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 8058C0BC  3C 80 80 59 */	lis r4, __ct__8dCcD_SphFv@ha
/* 8058C0C0  38 84 C1 F4 */	addi r4, r4, __ct__8dCcD_SphFv@l
/* 8058C0C4  3C A0 80 59 */	lis r5, __dt__8dCcD_SphFv@ha
/* 8058C0C8  38 A5 AF 60 */	addi r5, r5, __dt__8dCcD_SphFv@l
/* 8058C0CC  38 C0 01 38 */	li r6, 0x138
/* 8058C0D0  38 E0 00 08 */	li r7, 8
/* 8058C0D4  4B DD 5C 8C */	b __construct_array
/* 8058C0D8  3B DE 10 20 */	addi r30, r30, 0x1020
/* 8058C0DC  7F C3 F3 78 */	mr r3, r30
/* 8058C0E0  4B AF 79 48 */	b __ct__12dCcD_GObjInfFv
/* 8058C0E4  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 8058C0E8  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 8058C0EC  90 1E 01 20 */	stw r0, 0x120(r30)
/* 8058C0F0  3C 60 80 59 */	lis r3, __vt__8cM3dGAab@ha
/* 8058C0F4  38 03 C5 00 */	addi r0, r3, __vt__8cM3dGAab@l
/* 8058C0F8  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 8058C0FC  3C 60 80 59 */	lis r3, __vt__8cM3dGCyl@ha
/* 8058C100  38 03 C5 0C */	addi r0, r3, __vt__8cM3dGCyl@l
/* 8058C104  90 1E 01 38 */	stw r0, 0x138(r30)
/* 8058C108  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 8058C10C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 8058C110  90 7E 01 20 */	stw r3, 0x120(r30)
/* 8058C114  38 03 00 58 */	addi r0, r3, 0x58
/* 8058C118  90 1E 01 38 */	stw r0, 0x138(r30)
/* 8058C11C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 8058C120  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
