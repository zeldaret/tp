...
/* 8058BEFC  4B DD 62 D9 */	bl _savegpr_27
/* 8058BF00  7C 7F 1B 78 */	mr r31, r3
/* 8058BF04  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8058BF08  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8058BF0C  38 80 00 10 */	li r4, 0x10
/* 8058BF10  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8058BF14  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8058BF18  4B C1 78 AD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8058BF1C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8058BF20  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8058BF24  80 9F 06 08 */	lwz r4, 0x608(r31)
/* 8058BF28  80 84 00 04 */	lwz r4, 4(r4)
/* 8058BF2C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8058BF30  4B C1 8E 71 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8058BF40  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8058BF44  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8058BF48  80 9F 06 0C */	lwz r4, 0x60c(r31)
/* 8058BF4C  80 84 00 04 */	lwz r4, 4(r4)
/* 8058BF50  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8058BF54  4B C1 8E 4D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_8058BF58:
/* 8058BF58  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058BF5C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058BF60  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 8058BF64  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8058BF68  3B A3 4A C8 */	addi r29, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8058BF7C  4B A8 1D 49 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8058BF90  4B A8 1D 35 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8058BF94:
...
/* 8058BFA4  4B B1 09 35 */	bl entry__10dMdl_mng_cFP12J3DModelDataUsi
...
/* 8058BFC8  4B B1 06 A1 */	bl entryObj__6dMdl_cFP10dMdl_obj_c
...
lbl_8058BFE0:
/* 8058BFE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058BFE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058C000  4B DD 62 21 */	bl _restgpr_27
