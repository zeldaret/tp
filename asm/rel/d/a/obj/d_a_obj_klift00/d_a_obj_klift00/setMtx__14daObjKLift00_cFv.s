...
/* 8058B0F0  4B DD 70 D1 */	bl _savegpr_22
/* 8058B0F4  7C 7B 1B 78 */	mr r27, r3
/* 8058B0F8  3C 60 80 59 */	lis r3, l_bmdidx@ha /* 0x8058C380@ha */
/* 8058B0FC  3B C3 C3 80 */	addi r30, r3, l_bmdidx@l /* 0x8058C380@l */
/* 8058B100  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B104  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058B108  C0 3B 04 D0 */	lfs f1, 0x4d0(r27)
/* 8058B10C  C0 5B 04 D4 */	lfs f2, 0x4d4(r27)
/* 8058B110  C0 7B 04 D8 */	lfs f3, 0x4d8(r27)
/* 8058B114  4B DB B7 D5 */	bl PSMTXTrans
/* 8058B118  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B11C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058B120  A8 9B 04 E6 */	lha r4, 0x4e6(r27)
/* 8058B124  4B A8 13 11 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 8058B134  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B138  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058B13C  80 9B 06 0C */	lwz r4, 0x60c(r27)
/* 8058B140  38 84 00 24 */	addi r4, r4, 0x24
/* 8058B144  4B DB B3 6D */	bl PSMTXCopy
lbl_8058B148:
/* 8058B148  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B14C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058B150  38 9B 05 D8 */	addi r4, r27, 0x5d8
/* 8058B154  4B DB B3 5D */	bl PSMTXCopy
...
/* 8058B170  3C 60 80 43 */	lis r3, BaseZ__4cXyz@ha /* 0x80430D3C@ha */
/* 8058B174  3B E3 0D 3C */	addi r31, r3, BaseZ__4cXyz@l /* 0x80430D3C@l */
/* 8058B178  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 8058B17C  C3 E3 11 80 */	lfs f31, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
/* 8058B180  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B184  3A C3 D4 70 */	addi r22, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8058B1B4  4B CD B9 81 */	bl __mi__4cXyzCFRC3Vec
...
/* 8058B1DC  4B DB BF D9 */	bl PSVECCrossProduct
/* 8058B1E0  38 61 00 80 */	addi r3, r1, 0x80
/* 8058B1E4  4B DB BF 55 */	bl PSVECSquareMag
...
/* 8058B200  4B CD BC F5 */	bl normalize__4cXyzFv
/* 8058B204  38 61 00 80 */	addi r3, r1, 0x80
/* 8058B208  3C 80 80 43 */	lis r4, BaseZ__4cXyz@ha /* 0x80430D3C@ha */
/* 8058B20C  38 84 0D 3C */	addi r4, r4, BaseZ__4cXyz@l /* 0x80430D3C@l */
/* 8058B210  4B DB BF 85 */	bl PSVECDotProduct
/* 8058B214  FF C0 08 90 */	fmr f30, f1
/* 8058B218  38 61 00 74 */	addi r3, r1, 0x74
/* 8058B21C  4B DB BF 1D */	bl PSVECSquareMag
/* 8058B220  FC 00 0A 10 */	fabs f0, f1
/* 8058B224  FC 20 00 18 */	frsp f1, f0
/* 8058B228  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 8058B22C  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 8058B314  4B CD B8 21 */	bl __mi__4cXyzCFRC3Vec
...
/* 8058B34C  4B DB BD ED */	bl PSVECSquareMag
/* 8058B350  FC 00 0A 10 */	fabs f0, f1
/* 8058B354  FC 20 00 18 */	frsp f1, f0
/* 8058B358  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 8058B35C  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 8058B428  4B A8 19 3D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8058B42C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B430  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058B434  38 81 00 8C */	addi r4, r1, 0x8c
/* 8058B438  7C 65 1B 78 */	mr r5, r3
/* 8058B43C  4B DB B0 A9 */	bl PSMTXConcat
/* 8058B440  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B444  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058B448  7C 1D 00 D0 */	neg r0, r29
/* 8058B44C  7C 04 07 34 */	extsh r4, r0
/* 8058B450  4B A8 0F E5 */	bl mDoMtx_YrotM__FPA4_fs
/* 8058B454  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B458  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058B45C  80 9B 06 08 */	lwz r4, 0x608(r27)
/* 8058B460  38 84 00 24 */	addi r4, r4, 0x24
/* 8058B464  4B DB B0 4D */	bl PSMTXCopy
/* 8058B468  C0 3B 04 EC */	lfs f1, 0x4ec(r27)
/* 8058B46C  C0 5B 04 F0 */	lfs f2, 0x4f0(r27)
/* 8058B470  C0 7B 04 F4 */	lfs f3, 0x4f4(r27)
/* 8058B474  4B A8 19 C5 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8058B478  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058B47C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058B480  38 9B 05 A8 */	addi r4, r27, 0x5a8
/* 8058B484  4B DB B0 2D */	bl PSMTXCopy
...
/* 8058B49C  4B DD 6D 71 */	bl _restgpr_22
