...
/* 8058B994  4B DD 68 2D */	bl _savegpr_22
/* 8058B998  7C 7A 1B 78 */	mr r26, r3
/* 8058B99C  7C 9B 23 78 */	mr r27, r4
/* 8058B9A0  3C 60 80 59 */	lis r3, l_bmdidx@ha /* 0x8058C380@ha */
/* 8058B9A4  3B E3 C3 80 */	addi r31, r3, l_bmdidx@l /* 0x8058C380@l */
/* 8058B9A8  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 8058B9AC  4B CD BF A9 */	bl cM_rndF__Ff
...
/* 8058B9CC  4B AC F1 35 */	bl dKyw_get_wind_vecpow__Fv
...
/* 8058B9EC  4B CD BF 69 */	bl cM_rndF__Ff
/* 8058B9F0  38 61 00 9C */	addi r3, r1, 0x9c
/* 8058B9F4  7C 64 1B 78 */	mr r4, r3
/* 8058B9F8  4B DB B6 E1 */	bl PSVECScale
...
/* 8058BA0C  4B DB B6 85 */	bl PSVECAdd
...
/* 8058BA24  4B CD BF 31 */	bl cM_rndF__Ff
/* 8058BA28  38 61 00 9C */	addi r3, r1, 0x9c
/* 8058BA2C  7C 64 1B 78 */	mr r4, r3
/* 8058BA30  4B DB B6 A9 */	bl PSVECScale
...
/* 8058BA44  4B DB B6 4D */	bl PSVECAdd
lbl_8058BA48:
...
/* 8058BA88  4B AF 89 D9 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 8058BA8C  28 03 00 00 */	cmplwi r3, 0
/* 8058BA90  41 82 00 EC */	beq lbl_8058BB7C
/* 8058BA94  7E E3 BB 78 */	mr r3, r23
/* 8058BA98  4B AF 8A 61 */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 8058BA9C  7C 77 1B 78 */	mr r23, r3
/* 8058BAA0  4B CD 7F A9 */	bl GetAc__8cCcD_ObjFv
...
/* 8058BAC0  4B CD B0 75 */	bl __mi__4cXyzCFRC3Vec
...
/* 8058BAE0  4B DB B6 59 */	bl PSVECSquareMag
/* 8058BAE4  FC 00 0A 10 */	fabs f0, f1
/* 8058BAE8  FC 20 00 18 */	frsp f1, f0
/* 8058BAEC  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 8058BAF0  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 8058BB28  4B DB B5 69 */	bl PSVECAdd
lbl_8058BB2C:
...
/* 8058BB40  4B AF 8A 71 */	bl getHitSeID__12dCcD_GObjInfFUci
/* 8058BB44  90 61 00 08 */	stw r3, 8(r1)
/* 8058BB48  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058BB4C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058BB78  4B D1 FE 0D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8058BB7C:
...
/* 8058BB94  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 8058BB98  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 8058BC20  4B DB B4 71 */	bl PSVECAdd
...
/* 8058BC6C  4B CD AE 79 */	bl __pl__4cXyzCFRC3Vec
...
/* 8058BD08  4B CD AE 2D */	bl __mi__4cXyzCFRC3Vec
...
/* 8058BD4C  4B DB B3 ED */	bl PSVECSquareMag
/* 8058BD50  FC 00 0A 10 */	fabs f0, f1
/* 8058BD54  FC 20 00 18 */	frsp f1, f0
/* 8058BD58  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 8058BD5C  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 8058BD70  4B CD B1 85 */	bl normalize__4cXyzFv
...
/* 8058BD98  4B DB B3 41 */	bl PSVECScale
...
/* 8058BDB0  4B CD AD 35 */	bl __pl__4cXyzCFRC3Vec
...
/* 8058BDEC  4B CD AD 49 */	bl __mi__4cXyzCFRC3Vec
...
/* 8058BE58  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058BE5C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058BE8C  4B CE 37 BD */	bl SetC__8cM3dGSphFRC4cXyz
/* 8058BE90  7E E3 BB 78 */	mr r3, r23
/* 8058BE94  38 96 06 60 */	addi r4, r22, 0x660
/* 8058BE98  4B CD 8D 11 */	bl Set__4cCcSFP8cCcD_Obj
lbl_8058BE9C:
...
/* 8058BEB4  4B AF 79 7D */	bl Move__10dCcD_GSttsFv
...
/* 8058BED8  4B DD 63 35 */	bl _restgpr_22
