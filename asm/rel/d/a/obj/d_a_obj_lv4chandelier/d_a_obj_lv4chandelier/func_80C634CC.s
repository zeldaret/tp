...
/* 80C634EC  4B 6F EC C4 */	b _savegpr_18
/* 80C634F0  7C 97 23 78 */	mr r23, r4
/* 80C634F4  7C B8 2B 78 */	mr r24, r5
/* 80C634F8  7C D9 33 78 */	mr r25, r6
/* 80C634FC  3C 60 80 C6 */	lis r3, l_bmdidx@ha
/* 80C63500  3B C3 68 60 */	addi r30, r3, l_bmdidx@l
/* 80C63504  3B 60 00 00 */	li r27, 0
/* 80C63508  3B 40 00 00 */	li r26, 0
/* 80C6350C  3A C0 00 00 */	li r22, 0
/* 80C63510  3A A0 00 00 */	li r21, 0
/* 80C63514  3C 60 80 43 */	lis r3, BaseZ__4cXyz@ha
/* 80C63518  3B E3 0D 3C */	addi r31, r3, BaseZ__4cXyz@l
/* 80C6351C  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80C63520  C3 E3 11 80 */	lfs f31, G_CM3D_F_ABS_MIN@l(r3)
/* 80C63524  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C63528  3A 43 D4 70 */	addi r18, r3, now__14mDoMtx_stack_c@l
...
/* 80C63558  4B 60 35 DC */	b __mi__4cXyzCFRC3Vec
...
/* 80C63580  4B 6E 3C 34 */	b PSVECCrossProduct
/* 80C63584  38 61 00 38 */	addi r3, r1, 0x38
/* 80C63588  4B 6E 3B B0 */	b PSVECSquareMag
...
/* 80C635A4  4B 60 39 50 */	b normalize__4cXyzFv
/* 80C635A8  38 61 00 38 */	addi r3, r1, 0x38
/* 80C635AC  3C 80 80 43 */	lis r4, BaseZ__4cXyz@ha
/* 80C635B0  38 84 0D 3C */	addi r4, r4, BaseZ__4cXyz@l
/* 80C635B4  4B 6E 3B E0 */	b PSVECDotProduct
/* 80C635B8  FF C0 08 90 */	fmr f30, f1
/* 80C635BC  38 61 00 2C */	addi r3, r1, 0x2c
/* 80C635C0  4B 6E 3B 78 */	b PSVECSquareMag
/* 80C635C4  FC 00 0A 10 */	fabs f0, f1
/* 80C635C8  FC 20 00 18 */	frsp f1, f0
/* 80C635CC  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80C635D0  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 80C63604  4B 60 38 F0 */	b normalize__4cXyzFv
/* 80C63608  FC 20 F0 90 */	fmr f1, f30
/* 80C6360C  4B 70 90 D4 */	b acos
...
/* 80C636A0  4B 6F EB 5C */	b _restgpr_18
