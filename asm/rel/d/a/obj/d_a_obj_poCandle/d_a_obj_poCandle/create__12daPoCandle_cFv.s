...
/* 80CB1C04  4B 3C 6A 21 */	bl __ct__16dBgS_MoveBgActorFv
/* 80CB1C08  3C 60 80 CB */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80CB27C0@ha */
/* 80CB1C0C  38 03 27 C0 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80CB27C0@l */
...
/* 80CB1C20  3C 60 80 CB */	lis r3, __vt__12daPoCandle_c@ha /* 0x80CB27D8@ha */
/* 80CB1C24  38 63 27 D8 */	addi r3, r3, __vt__12daPoCandle_c@l /* 0x80CB27D8@l */
...
/* 80CB1C44  3C 80 80 CB */	lis r4, d_a_obj_poCandle__stringBase0@ha /* 0x80CB26E8@ha */
/* 80CB1C48  38 84 26 E8 */	addi r4, r4, d_a_obj_poCandle__stringBase0@l /* 0x80CB26E8@l */
/* 80CB1C4C  4B 37 B2 71 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CB1C60  3C 80 80 CB */	lis r4, d_a_obj_poCandle__stringBase0@ha /* 0x80CB26E8@ha */
/* 80CB1C64  38 84 26 E8 */	addi r4, r4, d_a_obj_poCandle__stringBase0@l /* 0x80CB26E8@l */
/* 80CB1C68  38 A0 00 07 */	li r5, 7
/* 80CB1C6C  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80CB1C70  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80CB1C74  38 E0 16 00 */	li r7, 0x1600
/* 80CB1C78  39 00 00 00 */	li r8, 0
/* 80CB1C7C  4B 3C 6B 41 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80CB1CB0  4B 36 88 C9 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80CB1CB4  C0 1E 04 D0 */	lfs f0, 0x4d0(r30)
/* 80CB1CB8  D0 1E 05 C4 */	stfs f0, 0x5c4(r30)
/* 80CB1CBC  3C 60 80 CB */	lis r3, lit_3714@ha /* 0x80CB26BC@ha */
/* 80CB1CC0  C0 23 26 BC */	lfs f1, lit_3714@l(r3)  /* 0x80CB26BC@l */
...
/* 80CB1D20  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB1D24  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CB1D28  88 9E 05 D4 */	lbz r4, 0x5d4(r30)
/* 80CB1D2C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80CB1D30  7C 05 07 74 */	extsb r5, r0
/* 80CB1D34  4B 38 36 2D */	bl isSwitch__10dSv_info_cCFii
