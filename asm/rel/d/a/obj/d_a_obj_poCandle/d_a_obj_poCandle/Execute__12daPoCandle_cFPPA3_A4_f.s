...
/* 80CB1F20  4B 6B 02 B9 */	bl _savegpr_28
/* 80CB1F24  7C 7D 1B 78 */	mr r29, r3
/* 80CB1F28  7C 9E 23 78 */	mr r30, r4
/* 80CB1F2C  3C 60 80 CB */	lis r3, cNullVec__6Z2Calc@ha /* 0x80CB26F0@ha */
/* 80CB1F30  3B E3 26 F0 */	addi r31, r3, cNullVec__6Z2Calc@l /* 0x80CB26F0@l */
/* 80CB1F34  3C 60 80 CB */	lis r3, data_80CB2858@ha /* 0x80CB2858@ha */
/* 80CB1F38  38 A3 28 58 */	addi r5, r3, data_80CB2858@l /* 0x80CB2858@l */
...
/* 80CB1FB8  4B 39 68 B5 */	bl eventUpdate__17dEvLib_callback_cFv
/* 80CB1FBC  88 1D 05 D1 */	lbz r0, 0x5d1(r29)
/* 80CB1FC0  28 00 00 00 */	cmplwi r0, 0
/* 80CB1FC4  41 82 01 28 */	beq lbl_80CB20EC
/* 80CB1FC8  3C 60 80 CB */	lis r3, l_HIO@ha /* 0x80CB284C@ha */
/* 80CB1FCC  38 63 28 4C */	addi r3, r3, l_HIO@l /* 0x80CB284C@l */
...
/* 80CB1FE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CB1FE4  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CB2030  3D 60 80 CB */	lis r11, lit_3739@ha /* 0x80CB26C8@ha */
/* 80CB2034  C0 2B 26 C8 */	lfs f1, lit_3739@l(r11)  /* 0x80CB26C8@l */
/* 80CB2038  4B 39 B4 95 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80CB2088  3D 60 80 CB */	lis r11, lit_3739@ha /* 0x80CB26C8@ha */
/* 80CB208C  C0 2B 26 C8 */	lfs f1, lit_3739@l(r11)  /* 0x80CB26C8@l */
/* 80CB2090  4B 39 B4 3D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80CB2094  90 7D 05 DC */	stw r3, 0x5dc(r29)
/* 80CB2098  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80CB209C  7C 03 07 74 */	extsb r3, r0
/* 80CB20A0  4B 37 AF CD */	bl dComIfGp_getReverb__Fi
...
/* 80CB20B4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80CB20B8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80CB20CC  3D 00 80 CB */	lis r8, lit_3739@ha /* 0x80CB26C8@ha */
/* 80CB20D0  C0 28 26 C8 */	lfs f1, lit_3739@l(r8)  /* 0x80CB26C8@l */
/* 80CB20D4  FC 40 08 90 */	fmr f2, f1
/* 80CB20D8  3D 00 80 CB */	lis r8, lit_3814@ha /* 0x80CB26E4@ha */
/* 80CB20DC  C0 68 26 E4 */	lfs f3, lit_3814@l(r8)  /* 0x80CB26E4@l */
/* 80CB20E0  FC 80 18 90 */	fmr f4, f3
/* 80CB20E4  39 00 00 00 */	li r8, 0
/* 80CB20E8  4B 5F A4 25 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80CB20EC:
...
/* 80CB2100  4B 6A FF 85 */	bl __ptmf_scall
...
/* 80CB212C  4B 6B 00 F9 */	bl _restgpr_28
