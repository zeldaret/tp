...
/* 80C0BF54  4B 75 62 81 */	bl _savegpr_27
/* 80C0BF58  7C 7C 1B 78 */	mr r28, r3
/* 80C0BF5C  FF C0 08 90 */	fmr f30, f1
/* 80C0BF60  7C 9D 23 78 */	mr r29, r4
/* 80C0BF64  3C 60 80 C1 */	lis r3, m__17daObj_GrA_Param_c@ha /* 0x80C0FA7C@ha */
/* 80C0BF68  3B E3 FA 7C */	addi r31, r3, m__17daObj_GrA_Param_c@l /* 0x80C0FA7C@l */
/* 80C0BF6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C0BF70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C0BFB8  4B 73 B3 E5 */	bl PSVECSquareDistance
...
/* 80C0C028  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C0C02C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C0C098  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C0C09C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C0C0A0:
/* 80C0C0A0  FC 40 F8 90 */	fmr f2, f31
/* 80C0C0A4  4B 65 B5 D1 */	bl cM_atan2s__Fff
/* 80C0C0A8  7C 60 07 34 */	extsh r0, r3
/* 80C0C0AC  C0 1F 01 1C */	lfs f0, 0x11c(r31)
/* 80C0C0B0  D0 01 00 9C */	stfs f0, 0x9c(r1)
/* 80C0C0B4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80C0C0B8  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80C0C108  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0C10C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C0C110  4B 73 A3 A1 */	bl PSMTXCopy
/* 80C0C114  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0C118  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C0C148  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0C14C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C0C150  4B 73 A3 61 */	bl PSMTXCopy
...
/* 80C0C1B8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0C1BC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C0C1C0  4B 73 A2 F1 */	bl PSMTXCopy
...
/* 80C0C1EC  4B 66 4A 19 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80C0C234  4B 66 4B 8D */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 80C0C24C  4B 66 45 61 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 80C0C268  4B 66 45 45 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 80C0C27C  4B 66 43 8D */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C0C2C8  4B 66 4A F9 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 80C0C314  4B 66 42 F5 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C0C334  4B 75 5E ED */	bl _restgpr_27
