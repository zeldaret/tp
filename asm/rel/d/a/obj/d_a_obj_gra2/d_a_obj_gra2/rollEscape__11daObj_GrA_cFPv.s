...
/* 80C09928  4B 75 88 B1 */	bl _savegpr_28
/* 80C0992C  7C 7C 1B 78 */	mr r28, r3
/* 80C09930  3C 60 80 C1 */	lis r3, m__17daObj_GrA_Param_c@ha /* 0x80C0FA7C@ha */
/* 80C09934  3B A3 FA 7C */	addi r29, r3, m__17daObj_GrA_Param_c@l /* 0x80C0FA7C@l */
...
lbl_80C099A8:
/* 80C099A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C099AC  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C099D8  4B 65 D1 5D */	bl __mi__4cXyzCFRC3Vec
...
/* 80C099F8  4B 73 D7 41 */	bl PSVECSquareMag
...
/* 80C09A68  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C09A6C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C09AD8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C09ADC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C09AE0:
...
/* 80C09B10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C09B14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C09B28  4B 46 5F E9 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 80C09B68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C09B6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C09B80  4B 46 5F 91 */	bl StartQuake__12dVibration_cFii4cXyz
/* 80C09B84  38 00 00 01 */	li r0, 1
/* 80C09B88  98 1C 20 05 */	stb r0, 0x2005(r28)
/* 80C09B8C  48 00 00 34 */	b lbl_80C09BC0
lbl_80C09B90:
/* 80C09B90  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C09B94  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C09B98  3B E3 5B D4 */	addi r31, r3, 0x5bd4
/* 80C09B9C  7F E3 FB 78 */	mr r3, r31
/* 80C09BA0  4B 46 62 BD */	bl CheckQuake__12dVibration_cFv
...
/* 80C09BB4  4B 46 61 E1 */	bl StopQuake__12dVibration_cFi
lbl_80C09BB8:
...
/* 80C09BC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C09BCC  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80C09BF8:
/* 80C09BF8  3C 60 80 45 */	lis r3, g_dComIfGoat_gameInfo@ha /* 0x80450618@ha */
/* 80C09BFC  84 03 06 18 */	lwzu r0, g_dComIfGoat_gameInfo@l(r3)  /* 0x80450618@l */
...
/* 80C09C30  4B 54 BA 45 */	bl daNpcF_onEvtBit__FUl
lbl_80C09C34:
...
/* 80C09C54  4B 41 31 A9 */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C09C74  4B 46 61 E9 */	bl CheckQuake__12dVibration_cFv
...
/* 80C09C88  4B 46 61 0D */	bl StopQuake__12dVibration_cFi
lbl_80C09C8C:
/* 80C09C8C  7F 83 E3 78 */	mr r3, r28
/* 80C09C90  4B 40 FF ED */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80C09CA4  4B 54 3D 05 */	bl isPath__16daBaseNpc_path_cFv
...
/* 80C09CD4  4B 54 3D 91 */	bl chkPnt__16daBaseNpc_path_cF4cXyz
...
/* 80C09CE8  4B 54 3D DD */	bl setNextPnt__16daBaseNpc_path_cFv
...
/* 80C09D58  4B 66 69 E9 */	bl cLib_chaseF__FPfff
/* 80C09D5C  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 80C09D60  38 81 00 54 */	addi r4, r1, 0x54
/* 80C09D64  4B 66 6E A1 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80C09D78  4B 66 68 91 */	bl cLib_addCalcAngleS2__FPssss
/* 80C09D7C  A8 1C 04 DE */	lha r0, 0x4de(r28)
/* 80C09D80  7C 7E 00 50 */	subf r3, r30, r0
/* 80C09D84  4B 75 B3 4D */	bl abs
...
/* 80C09DA0  4B 66 68 69 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C09DC0  4B 66 68 49 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C09DDC  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 80C09DE0  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
/* 80C09E24  4B 66 5C 19 */	bl cLib_addCalc2__FPffff
...
/* 80C09EA4  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 0x80451180@ha */
/* 80C09EA8  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)  /* 0x80451180@l */
...
lbl_80C09EC8:
/* 80C09EC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C09ECC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C09ED0  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C09ED4  38 80 00 1F */	li r4, 0x1f
/* 80C09ED8  4B 46 5E BD */	bl StopQuake__12dVibration_cFi
...
/* 80C09EF4  4B 75 83 31 */	bl _restgpr_28
