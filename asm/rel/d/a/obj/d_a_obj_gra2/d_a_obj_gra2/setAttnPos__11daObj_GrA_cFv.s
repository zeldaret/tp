...
/* 80C02980  4B 75 F8 5D */	bl _savegpr_29
/* 80C02984  7C 7D 1B 78 */	mr r29, r3
/* 80C02988  3C 80 80 C1 */	lis r4, lit_1109@ha /* 0x80C108A0@ha */
/* 80C0298C  3B C4 08 A0 */	addi r30, r4, lit_1109@l /* 0x80C108A0@l */
/* 80C02990  3C 80 80 C1 */	lis r4, m__17daObj_GrA_Param_c@ha /* 0x80C0FA7C@ha */
/* 80C02994  3B E4 FA 7C */	addi r31, r4, m__17daObj_GrA_Param_c@l /* 0x80C0FA7C@l */
...
/* 80C029C4  3C 80 80 C0 */	lis r4, __dt__4cXyzFv@ha /* 0x80C04C40@ha */
/* 80C029C8  38 84 4C 40 */	addi r4, r4, __dt__4cXyzFv@l /* 0x80C04C40@l */
...
/* 80C029F0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C029F4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C029F8  4B 74 3A B9 */	bl PSMTXCopy
/* 80C029FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C02A00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C02A04  38 9E 02 00 */	addi r4, r30, 0x200
/* 80C02A08  38 BD 05 38 */	addi r5, r29, 0x538
/* 80C02A0C  4B 74 43 61 */	bl PSMTXMultVec
/* 80C02A10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C02A14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80C02A48  4B 75 F7 E1 */	bl _restgpr_29
