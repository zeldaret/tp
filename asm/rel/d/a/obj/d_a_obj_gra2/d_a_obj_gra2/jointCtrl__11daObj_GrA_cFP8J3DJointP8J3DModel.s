...
/* 80C00ADC  4B 76 16 FD */	bl _savegpr_28
...
/* 80C00AFC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C00B00  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C00B04  4B 74 59 AD */	bl PSMTXCopy
...
lbl_80C00B28:
/* 80C00B28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C00B2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C00B30  38 81 00 44 */	addi r4, r1, 0x44
/* 80C00B34  4B 74 59 7D */	bl PSMTXCopy
...
/* 80C00B50  3C 60 80 C1 */	lis r3, lit_4333@ha /* 0x80C0FB98@ha */
/* 80C00B54  C0 03 FB 98 */	lfs f0, lit_4333@l(r3)  /* 0x80C0FB98@l */
...
/* 80C00B68  4B 40 C3 A5 */	bl ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80C00B6C  A8 1C 09 C8 */	lha r0, 0x9c8(r28)
/* 80C00B70  3C 60 80 C1 */	lis r3, lit_4501@ha /* 0x80C0FBAC@ha */
/* 80C00B74  C8 43 FB AC */	lfd f2, lit_4501@l(r3)  /* 0x80C0FBAC@l */
...
/* 80C00B90  3C 60 80 C1 */	lis r3, m__17daObj_GrA_Param_c@ha /* 0x80C0FA7C@ha */
/* 80C00B94  38 63 FA 7C */	addi r3, r3, m__17daObj_GrA_Param_c@l /* 0x80C0FA7C@l */
...
/* 80C00C30  4B 40 C3 15 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C00C34  48 00 00 0C */	b lbl_80C00C40
lbl_80C00C38:
/* 80C00C38  38 7C 09 C2 */	addi r3, r28, 0x9c2
/* 80C00C3C  4B 40 C3 09 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80C00C40:
/* 80C00C40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C00C44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C00C48  7C 64 1B 78 */	mr r4, r3
/* 80C00C4C  4B 74 59 65 */	bl PSMTXInverse
/* 80C00C50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C00C54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C00C58  38 81 00 14 */	addi r4, r1, 0x14
/* 80C00C5C  4B 74 58 55 */	bl PSMTXCopy
/* 80C00C60  38 61 00 08 */	addi r3, r1, 8
/* 80C00C64  4B 40 C1 01 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C00C68  38 7C 09 1A */	addi r3, r28, 0x91a
/* 80C00C6C  4B 40 C2 D9 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
...
/* 80C00C98  4B 40 C2 AD */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C00C9C  48 00 00 18 */	b lbl_80C00CB4
lbl_80C00CA0:
/* 80C00CA0  38 7C 09 C2 */	addi r3, r28, 0x9c2
/* 80C00CA4  4B 40 C2 A1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C00CA8  48 00 00 0C */	b lbl_80C00CB4
lbl_80C00CAC:
/* 80C00CAC  38 7C 09 C8 */	addi r3, r28, 0x9c8
/* 80C00CB0  4B 40 C2 95 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80C00CB4:
/* 80C00CB4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C00CB8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C00CBC  38 81 00 14 */	addi r4, r1, 0x14
/* 80C00CC0  7C 65 1B 78 */	mr r5, r3
/* 80C00CC4  4B 74 58 21 */	bl PSMTXConcat
/* 80C00CC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C00CCC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C00CD0  38 81 00 44 */	addi r4, r1, 0x44
/* 80C00CD4  7C 65 1B 78 */	mr r5, r3
/* 80C00CD8  4B 74 58 0D */	bl PSMTXConcat
lbl_80C00CDC:
/* 80C00CDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C00CE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C00CE4  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 80C00CE8  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C00CEC  7C 80 F2 14 */	add r4, r0, r30
/* 80C00CF0  4B 74 57 C1 */	bl PSMTXCopy
/* 80C00CF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C00CF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C00CFC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80C00D00  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80C00D04  4B 74 57 AD */	bl PSMTXCopy
...
/* 80C00D34  4B 40 CC 5D */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80C00D48  4B 76 14 DD */	bl _restgpr_28
