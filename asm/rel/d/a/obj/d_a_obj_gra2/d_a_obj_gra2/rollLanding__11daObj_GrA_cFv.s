...
/* 80C09F20  3C 60 80 C1 */	lis r3, m__17daObj_GrA_Param_c@ha /* 0x80C0FA7C@ha */
/* 80C09F24  3B C3 FA 7C */	addi r30, r3, m__17daObj_GrA_Param_c@l /* 0x80C0FA7C@l */
...
/* 80C09F5C  4B 40 2E 09 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C09F60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C09F64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C09F68  A8 9F 09 1C */	lha r4, 0x91c(r31)
/* 80C09F6C  4B 40 24 C9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C09F70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C09F74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C09F78  38 81 00 18 */	addi r4, r1, 0x18
/* 80C09F7C  38 BF 0C 88 */	addi r5, r31, 0xc88
/* 80C09F80  4B 73 CD ED */	bl PSMTXMultVec
...
/* 80C09FB8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C09FBC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C09FD0  4B 46 5A 55 */	bl StartShock__12dVibration_cFii4cXyz
