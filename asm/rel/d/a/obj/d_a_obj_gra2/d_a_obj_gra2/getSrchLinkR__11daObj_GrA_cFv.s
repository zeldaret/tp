...
/* 80C07C50  3C 60 80 C1 */	lis r3, lit_5726@ha /* 0x80C0FCB0@ha */
/* 80C07C54  C0 23 FC B0 */	lfs f1, lit_5726@l(r3)  /* 0x80C0FCB0@l */
/* 80C07C58  3C 60 80 C1 */	lis r3, m__17daObj_GrA_Param_c@ha /* 0x80C0FA7C@ha */
/* 80C07C5C  38 63 FA 7C */	addi r3, r3, m__17daObj_GrA_Param_c@l /* 0x80C0FA7C@l */
...
/* 80C07C70  3C 60 80 C1 */	lis r3, lit_4501@ha /* 0x80C0FBAC@ha */
/* 80C07C74  C8 23 FB AC */	lfd f1, lit_4501@l(r3)  /* 0x80C0FBAC@l */
