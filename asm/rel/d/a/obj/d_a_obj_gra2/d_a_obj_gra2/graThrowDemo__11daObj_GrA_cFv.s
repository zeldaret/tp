...
/* 80C0B9BC  4B 75 68 19 */	bl _savegpr_27
/* 80C0B9C0  7C 7C 1B 78 */	mr r28, r3
/* 80C0B9C4  3C 60 80 C1 */	lis r3, m__17daObj_GrA_Param_c@ha /* 0x80C0FA7C@ha */
/* 80C0B9C8  3B E3 FA 7C */	addi r31, r3, m__17daObj_GrA_Param_c@l /* 0x80C0FA7C@l */
/* 80C0B9CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C0B9D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C0B9EC  4B 57 5C 55 */	bl dCam_getBody__Fv
...
lbl_80C0BA20:
/* 80C0BA20  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C0BA24  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C0BA28  88 03 4F AD */	lbz r0, 0x4fad(r3)
/* 80C0BA2C  28 00 00 00 */	cmplwi r0, 0
/* 80C0BA30  41 82 03 48 */	beq lbl_80C0BD78
/* 80C0BA34  3C 60 80 C1 */	lis r3, lit_8967@ha /* 0x80C10320@ha */
/* 80C0BA38  38 83 03 20 */	addi r4, r3, lit_8967@l /* 0x80C10320@l */
...
/* 80C0BA6C  4B 55 5A 65 */	bl Stop__9dCamera_cFv
...
/* 80C0BA90  4B 57 64 09 */	bl Center__9dCamera_cFv
...
/* 80C0BAB4  4B 57 63 B1 */	bl Eye__9dCamera_cFv
...
/* 80C0BAD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0BAD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C0BAD8  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C0BADC  4B 40 09 01 */	bl mDoMtx_YrotS__FPA4_fs
...
lbl_80C0BBA0:
/* 80C0BBA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0BBA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C0BBA8  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C0BBAC  4B 40 08 31 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80C0BBC0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0BBC4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C0BBC8  38 9C 20 90 */	addi r4, r28, 0x2090
/* 80C0BBCC  7C 85 23 78 */	mr r5, r4
/* 80C0BBD0  4B 73 B1 9D */	bl PSMTXMultVec
/* 80C0BBD4  38 7C 20 90 */	addi r3, r28, 0x2090
/* 80C0BBD8  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 80C0BBDC  7C 65 1B 78 */	mr r5, r3
/* 80C0BBE0  4B 73 B4 B1 */	bl PSVECAdd
...
/* 80C0BC18  4B 66 4F ED */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80C0BC1C  7C 64 07 34 */	extsh r4, r3
/* 80C0BC20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0BC24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C0BC28  4B 40 07 B5 */	bl mDoMtx_YrotS__FPA4_fs
/* 80C0BC2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C0BC30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C0BC34  38 81 00 5C */	addi r4, r1, 0x5c
/* 80C0BC38  7C 85 23 78 */	mr r5, r4
/* 80C0BC3C  4B 73 B1 31 */	bl PSMTXMultVec
/* 80C0BC40  38 61 00 5C */	addi r3, r1, 0x5c
/* 80C0BC44  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C0BC48  7C 65 1B 78 */	mr r5, r3
/* 80C0BC4C  4B 73 B4 45 */	bl PSVECAdd
/* 80C0BC50  38 7C 20 58 */	addi r3, r28, 0x2058
/* 80C0BC54  38 81 00 5C */	addi r4, r1, 0x5c
/* 80C0BC58  7F 85 E3 78 */	mr r5, r28
/* 80C0BC5C  4B 41 20 0D */	bl lineCheck__11fopAcM_lc_cFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 80C0BC98  4B 66 44 E1 */	bl cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
/* 80C0BCAC  4B 66 44 CD */	bl cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
/* 80C0BCF8  4B 66 44 81 */	bl cLib_addCalcPos2__FP4cXyzRC4cXyzff
/* 80C0BCFC  48 00 00 28 */	b lbl_80C0BD24
lbl_80C0BD00:
/* 80C0BD00  38 7D 02 48 */	addi r3, r29, 0x248
/* 80C0BD04  4B 55 57 A9 */	bl Start__9dCamera_cFv
/* 80C0BD08  38 7D 02 48 */	addi r3, r29, 0x248
/* 80C0BD0C  38 80 00 00 */	li r4, 0
/* 80C0BD10  4B 55 72 FD */	bl SetTrimSize__9dCamera_cFl
...
/* 80C0BD74  4B 57 4D 6D */	bl Set__9dCamera_cF4cXyz4cXyzfs
lbl_80C0BD78:
/* 80C0BD78  39 61 00 80 */	addi r11, r1, 0x80
/* 80C0BD7C  4B 75 64 A5 */	bl _restgpr_27
