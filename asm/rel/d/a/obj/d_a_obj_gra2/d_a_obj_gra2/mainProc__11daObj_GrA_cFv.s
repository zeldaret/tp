...
/* 80C01D94  4B 76 04 49 */	bl _savegpr_29
/* 80C01D98  7C 7E 1B 78 */	mr r30, r3
/* 80C01D9C  3C 80 80 C1 */	lis r4, m__17daObj_GrA_Param_c@ha /* 0x80C0FA7C@ha */
/* 80C01DA0  3B E4 FA 7C */	addi r31, r4, m__17daObj_GrA_Param_c@l /* 0x80C0FA7C@l */
...
/* 80C01DBC  4B 41 87 8D */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80C01DDC  4B 76 02 3D */	bl __ptmf_test
...
/* 80C01DF4  4B 76 02 91 */	bl __ptmf_scall
...
/* 80C01E14  4B 66 4D 21 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C01E34  4B 74 53 05 */	bl PSVECSquareMag
...
/* 80C01EA4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C01EA8  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C01F14  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C01F18  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C01F5C  4B 66 EC A9 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80C01F70  4B 66 EE 51 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
lbl_80C01F74:
...
/* 80C01F8C  3C A0 80 C1 */	lis r5, l_evtNameList@ha /* 0x80C1004C@ha */
/* 80C01F90  38 A5 00 4C */	addi r5, r5, l_evtNameList@l /* 0x80C1004C@l */
/* 80C01F94  7C A5 00 2E */	lwzx r5, r5, r0
/* 80C01F98  4B 54 D0 5D */	bl orderEvent__11daBaseNpc_cFiPc
lbl_80C01F9C:
...
/* 80C01FD0  4B 76 02 59 */	bl _restgpr_29
