...
/* 80C04C9C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80C04CA0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80C04CC0  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80C04CC4  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 80C04CDC  3C 60 80 C1 */	lis r3, __vt__8cM3dGSph@ha /* 0x80C10858@ha */
/* 80C04CE0  38 03 08 58 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80C10858@l */
/* 80C04CE4  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_80C04CE8:
/* 80C04CE8  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80C04CEC  41 82 00 24 */	beq lbl_80C04D10
/* 80C04CF0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80C04CF4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80C04CF8  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C04CFC  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80C04D00  41 82 00 10 */	beq lbl_80C04D10
/* 80C04D04  3C 60 80 C1 */	lis r3, __vt__8cM3dGAab@ha /* 0x80C1087C@ha */
/* 80C04D08  38 03 08 7C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80C1087C@l */
/* 80C04D0C  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_80C04D10:
/* 80C04D10  7F C3 F3 78 */	mr r3, r30
/* 80C04D14  38 80 00 00 */	li r4, 0
/* 80C04D18  4B 47 F3 CD */	bl __dt__12dCcD_GObjInfFv
/* 80C04D1C  7F E0 07 35 */	extsh. r0, r31
/* 80C04D20  40 81 00 0C */	ble lbl_80C04D2C
/* 80C04D24  7F C3 F3 78 */	mr r3, r30
/* 80C04D28  4B 6C A0 15 */	bl __dl__FPv
lbl_80C04D2C:
