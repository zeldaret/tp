...
/* 80C0D30C  4B 75 4E D1 */	bl _savegpr_29
/* 80C0D310  7C 7D 1B 78 */	mr r29, r3
/* 80C0D314  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C0D318  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C0D334  4B 54 05 05 */	bl getActor__18daBaseNpc_acMngr_cFv
/* 80C0D338  7C 7E 1B 78 */	mr r30, r3
/* 80C0D33C  38 7F 02 48 */	addi r3, r31, 0x248
/* 80C0D340  4B 55 41 6D */	bl Start__9dCamera_cFv
/* 80C0D344  38 7F 02 48 */	addi r3, r31, 0x248
/* 80C0D348  38 80 00 00 */	li r4, 0
/* 80C0D34C  4B 55 5C C1 */	bl SetTrimSize__9dCamera_cFl
/* 80C0D350  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C0D354  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C0D358  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80C0D35C  4B 43 51 0D */	bl reset__14dEvt_control_cFv
...
/* 80C0D370  4B 54 04 AD */	bl entry__18daBaseNpc_acMngr_cFP10fopAc_ac_c
/* 80C0D374  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C0D378  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C0D37C  88 9D 0A 7F */	lbz r4, 0xa7f(r29)
/* 80C0D380  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80C0D384  7C 05 07 74 */	extsb r5, r0
/* 80C0D388  4B 42 7E 79 */	bl onSwitch__10dSv_info_cFii
/* 80C0D38C  38 60 00 01 */	li r3, 1
/* 80C0D390  39 61 00 20 */	addi r11, r1, 0x20
/* 80C0D394  4B 75 4E 95 */	bl _restgpr_29
