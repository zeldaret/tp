...
/* 8059BA34  3C 60 80 5A */	lis r3, l_arcName@ha /* 0x8059C6FC@ha */
/* 8059BA38  38 63 C6 FC */	addi r3, r3, l_arcName@l /* 0x8059C6FC@l */
/* 8059BA3C  80 63 00 00 */	lwz r3, 0(r3)
/* 8059BA40  38 80 00 04 */	li r4, 4
/* 8059BA44  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8059BA48  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8059BA5C  4B AA 08 91 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8059BA6C  4B A7 91 E9 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8059BA8C  4B D3 31 C1 */	bl __nw__FUl
/* 8059BA90  7C 60 1B 79 */	or. r0, r3, r3
/* 8059BA94  41 82 00 0C */	beq lbl_8059BAA0
/* 8059BA98  4B AD FE D9 */	bl __ct__4dBgWFv
...
/* 8059BAB0  3C 60 80 5A */	lis r3, l_arcName@ha /* 0x8059C6FC@ha */
/* 8059BAB4  38 63 C6 FC */	addi r3, r3, l_arcName@l /* 0x8059C6FC@l */
/* 8059BAB8  80 63 00 00 */	lwz r3, 0(r3)
/* 8059BABC  3C 80 80 5A */	lis r4, l_dzbIdx@ha /* 0x8059C6A4@ha */
/* 8059BAC0  38 84 C6 A4 */	addi r4, r4, l_dzbIdx@l /* 0x8059C6A4@l */
/* 8059BAC4  80 84 00 00 */	lwz r4, 0(r4)
/* 8059BAC8  7F C5 F3 78 */	mr r5, r30
/* 8059BACC  38 C0 00 80 */	li r6, 0x80
/* 8059BAD0  4B AA 08 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8059BAE4  4B AD E4 55 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
