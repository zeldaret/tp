...
/* 8059B934  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8059B938  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8059B93C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8059B940  80 9F 05 B8 */	lwz r4, 0x5b8(r31)
/* 8059B944  7F E5 FB 78 */	mr r5, r31
/* 8059B948  4B AD 90 C1 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 8059B97C  4B A7 EB FD */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 8059B980  3C 60 80 5A */	lis r3, rideCallBack__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 0x8059B4EC@ha */
/* 8059B984  38 03 B4 EC */	addi r0, r3, rideCallBack__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 0x8059B4EC@l */
...
/* 8059B9A0  3C 60 80 5A */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x8059B754@ha */
/* 8059B9A4  38 03 B7 54 */	addi r0, r3, nodeCallBack__FP8J3DJointi@l /* 0x8059B754@l */
/* 8059B9A8  90 04 00 04 */	stw r0, 4(r4)
/* 8059B9AC  80 7F 05 A8 */	lwz r3, 0x5a8(r31)
/* 8059B9B0  93 E3 00 14 */	stw r31, 0x14(r3)
/* 8059B9B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8059B9B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8059B9CC  4B A9 99 95 */	bl isSwitch__10dSv_info_cCFii
/* 8059B9D0  2C 03 00 00 */	cmpwi r3, 0
/* 8059B9D4  41 82 00 18 */	beq lbl_8059B9EC
/* 8059B9D8  3C 60 80 5A */	lis r3, lit_3815@ha /* 0x8059C6B8@ha */
/* 8059B9DC  C0 03 C6 B8 */	lfs f0, lit_3815@l(r3)  /* 0x8059C6B8@l */
...
/* 8059B9F0  4B AD FF D1 */	bl Move__4dBgWFv
