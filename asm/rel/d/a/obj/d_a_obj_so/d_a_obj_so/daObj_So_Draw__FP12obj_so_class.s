...
/* 80CE0400  4B 68 1D D5 */	bl _savegpr_27
/* 80CE0404  7C 7F 1B 78 */	mr r31, r3
/* 80CE0408  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CE040C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CE0410  38 80 00 10 */	li r4, 0x10
/* 80CE0414  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CE0418  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CE041C  4B 4C 33 A9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CE0420  A8 1F 05 62 */	lha r0, 0x562(r31)
/* 80CE0424  2C 00 00 00 */	cmpwi r0, 0
/* 80CE0428  41 82 00 24 */	beq lbl_80CE044C
/* 80CE042C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CE0430  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CE0434  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80CE0438  80 84 00 04 */	lwz r4, 4(r4)
/* 80CE043C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CE0440  4B 4C 49 61 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CE0444  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80CE0448  4B 32 D8 7D */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80CE044C:
...
/* 80CE0464  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CE0468  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 80CE047C  4B 4C 49 25 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CE0480  80 7C 05 94 */	lwz r3, 0x594(r28)
/* 80CE0484  4B 32 D8 41 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80CE04B0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CE04B4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CE04B8  80 9C 1A 98 */	lwz r4, 0x1a98(r28)
/* 80CE04BC  80 84 00 04 */	lwz r4, 4(r4)
/* 80CE04C0  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CE04C4  4B 4C 48 DD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CE04C8  80 7C 1A 98 */	lwz r3, 0x1a98(r28)
/* 80CE04CC  4B 32 D7 F9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_80CE04D0:
...
/* 80CE04E8  4B 68 1D 39 */	bl _restgpr_27
