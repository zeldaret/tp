...
/* 80CE0754  4B 68 1A 5D */	bl _savegpr_18
/* 80CE0758  7C 7E 1B 78 */	mr r30, r3
/* 80CE075C  7C 94 23 78 */	mr r20, r4
/* 80CE0760  3C 60 80 CE */	lis r3, lit_3779@ha /* 0x80CE39E8@ha */
/* 80CE0764  3B E3 39 E8 */	addi r31, r3, lit_3779@l /* 0x80CE39E8@l */
/* 80CE0768  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE076C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0770  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80CE0774  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80CE0778  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80CE077C  4B 66 61 6D */	bl PSMTXTrans
/* 80CE0780  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE0784  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0788  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CE078C  4B 32 BC A9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CE0790  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE0794  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0798  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80CE079C  4B 32 BC 01 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CE07A0  C0 3E 04 EC */	lfs f1, 0x4ec(r30)
/* 80CE07A4  FC 40 08 90 */	fmr f2, f1
/* 80CE07A8  FC 60 08 90 */	fmr f3, f1
/* 80CE07AC  4B 32 C6 8D */	bl scaleM__14mDoMtx_stack_cFfff
...
lbl_80CE07D8:
/* 80CE07D8  4B 32 C4 F1 */	bl push__14mDoMtx_stack_cFv
...
/* 80CE080C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE0810  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0814  38 81 00 08 */	addi r4, r1, 8
/* 80CE0818  7E 5E B2 14 */	add r18, r30, r22
/* 80CE081C  38 B2 06 18 */	addi r5, r18, 0x618
/* 80CE0820  4B 66 65 4D */	bl PSMTXMultVec
...
/* 80CE0854  4B 58 71 39 */	bl cM_rndFX__Ff
...
/* 80CE087C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE0880  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0884  38 18 F0 E8 */	addi r0, r24, -3864
/* 80CE0888  7C 04 07 34 */	extsh r4, r0
/* 80CE088C  4B 32 BB A9 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80CE08A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE08AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE08B0  38 81 00 08 */	addi r4, r1, 8
/* 80CE08B4  7E 5E B2 14 */	add r18, r30, r22
/* 80CE08B8  38 B2 06 18 */	addi r5, r18, 0x618
/* 80CE08BC  4B 66 64 B1 */	bl PSMTXMultVec
...
lbl_80CE0910:
/* 80CE0910  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE0914  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0918  38 18 47 18 */	addi r0, r24, 0x4718
/* 80CE091C  7C 04 07 34 */	extsh r4, r0
/* 80CE0920  4B 32 BB 15 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80CE0968  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE096C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0970  38 81 00 08 */	addi r4, r1, 8
/* 80CE0974  7E 5E B2 14 */	add r18, r30, r22
/* 80CE0978  38 B2 06 18 */	addi r5, r18, 0x618
/* 80CE097C  4B 66 63 F1 */	bl PSMTXMultVec
...
lbl_80CE09B4:
/* 80CE09B4  4B 32 C3 61 */	bl pop__14mDoMtx_stack_cFv
...
/* 80CE09F8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80CE09FC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80CE0A00  80 63 00 00 */	lwz r3, 0(r3)
/* 80CE0A04  38 1A 1E FF */	addi r0, r26, 0x1eff
/* 80CE0A08  7C 04 07 34 */	extsh r4, r0
/* 80CE0A0C  4B 32 B9 D1 */	bl mDoMtx_YrotS__FPA4_fs
/* 80CE0A10  48 00 00 38 */	b lbl_80CE0A48
lbl_80CE0A14:
/* 80CE0A14  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80CE0A18  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80CE0A1C  80 63 00 00 */	lwz r3, 0(r3)
/* 80CE0A20  38 1B 25 3B */	addi r0, r27, 0x253b
/* 80CE0A24  7C 04 07 34 */	extsh r4, r0
/* 80CE0A28  4B 32 B9 B5 */	bl mDoMtx_YrotS__FPA4_fs
/* 80CE0A2C  C0 3F 00 44 */	lfs f1, 0x44(r31)
/* 80CE0A30  4B 58 6F 5D */	bl cM_rndFX__Ff
...
/* 80CE0A4C  4B 58 6F 09 */	bl cM_rndF__Ff
...
/* 80CE0A60  4B 58 6F 2D */	bl cM_rndFX__Ff
...
/* 80CE0A7C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80CE0A80  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
lbl_80CE0ADC:
/* 80CE0ADC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80CE0AE0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80CE0AE4  80 63 00 00 */	lwz r3, 0(r3)
/* 80CE0AE8  38 1D 15 54 */	addi r0, r29, 0x1554
/* 80CE0AEC  7C 04 07 34 */	extsh r4, r0
/* 80CE0AF0  4B 32 B8 ED */	bl mDoMtx_YrotS__FPA4_fs
/* 80CE0AF4  C0 3F 00 44 */	lfs f1, 0x44(r31)
/* 80CE0AF8  4B 58 6E 95 */	bl cM_rndFX__Ff
...
/* 80CE0B14  4B 58 6E 41 */	bl cM_rndF__Ff
...
/* 80CE0B28  4B 58 6E 65 */	bl cM_rndFX__Ff
...
/* 80CE0B44  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80CE0B48  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80CE0B4C  80 63 00 00 */	lwz r3, 0(r3)
/* 80CE0B50  38 1C 60 00 */	addi r0, r28, 0x6000
/* 80CE0B54  7C 04 07 34 */	extsh r4, r0
/* 80CE0B58  4B 32 B8 85 */	bl mDoMtx_YrotS__FPA4_fs
/* 80CE0B5C  48 00 00 44 */	b lbl_80CE0BA0
lbl_80CE0B60:
/* 80CE0B60  C0 3F 00 5C */	lfs f1, 0x5c(r31)
/* 80CE0B64  4B 58 6E 29 */	bl cM_rndFX__Ff
/* 80CE0B68  FC 00 08 1E */	fctiwz f0, f1
/* 80CE0B6C  D8 01 00 18 */	stfd f0, 0x18(r1)
/* 80CE0B70  80 81 00 1C */	lwz r4, 0x1c(r1)
/* 80CE0B74  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80CE0B78  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80CE0B7C  80 63 00 00 */	lwz r3, 0(r3)
/* 80CE0B80  4B 32 B8 5D */	bl mDoMtx_YrotS__FPA4_fs
/* 80CE0B84  C0 3F 00 60 */	lfs f1, 0x60(r31)
/* 80CE0B88  4B 58 6E 05 */	bl cM_rndFX__Ff
...
/* 80CE0BBC  4B 58 6D 99 */	bl cM_rndF__Ff
...
/* 80CE0BD0  4B 58 6D BD */	bl cM_rndFX__Ff
...
/* 80CE0BEC  4B 59 03 01 */	bl MtxPosition__FP4cXyzP4cXyz
/* 80CE0BF0  C0 3F 00 5C */	lfs f1, 0x5c(r31)
/* 80CE0BF4  4B 58 6D 99 */	bl cM_rndFX__Ff
...
/* 80CE0C40  4B 68 15 BD */	bl _restgpr_18
