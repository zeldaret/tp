...
/* 80CE36F0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CE36F4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80CE3714  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CE3718  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80CE3730  3C 60 80 CE */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CE3C18@ha */
/* 80CE3734  38 03 3C 18 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CE3C18@l */
/* 80CE3738  90 1E 01 38 */	stw r0, 0x138(r30)
lbl_80CE373C:
/* 80CE373C  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80CE3740  41 82 00 24 */	beq lbl_80CE3764
/* 80CE3744  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CE3748  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CE374C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80CE3750  34 1E 01 04 */	addic. r0, r30, 0x104
/* 80CE3754  41 82 00 10 */	beq lbl_80CE3764
/* 80CE3758  3C 60 80 CE */	lis r3, __vt__8cM3dGAab@ha /* 0x80CE3C0C@ha */
/* 80CE375C  38 03 3C 0C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CE3C0C@l */
/* 80CE3760  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_80CE3764:
/* 80CE3764  7F C3 F3 78 */	mr r3, r30
/* 80CE3768  38 80 00 00 */	li r4, 0
/* 80CE376C  4B 3A 09 79 */	bl __dt__12dCcD_GObjInfFv
/* 80CE3770  7F E0 07 35 */	extsh. r0, r31
/* 80CE3774  40 81 00 0C */	ble lbl_80CE3780
/* 80CE3778  7F C3 F3 78 */	mr r3, r30
/* 80CE377C  4B 5E B5 C1 */	bl __dl__FPv
lbl_80CE3780:
