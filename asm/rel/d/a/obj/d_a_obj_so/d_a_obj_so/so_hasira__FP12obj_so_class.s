...
/* 80CE0534  4B 68 1C A9 */	bl _savegpr_29
/* 80CE0538  7C 7D 1B 78 */	mr r29, r3
/* 80CE053C  3C 60 80 CE */	lis r3, lit_3779@ha /* 0x80CE39E8@ha */
/* 80CE0540  3B C3 39 E8 */	addi r30, r3, lit_3779@l /* 0x80CE39E8@l */
/* 80CE0544  38 00 00 33 */	li r0, 0x33
/* 80CE0548  B0 01 00 08 */	sth r0, 8(r1)
/* 80CE054C  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 80CE0550  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 80CE0554  38 81 00 08 */	addi r4, r1, 8
/* 80CE0558  4B 33 92 A1 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80CE055C  7C 7F 1B 79 */	or. r31, r3, r3
/* 80CE0560  41 82 01 CC */	beq lbl_80CE072C
/* 80CE0564  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE0568  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE056C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80CE0570  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80CE0574  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80CE0578  4B 66 63 71 */	bl PSMTXTrans
/* 80CE057C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE0580  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0584  A8 9F 07 2E */	lha r4, 0x72e(r31)
/* 80CE0588  4B 32 BE AD */	bl mDoMtx_YrotM__FPA4_fs
/* 80CE058C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE0590  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE0594  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80CE0598  4B 32 BE 05 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CE059C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE05A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CE05A4  A8 1F 07 2E */	lha r0, 0x72e(r31)
/* 80CE05A8  7C 00 00 D0 */	neg r0, r0
/* 80CE05AC  7C 04 07 34 */	extsh r4, r0
/* 80CE05B0  4B 32 BE 85 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CE05B4  C0 3E 00 04 */	lfs f1, 4(r30)
/* 80CE05B8  C0 5E 00 08 */	lfs f2, 8(r30)
/* 80CE05BC  FC 60 08 90 */	fmr f3, f1
/* 80CE05C0  4B 32 C7 DD */	bl transM__14mDoMtx_stack_cFfff
/* 80CE05C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CE05C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80CE05F8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CE05FC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80CE062C  4B 58 F4 55 */	bl cLib_addCalc0__FPfff
/* 80CE0630  A8 1D 0D B2 */	lha r0, 0xdb2(r29)
/* 80CE0634  2C 00 00 01 */	cmpwi r0, 1
/* 80CE0638  40 82 00 2C */	bne lbl_80CE0664
/* 80CE063C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE0640  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_80CE0664:
/* 80CE0664  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE0668  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CE0680  4B 33 A2 E5 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80CE0728  4B 58 FE E1 */	bl cLib_addCalcAngleS2__FPssss
lbl_80CE072C:
/* 80CE072C  39 61 00 30 */	addi r11, r1, 0x30
/* 80CE0730  4B 68 1A F9 */	bl _restgpr_29
