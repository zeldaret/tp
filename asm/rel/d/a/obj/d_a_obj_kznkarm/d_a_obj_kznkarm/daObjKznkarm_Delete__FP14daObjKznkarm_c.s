...
/* 80C509CC  3C 80 80 C5 */	lis r4, l_arcName@ha /* 0x80C50DC4@ha */
/* 80C509D0  38 84 0D C4 */	addi r4, r4, l_arcName@l /* 0x80C50DC4@l */
/* 80C509D4  80 84 00 00 */	lwz r4, 0(r4)
/* 80C509D8  4B 3D C6 31 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80C509DC  34 1F 05 B4 */	addic. r0, r31, 0x5b4
/* 80C509E0  41 82 00 2C */	beq lbl_80C50A0C
/* 80C509E4  3C 60 80 C5 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80C50EEC@ha */
/* 80C509E8  38 63 0E EC */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80C50EEC@l */
...
/* 80C50A08  4B 42 55 8D */	bl __dt__9dBgS_AcchFv
lbl_80C50A0C:
/* 80C50A0C  34 1F 05 74 */	addic. r0, r31, 0x574
/* 80C50A10  41 82 00 28 */	beq lbl_80C50A38
/* 80C50A14  3C 60 80 C5 */	lis r3, __vt__12dBgS_AcchCir@ha /* 0x80C50EE0@ha */
/* 80C50A18  38 03 0E E0 */	addi r0, r3, __vt__12dBgS_AcchCir@l /* 0x80C50EE0@l */
/* 80C50A1C  90 1F 05 80 */	stw r0, 0x580(r31)
/* 80C50A20  38 7F 05 88 */	addi r3, r31, 0x588
/* 80C50A24  38 80 FF FF */	li r4, -1
/* 80C50A28  4B 61 E4 F1 */	bl __dt__8cM3dGCirFv
/* 80C50A2C  38 7F 05 74 */	addi r3, r31, 0x574
/* 80C50A30  38 80 00 00 */	li r4, 0
/* 80C50A34  4B 61 76 7D */	bl __dt__13cBgS_PolyInfoFv
lbl_80C50A38:
/* 80C50A38  7F E3 FB 78 */	mr r3, r31
/* 80C50A3C  38 80 00 00 */	li r4, 0
/* 80C50A40  4B 3C 82 4D */	bl __dt__10fopAc_ac_cFv
lbl_80C50A44:
