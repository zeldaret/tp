...
/* 80C4FDCC  4B 71 23 FD */	bl _savegpr_24
/* 80C4FDD0  7C 7D 1B 78 */	mr r29, r3
/* 80C4FDD4  3C 60 80 C5 */	lis r3, M_attr__14daObjKznkarm_c@ha /* 0x80C50D08@ha */
/* 80C4FDD8  3B E3 0D 08 */	addi r31, r3, M_attr__14daObjKznkarm_c@l /* 0x80C50D08@l */
...
/* 80C4FE4C  4B 3C A8 15 */	bl fopAcM_posMove__FP10fopAc_ac_cPC4cXyz
/* 80C4FE50  38 7D 05 B4 */	addi r3, r29, 0x5b4
/* 80C4FE54  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4FE58  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C4FE5C  3B C4 0F 38 */	addi r30, r4, 0xf38
/* 80C4FE60  7F C4 F3 78 */	mr r4, r30
/* 80C4FE64  4B 42 6C 49 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80C4FE7C  4B 6F 72 BD */	bl PSVECSquareMag
...
/* 80C4FEEC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C4FEF0  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C4FF5C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C4FF60  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80C4FF64  48 00 00 08 */	b lbl_80C4FF6C
lbl_80C4FF68:
/* 80C4FF68  FF E0 08 90 */	fmr f31, f1
lbl_80C4FF6C:
/* 80C4FF6C  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C50F10@ha */
/* 80C4FF70  38 03 0F 10 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C50F10@l */
...
/* 80C4FF84  4B 42 47 C1 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C4FF9C  4B 6F 73 2D */	bl C_VECReflect
...
/* 80C4FFB4  4B 6F 71 25 */	bl PSVECScale
...
/* 80C4FFDC  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C50F10@ha */
/* 80C4FFE0  38 03 0F 10 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C50F10@l */
...
/* 80C50020  4B 6F 71 19 */	bl PSVECSquareMag
...
/* 80C50090  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C50094  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C50100  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C50104  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80C50108  48 00 00 08 */	b lbl_80C50110
lbl_80C5010C:
/* 80C5010C  FF E0 08 90 */	fmr f31, f1
lbl_80C50110:
/* 80C50110  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C50F10@ha */
/* 80C50114  38 03 0F 10 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C50F10@l */
...
/* 80C50128  4B 42 46 1D */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C50140  4B 6F 71 89 */	bl C_VECReflect
...
/* 80C50158  4B 6F 6F 81 */	bl PSVECScale
...
/* 80C50190  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha /* 0x80C50F10@ha */
/* 80C50194  38 03 0F 10 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80C50F10@l */
...
/* 80C501E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C501E4  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C501E8  3C 60 80 C5 */	lis r3, w_eff_id@ha /* 0x80C50E88@ha */
/* 80C501EC  3B 63 0E 88 */	addi r27, r3, w_eff_id@l /* 0x80C50E88@l */
lbl_80C501F0:
...
/* 80C5023C  4B 3F D2 91 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C50264  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C50268  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C50294  4B 65 B6 F1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C502E8  4B 6F 6E 51 */	bl PSVECSquareMag
...
/* 80C50358  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C5035C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80C503C8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80C503CC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80C503D0:
...
/* 80C5042C  4B 71 1D E9 */	bl _restgpr_24
