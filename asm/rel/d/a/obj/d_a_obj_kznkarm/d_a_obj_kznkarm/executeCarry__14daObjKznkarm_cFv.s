...
/* 80C4FC30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C4FC34  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C4FC60  4B 3C D5 9D */	bl fopAcM_carryOffRevise__FP10fopAc_ac_c
...
/* 80C4FC74  4B 3B D0 F1 */	bl transS__14mDoMtx_stack_cFRC4cXyz
...
/* 80C4FC88  4B 3B D2 BD */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C4FC8C  3C 60 80 C5 */	lis r3, M_attr__14daObjKznkarm_c@ha /* 0x80C50D08@ha */
/* 80C4FC90  38 63 0D 08 */	addi r3, r3, M_attr__14daObjKznkarm_c@l /* 0x80C50D08@l */
/* 80C4FC94  C0 23 00 18 */	lfs f1, 0x18(r3)
/* 80C4FC98  C0 43 00 1C */	lfs f2, 0x1c(r3)
/* 80C4FC9C  C0 63 00 20 */	lfs f3, 0x20(r3)
/* 80C4FCA0  4B 3B D0 FD */	bl transM__14mDoMtx_stack_cFfff
/* 80C4FCA4  48 00 00 4C */	b lbl_80C4FCF0
lbl_80C4FCA8:
/* 80C4FCA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C4FCAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C4FCB0  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C4FCB4  4B 3B C7 81 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C4FCB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C4FCBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C4FCC0  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 80C4FCC4  4B 3B C8 09 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80C4FCC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C4FCCC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C4FCD0  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C4FCD4  4B 3B C6 C9 */	bl mDoMtx_XrotM__FPA4_fs
/* 80C4FCD8  3C 60 80 C5 */	lis r3, M_attr__14daObjKznkarm_c@ha /* 0x80C50D08@ha */
/* 80C4FCDC  38 63 0D 08 */	addi r3, r3, M_attr__14daObjKznkarm_c@l /* 0x80C50D08@l */
/* 80C4FCE0  C0 23 00 24 */	lfs f1, 0x24(r3)
/* 80C4FCE4  C0 43 00 28 */	lfs f2, 0x28(r3)
/* 80C4FCE8  C0 63 00 2C */	lfs f3, 0x2c(r3)
/* 80C4FCEC  4B 3B D0 B1 */	bl transM__14mDoMtx_stack_cFfff
lbl_80C4FCF0:
/* 80C4FCF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C4FCF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C4FCF8  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80C4FCFC  38 84 00 24 */	addi r4, r4, 0x24
/* 80C4FD00  4B 6F 67 B1 */	bl PSMTXCopy
