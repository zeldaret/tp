...
/* 80C8F27C  3C 60 80 C9 */	lis r3, lit_3627@ha /* 0x80C8FAE8@ha */
/* 80C8F280  3B E3 FA E8 */	addi r31, r3, lit_3627@l /* 0x80C8FAE8@l */
/* 80C8F284  3C 60 80 C9 */	lis r3, l_HIO@ha /* 0x80C8FCCC@ha */
/* 80C8F288  38 63 FC CC */	addi r3, r3, l_HIO@l /* 0x80C8FCCC@l */
...
/* 80C8F2A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F2A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F2A8  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C8F2AC  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C8F2B0  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C8F2B4  4B 37 CF 55 */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C8F2C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F2CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F2D0  38 81 00 2C */	addi r4, r1, 0x2c
/* 80C8F2D4  7C 85 23 78 */	mr r5, r4
/* 80C8F2D8  4B 6B 7A 95 */	bl PSMTXMultVec
/* 80C8F2DC  38 61 00 2C */	addi r3, r1, 0x2c
/* 80C8F2E0  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C8F2E4  7C 65 1B 78 */	mr r5, r3
/* 80C8F2E8  4B 6B 7D A9 */	bl PSVECAdd
/* 80C8F2EC  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8F2F0  7C 03 07 74 */	extsb r3, r0
/* 80C8F2F4  4B 39 DD 79 */	bl dComIfGp_getReverb__Fi
/* 80C8F2F8  7C 67 1B 78 */	mr r7, r3
/* 80C8F2FC  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80C8F300  54 00 10 3A */	slwi r0, r0, 2
/* 80C8F304  3C 60 80 C9 */	lis r3, selLabel_3897@ha /* 0x80C8FC04@ha */
/* 80C8F308  38 63 FC 04 */	addi r3, r3, selLabel_3897@l /* 0x80C8FC04@l */
/* 80C8F30C  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F310  90 01 00 10 */	stw r0, 0x10(r1)
/* 80C8F314  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8F318  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8F340  4B 61 C6 45 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C8F344  48 00 01 3C */	b lbl_80C8F480
lbl_80C8F348:
/* 80C8F348  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F34C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F350  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C8F354  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C8F358  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C8F35C  4B 37 CE AD */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C8F374  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F378  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F37C  38 81 00 20 */	addi r4, r1, 0x20
/* 80C8F380  7C 85 23 78 */	mr r5, r4
/* 80C8F384  4B 6B 79 E9 */	bl PSMTXMultVec
/* 80C8F388  38 61 00 20 */	addi r3, r1, 0x20
/* 80C8F38C  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C8F390  7C 65 1B 78 */	mr r5, r3
/* 80C8F394  4B 6B 7C FD */	bl PSVECAdd
...
/* 80C8F3AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F3B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F3B4  38 81 00 14 */	addi r4, r1, 0x14
/* 80C8F3B8  7C 85 23 78 */	mr r5, r4
/* 80C8F3BC  4B 6B 79 B1 */	bl PSMTXMultVec
/* 80C8F3C0  38 61 00 14 */	addi r3, r1, 0x14
/* 80C8F3C4  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C8F3C8  7C 65 1B 78 */	mr r5, r3
/* 80C8F3CC  4B 6B 7C C5 */	bl PSVECAdd
/* 80C8F3D0  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8F3D4  7C 03 07 74 */	extsb r3, r0
/* 80C8F3D8  4B 39 DC 95 */	bl dComIfGp_getReverb__Fi
/* 80C8F3DC  7C 67 1B 78 */	mr r7, r3
/* 80C8F3E0  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80C8F3E4  54 00 10 3A */	slwi r0, r0, 2
/* 80C8F3E8  3C 60 80 C9 */	lis r3, selLabel_3897@ha /* 0x80C8FC04@ha */
/* 80C8F3EC  38 63 FC 04 */	addi r3, r3, selLabel_3897@l /* 0x80C8FC04@l */
/* 80C8F3F0  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F3F4  90 01 00 0C */	stw r0, 0xc(r1)
/* 80C8F3F8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8F3FC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8F424  4B 61 C5 61 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C8F428  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8F42C  7C 03 07 74 */	extsb r3, r0
/* 80C8F430  4B 39 DC 3D */	bl dComIfGp_getReverb__Fi
/* 80C8F434  7C 67 1B 78 */	mr r7, r3
/* 80C8F438  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80C8F43C  54 00 10 3A */	slwi r0, r0, 2
/* 80C8F440  3C 60 80 C9 */	lis r3, selLabel_3897@ha /* 0x80C8FC04@ha */
/* 80C8F444  38 63 FC 04 */	addi r3, r3, selLabel_3897@l /* 0x80C8FC04@l */
/* 80C8F448  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F44C  90 01 00 08 */	stw r0, 8(r1)
/* 80C8F450  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8F454  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8F47C  4B 61 C5 09 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C8F480:
