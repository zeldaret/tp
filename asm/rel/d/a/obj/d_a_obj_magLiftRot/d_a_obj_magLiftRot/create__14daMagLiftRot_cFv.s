...
/* 80C8EC74  4B 6D 35 64 */	b _savegpr_28
/* 80C8EC78  7C 7D 1B 78 */	mr r29, r3
/* 80C8EC7C  3C 80 80 C9 */	lis r4, lit_3627@ha
/* 80C8EC80  3B E4 FA E8 */	addi r31, r4, lit_3627@l
...
/* 80C8EC9C  4B 3E 99 88 */	b __ct__16dBgS_MoveBgActorFv
/* 80C8ECA0  3C 60 80 C9 */	lis r3, __vt__14daMagLiftRot_c@ha
/* 80C8ECA4  38 03 FC 78 */	addi r0, r3, __vt__14daMagLiftRot_c@l
/* 80C8ECA8  90 1C 05 9C */	stw r0, 0x59c(r28)
/* 80C8ECAC  3B DC 05 AC */	addi r30, r28, 0x5ac
/* 80C8ECB0  3C 60 80 C9 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80C8ECB4  38 03 FC 6C */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 80C8ECB8  90 1C 05 AC */	stw r0, 0x5ac(r28)
/* 80C8ECBC  7F C3 F3 78 */	mr r3, r30
/* 80C8ECC0  38 80 00 00 */	li r4, 0
/* 80C8ECC4  4B 69 97 38 */	b init__12J3DFrameCtrlFs
/* 80C8ECC8  38 00 00 00 */	li r0, 0
/* 80C8ECCC  90 1E 00 14 */	stw r0, 0x14(r30)
/* 80C8ECD0  3C 60 80 C9 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80C8ECD4  38 03 FC 6C */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 80C8ECD8  94 1C 05 C4 */	stwu r0, 0x5c4(r28)
/* 80C8ECDC  7F 83 E3 78 */	mr r3, r28
/* 80C8ECE0  38 80 00 00 */	li r4, 0
/* 80C8ECE4  4B 69 97 18 */	b init__12J3DFrameCtrlFs
...
/* 80C8ED2C  3C 80 80 C9 */	lis r4, l_arcName@ha
/* 80C8ED30  38 84 FB B0 */	addi r4, r4, l_arcName@l
/* 80C8ED34  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C8ED38  4B 39 E1 84 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C8ED64  3C 80 80 C9 */	lis r4, l_arcName@ha
/* 80C8ED68  38 84 FB B0 */	addi r4, r4, l_arcName@l
/* 80C8ED6C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C8ED70  38 BF 00 3C */	addi r5, r31, 0x3c
/* 80C8ED74  7C A5 00 2E */	lwzx r5, r5, r0
/* 80C8ED78  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C8ED7C  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C8ED80  39 00 00 00 */	li r8, 0
/* 80C8ED84  4B 3E 9A 38 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C8EDB0  4B 38 B7 C8 */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80C8EF38  4B 6D 32 EC */	b _restgpr_28
