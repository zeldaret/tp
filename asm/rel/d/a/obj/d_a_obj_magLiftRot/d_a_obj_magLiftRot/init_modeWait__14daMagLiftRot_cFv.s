...
/* 80C8F550  3C 60 80 C9 */	lis r3, lit_3627@ha /* 0x80C8FAE8@ha */
/* 80C8F554  3B E3 FA E8 */	addi r31, r3, lit_3627@l /* 0x80C8FAE8@l */
/* 80C8F558  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80C8F55C  28 00 00 02 */	cmplwi r0, 2
/* 80C8F560  41 82 00 AC */	beq lbl_80C8F60C
/* 80C8F564  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F568  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F56C  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C8F570  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C8F574  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C8F578  4B 37 CC 91 */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C8F58C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F590  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F594  38 81 00 2C */	addi r4, r1, 0x2c
/* 80C8F598  7C 85 23 78 */	mr r5, r4
/* 80C8F59C  4B 6B 77 D1 */	bl PSMTXMultVec
/* 80C8F5A0  38 61 00 2C */	addi r3, r1, 0x2c
/* 80C8F5A4  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C8F5A8  7C 65 1B 78 */	mr r5, r3
/* 80C8F5AC  4B 6B 7A E5 */	bl PSVECAdd
/* 80C8F5B0  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8F5B4  7C 03 07 74 */	extsb r3, r0
/* 80C8F5B8  4B 39 DA B5 */	bl dComIfGp_getReverb__Fi
/* 80C8F5BC  7C 67 1B 78 */	mr r7, r3
/* 80C8F5C0  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80C8F5C4  54 00 10 3A */	slwi r0, r0, 2
/* 80C8F5C8  3C 60 80 C9 */	lis r3, selLabel_3963@ha /* 0x80C8FC10@ha */
/* 80C8F5CC  38 63 FC 10 */	addi r3, r3, selLabel_3963@l /* 0x80C8FC10@l */
/* 80C8F5D0  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F5D4  90 01 00 10 */	stw r0, 0x10(r1)
/* 80C8F5D8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8F5DC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8F604  4B 61 C3 81 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C8F608  48 00 01 3C */	b lbl_80C8F744
lbl_80C8F60C:
/* 80C8F60C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F610  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F614  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C8F618  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C8F61C  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C8F620  4B 37 CB E9 */	bl mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C8F638  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F63C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F640  38 81 00 20 */	addi r4, r1, 0x20
/* 80C8F644  7C 85 23 78 */	mr r5, r4
/* 80C8F648  4B 6B 77 25 */	bl PSMTXMultVec
/* 80C8F64C  38 61 00 20 */	addi r3, r1, 0x20
/* 80C8F650  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C8F654  7C 65 1B 78 */	mr r5, r3
/* 80C8F658  4B 6B 7A 39 */	bl PSVECAdd
...
/* 80C8F670  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C8F674  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C8F678  38 81 00 14 */	addi r4, r1, 0x14
/* 80C8F67C  7C 85 23 78 */	mr r5, r4
/* 80C8F680  4B 6B 76 ED */	bl PSMTXMultVec
/* 80C8F684  38 61 00 14 */	addi r3, r1, 0x14
/* 80C8F688  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C8F68C  7C 65 1B 78 */	mr r5, r3
/* 80C8F690  4B 6B 7A 01 */	bl PSVECAdd
/* 80C8F694  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8F698  7C 03 07 74 */	extsb r3, r0
/* 80C8F69C  4B 39 D9 D1 */	bl dComIfGp_getReverb__Fi
/* 80C8F6A0  7C 67 1B 78 */	mr r7, r3
/* 80C8F6A4  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80C8F6A8  54 00 10 3A */	slwi r0, r0, 2
/* 80C8F6AC  3C 60 80 C9 */	lis r3, selLabel_3963@ha /* 0x80C8FC10@ha */
/* 80C8F6B0  38 63 FC 10 */	addi r3, r3, selLabel_3963@l /* 0x80C8FC10@l */
/* 80C8F6B4  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F6B8  90 01 00 0C */	stw r0, 0xc(r1)
/* 80C8F6BC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8F6C0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8F6E8  4B 61 C2 9D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C8F6EC  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8F6F0  7C 03 07 74 */	extsb r3, r0
/* 80C8F6F4  4B 39 D9 79 */	bl dComIfGp_getReverb__Fi
/* 80C8F6F8  7C 67 1B 78 */	mr r7, r3
/* 80C8F6FC  88 1E 05 DC */	lbz r0, 0x5dc(r30)
/* 80C8F700  54 00 10 3A */	slwi r0, r0, 2
/* 80C8F704  3C 60 80 C9 */	lis r3, selLabel_3963@ha /* 0x80C8FC10@ha */
/* 80C8F708  38 63 FC 10 */	addi r3, r3, selLabel_3963@l /* 0x80C8FC10@l */
/* 80C8F70C  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F710  90 01 00 08 */	stw r0, 8(r1)
/* 80C8F714  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C8F718  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C8F740  4B 61 C2 45 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C8F744:
/* 80C8F744  3C 60 80 C9 */	lis r3, l_HIO@ha /* 0x80C8FCCC@ha */
/* 80C8F748  38 63 FC CC */	addi r3, r3, l_HIO@l /* 0x80C8FCCC@l */
