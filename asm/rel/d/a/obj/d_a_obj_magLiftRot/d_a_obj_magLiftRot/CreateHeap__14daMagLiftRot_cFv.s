...
/* 80C8EB2C  4B 6D 36 AD */	bl _savegpr_28
/* 80C8EB30  7C 7D 1B 78 */	mr r29, r3
/* 80C8EB34  3C 60 80 C9 */	lis r3, lit_3627@ha /* 0x80C8FAE8@ha */
/* 80C8EB38  3B C3 FA E8 */	addi r30, r3, lit_3627@l /* 0x80C8FAE8@l */
/* 80C8EB3C  88 1D 05 DC */	lbz r0, 0x5dc(r29)
/* 80C8EB40  54 00 10 3A */	slwi r0, r0, 2
/* 80C8EB44  3C 60 80 C9 */	lis r3, l_arcName@ha /* 0x80C8FBB0@ha */
/* 80C8EB48  38 63 FB B0 */	addi r3, r3, l_arcName@l /* 0x80C8FBB0@l */
/* 80C8EB4C  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C8EB50  38 9E 00 30 */	addi r4, r30, 0x30
/* 80C8EB54  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C8EB58  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C8EB5C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C8EB70  4B 3A D7 7D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C8EB84  4B 38 60 D1 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C8EBB8  3C 60 80 C9 */	lis r3, l_arcName@ha /* 0x80C8FBB0@ha */
/* 80C8EBBC  38 63 FB B0 */	addi r3, r3, l_arcName@l /* 0x80C8FBB0@l */
/* 80C8EBC0  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C8EBC4  7F 85 E3 78 */	mr r5, r28
/* 80C8EBC8  38 C0 00 80 */	li r6, 0x80
/* 80C8EBCC  4B 3A D7 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C8EBF0  4B 37 EA 4D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
lbl_80C8EBF4:
...
/* 80C8EC0C  3C 60 80 C9 */	lis r3, l_arcName@ha /* 0x80C8FBB0@ha */
/* 80C8EC10  38 63 FB B0 */	addi r3, r3, l_arcName@l /* 0x80C8FBB0@l */
/* 80C8EC14  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C8EC18  7F 85 E3 78 */	mr r5, r28
/* 80C8EC1C  38 C0 00 80 */	li r6, 0x80
/* 80C8EC20  4B 3A D6 CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C8EC44  4B 37 EA C9 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
lbl_80C8EC48:
/* 80C8EC48  38 60 00 01 */	li r3, 1
lbl_80C8EC4C:
/* 80C8EC4C  39 61 00 20 */	addi r11, r1, 0x20
/* 80C8EC50  4B 6D 35 D5 */	bl _restgpr_28
