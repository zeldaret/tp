...
/* 80D244F0  4B 63 DC E5 */	bl _savegpr_27
/* 80D244F4  7C 7F 1B 78 */	mr r31, r3
/* 80D244F8  3C 60 80 D2 */	lis r3, l_arcName@ha /* 0x80D26C74@ha */
/* 80D244FC  38 63 6C 74 */	addi r3, r3, l_arcName@l /* 0x80D26C74@l */
/* 80D24500  80 63 00 00 */	lwz r3, 0(r3)
/* 80D24504  38 80 00 0C */	li r4, 0xc
/* 80D24508  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2450C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D24520  4B 31 7D CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D24534  4B 2F 07 21 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D24550:
/* 80D24550  3C 60 80 D2 */	lis r3, l_arcName@ha /* 0x80D26C74@ha */
/* 80D24554  38 63 6C 74 */	addi r3, r3, l_arcName@l /* 0x80D26C74@l */
...
/* 80D24568  4B 31 7D 85 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D2456C  7C 7B 1B 78 */	mr r27, r3
/* 80D24570  38 60 00 18 */	li r3, 0x18
/* 80D24574  4B 5A A6 D9 */	bl __nw__FUl
/* 80D24578  7C 7C 1B 79 */	or. r28, r3, r3
/* 80D2457C  41 82 00 20 */	beq lbl_80D2459C
/* 80D24580  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80D26E74@ha */
/* 80D24584  38 04 6E 74 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80D26E74@l */
/* 80D24588  90 1C 00 00 */	stw r0, 0(r28)
/* 80D2458C  38 80 00 00 */	li r4, 0
/* 80D24590  4B 60 3E 6D */	bl init__12J3DFrameCtrlFs
...
/* 80D245BC  3D 00 80 D2 */	lis r8, lit_3785@ha /* 0x80D26B7C@ha */
/* 80D245C0  C0 28 6B 7C */	lfs f1, lit_3785@l(r8)  /* 0x80D26B7C@l */
/* 80D245C4  39 00 00 00 */	li r8, 0
/* 80D245C8  39 20 FF FF */	li r9, -1
/* 80D245CC  4B 2E 91 41 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80D245E0:
/* 80D245E0  3C 60 80 D2 */	lis r3, l_arcName@ha /* 0x80D26C74@ha */
/* 80D245E4  38 63 6C 74 */	addi r3, r3, l_arcName@l /* 0x80D26C74@l */
...
/* 80D245F8  4B 31 7C F5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D245FC  7C 7B 1B 78 */	mr r27, r3
/* 80D24600  38 60 00 18 */	li r3, 0x18
/* 80D24604  4B 5A A6 49 */	bl __nw__FUl
/* 80D24608  7C 7C 1B 79 */	or. r28, r3, r3
/* 80D2460C  41 82 00 20 */	beq lbl_80D2462C
/* 80D24610  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80D26E74@ha */
/* 80D24614  38 04 6E 74 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80D26E74@l */
/* 80D24618  90 1C 00 00 */	stw r0, 0(r28)
/* 80D2461C  38 80 00 00 */	li r4, 0
/* 80D24620  4B 60 3D DD */	bl init__12J3DFrameCtrlFs
...
/* 80D2464C  3D 00 80 D2 */	lis r8, lit_3785@ha /* 0x80D26B7C@ha */
/* 80D24650  C0 28 6B 7C */	lfs f1, lit_3785@l(r8)  /* 0x80D26B7C@l */
/* 80D24654  39 00 00 00 */	li r8, 0
/* 80D24658  39 20 FF FF */	li r9, -1
/* 80D2465C  4B 2E 8F E1 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80D24670:
/* 80D24670  3C 60 80 D2 */	lis r3, l_arcName@ha /* 0x80D26C74@ha */
/* 80D24674  38 63 6C 74 */	addi r3, r3, l_arcName@l /* 0x80D26C74@l */
...
/* 80D24688  4B 31 7C 65 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D2468C  7C 7B 1B 78 */	mr r27, r3
/* 80D24690  38 60 00 1C */	li r3, 0x1c
/* 80D24694  4B 5A A5 B9 */	bl __nw__FUl
/* 80D24698  7C 7C 1B 79 */	or. r28, r3, r3
/* 80D2469C  41 82 00 20 */	beq lbl_80D246BC
/* 80D246A0  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80D26E74@ha */
/* 80D246A4  38 04 6E 74 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80D26E74@l */
/* 80D246A8  90 1C 00 00 */	stw r0, 0(r28)
/* 80D246AC  38 80 00 00 */	li r4, 0
/* 80D246B0  4B 60 3D 4D */	bl init__12J3DFrameCtrlFs
...
/* 80D246D8  3C E0 80 D2 */	lis r7, lit_3785@ha /* 0x80D26B7C@ha */
/* 80D246DC  C0 27 6B 7C */	lfs f1, lit_3785@l(r7)  /* 0x80D26B7C@l */
/* 80D246E0  38 E0 00 00 */	li r7, 0
/* 80D246E4  39 00 FF FF */	li r8, -1
/* 80D246E8  39 20 00 00 */	li r9, 0
/* 80D246EC  4B 2E 90 F1 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80D24708  3C 60 80 D2 */	lis r3, l_arcName@ha /* 0x80D26C74@ha */
/* 80D2470C  38 63 6C 74 */	addi r3, r3, l_arcName@l /* 0x80D26C74@l */
...
/* 80D24720  4B 31 7B CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D24734  4B 2F 05 21 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D24750:
/* 80D24750  3C 60 80 D2 */	lis r3, l_arcName@ha /* 0x80D26C74@ha */
/* 80D24754  38 63 6C 74 */	addi r3, r3, l_arcName@l /* 0x80D26C74@l */
...
/* 80D24768  4B 31 7B 85 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D2476C  7C 7B 1B 78 */	mr r27, r3
/* 80D24770  38 60 00 18 */	li r3, 0x18
/* 80D24774  4B 5A A4 D9 */	bl __nw__FUl
/* 80D24778  7C 7C 1B 79 */	or. r28, r3, r3
/* 80D2477C  41 82 00 20 */	beq lbl_80D2479C
/* 80D24780  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80D26E74@ha */
/* 80D24784  38 04 6E 74 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80D26E74@l */
/* 80D24788  90 1C 00 00 */	stw r0, 0(r28)
/* 80D2478C  38 80 00 00 */	li r4, 0
/* 80D24790  4B 60 3C 6D */	bl init__12J3DFrameCtrlFs
...
/* 80D247BC  3D 00 80 D2 */	lis r8, lit_3785@ha /* 0x80D26B7C@ha */
/* 80D247C0  C0 28 6B 7C */	lfs f1, lit_3785@l(r8)  /* 0x80D26B7C@l */
/* 80D247C4  39 00 00 00 */	li r8, 0
/* 80D247C8  39 20 FF FF */	li r9, -1
/* 80D247CC  4B 2E 8F 41 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80D247E0:
/* 80D247E0  3C 60 80 D2 */	lis r3, lit_3904@ha /* 0x80D26B8C@ha */
/* 80D247E4  C0 03 6B 8C */	lfs f0, lit_3904@l(r3)  /* 0x80D26B8C@l */
/* 80D247E8  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 80D247EC  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 80D247F0  3C 60 80 D2 */	lis r3, l_arcName@ha /* 0x80D26C74@ha */
/* 80D247F4  38 63 6C 74 */	addi r3, r3, l_arcName@l /* 0x80D26C74@l */
...
/* 80D24808  4B 31 7A E5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D2480C  7C 7B 1B 78 */	mr r27, r3
/* 80D24810  38 60 00 18 */	li r3, 0x18
/* 80D24814  4B 5A A4 39 */	bl __nw__FUl
/* 80D24818  7C 7D 1B 79 */	or. r29, r3, r3
/* 80D2481C  41 82 00 20 */	beq lbl_80D2483C
/* 80D24820  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80D26E74@ha */
/* 80D24824  38 04 6E 74 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80D26E74@l */
/* 80D24828  90 1D 00 00 */	stw r0, 0(r29)
/* 80D2482C  38 80 00 00 */	li r4, 0
/* 80D24830  4B 60 3B CD */	bl init__12J3DFrameCtrlFs
...
/* 80D2485C  3D 00 80 D2 */	lis r8, lit_3785@ha /* 0x80D26B7C@ha */
/* 80D24860  C0 28 6B 7C */	lfs f1, lit_3785@l(r8)  /* 0x80D26B7C@l */
/* 80D24864  39 00 00 00 */	li r8, 0
/* 80D24868  39 20 FF FF */	li r9, -1
/* 80D2486C  4B 2E 8D D1 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80D24880:
/* 80D24880  3C 60 80 D2 */	lis r3, lit_3904@ha /* 0x80D26B8C@ha */
/* 80D24884  C0 03 6B 8C */	lfs f0, lit_3904@l(r3)  /* 0x80D26B8C@l */
...
/* 80D24898  4B 63 D9 89 */	bl _restgpr_27
