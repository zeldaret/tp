...
/* 80D24908  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D2490C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D24910  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D24914  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80D24918  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80D2491C  A0 84 00 82 */	lhz r4, 0x82(r4)
/* 80D24920  4B 31 00 9D */	bl isEventBit__11dSv_event_cCFUs
...
/* 80D24964  3C 80 80 D2 */	lis r4, l_arcName@ha /* 0x80D26C74@ha */
/* 80D24968  38 84 6C 74 */	addi r4, r4, l_arcName@l /* 0x80D26C74@l */
/* 80D2496C  80 84 00 00 */	lwz r4, 0(r4)
/* 80D24970  4B 30 85 4D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80D24984  3C 80 80 D2 */	lis r4, l_arcName@ha /* 0x80D26C74@ha */
/* 80D24988  38 84 6C 74 */	addi r4, r4, l_arcName@l /* 0x80D26C74@l */
/* 80D2498C  80 84 00 00 */	lwz r4, 0(r4)
/* 80D24990  38 A0 00 18 */	li r5, 0x18
/* 80D24994  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80D24998  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80D2499C  38 E0 40 00 */	li r7, 0x4000
/* 80D249A0  39 00 00 00 */	li r8, 0
/* 80D249A4  4B 35 3E 19 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
