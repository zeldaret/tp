...
/* 80D25A18  4B 63 C7 C1 */	bl _savegpr_28
...
/* 80D25A2C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D25A30  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D25A34  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D25A38  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80D25A3C  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80D25A40  A0 84 00 A8 */	lhz r4, 0xa8(r4)
/* 80D25A44  4B 30 EF 79 */	bl isEventBit__11dSv_event_cCFUs
...
lbl_80D25A60:
/* 80D25A60  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D25A64  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D25A78  4B 32 1F 81 */	bl startCheck__16dEvent_manager_cFs
/* 80D25A7C  2C 03 00 00 */	cmpwi r3, 0
/* 80D25A80  41 82 00 6C */	beq lbl_80D25AEC
/* 80D25A84  7F 83 E3 78 */	mr r3, r28
/* 80D25A88  4B 32 29 61 */	bl getRunEventName__16dEvent_manager_cFv
/* 80D25A8C  3C 80 80 D2 */	lis r4, d_a_obj_volcbom__stringBase0@ha /* 0x80D26C0C@ha */
/* 80D25A90  38 84 6C 0C */	addi r4, r4, d_a_obj_volcbom__stringBase0@l /* 0x80D26C0C@l */
/* 80D25A94  38 84 00 0A */	addi r4, r4, 0xa
/* 80D25A98  4B 64 2E FD */	bl strcmp
...
/* 80D25AB8  4B 31 DB A5 */	bl setPt2__14dEvt_control_cFPv
/* 80D25ABC  7F 83 E3 78 */	mr r3, r28
/* 80D25AC0  3C 80 80 D2 */	lis r4, l_staff_name@ha /* 0x80D26C7C@ha */
/* 80D25AC4  38 84 6C 7C */	addi r4, r4, l_staff_name@l /* 0x80D26C7C@l */
/* 80D25AC8  80 84 00 00 */	lwz r4, 0(r4)
/* 80D25ACC  38 A0 00 00 */	li r5, 0
/* 80D25AD0  38 C0 00 00 */	li r6, 0
/* 80D25AD4  4B 32 20 49 */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80D25AF0  4B 63 C7 35 */	bl _restgpr_28
