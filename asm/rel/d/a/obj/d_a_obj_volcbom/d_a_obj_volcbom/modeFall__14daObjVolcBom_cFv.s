...
/* 80D24E60  4B 63 D3 71 */	bl _savegpr_26
/* 80D24E64  7C 7E 1B 78 */	mr r30, r3
/* 80D24E68  3C 80 80 D2 */	lis r4, l_midna_offset@ha /* 0x80D26B5C@ha */
/* 80D24E6C  3B E4 6B 5C */	addi r31, r4, l_midna_offset@l /* 0x80D26B5C@l */
/* 80D24E70  3B 60 00 00 */	li r27, 0
/* 80D24E74  38 80 00 00 */	li r4, 0
/* 80D24E78  4B 2F 58 55 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 80D24EB0  4B 2E 85 79 */	bl play__14mDoExt_baseAnmFv
/* 80D24EB4  80 7E 05 C0 */	lwz r3, 0x5c0(r30)
/* 80D24EB8  4B 2E 85 71 */	bl play__14mDoExt_baseAnmFv
...
/* 80D24ED8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D24EDC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D24F08  4B 58 76 05 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D24F28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D24F2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D24F40  4B 34 AA E5 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 80D24F60  4B 2F 8D 5D */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80D24F64  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80D24F68  41 82 00 10 */	beq lbl_80D24F78
/* 80D24F6C  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80D24F70  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
/* 80D24F74  D0 01 00 34 */	stfs f0, 0x34(r1)
lbl_80D24F78:
/* 80D24F78  3B 40 00 00 */	li r26, 0
/* 80D24F7C  3B A0 00 00 */	li r29, 0
/* 80D24F80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D24F84  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D24FCC  4B 32 7A C5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D24FE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D24FE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D24FF8  4B 31 02 09 */	bl onSwitch__10dSv_info_cFii
...
/* 80D25010  4B 63 D2 0D */	bl _restgpr_26
