...
/* 80D25F00  4B 63 C2 D5 */	bl _savegpr_27
/* 80D25F04  7C 7F 1B 78 */	mr r31, r3
/* 80D25F08  3C 60 80 D2 */	lis r3, l_midna_offset@ha /* 0x80D26B5C@ha */
/* 80D25F0C  3B C3 6B 5C */	addi r30, r3, l_midna_offset@l /* 0x80D26B5C@l */
/* 80D25F10  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 80D25F14  83 63 10 18 */	lwz r27, m_midnaActor__9daPy_py_c@l(r3)  /* 0x80451018@l */
/* 80D25F18  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D25F1C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D25F20  3B A3 4F F8 */	addi r29, r3, 0x4ff8
/* 80D25F24  7F A3 EB 78 */	mr r3, r29
/* 80D25F28  80 9F 09 F4 */	lwz r4, 0x9f4(r31)
/* 80D25F2C  3C A0 80 D2 */	lis r5, action_table@ha /* 0x80D26DB4@ha */
/* 80D25F30  38 A5 6D B4 */	addi r5, r5, action_table@l /* 0x80D26DB4@l */
/* 80D25F34  38 C0 00 04 */	li r6, 4
/* 80D25F38  38 E0 00 00 */	li r7, 0
/* 80D25F3C  39 00 00 00 */	li r8, 0
/* 80D25F40  4B 32 1E D1 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
/* 80D25F44  7C 7C 1B 78 */	mr r28, r3
/* 80D25F48  7F A3 EB 78 */	mr r3, r29
/* 80D25F4C  80 9F 09 F4 */	lwz r4, 0x9f4(r31)
/* 80D25F50  4B 32 1D FD */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 80D25F8C  3C A0 80 D2 */	lis r5, d_a_obj_volcbom__stringBase0@ha /* 0x80D26C0C@ha */
/* 80D25F90  38 A5 6C 0C */	addi r5, r5, d_a_obj_volcbom__stringBase0@l /* 0x80D26C0C@l */
/* 80D25F94  38 A5 00 42 */	addi r5, r5, 0x42
/* 80D25F98  38 C0 00 03 */	li r6, 3
/* 80D25F9C  4B 32 21 51 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80D25FF4  3C 60 80 D2 */	lis r3, l_arcName@ha /* 0x80D26C74@ha */
/* 80D25FF8  38 63 6C 74 */	addi r3, r3, l_arcName@l /* 0x80D26C74@l */
/* 80D25FFC  80 63 00 00 */	lwz r3, 0(r3)
/* 80D26000  38 80 00 15 */	li r4, 0x15
/* 80D26004  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D26008  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D2600C  3C A5 00 02 */	addis r5, r5, 2
/* 80D26010  38 C0 00 80 */	li r6, 0x80
/* 80D26014  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80D26018  4B 31 62 D5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D26044  4B 2E 75 F9 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80D2607C  4B 30 6F F1 */	bl dComIfGp_getReverb__Fi
...
/* 80D26090  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D26094  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D260BC  4B 58 58 C9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80D260C0  48 00 00 58 */	b lbl_80D26118
lbl_80D260C4:
/* 80D260C4  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80D260C8  7C 03 07 74 */	extsb r3, r0
/* 80D260CC  4B 30 6F A1 */	bl dComIfGp_getReverb__Fi
...
/* 80D260E0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D260E4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D2610C  4B 58 58 79 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D26158  4B 32 20 25 */	bl cutEnd__16dEvent_manager_cFi
...
/* 80D26198  4B 32 1F E5 */	bl cutEnd__16dEvent_manager_cFi
...
/* 80D261C4  4B 30 6E A9 */	bl dComIfGp_getReverb__Fi
...
/* 80D261D8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D261DC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D26204  4B 58 57 81 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D26208:
/* 80D26208  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 80D2620C  4B 2E 72 1D */	bl play__14mDoExt_baseAnmFv
...
/* 80D26220  4B 32 1F 5D */	bl cutEnd__16dEvent_manager_cFi
lbl_80D26224:
...
/* 80D26240  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D26244  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D26248  4B 62 02 69 */	bl PSMTXCopy
/* 80D2624C  C0 3E 00 A0 */	lfs f1, 0xa0(r30)
/* 80D26250  C0 5E 00 A4 */	lfs f2, 0xa4(r30)
/* 80D26254  C0 7E 00 A8 */	lfs f3, 0xa8(r30)
/* 80D26258  4B 2E 6B 45 */	bl transM__14mDoMtx_stack_cFfff
/* 80D2625C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D26260  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80D2628C  4B 62 02 25 */	bl PSMTXCopy
...
/* 80D262B0  4B 54 A9 55 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80D262B4  B0 61 00 32 */	sth r3, 0x32(r1)
/* 80D262B8  38 61 00 38 */	addi r3, r1, 0x38
/* 80D262BC  38 81 00 44 */	addi r4, r1, 0x44
/* 80D262C0  4B 54 A9 B5 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 80D262D8  4B 62 10 C5 */	bl PSVECSquareDistance
...
/* 80D26348  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D2634C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80D263B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80D263BC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80D263C0  48 00 00 08 */	b lbl_80D263C8
lbl_80D263C4:
/* 80D263C4  FF E0 08 90 */	fmr f31, f1
lbl_80D263C8:
/* 80D263C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D263CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D26414  4B 32 66 7D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
