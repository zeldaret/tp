...
/* 80D161BC  4B 64 C0 05 */	bl _savegpr_22
/* 80D161C0  7C 7C 1B 78 */	mr r28, r3
/* 80D161C4  3C 60 80 D1 */	lis r3, l_bmd@ha /* 0x80D1774C@ha */
/* 80D161C8  3B E3 77 4C */	addi r31, r3, l_bmd@l /* 0x80D1774C@l */
/* 80D161CC  88 1C 05 E5 */	lbz r0, 0x5e5(r28)
/* 80D161D0  54 00 10 3A */	slwi r0, r0, 2
/* 80D161D4  3C 60 80 D1 */	lis r3, l_arcName@ha /* 0x80D17878@ha */
/* 80D161D8  38 63 78 78 */	addi r3, r3, l_arcName@l /* 0x80D17878@l */
/* 80D161DC  7C 63 00 2E */	lwzx r3, r3, r0
/* 80D161E0  38 9F 00 00 */	addi r4, r31, 0
/* 80D161E4  7C 84 00 2E */	lwzx r4, r4, r0
/* 80D161E8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D161EC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D16200  4B 32 60 ED */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D16210  4B 2F EA 45 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80D16240  3C 60 80 D1 */	lis r3, l_arcName@ha /* 0x80D17878@ha */
/* 80D16244  3B 03 78 78 */	addi r24, r3, l_arcName@l /* 0x80D17878@l */
...
/* 80D16268  4B 32 60 85 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D1626C  7C 76 1B 78 */	mr r22, r3
/* 80D16270  38 60 00 1C */	li r3, 0x1c
/* 80D16274  4B 5B 89 D9 */	bl __nw__FUl
/* 80D16278  7C 7A 1B 79 */	or. r26, r3, r3
/* 80D1627C  41 82 00 20 */	beq lbl_80D1629C
/* 80D16280  3C 80 80 D1 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80D17980@ha */
/* 80D16284  38 04 79 80 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80D17980@l */
/* 80D16288  90 1A 00 00 */	stw r0, 0(r26)
/* 80D1628C  38 80 00 00 */	li r4, 0
/* 80D16290  4B 61 21 6D */	bl init__12J3DFrameCtrlFs
...
/* 80D162CC  4B 2F 75 11 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80D16300  3C 60 80 D1 */	lis r3, l_arcName@ha /* 0x80D17878@ha */
/* 80D16304  38 63 78 78 */	addi r3, r3, l_arcName@l /* 0x80D17878@l */
...
/* 80D1631C  4B 32 5F D1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D16320  7C 77 1B 78 */	mr r23, r3
/* 80D16324  88 1C 05 E5 */	lbz r0, 0x5e5(r28)
/* 80D16328  54 00 10 3A */	slwi r0, r0, 2
/* 80D1632C  3C 60 80 D1 */	lis r3, l_arcName@ha /* 0x80D17878@ha */
/* 80D16330  38 63 78 78 */	addi r3, r3, l_arcName@l /* 0x80D17878@l */
...
/* 80D16348  4B 32 5F A5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D1634C  7C 64 1B 78 */	mr r4, r3
/* 80D16350  7E E3 BB 78 */	mr r3, r23
/* 80D16354  4B 2F 84 E1 */	bl mDoExt_setupShareTexture__FP12J3DModelDataP12J3DModelData
...
/* 80D16368  4B 2F E8 ED */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80D16394  4B 64 BE 79 */	bl _restgpr_22
