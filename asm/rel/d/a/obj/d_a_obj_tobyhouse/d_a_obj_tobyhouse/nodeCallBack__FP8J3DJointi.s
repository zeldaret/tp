...
/* 80D15DC8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80D15DCC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80D15E0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D15E10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D15E14  A8 85 05 E0 */	lha r4, 0x5e0(r5)
/* 80D15E18  4B 2F 65 C5 */	bl mDoMtx_YrotS__FPA4_fs
/* 80D15E1C  80 7F 00 84 */	lwz r3, 0x84(r31)
/* 80D15E20  80 03 00 0C */	lwz r0, 0xc(r3)
/* 80D15E24  7C 80 F2 14 */	add r4, r0, r30
/* 80D15E28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D15E2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D15E30  7C 65 1B 78 */	mr r5, r3
/* 80D15E34  4B 63 06 B1 */	bl PSMTXConcat
/* 80D15E38  C0 01 00 08 */	lfs f0, 8(r1)
/* 80D15E3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D15E40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80D15E64  4B 63 06 4D */	bl PSMTXCopy
/* 80D15E68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D15E6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D15E70  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80D15E74  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80D15E78  4B 63 06 39 */	bl PSMTXCopy
lbl_80D15E7C:
