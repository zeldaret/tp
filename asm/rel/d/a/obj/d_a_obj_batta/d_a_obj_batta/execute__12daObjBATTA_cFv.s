...
/* 80BABE40  3C 60 80 BB */	lis r3, lit_4698@ha /* 0x80BACA44@ha */
/* 80BABE44  C0 43 CA 44 */	lfs f2, lit_4698@l(r3)  /* 0x80BACA44@l */
/* 80BABE48  80 1F 05 78 */	lwz r0, 0x578(r31)
/* 80BABE4C  3C 60 80 BB */	lis r3, lit_4700@ha /* 0x80BACA48@ha */
/* 80BABE50  C8 23 CA 48 */	lfd f1, lit_4700@l(r3)  /* 0x80BACA48@l */
...
/* 80BABEA0  4B 5B 21 D9 */	bl Insect_GetDemoMain__9dInsect_cFv
...
/* 80BABF2C  4B 6C 37 1D */	bl SetC__8cM3dGSphFRC4cXyz
/* 80BABF30  38 7F 09 A4 */	addi r3, r31, 0x9a4
/* 80BABF34  3C 80 80 BB */	lis r4, lit_4213@ha /* 0x80BAC9F4@ha */
/* 80BABF38  C0 24 C9 F4 */	lfs f1, lit_4213@l(r4)  /* 0x80BAC9F4@l */
/* 80BABF3C  C0 1F 04 EC */	lfs f0, 0x4ec(r31)
/* 80BABF40  EC 21 00 32 */	fmuls f1, f1, f0
/* 80BABF44  4B 6C 37 C5 */	bl SetR__8cM3dGSphFf
/* 80BABF48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BABF4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BABF50  38 63 23 3C */	addi r3, r3, 0x233c
/* 80BABF54  38 9F 08 80 */	addi r4, r31, 0x880
/* 80BABF58  4B 6B 8C 51 */	bl Set__4cCcSFP8cCcD_Obj
