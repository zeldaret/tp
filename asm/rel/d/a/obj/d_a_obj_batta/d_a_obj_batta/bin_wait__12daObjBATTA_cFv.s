...
/* 80BAB518  3C 60 80 BB */	lis r3, lit_3774@ha /* 0x80BAC970@ha */
/* 80BAB51C  3B E3 C9 70 */	addi r31, r3, lit_3774@l /* 0x80BAC970@l */
/* 80BAB520  80 1E 09 E8 */	lwz r0, 0x9e8(r30)
/* 80BAB524  2C 00 00 00 */	cmpwi r0, 0
/* 80BAB528  40 82 00 78 */	bne lbl_80BAB5A0
/* 80BAB52C  3C 60 80 BB */	lis r3, d_a_obj_batta__stringBase0@ha /* 0x80BACA64@ha */
/* 80BAB530  38 63 CA 64 */	addi r3, r3, d_a_obj_batta__stringBase0@l /* 0x80BACA64@l */
/* 80BAB534  38 80 00 08 */	li r4, 8
/* 80BAB538  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BAB53C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BAB540  3C A5 00 02 */	addis r5, r5, 2
/* 80BAB544  38 C0 00 80 */	li r6, 0x80
/* 80BAB548  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BAB54C  4B 49 0D A1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BAB56C  4B 46 59 05 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80BAB5B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BAB5B8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BAB5CC  3C 60 80 BB */	lis r3, d_a_obj_batta__stringBase0@ha /* 0x80BACA64@ha */
/* 80BAB5D0  38 63 CA 64 */	addi r3, r3, d_a_obj_batta__stringBase0@l /* 0x80BACA64@l */
/* 80BAB5D4  38 63 00 04 */	addi r3, r3, 4
/* 80BAB5D8  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80BAB5DC  4B 7B D3 B9 */	bl strcmp
/* 80BAB5E0  2C 03 00 00 */	cmpwi r3, 0
/* 80BAB5E4  40 82 00 A0 */	bne lbl_80BAB684
/* 80BAB5E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BAB5EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BAB630  4B 4C AC 19 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80BAB634  38 7E 06 80 */	addi r3, r30, 0x680
/* 80BAB638  4B 4C D8 31 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80BAB63C  38 7E 06 2C */	addi r3, r30, 0x62c
/* 80BAB640  C0 3F 00 A4 */	lfs f1, 0xa4(r31)
/* 80BAB644  FC 40 08 90 */	fmr f2, f1
/* 80BAB648  4B 4C A9 11 */	bl SetWall__12dBgS_AcchCirFff
/* 80BAB64C  38 00 00 01 */	li r0, 1
/* 80BAB650  98 1E 05 6D */	stb r0, 0x56d(r30)
/* 80BAB654  3C 60 80 BB */	lis r3, lit_4415@ha /* 0x80BACB30@ha */
/* 80BAB658  38 83 CB 30 */	addi r4, r3, lit_4415@l /* 0x80BACB30@l */
...
lbl_80BAB684:
/* 80BAB684  3C 60 80 BB */	lis r3, lit_4418@ha /* 0x80BACB3C@ha */
/* 80BAB688  38 83 CB 3C */	addi r4, r3, lit_4418@l /* 0x80BACB3C@l */
