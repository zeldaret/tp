...
/* 80BAC094  4B 7B 61 49 */	bl _savegpr_29
/* 80BAC098  7C 7D 1B 78 */	mr r29, r3
/* 80BAC09C  3C 80 80 BB */	lis r4, lit_3774@ha /* 0x80BAC970@ha */
/* 80BAC0A0  3B E4 C9 70 */	addi r31, r4, lit_3774@l /* 0x80BAC970@l */
...
/* 80BAC0B4  4B 5B 21 B9 */	bl CalcZBuffer__9dInsect_cFf
/* 80BAC0B8  80 7D 06 20 */	lwz r3, 0x620(r29)
/* 80BAC0BC  83 C3 00 04 */	lwz r30, 4(r3)
/* 80BAC0C0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BAC0C4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BAC0C8  38 80 00 00 */	li r4, 0
/* 80BAC0CC  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80BAC0D0  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80BAC0D4  4B 5F 76 F1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BAC0D8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BAC0DC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BAC0E0  80 9E 00 04 */	lwz r4, 4(r30)
/* 80BAC0E4  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80BAC0E8  4B 5F 8C B9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80BAC0FC  4B 46 15 DD */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80BAC110  4B 46 16 99 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80BAC124  4B 46 50 9D */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 80BAC14C  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80BAC150  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80BAC154  4B 48 0F 61 */	bl dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80BAC158:
/* 80BAC158  38 60 00 01 */	li r3, 1
/* 80BAC15C  39 61 00 20 */	addi r11, r1, 0x20
/* 80BAC160  4B 7B 60 C9 */	bl _restgpr_29
