...
/* 80CE53FC  4B 67 CD D9 */	bl _savegpr_27
/* 80CE5400  7C 7D 1B 78 */	mr r29, r3
/* 80CE5404  3C 80 80 CE */	lis r4, l_bmdName@ha /* 0x80CE69E8@ha */
/* 80CE5408  83 84 69 E8 */	lwz r28, l_bmdName@l(r4)  /* 0x80CE69E8@l */
/* 80CE540C  48 00 06 45 */	bl getResName__15daObj_SSDrink_cFv
/* 80CE5410  7F 84 E3 78 */	mr r4, r28
/* 80CE5414  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE5418  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CE542C  4B 35 6F 51 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80CE5440  4B 32 F8 15 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80CE545C:
/* 80CE545C  3C 60 80 CE */	lis r3, l_resFileName@ha /* 0x80CE69E4@ha */
/* 80CE5460  38 63 69 E4 */	addi r3, r3, l_resFileName@l /* 0x80CE69E4@l */
/* 80CE5464  80 63 00 00 */	lwz r3, 0(r3)
/* 80CE5468  3C 80 80 CE */	lis r4, d_a_obj_ss_drink__stringBase0@ha /* 0x80CE6990@ha */
/* 80CE546C  38 84 69 90 */	addi r4, r4, d_a_obj_ss_drink__stringBase0@l /* 0x80CE6990@l */
/* 80CE5470  38 84 00 16 */	addi r4, r4, 0x16
/* 80CE5474  7F C5 F3 78 */	mr r5, r30
/* 80CE5478  38 C0 00 80 */	li r6, 0x80
/* 80CE547C  4B 35 6F 01 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CE5480  7C 7B 1B 78 */	mr r27, r3
/* 80CE5484  38 60 00 18 */	li r3, 0x18
/* 80CE5488  4B 5E 97 C5 */	bl __nw__FUl
/* 80CE548C  7C 7C 1B 79 */	or. r28, r3, r3
/* 80CE5490  41 82 00 20 */	beq lbl_80CE54B0
/* 80CE5494  3C 80 80 CE */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80CE6B04@ha */
/* 80CE5498  38 04 6B 04 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80CE6B04@l */
/* 80CE549C  90 1C 00 00 */	stw r0, 0(r28)
/* 80CE54A0  38 80 00 00 */	li r4, 0
/* 80CE54A4  4B 64 2F 59 */	bl init__12J3DFrameCtrlFs
...
/* 80CE54D0  3D 00 80 CE */	lis r8, lit_4000@ha /* 0x80CE6960@ha */
/* 80CE54D4  C0 28 69 60 */	lfs f1, lit_4000@l(r8)  /* 0x80CE6960@l */
/* 80CE54D8  39 00 00 00 */	li r8, 0
/* 80CE54DC  39 20 FF FF */	li r9, -1
/* 80CE54E0  4B 32 80 6D */	bl init__13mDoExt_btpAnmFP16J3DMaterialTableP16J3DAnmTexPatterniifss
...
lbl_80CE54F4:
/* 80CE54F4  3C 60 80 CE */	lis r3, l_resFileName@ha /* 0x80CE69E4@ha */
/* 80CE54F8  38 63 69 E4 */	addi r3, r3, l_resFileName@l /* 0x80CE69E4@l */
/* 80CE54FC  80 63 00 00 */	lwz r3, 0(r3)
/* 80CE5500  3C 80 80 CE */	lis r4, d_a_obj_ss_drink__stringBase0@ha /* 0x80CE6990@ha */
/* 80CE5504  38 84 69 90 */	addi r4, r4, d_a_obj_ss_drink__stringBase0@l /* 0x80CE6990@l */
/* 80CE5508  38 84 00 24 */	addi r4, r4, 0x24
/* 80CE550C  7F C5 F3 78 */	mr r5, r30
/* 80CE5510  38 C0 00 80 */	li r6, 0x80
/* 80CE5514  4B 35 6E 69 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CE5518  7C 7C 1B 78 */	mr r28, r3
/* 80CE551C  38 60 00 18 */	li r3, 0x18
/* 80CE5520  4B 5E 97 2D */	bl __nw__FUl
/* 80CE5524  7C 7E 1B 79 */	or. r30, r3, r3
/* 80CE5528  41 82 00 20 */	beq lbl_80CE5548
/* 80CE552C  3C 80 80 CE */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80CE6B04@ha */
/* 80CE5530  38 04 6B 04 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80CE6B04@l */
/* 80CE5534  90 1E 00 00 */	stw r0, 0(r30)
/* 80CE5538  38 80 00 00 */	li r4, 0
/* 80CE553C  4B 64 2E C1 */	bl init__12J3DFrameCtrlFs
...
/* 80CE5568  3D 00 80 CE */	lis r8, lit_4000@ha /* 0x80CE6960@ha */
/* 80CE556C  C0 28 69 60 */	lfs f1, lit_4000@l(r8)  /* 0x80CE6960@l */
/* 80CE5570  39 00 00 00 */	li r8, 0
/* 80CE5574  39 20 FF FF */	li r9, -1
/* 80CE5578  4B 32 81 95 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80CE5594  4B 67 CC 8D */	bl _restgpr_27
