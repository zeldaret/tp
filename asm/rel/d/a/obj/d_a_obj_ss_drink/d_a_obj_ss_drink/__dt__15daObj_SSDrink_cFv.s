...
/* 80CE4F98  3C 80 80 CE */	lis r4, __vt__15daObj_SSDrink_c@ha /* 0x80CE6B70@ha */
/* 80CE4F9C  38 04 6B 70 */	addi r0, r4, __vt__15daObj_SSDrink_c@l /* 0x80CE6B70@l */
...
/* 80CE4FB0  4B 34 80 59 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80CE4FB4  38 7E 0A A4 */	addi r3, r30, 0xaa4
/* 80CE4FB8  38 80 FF FF */	li r4, -1
/* 80CE4FBC  4B 56 4F 8D */	bl __dt__10dMsgFlow_cFv
/* 80CE4FC0  38 7E 0A 5C */	addi r3, r30, 0xa5c
/* 80CE4FC4  38 80 FF FF */	li r4, -1
/* 80CE4FC8  4B 58 2C CD */	bl __dt__11cBgS_GndChkFv
/* 80CE4FCC  34 1E 09 20 */	addic. r0, r30, 0x920
/* 80CE4FD0  41 82 00 84 */	beq lbl_80CE5054
/* 80CE4FD4  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CE4FD8  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80CE4FF8  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CE4FFC  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80CE5014  3C 60 80 CE */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CE6B64@ha */
/* 80CE5018  38 03 6B 64 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CE6B64@l */
/* 80CE501C  90 1E 0A 58 */	stw r0, 0xa58(r30)
lbl_80CE5020:
/* 80CE5020  34 1E 0A 24 */	addic. r0, r30, 0xa24
/* 80CE5024  41 82 00 24 */	beq lbl_80CE5048
/* 80CE5028  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CE502C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CE5030  90 1E 0A 40 */	stw r0, 0xa40(r30)
/* 80CE5034  34 1E 0A 24 */	addic. r0, r30, 0xa24
/* 80CE5038  41 82 00 10 */	beq lbl_80CE5048
/* 80CE503C  3C 60 80 CE */	lis r3, __vt__8cM3dGAab@ha /* 0x80CE6B58@ha */
/* 80CE5040  38 03 6B 58 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CE6B58@l */
/* 80CE5044  90 1E 0A 3C */	stw r0, 0xa3c(r30)
lbl_80CE5048:
/* 80CE5048  38 7E 09 20 */	addi r3, r30, 0x920
/* 80CE504C  38 80 00 00 */	li r4, 0
/* 80CE5050  4B 39 F0 95 */	bl __dt__12dCcD_GObjInfFv
lbl_80CE5054:
/* 80CE5054  34 1E 07 E4 */	addic. r0, r30, 0x7e4
/* 80CE5058  41 82 00 84 */	beq lbl_80CE50DC
/* 80CE505C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80CE5060  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80CE5080  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80CE5084  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 80CE509C  3C 60 80 CE */	lis r3, __vt__8cM3dGCyl@ha /* 0x80CE6B64@ha */
/* 80CE50A0  38 03 6B 64 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80CE6B64@l */
/* 80CE50A4  90 1E 09 1C */	stw r0, 0x91c(r30)
lbl_80CE50A8:
/* 80CE50A8  34 1E 08 E8 */	addic. r0, r30, 0x8e8
/* 80CE50AC  41 82 00 24 */	beq lbl_80CE50D0
/* 80CE50B0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CE50B4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CE50B8  90 1E 09 04 */	stw r0, 0x904(r30)
/* 80CE50BC  34 1E 08 E8 */	addic. r0, r30, 0x8e8
/* 80CE50C0  41 82 00 10 */	beq lbl_80CE50D0
/* 80CE50C4  3C 60 80 CE */	lis r3, __vt__8cM3dGAab@ha /* 0x80CE6B58@ha */
/* 80CE50C8  38 03 6B 58 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CE6B58@l */
/* 80CE50CC  90 1E 09 00 */	stw r0, 0x900(r30)
lbl_80CE50D0:
/* 80CE50D0  38 7E 07 E4 */	addi r3, r30, 0x7e4
/* 80CE50D4  38 80 00 00 */	li r4, 0
/* 80CE50D8  4B 39 F0 0D */	bl __dt__12dCcD_GObjInfFv
lbl_80CE50DC:
/* 80CE50DC  34 1E 07 A4 */	addic. r0, r30, 0x7a4
/* 80CE50E0  41 82 00 28 */	beq lbl_80CE5108
/* 80CE50E4  3C 60 80 CE */	lis r3, __vt__12dBgS_AcchCir@ha /* 0x80CE6B4C@ha */
/* 80CE50E8  38 03 6B 4C */	addi r0, r3, __vt__12dBgS_AcchCir@l /* 0x80CE6B4C@l */
/* 80CE50EC  90 1E 07 B0 */	stw r0, 0x7b0(r30)
/* 80CE50F0  38 7E 07 B8 */	addi r3, r30, 0x7b8
/* 80CE50F4  38 80 FF FF */	li r4, -1
/* 80CE50F8  4B 58 9E 21 */	bl __dt__8cM3dGCirFv
/* 80CE50FC  38 7E 07 A4 */	addi r3, r30, 0x7a4
/* 80CE5100  38 80 00 00 */	li r4, 0
/* 80CE5104  4B 58 2F AD */	bl __dt__13cBgS_PolyInfoFv
lbl_80CE5108:
/* 80CE5108  34 1E 07 68 */	addic. r0, r30, 0x768
/* 80CE510C  41 82 00 54 */	beq lbl_80CE5160
/* 80CE5110  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CE5114  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CE512C  3C 60 80 CE */	lis r3, __vt__10dCcD_GStts@ha /* 0x80CE6B40@ha */
/* 80CE5130  38 03 6B 40 */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x80CE6B40@l */
/* 80CE5134  90 1E 07 84 */	stw r0, 0x784(r30)
/* 80CE5138  34 1E 07 84 */	addic. r0, r30, 0x784
/* 80CE513C  41 82 00 10 */	beq lbl_80CE514C
/* 80CE5140  3C 60 80 CE */	lis r3, __vt__10cCcD_GStts@ha /* 0x80CE6B34@ha */
/* 80CE5144  38 03 6B 34 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x80CE6B34@l */
/* 80CE5148  90 1E 07 84 */	stw r0, 0x784(r30)
lbl_80CE514C:
/* 80CE514C  34 1E 07 68 */	addic. r0, r30, 0x768
/* 80CE5150  41 82 00 10 */	beq lbl_80CE5160
/* 80CE5154  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CE5158  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CE515C  90 1E 07 80 */	stw r0, 0x780(r30)
lbl_80CE5160:
/* 80CE5160  34 1E 05 90 */	addic. r0, r30, 0x590
/* 80CE5164  41 82 00 2C */	beq lbl_80CE5190
/* 80CE5168  3C 60 80 CE */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80CE6B10@ha */
/* 80CE516C  38 63 6B 10 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80CE6B10@l */
