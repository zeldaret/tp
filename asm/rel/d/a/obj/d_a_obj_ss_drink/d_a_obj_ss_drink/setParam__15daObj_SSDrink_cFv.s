...
/* 80CE5EE0  3C 60 80 CE */	lis r3, mCcDObjInfo__15daObj_SSDrink_c@ha /* 0x80CE6930@ha */
/* 80CE5EE4  3B C3 69 30 */	addi r30, r3, mCcDObjInfo__15daObj_SSDrink_c@l /* 0x80CE6930@l */
...
/* 80CE5F0C  4B 39 00 35 */	bl SetWallR__12dBgS_AcchCirFf
...
/* 80CE5F20  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE5F24  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CE5F48  3C 60 80 CE */	lis r3, lit_4233@ha /* 0x80CE6A54@ha */
/* 80CE5F4C  38 83 6A 54 */	addi r4, r3, lit_4233@l /* 0x80CE6A54@l */
...
/* 80CE5F94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE5F98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CE5F9C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CE5FA0  7C 05 07 74 */	extsb r5, r0
/* 80CE5FA4  4B 34 F3 0D */	bl offSwitch__10dSv_info_cFii
...
/* 80CE5FB8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CE5FBC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CE5FC0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80CE5FC4  7C 05 07 74 */	extsb r5, r0
/* 80CE5FC8  4B 34 F2 39 */	bl onSwitch__10dSv_info_cFii
lbl_80CE5FCC:
