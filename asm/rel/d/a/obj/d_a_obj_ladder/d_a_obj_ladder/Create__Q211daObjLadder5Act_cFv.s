...
/* 8058D1F0  3C 80 80 59 */	lis r4, data_8058DD50@ha /* 0x8058DD50@ha */
/* 8058D1F4  3B C4 DD 50 */	addi r30, r4, data_8058DD50@l /* 0x8058DD50@l */
...
/* 8058D210  3C 60 80 59 */	lis r3, data_8058DDCC@ha /* 0x8058DDCC@ha */
/* 8058D214  38 03 DD CC */	addi r0, r3, data_8058DDCC@l /* 0x8058DDCC@l */
...
/* 8058D240  4B A8 D3 09 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 8058D244  4B A7 FA 85 */	bl push__14mDoMtx_stack_cFv
/* 8058D248  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 8058D24C  4B A7 FB 19 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8058D250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058D254  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058D258  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8058D25C  4B A7 F1 D9 */	bl mDoMtx_YrotM__FPA4_fs
/* 8058D260  C0 3E 00 44 */	lfs f1, 0x44(r30)
/* 8058D264  C0 5E 00 40 */	lfs f2, 0x40(r30)
/* 8058D268  C0 7E 00 48 */	lfs f3, 0x48(r30)
/* 8058D26C  4B A7 FB 31 */	bl transM__14mDoMtx_stack_cFfff
/* 8058D270  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058D274  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8058D290  4B A7 FA 85 */	bl pop__14mDoMtx_stack_cFv
/* 8058D294  38 7F 05 BC */	addi r3, r31, 0x5bc
/* 8058D298  38 81 00 08 */	addi r4, r1, 8
/* 8058D29C  4B CD AA 8D */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 8058D2A0  80 1F 00 04 */	lwz r0, 4(r31)
/* 8058D2A4  90 1F 05 C4 */	stw r0, 0x5c4(r31)
/* 8058D2A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058D2AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058D2B0  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 8058D2B4  7F C3 F3 78 */	mr r3, r30
/* 8058D2B8  38 9F 05 BC */	addi r4, r31, 0x5bc
/* 8058D2BC  4B AE 71 E5 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8058D2E8  4B AB A3 B1 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
/* 8058D31C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058D320  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8058D324  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 8058D328  7C 05 07 74 */	extsb r5, r0
/* 8058D32C  4B AA 80 35 */	bl isSwitch__10dSv_info_cCFii
