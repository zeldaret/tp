...
/* 8058D7FC  4B DD 49 E1 */	bl _savegpr_29
/* 8058D800  7C 7E 1B 78 */	mr r30, r3
/* 8058D804  3C 80 80 59 */	lis r4, data_8058DD50@ha /* 0x8058DD50@ha */
/* 8058D808  3B E4 DD 50 */	addi r31, r4, data_8058DD50@l /* 0x8058DD50@l */
/* 8058D80C  38 80 00 00 */	li r4, 0
/* 8058D810  3C A0 80 43 */	lis r5, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 8058D814  38 A5 0C F4 */	addi r5, r5, Zero__4cXyz@l /* 0x80430CF4@l */
/* 8058D818  38 DF 00 00 */	addi r6, r31, 0
/* 8058D81C  C0 26 00 04 */	lfs f1, 4(r6)
/* 8058D820  C0 46 00 08 */	lfs f2, 8(r6)
/* 8058D824  4B AA 9B 9D */	bl posMoveF_stream__5daObjFP10fopAc_ac_cPC4cXyzPC4cXyzff
...
/* 8058D850  4B C1 DC 71 */	bl dKy_pol_sound_get__FPC13cBgS_PolyInfo
/* 8058D854  54 7D 06 3E */	clrlwi r29, r3, 0x18
/* 8058D858  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8058D85C  7C 03 07 74 */	extsb r3, r0
/* 8058D860  4B A9 F8 0D */	bl dComIfGp_getReverb__Fi
/* 8058D864  7C 67 1B 78 */	mr r7, r3
/* 8058D868  38 00 00 00 */	li r0, 0
/* 8058D86C  90 01 00 0C */	stw r0, 0xc(r1)
/* 8058D870  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058D874  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058D89C  4B D1 E0 E9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 8058D8B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058D8B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058D8CC  4B AE 21 59 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 8058D914  4B A9 F7 59 */	bl dComIfGp_getReverb__Fi
/* 8058D918  7C 67 1B 78 */	mr r7, r3
/* 8058D91C  38 00 00 00 */	li r0, 0
/* 8058D920  90 01 00 08 */	stw r0, 8(r1)
/* 8058D924  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8058D928  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8058D950  4B D1 E0 35 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8058D954:
...
/* 8058D9AC  4B DD 48 7D */	bl _restgpr_29
