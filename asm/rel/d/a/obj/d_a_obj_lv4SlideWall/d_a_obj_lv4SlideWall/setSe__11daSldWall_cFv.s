...
/* 80C623F8  3C 60 80 C6 */	lis r3, lit_3627@ha /* 0x80C626A8@ha */
/* 80C623FC  3B E3 26 A8 */	addi r31, r3, lit_3627@l /* 0x80C626A8@l */
/* 80C62400  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C62404  7C 03 07 74 */	extsb r3, r0
/* 80C62408  4B 3C AC 65 */	bl dComIfGp_getReverb__Fi
...
/* 80C6241C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C62420  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C62448  4B 64 95 3D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C62460  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C62464  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C62468  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C6246C  3C 80 80 C6 */	lis r4, l_HIO@ha /* 0x80C627DC@ha */
/* 80C62470  38 84 27 DC */	addi r4, r4, l_HIO@l /* 0x80C627DC@l */
/* 80C62474  88 84 00 0C */	lbz r4, 0xc(r4)
/* 80C62478  38 A0 00 0F */	li r5, 0xf
/* 80C6247C  38 C1 00 0C */	addi r6, r1, 0xc
/* 80C62480  4B 40 D5 A5 */	bl StartShock__12dVibration_cFii4cXyz
