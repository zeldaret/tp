...
/* 80C624B4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C624B8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C624BC  38 80 00 10 */	li r4, 0x10
/* 80C624C0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C624C4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C624C8  4B 54 12 FD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C624CC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C624D0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C624D4  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80C624D8  80 84 00 04 */	lwz r4, 4(r4)
/* 80C624DC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C624E0  4B 54 28 C1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C624E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C624E8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C624EC  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C624F0  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C624F4  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C62508  4B 3A B7 BD */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C6250C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C62510  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
