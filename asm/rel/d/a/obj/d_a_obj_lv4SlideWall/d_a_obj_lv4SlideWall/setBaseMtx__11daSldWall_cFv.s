...
/* 80C61EC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C61EC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C61ECC  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C61ED0  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C61ED4  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C61ED8  4B 6E 4A 10 */	b PSMTXTrans
/* 80C61EDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C61EE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C61EE4  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C61EE8  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C61EEC  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C61EF0  4B 3A A3 B0 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C61EF4  C0 3F 05 B0 */	lfs f1, 0x5b0(r31)
/* 80C61EF8  3C 60 80 C6 */	lis r3, lit_3649@ha
/* 80C61EFC  C0 43 26 B0 */	lfs f2, lit_3649@l(r3)
/* 80C61F00  FC 60 10 90 */	fmr f3, f2
/* 80C61F04  4B 3A AE 98 */	b transM__14mDoMtx_stack_cFfff
...
/* 80C61F24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C61F28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C61F2C  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C61F30  38 84 00 24 */	addi r4, r4, 0x24
/* 80C61F34  4B 6E 45 7C */	b PSMTXCopy
