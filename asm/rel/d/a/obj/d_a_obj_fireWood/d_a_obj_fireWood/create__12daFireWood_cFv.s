...
/* 80BE7738  4B 43 14 2D */	bl __ct__10fopAc_ac_cFv
/* 80BE773C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BE7740  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BE7744  90 1E 05 8C */	stw r0, 0x58c(r30)
/* 80BE7748  38 7E 05 90 */	addi r3, r30, 0x590
/* 80BE774C  4B 49 C0 15 */	bl __ct__10dCcD_GSttsFv
/* 80BE7750  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BE7754  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BE776C  4B 49 C2 BD */	bl __ct__12dCcD_GObjInfFv
/* 80BE7770  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BE7774  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BE7778  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80BE777C  3C 60 80 BF */	lis r3, __vt__8cM3dGAab@ha /* 0x80BE8108@ha */
/* 80BE7780  38 03 81 08 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BE8108@l */
/* 80BE7784  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80BE7788  3C 60 80 BF */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BE80FC@ha */
/* 80BE778C  38 03 80 FC */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BE80FC@l */
/* 80BE7790  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80BE7794  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BE7798  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80BE779C  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80BE77A0  38 03 00 58 */	addi r0, r3, 0x58
/* 80BE77A4  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80BE77A8  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BE77AC  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80BE77E8  4B 49 C0 79 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80BE77EC  38 7F 05 B0 */	addi r3, r31, 0x5b0
/* 80BE77F0  3C 80 80 BF */	lis r4, mCcDCyl__12daFireWood_c@ha /* 0x80BE8050@ha */
/* 80BE77F4  38 84 80 50 */	addi r4, r4, mCcDCyl__12daFireWood_c@l /* 0x80BE8050@l */
/* 80BE77F8  4B 49 D0 BD */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
/* 80BE77FC  38 1F 05 74 */	addi r0, r31, 0x574
/* 80BE7800  90 1F 05 F4 */	stw r0, 0x5f4(r31)
/* 80BE7804  3C 60 80 BF */	lis r3, l_cull_box@ha /* 0x80BE8094@ha */
/* 80BE7808  38 83 80 94 */	addi r4, r3, l_cull_box@l /* 0x80BE8094@l */
...
/* 80BE7844  4B 43 2D 05 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80BE7848  C0 1F 04 D0 */	lfs f0, 0x4d0(r31)
/* 80BE784C  D0 1F 06 EC */	stfs f0, 0x6ec(r31)
/* 80BE7850  C0 3F 04 D4 */	lfs f1, 0x4d4(r31)
/* 80BE7854  3C 60 80 BF */	lis r3, l_HIO@ha /* 0x80BE8144@ha */
/* 80BE7858  38 63 81 44 */	addi r3, r3, l_HIO@l /* 0x80BE8144@l */
...
/* 80BE78A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BE78A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80BE78B8  4B 44 DA A9 */	bl isSwitch__10dSv_info_cCFii
