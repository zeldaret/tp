...
/* 80C87E74  4B 3F 07 B1 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C87E78  3C 60 80 C9 */	lis r3, __vt__13daKekaiTrap_c@ha /* 0x80C885C8@ha */
/* 80C87E7C  38 03 85 C8 */	addi r0, r3, __vt__13daKekaiTrap_c@l /* 0x80C885C8@l */
...
/* 80C87EA8  3C 80 80 C9 */	lis r4, l_type@ha /* 0x80C88524@ha */
/* 80C87EAC  38 84 85 24 */	addi r4, r4, l_type@l /* 0x80C88524@l */
/* 80C87EB0  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C87EB4  4B 3A 50 09 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C87ED0  3C 80 80 C9 */	lis r4, l_type@ha /* 0x80C88524@ha */
/* 80C87ED4  38 84 85 24 */	addi r4, r4, l_type@l /* 0x80C88524@l */
/* 80C87ED8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C87EDC  3C A0 80 C9 */	lis r5, l_dzbIdx@ha /* 0x80C8852C@ha */
/* 80C87EE0  38 A5 85 2C */	addi r5, r5, l_dzbIdx@l /* 0x80C8852C@l */
/* 80C87EE4  7C A5 00 2E */	lwzx r5, r5, r0
/* 80C87EE8  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80C87EEC  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80C87EF0  38 E0 40 00 */	li r7, 0x4000
/* 80C87EF4  39 00 00 00 */	li r8, 0
/* 80C87EF8  4B 3F 08 C5 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C87F24  4B 39 26 55 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80C87F34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C87F38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C87F3C  88 9E 05 AD */	lbz r4, 0x5ad(r30)
/* 80C87F40  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C87F44  7C 05 07 74 */	extsb r5, r0
/* 80C87F48  4B 3A D4 19 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C87F68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C87F6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C87F70  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C87F74  4B 3E C2 DD */	bl Release__4cBgSFP9dBgW_Base
lbl_80C87F78:
/* 80C87F78  3C 60 80 C9 */	lis r3, lit_3651@ha /* 0x80C884E4@ha */
/* 80C87F7C  C0 03 84 E4 */	lfs f0, lit_3651@l(r3)  /* 0x80C884E4@l */
