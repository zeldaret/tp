...
/* 80C87DE4  3C 60 80 C9 */	lis r3, l_type@ha /* 0x80C88524@ha */
/* 80C87DE8  38 63 85 24 */	addi r3, r3, l_type@l /* 0x80C88524@l */
/* 80C87DEC  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C87DF0  3C 80 80 C9 */	lis r4, l_bmdIdx@ha /* 0x80C88528@ha */
/* 80C87DF4  38 84 85 28 */	addi r4, r4, l_bmdIdx@l /* 0x80C88528@l */
/* 80C87DF8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C87DFC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C87E00  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C87E04  3C A5 00 02 */	addis r5, r5, 2
/* 80C87E08  38 C0 00 80 */	li r6, 0x80
/* 80C87E0C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C87E10  4B 3B 44 DD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C87E20  4B 38 CE 35 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
