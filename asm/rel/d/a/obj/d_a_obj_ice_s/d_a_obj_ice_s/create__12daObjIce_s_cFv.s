...
/* 80C212E4  4B 74 0E F9 */	bl _savegpr_29
/* 80C212E8  7C 7D 1B 78 */	mr r29, r3
/* 80C212EC  3C 80 80 C2 */	lis r4, lit_3644@ha /* 0x80C21AF8@ha */
/* 80C212F0  3B E4 1A F8 */	addi r31, r4, lit_3644@l /* 0x80C21AF8@l */
...
/* 80C2130C  4B 45 73 19 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C21310  3C 60 80 C2 */	lis r3, __vt__12daObjIce_s_c@ha /* 0x80C21BFC@ha */
/* 80C21314  38 03 1B FC */	addi r0, r3, __vt__12daObjIce_s_c@l /* 0x80C21BFC@l */
/* 80C21318  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C2131C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C21320  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C21324  90 1E 06 10 */	stw r0, 0x610(r30)
/* 80C21328  38 7E 06 14 */	addi r3, r30, 0x614
/* 80C2132C  4B 46 24 35 */	bl __ct__10dCcD_GSttsFv
/* 80C21330  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C21334  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C21354  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C21BA8@ha */
/* 80C21358  38 84 1B A8 */	addi r4, r4, l_arcName@l /* 0x80C21BA8@l */
/* 80C2135C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C21360  4B 40 BB 5D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 80C21364  7C 7E 1B 78 */	mr r30, r3
/* 80C21368  2C 1E 00 04 */	cmpwi r30, 4
/* 80C2136C  40 82 00 68 */	bne lbl_80C213D4
/* 80C21370  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C21374  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C21378  3C 63 00 02 */	addis r3, r3, 2
/* 80C2137C  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C21BA8@ha */
/* 80C21380  38 84 1B A8 */	addi r4, r4, l_arcName@l /* 0x80C21BA8@l */
/* 80C21384  80 84 00 00 */	lwz r4, 0(r4)
/* 80C21388  3C A0 80 C2 */	lis r5, d_a_obj_ice_s__stringBase0@ha /* 0x80C21B8C@ha */
/* 80C2138C  38 A5 1B 8C */	addi r5, r5, d_a_obj_ice_s__stringBase0@l /* 0x80C21B8C@l */
/* 80C21390  38 A5 00 08 */	addi r5, r5, 8
/* 80C21394  38 63 C2 F8 */	addi r3, r3, -15624
/* 80C21398  4B 41 B3 21 */	bl getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80C2139C  7C 65 1B 78 */	mr r5, r3
/* 80C213A0  7F A3 EB 78 */	mr r3, r29
/* 80C213A4  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C21BA8@ha */
/* 80C213A8  38 84 1B A8 */	addi r4, r4, l_arcName@l /* 0x80C21BA8@l */
/* 80C213AC  80 84 00 00 */	lwz r4, 0(r4)
/* 80C213B0  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80C213B4  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80C213B8  38 E0 14 40 */	li r7, 0x1440
/* 80C213BC  39 00 00 00 */	li r8, 0
/* 80C213C0  4B 45 73 FD */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
lbl_80C213D4:
/* 80C213D4  3C 60 80 C2 */	lis r3, data_80C21C38@ha /* 0x80C21C38@ha */
/* 80C213D8  8C 03 1C 38 */	lbzu r0, data_80C21C38@l(r3)  /* 0x80C21C38@l */
...
/* 80C213F4  3C 60 80 C2 */	lis r3, l_HIO@ha /* 0x80C21C48@ha */
/* 80C213F8  38 63 1C 48 */	addi r3, r3, l_HIO@l /* 0x80C21C48@l */
...
/* 80C21428  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C2142C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C2147C  4B 3F 90 CD */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80C214C8  4B 64 64 C5 */	bl cM_rndFX__Ff
...
/* 80C21500  4B 45 62 B1 */	bl __ct__18dBgS_ObjGndChk_SplFv
/* 80C21504  38 61 00 14 */	addi r3, r1, 0x14
/* 80C21508  38 81 00 08 */	addi r4, r1, 8
/* 80C2150C  4B 64 68 1D */	bl SetPos__11cBgS_GndChkFPC4cXyz
...
/* 80C21534  4B 3F 8F F5 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80C21548  4B 3F 8F F1 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
/* 80C2154C  38 61 00 14 */	addi r3, r1, 0x14
/* 80C21550  38 80 FF FF */	li r4, -1
/* 80C21554  4B 45 62 F5 */	bl __dt__18dBgS_ObjGndChk_SplFv
...
/* 80C21568  4B 74 0C C1 */	bl _restgpr_29
