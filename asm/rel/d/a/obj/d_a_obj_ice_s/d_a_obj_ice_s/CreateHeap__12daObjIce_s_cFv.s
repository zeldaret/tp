...
/* 80C21590  3C 60 80 C2 */	lis r3, l_arcName@ha /* 0x80C21BA8@ha */
/* 80C21594  38 63 1B A8 */	addi r3, r3, l_arcName@l /* 0x80C21BA8@l */
/* 80C21598  80 63 00 00 */	lwz r3, 0(r3)
/* 80C2159C  3C 80 80 C2 */	lis r4, d_a_obj_ice_s__stringBase0@ha /* 0x80C21B8C@ha */
/* 80C215A0  38 84 1B 8C */	addi r4, r4, d_a_obj_ice_s__stringBase0@l /* 0x80C21B8C@l */
/* 80C215A4  38 84 00 12 */	addi r4, r4, 0x12
/* 80C215A8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C215AC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C215B0  3C A5 00 02 */	addis r5, r5, 2
/* 80C215B4  38 C0 00 80 */	li r6, 0x80
/* 80C215B8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C215BC  4B 41 AD C1 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80C215CC  4B 3F 36 89 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
