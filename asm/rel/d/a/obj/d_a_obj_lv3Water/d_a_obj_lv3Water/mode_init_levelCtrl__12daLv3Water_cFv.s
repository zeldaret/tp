...
/* 80C59770  3C 60 80 C6 */	lis r3, l_HIO@ha /* 0x80C5A314@ha */
/* 80C59774  38 63 A3 14 */	addi r3, r3, l_HIO@l /* 0x80C5A314@l */
...
/* 80C59794  4B 3D 38 D9 */	bl dComIfGp_getReverb__Fi
...
/* 80C597A8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C597AC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C597C0  3D 00 80 C6 */	lis r8, lit_3737@ha /* 0x80C5A014@ha */
/* 80C597C4  C0 28 A0 14 */	lfs f1, lit_3737@l(r8)  /* 0x80C5A014@l */
/* 80C597C8  FC 40 08 90 */	fmr f2, f1
/* 80C597CC  3D 00 80 C6 */	lis r8, lit_4068@ha /* 0x80C5A050@ha */
/* 80C597D0  C0 68 A0 50 */	lfs f3, lit_4068@l(r8)  /* 0x80C5A050@l */
/* 80C597D4  FC 80 18 90 */	fmr f4, f3
/* 80C597D8  39 00 00 00 */	li r8, 0
/* 80C597DC  4B 65 21 A9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C597E0:
