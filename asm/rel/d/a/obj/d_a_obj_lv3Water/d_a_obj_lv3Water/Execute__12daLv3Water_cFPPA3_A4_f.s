...
/* 80C58D88  4B 3B 46 A1 */	bl play__14mDoExt_baseAnmFv
...
/* 80C58D9C  4B 3B 46 8D */	bl play__14mDoExt_baseAnmFv
lbl_80C58DA0:
/* 80C58DA0  38 7E 05 A8 */	addi r3, r30, 0x5a8
/* 80C58DA4  4B 3E FA C9 */	bl eventUpdate__17dEvLib_callback_cFv
/* 80C58DA8  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 80C58DAC  54 04 06 3E */	clrlwi r4, r0, 0x18
/* 80C58DB0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C58DB4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C58DB8  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C58DBC  7C 05 07 74 */	extsb r5, r0
/* 80C58DC0  4B 3D C5 A1 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C58DD4  3C 80 80 C6 */	lis r4, l_mode_func@ha /* 0x80C5A1C8@ha */
/* 80C58DD8  38 04 A1 C8 */	addi r0, r4, l_mode_func@l /* 0x80C5A1C8@l */
/* 80C58DDC  7D 80 2A 14 */	add r12, r0, r5
/* 80C58DE0  4B 70 92 A5 */	bl __ptmf_scall
