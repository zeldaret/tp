...
/* 80C59DA0  3C 60 80 C6 */	lis r3, __vt__12daLv3Water_c@ha /* 0x80C5A29C@ha */
/* 80C59DA4  38 63 A2 9C */	addi r3, r3, __vt__12daLv3Water_c@l /* 0x80C5A29C@l */
...
/* 80C59DCC  3C 60 80 C6 */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80C5A278@ha */
/* 80C59DD0  38 03 A2 78 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80C5A278@l */
...
/* 80C59DF0  3C 60 80 C6 */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80C5A278@ha */
/* 80C59DF4  38 03 A2 78 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80C5A278@l */
/* 80C59DF8  90 1E 05 C8 */	stw r0, 0x5c8(r30)
lbl_80C59DFC:
/* 80C59DFC  34 1E 05 A8 */	addic. r0, r30, 0x5a8
/* 80C59E00  41 82 00 10 */	beq lbl_80C59E10
/* 80C59E04  3C 60 80 C6 */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80C5A284@ha */
/* 80C59E08  38 03 A2 84 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80C5A284@l */
/* 80C59E0C  90 1E 05 A8 */	stw r0, 0x5a8(r30)
lbl_80C59E10:
/* 80C59E10  28 1E 00 00 */	cmplwi r30, 0
/* 80C59E14  41 82 00 1C */	beq lbl_80C59E30
/* 80C59E18  3C 60 80 3B */	lis r3, __vt__16dBgS_MoveBgActor@ha /* 0x803AB9A0@ha */
/* 80C59E1C  38 03 B9 A0 */	addi r0, r3, __vt__16dBgS_MoveBgActor@l /* 0x803AB9A0@l */
/* 80C59E20  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C59E24  7F C3 F3 78 */	mr r3, r30
/* 80C59E28  38 80 00 00 */	li r4, 0
/* 80C59E2C  4B 3B EE 61 */	bl __dt__10fopAc_ac_cFv
lbl_80C59E30:
/* 80C59E30  7F E0 07 35 */	extsh. r0, r31
/* 80C59E34  40 81 00 0C */	ble lbl_80C59E40
/* 80C59E38  7F C3 F3 78 */	mr r3, r30
/* 80C59E3C  4B 67 4F 01 */	bl __dl__FPv
lbl_80C59E40:
