...
/* 80C59C4C  3C 60 80 C6 */	lis r3, __vt__16daLv3Water_HIO_c@ha /* 0x80C5A2E4@ha */
/* 80C59C50  38 03 A2 E4 */	addi r0, r3, __vt__16daLv3Water_HIO_c@l /* 0x80C5A2E4@l */
/* 80C59C54  90 1F 00 00 */	stw r0, 0(r31)
/* 80C59C58  41 82 00 10 */	beq lbl_80C59C68
/* 80C59C5C  3C 60 80 C6 */	lis r3, __vt__14mDoHIO_entry_c@ha /* 0x80C5A2F0@ha */
/* 80C59C60  38 03 A2 F0 */	addi r0, r3, __vt__14mDoHIO_entry_c@l /* 0x80C5A2F0@l */
...
/* 80C59C74  4B 67 50 C9 */	bl __dl__FPv
lbl_80C59C78:
