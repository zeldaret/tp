...
/* 80C58858  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C5885C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C58860  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C58864  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C58868  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C5886C  4B 6E E0 7D */	bl PSMTXTrans
/* 80C58870  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C58874  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C58878  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C5887C  4B 3B 3B B9 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80C5889C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C588A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C588A4  80 9F 05 C4 */	lwz r4, 0x5c4(r31)
/* 80C588A8  38 84 00 24 */	addi r4, r4, 0x24
/* 80C588AC  4B 6E DC 05 */	bl PSMTXCopy
lbl_80C588B0:
/* 80C588B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C588B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C588B8  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C588BC  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C588C0  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C588C4  4B 6E E0 25 */	bl PSMTXTrans
/* 80C588C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C588CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C588D0  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C588D4  4B 3B 3B 61 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80C588F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C588F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C588FC  80 9F 05 C0 */	lwz r4, 0x5c0(r31)
/* 80C58900  38 84 00 24 */	addi r4, r4, 0x24
/* 80C58904  4B 6E DB AD */	bl PSMTXCopy
