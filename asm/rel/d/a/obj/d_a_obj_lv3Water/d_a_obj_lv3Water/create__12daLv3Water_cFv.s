...
/* 80C58ACC  4B 70 97 11 */	bl _savegpr_29
...
/* 80C58AEC  4B 41 FB 39 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C58AF0  3C 60 80 C6 */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80C5A284@ha */
/* 80C58AF4  38 03 A2 84 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80C5A284@l */
...
/* 80C58B08  3C 60 80 C6 */	lis r3, __vt__12daLv3Water_c@ha /* 0x80C5A29C@ha */
/* 80C58B0C  38 63 A2 9C */	addi r3, r3, __vt__12daLv3Water_c@l /* 0x80C5A29C@l */
...
/* 80C58B20  3C 60 80 C6 */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80C5A278@ha */
/* 80C58B24  38 03 A2 78 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80C5A278@l */
/* 80C58B28  90 1F 05 C8 */	stw r0, 0x5c8(r31)
/* 80C58B2C  7F A3 EB 78 */	mr r3, r29
/* 80C58B30  38 80 00 00 */	li r4, 0
/* 80C58B34  4B 6C F8 C9 */	bl init__12J3DFrameCtrlFs
/* 80C58B38  38 00 00 00 */	li r0, 0
/* 80C58B3C  90 1D 00 14 */	stw r0, 0x14(r29)
/* 80C58B40  3B BF 05 E0 */	addi r29, r31, 0x5e0
/* 80C58B44  3C 60 80 C6 */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x80C5A278@ha */
/* 80C58B48  38 03 A2 78 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x80C5A278@l */
/* 80C58B4C  90 1F 05 E0 */	stw r0, 0x5e0(r31)
/* 80C58B50  7F A3 EB 78 */	mr r3, r29
/* 80C58B54  38 80 00 00 */	li r4, 0
/* 80C58B58  4B 6C F8 A5 */	bl init__12J3DFrameCtrlFs
...
/* 80C58B88  3C 80 80 C6 */	lis r4, l_resNameIdx@ha /* 0x80C5A15C@ha */
/* 80C58B8C  38 84 A1 5C */	addi r4, r4, l_resNameIdx@l /* 0x80C5A15C@l */
/* 80C58B90  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C58B94  4B 3D 43 29 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C58BB0  3C 80 80 C6 */	lis r4, l_resNameIdx@ha /* 0x80C5A15C@ha */
/* 80C58BB4  38 84 A1 5C */	addi r4, r4, l_resNameIdx@l /* 0x80C5A15C@l */
/* 80C58BB8  7C 84 30 2E */	lwzx r4, r4, r6
/* 80C58BBC  3C A0 80 C6 */	lis r5, l_dzbIdx@ha /* 0x80C59EC4@ha */
/* 80C58BC0  38 A5 9E C4 */	addi r5, r5, l_dzbIdx@l /* 0x80C59EC4@l */
/* 80C58BC4  7C A5 30 2E */	lwzx r5, r5, r6
/* 80C58BC8  38 C0 00 00 */	li r6, 0
/* 80C58BCC  54 00 08 3C */	slwi r0, r0, 1
/* 80C58BD0  3C E0 80 C6 */	lis r7, estimateSizeTbl@ha /* 0x80C5A018@ha */
/* 80C58BD4  38 E7 A0 18 */	addi r7, r7, estimateSizeTbl@l /* 0x80C5A018@l */
/* 80C58BD8  7C E7 02 2E */	lhzx r7, r7, r0
/* 80C58BDC  39 00 00 00 */	li r8, 0
/* 80C58BE0  4B 41 FB DD */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C58BFC  3C 60 80 C6 */	lis r3, lit_3812@ha /* 0x80C5A048@ha */
/* 80C58C00  C8 23 A0 48 */	lfd f1, lit_3812@l(r3)  /* 0x80C5A048@l */
...
/* 80C58C28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C58C2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C58C30  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C58C34  7C 05 07 74 */	extsb r5, r0
/* 80C58C38  4B 3D C7 29 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C58C94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C58C98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C58C9C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C58CA0  4B 41 B5 B1 */	bl Release__4cBgSFP9dBgW_Base
lbl_80C58CA4:
...
/* 80C58D0C  4B 70 95 1D */	bl _restgpr_29
