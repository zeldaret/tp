...
/* 8057EE44  3C 60 80 58 */	lis r3, lit_3656@ha /* 0x8057F570@ha */
/* 8057EE48  3B C3 F5 70 */	addi r30, r3, lit_3656@l /* 0x8057F570@l */
...
/* 8057EE84  4B CF 0A F9 */	bl cLib_addCalc__FPfffff
...
/* 8057EEC0  4B CF 0A BD */	bl cLib_addCalc__FPfffff
...
/* 8057EEEC  4B AA E1 81 */	bl dComIfGp_getReverb__Fi
...
/* 8057EF00  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8057EF04  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8057EF2C  4B D2 CA 59 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 8057EF44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8057EF48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8057EF4C  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8057EF50  3C 80 80 58 */	lis r4, l_HIO@ha /* 0x8057F8E4@ha */
/* 8057EF54  38 84 F8 E4 */	addi r4, r4, l_HIO@l /* 0x8057F8E4@l */
/* 8057EF58  88 84 00 11 */	lbz r4, 0x11(r4)
/* 8057EF5C  38 A0 00 0F */	li r5, 0xf
/* 8057EF60  38 C1 00 0C */	addi r6, r1, 0xc
/* 8057EF64  4B AF 0A C1 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 8057EF80  3C 60 80 58 */	lis r3, l_HIO@ha /* 0x8057F8E4@ha */
/* 8057EF84  38 63 F8 E4 */	addi r3, r3, l_HIO@l /* 0x8057F8E4@l */
