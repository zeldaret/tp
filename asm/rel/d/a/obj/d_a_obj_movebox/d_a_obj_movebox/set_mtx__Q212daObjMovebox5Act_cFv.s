...
/* 8047E6F4  4B B8 E6 71 */	bl transS__14mDoMtx_stack_cFRC4cXyz
...
/* 8047E70C  3C 60 80 48 */	lis r3, lit_3902@ha /* 0x804810FC@ha */
/* 8047E710  C0 03 10 FC */	lfs f0, lit_3902@l(r3)  /* 0x804810FC@l */
/* 8047E714  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 8047E718  D0 21 00 20 */	stfs f1, 0x20(r1)
/* 8047E71C  3C 60 80 48 */	lis r3, lit_3687@ha /* 0x804810E8@ha */
/* 8047E720  C0 23 10 E8 */	lfs f1, lit_3687@l(r3)  /* 0x804810E8@l */
/* 8047E724  C0 5F 08 D8 */	lfs f2, 0x8d8(r31)
/* 8047E728  FC 60 08 90 */	fmr f3, f1
/* 8047E72C  4B B8 E6 71 */	bl transM__14mDoMtx_stack_cFfff
/* 8047E730  38 61 00 08 */	addi r3, r1, 8
/* 8047E734  38 81 00 18 */	addi r4, r1, 0x18
/* 8047E738  4B BB 90 51 */	bl quat_rotBaseY__5daObjFP10QuaternionRC4cXyz
/* 8047E73C  38 61 00 08 */	addi r3, r1, 8
/* 8047E740  4B B8 E8 3D */	bl quatM__14mDoMtx_stack_cFPC10Quaternion
lbl_8047E744:
/* 8047E744  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 8047E748  4B B8 E7 FD */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8047E74C  57 C0 06 3F */	clrlwi. r0, r30, 0x18
/* 8047E750  41 82 00 1C */	beq lbl_8047E76C
/* 8047E754  3C 60 80 48 */	lis r3, lit_3687@ha /* 0x804810E8@ha */
/* 8047E758  C0 23 10 E8 */	lfs f1, lit_3687@l(r3)  /* 0x804810E8@l */
/* 8047E75C  C0 1F 08 D8 */	lfs f0, 0x8d8(r31)
/* 8047E760  FC 40 00 50 */	fneg f2, f0
/* 8047E764  FC 60 08 90 */	fmr f3, f1
/* 8047E768  4B B8 E6 35 */	bl transM__14mDoMtx_stack_cFfff
lbl_8047E76C:
/* 8047E76C  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 8047E770  28 04 00 00 */	cmplwi r4, 0
/* 8047E774  41 82 00 14 */	beq lbl_8047E788
/* 8047E778  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8047E77C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8047E780  38 84 00 24 */	addi r4, r4, 0x24
/* 8047E784  4B EC 7D 2D */	bl PSMTXCopy
lbl_8047E788:
/* 8047E788  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8047E78C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8047E790  38 9F 05 6C */	addi r4, r31, 0x56c
/* 8047E794  4B EC 7D 1D */	bl PSMTXCopy
