...
/* 80480930  4B EE 18 AC */	b _savegpr_29
...
/* 80480950  4B BF 7C D4 */	b __ct__16dBgS_MoveBgActorFv
/* 80480954  3C 60 80 48 */	lis r3, __vt__Q212daObjMovebox5Act_c@ha
/* 80480958  38 03 18 28 */	addi r0, r3, __vt__Q212daObjMovebox5Act_c@l
/* 8048095C  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80480960  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80480964  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80480968  90 1E 05 C8 */	stw r0, 0x5c8(r30)
/* 8048096C  38 7E 05 CC */	addi r3, r30, 0x5cc
/* 80480970  4B C0 2D F0 */	b __ct__10dCcD_GSttsFv
/* 80480974  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80480978  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80480990  4B C0 30 98 */	b __ct__12dCcD_GObjInfFv
/* 80480994  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80480998  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 8048099C  90 1D 01 20 */	stw r0, 0x120(r29)
/* 804809A0  3C 60 80 48 */	lis r3, __vt__8cM3dGAab@ha
/* 804809A4  38 03 17 E0 */	addi r0, r3, __vt__8cM3dGAab@l
/* 804809A8  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 804809AC  3C 60 80 48 */	lis r3, __vt__8cM3dGCyl@ha
/* 804809B0  38 03 17 D4 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 804809B4  90 1D 01 38 */	stw r0, 0x138(r29)
/* 804809B8  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 804809BC  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 804809C0  90 7D 01 20 */	stw r3, 0x120(r29)
/* 804809C4  38 03 00 58 */	addi r0, r3, 0x58
/* 804809C8  90 1D 01 38 */	stw r0, 0x138(r29)
/* 804809CC  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 804809D0  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80480A44  3C 80 80 48 */	lis r4, M_arcname__Q212daObjMovebox5Act_c@ha
/* 80480A48  38 84 11 04 */	addi r4, r4, M_arcname__Q212daObjMovebox5Act_c@l
/* 80480A4C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80480A50  4B BA C4 6C */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80480A64  3C 60 80 48 */	lis r3, M_attr__Q212daObjMovebox5Act_c@ha
/* 80480A68  38 03 11 68 */	addi r0, r3, M_attr__Q212daObjMovebox5Act_c@l
...
/* 80480A88  3C 80 80 48 */	lis r4, M_arcname__Q212daObjMovebox5Act_c@ha
/* 80480A8C  38 84 11 04 */	addi r4, r4, M_arcname__Q212daObjMovebox5Act_c@l
/* 80480A90  7C 84 00 2E */	lwzx r4, r4, r0
/* 80480A94  1C C5 00 A0 */	mulli r6, r5, 0xa0
/* 80480A98  3C A0 80 48 */	lis r5, M_attr__Q212daObjMovebox5Act_c@ha
/* 80480A9C  38 05 11 68 */	addi r0, r5, M_attr__Q212daObjMovebox5Act_c@l
/* 80480AA0  7C A0 32 14 */	add r5, r0, r6
/* 80480AA4  80 A5 00 5C */	lwz r5, 0x5c(r5)
/* 80480AA8  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Trans__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80480AAC  38 C6 5B 44 */	addi r6, r6, dBgS_MoveBGProc_Trans__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80480AB0  7F C7 F3 78 */	mr r7, r30
/* 80480AB4  39 00 00 00 */	li r8, 0
/* 80480AB8  4B BF 7D 04 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
lbl_80480ABC:
/* 80480ABC  39 61 00 20 */	addi r11, r1, 0x20
/* 80480AC0  4B EE 17 68 */	b _restgpr_29
