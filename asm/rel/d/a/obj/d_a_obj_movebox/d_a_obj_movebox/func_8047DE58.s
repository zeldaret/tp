...
/* 8047DE80  4B EE 43 25 */	bl _savegpr_15
...
/* 8047DEAC  3C 60 80 45 */	lis r3, __float_max@ha /* 0x80450AE8@ha */
/* 8047DEB0  C0 03 0A E8 */	lfs f0, __float_max@l(r3)  /* 0x80450AE8@l */
/* 8047DEB4  D0 18 01 7C */	stfs f0, 0x17c(r24)
/* 8047DEB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8047DEBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8047DEC0  7C 9D 23 78 */	mr r29, r4
/* 8047DEC4  4B B8 E5 19 */	bl mDoMtx_YrotS__FPA4_fs
/* 8047DEC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8047DECC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8047DED0  38 80 40 00 */	li r4, 0x4000
/* 8047DED4  4B B8 E4 C9 */	bl mDoMtx_XrotM__FPA4_fs
/* 8047DED8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8047DEDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8047DEE0  3C 80 80 43 */	lis r4, BaseY__4cXyz@ha /* 0x80430D24@ha */
/* 8047DEE4  38 84 0D 24 */	addi r4, r4, BaseY__4cXyz@l /* 0x80430D24@l */
/* 8047DEE8  38 A1 00 24 */	addi r5, r1, 0x24
/* 8047DEEC  4B EC 8E 81 */	bl PSMTXMultVec
/* 8047DEF0  7F 23 CB 78 */	mr r3, r25
/* 8047DEF4  48 00 07 BD */	bl attr__Q212daObjMovebox5Act_cCFv
/* 8047DEF8  C0 23 00 78 */	lfs f1, 0x78(r3)
/* 8047DEFC  3C 60 80 48 */	lis r3, lit_3831@ha /* 0x804810F8@ha */
/* 8047DF00  C0 03 10 F8 */	lfs f0, lit_3831@l(r3)  /* 0x804810F8@l */
...
/* 8047DF14  4B EC 91 C5 */	bl PSVECScale
/* 8047DF18  3B 60 00 00 */	li r27, 0
/* 8047DF1C  3A E0 00 00 */	li r23, 0
/* 8047DF20  3A C0 00 00 */	li r22, 0
/* 8047DF24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8047DF28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8047DF2C  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 8047DF30  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 8047DF34  3B E3 0C F4 */	addi r31, r3, Zero__4cXyz@l /* 0x80430CF4@l */
/* 8047DF38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8047DF3C  39 E3 D4 70 */	addi r15, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8047DF40  3C 60 80 48 */	lis r3, lit_3687@ha /* 0x804810E8@ha */
/* 8047DF44  3A 03 10 E8 */	addi r16, r3, lit_3687@l /* 0x804810E8@l */
/* 8047DF48  C3 B0 00 00 */	lfs f29, 0(r16)
/* 8047DF4C  3C 60 80 48 */	lis r3, lit_3831@ha /* 0x804810F8@ha */
/* 8047DF50  3A 23 10 F8 */	addi r17, r3, lit_3831@l /* 0x804810F8@l */
/* 8047DF54  7D F2 7B 78 */	mr r18, r15
/* 8047DF58  7D F3 7B 78 */	mr r19, r15
/* 8047DF5C  3C 60 80 48 */	lis r3, M_wall_work__Q212daObjMovebox5Bgc_c@ha /* 0x804820CC@ha */
/* 8047DF60  3A 83 20 CC */	addi r20, r3, M_wall_work__Q212daObjMovebox5Bgc_c@l /* 0x804820CC@l */
...
/* 8047DF74  4B B8 E3 D1 */	bl mDoMtx_XrotS__FPA4_fs
...
/* 8047DF98  4B EC 8D D5 */	bl PSMTXMultVec
/* 8047DF9C  7D E3 7B 78 */	mr r3, r15
/* 8047DFA0  7F A4 EB 78 */	mr r4, r29
/* 8047DFA4  4B B8 E4 39 */	bl mDoMtx_YrotS__FPA4_fs
/* 8047DFA8  38 61 00 30 */	addi r3, r1, 0x30
/* 8047DFAC  4B B8 EE 29 */	bl transM__14mDoMtx_stack_cFRC4cXyz
...
/* 8047E06C  4B BF 9C F9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8047E070  92 BC 00 08 */	stw r21, 8(r28)
/* 8047E074  7F C3 F3 78 */	mr r3, r30
/* 8047E078  7F 84 E3 78 */	mr r4, r28
/* 8047E07C  4B BF 63 39 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8047E0AC  4B EC 92 F1 */	bl PSVECSquareDistance
...
lbl_8047E0C8:
/* 8047E0C8  3C 60 80 43 */	lis r3, Zero__4cXyz@ha /* 0x80430CF4@ha */
/* 8047E0CC  C0 03 0C F4 */	lfs f0, Zero__4cXyz@l(r3)  /* 0x80430CF4@l */
...
/* 8047E120  4B EE 40 D1 */	bl _restgpr_15
