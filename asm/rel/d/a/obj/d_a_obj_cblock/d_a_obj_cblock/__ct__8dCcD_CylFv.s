...
/* 80BC6038  4B 4B D9 F1 */	bl __ct__12dCcD_GObjInfFv
/* 80BC603C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BC6040  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BC6044  90 1F 01 20 */	stw r0, 0x120(r31)
/* 80BC6048  3C 60 80 BC */	lis r3, __vt__8cM3dGAab@ha /* 0x80BC6C10@ha */
/* 80BC604C  38 03 6C 10 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BC6C10@l */
/* 80BC6050  90 1F 01 1C */	stw r0, 0x11c(r31)
/* 80BC6054  3C 60 80 BC */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BC6C04@ha */
/* 80BC6058  38 03 6C 04 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BC6C04@l */
/* 80BC605C  90 1F 01 38 */	stw r0, 0x138(r31)
/* 80BC6060  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BC6064  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80BC6068  90 7F 01 20 */	stw r3, 0x120(r31)
/* 80BC606C  38 03 00 58 */	addi r0, r3, 0x58
/* 80BC6070  90 1F 01 38 */	stw r0, 0x138(r31)
/* 80BC6074  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BC6078  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
