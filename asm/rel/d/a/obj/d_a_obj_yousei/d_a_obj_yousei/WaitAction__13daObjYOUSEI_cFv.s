...
/* 804CF6F4  4B E9 2A D9 */	bl _savegpr_25
/* 804CF6F8  7C 7B 1B 78 */	mr r27, r3
/* 804CF6FC  3C 60 80 4D */	lis r3, lit_1109@ha /* 0x804D17E8@ha */
/* 804CF700  3B A3 17 E8 */	addi r29, r3, lit_1109@l /* 0x804D17E8@l */
/* 804CF704  3C 60 80 4D */	lis r3, ccSphSrc@ha /* 0x804D15F0@ha */
/* 804CF708  3B C3 15 F0 */	addi r30, r3, ccSphSrc@l /* 0x804D15F0@l */
...
/* 804CF720  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CF724  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804CF728  83 3F 5D AC */	lwz r25, 0x5dac(r31)
/* 804CF72C  A3 5F 00 02 */	lhz r26, 2(r31)
/* 804CF730  4B B5 E5 79 */	bl dComIfGs_getMaxLifeGauge__Fv
...
/* 804CF7CC  4B E5 8C 61 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804CF7F4  4B D9 81 61 */	bl cM_rndF__Ff
...
/* 804CF818  4B D9 81 3D */	bl cM_rndF__Ff
...
/* 804CF8D8  4B E5 8B 55 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804CF968  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CF96C  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804CF970  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)
/* 804CF974  38 63 02 10 */	addi r3, r3, 0x210
/* 804CF978  80 9B 06 04 */	lwz r4, 0x604(r27)
/* 804CF97C  4B B7 BF 9D */	bl getEmitter__Q213dPa_control_c7level_cFUl
/* 804CF980  4B DA F2 E1 */	bl deleteAllParticle__14JPABaseEmitterFv
/* 804CF984  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)
/* 804CF988  38 63 02 10 */	addi r3, r3, 0x210
/* 804CF98C  80 9B 06 04 */	lwz r4, 0x604(r27)
/* 804CF990  4B B7 BF 25 */	bl forceOnEventMove__Q213dPa_control_c7level_cFUl
/* 804CF994  3B 80 00 01 */	li r28, 1
/* 804CF998  7F 63 DB 78 */	mr r3, r27
/* 804CF99C  4B B4 A2 E1 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_804CF9A0:
/* 804CF9A0  80 7B 06 B0 */	lwz r3, 0x6b0(r27)
/* 804CF9A4  38 63 00 0C */	addi r3, r3, 0xc
/* 804CF9A8  C0 3E 00 88 */	lfs f1, 0x88(r30)
/* 804CF9AC  4B E5 8A 81 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804CF9D8  4B E5 8A 55 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804CFA28  4B D9 7F 2D */	bl cM_rndF__Ff
...
/* 804CFA54  4B D9 70 E1 */	bl __mi__4cXyzCFRC3Vec
...
/* 804CFA74  4B D9 7F 19 */	bl cM_rndFX__Ff
...
/* 804CFA88  4B D9 7F 05 */	bl cM_rndFX__Ff
...
/* 804CFA9C  4B D9 7B D9 */	bl cM_atan2s__Fff
...
/* 804CFAB8  4B D9 FE C5 */	bl cLib_addCalc__FPfffff
...
/* 804CFAD0  4B D9 FE AD */	bl cLib_addCalc__FPfffff
/* 804CFAD4  A0 1B 00 F8 */	lhz r0, 0xf8(r27)
/* 804CFAD8  28 00 00 06 */	cmplwi r0, 6
/* 804CFADC  40 82 00 70 */	bne lbl_804CFB4C
/* 804CFAE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CFAE4  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804CFAE8  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)
/* 804CFAEC  38 63 02 10 */	addi r3, r3, 0x210
/* 804CFAF0  80 9B 06 04 */	lwz r4, 0x604(r27)
/* 804CFAF4  4B B7 BE 25 */	bl getEmitter__Q213dPa_control_c7level_cFUl
/* 804CFAF8  4B DA F1 69 */	bl deleteAllParticle__14JPABaseEmitterFv
/* 804CFAFC  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)
/* 804CFB00  38 63 02 10 */	addi r3, r3, 0x210
/* 804CFB04  80 9B 06 04 */	lwz r4, 0x604(r27)
/* 804CFB08  4B B7 BD AD */	bl forceOnEventMove__Q213dPa_control_c7level_cFUl
/* 804CFB0C  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)
/* 804CFB10  38 63 02 10 */	addi r3, r3, 0x210
/* 804CFB14  80 9B 06 08 */	lwz r4, 0x608(r27)
/* 804CFB18  4B B7 BE 01 */	bl getEmitter__Q213dPa_control_c7level_cFUl
/* 804CFB1C  4B DA F1 45 */	bl deleteAllParticle__14JPABaseEmitterFv
/* 804CFB20  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)
/* 804CFB24  38 63 02 10 */	addi r3, r3, 0x210
/* 804CFB28  80 9B 06 08 */	lwz r4, 0x608(r27)
/* 804CFB2C  4B B7 BD 89 */	bl forceOnEventMove__Q213dPa_control_c7level_cFUl
...
/* 804CFB44  4B B4 A1 39 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 804CFB48  48 00 00 3C */	b lbl_804CFB84
lbl_804CFB4C:
/* 804CFB4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CFB50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CFB74  4B BA 3E 95 */	bl request__11dAttCatch_cFP10fopAc_ac_cUcfffsi
...
/* 804CFB8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CFB90  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CFBDC  4B B7 D8 F1 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804CFC2C  4B B7 D8 A1 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804CFC44  4B B5 E0 65 */	bl dComIfGs_getMaxLifeGauge__Fv
...
/* 804CFCAC  4B DA 09 5D */	bl cLib_addCalcAngleS2__FPssss
...
/* 804CFCD4  4B E9 25 45 */	bl _restgpr_25
