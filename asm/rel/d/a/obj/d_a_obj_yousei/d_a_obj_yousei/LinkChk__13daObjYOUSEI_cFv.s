...
/* 804CF0A8  4B E9 31 31 */	bl _savegpr_28
/* 804CF0AC  7C 7C 1B 78 */	mr r28, r3
/* 804CF0B0  3C 60 80 4D */	lis r3, ccSphSrc@ha /* 0x804D15F0@ha */
/* 804CF0B4  3B E3 15 F0 */	addi r31, r3, ccSphSrc@l /* 0x804D15F0@l */
/* 804CF0B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CF0BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CF0D0  4B E7 82 CD */	bl PSVECSquareDistance
...
/* 804CF140  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CF144  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804CF1B0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CF1B4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804CF1B8:
...
/* 804CF214  3C 60 80 4D */	lis r3, struct_804D1830+0x0@ha /* 0x804D1830@ha */
/* 804CF218  88 03 18 30 */	lbz r0, struct_804D1830+0x0@l(r3)  /* 0x804D1830@l */
...
/* 804CF234  3C 60 80 4D */	lis r3, struct_804D1830+0x0@ha /* 0x804D1830@ha */
/* 804CF238  98 03 18 30 */	stb r0, struct_804D1830+0x0@l(r3)  /* 0x804D1830@l */
...
/* 804CF258  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804CF25C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804CF278  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804CF27C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804CF280  80 84 00 00 */	lwz r4, 0(r4)
/* 804CF284  4B E7 72 2D */	bl PSMTXCopy
/* 804CF288  38 61 00 2C */	addi r3, r1, 0x2c
/* 804CF28C  38 81 00 20 */	addi r4, r1, 0x20
/* 804CF290  4B DA 1C 5D */	bl MtxPosition__FP4cXyzP4cXyz
/* 804CF294  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 804CF298  38 81 00 20 */	addi r4, r1, 0x20
/* 804CF29C  4B DA 19 69 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 804CF2B4  4B DA 13 55 */	bl cLib_addCalcAngleS2__FPssss
...
/* 804CF2EC  4B E7 80 B1 */	bl PSVECSquareDistance
...
/* 804CF35C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CF360  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804CF3CC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CF3D0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804CF3D4:
...
lbl_804CF40C:
/* 804CF40C  3C 60 80 4D */	lis r3, struct_804D1830+0x1@ha /* 0x804D1831@ha */
/* 804CF410  88 03 18 31 */	lbz r0, struct_804D1830+0x1@l(r3)  /* 0x804D1831@l */
...
/* 804CF450  3C 60 80 4D */	lis r3, struct_804D1830+0x1@ha /* 0x804D1831@ha */
/* 804CF454  98 03 18 31 */	stb r0, struct_804D1830+0x1@l(r3)  /* 0x804D1831@l */
...
/* 804CF490  4B DA 17 75 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 804CF4D8  4B DA 11 31 */	bl cLib_addCalcAngleS2__FPssss
lbl_804CF4DC:
/* 804CF4DC  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 804CF4E0  38 81 00 20 */	addi r4, r1, 0x20
/* 804CF4E4  4B E7 7E B9 */	bl PSVECSquareDistance
...
/* 804CF554  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CF558  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 804CF5C4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 804CF5C8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_804CF5CC:
...
/* 804CF640  3C 60 80 4D */	lis r3, struct_804D1830+0x0@ha /* 0x804D1830@ha */
/* 804CF644  98 03 18 30 */	stb r0, struct_804D1830+0x0@l(r3)  /* 0x804D1830@l */
...
/* 804CF660  3C 60 80 4D */	lis r3, struct_804D1830+0x1@ha /* 0x804D1831@ha */
/* 804CF664  98 03 18 31 */	stb r0, struct_804D1830+0x1@l(r3)  /* 0x804D1831@l */
...
/* 804CF680  3C 60 80 4D */	lis r3, struct_804D1830+0x0@ha /* 0x804D1830@ha */
/* 804CF684  98 03 18 30 */	stb r0, struct_804D1830+0x0@l(r3)  /* 0x804D1830@l */
...
/* 804CF6A0  3C 60 80 4D */	lis r3, struct_804D1830+0x1@ha /* 0x804D1831@ha */
/* 804CF6A4  98 03 18 31 */	stb r0, struct_804D1830+0x1@l(r3)  /* 0x804D1831@l */
/* 804CF6A8  98 1C 05 AD */	stb r0, 0x5ad(r28)
lbl_804CF6AC:
/* 804CF6AC  39 61 00 50 */	addi r11, r1, 0x50
/* 804CF6B0  4B E9 2B 75 */	bl _restgpr_28
