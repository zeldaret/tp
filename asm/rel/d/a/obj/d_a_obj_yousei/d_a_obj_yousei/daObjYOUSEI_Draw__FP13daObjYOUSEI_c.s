...
/* 804D1050  4B E9 11 8D */	bl _savegpr_29
/* 804D1054  7C 7D 1B 78 */	mr r29, r3
/* 804D1058  3C 60 80 4D */	lis r3, ccSphSrc@ha /* 0x804D15F0@ha */
/* 804D105C  3B E3 15 F0 */	addi r31, r3, ccSphSrc@l /* 0x804D15F0@l */
/* 804D1060  80 7D 06 B0 */	lwz r3, 0x6b0(r29)
/* 804D1064  83 C3 00 04 */	lwz r30, 4(r3)
/* 804D1068  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804D106C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804D1070  38 80 00 00 */	li r4, 0
/* 804D1074  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 804D1078  38 DD 01 0C */	addi r6, r29, 0x10c
/* 804D107C  4B CD 27 49 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 804D1080  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804D1084  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804D1088  80 9E 00 04 */	lwz r4, 4(r30)
/* 804D108C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 804D1090  4B CD 3D 11 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804D1094  80 7D 06 B0 */	lwz r3, 0x6b0(r29)
/* 804D1098  4B B4 01 29 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 804D10D4  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 804D10D8  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 804D10DC  4B B5 BF D9 */	bl dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
/* 804D10E0  38 60 00 01 */	li r3, 1
/* 804D10E4  39 61 00 30 */	addi r11, r1, 0x30
/* 804D10E8  4B E9 11 41 */	bl _restgpr_29
