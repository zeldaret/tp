...
/* 804D0E00  4B E9 13 DD */	bl _savegpr_29
/* 804D0E04  7C 7F 1B 78 */	mr r31, r3
/* 804D0E08  3C 80 80 4D */	lis r4, ccSphSrc@ha /* 0x804D15F0@ha */
/* 804D0E0C  3B A4 15 F0 */	addi r29, r4, ccSphSrc@l /* 0x804D15F0@l */
/* 804D0E10  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D0E14  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D0E18  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 804D0E1C  38 04 04 D0 */	addi r0, r4, 0x4d0
/* 804D0E20  3C A0 80 4D */	lis r5, sLink_Pos@ha /* 0x804D182C@ha */
/* 804D0E24  90 05 18 2C */	stw r0, sLink_Pos@l(r5)  /* 0x804D182C@l */
/* 804D0E28  4B B4 9B 3D */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 804D0E2C  D0 3F 06 14 */	stfs f1, 0x614(r31)
/* 804D0E30  7F E3 FB 78 */	mr r3, r31
/* 804D0E34  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 804D0E38  4B B4 98 D9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 804D0EB8  4B E5 75 75 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804D0EEC  4B E9 11 C1 */	bl __cvt_fp2unsigned
...
/* 804D0F60  4B B5 C1 0D */	bl dComIfGp_getReverb__Fi
/* 804D0F64  7C 65 1B 78 */	mr r5, r3
/* 804D0F68  80 7F 06 B0 */	lwz r3, 0x6b0(r31)
/* 804D0F6C  38 80 00 00 */	li r4, 0
/* 804D0F70  4B B4 01 41 */	bl play__16mDoExt_McaMorfSOFUlSc
...
/* 804D0F84  4B E9 12 A5 */	bl _restgpr_29
