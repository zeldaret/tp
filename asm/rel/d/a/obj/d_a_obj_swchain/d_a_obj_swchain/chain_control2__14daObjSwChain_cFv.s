...
/* 80CF99F8  4B 66 87 D5 */	bl _savegpr_25
/* 80CF99FC  7C 7F 1B 78 */	mr r31, r3
/* 80CF9A00  3C 60 80 D0 */	lis r3, lit_3734@ha /* 0x80CFB6EC@ha */
/* 80CF9A04  3B C3 B6 EC */	addi r30, r3, lit_3734@l /* 0x80CFB6EC@l */
/* 80CF9A08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF9A0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF9A48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF9A4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF9A74  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9A78  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9A7C  4B 64 CA 35 */	bl PSMTXCopy
/* 80CF9A80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9A84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80CF9AF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9AF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9AFC  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80CF9B00  4B 31 28 DD */	bl mDoMtx_YrotS__FPA4_fs
/* 80CF9B04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9B08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9B0C  A8 9F 0A 6E */	lha r4, 0xa6e(r31)
/* 80CF9B10  4B 31 28 8D */	bl mDoMtx_XrotM__FPA4_fs
/* 80CF9B14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9B18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9B1C  38 81 00 90 */	addi r4, r1, 0x90
/* 80CF9B20  7C 85 23 78 */	mr r5, r4
/* 80CF9B24  4B 64 D2 49 */	bl PSMTXMultVec
/* 80CF9B28  38 61 00 54 */	addi r3, r1, 0x54
/* 80CF9B2C  38 81 00 90 */	addi r4, r1, 0x90
/* 80CF9B30  38 A1 00 B4 */	addi r5, r1, 0xb4
/* 80CF9B34  4B 56 CF B1 */	bl __pl__4cXyzCFRC3Vec
...
/* 80CF9BBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9BC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9BC4  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80CF9BC8  4B 31 28 15 */	bl mDoMtx_YrotS__FPA4_fs
/* 80CF9BCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9BD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9BD4  A8 9F 0A 6E */	lha r4, 0xa6e(r31)
/* 80CF9BD8  4B 31 27 C5 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CF9BDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9BE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9BE4  38 81 00 84 */	addi r4, r1, 0x84
/* 80CF9BE8  7C 85 23 78 */	mr r5, r4
/* 80CF9BEC  4B 64 D1 81 */	bl PSMTXMultVec
/* 80CF9BF0  38 61 00 84 */	addi r3, r1, 0x84
/* 80CF9BF4  38 81 00 B4 */	addi r4, r1, 0xb4
/* 80CF9BF8  7C 65 1B 78 */	mr r5, r3
/* 80CF9BFC  4B 64 D4 95 */	bl PSVECAdd
...
lbl_80CF9C44:
/* 80CF9C44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9C48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9C4C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80CF9C50  38 04 7F FF */	addi r0, r4, 0x7fff
/* 80CF9C54  7C 04 07 34 */	extsh r4, r0
/* 80CF9C58  4B 31 27 85 */	bl mDoMtx_YrotS__FPA4_fs
/* 80CF9C5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9C60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9C64  A8 1F 0A 6E */	lha r0, 0xa6e(r31)
/* 80CF9C68  7C 00 00 D0 */	neg r0, r0
/* 80CF9C6C  7C 04 07 34 */	extsh r4, r0
/* 80CF9C70  4B 31 27 2D */	bl mDoMtx_XrotM__FPA4_fs
/* 80CF9C74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CF9C78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CF9C7C  38 81 00 B4 */	addi r4, r1, 0xb4
/* 80CF9C80  38 A1 00 A8 */	addi r5, r1, 0xa8
/* 80CF9C84  4B 64 D0 E9 */	bl PSMTXMultVec
/* 80CF9C88  38 61 00 A8 */	addi r3, r1, 0xa8
/* 80CF9C8C  38 9F 0A 78 */	addi r4, r31, 0xa78
/* 80CF9C90  7C 65 1B 78 */	mr r5, r3
/* 80CF9C94  4B 64 D3 FD */	bl PSVECAdd
...
/* 80CF9CE0  3C 60 80 3F */	lis r3, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 80CF9CE4  38 63 1C C4 */	addi r3, r3, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
...
/* 80CF9D20  4B 56 CE 15 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CF9D84  4B 32 3F 39 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
...
/* 80CF9DA8  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80CF9DAC  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 80CF9E60  4B 56 CC D5 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CF9E80  4B 64 D2 B9 */	bl PSVECSquareMag
...
/* 80CF9EEC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CF9EF0  C3 A3 0A E0 */	lfs f29, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CF9F5C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CF9F60  C3 A3 0A E0 */	lfs f29, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CF9F74  4B 56 CF D5 */	bl normalizeZP__4cXyzFv
...
/* 80CF9FAC  4B 56 CB D9 */	bl __ml__4cXyzCFf
...
/* 80CF9FD4  4B 56 CB 11 */	bl __pl__4cXyzCFRC3Vec
...
/* 80CFA048  4B 66 81 D1 */	bl _restgpr_25
