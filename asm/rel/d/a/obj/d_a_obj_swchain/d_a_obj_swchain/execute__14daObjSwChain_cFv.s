...
/* 80CF8EE0  4B 66 92 FD */	bl _savegpr_29
/* 80CF8EE4  7C 7E 1B 78 */	mr r30, r3
/* 80CF8EE8  3C 60 80 D0 */	lis r3, lit_3734@ha /* 0x80CFB6EC@ha */
/* 80CF8EEC  3B E3 B6 EC */	addi r31, r3, lit_3734@l /* 0x80CFB6EC@l */
...
/* 80CF8F08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF8F0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF8F10  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80CF8F14  7C 05 07 74 */	extsb r5, r0
/* 80CF8F18  4B 33 C4 49 */	bl isSwitch__10dSv_info_cCFii
...
/* 80CF8F70  4B 46 65 09 */	bl setFmChainPos__9daPy_py_cFP10fopAc_ac_cP4cXyzi
...
/* 80CF8FF4  4B 46 65 2D */	bl setPlayerSe__9daPy_py_cFUl
lbl_80CF8FF8:
...
/* 80CF90D8  4B 64 E2 C5 */	bl PSVECSquareDistance
...
/* 80CF9148  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CF914C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CF91B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CF91BC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80CF91C0:
...
/* 80CF925C  4B 56 D8 D9 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CF9280  4B 56 DC C9 */	bl normalizeZP__4cXyzFv
...
/* 80CF9340  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF9344  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF9348  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80CF934C  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 80CF9350  38 BE 04 A8 */	addi r5, r30, 0x4a8
/* 80CF9354  4B 56 D7 E1 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CF93A8  4B 57 62 A1 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80CF93AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF93B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF93B4  38 63 23 3C */	addi r3, r3, 0x233c
/* 80CF93B8  38 9E 05 D4 */	addi r4, r30, 0x5d4
/* 80CF93BC  4B 56 B7 ED */	bl Set__4cCcSFP8cCcD_Obj
lbl_80CF93C0:
...
/* 80CF93E8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF93EC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF93F0  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80CF93F4  4B 37 D6 B9 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 80CF93F8  38 61 00 0C */	addi r3, r1, 0xc
/* 80CF93FC  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80CF9400  38 A1 00 60 */	addi r5, r1, 0x60
/* 80CF9404  4B 56 D7 31 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CF943C  4B 38 B2 1D */	bl ChkCoHit__12dCcD_GObjInfFv
...
/* 80CF9458  4B 64 DC 39 */	bl PSVECAdd
lbl_80CF945C:
/* 80CF945C  38 7E 05 98 */	addi r3, r30, 0x598
/* 80CF9460  4B 56 A4 FD */	bl ClrCcMove__9cCcD_SttsFv
...
/* 80CF9478  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF947C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CF94A8  4B 57 61 A1 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80CF94AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CF94B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CF94B4  38 63 23 3C */	addi r3, r3, 0x233c
/* 80CF94B8  38 9E 07 0C */	addi r4, r30, 0x70c
/* 80CF94BC  4B 56 B6 ED */	bl Set__4cCcSFP8cCcD_Obj
lbl_80CF94C0:
...
/* 80CF94D0  4B 66 8D 59 */	bl _restgpr_29
