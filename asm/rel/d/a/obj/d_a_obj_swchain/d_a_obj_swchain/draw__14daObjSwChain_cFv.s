...
/* 80CFB54C  4B 66 6C 90 */	b _savegpr_29
/* 80CFB550  7C 7D 1B 78 */	mr r29, r3
/* 80CFB554  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CFB558  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CFB55C  38 80 00 00 */	li r4, 0
/* 80CFB560  38 BD 04 A8 */	addi r5, r29, 0x4a8
/* 80CFB564  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80CFB568  4B 4A 82 5C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 80CFB590  4B 3A 10 D8 */	b entryObj__6dMdl_cFP10dMdl_obj_c
...
/* 80CFB5AC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CFB5B0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CFB5B4  80 9D 05 70 */	lwz r4, 0x570(r29)
/* 80CFB5B8  80 84 00 04 */	lwz r4, 4(r4)
/* 80CFB5BC  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80CFB5C0  4B 4A 97 E0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CFB5C4  80 7D 05 70 */	lwz r3, 0x570(r29)
/* 80CFB5C8  4B 31 26 FC */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80CFB5CC  38 60 00 01 */	li r3, 1
/* 80CFB5D0  39 61 00 20 */	addi r11, r1, 0x20
/* 80CFB5D4  4B 66 6C 54 */	b _restgpr_29
