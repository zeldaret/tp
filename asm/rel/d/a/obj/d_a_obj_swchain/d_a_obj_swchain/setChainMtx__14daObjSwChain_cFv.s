...
/* 80CFA13C  4B 66 80 8D */	bl _savegpr_24
/* 80CFA140  7C 7A 1B 78 */	mr r26, r3
/* 80CFA144  3C 80 80 D0 */	lis r4, lit_3734@ha /* 0x80CFB6EC@ha */
/* 80CFA148  3B C4 B6 EC */	addi r30, r4, lit_3734@l /* 0x80CFB6EC@l */
/* 80CFA14C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CFA150  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CFA19C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFA1A0  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80CFA1E0  4B 56 C9 55 */	bl __mi__4cXyzCFRC3Vec
...
/* 80CFA24C  4B 64 CE ED */	bl PSVECSquareMag
...
/* 80CFA2B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CFA2BC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CFA328  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CFA32C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80CFA330  48 00 00 08 */	b lbl_80CFA338
lbl_80CFA334:
/* 80CFA334  FC 40 08 90 */	fmr f2, f1
lbl_80CFA338:
/* 80CFA338  C0 21 00 4C */	lfs f1, 0x4c(r1)
/* 80CFA33C  4B 56 D3 39 */	bl cM_atan2s__Fff
...
/* 80CFA350  4B 56 D3 25 */	bl cM_atan2s__Fff
/* 80CFA354  7C 78 1B 78 */	mr r24, r3
/* 80CFA358  38 61 00 3C */	addi r3, r1, 0x3c
/* 80CFA35C  4B 31 2A 09 */	bl transS__14mDoMtx_stack_cFRC4cXyz
...
/* 80CFA370  4B 31 1F 31 */	bl mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80CFA3A0  4B 31 29 C5 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80CFA3A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFA3A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFA3AC  7F 24 CB 78 */	mr r4, r25
/* 80CFA3B0  4B 31 20 85 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CFA3B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFA3B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFA3BC  A8 1A 0A 6E */	lha r0, 0xa6e(r26)
/* 80CFA3C0  7C 00 00 D0 */	neg r0, r0
/* 80CFA3C4  7C 04 07 34 */	extsh r4, r0
/* 80CFA3C8  4B 31 1F D5 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CFA3CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFA3D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFA3D4  38 80 00 00 */	li r4, 0
/* 80CFA3D8  4B 31 20 F5 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80CFA3DC:
...
/* 80CFA3F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFA3FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFA400  80 9A 05 70 */	lwz r4, 0x570(r26)
/* 80CFA404  38 84 00 24 */	addi r4, r4, 0x24
/* 80CFA408  4B 64 C0 A9 */	bl PSMTXCopy
/* 80CFA40C  48 00 00 14 */	b lbl_80CFA420
lbl_80CFA410:
/* 80CFA410  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFA414  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFA418  7F 84 E3 78 */	mr r4, r28
/* 80CFA41C  4B 64 C0 95 */	bl PSMTXCopy
lbl_80CFA420:
...
/* 80CFA434  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFA438  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFA43C  80 9A 05 70 */	lwz r4, 0x570(r26)
/* 80CFA440  38 84 00 24 */	addi r4, r4, 0x24
/* 80CFA444  4B 64 C0 6D */	bl PSMTXCopy
/* 80CFA448  48 00 00 14 */	b lbl_80CFA45C
lbl_80CFA44C:
/* 80CFA44C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CFA450  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CFA454  7F 84 E3 78 */	mr r4, r28
/* 80CFA458  4B 64 C0 59 */	bl PSMTXCopy
lbl_80CFA45C:
