...
/* 80BBE048  4B 7A 41 85 */	bl _savegpr_25
/* 80BBE04C  7C 7C 1B 78 */	mr r28, r3
/* 80BBE050  3C 60 80 BC */	lis r3, lit_3896@ha /* 0x80BC2148@ha */
/* 80BBE054  3B A3 21 48 */	addi r29, r3, lit_3896@l /* 0x80BC2148@l */
...
/* 80BBE070  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80BBE074  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80BBE078  80 63 00 00 */	lwz r3, 0(r3)
/* 80BBE07C  A8 9C 04 B6 */	lha r4, 0x4b6(r28)
/* 80BBE080  4B 44 E3 5D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80BBE0A0  4B 6B 2E 4D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80BBE0C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BBE0C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BBE0C8  88 03 4F AD */	lbz r0, 0x4fad(r3)
/* 80BBE0CC  28 00 00 00 */	cmplwi r0, 0
/* 80BBE0D0  40 82 00 6C */	bne lbl_80BBE13C
/* 80BBE0D4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80BBE0D8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80BBE0DC  80 63 00 00 */	lwz r3, 0(r3)
/* 80BBE0E0  3C 80 80 BC */	lis r4, struct_80BC2524+0x2@ha /* 0x80BC2526@ha */
/* 80BBE0E4  38 84 25 26 */	addi r4, r4, struct_80BC2524+0x2@l /* 0x80BC2526@l */
/* 80BBE0E8  A8 84 00 00 */	lha r4, 0(r4)
/* 80BBE0EC  4B 44 E2 F1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80BBE108  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80BBE10C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80BBE138  4B 6B 2D B5 */	bl MtxPosition__FP4cXyzP4cXyz
lbl_80BBE13C:
...
/* 80BBE164  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80BBE168  3B A3 07 68 */	addi r29, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80BBE210  4B 6A 94 65 */	bl cM_atan2s__Fff
...
/* 80BBE238  4B 6A 94 3D */	bl cM_atan2s__Fff
...
/* 80BBE280  4B 44 E1 5D */	bl mDoMtx_YrotS__FPA4_fs
/* 80BBE284  80 7D 00 00 */	lwz r3, 0(r29)
/* 80BBE288  7F 44 D3 78 */	mr r4, r26
/* 80BBE28C  4B 44 E1 11 */	bl mDoMtx_XrotM__FPA4_fs
/* 80BBE290  38 61 00 2C */	addi r3, r1, 0x2c
/* 80BBE294  38 81 00 20 */	addi r4, r1, 0x20
/* 80BBE298  4B 6B 2C 55 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80BBE324  4B 7A 3E F5 */	bl _restgpr_25
