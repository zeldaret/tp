...
/* 80C77CDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C77CE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C77CE4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C77CE8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C77CEC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C77CF0  4B 6C EB F9 */	bl PSMTXTrans
/* 80C77CF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C77CF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C77CFC  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C77D00  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80C77D04  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80C77D08  4B 39 45 99 */	bl mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80C77D28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C77D2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C77D30  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C77D34  38 84 00 24 */	addi r4, r4, 0x24
/* 80C77D38  4B 6C E7 79 */	bl PSMTXCopy
