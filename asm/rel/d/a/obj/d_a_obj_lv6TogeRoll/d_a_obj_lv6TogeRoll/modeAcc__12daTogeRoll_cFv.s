...
/* 80C78CC4  4B 6E 95 15 */	bl _savegpr_28
/* 80C78CC8  7C 7C 1B 78 */	mr r28, r3
/* 80C78CCC  3C 60 80 C8 */	lis r3, lit_3651@ha /* 0x80C799E4@ha */
/* 80C78CD0  3B C3 99 E4 */	addi r30, r3, lit_3651@l /* 0x80C799E4@l */
/* 80C78CD4  C0 3C 05 D4 */	lfs f1, 0x5d4(r28)
/* 80C78CD8  38 7C 05 2C */	addi r3, r28, 0x52c
/* 80C78CDC  3C 80 80 C8 */	lis r4, l_HIO@ha /* 0x80C79D44@ha */
/* 80C78CE0  38 84 9D 44 */	addi r4, r4, l_HIO@l /* 0x80C79D44@l */
/* 80C78CE4  C0 04 00 08 */	lfs f0, 8(r4)
/* 80C78CE8  EC 41 00 24 */	fdivs f2, f1, f0
/* 80C78CEC  4B 5F 7A 55 */	bl cLib_chaseF__FPfff
...
/* 80C78D08  4B 5F 6D B1 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
/* 80C78D0C  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 80C78D10  7C 03 07 74 */	extsb r3, r0
/* 80C78D14  4B 3B 43 59 */	bl dComIfGp_getReverb__Fi
/* 80C78D18  7C 7D 1B 78 */	mr r29, r3
/* 80C78D1C  C0 3C 05 2C */	lfs f1, 0x52c(r28)
/* 80C78D20  4B 6E 93 8D */	bl __cvt_fp2unsigned
...
/* 80C78D34  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C78D38  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C78D60  4B 63 37 AD */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C78D74  4B 5E E2 B9 */	bl __eq__4cXyzCFRC3Vec
...
/* 80C78D8C  4B 6E 94 99 */	bl _restgpr_28
