...
/* 80C7972C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C79730  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C79734  38 80 00 40 */	li r4, 0x40
/* 80C79738  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C7973C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C79740  4B 52 A0 85 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C79744  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80C79748  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80C7974C  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80C79750  80 84 00 04 */	lwz r4, 4(r4)
/* 80C79754  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C79758  4B 52 B6 49 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C7975C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C79760  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C79764  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C79768  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80C7976C  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80C79780  4B 39 45 45 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C79784  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C79788  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
