...
/* 80C782C4  4B 6E 9E FD */	bl _savegpr_22
/* 80C782C8  7C 7E 1B 78 */	mr r30, r3
/* 80C782CC  7C 9F 23 78 */	mr r31, r4
/* 80C782D0  3C 80 80 C8 */	lis r4, lit_3651@ha /* 0x80C799E4@ha */
/* 80C782D4  3B A4 99 E4 */	addi r29, r4, lit_3651@l /* 0x80C799E4@l */
...
/* 80C78348  4B 40 C1 19 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 80C7834C  28 03 00 00 */	cmplwi r3, 0
/* 80C78350  41 82 00 48 */	beq lbl_80C78398
/* 80C78354  7F 23 CB 78 */	mr r3, r25
/* 80C78358  4B 40 C1 F1 */	bl GetTgHitGObj__12dCcD_GObjInfFv
/* 80C7835C  7C 7C 1B 78 */	mr r28, r3
/* 80C78360  7F 23 CB 78 */	mr r3, r25
/* 80C78364  4B 40 C1 95 */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 80C78368  7C 77 1B 78 */	mr r23, r3
/* 80C7836C  7F 23 CB 78 */	mr r3, r25
/* 80C78370  4B 40 C2 0D */	bl GetTgHitObjSe__12dCcD_GObjInfFv
/* 80C78374  38 80 00 01 */	li r4, 1
/* 80C78378  4B 40 C2 39 */	bl getHitSeID__12dCcD_GObjInfFUci
...
/* 80C783BC  4B 5E B6 8D */	bl GetAc__8cCcD_ObjFv
...
/* 80C7840C  4B 64 60 99 */	bl startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
...
/* 80C7842C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C78430  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C7844C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C78450  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_80C78454:
...
/* 80C784C8  4B 6C EB C9 */	bl PSVECAdd
...
/* 80C7851C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C78520  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C78524  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 80C78528  A8 BE 04 DE */	lha r5, 0x4de(r30)
/* 80C7852C  A8 DE 04 E0 */	lha r6, 0x4e0(r30)
/* 80C78530  4B 39 3C D9 */	bl mDoMtx_ZXYrotS__FPA4_fsss
/* 80C78534  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80C78538  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80C7853C  38 81 00 20 */	addi r4, r1, 0x20
/* 80C78540  7C 85 23 78 */	mr r5, r4
/* 80C78544  4B 6C E8 29 */	bl PSMTXMultVec
/* 80C78548  38 61 00 14 */	addi r3, r1, 0x14
/* 80C7854C  38 81 00 20 */	addi r4, r1, 0x20
/* 80C78550  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C78554  4B 5E E5 91 */	bl __pl__4cXyzCFRC3Vec
...
/* 80C7857C  4B 5E E5 B9 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C785A8  4B 5F 6A 95 */	bl Set__8cM3dGCpsFRC9cM3dGCpsS
/* 80C785AC  7E E3 BB 78 */	mr r3, r23
/* 80C785B0  38 9E 0F F8 */	addi r4, r30, 0xff8
/* 80C785B4  4B 5E C5 F5 */	bl Set__4cCcSFP8cCcD_Obj
/* 80C785B8  38 7E 06 18 */	addi r3, r30, 0x618
/* 80C785BC  4B 40 B2 75 */	bl Move__10dCcD_GSttsFv
/* 80C785C0  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C785C4  7C 03 07 74 */	extsb r3, r0
/* 80C785C8  4B 3B 4A A5 */	bl dComIfGp_getReverb__Fi
...
/* 80C78624  4B 6E 9B E9 */	bl _restgpr_22
