...
/* 80BEDCF8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BEDCFC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BEDD00  38 80 00 10 */	li r4, 0x10
/* 80BEDD04  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80BEDD08  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80BEDD0C  4B 5B 5A B9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80BEDD10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BEDD14  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BEDD18  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80BEDD1C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80BEDD20  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
/* 80BEDD24  90 1F 00 48 */	stw r0, 0x48(r31)
/* 80BEDD28  80 04 5F 74 */	lwz r0, 0x5f74(r4)
/* 80BEDD2C  90 1F 00 4C */	stw r0, 0x4c(r31)
/* 80BEDD30  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80BEDD34  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80BEDD38  80 9E 05 68 */	lwz r4, 0x568(r30)
/* 80BEDD3C  80 84 00 04 */	lwz r4, 4(r4)
/* 80BEDD40  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80BEDD44  4B 5B 70 5D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BEDD48  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 80BEDD4C  4B 41 FF 79 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80BEDD68  4B 73 77 25 */	bl entryImm__13J3DDrawBufferFP9J3DPacketUs
lbl_80BEDD6C:
/* 80BEDD6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BEDD70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
