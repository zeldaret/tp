...
/* 80BEC940  4B 77 58 9D */	bl _savegpr_29
/* 80BEC944  7C 7D 1B 78 */	mr r29, r3
/* 80BEC948  7C 80 23 78 */	mr r0, r4
/* 80BEC94C  7C DE 33 78 */	mr r30, r6
/* 80BEC950  FF E0 08 90 */	fmr f31, f1
/* 80BEC954  3C 60 80 BF */	lis r3, M_attr__12daObjFlag2_c@ha /* 0x80BEE0DC@ha */
/* 80BEC958  3B E3 E0 DC */	addi r31, r3, M_attr__12daObjFlag2_c@l /* 0x80BEE0DC@l */
/* 80BEC95C  38 61 00 18 */	addi r3, r1, 0x18
/* 80BEC960  7C A4 2B 78 */	mr r4, r5
/* 80BEC964  7C 05 03 78 */	mr r5, r0
/* 80BEC968  4B 67 A1 CD */	bl __mi__4cXyzCFRC3Vec
...
/* 80BEC988  4B 75 A7 B1 */	bl PSVECSquareMag
...
/* 80BEC9F8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BEC9FC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80BECA68  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80BECA6C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80BECA70:
/* 80BECA70  EF E1 F8 28 */	fsubs f31, f1, f31
/* 80BECA74  38 61 00 0C */	addi r3, r1, 0xc
/* 80BECA78  38 81 00 30 */	addi r4, r1, 0x30
/* 80BECA7C  4B 67 A3 49 */	bl normZC__4cXyzCFv
