...
/* 80BED490  4B 77 4D 4D */	bl _savegpr_29
...
/* 80BED4B4  3C 80 80 BF */	lis r4, d_a_obj_flag2__stringBase0@ha /* 0x80BEE1E8@ha */
/* 80BED4B8  38 84 E1 E8 */	addi r4, r4, d_a_obj_flag2__stringBase0@l /* 0x80BEE1E8@l */
/* 80BED4BC  38 84 00 09 */	addi r4, r4, 9
/* 80BED4C0  4C C6 31 82 */	crclr 6
/* 80BED4C4  4B 77 90 19 */	bl sprintf
...
/* 80BED4E8  3C 80 80 BF */	lis r4, d_a_obj_flag2__stringBase0@ha /* 0x80BEE1E8@ha */
/* 80BED4EC  38 84 E1 E8 */	addi r4, r4, d_a_obj_flag2__stringBase0@l /* 0x80BEE1E8@l */
/* 80BED4F0  38 84 00 16 */	addi r4, r4, 0x16
/* 80BED4F4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BED4F8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BED4FC  3C A5 00 02 */	addis r5, r5, 2
/* 80BED500  38 C0 00 80 */	li r6, 0x80
/* 80BED504  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BED508  4B 44 EE 75 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80BED540  4B 77 09 01 */	bl GXInitTexObj
...
/* 80BED55C  3C C0 80 BF */	lis r6, lit_4020@ha /* 0x80BEE1C8@ha */
/* 80BED560  C0 46 E1 C8 */	lfs f2, lit_4020@l(r6)  /* 0x80BEE1C8@l */
/* 80BED564  88 1F 00 16 */	lbz r0, 0x16(r31)
/* 80BED568  7C 00 07 74 */	extsb r0, r0
/* 80BED56C  3C C0 80 BF */	lis r6, lit_4023@ha /* 0x80BEE1D4@ha */
/* 80BED570  C8 86 E1 D4 */	lfd f4, lit_4023@l(r6)  /* 0x80BEE1D4@l */
...
/* 80BED5B0  3C C0 80 BF */	lis r6, lit_4021@ha /* 0x80BEE1CC@ha */
/* 80BED5B4  C0 66 E1 CC */	lfs f3, lit_4021@l(r6)  /* 0x80BEE1CC@l */
...
/* 80BED5E0  4B 77 0A F5 */	bl GXInitTexObjLOD
lbl_80BED5E4:
...
/* 80BED5F4  3C 60 80 BF */	lis r3, l_texCoord_64x64@ha /* 0x80BEE31C@ha */
/* 80BED5F8  38 03 E3 1C */	addi r0, r3, l_texCoord_64x64@l /* 0x80BEE31C@l */
...
/* 80BED610  3C 60 80 BF */	lis r3, l_texCoord@ha /* 0x80BEE3C4@ha */
/* 80BED614  38 03 E3 C4 */	addi r0, r3, l_texCoord@l /* 0x80BEE3C4@l */
/* 80BED618  90 1E 10 6C */	stw r0, 0x106c(r30)
lbl_80BED61C:
/* 80BED61C  7F C3 F3 78 */	mr r3, r30
/* 80BED620  4B 44 42 51 */	bl getArcName__12daSetBgObj_cFP10fopAc_ac_c
/* 80BED624  3C 80 80 BF */	lis r4, d_a_obj_flag2__stringBase0@ha /* 0x80BEE1E8@ha */
/* 80BED628  38 84 E1 E8 */	addi r4, r4, d_a_obj_flag2__stringBase0@l /* 0x80BEE1E8@l */
/* 80BED62C  38 84 00 1F */	addi r4, r4, 0x1f
/* 80BED630  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80BED634  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80BED638  3C A5 00 02 */	addis r5, r5, 2
/* 80BED63C  38 C0 00 80 */	li r6, 0x80
/* 80BED640  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BED644  4B 44 ED 39 */	bl getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80BED654  4B 42 76 01 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80BED66C  4B 77 4B BD */	bl _restgpr_29
