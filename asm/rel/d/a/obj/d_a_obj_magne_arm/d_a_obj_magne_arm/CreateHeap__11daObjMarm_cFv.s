...
/* 8058FD08  4B DD 24 CD */	bl _savegpr_27
/* 8058FD0C  7C 7F 1B 78 */	mr r31, r3
/* 8058FD10  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FD14  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
/* 8058FD18  80 63 00 00 */	lwz r3, 0(r3)
/* 8058FD1C  38 80 00 07 */	li r4, 7
/* 8058FD20  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058FD24  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058FD38  4B AA C5 B5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8058FD48  4B A8 4F 0D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8058FD64:
/* 8058FD64  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FD68  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8058FD7C  4B AA C5 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8058FD8C  4B A8 4E C9 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8058FDA8:
/* 8058FDA8  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FDAC  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8058FDC0  4B AA C5 2D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8058FDD0  4B A8 4E 85 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8058FDF0  4B D3 EE 5D */	bl __nw__FUl
/* 8058FDF4  7C 60 1B 79 */	or. r0, r3, r3
/* 8058FDF8  41 82 00 0C */	beq lbl_8058FE04
/* 8058FDFC  4B AE BB 75 */	bl __ct__4dBgWFv
...
/* 8058FE14  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FE18  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8058FE2C  4B AA C4 C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8058FE40  4B AE A0 F9 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_8058FE5C:
/* 8058FE5C  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FE60  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8058FE74  4B AA C4 79 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8058FE84  4B A8 4D D1 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8058FEA0:
/* 8058FEA0  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FEA4  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8058FEB8  4B AA C4 35 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8058FEC8  4B A8 4D 8D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8058FEE4:
/* 8058FEE4  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FEE8  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8058FEFC  4B AA C3 F1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8058FF10  4B A8 4D 45 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8058FF2C:
/* 8058FF2C  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FF30  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8058FF44  4B AA C3 A9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8058FF48  7C 7B 1B 78 */	mr r27, r3
/* 8058FF4C  38 60 00 18 */	li r3, 0x18
/* 8058FF50  4B D3 EC FD */	bl __nw__FUl
/* 8058FF54  7C 7C 1B 79 */	or. r28, r3, r3
/* 8058FF58  41 82 00 20 */	beq lbl_8058FF78
/* 8058FF5C  3C 80 80 59 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80592D30@ha */
/* 8058FF60  38 04 2D 30 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80592D30@l */
/* 8058FF64  90 1C 00 00 */	stw r0, 0(r28)
/* 8058FF68  38 80 00 00 */	li r4, 0
/* 8058FF6C  4B D9 84 91 */	bl init__12J3DFrameCtrlFs
...
/* 8058FF98  3D 00 80 59 */	lis r8, lit_4010@ha /* 0x8059290C@ha */
/* 8058FF9C  C0 28 29 0C */	lfs f1, lit_4010@l(r8)  /* 0x8059290C@l */
/* 8058FFA0  39 00 00 00 */	li r8, 0
/* 8058FFA4  39 20 FF FF */	li r9, -1
/* 8058FFA8  4B A7 D7 65 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_8058FFBC:
/* 8058FFBC  3C 60 80 59 */	lis r3, lit_4010@ha /* 0x8059290C@ha */
/* 8058FFC0  C0 03 29 0C */	lfs f0, lit_4010@l(r3)  /* 0x8059290C@l */
/* 8058FFC4  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 8058FFC8  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 8058FFCC  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 8058FFD0  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8058FFE4  4B AA C3 09 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8058FFE8  7C 7B 1B 78 */	mr r27, r3
/* 8058FFEC  38 60 00 18 */	li r3, 0x18
/* 8058FFF0  4B D3 EC 5D */	bl __nw__FUl
/* 8058FFF4  7C 7C 1B 79 */	or. r28, r3, r3
/* 8058FFF8  41 82 00 20 */	beq lbl_80590018
/* 8058FFFC  3C 80 80 59 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80592D30@ha */
/* 80590000  38 04 2D 30 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80592D30@l */
/* 80590004  90 1C 00 00 */	stw r0, 0(r28)
/* 80590008  38 80 00 00 */	li r4, 0
/* 8059000C  4B D9 83 F1 */	bl init__12J3DFrameCtrlFs
...
/* 80590038  3D 00 80 59 */	lis r8, lit_4010@ha /* 0x8059290C@ha */
/* 8059003C  C0 28 29 0C */	lfs f1, lit_4010@l(r8)  /* 0x8059290C@l */
/* 80590040  39 00 00 00 */	li r8, 0
/* 80590044  39 20 FF FF */	li r9, -1
/* 80590048  4B A7 D5 F5 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_8059005C:
/* 8059005C  3C 60 80 59 */	lis r3, lit_4010@ha /* 0x8059290C@ha */
/* 80590060  C0 03 29 0C */	lfs f0, lit_4010@l(r3)  /* 0x8059290C@l */
/* 80590064  80 7F 05 C4 */	lwz r3, 0x5c4(r31)
/* 80590068  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 8059006C  38 60 00 C0 */	li r3, 0xc0
/* 80590070  4B D3 EB DD */	bl __nw__FUl
/* 80590074  7C 60 1B 79 */	or. r0, r3, r3
/* 80590078  41 82 00 0C */	beq lbl_80590084
/* 8059007C  4B AE B8 F5 */	bl __ct__4dBgWFv
...
/* 80590094  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 80590098  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 805900AC  4B AA C2 41 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805900C0  4B AE 9E 79 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 805900F0  4B D3 EB 5D */	bl __nw__FUl
/* 805900F4  28 03 00 00 */	cmplwi r3, 0
/* 805900F8  41 82 00 1C */	beq lbl_80590114
/* 805900FC  3C 80 80 59 */	lis r4, __vt__18mDoExt_3DlineMat_c@ha /* 0x80592D1C@ha */
/* 80590100  38 04 2D 1C */	addi r0, r4, __vt__18mDoExt_3DlineMat_c@l /* 0x80592D1C@l */
/* 80590104  90 03 00 00 */	stw r0, 0(r3)
/* 80590108  3C 80 80 3A */	lis r4, __vt__19mDoExt_3DlineMat1_c@ha /* 0x803A3248@ha */
/* 8059010C  38 04 32 48 */	addi r0, r4, __vt__19mDoExt_3DlineMat1_c@l /* 0x803A3248@l */
/* 80590110  90 03 00 00 */	stw r0, 0(r3)
lbl_80590114:
/* 80590114  90 7F 0A 20 */	stw r3, 0xa20(r31)
/* 80590118  38 60 00 3C */	li r3, 0x3c
/* 8059011C  4B D3 EB 31 */	bl __nw__FUl
/* 80590120  28 03 00 00 */	cmplwi r3, 0
/* 80590124  41 82 00 1C */	beq lbl_80590140
/* 80590128  3C 80 80 59 */	lis r4, __vt__18mDoExt_3DlineMat_c@ha /* 0x80592D1C@ha */
/* 8059012C  38 04 2D 1C */	addi r0, r4, __vt__18mDoExt_3DlineMat_c@l /* 0x80592D1C@l */
/* 80590130  90 03 00 00 */	stw r0, 0(r3)
/* 80590134  3C 80 80 3A */	lis r4, __vt__19mDoExt_3DlineMat1_c@ha /* 0x803A3248@ha */
/* 80590138  38 04 32 48 */	addi r0, r4, __vt__19mDoExt_3DlineMat1_c@l /* 0x803A3248@l */
...
lbl_80590164:
/* 80590164  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 80590168  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 8059017C  4B AA C1 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80590194  4B A8 31 CD */	bl init__19mDoExt_3DlineMat1_cFUsUsP7ResTIMGi
...
lbl_805901A8:
/* 805901A8  3C 60 80 59 */	lis r3, l_arcName@ha /* 0x805929A0@ha */
/* 805901AC  38 63 29 A0 */	addi r3, r3, l_arcName@l /* 0x805929A0@l */
...
/* 805901C0  4B AA C1 2D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
