...
/* 8058FA60  4B DD 27 7D */	bl _savegpr_29
/* 8058FA64  7C 7E 1B 78 */	mr r30, r3
/* 8058FA68  3C 80 80 59 */	lis r4, l_magne_scale@ha /* 0x80592848@ha */
/* 8058FA6C  3B E4 28 48 */	addi r31, r4, l_magne_scale@l /* 0x80592848@l */
...
lbl_8058FB40:
/* 8058FB40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8058FB44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8058FB58  4B AE 4E B1 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 8058FB70  4B AE 4E 99 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
lbl_8058FB84:
/* 8058FB84  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075A24@ha */
/* 8058FB88  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075A24@l */
/* 8058FB8C  80 7E 05 CC */	lwz r3, 0x5cc(r30)
/* 8058FB90  90 03 00 B0 */	stw r0, 0xb0(r3)
/* 8058FB94  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 8058FB98  38 03 5A D8 */	addi r0, r3, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
...
/* 8058FBB8  4B AE 63 A1 */	bl SetWall__12dBgS_AcchCirFff
...
/* 8058FBE4  4B AE 66 65 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 8058FBF8  3C 80 80 59 */	lis r4, l_cull_box2@ha /* 0x805929BC@ha */
/* 8058FBFC  C4 24 29 BC */	lfsu f1, l_cull_box2@l(r4)  /* 0x805929BC@l */
...
/* 8058FC14  4B A8 A9 35 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 8058FC18  48 00 00 28 */	b lbl_8058FC40
lbl_8058FC1C:
/* 8058FC1C  7F C3 F3 78 */	mr r3, r30
/* 8058FC20  3C 80 80 59 */	lis r4, l_cull_box@ha /* 0x805929A4@ha */
/* 8058FC24  C4 24 29 A4 */	lfsu f1, l_cull_box@l(r4)  /* 0x805929A4@l */
...
lbl_8058FCBC:
/* 8058FCBC  3C 60 80 59 */	lis r3, rideCallBack__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 0x8058FA38@ha */
/* 8058FCC0  38 03 FA 38 */	addi r0, r3, rideCallBack__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 0x8058FA38@l */
/* 8058FCC4  80 7E 06 30 */	lwz r3, 0x630(r30)
/* 8058FCC8  90 03 00 B4 */	stw r0, 0xb4(r3)
/* 8058FCCC  7F C3 F3 78 */	mr r3, r30
/* 8058FCD0  4B AE 8C 81 */	bl MoveBGExecute__16dBgS_MoveBgActorFv
...
/* 8058FCE4  4B DD 25 45 */	bl _restgpr_29
