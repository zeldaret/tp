...
/* 80592478  4B DC FD 65 */	bl _savegpr_29
...
/* 80592498  4B AE 61 8D */	bl __ct__16dBgS_MoveBgActorFv
/* 8059249C  3C 60 80 59 */	lis r3, __vt__11daObjMarm_c@ha /* 0x80592D3C@ha */
/* 805924A0  38 03 2D 3C */	addi r0, r3, __vt__11daObjMarm_c@l /* 0x80592D3C@l */
/* 805924A4  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 805924A8  3B BE 06 64 */	addi r29, r30, 0x664
/* 805924AC  7F A3 EB 78 */	mr r3, r29
/* 805924B0  4B AE 3B F1 */	bl __ct__9dBgS_AcchFv
/* 805924B4  3C 60 80 59 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80592CF8@ha */
/* 805924B8  38 63 2C F8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80592CF8@l */
...
/* 805924D4  4B AE 69 95 */	bl SetObj__16dBgS_PolyPassChkFv
/* 805924D8  38 7E 08 3C */	addi r3, r30, 0x83c
/* 805924DC  4B AE 39 D1 */	bl __ct__12dBgS_AcchCirFv
/* 805924E0  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 805924E4  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 805924E8  90 1E 08 94 */	stw r0, 0x894(r30)
/* 805924EC  38 7E 08 98 */	addi r3, r30, 0x898
/* 805924F0  4B AF 12 71 */	bl __ct__10dCcD_GSttsFv
/* 805924F4  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 805924F8  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80592510  4B AF 15 19 */	bl __ct__12dCcD_GObjInfFv
/* 80592514  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80592518  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8059251C  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80592520  3C 60 80 59 */	lis r3, __vt__8cM3dGAab@ha /* 0x80592CEC@ha */
/* 80592524  38 03 2C EC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80592CEC@l */
/* 80592528  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 8059252C  3C 60 80 59 */	lis r3, __vt__8cM3dGCyl@ha /* 0x80592CE0@ha */
/* 80592530  38 03 2C E0 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80592CE0@l */
/* 80592534  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80592538  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 8059253C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80592540  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80592544  38 03 00 58 */	addi r0, r3, 0x58
/* 80592548  90 1D 01 38 */	stw r0, 0x138(r29)
/* 8059254C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80592550  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80592580  4B DC FC A9 */	bl _restgpr_29
