...
/* 8058F630  3C 60 80 59 */	lis r3, lit_3706@ha /* 0x805928C8@ha */
/* 8058F634  C0 03 28 C8 */	lfs f0, lit_3706@l(r3)  /* 0x805928C8@l */
/* 8058F638  D0 01 00 08 */	stfs f0, 8(r1)
/* 8058F63C  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 8058F640  3C 60 80 59 */	lis r3, lit_3707@ha /* 0x805928CC@ha */
/* 8058F644  C0 03 28 CC */	lfs f0, lit_3707@l(r3)  /* 0x805928CC@l */
/* 8058F648  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8058F64C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058F650  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8058F664  4B A7 CD 79 */	bl mDoMtx_YrotS__FPA4_fs
/* 8058F668  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058F66C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058F670  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 8058F674  4B A7 CD C1 */	bl mDoMtx_YrotM__FPA4_fs
/* 8058F678  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8058F67C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8058F680  38 81 00 08 */	addi r4, r1, 8
/* 8058F684  7C 85 23 78 */	mr r5, r4
/* 8058F688  4B DB 76 E5 */	bl PSMTXMultVec
/* 8058F68C  7F E3 FB 78 */	mr r3, r31
/* 8058F690  38 81 00 08 */	addi r4, r1, 8
/* 8058F694  7F E5 FB 78 */	mr r5, r31
/* 8058F698  4B DB 79 F9 */	bl PSVECAdd
