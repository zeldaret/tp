...
/* 80C200DC  4B 74 21 01 */	bl _savegpr_29
/* 80C200E0  7C 7E 1B 78 */	mr r30, r3
/* 80C200E4  3C 80 80 C2 */	lis r4, lit_3675@ha /* 0x80C2078C@ha */
/* 80C200E8  3B E4 07 8C */	addi r31, r4, lit_3675@l /* 0x80C2078C@l */
...
/* 80C20104  4B 45 85 21 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C20108  3C 60 80 C2 */	lis r3, __vt__12daObjIce_l_c@ha /* 0x80C2088C@ha */
/* 80C2010C  38 03 08 8C */	addi r0, r3, __vt__12daObjIce_l_c@l /* 0x80C2088C@l */
/* 80C20110  90 1D 05 9C */	stw r0, 0x59c(r29)
/* 80C20114  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80C20118  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80C2011C  90 1D 06 10 */	stw r0, 0x610(r29)
/* 80C20120  38 7D 06 14 */	addi r3, r29, 0x614
/* 80C20124  4B 46 36 3D */	bl __ct__10dCcD_GSttsFv
/* 80C20128  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80C2012C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80C2014C  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C20838@ha */
/* 80C20150  38 84 08 38 */	addi r4, r4, l_arcName@l /* 0x80C20838@l */
/* 80C20154  80 84 00 00 */	lwz r4, 0(r4)
/* 80C20158  4B 40 CD 65 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 80C2015C  7C 7D 1B 78 */	mr r29, r3
/* 80C20160  2C 1D 00 04 */	cmpwi r29, 4
/* 80C20164  40 82 00 68 */	bne lbl_80C201CC
/* 80C20168  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C2016C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80C20170  3C 63 00 02 */	addis r3, r3, 2
/* 80C20174  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C20838@ha */
/* 80C20178  38 84 08 38 */	addi r4, r4, l_arcName@l /* 0x80C20838@l */
/* 80C2017C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C20180  3C A0 80 C2 */	lis r5, d_a_obj_ice_l__stringBase0@ha /* 0x80C2081C@ha */
/* 80C20184  38 A5 08 1C */	addi r5, r5, d_a_obj_ice_l__stringBase0@l /* 0x80C2081C@l */
/* 80C20188  38 A5 00 08 */	addi r5, r5, 8
/* 80C2018C  38 63 C2 F8 */	addi r3, r3, -15624
/* 80C20190  4B 41 C5 29 */	bl getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80C20194  7C 65 1B 78 */	mr r5, r3
/* 80C20198  7F C3 F3 78 */	mr r3, r30
/* 80C2019C  3C 80 80 C2 */	lis r4, l_arcName@ha /* 0x80C20838@ha */
/* 80C201A0  38 84 08 38 */	addi r4, r4, l_arcName@l /* 0x80C20838@l */
/* 80C201A4  80 84 00 00 */	lwz r4, 0(r4)
/* 80C201A8  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075AD8@ha */
/* 80C201AC  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075AD8@l */
/* 80C201B0  38 E0 14 40 */	li r7, 0x1440
/* 80C201B4  39 00 00 00 */	li r8, 0
/* 80C201B8  4B 45 86 05 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C201F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80C201F8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80C20284  4B 64 77 09 */	bl cM_rndFX__Ff
...
/* 80C2029C  4B 45 75 15 */	bl __ct__18dBgS_ObjGndChk_SplFv
/* 80C202A0  38 61 00 14 */	addi r3, r1, 0x14
/* 80C202A4  38 81 00 08 */	addi r4, r1, 8
/* 80C202A8  4B 64 7A 81 */	bl SetPos__11cBgS_GndChkFPC4cXyz
...
/* 80C202E0  4B 3F A2 69 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80C202E4  38 61 00 14 */	addi r3, r1, 0x14
/* 80C202E8  38 80 FF FF */	li r4, -1
/* 80C202EC  4B 45 75 5D */	bl __dt__18dBgS_ObjGndChk_SplFv
/* 80C202F0  7F A3 EB 78 */	mr r3, r29
lbl_80C202F4:
/* 80C202F4  39 61 00 90 */	addi r11, r1, 0x90
/* 80C202F8  4B 74 1F 31 */	bl _restgpr_29
