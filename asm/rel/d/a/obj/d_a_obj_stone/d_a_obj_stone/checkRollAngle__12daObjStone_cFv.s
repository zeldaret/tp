...
/* 80CEC5D0  3C 80 80 CF */	lis r4, l_bmdIdx@ha /* 0x80CECAB4@ha */
/* 80CEC5D4  3B C4 CA B4 */	addi r30, r4, l_bmdIdx@l /* 0x80CECAB4@l */
...
/* 80CEC5FC  3C 60 80 CF */	lis r3, __vt__8cM3dGPla@ha /* 0x80CECE04@ha */
/* 80CEC600  38 03 CE 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CECE04@l */
/* 80CEC604  90 01 00 30 */	stw r0, 0x30(r1)
/* 80CEC608  38 61 00 14 */	addi r3, r1, 0x14
/* 80CEC60C  4B 33 16 B1 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80CEC610  7C 7F 1B 78 */	mr r31, r3
/* 80CEC614  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CEC618  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CEC61C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CEC620  3C 80 80 3F */	lis r4, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 80CEC624  38 84 1C C4 */	addi r4, r4, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
/* 80CEC628  38 84 00 14 */	addi r4, r4, 0x14
/* 80CEC62C  38 A1 00 20 */	addi r5, r1, 0x20
/* 80CEC630  4B 38 81 15 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80CEC634  3C 80 80 45 */	lis r4, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80CEC638  C0 24 0C D0 */	lfs f1, mGroundY__11fopAcM_gc_c@l(r4)  /* 0x80450CD0@l */
...
/* 80CEC668  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CEC66C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80CEC69C  3C 60 80 CF */	lis r3, __vt__8cM3dGPla@ha /* 0x80CECE04@ha */
/* 80CEC6A0  38 03 CE 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CECE04@l */
/* 80CEC6A4  90 01 00 30 */	stw r0, 0x30(r1)
/* 80CEC6A8  38 60 00 01 */	li r3, 1
/* 80CEC6AC  48 00 00 14 */	b lbl_80CEC6C0
lbl_80CEC6B0:
/* 80CEC6B0  3C 60 80 CF */	lis r3, __vt__8cM3dGPla@ha /* 0x80CECE04@ha */
/* 80CEC6B4  38 03 CE 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CECE04@l */
