...
/* 80CEB730  4B 67 6A AD */	bl _savegpr_29
/* 80CEB734  7C 7E 1B 78 */	mr r30, r3
/* 80CEB738  3C 80 80 CF */	lis r4, l_bmdIdx@ha /* 0x80CECAB4@ha */
/* 80CEB73C  3B E4 CA B4 */	addi r31, r4, l_bmdIdx@l /* 0x80CECAB4@l */
...
/* 80CEB7AC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CEB7B0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80CEB834  4B 65 B8 5D */	bl PSVECAdd
...
/* 80CEB8B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CEB8BC  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CEB928  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CEB92C  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80CEB930:
...
/* 80CEB960  4B 32 ED 6D */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 80CEB988  3C 60 80 CF */	lis r3, __vt__8cM3dGPla@ha /* 0x80CECE04@ha */
/* 80CEB98C  38 03 CE 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CECE04@l */
/* 80CEB990  90 01 00 80 */	stw r0, 0x80(r1)
/* 80CEB994  38 61 00 4C */	addi r3, r1, 0x4c
/* 80CEB998  4B 33 23 25 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80CEB99C  7C 7D 1B 78 */	mr r29, r3
/* 80CEB9A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CEB9A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CEB9A8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CEB9AC  3C 80 80 3F */	lis r4, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 80CEB9B0  38 84 1C C4 */	addi r4, r4, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
/* 80CEB9B4  38 84 00 14 */	addi r4, r4, 0x14
/* 80CEB9B8  38 A1 00 70 */	addi r5, r1, 0x70
/* 80CEB9BC  4B 38 8D 89 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80CEB9C0  3C 80 80 45 */	lis r4, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 80CEB9C4  C0 24 0C D0 */	lfs f1, mGroundY__11fopAcM_gc_c@l(r4)  /* 0x80450CD0@l */
...
/* 80CEB9F4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CEB9F8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80CEBA3C  4B 57 BC 39 */	bl cM_atan2s__Fff
...
/* 80CEBA88  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80CEBA8C  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80CEBAD4  4B 65 B5 BD */	bl PSVECAdd
...
/* 80CEBB58  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CEBB5C  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80CEBBC8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80CEBBCC  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80CEBBD0:
/* 80CEBBD0  D0 9E 05 2C */	stfs f4, 0x52c(r30)
/* 80CEBBD4  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80CEBBD8  C0 41 00 30 */	lfs f2, 0x30(r1)
/* 80CEBBDC  4B 57 BA 99 */	bl cM_atan2s__Fff
...
/* 80CEBC10  4B 65 B5 29 */	bl PSVECSquareMag
...
/* 80CEBC84  4B 58 4A BD */	bl cLib_chaseF__FPfff
...
lbl_80CEBCB8:
/* 80CEBCB8  3C 60 80 CF */	lis r3, __vt__8cM3dGPla@ha /* 0x80CECE04@ha */
/* 80CEBCBC  38 03 CE 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80CECE04@l */
/* 80CEBCC0  90 01 00 80 */	stw r0, 0x80(r1)
/* 80CEBCC4  39 61 00 A0 */	addi r11, r1, 0xa0
/* 80CEBCC8  4B 67 65 61 */	bl _restgpr_29
