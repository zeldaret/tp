...
/* 80CE9850  4B 67 89 8D */	bl _savegpr_29
...
/* 80CE9870  4B 32 F2 F5 */	bl __ct__10fopAc_ac_cFv
/* 80CE9874  3B BE 05 74 */	addi r29, r30, 0x574
/* 80CE9878  7F A3 EB 78 */	mr r3, r29
/* 80CE987C  4B 38 C8 25 */	bl __ct__9dBgS_AcchFv
/* 80CE9880  3C 60 80 CF */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80CECDE0@ha */
/* 80CE9884  38 63 CD E0 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80CECDE0@l */
...
/* 80CE98A0  4B 38 F5 C9 */	bl SetObj__16dBgS_PolyPassChkFv
/* 80CE98A4  38 7E 07 4C */	addi r3, r30, 0x74c
/* 80CE98A8  4B 38 C6 05 */	bl __ct__12dBgS_AcchCirFv
/* 80CE98AC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80CE98B0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80CE98B4  90 1E 07 A4 */	stw r0, 0x7a4(r30)
/* 80CE98B8  38 7E 07 A8 */	addi r3, r30, 0x7a8
/* 80CE98BC  4B 39 9E A5 */	bl __ct__10dCcD_GSttsFv
/* 80CE98C0  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80CE98C4  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80CE98DC  4B 39 A1 4D */	bl __ct__12dCcD_GObjInfFv
/* 80CE98E0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80CE98E4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80CE98E8  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80CE98EC  3C 60 80 CF */	lis r3, __vt__8cM3dGAab@ha /* 0x80CECDD4@ha */
/* 80CE98F0  38 03 CD D4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80CECDD4@l */
/* 80CE98F4  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80CE98F8  3C 60 80 CF */	lis r3, __vt__8cM3dGSph@ha /* 0x80CECDC8@ha */
/* 80CE98FC  38 03 CD C8 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80CECDC8@l */
/* 80CE9900  90 1D 01 34 */	stw r0, 0x134(r29)
/* 80CE9904  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80CE9908  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 80CE990C  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80CE9910  38 03 00 58 */	addi r0, r3, 0x58
/* 80CE9914  90 1D 01 34 */	stw r0, 0x134(r29)
/* 80CE9918  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 80CE991C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 80CE9938  4B 5D 4F 0D */	bl __ct__16Z2SoundObjSimpleFv
lbl_80CE993C:
...
/* 80CE9960  3C 80 80 CF */	lis r4, l_arcName@ha /* 0x80CECC74@ha */
/* 80CE9964  38 84 CC 74 */	addi r4, r4, l_arcName@l /* 0x80CECC74@l */
/* 80CE9968  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CE996C  4B 34 35 51 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CE9980  3C 80 80 CF */	lis r4, CheckCreateHeap__FP10fopAc_ac_c@ha /* 0x80CE93A4@ha */
/* 80CE9984  38 84 93 A4 */	addi r4, r4, CheckCreateHeap__FP10fopAc_ac_c@l /* 0x80CE93A4@l */
/* 80CE9988  38 A0 08 60 */	li r5, 0x860
/* 80CE998C  4B 33 0B 25 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80CE99C0  4B 67 88 69 */	bl _restgpr_29
