...
/* 80CEC89C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CEC8A0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CEC8A4  38 80 00 08 */	li r4, 8
/* 80CEC8A8  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CEC8AC  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CEC8B0  4B 4B 6F 15 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CEC8B4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80CEC8B8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80CEC8BC  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80CEC8C0  80 84 00 04 */	lwz r4, 4(r4)
/* 80CEC8C4  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CEC8C8  4B 4B 84 D9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CEC8CC  80 7F 05 70 */	lwz r3, 0x570(r31)
/* 80CEC8D0  4B 32 13 F5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80CEC8E8  3C 60 80 CF */	lis r3, l_shadow_size@ha /* 0x80CECB60@ha */
/* 80CEC8EC  38 63 CB 60 */	addi r3, r3, l_shadow_size@l /* 0x80CECB60@l */
...
/* 80CEC91C  3C C0 80 CF */	lis r6, lit_3845@ha /* 0x80CECBB8@ha */
/* 80CEC920  C0 66 CB B8 */	lfs f3, lit_3845@l(r6)  /* 0x80CECBB8@l */
/* 80CEC924  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80CEC928  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80CEC92C  4B 34 07 89 */	bl dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80CEC930:
