...
/* 80D3A308  3C 80 80 D4 */	lis r4, l_cyl_src@ha /* 0x80D3B638@ha */
/* 80D3A30C  3B E4 B6 38 */	addi r31, r4, l_cyl_src@l /* 0x80D3B638@l */
...
/* 80D3A32C  4B 33 BC 2D */	bl SetWall__12dBgS_AcchCirFff
...
/* 80D3A358  4B 33 BE F1 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80D3A36C  4B 34 94 F5 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80D3A370  38 7E 07 E0 */	addi r3, r30, 0x7e0
/* 80D3A374  38 9F 00 00 */	addi r4, r31, 0
/* 80D3A378  4B 34 A5 3D */	bl Set__8dCcD_CylFRC11dCcD_SrcCyl
/* 80D3A37C  38 1E 07 A4 */	addi r0, r30, 0x7a4
/* 80D3A380  90 1E 08 24 */	stw r0, 0x824(r30)
/* 80D3A384  3C 60 80 D4 */	lis r3, lifeGetCoCallBack__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 0x80D3A1D8@ha */
/* 80D3A388  38 03 A1 D8 */	addi r0, r3, lifeGetCoCallBack__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 0x80D3A1D8@l */
/* 80D3A38C  90 1E 08 D0 */	stw r0, 0x8d0(r30)
/* 80D3A390  3C 60 80 D4 */	lis r3, lifeGetTgCallBack__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 0x80D3A17C@ha */
/* 80D3A394  38 03 A1 7C */	addi r0, r3, lifeGetTgCallBack__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 0x80D3A17C@l */
/* 80D3A398  90 1E 08 84 */	stw r0, 0x884(r30)
/* 80D3A39C  3C 60 80 3B */	lis r3, item_info__10dItem_data@ha /* 0x803AED78@ha */
/* 80D3A3A0  38 63 ED 78 */	addi r3, r3, item_info__10dItem_data@l /* 0x803AED78@l */
...
/* 80D3A3D0  4B 53 4E 31 */	bl SetR__8cM3dGCylFf
/* 80D3A3D4  3C 60 80 3B */	lis r3, item_info__10dItem_data@ha /* 0x803AED78@ha */
/* 80D3A3D8  38 63 ED 78 */	addi r3, r3, item_info__10dItem_data@l /* 0x803AED78@l */
...
/* 80D3A408  4B 53 4D F1 */	bl SetH__8cM3dGCylFf
...
/* 80D3A424  3C 60 80 D4 */	lis r3, l_arcName@ha /* 0x80D3B73C@ha */
/* 80D3A428  80 03 B7 3C */	lwz r0, l_arcName@l(r3)  /* 0x80D3B73C@l */
/* 80D3A42C  90 1E 01 00 */	stw r0, 0x100(r30)
/* 80D3A430  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D3A434  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D3A438  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80D3A43C  7F C4 F3 78 */	mr r4, r30
/* 80D3A440  3C A0 80 D4 */	lis r5, l_eventName@ha /* 0x80D3B740@ha */
/* 80D3A444  38 A5 B7 40 */	addi r5, r5, l_eventName@l /* 0x80D3B740@l */
/* 80D3A448  80 A5 00 00 */	lwz r5, 0(r5)
/* 80D3A44C  38 C0 00 FF */	li r6, 0xff
/* 80D3A450  4B 30 D3 09 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
