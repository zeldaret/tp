...
/* 80C7659C  3C 60 80 C7 */	lis r3, __vt__17daLv6SzGate_HIO_c@ha /* 0x80C767B4@ha */
/* 80C765A0  38 03 67 B4 */	addi r0, r3, __vt__17daLv6SzGate_HIO_c@l /* 0x80C767B4@l */
/* 80C765A4  90 1F 00 00 */	stw r0, 0(r31)
/* 80C765A8  41 82 00 10 */	beq lbl_80C765B8
/* 80C765AC  3C 60 80 C7 */	lis r3, __vt__14mDoHIO_entry_c@ha /* 0x80C767C0@ha */
/* 80C765B0  38 03 67 C0 */	addi r0, r3, __vt__14mDoHIO_entry_c@l /* 0x80C767C0@l */
...
/* 80C765C4  4B 65 87 79 */	bl __dl__FPv
lbl_80C765C8:
