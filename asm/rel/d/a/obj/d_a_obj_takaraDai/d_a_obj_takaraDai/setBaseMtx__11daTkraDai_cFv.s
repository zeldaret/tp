...
/* 80D06E78  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06E7C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06E80  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80D06E84  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80D06E88  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80D06E8C  4B 63 FA 5C */	b PSMTXTrans
/* 80D06E90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06E94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06E98  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 80D06E9C  A8 BF 04 DE */	lha r5, 0x4de(r31)
/* 80D06EA0  A8 DF 04 E0 */	lha r6, 0x4e0(r31)
/* 80D06EA4  4B 30 53 FC */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80D06EA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06EAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06EB0  A8 9F 05 D4 */	lha r4, 0x5d4(r31)
/* 80D06EB4  A8 BF 05 D6 */	lha r5, 0x5d6(r31)
/* 80D06EB8  A8 DF 05 D8 */	lha r6, 0x5d8(r31)
/* 80D06EBC  4B 30 53 E4 */	b mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80D06EDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06EE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06EE4  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80D06EE8  38 84 00 24 */	addi r4, r4, 0x24
/* 80D06EEC  4B 63 F5 C4 */	b PSMTXCopy
/* 80D06EF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06EF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06EF8  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80D06EFC  4B 63 F5 B4 */	b PSMTXCopy
/* 80D06F00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06F04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06F08  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 80D06F0C  A8 BF 04 DE */	lha r5, 0x4de(r31)
/* 80D06F10  A8 DF 04 E0 */	lha r6, 0x4e0(r31)
/* 80D06F14  4B 30 52 F4 */	b mDoMtx_ZXYrotS__FPA4_fsss
/* 80D06F18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06F1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06F20  A8 9F 05 D4 */	lha r4, 0x5d4(r31)
/* 80D06F24  A8 BF 05 D6 */	lha r5, 0x5d6(r31)
/* 80D06F28  A8 DF 05 D8 */	lha r6, 0x5d8(r31)
/* 80D06F2C  4B 30 53 74 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80D06F30  3C 60 80 D0 */	lis r3, lit_3687@ha
/* 80D06F34  C0 23 78 38 */	lfs f1, lit_3687@l(r3)
/* 80D06F38  D0 3F 06 1C */	stfs f1, 0x61c(r31)
/* 80D06F3C  3C 60 80 D0 */	lis r3, lit_3688@ha
/* 80D06F40  C0 03 78 3C */	lfs f0, lit_3688@l(r3)
/* 80D06F44  D0 1F 06 20 */	stfs f0, 0x620(r31)
/* 80D06F48  D0 3F 06 24 */	stfs f1, 0x624(r31)
/* 80D06F4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06F50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06F54  38 9F 06 1C */	addi r4, r31, 0x61c
/* 80D06F58  7C 85 23 78 */	mr r5, r4
/* 80D06F5C  4B 63 FE 10 */	b PSMTXMultVec
/* 80D06F60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06F64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D06F8C  4B 63 F9 5C */	b PSMTXTrans
/* 80D06F90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06F94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06F98  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80D06F9C  A8 BF 04 E6 */	lha r5, 0x4e6(r31)
/* 80D06FA0  A8 DF 04 E8 */	lha r6, 0x4e8(r31)
/* 80D06FA4  4B 30 52 FC */	b mDoMtx_ZXYrotM__FPA4_fsss
...
/* 80D06FC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06FC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06FCC  80 9F 05 AC */	lwz r4, 0x5ac(r31)
/* 80D06FD0  38 84 00 24 */	addi r4, r4, 0x24
/* 80D06FD4  4B 63 F4 DC */	b PSMTXCopy
/* 80D06FD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D06FDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D06FE0  38 9F 06 2C */	addi r4, r31, 0x62c
/* 80D06FE4  4B 63 F4 CC */	b PSMTXCopy
