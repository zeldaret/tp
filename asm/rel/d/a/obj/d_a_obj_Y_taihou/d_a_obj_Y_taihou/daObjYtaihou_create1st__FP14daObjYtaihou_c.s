...
/* 80BA0C98  4B 7C 15 45 */	bl _savegpr_29
...
/* 80BA0CB8  4B 4D 79 6D */	bl __ct__16dBgS_MoveBgActorFv
/* 80BA0CBC  3C 60 80 BA */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x80BA12B0@ha */
/* 80BA0CC0  38 03 12 B0 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x80BA12B0@l */
...
/* 80BA0CD4  3C 60 80 BA */	lis r3, __vt__14daObjYtaihou_c@ha /* 0x80BA12C8@ha */
/* 80BA0CD8  38 63 12 C8 */	addi r3, r3, __vt__14daObjYtaihou_c@l /* 0x80BA12C8@l */
/* 80BA0CDC  90 7E 05 9C */	stw r3, 0x59c(r30)
/* 80BA0CE0  38 03 00 28 */	addi r0, r3, 0x28
/* 80BA0CE4  90 1E 05 A8 */	stw r0, 0x5a8(r30)
/* 80BA0CE8  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 80BA0CEC  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 80BA0CF0  90 1E 06 04 */	stw r0, 0x604(r30)
/* 80BA0CF4  38 7E 06 08 */	addi r3, r30, 0x608
/* 80BA0CF8  4B 4E 2A 69 */	bl __ct__10dCcD_GSttsFv
/* 80BA0CFC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 80BA0D00  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 80BA0D18  4B 4E 2D 11 */	bl __ct__12dCcD_GObjInfFv
/* 80BA0D1C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80BA0D20  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80BA0D24  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80BA0D28  3C 60 80 BA */	lis r3, __vt__8cM3dGAab@ha /* 0x80BA12A4@ha */
/* 80BA0D2C  38 03 12 A4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80BA12A4@l */
/* 80BA0D30  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80BA0D34  3C 60 80 BA */	lis r3, __vt__8cM3dGCyl@ha /* 0x80BA1298@ha */
/* 80BA0D38  38 03 12 98 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x80BA1298@l */
/* 80BA0D3C  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80BA0D40  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 80BA0D44  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 80BA0D48  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80BA0D4C  38 03 00 58 */	addi r0, r3, 0x58
/* 80BA0D50  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80BA0D54  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 80BA0D58  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 80BA0D90  4B 7C 14 99 */	bl _restgpr_29
