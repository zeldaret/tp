...
/* 80C7388C  3C 60 80 C7 */	lis r3, lit_3627@ha /* 0x80C73CBC@ha */
/* 80C73890  3B E3 3C BC */	addi r31, r3, lit_3627@l /* 0x80C73CBC@l */
...
/* 80C738A8  3C 80 80 C7 */	lis r4, l_HIO@ha /* 0x80C73DFC@ha */
/* 80C738AC  38 84 3D FC */	addi r4, r4, l_HIO@l /* 0x80C73DFC@l */
/* 80C738B0  C0 64 00 04 */	lfs f3, 4(r4)
/* 80C738B4  C0 9F 00 0C */	lfs f4, 0xc(r31)
/* 80C738B8  4B 5F C0 C5 */	bl cLib_addCalc__FPfffff
/* 80C738BC  FF E0 08 90 */	fmr f31, f1
/* 80C738C0  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C738C4  7C 03 07 74 */	extsb r3, r0
/* 80C738C8  4B 3B 97 A5 */	bl dComIfGp_getReverb__Fi
...
/* 80C738DC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C738E0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C73908  4B 63 8C 05 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C73920  4B 3B 97 4D */	bl dComIfGp_getReverb__Fi
...
/* 80C73934  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80C73938  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80C73960  4B 63 80 25 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
