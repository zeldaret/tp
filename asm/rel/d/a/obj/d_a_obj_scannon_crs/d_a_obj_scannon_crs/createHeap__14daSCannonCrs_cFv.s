...
/* 80CCA8DC  4B 69 79 01 */	bl _savegpr_29
/* 80CCA8E0  7C 7E 1B 78 */	mr r30, r3
/* 80CCA8E4  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCB17C@ha */
/* 80CCA8E8  38 63 B1 7C */	addi r3, r3, l_arcName@l /* 0x80CCB17C@l */
/* 80CCA8EC  80 63 00 00 */	lwz r3, 0(r3)
/* 80CCA8F0  38 80 00 0A */	li r4, 0xa
/* 80CCA8F4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CCA8F8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CCA90C  4B 37 19 E1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCA920  4B 34 A3 35 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80CCA93C:
/* 80CCA93C  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCB17C@ha */
/* 80CCA940  38 63 B1 7C */	addi r3, r3, l_arcName@l /* 0x80CCB17C@l */
...
/* 80CCA954  4B 37 19 99 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCA968  3C E0 80 CD */	lis r7, lit_4033@ha /* 0x80CCB0B4@ha */
/* 80CCA96C  C0 27 B0 B4 */	lfs f1, lit_4033@l(r7)  /* 0x80CCB0B4@l */
/* 80CCA970  38 E0 00 00 */	li r7, 0
/* 80CCA974  39 00 FF FF */	li r8, -1
/* 80CCA978  39 20 00 00 */	li r9, 0
/* 80CCA97C  4B 34 2E 61 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
lbl_80CCA990:
/* 80CCA990  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCB17C@ha */
/* 80CCA994  38 63 B1 7C */	addi r3, r3, l_arcName@l /* 0x80CCB17C@l */
...
/* 80CCA9A8  4B 37 19 45 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCA9C0  3D 00 80 CD */	lis r8, lit_4033@ha /* 0x80CCB0B4@ha */
/* 80CCA9C4  C0 28 B0 B4 */	lfs f1, lit_4033@l(r8)  /* 0x80CCB0B4@l */
/* 80CCA9C8  39 00 00 00 */	li r8, 0
/* 80CCA9CC  39 20 FF FF */	li r9, -1
/* 80CCA9D0  4B 34 2C 6D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80CCA9E8  4B 60 42 65 */	bl __nw__FUl
/* 80CCA9EC  7C 60 1B 79 */	or. r0, r3, r3
/* 80CCA9F0  41 82 00 0C */	beq lbl_80CCA9FC
/* 80CCA9F4  4B 3B 0F 7D */	bl __ct__4dBgWFv
...
lbl_80CCAA14:
/* 80CCAA14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CCAA18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CCAA1C  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80CCAA20  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80CCAA24  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80CCAA28  4B 67 BE C1 */	bl PSMTXTrans
/* 80CCAA2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CCAA30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CCAA34  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CCAA38  4B 34 19 FD */	bl mDoMtx_YrotM__FPA4_fs
/* 80CCAA3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CCAA40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CCAA44  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80CCAA48  4B 34 19 55 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CCAA4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CCAA50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CCAA54  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 80CCAA58  4B 34 1A 75 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80CCAA5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80CCAA60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80CCAA64  38 9E 06 08 */	addi r4, r30, 0x608
/* 80CCAA68  4B 67 BA 49 */	bl PSMTXCopy
/* 80CCAA6C  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCB17C@ha */
/* 80CCAA70  38 63 B1 7C */	addi r3, r3, l_arcName@l /* 0x80CCB17C@l */
...
/* 80CCAA84  4B 37 18 69 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCAA98  4B 3A F4 A1 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80CCAAB0  4B 69 77 79 */	bl _restgpr_29
