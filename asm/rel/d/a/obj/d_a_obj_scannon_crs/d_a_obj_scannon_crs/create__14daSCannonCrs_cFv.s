...
/* 80CC9920  4B 69 88 B5 */	bl _savegpr_27
/* 80CC9924  7C 7D 1B 78 */	mr r29, r3
/* 80CC9928  3C 80 80 CD */	lis r4, DISAP_PARTICLE_NAME@ha /* 0x80CCB080@ha */
/* 80CC992C  3B E4 B0 80 */	addi r31, r4, DISAP_PARTICLE_NAME@l /* 0x80CCB080@l */
...
lbl_80CC9954:
/* 80CC9954  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC9958  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80CC995C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80CC9960  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80CC9964  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80CC9968  A0 84 03 20 */	lhz r4, 0x320(r4)
/* 80CC996C  4B 36 B0 51 */	bl isEventBit__11dSv_event_cCFUs
...
lbl_80CC9990:
/* 80CC9990  3C 80 80 CD */	lis r4, l_arcName@ha /* 0x80CCB17C@ha */
/* 80CC9994  38 84 B1 7C */	addi r4, r4, l_arcName@l /* 0x80CCB17C@l */
/* 80CC9998  80 84 00 00 */	lwz r4, 0(r4)
/* 80CC999C  4B 36 35 21 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CC99B0  3C 80 80 CD */	lis r4, daSCannonCrs_c_createHeap__FP10fopAc_ac_c@ha /* 0x80CC9678@ha */
/* 80CC99B4  38 84 96 78 */	addi r4, r4, daSCannonCrs_c_createHeap__FP10fopAc_ac_c@l /* 0x80CC9678@l */
/* 80CC99B8  3C A0 00 01 */	lis r5, 0x0001 /* 0x00009000@ha */
/* 80CC99BC  38 A5 90 00 */	addi r5, r5, 0x9000 /* 0x00009000@l */
/* 80CC99C0  4B 35 0A F1 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80CC99D4:
/* 80CC99D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80CC99D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80CC99EC  4B 3A B0 1D */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80CC9A38  4B 35 0B 11 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80CC9A3C  38 00 00 36 */	li r0, 0x36
/* 80CC9A40  98 1D 05 45 */	stb r0, 0x545(r29)
/* 80CC9A44  98 1D 05 47 */	stb r0, 0x547(r29)
/* 80CC9A48  3C 60 80 CD */	lis r3, l_arcName@ha /* 0x80CCB17C@ha */
/* 80CC9A4C  80 03 B1 7C */	lwz r0, l_arcName@l(r3)  /* 0x80CCB17C@l */
/* 80CC9A50  90 1D 01 00 */	stw r0, 0x100(r29)
/* 80CC9A54  38 7C 40 C0 */	addi r3, r28, 0x40c0
/* 80CC9A58  7F A4 EB 78 */	mr r4, r29
/* 80CC9A5C  3C A0 80 CD */	lis r5, l_eventName@ha /* 0x80CCB180@ha */
/* 80CC9A60  38 A5 B1 80 */	addi r5, r5, l_eventName@l /* 0x80CCB180@l */
/* 80CC9A64  80 A5 00 00 */	lwz r5, 0(r5)
/* 80CC9A68  38 C0 00 FF */	li r6, 0xff
/* 80CC9A6C  4B 37 DC ED */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 80CC9A84  3C 60 80 CD */	lis r3, d_a_obj_scannon_crs__stringBase0@ha /* 0x80CCB114@ha */
/* 80CC9A88  3B E3 B1 14 */	addi r31, r3, d_a_obj_scannon_crs__stringBase0@l /* 0x80CCB114@l */
/* 80CC9A8C  48 00 00 54 */	b lbl_80CC9AE0
lbl_80CC9A90:
/* 80CC9A90  7F 83 E3 78 */	mr r3, r28
/* 80CC9A94  57 64 04 3E */	clrlwi r4, r27, 0x10
/* 80CC9A98  4B 61 50 61 */	bl getName__10JUTNameTabCFUs
/* 80CC9A9C  38 9F 00 1E */	addi r4, r31, 0x1e
/* 80CC9AA0  4B 69 EE F5 */	bl strcmp
...
/* 80CC9ABC  4B 61 50 3D */	bl getName__10JUTNameTabCFUs
/* 80CC9AC0  3C 80 80 CD */	lis r4, d_a_obj_scannon_crs__stringBase0@ha /* 0x80CCB114@ha */
/* 80CC9AC4  38 84 B1 14 */	addi r4, r4, d_a_obj_scannon_crs__stringBase0@l /* 0x80CCB114@l */
/* 80CC9AC8  38 84 00 27 */	addi r4, r4, 0x27
/* 80CC9ACC  4B 69 EE C9 */	bl strcmp
...
/* 80CC9AFC  4B 69 87 25 */	bl _restgpr_27
