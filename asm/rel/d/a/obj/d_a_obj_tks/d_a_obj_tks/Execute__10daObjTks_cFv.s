...
/* 80D0FD80  3C 60 80 D1 */	lis r3, m__16daObjTks_Param_c@ha /* 0x80D1273C@ha */
/* 80D0FD84  3B E3 27 3C */	addi r31, r3, m__16daObjTks_Param_c@l /* 0x80D1273C@l */
...
lbl_80D0FD9C:
/* 80D0FD9C  3C 60 80 D1 */	lis r3, lit_4353@ha /* 0x80D1295C@ha */
/* 80D0FDA0  38 83 29 5C */	addi r4, r3, lit_4353@l /* 0x80D1295C@l */
...
/* 80D0FDC4  4B 65 22 85 */	bl __ptmf_cmpr
...
/* 80D0FDE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D0FDEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D0FE04  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D0FE08  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D0FE0C  4B 63 66 A5 */	bl PSMTXCopy
/* 80D0FE10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D0FE14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D0FE18  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80D0FE1C  7C 85 23 78 */	mr r5, r4
/* 80D0FE20  4B 63 6F 4D */	bl PSMTXMultVec
...
/* 80D0FE40  4B 44 21 D5 */	bl execute__8daNpcF_cFv
