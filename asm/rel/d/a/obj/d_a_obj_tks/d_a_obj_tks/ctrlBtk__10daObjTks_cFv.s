...
/* 80D11908  3C 80 80 D1 */	lis r4, l_arcName@ha /* 0x80D12954@ha */
/* 80D1190C  38 84 29 54 */	addi r4, r4, l_arcName@l /* 0x80D12954@l */
/* 80D11910  80 84 00 00 */	lwz r4, 0(r4)
/* 80D11914  3C A0 80 D1 */	lis r5, l_btkGetParamList@ha /* 0x80D12948@ha */
/* 80D11918  38 A5 29 48 */	addi r5, r5, l_btkGetParamList@l /* 0x80D12948@l */
/* 80D1191C  80 A5 00 00 */	lwz r5, 0(r5)
/* 80D11920  4B 44 12 85 */	bl getTexSRTKeyAnmP__8daNpcF_cFPci
/* 80D11924  80 1F 05 B4 */	lwz r0, 0x5b4(r31)
/* 80D11928  7C 03 00 40 */	cmplw r3, r0
/* 80D1192C  40 82 00 6C */	bne lbl_80D11998
/* 80D11930  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80D11934  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80D11938  A8 9F 08 FE */	lha r4, 0x8fe(r31)
/* 80D1193C  48 00 05 65 */	bl func_80D11EA0
/* 80D11940  3C 60 80 D1 */	lis r3, lit_4324@ha /* 0x80D127D4@ha */
/* 80D11944  C0 43 27 D4 */	lfs f2, lit_4324@l(r3)  /* 0x80D127D4@l */
/* 80D11948  3C 60 80 D1 */	lis r3, lit_5057@ha /* 0x80D128A4@ha */
/* 80D1194C  C0 03 28 A4 */	lfs f0, lit_5057@l(r3)  /* 0x80D128A4@l */
...
/* 80D11960  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80D11964  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80D11968  A8 9F 08 FC */	lha r4, 0x8fc(r31)
/* 80D1196C  48 00 05 35 */	bl func_80D11EA0
/* 80D11970  3C 60 80 D1 */	lis r3, lit_5057@ha /* 0x80D128A4@ha */
/* 80D11974  C0 03 28 A4 */	lfs f0, lit_5057@l(r3)  /* 0x80D128A4@l */
