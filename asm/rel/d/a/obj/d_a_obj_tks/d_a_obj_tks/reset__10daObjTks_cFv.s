...
/* 80D103F8  4B 65 1D E1 */	bl _savegpr_28
/* 80D103FC  7C 7E 1B 78 */	mr r30, r3
/* 80D10400  3C 80 80 D1 */	lis r4, m__16daObjTks_Param_c@ha /* 0x80D1273C@ha */
/* 80D10404  3B E4 27 3C */	addi r31, r4, m__16daObjTks_Param_c@l /* 0x80D1273C@l */
/* 80D10408  4B 44 24 C1 */	bl initialize__8daNpcF_cFv
/* 80D1040C  80 7E 0B D8 */	lwz r3, 0xbd8(r30)
/* 80D10410  4B 44 03 29 */	bl initialize__15daNpcF_MatAnm_cFv
/* 80D10414  38 7E 0B DC */	addi r3, r30, 0xbdc
/* 80D10418  4B 44 0C 21 */	bl initialize__15daNpcF_Lookat_cFv
/* 80D1041C  C0 1F 00 B4 */	lfs f0, 0xb4(r31)
/* 80D10420  D0 1E 05 30 */	stfs f0, 0x530(r30)
/* 80D10424  3C 60 80 3A */	lis r3, __ptmf_null@ha /* 0x803A2180@ha */
/* 80D10428  38 83 21 80 */	addi r4, r3, __ptmf_null@l /* 0x803A2180@l */
...
/* 80D10454  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D10458  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D1045C  83 9D 5D AC */	lwz r28, 0x5dac(r29)
/* 80D10460  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 80D10464  4B 2F C9 01 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80D10468  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D1046C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D10470  A8 9C 04 DE */	lha r4, 0x4de(r28)
/* 80D10474  4B 2F BF C1 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80D10488  4B 2F C9 15 */	bl transM__14mDoMtx_stack_cFfff
/* 80D1048C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D10490  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80D104E4  4B 30 A2 2D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80D104E8  7C 64 1B 78 */	mr r4, r3
/* 80D104EC  7F C3 F3 78 */	mr r3, r30
/* 80D104F0  4B 44 3D 61 */	bl setAngle__8daNpcF_cFs
...
/* 80D10528  3C 60 80 D1 */	lis r3, lit_4572@ha /* 0x80D12968@ha */
/* 80D1052C  38 83 29 68 */	addi r4, r3, lit_4572@l /* 0x80D12968@l */
...
/* 80D10564  4B 65 1C C1 */	bl _restgpr_28
