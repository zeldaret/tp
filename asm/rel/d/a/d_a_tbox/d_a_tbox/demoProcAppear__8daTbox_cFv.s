...
/* 804934B4  3C 60 80 49 */	lis r3, lit_5021@ha /* 0x8049630C@ha */
/* 804934B8  C0 03 63 0C */	lfs f0, lit_5021@l(r3)  /* 0x8049630C@l */
...
/* 804934D4  4B B7 9F 55 */	bl play__14mDoExt_baseAnmFv
/* 804934D8  2C 03 00 00 */	cmpwi r3, 0
/* 804934DC  41 82 00 28 */	beq lbl_80493504
/* 804934E0  3C 60 80 49 */	lis r3, lit_3934@ha /* 0x80496248@ha */
/* 804934E4  C0 03 62 48 */	lfs f0, lit_3934@l(r3)  /* 0x80496248@l */
/* 804934E8  80 7F 07 34 */	lwz r3, 0x734(r31)
/* 804934EC  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 804934F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804934F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804934F8  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 804934FC  80 9F 07 4C */	lwz r4, 0x74c(r31)
/* 80493500  4B BB 4C 7D */	bl cutEnd__16dEvent_manager_cFi
lbl_80493504:
