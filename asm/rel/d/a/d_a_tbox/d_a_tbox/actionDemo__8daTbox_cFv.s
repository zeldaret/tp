...
/* 80493A0C  4B EC E7 D1 */	bl _savegpr_29
/* 80493A10  7C 7E 1B 78 */	mr r30, r3
/* 80493A14  A8 83 00 FC */	lha r4, 0xfc(r3)
/* 80493A18  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80493A1C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80493A20  38 7F 4F F8 */	addi r3, r31, 0x4ff8
/* 80493A24  4B BB 40 55 */	bl endCheck__16dEvent_manager_cFs
...
/* 80493A3C  3C 60 80 49 */	lis r3, lit_3934@ha /* 0x80496248@ha */
/* 80493A40  C0 03 62 48 */	lfs f0, lit_3934@l(r3)  /* 0x80496248@l */
...
/* 80493A54  3C 60 80 49 */	lis r3, lit_5194@ha /* 0x804965DC@ha */
/* 80493A58  38 83 65 DC */	addi r4, r3, lit_5194@l /* 0x804965DC@l */
...
lbl_80493A78:
/* 80493A78  3C 60 80 49 */	lis r3, lit_5197@ha /* 0x804965E8@ha */
/* 80493A7C  38 83 65 E8 */	addi r4, r3, lit_5197@l /* 0x804965E8@l */
...
/* 80493AA0  4B BA E9 C9 */	bl reset__14dEvt_control_cFv
/* 80493AA4  3C 60 80 49 */	lis r3, lit_3933@ha /* 0x80496244@ha */
/* 80493AA8  C0 23 62 44 */	lfs f1, lit_3933@l(r3)  /* 0x80496244@l */
/* 80493AAC  4B D1 4F 99 */	bl dKy_set_allcol_ratio__Ff
...
/* 80493AC4  4B BA FB F9 */	bl setPtI__14dEvt_control_cFPv
...
/* 80493AE0  3C 80 80 49 */	lis r4, d_a_tbox__stringBase0@ha /* 0x80496334@ha */
/* 80493AE4  38 84 63 34 */	addi r4, r4, d_a_tbox__stringBase0@l /* 0x80496334@l */
/* 80493AE8  38 84 00 8C */	addi r4, r4, 0x8c
/* 80493AEC  4B ED 4E A9 */	bl strcmp
...
lbl_80493B24:
/* 80493B24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80493B28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80493B3C  4B BA 0E C9 */	bl getEventReg__11dSv_event_cCFUs
...
/* 80493B58  4B BA 0E 89 */	bl setEventReg__11dSv_event_cFUsUc
/* 80493B5C  48 00 01 44 */	b lbl_80493CA0
lbl_80493B60:
/* 80493B60  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80493B64  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80493B78  4B BA 0E 8D */	bl getEventReg__11dSv_event_cCFUs
...
/* 80493B94  4B BA 0E 4D */	bl setEventReg__11dSv_event_cFUsUc
/* 80493B98  48 00 01 08 */	b lbl_80493CA0
lbl_80493B9C:
/* 80493B9C  3C 60 80 49 */	lis r3, d_a_tbox__stringBase0@ha /* 0x80496334@ha */
/* 80493BA0  38 63 63 34 */	addi r3, r3, d_a_tbox__stringBase0@l /* 0x80496334@l */
/* 80493BA4  38 63 00 94 */	addi r3, r3, 0x94
/* 80493BA8  4C C6 31 82 */	crclr 6
/* 80493BAC  4B B7 30 61 */	bl OSReport_Error
...
lbl_80493BD0:
/* 80493BD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80493BD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80493BE8  4B BA 0E 1D */	bl getEventReg__11dSv_event_cCFUs
...
/* 80493C04  4B BA 0D DD */	bl setEventReg__11dSv_event_cFUsUc
/* 80493C08  48 00 00 98 */	b lbl_80493CA0
lbl_80493C0C:
/* 80493C0C  3C 60 80 49 */	lis r3, d_a_tbox__stringBase0@ha /* 0x80496334@ha */
/* 80493C10  38 63 63 34 */	addi r3, r3, d_a_tbox__stringBase0@l /* 0x80496334@l */
/* 80493C14  38 63 00 94 */	addi r3, r3, 0x94
/* 80493C18  4C C6 31 82 */	crclr 6
/* 80493C1C  4B B7 2F F1 */	bl OSReport_Error
/* 80493C20  48 00 00 80 */	b lbl_80493CA0
lbl_80493C24:
/* 80493C24  7F A3 EB 78 */	mr r3, r29
/* 80493C28  3C 80 80 49 */	lis r4, d_a_tbox__stringBase0@ha /* 0x80496334@ha */
/* 80493C2C  38 84 63 34 */	addi r4, r4, d_a_tbox__stringBase0@l /* 0x80496334@l */
/* 80493C30  38 84 00 DC */	addi r4, r4, 0xdc
/* 80493C34  4B ED 4D 61 */	bl strcmp
...
/* 80493C5C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80493C60  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80493C74  4B BA 0D 91 */	bl getEventReg__11dSv_event_cCFUs
...
/* 80493C90  4B BA 0D 51 */	bl setEventReg__11dSv_event_cFUsUc
...
/* 80493CB4  4B EC E5 75 */	bl _restgpr_29
