...
lbl_80495B1C:
/* 80495B1C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80495B20  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80495B24  38 80 00 10 */	li r4, 0x10
/* 80495B28  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80495B2C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80495B30  4B D0 DC 95 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 80495B48  3C 60 80 49 */	lis r3, lit_3934@ha /* 0x80496248@ha */
/* 80495B4C  C0 03 62 48 */	lfs f0, lit_3934@l(r3)  /* 0x80496248@l */
/* 80495B50  FC 00 08 00 */	fcmpu cr0, f0, f1
/* 80495B54  41 82 00 44 */	beq lbl_80495B98
/* 80495B58  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80495B5C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80495B60  80 84 00 04 */	lwz r4, 4(r4)
/* 80495B64  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80495B68  4B D0 F2 39 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80495B80  4B B7 7C 29 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80495B84  80 7F 07 30 */	lwz r3, 0x730(r31)
/* 80495B88  4B B7 81 3D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80495B8C  80 7F 07 30 */	lwz r3, 0x730(r31)
/* 80495B90  80 63 00 04 */	lwz r3, 4(r3)
/* 80495B94  4B B7 82 F9 */	bl mDoExt_brkAnmRemove__FP12J3DModelData
lbl_80495B98:
...
lbl_80495BAC:
/* 80495BAC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80495BB0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80495BB4  80 9F 07 24 */	lwz r4, 0x724(r31)
/* 80495BB8  80 84 00 04 */	lwz r4, 4(r4)
/* 80495BBC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80495BC0  4B D0 F1 E1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80495BC4  80 7F 07 28 */	lwz r3, 0x728(r31)
/* 80495BC8  28 03 00 00 */	cmplwi r3, 0
/* 80495BCC  41 82 00 40 */	beq lbl_80495C0C
/* 80495BD0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80495BD4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80495BD8  80 04 5F 74 */	lwz r0, 0x5f74(r4)
/* 80495BDC  3C 80 80 43 */	lis r4, j3dSys@ha /* 0x80434AC8@ha */
/* 80495BE0  3B C4 4A C8 */	addi r30, r4, j3dSys@l /* 0x80434AC8@l */
/* 80495BE4  90 1E 00 4C */	stw r0, 0x4c(r30)
/* 80495BE8  4B B7 80 DD */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80495BEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80495BF0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80495BF4  80 04 5F 80 */	lwz r0, 0x5f80(r4)
/* 80495BF8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80495BFC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80495C1C  4B B7 7D B1 */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
...
/* 80495C3C  4B B8 77 F1 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
lbl_80495C40:
/* 80495C40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80495C44  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80495C48  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80495C4C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80495C50  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80495C64  4B B7 80 61 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80495C68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80495C6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
