...
/* 80498530  4B EC 9C A9 */	bl _savegpr_28
/* 80498534  83 E3 05 6C */	lwz r31, 0x56c(r3)
/* 80498538  3C 80 80 4A */	lis r4, lit_3695@ha /* 0x80498990@ha */
/* 8049853C  C3 E4 89 90 */	lfs f31, lit_3695@l(r4)  /* 0x80498990@l */
/* 80498540  3B A0 00 00 */	li r29, 0
/* 80498544  48 00 01 75 */	bl daVrbox_color_set__FP11vrbox_class
/* 80498548  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8049854C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
lbl_80498564:
/* 80498564  3C 60 80 45 */	lis r3, mStayNo__20dStage_roomControl_c+0x0@ha /* 0x80450D64@ha */
/* 80498568  88 83 0D 64 */	lbz r4, mStayNo__20dStage_roomControl_c+0x0@l(r3)  /* 0x80450D64@l */
/* 8049856C  7C 84 07 75 */	extsb. r4, r4
/* 80498570  41 80 00 28 */	blt lbl_80498598
/* 80498574  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80498578  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8049857C  38 63 4E C4 */	addi r3, r3, 0x4ec4
/* 80498580  4B B8 BE 05 */	bl getStatusRoomDt__20dStage_roomControl_cFi
...
lbl_804985A4:
/* 804985A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804985A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804985AC  80 83 61 B0 */	lwz r4, 0x61b0(r3)
/* 804985B0  28 04 00 00 */	cmplwi r4, 0
/* 804985B4  41 82 00 1C */	beq lbl_804985D0
/* 804985B8  3C 60 80 4A */	lis r3, lit_3696@ha /* 0x80498994@ha */
/* 804985BC  C0 23 89 94 */	lfs f1, lit_3696@l(r3)  /* 0x80498994@l */
...
lbl_804985D0:
/* 804985D0  3C 60 80 4A */	lis r3, lit_3695@ha /* 0x80498990@ha */
/* 804985D4  C0 43 89 90 */	lfs f2, lit_3695@l(r3)  /* 0x80498990@l */
lbl_804985D8:
/* 804985D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804985DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804985F0  4B EA E2 F9 */	bl PSMTXTrans
/* 804985F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804985F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804985FC  38 9F 00 24 */	addi r4, r31, 0x24
/* 80498600  4B EA DE B1 */	bl PSMTXCopy
/* 80498604  4B D1 00 29 */	bl dKy_GxFog_set__Fv
...
/* 80498654  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80498658  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8049865C  80 04 5F 64 */	lwz r0, 0x5f64(r4)
/* 80498660  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80498664  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80498678  4B B7 56 4D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 8049867C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80498680  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804986A4  4B EC 9B 81 */	bl _restgpr_28
