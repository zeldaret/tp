...
/* 805A8604  4B DB 9B D5 */	bl _savegpr_28
/* 805A8608  3C 60 80 5B */	lis r3, lit_3759@ha /* 0x805A8FBC@ha */
/* 805A860C  3B E3 8F BC */	addi r31, r3, lit_3759@l /* 0x805A8FBC@l */
/* 805A8610  3C 60 80 45 */	lis r3, m_path__8daYkgr_c@ha /* 0x80450D94@ha */
/* 805A8614  80 83 0D 94 */	lwz r4, m_path__8daYkgr_c@l(r3)  /* 0x80450D94@l */
...
lbl_805A8628:
/* 805A8628  3C 60 80 45 */	lis r3, __float_max@ha /* 0x80450AE8@ha */
/* 805A862C  C3 83 0A E8 */	lfs f28, __float_max@l(r3)  /* 0x80450AE8@l */
/* 805A8630  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A8634  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805A86A8  4B D9 EC F5 */	bl PSVECSquareDistance
...
/* 805A8714  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805A8718  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 805A8784  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 805A8788  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_805A878C:
...
/* 805A87A8  3C 60 80 5B */	lis r3, l_HIO@ha /* 0x805A9104@ha */
/* 805A87AC  38 63 91 04 */	addi r3, r3, l_HIO@l /* 0x805A9104@l */
...
lbl_805A87D4:
/* 805A87D4  3C 60 80 5B */	lis r3, l_HIO@ha /* 0x805A9104@ha */
/* 805A87D8  38 63 91 04 */	addi r3, r3, l_HIO@l /* 0x805A9104@l */
...
/* 805A8818  4B DB 9A 0D */	bl _restgpr_28
