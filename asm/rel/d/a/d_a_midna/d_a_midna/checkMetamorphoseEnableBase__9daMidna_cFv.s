...
/* 804C4AF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C4AF8  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804C4B0C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804C4B10  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 804C4B28  4B B6 FE 95 */	bl isEventBit__11dSv_event_cCFUs
/* 804C4B2C  2C 03 00 00 */	cmpwi r3, 0
/* 804C4B30  41 82 00 1C */	beq lbl_804C4B4C
/* 804C4B34  3C 60 80 4C */	lis r3, daMidna_searchNpc__FP10fopAc_ac_cPv@ha /* 0x804C4750@ha */
/* 804C4B38  38 63 47 50 */	addi r3, r3, daMidna_searchNpc__FP10fopAc_ac_cPv@l /* 0x804C4750@l */
/* 804C4B3C  38 81 00 08 */	addi r4, r1, 8
/* 804C4B40  4B B5 4C B9 */	bl fopAcIt_Judge__FPFPvPv_PvPv
