...
/* 804C4BD0  4B E9 D6 0D */	bl _savegpr_29
/* 804C4BD4  7C 7D 1B 78 */	mr r29, r3
/* 804C4BD8  3C 60 80 4C */	lis r3, lit_3777@ha /* 0x804C64C8@ha */
/* 804C4BDC  3B E3 64 C8 */	addi r31, r3, lit_3777@l /* 0x804C64C8@l */
...
/* 804C4C48  4B E6 37 E5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4C94  4B E6 37 99 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4CD4  4B E6 37 59 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4CE8  4B E6 37 45 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4D14  4B E6 37 19 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4D60  4B E6 36 CD */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4D88  4B E6 36 A5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4DB0  4B E6 36 7D */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4DC4  4B E6 36 69 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4DE0  4B E6 36 4D */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4DF4  4B E6 36 39 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4E1C  4B E6 36 11 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4E38  4B E6 35 F5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4E60  4B E6 35 CD */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4E74  4B E6 35 B9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4E88  4B E6 35 A5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4EB0  4B E6 35 7D */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4EC4  4B E6 35 69 */	bl checkPass__12J3DFrameCtrlFf
...
/* 804C4EE4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C4EE8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804C4F3C  4B DF B7 95 */	bl updateAnime__10Z2CreatureFff
lbl_804C4F40:
/* 804C4F40  3B C0 00 00 */	li r30, 0
/* 804C4F44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C4F48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804C4F4C  38 63 00 28 */	addi r3, r3, 0x28
/* 804C4F50  38 80 00 03 */	li r4, 3
/* 804C4F54  4B B6 DC 99 */	bl isTransformLV__21dSv_player_status_b_cCFi
/* 804C4F58  2C 03 00 00 */	cmpwi r3, 0
/* 804C4F5C  41 82 00 24 */	beq lbl_804C4F80
/* 804C4F60  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C4F64  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804C4F68  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 804C4F6C  38 80 1E 08 */	li r4, 0x1e08
/* 804C4F70  4B B6 FA 4D */	bl isEventBit__11dSv_event_cCFUs
...
/* 804C4F88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C4F8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804C4FC8  4B E9 D2 61 */	bl _restgpr_29
