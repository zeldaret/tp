...
/* 804C43AC  3C 60 80 4C */	lis r3, l_arcName@ha /* 0x804C64D4@ha */
/* 804C43B0  38 63 64 D4 */	addi r3, r3, l_arcName@l /* 0x804C64D4@l */
/* 804C43B4  54 A4 04 3E */	clrlwi r4, r5, 0x10
/* 804C43B8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C43BC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804C43C0  3C A5 00 02 */	addis r5, r5, 2
/* 804C43C4  38 C0 00 80 */	li r6, 0x80
/* 804C43C8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 804C43CC  4B B7 7F 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804C43E4  4B E6 74 99 */	bl searchUpdateMaterialID__15J3DAnmTevRegKeyFP12J3DModelData
/* 804C43E8  38 7E 00 58 */	addi r3, r30, 0x58
/* 804C43EC  7F E4 FB 78 */	mr r4, r31
/* 804C43F0  4B E6 BA 81 */	bl entryTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
/* 804C43F4  A8 1F 00 06 */	lha r0, 6(r31)
/* 804C43F8  3C 60 80 4C */	lis r3, lit_4305@ha /* 0x804C6588@ha */
/* 804C43FC  C8 23 65 88 */	lfd f1, lit_4305@l(r3)  /* 0x804C6588@l */
...
/* 804C4418  3C 60 80 4C */	lis r3, lit_5079@ha /* 0x804C6868@ha */
/* 804C441C  C0 03 68 68 */	lfs f0, lit_5079@l(r3)  /* 0x804C6868@l */
