...
/* 804C61C8  3C 80 80 4C */	lis r4, l_arcName@ha
/* 804C61CC  38 84 64 D4 */	addi r4, r4, l_arcName@l
/* 804C61D0  4B B6 6E 38 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 804C61D4  38 00 00 00 */	li r0, 0
/* 804C61D8  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 804C61DC  90 03 10 18 */	stw r0, m_midnaActor__9daPy_py_c@l(r3)
...
/* 804C61F8  3C 80 80 4C */	lis r4, __dt__4cXyzFv@ha
/* 804C61FC  38 84 D8 B8 */	addi r4, r4, __dt__4cXyzFv@l
/* 804C6200  38 A0 00 0C */	li r5, 0xc
/* 804C6204  38 C0 00 05 */	li r6, 5
/* 804C6208  4B E9 BA E0 */	b __destroy_arr
/* 804C620C  38 7E 09 1C */	addi r3, r30, 0x91c
/* 804C6210  3C 80 80 4C */	lis r4, __dt__4cXyzFv@ha
/* 804C6214  38 84 D8 B8 */	addi r4, r4, __dt__4cXyzFv@l
/* 804C6218  38 A0 00 0C */	li r5, 0xc
/* 804C621C  38 C0 00 05 */	li r6, 5
/* 804C6220  4B E9 BA C8 */	b __destroy_arr
/* 804C6224  38 7E 08 E0 */	addi r3, r30, 0x8e0
/* 804C6228  3C 80 80 4C */	lis r4, __dt__4cXyzFv@ha
/* 804C622C  38 84 D8 B8 */	addi r4, r4, __dt__4cXyzFv@l
/* 804C6230  38 A0 00 0C */	li r5, 0xc
/* 804C6234  38 C0 00 05 */	li r6, 5
/* 804C6238  4B E9 BA B0 */	b __destroy_arr
/* 804C623C  38 7E 07 D8 */	addi r3, r30, 0x7d8
/* 804C6240  38 80 FF FF */	li r4, -1
/* 804C6244  4B BB 1E 48 */	b __dt__15dBgS_LinkLinChkFv
/* 804C6248  38 7E 07 8C */	addi r3, r30, 0x78c
/* 804C624C  38 80 FF FF */	li r4, -1
/* 804C6250  4B D8 3C F8 */	b __dt__10dMsgFlow_cFv
/* 804C6254  38 7E 06 FC */	addi r3, r30, 0x6fc
/* 804C6258  38 80 FF FF */	li r4, -1
/* 804C625C  4B DF A1 C4 */	b __dt__10Z2CreatureFv
/* 804C6260  38 7E 06 34 */	addi r3, r30, 0x634
/* 804C6264  38 80 FF FF */	li r4, -1
/* 804C6268  4B C9 8A E8 */	b __dt__14daPy_anmHeap_cFv
/* 804C626C  38 7E 06 20 */	addi r3, r30, 0x620
/* 804C6270  38 80 FF FF */	li r4, -1
/* 804C6274  4B C9 8A DC */	b __dt__14daPy_anmHeap_cFv
/* 804C6278  38 7E 05 E4 */	addi r3, r30, 0x5e4
/* 804C627C  3C 80 80 16 */	lis r4, __dt__14daPy_anmHeap_cFv@ha
/* 804C6280  38 84 ED 50 */	addi r4, r4, __dt__14daPy_anmHeap_cFv@l
/* 804C6284  38 A0 00 14 */	li r5, 0x14
/* 804C6288  38 C0 00 03 */	li r6, 3
/* 804C628C  4B E9 BA 5C */	b __destroy_arr
...
/* 804C62A8  3C 60 80 4C */	lis r3, __vt__12J3DFrameCtrl@ha
/* 804C62AC  38 03 6C A8 */	addi r0, r3, __vt__12J3DFrameCtrl@l
