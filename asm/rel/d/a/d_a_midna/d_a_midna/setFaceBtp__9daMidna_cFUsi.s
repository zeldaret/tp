...
/* 804C0BD0  4B C9 E5 48 */	b loadDataDemoRID__14daPy_anmHeap_cFUsUs
/* 804C0BD4  48 00 00 0C */	b lbl_804C0BE0
lbl_804C0BD8:
/* 804C0BD8  38 7F 06 20 */	addi r3, r31, 0x620
/* 804C0BDC  4B C9 E4 8C */	b loadDataIdx__14daPy_anmHeap_cFUs
lbl_804C0BE0:
...
/* 804C0C04  4B E6 A4 98 */	b searchUpdateMaterialID__16J3DAnmTexPatternFP12J3DModelData
...
/* 804C0C18  4B E6 EF B0 */	b entryTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern
/* 804C0C1C  38 00 00 00 */	li r0, 0
/* 804C0C20  98 1F 08 4A */	stb r0, 0x84a(r31)
/* 804C0C24  88 1F 08 4A */	lbz r0, 0x84a(r31)
/* 804C0C28  3C 60 80 4C */	lis r3, lit_6968@ha
/* 804C0C2C  C8 23 69 40 */	lfd f1, lit_6968@l(r3)
