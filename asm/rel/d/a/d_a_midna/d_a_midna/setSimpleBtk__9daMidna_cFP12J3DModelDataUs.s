...
/* 804C445C  3C 60 80 4C */	lis r3, l_arcName@ha /* 0x804C64D4@ha */
/* 804C4460  38 63 64 D4 */	addi r3, r3, l_arcName@l /* 0x804C64D4@l */
/* 804C4464  54 A4 04 3E */	clrlwi r4, r5, 0x10
/* 804C4468  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804C446C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804C4470  3C A5 00 02 */	addis r5, r5, 2
/* 804C4474  38 C0 00 80 */	li r6, 0x80
/* 804C4478  38 A5 C2 F8 */	addi r5, r5, -15624
/* 804C447C  4B B7 7E 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804C4494  4B E6 6D 41 */	bl searchUpdateMaterialID__19J3DAnmTextureSRTKeyFP12J3DModelData
/* 804C4498  38 7E 00 58 */	addi r3, r30, 0x58
/* 804C449C  7F E4 FB 78 */	mr r4, r31
/* 804C44A0  4B E6 B8 25 */	bl entryTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
/* 804C44A4  3C 60 80 4C */	lis r3, lit_4278@ha /* 0x804C6580@ha */
/* 804C44A8  C0 03 65 80 */	lfs f0, lit_4278@l(r3)  /* 0x804C6580@l */
