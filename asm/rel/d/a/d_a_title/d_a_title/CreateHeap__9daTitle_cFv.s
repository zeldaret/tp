...
/* 80D66B64  4B 5F B6 79 */	bl _savegpr_29
/* 80D66B68  7C 7D 1B 78 */	mr r29, r3
/* 80D66B6C  3C 60 80 D6 */	lis r3, l_arcName@ha /* 0x80D67BE0@ha */
/* 80D66B70  38 63 7B E0 */	addi r3, r3, l_arcName@l /* 0x80D67BE0@l */
/* 80D66B74  38 80 00 0A */	li r4, 0xa
/* 80D66B78  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D66B7C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D66B90  4B 2D 57 5D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D66BA4  4B 2A E0 B1 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D66BC0:
/* 80D66BC0  3C 60 80 D6 */	lis r3, l_arcName@ha /* 0x80D67BE0@ha */
/* 80D66BC4  38 63 7B E0 */	addi r3, r3, l_arcName@l /* 0x80D67BE0@l */
/* 80D66BC8  38 80 00 07 */	li r4, 7
/* 80D66BCC  7F C5 F3 78 */	mr r5, r30
/* 80D66BD0  38 C0 00 80 */	li r6, 0x80
/* 80D66BD4  4B 2D 57 19 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D66BE8  3C E0 80 D6 */	lis r7, lit_4030@ha /* 0x80D67BF4@ha */
/* 80D66BEC  C0 27 7B F4 */	lfs f1, lit_4030@l(r7)  /* 0x80D67BF4@l */
/* 80D66BF0  38 E0 00 00 */	li r7, 0
/* 80D66BF4  39 00 FF FF */	li r8, -1
/* 80D66BF8  39 20 00 00 */	li r9, 0
/* 80D66BFC  4B 2A 6B E1 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
/* 80D66C00  3C 60 80 D6 */	lis r3, l_arcName@ha /* 0x80D67BE0@ha */
/* 80D66C04  38 63 7B E0 */	addi r3, r3, l_arcName@l /* 0x80D67BE0@l */
/* 80D66C08  38 80 00 0D */	li r4, 0xd
/* 80D66C0C  7F C5 F3 78 */	mr r5, r30
/* 80D66C10  38 C0 00 80 */	li r6, 0x80
/* 80D66C14  4B 2D 56 D9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D66C2C  3D 00 80 D6 */	lis r8, lit_4030@ha /* 0x80D67BF4@ha */
/* 80D66C30  C0 28 7B F4 */	lfs f1, lit_4030@l(r8)  /* 0x80D67BF4@l */
/* 80D66C34  39 00 00 00 */	li r8, 0
/* 80D66C38  39 20 FF FF */	li r9, -1
/* 80D66C3C  4B 2A 68 41 */	bl init__13mDoExt_bpkAnmFP16J3DMaterialTableP11J3DAnmColoriifss
/* 80D66C40  3C 60 80 D6 */	lis r3, l_arcName@ha /* 0x80D67BE0@ha */
/* 80D66C44  38 63 7B E0 */	addi r3, r3, l_arcName@l /* 0x80D67BE0@l */
/* 80D66C48  38 80 00 10 */	li r4, 0x10
/* 80D66C4C  7F C5 F3 78 */	mr r5, r30
/* 80D66C50  38 C0 00 80 */	li r6, 0x80
/* 80D66C54  4B 2D 56 99 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D66C6C  3D 00 80 D6 */	lis r8, lit_4030@ha /* 0x80D67BF4@ha */
/* 80D66C70  C0 28 7B F4 */	lfs f1, lit_4030@l(r8)  /* 0x80D67BF4@l */
/* 80D66C74  39 00 00 00 */	li r8, 0
/* 80D66C78  39 20 FF FF */	li r9, -1
/* 80D66C7C  4B 2A 6A 91 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80D66C80  3C 60 80 D6 */	lis r3, l_arcName@ha /* 0x80D67BE0@ha */
/* 80D66C84  38 63 7B E0 */	addi r3, r3, l_arcName@l /* 0x80D67BE0@l */
/* 80D66C88  38 80 00 13 */	li r4, 0x13
/* 80D66C8C  7F C5 F3 78 */	mr r5, r30
/* 80D66C90  38 C0 00 80 */	li r6, 0x80
/* 80D66C94  4B 2D 56 59 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D66CAC  3D 00 80 D6 */	lis r8, lit_4030@ha /* 0x80D67BF4@ha */
/* 80D66CB0  C0 28 7B F4 */	lfs f1, lit_4030@l(r8)  /* 0x80D67BF4@l */
/* 80D66CB4  39 00 00 00 */	li r8, 0
/* 80D66CB8  39 20 FF FF */	li r9, -1
/* 80D66CBC  4B 2A 69 81 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80D66CC0  38 60 00 01 */	li r3, 1
lbl_80D66CC4:
/* 80D66CC4  39 61 00 20 */	addi r11, r1, 0x20
/* 80D66CC8  4B 5F B5 61 */	bl _restgpr_29
