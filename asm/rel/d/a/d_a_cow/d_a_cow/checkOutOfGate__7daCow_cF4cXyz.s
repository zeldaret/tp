...
/* 8065B790  3C A0 80 66 */	lis r5, data_806634C4@ha /* 0x806634C4@ha */
/* 8065B794  38 A5 34 C4 */	addi r5, r5, data_806634C4@l /* 0x806634C4@l */
/* 8065B798  4B C0 B3 9D */	bl __mi__4cXyzCFRC3Vec
...
/* 8065B7B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8065B7B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8065B7BC  3C 80 80 66 */	lis r4, struct_80662FB8+0x2@ha /* 0x80662FBA@ha */
/* 8065B7C0  38 84 2F BA */	addi r4, r4, struct_80662FB8+0x2@l /* 0x80662FBA@l */
/* 8065B7C4  A8 84 00 00 */	lha r4, 0(r4)
/* 8065B7C8  4B 9B 0C 15 */	bl mDoMtx_YrotS__FPA4_fs
/* 8065B7CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8065B7D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8065B7D4  38 81 00 20 */	addi r4, r1, 0x20
/* 8065B7D8  7C 85 23 78 */	mr r5, r4
/* 8065B7DC  4B CE B6 71 */	bl PSMTXMultVecSR
/* 8065B7E0  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 8065B7E4  3C 60 80 66 */	lis r3, lit_3998@ha /* 0x80662DC8@ha */
/* 8065B7E8  C0 03 2D C8 */	lfs f0, lit_3998@l(r3)  /* 0x80662DC8@l */
...
/* 8065B800  3C 60 80 66 */	lis r3, lit_5409@ha /* 0x80662E68@ha */
/* 8065B804  C0 03 2E 68 */	lfs f0, lit_5409@l(r3)  /* 0x80662E68@l */
...
/* 8065B820  3C A0 80 66 */	lis r5, data_806634AC@ha /* 0x806634AC@ha */
/* 8065B824  38 A5 34 AC */	addi r5, r5, data_806634AC@l /* 0x806634AC@l */
/* 8065B828  4B C0 B3 0D */	bl __mi__4cXyzCFRC3Vec
...
/* 8065B844  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8065B848  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8065B84C  3C 80 80 66 */	lis r4, struct_80662FB8+0x0@ha /* 0x80662FB8@ha */
/* 8065B850  A8 04 2F B8 */	lha r0, struct_80662FB8+0x0@l(r4)  /* 0x80662FB8@l */
/* 8065B854  7C 00 00 D0 */	neg r0, r0
/* 8065B858  7C 04 07 34 */	extsh r4, r0
/* 8065B85C  4B 9B 0B 81 */	bl mDoMtx_YrotS__FPA4_fs
/* 8065B860  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8065B864  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8065B868  38 81 00 20 */	addi r4, r1, 0x20
/* 8065B86C  7C 85 23 78 */	mr r5, r4
/* 8065B870  4B CE B5 DD */	bl PSMTXMultVecSR
/* 8065B874  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 8065B878  3C 60 80 66 */	lis r3, lit_3998@ha /* 0x80662DC8@ha */
/* 8065B87C  C0 03 2D C8 */	lfs f0, lit_3998@l(r3)  /* 0x80662DC8@l */
