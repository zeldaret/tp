...
/* 80661B00  4B D0 06 DD */	bl _savegpr_29
/* 80661B04  7C 7D 1B 78 */	mr r29, r3
/* 80661B08  3C 60 80 66 */	lis r3, d_a_cow__stringBase0@ha /* 0x80662F18@ha */
/* 80661B0C  38 63 2F 18 */	addi r3, r3, d_a_cow__stringBase0@l /* 0x80662F18@l */
/* 80661B10  38 80 00 1F */	li r4, 0x1f
/* 80661B14  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80661B18  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80661B2C  4B 9D A7 C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80661B30  7C 7F 1B 78 */	mr r31, r3
/* 80661B34  38 60 00 58 */	li r3, 0x58
/* 80661B38  4B C6 D1 15 */	bl __nw__FUl
...
/* 80661B74  3D 20 80 66 */	lis r9, lit_3989@ha /* 0x80662DB8@ha */
/* 80661B78  C0 29 2D B8 */	lfs f1, lit_3989@l(r9)  /* 0x80662DB8@l */
/* 80661B7C  39 20 00 00 */	li r9, 0
/* 80661B80  39 40 FF FF */	li r10, -1
/* 80661B84  4B 9A EC 4D */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80661BB8  3C 60 80 66 */	lis r3, ctrlJointCallBack__7daCow_cFP8J3DJointi@ha /* 0x80662920@ha */
/* 80661BBC  38 83 29 20 */	addi r4, r3, ctrlJointCallBack__7daCow_cFP8J3DJointi@l /* 0x80662920@l */
...
/* 80661C10  3C C0 80 66 */	lis r6, lit_3998@ha /* 0x80662DC8@ha */
/* 80661C14  C0 26 2D C8 */	lfs f1, lit_3998@l(r6)  /* 0x80662DC8@l */
/* 80661C18  3C C0 80 66 */	lis r6, lit_3989@ha /* 0x80662DB8@ha */
/* 80661C1C  C0 46 2D B8 */	lfs f2, lit_3989@l(r6)  /* 0x80662DB8@l */
/* 80661C20  4B FF 6B 11 */	bl setBck__7daCow_cFiUcff
/* 80661C24  38 60 00 18 */	li r3, 0x18
/* 80661C28  4B C6 D0 25 */	bl __nw__FUl
/* 80661C2C  7C 7F 1B 79 */	or. r31, r3, r3
/* 80661C30  41 82 00 20 */	beq lbl_80661C50
/* 80661C34  3C 80 80 66 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80663440@ha */
/* 80661C38  38 04 34 40 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80663440@l */
/* 80661C3C  90 1F 00 00 */	stw r0, 0(r31)
/* 80661C40  38 80 00 00 */	li r4, 0
/* 80661C44  4B CC 67 B9 */	bl init__12J3DFrameCtrlFs
...
lbl_80661C68:
/* 80661C68  3C 60 80 66 */	lis r3, d_a_cow__stringBase0@ha /* 0x80662F18@ha */
/* 80661C6C  38 63 2F 18 */	addi r3, r3, d_a_cow__stringBase0@l /* 0x80662F18@l */
/* 80661C70  38 80 00 22 */	li r4, 0x22
/* 80661C74  7F C5 F3 78 */	mr r5, r30
/* 80661C78  38 C0 00 80 */	li r6, 0x80
/* 80661C7C  4B 9D A6 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80661CA0  3D 00 80 66 */	lis r8, lit_3989@ha /* 0x80662DB8@ha */
/* 80661CA4  C0 28 2D B8 */	lfs f1, lit_3989@l(r8)  /* 0x80662DB8@l */
/* 80661CA8  39 00 00 00 */	li r8, 0
/* 80661CAC  39 20 FF FF */	li r9, -1
/* 80661CB0  4B 9A B8 9D */	bl init__13mDoExt_btpAnmFP16J3DMaterialTableP16J3DAnmTexPatterniifss
...
/* 80661CC8  4B D0 05 61 */	bl _restgpr_29
