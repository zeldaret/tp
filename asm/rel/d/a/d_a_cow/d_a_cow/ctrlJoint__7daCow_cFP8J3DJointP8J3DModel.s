...
/* 80662720  4B CF FA B9 */	bl _savegpr_28
...
/* 80662740  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80662744  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80662748  4B CE 3D 69 */	bl PSMTXCopy
...
lbl_80662764:
/* 80662764  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80662768  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8066276C  A8 9E 0C 3A */	lha r4, 0xc3a(r30)
/* 80662770  4B 9A 9C C5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80662774  48 00 00 24 */	b lbl_80662798
lbl_80662778:
/* 80662778  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8066277C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80662780  A8 9E 0C 42 */	lha r4, 0xc42(r30)
/* 80662784  4B 9A 9D 49 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80662788  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8066278C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80662790  A8 9E 0C 40 */	lha r4, 0xc40(r30)
/* 80662794  4B 9A 9C A1 */	bl mDoMtx_YrotM__FPA4_fs
lbl_80662798:
/* 80662798  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8066279C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806627A0  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 806627A4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806627A8  7C 80 EA 14 */	add r4, r0, r29
/* 806627AC  4B CE 3D 05 */	bl PSMTXCopy
/* 806627B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806627B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806627B8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 806627BC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 806627C0  4B CE 3C F1 */	bl PSMTXCopy
...
lbl_806627F4:
/* 806627F4  3C 60 80 43 */	lis r3, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 806627F8  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
...
lbl_80662818:
/* 80662818  3C 60 80 43 */	lis r3, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8066281C  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
...
/* 80662844  4B C0 42 F1 */	bl __mi__4cXyzCFRC3Vec
...
/* 8066286C  4B C0 42 C9 */	bl __mi__4cXyzCFRC3Vec
...
/* 80662894  4B CE 48 21 */	bl PSVECSubtract
...
/* 806628B4  3C 60 80 66 */	lis r3, lit_5656@ha /* 0x80662E88@ha */
/* 806628B8  C0 03 2E 88 */	lfs f0, lit_5656@l(r3)  /* 0x80662E88@l */
...
/* 806628D4  4B C0 42 11 */	bl __pl__4cXyzCFRC3Vec
...
/* 806628F0  3C 60 80 43 */	lis r3, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 806628F4  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
...
/* 8066290C  4B CF F9 19 */	bl _restgpr_28
