...
/* 80658D58  3C 80 80 66 */	lis r4, lit_3989@ha /* 0x80662DB8@ha */
/* 80658D5C  C0 24 2D B8 */	lfs f1, lit_3989@l(r4)  /* 0x80662DB8@l */
/* 80658D60  4B CC F6 CD */	bl checkPass__12J3DFrameCtrlFf
/* 80658D64  2C 03 00 00 */	cmpwi r3, 0
/* 80658D68  41 82 00 3C */	beq lbl_80658DA4
/* 80658D6C  3C 60 80 66 */	lis r3, lit_3998@ha /* 0x80662DC8@ha */
/* 80658D70  C0 23 2D C8 */	lfs f1, lit_3998@l(r3)  /* 0x80662DC8@l */
/* 80658D74  D0 21 00 08 */	stfs f1, 8(r1)
/* 80658D78  3C 60 80 66 */	lis r3, lit_3989@ha /* 0x80662DB8@ha */
/* 80658D7C  C0 03 2D B8 */	lfs f0, lit_3989@l(r3)  /* 0x80662DB8@l */
/* 80658D80  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80658D84  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80658D88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80658D8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80658DA0  4B A1 6C 85 */	bl StartShock__12dVibration_cFii4cXyz
lbl_80658DA4:
