...
/* 8065D244  3C 80 80 66 */	lis r4, lit_3989@ha /* 0x80662DB8@ha */
/* 8065D248  C0 24 2D B8 */	lfs f1, lit_3989@l(r4)  /* 0x80662DB8@l */
/* 8065D24C  C0 03 0C AC */	lfs f0, 0xcac(r3)
/* 8065D250  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 8065D254  4C 82 00 20 */	bnelr 
/* 8065D258  3C 80 80 66 */	lis r4, lit_3998@ha /* 0x80662DC8@ha */
/* 8065D25C  C0 04 2D C8 */	lfs f0, lit_3998@l(r4)  /* 0x80662DC8@l */
...
lbl_8065D270:
/* 8065D270  3C 80 80 66 */	lis r4, lit_3998@ha /* 0x80662DC8@ha */
/* 8065D274  C0 24 2D C8 */	lfs f1, lit_3998@l(r4)  /* 0x80662DC8@l */
/* 8065D278  C0 03 0C AC */	lfs f0, 0xcac(r3)
/* 8065D27C  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 8065D280  4C 82 00 20 */	bnelr 
/* 8065D284  3C 80 80 66 */	lis r4, lit_3989@ha /* 0x80662DB8@ha */
/* 8065D288  C0 04 2D B8 */	lfs f0, lit_3989@l(r4)  /* 0x80662DB8@l */
