...
/* 8065C518  4B D0 5C C5 */	bl _savegpr_29
...
/* 8065C548  4B C0 74 15 */	bl ClrCcMove__9cCcD_SttsFv
...
/* 8065C560  3C 80 80 66 */	lis r4, lit_3998@ha /* 0x80662DC8@ha */
/* 8065C564  C0 24 2D C8 */	lfs f1, lit_3998@l(r4)  /* 0x80662DC8@l */
/* 8065C568  FC 40 08 90 */	fmr f2, f1
/* 8065C56C  4B A1 99 ED */	bl SetWall__12dBgS_AcchCirFff
/* 8065C570  3C 60 80 66 */	lis r3, lit_5651@ha /* 0x80662E74@ha */
/* 8065C574  C0 23 2E 74 */	lfs f1, lit_5651@l(r3)  /* 0x80662E74@l */
/* 8065C578  4B C0 B3 DD */	bl cM_rndF__Ff
/* 8065C57C  FC 00 08 1E */	fctiwz f0, f1
/* 8065C580  D8 01 00 08 */	stfd f0, 8(r1)
/* 8065C584  80 E1 00 0C */	lwz r7, 0xc(r1)
/* 8065C588  3C 60 80 66 */	lis r3, data_806634D0@ha /* 0x806634D0@ha */
/* 8065C58C  80 83 34 D0 */	lwz r4, data_806634D0@l(r3)  /* 0x806634D0@l */
...
/* 8065C5E4  3C 60 80 66 */	lis r3, data_80662FC0@ha /* 0x80662FC0@ha */
/* 8065C5E8  38 63 2F C0 */	addi r3, r3, data_80662FC0@l /* 0x80662FC0@l */
...
/* 8065C5FC  3C 60 80 66 */	lis r3, data_80663010@ha /* 0x80663010@ha */
/* 8065C600  38 63 30 10 */	addi r3, r3, data_80663010@l /* 0x80663010@l */
...
/* 8065C624  3C 60 80 66 */	lis r3, data_806634D0@ha /* 0x806634D0@ha */
/* 8065C628  38 83 34 D0 */	addi r4, r3, data_806634D0@l /* 0x806634D0@l */
...
/* 8065C66C  4B D0 5B BD */	bl _restgpr_29
