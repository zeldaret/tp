...
/* 8065BB6C  3C A0 80 66 */	lis r5, data_806634AC@ha /* 0x806634AC@ha */
/* 8065BB70  38 A5 34 AC */	addi r5, r5, data_806634AC@l /* 0x806634AC@l */
/* 8065BB74  4B C0 AF C1 */	bl __mi__4cXyzCFRC3Vec
...
/* 8065BBAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8065BBB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8065BBB4  38 81 00 20 */	addi r4, r1, 0x20
/* 8065BBB8  7C 85 23 78 */	mr r5, r4
/* 8065BBBC  4B CE B2 91 */	bl PSMTXMultVecSR
/* 8065BBC0  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 8065BBC4  3C 60 80 66 */	lis r3, lit_5516@ha /* 0x80662E6C@ha */
/* 8065BBC8  C0 03 2E 6C */	lfs f0, lit_5516@l(r3)  /* 0x80662E6C@l */
...
/* 8065BBE0  3C 60 80 66 */	lis r3, lit_5517@ha /* 0x80662E70@ha */
...
/* 8065BC0C  3C 60 80 66 */	lis r3, lit_5493@ha /* 0x806631D8@ha */
/* 8065BC10  38 83 31 D8 */	addi r4, r3, lit_5493@l /* 0x806631D8@l */
