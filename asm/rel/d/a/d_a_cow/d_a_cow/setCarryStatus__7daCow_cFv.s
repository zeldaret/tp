...
/* 80658B38  3C 60 80 66 */	lis r3, lit_3987@ha /* 0x80662DB0@ha */
/* 80658B3C  3B E3 2D B0 */	addi r31, r3, lit_3987@l /* 0x80662DB0@l */
...
lbl_80658B64:
/* 80658B64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80658B68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80658B6C  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 80658B70  7C 00 00 D0 */	neg r0, r0
/* 80658B74  7C 04 07 34 */	extsh r4, r0
/* 80658B78  4B 9B 38 65 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80658B94  4B 9B 42 09 */	bl transM__14mDoMtx_stack_cFfff
/* 80658B98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80658B9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80658BA0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80658BA4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80658BA8  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80658BAC  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 80658BB0  38 A1 00 08 */	addi r5, r1, 8
/* 80658BB4  4B CE E1 B9 */	bl PSMTXMultVec
