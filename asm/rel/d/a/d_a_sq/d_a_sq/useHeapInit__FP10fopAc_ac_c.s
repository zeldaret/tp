...
/* 805A0A58  4B DC 17 81 */	bl _savegpr_28
/* 805A0A5C  7C 7F 1B 78 */	mr r31, r3
/* 805A0A60  38 60 00 54 */	li r3, 0x54
/* 805A0A64  4B D2 E1 E9 */	bl __nw__FUl
/* 805A0A68  7C 7E 1B 79 */	or. r30, r3, r3
/* 805A0A6C  41 82 00 9C */	beq lbl_805A0B08
/* 805A0A70  3C 60 80 5A */	lis r3, d_a_sq__stringBase0@ha /* 0x805A11E4@ha */
/* 805A0A74  38 63 11 E4 */	addi r3, r3, d_a_sq__stringBase0@l /* 0x805A11E4@l */
/* 805A0A78  38 80 00 09 */	li r4, 9
/* 805A0A7C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A0A80  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805A0A94  4B A9 B8 59 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 805A0A98  7C 7D 1B 78 */	mr r29, r3
/* 805A0A9C  3C 60 80 5A */	lis r3, d_a_sq__stringBase0@ha /* 0x805A11E4@ha */
/* 805A0AA0  38 63 11 E4 */	addi r3, r3, d_a_sq__stringBase0@l /* 0x805A11E4@l */
/* 805A0AA4  38 80 00 11 */	li r4, 0x11
/* 805A0AA8  7F 85 E3 78 */	mr r5, r28
/* 805A0AAC  38 C0 00 80 */	li r6, 0x80
/* 805A0AB0  4B A9 B8 3D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805A0AF0  3D 20 80 5A */	lis r9, lit_3771@ha /* 0x805A1160@ha */
/* 805A0AF4  C0 29 11 60 */	lfs f1, lit_3771@l(r9)  /* 0x805A1160@l */
/* 805A0AF8  39 20 00 00 */	li r9, 0
/* 805A0AFC  39 40 FF FF */	li r10, -1
/* 805A0B00  4B A6 F1 4D */	bl __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 805A0B30  4B D2 E1 1D */	bl __nw__FUl
/* 805A0B34  7C 7E 1B 79 */	or. r30, r3, r3
/* 805A0B38  41 82 00 20 */	beq lbl_805A0B58
/* 805A0B3C  3C 80 80 5A */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x805A1310@ha */
/* 805A0B40  38 04 13 10 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x805A1310@l */
/* 805A0B44  90 1E 00 00 */	stw r0, 0(r30)
/* 805A0B48  38 80 00 00 */	li r4, 0
/* 805A0B4C  4B D8 78 B1 */	bl init__12J3DFrameCtrlFs
...
lbl_805A0B70:
/* 805A0B70  3C 60 80 5A */	lis r3, d_a_sq__stringBase0@ha /* 0x805A11E4@ha */
/* 805A0B74  38 63 11 E4 */	addi r3, r3, d_a_sq__stringBase0@l /* 0x805A11E4@l */
/* 805A0B78  38 80 00 14 */	li r4, 0x14
/* 805A0B7C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A0B80  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A0B84  3C A5 00 02 */	addis r5, r5, 2
/* 805A0B88  38 C0 00 80 */	li r6, 0x80
/* 805A0B8C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 805A0B90  4B A9 B7 5D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805A0BB4  3D 00 80 5A */	lis r8, lit_3771@ha /* 0x805A1160@ha */
/* 805A0BB8  C0 28 11 60 */	lfs f1, lit_3771@l(r8)  /* 0x805A1160@l */
/* 805A0BBC  39 00 00 00 */	li r8, 0
/* 805A0BC0  39 20 FF FF */	li r9, -1
/* 805A0BC4  4B A6 CA 79 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 805A0BC8  30 03 FF FF */	addic r0, r3, -1
/* 805A0BCC  7C 60 19 10 */	subfe r3, r0, r3
lbl_805A0BD0:
/* 805A0BD0  39 61 00 30 */	addi r11, r1, 0x30
/* 805A0BD4  4B DC 16 51 */	bl _restgpr_28
