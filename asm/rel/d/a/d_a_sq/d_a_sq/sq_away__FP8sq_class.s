...
/* 8059FE68  4B DC 23 75 */	bl _savegpr_29
/* 8059FE6C  7C 7E 1B 78 */	mr r30, r3
/* 8059FE70  3C 60 80 5A */	lis r3, lit_3769@ha /* 0x805A1158@ha */
/* 8059FE74  3B E3 11 58 */	addi r31, r3, lit_3769@l /* 0x805A1158@l */
/* 8059FE78  C3 FF 00 20 */	lfs f31, 0x20(r31)
/* 8059FE7C  38 61 00 08 */	addi r3, r1, 8
/* 8059FE80  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 8059FE84  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8059FE88  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8059FE8C  80 A5 5D AC */	lwz r5, 0x5dac(r5)
/* 8059FE90  38 A5 04 D0 */	addi r5, r5, 0x4d0
/* 8059FE94  4B CC 6C A1 */	bl __mi__4cXyzCFRC3Vec
...
/* 8059FEE0  3C C0 80 5A */	lis r6, l_HIO@ha /* 0x805A1340@ha */
/* 8059FEE4  38 C6 13 40 */	addi r6, r6, l_HIO@l /* 0x805A1340@l */
...
lbl_8059FF0C:
/* 8059FF0C  3C 60 80 5A */	lis r3, l_HIO@ha /* 0x805A1340@ha */
/* 8059FF10  38 63 13 40 */	addi r3, r3, l_HIO@l /* 0x805A1340@l */
...
/* 8059FF50  4B CC 7A 05 */	bl cM_rndF__Ff
...
/* 8059FF8C  4B CC 7A 01 */	bl cM_rndFX__Ff
...
/* 8059FFA4  4B CC 76 D1 */	bl cM_atan2s__Fff
...
/* 8059FFEC  4B CC FA 51 */	bl cLib_addCalc2__FPffff
