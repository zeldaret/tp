...
/* 805A0C40  4B DC 15 8D */	bl _savegpr_25
/* 805A0C44  7C 7B 1B 78 */	mr r27, r3
/* 805A0C48  3C 80 80 5A */	lis r4, lit_3769@ha /* 0x805A1158@ha */
/* 805A0C4C  3B E4 11 58 */	addi r31, r4, lit_3769@l /* 0x805A1158@l */
...
/* 805A0C68  4B A7 7E FD */	bl __ct__10fopAc_ac_cFv
/* 805A0C6C  38 7A 06 24 */	addi r3, r26, 0x624
/* 805A0C70  4B CA 92 91 */	bl __ct__10dMsgFlow_cFv
/* 805A0C74  38 7A 06 70 */	addi r3, r26, 0x670
/* 805A0C78  4B AD 52 35 */	bl __ct__12dBgS_AcchCirFv
/* 805A0C7C  3B 3A 06 B0 */	addi r25, r26, 0x6b0
/* 805A0C80  7F 23 CB 78 */	mr r3, r25
/* 805A0C84  4B AD 54 1D */	bl __ct__9dBgS_AcchFv
/* 805A0C88  3C 60 80 5A */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x805A12EC@ha */
/* 805A0C8C  38 63 12 EC */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x805A12EC@l */
...
/* 805A0CA8  4B AD 81 C1 */	bl SetObj__16dBgS_PolyPassChkFv
/* 805A0CAC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 805A0CB0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 805A0CB4  90 1A 08 A0 */	stw r0, 0x8a0(r26)
/* 805A0CB8  38 7A 08 A4 */	addi r3, r26, 0x8a4
/* 805A0CBC  4B AE 2A A5 */	bl __ct__10dCcD_GSttsFv
/* 805A0CC0  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 805A0CC4  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 805A0CDC  4B AE 2D 4D */	bl __ct__12dCcD_GObjInfFv
/* 805A0CE0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805A0CE4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805A0CE8  90 19 01 20 */	stw r0, 0x120(r25)
/* 805A0CEC  3C 60 80 5A */	lis r3, __vt__8cM3dGAab@ha /* 0x805A12E0@ha */
/* 805A0CF0  38 03 12 E0 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805A12E0@l */
/* 805A0CF4  90 19 01 1C */	stw r0, 0x11c(r25)
/* 805A0CF8  3C 60 80 5A */	lis r3, __vt__8cM3dGSph@ha /* 0x805A12D4@ha */
/* 805A0CFC  38 03 12 D4 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x805A12D4@l */
/* 805A0D00  90 19 01 34 */	stw r0, 0x134(r25)
/* 805A0D04  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 805A0D08  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 805A0D0C  90 79 01 20 */	stw r3, 0x120(r25)
/* 805A0D10  3B C3 00 58 */	addi r30, r3, 0x58
/* 805A0D14  93 D9 01 34 */	stw r30, 0x134(r25)
/* 805A0D18  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 805A0D1C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 805A0D3C  4B AE 2C ED */	bl __ct__12dCcD_GObjInfFv
/* 805A0D40  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805A0D44  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805A0D48  90 19 01 20 */	stw r0, 0x120(r25)
/* 805A0D4C  3C 60 80 5A */	lis r3, __vt__8cM3dGAab@ha /* 0x805A12E0@ha */
/* 805A0D50  38 03 12 E0 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805A12E0@l */
/* 805A0D54  90 19 01 1C */	stw r0, 0x11c(r25)
/* 805A0D58  3C 60 80 5A */	lis r3, __vt__8cM3dGSph@ha /* 0x805A12D4@ha */
/* 805A0D5C  38 03 12 D4 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x805A12D4@l */
/* 805A0D60  90 19 01 34 */	stw r0, 0x134(r25)
/* 805A0D64  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 805A0D68  38 03 35 40 */	addi r0, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 805A0D6C  90 19 01 20 */	stw r0, 0x120(r25)
/* 805A0D70  93 D9 01 34 */	stw r30, 0x134(r25)
/* 805A0D74  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 805A0D78  38 03 BF C0 */	addi r0, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 805A0D98  3C 80 80 5A */	lis r4, d_a_sq__stringBase0@ha /* 0x805A11E4@ha */
/* 805A0D9C  38 84 11 E4 */	addi r4, r4, d_a_sq__stringBase0@l /* 0x805A11E4@l */
/* 805A0DA0  4B A8 C1 1D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 805A0DE4  4B A7 8F B5 */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
...
/* 805A0E44  3C 80 80 5A */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x805A0A48@ha */
/* 805A0E48  38 84 0A 48 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x805A0A48@l */
/* 805A0E4C  38 A0 17 C0 */	li r5, 0x17c0
/* 805A0E50  4B A7 96 61 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_805A0E64:
/* 805A0E64  3C 60 80 5A */	lis r3, data_805A1330@ha /* 0x805A1330@ha */
/* 805A0E68  8C 03 13 30 */	lbzu r0, data_805A1330@l(r3)  /* 0x805A1330@l */
...
/* 805A0E84  3C 60 80 5A */	lis r3, l_HIO@ha /* 0x805A1340@ha */
/* 805A0E88  38 63 13 40 */	addi r3, r3, l_HIO@l /* 0x805A1340@l */
...
/* 805A0EDC  4B AD 53 6D */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 805A0EE0  38 7B 06 70 */	addi r3, r27, 0x670
/* 805A0EE4  C0 3F 00 14 */	lfs f1, 0x14(r31)
/* 805A0EE8  C0 5F 00 58 */	lfs f2, 0x58(r31)
/* 805A0EEC  4B AD 50 6D */	bl SetWall__12dBgS_AcchCirFff
...
/* 805A0F0C  4B AE 29 55 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 805A0F10  38 7B 08 C4 */	addi r3, r27, 0x8c4
/* 805A0F14  3C 80 80 5A */	lis r4, cc_sph_src@ha /* 0x805A1204@ha */
/* 805A0F18  38 84 12 04 */	addi r4, r4, cc_sph_src@l /* 0x805A1204@l */
/* 805A0F1C  4B AE 3B 19 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
/* 805A0F20  38 1B 08 88 */	addi r0, r27, 0x888
/* 805A0F24  90 1B 09 08 */	stw r0, 0x908(r27)
/* 805A0F28  38 7B 09 FC */	addi r3, r27, 0x9fc
/* 805A0F2C  3C 80 80 5A */	lis r4, at_sph_src@ha /* 0x805A1244@ha */
/* 805A0F30  38 84 12 44 */	addi r4, r4, at_sph_src@l /* 0x805A1244@l */
/* 805A0F34  4B AE 3B 01 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805A0F58  4B CC 69 FD */	bl cM_rndF__Ff
...
/* 805A0F9C  4B DC 12 7D */	bl _restgpr_25
