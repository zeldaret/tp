...
/* 8049FBC4  4B B6 D1 A1 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8049FBC8  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 8049FBCC  4B B6 D3 79 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8049FBD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8049FBD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8049FBD8  80 9F 05 6C */	lwz r4, 0x56c(r31)
/* 8049FBDC  38 84 00 24 */	addi r4, r4, 0x24
/* 8049FBE0  4B EA 68 D1 */	bl PSMTXCopy
/* 8049FBE4  80 7F 05 70 */	lwz r3, 0x570(r31)
/* 8049FBE8  4B C0 96 61 */	bl simpleAnmPlay__9daAlink_cFP10J3DAnmBase
/* 8049FBEC  C0 3F 09 8C */	lfs f1, 0x98c(r31)
/* 8049FBF0  3C 60 80 4A */	lis r3, lit_4945@ha /* 0x804A2910@ha */
/* 8049FBF4  C0 03 29 10 */	lfs f0, lit_4945@l(r3)  /* 0x804A2910@l */
...
/* 8049FC0C  3C 60 80 4A */	lis r3, lit_4487@ha /* 0x804A28C0@ha */
/* 8049FC10  C8 23 28 C0 */	lfd f1, lit_4487@l(r3)  /* 0x804A28C0@l */
...
/* 8049FC60  4B B6 DD 6D */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
...
/* 8049FC7C  4B B6 D0 E9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8049FC80  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 8049FC84  4B B6 D2 C1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8049FC88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8049FC8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8049FC90  A8 9F 09 5A */	lha r4, 0x95a(r31)
/* 8049FC94  4B B6 C7 A1 */	bl mDoMtx_YrotM__FPA4_fs
/* 8049FC98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8049FC9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8049FCA0  38 80 7F FF */	li r4, 0x7fff
/* 8049FCA4  4B B6 C6 F9 */	bl mDoMtx_XrotM__FPA4_fs
/* 8049FCA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8049FCAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8049FCB0  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 8049FCB4  38 84 00 24 */	addi r4, r4, 0x24
/* 8049FCB8  4B EA 67 F9 */	bl PSMTXCopy
