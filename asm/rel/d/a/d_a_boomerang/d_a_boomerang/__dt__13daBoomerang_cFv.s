...
/* 804A1C18  4B E1 C3 E1 */	bl deleteObject__14Z2SoundObjBaseFv
/* 804A1C1C  34 1E 0D 6C */	addic. r0, r30, 0xd6c
/* 804A1C20  41 82 00 34 */	beq lbl_804A1C54
/* 804A1C24  3C 60 80 4A */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x804A2C84@ha */
/* 804A1C28  38 63 2C 84 */	addi r3, r3, __vt__14dBgS_ObjGndChk@l /* 0x804A2C84@l */
...
/* 804A1C50  4B BD 59 A1 */	bl __dt__11dBgS_GndChkFv
lbl_804A1C54:
/* 804A1C54  38 7E 0C FC */	addi r3, r30, 0xcfc
/* 804A1C58  38 80 FF FF */	li r4, -1
/* 804A1C5C  4B BD 63 5D */	bl __dt__14dBgS_ObjLinChkFv
/* 804A1C60  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 804A1C64  38 80 FF FF */	li r4, -1
/* 804A1C68  4B BD 66 AD */	bl __dt__20dBgS_BoomerangLinChkFv
/* 804A1C6C  34 1E 0B 50 */	addic. r0, r30, 0xb50
/* 804A1C70  41 82 00 84 */	beq lbl_804A1CF4
/* 804A1C74  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 804A1C78  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 804A1C98  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 804A1C9C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 804A1CB4  3C 60 80 4A */	lis r3, __vt__8cM3dGCyl@ha /* 0x804A2C78@ha */
/* 804A1CB8  38 03 2C 78 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x804A2C78@l */
/* 804A1CBC  90 1E 0C 88 */	stw r0, 0xc88(r30)
lbl_804A1CC0:
/* 804A1CC0  34 1E 0C 54 */	addic. r0, r30, 0xc54
/* 804A1CC4  41 82 00 24 */	beq lbl_804A1CE8
/* 804A1CC8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 804A1CCC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 804A1CD0  90 1E 0C 70 */	stw r0, 0xc70(r30)
/* 804A1CD4  34 1E 0C 54 */	addic. r0, r30, 0xc54
/* 804A1CD8  41 82 00 10 */	beq lbl_804A1CE8
/* 804A1CDC  3C 60 80 4A */	lis r3, __vt__8cM3dGAab@ha /* 0x804A2C6C@ha */
/* 804A1CE0  38 03 2C 6C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x804A2C6C@l */
/* 804A1CE4  90 1E 0C 6C */	stw r0, 0xc6c(r30)
lbl_804A1CE8:
/* 804A1CE8  38 7E 0B 50 */	addi r3, r30, 0xb50
/* 804A1CEC  38 80 00 00 */	li r4, 0
/* 804A1CF0  4B BE 23 F5 */	bl __dt__12dCcD_GObjInfFv
lbl_804A1CF4:
/* 804A1CF4  34 1E 0A 0C */	addic. r0, r30, 0xa0c
/* 804A1CF8  41 82 00 7C */	beq lbl_804A1D74
/* 804A1CFC  3C 60 80 3B */	lis r3, __vt__8dCcD_Cps@ha /* 0x803AC170@ha */
/* 804A1D00  38 63 C1 70 */	addi r3, r3, __vt__8dCcD_Cps@l /* 0x803AC170@l */
...
/* 804A1D20  3C 60 80 3C */	lis r3, __vt__12cCcD_CpsAttr@ha /* 0x803C3608@ha */
/* 804A1D24  38 63 36 08 */	addi r3, r3, __vt__12cCcD_CpsAttr@l /* 0x803C3608@l */
...
/* 804A1D3C  4B DC D2 69 */	bl __dt__8cM3dGCpsFv
/* 804A1D40  34 1E 0B 10 */	addic. r0, r30, 0xb10
/* 804A1D44  41 82 00 24 */	beq lbl_804A1D68
/* 804A1D48  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 804A1D4C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 804A1D50  90 1E 0B 2C */	stw r0, 0xb2c(r30)
/* 804A1D54  34 1E 0B 10 */	addic. r0, r30, 0xb10
/* 804A1D58  41 82 00 10 */	beq lbl_804A1D68
/* 804A1D5C  3C 60 80 4A */	lis r3, __vt__8cM3dGAab@ha /* 0x804A2C6C@ha */
/* 804A1D60  38 03 2C 6C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x804A2C6C@l */
/* 804A1D64  90 1E 0B 28 */	stw r0, 0xb28(r30)
lbl_804A1D68:
/* 804A1D68  38 7E 0A 0C */	addi r3, r30, 0xa0c
/* 804A1D6C  38 80 00 00 */	li r4, 0
/* 804A1D70  4B BE 23 75 */	bl __dt__12dCcD_GObjInfFv
lbl_804A1D74:
/* 804A1D74  34 1E 09 D0 */	addic. r0, r30, 0x9d0
/* 804A1D78  41 82 00 54 */	beq lbl_804A1DCC
/* 804A1D7C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 804A1D80  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 804A1D98  3C 60 80 4A */	lis r3, __vt__10dCcD_GStts@ha /* 0x804A2C60@ha */
/* 804A1D9C  38 03 2C 60 */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x804A2C60@l */
/* 804A1DA0  90 1E 09 EC */	stw r0, 0x9ec(r30)
/* 804A1DA4  34 1E 09 EC */	addic. r0, r30, 0x9ec
/* 804A1DA8  41 82 00 10 */	beq lbl_804A1DB8
/* 804A1DAC  3C 60 80 4A */	lis r3, __vt__10cCcD_GStts@ha /* 0x804A2C54@ha */
/* 804A1DB0  38 03 2C 54 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x804A2C54@l */
/* 804A1DB4  90 1E 09 EC */	stw r0, 0x9ec(r30)
lbl_804A1DB8:
/* 804A1DB8  34 1E 09 D0 */	addic. r0, r30, 0x9d0
/* 804A1DBC  41 82 00 10 */	beq lbl_804A1DCC
/* 804A1DC0  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 804A1DC4  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 804A1DC8  90 1E 09 E8 */	stw r0, 0x9e8(r30)
lbl_804A1DCC:
/* 804A1DCC  34 1E 07 40 */	addic. r0, r30, 0x740
/* 804A1DD0  41 82 00 2C */	beq lbl_804A1DFC
/* 804A1DD4  3C 60 80 4A */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x804A2C30@ha */
/* 804A1DD8  38 63 2C 30 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x804A2C30@l */
...
/* 804A1DF8  4B BD 41 9D */	bl __dt__9dBgS_AcchFv
lbl_804A1DFC:
/* 804A1DFC  34 1E 07 20 */	addic. r0, r30, 0x720
/* 804A1E00  41 82 00 1C */	beq lbl_804A1E1C
/* 804A1E04  3C 60 80 3D */	lis r3, __vt__16Z2SoundObjSimple@ha /* 0x803CAD10@ha */
/* 804A1E08  38 03 AD 10 */	addi r0, r3, __vt__16Z2SoundObjSimple@l /* 0x803CAD10@l */
/* 804A1E0C  90 1E 07 30 */	stw r0, 0x730(r30)
/* 804A1E10  38 7E 07 20 */	addi r3, r30, 0x720
/* 804A1E14  38 80 00 00 */	li r4, 0
/* 804A1E18  4B E1 C1 31 */	bl __dt__14Z2SoundObjBaseFv
lbl_804A1E1C:
/* 804A1E1C  38 7E 06 DC */	addi r3, r30, 0x6dc
/* 804A1E20  3C 80 80 4A */	lis r4, __dt__4cXyzFv@ha /* 0x8049EE8C@ha */
/* 804A1E24  38 84 EE 8C */	addi r4, r4, __dt__4cXyzFv@l /* 0x8049EE8C@l */
/* 804A1E28  38 A0 00 0C */	li r5, 0xc
/* 804A1E2C  38 C0 00 05 */	li r6, 5
/* 804A1E30  4B EB FE B9 */	bl __destroy_arr
/* 804A1E34  34 1E 05 98 */	addic. r0, r30, 0x598
/* 804A1E38  41 82 00 28 */	beq lbl_804A1E60
/* 804A1E3C  3C 60 80 4A */	lis r3, __vt__19daBoomerang_sight_c@ha /* 0x804A2CC0@ha */
/* 804A1E40  38 03 2C C0 */	addi r0, r3, __vt__19daBoomerang_sight_c@l /* 0x804A2CC0@l */
/* 804A1E44  90 1E 05 98 */	stw r0, 0x598(r30)
/* 804A1E48  38 7E 06 60 */	addi r3, r30, 0x660
/* 804A1E4C  3C 80 80 4A */	lis r4, __dt__4cXyzFv@ha /* 0x8049EE8C@ha */
/* 804A1E50  38 84 EE 8C */	addi r4, r4, __dt__4cXyzFv@l /* 0x8049EE8C@l */
/* 804A1E54  38 A0 00 0C */	li r5, 0xc
/* 804A1E58  38 C0 00 06 */	li r6, 6
/* 804A1E5C  4B EB FE 8D */	bl __destroy_arr
lbl_804A1E60:
...
/* 804A1E78  3C 60 80 4A */	lis r3, __vt__12J3DFrameCtrl@ha /* 0x804A2C24@ha */
/* 804A1E7C  38 03 2C 24 */	addi r0, r3, __vt__12J3DFrameCtrl@l /* 0x804A2C24@l */
/* 804A1E80  90 1E 05 74 */	stw r0, 0x574(r30)
lbl_804A1E84:
/* 804A1E84  7F C3 F3 78 */	mr r3, r30
/* 804A1E88  38 80 00 00 */	li r4, 0
/* 804A1E8C  4B B7 6E 01 */	bl __dt__10fopAc_ac_cFv
/* 804A1E90  7F E0 07 35 */	extsh. r0, r31
/* 804A1E94  40 81 00 0C */	ble lbl_804A1EA0
/* 804A1E98  7F C3 F3 78 */	mr r3, r30
/* 804A1E9C  4B E2 CE A1 */	bl __dl__FPv
lbl_804A1EA0:
