...
/* 8059F0E8  4B DC 30 F5 */	bl _savegpr_29
...
/* 8059F108  4B A7 9A 5D */	bl __ct__10fopAc_ac_cFv
/* 8059F10C  3C 60 80 3B */	lis r3, __vt__12daItemBase_c@ha /* 0x803B3610@ha */
/* 8059F110  38 03 36 10 */	addi r0, r3, __vt__12daItemBase_c@l /* 0x803B3610@l */
/* 8059F114  90 1E 05 68 */	stw r0, 0x568(r30)
/* 8059F118  3B BE 05 8C */	addi r29, r30, 0x58c
/* 8059F11C  7F A3 EB 78 */	mr r3, r29
/* 8059F120  4B AD 6F 81 */	bl __ct__9dBgS_AcchFv
/* 8059F124  3C 60 80 5A */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x8059F504@ha */
/* 8059F128  38 63 F5 04 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x8059F504@l */
...
/* 8059F144  4B AD 9D 25 */	bl SetObj__16dBgS_PolyPassChkFv
/* 8059F148  38 7E 07 64 */	addi r3, r30, 0x764
/* 8059F14C  4B AD 6D 61 */	bl __ct__12dBgS_AcchCirFv
/* 8059F150  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 8059F154  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 8059F158  90 1E 07 BC */	stw r0, 0x7bc(r30)
/* 8059F15C  38 7E 07 C0 */	addi r3, r30, 0x7c0
/* 8059F160  4B AE 46 01 */	bl __ct__10dCcD_GSttsFv
/* 8059F164  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 8059F168  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 8059F180  4B AE 48 A9 */	bl __ct__12dCcD_GObjInfFv
/* 8059F184  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8059F188  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8059F18C  90 1D 01 20 */	stw r0, 0x120(r29)
/* 8059F190  3C 60 80 5A */	lis r3, __vt__8cM3dGAab@ha /* 0x8059F4F8@ha */
/* 8059F194  38 03 F4 F8 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8059F4F8@l */
/* 8059F198  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 8059F19C  3C 60 80 5A */	lis r3, __vt__8cM3dGCyl@ha /* 0x8059F4EC@ha */
/* 8059F1A0  38 03 F4 EC */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x8059F4EC@l */
/* 8059F1A4  90 1D 01 38 */	stw r0, 0x138(r29)
/* 8059F1A8  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 8059F1AC  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 8059F1B0  90 7D 01 20 */	stw r3, 0x120(r29)
/* 8059F1B4  38 03 00 58 */	addi r0, r3, 0x58
/* 8059F1B8  90 1D 01 38 */	stw r0, 0x138(r29)
/* 8059F1BC  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 8059F1C0  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 8059F1D8  3C 60 80 5A */	lis r3, __vt__12daShopItem_c@ha /* 0x8059F528@ha */
/* 8059F1DC  38 03 F5 28 */	addi r0, r3, __vt__12daShopItem_c@l /* 0x8059F528@l */
...
/* 8059F22C  4B A8 DC 91 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8059F254  3C 80 80 03 */	lis r4, CheckShopItemCreateHeap__FP10fopAc_ac_c@ha /* 0x80037C24@ha */
/* 8059F258  38 84 7C 24 */	addi r4, r4, CheckShopItemCreateHeap__FP10fopAc_ac_c@l /* 0x80037C24@l */
/* 8059F25C  4B A7 B2 55 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8059F280  4B DC 2F A9 */	bl _restgpr_29
