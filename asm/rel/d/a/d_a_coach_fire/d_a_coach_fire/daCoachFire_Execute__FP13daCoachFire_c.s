...
/* 80657EB0  4B D0 A3 2D */	bl _savegpr_29
/* 80657EB4  7C 7F 1B 78 */	mr r31, r3
/* 80657EB8  80 63 04 A4 */	lwz r3, 0x4a4(r3)
/* 80657EBC  4B 9C 94 9D */	bl fpcEx_SearchByID__FUi
...
/* 80657EDC  4B A2 C5 85 */	bl ChkTgHit__12dCcD_GObjInfFv
...
lbl_80657F14:
/* 80657F14  48 34 5C 91 */	bl deleteFireArrow__12daNpcCoach_cFUi
lbl_80657F18:
...
/* 80657F34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80657F38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80657F3C  3B A3 56 B8 */	addi r29, r3, 0x56b8
/* 80657F40  7F A3 EB 78 */	mr r3, r29
/* 80657F44  4B A1 B8 A1 */	bl LockonTruth__12dAttention_cFv
...
/* 80657F58  4B A1 B5 E5 */	bl LockonTarget__12dAttention_cFl
...
lbl_80657F7C:
/* 80657F7C  48 34 5D 6D */	bl deleteFireArrowFromList__12daNpcCoach_cFUi
/* 80657F80  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80657F84  41 82 00 3C */	beq lbl_80657FC0
/* 80657F88  7F E3 FB 78 */	mr r3, r31
/* 80657F8C  4B 9C 1C F1 */	bl fopAcM_delete__FP10fopAc_ac_c
...
lbl_80657FAC:
/* 80657FAC  48 34 5D 3D */	bl deleteFireArrowFromList__12daNpcCoach_cFUi
/* 80657FB0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80657FB4  41 82 00 0C */	beq lbl_80657FC0
/* 80657FB8  7F E3 FB 78 */	mr r3, r31
/* 80657FBC  4B 9C 1C C1 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_80657FC0:
/* 80657FC0  80 7F 06 FC */	lwz r3, 0x6fc(r31)
/* 80657FC4  28 03 00 00 */	cmplwi r3, 0
/* 80657FC8  41 82 00 54 */	beq lbl_8065801C
/* 80657FCC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80657FD0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80657FD4  4B CE E4 DD */	bl PSMTXCopy
/* 80657FD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80657FDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80657FE0  38 9F 07 00 */	addi r4, r31, 0x700
/* 80657FE4  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80657FE8  4B CE ED 85 */	bl PSMTXMultVec
...
/* 80658048  4B C1 76 01 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8065804C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80658050  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80658054  38 63 23 3C */	addi r3, r3, 0x233c
/* 80658058  38 9F 05 C4 */	addi r4, r31, 0x5c4
/* 8065805C  4B C0 CB 4D */	bl Set__4cCcSFP8cCcD_Obj
lbl_80658060:
...
/* 80658080  4B D0 A1 A9 */	bl _restgpr_29
