...
/* 804679A8  3C 60 80 46 */	lis r3, lit_3802@ha
/* 804679AC  C0 23 7F 38 */	lfs f1, lit_3802@l(r3)
/* 804679B0  4B DF FF DC */	b cM_rndFX__Ff
...
/* 804679C8  3C 80 80 45 */	lis r4, OPEN_SPEED__7daDsh_c@ha
/* 804679CC  C0 24 1D 38 */	lfs f1, OPEN_SPEED__7daDsh_c@l(r4)
/* 804679D0  C0 5F 05 30 */	lfs f2, 0x530(r31)
/* 804679D4  4B E0 8D 6C */	b cLib_chaseF__FPfff
...
/* 804679EC  3C 60 80 45 */	lis r3, OPEN_SIZE__7daDsh_c@ha
/* 804679F0  C0 03 1D 30 */	lfs f0, OPEN_SIZE__7daDsh_c@l(r3)
...
/* 80467A0C  3C 60 80 45 */	lis r3, OPEN_BOUND_SPEED__7daDsh_c@ha
/* 80467A10  C0 03 1D 3C */	lfs f0, OPEN_BOUND_SPEED__7daDsh_c@l(r3)
/* 80467A14  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80467A18  40 80 00 24 */	bge lbl_80467A3C
/* 80467A1C  3C 60 80 45 */	lis r3, OPEN_BOUND_RATIO__7daDsh_c@ha
/* 80467A20  C0 03 1D 40 */	lfs f0, OPEN_BOUND_RATIO__7daDsh_c@l(r3)
/* 80467A24  EC 01 00 32 */	fmuls f0, f1, f0
/* 80467A28  D0 1F 04 FC */	stfs f0, 0x4fc(r31)
/* 80467A2C  3C 60 80 46 */	lis r3, lit_3803@ha
/* 80467A30  C0 03 7F 3C */	lfs f0, lit_3803@l(r3)
/* 80467A34  D0 1F 05 30 */	stfs f0, 0x530(r31)
/* 80467A38  48 00 00 14 */	b lbl_80467A4C
lbl_80467A3C:
/* 80467A3C  7F E3 FB 78 */	mr r3, r31
/* 80467A40  3C 80 80 47 */	lis r4, l_closeWaitAction@ha
/* 80467A44  38 84 80 E0 */	addi r4, r4, l_closeWaitAction@l
