...
/* 8086C9E0  4B AF 57 D1 */	bl _savegpr_18
/* 8086C9E4  3C 80 80 87 */	lis r4, lit_3829@ha /* 0x80870094@ha */
/* 8086C9E8  3A C4 00 94 */	addi r22, r4, lit_3829@l /* 0x80870094@l */
/* 8086C9EC  3A A3 11 74 */	addi r21, r3, 0x1174
/* 8086C9F0  3A 80 00 00 */	li r20, 0
/* 8086C9F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8086C9F8  3A E3 D4 70 */	addi r23, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8086C9FC  3C 60 80 87 */	lis r3, guide_p@ha /* 0x80870774@ha */
/* 8086CA00  3B 83 07 74 */	addi r28, r3, guide_p@l /* 0x80870774@l */
/* 8086CA04  3C 60 80 87 */	lis r3, guide_s@ha /* 0x8087078C@ha */
/* 8086CA08  3B A3 07 8C */	addi r29, r3, guide_s@l /* 0x8087078C@l */
...
/* 8086CA34  4B AD 9E B5 */	bl PSMTXTrans
/* 8086CA38  2C 14 00 00 */	cmpwi r20, 0
/* 8086CA3C  40 82 00 18 */	bne lbl_8086CA54
/* 8086CA40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8086CA44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8086CA48  38 80 D1 20 */	li r4, -12000
/* 8086CA4C  4B 79 F9 E9 */	bl mDoMtx_YrotM__FPA4_fs
/* 8086CA50  48 00 00 30 */	b lbl_8086CA80
lbl_8086CA54:
/* 8086CA54  2C 14 00 01 */	cmpwi r20, 1
/* 8086CA58  40 82 00 18 */	bne lbl_8086CA70
/* 8086CA5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8086CA60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8086CA64  38 80 DC D8 */	li r4, -9000
/* 8086CA68  4B 79 F9 CD */	bl mDoMtx_YrotM__FPA4_fs
/* 8086CA6C  48 00 00 14 */	b lbl_8086CA80
lbl_8086CA70:
/* 8086CA70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8086CA74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8086CA78  38 80 C1 80 */	li r4, -16000
/* 8086CA7C  4B 79 F9 B9 */	bl mDoMtx_YrotM__FPA4_fs
lbl_8086CA80:
/* 8086CA80  7F 23 CB 78 */	mr r3, r25
/* 8086CA84  38 80 05 14 */	li r4, 0x514
/* 8086CA88  4B 79 F9 15 */	bl mDoMtx_XrotM__FPA4_fs
/* 8086CA8C  7F 43 D3 78 */	mr r3, r26
/* 8086CA90  38 80 00 00 */	li r4, 0
/* 8086CA94  4B 79 F9 A1 */	bl mDoMtx_YrotM__FPA4_fs
/* 8086CA98  7F 63 DB 78 */	mr r3, r27
/* 8086CA9C  80 95 00 14 */	lwz r4, 0x14(r21)
/* 8086CAA0  38 84 00 24 */	addi r4, r4, 0x24
/* 8086CAA4  4B AD 9A 0D */	bl PSMTXCopy
...
/* 8086CAC8  4B 7A 02 D5 */	bl transM__14mDoMtx_stack_cFfff
...
/* 8086CADC  4B 7A 02 C1 */	bl transM__14mDoMtx_stack_cFfff
lbl_8086CAE0:
...
/* 8086CB4C  4B 7A 02 51 */	bl transM__14mDoMtx_stack_cFfff
...
/* 8086CBF4  4B AD 98 BD */	bl PSMTXCopy
...
/* 8086CC1C  4B AF 55 E1 */	bl _restgpr_18
