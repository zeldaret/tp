...
/* 8086C328  4B AF 5E 8D */	bl _savegpr_19
/* 8086C32C  7C 7A 1B 78 */	mr r26, r3
/* 8086C330  3C 60 80 87 */	lis r3, lit_3829@ha /* 0x80870094@ha */
/* 8086C334  3B E3 00 94 */	addi r31, r3, lit_3829@l /* 0x80870094@l */
/* 8086C338  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8086C33C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8086C340  38 80 00 10 */	li r4, 0x10
/* 8086C344  38 BA 04 D0 */	addi r5, r26, 0x4d0
/* 8086C348  38 DA 01 0C */	addi r6, r26, 0x10c
/* 8086C34C  4B 93 74 79 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8086C350  80 9A 40 70 */	lwz r4, 0x4070(r26)
/* 8086C354  28 04 00 00 */	cmplwi r4, 0
/* 8086C358  41 82 00 84 */	beq lbl_8086C3DC
/* 8086C35C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8086C360  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8086C364  80 84 00 04 */	lwz r4, 4(r4)
/* 8086C368  38 BA 01 0C */	addi r5, r26, 0x10c
/* 8086C36C  4B 93 8A 35 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8086C3A4  4B 7A 19 21 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8086C3C8  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 8086C3CC  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 8086C3D0  4B 7C 0C E5 */	bl dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
...
/* 8086C418  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8086C41C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8086C464  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8086C468  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8086C46C  80 96 05 88 */	lwz r4, 0x588(r22)
/* 8086C470  80 84 00 04 */	lwz r4, 4(r4)
/* 8086C474  38 BA 01 0C */	addi r5, r26, 0x10c
/* 8086C478  4B 93 89 29 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8086C47C  80 76 05 88 */	lwz r3, 0x588(r22)
/* 8086C480  4B 7A 18 45 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8086C4AC  4B 7C 06 BD */	bl entrySimpleModel__14dComIfG_play_cFP8J3DModeli
...
/* 8086C4DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8086C4E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8086C4E4  3B A3 5F 64 */	addi r29, r3, 0x5f64
/* 8086C4E8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8086C4EC  3A A3 CA 54 */	addi r21, r3, g_env_light@l /* 0x8042CA54@l */
/* 8086C4F0  3C 60 80 87 */	lis r3, rod_color@ha /* 0x8087071C@ha */
/* 8086C4F4  3A C3 07 1C */	addi r22, r3, rod_color@l /* 0x8087071C@l */
lbl_8086C4F8:
...
/* 8086C50C  4B 93 88 95 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8086C510  80 74 11 88 */	lwz r3, 0x1188(r20)
/* 8086C514  4B 7A 17 B1 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8086C52C  4B 7A 69 11 */	bl update__19mDoExt_3DlineMat0_cFiR8_GXColorP12dKy_tevstr_c
...
/* 8086C558  4B 7A 81 E1 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
...
/* 8086C574  4B 7C 05 F5 */	bl entrySimpleModel__14dComIfG_play_cFP8J3DModeli
...
/* 8086C5A4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8086C5A8  3A E3 CA 54 */	addi r23, r3, g_env_light@l /* 0x8042CA54@l */
lbl_8086C5AC:
...
/* 8086C5C0  4B 93 87 E1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8086C5C4  7C 7A A0 2E */	lwzx r3, r26, r20
/* 8086C5C8  4B 7A 16 FD */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8086C5E8  3C A0 80 87 */	lis r5, l_color@ha /* 0x80870728@ha */
/* 8086C5EC  38 A5 07 28 */	addi r5, r5, l_color@l /* 0x80870728@l */
/* 8086C5F0  38 C0 00 02 */	li r6, 2
/* 8086C5F4  38 FA 01 0C */	addi r7, r26, 0x10c
/* 8086C5F8  4B 7A 62 7D */	bl update__19mDoExt_3DlineMat0_cFifR8_GXColorUsP12dKy_tevstr_c
...
/* 8086C624  4B 7A 81 15 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
/* 8086C628  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8086C62C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8086C630  80 9A 6B 30 */	lwz r4, 0x6b30(r26)
/* 8086C634  80 84 00 04 */	lwz r4, 4(r4)
/* 8086C638  38 BA 01 0C */	addi r5, r26, 0x10c
/* 8086C63C  4B 93 87 65 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8086C640  80 7A 6B 30 */	lwz r3, 0x6b30(r26)
/* 8086C644  4B 7A 16 81 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 8086C648  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8086C64C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8086C650  80 9A 3F F4 */	lwz r4, 0x3ff4(r26)
/* 8086C654  80 84 00 04 */	lwz r4, 4(r4)
/* 8086C658  38 BA 01 0C */	addi r5, r26, 0x10c
/* 8086C65C  4B 93 87 45 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8086C660  80 7A 3F F4 */	lwz r3, 0x3ff4(r26)
/* 8086C664  4B 7A 16 61 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 8086C668  80 1A 40 04 */	lwz r0, 0x4004(r26)
/* 8086C66C  28 00 00 00 */	cmplwi r0, 0
/* 8086C670  41 82 00 50 */	beq lbl_8086C6C0
/* 8086C674  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8086C678  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8086C67C  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 8086C680  FC 40 08 90 */	fmr f2, f1
/* 8086C684  FC 60 08 90 */	fmr f3, f1
/* 8086C688  4B AD A2 61 */	bl PSMTXTrans
/* 8086C68C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8086C690  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8086C694  80 9A 40 04 */	lwz r4, 0x4004(r26)
/* 8086C698  38 84 00 24 */	addi r4, r4, 0x24
/* 8086C69C  4B AD 9E 15 */	bl PSMTXCopy
/* 8086C6A0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8086C6A4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8086C6A8  80 9A 40 04 */	lwz r4, 0x4004(r26)
/* 8086C6AC  80 84 00 04 */	lwz r4, 4(r4)
/* 8086C6B0  38 BA 01 0C */	addi r5, r26, 0x10c
/* 8086C6B4  4B 93 86 ED */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8086C6B8  80 7A 40 04 */	lwz r3, 0x4004(r26)
/* 8086C6BC  4B 7A 16 09 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8086C6C0:
...
/* 8086C6D0  4B AF 5B 31 */	bl _restgpr_19
