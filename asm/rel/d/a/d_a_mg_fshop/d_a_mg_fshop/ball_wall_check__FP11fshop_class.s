...
/* 8086D864  4B AF 49 6D */	bl _savegpr_26
...
/* 8086D884  4B 80 A3 E5 */	bl __ct__11dBgS_LinChkFv
/* 8086D888  3C 60 80 87 */	lis r3, lit_3980@ha /* 0x808700B0@ha */
/* 8086D88C  C0 03 00 B0 */	lfs f0, lit_3980@l(r3)  /* 0x808700B0@l */
...
/* 8086D8AC  3C 60 80 87 */	lis r3, lit_3871@ha /* 0x808700A0@ha */
/* 8086D8B0  C0 03 00 A0 */	lfs f0, lit_3871@l(r3)  /* 0x808700A0@l */
...
/* 8086D8C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8086D8C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8086D8CC  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 8086D8D0  3C 60 80 87 */	lis r3, c_x@ha /* 0x808707A4@ha */
/* 8086D8D4  3B C3 07 A4 */	addi r30, r3, c_x@l /* 0x808707A4@l */
/* 8086D8D8  3C 60 80 87 */	lis r3, c_z@ha /* 0x808707B4@ha */
/* 8086D8DC  3B E3 07 B4 */	addi r31, r3, c_z@l /* 0x808707B4@l */
lbl_8086D8E0:
...
/* 8086D8FC  4B 9F 91 E9 */	bl __pl__4cXyzCFRC3Vec
...
/* 8086D928  4B 80 A4 3D */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8086D92C  7F A3 EB 78 */	mr r3, r29
/* 8086D930  38 81 00 38 */	addi r4, r1, 0x38
/* 8086D934  4B 80 6A 81 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8086D94C  3C 60 80 87 */	lis r3, lit_3980@ha /* 0x808700B0@ha */
/* 8086D950  C0 03 00 B0 */	lfs f0, lit_3980@l(r3)  /* 0x808700B0@l */
...
/* 8086D968  3C 60 80 87 */	lis r3, lit_3980@ha /* 0x808700B0@ha */
/* 8086D96C  C0 03 00 B0 */	lfs f0, lit_3980@l(r3)  /* 0x808700B0@l */
/* 8086D970  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8086D974  40 80 00 10 */	bge lbl_8086D984
lbl_8086D978:
/* 8086D978  3C 60 80 87 */	lis r3, lit_3980@ha /* 0x808700B0@ha */
/* 8086D97C  C0 03 00 B0 */	lfs f0, lit_3980@l(r3)  /* 0x808700B0@l */
...
/* 8086D990  3C 60 80 87 */	lis r3, lit_3980@ha /* 0x808700B0@ha */
/* 8086D994  C0 03 00 B0 */	lfs f0, lit_3980@l(r3)  /* 0x808700B0@l */
...
/* 8086D9AC  3C 60 80 87 */	lis r3, lit_3980@ha /* 0x808700B0@ha */
/* 8086D9B0  C0 03 00 B0 */	lfs f0, lit_3980@l(r3)  /* 0x808700B0@l */
/* 8086D9B4  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8086D9B8  40 80 00 10 */	bge lbl_8086D9C8
lbl_8086D9BC:
/* 8086D9BC  3C 60 80 87 */	lis r3, lit_3980@ha /* 0x808700B0@ha */
/* 8086D9C0  C0 03 00 B0 */	lfs f0, lit_3980@l(r3)  /* 0x808700B0@l */
...
/* 8086D9E0  4B 80 A2 FD */	bl __dt__11dBgS_LinChkFv
/* 8086D9E4  38 60 00 00 */	li r3, 0
lbl_8086D9E8:
/* 8086D9E8  39 61 00 C0 */	addi r11, r1, 0xc0
/* 8086D9EC  4B AF 48 31 */	bl _restgpr_26
