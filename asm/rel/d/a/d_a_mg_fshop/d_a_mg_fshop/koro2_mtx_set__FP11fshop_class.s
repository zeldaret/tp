...
/* 8086D1FC  4B AF 4F D4 */	b _savegpr_26
/* 8086D200  7C 7F 1B 78 */	mr r31, r3
/* 8086D204  3C 60 80 87 */	lis r3, lit_3829@ha
/* 8086D208  3B A3 00 94 */	addi r29, r3, lit_3829@l
/* 8086D20C  88 1F 40 0D */	lbz r0, 0x400d(r31)
/* 8086D210  28 00 00 00 */	cmplwi r0, 0
/* 8086D214  41 82 00 7C */	beq lbl_8086D290
/* 8086D218  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D21C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D220  C0 3D 00 1C */	lfs f1, 0x1c(r29)
/* 8086D224  C0 5D 00 7C */	lfs f2, 0x7c(r29)
/* 8086D228  FC 60 08 90 */	fmr f3, f1
/* 8086D22C  4B AD 96 BC */	b PSMTXTrans
/* 8086D230  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D234  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D238  38 9F 40 30 */	addi r4, r31, 0x4030
/* 8086D23C  4B AD 92 74 */	b PSMTXCopy
/* 8086D240  80 7F 40 2C */	lwz r3, 0x402c(r31)
/* 8086D244  4B 80 E7 7C */	b Move__4dBgWFv
/* 8086D248  3B 40 00 00 */	li r26, 0
/* 8086D24C  3B 60 00 00 */	li r27, 0
/* 8086D250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D254  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l
lbl_8086D258:
...
/* 8086D270  4B AD 92 40 */	b PSMTXCopy
/* 8086D274  80 7D 42 F4 */	lwz r3, 0x42f4(r29)
/* 8086D278  4B 80 E7 48 */	b Move__4dBgWFv
lbl_8086D27C:
...
lbl_8086D290:
/* 8086D290  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D294  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D298  C0 3F 40 14 */	lfs f1, 0x4014(r31)
/* 8086D29C  C0 5F 40 18 */	lfs f2, 0x4018(r31)
/* 8086D2A0  C0 7F 40 1C */	lfs f3, 0x401c(r31)
/* 8086D2A4  4B AD 96 44 */	b PSMTXTrans
/* 8086D2A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D2AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D2B0  A8 9F 40 22 */	lha r4, 0x4022(r31)
/* 8086D2B4  4B 79 F1 80 */	b mDoMtx_YrotM__FPA4_fs
/* 8086D2B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D2BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D2C0  A8 9F 40 20 */	lha r4, 0x4020(r31)
/* 8086D2C4  4B 79 F0 D8 */	b mDoMtx_XrotM__FPA4_fs
/* 8086D2C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D2CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D2D0  A8 9F 40 24 */	lha r4, 0x4024(r31)
/* 8086D2D4  4B 79 F1 F8 */	b mDoMtx_ZrotM__FPA4_fs
/* 8086D2D8  C0 3F 04 EC */	lfs f1, 0x4ec(r31)
/* 8086D2DC  FC 40 08 90 */	fmr f2, f1
/* 8086D2E0  FC 60 08 90 */	fmr f3, f1
/* 8086D2E4  4B 79 FB 54 */	b scaleM__14mDoMtx_stack_cFfff
/* 8086D2E8  4B 79 F9 E0 */	b push__14mDoMtx_stack_cFv
/* 8086D2EC  C0 3D 00 80 */	lfs f1, 0x80(r29)
/* 8086D2F0  FC 40 08 90 */	fmr f2, f1
/* 8086D2F4  FC 60 08 90 */	fmr f3, f1
/* 8086D2F8  4B 79 FB 40 */	b scaleM__14mDoMtx_stack_cFfff
/* 8086D2FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D300  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D304  80 9F 40 28 */	lwz r4, 0x4028(r31)
/* 8086D308  38 84 00 24 */	addi r4, r4, 0x24
/* 8086D30C  4B AD 91 A4 */	b PSMTXCopy
/* 8086D310  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D314  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D318  38 9F 40 30 */	addi r4, r31, 0x4030
/* 8086D31C  4B AD 91 94 */	b PSMTXCopy
/* 8086D320  80 7F 40 2C */	lwz r3, 0x402c(r31)
/* 8086D324  4B 80 E6 9C */	b Move__4dBgWFv
/* 8086D328  4B 79 F9 EC */	b pop__14mDoMtx_stack_cFv
/* 8086D32C  3B 80 00 00 */	li r28, 0
/* 8086D330  3B 60 00 00 */	li r27, 0
/* 8086D334  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D338  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
lbl_8086D33C:
...
/* 8086D34C  4B 79 F9 7C */	b push__14mDoMtx_stack_cFv
...
/* 8086D36C  4B 79 FA 30 */	b transM__14mDoMtx_stack_cFfff
/* 8086D370  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D374  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D378  A8 9A 42 E0 */	lha r4, 0x42e0(r26)
/* 8086D37C  4B 79 F0 B8 */	b mDoMtx_YrotM__FPA4_fs
/* 8086D380  C0 3A 42 D4 */	lfs f1, 0x42d4(r26)
/* 8086D384  C0 5A 42 D8 */	lfs f2, 0x42d8(r26)
/* 8086D388  C0 7A 42 DC */	lfs f3, 0x42dc(r26)
/* 8086D38C  4B 79 FA AC */	b scaleM__14mDoMtx_stack_cFfff
/* 8086D390  4B 79 F9 38 */	b push__14mDoMtx_stack_cFv
/* 8086D394  C0 3D 00 80 */	lfs f1, 0x80(r29)
/* 8086D398  FC 40 08 90 */	fmr f2, f1
/* 8086D39C  FC 60 08 90 */	fmr f3, f1
/* 8086D3A0  4B 79 FA 98 */	b scaleM__14mDoMtx_stack_cFfff
/* 8086D3A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D3A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D3AC  80 9A 42 90 */	lwz r4, 0x4290(r26)
/* 8086D3B0  38 84 00 24 */	addi r4, r4, 0x24
/* 8086D3B4  4B AD 90 FC */	b PSMTXCopy
/* 8086D3B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D3BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D3C0  38 9A 42 94 */	addi r4, r26, 0x4294
/* 8086D3C4  4B AD 90 EC */	b PSMTXCopy
/* 8086D3C8  80 7A 42 F4 */	lwz r3, 0x42f4(r26)
/* 8086D3CC  4B 80 E5 F4 */	b Move__4dBgWFv
/* 8086D3D0  4B 79 F9 44 */	b pop__14mDoMtx_stack_cFv
...
/* 8086D410  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D414  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D418  38 81 00 08 */	addi r4, r1, 8
/* 8086D41C  3C A0 80 87 */	lis r5, BallStartPos@ha
/* 8086D420  38 A5 09 A4 */	addi r5, r5, BallStartPos@l
/* 8086D424  4B AD 99 48 */	b PSMTXMultVec
...
/* 8086D448  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086D44C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086D450  38 81 00 08 */	addi r4, r1, 8
/* 8086D454  3C A0 80 87 */	lis r5, BallEndPos@ha
/* 8086D458  38 A5 09 BC */	addi r5, r5, BallEndPos@l
/* 8086D45C  4B AD 99 10 */	b PSMTXMultVec
lbl_8086D460:
/* 8086D460  4B 79 F8 B4 */	b pop__14mDoMtx_stack_cFv
lbl_8086D464:
...
/* 8086D478  4B AF 4D A4 */	b _restgpr_26
