...
/* 8086C150  4B AF 60 8D */	bl _savegpr_29
/* 8086C154  3C A0 80 87 */	lis r5, lit_3829@ha /* 0x80870094@ha */
/* 8086C158  3B E5 00 94 */	addi r31, r5, lit_3829@l /* 0x80870094@l */
/* 8086C15C  2C 04 00 00 */	cmpwi r4, 0
/* 8086C160  40 82 00 98 */	bne lbl_8086C1F8
/* 8086C164  A0 83 00 14 */	lhz r4, 0x14(r3)
/* 8086C168  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8086C16C  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8086C18C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8086C190  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8086C194  80 84 00 00 */	lwz r4, 0(r4)
/* 8086C198  4B AD A3 19 */	bl PSMTXCopy
/* 8086C19C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8086C1A0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8086C1A4  80 63 00 00 */	lwz r3, 0(r3)
/* 8086C1A8  38 80 DD A0 */	li r4, -8800
/* 8086C1AC  4B 7A 02 89 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 8086C1C0  4B A0 4C E5 */	bl MtxScale__FfffUc
/* 8086C1C4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8086C1C8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8086C1DC  4B AD A2 D5 */	bl PSMTXCopy
/* 8086C1E0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8086C1E4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8086C1E8  80 63 00 00 */	lwz r3, 0(r3)
/* 8086C1EC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8086C1F0  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8086C1F4  4B AD A2 BD */	bl PSMTXCopy
lbl_8086C1F8:
/* 8086C1F8  38 60 00 01 */	li r3, 1
/* 8086C1FC  39 61 00 20 */	addi r11, r1, 0x20
/* 8086C200  4B AF 60 29 */	bl _restgpr_29
