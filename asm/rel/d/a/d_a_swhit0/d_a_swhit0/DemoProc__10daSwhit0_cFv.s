...
/* 804868C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804868C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804868C8  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 804868CC  7F E3 FB 78 */	mr r3, r31
/* 804868D0  80 9E 07 58 */	lwz r4, 0x758(r30)
/* 804868D4  4B BC 14 79 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 804868E8  3C A0 80 48 */	lis r5, action_table@ha /* 0x80487400@ha */
/* 804868EC  38 A5 74 00 */	addi r5, r5, action_table@l /* 0x80487400@l */
/* 804868F0  38 C0 00 02 */	li r6, 2
/* 804868F4  38 E0 00 00 */	li r7, 0
/* 804868F8  39 00 00 00 */	li r8, 0
/* 804868FC  4B BC 15 15 */	bl getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 80486918  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8048691C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80486920  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80486924  7C 05 07 74 */	extsb r5, r0
/* 80486928  4B BA EA 39 */	bl isSwitch__10dSv_info_cCFii
...
/* 80486950  4B BA 67 1D */	bl dComIfGp_getReverb__Fi
...
/* 80486964  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80486968  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8048697C  3D 00 80 48 */	lis r8, lit_3685@ha /* 0x80487370@ha */
/* 80486980  C0 28 73 70 */	lfs f1, lit_3685@l(r8)  /* 0x80487370@l */
/* 80486984  FC 40 08 90 */	fmr f2, f1
/* 80486988  3D 00 80 48 */	lis r8, lit_3982@ha /* 0x80487378@ha */
/* 8048698C  C0 68 73 78 */	lfs f3, lit_3982@l(r8)  /* 0x80487378@l */
/* 80486990  FC 80 18 90 */	fmr f4, f3
/* 80486994  39 00 00 00 */	li r8, 0
/* 80486998  4B E2 4F ED */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8048699C:
/* 8048699C  7F E3 FB 78 */	mr r3, r31
/* 804869A0  80 9E 07 58 */	lwz r4, 0x758(r30)
/* 804869A4  4B BC 17 D9 */	bl cutEnd__16dEvent_manager_cFi
