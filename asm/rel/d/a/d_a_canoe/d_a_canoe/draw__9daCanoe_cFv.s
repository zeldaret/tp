...
/* 804DD36C  4B E8 4E 71 */	bl _savegpr_29
/* 804DD370  7C 7E 1B 78 */	mr r30, r3
/* 804DD374  3C 60 80 4E */	lis r3, lit_3766@ha /* 0x804DD5DC@ha */
/* 804DD378  3B E3 D5 DC */	addi r31, r3, lit_3766@l /* 0x804DD5DC@l */
/* 804DD37C  38 00 00 01 */	li r0, 1
/* 804DD380  98 1E 14 44 */	stb r0, 0x1444(r30)
/* 804DD384  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804DD388  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804DD38C  38 80 00 00 */	li r4, 0
/* 804DD390  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 804DD394  38 DE 01 0C */	addi r6, r30, 0x10c
/* 804DD398  4B CC 64 2D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 804DD39C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804DD3A0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804DD3A4  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 804DD3A8  80 84 00 04 */	lwz r4, 4(r4)
/* 804DD3AC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 804DD3B0  4B CC 79 F1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804DD3B4  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 804DD3B8  4B B3 09 0D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 804DD3BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DD3C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804DD3C4  80 03 5F 74 */	lwz r0, 0x5f74(r3)
/* 804DD3C8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 804DD3CC  3B A3 4A C8 */	addi r29, r3, j3dSys@l /* 0x80434AC8@l */
/* 804DD3D0  90 1D 00 4C */	stw r0, 0x4c(r29)
/* 804DD3D4  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 804DD3D8  4B B3 08 ED */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 804DD3DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DD3E0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804DD3E4  80 04 5F 80 */	lwz r0, 0x5f80(r4)
/* 804DD3E8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 804DD3EC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 804DD424  4B C1 6A 95 */	bl checkCanoePaddleGrab__9daAlink_cCFP10fopAc_ac_c
...
/* 804DD438  4B C1 6A 81 */	bl checkCanoePaddleGrab__9daAlink_cCFP10fopAc_ac_c
/* 804DD43C  2C 03 00 00 */	cmpwi r3, 0
/* 804DD440  41 82 00 1C */	beq lbl_804DD45C
/* 804DD444  7F A3 EB 78 */	mr r3, r29
/* 804DD448  4B C1 69 B5 */	bl getCanoePaddleMatrix__9daAlink_cFv
/* 804DD44C  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 804DD450  38 84 00 24 */	addi r4, r4, 0x24
/* 804DD454  4B E6 90 5D */	bl PSMTXCopy
/* 804DD458  48 00 00 68 */	b lbl_804DD4C0
lbl_804DD45C:
/* 804DD45C  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 804DD460  38 63 00 24 */	addi r3, r3, 0x24
/* 804DD464  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804DD468  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804DD46C  4B E6 90 45 */	bl PSMTXCopy
...
/* 804DD490  4B B2 F9 0D */	bl transM__14mDoMtx_stack_cFfff
/* 804DD494  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804DD498  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804DD49C  38 80 FE 94 */	li r4, -364
/* 804DD4A0  38 A0 08 88 */	li r5, 0x888
/* 804DD4A4  38 C0 7D DD */	li r6, 0x7ddd
/* 804DD4A8  4B B2 EC BD */	bl mDoMtx_XYZrotM__FPA4_fsss
/* 804DD4AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804DD4B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804DD4B4  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 804DD4B8  38 84 00 24 */	addi r4, r4, 0x24
/* 804DD4BC  4B E6 8F F5 */	bl PSMTXCopy
lbl_804DD4C0:
/* 804DD4C0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804DD4C4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804DD4C8  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 804DD4CC  80 84 00 04 */	lwz r4, 4(r4)
/* 804DD4D0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 804DD4D4  4B CC 78 CD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804DD4D8  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 804DD4DC  4B B3 07 E9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_804DD4E0:
...
/* 804DD510  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 804DD514  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 804DD518  4B B5 13 F9 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 804DD51C  90 7E 14 74 */	stw r3, 0x1474(r30)
/* 804DD520  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DD524  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804DD528  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 804DD52C  80 9E 14 74 */	lwz r4, 0x1474(r30)
/* 804DD530  80 BE 05 74 */	lwz r5, 0x574(r30)
/* 804DD534  4B B7 89 E9 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
/* 804DD538  38 60 00 01 */	li r3, 1
/* 804DD53C  39 61 00 20 */	addi r11, r1, 0x20
/* 804DD540  4B E8 4C E9 */	bl _restgpr_29
