...
/* 804DAED0  4B B5 21 39 */	bl dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 804DAED4  38 7E 14 1C */	addi r3, r30, 0x141c
/* 804DAED8  4B DE 31 21 */	bl deleteObject__14Z2SoundObjBaseFv
/* 804DAEDC  34 1E 14 1C */	addic. r0, r30, 0x141c
/* 804DAEE0  41 82 00 1C */	beq lbl_804DAEFC
/* 804DAEE4  3C 60 80 3D */	lis r3, __vt__16Z2SoundObjSimple@ha /* 0x803CAD10@ha */
/* 804DAEE8  38 03 AD 10 */	addi r0, r3, __vt__16Z2SoundObjSimple@l /* 0x803CAD10@l */
/* 804DAEEC  90 1E 14 2C */	stw r0, 0x142c(r30)
/* 804DAEF0  38 7E 14 1C */	addi r3, r30, 0x141c
/* 804DAEF4  38 80 00 00 */	li r4, 0
/* 804DAEF8  4B DE 30 51 */	bl __dt__14Z2SoundObjBaseFv
lbl_804DAEFC:
/* 804DAEFC  38 7E 13 AC */	addi r3, r30, 0x13ac
/* 804DAF00  38 80 FF FF */	li r4, -1
/* 804DAF04  4B B9 D1 89 */	bl __dt__15dBgS_LinkLinChkFv
/* 804DAF08  38 7E 0D 80 */	addi r3, r30, 0xd80
/* 804DAF0C  3C 80 80 4E */	lis r4, __dt__8dCcD_CylFv@ha /* 0x804DAB18@ha */
/* 804DAF10  38 84 AB 18 */	addi r4, r4, __dt__8dCcD_CylFv@l /* 0x804DAB18@l */
/* 804DAF14  38 A0 01 3C */	li r5, 0x13c
/* 804DAF18  38 C0 00 05 */	li r6, 5
/* 804DAF1C  4B E8 6D CD */	bl __destroy_arr
/* 804DAF20  38 7E 07 F8 */	addi r3, r30, 0x7f8
/* 804DAF24  3C 80 80 4E */	lis r4, __dt__13dBgS_LinkAcchFv@ha /* 0x804DACF8@ha */
/* 804DAF28  38 84 AC F8 */	addi r4, r4, __dt__13dBgS_LinkAcchFv@l /* 0x804DACF8@l */
/* 804DAF2C  38 A0 01 D8 */	li r5, 0x1d8
/* 804DAF30  38 C0 00 03 */	li r6, 3
/* 804DAF34  4B E8 6D B5 */	bl __destroy_arr
/* 804DAF38  38 7E 05 B8 */	addi r3, r30, 0x5b8
/* 804DAF3C  3C 80 80 4E */	lis r4, __dt__12dBgS_AcchCirFv@ha /* 0x804DADBC@ha */
/* 804DAF40  38 84 AD BC */	addi r4, r4, __dt__12dBgS_AcchCirFv@l /* 0x804DADBC@l */
/* 804DAF44  38 A0 00 40 */	li r5, 0x40
/* 804DAF48  38 C0 00 09 */	li r6, 9
/* 804DAF4C  4B E8 6D 9D */	bl __destroy_arr
/* 804DAF50  34 1E 05 7C */	addic. r0, r30, 0x57c
/* 804DAF54  41 82 00 54 */	beq lbl_804DAFA8
/* 804DAF58  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 804DAF5C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 804DAF74  3C 60 80 4E */	lis r3, __vt__10dCcD_GStts@ha /* 0x804DD79C@ha */
/* 804DAF78  38 03 D7 9C */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x804DD79C@l */
/* 804DAF7C  90 1E 05 98 */	stw r0, 0x598(r30)
/* 804DAF80  34 1E 05 98 */	addic. r0, r30, 0x598
/* 804DAF84  41 82 00 10 */	beq lbl_804DAF94
/* 804DAF88  3C 60 80 4E */	lis r3, __vt__10cCcD_GStts@ha /* 0x804DD790@ha */
/* 804DAF8C  38 03 D7 90 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x804DD790@l */
/* 804DAF90  90 1E 05 98 */	stw r0, 0x598(r30)
lbl_804DAF94:
/* 804DAF94  34 1E 05 7C */	addic. r0, r30, 0x57c
/* 804DAF98  41 82 00 10 */	beq lbl_804DAFA8
/* 804DAF9C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 804DAFA0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 804DAFA4  90 1E 05 94 */	stw r0, 0x594(r30)
lbl_804DAFA8:
/* 804DAFA8  7F C3 F3 78 */	mr r3, r30
/* 804DAFAC  38 80 00 00 */	li r4, 0
/* 804DAFB0  4B B3 DC DD */	bl __dt__10fopAc_ac_cFv
/* 804DAFB4  7F E0 07 35 */	extsh. r0, r31
/* 804DAFB8  40 81 00 0C */	ble lbl_804DAFC4
/* 804DAFBC  7F C3 F3 78 */	mr r3, r30
/* 804DAFC0  4B DF 3D 7D */	bl __dl__FPv
lbl_804DAFC4:
