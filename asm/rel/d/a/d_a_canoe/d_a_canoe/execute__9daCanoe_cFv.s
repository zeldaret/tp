...
/* 804DC7CC  4B E8 5A 01 */	bl _savegpr_25
/* 804DC7D0  7C 7B 1B 78 */	mr r27, r3
/* 804DC7D4  3C 60 80 4E */	lis r3, lit_1109@ha /* 0x804DD7F8@ha */
/* 804DC7D8  3B C3 D7 F8 */	addi r30, r3, lit_1109@l /* 0x804DD7F8@l */
/* 804DC7DC  3C 60 80 4E */	lis r3, lit_3766@ha /* 0x804DD5DC@ha */
/* 804DC7E0  3B E3 D5 DC */	addi r31, r3, lit_3766@l /* 0x804DD5DC@l */
/* 804DC7E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DC7E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804DC840  4B C1 74 05 */	bl getCanoeMaxRotSpeed__9daAlink_cCFv
...
/* 804DC8A0  4B E6 A8 99 */	bl PSVECSquareMag
...
/* 804DC8EC  4B D9 3D 1D */	bl cLib_addCalcAngleS2__FPssss
lbl_804DC8F0:
...
/* 804DC904  4B D9 3C 3D */	bl cLib_addCalcAngleS__FPsssss
...
/* 804DC95C  4B D8 AC 89 */	bl cM_rad2s__Ff
/* 804DC960  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 804DC964  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804DC968  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804DCAB4  4B C8 1F 6D */	bl checkFishingRodItem__9daPy_py_cFi
...
/* 804DCB1C  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804DCB20  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804DCB64  4B D8 AD F1 */	bl cM_rndF__Ff
...
/* 804DCC64  4B C8 1D BD */	bl checkFishingRodItem__9daPy_py_cFi
...
/* 804DCD24  4B C8 1C FD */	bl checkFishingRodItem__9daPy_py_cFi
...
/* 804DCD7C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804DCD80  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804DCEDC  4B C1 6D 11 */	bl getCanoeCres__9daAlink_cCFv
...
/* 804DCEF4  4B D9 2A 89 */	bl cLib_addCalc__FPfffff
/* 804DCEF8  7F A3 EB 78 */	mr r3, r29
/* 804DCEFC  4B C1 6C B5 */	bl getCanoeMaxSpeed__9daAlink_cCFv
...
/* 804DCF10  4B C1 6C A1 */	bl getCanoeMaxSpeed__9daAlink_cCFv
/* 804DCF14  D0 3B 05 2C */	stfs f1, 0x52c(r27)
/* 804DCF18  48 00 00 2C */	b lbl_804DCF44
lbl_804DCF1C:
/* 804DCF1C  7F A3 EB 78 */	mr r3, r29
/* 804DCF20  4B C1 6C BD */	bl getCanoeBackMaxSpeed__9daAlink_cCFv
...
/* 804DCF38  4B C1 6C A5 */	bl getCanoeBackMaxSpeed__9daAlink_cCFv
...
/* 804DCF58  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DCF5C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804DCF60  38 84 0F 38 */	addi r4, r4, 0xf38
/* 804DCF64  4B B9 9B 49 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 804DCF88  3C 80 80 4E */	lis r4, __dt__4cXyzFv@ha /* 0x804DA5B8@ha */
/* 804DCF8C  38 84 A5 B8 */	addi r4, r4, __dt__4cXyzFv@l /* 0x804DA5B8@l */
...
/* 804DCFCC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DCFD0  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804DCFD4  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)
/* 804DCFD8  38 63 02 10 */	addi r3, r3, 0x210
/* 804DCFDC  80 9B 14 88 */	lwz r4, 0x1488(r27)
/* 804DCFE0  4B B6 E9 39 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 804DCFF8  4B B6 E9 21 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 804DD018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804DD01C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804DD038  4B B6 F8 01 */	bl setWaterRipple__13dPa_control_cFPUlR13cBgS_PolyInfoPC4cXyzfPC12dKy_tevstr_cPC4cXyzSc
lbl_804DD03C:
...
/* 804DD0C8  4B B4 0C BD */	bl waterCheck__11fopAcM_wt_cFPC4cXyz
/* 804DD0CC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804DD0D0  41 82 00 10 */	beq lbl_804DD0E0
/* 804DD0D4  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha /* 0x80450CD8@ha */
/* 804DD0D8  C0 03 0C D8 */	lfs f0, mWaterY__11fopAcM_wt_c@l(r3)  /* 0x80450CD8@l */
/* 804DD0DC  D0 01 00 34 */	stfs f0, 0x34(r1)
lbl_804DD0E0:
/* 804DD0E0  38 61 00 24 */	addi r3, r1, 0x24
/* 804DD0E4  4B B4 0C A1 */	bl waterCheck__11fopAcM_wt_cFPC4cXyz
/* 804DD0E8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804DD0EC  41 82 00 10 */	beq lbl_804DD0FC
/* 804DD0F0  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha /* 0x80450CD8@ha */
/* 804DD0F4  C0 03 0C D8 */	lfs f0, mWaterY__11fopAcM_wt_c@l(r3)  /* 0x80450CD8@l */
...
/* 804DD108  4B E6 9F AD */	bl PSVECSubtract
/* 804DD10C  38 61 00 30 */	addi r3, r1, 0x30
/* 804DD110  4B D8 A0 41 */	bl atan2sY_XZ__4cXyzCFv
...
/* 804DD264  4B E6 9E D5 */	bl PSVECSquareMag
...
/* 804DD278  4B C8 17 A9 */	bl checkFishingRodItem__9daPy_py_cFi
...
/* 804DD328  4B E8 4E F1 */	bl _restgpr_25
