...
/* 80D4E6D8  4B 61 3A F5 */	bl _savegpr_25
/* 80D4E6DC  7C 7B 1B 78 */	mr r27, r3
/* 80D4E6E0  3C 60 80 D5 */	lis r3, lit_3718@ha /* 0x80D4E998@ha */
/* 80D4E6E4  3B E3 E9 98 */	addi r31, r3, lit_3718@l /* 0x80D4E998@l */
/* 80D4E6E8  80 1B 00 B0 */	lwz r0, 0xb0(r27)
/* 80D4E6EC  54 00 27 BF */	rlwinm. r0, r0, 4, 0x1e, 0x1f
/* 80D4E6F0  40 82 02 04 */	bne lbl_80D4E8F4
/* 80D4E6F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D4E6F8  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D4E6FC  83 9A 5D AC */	lwz r28, 0x5dac(r26)
/* 80D4E700  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 80D4E704  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 80D4E708  4B 52 24 FD */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80D4E720  4B 2C C2 45 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80D4E750  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80D4E754  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80D4E758  38 81 00 0C */	addi r4, r1, 0xc
/* 80D4E75C  4B 2C B0 9D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 80D4E760  7C 7A 1B 79 */	or. r26, r3, r3
/* 80D4E764  41 82 00 40 */	beq lbl_80D4E7A4
/* 80D4E768  4B 2C A5 79 */	bl fopAc_IsActor__FPv
...
/* 80D4E7C4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80D4E7C8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 80D4E7CC  38 81 00 08 */	addi r4, r1, 8
/* 80D4E7D0  4B 2C B0 29 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80D4E8F8  4B 61 39 21 */	bl _restgpr_25
