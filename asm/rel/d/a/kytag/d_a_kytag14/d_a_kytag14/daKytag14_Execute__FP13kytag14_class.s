...
/* 805299B0  4B E3 88 25 */	bl _savegpr_27
...
/* 805299C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805299CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805299D0  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 805299D4  38 80 13 01 */	li r4, 0x1301
/* 805299D8  4B B0 AF E5 */	bl isEventBit__11dSv_event_cCFUs
...
/* 805299F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805299FC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80529A00  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80529A04  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 80529A08  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80529A0C  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80529A10  7C 84 02 2E */	lhzx r4, r4, r0
/* 80529A14  4B B0 AF A9 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80529A38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80529A3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80529A40  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80529A44  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 80529A48  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80529A4C  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80529A50  7C 84 02 2E */	lhzx r4, r4, r0
/* 80529A54  4B B0 AF 69 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80529A78  3C 60 80 45 */	lis r3, mStayNo__20dStage_roomControl_c+0x0@ha /* 0x80450D64@ha */
/* 80529A7C  88 A3 0D 64 */	lbz r5, mStayNo__20dStage_roomControl_c+0x0@l(r3)  /* 0x80450D64@l */
/* 80529A80  7C A5 07 74 */	extsb r5, r5
/* 80529A84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80529A88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80529A8C  4B B0 B8 D5 */	bl isSwitch__10dSv_info_cCFii
...
/* 80529AB0  3C 60 80 45 */	lis r3, mStayNo__20dStage_roomControl_c+0x0@ha /* 0x80450D64@ha */
/* 80529AB4  88 A3 0D 64 */	lbz r5, mStayNo__20dStage_roomControl_c+0x0@l(r3)  /* 0x80450D64@l */
/* 80529AB8  7C A5 07 74 */	extsb r5, r5
/* 80529ABC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80529AC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80529AC4  4B B0 B8 9D */	bl isSwitch__10dSv_info_cCFii
...
/* 80529AFC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80529B00  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80529B14  4B B0 92 09 */	bl set__25dSv_player_return_place_cFPCcScUc
lbl_80529B18:
/* 80529B18  38 60 00 01 */	li r3, 1
lbl_80529B1C:
/* 80529B1C  39 61 00 20 */	addi r11, r1, 0x20
/* 80529B20  4B E3 87 01 */	bl _restgpr_27
