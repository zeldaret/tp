...
/* 8084D140  4B A2 35 1D */	bl cLib_chaseUC__FPUcUcUc
lbl_8084D144:
/* 8084D144  88 1E 06 DF */	lbz r0, 0x6df(r30)
/* 8084D148  28 00 00 00 */	cmplwi r0, 0
/* 8084D14C  40 82 01 F0 */	bne lbl_8084D33C
/* 8084D150  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D154  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8084D17C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D180  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8084D1D0  4B 80 45 E1 */	bl dPath_GetPnt__FPC5dPathi
...
/* 8084D220  4B 80 45 91 */	bl dPath_GetPnt__FPC5dPathi
...
/* 8084D244  4B A2 39 C1 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8084D298  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D29C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084D2A0  38 63 09 58 */	addi r3, r3, 0x958
/* 8084D2A4  38 80 00 09 */	li r4, 9
/* 8084D2A8  4B 7E 75 B9 */	bl isSwitch__12dSv_memBit_cCFi
