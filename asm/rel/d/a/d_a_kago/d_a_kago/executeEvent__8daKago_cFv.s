...
/* 8084DC0C  4B B1 45 D1 */	bl _savegpr_29
/* 8084DC10  7C 7D 1B 78 */	mr r29, r3
/* 8084DC14  4B 93 3A 2D */	bl dCam_getBody__Fv
...
/* 8084DC2C  4B 7D ED 51 */	bl getLayerNo__14dComIfG_play_cFi
/* 8084DC30  2C 03 00 0D */	cmpwi r3, 0xd
/* 8084DC34  40 82 00 44 */	bne lbl_8084DC78
/* 8084DC38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084DC3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084DC40  3B E3 09 58 */	addi r31, r3, 0x958
/* 8084DC44  7F E3 FB 78 */	mr r3, r31
/* 8084DC48  38 80 00 10 */	li r4, 0x10
/* 8084DC4C  4B 7E 6C 15 */	bl isSwitch__12dSv_memBit_cCFi
...
/* 8084DC60  4B 7E 6B B1 */	bl onSwitch__12dSv_memBit_cFi
...
/* 8084DC98  4B 7C DC 71 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 8084DCB0  4B 91 38 21 */	bl Stop__9dCamera_cFv
/* 8084DCB4  7F C3 F3 78 */	mr r3, r30
/* 8084DCB8  38 80 00 03 */	li r4, 3
/* 8084DCBC  4B 91 53 51 */	bl SetTrimSize__9dCamera_cFl
...
/* 8084DCEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084DCF0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084DCF4  38 63 09 58 */	addi r3, r3, 0x958
/* 8084DCF8  38 80 00 08 */	li r4, 8
/* 8084DCFC  4B 7E 6B 15 */	bl onSwitch__12dSv_memBit_cFi
lbl_8084DD00:
/* 8084DD00  39 61 00 20 */	addi r11, r1, 0x20
/* 8084DD04  4B B1 45 25 */	bl _restgpr_29
