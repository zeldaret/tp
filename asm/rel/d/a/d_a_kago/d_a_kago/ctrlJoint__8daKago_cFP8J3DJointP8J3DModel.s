...
/* 80854230  4B B0 DF A8 */	b _savegpr_28
...
/* 80854250  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80854254  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80854258  4B AF 22 58 */	b PSMTXCopy
...
lbl_80854274:
/* 80854274  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80854278  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8085427C  A8 9C 07 1A */	lha r4, 0x71a(r28)
/* 80854280  4B 7B 81 B4 */	b mDoMtx_YrotM__FPA4_fs
/* 80854284  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80854288  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8085428C  A8 9C 07 18 */	lha r4, 0x718(r28)
/* 80854290  4B 7B 82 3C */	b mDoMtx_ZrotM__FPA4_fs
lbl_80854294:
/* 80854294  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80854298  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8085429C  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 808542A0  80 04 00 0C */	lwz r0, 0xc(r4)
/* 808542A4  7C 80 F2 14 */	add r4, r0, r30
/* 808542A8  4B AF 22 08 */	b PSMTXCopy
/* 808542AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 808542B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 808542B4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 808542B8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 808542BC  4B AF 21 F4 */	b PSMTXCopy
/* 808542C0  38 60 00 01 */	li r3, 1
/* 808542C4  39 61 00 20 */	addi r11, r1, 0x20
/* 808542C8  4B B0 DF 5C */	b _restgpr_28
