...
/* 8084D51C  4B B1 4C C1 */	bl _savegpr_29
/* 8084D520  7C 7E 1B 78 */	mr r30, r3
/* 8084D524  3C 60 80 85 */	lis r3, lit_3929@ha /* 0x80854B04@ha */
/* 8084D528  3B E3 4B 04 */	addi r31, r3, lit_3929@l /* 0x80854B04@l */
...
/* 8084D544  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D548  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8084D560  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D564  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_8084D5D8:
/* 8084D5D8  3C 60 80 85 */	lis r3, l_HIO@ha /* 0x80854F78@ha */
/* 8084D5DC  38 63 4F 78 */	addi r3, r3, l_HIO@l /* 0x80854F78@l */
...
/* 8084D62C  3C C0 80 85 */	lis r6, l_HIO@ha /* 0x80854F78@ha */
/* 8084D630  38 C6 4F 78 */	addi r6, r6, l_HIO@l /* 0x80854F78@l */
...
/* 8084D650  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D654  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8084D668  4B 82 23 BD */	bl StartShock__12dVibration_cFii4cXyz
...
/* 8084D67C  4B 82 61 69 */	bl LockonTruth__12dAttention_cFv
...
/* 8084D690  4B 82 5E AD */	bl LockonTarget__12dAttention_cFl
...
/* 8084D6A4  4B FC 4D 21 */	bl setLockByCargo__8daE_YM_cFv
...
/* 8084D6D4  3C 80 80 85 */	lis r4, l_HIO@ha /* 0x80854F78@ha */
/* 8084D6D8  38 84 4F 78 */	addi r4, r4, l_HIO@l /* 0x80854F78@l */
/* 8084D6DC  C0 04 00 38 */	lfs f0, 0x38(r4)
/* 8084D6E0  EC 42 00 32 */	fmuls f2, f2, f0
/* 8084D6E4  4B A2 30 5D */	bl cLib_chaseF__FPfff
/* 8084D6E8  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 8084D6EC  38 63 00 0C */	addi r3, r3, 0xc
/* 8084D6F0  C0 3F 00 F8 */	lfs f1, 0xf8(r31)
/* 8084D6F4  4B AD AD 39 */	bl checkPass__12J3DFrameCtrlFf
...
/* 8084D774  4B AD AC B9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 8084D7A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D7A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8084D7C0  4B 82 22 65 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 8084D7E8  4B 82 23 29 */	bl StartQuake__12dVibration_cFii4cXyz
/* 8084D7EC  3C 60 80 85 */	lis r3, l_HIO@ha /* 0x80854F78@ha */
/* 8084D7F0  38 63 4F 78 */	addi r3, r3, l_HIO@l /* 0x80854F78@l */
...
/* 8084D830  4B AD AB FD */	bl checkPass__12J3DFrameCtrlFf
...
/* 8084D868  4B A2 2E D9 */	bl cLib_chaseF__FPfff
...
/* 8084D8A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D8A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084D8A8  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8084D8AC  38 80 00 1F */	li r4, 0x1f
/* 8084D8B0  4B 82 24 E5 */	bl StopQuake__12dVibration_cFi
...
/* 8084D90C  4B A2 2E 35 */	bl cLib_chaseF__FPfff
...
/* 8084D924  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D928  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084D92C  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8084D930  38 80 00 1F */	li r4, 0x1f
/* 8084D934  4B 82 24 61 */	bl StopQuake__12dVibration_cFi
...
/* 8084D964  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084D968  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084D96C  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8084D970  38 80 00 1F */	li r4, 0x1f
/* 8084D974  4B 82 24 21 */	bl StopQuake__12dVibration_cFi
...
/* 8084D99C  3C 80 80 85 */	lis r4, l_HIO@ha /* 0x80854F78@ha */
/* 8084D9A0  3B A4 4F 78 */	addi r29, r4, l_HIO@l /* 0x80854F78@l */
/* 8084D9A4  C0 3D 00 1C */	lfs f1, 0x1c(r29)
/* 8084D9A8  C0 5F 00 1C */	lfs f2, 0x1c(r31)
/* 8084D9AC  4B A2 2D 95 */	bl cLib_chaseF__FPfff
...
/* 8084DA04  4B B1 48 25 */	bl _restgpr_29
