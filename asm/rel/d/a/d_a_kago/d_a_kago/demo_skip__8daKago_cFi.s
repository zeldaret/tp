...
/* 8084A6F4  4B B1 7A E5 */	bl _savegpr_28
/* 8084A6F8  7C 7F 1B 78 */	mr r31, r3
/* 8084A6FC  7C 9C 23 78 */	mr r28, r4
/* 8084A700  3C 60 80 85 */	lis r3, lit_3929@ha /* 0x80854B04@ha */
/* 8084A704  3B C3 4B 04 */	addi r30, r3, lit_3929@l /* 0x80854B04@l */
/* 8084A708  4B 93 6F 39 */	bl dCam_getBody__Fv
/* 8084A70C  7C 7D 1B 78 */	mr r29, r3
/* 8084A710  28 1C 00 0A */	cmplwi r28, 0xa
/* 8084A714  41 81 03 38 */	bgt lbl_8084AA4C
/* 8084A718  3C 60 80 85 */	lis r3, lit_4496@ha /* 0x80854DC8@ha */
/* 8084A71C  38 63 4D C8 */	addi r3, r3, lit_4496@l /* 0x80854DC8@l */
...
/* 8084A754  4B 9F FD 71 */	bl remove__10dMsgFlow_cFv
lbl_8084A758:
...
/* 8084A774  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084A778  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084A77C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 8084A780  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 8084A784  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 8084A788  A0 84 00 A8 */	lhz r4, 0xa8(r4)
/* 8084A78C  4B 7E A2 01 */	bl onEventBit__11dSv_event_cFUs
...
/* 8084A848  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084A84C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8084A8D8  4B 93 62 09 */	bl Set__9dCamera_cF4cXyz4cXyzfs
/* 8084A8DC  7F A3 EB 78 */	mr r3, r29
/* 8084A8E0  4B 93 63 89 */	bl Reset__9dCamera_cFv
/* 8084A8E4  7F A3 EB 78 */	mr r3, r29
/* 8084A8E8  4B 91 6B C5 */	bl Start__9dCamera_cFv
/* 8084A8EC  7F A3 EB 78 */	mr r3, r29
/* 8084A8F0  38 80 00 00 */	li r4, 0
/* 8084A8F4  4B 91 87 19 */	bl SetTrimSize__9dCamera_cFl
/* 8084A8F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084A8FC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084A900  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8084A904  4B 7F 7B 65 */	bl reset__14dEvt_control_cFv
/* 8084A908  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8084A90C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 8084A910  80 63 00 00 */	lwz r3, 0(r3)
/* 8084A914  38 63 04 C4 */	addi r3, r3, 0x4c4
/* 8084A918  38 80 00 00 */	li r4, 0
/* 8084A91C  4B A6 B8 CD */	bl setDemoName__11Z2StatusMgrFPc
...
/* 8084A974  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084A978  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8084AA04  4B 93 60 DD */	bl Set__9dCamera_cF4cXyz4cXyzfs
/* 8084AA08  7F A3 EB 78 */	mr r3, r29
/* 8084AA0C  4B 93 62 5D */	bl Reset__9dCamera_cFv
/* 8084AA10  7F A3 EB 78 */	mr r3, r29
/* 8084AA14  4B 91 6A 99 */	bl Start__9dCamera_cFv
/* 8084AA18  7F A3 EB 78 */	mr r3, r29
/* 8084AA1C  38 80 00 00 */	li r4, 0
/* 8084AA20  4B 91 85 ED */	bl SetTrimSize__9dCamera_cFl
/* 8084AA24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084AA28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084AA2C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8084AA30  4B 7F 7A 39 */	bl reset__14dEvt_control_cFv
/* 8084AA34  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8084AA38  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 8084AA3C  80 63 00 00 */	lwz r3, 0(r3)
/* 8084AA40  38 63 04 C4 */	addi r3, r3, 0x4c4
/* 8084AA44  38 80 00 00 */	li r4, 0
/* 8084AA48  4B A6 B7 A1 */	bl setDemoName__11Z2StatusMgrFPc
lbl_8084AA4C:
/* 8084AA4C  39 61 00 50 */	addi r11, r1, 0x50
/* 8084AA50  4B B1 77 D5 */	bl _restgpr_28
