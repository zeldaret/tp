...
/* 80849808  4B B1 89 D1 */	bl _savegpr_28
/* 8084980C  7C 7E 1B 78 */	mr r30, r3
/* 80849810  3C 60 80 85 */	lis r3, lit_3929@ha /* 0x80854B04@ha */
/* 80849814  3B E3 4B 04 */	addi r31, r3, lit_3929@l /* 0x80854B04@l */
...
lbl_8084982C:
/* 8084982C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80849830  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80849834  38 80 00 02 */	li r4, 2
/* 80849838  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 8084983C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80849840  4B 95 9F 85 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80849844  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80849848  83 83 00 04 */	lwz r28, 4(r3)
/* 8084984C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80849850  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80849854  80 9C 00 04 */	lwz r4, 4(r28)
/* 80849858  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8084985C  4B 95 B5 45 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80849860  7F C3 F3 78 */	mr r3, r30
/* 80849864  80 9C 00 04 */	lwz r4, 4(r28)
/* 80849868  4B 7D 3B C5 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 8084986C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80849870  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80849874  80 04 5F 88 */	lwz r0, 0x5f88(r4)
/* 80849878  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8084987C  3B A3 4A C8 */	addi r29, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80849890  4B 7C 79 31 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 80849894  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80849898  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 808498F8  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 808498FC  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80849900  4B 7E 50 11 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 80849904  90 7E 07 64 */	stw r3, 0x764(r30)
/* 80849908  38 60 00 01 */	li r3, 1
lbl_8084990C:
/* 8084990C  39 61 00 30 */	addi r11, r1, 0x30
/* 80849910  4B B1 89 15 */	bl _restgpr_28
