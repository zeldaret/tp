...
/* 8084C1C8  3C C0 80 85 */	lis r6, lit_3943@ha /* 0x80854B3C@ha */
/* 8084C1CC  C0 26 4B 3C */	lfs f1, lit_3943@l(r6)  /* 0x80854B3C@l */
/* 8084C1D0  3C C0 80 85 */	lis r6, lit_3932@ha /* 0x80854B10@ha */
/* 8084C1D4  C0 46 4B 10 */	lfs f2, lit_3932@l(r6)  /* 0x80854B10@l */
/* 8084C1D8  4B FF D5 19 */	bl setBck__8daKago_cFiUcff
lbl_8084C1DC:
/* 8084C1DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8084C1E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8084C1E4  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8084C1E8  38 80 00 1F */	li r4, 0x1f
/* 8084C1EC  4B 82 3B A9 */	bl StopQuake__12dVibration_cFi
