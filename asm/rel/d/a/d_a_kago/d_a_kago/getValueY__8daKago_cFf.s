...
/* 8084B604  3C 60 80 85 */	lis r3, lit_3941@ha
/* 8084B608  C0 03 4B 34 */	lfs f0, lit_3941@l(r3)
...
lbl_8084B628:
/* 8084B628  3C 60 80 85 */	lis r3, lit_3941@ha
/* 8084B62C  C0 23 4B 34 */	lfs f1, lit_3941@l(r3)
/* 8084B630  EC 01 10 28 */	fsubs f0, f1, f2
/* 8084B634  EC 40 08 24 */	fdivs f2, f0, f1
/* 8084B638  7C A0 07 34 */	extsh r0, r5
/* 8084B63C  3C 60 80 85 */	lis r3, lit_4923@ha
/* 8084B640  C8 23 4B D4 */	lfd f1, lit_4923@l(r3)
...
/* 8084B67C  3C 80 80 85 */	lis r4, lit_3941@ha
/* 8084B680  C0 24 4B 34 */	lfs f1, lit_3941@l(r4)
...
lbl_8084B6A4:
/* 8084B6A4  3C 60 80 85 */	lis r3, lit_3941@ha
/* 8084B6A8  C0 23 4B 34 */	lfs f1, lit_3941@l(r3)
/* 8084B6AC  EC 01 00 28 */	fsubs f0, f1, f0
/* 8084B6B0  EC 40 08 24 */	fdivs f2, f0, f1
/* 8084B6B4  7C A0 07 34 */	extsh r0, r5
/* 8084B6B8  3C 60 80 85 */	lis r3, lit_4923@ha
/* 8084B6BC  C8 23 4B D4 */	lfd f1, lit_4923@l(r3)
