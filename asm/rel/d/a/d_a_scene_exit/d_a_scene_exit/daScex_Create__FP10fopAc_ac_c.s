...
/* 8048599C  4B B9 31 C8 */	b __ct__10fopAc_ac_cFv
lbl_804859A0:
/* 804859A0  80 1F 04 A0 */	lwz r0, 0x4a0(r31)
/* 804859A4  60 00 00 08 */	ori r0, r0, 8
/* 804859A8  90 1F 04 A0 */	stw r0, 0x4a0(r31)
lbl_804859AC:
/* 804859AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804859B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804859B4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 804859B8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 804859BC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 804859C0  4B EC 0F 28 */	b PSMTXTrans
/* 804859C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804859C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804859CC  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 804859D0  4B B8 6A 64 */	b mDoMtx_YrotM__FPA4_fs
/* 804859D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804859D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804859DC  38 9F 05 68 */	addi r4, r31, 0x568
/* 804859E0  4B EC 0B D0 */	b PSMTXInverse
/* 804859E4  C0 1F 04 EC */	lfs f0, 0x4ec(r31)
/* 804859E8  3C 60 80 48 */	lis r3, lit_3758@ha
/* 804859EC  C0 23 5C 98 */	lfs f1, lit_3758@l(r3)
...
/* 80485A08  3C 60 80 48 */	lis r3, lit_3759@ha
/* 80485A0C  C0 03 5C 9C */	lfs f0, lit_3759@l(r3)
