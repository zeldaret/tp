...
/* 804FFB7C  4B E6 26 59 */	bl _savegpr_27
/* 804FFB80  7C 7F 1B 78 */	mr r31, r3
/* 804FFB84  38 60 00 58 */	li r3, 0x58
/* 804FFB88  4B DC F0 C5 */	bl __nw__FUl
/* 804FFB8C  7C 7E 1B 79 */	or. r30, r3, r3
/* 804FFB90  41 82 00 94 */	beq lbl_804FFC24
/* 804FFB94  3C 60 80 50 */	lis r3, d_a_e_hb__stringBase0@ha /* 0x80500C34@ha */
/* 804FFB98  38 63 0C 34 */	addi r3, r3, d_a_e_hb__stringBase0@l /* 0x80500C34@l */
/* 804FFB9C  38 80 00 12 */	li r4, 0x12
/* 804FFBA0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FFBA4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804FFBB8  4B B3 C7 35 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 804FFBBC  7C 7D 1B 78 */	mr r29, r3
/* 804FFBC0  3C 60 80 50 */	lis r3, d_a_e_hb__stringBase0@ha /* 0x80500C34@ha */
/* 804FFBC4  38 63 0C 34 */	addi r3, r3, d_a_e_hb__stringBase0@l /* 0x80500C34@l */
/* 804FFBC8  38 80 00 17 */	li r4, 0x17
/* 804FFBCC  7F 85 E3 78 */	mr r5, r28
/* 804FFBD0  38 C0 00 80 */	li r6, 0x80
/* 804FFBD4  4B B3 C7 19 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804FFC0C  3D 20 80 50 */	lis r9, lit_3790@ha /* 0x80500B0C@ha */
/* 804FFC10  C0 29 0B 0C */	lfs f1, lit_3790@l(r9)  /* 0x80500B0C@l */
/* 804FFC14  39 20 00 00 */	li r9, 0
/* 804FFC18  39 40 FF FF */	li r10, -1
/* 804FFC1C  4B B1 0B B5 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
lbl_804FFC48:
/* 804FFC48  3C 60 80 50 */	lis r3, d_a_e_hb__stringBase0@ha /* 0x80500C34@ha */
/* 804FFC4C  38 63 0C 34 */	addi r3, r3, d_a_e_hb__stringBase0@l /* 0x80500C34@l */
/* 804FFC50  38 80 00 1D */	li r4, 0x1d
/* 804FFC54  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FFC58  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804FFC6C  4B B3 C6 81 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804FFC84  4B B1 36 DD */	bl init__19mDoExt_3DlineMat1_cFUsUsP7ResTIMGi
...
/* 804FFCA0  3C 60 80 50 */	lis r3, lit_4108@ha /* 0x80500B6C@ha */
/* 804FFCA4  C0 03 0B 6C */	lfs f0, lit_4108@l(r3)  /* 0x80500B6C@l */
...
/* 804FFCBC  3C 60 80 50 */	lis r3, d_a_e_hb__stringBase0@ha /* 0x80500C34@ha */
/* 804FFCC0  38 63 0C 34 */	addi r3, r3, d_a_e_hb__stringBase0@l /* 0x80500C34@l */
/* 804FFCC4  38 80 00 19 */	li r4, 0x19
/* 804FFCC8  7F 85 E3 78 */	mr r5, r28
/* 804FFCCC  38 C0 00 80 */	li r6, 0x80
/* 804FFCD0  4B B3 C6 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804FFCF8  4B B1 4F 5D */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_804FFD18:
/* 804FFD18  3C 60 80 50 */	lis r3, lit_3790@ha /* 0x80500B0C@ha */
/* 804FFD1C  C0 23 0B 0C */	lfs f1, lit_3790@l(r3)  /* 0x80500B0C@l */
/* 804FFD20  4B D6 7C 35 */	bl cM_rndF__Ff
/* 804FFD24  3C 60 80 50 */	lis r3, lit_3790@ha /* 0x80500B0C@ha */
/* 804FFD28  C0 03 0B 0C */	lfs f0, lit_3790@l(r3)  /* 0x80500B0C@l */
...
/* 804FFD4C  4B E6 24 D5 */	bl _restgpr_27
