...
/* 804FBF4C  4B E6 62 89 */	bl _savegpr_27
/* 804FBF50  7C 7F 1B 78 */	mr r31, r3
/* 804FBF54  3C 60 80 50 */	lis r3, lit_3788@ha /* 0x80500B04@ha */
/* 804FBF58  3B A3 0B 04 */	addi r29, r3, lit_3788@l /* 0x80500B04@l */
/* 804FBF5C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804FBF60  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804FBF64  38 80 00 00 */	li r4, 0
/* 804FBF68  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 804FBF6C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 804FBF70  4B CA 78 55 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 804FBF88  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804FBF8C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804FBF90  80 9E 00 04 */	lwz r4, 4(r30)
/* 804FBF94  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804FBF98  4B CA 8E 09 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804FBF9C  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 804FBFA0  4B B1 52 21 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 804FBFDC  3C E0 80 45 */	lis r7, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 804FBFE0  C0 87 0C D0 */	lfs f4, mGroundY__11fopAcM_gc_c@l(r7)  /* 0x80450CD0@l */
/* 804FBFE4  3C E0 80 3F */	lis r7, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 804FBFE8  38 E7 1C C4 */	addi r7, r7, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
...
/* 804FBFFC  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 804FC000  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 804FC004  4B B3 29 0D */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 804FC008  90 7F 06 64 */	stw r3, 0x664(r31)
lbl_804FC00C:
/* 804FC00C  38 7F 08 08 */	addi r3, r31, 0x808
/* 804FC010  38 80 00 0C */	li r4, 0xc
/* 804FC014  3C A0 80 50 */	lis r5, l_color@ha /* 0x80500C74@ha */
/* 804FC018  38 A5 0C 74 */	addi r5, r5, l_color@l /* 0x80500C74@l */
/* 804FC01C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 804FC020  4B B1 7F 91 */	bl update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 804FC03C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FC040  38 03 61 C0 */	addi r0, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804FC058  4B B1 86 E1 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
/* 804FC05C  3B 60 00 01 */	li r27, 1
/* 804FC060  3B C0 00 04 */	li r30, 4
/* 804FC064  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804FC068  3B A3 CA 54 */	addi r29, r3, g_env_light@l /* 0x8042CA54@l */
lbl_804FC06C:
...
/* 804FC088  4B CA 8D 19 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804FC08C  7C 7F E0 2E */	lwzx r3, r31, r28
/* 804FC090  4B B1 1C 35 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_804FC094:
...
/* 804FC0AC  4B E6 61 75 */	bl _restgpr_27
