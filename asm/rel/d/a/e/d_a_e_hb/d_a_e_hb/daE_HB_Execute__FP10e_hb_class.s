...
/* 804FF754  4B E6 2A 85 */	bl _savegpr_28
/* 804FF758  7C 7D 1B 78 */	mr r29, r3
/* 804FF75C  3C 80 80 50 */	lis r4, lit_3788@ha /* 0x80500B04@ha */
/* 804FF760  3B C4 0B 04 */	addi r30, r4, lit_3788@l /* 0x80500B04@l */
...
/* 804FF784  4B B1 A4 F9 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_804FF788:
...
/* 804FF7C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FF7C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804FF808  4B B4 D2 89 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 804FF80C  7F A3 EB 78 */	mr r3, r29
/* 804FF810  4B B1 A4 6D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 804FF878  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FF87C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FF880  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 804FF884  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 804FF888  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 804FF88C  4B E4 70 5D */	bl PSMTXTrans
/* 804FF890  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FF894  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FF898  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 804FF89C  4B B0 CB 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 804FF8A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FF8A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FF8A8  A8 9D 04 E4 */	lha r4, 0x4e4(r29)
/* 804FF8AC  4B B0 CA F1 */	bl mDoMtx_XrotM__FPA4_fs
/* 804FF8B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FF8B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FF8B8  A8 9D 04 E8 */	lha r4, 0x4e8(r29)
/* 804FF8BC  4B B0 CC 11 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 804FF8D0  4B D7 0D 39 */	bl cLib_addCalcAngleS2__FPssss
/* 804FF8D4  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x80500E70@ha */
/* 804FF8D8  3B E3 0E 70 */	addi r31, r3, l_HIO@l /* 0x80500E70@l */
...
/* 804FF8F0  4B B0 D5 49 */	bl scaleM__14mDoMtx_stack_cFfff
/* 804FF8F4  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 804FF8F8  83 83 00 04 */	lwz r28, 4(r3)
/* 804FF8FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FF900  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FF904  38 9C 00 24 */	addi r4, r28, 0x24
/* 804FF908  4B E4 6B A9 */	bl PSMTXCopy
/* 804FF90C  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 804FF910  7C 03 07 74 */	extsb r3, r0
/* 804FF914  4B B2 D7 59 */	bl dComIfGp_getReverb__Fi
/* 804FF918  7C 65 1B 78 */	mr r5, r3
/* 804FF91C  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 804FF920  38 80 00 00 */	li r4, 0
/* 804FF924  4B B1 17 8D */	bl play__16mDoExt_McaMorfSOFUlSc
/* 804FF928  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 804FF92C  4B B1 18 C1 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 804FF954  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804FF958  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804FF95C  80 84 00 00 */	lwz r4, 0(r4)
/* 804FF960  4B E4 6B 51 */	bl PSMTXCopy
...
/* 804FF9CC  4B D7 15 21 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804FFA0C  4B D7 14 E1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804FFA28  4B E4 76 69 */	bl PSVECAdd
lbl_804FFA2C:
/* 804FFA2C  38 7D 09 C0 */	addi r3, r29, 0x9c0
/* 804FFA30  38 81 00 50 */	addi r4, r1, 0x50
/* 804FFA34  4B D6 FC 15 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 804FFA50  4B D6 FC B9 */	bl SetR__8cM3dGSphFf
/* 804FFA54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FFA58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804FFA5C  3B 83 23 3C */	addi r28, r3, 0x233c
/* 804FFA60  7F 83 E3 78 */	mr r3, r28
/* 804FFA64  38 9D 08 9C */	addi r4, r29, 0x89c
/* 804FFA68  4B D6 51 41 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 804FFA80  4B B8 50 45 */	bl MoveCAt__8dCcD_SphFR4cXyz
...
/* 804FFA9C  4B D6 70 49 */	bl __pl__4cXyzCFRC3Vec
/* 804FFAA0  38 7D 0A F8 */	addi r3, r29, 0xaf8
/* 804FFAA4  38 81 00 20 */	addi r4, r1, 0x20
/* 804FFAA8  4B D6 FB A1 */	bl SetC__8cM3dGSphFRC4cXyz
lbl_804FFAAC:
...
/* 804FFAC4  4B D6 FC 45 */	bl SetR__8cM3dGSphFf
/* 804FFAC8  7F 83 E3 78 */	mr r3, r28
/* 804FFACC  38 9D 09 D4 */	addi r4, r29, 0x9d4
/* 804FFAD0  4B D6 50 D9 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 804FFAE8  4B E6 27 3D */	bl _restgpr_28
