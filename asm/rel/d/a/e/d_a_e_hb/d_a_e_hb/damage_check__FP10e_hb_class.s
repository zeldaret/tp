...
/* 804FC128  4B E6 60 A5 */	bl _savegpr_25
/* 804FC12C  7C 7C 1B 78 */	mr r28, r3
/* 804FC130  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FC134  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804FC14C  4B B8 76 E5 */	bl Move__10dCcD_GSttsFv
...
/* 804FC190  3C 60 80 50 */	lis r3, lit_3789@ha /* 0x80500B08@ha */
/* 804FC194  C0 23 0B 08 */	lfs f1, lit_3789@l(r3)  /* 0x80500B08@l */
/* 804FC198  D0 21 00 34 */	stfs f1, 0x34(r1)
/* 804FC19C  3C 60 80 50 */	lis r3, lit_3790@ha /* 0x80500B0C@ha */
/* 804FC1A0  C0 03 0B 0C */	lfs f0, lit_3790@l(r3)  /* 0x80500B0C@l */
/* 804FC1A4  D0 01 00 38 */	stfs f0, 0x38(r1)
/* 804FC1A8  D0 21 00 3C */	stfs f1, 0x3c(r1)
/* 804FC1AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FC1B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804FC1C4  4B B7 38 61 */	bl StartShock__12dVibration_cFii4cXyz
...
/* 804FC1E4  4B B8 82 7D */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 804FC1FC  4B B8 82 FD */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 804FC234  4B B8 B8 25 */	bl at_power_check__FP11dCcU_AtInfo
...
/* 804FC290  4B B8 B2 85 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
...
/* 804FC348  4B B8 B1 CD */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
lbl_804FC34C:
...
lbl_804FC374:
/* 804FC374  3C 60 80 50 */	lis r3, lit_3789@ha /* 0x80500B08@ha */
/* 804FC378  C0 03 0B 08 */	lfs f0, lit_3789@l(r3)  /* 0x80500B08@l */
...
/* 804FC38C  4B D6 76 BD */	bl GetAc__8cCcD_ObjFv
...
/* 804FC3A4  4B D6 A7 91 */	bl __mi__4cXyzCFRC3Vec
...
/* 804FC3C8  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 804FC3CC  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 804FC3D0  38 81 00 20 */	addi r4, r1, 0x20
/* 804FC3D4  4B B1 D4 25 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 804FC404  4B B2 04 6D */	bl fopAcM_createBokkuri__FUsPC4cXyziiiPC4cXyzii
...
lbl_804FC41C:
/* 804FC41C  3C 60 80 50 */	lis r3, lit_3789@ha /* 0x80500B08@ha */
/* 804FC420  C0 03 0B 08 */	lfs f0, lit_3789@l(r3)  /* 0x80500B08@l */
/* 804FC424  D0 1C 12 4C */	stfs f0, 0x124c(r28)
/* 804FC428  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FC42C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804FC470  3D 60 80 50 */	lis r11, lit_3790@ha /* 0x80500B0C@ha */
/* 804FC474  C0 2B 0B 0C */	lfs f1, lit_3790@l(r11)  /* 0x80500B0C@l */
/* 804FC478  4B B5 06 19 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804FC4A4  4B B8 B0 71 */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
