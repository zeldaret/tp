...
/* 804FEB58  4B E6 36 75 */	bl _savegpr_25
...
/* 804FEB94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FEB98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FEB9C  C0 3F 00 00 */	lfs f1, 0(r31)
/* 804FEBA0  C0 5F 00 04 */	lfs f2, 4(r31)
/* 804FEBA4  C0 7F 00 08 */	lfs f3, 8(r31)
/* 804FEBA8  4B E4 7D 41 */	bl PSMTXTrans
/* 804FEBAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FEBB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FEBB4  A8 9E 00 02 */	lha r4, 2(r30)
/* 804FEBB8  4B B0 D8 7D */	bl mDoMtx_YrotM__FPA4_fs
/* 804FEBBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FEBC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FEBC4  A8 9E 00 00 */	lha r4, 0(r30)
/* 804FEBC8  4B B0 D7 D5 */	bl mDoMtx_XrotM__FPA4_fs
/* 804FEBCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FEBD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FEBD4  7F 64 07 34 */	extsh r4, r27
/* 804FEBD8  4B B0 D8 F5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804FEBDC  C0 39 07 D8 */	lfs f1, 0x7d8(r25)
/* 804FEBE0  FC 40 08 90 */	fmr f2, f1
/* 804FEBE4  FC 60 08 90 */	fmr f3, f1
/* 804FEBE8  4B B0 E2 51 */	bl scaleM__14mDoMtx_stack_cFfff
/* 804FEBEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FEBF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FEBF4  80 99 07 78 */	lwz r4, 0x778(r25)
/* 804FEBF8  38 84 00 24 */	addi r4, r4, 0x24
/* 804FEBFC  4B E4 78 B5 */	bl PSMTXCopy
lbl_804FEC00:
...
/* 804FEC20  4B E6 35 F9 */	bl _restgpr_25
