...
/* 804FFD70  4B E6 24 59 */	bl _savegpr_24
/* 804FFD74  7C 7F 1B 78 */	mr r31, r3
/* 804FFD78  3C 80 80 50 */	lis r4, cNullVec__6Z2Calc@ha /* 0x80500C3C@ha */
/* 804FFD7C  3B A4 0C 3C */	addi r29, r4, cNullVec__6Z2Calc@l /* 0x80500C3C@l */
/* 804FFD80  3C 80 80 50 */	lis r4, lit_3788@ha /* 0x80500B04@ha */
/* 804FFD84  3B C4 0B 04 */	addi r30, r4, lit_3788@l /* 0x80500B04@l */
...
/* 804FFDA0  4B B1 8D C5 */	bl __ct__10fopAc_ac_cFv
/* 804FFDA4  38 79 05 BC */	addi r3, r25, 0x5bc
/* 804FFDA8  4B DC 11 BD */	bl __ct__15Z2CreatureEnemyFv
/* 804FFDAC  38 79 06 A0 */	addi r3, r25, 0x6a0
/* 804FFDB0  3C 80 80 50 */	lis r4, __ct__4cXyzFv@ha /* 0x80500584@ha */
/* 804FFDB4  38 84 05 84 */	addi r4, r4, __ct__4cXyzFv@l /* 0x80500584@l */
/* 804FFDB8  3C A0 80 50 */	lis r5, __dt__4cXyzFv@ha /* 0x80500AB4@ha */
/* 804FFDBC  38 A5 0A B4 */	addi r5, r5, __dt__4cXyzFv@l /* 0x80500AB4@l */
/* 804FFDC0  38 C0 00 0C */	li r6, 0xc
/* 804FFDC4  38 E0 00 0C */	li r7, 0xc
/* 804FFDC8  4B E6 1F 99 */	bl __construct_array
/* 804FFDCC  38 79 07 30 */	addi r3, r25, 0x730
/* 804FFDD0  3C 80 80 50 */	lis r4, __ct__5csXyzFv@ha /* 0x80500580@ha */
/* 804FFDD4  38 84 05 80 */	addi r4, r4, __ct__5csXyzFv@l /* 0x80500580@l */
/* 804FFDD8  3C A0 80 50 */	lis r5, __dt__5csXyzFv@ha /* 0x80500A78@ha */
/* 804FFDDC  38 A5 0A 78 */	addi r5, r5, __dt__5csXyzFv@l /* 0x80500A78@l */
/* 804FFDE0  38 C0 00 06 */	li r6, 6
/* 804FFDE4  38 E0 00 0C */	li r7, 0xc
/* 804FFDE8  4B E6 1F 79 */	bl __construct_array
/* 804FFDEC  3C 60 80 50 */	lis r3, __vt__18mDoExt_3DlineMat_c@ha /* 0x80500E38@ha */
/* 804FFDF0  38 03 0E 38 */	addi r0, r3, __vt__18mDoExt_3DlineMat_c@l /* 0x80500E38@l */
/* 804FFDF4  90 19 08 08 */	stw r0, 0x808(r25)
/* 804FFDF8  3C 60 80 3A */	lis r3, __vt__19mDoExt_3DlineMat1_c@ha /* 0x803A3248@ha */
/* 804FFDFC  38 03 32 48 */	addi r0, r3, __vt__19mDoExt_3DlineMat1_c@l /* 0x803A3248@l */
/* 804FFE00  90 19 08 08 */	stw r0, 0x808(r25)
/* 804FFE04  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 804FFE08  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 804FFE0C  90 19 08 78 */	stw r0, 0x878(r25)
/* 804FFE10  38 79 08 7C */	addi r3, r25, 0x87c
/* 804FFE14  4B B8 39 4D */	bl __ct__10dCcD_GSttsFv
/* 804FFE18  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 804FFE1C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 804FFE34  4B B8 3B F5 */	bl __ct__12dCcD_GObjInfFv
/* 804FFE38  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 804FFE3C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 804FFE40  90 18 01 20 */	stw r0, 0x120(r24)
/* 804FFE44  3C 60 80 50 */	lis r3, __vt__8cM3dGAab@ha /* 0x80500E2C@ha */
/* 804FFE48  38 03 0E 2C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80500E2C@l */
/* 804FFE4C  90 18 01 1C */	stw r0, 0x11c(r24)
/* 804FFE50  3C 60 80 50 */	lis r3, __vt__8cM3dGSph@ha /* 0x80500E20@ha */
/* 804FFE54  38 03 0E 20 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80500E20@l */
/* 804FFE58  90 18 01 34 */	stw r0, 0x134(r24)
/* 804FFE5C  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 804FFE60  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 804FFE64  90 78 01 20 */	stw r3, 0x120(r24)
/* 804FFE68  3B 83 00 58 */	addi r28, r3, 0x58
/* 804FFE6C  93 98 01 34 */	stw r28, 0x134(r24)
/* 804FFE70  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 804FFE74  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 804FFE94  4B B8 3B 95 */	bl __ct__12dCcD_GObjInfFv
/* 804FFE98  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 804FFE9C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 804FFEA0  90 18 01 20 */	stw r0, 0x120(r24)
/* 804FFEA4  3C 60 80 50 */	lis r3, __vt__8cM3dGAab@ha /* 0x80500E2C@ha */
/* 804FFEA8  38 03 0E 2C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80500E2C@l */
/* 804FFEAC  90 18 01 1C */	stw r0, 0x11c(r24)
/* 804FFEB0  3C 60 80 50 */	lis r3, __vt__8cM3dGSph@ha /* 0x80500E20@ha */
/* 804FFEB4  38 03 0E 20 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80500E20@l */
/* 804FFEB8  90 18 01 34 */	stw r0, 0x134(r24)
/* 804FFEBC  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 804FFEC0  38 03 35 40 */	addi r0, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 804FFEC4  90 18 01 20 */	stw r0, 0x120(r24)
/* 804FFEC8  93 98 01 34 */	stw r28, 0x134(r24)
/* 804FFECC  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 804FFED0  38 03 BF C0 */	addi r0, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 804FFEE4  3C 80 80 50 */	lis r4, __ct__8dCcD_SphFv@ha /* 0x80500344@ha */
/* 804FFEE8  38 84 03 44 */	addi r4, r4, __ct__8dCcD_SphFv@l /* 0x80500344@l */
/* 804FFEEC  3C A0 80 50 */	lis r5, __dt__8dCcD_SphFv@ha /* 0x805003C8@ha */
/* 804FFEF0  38 A5 03 C8 */	addi r5, r5, __dt__8dCcD_SphFv@l /* 0x805003C8@l */
/* 804FFEF4  38 C0 01 38 */	li r6, 0x138
/* 804FFEF8  38 E0 00 04 */	li r7, 4
/* 804FFEFC  4B E6 1E 65 */	bl __construct_array
/* 804FFF00  38 79 10 14 */	addi r3, r25, 0x1014
/* 804FFF04  4B B7 5F A9 */	bl __ct__12dBgS_AcchCirFv
/* 804FFF08  3B 19 10 54 */	addi r24, r25, 0x1054
/* 804FFF0C  7F 03 C3 78 */	mr r3, r24
/* 804FFF10  4B B7 61 91 */	bl __ct__9dBgS_AcchFv
/* 804FFF14  3C 60 80 50 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x80500DFC@ha */
/* 804FFF18  38 63 0D FC */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x80500DFC@l */
...
/* 804FFF34  4B B7 8F 35 */	bl SetObj__16dBgS_PolyPassChkFv
lbl_804FFF38:
...
/* 804FFF48  3C 80 80 50 */	lis r4, d_a_e_hb__stringBase0@ha /* 0x80500C34@ha */
/* 804FFF4C  38 84 0C 34 */	addi r4, r4, d_a_e_hb__stringBase0@l /* 0x80500C34@l */
/* 804FFF50  4B B2 CF 6D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 804FFF70  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FFF74  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804FFF78  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 804FFF7C  7C 05 07 74 */	extsb r5, r0
/* 804FFF80  4B B3 53 E1 */	bl isSwitch__10dSv_info_cCFii
...
/* 80500020  3C 80 80 50 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x804FFB6C@ha */
/* 80500024  38 84 FB 6C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x804FFB6C@l */
/* 80500028  38 A0 40 60 */	li r5, 0x4060
/* 8050002C  4B B1 A4 85 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80500040:
/* 80500040  3C 60 80 50 */	lis r3, data_80500E60@ha /* 0x80500E60@ha */
/* 80500044  8C 03 0E 60 */	lbzu r0, data_80500E60@l(r3)  /* 0x80500E60@l */
...
/* 80500060  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x80500E70@ha */
/* 80500064  38 63 0E 70 */	addi r3, r3, l_HIO@l /* 0x80500E70@l */
...
/* 80500094  4B B1 A4 95 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 805000A8  4B B1 A4 91 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 805000C8  4B B8 37 99 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 805000CC  38 7F 08 9C */	addi r3, r31, 0x89c
/* 805000D0  38 9D 00 8C */	addi r4, r29, 0x8c
/* 805000D4  4B B8 49 61 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805000E8  4B B8 49 4D */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80500108  4B B8 49 2D */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80500148  4B B7 61 01 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 8050014C  38 7F 10 14 */	addi r3, r31, 0x1014
/* 80500150  C0 3E 00 34 */	lfs f1, 0x34(r30)
/* 80500154  FC 40 08 90 */	fmr f2, f1
/* 80500158  4B B7 5E 01 */	bl SetWall__12dBgS_AcchCirFff
...
/* 80500170  4B DC 0F 25 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 80500174  38 7F 05 BC */	addi r3, r31, 0x5bc
/* 80500178  3C 80 80 50 */	lis r4, d_a_e_hb__stringBase0@ha /* 0x80500C34@ha */
/* 8050017C  38 84 0C 34 */	addi r4, r4, d_a_e_hb__stringBase0@l /* 0x80500C34@l */
/* 80500180  4B DC 1A 11 */	bl setEnemyName__15Z2CreatureEnemyFPCc
...
/* 805001A0  4B D6 77 B5 */	bl cM_rndF__Ff
...
/* 805001B4  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x80500E70@ha */
/* 805001B8  38 63 0E 70 */	addi r3, r3, l_HIO@l /* 0x80500E70@l */
...
/* 80500220  4B B1 9C D1 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 80500250  4B E6 1F C5 */	bl _restgpr_24
