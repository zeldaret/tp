...
/* 804FBE84  4B E6 63 59 */	bl _savegpr_29
...
/* 804FBEA0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 804FBEA4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 804FBEA8  38 81 00 08 */	addi r4, r1, 8
/* 804FBEAC  4B B1 D9 4D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 804FBEB0  7C 7F 1B 79 */	or. r31, r3, r3
/* 804FBEB4  41 82 00 5C */	beq lbl_804FBF10
/* 804FBEB8  3C 60 80 50 */	lis r3, d_a_e_hb__stringBase0@ha /* 0x80500C34@ha */
/* 804FBEBC  38 63 0C 34 */	addi r3, r3, d_a_e_hb__stringBase0@l /* 0x80500C34@l */
/* 804FBEC0  7F A4 EB 78 */	mr r4, r29
/* 804FBEC4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FBEC8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804FBECC  3C A5 00 02 */	addis r5, r5, 2
/* 804FBED0  38 C0 00 80 */	li r6, 0x80
/* 804FBED4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 804FBED8  4B B4 04 15 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804FBEF0  3C C0 80 50 */	lis r6, lit_3789@ha /* 0x80500B08@ha */
/* 804FBEF4  C0 66 0B 08 */	lfs f3, lit_3789@l(r6)  /* 0x80500B08@l */
/* 804FBEF8  3C C0 80 50 */	lis r6, lit_3823@ha /* 0x80500B34@ha */
/* 804FBEFC  C0 86 0B 34 */	lfs f4, lit_3823@l(r6)  /* 0x80500B34@l */
/* 804FBF00  38 C0 00 00 */	li r6, 0
/* 804FBF04  4B B1 44 79 */	bl setAnm__14mDoExt_McaMorfFP15J3DAnmTransformiffffPv
...
/* 804FBF28  4B E6 63 01 */	bl _restgpr_29
