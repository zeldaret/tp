...
/* 806FEDC4  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 806FEDC8  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 806FEDE8  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 806FEDEC  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 806FEE04  3C 60 80 70 */	lis r3, __vt__8cM3dGSph@ha /* 0x806FF820@ha */
/* 806FEE08  38 03 F8 20 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x806FF820@l */
/* 806FEE0C  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_806FEE10:
/* 806FEE10  34 1E 01 04 */	addic. r0, r30, 0x104
/* 806FEE14  41 82 00 24 */	beq lbl_806FEE38
/* 806FEE18  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 806FEE1C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 806FEE20  90 1E 01 20 */	stw r0, 0x120(r30)
/* 806FEE24  34 1E 01 04 */	addic. r0, r30, 0x104
/* 806FEE28  41 82 00 10 */	beq lbl_806FEE38
/* 806FEE2C  3C 60 80 70 */	lis r3, __vt__8cM3dGAab@ha /* 0x806FF838@ha */
/* 806FEE30  38 03 F8 38 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x806FF838@l */
/* 806FEE34  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_806FEE38:
/* 806FEE38  7F C3 F3 78 */	mr r3, r30
/* 806FEE3C  38 80 00 00 */	li r4, 0
/* 806FEE40  4B 98 52 A5 */	bl __dt__12dCcD_GObjInfFv
/* 806FEE44  7F E0 07 35 */	extsh. r0, r31
/* 806FEE48  40 81 00 0C */	ble lbl_806FEE54
/* 806FEE4C  7F C3 F3 78 */	mr r3, r30
/* 806FEE50  4B BC FE ED */	bl __dl__FPv
lbl_806FEE54:
