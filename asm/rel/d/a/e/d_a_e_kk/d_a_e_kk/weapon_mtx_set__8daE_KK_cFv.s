...
/* 806FDF3C  4B C6 42 91 */	bl _savegpr_25
/* 806FDF40  7C 7D 1B 78 */	mr r29, r3
/* 806FDF44  3C 60 80 70 */	lis r3, lit_3792@ha /* 0x806FF5E8@ha */
/* 806FDF48  3B E3 F5 E8 */	addi r31, r3, lit_3792@l /* 0x806FF5E8@l */
/* 806FDF4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDF50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FDF54  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 806FDF58  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 806FDF5C  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 806FDF60  4B C4 89 89 */	bl PSMTXTrans
/* 806FDF64  38 7D 04 E4 */	addi r3, r29, 0x4e4
/* 806FDF68  4B 90 EF DD */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806FDF6C  3C 60 80 70 */	lis r3, l_HIO@ha /* 0x806FF890@ha */
/* 806FDF70  38 63 F8 90 */	addi r3, r3, l_HIO@l /* 0x806FF890@l */
/* 806FDF74  C0 23 00 08 */	lfs f1, 8(r3)
/* 806FDF78  FC 40 08 90 */	fmr f2, f1
/* 806FDF7C  FC 60 08 90 */	fmr f3, f1
/* 806FDF80  4B 90 EE B9 */	bl scaleM__14mDoMtx_stack_cFfff
/* 806FDF84  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806FDF88  83 C3 00 04 */	lwz r30, 4(r3)
/* 806FDF8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDF90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FDF94  38 9E 00 24 */	addi r4, r30, 0x24
/* 806FDF98  4B C4 85 19 */	bl PSMTXCopy
/* 806FDF9C  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806FDFA0  4B 91 32 4D */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 806FDFA4  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 806FDFA8  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806FDFAC  38 63 00 30 */	addi r3, r3, 0x30
/* 806FDFB0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDFB4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FDFB8  4B C4 84 F9 */	bl PSMTXCopy
/* 806FDFBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDFC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806FDFF8  4B C4 8D 75 */	bl PSMTXMultVec
/* 806FDFFC  3B 20 00 00 */	li r25, 0
/* 806FE000  3B 80 00 00 */	li r28, 0
/* 806FE004  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FE008  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806FE030  4B C4 84 81 */	bl PSMTXCopy
...
/* 806FE06C  4B C4 8D 01 */	bl PSMTXMultVec
...
/* 806FE0A4  4B C6 41 75 */	bl _restgpr_25
