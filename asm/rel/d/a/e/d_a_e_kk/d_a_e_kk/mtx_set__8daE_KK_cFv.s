...
/* 806FDD3C  4B C6 44 91 */	bl _savegpr_25
/* 806FDD40  7C 7D 1B 78 */	mr r29, r3
/* 806FDD44  3C 60 80 70 */	lis r3, lit_3792@ha /* 0x806FF5E8@ha */
/* 806FDD48  3B E3 F5 E8 */	addi r31, r3, lit_3792@l /* 0x806FF5E8@l */
/* 806FDD4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDD50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FDD54  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 806FDD58  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 806FDD5C  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 806FDD60  4B C4 8B 89 */	bl PSMTXTrans
/* 806FDD64  38 7D 04 E4 */	addi r3, r29, 0x4e4
/* 806FDD68  4B 90 F1 DD */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806FDD6C  3C 60 80 70 */	lis r3, l_HIO@ha /* 0x806FF890@ha */
/* 806FDD70  38 63 F8 90 */	addi r3, r3, l_HIO@l /* 0x806FF890@l */
/* 806FDD74  C0 23 00 08 */	lfs f1, 8(r3)
/* 806FDD78  FC 40 08 90 */	fmr f2, f1
/* 806FDD7C  FC 60 08 90 */	fmr f3, f1
/* 806FDD80  4B 90 F0 B9 */	bl scaleM__14mDoMtx_stack_cFfff
/* 806FDD84  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806FDD88  83 43 00 04 */	lwz r26, 4(r3)
/* 806FDD8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDD90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FDD94  38 9A 00 24 */	addi r4, r26, 0x24
/* 806FDD98  4B C4 87 19 */	bl PSMTXCopy
/* 806FDD9C  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806FDDA0  4B 91 34 4D */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 806FDDA4  80 7A 00 84 */	lwz r3, 0x84(r26)
/* 806FDDA8  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806FDDAC  38 63 02 A0 */	addi r3, r3, 0x2a0
/* 806FDDB0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDDB4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FDDB8  4B C4 86 F9 */	bl PSMTXCopy
/* 806FDDBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDDC0  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806FDDEC  4B C4 86 C5 */	bl PSMTXCopy
/* 806FDDF0  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806FDDF4  4B 91 33 F9 */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 806FDDF8  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 806FDDFC  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806FDE00  38 63 00 60 */	addi r3, r3, 0x60
/* 806FDE04  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDE08  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FDE0C  4B C4 86 A5 */	bl PSMTXCopy
...
/* 806FDE3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDE40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FDE44  38 81 00 08 */	addi r4, r1, 8
/* 806FDE48  38 BD 06 8C */	addi r5, r29, 0x68c
/* 806FDE4C  4B C4 8F 21 */	bl PSMTXMultVec
/* 806FDE50  3B 20 00 00 */	li r25, 0
/* 806FDE54  3B 80 00 00 */	li r28, 0
/* 806FDE58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FDE5C  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806FDE84  4B C4 86 2D */	bl PSMTXCopy
...
/* 806FDEC0  4B C4 8E AD */	bl PSMTXMultVec
...
/* 806FDEF8  4B C6 43 21 */	bl _restgpr_25
