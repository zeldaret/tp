...
/* 806FA76C  4B C6 7A 6C */	b _savegpr_28
...
/* 806FA78C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806FA790  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806FA794  4B C4 BD 1C */	b PSMTXCopy
/* 806FA798  2C 1F 00 04 */	cmpwi r31, 4
/* 806FA79C  41 82 00 08 */	beq lbl_806FA7A4
/* 806FA7A0  48 00 00 14 */	b lbl_806FA7B4
lbl_806FA7A4:
/* 806FA7A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806FA7A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806FA7AC  A8 9C 07 58 */	lha r4, 0x758(r28)
/* 806FA7B0  4B 91 1C 84 */	b mDoMtx_YrotM__FPA4_fs
lbl_806FA7B4:
/* 806FA7B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806FA7B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806FA7BC  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 806FA7C0  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806FA7C4  7C 80 F2 14 */	add r4, r0, r30
/* 806FA7C8  4B C4 BC E8 */	b PSMTXCopy
/* 806FA7CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806FA7D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806FA7D4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 806FA7D8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 806FA7DC  4B C4 BC D4 */	b PSMTXCopy
/* 806FA7E0  38 60 00 01 */	li r3, 1
/* 806FA7E4  39 61 00 20 */	addi r11, r1, 0x20
/* 806FA7E8  4B C6 7A 3C */	b _restgpr_28
