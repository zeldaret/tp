...
/* 806FA858  4B C6 79 85 */	bl _savegpr_29
/* 806FA85C  7C 7E 1B 78 */	mr r30, r3
/* 806FA860  3C 60 80 70 */	lis r3, lit_3792@ha /* 0x806FF5E8@ha */
/* 806FA864  3B E3 F5 E8 */	addi r31, r3, lit_3792@l /* 0x806FF5E8@l */
...
/* 806FA87C  4B 99 D6 65 */	bl checkItemGet__FUci
...
/* 806FA8C4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806FA8C8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806FA8CC  38 80 00 00 */	li r4, 0
/* 806FA8D0  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 806FA8D4  38 DE 01 0C */	addi r6, r30, 0x10c
/* 806FA8D8  4B AA 8E ED */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806FA8DC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806FA8E0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806FA8E4  80 9D 00 04 */	lwz r4, 4(r29)
/* 806FA8E8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 806FA8EC  4B AA A4 B5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806FA94C  4B 92 2A E1 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 806FA950  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 806FA954  4B 91 68 6D */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 806FA988  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806FA98C  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806FA990  4B 93 3F 81 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 806FA9B4  4B 92 2A 79 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 806FA9B8  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 806FA9BC  4B 91 68 05 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 806FA9C0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806FA9C4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806FA9C8  38 80 00 00 */	li r4, 0
/* 806FA9CC  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 806FA9D0  38 DE 01 0C */	addi r6, r30, 0x10c
/* 806FA9D4  4B AA 8D F1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806FA9D8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806FA9DC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806FA9E0  80 9D 00 04 */	lwz r4, 4(r29)
/* 806FA9E4  38 BE 01 0C */	addi r5, r30, 0x10c
/* 806FA9E8  4B AA A3 B9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806FAA1C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806FAA20  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806FAA24  4B 93 3E ED */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806FAA28  90 7E 06 6C */	stw r3, 0x66c(r30)
lbl_806FAA2C:
/* 806FAA2C  38 60 00 01 */	li r3, 1
lbl_806FAA30:
/* 806FAA30  39 61 00 30 */	addi r11, r1, 0x30
/* 806FAA34  4B C6 77 F5 */	bl _restgpr_29
