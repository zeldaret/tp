...
/* 806FF194  4B C6 30 21 */	bl _savegpr_19
/* 806FF198  7C 7E 1B 78 */	mr r30, r3
/* 806FF19C  7C 9A 23 78 */	mr r26, r4
/* 806FF1A0  7C BB 2B 78 */	mr r27, r5
/* 806FF1A4  7C DC 33 78 */	mr r28, r6
/* 806FF1A8  3C 60 80 70 */	lis r3, cNullVec__6Z2Calc@ha /* 0x806FF6C4@ha */
/* 806FF1AC  3A E3 F6 C4 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x806FF6C4@l */
/* 806FF1B0  3C 60 80 70 */	lis r3, lit_3792@ha /* 0x806FF5E8@ha */
/* 806FF1B4  3B E3 F5 E8 */	addi r31, r3, lit_3792@l /* 0x806FF5E8@l */
/* 806FF1B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806FF1BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806FF1C0  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 806FF1C4  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806FF1C8  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 806FF1F0  4B AA D3 8D */	bl dKy_darkworld_check__Fv
...
/* 806FF214  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806FF218  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 806FF230  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FF234  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FF238  4B C4 72 79 */	bl PSMTXCopy
...
/* 806FF250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806FF254  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806FF258  38 81 00 4C */	addi r4, r1, 0x4c
/* 806FF25C  38 A1 00 58 */	addi r5, r1, 0x58
/* 806FF260  4B C4 7B 0D */	bl PSMTXMultVec
/* 806FF264  38 61 00 34 */	addi r3, r1, 0x34
/* 806FF268  38 81 00 58 */	addi r4, r1, 0x58
/* 806FF26C  7F 65 DB 78 */	mr r5, r27
/* 806FF270  4B B6 78 C5 */	bl __mi__4cXyzCFRC3Vec
...
/* 806FF28C  4B B6 83 E9 */	bl cM_atan2s__Fff
...
/* 806FF2C0  4B B6 83 B5 */	bl cM_atan2s__Fff
...
/* 806FF2DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806FF2E0  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806FF330  4B 94 D7 61 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806FF334  7C 79 1B 79 */	or. r25, r3, r3
/* 806FF338  41 82 00 FC */	beq lbl_806FF434
/* 806FF33C  38 61 00 40 */	addi r3, r1, 0x40
/* 806FF340  4B C4 7D F9 */	bl PSVECSquareMag
...
/* 806FF3B0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806FF3B4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806FF420  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806FF424  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806FF428:
...
/* 806FF478  4B 94 D6 19 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806FF4B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806FF4B8  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806FF524  4B 94 DF A9 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806FF584  4B C6 2C 7D */	bl _restgpr_19
