...
/* 807F7E30  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807F7E34  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 807F7E38  38 80 00 02 */	li r4, 2
/* 807F7E3C  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 807F7E40  38 DE 01 0C */	addi r6, r30, 0x10c
/* 807F7E44  4B 9A B9 81 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 807F7E48  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 807F7E4C  80 83 00 04 */	lwz r4, 4(r3)
/* 807F7E50  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807F7E54  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 807F7E58  80 84 00 04 */	lwz r4, 4(r4)
/* 807F7E5C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 807F7E60  4B 9A CF 41 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 807F7E64  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807F7E68  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807F7E6C  80 04 5F 88 */	lwz r0, 0x5f88(r4)
/* 807F7E70  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 807F7E74  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 807F7E88  4B 81 87 F9 */	bl entryDL__14mDoExt_McaMorfFv
/* 807F7E8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807F7E90  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
