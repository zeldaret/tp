...
/* 80725CDC  4B C3 C4 FD */	bl _savegpr_28
/* 80725CE0  7C 7E 1B 78 */	mr r30, r3
/* 80725CE4  3C 60 80 73 */	lis r3, lit_3800@ha /* 0x80729504@ha */
/* 80725CE8  3B E3 95 04 */	addi r31, r3, lit_3800@l /* 0x80729504@l */
...
/* 80725D08  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80725D0C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80725D10  38 80 00 00 */	li r4, 0
/* 80725D14  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80725D18  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80725D1C  4B A7 DA A9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80725D20  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80725D24  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80725D28  80 9C 00 04 */	lwz r4, 4(r28)
/* 80725D2C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80725D30  4B A7 F0 71 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80725D34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80725D38  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80725D3C  80 04 5F 88 */	lwz r0, 0x5f88(r4)
/* 80725D40  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80725D44  3B A3 4A C8 */	addi r29, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80725D58  4B 8E B4 69 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 80725D5C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80725D60  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80725DC0  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80725DC4  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80725DC8  4B 90 8B 49 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 80725DCC  90 7E 05 D4 */	stw r3, 0x5d4(r30)
/* 80725DD0  38 60 00 01 */	li r3, 1
lbl_80725DD4:
/* 80725DD4  39 61 00 30 */	addi r11, r1, 0x30
/* 80725DD8  4B C3 C4 4D */	bl _restgpr_28
