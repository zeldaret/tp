...
/* 8077E080  4B BE 41 49 */	bl _savegpr_24
/* 8077E084  7C 7D 1B 78 */	mr r29, r3
/* 8077E088  3C 80 80 78 */	lis r4, lit_3903@ha /* 0x80780DC4@ha */
/* 8077E08C  3B C4 0D C4 */	addi r30, r4, lit_3903@l /* 0x80780DC4@l */
...
/* 8077E0A0  4B 8F 7E B9 */	bl SetWall__12dBgS_AcchCirFff
...
/* 8077E0D4  3C 60 80 78 */	lis r3, lit_5377@ha /* 0x807810B4@ha */
/* 8077E0D8  38 63 10 B4 */	addi r3, r3, lit_5377@l /* 0x807810B4@l */
...
/* 8077E224  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8077E228  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8077E22C  4B BC 82 85 */	bl PSMTXCopy
/* 8077E230  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8077E234  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8077E26C  4B 8F 9A F9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8077E270  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077E274  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8077E278  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8077E27C  38 81 00 54 */	addi r4, r1, 0x54
/* 8077E280  4B 8F 61 35 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8077E298  4B AE 88 9D */	bl __mi__4cXyzCFRC3Vec
...
/* 8077E2B4  4B AE 93 C1 */	bl cM_atan2s__Fff
/* 8077E2B8  7C 64 1B 78 */	mr r4, r3
/* 8077E2BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8077E2C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8077E2C4  4B 88 E1 19 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8077E2DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8077E2E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8077E2E4  38 81 00 30 */	addi r4, r1, 0x30
/* 8077E2E8  38 A1 00 3C */	addi r5, r1, 0x3c
/* 8077E2EC  4B BC 8A 81 */	bl PSMTXMultVec
/* 8077E2F0  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 8077E2F4  38 81 00 3C */	addi r4, r1, 0x3c
/* 8077E2F8  7C 65 1B 78 */	mr r5, r3
/* 8077E2FC  4B BC 8D 95 */	bl PSVECAdd
lbl_8077E300:
/* 8077E300  38 61 00 54 */	addi r3, r1, 0x54
/* 8077E304  38 80 FF FF */	li r4, -1
/* 8077E308  4B 8F 99 D5 */	bl __dt__11dBgS_LinChkFv
lbl_8077E30C:
/* 8077E30C  3C 60 80 78 */	lis r3, struct_8078137C+0x1@ha /* 0x8078137D@ha */
/* 8077E310  88 03 13 7D */	lbz r0, struct_8078137C+0x1@l(r3)  /* 0x8078137D@l */
...
/* 8077E33C  3C 60 80 78 */	lis r3, s_down_sub__FPvPv@ha /* 0x8077C894@ha */
/* 8077E340  38 63 C8 94 */	addi r3, r3, s_down_sub__FPvPv@l /* 0x8077C894@l */
/* 8077E344  7F A4 EB 78 */	mr r4, r29
/* 8077E348  4B 8A 2F F1 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 8077E364  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077E368  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8077E3AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077E3B0  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8077E3D0  3C 80 80 78 */	lis r4, l_HIO@ha /* 0x8078138C@ha */
/* 8077E3D4  38 84 13 8C */	addi r4, r4, l_HIO@l /* 0x8078138C@l */
...
/* 8077E3F4  4B 89 C3 1D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8077E410  3C 60 80 78 */	lis r3, l_HIO@ha /* 0x8078138C@ha */
/* 8077E414  38 63 13 8C */	addi r3, r3, l_HIO@l /* 0x8078138C@l */
...
/* 8077E468  4B 89 C2 A9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8077E4A8  4B AF 21 61 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8077E4BC  4B AF 21 4D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8077E4D0  4B AF 21 39 */	bl cLib_addCalcAngleS2__FPssss
/* 8077E4D4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8077E4D8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8077E4DC  80 63 00 00 */	lwz r3, 0(r3)
/* 8077E4E0  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 8077E4E4  4B 88 DE F9 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8077E4F8  3C 60 80 78 */	lis r3, l_HIO@ha /* 0x8078138C@ha */
/* 8077E4FC  38 63 13 8C */	addi r3, r3, l_HIO@l /* 0x8078138C@l */
...
/* 8077E514  4B AF 29 D9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8077E534  4B BC 8B 5D */	bl PSVECAdd
...
/* 8077E604  4B BE 3C 11 */	bl _restgpr_24
