...
/* 8077D460  3C 80 80 78 */	lis r4, lit_3903@ha /* 0x80780DC4@ha */
/* 8077D464  3B E4 0D C4 */	addi r31, r4, lit_3903@l /* 0x80780DC4@l */
...
/* 8077D4E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077D4EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8077D4F0  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8077D4F4  3C 80 80 78 */	lis r4, d_a_e_s1__stringBase0@ha /* 0x80780F74@ha */
/* 8077D4F8  38 84 0F 74 */	addi r4, r4, d_a_e_s1__stringBase0@l /* 0x80780F74@l */
/* 8077D4FC  38 84 00 0C */	addi r4, r4, 0xc
/* 8077D500  4B BE B4 95 */	bl strcmp
/* 8077D504  2C 03 00 00 */	cmpwi r3, 0
/* 8077D508  40 82 01 70 */	bne lbl_8077D678
/* 8077D50C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077D510  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8077D514  38 80 00 0E */	li r4, 0xe
/* 8077D518  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8077D51C  7C 05 07 74 */	extsb r5, r0
/* 8077D520  4B 8B 7E 41 */	bl isSwitch__10dSv_info_cCFii
...
/* 8077D558  3C 60 80 78 */	lis r3, s_check@ha /* 0x807814C0@ha */
/* 8077D55C  90 03 14 C0 */	stw r0, s_check@l(r3)  /* 0x807814C0@l */
/* 8077D560  3C 60 80 78 */	lis r3, s_posrevise_sub__FPvPv@ha /* 0x8077CB68@ha */
/* 8077D564  38 63 CB 68 */	addi r3, r3, s_posrevise_sub__FPvPv@l /* 0x8077CB68@l */
/* 8077D568  7F C4 F3 78 */	mr r4, r30
/* 8077D56C  4B 8A 3D CD */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 8077D594  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077D598  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8077D5AC  4B 8F 24 79 */	bl StartShock__12dVibration_cFii4cXyz
lbl_8077D5B0:
/* 8077D5B0  A8 1E 06 A0 */	lha r0, 0x6a0(r30)
/* 8077D5B4  2C 00 00 05 */	cmpwi r0, 5
/* 8077D5B8  40 81 00 20 */	ble lbl_8077D5D8
/* 8077D5BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077D5C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_8077D5D8:
/* 8077D5D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077D5DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8077D5FC  3C 60 80 78 */	lis r3, s_allwakeup_sub__FPvPv@ha /* 0x8077CAD0@ha */
/* 8077D600  38 63 CA D0 */	addi r3, r3, s_allwakeup_sub__FPvPv@l /* 0x8077CAD0@l */
/* 8077D604  7F C4 F3 78 */	mr r4, r30
/* 8077D608  4B 8A 3D 31 */	bl fpcEx_Search__FPFPvPv_PvPv
lbl_8077D60C:
...
/* 8077D644  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077D648  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8077D684  4B AF 23 FD */	bl cLib_addCalc0__FPfff
