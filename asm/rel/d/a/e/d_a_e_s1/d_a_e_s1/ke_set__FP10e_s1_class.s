...
/* 8077E650  4B BE 3B 79 */	bl _savegpr_24
/* 8077E654  7C 7C 1B 79 */	or. r28, r3, r3
/* 8077E658  3C 60 80 78 */	lis r3, lit_3903@ha /* 0x80780DC4@ha */
/* 8077E65C  3B C3 0D C4 */	addi r30, r3, lit_3903@l /* 0x80780DC4@l */
...
/* 8077E680  4B AE 93 55 */	bl cM_initRnd2__Fiii
...
/* 8077E698  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8077E69C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8077E6A0  80 84 00 00 */	lwz r4, 0(r4)
/* 8077E6A4  4B BC 7E 0D */	bl PSMTXCopy
/* 8077E6A8  3B A0 00 00 */	li r29, 0
/* 8077E6AC  3B 60 00 00 */	li r27, 0
/* 8077E6B0  3B 40 00 00 */	li r26, 0
/* 8077E6B4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8077E6B8  3B E3 07 68 */	addi r31, r3, calc_mtx@l /* 0x80450768@l */
/* 8077E6BC  C3 DE 00 64 */	lfs f30, 0x64(r30)
/* 8077E6C0  C3 FE 00 E0 */	lfs f31, 0xe0(r30)
lbl_8077E6C4:
/* 8077E6C4  4B AF 28 59 */	bl MtxPush__Fv
/* 8077E6C8  80 7F 00 00 */	lwz r3, 0(r31)
/* 8077E6CC  38 80 40 00 */	li r4, 0x4000
/* 8077E6D0  4B 88 DD 65 */	bl mDoMtx_YrotM__FPA4_fs
/* 8077E6D4  C0 3E 00 D0 */	lfs f1, 0xd0(r30)
/* 8077E6D8  4B AE 93 F5 */	bl cM_rndF2__Ff
...
/* 8077E6F4  4B 88 DC A9 */	bl mDoMtx_XrotM__FPA4_fs
/* 8077E6F8  2C 1D 00 0A */	cmpwi r29, 0xa
/* 8077E6FC  40 80 00 5C */	bge lbl_8077E758
/* 8077E700  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8077E704  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8077E708  80 63 00 00 */	lwz r3, 0(r3)
/* 8077E70C  3C 80 80 78 */	lis r4, ke_za@ha /* 0x80781108@ha */
/* 8077E710  38 84 11 08 */	addi r4, r4, ke_za@l /* 0x80781108@l */
/* 8077E714  7C 04 D2 AE */	lhax r0, r4, r26
/* 8077E718  1C 00 00 05 */	mulli r0, r0, 5
/* 8077E71C  7C 04 07 34 */	extsh r4, r0
/* 8077E720  4B 88 DD AD */	bl mDoMtx_ZrotM__FPA4_fs
/* 8077E724  C0 3E 00 D8 */	lfs f1, 0xd8(r30)
/* 8077E728  4B AE 93 A5 */	bl cM_rndF2__Ff
/* 8077E72C  C0 1E 00 D4 */	lfs f0, 0xd4(r30)
/* 8077E730  EF A0 08 2A */	fadds f29, f0, f1
/* 8077E734  C0 3E 00 4C */	lfs f1, 0x4c(r30)
/* 8077E738  4B AE 93 95 */	bl cM_rndF2__Ff
/* 8077E73C  C0 1E 00 84 */	lfs f0, 0x84(r30)
/* 8077E740  EF 81 00 28 */	fsubs f28, f1, f0
/* 8077E744  C0 3E 00 34 */	lfs f1, 0x34(r30)
/* 8077E748  4B AE 93 85 */	bl cM_rndF2__Ff
/* 8077E74C  C0 1E 00 4C */	lfs f0, 0x4c(r30)
/* 8077E750  EF 61 00 28 */	fsubs f27, f1, f0
/* 8077E754  48 00 00 60 */	b lbl_8077E7B4
lbl_8077E758:
/* 8077E758  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8077E75C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8077E760  80 63 00 00 */	lwz r3, 0(r3)
/* 8077E764  3C 80 80 78 */	lis r4, ke_za@ha /* 0x80781108@ha */
/* 8077E768  38 84 11 08 */	addi r4, r4, ke_za@l /* 0x80781108@l */
...
/* 8077E7D0  4B AF 27 1D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8077E818  4B AF 27 41 */	bl MtxPull__Fv
...
/* 8077E85C  4B BE 39 B9 */	bl _restgpr_24
