...
/* 807651AC  4B BF D0 2D */	bl _savegpr_28
/* 807651B0  2C 04 00 00 */	cmpwi r4, 0
/* 807651B4  40 82 01 44 */	bne lbl_807652F8
/* 807651B8  A3 83 00 14 */	lhz r28, 0x14(r3)
/* 807651BC  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 807651C0  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 807651E4  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807651E8  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807651EC  80 84 00 00 */	lwz r4, 0(r4)
/* 807651F0  4B BE 12 C1 */	bl PSMTXCopy
...
lbl_80765204:
/* 80765204  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80765208  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80765220  4B 8A 71 7D */	bl mDoMtx_XrotM__FPA4_fs
/* 80765224  2C 1C 00 01 */	cmpwi r28, 1
/* 80765228  40 82 00 18 */	bne lbl_80765240
/* 8076522C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80765230  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80765234  80 63 00 00 */	lwz r3, 0(r3)
/* 80765238  A8 9D 06 D0 */	lha r4, 0x6d0(r29)
/* 8076523C  4B 8A 71 61 */	bl mDoMtx_XrotM__FPA4_fs
lbl_80765240:
/* 80765240  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80765244  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80765260  4B 8A 72 6D */	bl mDoMtx_ZrotM__FPA4_fs
...
lbl_80765278:
/* 80765278  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8076527C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8076529C  4B 8A 71 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 807652A0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807652A4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 807652C0  4B 8A 72 0D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_807652C4:
/* 807652C4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807652C8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 807652DC  4B BE 11 D5 */	bl PSMTXCopy
/* 807652E0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807652E4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807652E8  80 63 00 00 */	lwz r3, 0(r3)
/* 807652EC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 807652F0  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 807652F4  4B BE 11 BD */	bl PSMTXCopy
lbl_807652F8:
/* 807652F8  38 60 00 01 */	li r3, 1
/* 807652FC  39 61 00 20 */	addi r11, r1, 0x20
/* 80765300  4B BF CF 25 */	bl _restgpr_28
