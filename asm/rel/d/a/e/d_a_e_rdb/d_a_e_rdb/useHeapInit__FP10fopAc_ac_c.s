...
/* 8076A498  4B BF 7D 41 */	bl _savegpr_28
/* 8076A49C  7C 7F 1B 78 */	mr r31, r3
/* 8076A4A0  38 60 00 58 */	li r3, 0x58
/* 8076A4A4  4B B6 47 A9 */	bl __nw__FUl
/* 8076A4A8  7C 7E 1B 79 */	or. r30, r3, r3
/* 8076A4AC  41 82 00 94 */	beq lbl_8076A540
/* 8076A4B0  3C 60 80 77 */	lis r3, d_a_e_rdb__stringBase0@ha /* 0x8076B6C4@ha */
/* 8076A4B4  38 63 B6 C4 */	addi r3, r3, d_a_e_rdb__stringBase0@l /* 0x8076B6C4@l */
/* 8076A4B8  38 80 00 45 */	li r4, 0x45
/* 8076A4BC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076A4C0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8076A4D4  4B 8D 1E 19 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8076A4D8  7C 7D 1B 78 */	mr r29, r3
/* 8076A4DC  3C 60 80 77 */	lis r3, d_a_e_rdb__stringBase0@ha /* 0x8076B6C4@ha */
/* 8076A4E0  38 63 B6 C4 */	addi r3, r3, d_a_e_rdb__stringBase0@l /* 0x8076B6C4@l */
/* 8076A4E4  38 80 00 53 */	li r4, 0x53
/* 8076A4E8  7F 85 E3 78 */	mr r5, r28
/* 8076A4EC  38 C0 00 80 */	li r6, 0x80
/* 8076A4F0  4B 8D 1D FD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8076A528  3D 20 80 77 */	lis r9, lit_4009@ha /* 0x8076B464@ha */
/* 8076A52C  C0 29 B4 64 */	lfs f1, lit_4009@l(r9)  /* 0x8076B464@l */
/* 8076A530  39 20 00 00 */	li r9, 0
/* 8076A534  39 40 FF FF */	li r10, -1
/* 8076A538  4B 8A 62 99 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8076A56C  3C 60 80 76 */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x8076519C@ha */
/* 8076A570  38 83 51 9C */	addi r4, r3, nodeCallBack__FP8J3DJointi@l /* 0x8076519C@l */
...
/* 8076A5A0  3C 60 80 77 */	lis r3, d_a_e_rdb__stringBase0@ha /* 0x8076B6C4@ha */
/* 8076A5A4  38 63 B6 C4 */	addi r3, r3, d_a_e_rdb__stringBase0@l /* 0x8076B6C4@l */
/* 8076A5A8  38 80 00 55 */	li r4, 0x55
/* 8076A5AC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076A5B0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8076A5B4  3C A5 00 02 */	addis r5, r5, 2
/* 8076A5B8  38 C0 00 80 */	li r6, 0x80
/* 8076A5BC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8076A5C0  4B 8D 1D 2D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8076A5D0  4B 8A A6 85 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8076A5E8  4B BF 7C 3D */	bl _restgpr_28
