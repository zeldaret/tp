...
/* 8076ACB0  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 8076ACB4  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 8076ACD4  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 8076ACD8  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 8076ACF0  3C 60 80 77 */	lis r3, __vt__8cM3dGSph@ha /* 0x8076B968@ha */
/* 8076ACF4  38 03 B9 68 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x8076B968@l */
/* 8076ACF8  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_8076ACFC:
/* 8076ACFC  34 1E 01 04 */	addic. r0, r30, 0x104
/* 8076AD00  41 82 00 24 */	beq lbl_8076AD24
/* 8076AD04  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8076AD08  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8076AD0C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 8076AD10  34 1E 01 04 */	addic. r0, r30, 0x104
/* 8076AD14  41 82 00 10 */	beq lbl_8076AD24
/* 8076AD18  3C 60 80 77 */	lis r3, __vt__8cM3dGAab@ha /* 0x8076B980@ha */
/* 8076AD1C  38 03 B9 80 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8076B980@l */
/* 8076AD20  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_8076AD24:
/* 8076AD24  7F C3 F3 78 */	mr r3, r30
/* 8076AD28  38 80 00 00 */	li r4, 0
/* 8076AD2C  4B 91 93 B9 */	bl __dt__12dCcD_GObjInfFv
/* 8076AD30  7F E0 07 35 */	extsh. r0, r31
/* 8076AD34  40 81 00 0C */	ble lbl_8076AD40
/* 8076AD38  7F C3 F3 78 */	mr r3, r30
/* 8076AD3C  4B B6 40 01 */	bl __dl__FPv
lbl_8076AD40:
