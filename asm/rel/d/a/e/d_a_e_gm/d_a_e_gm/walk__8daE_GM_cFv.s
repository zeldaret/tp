...
/* 806D1CD0  4B C9 05 09 */	bl _savegpr_28
/* 806D1CD4  7C 7C 1B 78 */	mr r28, r3
/* 806D1CD8  3C 80 80 6D */	lis r4, cNullVec__6Z2Calc@ha /* 0x806D7AFC@ha */
/* 806D1CDC  3B C4 7A FC */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x806D7AFC@l */
/* 806D1CE0  3C 80 80 6D */	lis r4, lit_3906@ha /* 0x806D79A0@ha */
/* 806D1CE4  3B E4 79 A0 */	addi r31, r4, lit_3906@l /* 0x806D79A0@l */
...
/* 806D1CFC  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D1D00  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D1D04  38 80 00 08 */	li r4, 8
/* 806D1D08  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D1D0C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D1D10  3C A5 00 02 */	addis r5, r5, 2
/* 806D1D14  38 C0 00 80 */	li r6, 0x80
/* 806D1D18  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D1D1C  4B 96 A5 D1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D1D3C  4B 93 F1 35 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D1D64  4B 9A 41 F5 */	bl SetWall__12dBgS_AcchCirFff
...
/* 806D1D98  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D1D9C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806D1DDC  4B 94 7B E1 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 806D1E30  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806D1E34  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 806D1E38  7C 43 04 2E */	lfsx f2, r3, r0
/* 806D1E3C  C0 3F 00 A4 */	lfs f1, 0xa4(r31)
/* 806D1E40  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D7EC4@ha */
/* 806D1E44  38 83 7E C4 */	addi r4, r3, l_HIO@l /* 0x806D7EC4@l */
...
/* 806D1E90  4B 94 88 3D */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806D1E94  38 7C 05 F4 */	addi r3, r28, 0x5f4
/* 806D1E98  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D1E9C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D1EA0  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D1EA4  4B 9A 4C 09 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 806D1EA8  3C 60 80 6D */	lis r3, s_obj_sub2__FPvPv@ha /* 0x806D14E0@ha */
/* 806D1EAC  38 63 14 E0 */	addi r3, r3, s_obj_sub2__FPvPv@l /* 0x806D14E0@l */
/* 806D1EB0  7F 84 E3 78 */	mr r4, r28
/* 806D1EB4  4B 94 F4 85 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 806D1EC8  4B B9 ED 3D */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 806D1ECC  B0 7C 0A 1E */	sth r3, 0xa1e(r28)
/* 806D1ED0  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 806D1ED4  4B B9 5A B9 */	bl cM_rndFX__Ff
...
/* 806D1F44  4B C7 54 59 */	bl PSVECSquareDistance
...
/* 806D1FB4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D1FB8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806D2024  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D2028  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806D202C:
...
/* 806D2050  3C 60 80 6D */	lis r3, struct_806D7F1C+0x0@ha /* 0x806D7F1C@ha */
/* 806D2054  88 03 7F 1C */	lbz r0, struct_806D7F1C+0x0@l(r3)  /* 0x806D7F1C@l */
...
/* 806D2068  4B B9 EB 9D */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806D2090  4B B9 EB 75 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806D20BC  4B B9 58 99 */	bl cM_rndF__Ff
...
/* 806D20F4  4B B9 E4 4D */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D210C  4B B9 E4 35 */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D2124  4B B9 E4 1D */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D2190  4B C9 00 95 */	bl _restgpr_28
