...
/* 806D35FC  3C 60 80 6D */	lis r3, lit_3906@ha /* 0x806D79A0@ha */
/* 806D3600  3B C3 79 A0 */	addi r30, r3, lit_3906@l /* 0x806D79A0@l */
/* 806D3604  80 1F 0A 3C */	lwz r0, 0xa3c(r31)
/* 806D3608  2C 00 00 00 */	cmpwi r0, 0
/* 806D360C  40 82 00 D4 */	bne lbl_806D36E0
/* 806D3610  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D3614  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D3618  38 63 00 05 */	addi r3, r3, 5
/* 806D361C  38 80 00 06 */	li r4, 6
/* 806D3620  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D3624  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D3628  3C A5 00 02 */	addis r5, r5, 2
/* 806D362C  38 C0 00 80 */	li r6, 0x80
/* 806D3630  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D3634  4B 96 8C B9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D3654  4B 93 D8 1D */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D3678  3C 60 80 6D */	lis r3, struct_806D7F1C+0x3@ha /* 0x806D7F1F@ha */
/* 806D367C  98 03 7F 1F */	stb r0, struct_806D7F1C+0x3@l(r3)  /* 0x806D7F1F@l */
...
/* 806D36F8  4B B9 C3 45 */	bl cLib_addCalc2__FPffff
...
/* 806D3724  3C 60 80 6D */	lis r3, lit_4863@ha /* 0x806D7C58@ha */
/* 806D3728  38 83 7C 58 */	addi r4, r3, lit_4863@l /* 0x806D7C58@l */
...
/* 806D375C  4B 94 6F 71 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806D3760  38 7F 05 F4 */	addi r3, r31, 0x5f4
/* 806D3764  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D3768  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D376C  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D3770  4B 9A 33 3D */	bl CrrPos__9dBgS_AcchFR4dBgS
lbl_806D3774:
