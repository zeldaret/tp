...
/* 806D546C  4B C8 CD 6D */	bl _savegpr_28
/* 806D5470  7C 7D 1B 78 */	mr r29, r3
/* 806D5474  3C 80 80 6D */	lis r4, lit_3906@ha /* 0x806D79A0@ha */
/* 806D5478  3B E4 79 A0 */	addi r31, r4, lit_3906@l /* 0x806D79A0@l */
...
/* 806D5490  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D5494  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D5498  38 80 00 08 */	li r4, 8
/* 806D549C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D54A0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D54A4  3C A5 00 02 */	addis r5, r5, 2
/* 806D54A8  38 C0 00 80 */	li r6, 0x80
/* 806D54AC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D54B0  4B 96 6E 3D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D54D0  4B 93 B9 A1 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D5518  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D551C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D5520  83 C4 5D AC */	lwz r30, 0x5dac(r4)
/* 806D5524  38 9D 07 CC */	addi r4, r29, 0x7cc
/* 806D5528  4B 94 51 A5 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806D552C  38 7D 05 F4 */	addi r3, r29, 0x5f4
/* 806D5530  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D5534  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D5538  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D553C  4B 9A 15 71 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 806D5550  3C 60 80 6D */	lis r3, lit_5581@ha /* 0x806D7D18@ha */
/* 806D5554  38 83 7D 18 */	addi r4, r3, lit_5581@l /* 0x806D7D18@l */
...
/* 806D55B4  4B B9 B6 51 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806D55E4  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D7EC4@ha */
/* 806D55E8  38 63 7E C4 */	addi r3, r3, l_HIO@l /* 0x806D7EC4@l */
/* 806D55EC  C0 03 00 18 */	lfs f0, 0x18(r3)
/* 806D55F0  D0 1D 0A 4C */	stfs f0, 0xa4c(r29)
/* 806D55F4  48 00 00 20 */	b lbl_806D5614
lbl_806D55F8:
/* 806D55F8  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D7EC4@ha */
/* 806D55FC  38 63 7E C4 */	addi r3, r3, l_HIO@l /* 0x806D7EC4@l */
...
/* 806D5638  3C 60 80 6D */	lis r3, struct_806D7F1C+0x0@ha /* 0x806D7F1C@ha */
/* 806D563C  88 03 7F 1C */	lbz r0, struct_806D7F1C+0x0@l(r3)  /* 0x806D7F1C@l */
...
/* 806D5650  4B B9 B5 B5 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806D5684  4B B9 22 D1 */	bl cM_rndF__Ff
...
/* 806D56B4  4B B9 B0 8D */	bl cLib_chaseF__FPfff
...
/* 806D56CC  4B B9 AE 75 */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D56E4  4B B9 AE 5D */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D56FC  4B B9 AE 45 */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D5778  4B C8 CA AD */	bl _restgpr_28
