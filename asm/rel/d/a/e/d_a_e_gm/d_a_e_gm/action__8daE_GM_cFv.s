...
/* 806D1384  3C 60 80 6D */	lis r3, lit_3906@ha /* 0x806D79A0@ha */
/* 806D1388  3B E3 79 A0 */	addi r31, r3, lit_3906@l /* 0x806D79A0@l */
/* 806D138C  88 1E 0A 76 */	lbz r0, 0xa76(r30)
/* 806D1390  28 00 00 00 */	cmplwi r0, 0
/* 806D1394  41 82 01 24 */	beq lbl_806D14B8
/* 806D1398  3C 60 80 6D */	lis r3, lit_4075@ha /* 0x806D7B7C@ha */
/* 806D139C  38 83 7B 7C */	addi r4, r3, lit_4075@l /* 0x806D7B7C@l */
...
/* 806D13C0  4B C9 0C 89 */	bl __ptmf_cmpr
/* 806D13C4  2C 03 00 00 */	cmpwi r3, 0
/* 806D13C8  41 82 00 38 */	beq lbl_806D1400
/* 806D13CC  3C 60 80 6D */	lis r3, lit_4077@ha /* 0x806D7B88@ha */
/* 806D13D0  38 83 7B 88 */	addi r4, r3, lit_4077@l /* 0x806D7B88@l */
...
/* 806D13F4  4B C9 0C 55 */	bl __ptmf_cmpr
...
/* 806D141C  4B B9 E6 21 */	bl cLib_addCalc2__FPffff
...
/* 806D1434  3C 60 80 6D */	lis r3, struct_806D7F1C+0x2@ha /* 0x806D7F1E@ha */
/* 806D1438  88 03 7F 1E */	lbz r0, struct_806D7F1C+0x2@l(r3)  /* 0x806D7F1E@l */
...
/* 806D1454  4B 95 BC 19 */	bl dComIfGp_getReverb__Fi
...
/* 806D1468  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806D146C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806D1494  4B BD A4 F1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 806D1498  7F C3 F3 78 */	mr r3, r30
/* 806D149C  4B 94 87 E1 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 806D14A0  3C 60 80 6D */	lis r3, struct_806D7F1C+0x2@ha /* 0x806D7F1E@ha */
/* 806D14A4  38 83 7F 1E */	addi r4, r3, struct_806D7F1C+0x2@l /* 0x806D7F1E@l */
...
/* 806D14C0  4B C9 0B C5 */	bl __ptmf_scall
