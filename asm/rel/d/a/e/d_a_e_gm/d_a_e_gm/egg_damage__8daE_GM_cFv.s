...
/* 806D25F8  4B C8 FB E5 */	bl _savegpr_29
/* 806D25FC  7C 7E 1B 78 */	mr r30, r3
/* 806D2600  3C 60 80 6D */	lis r3, lit_3906@ha /* 0x806D79A0@ha */
/* 806D2604  3B E3 79 A0 */	addi r31, r3, lit_3906@l /* 0x806D79A0@l */
/* 806D2608  80 1E 0A 3C */	lwz r0, 0xa3c(r30)
/* 806D260C  2C 00 00 00 */	cmpwi r0, 0
/* 806D2610  40 82 00 F4 */	bne lbl_806D2704
/* 806D2614  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D2618  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806D2634  4B B9 53 59 */	bl cM_rndFX__Ff
...
/* 806D2648  4B B9 53 45 */	bl cM_rndFX__Ff
...
/* 806D2670  4B B9 E5 95 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806D26A8  4B B9 52 AD */	bl cM_rndF__Ff
...
/* 806D2728  4B B9 D3 15 */	bl cLib_addCalc2__FPffff
/* 806D272C  7F C3 F3 78 */	mr r3, r30
/* 806D2730  38 9E 07 CC */	addi r4, r30, 0x7cc
/* 806D2734  4B 94 7F 99 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806D2738  38 7E 05 F4 */	addi r3, r30, 0x5f4
/* 806D273C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D2740  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D2744  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D2748  4B 9A 43 65 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 806D27BC  3C 60 80 6D */	lis r3, struct_806D7F1C+0x2@ha /* 0x806D7F1E@ha */
/* 806D27C0  88 03 7F 1E */	lbz r0, struct_806D7F1C+0x2@l(r3)  /* 0x806D7F1E@l */
...
/* 806D27DC  4B 95 A8 91 */	bl dComIfGp_getReverb__Fi
...
/* 806D27F0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806D27F4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806D281C  4B BD 91 69 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 806D2820  7F C3 F3 78 */	mr r3, r30
/* 806D2824  4B FF F9 81 */	bl create_item__8daE_GM_cFv
/* 806D2828  7F C3 F3 78 */	mr r3, r30
/* 806D282C  4B 94 74 51 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 806D2830  3C 60 80 6D */	lis r3, struct_806D7F1C+0x2@ha /* 0x806D7F1E@ha */
/* 806D2834  38 83 7F 1E */	addi r4, r3, struct_806D7F1C+0x2@l /* 0x806D7F1E@l */
