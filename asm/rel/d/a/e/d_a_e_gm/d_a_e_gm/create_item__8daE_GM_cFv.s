...
/* 806D21E4  4B 94 9C 31 */	bl fopAcM_createItemFromEnemyID__FUcPC4cXyziiPC5csXyzPC4cXyzPfPf
/* 806D21E8  48 00 00 98 */	b lbl_806D2280
lbl_806D21EC:
/* 806D21EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D21F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D21F4  A0 03 00 02 */	lhz r0, 2(r3)
/* 806D21F8  2C 00 00 05 */	cmpwi r0, 5
/* 806D21FC  40 80 00 10 */	bge lbl_806D220C
/* 806D2200  3C 60 80 6D */	lis r3, lit_4424@ha /* 0x806D7A50@ha */
/* 806D2204  C0 23 7A 50 */	lfs f1, lit_4424@l(r3)  /* 0x806D7A50@l */
/* 806D2208  48 00 00 0C */	b lbl_806D2214
lbl_806D220C:
/* 806D220C  3C 60 80 6D */	lis r3, lit_4425@ha /* 0x806D7A54@ha */
/* 806D2210  C0 23 7A 54 */	lfs f1, lit_4425@l(r3)  /* 0x806D7A54@l */
lbl_806D2214:
/* 806D2214  4B B9 57 41 */	bl cM_rndF__Ff
...
/* 806D2258  4B 94 9F E9 */	bl fopAcM_createItem__FPC4cXyziiiPC5csXyzPC4cXyzi
...
/* 806D227C  4B 94 9F C5 */	bl fopAcM_createItem__FPC4cXyziiiPC5csXyzPC4cXyzi
lbl_806D2280:
