...
/* 806D3EDC  4B C8 E2 FD */	bl _savegpr_28
/* 806D3EE0  7C 7C 1B 78 */	mr r28, r3
/* 806D3EE4  3C 80 80 6D */	lis r4, lit_1109@ha /* 0x806D7E78@ha */
/* 806D3EE8  3B A4 7E 78 */	addi r29, r4, lit_1109@l /* 0x806D7E78@l */
/* 806D3EEC  3C 80 80 6D */	lis r4, cNullVec__6Z2Calc@ha /* 0x806D7AFC@ha */
/* 806D3EF0  3B C4 7A FC */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x806D7AFC@l */
/* 806D3EF4  3C 80 80 6D */	lis r4, lit_3906@ha /* 0x806D79A0@ha */
/* 806D3EF8  3B E4 79 A0 */	addi r31, r4, lit_3906@l /* 0x806D79A0@l */
...
/* 806D3F10  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D3F14  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D3F18  38 80 00 08 */	li r4, 8
/* 806D3F1C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D3F20  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D3F24  3C A5 00 02 */	addis r5, r5, 2
/* 806D3F28  38 C0 00 80 */	li r6, 0x80
/* 806D3F2C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D3F30  4B 96 83 BD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D3F50  4B 93 CF 21 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D3F9C  4B 94 67 31 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806D3FA0  38 7C 05 F4 */	addi r3, r28, 0x5f4
/* 806D3FA4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D3FA8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D3FAC  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D3FB0  4B 9A 2A FD */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 806D3FB4  80 1C 06 20 */	lwz r0, 0x620(r28)
/* 806D3FB8  54 00 06 B5 */	rlwinm. r0, r0, 0, 0x1a, 0x1a
/* 806D3FBC  41 82 00 A8 */	beq lbl_806D4064
/* 806D3FC0  3C 60 80 6D */	lis r3, s_obj_sub2__FPvPv@ha /* 0x806D14E0@ha */
/* 806D3FC4  38 63 14 E0 */	addi r3, r3, s_obj_sub2__FPvPv@l /* 0x806D14E0@l */
/* 806D3FC8  7F 84 E3 78 */	mr r4, r28
/* 806D3FCC  4B 94 D3 6D */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 806D3FE0  4B B9 CC 25 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 806D3FE4  B0 7C 0A 1E */	sth r3, 0xa1e(r28)
/* 806D3FE8  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 806D3FEC  4B B9 39 A1 */	bl cM_rndFX__Ff
...
/* 806D409C  4B C7 33 01 */	bl PSVECSquareDistance
...
/* 806D410C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D4110  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806D417C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D4180  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806D4194  4B B9 CA 71 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806D41B8  4B B9 C5 89 */	bl cLib_chaseF__FPfff
...
/* 806D4274  4B C8 DF B1 */	bl _restgpr_28
