...
/* 806D59E8  3C 60 80 6D */	lis r3, lit_3906@ha /* 0x806D79A0@ha */
/* 806D59EC  3B E3 79 A0 */	addi r31, r3, lit_3906@l /* 0x806D79A0@l */
...
/* 806D5A08  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5A0C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5A10  4B C7 0A A1 */	bl PSMTXCopy
...
/* 806D5A3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5A40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5A44  38 81 00 2C */	addi r4, r1, 0x2c
/* 806D5A48  38 BE 05 38 */	addi r5, r30, 0x538
/* 806D5A4C  4B C7 13 21 */	bl PSMTXMultVec
...
/* 806D5AA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5AAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5AB0  38 81 00 2C */	addi r4, r1, 0x2c
/* 806D5AB4  38 A1 00 20 */	addi r5, r1, 0x20
/* 806D5AB8  4B C7 12 B5 */	bl PSMTXMultVec
/* 806D5ABC  38 7E 09 2C */	addi r3, r30, 0x92c
/* 806D5AC0  38 81 00 20 */	addi r4, r1, 0x20
/* 806D5AC4  4B B9 9B 85 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 806D5AD8  4B B9 9C 31 */	bl SetR__8cM3dGSphFf
/* 806D5ADC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D5AE0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D5AE4  38 63 23 3C */	addi r3, r3, 0x233c
/* 806D5AE8  38 9E 08 08 */	addi r4, r30, 0x808
/* 806D5AEC  4B B8 F0 BD */	bl Set__4cCcSFP8cCcD_Obj
...
/* 806D5B38  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5B3C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5B40  4B C7 09 71 */	bl PSMTXCopy
...
/* 806D5B60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5B64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5B68  38 81 00 2C */	addi r4, r1, 0x2c
/* 806D5B6C  38 BE 05 38 */	addi r5, r30, 0x538
/* 806D5B70  4B C7 11 FD */	bl PSMTXMultVec
...
/* 806D5BCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5BD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5BD4  38 81 00 2C */	addi r4, r1, 0x2c
/* 806D5BD8  38 A1 00 20 */	addi r5, r1, 0x20
/* 806D5BDC  4B C7 11 91 */	bl PSMTXMultVec
/* 806D5BE0  38 7E 09 2C */	addi r3, r30, 0x92c
/* 806D5BE4  38 81 00 20 */	addi r4, r1, 0x20
/* 806D5BE8  4B B9 9A 61 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 806D5BFC  4B B9 9B 0D */	bl SetR__8cM3dGSphFf
/* 806D5C00  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D5C04  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D5C08  38 63 23 3C */	addi r3, r3, 0x233c
/* 806D5C0C  38 9E 08 08 */	addi r4, r30, 0x808
/* 806D5C10  4B B8 EF 99 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 806D5C48  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5C4C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5C50  4B C7 08 61 */	bl PSMTXCopy
...
/* 806D5C64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5C68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5C6C  38 81 00 2C */	addi r4, r1, 0x2c
/* 806D5C70  38 BE 05 38 */	addi r5, r30, 0x538
/* 806D5C74  4B C7 10 F9 */	bl PSMTXMultVec
...
/* 806D5CB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D5CBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D5CC0  38 81 00 2C */	addi r4, r1, 0x2c
/* 806D5CC4  38 A1 00 20 */	addi r5, r1, 0x20
/* 806D5CC8  4B C7 10 A5 */	bl PSMTXMultVec
/* 806D5CCC  38 7E 09 2C */	addi r3, r30, 0x92c
/* 806D5CD0  38 81 00 20 */	addi r4, r1, 0x20
/* 806D5CD4  4B B9 99 75 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 806D5CE8  4B B9 9A 21 */	bl SetR__8cM3dGSphFf
/* 806D5CEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D5CF0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D5CF4  38 63 23 3C */	addi r3, r3, 0x233c
/* 806D5CF8  38 9E 08 08 */	addi r4, r30, 0x808
/* 806D5CFC  4B B8 EE AD */	bl Set__4cCcSFP8cCcD_Obj
