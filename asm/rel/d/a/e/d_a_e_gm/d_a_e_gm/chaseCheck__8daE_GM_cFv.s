...
/* 806D4D2C  4B C8 D4 B1 */	bl _savegpr_29
/* 806D4D30  7C 7F 1B 78 */	mr r31, r3
/* 806D4D34  3C 60 80 6D */	lis r3, lit_3906@ha /* 0x806D79A0@ha */
/* 806D4D38  3B C3 79 A0 */	addi r30, r3, lit_3906@l /* 0x806D79A0@l */
/* 806D4D3C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D4D40  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806D4D5C  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D7EC4@ha */
/* 806D4D60  38 63 7E C4 */	addi r3, r3, l_HIO@l /* 0x806D7EC4@l */
...
/* 806D4DB0  4B C7 25 ED */	bl PSVECSquareDistance
...
/* 806D4E20  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D4E24  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806D4E90  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D4E94  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806D4E98:
...
/* 806D4EE0  4B C8 D3 49 */	bl _restgpr_29
