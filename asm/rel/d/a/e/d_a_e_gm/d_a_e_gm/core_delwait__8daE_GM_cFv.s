...
/* 806D3338  4B 95 9D 35 */	bl dComIfGp_getReverb__Fi
...
/* 806D334C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806D3350  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806D3364  3D 00 80 6D */	lis r8, lit_3908@ha /* 0x806D79A8@ha */
/* 806D3368  C0 28 79 A8 */	lfs f1, lit_3908@l(r8)  /* 0x806D79A8@l */
/* 806D336C  FC 40 08 90 */	fmr f2, f1
/* 806D3370  3D 00 80 6D */	lis r8, lit_4100@ha /* 0x806D79E4@ha */
/* 806D3374  C0 68 79 E4 */	lfs f3, lit_4100@l(r8)  /* 0x806D79E4@l */
/* 806D3378  FC 80 18 90 */	fmr f4, f3
/* 806D337C  39 00 00 00 */	li r8, 0
/* 806D3380  4B BD 86 05 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806D3398  4B 94 97 41 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
...
/* 806D33C8  3C 80 80 6D */	lis r4, struct_806D7F1C+0x2@ha /* 0x806D7F1E@ha */
/* 806D33CC  88 04 7F 1E */	lbz r0, struct_806D7F1C+0x2@l(r4)  /* 0x806D7F1E@l */
/* 806D33D0  28 00 00 00 */	cmplwi r0, 0
/* 806D33D4  40 82 00 64 */	bne lbl_806D3438
/* 806D33D8  4B 94 68 A5 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 806D33E8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806D33EC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806D3404  3D 00 80 6D */	lis r8, lit_3908@ha /* 0x806D79A8@ha */
/* 806D3408  C0 28 79 A8 */	lfs f1, lit_3908@l(r8)  /* 0x806D79A8@l */
/* 806D340C  FC 40 08 90 */	fmr f2, f1
/* 806D3410  3D 00 80 6D */	lis r8, lit_4100@ha /* 0x806D79E4@ha */
/* 806D3414  C0 68 79 E4 */	lfs f3, lit_4100@l(r8)  /* 0x806D79E4@l */
/* 806D3418  FC 80 18 90 */	fmr f4, f3
/* 806D341C  39 00 00 00 */	li r8, 0
/* 806D3420  4B BD 85 65 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 806D3424  3C 60 80 6D */	lis r3, struct_806D7F1C+0x2@ha /* 0x806D7F1E@ha */
/* 806D3428  38 83 7F 1E */	addi r4, r3, struct_806D7F1C+0x2@l /* 0x806D7F1E@l */
