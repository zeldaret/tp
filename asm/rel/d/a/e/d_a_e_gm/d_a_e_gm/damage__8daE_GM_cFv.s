...
/* 806D2A04  3C 60 80 6D */	lis r3, lit_3906@ha /* 0x806D79A0@ha */
/* 806D2A08  3B E3 79 A0 */	addi r31, r3, lit_3906@l /* 0x806D79A0@l */
/* 806D2A0C  80 1E 0A 3C */	lwz r0, 0xa3c(r30)
/* 806D2A10  2C 00 00 00 */	cmpwi r0, 0
/* 806D2A14  40 82 01 44 */	bne lbl_806D2B58
/* 806D2A18  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D2A1C  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D2A20  38 80 00 06 */	li r4, 6
/* 806D2A24  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D2A28  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D2A2C  3C A5 00 02 */	addis r5, r5, 2
/* 806D2A30  38 C0 00 80 */	li r6, 0x80
/* 806D2A34  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D2A38  4B 96 98 B5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D2A58  4B 93 E4 19 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D2A78  4B B9 4F 15 */	bl cM_rndFX__Ff
...
/* 806D2A8C  4B B9 4F 01 */	bl cM_rndFX__Ff
...
/* 806D2AB8  4B B9 4E 9D */	bl cM_rndF__Ff
...
/* 806D2B28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D2B2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D2B30  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806D2B34  7C 05 07 74 */	extsb r5, r0
/* 806D2B38  4B 96 26 C9 */	bl onSwitch__10dSv_info_cFii
lbl_806D2B3C:
...
/* 806D2B74  4B B9 CE C9 */	bl cLib_addCalc2__FPffff
/* 806D2B78  A8 1E 0A 1E */	lha r0, 0xa1e(r30)
/* 806D2B7C  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 806D2B80  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806D2B84  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
lbl_806D2BBC:
/* 806D2BBC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806D2BC0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806D2BE8  4B 94 7A 79 */	bl fopAcM_posMove__FP10fopAc_ac_cPC4cXyz
/* 806D2BEC  38 7E 05 F4 */	addi r3, r30, 0x5f4
/* 806D2BF0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D2BF4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D2BF8  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D2BFC  4B 9A 3E B1 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 806D2C30  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D2C34  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D2C38  38 80 00 07 */	li r4, 7
/* 806D2C3C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D2C40  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D2C44  3C A5 00 02 */	addis r5, r5, 2
/* 806D2C48  38 C0 00 80 */	li r6, 0x80
/* 806D2C4C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D2C50  4B 96 96 9D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D2C70  4B 93 E2 01 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D2C94  4B B9 D8 AD */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D2CAC  4B B9 D8 95 */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D2D2C  3C 60 80 6D */	lis r3, struct_806D7F1C+0x2@ha /* 0x806D7F1E@ha */
/* 806D2D30  88 03 7F 1E */	lbz r0, struct_806D7F1C+0x2@l(r3)  /* 0x806D7F1E@l */
...
/* 806D2D4C  4B 95 A3 21 */	bl dComIfGp_getReverb__Fi
...
/* 806D2D60  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806D2D64  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806D2D8C  4B BD 8B F9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 806D2D90  7F C3 F3 78 */	mr r3, r30
/* 806D2D94  4B FF F4 11 */	bl create_item__8daE_GM_cFv
/* 806D2D98  7F C3 F3 78 */	mr r3, r30
/* 806D2D9C  4B 94 6E E1 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 806D2DA0  3C 60 80 6D */	lis r3, struct_806D7F1C+0x2@ha /* 0x806D7F1E@ha */
/* 806D2DA4  38 83 7F 1E */	addi r4, r3, struct_806D7F1C+0x2@l /* 0x806D7F1E@l */
