...
/* 806D4F14  4B C8 D2 C9 */	bl _savegpr_29
/* 806D4F18  7C 7E 1B 78 */	mr r30, r3
/* 806D4F1C  3C 80 80 6D */	lis r4, lit_3906@ha /* 0x806D79A0@ha */
/* 806D4F20  3B E4 79 A0 */	addi r31, r4, lit_3906@l /* 0x806D79A0@l */
...
/* 806D4F38  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D4F3C  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D4F40  38 80 00 08 */	li r4, 8
/* 806D4F44  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D4F48  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D4F4C  3C A5 00 02 */	addis r5, r5, 2
/* 806D4F50  38 C0 00 80 */	li r6, 0x80
/* 806D4F54  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D4F58  4B 96 73 95 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D4F78  4B 93 BE F9 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D4FC0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D4FC4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D4FC8  83 A4 5D AC */	lwz r29, 0x5dac(r4)
/* 806D4FCC  38 9E 07 CC */	addi r4, r30, 0x7cc
/* 806D4FD0  4B 94 56 FD */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806D4FD4  38 7E 05 F4 */	addi r3, r30, 0x5f4
/* 806D4FD8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D4FDC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D4FE0  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D4FE4  4B 9A 1A C9 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 806D4FF8  3C 60 80 6D */	lis r3, lit_5469@ha /* 0x806D7D0C@ha */
/* 806D4FFC  38 83 7D 0C */	addi r4, r3, lit_5469@l /* 0x806D7D0C@l */
...
/* 806D505C  4B C7 23 41 */	bl PSVECSquareDistance
...
/* 806D50CC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D50D0  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806D513C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D5140  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806D5168  4B B9 BA 9D */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 806D516C  3C 80 80 6D */	lis r4, l_HIO@ha /* 0x806D7EC4@ha */
/* 806D5170  38 84 7E C4 */	addi r4, r4, l_HIO@l /* 0x806D7EC4@l */
...
/* 806D51CC  4B B9 27 89 */	bl cM_rndF__Ff
...
/* 806D51F0  4B B9 BA 15 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 806D51F4  7C 7D 1B 78 */	mr r29, r3
/* 806D51F8  C0 3F 01 10 */	lfs f1, 0x110(r31)
/* 806D51FC  4B B9 27 91 */	bl cM_rndFX__Ff
...
/* 806D5264  4B B9 B4 DD */	bl cLib_chaseF__FPfff
...
/* 806D527C  4B B9 B2 C5 */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D5294  4B B9 B2 AD */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D52AC  4B B9 B2 95 */	bl cLib_addCalcAngleS__FPsssss
...
/* 806D52EC  4B C8 FD E5 */	bl abs
/* 806D52F0  2C 03 04 00 */	cmpwi r3, 0x400
/* 806D52F4  40 80 00 54 */	bge lbl_806D5348
/* 806D52F8  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D52FC  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D5300  38 80 00 09 */	li r4, 9
/* 806D5304  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D5308  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D530C  3C A5 00 02 */	addis r5, r5, 2
/* 806D5310  38 C0 00 80 */	li r6, 0x80
/* 806D5314  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D5318  4B 96 6F D5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D5338  4B 93 BB 39 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D537C  4B C8 FD 55 */	bl abs
/* 806D5380  2C 03 04 00 */	cmpwi r3, 0x400
/* 806D5384  40 81 00 50 */	ble lbl_806D53D4
lbl_806D5388:
/* 806D5388  3C 60 80 6D */	lis r3, d_a_e_gm__stringBase0@ha /* 0x806D7AF0@ha */
/* 806D538C  38 63 7A F0 */	addi r3, r3, d_a_e_gm__stringBase0@l /* 0x806D7AF0@l */
/* 806D5390  38 80 00 08 */	li r4, 8
/* 806D5394  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D5398  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D539C  3C A5 00 02 */	addis r5, r5, 2
/* 806D53A0  38 C0 00 80 */	li r6, 0x80
/* 806D53A4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D53A8  4B 96 6F 45 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D53C8  4B 93 BA A9 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D5448  4B C8 CD E1 */	bl _restgpr_29
