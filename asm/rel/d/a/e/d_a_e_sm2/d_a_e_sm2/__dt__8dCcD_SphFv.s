...
/* 8079CB48  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 8079CB4C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 8079CB6C  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 8079CB70  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
...
/* 8079CB88  3C 60 80 7A */	lis r3, __vt__8cM3dGSph@ha /* 0x8079DAEC@ha */
/* 8079CB8C  38 03 DA EC */	addi r0, r3, __vt__8cM3dGSph@l /* 0x8079DAEC@l */
/* 8079CB90  90 1E 01 34 */	stw r0, 0x134(r30)
lbl_8079CB94:
/* 8079CB94  34 1E 01 04 */	addic. r0, r30, 0x104
/* 8079CB98  41 82 00 24 */	beq lbl_8079CBBC
/* 8079CB9C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8079CBA0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8079CBA4  90 1E 01 20 */	stw r0, 0x120(r30)
/* 8079CBA8  34 1E 01 04 */	addic. r0, r30, 0x104
/* 8079CBAC  41 82 00 10 */	beq lbl_8079CBBC
/* 8079CBB0  3C 60 80 7A */	lis r3, __vt__8cM3dGAab@ha /* 0x8079DAE0@ha */
/* 8079CBB4  38 03 DA E0 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8079DAE0@l */
/* 8079CBB8  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_8079CBBC:
/* 8079CBBC  7F C3 F3 78 */	mr r3, r30
/* 8079CBC0  38 80 00 00 */	li r4, 0
/* 8079CBC4  4B 8E 75 21 */	bl __dt__12dCcD_GObjInfFv
/* 8079CBC8  7F E0 07 35 */	extsh. r0, r31
/* 8079CBCC  40 81 00 0C */	ble lbl_8079CBD8
/* 8079CBD0  7F C3 F3 78 */	mr r3, r30
/* 8079CBD4  4B B3 21 69 */	bl __dl__FPv
lbl_8079CBD8:
