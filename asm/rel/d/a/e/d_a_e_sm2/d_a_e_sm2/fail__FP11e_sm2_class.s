...
/* 8079A3C4  3C 60 80 7A */	lis r3, lit_3790@ha /* 0x8079D5B0@ha */
/* 8079A3C8  3B E3 D5 B0 */	addi r31, r3, lit_3790@l /* 0x8079D5B0@l */
...
/* 8079A414  4B AD 56 29 */	bl cLib_addCalc2__FPffff
...
/* 8079A434  4B AD 56 4D */	bl cLib_addCalc0__FPfff
...
lbl_8079A494:
/* 8079A494  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8079A498  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8079A49C  38 63 5B 54 */	addi r3, r3, 0x5b54
/* 8079A4A0  7F C4 F3 78 */	mr r4, r30
/* 8079A4A4  88 1E 05 B7 */	lbz r0, 0x5b7(r30)
/* 8079A4A8  3C A0 80 7A */	lis r5, item_no@ha /* 0x8079D874@ha */
/* 8079A4AC  38 A5 D8 74 */	addi r5, r5, item_no@l /* 0x8079D874@l */
...
/* 8079A4C8  4B 8D 95 41 */	bl request__11dAttCatch_cFP10fopAc_ac_cUcfffsi
...
/* 8079A4F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8079A4F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8079A50C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8079A510  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8079A514  80 84 00 00 */	lwz r4, 0(r4)
/* 8079A518  4B BA BF 99 */	bl PSMTXCopy
...
/* 8079A534  4B AD 69 B9 */	bl MtxPosition__FP4cXyzP4cXyz
