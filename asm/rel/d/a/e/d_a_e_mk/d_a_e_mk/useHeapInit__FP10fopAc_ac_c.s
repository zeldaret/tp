...
/* 8071BA44  4B C4 67 95 */	bl _savegpr_28
/* 8071BA48  7C 7F 1B 78 */	mr r31, r3
/* 8071BA4C  38 60 00 58 */	li r3, 0x58
/* 8071BA50  4B BB 31 FD */	bl __nw__FUl
/* 8071BA54  7C 7E 1B 79 */	or. r30, r3, r3
/* 8071BA58  41 82 00 94 */	beq lbl_8071BAEC
/* 8071BA5C  3C 60 80 72 */	lis r3, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071BA60  38 63 C7 E8 */	addi r3, r3, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071BA64  38 80 00 28 */	li r4, 0x28
/* 8071BA68  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071BA6C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8071BA80  4B 92 08 6D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8071BA84  7C 7D 1B 78 */	mr r29, r3
/* 8071BA88  3C 60 80 72 */	lis r3, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071BA8C  38 63 C7 E8 */	addi r3, r3, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071BA90  38 80 00 30 */	li r4, 0x30
/* 8071BA94  7F 85 E3 78 */	mr r5, r28
/* 8071BA98  38 C0 00 80 */	li r6, 0x80
/* 8071BA9C  4B 92 08 51 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8071BAD4  3D 20 80 72 */	lis r9, lit_3778@ha /* 0x8071C548@ha */
/* 8071BAD8  C0 29 C5 48 */	lfs f1, lit_3778@l(r9)  /* 0x8071C548@l */
/* 8071BADC  39 20 00 00 */	li r9, 0
/* 8071BAE0  39 40 FF FF */	li r10, -1
/* 8071BAE4  4B 8F 4C ED */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8071BB14  4B BB 31 39 */	bl __nw__FUl
/* 8071BB18  7C 7E 1B 79 */	or. r30, r3, r3
/* 8071BB1C  41 82 00 20 */	beq lbl_8071BB3C
/* 8071BB20  3C 80 80 72 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x8071CA44@ha */
/* 8071BB24  38 04 CA 44 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x8071CA44@l */
/* 8071BB28  90 1E 00 00 */	stw r0, 0(r30)
/* 8071BB2C  38 80 00 00 */	li r4, 0
/* 8071BB30  4B C0 C8 CD */	bl init__12J3DFrameCtrlFs
...
lbl_8071BB54:
/* 8071BB54  3C 60 80 72 */	lis r3, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071BB58  38 63 C7 E8 */	addi r3, r3, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071BB5C  38 80 00 37 */	li r4, 0x37
/* 8071BB60  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071BB64  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8071BB78  4B 92 07 75 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8071BB9C  3D 00 80 72 */	lis r8, lit_3778@ha /* 0x8071C548@ha */
/* 8071BBA0  C0 28 C5 48 */	lfs f1, lit_3778@l(r8)  /* 0x8071C548@l */
/* 8071BBA4  39 00 00 00 */	li r8, 0
/* 8071BBA8  39 20 FF FF */	li r9, -1
/* 8071BBAC  4B 8F 19 A1 */	bl init__13mDoExt_btpAnmFP16J3DMaterialTableP16J3DAnmTexPatterniifss
...
/* 8071BBC4  4B BB 30 89 */	bl __nw__FUl
/* 8071BBC8  7C 7D 1B 79 */	or. r29, r3, r3
/* 8071BBCC  41 82 00 8C */	beq lbl_8071BC58
/* 8071BBD0  3C 60 80 72 */	lis r3, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071BBD4  38 63 C7 E8 */	addi r3, r3, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071BBD8  38 80 00 29 */	li r4, 0x29
/* 8071BBDC  7F C5 F3 78 */	mr r5, r30
/* 8071BBE0  38 C0 00 80 */	li r6, 0x80
/* 8071BBE4  4B 92 07 09 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8071BBE8  7C 7C 1B 78 */	mr r28, r3
/* 8071BBEC  3C 60 80 72 */	lis r3, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071BBF0  38 63 C7 E8 */	addi r3, r3, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071BBF4  38 80 00 31 */	li r4, 0x31
/* 8071BBF8  7F C5 F3 78 */	mr r5, r30
/* 8071BBFC  38 C0 00 80 */	li r6, 0x80
/* 8071BC00  4B 92 06 ED */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8071BC40  3D 20 80 72 */	lis r9, lit_3778@ha /* 0x8071C548@ha */
/* 8071BC44  C0 29 C5 48 */	lfs f1, lit_3778@l(r9)  /* 0x8071C548@l */
/* 8071BC48  39 20 00 00 */	li r9, 0
/* 8071BC4C  39 40 FF FF */	li r10, -1
/* 8071BC50  4B 8F 3F FD */	bl __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
lbl_8071BC7C:
/* 8071BC7C  3C 60 80 72 */	lis r3, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071BC80  38 63 C7 E8 */	addi r3, r3, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071BC84  38 80 00 2E */	li r4, 0x2e
/* 8071BC88  7F C5 F3 78 */	mr r5, r30
/* 8071BC8C  38 C0 00 80 */	li r6, 0x80
/* 8071BC90  4B 92 06 5D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8071BCA0  4B 8F 8F B5 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8071BCB8  4B C4 65 6D */	bl _restgpr_28
