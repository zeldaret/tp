...
/* 8071BD24  4B C4 64 B1 */	bl _savegpr_27
/* 8071BD28  7C 7E 1B 78 */	mr r30, r3
/* 8071BD2C  3C 80 80 72 */	lis r4, lit_1109@ha /* 0x8071CA68@ha */
/* 8071BD30  3B A4 CA 68 */	addi r29, r4, lit_1109@l /* 0x8071CA68@l */
/* 8071BD34  3C 80 80 72 */	lis r4, lit_3777@ha /* 0x8071C544@ha */
/* 8071BD38  3B E4 C5 44 */	addi r31, r4, lit_3777@l /* 0x8071C544@l */
...
/* 8071BD64  3C 80 80 72 */	lis r4, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071BD68  38 84 C7 E8 */	addi r4, r4, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071BD6C  4B 91 11 51 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 8071BD70  7C 7C 1B 78 */	mr r28, r3
/* 8071BD74  2C 1C 00 04 */	cmpwi r28, 4
/* 8071BD78  40 82 03 FC */	bne lbl_8071C174
/* 8071BD7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071BD80  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071BD84  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8071BD88  3C 80 80 72 */	lis r4, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071BD8C  38 84 C7 E8 */	addi r4, r4, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071BD90  38 84 00 0C */	addi r4, r4, 0xc
/* 8071BD94  4B C4 CC 01 */	bl strcmp
/* 8071BD98  2C 03 00 00 */	cmpwi r3, 0
/* 8071BD9C  40 82 00 28 */	bne lbl_8071BDC4
/* 8071BDA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071BDA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071BDA8  38 63 09 58 */	addi r3, r3, 0x958
/* 8071BDAC  38 80 00 07 */	li r4, 7
/* 8071BDB0  4B 91 8B 85 */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 8071BDD4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071BDD8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071BDDC  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8071BDE0  7C 05 07 74 */	extsb r5, r0
/* 8071BDE4  4B 91 95 7D */	bl isSwitch__10dSv_info_cCFii
...
/* 8071BE04  3C 80 80 72 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x8071BA34@ha */
/* 8071BE08  38 84 BA 34 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x8071BA34@l */
/* 8071BE0C  38 A0 56 F0 */	li r5, 0x56f0
/* 8071BE10  4B 8F E6 A1 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8071BE78  4B 8F E6 B1 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 8071BE8C  4B 8F E6 AD */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 8071BEB8  4B 95 A3 91 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 8071BEBC  38 7E 07 20 */	addi r3, r30, 0x720
/* 8071BEC0  C0 3F 02 64 */	lfs f1, 0x264(r31)
/* 8071BEC4  C0 5F 00 88 */	lfs f2, 0x88(r31)
/* 8071BEC8  4B 95 A0 91 */	bl SetWall__12dBgS_AcchCirFff
...
/* 8071BEEC  4B BA 51 A9 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 8071BF10  4B 96 79 51 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 8071BF14  38 7E 0A D0 */	addi r3, r30, 0xad0
/* 8071BF18  3C 80 80 72 */	lis r4, cc_sph_src@ha /* 0x8071C978@ha */
/* 8071BF1C  38 84 C9 78 */	addi r4, r4, cc_sph_src@l /* 0x8071C978@l */
/* 8071BF20  4B 96 8B 15 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
/* 8071BF24  38 1E 09 5C */	addi r0, r30, 0x95c
/* 8071BF28  90 1E 0B 14 */	stw r0, 0xb14(r30)
/* 8071BF2C  38 7E 09 98 */	addi r3, r30, 0x998
/* 8071BF30  3C 80 80 72 */	lis r4, cc_sph_src@ha /* 0x8071C978@ha */
/* 8071BF34  38 84 C9 78 */	addi r4, r4, cc_sph_src@l /* 0x8071C978@l */
/* 8071BF38  4B 96 8A FD */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 8071C014  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071C018  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071C01C  7F 64 DB 78 */	mr r4, r27
/* 8071C020  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8071C024  7C 05 07 74 */	extsb r5, r0
/* 8071C028  4B 91 93 39 */	bl isSwitch__10dSv_info_cCFii
/* 8071C02C  2C 03 00 00 */	cmpwi r3, 0
/* 8071C030  41 82 00 44 */	beq lbl_8071C074
/* 8071C034  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071C038  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071C03C  7F 64 DB 78 */	mr r4, r27
/* 8071C040  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8071C044  7C 05 07 74 */	extsb r5, r0
/* 8071C048  4B 91 92 69 */	bl offSwitch__10dSv_info_cFii
/* 8071C04C  38 00 00 00 */	li r0, 0
/* 8071C050  B0 1E 06 B6 */	sth r0, 0x6b6(r30)
/* 8071C054  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8071C058  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8071C06C  4B B9 34 31 */	bl subBgmStart__8Z2SeqMgrFUl
...
/* 8071C0E0  4B 8F DE 11 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 8071C13C  4B 8F DD B5 */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 8071C17C  4B C4 60 A5 */	bl _restgpr_27
