...
/* 8071492C  4B C4 D8 A5 */	bl _savegpr_26
/* 80714930  7C 7C 1B 78 */	mr r28, r3
/* 80714934  3C 60 80 72 */	lis r3, lit_3777@ha /* 0x8071C544@ha */
/* 80714938  3B C3 C5 44 */	addi r30, r3, lit_3777@l /* 0x8071C544@l */
/* 8071493C  38 A0 00 00 */	li r5, 0
/* 80714940  3C 60 80 72 */	lis r3, target_info_count@ha /* 0x8071CB8C@ha */
/* 80714944  90 A3 CB 8C */	stw r5, target_info_count@l(r3)  /* 0x8071CB8C@l */
/* 80714948  7C A3 2B 78 */	mr r3, r5
/* 8071494C  3C 80 80 72 */	lis r4, target_info@ha /* 0x8071CB3C@ha */
/* 80714950  38 84 CB 3C */	addi r4, r4, target_info@l /* 0x8071CB3C@l */
...
/* 80714968  3C 60 80 71 */	lis r3, s_d_sub__FPvPv@ha /* 0x80714874@ha */
/* 8071496C  38 63 48 74 */	addi r3, r3, s_d_sub__FPvPv@l /* 0x80714874@l */
/* 80714970  7F 84 E3 78 */	mr r4, r28
/* 80714974  4B 90 C9 C5 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 80714978  C3 DE 00 4C */	lfs f30, 0x4c(r30)
/* 8071497C  3C 60 80 72 */	lis r3, target_info_count@ha /* 0x8071CB8C@ha */
/* 80714980  3B E3 CB 8C */	addi r31, r3, target_info_count@l /* 0x8071CB8C@l */
...
/* 807149AC  4B B5 21 89 */	bl __mi__4cXyzCFRC3Vec
...
/* 807149CC  4B C3 27 6D */	bl PSVECSquareMag
...
/* 80714A38  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80714A3C  C3 83 0A E0 */	lfs f28, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80714AA8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80714AAC  C3 83 0A E0 */	lfs f28, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 80714AB0  48 00 00 08 */	b lbl_80714AB8
lbl_80714AB4:
/* 80714AB4  FF 80 08 90 */	fmr f28, f1
lbl_80714AB8:
/* 80714AB8  C0 3E 00 04 */	lfs f1, 4(r30)
/* 80714ABC  4B B5 2E 99 */	bl cM_rndF__Ff
...
lbl_80714B14:
/* 80714B14  3C 60 80 72 */	lis r3, target_info@ha /* 0x8071CB3C@ha */
/* 80714B18  3B 63 CB 3C */	addi r27, r3, target_info@l /* 0x8071CB3C@l */
...
/* 80714B64  4B C4 D6 B9 */	bl _restgpr_26
