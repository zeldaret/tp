...
/* 8071A23C  4B C4 7F 9D */	bl _savegpr_28
/* 8071A240  7C 7D 1B 78 */	mr r29, r3
/* 8071A244  3C 80 80 72 */	lis r4, lit_3777@ha /* 0x8071C544@ha */
/* 8071A248  3B E4 C5 44 */	addi r31, r4, lit_3777@l /* 0x8071C544@l */
/* 8071A24C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071A250  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8071A274  3C 80 80 72 */	lis r4, lit_6176@ha /* 0x8071C8B0@ha */
/* 8071A278  38 84 C8 B0 */	addi r4, r4, lit_6176@l /* 0x8071C8B0@l */
...
/* 8071A2A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071A2A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071A2A8  A0 03 4F A2 */	lhz r0, 0x4fa2(r3)
/* 8071A2AC  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c
/* 8071A2B0  41 82 01 18 */	beq lbl_8071A3C8
/* 8071A2B4  3C 60 80 72 */	lis r3, s_ks_sub__FPvPv@ha /* 0x80719488@ha */
/* 8071A2B8  38 63 94 88 */	addi r3, r3, s_ks_sub__FPvPv@l /* 0x80719488@l */
/* 8071A2BC  7F A4 EB 78 */	mr r4, r29
/* 8071A2C0  4B 90 70 79 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 8071A2DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071A2E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071A2E4  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8071A2E8  7C 05 07 74 */	extsb r5, r0
/* 8071A2EC  4B 91 AF 15 */	bl onSwitch__10dSv_info_cFii
lbl_8071A2F0:
...
/* 8071A300  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071A304  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071A308  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 8071A30C  7C 05 07 74 */	extsb r5, r0
/* 8071A310  4B 91 AE F1 */	bl onSwitch__10dSv_info_cFii
lbl_8071A314:
/* 8071A314  3C 60 80 72 */	lis r3, d_a_e_mk__stringBase0@ha /* 0x8071C7E8@ha */
/* 8071A318  38 63 C7 E8 */	addi r3, r3, d_a_e_mk__stringBase0@l /* 0x8071C7E8@l */
/* 8071A31C  38 63 00 05 */	addi r3, r3, 5
/* 8071A320  38 80 00 00 */	li r4, 0
/* 8071A324  38 A0 00 04 */	li r5, 4
/* 8071A328  38 C0 00 00 */	li r6, 0
/* 8071A32C  4B 91 32 29 */	bl dComIfGp_setNextStage__FPCcsScSc
...
/* 8071A378  4B A6 68 A1 */	bl Reset__9dCamera_cF4cXyz4cXyz
/* 8071A37C  38 7E 02 48 */	addi r3, r30, 0x248
/* 8071A380  4B A4 71 2D */	bl Start__9dCamera_cFv
/* 8071A384  38 7E 02 48 */	addi r3, r30, 0x248
/* 8071A388  38 80 00 00 */	li r4, 0
/* 8071A38C  4B A4 8C 81 */	bl SetTrimSize__9dCamera_cFl
/* 8071A390  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071A394  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071A398  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8071A39C  4B 92 80 CD */	bl reset__14dEvt_control_cFv
/* 8071A3A0  38 00 00 00 */	li r0, 0
/* 8071A3A4  B0 1D 0C 30 */	sth r0, 0xc30(r29)
/* 8071A3A8  B0 1D 0C 32 */	sth r0, 0xc32(r29)
/* 8071A3AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071A3B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8071A3D4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8071A3D8  38 E3 9A 20 */	addi r7, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8071A524  4B C4 7D 01 */	bl _restgpr_28
