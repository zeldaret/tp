...
/* 8071A548  4B C4 7C 91 */	bl _savegpr_28
/* 8071A54C  7C 7E 1B 78 */	mr r30, r3
/* 8071A550  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071A554  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071A558  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8071A55C  4B 90 04 09 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8071A560  D0 3E 06 B8 */	stfs f1, 0x6b8(r30)
/* 8071A564  7F C3 F3 78 */	mr r3, r30
/* 8071A568  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8071A56C  4B 90 01 A5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8071A598  3C 60 80 72 */	lis r3, lit_6244@ha /* 0x8071C8DC@ha */
/* 8071A59C  38 63 C8 DC */	addi r3, r3, lit_6244@l /* 0x8071C8DC@l */
...
/* 8071A678  4B B5 5F 91 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8071A694  4B C2 C9 FD */	bl PSVECAdd
...
/* 8071A6B8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071A6BC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071A6C0  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8071A6C4  4B 95 C3 E9 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 8071A6D8  4B C2 C9 B9 */	bl PSVECAdd
lbl_8071A6DC:
...
/* 8071A708  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8071A70C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8071A710  80 84 00 00 */	lwz r4, 0(r4)
/* 8071A714  4B C2 BD 9D */	bl PSMTXCopy
/* 8071A718  3C 60 80 72 */	lis r3, lit_3780@ha /* 0x8071C550@ha */
/* 8071A71C  C0 03 C5 50 */	lfs f0, lit_3780@l(r3)  /* 0x8071C550@l */
...
/* 8071A734  4B B5 67 B9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8071A748  3C E0 80 72 */	lis r7, lit_6243@ha /* 0x8071C768@ha */
/* 8071A74C  C0 27 C7 68 */	lfs f1, lit_6243@l(r7)  /* 0x8071C768@l */
/* 8071A750  38 FE 01 0C */	addi r7, r30, 0x10c
/* 8071A754  39 00 00 00 */	li r8, 0
/* 8071A758  4B 90 28 C9 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
/* 8071A75C  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 8071A760  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8071A764  38 63 06 30 */	addi r3, r3, 0x630
/* 8071A768  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8071A76C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8071A770  80 84 00 00 */	lwz r4, 0(r4)
/* 8071A774  4B C2 BD 3D */	bl PSMTXCopy
/* 8071A778  38 61 00 14 */	addi r3, r1, 0x14
/* 8071A77C  38 81 00 08 */	addi r4, r1, 8
/* 8071A780  4B B5 67 6D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8071A794  3C E0 80 72 */	lis r7, lit_6243@ha /* 0x8071C768@ha */
/* 8071A798  C0 27 C7 68 */	lfs f1, lit_6243@l(r7)  /* 0x8071C768@l */
/* 8071A79C  38 FE 01 0C */	addi r7, r30, 0x10c
/* 8071A7A0  39 00 00 00 */	li r8, 0
/* 8071A7A4  4B 90 28 7D */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 8071A7BC  3C E0 80 72 */	lis r7, lit_6243@ha /* 0x8071C768@ha */
/* 8071A7C0  C0 27 C7 68 */	lfs f1, lit_6243@l(r7)  /* 0x8071C768@l */
/* 8071A7C4  38 FE 01 0C */	addi r7, r30, 0x10c
/* 8071A7C8  39 00 00 01 */	li r8, 1
/* 8071A7CC  4B 90 28 55 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
lbl_8071A7D0:
...
/* 8071A7F4  4B C4 7A 31 */	bl _restgpr_28
