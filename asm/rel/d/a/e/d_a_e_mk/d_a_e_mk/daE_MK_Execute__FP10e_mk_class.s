...
/* 8071AF2C  4B C4 72 A5 */	bl _savegpr_26
/* 8071AF30  7C 7F 1B 78 */	mr r31, r3
/* 8071AF34  3C 60 80 72 */	lis r3, lit_3777@ha /* 0x8071C544@ha */
/* 8071AF38  3B C3 C5 44 */	addi r30, r3, lit_3777@l /* 0x8071C544@l */
...
lbl_8071AF9C:
/* 8071AF9C  3C 60 80 72 */	lis r3, l_HIO@ha /* 0x8071CB18@ha */
/* 8071AFA0  38 63 CB 18 */	addi r3, r3, l_HIO@l /* 0x8071CB18@l */
...
/* 8071AFD8  4B B4 BB 5D */	bl __mi__4cXyzCFRC3Vec
...
/* 8071AFF8  4B C2 C1 41 */	bl PSVECSquareMag
...
/* 8071B068  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8071B06C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8071B0D8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8071B0DC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8071B0F4  4B B4 BA 41 */	bl __mi__4cXyzCFRC3Vec
...
/* 8071B114  4B C2 C0 25 */	bl PSVECSquareMag
...
/* 8071B184  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8071B188  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8071B1F4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8071B1F8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8071B1FC:
...
/* 8071B230  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8071B234  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
lbl_8071B250:
/* 8071B250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B254  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8071B26C  4B C2 B6 7D */	bl PSMTXTrans
/* 8071B270  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B274  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B278  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8071B27C  4B 8F 11 B9 */	bl mDoMtx_YrotM__FPA4_fs
/* 8071B280  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B284  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B288  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 8071B28C  4B 8F 11 11 */	bl mDoMtx_XrotM__FPA4_fs
/* 8071B290  3C 60 80 72 */	lis r3, l_HIO@ha /* 0x8071CB18@ha */
/* 8071B294  3B 83 CB 18 */	addi r28, r3, l_HIO@l /* 0x8071CB18@l */
/* 8071B298  C0 3C 00 08 */	lfs f1, 8(r28)
/* 8071B29C  FC 40 08 90 */	fmr f2, f1
/* 8071B2A0  FC 60 08 90 */	fmr f3, f1
/* 8071B2A4  4B 8F 1B 95 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8071B2A8  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 8071B2AC  83 A3 00 04 */	lwz r29, 4(r3)
/* 8071B2B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B2B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B2B8  38 9D 00 24 */	addi r4, r29, 0x24
/* 8071B2BC  4B C2 B1 F5 */	bl PSMTXCopy
/* 8071B2C0  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8071B2C4  7C 03 07 74 */	extsb r3, r0
/* 8071B2C8  4B 91 1D A5 */	bl dComIfGp_getReverb__Fi
/* 8071B2CC  7C 65 1B 78 */	mr r5, r3
/* 8071B2D0  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 8071B2D4  38 80 00 00 */	li r4, 0
/* 8071B2D8  4B 8F 5D D9 */	bl play__16mDoExt_McaMorfSOFUlSc
...
/* 8071B2EC  4B B4 C6 69 */	bl cM_rndF__Ff
...
/* 8071B388  4B 8F 5E 65 */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 8071B38C  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 8071B390  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8071B394  38 63 01 50 */	addi r3, r3, 0x150
/* 8071B398  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8071B39C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8071B3A0  80 84 00 00 */	lwz r4, 0(r4)
/* 8071B3A4  4B C2 B1 0D */	bl PSMTXCopy
...
/* 8071B3C0  4B B5 5B 2D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8071B418  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B41C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B420  4B C2 B0 91 */	bl PSMTXCopy
/* 8071B424  3C 60 80 72 */	lis r3, l_HIO@ha /* 0x8071CB18@ha */
/* 8071B428  38 63 CB 18 */	addi r3, r3, l_HIO@l /* 0x8071CB18@l */
/* 8071B42C  C0 23 00 18 */	lfs f1, 0x18(r3)
/* 8071B430  C0 43 00 1C */	lfs f2, 0x1c(r3)
/* 8071B434  C0 63 00 20 */	lfs f3, 0x20(r3)
/* 8071B438  4B 8F 19 65 */	bl transM__14mDoMtx_stack_cFfff
/* 8071B43C  80 7F 05 DC */	lwz r3, 0x5dc(r31)
/* 8071B440  80 83 00 04 */	lwz r4, 4(r3)
/* 8071B444  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B448  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B44C  38 84 00 24 */	addi r4, r4, 0x24
/* 8071B450  4B C2 B0 61 */	bl PSMTXCopy
/* 8071B454  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B458  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
lbl_8071B478:
/* 8071B478  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8071B47C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8071B480  80 63 00 00 */	lwz r3, 0(r3)
/* 8071B484  A8 9F 05 F2 */	lha r4, 0x5f2(r31)
/* 8071B488  4B 8F 0F 55 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8071B4D4  3C 60 80 72 */	lis r3, STAGE_CENTER_POS@ha /* 0x8071CAFC@ha */
/* 8071B4D8  38 63 CA FC */	addi r3, r3, STAGE_CENTER_POS@l /* 0x8071CAFC@l */
...
/* 8071B540  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8071B544  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8071B588  4B B5 44 F9 */	bl cLib_addCalc0__FPfff
/* 8071B58C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B590  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B594  C0 3F 05 E4 */	lfs f1, 0x5e4(r31)
/* 8071B598  C0 5F 05 E8 */	lfs f2, 0x5e8(r31)
/* 8071B59C  C0 7F 05 EC */	lfs f3, 0x5ec(r31)
/* 8071B5A0  4B C2 B3 49 */	bl PSMTXTrans
/* 8071B5A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B5A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B5AC  A8 9F 05 F2 */	lha r4, 0x5f2(r31)
/* 8071B5B0  4B 8F 0E 85 */	bl mDoMtx_YrotM__FPA4_fs
/* 8071B5B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B5B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B5BC  A8 1F 05 F0 */	lha r0, 0x5f0(r31)
/* 8071B5C0  7C 00 DA 14 */	add r0, r0, r27
/* 8071B5C4  7C 04 07 34 */	extsh r4, r0
/* 8071B5C8  4B 8F 0D D5 */	bl mDoMtx_XrotM__FPA4_fs
/* 8071B5CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B5D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B5D4  7F 44 D3 78 */	mr r4, r26
/* 8071B5D8  4B 8F 0E F5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8071B5DC  C0 3E 00 0C */	lfs f1, 0xc(r30)
/* 8071B5E0  C0 5E 00 80 */	lfs f2, 0x80(r30)
/* 8071B5E4  C0 7E 00 8C */	lfs f3, 0x8c(r30)
/* 8071B5E8  4B 8F 17 B5 */	bl transM__14mDoMtx_stack_cFfff
/* 8071B5EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B5F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B5F4  38 80 E0 C0 */	li r4, -8000
/* 8071B5F8  4B 8F 0D A5 */	bl mDoMtx_XrotM__FPA4_fs
/* 8071B5FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B600  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B604  38 80 C0 00 */	li r4, -16384
/* 8071B608  4B 8F 0E C5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8071B60C  80 7F 05 DC */	lwz r3, 0x5dc(r31)
/* 8071B610  80 83 00 04 */	lwz r4, 4(r3)
/* 8071B614  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B618  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B61C  38 84 00 24 */	addi r4, r4, 0x24
/* 8071B620  4B C2 AE 91 */	bl PSMTXCopy
...
/* 8071B634  4B B5 4F D5 */	bl cLib_addCalcAngleS2__FPssss
lbl_8071B638:
...
/* 8071B648  4B 8F 4F 81 */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 8071B64C  80 7F 05 DC */	lwz r3, 0x5dc(r31)
/* 8071B650  4B 8F 50 5D */	bl modelCalc__14mDoExt_McaMorfFv
lbl_8071B654:
...
/* 8071B674  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B678  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B67C  4B C2 AE 35 */	bl PSMTXCopy
/* 8071B680  3C 60 80 72 */	lis r3, l_HIO@ha /* 0x8071CB18@ha */
/* 8071B684  38 63 CB 18 */	addi r3, r3, l_HIO@l /* 0x8071CB18@l */
/* 8071B688  C0 23 00 0C */	lfs f1, 0xc(r3)
/* 8071B68C  FC 40 08 90 */	fmr f2, f1
/* 8071B690  FC 60 08 90 */	fmr f3, f1
/* 8071B694  4B 8F 17 A5 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8071B698  C0 3E 00 80 */	lfs f1, 0x80(r30)
/* 8071B69C  C0 5E 00 68 */	lfs f2, 0x68(r30)
/* 8071B6A0  C0 7E 01 38 */	lfs f3, 0x138(r30)
/* 8071B6A4  4B 8F 16 F9 */	bl transM__14mDoMtx_stack_cFfff
/* 8071B6A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B6AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B6B0  38 80 9A D4 */	li r4, -25900
/* 8071B6B4  4B 8F 0D 81 */	bl mDoMtx_YrotM__FPA4_fs
/* 8071B6B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B6BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B6C0  38 80 DD E7 */	li r4, -8729
/* 8071B6C4  4B 8F 0C D9 */	bl mDoMtx_XrotM__FPA4_fs
/* 8071B6C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B6CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B6D0  38 80 38 D8 */	li r4, 0x38d8
/* 8071B6D4  4B 8F 0D F9 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8071B6D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8071B6DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8071B6E0  80 9F 06 08 */	lwz r4, 0x608(r31)
/* 8071B6E4  38 84 00 24 */	addi r4, r4, 0x24
/* 8071B6E8  4B C2 AD C9 */	bl PSMTXCopy
lbl_8071B6EC:
...
/* 8071B744  4B 8F E7 AD */	bl fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 8071B768  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 8071B76C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8071B770  38 81 00 28 */	addi r4, r1, 0x28
/* 8071B774  4B 8F E0 85 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8071B794  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8071B798  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8071B79C  80 84 00 00 */	lwz r4, 0(r4)
/* 8071B7A0  4B C2 AD 11 */	bl PSMTXCopy
...
/* 8071B7BC  4B B5 57 31 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8071B7F0  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8071B7F4  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8071B7F8  80 84 00 00 */	lwz r4, 0(r4)
/* 8071B7FC  4B C2 AC B5 */	bl PSMTXCopy
...
/* 8071B81C  4B B5 56 D1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8071B890  4B B5 3D B9 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 8071B8A4  4B B5 3E 65 */	bl SetR__8cM3dGSphFf
/* 8071B8A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071B8AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8071B8B0  3B 63 23 3C */	addi r27, r3, 0x233c
/* 8071B8B4  7F 63 DB 78 */	mr r3, r27
/* 8071B8B8  38 9F 0A D0 */	addi r4, r31, 0xad0
/* 8071B8BC  4B B4 92 ED */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8071B8E0  4B B5 56 0D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8071B908  4B B5 3D 41 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 8071B91C  4B B5 3D ED */	bl SetR__8cM3dGSphFf
/* 8071B920  7F 63 DB 78 */	mr r3, r27
/* 8071B924  38 9F 09 98 */	addi r4, r31, 0x998
/* 8071B928  4B B4 92 81 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8071B94C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071B950  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8071B994  4B 93 10 FD */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_8071B998:
...
/* 8071B9B0  4B C4 68 6D */	bl _restgpr_26
