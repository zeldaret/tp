...
/* 80763E0C  4B BF E3 D1 */	bl _savegpr_29
/* 80763E10  7C 7D 1B 78 */	mr r29, r3
/* 80763E14  3C 80 80 76 */	lis r4, lit_3788@ha /* 0x80764D0C@ha */
/* 80763E18  3B C4 4D 0C */	addi r30, r4, lit_3788@l /* 0x80764D0C@l */
/* 80763E1C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80763E20  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80763E24  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80763E28  4B 8B 68 E9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80763E2C  B0 7D 0A 48 */	sth r3, 0xa48(r29)
/* 80763E30  7F A3 EB 78 */	mr r3, r29
/* 80763E34  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 80763E38  4B 8B 6B 2D */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80763E9C  4B 8B 5B 21 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80763ED8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80763EDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80763EE0  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 80763EE4  C0 7D 04 D4 */	lfs f3, 0x4d4(r29)
/* 80763EE8  C0 5D 0A 20 */	lfs f2, 0xa20(r29)
/* 80763EEC  3C 80 80 76 */	lis r4, l_HIO@ha /* 0x80764F90@ha */
/* 80763EF0  3B E4 4F 90 */	addi r31, r4, l_HIO@l /* 0x80764F90@l */
...
/* 80763F04  4B BE 29 E5 */	bl PSMTXTrans
/* 80763F08  A8 1D 0A 42 */	lha r0, 0xa42(r29)
/* 80763F0C  2C 00 00 0A */	cmpwi r0, 0xa
/* 80763F10  40 82 00 14 */	bne lbl_80763F24
/* 80763F14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80763F18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80763F1C  A8 9D 0A 58 */	lha r4, 0xa58(r29)
/* 80763F20  4B 8A 85 15 */	bl mDoMtx_YrotM__FPA4_fs
lbl_80763F24:
/* 80763F24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80763F28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80763F2C  A8 9D 0A 52 */	lha r4, 0xa52(r29)
/* 80763F30  4B 8A 85 05 */	bl mDoMtx_YrotM__FPA4_fs
/* 80763F34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80763F38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80763F3C  A8 9D 0A 54 */	lha r4, 0xa54(r29)
/* 80763F40  4B 8A 84 5D */	bl mDoMtx_XrotM__FPA4_fs
/* 80763F44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80763F48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80763F4C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80763F50  4B 8A 84 E5 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80763F74  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80763F78  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80763F98  4B B0 BA E9 */	bl cLib_addCalc0__FPfff
lbl_80763F9C:
...
/* 80763FC4  4B 8A 8E AD */	bl scaleM__14mDoMtx_stack_cFRC4cXyz
/* 80763FC8  80 7D 09 68 */	lwz r3, 0x968(r29)
/* 80763FCC  80 83 00 04 */	lwz r4, 4(r3)
/* 80763FD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80763FD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80763FD8  38 84 00 24 */	addi r4, r4, 0x24
/* 80763FDC  4B BE 24 D5 */	bl PSMTXCopy
/* 80763FE0  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80763FE4  7C 03 07 74 */	extsb r3, r0
/* 80763FE8  4B 8C 90 85 */	bl dComIfGp_getReverb__Fi
/* 80763FEC  7C 65 1B 78 */	mr r5, r3
/* 80763FF0  80 7D 09 68 */	lwz r3, 0x968(r29)
/* 80763FF4  38 80 00 00 */	li r4, 0
/* 80763FF8  4B 8A D0 B9 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 80763FFC  80 7D 09 68 */	lwz r3, 0x968(r29)
/* 80764000  4B 8A D1 ED */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 80764094  4B B0 B5 B5 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 807640A8  4B B0 B6 61 */	bl SetR__8cM3dGSphFf
/* 807640AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807640B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807640B4  38 63 23 3C */	addi r3, r3, 0x233c
/* 807640B8  38 9D 08 0C */	addi r4, r29, 0x80c
/* 807640BC  4B B0 0A ED */	bl Set__4cCcSFP8cCcD_Obj
...
/* 807640F0  4B BF E1 39 */	bl _restgpr_29
