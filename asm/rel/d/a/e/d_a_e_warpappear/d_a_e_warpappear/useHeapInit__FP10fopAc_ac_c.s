...
/* 807D1C9C  4B B9 05 41 */	bl _savegpr_29
/* 807D1CA0  7C 7E 1B 78 */	mr r30, r3
/* 807D1CA4  3C 60 80 7D */	lis r3, d_a_e_warpappear__stringBase0@ha /* 0x807D2280@ha */
/* 807D1CA8  38 63 22 80 */	addi r3, r3, d_a_e_warpappear__stringBase0@l /* 0x807D2280@l */
/* 807D1CAC  38 63 00 08 */	addi r3, r3, 8
/* 807D1CB0  38 80 00 05 */	li r4, 5
/* 807D1CB4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D1CB8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807D1CCC  4B 86 A6 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807D1CDC  4B 84 2F 79 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 807D1CFC  4B AF CF 51 */	bl __nw__FUl
/* 807D1D00  7C 7D 1B 79 */	or. r29, r3, r3
/* 807D1D04  41 82 00 20 */	beq lbl_807D1D24
/* 807D1D08  3C 80 80 7D */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x807D2368@ha */
/* 807D1D0C  38 04 23 68 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x807D2368@l */
/* 807D1D10  90 1D 00 00 */	stw r0, 0(r29)
/* 807D1D14  38 80 00 00 */	li r4, 0
/* 807D1D18  4B B5 66 E5 */	bl init__12J3DFrameCtrlFs
...
lbl_807D1D3C:
/* 807D1D3C  3C 60 80 7D */	lis r3, d_a_e_warpappear__stringBase0@ha /* 0x807D2280@ha */
/* 807D1D40  38 63 22 80 */	addi r3, r3, d_a_e_warpappear__stringBase0@l /* 0x807D2280@l */
...
/* 807D1D54  4B 86 A5 99 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807D1D74  3D 00 80 7D */	lis r8, lit_3914@ha /* 0x807D20B8@ha */
/* 807D1D78  C0 28 20 B8 */	lfs f1, lit_3914@l(r8)  /* 0x807D20B8@l */
/* 807D1D7C  39 00 00 00 */	li r8, 0
/* 807D1D80  39 20 FF FF */	li r9, -1
/* 807D1D84  4B 83 B8 B9 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 807D1D9C  4B AF CE B1 */	bl __nw__FUl
/* 807D1DA0  7C 7D 1B 79 */	or. r29, r3, r3
/* 807D1DA4  41 82 00 20 */	beq lbl_807D1DC4
/* 807D1DA8  3C 80 80 7D */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x807D2368@ha */
/* 807D1DAC  38 04 23 68 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x807D2368@l */
/* 807D1DB0  90 1D 00 00 */	stw r0, 0(r29)
/* 807D1DB4  38 80 00 00 */	li r4, 0
/* 807D1DB8  4B B5 66 45 */	bl init__12J3DFrameCtrlFs
...
lbl_807D1DDC:
/* 807D1DDC  3C 60 80 7D */	lis r3, d_a_e_warpappear__stringBase0@ha /* 0x807D2280@ha */
/* 807D1DE0  38 63 22 80 */	addi r3, r3, d_a_e_warpappear__stringBase0@l /* 0x807D2280@l */
...
/* 807D1DF4  4B 86 A4 F9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807D1E14  3D 00 80 7D */	lis r8, lit_3914@ha /* 0x807D20B8@ha */
/* 807D1E18  C0 28 20 B8 */	lfs f1, lit_3914@l(r8)  /* 0x807D20B8@l */
/* 807D1E1C  39 00 00 00 */	li r8, 0
/* 807D1E20  39 20 FF FF */	li r9, -1
/* 807D1E24  4B 83 B8 E9 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_807D1E38:
/* 807D1E38  3C 60 80 7D */	lis r3, lit_3911@ha /* 0x807D20AC@ha */
/* 807D1E3C  C0 03 20 AC */	lfs f0, lit_3911@l(r3)  /* 0x807D20AC@l */
/* 807D1E40  80 7E 05 7C */	lwz r3, 0x57c(r30)
/* 807D1E44  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 807D1E48  38 60 00 18 */	li r3, 0x18
/* 807D1E4C  4B AF CE 01 */	bl __nw__FUl
/* 807D1E50  7C 7D 1B 79 */	or. r29, r3, r3
/* 807D1E54  41 82 00 20 */	beq lbl_807D1E74
/* 807D1E58  3C 80 80 7D */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x807D2368@ha */
/* 807D1E5C  38 04 23 68 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x807D2368@l */
/* 807D1E60  90 1D 00 00 */	stw r0, 0(r29)
/* 807D1E64  38 80 00 00 */	li r4, 0
/* 807D1E68  4B B5 65 95 */	bl init__12J3DFrameCtrlFs
...
lbl_807D1E8C:
/* 807D1E8C  3C 60 80 7D */	lis r3, d_a_e_warpappear__stringBase0@ha /* 0x807D2280@ha */
/* 807D1E90  38 63 22 80 */	addi r3, r3, d_a_e_warpappear__stringBase0@l /* 0x807D2280@l */
...
/* 807D1EA4  4B 86 A4 49 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807D1EC4  3D 00 80 7D */	lis r8, lit_3914@ha /* 0x807D20B8@ha */
/* 807D1EC8  C0 28 20 B8 */	lfs f1, lit_3914@l(r8)  /* 0x807D20B8@l */
/* 807D1ECC  39 00 00 00 */	li r8, 0
/* 807D1ED0  39 20 FF FF */	li r9, -1
/* 807D1ED4  4B 83 B8 39 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 807D1ED8  30 03 FF FF */	addic r0, r3, -1
/* 807D1EDC  7C 60 19 10 */	subfe r3, r0, r3
lbl_807D1EE0:
/* 807D1EE0  39 61 00 20 */	addi r11, r1, 0x20
/* 807D1EE4  4B B9 03 45 */	bl _restgpr_29
