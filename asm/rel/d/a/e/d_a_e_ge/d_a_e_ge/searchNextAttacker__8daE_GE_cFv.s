...
/* 806C8424  3C 60 80 6D */	lis r3, target_count@ha
/* 806C8428  90 03 D3 9C */	stw r0, target_count@l(r3)
/* 806C842C  3C 60 80 6C */	lis r3, s_ge_attack__FPvPv@ha
/* 806C8430  38 63 7F E4 */	addi r3, r3, s_ge_attack__FPvPv@l
/* 806C8434  7F E4 FB 78 */	mr r4, r31
/* 806C8438  4B 95 8F 00 */	b fpcEx_Search__FPFPvPv_PvPv
/* 806C843C  3C 60 80 6D */	lis r3, target_count@ha
/* 806C8440  80 03 D3 9C */	lwz r0, target_count@l(r3)
...
/* 806C8460  3C 60 80 6D */	lis r3, lit_3926@ha
/* 806C8464  C0 23 D0 30 */	lfs f1, lit_3926@l(r3)
/* 806C8468  4B B9 F4 EC */	b cM_rndF__Ff
/* 806C846C  3C 60 80 6D */	lis r3, lit_4178@ha
/* 806C8470  C0 03 D0 78 */	lfs f0, lit_4178@l(r3)
