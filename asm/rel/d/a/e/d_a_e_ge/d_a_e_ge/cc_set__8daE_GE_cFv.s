...
/* 806CBF00  4B C9 62 DD */	bl _savegpr_29
/* 806CBF04  7C 7F 1B 78 */	mr r31, r3
/* 806CBF08  3C 60 80 6D */	lis r3, lit_3904@ha /* 0x806CD000@ha */
/* 806CBF0C  3B C3 D0 00 */	addi r30, r3, lit_3904@l /* 0x806CD000@l */
...
/* 806CBF24  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CBF28  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CBF2C  4B C7 A5 85 */	bl PSMTXCopy
/* 806CBF30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CBF34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806CBF64  4B BA 36 E5 */	bl SetC__8cM3dGSphFRC4cXyz
/* 806CBF68  38 7F 09 D4 */	addi r3, r31, 0x9d4
/* 806CBF6C  C0 3E 00 64 */	lfs f1, 0x64(r30)
/* 806CBF70  4B BA 37 99 */	bl SetR__8cM3dGSphFf
/* 806CBF74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CBF78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CBF7C  3B A3 23 3C */	addi r29, r3, 0x233c
/* 806CBF80  7F A3 EB 78 */	mr r3, r29
/* 806CBF84  38 9F 08 B0 */	addi r4, r31, 0x8b0
/* 806CBF88  4B B9 8C 21 */	bl Set__4cCcSFP8cCcD_Obj
/* 806CBF8C  38 7F 0B 0C */	addi r3, r31, 0xb0c
/* 806CBF90  38 9F 05 38 */	addi r4, r31, 0x538
/* 806CBF94  4B BA 36 B5 */	bl SetC__8cM3dGSphFRC4cXyz
