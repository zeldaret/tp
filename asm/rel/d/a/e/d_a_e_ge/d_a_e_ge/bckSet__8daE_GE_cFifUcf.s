...
/* 806C7AEC  3C 60 80 6D */	lis r3, d_a_e_ge__stringBase0@ha /* 0x806CD10C@ha */
/* 806C7AF0  38 63 D1 0C */	addi r3, r3, d_a_e_ge__stringBase0@l /* 0x806CD10C@l */
/* 806C7AF4  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C7AF8  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C7AFC  3C A5 00 02 */	addis r5, r5, 2
/* 806C7B00  38 C0 00 80 */	li r6, 0x80
/* 806C7B04  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806C7B08  4B 97 47 E5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806C7B20  3C C0 80 6D */	lis r6, lit_3905@ha /* 0x806CD004@ha */
/* 806C7B24  C0 66 D0 04 */	lfs f3, lit_3905@l(r6)  /* 0x806CD004@l */
/* 806C7B28  3C C0 80 6D */	lis r6, lit_3946@ha /* 0x806CD04C@ha */
/* 806C7B2C  C0 86 D0 4C */	lfs f4, lit_3946@l(r6)  /* 0x806CD04C@l */
/* 806C7B30  4B 94 93 41 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
