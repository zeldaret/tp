...
/* 806C7BC8  4B C9 A6 14 */	b _savegpr_29
/* 806C7BCC  7C 7D 1B 78 */	mr r29, r3
/* 806C7BD0  3C 60 80 6D */	lis r3, lit_3904@ha
/* 806C7BD4  3B E3 D0 00 */	addi r31, r3, lit_3904@l
/* 806C7BD8  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806C7BDC  83 C3 00 04 */	lwz r30, 4(r3)
/* 806C7BE0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806C7BE4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806C7BE8  38 80 00 00 */	li r4, 0
/* 806C7BEC  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 806C7BF0  38 DD 01 0C */	addi r6, r29, 0x10c
/* 806C7BF4  4B AD BB D0 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806C7BF8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806C7BFC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806C7C00  80 9E 00 04 */	lwz r4, 4(r30)
/* 806C7C04  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806C7C08  4B AD D1 98 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806C7C0C  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806C7C10  4B 94 95 B0 */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 806C7C60  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 806C7C64  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 806C7C68  4B 96 6C A8 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806C7C6C  90 7D 0B 84 */	stw r3, 0xb84(r29)
/* 806C7C70  38 60 00 01 */	li r3, 1
/* 806C7C74  39 61 00 30 */	addi r11, r1, 0x30
/* 806C7C78  4B C9 A5 B0 */	b _restgpr_29
