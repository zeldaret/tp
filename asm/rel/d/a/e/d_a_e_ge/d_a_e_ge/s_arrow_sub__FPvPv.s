...
/* 806C7DD4  4B 95 0F 0D */	bl fopAc_IsActor__FPv
...
lbl_806C7DF4:
/* 806C7DF4  4B 95 A3 45 */	bl fpcM_IsCreating__FUi
...
/* 806C7E10  3C 60 80 6D */	lis r3, lit_3905@ha /* 0x806CD004@ha */
/* 806C7E14  C0 03 D0 04 */	lfs f0, lit_3905@l(r3)  /* 0x806CD004@l */
...
/* 806C7E28  4B 95 29 B9 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806C7E2C  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806CD368@ha */
/* 806C7E30  38 63 D3 68 */	addi r3, r3, l_HIO@l /* 0x806CD368@l */
/* 806C7E34  C0 03 00 0C */	lfs f0, 0xc(r3)
/* 806C7E38  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 806C7E3C  40 80 00 24 */	bge lbl_806C7E60
/* 806C7E40  3C 60 80 6D */	lis r3, lit_4025@ha /* 0x806CD054@ha */
/* 806C7E44  C0 23 D0 54 */	lfs f1, lit_4025@l(r3)  /* 0x806CD054@l */
/* 806C7E48  4B B9 FB 0D */	bl cM_rndF__Ff
