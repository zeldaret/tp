...
/* 806CCBE8  4B C9 55 CD */	bl _savegpr_19
/* 806CCBEC  7C 7E 1B 78 */	mr r30, r3
/* 806CCBF0  7C 9A 23 78 */	mr r26, r4
/* 806CCBF4  7C BB 2B 78 */	mr r27, r5
/* 806CCBF8  7C DC 33 78 */	mr r28, r6
/* 806CCBFC  3C 60 80 6D */	lis r3, cNullVec__6Z2Calc@ha /* 0x806CD118@ha */
/* 806CCC00  3A E3 D1 18 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x806CD118@l */
/* 806CCC04  3C 60 80 6D */	lis r3, lit_3904@ha /* 0x806CD000@ha */
/* 806CCC08  3B E3 D0 00 */	addi r31, r3, lit_3904@l /* 0x806CD000@l */
/* 806CCC0C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CCC10  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CCC14  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 806CCC18  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806CCC1C  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 806CCC44  4B AD F9 39 */	bl dKy_darkworld_check__Fv
...
/* 806CCC68  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806CCC6C  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 806CCC84  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CCC88  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CCC8C  4B C7 98 25 */	bl PSMTXCopy
...
/* 806CCCA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CCCA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CCCAC  38 81 00 4C */	addi r4, r1, 0x4c
/* 806CCCB0  38 A1 00 58 */	addi r5, r1, 0x58
/* 806CCCB4  4B C7 A0 B9 */	bl PSMTXMultVec
/* 806CCCB8  38 61 00 34 */	addi r3, r1, 0x34
/* 806CCCBC  38 81 00 58 */	addi r4, r1, 0x58
/* 806CCCC0  7F 65 DB 78 */	mr r5, r27
/* 806CCCC4  4B B9 9E 71 */	bl __mi__4cXyzCFRC3Vec
...
/* 806CCCE0  4B B9 A9 95 */	bl cM_atan2s__Fff
...
/* 806CCD14  4B B9 A9 61 */	bl cM_atan2s__Fff
...
/* 806CCD30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CCD34  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806CCD84  4B 97 FD 0D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806CCD88  7C 79 1B 79 */	or. r25, r3, r3
/* 806CCD8C  41 82 00 FC */	beq lbl_806CCE88
/* 806CCD90  38 61 00 40 */	addi r3, r1, 0x40
/* 806CCD94  4B C7 A3 A5 */	bl PSVECSquareMag
...
/* 806CCE04  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806CCE08  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806CCE74  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806CCE78  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806CCE7C:
...
/* 806CCECC  4B 97 FB C5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806CCF08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CCF0C  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806CCF78  4B 98 05 55 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806CCFD8  4B C9 52 29 */	bl _restgpr_19
