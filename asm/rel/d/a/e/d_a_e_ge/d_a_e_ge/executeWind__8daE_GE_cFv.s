...
/* 806CB714  3C 60 80 6D */	lis r3, lit_3904@ha /* 0x806CD000@ha */
/* 806CB718  3B E3 D0 00 */	addi r31, r3, lit_3904@l /* 0x806CD000@l */
/* 806CB71C  4B A9 41 B5 */	bl getThrowBoomerangActor__9daPy_py_cFv
...
/* 806CB740  4B B9 C2 4D */	bl cM_rndFX__Ff
...
/* 806CB78C  4B A9 41 45 */	bl getThrowBoomerangActor__9daPy_py_cFv
...
/* 806CB7D4  4B C7 BB C9 */	bl PSVECSquareDistance
...
/* 806CB844  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806CB848  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806CB8B4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806CB8B8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806CB8BC:
...
/* 806CB900  4B B9 C0 8D */	bl cM_rndFX__Ff
/* 806CB904  D0 3E 0B 64 */	stfs f1, 0xb64(r30)
/* 806CB908  C0 3F 00 00 */	lfs f1, 0(r31)
/* 806CB90C  4B B9 C0 81 */	bl cM_rndFX__Ff
...
/* 806CB920  4B C5 CB 0D */	bl checkPass__12J3DFrameCtrlFf
...
lbl_806CB954:
/* 806CB954  4B A9 3F 7D */	bl getThrowBoomerangActor__9daPy_py_cFv
...
/* 806CB984  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806CB988  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806CB9CC  4B BA 4D 75 */	bl cLib_chaseF__FPfff
...
/* 806CB9FC  4B BA 4D 45 */	bl cLib_chaseF__FPfff
...
/* 806CBA10  4B BA 4D 31 */	bl cLib_chaseF__FPfff
lbl_806CBA14:
...
/* 806CBA40  4B BA 4B C9 */	bl cLib_addCalcAngleS2__FPssss
