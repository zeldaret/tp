...
/* 806951D8  4B CC D0 05 */	bl _savegpr_29
/* 806951DC  7C 7D 1B 78 */	mr r29, r3
/* 806951E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806951E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806951F8  4B BD 19 3D */	bl __mi__4cXyzCFRC3Vec
...
/* 80695220  3C 60 80 69 */	lis r3, lit_3945@ha /* 0x80697CA8@ha */
/* 80695224  C0 03 7C A8 */	lfs f0, lit_3945@l(r3)  /* 0x80697CA8@l */
...
/* 8069523C  4B BD 24 39 */	bl cM_atan2s__Fff
...
lbl_80695258:
/* 80695258  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069525C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80695278  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8069527C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80695280  80 84 00 00 */	lwz r4, 0(r4)
/* 80695284  4B CB 12 2D */	bl PSMTXCopy
/* 80695288  3C 60 80 69 */	lis r3, lit_3945@ha /* 0x80697CA8@ha */
/* 8069528C  C0 03 7C A8 */	lfs f0, lit_3945@l(r3)  /* 0x80697CA8@l */
...
/* 806952D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806952D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806952D8  C0 21 00 2C */	lfs f1, 0x2c(r1)
/* 806952DC  C0 41 00 30 */	lfs f2, 0x30(r1)
/* 806952E0  C0 61 00 34 */	lfs f3, 0x34(r1)
/* 806952E4  4B CB 16 05 */	bl PSMTXTrans
/* 806952E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806952EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806952F0  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806952F4  4B 97 71 41 */	bl mDoMtx_YrotM__FPA4_fs
/* 806952F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806952FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80695300  38 80 C9 50 */	li r4, -14000
/* 80695304  4B 97 70 99 */	bl mDoMtx_XrotM__FPA4_fs
/* 80695308  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 8069530C  C0 41 00 24 */	lfs f2, 0x24(r1)
/* 80695310  C0 61 00 28 */	lfs f3, 0x28(r1)
/* 80695314  4B 97 7A 89 */	bl transM__14mDoMtx_stack_cFfff
/* 80695318  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8069531C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80695320  A8 9D 00 3E */	lha r4, 0x3e(r29)
/* 80695324  4B 97 71 11 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80695338  4B BD B2 D1 */	bl cLib_addCalcAngleS2__FPssss
/* 8069533C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80695340  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80695344  A8 9D 00 40 */	lha r4, 0x40(r29)
/* 80695348  4B 97 71 85 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8069534C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80695350  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80695354  38 80 C0 00 */	li r4, -16384
/* 80695358  4B 97 70 45 */	bl mDoMtx_XrotM__FPA4_fs
/* 8069535C  3C 60 80 69 */	lis r3, l_HIO@ha /* 0x80697E7C@ha */
/* 80695360  38 63 7E 7C */	addi r3, r3, l_HIO@l /* 0x80697E7C@l */
...
/* 80695378  4B 97 7A C1 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8069537C  3C 60 80 69 */	lis r3, lit_3945@ha /* 0x80697CA8@ha */
/* 80695380  C0 23 7C A8 */	lfs f1, lit_3945@l(r3)  /* 0x80697CA8@l */
/* 80695384  3C 60 80 69 */	lis r3, lit_4019@ha /* 0x80697CD0@ha */
/* 80695388  C0 43 7C D0 */	lfs f2, lit_4019@l(r3)  /* 0x80697CD0@l */
/* 8069538C  FC 60 08 90 */	fmr f3, f1
/* 80695390  4B 97 7A 0D */	bl transM__14mDoMtx_stack_cFfff
/* 80695394  88 1D 00 52 */	lbz r0, 0x52(r29)
/* 80695398  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e
/* 8069539C  41 82 00 1C */	beq lbl_806953B8
/* 806953A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806953A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806953A8  80 9D 00 00 */	lwz r4, 0(r29)
/* 806953AC  38 84 00 24 */	addi r4, r4, 0x24
/* 806953B0  4B CB 11 01 */	bl PSMTXCopy
/* 806953B4  48 00 00 18 */	b lbl_806953CC
lbl_806953B8:
/* 806953B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806953BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806953C0  80 9D 00 04 */	lwz r4, 4(r29)
/* 806953C4  38 84 00 24 */	addi r4, r4, 0x24
/* 806953C8  4B CB 10 E9 */	bl PSMTXCopy
lbl_806953CC:
/* 806953CC  39 61 00 60 */	addi r11, r1, 0x60
/* 806953D0  4B CC CE 59 */	bl _restgpr_29
