...
/* 806FFCF8  4B C6 24 E5 */	bl _savegpr_29
...
/* 806FFD10  3C 60 80 70 */	lis r3, d_a_e_kr__stringBase0@ha /* 0x80705C4C@ha */
/* 806FFD14  38 63 5C 4C */	addi r3, r3, d_a_e_kr__stringBase0@l /* 0x80705C4C@l */
/* 806FFD18  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806FFD1C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806FFD20  3C A5 00 02 */	addis r5, r5, 2
/* 806FFD24  38 C0 00 80 */	li r6, 0x80
/* 806FFD28  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806FFD2C  4B 93 C5 C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806FFD44  3C C0 80 70 */	lis r6, lit_3904@ha /* 0x80705AFC@ha */
/* 806FFD48  C0 66 5A FC */	lfs f3, lit_3904@l(r6)  /* 0x80705AFC@l */
/* 806FFD4C  3C C0 80 70 */	lis r6, lit_4043@ha /* 0x80705B24@ha */
/* 806FFD50  C0 86 5B 24 */	lfs f4, lit_4043@l(r6)  /* 0x80705B24@l */
/* 806FFD54  4B 91 11 1D */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806FFD70  4B C6 24 B9 */	bl _restgpr_29
