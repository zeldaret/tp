...
/* 8068FBEC  4B CD 25 ED */	bl _savegpr_28
/* 8068FBF0  7C 7C 1B 78 */	mr r28, r3
/* 8068FBF4  3C 60 80 69 */	lis r3, lit_3788@ha /* 0x80690DD8@ha */
/* 8068FBF8  3B C3 0D D8 */	addi r30, r3, lit_3788@l /* 0x80690DD8@l */
...
/* 8068FC70  4B BD FD CD */	bl cLib_addCalc2__FPffff
/* 8068FC74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8068FC78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8068FC7C  C0 3C 04 D0 */	lfs f1, 0x4d0(r28)
/* 8068FC80  C0 5C 06 90 */	lfs f2, 0x690(r28)
/* 8068FC84  C0 7C 04 D8 */	lfs f3, 0x4d8(r28)
/* 8068FC88  4B CB 6C 61 */	bl PSMTXTrans
/* 8068FC8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8068FC90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8068FC94  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 8068FC98  4B 97 C7 9D */	bl mDoMtx_YrotM__FPA4_fs
/* 8068FC9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8068FCA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8068FCA4  A8 9C 04 E4 */	lha r4, 0x4e4(r28)
/* 8068FCA8  4B 97 C6 F5 */	bl mDoMtx_XrotM__FPA4_fs
/* 8068FCAC  3C 60 80 69 */	lis r3, l_HIO@ha /* 0x806910A0@ha */
/* 8068FCB0  3B E3 10 A0 */	addi r31, r3, l_HIO@l /* 0x806910A0@l */
/* 8068FCB4  C0 3F 00 08 */	lfs f1, 8(r31)
/* 8068FCB8  FC 40 08 90 */	fmr f2, f1
/* 8068FCBC  FC 60 08 90 */	fmr f3, f1
/* 8068FCC0  4B 97 D1 79 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8068FCC4  80 7C 05 CC */	lwz r3, 0x5cc(r28)
/* 8068FCC8  83 A3 00 04 */	lwz r29, 4(r3)
/* 8068FCCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8068FCD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8068FCD4  38 9D 00 24 */	addi r4, r29, 0x24
/* 8068FCD8  4B CB 67 D9 */	bl PSMTXCopy
/* 8068FCDC  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 8068FCE0  7C 03 07 74 */	extsb r3, r0
/* 8068FCE4  4B 99 D3 89 */	bl dComIfGp_getReverb__Fi
/* 8068FCE8  7C 65 1B 78 */	mr r5, r3
/* 8068FCEC  80 7C 05 CC */	lwz r3, 0x5cc(r28)
/* 8068FCF0  38 80 00 00 */	li r4, 0
/* 8068FCF4  4B 98 13 BD */	bl play__16mDoExt_McaMorfSOFUlSc
/* 8068FCF8  7F 83 E3 78 */	mr r3, r28
/* 8068FCFC  4B FF FD 09 */	bl anm_se_set__FP10e_bs_class
/* 8068FD00  80 7C 05 CC */	lwz r3, 0x5cc(r28)
/* 8068FD04  4B 98 14 E9 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 8068FD44  4B CB 73 4D */	bl PSVECAdd
lbl_8068FD48:
/* 8068FD48  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 8068FD4C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8068FD50  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 8068FD54  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8068FD58  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8068FD5C  80 84 00 00 */	lwz r4, 0(r4)
/* 8068FD60  4B CB 67 51 */	bl PSMTXCopy
...
/* 8068FDAC  4B BD F9 5D */	bl SetR__8cM3dGSphFf
...
/* 8068FDE4  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8068FDE8  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8068FDEC  80 84 00 00 */	lwz r4, 0(r4)
/* 8068FDF0  4B CB 66 C1 */	bl PSMTXCopy
...
/* 8068FE3C  4B BD F8 CD */	bl SetR__8cM3dGSphFf
/* 8068FE40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8068FE44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8068FE48  3B A3 23 3C */	addi r29, r3, 0x233c
/* 8068FE4C  7F A3 EB 78 */	mr r3, r29
/* 8068FE50  38 9C 09 2C */	addi r4, r28, 0x92c
/* 8068FE54  4B BD 4D 55 */	bl Set__4cCcSFP8cCcD_Obj
/* 8068FE58  7F A3 EB 78 */	mr r3, r29
/* 8068FE5C  38 9C 0A 64 */	addi r4, r28, 0xa64
/* 8068FE60  4B BD 4D 49 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8068FE74  4B 98 07 55 */	bl play__14mDoExt_McaMorfFP3VecUlSc
...
/* 8068FE8C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8068FE90  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8068FE94  80 84 00 00 */	lwz r4, 0(r4)
/* 8068FE98  4B CB 66 19 */	bl PSMTXCopy
/* 8068FE9C  80 7C 05 D4 */	lwz r3, 0x5d4(r28)
/* 8068FEA0  80 83 00 04 */	lwz r4, 4(r3)
/* 8068FEA4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8068FEA8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8068FEAC  80 63 00 00 */	lwz r3, 0(r3)
/* 8068FEB0  38 84 00 24 */	addi r4, r4, 0x24
/* 8068FEB4  4B CB 65 FD */	bl PSMTXCopy
/* 8068FEB8  80 7C 05 D4 */	lwz r3, 0x5d4(r28)
/* 8068FEBC  4B 98 07 F1 */	bl modelCalc__14mDoExt_McaMorfFv
...
/* 8068FEE8  4B BE 10 05 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8068FF2C  4B BD F7 DD */	bl SetR__8cM3dGSphFf
lbl_8068FF30:
...
/* 8068FF44  4B BD F7 05 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 8068FF64  4B BD 4C 45 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8068FF94  4B CD 22 91 */	bl _restgpr_28
