...
/* 8068E3E4  4B CD 3D F5 */	bl _savegpr_28
/* 8068E3E8  7C 7F 1B 78 */	mr r31, r3
/* 8068E3EC  3C 60 80 69 */	lis r3, lit_3788@ha /* 0x80690DD8@ha */
/* 8068E3F0  3B C3 0D D8 */	addi r30, r3, lit_3788@l /* 0x80690DD8@l */
/* 8068E3F4  80 7F 05 CC */	lwz r3, 0x5cc(r31)
/* 8068E3F8  83 A3 00 04 */	lwz r29, 4(r3)
/* 8068E3FC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8068E400  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8068E404  38 80 00 00 */	li r4, 0
/* 8068E408  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8068E40C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8068E410  4B B1 53 B5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8068E414  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8068E418  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8068E41C  80 9D 00 04 */	lwz r4, 4(r29)
/* 8068E420  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8068E424  4B B1 69 7D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8068E428  80 7F 05 CC */	lwz r3, 0x5cc(r31)
/* 8068E42C  4B 98 2D 95 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 8068E430  80 7F 05 D4 */	lwz r3, 0x5d4(r31)
/* 8068E434  83 83 00 04 */	lwz r28, 4(r3)
/* 8068E438  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8068E43C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8068E440  80 9C 00 04 */	lwz r4, 4(r28)
/* 8068E444  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8068E448  4B B1 69 59 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8068E44C  80 7F 05 D4 */	lwz r3, 0x5d4(r31)
/* 8068E450  4B 98 22 31 */	bl entryDL__14mDoExt_McaMorfFv
...
/* 8068E4AC  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 8068E4B0  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 8068E4B4  4B 9A 04 5D */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 8068E4B8  90 7F 06 98 */	stw r3, 0x698(r31)
/* 8068E4BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8068E4C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8068E4C4  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 8068E4C8  80 9F 06 98 */	lwz r4, 0x698(r31)
/* 8068E4CC  7F 85 E3 78 */	mr r5, r28
/* 8068E4D0  4B 9C 7A 4D */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_8068E4D4:
/* 8068E4D4  38 60 00 01 */	li r3, 1
/* 8068E4D8  39 61 00 30 */	addi r11, r1, 0x30
/* 8068E4DC  4B CD 3D 49 */	bl _restgpr_28
