...
/* 806F67C8  3C 60 80 6F */	lis r3, lit_3648@ha /* 0x806F7B6C@ha */
/* 806F67CC  3B E3 7B 6C */	addi r31, r3, lit_3648@l /* 0x806F7B6C@l */
...
/* 806F685C  3C 60 80 6F */	lis r3, s_stop_sub__FPvPv@ha /* 0x806F5EB4@ha */
/* 806F6860  38 63 5E B4 */	addi r3, r3, s_stop_sub__FPvPv@l /* 0x806F5EB4@l */
/* 806F6864  7F C4 F3 78 */	mr r4, r30
/* 806F6868  4B 92 AA D1 */	bl fpcEx_Search__FPFPvPv_PvPv
...
lbl_806F6888:
/* 806F6888  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F688C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806F6890  80 9E 05 B8 */	lwz r4, 0x5b8(r30)
/* 806F6894  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806F6898  7C 05 07 74 */	extsb r5, r0
/* 806F689C  4B 93 E9 65 */	bl onSwitch__10dSv_info_cFii
/* 806F68A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F68A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806F68A8  80 9E 05 C0 */	lwz r4, 0x5c0(r30)
/* 806F68AC  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806F68B0  7C 05 07 74 */	extsb r5, r0
/* 806F68B4  4B 93 E9 4D */	bl onSwitch__10dSv_info_cFii
/* 806F68B8  80 9E 06 C0 */	lwz r4, 0x6c0(r30)
/* 806F68BC  2C 04 00 FF */	cmpwi r4, 0xff
/* 806F68C0  41 82 00 18 */	beq lbl_806F68D8
/* 806F68C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F68C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806F68CC  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806F68D0  7C 05 07 74 */	extsb r5, r0
/* 806F68D4  4B 93 E9 2D */	bl onSwitch__10dSv_info_cFii
lbl_806F68D8:
/* 806F68D8  38 7E 06 74 */	addi r3, r30, 0x674
/* 806F68DC  C0 3F 00 00 */	lfs f1, 0(r31)
/* 806F68E0  C0 5F 00 64 */	lfs f2, 0x64(r31)
/* 806F68E4  4B B7 91 9D */	bl cLib_addCalc0__FPfff
...
/* 806F6900  4B B7 91 81 */	bl cLib_addCalc0__FPfff
