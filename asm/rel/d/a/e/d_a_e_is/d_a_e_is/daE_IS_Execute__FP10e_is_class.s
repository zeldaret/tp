...
/* 806F6E68  4B C6 B3 71 */	bl _savegpr_28
/* 806F6E6C  7C 7C 1B 78 */	mr r28, r3
/* 806F6E70  3C 60 80 6F */	lis r3, lit_3648@ha /* 0x806F7B6C@ha */
/* 806F6E74  3B E3 7B 6C */	addi r31, r3, lit_3648@l /* 0x806F7B6C@l */
...
/* 806F6EE8  4B B7 8B 55 */	bl cLib_addCalc2__FPffff
...
/* 806F6EFC  4B B7 8B 41 */	bl cLib_addCalc2__FPffff
...
/* 806F6F10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806F6F14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806F6F18  C0 3C 04 D0 */	lfs f1, 0x4d0(r28)
/* 806F6F1C  C0 5C 04 D4 */	lfs f2, 0x4d4(r28)
/* 806F6F20  C0 7C 04 D8 */	lfs f3, 0x4d8(r28)
/* 806F6F24  4B C4 F9 C5 */	bl PSMTXTrans
/* 806F6F28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806F6F2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806F6F30  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 806F6F34  4B 91 55 01 */	bl mDoMtx_YrotM__FPA4_fs
/* 806F6F38  3C 60 80 6F */	lis r3, l_HIO@ha /* 0x806F7DE0@ha */
/* 806F6F3C  38 63 7D E0 */	addi r3, r3, l_HIO@l /* 0x806F7DE0@l */
/* 806F6F40  C0 23 00 08 */	lfs f1, 8(r3)
/* 806F6F44  FC 40 08 90 */	fmr f2, f1
/* 806F6F48  FC 60 08 90 */	fmr f3, f1
/* 806F6F4C  4B 91 5E ED */	bl scaleM__14mDoMtx_stack_cFfff
/* 806F6F50  80 7C 05 C8 */	lwz r3, 0x5c8(r28)
/* 806F6F54  83 C3 00 04 */	lwz r30, 4(r3)
/* 806F6F58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806F6F5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806F6F60  38 9E 00 24 */	addi r4, r30, 0x24
/* 806F6F64  4B C4 F5 4D */	bl PSMTXCopy
/* 806F6F68  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 806F6F6C  7C 03 07 74 */	extsb r3, r0
/* 806F6F70  4B 93 60 FD */	bl dComIfGp_getReverb__Fi
/* 806F6F74  7C 65 1B 78 */	mr r5, r3
/* 806F6F78  80 7C 05 C8 */	lwz r3, 0x5c8(r28)
/* 806F6F7C  38 80 00 00 */	li r4, 0
/* 806F6F80  4B 91 A1 31 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 806F6F84  7F 83 E3 78 */	mr r3, r28
/* 806F6F88  4B FF FE 09 */	bl anm_se_set__FP10e_is_class
/* 806F6F8C  80 7C 05 C8 */	lwz r3, 0x5c8(r28)
/* 806F6F90  4B 91 A2 5D */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 806F6FCC  4B B7 82 35 */	bl SetR__8cM3dGCylFf
/* 806F6FD0  7F 83 E3 78 */	mr r3, r28
/* 806F6FD4  38 80 40 00 */	li r4, 0x4000
/* 806F6FD8  4B 92 60 01 */	bl fopAcM_plAngleCheck__FPC10fopAc_ac_cs
...
/* 806F7020  4B B7 81 E1 */	bl SetR__8cM3dGCylFf
lbl_806F7024:
...
/* 806F7048  4B B7 81 95 */	bl SetC__8cM3dGCylFRC4cXyz
/* 806F704C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F7050  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806F7054  3B A3 23 3C */	addi r29, r3, 0x233c
/* 806F7058  7F A3 EB 78 */	mr r3, r29
/* 806F705C  38 9C 0B 88 */	addi r4, r28, 0xb88
/* 806F7060  4B B6 DB 49 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 806F707C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 806F7080  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 806F7084  80 84 00 00 */	lwz r4, 0(r4)
/* 806F7088  4B C4 F4 29 */	bl PSMTXCopy
...
/* 806F70A4  4B B7 9E 49 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 806F7164  4B B7 9D 89 */	bl MtxPosition__FP4cXyzP4cXyz
