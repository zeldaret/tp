...
/* 806F614C  3C 80 80 6F */	lis r4, lit_3666@ha /* 0x806F7B80@ha */
/* 806F6150  C0 44 7B 80 */	lfs f2, lit_3666@l(r4)  /* 0x806F7B80@l */
...
/* 806F61B4  3C A0 80 6F */	lis r5, lit_3648@ha /* 0x806F7B6C@ha */
/* 806F61B8  C0 25 7B 6C */	lfs f1, lit_3648@l(r5)  /* 0x806F7B6C@l */
...
/* 806F61CC  3C A0 80 6F */	lis r5, lit_3648@ha /* 0x806F7B6C@ha */
/* 806F61D0  C0 25 7B 6C */	lfs f1, lit_3648@l(r5)  /* 0x806F7B6C@l */
...
/* 806F61E4  3C 60 80 6F */	lis r3, lit_3666@ha /* 0x806F7B80@ha */
/* 806F61E8  C0 03 7B 80 */	lfs f0, lit_3666@l(r3)  /* 0x806F7B80@l */
...
/* 806F6204  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F6208  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806F620C  80 9F 05 BC */	lwz r4, 0x5bc(r31)
/* 806F6210  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806F6214  7C 05 07 74 */	extsb r5, r0
/* 806F6218  4B 93 F1 49 */	bl isSwitch__10dSv_info_cCFii
...
lbl_806F622C:
/* 806F622C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F6230  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806F6234  80 9F 05 BC */	lwz r4, 0x5bc(r31)
/* 806F6238  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806F623C  7C 05 07 74 */	extsb r5, r0
/* 806F6240  4B 93 F1 21 */	bl isSwitch__10dSv_info_cCFii
...
lbl_806F627C:
/* 806F627C  3C 60 80 6F */	lis r3, lit_3648@ha /* 0x806F7B6C@ha */
/* 806F6280  C0 03 7B 6C */	lfs f0, lit_3648@l(r3)  /* 0x806F7B6C@l */
...
/* 806F629C  3C 60 80 6F */	lis r3, lit_3648@ha /* 0x806F7B6C@ha */
/* 806F62A0  C0 03 7B 6C */	lfs f0, lit_3648@l(r3)  /* 0x806F7B6C@l */
