...
/* 8079ECA0  4B BC 35 39 */	bl _savegpr_28
/* 8079ECA4  7C 7D 1B 78 */	mr r29, r3
/* 8079ECA8  7C 9E 23 78 */	mr r30, r4
/* 8079ECAC  3C 60 80 7A */	lis r3, lit_3903@ha /* 0x807A6824@ha */
/* 8079ECB0  3B E3 68 24 */	addi r31, r3, lit_3903@l /* 0x807A6824@l */
/* 8079ECB4  38 61 00 5C */	addi r3, r1, 0x5c
/* 8079ECB8  4B 8D 8F B1 */	bl __ct__11dBgS_LinChkFv
...
/* 8079ECCC  4B AD 21 91 */	bl MtxTrans__FfffUc
/* 8079ECD0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079ECD4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079ECD8  80 63 00 00 */	lwz r3, 0(r3)
/* 8079ECDC  A8 9D 06 9E */	lha r4, 0x69e(r29)
/* 8079ECE0  4B 86 D7 55 */	bl mDoMtx_YrotM__FPA4_fs
/* 8079ECE4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079ECE8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079ECEC  80 63 00 00 */	lwz r3, 0(r3)
/* 8079ECF0  A8 9D 06 9C */	lha r4, 0x69c(r29)
/* 8079ECF4  4B 86 D6 A9 */	bl mDoMtx_XrotM__FPA4_fs
/* 8079ECF8  4B AD 22 25 */	bl MtxPush__Fv
...
/* 8079ED1C  4B AD 21 D1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8079ED30  4B AD 21 BD */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8079ED44  4B 8D 90 21 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8079ED48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8079ED4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8079ED50  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 8079ED54  7F 83 E3 78 */	mr r3, r28
/* 8079ED58  38 81 00 5C */	addi r4, r1, 0x5c
/* 8079ED5C  4B 8D 56 59 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8079ED8C  4B AC 7D A9 */	bl __mi__4cXyzCFRC3Vec
...
/* 8079EDA8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079EDAC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079EDC0  4B 86 D5 85 */	bl mDoMtx_XrotS__FPA4_fs
/* 8079EDC4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079EDC8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079EE0C  4B AD 17 FD */	bl cLib_addCalcAngleS2__FPssss
lbl_8079EE10:
/* 8079EE10  4B AD 21 49 */	bl MtxPull__Fv
...
/* 8079EE34  4B AD 20 B9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8079EE48  4B AD 20 A5 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8079EE5C  4B 8D 8F 09 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8079EE60  7F 83 E3 78 */	mr r3, r28
/* 8079EE64  38 81 00 5C */	addi r4, r1, 0x5c
/* 8079EE68  4B 8D 55 4D */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8079EE98  4B AC 7C 9D */	bl __mi__4cXyzCFRC3Vec
...
/* 8079EEB4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079EEB8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079EECC  4B 86 D4 79 */	bl mDoMtx_XrotS__FPA4_fs
/* 8079EED0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079EED4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079EF14  4B AD 16 F5 */	bl cLib_addCalcAngleS2__FPssss
lbl_8079EF18:
/* 8079EF18  38 61 00 5C */	addi r3, r1, 0x5c
/* 8079EF1C  38 80 FF FF */	li r4, -1
/* 8079EF20  4B 8D 8D BD */	bl __dt__11dBgS_LinChkFv
/* 8079EF24  39 61 00 E0 */	addi r11, r1, 0xe0
/* 8079EF28  4B BC 32 FD */	bl _restgpr_28
