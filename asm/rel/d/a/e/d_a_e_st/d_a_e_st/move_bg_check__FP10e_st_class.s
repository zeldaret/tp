...
/* 8079EAB8  4B BC 37 19 */	bl _savegpr_26
/* 8079EABC  7C 7C 1B 78 */	mr r28, r3
/* 8079EAC0  38 61 00 2C */	addi r3, r1, 0x2c
/* 8079EAC4  4B 8D 91 A5 */	bl __ct__11dBgS_LinChkFv
...
/* 8079EADC  4B 8D 92 89 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8079EAE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8079EAE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8079EAE8  3B E3 0F 38 */	addi r31, r3, 0xf38
/* 8079EAEC  7F E3 FB 78 */	mr r3, r31
/* 8079EAF0  38 81 00 2C */	addi r4, r1, 0x2c
/* 8079EAF4  4B 8D 58 C1 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8079EB14  4B 8D 92 51 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8079EB18  7F E3 FB 78 */	mr r3, r31
/* 8079EB1C  38 81 00 2C */	addi r4, r1, 0x2c
/* 8079EB20  4B 8D 58 95 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8079EB48  4B 8D 61 75 */	bl GetSpecialCode__4dBgSFRC13cBgS_PolyInfo
...
/* 8079EB78  4B 8D 91 ED */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8079EB7C  7F E3 FB 78 */	mr r3, r31
/* 8079EB80  38 81 00 2C */	addi r4, r1, 0x2c
/* 8079EB84  4B 8D 58 31 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8079EB9C  4B AC 7F 99 */	bl __mi__4cXyzCFRC3Vec
...
/* 8079EBB8  4B AC 8A BD */	bl cM_atan2s__Fff
/* 8079EBBC  7C 64 1B 78 */	mr r4, r3
/* 8079EBC0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079EBC4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079EBC8  80 63 00 00 */	lwz r3, 0(r3)
/* 8079EBCC  4B 86 D8 11 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8079EBE4  3C 60 80 7A */	lis r3, lit_3904@ha /* 0x807A6828@ha */
/* 8079EBE8  C0 03 68 28 */	lfs f0, lit_3904@l(r3)  /* 0x807A6828@l */
...
/* 8079EC00  4B AC 8A 75 */	bl cM_atan2s__Fff
/* 8079EC04  7C 03 00 D0 */	neg r0, r3
/* 8079EC08  7C 04 07 34 */	extsh r4, r0
/* 8079EC0C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079EC10  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079EC14  80 63 00 00 */	lwz r3, 0(r3)
/* 8079EC18  4B 86 D7 85 */	bl mDoMtx_XrotM__FPA4_fs
/* 8079EC1C  3C 60 80 7A */	lis r3, lit_3904@ha /* 0x807A6828@ha */
/* 8079EC20  C0 03 68 28 */	lfs f0, lit_3904@l(r3)  /* 0x807A6828@l */
/* 8079EC24  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8079EC28  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 8079EC2C  3C 60 80 7A */	lis r3, lit_4330@ha /* 0x807A689C@ha */
/* 8079EC30  C0 03 68 9C */	lfs f0, lit_4330@l(r3)  /* 0x807A689C@l */
/* 8079EC34  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 8079EC38  38 61 00 14 */	addi r3, r1, 0x14
/* 8079EC3C  38 81 00 20 */	addi r4, r1, 0x20
/* 8079EC40  4B AD 22 AD */	bl MtxPosition__FP4cXyzP4cXyz
/* 8079EC44  38 7C 06 90 */	addi r3, r28, 0x690
/* 8079EC48  38 81 00 20 */	addi r4, r1, 0x20
/* 8079EC4C  7C 65 1B 78 */	mr r5, r3
/* 8079EC50  4B BA 84 41 */	bl PSVECAdd
...
/* 8079EC70  4B 8D 90 6D */	bl __dt__11dBgS_LinChkFv
/* 8079EC74  7F C3 F3 78 */	mr r3, r30
/* 8079EC78  39 61 00 C0 */	addi r11, r1, 0xc0
/* 8079EC7C  4B BC 35 A1 */	bl _restgpr_26
