...
/* 807A4A58  4B BB D7 81 */	bl _savegpr_28
/* 807A4A5C  7C 7F 1B 78 */	mr r31, r3
/* 807A4A60  3C 80 80 7A */	lis r4, lit_3903@ha /* 0x807A6824@ha */
/* 807A4A64  3B C4 68 24 */	addi r30, r4, lit_3903@l /* 0x807A6824@l */
/* 807A4A68  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A4A6C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807A4A70  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 807A4A74  4B 87 5D 6D */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 807A4A78  D0 3F 07 F8 */	stfs f1, 0x7f8(r31)
/* 807A4A7C  3C 60 80 7A */	lis r3, l_HIO@ha /* 0x807A6DF4@ha */
/* 807A4A80  38 63 6D F4 */	addi r3, r3, l_HIO@l /* 0x807A6DF4@l */
/* 807A4A84  C3 E3 00 08 */	lfs f31, 8(r3)
/* 807A4A88  3C 60 80 7A */	lis r3, small@ha /* 0x807A6DE0@ha */
/* 807A4A8C  80 03 6D E0 */	lwz r0, small@l(r3)  /* 0x807A6DE0@l */
...
/* 807A4B28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4B2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4B30  C0 3F 06 B0 */	lfs f1, 0x6b0(r31)
/* 807A4B34  C0 5F 06 B4 */	lfs f2, 0x6b4(r31)
/* 807A4B38  C0 7F 06 B8 */	lfs f3, 0x6b8(r31)
/* 807A4B3C  4B BA 1D AD */	bl PSMTXTrans
/* 807A4B40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4B44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807A4B58  4B 86 78 45 */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4B5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4B60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807A4B74  4B 86 79 59 */	bl mDoMtx_ZrotM__FPA4_fs
/* 807A4B78  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4B7C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4B80  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 807A4B84  4B 86 78 B1 */	bl mDoMtx_YrotM__FPA4_fs
/* 807A4B88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4B8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4B90  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 807A4B94  4B 86 78 09 */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4B98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4B9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4BA0  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 807A4BA4  4B 86 79 29 */	bl mDoMtx_ZrotM__FPA4_fs
/* 807A4BA8  FC 20 F8 90 */	fmr f1, f31
/* 807A4BAC  FC 40 F8 90 */	fmr f2, f31
/* 807A4BB0  FC 60 F8 90 */	fmr f3, f31
/* 807A4BB4  4B 86 82 85 */	bl scaleM__14mDoMtx_stack_cFfff
/* 807A4BB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4BBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4BC0  38 9D 00 24 */	addi r4, r29, 0x24
/* 807A4BC4  4B BA 18 ED */	bl PSMTXCopy
...
/* 807A4BEC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807A4BF0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807A4BF4  80 63 00 00 */	lwz r3, 0(r3)
/* 807A4BF8  A8 9F 07 F2 */	lha r4, 0x7f2(r31)
/* 807A4BFC  4B 86 77 E1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807A4C18  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 807A4C1C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 807A4C3C  4B AC C2 B1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A4C58  4B AC AE 29 */	bl cLib_addCalc0__FPfff
...
lbl_807A4C74:
/* 807A4C74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4C78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807A4CA8  4B BA 1C 41 */	bl PSMTXTrans
/* 807A4CAC  7F 80 07 35 */	extsh. r0, r28
/* 807A4CB0  41 82 00 3C */	beq lbl_807A4CEC
/* 807A4CB4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4CB8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4CBC  A8 9F 07 F2 */	lha r4, 0x7f2(r31)
/* 807A4CC0  4B 86 77 75 */	bl mDoMtx_YrotM__FPA4_fs
/* 807A4CC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4CC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4CCC  7F 84 E3 78 */	mr r4, r28
/* 807A4CD0  4B 86 76 CD */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4CD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4CD8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4CDC  A8 1F 07 F2 */	lha r0, 0x7f2(r31)
/* 807A4CE0  7C 00 00 D0 */	neg r0, r0
/* 807A4CE4  7C 04 07 34 */	extsh r4, r0
/* 807A4CE8  4B 86 77 4D */	bl mDoMtx_YrotM__FPA4_fs
lbl_807A4CEC:
/* 807A4CEC  C0 1E 00 04 */	lfs f0, 4(r30)
/* 807A4CF0  D0 1F 07 1C */	stfs f0, 0x71c(r31)
/* 807A4CF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4CF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4CFC  A8 9F 06 9E */	lha r4, 0x69e(r31)
/* 807A4D00  4B 86 77 35 */	bl mDoMtx_YrotM__FPA4_fs
/* 807A4D04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4D08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4D0C  A8 9F 06 9C */	lha r4, 0x69c(r31)
/* 807A4D10  4B 86 76 8D */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4D14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4D18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4D1C  A8 9F 06 A4 */	lha r4, 0x6a4(r31)
/* 807A4D20  4B 86 76 7D */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4D24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4D28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4D2C  A8 9F 06 A2 */	lha r4, 0x6a2(r31)
/* 807A4D30  4B 86 77 9D */	bl mDoMtx_ZrotM__FPA4_fs
/* 807A4D34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4D38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4D3C  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 807A4D40  4B 86 76 F5 */	bl mDoMtx_YrotM__FPA4_fs
/* 807A4D44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4D48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4D4C  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 807A4D50  4B 86 76 4D */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4D54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4D58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4D5C  A8 9F 04 E0 */	lha r4, 0x4e0(r31)
/* 807A4D60  4B 86 77 6D */	bl mDoMtx_ZrotM__FPA4_fs
/* 807A4D64  FC 20 F8 90 */	fmr f1, f31
/* 807A4D68  FC 40 F8 90 */	fmr f2, f31
/* 807A4D6C  FC 60 F8 90 */	fmr f3, f31
/* 807A4D70  4B 86 80 C9 */	bl scaleM__14mDoMtx_stack_cFfff
/* 807A4D74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4D78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4D7C  38 9D 00 24 */	addi r4, r29, 0x24
/* 807A4D80  4B BA 17 31 */	bl PSMTXCopy
/* 807A4D84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807A4D88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807A4D8C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807A4D90  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807A4D94  80 84 00 00 */	lwz r4, 0(r4)
/* 807A4D98  4B BA 17 19 */	bl PSMTXCopy
...
/* 807A4DB8  4B AC C1 35 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A4DDC  4B AC C1 11 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A4E00  4B AC C0 ED */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A4E24  4B AC C0 C9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A4E40  4B AC C0 AD */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A4EA4  4B B8 35 89 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4EBC  4B B8 35 71 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4ED4  4B B8 35 59 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4EEC  4B B8 35 41 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4F04  4B B8 35 29 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4F1C  4B B8 35 11 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4F34  4B B8 34 F9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4F4C  4B B8 34 E1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4F64  4B B8 34 C9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4F7C  4B B8 34 B1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807A4FB8  4B 86 C2 35 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 807A4FD8  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 807A4FDC  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
...
/* 807A500C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807A5010  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807A5014  80 84 00 00 */	lwz r4, 0(r4)
/* 807A5018  4B BA 14 99 */	bl PSMTXCopy
...
/* 807A5034  4B AC BE B9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A50A0  4B AC BE 4D */	bl MtxPosition__FP4cXyzP4cXyz
/* 807A50A4  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 807A50A8  80 63 00 0C */	lwz r3, 0xc(r3)
/* 807A50AC  38 63 06 00 */	addi r3, r3, 0x600
/* 807A50B0  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807A50B4  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807A50B8  80 84 00 00 */	lwz r4, 0(r4)
/* 807A50BC  4B BA 13 F5 */	bl PSMTXCopy
...
/* 807A50E0  4B AC BE 0D */	bl MtxPosition__FP4cXyzP4cXyz
...
lbl_807A5150:
/* 807A5150  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A5154  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807A5158  3B A3 23 3C */	addi r29, r3, 0x233c
/* 807A515C  7F A3 EB 78 */	mr r3, r29
/* 807A5160  38 9F 0A 5C */	addi r4, r31, 0xa5c
/* 807A5164  4B AB FA 45 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 807A5200  4B AC BC ED */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A5224  4B AC BC C9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A524C  4B AC BC A1 */	bl MtxPosition__FP4cXyzP4cXyz
lbl_807A5250:
...
/* 807A5268  4B AC BC 85 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807A5304  4B AC A7 7D */	bl cLib_addCalc0__FPfff
...
/* 807A533C  4B AC A7 01 */	bl cLib_addCalc2__FPffff
lbl_807A5340:
...
/* 807A5368  4B 87 49 15 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 807A536C  88 9F 05 B8 */	lbz r4, 0x5b8(r31)
/* 807A5370  28 04 00 FF */	cmplwi r4, 0xff
/* 807A5374  41 82 00 18 */	beq lbl_807A538C
/* 807A5378  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A537C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807A5380  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 807A5384  7C 05 07 74 */	extsb r5, r0
/* 807A5388  4B 88 FE 79 */	bl onSwitch__10dSv_info_cFii
lbl_807A538C:
...
/* 807A53A8  4B BB CE 7D */	bl _restgpr_28
