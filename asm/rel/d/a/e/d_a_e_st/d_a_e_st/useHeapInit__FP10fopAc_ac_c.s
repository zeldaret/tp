...
/* 807A543C  4B BB CD 99 */	bl _savegpr_27
/* 807A5440  7C 7F 1B 78 */	mr r31, r3
/* 807A5444  3C 60 80 7A */	lis r3, small@ha /* 0x807A6DE0@ha */
/* 807A5448  80 03 6D E0 */	lwz r0, small@l(r3)  /* 0x807A6DE0@l */
...
/* 807A545C  4B B2 97 F1 */	bl __nw__FUl
/* 807A5460  7C 7D 1B 79 */	or. r29, r3, r3
/* 807A5464  41 82 00 94 */	beq lbl_807A54F8
/* 807A5468  3C 60 80 7A */	lis r3, d_a_e_st__stringBase0@ha /* 0x807A69E0@ha */
/* 807A546C  38 63 69 E0 */	addi r3, r3, d_a_e_st__stringBase0@l /* 0x807A69E0@l */
/* 807A5470  38 80 00 22 */	li r4, 0x22
/* 807A5474  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A5478  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807A548C  4B 89 6E 61 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 807A5490  7C 7C 1B 78 */	mr r28, r3
/* 807A5494  3C 60 80 7A */	lis r3, d_a_e_st__stringBase0@ha /* 0x807A69E0@ha */
/* 807A5498  38 63 69 E0 */	addi r3, r3, d_a_e_st__stringBase0@l /* 0x807A69E0@l */
/* 807A549C  7F C4 F3 78 */	mr r4, r30
/* 807A54A0  7F 65 DB 78 */	mr r5, r27
/* 807A54A4  38 C0 00 80 */	li r6, 0x80
/* 807A54A8  4B 89 6E 45 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807A54E0  3D 20 80 7A */	lis r9, lit_3905@ha /* 0x807A682C@ha */
/* 807A54E4  C0 29 68 2C */	lfs f1, lit_3905@l(r9)  /* 0x807A682C@l */
/* 807A54E8  39 20 00 00 */	li r9, 0
/* 807A54EC  39 40 FF FF */	li r10, -1
/* 807A54F0  4B 86 B2 E1 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 807A5538  4B 86 D0 A9 */	bl init__19mDoExt_3DlineMat0_cFUsUsi
...
/* 807A5554  3C 60 80 7A */	lis r3, lit_4268@ha /* 0x807A6884@ha */
/* 807A5558  C0 03 68 84 */	lfs f0, lit_4268@l(r3)  /* 0x807A6884@l */
...
/* 807A5580  4B 86 D0 61 */	bl init__19mDoExt_3DlineMat0_cFUsUsi
...
/* 807A559C  3C 60 80 7A */	lis r3, lit_4268@ha /* 0x807A6884@ha */
/* 807A55A0  C0 03 68 84 */	lfs f0, lit_4268@l(r3)  /* 0x807A6884@l */
...
/* 807A55C8  3C 60 80 7A */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x8079DEF8@ha */
/* 807A55CC  38 83 DE F8 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l /* 0x8079DEF8@l */
...
/* 807A5604  4B BB CC 1D */	bl _restgpr_27
