...
/* 807A4014  4B BB E1 C5 */	bl _savegpr_28
/* 807A4018  7C 7C 1B 78 */	mr r28, r3
/* 807A401C  7C 9D 23 78 */	mr r29, r4
/* 807A4020  3C 60 80 7A */	lis r3, lit_3903@ha /* 0x807A6824@ha */
/* 807A4024  3B E3 68 24 */	addi r31, r3, lit_3903@l /* 0x807A6824@l */
/* 807A4028  3B C0 00 00 */	li r30, 0
/* 807A402C  38 61 00 08 */	addi r3, r1, 8
/* 807A4030  4B 8D 3C 39 */	bl __ct__11dBgS_LinChkFv
...
/* 807A4044  4B 8D 3D 21 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807A4048  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A404C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807A4050  38 63 0F 38 */	addi r3, r3, 0xf38
/* 807A4054  38 81 00 08 */	addi r4, r1, 8
/* 807A4058  4B 8D 03 5D */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 807A40A4  4B AC B9 99 */	bl cLib_addCalc2__FPffff
lbl_807A40A8:
/* 807A40A8  C0 3D 00 00 */	lfs f1, 0(r29)
/* 807A40AC  3C 60 80 7A */	lis r3, l_HIO@ha /* 0x807A6DF4@ha */
/* 807A40B0  38 63 6D F4 */	addi r3, r3, l_HIO@l /* 0x807A6DF4@l */
...
/* 807A4128  4B 8D 3B B5 */	bl __dt__11dBgS_LinChkFv
/* 807A412C  7F C3 F3 78 */	mr r3, r30
/* 807A4130  39 61 00 A0 */	addi r11, r1, 0xa0
/* 807A4134  4B BB E0 F1 */	bl _restgpr_28
