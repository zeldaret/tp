...
/* 8079DF08  4B BC 42 D1 */	bl _savegpr_28
/* 8079DF0C  2C 04 00 00 */	cmpwi r4, 0
/* 8079DF10  40 82 02 78 */	bne lbl_8079E188
/* 8079DF14  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 8079DF18  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8079DF1C  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8079DF40  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8079DF44  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8079DF48  80 84 00 00 */	lwz r4, 0(r4)
/* 8079DF4C  4B BA 85 65 */	bl PSMTXCopy
...
/* 8079DF60  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079DF64  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079DF78  4B 86 E5 55 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8079DF90  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079DF94  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079DFA8  4B 86 E5 25 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8079DFC0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079DFC4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079DFD8  4B 86 E4 F5 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8079DFF0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079DFF4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079E008  4B 86 E4 C5 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8079E020  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E024  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079E038  4B 86 E4 95 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8079E050  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E054  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079E068  4B 86 E4 65 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8079E080  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E084  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079E098  4B 86 E4 35 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8079E0B0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E0B4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079E0C8  4B 86 E4 05 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_8079E0CC:
/* 8079E0CC  2C 1F 00 00 */	cmpwi r31, 0
/* 8079E0D0  40 82 00 44 */	bne lbl_8079E114
/* 8079E0D4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E0D8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079E0DC  80 63 00 00 */	lwz r3, 0(r3)
/* 8079E0E0  38 80 00 00 */	li r4, 0
/* 8079E0E4  4B 86 E2 B9 */	bl mDoMtx_XrotM__FPA4_fs
/* 8079E0E8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E0EC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079E0F0  80 63 00 00 */	lwz r3, 0(r3)
/* 8079E0F4  38 80 00 00 */	li r4, 0
/* 8079E0F8  4B 86 E2 A5 */	bl mDoMtx_XrotM__FPA4_fs
/* 8079E0FC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E100  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079E104  80 63 00 00 */	lwz r3, 0(r3)
/* 8079E108  38 80 00 00 */	li r4, 0
/* 8079E10C  4B 86 E3 C1 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8079E110  48 00 00 44 */	b lbl_8079E154
lbl_8079E114:
/* 8079E114  40 82 00 40 */	bne lbl_8079E154
/* 8079E118  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E11C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079E120  80 63 00 00 */	lwz r3, 0(r3)
/* 8079E124  38 80 00 00 */	li r4, 0
/* 8079E128  4B 86 E2 75 */	bl mDoMtx_XrotM__FPA4_fs
/* 8079E12C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E130  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079E134  80 63 00 00 */	lwz r3, 0(r3)
/* 8079E138  38 80 00 00 */	li r4, 0
/* 8079E13C  4B 86 E2 61 */	bl mDoMtx_XrotM__FPA4_fs
/* 8079E140  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E144  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079E148  80 63 00 00 */	lwz r3, 0(r3)
/* 8079E14C  38 80 00 00 */	li r4, 0
/* 8079E150  4B 86 E3 7D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_8079E154:
/* 8079E154  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E158  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8079E16C  4B BA 83 45 */	bl PSMTXCopy
/* 8079E170  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079E174  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079E178  80 63 00 00 */	lwz r3, 0(r3)
/* 8079E17C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8079E180  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8079E184  4B BA 83 2D */	bl PSMTXCopy
lbl_8079E188:
/* 8079E188  38 60 00 01 */	li r3, 1
/* 8079E18C  39 61 00 20 */	addi r11, r1, 0x20
/* 8079E190  4B BC 40 95 */	bl _restgpr_28
