...
/* 807A3B48  4B BB E6 95 */	bl _savegpr_29
/* 807A3B4C  7C 7E 1B 78 */	mr r30, r3
/* 807A3B50  3C 60 80 7A */	lis r3, lit_3903@ha /* 0x807A6824@ha */
/* 807A3B54  3B E3 68 24 */	addi r31, r3, lit_3903@l /* 0x807A6824@l */
/* 807A3B58  38 7E 0A 38 */	addi r3, r30, 0xa38
/* 807A3B5C  4B 8D FC D5 */	bl Move__10dCcD_GSttsFv
...
/* 807A3BBC  4B 8E 40 49 */	bl cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 807A3C08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A3C0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_807A3C44:
/* 807A3C44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A3C48  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807A3D6C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807A3D70  80 63 00 00 */	lwz r3, 0(r3)
/* 807A3D74  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 807A3D78  4B 86 86 65 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807A3D9C  4B AC D1 51 */	bl MtxPosition__FP4cXyzP4cXyz
/* 807A3DA0  38 61 00 0C */	addi r3, r1, 0xc
/* 807A3DA4  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 807A3DA8  7C 65 1B 78 */	mr r5, r3
/* 807A3DAC  4B BA 32 E5 */	bl PSVECAdd
/* 807A3DB0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A3DB4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807A3DD4  4B 8A 84 45 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 807A3E30  4B BB E3 F9 */	bl _restgpr_29
