...
/* 807A2980  4B BB F8 55 */	bl _savegpr_27
/* 807A2984  7C 7C 1B 78 */	mr r28, r3
/* 807A2988  3B 61 00 14 */	addi r27, r1, 0x14
/* 807A298C  7F 63 DB 78 */	mr r3, r27
/* 807A2990  4B 8D 4B ED */	bl __ct__11dBgS_GndChkFv
/* 807A2994  3C 60 80 7A */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x807A6D58@ha */
/* 807A2998  38 63 6D 58 */	addi r3, r3, __vt__14dBgS_ObjGndChk@l /* 0x807A6D58@l */
...
/* 807A29BC  4B 8D 64 AD */	bl SetObj__16dBgS_PolyPassChkFv
/* 807A29C0  C0 1C 04 D0 */	lfs f0, 0x4d0(r28)
/* 807A29C4  D0 01 00 08 */	stfs f0, 8(r1)
/* 807A29C8  3C 60 80 7A */	lis r3, lit_3926@ha /* 0x807A6858@ha */
/* 807A29CC  C0 23 68 58 */	lfs f1, lit_3926@l(r3)  /* 0x807A6858@l */
...
/* 807A29EC  4B AC 53 21 */	bl SetPos__11cBgS_GndChkFPC3Vec
/* 807A29F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A29F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807A29F8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 807A29FC  7F 64 DB 78 */	mr r4, r27
/* 807A2A00  4B 8D 1A A1 */	bl GroundCross__4cBgSFP11cBgS_GndChk
/* 807A2A04  C0 1C 04 D4 */	lfs f0, 0x4d4(r28)
/* 807A2A08  EC 20 08 28 */	fsubs f1, f0, f1
/* 807A2A0C  3C 60 80 7A */	lis r3, lit_3926@ha /* 0x807A6858@ha */
/* 807A2A10  C0 03 68 58 */	lfs f0, lit_3926@l(r3)  /* 0x807A6858@l */
/* 807A2A14  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 807A2A18  40 81 00 30 */	ble lbl_807A2A48
/* 807A2A1C  3C 60 80 7A */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x807A6D58@ha */
/* 807A2A20  38 03 6D 58 */	addi r0, r3, __vt__14dBgS_ObjGndChk@l /* 0x807A6D58@l */
...
/* 807A2A3C  4B 8D 4B B5 */	bl __dt__11dBgS_GndChkFv
/* 807A2A40  38 60 00 01 */	li r3, 1
/* 807A2A44  48 00 00 2C */	b lbl_807A2A70
lbl_807A2A48:
/* 807A2A48  3C 60 80 7A */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x807A6D58@ha */
/* 807A2A4C  38 03 6D 58 */	addi r0, r3, __vt__14dBgS_ObjGndChk@l /* 0x807A6D58@l */
...
/* 807A2A68  4B 8D 4B 89 */	bl __dt__11dBgS_GndChkFv
/* 807A2A6C  38 60 00 00 */	li r3, 0
lbl_807A2A70:
/* 807A2A70  39 61 00 80 */	addi r11, r1, 0x80
/* 807A2A74  4B BB F7 AD */	bl _restgpr_27
