...
/* 8079EF54  3C 60 80 7A */	lis r3, lit_3903@ha /* 0x807A6824@ha */
/* 8079EF58  3B E3 68 24 */	addi r31, r3, lit_3903@l /* 0x807A6824@l */
/* 8079EF5C  38 61 00 2C */	addi r3, r1, 0x2c
/* 8079EF60  4B 8D 8D 09 */	bl __ct__11dBgS_LinChkFv
/* 8079EF64  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079EF68  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079EF6C  80 63 00 00 */	lwz r3, 0(r3)
/* 8079EF70  A8 9E 06 9E */	lha r4, 0x69e(r30)
/* 8079EF74  4B 86 D4 69 */	bl mDoMtx_YrotS__FPA4_fs
/* 8079EF78  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079EF7C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8079EF80  80 63 00 00 */	lwz r3, 0(r3)
/* 8079EF84  A8 9E 06 9C */	lha r4, 0x69c(r30)
/* 8079EF88  4B 86 D4 15 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 8079EFCC  4B 8D 8D 99 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8079EFD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8079EFD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8079EFD8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8079EFDC  38 81 00 2C */	addi r4, r1, 0x2c
/* 8079EFE0  4B 8D 53 D5 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8079F058  4B 8D 8C 85 */	bl __dt__11dBgS_LinChkFv
...
/* 8079F06C  4B 8D 8C 71 */	bl __dt__11dBgS_LinChkFv
