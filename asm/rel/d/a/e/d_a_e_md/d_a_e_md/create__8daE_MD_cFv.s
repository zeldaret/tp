...
/* 8070A054  4B C5 81 85 */	bl _savegpr_28
/* 8070A058  7C 7D 1B 78 */	mr r29, r3
/* 8070A05C  3C 80 80 71 */	lis r4, ccCylSrc@ha /* 0x8070A4EC@ha */
/* 8070A060  3B E4 A4 EC */	addi r31, r4, ccCylSrc@l /* 0x8070A4EC@l */
...
/* 8070A07C  4B 90 EA E9 */	bl __ct__10fopAc_ac_cFv
/* 8070A080  38 7E 05 E4 */	addi r3, r30, 0x5e4
/* 8070A084  4B BB 6E E1 */	bl __ct__15Z2CreatureEnemyFv
/* 8070A088  38 7E 06 98 */	addi r3, r30, 0x698
/* 8070A08C  4B 96 BE 21 */	bl __ct__12dBgS_AcchCirFv
/* 8070A090  3B 9E 06 D8 */	addi r28, r30, 0x6d8
/* 8070A094  7F 83 E3 78 */	mr r3, r28
/* 8070A098  4B 96 C0 09 */	bl __ct__9dBgS_AcchFv
/* 8070A09C  3C 60 80 71 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x8070A5E0@ha */
/* 8070A0A0  38 63 A5 E0 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x8070A5E0@l */
...
/* 8070A0BC  4B 96 ED AD */	bl SetObj__16dBgS_PolyPassChkFv
/* 8070A0C0  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 8070A0C4  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 8070A0C8  90 1E 08 C8 */	stw r0, 0x8c8(r30)
/* 8070A0CC  38 7E 08 CC */	addi r3, r30, 0x8cc
/* 8070A0D0  4B 97 96 91 */	bl __ct__10dCcD_GSttsFv
/* 8070A0D4  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 8070A0D8  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 8070A0F0  4B 97 99 39 */	bl __ct__12dCcD_GObjInfFv
/* 8070A0F4  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 8070A0F8  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 8070A0FC  90 1C 01 20 */	stw r0, 0x120(r28)
/* 8070A100  3C 60 80 71 */	lis r3, __vt__8cM3dGAab@ha /* 0x8070A5D4@ha */
/* 8070A104  38 03 A5 D4 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x8070A5D4@l */
/* 8070A108  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 8070A10C  3C 60 80 71 */	lis r3, __vt__8cM3dGCyl@ha /* 0x8070A5C8@ha */
/* 8070A110  38 03 A5 C8 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x8070A5C8@l */
/* 8070A114  90 1C 01 38 */	stw r0, 0x138(r28)
/* 8070A118  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 8070A11C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 8070A120  90 7C 01 20 */	stw r3, 0x120(r28)
/* 8070A124  38 03 00 58 */	addi r0, r3, 0x58
/* 8070A128  90 1C 01 38 */	stw r0, 0x138(r28)
/* 8070A12C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 8070A130  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 8070A158  3C 80 80 71 */	lis r4, d_a_e_md__stringBase0@ha /* 0x8070A570@ha */
/* 8070A15C  38 84 A5 70 */	addi r4, r4, d_a_e_md__stringBase0@l /* 0x8070A570@l */
/* 8070A160  4B 92 2D 5D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 8070A164  7C 7E 1B 78 */	mr r30, r3
/* 8070A168  2C 1E 00 04 */	cmpwi r30, 4
/* 8070A16C  40 82 02 44 */	bne lbl_8070A3B0
/* 8070A170  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 8070A174  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
...
/* 8070A204  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8070A208  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8070A20C  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8070A210  7C 05 07 74 */	extsb r5, r0
/* 8070A214  4B 92 B1 4D */	bl isSwitch__10dSv_info_cCFii
...
lbl_8070A228:
/* 8070A228  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8070A22C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8070A230  38 63 09 58 */	addi r3, r3, 0x958
/* 8070A234  38 80 00 07 */	li r4, 7
/* 8070A238  4B 92 A6 FD */	bl isDungeonItem__12dSv_memBit_cCFi
...
/* 8070A26C  3C 80 80 71 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x80708EE8@ha */
/* 8070A270  38 84 8E E8 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x80708EE8@l */
/* 8070A274  38 A0 24 90 */	li r5, 0x2490
/* 8070A278  4B 91 02 39 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8070A2D4  4B 96 BC 85 */	bl SetWall__12dBgS_AcchCirFff
...
/* 8070A2F4  4B 91 02 55 */	bl fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 8070A320  4B 96 BF 29 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 8070A348  4B 91 39 75 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 8070A34C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8070A350  41 82 00 10 */	beq lbl_8070A360
/* 8070A354  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 8070A358  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 8070A394  4B BB 6D 01 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 8070A3B8  4B C5 7E 6D */	bl _restgpr_28
