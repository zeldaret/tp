...
/* 806A2F2C  4B CB F2 B1 */	bl _savegpr_29
/* 806A2F30  7C 7E 1B 78 */	mr r30, r3
/* 806A2F34  3C 80 80 6A */	lis r4, lit_3903@ha /* 0x806A71C4@ha */
/* 806A2F38  3B E4 71 C4 */	addi r31, r4, lit_3903@l /* 0x806A71C4@l */
...
/* 806A2FC8  4B BC 49 C5 */	bl cM_rndFX__Ff
...
/* 806A2FE4  4B BC 49 A9 */	bl cM_rndFX__Ff
...
/* 806A3000  4B BC 3B 35 */	bl __mi__4cXyzCFRC3Vec
...
/* 806A301C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806A3020  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 806A3034  4B 96 93 11 */	bl mDoMtx_XrotS__FPA4_fs
/* 806A3038  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806A303C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 806A308C  4B BC 48 C9 */	bl cM_rndF__Ff
...
lbl_806A30D4:
/* 806A30D4  3C 60 80 6A */	lis r3, l_HIO@ha /* 0x806A74C8@ha */
/* 806A30D8  38 63 74 C8 */	addi r3, r3, l_HIO@l /* 0x806A74C8@l */
...
/* 806A3108  4B BC 48 4D */	bl cM_rndF__Ff
...
lbl_806A31AC:
/* 806A31AC  3C 60 80 6A */	lis r3, l_HIO@ha /* 0x806A74C8@ha */
/* 806A31B0  38 63 74 C8 */	addi r3, r3, l_HIO@l /* 0x806A74C8@l */
...
/* 806A31C4  4B BC 39 71 */	bl __mi__4cXyzCFRC3Vec
...
/* 806A31E0  4B BC 44 95 */	bl cM_atan2s__Fff
...
/* 806A31FC  4B CA 3F 3D */	bl PSVECSquareMag
...
/* 806A326C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806A3270  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806A32DC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806A32E0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806A32E4:
...
/* 806A3370  4B BC 45 E5 */	bl cM_rndF__Ff
...
/* 806A33CC  3C 80 80 6A */	lis r4, l_HIO@ha /* 0x806A74C8@ha */
/* 806A33D0  38 84 74 C8 */	addi r4, r4, l_HIO@l /* 0x806A74C8@l */
/* 806A33D4  C0 04 00 0C */	lfs f0, 0xc(r4)
/* 806A33D8  EC 63 00 32 */	fmuls f3, f3, f0
/* 806A33DC  4B BC C6 61 */	bl cLib_addCalc2__FPffff
...
/* 806A342C  4B BC D1 DD */	bl cLib_addCalcAngleS2__FPssss
lbl_806A3430:
...
/* 806A3478  3C 80 80 6A */	lis r4, l_HIO@ha /* 0x806A74C8@ha */
/* 806A347C  38 84 74 C8 */	addi r4, r4, l_HIO@l /* 0x806A74C8@l */
...
/* 806A34C8  4B CB ED 61 */	bl _restgpr_29
