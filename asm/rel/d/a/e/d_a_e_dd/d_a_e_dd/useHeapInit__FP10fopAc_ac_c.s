...
/* 806A616C  4B CB C0 55 */	bl _savegpr_22
/* 806A6170  7C 7B 1B 78 */	mr r27, r3
/* 806A6174  38 60 00 58 */	li r3, 0x58
/* 806A6178  4B C2 8A D5 */	bl __nw__FUl
/* 806A617C  7C 76 1B 79 */	or. r22, r3, r3
/* 806A6180  41 82 00 9C */	beq lbl_806A621C
/* 806A6184  3C 60 80 6A */	lis r3, d_a_e_dd__stringBase0@ha /* 0x806A72B4@ha */
/* 806A6188  38 63 72 B4 */	addi r3, r3, d_a_e_dd__stringBase0@l /* 0x806A72B4@l */
/* 806A618C  38 63 00 05 */	addi r3, r3, 5
/* 806A6190  38 80 00 15 */	li r4, 0x15
/* 806A6194  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A6198  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806A61AC  4B 99 61 41 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806A61B0  7C 77 1B 78 */	mr r23, r3
/* 806A61B4  3C 60 80 6A */	lis r3, d_a_e_dd__stringBase0@ha /* 0x806A72B4@ha */
/* 806A61B8  38 63 72 B4 */	addi r3, r3, d_a_e_dd__stringBase0@l /* 0x806A72B4@l */
...
/* 806A61CC  4B 99 61 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806A6204  3D 20 80 6A */	lis r9, lit_3905@ha /* 0x806A71CC@ha */
/* 806A6208  C0 29 71 CC */	lfs f1, lit_3905@l(r9)  /* 0x806A71CC@l */
/* 806A620C  39 20 00 00 */	li r9, 0
/* 806A6210  39 40 FF FF */	li r10, -1
/* 806A6214  4B 96 A5 BD */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806A6248  3C 60 80 6A */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 0x806A2378@ha */
/* 806A624C  38 83 23 78 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l /* 0x806A2378@l */
...
/* 806A628C  3C 60 80 6A */	lis r3, l_HIO@ha /* 0x806A74C8@ha */
/* 806A6290  3B E3 74 C8 */	addi r31, r3, l_HIO@l /* 0x806A74C8@l */
/* 806A6294  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A6298  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806A629C  3F C3 00 02 */	addis r30, r3, 2
/* 806A62A0  3C 60 80 6A */	lis r3, lit_3905@ha /* 0x806A71CC@ha */
/* 806A62A4  3A E3 71 CC */	addi r23, r3, lit_3905@l /* 0x806A71CC@l */
/* 806A62A8  3C 60 80 6A */	lis r3, d_a_e_dd__stringBase0@ha /* 0x806A72B4@ha */
/* 806A62AC  3B 03 72 B4 */	addi r24, r3, d_a_e_dd__stringBase0@l /* 0x806A72B4@l */
/* 806A62B0  3C 60 80 6A */	lis r3, brk_d@ha /* 0x806A7338@ha */
/* 806A62B4  3B 23 73 38 */	addi r25, r3, brk_d@l /* 0x806A7338@l */
/* 806A62B8  3B DE C2 F8 */	addi r30, r30, -15624
lbl_806A62BC:
/* 806A62BC  38 60 00 18 */	li r3, 0x18
/* 806A62C0  4B C2 89 8D */	bl __nw__FUl
/* 806A62C4  7C 76 1B 79 */	or. r22, r3, r3
/* 806A62C8  41 82 00 20 */	beq lbl_806A62E8
/* 806A62CC  3C 80 80 6A */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x806A7494@ha */
/* 806A62D0  38 04 74 94 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x806A7494@l */
/* 806A62D4  90 16 00 00 */	stw r0, 0(r22)
/* 806A62D8  38 80 00 00 */	li r4, 0
/* 806A62DC  4B C8 21 21 */	bl init__12J3DFrameCtrlFs
...
/* 806A6340  4B 99 5F AD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806A6370  4B 96 73 9D */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 806A63A4  4B CB BE 69 */	bl _restgpr_22
