...
/* 806A22EC  4B CB FE F1 */	bl _savegpr_29
...
/* 806A2304  3C 60 80 6A */	lis r3, d_a_e_dd__stringBase0@ha /* 0x806A72B4@ha */
/* 806A2308  38 63 72 B4 */	addi r3, r3, d_a_e_dd__stringBase0@l /* 0x806A72B4@l */
/* 806A230C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A2310  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806A2314  3C A5 00 02 */	addis r5, r5, 2
/* 806A2318  38 C0 00 80 */	li r6, 0x80
/* 806A231C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806A2320  4B 99 9F CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806A2338  3C C0 80 6A */	lis r6, lit_3904@ha /* 0x806A71C8@ha */
/* 806A233C  C0 66 71 C8 */	lfs f3, lit_3904@l(r6)  /* 0x806A71C8@l */
/* 806A2340  3C C0 80 6A */	lis r6, lit_3943@ha /* 0x806A7208@ha */
/* 806A2344  C0 86 72 08 */	lfs f4, lit_3943@l(r6)  /* 0x806A7208@l */
/* 806A2348  4B 96 EB 29 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806A2364  4B CB FE C5 */	bl _restgpr_29
