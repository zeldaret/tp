...
/* 806A3D7C  4B CB E4 5D */	bl _savegpr_28
/* 806A3D80  7C 7F 1B 78 */	mr r31, r3
/* 806A3D84  7C 9C 23 78 */	mr r28, r4
/* 806A3D88  3C 80 80 6A */	lis r4, lit_3903@ha /* 0x806A71C4@ha */
/* 806A3D8C  3B C4 71 C4 */	addi r30, r4, lit_3903@l /* 0x806A71C4@l */
/* 806A3D90  4B 97 4F 51 */	bl fopAc_IsActor__FPv
...
/* 806A3DE8  4B BC 2D 4D */	bl __mi__4cXyzCFRC3Vec
/* 806A3DEC  38 61 00 0C */	addi r3, r1, 0xc
/* 806A3DF0  4B CA 33 49 */	bl PSVECSquareMag
...
/* 806A3E60  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806A3E64  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806A3ED0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806A3ED4  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806A3F00  4B BC BB 3D */	bl cLib_addCalc2__FPffff
...
/* 806A3F14  4B BC BB 29 */	bl cLib_addCalc2__FPffff
...
/* 806A3F28  4B BC BB 15 */	bl cLib_addCalc2__FPffff
...
/* 806A3F68  4B 97 5D 15 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 806A3F84  4B CB E2 A1 */	bl _restgpr_28
