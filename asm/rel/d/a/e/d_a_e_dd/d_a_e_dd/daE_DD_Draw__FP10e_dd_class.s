...
/* 806A255C  4B CB FC 81 */	bl _savegpr_29
/* 806A2560  7C 7F 1B 78 */	mr r31, r3
/* 806A2564  3C 60 80 6A */	lis r3, lit_3903@ha /* 0x806A71C4@ha */
/* 806A2568  3B C3 71 C4 */	addi r30, r3, lit_3903@l /* 0x806A71C4@l */
/* 806A256C  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 806A2570  83 A3 00 04 */	lwz r29, 4(r3)
/* 806A2574  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806A2578  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806A257C  38 80 00 00 */	li r4, 0
/* 806A2580  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 806A2584  38 DF 01 0C */	addi r6, r31, 0x10c
/* 806A2588  4B B0 12 3D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806A258C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806A2590  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806A2594  80 9D 00 04 */	lwz r4, 4(r29)
/* 806A2598  38 BF 01 0C */	addi r5, r31, 0x10c
/* 806A259C  4B B0 28 05 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806A25BC  4B 96 B1 ED */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 806A25C0  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 806A25C4  4B 96 EB FD */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 806A2620  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806A2624  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806A2628  4B 98 C2 E9 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806A262C  90 7F 06 B4 */	stw r3, 0x6b4(r31)
lbl_806A2630:
/* 806A2630  38 60 00 01 */	li r3, 1
/* 806A2634  39 61 00 30 */	addi r11, r1, 0x30
/* 806A2638  4B CB FB F1 */	bl _restgpr_29
