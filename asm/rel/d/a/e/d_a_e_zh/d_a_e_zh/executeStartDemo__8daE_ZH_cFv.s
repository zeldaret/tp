...
/* 8082A8A4  4B B3 79 39 */	bl _savegpr_29
/* 8082A8A8  7C 7D 1B 78 */	mr r29, r3
/* 8082A8AC  3C 80 80 83 */	lis r4, lit_3778@ha /* 0x8082F208@ha */
/* 8082A8B0  3B E4 F2 08 */	addi r31, r4, lit_3778@l /* 0x8082F208@l */
/* 8082A8B4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082A8B8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8082A904  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082A908  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082A90C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8082A910  7F A4 EB 78 */	mr r4, r29
/* 8082A914  3C A0 80 04 */	lis r5, dEv_noFinishSkipProc__FPvi@ha /* 0x800428DC@ha */
/* 8082A918  38 A5 28 DC */	addi r5, r5, dEv_noFinishSkipProc__FPvi@l /* 0x800428DC@l */
/* 8082A91C  38 C0 00 00 */	li r6, 0
/* 8082A920  4B 81 7F F5 */	bl setSkipProc__14dEvt_control_cFPvPFPvi_ii
...
/* 8082A9E0  4B A4 50 D9 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 8082AA14  4B A4 50 A5 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 8082AAB8  4B 95 61 61 */	bl Reset__9dCamera_cF4cXyz4cXyz
/* 8082AABC  38 7E 02 48 */	addi r3, r30, 0x248
/* 8082AAC0  4B 93 69 ED */	bl Start__9dCamera_cFv
/* 8082AAC4  38 7E 02 48 */	addi r3, r30, 0x248
/* 8082AAC8  38 80 00 00 */	li r4, 0
/* 8082AACC  4B 93 85 41 */	bl SetTrimSize__9dCamera_cFl
/* 8082AAD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082AAD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082AAD8  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8082AADC  4B 81 79 8D */	bl reset__14dEvt_control_cFv
/* 8082AAE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082AAE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082AAE8  38 80 00 12 */	li r4, 0x12
/* 8082AAEC  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8082AAF0  7C 05 07 74 */	extsb r5, r0
/* 8082AAF4  4B 80 A7 0D */	bl onSwitch__10dSv_info_cFii
...
/* 8082AB2C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082AB30  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8082AB4C  4B 80 A6 B5 */	bl onSwitch__10dSv_info_cFii
...
/* 8082AB6C  4B 7F C6 05 */	bl dStage_changeScene__FifUlScsi
lbl_8082AB70:
