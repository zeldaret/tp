...
/* 8082B294  4B B3 6F 49 */	bl _savegpr_29
/* 8082B298  7C 7D 1B 78 */	mr r29, r3
/* 8082B29C  3C 80 80 83 */	lis r4, lit_3778@ha /* 0x8082F208@ha */
/* 8082B2A0  3B E4 F2 08 */	addi r31, r4, lit_3778@l /* 0x8082F208@l */
/* 8082B2A4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082B2A8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8082B2D8  3C 80 80 83 */	lis r4, lit_4883@ha /* 0x8082F55C@ha */
/* 8082B2DC  38 84 F5 5C */	addi r4, r4, lit_4883@l /* 0x8082F55C@l */
...
/* 8082B310  4B 7F 18 91 */	bl fopAcM_cancelCarryNow__FP10fopAc_ac_c
/* 8082B314  88 9D 07 A9 */	lbz r4, 0x7a9(r29)
/* 8082B318  28 04 00 FF */	cmplwi r4, 0xff
/* 8082B31C  41 82 00 30 */	beq lbl_8082B34C
/* 8082B320  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082B324  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082B328  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8082B32C  7C 05 07 74 */	extsb r5, r0
/* 8082B330  4B 80 9E D1 */	bl onSwitch__10dSv_info_cFii
...
lbl_8082B3CC:
/* 8082B3CC  3C 60 80 83 */	lis r3, mStartFlag@ha /* 0x8082F750@ha */
/* 8082B3D0  80 03 F7 50 */	lwz r0, mStartFlag@l(r3)  /* 0x8082F750@l */
...
/* 8082B3E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082B3EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082B3F0  38 80 00 5A */	li r4, 0x5a
/* 8082B3F4  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8082B3F8  7C 05 07 74 */	extsb r5, r0
/* 8082B3FC  4B 80 9F 65 */	bl isSwitch__10dSv_info_cCFii
...
/* 8082B414  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082B418  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082B41C  38 80 00 5B */	li r4, 0x5b
/* 8082B420  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8082B424  7C 05 07 74 */	extsb r5, r0
/* 8082B428  4B 80 9F 39 */	bl isSwitch__10dSv_info_cCFii
...
lbl_8082B440:
/* 8082B440  3C 60 80 83 */	lis r3, l_HIO@ha /* 0x8082F734@ha */
/* 8082B444  38 63 F7 34 */	addi r3, r3, l_HIO@l /* 0x8082F734@l */
...
lbl_8082B4DC:
/* 8082B4DC  3C 80 80 83 */	lis r4, mStartFlag@ha /* 0x8082F750@ha */
/* 8082B4E0  80 04 F7 50 */	lwz r0, mStartFlag@l(r4)  /* 0x8082F750@l */
...
/* 8082B504  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082B508  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082B50C  38 80 00 5A */	li r4, 0x5a
/* 8082B510  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8082B514  7C 05 07 74 */	extsb r5, r0
/* 8082B518  4B 80 9C E9 */	bl onSwitch__10dSv_info_cFii
/* 8082B51C  48 00 00 1C */	b lbl_8082B538
lbl_8082B520:
/* 8082B520  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082B524  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082B528  38 80 00 5B */	li r4, 0x5b
/* 8082B52C  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8082B530  7C 05 07 74 */	extsb r5, r0
/* 8082B534  4B 80 9C CD */	bl onSwitch__10dSv_info_cFii
lbl_8082B538:
/* 8082B538  38 00 00 02 */	li r0, 2
/* 8082B53C  3C 60 80 83 */	lis r3, mStartFlag@ha /* 0x8082F750@ha */
/* 8082B540  90 03 F7 50 */	stw r0, mStartFlag@l(r3)  /* 0x8082F750@l */
...
/* 8082B5CC  4B 95 55 15 */	bl Set__9dCamera_cF4cXyz4cXyzfs
...
/* 8082B648  4B 95 5F F9 */	bl dCam_getBody__Fv
...
/* 8082B65C  4B 95 5B 15 */	bl StartBlure__9dCamera_cFiP10fopAc_ac_cff
lbl_8082B660:
...
/* 8082B6A0  4B A4 44 19 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 8082B6E8  4B 95 53 F9 */	bl Set__9dCamera_cF4cXyz4cXyzfs
...
/* 8082B78C  4B A4 42 B1 */	bl cLib_addCalc2__FPffff
...
/* 8082B7D8  4B 93 5C D5 */	bl Start__9dCamera_cFv
/* 8082B7DC  38 7E 02 48 */	addi r3, r30, 0x248
/* 8082B7E0  38 80 00 00 */	li r4, 0
/* 8082B7E4  4B 93 78 29 */	bl SetTrimSize__9dCamera_cFl
/* 8082B7E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082B7EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082B7F0  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8082B7F4  4B 81 6C 75 */	bl reset__14dEvt_control_cFv
...
/* 8082B80C  4B B3 6A 1D */	bl _restgpr_29
