...
/* 8082BA28  4B B3 67 B5 */	bl _savegpr_29
/* 8082BA2C  7C 7E 1B 78 */	mr r30, r3
/* 8082BA30  3C 80 80 83 */	lis r4, lit_3778@ha /* 0x8082F208@ha */
/* 8082BA34  3B E4 F2 08 */	addi r31, r4, lit_3778@l /* 0x8082F208@l */
...
/* 8082BA58  4B 84 C2 11 */	bl __ct__11dBgS_LinChkFv
...
/* 8082BAD4  4B A3 BE 81 */	bl cM_rndF__Ff
...
/* 8082BAFC  4B A3 B0 39 */	bl __mi__4cXyzCFRC3Vec
...
/* 8082BB1C  4B B1 B6 1D */	bl PSVECSquareMag
...
/* 8082BB8C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8082BB90  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8082BBFC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8082BC00  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8082BC04:
/* 8082BC04  3C 60 80 83 */	lis r3, l_HIO@ha /* 0x8082F734@ha */
/* 8082BC08  3B A3 F7 34 */	addi r29, r3, l_HIO@l /* 0x8082F734@l */
...
/* 8082BC1C  4B A3 BD 71 */	bl cM_rndFX__Ff
...
/* 8082BC64  4B A3 B4 C5 */	bl atan2sX_Z__4cXyzCFv
/* 8082BC68  B0 7E 07 B2 */	sth r3, 0x7b2(r30)
lbl_8082BC6C:
/* 8082BC6C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8082BC70  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8082BC74  80 63 00 00 */	lwz r3, 0(r3)
/* 8082BC78  A8 9E 07 B2 */	lha r4, 0x7b2(r30)
/* 8082BC7C  4B 7E 07 61 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8082BCE4  4B A3 B4 45 */	bl atan2sX_Z__4cXyzCFv
...
/* 8082BD28  4B A4 48 E1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8082BD3C  4B A4 48 CD */	bl cLib_addCalcAngleS2__FPssss
...
/* 8082BD50  4B A4 48 B9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8082BD64  4B B3 93 6D */	bl abs
/* 8082BD68  2C 03 02 00 */	cmpwi r3, 0x200
/* 8082BD6C  41 81 00 70 */	bgt lbl_8082BDDC
/* 8082BD70  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8082BD74  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8082BD78  80 63 00 00 */	lwz r3, 0(r3)
/* 8082BD7C  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 8082BD80  4B 7E 06 5D */	bl mDoMtx_YrotS__FPA4_fs
/* 8082BD84  C0 1F 00 10 */	lfs f0, 0x10(r31)
/* 8082BD88  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 8082BD8C  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 8082BD90  3C 60 80 83 */	lis r3, l_HIO@ha /* 0x8082F734@ha */
/* 8082BD94  38 63 F7 34 */	addi r3, r3, l_HIO@l /* 0x8082F734@l */
...
/* 8082BDD8  4B A4 3C E1 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
lbl_8082BDDC:
...
/* 8082BE04  4B 84 BE D9 */	bl __dt__11dBgS_LinChkFv
lbl_8082BE08:
/* 8082BE08  39 61 00 E0 */	addi r11, r1, 0xe0
/* 8082BE0C  4B B3 64 1D */	bl _restgpr_29
