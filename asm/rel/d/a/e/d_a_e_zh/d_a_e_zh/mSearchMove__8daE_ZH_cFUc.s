...
/* 8082A034  4B B3 81 A1 */	bl _savegpr_27
/* 8082A038  7C 7C 1B 78 */	mr r28, r3
/* 8082A03C  7C 9D 23 78 */	mr r29, r4
/* 8082A040  3C 80 80 83 */	lis r4, lit_3778@ha /* 0x8082F208@ha */
/* 8082A044  3B E4 F2 08 */	addi r31, r4, lit_3778@l /* 0x8082F208@l */
...
lbl_8082A094:
/* 8082A094  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8082A098  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8082A09C  80 63 00 00 */	lwz r3, 0(r3)
/* 8082A0A0  A8 9C 04 DE */	lha r4, 0x4de(r28)
/* 8082A0A4  4B 7E 23 39 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8082A0C4  4B A4 6E 29 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8082A0E0  4B B1 CF B1 */	bl PSVECAdd
...
/* 8082A118  4B B1 CF 79 */	bl PSVECAdd
...
/* 8082A164  4B A3 C9 81 */	bl __pl__4cXyzCFRC3Vec
...
/* 8082A19C  4B A4 59 1D */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 8082A1B0  4B A3 C9 85 */	bl __mi__4cXyzCFRC3Vec
...
/* 8082A1DC  4B A4 64 2D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8082A220  4B 7F 04 F1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8082A224  7C 7B 1B 78 */	mr r27, r3
/* 8082A228  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8082A22C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8082A24C  4B A8 5D 41 */	bl changeBgmStatus__8Z2SeqMgrFl
/* 8082A250  48 00 00 28 */	b lbl_8082A278
lbl_8082A254:
/* 8082A254  38 61 00 2C */	addi r3, r1, 0x2c
/* 8082A258  4B A3 CE D1 */	bl atan2sX_Z__4cXyzCFv
/* 8082A25C  7C 7B 07 34 */	extsh r27, r3
/* 8082A260  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8082A264  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 8082A268  80 63 00 00 */	lwz r3, 0(r3)
/* 8082A26C  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8082A270  38 80 00 63 */	li r4, 0x63
/* 8082A274  4B A8 5D 19 */	bl changeBgmStatus__8Z2SeqMgrFl
lbl_8082A278:
...
/* 8082A288  4B A4 63 81 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8082A37C  4B B3 7E A5 */	bl _restgpr_27
