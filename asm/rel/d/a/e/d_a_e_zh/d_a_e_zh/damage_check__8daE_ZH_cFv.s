...
lbl_8082A570:
/* 8082A570  3C 60 80 83 */	lis r3, l_HIO@ha /* 0x8082F734@ha */
/* 8082A574  38 63 F7 34 */	addi r3, r3, l_HIO@l /* 0x8082F734@l */
/* 8082A578  88 03 00 18 */	lbz r0, 0x18(r3)
/* 8082A57C  28 00 00 00 */	cmplwi r0, 0
/* 8082A580  40 82 00 84 */	bne lbl_8082A604
/* 8082A584  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082A588  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082A58C  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8082A590  3C 80 80 83 */	lis r4, d_a_e_zh__stringBase0@ha /* 0x8082F410@ha */
/* 8082A594  38 84 F4 10 */	addi r4, r4, d_a_e_zh__stringBase0@l /* 0x8082F410@l */
/* 8082A598  38 84 00 05 */	addi r4, r4, 5
/* 8082A59C  4B B3 E3 F9 */	bl strcmp
...
/* 8082A5B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082A5B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082A5BC  38 80 00 14 */	li r4, 0x14
/* 8082A5C0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 8082A5C4  7C 05 07 74 */	extsb r5, r0
/* 8082A5C8  4B 80 AD 99 */	bl isSwitch__10dSv_info_cCFii
...
/* 8082A5E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082A5E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082A5E8  38 80 00 15 */	li r4, 0x15
/* 8082A5EC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 8082A5F0  7C 05 07 74 */	extsb r5, r0
/* 8082A5F4  4B 80 AD 6D */	bl isSwitch__10dSv_info_cCFii
...
/* 8082A668  4B 85 9E 91 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 8082A694  4B A3 CA 95 */	bl atan2sX_Z__4cXyzCFv
...
/* 8082A6E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082A6E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8082A708  4B 82 1B 11 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
/* 8082A70C  7F E3 FB 78 */	mr r3, r31
/* 8082A710  38 9F 0D B8 */	addi r4, r31, 0xdb8
/* 8082A714  4B 85 D4 F1 */	bl cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 8082A790  4B 80 33 71 */	bl dComIfGs_offOneZoneSwitch__Fii
...
/* 8082A7C0  4B 85 9C A1 */	bl ChkTgHit__12dCcD_GObjInfFv
/* 8082A7C4  28 03 00 00 */	cmplwi r3, 0
/* 8082A7C8  41 82 00 14 */	beq lbl_8082A7DC
/* 8082A7CC  38 7F 0A 08 */	addi r3, r31, 0xa08
/* 8082A7D0  4B 85 9D 29 */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 8082A7D4  7C 7E 1B 78 */	mr r30, r3
/* 8082A7D8  48 00 00 10 */	b lbl_8082A7E8
lbl_8082A7DC:
/* 8082A7DC  38 7F 0B 40 */	addi r3, r31, 0xb40
/* 8082A7E0  4B 85 9D 19 */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 8082A7E4  7C 7E 1B 78 */	mr r30, r3
lbl_8082A7E8:
/* 8082A7E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082A7EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8082A80C  4B 82 1A 0D */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 8082A828  4B 85 9D 89 */	bl getHitSeID__12dCcD_GObjInfFUci
...
/* 8082A870  4B 85 8F C1 */	bl Move__10dCcD_GSttsFv
lbl_8082A874:
