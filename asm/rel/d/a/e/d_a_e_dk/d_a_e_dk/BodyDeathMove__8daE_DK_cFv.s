...
/* 806ABE54  3C 60 80 6B */	lis r3, lit_3764@ha /* 0x806AD538@ha */
/* 806ABE58  3B E3 D5 38 */	addi r31, r3, lit_3764@l /* 0x806AD538@l */
/* 806ABE5C  38 7E 06 AC */	addi r3, r30, 0x6ac
/* 806ABE60  C0 3F 00 AC */	lfs f1, 0xac(r31)
/* 806ABE64  C0 5F 00 94 */	lfs f2, 0x94(r31)
/* 806ABE68  4B BC 48 D9 */	bl cLib_chaseF__FPfff
/* 806ABE6C  38 7E 06 B0 */	addi r3, r30, 0x6b0
/* 806ABE70  C0 3F 00 20 */	lfs f1, 0x20(r31)
/* 806ABE74  C0 5F 00 94 */	lfs f2, 0x94(r31)
/* 806ABE78  4B BC 48 C9 */	bl cLib_chaseF__FPfff
/* 806ABE7C  A8 1E 06 8C */	lha r0, 0x68c(r30)
/* 806ABE80  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 806ABE84  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806ABE88  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806ABEDC  4B 9C B6 A1 */	bl __ct__11dBgS_GndChkFv
...
/* 806ABF0C  4B BB BE 1D */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 806ABF10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806ABF14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806ABF18  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806ABF1C  38 81 00 14 */	addi r4, r1, 0x14
/* 806ABF20  4B 9C 85 81 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 806ABF50  4B 9C B6 A1 */	bl __dt__11dBgS_GndChkFv
