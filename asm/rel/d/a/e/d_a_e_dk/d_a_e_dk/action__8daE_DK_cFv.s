...
/* 806AC3D0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806AC3D4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806AC3D8  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806AC3DC  4B 96 E4 05 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806AC3E0  3C 60 80 6B */	lis r3, l_HIO@ha /* 0x806AD808@ha */
/* 806AC3E4  38 63 D8 08 */	addi r3, r3, l_HIO@l /* 0x806AD808@l */
...
/* 806AC49C  4B C1 56 E1 */	bl setLinkSearch__15Z2CreatureEnemyFb
/* 806AC4A0  7F E3 FB 78 */	mr r3, r31
/* 806AC4A4  38 9F 09 28 */	addi r4, r31, 0x928
/* 806AC4A8  4B 96 E2 25 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806AC4AC  38 7F 06 FC */	addi r3, r31, 0x6fc
/* 806AC4B0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806AC4B4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806AC4B8  3B C4 0F 38 */	addi r30, r4, 0xf38
/* 806AC4BC  7F C4 F3 78 */	mr r4, r30
/* 806AC4C0  4B 9C A5 ED */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 806AC4D4  3C 60 80 6B */	lis r3, lit_3873@ha /* 0x806AD558@ha */
/* 806AC4D8  C0 03 D5 58 */	lfs f0, lit_3873@l(r3)  /* 0x806AD558@l */
...
/* 806AC4FC  3C 60 80 6B */	lis r3, lit_4062@ha /* 0x806AD59C@ha */
/* 806AC500  C0 03 D5 9C */	lfs f0, lit_4062@l(r3)  /* 0x806AD59C@l */
...
/* 806AC514  4B BC 31 35 */	bl SetC__8cM3dGSphFRC4cXyz
/* 806AC518  38 7F 08 D4 */	addi r3, r31, 0x8d4
/* 806AC51C  3C 80 80 6B */	lis r4, lit_4062@ha /* 0x806AD59C@ha */
/* 806AC520  C0 24 D5 9C */	lfs f1, lit_4062@l(r4)  /* 0x806AD59C@l */
/* 806AC524  4B BC 31 E5 */	bl SetR__8cM3dGSphFf
/* 806AC528  3C 60 80 6B */	lis r3, SphBgcCallBack__8daE_DK_cFP11dBgS_SphChkP10cBgD_Vtx_tiiiP8cM3dGPlaPv@ha /* 0x806AAD68@ha */
/* 806AC52C  38 03 AD 68 */	addi r0, r3, SphBgcCallBack__8daE_DK_cFP11dBgS_SphChkP10cBgD_Vtx_tiiiP8cM3dGPlaPv@l /* 0x806AAD68@l */
...
/* 806AC540  4B 9C 91 49 */	bl SphChk__4dBgSFP11dBgS_SphChkPv
lbl_806AC544:
...
/* 806AC554  4B 96 0E D5 */	bl play__14mDoExt_baseAnmFv
