...
/* 806AA238  4B CB 7F 95 */	bl _savegpr_25
/* 806AA23C  7C 79 1B 78 */	mr r25, r3
/* 806AA240  3C 60 80 6B */	lis r3, lit_3764@ha /* 0x806AD538@ha */
/* 806AA244  3B E3 D5 38 */	addi r31, r3, lit_3764@l /* 0x806AD538@l */
...
/* 806AA258  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806AA25C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806AA260  38 80 00 00 */	li r4, 0
/* 806AA264  38 B9 04 D0 */	addi r5, r25, 0x4d0
/* 806AA268  38 D9 01 0C */	addi r6, r25, 0x10c
/* 806AA26C  4B AF 95 59 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806AA270  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806AA274  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806AA278  80 9E 00 04 */	lwz r4, 4(r30)
/* 806AA27C  38 B9 01 0C */	addi r5, r25, 0x10c
/* 806AA280  4B AF AB 21 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806AA284  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806AA288  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806AA28C  80 9D 00 04 */	lwz r4, 4(r29)
/* 806AA290  38 B9 01 0C */	addi r5, r25, 0x10c
/* 806AA294  4B AF AB 0D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806AA30C  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 806AA310  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 806AA37C  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 806AA380  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 806AA430  4B 96 33 79 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 806AA450  4B 96 32 89 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 806AA454  80 79 05 B4 */	lwz r3, 0x5b4(r25)
/* 806AA458  4B 96 6D 69 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 806AA46C  4B 96 6D 55 */	bl entryDL__16mDoExt_McaMorfSOFv
lbl_806AA470:
...
/* 806AA4D0  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806AA4D4  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806AA4D8  4B 98 44 39 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 806AA51C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806AA520  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806AA524  4B 98 43 ED */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 806AA57C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806AA580  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806AA584  4B 98 43 8D */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806AA588  90 79 06 84 */	stw r3, 0x684(r25)
lbl_806AA58C:
/* 806AA58C  38 60 00 01 */	li r3, 1
lbl_806AA590:
/* 806AA590  39 61 00 40 */	addi r11, r1, 0x40
/* 806AA594  4B CB 7C 85 */	bl _restgpr_25
