...
/* 806AB06C  3C 60 80 6B */	lis r3, l_HIO@ha /* 0x806AD808@ha */
/* 806AB070  38 63 D8 08 */	addi r3, r3, l_HIO@l /* 0x806AD808@l */
...
/* 806AB094  4B BB C3 61 */	bl __ct__5csXyzFsss
/* 806AB098  3B C0 00 FF */	li r30, 0xff
/* 806AB09C  4B B0 01 E5 */	bl dKy_camera_water_in_status_check__Fv
...
/* 806AB0C0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806AB0C4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806AB0C8  4B C9 B3 E9 */	bl PSMTXCopy
/* 806AB0CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806AB0D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806AB0EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806AB0F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806AB134  3D 60 80 6B */	lis r11, lit_3874@ha /* 0x806AD55C@ha */
/* 806AB138  C0 2B D5 5C */	lfs f1, lit_3874@l(r11)  /* 0x806AD55C@l */
/* 806AB13C  4B 9A 19 55 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
