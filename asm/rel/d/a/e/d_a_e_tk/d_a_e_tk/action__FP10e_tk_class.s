...
/* 807B942C  4B BA 8D B1 */	bl _savegpr_29
/* 807B9430  7C 7D 1B 78 */	mr r29, r3
/* 807B9434  3C 80 80 7C */	lis r4, lit_3762@ha /* 0x807BA26C@ha */
/* 807B9438  3B C4 A2 6C */	addi r30, r4, lit_3762@l /* 0x807BA26C@l */
/* 807B943C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B9440  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B9444  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 807B9448  4B 86 12 C9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 807B944C  B0 7D 06 8C */	sth r3, 0x68c(r29)
/* 807B9450  7F A3 EB 78 */	mr r3, r29
/* 807B9454  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 807B9458  4B 86 13 89 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807B9478  3C 60 80 7C */	lis r3, lit_4185@ha /* 0x807BA32C@ha */
/* 807B947C  38 63 A3 2C */	addi r3, r3, lit_4185@l /* 0x807BA32C@l */
...
/* 807B94EC  4B B0 86 91 */	bl setLinkSearch__15Z2CreatureEnemyFb
/* 807B94F0  48 00 00 10 */	b lbl_807B9500
lbl_807B94F4:
/* 807B94F4  38 7D 05 CC */	addi r3, r29, 0x5cc
/* 807B94F8  38 80 00 00 */	li r4, 0
/* 807B94FC  4B B0 86 81 */	bl setLinkSearch__15Z2CreatureEnemyFb
lbl_807B9500:
...
/* 807B9538  4B 86 3B D5 */	bl fopAcM_effHamonSet__FPUlPC4cXyzff
lbl_807B953C:
/* 807B953C  39 61 00 30 */	addi r11, r1, 0x30
/* 807B9540  4B BA 8C E9 */	bl _restgpr_29
