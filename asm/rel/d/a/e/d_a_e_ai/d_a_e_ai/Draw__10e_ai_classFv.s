...
/* 8067940C  4B CE 8D CD */	bl _savegpr_28
/* 80679410  7C 7C 1B 78 */	mr r28, r3
/* 80679414  3C 60 80 68 */	lis r3, lit_3789@ha /* 0x8067C3FC@ha */
/* 80679418  3B E3 C3 FC */	addi r31, r3, lit_3789@l /* 0x8067C3FC@l */
/* 8067941C  80 7C 05 D0 */	lwz r3, 0x5d0(r28)
/* 80679420  83 C3 00 04 */	lwz r30, 4(r3)
/* 80679424  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80679428  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8067942C  38 80 00 08 */	li r4, 8
/* 80679430  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 80679434  38 DC 01 0C */	addi r6, r28, 0x10c
/* 80679438  4B B2 A3 8D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8067943C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80679440  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80679444  80 9E 00 04 */	lwz r4, 4(r30)
/* 80679448  38 BC 01 0C */	addi r5, r28, 0x10c
/* 8067944C  4B B2 B9 55 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80679460  4B 99 43 49 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80679464  80 7C 05 D0 */	lwz r3, 0x5d0(r28)
/* 80679468  4B 99 7D 59 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 8067946C  38 7D 00 58 */	addi r3, r29, 0x58
/* 80679470  80 9C 05 C8 */	lwz r4, 0x5c8(r28)
/* 80679474  80 84 00 14 */	lwz r4, 0x14(r4)
/* 80679478  4B CB 64 09 */	bl removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
...
/* 806794C8  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806794CC  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806794D0  4B 9B 54 41 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806794D4  90 7C 06 80 */	stw r3, 0x680(r28)
/* 806794D8  38 60 00 01 */	li r3, 1
/* 806794DC  39 61 00 30 */	addi r11, r1, 0x30
/* 806794E0  4B CE 8D 45 */	bl _restgpr_28
