...
/* 8067B8F4  4B CE 68 E9 */	bl _savegpr_29
/* 8067B8F8  7C 7D 1B 78 */	mr r29, r3
/* 8067B8FC  3C 80 80 68 */	lis r4, lit_3789@ha /* 0x8067C3FC@ha */
/* 8067B900  3B E4 C3 FC */	addi r31, r4, lit_3789@l /* 0x8067C3FC@l */
...
/* 8067B92C  3C 80 80 68 */	lis r4, d_a_e_ai__stringBase0@ha /* 0x8067C538@ha */
/* 8067B930  38 84 C5 38 */	addi r4, r4, d_a_e_ai__stringBase0@l /* 0x8067C538@l */
/* 8067B934  4B 9B 15 89 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8067B964  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8067B968  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8067B96C  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8067B970  7C 05 07 74 */	extsb r5, r0
/* 8067B974  4B 9B 99 ED */	bl isSwitch__10dSv_info_cCFii
...
/* 8067B98C  3C 80 80 68 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x8067B8C4@ha */
/* 8067B990  38 84 B8 C4 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x8067B8C4@l */
/* 8067B994  38 A0 10 80 */	li r5, 0x1080
/* 8067B998  4B 99 EB 19 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_8067B9AC:
/* 8067B9AC  3C 60 80 68 */	lis r3, data_8067C698@ha /* 0x8067C698@ha */
/* 8067B9B0  8C 03 C6 98 */	lbzu r0, data_8067C698@l(r3)  /* 0x8067C698@l */
...
/* 8067B9CC  3C 60 80 68 */	lis r3, l_HIO@ha /* 0x8067C6A8@ha */
/* 8067B9D0  38 63 C6 A8 */	addi r3, r3, l_HIO@l /* 0x8067C6A8@l */
...
/* 8067BA00  4B 99 EB 29 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 8067BA14  4B 99 EB 25 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 8067BA54  4B 9F A7 F5 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 8067BA58  38 7D 06 C8 */	addi r3, r29, 0x6c8
/* 8067BA5C  C0 3F 00 00 */	lfs f1, 0(r31)
/* 8067BA60  C0 5F 01 34 */	lfs f2, 0x134(r31)
/* 8067BA64  4B 9F A4 F5 */	bl SetWall__12dBgS_AcchCirFff
...
/* 8067BA84  4B C4 56 11 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 8067BAB4  3C 60 80 68 */	lis r3, l_HIO@ha /* 0x8067C6A8@ha */
/* 8067BAB8  38 63 C6 A8 */	addi r3, r3, l_HIO@l /* 0x8067C6A8@l */
...
/* 8067BAD8  4B CE 67 51 */	bl _restgpr_29
