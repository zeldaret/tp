...
/* 8067B700  4B CE 6A D9 */	bl _savegpr_28
/* 8067B704  7C 7E 1B 78 */	mr r30, r3
/* 8067B708  3C 60 80 68 */	lis r3, d_a_e_ai__stringBase0@ha /* 0x8067C538@ha */
/* 8067B70C  38 63 C5 38 */	addi r3, r3, d_a_e_ai__stringBase0@l /* 0x8067C538@l */
/* 8067B710  38 80 00 0D */	li r4, 0xd
/* 8067B714  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8067B718  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8067B72C  4B 9C 0B C1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8067B730  7C 7C 1B 78 */	mr r28, r3
/* 8067B734  38 60 00 58 */	li r3, 0x58
/* 8067B738  4B C5 35 15 */	bl __nw__FUl
/* 8067B73C  7C 7D 1B 79 */	or. r29, r3, r3
/* 8067B740  41 82 00 68 */	beq lbl_8067B7A8
/* 8067B744  3C 60 80 68 */	lis r3, d_a_e_ai__stringBase0@ha /* 0x8067C538@ha */
/* 8067B748  38 63 C5 38 */	addi r3, r3, d_a_e_ai__stringBase0@l /* 0x8067C538@l */
/* 8067B74C  38 80 00 09 */	li r4, 9
/* 8067B750  7F E5 FB 78 */	mr r5, r31
/* 8067B754  38 C0 00 80 */	li r6, 0x80
/* 8067B758  4B 9C 0B 95 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8067B790  3D 20 80 68 */	lis r9, lit_3791@ha /* 0x8067C404@ha */
/* 8067B794  C0 29 C4 04 */	lfs f1, lit_3791@l(r9)  /* 0x8067C404@l */
/* 8067B798  39 20 00 00 */	li r9, 0
/* 8067B79C  39 40 FF FF */	li r10, -1
/* 8067B7A0  4B 99 50 31 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8067B7D0  4B C5 34 7D */	bl __nw__FUl
/* 8067B7D4  7C 7D 1B 79 */	or. r29, r3, r3
/* 8067B7D8  41 82 00 20 */	beq lbl_8067B7F8
/* 8067B7DC  3C 80 80 68 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x8067C678@ha */
/* 8067B7E0  38 04 C6 78 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x8067C678@l */
/* 8067B7E4  90 1D 00 00 */	stw r0, 0(r29)
/* 8067B7E8  38 80 00 00 */	li r4, 0
/* 8067B7EC  4B CA CC 11 */	bl init__12J3DFrameCtrlFs
...
lbl_8067B810:
/* 8067B810  3C 60 80 68 */	lis r3, d_a_e_ai__stringBase0@ha /* 0x8067C538@ha */
/* 8067B814  38 63 C5 38 */	addi r3, r3, d_a_e_ai__stringBase0@l /* 0x8067C538@l */
/* 8067B818  38 80 00 12 */	li r4, 0x12
/* 8067B81C  7F E5 FB 78 */	mr r5, r31
/* 8067B820  38 C0 00 80 */	li r6, 0x80
/* 8067B824  4B 9C 0A C9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8067B848  3D 00 80 68 */	lis r8, lit_3790@ha /* 0x8067C400@ha */
/* 8067B84C  C0 28 C4 00 */	lfs f1, lit_3790@l(r8)  /* 0x8067C400@l */
/* 8067B850  39 00 00 00 */	li r8, 0
/* 8067B854  39 20 FF FF */	li r9, -1
/* 8067B858  4B 99 1E B5 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 8067B85C  30 03 FF FF */	addic r0, r3, -1
/* 8067B860  7C 60 19 10 */	subfe r3, r0, r3
lbl_8067B864:
/* 8067B864  39 61 00 30 */	addi r11, r1, 0x30
/* 8067B868  4B CE 69 BD */	bl _restgpr_28
