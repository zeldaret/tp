...
/* 8067ACB8  3C 60 80 68 */	lis r3, lit_3789@ha /* 0x8067C3FC@ha */
/* 8067ACBC  3B E3 C3 FC */	addi r31, r3, lit_3789@l /* 0x8067C3FC@l */
...
/* 8067AD44  4B CC C6 59 */	bl PSVECSquareDistance
...
/* 8067ADB4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8067ADB8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8067AE24  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8067AE28  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8067AE2C:
/* 8067AE2C  C0 1F 00 BC */	lfs f0, 0xbc(r31)
/* 8067AE30  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8067AE34  40 81 00 3C */	ble lbl_8067AE70
/* 8067AE38  3C 60 80 68 */	lis r3, l_HIO@ha /* 0x8067C6A8@ha */
/* 8067AE3C  38 63 C6 A8 */	addi r3, r3, l_HIO@l /* 0x8067C6A8@l */
...
/* 8067AE50  4B BF 5D B5 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8067AE68  4B BF 57 A1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8067AE8C  4B BF 5D 05 */	bl cLib_chaseAngleS__FPsss
lbl_8067AE90:
...
/* 8067AED4  3C 60 80 68 */	lis r3, d_a_e_ai__stringBase0@ha /* 0x8067C538@ha */
/* 8067AED8  38 63 C5 38 */	addi r3, r3, d_a_e_ai__stringBase0@l /* 0x8067C538@l */
/* 8067AEDC  38 80 00 13 */	li r4, 0x13
/* 8067AEE0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8067AEE4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8067AEE8  3C A5 00 02 */	addis r5, r5, 2
/* 8067AEEC  38 C0 00 80 */	li r6, 0x80
/* 8067AEF0  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8067AEF4  4B 9C 13 F9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8067AF24  4B 99 27 E9 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 8067AF40  3C 60 80 68 */	lis r3, l_HIO@ha /* 0x8067C6A8@ha */
/* 8067AF44  38 63 C6 A8 */	addi r3, r3, l_HIO@l /* 0x8067C6A8@l */
...
/* 8067AF58  4B A0 95 09 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 8067B008  4B 9A 20 19 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
lbl_8067B00C:
