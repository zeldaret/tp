...
/* 8074AB40  4B 8C 22 25 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8074AB44  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 8074AB48  4B 8C 23 FD */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8074AB4C  80 7F 07 04 */	lwz r3, 0x704(r31)
/* 8074AB50  80 83 00 04 */	lwz r4, 4(r3)
/* 8074AB54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074AB58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074AB5C  38 84 00 24 */	addi r4, r4, 0x24
/* 8074AB60  4B BF B9 51 */	bl PSMTXCopy
/* 8074AB64  80 7F 07 04 */	lwz r3, 0x704(r31)
/* 8074AB68  4B 8C 66 85 */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 8074AB6C  88 1F 06 89 */	lbz r0, 0x689(r31)
/* 8074AB70  3C 60 80 75 */	lis r3, lit_7464@ha /* 0x8074C13C@ha */
/* 8074AB74  C8 23 C1 3C */	lfd f1, lit_7464@l(r3)  /* 0x8074C13C@l */
