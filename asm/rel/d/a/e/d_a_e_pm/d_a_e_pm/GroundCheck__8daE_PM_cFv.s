...
/* 80745624  4B C1 CB A9 */	bl _savegpr_25
/* 80745628  7C 7B 1B 78 */	mr r27, r3
/* 8074562C  3C 60 80 75 */	lis r3, lit_3910@ha /* 0x8074BF3C@ha */
/* 80745630  3B E3 BF 3C */	addi r31, r3, lit_3910@l /* 0x8074BF3C@l */
/* 80745634  3C 60 80 75 */	lis r3, data_8074C3E8@ha /* 0x8074C3E8@ha */
/* 80745638  38 63 C3 E8 */	addi r3, r3, data_8074C3E8@l /* 0x8074C3E8@l */
...
/* 8074569C  4B 8C 76 C9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 807456A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807456A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807456A8  A8 9B 04 DE */	lha r4, 0x4de(r27)
/* 807456AC  4B 8C 6D 89 */	bl mDoMtx_YrotM__FPA4_fs
/* 807456B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807456B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807456B8  38 81 00 44 */	addi r4, r1, 0x44
/* 807456BC  38 A1 00 2C */	addi r5, r1, 0x2c
/* 807456C0  4B C0 16 AD */	bl PSMTXMultVec
/* 807456C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807456C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807456CC  38 81 00 14 */	addi r4, r1, 0x14
/* 807456D0  38 A1 00 20 */	addi r5, r1, 0x20
/* 807456D4  4B C0 16 99 */	bl PSMTXMultVec
/* 807456D8  3B 21 00 C0 */	addi r25, r1, 0xc0
/* 807456DC  7F 23 CB 78 */	mr r3, r25
/* 807456E0  4B 93 1E 9D */	bl __ct__11dBgS_GndChkFv
/* 807456E4  3C 60 80 75 */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x8074C2EC@ha */
/* 807456E8  38 63 C2 EC */	addi r3, r3, __vt__14dBgS_ObjGndChk@l /* 0x8074C2EC@l */
...
/* 8074570C  4B 93 37 5D */	bl SetObj__16dBgS_PolyPassChkFv
/* 80745710  38 61 00 50 */	addi r3, r1, 0x50
/* 80745714  4B 93 25 55 */	bl __ct__11dBgS_LinChkFv
/* 80745718  7F 23 CB 78 */	mr r3, r25
/* 8074571C  38 81 00 2C */	addi r4, r1, 0x2c
/* 80745720  4B B2 26 09 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 80745724  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80745728  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8074572C  3B 43 0F 38 */	addi r26, r3, 0xf38
/* 80745730  7F 43 D3 78 */	mr r3, r26
/* 80745734  7F 24 CB 78 */	mr r4, r25
/* 80745738  4B 92 ED 69 */	bl GroundCross__4cBgSFP11cBgS_GndChk
/* 8074573C  D0 21 00 30 */	stfs f1, 0x30(r1)
/* 80745740  7F 23 CB 78 */	mr r3, r25
/* 80745744  38 81 00 20 */	addi r4, r1, 0x20
/* 80745748  4B B2 25 E1 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 8074574C  7F 43 D3 78 */	mr r3, r26
/* 80745750  7F 24 CB 78 */	mr r4, r25
/* 80745754  4B 92 ED 4D */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 807457F4  4B B2 B5 CD */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 80745808  4B B2 B5 B9 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 8074581C  4B 93 25 49 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80745820  7F 43 D3 78 */	mr r3, r26
/* 80745824  38 81 00 50 */	addi r4, r1, 0x50
/* 80745828  4B 92 EB 8D */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80745874  3C 60 80 75 */	lis r3, data_8074C3E8@ha /* 0x8074C3E8@ha */
/* 80745878  A8 03 C3 E8 */	lha r0, data_8074C3E8@l(r3)  /* 0x8074C3E8@l */
/* 8074587C  B0 1B 06 02 */	sth r0, 0x602(r27)
/* 80745880  48 00 00 10 */	b lbl_80745890
lbl_80745884:
/* 80745884  3C 60 80 75 */	lis r3, data_8074C3E8@ha /* 0x8074C3E8@ha */
/* 80745888  A8 03 C3 E8 */	lha r0, data_8074C3E8@l(r3)  /* 0x8074C3E8@l */
/* 8074588C  B0 1B 06 02 */	sth r0, 0x602(r27)
lbl_80745890:
/* 80745890  38 61 00 50 */	addi r3, r1, 0x50
/* 80745894  38 80 FF FF */	li r4, -1
/* 80745898  4B 93 24 45 */	bl __dt__11dBgS_LinChkFv
/* 8074589C  3C 60 80 75 */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x8074C2EC@ha */
/* 807458A0  38 03 C2 EC */	addi r0, r3, __vt__14dBgS_ObjGndChk@l /* 0x8074C2EC@l */
...
/* 807458BC  4B 93 1D 35 */	bl __dt__11dBgS_GndChkFv
...
/* 807458E4  4B C1 C9 35 */	bl _restgpr_25
