...
/* 8074AC20  4B C1 75 BD */	bl _savegpr_29
/* 8074AC24  7C 7E 1B 78 */	mr r30, r3
/* 8074AC28  3C 60 80 75 */	lis r3, lit_3910@ha /* 0x8074BF3C@ha */
/* 8074AC2C  3B E3 BF 3C */	addi r31, r3, lit_3910@l /* 0x8074BF3C@l */
...
/* 8074AC44  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8074AC48  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8074AC4C  80 84 00 00 */	lwz r4, 0(r4)
/* 8074AC50  4B BF B8 61 */	bl PSMTXCopy
...
/* 8074AC74  4B B2 62 79 */	bl MtxPosition__FP4cXyzP4cXyz
/* 8074AC78  38 7E 06 E8 */	addi r3, r30, 0x6e8
/* 8074AC7C  4B 8C 20 E9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8074AC80  38 7E 06 F4 */	addi r3, r30, 0x6f4
/* 8074AC84  4B 8C 22 C1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8074AC88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074AC8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074AC90  80 9E 07 0C */	lwz r4, 0x70c(r30)
/* 8074AC94  38 84 00 24 */	addi r4, r4, 0x24
/* 8074AC98  4B BF B8 19 */	bl PSMTXCopy
/* 8074AC9C  C0 3F 00 04 */	lfs f1, 4(r31)
/* 8074ACA0  C0 5F 02 08 */	lfs f2, 0x208(r31)
/* 8074ACA4  FC 60 08 90 */	fmr f3, f1
/* 8074ACA8  4B 8C 20 F5 */	bl transM__14mDoMtx_stack_cFfff
/* 8074ACAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074ACB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074ACB4  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8074ACB8  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8074ACBC  80 84 00 00 */	lwz r4, 0(r4)
/* 8074ACC0  4B BF B7 F1 */	bl PSMTXCopy
/* 8074ACC4  38 61 00 5C */	addi r3, r1, 0x5c
/* 8074ACC8  38 81 00 50 */	addi r4, r1, 0x50
/* 8074ACCC  4B B2 62 21 */	bl MtxPosition__FP4cXyzP4cXyz
/* 8074ACD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8074ACD4  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8074AD24  4B 90 27 A9 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8074AD38  4B 90 0B E1 */	bl getEmitter__Q213dPa_control_c7level_cFUl
/* 8074AD3C  28 03 00 00 */	cmplwi r3, 0
/* 8074AD40  41 82 00 48 */	beq lbl_8074AD88
/* 8074AD44  3C 80 80 75 */	lis r4, l_HIO@ha /* 0x8074C394@ha */
/* 8074AD48  38 84 C3 94 */	addi r4, r4, l_HIO@l /* 0x8074C394@l */
...
lbl_8074AD88:
/* 8074AD88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074AD8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074AD90  C0 21 00 50 */	lfs f1, 0x50(r1)
/* 8074AD94  C0 41 00 54 */	lfs f2, 0x54(r1)
/* 8074AD98  C0 61 00 58 */	lfs f3, 0x58(r1)
/* 8074AD9C  4B BF BB 4D */	bl PSMTXTrans
/* 8074ADA0  38 61 00 20 */	addi r3, r1, 0x20
/* 8074ADA4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8074ADA8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8074ADAC  80 84 5D 74 */	lwz r4, 0x5d74(r4)
/* 8074ADB0  38 84 00 D8 */	addi r4, r4, 0xd8
/* 8074ADB4  38 A1 00 50 */	addi r5, r1, 0x50
/* 8074ADB8  4B B1 BD 7D */	bl __mi__4cXyzCFRC3Vec
...
/* 8074ADD4  4B B1 C8 A1 */	bl cM_atan2s__Fff
/* 8074ADD8  7C 64 1B 78 */	mr r4, r3
/* 8074ADDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074ADE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074ADE4  4B 8C 16 51 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 8074AE14  4B B1 C8 61 */	bl cM_atan2s__Fff
/* 8074AE18  7C 03 00 D0 */	neg r0, r3
/* 8074AE1C  7C 04 07 34 */	extsh r4, r0
/* 8074AE20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074AE24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074AE28  4B 8C 15 75 */	bl mDoMtx_XrotM__FPA4_fs
/* 8074AE2C  3C 60 80 75 */	lis r3, l_HIO@ha /* 0x8074C394@ha */
/* 8074AE30  38 63 C3 94 */	addi r3, r3, l_HIO@l /* 0x8074C394@l */
/* 8074AE34  C0 23 00 0C */	lfs f1, 0xc(r3)
/* 8074AE38  FC 40 08 90 */	fmr f2, f1
/* 8074AE3C  FC 60 08 90 */	fmr f3, f1
/* 8074AE40  4B 8C 1F F9 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8074AE44  80 7E 07 10 */	lwz r3, 0x710(r30)
/* 8074AE48  80 83 00 04 */	lwz r4, 4(r3)
/* 8074AE4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074AE50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074AE54  38 84 00 24 */	addi r4, r4, 0x24
/* 8074AE58  4B BF B6 59 */	bl PSMTXCopy
...
/* 8074AE6C  4B 8C 57 5D */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 8074AE70  80 7E 07 10 */	lwz r3, 0x710(r30)
/* 8074AE74  4B 8C 58 39 */	bl modelCalc__14mDoExt_McaMorfFv
/* 8074AE78  39 61 00 80 */	addi r11, r1, 0x80
/* 8074AE7C  4B C1 73 AD */	bl _restgpr_29
