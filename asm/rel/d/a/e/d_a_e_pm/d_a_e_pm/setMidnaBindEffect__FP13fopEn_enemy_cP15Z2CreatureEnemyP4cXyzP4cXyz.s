...
/* 8074BB24  4B C1 66 91 */	bl _savegpr_19
/* 8074BB28  7C 7E 1B 78 */	mr r30, r3
/* 8074BB2C  7C 9A 23 78 */	mr r26, r4
/* 8074BB30  7C BB 2B 78 */	mr r27, r5
/* 8074BB34  7C DC 33 78 */	mr r28, r6
/* 8074BB38  3C 60 80 75 */	lis r3, cNullVec__6Z2Calc@ha /* 0x8074C150@ha */
/* 8074BB3C  3A E3 C1 50 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x8074C150@l */
/* 8074BB40  3C 60 80 75 */	lis r3, lit_3910@ha /* 0x8074BF3C@ha */
/* 8074BB44  3B E3 BF 3C */	addi r31, r3, lit_3910@l /* 0x8074BF3C@l */
/* 8074BB48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8074BB4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8074BB50  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 8074BB54  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8074BB58  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 8074BB80  4B A6 09 FD */	bl dKy_darkworld_check__Fv
...
/* 8074BBA4  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8074BBA8  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 8074BBC0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074BBC4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074BBC8  4B BF A8 E9 */	bl PSMTXCopy
...
/* 8074BBE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8074BBE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8074BBE8  38 81 00 4C */	addi r4, r1, 0x4c
/* 8074BBEC  38 A1 00 58 */	addi r5, r1, 0x58
/* 8074BBF0  4B BF B1 7D */	bl PSMTXMultVec
/* 8074BBF4  38 61 00 34 */	addi r3, r1, 0x34
/* 8074BBF8  38 81 00 58 */	addi r4, r1, 0x58
/* 8074BBFC  7F 65 DB 78 */	mr r5, r27
/* 8074BC00  4B B1 AF 35 */	bl __mi__4cXyzCFRC3Vec
...
/* 8074BC1C  4B B1 BA 59 */	bl cM_atan2s__Fff
...
/* 8074BC50  4B B1 BA 25 */	bl cM_atan2s__Fff
...
/* 8074BC6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8074BC70  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8074BCC0  4B 90 0D D1 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8074BCC4  7C 79 1B 79 */	or. r25, r3, r3
/* 8074BCC8  41 82 00 FC */	beq lbl_8074BDC4
/* 8074BCCC  38 61 00 40 */	addi r3, r1, 0x40
/* 8074BCD0  4B BF B4 69 */	bl PSVECSquareMag
...
/* 8074BD40  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8074BD44  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8074BDB0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8074BDB4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8074BDB8:
...
/* 8074BE08  4B 90 0C 89 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8074BE44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8074BE48  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8074BEB4  4B 90 16 19 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8074BF14  4B C1 62 ED */	bl _restgpr_19
