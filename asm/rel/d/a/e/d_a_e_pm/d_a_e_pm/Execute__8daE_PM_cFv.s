...
/* 80748B28  4B C1 96 B5 */	bl _savegpr_29
/* 80748B2C  7C 7E 1B 78 */	mr r30, r3
/* 80748B30  3C 60 80 75 */	lis r3, lit_1109@ha /* 0x8074C348@ha */
/* 80748B34  3B A3 C3 48 */	addi r29, r3, lit_1109@l /* 0x8074C348@l */
/* 80748B38  3C 60 80 75 */	lis r3, lit_3910@ha /* 0x8074BF3C@ha */
/* 80748B3C  3B E3 BF 3C */	addi r31, r3, lit_3910@l /* 0x8074BF3C@l */
/* 80748B40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80748B44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80748BD8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80748BDC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80748C48  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80748C4C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80748C50:
...
/* 80748D04  4B 8E 43 69 */	bl dComIfGp_getReverb__Fi
/* 80748D08  7C 65 1B 78 */	mr r5, r3
/* 80748D0C  80 7E 07 04 */	lwz r3, 0x704(r30)
/* 80748D10  38 80 00 00 */	li r4, 0
/* 80748D14  4B 8C 83 9D */	bl play__16mDoExt_McaMorfSOFUlSc
...
/* 80748D28  4B 8D 19 A5 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 80748D2C  38 7E 08 04 */	addi r3, r30, 0x804
/* 80748D30  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80748D34  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80748D38  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80748D3C  4B 92 DD 71 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 80748D60  4B C1 94 C9 */	bl _restgpr_29
