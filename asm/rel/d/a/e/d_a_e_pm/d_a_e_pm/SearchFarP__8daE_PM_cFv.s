...
/* 80742978  4B C1 F8 5D */	bl _savegpr_27
/* 8074297C  7C 7B 1B 78 */	mr r27, r3
/* 80742980  3C 60 80 75 */	lis r3, lit_3910@ha /* 0x8074BF3C@ha */
/* 80742984  3B C3 BF 3C */	addi r30, r3, lit_3910@l /* 0x8074BF3C@l */
/* 80742988  80 7B 05 E0 */	lwz r3, 0x5e0(r27)
/* 8074298C  38 80 00 00 */	li r4, 0
/* 80742990  4B 90 EE 21 */	bl dPath_GetPnt__FPC5dPathi
...
/* 807429B0  3C 60 80 75 */	lis r3, data_8074C3E4@ha /* 0x8074C3E4@ha */
/* 807429B4  3B E3 C3 E4 */	addi r31, r3, data_8074C3E4@l /* 0x8074C3E4@l */
/* 807429B8  C3 FE 00 04 */	lfs f31, 4(r30)
/* 807429BC  48 00 02 7C */	b lbl_80742C38
lbl_807429C0:
/* 807429C0  7F 84 E3 78 */	mr r4, r28
/* 807429C4  4B 90 ED ED */	bl dPath_GetPnt__FPC5dPathi
...
/* 80742A0C  4B C0 49 91 */	bl PSVECSquareDistance
...
/* 80742A78  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80742A7C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80742AE8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80742AEC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80742AF0:
...
/* 80742B08  3C 60 80 75 */	lis r3, data_8074C3E4@ha /* 0x8074C3E4@ha */
/* 80742B0C  38 63 C3 E4 */	addi r3, r3, data_8074C3E4@l /* 0x8074C3E4@l */
...
/* 80742B48  4B C0 48 55 */	bl PSVECSquareDistance
...
/* 80742BB8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80742BBC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80742C28  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80742C2C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80742C30:
...
/* 80742C4C  4B 90 EB 65 */	bl dPath_GetPnt__FPC5dPathi
...
/* 80742C80  4B C1 F5 A1 */	bl _restgpr_27
