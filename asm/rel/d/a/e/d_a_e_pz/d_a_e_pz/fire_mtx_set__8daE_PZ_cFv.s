...
/* 8075F588  4B C0 2C 41 */	bl _savegpr_24
/* 8075F58C  7C 7E 1B 78 */	mr r30, r3
/* 8075F590  3C 60 80 76 */	lis r3, lit_3906@ha /* 0x807614FC@ha */
/* 8075F594  3B E3 14 FC */	addi r31, r3, lit_3906@l /* 0x807614FC@l */
...
/* 8075F5AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8075F5B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8075F5B4  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 8075F5B8  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 8075F5BC  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 8075F5C0  4B BE 73 29 */	bl PSMTXTrans
/* 8075F5C4  C0 3E 07 C8 */	lfs f1, 0x7c8(r30)
/* 8075F5C8  FC 40 08 90 */	fmr f2, f1
/* 8075F5CC  FC 60 08 90 */	fmr f3, f1
/* 8075F5D0  4B 8A D8 69 */	bl scaleM__14mDoMtx_stack_cFfff
...
/* 8075F5FC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8075F600  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8075F604  3C 60 80 76 */	lis r3, eff_darkHoll_id@ha /* 0x80761CD4@ha */
/* 8075F608  3B 63 1C D4 */	addi r27, r3, eff_darkHoll_id@l /* 0x80761CD4@l */
lbl_8075F60C:
...
/* 8075F658  4B 8E DE 75 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8075F674  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8075F678  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8075F67C  80 9E 05 BC */	lwz r4, 0x5bc(r30)
/* 8075F680  38 84 00 24 */	addi r4, r4, 0x24
/* 8075F684  4B BE 6E 2D */	bl PSMTXCopy
/* 8075F688  80 7E 05 C0 */	lwz r3, 0x5c0(r30)
/* 8075F68C  4B 8A DD 9D */	bl play__14mDoExt_baseAnmFv
...
/* 8075F6A0  4B 8A DD 89 */	bl play__14mDoExt_baseAnmFv
/* 8075F6A4  48 00 00 40 */	b lbl_8075F6E4
lbl_8075F6A8:
/* 8075F6A8  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8075F6AC  7C 03 07 74 */	extsb r3, r0
/* 8075F6B0  4B 8C D9 BD */	bl dComIfGp_getReverb__Fi
/* 8075F6B4  7C 65 1B 78 */	mr r5, r3
/* 8075F6B8  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 8075F6BC  38 80 00 00 */	li r4, 0
/* 8075F6C0  4B 8B 19 F1 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 8075F6C4  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 8075F6C8  80 83 00 04 */	lwz r4, 4(r3)
/* 8075F6CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8075F6D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8075F6D4  38 84 00 24 */	addi r4, r4, 0x24
/* 8075F6D8  4B BE 6D D9 */	bl PSMTXCopy
/* 8075F6DC  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 8075F6E0  4B 8B 1B 0D */	bl modelCalc__16mDoExt_McaMorfSOFv
lbl_8075F6E4:
...
/* 8075F6F8  4B B0 FF 51 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8075F6FC  38 7E 0E AC */	addi r3, r30, 0xeac
/* 8075F700  C0 3F 00 94 */	lfs f1, 0x94(r31)
/* 8075F704  4B B1 00 05 */	bl SetR__8cM3dGSphFf
/* 8075F708  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8075F70C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8075F710  38 63 23 3C */	addi r3, r3, 0x233c
/* 8075F714  38 9E 0D 88 */	addi r4, r30, 0xd88
/* 8075F718  4B B0 54 91 */	bl Set__4cCcSFP8cCcD_Obj
lbl_8075F71C:
/* 8075F71C  39 61 00 50 */	addi r11, r1, 0x50
/* 8075F720  4B C0 2A F5 */	bl _restgpr_24
