...
/* 8075F0CC  4B C0 30 FD */	bl _savegpr_24
/* 8075F0D0  7C 7D 1B 78 */	mr r29, r3
/* 8075F0D4  3C 60 80 76 */	lis r3, lit_3906@ha /* 0x807614FC@ha */
/* 8075F0D8  3B C3 14 FC */	addi r30, r3, lit_3906@l /* 0x807614FC@l */
...
lbl_8075F0F8:
/* 8075F0F8  3C 60 80 76 */	lis r3, struct_80761E0C+0x0@ha /* 0x80761E0C@ha */
/* 8075F0FC  38 63 1E 0C */	addi r3, r3, struct_80761E0C+0x0@l /* 0x80761E0C@l */
/* 8075F100  C0 03 00 10 */	lfs f0, 0x10(r3)
/* 8075F104  D0 1D 05 2C */	stfs f0, 0x52c(r29)
/* 8075F108  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8075F10C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8075F110  80 63 00 00 */	lwz r3, 0(r3)
/* 8075F114  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 8075F118  4B 8A D2 C5 */	bl mDoMtx_YrotS__FPA4_fs
/* 8075F11C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8075F120  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8075F124  80 63 00 00 */	lwz r3, 0(r3)
/* 8075F128  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 8075F12C  4B 8A D2 71 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 8075F14C  4B B1 1D A1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8075F1A4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8075F1A8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8075F1D4  4B B4 D3 39 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8075F1D8:
/* 8075F1D8  3B 00 00 00 */	li r24, 0
/* 8075F1DC  3B 80 00 00 */	li r28, 0
/* 8075F1E0  3B 60 00 00 */	li r27, 0
/* 8075F1E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8075F1E8  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8075F1EC  3C 60 80 76 */	lis r3, eff_bullet_id@ha /* 0x80761CC4@ha */
/* 8075F1F0  3B 43 1C C4 */	addi r26, r3, eff_bullet_id@l /* 0x80761CC4@l */
lbl_8075F1F4:
...
/* 8075F240  4B 8E E2 8D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8075F254  4B 8E C6 C5 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 8075F2EC  3C 60 80 76 */	lis r3, eff_bullet_delete_id@ha /* 0x80761CCC@ha */
/* 8075F2F0  3B 63 1C CC */	addi r27, r3, eff_bullet_delete_id@l /* 0x80761CCC@l */
lbl_8075F2F4:
...
/* 8075F334  4B 8E D7 5D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8075F354  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8075F358  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 8075F384  4B B4 C6 01 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8075F388  7F A3 EB 78 */	mr r3, r29
/* 8075F38C  4B 8B A8 F1 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_8075F390:
/* 8075F390  39 61 00 70 */	addi r11, r1, 0x70
/* 8075F394  4B C0 2E 81 */	bl _restgpr_24
