...
/* 8075F7F8  4B C0 29 E5 */	bl _savegpr_29
/* 8075F7FC  7C 7E 1B 78 */	mr r30, r3
/* 8075F800  3C 60 80 76 */	lis r3, lit_3906@ha /* 0x807614FC@ha */
/* 8075F804  3B E3 14 FC */	addi r31, r3, lit_3906@l /* 0x807614FC@l */
...
/* 8075F818  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8075F81C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8075F820  4B BE 6C 91 */	bl PSMTXCopy
...
/* 8075F838  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8075F83C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8075F840  38 81 00 14 */	addi r4, r1, 0x14
/* 8075F844  38 BE 07 A8 */	addi r5, r30, 0x7a8
/* 8075F848  4B BE 75 25 */	bl PSMTXMultVec
/* 8075F84C  88 1E 08 41 */	lbz r0, 0x841(r30)
/* 8075F850  28 00 00 00 */	cmplwi r0, 0
/* 8075F854  40 82 00 4C */	bne lbl_8075F8A0
/* 8075F858  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8075F85C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8075F8A8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8075F8AC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8075F8B0  4B BE 6C 01 */	bl PSMTXCopy
