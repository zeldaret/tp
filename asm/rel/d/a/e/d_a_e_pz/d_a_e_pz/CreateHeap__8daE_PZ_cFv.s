...
/* 8075FB5C  4B C0 26 69 */	bl _savegpr_23
...
/* 8075FB78  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FB7C  38 63 17 B4 */	addi r3, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FB80  38 80 00 18 */	li r4, 0x18
/* 8075FB84  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8075FB88  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8075FB9C  4B 8D C7 51 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8075FBAC  4B 8B 50 A9 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8075FBCC  4B B6 F0 81 */	bl __nw__FUl
/* 8075FBD0  7C 78 1B 79 */	or. r24, r3, r3
/* 8075FBD4  41 82 00 20 */	beq lbl_8075FBF4
/* 8075FBD8  3C 80 80 76 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80761D9C@ha */
/* 8075FBDC  38 04 1D 9C */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80761D9C@l */
/* 8075FBE0  90 18 00 00 */	stw r0, 0(r24)
/* 8075FBE4  38 80 00 00 */	li r4, 0
/* 8075FBE8  4B BC 88 15 */	bl init__12J3DFrameCtrlFs
...
lbl_8075FC0C:
/* 8075FC0C  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FC10  38 63 17 B4 */	addi r3, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FC14  38 80 00 25 */	li r4, 0x25
/* 8075FC18  7F C5 F3 78 */	mr r5, r30
/* 8075FC1C  38 C0 00 80 */	li r6, 0x80
/* 8075FC20  4B 8D C6 CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8075FC40  3D 00 80 76 */	lis r8, lit_3908@ha /* 0x80761504@ha */
/* 8075FC44  C0 28 15 04 */	lfs f1, lit_3908@l(r8)  /* 0x80761504@l */
/* 8075FC48  39 00 00 00 */	li r8, 0
/* 8075FC4C  39 20 FF FF */	li r9, -1
/* 8075FC50  4B 8A D9 ED */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 8075FC6C  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FC70  3B 23 17 B4 */	addi r25, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FC74  3C 60 80 76 */	lis r3, mPzDarkHoll_dt@ha /* 0x80761CD8@ha */
/* 8075FC78  3B 43 1C D8 */	addi r26, r3, mPzDarkHoll_dt@l /* 0x80761CD8@l */
/* 8075FC7C  3C 60 80 76 */	lis r3, lit_3908@ha /* 0x80761504@ha */
/* 8075FC80  3B 63 15 04 */	addi r27, r3, lit_3908@l /* 0x80761504@l */
lbl_8075FC84:
/* 8075FC84  38 60 00 18 */	li r3, 0x18
/* 8075FC88  4B B6 EF C5 */	bl __nw__FUl
/* 8075FC8C  7C 78 1B 79 */	or. r24, r3, r3
/* 8075FC90  41 82 00 20 */	beq lbl_8075FCB0
/* 8075FC94  3C 80 80 76 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80761D9C@ha */
/* 8075FC98  38 04 1D 9C */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80761D9C@l */
/* 8075FC9C  90 18 00 00 */	stw r0, 0(r24)
/* 8075FCA0  38 80 00 00 */	li r4, 0
/* 8075FCA4  4B BC 87 59 */	bl init__12J3DFrameCtrlFs
...
/* 8075FCDC  4B 8D C6 11 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8075FD08  4B 8A DA 05 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 8075FD2C  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FD30  38 63 17 B4 */	addi r3, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FD34  38 80 00 19 */	li r4, 0x19
/* 8075FD38  7F C5 F3 78 */	mr r5, r30
/* 8075FD3C  38 C0 00 80 */	li r6, 0x80
/* 8075FD40  4B 8D C5 AD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8075FD44  7C 77 1B 78 */	mr r23, r3
/* 8075FD48  38 60 00 58 */	li r3, 0x58
/* 8075FD4C  4B B6 EF 01 */	bl __nw__FUl
/* 8075FD50  7C 78 1B 79 */	or. r24, r3, r3
/* 8075FD54  41 82 00 64 */	beq lbl_8075FDB8
/* 8075FD58  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FD5C  38 63 17 B4 */	addi r3, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FD60  38 80 00 07 */	li r4, 7
/* 8075FD64  7F C5 F3 78 */	mr r5, r30
/* 8075FD68  38 C0 00 80 */	li r6, 0x80
/* 8075FD6C  4B 8D C5 81 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8075FDA0  3D 20 80 76 */	lis r9, lit_3908@ha /* 0x80761504@ha */
/* 8075FDA4  C0 29 15 04 */	lfs f1, lit_3908@l(r9)  /* 0x80761504@l */
/* 8075FDA8  39 20 00 00 */	li r9, 0
/* 8075FDAC  39 40 FF FF */	li r10, -1
/* 8075FDB0  4B 8B 0A 21 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8075FDD4  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FDD8  3B A3 17 B4 */	addi r29, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FDDC  3C 60 80 76 */	lis r3, lit_3908@ha /* 0x80761504@ha */
/* 8075FDE0  3B 83 15 04 */	addi r28, r3, lit_3908@l /* 0x80761504@l */
lbl_8075FDE4:
/* 8075FDE4  38 60 00 18 */	li r3, 0x18
/* 8075FDE8  4B B6 EE 65 */	bl __nw__FUl
/* 8075FDEC  7C 7B 1B 79 */	or. r27, r3, r3
/* 8075FDF0  41 82 00 20 */	beq lbl_8075FE10
/* 8075FDF4  3C 80 80 76 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80761D9C@ha */
/* 8075FDF8  38 04 1D 9C */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80761D9C@l */
/* 8075FDFC  90 1B 00 00 */	stw r0, 0(r27)
/* 8075FE00  38 80 00 00 */	li r4, 0
/* 8075FE04  4B BC 85 F9 */	bl init__12J3DFrameCtrlFs
...
/* 8075FE38  4B 8D C4 B5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8075FE68  4B 8A D8 A5 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_8075FE90:
/* 8075FE90  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FE94  38 63 17 B4 */	addi r3, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FE98  38 80 00 1C */	li r4, 0x1c
/* 8075FE9C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8075FEA0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8075FEB4  4B 8D C4 39 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8075FEB8  7C 77 1B 78 */	mr r23, r3
/* 8075FEBC  38 60 00 58 */	li r3, 0x58
/* 8075FEC0  4B B6 ED 8D */	bl __nw__FUl
/* 8075FEC4  7C 78 1B 79 */	or. r24, r3, r3
/* 8075FEC8  41 82 00 68 */	beq lbl_8075FF30
/* 8075FECC  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FED0  38 63 17 B4 */	addi r3, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FED4  38 80 00 08 */	li r4, 8
/* 8075FED8  7F C5 F3 78 */	mr r5, r30
/* 8075FEDC  38 C0 00 80 */	li r6, 0x80
/* 8075FEE0  4B 8D C4 0D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8075FF18  3D 20 80 76 */	lis r9, lit_3908@ha /* 0x80761504@ha */
/* 8075FF1C  C0 29 15 04 */	lfs f1, lit_3908@l(r9)  /* 0x80761504@l */
/* 8075FF20  39 20 00 00 */	li r9, 0
/* 8075FF24  39 40 FF FF */	li r10, -1
/* 8075FF28  4B 8B 08 A9 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8075FF58  4B B6 EC F5 */	bl __nw__FUl
/* 8075FF5C  7C 7C 1B 79 */	or. r28, r3, r3
/* 8075FF60  41 82 00 20 */	beq lbl_8075FF80
/* 8075FF64  3C 80 80 76 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80761D9C@ha */
/* 8075FF68  38 04 1D 9C */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80761D9C@l */
/* 8075FF6C  90 1C 00 00 */	stw r0, 0(r28)
/* 8075FF70  38 80 00 00 */	li r4, 0
/* 8075FF74  4B BC 84 89 */	bl init__12J3DFrameCtrlFs
...
lbl_8075FF98:
/* 8075FF98  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8075FF9C  38 63 17 B4 */	addi r3, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 8075FFA0  38 80 00 22 */	li r4, 0x22
/* 8075FFA4  7F C5 F3 78 */	mr r5, r30
/* 8075FFA8  38 C0 00 80 */	li r6, 0x80
/* 8075FFAC  4B 8D C3 41 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8075FFD0  3D 00 80 76 */	lis r8, lit_3908@ha /* 0x80761504@ha */
/* 8075FFD4  C0 28 15 04 */	lfs f1, lit_3908@l(r8)  /* 0x80761504@l */
/* 8075FFD8  39 00 00 00 */	li r8, 0
/* 8075FFDC  39 20 FF FF */	li r9, -1
/* 8075FFE0  4B 8A D7 2D */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 8075FFF8  4B B6 EC 55 */	bl __nw__FUl
/* 8075FFFC  7C 7C 1B 79 */	or. r28, r3, r3
/* 80760000  41 82 00 20 */	beq lbl_80760020
/* 80760004  3C 80 80 76 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x80761D9C@ha */
/* 80760008  38 04 1D 9C */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x80761D9C@l */
/* 8076000C  90 1C 00 00 */	stw r0, 0(r28)
/* 80760010  38 80 00 00 */	li r4, 0
/* 80760014  4B BC 83 E9 */	bl init__12J3DFrameCtrlFs
...
lbl_80760038:
/* 80760038  3C 60 80 76 */	lis r3, d_a_e_pz__stringBase0@ha /* 0x807617B4@ha */
/* 8076003C  38 63 17 B4 */	addi r3, r3, d_a_e_pz__stringBase0@l /* 0x807617B4@l */
/* 80760040  38 80 00 26 */	li r4, 0x26
/* 80760044  7F C5 F3 78 */	mr r5, r30
/* 80760048  38 C0 00 80 */	li r6, 0x80
/* 8076004C  4B 8D C2 A1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80760070  3D 00 80 76 */	lis r8, lit_3908@ha /* 0x80761504@ha */
/* 80760074  C0 28 15 04 */	lfs f1, lit_3908@l(r8)  /* 0x80761504@l */
/* 80760078  39 00 00 00 */	li r8, 0
/* 8076007C  39 20 FF FF */	li r9, -1
/* 80760080  4B 8A D5 BD */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80760084  30 03 FF FF */	addic r0, r3, -1
/* 80760088  7C 60 19 10 */	subfe r3, r0, r3
lbl_8076008C:
/* 8076008C  39 61 00 40 */	addi r11, r1, 0x40
/* 80760090  4B C0 21 81 */	bl _restgpr_23
