...
/* 8075F3BC  3C 80 80 76 */	lis r4, lit_3929@ha /* 0x80761530@ha */
/* 8075F3C0  C0 24 15 30 */	lfs f1, lit_3929@l(r4)  /* 0x80761530@l */
/* 8075F3C4  3C 80 80 76 */	lis r4, struct_80761E0C+0x0@ha /* 0x80761E0C@ha */
/* 8075F3C8  38 84 1E 0C */	addi r4, r4, struct_80761E0C+0x0@l /* 0x80761E0C@l */
...
/* 8075F494  4B 8B B2 39 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 8075F4B8  4B 91 7C 5D */	bl SetGroundUpY__9dBgS_AcchFf
/* 8075F4BC  38 7F 08 90 */	addi r3, r31, 0x890
/* 8075F4C0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8075F4C4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8075F4C8  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8075F4CC  4B 91 75 E1 */	bl CrrPos__9dBgS_AcchFR4dBgS
lbl_8075F4D0:
/* 8075F4D0  80 7F 05 D4 */	lwz r3, 0x5d4(r31)
/* 8075F4D4  4B 8A DF 55 */	bl play__14mDoExt_baseAnmFv
/* 8075F4D8  80 7F 05 D0 */	lwz r3, 0x5d0(r31)
/* 8075F4DC  4B 8A DF 4D */	bl play__14mDoExt_baseAnmFv
/* 8075F4E0  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8075F4E4  7C 03 07 74 */	extsb r3, r0
/* 8075F4E8  4B 8C DB 85 */	bl dComIfGp_getReverb__Fi
/* 8075F4EC  7C 65 1B 78 */	mr r5, r3
/* 8075F4F0  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8075F4F4  38 80 00 00 */	li r4, 0
/* 8075F4F8  4B 8B 1B B9 */	bl play__16mDoExt_McaMorfSOFUlSc
lbl_8075F4FC:
