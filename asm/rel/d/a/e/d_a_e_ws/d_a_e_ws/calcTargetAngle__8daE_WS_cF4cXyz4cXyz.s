...
/* 807E40EC  4B A8 2A 49 */	bl __mi__4cXyzCFRC3Vec
...
/* 807E4108  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807E410C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807E4110  A8 1F 06 68 */	lha r0, 0x668(r31)
/* 807E4114  7C 00 00 D0 */	neg r0, r0
/* 807E4118  7C 04 07 34 */	extsh r4, r0
/* 807E411C  4B 82 82 29 */	bl mDoMtx_XrotS__FPA4_fs
/* 807E4120  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807E4124  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807E4128  A8 1F 06 6A */	lha r0, 0x66a(r31)
/* 807E412C  7C 00 00 D0 */	neg r0, r0
/* 807E4130  7C 04 07 34 */	extsh r4, r0
/* 807E4134  4B 82 83 01 */	bl mDoMtx_YrotM__FPA4_fs
/* 807E4138  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807E413C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807E4140  38 81 00 14 */	addi r4, r1, 0x14
/* 807E4144  38 A1 00 20 */	addi r5, r1, 0x20
/* 807E4148  4B B6 2C 25 */	bl PSMTXMultVec
/* 807E414C  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 807E4150  C0 41 00 28 */	lfs f2, 0x28(r1)
/* 807E4154  4B A8 35 21 */	bl cM_atan2s__Fff
