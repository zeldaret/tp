...
/* 807E52AC  3C 60 80 7E */	lis r3, lit_3802@ha /* 0x807E7300@ha */
/* 807E52B0  3B E3 73 00 */	addi r31, r3, lit_3802@l /* 0x807E7300@l */
...
/* 807E5324  4B 89 0C 35 */	bl SetWall__12dBgS_AcchCirFff
...
/* 807E5380  4B 89 1D 95 */	bl SetGroundUpY__9dBgS_AcchFf
...
/* 807E5480  4B A8 24 D5 */	bl cM_rndF__Ff
...
/* 807E55C0  4B A8 A4 7D */	bl cLib_addCalc2__FPffff
...
/* 807E55E0  4B A8 B5 B1 */	bl cLib_chaseAngleS__FPsss
...
/* 807E5648  4B A8 A3 F5 */	bl cLib_addCalc2__FPffff
...
/* 807E565C  4B 83 46 21 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 807E5674  4B 83 74 65 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
/* 807E5678  88 9E 06 92 */	lbz r4, 0x692(r30)
/* 807E567C  28 04 00 FF */	cmplwi r4, 0xff
/* 807E5680  41 82 00 38 */	beq lbl_807E56B8
/* 807E5684  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807E5688  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807E568C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 807E5690  7C 05 07 74 */	extsb r5, r0
/* 807E5694  4B 84 FC CD */	bl isSwitch__10dSv_info_cCFii
/* 807E5698  2C 03 00 00 */	cmpwi r3, 0
/* 807E569C  40 82 00 1C */	bne lbl_807E56B8
/* 807E56A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807E56A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807E56A8  88 9E 06 92 */	lbz r4, 0x692(r30)
/* 807E56AC  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 807E56B0  7C 05 07 74 */	extsb r5, r0
/* 807E56B4  4B 84 FB 4D */	bl onSwitch__10dSv_info_cFii
lbl_807E56B8:
