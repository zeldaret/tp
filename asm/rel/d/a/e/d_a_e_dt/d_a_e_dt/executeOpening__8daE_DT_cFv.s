...
/* 806B29E4  4B CA F7 ED */	bl _savegpr_26
/* 806B29E8  7C 7F 1B 78 */	mr r31, r3
/* 806B29EC  3C 60 80 6B */	lis r3, lit_1109@ha /* 0x806B6260@ha */
/* 806B29F0  3B 83 62 60 */	addi r28, r3, lit_1109@l /* 0x806B6260@l */
/* 806B29F4  3C 60 80 6B */	lis r3, lit_3792@ha /* 0x806B5CD4@ha */
/* 806B29F8  3B C3 5C D4 */	addi r30, r3, lit_3792@l /* 0x806B5CD4@l */
/* 806B29FC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B2A00  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B2A04  83 63 5D AC */	lwz r27, 0x5dac(r3)
/* 806B2A08  4B AC EC 39 */	bl dCam_getBody__Fv
...
/* 806B2A40  3C 60 80 6B */	lis r3, lit_6452@ha /* 0x806B6100@ha */
/* 806B2A44  38 63 61 00 */	addi r3, r3, lit_6452@l /* 0x806B6100@l */
...
/* 806B2AB4  4B 96 72 E5 */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
...
/* 806B2ADC  4B BB E1 29 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 806B2AE0  B0 7F 04 E6 */	sth r3, 0x4e6(r31)
/* 806B2AE4  38 00 C0 00 */	li r0, -16384
/* 806B2AE8  B0 1F 04 E4 */	sth r0, 0x4e4(r31)
/* 806B2AEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B2AF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B2AF4  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 806B2AF8  C0 5E 00 70 */	lfs f2, 0x70(r30)
/* 806B2AFC  FC 60 08 90 */	fmr f3, f1
/* 806B2B00  4B C9 3D E9 */	bl PSMTXTrans
/* 806B2B04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B2B08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B2B0C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806B2B10  4B 95 99 25 */	bl mDoMtx_YrotM__FPA4_fs
/* 806B2B14  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 806B2B18  FC 40 08 90 */	fmr f2, f1
/* 806B2B1C  C0 7E 01 58 */	lfs f3, 0x158(r30)
/* 806B2B20  4B 95 A2 7D */	bl transM__14mDoMtx_stack_cFfff
/* 806B2B24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B2B28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B2C10  4B BB 4D 45 */	bl cM_rndF__Ff
...
/* 806B2C38  4B C7 57 F5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B2C58  4B C7 57 D5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B2C84  4B C7 57 A9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B2CE0  4B 96 70 B9 */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
lbl_806B2CE4:
...
/* 806B2D48  4B BB 4C 45 */	bl cM_rndFX__Ff
...
/* 806B2DA4  4B AA E7 2D */	bl Stop__9dCamera_cFv
/* 806B2DA8  38 61 00 64 */	addi r3, r1, 0x64
/* 806B2DAC  7F A4 EB 78 */	mr r4, r29
/* 806B2DB0  4B AC F0 B5 */	bl Eye__9dCamera_cFv
...
/* 806B2DD4  4B AC F0 C5 */	bl Center__9dCamera_cFv
...
/* 806B2E28  4B AB 01 E5 */	bl SetTrimSize__9dCamera_cFl
...
/* 806B2E4C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806B2E50  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806B2E64  4B BF C6 39 */	bl subBgmStart__8Z2SeqMgrFUl
/* 806B2E68  38 60 00 03 */	li r3, 3
/* 806B2E6C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806B2E70  7C 04 07 74 */	extsb r4, r0
/* 806B2E74  4B 97 AC 29 */	bl dComIfGs_onOneZoneSwitch__Fii
...
/* 806B2E9C  4B 96 8A 6D */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 806B2EF8  4B BB D8 B5 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 806B2F48  4B BB D8 65 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 806B2F6C  4B C7 54 C1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B2F84  4B C7 54 A9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B2F9C  4B C7 54 91 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B2FC8  3C 60 80 6B */	lis r3, s_fall_otama__FPvPv@ha /* 0x806AFD94@ha */
/* 806B2FCC  38 63 FD 94 */	addi r3, r3, s_fall_otama__FPvPv@l /* 0x806AFD94@l */
/* 806B2FD0  7F E4 FB 78 */	mr r4, r31
/* 806B2FD4  4B 96 E3 65 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 806B3084  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B3088  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B308C  4B C9 34 25 */	bl PSMTXCopy
/* 806B3090  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B3094  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B312C  4B BB D6 15 */	bl cLib_chaseF__FPfff
/* 806B3130  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B3134  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B3138  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806B313C  38 04 60 00 */	addi r0, r4, 0x6000
/* 806B3140  7C 04 07 34 */	extsh r4, r0
/* 806B3144  4B 95 92 99 */	bl mDoMtx_YrotS__FPA4_fs
/* 806B3148  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 806B314C  C0 5E 01 78 */	lfs f2, 0x178(r30)
/* 806B3150  C0 7E 01 7C */	lfs f3, 0x17c(r30)
/* 806B3154  4B 95 9C 49 */	bl transM__14mDoMtx_stack_cFfff
/* 806B3158  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B315C  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B3184  4B BB D6 29 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 806B319C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B31A0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B31A4  4B C9 33 0D */	bl PSMTXCopy
...
/* 806B31D8  4B BB D5 D5 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 806B3218  4B BB D5 29 */	bl cLib_chaseF__FPfff
/* 806B321C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B3220  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B3224  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806B3228  38 04 60 00 */	addi r0, r4, 0x6000
/* 806B322C  7C 04 07 34 */	extsh r4, r0
/* 806B3230  4B 95 91 AD */	bl mDoMtx_YrotS__FPA4_fs
/* 806B3234  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 806B3238  C0 5E 01 78 */	lfs f2, 0x178(r30)
/* 806B323C  C0 7E 01 7C */	lfs f3, 0x17c(r30)
/* 806B3240  4B 95 9B 5D */	bl transM__14mDoMtx_stack_cFfff
/* 806B3244  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B3248  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B3270  4B BB D5 3D */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 806B3288  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B328C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B3290  4B C9 32 21 */	bl PSMTXCopy
...
lbl_806B3318:
/* 806B3318  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B331C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B3320  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806B3324  38 04 60 00 */	addi r0, r4, 0x6000
/* 806B3328  7C 04 07 34 */	extsh r4, r0
/* 806B332C  4B 95 90 B1 */	bl mDoMtx_YrotS__FPA4_fs
/* 806B3330  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 806B3334  C0 5E 01 70 */	lfs f2, 0x170(r30)
/* 806B3338  C0 7E 01 74 */	lfs f3, 0x174(r30)
/* 806B333C  4B 95 9A 61 */	bl transM__14mDoMtx_stack_cFfff
/* 806B3340  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B3344  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B336C  4B BB D4 41 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 806B3384  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B3388  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B338C  4B C9 31 25 */	bl PSMTXCopy
...
/* 806B33B4  4B BB D3 F9 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 806B340C  4B BB D3 35 */	bl cLib_chaseF__FPfff
...
/* 806B3428  4B BB D3 19 */	bl cLib_chaseF__FPfff
lbl_806B342C:
...
/* 806B3558  4B BB D1 E9 */	bl cLib_chaseF__FPfff
...
/* 806B35A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B35A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806B35BC  4B 9B C5 55 */	bl StartQuake__12dVibration_cFii4cXyz
...
/* 806B3630  4B BB D1 7D */	bl cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 806B36A0  4B C7 4D 8D */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B36EC  4B 96 66 AD */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
...
/* 806B3710  4B C7 4D 1D */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B377C  3C 80 80 6B */	lis r4, eDt_ShakeFrameDemo__6E_DT_n@ha /* 0x806B5F14@ha */
/* 806B3780  38 84 5F 14 */	addi r4, r4, eDt_ShakeFrameDemo__6E_DT_n@l /* 0x806B5F14@l */
/* 806B3784  7C 24 04 2E */	lfsx f1, r4, r0
/* 806B3788  4B C7 4C A5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B37B4  4B C7 4C 79 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B37D4  4B C7 4C 59 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806B37FC  4B 96 61 C1 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 806B3874  4B BB CE CD */	bl cLib_chaseF__FPfff
...
/* 806B388C  4B 96 61 31 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 806B38CC  4B BB CE E1 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
lbl_806B38D0:
...
/* 806B395C  4B BB CD E5 */	bl cLib_chaseF__FPfff
...
/* 806B3974  4B 96 60 49 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 806B39B4  4B BB CD F9 */	bl cLib_chasePos__FP4cXyzRC4cXyzf
lbl_806B39B8:
...
/* 806B3A1C  4B AC D1 FD */	bl Reset__9dCamera_cF4cXyz4cXyz
/* 806B3A20  7F A3 EB 78 */	mr r3, r29
/* 806B3A24  4B AA DA 89 */	bl Start__9dCamera_cFv
/* 806B3A28  7F A3 EB 78 */	mr r3, r29
/* 806B3A2C  38 80 00 00 */	li r4, 0
/* 806B3A30  4B AA F5 DD */	bl SetTrimSize__9dCamera_cFl
/* 806B3A34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B3A38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B3A3C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 806B3A40  4B 98 EA 29 */	bl reset__14dEvt_control_cFv
/* 806B3A44  38 00 00 04 */	li r0, 4
/* 806B3A48  90 1F 05 5C */	stw r0, 0x55c(r31)
/* 806B3A4C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806B3A50  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806B3A64  4B BF BA 39 */	bl subBgmStart__8Z2SeqMgrFUl
/* 806B3A68  3C 60 80 6B */	lis r3, s_demo_otama__FPvPv@ha /* 0x806AFF1C@ha */
/* 806B3A6C  38 63 FF 1C */	addi r3, r3, s_demo_otama__FPvPv@l /* 0x806AFF1C@l */
/* 806B3A70  7F E4 FB 78 */	mr r4, r31
/* 806B3A74  4B 96 D8 C5 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 806B3AC0  4B AC D0 21 */	bl Set__9dCamera_cF4cXyz4cXyzfs
/* 806B3AC4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B3AC8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B3ACC  3B 63 4E C8 */	addi r27, r3, 0x4ec8
/* 806B3AD0  7F 63 DB 78 */	mr r3, r27
/* 806B3AD4  4B 98 EE D5 */	bl onSkipFade__14dEvt_control_cFv
/* 806B3AD8  7F 63 DB 78 */	mr r3, r27
/* 806B3ADC  7F E4 FB 78 */	mr r4, r31
/* 806B3AE0  3C A0 80 6B */	lis r5, DemoSkipCallBack__8daE_DT_cFPvi@ha /* 0x806AE618@ha */
/* 806B3AE4  38 A5 E6 18 */	addi r5, r5, DemoSkipCallBack__8daE_DT_cFPvi@l /* 0x806AE618@l */
/* 806B3AE8  38 C0 00 00 */	li r6, 0
/* 806B3AEC  4B 98 EE 29 */	bl setSkipProc__14dEvt_control_cFPvPFPvi_ii
lbl_806B3AF0:
/* 806B3AF0  39 61 00 B0 */	addi r11, r1, 0xb0
/* 806B3AF4  4B CA E7 29 */	bl _restgpr_26
