...
/* 806B4A08  3C 60 80 6B */	lis r3, lit_3792@ha /* 0x806B5CD4@ha */
/* 806B4A0C  3B C3 5C D4 */	addi r30, r3, lit_3792@l /* 0x806B5CD4@l */
/* 806B4A10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4A14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4A18  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 806B4A1C  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 806B4A20  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 806B4A24  4B C9 1E C5 */	bl PSMTXTrans
/* 806B4A28  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 806B4A2C  4B 95 85 19 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806B4A30  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 806B4A34  FC 40 08 90 */	fmr f2, f1
/* 806B4A38  C0 7E 01 58 */	lfs f3, 0x158(r30)
/* 806B4A3C  4B 95 83 61 */	bl transM__14mDoMtx_stack_cFfff
/* 806B4A40  C0 3F 06 EC */	lfs f1, 0x6ec(r31)
/* 806B4A44  FC 40 08 90 */	fmr f2, f1
/* 806B4A48  FC 60 08 90 */	fmr f3, f1
/* 806B4A4C  4B 95 83 ED */	bl scaleM__14mDoMtx_stack_cFfff
/* 806B4A50  80 7F 05 D0 */	lwz r3, 0x5d0(r31)
/* 806B4A54  80 83 00 04 */	lwz r4, 4(r3)
/* 806B4A58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4A5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4A60  38 84 00 24 */	addi r4, r4, 0x24
/* 806B4A64  4B C9 1A 4D */	bl PSMTXCopy
/* 806B4A68  80 7F 05 D0 */	lwz r3, 0x5d0(r31)
/* 806B4A6C  4B 95 C7 81 */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 806B4A70  38 7F 06 AC */	addi r3, r31, 0x6ac
/* 806B4A74  4B 95 82 F1 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 806B4A78  38 7F 06 C4 */	addi r3, r31, 0x6c4
/* 806B4A7C  4B 95 84 C9 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806B4A80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4A84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4A88  80 9F 05 C4 */	lwz r4, 0x5c4(r31)
/* 806B4A8C  38 84 00 24 */	addi r4, r4, 0x24
/* 806B4A90  4B C9 1A 21 */	bl PSMTXCopy
/* 806B4A94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4A98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4A9C  80 9F 05 CC */	lwz r4, 0x5cc(r31)
/* 806B4AA0  38 84 00 24 */	addi r4, r4, 0x24
/* 806B4AA4  4B C9 1A 0D */	bl PSMTXCopy
/* 806B4AA8  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 806B4AAC  C0 5F 07 00 */	lfs f2, 0x700(r31)
/* 806B4AB0  FC 60 08 90 */	fmr f3, f1
/* 806B4AB4  4B 95 82 E9 */	bl transM__14mDoMtx_stack_cFfff
/* 806B4AB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4ABC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B4ADC  4B 95 82 89 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 806B4AE0  38 7F 06 CA */	addi r3, r31, 0x6ca
/* 806B4AE4  4B 95 84 61 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806B4AE8  C0 3F 06 F0 */	lfs f1, 0x6f0(r31)
/* 806B4AEC  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 806B4AF0  FC 60 08 90 */	fmr f3, f1
/* 806B4AF4  4B 95 83 45 */	bl scaleM__14mDoMtx_stack_cFfff
/* 806B4AF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4AFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4B00  80 9F 05 C8 */	lwz r4, 0x5c8(r31)
/* 806B4B04  38 84 00 24 */	addi r4, r4, 0x24
/* 806B4B08  4B C9 19 A9 */	bl PSMTXCopy
