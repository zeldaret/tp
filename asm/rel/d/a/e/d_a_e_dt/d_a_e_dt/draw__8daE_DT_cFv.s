...
/* 806ADDAC  4B CB 44 25 */	bl _savegpr_26
/* 806ADDB0  7C 7C 1B 78 */	mr r28, r3
/* 806ADDB4  3C 60 80 6B */	lis r3, lit_3792@ha /* 0x806B5CD4@ha */
/* 806ADDB8  3B E3 5C D4 */	addi r31, r3, lit_3792@l /* 0x806B5CD4@l */
/* 806ADDBC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806ADDC0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806ADDC4  38 80 00 00 */	li r4, 0
/* 806ADDC8  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 806ADDCC  38 DC 01 0C */	addi r6, r28, 0x10c
/* 806ADDD0  4B AF 59 F5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806ADDD4  88 1C 07 78 */	lbz r0, 0x778(r28)
/* 806ADDD8  28 00 00 00 */	cmplwi r0, 0
/* 806ADDDC  41 82 04 D0 */	beq lbl_806AE2AC
/* 806ADDE0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806ADDE4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806ADDE8  80 9C 05 C8 */	lwz r4, 0x5c8(r28)
/* 806ADDEC  80 84 00 04 */	lwz r4, 4(r4)
/* 806ADDF0  38 BC 01 0C */	addi r5, r28, 0x10c
/* 806ADDF4  4B AF 6F AD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806AE06C  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 806AE070  38 C4 71 60 */	addi r6, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 806AE0D0  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 806AE0D4  38 A4 71 60 */	addi r5, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 806AE16C  4B 96 F2 C1 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 806AE170  80 7C 05 C8 */	lwz r3, 0x5c8(r28)
/* 806AE174  4B 95 FB 51 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 806AE178  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806AE17C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806AE180  80 9C 05 CC */	lwz r4, 0x5cc(r28)
/* 806AE184  80 84 00 04 */	lwz r4, 4(r4)
/* 806AE188  38 BC 01 0C */	addi r5, r28, 0x10c
/* 806AE18C  4B AF 6C 15 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806AE2A0  4B 96 F1 8D */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 806AE2A4  80 7C 05 CC */	lwz r3, 0x5cc(r28)
/* 806AE2A8  4B 95 FA 1D */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_806AE2AC:
...
/* 806AE2C8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806AE2CC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806AE2D0  80 9D 00 04 */	lwz r4, 4(r29)
/* 806AE2D4  38 BC 01 0C */	addi r5, r28, 0x10c
/* 806AE2D8  4B AF 6A C9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806AE3A4  4B 96 F0 89 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 806AE3A8  80 7C 05 D0 */	lwz r3, 0x5d0(r28)
/* 806AE3AC  4B 96 2E 15 */	bl entryDL__16mDoExt_McaMorfSOFv
...
lbl_806AE414:
/* 806AE414  3C 60 80 6B */	lis r3, l_HIO@ha /* 0x806B62AC@ha */
/* 806AE418  38 63 62 AC */	addi r3, r3, l_HIO@l /* 0x806B62AC@l */
...
/* 806AE478  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806AE47C  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806AE480  4B 98 04 91 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 806AE4B8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806AE4BC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806AE4C0  38 80 00 10 */	li r4, 0x10
/* 806AE4C4  38 BC 06 AC */	addi r5, r28, 0x6ac
/* 806AE4C8  38 DC 01 0C */	addi r6, r28, 0x10c
/* 806AE4CC  4B AF 52 F9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806AE4D0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806AE4D4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806AE4D8  80 9C 05 C4 */	lwz r4, 0x5c4(r28)
/* 806AE4DC  80 84 00 04 */	lwz r4, 4(r4)
/* 806AE4E0  38 BC 01 0C */	addi r5, r28, 0x10c
/* 806AE4E4  4B AF 68 BD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806AE4E8  80 7C 05 C4 */	lwz r3, 0x5c4(r28)
/* 806AE4EC  4B 95 F7 D9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_806AE4F0:
...
/* 806AE50C  3C 60 80 45 */	lis r3, mBlureFlag__13mDoGph_gInf_c+0x1@ha /* 0x80450BE5@ha */
/* 806AE510  98 03 0B E5 */	stb r0, mBlureFlag__13mDoGph_gInf_c+0x1@l(r3)  /* 0x80450BE5@l */
/* 806AE514  4B 95 9B 65 */	bl onBlure__13mDoGph_gInf_cFv
...
/* 806AE528  3C 60 80 45 */	lis r3, mBlureFlag__13mDoGph_gInf_c+0x0@ha /* 0x80450BE4@ha */
/* 806AE52C  98 03 0B E4 */	stb r0, mBlureFlag__13mDoGph_gInf_c+0x0@l(r3)  /* 0x80450BE4@l */
lbl_806AE530:
...
/* 806AE558  4B CB 3C C5 */	bl _restgpr_26
