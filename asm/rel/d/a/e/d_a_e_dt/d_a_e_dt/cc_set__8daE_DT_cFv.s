...
/* 806B4B34  4B CA D6 A1 */	bl _savegpr_27
/* 806B4B38  7C 7F 1B 78 */	mr r31, r3
/* 806B4B3C  3C 60 80 6B */	lis r3, lit_3792@ha /* 0x806B5CD4@ha */
/* 806B4B40  3B C3 5C D4 */	addi r30, r3, lit_3792@l /* 0x806B5CD4@l */
...
/* 806B4B84  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4B88  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4B8C  4B C9 19 25 */	bl PSMTXCopy
/* 806B4B90  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 806B4B94  C0 5E 00 64 */	lfs f2, 0x64(r30)
/* 806B4B98  FC 60 08 90 */	fmr f3, f1
/* 806B4B9C  4B 95 82 01 */	bl transM__14mDoMtx_stack_cFfff
/* 806B4BA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4BA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B4BD0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4BD4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4BD8  4B C9 18 D9 */	bl PSMTXCopy
/* 806B4BDC  C0 3E 00 B4 */	lfs f1, 0xb4(r30)
/* 806B4BE0  C0 5E 00 60 */	lfs f2, 0x60(r30)
/* 806B4BE4  FC 60 10 90 */	fmr f3, f2
/* 806B4BE8  4B 95 81 B5 */	bl transM__14mDoMtx_stack_cFfff
/* 806B4BEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4BF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B4C1C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4C20  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4C24  4B C9 18 8D */	bl PSMTXCopy
/* 806B4C28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4C2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B4C98  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4C9C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4CA0  4B C9 18 11 */	bl PSMTXCopy
/* 806B4CA4  C0 3E 01 2C */	lfs f1, 0x12c(r30)
/* 806B4CA8  C0 5E 01 58 */	lfs f2, 0x158(r30)
/* 806B4CAC  C0 7E 00 60 */	lfs f3, 0x60(r30)
/* 806B4CB0  4B 95 80 ED */	bl transM__14mDoMtx_stack_cFfff
...
/* 806B4CE8  4B BB AA 21 */	bl SetR__8cM3dGSphFf
/* 806B4CEC  48 00 00 20 */	b lbl_806B4D0C
lbl_806B4CF0:
/* 806B4CF0  38 7F 0A FC */	addi r3, r31, 0xafc
/* 806B4CF4  C0 3E 01 E0 */	lfs f1, 0x1e0(r30)
/* 806B4CF8  4B BB AA 11 */	bl SetR__8cM3dGSphFf
/* 806B4CFC  48 00 00 10 */	b lbl_806B4D0C
lbl_806B4D00:
/* 806B4D00  38 7F 0A FC */	addi r3, r31, 0xafc
/* 806B4D04  C0 3E 01 B0 */	lfs f1, 0x1b0(r30)
/* 806B4D08  4B BB AA 01 */	bl SetR__8cM3dGSphFf
lbl_806B4D0C:
/* 806B4D0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4D10  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B4D34  4B BB A9 15 */	bl SetC__8cM3dGSphFRC4cXyz
/* 806B4D38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B4D3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B4D40  3B 63 23 3C */	addi r27, r3, 0x233c
/* 806B4D44  7F 63 DB 78 */	mr r3, r27
/* 806B4D48  38 9F 09 D8 */	addi r4, r31, 0x9d8
/* 806B4D4C  4B BA FE 5D */	bl Set__4cCcSFP8cCcD_Obj
/* 806B4D50  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 806B4D54  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806B4D58  38 63 00 30 */	addi r3, r3, 0x30
/* 806B4D5C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4D60  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4D64  4B C9 17 4D */	bl PSMTXCopy
/* 806B4D68  C0 3E 01 2C */	lfs f1, 0x12c(r30)
/* 806B4D6C  C0 5E 01 58 */	lfs f2, 0x158(r30)
/* 806B4D70  C0 7E 00 60 */	lfs f3, 0x60(r30)
/* 806B4D74  4B 95 80 29 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806B4DB0  4B 95 7F ED */	bl transM__14mDoMtx_stack_cFfff
/* 806B4DB4  38 7F 0C 34 */	addi r3, r31, 0xc34
/* 806B4DB8  C0 3E 01 9C */	lfs f1, 0x19c(r30)
/* 806B4DBC  4B BB A9 4D */	bl SetR__8cM3dGSphFf
...
/* 806B4DD0  4B 95 7F CD */	bl transM__14mDoMtx_stack_cFfff
/* 806B4DD4  38 7F 0C 34 */	addi r3, r31, 0xc34
/* 806B4DD8  C0 3E 01 E4 */	lfs f1, 0x1e4(r30)
/* 806B4DDC  4B BB A9 2D */	bl SetR__8cM3dGSphFf
...
/* 806B4DF0  4B 95 7F AD */	bl transM__14mDoMtx_stack_cFfff
/* 806B4DF4  38 7F 0C 34 */	addi r3, r31, 0xc34
/* 806B4DF8  C0 3E 01 9C */	lfs f1, 0x19c(r30)
/* 806B4DFC  4B BB A9 0D */	bl SetR__8cM3dGSphFf
lbl_806B4E00:
...
/* 806B4E20  4B BB A8 29 */	bl SetC__8cM3dGSphFRC4cXyz
/* 806B4E24  7F 63 DB 78 */	mr r3, r27
/* 806B4E28  38 9F 0B 10 */	addi r4, r31, 0xb10
/* 806B4E2C  4B BA FD 7D */	bl Set__4cCcSFP8cCcD_Obj
/* 806B4E30  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 806B4E34  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806B4E38  38 63 05 70 */	addi r3, r3, 0x570
/* 806B4E3C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4E40  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4E44  4B C9 16 6D */	bl PSMTXCopy
/* 806B4E48  C0 3E 00 B4 */	lfs f1, 0xb4(r30)
/* 806B4E4C  C0 5E 00 60 */	lfs f2, 0x60(r30)
/* 806B4E50  FC 60 10 90 */	fmr f3, f2
/* 806B4E54  4B 95 7F 49 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806B4E78  4B BB A7 D1 */	bl SetC__8cM3dGSphFRC4cXyz
/* 806B4E7C  38 7F 0F DC */	addi r3, r31, 0xfdc
/* 806B4E80  C0 3E 00 C4 */	lfs f1, 0xc4(r30)
/* 806B4E84  4B BB A8 85 */	bl SetR__8cM3dGSphFf
/* 806B4E88  7F 63 DB 78 */	mr r3, r27
/* 806B4E8C  38 9F 0E B8 */	addi r4, r31, 0xeb8
/* 806B4E90  4B BA FD 19 */	bl Set__4cCcSFP8cCcD_Obj
/* 806B4E94  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 806B4E98  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806B4E9C  38 63 05 70 */	addi r3, r3, 0x570
/* 806B4EA0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4EA4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4EA8  4B C9 16 09 */	bl PSMTXCopy
/* 806B4EAC  C0 3E 00 58 */	lfs f1, 0x58(r30)
/* 806B4EB0  C0 5E 00 60 */	lfs f2, 0x60(r30)
/* 806B4EB4  FC 60 10 90 */	fmr f3, f2
/* 806B4EB8  4B 95 7E E5 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806B4EDC  4B BB A7 6D */	bl SetC__8cM3dGSphFRC4cXyz
/* 806B4EE0  38 7F 11 14 */	addi r3, r31, 0x1114
/* 806B4EE4  C0 3E 00 C4 */	lfs f1, 0xc4(r30)
/* 806B4EE8  4B BB A8 21 */	bl SetR__8cM3dGSphFf
/* 806B4EEC  7F 63 DB 78 */	mr r3, r27
/* 806B4EF0  38 9F 0F F0 */	addi r4, r31, 0xff0
/* 806B4EF4  4B BA FC B5 */	bl Set__4cCcSFP8cCcD_Obj
/* 806B4EF8  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 806B4EFC  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806B4F00  38 63 06 30 */	addi r3, r3, 0x630
/* 806B4F04  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4F08  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4F0C  4B C9 15 A5 */	bl PSMTXCopy
/* 806B4F10  C0 3E 00 7C */	lfs f1, 0x7c(r30)
/* 806B4F14  C0 5E 00 60 */	lfs f2, 0x60(r30)
/* 806B4F18  FC 60 10 90 */	fmr f3, f2
/* 806B4F1C  4B 95 7E 81 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806B4F40  4B BB A7 09 */	bl SetC__8cM3dGSphFRC4cXyz
/* 806B4F44  38 7F 0D 6C */	addi r3, r31, 0xd6c
/* 806B4F48  C0 3E 00 64 */	lfs f1, 0x64(r30)
/* 806B4F4C  4B BB A7 BD */	bl SetR__8cM3dGSphFf
/* 806B4F50  7F 63 DB 78 */	mr r3, r27
/* 806B4F54  38 9F 0C 48 */	addi r4, r31, 0xc48
/* 806B4F58  4B BA FC 51 */	bl Set__4cCcSFP8cCcD_Obj
/* 806B4F5C  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 806B4F60  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806B4F64  38 63 06 F0 */	addi r3, r3, 0x6f0
/* 806B4F68  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B4F6C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B4F70  4B C9 15 41 */	bl PSMTXCopy
/* 806B4F74  C0 3E 00 7C */	lfs f1, 0x7c(r30)
/* 806B4F78  C0 5E 00 60 */	lfs f2, 0x60(r30)
/* 806B4F7C  FC 60 10 90 */	fmr f3, f2
/* 806B4F80  4B 95 7E 1D */	bl transM__14mDoMtx_stack_cFfff
