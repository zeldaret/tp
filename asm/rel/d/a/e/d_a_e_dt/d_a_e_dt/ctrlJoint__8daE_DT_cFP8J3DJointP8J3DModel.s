...
/* 806AD994  4B CB 48 44 */	b _savegpr_28
...
/* 806AD9B4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806AD9B8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806AD9BC  4B C9 8A F4 */	b PSMTXCopy
/* 806AD9C0  A8 1C 07 4C */	lha r0, 0x74c(r28)
/* 806AD9C4  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 806AD9C8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806AD9CC  38 A3 9A 20 */	addi r5, r3, sincosTable___5JMath@l
/* 806AD9D0  7C 45 04 2E */	lfsx f2, r5, r0
/* 806AD9D4  3C 60 80 6B */	lis r3, lit_3868@ha
/* 806AD9D8  C0 23 5C FC */	lfs f1, lit_3868@l(r3)
...
/* 806AD9F8  3C 60 80 6B */	lis r3, lit_3870@ha
/* 806AD9FC  C8 43 5D 04 */	lfd f2, lit_3870@l(r3)
...
/* 806ADA64  3C 60 80 6B */	lis r3, lit_3874@ha
/* 806ADA68  38 63 5F BC */	addi r3, r3, lit_3874@l
...
/* 806ADA84  4B 95 F3 B4 */	b scaleM__14mDoMtx_stack_cFfff
/* 806ADA88  3C 60 80 6B */	lis r3, lit_3868@ha
/* 806ADA8C  C0 23 5C FC */	lfs f1, lit_3868@l(r3)
/* 806ADA90  FC 40 08 90 */	fmr f2, f1
/* 806ADA94  FC 60 F8 90 */	fmr f3, f31
/* 806ADA98  4B 95 F3 A0 */	b scaleM__14mDoMtx_stack_cFfff
...
/* 806ADAAC  4B 95 F3 8C */	b scaleM__14mDoMtx_stack_cFfff
/* 806ADAB0  3C 60 80 6B */	lis r3, lit_3868@ha
/* 806ADAB4  C0 23 5C FC */	lfs f1, lit_3868@l(r3)
/* 806ADAB8  FC 40 08 90 */	fmr f2, f1
/* 806ADABC  FC 60 F8 90 */	fmr f3, f31
/* 806ADAC0  4B 95 F3 78 */	b scaleM__14mDoMtx_stack_cFfff
/* 806ADAC4  48 00 00 8C */	b lbl_806ADB50
lbl_806ADAC8:
/* 806ADAC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADACC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADAD0  4B 95 E9 64 */	b mDoMtx_YrotM__FPA4_fs
/* 806ADAD4  48 00 00 7C */	b lbl_806ADB50
lbl_806ADAD8:
/* 806ADAD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADADC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADAE0  7C 04 00 D0 */	neg r0, r4
/* 806ADAE4  7C 04 07 34 */	extsh r4, r0
/* 806ADAE8  4B 95 E9 4C */	b mDoMtx_YrotM__FPA4_fs
/* 806ADAEC  48 00 00 64 */	b lbl_806ADB50
lbl_806ADAF0:
/* 806ADAF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADAF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADAF8  7C A4 2B 78 */	mr r4, r5
/* 806ADAFC  4B 95 E9 38 */	b mDoMtx_YrotM__FPA4_fs
/* 806ADB00  48 00 00 50 */	b lbl_806ADB50
lbl_806ADB04:
/* 806ADB04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADB08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADB0C  7C 05 00 D0 */	neg r0, r5
/* 806ADB10  7C 04 07 34 */	extsh r4, r0
/* 806ADB14  4B 95 E9 20 */	b mDoMtx_YrotM__FPA4_fs
/* 806ADB18  48 00 00 38 */	b lbl_806ADB50
lbl_806ADB1C:
/* 806ADB1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADB20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADB24  A8 9C 07 34 */	lha r4, 0x734(r28)
/* 806ADB28  4B 95 E9 A4 */	b mDoMtx_ZrotM__FPA4_fs
/* 806ADB2C  48 00 00 24 */	b lbl_806ADB50
lbl_806ADB30:
/* 806ADB30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADB34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADB38  A8 9C 07 44 */	lha r4, 0x744(r28)
/* 806ADB3C  4B 95 E8 F8 */	b mDoMtx_YrotM__FPA4_fs
/* 806ADB40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADB44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADB48  A8 9C 07 42 */	lha r4, 0x742(r28)
/* 806ADB4C  4B 95 E9 80 */	b mDoMtx_ZrotM__FPA4_fs
lbl_806ADB50:
/* 806ADB50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADB54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADB58  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 806ADB5C  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806ADB60  7C 80 F2 14 */	add r4, r0, r30
/* 806ADB64  4B C9 89 4C */	b PSMTXCopy
/* 806ADB68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806ADB6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806ADB70  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 806ADB74  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 806ADB78  4B C9 89 38 */	b PSMTXCopy
...
/* 806ADB8C  4B CB 46 98 */	b _restgpr_28
