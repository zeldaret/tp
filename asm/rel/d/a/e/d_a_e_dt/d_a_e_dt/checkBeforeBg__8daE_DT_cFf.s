...
/* 806AEBFC  4B 9C 90 6D */	bl __ct__11dBgS_LinChkFv
/* 806AEC00  3C 60 80 6B */	lis r3, __vt__8cM3dGPla@ha /* 0x806B623C@ha */
/* 806AEC04  38 03 62 3C */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806B623C@l */
...
/* 806AEC24  3C 60 80 6B */	lis r3, lit_4072@ha /* 0x806B5D38@ha */
/* 806AEC28  C0 03 5D 38 */	lfs f0, lit_4072@l(r3)  /* 0x806B5D38@l */
...
/* 806AEC48  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806AEC4C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806AEC8C  4B 9C 90 D9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806AEC90  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806AEC94  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806AEC98  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 806AEC9C  7F C3 F3 78 */	mr r3, r30
/* 806AECA0  38 81 00 34 */	addi r4, r1, 0x34
/* 806AECA4  4B 9C 57 11 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 806AECBC  4B 9C 5A 89 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 806AECC0  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 806AECC4  C0 41 00 28 */	lfs f2, 0x28(r1)
/* 806AECC8  4B BB 89 AD */	bl cM_atan2s__Fff
...
lbl_806AECF0:
/* 806AECF0  3C 60 80 6B */	lis r3, __vt__8cM3dGPla@ha /* 0x806B623C@ha */
/* 806AECF4  38 03 62 3C */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806B623C@l */
/* 806AECF8  90 01 00 30 */	stw r0, 0x30(r1)
/* 806AECFC  38 61 00 34 */	addi r3, r1, 0x34
/* 806AED00  38 80 FF FF */	li r4, -1
/* 806AED04  4B 9C 8F D9 */	bl __dt__11dBgS_LinChkFv
/* 806AED08  38 60 00 01 */	li r3, 1
/* 806AED0C  48 00 00 20 */	b lbl_806AED2C
lbl_806AED10:
/* 806AED10  3C 60 80 6B */	lis r3, __vt__8cM3dGPla@ha /* 0x806B623C@ha */
/* 806AED14  38 03 62 3C */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806B623C@l */
/* 806AED18  90 01 00 30 */	stw r0, 0x30(r1)
/* 806AED1C  38 61 00 34 */	addi r3, r1, 0x34
/* 806AED20  38 80 FF FF */	li r4, -1
/* 806AED24  4B 9C 8F B9 */	bl __dt__11dBgS_LinChkFv
