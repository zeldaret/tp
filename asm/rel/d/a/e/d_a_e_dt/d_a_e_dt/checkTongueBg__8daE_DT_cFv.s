...
/* 806AEDA4  4B CB 34 35 */	bl _savegpr_28
/* 806AEDA8  7C 7F 1B 78 */	mr r31, r3
/* 806AEDAC  3C 60 80 6B */	lis r3, lit_3792@ha /* 0x806B5CD4@ha */
/* 806AEDB0  3B A3 5C D4 */	addi r29, r3, lit_3792@l /* 0x806B5CD4@l */
...
/* 806AEDDC  4B BC 1D B5 */	bl cLib_chaseAngleS__FPsss
...
/* 806AEDF8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806AEDFC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806AEE00  4B C9 76 B1 */	bl PSMTXCopy
/* 806AEE04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806AEE08  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806AEE64  4B 9C 8E 05 */	bl __ct__11dBgS_LinChkFv
...
/* 806AEE80  4B 9C 8E E5 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806AEE84  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806AEE88  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806AEE8C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806AEE90  38 81 00 20 */	addi r4, r1, 0x20
/* 806AEE94  4B 9C 55 21 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 806AEEAC  4B BC 1C E5 */	bl cLib_chaseAngleS__FPsss
...
/* 806AEED4  4B BC 1C BD */	bl cLib_chaseAngleS__FPsss
lbl_806AEED8:
/* 806AEED8  38 61 00 20 */	addi r3, r1, 0x20
/* 806AEEDC  38 80 FF FF */	li r4, -1
/* 806AEEE0  4B 9C 8D FD */	bl __dt__11dBgS_LinChkFv
lbl_806AEEE4:
/* 806AEEE4  39 61 00 A0 */	addi r11, r1, 0xa0
/* 806AEEE8  4B CB 33 3D */	bl _restgpr_28
