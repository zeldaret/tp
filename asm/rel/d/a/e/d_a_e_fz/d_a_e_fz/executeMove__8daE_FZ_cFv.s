...
/* 806BF900  3C 60 80 6C */	lis r3, lit_3803@ha /* 0x806C1938@ha */
/* 806BF904  3B C3 19 38 */	addi r30, r3, lit_3803@l /* 0x806C1938@l */
...
lbl_806BF924:
/* 806BF924  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BF928  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
/* 806BF92C  C0 23 00 34 */	lfs f1, 0x34(r3)
/* 806BF930  4B BA 80 5D */	bl cM_rndFX__Ff
/* 806BF934  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BF938  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BF988  4B BB 0C 81 */	bl cLib_addCalcAngleS2__FPssss
/* 806BF98C  38 7F 05 2C */	addi r3, r31, 0x52c
/* 806BF990  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BF994  38 84 1B B0 */	addi r4, r4, l_HIO@l /* 0x806C1BB0@l */
/* 806BF998  C0 24 00 1C */	lfs f1, 0x1c(r4)
/* 806BF99C  C0 5E 00 08 */	lfs f2, 8(r30)
/* 806BF9A0  C0 7E 00 4C */	lfs f3, 0x4c(r30)
/* 806BF9A4  4B BB 00 99 */	bl cLib_addCalc2__FPffff
/* 806BF9A8  7F E3 FB 78 */	mr r3, r31
/* 806BF9AC  C0 3E 00 68 */	lfs f1, 0x68(r30)
/* 806BF9B0  C0 5E 00 48 */	lfs f2, 0x48(r30)
/* 806BF9B4  4B 95 D5 1D */	bl fopAcM_wayBgCheck__FPC10fopAc_ac_cff
...
/* 806BFA14  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BFA18  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806BFA1C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806BFA20  4B 95 AD C1 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806BFA24  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BFA28  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
