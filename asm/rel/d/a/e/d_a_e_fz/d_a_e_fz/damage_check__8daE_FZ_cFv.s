...
/* 806BED44  4B CA 34 95 */	bl _savegpr_28
...
/* 806BED58  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BED5C  3B E4 1B B0 */	addi r31, r4, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BED8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BED90  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806BEDB4  4B 9C 4A 7D */	bl Move__10dCcD_GSttsFv
...
/* 806BEE38  4B 9C 56 C1 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 806BEE50  4B 95 B8 C1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806BEE54  3C 63 00 01 */	addis r3, r3, 1
/* 806BEE58  38 03 80 00 */	addi r0, r3, -32768
/* 806BEE5C  B0 1D 04 DE */	sth r0, 0x4de(r29)
/* 806BEE60  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BEE64  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BEEA0  4B BA 7C 95 */	bl __mi__4cXyzCFRC3Vec
...
/* 806BEEE0  4B BA 82 49 */	bl atan2sX_Z__4cXyzCFv
...
/* 806BEEF4  4B 9C 56 05 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 806BEF08  4B 9C 55 F1 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 806BEF20  4B 95 B7 F1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806BEF24  3C 63 00 01 */	addis r3, r3, 1
/* 806BEF28  38 03 80 00 */	addi r0, r3, -32768
/* 806BEF2C  B0 1D 04 DE */	sth r0, 0x4de(r29)
/* 806BEF30  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BEF34  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BEF4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BEF50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806BEF70  4B 98 D2 A9 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 806BEF98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BEF9C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806BEFE0  3D 60 80 6C */	lis r11, lit_3805@ha /* 0x806C1940@ha */
/* 806BEFE4  C0 2B 19 40 */	lfs f1, lit_3805@l(r11)  /* 0x806C1940@l */
/* 806BEFE8  4B 98 DA A9 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806BEFEC  38 7D 09 80 */	addi r3, r29, 0x980
/* 806BEFF0  4B 9C 55 09 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 806BF020  4B 95 B6 F1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806BF024  3C 63 00 01 */	addis r3, r3, 1
/* 806BF028  38 03 80 00 */	addi r0, r3, -32768
/* 806BF02C  B0 1D 04 DE */	sth r0, 0x4de(r29)
/* 806BF030  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BF034  3B C3 1B B0 */	addi r30, r3, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BF0A8  4B 98 D1 71 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 806BF0D8  4B 98 D1 41 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
/* 806BF0DC  48 00 03 50 */	b lbl_806BF42C
lbl_806BF0E0:
/* 806BF0E0  38 7D 09 80 */	addi r3, r29, 0x980
/* 806BF0E4  4B 9C 54 15 */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 806BF130  4B 98 D0 E9 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
/* 806BF134  48 00 02 F8 */	b lbl_806BF42C
lbl_806BF138:
/* 806BF138  7F A3 EB 78 */	mr r3, r29
/* 806BF13C  38 9D 0B F0 */	addi r4, r29, 0xbf0
/* 806BF140  4B 9C 8A C5 */	bl cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 806BF16C  4B 98 D0 AD */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 806BF190  4B 98 D0 89 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
lbl_806BF194:
...
/* 806BF1F0  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BF1F4  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BF238  4B 9C 54 21 */	bl ChkCoHit__12dCcD_GObjInfFv
...
/* 806BF24C  4B 9C 44 3D */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 806BF250  7C 7F 1B 78 */	mr r31, r3
/* 806BF254  4B 95 9A 8D */	bl fopAc_IsActor__FPv
...
/* 806BF270  4B 9C 44 19 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 806BF284  4B BA 78 B1 */	bl __mi__4cXyzCFRC3Vec
...
/* 806BF2B8  3C 60 80 6C */	lis r3, lit_4109@ha /* 0x806C1994@ha */
/* 806BF2BC  C0 23 19 94 */	lfs f1, lit_4109@l(r3)  /* 0x806C1994@l */
/* 806BF2C0  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BF2C4  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BF2F0  4B BA 78 45 */	bl __mi__4cXyzCFRC3Vec
...
/* 806BF310  4B BA 7E 19 */	bl atan2sX_Z__4cXyzCFv
...
/* 806BF364  4B 9C 4F 5D */	bl ChkAtHit__12dCcD_GObjInfFv
...
/* 806BF378  4B 9C 43 11 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 806BF37C  7C 7F 1B 78 */	mr r31, r3
/* 806BF380  7F A3 EB 78 */	mr r3, r29
/* 806BF384  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 806BF388  4B 95 B3 89 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806BF3C4  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BF3C8  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BF430  4B CA 2D F5 */	bl _restgpr_28
