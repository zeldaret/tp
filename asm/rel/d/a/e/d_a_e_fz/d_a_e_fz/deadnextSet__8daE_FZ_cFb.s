...
/* 806BEC38  3C 60 80 6C */	lis r3, lit_3804@ha /* 0x806C193C@ha */
/* 806BEC3C  C0 23 19 3C */	lfs f1, lit_3804@l(r3)  /* 0x806C193C@l */
/* 806BEC40  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 806BEC44  3C 60 80 6C */	lis r3, lit_3805@ha /* 0x806C1940@ha */
/* 806BEC48  C0 03 19 40 */	lfs f0, lit_3805@l(r3)  /* 0x806C1940@l */
/* 806BEC4C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 806BEC50  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 806BEC54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BEC58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806BEC6C  4B 9B 0D B9 */	bl StartShock__12dVibration_cFii4cXyz
lbl_806BEC70:
...
/* 806BED00  3C 60 80 6C */	lis r3, lit_3804@ha /* 0x806C193C@ha */
/* 806BED04  C0 03 19 3C */	lfs f0, lit_3804@l(r3)  /* 0x806C193C@l */
