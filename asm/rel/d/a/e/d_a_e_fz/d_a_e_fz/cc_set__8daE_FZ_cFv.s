...
/* 806C0770  4B CA 1A 6D */	bl _savegpr_29
/* 806C0774  7C 7E 1B 78 */	mr r30, r3
/* 806C0778  3C 60 80 6C */	lis r3, lit_3803@ha /* 0x806C1938@ha */
/* 806C077C  3B E3 19 38 */	addi r31, r3, lit_3803@l /* 0x806C1938@l */
...
/* 806C0794  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806C0798  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806C079C  38 81 00 14 */	addi r4, r1, 0x14
/* 806C07A0  38 BE 05 38 */	addi r5, r30, 0x538
/* 806C07A4  4B C8 65 C9 */	bl PSMTXMultVec
...
/* 806C07D8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806C07DC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806C07E0  4B C8 5C D1 */	bl PSMTXCopy
...
/* 806C07F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806C07FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806C0800  38 81 00 14 */	addi r4, r1, 0x14
/* 806C0804  38 A1 00 08 */	addi r5, r1, 8
/* 806C0808  4B C8 65 65 */	bl PSMTXMultVec
/* 806C080C  38 7E 0A A4 */	addi r3, r30, 0xaa4
/* 806C0810  38 81 00 08 */	addi r4, r1, 8
/* 806C0814  4B BA EE 35 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 806C0828  4B BA EE E1 */	bl SetR__8cM3dGSphFf
/* 806C082C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C0830  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C0834  3B A3 23 3C */	addi r29, r3, 0x233c
/* 806C0838  7F A3 EB 78 */	mr r3, r29
/* 806C083C  38 9E 09 80 */	addi r4, r30, 0x980
/* 806C0840  4B BA 43 69 */	bl Set__4cCcSFP8cCcD_Obj
/* 806C0844  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 806C0848  38 63 00 24 */	addi r3, r3, 0x24
/* 806C084C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806C0850  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806C0854  4B C8 5C 5D */	bl PSMTXCopy
...
/* 806C086C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806C0870  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806C0874  38 81 00 14 */	addi r4, r1, 0x14
/* 806C0878  38 A1 00 08 */	addi r5, r1, 8
/* 806C087C  4B C8 64 F1 */	bl PSMTXMultVec
/* 806C0880  38 7E 0B DC */	addi r3, r30, 0xbdc
/* 806C0884  38 81 00 08 */	addi r4, r1, 8
/* 806C0888  4B BA ED C1 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 806C089C  4B BA EE 6D */	bl SetR__8cM3dGSphFf
/* 806C08A0  7F A3 EB 78 */	mr r3, r29
/* 806C08A4  38 9E 0A B8 */	addi r4, r30, 0xab8
/* 806C08A8  4B BA 43 01 */	bl Set__4cCcSFP8cCcD_Obj
/* 806C08AC  39 61 00 30 */	addi r11, r1, 0x30
/* 806C08B0  4B CA 19 79 */	bl _restgpr_29
