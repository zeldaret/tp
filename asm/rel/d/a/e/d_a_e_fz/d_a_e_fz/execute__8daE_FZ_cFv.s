...
/* 806C08D4  4B CA 18 F1 */	bl _savegpr_23
/* 806C08D8  7C 7A 1B 78 */	mr r26, r3
/* 806C08DC  3C 60 80 6C */	lis r3, lit_3803@ha /* 0x806C1938@ha */
/* 806C08E0  3B A3 19 38 */	addi r29, r3, lit_3803@l /* 0x806C1938@l */
...
/* 806C08F8  4B 9D 75 E9 */	bl checkItemGet__FUci
...
/* 806C0990  4B 96 C6 DD */	bl dComIfGp_getReverb__Fi
...
/* 806C09BC  4B BA 61 79 */	bl __mi__4cXyzCFRC3Vec
...
/* 806C09E4  4B C8 66 F5 */	bl PSVECScale
/* 806C09E8  3B 60 00 00 */	li r27, 0
/* 806C09EC  3B 20 00 00 */	li r25, 0
/* 806C09F0  3B 00 00 00 */	li r24, 0
/* 806C09F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C09F8  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C09FC  3B 9A 06 64 */	addi r28, r26, 0x664
/* 806C0A00  3C 60 80 6C */	lis r3, ice_name@ha /* 0x806C1AD4@ha */
/* 806C0A04  3B E3 1A D4 */	addi r31, r3, ice_name@l /* 0x806C1AD4@l */
lbl_806C0A08:
...
/* 806C0A54  4B 98 CA 79 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806C0A68  4B 98 AE B1 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806C0A7C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806C0A80  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806C0A84  4B C8 5A 2D */	bl PSMTXCopy
/* 806C0A88  C0 3D 00 04 */	lfs f1, 4(r29)
/* 806C0A8C  C0 5D 00 50 */	lfs f2, 0x50(r29)
/* 806C0A90  FC 60 08 90 */	fmr f3, f1
/* 806C0A94  4B 94 C3 09 */	bl transM__14mDoMtx_stack_cFfff
/* 806C0A98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806C0A9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806C0AA0  38 97 00 68 */	addi r4, r23, 0x68
/* 806C0AA4  38 B7 00 98 */	addi r5, r23, 0x98
/* 806C0AA8  38 D7 00 A4 */	addi r6, r23, 0xa4
/* 806C0AAC  4B BB FD 5D */	bl func_80280808
...
/* 806C0AC0  3C 60 80 45 */	lis r3, mParticleTracePCB__13dPa_control_c@ha /* 0x80450EC8@ha */
/* 806C0AC4  38 03 0E C8 */	addi r0, r3, mParticleTracePCB__13dPa_control_c@l /* 0x80450EC8@l */
...
/* 806C0AEC  4B CA 17 25 */	bl _restgpr_23
