...
/* 806BE9E4  4B CA 37 F8 */	b _savegpr_29
/* 806BE9E8  7C 7D 1B 78 */	mr r29, r3
/* 806BE9EC  3C 60 80 6C */	lis r3, lit_3803@ha
/* 806BE9F0  3B E3 19 38 */	addi r31, r3, lit_3803@l
...
/* 806BEA08  4B 9D 94 D8 */	b checkItemGet__FUci
...
/* 806BEA20  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806BEA24  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806BEA28  38 80 00 00 */	li r4, 0
/* 806BEA2C  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 806BEA30  38 DD 01 0C */	addi r6, r29, 0x10c
/* 806BEA34  4B AE 4D 90 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806BEA38  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806BEA3C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806BEA40  80 9D 05 B4 */	lwz r4, 0x5b4(r29)
/* 806BEA44  80 84 00 04 */	lwz r4, 4(r4)
/* 806BEA48  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806BEA4C  4B AE 63 54 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806BEA50  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806BEA54  4B 94 F2 70 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 806BEA58  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806BEA5C  4B 97 2E F0 */	b entry__10daMirror_cFP8J3DModel
...
/* 806BEAAC  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 806BEAB0  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 806BEAB4  4B 96 FE 5C */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806BEAB8  90 7D 07 0C */	stw r3, 0x70c(r29)
/* 806BEABC  38 60 00 01 */	li r3, 1
lbl_806BEAC0:
/* 806BEAC0  39 61 00 30 */	addi r11, r1, 0x30
/* 806BEAC4  4B CA 37 64 */	b _restgpr_29
