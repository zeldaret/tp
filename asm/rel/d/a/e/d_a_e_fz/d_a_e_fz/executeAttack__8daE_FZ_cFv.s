...
/* 806BFA7C  3C 80 80 6C */	lis r4, lit_3803@ha /* 0x806C1938@ha */
/* 806BFA80  3B E4 19 38 */	addi r31, r4, lit_3803@l /* 0x806C1938@l */
...
lbl_806BFA94:
/* 806BFA94  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BFA98  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806BFA9C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806BFAA0  4B 95 AC 71 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806BFAB4  4B BB 0B 55 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806BFACC  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BFAD0  38 84 1B B0 */	addi r4, r4, l_HIO@l /* 0x806C1BB0@l */
/* 806BFAD4  C0 24 00 20 */	lfs f1, 0x20(r4)
/* 806BFAD8  C0 5F 00 80 */	lfs f2, 0x80(r31)
/* 806BFADC  C0 7F 00 08 */	lfs f3, 8(r31)
/* 806BFAE0  4B BA FF 5D */	bl cLib_addCalc2__FPffff
...
/* 806BFAFC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BFB00  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806BFB04  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 806BFB08  4B 95 AC D9 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806BFB0C  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C1BB0@ha */
/* 806BFB10  38 63 1B B0 */	addi r3, r3, l_HIO@l /* 0x806C1BB0@l */
...
/* 806BFB2C  4B 95 D2 D1 */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
