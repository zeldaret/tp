...
/* 807CDF28  4B 8B 5B 01 */	bl __ct__12dCcD_GObjInfFv
/* 807CDF2C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 807CDF30  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 807CDF34  90 1F 01 20 */	stw r0, 0x120(r31)
/* 807CDF38  3C 60 80 7D */	lis r3, __vt__8cM3dGAab@ha /* 0x807CF454@ha */
/* 807CDF3C  38 03 F4 54 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x807CF454@l */
/* 807CDF40  90 1F 01 1C */	stw r0, 0x11c(r31)
/* 807CDF44  3C 60 80 7D */	lis r3, __vt__8cM3dGCyl@ha /* 0x807CF448@ha */
/* 807CDF48  38 03 F4 48 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x807CF448@l */
/* 807CDF4C  90 1F 01 38 */	stw r0, 0x138(r31)
/* 807CDF50  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 807CDF54  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 807CDF58  90 7F 01 20 */	stw r3, 0x120(r31)
/* 807CDF5C  38 03 00 58 */	addi r0, r3, 0x58
/* 807CDF60  90 1F 01 38 */	stw r0, 0x138(r31)
/* 807CDF64  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 807CDF68  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
