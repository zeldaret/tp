...
/* 807C5EBC  4B B9 C3 11 */	bl _savegpr_25
/* 807C5EC0  7C 7A 1B 78 */	mr r26, r3
/* 807C5EC4  7C 9B 23 78 */	mr r27, r4
/* 807C5EC8  7C BC 2B 78 */	mr r28, r5
/* 807C5ECC  3C 60 80 7D */	lis r3, cNullVec__6Z2Calc@ha /* 0x807CEF08@ha */
/* 807C5ED0  3B E3 EF 08 */	addi r31, r3, cNullVec__6Z2Calc@l /* 0x807CEF08@l */
...
lbl_807C5F3C:
/* 807C5F3C  3C 60 80 7D */	lis r3, lit_5913@ha /* 0x807CED8C@ha */
/* 807C5F40  C0 23 ED 8C */	lfs f1, lit_5913@l(r3)  /* 0x807CED8C@l */
/* 807C5F44  4B AA 1A 11 */	bl cM_rndF__Ff
...
/* 807C5F70  3C 60 80 7D */	lis r3, lit_5913@ha /* 0x807CED8C@ha */
/* 807C5F74  C0 23 ED 8C */	lfs f1, lit_5913@l(r3)  /* 0x807CED8C@l */
/* 807C5F78  4B AA 19 DD */	bl cM_rndF__Ff
...
/* 807C5FA0  3C 60 80 7D */	lis r3, lit_5913@ha /* 0x807CED8C@ha */
/* 807C5FA4  C0 23 ED 8C */	lfs f1, lit_5913@l(r3)  /* 0x807CED8C@l */
/* 807C5FA8  4B AA 19 AD */	bl cM_rndF__Ff
/* 807C5FAC  3C 60 80 7D */	lis r3, lit_5914@ha /* 0x807CED90@ha */
/* 807C5FB0  C0 03 ED 90 */	lfs f0, lit_5914@l(r3)  /* 0x807CED90@l */
...
/* 807C5FD4  3C 60 80 7D */	lis r3, lit_5913@ha /* 0x807CED8C@ha */
/* 807C5FD8  C0 23 ED 8C */	lfs f1, lit_5913@l(r3)  /* 0x807CED8C@l */
/* 807C5FDC  4B AA 19 79 */	bl cM_rndF__Ff
/* 807C5FE0  3C 60 80 7D */	lis r3, lit_5914@ha /* 0x807CED90@ha */
/* 807C5FE4  C0 03 ED 90 */	lfs f0, lit_5914@l(r3)  /* 0x807CED90@l */
...
/* 807C60C0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 807C60C4  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 807C60C8  7C 44 04 2E */	lfsx f2, r4, r0
/* 807C60CC  A8 05 08 40 */	lha r0, 0x840(r5)
/* 807C60D0  3C 60 80 7D */	lis r3, lit_5843@ha /* 0x807CED80@ha */
/* 807C60D4  C8 23 ED 80 */	lfd f1, lit_5843@l(r3)  /* 0x807CED80@l */
...
/* 807C6150  4B B9 C0 C9 */	bl _restgpr_25
