...
/* 807C534C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 807C5350  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 807C5354  80 63 00 00 */	lwz r3, 0(r3)
/* 807C5358  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 807C535C  38 80 00 1E */	li r4, 0x1e
/* 807C5360  4B AE AB 7D */	bl bgmStreamStop__8Z2SeqMgrFUl
/* 807C5364  38 00 00 01 */	li r0, 1
/* 807C5368  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 807C536C  98 03 0C 98 */	stb r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
/* 807C5370  38 60 00 01 */	li r3, 1
/* 807C5374  3C 80 80 7D */	lis r4, lit_3908@ha /* 0x807CECAC@ha */
/* 807C5378  C0 24 EC AC */	lfs f1, lit_3908@l(r4)  /* 0x807CECAC@l */
...
/* 807C5390  4B 86 1D E1 */	bl dStage_changeScene__FifUlScsi
