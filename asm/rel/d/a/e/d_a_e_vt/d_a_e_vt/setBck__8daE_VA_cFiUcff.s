...
/* 807C384C  3C 60 80 7D */	lis r3, d_a_e_vt__stringBase0@ha /* 0x807CEEFC@ha */
/* 807C3850  38 63 EE FC */	addi r3, r3, d_a_e_vt__stringBase0@l /* 0x807CEEFC@l */
/* 807C3854  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C3858  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807C385C  3C A5 00 02 */	addis r5, r5, 2
/* 807C3860  38 C0 00 80 */	li r6, 0x80
/* 807C3864  38 A5 C2 F8 */	addi r5, r5, -15624
/* 807C3868  4B 87 8A 85 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807C3880  3C C0 80 7D */	lis r6, lit_3908@ha /* 0x807CECAC@ha */
/* 807C3884  C0 66 EC AC */	lfs f3, lit_3908@l(r6)  /* 0x807CECAC@l */
/* 807C3888  3C C0 80 7D */	lis r6, lit_4473@ha /* 0x807CED40@ha */
/* 807C388C  C0 86 ED 40 */	lfs f4, lit_4473@l(r6)  /* 0x807CED40@l */
/* 807C3890  4B 84 D5 E1 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
