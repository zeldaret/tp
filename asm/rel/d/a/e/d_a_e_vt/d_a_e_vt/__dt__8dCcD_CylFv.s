...
/* 807C4708  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 807C470C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 807C472C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 807C4730  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 807C4748  3C 60 80 7D */	lis r3, __vt__8cM3dGCyl@ha /* 0x807CF448@ha */
/* 807C474C  38 03 F4 48 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x807CF448@l */
/* 807C4750  90 1E 01 38 */	stw r0, 0x138(r30)
lbl_807C4754:
/* 807C4754  34 1E 01 04 */	addic. r0, r30, 0x104
/* 807C4758  41 82 00 24 */	beq lbl_807C477C
/* 807C475C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 807C4760  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 807C4764  90 1E 01 20 */	stw r0, 0x120(r30)
/* 807C4768  34 1E 01 04 */	addic. r0, r30, 0x104
/* 807C476C  41 82 00 10 */	beq lbl_807C477C
/* 807C4770  3C 60 80 7D */	lis r3, __vt__8cM3dGAab@ha /* 0x807CF454@ha */
/* 807C4774  38 03 F4 54 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x807CF454@l */
/* 807C4778  90 1E 01 1C */	stw r0, 0x11c(r30)
lbl_807C477C:
/* 807C477C  7F C3 F3 78 */	mr r3, r30
/* 807C4780  38 80 00 00 */	li r4, 0
/* 807C4784  4B 8B F9 61 */	bl __dt__12dCcD_GObjInfFv
/* 807C4788  7F E0 07 35 */	extsh. r0, r31
/* 807C478C  40 81 00 0C */	ble lbl_807C4798
/* 807C4790  7F C3 F3 78 */	mr r3, r30
/* 807C4794  4B B0 A5 A9 */	bl __dl__FPv
lbl_807C4798:
