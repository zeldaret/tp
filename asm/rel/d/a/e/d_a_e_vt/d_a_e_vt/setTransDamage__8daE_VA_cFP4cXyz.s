...
/* 807C3AC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C3ACC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807C3AF8  4B 88 87 21 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
/* 807C3AFC  3C 60 80 7D */	lis r3, lit_3908@ha /* 0x807CECAC@ha */
/* 807C3B00  C0 23 EC AC */	lfs f1, lit_3908@l(r3)  /* 0x807CECAC@l */
/* 807C3B04  D0 21 00 08 */	stfs f1, 8(r1)
/* 807C3B08  3C 60 80 7D */	lis r3, lit_3909@ha /* 0x807CECB0@ha */
/* 807C3B0C  C0 03 EC B0 */	lfs f0, lit_3909@l(r3)  /* 0x807CECB0@l */
/* 807C3B10  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 807C3B14  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 807C3B18  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C3B1C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807C3B30  4B 8A BE F5 */	bl StartShock__12dVibration_cFii4cXyz
