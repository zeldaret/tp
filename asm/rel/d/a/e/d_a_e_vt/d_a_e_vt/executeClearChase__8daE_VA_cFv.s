...
/* 807C7650  4B B9 AB 89 */	bl _savegpr_28
/* 807C7654  7C 7C 1B 78 */	mr r28, r3
/* 807C7658  3C 60 80 7D */	lis r3, lit_3907@ha /* 0x807CECA8@ha */
/* 807C765C  3B A3 EC A8 */	addi r29, r3, lit_3907@l /* 0x807CECA8@l */
...
/* 807C7674  4B AA 83 09 */	bl cLib_addCalc__FPfffff
...
/* 807C76B8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C76BC  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807C76C0  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 807C76C4  4B 85 30 4D */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807C76DC  4B AA 8E 65 */	bl cLib_addCalcAngleS__FPsssss
...
/* 807C76F0  4B 85 30 F1 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 807C76F4  3C 60 80 7D */	lis r3, l_HIO@ha /* 0x807CF4C4@ha */
/* 807C76F8  3B E3 F4 C4 */	addi r31, r3, l_HIO@l /* 0x807CF4C4@l */
...
/* 807C7714  4B AA 90 2D */	bl cLib_chaseF__FPfff
/* 807C7718  48 00 00 78 */	b lbl_807C7790
lbl_807C771C:
/* 807C771C  7F 83 E3 78 */	mr r3, r28
/* 807C7720  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 807C7724  4B 85 30 BD */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807C7748  4B AA 8F F9 */	bl cLib_chaseF__FPfff
...
/* 807C775C  4B AA 8F E5 */	bl cLib_chaseF__FPfff
...
lbl_807C77FC:
/* 807C77FC  4B 99 7C 29 */	bl checkNowWolfEyeUp__9daPy_py_cFv
...
/* 807C7828  4B B9 A9 FD */	bl _restgpr_28
