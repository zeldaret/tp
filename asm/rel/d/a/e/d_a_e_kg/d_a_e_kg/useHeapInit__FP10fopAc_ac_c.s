...
/* 806F9828  4B C6 89 B1 */	bl _savegpr_28
/* 806F982C  7C 7F 1B 78 */	mr r31, r3
/* 806F9830  38 60 00 58 */	li r3, 0x58
/* 806F9834  4B BD 54 19 */	bl __nw__FUl
/* 806F9838  7C 7E 1B 79 */	or. r30, r3, r3
/* 806F983C  41 82 00 94 */	beq lbl_806F98D0
/* 806F9840  3C 60 80 70 */	lis r3, d_a_e_kg__stringBase0@ha /* 0x806FA46C@ha */
/* 806F9844  38 63 A4 6C */	addi r3, r3, d_a_e_kg__stringBase0@l /* 0x806FA46C@l */
/* 806F9848  38 80 00 0E */	li r4, 0xe
/* 806F984C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F9850  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806F9864  4B 94 2A 89 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806F9868  7C 7D 1B 78 */	mr r29, r3
/* 806F986C  3C 60 80 70 */	lis r3, d_a_e_kg__stringBase0@ha /* 0x806FA46C@ha */
/* 806F9870  38 63 A4 6C */	addi r3, r3, d_a_e_kg__stringBase0@l /* 0x806FA46C@l */
/* 806F9874  38 80 00 12 */	li r4, 0x12
/* 806F9878  7F 85 E3 78 */	mr r5, r28
/* 806F987C  38 C0 00 80 */	li r6, 0x80
/* 806F9880  4B 94 2A 6D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806F98B8  3D 20 80 70 */	lis r9, lit_3790@ha /* 0x806FA3AC@ha */
/* 806F98BC  C0 29 A3 AC */	lfs f1, lit_3790@l(r9)  /* 0x806FA3AC@l */
/* 806F98C0  39 20 00 00 */	li r9, 0
/* 806F98C4  39 40 FF FF */	li r10, -1
/* 806F98C8  4B 91 6F 09 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806F98F8  4B BD 53 55 */	bl __nw__FUl
/* 806F98FC  7C 7E 1B 79 */	or. r30, r3, r3
/* 806F9900  41 82 00 20 */	beq lbl_806F9920
/* 806F9904  3C 80 80 70 */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x806FA5C8@ha */
/* 806F9908  38 04 A5 C8 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x806FA5C8@l */
/* 806F990C  90 1E 00 00 */	stw r0, 0(r30)
/* 806F9910  38 80 00 00 */	li r4, 0
/* 806F9914  4B C2 EA E9 */	bl init__12J3DFrameCtrlFs
...
lbl_806F9938:
/* 806F9938  3C 60 80 70 */	lis r3, d_a_e_kg__stringBase0@ha /* 0x806FA46C@ha */
/* 806F993C  38 63 A4 6C */	addi r3, r3, d_a_e_kg__stringBase0@l /* 0x806FA46C@l */
/* 806F9940  38 80 00 15 */	li r4, 0x15
/* 806F9944  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F9948  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806F994C  3C A5 00 02 */	addis r5, r5, 2
/* 806F9950  38 C0 00 80 */	li r6, 0x80
/* 806F9954  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806F9958  4B 94 29 95 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806F997C  3D 00 80 70 */	lis r8, lit_3790@ha /* 0x806FA3AC@ha */
/* 806F9980  C0 28 A3 AC */	lfs f1, lit_3790@l(r8)  /* 0x806FA3AC@l */
/* 806F9984  39 00 00 00 */	li r8, 0
/* 806F9988  39 20 FF FF */	li r9, -1
/* 806F998C  4B 91 3B C1 */	bl init__13mDoExt_btpAnmFP16J3DMaterialTableP16J3DAnmTexPatterniifss
...
/* 806F99A4  4B C6 88 81 */	bl _restgpr_28
