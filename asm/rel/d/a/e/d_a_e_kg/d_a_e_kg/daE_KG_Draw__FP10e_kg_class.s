...
/* 806F7FE0  4B C6 A1 FC */	b _savegpr_29
/* 806F7FE4  7C 7D 1B 78 */	mr r29, r3
/* 806F7FE8  3C 60 80 70 */	lis r3, lit_3788@ha
/* 806F7FEC  3B E3 A3 A4 */	addi r31, r3, lit_3788@l
/* 806F7FF0  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806F7FF4  83 C3 00 04 */	lwz r30, 4(r3)
/* 806F7FF8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806F7FFC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806F8000  38 80 00 00 */	li r4, 0
/* 806F8004  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 806F8008  38 DD 01 0C */	addi r6, r29, 0x10c
/* 806F800C  4B AA B7 B8 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806F8010  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806F8014  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806F8018  80 9E 00 04 */	lwz r4, 4(r30)
/* 806F801C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806F8020  4B AA CD 80 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806F8040  4B 91 55 A8 */	b entry__13mDoExt_btpAnmFP16J3DMaterialTables
/* 806F8044  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806F8048  4B 91 91 78 */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 806F80A4  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 806F80A8  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 806F80AC  4B 93 68 64 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806F80B0  90 7D 06 A0 */	stw r3, 0x6a0(r29)
lbl_806F80B4:
/* 806F80B4  38 60 00 01 */	li r3, 1
/* 806F80B8  39 61 00 30 */	addi r11, r1, 0x30
/* 806F80BC  4B C6 A1 6C */	b _restgpr_29
