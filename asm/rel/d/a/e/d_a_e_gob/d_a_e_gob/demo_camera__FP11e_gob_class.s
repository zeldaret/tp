...
/* 806DC5E4  4B C8 5B ED */	bl _savegpr_26
/* 806DC5E8  7C 7F 1B 78 */	mr r31, r3
/* 806DC5EC  3C 80 80 6E */	lis r4, lit_3763@ha /* 0x806DEE38@ha */
/* 806DC5F0  3B C4 EE 38 */	addi r30, r4, lit_3763@l /* 0x806DEE38@l */
/* 806DC5F4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DC5F8  3B 84 61 C0 */	addi r28, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DC6B4  4B 93 F2 55 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 806DC6CC  4B A8 4E 05 */	bl Stop__9dCamera_cFv
...
/* 806DC6F0  4B A8 69 1D */	bl SetTrimSize__9dCamera_cFl
...
/* 806DC72C  4B A8 68 E1 */	bl SetTrimSize__9dCamera_cFl
...
/* 806DC740  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DC744  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806DC758  4B BD 2D 45 */	bl subBgmStart__8Z2SeqMgrFUl
/* 806DC75C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DC760  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806DC764  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 806DC768  7F E4 FB 78 */	mr r4, r31
/* 806DC76C  3C A0 80 04 */	lis r5, dEv_noFinishSkipProc__FPvi@ha /* 0x800428DC@ha */
/* 806DC770  38 A5 28 DC */	addi r5, r5, dEv_noFinishSkipProc__FPvi@l /* 0x800428DC@l */
/* 806DC774  38 C0 00 00 */	li r6, 0
/* 806DC778  4B 96 61 9D */	bl setSkipProc__14dEvt_control_cFPvPFPvi_ii
lbl_806DC77C:
...
/* 806DC8B4  4B B9 31 89 */	bl cLib_addCalc2__FPffff
...
/* 806DC8F0  4B B6 D6 A1 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
lbl_806DC8F4:
...
/* 806DC904  4B B6 D9 D5 */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 806DC990  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DC994  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806DC9A8  4B BD 2A F5 */	bl subBgmStart__8Z2SeqMgrFUl
...
/* 806DCA28  3C 60 80 6E */	lis r3, ms@ha /* 0x806DF2F4@ha */
/* 806DCA2C  38 A3 F2 F4 */	addi r5, r3, ms@l /* 0x806DF2F4@l */
...
/* 806DCAB0  3C 60 80 6E */	lis r3, ms@ha /* 0x806DF2F4@ha */
/* 806DCAB4  38 C3 F2 F4 */	addi r6, r3, ms@l /* 0x806DF2F4@l */
...
/* 806DCAD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DCADC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DCB2C  4B 96 FF 65 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806DCB30  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806DCB34  7C 03 07 74 */	extsb r3, r0
/* 806DCB38  4B 95 05 35 */	bl dComIfGp_getReverb__Fi
...
/* 806DCB4C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DCB50  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806DCB54  80 63 00 00 */	lwz r3, 0(r3)
/* 806DCB58  38 81 00 28 */	addi r4, r1, 0x28
/* 806DCB5C  3C A0 80 6E */	lis r5, ms@ha /* 0x806DF2F4@ha */
/* 806DCB60  80 05 F2 F4 */	lwz r0, ms@l(r5)  /* 0x806DF2F4@l */
...
/* 806DCB84  4B BC EE 01 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_806DCB88:
...
/* 806DCC08  4B 99 2E 1D */	bl StartShock__12dVibration_cFii4cXyz
...
/* 806DCD08  3C 60 80 6E */	lis r3, ms@ha /* 0x806DF2F4@ha */
/* 806DCD0C  38 83 F2 F4 */	addi r4, r3, ms@l /* 0x806DF2F4@l */
...
/* 806DCD3C  4B B9 2D 01 */	bl cLib_addCalc2__FPffff
...
/* 806DCD64  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DCD68  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806DCD7C  4B BD 27 21 */	bl subBgmStart__8Z2SeqMgrFUl
...
/* 806DCDC0  4B 93 EB 49 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 806DCDD8  4B A8 46 F9 */	bl Stop__9dCamera_cFv
...
/* 806DCDFC  4B A8 62 11 */	bl SetTrimSize__9dCamera_cFl
...
/* 806DCE60  4B A8 61 AD */	bl SetTrimSize__9dCamera_cFl
...
/* 806DCF28  4B B9 2B 15 */	bl cLib_addCalc2__FPffff
...
/* 806DCF3C  4B B9 2B 01 */	bl cLib_addCalc2__FPffff
...
/* 806DCF50  4B B9 2A ED */	bl cLib_addCalc2__FPffff
...
/* 806DCF6C  4B B9 2A D1 */	bl cLib_addCalc2__FPffff
...
/* 806DCF90  4B B9 2A AD */	bl cLib_addCalc2__FPffff
...
/* 806DCFA8  4B B9 2A 95 */	bl cLib_addCalc2__FPffff
...
/* 806DCFE0  4B 95 00 8D */	bl dComIfGp_getReverb__Fi
...
/* 806DCFF4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DCFF8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806DD020  4B BC E9 65 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806DD038  4B B9 2A 05 */	bl cLib_addCalc2__FPffff
...
/* 806DD054  4B B9 29 E9 */	bl cLib_addCalc2__FPffff
...
/* 806DD068  4B B9 29 D5 */	bl cLib_addCalc2__FPffff
lbl_806DD06C:
...
/* 806DD088  4B 94 FF E5 */	bl dComIfGp_getReverb__Fi
...
/* 806DD09C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DD0A0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806DD0C8  4B BC E8 BD */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_806DD0CC:
...
/* 806DD19C  4B B6 CD F5 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 806DD1A0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DD1A4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806DD204  4B B6 D3 35 */	bl getMsgNo__10dMsgFlow_cFv
/* 806DD208  28 03 17 77 */	cmplwi r3, 0x1777
/* 806DD20C  41 82 00 18 */	beq lbl_806DD224
/* 806DD210  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 806DD214  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
...
/* 806DD248  4B B6 D0 91 */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 806DD274  4B B9 27 C9 */	bl cLib_addCalc2__FPffff
...
/* 806DD288  4B B9 27 B5 */	bl cLib_addCalc2__FPffff
...
/* 806DD29C  4B B9 27 A1 */	bl cLib_addCalc2__FPffff
...
/* 806DD2BC  3C 60 80 45 */	lis r3, g_blackColor@ha /* 0x80450604@ha */
/* 806DD2C0  38 63 06 04 */	addi r3, r3, g_blackColor@l /* 0x80450604@l */
/* 806DD2C4  4B 92 AD 15 */	bl fadeOut__13mDoGph_gInf_cFfR8_GXColor
lbl_806DD2C8:
...
/* 806DD2F4  3C 60 80 6E */	lis r3, ms@ha /* 0x806DF2F4@ha */
/* 806DD2F8  38 A3 F2 F4 */	addi r5, r3, ms@l /* 0x806DF2F4@l */
/* 806DD2FC  80 65 00 00 */	lwz r3, 0(r5)
/* 806DD300  B0 03 05 82 */	sth r0, 0x582(r3)
/* 806DD304  38 00 00 01 */	li r0, 1
/* 806DD308  3C 60 80 6E */	lis r3, my@ha /* 0x806DF2F8@ha */
/* 806DD30C  38 83 F2 F8 */	addi r4, r3, my@l /* 0x806DF2F8@l */
...
/* 806DD3A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DD3A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DD3BC  4B 99 27 55 */	bl StartQuake__12dVibration_cFii4cXyz
lbl_806DD3C0:
...
/* 806DD408  3C 60 80 45 */	lis r3, g_blackColor@ha /* 0x80450604@ha */
/* 806DD40C  38 63 06 04 */	addi r3, r3, g_blackColor@l /* 0x80450604@l */
/* 806DD410  4B 92 AB C9 */	bl fadeOut__13mDoGph_gInf_cFfR8_GXColor
lbl_806DD414:
/* 806DD414  3C 60 80 6E */	lis r3, ms@ha /* 0x806DF2F4@ha */
/* 806DD418  38 63 F2 F4 */	addi r3, r3, ms@l /* 0x806DF2F4@l */
...
/* 806DD430  4B B9 26 0D */	bl cLib_addCalc2__FPffff
/* 806DD434  3C 60 80 6E */	lis r3, ms@ha /* 0x806DF2F4@ha */
/* 806DD438  38 63 F2 F4 */	addi r3, r3, ms@l /* 0x806DF2F4@l */
...
/* 806DD474  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DD478  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DD4C8  4B 97 00 05 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806DD4DC  4B 96 E3 D9 */	bl forceOnEventMove__Q213dPa_control_c7level_cFUl
...
/* 806DD528  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DD52C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806DD530  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 806DD534  38 80 00 1F */	li r4, 0x1f
/* 806DD538  4B 99 28 5D */	bl StopQuake__12dVibration_cFi
lbl_806DD53C:
/* 806DD53C  C0 5E 00 90 */	lfs f2, 0x90(r30)
/* 806DD540  3C 60 80 6E */	lis r3, ms@ha /* 0x806DF2F4@ha */
/* 806DD544  38 63 F2 F4 */	addi r3, r3, ms@l /* 0x806DF2F4@l */
...
/* 806DD55C  3C 60 80 6E */	lis r3, my@ha /* 0x806DF2F8@ha */
/* 806DD560  38 63 F2 F8 */	addi r3, r3, my@l /* 0x806DF2F8@l */
...
/* 806DD590  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DD594  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806DD598  38 63 09 58 */	addi r3, r3, 0x958
/* 806DD59C  38 80 00 07 */	li r4, 7
/* 806DD5A0  4B 95 73 79 */	bl onDungeonItem__12dSv_memBit_cFi
/* 806DD5A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DD5A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806DD5AC  38 80 00 0E */	li r4, 0xe
/* 806DD5B0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 806DD5B4  7C 05 07 74 */	extsb r5, r0
/* 806DD5B8  4B 95 7C 49 */	bl onSwitch__10dSv_info_cFii
...
/* 806DD604  4B AA 35 9D */	bl Reset__9dCamera_cF4cXyz4cXyzfs
/* 806DD608  38 7D 02 48 */	addi r3, r29, 0x248
/* 806DD60C  4B A8 3E A1 */	bl Start__9dCamera_cFv
/* 806DD610  38 7D 02 48 */	addi r3, r29, 0x248
/* 806DD614  38 80 00 00 */	li r4, 0
/* 806DD618  4B A8 59 F5 */	bl SetTrimSize__9dCamera_cFl
/* 806DD61C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DD620  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806DD624  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 806DD628  4B 96 4E 41 */	bl reset__14dEvt_control_cFv
...
/* 806DD6A4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806DD6A8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806DD720  4B B9 23 61 */	bl cLib_addCalc0__FPfff
lbl_806DD724:
...
/* 806DD768  4B AA 33 D9 */	bl Set__9dCamera_cF4cXyz4cXyzsf
...
/* 806DD7A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DD7A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DD7B8  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 806DD7BC  98 03 0C 98 */	stb r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
...
/* 806DD7E4  4B 94 99 8D */	bl dStage_changeScene__FifUlScsi
lbl_806DD7E8:
/* 806DD7E8  39 61 00 D0 */	addi r11, r1, 0xd0
/* 806DD7EC  4B C8 4A 31 */	bl _restgpr_26
