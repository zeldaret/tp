...
/* 806D9DF8  4B C8 83 BD */	bl _savegpr_19
/* 806D9DFC  7C 73 1B 78 */	mr r19, r3
/* 806D9E00  3C 60 80 6E */	lis r3, lit_3763@ha /* 0x806DEE38@ha */
/* 806D9E04  3B E3 EE 38 */	addi r31, r3, lit_3763@l /* 0x806DEE38@l */
/* 806D9E08  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D9E0C  3A 83 61 C0 */	addi r20, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D9E10  83 74 5D AC */	lwz r27, 0x5dac(r20)
/* 806D9E14  3A A1 01 78 */	addi r21, r1, 0x178
/* 806D9E18  7E A3 AB 78 */	mr r3, r21
/* 806D9E1C  4B 99 D7 61 */	bl __ct__11dBgS_GndChkFv
/* 806D9E20  3C 60 80 6E */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x806DF240@ha */
/* 806D9E24  38 63 F2 40 */	addi r3, r3, __vt__14dBgS_ObjGndChk@l /* 0x806DF240@l */
...
/* 806D9E48  4B 99 F0 21 */	bl SetObj__16dBgS_PolyPassChkFv
...
/* 806D9E8C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 806D9E90  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 806D9E94  80 84 00 00 */	lwz r4, 0(r4)
/* 806D9E98  4B C6 C6 19 */	bl PSMTXCopy
/* 806D9E9C  38 61 00 C4 */	addi r3, r1, 0xc4
/* 806D9EA0  38 81 00 B8 */	addi r4, r1, 0xb8
/* 806D9EA4  4B B9 70 49 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 806D9F2C  4B B8 CC 09 */	bl __mi__4cXyzCFRC3Vec
...
/* 806D9F48  4B B8 D7 2D */	bl cM_atan2s__Fff
...
/* 806D9F80  4B B8 D6 F5 */	bl cM_atan2s__Fff
...
/* 806D9FBC  4B B9 66 4D */	bl cLib_addCalcAngleS2__FPssss
...
/* 806DA154  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806DA158  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 806DA16C  4B 93 22 71 */	bl mDoMtx_YrotS__FPA4_fs
/* 806DA170  48 00 00 20 */	b lbl_806DA190
lbl_806DA174:
/* 806DA174  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806DA178  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 806DA18C  4B 93 22 51 */	bl mDoMtx_YrotS__FPA4_fs
lbl_806DA190:
...
/* 806DA1AC  4B B9 6D 41 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 806DA1D8  4B 99 D5 D9 */	bl __ct__18dBgS_ObjGndChk_SplFv
/* 806DA1DC  38 61 01 24 */	addi r3, r1, 0x124
/* 806DA1E0  38 93 04 D0 */	addi r4, r19, 0x4d0
/* 806DA1E4  4B B8 DB 45 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 806DA1E8  3B 41 00 D0 */	addi r26, r1, 0xd0
/* 806DA1EC  7F 43 D3 78 */	mr r3, r26
/* 806DA1F0  4B 99 D3 8D */	bl __ct__11dBgS_GndChkFv
/* 806DA1F4  3C 60 80 6E */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x806DF240@ha */
/* 806DA1F8  38 03 F2 40 */	addi r0, r3, __vt__14dBgS_ObjGndChk@l /* 0x806DF240@l */
...
/* 806DA210  4B 99 EC 59 */	bl SetObj__16dBgS_PolyPassChkFv
/* 806DA214  7F 43 D3 78 */	mr r3, r26
/* 806DA218  38 93 04 D0 */	addi r4, r19, 0x4d0
/* 806DA21C  4B B8 DB 0D */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 806DA220  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DA224  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806DA228  3B 43 0F 38 */	addi r26, r3, 0xf38
/* 806DA22C  7F 43 D3 78 */	mr r3, r26
/* 806DA230  38 81 01 24 */	addi r4, r1, 0x124
/* 806DA234  4B 99 A2 6D */	bl GroundCross__4cBgSFP11cBgS_GndChk
/* 806DA238  FF E0 08 90 */	fmr f31, f1
/* 806DA23C  7F 43 D3 78 */	mr r3, r26
/* 806DA240  38 81 00 D0 */	addi r4, r1, 0xd0
/* 806DA244  4B 99 A2 5D */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
lbl_806DA264:
/* 806DA264  3C 60 80 6E */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x806DF240@ha */
/* 806DA268  38 03 F2 40 */	addi r0, r3, __vt__14dBgS_ObjGndChk@l /* 0x806DF240@l */
...
/* 806DA284  4B 99 D3 6D */	bl __dt__11dBgS_GndChkFv
/* 806DA288  38 61 01 24 */	addi r3, r1, 0x124
/* 806DA28C  38 80 FF FF */	li r4, -1
/* 806DA290  4B 99 D5 B9 */	bl __dt__18dBgS_ObjGndChk_SplFv
lbl_806DA294:
...
/* 806DA2FC  4B B9 63 0D */	bl cLib_addCalcAngleS2__FPssss
...
/* 806DA330  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DA334  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DA348  4B 99 56 DD */	bl StartShock__12dVibration_cFii4cXyz
...
/* 806DA3A4  4B B9 62 65 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806DA3D4  4B B8 D9 55 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 806DA3D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DA3DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806DA3E0  3B 63 0F 38 */	addi r27, r3, 0xf38
/* 806DA3E4  7F 63 DB 78 */	mr r3, r27
/* 806DA3E8  38 81 01 78 */	addi r4, r1, 0x178
/* 806DA3EC  4B 99 A0 B5 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 806DA40C  4B B8 C7 29 */	bl __mi__4cXyzCFRC3Vec
...
/* 806DA428  4B B8 D2 4D */	bl cM_atan2s__Fff
/* 806DA42C  7C 64 1B 78 */	mr r4, r3
/* 806DA430  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806DA434  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806DA438  80 63 00 00 */	lwz r3, 0(r3)
/* 806DA43C  4B 93 1F A1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 806DA46C  4B B8 D2 09 */	bl cM_atan2s__Fff
/* 806DA470  7C 03 00 D0 */	neg r0, r3
/* 806DA474  7C 04 07 34 */	extsh r4, r0
/* 806DA478  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806DA47C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806DA480  80 63 00 00 */	lwz r3, 0(r3)
/* 806DA484  4B 93 1F 19 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 806DA4E4  4B C6 CC 55 */	bl PSVECSquareMag
...
/* 806DA554  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806DA558  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806DA5C4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806DA5C8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806DA5CC:
...
/* 806DA614  4B 99 54 11 */	bl StartShock__12dVibration_cFii4cXyz
/* 806DA618  C0 1F 00 90 */	lfs f0, 0x90(r31)
/* 806DA61C  3C 60 80 6E */	lis r3, ms@ha /* 0x806DF2F4@ha */
/* 806DA620  38 83 F2 F4 */	addi r4, r3, ms@l /* 0x806DF2F4@l */
...
/* 806DA6B8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DA6BC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806DA6C0  80 63 00 00 */	lwz r3, 0(r3)
/* 806DA6C4  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 806DA6C8  38 80 00 02 */	li r4, 2
/* 806DA6CC  4B BD 77 29 */	bl changeSubBgmStatus__8Z2SeqMgrFl
/* 806DA6D0  48 00 00 24 */	b lbl_806DA6F4
lbl_806DA6D4:
/* 806DA6D4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DA6D8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806DA6DC  80 63 00 00 */	lwz r3, 0(r3)
/* 806DA6E0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 806DA6E4  38 80 00 03 */	li r4, 3
/* 806DA6E8  4B BD 77 0D */	bl changeSubBgmStatus__8Z2SeqMgrFl
...
/* 806DA700  4B B8 C4 35 */	bl __mi__4cXyzCFRC3Vec
...
/* 806DA728  4B C6 CA 11 */	bl PSVECSquareMag
...
/* 806DA798  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806DA79C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806DA808  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806DA80C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806DA824  4B B8 C3 11 */	bl __mi__4cXyzCFRC3Vec
...
/* 806DA84C  4B C6 C8 ED */	bl PSVECSquareMag
...
/* 806DA8BC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806DA8C0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806DA92C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806DA930  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806DA934:
...
/* 806DA964  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806DA968  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806DA990  4B B9 5C 79 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806DA9AC  4B B9 5C 5D */	bl cLib_addCalcAngleS2__FPssss
...
/* 806DA9F8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806DA9FC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806DAA00  80 63 00 00 */	lwz r3, 0(r3)
/* 806DAA04  7E E4 BB 78 */	mr r4, r23
/* 806DAA08  4B 93 19 D5 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 806DAA50  4B B9 4F ED */	bl cLib_addCalc2__FPffff
...
/* 806DAA64  4B B9 4F D9 */	bl cLib_addCalc2__FPffff
...
/* 806DAA78  4B B9 4F C5 */	bl cLib_addCalc2__FPffff
...
/* 806DAA94  4B B9 5B 75 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806DAAB0  4B B9 5B 59 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806DAAC4  4B B9 5B 45 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806DAB24  3C 60 80 6E */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x806DF240@ha */
/* 806DAB28  38 03 F2 40 */	addi r0, r3, __vt__14dBgS_ObjGndChk@l /* 0x806DF240@l */
...
/* 806DAB44  4B 99 CA AD */	bl __dt__11dBgS_GndChkFv
...
/* 806DAB58  4B C8 76 A9 */	bl _restgpr_19
