...
/* 806D9534  4B C8 8C A5 */	bl _savegpr_28
/* 806D9538  7C 7C 1B 78 */	mr r28, r3
/* 806D953C  3C 80 80 6E */	lis r4, lit_3763@ha /* 0x806DEE38@ha */
/* 806D9540  3B C4 EE 38 */	addi r30, r4, lit_3763@l /* 0x806DEE38@l */
...
/* 806D95DC  4B C4 EE 51 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806D9620  4B C4 EE 0D */	bl checkPass__12J3DFrameCtrlFf
...
/* 806D96C4  4B B8 E2 91 */	bl cM_rndF__Ff
...
lbl_806D96E0:
/* 806D96E0  3C 60 80 6E */	lis r3, l_HIO@ha /* 0x806DF2D4@ha */
/* 806D96E4  38 63 F2 D4 */	addi r3, r3, l_HIO@l /* 0x806DF2D4@l */
...
lbl_806D971C:
/* 806D971C  3C 60 80 6E */	lis r3, l_HIO@ha /* 0x806DF2D4@ha */
/* 806D9720  38 63 F2 D4 */	addi r3, r3, l_HIO@l /* 0x806DF2D4@l */
...
/* 806D974C  4B B8 E2 09 */	bl cM_rndF__Ff
...
/* 806D977C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D9780  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806D97B0  4B B9 6E 59 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806D97C4  4B B9 6E 45 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806D97F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D97F8  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806D9834  3D 20 80 6E */	lis r9, base_sc@ha /* 0x806DF308@ha */
/* 806D9838  39 29 F3 08 */	addi r9, r9, base_sc@l /* 0x806DF308@l */
/* 806D983C  39 40 00 FF */	li r10, 0xff
/* 806D9840  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 806D9844  4B 97 32 4D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806D9880  3D 20 80 6E */	lis r9, base_sc@ha /* 0x806DF308@ha */
/* 806D9884  39 29 F3 08 */	addi r9, r9, base_sc@l /* 0x806DF308@l */
/* 806D9888  39 40 00 FF */	li r10, 0xff
/* 806D988C  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 806D9890  4B 97 32 01 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806D990C  4B B9 6C FD */	bl cLib_addCalcAngleS2__FPssss
...
lbl_806D9968:
/* 806D9968  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D996C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806D99B4  3D 40 80 6E */	lis r10, base_sc@ha /* 0x806DF308@ha */
/* 806D99B8  39 4A F3 08 */	addi r10, r10, base_sc@l /* 0x806DF308@l */
/* 806D99BC  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 806D99C0  4B 97 3B 0D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806D9A0C  3D 40 80 6E */	lis r10, base_sc@ha /* 0x806DF308@ha */
/* 806D9A10  39 4A F3 08 */	addi r10, r10, base_sc@l /* 0x806DF308@l */
/* 806D9A14  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 806D9A18  4B 97 3A B5 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806D9A2C  4B 97 1E 89 */	bl forceOnEventMove__Q213dPa_control_c7level_cFUl
/* 806D9A30  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)
/* 806D9A34  38 63 02 10 */	addi r3, r3, 0x210
/* 806D9A38  80 9C 0D 34 */	lwz r4, 0xd34(r28)
/* 806D9A3C  4B 97 1E 79 */	bl forceOnEventMove__Q213dPa_control_c7level_cFUl
lbl_806D9A40:
...
/* 806D9AA0  4B B9 6B 69 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806D9AB4  4B B9 5F 89 */	bl cLib_addCalc2__FPffff
...
/* 806D9AC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D9ACC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_806D9B18:
/* 806D9B18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D9B1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D9B20  A8 1C 04 E6 */	lha r0, 0x4e6(r28)
/* 806D9B24  7C 00 00 D0 */	neg r0, r0
/* 806D9B28  7C 04 07 34 */	extsh r4, r0
/* 806D9B2C  4B 93 28 B1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 806D9B48  4B 93 32 55 */	bl transM__14mDoMtx_stack_cFfff
/* 806D9B4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D9B50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D9B54  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D9B58  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D9B5C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806D9B60  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 806D9B64  38 A1 00 38 */	addi r5, r1, 0x38
/* 806D9B68  4B C6 D2 05 */	bl PSMTXMultVec
...
/* 806D9BCC  3C 60 80 45 */	lis r3, g_dComIfGoat_gameInfo@ha /* 0x80450618@ha */
/* 806D9BD0  93 83 06 18 */	stw r28, g_dComIfGoat_gameInfo@l(r3)  /* 0x80450618@l */
...
lbl_806D9C00:
/* 806D9C00  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 806D9C04  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
...
/* 806D9C24  3C 60 80 6E */	lis r3, l_HIO@ha /* 0x806DF2D4@ha */
/* 806D9C28  38 63 F2 D4 */	addi r3, r3, l_HIO@l /* 0x806DF2D4@l */
...
/* 806D9C6C  4B C8 85 B9 */	bl _restgpr_28
