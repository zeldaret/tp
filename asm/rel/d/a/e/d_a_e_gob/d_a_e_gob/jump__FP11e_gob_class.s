...
/* 806DAB7C  4B C8 76 5D */	bl _savegpr_28
/* 806DAB80  7C 7D 1B 78 */	mr r29, r3
/* 806DAB84  3C 60 80 6E */	lis r3, lit_3763@ha /* 0x806DEE38@ha */
/* 806DAB88  3B E3 EE 38 */	addi r31, r3, lit_3763@l /* 0x806DEE38@l */
...
/* 806DAC14  4B B8 CD 79 */	bl cM_rndFX__Ff
...
/* 806DAC44  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DAC48  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806DAC4C  80 63 00 00 */	lwz r3, 0(r3)
/* 806DAC50  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 806DAC54  4B BD 4C 31 */	bl subBgmStop__8Z2SeqMgrFv
/* 806DAC58  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DAC5C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806DAC8C  4B B8 BE A9 */	bl __mi__4cXyzCFRC3Vec
...
/* 806DAD08  4B B8 CC 4D */	bl cM_rndF__Ff
...
/* 806DAD20  4B B9 61 CD */	bl MtxPosition__FP4cXyzP4cXyz
/* 806DAD24  88 1D 06 D8 */	lbz r0, 0x6d8(r29)
/* 806DAD28  2C 00 00 01 */	cmpwi r0, 1
/* 806DAD2C  40 82 00 20 */	bne lbl_806DAD4C
/* 806DAD30  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DAD34  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806DAD38  80 63 00 00 */	lwz r3, 0(r3)
/* 806DAD3C  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 806DAD40  38 80 00 01 */	li r4, 1
/* 806DAD44  4B BD 70 B1 */	bl changeSubBgmStatus__8Z2SeqMgrFl
/* 806DAD48  48 00 01 98 */	b lbl_806DAEE0
lbl_806DAD4C:
/* 806DAD4C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806DAD50  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806DAD54  80 63 00 00 */	lwz r3, 0(r3)
/* 806DAD58  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 806DAD5C  38 80 00 04 */	li r4, 4
/* 806DAD60  4B BD 70 95 */	bl changeSubBgmStatus__8Z2SeqMgrFl
...
/* 806DAF34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DAF38  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DAF74  3D 20 80 6E */	lis r9, base_sc@ha /* 0x806DF308@ha */
/* 806DAF78  39 29 F3 08 */	addi r9, r9, base_sc@l /* 0x806DF308@l */
/* 806DAF7C  39 40 00 FF */	li r10, 0xff
/* 806DAF80  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 806DAF84  4B 97 1B 0D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806DAFC0  3D 20 80 6E */	lis r9, base_sc@ha /* 0x806DF308@ha */
/* 806DAFC4  39 29 F3 08 */	addi r9, r9, base_sc@l /* 0x806DF308@l */
/* 806DAFC8  39 40 00 FF */	li r10, 0xff
/* 806DAFCC  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 806DAFD0  4B 97 1A C1 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806DB00C  3D 20 80 6E */	lis r9, base_sc@ha /* 0x806DF308@ha */
/* 806DB010  39 29 F3 08 */	addi r9, r9, base_sc@l /* 0x806DF308@l */
/* 806DB014  39 40 00 FF */	li r10, 0xff
/* 806DB018  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 806DB01C  4B 97 1A 75 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_806DB020:
/* 806DB020  39 61 00 90 */	addi r11, r1, 0x90
/* 806DB024  4B C8 72 01 */	bl _restgpr_28
