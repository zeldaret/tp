...
/* 807B4928  4B BA D8 95 */	bl _savegpr_21
/* 807B492C  7C 7C 1B 78 */	mr r28, r3
/* 807B4930  3C 60 80 7B */	lis r3, lit_3746@ha /* 0x807B7EB8@ha */
/* 807B4934  3B E3 7E B8 */	addi r31, r3, lit_3746@l /* 0x807B7EB8@l */
/* 807B4938  3B C0 00 00 */	li r30, 0
/* 807B493C  3B 20 00 00 */	li r25, 0
/* 807B4940  AB BC 0D D0 */	lha r29, 0xdd0(r28)
/* 807B4944  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B4948  3A C3 07 68 */	addi r22, r3, calc_mtx@l /* 0x80450768@l */
/* 807B494C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807B4950  3A E3 CA 54 */	addi r23, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 807B49B0  4B 85 7B 1D */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 807B49C4  4B AB C4 E1 */	bl MtxScale__FfffUc
...
/* 807B49D8  4B AB C4 85 */	bl MtxTrans__FfffUc
...
/* 807B49EC  4B B9 1A C5 */	bl PSMTXCopy
/* 807B49F0  7E E3 BB 78 */	mr r3, r23
/* 807B49F4  80 95 00 04 */	lwz r4, 4(r21)
/* 807B49F8  38 BC 01 0C */	addi r5, r28, 0x10c
/* 807B49FC  4B 9F 03 A5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 807B4A00  7E A3 AB 78 */	mr r3, r21
/* 807B4A04  4B 85 92 29 */	bl mDoExt_modelUpdate__FP8J3DModel
...
/* 807B4A28  3C 60 80 7C */	lis r3, master@ha /* 0x807B80E0@ha */
/* 807B4A2C  38 63 80 E0 */	addi r3, r3, master@l /* 0x807B80E0@l */
...
/* 807B4A54  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B4A58  3B 03 07 68 */	addi r24, r3, calc_mtx@l /* 0x80450768@l */
/* 807B4A5C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807B4A60  3A E3 CA 54 */	addi r23, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 807B4AC0  4B 85 7A 0D */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 807B4AD4  4B AB C3 D1 */	bl MtxScale__FfffUc
...
/* 807B4AE8  4B AB C3 75 */	bl MtxTrans__FfffUc
...
/* 807B4AFC  4B B9 19 B5 */	bl PSMTXCopy
/* 807B4B00  7E E3 BB 78 */	mr r3, r23
/* 807B4B04  80 95 00 04 */	lwz r4, 4(r21)
/* 807B4B08  38 BC 01 0C */	addi r5, r28, 0x10c
/* 807B4B0C  4B 9F 02 95 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 807B4B10  7E A3 AB 78 */	mr r3, r21
/* 807B4B14  4B 85 91 19 */	bl mDoExt_modelUpdate__FP8J3DModel
...
/* 807B4B44  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B4B48  3A E3 07 68 */	addi r23, r3, calc_mtx@l /* 0x80450768@l */
/* 807B4B4C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807B4B50  3B 03 CA 54 */	addi r24, r3, g_env_light@l /* 0x8042CA54@l */
...
/* 807B4BB0  4B 85 79 1D */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 807B4BC4  4B AB C2 E1 */	bl MtxScale__FfffUc
...
/* 807B4BD8  4B AB C2 85 */	bl MtxTrans__FfffUc
...
/* 807B4BEC  4B B9 18 C5 */	bl PSMTXCopy
/* 807B4BF0  7F 03 C3 78 */	mr r3, r24
/* 807B4BF4  80 95 00 04 */	lwz r4, 4(r21)
/* 807B4BF8  38 BC 01 0C */	addi r5, r28, 0x10c
/* 807B4BFC  4B 9F 01 A5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 807B4C00  7E A3 AB 78 */	mr r3, r21
/* 807B4C04  4B 85 90 29 */	bl mDoExt_modelUpdate__FP8J3DModel
...
/* 807B4C2C  4B BA D5 DD */	bl _restgpr_21
