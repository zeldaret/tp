...
/* 807B756C  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 807B7570  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 807B7574  38 81 00 08 */	addi r4, r1, 8
/* 807B7578  4B 86 22 81 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 807B757C  3C 80 80 7C */	lis r4, master@ha /* 0x807B80E0@ha */
/* 807B7580  90 64 80 E0 */	stw r3, master@l(r4)  /* 0x807B80E0@l */
...
/* 807B75E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807B75EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807B75F0  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 807B75F4  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 807B75F8  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 807B75FC  4B B8 F2 ED */	bl PSMTXTrans
/* 807B7600  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807B7604  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807B7608  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 807B760C  4B 85 4E 29 */	bl mDoMtx_YrotM__FPA4_fs
/* 807B7610  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807B7614  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807B7618  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 807B761C  4B 85 4D 81 */	bl mDoMtx_XrotM__FPA4_fs
/* 807B7620  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807B7624  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807B7628  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 807B762C  4B 85 4E 09 */	bl mDoMtx_YrotM__FPA4_fs
/* 807B7630  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807B7634  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807B7638  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 807B763C  38 04 C0 00 */	addi r0, r4, -16384
/* 807B7640  7C 04 07 34 */	extsh r4, r0
/* 807B7644  4B 85 4D 59 */	bl mDoMtx_XrotM__FPA4_fs
/* 807B7648  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807B764C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807B7660  4B 85 4D D5 */	bl mDoMtx_YrotM__FPA4_fs
/* 807B7664  3C 60 80 7B */	lis r3, lit_3747@ha /* 0x807B7EBC@ha */
/* 807B7668  C0 23 7E BC */	lfs f1, lit_3747@l(r3)  /* 0x807B7EBC@l */
/* 807B766C  3C 60 80 7B */	lis r3, lit_3759@ha /* 0x807B7EC4@ha */
/* 807B7670  C0 43 7E C4 */	lfs f2, lit_3759@l(r3)  /* 0x807B7EC4@l */
/* 807B7674  FC 60 08 90 */	fmr f3, f1
/* 807B7678  4B 85 57 25 */	bl transM__14mDoMtx_stack_cFfff
/* 807B767C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807B7680  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807B7684  80 9F 05 B8 */	lwz r4, 0x5b8(r31)
/* 807B7688  38 84 00 24 */	addi r4, r4, 0x24
/* 807B768C  4B B8 EE 25 */	bl PSMTXCopy
/* 807B7690  3C 60 80 7B */	lis r3, lit_3747@ha /* 0x807B7EBC@ha */
/* 807B7694  C0 23 7E BC */	lfs f1, lit_3747@l(r3)  /* 0x807B7EBC@l */
/* 807B7698  FC 40 08 90 */	fmr f2, f1
/* 807B769C  FC 60 08 90 */	fmr f3, f1
/* 807B76A0  4B 85 56 FD */	bl transM__14mDoMtx_stack_cFfff
/* 807B76A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807B76A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807B770C  4B 87 59 61 */	bl dComIfGp_getReverb__Fi
