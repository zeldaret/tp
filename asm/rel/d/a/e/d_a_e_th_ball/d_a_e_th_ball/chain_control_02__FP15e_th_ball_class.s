...
/* 807B50F0  4B BA D0 D1 */	bl _savegpr_22
/* 807B50F4  7C 78 1B 78 */	mr r24, r3
/* 807B50F8  3C 60 80 7B */	lis r3, lit_3746@ha /* 0x807B7EB8@ha */
/* 807B50FC  3B C3 7E B8 */	addi r30, r3, lit_3746@l /* 0x807B7EB8@l */
...
/* 807B5144  3C 60 80 7C */	lis r3, master@ha /* 0x807B80E0@ha */
/* 807B5148  38 63 80 E0 */	addi r3, r3, master@l /* 0x807B80E0@l */
...
/* 807B5174  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B5178  3B E3 07 68 */	addi r31, r3, calc_mtx@l /* 0x80450768@l */
...
/* 807B5190  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B5194  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807B5198  80 63 00 00 */	lwz r3, 0(r3)
/* 807B519C  A8 98 04 DE */	lha r4, 0x4de(r24)
/* 807B51A0  4B 85 72 3D */	bl mDoMtx_YrotS__FPA4_fs
/* 807B51A4  C0 3E 00 24 */	lfs f1, 0x24(r30)
/* 807B51A8  56 E0 04 38 */	rlwinm r0, r23, 0, 0x10, 0x1c
/* 807B51AC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 807B51B0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 807B51D8  4B AB BD 15 */	bl MtxPosition__FP4cXyzP4cXyz
lbl_807B51DC:
...
/* 807B5218  4B AB 24 5D */	bl cM_atan2s__Fff
...
/* 807B5240  4B AB 24 35 */	bl cM_atan2s__Fff
...
/* 807B5254  4B 85 71 89 */	bl mDoMtx_YrotS__FPA4_fs
/* 807B5258  80 7F 00 00 */	lwz r3, 0(r31)
/* 807B525C  7E C4 B3 78 */	mr r4, r22
/* 807B5260  4B 85 71 3D */	bl mDoMtx_XrotM__FPA4_fs
...
/* 807B5284  4B AB BC 69 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807B5318  4B B9 1E 21 */	bl PSVECSquareMag
...
/* 807B5384  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807B5388  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807B53F4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807B53F8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807B53FC:
...
/* 807B5454  4B AB B1 B5 */	bl cLib_addCalcAngleS2__FPssss
lbl_807B5458:
...
/* 807B54A0  4B BA CD 6D */	bl _restgpr_22
