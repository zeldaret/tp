...
/* 807B74A8  4B 86 47 CD */	bl fopAcM_createItemForTrBoxDemo__FPC4cXyziiiPC5csXyzPC4cXyz
/* 807B74AC  3C 80 80 7C */	lis r4, demo_id@ha /* 0x807B80E4@ha */
/* 807B74B0  90 64 80 E4 */	stw r3, demo_id@l(r4)  /* 0x807B80E4@l */
...
/* 807B74CC  3C 60 80 7C */	lis r3, demo_id@ha /* 0x807B80E4@ha */
/* 807B74D0  80 83 80 E4 */	lwz r4, demo_id@l(r3)  /* 0x807B80E4@l */
/* 807B74D4  3C 04 00 01 */	addis r0, r4, 1
/* 807B74D8  28 00 FF FF */	cmplwi r0, 0xffff
/* 807B74DC  41 82 00 14 */	beq lbl_807B74F0
/* 807B74E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B74E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B74E8  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 807B74EC  4B 88 C2 01 */	bl setPtI_Id__14dEvt_control_cFUi
lbl_807B74F0:
/* 807B74F0  38 00 00 01 */	li r0, 1
/* 807B74F4  98 1F 1A 8E */	stb r0, 0x1a8e(r31)
/* 807B74F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B74FC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B7500  38 63 09 58 */	addi r3, r3, 0x958
/* 807B7504  38 80 00 5F */	li r4, 0x5f
/* 807B7508  4B 87 D3 09 */	bl onSwitch__12dSv_memBit_cFi
/* 807B750C  48 00 00 1C */	b lbl_807B7528
lbl_807B7510:
/* 807B7510  38 80 00 00 */	li r4, 0
/* 807B7514  38 A0 00 00 */	li r5, 0
/* 807B7518  4B 86 44 B9 */	bl fopAcM_orderItemEvent__FP10fopAc_ac_cUsUs
