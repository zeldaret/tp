...
/* 807B4D24  4B BA D4 9D */	bl _savegpr_22
/* 807B4D28  7C 7B 1B 78 */	mr r27, r3
/* 807B4D2C  3C 60 80 7B */	lis r3, lit_3746@ha /* 0x807B7EB8@ha */
/* 807B4D30  3B E3 7E B8 */	addi r31, r3, lit_3746@l /* 0x807B7EB8@l */
/* 807B4D34  38 61 00 44 */	addi r3, r1, 0x44
/* 807B4D38  4B 8C 28 45 */	bl __ct__11dBgS_GndChkFv
/* 807B4D3C  3B DB 06 5C */	addi r30, r27, 0x65c
/* 807B4D40  3C 60 80 7C */	lis r3, master@ha /* 0x807B80E0@ha */
/* 807B4D44  38 63 80 E0 */	addi r3, r3, master@l /* 0x807B80E0@l */
...
/* 807B4DB0  4B AB 1D 85 */	bl __mi__4cXyzCFRC3Vec
...
/* 807B4DCC  4B AB 28 A9 */	bl cM_atan2s__Fff
/* 807B4DD0  7C 64 1B 78 */	mr r4, r3
/* 807B4DD4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B4DD8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807B4DDC  80 63 00 00 */	lwz r3, 0(r3)
/* 807B4DE0  4B 85 75 FD */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807B4E10  4B AB 28 65 */	bl cM_atan2s__Fff
/* 807B4E14  7C 03 00 D0 */	neg r0, r3
/* 807B4E18  7C 04 07 34 */	extsh r4, r0
/* 807B4E1C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B4E20  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807B4E24  80 63 00 00 */	lwz r3, 0(r3)
/* 807B4E28  4B 85 75 75 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 807B4E50  4B AB C0 9D */	bl MtxPosition__FP4cXyzP4cXyz
/* 807B4E54  C3 FF 00 04 */	lfs f31, 4(r31)
/* 807B4E58  D3 E1 00 40 */	stfs f31, 0x40(r1)
/* 807B4E5C  3B 00 00 01 */	li r24, 1
/* 807B4E60  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B4E64  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B4E68  3B 23 0F 38 */	addi r25, r3, 0xf38
/* 807B4E6C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B4E70  3B 43 07 68 */	addi r26, r3, calc_mtx@l /* 0x80450768@l */
lbl_807B4E74:
...
/* 807B4ED0  4B AB 27 A5 */	bl cM_atan2s__Fff
...
/* 807B4EF8  4B AB 27 7D */	bl cM_atan2s__Fff
...
/* 807B4F0C  4B 85 74 D1 */	bl mDoMtx_YrotS__FPA4_fs
/* 807B4F10  80 7A 00 00 */	lwz r3, 0(r26)
/* 807B4F14  7E E4 BB 78 */	mr r4, r23
/* 807B4F18  4B 85 74 85 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 807B4F3C  4B AB BF B1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807B4FAC  4B AB 2D 61 */	bl SetPos__11cBgS_GndChkFPC3Vec
/* 807B4FB0  7F 23 CB 78 */	mr r3, r25
/* 807B4FB4  38 81 00 44 */	addi r4, r1, 0x44
/* 807B4FB8  4B 8B F4 E9 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 807B5030  4B 8C 25 C1 */	bl __dt__11dBgS_GndChkFv
...
/* 807B5060  4B BA D1 AD */	bl _restgpr_22
