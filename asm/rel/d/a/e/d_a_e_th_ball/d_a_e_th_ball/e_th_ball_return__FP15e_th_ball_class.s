...
/* 807B69B4  4B BA B8 25 */	bl _savegpr_28
/* 807B69B8  7C 7D 1B 78 */	mr r29, r3
/* 807B69BC  3C 60 80 7B */	lis r3, lit_3746@ha /* 0x807B7EB8@ha */
/* 807B69C0  3B E3 7E B8 */	addi r31, r3, lit_3746@l /* 0x807B7EB8@l */
/* 807B69C4  3C 60 80 7C */	lis r3, master@ha /* 0x807B80E0@ha */
/* 807B69C8  38 63 80 E0 */	addi r3, r3, master@l /* 0x807B80E0@l */
...
/* 807B69E4  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807B69E8  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807B69EC  80 84 00 00 */	lwz r4, 0(r4)
/* 807B69F0  4B B8 FA C1 */	bl PSMTXCopy
...
/* 807B6A30  4B AB 0C 45 */	bl cM_atan2s__Fff
...
lbl_807B6A68:
/* 807B6A68  3C 60 80 7C */	lis r3, master@ha /* 0x807B80E0@ha */
/* 807B6A6C  80 83 80 E0 */	lwz r4, master@l(r3)  /* 0x807B80E0@l */
...
/* 807B6AB4  4B AB 8F 89 */	bl cLib_addCalc2__FPffff
...
/* 807B6AC8  4B AB 9B 41 */	bl cLib_addCalcAngleS2__FPssss
...
/* 807B6ADC  4B AB 9B 2D */	bl cLib_addCalcAngleS2__FPssss
...
/* 807B6AF8  4B AB 9B 11 */	bl cLib_addCalcAngleS2__FPssss
...
/* 807B6B20  4B AB 0E 6D */	bl cM_rndFX__Ff
...
/* 807B6B38  4B AB 0E 55 */	bl cM_rndFX__Ff
...
/* 807B6B64  4B B9 05 D5 */	bl PSVECSquareMag
...
/* 807B6BD4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807B6BD8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807B6C44  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807B6C48  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807B6C4C:
...
/* 807B6C74  4B AB 0D 19 */	bl cM_rndFX__Ff
...
/* 807B6CEC  4B BA B5 39 */	bl _restgpr_28
