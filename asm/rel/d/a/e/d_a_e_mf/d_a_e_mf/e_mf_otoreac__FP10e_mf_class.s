...
/* 8070BFB4  3C 60 80 71 */	lis r3, lit_3828@ha /* 0x80713974@ha */
/* 8070BFB8  3B E3 39 74 */	addi r31, r3, lit_3828@l /* 0x80713974@l */
...
/* 8070BFF4  4B B5 B9 61 */	bl cM_rndF__Ff
...
/* 8070C018  4B B5 B9 3D */	bl cM_rndF__Ff
...
/* 8070C04C  4B B5 B9 41 */	bl cM_rndFX__Ff
...
lbl_8070C078:
/* 8070C078  3C 60 80 71 */	lis r3, l_HIO@ha /* 0x80713F74@ha */
/* 8070C07C  38 63 3F 74 */	addi r3, r3, l_HIO@l /* 0x80713F74@l */
...
/* 8070C0B4  4B B5 AA 81 */	bl __mi__4cXyzCFRC3Vec
...
/* 8070C0D0  4B B5 B5 A5 */	bl cM_atan2s__Fff
...
/* 8070C0E4  4B B6 45 25 */	bl cLib_addCalcAngleS2__FPssss
/* 8070C0E8  38 61 00 18 */	addi r3, r1, 0x18
/* 8070C0EC  4B C3 B0 4D */	bl PSVECSquareMag
...
/* 8070C15C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8070C160  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8070C1CC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8070C1D0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8070C1D4:
...
/* 8070C1FC  4B B5 B7 59 */	bl cM_rndF__Ff
...
/* 8070C240  4B B6 37 FD */	bl cLib_addCalc2__FPffff
