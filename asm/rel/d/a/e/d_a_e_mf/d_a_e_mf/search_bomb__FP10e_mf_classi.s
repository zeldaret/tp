...
/* 8070B290  4B C5 6F 3D */	bl _savegpr_25
/* 8070B294  7C 79 1B 78 */	mr r25, r3
/* 8070B298  7C 9A 23 78 */	mr r26, r4
/* 8070B29C  3C 60 80 71 */	lis r3, lit_3828@ha /* 0x80713974@ha */
/* 8070B2A0  3B A3 39 74 */	addi r29, r3, lit_3828@l /* 0x80713974@l */
/* 8070B2A4  38 A0 00 00 */	li r5, 0
/* 8070B2A8  3C 60 80 71 */	lis r3, target_info_count@ha /* 0x80713FC0@ha */
/* 8070B2AC  90 A3 3F C0 */	stw r5, target_info_count@l(r3)  /* 0x80713FC0@l */
/* 8070B2B0  7C A3 2B 78 */	mr r3, r5
/* 8070B2B4  3C 80 80 71 */	lis r4, target_info@ha /* 0x80713F98@ha */
/* 8070B2B8  38 84 3F 98 */	addi r4, r4, target_info@l /* 0x80713F98@l */
...
/* 8070B2D0  3C 60 80 71 */	lis r3, s_b_sub__FPvPv@ha /* 0x8070B1EC@ha */
/* 8070B2D4  38 63 B1 EC */	addi r3, r3, s_b_sub__FPvPv@l /* 0x8070B1EC@l */
/* 8070B2D8  7F 24 CB 78 */	mr r4, r25
/* 8070B2DC  4B 91 60 5D */	bl fpcEx_Search__FPFPvPv_PvPv
/* 8070B2E0  C3 BD 00 44 */	lfs f29, 0x44(r29)
/* 8070B2E4  3C 60 80 71 */	lis r3, target_info_count@ha /* 0x80713FC0@ha */
/* 8070B2E8  3B C3 3F C0 */	addi r30, r3, target_info_count@l /* 0x80713FC0@l */
...
/* 8070B364  4B C3 BD D5 */	bl PSVECSquareMag
...
/* 8070B3D0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8070B3D4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8070B440  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8070B444  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8070B448:
/* 8070B448  FC 01 E8 40 */	fcmpo cr0, f1, f29
/* 8070B44C  40 80 02 08 */	bge lbl_8070B654
/* 8070B450  38 61 00 1C */	addi r3, r1, 0x1c
/* 8070B454  4B C3 BC E5 */	bl PSVECSquareMag
...
/* 8070B4C4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8070B4C8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8070B534  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8070B538  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8070B53C:
...
/* 8070B5A8  4B B5 C0 CD */	bl cM_atan2s__Fff
...
lbl_8070B5D8:
/* 8070B5D8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8070B5DC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8070B5E0  80 63 00 00 */	lwz r3, 0(r3)
/* 8070B5E4  7C 04 00 D0 */	neg r0, r4
/* 8070B5E8  7C 04 07 34 */	extsh r4, r0
/* 8070B5EC  4B 90 0D F1 */	bl mDoMtx_YrotS__FPA4_fs
/* 8070B5F0  38 61 00 28 */	addi r3, r1, 0x28
/* 8070B5F4  38 81 00 10 */	addi r4, r1, 0x10
/* 8070B5F8  4B B6 58 F5 */	bl MtxPosition__FP4cXyzP4cXyz
...
lbl_8070B684:
/* 8070B684  3C 60 80 71 */	lis r3, target_info@ha /* 0x80713F98@ha */
/* 8070B688  3B E3 3F 98 */	addi r31, r3, target_info@l /* 0x80713F98@l */
...
/* 8070B6CC  4B C5 6B 4D */	bl _restgpr_25
