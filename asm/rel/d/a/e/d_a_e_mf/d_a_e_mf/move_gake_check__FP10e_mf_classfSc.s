...
/* 8070B860  4B C5 69 7D */	bl _savegpr_29
/* 8070B864  7C 7D 1B 78 */	mr r29, r3
/* 8070B868  FF E0 08 90 */	fmr f31, f1
/* 8070B86C  7C 9E 23 78 */	mr r30, r4
/* 8070B870  3C 60 80 71 */	lis r3, lit_3828@ha /* 0x80713974@ha */
/* 8070B874  3B E3 39 74 */	addi r31, r3, lit_3828@l /* 0x80713974@l */
/* 8070B878  38 61 00 20 */	addi r3, r1, 0x20
/* 8070B87C  4B 96 BD 01 */	bl __ct__11dBgS_GndChkFv
/* 8070B880  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8070B884  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8070B888  80 63 00 00 */	lwz r3, 0(r3)
/* 8070B88C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 8070B890  4B 90 0B 4D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8070B8C4  4B B6 56 29 */	bl MtxPosition__FP4cXyzP4cXyz
/* 8070B8C8  38 61 00 08 */	addi r3, r1, 8
/* 8070B8CC  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 8070B8D0  7C 65 1B 78 */	mr r5, r3
/* 8070B8D4  4B C3 B7 BD */	bl PSVECAdd
/* 8070B8D8  38 61 00 20 */	addi r3, r1, 0x20
/* 8070B8DC  38 81 00 08 */	addi r4, r1, 8
/* 8070B8E0  4B B5 C4 49 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 8070B8E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8070B8E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8070B8EC  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8070B8F0  38 81 00 20 */	addi r4, r1, 0x20
/* 8070B8F4  4B 96 8B AD */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8070B914  4B 96 BC DD */	bl __dt__11dBgS_GndChkFv
...
/* 8070B928  4B 96 BC C9 */	bl __dt__11dBgS_GndChkFv
...
/* 8070B93C  4B C5 68 ED */	bl _restgpr_29
