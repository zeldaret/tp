...
/* 8071FEA8  4B C4 23 35 */	bl _savegpr_29
/* 8071FEAC  7C 7E 1B 78 */	mr r30, r3
/* 8071FEB0  3C 80 80 72 */	lis r4, lit_3789@ha /* 0x80722C3C@ha */
/* 8071FEB4  3B E4 2C 3C */	addi r31, r4, lit_3789@l /* 0x80722C3C@l */
...
/* 8071FEE4  4B 96 39 4D */	bl Move__10dCcD_GSttsFv
...
/* 8071FF0C  3C 60 80 72 */	lis r3, l_HIO@ha /* 0x80722EC0@ha */
/* 8071FF10  38 63 2E C0 */	addi r3, r3, l_HIO@l /* 0x80722EC0@l */
...
/* 8071FF7C  3C 60 80 72 */	lis r3, l_HIO@ha /* 0x80722EC0@ha */
/* 8071FF80  38 63 2E C0 */	addi r3, r3, l_HIO@l /* 0x80722EC0@l */
/* 8071FF84  A8 03 00 30 */	lha r0, 0x30(r3)
/* 8071FF88  B0 1E 06 9C */	sth r0, 0x69c(r30)
/* 8071FF8C  48 00 00 14 */	b lbl_8071FFA0
lbl_8071FF90:
/* 8071FF90  3C 60 80 72 */	lis r3, l_HIO@ha /* 0x80722EC0@ha */
/* 8071FF94  38 63 2E C0 */	addi r3, r3, l_HIO@l /* 0x80722EC0@l */
/* 8071FF98  A8 03 00 18 */	lha r0, 0x18(r3)
/* 8071FF9C  B0 1E 06 9C */	sth r0, 0x69c(r30)
lbl_8071FFA0:
/* 8071FFA0  38 7E 09 04 */	addi r3, r30, 0x904
/* 8071FFA4  4B 96 43 B5 */	bl GetAtHitObj__12dCcD_GObjInfFv
...
/* 8071FFE0  4B 96 7C 25 */	bl cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 8072012C  4B C2 6F AD */	bl PSVECScale
...
/* 80720144  4B B4 F8 39 */	bl cLib_addCalc__FPfffff
...
/* 8072015C  4B B4 F8 21 */	bl cLib_addCalc__FPfffff
