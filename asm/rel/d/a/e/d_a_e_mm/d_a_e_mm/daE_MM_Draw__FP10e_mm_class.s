...
/* 8071FB00  4B C4 26 DD */	bl _savegpr_29
/* 8071FB04  7C 7D 1B 78 */	mr r29, r3
/* 8071FB08  3C 60 80 72 */	lis r3, lit_3789@ha /* 0x80722C3C@ha */
/* 8071FB0C  3B E3 2C 3C */	addi r31, r3, lit_3789@l /* 0x80722C3C@l */
/* 8071FB10  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 8071FB14  83 C3 00 04 */	lwz r30, 4(r3)
/* 8071FB18  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8071FB1C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8071FB20  38 80 00 00 */	li r4, 0
/* 8071FB24  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 8071FB28  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8071FB2C  4B A8 3C 99 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8071FB30  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8071FB34  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8071FB38  80 9E 00 04 */	lwz r4, 4(r30)
/* 8071FB3C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8071FB40  4B A8 52 61 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8071FB44  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 8071FB48  4B 8F 16 79 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 8071FB98  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 8071FB9C  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 8071FBA0  4B 90 ED 71 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 8071FBA4  90 7D 06 64 */	stw r3, 0x664(r29)
/* 8071FBA8  38 60 00 01 */	li r3, 1
/* 8071FBAC  39 61 00 30 */	addi r11, r1, 0x30
/* 8071FBB0  4B C4 26 79 */	bl _restgpr_29
