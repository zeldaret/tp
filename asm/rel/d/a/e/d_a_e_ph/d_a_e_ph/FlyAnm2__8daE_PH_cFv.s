...
/* 8073F8D8  4B C2 29 05 */	bl _savegpr_29
/* 8073F8DC  7C 7E 1B 78 */	mr r30, r3
/* 8073F8E0  3C 60 80 74 */	lis r3, lit_3767@ha /* 0x80741BF4@ha */
/* 8073F8E4  3B E3 1B F4 */	addi r31, r3, lit_3767@l /* 0x80741BF4@l */
...
lbl_8073F94C:
/* 8073F94C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073F950  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8073F9A0  4B 90 DB 2D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8073F9F4  4B 90 DA D9 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8073FA0C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073FA10  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8073FA14  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 8073FA18  4B 8D AD C9 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8073FA1C  C0 1F 00 C8 */	lfs f0, 0xc8(r31)
/* 8073FA20  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8073FA24  40 80 00 58 */	bge lbl_8073FA7C
/* 8073FA28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073FA2C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8073FAD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073FADC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8073FB5C  4B C2 26 CD */	bl _restgpr_29
