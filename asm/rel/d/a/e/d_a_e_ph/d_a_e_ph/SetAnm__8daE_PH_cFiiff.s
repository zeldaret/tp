...
/* 8073DB48  4B C2 46 95 */	bl _savegpr_29
...
/* 8073DB60  3C 60 80 74 */	lis r3, d_a_e_ph__stringBase0@ha /* 0x80741D0C@ha */
/* 8073DB64  38 63 1D 0C */	addi r3, r3, d_a_e_ph__stringBase0@l /* 0x80741D0C@l */
/* 8073DB68  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073DB6C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8073DB70  3C A5 00 02 */	addis r5, r5, 2
/* 8073DB74  38 C0 00 80 */	li r6, 0x80
/* 8073DB78  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8073DB7C  4B 8F E7 71 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8073DB94  3C C0 80 74 */	lis r6, lit_3767@ha /* 0x80741BF4@ha */
/* 8073DB98  C0 66 1B F4 */	lfs f3, lit_3767@l(r6)  /* 0x80741BF4@l */
/* 8073DB9C  3C C0 80 74 */	lis r6, lit_4064@ha /* 0x80741C4C@ha */
/* 8073DBA0  C0 86 1C 4C */	lfs f4, lit_4064@l(r6)  /* 0x80741C4C@l */
/* 8073DBA4  4B 8D 32 CD */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 8073DBC0  4B C2 46 69 */	bl _restgpr_29
