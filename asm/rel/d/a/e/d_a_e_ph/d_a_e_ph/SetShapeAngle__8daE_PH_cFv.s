...
/* 8073E084  3C 60 80 74 */	lis r3, lit_4215@ha /* 0x80741C74@ha */
/* 8073E088  C8 63 1C 74 */	lfd f3, lit_4215@l(r3)  /* 0x80741C74@l */
...
/* 8073E104  4B C2 3F A9 */	bl __cvt_fp2unsigned
...
/* 8073E148  4B B3 2A BD */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8073E15C  3C A0 80 74 */	lis r5, l_HIO@ha /* 0x80741DD0@ha */
/* 8073E160  38 A5 1D D0 */	addi r5, r5, l_HIO@l /* 0x80741DD0@l */
/* 8073E164  C0 45 00 14 */	lfs f2, 0x14(r5)
/* 8073E168  A8 1F 05 B4 */	lha r0, 0x5b4(r31)
/* 8073E16C  54 00 40 2E */	slwi r0, r0, 8
/* 8073E170  3C A0 80 74 */	lis r5, lit_4215@ha /* 0x80741C74@ha */
/* 8073E174  C8 25 1C 74 */	lfd f1, lit_4215@l(r5)  /* 0x80741C74@l */
...
/* 8073E1A0  4B B3 29 F1 */	bl cLib_chaseAngleS__FPsss
...
/* 8073E1C8  4B B3 24 41 */	bl cLib_addCalcAngleS2__FPssss
lbl_8073E1CC:
/* 8073E1CC  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 8073E1D0  3C 80 80 74 */	lis r4, lit_4213@ha /* 0x80741C70@ha */
/* 8073E1D4  C0 44 1C 70 */	lfs f2, lit_4213@l(r4)  /* 0x80741C70@l */
/* 8073E1D8  7C 1E 00 D0 */	neg r0, r30
/* 8073E1DC  3C 80 80 74 */	lis r4, lit_4215@ha /* 0x80741C74@ha */
/* 8073E1E0  C8 24 1C 74 */	lfd f1, lit_4215@l(r4)  /* 0x80741C74@l */
...
/* 8073E210  4B B3 29 81 */	bl cLib_chaseAngleS__FPsss
