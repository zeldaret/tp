...
/* 807F5A80  4B B6 C7 4D */	bl _savegpr_25
...
/* 807F5ABC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807F5AC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807F5AC4  C0 3F 00 00 */	lfs f1, 0(r31)
/* 807F5AC8  C0 5F 00 04 */	lfs f2, 4(r31)
/* 807F5ACC  C0 7F 00 08 */	lfs f3, 8(r31)
/* 807F5AD0  4B B5 0E 19 */	bl PSMTXTrans
/* 807F5AD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807F5AD8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807F5ADC  A8 9E 00 02 */	lha r4, 2(r30)
/* 807F5AE0  4B 81 69 55 */	bl mDoMtx_YrotM__FPA4_fs
/* 807F5AE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807F5AE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807F5AEC  A8 9E 00 00 */	lha r4, 0(r30)
/* 807F5AF0  4B 81 68 AD */	bl mDoMtx_XrotM__FPA4_fs
/* 807F5AF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807F5AF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807F5AFC  7F 64 07 34 */	extsh r4, r27
/* 807F5B00  4B 81 69 CD */	bl mDoMtx_ZrotM__FPA4_fs
/* 807F5B04  C0 39 07 DC */	lfs f1, 0x7dc(r25)
/* 807F5B08  FC 40 08 90 */	fmr f2, f1
/* 807F5B0C  FC 60 08 90 */	fmr f3, f1
/* 807F5B10  4B 81 73 29 */	bl scaleM__14mDoMtx_stack_cFfff
/* 807F5B14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807F5B18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807F5B1C  80 99 07 7C */	lwz r4, 0x77c(r25)
/* 807F5B20  38 84 00 24 */	addi r4, r4, 0x24
/* 807F5B24  4B B5 09 8D */	bl PSMTXCopy
lbl_807F5B28:
...
/* 807F5B48  4B B6 C6 D1 */	bl _restgpr_25
