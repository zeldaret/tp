...
/* 807F2FB4  4B B6 F2 15 */	bl _savegpr_24
/* 807F2FB8  7C 7C 1B 78 */	mr r28, r3
/* 807F2FBC  3C 60 80 7F */	lis r3, lit_3788@ha /* 0x807F7A00@ha */
/* 807F2FC0  3B C3 7A 00 */	addi r30, r3, lit_3788@l /* 0x807F7A00@l */
/* 807F2FC4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807F2FC8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 807F2FCC  38 80 00 02 */	li r4, 2
/* 807F2FD0  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 807F2FD4  38 DC 01 0C */	addi r6, r28, 0x10c
/* 807F2FD8  4B 9B 07 ED */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 807F2FDC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807F2FE0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807F2FE4  80 04 5F 88 */	lwz r0, 0x5f88(r4)
/* 807F2FE8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 807F2FEC  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 807F3004  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807F3008  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 807F300C  80 9D 00 04 */	lwz r4, 4(r29)
/* 807F3010  38 BC 01 0C */	addi r5, r28, 0x10c
/* 807F3014  4B 9B 1D 8D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 807F3028  4B 81 A7 81 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 807F302C  80 7C 05 B8 */	lwz r3, 0x5b8(r28)
/* 807F3030  4B 81 E1 91 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 807F3034  38 7C 08 0C */	addi r3, r28, 0x80c
/* 807F3038  38 80 00 0C */	li r4, 0xc
/* 807F303C  3C A0 80 7F */	lis r5, l_color@ha /* 0x807F7B70@ha */
/* 807F3040  38 A5 7B 70 */	addi r5, r5, l_color@l /* 0x807F7B70@l */
/* 807F3044  38 DC 01 0C */	addi r6, r28, 0x10c
/* 807F3048  4B 82 0F 69 */	bl update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 807F3064  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807F3068  38 03 61 C0 */	addi r0, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807F3080  4B 82 16 B9 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
/* 807F3084  3B 00 00 01 */	li r24, 1
/* 807F3088  3B 60 00 04 */	li r27, 4
/* 807F308C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807F3090  3B 43 CA 54 */	addi r26, r3, g_env_light@l /* 0x8042CA54@l */
lbl_807F3094:
...
/* 807F30B0  4B 9B 1C F1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 807F30B4  7C 7C C8 2E */	lwzx r3, r28, r25
/* 807F30B8  4B 81 AC 0D */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_807F30BC:
...
/* 807F30CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807F30D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807F311C  3C E0 80 45 */	lis r7, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 807F3120  C0 87 0C D0 */	lfs f4, mGroundY__11fopAcM_gc_c@l(r7)  /* 0x80450CD0@l */
/* 807F3124  3C E0 80 3F */	lis r7, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 807F3128  38 E7 1C C4 */	addi r7, r7, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
...
/* 807F313C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 807F3140  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 807F3144  4B 83 B7 CD */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 807F3148  90 7C 06 68 */	stw r3, 0x668(r28)
/* 807F314C  38 60 00 01 */	li r3, 1
/* 807F3150  39 61 00 40 */	addi r11, r1, 0x40
/* 807F3154  4B B6 F0 C1 */	bl _restgpr_24
