...
/* 807F7570  4B B6 AC 45 */	bl _savegpr_19
/* 807F7574  7C 7E 1B 78 */	mr r30, r3
/* 807F7578  7C 9A 23 78 */	mr r26, r4
/* 807F757C  7C BB 2B 78 */	mr r27, r5
/* 807F7580  7C DC 33 78 */	mr r28, r6
/* 807F7584  3C 60 80 7F */	lis r3, cNullVec__6Z2Calc@ha /* 0x807F7B38@ha */
/* 807F7588  3A E3 7B 38 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x807F7B38@l */
/* 807F758C  3C 60 80 7F */	lis r3, lit_3788@ha /* 0x807F7A00@ha */
/* 807F7590  3B E3 7A 00 */	addi r31, r3, lit_3788@l /* 0x807F7A00@l */
/* 807F7594  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807F7598  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807F759C  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 807F75A0  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 807F75A4  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 807F75CC  4B 9B 4F B1 */	bl dKy_darkworld_check__Fv
...
/* 807F75F0  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 807F75F4  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 807F760C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807F7610  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807F7614  4B B4 EE 9D */	bl PSMTXCopy
...
/* 807F762C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807F7630  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807F7634  38 81 00 4C */	addi r4, r1, 0x4c
/* 807F7638  38 A1 00 58 */	addi r5, r1, 0x58
/* 807F763C  4B B4 F7 31 */	bl PSMTXMultVec
/* 807F7640  38 61 00 34 */	addi r3, r1, 0x34
/* 807F7644  38 81 00 58 */	addi r4, r1, 0x58
/* 807F7648  7F 65 DB 78 */	mr r5, r27
/* 807F764C  4B A6 F4 E9 */	bl __mi__4cXyzCFRC3Vec
...
/* 807F7668  4B A7 00 0D */	bl cM_atan2s__Fff
...
/* 807F769C  4B A6 FF D9 */	bl cM_atan2s__Fff
...
/* 807F76B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807F76BC  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807F770C  4B 85 53 85 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 807F7710  7C 79 1B 79 */	or. r25, r3, r3
/* 807F7714  41 82 00 FC */	beq lbl_807F7810
/* 807F7718  38 61 00 40 */	addi r3, r1, 0x40
/* 807F771C  4B B4 FA 1D */	bl PSVECSquareMag
...
/* 807F778C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807F7790  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807F77FC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807F7800  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807F7804:
...
/* 807F7854  4B 85 52 3D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807F7890  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807F7894  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807F7900  4B 85 5B CD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807F7960  4B B6 A8 A1 */	bl _restgpr_19
