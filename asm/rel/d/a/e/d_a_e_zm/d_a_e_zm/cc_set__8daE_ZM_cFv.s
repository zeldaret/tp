...
/* 80831BAC  4B B3 06 2D */	bl _savegpr_28
/* 80831BB0  7C 7E 1B 78 */	mr r30, r3
/* 80831BB4  3C 60 80 83 */	lis r3, lit_3789@ha /* 0x80832CF8@ha */
/* 80831BB8  3B E3 2C F8 */	addi r31, r3, lit_3789@l /* 0x80832CF8@l */
...
lbl_80831BD8:
/* 80831BD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80831BDC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80831BE0  83 A3 5D AC */	lwz r29, 0x5dac(r3)
/* 80831BE4  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 80831BE8  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80831BEC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80831BF0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80831BF4  4B B1 48 BD */	bl PSMTXCopy
...
/* 80831C0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80831C10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80831C14  38 81 00 20 */	addi r4, r1, 0x20
/* 80831C18  38 A1 00 14 */	addi r5, r1, 0x14
/* 80831C1C  4B B1 51 51 */	bl PSMTXMultVec
/* 80831C20  38 61 00 08 */	addi r3, r1, 8
/* 80831C24  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 80831C28  38 A1 00 14 */	addi r5, r1, 0x14
/* 80831C2C  4B A3 4F 09 */	bl __mi__4cXyzCFRC3Vec
...
/* 80831C4C  4B A3 55 05 */	bl atan2sY_XZ__4cXyzCFv
...
/* 80831C60  4B A3 E9 A9 */	bl cLib_addCalcAngleS2__FPssss
lbl_80831C64:
...
/* 80831C84  3C 60 80 83 */	lis r3, l_HIO@ha /* 0x80832F90@ha */
/* 80831C88  3B A3 2F 90 */	addi r29, r3, l_HIO@l /* 0x80832F90@l */
...
/* 80831CD0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80831CD4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80831CD8  4B B1 47 D9 */	bl PSMTXCopy
...
/* 80831CF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80831CF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80831CF8  38 81 00 20 */	addi r4, r1, 0x20
/* 80831CFC  38 A1 00 14 */	addi r5, r1, 0x14
/* 80831D00  4B B1 50 6D */	bl PSMTXMultVec
/* 80831D04  38 7E 0A B4 */	addi r3, r30, 0xab4
/* 80831D08  38 81 00 14 */	addi r4, r1, 0x14
/* 80831D0C  4B A3 D4 D1 */	bl SetC__8cM3dGCylFRC4cXyz
...
/* 80831D20  4B A3 D4 D9 */	bl SetH__8cM3dGCylFf
...
/* 80831D34  4B A3 D4 CD */	bl SetR__8cM3dGCylFf
/* 80831D38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80831D3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80831D40  38 63 23 3C */	addi r3, r3, 0x233c
/* 80831D44  38 9E 09 90 */	addi r4, r30, 0x990
/* 80831D48  4B A3 2E 61 */	bl Set__4cCcSFP8cCcD_Obj
/* 80831D4C  39 61 00 40 */	addi r11, r1, 0x40
/* 80831D50  4B B3 04 D5 */	bl _restgpr_28
