...
/* 804EFC4C  4B E7 25 89 */	bl _savegpr_27
/* 804EFC50  7C 7D 1B 78 */	mr r29, r3
/* 804EFC54  3C 60 80 50 */	lis r3, lit_3777@ha /* 0x804FA6BC@ha */
/* 804EFC58  3B E3 A6 BC */	addi r31, r3, lit_3777@l /* 0x804FA6BC@l */
/* 804EFC5C  80 7D 05 D0 */	lwz r3, 0x5d0(r29)
/* 804EFC60  83 C3 00 04 */	lwz r30, 4(r3)
/* 804EFC64  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804EFC68  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804EFC6C  38 80 00 00 */	li r4, 0
/* 804EFC70  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 804EFC74  38 DD 01 0C */	addi r6, r29, 0x10c
/* 804EFC78  4B CB 3B 4D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 804EFC7C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804EFC80  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804EFC84  80 9E 00 04 */	lwz r4, 4(r30)
/* 804EFC88  38 BD 01 0C */	addi r5, r29, 0x10c
/* 804EFC8C  4B CB 51 15 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804EFCAC  4B B1 DA 2D */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 804EFCCC  4B B1 DA DD */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 804EFD80  4B B2 09 01 */	bl entryDL__14mDoExt_McaMorfFv
/* 804EFD84  88 1D 18 2D */	lbz r0, 0x182d(r29)
/* 804EFD88  7C 00 07 75 */	extsb. r0, r0
/* 804EFD8C  40 82 00 64 */	bne lbl_804EFDF0
/* 804EFD90  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804EFD94  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804EFD98  80 9D 07 60 */	lwz r4, 0x760(r29)
/* 804EFD9C  80 84 00 04 */	lwz r4, 4(r4)
/* 804EFDA0  38 BD 01 0C */	addi r5, r29, 0x10c
/* 804EFDA4  4B CB 4F FD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804EFDA8  80 7D 07 60 */	lwz r3, 0x760(r29)
/* 804EFDAC  80 83 00 04 */	lwz r4, 4(r3)
/* 804EFDB0  7F A3 EB 78 */	mr r3, r29
/* 804EFDB4  4B B2 D6 79 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
...
/* 804EFDCC  4B B1 D9 0D */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 804EFDE4  4B B1 D9 C5 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 804EFDE8  80 7D 07 60 */	lwz r3, 0x760(r29)
/* 804EFDEC  4B B1 DE D9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_804EFDF0:
...
/* 804EFE3C  3C E0 80 50 */	lis r7, l_HIO@ha /* 0x804FAEA4@ha */
/* 804EFE40  38 E7 AE A4 */	addi r7, r7, l_HIO@l /* 0x804FAEA4@l */
...
/* 804EFE64  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 804EFE68  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 804EFE6C  4B B3 EA A5 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 804EFE88  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 804EFE8C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 804EFE90  80 9C 00 04 */	lwz r4, 4(r28)
/* 804EFE94  38 BD 01 0C */	addi r5, r29, 0x10c
/* 804EFE98  4B CB 4F 09 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804EFEAC  4B B1 D8 FD */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 804EFEB0  80 7D 06 28 */	lwz r3, 0x628(r29)
/* 804EFEB4  4B B2 07 CD */	bl entryDL__14mDoExt_McaMorfFv
lbl_804EFEB8:
...
/* 804EFEE8  4B B1 D7 F1 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 804EFF04  4B B1 D8 A5 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_804EFF08:
/* 804EFF08  80 7F 07 7C */	lwz r3, 0x77c(r31)
/* 804EFF0C  4B B2 07 75 */	bl entryDL__14mDoExt_McaMorfFv
...
/* 804EFF54  4B E7 22 CD */	bl _restgpr_27
