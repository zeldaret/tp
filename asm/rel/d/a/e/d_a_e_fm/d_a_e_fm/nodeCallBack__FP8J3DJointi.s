...
/* 804EF8D8  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 804EF8DC  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 804EF900  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804EF904  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804EF908  80 84 00 00 */	lwz r4, 0(r4)
/* 804EF90C  4B E5 6B A5 */	bl PSMTXCopy
/* 804EF910  2C 1F 00 02 */	cmpwi r31, 2
/* 804EF914  40 82 00 38 */	bne lbl_804EF94C
/* 804EF918  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804EF91C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804EF930  4B B1 CB 05 */	bl mDoMtx_YrotM__FPA4_fs
/* 804EF934  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804EF938  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804EF93C  80 63 00 00 */	lwz r3, 0(r3)
/* 804EF940  A8 9E 07 C4 */	lha r4, 0x7c4(r30)
/* 804EF944  4B B1 CB 89 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804EF948  48 00 00 20 */	b lbl_804EF968
lbl_804EF94C:
/* 804EF94C  2C 1F 00 01 */	cmpwi r31, 1
/* 804EF950  40 82 00 18 */	bne lbl_804EF968
/* 804EF954  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804EF958  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804EF95C  80 63 00 00 */	lwz r3, 0(r3)
/* 804EF960  A8 9E 07 C2 */	lha r4, 0x7c2(r30)
/* 804EF964  4B B1 CA 39 */	bl mDoMtx_XrotM__FPA4_fs
lbl_804EF968:
/* 804EF968  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804EF96C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804EF970  80 63 00 00 */	lwz r3, 0(r3)
/* 804EF974  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 804EF978  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 804EF97C  4B E5 6B 35 */	bl PSMTXCopy
lbl_804EF980:
