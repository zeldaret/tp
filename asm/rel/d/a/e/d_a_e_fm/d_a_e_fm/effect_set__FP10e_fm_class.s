...
/* 804F6C08  4B E6 B5 B9 */	bl _savegpr_22
/* 804F6C0C  7C 7F 1B 78 */	mr r31, r3
/* 804F6C10  3C 60 80 50 */	lis r3, cNullVec__6Z2Calc@ha /* 0x804FA950@ha */
/* 804F6C14  3B 43 A9 50 */	addi r26, r3, cNullVec__6Z2Calc@l /* 0x804FA950@l */
/* 804F6C18  3C 60 80 50 */	lis r3, lit_3777@ha /* 0x804FA6BC@ha */
/* 804F6C1C  3B 63 A6 BC */	addi r27, r3, lit_3777@l /* 0x804FA6BC@l */
/* 804F6C20  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x804FAEA4@ha */
/* 804F6C24  38 63 AE A4 */	addi r3, r3, l_HIO@l /* 0x804FAEA4@l */
...
/* 804F6C58  4B B3 6C A5 */	bl dComIfGs_BossLife_public_Set__FSc
...
/* 804F6C6C  4B B3 6C 91 */	bl dComIfGs_BossLife_public_Set__FSc
...
lbl_804F6C8C:
/* 804F6C8C  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x804FAEA4@ha */
/* 804F6C90  38 63 AE A4 */	addi r3, r3, l_HIO@l /* 0x804FAEA4@l */
...
/* 804F6CAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804F6CB0  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804F6D04  4B B5 67 C9 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804F6D18  4B B5 4C 01 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 804F6D3C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804F6D40  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804F6D44  80 84 00 00 */	lwz r4, 0(r4)
/* 804F6D48  4B E4 F7 69 */	bl PSMTXCopy
...
/* 804F6D5C  4B D7 A1 49 */	bl MtxScale__FfffUc
/* 804F6D60  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804F6D64  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804F6D78  4B D8 9A 91 */	bl func_80280808
...
/* 804F6DE8  4B D7 8C 55 */	bl cLib_addCalc2__FPffff
...
/* 804F6E54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804F6E58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804F6E5C  3F 23 00 02 */	addis r25, r3, 2
/* 804F6E60  3C 60 80 50 */	lis r3, d_a_e_fm__stringBase0@ha /* 0x804FA948@ha */
/* 804F6E64  3A E3 A9 48 */	addi r23, r3, d_a_e_fm__stringBase0@l /* 0x804FA948@l */
...
/* 804F6E84  4B B4 54 69 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804F6EAC  4B B1 94 D1 */	bl setAnm__14mDoExt_McaMorfFP15J3DAnmTransformiffffPv
...
/* 804F6EE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804F6EEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804F6F34  4B B5 5B 5D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
lbl_804F6F58:
/* 804F6F58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804F6F5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804F6F74  4B E4 F9 75 */	bl PSMTXTrans
/* 804F6F78  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x804FAEA4@ha */
/* 804F6F7C  38 63 AE A4 */	addi r3, r3, l_HIO@l /* 0x804FAEA4@l */
/* 804F6F80  C0 23 00 30 */	lfs f1, 0x30(r3)
/* 804F6F84  FC 40 08 90 */	fmr f2, f1
/* 804F6F88  FC 60 08 90 */	fmr f3, f1
/* 804F6F8C  4B B1 5E AD */	bl scaleM__14mDoMtx_stack_cFfff
/* 804F6F90  3B 20 00 00 */	li r25, 0
/* 804F6F94  3B 00 00 00 */	li r24, 0
/* 804F6F98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804F6F9C  3A C3 D4 70 */	addi r22, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
lbl_804F6FA0:
...
/* 804F6FB4  4B E4 F4 FD */	bl PSMTXCopy
...
/* 804F6FDC  4B D7 8A 61 */	bl cLib_addCalc2__FPffff
lbl_804F6FE0:
...
/* 804F6FF0  4B B1 95 D9 */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 804F6FF4  80 77 07 84 */	lwz r3, 0x784(r23)
/* 804F6FF8  4B B1 64 31 */	bl play__14mDoExt_baseAnmFv
/* 804F6FFC  2C 19 00 01 */	cmpwi r25, 1
/* 804F7000  40 82 00 0C */	bne lbl_804F700C
/* 804F7004  80 7F 07 8C */	lwz r3, 0x78c(r31)
/* 804F7008  4B B1 64 21 */	bl play__14mDoExt_baseAnmFv
lbl_804F700C:
/* 804F700C  80 77 07 7C */	lwz r3, 0x77c(r23)
/* 804F7010  4B B1 96 9D */	bl modelCalc__14mDoExt_McaMorfFv
...
/* 804F7030  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x804FAEA4@ha */
/* 804F7034  38 63 AE A4 */	addi r3, r3, l_HIO@l /* 0x804FAEA4@l */
/* 804F7038  C0 03 00 28 */	lfs f0, 0x28(r3)
/* 804F703C  EC 00 00 B2 */	fmuls f0, f0, f2
/* 804F7040  EC 01 00 32 */	fmuls f0, f1, f0
/* 804F7044  3C 60 80 50 */	lis r3, fire_range@ha /* 0x804FAF78@ha */
/* 804F7048  D0 03 AF 78 */	stfs f0, fire_range@l(r3)  /* 0x804FAF78@l */
...
/* 804F7060  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804F7064  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804F7068  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 804F706C  38 80 00 1F */	li r4, 0x1f
/* 804F7070  4B B7 8D 25 */	bl StopQuake__12dVibration_cFi
lbl_804F7074:
/* 804F7074  7F E3 FB 78 */	mr r3, r31
/* 804F7078  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804F707C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804F70B4  4B D7 85 95 */	bl SetC__8cM3dGSphFRC4cXyz
/* 804F70B8  38 7F 17 F0 */	addi r3, r31, 0x17f0
/* 804F70BC  3C 80 80 50 */	lis r4, fire_range@ha /* 0x804FAF78@ha */
/* 804F70C0  C0 24 AF 78 */	lfs f1, fire_range@l(r4)  /* 0x804FAF78@l */
/* 804F70C4  4B D7 86 45 */	bl SetR__8cM3dGSphFf
/* 804F70C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804F70CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804F70D0  38 63 23 3C */	addi r3, r3, 0x233c
/* 804F70D4  38 9F 16 CC */	addi r4, r31, 0x16cc
/* 804F70D8  4B D6 DA D1 */	bl Set__4cCcSFP8cCcD_Obj
/* 804F70DC  38 00 00 02 */	li r0, 2
/* 804F70E0  98 1F 07 B6 */	stb r0, 0x7b6(r31)
/* 804F70E4  3C 60 80 4F */	lis r3, s_hasira_eff_sub__FPvPv@ha /* 0x804EF3CC@ha */
/* 804F70E8  38 63 F3 CC */	addi r3, r3, s_hasira_eff_sub__FPvPv@l /* 0x804EF3CC@l */
/* 804F70EC  7F E4 FB 78 */	mr r4, r31
/* 804F70F0  4B B2 A2 49 */	bl fpcEx_Search__FPFPvPv_PvPv
lbl_804F70F4:
...
/* 804F7128  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x804FAEA4@ha */
/* 804F712C  38 A3 AE A4 */	addi r5, r3, l_HIO@l /* 0x804FAEA4@l */
...
/* 804F7188  4B CB 2B D9 */	bl dKy_BossLight_set__FP4cXyzP8_GXColorfUc
lbl_804F718C:
...
/* 804F71BC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804F71C0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804F723C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804F7240  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804F7244  80 84 00 00 */	lwz r4, 0(r4)
/* 804F7248  4B E4 F2 69 */	bl PSMTXCopy
...
/* 804F7264  4B D7 9C 89 */	bl MtxPosition__FP4cXyzP4cXyz
/* 804F7268  80 76 00 84 */	lwz r3, 0x84(r22)
/* 804F726C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 804F7270  38 63 04 B0 */	addi r3, r3, 0x4b0
/* 804F7274  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804F7278  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804F727C  80 84 00 00 */	lwz r4, 0(r4)
/* 804F7280  4B E4 F2 31 */	bl PSMTXCopy
/* 804F7284  38 61 00 28 */	addi r3, r1, 0x28
/* 804F7288  38 9F 07 D4 */	addi r4, r31, 0x7d4
/* 804F728C  4B D7 9C 61 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804F72BC  4B E6 AF 51 */	bl _restgpr_22
