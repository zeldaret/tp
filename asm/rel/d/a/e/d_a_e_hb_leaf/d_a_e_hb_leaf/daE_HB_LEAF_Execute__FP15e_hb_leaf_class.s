...
/* 806DFFD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806DFFD8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806DFFDC  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 806DFFE0  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 806DFFE4  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 806DFFE8  4B C6 69 00 */	b PSMTXTrans
/* 806DFFEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806DFFF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806DFFF4  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806DFFF8  4B 92 C4 3C */	b mDoMtx_YrotM__FPA4_fs
/* 806DFFFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806E0000  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806E0004  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 806E0008  4B 92 C3 94 */	b mDoMtx_XrotM__FPA4_fs
/* 806E000C  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 806E0010  80 83 00 04 */	lwz r4, 4(r3)
/* 806E0014  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806E0018  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806E001C  38 84 00 24 */	addi r4, r4, 0x24
/* 806E0020  4B C6 64 90 */	b PSMTXCopy
/* 806E0024  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 806E0028  4B 93 06 84 */	b modelCalc__14mDoExt_McaMorfFv
/* 806E002C  80 1F 05 BC */	lwz r0, 0x5bc(r31)
/* 806E0030  90 01 00 08 */	stw r0, 8(r1)
/* 806E0034  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 806E0038  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 806E003C  38 81 00 08 */	addi r4, r1, 8
/* 806E0040  4B 93 97 B8 */	b fopAcIt_Judge__FPFPvPv_PvPv
