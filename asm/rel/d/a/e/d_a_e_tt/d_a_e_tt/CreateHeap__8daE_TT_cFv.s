...
/* 807C122C  4B BA 0F B1 */	bl _savegpr_29
...
/* 807C1248  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C124C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807C1250  3C A5 00 02 */	addis r5, r5, 2
/* 807C1254  38 C0 00 80 */	li r6, 0x80
/* 807C1258  38 A5 C2 F8 */	addi r5, r5, -15624
/* 807C125C  4B 87 B0 91 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807C1270  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C1274  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807C1278  3C A5 00 02 */	addis r5, r5, 2
/* 807C127C  38 C0 00 80 */	li r6, 0x80
/* 807C1280  38 A5 C2 F8 */	addi r5, r5, -15624
/* 807C1284  4B 87 B0 69 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 807C1288  7C 7D 1B 78 */	mr r29, r3
lbl_807C128C:
/* 807C128C  38 60 00 58 */	li r3, 0x58
/* 807C1290  4B B0 D9 BD */	bl __nw__FUl
/* 807C1294  7C 7E 1B 79 */	or. r30, r3, r3
/* 807C1298  41 82 00 74 */	beq lbl_807C130C
/* 807C129C  3C 60 80 7C */	lis r3, d_a_e_tt__stringBase0@ha /* 0x807C20B0@ha */
/* 807C12A0  38 63 20 B0 */	addi r3, r3, d_a_e_tt__stringBase0@l /* 0x807C20B0@l */
/* 807C12A4  38 80 00 0E */	li r4, 0xe
/* 807C12A8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C12AC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807C12B0  3C A5 00 02 */	addis r5, r5, 2
/* 807C12B4  38 C0 00 80 */	li r6, 0x80
/* 807C12B8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 807C12BC  4B 87 B0 31 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807C12F4  3D 20 80 7C */	lis r9, lit_3910@ha /* 0x807C1FC0@ha */
/* 807C12F8  C0 29 1F C0 */	lfs f1, lit_3910@l(r9)  /* 0x807C1FC0@l */
/* 807C12FC  39 20 00 00 */	li r9, 0
/* 807C1300  39 40 FF FF */	li r10, -1
/* 807C1304  4B 84 F4 CD */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 807C1344  3C 60 80 7C */	lis r3, JointCallBack__8daE_TT_cFP8J3DJointi@ha /* 0x807BD8E0@ha */
/* 807C1348  38 83 D8 E0 */	addi r4, r3, JointCallBack__8daE_TT_cFP8J3DJointi@l /* 0x807BD8E0@l */
...
/* 807C1380  4B BA 0E A9 */	bl _restgpr_29
