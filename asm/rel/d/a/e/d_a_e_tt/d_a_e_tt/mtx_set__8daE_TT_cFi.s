...
/* 807C0E2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807C0E30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807C0E48  4B B8 5A A1 */	bl PSMTXTrans
/* 807C0E4C  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 807C0E50  4B 84 C0 F5 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 807C0E54  3C 60 80 7C */	lis r3, l_HIO@ha /* 0x807C23EC@ha */
/* 807C0E58  38 63 23 EC */	addi r3, r3, l_HIO@l /* 0x807C23EC@l */
/* 807C0E5C  C0 23 00 08 */	lfs f1, 8(r3)
/* 807C0E60  FC 40 08 90 */	fmr f2, f1
/* 807C0E64  FC 60 08 90 */	fmr f3, f1
/* 807C0E68  4B 84 BF D1 */	bl scaleM__14mDoMtx_stack_cFfff
/* 807C0E6C  80 7E 05 BC */	lwz r3, 0x5bc(r30)
/* 807C0E70  80 83 00 04 */	lwz r4, 4(r3)
/* 807C0E74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807C0E78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807C0E7C  38 84 00 24 */	addi r4, r4, 0x24
/* 807C0E80  4B B8 56 31 */	bl PSMTXCopy
...
/* 807C0EA8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C0EAC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807C0EB0  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 807C0EB4  4B 85 99 2D */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 807C0EB8  3C 60 80 7C */	lis r3, lit_5507@ha /* 0x807C2098@ha */
/* 807C0EBC  C0 03 20 98 */	lfs f0, lit_5507@l(r3)  /* 0x807C2098@l */
/* 807C0EC0  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 807C0EC4  41 81 00 0C */	bgt lbl_807C0ED0
lbl_807C0EC8:
/* 807C0EC8  80 7E 05 BC */	lwz r3, 0x5bc(r30)
/* 807C0ECC  4B 85 03 21 */	bl modelCalc__16mDoExt_McaMorfSOFv
lbl_807C0ED0:
