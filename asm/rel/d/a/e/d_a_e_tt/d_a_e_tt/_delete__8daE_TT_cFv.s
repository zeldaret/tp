...
/* 807C1178  3C 60 80 7C */	lis r3, m_attack_tt@ha
/* 807C117C  84 03 24 04 */	lwzu r0, m_attack_tt@l(r3)
...
/* 807C1198  4B 86 BE 70 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 807C119C  38 7F 05 B4 */	addi r3, r31, 0x5b4
/* 807C11A0  3C 80 80 7C */	lis r4, stringBase0@ha
/* 807C11A4  38 84 20 B0 */	addi r4, r4, stringBase0@l
/* 807C11A8  4B 86 BE 60 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 807C11BC  3C 60 80 7C */	lis r3, struct_807C23DC+0x1@ha
/* 807C11C0  98 03 23 DD */	stb r0, struct_807C23DC+0x1@l(r3)
lbl_807C11C4:
