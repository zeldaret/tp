...
/* 807BE718  4B BA 3A C5 */	bl _savegpr_29
/* 807BE71C  7C 7E 1B 78 */	mr r30, r3
/* 807BE720  3C 60 80 7C */	lis r3, lit_1109@ha /* 0x807C23A0@ha */
/* 807BE724  3B E3 23 A0 */	addi r31, r3, lit_1109@l /* 0x807C23A0@l */
/* 807BE728  88 1F 00 C8 */	lbz r0, 0xc8(r31)
/* 807BE72C  7C 00 07 75 */	extsb. r0, r0
/* 807BE730  40 82 00 34 */	bne lbl_807BE764
/* 807BE734  3C 60 80 7C */	lis r3, lit_3929@ha /* 0x807C1FE4@ha */
/* 807BE738  C0 03 1F E4 */	lfs f0, lit_3929@l(r3)  /* 0x807C1FE4@l */
...
/* 807BE74C  3C 80 80 7C */	lis r4, __dt__4cXyzFv@ha /* 0x807C1F68@ha */
/* 807BE750  38 84 1F 68 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807C1F68@l */
...
/* 807BE770  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807BE774  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807BE7C0  3D 60 80 7C */	lis r11, lit_3910@ha /* 0x807C1FC0@ha */
/* 807BE7C4  C0 2B 1F C0 */	lfs f1, lit_3910@l(r11)  /* 0x807C1FC0@l */
/* 807BE7C8  4B 88 ED 05 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807BE818  3D 60 80 7C */	lis r11, lit_3910@ha /* 0x807C1FC0@ha */
/* 807BE81C  C0 2B 1F C0 */	lfs f1, lit_3910@l(r11)  /* 0x807C1FC0@l */
/* 807BE820  4B 88 EC AD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 807BE824  90 7E 0A C0 */	stw r3, 0xac0(r30)
/* 807BE828  48 00 00 BC */	b lbl_807BE8E4
lbl_807BE82C:
/* 807BE82C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807BE830  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807BE87C  3D 60 80 7C */	lis r11, lit_3910@ha /* 0x807C1FC0@ha */
/* 807BE880  C0 2B 1F C0 */	lfs f1, lit_3910@l(r11)  /* 0x807C1FC0@l */
/* 807BE884  4B 88 EC 49 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807BE8D4  3D 60 80 7C */	lis r11, lit_3910@ha /* 0x807C1FC0@ha */
/* 807BE8D8  C0 2B 1F C0 */	lfs f1, lit_3910@l(r11)  /* 0x807C1FC0@l */
/* 807BE8DC  4B 88 EB F1 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 807BE8E0  90 7E 0A C0 */	stw r3, 0xac0(r30)
lbl_807BE8E4:
/* 807BE8E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807BE8E8  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807BE8EC  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)
/* 807BE8F0  38 63 02 10 */	addi r3, r3, 0x210
/* 807BE8F4  80 9E 0A BC */	lwz r4, 0xabc(r30)
/* 807BE8F8  4B 88 D0 21 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 807BE924  4B AC 1E E5 */	bl func_80280808
...
/* 807BE944  4B 88 CF D5 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 807BE970  4B AC 1E 99 */	bl func_80280808
...
/* 807BE988  4B BA 38 A1 */	bl _restgpr_29
