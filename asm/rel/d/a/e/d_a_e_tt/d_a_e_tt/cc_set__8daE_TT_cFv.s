...
/* 807C0EF8  4B BA 12 E1 */	bl _savegpr_28
/* 807C0EFC  7C 7F 1B 78 */	mr r31, r3
/* 807C0F00  3C 60 80 7C */	lis r3, lit_3908@ha /* 0x807C1FB8@ha */
/* 807C0F04  3B A3 1F B8 */	addi r29, r3, lit_3908@l /* 0x807C1FB8@l */
...
/* 807C0F1C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807C0F20  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807C0F24  4B B8 55 8D */	bl PSMTXCopy
/* 807C0F28  C0 3D 00 78 */	lfs f1, 0x78(r29)
/* 807C0F2C  C0 5D 00 60 */	lfs f2, 0x60(r29)
/* 807C0F30  C0 7D 00 04 */	lfs f3, 4(r29)
/* 807C0F34  4B 84 BE 69 */	bl transM__14mDoMtx_stack_cFfff
/* 807C0F38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807C0F3C  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807C0FCC  4B AA E6 7D */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 807C0FE4  4B AA E7 25 */	bl SetR__8cM3dGSphFf
/* 807C0FE8  48 00 00 10 */	b lbl_807C0FF8
lbl_807C0FEC:
/* 807C0FEC  38 7F 0A 74 */	addi r3, r31, 0xa74
/* 807C0FF0  C0 3D 00 E4 */	lfs f1, 0xe4(r29)
/* 807C0FF4  4B AA E7 15 */	bl SetR__8cM3dGSphFf
lbl_807C0FF8:
/* 807C0FF8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C0FFC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807C1000  38 63 23 3C */	addi r3, r3, 0x233c
/* 807C1004  38 9F 09 50 */	addi r4, r31, 0x950
/* 807C1008  4B AA 3B A1 */	bl Set__4cCcSFP8cCcD_Obj
lbl_807C100C:
/* 807C100C  39 61 00 30 */	addi r11, r1, 0x30
/* 807C1010  4B BA 12 15 */	bl _restgpr_28
