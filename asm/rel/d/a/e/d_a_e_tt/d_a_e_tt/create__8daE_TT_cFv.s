...
/* 807C13C4  4B BA 0E 15 */	bl _savegpr_28
/* 807C13C8  7C 7D 1B 78 */	mr r29, r3
/* 807C13CC  3C 80 80 7C */	lis r4, lit_3908@ha /* 0x807C1FB8@ha */
/* 807C13D0  3B E4 1F B8 */	addi r31, r4, lit_3908@l /* 0x807C1FB8@l */
...
/* 807C13EC  4B 85 77 79 */	bl __ct__10fopAc_ac_cFv
/* 807C13F0  38 7E 05 C0 */	addi r3, r30, 0x5c0
/* 807C13F4  4B AF FB 71 */	bl __ct__15Z2CreatureEnemyFv
/* 807C13F8  3B 9E 06 64 */	addi r28, r30, 0x664
/* 807C13FC  7F 83 E3 78 */	mr r3, r28
/* 807C1400  4B 8B 61 7D */	bl __ct__11dBgS_GndChkFv
/* 807C1404  3C 60 80 7C */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 0x807C235C@ha */
/* 807C1408  38 63 23 5C */	addi r3, r3, __vt__14dBgS_ObjGndChk@l /* 0x807C235C@l */
...
/* 807C142C  4B 8B 7A 3D */	bl SetObj__16dBgS_PolyPassChkFv
/* 807C1430  3C 60 80 3B */	lis r3, __vt__18dBgS_ObjGndChk_All@ha /* 0x803AB6E8@ha */
/* 807C1434  38 63 B6 E8 */	addi r3, r3, __vt__18dBgS_ObjGndChk_All@l /* 0x803AB6E8@l */
...
/* 807C1464  4B 8B 4A 49 */	bl __ct__12dBgS_AcchCirFv
/* 807C1468  3B 9E 07 3C */	addi r28, r30, 0x73c
/* 807C146C  7F 83 E3 78 */	mr r3, r28
/* 807C1470  4B 8B 4C 31 */	bl __ct__9dBgS_AcchFv
/* 807C1474  3C 60 80 7C */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x807C2338@ha */
/* 807C1478  38 63 23 38 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x807C2338@l */
...
/* 807C1494  4B 8B 79 D5 */	bl SetObj__16dBgS_PolyPassChkFv
/* 807C1498  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 807C149C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 807C14A0  90 1E 09 2C */	stw r0, 0x92c(r30)
/* 807C14A4  38 7E 09 30 */	addi r3, r30, 0x930
/* 807C14A8  4B 8C 22 B9 */	bl __ct__10dCcD_GSttsFv
/* 807C14AC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 807C14B0  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 807C14C8  4B 8C 25 61 */	bl __ct__12dCcD_GObjInfFv
/* 807C14CC  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 807C14D0  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 807C14D4  90 1C 01 20 */	stw r0, 0x120(r28)
/* 807C14D8  3C 60 80 7C */	lis r3, __vt__8cM3dGAab@ha /* 0x807C232C@ha */
/* 807C14DC  38 03 23 2C */	addi r0, r3, __vt__8cM3dGAab@l /* 0x807C232C@l */
/* 807C14E0  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 807C14E4  3C 60 80 7C */	lis r3, __vt__8cM3dGSph@ha /* 0x807C2320@ha */
/* 807C14E8  38 03 23 20 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x807C2320@l */
/* 807C14EC  90 1C 01 34 */	stw r0, 0x134(r28)
/* 807C14F0  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 807C14F4  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 807C14F8  90 7C 01 20 */	stw r3, 0x120(r28)
/* 807C14FC  38 03 00 58 */	addi r0, r3, 0x58
/* 807C1500  90 1C 01 34 */	stw r0, 0x134(r28)
/* 807C1504  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 807C1508  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 807C1540  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807C1544  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807C1548  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 807C154C  7C 05 07 74 */	extsb r5, r0
/* 807C1550  4B 87 3E 11 */	bl isSwitch__10dSv_info_cCFii
...
/* 807C1590  3C 60 80 7C */	lis r3, d_a_e_tt__stringBase0@ha /* 0x807C20B0@ha */
/* 807C1594  38 63 20 B0 */	addi r3, r3, d_a_e_tt__stringBase0@l /* 0x807C20B0@l */
/* 807C1598  38 03 00 05 */	addi r0, r3, 5
/* 807C159C  90 1D 06 E4 */	stw r0, 0x6e4(r29)
/* 807C15A0  48 00 00 14 */	b lbl_807C15B4
lbl_807C15A4:
/* 807C15A4  3C 60 80 7C */	lis r3, d_a_e_tt__stringBase0@ha /* 0x807C20B0@ha */
/* 807C15A8  38 63 20 B0 */	addi r3, r3, d_a_e_tt__stringBase0@l /* 0x807C20B0@l */
...
/* 807C161C  4B 86 B8 A1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 807C1630  3C 80 80 7C */	lis r4, d_a_e_tt__stringBase0@ha /* 0x807C20B0@ha */
/* 807C1634  38 84 20 B0 */	addi r4, r4, d_a_e_tt__stringBase0@l /* 0x807C20B0@l */
/* 807C1638  4B 86 B8 85 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 807C164C  3C 80 80 7C */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x807C1394@ha */
/* 807C1650  38 84 13 94 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x807C1394@l */
/* 807C1654  38 A0 16 00 */	li r5, 0x1600
/* 807C1658  4B 85 8E 59 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_807C166C:
/* 807C166C  3C 60 80 7C */	lis r3, struct_807C23DC+0x1@ha /* 0x807C23DD@ha */
/* 807C1670  8C 03 23 DD */	lbzu r0, struct_807C23DC+0x1@l(r3)  /* 0x807C23DD@l */
...
/* 807C168C  3C 60 80 7C */	lis r3, l_HIO@ha /* 0x807C23EC@ha */
/* 807C1690  38 63 23 EC */	addi r3, r3, l_HIO@l /* 0x807C23EC@l */
...
/* 807C16C0  4B 85 8E 69 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 807C16D4  4B 85 8E 65 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 807C1700  4B 8B 4B 49 */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 807C1704  38 7D 06 FC */	addi r3, r29, 0x6fc
/* 807C1708  C0 3F 00 78 */	lfs f1, 0x78(r31)
/* 807C170C  C0 5F 00 00 */	lfs f2, 0(r31)
/* 807C1710  4B 8B 48 49 */	bl SetWall__12dBgS_AcchCirFff
...
/* 807C1744  4B 8C 21 1D */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 807C1748  38 7D 09 50 */	addi r3, r29, 0x950
/* 807C174C  3C 80 80 7C */	lis r4, data_807C2100@ha /* 0x807C2100@ha */
/* 807C1750  38 84 21 00 */	addi r4, r4, data_807C2100@l /* 0x807C2100@l */
/* 807C1754  4B 8C 32 E1 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807C1774  4B AF F9 21 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 807C1778  38 7D 05 C0 */	addi r3, r29, 0x5c0
/* 807C177C  3C 80 80 7C */	lis r4, d_a_e_tt__stringBase0@ha /* 0x807C20B0@ha */
/* 807C1780  38 84 20 B0 */	addi r4, r4, d_a_e_tt__stringBase0@l /* 0x807C20B0@l */
/* 807C1784  38 84 00 11 */	addi r4, r4, 0x11
/* 807C1788  4B B0 04 09 */	bl setEnemyName__15Z2CreatureEnemyFPCc
...
/* 807C17E8  4B BA 0A 3D */	bl _restgpr_28
