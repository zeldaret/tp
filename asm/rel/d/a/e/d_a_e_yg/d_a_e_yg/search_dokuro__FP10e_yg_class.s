...
/* 807F8B04  4B B6 96 C9 */	bl _savegpr_25
/* 807F8B08  7C 64 1B 78 */	mr r4, r3
/* 807F8B0C  3C 60 80 80 */	lis r3, lit_3801@ha /* 0x807FCCB4@ha */
/* 807F8B10  3B E3 CC B4 */	addi r31, r3, lit_3801@l /* 0x807FCCB4@l */
/* 807F8B14  7C 9E 23 78 */	mr r30, r4
/* 807F8B18  38 C0 00 00 */	li r6, 0
/* 807F8B1C  3C 60 80 80 */	lis r3, target_info_count@ha /* 0x807FD124@ha */
/* 807F8B20  90 C3 D1 24 */	stw r6, target_info_count@l(r3)  /* 0x807FD124@l */
/* 807F8B24  7C C3 33 78 */	mr r3, r6
/* 807F8B28  3C A0 80 80 */	lis r5, target_info@ha /* 0x807FD0D4@ha */
/* 807F8B2C  38 A5 D0 D4 */	addi r5, r5, target_info@l /* 0x807FD0D4@l */
...
/* 807F8B44  3C 60 80 80 */	lis r3, s_d_sub__FPvPv@ha /* 0x807F8A68@ha */
/* 807F8B48  38 63 8A 68 */	addi r3, r3, s_d_sub__FPvPv@l /* 0x807F8A68@l */
/* 807F8B4C  4B 82 87 ED */	bl fpcEx_Search__FPFPvPv_PvPv
/* 807F8B50  C3 DF 00 00 */	lfs f30, 0(r31)
/* 807F8B54  3C 60 80 80 */	lis r3, target_info_count@ha /* 0x807FD124@ha */
/* 807F8B58  3B 63 D1 24 */	addi r27, r3, target_info_count@l /* 0x807FD124@l */
...
/* 807F8B84  4B A6 DF B1 */	bl __mi__4cXyzCFRC3Vec
...
/* 807F8BCC  4B 82 42 31 */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
...
lbl_807F8C10:
/* 807F8C10  3C 60 80 80 */	lis r3, target_info@ha /* 0x807FD0D4@ha */
/* 807F8C14  3B A3 D0 D4 */	addi r29, r3, target_info@l /* 0x807FD0D4@l */
...
/* 807F8C4C  4B B6 95 CD */	bl _restgpr_25
