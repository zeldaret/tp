...
/* 807FBA98  4B B6 67 35 */	bl _savegpr_25
/* 807FBA9C  7C 7F 1B 78 */	mr r31, r3
/* 807FBAA0  3C 80 80 80 */	lis r4, lit_3801@ha /* 0x807FCCB4@ha */
/* 807FBAA4  3B C4 CC B4 */	addi r30, r4, lit_3801@l /* 0x807FCCB4@l */
...
/* 807FBAC0  4B 81 D0 A5 */	bl __ct__10fopAc_ac_cFv
/* 807FBAC4  38 7A 05 D8 */	addi r3, r26, 0x5d8
/* 807FBAC8  4B AC 54 9D */	bl __ct__15Z2CreatureEnemyFv
/* 807FBACC  38 7A 06 98 */	addi r3, r26, 0x698
/* 807FBAD0  4B 87 A3 DD */	bl __ct__12dBgS_AcchCirFv
/* 807FBAD4  3B 3A 06 D8 */	addi r25, r26, 0x6d8
/* 807FBAD8  7F 23 CB 78 */	mr r3, r25
/* 807FBADC  4B 87 A5 C5 */	bl __ct__9dBgS_AcchFv
/* 807FBAE0  3C 60 80 80 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 0x807FCFE8@ha */
/* 807FBAE4  38 63 CF E8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 0x807FCFE8@l */
...
/* 807FBB00  4B 87 D3 69 */	bl SetObj__16dBgS_PolyPassChkFv
/* 807FBB04  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 807FBB08  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 807FBB0C  90 1A 08 CC */	stw r0, 0x8cc(r26)
/* 807FBB10  38 7A 08 D0 */	addi r3, r26, 0x8d0
/* 807FBB14  4B 88 7C 4D */	bl __ct__10dCcD_GSttsFv
/* 807FBB18  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 807FBB1C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 807FBB34  4B 88 7E F5 */	bl __ct__12dCcD_GObjInfFv
/* 807FBB38  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 807FBB3C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 807FBB40  90 19 01 20 */	stw r0, 0x120(r25)
/* 807FBB44  3C 60 80 80 */	lis r3, __vt__8cM3dGAab@ha /* 0x807FCFDC@ha */
/* 807FBB48  38 03 CF DC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x807FCFDC@l */
/* 807FBB4C  90 19 01 1C */	stw r0, 0x11c(r25)
/* 807FBB50  3C 60 80 80 */	lis r3, __vt__8cM3dGSph@ha /* 0x807FCFD0@ha */
/* 807FBB54  38 03 CF D0 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x807FCFD0@l */
/* 807FBB58  90 19 01 34 */	stw r0, 0x134(r25)
/* 807FBB5C  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 807FBB60  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 807FBB64  90 79 01 20 */	stw r3, 0x120(r25)
/* 807FBB68  3B A3 00 58 */	addi r29, r3, 0x58
/* 807FBB6C  93 B9 01 34 */	stw r29, 0x134(r25)
/* 807FBB70  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 807FBB74  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 807FBB94  4B 88 7E 95 */	bl __ct__12dCcD_GObjInfFv
/* 807FBB98  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 807FBB9C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 807FBBA0  90 19 01 20 */	stw r0, 0x120(r25)
/* 807FBBA4  3C 60 80 80 */	lis r3, __vt__8cM3dGAab@ha /* 0x807FCFDC@ha */
/* 807FBBA8  38 03 CF DC */	addi r0, r3, __vt__8cM3dGAab@l /* 0x807FCFDC@l */
/* 807FBBAC  90 19 01 1C */	stw r0, 0x11c(r25)
/* 807FBBB0  3C 60 80 80 */	lis r3, __vt__8cM3dGSph@ha /* 0x807FCFD0@ha */
/* 807FBBB4  38 03 CF D0 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x807FCFD0@l */
/* 807FBBB8  90 19 01 34 */	stw r0, 0x134(r25)
/* 807FBBBC  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 807FBBC0  38 03 35 40 */	addi r0, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 807FBBC4  90 19 01 20 */	stw r0, 0x120(r25)
/* 807FBBC8  93 B9 01 34 */	stw r29, 0x134(r25)
/* 807FBBCC  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 807FBBD0  38 03 BF C0 */	addi r0, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
...
/* 807FBBE4  3C 80 80 80 */	lis r4, __ct__7yg_ke_sFv@ha /* 0x807FBEEC@ha */
/* 807FBBE8  38 84 BE EC */	addi r4, r4, __ct__7yg_ke_sFv@l /* 0x807FBEEC@l */
/* 807FBBEC  3C A0 80 80 */	lis r5, __dt__7yg_ke_sFv@ha /* 0x807FBE70@ha */
/* 807FBBF0  38 A5 BE 70 */	addi r5, r5, __dt__7yg_ke_sFv@l /* 0x807FBE70@l */
/* 807FBBF4  38 C0 00 FC */	li r6, 0xfc
/* 807FBBF8  38 E0 00 0D */	li r7, 0xd
/* 807FBBFC  4B B6 61 65 */	bl __construct_array
/* 807FBC00  3C 60 80 80 */	lis r3, __vt__18mDoExt_3DlineMat_c@ha /* 0x807FCFBC@ha */
/* 807FBC04  38 03 CF BC */	addi r0, r3, __vt__18mDoExt_3DlineMat_c@l /* 0x807FCFBC@l */
/* 807FBC08  90 1A 18 80 */	stw r0, 0x1880(r26)
/* 807FBC0C  3C 60 80 3A */	lis r3, __vt__19mDoExt_3DlineMat0_c@ha /* 0x803A325C@ha */
/* 807FBC10  38 03 32 5C */	addi r0, r3, __vt__19mDoExt_3DlineMat0_c@l /* 0x803A325C@l */
...
/* 807FBC28  3C 80 80 80 */	lis r4, d_a_e_yg__stringBase0@ha /* 0x807FCDF0@ha */
/* 807FBC2C  38 84 CD F0 */	addi r4, r4, d_a_e_yg__stringBase0@l /* 0x807FCDF0@l */
/* 807FBC30  4B 83 12 8D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 807FBC50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807FBC54  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807FBC58  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 807FBC5C  7C 05 07 74 */	extsb r5, r0
/* 807FBC60  4B 83 97 01 */	bl isSwitch__10dSv_info_cCFii
...
/* 807FBC98  3C 80 80 80 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x807FB978@ha */
/* 807FBC9C  38 84 B9 78 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x807FB978@l */
/* 807FBCA0  38 A0 3C 60 */	li r5, 0x3c60
/* 807FBCA4  4B 81 E8 0D */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_807FBCB8:
/* 807FBCB8  3C 60 80 80 */	lis r3, struct_807FD05C+0x1@ha /* 0x807FD05D@ha */
/* 807FBCBC  8C 03 D0 5D */	lbzu r0, struct_807FD05C+0x1@l(r3)  /* 0x807FD05D@l */
...
/* 807FBCD8  3C 60 80 80 */	lis r3, l_HIO@ha /* 0x807FD06C@ha */
/* 807FBCDC  38 63 D0 6C */	addi r3, r3, l_HIO@l /* 0x807FD06C@l */
...
/* 807FBD10  4B 88 7B 51 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 807FBD14  38 7F 08 F0 */	addi r3, r31, 0x8f0
/* 807FBD18  3C 80 80 80 */	lis r4, cc_sph_src@ha /* 0x807FCEC8@ha */
/* 807FBD1C  38 84 CE C8 */	addi r4, r4, cc_sph_src@l /* 0x807FCEC8@l */
/* 807FBD20  4B 88 8D 15 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
/* 807FBD24  38 1F 08 B4 */	addi r0, r31, 0x8b4
/* 807FBD28  90 1F 09 34 */	stw r0, 0x934(r31)
/* 807FBD2C  38 7F 0A 28 */	addi r3, r31, 0xa28
/* 807FBD30  3C 80 80 80 */	lis r4, at_sph_src@ha /* 0x807FCF08@ha */
/* 807FBD34  38 84 CF 08 */	addi r4, r4, at_sph_src@l /* 0x807FCF08@l */
/* 807FBD38  4B 88 8C FD */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807FBD6C  4B 87 A4 DD */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 807FBD70  38 7F 06 98 */	addi r3, r31, 0x698
/* 807FBD74  C0 3E 00 7C */	lfs f1, 0x7c(r30)
/* 807FBD78  C0 5E 01 30 */	lfs f2, 0x130(r30)
/* 807FBD7C  4B 87 A1 DD */	bl SetWall__12dBgS_AcchCirFff
...
/* 807FBD94  4B AC 53 01 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 807FBD98  38 7F 05 D8 */	addi r3, r31, 0x5d8
/* 807FBD9C  3C 80 80 80 */	lis r4, d_a_e_yg__stringBase0@ha /* 0x807FCDF0@ha */
/* 807FBDA0  38 84 CD F0 */	addi r4, r4, d_a_e_yg__stringBase0@l /* 0x807FCDF0@l */
/* 807FBDA4  38 84 00 05 */	addi r4, r4, 5
/* 807FBDA8  4B AC 5D E9 */	bl setEnemyName__15Z2CreatureEnemyFPCc
/* 807FBDAC  38 1F 05 D8 */	addi r0, r31, 0x5d8
/* 807FBDB0  90 1F 0B 68 */	stw r0, 0xb68(r31)
/* 807FBDB4  C0 3E 00 70 */	lfs f1, 0x70(r30)
/* 807FBDB8  4B A6 BB 9D */	bl cM_rndF__Ff
...
/* 807FBDD8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807FBDDC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807FBDE0  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 807FBDE4  7C 05 07 74 */	extsb r5, r0
/* 807FBDE8  4B 83 95 79 */	bl isSwitch__10dSv_info_cCFii
...
lbl_807FBE0C:
/* 807FBE0C  3C 60 80 80 */	lis r3, l_HIO@ha /* 0x807FD06C@ha */
/* 807FBE10  38 63 D0 6C */	addi r3, r3, l_HIO@l /* 0x807FD06C@l */
...
/* 807FBE24  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 807FBE28  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 807FBE2C  38 81 00 10 */	addi r4, r1, 0x10
/* 807FBE30  4B 81 D9 C9 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 807FBE5C  4B B6 63 BD */	bl _restgpr_25
