...
/* 807FB40C  4B B6 6D B5 */	bl _savegpr_22
/* 807FB410  7C 7F 1B 78 */	mr r31, r3
/* 807FB414  3C 60 80 80 */	lis r3, lit_1109@ha /* 0x807FD020@ha */
/* 807FB418  3B A3 D0 20 */	addi r29, r3, lit_1109@l /* 0x807FD020@l */
/* 807FB41C  3C 60 80 80 */	lis r3, lit_3801@ha /* 0x807FCCB4@ha */
/* 807FB420  3B C3 CC B4 */	addi r30, r3, lit_3801@l /* 0x807FCCB4@l */
...
/* 807FB4B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807FB4B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807FB4CC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB4D0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807FB4D4  4B B4 AF DD */	bl PSMTXCopy
/* 807FB4D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB4DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807FB4FC  4B 81 0F 39 */	bl mDoMtx_YrotM__FPA4_fs
/* 807FB500  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB504  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807FB508  38 80 80 00 */	li r4, -32768
/* 807FB50C  4B 81 0E 91 */	bl mDoMtx_XrotM__FPA4_fs
/* 807FB510  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB514  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807FB518  38 80 09 C4 */	li r4, 0x9c4
/* 807FB51C  4B 81 0F B1 */	bl mDoMtx_ZrotM__FPA4_fs
/* 807FB520  C0 3E 00 98 */	lfs f1, 0x98(r30)
/* 807FB524  C0 5E 01 24 */	lfs f2, 0x124(r30)
/* 807FB528  C0 7E 01 28 */	lfs f3, 0x128(r30)
/* 807FB52C  4B 81 18 71 */	bl transM__14mDoMtx_stack_cFfff
/* 807FB530  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB534  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807FB538  38 9C 00 24 */	addi r4, r28, 0x24
/* 807FB53C  4B B4 AF 75 */	bl PSMTXCopy
/* 807FB540  48 00 00 54 */	b lbl_807FB594
lbl_807FB544:
/* 807FB544  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB548  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807FB560  4B B4 B3 89 */	bl PSMTXTrans
/* 807FB564  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB568  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807FB56C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 807FB570  4B 81 0E C5 */	bl mDoMtx_YrotM__FPA4_fs
/* 807FB574  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB578  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807FB57C  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 807FB580  4B 81 0E 1D */	bl mDoMtx_XrotM__FPA4_fs
/* 807FB584  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB588  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807FB58C  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 807FB590  4B 81 0F 3D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_807FB594:
...
/* 807FB5A4  4B 81 18 95 */	bl scaleM__14mDoMtx_stack_cFfff
/* 807FB5A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807FB5AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807FB5B0  38 9C 00 24 */	addi r4, r28, 0x24
/* 807FB5B4  4B B4 AE FD */	bl PSMTXCopy
/* 807FB5B8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 807FB5BC  7C 03 07 74 */	extsb r3, r0
/* 807FB5C0  4B 83 1A AD */	bl dComIfGp_getReverb__Fi
/* 807FB5C4  7C 65 1B 78 */	mr r5, r3
/* 807FB5C8  80 7F 05 CC */	lwz r3, 0x5cc(r31)
/* 807FB5CC  38 80 00 00 */	li r4, 0
/* 807FB5D0  4B 81 5A E1 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 807FB5D4  80 7F 05 CC */	lwz r3, 0x5cc(r31)
/* 807FB5D8  4B 81 5C 15 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 807FB5F8  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807FB5FC  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807FB600  80 84 00 00 */	lwz r4, 0(r4)
/* 807FB604  4B B4 AE AD */	bl PSMTXCopy
...
/* 807FB624  4B A7 58 C9 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807FB66C  4B A7 58 81 */	bl MtxPosition__FP4cXyzP4cXyz
/* 807FB670  38 7F 0A 14 */	addi r3, r31, 0xa14
/* 807FB674  38 81 00 2C */	addi r4, r1, 0x2c
/* 807FB678  4B A7 3F D1 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 807FB68C  4B A7 40 7D */	bl SetR__8cM3dGSphFf
/* 807FB690  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807FB694  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807FB698  3B 03 23 3C */	addi r24, r3, 0x233c
/* 807FB69C  7F 03 C3 78 */	mr r3, r24
/* 807FB6A0  38 9F 08 F0 */	addi r4, r31, 0x8f0
/* 807FB6A4  4B A6 95 05 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 807FB6E0  4B A7 58 0D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807FB6F4  4B A7 3F 55 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 807FB708  4B A7 40 01 */	bl SetR__8cM3dGSphFf
/* 807FB70C  7F 03 C3 78 */	mr r3, r24
/* 807FB710  38 9F 0A 28 */	addi r4, r31, 0xa28
/* 807FB714  4B A6 94 95 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 807FB73C  4B B2 CC F1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807FB794  3C 80 80 80 */	lis r4, __dt__4cXyzFv@ha /* 0x807FCC64@ha */
/* 807FB798  38 84 CC 64 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807FCC64@l */
...
/* 807FB7B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807FB7BC  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807FB7C0  3C 60 80 80 */	lis r3, eff_id_5034@ha /* 0x807FCEC0@ha */
/* 807FB7C4  3B 23 CE C0 */	addi r25, r3, eff_id_5034@l /* 0x807FCEC0@l */
lbl_807FB7C8:
...
/* 807FB814  4B 85 1C B9 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807FB83C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807FB840  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807FB890  4B 85 1C 3D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807FB8A4  4B 85 00 75 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 807FB8C4  4B A8 4F 1D */	bl func_802807E0
lbl_807FB8C8:
...
/* 807FB8F4  4B B6 69 19 */	bl _restgpr_22
