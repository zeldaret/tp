...
/* 807FA8A0  4B B6 79 1D */	bl _savegpr_21
/* 807FA8A4  7C 7D 1B 79 */	or. r29, r3, r3
/* 807FA8A8  3C 60 80 80 */	lis r3, lit_3801@ha /* 0x807FCCB4@ha */
/* 807FA8AC  3B E3 CC B4 */	addi r31, r3, lit_3801@l /* 0x807FCCB4@l */
...
/* 807FA8D0  4B A6 D1 05 */	bl cM_initRnd2__Fiii
...
/* 807FA8E8  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807FA8EC  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807FA8F0  80 84 00 00 */	lwz r4, 0(r4)
/* 807FA8F4  4B B4 BB BD */	bl PSMTXCopy
/* 807FA8F8  3B C0 00 00 */	li r30, 0
/* 807FA8FC  3B 80 00 00 */	li r28, 0
/* 807FA900  3B 60 00 00 */	li r27, 0
/* 807FA904  3B 40 00 00 */	li r26, 0
/* 807FA908  3C 60 80 80 */	lis r3, ke_p@ha /* 0x807FD1C4@ha */
/* 807FA90C  3A E3 D1 C4 */	addi r23, r3, ke_p@l /* 0x807FD1C4@l */
/* 807FA910  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807FA914  3B 03 07 68 */	addi r24, r3, calc_mtx@l /* 0x80450768@l */
/* 807FA918  3C 60 80 80 */	lis r3, ke_a@ha /* 0x807FD2FC@ha */
/* 807FA91C  3B 23 D2 FC */	addi r25, r3, ke_a@l /* 0x807FD2FC@l */
/* 807FA920  C3 FF 00 04 */	lfs f31, 4(r31)
lbl_807FA924:
/* 807FA924  4B A7 65 F9 */	bl MtxPush__Fv
...
/* 807FA984  4B A7 65 69 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807FA9F8  4B A7 65 61 */	bl MtxPull__Fv
...
/* 807FAA20  4B B6 77 E9 */	bl _restgpr_21
