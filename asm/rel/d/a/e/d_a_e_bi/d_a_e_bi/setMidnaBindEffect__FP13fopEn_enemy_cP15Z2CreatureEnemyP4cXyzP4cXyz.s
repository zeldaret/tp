...
/* 8068D398  4B CD 4E 1D */	bl _savegpr_19
/* 8068D39C  7C 7E 1B 78 */	mr r30, r3
/* 8068D3A0  7C 9A 23 78 */	mr r26, r4
/* 8068D3A4  7C BB 2B 78 */	mr r27, r5
/* 8068D3A8  7C DC 33 78 */	mr r28, r6
/* 8068D3AC  3C 60 80 69 */	lis r3, cNullVec__6Z2Calc@ha /* 0x8068D8EC@ha */
/* 8068D3B0  3A E3 D8 EC */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x8068D8EC@l */
/* 8068D3B4  3C 60 80 69 */	lis r3, lit_3903@ha /* 0x8068D7EC@ha */
/* 8068D3B8  3B E3 D7 EC */	addi r31, r3, lit_3903@l /* 0x8068D7EC@l */
/* 8068D3BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8068D3C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8068D3C4  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 8068D3C8  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8068D3CC  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 8068D3F4  4B B1 F1 89 */	bl dKy_darkworld_check__Fv
...
/* 8068D418  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8068D41C  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 8068D434  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8068D438  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8068D43C  4B CB 90 75 */	bl PSMTXCopy
...
/* 8068D454  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8068D458  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8068D45C  38 81 00 4C */	addi r4, r1, 0x4c
/* 8068D460  38 A1 00 58 */	addi r5, r1, 0x58
/* 8068D464  4B CB 99 09 */	bl PSMTXMultVec
/* 8068D468  38 61 00 34 */	addi r3, r1, 0x34
/* 8068D46C  38 81 00 58 */	addi r4, r1, 0x58
/* 8068D470  7F 65 DB 78 */	mr r5, r27
/* 8068D474  4B BD 96 C1 */	bl __mi__4cXyzCFRC3Vec
...
/* 8068D490  4B BD A1 E5 */	bl cM_atan2s__Fff
...
/* 8068D4C4  4B BD A1 B1 */	bl cM_atan2s__Fff
...
/* 8068D4E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8068D4E4  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8068D534  4B 9B F5 5D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8068D538  7C 79 1B 79 */	or. r25, r3, r3
/* 8068D53C  41 82 00 FC */	beq lbl_8068D638
/* 8068D540  38 61 00 40 */	addi r3, r1, 0x40
/* 8068D544  4B CB 9B F5 */	bl PSVECSquareMag
...
/* 8068D5B4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8068D5B8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8068D624  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8068D628  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8068D62C:
...
/* 8068D67C  4B 9B F4 15 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8068D6B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8068D6BC  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8068D728  4B 9B FD A5 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8068D788  4B CD 4A 79 */	bl _restgpr_19
