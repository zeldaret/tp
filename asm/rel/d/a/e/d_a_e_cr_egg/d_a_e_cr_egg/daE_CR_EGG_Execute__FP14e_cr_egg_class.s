...
/* 8069A390  3C 60 80 6A */	lis r3, lit_3657@ha /* 0x8069A8CC@ha */
/* 8069A394  3B E3 A8 CC */	addi r31, r3, lit_3657@l /* 0x8069A8CC@l */
...
/* 8069A3EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8069A3F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8069A3F4  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 8069A3F8  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 8069A3FC  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 8069A400  4B CA C4 E9 */	bl PSMTXTrans
/* 8069A404  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8069A408  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8069A40C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 8069A410  4B 97 20 25 */	bl mDoMtx_YrotM__FPA4_fs
/* 8069A414  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8069A418  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8069A41C  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 8069A420  4B 97 1F 7D */	bl mDoMtx_XrotM__FPA4_fs
/* 8069A424  C0 3F 00 34 */	lfs f1, 0x34(r31)
/* 8069A428  C0 5F 00 3C */	lfs f2, 0x3c(r31)
/* 8069A42C  FC 60 08 90 */	fmr f3, f1
/* 8069A430  4B 97 29 6D */	bl transM__14mDoMtx_stack_cFfff
/* 8069A434  C0 3F 00 04 */	lfs f1, 4(r31)
/* 8069A438  FC 40 08 90 */	fmr f2, f1
/* 8069A43C  FC 60 08 90 */	fmr f3, f1
/* 8069A440  4B 97 29 F9 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8069A444  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8069A448  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8069A44C  80 9E 05 B8 */	lwz r4, 0x5b8(r30)
/* 8069A450  38 84 00 24 */	addi r4, r4, 0x24
/* 8069A454  4B CA C0 5D */	bl PSMTXCopy
...
/* 8069A478  4B BC C6 6D */	bl __pl__4cXyzCFRC3Vec
/* 8069A47C  38 7E 09 D4 */	addi r3, r30, 0x9d4
/* 8069A480  38 81 00 08 */	addi r4, r1, 8
/* 8069A484  4B BD 51 C5 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8069A488  38 7E 09 D4 */	addi r3, r30, 0x9d4
/* 8069A48C  C0 3F 00 38 */	lfs f1, 0x38(r31)
/* 8069A490  4B BD 52 79 */	bl SetR__8cM3dGSphFf
/* 8069A494  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069A498  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8069A49C  38 63 23 3C */	addi r3, r3, 0x233c
/* 8069A4A0  38 9E 08 B0 */	addi r4, r30, 0x8b0
/* 8069A4A4  4B BC A7 05 */	bl Set__4cCcSFP8cCcD_Obj
