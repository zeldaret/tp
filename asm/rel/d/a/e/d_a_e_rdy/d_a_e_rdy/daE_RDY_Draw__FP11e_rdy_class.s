...
/* 8076C55C  4B BF 5C 61 */	bl _savegpr_21
/* 8076C560  7C 78 1B 78 */	mr r24, r3
/* 8076C564  3C 60 80 78 */	lis r3, lit_4018@ha /* 0x80779DFC@ha */
/* 8076C568  3B A3 9D FC */	addi r29, r3, lit_4018@l /* 0x80779DFC@l */
/* 8076C56C  88 18 05 B8 */	lbz r0, 0x5b8(r24)
/* 8076C570  28 00 00 0C */	cmplwi r0, 0xc
/* 8076C574  40 82 00 30 */	bne lbl_8076C5A4
/* 8076C578  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076C57C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8076C580  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 8076C584  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 8076C588  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 8076C58C  A0 84 01 DE */	lhz r4, 0x1de(r4)
/* 8076C590  4B 8C 84 2D */	bl isEventBit__11dSv_event_cCFUs
...
/* 8076C5C0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8076C5C4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8076C5C8  38 80 00 02 */	li r4, 2
/* 8076C5CC  38 B8 04 D0 */	addi r5, r24, 0x4d0
/* 8076C5D0  38 D8 01 0C */	addi r6, r24, 0x10c
/* 8076C5D4  4B A3 71 F1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8076C5D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076C5DC  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8076C5E0  80 04 5F 88 */	lwz r0, 0x5f88(r4)
/* 8076C5E4  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8076C5E8  3B C3 4A C8 */	addi r30, r3, j3dSys@l /* 0x80434AC8@l */
/* 8076C5EC  90 1E 00 48 */	stw r0, 0x48(r30)
/* 8076C5F0  80 04 5F 8C */	lwz r0, 0x5f8c(r4)
/* 8076C5F4  90 1E 00 4C */	stw r0, 0x4c(r30)
/* 8076C5F8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8076C5FC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8076C600  80 9C 00 04 */	lwz r4, 4(r28)
/* 8076C604  38 B8 01 0C */	addi r5, r24, 0x10c
/* 8076C608  4B A3 87 99 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8076C6CC  4B 8A 4A F5 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 8076C774  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8076C778  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8076C77C  80 98 06 90 */	lwz r4, 0x690(r24)
/* 8076C780  80 84 00 04 */	lwz r4, 4(r4)
/* 8076C784  38 B8 01 0C */	addi r5, r24, 0x10c
/* 8076C788  4B A3 86 19 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8076C78C  80 78 06 90 */	lwz r3, 0x690(r24)
/* 8076C790  4B 8A 15 35 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8076C7A8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8076C7AC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8076C7B0  80 84 00 04 */	lwz r4, 4(r4)
/* 8076C7B4  38 B8 01 0C */	addi r5, r24, 0x10c
/* 8076C7B8  4B A3 85 E9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8076C7BC  80 78 06 94 */	lwz r3, 0x694(r24)
/* 8076C7C0  4B 8A 4A 01 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 8076C7C4  88 18 0A 72 */	lbz r0, 0xa72(r24)
/* 8076C7C8  7C 00 07 75 */	extsb. r0, r0
/* 8076C7CC  41 82 00 24 */	beq lbl_8076C7F0
/* 8076C7D0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8076C7D4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8076C7D8  80 98 06 90 */	lwz r4, 0x690(r24)
/* 8076C7DC  80 84 00 04 */	lwz r4, 4(r4)
/* 8076C7E0  38 B8 01 0C */	addi r5, r24, 0x10c
/* 8076C7E4  4B A3 85 BD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8076C7E8  80 78 06 90 */	lwz r3, 0x690(r24)
/* 8076C7EC  4B 8A 14 D9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8076C7F0:
...
/* 8076C804  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8076C808  3B E3 CA 54 */	addi r31, r3, g_env_light@l /* 0x8042CA54@l */
lbl_8076C80C:
...
/* 8076C820  4B A3 85 81 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8076C8B8  4B 8A 14 0D */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
lbl_8076C8CC:
/* 8076C8CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076C8D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8076C93C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 8076C940  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 8076C944  4B 8C 1F CD */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 8076C958  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076C95C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8076C960  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 8076C964  80 98 0A 58 */	lwz r4, 0xa58(r24)
/* 8076C968  80 B8 06 90 */	lwz r5, 0x690(r24)
/* 8076C96C  4B 8E 95 B1 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_8076C970:
/* 8076C970  88 18 06 9C */	lbz r0, 0x69c(r24)
/* 8076C974  7C 00 07 75 */	extsb. r0, r0
/* 8076C978  41 82 00 3C */	beq lbl_8076C9B4
/* 8076C97C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8076C980  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8076C984  38 80 00 10 */	li r4, 0x10
/* 8076C988  38 B8 04 D0 */	addi r5, r24, 0x4d0
/* 8076C98C  38 D8 06 A0 */	addi r6, r24, 0x6a0
/* 8076C990  4B A3 6E 35 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8076C994  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8076C998  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8076C99C  80 98 06 98 */	lwz r4, 0x698(r24)
/* 8076C9A0  80 84 00 04 */	lwz r4, 4(r4)
/* 8076C9A4  38 B8 06 A0 */	addi r5, r24, 0x6a0
/* 8076C9A8  4B A3 83 F9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8076C9AC  80 78 06 98 */	lwz r3, 0x698(r24)
/* 8076C9B0  4B 8A 13 15 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8076C9B4:
/* 8076C9B4  38 60 00 01 */	li r3, 1
lbl_8076C9B8:
/* 8076C9B8  39 61 00 60 */	addi r11, r1, 0x60
/* 8076C9BC  4B BF 58 4D */	bl _restgpr_21
