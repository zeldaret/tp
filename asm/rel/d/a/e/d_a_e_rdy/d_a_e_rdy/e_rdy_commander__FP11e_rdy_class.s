...
/* 80772C14  4B BE F5 C5 */	bl _savegpr_28
/* 80772C18  7C 7C 1B 78 */	mr r28, r3
/* 80772C1C  3C 60 80 78 */	lis r3, lit_4018@ha /* 0x80779DFC@ha */
/* 80772C20  3B E3 9D FC */	addi r31, r3, lit_4018@l /* 0x80779DFC@l */
/* 80772C24  3B C0 00 00 */	li r30, 0
/* 80772C28  3B A0 00 00 */	li r29, 0
/* 80772C2C  3C 60 80 78 */	lis r3, boss@ha /* 0x8077A870@ha */
/* 80772C30  93 83 A8 70 */	stw r28, boss@l(r3)  /* 0x8077A870@l */
/* 80772C34  A8 1C 0A 64 */	lha r0, 0xa64(r28)
/* 80772C38  2C 00 00 00 */	cmpwi r0, 0
/* 80772C3C  40 82 00 30 */	bne lbl_80772C6C
/* 80772C40  3C 60 80 77 */	lis r3, s_command4_sub__FPvPv@ha /* 0x80772B98@ha */
/* 80772C44  38 63 2B 98 */	addi r3, r3, s_command4_sub__FPvPv@l /* 0x80772B98@l */
/* 80772C48  7F 84 E3 78 */	mr r4, r28
/* 80772C4C  4B 8A E6 ED */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80772C78  3C 60 80 78 */	lis r3, lit_7053@ha /* 0x8077A314@ha */
/* 80772C7C  38 63 A3 14 */	addi r3, r3, lit_7053@l /* 0x8077A314@l */
...
/* 80772CD0  4B AF 4C 85 */	bl cM_rndF__Ff
...
/* 80772D1C  4B AF 4C 39 */	bl cM_rndF__Ff
...
/* 80772DA4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80772DA8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80772DD4  4B B3 8B B1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80772DD8  38 00 00 07 */	li r0, 7
/* 80772DDC  B0 1C 05 B4 */	sth r0, 0x5b4(r28)
/* 80772DE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80772DE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80772DE8  88 03 4F AD */	lbz r0, 0x4fad(r3)
/* 80772DEC  28 00 00 00 */	cmplwi r0, 0
/* 80772DF0  41 82 00 1C */	beq lbl_80772E0C
/* 80772DF4  3C 60 80 78 */	lis r3, l_HIO@ha /* 0x8077A884@ha */
/* 80772DF8  38 63 A8 84 */	addi r3, r3, l_HIO@l /* 0x8077A884@l */
...
/* 80772E28  3C 60 80 77 */	lis r3, s_command2_sub__FPvPv@ha /* 0x80772B0C@ha */
/* 80772E2C  38 63 2B 0C */	addi r3, r3, s_command2_sub__FPvPv@l /* 0x80772B0C@l */
/* 80772E30  7F 84 E3 78 */	mr r4, r28
/* 80772E34  4B 8A E5 05 */	bl fpcEx_Search__FPFPvPv_PvPv
lbl_80772E38:
...
/* 80772E8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80772E90  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80772F1C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80772F20  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80772F4C  4B B3 8A 39 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80772F50  3C 60 80 77 */	lis r3, s_command2_sub__FPvPv@ha /* 0x80772B0C@ha */
/* 80772F54  38 63 2B 0C */	addi r3, r3, s_command2_sub__FPvPv@l /* 0x80772B0C@l */
/* 80772F58  7F 84 E3 78 */	mr r4, r28
/* 80772F5C  4B 8A E3 DD */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 80772FC4  4B AF 49 91 */	bl cM_rndF__Ff
...
/* 80773028  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8077302C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80773030  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 80773034  7C 05 07 74 */	extsb r5, r0
/* 80773038  4B 8C 21 C9 */	bl onSwitch__10dSv_info_cFii
lbl_8077303C:
...
/* 80773054  4B AF D5 B5 */	bl cLib_addCalcAngleS2__FPssss
lbl_80773058:
/* 80773058  39 61 00 30 */	addi r11, r1, 0x30
/* 8077305C  4B BE F1 C9 */	bl _restgpr_28
