...
/* 8076CE34  4B 90 AE 35 */	bl __ct__11dBgS_LinChkFv
...
/* 8076CE50  3C 60 80 78 */	lis r3, lit_4576@ha /* 0x80779E78@ha */
/* 8076CE54  C0 03 9E 78 */	lfs f0, lit_4576@l(r3)  /* 0x80779E78@l */
/* 8076CE58  EC 01 00 2A */	fadds f0, f1, f0
/* 8076CE5C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 8076CE60  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8076CE64  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8076CE68  80 63 00 00 */	lwz r3, 0(r3)
/* 8076CE6C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8076CE70  4B 89 F5 6D */	bl mDoMtx_YrotS__FPA4_fs
/* 8076CE74  3C 60 80 78 */	lis r3, lit_4019@ha /* 0x80779E00@ha */
/* 8076CE78  C0 03 9E 00 */	lfs f0, lit_4019@l(r3)  /* 0x80779E00@l */
/* 8076CE7C  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 8076CE80  3C 60 80 78 */	lis r3, lit_4576@ha /* 0x80779E78@ha */
/* 8076CE84  C0 03 9E 78 */	lfs f0, lit_4576@l(r3)  /* 0x80779E78@l */
...
/* 8076CEBC  4B 90 AE A9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8076CEC0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076CEC4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8076CEC8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8076CECC  38 81 00 2C */	addi r4, r1, 0x2c
/* 8076CED0  4B 90 74 E5 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8076CEE4  4B 90 AD F9 */	bl __dt__11dBgS_LinChkFv
...
/* 8076CEF8  4B 90 AD E5 */	bl __dt__11dBgS_LinChkFv
