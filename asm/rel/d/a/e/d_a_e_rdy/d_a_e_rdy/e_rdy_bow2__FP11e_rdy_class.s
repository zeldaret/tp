...
/* 8076EBC8  4B BF 36 05 */	bl _savegpr_25
/* 8076EBCC  7C 7B 1B 78 */	mr r27, r3
/* 8076EBD0  3C 80 80 78 */	lis r4, lit_4018@ha /* 0x80779DFC@ha */
/* 8076EBD4  3B E4 9D FC */	addi r31, r4, lit_4018@l /* 0x80779DFC@l */
/* 8076EBD8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076EBDC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8076EC68  4B AF 7E CD */	bl __mi__4cXyzCFRC3Vec
...
/* 8076EC84  4B AF 89 F1 */	bl cM_atan2s__Fff
...
/* 8076ECA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076ECA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8076ECA8  7F 44 D3 78 */	mr r4, r26
/* 8076ECAC  88 1B 04 E2 */	lbz r0, 0x4e2(r27)
/* 8076ECB0  7C 05 07 74 */	extsb r5, r0
/* 8076ECB4  4B 8C 66 AD */	bl isSwitch__10dSv_info_cCFii
...
/* 8076ED2C  4B AF 8C 29 */	bl cM_rndF__Ff
...
/* 8076ED74  4B AF 8B E1 */	bl cM_rndF__Ff
...
/* 8076EDBC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076EDC0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8076EDC4  3C A5 00 02 */	addis r5, r5, 2
/* 8076EDC8  38 C0 00 80 */	li r6, 0x80
/* 8076EDCC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8076EDD0  4B 8C D5 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8076EDF0  4B 8A 20 81 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 8076EE9C  4B AF 8A B9 */	bl cM_rndF__Ff
...
lbl_8076EF2C:
/* 8076EF2C  4B AC 93 01 */	bl getStatus__12dMsgObject_cFv
...
/* 8076EF74  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8076EF78  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8076EF7C  3C A5 00 02 */	addis r5, r5, 2
/* 8076EF80  38 C0 00 80 */	li r6, 0x80
/* 8076EF84  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8076EF88  4B 8C D3 65 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8076EFA8  4B 8A 1E C9 */	bl setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 8076F028  3C 60 80 78 */	lis r3, l_HIO@ha /* 0x8077A884@ha */
/* 8076F02C  38 63 A8 84 */	addi r3, r3, l_HIO@l /* 0x8077A884@l */
...
/* 8076F0A0  4B B0 15 69 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8076F0CC  4B BF 31 4D */	bl _restgpr_25
