...
/* 80779958  4B BE 88 5D */	bl _savegpr_19
/* 8077995C  7C 7E 1B 78 */	mr r30, r3
/* 80779960  7C 9A 23 78 */	mr r26, r4
/* 80779964  7C BB 2B 78 */	mr r27, r5
/* 80779968  7C DC 33 78 */	mr r28, r6
/* 8077996C  3C 60 80 78 */	lis r3, cNullVec__6Z2Calc@ha /* 0x8077A0DC@ha */
/* 80779970  3A E3 A0 DC */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x8077A0DC@l */
/* 80779974  3C 60 80 78 */	lis r3, lit_4018@ha /* 0x80779DFC@ha */
/* 80779978  3B E3 9D FC */	addi r31, r3, lit_4018@l /* 0x80779DFC@l */
/* 8077997C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80779980  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80779984  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80779988  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8077998C  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 807799B4  4B A3 2B C9 */	bl dKy_darkworld_check__Fv
...
/* 807799D8  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 807799DC  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 807799F4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807799F8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807799FC  4B BC CA B5 */	bl PSMTXCopy
...
/* 80779A14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80779A18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80779A1C  38 81 00 4C */	addi r4, r1, 0x4c
/* 80779A20  38 A1 00 58 */	addi r5, r1, 0x58
/* 80779A24  4B BC D3 49 */	bl PSMTXMultVec
/* 80779A28  38 61 00 34 */	addi r3, r1, 0x34
/* 80779A2C  38 81 00 58 */	addi r4, r1, 0x58
/* 80779A30  7F 65 DB 78 */	mr r5, r27
/* 80779A34  4B AE D1 01 */	bl __mi__4cXyzCFRC3Vec
...
/* 80779A50  4B AE DC 25 */	bl cM_atan2s__Fff
...
/* 80779A84  4B AE DB F1 */	bl cM_atan2s__Fff
...
/* 80779AA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80779AA4  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80779AF4  4B 8D 2F 9D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80779AF8  7C 79 1B 79 */	or. r25, r3, r3
/* 80779AFC  41 82 00 FC */	beq lbl_80779BF8
/* 80779B00  38 61 00 40 */	addi r3, r1, 0x40
/* 80779B04  4B BC D6 35 */	bl PSVECSquareMag
...
/* 80779B74  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80779B78  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80779BE4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80779BE8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80779BEC:
...
/* 80779C3C  4B 8D 2E 55 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80779C78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80779C7C  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80779CE8  4B 8D 37 E5 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80779D48  4B BE 84 B9 */	bl _restgpr_19
