...
/* 807B1FA8  4B BB 02 25 */	bl _savegpr_25
/* 807B1FAC  7C 7C 1B 78 */	mr r28, r3
/* 807B1FB0  3C 80 80 7B */	lis r4, lit_3906@ha /* 0x807B449C@ha */
/* 807B1FB4  3B C4 44 9C */	addi r30, r4, lit_3906@l /* 0x807B449C@l */
/* 807B1FB8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B1FBC  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807B1FE8  3C 80 80 7B */	lis r4, lit_5133@ha /* 0x807B471C@ha */
/* 807B1FEC  38 84 47 1C */	addi r4, r4, lit_5133@l /* 0x807B471C@l */
...
/* 807B201C  4B 86 98 ED */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 807B2034  4B 9A F4 9D */	bl Stop__9dCamera_cFv
...
/* 807B2058  4B 9B 0F B5 */	bl SetTrimSize__9dCamera_cFl
...
/* 807B2088  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B208C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B2090  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 807B2094  7F 84 E3 78 */	mr r4, r28
/* 807B2098  3C A0 80 04 */	lis r5, dEv_noFinishSkipProc__FPvi@ha /* 0x800428DC@ha */
/* 807B209C  38 A5 28 DC */	addi r5, r5, dEv_noFinishSkipProc__FPvi@l /* 0x800428DC@l */
/* 807B20A0  38 C0 00 00 */	li r6, 0
/* 807B20A4  4B 89 08 71 */	bl setSkipProc__14dEvt_control_cFPvPFPvi_ii
lbl_807B20A8:
...
/* 807B2130  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B2134  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807B2148  4B 88 31 69 */	bl offSwitch__10dSv_info_cFii
lbl_807B214C:
...
/* 807B21DC  4B AB D8 61 */	bl cLib_addCalc2__FPffff
...
/* 807B21F0  4B AB D8 4D */	bl cLib_addCalc2__FPffff
...
/* 807B2318  4B AB D7 25 */	bl cLib_addCalc2__FPffff
...
/* 807B247C  4B AB D5 C1 */	bl cLib_addCalc2__FPffff
...
/* 807B2570  3C 60 80 7B */	lis r3, s_md_sub2__FPvPv@ha /* 0x807B0434@ha */
/* 807B2574  38 63 04 34 */	addi r3, r3, s_md_sub2__FPvPv@l /* 0x807B0434@l */
/* 807B2578  7F 84 E3 78 */	mr r4, r28
/* 807B257C  4B 86 ED BD */	bl fpcEx_Search__FPFPvPv_PvPv
/* 807B2580  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B2584  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B2588  38 80 00 6A */	li r4, 0x6a
/* 807B258C  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 807B2590  7C 05 07 74 */	extsb r5, r0
/* 807B2594  4B 88 2C 6D */	bl onSwitch__10dSv_info_cFii
...
/* 807B25E0  4B AB D4 5D */	bl cLib_addCalc2__FPffff
...
/* 807B25F4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 807B25F8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 807B260C  4B AF CE 91 */	bl subBgmStart__8Z2SeqMgrFUl
...
/* 807B2630  4B 86 92 D9 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 807B2648  4B 9A EE 89 */	bl Stop__9dCamera_cFv
...
/* 807B2678  4B 9B 09 95 */	bl SetTrimSize__9dCamera_cFl
...
/* 807B26B4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 807B26B8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 807B26BC  38 81 00 08 */	addi r4, r1, 8
/* 807B26C0  4B 86 71 39 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 807B26C4  7C 79 1B 78 */	mr r25, r3
/* 807B26C8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B26CC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807B26D0  80 63 00 00 */	lwz r3, 0(r3)
/* 807B26D4  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 807B26D8  4B 85 9D 05 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807B2748  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B274C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807B27C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B27C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B27CC  38 63 09 58 */	addi r3, r3, 0x958
/* 807B27D0  38 80 00 5E */	li r4, 0x5e
/* 807B27D4  4B 88 20 3D */	bl onSwitch__12dSv_memBit_cFi
lbl_807B27D8:
...
lbl_807B2814:
/* 807B2814  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B2818  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807B281C  80 63 00 00 */	lwz r3, 0(r3)
/* 807B2820  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 807B2824  4B 85 9B B9 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807B2954  4B AB D0 E9 */	bl cLib_addCalc2__FPffff
...
/* 807B2968  4B AB D0 D5 */	bl cLib_addCalc2__FPffff
...
/* 807B297C  4B AB D0 C1 */	bl cLib_addCalc2__FPffff
lbl_807B2980:
...
/* 807B29A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B29A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807B29B8  4B 8B D0 6D */	bl StartShock__12dVibration_cFii4cXyz
...
/* 807B29D8  4B 86 A6 49 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 807B2A30  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807B2A34  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807B2A38  80 84 00 00 */	lwz r4, 0(r4)
/* 807B2A3C  4B B9 3A 75 */	bl PSMTXCopy
...
/* 807B2A58  4B AB E4 95 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807B2A70  4B 86 A0 69 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
lbl_807B2A74:
...
/* 807B2AB8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B2ABC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807B2AC0  80 63 00 00 */	lwz r3, 0(r3)
/* 807B2AC4  A8 9A 04 E6 */	lha r4, 0x4e6(r26)
/* 807B2AC8  4B 85 99 15 */	bl mDoMtx_YrotS__FPA4_fs
...
lbl_807B2B64:
/* 807B2B64  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807B2B68  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807B2B6C  80 63 00 00 */	lwz r3, 0(r3)
/* 807B2B70  A8 9A 04 E6 */	lha r4, 0x4e6(r26)
/* 807B2B74  4B 85 98 69 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807B2C04  4B AB CE 39 */	bl cLib_addCalc2__FPffff
...
/* 807B2C20  4B AB CE 1D */	bl cLib_addCalc2__FPffff
...
/* 807B2C34  4B AB CE 09 */	bl cLib_addCalc2__FPffff
...
/* 807B2C50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B2C54  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807B2C68  4B 88 25 99 */	bl onSwitch__10dSv_info_cFii
/* 807B2C6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B2C70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B2C74  38 80 00 6A */	li r4, 0x6a
/* 807B2C78  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 807B2C7C  7C 05 07 74 */	extsb r5, r0
/* 807B2C80  4B 88 26 31 */	bl offSwitch__10dSv_info_cFii
lbl_807B2C84:
...
/* 807B2CC8  4B 9C DF 51 */	bl Reset__9dCamera_cF4cXyz4cXyz
/* 807B2CCC  38 7D 02 48 */	addi r3, r29, 0x248
/* 807B2CD0  4B 9A E7 DD */	bl Start__9dCamera_cFv
/* 807B2CD4  38 7D 02 48 */	addi r3, r29, 0x248
/* 807B2CD8  38 80 00 00 */	li r4, 0
/* 807B2CDC  4B 9B 03 31 */	bl SetTrimSize__9dCamera_cFl
/* 807B2CE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B2CE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B2CE8  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 807B2CEC  4B 88 F7 7D */	bl reset__14dEvt_control_cFv
...
/* 807B2D5C  4B 9C DD 85 */	bl Set__9dCamera_cF4cXyz4cXyzfs
...
/* 807B2D80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807B2D84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807B2D88  A0 03 4F A2 */	lhz r0, 0x4fa2(r3)
/* 807B2D8C  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c
/* 807B2D90  41 82 00 44 */	beq lbl_807B2DD4
/* 807B2D94  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 807B2D98  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 807B2D9C  80 63 00 00 */	lwz r3, 0(r3)
/* 807B2DA0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 807B2DA4  4B AF CA E1 */	bl subBgmStop__8Z2SeqMgrFv
/* 807B2DA8  38 00 00 1E */	li r0, 0x1e
/* 807B2DAC  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha /* 0x80450C98@ha */
/* 807B2DB0  98 03 0C 98 */	stb r0, struct_80450C98+0x0@l(r3)  /* 0x80450C98@l */
...
/* 807B2DD0  4B 87 43 A1 */	bl dStage_changeScene__FifUlScsi
lbl_807B2DD4:
/* 807B2DD4  39 61 00 A0 */	addi r11, r1, 0xa0
/* 807B2DD8  4B BA F4 41 */	bl _restgpr_25
