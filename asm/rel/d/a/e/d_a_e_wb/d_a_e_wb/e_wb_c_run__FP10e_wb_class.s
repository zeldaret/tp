...
/* 807DAA18  4B B8 77 A5 */	bl _savegpr_21
/* 807DAA1C  7C 7D 1B 78 */	mr r29, r3
/* 807DAA20  3C 60 80 7E */	lis r3, lit_1109@ha /* 0x807E3578@ha */
/* 807DAA24  3B C3 35 78 */	addi r30, r3, lit_1109@l /* 0x807E3578@l */
/* 807DAA28  3C 60 80 7E */	lis r3, lit_3882@ha /* 0x807E298C@ha */
/* 807DAA2C  3B E3 29 8C */	addi r31, r3, lit_3882@l /* 0x807E298C@l */
/* 807DAA30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807DAA34  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807DAA38  82 C3 5D AC */	lwz r22, 0x5dac(r3)
/* 807DAA3C  38 00 00 56 */	li r0, 0x56
/* 807DAA40  B0 01 00 08 */	sth r0, 8(r1)
/* 807DAA44  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 807DAA48  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 807DAA4C  38 81 00 08 */	addi r4, r1, 8
/* 807DAA50  4B 83 ED A9 */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 807DAA54  7C 7C 1B 78 */	mr r28, r3
/* 807DAA58  80 1D 14 34 */	lwz r0, 0x1434(r29)
/* 807DAA5C  90 01 00 18 */	stw r0, 0x18(r1)
/* 807DAA60  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 807DAA64  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 807DAA68  38 81 00 18 */	addi r4, r1, 0x18
/* 807DAA6C  4B 83 ED 8D */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 807DAB40  4B 89 D1 29 */	bl __ct__11dBgS_LinChkFv
/* 807DAB44  A8 1D 05 B4 */	lha r0, 0x5b4(r29)
/* 807DAB48  28 00 00 15 */	cmplwi r0, 0x15
/* 807DAB4C  41 81 0A A0 */	bgt lbl_807DB5EC
/* 807DAB50  3C 60 80 7E */	lis r3, lit_8136@ha /* 0x807E3028@ha */
/* 807DAB54  38 63 30 28 */	addi r3, r3, lit_8136@l /* 0x807E3028@l */
...
/* 807DABB8  4B A8 BF 7D */	bl __mi__4cXyzCFRC3Vec
...
/* 807DABD4  4B A8 CA A1 */	bl cM_atan2s__Fff
...
/* 807DABE8  4B A8 BF 4D */	bl __mi__4cXyzCFRC3Vec
...
/* 807DAC50  4B 83 EC 75 */	bl fopAcM_setStageLayer__FPv
...
/* 807DACC8  4B A8 CC 8D */	bl cM_rndF__Ff
...
/* 807DAD50  4B B4 D6 DD */	bl checkPass__12J3DFrameCtrlFf
...
/* 807DAD80  4B B4 D6 AD */	bl checkPass__12J3DFrameCtrlFf
...
/* 807DAE80  4B 89 CE E5 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807DAE84  3A A0 00 00 */	li r21, 0
/* 807DAE88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807DAE8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807DAE90  38 63 0F 38 */	addi r3, r3, 0xf38
/* 807DAE94  38 81 00 E8 */	addi r4, r1, 0xe8
/* 807DAE98  4B 89 95 1D */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 807DAEB0  4B A8 BC 85 */	bl __mi__4cXyzCFRC3Vec
...
/* 807DAED8  4B A8 BC 5D */	bl __mi__4cXyzCFRC3Vec
...
/* 807DAEF8  4B B6 C2 41 */	bl PSVECSquareMag
...
/* 807DAF68  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807DAF6C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807DAFD8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807DAFDC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 807DAFE0  48 00 00 08 */	b lbl_807DAFE8
lbl_807DAFE4:
/* 807DAFE4  FF E0 08 90 */	fmr f31, f1
lbl_807DAFE8:
/* 807DAFE8  38 61 00 DC */	addi r3, r1, 0xdc
/* 807DAFEC  4B B6 C1 4D */	bl PSVECSquareMag
...
/* 807DB05C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807DB060  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807DB0CC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807DB0D0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807DB0D4:
...
lbl_807DB0FC:
/* 807DB0FC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807DB100  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807DB104  80 63 00 00 */	lwz r3, 0(r3)
/* 807DB108  A8 96 04 E6 */	lha r4, 0x4e6(r22)
/* 807DB10C  4B 83 12 D1 */	bl mDoMtx_YrotS__FPA4_fs
...
lbl_807DB12C:
/* 807DB12C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807DB130  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807DB134  80 63 00 00 */	lwz r3, 0(r3)
/* 807DB138  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 807DB13C  4B 83 12 A1 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807DB1A4  3C 80 80 7D */	lis r4, __dt__4cXyzFv@ha /* 0x807D2B48@ha */
/* 807DB1A8  38 84 2B 48 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807D2B48@l */
...
/* 807DB1E0  3C 80 80 7D */	lis r4, __dt__4cXyzFv@ha /* 0x807D2B48@ha */
/* 807DB1E4  38 84 2B 48 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807D2B48@l */
...
/* 807DB21C  3C 80 80 7D */	lis r4, __dt__4cXyzFv@ha /* 0x807D2B48@ha */
/* 807DB220  38 84 2B 48 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807D2B48@l */
...
/* 807DB264  3C 80 80 7D */	lis r4, __dt__4cXyzFv@ha /* 0x807D2B48@ha */
/* 807DB268  38 84 2B 48 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807D2B48@l */
...
/* 807DB2A0  3C 80 80 7D */	lis r4, __dt__4cXyzFv@ha /* 0x807D2B48@ha */
/* 807DB2A4  38 84 2B 48 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807D2B48@l */
...
/* 807DB2DC  3C 80 80 7D */	lis r4, __dt__4cXyzFv@ha /* 0x807D2B48@ha */
/* 807DB2E0  38 84 2B 48 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807D2B48@l */
...
/* 807DB388  4B A8 C5 CD */	bl cM_rndF__Ff
...
/* 807DB488  4B A8 C1 ED */	bl cM_atan2s__Fff
...
/* 807DB4B0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 807DB4B4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 807DB510  4B A9 50 F9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 807DB660  4B A8 B4 D5 */	bl __mi__4cXyzCFRC3Vec
...
/* 807DB680  4B B6 BA B9 */	bl PSVECSquareMag
...
/* 807DB6F0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807DB6F4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807DB760  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807DB764  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807DB768:
...
/* 807DB78C  4B A9 42 B1 */	bl cLib_addCalc2__FPffff
...
/* 807DB7B0  4B A9 4E 59 */	bl cLib_addCalcAngleS2__FPssss
/* 807DB7B4  38 61 00 E8 */	addi r3, r1, 0xe8
/* 807DB7B8  38 80 FF FF */	li r4, -1
/* 807DB7BC  4B 89 C5 21 */	bl __dt__11dBgS_LinChkFv
...
/* 807DB7D0  4B B8 6A 39 */	bl _restgpr_21
