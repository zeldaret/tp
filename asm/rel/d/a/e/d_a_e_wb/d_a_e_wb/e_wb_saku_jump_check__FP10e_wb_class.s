...
/* 807D3BA4  4B B8 E6 39 */	bl _savegpr_29
/* 807D3BA8  3C 80 80 7E */	lis r4, lit_3882@ha /* 0x807E298C@ha */
/* 807D3BAC  3B E4 29 8C */	addi r31, r4, lit_3882@l /* 0x807E298C@l */
/* 807D3BB0  7C 7D 1B 78 */	mr r29, r3
/* 807D3BB4  38 61 00 50 */	addi r3, r1, 0x50
/* 807D3BB8  4B 8A 40 B1 */	bl __ct__11dBgS_LinChkFv
/* 807D3BBC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807D3BC0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807D3BC4  80 63 00 00 */	lwz r3, 0(r3)
/* 807D3BC8  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 807D3BCC  4B 83 88 11 */	bl mDoMtx_YrotS__FPA4_fs
/* 807D3BD0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807D3BD4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807D3BD8  80 63 00 00 */	lwz r3, 0(r3)
/* 807D3BDC  A8 9D 04 E4 */	lha r4, 0x4e4(r29)
/* 807D3BE0  4B 83 87 BD */	bl mDoMtx_XrotM__FPA4_fs
...
/* 807D3C4C  4B 8A 41 19 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807D3C50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D3C54  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807D3C58  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 807D3C5C  7F C3 F3 78 */	mr r3, r30
/* 807D3C60  38 81 00 50 */	addi r4, r1, 0x50
/* 807D3C64  4B 8A 07 51 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 807D3CC4  4B 8A 40 A1 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807D3CC8  7F C3 F3 78 */	mr r3, r30
/* 807D3CCC  38 81 00 50 */	addi r4, r1, 0x50
/* 807D3CD0  4B 8A 06 E5 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 807D3D00  4B 8A 3F DD */	bl __dt__11dBgS_LinChkFv
...
/* 807D3D18  4B A9 2E 1D */	bl __mi__4cXyzCFRC3Vec
...
/* 807D3D34  4B A9 39 41 */	bl cM_atan2s__Fff
...
/* 807D3D60  4B 8A 3F 7D */	bl __dt__11dBgS_LinChkFv
...
/* 807D3D74  4B 8A 3F 69 */	bl __dt__11dBgS_LinChkFv
/* 807D3D78  38 60 00 00 */	li r3, 0
lbl_807D3D7C:
/* 807D3D7C  39 61 00 D0 */	addi r11, r1, 0xd0
/* 807D3D80  4B B8 E4 A9 */	bl _restgpr_29
