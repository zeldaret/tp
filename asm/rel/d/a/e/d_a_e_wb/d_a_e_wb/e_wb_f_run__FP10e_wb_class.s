...
/* 807D4CAC  4B B8 D5 21 */	bl _savegpr_25
/* 807D4CB0  7C 7B 1B 78 */	mr r27, r3
/* 807D4CB4  3C 80 80 7E */	lis r4, lit_3882@ha /* 0x807E298C@ha */
/* 807D4CB8  3B A4 29 8C */	addi r29, r4, lit_3882@l /* 0x807E298C@l */
/* 807D4CBC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D4CC0  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807D4CC4  83 9E 5D AC */	lwz r28, 0x5dac(r30)
/* 807D4CC8  7F 84 E3 78 */	mr r4, r28
/* 807D4CCC  4B 84 5C 99 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807D4D04  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 807D4D08  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 807D4D0C  38 81 00 08 */	addi r4, r1, 8
/* 807D4D10  4B 84 4A E9 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 807D4D5C  4B A9 B8 AD */	bl cLib_addCalcAngleS2__FPssss
...
/* 807D4D80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D4D84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807D4E40  4B A9 2B 15 */	bl cM_rndF__Ff
...
/* 807D4EC8  4B B5 35 65 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807D4EF8  4B B5 35 35 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807D4FAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D4FB0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807D4FB4  80 63 5D B8 */	lwz r3, 0x5db8(r3)
/* 807D4FB8  C3 E3 05 2C */	lfs f31, 0x52c(r3)
/* 807D4FBC  3C 60 80 7E */	lis r3, l_HIO@ha /* 0x807E35C8@ha */
/* 807D4FC0  38 63 35 C8 */	addi r3, r3, l_HIO@l /* 0x807E35C8@l */
...
/* 807D5020  4B A9 29 35 */	bl cM_rndF__Ff
...
/* 807D50AC  4B A9 25 C9 */	bl cM_atan2s__Fff
...
/* 807D5108  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 807D510C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 807D5150  4B A9 B4 B9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 807D5164  4B A9 B4 A5 */	bl cLib_addCalcAngleS2__FPssss
...
/* 807D51B0  3C 60 80 7E */	lis r3, l_HIO@ha /* 0x807E35C8@ha */
/* 807D51B4  38 63 35 C8 */	addi r3, r3, l_HIO@l /* 0x807E35C8@l */
...
/* 807D51D0  4B 84 55 41 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807D51F0  4B A9 B4 19 */	bl cLib_addCalcAngleS2__FPssss
lbl_807D51F4:
...
/* 807D5224  3C 60 80 7E */	lis r3, l_HIO@ha /* 0x807E35C8@ha */
/* 807D5228  38 63 35 C8 */	addi r3, r3, l_HIO@l /* 0x807E35C8@l */
...
/* 807D52FC  4B A9 A7 41 */	bl cLib_addCalc2__FPffff
...
/* 807D5320  4B A9 B2 E9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 807D5398  4B B8 CE 81 */	bl _restgpr_25
