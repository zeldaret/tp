...
/* 807D9D5C  4B B8 84 65 */	bl _savegpr_22
/* 807D9D60  7C 7F 1B 78 */	mr r31, r3
/* 807D9D64  3C 60 80 7E */	lis r3, cNullVec__6Z2Calc@ha /* 0x807E2F58@ha */
/* 807D9D68  3B 43 2F 58 */	addi r26, r3, cNullVec__6Z2Calc@l /* 0x807E2F58@l */
/* 807D9D6C  3C 60 80 7E */	lis r3, lit_1109@ha /* 0x807E3578@ha */
/* 807D9D70  3B 63 35 78 */	addi r27, r3, lit_1109@l /* 0x807E3578@l */
/* 807D9D74  3C 60 80 7E */	lis r3, lit_3882@ha /* 0x807E298C@ha */
/* 807D9D78  3B C3 29 8C */	addi r30, r3, lit_3882@l /* 0x807E298C@l */
/* 807D9D7C  38 61 00 A0 */	addi r3, r1, 0xa0
/* 807D9D80  4B 89 D7 FD */	bl __ct__11dBgS_GndChkFv
/* 807D9D84  38 61 00 4C */	addi r3, r1, 0x4c
/* 807D9D88  4B 89 DA 29 */	bl __ct__18dBgS_ObjGndChk_SplFv
...
/* 807D9DB8  4B A8 DF 71 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 807D9DBC  38 61 00 4C */	addi r3, r1, 0x4c
/* 807D9DC0  38 81 00 40 */	addi r4, r1, 0x40
/* 807D9DC4  4B A8 DF 65 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 807D9DC8  3B A0 00 00 */	li r29, 0
/* 807D9DCC  3B 80 00 00 */	li r28, 0
/* 807D9DD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D9DD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807D9DD8  3A E3 0F 38 */	addi r23, r3, 0xf38
/* 807D9DDC  7E E3 BB 78 */	mr r3, r23
/* 807D9DE0  38 81 00 A0 */	addi r4, r1, 0xa0
/* 807D9DE4  4B 89 A6 BD */	bl GroundCross__4cBgSFP11cBgS_GndChk
/* 807D9DE8  FF E0 08 90 */	fmr f31, f1
/* 807D9DEC  7E E3 BB 78 */	mr r3, r23
/* 807D9DF0  38 81 00 4C */	addi r4, r1, 0x4c
/* 807D9DF4  4B 89 A6 AD */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 807D9E24  4B B4 E6 09 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807D9E4C  4B B4 E5 E1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 807D9EB8  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807D9EBC  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807D9EC0  80 84 00 00 */	lwz r4, 0(r4)
/* 807D9EC4  4B B6 C5 ED */	bl PSMTXCopy
...
/* 807D9EE8  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807D9EEC  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807D9EF0  80 84 00 00 */	lwz r4, 0(r4)
/* 807D9EF4  4B B6 C5 BD */	bl PSMTXCopy
lbl_807D9EF8:
/* 807D9EF8  38 61 00 40 */	addi r3, r1, 0x40
/* 807D9EFC  38 81 00 34 */	addi r4, r1, 0x34
/* 807D9F00  4B A9 6F ED */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807D9F4C  4B 84 30 D5 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
lbl_807D9F50:
...
/* 807D9F88  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807D9F8C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807D9F90  80 84 00 00 */	lwz r4, 0(r4)
/* 807D9F94  4B B6 C5 1D */	bl PSMTXCopy
/* 807D9F98  38 61 00 40 */	addi r3, r1, 0x40
/* 807D9F9C  38 81 00 34 */	addi r4, r1, 0x34
/* 807D9FA0  4B A9 6F 4D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807D9FD8  4B 84 30 49 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
/* 807D9FDC  88 1F 14 2C */	lbz r0, 0x142c(r31)
/* 807D9FE0  28 00 00 00 */	cmplwi r0, 0
/* 807D9FE4  41 82 00 60 */	beq lbl_807DA044
/* 807D9FE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D9FEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807DA03C  4B 87 34 91 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807DA05C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807DA060  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807DA064  80 84 00 00 */	lwz r4, 0(r4)
/* 807DA068  4B B6 C4 49 */	bl PSMTXCopy
/* 807DA06C  38 61 00 40 */	addi r3, r1, 0x40
/* 807DA070  38 81 00 34 */	addi r4, r1, 0x34
/* 807DA074  4B A9 6E 79 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807DA0AC  4B 84 2F 75 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
/* 807DA0B0  88 1F 14 2C */	lbz r0, 0x142c(r31)
/* 807DA0B4  28 00 00 00 */	cmplwi r0, 0
/* 807DA0B8  41 82 00 60 */	beq lbl_807DA118
/* 807DA0BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807DA0C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807DA110  4B 87 33 BD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807DA13C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807DA140  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807DA144  80 84 00 00 */	lwz r4, 0(r4)
/* 807DA148  4B B6 C3 69 */	bl PSMTXCopy
...
/* 807DA15C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807DA160  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807DA164  80 84 00 00 */	lwz r4, 0(r4)
/* 807DA168  4B B6 C3 49 */	bl PSMTXCopy
lbl_807DA16C:
/* 807DA16C  38 61 00 40 */	addi r3, r1, 0x40
/* 807DA170  38 81 00 34 */	addi r4, r1, 0x34
/* 807DA174  4B A9 6D 79 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807DA1AC  4B 84 2E 75 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
/* 807DA1B0  88 1F 14 2C */	lbz r0, 0x142c(r31)
/* 807DA1B4  28 00 00 00 */	cmplwi r0, 0
/* 807DA1B8  41 82 00 60 */	beq lbl_807DA218
/* 807DA1BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807DA1C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807DA210  4B 87 32 BD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807DA23C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807DA240  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807DA244  80 84 00 00 */	lwz r4, 0(r4)
/* 807DA248  4B B6 C2 69 */	bl PSMTXCopy
...
/* 807DA25C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807DA260  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807DA264  80 84 00 00 */	lwz r4, 0(r4)
/* 807DA268  4B B6 C2 49 */	bl PSMTXCopy
lbl_807DA26C:
/* 807DA26C  38 61 00 40 */	addi r3, r1, 0x40
/* 807DA270  38 81 00 34 */	addi r4, r1, 0x34
/* 807DA274  4B A9 6C 79 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807DA2AC  4B 84 2D 75 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
/* 807DA2B0  88 1F 14 2C */	lbz r0, 0x142c(r31)
/* 807DA2B4  28 00 00 00 */	cmplwi r0, 0
/* 807DA2B8  41 82 00 60 */	beq lbl_807DA318
/* 807DA2BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807DA2C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807DA310  4B 87 31 BD */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807DA364  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 807DA368  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 807DA36C  80 84 00 00 */	lwz r4, 0(r4)
/* 807DA370  4B B6 C1 41 */	bl PSMTXCopy
/* 807DA374  38 61 00 40 */	addi r3, r1, 0x40
/* 807DA378  38 81 00 34 */	addi r4, r1, 0x34
/* 807DA37C  4B A9 6B 71 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 807DA3A4  4B 84 2C 7D */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
lbl_807DA3A8:
...
/* 807DA3D0  4B A8 D0 25 */	bl __ct__5csXyzFsss
/* 807DA3D4  3B 20 00 00 */	li r25, 0
/* 807DA3D8  3B 00 00 00 */	li r24, 0
/* 807DA3DC  3A E0 00 00 */	li r23, 0
/* 807DA3E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807DA3E4  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_807DA3E8:
...
/* 807DA444  4B 87 30 89 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807DA4A0  4B 87 30 2D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807DA4F0  3C 80 80 7D */	lis r4, __dt__4cXyzFv@ha /* 0x807D2B48@ha */
/* 807DA4F4  38 84 2B 48 */	addi r4, r4, __dt__4cXyzFv@l /* 0x807D2B48@l */
...
/* 807DA514  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807DA518  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807DA56C  4B 87 2F 61 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
