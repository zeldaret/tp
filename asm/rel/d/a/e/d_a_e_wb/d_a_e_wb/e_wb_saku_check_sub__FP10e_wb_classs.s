...
/* 807D3DAC  4B B8 E4 31 */	bl _savegpr_29
/* 807D3DB0  7C 7D 1B 78 */	mr r29, r3
/* 807D3DB4  7C 9E 23 78 */	mr r30, r4
/* 807D3DB8  3C 60 80 7E */	lis r3, lit_3882@ha /* 0x807E298C@ha */
/* 807D3DBC  3B E3 29 8C */	addi r31, r3, lit_3882@l /* 0x807E298C@l */
/* 807D3DC0  38 61 00 9C */	addi r3, r1, 0x9c
/* 807D3DC4  4B 8A 37 B9 */	bl __ct__11dBgS_GndChkFv
/* 807D3DC8  38 61 00 2C */	addi r3, r1, 0x2c
/* 807D3DCC  4B 8A 3E 9D */	bl __ct__11dBgS_LinChkFv
...
/* 807D3DFC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807D3E00  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 807D3E14  4B 83 85 C9 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807D3E34  4B A9 D0 B9 */	bl MtxPosition__FP4cXyzP4cXyz
/* 807D3E38  38 61 00 14 */	addi r3, r1, 0x14
/* 807D3E3C  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 807D3E40  7C 65 1B 78 */	mr r5, r3
/* 807D3E44  4B B7 32 4D */	bl PSVECAdd
/* 807D3E48  38 61 00 9C */	addi r3, r1, 0x9c
/* 807D3E4C  38 81 00 14 */	addi r4, r1, 0x14
/* 807D3E50  4B A9 3E D9 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 807D3E54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D3E58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807D3E5C  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 807D3E60  7F C3 F3 78 */	mr r3, r30
/* 807D3E64  38 81 00 9C */	addi r4, r1, 0x9c
/* 807D3E68  4B 8A 06 39 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 807D3EB8  4B 8A 3E AD */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807D3EBC  7F C3 F3 78 */	mr r3, r30
/* 807D3EC0  38 81 00 2C */	addi r4, r1, 0x2c
/* 807D3EC4  4B 8A 04 F1 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 807D3ED8  4B 8A 3E 05 */	bl __dt__11dBgS_LinChkFv
/* 807D3EDC  38 61 00 9C */	addi r3, r1, 0x9c
/* 807D3EE0  38 80 FF FF */	li r4, -1
/* 807D3EE4  4B 8A 37 0D */	bl __dt__11dBgS_GndChkFv
...
/* 807D3EF8  4B 8A 3D E5 */	bl __dt__11dBgS_LinChkFv
/* 807D3EFC  38 61 00 9C */	addi r3, r1, 0x9c
/* 807D3F00  38 80 FF FF */	li r4, -1
/* 807D3F04  4B 8A 36 ED */	bl __dt__11dBgS_GndChkFv
...
/* 807D3F18  4B B8 E3 11 */	bl _restgpr_29
