...
/* 807D389C  4B B8 E9 35 */	bl _savegpr_26
/* 807D38A0  3C 80 80 7E */	lis r4, lit_3882@ha /* 0x807E298C@ha */
/* 807D38A4  3B E4 29 8C */	addi r31, r4, lit_3882@l /* 0x807E298C@l */
/* 807D38A8  7C 7E 1B 78 */	mr r30, r3
/* 807D38AC  38 61 00 20 */	addi r3, r1, 0x20
/* 807D38B0  4B 8A 3C CD */	bl __ct__11dBgS_GndChkFv
/* 807D38B4  3C 60 80 7E */	lis r3, struct_807E35B4+0x2@ha /* 0x807E35B6@ha */
/* 807D38B8  88 03 35 B6 */	lbz r0, struct_807E35B4+0x2@l(r3)  /* 0x807E35B6@l */
/* 807D38BC  7C 00 07 75 */	extsb. r0, r0
/* 807D38C0  41 82 01 38 */	beq lbl_807D39F8
/* 807D38C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D38C8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807D391C  4B 84 63 61 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 807D3920  38 61 00 20 */	addi r3, r1, 0x20
/* 807D3924  38 80 FF FF */	li r4, -1
/* 807D3928  4B 8A 3C C9 */	bl __dt__11dBgS_GndChkFv
...
/* 807D393C  3C 60 80 7E */	lis r3, chk_x@ha /* 0x807E2F7C@ha */
/* 807D3940  3B 63 2F 7C */	addi r27, r3, chk_x@l /* 0x807E2F7C@l */
/* 807D3944  3C 60 80 7E */	lis r3, chk_z@ha /* 0x807E2F8C@ha */
/* 807D3948  3B 83 2F 8C */	addi r28, r3, chk_z@l /* 0x807E2F8C@l */
...
/* 807D3974  4B A9 3D 01 */	bl cM_atan2s__Fff
...
/* 807D39C8  4B 8A 3C 29 */	bl __dt__11dBgS_GndChkFv
...
/* 807D39DC  4B 8A 3C 15 */	bl __dt__11dBgS_GndChkFv
...
lbl_807D39F8:
/* 807D39F8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 807D39FC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 807D3A00  80 63 00 00 */	lwz r3, 0(r3)
/* 807D3A04  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 807D3A08  4B 83 89 D5 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 807D3A28  4B A9 D4 C5 */	bl MtxPosition__FP4cXyzP4cXyz
/* 807D3A2C  38 61 00 08 */	addi r3, r1, 8
/* 807D3A30  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 807D3A34  7C 65 1B 78 */	mr r5, r3
/* 807D3A38  4B B7 36 59 */	bl PSVECAdd
/* 807D3A3C  38 61 00 20 */	addi r3, r1, 0x20
/* 807D3A40  38 81 00 08 */	addi r4, r1, 8
/* 807D3A44  4B A9 42 E5 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 807D3A48  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807D3A4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807D3A50  3B 63 0F 38 */	addi r27, r3, 0xf38
/* 807D3A54  7F 63 DB 78 */	mr r3, r27
/* 807D3A58  38 81 00 20 */	addi r4, r1, 0x20
/* 807D3A5C  4B 8A 0A 45 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 807D3A7C  4B 8A 3B 75 */	bl __dt__11dBgS_GndChkFv
...
/* 807D3AE0  4B 8A 3B 11 */	bl __dt__11dBgS_GndChkFv
...
/* 807D3B50  4B 8A 3A A1 */	bl __dt__11dBgS_GndChkFv
...
/* 807D3B64  4B 8A 3A 8D */	bl __dt__11dBgS_GndChkFv
...
/* 807D3B80  4B B8 E6 9D */	bl _restgpr_26
