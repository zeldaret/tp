...
/* 806CFC00  4B C9 25 C5 */	bl _savegpr_23
/* 806CFC04  7C 7A 1B 78 */	mr r26, r3
/* 806CFC08  3C 60 80 6D */	lis r3, lit_3907@ha /* 0x806D0E60@ha */
/* 806CFC0C  3B C3 0E 60 */	addi r30, r3, lit_3907@l /* 0x806D0E60@l */
...
/* 806CFC24  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CFC28  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CFC2C  4B C7 68 85 */	bl PSMTXCopy
/* 806CFC30  C0 3E 00 04 */	lfs f1, 4(r30)
/* 806CFC34  FC 40 08 90 */	fmr f2, f1
/* 806CFC38  FC 60 08 90 */	fmr f3, f1
/* 806CFC3C  4B 93 D1 61 */	bl transM__14mDoMtx_stack_cFfff
/* 806CFC40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CFC44  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806CFC90  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CFC94  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806CFCB0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CFCB4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CFCB8  4B C7 67 F9 */	bl PSMTXCopy
/* 806CFCBC  C0 3E 00 F8 */	lfs f1, 0xf8(r30)
/* 806CFCC0  C0 5E 00 04 */	lfs f2, 4(r30)
/* 806CFCC4  FC 60 10 90 */	fmr f3, f2
/* 806CFCC8  4B 93 D0 D5 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806CFCDC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CFCE0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CFCE4  4B C7 67 CD */	bl PSMTXCopy
/* 806CFCE8  C0 3E 00 FC */	lfs f1, 0xfc(r30)
/* 806CFCEC  C0 5E 00 04 */	lfs f2, 4(r30)
/* 806CFCF0  FC 60 10 90 */	fmr f3, f2
/* 806CFCF4  4B 93 D0 A9 */	bl transM__14mDoMtx_stack_cFfff
lbl_806CFCF8:
...
/* 806CFD54  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CFD58  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CFD5C  4B C7 67 55 */	bl PSMTXCopy
/* 806CFD60  C0 3E 00 04 */	lfs f1, 4(r30)
/* 806CFD64  C0 5E 00 DC */	lfs f2, 0xdc(r30)
/* 806CFD68  FC 60 08 90 */	fmr f3, f1
/* 806CFD6C  4B 93 D0 31 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806CFD84  4B 93 D0 19 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806CFDE0  4B C9 24 31 */	bl _restgpr_23
