...
/* 806D0A30  4B C9 17 85 */	bl _savegpr_19
/* 806D0A34  7C 7E 1B 78 */	mr r30, r3
/* 806D0A38  7C 9A 23 78 */	mr r26, r4
/* 806D0A3C  7C BB 2B 78 */	mr r27, r5
/* 806D0A40  7C DC 33 78 */	mr r28, r6
/* 806D0A44  3C 60 80 6D */	lis r3, cNullVec__6Z2Calc@ha /* 0x806D0F84@ha */
/* 806D0A48  3A E3 0F 84 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x806D0F84@l */
/* 806D0A4C  3C 60 80 6D */	lis r3, lit_3907@ha /* 0x806D0E60@ha */
/* 806D0A50  3B E3 0E 60 */	addi r31, r3, lit_3907@l /* 0x806D0E60@l */
/* 806D0A54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D0A58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806D0A5C  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 806D0A60  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806D0A64  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 806D0A8C  4B AD BA F1 */	bl dKy_darkworld_check__Fv
...
/* 806D0AB0  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806D0AB4  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 806D0ACC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D0AD0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D0AD4  4B C7 59 DD */	bl PSMTXCopy
...
/* 806D0AEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806D0AF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806D0AF4  38 81 00 4C */	addi r4, r1, 0x4c
/* 806D0AF8  38 A1 00 58 */	addi r5, r1, 0x58
/* 806D0AFC  4B C7 62 71 */	bl PSMTXMultVec
/* 806D0B00  38 61 00 34 */	addi r3, r1, 0x34
/* 806D0B04  38 81 00 58 */	addi r4, r1, 0x58
/* 806D0B08  7F 65 DB 78 */	mr r5, r27
/* 806D0B0C  4B B9 60 29 */	bl __mi__4cXyzCFRC3Vec
...
/* 806D0B28  4B B9 6B 4D */	bl cM_atan2s__Fff
...
/* 806D0B5C  4B B9 6B 19 */	bl cM_atan2s__Fff
...
/* 806D0B78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D0B7C  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806D0BCC  4B 97 BE C5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806D0BD0  7C 79 1B 79 */	or. r25, r3, r3
/* 806D0BD4  41 82 00 FC */	beq lbl_806D0CD0
/* 806D0BD8  38 61 00 40 */	addi r3, r1, 0x40
/* 806D0BDC  4B C7 65 5D */	bl PSVECSquareMag
...
/* 806D0C4C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D0C50  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806D0CBC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806D0CC0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806D0CC4:
...
/* 806D0D14  4B 97 BD 7D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806D0D50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806D0D54  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806D0DC0  4B 97 C7 0D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806D0E20  4B C9 13 E1 */	bl _restgpr_19
