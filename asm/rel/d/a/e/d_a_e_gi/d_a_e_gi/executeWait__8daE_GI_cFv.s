...
/* 806CE6C4  4B C9 3B 19 */	bl _savegpr_29
/* 806CE6C8  7C 7E 1B 78 */	mr r30, r3
/* 806CE6CC  3C 80 80 6D */	lis r4, lit_3907@ha /* 0x806D0E60@ha */
/* 806CE6D0  3B A4 0E 60 */	addi r29, r4, lit_3907@l /* 0x806D0E60@l */
/* 806CE6D4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CE6D8  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CE6DC  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 806CE6E0  4B 94 C1 01 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806CE740  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CE744  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CE748  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806CE74C  7C 05 07 74 */	extsb r5, r0
/* 806CE750  4B 96 6C 11 */	bl isSwitch__10dSv_info_cCFii
/* 806CE754  2C 03 00 00 */	cmpwi r3, 0
/* 806CE758  41 82 00 E0 */	beq lbl_806CE838
lbl_806CE75C:
/* 806CE75C  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D1138@ha */
/* 806CE760  38 63 11 38 */	addi r3, r3, l_HIO@l /* 0x806D1138@l */
...
/* 806CE778  4B 94 BF 99 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806CE77C  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 806CE780  7C 00 18 50 */	subf r0, r0, r3
/* 806CE784  7C 03 07 34 */	extsh r3, r0
/* 806CE788  4B C9 69 49 */	bl abs
/* 806CE78C  3C 80 80 6D */	lis r4, l_HIO@ha /* 0x806D1138@ha */
/* 806CE790  38 84 11 38 */	addi r4, r4, l_HIO@l /* 0x806D1138@l */
...
/* 806CE7B8  4B 94 E6 45 */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806CE7BC  2C 03 00 00 */	cmpwi r3, 0
/* 806CE7C0  40 82 00 50 */	bne lbl_806CE810
/* 806CE7C4  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D1138@ha */
/* 806CE7C8  38 63 11 38 */	addi r3, r3, l_HIO@l /* 0x806D1138@l */
...
lbl_806CE810:
/* 806CE810  3C 60 80 6D */	lis r3, s_battle_gi__FPvPv@ha /* 0x806CE31C@ha */
/* 806CE814  38 63 E3 1C */	addi r3, r3, s_battle_gi__FPvPv@l /* 0x806CE31C@l */
/* 806CE818  7F C4 F3 78 */	mr r4, r30
/* 806CE81C  4B 95 2B 1D */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 806CE844  4B C9 39 E5 */	bl _restgpr_29
