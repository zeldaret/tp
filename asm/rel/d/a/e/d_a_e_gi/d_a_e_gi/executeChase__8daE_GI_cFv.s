...
/* 806CE868  4B C9 39 75 */	bl _savegpr_29
/* 806CE86C  7C 7E 1B 78 */	mr r30, r3
/* 806CE870  3C 60 80 6D */	lis r3, lit_3907@ha /* 0x806D0E60@ha */
/* 806CE874  3B E3 0E 60 */	addi r31, r3, lit_3907@l /* 0x806D0E60@l */
...
/* 806CE934  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CE938  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CE93C  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 806CE940  4B 94 BE A1 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806CE944  C0 5F 00 B0 */	lfs f2, 0xb0(r31)
/* 806CE948  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D1138@ha */
/* 806CE94C  38 63 11 38 */	addi r3, r3, l_HIO@l /* 0x806D1138@l */
...
/* 806CE968  4B 94 BD A9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806CE96C  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 806CE970  7C 00 18 50 */	subf r0, r0, r3
/* 806CE974  7C 03 07 34 */	extsh r3, r0
/* 806CE978  4B C9 67 59 */	bl abs
...
/* 806CE98C  4B 94 E4 71 */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806CE9B4  4B C5 9A 79 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806CEA18  3C 80 80 6D */	lis r4, l_HIO@ha /* 0x806D1138@ha */
/* 806CEA1C  38 84 11 38 */	addi r4, r4, l_HIO@l /* 0x806D1138@l */
...
/* 806CEA34  4B BA 1D 0D */	bl cLib_chaseF__FPfff
...
/* 806CEA60  3C 80 80 6D */	lis r4, l_HIO@ha /* 0x806D1138@ha */
/* 806CEA64  38 84 11 38 */	addi r4, r4, l_HIO@l /* 0x806D1138@l */
/* 806CEA68  C0 04 00 0C */	lfs f0, 0xc(r4)
/* 806CEA6C  EC 21 00 2A */	fadds f1, f1, f0
/* 806CEA70  C0 5F 00 58 */	lfs f2, 0x58(r31)
/* 806CEA74  4B BA 1C CD */	bl cLib_chaseF__FPfff
...
/* 806CEA88  4B BA 1C B9 */	bl cLib_chaseF__FPfff
lbl_806CEA8C:
/* 806CEA8C  7F C3 F3 78 */	mr r3, r30
/* 806CEA90  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CEA94  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CEA98  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 806CEA9C  4B 94 BC 75 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806CEAB4  4B BA 1A 8D */	bl cLib_addCalcAngleS__FPsssss
...
/* 806CEAC8  4B 94 BD 19 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806CEACC  C0 5F 00 B0 */	lfs f2, 0xb0(r31)
/* 806CEAD0  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D1138@ha */
/* 806CEAD4  38 63 11 38 */	addi r3, r3, l_HIO@l /* 0x806D1138@l */
...
/* 806CEAF0  4B 94 BC 21 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806CEAF4  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 806CEAF8  7C 00 18 50 */	subf r0, r0, r3
/* 806CEAFC  7C 03 07 34 */	extsh r3, r0
/* 806CEB00  4B C9 65 D1 */	bl abs
...
/* 806CEB14  4B 94 E2 E9 */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806CEB84  4B 94 BC 5D */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806CEB88  C0 5F 00 C0 */	lfs f2, 0xc0(r31)
/* 806CEB8C  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D1138@ha */
/* 806CEB90  38 63 11 38 */	addi r3, r3, l_HIO@l /* 0x806D1138@l */
...
/* 806CEBC8  4B C5 98 65 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806CEC80  4B C9 35 A9 */	bl _restgpr_29
