...
/* 806CDFC8  3C 60 80 6D */	lis r3, lit_3907@ha /* 0x806D0E60@ha */
/* 806CDFCC  3B C3 0E 60 */	addi r30, r3, lit_3907@l /* 0x806D0E60@l */
/* 806CDFD0  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D1138@ha */
/* 806CDFD4  38 63 11 38 */	addi r3, r3, l_HIO@l /* 0x806D1138@l */
...
/* 806CDFF0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CDFF4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CDFF8  4B C7 84 B9 */	bl PSMTXCopy
/* 806CDFFC  C0 3E 00 78 */	lfs f1, 0x78(r30)
/* 806CE000  C0 5E 00 7C */	lfs f2, 0x7c(r30)
/* 806CE004  C0 7E 00 04 */	lfs f3, 4(r30)
/* 806CE008  4B 93 ED 95 */	bl transM__14mDoMtx_stack_cFfff
/* 806CE00C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CE010  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806CE030  4B 9A 95 4D */	bl __ct__11dBgS_GndChkFv
/* 806CE034  38 61 00 30 */	addi r3, r1, 0x30
/* 806CE038  38 81 00 18 */	addi r4, r1, 0x18
/* 806CE03C  4B B9 9C ED */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 806CE040  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CE044  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CE048  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806CE04C  38 81 00 30 */	addi r4, r1, 0x30
/* 806CE050  4B 9A 64 51 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 806CE07C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CE080  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806CE0A8  4B 97 F5 FD */	bl setPoly__13dPa_control_cFUlUsR13cBgS_PolyInfoPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyziP18dPa_levelEcallBackScPC4cXyz
/* 806CE0AC  90 7F 10 74 */	stw r3, 0x1074(r31)
/* 806CE0B0  38 61 00 30 */	addi r3, r1, 0x30
/* 806CE0B4  38 80 FF FF */	li r4, -1
/* 806CE0B8  4B 9A 95 39 */	bl __dt__11dBgS_GndChkFv
