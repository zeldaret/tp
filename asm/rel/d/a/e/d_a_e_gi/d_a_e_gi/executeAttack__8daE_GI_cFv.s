...
/* 806CECA4  4B C9 35 39 */	bl _savegpr_29
/* 806CECA8  7C 7E 1B 78 */	mr r30, r3
/* 806CECAC  3C 80 80 6D */	lis r4, lit_3907@ha /* 0x806D0E60@ha */
/* 806CECB0  3B E4 0E 60 */	addi r31, r4, lit_3907@l /* 0x806D0E60@l */
...
/* 806CECC8  3C 80 80 6D */	lis r4, lit_4707@ha /* 0x806D1044@ha */
/* 806CECCC  38 84 10 44 */	addi r4, r4, lit_4707@l /* 0x806D1044@l */
...
/* 806CED18  4B C5 97 15 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806CED58  4B C5 96 D5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806CED9C  4B C5 96 91 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806CEDFC  4B BA 19 45 */	bl cLib_chaseF__FPfff
/* 806CEE00  7F C3 F3 78 */	mr r3, r30
/* 806CEE04  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CEE08  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CEE0C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806CEE10  4B 94 B9 01 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806CEE30  4B BA 17 11 */	bl cLib_addCalcAngleS__FPsssss
...
/* 806CEE64  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CEE68  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CEE6C  4B C7 76 45 */	bl PSMTXCopy
/* 806CEE70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CEE74  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806CEE9C  4B 93 DF 01 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806CEEBC  4B 9A 8D AD */	bl __ct__11dBgS_LinChkFv
...
/* 806CEED0  4B 9A 8E 95 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806CEED4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CEED8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CEEDC  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806CEEE0  38 81 00 2C */	addi r4, r1, 0x2c
/* 806CEEE4  4B 9A 54 D1 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 806CEEE8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 806CEEEC  41 82 00 50 */	beq lbl_806CEF3C
/* 806CEEF0  38 C1 00 5C */	addi r6, r1, 0x5c
/* 806CEEF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CEEF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806CEF14  4B 97 D3 05 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 806CEF74  4B C5 94 B9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806CEFD8  4B C5 94 55 */	bl checkPass__12J3DFrameCtrlFf
...
lbl_806CF01C:
/* 806CF01C  3C 60 80 6D */	lis r3, m_cry_gi@ha /* 0x806D1164@ha */
/* 806CF020  38 63 11 64 */	addi r3, r3, m_cry_gi@l /* 0x806D1164@l */
...
/* 806CF034  4B B9 89 21 */	bl cM_rndF__Ff
...
/* 806CF064  4B B9 88 F1 */	bl cM_rndF__Ff
...
/* 806CF0A4  4B C9 31 85 */	bl _restgpr_29
