...
/* 806CFB7C  4B 93 D1 E9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 806CFB80  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 806CFB84  4B 93 D3 C1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806CFB88  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D1138@ha */
/* 806CFB8C  38 63 11 38 */	addi r3, r3, l_HIO@l /* 0x806D1138@l */
/* 806CFB90  C0 23 00 08 */	lfs f1, 8(r3)
/* 806CFB94  FC 40 08 90 */	fmr f2, f1
/* 806CFB98  FC 60 08 90 */	fmr f3, f1
/* 806CFB9C  4B 93 D2 9D */	bl scaleM__14mDoMtx_stack_cFfff
/* 806CFBA0  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 806CFBA4  83 E3 00 04 */	lwz r31, 4(r3)
/* 806CFBA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CFBAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CFBB0  38 9F 00 24 */	addi r4, r31, 0x24
/* 806CFBB4  4B C7 68 FD */	bl PSMTXCopy
/* 806CFBB8  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 806CFBBC  4B 94 16 31 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 806CFBD4  4B C7 68 DD */	bl PSMTXCopy
