...
/* 806CE194  4B C9 40 3D */	bl _savegpr_26
/* 806CE198  7C 7F 1B 78 */	mr r31, r3
/* 806CE19C  3C 60 80 6D */	lis r3, l_HIO@ha /* 0x806D1138@ha */
/* 806CE1A0  38 63 11 38 */	addi r3, r3, l_HIO@l /* 0x806D1138@l */
...
/* 806CE1C8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CE1CC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806CE1D0  4B C7 82 E1 */	bl PSMTXCopy
/* 806CE1D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806CE1D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806CE1FC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806CE200  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806CE204  3C 60 80 6D */	lis r3, gi_damage_eff_id@ha /* 0x806D103C@ha */
/* 806CE208  3B 83 10 3C */	addi r28, r3, gi_damage_eff_id@l /* 0x806D103C@l */
/* 806CE20C  3C 60 80 6D */	lis r3, lit_3909@ha /* 0x806D0E68@ha */
/* 806CE210  3B A3 0E 68 */	addi r29, r3, lit_3909@l /* 0x806D0E68@l */
lbl_806CE214:
...
/* 806CE254  4B 97 E8 3D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806CE26C  4B C9 3F B1 */	bl _restgpr_26
