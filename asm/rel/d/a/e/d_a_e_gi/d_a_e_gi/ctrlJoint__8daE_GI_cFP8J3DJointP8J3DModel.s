...
/* 806CD504  4B C9 4C D4 */	b _savegpr_28
...
/* 806CD524  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806CD528  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806CD52C  4B C7 8F 84 */	b PSMTXCopy
/* 806CD530  2C 1F 00 03 */	cmpwi r31, 3
/* 806CD534  41 82 00 08 */	beq lbl_806CD53C
/* 806CD538  48 00 00 14 */	b lbl_806CD54C
lbl_806CD53C:
/* 806CD53C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806CD540  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806CD544  A8 9C 06 7E */	lha r4, 0x67e(r28)
/* 806CD548  4B 93 EE 54 */	b mDoMtx_XrotM__FPA4_fs
lbl_806CD54C:
/* 806CD54C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806CD550  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806CD554  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 806CD558  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806CD55C  7C 80 F2 14 */	add r4, r0, r30
/* 806CD560  4B C7 8F 50 */	b PSMTXCopy
/* 806CD564  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806CD568  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806CD56C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 806CD570  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 806CD574  4B C7 8F 3C */	b PSMTXCopy
/* 806CD578  38 60 00 01 */	li r3, 1
/* 806CD57C  39 61 00 20 */	addi r11, r1, 0x20
/* 806CD580  4B C9 4C A4 */	b _restgpr_28
