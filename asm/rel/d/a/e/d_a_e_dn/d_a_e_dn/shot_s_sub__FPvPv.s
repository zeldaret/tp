...
/* 804E7B84  4B E7 A6 58 */	b _savegpr_29
/* 804E7B88  7C 7F 1B 78 */	mr r31, r3
/* 804E7B8C  7C 9D 23 78 */	mr r29, r4
/* 804E7B90  3C 80 80 4F */	lis r4, lit_3789@ha
/* 804E7B94  3B C4 E8 AC */	addi r30, r4, lit_3789@l
/* 804E7B98  4B B3 11 48 */	b fopAc_IsActor__FPv
/* 804E7B9C  2C 03 00 00 */	cmpwi r3, 0
/* 804E7BA0  41 82 01 5C */	beq lbl_804E7CFC
/* 804E7BA4  3C 60 80 4F */	lis r3, learn_check@ha
/* 804E7BA8  80 03 EF 90 */	lwz r0, learn_check@l(r3)
...
/* 804E7BE0  4B D7 EF 54 */	b __mi__4cXyzCFRC3Vec
...
/* 804E7C00  4B E5 F5 38 */	b PSVECSquareMag
...
/* 804E7C70  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804E7C74  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 804E7CE0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804E7CE4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_804E7CE8:
...
/* 804E7D04  4B E7 A5 24 */	b _restgpr_29
