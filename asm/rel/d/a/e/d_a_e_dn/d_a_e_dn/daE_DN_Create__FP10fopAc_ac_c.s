...
/* 804EDAFC  4B E7 46 C9 */	bl _savegpr_23
/* 804EDB00  7C 7C 1B 78 */	mr r28, r3
/* 804EDB04  3C 80 80 4F */	lis r4, lit_1109@ha /* 0x804EEEF0@ha */
/* 804EDB08  3B A4 EE F0 */	addi r29, r4, lit_1109@l /* 0x804EEEF0@l */
/* 804EDB0C  3C 80 80 4F */	lis r4, cNullVec__6Z2Calc@ha /* 0x804EEA40@ha */
/* 804EDB10  3B C4 EA 40 */	addi r30, r4, cNullVec__6Z2Calc@l /* 0x804EEA40@l */
/* 804EDB14  3C 80 80 4F */	lis r4, lit_3789@ha /* 0x804EE8AC@ha */
/* 804EDB18  3B E4 E8 AC */	addi r31, r4, lit_3789@l /* 0x804EE8AC@l */
...
/* 804EDB44  3C 80 80 4F */	lis r4, d_a_e_dn__stringBase0@ha /* 0x804EEA34@ha */
/* 804EDB48  38 84 EA 34 */	addi r4, r4, d_a_e_dn__stringBase0@l /* 0x804EEA34@l */
/* 804EDB4C  4B B3 F3 71 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 804EDB6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804EDB70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804EDB74  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 804EDB78  7C 05 07 74 */	extsb r5, r0
/* 804EDB7C  4B B4 77 E5 */	bl isSwitch__10dSv_info_cCFii
...
/* 804EDC14  3C 80 80 4F */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x804ED8AC@ha */
/* 804EDC18  38 84 D8 AC */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x804ED8AC@l */
/* 804EDC1C  38 A0 3B F0 */	li r5, 0x3bf0
/* 804EDC20  4B B2 C8 91 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 804EDC8C  4B B2 C8 9D */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 804EDCA0  4B B2 C8 99 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 804EDCCC  4B B8 85 7D */	bl Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 804EDCD0  38 7C 08 44 */	addi r3, r28, 0x844
/* 804EDCD4  C0 3F 01 60 */	lfs f1, 0x160(r31)
/* 804EDCD8  C0 5F 00 00 */	lfs f2, 0(r31)
/* 804EDCDC  4B B8 82 7D */	bl SetWall__12dBgS_AcchCirFff
...
/* 804EDD18  4B B9 5B 49 */	bl Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 804EDD34  4B B9 6D 01 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 804EDD54  4B B9 6C E1 */	bl Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 804EDDF0  4B B8 81 69 */	bl SetWall__12dBgS_AcchCirFff
lbl_804EDDF4:
...
/* 804EDE08  4B DD 32 8D */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 804EDE0C  38 7C 05 E8 */	addi r3, r28, 0x5e8
/* 804EDE10  3C 80 80 4F */	lis r4, d_a_e_dn__stringBase0@ha /* 0x804EEA34@ha */
/* 804EDE14  38 84 EA 34 */	addi r4, r4, d_a_e_dn__stringBase0@l /* 0x804EEA34@l */
/* 804EDE18  4B DD 3D 79 */	bl setEnemyName__15Z2CreatureEnemyFPCc
...
/* 804EDE44  4B E7 43 CD */	bl _restgpr_23
