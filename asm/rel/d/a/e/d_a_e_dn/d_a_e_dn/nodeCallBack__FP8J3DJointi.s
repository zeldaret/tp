...
/* 804E538C  4B E7 CE 49 */	bl _savegpr_27
/* 804E5390  2C 04 00 00 */	cmpwi r4, 0
/* 804E5394  40 82 04 88 */	bne lbl_804E581C
/* 804E5398  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 804E539C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 804E53A0  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 804E53C4  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804E53C8  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804E53CC  80 84 00 00 */	lwz r4, 0(r4)
/* 804E53D0  4B E6 10 E1 */	bl PSMTXCopy
...
/* 804E53E4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E53E8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E53EC  80 63 00 00 */	lwz r3, 0(r3)
/* 804E53F0  A8 9C 08 32 */	lha r4, 0x832(r28)
/* 804E53F4  4B B2 70 41 */	bl mDoMtx_YrotM__FPA4_fs
/* 804E53F8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E53FC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E54D8  4B B2 6F 5D */	bl mDoMtx_YrotM__FPA4_fs
/* 804E54DC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E54E0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E54F8  4B B2 6F D5 */	bl mDoMtx_ZrotM__FPA4_fs
...
lbl_804E5510:
/* 804E5510  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5514  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E5534  4B B2 6F 01 */	bl mDoMtx_YrotM__FPA4_fs
/* 804E5538  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E553C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E555C  4B B2 6F 71 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804E5560  48 00 01 04 */	b lbl_804E5664
lbl_804E5564:
/* 804E5564  2C 1F 00 0B */	cmpwi r31, 0xb
/* 804E5568  40 82 00 28 */	bne lbl_804E5590
/* 804E556C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5570  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E5588  4B B2 6F 45 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804E558C  48 00 00 D8 */	b lbl_804E5664
lbl_804E5590:
/* 804E5590  2C 1F 00 0C */	cmpwi r31, 0xc
/* 804E5594  40 82 00 28 */	bne lbl_804E55BC
/* 804E5598  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E559C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E55B4  4B B2 6F 19 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804E55B8  48 00 00 AC */	b lbl_804E5664
lbl_804E55BC:
/* 804E55BC  2C 1F 00 11 */	cmpwi r31, 0x11
/* 804E55C0  40 82 00 28 */	bne lbl_804E55E8
/* 804E55C4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E55C8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E55E0  4B B2 6E ED */	bl mDoMtx_ZrotM__FPA4_fs
/* 804E55E4  48 00 00 80 */	b lbl_804E5664
lbl_804E55E8:
/* 804E55E8  2C 1F 00 12 */	cmpwi r31, 0x12
/* 804E55EC  40 82 00 28 */	bne lbl_804E5614
/* 804E55F0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E55F4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E560C  4B B2 6E C1 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 804E5624  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5628  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E5648  4B B2 6D ED */	bl mDoMtx_YrotM__FPA4_fs
/* 804E564C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5650  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E5654  80 63 00 00 */	lwz r3, 0(r3)
/* 804E5658  7C 9C DA 14 */	add r4, r28, r27
/* 804E565C  A8 84 07 54 */	lha r4, 0x754(r4)
/* 804E5660  4B B2 6E 6D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_804E5664:
...
/* 804E5678  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E567C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E5680  80 63 00 00 */	lwz r3, 0(r3)
/* 804E5684  4B B2 6D B1 */	bl mDoMtx_YrotM__FPA4_fs
/* 804E5688  48 00 00 38 */	b lbl_804E56C0
lbl_804E568C:
/* 804E568C  57 E0 07 BD */	rlwinm. r0, r31, 0, 0x1e, 0x1e
/* 804E5690  41 82 00 18 */	beq lbl_804E56A8
/* 804E5694  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5698  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E569C  80 63 00 00 */	lwz r3, 0(r3)
/* 804E56A0  4B B2 6C FD */	bl mDoMtx_XrotM__FPA4_fs
/* 804E56A4  48 00 00 1C */	b lbl_804E56C0
lbl_804E56A8:
/* 804E56A8  57 E0 07 7B */	rlwinm. r0, r31, 0, 0x1d, 0x1d
/* 804E56AC  41 82 00 14 */	beq lbl_804E56C0
/* 804E56B0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E56B4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E56B8  80 63 00 00 */	lwz r3, 0(r3)
/* 804E56BC  4B B2 6E 11 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_804E56C0:
/* 804E56C0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E56C4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E56D8  4B E6 0D D9 */	bl PSMTXCopy
/* 804E56DC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E56E0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E56E4  80 63 00 00 */	lwz r3, 0(r3)
/* 804E56E8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 804E56EC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 804E56F0  4B E6 0D C1 */	bl PSMTXCopy
...
/* 804E5708  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804E570C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804E5710  80 84 00 00 */	lwz r4, 0(r4)
/* 804E5714  4B E6 0D 9D */	bl PSMTXCopy
/* 804E5718  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E571C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E5720  80 63 00 00 */	lwz r3, 0(r3)
/* 804E5724  38 80 00 00 */	li r4, 0
/* 804E5728  4B B2 6D 0D */	bl mDoMtx_YrotM__FPA4_fs
/* 804E572C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5730  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E5734  80 63 00 00 */	lwz r3, 0(r3)
/* 804E5738  38 80 00 00 */	li r4, 0
/* 804E573C  4B B2 6C 61 */	bl mDoMtx_XrotM__FPA4_fs
/* 804E5740  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5744  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E5748  80 63 00 00 */	lwz r3, 0(r3)
/* 804E574C  38 80 00 00 */	li r4, 0
/* 804E5750  4B B2 6D 7D */	bl mDoMtx_ZrotM__FPA4_fs
/* 804E5754  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5758  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E576C  4B E6 0D 45 */	bl PSMTXCopy
/* 804E5770  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5774  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E5778  80 63 00 00 */	lwz r3, 0(r3)
/* 804E577C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 804E5780  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 804E5784  4B E6 0D 2D */	bl PSMTXCopy
lbl_804E5788:
...
/* 804E579C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804E57A0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804E57A4  80 84 00 00 */	lwz r4, 0(r4)
/* 804E57A8  4B E6 0D 09 */	bl PSMTXCopy
/* 804E57AC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E57B0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E57B4  80 63 00 00 */	lwz r3, 0(r3)
/* 804E57B8  38 80 00 00 */	li r4, 0
/* 804E57BC  4B B2 6C 79 */	bl mDoMtx_YrotM__FPA4_fs
/* 804E57C0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E57C4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E57C8  80 63 00 00 */	lwz r3, 0(r3)
/* 804E57CC  38 80 00 00 */	li r4, 0
/* 804E57D0  4B B2 6B CD */	bl mDoMtx_XrotM__FPA4_fs
/* 804E57D4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E57D8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E57DC  80 63 00 00 */	lwz r3, 0(r3)
/* 804E57E0  38 80 00 00 */	li r4, 0
/* 804E57E4  4B B2 6C E9 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804E57E8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E57EC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 804E5800  4B E6 0C B1 */	bl PSMTXCopy
/* 804E5804  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E5808  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E580C  80 63 00 00 */	lwz r3, 0(r3)
/* 804E5810  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 804E5814  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 804E5818  4B E6 0C 99 */	bl PSMTXCopy
lbl_804E581C:
/* 804E581C  38 60 00 01 */	li r3, 1
/* 804E5820  39 61 00 20 */	addi r11, r1, 0x20
/* 804E5824  4B E7 C9 FD */	bl _restgpr_27
