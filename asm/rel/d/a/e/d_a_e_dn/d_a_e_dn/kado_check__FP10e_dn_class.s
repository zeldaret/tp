...
/* 804E9824  4B E7 89 AD */	bl _savegpr_26
/* 804E9828  7C 7A 1B 78 */	mr r26, r3
/* 804E982C  3C 60 80 4F */	lis r3, lit_3789@ha /* 0x804EE8AC@ha */
/* 804E9830  3B C3 E8 AC */	addi r30, r3, lit_3789@l /* 0x804EE8AC@l */
/* 804E9834  7F 5C D3 78 */	mr r28, r26
/* 804E9838  38 61 00 2C */	addi r3, r1, 0x2c
/* 804E983C  4B B8 E4 2D */	bl __ct__11dBgS_LinChkFv
/* 804E9840  3B 60 00 00 */	li r27, 0
/* 804E9844  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804E9848  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804E984C  80 63 00 00 */	lwz r3, 0(r3)
/* 804E9850  A8 9A 07 26 */	lha r4, 0x726(r26)
/* 804E9854  4B B2 2B 89 */	bl mDoMtx_YrotS__FPA4_fs
/* 804E9858  3B 40 00 00 */	li r26, 0
/* 804E985C  3B E0 00 00 */	li r31, 0
/* 804E9860  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804E9864  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804E9880  3C 60 80 4F */	lis r3, kado_check_x@ha /* 0x804EEB00@ha */
/* 804E9884  3B C3 EB 00 */	addi r30, r3, kado_check_x@l /* 0x804EEB00@l */
lbl_804E9888:
...
/* 804E990C  4B B8 E4 59 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 804E9910  7F A3 EB 78 */	mr r3, r29
/* 804E9914  38 81 00 2C */	addi r4, r1, 0x2c
/* 804E9918  4B B8 AA 9D */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 804E991C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804E9920  41 82 00 14 */	beq lbl_804E9934
/* 804E9924  3C 60 80 4F */	lis r3, kado_bit@ha /* 0x804EEAF8@ha */
/* 804E9928  38 63 EA F8 */	addi r3, r3, kado_bit@l /* 0x804EEAF8@l */
...
/* 804E9958  4B B8 E3 85 */	bl __dt__11dBgS_LinChkFv
...
/* 804E998C  4B E7 88 91 */	bl _restgpr_26
