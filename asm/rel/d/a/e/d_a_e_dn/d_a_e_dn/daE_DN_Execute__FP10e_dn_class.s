...
/* 804ECB60  4B E7 56 6D */	bl _savegpr_25
/* 804ECB64  7C 7F 1B 78 */	mr r31, r3
/* 804ECB68  3C 60 80 4F */	lis r3, lit_3789@ha /* 0x804EE8AC@ha */
/* 804ECB6C  3B C3 E8 AC */	addi r30, r3, lit_3789@l /* 0x804EE8AC@l */
...
lbl_804ECB84:
/* 804ECB84  3C 60 80 4F */	lis r3, c_start@ha /* 0x804EEF94@ha */
/* 804ECB88  80 03 EF 94 */	lwz r0, c_start@l(r3)  /* 0x804EEF94@l */
/* 804ECB8C  2C 00 00 00 */	cmpwi r0, 0
/* 804ECB90  40 82 00 50 */	bne lbl_804ECBE0
/* 804ECB94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804ECB98  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804ECB9C  88 04 4F AD */	lbz r0, 0x4fad(r4)
/* 804ECBA0  28 00 00 00 */	cmplwi r0, 0
/* 804ECBA4  41 82 00 3C */	beq lbl_804ECBE0
/* 804ECBA8  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 804ECBAC  83 23 10 18 */	lwz r25, m_midnaActor__9daPy_py_c@l(r3)  /* 0x80451018@l */
/* 804ECBB0  80 64 5D B4 */	lwz r3, 0x5db4(r4)
/* 804ECBB4  4B B2 EF 61 */	bl fopAcM_getTalkEventPartner__FPC10fopAc_ac_c
/* 804ECBB8  7C 03 C8 40 */	cmplw r3, r25
/* 804ECBBC  41 82 00 1C */	beq lbl_804ECBD8
/* 804ECBC0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804ECBC4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804ECCA0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804ECCA4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804ECCA8  80 63 00 00 */	lwz r3, 0(r3)
/* 804ECCAC  A8 9F 07 26 */	lha r4, 0x726(r31)
/* 804ECCB0  4B B1 F7 2D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 804ECD0C  4B D8 2D 31 */	bl cLib_addCalc2__FPffff
...
/* 804ECD20  4B D8 2D 61 */	bl cLib_addCalc0__FPfff
lbl_804ECD24:
/* 804ECD24  38 7F 08 84 */	addi r3, r31, 0x884
/* 804ECD28  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804ECD2C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804ECD30  38 84 0F 38 */	addi r4, r4, 0xf38
/* 804ECD34  4B B8 9D 79 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
lbl_804ECE18:
/* 804ECE18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECE1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804ECE34  4B E5 9A B5 */	bl PSMTXTrans
/* 804ECE38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECE3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECE40  A8 9F 07 2A */	lha r4, 0x72a(r31)
/* 804ECE44  4B B1 F5 59 */	bl mDoMtx_XrotM__FPA4_fs
/* 804ECE48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECE4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECE50  A8 9F 07 2E */	lha r4, 0x72e(r31)
/* 804ECE54  4B B1 F6 79 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804ECE58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECE5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECE60  A8 9F 07 26 */	lha r4, 0x726(r31)
/* 804ECE64  4B B1 F5 D1 */	bl mDoMtx_YrotM__FPA4_fs
/* 804ECE68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECE6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECE70  A8 9F 07 24 */	lha r4, 0x724(r31)
/* 804ECE74  4B B1 F5 29 */	bl mDoMtx_XrotM__FPA4_fs
/* 804ECE78  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECE7C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECE80  A8 1F 07 26 */	lha r0, 0x726(r31)
/* 804ECE84  7C 00 00 D0 */	neg r0, r0
/* 804ECE88  7C 04 07 34 */	extsh r4, r0
/* 804ECE8C  4B B1 F5 A9 */	bl mDoMtx_YrotM__FPA4_fs
/* 804ECE90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECE94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECE98  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 804ECE9C  4B B1 F5 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 804ECEA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECEA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECEA8  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 804ECEAC  4B B1 F4 F1 */	bl mDoMtx_XrotM__FPA4_fs
/* 804ECEB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECEB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECEB8  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 804ECEBC  4B B1 F6 11 */	bl mDoMtx_ZrotM__FPA4_fs
/* 804ECEC0  3C 60 80 4F */	lis r3, l_HIO@ha /* 0x804EEF3C@ha */
/* 804ECEC4  3B A3 EF 3C */	addi r29, r3, l_HIO@l /* 0x804EEF3C@l */
...
/* 804ECEDC  4B B1 FF 5D */	bl scaleM__14mDoMtx_stack_cFfff
/* 804ECEE0  80 7F 05 DC */	lwz r3, 0x5dc(r31)
/* 804ECEE4  83 83 00 04 */	lwz r28, 4(r3)
/* 804ECEE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ECEEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ECEF0  38 9C 00 24 */	addi r4, r28, 0x24
/* 804ECEF4  4B E5 95 BD */	bl PSMTXCopy
/* 804ECEF8  80 7F 05 DC */	lwz r3, 0x5dc(r31)
/* 804ECEFC  38 80 00 00 */	li r4, 0
/* 804ECF00  38 A0 00 00 */	li r5, 0
/* 804ECF04  4B B2 41 AD */	bl play__16mDoExt_McaMorfSOFUlSc
/* 804ECF08  7F E3 FB 78 */	mr r3, r31
/* 804ECF0C  4B FF F9 49 */	bl anm_se_set__FP10e_dn_class
/* 804ECF10  80 7F 05 DC */	lwz r3, 0x5dc(r31)
/* 804ECF14  4B B2 42 D9 */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 804ECF18  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 804ECF1C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 804ECF20  38 63 00 60 */	addi r3, r3, 0x60
/* 804ECF24  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804ECF28  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804ECF2C  80 84 00 00 */	lwz r4, 0(r4)
/* 804ECF30  4B E5 95 81 */	bl PSMTXCopy
...
/* 804ECF4C  4B D8 3F A1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804ECF6C  4B D8 3F 81 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804ECFD4  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804ECFD8  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804ECFDC  80 84 00 00 */	lwz r4, 0(r4)
/* 804ECFE0  4B E5 94 D1 */	bl PSMTXCopy
...
/* 804ED000  4B D8 3E ED */	bl MtxPosition__FP4cXyzP4cXyz
/* 804ED004  38 61 00 48 */	addi r3, r1, 0x48
/* 804ED008  38 9F 05 38 */	addi r4, r31, 0x538
/* 804ED00C  38 A1 00 78 */	addi r5, r1, 0x78
/* 804ED010  4B D7 9A D5 */	bl __pl__4cXyzCFRC3Vec
/* 804ED014  38 7F 0B C0 */	addi r3, r31, 0xbc0
/* 804ED018  38 81 00 48 */	addi r4, r1, 0x48
/* 804ED01C  4B D8 26 2D */	bl SetC__8cM3dGSphFRC4cXyz
/* 804ED020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804ED024  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804ED094  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804ED098  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804ED09C  80 84 00 00 */	lwz r4, 0(r4)
/* 804ED0A0  4B E5 94 11 */	bl PSMTXCopy
...
/* 804ED1A0  4B D7 7A 09 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 804ED1C8  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804ED1CC  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804ED1D0  80 84 00 00 */	lwz r4, 0(r4)
/* 804ED1D4  4B E5 92 DD */	bl PSMTXCopy
/* 804ED1D8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804ED1DC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804ED1E0  80 63 00 00 */	lwz r3, 0(r3)
/* 804ED1E4  80 9F 05 E4 */	lwz r4, 0x5e4(r31)
/* 804ED1E8  38 84 00 24 */	addi r4, r4, 0x24
/* 804ED1EC  4B E5 92 C5 */	bl PSMTXCopy
...
/* 804ED228  4B D8 3C C5 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804ED278  4B D8 24 91 */	bl SetR__8cM3dGSphFf
...
/* 804ED290  4B D8 24 79 */	bl SetR__8cM3dGSphFf
lbl_804ED294:
...
/* 804ED2C8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ED2CC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ED2D0  4B E5 91 E1 */	bl PSMTXCopy
/* 804ED2D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ED2D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804ED304  4B E5 9D 8D */	bl PSVECAdd
...
/* 804ED334  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ED338  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ED33C  C0 3F 06 98 */	lfs f1, 0x698(r31)
/* 804ED340  C0 5F 06 9C */	lfs f2, 0x69c(r31)
/* 804ED344  C0 7F 06 A0 */	lfs f3, 0x6a0(r31)
/* 804ED348  4B E5 95 A1 */	bl PSMTXTrans
/* 804ED34C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ED350  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ED354  A8 9F 06 B0 */	lha r4, 0x6b0(r31)
/* 804ED358  4B B1 F0 DD */	bl mDoMtx_YrotM__FPA4_fs
/* 804ED35C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ED360  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ED364  A8 9F 06 B2 */	lha r4, 0x6b2(r31)
/* 804ED368  4B B1 F0 35 */	bl mDoMtx_XrotM__FPA4_fs
lbl_804ED36C:
/* 804ED36C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ED370  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ED374  80 9F 06 90 */	lwz r4, 0x690(r31)
/* 804ED378  38 84 00 24 */	addi r4, r4, 0x24
/* 804ED37C  4B E5 91 35 */	bl PSMTXCopy
lbl_804ED380:
...
/* 804ED394  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804ED398  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804ED39C  80 84 00 00 */	lwz r4, 0(r4)
/* 804ED3A0  4B E5 91 11 */	bl PSMTXCopy
/* 804ED3A4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804ED3A8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804ED3AC  80 63 00 00 */	lwz r3, 0(r3)
/* 804ED3B0  80 9F 06 8C */	lwz r4, 0x68c(r31)
/* 804ED3B4  38 84 00 24 */	addi r4, r4, 0x24
/* 804ED3B8  4B E5 90 F9 */	bl PSMTXCopy
...
/* 804ED3E8  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804ED3EC  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804ED3F0  80 84 00 00 */	lwz r4, 0(r4)
/* 804ED3F4  4B E5 90 BD */	bl PSMTXCopy
...
/* 804ED410  4B D8 3A DD */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 804ED45C  4B D8 22 AD */	bl SetR__8cM3dGSphFf
lbl_804ED460:
...
/* 804ED490  4B D7 96 55 */	bl __pl__4cXyzCFRC3Vec
/* 804ED494  38 7F 0F 68 */	addi r3, r31, 0xf68
/* 804ED498  38 81 00 24 */	addi r4, r1, 0x24
/* 804ED49C  4B D8 21 AD */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 804ED4BC  4B D7 76 ED */	bl Set__4cCcSFP8cCcD_Obj
...
/* 804ED4EC  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 804ED4F0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 804ED4F4  80 84 00 00 */	lwz r4, 0(r4)
/* 804ED4F8  4B E5 8F B9 */	bl PSMTXCopy
...
/* 804ED51C  4B D8 39 D1 */	bl MtxPosition__FP4cXyzP4cXyz
/* 804ED520  38 7F 10 A0 */	addi r3, r31, 0x10a0
/* 804ED524  38 81 00 90 */	addi r4, r1, 0x90
/* 804ED528  4B D8 21 21 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 804ED568  4B B9 9F AD */	bl def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
...
/* 804ED58C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804ED590  80 63 00 00 */	lwz r3, 0(r3)
/* 804ED594  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 804ED598  4B B1 EE 45 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 804ED5BC  4B D8 39 31 */	bl MtxPosition__FP4cXyzP4cXyz
/* 804ED5C0  38 61 00 90 */	addi r3, r1, 0x90
/* 804ED5C4  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 804ED5C8  7C 65 1B 78 */	mr r5, r3
/* 804ED5CC  4B E5 9A C5 */	bl PSVECAdd
/* 804ED5D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804ED5D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804ED5F4  4B B5 EC 25 */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 804ED620  4B D7 94 C5 */	bl __pl__4cXyzCFRC3Vec
/* 804ED624  38 7F 10 A0 */	addi r3, r31, 0x10a0
/* 804ED628  38 81 00 18 */	addi r4, r1, 0x18
/* 804ED62C  4B D8 20 1D */	bl SetC__8cM3dGSphFRC4cXyz
lbl_804ED630:
...
/* 804ED640  4B D7 75 69 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 804ED660  4B D8 23 DD */	bl cLib_addCalc2__FPffff
lbl_804ED664:
...
/* 804ED67C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ED680  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804ED684  4B E5 8E 2D */	bl PSMTXCopy
/* 804ED688  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804ED68C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 804ED6B4  4B D7 94 81 */	bl __mi__4cXyzCFRC3Vec
...
/* 804ED6D0  4B D7 9F A5 */	bl cM_atan2s__Fff
/* 804ED6D4  7C 64 1B 78 */	mr r4, r3
/* 804ED6D8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804ED6DC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804ED6E0  80 63 00 00 */	lwz r3, 0(r3)
/* 804ED6E4  4B B1 EC F9 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 804ED78C  4B B2 C4 F1 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 804ED7A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804ED7A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804ED7A8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 804ED7AC  7C 05 07 74 */	extsb r5, r0
/* 804ED7B0  4B B4 7A 51 */	bl onSwitch__10dSv_info_cFii
lbl_804ED7B4:
/* 804ED7B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804ED7B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804ED7BC  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 804ED7C0  3C 80 80 4F */	lis r4, d_a_e_dn__stringBase0@ha /* 0x804EEA34@ha */
/* 804ED7C4  38 84 EA 34 */	addi r4, r4, d_a_e_dn__stringBase0@l /* 0x804EEA34@l */
/* 804ED7C8  38 84 00 05 */	addi r4, r4, 5
/* 804ED7CC  4B E7 B1 C9 */	bl strcmp
...
/* 804ED828  4B E7 49 F1 */	bl _restgpr_25
