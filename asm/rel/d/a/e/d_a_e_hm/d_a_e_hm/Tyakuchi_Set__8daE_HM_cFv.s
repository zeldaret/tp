...
/* 806E1C38  4B C8 05 A5 */	bl _savegpr_29
/* 806E1C3C  7C 7F 1B 78 */	mr r31, r3
/* 806E1C40  3C 60 80 6E */	lis r3, lit_3791@ha /* 0x806E5920@ha */
/* 806E1C44  3B C3 59 20 */	addi r30, r3, lit_3791@l /* 0x806E5920@l */
...
/* 806E1C70  4B 99 5F F9 */	bl __ct__11dBgS_LinChkFv
/* 806E1C74  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 806E1C78  4B 92 B0 ED */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 806E1C7C  38 7F 05 CC */	addi r3, r31, 0x5cc
/* 806E1C80  4B 92 B2 C5 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806E1C84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E1C88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E1C8C  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 806E1C90  4B 92 A7 A5 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E1C94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E1C98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E1C9C  38 81 00 48 */	addi r4, r1, 0x48
/* 806E1CA0  38 A1 00 3C */	addi r5, r1, 0x3c
/* 806E1CA4  4B C6 50 C9 */	bl PSMTXMultVec
/* 806E1CA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E1CAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E1CB0  38 81 00 30 */	addi r4, r1, 0x30
/* 806E1CB4  38 A1 00 24 */	addi r5, r1, 0x24
/* 806E1CB8  4B C6 50 B5 */	bl PSMTXMultVec
...
/* 806E1CCC  4B 99 60 99 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806E1CD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E1CD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E1CD8  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 806E1CDC  7F A3 EB 78 */	mr r3, r29
/* 806E1CE0  38 81 00 68 */	addi r4, r1, 0x68
/* 806E1CE4  4B 99 26 D1 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 806E1CE8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 806E1CEC  41 82 01 68 */	beq lbl_806E1E54
/* 806E1CF0  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha /* 0x806E5BAC@ha */
/* 806E1CF4  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806E5BAC@l */
...
/* 806E1D08  4B 99 2A 3D */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 806E1D38  4B C6 56 65 */	bl PSVECSquareDistance
...
/* 806E1DA8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E1DAC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806E1E18  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E1E1C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 806E1E20  48 00 00 08 */	b lbl_806E1E28
lbl_806E1E24:
/* 806E1E24  FC 40 08 90 */	fmr f2, f1
lbl_806E1E28:
/* 806E1E28  C0 21 00 54 */	lfs f1, 0x54(r1)
/* 806E1E2C  4B B8 58 49 */	bl cM_atan2s__Fff
...
/* 806E1E40  4B B8 58 35 */	bl cM_atan2s__Fff
/* 806E1E44  B0 7F 05 CC */	sth r3, 0x5cc(r31)
/* 806E1E48  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha /* 0x806E5BAC@ha */
/* 806E1E4C  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806E5BAC@l */
/* 806E1E50  90 01 00 64 */	stw r0, 0x64(r1)
lbl_806E1E54:
/* 806E1E54  38 61 00 68 */	addi r3, r1, 0x68
/* 806E1E58  38 80 FF FF */	li r4, -1
/* 806E1E5C  4B 99 5E 81 */	bl __dt__11dBgS_LinChkFv
/* 806E1E60  39 61 00 F0 */	addi r11, r1, 0xf0
/* 806E1E64  4B C8 03 C5 */	bl _restgpr_29
