...
/* 806E0968  4B C8 18 6D */	bl _savegpr_27
/* 806E096C  7C 7E 1B 78 */	mr r30, r3
/* 806E0970  7C BD 2B 78 */	mr r29, r5
/* 806E0974  3C 60 80 6E */	lis r3, lit_3791@ha /* 0x806E5920@ha */
/* 806E0978  3B E3 59 20 */	addi r31, r3, lit_3791@l /* 0x806E5920@l */
...
/* 806E0990  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0994  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E0998  4B C6 5B 19 */	bl PSMTXCopy
...
/* 806E09B0  3C 60 80 6E */	lis r3, lit_4024@ha /* 0x806E5AD8@ha */
/* 806E09B4  38 63 5A D8 */	addi r3, r3, lit_4024@l /* 0x806E5AD8@l */
...
lbl_806E09C8:
/* 806E09C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E09CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0A04  4B 92 BA 31 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0A08  48 00 03 14 */	b lbl_806E0D1C
lbl_806E0A0C:
/* 806E0A0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0A10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0A48  4B 92 B9 ED */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0A4C  48 00 02 D0 */	b lbl_806E0D1C
lbl_806E0A50:
/* 806E0A50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0A54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0A8C  4B 92 B9 A9 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0A90  48 00 02 8C */	b lbl_806E0D1C
lbl_806E0A94:
/* 806E0A94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0A98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0AD0  4B 92 B9 65 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0AD4  48 00 02 48 */	b lbl_806E0D1C
lbl_806E0AD8:
/* 806E0AD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0ADC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0B14  4B 92 B9 21 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0B18  48 00 02 04 */	b lbl_806E0D1C
lbl_806E0B1C:
/* 806E0B1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0B20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0B58  4B 92 B8 DD */	bl mDoMtx_YrotM__FPA4_fs
...
/* 806E0B70  3C 60 80 6E */	lis r3, lit_4028@ha /* 0x806E5AB4@ha */
/* 806E0B74  38 63 5A B4 */	addi r3, r3, lit_4028@l /* 0x806E5AB4@l */
...
lbl_806E0B88:
/* 806E0B88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0B8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0BC4  4B 92 B8 71 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0BC8  48 00 01 54 */	b lbl_806E0D1C
lbl_806E0BCC:
/* 806E0BCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0BD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0C08  4B 92 B8 2D */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0C0C  48 00 01 10 */	b lbl_806E0D1C
lbl_806E0C10:
/* 806E0C10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0C14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0C4C  4B 92 B7 E9 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0C50  48 00 00 CC */	b lbl_806E0D1C
lbl_806E0C54:
/* 806E0C54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0C58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0C90  4B 92 B7 A5 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0C94  48 00 00 88 */	b lbl_806E0D1C
lbl_806E0C98:
/* 806E0C98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0C9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0CD4  4B 92 B7 61 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0CD8  48 00 00 44 */	b lbl_806E0D1C
lbl_806E0CDC:
/* 806E0CDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0CE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E0D18  4B 92 B7 1D */	bl mDoMtx_YrotM__FPA4_fs
lbl_806E0D1C:
/* 806E0D1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0D20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E0D24  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 806E0D28  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806E0D2C  7C 80 E2 14 */	add r4, r0, r28
/* 806E0D30  4B C6 57 81 */	bl PSMTXCopy
/* 806E0D34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0D38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E0D3C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 806E0D40  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 806E0D44  4B C6 57 6D */	bl PSMTXCopy
/* 806E0D48  38 60 00 01 */	li r3, 1
/* 806E0D4C  39 61 00 30 */	addi r11, r1, 0x30
/* 806E0D50  4B C8 14 D1 */	bl _restgpr_27
