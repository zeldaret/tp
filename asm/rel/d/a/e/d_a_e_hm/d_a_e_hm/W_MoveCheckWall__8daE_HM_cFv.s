...
/* 806E156C  4B C8 0C 69 */	bl _savegpr_27
/* 806E1570  7C 7F 1B 78 */	mr r31, r3
/* 806E1574  3C 60 80 6E */	lis r3, lit_3791@ha /* 0x806E5920@ha */
/* 806E1578  3B C3 59 20 */	addi r30, r3, lit_3791@l /* 0x806E5920@l */
...
/* 806E15B0  4B 99 66 B9 */	bl __ct__11dBgS_LinChkFv
/* 806E15B4  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 806E15B8  4B 92 B7 AD */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 806E15BC  38 7F 05 CC */	addi r3, r31, 0x5cc
/* 806E15C0  4B 92 B9 85 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806E15C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E15C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E15CC  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 806E15D0  4B 92 AE 65 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E15D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E15D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E15DC  38 81 00 30 */	addi r4, r1, 0x30
/* 806E15E0  7C 85 23 78 */	mr r5, r4
/* 806E15E4  4B C6 57 89 */	bl PSMTXMultVec
/* 806E15E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E15EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E15F0  38 81 00 24 */	addi r4, r1, 0x24
/* 806E15F4  7C 85 23 78 */	mr r5, r4
/* 806E15F8  4B C6 57 75 */	bl PSMTXMultVec
...
/* 806E160C  4B 99 67 59 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806E1610  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E1614  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E1618  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 806E161C  7F A3 EB 78 */	mr r3, r29
/* 806E1620  38 81 00 64 */	addi r4, r1, 0x64
/* 806E1624  4B 99 2D 91 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 806E1628  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 806E162C  41 82 01 E4 */	beq lbl_806E1810
/* 806E1630  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha /* 0x806E5BAC@ha */
/* 806E1634  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806E5BAC@l */
...
/* 806E164C  4B 99 30 F9 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 806E1650  7F A3 EB 78 */	mr r3, r29
/* 806E1654  7F 84 E3 78 */	mr r4, r28
/* 806E1658  4B 99 36 B5 */	bl GetMagnetCode__4dBgSFRC13cBgS_PolyInfo
...
/* 806E1670  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha /* 0x806E5BAC@ha */
/* 806E1674  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806E5BAC@l */
/* 806E1678  90 01 00 60 */	stw r0, 0x60(r1)
/* 806E167C  38 61 00 64 */	addi r3, r1, 0x64
/* 806E1680  38 80 FF FF */	li r4, -1
/* 806E1684  4B 99 66 59 */	bl __dt__11dBgS_LinChkFv
/* 806E1688  38 60 00 01 */	li r3, 1
/* 806E168C  48 00 01 B4 */	b lbl_806E1840
lbl_806E1690:
/* 806E1690  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha /* 0x806E5BAC@ha */
/* 806E1694  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806E5BAC@l */
...
/* 806E16A8  4B 99 30 9D */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 806E16F0  4B C6 5C AD */	bl PSVECSquareDistance
...
/* 806E1760  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E1764  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806E17D0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E17D4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 806E17D8  48 00 00 08 */	b lbl_806E17E0
lbl_806E17DC:
/* 806E17DC  FC 40 08 90 */	fmr f2, f1
lbl_806E17E0:
/* 806E17E0  C0 21 00 3C */	lfs f1, 0x3c(r1)
/* 806E17E4  4B B8 5E 91 */	bl cM_atan2s__Fff
...
/* 806E17F8  4B B8 5E 7D */	bl cM_atan2s__Fff
/* 806E17FC  7C 7B 1B 78 */	mr r27, r3
/* 806E1800  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha /* 0x806E5BAC@ha */
/* 806E1804  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806E5BAC@l */
