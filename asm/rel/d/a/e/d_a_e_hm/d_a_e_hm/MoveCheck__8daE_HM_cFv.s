...
/* 806E26A4  4B C7 FB 39 */	bl _savegpr_29
/* 806E26A8  7C 7F 1B 78 */	mr r31, r3
/* 806E26AC  3C 60 80 6E */	lis r3, lit_3791@ha /* 0x806E5920@ha */
/* 806E26B0  3B C3 59 20 */	addi r30, r3, lit_3791@l /* 0x806E5920@l */
...
/* 806E26E8  4B 99 55 81 */	bl __ct__11dBgS_LinChkFv
/* 806E26EC  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 806E26F0  4B 92 A6 75 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 806E26F4  38 7F 05 CC */	addi r3, r31, 0x5cc
/* 806E26F8  4B 92 A8 4D */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806E26FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E2700  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E2704  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 806E2708  4B 92 9D 2D */	bl mDoMtx_YrotM__FPA4_fs
/* 806E270C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E2710  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E2714  38 81 00 48 */	addi r4, r1, 0x48
/* 806E2718  7C 85 23 78 */	mr r5, r4
/* 806E271C  4B C6 46 51 */	bl PSMTXMultVec
/* 806E2720  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E2724  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E2728  38 81 00 3C */	addi r4, r1, 0x3c
/* 806E272C  7C 85 23 78 */	mr r5, r4
/* 806E2730  4B C6 46 3D */	bl PSMTXMultVec
...
/* 806E2744  4B 99 56 21 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806E2748  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E274C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E2750  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 806E2754  7F A3 EB 78 */	mr r3, r29
/* 806E2758  38 81 00 68 */	addi r4, r1, 0x68
/* 806E275C  4B 99 1C 59 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 806E2774  4B B8 43 C1 */	bl __mi__4cXyzCFRC3Vec
...
/* 806E2794  4B B8 51 F9 */	bl cM_rndFX__Ff
...
/* 806E27A8  4B B8 51 E5 */	bl cM_rndFX__Ff
...
/* 806E27BC  4B B8 4E B9 */	bl cM_atan2s__Fff
/* 806E27C0  B0 7F 05 B4 */	sth r3, 0x5b4(r31)
/* 806E27C4  C0 3E 00 80 */	lfs f1, 0x80(r30)
/* 806E27C8  4B B8 51 C5 */	bl cM_rndFX__Ff
...
/* 806E27EC  4B 99 54 F1 */	bl __dt__11dBgS_LinChkFv
/* 806E27F0  38 60 00 01 */	li r3, 1
/* 806E27F4  48 00 01 AC */	b lbl_806E29A0
lbl_806E27F8:
/* 806E27F8  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha /* 0x806E5BAC@ha */
/* 806E27FC  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806E5BAC@l */
...
/* 806E2810  4B 99 1F 35 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 806E2840  4B C6 4B 5D */	bl PSVECSquareDistance
...
/* 806E28B0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E28B4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806E2920  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E2924  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 806E2928  48 00 00 08 */	b lbl_806E2930
lbl_806E292C:
/* 806E292C  FC 40 08 90 */	fmr f2, f1
lbl_806E2930:
/* 806E2930  C0 21 00 54 */	lfs f1, 0x54(r1)
/* 806E2934  4B B8 4D 41 */	bl cM_atan2s__Fff
...
/* 806E2948  4B B8 4D 2D */	bl cM_atan2s__Fff
