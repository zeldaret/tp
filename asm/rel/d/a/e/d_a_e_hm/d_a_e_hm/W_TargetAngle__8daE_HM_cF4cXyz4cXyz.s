...
/* 806E0F5C  4B B8 5B D9 */	bl __mi__4cXyzCFRC3Vec
...
/* 806E0F78  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0F7C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E0F80  A8 1F 05 D0 */	lha r0, 0x5d0(r31)
/* 806E0F84  7C 00 00 D0 */	neg r0, r0
/* 806E0F88  7C 04 07 34 */	extsh r4, r0
/* 806E0F8C  4B 92 B4 E9 */	bl mDoMtx_ZrotS__FPA4_fs
/* 806E0F90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0F94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E0F98  A8 1F 05 CC */	lha r0, 0x5cc(r31)
/* 806E0F9C  7C 00 00 D0 */	neg r0, r0
/* 806E0FA0  7C 04 07 34 */	extsh r4, r0
/* 806E0FA4  4B 92 B3 F9 */	bl mDoMtx_XrotM__FPA4_fs
/* 806E0FA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0FAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E0FB0  A8 1F 05 CE */	lha r0, 0x5ce(r31)
/* 806E0FB4  7C 00 00 D0 */	neg r0, r0
/* 806E0FB8  7C 04 07 34 */	extsh r4, r0
/* 806E0FBC  4B 92 B4 79 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E0FC0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E0FC4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E0FC8  38 81 00 14 */	addi r4, r1, 0x14
/* 806E0FCC  38 A1 00 20 */	addi r5, r1, 0x20
/* 806E0FD0  4B C6 5D 9D */	bl PSMTXMultVec
/* 806E0FD4  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 806E0FD8  C0 41 00 28 */	lfs f2, 0x28(r1)
/* 806E0FDC  4B B8 66 99 */	bl cM_atan2s__Fff
