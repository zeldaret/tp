...
/* 80790968  4B BD 18 55 */	bl _savegpr_21
/* 8079096C  7C 7F 1B 78 */	mr r31, r3
/* 80790970  3C 60 80 79 */	lis r3, lit_3902@ha /* 0x80791D70@ha */
/* 80790974  3B 83 1D 70 */	addi r28, r3, lit_3902@l /* 0x80791D70@l */
...
/* 807909CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807909D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807909D4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 807909D8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 807909DC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 807909E0  4B BB 5F 09 */	bl PSMTXTrans
/* 807909E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807909E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807909EC  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 807909F0  4B 87 BA 45 */	bl mDoMtx_YrotM__FPA4_fs
/* 807909F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807909F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807909FC  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80790A00  4B 87 B9 9D */	bl mDoMtx_XrotM__FPA4_fs
/* 80790A04  3C 60 80 79 */	lis r3, l_HIO@ha /* 0x80792108@ha */
/* 80790A08  3B A3 21 08 */	addi r29, r3, l_HIO@l /* 0x80792108@l */
/* 80790A0C  C0 3D 00 08 */	lfs f1, 8(r29)
/* 80790A10  FC 40 08 90 */	fmr f2, f1
/* 80790A14  FC 60 08 90 */	fmr f3, f1
/* 80790A18  4B 87 C4 21 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80790A1C  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 80790A20  83 63 00 04 */	lwz r27, 4(r3)
/* 80790A24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80790A28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80790A2C  38 9B 00 24 */	addi r4, r27, 0x24
/* 80790A30  4B BB 5A 81 */	bl PSMTXCopy
/* 80790A34  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80790A38  7C 03 07 74 */	extsb r3, r0
/* 80790A3C  4B 89 C6 31 */	bl dComIfGp_getReverb__Fi
/* 80790A40  7C 65 1B 78 */	mr r5, r3
/* 80790A44  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 80790A48  38 80 00 00 */	li r4, 0
/* 80790A4C  4B 88 06 65 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 80790A50  7F E3 FB 78 */	mr r3, r31
/* 80790A54  4B FF FA 45 */	bl anm_se_set__FP10e_sh_class
/* 80790A58  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 80790A5C  4B 88 07 91 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 80790A70  4B AD EF CD */	bl cLib_addCalc2__FPffff
...
/* 80790A88  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80790A8C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80790A90  80 84 00 00 */	lwz r4, 0(r4)
/* 80790A94  4B BB 5A 1D */	bl PSMTXCopy
/* 80790A98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80790A9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80790AA0  83 43 5D 74 */	lwz r26, 0x5d74(r3)
/* 80790AA4  3A E0 00 00 */	li r23, 0
/* 80790AA8  3A C0 00 00 */	li r22, 0
/* 80790AAC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80790AB0  3B C3 CA 54 */	addi r30, r3, g_env_light@l /* 0x8042CA54@l */
/* 80790AB4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80790AB8  3A A3 07 68 */	addi r21, r3, calc_mtx@l /* 0x80450768@l */
lbl_80790ABC:
/* 80790ABC  4B AE 04 61 */	bl MtxPush__Fv
...
/* 80790B14  4B AD 6B 61 */	bl cM_atan2s__Fff
...
/* 80790BC8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80790BCC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80790C38  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80790C3C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80790C40:
...
/* 80790C78  3C 60 80 79 */	lis r3, time_scale@ha /* 0x80791F4C@ha */
/* 80790C7C  38 63 1F 4C */	addi r3, r3, time_scale@l /* 0x80791F4C@l */
...
/* 80790CC4  4B AE 02 29 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80790CD8  4B AE 01 85 */	bl MtxTrans__FfffUc
/* 80790CDC  80 75 00 00 */	lwz r3, 0(r21)
/* 80790CE0  7F 04 C3 78 */	mr r4, r24
/* 80790CE4  4B 87 B7 51 */	bl mDoMtx_YrotM__FPA4_fs
/* 80790CE8  80 75 00 00 */	lwz r3, 0(r21)
/* 80790CEC  7F 24 CB 78 */	mr r4, r25
/* 80790CF0  4B 87 B6 AD */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80790D04  4B AE 01 A1 */	bl MtxScale__FfffUc
...
/* 80790D18  4B BB 57 99 */	bl PSMTXCopy
/* 80790D1C  4B AE 02 3D */	bl MtxPull__Fv
...
/* 80790DA0  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80790DA4  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80790DA8  80 84 00 00 */	lwz r4, 0(r4)
/* 80790DAC  4B BB 57 05 */	bl PSMTXCopy
...
/* 80790DD0  4B AE 01 1D */	bl MtxPosition__FP4cXyzP4cXyz
/* 80790DD4  38 7F 0B 78 */	addi r3, r31, 0xb78
/* 80790DD8  38 81 00 3C */	addi r4, r1, 0x3c
/* 80790DDC  4B AD E8 6D */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 80790DF0  4B AD E9 19 */	bl SetR__8cM3dGSphFf
...
/* 80790E0C  4B AD 5C D9 */	bl __pl__4cXyzCFRC3Vec
/* 80790E10  38 7F 0B 78 */	addi r3, r31, 0xb78
/* 80790E14  38 81 00 18 */	addi r4, r1, 0x18
/* 80790E18  4B AD E8 31 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80790E1C  48 00 00 10 */	b lbl_80790E2C
lbl_80790E20:
/* 80790E20  38 7F 0B 78 */	addi r3, r31, 0xb78
/* 80790E24  38 81 00 3C */	addi r4, r1, 0x3c
/* 80790E28  4B AD E8 21 */	bl SetC__8cM3dGSphFRC4cXyz
lbl_80790E2C:
/* 80790E2C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80790E30  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80790E34  3A A3 23 3C */	addi r21, r3, 0x233c
/* 80790E38  7E A3 AB 78 */	mr r3, r21
/* 80790E3C  38 9F 0A 54 */	addi r4, r31, 0xa54
/* 80790E40  4B AD 3D 69 */	bl Set__4cCcSFP8cCcD_Obj
/* 80790E44  80 7B 00 84 */	lwz r3, 0x84(r27)
/* 80790E48  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80790E4C  38 63 02 70 */	addi r3, r3, 0x270
/* 80790E50  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80790E54  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80790E58  80 84 00 00 */	lwz r4, 0(r4)
/* 80790E5C  4B BB 56 55 */	bl PSMTXCopy
...
/* 80790E78  4B AE 00 75 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80790EC4  4B AE 00 29 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80790EDC  4B AD E7 6D */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 80790EF0  4B AD E8 19 */	bl SetR__8cM3dGSphFf
...
/* 80790F08  4B AD E7 41 */	bl SetC__8cM3dGSphFRC4cXyz
lbl_80790F0C:
/* 80790F0C  7E A3 AB 78 */	mr r3, r21
/* 80790F10  38 9F 0B 8C */	addi r4, r31, 0xb8c
/* 80790F14  4B AD 3C 95 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80790F38  4B AD FF B5 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80790F84  4B AD E7 85 */	bl SetR__8cM3dGSphFf
/* 80790F88  7E A3 AB 78 */	mr r3, r21
/* 80790F8C  38 9F 09 1C */	addi r4, r31, 0x91c
/* 80790F90  4B AD 3C 19 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80790FAC  4B BD 12 5D */	bl _restgpr_21
