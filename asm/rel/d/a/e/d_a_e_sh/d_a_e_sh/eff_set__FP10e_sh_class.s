...
/* 80790288  4B BD 1F 3D */	bl _savegpr_23
...
/* 807902D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807902DC  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807902E0  3C 60 80 79 */	lis r3, p_name@ha /* 0x80791F40@ha */
/* 807902E4  3B A3 1F 40 */	addi r29, r3, p_name@l /* 0x80791F40@l */
/* 807902E8  3C 60 80 79 */	lis r3, lit_3904@ha /* 0x80791D78@ha */
/* 807902EC  3B C3 1D 78 */	addi r30, r3, lit_3904@l /* 0x80791D78@l */
lbl_807902F0:
...
/* 8079033C  4B 8B D1 91 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80790350  4B 8B B5 C9 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 80790364  3C 60 80 79 */	lis r3, p_idx@ha /* 0x80791F44@ha */
/* 80790368  38 63 1F 44 */	addi r3, r3, p_idx@l /* 0x80791F44@l */
/* 8079036C  7C 03 B8 2E */	lwzx r0, r3, r23
/* 80790370  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80790374  7C 64 02 14 */	add r3, r4, r0
/* 80790378  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8079037C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80790380  80 84 00 00 */	lwz r4, 0(r4)
/* 80790384  4B BB 61 2D */	bl PSMTXCopy
/* 80790388  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079038C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 807903A0  4B AF 04 69 */	bl func_80280808
...
/* 807903D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807903D8  3A E3 61 C0 */	addi r23, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80790424  3D 60 80 79 */	lis r11, lit_3904@ha /* 0x80791D78@ha */
/* 80790428  C0 2B 1D 78 */	lfs f1, lit_3904@l(r11)  /* 0x80791D78@l */
/* 8079042C  4B 8B D0 A1 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80790440  4B 8B B4 D9 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 80790458  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8079045C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80790460  80 84 00 00 */	lwz r4, 0(r4)
/* 80790464  4B BB 60 4D */	bl PSMTXCopy
/* 80790468  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8079046C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80790470  80 63 00 00 */	lwz r3, 0(r3)
/* 80790474  38 97 00 68 */	addi r4, r23, 0x68
/* 80790478  38 B7 00 A4 */	addi r5, r23, 0xa4
/* 8079047C  4B AF 03 65 */	bl func_802807E0
lbl_80790480:
/* 80790480  39 61 00 50 */	addi r11, r1, 0x50
/* 80790484  4B BD 1D 8D */	bl _restgpr_23
