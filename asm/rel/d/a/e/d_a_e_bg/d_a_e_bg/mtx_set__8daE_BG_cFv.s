...
/* 8068955C  3C 60 80 69 */	lis r3, lit_3768@ha /* 0x8068A244@ha */
/* 80689560  3B C3 A2 44 */	addi r30, r3, lit_3768@l /* 0x8068A244@l */
/* 80689564  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80689568  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80689580  4B CB D3 69 */	bl PSMTXTrans
/* 80689584  C0 3E 00 20 */	lfs f1, 0x20(r30)
/* 80689588  C0 5E 00 B0 */	lfs f2, 0xb0(r30)
/* 8068958C  FC 60 08 90 */	fmr f3, f1
/* 80689590  4B 98 38 0D */	bl transM__14mDoMtx_stack_cFfff
/* 80689594  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80689598  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806895B0  4B 98 2C F1 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 806895B4  C0 3E 00 20 */	lfs f1, 0x20(r30)
/* 806895B8  C0 5E 00 B4 */	lfs f2, 0xb4(r30)
/* 806895BC  FC 60 08 90 */	fmr f3, f1
/* 806895C0  4B 98 37 DD */	bl transM__14mDoMtx_stack_cFfff
/* 806895C4  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 806895C8  83 C3 00 04 */	lwz r30, 4(r3)
/* 806895CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806895D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806895D4  38 9E 00 24 */	addi r4, r30, 0x24
/* 806895D8  4B CB CE D9 */	bl PSMTXCopy
/* 806895DC  93 FE 00 14 */	stw r31, 0x14(r30)
/* 806895E0  38 C0 00 01 */	li r6, 1
/* 806895E4  3C 60 80 68 */	lis r3, JointCallBack__8daE_BG_cFP8J3DJointi@ha /* 0x80685948@ha */
/* 806895E8  38 83 59 48 */	addi r4, r3, JointCallBack__8daE_BG_cFP8J3DJointi@l /* 0x80685948@l */
...
/* 8068961C  4B 98 7B D1 */	bl modelCalc__16mDoExt_McaMorfSOFv
