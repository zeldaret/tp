...
/* 8068586C  4B CD C9 6C */	b _savegpr_28
...
/* 8068588C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80685890  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80685894  4B CC 0C 1C */	b PSMTXCopy
...
/* 806858B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806858B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806858BC  A8 9D 06 AA */	lha r4, 0x6aa(r29)
/* 806858C0  4B 98 6B 74 */	b mDoMtx_YrotM__FPA4_fs
/* 806858C4  48 00 00 3C */	b lbl_80685900
lbl_806858C8:
/* 806858C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806858CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 806858E0  4B 98 6B 54 */	b mDoMtx_YrotM__FPA4_fs
/* 806858E4  48 00 00 1C */	b lbl_80685900
lbl_806858E8:
/* 806858E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806858EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806858F0  57 80 08 3C */	slwi r0, r28, 1
/* 806858F4  7C 9D 02 14 */	add r4, r29, r0
/* 806858F8  A8 84 06 A0 */	lha r4, 0x6a0(r4)
/* 806858FC  4B 98 6B 38 */	b mDoMtx_YrotM__FPA4_fs
lbl_80685900:
/* 80685900  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80685904  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80685908  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 8068590C  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80685910  7C 80 FA 14 */	add r4, r0, r31
/* 80685914  4B CC 0B 9C */	b PSMTXCopy
/* 80685918  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068591C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80685920  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80685924  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80685928  4B CC 0B 88 */	b PSMTXCopy
/* 8068592C  38 60 00 01 */	li r3, 1
/* 80685930  39 61 00 20 */	addi r11, r1, 0x20
/* 80685934  4B CD C8 F0 */	b _restgpr_28
