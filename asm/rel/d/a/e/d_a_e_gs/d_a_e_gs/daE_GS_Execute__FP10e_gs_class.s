...
/* 806DF89C  3C 60 80 6E */	lis r3, lit_3646@ha /* 0x806DFDF4@ha */
/* 806DF8A0  3B C3 FD F4 */	addi r30, r3, lit_3646@l /* 0x806DFDF4@l */
/* 806DF8A4  C3 FE 00 10 */	lfs f31, 0x10(r30)
/* 806DF8A8  3C 60 80 6E */	lis r3, l_HIO@ha /* 0x806DFEA8@ha */
/* 806DF8AC  38 63 FE A8 */	addi r3, r3, l_HIO@l /* 0x806DFEA8@l */
/* 806DF8B0  C3 C3 00 14 */	lfs f30, 0x14(r3)
/* 806DF8B4  4B A7 FB 71 */	bl checkNowWolfEyeUp__9daPy_py_cFv
...
/* 806DF8D0  3C 60 80 6E */	lis r3, l_HIO@ha /* 0x806DFEA8@ha */
/* 806DF8D4  38 63 FE A8 */	addi r3, r3, l_HIO@l /* 0x806DFEA8@l */
/* 806DF8D8  C3 C3 00 10 */	lfs f30, 0x10(r3)
/* 806DF8DC  48 00 00 14 */	b lbl_806DF8F0
lbl_806DF8E0:
/* 806DF8E0  3C 60 80 6E */	lis r3, l_HIO@ha /* 0x806DFEA8@ha */
/* 806DF8E4  38 63 FE A8 */	addi r3, r3, l_HIO@l /* 0x806DFEA8@l */
...
/* 806DF900  4B B9 01 3D */	bl cLib_addCalc2__FPffff
/* 806DF904  4B 93 89 A5 */	bl cDmrNowMidnaTalk__Fv
/* 806DF908  2C 03 00 00 */	cmpwi r3, 0
/* 806DF90C  40 82 00 18 */	bne lbl_806DF924
/* 806DF910  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DF914  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DF980  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806DF984  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806DF988  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 806DF98C  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 806DF990  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 806DF994  4B C6 6F 55 */	bl PSMTXTrans
/* 806DF998  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806DF99C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806DF9A0  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806DF9A4  4B 92 CA 91 */	bl mDoMtx_YrotM__FPA4_fs
/* 806DF9A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806DF9AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806DF9B0  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 806DF9B4  4B 92 C9 E9 */	bl mDoMtx_XrotM__FPA4_fs
/* 806DF9B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806DF9BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806DF9C0  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 806DF9C4  4B 92 CB 09 */	bl mDoMtx_ZrotM__FPA4_fs
/* 806DF9C8  3C 60 80 6E */	lis r3, l_HIO@ha /* 0x806DFEA8@ha */
/* 806DF9CC  38 63 FE A8 */	addi r3, r3, l_HIO@l /* 0x806DFEA8@l */
/* 806DF9D0  C0 23 00 08 */	lfs f1, 8(r3)
/* 806DF9D4  FC 40 08 90 */	fmr f2, f1
/* 806DF9D8  FC 60 08 90 */	fmr f3, f1
/* 806DF9DC  4B 92 D4 5D */	bl scaleM__14mDoMtx_stack_cFfff
/* 806DF9E0  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 806DF9E4  80 83 00 04 */	lwz r4, 4(r3)
/* 806DF9E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806DF9EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806DF9F0  38 84 00 24 */	addi r4, r4, 0x24
/* 806DF9F4  4B C6 6A BD */	bl PSMTXCopy
/* 806DF9F8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806DF9FC  7C 03 07 74 */	extsb r3, r0
/* 806DFA00  4B 94 D6 6D */	bl dComIfGp_getReverb__Fi
/* 806DFA04  7C 65 1B 78 */	mr r5, r3
/* 806DFA08  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 806DFA0C  38 80 00 00 */	li r4, 0
/* 806DFA10  4B 93 16 A1 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 806DFA14  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 806DFA18  4B 93 17 D5 */	bl modelCalc__16mDoExt_McaMorfSOFv
