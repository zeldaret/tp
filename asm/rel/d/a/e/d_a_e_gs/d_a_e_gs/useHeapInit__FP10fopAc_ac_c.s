...
/* 806DFAC8  4B C8 27 11 */	bl _savegpr_28
/* 806DFACC  7C 7F 1B 78 */	mr r31, r3
/* 806DFAD0  38 60 00 58 */	li r3, 0x58
/* 806DFAD4  4B BE F1 79 */	bl __nw__FUl
/* 806DFAD8  7C 7E 1B 79 */	or. r30, r3, r3
/* 806DFADC  41 82 00 94 */	beq lbl_806DFB70
/* 806DFAE0  3C 60 80 6E */	lis r3, d_a_e_gs__stringBase0@ha /* 0x806DFE2C@ha */
/* 806DFAE4  38 63 FE 2C */	addi r3, r3, d_a_e_gs__stringBase0@l /* 0x806DFE2C@l */
/* 806DFAE8  38 80 00 06 */	li r4, 6
/* 806DFAEC  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806DFAF0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806DFB04  4B 95 C7 E9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806DFB08  7C 7D 1B 78 */	mr r29, r3
/* 806DFB0C  3C 60 80 6E */	lis r3, d_a_e_gs__stringBase0@ha /* 0x806DFE2C@ha */
/* 806DFB10  38 63 FE 2C */	addi r3, r3, d_a_e_gs__stringBase0@l /* 0x806DFE2C@l */
/* 806DFB14  38 80 00 09 */	li r4, 9
/* 806DFB18  7F 85 E3 78 */	mr r5, r28
/* 806DFB1C  38 C0 00 80 */	li r6, 0x80
/* 806DFB20  4B 95 C7 CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806DFB58  3D 20 80 6E */	lis r9, lit_3687@ha /* 0x806DFE0C@ha */
/* 806DFB5C  C0 29 FE 0C */	lfs f1, lit_3687@l(r9)  /* 0x806DFE0C@l */
/* 806DFB60  39 20 00 00 */	li r9, 0
/* 806DFB64  39 40 FF FF */	li r10, -1
/* 806DFB68  4B 93 0C 69 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806DFB9C  4B 92 E9 A1 */	bl create__21mDoExt_invisibleModelFP8J3DModelUc
...
lbl_806DFBB0:
/* 806DFBB0  3C 60 80 6E */	lis r3, lit_3663@ha /* 0x806DFE04@ha */
/* 806DFBB4  C0 23 FE 04 */	lfs f1, lit_3663@l(r3)  /* 0x806DFE04@l */
/* 806DFBB8  FC 40 08 90 */	fmr f2, f1
/* 806DFBBC  FC 60 08 90 */	fmr f3, f1
/* 806DFBC0  38 60 00 00 */	li r3, 0
/* 806DFBC4  4B B9 12 E1 */	bl MtxScale__FfffUc
/* 806DFBC8  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 806DFBCC  80 83 00 04 */	lwz r4, 4(r3)
/* 806DFBD0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806DFBD4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806DFBD8  80 63 00 00 */	lwz r3, 0(r3)
/* 806DFBDC  38 84 00 24 */	addi r4, r4, 0x24
/* 806DFBE0  4B C6 68 D1 */	bl PSMTXCopy
/* 806DFBE4  38 60 00 01 */	li r3, 1
lbl_806DFBE8:
/* 806DFBE8  39 61 00 30 */	addi r11, r1, 0x30
/* 806DFBEC  4B C8 26 39 */	bl _restgpr_28
