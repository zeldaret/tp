...
/* 806DFC30  4B 93 8F 35 */	bl __ct__10fopAc_ac_cFv
/* 806DFC34  38 7E 05 DC */	addi r3, r30, 0x5dc
/* 806DFC38  4B BE 13 2D */	bl __ct__15Z2CreatureEnemyFv
lbl_806DFC3C:
...
/* 806DFC4C  3C 80 80 6E */	lis r4, d_a_e_gs__stringBase0@ha /* 0x806DFE2C@ha */
/* 806DFC50  38 84 FE 2C */	addi r4, r4, d_a_e_gs__stringBase0@l /* 0x806DFE2C@l */
/* 806DFC54  4B 94 D2 69 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806DFC7C  3C 80 80 6E */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x806DFAB8@ha */
/* 806DFC80  38 84 FA B8 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x806DFAB8@l */
/* 806DFC84  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 806DFC88  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 806DFC8C  4B 93 A8 25 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_806DFCA0:
/* 806DFCA0  3C 60 80 6E */	lis r3, data_806DFE98@ha /* 0x806DFE98@ha */
/* 806DFCA4  8C 03 FE 98 */	lbzu r0, data_806DFE98@l(r3)  /* 0x806DFE98@l */
...
/* 806DFCC0  3C 60 80 6E */	lis r3, l_HIO@ha /* 0x806DFEA8@ha */
/* 806DFCC4  38 63 FE A8 */	addi r3, r3, l_HIO@l /* 0x806DFEA8@l */
...
/* 806DFCE0  3C 80 80 6E */	lis r4, lit_3893@ha /* 0x806DFE24@ha */
/* 806DFCE4  C0 24 FE 24 */	lfs f1, lit_3893@l(r4)  /* 0x806DFE24@l */
/* 806DFCE8  FC 40 08 90 */	fmr f2, f1
/* 806DFCEC  FC 60 08 90 */	fmr f3, f1
/* 806DFCF0  4B 93 A8 39 */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
/* 806DFCF4  7F E3 FB 78 */	mr r3, r31
/* 806DFCF8  3C 80 80 6E */	lis r4, lit_3894@ha /* 0x806DFE28@ha */
/* 806DFCFC  C0 24 FE 28 */	lfs f1, lit_3894@l(r4)  /* 0x806DFE28@l */
/* 806DFD00  FC 40 08 90 */	fmr f2, f1
/* 806DFD04  FC 60 08 90 */	fmr f3, f1
/* 806DFD08  4B 93 A8 31 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 806DFD2C  4B BE 13 69 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
