...
/* 80504DEC  4B E5 D3 ED */	bl _savegpr_28
/* 80504DF0  2C 04 00 00 */	cmpwi r4, 0
/* 80504DF4  40 82 04 E4 */	bne lbl_805052D8
/* 80504DF8  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 80504DFC  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80504E00  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80504E24  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80504E28  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80504E2C  80 84 00 00 */	lwz r4, 0(r4)
/* 80504E30  4B E4 16 81 */	bl PSMTXCopy
...
/* 80504E48  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504E4C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504E50  80 63 00 00 */	lwz r3, 0(r3)
/* 80504E54  A8 9C 09 CA */	lha r4, 0x9ca(r28)
/* 80504E58  4B B0 75 DD */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80504E74  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504E78  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504E7C  80 63 00 00 */	lwz r3, 0(r3)
/* 80504E80  A8 9C 09 CA */	lha r4, 0x9ca(r28)
/* 80504E84  4B B0 75 19 */	bl mDoMtx_XrotM__FPA4_fs
lbl_80504E88:
/* 80504E88  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504E8C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504E90  80 63 00 00 */	lwz r3, 0(r3)
/* 80504E94  A8 9C 0A E0 */	lha r4, 0xae0(r28)
/* 80504E98  4B B0 75 9D */	bl mDoMtx_YrotM__FPA4_fs
/* 80504E9C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504EA0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80504EC0  4B B0 76 0D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80504EC4  48 00 03 84 */	b lbl_80505248
lbl_80504EC8:
/* 80504EC8  2C 1F 00 02 */	cmpwi r31, 2
/* 80504ECC  40 82 00 1C */	bne lbl_80504EE8
/* 80504ED0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504ED4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504ED8  80 63 00 00 */	lwz r3, 0(r3)
/* 80504EDC  A8 9C 0A CA */	lha r4, 0xaca(r28)
/* 80504EE0  4B B0 75 55 */	bl mDoMtx_YrotM__FPA4_fs
/* 80504EE4  48 00 03 64 */	b lbl_80505248
lbl_80504EE8:
/* 80504EE8  2C 1F 00 04 */	cmpwi r31, 4
/* 80504EEC  40 82 00 1C */	bne lbl_80504F08
/* 80504EF0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504EF4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504EF8  80 63 00 00 */	lwz r3, 0(r3)
/* 80504EFC  A8 9C 0A CC */	lha r4, 0xacc(r28)
/* 80504F00  4B B0 75 CD */	bl mDoMtx_ZrotM__FPA4_fs
/* 80504F04  48 00 03 44 */	b lbl_80505248
lbl_80504F08:
/* 80504F08  2C 1F 00 06 */	cmpwi r31, 6
/* 80504F0C  40 82 00 1C */	bne lbl_80504F28
/* 80504F10  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504F14  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504F18  80 63 00 00 */	lwz r3, 0(r3)
/* 80504F1C  A8 9C 0A CE */	lha r4, 0xace(r28)
/* 80504F20  4B B0 75 15 */	bl mDoMtx_YrotM__FPA4_fs
/* 80504F24  48 00 03 24 */	b lbl_80505248
lbl_80504F28:
/* 80504F28  2C 1F 00 08 */	cmpwi r31, 8
/* 80504F2C  40 82 00 1C */	bne lbl_80504F48
/* 80504F30  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504F34  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504F38  80 63 00 00 */	lwz r3, 0(r3)
/* 80504F3C  A8 9C 0A D0 */	lha r4, 0xad0(r28)
/* 80504F40  4B B0 75 8D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80504F44  48 00 03 04 */	b lbl_80505248
lbl_80504F48:
/* 80504F48  2C 1F 00 0B */	cmpwi r31, 0xb
/* 80504F4C  40 82 01 20 */	bne lbl_8050506C
/* 80504F50  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504F54  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504F58  80 63 00 00 */	lwz r3, 0(r3)
/* 80504F5C  A8 9C 0A 3A */	lha r4, 0xa3a(r28)
/* 80504F60  4B B0 74 D5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80504F64  88 1C 09 C8 */	lbz r0, 0x9c8(r28)
/* 80504F68  2C 00 00 03 */	cmpwi r0, 3
/* 80504F6C  40 82 00 18 */	bne lbl_80504F84
/* 80504F70  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504F74  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80504F78  80 63 00 00 */	lwz r3, 0(r3)
/* 80504F7C  A8 9C 09 CA */	lha r4, 0x9ca(r28)
/* 80504F80  4B B0 74 1D */	bl mDoMtx_XrotM__FPA4_fs
lbl_80504F84:
/* 80504F84  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504F88  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80504FA0  4B B0 75 2D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80504FA4  88 1C 09 C8 */	lbz r0, 0x9c8(r28)
/* 80504FA8  2C 00 00 04 */	cmpwi r0, 4
/* 80504FAC  40 82 00 9C */	bne lbl_80505048
/* 80504FB0  3C 60 80 52 */	lis r3, lit_4289@ha /* 0x805185E4@ha */
/* 80504FB4  C0 43 85 E4 */	lfs f2, lit_4289@l(r3)  /* 0x805185E4@l */
/* 80504FB8  A8 1C 09 CC */	lha r0, 0x9cc(r28)
/* 80504FBC  3C 60 80 52 */	lis r3, lit_4293@ha /* 0x805185EC@ha */
/* 80504FC0  C8 23 85 EC */	lfd f1, lit_4293@l(r3)  /* 0x805185EC@l */
...
/* 80504FE0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80504FE4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80504FF8  4B B0 74 3D */	bl mDoMtx_YrotM__FPA4_fs
/* 80504FFC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505000  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80505004  80 63 00 00 */	lwz r3, 0(r3)
/* 80505008  3C 80 80 52 */	lis r4, lit_4468@ha /* 0x805185F4@ha */
/* 8050500C  C0 44 85 F4 */	lfs f2, lit_4468@l(r4)  /* 0x805185F4@l */
/* 80505010  A8 1C 09 CC */	lha r0, 0x9cc(r28)
/* 80505014  3C 80 80 52 */	lis r4, lit_4293@ha /* 0x805185EC@ha */
/* 80505018  C8 24 85 EC */	lfd f1, lit_4293@l(r4)  /* 0x805185EC@l */
...
/* 80505044  4B B0 73 59 */	bl mDoMtx_XrotM__FPA4_fs
lbl_80505048:
/* 80505048  88 1C 09 C8 */	lbz r0, 0x9c8(r28)
/* 8050504C  2C 00 00 03 */	cmpwi r0, 3
/* 80505050  40 82 01 F8 */	bne lbl_80505248
/* 80505054  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505058  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8050505C  80 63 00 00 */	lwz r3, 0(r3)
/* 80505060  A8 9C 09 CC */	lha r4, 0x9cc(r28)
/* 80505064  4B B0 74 69 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8050508C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505090  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805050B0  4B B0 73 85 */	bl mDoMtx_YrotM__FPA4_fs
/* 805050B4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805050B8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805050E0  4B B0 73 ED */	bl mDoMtx_ZrotM__FPA4_fs
/* 805050E4  48 00 01 64 */	b lbl_80505248
lbl_805050E8:
/* 805050E8  2C 1F 00 0C */	cmpwi r31, 0xc
/* 805050EC  40 82 00 B0 */	bne lbl_8050519C
/* 805050F0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805050F4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805050F8  80 63 00 00 */	lwz r3, 0(r3)
/* 805050FC  A8 9C 0A 34 */	lha r4, 0xa34(r28)
/* 80505100  4B B0 73 35 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 8050511C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505120  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80505140  4B B0 72 F5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80505144  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505148  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80505170  4B B0 73 5D */	bl mDoMtx_ZrotM__FPA4_fs
/* 80505174  48 00 00 D4 */	b lbl_80505248
lbl_80505178:
/* 80505178  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8050517C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80505194  4B B0 73 39 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80505198  48 00 00 B0 */	b lbl_80505248
lbl_8050519C:
/* 8050519C  2C 1F 00 11 */	cmpwi r31, 0x11
/* 805051A0  40 82 00 28 */	bne lbl_805051C8
/* 805051A4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805051A8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805051C0  4B B0 72 75 */	bl mDoMtx_YrotM__FPA4_fs
/* 805051C4  48 00 00 84 */	b lbl_80505248
lbl_805051C8:
/* 805051C8  2C 1F 00 12 */	cmpwi r31, 0x12
/* 805051CC  40 82 00 28 */	bne lbl_805051F4
/* 805051D0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805051D4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805051EC  4B B0 72 49 */	bl mDoMtx_YrotM__FPA4_fs
/* 805051F0  48 00 00 58 */	b lbl_80505248
lbl_805051F4:
/* 805051F4  2C 1F 00 16 */	cmpwi r31, 0x16
/* 805051F8  40 82 00 28 */	bne lbl_80505220
/* 805051FC  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505200  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80505218  4B B0 72 1D */	bl mDoMtx_YrotM__FPA4_fs
/* 8050521C  48 00 00 2C */	b lbl_80505248
lbl_80505220:
/* 80505220  2C 1F 00 17 */	cmpwi r31, 0x17
/* 80505224  40 82 00 24 */	bne lbl_80505248
/* 80505228  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8050522C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80505244  4B B0 71 F1 */	bl mDoMtx_YrotM__FPA4_fs
lbl_80505248:
...
/* 8050525C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505260  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80505264  80 63 00 00 */	lwz r3, 0(r3)
/* 80505268  4B B0 71 CD */	bl mDoMtx_YrotM__FPA4_fs
/* 8050526C  48 00 00 38 */	b lbl_805052A4
lbl_80505270:
/* 80505270  57 E0 07 BD */	rlwinm. r0, r31, 0, 0x1e, 0x1e
/* 80505274  41 82 00 18 */	beq lbl_8050528C
/* 80505278  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8050527C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80505280  80 63 00 00 */	lwz r3, 0(r3)
/* 80505284  4B B0 71 19 */	bl mDoMtx_XrotM__FPA4_fs
/* 80505288  48 00 00 1C */	b lbl_805052A4
lbl_8050528C:
/* 8050528C  57 E0 07 7B */	rlwinm. r0, r31, 0, 0x1d, 0x1d
/* 80505290  41 82 00 14 */	beq lbl_805052A4
/* 80505294  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505298  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8050529C  80 63 00 00 */	lwz r3, 0(r3)
/* 805052A0  4B B0 72 2D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_805052A4:
/* 805052A4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805052A8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 805052BC  4B E4 11 F5 */	bl PSMTXCopy
/* 805052C0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 805052C4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805052C8  80 63 00 00 */	lwz r3, 0(r3)
/* 805052CC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 805052D0  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 805052D4  4B E4 11 DD */	bl PSMTXCopy
lbl_805052D8:
/* 805052D8  38 60 00 01 */	li r3, 1
/* 805052DC  39 61 00 40 */	addi r11, r1, 0x40
/* 805052E0  4B E5 CF 45 */	bl _restgpr_28
