...
/* 80505414  4B E5 CD C9 */	bl _savegpr_29
/* 80505418  2C 04 00 00 */	cmpwi r4, 0
/* 8050541C  40 82 00 94 */	bne lbl_805054B0
/* 80505420  A0 83 00 14 */	lhz r4, 0x14(r3)
/* 80505424  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80505428  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 80505458  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8050545C  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80505460  80 84 00 00 */	lwz r4, 0(r4)
/* 80505464  4B E4 10 4D */	bl PSMTXCopy
/* 80505468  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8050546C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80505470  80 63 00 00 */	lwz r3, 0(r3)
/* 80505474  A8 9D 09 A8 */	lha r4, 0x9a8(r29)
/* 80505478  4B B0 70 55 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8050547C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80505480  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 80505494  4B E4 10 1D */	bl PSMTXCopy
/* 80505498  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8050549C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 805054A0  80 63 00 00 */	lwz r3, 0(r3)
/* 805054A4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 805054A8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 805054AC  4B E4 10 05 */	bl PSMTXCopy
lbl_805054B0:
/* 805054B0  38 60 00 01 */	li r3, 1
/* 805054B4  39 61 00 20 */	addi r11, r1, 0x20
/* 805054B8  4B E5 CD 71 */	bl _restgpr_29
