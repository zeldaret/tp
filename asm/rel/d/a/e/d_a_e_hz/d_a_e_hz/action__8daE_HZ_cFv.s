...
/* 806EEEFC  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806EEF00  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806EEF04  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 806EEF08  4B 92 B8 D9 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806EEF0C  D0 3F 06 A4 */	stfs f1, 0x6a4(r31)
/* 806EEF10  7F E3 FB 78 */	mr r3, r31
/* 806EEF14  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 806EEF18  4B 92 B7 F9 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806EEF6C  3C 60 80 6F */	lis r3, lit_5940@ha /* 0x806F09B8@ha */
/* 806EEF70  38 63 09 B8 */	addi r3, r3, lit_5940@l /* 0x806F09B8@l */
...
/* 806EF06C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806EF070  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806EF074  4B C5 74 3D */	bl PSMTXCopy
/* 806EF078  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806EF07C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806EF098  3C 60 80 6F */	lis r3, lit_4263@ha /* 0x806F08C4@ha */
/* 806EF09C  C0 03 08 C4 */	lfs f0, lit_4263@l(r3)  /* 0x806F08C4@l */
...
/* 806EF0D0  4B BD 2A AD */	bl setLinkSearch__15Z2CreatureEnemyFb
/* 806EF0D4  7F E3 FB 78 */	mr r3, r31
/* 806EF0D8  38 80 00 00 */	li r4, 0
/* 806EF0DC  4B 92 B5 F1 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 806EF0F0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806EF0F4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806EF0F8  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806EF0FC  4B 98 79 B1 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 806EF118  4B 93 DF 55 */	bl dComIfGp_getReverb__Fi
/* 806EF11C  7C 65 1B 78 */	mr r5, r3
/* 806EF120  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 806EF124  38 80 00 00 */	li r4, 0
/* 806EF128  4B 92 1F 89 */	bl play__16mDoExt_McaMorfSOFUlSc
