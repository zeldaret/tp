...
/* 806ECB7C  4B C7 56 61 */	bl _savegpr_29
/* 806ECB80  7C 7D 1B 78 */	mr r29, r3
/* 806ECB84  3C 60 80 6F */	lis r3, lit_3966@ha /* 0x806F0860@ha */
/* 806ECB88  3B E3 08 60 */	addi r31, r3, lit_3966@l /* 0x806F0860@l */
/* 806ECB8C  38 61 00 CC */	addi r3, r1, 0xcc
/* 806ECB90  4B 98 A9 ED */	bl __ct__11dBgS_GndChkFv
/* 806ECB94  38 61 00 5C */	addi r3, r1, 0x5c
/* 806ECB98  4B 98 B0 D1 */	bl __ct__11dBgS_LinChkFv
/* 806ECB9C  3B C0 00 00 */	li r30, 0
/* 806ECBA0  80 7D 05 BC */	lwz r3, 0x5bc(r29)
/* 806ECBA4  C3 E3 00 1C */	lfs f31, 0x1c(r3)
/* 806ECBA8  4B A7 2D 29 */	bl getThrowBoomerangActor__9daPy_py_cFv
...
/* 806ECC8C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806ECC90  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806ECC94  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806ECC98  4B 92 DB 49 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806ECD44  4B C3 B6 E9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806ECE2C  4B B8 39 15 */	bl cLib_chaseF__FPfff
...
/* 806ECE4C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806ECE50  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806ECE54  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806ECE58  4B 92 D9 89 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806ECE98  4B B7 9C 9D */	bl __mi__4cXyzCFRC3Vec
...
/* 806ECEBC  4B B8 3D 49 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806ECEE0  4B C5 A2 59 */	bl PSVECSquareMag
...
/* 806ECF50  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806ECF54  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806ECFC0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806ECFC4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806ECFC8:
...
/* 806ED004  4B 98 AC D9 */	bl __dt__11dBgS_LinChkFv
/* 806ED008  38 61 00 CC */	addi r3, r1, 0xcc
/* 806ED00C  38 80 FF FF */	li r4, -1
/* 806ED010  4B 98 A5 E1 */	bl __dt__11dBgS_GndChkFv
...
/* 806ED05C  4B 98 AC 81 */	bl __dt__11dBgS_LinChkFv
/* 806ED060  38 61 00 CC */	addi r3, r1, 0xcc
/* 806ED064  38 80 FF FF */	li r4, -1
/* 806ED068  4B 98 A5 89 */	bl __dt__11dBgS_GndChkFv
...
/* 806ED08C  4B 98 AC D9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806ED090  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806ED094  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806ED098  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 806ED09C  7F C3 F3 78 */	mr r3, r30
/* 806ED0A0  38 81 00 5C */	addi r4, r1, 0x5c
/* 806ED0A4  4B 98 73 11 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 806ED0B8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806ED0BC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806ED0DC  4B B8 36 65 */	bl cLib_chaseF__FPfff
/* 806ED0E0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806ED0E4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806ED110  4B B8 36 31 */	bl cLib_chaseF__FPfff
...
/* 806ED134  4B B8 36 0D */	bl cLib_chaseF__FPfff
/* 806ED138  38 61 00 CC */	addi r3, r1, 0xcc
/* 806ED13C  38 81 00 50 */	addi r4, r1, 0x50
/* 806ED140  4B B7 AB E9 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 806ED144  7F C3 F3 78 */	mr r3, r30
/* 806ED148  38 81 00 CC */	addi r4, r1, 0xcc
/* 806ED14C  4B 98 73 55 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 806ED184  3C 60 80 6F */	lis r3, l_HIO@ha /* 0x806F0B7C@ha */
/* 806ED188  38 63 0B 7C */	addi r3, r3, l_HIO@l /* 0x806F0B7C@l */
...
/* 806ED1B4  4B B8 35 8D */	bl cLib_chaseF__FPfff
/* 806ED1B8  38 7D 06 7C */	addi r3, r29, 0x67c
/* 806ED1BC  C0 3F 00 04 */	lfs f1, 4(r31)
/* 806ED1C0  C0 5F 00 78 */	lfs f2, 0x78(r31)
/* 806ED1C4  4B B8 35 7D */	bl cLib_chaseF__FPfff
/* 806ED1C8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806ED1CC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806ED1FC  4B B8 39 95 */	bl cLib_chaseAngleS__FPsss
...
/* 806ED23C  4B B8 39 55 */	bl cLib_chaseAngleS__FPsss
lbl_806ED240:
/* 806ED240  3C 60 80 6F */	lis r3, l_HIO@ha /* 0x806F0B7C@ha */
/* 806ED244  38 63 0B 7C */	addi r3, r3, l_HIO@l /* 0x806F0B7C@l */
...
/* 806ED274  4B B8 39 1D */	bl cLib_chaseAngleS__FPsss
/* 806ED278  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806ED27C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806ED2F0  3C 60 80 6F */	lis r3, l_HIO@ha /* 0x806F0B7C@ha */
/* 806ED2F4  38 63 0B 7C */	addi r3, r3, l_HIO@l /* 0x806F0B7C@l */
...
lbl_806ED408:
/* 806ED408  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806ED40C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806ED4AC  4B B8 36 E5 */	bl cLib_chaseAngleS__FPsss
...
/* 806ED500  4B 98 A7 DD */	bl __dt__11dBgS_LinChkFv
/* 806ED504  38 61 00 CC */	addi r3, r1, 0xcc
/* 806ED508  38 80 FF FF */	li r4, -1
/* 806ED50C  4B 98 A0 E5 */	bl __dt__11dBgS_GndChkFv
...
/* 806ED544  4B C3 AE E9 */	bl checkPass__12J3DFrameCtrlFf
