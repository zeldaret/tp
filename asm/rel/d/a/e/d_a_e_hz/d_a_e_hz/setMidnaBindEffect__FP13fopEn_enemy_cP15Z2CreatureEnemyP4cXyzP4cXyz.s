...
/* 806F040C  4B C7 1D A9 */	bl _savegpr_19
/* 806F0410  7C 7E 1B 78 */	mr r30, r3
/* 806F0414  7C 9A 23 78 */	mr r26, r4
/* 806F0418  7C BB 2B 78 */	mr r27, r5
/* 806F041C  7C DC 33 78 */	mr r28, r6
/* 806F0420  3C 60 80 6F */	lis r3, cNullVec__6Z2Calc@ha /* 0x806F0974@ha */
/* 806F0424  3A E3 09 74 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x806F0974@l */
/* 806F0428  3C 60 80 6F */	lis r3, lit_3966@ha /* 0x806F0860@ha */
/* 806F042C  3B E3 08 60 */	addi r31, r3, lit_3966@l /* 0x806F0860@l */
/* 806F0430  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F0434  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806F0438  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 806F043C  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806F0440  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 806F0468  4B AB C1 15 */	bl dKy_darkworld_check__Fv
...
/* 806F048C  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806F0490  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 806F04A8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806F04AC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806F04B0  4B C5 60 01 */	bl PSMTXCopy
...
/* 806F04C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806F04CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806F04D0  38 81 00 4C */	addi r4, r1, 0x4c
/* 806F04D4  38 A1 00 58 */	addi r5, r1, 0x58
/* 806F04D8  4B C5 68 95 */	bl PSMTXMultVec
/* 806F04DC  38 61 00 34 */	addi r3, r1, 0x34
/* 806F04E0  38 81 00 58 */	addi r4, r1, 0x58
/* 806F04E4  7F 65 DB 78 */	mr r5, r27
/* 806F04E8  4B B7 66 4D */	bl __mi__4cXyzCFRC3Vec
...
/* 806F0504  4B B7 71 71 */	bl cM_atan2s__Fff
...
/* 806F0538  4B B7 71 3D */	bl cM_atan2s__Fff
...
/* 806F0554  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F0558  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806F05A8  4B 95 C4 E9 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806F05AC  7C 79 1B 79 */	or. r25, r3, r3
/* 806F05B0  41 82 00 FC */	beq lbl_806F06AC
/* 806F05B4  38 61 00 40 */	addi r3, r1, 0x40
/* 806F05B8  4B C5 6B 81 */	bl PSVECSquareMag
...
/* 806F0628  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806F062C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806F0698  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806F069C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806F06A0:
...
/* 806F06F0  4B 95 C3 A1 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806F072C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806F0730  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806F079C  4B 95 CD 31 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806F07FC  4B C7 1A 05 */	bl _restgpr_19
