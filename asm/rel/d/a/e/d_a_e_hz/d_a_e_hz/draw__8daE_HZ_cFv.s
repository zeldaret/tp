...
/* 806EA7A0  4B C7 7A 31 */	bl _savegpr_26
/* 806EA7A4  7C 7D 1B 78 */	mr r29, r3
/* 806EA7A8  3C 60 80 6F */	lis r3, lit_3966@ha /* 0x806F0860@ha */
/* 806EA7AC  3B E3 08 60 */	addi r31, r3, lit_3966@l /* 0x806F0860@l */
/* 806EA7B0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806EA7B4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806EA7B8  38 80 00 00 */	li r4, 0
/* 806EA7BC  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 806EA7C0  38 DD 01 0C */	addi r6, r29, 0x10c
/* 806EA7C4  4B AB 90 01 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806EA7C8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806EA7CC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806EA7D0  80 9D 05 C4 */	lwz r4, 0x5c4(r29)
/* 806EA7D4  80 84 00 04 */	lwz r4, 4(r4)
/* 806EA7D8  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806EA7DC  4B AB A5 C5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806EA7E0  80 7D 05 C4 */	lwz r3, 0x5c4(r29)
/* 806EA7E4  4B 92 34 E1 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 806EA804  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806EA808  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806EA80C  80 9E 00 04 */	lwz r4, 4(r30)
/* 806EA810  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806EA814  4B AB A5 8D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806EA8D8  4B 92 68 E9 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 806EA8DC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806EA8E0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806EA8E4  38 80 00 10 */	li r4, 0x10
/* 806EA8E8  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 806EA8EC  38 DD 06 F8 */	addi r6, r29, 0x6f8
/* 806EA8F0  4B AB 8E D5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806EA8F4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806EA8F8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806EA8FC  80 9D 05 C0 */	lwz r4, 0x5c0(r29)
/* 806EA900  80 84 00 04 */	lwz r4, 4(r4)
/* 806EA904  38 BD 06 F8 */	addi r5, r29, 0x6f8
/* 806EA908  4B AB A4 99 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806EA90C  80 7D 05 C0 */	lwz r3, 0x5c0(r29)
/* 806EA910  4B 92 33 B5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 806EA96C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806EA970  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806EA974  4B 94 3F 9D */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806EA978  90 7D 06 D0 */	stw r3, 0x6d0(r29)
lbl_806EA97C:
/* 806EA97C  38 60 00 01 */	li r3, 1
lbl_806EA980:
/* 806EA980  39 61 00 50 */	addi r11, r1, 0x50
/* 806EA984  4B C7 78 99 */	bl _restgpr_26
