...
/* 806EF8DC  4B C7 28 FD */	bl _savegpr_28
/* 806EF8E0  7C 7F 1B 78 */	mr r31, r3
/* 806EF8E4  3C 60 80 6F */	lis r3, d_a_e_hz__stringBase0@ha /* 0x806F095C@ha */
/* 806EF8E8  38 63 09 5C */	addi r3, r3, d_a_e_hz__stringBase0@l /* 0x806F095C@l */
/* 806EF8EC  38 80 00 16 */	li r4, 0x16
/* 806EF8F0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806EF8F4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806EF908  4B 94 C9 E5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806EF90C  7C 7C 1B 78 */	mr r28, r3
/* 806EF910  38 60 00 58 */	li r3, 0x58
/* 806EF914  4B BD F3 39 */	bl __nw__FUl
/* 806EF918  7C 7D 1B 79 */	or. r29, r3, r3
/* 806EF91C  41 82 00 68 */	beq lbl_806EF984
/* 806EF920  3C 60 80 6F */	lis r3, d_a_e_hz__stringBase0@ha /* 0x806F095C@ha */
/* 806EF924  38 63 09 5C */	addi r3, r3, d_a_e_hz__stringBase0@l /* 0x806F095C@l */
/* 806EF928  38 80 00 10 */	li r4, 0x10
/* 806EF92C  7F C5 F3 78 */	mr r5, r30
/* 806EF930  38 C0 00 80 */	li r6, 0x80
/* 806EF934  4B 94 C9 B9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806EF96C  3D 20 80 6F */	lis r9, lit_3968@ha /* 0x806F0868@ha */
/* 806EF970  C0 29 08 68 */	lfs f1, lit_3968@l(r9)  /* 0x806F0868@l */
/* 806EF974  39 20 00 00 */	li r9, 0
/* 806EF978  39 40 FF FF */	li r10, -1
/* 806EF97C  4B 92 0E 55 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806EF9AC  3C 80 80 6F */	lis r4, d_a_e_hz__stringBase0@ha /* 0x806F095C@ha */
/* 806EF9B0  38 84 09 5C */	addi r4, r4, d_a_e_hz__stringBase0@l /* 0x806F095C@l */
...
/* 806EF9CC  4B 94 C9 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806EF9E0  4B 94 C9 0D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
lbl_806EF9E4:
...
/* 806EF9F0  4B 92 52 65 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 806EFA10  4B BD F2 3D */	bl __nw__FUl
/* 806EFA14  7C 60 1B 79 */	or. r0, r3, r3
/* 806EFA18  41 82 00 0C */	beq lbl_806EFA24
/* 806EFA1C  4B 98 BF 55 */	bl __ct__4dBgWFv
...
lbl_806EFA3C:
/* 806EFA3C  3C 60 80 6F */	lis r3, d_a_e_hz__stringBase0@ha /* 0x806F095C@ha */
/* 806EFA40  38 63 09 5C */	addi r3, r3, d_a_e_hz__stringBase0@l /* 0x806F095C@l */
/* 806EFA44  38 80 00 1A */	li r4, 0x1a
/* 806EFA48  7F C5 F3 78 */	mr r5, r30
/* 806EFA4C  38 C0 00 80 */	li r6, 0x80
/* 806EFA50  4B 94 C8 9D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806EFA64  4B 98 A4 D5 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_806EFA7C:
/* 806EFA7C  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 0x80075A24@ha */
/* 806EFA80  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 0x80075A24@l */
/* 806EFA84  80 7F 0A B4 */	lwz r3, 0xab4(r31)
/* 806EFA88  90 03 00 B0 */	stw r0, 0xb0(r3)
/* 806EFA8C  3C 60 80 6F */	lis r3, d_a_e_hz__stringBase0@ha /* 0x806F095C@ha */
/* 806EFA90  38 63 09 5C */	addi r3, r3, d_a_e_hz__stringBase0@l /* 0x806F095C@l */
/* 806EFA94  38 80 00 17 */	li r4, 0x17
/* 806EFA98  7F C5 F3 78 */	mr r5, r30
/* 806EFA9C  38 C0 00 80 */	li r6, 0x80
/* 806EFAA0  4B 94 C8 4D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806EFAB0  4B 92 51 A5 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 806EFADC  3C 60 80 6F */	lis r3, JointCallBack__8daE_HZ_cFP8J3DJointi@ha /* 0x806EF880@ha */
/* 806EFAE0  38 83 F8 80 */	addi r4, r3, JointCallBack__8daE_HZ_cFP8J3DJointi@l /* 0x806EF880@l */
...
/* 806EFB20  4B C7 27 05 */	bl _restgpr_28
