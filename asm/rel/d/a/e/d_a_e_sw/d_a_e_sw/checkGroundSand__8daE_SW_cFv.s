...
/* 807ABD40  3C 60 80 7B */	lis r3, lit_3909@ha /* 0x807AFD2C@ha */
/* 807ABD44  3B C3 FD 2C */	addi r30, r3, lit_3909@l /* 0x807AFD2C@l */
...
/* 807ABD74  4B AC 50 4D */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 807ABD78  38 61 00 08 */	addi r3, r1, 8
/* 807ABD7C  4B 87 1F 41 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 807ABD80  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 807ABD84  41 82 00 34 */	beq lbl_807ABDB8
/* 807ABD88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807ABD8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807ABD90  38 63 0F 38 */	addi r3, r3, 0xf38
/* 807ABD94  3C 80 80 3F */	lis r4, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 807ABD98  38 84 1C C4 */	addi r4, r4, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
/* 807ABD9C  38 84 00 14 */	addi r4, r4, 0x14
/* 807ABDA0  4B 8C 90 B1 */	bl GetPolyAtt0__4dBgSFRC13cBgS_PolyInfo
...
/* 807ABDD0  4B AC 4F F1 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 807ABDD4  38 61 00 08 */	addi r3, r1, 8
/* 807ABDD8  4B 87 1E E5 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 807ABDDC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 807ABDE0  41 82 00 34 */	beq lbl_807ABE14
/* 807ABDE4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807ABDE8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807ABDEC  38 63 0F 38 */	addi r3, r3, 0xf38
/* 807ABDF0  3C 80 80 3F */	lis r4, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 807ABDF4  38 84 1C C4 */	addi r4, r4, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
/* 807ABDF8  38 84 00 14 */	addi r4, r4, 0x14
/* 807ABDFC  4B 8C 90 55 */	bl GetPolyAtt0__4dBgSFRC13cBgS_PolyInfo
