...
/* 807A9778  4B BB 8A 65 */	bl _savegpr_29
/* 807A977C  7C 7D 1B 78 */	mr r29, r3
/* 807A9780  3C 80 80 7B */	lis r4, lit_3909@ha /* 0x807AFD2C@ha */
/* 807A9784  3B E4 FD 2C */	addi r31, r4, lit_3909@l /* 0x807AFD2C@l */
/* 807A9788  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807A978C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807A9848  4B AC 73 BD */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807A98A0  4B B9 DA FD */	bl PSVECSquareDistance
...
/* 807A9910  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807A9914  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807A9980  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807A9984  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807A9988:
...
/* 807A9A44  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 807A9A48  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 807A9A9C  4B AB DB D9 */	bl cM_atan2s__Fff
...
/* 807A9AC0  4B B9 D6 79 */	bl PSVECSquareMag
...
/* 807A9B30  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807A9B34  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807A9BA0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807A9BA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807A9BA8:
...
/* 807A9BE0  4B AC 6F B1 */	bl cLib_chaseAngleS__FPsss
...
/* 807A9CF8  4B 86 FF 85 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_807A9CFC:
...
/* 807A9DB8  4B AC 69 89 */	bl cLib_chaseF__FPfff
...
/* 807A9E00  4B 87 3E BD */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 807A9E04  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 807A9E08  40 82 00 10 */	bne lbl_807A9E18
/* 807A9E0C  7F A3 EB 78 */	mr r3, r29
/* 807A9E10  4B 86 FE 6D */	bl fopAcM_delete__FP10fopAc_ac_c
/* 807A9E14  48 00 00 2C */	b lbl_807A9E40
lbl_807A9E18:
/* 807A9E18  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 807A9E1C  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
