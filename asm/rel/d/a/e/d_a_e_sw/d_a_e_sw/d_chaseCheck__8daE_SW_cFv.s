...
/* 807AD7D8  4B BB 4A 05 */	bl _savegpr_29
/* 807AD7DC  7C 7F 1B 78 */	mr r31, r3
/* 807AD7E0  3C 60 80 7B */	lis r3, lit_3909@ha /* 0x807AFD2C@ha */
/* 807AD7E4  3B C3 FD 2C */	addi r30, r3, lit_3909@l /* 0x807AFD2C@l */
/* 807AD7E8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807AD7EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807AD828  4B B9 9B 75 */	bl PSVECSquareDistance
...
/* 807AD898  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807AD89C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807AD908  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807AD90C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
/* 807AD910  48 00 00 08 */	b lbl_807AD918
lbl_807AD914:
/* 807AD914  FF E0 08 90 */	fmr f31, f1
lbl_807AD918:
/* 807AD918  3B A0 00 00 */	li r29, 0
/* 807AD91C  3C 60 80 7B */	lis r3, l_HIO@ha /* 0x807B0210@ha */
/* 807AD920  38 63 02 10 */	addi r3, r3, l_HIO@l /* 0x807B0210@l */
...
lbl_807AD93C:
/* 807AD93C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807AD940  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807AD944  3B C3 56 B8 */	addi r30, r3, 0x56b8
/* 807AD948  7F C3 F3 78 */	mr r3, r30
/* 807AD94C  4B 8C 5E 99 */	bl LockonTruth__12dAttention_cFv
...
/* 807AD960  4B 8C 5B DD */	bl LockonTarget__12dAttention_cFl
/* 807AD964  7C 03 F8 40 */	cmplw r3, r31
/* 807AD968  40 82 00 08 */	bne lbl_807AD970
/* 807AD96C  3B A0 00 01 */	li r29, 1
lbl_807AD970:
/* 807AD970  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807AD974  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807AD994  4B AC 34 91 */	bl cLib_distanceAngleS__Fss
...
/* 807AD9BC  4B BB 77 15 */	bl abs
/* 807AD9C0  2C 03 20 00 */	cmpwi r3, 0x2000
/* 807AD9C4  41 80 00 18 */	blt lbl_807AD9DC
/* 807AD9C8  3C 60 80 7B */	lis r3, l_HIO@ha /* 0x807B0210@ha */
/* 807AD9CC  38 63 02 10 */	addi r3, r3, l_HIO@l /* 0x807B0210@l */
...
/* 807AD9F4  4B BB 48 35 */	bl _restgpr_29
