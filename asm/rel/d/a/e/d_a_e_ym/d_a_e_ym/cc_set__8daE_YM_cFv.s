...
/* 808135C0  4B B4 EC 1D */	bl _savegpr_29
/* 808135C4  7C 7D 1B 78 */	mr r29, r3
/* 808135C8  3C 60 80 81 */	lis r3, lit_3925@ha /* 0x80815994@ha */
/* 808135CC  3B E3 59 94 */	addi r31, r3, lit_3925@l /* 0x80815994@l */
...
/* 8081361C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813620  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813624  4B B3 2E 8D */	bl PSMTXCopy
...
/* 8081363C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813640  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813644  38 81 00 44 */	addi r4, r1, 0x44
/* 80813648  38 BD 05 38 */	addi r5, r29, 0x538
/* 8081364C  4B B3 37 21 */	bl PSMTXMultVec
...
lbl_80813684:
/* 80813684  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813688  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8081368C  A8 9D 06 68 */	lha r4, 0x668(r29)
/* 80813690  4B 7F 8C B5 */	bl mDoMtx_XrotS__FPA4_fs
/* 80813694  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813698  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8081369C  A8 9D 06 6C */	lha r4, 0x66c(r29)
/* 808136A0  4B 7F 8E 2D */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 808136BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 808136C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 808136C4  38 81 00 44 */	addi r4, r1, 0x44
/* 808136C8  38 A1 00 38 */	addi r5, r1, 0x38
/* 808136CC  4B B3 36 A1 */	bl PSMTXMultVec
/* 808136D0  38 61 00 20 */	addi r3, r1, 0x20
/* 808136D4  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 808136D8  38 A1 00 38 */	addi r5, r1, 0x38
/* 808136DC  4B A5 34 09 */	bl __pl__4cXyzCFRC3Vec
...
/* 808136F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 808136FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813700  A8 9D 06 68 */	lha r4, 0x668(r29)
/* 80813704  4B 7F 8C 41 */	bl mDoMtx_XrotS__FPA4_fs
/* 80813708  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8081370C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813710  A8 9D 06 6C */	lha r4, 0x66c(r29)
/* 80813714  4B 7F 8D B9 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80813730  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813734  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813738  38 81 00 44 */	addi r4, r1, 0x44
/* 8081373C  38 A1 00 38 */	addi r5, r1, 0x38
/* 80813740  4B B3 36 2D */	bl PSMTXMultVec
/* 80813744  38 61 00 14 */	addi r3, r1, 0x14
/* 80813748  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 8081374C  38 A1 00 38 */	addi r5, r1, 0x38
/* 80813750  4B A5 33 95 */	bl __pl__4cXyzCFRC3Vec
...
/* 808137C0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 808137C4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 808137C8  4B B3 2C E9 */	bl PSMTXCopy
...
lbl_8081380C:
/* 8081380C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813810  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813814  38 81 00 44 */	addi r4, r1, 0x44
/* 80813818  38 A1 00 38 */	addi r5, r1, 0x38
/* 8081381C  4B B3 35 51 */	bl PSMTXMultVec
/* 80813820  38 61 00 08 */	addi r3, r1, 8
/* 80813824  38 81 00 38 */	addi r4, r1, 0x38
/* 80813828  38 A1 00 2C */	addi r5, r1, 0x2c
/* 8081382C  4B A5 32 B9 */	bl __pl__4cXyzCFRC3Vec
/* 80813830  38 7D 0A 98 */	addi r3, r29, 0xa98
/* 80813834  38 81 00 08 */	addi r4, r1, 8
/* 80813838  4B A5 BE 11 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 80813850  4B A5 BE B9 */	bl SetR__8cM3dGSphFf
...
/* 8081386C  4B A5 BE 9D */	bl SetR__8cM3dGSphFf
/* 80813870  48 00 00 10 */	b lbl_80813880
lbl_80813874:
/* 80813874  38 7D 0A 98 */	addi r3, r29, 0xa98
/* 80813878  C0 3F 00 30 */	lfs f1, 0x30(r31)
/* 8081387C  4B A5 BE 8D */	bl SetR__8cM3dGSphFf
lbl_80813880:
/* 80813880  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80813884  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80813888  38 63 23 3C */	addi r3, r3, 0x233c
/* 8081388C  38 9D 09 74 */	addi r4, r29, 0x974
/* 80813890  4B A5 13 19 */	bl Set__4cCcSFP8cCcD_Obj
/* 80813894  39 61 00 60 */	addi r11, r1, 0x60
/* 80813898  4B B4 E9 91 */	bl _restgpr_29
