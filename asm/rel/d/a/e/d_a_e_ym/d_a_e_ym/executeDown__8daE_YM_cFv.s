...
/* 8080B45C  4B B5 6D 7D */	bl _savegpr_28
/* 8080B460  7C 7D 1B 78 */	mr r29, r3
/* 8080B464  3C 60 80 81 */	lis r3, lit_3925@ha /* 0x80815994@ha */
/* 8080B468  3B E3 59 94 */	addi r31, r3, lit_3925@l /* 0x80815994@l */
...
/* 8080B4B0  4B 86 C1 C9 */	bl __ct__18dBgS_ObjGndChk_WtrFv
/* 8080B4B4  38 61 01 2C */	addi r3, r1, 0x12c
/* 8080B4B8  38 81 00 48 */	addi r4, r1, 0x48
/* 8080B4BC  4B A5 C8 51 */	bl SetPos__11cBgS_GndChkFPC3Vec
/* 8080B4C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8080B4C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8080B4C8  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 8080B4CC  7F C3 F3 78 */	mr r3, r30
/* 8080B4D0  38 81 01 2C */	addi r4, r1, 0x12c
/* 8080B4D4  4B 86 8F CD */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8080B580  4B A5 C3 D5 */	bl cM_rndF__Ff
...
/* 8080B594  4B A5 C3 C1 */	bl cM_rndF__Ff
...
/* 8080B5D4  4B 86 A9 85 */	bl SetWall__12dBgS_AcchCirFff
/* 8080B5D8  88 1D 06 A0 */	lbz r0, 0x6a0(r29)
/* 8080B5DC  28 00 00 01 */	cmplwi r0, 1
/* 8080B5E0  40 82 01 20 */	bne lbl_8080B700
/* 8080B5E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8080B5E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8080B614  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8080B618  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8080B658  4B B3 BA 39 */	bl PSVECAdd
/* 8080B65C  38 61 00 BC */	addi r3, r1, 0xbc
/* 8080B660  4B 86 C6 09 */	bl __ct__11dBgS_LinChkFv
...
/* 8080B674  4B 86 C6 F1 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8080B678  7F C3 F3 78 */	mr r3, r30
/* 8080B67C  38 81 00 BC */	addi r4, r1, 0xbc
/* 8080B680  4B 86 8D 35 */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 8080B684  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8080B688  41 82 00 6C */	beq lbl_8080B6F4
/* 8080B68C  3C 60 80 81 */	lis r3, __vt__8cM3dGPla@ha /* 0x80815D04@ha */
/* 8080B690  38 03 5D 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80815D04@l */
...
/* 8080B6E8  3C 60 80 81 */	lis r3, __vt__8cM3dGPla@ha /* 0x80815D04@ha */
/* 8080B6EC  38 03 5D 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80815D04@l */
/* 8080B6F0  90 01 00 64 */	stw r0, 0x64(r1)
lbl_8080B6F4:
/* 8080B6F4  38 61 00 BC */	addi r3, r1, 0xbc
/* 8080B6F8  38 80 FF FF */	li r4, -1
/* 8080B6FC  4B 86 C5 E1 */	bl __dt__11dBgS_LinChkFv
lbl_8080B700:
...
/* 8080B710  3C 60 80 81 */	lis r3, d_a_e_ym__stringBase0@ha /* 0x80815AEC@ha */
/* 8080B714  38 63 5A EC */	addi r3, r3, d_a_e_ym__stringBase0@l /* 0x80815AEC@l */
/* 8080B718  38 63 00 0A */	addi r3, r3, 0xa
/* 8080B71C  38 9E 3E C8 */	addi r4, r30, 0x3ec8
/* 8080B720  4B B5 D2 75 */	bl strcmp
/* 8080B724  2C 03 00 00 */	cmpwi r3, 0
/* 8080B728  40 82 03 D8 */	bne lbl_8080BB00
/* 8080B72C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8080B730  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8080B744  4B 82 12 39 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 8080B75C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8080B760  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8080B764  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8080B768  7C 05 07 74 */	extsb r5, r0
/* 8080B76C  4B 82 9B F5 */	bl isSwitch__10dSv_info_cCFii
/* 8080B770  2C 03 00 00 */	cmpwi r3, 0
/* 8080B774  40 82 03 8C */	bne lbl_8080BB00
/* 8080B778  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8080B77C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8080B780  88 9D 06 A2 */	lbz r4, 0x6a2(r29)
/* 8080B784  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8080B788  7C 05 07 74 */	extsb r5, r0
/* 8080B78C  4B 82 9A 75 */	bl onSwitch__10dSv_info_cFii
...
/* 8080B7B4  4B 86 B9 61 */	bl SetGroundUpY__9dBgS_AcchFf
lbl_8080B7B8:
...
/* 8080B7CC  4B A6 4D 75 */	bl cLib_addCalcAngleS__FPsssss
...
/* 8080B7E8  4B A6 4D 59 */	bl cLib_addCalcAngleS__FPsssss
lbl_8080B7EC:
...
/* 8080B860  4B A5 C0 F5 */	bl cM_rndF__Ff
...
/* 8080B9A4  4B 86 BB D9 */	bl __ct__11dBgS_GndChkFv
/* 8080B9A8  38 61 00 68 */	addi r3, r1, 0x68
/* 8080B9AC  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 8080B9B0  4B A5 C3 79 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 8080B9B4  7F C3 F3 78 */	mr r3, r30
/* 8080B9B8  38 81 00 68 */	addi r4, r1, 0x68
/* 8080B9BC  4B 86 8A E5 */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8080B9F4  4B 86 94 FD */	bl GetGroundCode__4dBgSFRC13cBgS_PolyInfo
...
/* 8080BA08  4B 86 94 E9 */	bl GetGroundCode__4dBgSFRC13cBgS_PolyInfo
...
/* 8080BA1C  4B 86 94 D5 */	bl GetGroundCode__4dBgSFRC13cBgS_PolyInfo
...
/* 8080BA68  4B 86 BB 89 */	bl __dt__11dBgS_GndChkFv
...
/* 8080BAAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8080BAB0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8080BAB4  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8080BAB8  7C 05 07 74 */	extsb r5, r0
/* 8080BABC  4B 82 98 A5 */	bl isSwitch__10dSv_info_cCFii
/* 8080BAC0  2C 03 00 00 */	cmpwi r3, 0
/* 8080BAC4  40 82 00 1C */	bne lbl_8080BAE0
/* 8080BAC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8080BACC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8080BAD0  88 9D 06 A2 */	lbz r4, 0x6a2(r29)
/* 8080BAD4  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8080BAD8  7C 05 07 74 */	extsb r5, r0
/* 8080BADC  4B 82 97 25 */	bl onSwitch__10dSv_info_cFii
lbl_8080BAE0:
/* 8080BAE0  7F A3 EB 78 */	mr r3, r29
/* 8080BAE4  4B 80 E1 99 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 8080BAFC  4B 81 0F DD */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
lbl_8080BB00:
