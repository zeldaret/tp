...
/* 8081301C  4B B4 F1 C1 */	bl _savegpr_29
/* 80813020  7C 7E 1B 78 */	mr r30, r3
/* 80813024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80813028  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8081304C  4B 80 77 95 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80813050  D0 3E 06 D8 */	stfs f1, 0x6d8(r30)
/* 80813054  7F C3 F3 78 */	mr r3, r30
/* 80813058  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8081305C  4B 80 76 B5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8081308C  3C 60 80 81 */	lis r3, lit_3926@ha /* 0x80815998@ha */
/* 80813090  C0 03 59 98 */	lfs f0, lit_3926@l(r3)  /* 0x80815998@l */
...
/* 80813118  3C 60 80 81 */	lis r3, lit_8522@ha /* 0x80815BDC@ha */
/* 8081311C  38 63 5B DC */	addi r3, r3, lit_8522@l /* 0x80815BDC@l */
...
/* 80813230  4B AA E9 4D */	bl setLinkSearch__15Z2CreatureEnemyFb
...
/* 80813284  3C 60 80 81 */	lis r3, __vt__8cM3dGPla@ha /* 0x80815D04@ha */
/* 80813288  38 03 5D 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80815D04@l */
/* 8081328C  90 01 00 4C */	stw r0, 0x4c(r1)
/* 80813290  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80813294  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80813298  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8081329C  38 9E 08 50 */	addi r4, r30, 0x850
/* 808132A0  38 A1 00 3C */	addi r5, r1, 0x3c
/* 808132A4  4B 86 14 A1 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 808132A8  C0 21 00 44 */	lfs f1, 0x44(r1)
/* 808132AC  C0 41 00 40 */	lfs f2, 0x40(r1)
/* 808132B0  4B A5 43 C5 */	bl cM_atan2s__Fff
...
/* 808132C8  4B A5 D2 79 */	bl cLib_addCalcAngleS__FPsssss
/* 808132CC  C0 21 00 3C */	lfs f1, 0x3c(r1)
/* 808132D0  C0 41 00 40 */	lfs f2, 0x40(r1)
/* 808132D4  4B A5 43 A1 */	bl cM_atan2s__Fff
...
/* 808132EC  4B A5 D2 55 */	bl cLib_addCalcAngleS__FPsssss
/* 808132F0  3C 60 80 81 */	lis r3, __vt__8cM3dGPla@ha /* 0x80815D04@ha */
/* 808132F4  38 03 5D 04 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x80815D04@l */
...
/* 80813318  4B 80 73 B5 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 8081332C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80813330  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80813334  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80813338  4B 86 37 75 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 8081333C  48 00 00 88 */	b lbl_808133C4
lbl_80813340:
/* 80813340  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813344  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813348  A8 9E 06 68 */	lha r4, 0x668(r30)
/* 8081334C  4B 7F 8F F9 */	bl mDoMtx_XrotS__FPA4_fs
/* 80813350  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813354  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813358  A8 9E 06 6C */	lha r4, 0x66c(r30)
/* 8081335C  4B 7F 91 71 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80813360  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80813364  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813368  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 8081336C  4B 7F 90 C9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80813370  C0 3E 05 2C */	lfs f1, 0x52c(r30)
/* 80813374  3C 60 80 81 */	lis r3, lit_3926@ha /* 0x80815998@ha */
/* 80813378  C0 03 59 98 */	lfs f0, lit_3926@l(r3)  /* 0x80815998@l */
/* 8081337C  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80813380  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 80813384  D0 21 00 38 */	stfs f1, 0x38(r1)
/* 80813388  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8081338C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80813390  38 81 00 30 */	addi r4, r1, 0x30
/* 80813394  38 A1 00 24 */	addi r5, r1, 0x24
/* 80813398  4B B3 39 D5 */	bl PSMTXMultVec
...
/* 808133C0  4B B3 3C D1 */	bl PSVECAdd
lbl_808133C4:
/* 808133C4  C0 3E 06 D4 */	lfs f1, 0x6d4(r30)
/* 808133C8  3C 60 80 81 */	lis r3, lit_3926@ha /* 0x80815998@ha */
/* 808133CC  C0 03 59 98 */	lfs f0, lit_3926@l(r3)  /* 0x80815998@l */
...
/* 80813458  4B 86 48 11 */	bl __ct__11dBgS_LinChkFv
/* 8081345C  38 61 00 50 */	addi r3, r1, 0x50
/* 80813460  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80813464  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80813478  4B 86 48 ED */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8081347C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80813480  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80813484  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80813488  38 81 00 50 */	addi r4, r1, 0x50
/* 8081348C  4B 86 0F 29 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 808134AC  4B 86 48 31 */	bl __dt__11dBgS_LinChkFv
lbl_808134B0:
...
/* 808134F4  4B 81 9B 79 */	bl dComIfGp_getReverb__Fi
/* 808134F8  7C 65 1B 78 */	mr r5, r3
/* 808134FC  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 80813500  38 80 00 00 */	li r4, 0
/* 80813504  4B 7F DB AD */	bl play__16mDoExt_McaMorfSOFUlSc
/* 80813508  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 8081350C  4B 7F 9F 1D */	bl play__14mDoExt_baseAnmFv
/* 80813510  39 61 00 D0 */	addi r11, r1, 0xd0
/* 80813514  4B B4 ED 15 */	bl _restgpr_29
