...
/* 8080F93C  4B B5 28 99 */	bl _savegpr_27
/* 8080F940  7C 7D 1B 78 */	mr r29, r3
/* 8080F944  3C 60 80 81 */	lis r3, lit_3925@ha /* 0x80815994@ha */
/* 8080F948  3B C3 59 94 */	addi r30, r3, lit_3925@l /* 0x80815994@l */
...
/* 8080F9D4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8080F9D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8080FB1C  3C 60 80 81 */	lis r3, l_HIO@ha /* 0x80815D38@ha */
/* 8080FB20  3B E3 5D 38 */	addi r31, r3, l_HIO@l /* 0x80815D38@l */
...
/* 8080FB50  4B A5 6F E5 */	bl __mi__4cXyzCFRC3Vec
...
/* 8080FB74  4B A6 10 91 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 8080FB78  7C 64 1B 78 */	mr r4, r3
/* 8080FB7C  38 7D 04 E6 */	addi r3, r29, 0x4e6
/* 8080FB80  38 A0 08 00 */	li r5, 0x800
/* 8080FB84  4B A6 10 0D */	bl cLib_chaseAngleS__FPsss
...
/* 8080FBAC  4B B3 75 8D */	bl PSVECSquareMag
...
/* 8080FC1C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080FC20  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8080FC8C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080FC90  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8080FC94:
/* 8080FC94  C0 41 00 3C */	lfs f2, 0x3c(r1)
/* 8080FC98  4B A5 79 DD */	bl cM_atan2s__Fff
/* 8080FC9C  7C 65 07 34 */	extsh r5, r3
/* 8080FCA0  38 7D 04 FC */	addi r3, r29, 0x4fc
/* 8080FCA4  3C 80 80 81 */	lis r4, l_HIO@ha /* 0x80815D38@ha */
/* 8080FCA8  3B 84 5D 38 */	addi r28, r4, l_HIO@l /* 0x80815D38@l */
/* 8080FCAC  C0 3C 00 18 */	lfs f1, 0x18(r28)
/* 8080FCB0  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8080FCB4  38 04 9A 20 */	addi r0, r4, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8080FCCC  4B A6 0A 75 */	bl cLib_chaseF__FPfff
/* 8080FCD0  38 7D 05 2C */	addi r3, r29, 0x52c
/* 8080FCD4  C0 3C 00 18 */	lfs f1, 0x18(r28)
/* 8080FCD8  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8080FCDC  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l /* 0x80439A20@l */
/* 8080FCE0  7C 04 DC 2E */	lfsx f0, r4, r27
/* 8080FCE4  EC 21 00 32 */	fmuls f1, f1, f0
/* 8080FCE8  C0 5E 00 38 */	lfs f2, 0x38(r30)
/* 8080FCEC  4B A6 0A 55 */	bl cLib_chaseF__FPfff
/* 8080FCF0  38 7D 09 74 */	addi r3, r29, 0x974
/* 8080FCF4  4B 87 45 CD */	bl ChkAtHit__12dCcD_GObjInfFv
/* 8080FCF8  28 03 00 00 */	cmplwi r3, 0
/* 8080FCFC  41 82 00 64 */	beq lbl_8080FD60
/* 8080FD00  38 7D 09 74 */	addi r3, r29, 0x974
/* 8080FD04  4B 87 46 55 */	bl GetAtHitObj__12dCcD_GObjInfFv
/* 8080FD08  4B A5 3D 41 */	bl GetAc__8cCcD_ObjFv
...
/* 8080FD4C  4B A6 0E B9 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8080FD64  4B B3 73 D5 */	bl PSVECSquareMag
...
/* 8080FDD4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080FDD8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8080FE44  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080FE48  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8080FE4C:
...
/* 8080FEC0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8080FEC4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8080FF8C  4B A5 79 C9 */	bl cM_rndF__Ff
...
/* 80810030  4B A5 76 45 */	bl cM_atan2s__Fff
