...
/* 8080A594  4B B5 7C 49 */	bl _savegpr_29
/* 8080A598  7C 7D 1B 78 */	mr r29, r3
/* 8080A59C  3C 60 80 81 */	lis r3, lit_3925@ha /* 0x80815994@ha */
/* 8080A5A0  3B E3 59 94 */	addi r31, r3, lit_3925@l /* 0x80815994@l */
...
/* 8080A614  4B A6 61 2D */	bl cLib_chaseF__FPfff
lbl_8080A618:
...
/* 8080A678  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8080A67C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8080A698  4B 86 CA 7D */	bl SetGroundUpY__9dBgS_AcchFf
lbl_8080A69C:
/* 8080A69C  C0 3F 00 90 */	lfs f1, 0x90(r31)
/* 8080A6A0  4B A5 D2 ED */	bl cM_rndFX__Ff
...
/* 8080A6BC  4B A6 67 69 */	bl cLib_distanceAngleS__Fss
...
/* 8080A6E4  4B A5 C4 51 */	bl __mi__4cXyzCFRC3Vec
...
/* 8080A70C  4B B3 CA 2D */	bl PSVECSquareMag
...
/* 8080A77C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080A780  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8080A7EC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080A7F0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8080A7F4:
...
/* 8080A808  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8080A80C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8080A810  A8 1D 06 6C */	lha r0, 0x66c(r29)
/* 8080A814  7C 00 00 D0 */	neg r0, r0
/* 8080A818  7C 04 07 34 */	extsh r4, r0
/* 8080A81C  4B 80 1C 59 */	bl mDoMtx_ZrotS__FPA4_fs
/* 8080A820  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8080A824  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8080A828  A8 1D 06 68 */	lha r0, 0x668(r29)
/* 8080A82C  7C 00 00 D0 */	neg r0, r0
/* 8080A830  7C 04 07 34 */	extsh r4, r0
/* 8080A834  4B 80 1B 69 */	bl mDoMtx_XrotM__FPA4_fs
/* 8080A838  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8080A83C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8080A840  38 81 00 3C */	addi r4, r1, 0x3c
/* 8080A844  38 A1 00 30 */	addi r5, r1, 0x30
/* 8080A848  4B B3 C5 25 */	bl PSMTXMultVec
...
/* 8080A870  4B A5 CE 05 */	bl cM_atan2s__Fff
...
/* 8080A8C0  4B A6 62 D1 */	bl cLib_chaseAngleS__FPsss
...
/* 8080A928  4B A5 D0 2D */	bl cM_rndF__Ff
...
/* 8080A994  4B B1 DA 99 */	bl checkPass__12J3DFrameCtrlFf
...
/* 8080A9EC  4B A5 CF 69 */	bl cM_rndF__Ff
...
/* 8080AA28  4B A5 C1 0D */	bl __mi__4cXyzCFRC3Vec
...
/* 8080AA54  4B B3 C6 E5 */	bl PSVECSquareMag
...
/* 8080AAC4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080AAC8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8080AB34  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080AB38  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8080AB3C:
...
/* 8080AB54  4B B3 C5 E5 */	bl PSVECSquareMag
...
/* 8080ABC4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080ABC8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8080AC34  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080AC38  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8080AC3C:
...
/* 8080ACA0  4B B5 75 89 */	bl _restgpr_29
