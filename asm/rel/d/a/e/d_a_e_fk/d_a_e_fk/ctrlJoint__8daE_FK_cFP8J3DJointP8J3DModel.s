...
/* 806B98D4  4B CA 89 05 */	bl _savegpr_28
...
/* 806B98F4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B98F8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B98FC  4B C8 CB B5 */	bl PSMTXCopy
...
lbl_806B9924:
/* 806B9924  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B9928  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B992C  A8 9D 05 D4 */	lha r4, 0x5d4(r29)
/* 806B9930  4B 95 2B 05 */	bl mDoMtx_YrotM__FPA4_fs
/* 806B9934  48 00 00 60 */	b lbl_806B9994
lbl_806B9938:
/* 806B9938  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B993C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B9940  3C 80 80 6C */	lis r4, lit_4008@ha /* 0x806BB794@ha */
/* 806B9944  C0 44 B7 94 */	lfs f2, lit_4008@l(r4)  /* 0x806BB794@l */
/* 806B9948  A8 1D 05 D4 */	lha r0, 0x5d4(r29)
/* 806B994C  3C 80 80 6C */	lis r4, lit_4010@ha /* 0x806BB798@ha */
/* 806B9950  C8 24 B7 98 */	lfd f1, lit_4010@l(r4)  /* 0x806BB798@l */
...
/* 806B997C  4B 95 2A B9 */	bl mDoMtx_YrotM__FPA4_fs
/* 806B9980  48 00 00 14 */	b lbl_806B9994
lbl_806B9984:
/* 806B9984  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B9988  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B998C  A8 9D 05 D8 */	lha r4, 0x5d8(r29)
/* 806B9990  4B 95 2A 0D */	bl mDoMtx_XrotM__FPA4_fs
lbl_806B9994:
/* 806B9994  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B9998  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B999C  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 806B99A0  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806B99A4  7C 80 FA 14 */	add r4, r0, r31
/* 806B99A8  4B C8 CB 09 */	bl PSMTXCopy
/* 806B99AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B99B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B99B4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 806B99B8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 806B99BC  4B C8 CA F5 */	bl PSMTXCopy
/* 806B99C0  38 60 00 01 */	li r3, 1
/* 806B99C4  39 61 00 30 */	addi r11, r1, 0x30
/* 806B99C8  4B CA 88 5D */	bl _restgpr_28
