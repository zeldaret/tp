...
/* 806BAD0C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806BAD10  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806BAD14  38 80 00 07 */	li r4, 7
/* 806BAD18  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 806BAD1C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 806BAD20  4B AE 8A A5 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806BAD24  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806BAD28  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806BAD2C  80 9F 00 04 */	lwz r4, 4(r31)
/* 806BAD30  38 BE 01 0C */	addi r5, r30, 0x10c
/* 806BAD34  4B AE A0 6D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806BAD5C  3C 80 80 6C */	lis r4, lit_4618@ha /* 0x806BB7F8@ha */
/* 806BAD60  C0 24 B7 F8 */	lfs f1, lit_4618@l(r4)  /* 0x806BB7F8@l */
/* 806BAD64  C0 1E 06 04 */	lfs f0, 0x604(r30)
/* 806BAD68  EC 21 00 32 */	fmuls f1, f1, f0
/* 806BAD6C  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806BB91C@ha */
/* 806BAD70  38 84 B9 1C */	addi r4, r4, l_HIO@l /* 0x806BB91C@l */
...
/* 806BAD94  4B 95 3A 2D */	bl entryDL__21mDoExt_invisibleModelFP4cXyz
