...
/* 806B97B4  4B CA 8A 25 */	bl _savegpr_28
/* 806B97B8  7C 7C 1B 78 */	mr r28, r3
/* 806B97BC  3C 60 80 6C */	lis r3, lit_3826@ha /* 0x806BB6D0@ha */
/* 806B97C0  3B C3 B6 D0 */	addi r30, r3, lit_3826@l /* 0x806BB6D0@l */
...
/* 806B97F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B97FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B9800  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 806B9804  4B 95 2B D9 */	bl mDoMtx_YrotS__FPA4_fs
/* 806B9808  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B980C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B9810  38 81 00 14 */	addi r4, r1, 0x14
/* 806B9814  7C 85 23 78 */	mr r5, r4
/* 806B9818  4B C8 D5 55 */	bl PSMTXMultVec
/* 806B981C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B9820  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B9824  38 81 00 08 */	addi r4, r1, 8
/* 806B9828  7C 85 23 78 */	mr r5, r4
/* 806B982C  4B C8 D5 41 */	bl PSMTXMultVec
/* 806B9830  38 61 00 14 */	addi r3, r1, 0x14
/* 806B9834  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 806B9838  7C 65 1B 78 */	mr r5, r3
/* 806B983C  4B C8 D8 55 */	bl PSVECAdd
/* 806B9840  38 7C 09 AC */	addi r3, r28, 0x9ac
/* 806B9844  38 81 00 14 */	addi r4, r1, 0x14
/* 806B9848  4B BB 5E 01 */	bl SetC__8cM3dGSphFRC4cXyz
/* 806B984C  38 7C 09 AC */	addi r3, r28, 0x9ac
/* 806B9850  C0 3E 00 C0 */	lfs f1, 0xc0(r30)
/* 806B9854  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806BB91C@ha */
/* 806B9858  3B E4 B9 1C */	addi r31, r4, l_HIO@l /* 0x806BB91C@l */
/* 806B985C  C0 1F 00 08 */	lfs f0, 8(r31)
/* 806B9860  EC 21 00 32 */	fmuls f1, f1, f0
/* 806B9864  4B BB 5E A5 */	bl SetR__8cM3dGSphFf
/* 806B9868  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B986C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B9870  3B A3 23 3C */	addi r29, r3, 0x233c
/* 806B9874  7F A3 EB 78 */	mr r3, r29
/* 806B9878  38 9C 08 88 */	addi r4, r28, 0x888
/* 806B987C  4B BA B3 2D */	bl Set__4cCcSFP8cCcD_Obj
/* 806B9880  38 7C 0A E4 */	addi r3, r28, 0xae4
/* 806B9884  38 81 00 08 */	addi r4, r1, 8
/* 806B9888  4B BB 5D C1 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 806B989C  4B BB 5E 6D */	bl SetR__8cM3dGSphFf
/* 806B98A0  7F A3 EB 78 */	mr r3, r29
/* 806B98A4  38 9C 09 C0 */	addi r4, r28, 0x9c0
/* 806B98A8  4B BA B3 01 */	bl Set__4cCcSFP8cCcD_Obj
/* 806B98AC  39 61 00 30 */	addi r11, r1, 0x30
/* 806B98B0  4B CA 89 75 */	bl _restgpr_28
