...
/* 80824BDC  4B B3 D5 F9 */	bl _savegpr_27
/* 80824BE0  7C 7C 1B 78 */	mr r28, r3
/* 80824BE4  3C 60 80 83 */	lis r3, lit_3902@ha /* 0x80828850@ha */
/* 80824BE8  3B E3 88 50 */	addi r31, r3, lit_3902@l /* 0x80828850@l */
/* 80824BEC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80824BF0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80824C90  4B A4 2C C5 */	bl cM_rndF__Ff
...
/* 80824CB4  4B A4 2C A1 */	bl cM_rndF__Ff
...
/* 80824CF8  4B A4 2C 5D */	bl cM_rndF__Ff
...
/* 80824D24  4B A4 2C 31 */	bl cM_rndF__Ff
...
/* 80824D74  4B A4 2B E1 */	bl cM_rndF__Ff
...
/* 80824DA0  4B A4 B8 69 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80824DD4  4B A4 2B 81 */	bl cM_rndF__Ff
...
/* 80824DFC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80824E00  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 80824E04  7F C3 04 2E */	lfsx f30, r3, r0
/* 80824E08  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80824E0C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80824E10  80 63 00 00 */	lwz r3, 0(r3)
/* 80824E14  A8 9C 06 C4 */	lha r4, 0x6c4(r28)
/* 80824E18  4B 7E 75 C5 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80824E88  4B A4 1C AD */	bl __mi__4cXyzCFRC3Vec
...
/* 80824EA8  4B B2 22 91 */	bl PSVECSquareMag
...
/* 80824F18  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80824F1C  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80824F88  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80824F8C  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80824FA8  4B A4 29 AD */	bl cM_rndF__Ff
...
/* 80825030  4B A4 29 25 */	bl cM_rndF__Ff
...
/* 80825054  4B A4 29 01 */	bl cM_rndF__Ff
...
/* 80825078  4B A4 28 DD */	bl cM_rndF__Ff
...
/* 8082509C  4B A4 28 B9 */	bl cM_rndF__Ff
...
/* 808250D8  4B A4 1A 5D */	bl __mi__4cXyzCFRC3Vec
...
/* 808250F8  4B B2 20 41 */	bl PSVECSquareMag
...
/* 80825168  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8082516C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 808251D8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 808251DC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_808251E0:
...
/* 808251F8  4B A4 27 5D */	bl cM_rndF__Ff
...
/* 80825284  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80825288  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8082528C  80 63 00 00 */	lwz r3, 0(r3)
/* 80825290  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80825294  4B 7E 71 49 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 808252B4  4B A4 BC 39 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 808252D0  4B A4 A7 6D */	bl cLib_addCalc2__FPffff
...
/* 808252E4  4B A4 A7 59 */	bl cLib_addCalc2__FPffff
...
/* 80825300  4B A4 A7 3D */	bl cLib_addCalc2__FPffff
...
/* 80825314  4B A4 A3 35 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80825318  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082531C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80825320  38 63 23 3C */	addi r3, r3, 0x233c
/* 80825324  38 9C 09 68 */	addi r4, r28, 0x968
/* 80825328  4B A3 F8 81 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80825388  4B A4 25 CD */	bl cM_rndF__Ff
...
/* 808253BC  4B A4 B2 4D */	bl cLib_addCalcAngleS2__FPssss
/* 808253C0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 808253C4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 808253C8  80 63 00 00 */	lwz r3, 0(r3)
/* 808253CC  A8 9C 06 C4 */	lha r4, 0x6c4(r28)
/* 808253D0  4B 7E 70 0D */	bl mDoMtx_YrotS__FPA4_fs
...
/* 80825470  4B B3 CD B1 */	bl _restgpr_27
