...
/* 808225D0  4B B3 FC 0D */	bl _savegpr_29
/* 808225D4  7C 7E 1B 78 */	mr r30, r3
/* 808225D8  3C 60 80 83 */	lis r3, lit_3902@ha /* 0x80828850@ha */
/* 808225DC  3B E3 88 50 */	addi r31, r3, lit_3902@l /* 0x80828850@l */
...
/* 80822600  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80822604  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80822648  4B 82 A4 49 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8082264C  80 1E 05 B8 */	lwz r0, 0x5b8(r30)
/* 80822650  2C 00 00 06 */	cmpwi r0, 6
/* 80822654  40 82 00 3C */	bne lbl_80822690
/* 80822658  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8082265C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80822660  80 63 00 00 */	lwz r3, 0(r3)
/* 80822664  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80822668  4B 7E 9D 75 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 808226E4  4B 82 A3 AD */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 808226E8  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 808226EC  7C 03 07 74 */	extsb r3, r0
/* 808226F0  4B 80 A9 7D */	bl dComIfGp_getReverb__Fi
...
/* 80822704  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80822708  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80822730  4B A8 92 55 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80822754  4B 7F 96 C1 */	bl fopAcM_createItemFromEnemyID__FUcPC4cXyziiPC5csXyzPC4cXyzPfPf
/* 80822758  88 9E 06 68 */	lbz r4, 0x668(r30)
/* 8082275C  28 04 00 FF */	cmplwi r4, 0xff
/* 80822760  41 82 00 18 */	beq lbl_80822778
/* 80822764  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80822768  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8082276C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80822770  7C 05 07 74 */	extsb r5, r0
/* 80822774  4B 81 2A 8D */	bl onSwitch__10dSv_info_cFii
lbl_80822778:
/* 80822778  39 61 00 60 */	addi r11, r1, 0x60
/* 8082277C  4B B3 FA AD */	bl _restgpr_29
