...
/* 80823D54  4B B3 E4 7D */	bl _savegpr_26
/* 80823D58  7C 7A 1B 78 */	mr r26, r3
/* 80823D5C  3C 80 80 83 */	lis r4, lit_3902@ha /* 0x80828850@ha */
/* 80823D60  3B E4 88 50 */	addi r31, r4, lit_3902@l /* 0x80828850@l */
/* 80823D64  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80823D68  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80823D6C  83 C4 5D AC */	lwz r30, 0x5dac(r4)
/* 80823D70  7F C4 F3 78 */	mr r4, r30
/* 80823D74  4B 7F 6A 6D */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80823DA4  4B A4 3B B1 */	bl cM_rndF__Ff
/* 80823DA8  C0 1F 00 4C */	lfs f0, 0x4c(r31)
/* 80823DAC  EC 20 08 2A */	fadds f1, f0, f1
/* 80823DB0  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80823DB4  38 C3 8D BC */	addi r6, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80823E34  3C 60 80 83 */	lis r3, lit_4948@ha /* 0x80828A58@ha */
/* 80823E38  38 63 8A 58 */	addi r3, r3, lit_4948@l /* 0x80828A58@l */
...
/* 80823EC0  4B A4 2C 75 */	bl __mi__4cXyzCFRC3Vec
...
/* 80823EE0  4B B2 32 59 */	bl PSVECSquareMag
...
/* 80823F50  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80823F54  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80823FC0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80823FC4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80823FC8:
...
/* 80823FF4  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80823FF8  38 63 8D BC */	addi r3, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
lbl_808240CC:
/* 808240CC  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 808240D0  3B 63 8D BC */	addi r27, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 808240FC  4B A4 38 59 */	bl cM_rndF__Ff
...
lbl_80824138:
/* 80824138  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 8082413C  3B 63 8D BC */	addi r27, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80824168  4B A4 37 ED */	bl cM_rndF__Ff
...
/* 808241F8  3C C0 80 83 */	lis r6, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 808241FC  38 C6 8D BC */	addi r6, r6, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80824224  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80824228  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80824288  4B A4 B7 B5 */	bl cLib_addCalc2__FPffff
...
/* 808242AC  4B A4 B7 91 */	bl cLib_addCalc2__FPffff
...
/* 808242D0  4B A4 B7 6D */	bl cLib_addCalc2__FPffff
/* 808242D4  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 808242D8  38 63 8D BC */	addi r3, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 808242F0  4B A4 B7 4D */	bl cLib_addCalc2__FPffff
...
/* 80824318  4B A4 C2 F1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80824340  4B A4 C2 C9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80824368  4B A4 C2 A1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8082437C  4B A4 B6 C1 */	bl cLib_addCalc2__FPffff
...
/* 808243A4  4B A4 35 B1 */	bl cM_rndF__Ff
...
/* 808243D8  4B A4 35 B5 */	bl cM_rndFX__Ff
...
/* 808243F4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 808243F8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 808243FC  80 63 00 00 */	lwz r3, 0(r3)
/* 80824400  4B 7E 7F DD */	bl mDoMtx_YrotS__FPA4_fs
/* 80824404  C0 1F 00 04 */	lfs f0, 4(r31)
/* 80824408  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 8082440C  C0 3F 00 00 */	lfs f1, 0(r31)
/* 80824410  4B A4 35 45 */	bl cM_rndF__Ff
...
/* 80824424  4B A4 35 31 */	bl cM_rndF__Ff
...
/* 808244B8  4B A4 34 9D */	bl cM_rndF__Ff
/* 808244BC  C0 1F 00 4C */	lfs f0, 0x4c(r31)
/* 808244C0  EC 20 08 2A */	fadds f1, f0, f1
/* 808244C4  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 808244C8  38 C3 8D BC */	addi r6, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80824558  4B A4 33 FD */	bl cM_rndF__Ff
...
/* 80824588  4B A4 33 CD */	bl cM_rndF__Ff
...
/* 8082471C  3C C0 80 83 */	lis r6, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80824720  38 C6 8D BC */	addi r6, r6, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80824730  4B A4 32 25 */	bl cM_rndF__Ff
/* 80824734  C0 1F 00 4C */	lfs f0, 0x4c(r31)
/* 80824738  EC 20 08 2A */	fadds f1, f0, f1
/* 8082473C  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80824740  38 63 8D BC */	addi r3, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80824760  4B A4 32 2D */	bl cM_rndFX__Ff
...
/* 8082477C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80824780  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80824784  80 63 00 00 */	lwz r3, 0(r3)
/* 80824788  4B 7E 7C 55 */	bl mDoMtx_YrotS__FPA4_fs
/* 8082478C  C0 1F 00 04 */	lfs f0, 4(r31)
/* 80824790  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80824794  C0 3F 00 00 */	lfs f1, 0(r31)
/* 80824798  4B A4 31 BD */	bl cM_rndF__Ff
...
/* 808247AC  4B A4 31 A9 */	bl cM_rndF__Ff
...
/* 8082483C  4B 85 FA 85 */	bl ChkAtHit__12dCcD_GObjInfFv
...
/* 80824854  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80824858  38 C3 8D BC */	addi r6, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 8082496C  3C C0 80 83 */	lis r6, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80824970  38 C6 8D BC */	addi r6, r6, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80824994  4B A4 2F C1 */	bl cM_rndF__Ff
/* 80824998  C0 1F 00 4C */	lfs f0, 0x4c(r31)
/* 8082499C  EC 20 08 2A */	fadds f1, f0, f1
/* 808249A0  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 808249A4  38 C3 8D BC */	addi r6, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 808249FC  4B A4 B0 41 */	bl cLib_addCalc2__FPffff
lbl_80824A00:
...
/* 80824A18  4B A4 21 1D */	bl __mi__4cXyzCFRC3Vec
...
/* 80824A38  4B B2 27 01 */	bl PSVECSquareMag
...
/* 80824AAC  3C C0 80 83 */	lis r6, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80824AB0  38 C6 8D BC */	addi r6, r6, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80824B0C  4B A4 2E 49 */	bl cM_rndF__Ff
...
/* 80824B40  4B A4 AB 09 */	bl SetC__8cM3dGSphFRC4cXyz
/* 80824B44  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80824B48  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80824B4C  38 63 23 3C */	addi r3, r3, 0x233c
/* 80824B50  38 9A 09 68 */	addi r4, r26, 0x968
/* 80824B54  4B A4 00 55 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 80824BA8  4B B3 D6 75 */	bl _restgpr_26
