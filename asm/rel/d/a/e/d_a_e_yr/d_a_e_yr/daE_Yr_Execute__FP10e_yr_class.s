...
/* 80826B14  4B B3 B6 A9 */	bl _savegpr_21
/* 80826B18  7C 7E 1B 78 */	mr r30, r3
/* 80826B1C  3C 60 80 83 */	lis r3, cNullVec__6Z2Calc@ha /* 0x808289B4@ha */
/* 80826B20  3B 83 89 B4 */	addi r28, r3, cNullVec__6Z2Calc@l /* 0x808289B4@l */
/* 80826B24  3C 60 80 83 */	lis r3, lit_3902@ha /* 0x80828850@ha */
/* 80826B28  3B E3 88 50 */	addi r31, r3, lit_3902@l /* 0x80828850@l */
/* 80826B2C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80826B30  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80826BBC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80826BC0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80826BC4  38 84 FF FF */	addi r4, r4, -1
/* 80826BC8  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80826BCC  7C 05 07 74 */	extsb r5, r0
/* 80826BD0  4B 80 E7 91 */	bl isSwitch__10dSv_info_cCFii
...
/* 80826BFC  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80826C00  38 63 8D BC */	addi r3, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80826C6C  4B 80 64 01 */	bl dComIfGp_getReverb__Fi
/* 80826C70  7C 65 1B 78 */	mr r5, r3
/* 80826C74  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 80826C78  38 80 00 00 */	li r4, 0
/* 80826C7C  4B 7E A4 35 */	bl play__16mDoExt_McaMorfSOFUlSc
...
/* 80826CFC  4B B0 17 31 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80826D44  4B B0 16 E9 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80826D98  4B B0 16 95 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80826DEC  4B B0 16 41 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80826EEC  4B A9 AC 91 */	bl setLinkSearch__15Z2CreatureEnemyFb
/* 80826EF0  48 00 00 10 */	b lbl_80826F00
lbl_80826EF4:
/* 80826EF4  38 7E 05 C0 */	addi r3, r30, 0x5c0
/* 80826EF8  38 80 00 00 */	li r4, 0
/* 80826EFC  4B A9 AC 81 */	bl setLinkSearch__15Z2CreatureEnemyFb
lbl_80826F00:
...
/* 80826F10  4B A4 96 F9 */	bl cLib_addCalcAngleS2__FPssss
lbl_80826F14:
...
/* 80826F3C  4B A4 04 C9 */	bl __pl__5csXyzFR5csXyz
...
/* 80826F70  4B A4 9E ED */	bl MtxTrans__FfffUc
/* 80826F74  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80826F78  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80826F7C  80 63 00 00 */	lwz r3, 0(r3)
/* 80826F80  A8 9E 06 F8 */	lha r4, 0x6f8(r30)
/* 80826F84  4B 7E 54 19 */	bl mDoMtx_XrotM__FPA4_fs
/* 80826F88  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80826F8C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80826F90  80 63 00 00 */	lwz r3, 0(r3)
/* 80826F94  A8 9E 06 FC */	lha r4, 0x6fc(r30)
/* 80826F98  4B 7E 55 35 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80826F9C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80826FA0  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80826FA4  80 63 00 00 */	lwz r3, 0(r3)
/* 80826FA8  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80826FAC  4B 7E 54 89 */	bl mDoMtx_YrotM__FPA4_fs
/* 80826FB0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80826FB4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80826FB8  80 63 00 00 */	lwz r3, 0(r3)
/* 80826FBC  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80826FC0  4B 7E 53 DD */	bl mDoMtx_XrotM__FPA4_fs
/* 80826FC4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80826FC8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80826FCC  80 63 00 00 */	lwz r3, 0(r3)
/* 80826FD0  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 80826FD4  4B 7E 54 F9 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80826FD8  3C 60 80 83 */	lis r3, l_e_yrHIO@ha /* 0x80828DBC@ha */
/* 80826FDC  38 63 8D BC */	addi r3, r3, l_e_yrHIO@l /* 0x80828DBC@l */
...
/* 80826FF0  4B A4 9E B5 */	bl MtxScale__FfffUc
...
/* 80827014  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80827018  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8082701C  80 63 00 00 */	lwz r3, 0(r3)
/* 80827020  38 99 00 24 */	addi r4, r25, 0x24
/* 80827024  4B B1 F4 8D */	bl PSMTXCopy
/* 80827028  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 8082702C  4B 7E A1 C1 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 80827048  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8082704C  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 808270A0  4B 82 64 2D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 808270BC  4B 82 48 5D */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 808270E8  4B A5 96 F9 */	bl func_802807E0
lbl_808270EC:
...
/* 80827118  4B B0 13 15 */	bl checkPass__12J3DFrameCtrlFf
/* 8082711C  2C 03 00 00 */	cmpwi r3, 0
/* 80827120  41 82 00 54 */	beq lbl_80827174
/* 80827124  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80827128  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80827170  4B 82 59 21 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_80827174:
...
/* 80827194  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80827198  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 808271EC  4B 82 62 E1 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80827200  4B 82 47 19 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 8082722C  4B A5 95 B5 */	bl func_802807E0
lbl_80827230:
...
/* 8082725C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 80827260  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 80827264  80 84 00 00 */	lwz r4, 0(r4)
/* 80827268  4B B1 F2 49 */	bl PSMTXCopy
...
/* 80827284  4B A4 9C 69 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 808272BC  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 808272C0  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 808272C4  80 84 00 00 */	lwz r4, 0(r4)
/* 808272C8  4B B1 F1 E9 */	bl PSMTXCopy
/* 808272CC  38 61 00 6C */	addi r3, r1, 0x6c
/* 808272D0  38 9E 0E 6C */	addi r4, r30, 0xe6c
/* 808272D4  4B A4 9C 19 */	bl MtxPosition__FP4cXyzP4cXyz
/* 808272D8  80 79 00 84 */	lwz r3, 0x84(r25)
/* 808272DC  80 63 00 0C */	lwz r3, 0xc(r3)
/* 808272E0  38 63 05 10 */	addi r3, r3, 0x510
/* 808272E4  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 808272E8  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 808272EC  80 84 00 00 */	lwz r4, 0(r4)
/* 808272F0  4B B1 F1 C1 */	bl PSMTXCopy
/* 808272F4  38 61 00 6C */	addi r3, r1, 0x6c
/* 808272F8  38 9E 0E 78 */	addi r4, r30, 0xe78
/* 808272FC  4B A4 9B F1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 80827344  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 80827348  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8082734C  38 81 00 20 */	addi r4, r1, 0x20
/* 80827350  4B 7F 24 A9 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80827514  4B A4 85 29 */	bl cLib_addCalc2__FPffff
...
/* 8082753C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80827540  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80827544  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80827548  4B 84 F5 65 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 808275AC  4B A4 00 C9 */	bl cM_atan2s__Fff
...
/* 80827604  4B A4 03 51 */	bl cM_rndF__Ff
...
/* 80827618  4B A4 03 75 */	bl cM_rndFX__Ff
...
/* 8082763C  4B A4 03 19 */	bl cM_rndF__Ff
...
/* 80827694  4B A4 8F 75 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80827700  4B A4 8F 09 */	bl cLib_addCalcAngleS2__FPssss
/* 80827704  38 60 00 00 */	li r3, 0
/* 80827708  38 80 00 00 */	li r4, 0
/* 8082770C  3C A0 80 44 */	lis r5, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80827710  38 C5 9A 20 */	addi r6, r5, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80827764  4B A4 83 1D */	bl cLib_addCalc0__FPfff
...
/* 808277FC  4B A4 8E 0D */	bl cLib_addCalcAngleS2__FPssss
...
/* 80827810  4B A4 8D F9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80827820  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80827824  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80827850  4B A4 82 31 */	bl cLib_addCalc0__FPfff
...
/* 80827888  4B B3 A9 81 */	bl _restgpr_21
