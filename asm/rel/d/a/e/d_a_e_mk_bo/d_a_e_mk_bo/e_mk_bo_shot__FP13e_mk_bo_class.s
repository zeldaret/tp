...
/* 8071D094  4B C4 51 45 */	bl _savegpr_28
/* 8071D098  7C 7D 1B 78 */	mr r29, r3
/* 8071D09C  3C 60 80 72 */	lis r3, lit_3776@ha /* 0x8071F640@ha */
/* 8071D0A0  3B E3 F6 40 */	addi r31, r3, lit_3776@l /* 0x8071F640@l */
/* 8071D0A4  80 1D 04 A4 */	lwz r0, 0x4a4(r29)
/* 8071D0A8  90 01 00 10 */	stw r0, 0x10(r1)
/* 8071D0AC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 8071D0B0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8071D0B4  38 81 00 10 */	addi r4, r1, 0x10
/* 8071D0B8  4B 8F C7 41 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
lbl_8071D0D0:
/* 8071D0D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071D0D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8071D178  4B B4 99 BD */	bl __mi__4cXyzCFRC3Vec
...
/* 8071D194  4B B4 A4 E1 */	bl cM_atan2s__Fff
...
/* 8071D1D0  4B B4 A4 A5 */	bl cM_atan2s__Fff
...
/* 8071D1F4  4B B4 99 41 */	bl __mi__4cXyzCFRC3Vec
...
/* 8071D214  4B C2 9F 25 */	bl PSVECSquareMag
...
/* 8071D284  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8071D288  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8071D2F4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8071D2F8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8071D2FC:
...
/* 8071D360  4B B4 97 D5 */	bl __mi__4cXyzCFRC3Vec
...
/* 8071D37C  4B B4 A2 F9 */	bl cM_atan2s__Fff
...
/* 8071D390  4B B5 32 79 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8071D3C0  4B B4 A2 B5 */	bl cM_atan2s__Fff
...
/* 8071D3D8  4B B5 32 31 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8071D3EC  4B B5 32 1D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8071D400  4B B5 32 09 */	bl cLib_addCalcAngleS2__FPssss
/* 8071D404  38 61 00 38 */	addi r3, r1, 0x38
/* 8071D408  4B C2 9D 31 */	bl PSVECSquareMag
...
/* 8071D478  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8071D47C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8071D4E8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8071D4EC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8071D4F0:
...
/* 8071D578  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8071D57C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8071D59C  4B 92 EC 7D */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 8071D5C0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8071D5C4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8071D5C8  80 63 00 00 */	lwz r3, 0(r3)
/* 8071D5CC  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 8071D5D0  4B 8E EE 0D */	bl mDoMtx_YrotS__FPA4_fs
/* 8071D5D4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8071D5D8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8071D5DC  80 63 00 00 */	lwz r3, 0(r3)
/* 8071D5E0  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 8071D5E4  4B 8E ED B9 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 8071D640  4B 96 6D 19 */	bl GetAtHitObj__12dCcD_GObjInfFv
/* 8071D644  4B B4 64 05 */	bl GetAc__8cCcD_ObjFv
...
/* 8071D674  4B B5 23 C9 */	bl cLib_addCalc2__FPffff
/* 8071D678  7F 83 E3 78 */	mr r3, r28
lbl_8071D67C:
/* 8071D67C  39 61 00 60 */	addi r11, r1, 0x60
/* 8071D680  4B C4 4B A5 */	bl _restgpr_28
