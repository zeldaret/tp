...
/* 8073BD8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8073BD90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8073BD94  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 8073BD98  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 8073BD9C  3C 80 80 74 */	lis r4, lit_3934@ha /* 0x8073CEDC@ha */
/* 8073BDA0  C0 04 CE DC */	lfs f0, lit_3934@l(r4)  /* 0x8073CEDC@l */
/* 8073BDA4  EC 42 00 28 */	fsubs f2, f2, f0
/* 8073BDA8  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 8073BDAC  4B C0 AB 3D */	bl PSMTXTrans
/* 8073BDB0  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 8073BDB4  4B 8D 11 91 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8073BDB8  C0 3F 06 80 */	lfs f1, 0x680(r31)
/* 8073BDBC  FC 40 08 90 */	fmr f2, f1
/* 8073BDC0  FC 60 08 90 */	fmr f3, f1
/* 8073BDC4  4B 8D 10 75 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8073BDC8  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8073BDCC  80 83 00 04 */	lwz r4, 4(r3)
/* 8073BDD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8073BDD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8073BDD8  38 84 00 24 */	addi r4, r4, 0x24
/* 8073BDDC  4B C0 A6 D5 */	bl PSMTXCopy
/* 8073BDE0  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8073BDE4  4B 8D 54 09 */	bl modelCalc__16mDoExt_McaMorfSOFv
/* 8073BDE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8073BDEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8073BDF0  80 9F 05 B8 */	lwz r4, 0x5b8(r31)
/* 8073BDF4  38 84 00 24 */	addi r4, r4, 0x24
/* 8073BDF8  4B C0 A6 B9 */	bl PSMTXCopy
