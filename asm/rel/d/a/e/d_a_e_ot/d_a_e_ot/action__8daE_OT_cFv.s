...
/* 8073BBB4  3C 60 80 74 */	lis r3, lit_3910@ha /* 0x8073CEA8@ha */
/* 8073BBB8  3B C3 CE A8 */	addi r30, r3, lit_3910@l /* 0x8073CEA8@l */
/* 8073BBBC  38 60 02 00 */	li r3, 0x200
/* 8073BBC0  38 9F 06 70 */	addi r4, r31, 0x670
/* 8073BBC4  4B 8D DE 69 */	bl fopAcM_SearchByName__FsPP10fopAc_ac_c
...
lbl_8073BBE4:
/* 8073BBE4  4B 8E 65 55 */	bl fpcM_IsCreating__FUi
...
/* 8073BC04  4B 8D E0 79 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 8073BC18  3C 60 80 74 */	lis r3, struct_8073D2DC+0x1@ha /* 0x8073D2DD@ha */
/* 8073BC1C  38 83 D2 DD */	addi r4, r3, struct_8073D2DC+0x1@l /* 0x8073D2DD@l */
...
/* 8073BC30  3C 60 80 74 */	lis r3, struct_8073D2DC+0x0@ha /* 0x8073D2DC@ha */
/* 8073BC34  98 03 D2 DC */	stb r0, struct_8073D2DC+0x0@l(r3)  /* 0x8073D2DC@l */
...
/* 8073BC48  3C 60 80 74 */	lis r3, struct_8073D2DC+0x1@ha /* 0x8073D2DD@ha */
/* 8073BC4C  98 03 D2 DD */	stb r0, struct_8073D2DC+0x1@l(r3)  /* 0x8073D2DD@l */
lbl_8073BC50:
...
/* 8073BCC8  4B 8D EA 05 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 8073BD18  4B 8E 13 F5 */	bl fopAcM_effHamonSet__FPUlPC4cXyzff
lbl_8073BD1C:
/* 8073BD1C  38 7F 06 D8 */	addi r3, r31, 0x6d8
/* 8073BD20  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073BD24  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8073BD28  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8073BD2C  4B 93 AD 81 */	bl CrrPos__9dBgS_AcchFR4dBgS
/* 8073BD30  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8073BD34  7C 03 07 74 */	extsb r3, r0
/* 8073BD38  4B 8F 13 35 */	bl dComIfGp_getReverb__Fi
/* 8073BD3C  7C 65 1B 78 */	mr r5, r3
/* 8073BD40  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8073BD44  38 80 00 00 */	li r4, 0
/* 8073BD48  4B 8D 53 69 */	bl play__16mDoExt_McaMorfSOFUlSc
...
/* 8073BD5C  4B 8D 16 CD */	bl play__14mDoExt_baseAnmFv
lbl_8073BD60:
