...
/* 8073CA54  4B C2 57 61 */	bl _savegpr_19
/* 8073CA58  7C 7E 1B 78 */	mr r30, r3
/* 8073CA5C  7C 9A 23 78 */	mr r26, r4
/* 8073CA60  7C BB 2B 78 */	mr r27, r5
/* 8073CA64  7C DC 33 78 */	mr r28, r6
/* 8073CA68  3C 60 80 74 */	lis r3, cNullVec__6Z2Calc@ha /* 0x8073CF74@ha */
/* 8073CA6C  3A E3 CF 74 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x8073CF74@l */
/* 8073CA70  3C 60 80 74 */	lis r3, lit_3910@ha /* 0x8073CEA8@ha */
/* 8073CA74  3B E3 CE A8 */	addi r31, r3, lit_3910@l /* 0x8073CEA8@l */
/* 8073CA78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073CA7C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8073CA80  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 8073CA84  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8073CA88  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 8073CAB0  4B A6 FA CD */	bl dKy_darkworld_check__Fv
...
/* 8073CAD4  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8073CAD8  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 8073CAF0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8073CAF4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8073CAF8  4B C0 99 B9 */	bl PSMTXCopy
...
/* 8073CB10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8073CB14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8073CB18  38 81 00 4C */	addi r4, r1, 0x4c
/* 8073CB1C  38 A1 00 58 */	addi r5, r1, 0x58
/* 8073CB20  4B C0 A2 4D */	bl PSMTXMultVec
/* 8073CB24  38 61 00 34 */	addi r3, r1, 0x34
/* 8073CB28  38 81 00 58 */	addi r4, r1, 0x58
/* 8073CB2C  7F 65 DB 78 */	mr r5, r27
/* 8073CB30  4B B2 A0 05 */	bl __mi__4cXyzCFRC3Vec
...
/* 8073CB4C  4B B2 AB 29 */	bl cM_atan2s__Fff
...
/* 8073CB80  4B B2 AA F5 */	bl cM_atan2s__Fff
...
/* 8073CB9C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073CBA0  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8073CBF0  4B 90 FE A1 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8073CBF4  7C 79 1B 79 */	or. r25, r3, r3
/* 8073CBF8  41 82 00 FC */	beq lbl_8073CCF4
/* 8073CBFC  38 61 00 40 */	addi r3, r1, 0x40
/* 8073CC00  4B C0 A5 39 */	bl PSVECSquareMag
...
/* 8073CC70  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8073CC74  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8073CCE0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8073CCE4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8073CCE8:
...
/* 8073CD38  4B 90 FD 59 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8073CD74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8073CD78  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8073CDE4  4B 91 06 E9 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8073CE44  4B C2 53 BD */	bl _restgpr_19
