...
/* 806BC830  4B CA 59 95 */	bl _savegpr_23
/* 806BC834  7C 7D 1B 78 */	mr r29, r3
/* 806BC838  3C 60 80 6C */	lis r3, lit_1109@ha /* 0x806BE760@ha */
/* 806BC83C  3B C3 E7 60 */	addi r30, r3, lit_1109@l /* 0x806BE760@l */
/* 806BC840  3C 60 80 6C */	lis r3, lit_3917@ha /* 0x806BE48C@ha */
/* 806BC844  3B E3 E4 8C */	addi r31, r3, lit_3917@l /* 0x806BE48C@l */
...
/* 806BC870  4B BA B0 E5 */	bl cM_rndF__Ff
...
/* 806BC8BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BC8C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806BC8E0  4B BA B0 75 */	bl cM_rndF__Ff
...
/* 806BC904  4B BA B0 89 */	bl cM_rndFX__Ff
...
/* 806BC928  4B C6 BB 05 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806BC948  4B C6 BA E5 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806BC968  4B 9B AC 15 */	bl __ct__11dBgS_GndChkFv
/* 806BC96C  38 61 00 40 */	addi r3, r1, 0x40
/* 806BC970  4B 9B AE 41 */	bl __ct__18dBgS_ObjGndChk_SplFv
...
/* 806BC9A0  4B BA B3 89 */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 806BC9A4  38 61 00 40 */	addi r3, r1, 0x40
/* 806BC9A8  38 81 00 34 */	addi r4, r1, 0x34
/* 806BC9AC  4B BA B3 7D */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 806BC9B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BC9B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806BC9B8  3B 23 0F 38 */	addi r25, r3, 0xf38
/* 806BC9BC  7F 23 CB 78 */	mr r3, r25
/* 806BC9C0  38 81 00 94 */	addi r4, r1, 0x94
/* 806BC9C4  4B 9B 7A DD */	bl GroundCross__4cBgSFP11cBgS_GndChk
/* 806BC9C8  FF E0 08 90 */	fmr f31, f1
/* 806BC9CC  7F 23 CB 78 */	mr r3, r25
/* 806BC9D0  38 81 00 40 */	addi r4, r1, 0x40
/* 806BC9D4  4B 9B 7A CD */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 806BCA08  3C 80 80 6C */	lis r4, __dt__4cXyzFv@ha /* 0x806BE43C@ha */
/* 806BCA0C  38 84 E4 3C */	addi r4, r4, __dt__4cXyzFv@l /* 0x806BE43C@l */
...
/* 806BCA2C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BCA30  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806BCA34  3C 60 80 6C */	lis r3, w_eff_id@ha /* 0x806BE5B8@ha */
/* 806BCA38  3B 43 E5 B8 */	addi r26, r3, w_eff_id@l /* 0x806BE5B8@l */
lbl_806BCA3C:
...
/* 806BCA88  4B 99 0A 45 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806BCAF0  4B 96 05 31 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 806BCB28  4B 9B AD 21 */	bl __dt__18dBgS_ObjGndChk_SplFv
/* 806BCB2C  38 61 00 94 */	addi r3, r1, 0x94
/* 806BCB30  38 80 FF FF */	li r4, -1
/* 806BCB34  4B 9B AA BD */	bl __dt__11dBgS_GndChkFv
lbl_806BCB38:
...
/* 806BCB80  3C 60 80 6C */	lis r3, d_a_e_fs__stringBase0@ha /* 0x806BE564@ha */
/* 806BCB84  38 63 E5 64 */	addi r3, r3, d_a_e_fs__stringBase0@l /* 0x806BE564@l */
/* 806BCB88  38 63 00 05 */	addi r3, r3, 5
/* 806BCB8C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BCB90  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806BCB94  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 806BCB98  4B CA BD FD */	bl strcmp
/* 806BCB9C  2C 03 00 00 */	cmpwi r3, 0
/* 806BCBA0  40 82 00 30 */	bne lbl_806BCBD0
/* 806BCBA4  38 60 00 00 */	li r3, 0
/* 806BCBA8  4B 96 FD D5 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 806BCBC8  4B 95 FF 11 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
...
/* 806BCBE4  4B 95 FE F5 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
lbl_806BCBE8:
/* 806BCBE8  7F A3 EB 78 */	mr r3, r29
/* 806BCBEC  4B 95 D0 91 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_806BCBF0:
/* 806BCBF0  38 7D 05 2C */	addi r3, r29, 0x52c
/* 806BCBF4  C0 3F 00 08 */	lfs f1, 8(r31)
/* 806BCBF8  C0 5F 00 5C */	lfs f2, 0x5c(r31)
/* 806BCBFC  4B BB 2E 85 */	bl cLib_addCalc0__FPfff
...
/* 806BCC1C  4B CA 55 F5 */	bl _restgpr_23
