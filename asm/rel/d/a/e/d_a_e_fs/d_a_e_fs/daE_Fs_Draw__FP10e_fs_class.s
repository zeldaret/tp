...
/* 806BBBCC  4B CA 66 05 */	bl _savegpr_26
/* 806BBBD0  7C 7F 1B 78 */	mr r31, r3
/* 806BBBD4  3C 60 80 6C */	lis r3, lit_3917@ha /* 0x806BE48C@ha */
/* 806BBBD8  3B A3 E4 8C */	addi r29, r3, lit_3917@l /* 0x806BE48C@l */
/* 806BBBDC  80 7F 05 D0 */	lwz r3, 0x5d0(r31)
/* 806BBBE0  83 83 00 04 */	lwz r28, 4(r3)
/* 806BBBE4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806BBBE8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806BBBEC  38 80 00 00 */	li r4, 0
/* 806BBBF0  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 806BBBF4  38 DF 01 0C */	addi r6, r31, 0x10c
/* 806BBBF8  4B AE 7B CD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806BBBFC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806BBC00  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806BBC04  80 9C 00 04 */	lwz r4, 4(r28)
/* 806BBC08  38 BF 01 0C */	addi r5, r31, 0x10c
/* 806BBC0C  4B AE 91 95 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806BBC60  4B 95 55 61 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 806BBCB0  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806BBCB4  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806BBCB8  4B 97 2C 59 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806BBCBC  90 7F 06 84 */	stw r3, 0x684(r31)
/* 806BBCC0  38 60 00 01 */	li r3, 1
/* 806BBCC4  39 61 00 30 */	addi r11, r1, 0x30
/* 806BBCC8  4B CA 65 55 */	bl _restgpr_26
