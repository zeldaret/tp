...
/* 806BBD08  4B 9B BF 61 */	bl __ct__11dBgS_LinChkFv
...
/* 806BBD24  3C 60 80 6C */	lis r3, lit_3917@ha /* 0x806BE48C@ha */
/* 806BBD28  C0 03 E4 8C */	lfs f0, lit_3917@l(r3)  /* 0x806BE48C@l */
/* 806BBD2C  EC 01 00 2A */	fadds f0, f1, f0
/* 806BBD30  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 806BBD34  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806BBD38  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806BBD3C  80 63 00 00 */	lwz r3, 0(r3)
/* 806BBD40  7F C4 F3 78 */	mr r4, r30
/* 806BBD44  4B 95 06 99 */	bl mDoMtx_YrotS__FPA4_fs
/* 806BBD48  3C 60 80 6C */	lis r3, lit_3918@ha /* 0x806BE490@ha */
/* 806BBD4C  C0 03 E4 90 */	lfs f0, lit_3918@l(r3)  /* 0x806BE490@l */
/* 806BBD50  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 806BBD54  3C 60 80 6C */	lis r3, lit_3917@ha /* 0x806BE48C@ha */
/* 806BBD58  C0 03 E4 8C */	lfs f0, lit_3917@l(r3)  /* 0x806BE48C@l */
...
/* 806BBD90  4B 9B BF D5 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806BBD94  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806BBD98  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806BBD9C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806BBDA0  38 81 00 2C */	addi r4, r1, 0x2c
/* 806BBDA4  4B 9B 86 11 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 806BBDB8  4B 9B BF 25 */	bl __dt__11dBgS_LinChkFv
...
/* 806BBDCC  4B 9B BF 11 */	bl __dt__11dBgS_LinChkFv
