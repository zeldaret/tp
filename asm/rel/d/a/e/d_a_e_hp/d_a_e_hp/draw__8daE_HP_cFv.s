...
/* 806E6028  4B C7 C1 A1 */	bl _savegpr_24
/* 806E602C  7C 7F 1B 78 */	mr r31, r3
/* 806E6030  3C 60 80 6F */	lis r3, lit_3905@ha /* 0x806EA1F4@ha */
/* 806E6034  3B C3 A1 F4 */	addi r30, r3, lit_3905@l /* 0x806EA1F4@l */
/* 806E6038  88 9F 07 7C */	lbz r4, 0x77c(r31)
/* 806E603C  28 04 00 FF */	cmplwi r4, 0xff
/* 806E6040  41 82 00 28 */	beq lbl_806E6068
/* 806E6044  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E6048  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E604C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 806E6050  7C 05 07 74 */	extsb r5, r0
/* 806E6054  4B 94 F3 0D */	bl isSwitch__10dSv_info_cCFii
...
/* 806E6074  4B AB 9A 45 */	bl dKy_daynight_check__Fv
...
/* 806E60B8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806E60BC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806E60C0  38 80 00 00 */	li r4, 0
/* 806E60C4  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 806E60C8  38 DF 01 0C */	addi r6, r31, 0x10c
/* 806E60CC  4B AB D6 F9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806E60D0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806E60D4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806E60D8  80 99 00 04 */	lwz r4, 4(r25)
/* 806E60DC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 806E60E0  4B AB EC C1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806E6160  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E6164  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E6168  88 04 4F AD */	lbz r0, 0x4fad(r4)
/* 806E616C  28 00 00 00 */	cmplwi r0, 0
/* 806E6170  41 82 00 1C */	beq lbl_806E618C
/* 806E6174  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 806E6178  83 23 10 18 */	lwz r25, m_midnaActor__9daPy_py_c@l(r3)  /* 0x80451018@l */
/* 806E617C  80 64 5D B4 */	lwz r3, 0x5db4(r4)
/* 806E6180  4B 93 59 95 */	bl fopAcM_getTalkEventPartner__FPC10fopAc_ac_c
...
/* 806E6194  4B 92 86 2D */	bl entryDL__21mDoExt_invisibleModelFP4cXyz
/* 806E6198  48 00 00 0C */	b lbl_806E61A4
lbl_806E619C:
/* 806E619C  C0 1E 00 04 */	lfs f0, 4(r30)
/* 806E61A0  D0 1F 07 90 */	stfs f0, 0x790(r31)
lbl_806E61A4:
/* 806E61A4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806E61A8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806E61AC  80 9F 05 C0 */	lwz r4, 0x5c0(r31)
/* 806E61B0  80 84 00 04 */	lwz r4, 4(r4)
/* 806E61B4  38 BF 01 0C */	addi r5, r31, 0x10c
/* 806E61B8  4B AB EB E9 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806E61BC  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 806E61C0  4B 92 7B 05 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 806E6210  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806E6214  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806E6218  4B 94 86 F9 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 806E6230  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E6234  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E6238  4B C6 02 79 */	bl PSMTXCopy
...
/* 806E6250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E6254  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E6258  38 81 00 50 */	addi r4, r1, 0x50
/* 806E625C  38 BF 07 5C */	addi r5, r31, 0x75c
/* 806E6260  4B C6 0B 0D */	bl PSMTXMultVec
/* 806E6264  38 7F 07 5C */	addi r3, r31, 0x75c
/* 806E6268  4B 92 6A FD */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 806E626C  38 61 00 2C */	addi r3, r1, 0x2c
/* 806E6270  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E6274  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E6278  80 84 5D 74 */	lwz r4, 0x5d74(r4)
/* 806E627C  38 84 00 D8 */	addi r4, r4, 0xd8
/* 806E6280  38 BF 07 5C */	addi r5, r31, 0x75c
/* 806E6284  4B B8 08 B1 */	bl __mi__4cXyzCFRC3Vec
...
/* 806E62A4  4B B8 0E 85 */	bl atan2sX_Z__4cXyzCFv
/* 806E62A8  7C 64 1B 78 */	mr r4, r3
/* 806E62AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E62B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E62B4  4B 92 61 81 */	bl mDoMtx_YrotM__FPA4_fs
/* 806E62B8  38 61 00 50 */	addi r3, r1, 0x50
/* 806E62BC  4B B8 0E 95 */	bl atan2sY_XZ__4cXyzCFv
/* 806E62C0  7C 64 07 34 */	extsh r4, r3
/* 806E62C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E62C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E62CC  4B 92 60 D1 */	bl mDoMtx_XrotM__FPA4_fs
/* 806E62D0  3C 60 80 6F */	lis r3, l_HIO@ha /* 0x806EA4F8@ha */
/* 806E62D4  38 63 A4 F8 */	addi r3, r3, l_HIO@l /* 0x806EA4F8@l */
/* 806E62D8  C0 23 00 08 */	lfs f1, 8(r3)
/* 806E62DC  FC 40 08 90 */	fmr f2, f1
/* 806E62E0  FC 60 08 90 */	fmr f3, f1
/* 806E62E4  4B 92 6B 55 */	bl scaleM__14mDoMtx_stack_cFfff
/* 806E62E8  80 7F 05 C4 */	lwz r3, 0x5c4(r31)
/* 806E62EC  80 83 00 04 */	lwz r4, 4(r3)
/* 806E62F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E62F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E62F8  38 84 00 24 */	addi r4, r4, 0x24
/* 806E62FC  4B C6 01 B5 */	bl PSMTXCopy
/* 806E6300  80 7F 05 C4 */	lwz r3, 0x5c4(r31)
/* 806E6304  4B 92 A3 A9 */	bl modelCalc__14mDoExt_McaMorfFv
...
/* 806E6318  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E631C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806E6320  4B C6 01 91 */	bl PSMTXCopy
/* 806E6324  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806E6328  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806E6350  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E6354  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E6358  3C 60 80 6F */	lis r3, particleNmaeDt@ha /* 0x806EA3E8@ha */
/* 806E635C  3B 43 A3 E8 */	addi r26, r3, particleNmaeDt@l /* 0x806EA3E8@l */
lbl_806E6360:
...
/* 806E63AC  4B 96 71 21 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806E63C0  4B 96 55 59 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806E63E4  4B B9 A3 FD */	bl func_802807E0
lbl_806E63E8:
...
/* 806E6400  4B 92 A2 81 */	bl entryDL__14mDoExt_McaMorfFv
/* 806E6404  A0 1F 05 8E */	lhz r0, 0x58e(r31)
/* 806E6408  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 806E640C  41 82 00 90 */	beq lbl_806E649C
/* 806E6410  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806E6414  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806E6418  80 63 00 00 */	lwz r3, 0(r3)
/* 806E641C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806E6420  4B 92 5F BD */	bl mDoMtx_YrotS__FPA4_fs
...
/* 806E6498  4B B8 95 A5 */	bl cLib_addCalc2__FPffff
lbl_806E649C:
/* 806E649C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E64A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806E64D4  4B 93 31 CD */	bl drawBallModel__13fopEn_enemy_cFP12dKy_tevstr_c
lbl_806E64D8:
/* 806E64D8  38 60 00 01 */	li r3, 1
lbl_806E64DC:
/* 806E64DC  39 61 00 90 */	addi r11, r1, 0x90
/* 806E64E0  4B C7 BD 35 */	bl _restgpr_24
