...
/* 806E815C  4B C7 A0 75 */	bl _savegpr_26
/* 806E8160  7C 7A 1B 78 */	mr r26, r3
/* 806E8164  3C 60 80 6F */	lis r3, lit_3905@ha /* 0x806EA1F4@ha */
/* 806E8168  3B C3 A1 F4 */	addi r30, r3, lit_3905@l /* 0x806EA1F4@l */
...
/* 806E818C  3C 80 80 6F */	lis r4, d_a_e_hp__stringBase0@ha /* 0x806EA2CC@ha */
/* 806E8190  38 84 A2 CC */	addi r4, r4, d_a_e_hp__stringBase0@l /* 0x806EA2CC@l */
/* 806E8194  38 84 00 15 */	addi r4, r4, 0x15
/* 806E8198  4B BD 99 F9 */	bl setEnemyName__15Z2CreatureEnemyFPCc
lbl_806E819C:
...
/* 806E81B0  3C 60 80 6F */	lis r3, lit_5058@ha /* 0x806EA3EC@ha */
/* 806E81B4  38 63 A3 EC */	addi r3, r3, lit_5058@l /* 0x806EA3EC@l */
...
/* 806E8224  4B 93 12 D9 */	bl checkBallModelDraw__13fopEn_enemy_cFv
...
lbl_806E82A4:
/* 806E82A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E82A8  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806E8318  4B 98 FC 45 */	bl __ct__14dBgS_ObjLinChkFv
/* 806E831C  3C 60 80 6F */	lis r3, __vt__8cM3dGPla@ha /* 0x806EA4C4@ha */
/* 806E8320  38 03 A4 C4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806EA4C4@l */
/* 806E8324  90 01 00 50 */	stw r0, 0x50(r1)
/* 806E8328  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E832C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E8330  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806E8334  38 9A 08 DC */	addi r4, r26, 0x8dc
/* 806E8338  38 A1 00 40 */	addi r5, r1, 0x40
/* 806E833C  4B 98 C4 09 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 806E8374  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806E8378  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806E83A4  4B BC 35 E1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806E83B8  4B B7 F2 BD */	bl cM_atan2s__Fff
...
/* 806E83CC  4B B7 F2 A9 */	bl cM_atan2s__Fff
/* 806E83D0  B0 7A 07 76 */	sth r3, 0x776(r26)
/* 806E83D4  3C 60 80 6F */	lis r3, __vt__8cM3dGPla@ha /* 0x806EA4C4@ha */
/* 806E83D8  38 03 A4 C4 */	addi r0, r3, __vt__8cM3dGPla@l /* 0x806EA4C4@l */
/* 806E83DC  90 01 00 50 */	stw r0, 0x50(r1)
/* 806E83E0  38 61 00 54 */	addi r3, r1, 0x54
/* 806E83E4  38 80 FF FF */	li r4, -1
/* 806E83E8  4B 98 FB D1 */	bl __dt__14dBgS_ObjLinChkFv
...
/* 806E8418  4B B8 76 25 */	bl cLib_addCalc2__FPffff
...
/* 806E8430  4B B8 76 0D */	bl cLib_addCalc2__FPffff
...
/* 806E8460  4B B8 75 DD */	bl cLib_addCalc2__FPffff
lbl_806E8464:
...
/* 806E8494  4B 93 22 39 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 806E84B0  4B 98 DA A9 */	bl SetWall__12dBgS_AcchCirFff
...
/* 806E84EC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806E84F0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806E8528  4B 98 EB ED */	bl SetGroundUpY__9dBgS_AcchFf
/* 806E852C  38 7A 07 EC */	addi r3, r26, 0x7ec
/* 806E8530  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806E8534  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806E8538  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806E853C  4B 98 E5 71 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 806E8598  4B B8 80 71 */	bl cLib_addCalcAngleS2__FPssss
lbl_806E859C:
/* 806E859C  4B A7 6E 89 */	bl checkNowWolfEyeUp__9daPy_py_cFv
...
/* 806E85CC  4B B7 E5 69 */	bl __mi__4cXyzCFRC3Vec
...
/* 806E85EC  4B C5 EB 4D */	bl PSVECSquareMag
...
/* 806E865C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E8660  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806E86CC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E86D0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806E86D4:
...
/* 806E871C  4B B8 73 21 */	bl cLib_addCalc2__FPffff
...
/* 806E873C  4B B7 E3 F9 */	bl __mi__4cXyzCFRC3Vec
...
/* 806E8768  4B C5 E9 D1 */	bl PSVECSquareMag
...
/* 806E87D8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E87DC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806E8848  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806E884C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806E8850:
...
/* 806E8864  4B 93 1E AD */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806E8868  A8 1A 04 DE */	lha r0, 0x4de(r26)
/* 806E886C  7C 03 00 50 */	subf r0, r3, r0
/* 806E8870  7C 03 07 34 */	extsh r3, r0
/* 806E8874  4B C7 C8 5D */	bl abs
...
/* 806E88B0  4B 93 1E 61 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806E893C  4B 92 7C 8D */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 806E8940  7F 43 D3 78 */	mr r3, r26
/* 806E8944  38 9A 01 0C */	addi r4, r26, 0x10c
/* 806E8948  4B 93 0B D9 */	bl setBallModelEffect__13fopEn_enemy_cFP12dKy_tevstr_c
...
/* 806E895C  4B BD 92 21 */	bl setLinkSearch__15Z2CreatureEnemyFb
/* 806E8960  39 61 00 F0 */	addi r11, r1, 0xf0
/* 806E8964  4B C7 98 B9 */	bl _restgpr_26
