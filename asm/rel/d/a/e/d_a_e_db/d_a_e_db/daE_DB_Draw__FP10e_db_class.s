...
/* 8069ACC8  4B CC 75 05 */	bl _savegpr_25
/* 8069ACCC  7C 7D 1B 78 */	mr r29, r3
/* 8069ACD0  3C 60 80 6A */	lis r3, lit_3902@ha /* 0x806A190C@ha */
/* 8069ACD4  3B E3 19 0C */	addi r31, r3, lit_3902@l /* 0x806A190C@l */
/* 8069ACD8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8069ACDC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8069ACE0  38 80 00 00 */	li r4, 0
/* 8069ACE4  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 8069ACE8  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8069ACEC  4B B0 8A D9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8069ACF0  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 8069ACF4  83 83 00 04 */	lwz r28, 4(r3)
/* 8069ACF8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8069ACFC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8069AD00  80 9C 00 04 */	lwz r4, 4(r28)
/* 8069AD04  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8069AD08  4B B0 A0 99 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8069ADCC  4B 97 63 F5 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 8069AE14  3C E0 80 45 */	lis r7, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 8069AE18  C0 87 0C D0 */	lfs f4, mGroundY__11fopAcM_gc_c@l(r7)  /* 0x80450CD0@l */
/* 8069AE1C  3C E0 80 3F */	lis r7, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 8069AE20  38 E7 1C C4 */	addi r7, r7, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
...
/* 8069AE34  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 8069AE38  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 8069AE3C  4B 99 3A D5 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 8069AE40  90 7D 06 64 */	stw r3, 0x664(r29)
lbl_8069AE44:
/* 8069AE44  38 7D 08 04 */	addi r3, r29, 0x804
/* 8069AE48  38 80 00 0C */	li r4, 0xc
/* 8069AE4C  3C A0 80 6A */	lis r5, l_color@ha /* 0x806A1AAC@ha */
/* 8069AE50  38 A5 1A AC */	addi r5, r5, l_color@l /* 0x806A1AAC@l */
/* 8069AE54  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8069AE58  4B 97 91 59 */	bl update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 8069AE74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069AE78  38 03 61 C0 */	addi r0, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8069AE90  4B 97 98 A9 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
...
/* 8069AEAC  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8069AEB0  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8069AEB4  80 84 00 04 */	lwz r4, 4(r4)
/* 8069AEB8  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8069AEBC  4B B0 9E E5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8069AF84  4B 97 2D 41 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8069AF88:
...
/* 8069AFA0  4B CC 72 79 */	bl _restgpr_25
