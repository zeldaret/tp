...
/* 806A1160  4B 9E 28 C9 */	bl __ct__12dCcD_GObjInfFv
/* 806A1164  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 806A1168  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 806A116C  90 1F 01 20 */	stw r0, 0x120(r31)
/* 806A1170  3C 60 80 6A */	lis r3, __vt__8cM3dGAab@ha /* 0x806A1D64@ha */
/* 806A1174  38 03 1D 64 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x806A1D64@l */
/* 806A1178  90 1F 01 1C */	stw r0, 0x11c(r31)
/* 806A117C  3C 60 80 6A */	lis r3, __vt__8cM3dGSph@ha /* 0x806A1D58@ha */
/* 806A1180  38 03 1D 58 */	addi r0, r3, __vt__8cM3dGSph@l /* 0x806A1D58@l */
/* 806A1184  90 1F 01 34 */	stw r0, 0x134(r31)
/* 806A1188  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 806A118C  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 806A1190  90 7F 01 20 */	stw r3, 0x120(r31)
/* 806A1194  38 03 00 58 */	addi r0, r3, 0x58
/* 806A1198  90 1F 01 34 */	stw r0, 0x134(r31)
/* 806A119C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 806A11A0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
