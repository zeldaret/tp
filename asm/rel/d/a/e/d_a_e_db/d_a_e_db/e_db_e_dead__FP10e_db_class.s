...
/* 8069F380  4B CC 2E 5D */	bl _savegpr_29
/* 8069F384  7C 7D 1B 78 */	mr r29, r3
/* 8069F388  3C 60 80 6A */	lis r3, lit_3902@ha /* 0x806A190C@ha */
/* 8069F38C  3B E3 19 0C */	addi r31, r3, lit_3902@l /* 0x806A190C@l */
/* 8069F390  38 00 00 06 */	li r0, 6
/* 8069F394  B0 1D 06 9A */	sth r0, 0x69a(r29)
/* 8069F398  38 61 00 20 */	addi r3, r1, 0x20
/* 8069F39C  4B 9D 84 15 */	bl __ct__18dBgS_ObjGndChk_SplFv
...
/* 8069F3CC  4B BC 89 5D */	bl SetPos__11cBgS_GndChkFPC4cXyz
/* 8069F3D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069F3D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8069F3D8  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 8069F3DC  7F C3 F3 78 */	mr r3, r30
/* 8069F3E0  38 81 00 20 */	addi r4, r1, 0x20
/* 8069F3E4  4B 9D 50 BD */	bl GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8069F420  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8069F424  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8069F428  80 63 00 00 */	lwz r3, 0(r3)
/* 8069F42C  A8 9D 06 80 */	lha r4, 0x680(r29)
/* 8069F430  4B 96 CF AD */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8069F454  4B BD 1A 99 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8069F4A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069F4AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8069F538  4B BC 84 1D */	bl cM_rndF__Ff
...
/* 8069F578  4B 97 DA A9 */	bl fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 8069F5D4  4B BD 10 35 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8069F5E8  4B BD 10 21 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8069F60C  4B 97 D4 CD */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
...
/* 8069F6A4  3C 60 80 6A */	lis r3, l_HIO@ha /* 0x806A1DA8@ha */
/* 8069F6A8  38 63 1D A8 */	addi r3, r3, l_HIO@l /* 0x806A1DA8@l */
...
/* 8069F6C8  4B 9D 81 81 */	bl __dt__18dBgS_ObjGndChk_SplFv
/* 8069F6CC  48 00 02 84 */	b lbl_8069F950
lbl_8069F6D0:
/* 8069F6D0  7F A3 EB 78 */	mr r3, r29
/* 8069F6D4  4B 97 A5 A9 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 8069F6D8  A0 9D 04 94 */	lhz r4, 0x494(r29)
/* 8069F6DC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069F6E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8069F6E4  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 8069F6E8  7C 05 07 74 */	extsb r5, r0
/* 8069F6EC  4B 99 5F 59 */	bl onActor__10dSv_info_cFii
...
/* 8069F700  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069F704  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8069F708  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8069F70C  7C 05 07 74 */	extsb r5, r0
/* 8069F710  4B 99 5A F1 */	bl onSwitch__10dSv_info_cFii
lbl_8069F714:
...
/* 8069F730  4B BD 0E D9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8069F768  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8069F76C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8069F780  3C 60 80 6A */	lis r3, l_HIO@ha /* 0x806A1DA8@ha */
/* 8069F784  38 63 1D A8 */	addi r3, r3, l_HIO@l /* 0x806A1DA8@l */
...
/* 8069F7C8  4B 9D 72 E5 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 8069F850  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069F854  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8069F87C  4B BC 80 D9 */	bl cM_rndF__Ff
...
/* 8069F8D0  4B 97 FF AD */	bl fopKyM_createWpillar__FPC4cXyzfi
...
/* 8069F91C  4B 97 A3 61 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 8069F930  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8069F934  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8069F938  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8069F93C  7C 05 07 74 */	extsb r5, r0
/* 8069F940  4B 99 58 C1 */	bl onSwitch__10dSv_info_cFii
lbl_8069F944:
/* 8069F944  38 61 00 20 */	addi r3, r1, 0x20
/* 8069F948  38 80 FF FF */	li r4, -1
/* 8069F94C  4B 9D 7E FD */	bl __dt__18dBgS_ObjGndChk_SplFv
lbl_8069F950:
...
/* 8069F964  4B CC 28 C5 */	bl _restgpr_29
