...
/* 8069E124  4B CC 40 A8 */	b _savegpr_25
...
/* 8069E160  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8069E164  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069E168  C0 3F 00 00 */	lfs f1, 0(r31)
/* 8069E16C  C0 5F 00 04 */	lfs f2, 4(r31)
/* 8069E170  C0 7F 00 08 */	lfs f3, 8(r31)
/* 8069E174  4B CA 87 74 */	b PSMTXTrans
/* 8069E178  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8069E17C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069E180  A8 9E 00 02 */	lha r4, 2(r30)
/* 8069E184  4B 96 E2 B0 */	b mDoMtx_YrotM__FPA4_fs
/* 8069E188  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8069E18C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069E190  A8 9E 00 00 */	lha r4, 0(r30)
/* 8069E194  4B 96 E2 08 */	b mDoMtx_XrotM__FPA4_fs
/* 8069E198  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8069E19C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069E1A0  7F 64 07 34 */	extsh r4, r27
/* 8069E1A4  4B 96 E3 28 */	b mDoMtx_ZrotM__FPA4_fs
/* 8069E1A8  C0 39 07 D4 */	lfs f1, 0x7d4(r25)
/* 8069E1AC  FC 40 08 90 */	fmr f2, f1
/* 8069E1B0  FC 60 08 90 */	fmr f3, f1
/* 8069E1B4  4B 96 EC 84 */	b scaleM__14mDoMtx_stack_cFfff
/* 8069E1B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8069E1BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069E1C0  80 99 07 74 */	lwz r4, 0x774(r25)
/* 8069E1C4  38 84 00 24 */	addi r4, r4, 0x24
/* 8069E1C8  4B CA 82 E8 */	b PSMTXCopy
lbl_8069E1CC:
...
/* 8069E1EC  4B CC 40 2C */	b _restgpr_25
