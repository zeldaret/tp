...
/* 806A0970  4B CC 18 65 */	bl _savegpr_27
/* 806A0974  7C 7F 1B 78 */	mr r31, r3
/* 806A0978  38 60 00 58 */	li r3, 0x58
/* 806A097C  4B C2 E2 D1 */	bl __nw__FUl
/* 806A0980  7C 7E 1B 79 */	or. r30, r3, r3
/* 806A0984  41 82 00 94 */	beq lbl_806A0A18
/* 806A0988  3C 60 80 6A */	lis r3, d_a_e_db__stringBase0@ha /* 0x806A1A6C@ha */
/* 806A098C  38 63 1A 6C */	addi r3, r3, d_a_e_db__stringBase0@l /* 0x806A1A6C@l */
/* 806A0990  38 80 00 12 */	li r4, 0x12
/* 806A0994  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A0998  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806A09AC  4B 99 B9 41 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806A09B0  7C 7D 1B 78 */	mr r29, r3
/* 806A09B4  3C 60 80 6A */	lis r3, d_a_e_db__stringBase0@ha /* 0x806A1A6C@ha */
/* 806A09B8  38 63 1A 6C */	addi r3, r3, d_a_e_db__stringBase0@l /* 0x806A1A6C@l */
/* 806A09BC  38 80 00 17 */	li r4, 0x17
/* 806A09C0  7F 85 E3 78 */	mr r5, r28
/* 806A09C4  38 C0 00 80 */	li r6, 0x80
/* 806A09C8  4B 99 B9 25 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806A0A00  3D 20 80 6A */	lis r9, lit_3904@ha /* 0x806A1914@ha */
/* 806A0A04  C0 29 19 14 */	lfs f1, lit_3904@l(r9)  /* 0x806A1914@l */
/* 806A0A08  39 20 00 00 */	li r9, 0
/* 806A0A0C  39 40 FF FF */	li r10, -1
/* 806A0A10  4B 96 FD C1 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
lbl_806A0A3C:
/* 806A0A3C  3C 60 80 6A */	lis r3, d_a_e_db__stringBase0@ha /* 0x806A1A6C@ha */
/* 806A0A40  38 63 1A 6C */	addi r3, r3, d_a_e_db__stringBase0@l /* 0x806A1A6C@l */
/* 806A0A44  38 80 00 1C */	li r4, 0x1c
/* 806A0A48  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A0A4C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806A0A60  4B 99 B8 8D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806A0A78  4B 97 28 E9 */	bl init__19mDoExt_3DlineMat1_cFUsUsP7ResTIMGi
...
/* 806A0A94  3C 60 80 6A */	lis r3, lit_4122@ha /* 0x806A195C@ha */
/* 806A0A98  C0 03 19 5C */	lfs f0, lit_4122@l(r3)  /* 0x806A195C@l */
...
/* 806A0AB0  3C 60 80 6A */	lis r3, d_a_e_db__stringBase0@ha /* 0x806A1A6C@ha */
/* 806A0AB4  38 63 1A 6C */	addi r3, r3, d_a_e_db__stringBase0@l /* 0x806A1A6C@l */
/* 806A0AB8  38 80 00 19 */	li r4, 0x19
/* 806A0ABC  7F 85 E3 78 */	mr r5, r28
/* 806A0AC0  38 C0 00 80 */	li r6, 0x80
/* 806A0AC4  4B 99 B8 29 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806A0AEC  4B 97 41 69 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_806A0B0C:
/* 806A0B0C  3C 60 80 6A */	lis r3, lit_3904@ha /* 0x806A1914@ha */
/* 806A0B10  C0 23 19 14 */	lfs f1, lit_3904@l(r3)  /* 0x806A1914@l */
/* 806A0B14  4B BC 6E 41 */	bl cM_rndF__Ff
/* 806A0B18  3C 60 80 6A */	lis r3, lit_3904@ha /* 0x806A1914@ha */
/* 806A0B1C  C0 03 19 14 */	lfs f0, lit_3904@l(r3)  /* 0x806A1914@l */
...
/* 806A0B40  4B CC 16 E1 */	bl _restgpr_27
