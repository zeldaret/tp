...
/* 806A053C  4B CC 1C 9D */	bl _savegpr_28
/* 806A0540  7C 7D 1B 78 */	mr r29, r3
/* 806A0544  3C 60 80 6A */	lis r3, lit_3902@ha /* 0x806A190C@ha */
/* 806A0548  3B C3 19 0C */	addi r30, r3, lit_3902@l /* 0x806A190C@l */
...
/* 806A0580  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A0584  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806A05C4  4B 9A C4 CD */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806A05C8  7F A3 EB 78 */	mr r3, r29
/* 806A05CC  4B 97 96 B1 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 806A0634  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806A0638  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806A063C  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 806A0640  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 806A0644  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 806A0648  4B CA 62 A1 */	bl PSMTXTrans
/* 806A064C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806A0650  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806A0654  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 806A0658  4B 96 BD DD */	bl mDoMtx_YrotM__FPA4_fs
/* 806A065C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806A0660  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806A0664  A8 9D 04 E4 */	lha r4, 0x4e4(r29)
/* 806A0668  4B 96 BD 35 */	bl mDoMtx_XrotM__FPA4_fs
/* 806A066C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806A0670  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806A0674  A8 9D 04 E8 */	lha r4, 0x4e8(r29)
/* 806A0678  4B 96 BE 55 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 806A0698  4B BC FF 71 */	bl cLib_addCalcAngleS2__FPssss
lbl_806A069C:
/* 806A069C  3C 60 80 6A */	lis r3, l_HIO@ha /* 0x806A1DA8@ha */
/* 806A06A0  3B E3 1D A8 */	addi r31, r3, l_HIO@l /* 0x806A1DA8@l */
...
/* 806A06B8  4B 96 C7 81 */	bl scaleM__14mDoMtx_stack_cFfff
/* 806A06BC  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806A06C0  83 83 00 04 */	lwz r28, 4(r3)
/* 806A06C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806A06C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806A06CC  38 9C 00 24 */	addi r4, r28, 0x24
/* 806A06D0  4B CA 5D E1 */	bl PSMTXCopy
/* 806A06D4  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 806A06D8  7C 03 07 74 */	extsb r3, r0
/* 806A06DC  4B 98 C9 91 */	bl dComIfGp_getReverb__Fi
/* 806A06E0  7C 65 1B 78 */	mr r5, r3
/* 806A06E4  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806A06E8  38 80 00 00 */	li r4, 0
/* 806A06EC  4B 97 09 C5 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 806A06F0  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806A06F4  4B 97 0A F9 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 806A071C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 806A0720  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 806A0724  80 84 00 00 */	lwz r4, 0(r4)
/* 806A0728  4B CA 5D 89 */	bl PSMTXCopy
...
/* 806A0794  4B BD 07 59 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 806A07D4  4B BD 07 19 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 806A07FC  4B CA 68 95 */	bl PSVECAdd
lbl_806A0800:
/* 806A0800  38 7D 09 C8 */	addi r3, r29, 0x9c8
/* 806A0804  38 81 00 50 */	addi r4, r1, 0x50
/* 806A0808  4B BC EE 41 */	bl SetC__8cM3dGSphFRC4cXyz
...
/* 806A0824  4B BC EE E5 */	bl SetR__8cM3dGSphFf
/* 806A0828  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A082C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806A0830  3B 83 23 3C */	addi r28, r3, 0x233c
/* 806A0834  7F 83 E3 78 */	mr r3, r28
/* 806A0838  38 9D 08 A4 */	addi r4, r29, 0x8a4
/* 806A083C  4B BC 43 6D */	bl Set__4cCcSFP8cCcD_Obj
...
/* 806A0854  4B 9E 42 71 */	bl MoveCAt__8dCcD_SphFR4cXyz
...
/* 806A0870  4B BC 62 75 */	bl __pl__4cXyzCFRC3Vec
/* 806A0874  38 7D 0B 00 */	addi r3, r29, 0xb00
/* 806A0878  38 81 00 20 */	addi r4, r1, 0x20
/* 806A087C  4B BC ED CD */	bl SetC__8cM3dGSphFRC4cXyz
lbl_806A0880:
...
/* 806A0898  4B BC EE 71 */	bl SetR__8cM3dGSphFf
/* 806A089C  7F 83 E3 78 */	mr r3, r28
/* 806A08A0  38 9D 09 DC */	addi r4, r29, 0x9dc
/* 806A08A4  4B BC 43 05 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 806A08D0  4B BC F1 6D */	bl cLib_addCalc2__FPffff
lbl_806A08D4:
/* 806A08D4  38 60 00 01 */	li r3, 1
lbl_806A08D8:
/* 806A08D8  39 61 00 80 */	addi r11, r1, 0x80
/* 806A08DC  4B CC 19 49 */	bl _restgpr_28
