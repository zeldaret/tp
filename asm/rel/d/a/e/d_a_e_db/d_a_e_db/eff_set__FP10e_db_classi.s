...
/* 806A000C  4B CC 21 B5 */	bl _savegpr_22
/* 806A0010  7C 79 1B 78 */	mr r25, r3
/* 806A0014  7C 9A 23 78 */	mr r26, r4
/* 806A0018  3C 60 80 6A */	lis r3, lit_3902@ha /* 0x806A190C@ha */
/* 806A001C  3B A3 19 0C */	addi r29, r3, lit_3902@l /* 0x806A190C@l */
...
/* 806A0068  4B BC F9 D5 */	bl cLib_addCalc2__FPffff
/* 806A006C  3B 60 00 00 */	li r27, 0
/* 806A0070  3B 00 00 00 */	li r24, 0
/* 806A0074  3A E0 00 00 */	li r23, 0
/* 806A0078  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A007C  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
lbl_806A0080:
...
/* 806A00BC  3C C0 80 6A */	lis r6, p_name@ha /* 0x806A1BEC@ha */
/* 806A00C0  38 C6 1B EC */	addi r6, r6, p_name@l /* 0x806A1BEC@l */
...
/* 806A00DC  4B 9A D3 F1 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806A00F4  4B 9A B8 25 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806A0108  4B BD EB 59 */	bl deleteAllParticle__14JPABaseEmitterFv
/* 806A010C  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)
/* 806A0110  38 63 02 10 */	addi r3, r3, 0x210
/* 806A0114  7C 99 B0 2E */	lwzx r4, r25, r22
/* 806A0118  4B 9A B7 9D */	bl forceOnEventMove__Q213dPa_control_c7level_cFUl
/* 806A011C  48 00 00 70 */	b lbl_806A018C
lbl_806A0120:
/* 806A0120  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 806A0124  80 83 00 0C */	lwz r4, 0xc(r3)
/* 806A0128  3C 60 80 6A */	lis r3, p_idx@ha /* 0x806A1BF4@ha */
/* 806A012C  38 63 1B F4 */	addi r3, r3, p_idx@l /* 0x806A1BF4@l */
/* 806A0130  7C 03 B8 2E */	lwzx r0, r3, r23
/* 806A0134  1C 00 00 30 */	mulli r0, r0, 0x30
/* 806A0138  7C 64 02 14 */	add r3, r4, r0
/* 806A013C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 806A0140  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 806A0144  80 84 00 00 */	lwz r4, 0(r4)
/* 806A0148  4B CA 63 69 */	bl PSMTXCopy
...
/* 806A015C  4B BD 0D 49 */	bl MtxScale__FfffUc
/* 806A0160  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806A0164  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 806A0178  4B BE 06 91 */	bl func_80280808
...
/* 806A01E0  4B 97 DA DD */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 806A01E4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 806A01E8  41 82 00 10 */	beq lbl_806A01F8
/* 806A01EC  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 806A01F0  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 806A0244  4B 9A D2 89 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806A02A4  4B 9A D2 29 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806A02B8  4B 9A B6 61 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806A02D0  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 806A02D4  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 806A02D8  80 84 00 00 */	lwz r4, 0(r4)
/* 806A02DC  4B CA 61 D5 */	bl PSMTXCopy
/* 806A02E0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806A02E4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806A02E8  80 63 00 00 */	lwz r3, 0(r3)
/* 806A02EC  38 97 00 68 */	addi r4, r23, 0x68
/* 806A02F0  38 B7 00 A4 */	addi r5, r23, 0xa4
/* 806A02F4  4B BE 04 ED */	bl func_802807E0
...
/* 806A0350  4B 9A D1 7D */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806A0364  4B 9A B5 B5 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806A037C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 806A0380  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 806A0384  80 84 00 00 */	lwz r4, 0(r4)
/* 806A0388  4B CA 61 29 */	bl PSMTXCopy
/* 806A038C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806A0390  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806A0394  80 63 00 00 */	lwz r3, 0(r3)
/* 806A0398  38 97 00 68 */	addi r4, r23, 0x68
/* 806A039C  38 B7 00 A4 */	addi r5, r23, 0xa4
/* 806A03A0  4B BE 04 41 */	bl func_802807E0
lbl_806A03A4:
/* 806A03A4  38 00 00 00 */	li r0, 0
/* 806A03A8  98 19 12 39 */	stb r0, 0x1239(r25)
lbl_806A03AC:
/* 806A03AC  39 61 00 60 */	addi r11, r1, 0x60
/* 806A03B0  4B CC 1E 5D */	bl _restgpr_22
