...
/* 80807884  4B B5 A9 31 */	bl _savegpr_19
/* 80807888  7C 7E 1B 78 */	mr r30, r3
/* 8080788C  7C 9A 23 78 */	mr r26, r4
/* 80807890  7C BB 2B 78 */	mr r27, r5
/* 80807894  7C DC 33 78 */	mr r28, r6
/* 80807898  3C 60 80 80 */	lis r3, cNullVec__6Z2Calc@ha /* 0x80807D70@ha */
/* 8080789C  3A E3 7D 70 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x80807D70@l */
/* 808078A0  3C 60 80 80 */	lis r3, lit_3941@ha /* 0x80807C9C@ha */
/* 808078A4  3B E3 7C 9C */	addi r31, r3, lit_3941@l /* 0x80807C9C@l */
/* 808078A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 808078AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 808078B0  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 808078B4  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 808078B8  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 808078E0  4B 9A 4C 9D */	bl dKy_darkworld_check__Fv
...
/* 80807904  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 80807908  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 80807920  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80807924  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80807928  4B B3 EB 89 */	bl PSMTXCopy
...
/* 80807940  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80807944  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80807948  38 81 00 4C */	addi r4, r1, 0x4c
/* 8080794C  38 A1 00 58 */	addi r5, r1, 0x58
/* 80807950  4B B3 F4 1D */	bl PSMTXMultVec
/* 80807954  38 61 00 34 */	addi r3, r1, 0x34
/* 80807958  38 81 00 58 */	addi r4, r1, 0x58
/* 8080795C  7F 65 DB 78 */	mr r5, r27
/* 80807960  4B A5 F1 D5 */	bl __mi__4cXyzCFRC3Vec
...
/* 8080797C  4B A5 FC F9 */	bl cM_atan2s__Fff
...
/* 808079B0  4B A5 FC C5 */	bl cM_atan2s__Fff
...
/* 808079CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 808079D0  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80807A20  4B 84 50 71 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80807A24  7C 79 1B 79 */	or. r25, r3, r3
/* 80807A28  41 82 00 FC */	beq lbl_80807B24
/* 80807A2C  38 61 00 40 */	addi r3, r1, 0x40
/* 80807A30  4B B3 F7 09 */	bl PSVECSquareMag
...
/* 80807AA0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80807AA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80807B10  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80807B14  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80807B18:
...
/* 80807B68  4B 84 4F 29 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80807BA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80807BA8  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80807C14  4B 84 58 B9 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80807C74  4B B5 A5 8D */	bl _restgpr_19
