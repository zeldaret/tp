...
/* 8067FF78  3C 80 80 68 */	lis r4, lit_3947@ha /* 0x806823BC@ha */
/* 8067FF7C  3B E4 23 BC */	addi r31, r4, lit_3947@l /* 0x806823BC@l */
...
/* 8067FFCC  4B BE 79 89 */	bl cM_rndF__Ff
...
/* 80680014  4B BE 79 79 */	bl cM_rndFX__Ff
...
/* 80680028  4B BE 79 65 */	bl cM_rndFX__Ff
...
/* 8068003C  4B BE 79 51 */	bl cM_rndFX__Ff
...
/* 80680058  4B BE 6A DD */	bl __mi__4cXyzCFRC3Vec
...
/* 80680074  4B BE 76 01 */	bl cM_atan2s__Fff
/* 80680078  7C 64 1B 78 */	mr r4, r3
/* 8068007C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 80680080  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 80680084  80 63 00 00 */	lwz r3, 0(r3)
/* 80680088  4B 98 C3 55 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 806800B8  4B BE 75 BD */	bl cM_atan2s__Fff
/* 806800BC  7C 03 00 D0 */	neg r0, r3
/* 806800C0  7C 04 07 34 */	extsh r4, r0
/* 806800C4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806800C8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806800CC  80 63 00 00 */	lwz r3, 0(r3)
/* 806800D0  4B 98 C2 CD */	bl mDoMtx_XrotM__FPA4_fs
/* 806800D4  C0 1F 00 04 */	lfs f0, 4(r31)
/* 806800D8  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 806800DC  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 806800E0  3C 60 80 68 */	lis r3, l_HIO@ha /* 0x80682648@ha */
/* 806800E4  38 63 26 48 */	addi r3, r3, l_HIO@l /* 0x80682648@l */
...
/* 806800F8  4B BF 0D F5 */	bl MtxPosition__FP4cXyzP4cXyz
/* 806800FC  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 80680100  4B BE 78 55 */	bl cM_rndF__Ff
...
lbl_80680124:
/* 80680124  3C 60 80 68 */	lis r3, l_HIO@ha /* 0x80682648@ha */
/* 80680128  38 63 26 48 */	addi r3, r3, l_HIO@l /* 0x80682648@l */
...
/* 80680140  4B BE F8 FD */	bl cLib_addCalc2__FPffff
