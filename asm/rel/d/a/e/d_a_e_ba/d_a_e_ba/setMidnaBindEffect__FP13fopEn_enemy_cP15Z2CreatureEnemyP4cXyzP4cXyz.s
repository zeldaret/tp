...
/* 80681FA4  4B CE 02 11 */	bl _savegpr_19
/* 80681FA8  7C 7E 1B 78 */	mr r30, r3
/* 80681FAC  7C 9A 23 78 */	mr r26, r4
/* 80681FB0  7C BB 2B 78 */	mr r27, r5
/* 80681FB4  7C DC 33 78 */	mr r28, r6
/* 80681FB8  3C 60 80 68 */	lis r3, cNullVec__6Z2Calc@ha /* 0x8068249C@ha */
/* 80681FBC  3A E3 24 9C */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x8068249C@l */
/* 80681FC0  3C 60 80 68 */	lis r3, lit_3947@ha /* 0x806823BC@ha */
/* 80681FC4  3B E3 23 BC */	addi r31, r3, lit_3947@l /* 0x806823BC@l */
/* 80681FC8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80681FCC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80681FD0  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80681FD4  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 80681FD8  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 80682000  4B B2 A5 7D */	bl dKy_darkworld_check__Fv
...
/* 80682024  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 80682028  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 80682040  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80682044  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80682048  4B CC 44 69 */	bl PSMTXCopy
...
/* 80682060  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80682064  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80682068  38 81 00 4C */	addi r4, r1, 0x4c
/* 8068206C  38 A1 00 58 */	addi r5, r1, 0x58
/* 80682070  4B CC 4C FD */	bl PSMTXMultVec
/* 80682074  38 61 00 34 */	addi r3, r1, 0x34
/* 80682078  38 81 00 58 */	addi r4, r1, 0x58
/* 8068207C  7F 65 DB 78 */	mr r5, r27
/* 80682080  4B BE 4A B5 */	bl __mi__4cXyzCFRC3Vec
...
/* 8068209C  4B BE 55 D9 */	bl cM_atan2s__Fff
...
/* 806820D0  4B BE 55 A5 */	bl cM_atan2s__Fff
...
/* 806820EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806820F0  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80682140  4B 9C A9 51 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80682144  7C 79 1B 79 */	or. r25, r3, r3
/* 80682148  41 82 00 FC */	beq lbl_80682244
/* 8068214C  38 61 00 40 */	addi r3, r1, 0x40
/* 80682150  4B CC 4F E9 */	bl PSVECSquareMag
...
/* 806821C0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806821C4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80682230  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80682234  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80682238:
...
/* 80682288  4B 9C A8 09 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806822C4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806822C8  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80682334  4B 9C B1 99 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80682394  4B CD FE 6D */	bl _restgpr_19
