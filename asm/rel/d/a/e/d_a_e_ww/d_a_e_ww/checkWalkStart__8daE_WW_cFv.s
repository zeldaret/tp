...
/* 807EC950  4B B7 58 85 */	bl _savegpr_27
/* 807EC954  7C 7D 1B 78 */	mr r29, r3
/* 807EC958  3C 80 80 7F */	lis r4, lit_3905@ha /* 0x807EF770@ha */
/* 807EC95C  3B E4 F7 70 */	addi r31, r4, lit_3905@l /* 0x807EF770@l */
...
lbl_807EC974:
/* 807EC974  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807EC978  38 A4 61 C0 */	addi r5, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807EC9C8  4B 82 DD 49 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807ECA08  4B A7 AF 85 */	bl cM_rndFX__Ff
...
/* 807ECA90  4B B5 A9 0D */	bl PSVECSquareDistance
...
/* 807ECB00  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807ECB04  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807ECB70  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807ECB74  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807ECB78:
...
/* 807ECBC0  4B A8 42 01 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 807ECBE8  4B 88 B0 81 */	bl __ct__11dBgS_LinChkFv
...
/* 807ECBFC  4B 88 B1 69 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807ECC00  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807ECC04  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807ECC08  38 63 0F 38 */	addi r3, r3, 0xf38
/* 807ECC0C  38 81 00 84 */	addi r4, r1, 0x84
/* 807ECC10  4B 88 77 A5 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 807ECC4C  4B 88 B0 91 */	bl __dt__11dBgS_LinChkFv
...
/* 807ECC60  4B 88 B0 7D */	bl __dt__11dBgS_LinChkFv
/* 807ECC64  48 00 01 D8 */	b lbl_807ECE3C
lbl_807ECC68:
/* 807ECC68  4B A7 AC 05 */	bl cM_rnd__Fv
...
/* 807ECCA0  4B A7 AC ED */	bl cM_rndFX__Ff
...
/* 807ECCE0  4B A8 40 E1 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 807ECD20  4B A7 AC 6D */	bl cM_rndFX__Ff
...
/* 807ECD60  4B A8 40 61 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 807ECDB8  4B A7 AA B5 */	bl cM_rnd__Fv
...
/* 807ECE30  4B 82 CE 4D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 807ECE44  4B B7 53 DD */	bl _restgpr_27
