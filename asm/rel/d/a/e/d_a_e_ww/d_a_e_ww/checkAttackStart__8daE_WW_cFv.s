...
/* 807EA484  4B B7 7D 55 */	bl _savegpr_28
/* 807EA488  7C 7D 1B 78 */	mr r29, r3
/* 807EA48C  3C 80 80 7F */	lis r4, lit_3905@ha /* 0x807EF770@ha */
/* 807EA490  3B E4 F7 70 */	addi r31, r4, lit_3905@l /* 0x807EF770@l */
/* 807EA494  80 03 07 34 */	lwz r0, 0x734(r3)
/* 807EA498  2C 00 00 00 */	cmpwi r0, 0
/* 807EA49C  40 82 03 B8 */	bne lbl_807EA854
/* 807EA4A0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807EA4A4  3B 84 61 C0 */	addi r28, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807EA4C0  4B 83 02 51 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807EA500  3C 60 80 7F */	lis r3, s_attack_ww__FPvPv@ha /* 0x807E8E6C@ha */
/* 807EA504  38 63 8E 6C */	addi r3, r3, s_attack_ww__FPvPv@l /* 0x807E8E6C@l */
/* 807EA508  7F A4 EB 78 */	mr r4, r29
/* 807EA50C  4B 83 6E 2D */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 807EA564  4B B5 CE 39 */	bl PSVECSquareDistance
...
/* 807EA5D4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807EA5D8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807EA644  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807EA648  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807EA64C:
...
/* 807EA664  4B 82 F6 19 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 807EA6E8  4B B5 CC B5 */	bl PSVECSquareDistance
...
/* 807EA758  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807EA75C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 807EA7C8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 807EA7CC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_807EA7D0:
...
/* 807EA85C  4B B7 79 C9 */	bl _restgpr_28
