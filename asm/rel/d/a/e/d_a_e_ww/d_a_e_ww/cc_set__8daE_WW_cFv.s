...
/* 807EDB10  4B B7 46 C5 */	bl _savegpr_27
/* 807EDB14  7C 7E 1B 78 */	mr r30, r3
/* 807EDB18  3C 60 80 7F */	lis r3, lit_3905@ha /* 0x807EF770@ha */
/* 807EDB1C  3B E3 F7 70 */	addi r31, r3, lit_3905@l /* 0x807EF770@l */
...
/* 807EDB40  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807EDB44  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807EDB48  4B B5 89 69 */	bl PSMTXCopy
/* 807EDB4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807EDB50  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 807EDBD8  4B A8 1A 71 */	bl SetC__8cM3dGSphFRC4cXyz
/* 807EDBDC  38 7E 0A D8 */	addi r3, r30, 0xad8
/* 807EDBE0  C0 3F 00 38 */	lfs f1, 0x38(r31)
/* 807EDBE4  4B A8 1B 25 */	bl SetR__8cM3dGSphFf
/* 807EDBE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807EDBEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 807EDBF0  3B 63 23 3C */	addi r27, r3, 0x233c
/* 807EDBF4  7F 63 DB 78 */	mr r3, r27
/* 807EDBF8  38 9E 09 B4 */	addi r4, r30, 0x9b4
/* 807EDBFC  4B A7 6F AD */	bl Set__4cCcSFP8cCcD_Obj
/* 807EDC00  38 7E 0D 48 */	addi r3, r30, 0xd48
/* 807EDC04  38 81 00 08 */	addi r4, r1, 8
/* 807EDC08  4B A8 1A 41 */	bl SetC__8cM3dGSphFRC4cXyz
/* 807EDC0C  38 7E 0D 48 */	addi r3, r30, 0xd48
/* 807EDC10  C0 3F 01 08 */	lfs f1, 0x108(r31)
/* 807EDC14  4B A8 1A F5 */	bl SetR__8cM3dGSphFf
/* 807EDC18  7F 63 DB 78 */	mr r3, r27
/* 807EDC1C  38 9E 0C 24 */	addi r4, r30, 0xc24
/* 807EDC20  4B A7 6F 89 */	bl Set__4cCcSFP8cCcD_Obj
/* 807EDC24  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 807EDC28  80 63 00 0C */	lwz r3, 0xc(r3)
/* 807EDC2C  38 63 00 C0 */	addi r3, r3, 0xc0
/* 807EDC30  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807EDC34  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807EDC38  4B B5 88 79 */	bl PSMTXCopy
/* 807EDC3C  C0 3F 00 4C */	lfs f1, 0x4c(r31)
/* 807EDC40  C0 5F 00 50 */	lfs f2, 0x50(r31)
/* 807EDC44  C0 7F 00 04 */	lfs f3, 4(r31)
/* 807EDC48  4B 81 F1 55 */	bl transM__14mDoMtx_stack_cFfff
