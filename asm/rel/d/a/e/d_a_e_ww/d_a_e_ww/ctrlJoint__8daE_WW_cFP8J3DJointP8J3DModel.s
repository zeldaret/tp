...
/* 807E7758  4B B7 AA 80 */	b _savegpr_28
...
/* 807E7778  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807E777C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807E7780  4B B5 ED 30 */	b PSMTXCopy
...
lbl_807E7798:
/* 807E7798  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E779C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E77A0  A8 9C 06 7C */	lha r4, 0x67c(r28)
/* 807E77A4  4B 82 4C 90 */	b mDoMtx_YrotM__FPA4_fs
/* 807E77A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E77AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E77B0  A8 9C 06 7E */	lha r4, 0x67e(r28)
/* 807E77B4  4B 82 4D 18 */	b mDoMtx_ZrotM__FPA4_fs
lbl_807E77B8:
/* 807E77B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E77BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E77C0  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 807E77C4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 807E77C8  7C 80 F2 14 */	add r4, r0, r30
/* 807E77CC  4B B5 EC E4 */	b PSMTXCopy
/* 807E77D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E77D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E77D8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 807E77DC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 807E77E0  4B B5 EC D0 */	b PSMTXCopy
/* 807E77E4  38 60 00 01 */	li r3, 1
/* 807E77E8  39 61 00 20 */	addi r11, r1, 0x20
/* 807E77EC  4B B7 AA 38 */	b _restgpr_28
