...
/* 8078AA5C  4B BD 77 75 */	bl _savegpr_26
/* 8078AA60  7C 7E 1B 78 */	mr r30, r3
/* 8078AA64  3C 60 80 79 */	lis r3, lit_3767@ha /* 0x8078DDA4@ha */
/* 8078AA68  3B E3 DD A4 */	addi r31, r3, lit_3767@l /* 0x8078DDA4@l */
/* 8078AA6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8078AA70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8078AACC  4B AD CE C1 */	bl cM_rndFX__Ff
...
/* 8078AAE0  4B AD CE AD */	bl cM_rndFX__Ff
...
/* 8078AAF4  4B AD CE 99 */	bl cM_rndFX__Ff
...
/* 8078AB10  4B AD C0 25 */	bl __mi__4cXyzCFRC3Vec
...
/* 8078AB34  4B BB C6 05 */	bl PSVECSquareMag
...
/* 8078ABA0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8078ABA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8078AC10  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8078AC14  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8078AC18:
...
/* 8078AC34  4B AD CD 21 */	bl cM_rndF__Ff
...
/* 8078AC8C  4B AD CC C9 */	bl cM_rndF__Ff
...
/* 8078AD00  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8078AD04  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8078AD48  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 8078AD4C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8078AD50  38 81 00 0C */	addi r4, r1, 0xc
/* 8078AD54  4B 88 EA A5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8078ADA4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8078ADA8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8078AE08  4B AD BD 2D */	bl __mi__4cXyzCFRC3Vec
...
/* 8078AE28  4B AD C8 4D */	bl cM_atan2s__Fff
...
/* 8078AE40  4B AE 57 C9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8078AE70  4B AD C8 05 */	bl cM_atan2s__Fff
...
/* 8078AE88  4B AE 57 81 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8078AEEC  4B AE 4B 51 */	bl cLib_addCalc2__FPffff
/* 8078AEF0  38 7E 05 2C */	addi r3, r30, 0x52c
/* 8078AEF4  C0 3E 06 94 */	lfs f1, 0x694(r30)
/* 8078AEF8  3C 80 80 79 */	lis r4, l_HIO@ha /* 0x8078E0EC@ha */
/* 8078AEFC  38 84 E0 EC */	addi r4, r4, l_HIO@l /* 0x8078E0EC@l */
...
/* 8078AF10  4B AE 4B 2D */	bl cLib_addCalc2__FPffff
/* 8078AF14  7F C3 F3 78 */	mr r3, r30
/* 8078AF18  7F A4 EB 78 */	mr r4, r29
/* 8078AF1C  4B 89 1E E1 */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8078AF84  4B AD C9 D1 */	bl cM_rndF__Ff
...
/* 8078AF9C  4B AD C9 B9 */	bl cM_rndF__Ff
...
/* 8078AFE8  3C 60 80 79 */	lis r3, l_HIO@ha /* 0x8078E0EC@ha */
/* 8078AFEC  38 63 E0 EC */	addi r3, r3, l_HIO@l /* 0x8078E0EC@l */
...
/* 8078B024  4B AD C9 31 */	bl cM_rndF__Ff
...
/* 8078B070  4B AD C8 E5 */	bl cM_rndF__Ff
...
/* 8078B0B8  4B AD C8 9D */	bl cM_rndF__Ff
...
/* 8078B0DC  4B AE 55 2D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8078B100  4B BD 71 1D */	bl _restgpr_26
