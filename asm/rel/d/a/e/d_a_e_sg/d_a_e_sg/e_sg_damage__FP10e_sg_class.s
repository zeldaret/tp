...
/* 8078C794  3C 60 80 79 */	lis r3, lit_3767@ha /* 0x8078DDA4@ha */
/* 8078C798  3B E3 DD A4 */	addi r31, r3, lit_3767@l /* 0x8078DDA4@l */
/* 8078C79C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8078C7A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8078C7E4  4B AD A3 51 */	bl __mi__4cXyzCFRC3Vec
...
/* 8078C800  4B AD AE 75 */	bl cM_atan2s__Fff
...
/* 8078C844  4B AD AE 31 */	bl cM_atan2s__Fff
...
/* 8078C85C  4B AD B0 F9 */	bl cM_rndF__Ff
...
/* 8078C884  4B AD B0 D1 */	bl cM_rndF__Ff
...
/* 8078C898  4B AD B0 BD */	bl cM_rndF__Ff
...
/* 8078C8F0  4B AE 31 91 */	bl cLib_addCalc0__FPfff
lbl_8078C8F4:
...
/* 8078C93C  4B AE 31 45 */	bl cLib_addCalc0__FPfff
lbl_8078C940:
/* 8078C940  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8078C944  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8078C948  80 63 00 00 */	lwz r3, 0(r3)
/* 8078C94C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 8078C950  4B 87 FA 8D */	bl mDoMtx_YrotS__FPA4_fs
/* 8078C954  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8078C958  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8078C95C  80 63 00 00 */	lwz r3, 0(r3)
/* 8078C960  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 8078C964  4B 87 FA 39 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 8078C97C  3C 60 80 79 */	lis r3, l_HIO@ha /* 0x8078E0EC@ha */
/* 8078C980  38 63 E0 EC */	addi r3, r3, l_HIO@l /* 0x8078E0EC@l */
...
/* 8078C9C4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8078C9C8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8078C9CC  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8078C9D0  4B 8E A0 DD */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 8078C9F8  4B 89 00 E1 */	bl fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
/* 8078C9FC  7F C3 F3 78 */	mr r3, r30
/* 8078CA00  4B 88 D2 7D */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_8078CA04:
