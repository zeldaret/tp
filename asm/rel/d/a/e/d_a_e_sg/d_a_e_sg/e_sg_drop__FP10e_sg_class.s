...
/* 8078C490  3C 60 80 79 */	lis r3, lit_3767@ha /* 0x8078DDA4@ha */
/* 8078C494  3B E3 DD A4 */	addi r31, r3, lit_3767@l /* 0x8078DDA4@l */
...
/* 8078C4C4  4B AD A6 71 */	bl __mi__4cXyzCFRC3Vec
...
/* 8078C4E0  4B AD B1 95 */	bl cM_atan2s__Fff
/* 8078C4E4  7C 64 1B 78 */	mr r4, r3
/* 8078C4E8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8078C4EC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8078C4F0  80 63 00 00 */	lwz r3, 0(r3)
/* 8078C4F4  4B 87 FE E9 */	bl mDoMtx_YrotS__FPA4_fs
/* 8078C4F8  C0 3F 00 60 */	lfs f1, 0x60(r31)
/* 8078C4FC  4B AD B4 91 */	bl cM_rndFX__Ff
/* 8078C500  D0 21 00 24 */	stfs f1, 0x24(r1)
/* 8078C504  C0 3F 00 04 */	lfs f1, 4(r31)
/* 8078C508  4B AD B4 4D */	bl cM_rndF__Ff
...
/* 8078C51C  4B AD B4 39 */	bl cM_rndF__Ff
...
/* 8078C534  4B AE 49 B9 */	bl MtxPosition__FP4cXyzP4cXyz
/* 8078C538  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 8078C53C  4B AD B4 19 */	bl cM_rndF__Ff
...
/* 8078C564  4B AD B3 F1 */	bl cM_rndF__Ff
...
/* 8078C58C  4B AD B4 01 */	bl cM_rndFX__Ff
...
/* 8078C5E0  4B BB AA B1 */	bl PSVECAdd
...
/* 8078C5F8  3C 60 80 79 */	lis r3, l_HIO@ha /* 0x8078E0EC@ha */
/* 8078C5FC  38 63 E0 EC */	addi r3, r3, l_HIO@l /* 0x8078E0EC@l */
...
/* 8078C62C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8078C630  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8078C634  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8078C638  4B 8E A4 75 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 8078C680  4B AD B2 D5 */	bl cM_rndF__Ff
...
/* 8078C6A0  4B AD B2 B5 */	bl cM_rndF__Ff
...
/* 8078C6D8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8078C6DC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8078C6E0  80 63 00 00 */	lwz r3, 0(r3)
/* 8078C6E4  A8 9E 06 88 */	lha r4, 0x688(r30)
/* 8078C6E8  4B 87 FC F5 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 8078C708  4B AE 47 E5 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8078C758  4B 88 FA E9 */	bl fopAcM_createItem__FPC4cXyziiiPC5csXyzPC4cXyzi
lbl_8078C75C:
