...
/* 8078C080  4B BD 61 5D */	bl _savegpr_29
/* 8078C084  7C 7D 1B 78 */	mr r29, r3
/* 8078C088  3C 60 80 79 */	lis r3, lit_3767@ha /* 0x8078DDA4@ha */
/* 8078C08C  3B E3 DD A4 */	addi r31, r3, lit_3767@l /* 0x8078DDA4@l */
/* 8078C090  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8078C094  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_8078C10C:
/* 8078C10C  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 0x803DD2E8@ha */
/* 8078C110  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 0x803DD2E8@l */
...
/* 8078C160  4B AD B7 F5 */	bl cM_rndF__Ff
...
/* 8078C188  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8078C18C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8078C1E0  4B AD B7 75 */	bl cM_rndF__Ff
...
/* 8078C210  3C 60 80 79 */	lis r3, stick_pt@ha /* 0x8078E104@ha */
/* 8078C214  38 A3 E1 04 */	addi r5, r3, stick_pt@l /* 0x8078E104@l */
/* 8078C218  80 85 00 00 */	lwz r4, 0(r5)
/* 8078C21C  3C 60 80 79 */	lis r3, stick_bit@ha /* 0x8078DEB4@ha */
/* 8078C220  38 63 DE B4 */	addi r3, r3, stick_bit@l /* 0x8078DEB4@l */
...
/* 8078C250  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8078C254  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8078C258  80 63 5D B4 */	lwz r3, 0x5db4(r3)
/* 8078C25C  3C 80 80 79 */	lis r4, stick_d@ha /* 0x8078DF34@ha */
/* 8078C260  38 84 DF 34 */	addi r4, r4, stick_d@l /* 0x8078DF34@l */
...
/* 8078C28C  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8078C290  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8078C294  80 84 00 00 */	lwz r4, 0(r4)
/* 8078C298  4B BB A2 19 */	bl PSMTXCopy
/* 8078C29C  3C 60 80 79 */	lis r3, stick_d@ha /* 0x8078DF34@ha */
/* 8078C2A0  38 63 DF 34 */	addi r3, r3, stick_d@l /* 0x8078DF34@l */
...
/* 8078C30C  4B AE 4B E1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8078C320  4B AE 37 1D */	bl cLib_addCalc2__FPffff
...
/* 8078C334  4B AE 37 09 */	bl cLib_addCalc2__FPffff
...
/* 8078C348  4B AE 36 F5 */	bl cLib_addCalc2__FPffff
...
/* 8078C35C  4B AE 36 E1 */	bl cLib_addCalc2__FPffff
...
/* 8078C3F4  4B AE 42 15 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8078C408  4B AE 42 01 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8078C418  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8078C41C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
