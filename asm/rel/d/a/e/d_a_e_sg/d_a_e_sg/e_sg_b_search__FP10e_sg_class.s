...
/* 8078B640  4B BD 6B 99 */	bl _savegpr_28
/* 8078B644  7C 7D 1B 78 */	mr r29, r3
/* 8078B648  3C 60 80 79 */	lis r3, lit_3767@ha /* 0x8078DDA4@ha */
/* 8078B64C  3B C3 DD A4 */	addi r30, r3, lit_3767@l /* 0x8078DDA4@l */
/* 8078B650  80 1D 06 CC */	lwz r0, 0x6cc(r29)
/* 8078B654  90 01 00 10 */	stw r0, 0x10(r1)
/* 8078B658  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 8078B65C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 8078B660  38 81 00 10 */	addi r4, r1, 0x10
/* 8078B664  4B 88 E1 95 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8078B688  4B AD C2 CD */	bl cM_rndF__Ff
...
/* 8078B6F8  4B AD B4 3D */	bl __mi__4cXyzCFRC3Vec
...
/* 8078B718  4B BB BA 21 */	bl PSVECSquareMag
...
/* 8078B788  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8078B78C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8078B7F8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8078B7FC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8078B800:
...
/* 8078B86C  4B AD B2 C9 */	bl __mi__4cXyzCFRC3Vec
...
/* 8078B8B4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8078B8B8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
/* 8078B8BC  7F C3 04 2E */	lfsx f30, r3, r0
/* 8078B8C0  C0 21 00 48 */	lfs f1, 0x48(r1)
/* 8078B8C4  C0 41 00 50 */	lfs f2, 0x50(r1)
/* 8078B8C8  4B AD BD AD */	bl cM_atan2s__Fff
...
/* 8078B8F0  4B AE 4D 19 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8078B920  4B AD BD 55 */	bl cM_atan2s__Fff
...
/* 8078B938  4B AE 4C D1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 8078B99C  4B AE 40 A1 */	bl cLib_addCalc2__FPffff
/* 8078B9A0  38 7D 05 2C */	addi r3, r29, 0x52c
/* 8078B9A4  C0 3D 06 94 */	lfs f1, 0x694(r29)
/* 8078B9A8  3C 80 80 79 */	lis r4, l_HIO@ha /* 0x8078E0EC@ha */
/* 8078B9AC  38 84 E0 EC */	addi r4, r4, l_HIO@l /* 0x8078E0EC@l */
...
/* 8078B9C0  4B AE 40 7D */	bl cLib_addCalc2__FPffff
...
/* 8078B9D4  4B AD B1 61 */	bl __mi__4cXyzCFRC3Vec
...
/* 8078B9F4  4B BB B7 45 */	bl PSVECSquareMag
...
/* 8078BA64  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8078BA68  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8078BAD4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8078BAD8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8078BADC:
...
/* 8078BAF4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8078BAF8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8078BB38  4B AD BE 1D */	bl cM_rndF__Ff
...
/* 8078BB58  4B AD BD FD */	bl cM_rndF__Ff
...
/* 8078BBA4  4B AE 3E 99 */	bl cLib_addCalc2__FPffff
...
/* 8078BBF0  4B AE 4A 19 */	bl cLib_addCalcAngleS2__FPssss
lbl_8078BBF4:
...
/* 8078BC10  4B BD 66 15 */	bl _restgpr_28
