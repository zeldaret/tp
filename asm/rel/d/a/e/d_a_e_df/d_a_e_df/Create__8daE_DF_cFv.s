...
/* 806A9688  4B CB 8B 55 */	bl _savegpr_29
/* 806A968C  7C 7D 1B 78 */	mr r29, r3
/* 806A9690  3C 80 80 6B */	lis r4, lit_3916@ha /* 0x806A9F30@ha */
/* 806A9694  3B E4 9F 30 */	addi r31, r4, lit_3916@l /* 0x806A9F30@l */
...
/* 806A96B0  4B 96 F4 B5 */	bl __ct__10fopAc_ac_cFv
/* 806A96B4  38 7E 05 D8 */	addi r3, r30, 0x5d8
/* 806A96B8  4B C1 78 AD */	bl __ct__15Z2CreatureEnemyFv
/* 806A96BC  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 806A96C0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 806A96C4  90 1E 06 94 */	stw r0, 0x694(r30)
/* 806A96C8  38 7E 06 98 */	addi r3, r30, 0x698
/* 806A96CC  4B 9D A0 95 */	bl __ct__10dCcD_GSttsFv
/* 806A96D0  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 806A96D4  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 806A96EC  4B 9D A3 3D */	bl __ct__12dCcD_GObjInfFv
/* 806A96F0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 806A96F4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 806A96F8  90 1E 01 20 */	stw r0, 0x120(r30)
/* 806A96FC  3C 60 80 6B */	lis r3, __vt__8cM3dGAab@ha /* 0x806AA0B0@ha */
/* 806A9700  38 03 A0 B0 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x806AA0B0@l */
/* 806A9704  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 806A9708  3C 60 80 6B */	lis r3, __vt__8cM3dGCyl@ha /* 0x806AA0A4@ha */
/* 806A970C  38 03 A0 A4 */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x806AA0A4@l */
/* 806A9710  90 1E 01 38 */	stw r0, 0x138(r30)
/* 806A9714  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 806A9718  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
/* 806A971C  90 7E 01 20 */	stw r3, 0x120(r30)
/* 806A9720  38 03 00 58 */	addi r0, r3, 0x58
/* 806A9724  90 1E 01 38 */	stw r0, 0x138(r30)
/* 806A9728  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 806A972C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 806A9754  3C 80 80 6B */	lis r4, d_a_e_df__stringBase0@ha /* 0x806A9FFC@ha */
/* 806A9758  38 84 9F FC */	addi r4, r4, d_a_e_df__stringBase0@l /* 0x806A9FFC@l */
/* 806A975C  4B 98 37 61 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806A9780  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A9784  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806A9788  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 806A978C  7C 05 07 74 */	extsb r5, r0
/* 806A9790  4B 98 BB D1 */	bl isSwitch__10dSv_info_cCFii
...
/* 806A97A8  3C 80 80 6A */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x806A7808@ha */
/* 806A97AC  38 84 78 08 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x806A7808@l */
/* 806A97B0  38 A0 1A 40 */	li r5, 0x1a40
/* 806A97B4  4B 97 0C FD */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_806A97C8:
/* 806A97C8  3C 60 80 6B */	lis r3, data_806AA0D0@ha /* 0x806AA0D0@ha */
/* 806A97CC  8C 03 A0 D0 */	lbzu r0, data_806AA0D0@l(r3)  /* 0x806AA0D0@l */
...
/* 806A97E8  3C 60 80 6B */	lis r3, l_HIO@ha /* 0x806AA0E0@ha */
/* 806A97EC  38 63 A0 E0 */	addi r3, r3, l_HIO@l /* 0x806AA0E0@l */
...
/* 806A981C  4B 97 0D 0D */	bl fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 806A9830  4B 97 0D 09 */	bl fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 806A9848  4B C1 78 4D */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 806A984C  38 7D 05 D8 */	addi r3, r29, 0x5d8
/* 806A9850  3C 80 80 6B */	lis r4, d_a_e_df__stringBase0@ha /* 0x806A9FFC@ha */
/* 806A9854  38 84 9F FC */	addi r4, r4, d_a_e_df__stringBase0@l /* 0x806A9FFC@l */
/* 806A9858  4B C1 83 39 */	bl setEnemyName__15Z2CreatureEnemyFPCc
...
/* 806A9894  4B 97 44 29 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 806A9898  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 806A989C  41 82 00 10 */	beq lbl_806A98AC
/* 806A98A0  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 806A98A4  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)  /* 0x80450CD0@l */
...
/* 806A98C4  3C 60 80 6A */	lis r3, JointCallBack__FP8J3DJointi@ha /* 0x806A7E30@ha */
/* 806A98C8  38 83 7E 30 */	addi r4, r3, JointCallBack__FP8J3DJointi@l /* 0x806A7E30@l */
...
/* 806A991C  4B CB 89 0D */	bl _restgpr_29
