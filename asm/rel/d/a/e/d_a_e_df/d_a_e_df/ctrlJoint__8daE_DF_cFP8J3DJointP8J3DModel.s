...
/* 806A7CF0  4B CB A4 E8 */	b _savegpr_28
...
/* 806A7D10  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806A7D14  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806A7D18  4B C9 E7 98 */	b PSMTXCopy
...
lbl_806A7D34:
/* 806A7D34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A7D38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A7D3C  3C 80 80 6B */	lis r4, lit_4096@ha
/* 806A7D40  C0 44 9F AC */	lfs f2, lit_4096@l(r4)
/* 806A7D44  A8 1D 05 B0 */	lha r0, 0x5b0(r29)
/* 806A7D48  3C 80 80 6B */	lis r4, lit_4098@ha
/* 806A7D4C  C8 24 9F B0 */	lfd f1, lit_4098@l(r4)
...
/* 806A7D78  4B 96 46 BC */	b mDoMtx_YrotM__FPA4_fs
/* 806A7D7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A7D80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A7D84  3C 80 80 6B */	lis r4, lit_4096@ha
/* 806A7D88  C0 44 9F AC */	lfs f2, lit_4096@l(r4)
/* 806A7D8C  A8 1D 05 B4 */	lha r0, 0x5b4(r29)
/* 806A7D90  3C 80 80 6B */	lis r4, lit_4098@ha
/* 806A7D94  C8 24 9F B0 */	lfd f1, lit_4098@l(r4)
...
/* 806A7DC0  4B 96 47 0C */	b mDoMtx_ZrotM__FPA4_fs
/* 806A7DC4  48 00 00 24 */	b lbl_806A7DE8
lbl_806A7DC8:
/* 806A7DC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A7DCC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A7DD0  A8 9D 05 B0 */	lha r4, 0x5b0(r29)
/* 806A7DD4  4B 96 46 60 */	b mDoMtx_YrotM__FPA4_fs
/* 806A7DD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A7DDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A7DE0  A8 9D 05 B4 */	lha r4, 0x5b4(r29)
/* 806A7DE4  4B 96 46 E8 */	b mDoMtx_ZrotM__FPA4_fs
lbl_806A7DE8:
/* 806A7DE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A7DEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A7DF0  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 806A7DF4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806A7DF8  7C 80 FA 14 */	add r4, r0, r31
/* 806A7DFC  4B C9 E6 B4 */	b PSMTXCopy
/* 806A7E00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A7E04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A7E08  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 806A7E0C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 806A7E10  4B C9 E6 A0 */	b PSMTXCopy
/* 806A7E14  38 60 00 01 */	li r3, 1
/* 806A7E18  39 61 00 40 */	addi r11, r1, 0x40
/* 806A7E1C  4B CB A4 08 */	b _restgpr_28
