...
/* 806A8F3C  4B CB 92 9D */	bl _savegpr_28
/* 806A8F40  7C 7D 1B 78 */	mr r29, r3
/* 806A8F44  3C 60 80 6B */	lis r3, lit_3916@ha /* 0x806A9F30@ha */
/* 806A8F48  3B E3 9F 30 */	addi r31, r3, lit_3916@l /* 0x806A9F30@l */
/* 806A8F4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A8F50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806A8F70  4B C9 E4 2D */	bl PSVECSquareDistance
...
/* 806A8FE0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806A8FE4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806A9050  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806A9054  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_806A9058:
...
/* 806A9098  4B BC 7B 6D */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 806A909C  B0 7D 05 C4 */	sth r3, 0x5c4(r29)
/* 806A90A0  38 00 00 01 */	li r0, 1
/* 806A90A4  98 1D 05 AC */	stb r0, 0x5ac(r29)
lbl_806A90A8:
/* 806A90A8  3C 60 80 6A */	lis r3, s_obj_sub__FPvPv@ha /* 0x806A7E7C@ha */
/* 806A90AC  38 63 7E 7C */	addi r3, r3, s_obj_sub__FPvPv@l /* 0x806A7E7C@l */
/* 806A90B0  7F A4 EB 78 */	mr r4, r29
/* 806A90B4  4B 97 82 85 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 806A90E0  4B 97 0B 9D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 806A912C  4B BC 7A D9 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806A9150  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806A9154  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806A9168  4B 9C 68 BD */	bl StartShock__12dVibration_cFii4cXyz
