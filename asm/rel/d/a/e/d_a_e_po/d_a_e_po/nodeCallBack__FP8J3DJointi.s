...
/* 8074C71C  4B C1 5A BD */	bl _savegpr_28
/* 8074C720  2C 04 00 00 */	cmpwi r4, 0
/* 8074C724  40 82 01 18 */	bne lbl_8074C83C
/* 8074C728  A3 83 00 14 */	lhz r28, 0x14(r3)
/* 8074C72C  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 8074C730  38 63 4A C8 */	addi r3, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8074C754  3C 80 80 45 */	lis r4, calc_mtx@ha /* 0x80450768@ha */
/* 8074C758  38 84 07 68 */	addi r4, r4, calc_mtx@l /* 0x80450768@l */
/* 8074C75C  80 84 00 00 */	lwz r4, 0(r4)
/* 8074C760  4B BF 9D 51 */	bl PSMTXCopy
...
/* 8074C77C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8074C780  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8074C794  4B 8B FC A1 */	bl mDoMtx_YrotM__FPA4_fs
/* 8074C798  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8074C79C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8074C7A0  80 63 00 00 */	lwz r3, 0(r3)
/* 8074C7A4  7C 9D E2 14 */	add r4, r29, r28
/* 8074C7A8  A8 84 07 74 */	lha r4, 0x774(r4)
/* 8074C7AC  4B 8B FD 21 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8074C7B0  48 00 00 38 */	b lbl_8074C7E8
lbl_8074C7B4:
/* 8074C7B4  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8074C7B8  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8074C7CC  4B 8B FC 69 */	bl mDoMtx_YrotM__FPA4_fs
/* 8074C7D0  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8074C7D4  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8074C7D8  80 63 00 00 */	lwz r3, 0(r3)
/* 8074C7DC  7C 9D E2 14 */	add r4, r29, r28
/* 8074C7E0  A8 84 07 80 */	lha r4, 0x780(r4)
/* 8074C7E4  4B 8B FC E9 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_8074C7E8:
/* 8074C7E8  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8074C7EC  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
...
/* 8074C800  4B BF 9C B1 */	bl PSMTXCopy
/* 8074C804  48 00 00 20 */	b lbl_8074C824
lbl_8074C808:
/* 8074C808  2C 1C 00 02 */	cmpwi r28, 2
/* 8074C80C  40 82 00 18 */	bne lbl_8074C824
/* 8074C810  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8074C814  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8074C818  80 63 00 00 */	lwz r3, 0(r3)
/* 8074C81C  A8 9D 08 10 */	lha r4, 0x810(r29)
/* 8074C820  4B 8B FB 7D */	bl mDoMtx_XrotM__FPA4_fs
lbl_8074C824:
/* 8074C824  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 8074C828  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 8074C82C  80 63 00 00 */	lwz r3, 0(r3)
/* 8074C830  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 8074C834  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 8074C838  4B BF 9C 79 */	bl PSMTXCopy
lbl_8074C83C:
/* 8074C83C  38 60 00 01 */	li r3, 1
/* 8074C840  39 61 00 20 */	addi r11, r1, 0x20
/* 8074C844  4B C1 59 E1 */	bl _restgpr_28
