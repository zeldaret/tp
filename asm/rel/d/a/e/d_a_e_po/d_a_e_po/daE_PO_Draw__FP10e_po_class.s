...
/* 8074C868  4B C1 59 69 */	bl _savegpr_26
/* 8074C86C  7C 7D 1B 78 */	mr r29, r3
/* 8074C870  3C 80 80 75 */	lis r4, lit_3917@ha /* 0x807576FC@ha */
/* 8074C874  3B E4 76 FC */	addi r31, r4, lit_3917@l /* 0x807576FC@l */
...
/* 8074C888  3C 60 80 75 */	lis r3, struct_80757E9C+0x2@ha /* 0x80757E9E@ha */
/* 8074C88C  A8 03 7E 9E */	lha r0, struct_80757E9C+0x2@l(r3)  /* 0x80757E9E@l */
...
lbl_8074C8B4:
/* 8074C8B4  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8074C8B8  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8074C8BC  38 80 00 00 */	li r4, 0
/* 8074C8C0  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 8074C8C4  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8074C8C8  4B A5 6E FD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8074C8CC  88 1D 07 58 */	lbz r0, 0x758(r29)
/* 8074C8D0  28 00 00 00 */	cmplwi r0, 0
/* 8074C8D4  40 82 00 24 */	bne lbl_8074C8F8
/* 8074C8D8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8074C8DC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8074C8E0  80 9D 05 E8 */	lwz r4, 0x5e8(r29)
/* 8074C8E4  80 84 00 04 */	lwz r4, 4(r4)
/* 8074C8E8  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8074C8EC  4B A5 84 B5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8074C8F0  80 7D 05 E8 */	lwz r3, 0x5e8(r29)
/* 8074C8F4  4B 8C 13 D1 */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8074C8F8:
...
/* 8074C93C  3C 80 80 75 */	lis r4, l_HIO@ha /* 0x80757E5C@ha */
/* 8074C940  38 84 7E 5C */	addi r4, r4, l_HIO@l /* 0x80757E5C@l */
...
/* 8074C964  3C 80 80 75 */	lis r4, l_HIO@ha /* 0x80757E5C@ha */
/* 8074C968  38 84 7E 5C */	addi r4, r4, l_HIO@l /* 0x80757E5C@l */
...
/* 8074C98C  3C 80 80 75 */	lis r4, l_HIO@ha /* 0x80757E5C@ha */
/* 8074C990  38 84 7E 5C */	addi r4, r4, l_HIO@l /* 0x80757E5C@l */
...
/* 8074C9F4  3C 80 80 75 */	lis r4, l_HIO@ha /* 0x80757E5C@ha */
/* 8074C9F8  38 84 7E 5C */	addi r4, r4, l_HIO@l /* 0x80757E5C@l */
...
/* 8074CA1C  3C 80 80 75 */	lis r4, l_HIO@ha /* 0x80757E5C@ha */
/* 8074CA20  38 84 7E 5C */	addi r4, r4, l_HIO@l /* 0x80757E5C@l */
...
/* 8074CA44  3C 80 80 75 */	lis r4, l_HIO@ha /* 0x80757E5C@ha */
/* 8074CA48  38 84 7E 5C */	addi r4, r4, l_HIO@l /* 0x80757E5C@l */
/* 8074CA4C  A8 04 00 26 */	lha r0, 0x26(r4)
/* 8074CA50  B0 03 00 04 */	sth r0, 4(r3)
lbl_8074CA54:
/* 8074CA54  80 7D 05 F0 */	lwz r3, 0x5f0(r29)
/* 8074CA58  4B 8C 3C 29 */	bl entryDL__14mDoExt_McaMorfFv
lbl_8074CA5C:
/* 8074CA5C  88 1D 07 5A */	lbz r0, 0x75a(r29)
/* 8074CA60  28 00 00 00 */	cmplwi r0, 0
/* 8074CA64  41 82 00 2C */	beq lbl_8074CA90
/* 8074CA68  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8074CA6C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8074CA70  80 9D 05 EC */	lwz r4, 0x5ec(r29)
/* 8074CA74  80 84 00 04 */	lwz r4, 4(r4)
/* 8074CA78  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8074CA7C  4B A5 83 25 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8074CA80  80 7D 05 D8 */	lwz r3, 0x5d8(r29)
/* 8074CA84  4B 8C 47 3D */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 8074CAAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8074CAB0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8074CAB4  88 04 4F AD */	lbz r0, 0x4fad(r4)
/* 8074CAB8  28 00 00 00 */	cmplwi r0, 0
/* 8074CABC  41 82 00 1C */	beq lbl_8074CAD8
/* 8074CAC0  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 8074CAC4  83 C3 10 18 */	lwz r30, m_midnaActor__9daPy_py_c@l(r3)  /* 0x80451018@l */
/* 8074CAC8  80 64 5D B4 */	lwz r3, 0x5db4(r4)
/* 8074CACC  4B 8C F0 49 */	bl fopAcM_getTalkEventPartner__FPC10fopAc_ac_c
...
/* 8074CAE0  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8074CAE4  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8074CAE8  80 9E 00 04 */	lwz r4, 4(r30)
/* 8074CAEC  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8074CAF0  4B A5 82 B1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8074CC14  4B 8C 1B AD */	bl entryDL__21mDoExt_invisibleModelFP4cXyz
...
/* 8074CC30  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8074CC34  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8074CC64  4B B2 2D D9 */	bl cLib_addCalc2__FPffff
lbl_8074CC68:
/* 8074CC68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8074CC6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8074CCAC  4B 8C C9 F5 */	bl drawBallModel__13fopEn_enemy_cFP12dKy_tevstr_c
lbl_8074CCB0:
/* 8074CCB0  38 60 00 01 */	li r3, 1
lbl_8074CCB4:
/* 8074CCB4  39 61 00 30 */	addi r11, r1, 0x30
/* 8074CCB8  4B C1 55 65 */	bl _restgpr_26
