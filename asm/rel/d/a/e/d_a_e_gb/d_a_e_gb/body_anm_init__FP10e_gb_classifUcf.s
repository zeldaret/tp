...
/* 806C1E0C  4B CA 03 D1 */	bl _savegpr_29
...
/* 806C1E24  3C 60 80 6C */	lis r3, d_a_e_gb__stringBase0@ha /* 0x806C76B8@ha */
/* 806C1E28  38 63 76 B8 */	addi r3, r3, d_a_e_gb__stringBase0@l /* 0x806C76B8@l */
/* 806C1E2C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C1E30  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C1E34  3C A5 00 02 */	addis r5, r5, 2
/* 806C1E38  38 C0 00 80 */	li r6, 0x80
/* 806C1E3C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806C1E40  4B 97 A4 AD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806C1E58  3C C0 80 6C */	lis r6, lit_3907@ha /* 0x806C74EC@ha */
/* 806C1E5C  C0 66 74 EC */	lfs f3, lit_3907@l(r6)  /* 0x806C74EC@l */
/* 806C1E60  3C C0 80 6C */	lis r6, lit_3941@ha /* 0x806C7518@ha */
/* 806C1E64  C0 86 75 18 */	lfs f4, lit_3941@l(r6)  /* 0x806C7518@l */
/* 806C1E68  38 C0 00 00 */	li r6, 0
/* 806C1E6C  4B 94 E5 11 */	bl setAnm__14mDoExt_McaMorfFP15J3DAnmTransformiffffPv
...
/* 806C1E88  4B CA 03 A1 */	bl _restgpr_29
