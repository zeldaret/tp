lbl_806C1CEC:
/* 806C1CEC  3C 80 80 6C */	lis r4, __vt__12daE_GB_HIO_c@ha /* 0x806C7914@ha */
/* 806C1CF0  38 04 79 14 */	addi r0, r4, __vt__12daE_GB_HIO_c@l /* 0x806C7914@l */
/* 806C1CF4  90 03 00 00 */	stw r0, 0(r3)
/* 806C1CF8  38 00 FF FF */	li r0, -1
/* 806C1CFC  98 03 00 04 */	stb r0, 4(r3)
/* 806C1D00  3C 80 80 6C */	lis r4, lit_3908@ha /* 0x806C74F0@ha */
/* 806C1D04  C0 04 74 F0 */	lfs f0, lit_3908@l(r4)  /* 0x806C74F0@l */
...
/* 806C1D1C  3C 80 80 6C */	lis r4, lit_3927@ha /* 0x806C7514@ha */
/* 806C1D20  C0 04 75 14 */	lfs f0, lit_3927@l(r4)  /* 0x806C7514@l */
