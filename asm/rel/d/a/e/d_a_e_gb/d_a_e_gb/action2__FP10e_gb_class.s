...
/* 806C4D58  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C4D5C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806C4D84  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha /* 0x80023578@ha */
/* 806C4D88  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l /* 0x80023578@l */
/* 806C4D8C  38 81 00 08 */	addi r4, r1, 8
/* 806C4D90  4B 95 4A 69 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 806C4DBC  4B 96 82 B1 */	bl dComIfGp_getReverb__Fi
...
/* 806C4DD0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806C4DD4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806C4DE8  3D 00 80 6C */	lis r8, lit_3908@ha /* 0x806C74F0@ha */
/* 806C4DEC  C0 28 74 F0 */	lfs f1, lit_3908@l(r8)  /* 0x806C74F0@l */
/* 806C4DF0  FC 40 08 90 */	fmr f2, f1
/* 806C4DF4  3D 00 80 6C */	lis r8, lit_3941@ha /* 0x806C7518@ha */
/* 806C4DF8  C0 68 75 18 */	lfs f3, lit_3941@l(r8)  /* 0x806C7518@l */
/* 806C4DFC  FC 80 18 90 */	fmr f4, f3
/* 806C4E00  39 00 00 00 */	li r8, 0
/* 806C4E04  4B BE 77 09 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
