...
/* 806C4F1C  4B C9 D2 B9 */	bl _savegpr_27
/* 806C4F20  7C 7C 1B 78 */	mr r28, r3
/* 806C4F24  3C 80 80 6C */	lis r4, lit_3906@ha /* 0x806C74E8@ha */
/* 806C4F28  3B C4 74 E8 */	addi r30, r4, lit_3906@l /* 0x806C74E8@l */
/* 806C4F2C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C4F30  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806C4FB8  4B 95 69 51 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 806C4FD0  4B A9 C5 01 */	bl Stop__9dCamera_cFv
...
/* 806C4FF4  4B A9 E0 19 */	bl SetTrimSize__9dCamera_cFl
...
/* 806C511C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806C5120  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806C5124  80 63 00 00 */	lwz r3, 0(r3)
/* 806C5128  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 806C512C  38 80 00 01 */	li r4, 1
/* 806C5130  4B BE F0 35 */	bl setBattleBgmOff__8Z2SeqMgrFb
/* 806C5134  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C5138  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C513C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 806C5140  7F 84 E3 78 */	mr r4, r28
/* 806C5144  3C A0 80 04 */	lis r5, dEv_noFinishSkipProc__FPvi@ha /* 0x800428DC@ha */
/* 806C5148  38 A5 28 DC */	addi r5, r5, dEv_noFinishSkipProc__FPvi@l /* 0x800428DC@l */
/* 806C514C  38 C0 00 00 */	li r6, 0
/* 806C5150  4B 97 D7 C5 */	bl setSkipProc__14dEvt_control_cFPvPFPvi_ii
/* 806C5154  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C5158  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806C516C  4B 97 00 95 */	bl onSwitch__10dSv_info_cFii
lbl_806C5170:
...
/* 806C51D0  4B BA A8 6D */	bl cLib_addCalc2__FPffff
lbl_806C51D4:
...
/* 806C5314  4B BA A7 29 */	bl cLib_addCalc2__FPffff
lbl_806C5318:
...
/* 806C53F8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806C53FC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806C5428  4B BE 65 5D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806C5600  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806C5604  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 806C5630  4B BE 63 55 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806C5664  4B BA A3 D9 */	bl cLib_addCalc2__FPffff
...
/* 806C5684  4B BA A3 B9 */	bl cLib_addCalc2__FPffff
lbl_806C5688:
...
/* 806C5704  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806C5708  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806C570C  80 63 00 00 */	lwz r3, 0(r3)
/* 806C5710  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 806C5714  38 80 00 00 */	li r4, 0
/* 806C5718  4B BE EA 4D */	bl setBattleBgmOff__8Z2SeqMgrFb
...
/* 806C573C  4B 95 61 CD */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 806C5754  4B A9 BD 7D */	bl Stop__9dCamera_cFv
...
/* 806C5778  4B A9 D8 95 */	bl SetTrimSize__9dCamera_cFl
lbl_806C577C:
...
/* 806C5830  4B AB B3 E9 */	bl Reset__9dCamera_cF4cXyz4cXyz
/* 806C5834  38 7D 02 48 */	addi r3, r29, 0x248
/* 806C5838  4B A9 BC 75 */	bl Start__9dCamera_cFv
/* 806C583C  38 7D 02 48 */	addi r3, r29, 0x248
/* 806C5840  38 80 00 00 */	li r4, 0
/* 806C5844  4B A9 D7 C9 */	bl SetTrimSize__9dCamera_cFl
/* 806C5848  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C584C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C5850  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 806C5854  4B 97 CC 15 */	bl reset__14dEvt_control_cFv
...
/* 806C58C4  4B AB B2 1D */	bl Set__9dCamera_cF4cXyz4cXyzfs
...
/* 806C58E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C58E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C58E8  3B A3 4E C8 */	addi r29, r3, 0x4ec8
/* 806C58EC  7F A3 EB 78 */	mr r3, r29
/* 806C58F0  7F 84 E3 78 */	mr r4, r28
/* 806C58F4  3C A0 80 04 */	lis r5, dEv_defaultSkipProc__FPvi@ha /* 0x800425E8@ha */
/* 806C58F8  38 A5 25 E8 */	addi r5, r5, dEv_defaultSkipProc__FPvi@l /* 0x800425E8@l */
/* 806C58FC  38 C0 00 00 */	li r6, 0
/* 806C5900  4B 97 D0 15 */	bl setSkipProc__14dEvt_control_cFPvPFPvi_ii
...
/* 806C5918  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806C591C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806C5920  80 63 00 00 */	lwz r3, 0(r3)
/* 806C5924  A8 9B 04 E6 */	lha r4, 0x4e6(r27)
/* 806C5928  4B 94 6A B5 */	bl mDoMtx_YrotS__FPA4_fs
...
/* 806C59C4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 806C59C8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
/* 806C59CC  80 63 00 00 */	lwz r3, 0(r3)
/* 806C59D0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 806C59D4  38 80 00 00 */	li r4, 0
/* 806C59D8  4B BE E7 8D */	bl setBattleBgmOff__8Z2SeqMgrFb
lbl_806C59DC:
/* 806C59DC  39 61 00 80 */	addi r11, r1, 0x80
/* 806C59E0  4B C9 C8 41 */	bl _restgpr_27
