...
/* 806C1D5C  4B CA 04 81 */	bl _savegpr_29
...
/* 806C1D74  3C 60 80 6C */	lis r3, d_a_e_gb__stringBase0@ha /* 0x806C76B8@ha */
/* 806C1D78  38 63 76 B8 */	addi r3, r3, d_a_e_gb__stringBase0@l /* 0x806C76B8@l */
/* 806C1D7C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C1D80  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C1D84  3C A5 00 02 */	addis r5, r5, 2
/* 806C1D88  38 C0 00 80 */	li r6, 0x80
/* 806C1D8C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806C1D90  4B 97 A5 5D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806C1DA8  3C C0 80 6C */	lis r6, lit_3907@ha /* 0x806C74EC@ha */
/* 806C1DAC  C0 66 74 EC */	lfs f3, lit_3907@l(r6)  /* 0x806C74EC@l */
/* 806C1DB0  3C C0 80 6C */	lis r6, lit_3941@ha /* 0x806C7518@ha */
/* 806C1DB4  C0 86 75 18 */	lfs f4, lit_3941@l(r6)  /* 0x806C7518@l */
/* 806C1DB8  38 C0 00 00 */	li r6, 0
/* 806C1DBC  4B 94 E5 C1 */	bl setAnm__14mDoExt_McaMorfFP15J3DAnmTransformiffffPv
...
/* 806C1DD8  4B CA 04 51 */	bl _restgpr_29
