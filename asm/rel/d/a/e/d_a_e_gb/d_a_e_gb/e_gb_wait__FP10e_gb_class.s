...
/* 806C2090  4B CA 01 49 */	bl _savegpr_28
/* 806C2094  7C 7D 1B 78 */	mr r29, r3
/* 806C2098  3C 60 80 6C */	lis r3, lit_3906@ha /* 0x806C74E8@ha */
/* 806C209C  3B E3 74 E8 */	addi r31, r3, lit_3906@l /* 0x806C74E8@l */
/* 806C20A0  38 61 00 0C */	addi r3, r1, 0xc
/* 806C20A4  38 9D 04 A8 */	addi r4, r29, 0x4a8
/* 806C20A8  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806C20AC  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806C20B0  80 A5 5D AC */	lwz r5, 0x5dac(r5)
/* 806C20B4  38 A5 04 D0 */	addi r5, r5, 0x4d0
/* 806C20B8  4B BA 4A 7D */	bl __mi__4cXyzCFRC3Vec
/* 806C20BC  38 61 00 0C */	addi r3, r1, 0xc
/* 806C20C0  4B C8 50 79 */	bl PSVECSquareMag
...
/* 806C2130  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806C2134  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806C21A0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 806C21A4  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 806C21F4  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C7938@ha */
/* 806C21F8  3B 83 79 38 */	addi r28, r3, l_HIO@l /* 0x806C7938@l */
...
/* 806C221C  4B BA 57 39 */	bl cM_rndF__Ff
...
/* 806C2288  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C7938@ha */
/* 806C228C  3B 83 79 38 */	addi r28, r3, l_HIO@l /* 0x806C7938@l */
...
/* 806C22B0  4B BA 56 A5 */	bl cM_rndF__Ff
...
/* 806C2368  4B BA 55 ED */	bl cM_rndF__Ff
...
/* 806C2384  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806C2388  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806C238C  80 63 00 00 */	lwz r3, 0(r3)
/* 806C2390  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 806C2394  4B 94 A0 49 */	bl mDoMtx_YrotS__FPA4_fs
/* 806C2398  C0 3F 00 00 */	lfs f1, 0(r31)
/* 806C239C  4B BA 55 F1 */	bl cM_rndFX__Ff
/* 806C23A0  D0 21 00 24 */	stfs f1, 0x24(r1)
/* 806C23A4  C0 3F 00 00 */	lfs f1, 0(r31)
/* 806C23A8  4B BA 55 E5 */	bl cM_rndFX__Ff
/* 806C23AC  C0 5F 00 48 */	lfs f2, 0x48(r31)
/* 806C23B0  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806C7938@ha */
/* 806C23B4  38 63 79 38 */	addi r3, r3, l_HIO@l /* 0x806C7938@l */
...
/* 806C23CC  4B BA 55 C1 */	bl cM_rndFX__Ff
...
/* 806C2428  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806C242C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806C2484  4B BA D5 B9 */	bl cLib_addCalc2__FPffff
...
/* 806C24A8  4B BA D5 95 */	bl cLib_addCalc2__FPffff
...
/* 806C24CC  4B BA D5 71 */	bl cLib_addCalc2__FPffff
...
/* 806C24E0  4B BA D5 5D */	bl cLib_addCalc2__FPffff
lbl_806C24E4:
...
/* 806C24F4  4B BA E1 15 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806C2508  4B BA E1 01 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806C251C  4B BA E0 ED */	bl cLib_addCalcAngleS2__FPssss
...
/* 806C254C  4B C9 FC D9 */	bl _restgpr_28
