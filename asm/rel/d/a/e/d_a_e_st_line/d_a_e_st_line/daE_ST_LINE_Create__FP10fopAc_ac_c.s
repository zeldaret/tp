...
/* 807A708C  4B BB B1 51 */	bl _savegpr_29
/* 807A7090  7C 7E 1B 78 */	mr r30, r3
/* 807A7094  3C 80 80 7A */	lis r4, lit_3704@ha /* 0x807A722C@ha */
/* 807A7098  3B E4 72 2C */	addi r31, r4, lit_3704@l /* 0x807A722C@l */
...
/* 807A70B4  4B 87 1A B1 */	bl __ct__10fopAc_ac_cFv
/* 807A70B8  3C 60 80 7A */	lis r3, __vt__18mDoExt_3DlineMat_c@ha /* 0x807A72F4@ha */
/* 807A70BC  38 03 72 F4 */	addi r0, r3, __vt__18mDoExt_3DlineMat_c@l /* 0x807A72F4@l */
/* 807A70C0  90 1D 05 B4 */	stw r0, 0x5b4(r29)
/* 807A70C4  3C 60 80 3A */	lis r3, __vt__19mDoExt_3DlineMat0_c@ha /* 0x803A325C@ha */
/* 807A70C8  38 03 32 5C */	addi r0, r3, __vt__19mDoExt_3DlineMat0_c@l /* 0x803A325C@l */
/* 807A70CC  90 1D 05 B4 */	stw r0, 0x5b4(r29)
/* 807A70D0  38 7D 05 DC */	addi r3, r29, 0x5dc
/* 807A70D4  3C 80 80 7A */	lis r4, __ct__4cXyzFv@ha /* 0x807A7220@ha */
/* 807A70D8  38 84 72 20 */	addi r4, r4, __ct__4cXyzFv@l /* 0x807A7220@l */
/* 807A70DC  3C A0 80 7A */	lis r5, __dt__4cXyzFv@ha /* 0x807A6F60@ha */
/* 807A70E0  38 A5 6F 60 */	addi r5, r5, __dt__4cXyzFv@l /* 0x807A6F60@l */
/* 807A70E4  38 C0 00 0C */	li r6, 0xc
/* 807A70E8  38 E0 00 40 */	li r7, 0x40
/* 807A70EC  4B BB AC 75 */	bl __construct_array
/* 807A70F0  38 7D 08 DC */	addi r3, r29, 0x8dc
/* 807A70F4  3C 80 80 7A */	lis r4, __ct__4cXyzFv@ha /* 0x807A7220@ha */
/* 807A70F8  38 84 72 20 */	addi r4, r4, __ct__4cXyzFv@l /* 0x807A7220@l */
/* 807A70FC  3C A0 80 7A */	lis r5, __dt__4cXyzFv@ha /* 0x807A6F60@ha */
/* 807A7100  38 A5 6F 60 */	addi r5, r5, __dt__4cXyzFv@l /* 0x807A6F60@l */
/* 807A7104  38 C0 00 0C */	li r6, 0xc
/* 807A7108  38 E0 00 32 */	li r7, 0x32
/* 807A710C  4B BB AC 55 */	bl __construct_array
/* 807A7110  38 7D 0C D4 */	addi r3, r29, 0xcd4
/* 807A7114  4B B1 77 31 */	bl __ct__16Z2SoundObjSimpleFv
lbl_807A7118:
...
/* 807A7128  3C 80 80 7A */	lis r4, d_a_e_st_line__stringBase0@ha /* 0x807A729C@ha */
/* 807A712C  38 84 72 9C */	addi r4, r4, d_a_e_st_line__stringBase0@l /* 0x807A729C@l */
/* 807A7130  4B 88 5D 8D */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 807A7144  3C 80 80 7A */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x807A7008@ha */
/* 807A7148  38 84 70 08 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x807A7008@l */
/* 807A714C  38 A0 0F 40 */	li r5, 0xf40
/* 807A7150  4B 87 33 61 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 807A7168  4B AC 07 ED */	bl cM_rndF__Ff
...
/* 807A71B8  4B AC 07 D5 */	bl cM_rndFX__Ff
...
/* 807A720C  4B BB B0 1D */	bl _restgpr_29
