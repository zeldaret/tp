...
/* 80800B28  4B B6 16 A5 */	bl _savegpr_25
...
/* 80800B64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80800B68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80800B6C  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80800B70  C0 5E 00 04 */	lfs f2, 4(r30)
/* 80800B74  C0 7E 00 08 */	lfs f3, 8(r30)
/* 80800B78  4B B4 5D 71 */	bl PSMTXTrans
/* 80800B7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80800B80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80800B84  A8 9D 00 02 */	lha r4, 2(r29)
/* 80800B88  4B 80 B8 AD */	bl mDoMtx_YrotM__FPA4_fs
/* 80800B8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80800B90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80800B94  A8 9D 00 00 */	lha r4, 0(r29)
/* 80800B98  4B 80 B8 05 */	bl mDoMtx_XrotM__FPA4_fs
/* 80800B9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80800BA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80800BA4  7F 44 07 34 */	extsh r4, r26
/* 80800BA8  4B 80 B9 25 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80800BAC  3C 60 80 80 */	lis r3, lit_3904@ha /* 0x80804284@ha */
/* 80800BB0  C0 43 42 84 */	lfs f2, lit_3904@l(r3)  /* 0x80804284@l */
...
/* 80800BE0  4B 80 C2 59 */	bl scaleM__14mDoMtx_stack_cFfff
...
/* 80800BF4  4B 80 C2 45 */	bl scaleM__14mDoMtx_stack_cFfff
lbl_80800BF8:
/* 80800BF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80800BFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80800C00  80 9F 07 78 */	lwz r4, 0x778(r31)
/* 80800C04  38 84 00 24 */	addi r4, r4, 0x24
/* 80800C08  4B B4 58 A9 */	bl PSMTXCopy
lbl_80800C0C:
...
/* 80800C2C  4B B6 15 ED */	bl _restgpr_25
