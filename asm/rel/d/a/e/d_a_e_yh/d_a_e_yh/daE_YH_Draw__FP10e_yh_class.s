...
/* 807FD850  4B B6 49 85 */	bl _savegpr_27
/* 807FD854  7C 7F 1B 78 */	mr r31, r3
/* 807FD858  3C 60 80 80 */	lis r3, lit_3902@ha /* 0x8080427C@ha */
/* 807FD85C  3B A3 42 7C */	addi r29, r3, lit_3902@l /* 0x8080427C@l */
/* 807FD860  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807FD864  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 807FD868  38 80 00 02 */	li r4, 2
/* 807FD86C  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 807FD870  38 DF 01 0C */	addi r6, r31, 0x10c
/* 807FD874  4B 9A 5F 51 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 807FD878  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 807FD87C  83 C3 00 04 */	lwz r30, 4(r3)
/* 807FD880  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807FD884  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 807FD888  80 9E 00 04 */	lwz r4, 4(r30)
/* 807FD88C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 807FD890  4B 9A 75 11 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 807FD8A4  4B 80 FF 05 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 807FD8A8  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 807FD8AC  4B 81 39 15 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 807FD8F4  3C E0 80 45 */	lis r7, mGroundY__11fopAcM_gc_c@ha /* 0x80450CD0@ha */
/* 807FD8F8  C0 87 0C D0 */	lfs f4, mGroundY__11fopAcM_gc_c@l(r7)  /* 0x80450CD0@l */
/* 807FD8FC  3C E0 80 3F */	lis r7, mGndCheck__11fopAcM_gc_c@ha /* 0x803F1CC4@ha */
/* 807FD900  38 E7 1C C4 */	addi r7, r7, mGndCheck__11fopAcM_gc_c@l /* 0x803F1CC4@l */
...
/* 807FD914  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 807FD918  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 807FD91C  4B 83 0F F5 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 807FD920  90 7F 06 68 */	stw r3, 0x668(r31)
lbl_807FD924:
/* 807FD924  38 7F 08 08 */	addi r3, r31, 0x808
/* 807FD928  38 80 00 0C */	li r4, 0xc
/* 807FD92C  3C A0 80 80 */	lis r5, l_color@ha /* 0x80804420@ha */
/* 807FD930  38 A5 44 20 */	addi r5, r5, l_color@l /* 0x80804420@l */
/* 807FD934  38 DF 01 0C */	addi r6, r31, 0x10c
/* 807FD938  4B 81 66 79 */	bl update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 807FD954  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 807FD958  38 03 61 C0 */	addi r0, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 807FD970  4B 81 6D C9 */	bl setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
/* 807FD974  3B 60 00 01 */	li r27, 1
/* 807FD978  3B C0 00 04 */	li r30, 4
/* 807FD97C  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 807FD980  3B A3 CA 54 */	addi r29, r3, g_env_light@l /* 0x8042CA54@l */
lbl_807FD984:
...
/* 807FD9A0  4B 9A 74 01 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 807FD9A4  7C 7F E0 2E */	lwzx r3, r31, r28
/* 807FD9A8  4B 81 03 1D */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_807FD9AC:
...
/* 807FD9C4  4B B6 48 5D */	bl _restgpr_27
