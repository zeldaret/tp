...
/* 80803DEC  4B B5 E3 C9 */	bl _savegpr_19
/* 80803DF0  7C 7E 1B 78 */	mr r30, r3
/* 80803DF4  7C 9A 23 78 */	mr r26, r4
/* 80803DF8  7C BB 2B 78 */	mr r27, r5
/* 80803DFC  7C DC 33 78 */	mr r28, r6
/* 80803E00  3C 60 80 80 */	lis r3, cNullVec__6Z2Calc@ha /* 0x808043E8@ha */
/* 80803E04  3A E3 43 E8 */	addi r23, r3, cNullVec__6Z2Calc@l /* 0x808043E8@l */
/* 80803E08  3C 60 80 80 */	lis r3, lit_3902@ha /* 0x8080427C@ha */
/* 80803E0C  3B E3 42 7C */	addi r31, r3, lit_3902@l /* 0x8080427C@l */
/* 80803E10  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80803E14  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80803E18  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80803E1C  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 80803E20  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)  /* 0x80451018@l */
...
/* 80803E48  4B 9A 87 35 */	bl dKy_darkworld_check__Fv
...
/* 80803E6C  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 80803E70  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l /* 0x80451018@l */
...
/* 80803E88  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80803E8C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80803E90  4B B4 26 21 */	bl PSMTXCopy
...
/* 80803EA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80803EAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80803EB0  38 81 00 4C */	addi r4, r1, 0x4c
/* 80803EB4  38 A1 00 58 */	addi r5, r1, 0x58
/* 80803EB8  4B B4 2E B5 */	bl PSMTXMultVec
/* 80803EBC  38 61 00 34 */	addi r3, r1, 0x34
/* 80803EC0  38 81 00 58 */	addi r4, r1, 0x58
/* 80803EC4  7F 65 DB 78 */	mr r5, r27
/* 80803EC8  4B A6 2C 6D */	bl __mi__4cXyzCFRC3Vec
...
/* 80803EE4  4B A6 37 91 */	bl cM_atan2s__Fff
...
/* 80803F18  4B A6 37 5D */	bl cM_atan2s__Fff
...
/* 80803F34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80803F38  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80803F88  4B 84 8B 09 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80803F8C  7C 79 1B 79 */	or. r25, r3, r3
/* 80803F90  41 82 00 FC */	beq lbl_8080408C
/* 80803F94  38 61 00 40 */	addi r3, r1, 0x40
/* 80803F98  4B B4 31 A1 */	bl PSVECSquareMag
...
/* 80804008  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080400C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80804078  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8080407C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80804080:
...
/* 808040D0  4B 84 89 C1 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8080410C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80804110  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8080417C  4B 84 93 51 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 808041DC  4B B5 E0 25 */	bl _restgpr_19
