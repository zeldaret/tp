...
/* 8081CE7C  4B B4 53 55 */	bl _savegpr_26
/* 8081CE80  7C 7D 1B 78 */	mr r29, r3
/* 8081CE84  3C 80 80 82 */	lis r4, lit_3791@ha /* 0x808218AC@ha */
/* 8081CE88  3B E4 18 AC */	addi r31, r4, lit_3791@l /* 0x808218AC@l */
/* 8081CE8C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8081CE90  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8081CFFC  3C 60 80 82 */	lis r3, l_HIO@ha /* 0x80821E64@ha */
/* 8081D000  38 63 1E 64 */	addi r3, r3, l_HIO@l /* 0x80821E64@l */
...
/* 8081D03C  4B 81 0A 61 */	bl dComIfGs_onOneZoneSwitch__Fii
...
/* 8081D144  4B A4 B0 91 */	bl ChkUsed__9cBgW_BgIdCFv
/* 8081D148  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8081D14C  40 82 00 1C */	bne lbl_8081D168
/* 8081D150  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8081D154  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8081D158  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8081D15C  80 9D 07 98 */	lwz r4, 0x798(r29)
/* 8081D160  7F A5 EB 78 */	mr r5, r29
/* 8081D164  4B 85 78 A5 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
lbl_8081D168:
...
/* 8081D17C  4B A5 33 C5 */	bl cLib_addCalcAngleS__FPsssss
...
/* 8081D1B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8081D1BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8081D1C0  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8081D1C4  4B 85 70 8D */	bl Release__4cBgSFP9dBgW_Base
lbl_8081D1C8:
...
/* 8081D230  4B 81 08 D1 */	bl dComIfGs_offOneZoneSwitch__Fii
lbl_8081D234:
...
/* 8081D2EC  4B A4 AE E9 */	bl ChkUsed__9cBgW_BgIdCFv
/* 8081D2F0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8081D2F4  41 82 00 18 */	beq lbl_8081D30C
/* 8081D2F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8081D2FC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8081D300  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8081D304  80 9D 07 98 */	lwz r4, 0x798(r29)
/* 8081D308  4B 85 6F 49 */	bl Release__4cBgSFP9dBgW_Base
lbl_8081D30C:
...
/* 8081D338  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8081D33C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8081D340  4B B2 91 71 */	bl PSMTXCopy
/* 8081D344  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8081D348  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 8081D390  4B B2 A0 0D */	bl PSVECSquareDistance
...
/* 8081D400  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081D404  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8081D470  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081D474  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8081D478:
...
/* 8081D4BC  4B 81 06 45 */	bl dComIfGs_offOneZoneSwitch__Fii
lbl_8081D4C0:
/* 8081D4C0  39 61 00 60 */	addi r11, r1, 0x60
/* 8081D4C4  4B B4 4D 59 */	bl _restgpr_26
