...
/* 80817FEC  4B B4 A1 E1 */	bl _savegpr_25
/* 80817FF0  7C 7E 1B 78 */	mr r30, r3
/* 80817FF4  3C 60 80 82 */	lis r3, lit_1109@ha /* 0x80821E18@ha */
/* 80817FF8  3B E3 1E 18 */	addi r31, r3, lit_1109@l /* 0x80821E18@l */
...
/* 80818010  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80818014  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80818018  4B B2 E4 99 */	bl PSMTXCopy
/* 8081801C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80818020  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80818060  3C 80 80 81 */	lis r4, __dt__4cXyzFv@ha /* 0x808164B4@ha */
/* 80818064  38 84 64 B4 */	addi r4, r4, __dt__4cXyzFv@l /* 0x808164B4@l */
...
/* 80818080  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80818084  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80818088  3C 60 80 82 */	lis r3, w_eff_id_4777@ha /* 0x80821C94@ha */
/* 8081808C  3B 63 1C 94 */	addi r27, r3, w_eff_id_4777@l /* 0x80821C94@l */
/* 80818090  3C 60 80 82 */	lis r3, lit_3791@ha /* 0x808218AC@ha */
/* 80818094  3B 83 18 AC */	addi r28, r3, lit_3791@l /* 0x808218AC@l */
lbl_80818098:
...
/* 808180D8  4B 83 49 B9 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 808180F4  4B 81 4F 79 */	bl dComIfGp_getReverb__Fi
...
/* 80818108  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 8081810C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80818120  3D 00 80 82 */	lis r8, lit_3791@ha /* 0x808218AC@ha */
/* 80818124  C0 28 18 AC */	lfs f1, lit_3791@l(r8)  /* 0x808218AC@l */
/* 80818128  FC 40 08 90 */	fmr f2, f1
/* 8081812C  3D 00 80 82 */	lis r8, lit_4083@ha /* 0x808218E0@ha */
/* 80818130  C0 68 18 E0 */	lfs f3, lit_4083@l(r8)  /* 0x808218E0@l */
/* 80818134  FC 80 18 90 */	fmr f4, f3
/* 80818138  39 00 00 00 */	li r8, 0
/* 8081813C  4B A9 38 49 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80818140  39 61 00 50 */	addi r11, r1, 0x50
/* 80818144  4B B4 A0 D5 */	bl _restgpr_25
