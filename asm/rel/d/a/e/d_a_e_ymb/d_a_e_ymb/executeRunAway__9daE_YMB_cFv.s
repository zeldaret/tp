...
/* 80819FE0  4B B4 81 F9 */	bl _savegpr_28
/* 80819FE4  7C 7D 1B 78 */	mr r29, r3
/* 80819FE8  3C 80 80 82 */	lis r4, lit_3791@ha /* 0x808218AC@ha */
/* 80819FEC  3B C4 18 AC */	addi r30, r4, lit_3791@l /* 0x808218AC@l */
/* 80819FF0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80819FF4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8081A014  4B 80 06 FD */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8081A0D8  4B B2 D2 C5 */	bl PSVECSquareDistance
...
/* 8081A148  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081A14C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8081A1B8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081A1BC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8081A1C0:
...
/* 8081A1D4  4B A5 6A 31 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8081A214  4B B2 D1 89 */	bl PSVECSquareDistance
...
/* 8081A284  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081A288  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8081A2F4  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081A2F8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8081A2FC:
...
/* 8081A30C  4B A4 D6 81 */	bl cM_rndFX__Ff
...
/* 8081A350  4B A5 68 B5 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8081A374  4B A4 D6 19 */	bl cM_rndFX__Ff
...
/* 8081A3B0  4B A4 D4 BD */	bl cM_rnd__Fv
...
/* 8081A3F0  4B A5 69 D1 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 8081A404  4B A5 68 01 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 8081A408  B0 7D 04 DE */	sth r3, 0x4de(r29)
/* 8081A40C  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 8081A410  38 9D 06 A8 */	addi r4, r29, 0x6a8
/* 8081A414  4B A5 68 61 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 8081A448  4B A5 67 BD */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 8081A44C  B0 7D 04 DE */	sth r3, 0x4de(r29)
/* 8081A450  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 8081A454  38 9D 06 A8 */	addi r4, r29, 0x6a8
/* 8081A458  4B A5 68 1D */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 8081A45C  B0 7D 04 DC */	sth r3, 0x4dc(r29)
/* 8081A460  38 7D 06 C8 */	addi r3, r29, 0x6c8
/* 8081A464  3C 80 80 82 */	lis r4, l_HIO@ha /* 0x80821E64@ha */
/* 8081A468  38 84 1E 64 */	addi r4, r4, l_HIO@l /* 0x80821E64@l */
/* 8081A46C  C0 24 00 14 */	lfs f1, 0x14(r4)
/* 8081A470  C0 5E 00 90 */	lfs f2, 0x90(r30)
/* 8081A474  4B A5 62 CD */	bl cLib_chaseF__FPfff
/* 8081A478  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8081A47C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8081A4A8  4B A5 62 99 */	bl cLib_chaseF__FPfff
/* 8081A4AC  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 8081A4B0  38 81 00 6C */	addi r4, r1, 0x6c
/* 8081A4B4  4B A5 67 51 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 8081A4B8  7C 64 1B 78 */	mr r4, r3
/* 8081A4BC  38 7D 04 E6 */	addi r3, r29, 0x4e6
/* 8081A4C0  38 A0 04 00 */	li r5, 0x400
/* 8081A4C4  4B A5 66 CD */	bl cLib_chaseAngleS__FPsss
/* 8081A4C8  A8 1D 04 DC */	lha r0, 0x4dc(r29)
/* 8081A4CC  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 8081A4D0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8081A4D4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8081A4EC  4B A5 62 55 */	bl cLib_chaseF__FPfff
...
/* 8081A52C  4B B2 CE 71 */	bl PSVECSquareDistance
...
/* 8081A59C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081A5A0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 8081A60C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081A610  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_8081A614:
...
/* 8081A704  4B B4 7B 21 */	bl _restgpr_28
