...
/* 8082132C  4B 86 26 FD */	bl __ct__12dCcD_GObjInfFv
/* 80821330  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 80821334  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 80821338  90 1F 01 20 */	stw r0, 0x120(r31)
/* 8082133C  3C 60 80 82 */	lis r3, __vt__8cM3dGAab@ha /* 0x80821DE8@ha */
/* 80821340  38 03 1D E8 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x80821DE8@l */
/* 80821344  90 1F 01 1C */	stw r0, 0x11c(r31)
/* 80821348  3C 60 80 82 */	lis r3, __vt__8cM3dGSph@ha /* 0x80821DDC@ha */
/* 8082134C  38 03 1D DC */	addi r0, r3, __vt__8cM3dGSph@l /* 0x80821DDC@l */
/* 80821350  90 1F 01 34 */	stw r0, 0x134(r31)
/* 80821354  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha /* 0x803C3540@ha */
/* 80821358  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 0x803C3540@l */
/* 8082135C  90 7F 01 20 */	stw r3, 0x120(r31)
/* 80821360  38 03 00 58 */	addi r0, r3, 0x58
/* 80821364  90 1F 01 34 */	stw r0, 0x134(r31)
/* 80821368  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha /* 0x803ABFC0@ha */
/* 8082136C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l /* 0x803ABFC0@l */
