...
/* 8081616C  4B B4 C0 65 */	bl _savegpr_26
/* 80816170  7C 7A 1B 78 */	mr r26, r3
/* 80816174  7C BB 2B 78 */	mr r27, r5
/* 80816178  3C 60 80 82 */	lis r3, lit_3791@ha /* 0x808218AC@ha */
/* 8081617C  3B C3 18 AC */	addi r30, r3, lit_3791@l /* 0x808218AC@l */
...
/* 80816194  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80816198  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8081619C  4B B3 03 15 */	bl PSMTXCopy
...
/* 808161E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 808161E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80816204  4B 7F 69 FD */	bl mDoMtx_MtxToRot__FPA4_CfP5csXyz
...
/* 80816248  4B 7F 6B 1D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8081624C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80816250  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 80816268  4B 7F 60 39 */	bl mDoMtx_ZXYrotM__FPA4_fsss
/* 8081626C  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80816270  FC 40 08 90 */	fmr f2, f1
/* 80816274  FC 60 08 90 */	fmr f3, f1
/* 80816278  4B 7F 6B C1 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8081627C  48 00 01 F0 */	b lbl_8081646C
lbl_80816280:
/* 80816280  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80816284  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 808162A8  4B 7F 69 59 */	bl mDoMtx_MtxToRot__FPA4_CfP5csXyz
...
/* 808162C0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 808162C4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 808162C8  4B B3 01 E9 */	bl PSMTXCopy
/* 808162CC  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 808162D0  C0 5E 00 18 */	lfs f2, 0x18(r30)
/* 808162D4  FC 60 10 90 */	fmr f3, f2
/* 808162D8  4B 7F 6A C5 */	bl transM__14mDoMtx_stack_cFfff
...
/* 808162F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 808162F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 808162FC  38 81 00 08 */	addi r4, r1, 8
/* 80816300  4B 7F 69 01 */	bl mDoMtx_MtxToRot__FPA4_CfP5csXyz
...
/* 80816450  4B 7F 69 15 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80816454  38 61 00 10 */	addi r3, r1, 0x10
/* 80816458  4B 7F 6A ED */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8081645C  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80816460  FC 40 08 90 */	fmr f2, f1
/* 80816464  FC 60 08 90 */	fmr f3, f1
/* 80816468  4B 7F 69 D1 */	bl scaleM__14mDoMtx_stack_cFfff
lbl_8081646C:
/* 8081646C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80816470  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80816474  80 9B 00 84 */	lwz r4, 0x84(r27)
/* 80816478  80 04 00 0C */	lwz r0, 0xc(r4)
/* 8081647C  7C 80 E2 14 */	add r4, r0, r28
/* 80816480  4B B3 00 31 */	bl PSMTXCopy
/* 80816484  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80816488  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8081648C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha /* 0x80434BE4@ha */
/* 80816490  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 0x80434BE4@l */
/* 80816494  4B B3 00 1D */	bl PSMTXCopy
/* 80816498  38 60 00 01 */	li r3, 1
/* 8081649C  39 61 00 C0 */	addi r11, r1, 0xc0
/* 808164A0  4B B4 BD 7D */	bl _restgpr_26
