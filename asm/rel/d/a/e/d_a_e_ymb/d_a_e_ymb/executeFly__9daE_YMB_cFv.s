...
/* 80818B00  4B B4 96 D9 */	bl _savegpr_28
/* 80818B04  7C 7D 1B 78 */	mr r29, r3
/* 80818B08  3C 80 80 82 */	lis r4, lit_3791@ha /* 0x808218AC@ha */
/* 80818B0C  3B C4 18 AC */	addi r30, r4, lit_3791@l /* 0x808218AC@l */
/* 80818B10  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80818B14  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80818B34  4B 80 1B DD */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80818C58  4B B2 E7 45 */	bl PSVECSquareDistance
...
/* 80818CC8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80818CCC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80818D38  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80818D3C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80818D7C  4B B2 E6 21 */	bl PSVECSquareDistance
...
/* 80818DEC  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80818DF0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80818E5C  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80818E60  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80818E64:
...
/* 80818EA8  4B A5 7D 5D */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80818EC4  4B A4 EA C9 */	bl cM_rndFX__Ff
...
/* 80818F08  4B A5 7C FD */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80818F2C  4B A4 EA 61 */	bl cM_rndFX__Ff
...
/* 80818F68  4B A4 E9 05 */	bl cM_rnd__Fv
...
/* 80818FA8  4B A5 7E 19 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 80818FBC  4B A5 7C 49 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80818FC0  B0 7D 04 DE */	sth r3, 0x4de(r29)
/* 80818FC4  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80818FC8  38 9D 06 A8 */	addi r4, r29, 0x6a8
/* 80818FCC  4B A5 7C A9 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 80819034  4B A5 7B D1 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80819038  B0 7D 04 DE */	sth r3, 0x4de(r29)
/* 8081903C  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80819040  38 9D 06 A8 */	addi r4, r29, 0x6a8
/* 80819044  4B A5 7C 31 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 8081905C  3C 80 80 82 */	lis r4, l_HIO@ha /* 0x80821E64@ha */
/* 80819060  38 84 1E 64 */	addi r4, r4, l_HIO@l /* 0x80821E64@l */
/* 80819064  C0 24 00 0C */	lfs f1, 0xc(r4)
/* 80819068  C0 5E 00 00 */	lfs f2, 0(r30)
/* 8081906C  4B A5 76 D5 */	bl cLib_chaseF__FPfff
/* 80819070  48 00 00 24 */	b lbl_80819094
lbl_80819074:
/* 80819074  38 7D 06 C8 */	addi r3, r29, 0x6c8
/* 80819078  C0 3E 00 04 */	lfs f1, 4(r30)
/* 8081907C  3C 80 80 82 */	lis r4, l_HIO@ha /* 0x80821E64@ha */
/* 80819080  38 84 1E 64 */	addi r4, r4, l_HIO@l /* 0x80821E64@l */
/* 80819084  C0 04 00 0C */	lfs f0, 0xc(r4)
/* 80819088  EC 21 00 2A */	fadds f1, f1, f0
/* 8081908C  C0 5E 00 00 */	lfs f2, 0(r30)
/* 80819090  4B A5 76 B1 */	bl cLib_chaseF__FPfff
lbl_80819094:
/* 80819094  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 80819098  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 808190C4  4B A5 76 7D */	bl cLib_chaseF__FPfff
/* 808190C8  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 808190CC  38 81 00 A4 */	addi r4, r1, 0xa4
/* 808190D0  4B A5 7B 35 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 808190D4  7C 64 1B 78 */	mr r4, r3
/* 808190D8  38 7D 04 E6 */	addi r3, r29, 0x4e6
/* 808190DC  38 A0 04 00 */	li r5, 0x400
/* 808190E0  4B A5 7A B1 */	bl cLib_chaseAngleS__FPsss
/* 808190E4  A8 1D 04 DC */	lha r0, 0x4dc(r29)
/* 808190E8  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 808190EC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 808190F0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 80819108  4B A5 76 39 */	bl cLib_chaseF__FPfff
...
/* 80819168  4B B2 E2 35 */	bl PSVECSquareDistance
...
/* 808191D8  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 808191DC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80819248  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081924C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80819250:
...
/* 80819398  4B B2 E0 05 */	bl PSVECSquareDistance
...
/* 80819408  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081940C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 80819478  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 8081947C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_80819480:
...
/* 808194C0  4B B2 DE DD */	bl PSVECSquareDistance
...
/* 80819530  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 80819534  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
...
/* 808195A0  3C 60 80 45 */	lis r3, __float_nan@ha /* 0x80450AE0@ha */
/* 808195A4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)  /* 0x80450AE0@l */
lbl_808195A8:
...
/* 808195FC  4B B4 8C 29 */	bl _restgpr_28
