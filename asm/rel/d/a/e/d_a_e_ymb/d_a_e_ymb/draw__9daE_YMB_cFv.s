...
/* 80816564  4B B4 BC 6D */	bl _savegpr_26
/* 80816568  7C 7A 1B 78 */	mr r26, r3
/* 8081656C  3C 60 80 82 */	lis r3, lit_3791@ha /* 0x808218AC@ha */
/* 80816570  3B E3 18 AC */	addi r31, r3, lit_3791@l /* 0x808218AC@l */
/* 80816574  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80816578  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 8081657C  38 80 00 06 */	li r4, 6
/* 80816580  38 BA 04 D0 */	addi r5, r26, 0x4d0
/* 80816584  38 DA 01 0C */	addi r6, r26, 0x10c
/* 80816588  4B 98 D2 3D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
lbl_808165F8:
/* 808165F8  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 808165FC  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80816600  80 9E 00 04 */	lwz r4, 4(r30)
/* 80816604  38 BA 01 0C */	addi r5, r26, 0x10c
/* 80816608  4B 98 E7 99 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 808166D0  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 808166D4  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 8081673C  3C 80 80 43 */	lis r4, j3dZModeTable@ha /* 0x80437160@ha */
/* 80816740  38 04 71 60 */	addi r0, r4, j3dZModeTable@l /* 0x80437160@l */
...
/* 80816860  4B 7F 6F 49 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80816878  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8081687C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80816880  80 04 5F 88 */	lwz r0, 0x5f88(r4)
/* 80816884  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 80816888  3B 63 4A C8 */	addi r27, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 8081689C  4B 7F A9 25 */	bl entryDL__16mDoExt_McaMorfSOFv
/* 808168A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 808168A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 808168C4  4B 7F 7E FD */	bl entryDL__21mDoExt_invisibleModelFP4cXyz
lbl_808168C8:
...
/* 80816930  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 80816934  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 80816938  4B 81 7F D9 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 8081693C  90 7A 06 BC */	stw r3, 0x6bc(r26)
/* 80816940  38 60 00 01 */	li r3, 1
lbl_80816944:
/* 80816944  39 61 00 50 */	addi r11, r1, 0x50
/* 80816948  4B B4 B8 D5 */	bl _restgpr_26
