...
/* 8072E4C0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8072E4C4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8072E4C8  4B C1 7F E9 */	bl PSMTXCopy
/* 8072E4CC  3C 60 80 73 */	lis r3, lit_4962@ha /* 0x80735BE8@ha */
/* 8072E4D0  C0 03 5B E8 */	lfs f0, lit_4962@l(r3)  /* 0x80735BE8@l */
/* 8072E4D4  D0 01 00 08 */	stfs f0, 8(r1)
/* 8072E4D8  3C 60 80 73 */	lis r3, lit_3912@ha /* 0x80735B2C@ha */
/* 8072E4DC  C0 03 5B 2C */	lfs f0, lit_3912@l(r3)  /* 0x80735B2C@l */
/* 8072E4E0  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 8072E4E4  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8072E4E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8072E4EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 8072E4F0  38 81 00 08 */	addi r4, r1, 8
/* 8072E4F4  38 A1 00 14 */	addi r5, r1, 0x14
/* 8072E4F8  4B C1 88 75 */	bl PSMTXMultVec
