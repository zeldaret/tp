...
/* 8072D650  4B C3 4B 89 */	bl _savegpr_28
/* 8072D654  7C 7E 1B 78 */	mr r30, r3
/* 8072D658  38 61 00 2C */	addi r3, r1, 0x2c
/* 8072D65C  4B 94 A6 0D */	bl __ct__11dBgS_LinChkFv
/* 8072D660  7F C3 F3 78 */	mr r3, r30
/* 8072D664  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8072D668  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8072D66C  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8072D670  4B 8E D0 A1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8072D690  3C 60 80 73 */	lis r3, lit_3911@ha /* 0x80735B28@ha */
/* 8072D694  C0 43 5B 28 */	lfs f2, lit_3911@l(r3)  /* 0x80735B28@l */
...
/* 8072D6D4  4B 94 A6 91 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8072D6D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8072D6DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8072D6E0  3B E3 0F 38 */	addi r31, r3, 0xf38
/* 8072D6E4  7F E3 FB 78 */	mr r3, r31
/* 8072D6E8  38 81 00 2C */	addi r4, r1, 0x2c
/* 8072D6EC  4B 94 6C C9 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8072D700  4B 94 A5 DD */	bl __dt__11dBgS_LinChkFv
...
/* 8072D728  3C 60 80 73 */	lis r3, lit_4463@ha /* 0x80735BCC@ha */
/* 8072D72C  C0 43 5B CC */	lfs f2, lit_4463@l(r3)  /* 0x80735BCC@l */
/* 8072D730  7F BD 07 34 */	extsh r29, r29
/* 8072D734  38 1D 40 00 */	addi r0, r29, 0x4000
/* 8072D738  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 8072D73C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8072D740  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8072D77C  4B 94 A5 E9 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8072D780  7F E3 FB 78 */	mr r3, r31
/* 8072D784  38 81 00 2C */	addi r4, r1, 0x2c
/* 8072D788  4B 94 6C 2D */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8072D79C  4B B4 34 69 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 8072D7A0  B0 7E 06 DA */	sth r3, 0x6da(r30)
/* 8072D7A4  38 61 00 2C */	addi r3, r1, 0x2c
/* 8072D7A8  38 80 FF FF */	li r4, -1
/* 8072D7AC  4B 94 A5 31 */	bl __dt__11dBgS_LinChkFv
/* 8072D7B0  38 60 00 01 */	li r3, 1
/* 8072D7B4  48 00 00 B0 */	b lbl_8072D864
lbl_8072D7B8:
/* 8072D7B8  C0 21 00 08 */	lfs f1, 8(r1)
/* 8072D7BC  3C 60 80 73 */	lis r3, lit_4463@ha /* 0x80735BCC@ha */
/* 8072D7C0  C0 43 5B CC */	lfs f2, lit_4463@l(r3)  /* 0x80735BCC@l */
/* 8072D7C4  38 1D C0 00 */	addi r0, r29, -16384
/* 8072D7C8  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 8072D7CC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 8072D7D0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 8072D808  4B 94 A5 5D */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8072D80C  7F E3 FB 78 */	mr r3, r31
/* 8072D810  38 81 00 2C */	addi r4, r1, 0x2c
/* 8072D814  4B 94 6B A1 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8072D828  4B B4 33 DD */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 8072D82C  B0 7E 06 DA */	sth r3, 0x6da(r30)
/* 8072D830  38 61 00 2C */	addi r3, r1, 0x2c
/* 8072D834  38 80 FF FF */	li r4, -1
/* 8072D838  4B 94 A4 A5 */	bl __dt__11dBgS_LinChkFv
