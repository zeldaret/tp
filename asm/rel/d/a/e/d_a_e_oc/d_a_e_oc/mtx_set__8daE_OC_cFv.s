...
/* 807345F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807345F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807345F8  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 807345FC  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80734600  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80734604  4B C1 22 E5 */	bl PSMTXTrans
/* 80734608  38 7E 06 88 */	addi r3, r30, 0x688
/* 8073460C  4B 8D 89 39 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80734610  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80734614  4B 8D 89 31 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80734618  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8073461C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80734620  A8 9E 06 D8 */	lha r4, 0x6d8(r30)
/* 80734624  4B 8D 7E 11 */	bl mDoMtx_YrotM__FPA4_fs
/* 80734628  3C 60 80 73 */	lis r3, l_HIO@ha /* 0x80736060@ha */
/* 8073462C  38 63 60 60 */	addi r3, r3, l_HIO@l /* 0x80736060@l */
/* 80734630  C0 23 00 1C */	lfs f1, 0x1c(r3)
/* 80734634  FC 40 08 90 */	fmr f2, f1
/* 80734638  FC 60 08 90 */	fmr f3, f1
/* 8073463C  4B 8D 87 FD */	bl scaleM__14mDoMtx_stack_cFfff
/* 80734640  80 7E 05 BC */	lwz r3, 0x5bc(r30)
/* 80734644  83 E3 00 04 */	lwz r31, 4(r3)
/* 80734648  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8073464C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80734650  38 9F 00 24 */	addi r4, r31, 0x24
/* 80734654  4B C1 1E 5D */	bl PSMTXCopy
/* 80734658  80 7E 05 BC */	lwz r3, 0x5bc(r30)
/* 8073465C  4B 8D CB 91 */	bl modelCalc__16mDoExt_McaMorfSOFv
...
/* 8073467C  4B C1 1E 35 */	bl PSMTXCopy
lbl_80734680:
