...
/* 8072C640  4B C3 5B 98 */	b _savegpr_28
...
/* 8072C660  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8072C664  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8072C668  4B C1 9E 48 */	b PSMTXCopy
/* 8072C66C  2C 1F 00 11 */	cmpwi r31, 0x11
/* 8072C670  40 82 00 18 */	bne lbl_8072C688
/* 8072C674  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8072C678  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8072C67C  A8 9C 06 D2 */	lha r4, 0x6d2(r28)
/* 8072C680  4B 8D FD B4 */	b mDoMtx_YrotM__FPA4_fs
/* 8072C684  48 00 00 1C */	b lbl_8072C6A0
lbl_8072C688:
/* 8072C688  2C 1F 00 0C */	cmpwi r31, 0xc
/* 8072C68C  40 82 00 14 */	bne lbl_8072C6A0
/* 8072C690  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8072C694  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8072C698  A8 9C 06 D0 */	lha r4, 0x6d0(r28)
/* 8072C69C  4B 8D FD 98 */	b mDoMtx_YrotM__FPA4_fs
lbl_8072C6A0:
/* 8072C6A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8072C6A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8072C6A8  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 8072C6AC  80 04 00 0C */	lwz r0, 0xc(r4)
/* 8072C6B0  7C 80 F2 14 */	add r4, r0, r30
/* 8072C6B4  4B C1 9D FC */	b PSMTXCopy
/* 8072C6B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8072C6BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8072C6C0  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 8072C6C4  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 8072C6C8  4B C1 9D E8 */	b PSMTXCopy
/* 8072C6CC  38 60 00 01 */	li r3, 1
/* 8072C6D0  39 61 00 20 */	addi r11, r1, 0x20
/* 8072C6D4  4B C3 5B 50 */	b _restgpr_28
