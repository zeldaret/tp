...
/* 8072CE10  4B C3 53 CD */	bl _savegpr_29
/* 8072CE14  7C 7D 1B 78 */	mr r29, r3
/* 8072CE18  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8072CE1C  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 8072CE20  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8072CE24  4B 8E D9 BD */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8072CE3C  4B 8E D8 D5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8072CE54  4B 8E D9 8D */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8072CE58  3C 60 80 73 */	lis r3, l_HIO@ha /* 0x80736060@ha */
/* 8072CE5C  38 63 60 60 */	addi r3, r3, l_HIO@l /* 0x80736060@l */
...
/* 8072CE74  3C 60 80 73 */	lis r3, lit_4206@ha /* 0x80735BC8@ha */
/* 8072CE78  C0 03 5B C8 */	lfs f0, lit_4206@l(r3)  /* 0x80735BC8@l */
...
/* 8072CEA4  4B 8E FF 59 */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8072CED0  4B 8E FF 2D */	bl fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8072CEEC  4B C3 53 3D */	bl _restgpr_29
