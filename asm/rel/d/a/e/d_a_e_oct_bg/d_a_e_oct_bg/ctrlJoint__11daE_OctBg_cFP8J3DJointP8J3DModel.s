...
/* 807390F4  4B C2 90 E4 */	b _savegpr_28
...
/* 80739114  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80739118  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8073911C  4B C0 D3 94 */	b PSMTXCopy
...
/* 8073913C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80739140  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80739144  A8 9D 0B 8A */	lha r4, 0xb8a(r29)
/* 80739148  4B 8D 32 EC */	b mDoMtx_YrotM__FPA4_fs
/* 8073914C  48 00 00 3C */	b lbl_80739188
lbl_80739150:
/* 80739150  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80739154  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80739168  4B 8D 32 CC */	b mDoMtx_YrotM__FPA4_fs
/* 8073916C  48 00 00 1C */	b lbl_80739188
lbl_80739170:
/* 80739170  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80739174  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80739178  57 80 08 3C */	slwi r0, r28, 1
/* 8073917C  7C 9D 02 14 */	add r4, r29, r0
/* 80739180  A8 84 0B 80 */	lha r4, 0xb80(r4)
/* 80739184  4B 8D 32 B0 */	b mDoMtx_YrotM__FPA4_fs
lbl_80739188:
/* 80739188  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8073918C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80739190  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80739194  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80739198  7C 80 FA 14 */	add r4, r0, r31
/* 8073919C  4B C0 D3 14 */	b PSMTXCopy
/* 807391A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807391A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807391A8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 807391AC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 807391B0  4B C0 D3 00 */	b PSMTXCopy
/* 807391B4  38 60 00 01 */	li r3, 1
/* 807391B8  39 61 00 20 */	addi r11, r1, 0x20
/* 807391BC  4B C2 90 68 */	b _restgpr_28
