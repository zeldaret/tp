...
/* 80796B1C  4B BC B6 B1 */	bl _savegpr_25
/* 80796B20  7C 7D 1B 78 */	mr r29, r3
/* 80796B24  3C 60 80 7A */	lis r3, lit_3920@ha /* 0x807985E0@ha */
/* 80796B28  3B E3 85 E0 */	addi r31, r3, lit_3920@l /* 0x807985E0@l */
...
/* 80796B70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796B74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796B78  C0 3D 09 90 */	lfs f1, 0x990(r29)
/* 80796B7C  C0 5D 09 94 */	lfs f2, 0x994(r29)
/* 80796B80  C0 7D 09 98 */	lfs f3, 0x998(r29)
/* 80796B84  4B BA FD 65 */	bl PSMTXTrans
/* 80796B88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796B8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796B90  A8 9D 09 B2 */	lha r4, 0x9b2(r29)
/* 80796B94  4B 87 58 A1 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80796BAC  4B 87 62 8D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80796BB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796BB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796BB8  A8 1D 09 B2 */	lha r0, 0x9b2(r29)
/* 80796BBC  7C 00 00 D0 */	neg r0, r0
/* 80796BC0  7C 04 07 34 */	extsh r4, r0
/* 80796BC4  4B 87 58 71 */	bl mDoMtx_YrotM__FPA4_fs
/* 80796BC8  FC 20 F0 90 */	fmr f1, f30
/* 80796BCC  FC 40 E8 90 */	fmr f2, f29
/* 80796BD0  FC 60 F0 90 */	fmr f3, f30
/* 80796BD4  4B 87 62 65 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80796BD8  C0 3F 00 90 */	lfs f1, 0x90(r31)
/* 80796BDC  C0 5F 00 04 */	lfs f2, 4(r31)
/* 80796BE0  FC 60 08 90 */	fmr f3, f1
/* 80796BE4  4B 87 61 B9 */	bl transM__14mDoMtx_stack_cFfff
/* 80796BE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796BEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796BF0  A8 9D 09 B4 */	lha r4, 0x9b4(r29)
/* 80796BF4  4B 87 58 D9 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80796BF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796BFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796C00  A8 9D 09 B4 */	lha r4, 0x9b4(r29)
/* 80796C04  4B 87 57 99 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80796C1C  4B 87 62 1D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80796C20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796C24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796C28  A8 1D 09 B4 */	lha r0, 0x9b4(r29)
/* 80796C2C  7C 00 00 D0 */	neg r0, r0
/* 80796C30  7C 04 07 34 */	extsh r4, r0
/* 80796C34  4B 87 57 69 */	bl mDoMtx_XrotM__FPA4_fs
/* 80796C38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796C3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796C40  A8 1D 09 B4 */	lha r0, 0x9b4(r29)
/* 80796C44  7C 00 00 D0 */	neg r0, r0
/* 80796C48  7C 04 07 34 */	extsh r4, r0
/* 80796C4C  4B 87 58 81 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80796C50  C0 3F 01 74 */	lfs f1, 0x174(r31)
/* 80796C54  C0 5F 00 B8 */	lfs f2, 0xb8(r31)
/* 80796C58  FC 60 08 90 */	fmr f3, f1
/* 80796C5C  4B 87 61 41 */	bl transM__14mDoMtx_stack_cFfff
/* 80796C60  C0 3F 00 04 */	lfs f1, 4(r31)
/* 80796C64  C0 5F 00 B4 */	lfs f2, 0xb4(r31)
/* 80796C68  FC 60 08 90 */	fmr f3, f1
/* 80796C6C  4B 87 61 31 */	bl transM__14mDoMtx_stack_cFfff
/* 80796C70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796C74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796C78  7F 5D DA 14 */	add r26, r29, r27
/* 80796C7C  A8 9A 08 0A */	lha r4, 0x80a(r26)
/* 80796C80  4B 87 57 B5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80796C84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796C88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796C8C  A8 9A 08 08 */	lha r4, 0x808(r26)
/* 80796C90  4B 87 57 0D */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80796CA4  4B 87 60 F9 */	bl transM__14mDoMtx_stack_cFfff
/* 80796CA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796CAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796CB0  A8 9A 08 BE */	lha r4, 0x8be(r26)
/* 80796CB4  4B 87 57 81 */	bl mDoMtx_YrotM__FPA4_fs
/* 80796CB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796CBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796CC0  A8 9A 08 BC */	lha r4, 0x8bc(r26)
/* 80796CC4  4B 87 56 D9 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80796CD8  4B AD 99 31 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80796CEC  4B AD 99 1D */	bl cLib_addCalcAngleS2__FPssss
/* 80796CF0  FC 20 E0 90 */	fmr f1, f28
/* 80796CF4  FC 40 E0 90 */	fmr f2, f28
/* 80796CF8  FC 60 E0 90 */	fmr f3, f28
/* 80796CFC  4B 87 61 3D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80796D00  80 79 07 18 */	lwz r3, 0x718(r25)
/* 80796D04  38 81 00 08 */	addi r4, r1, 8
/* 80796D08  4B 88 2C B5 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80796D20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796D24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796D28  80 84 05 68 */	lwz r4, 0x568(r4)
/* 80796D2C  38 84 00 24 */	addi r4, r4, 0x24
/* 80796D30  4B BA F7 81 */	bl PSMTXCopy
lbl_80796D34:
...
/* 80796D6C  4B BC B4 AD */	bl _restgpr_25
