...
/* 80796FDC  3C 60 80 7A */	lis r3, lit_3920@ha /* 0x807985E0@ha */
/* 80796FE0  3B E3 85 E0 */	addi r31, r3, lit_3920@l /* 0x807985E0@l */
/* 80796FE4  38 7E 09 90 */	addi r3, r30, 0x990
/* 80796FE8  4B 87 5D 7D */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80796FEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80796FF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80796FF4  A8 9E 09 B2 */	lha r4, 0x9b2(r30)
/* 80796FF8  4B 87 54 3D */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80797018  4B 87 5E 21 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8079701C  C0 3F 00 04 */	lfs f1, 4(r31)
/* 80797020  FC 40 08 90 */	fmr f2, f1
/* 80797024  C0 7E 06 9C */	lfs f3, 0x69c(r30)
/* 80797028  4B 87 5D 75 */	bl transM__14mDoMtx_stack_cFfff
...
/* 80797040  4B 87 5D F9 */	bl scaleM__14mDoMtx_stack_cFfff
...
/* 80797054  4B 87 5D 49 */	bl transM__14mDoMtx_stack_cFfff
/* 80797058  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8079705C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797060  A8 1E 09 B2 */	lha r0, 0x9b2(r30)
/* 80797064  7C 00 00 D0 */	neg r0, r0
/* 80797068  7C 04 07 34 */	extsh r4, r0
/* 8079706C  4B 87 53 C9 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80797084  4B 87 5D 19 */	bl transM__14mDoMtx_stack_cFfff
/* 80797088  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8079708C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797090  A8 9E 09 B4 */	lha r4, 0x9b4(r30)
/* 80797094  4B 87 54 39 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80797098  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8079709C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807970A0  A8 9E 09 B4 */	lha r4, 0x9b4(r30)
/* 807970A4  4B 87 52 F9 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 807970BC  4B 87 5D 7D */	bl scaleM__14mDoMtx_stack_cFfff
/* 807970C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807970C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807970C8  A8 1E 09 B4 */	lha r0, 0x9b4(r30)
/* 807970CC  7C 00 00 D0 */	neg r0, r0
/* 807970D0  7C 04 07 34 */	extsh r4, r0
/* 807970D4  4B 87 52 C9 */	bl mDoMtx_XrotM__FPA4_fs
/* 807970D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807970DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807970E0  A8 1E 09 B4 */	lha r0, 0x9b4(r30)
/* 807970E4  7C 00 00 D0 */	neg r0, r0
/* 807970E8  7C 04 07 34 */	extsh r4, r0
/* 807970EC  4B 87 53 E1 */	bl mDoMtx_ZrotM__FPA4_fs
/* 807970F0  C0 3F 01 74 */	lfs f1, 0x174(r31)
/* 807970F4  C0 5F 00 B8 */	lfs f2, 0xb8(r31)
/* 807970F8  FC 60 08 90 */	fmr f3, f1
/* 807970FC  4B 87 5C A1 */	bl transM__14mDoMtx_stack_cFfff
/* 80797100  C0 3F 00 90 */	lfs f1, 0x90(r31)
/* 80797104  C0 5F 00 04 */	lfs f2, 4(r31)
/* 80797108  C0 7F 01 74 */	lfs f3, 0x174(r31)
/* 8079710C  4B 87 5C 91 */	bl transM__14mDoMtx_stack_cFfff
/* 80797110  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80797114  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797118  A8 9E 09 B4 */	lha r4, 0x9b4(r30)
/* 8079711C  4B 87 53 B1 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80797120  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80797124  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797128  A8 9E 09 B4 */	lha r4, 0x9b4(r30)
/* 8079712C  4B 87 53 09 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80797144  4B 87 5C F5 */	bl scaleM__14mDoMtx_stack_cFfff
/* 80797148  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8079714C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797150  A8 1E 09 B4 */	lha r0, 0x9b4(r30)
/* 80797154  7C 00 00 D0 */	neg r0, r0
/* 80797158  7C 04 07 34 */	extsh r4, r0
/* 8079715C  4B 87 52 D9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80797160  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80797164  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797168  A8 1E 09 B4 */	lha r0, 0x9b4(r30)
/* 8079716C  7C 00 00 D0 */	neg r0, r0
/* 80797170  7C 04 07 34 */	extsh r4, r0
/* 80797174  4B 87 53 59 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80797178  C0 3F 01 74 */	lfs f1, 0x174(r31)
/* 8079717C  C0 5F 00 B8 */	lfs f2, 0xb8(r31)
/* 80797180  C0 7F 00 90 */	lfs f3, 0x90(r31)
/* 80797184  4B 87 5C 19 */	bl transM__14mDoMtx_stack_cFfff
/* 80797188  C0 3F 01 74 */	lfs f1, 0x174(r31)
/* 8079718C  C0 5F 00 04 */	lfs f2, 4(r31)
/* 80797190  C0 7F 00 90 */	lfs f3, 0x90(r31)
/* 80797194  4B 87 5C 09 */	bl transM__14mDoMtx_stack_cFfff
/* 80797198  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8079719C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807971A0  A8 9E 09 B4 */	lha r4, 0x9b4(r30)
/* 807971A4  4B 87 53 29 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 807971BC  4B 87 5C 7D */	bl scaleM__14mDoMtx_stack_cFfff
/* 807971C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807971C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 807971C8  A8 1E 09 B4 */	lha r0, 0x9b4(r30)
/* 807971CC  7C 00 00 D0 */	neg r0, r0
/* 807971D0  7C 04 07 34 */	extsh r4, r0
/* 807971D4  4B 87 52 F9 */	bl mDoMtx_ZrotM__FPA4_fs
/* 807971D8  C0 3F 00 90 */	lfs f1, 0x90(r31)
/* 807971DC  C0 5F 00 B8 */	lfs f2, 0xb8(r31)
/* 807971E0  C0 7F 01 74 */	lfs f3, 0x174(r31)
/* 807971E4  4B 87 5B B9 */	bl transM__14mDoMtx_stack_cFfff
/* 807971E8  C0 3F 01 74 */	lfs f1, 0x174(r31)
/* 807971EC  C0 5F 00 04 */	lfs f2, 4(r31)
/* 807971F0  FC 60 08 90 */	fmr f3, f1
/* 807971F4  4B 87 5B A9 */	bl transM__14mDoMtx_stack_cFfff
/* 807971F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 807971FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797200  A8 9E 09 B4 */	lha r4, 0x9b4(r30)
/* 80797204  4B 87 51 99 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 8079721C  4B 87 5C 1D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80797220  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80797224  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797228  A8 1E 09 B4 */	lha r0, 0x9b4(r30)
/* 8079722C  7C 00 00 D0 */	neg r0, r0
/* 80797230  7C 04 07 34 */	extsh r4, r0
/* 80797234  4B 87 51 69 */	bl mDoMtx_XrotM__FPA4_fs
/* 80797238  C0 3F 00 90 */	lfs f1, 0x90(r31)
/* 8079723C  C0 5F 00 B8 */	lfs f2, 0xb8(r31)
/* 80797240  FC 60 08 90 */	fmr f3, f1
/* 80797244  4B 87 5B 59 */	bl transM__14mDoMtx_stack_cFfff
/* 80797248  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 8079724C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80797250  80 9E 05 B8 */	lwz r4, 0x5b8(r30)
/* 80797254  38 84 00 24 */	addi r4, r4, 0x24
/* 80797258  4B BA F2 59 */	bl PSMTXCopy
