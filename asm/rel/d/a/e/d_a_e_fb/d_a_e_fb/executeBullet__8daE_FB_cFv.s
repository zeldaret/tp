...
/* 806B7BA0  3C 60 80 6C */	lis r3, lit_3662@ha /* 0x806B8F8C@ha */
/* 806B7BA4  3B E3 8F 8C */	addi r31, r3, lit_3662@l /* 0x806B8F8C@l */
...
lbl_806B7BC4:
/* 806B7BC4  3C 60 80 6C */	lis r3, mFireTimer@ha /* 0x806B9220@ha */
/* 806B7BC8  38 83 92 20 */	addi r4, r3, mFireTimer@l /* 0x806B9220@l */
...
/* 806B7C18  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 0x80023590@ha */
/* 806B7C1C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 0x80023590@l */
/* 806B7C20  38 81 00 08 */	addi r4, r1, 8
/* 806B7C24  4B 96 1B D5 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
lbl_806B7C7C:
/* 806B7C7C  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806B7C80  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806B7C84  80 63 00 00 */	lwz r3, 0(r3)
/* 806B7C88  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 806B7C8C  4B 95 47 51 */	bl mDoMtx_YrotS__FPA4_fs
/* 806B7C90  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 806B7C94  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 806B7C98  80 63 00 00 */	lwz r3, 0(r3)
/* 806B7C9C  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 806B7CA0  4B 95 46 FD */	bl mDoMtx_XrotM__FPA4_fs
...
/* 806B7CC0  4B BB 92 2D */	bl MtxPosition__FP4cXyzP4cXyz
/* 806B7CC4  C0 01 00 1C */	lfs f0, 0x1c(r1)
/* 806B7CC8  D0 1E 04 FC */	stfs f0, 0x4fc(r30)
lbl_806B7CCC:
/* 806B7CCC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 806B7CD0  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 806B7D0C  4B BB 79 3D */	bl SetC__8cM3dGSphFRC4cXyz
/* 806B7D10  38 7E 0C 8C */	addi r3, r30, 0xc8c
/* 806B7D14  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 806B7D18  4B BB 79 F1 */	bl SetR__8cM3dGSphFf
...
/* 806B7D34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B7D38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B7D3C  38 63 23 3C */	addi r3, r3, 0x233c
/* 806B7D40  38 9E 0B 68 */	addi r4, r30, 0xb68
/* 806B7D44  4B BA CE 65 */	bl Set__4cCcSFP8cCcD_Obj
/* 806B7D48  38 7E 0B 68 */	addi r3, r30, 0xb68
/* 806B7D4C  4B 9C C5 75 */	bl ChkAtHit__12dCcD_GObjInfFv
/* 806B7D50  28 03 00 00 */	cmplwi r3, 0
/* 806B7D54  41 82 00 50 */	beq lbl_806B7DA4
/* 806B7D58  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B7D5C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B7D60  83 E3 5D AC */	lwz r31, 0x5dac(r3)
/* 806B7D64  38 7E 0B C0 */	addi r3, r30, 0xbc0
/* 806B7D68  4B 9C B9 21 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 806B7D6C  7C 1F 18 40 */	cmplw r31, r3
/* 806B7D70  40 82 00 20 */	bne lbl_806B7D90
/* 806B7D74  3C 60 80 6C */	lis r3, data_806B9224@ha /* 0x806B9224@ha */
/* 806B7D78  38 83 92 24 */	addi r4, r3, data_806B9224@l /* 0x806B9224@l */
...
/* 806B7DC0  4B 96 1E BD */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_806B7DC4:
