...
/* 806B6E04  4B CA B3 D9 */	bl _savegpr_29
/* 806B6E08  7C 7E 1B 78 */	mr r30, r3
/* 806B6E0C  3B E0 00 00 */	li r31, 0
/* 806B6E10  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B6E14  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B6E18  80 9D 5D AC */	lwz r4, 0x5dac(r29)
/* 806B6E1C  4B 96 39 C5 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806B6E20  3C 60 80 6C */	lis r3, l_HIO@ha /* 0x806B91FC@ha */
/* 806B6E24  38 63 91 FC */	addi r3, r3, l_HIO@l /* 0x806B91FC@l */
...
/* 806B6E4C  4B 96 38 C5 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806B6EA0  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806B91FC@ha */
/* 806B6EA4  38 C4 91 FC */	addi r6, r4, l_HIO@l /* 0x806B91FC@l */
/* 806B6EA8  A8 86 00 12 */	lha r4, 0x12(r6)
/* 806B6EAC  38 A0 00 01 */	li r5, 1
/* 806B6EB0  A8 C6 00 14 */	lha r6, 0x14(r6)
/* 806B6EB4  4B BB 97 55 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806B6EC8  4B BB 97 41 */	bl cLib_addCalcAngleS2__FPssss
...
/* 806B6F2C  4B CA B2 FD */	bl _restgpr_29
