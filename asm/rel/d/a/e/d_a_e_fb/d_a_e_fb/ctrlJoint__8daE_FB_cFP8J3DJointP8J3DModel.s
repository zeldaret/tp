...
/* 806B6530  4B CA BC A8 */	b _savegpr_28
...
/* 806B6550  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806B6554  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806B6558  4B C8 FF 58 */	b PSMTXCopy
/* 806B655C  2C 1F 00 02 */	cmpwi r31, 2
/* 806B6560  41 82 00 08 */	beq lbl_806B6568
/* 806B6564  48 00 00 14 */	b lbl_806B6578
lbl_806B6568:
/* 806B6568  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B656C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B6570  A8 9C 06 98 */	lha r4, 0x698(r28)
/* 806B6574  4B 95 5F 58 */	b mDoMtx_ZrotM__FPA4_fs
lbl_806B6578:
/* 806B6578  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B657C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B6580  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 806B6584  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806B6588  7C 80 F2 14 */	add r4, r0, r30
/* 806B658C  4B C8 FF 24 */	b PSMTXCopy
/* 806B6590  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B6594  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B6598  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 806B659C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 806B65A0  4B C8 FF 10 */	b PSMTXCopy
/* 806B65A4  38 60 00 01 */	li r3, 1
/* 806B65A8  39 61 00 20 */	addi r11, r1, 0x20
/* 806B65AC  4B CA BC 78 */	b _restgpr_28
