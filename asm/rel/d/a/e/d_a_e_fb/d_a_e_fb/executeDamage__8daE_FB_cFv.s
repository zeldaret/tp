...
/* 806B78B8  4B CA A9 0D */	bl _savegpr_23
/* 806B78BC  7C 7B 1B 78 */	mr r27, r3
/* 806B78C0  3C 60 80 6C */	lis r3, lit_3662@ha /* 0x806B8F8C@ha */
/* 806B78C4  3B C3 8F 8C */	addi r30, r3, lit_3662@l /* 0x806B8F8C@l */
...
/* 806B7900  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B7904  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B7908  3B A1 00 28 */	addi r29, r1, 0x28
/* 806B790C  3C 60 80 6C */	lis r3, d_eff_id_4275@ha /* 0x806B90BC@ha */
/* 806B7910  3A E3 90 BC */	addi r23, r3, d_eff_id_4275@l /* 0x806B90BC@l */
lbl_806B7914:
...
/* 806B795C  4B 99 5B 71 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806B7970  4B 99 3F A9 */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806B799C  4B BC 8E 6D */	bl func_80280808
...
/* 806B79F8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B79FC  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806B7A24  4B 96 2C ED */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806B7A38  4B BA FF 55 */	bl cM_rndFX__Ff
...
/* 806B7A70  4B BA FE E5 */	bl cM_rndF__Ff
...
/* 806B7A84  4B BA FE D1 */	bl cM_rndF__Ff
...
/* 806B7A9C  4B BA FE B9 */	bl cM_rndF__Ff
...
/* 806B7ACC  4B 96 22 CD */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
...
/* 806B7AF0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B7AF4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B7AF8  88 1B 04 BA */	lbz r0, 0x4ba(r27)
/* 806B7AFC  7C 05 07 74 */	extsb r5, r0
/* 806B7B00  4B 97 D7 01 */	bl onSwitch__10dSv_info_cFii
lbl_806B7B04:
/* 806B7B04  7F 63 DB 78 */	mr r3, r27
/* 806B7B08  4B 96 21 75 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 806B7B74  4B CA A6 9D */	bl _restgpr_23
