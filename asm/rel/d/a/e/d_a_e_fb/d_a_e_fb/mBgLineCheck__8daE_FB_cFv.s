...
/* 806B6D38  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B6D3C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B6D40  83 E3 5D AC */	lwz r31, 0x5dac(r3)
/* 806B6D44  38 61 00 14 */	addi r3, r1, 0x14
/* 806B6D48  4B 9C 0F 21 */	bl __ct__11dBgS_LinChkFv
...
/* 806B6D64  3C 60 80 6C */	lis r3, lit_3877@ha /* 0x806B8FA8@ha */
/* 806B6D68  C0 03 8F A8 */	lfs f0, lit_3877@l(r3)  /* 0x806B8FA8@l */
...
/* 806B6D84  4B 9C 0F E1 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806B6D88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B6D8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B6D90  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806B6D94  38 81 00 14 */	addi r4, r1, 0x14
/* 806B6D98  4B 9B D6 1D */	bl LineCross__4cBgSFP11cBgS_LinChk
/* 806B6D9C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 806B6DA0  41 82 00 2C */	beq lbl_806B6DCC
/* 806B6DA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B6DA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806B6DC0  4B 9C 0F 1D */	bl __dt__11dBgS_LinChkFv
...
/* 806B6DD4  4B 9C 0F 09 */	bl __dt__11dBgS_LinChkFv
