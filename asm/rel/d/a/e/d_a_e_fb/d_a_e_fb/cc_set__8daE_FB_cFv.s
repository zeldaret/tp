...
/* 806B812C  4B CA A0 AD */	bl _savegpr_28
/* 806B8130  7C 7E 1B 78 */	mr r30, r3
/* 806B8134  3C 60 80 6C */	lis r3, lit_3662@ha /* 0x806B8F8C@ha */
/* 806B8138  3B E3 8F 8C */	addi r31, r3, lit_3662@l /* 0x806B8F8C@l */
...
/* 806B8150  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B8154  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B8158  4B C8 E3 59 */	bl PSMTXCopy
/* 806B815C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B8160  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
...
/* 806B8174  4B C8 E7 75 */	bl PSMTXTrans
...
/* 806B81B4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B81B8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B81BC  4B C8 E2 F5 */	bl PSMTXCopy
/* 806B81C0  C0 3F 00 80 */	lfs f1, 0x80(r31)
/* 806B81C4  C0 5F 00 84 */	lfs f2, 0x84(r31)
/* 806B81C8  C0 7F 00 10 */	lfs f3, 0x10(r31)
/* 806B81CC  4B 95 4B D1 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806B81F0  4B BB 74 59 */	bl SetC__8cM3dGSphFRC4cXyz
/* 806B81F4  38 7E 0A 1C */	addi r3, r30, 0xa1c
/* 806B81F8  C0 3F 00 88 */	lfs f1, 0x88(r31)
/* 806B81FC  4B BB 75 0D */	bl SetR__8cM3dGSphFf
/* 806B8200  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B8204  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 806B8208  3B 83 23 3C */	addi r28, r3, 0x233c
/* 806B820C  7F 83 E3 78 */	mr r3, r28
/* 806B8210  38 9E 08 F8 */	addi r4, r30, 0x8f8
/* 806B8214  4B BA C9 95 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 806B822C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 806B8230  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 806B8234  4B C8 E2 7D */	bl PSMTXCopy
/* 806B8238  C0 3F 00 8C */	lfs f1, 0x8c(r31)
/* 806B823C  C0 5F 00 84 */	lfs f2, 0x84(r31)
/* 806B8240  C0 7F 00 80 */	lfs f3, 0x80(r31)
/* 806B8244  4B 95 4B 59 */	bl transM__14mDoMtx_stack_cFfff
...
/* 806B82A0  4B CA 9F 85 */	bl _restgpr_28
