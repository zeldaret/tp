...
/* 806B661C  4B CA BB BD */	bl _savegpr_28
/* 806B6620  7C 7D 1B 78 */	mr r29, r3
/* 806B6624  3C 60 80 6C */	lis r3, lit_3662@ha /* 0x806B8F8C@ha */
/* 806B6628  3B E3 8F 8C */	addi r31, r3, lit_3662@l /* 0x806B8F8C@l */
...
/* 806B6650  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806B6654  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806B6658  38 80 00 00 */	li r4, 0
/* 806B665C  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 806B6660  38 DD 01 0C */	addi r6, r29, 0x10c
/* 806B6664  4B AE D1 61 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806B6668  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 806B666C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 806B6670  80 9E 00 04 */	lwz r4, 4(r30)
/* 806B6674  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806B6678  4B AE E7 29 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806B66A0  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806B91FC@ha */
/* 806B66A4  38 84 91 FC */	addi r4, r4, l_HIO@l /* 0x806B91FC@l */
...
/* 806B66C8  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806B91FC@ha */
/* 806B66CC  38 84 91 FC */	addi r4, r4, l_HIO@l /* 0x806B91FC@l */
...
/* 806B66F0  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806B91FC@ha */
/* 806B66F4  38 84 91 FC */	addi r4, r4, l_HIO@l /* 0x806B91FC@l */
...
/* 806B6718  3C 80 80 6C */	lis r4, l_HIO@ha /* 0x806B91FC@ha */
/* 806B671C  38 84 91 FC */	addi r4, r4, l_HIO@l /* 0x806B91FC@l */
...
/* 806B6738  4B 95 70 71 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 806B673C  38 7D 05 B8 */	addi r3, r29, 0x5b8
/* 806B6740  38 80 00 00 */	li r4, 0
/* 806B6744  4B 95 80 7D */	bl entryDL__21mDoExt_invisibleModelFP4cXyz
...
/* 806B6794  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 0x804248D0@ha */
/* 806B6798  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 0x804248D0@l */
/* 806B679C  4B 97 81 75 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806B67A0  90 7D 06 88 */	stw r3, 0x688(r29)
/* 806B67A4  38 60 00 01 */	li r3, 1
lbl_806B67A8:
/* 806B67A8  39 61 00 30 */	addi r11, r1, 0x30
/* 806B67AC  4B CA BA 79 */	bl _restgpr_28
