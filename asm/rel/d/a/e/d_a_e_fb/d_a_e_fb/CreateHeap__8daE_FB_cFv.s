...
/* 806B8688  4B CA 9B 51 */	bl _savegpr_28
/* 806B868C  7C 7E 1B 78 */	mr r30, r3
/* 806B8690  3C 60 80 6C */	lis r3, d_a_e_fb__stringBase0@ha /* 0x806B9028@ha */
/* 806B8694  38 63 90 28 */	addi r3, r3, d_a_e_fb__stringBase0@l /* 0x806B9028@l */
/* 806B8698  38 80 00 0B */	li r4, 0xb
/* 806B869C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 806B86A0  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 806B86B4  4B 98 3C 39 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806B86B8  7C 7C 1B 78 */	mr r28, r3
/* 806B86BC  38 60 00 58 */	li r3, 0x58
/* 806B86C0  4B C1 65 8D */	bl __nw__FUl
/* 806B86C4  7C 7D 1B 79 */	or. r29, r3, r3
/* 806B86C8  41 82 00 68 */	beq lbl_806B8730
/* 806B86CC  3C 60 80 6C */	lis r3, d_a_e_fb__stringBase0@ha /* 0x806B9028@ha */
/* 806B86D0  38 63 90 28 */	addi r3, r3, d_a_e_fb__stringBase0@l /* 0x806B9028@l */
/* 806B86D4  38 80 00 08 */	li r4, 8
/* 806B86D8  7F E5 FB 78 */	mr r5, r31
/* 806B86DC  38 C0 00 80 */	li r6, 0x80
/* 806B86E0  4B 98 3C 0D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806B8718  3D 20 80 6C */	lis r9, lit_3751@ha /* 0x806B8FA0@ha */
/* 806B871C  C0 29 8F A0 */	lfs f1, lit_3751@l(r9)  /* 0x806B8FA0@l */
/* 806B8720  39 20 00 00 */	li r9, 0
/* 806B8724  39 40 FF FF */	li r10, -1
/* 806B8728  4B 95 80 A9 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806B875C  4B 95 5D E1 */	bl create__21mDoExt_invisibleModelFP8J3DModelUc
...
/* 806B8788  3C 60 80 6B */	lis r3, JointCallBack__8daE_FB_cFP8J3DJointi@ha /* 0x806B65C0@ha */
/* 806B878C  38 83 65 C0 */	addi r4, r3, JointCallBack__8daE_FB_cFP8J3DJointi@l /* 0x806B65C0@l */
...
/* 806B87CC  4B C1 64 81 */	bl __nw__FUl
/* 806B87D0  7C 7D 1B 79 */	or. r29, r3, r3
/* 806B87D4  41 82 00 20 */	beq lbl_806B87F4
/* 806B87D8  3C 80 80 6C */	lis r4, __vt__12J3DFrameCtrl@ha /* 0x806B918C@ha */
/* 806B87DC  38 04 91 8C */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 0x806B918C@l */
/* 806B87E0  90 1D 00 00 */	stw r0, 0(r29)
/* 806B87E4  38 80 00 00 */	li r4, 0
/* 806B87E8  4B C6 FC 15 */	bl init__12J3DFrameCtrlFs
...
lbl_806B880C:
/* 806B880C  3C 60 80 6C */	lis r3, d_a_e_fb__stringBase0@ha /* 0x806B9028@ha */
/* 806B8810  38 63 90 28 */	addi r3, r3, d_a_e_fb__stringBase0@l /* 0x806B9028@l */
/* 806B8814  38 80 00 0E */	li r4, 0xe
/* 806B8818  7F E5 FB 78 */	mr r5, r31
/* 806B881C  38 C0 00 80 */	li r6, 0x80
/* 806B8820  4B 98 3A CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806B8844  3D 00 80 6C */	lis r8, lit_3751@ha /* 0x806B8FA0@ha */
/* 806B8848  C0 28 8F A0 */	lfs f1, lit_3751@l(r8)  /* 0x806B8FA0@l */
/* 806B884C  39 00 00 00 */	li r8, 0
/* 806B8850  39 20 FF FF */	li r9, -1
/* 806B8854  4B 95 4E B9 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 806B8858  30 03 FF FF */	addic r0, r3, -1
/* 806B885C  7C 60 19 10 */	subfe r3, r0, r3
lbl_806B8860:
/* 806B8860  39 61 00 30 */	addi r11, r1, 0x30
/* 806B8864  4B CA 99 C1 */	bl _restgpr_28
