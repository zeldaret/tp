...
/* 804FB1C8  4B E6 70 15 */	bl _savegpr_29
/* 804FB1CC  7C 7D 1B 78 */	mr r29, r3
/* 804FB1D0  7C 9F 23 78 */	mr r31, r4
/* 804FB1D4  3C 60 80 50 */	lis r3, lit_3646@ha /* 0x804FBB90@ha */
/* 804FB1D8  3B C3 BB 90 */	addi r30, r3, lit_3646@l /* 0x804FBB90@l */
...
/* 804FB210  4B D6 C7 45 */	bl cM_rndF__Ff
...
/* 804FB228  4B D6 C7 65 */	bl cM_rndFX__Ff
...
/* 804FB23C  4B D6 C7 19 */	bl cM_rndF__Ff
...
/* 804FB250  4B D6 C7 3D */	bl cM_rndFX__Ff
...
/* 804FB26C  4B D6 B8 C9 */	bl __mi__4cXyzCFRC3Vec
...
/* 804FB288  4B D6 C3 ED */	bl cM_atan2s__Fff
...
/* 804FB2BC  4B D6 C3 B9 */	bl cM_atan2s__Fff
...
/* 804FB2D8  4B D7 53 31 */	bl cLib_addCalcAngleS2__FPssss
...
/* 804FB2EC  4B D7 53 1D */	bl cLib_addCalcAngleS2__FPssss
...
/* 804FB304  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804FB308  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804FB30C  80 63 00 00 */	lwz r3, 0(r3)
/* 804FB310  A8 9F 00 2A */	lha r4, 0x2a(r31)
/* 804FB314  4B B1 10 C9 */	bl mDoMtx_YrotS__FPA4_fs
/* 804FB318  3C 60 80 45 */	lis r3, calc_mtx@ha /* 0x80450768@ha */
/* 804FB31C  38 63 07 68 */	addi r3, r3, calc_mtx@l /* 0x80450768@l */
/* 804FB320  80 63 00 00 */	lwz r3, 0(r3)
/* 804FB324  A8 9F 00 28 */	lha r4, 0x28(r31)
/* 804FB328  4B B1 10 75 */	bl mDoMtx_XrotM__FPA4_fs
/* 804FB32C  38 61 00 20 */	addi r3, r1, 0x20
/* 804FB330  38 81 00 14 */	addi r4, r1, 0x14
/* 804FB334  4B D7 5B B9 */	bl MtxPosition__FP4cXyzP4cXyz
/* 804FB338  38 7F 00 04 */	addi r3, r31, 4
/* 804FB33C  38 81 00 14 */	addi r4, r1, 0x14
/* 804FB340  7C 65 1B 78 */	mr r5, r3
/* 804FB344  4B E4 BD 4D */	bl PSVECAdd
...
/* 804FB36C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 804FB370  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 804FB394  4B E6 6E 95 */	bl _restgpr_29
