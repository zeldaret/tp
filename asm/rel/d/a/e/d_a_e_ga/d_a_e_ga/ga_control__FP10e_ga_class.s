...
/* 804FB5D8  4B E6 6C 01 */	bl _savegpr_28
/* 804FB5DC  7C 7C 1B 78 */	mr r28, r3
/* 804FB5E0  3C 60 80 50 */	lis r3, lit_3646@ha /* 0x804FBB90@ha */
/* 804FB5E4  3B E3 BB 90 */	addi r31, r3, lit_3646@l /* 0x804FBB90@l */
...
lbl_804FB654:
/* 804FB654  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FB658  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FB65C  C0 3E 00 04 */	lfs f1, 4(r30)
/* 804FB660  C0 5E 00 08 */	lfs f2, 8(r30)
/* 804FB664  C0 7E 00 0C */	lfs f3, 0xc(r30)
/* 804FB668  4B E4 B2 81 */	bl PSMTXTrans
/* 804FB66C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FB670  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FB674  A8 9E 00 2A */	lha r4, 0x2a(r30)
/* 804FB678  4B B1 0D BD */	bl mDoMtx_YrotM__FPA4_fs
/* 804FB67C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FB680  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FB684  A8 9E 00 28 */	lha r4, 0x28(r30)
/* 804FB688  4B B1 0D 15 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 804FB69C  4B B1 17 9D */	bl scaleM__14mDoMtx_stack_cFfff
/* 804FB6A0  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 804FB6A4  FC 40 F8 90 */	fmr f2, f31
/* 804FB6A8  FC 60 08 90 */	fmr f3, f1
/* 804FB6AC  4B B1 16 F1 */	bl transM__14mDoMtx_stack_cFfff
/* 804FB6B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804FB6B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804FB6B8  80 9E 00 00 */	lwz r4, 0(r30)
/* 804FB6BC  38 84 00 24 */	addi r4, r4, 0x24
/* 804FB6C0  4B E4 AD F1 */	bl PSMTXCopy
lbl_804FB6C4:
...
/* 804FB6E4  4B E6 6B 41 */	bl _restgpr_28
