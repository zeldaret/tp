...
/* 804FB884  4B E6 69 4D */	bl _savegpr_26
/* 804FB888  7C 7E 1B 78 */	mr r30, r3
/* 804FB88C  3C 80 80 50 */	lis r4, lit_3646@ha /* 0x804FBB90@ha */
/* 804FB890  3B E4 BB 90 */	addi r31, r4, lit_3646@l /* 0x804FBB90@l */
...
/* 804FB8AC  4B B1 D2 B9 */	bl __ct__10fopAc_ac_cFv
/* 804FB8B0  38 7A 05 74 */	addi r3, r26, 0x574
/* 804FB8B4  3C 80 80 50 */	lis r4, __ct__4ga_sFv@ha /* 0x804FBAF4@ha */
/* 804FB8B8  38 84 BA F4 */	addi r4, r4, __ct__4ga_sFv@l /* 0x804FBAF4@l */
/* 804FB8BC  3C A0 80 50 */	lis r5, __dt__4ga_sFv@ha /* 0x804FBAB8@ha */
/* 804FB8C0  38 A5 BA B8 */	addi r5, r5, __dt__4ga_sFv@l /* 0x804FBAB8@l */
/* 804FB8C4  38 C0 00 48 */	li r6, 0x48
/* 804FB8C8  38 E0 01 00 */	li r7, 0x100
/* 804FB8CC  4B E6 64 95 */	bl __construct_array
lbl_804FB8D0:
...
/* 804FB8E0  3C 80 80 50 */	lis r4, d_a_e_ga__stringBase0@ha /* 0x804FBBD4@ha */
/* 804FB8E4  38 84 BB D4 */	addi r4, r4, d_a_e_ga__stringBase0@l /* 0x804FBBD4@l */
/* 804FB8E8  38 84 00 05 */	addi r4, r4, 5
/* 804FB8EC  4B B3 15 D1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 804FB968  3C 80 80 50 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x804FB7C4@ha */
/* 804FB96C  38 84 B7 C4 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x804FB7C4@l */
/* 804FB970  38 A0 10 00 */	li r5, 0x1000
/* 804FB974  4B B1 EB 3D */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_804FB988:
/* 804FB988  3C 60 80 50 */	lis r3, data_804FBC48@ha /* 0x804FBC48@ha */
/* 804FB98C  8C 03 BC 48 */	lbzu r0, data_804FBC48@l(r3)  /* 0x804FBC48@l */
...
/* 804FB9A8  3C 60 80 50 */	lis r3, l_HIO@ha /* 0x804FBC58@ha */
/* 804FB9AC  38 63 BC 58 */	addi r3, r3, l_HIO@l /* 0x804FBC58@l */
...
/* 804FB9E8  4B D6 BF 6D */	bl cM_rndF__Ff
...
/* 804FBA0C  4B D6 BF 49 */	bl cM_rndF__Ff
...
/* 804FBA24  4B D6 BF 31 */	bl cM_rndF__Ff
...
/* 804FBA50  3C 60 80 50 */	lis r3, d_a_e_ga__stringBase0@ha /* 0x804FBBD4@ha */
/* 804FBA54  38 63 BB D4 */	addi r3, r3, d_a_e_ga__stringBase0@l /* 0x804FBBD4@l */
/* 804FBA58  38 80 00 03 */	li r4, 3
/* 804FBA5C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FBA60  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804FBA64  3C A5 00 02 */	addis r5, r5, 2
/* 804FBA68  38 C0 00 80 */	li r6, 0x80
/* 804FBA6C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 804FBA70  4B B4 08 7D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 804FBA74  7C 64 1B 78 */	mr r4, r3
/* 804FBA78  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804FBA7C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804FBA90  4B B3 10 61 */	bl addSimpleModel__14dComIfG_play_cFP12J3DModelDataiUc
...
/* 804FBAA4  4B E6 67 79 */	bl _restgpr_26
