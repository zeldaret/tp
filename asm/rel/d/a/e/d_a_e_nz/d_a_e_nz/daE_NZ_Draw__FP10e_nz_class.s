...
/* 80729B34  4B C3 86 A4 */	b _savegpr_28
...
lbl_80729B58:
/* 80729B58  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80729B5C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80729B60  38 80 00 00 */	li r4, 0
/* 80729B64  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80729B68  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80729B6C  4B A7 9C 58 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80729B70  C0 3F 05 F0 */	lfs f1, 0x5f0(r31)
/* 80729B74  3C 60 80 73 */	lis r3, lit_3791@ha
/* 80729B78  C0 03 C1 88 */	lfs f0, lit_3791@l(r3)
...
lbl_80729B8C:
/* 80729B8C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80729B90  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80729B94  80 9E 00 04 */	lwz r4, 4(r30)
/* 80729B98  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80729B9C  4B A7 B2 04 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80729C04  4B 8E 4B BC */	b entryDL__21mDoExt_invisibleModelFP4cXyz
/* 80729C08  38 60 00 01 */	li r3, 1
lbl_80729C0C:
/* 80729C0C  39 61 00 20 */	addi r11, r1, 0x20
/* 80729C10  4B C3 86 14 */	b _restgpr_28
