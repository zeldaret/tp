...
/* 80729C44  3C 60 80 73 */	lis r3, lit_3789@ha /* 0x8072C180@ha */
/* 80729C48  3B E3 C1 80 */	addi r31, r3, lit_3789@l /* 0x8072C180@l */
...
/* 80729C60  4B B3 DC F5 */	bl cM_rndF__Ff
...
/* 80729CE0  4B B3 DC 75 */	bl cM_rndF__Ff
...
/* 80729D08  4B B3 DC 4D */	bl cM_rndF__Ff
...
/* 80729D48  3C 60 80 73 */	lis r3, l_HIO@ha /* 0x8072C434@ha */
/* 80729D4C  38 63 C4 34 */	addi r3, r3, l_HIO@l /* 0x8072C434@l */
...
/* 80729DA4  4B BF E6 89 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80729E08  4B B3 DB 4D */	bl cM_rndF__Ff
...
/* 80729E64  4B 8F 30 6D */	bl fopAcM_wayBgCheck__FPC10fopAc_ac_cff
...
/* 80729E7C  4B B3 DA D9 */	bl cM_rndF__Ff
...
/* 80729ECC  4B B3 DA C1 */	bl cM_rndFX__Ff
...
/* 80729EE8  4B B3 DA A5 */	bl cM_rndFX__Ff
...
/* 80729F04  4B B3 D7 71 */	bl cM_atan2s__Fff
...
lbl_80729F24:
/* 80729F24  3C 60 80 73 */	lis r3, data_8072C454@ha /* 0x8072C454@ha */
/* 80729F28  88 03 C4 54 */	lbz r0, data_8072C454@l(r3)  /* 0x8072C454@l */
...
/* 80729F80  4B BF E4 AD */	bl checkPass__12J3DFrameCtrlFf
/* 80729F84  2C 03 00 00 */	cmpwi r3, 0
/* 80729F88  41 82 00 64 */	beq lbl_80729FEC
lbl_80729F8C:
/* 80729F8C  38 C0 00 00 */	li r6, 0
/* 80729F90  3C 60 80 73 */	lis r3, data_8072C454@ha /* 0x8072C454@ha */
/* 80729F94  88 83 C4 54 */	lbz r4, data_8072C454@l(r3)  /* 0x8072C454@l */
/* 80729F98  3C 60 80 73 */	lis r3, stick_bit@ha /* 0x8072C284@ha */
/* 80729F9C  38 63 C2 84 */	addi r3, r3, stick_bit@l /* 0x8072C284@l */
...
/* 80729FB4  3C 60 80 73 */	lis r3, data_8072C454@ha /* 0x8072C454@ha */
/* 80729FB8  8C 03 C4 54 */	lbzu r0, data_8072C454@l(r3)  /* 0x8072C454@l */
...
/* 80729FFC  4B B4 66 0D */	bl cLib_addCalcAngleS2__FPssss
...
/* 8072A010  3C 80 80 73 */	lis r4, l_HIO@ha /* 0x8072C434@ha */
/* 8072A014  38 84 C4 34 */	addi r4, r4, l_HIO@l /* 0x8072C434@l */
/* 8072A018  C0 04 00 0C */	lfs f0, 0xc(r4)
/* 8072A01C  EC 63 00 32 */	fmuls f3, f3, f0
/* 8072A020  4B B4 5A 1D */	bl cLib_addCalc2__FPffff
