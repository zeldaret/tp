...
/* 8072A690  4B C3 7B 4D */	bl _savegpr_29
/* 8072A694  7C 7D 1B 78 */	mr r29, r3
/* 8072A698  3C 80 80 73 */	lis r4, lit_3789@ha /* 0x8072C180@ha */
/* 8072A69C  3B E4 C1 80 */	addi r31, r4, lit_3789@l /* 0x8072C180@l */
...
/* 8072A6F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8072A6F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8072A708  4B 94 53 1D */	bl StartShock__12dVibration_cFii4cXyz
...
/* 8072A71C  4B BF DD 11 */	bl checkPass__12J3DFrameCtrlFf
...
lbl_8072A754:
/* 8072A754  3C 60 80 73 */	lis r3, data_8072C454@ha /* 0x8072C454@ha */
/* 8072A758  88 83 C4 54 */	lbz r4, data_8072C454@l(r3)  /* 0x8072C454@l */
/* 8072A75C  3C 60 80 73 */	lis r3, stick_bit@ha /* 0x8072C284@ha */
/* 8072A760  38 63 C2 84 */	addi r3, r3, stick_bit@l /* 0x8072C284@l */
...
/* 8072A794  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8072A798  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8072A7B0  4B C3 7A 79 */	bl _restgpr_29
