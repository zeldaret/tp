...
/* 805AAD88  4B A6 DD DD */	bl __ct__10fopAc_ac_cFv
/* 805AAD8C  38 7E 05 74 */	addi r3, r30, 0x574
/* 805AAD90  4B D1 61 D5 */	bl __ct__15Z2CreatureEnemyFv
lbl_805AAD94:
...
/* 805AADA4  3C 80 80 5B */	lis r4, d_a_L7low_dr__stringBase0@ha /* 0x805AAFB0@ha */
/* 805AADA8  38 84 AF B0 */	addi r4, r4, d_a_L7low_dr__stringBase0@l /* 0x805AAFB0@l */
/* 805AADAC  4B A8 21 11 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 805AADC0  3C 80 80 5B */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 0x805AAC3C@ha */
/* 805AADC4  38 84 AC 3C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 0x805AAC3C@l */
/* 805AADC8  38 A0 1D 20 */	li r5, 0x1d20
/* 805AADCC  4B A6 F6 E5 */	bl fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_805AADE0:
/* 805AADE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805AADE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805AADE8  38 63 09 58 */	addi r3, r3, 0x958
/* 805AADEC  38 80 00 03 */	li r4, 3
/* 805AADF0  4B A8 9B 45 */	bl isDungeonItem__12dSv_memBit_cCFi
...
lbl_805AAE04:
/* 805AAE04  3C 60 80 5B */	lis r3, lit_3773@ha /* 0x805AAF84@ha */
/* 805AAE08  C0 03 AF 84 */	lfs f0, lit_3773@l(r3)  /* 0x805AAF84@l */
...
/* 805AAE34  4B D1 62 61 */	bl init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 805AAE38  3C 60 80 5B */	lis r3, lit_3832@ha /* 0x805AAFB8@ha */
/* 805AAE3C  38 83 AF B8 */	addi r4, r3, lit_3832@l /* 0x805AAFB8@l */
