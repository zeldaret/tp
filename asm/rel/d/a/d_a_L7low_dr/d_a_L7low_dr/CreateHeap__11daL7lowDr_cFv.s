...
/* 805AAC6C  4B DB 75 6D */	bl _savegpr_28
/* 805AAC70  7C 7F 1B 78 */	mr r31, r3
/* 805AAC74  3C 60 80 5B */	lis r3, d_a_L7low_dr__stringBase0@ha /* 0x805AAFB0@ha */
/* 805AAC78  38 63 AF B0 */	addi r3, r3, d_a_L7low_dr__stringBase0@l /* 0x805AAFB0@l */
/* 805AAC7C  38 80 00 0A */	li r4, 0xa
/* 805AAC80  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805AAC84  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805AAC98  4B A9 16 55 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 805AAC9C  7C 7C 1B 78 */	mr r28, r3
/* 805AACA0  38 60 00 58 */	li r3, 0x58
/* 805AACA4  4B D2 3F A9 */	bl __nw__FUl
/* 805AACA8  7C 7E 1B 79 */	or. r30, r3, r3
/* 805AACAC  41 82 00 68 */	beq lbl_805AAD14
/* 805AACB0  3C 60 80 5B */	lis r3, d_a_L7low_dr__stringBase0@ha /* 0x805AAFB0@ha */
/* 805AACB4  38 63 AF B0 */	addi r3, r3, d_a_L7low_dr__stringBase0@l /* 0x805AAFB0@l */
/* 805AACB8  38 80 00 04 */	li r4, 4
/* 805AACBC  7F A5 EB 78 */	mr r5, r29
/* 805AACC0  38 C0 00 80 */	li r6, 0x80
/* 805AACC4  4B A9 16 29 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805AACFC  3D 20 80 5B */	lis r9, lit_3773@ha /* 0x805AAF84@ha */
/* 805AAD00  C0 29 AF 84 */	lfs f1, lit_3773@l(r9)  /* 0x805AAF84@l */
/* 805AAD04  39 20 00 00 */	li r9, 0
/* 805AAD08  39 40 FF FF */	li r10, -1
/* 805AAD0C  4B A6 5A C5 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 805AAD44  4B DB 74 E1 */	bl _restgpr_28
