...
/* 805A598C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5990  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805A59C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A59CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805A5A20  4B A7 57 7D */	bl fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
...
/* 805A5A3C  3C 80 80 5A */	lis r4, d_a_tag_mhint__stringBase0@ha /* 0x805A604C@ha */
/* 805A5A40  38 84 60 4C */	addi r4, r4, d_a_tag_mhint__stringBase0@l /* 0x805A604C@l */
/* 805A5A44  4B DC 2F 51 */	bl strcmp
...
/* 805A5A5C  4B AC DE A1 */	bl request__10dAttHint_cFP10fopAc_ac_ci
...
/* 805A5A88  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805A5A8C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805A5AA4  3D 00 80 5A */	lis r8, lit_3803@ha /* 0x805A6040@ha */
/* 805A5AA8  C0 28 60 40 */	lfs f1, lit_3803@l(r8)  /* 0x805A6040@l */
/* 805A5AAC  FC 40 08 90 */	fmr f2, f1
/* 805A5AB0  3D 00 80 5A */	lis r8, lit_3804@ha /* 0x805A6044@ha */
/* 805A5AB4  C0 68 60 44 */	lfs f3, lit_3804@l(r8)  /* 0x805A6044@l */
/* 805A5AB8  FC 80 18 90 */	fmr f4, f3
/* 805A5ABC  39 00 00 00 */	li r8, 0
/* 805A5AC0  4B D0 5E C5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_805A5AC4:
