...
/* 805A5AF4  4B DB C6 E9 */	bl _savegpr_29
/* 805A5AF8  7C 7D 1B 78 */	mr r29, r3
/* 805A5AFC  3C 60 80 5A */	lis r3, lit_3741@ha /* 0x805A6034@ha */
/* 805A5B00  3B E3 60 34 */	addi r31, r3, lit_3741@l /* 0x805A6034@l */
/* 805A5B04  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 805A5B08  83 C3 10 18 */	lwz r30, m_midnaActor__9daPy_py_c@l(r3)  /* 0x80451018@l */
...
/* 805A5B7C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5B80  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A5B84  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 805A5B88  4B A7 4B 89 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805A5B9C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5BA0  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A5BA4  38 7E 4F F8 */	addi r3, r30, 0x4ff8
/* 805A5BA8  A8 9D 05 76 */	lha r4, 0x576(r29)
/* 805A5BAC  4B AA 1E CD */	bl endCheck__16dEvent_manager_cFs
/* 805A5BB0  2C 03 00 00 */	cmpwi r3, 0
/* 805A5BB4  41 82 04 1C */	beq lbl_805A5FD0
/* 805A5BB8  38 7E 4E C8 */	addi r3, r30, 0x4ec8
/* 805A5BBC  4B A9 C8 AD */	bl reset__14dEvt_control_cFv
/* 805A5BC0  7F A3 EB 78 */	mr r3, r29
/* 805A5BC4  38 80 00 03 */	li r4, 3
/* 805A5BC8  38 A0 00 00 */	li r5, 0
/* 805A5BCC  4B A7 55 D1 */	bl fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
...
/* 805A5C2C  4B CA 43 65 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 805A5C40  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805A5C44  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805A5C70  4B D0 5D 15 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 805A5C90  4B CA 46 49 */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 805A5CA4  4B CA 48 85 */	bl getEventId__10dMsgFlow_cFPi
...
/* 805A5CB8  3C 60 80 43 */	lis r3, g_meter2_info@ha /* 0x80430188@ha */
/* 805A5CBC  38 63 01 88 */	addi r3, r3, g_meter2_info@l /* 0x80430188@l */
...
/* 805A5CE0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 805A5CE4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 805A5D10  4B D0 5C 75 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_805A5D14:
...
/* 805A5DAC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5DB0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A5DB4  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 805A5DB8  4B A9 C6 B1 */	bl reset__14dEvt_control_cFv
...
/* 805A5DF4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5DF8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A5DFC  88 9D 05 69 */	lbz r4, 0x569(r29)
/* 805A5E00  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 805A5E04  7C 05 07 74 */	extsb r5, r0
/* 805A5E08  4B A8 F3 F9 */	bl onSwitch__10dSv_info_cFii
lbl_805A5E0C:
/* 805A5E0C  7F A3 EB 78 */	mr r3, r29
/* 805A5E10  4B A7 3E 6D */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 805A5E44  4B A7 53 59 */	bl fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
...
/* 805A5E5C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5E60  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A5E64  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 805A5E68  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 805A5E6C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 805A5E70  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 805A5E74  7C 84 02 2E */	lhzx r4, r4, r0
/* 805A5E78  4B A8 EB 45 */	bl isEventBit__11dSv_event_cCFUs
...
/* 805A5E98  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5E9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A5EA0  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 805A5EA4  7C 05 07 74 */	extsb r5, r0
/* 805A5EA8  4B A8 F4 B9 */	bl isSwitch__10dSv_info_cCFii
/* 805A5EAC  2C 03 00 00 */	cmpwi r3, 0
/* 805A5EB0  41 82 00 14 */	beq lbl_805A5EC4
/* 805A5EB4  7F A3 EB 78 */	mr r3, r29
/* 805A5EB8  4B A7 3D C5 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 805A5ECC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5ED0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805A5F00  4B A7 4B 95 */	bl fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805A5F1C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5F20  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A5F24  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 805A5F28  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 805A5F2C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 805A5F30  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 805A5F34  7C 84 02 2E */	lhzx r4, r4, r0
/* 805A5F38  4B A8 EA 85 */	bl isEventBit__11dSv_event_cCFUs
...
/* 805A5F50  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5F54  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A5F58  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 805A5F5C  7C 05 07 74 */	extsb r5, r0
/* 805A5F60  4B A8 F4 01 */	bl isSwitch__10dSv_info_cCFii
...
/* 805A5F80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A5F84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805A5FF0  4B DB C2 39 */	bl _restgpr_29
