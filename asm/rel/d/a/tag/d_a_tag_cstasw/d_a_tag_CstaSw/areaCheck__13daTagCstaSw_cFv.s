...
/* 805A21B0  4B DC 00 2C */	b _savegpr_29
/* 805A21B4  7C 7D 1B 78 */	mr r29, r3
/* 805A21B8  3C 60 80 5A */	lis r3, lit_3724@ha
/* 805A21BC  3B E3 25 2C */	addi r31, r3, lit_3724@l
/* 805A21C0  3B C0 00 00 */	li r30, 0
/* 805A21C4  3C 60 80 5A */	lis r3, searchSekizoAct__13daTagCstaSw_cFPvPv@ha
/* 805A21C8  38 63 21 50 */	addi r3, r3, searchSekizoAct__13daTagCstaSw_cFPvPv@l
/* 805A21CC  7F A4 EB 78 */	mr r4, r29
/* 805A21D0  4B A7 76 28 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 805A21F0  4B CC 49 44 */	b __mi__4cXyzCFRC3Vec
...
/* 805A2220  4B DA 4F 18 */	b PSVECSquareMag
...
/* 805A2290  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805A2294  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805A2300  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805A2304  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805A2308:
...
/* 805A232C  4B DB FE FC */	b _restgpr_29
