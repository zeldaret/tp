...
/* 805A4178  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805A417C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805A4180  38 80 00 10 */	li r4, 0x10
/* 805A4184  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 805A4188  38 DE 01 0C */	addi r6, r30, 0x10c
/* 805A418C  4B BF F6 39 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805A4190  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 805A4194  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 805A4198  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 805A419C  80 84 00 04 */	lwz r4, 4(r4)
/* 805A41A0  38 BE 01 0C */	addi r5, r30, 0x10c
/* 805A41A4  4B C0 0B FD */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 805A41A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A41AC  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A41B0  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 805A41B4  3C 60 80 43 */	lis r3, j3dSys@ha /* 0x80434AC8@ha */
/* 805A41B8  3B E3 4A C8 */	addi r31, r3, j3dSys@l /* 0x80434AC8@l */
...
/* 805A41CC  4B A6 9A F9 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 805A41D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A41D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
