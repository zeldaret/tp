...
/* 805A3DC0  3C 60 80 5A */	lis r3, __vt__12daTagHjump_c@ha
/* 805A3DC4  38 03 42 BC */	addi r0, r3, __vt__12daTagHjump_c@l
...
/* 805A3DDC  3C 80 80 5A */	lis r4, l_arcName@ha
/* 805A3DE0  38 84 42 38 */	addi r4, r4, l_arcName@l
/* 805A3DE4  4B A8 92 24 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
lbl_805A3DE8:
/* 805A3DE8  28 1E 00 00 */	cmplwi r30, 0
/* 805A3DEC  41 82 00 1C */	beq lbl_805A3E08
/* 805A3DF0  3C 60 80 3B */	lis r3, __vt__16dBgS_MoveBgActor@ha
/* 805A3DF4  38 03 B9 A0 */	addi r0, r3, __vt__16dBgS_MoveBgActor@l
/* 805A3DF8  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 805A3DFC  7F C3 F3 78 */	mr r3, r30
/* 805A3E00  38 80 00 00 */	li r4, 0
/* 805A3E04  4B A7 4E 88 */	b __dt__10fopAc_ac_cFv
lbl_805A3E08:
/* 805A3E08  7F E0 07 35 */	extsh. r0, r31
/* 805A3E0C  40 81 00 0C */	ble lbl_805A3E18
/* 805A3E10  7F C3 F3 78 */	mr r3, r30
/* 805A3E14  4B D2 AF 28 */	b __dl__FPv
lbl_805A3E18:
