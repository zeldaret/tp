...
/* 805A3E80  4B DB E3 55 */	bl _savegpr_27
/* 805A3E84  7C 7D 1B 78 */	mr r29, r3
/* 805A3E88  3C 60 80 5A */	lis r3, l_arcName@ha /* 0x805A4238@ha */
/* 805A3E8C  3B E3 42 38 */	addi r31, r3, l_arcName@l /* 0x805A4238@l */
/* 805A3E90  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A3E94  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 805A3EC4  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 805A3EC8  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 805A3ECC  7C 84 02 2E */	lhzx r4, r4, r0
/* 805A3ED0  4B A9 0A ED */	bl isEventBit__11dSv_event_cCFUs
...
/* 805A3EE8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A3EEC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A3EF0  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 805A3EF4  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 805A3EF8  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 805A3EFC  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 805A3F00  7C 84 02 2E */	lhzx r4, r4, r0
/* 805A3F04  4B A9 0A B9 */	bl isEventBit__11dSv_event_cCFUs
...
/* 805A3FC0  4B A7 99 41 */	bl fpoAcM_relativePos__FPC10fopAc_ac_cPC4cXyzP4cXyz
...
lbl_805A4070:
/* 805A4070  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 805A4074  38 03 9A 20 */	addi r0, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 805A40AC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha /* 0x80439A20@ha */
/* 805A40B0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l /* 0x80439A20@l */
...
/* 805A4120  4B DB E1 01 */	bl _restgpr_27
