...
/* 80D59C88  4B 2B EE DD */	bl __ct__10fopAc_ac_cFv
/* 80D59C8C  38 7E 05 68 */	addi r3, r30, 0x568
/* 80D59C90  4B 4F 02 71 */	bl __ct__10dMsgFlow_cFv
lbl_80D59C94:
...
/* 80D59CA4  4B 2D 2C D9 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 80D59CB8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D59CBC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D59CF8  4B 2D 2C 85 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 80D59D14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D59D18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D59D1C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80D59D20  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80D59D24  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80D59D28  4B 5E CB C1 */	bl PSMTXTrans
/* 80D59D2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D59D30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D59D34  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80D59D38  4B 2B 26 FD */	bl mDoMtx_YrotM__FPA4_fs
/* 80D59D3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D59D40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D59D44  38 9F 05 B4 */	addi r4, r31, 0x5b4
/* 80D59D48  4B 5E C8 69 */	bl PSMTXInverse
/* 80D59D4C  C0 1F 04 EC */	lfs f0, 0x4ec(r31)
/* 80D59D50  3C 60 80 D6 */	lis r3, lit_3907@ha /* 0x80D5A6EC@ha */
/* 80D59D54  C0 23 A6 EC */	lfs f1, lit_3907@l(r3)  /* 0x80D5A6EC@l */
...
/* 80D59D70  3C 60 80 D6 */	lis r3, lit_3908@ha /* 0x80D5A6F0@ha */
/* 80D59D74  C0 03 A6 F0 */	lfs f0, lit_3908@l(r3)  /* 0x80D5A6F0@l */
...
lbl_80D59D90:
/* 80D59D90  3C 60 80 D6 */	lis r3, m_master_id@ha /* 0x80D5A710@ha */
/* 80D59D94  38 63 A7 10 */	addi r3, r3, m_master_id@l /* 0x80D5A710@l */
...
lbl_80D59DBC:
/* 80D59DBC  3C 60 80 D6 */	lis r3, m_master_id@ha /* 0x80D5A710@ha */
/* 80D59DC0  90 03 A7 10 */	stw r0, m_master_id@l(r3)  /* 0x80D5A710@l */
lbl_80D59DC4:
