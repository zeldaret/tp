...
/* 80D5A228  4B 60 7F B1 */	bl _savegpr_28
/* 80D5A22C  7C 7D 1B 78 */	mr r29, r3
/* 80D5A230  3C 80 80 D6 */	lis r4, lit_3907@ha /* 0x80D5A6EC@ha */
/* 80D5A234  3B E4 A6 EC */	addi r31, r4, lit_3907@l /* 0x80D5A6EC@l */
/* 80D5A238  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5A23C  3B 84 61 C0 */	addi r28, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D5A284  4B 5E CA E9 */	bl PSMTXMultVec
...
lbl_80D5A2EC:
/* 80D5A2EC  3C 60 80 D6 */	lis r3, m_master_id@ha /* 0x80D5A710@ha */
/* 80D5A2F0  38 63 A7 10 */	addi r3, r3, m_master_id@l /* 0x80D5A710@l */
...
/* 80D5A3A0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D5A3A4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D5A3D0  4B 55 15 B5 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D5A430  4B 2C 14 D9 */	bl fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 80D5A448  3C 60 80 45 */	lis r3, g_blackColor@ha /* 0x80450604@ha */
/* 80D5A44C  38 63 06 04 */	addi r3, r3, g_blackColor@l /* 0x80450604@l */
/* 80D5A450  4B 2A DB 89 */	bl fadeOut__13mDoGph_gInf_cFfR8_GXColor
...
/* 80D5A46C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 0x80451368@ha */
/* 80D5A470  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 0x80451368@l */
...
/* 80D5A49C  4B 55 14 E9 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D5A50C  4B 42 71 35 */	bl dCam_getBody__Fv
/* 80D5A510  4B 40 6F C1 */	bl Stop__9dCamera_cFv
/* 80D5A514  4B 42 71 2D */	bl dCam_getBody__Fv
/* 80D5A518  38 80 00 03 */	li r4, 3
/* 80D5A51C  4B 40 8A F1 */	bl SetTrimSize__9dCamera_cFl
...
/* 80D5A534  4B 4E FA 5D */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 80D5A538  38 00 00 03 */	li r0, 3
/* 80D5A53C  98 1D 05 F6 */	stb r0, 0x5f6(r29)
/* 80D5A540  38 61 00 24 */	addi r3, r1, 0x24
/* 80D5A544  4B 31 D7 25 */	bl __ct__11dBgS_LinChkFv
...
/* 80D5A568  4B 31 D7 FD */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80D5A56C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5A570  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5A574  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80D5A578  38 81 00 24 */	addi r4, r1, 0x24
/* 80D5A57C  4B 31 9E 39 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 80D5A598  4B 31 D7 45 */	bl __dt__11dBgS_LinChkFv
...
/* 80D5A5D0  4B 4E FD 09 */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
/* 80D5A5D4  2C 03 00 00 */	cmpwi r3, 0
/* 80D5A5D8  41 82 00 8C */	beq lbl_80D5A664
/* 80D5A5DC  4B 4D DE 65 */	bl getSelectCursorPos__12dMsgObject_cFv
...
/* 80D5A604  4B 2C CB 6D */	bl dStage_changeScene__FifUlScsi
/* 80D5A608  48 00 00 54 */	b lbl_80D5A65C
lbl_80D5A60C:
/* 80D5A60C  3C 60 80 45 */	lis r3, mStayNo__20dStage_roomControl_c+0x0@ha /* 0x80450D64@ha */
/* 80D5A610  8B 83 0D 64 */	lbz r28, mStayNo__20dStage_roomControl_c+0x0@l(r3)  /* 0x80450D64@l */
/* 80D5A614  7F 9C 07 74 */	extsb r28, r28
/* 80D5A618  38 60 00 00 */	li r3, 0
/* 80D5A61C  4B 2D 23 61 */	bl getLayerNo__14dComIfG_play_cFi
...
/* 80D5A634  3C 60 80 D6 */	lis r3, d_a_tag_kago_fall__stringBase0@ha /* 0x80D5A708@ha */
/* 80D5A638  38 63 A7 08 */	addi r3, r3, d_a_tag_kago_fall__stringBase0@l /* 0x80D5A708@l */
