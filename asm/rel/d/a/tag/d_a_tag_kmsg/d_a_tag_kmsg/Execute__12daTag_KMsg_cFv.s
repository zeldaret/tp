...
/* 8048E028  4B ED 41 A5 */	bl _savegpr_25
/* 8048E02C  7C 7B 1B 78 */	mr r27, r3
/* 8048E030  3C 80 80 49 */	lis r4, lit_3884@ha /* 0x8048EADC@ha */
/* 8048E034  3B E4 EA DC */	addi r31, r4, lit_3884@l /* 0x8048EADC@l */
/* 8048E038  3B 80 00 00 */	li r28, 0
/* 8048E03C  88 03 04 BA */	lbz r0, 0x4ba(r3)
/* 8048E040  7C 05 07 74 */	extsb r5, r0
/* 8048E044  3C 80 80 45 */	lis r4, mStayNo__20dStage_roomControl_c+0x0@ha /* 0x80450D64@ha */
/* 8048E048  88 04 0D 64 */	lbz r0, mStayNo__20dStage_roomControl_c+0x0@l(r4)  /* 0x80450D64@l */
...
/* 8048E068  4B B8 BC 15 */	bl fopAcM_delete__FP10fopAc_ac_c
...
lbl_8048E108:
/* 8048E108  4B CB E9 11 */	bl daNpcT_getDistTableIdx__Fii
...
lbl_8048E1B0:
/* 8048E1B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8048E1B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_8048E1D0:
/* 8048E1D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8048E1D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8048E22C  3C 60 80 49 */	lis r3, l_evtList@ha /* 0x8048EB2C@ha */
/* 8048E230  3B 43 EB 2C */	addi r26, r3, l_evtList@l /* 0x8048EB2C@l */
/* 8048E234  7C 7A F0 2E */	lwzx r3, r26, r30
/* 8048E238  4B ED A9 AD */	bl strlen
/* 8048E23C  28 03 00 00 */	cmplwi r3, 0
/* 8048E240  41 82 02 B8 */	beq lbl_8048E4F8
/* 8048E244  3C 60 80 49 */	lis r3, l_evtList@ha /* 0x8048EB2C@ha */
/* 8048E248  38 03 EB 2C */	addi r0, r3, l_evtList@l /* 0x8048EB2C@l */
/* 8048E24C  7F 20 F2 14 */	add r25, r0, r30
/* 8048E250  84 19 00 04 */	lwzu r0, 4(r25)
/* 8048E254  54 00 10 3A */	slwi r0, r0, 2
/* 8048E258  3C 60 80 49 */	lis r3, l_resNameList@ha /* 0x8048EB44@ha */
/* 8048E25C  38 63 EB 44 */	addi r3, r3, l_resNameList@l /* 0x8048EB44@l */
/* 8048E260  7C 63 00 2E */	lwzx r3, r3, r0
/* 8048E264  4B ED A9 81 */	bl strlen
...
/* 8048E278  3C 60 80 49 */	lis r3, l_resNameList@ha /* 0x8048EB44@ha */
/* 8048E27C  38 63 EB 44 */	addi r3, r3, l_resNameList@l /* 0x8048EB44@l */
...
/* 8048E290  4B BB 85 71 */	bl setObjectArchive__16dEvent_manager_cFPc
lbl_8048E294:
...
/* 8048E2A4  4B BB 94 B5 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
/* 8048E2A8  B0 7B 05 C0 */	sth r3, 0x5c0(r27)
/* 8048E2AC  38 7D 3F 90 */	addi r3, r29, 0x3f90
/* 8048E2B0  7F 64 DB 78 */	mr r4, r27
/* 8048E2B4  4B BB 42 65 */	bl reset__14dEvt_control_cFPv
...
/* 8048E2CC  4B B8 D3 19 */	bl fopAcM_orderChangeEventId__FP10fopAc_ac_csUsUs
...
/* 8048E2F8  4B DB BC 99 */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 8048E314  4B DB BF C5 */	bl doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
/* 8048E318  2C 03 00 00 */	cmpwi r3, 0
/* 8048E31C  41 82 01 DC */	beq lbl_8048E4F8
/* 8048E320  38 7D 3F 90 */	addi r3, r29, 0x3f90
/* 8048E324  4B BB 41 45 */	bl reset__14dEvt_control_cFv
...
/* 8048E36C  3C 80 80 49 */	lis r4, d_a_tag_kmsg__stringBase0@ha /* 0x8048EAFC@ha */
/* 8048E370  38 84 EA FC */	addi r4, r4, d_a_tag_kmsg__stringBase0@l /* 0x8048EAFC@l */
/* 8048E374  38 84 00 2B */	addi r4, r4, 0x2b
/* 8048E378  7F 65 DB 78 */	mr r5, r27
/* 8048E37C  38 C0 FF FF */	li r6, -1
/* 8048E380  4B BB 97 9D */	bl getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 8048E394  4B BB 9D E9 */	bl cutEnd__16dEvent_manager_cFi
...
/* 8048E3D8  4B B8 E7 C9 */	bl fopAcM_cancelCarryNow__FP10fopAc_ac_c
/* 8048E3DC  3C 60 80 49 */	lis r3, l_evtList@ha /* 0x8048EB2C@ha */
/* 8048E3E0  3B 43 EB 2C */	addi r26, r3, l_evtList@l /* 0x8048EB2C@l */
/* 8048E3E4  80 7A 00 08 */	lwz r3, 8(r26)
/* 8048E3E8  4B ED A7 FD */	bl strlen
/* 8048E3EC  28 03 00 00 */	cmplwi r3, 0
/* 8048E3F0  41 82 01 08 */	beq lbl_8048E4F8
/* 8048E3F4  3C 60 80 49 */	lis r3, l_evtList@ha /* 0x8048EB2C@ha */
/* 8048E3F8  3B C3 EB 2C */	addi r30, r3, l_evtList@l /* 0x8048EB2C@l */
/* 8048E3FC  80 1E 00 0C */	lwz r0, 0xc(r30)
/* 8048E400  54 00 10 3A */	slwi r0, r0, 2
/* 8048E404  3C 60 80 49 */	lis r3, l_resNameList@ha /* 0x8048EB44@ha */
/* 8048E408  38 63 EB 44 */	addi r3, r3, l_resNameList@l /* 0x8048EB44@l */
/* 8048E40C  7C 63 00 2E */	lwzx r3, r3, r0
/* 8048E410  4B ED A7 D5 */	bl strlen
...
/* 8048E424  3C 60 80 49 */	lis r3, l_resNameList@ha /* 0x8048EB44@ha */
/* 8048E428  38 63 EB 44 */	addi r3, r3, l_resNameList@l /* 0x8048EB44@l */
...
/* 8048E43C  4B BB 83 C5 */	bl setObjectArchive__16dEvent_manager_cFPc
lbl_8048E440:
...
/* 8048E450  4B BB 93 09 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 8048E474  4B B8 D2 09 */	bl fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs
...
/* 8048E4AC  4B CB E1 35 */	bl daNpcT_chkDoBtnIsSpeak__FP10fopAc_ac_c
...
/* 8048E4C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8048E4CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8048E4E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 8048E4E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8048E760  4B DE 28 39 */	bl __ct__7cSAngleFs
...
/* 8048E788  4B DE 29 71 */	bl Sin__7cSAngleCFv
...
/* 8048E7AC  4B DE 29 75 */	bl Cos__7cSAngleCFv
...
/* 8048E7C8  4B BE 94 A1 */	bl __ct__11dBgS_LinChkFv
...
/* 8048E7F4  4B BE 95 71 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8048E7F8  7F A3 EB 78 */	mr r3, r29
/* 8048E7FC  38 81 00 6C */	addi r4, r1, 0x6c
/* 8048E800  4B BE 5B B5 */	bl LineCross__4cBgSFP11cBgS_LinChk
...
/* 8048E818  4B DD 83 1D */	bl __mi__4cXyzCFRC3Vec
...
/* 8048E888  4B BE 94 55 */	bl __dt__11dBgS_LinChkFv
lbl_8048E88C:
...
/* 8048E8A4  4B ED 39 75 */	bl _restgpr_25
