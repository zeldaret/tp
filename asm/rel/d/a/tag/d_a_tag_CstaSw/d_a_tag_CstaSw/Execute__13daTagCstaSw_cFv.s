...
/* 805A2364  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A2368  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A236C  88 9F 05 68 */	lbz r4, 0x568(r31)
/* 805A2370  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A2374  7C 05 07 74 */	extsb r5, r0
/* 805A2378  4B A9 2F E9 */	bl isSwitch__10dSv_info_cCFii
/* 805A237C  2C 03 00 00 */	cmpwi r3, 0
/* 805A2380  40 82 00 58 */	bne lbl_805A23D8
/* 805A2384  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A2388  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A238C  88 9F 05 68 */	lbz r4, 0x568(r31)
/* 805A2390  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A2394  7C 05 07 74 */	extsb r5, r0
/* 805A2398  4B A9 2E 69 */	bl onSwitch__10dSv_info_cFii
/* 805A239C  48 00 00 3C */	b lbl_805A23D8
lbl_805A23A0:
/* 805A23A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A23A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A23A8  88 9F 05 68 */	lbz r4, 0x568(r31)
/* 805A23AC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A23B0  7C 05 07 74 */	extsb r5, r0
/* 805A23B4  4B A9 2F AD */	bl isSwitch__10dSv_info_cCFii
/* 805A23B8  2C 03 00 00 */	cmpwi r3, 0
/* 805A23BC  41 82 00 1C */	beq lbl_805A23D8
/* 805A23C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A23C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A23C8  88 9F 05 68 */	lbz r4, 0x568(r31)
/* 805A23CC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A23D0  7C 05 07 74 */	extsb r5, r0
/* 805A23D4  4B A9 2E DD */	bl offSwitch__10dSv_info_cFii
lbl_805A23D8:
