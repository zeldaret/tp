...
/* 80D5BB48  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha /* 0x80451018@ha */
/* 80D5BB4C  80 03 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r3)  /* 0x80451018@l */
...
/* 80D5BB6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5BB70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5BB74  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D5BB78  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 80D5BB7C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80D5BB80  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80D5BB84  7C 84 02 2E */	lhzx r4, r4, r0
/* 80D5BB88  4B 2D 8E 35 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80D5BBA8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5BBAC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5BBB0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D5BBB4  7C 05 07 74 */	extsb r5, r0
/* 80D5BBB8  4B 2D 97 A9 */	bl isSwitch__10dSv_info_cCFii
/* 80D5BBBC  2C 03 00 00 */	cmpwi r3, 0
/* 80D5BBC0  41 82 00 14 */	beq lbl_80D5BBD4
/* 80D5BBC4  7F E3 FB 78 */	mr r3, r31
/* 80D5BBC8  4B 2B E0 B5 */	bl fopAcM_delete__FP10fopAc_ac_c
...
/* 80D5BBE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5BBE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D5BC14  4B 2D 95 ED */	bl onSwitch__10dSv_info_cFii
/* 80D5BC18  7F E3 FB 78 */	mr r3, r31
/* 80D5BC1C  4B 2B E0 61 */	bl fopAcM_delete__FP10fopAc_ac_c
/* 80D5BC20  38 60 00 01 */	li r3, 1
/* 80D5BC24  48 00 00 CC */	b lbl_80D5BCF0
lbl_80D5BC28:
/* 80D5BC28  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5BC2C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D5BC60  4B 2B EE 35 */	bl fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80D5BC7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5BC80  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5BC84  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D5BC88  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 80D5BC8C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80D5BC90  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80D5BC94  7C 84 02 2E */	lhzx r4, r4, r0
/* 80D5BC98  4B 2D 8D 25 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80D5BCB0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5BCB4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5BCB8  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D5BCBC  7C 05 07 74 */	extsb r5, r0
/* 80D5BCC0  4B 2D 96 A1 */	bl isSwitch__10dSv_info_cCFii
