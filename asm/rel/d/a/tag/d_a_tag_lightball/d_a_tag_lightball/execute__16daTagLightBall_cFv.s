...
/* 80D5AA60  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5AA64  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5AA68  7F E4 FB 78 */	mr r4, r31
/* 80D5AA6C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80D5AA70  7C 05 07 74 */	extsb r5, r0
/* 80D5AA74  4B 2D A8 ED */	bl isSwitch__10dSv_info_cCFii
/* 80D5AA78  2C 03 00 00 */	cmpwi r3, 0
/* 80D5AA7C  40 82 00 18 */	bne lbl_80D5AA94
/* 80D5AA80  38 7E 05 68 */	addi r3, r30, 0x568
/* 80D5AA84  4B 44 CD E5 */	bl dKy_dalkmist_inf_cut__FP18DALKMIST_INFLUENCE
...
/* 80D5AAA0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5AAA4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5AAA8  7F E4 FB 78 */	mr r4, r31
/* 80D5AAAC  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80D5AAB0  7C 05 07 74 */	extsb r5, r0
/* 80D5AAB4  4B 2D A8 AD */	bl isSwitch__10dSv_info_cCFii
/* 80D5AAB8  2C 03 00 00 */	cmpwi r3, 0
/* 80D5AABC  41 82 00 94 */	beq lbl_80D5AB50
/* 80D5AAC0  38 7E 05 68 */	addi r3, r30, 0x568
/* 80D5AAC4  4B 44 CD 51 */	bl dKy_dalkmist_inf_set__FP18DALKMIST_INFLUENCE
...
/* 80D5AAE0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5AAE4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5AAE8  7F E4 FB 78 */	mr r4, r31
/* 80D5AAEC  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80D5AAF0  7C 05 07 74 */	extsb r5, r0
/* 80D5AAF4  4B 2D A8 6D */	bl isSwitch__10dSv_info_cCFii
/* 80D5AAF8  2C 03 00 00 */	cmpwi r3, 0
/* 80D5AAFC  41 82 00 18 */	beq lbl_80D5AB14
/* 80D5AB00  38 7E 05 68 */	addi r3, r30, 0x568
/* 80D5AB04  4B 44 CD 65 */	bl dKy_dalkmist_inf_cut__FP18DALKMIST_INFLUENCE
...
/* 80D5AB20  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5AB24  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5AB28  7F E4 FB 78 */	mr r4, r31
/* 80D5AB2C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80D5AB30  7C 05 07 74 */	extsb r5, r0
/* 80D5AB34  4B 2D A8 2D */	bl isSwitch__10dSv_info_cCFii
/* 80D5AB38  2C 03 00 00 */	cmpwi r3, 0
/* 80D5AB3C  40 82 00 14 */	bne lbl_80D5AB50
/* 80D5AB40  38 7E 05 68 */	addi r3, r30, 0x568
/* 80D5AB44  4B 44 CC D1 */	bl dKy_dalkmist_inf_set__FP18DALKMIST_INFLUENCE
...
/* 80D5AB68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5AB6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5AB70  7F E4 FB 78 */	mr r4, r31
/* 80D5AB74  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80D5AB78  7C 05 07 74 */	extsb r5, r0
/* 80D5AB7C  4B 2D A7 E5 */	bl isSwitch__10dSv_info_cCFii
