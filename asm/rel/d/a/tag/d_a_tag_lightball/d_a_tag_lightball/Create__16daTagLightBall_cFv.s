...
/* 80D5A8A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5A8A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5A8A8  38 80 00 46 */	li r4, 0x46
/* 80D5A8AC  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80D5A8B0  7C 05 07 74 */	extsb r5, r0
/* 80D5A8B4  4B 2D AA AD */	bl isSwitch__10dSv_info_cCFii
/* 80D5A8B8  2C 03 00 00 */	cmpwi r3, 0
/* 80D5A8BC  40 82 00 1C */	bne lbl_80D5A8D8
/* 80D5A8C0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5A8C4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5A8C8  7F E4 FB 78 */	mr r4, r31
/* 80D5A8CC  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80D5A8D0  7C 05 07 74 */	extsb r5, r0
/* 80D5A8D4  4B 2D A9 DD */	bl offSwitch__10dSv_info_cFii
lbl_80D5A8D8:
...
/* 80D5A8F0  3C 60 80 D6 */	lis r3, lit_3682@ha /* 0x80D5AC78@ha */
/* 80D5A8F4  C0 23 AC 78 */	lfs f1, lit_3682@l(r3)  /* 0x80D5AC78@l */
