...
/* 805A3138  3C 60 80 5A */	lis r3, __vt__14daTagAtkItem_c@ha /* 0x805A3388@ha */
/* 805A313C  38 63 33 88 */	addi r3, r3, __vt__14daTagAtkItem_c@l /* 0x805A3388@l */
...
/* 805A3154  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha /* 0x803AC050@ha */
/* 805A3158  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 0x803AC050@l */
...
/* 805A3178  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha /* 0x803C35A4@ha */
/* 805A317C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 0x803C35A4@l */
...
/* 805A3194  3C 60 80 5A */	lis r3, __vt__8cM3dGCyl@ha /* 0x805A33CC@ha */
/* 805A3198  38 03 33 CC */	addi r0, r3, __vt__8cM3dGCyl@l /* 0x805A33CC@l */
/* 805A319C  90 1E 06 F8 */	stw r0, 0x6f8(r30)
lbl_805A31A0:
/* 805A31A0  34 1E 06 C4 */	addic. r0, r30, 0x6c4
/* 805A31A4  41 82 00 24 */	beq lbl_805A31C8
/* 805A31A8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 0x803C36D0@ha */
/* 805A31AC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 0x803C36D0@l */
/* 805A31B0  90 1E 06 E0 */	stw r0, 0x6e0(r30)
/* 805A31B4  34 1E 06 C4 */	addic. r0, r30, 0x6c4
/* 805A31B8  41 82 00 10 */	beq lbl_805A31C8
/* 805A31BC  3C 60 80 5A */	lis r3, __vt__8cM3dGAab@ha /* 0x805A33D8@ha */
/* 805A31C0  38 03 33 D8 */	addi r0, r3, __vt__8cM3dGAab@l /* 0x805A33D8@l */
/* 805A31C4  90 1E 06 DC */	stw r0, 0x6dc(r30)
lbl_805A31C8:
/* 805A31C8  38 7E 05 C0 */	addi r3, r30, 0x5c0
/* 805A31CC  38 80 00 00 */	li r4, 0
/* 805A31D0  4B AE 0F 15 */	bl __dt__12dCcD_GObjInfFv
lbl_805A31D4:
/* 805A31D4  34 1E 05 84 */	addic. r0, r30, 0x584
/* 805A31D8  41 82 00 54 */	beq lbl_805A322C
/* 805A31DC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha /* 0x803AC2E4@ha */
/* 805A31E0  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l /* 0x803AC2E4@l */
...
/* 805A31F8  3C 60 80 5A */	lis r3, __vt__10dCcD_GStts@ha /* 0x805A33C0@ha */
/* 805A31FC  38 03 33 C0 */	addi r0, r3, __vt__10dCcD_GStts@l /* 0x805A33C0@l */
/* 805A3200  90 1E 05 A0 */	stw r0, 0x5a0(r30)
/* 805A3204  34 1E 05 A0 */	addic. r0, r30, 0x5a0
/* 805A3208  41 82 00 10 */	beq lbl_805A3218
/* 805A320C  3C 60 80 5A */	lis r3, __vt__10cCcD_GStts@ha /* 0x805A33B4@ha */
/* 805A3210  38 03 33 B4 */	addi r0, r3, __vt__10cCcD_GStts@l /* 0x805A33B4@l */
/* 805A3214  90 1E 05 A0 */	stw r0, 0x5a0(r30)
lbl_805A3218:
/* 805A3218  34 1E 05 84 */	addic. r0, r30, 0x584
/* 805A321C  41 82 00 10 */	beq lbl_805A322C
/* 805A3220  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha /* 0x803C3728@ha */
/* 805A3224  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l /* 0x803C3728@l */
/* 805A3228  90 1E 05 9C */	stw r0, 0x59c(r30)
lbl_805A322C:
/* 805A322C  34 1E 05 68 */	addic. r0, r30, 0x568
/* 805A3230  41 82 00 10 */	beq lbl_805A3240
/* 805A3234  3C 60 80 5A */	lis r3, __vt__17dEvLib_callback_c@ha /* 0x805A33E4@ha */
/* 805A3238  38 03 33 E4 */	addi r0, r3, __vt__17dEvLib_callback_c@l /* 0x805A33E4@l */
/* 805A323C  90 1E 05 68 */	stw r0, 0x568(r30)
lbl_805A3240:
/* 805A3240  7F C3 F3 78 */	mr r3, r30
/* 805A3244  38 80 00 00 */	li r4, 0
/* 805A3248  4B A7 5A 45 */	bl __dt__10fopAc_ac_cFv
/* 805A324C  7F E0 07 35 */	extsh. r0, r31
/* 805A3250  40 81 00 0C */	ble lbl_805A325C
/* 805A3254  7F C3 F3 78 */	mr r3, r30
/* 805A3258  4B D2 BA E5 */	bl __dl__FPv
lbl_805A325C:
