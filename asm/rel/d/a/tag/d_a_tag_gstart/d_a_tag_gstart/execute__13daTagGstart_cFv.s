...
/* 805A35B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A35B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A35B8  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A35BC  7C 05 07 74 */	extsb r5, r0
/* 805A35C0  4B A9 1D A1 */	bl isSwitch__10dSv_info_cCFii
...
/* 805A35D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A35DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 805A35E0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A35E4  7C 05 07 74 */	extsb r5, r0
/* 805A35E8  4B A9 1D 79 */	bl isSwitch__10dSv_info_cCFii
...
/* 805A3600  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A3604  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_805A3618:
/* 805A3618  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 805A361C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
