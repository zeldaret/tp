...
/* 804D53C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D53CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804D53E0  4B D9 17 55 */	bl __mi__4cXyzCFRC3Vec
...
/* 804D53FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804D5400  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804D5404  A8 1E 04 E6 */	lha r0, 0x4e6(r30)
/* 804D5408  7C 00 00 D0 */	neg r0, r0
/* 804D540C  7C 04 07 34 */	extsh r4, r0
/* 804D5410  4B B3 6F CD */	bl mDoMtx_YrotS__FPA4_fs
/* 804D5414  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 804D5418  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 804D541C  38 81 00 14 */	addi r4, r1, 0x14
/* 804D5420  7C 85 23 78 */	mr r5, r4
/* 804D5424  4B E7 19 49 */	bl PSMTXMultVec
...
/* 804D5438  3C 60 80 4D */	lis r3, lit_3773@ha /* 0x804D572C@ha */
/* 804D543C  38 63 57 2C */	addi r3, r3, lit_3773@l /* 0x804D572C@l */
...
/* 804D5454  3C 60 80 4D */	lis r3, lit_3772@ha /* 0x804D5728@ha */
/* 804D5458  C0 03 57 28 */	lfs f0, lit_3772@l(r3)  /* 0x804D5728@l */
...
/* 804D5470  3C 60 80 4D */	lis r3, lit_3772@ha /* 0x804D5728@ha */
/* 804D5474  C0 03 57 28 */	lfs f0, lit_3772@l(r3)  /* 0x804D5728@l */
...
/* 804D548C  3C 60 80 4D */	lis r3, lit_3772@ha /* 0x804D5728@ha */
/* 804D5490  C0 03 57 28 */	lfs f0, lit_3772@l(r3)  /* 0x804D5728@l */
...
/* 804D54A8  3C 60 80 4D */	lis r3, lit_3772@ha /* 0x804D5728@ha */
/* 804D54AC  C0 23 57 28 */	lfs f1, lit_3772@l(r3)  /* 0x804D5728@l */
...
/* 804D54D0  3C 60 80 4D */	lis r3, lit_3772@ha /* 0x804D5728@ha */
/* 804D54D4  C0 23 57 28 */	lfs f1, lit_3772@l(r3)  /* 0x804D5728@l */
...
lbl_804D54F0:
/* 804D54F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D54F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D54F8  54 84 86 3E */	rlwinm r4, r4, 0x10, 0x18, 0x1f
/* 804D54FC  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 804D5500  7C 05 07 74 */	extsb r5, r0
/* 804D5504  4B B5 FE 5D */	bl isSwitch__10dSv_info_cCFii
...
lbl_804D5540:
/* 804D5540  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D5544  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804D5560:
/* 804D5560  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D5564  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804D55B8:
/* 804D55B8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D55BC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
lbl_804D55D8:
/* 804D55D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D55DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 804D5608  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 804D560C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 804D5610  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 804D5614  7C 05 07 74 */	extsb r5, r0
/* 804D5618  4B B5 FD 49 */	bl isSwitch__10dSv_info_cCFii
