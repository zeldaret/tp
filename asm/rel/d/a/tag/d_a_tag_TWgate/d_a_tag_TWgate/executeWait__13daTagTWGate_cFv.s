...
/* 80D52620  3C 60 80 D5 */	lis r3, lit_3857@ha /* 0x80D55820@ha */
/* 80D52624  C0 23 58 20 */	lfs f1, lit_3857@l(r3)  /* 0x80D55820@l */
/* 80D52628  C0 1F 04 EC */	lfs f0, 0x4ec(r31)
/* 80D5262C  EC 21 00 32 */	fmuls f1, f1, f0
/* 80D52630  3C 60 80 D5 */	lis r3, lit_3858@ha /* 0x80D55824@ha */
/* 80D52634  C8 43 58 24 */	lfd f2, lit_3858@l(r3)  /* 0x80D55824@l */
/* 80D52638  4B 61 A1 49 */	bl pow
/* 80D5263C  FF E0 08 18 */	frsp f31, f1
/* 80D52640  7F E3 FB 78 */	mr r3, r31
/* 80D52644  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D52648  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80D5264C  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 80D52650  4B 2C 84 45 */	bl fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
lbl_80D5269C:
/* 80D5269C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D526A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D526B4  4B 2E 2C AD */	bl isSwitch__10dSv_info_cCFii
...
/* 80D526D0  3C 60 80 D5 */	lis r3, ActionTable__13daTagTWGate_c@ha /* 0x80D55AD0@ha */
/* 80D526D4  38 03 5A D0 */	addi r0, r3, ActionTable__13daTagTWGate_c@l /* 0x80D55AD0@l */
...
/* 80D526E8  4B 60 F9 9D */	bl __ptmf_scall
...
/* 80D52704  3C 60 80 D5 */	lis r3, ActionTable__13daTagTWGate_c@ha /* 0x80D55AD0@ha */
/* 80D52708  38 03 5A D0 */	addi r0, r3, ActionTable__13daTagTWGate_c@l /* 0x80D55AD0@l */
...
/* 80D5271C  4B 60 F9 69 */	bl __ptmf_scall
/* 80D52720  60 00 00 00 */	nop 
/* 80D52724  48 00 01 B0 */	b lbl_80D528D4
lbl_80D52728:
/* 80D52728  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5272C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D52740  4B 2E 2C 21 */	bl isSwitch__10dSv_info_cCFii
...
/* 80D5275C  3C 60 80 D5 */	lis r3, ActionTable__13daTagTWGate_c@ha /* 0x80D55AD0@ha */
/* 80D52760  38 03 5A D0 */	addi r0, r3, ActionTable__13daTagTWGate_c@l /* 0x80D55AD0@l */
...
/* 80D52774  4B 60 F9 11 */	bl __ptmf_scall
...
/* 80D52790  3C 60 80 D5 */	lis r3, ActionTable__13daTagTWGate_c@ha /* 0x80D55AD0@ha */
/* 80D52794  38 03 5A D0 */	addi r0, r3, ActionTable__13daTagTWGate_c@l /* 0x80D55AD0@l */
...
/* 80D527A8  4B 60 F8 DD */	bl __ptmf_scall
/* 80D527AC  60 00 00 00 */	nop 
/* 80D527B0  48 00 01 24 */	b lbl_80D528D4
lbl_80D527B4:
/* 80D527B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D527B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D527CC  4B 2E 2B 95 */	bl isSwitch__10dSv_info_cCFii
...
/* 80D527E8  3C 60 80 D5 */	lis r3, ActionTable__13daTagTWGate_c@ha /* 0x80D55AD0@ha */
/* 80D527EC  38 03 5A D0 */	addi r0, r3, ActionTable__13daTagTWGate_c@l /* 0x80D55AD0@l */
...
/* 80D52800  4B 60 F8 85 */	bl __ptmf_scall
...
/* 80D5281C  3C 60 80 D5 */	lis r3, ActionTable__13daTagTWGate_c@ha /* 0x80D55AD0@ha */
/* 80D52820  38 03 5A D0 */	addi r0, r3, ActionTable__13daTagTWGate_c@l /* 0x80D55AD0@l */
...
/* 80D52834  4B 60 F8 51 */	bl __ptmf_scall
/* 80D52838  60 00 00 00 */	nop 
/* 80D5283C  48 00 00 98 */	b lbl_80D528D4
lbl_80D52840:
/* 80D52840  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D52844  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D52858  4B 2E 2B 09 */	bl isSwitch__10dSv_info_cCFii
...
/* 80D52874  3C 60 80 D5 */	lis r3, ActionTable__13daTagTWGate_c@ha /* 0x80D55AD0@ha */
/* 80D52878  38 03 5A D0 */	addi r0, r3, ActionTable__13daTagTWGate_c@l /* 0x80D55AD0@l */
...
/* 80D5288C  4B 60 F7 F9 */	bl __ptmf_scall
...
/* 80D528A8  3C 60 80 D5 */	lis r3, ActionTable__13daTagTWGate_c@ha /* 0x80D55AD0@ha */
/* 80D528AC  38 03 5A D0 */	addi r0, r3, ActionTable__13daTagTWGate_c@l /* 0x80D55AD0@l */
...
/* 80D528C0  4B 60 F7 C5 */	bl __ptmf_scall
