...
/* 80D5FE04  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80D5FE08  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80D5FE2C  4B 50 6D 09 */	bl __mi__4cXyzCFRC3Vec
...
/* 80D5FE48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D5FE4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D5FE50  A8 1F 04 DE */	lha r0, 0x4de(r31)
/* 80D5FE54  7C 00 00 D0 */	neg r0, r0
/* 80D5FE58  7C 04 07 34 */	extsh r4, r0
/* 80D5FE5C  4B 2A C5 81 */	bl mDoMtx_YrotS__FPA4_fs
/* 80D5FE60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha /* 0x803DD470@ha */
/* 80D5FE64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 0x803DD470@l */
/* 80D5FE68  38 81 00 14 */	addi r4, r1, 0x14
/* 80D5FE6C  7C 85 23 78 */	mr r5, r4
/* 80D5FE70  4B 5E 6E FD */	bl PSMTXMultVec
/* 80D5FE74  3C 60 80 D6 */	lis r3, lit_3853@ha /* 0x80D5FFB0@ha */
/* 80D5FE78  C0 03 FF B0 */	lfs f0, lit_3853@l(r3)  /* 0x80D5FFB0@l */
