...
/* 80946514  3C 60 80 95 */	lis r3, daMyna_LightActor@ha
/* 80946518  80 03 BA C0 */	lwz r0, daMyna_LightActor@l(r3)
/* 8094651C  28 00 00 00 */	cmplwi r0, 0
/* 80946520  40 82 00 14 */	bne lbl_80946534
/* 80946524  3C 60 80 94 */	lis r3, daMyna_searchLight__FPvPv@ha
/* 80946528  38 63 5D 9C */	addi r3, r3, daMyna_searchLight__FPvPv@l
/* 8094652C  7F 64 DB 78 */	mr r4, r27
/* 80946530  4B 6D AE 08 */	b fpcEx_Search__FPFPvPv_PvPv
lbl_80946534:
/* 80946534  7F 63 DB 78 */	mr r3, r27
/* 80946538  48 00 30 0D */	bl setRoomNo__8daMyna_cFv
/* 8094653C  C0 5B 04 D8 */	lfs f2, 0x4d8(r27)
/* 80946540  3C 60 80 95 */	lis r3, lit_4207@ha
/* 80946544  C0 23 B1 F4 */	lfs f1, lit_4207@l(r3)
...
/* 80946598  4B 90 3F B0 */	b getMsg__10dMsgFlow_cFv
...
/* 809465D4  3C 80 80 95 */	lis r4, move_proc@ha
/* 809465D8  38 04 B6 98 */	addi r0, r4, move_proc@l
/* 809465DC  7D 80 2A 14 */	add r12, r0, r5
/* 809465E0  4B A1 BA A4 */	b __ptmf_scall
...
/* 80946620  3C 80 80 95 */	lis r4, init_proc@ha
/* 80946624  38 04 B4 88 */	addi r0, r4, init_proc@l
/* 80946628  7D 80 2A 14 */	add r12, r0, r5
/* 8094662C  4B A1 BA 58 */	b __ptmf_scall
...
/* 80946648  3C 60 80 95 */	lis r3, lit_4208@ha
/* 8094664C  C0 23 B1 F8 */	lfs f1, lit_4208@l(r3)
/* 80946650  4B 92 13 04 */	b cM_rndF__Ff
/* 80946654  3C 60 80 95 */	lis r3, lit_4208@ha
/* 80946658  C0 03 B1 F8 */	lfs f0, lit_4208@l(r3)
...
/* 809466C4  4B A1 BB 5C */	b _restgpr_27
