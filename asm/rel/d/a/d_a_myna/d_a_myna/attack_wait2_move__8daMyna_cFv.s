...
/* 809481C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809481CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 8094820C  4B 92 83 35 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80948224  4B 92 83 1D */	bl cLib_addCalcAngleS__FPsssss
...
lbl_8094825C:
/* 8094825C  3C 60 80 95 */	lis r3, daMyna_evtTagActor0@ha /* 0x8094BAC8@ha */
/* 80948260  80 03 BA C8 */	lwz r0, daMyna_evtTagActor0@l(r3)  /* 0x8094BAC8@l */
/* 80948264  28 00 00 00 */	cmplwi r0, 0
/* 80948268  41 82 01 0C */	beq lbl_80948374
/* 8094826C  3C 60 80 95 */	lis r3, lit_4270@ha /* 0x8094B1FC@ha */
/* 80948270  C0 03 B1 FC */	lfs f0, lit_4270@l(r3)  /* 0x8094B1FC@l */
/* 80948274  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80948278  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 8094827C  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80948280  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80948284  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
/* 80948288  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 8094828C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80948290  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80948294  A0 84 06 44 */	lhz r4, 0x644(r4)
/* 80948298  4B 6E C7 25 */	bl isEventBit__11dSv_event_cCFUs
...
/* 809482C0  3C 80 80 95 */	lis r4, daMyna_evtTagActor0@ha /* 0x8094BAC8@ha */
/* 809482C4  38 84 BA C8 */	addi r4, r4, daMyna_evtTagActor0@l /* 0x8094BAC8@l */
...
/* 8094832C  4B 6D 2E 71 */	bl fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
...
/* 8094834C  3C 60 80 95 */	lis r3, l_HOSTIO@ha /* 0x8094BA3C@ha */
/* 80948350  38 63 BA 3C */	addi r3, r3, l_HOSTIO@l /* 0x8094BA3C@l */
