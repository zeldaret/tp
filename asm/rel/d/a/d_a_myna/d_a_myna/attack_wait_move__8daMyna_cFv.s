...
/* 80946960  4B 92 9B E1 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80946978  4B 92 9B C9 */	bl cLib_addCalcAngleS__FPsssss
...
lbl_809469B0:
/* 809469B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 809469B4  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 809469C8  3C 60 80 95 */	lis r3, daMyna_evtTagActor0@ha /* 0x8094BAC8@ha */
/* 809469CC  80 03 BA C8 */	lwz r0, daMyna_evtTagActor0@l(r3)  /* 0x8094BAC8@l */
/* 809469D0  28 00 00 00 */	cmplwi r0, 0
/* 809469D4  41 82 01 04 */	beq lbl_80946AD8
/* 809469D8  3C 60 80 95 */	lis r3, lit_4270@ha /* 0x8094B1FC@ha */
/* 809469DC  C0 03 B1 FC */	lfs f0, lit_4270@l(r3)  /* 0x8094B1FC@l */
...
/* 809469F4  4B 6E DE 6D */	bl isSwitch__12dSv_memBit_cCFi
...
/* 80946A1C  3C 80 80 95 */	lis r4, daMyna_evtTagActor0@ha /* 0x8094BAC8@ha */
/* 80946A20  38 84 BA C8 */	addi r4, r4, daMyna_evtTagActor0@l /* 0x8094BAC8@l */
...
/* 80946A5C  4B 6D 47 41 */	bl fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
...
/* 80946A88  3C 60 80 95 */	lis r3, l_HOSTIO@ha /* 0x8094BA3C@ha */
/* 80946A8C  38 63 BA 3C */	addi r3, r3, l_HOSTIO@l /* 0x8094BA3C@l */
...
/* 80946AC0  4B 6D 46 DD */	bl fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
