...
/* 80949C54  4B A1 85 7D */	bl _savegpr_26
/* 80949C58  7C 7E 1B 78 */	mr r30, r3
/* 80949C5C  3B E0 00 00 */	li r31, 0
/* 80949C60  3B A0 00 00 */	li r29, 0
/* 80949C64  3C 60 80 3A */	lis r3, saveBitLabels__16dSv_event_flag_c@ha /* 0x803A7288@ha */
/* 80949C68  3B 83 72 88 */	addi r28, r3, saveBitLabels__16dSv_event_flag_c@l /* 0x803A7288@l */
/* 80949C6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha /* 0x804061C0@ha */
/* 80949C70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l /* 0x804061C0@l */
...
/* 80949C8C  4B 6D 77 11 */	bl fpcEx_IsExist__FUi
...
/* 80949CB8  4B 8E EA 79 */	bl dMsgObject_addTotalPrice__Fs
/* 80949CBC  80 7A 08 6C */	lwz r3, 0x86c(r26)
/* 80949CC0  4B 6C FF F9 */	bl fopAcM_delete__FUi
/* 80949CC4  3C 60 80 95 */	lis r3, lit_4270@ha /* 0x8094B1FC@ha */
/* 80949CC8  C0 03 B1 FC */	lfs f0, lit_4270@l(r3)  /* 0x8094B1FC@l */
/* 80949CCC  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80949CD0  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80949CD4  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80949CD8  3C 60 80 95 */	lis r3, daMyna_evtTagActor0@ha /* 0x8094BAC8@ha */
/* 80949CDC  80 83 BA C8 */	lwz r4, daMyna_evtTagActor0@l(r3)  /* 0x8094BAC8@l */
...
/* 80949D14  4B 6E AC A9 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80949D28  4B 6E AC 65 */	bl onEventBit__11dSv_event_cFUs
lbl_80949D2C:
...
/* 80949D40  4B A1 84 DD */	bl _restgpr_26
