...
/* 8094641C  4B A1 BD C1 */	bl _savegpr_29
...
/* 80946430  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 80946434  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80946438  38 80 00 00 */	li r4, 0
/* 8094643C  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80946440  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80946444  4B 85 D3 81 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80946448  3C 60 80 43 */	lis r3, g_env_light@ha /* 0x8042CA54@ha */
/* 8094644C  38 63 CA 54 */	addi r3, r3, g_env_light@l /* 0x8042CA54@l */
/* 80946450  80 9F 00 04 */	lwz r4, 4(r31)
/* 80946454  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80946458  4B 85 E9 49 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80946480  4B 6C 71 69 */	bl entry__13mDoExt_btpAnmFP16J3DMaterialTables
lbl_80946484:
/* 80946484  7F A3 EB 78 */	mr r3, r29
/* 80946488  7F C4 F3 78 */	mr r4, r30
/* 8094648C  4B 6D 6F A1 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 80946490  80 7D 05 74 */	lwz r3, 0x574(r29)
/* 80946494  4B 6C AD 2D */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 809464AC  4B 9E 92 4D */	bl removeTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern
lbl_809464B0:
/* 809464B0  38 60 00 01 */	li r3, 1
/* 809464B4  39 61 00 20 */	addi r11, r1, 0x20
/* 809464B8  4B A1 BD 71 */	bl _restgpr_29
