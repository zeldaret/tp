...
/* 80345498  3C 80 80 45 */	lis r4, Packet@ha /* 0x8044C630@ha */
/* 8034549C  90 01 00 04 */	stw r0, 4(r1)
/* 803454A0  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 803454A4  93 E1 00 0C */	stw r31, 0xc(r1)
/* 803454A8  3B E4 C6 30 */	addi r31, r4, Packet@l /* 0x8044C630@l */
...
/* 803454BC  3C 60 80 3D */	lis r3, Si@ha /* 0x803D11FC@ha */
/* 803454C0  38 83 11 FC */	addi r4, r3, Si@l /* 0x803D11FC@l */
...
/* 803454F8  3C 60 80 34 */	lis r3, SIInterruptHandler@ha /* 0x80344EF8@ha */
/* 803454FC  90 04 00 00 */	stw r0, 0(r4)
/* 80345500  38 83 4E F8 */	addi r4, r3, SIInterruptHandler@l /* 0x80344EF8@l */
