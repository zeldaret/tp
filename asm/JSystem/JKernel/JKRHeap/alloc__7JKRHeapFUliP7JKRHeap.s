...
/* 802CE48C  41 82 00 18 */	beq lbl_802CE4A4
/* 802CE490  7C A3 2B 78 */	mr r3, r5
/* 802CE494  7C C4 33 78 */	mr r4, r6
/* 802CE498  7C 05 03 78 */	mr r5, r0
/* 802CE49C  48 00 00 39 */	bl alloc__7JKRHeapFUli
/* 802CE4A0  48 00 00 24 */	b lbl_802CE4C4
lbl_802CE4A4:
/* 802CE4A4  80 6D 8D F4 */	lwz r3, sCurrentHeap__7JKRHeap(r13)
/* 802CE4A8  28 03 00 00 */	cmplwi r3, 0
/* 802CE4AC  41 82 00 14 */	beq lbl_802CE4C0
/* 802CE4B0  7C C4 33 78 */	mr r4, r6
/* 802CE4B4  7C 05 03 78 */	mr r5, r0
/* 802CE4B8  48 00 00 1D */	bl alloc__7JKRHeapFUli
/* 802CE4BC  48 00 00 08 */	b lbl_802CE4C4
lbl_802CE4C0:
