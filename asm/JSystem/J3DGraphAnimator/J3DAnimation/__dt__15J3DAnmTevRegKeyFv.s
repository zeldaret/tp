...
/* 8032BDB4  3C 60 80 3D */	lis r3, __vt__15J3DAnmTevRegKey@ha /* 0x803CED60@ha */
/* 8032BDB8  38 03 ED 60 */	addi r0, r3, __vt__15J3DAnmTevRegKey@l /* 0x803CED60@l */
/* 8032BDBC  90 1F 00 00 */	stw r0, 0(r31)
/* 8032BDC0  34 1F 00 38 */	addic. r0, r31, 0x38
/* 8032BDC4  41 82 00 10 */	beq lbl_8032BDD4
/* 8032BDC8  3C 60 80 3C */	lis r3, __vt__10JUTNameTab@ha /* 0x803BB3DC@ha */
/* 8032BDCC  38 03 B3 DC */	addi r0, r3, __vt__10JUTNameTab@l /* 0x803BB3DC@l */
/* 8032BDD0  90 1F 00 38 */	stw r0, 0x38(r31)
lbl_8032BDD4:
/* 8032BDD4  34 1F 00 24 */	addic. r0, r31, 0x24
/* 8032BDD8  41 82 00 10 */	beq lbl_8032BDE8
/* 8032BDDC  3C 60 80 3C */	lis r3, __vt__10JUTNameTab@ha /* 0x803BB3DC@ha */
/* 8032BDE0  38 03 B3 DC */	addi r0, r3, __vt__10JUTNameTab@l /* 0x803BB3DC@l */
/* 8032BDE4  90 1F 00 24 */	stw r0, 0x24(r31)
lbl_8032BDE8:
/* 8032BDE8  28 1F 00 00 */	cmplwi r31, 0
/* 8032BDEC  41 82 00 10 */	beq lbl_8032BDFC
/* 8032BDF0  3C 60 80 3A */	lis r3, __vt__10J3DAnmBase@ha /* 0x803A7C38@ha */
/* 8032BDF4  38 03 7C 38 */	addi r0, r3, __vt__10J3DAnmBase@l /* 0x803A7C38@l */
