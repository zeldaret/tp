...
asm void PSVECAdd(const Vec* a, const Vec* b, Vec* ab) {
    nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void PSVECSubtract(const Vec* a, const Vec* b, Vec* a_b) {
    nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void PSVECScale(const Vec* src, Vec* dst, f32 scale) {
    nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void PSVECNormalize(const Vec* src, Vec* unit) {
    nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm f32 PSVECDotProduct(const Vec* a, const Vec* b) {
    nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void PSVECCrossProduct(const Vec* a, const Vec* b, Vec* axb) {
    nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void C_VECReflect(const Vec* src, const Vec* normal, Vec* dst) {
    nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm f32 PSVECDistance(const Vec* a, const Vec* b) {
    nofralloc
