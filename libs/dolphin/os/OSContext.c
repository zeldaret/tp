...
asm void OSSaveContext(register OSContext* context) {
    // clang-format off
    nofralloc
...
SECTION_DATA static char lit_76[] = "FPU-unavailable handler installed\n";
