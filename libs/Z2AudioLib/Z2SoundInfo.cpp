...
struct Z2SoundInfo {
	/* 802BB00C */ // True False
//  JAISoundID False
void getBgmSeqResourceID(JAISoundID) const;
	/* 802BB090 */ // True False
//  JAISoundID False
void getSoundType(JAISoundID) const;
	/* 802BB0D8 */ // True False
//  JAISoundID False
void getCategory(JAISoundID) const;
	/* 802BB0E0 */ // True False
//  JAISoundID False
void getPriority(JAISoundID) const;
	/* 802BB158 */ // False False
//  JAISoundID False
void getAudibleSwFull(JAISoundID);
	/* 802BB448 */ // True False
//  JAISoundID False
void getAudibleSw(JAISoundID) const;
	/* 802BB6DC */ // True False
//  JAISoundID False
//  JAISe* False
// 	 JAISe False
void getSeInfo(JAISoundID, JAISe*) const;
	/* 802BB8B4 */ // True False
//  JAISoundID False
//  JAISeq* False
// 	 JAISeq False
void getSeqInfo(JAISoundID, JAISeq*) const;
	/* 802BB8E0 */ // True False
//  JAISoundID False
//  JAIStream* False
// 	 JAIStream False
void getStreamInfo(JAISoundID, JAIStream*) const;
	/* 802BBA10 */ // True False
//  JAISoundID False
void getStreamFilePath(JAISoundID);
	/* 802BBA88 */ // True False
//  JAISoundID False
