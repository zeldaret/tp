#ifndef RES_O_GD_TONM_H
#define RES_O_GD_TONM_H

enum dRes_INDEX_O_GD_TONM {
    /* BCK  */
...
enum O_GD_TON_M_JNT {
    O_GD_TON_M_JNT_CENTER_e=0x0,
    O_GD_TON_M_JNT_WING1_e=0x1,
    O_GD_TON_M_JNT_WING2_e=0x2,
};

#endif /* !RES_O_GD_TONM_H */