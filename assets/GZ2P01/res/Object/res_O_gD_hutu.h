#ifndef RES_O_GD_HUTU_H
#define RES_O_GD_HUTU_H

enum dRes_INDEX_O_GD_HUTU {
    /* BCK  */
...
enum O_GD_HUTU_JNT {
    O_GD_HUTU_JNT_WORLD_ROOT_e=0x0,
    O_GD_HUTU_JNT_O_GD_HUTU_e=0x1,
    O_GD_HUTU_JNT_HEART_e=0x2,
};

#endif /* !RES_O_GD_HUTU_H */