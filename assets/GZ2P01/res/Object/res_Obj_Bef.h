#ifndef RES_OBJ_BEF_H
#define RES_OBJ_BEF_H

enum dRes_INDEX_OBJ_BEF {
    /* BMDR */
...
enum EF_HAKO_BURN_JNT {
    EF_HAKO_BURN_JNT_J_HAKO_00_e=0x0,
};

enum EF_TARU_BURN_JNT {
    EF_TARU_BURN_JNT_J_TARU_00_e=0x0,
};
