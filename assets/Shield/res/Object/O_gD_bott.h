#ifndef RES_O_GD_BOTT_H
#define RES_O_GD_BOTT_H

enum dRes_INDEX_O_GD_BOTT {
    /* BMDE */
...
enum O_GD_BOTTLE_JNT {
    O_GD_BOTTLE_JNT_AL_BOTTLE_e=0x0,
    O_GD_BOTTLE_JNT_AL_BOTTLE_CAP_e=0x1,
};

#endif /* !RES_O_GD_BOTT_H */