#ifndef RES_O_GD_TKC_H
#define RES_O_GD_TKC_H

enum dRes_INDEX_O_GD_TKC {
    /* BCK  */
...
enum O_GD_TKC_JNT {
    O_GD_TKC_JNT_CENTER_e=0x0,
    O_GD_TKC_JNT_HEAD_e=0x1,
    O_GD_TKC_JNT_ARML_e=0x2,
    O_GD_TKC_JNT_ARMR_e=0x3,
    O_GD_TKC_JNT_CHIN_e=0x4,
    O_GD_TKC_JNT_MOUTH_e=0x5,
};

#endif /* !RES_O_GD_TKC_H */